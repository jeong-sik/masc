(** Keeper_types_profile_toml_key_validate — unknown-key detection,
    warning deduplication, and compile-time key-list assertions
    extracted from [Keeper_types_profile_toml_parser] (557 LoC).
