...
OAS Pin Snapshot: dependency floor `0.122.0`, runtime pin `main@782c2875f3da0382cbb60742718068adb87cc933`, declared base version `v0.122.0`
...
`masc-mcp` keeps the runtime pin ratcheted against upstream `main`, while the dependency floor tracks the pinned SDK declaration in `agent_sdk.opam`. Generated snapshot: runtime pin `main@782c2875f3da0382cbb60742718068adb87cc933`, declared base version `v0.122.0`, dependency floor `0.122.0`.
