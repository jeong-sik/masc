...
let all_custom_events : t list =
  [ Started; Reconciled; Restarted; Dead_cleaned; Self_preservation; Paused_pruned ]
;;

let valid_custom_event_strings : string list = List.map to_string all_custom_events
