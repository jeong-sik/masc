...
are required. This guide targets **0.36.0**. Check publication on
...
## First conversation with `imp` (0.36.0)

This is the 0.36.0 installation contract. Check the release tag and asset
