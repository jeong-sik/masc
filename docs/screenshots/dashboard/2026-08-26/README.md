# Dashboard screenshots — 2026-08-26

These screenshots were captured from the live loopback dashboard at
`http://127.0.0.1:8935/dashboard/`.

- Captured: `2026-08-26T05:24:25Z`
- Runtime: MASC `0.25.0`, commit `5383718928b5595a19e7012d5a0cf2856eed8d89`
- Documentation source: `5383718928b5595a19e7012d5a0cf2856eed8d89`
- Viewport: `1440 × 1000`, device scale factor `1`
- Keeper names redacted: 15
- Reproduce: `python3 scripts/capture-dashboard-screenshots.py --out docs/screenshots/dashboard/2026-08-26`
