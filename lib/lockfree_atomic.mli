...
(** [update_with_result atomic f] runs [f] on the current state and
    commits the [next_state, result] tuple via CAS, retrying on
    contention; returns [result]. Tuple-form sibling of
    [update_with_commit]. *)
