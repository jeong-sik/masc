  ...
  return html`
    <div class="p-4 rounded border ${coverageTone(coverage)} transition-colors" role="region" aria-label="평가 품질">
      ...
      <div class="flex items-center justify-between mb-3">
        ...
        <button type="button"
          class="text-2xs text-[var(--text-dim)] hover:text-[var(--text-muted)] cursor-pointer bg-transparent border-0 p-0"
      ...
      <div class="flex items-center gap-3 mb-3">
        <span class="text-3xs text-[var(--text-muted)] flex-shrink-0 w-16">커버리지</span>
