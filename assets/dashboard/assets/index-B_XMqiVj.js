...
`).map(n=>n.trim()).filter(n=>n!=="")}async function $c(t,e=20){return ee("masc_task_history",{task_id:t,limit:e})}async function hc(t){const e=await ee("masc_debate_start",{topic:t});try{return JSON.parse(e)}catch{return null}}async function yc(t){return So("fetchDebateStatus",async()=>{const e=encodeURIComponent(t),n=await et(`/api/v1/council/debates/${e}/summary`);if(!v(n))return null;const s=y(n.id,"").trim();return s?{id:s,topic:y(n.topic,""),status:y(n.status,"open"),support_count:B(n.support_count,0),oppose_count:B(n.oppose_count,0),neutral_count:B(n.neutral_count,0),total_arguments:B(n.total_arguments,0),created_at:an(n.created_at_iso??n.created_at),summary_text:y(n.summary_text,"")}:null})}function bc(t,e,n){return ee("masc_keeper_msg",{name:t,message:e})}const kc=g(""),Ot=g({}),rt=g({}),Ea=g({}),ja=g({}),Oa=g({}),Fa=g({}),Ft=g({});function it(t,e,n){t.value={...t.value,[e]:n}}function xc(t){var n;const e=(n=r(t))==null?void 0:n.toLowerCase();return e==="user"||e==="assistant"||e==="system"||e==="tool"?e:"other"}function Sc(t){switch(t){case"user":return"User";case"assistant":return"Keeper";case"system":return"System";case"tool":return"Tool";default:return"Event"}}function sa(t,e){if(!Array.isArray(t))return[];const n=[];for(const s of t){if(!v(s))continue;const a=r(s.name);if(!a)continue;const o=r(s[e]);e==="summary"?n.push({name:a,summary:o}):n.push({name:a,reason:o})}return n}function Ac(t){if(!v(t))return null;const e=r(t.name);return e?{name:e,trigger:r(t.trigger),outcome:r(t.outcome),summary:r(t.summary),reason:r(t.reason)}:null}function Cc(t){const e=t.toLowerCase();return e.includes("graphql")?"graphql_error":e.includes("timeout")||e.includes("model")||e.includes("llm")||e.includes("api key")||e.includes("api_key")||e.includes("provider")?"llm_error":"unknown"}function wc(t,e){return t==="offline"||t==="degraded"||t==="stale"?"Keeper is not in a healthy reply state. Probe or recover before relying on automation.":e==="quiet_hours"?"Lodge quiet hours are active. Direct messages still work, but scheduled social ticks may look asleep.":e==="min_gap"?"Keeper is inside its proactive cooldown window. Direct messages work now; autonomous check-ins will wait.":e==="never_started"?"Keeper metadata exists but no reply turn has been recorded yet.":"Keeper is reachable. Send a direct message for an immediate response."}function wo(t,e,n){return r(t)??wc(e,n)}function To(t,e){return typeof t=="boolean"?t:e==="recover"}function hs(t){if(!v(t))return null;const e=r(t.health_state),n=r(t.next_action_path),s=r(t.last_reply_status);return!e||!n||!s?null:{health_state:e,quiet_reason:r(t.quiet_reason)??null,next_action_path:n,last_reply_status:s,last_reply_at:Oe(t.last_reply_at)??null,last_reply_preview:r(t.last_reply_preview)??null,last_error:r(t.last_error)??null,next_eligible_at_s:c(t.next_eligible_at_s)??null,recoverable:To(t.recoverable,n),summary:wo(t.summary,e,r(t.quiet_reason)??null),keepalive_running:typeof t.keepalive_running=="boolean"?t.keepalive_running:void 0}}function Io(t){return v(t)?{hour:c(t.hour),checked:c(t.checked)??0,acted:c(t.acted)??0,acted_names:H(t.acted_names),activity_report:r(t.activity_report),quiet_hours_overridden:q(t.quiet_hours_overridden),skipped_reason:r(t.skipped_reason),acted_rows:sa(t.acted_rows,"summary").map(e=>({name:e.name,summary:e.summary})),passed_rows:sa(t.passed_rows,"reason").map(e=>({name:e.name,reason:e.reason})),skipped_rows:sa(t.skipped_rows,"reason").map(e=>({name:e.name,reason:e.reason})),checkins:Array.isArray(t.checkins)?t.checkins.map(Ac).filter(e=>e!==null):[]}:null}function Tc(t){return v(t)?{enabled:q(t.enabled)??!1,interval_s:c(t.interval_s)??0,quiet_start:c(t.quiet_start),quiet_end:c(t.quiet_end),quiet_active:q(t.quiet_active),use_planner:q(t.use_planner),delegate_llm:q(t.delegate_llm),agent_count:c(t.agent_count),agents:H(t.agents),last_tick_ago_s:c(t.last_tick_ago_s)??null,last_tick_ago:r(t.last_tick_ago),total_ticks:c(t.total_ticks),total_checkins:c(t.total_checkins),last_skip_reason:r(t.last_skip_reason)??null,last_tick_result:Io(t.last_tick_result),active_self_heartbeats:H(t.active_self_heartbeats)}:null}function Ic(t){return v(t)?{status:t.status,diagnostic:hs(t.diagnostic)}:null}function Rc(t){return v(t)?{recovered:q(t.recovered)??!1,skipped_reason:r(t.skipped_reason)??null,before:hs(t.before),after:hs(t.after),down:t.down,up:t.up}:null}function Pc(t,e){var w,P;if(!(t!=null&&t.name))return null;const n=r((w=t.agent)==null?void 0:w.status)??r(t.status)??"unknown",s=r((P=t.agent)==null?void 0:P.error)??null,a=t.presence_keepalive??!0,o=t.keepalive_running??!1,l=t.turn_count??0,d=t.last_turn_ago_s??null,m=t.proactive_enabled??!1,_=t.proactive_cooldown_sec??0,u=t.last_proactive_ago_s??null,p=m&&u!=null?Math.max(0,_-u):null,f=l<=0||d==null?"never":d>900?"stale":"fresh",h=typeof t.last_heartbeat=="string"&&t.last_heartbeat.trim()?t.last_heartbeat:null,S=s??(a&&!o?"keeper keepalive is not running":null),A=n==="offline"||n==="inactive"?"offline":S?"degraded":f==="stale"?"stale":f==="never"?"idle":"healthy",C=S?Cc(S):e!=null&&e.quiet_active&&f!=="fresh"?"quiet_hours":a&&!o?"disabled":l<=0?"never_started":p!=null&&p>0?"min_gap":f==="fresh"||f==="stale"?"no_recent_activity":"unknown",T=A==="offline"||A==="degraded"||A==="stale"?"recover":C==="quiet_hours"?"manual_lodge_poke":C==="unknown"?"probe":"direct_message";return{health_state:A,quiet_reason:C,next_action_path:T,last_reply_status:f,last_reply_at:h,last_reply_preview:null,last_error:S,next_eligible_at_s:p!=null&&p>0?p:null,recoverable:To(void 0,T),summary:wo(void 0,A,C),keepalive_running:o}}function Nc(t,e){if(!v(t))return null;const n=xc(t.role),s=r(t.content)??r(t.preview);if(!s)return null;const a=Oe(t.ts_unix)??Oe(t.timestamp);return{id:`${n}-${a??"entry"}-${e}`,role:n,label:Sc(n),text:s,timestamp:a,delivery:"history"}}function Lc(t,e,n){const s=v(n)?n:null,a=Array.isArray(s==null?void 0:s.history_tail)?s.history_tail.map((o,l)=>Nc(o,l)).filter(o=>o!==null):[];return{name:t,diagnostic:hs(s==null?void 0:s.diagnostic),history:a,rawText:e,rawStatus:n,loadedAt:new Date().toISOString()}}function Ni(t,e){const n=rt.value[t]??[];rt.value={...rt.value,[t]:[...n,e].slice(-50)}}function Mc(t,e){return t.role!==e.role||t.text!==e.text?!1:t.timestamp&&e.timestamp?t.timestamp===e.timestamp:!0}function Dc(t,e){const s=(rt.value[t]??[]).filter(a=>a.delivery!=="history"&&!e.some(o=>Mc(a,o)));rt.value={...rt.value,[t]:[...e,...s].slice(-50)}}function Ys(t,e){Ot.value={...Ot.value,[t]:e},Dc(t,e.history)}function Li(t,e){const n=Ot.value[t];if(!n)return;const s=n.diagnostic??{health_state:"idle",next_action_path:"direct_message",last_reply_status:"unknown"};Ys(t,{...n,diagnostic:{...s,...e}})}async function ii(){try{await En()}catch(t){console.warn("[keeper-runtime] dashboard refresh failed",t)}}function zc(t){kc.value=t.trim()}async function Ro(t,e=!1){const n=t.trim();if(!n)return null;if(!e&&Ot.value[n])return Ot.value[n];it(Ea,n,!0),it(Ft,n,null);try{const s=await ee("masc_keeper_status",{name:n,fast:!1,include_context:!0,include_metrics_overview:!0,include_memory_bank:!1,include_history_tail:!0,include_compaction_history:!1,tail_turns:5,tail_messages:10});let a=null;try{a=JSON.parse(s)}catch{a=null}const o=Lc(n,s,a);return Ys(n,o),o}catch(s){const a=s instanceof Error?s.message:`Failed to inspect ${n}`;return it(Ft,n,a),null}finally{it(Ea,n,!1)}}async function Ec(t,e){const n=t.trim(),s=e.trim();if(!n||!s)return;const a=`local-${Date.now()}`;Ni(n,{id:a,role:"user",label:"You",text:s,timestamp:new Date().toISOString(),delivery:"sending"}),it(ja,n,!0),it(Ft,n,null);try{const o=await bc(n,s);rt.value={...rt.value,[n]:(rt.value[n]??[]).map(l=>l.id===a?{...l,delivery:"delivered"}:l)},Ni(n,{id:`reply-${Date.now()}`,role:"assistant",label:n,text:o.trim()||"(empty reply)",timestamp:new Date().toISOString(),delivery:"delivered"}),Li(n,{last_reply_status:"delivered",last_reply_at:new Date().toISOString(),last_reply_preview:(o.trim()||"(empty reply)").slice(0,200),last_error:null}),await ii()}catch(o){const l=o instanceof Error?o.message:`Failed to send direct message to ${n}`;throw rt.value={...rt.value,[n]:(rt.value[n]??[]).map(d=>d.id===a?{...d,delivery:"error",error:l}:d)},Li(n,{last_reply_status:"error",last_error:l}),it(Ft,n,l),o}finally{it(ja,n,!1)}}async function jc(t,e){const n=t.trim();if(!n)return null;it(Oa,n,!0),it(Ft,n,null);try{const s=await Vs({actor:e,action_type:"keeper_probe",target_type:"keeper",target_id:n,payload:{}}),a=Ic(s.result),o=(a==null?void 0:a.diagnostic)??null;if(o){const l=Ot.value[n];Ys(n,{name:n,diagnostic:o,history:(l==null?void 0:l.history)??rt.value[n]??[],rawText:(l==null?void 0:l.rawText)??"",rawStatus:s.result,loadedAt:new Date().toISOString()})}return await ii(),o}catch(s){const a=s instanceof Error?s.message:`Failed to probe ${n}`;throw it(Ft,n,a),s}finally{it(Oa,n,!1)}}async function Oc(t,e){const n=t.trim();if(!n)return null;it(Fa,n,!0),it(Ft,n,null);try{const s=await Vs({actor:e,action_type:"keeper_recover",target_type:"keeper",target_id:n,payload:{}}),a=Rc(s.result),o=(a==null?void 0:a.after)??null;if(o){const l=Ot.value[n];Ys(n,{name:n,diagnostic:o,history:(l==null?void 0:l.history)??rt.value[n]??[],rawText:(l==null?void 0:l.rawText)??"",rawStatus:s.result,loadedAt:new Date().toISOString()})}return await ii(),o}catch(s){const a=s instanceof Error?s.message:`Failed to recover ${n}`;throw it(Ft,n,a),s}finally{it(Fa,n,!1)}}function re(t){return(t??"").trim().toLowerCase()}function ut(t){const e=typeof t=="number"?t:Date.parse(t);return Number.isNaN(e)?0:e}function rs(t,e=88){const n=t.replace(/\s+/g," ").trim();return n&&(n.length>e?`${n.slice(0,e-3)}...`:n)}function Jn(t){return typeof t!="number"||!Number.isFinite(t)||t<0?null:new Date(Date.now()-t*1e3).toISOString()}function Xe(t){return t.last_heartbeat??Jn(t.last_turn_ago_s)??Jn(t.last_proactive_ago_s)??Jn(t.last_handoff_ago_s)??Jn(t.last_compaction_ago_s)}function Fc(t){const e=t.title.trim();return e||rs(t.content)}function qc(t){const e=t.generation??"?",n=typeof t.context_ratio=="number"&&Number.isFinite(t.context_ratio)?`${Math.round(t.context_ratio*100)}%`:"?";return t.last_heartbeat?`Heartbeat gen=${e} ctx=${n}`:`Keeper snapshot gen=${e} ctx=${n}`}function Kc(t,e,n,s,a={}){var P;const o=re(t),l=e.filter(k=>re(k.assignee)===o&&(k.status==="claimed"||k.status==="in_progress")).length,d=n.filter(k=>re(k.from)===o).sort((k,R)=>ut(R.timestamp)-ut(k.timestamp))[0],m=s.filter(k=>re(k.agent)===o||re(k.author)===o).sort((k,R)=>ut(R.timestamp)-ut(k.timestamp))[0],_=(a.boardPosts??[]).filter(k=>re(k.author)===o).sort((k,R)=>ut(R.updated_at||R.created_at)-ut(k.updated_at||k.created_at))[0],u=(a.keepers??[]).filter(k=>re(k.name)===o&&Xe(k)!==null).sort((k,R)=>ut(Xe(R)??0)-ut(Xe(k)??0))[0],p=d?ut(d.timestamp):0,f=m?ut(m.timestamp):0,h=_?ut(_.updated_at||_.created_at):0,S=u?ut(Xe(u)??0):0,A=a.lastSeen?ut(a.lastSeen):0,C=((P=a.currentTask)==null?void 0:P.trim())||(l>0?`${l} claimed tasks`:null);if(p===0&&f===0&&h===0&&S===0&&A===0)return{activeAssignedCount:l,lastActivityAt:null,lastActivityText:C};const w=[d?{timestamp:d.timestamp,ts:p,text:rs(d.content)}:null,_?{timestamp:_.updated_at||_.created_at,ts:h,text:`Post: ${rs(Fc(_))}`}:null,u?{timestamp:Xe(u),ts:S,text:qc(u)}:null,m?{timestamp:new Date(m.timestamp).toISOString(),ts:f,text:rs(m.text)}:null].filter(k=>k!==null).sort((k,R)=>R.ts-k.ts)[0];return w&&w.ts>=A?{activeAssignedCount:l,lastActivityAt:w.timestamp,lastActivityText:w.text}:{activeAssignedCount:l,lastActivityAt:a.lastSeen??null,lastActivityText:C??"Presence heartbeat"}}const yt=g([]),It=g([]),Fe=g([]),Kt=g([]),_t=g(null),Uc=g(null),qa=g(new Map),fn=g([]),gn=g("recent"),Ae=g(!0),Po=g(null),jt=g(""),Re=g([]),on=g(!1),No=g(new Map),oi=g("unknown"),Pe=g(null),Ka=g(!1),$n=g(!1),Ua=g(!1),rn=g(!1),ri=g(null),ys=g(!1),bs=g(null),Lo=g(null),Ha=g(null),Hc=g(null),Wc=g(null),Bc=g(null);ht(()=>yt.value.filter(t=>t.status==="active"||t.status==="busy"||t.status==="listening"||t.status==="idle"));const Mo=ht(()=>{const t=It.value;return{todo:t.filter(e=>e.status==="todo"),inProgress:t.filter(e=>e.status==="in_progress"||e.status==="claimed"),done:t.filter(e=>e.status==="done")}}),li=ht(()=>{const t=new Map,e=It.value,n=Fe.value,s=$s.value,a=fn.value,o=Kt.value;for(const l of yt.value)t.set(l.name.trim().toLowerCase(),Kc(l.name,e,n,s,{currentTask:l.current_task,lastSeen:l.last_seen,boardPosts:a,keepers:o}));return t});function Gc(t){var o;const e=((o=t.status)==null?void 0:o.toLowerCase())??"";if(e==="offline"||e==="inactive")return"offline";const n=t.metrics_series;if(!n||n.length===0)return"idle";const s=n[n.length-1];if(!s)return"idle";if(s.is_handoff)return"handoff-imminent";if(s.is_compaction)return"compacting";const a=s.context_ratio;return a>.85?"handoff-imminent":a>.7?"preparing":a>.5?"compacting":"active"}const Jc=ht(()=>{const t=new Map;for(const e of Kt.value)t.set(e.name,Gc(e));return t}),Vc=12e4;function Yc(t,e){const n=e.get(t.name);if(n!=null)return n;const s=t.last_heartbeat?Date.parse(t.last_heartbeat):Number.NaN;if(!Number.isNaN(s))return s;const a=[t.last_turn_ago_s,t.last_proactive_ago_s,t.last_handoff_ago_s,t.last_compaction_ago_s].find(o=>typeof o=="number"&&Number.isFinite(o)&&o>=0);return typeof a=="number"?Date.now()-a*1e3:null}const Qc=ht(()=>{const t=Date.now(),e=new Set,n=qa.value;for(const s of Kt.value){const a=Yc(s,n);a!=null&&t-a>Vc&&e.add(s.name)}return e});let aa=null;function Xc(t){return t==="dashboard_refresh"||t==="masc/dashboard_refresh"||t.startsWith("goal_")||t.startsWith("masc/goal_")||t.startsWith("mdal_")||t.startsWith("masc/mdal_")||t.startsWith("operator_")||t.startsWith("masc/operator_")||t.startsWith("command_plane_")||t.startsWith("masc/command_plane_")}function Do(t){const e=typeof t=="string"?t.toLowerCase():"";return e==="active"||e==="busy"||e==="listening"||e==="idle"||e==="inactive"||e==="offline"?e:e==="in_progress"||e==="claimed"?"busy":"offline"}function Zc(t){const e=typeof t=="string"?t.toLowerCase():"";return e==="todo"||e==="in_progress"||e==="claimed"||e==="done"||e==="cancelled"?e:e==="inprogress"?"in_progress":"todo"}function td(t){if(!v(t))return null;const e=r(t.name);return e?{name:e,agent_type:r(t.agent_type),status:Do(t.status),current_task:r(t.current_task)??null,joined_at:r(t.joined_at),last_seen:r(t.last_seen),capabilities:H(t.capabilities),emoji:r(t.emoji),koreanName:r(t.koreanName)??r(t.korean_name),model:r(t.model),traits:H(t.traits),interests:H(t.interests),activityLevel:c(t.activityLevel)??c(t.activity_level),primaryValue:r(t.primaryValue)??r(t.primary_value)}:null}function ed(t){if(!v(t))return null;const e=r(t.id),n=r(t.title);return!e||!n?null:{id:e,title:n,status:Zc(t.status),priority:c(t.priority),assignee:r(t.assignee),description:r(t.description),created_at:r(t.created_at),updated_at:r(t.updated_at)}}function nd(t){if(!v(t))return null;const e=r(t.from)??r(t.from_agent)??"system",n=r(t.content)??"",s=r(t.timestamp)??new Date().toISOString();return{id:r(t.id),seq:c(t.seq),from:e,content:n,timestamp:s,type:r(t.type)}}function Mi(t){if(typeof t.seq=="number"&&Number.isFinite(t.seq))return t.seq;const e=Date.parse(t.timestamp);return Number.isNaN(e)?0:e}function sd(t,e){if(e.length===0)return t;const n=new Map;for(const s of t){const a=typeof s.seq=="number"?`seq:${s.seq}`:`ts:${s.timestamp}|from:${s.from}|content:${s.content}`;n.set(a,s)}for(const s of e){const a=typeof s.seq=="number"?`seq:${s.seq}`:`ts:${s.timestamp}|from:${s.from}|content:${s.content}`;n.set(a,s)}return[...n.values()].sort((s,a)=>Mi(s)-Mi(a)).slice(-500)}function ad(t){return Array.isArray(t)?t.map(e=>{if(!v(e))return null;const n=c(e.ts_unix);if(n==null)return null;const s=v(e.handoff)?e.handoff:null;return{ts:n,context_ratio:c(e.context_ratio)??0,context_tokens:c(e.context_tokens)??0,context_max:c(e.context_max)??0,latency_ms:c(e.latency_ms)??0,generation:c(e.generation)??0,channel:typeof e.channel=="string"?e.channel:"turn",is_handoff:s!=null&&e.handoff_performed===!0,is_compaction:e.compacted===!0,compaction_saved_tokens:c(e.compaction_saved_tokens)??0,compaction_trigger:typeof e.compaction_trigger=="string"?e.compaction_trigger:null,model_used:typeof e.model_used=="string"?e.model_used:"",cost_usd:c(e.cost_usd)??0,handoff_to_model:s&&typeof s.to_model=="string"?s.to_model:null,handoff_new_generation:s?c(s.new_generation)??null:null}}).filter(e=>e!==null):[]}function Di(t){if(!v(t))return null;const e=r(t.health_state),n=r(t.next_action_path),s=r(t.last_reply_status);if(!e||!n||!s)return null;const a=r(t.quiet_reason)??null,o=r(t.summary)??(e==="offline"||e==="degraded"||e==="stale"?"Keeper is not in a healthy reply state. Probe or recover before relying on automation.":a==="quiet_hours"?"Lodge quiet hours are active. Direct messages still work, but scheduled social ticks may look asleep.":a==="min_gap"?"Keeper is inside its proactive cooldown window. Direct messages work now; autonomous check-ins will wait.":a==="never_started"?"Keeper metadata exists but no reply turn has been recorded yet.":"Keeper is reachable. Send a direct message for an immediate response.");return{health_state:e,quiet_reason:a,next_action_path:n,last_reply_status:s,last_reply_at:Oe(t.last_reply_at)??r(t.last_reply_at)??null,last_reply_preview:r(t.last_reply_preview)??null,last_error:r(t.last_error)??null,next_eligible_at_s:c(t.next_eligible_at_s)??null,recoverable:typeof t.recoverable=="boolean"?t.recoverable:n==="recover",summary:o,keepalive_running:typeof t.keepalive_running=="boolean"?t.keepalive_running:void 0}}function id(t,e){return(Array.isArray(t)?t:v(t)&&Array.isArray(t.keepers)?t.keepers:[]).map(s=>{if(!v(s))return null;const a=v(s.agent)?s.agent:null,o=v(s.context)?s.context:null,l=v(s.metrics_window)?s.metrics_window:void 0,d=r(s.name);if(!d)return null;const m=c(s.context_ratio)??c(o==null?void 0:o.context_ratio),_=r(s.status)??r(a==null?void 0:a.status)??"offline",u=Do(_),p=r(s.model)??r(s.active_model)??r(s.primary_model),f=H(s.skill_secondary),h=o?{source:r(o.source),context_ratio:c(o.context_ratio),context_tokens:c(o.context_tokens),context_max:c(o.context_max),message_count:c(o.message_count),has_checkpoint:typeof o.has_checkpoint=="boolean"?o.has_checkpoint:void 0}:void 0,S=a?{name:r(a.name),exists:typeof a.exists=="boolean"?a.exists:void 0,error:r(a.error),agent_type:r(a.agent_type),status:r(a.status),current_task:r(a.current_task)??null,joined_at:r(a.joined_at),last_seen:r(a.last_seen),last_seen_ago_s:c(a.last_seen_ago_s),capabilities:H(a.capabilities),is_zombie:typeof a.is_zombie=="boolean"?a.is_zombie:void 0}:void 0,A=ad(s.metrics_series),C={name:d,emoji:r(s.emoji),koreanName:r(s.koreanName)??r(s.korean_name),agent_name:r(s.agent_name),trace_id:r(s.trace_id),model:p,primary_model:r(s.primary_model),active_model:r(s.active_model),next_model_hint:r(s.next_model_hint)??null,status:u,presence_keepalive:typeof s.presence_keepalive=="boolean"?s.presence_keepalive:void 0,presence_keepalive_sec:c(s.presence_keepalive_sec),keepalive_running:typeof s.keepalive_running=="boolean"?s.keepalive_running:void 0,proactive_enabled:typeof s.proactive_enabled=="boolean"?s.proactive_enabled:void 0,proactive_idle_sec:c(s.proactive_idle_sec),proactive_cooldown_sec:c(s.proactive_cooldown_sec),last_heartbeat:r(s.last_heartbeat)??r(a==null?void 0:a.last_seen),generation:c(s.generation),turn_count:c(s.turn_count)??c(s.total_turns),keeper_age_s:c(s.keeper_age_s),last_turn_ago_s:c(s.last_turn_ago_s),last_handoff_ago_s:c(s.last_handoff_ago_s),last_compaction_ago_s:c(s.last_compaction_ago_s),last_proactive_ago_s:c(s.last_proactive_ago_s),last_proactive_preview:r(s.last_proactive_preview)??null,context_ratio:m,context_tokens:c(s.context_tokens)??c(o==null?void 0:o.context_tokens),context_max:c(s.context_max)??c(o==null?void 0:o.context_max),context_source:r(s.context_source)??r(o==null?void 0:o.source),context:h,traits:H(s.traits),interests:H(s.interests),primaryValue:r(s.primaryValue)??r(s.primary_value),activityLevel:c(s.activityLevel)??c(s.activity_level),memory_recent_note:r(s.memory_recent_note)??null,recent_input_preview:r(s.recent_input_preview)??null,recent_output_preview:r(s.recent_output_preview)??null,recent_tool_names:H(s.recent_tool_names)??[],conversation_tail_count:c(s.conversation_tail_count),k2k_count:c(s.k2k_count),handoff_count_total:c(s.handoff_count_total)??c(s.trace_history_count),compaction_count:c(s.compaction_count),last_compaction_saved_tokens:c(s.last_compaction_saved_tokens),diagnostic:Di(s.diagnostic),skill_primary:r(s.skill_primary)??null,skill_secondary:f,skill_reason:r(s.skill_reason)??null,metrics_series:A.length>0?A:void 0,metrics_window:l,agent:S};return C.diagnostic=Di(s.diagnostic)??Pc(C,(e==null?void 0:e.lodge)??null),C}).filter(s=>s!==null)}function zo(t){return v(t)?{...t,lodge:Tc(t.lodge)??void 0}:null}function od(t){const e=typeof t=="string"?t.toLowerCase():"";return e==="running"||e==="interrupted"||e==="completed"||e==="stopped"||e==="error"?e:e.startsWith("error")?"error":"running"}function rd(t){if(!v(t))return null;const e=c(t.iteration);if(e==null)return null;const n=c(t.metric_before)??0,s=c(t.metric_after)??n,a=v(t.evidence)?t.evidence:null;return{iteration:e,metric_before:n,metric_after:s,delta:c(t.delta)??s-n,changes:r(t.changes)??"",failed_attempts:r(t.failed_attempts)??"",next_suggestion:r(t.next_suggestion)??"",elapsed_ms:c(t.elapsed_ms)??0,cost_usd:c(t.cost_usd)??null,evidence:a?{worker_engine:(a.worker_engine==="api_tool_loop","api_tool_loop"),worker_model:r(a.worker_model)??"",tool_call_count:c(a.tool_call_count)??0,tool_names:H(a.tool_names)??[],session_id:r(a.session_id)??"",evidence_status:a.evidence_status==="legacy_unverified"?"legacy_unverified":"verified"}:null}}function ld(t){var o,l;if(!v(t))return null;const e=r(t.loop_id);if(!e)return null;const n=c(t.baseline_metric)??0,s=Array.isArray(t.history)?t.history.map(rd).filter(d=>d!==null):[],a=c(t.current_metric)??((o=s[0])==null?void 0:o.metric_after)??n;return{loop_id:e,profile:r(t.profile)??"unknown",status:od(t.status),strict_mode:typeof t.strict_mode=="boolean"?t.strict_mode:void 0,error_message:r(t.error_message)??r(t.error_reason)??null,stop_reason:r(t.stop_reason)??r(t.reason)??null,current_iteration:c(t.current_iteration)??((l=s[0])==null?void 0:l.iteration)??0,max_iterations:c(t.max_iterations)??0,baseline_metric:n,current_metric:a,target:r(t.target)??"",stagnation_streak:c(t.stagnation_streak)??0,stagnation_limit:c(t.stagnation_limit)??0,elapsed_seconds:c(t.elapsed_seconds)??0,updated_at:Oe(t.updated_at)??null,stopped_at:Oe(t.stopped_at)??null,execution_mode:t.execution_mode==="worker_spawn"?"worker_spawn":void 0,worker_engine:t.worker_engine==="api_tool_loop"?"api_tool_loop":null,worker_model:r(t.worker_model)??null,evidence_policy:t.evidence_policy==="hard"||t.evidence_policy==="legacy"?t.evidence_policy:void 0,latest_tool_call_count:c(t.latest_tool_call_count)??0,latest_tool_names:H(t.latest_tool_names)??[],session_id:r(t.session_id)??null,evidence_status:t.evidence_status==="legacy_unverified"?"legacy_unverified":t.evidence_status==="verified"?"verified":null,durability:t.durability==="persistent_backend"||t.durability==="memory_only"?t.durability:void 0,persistence_backend:t.persistence_backend==="filesystem"||t.persistence_backend==="postgres"||t.persistence_backend==="memory"?t.persistence_backend:void 0,recoverable:typeof t.recoverable=="boolean"?t.recoverable:void 0,history:s}}async function En(){Ka.value=!0;try{await Promise.all([jo(),Et()]),Lo.value=new Date().toISOString()}catch(t){console.error("Dashboard refresh error:",t)}finally{Ka.value=!1}}async function Eo(){ys.value=!0,bs.value=null;try{const t=await Tl();ri.value=t,Bc.value=new Date().toISOString()}catch(t){bs.value=t instanceof Error?t.message:"Failed to load dashboard semantics"}finally{ys.value=!1}}function cd(t){var e;return((e=ri.value)==null?void 0:e.surfaces.find(n=>n.id===t))??null}function dd(t){var n;const e=((n=ri.value)==null?void 0:n.surfaces)??[];for(const s of e){const a=s.panels.find(o=>o.id===t);if(a)return a}return null}function ud(t){var s,a;Re.value=(Array.isArray(t.goals)?t.goals:[]).map(o=>{if(!v(o))return null;const l=r(o.id),d=r(o.title),m=r(o.horizon),_=r(o.status),u=r(o.created_at),p=r(o.updated_at);return!l||!d||!m||!_||!u||!p?null:{id:l,horizon:m,title:d,metric:r(o.metric)??null,target_value:r(o.target_value)??null,due_date:r(o.due_date)??null,priority:c(o.priority)??3,status:_,parent_goal_id:r(o.parent_goal_id)??null,last_review_note:r(o.last_review_note)??null,last_review_at:r(o.last_review_at)??null,created_at:u,updated_at:p}}).filter(o=>o!==null);const e=new Map,n=Array.isArray((s=t.mdal)==null?void 0:s.loops)?t.mdal.loops:[];for(const o of n){const l=ld(o);l&&e.set(l.loop_id,l)}No.value=e,Pe.value=typeof((a=t.mdal)==null?void 0:a.error)=="string"?t.mdal.error:null,oi.value=Pe.value?"error":e.size===0?"idle":"ready"}async function jo(){try{const t=await Sl(),e=zo(t.status);e&&(_t.value=e)}catch(t){console.error("Dashboard shell fetch error:",t)}}async function Et(){var t;try{const e=await Al(),n=zo(e.status),s=(t=_t.value)==null?void 0:t.room;n&&(_t.value=n);const a=s!=null&&(n==null?void 0:n.room)!=null&&s!==n.room;yt.value=(Array.isArray(e.agents)?e.agents:[]).map(td).filter(l=>l!==null),It.value=(Array.isArray(e.tasks)?e.tasks:[]).map(ed).filter(l=>l!==null);const o=(Array.isArray(e.messages)?e.messages:[]).map(nd).filter(l=>l!==null);Fe.value=a?o:sd(Fe.value,o),Kt.value=id(e.keepers,n??_t.value),Uc.value=null,Lo.value=new Date().toISOString()}catch(e){console.error("Dashboard execution fetch error:",e)}}async function Rt(){$n.value=!0;try{const t=await Cl(gn.value,{excludeSystem:Ae.value});fn.value=t.posts??[],Ha.value=new Date().toISOString()}catch(t){console.error("Board fetch error:",t)}finally{$n.value=!1}}async function Pt(){var t;Ua.value=!0;try{const e=jt.value||((t=_t.value)==null?void 0:t.room)||"default";jt.value||(jt.value=e);const n=await rc(e);Po.value=n}catch(e){console.error("TRPG fetch error:",e)}finally{Ua.value=!1}}async function hn(){on.value=!0,rn.value=!0;try{const t=await Pl();ud(t),Hc.value=new Date().toISOString(),Wc.value=new Date().toISOString()}catch(t){console.error("Planning fetch error:",t),oi.value="error",Pe.value=t instanceof Error?t.message:String(t)}finally{on.value=!1,rn.value=!1}}async function Oo(){return hn()}let ls=null;function pd(t){ls=t}let cs=null;function md(t){cs=t}let ds=null;function vd(t){ds=t}const ue={};function le(t,e,n=500){ue[t]&&clearTimeout(ue[t]),ue[t]=setTimeout(()=>{e(),delete ue[t]},n)}function _d(){const t=$o.subscribe(e=>{if(e){if(e.type==="keeper_heartbeat"&&e.name){const n=new Map(qa.value);n.set(e.name,e.ts_unix?e.ts_unix*1e3:Date.now()),qa.value=n;return}(e.type==="agent_joined"||e.type==="agent_left")&&le("execution",Et),Xc(e.type)&&(aa||(aa=setTimeout(()=>{En(),cs==null||cs(),ds==null||ds(),aa=null},500))),(e.type.startsWith("task_")||e.type.startsWith("masc/task_"))&&le("execution",Et),e.type==="broadcast"&&le("execution",Et),(e.type==="keeper_handoff"||e.type==="keeper_compaction"||e.type==="keeper_guardrail")&&le("execution",Et),(e.type==="board_post"||e.type==="masc/board_post"||e.type==="board_comment"||e.type==="masc/board_comment")&&le("board",Rt),e.type.startsWith("decision_")&&le("council",()=>ls==null?void 0:ls()),(e.type==="mdal_started"||e.type==="mdal_iteration"||e.type==="mdal_completed"||e.type==="mdal_stopped")&&le("mdal",Oo,350)}});return()=>{t();for(const e of Object.keys(ue))clearTimeout(ue[e]),delete ue[e]}}let ln=null;function fd(){ln||(ln=setInterval(()=>{Zt.value,En()},1e4))}function gd(){ln&&(clearInterval(ln),ln=null)}function $d({metric:t}){return i`
  ...
  `}function Gd(){var p,f,h,S,A,C,T;const t=Ge.value;if(!t)return null;const e=Kd(),n=Uo(t),s=Ko(t),a=Ss.value,o=Hd(t),l=Ud(n),d=(e==null?void 0:e.capabilities)??[],m=((p=_t.value)==null?void 0:p.room)??"default",_=((f=_t.value)==null?void 0:f.project)??"확인 없음",u=((h=_t.value)==null?void 0:h.cluster)??"확인 없음";return i`
    <div
      ...
      <div class="agent-detail-modal">
          ...
          <div style="display:flex;flex-direction:column;gap:8px;flex:1">
            ...
            ${(((S=e==null?void 0:e.traits)==null?void 0:S.length)??0)>0?i`
              <div style="display:flex;flex-wrap:wrap;gap:4px">
                ${(A=e==null?void 0:e.traits)==null?void 0:A.map(w=>i`<span style="font-size:0.7rem;background:#1e3a5f;color:#60a5fa;padding:2px 8px;border-radius:10px">${w}</span>`)}
              </div>
            `:""}
        ...
        <div class="agent-detail-grid">
          <${I} title="Assigned Tasks">
            ${s.length===0?i`<div class="empty-state">No assigned tasks</div>`:i`<div class="agent-detail-task-list">${s.map(w=>i`<${Wd} key=${w.id} task=${w} />`)}</div>`}
          <//>

          <${I} title="Recent Activity">
            ${a.length===0?i`<div class="empty-state">No recent room activity match</div>`:i`<div class="agent-activity-list">${a.map((w,P)=>i`<div key=${P} class="agent-activity-line">${w}</div>`)}</div>`}
          <//>
        </div>
        ...
        <${I} title="Task History">
          ${kn.value.length===0?i`<div class="empty-state">No task history loaded</div>`:i`<div class="agent-history-list">${kn.value.map(w=>i`<${Bd} key=${w.taskId} row=${w} />`)}</div>`}
        <//>
  ...
  `}function du({keeperName:t,placeholder:e}){const[n,s]=vo("");nt(()=>{t&&Ro(t)},[t]);const a=rt.value[t]??[],o=ja.value[t]??!1,l=Ft.value[t],d=async()=>{const m=n.trim();if(!(!t||!m)){s("");try{await Ec(t,m)}catch(_){const u=_ instanceof Error?_.message:`Failed to message ${t}`;N(u,"error")}}};return i`
  ...
  `}function uu({actor:t,keeper:e,onPokeLodge:n}){if(!e)return null;const s=Yo(e),a=Oa.value[e.name]??!1,o=Fa.value[e.name]??!1,l=(s==null?void 0:s.next_action_path)??"direct_message",d=(s==null?void 0:s.recoverable)??l==="recover";return i`
    <div class="control-actions">
      <button
        ...
        onClick=${()=>{jc(e.name,t).catch(m=>{const _=m instanceof Error?m.message:`Failed to probe ${e.name}`;N(_,"error")})}}
        disabled=${a||!t.trim()}
      >
        ${a?"Probing...":"Probe"}
      </button>
      <button
        ...
        onClick=${()=>{Oc(e.name,t).catch(m=>{const _=m instanceof Error?m.message:`Failed to recover ${e.name}`;N(_,"error")})}}
        disabled=${o||!d||!t.trim()}
      >
  ...
  `}function $u({keeper:t}){var u,p;const e=t.metrics_series??[];if(e.length<2){const f=(((u=t.context)==null?void 0:u.context_ratio)??0)*100,h=f>85?"#ef4444":f>70?"#f59e0b":"#22c55e";return i`
      ...
      </div>`}const n=200,s=60,a=2,o=e.length,l=e.map((f,h)=>{const S=a+h/(o-1)*(n-2*a),A=s-a-(f.context_ratio??0)*(s-2*a);return{x:S,y:A,p:f}}),d=l.map(({x:f,y:h})=>`${f.toFixed(1)},${h.toFixed(1)}`).join(" "),m=(((p=e[e.length-1])==null?void 0:p.context_ratio)??0)*100,_=m>85?"#ef4444":m>70?"#f59e0b":"#22c55e";return i`
  ...
  `}function Su({keeper:t}){var _,u,p,f,h,S,A;const e=((_=Nt.value)==null?void 0:_.room)??{},n=(((u=Nt.value)==null?void 0:u.available_actions)??[]).filter(C=>C.target_type==="keeper"||C.target_type==="room").slice(0,8),s=_u(t),a=fu(t),o=((p=t.agent)==null?void 0:p.capabilities)??[],l=e.current_room??e.room_id??((f=_t.value)==null?void 0:f.room)??"default",d=e.project??((h=_t.value)==null?void 0:h.project)??"확인 없음",m=e.cluster??((S=_t.value)==null?void 0:S.cluster)??"확인 없음";return i`
    <div class="keeper-signal-list">
      ...
      <div class="keeper-signal-row">
        ...
        <strong>${((A=t.agent)==null?void 0:A.current_task)??"없음"}</strong>
      </div>
      <div class="keeper-signal-row">
  ...
  `}function Xu(){const t=Fo.value,e=lt((t==null?void 0:t.status)??(de.value?"bad":"warn")),n=(t==null?void 0:t.status)==="error"||(t==null?void 0:t.status)==="unavailable"&&!(t!=null&&t.cached);return i`
  ...
  `}function Zu({item:t,selected:e,sessionLookup:n}){const s=Ku(t),a=t.related_session_ids.map(l=>n.get(l)).filter(l=>l!=null),o=t.top_action??null;return i`
    <article class="mission-attention-card ${lt((o==null?void 0:o.severity)??t.severity)} ${e?"is-selected":""}">
      <button class="mission-card-select" onClick=${()=>Vu(t.id)}>
        <div class="mission-card-head">
          <div>
  ...
  `}function tp({brief:t,selected:e}){var o,l;const n=t.member_names.slice(0,6).map(Ju),s=t.top_recommendation??null,a=t.top_attention??null;return i`
  ...
  `}function ep({row:t}){var s,a,o,l,d;const e=ci(t.brief.agent_name),n=t.withWhom.length>0?t.withWhom.slice(0,3).join(", "):"단독 또는 room-level";return i`
  ...
  `}function np({row:t}){var n,s,a,o,l,d,m,_,u,p;const e=[`gen ${t.brief.generation??((n=t.keeper)==null?void 0:n.generation)??0}`,t.brief.context_ratio!=null?`ctx ${Math.round(t.brief.context_ratio*100)}%`:((s=t.keeper)==null?void 0:s.context_ratio)!=null?`ctx ${Math.round(t.keeper.context_ratio*100)}%`:null,t.brief.last_turn_ago_s!=null?`last turn ${Math.round(t.brief.last_turn_ago_s)}s`:null].filter(f=>f!==null).join(" · ");return i`
    <article class="mission-activity-card ${lt(t.brief.status??((a=t.keeper)==null?void 0:a.status))}">
      <button class="mission-card-select" onClick=${()=>{t.keeper&&mi(t.keeper)}}>
        ...
        <div class="mission-activity-meta">
          <span>최근 heartbeat · ${(_=t.keeper)!=null&&_.last_heartbeat?_e(t.keeper.last_heartbeat):"n/a"}</span>
  ...
  `}function sp({item:t}){const e=t.action??null,n=t.attention??null;return i`
  ...
  `}function Wi(){var h,S,A,C,T,w,P;const t=di.value;if(Wa.value&&!t)return i`<div class="loading-indicator">상황판 스냅샷 불러오는 중...</div>`;if(ks.value&&!t)return i`<div class="empty-state error">${ks.value}</div>`;if(!t)return i`<div class="empty-state">상황판 스냅샷이 아직 없습니다.</div>`;Jt.value&&!t.attention_queue.some(k=>k.id===Jt.value)&&(Jt.value=null),zt.value&&!t.session_briefs.some(k=>k.session_id===zt.value)&&(zt.value=null);const e=t.attention_queue.find(k=>k.id===Jt.value)??null,n=zt.value,s=Gu(),a=e?new Set(e.related_session_ids):null,o=e?new Set(e.related_agent_names):null,l=(a?t.session_briefs.filter(k=>a.has(k.session_id)):t.session_briefs).slice(0,e?8:6),d=t.agent_briefs.filter(k=>!yd(k.agent_name)).filter(k=>n?k.related_session_id===n:o&&a?o.has(k.agent_name)||(k.related_session_id?a.has(k.related_session_id):!1):!0).slice(0,n||e?10:8).map(Wu),m=t.keeper_briefs.slice(0,6).map(Bu),_=t.attention_queue.length,u=t.attention_queue.slice(0,6),p=t.internal_signals.slice(0,3),f=d.filter(k=>k.recentOutput).length+m.filter(k=>k.recentOutput).length;return i`
    <section class="dashboard-panel mission-view">
      ...
      <div class="mission-stat-grid">
        <${be} label="주의 큐" value=${_} detail="개입 판단이 필요한 issue" tone=${((h=u[0])==null?void 0:h.severity)??"ok"} />
        <${be} label="영향 session" value=${l.length} detail="현재 선택 기준으로 좁힌 흐름" tone=${((A=(S=l[0])==null?void 0:S.top_attention)==null?void 0:A.severity)??((C=l[0])==null?void 0:C.health)??"ok"} />
        <${be} label="영향 agent" value=${d.length} detail="선택된 흐름에 연결된 actor" tone=${((T=d[0])==null?void 0:T.brief.status)??"ok"} />
        <${be} label="Keeper watch" value=${m.length} detail="continuity lane 관찰 대상" tone=${((w=m[0])==null?void 0:w.brief.status)??"ok"} />
        <${be} label="최근 output" value=${f} detail="선택된 영역에서 바로 읽을 수 있는 출력 수" tone=${f>0?"ok":"warn"} />
        <${be} label="내부 신호" value=${p.length} detail="room/system 진단은 하단 보조 lane" tone=${((P=p[0])==null?void 0:P.severity)??"ok"} />
      </div>

      ${e||n?i`
            <div class="mission-selection-bar">
              <span>현재 drill-down · ${e?e.summary:"session 선택"}${n?` · ${n}`:""}</span>
              <button class="control-btn ghost" onClick=${Yu}>선택 해제</button>
            </div>
          `:null}
      ...
      <${I} title="Attention Queue" class="mission-list-card" semanticId="mission.attention_queue">
        ...
        <div class="mission-lane-stack">
          ${u.length>0?u.map(k=>i`<${Zu} key=${k.id} item=${k} selected=${Jt.value===k.id} sessionLookup=${s} />`):i`<div class="empty-state">지금 Mission attention queue가 비어 있습니다.</div>`}
        </div>
      <//>
      ...
      <div class="mission-human-grid">
        <${I} title="Affected Sessions" class="mission-list-card" semanticId="mission.session_briefs">
          ...
          <div class="mission-list-stack">
            ${l.length>0?l.map(k=>i`<${tp} key=${k.session_id} brief=${k} selected=${zt.value===k.session_id} />`):i`<div class="empty-state">현재 선택과 연결된 session이 없습니다.</div>`}
          </div>
        <//>
        ...
        <${I} title="Impacted Agents" class="mission-list-card" semanticId="mission.agent_activity">
          ...
          <div class="mission-activity-list">
            ${d.length>0?d.map(k=>i`<${ep} key=${k.brief.agent_name} row=${k} />`):i`<div class="empty-state">현재 선택과 연결된 agent가 없습니다.</div>`}
          </div>
        <//>
      </div>
      ...
      <div class="mission-human-grid">
        <${I} title="Keeper Continuity" class="mission-list-card" semanticId="mission.keeper_activity">
          ...
          <div class="mission-activity-list">
            ${m.length>0?m.map(k=>i`<${np} key=${k.brief.name} row=${k} />`):i`<div class="empty-state">지금 보이는 keeper가 없습니다.</div>`}
          </div>
        <//>
        ...
        <${I} title="Internal Signals" class="mission-list-card" semanticId="mission.internal_signals">
          ...
          <div class="mission-list-stack">
            ${p.length>0?p.map(k=>i`<${sp} key=${k.id} item=${k} />`):i`<div class="empty-state">지금은 내부 진단 경고가 없습니다.</div>`}
          </div>
          <div class="mission-card-actions">
  ...
  `}const gi=g(null),Dt=g(null),Ts=g(!1),Is=g(!1),Rs=g(null),Ps=g(null),Ga=g(null),Ns=g(null),U=g("warroom"),On=g(null),Ja=g(!1),Ls=g(null),ge=g(null),Ms=g(!1),Ds=g(null),Fn=g(null),Va=g(!1),zs=g(null),An=g(null),Es=g(!1),Cn=g(null),De=g(null);let nn=null;function $i(t){return t!=="summary"&&t!=="swarm"&&t!=="warroom"}function cr(){if(typeof window>"u")return new URLSearchParams;const t=new URLSearchParams(window.location.search),e=window.location.hash.replace(/^#/,""),n=e.indexOf("?");return n>=0&&new URLSearchParams(e.slice(n+1)).forEach((a,o)=>{t.has(o)||t.set(o,a)}),t}function ap(){const e=cr().get("run_id")??void 0;return e&&e.trim()!==""?e.trim():void 0}function ip(){const e=cr().get("operation_id")??void 0;return e&&e.trim()!==""?e.trim():void 0}function op(t){if(v(t))return{policy_class:r(t.policy_class),approval_class:r(t.approval_class),tool_allowlist:H(t.tool_allowlist),model_allowlist:H(t.model_allowlist),requires_human_for:H(t.requires_human_for),autonomy_level:r(t.autonomy_level),escalation_timeout_sec:c(t.escalation_timeout_sec),kill_switch:q(t.kill_switch),frozen:q(t.frozen)}}function rp(t){if(v(t))return{headcount_cap:c(t.headcount_cap),active_operation_cap:c(t.active_operation_cap),max_cost_usd:c(t.max_cost_usd),max_tokens:c(t.max_tokens)}}function hi(t){if(!v(t))return null;const e=r(t.unit_id),n=r(t.label),s=r(t.kind);return!e||!n||!s?null:{unit_id:e,label:n,kind:s,parent_unit_id:r(t.parent_unit_id)??null,leader_id:r(t.leader_id)??null,roster:H(t.roster),capability_profile:H(t.capability_profile),source:r(t.source),created_at:r(t.created_at),updated_at:r(t.updated_at),policy:op(t.policy),budget:rp(t.budget)}}function dr(t){if(!v(t))return null;const e=hi(t.unit);return e?{unit:e,leader_status:r(t.leader_status),roster_total:c(t.roster_total),roster_live:c(t.roster_live),active_operation_count:c(t.active_operation_count),health:r(t.health),reasons:H(t.reasons),children:Array.isArray(t.children)?t.children.map(dr).filter(n=>n!==null):[]}:null}function lp(t){if(v(t))return{total_units:c(t.total_units),company_count:c(t.company_count),platoon_count:c(t.platoon_count),squad_count:c(t.squad_count),leaf_agent_unit_count:c(t.leaf_agent_unit_count),live_agent_count:c(t.live_agent_count),managed_unit_count:c(t.managed_unit_count),active_operation_count:c(t.active_operation_count)}}function ur(t){const e=v(t)?t:{};return{version:r(e.version),generated_at:r(e.generated_at),source:r(e.source),summary:lp(e.summary),units:Array.isArray(e.units)?e.units.map(dr).filter(n=>n!==null):[]}}function cp(t){if(!v(t))return null;const e=r(t.kind),n=r(t.status);return!e||!n?null:{kind:e,chain_id:r(t.chain_id)??null,goal:r(t.goal)??null,run_id:r(t.run_id)??null,status:n,viewer_path:r(t.viewer_path)??null,last_sync_at:r(t.last_sync_at)??null}}function Zs(t){if(!v(t))return null;const e=r(t.operation_id),n=r(t.objective),s=r(t.assigned_unit_id),a=r(t.trace_id),o=r(t.status);return!e||!n||!s||!a||!o?null:{operation_id:e,objective:n,assigned_unit_id:s,autonomy_level:r(t.autonomy_level),policy_class:r(t.policy_class),budget_class:r(t.budget_class),detachment_session_id:r(t.detachment_session_id)??null,trace_id:a,checkpoint_ref:r(t.checkpoint_ref)??null,active_goal_ids:H(t.active_goal_ids),note:r(t.note)??null,created_by:r(t.created_by),source:r(t.source),status:o,chain:cp(t.chain),created_at:r(t.created_at),updated_at:r(t.updated_at)}}function dp(t){if(!v(t))return null;const e=Zs(t.operation);return e?{operation:e,assigned_unit_label:r(t.assigned_unit_label)}:null}function Ze(t){if(v(t))return{tone:r(t.tone),pending_ops:c(t.pending_ops),blocked_ops:c(t.blocked_ops),in_flight_ops:c(t.in_flight_ops),pipeline_stalls:c(t.pipeline_stalls),bus_traffic:c(t.bus_traffic),l1_hit_rate:c(t.l1_hit_rate),invalidation_count:c(t.invalidation_count),current_pending:c(t.current_pending),current_in_flight:c(t.current_in_flight),cdb_wakeups:c(t.cdb_wakeups),total_stolen:c(t.total_stolen),avg_best_score:c(t.avg_best_score),avg_candidate_count:c(t.avg_candidate_count),best_first_operations:c(t.best_first_operations),active_sessions:c(t.active_sessions),commit_rate:c(t.commit_rate),total_speculations:c(t.total_speculations)}}function up(t){if(!v(t))return;const e=v(t.pipeline)?t.pipeline:void 0,n=v(t.cache)?t.cache:void 0,s=v(t.ooo)?t.ooo:void 0,a=v(t.speculative)?t.speculative:void 0,o=v(t.search_fabric)?t.search_fabric:void 0,l=v(t.signals)?t.signals:void 0;return{pipeline:e?{total_ops:c(e.total_ops),completed_ops:c(e.completed_ops),stalled_cycles:c(e.stalled_cycles),hazards_detected:c(e.hazards_detected),forwarding_used:c(e.forwarding_used),pipeline_flushes:c(e.pipeline_flushes),ipc:c(e.ipc)}:void 0,cache:n?{total_reads:c(n.total_reads),total_writes:c(n.total_writes),l1_hit_rate:c(n.l1_hit_rate),invalidation_count:c(n.invalidation_count),writeback_count:c(n.writeback_count),bus_traffic:c(n.bus_traffic)}:void 0,ooo:s?{agent_count:c(s.agent_count),total_added:c(s.total_added),total_issued:c(s.total_issued),total_completed:c(s.total_completed),total_stolen:c(s.total_stolen),cdb_wakeups:c(s.cdb_wakeups),stall_cycles:c(s.stall_cycles),global_cdb_events:c(s.global_cdb_events),current_pending:c(s.current_pending),current_in_flight:c(s.current_in_flight)}:void 0,speculative:a?{total_speculations:c(a.total_speculations),total_commits:c(a.total_commits),total_aborts:c(a.total_aborts),commit_rate:c(a.commit_rate),total_fast_calls:c(a.total_fast_calls),total_cost_usd:c(a.total_cost_usd),active_sessions:c(a.active_sessions)}:void 0,search_fabric:o?{total_operations:c(o.total_operations),best_first_operations:c(o.best_first_operations),legacy_operations:c(o.legacy_operations),blocked_operations:c(o.blocked_operations),ready_operations:c(o.ready_operations),research_pipeline_operations:c(o.research_pipeline_operations),avg_candidate_count:c(o.avg_candidate_count),avg_best_score:c(o.avg_best_score),top_stage:r(o.top_stage)??null}:void 0,signals:l?{issue_pressure:Ze(l.issue_pressure),cache_contention:Ze(l.cache_contention),scheduler_efficiency:Ze(l.scheduler_efficiency),routing_confidence:Ze(l.routing_confidence),speculative_posture:Ze(l.speculative_posture)}:void 0}}function pr(t){const e=v(t)?t:{},n=v(e.summary)?e.summary:void 0;return{version:r(e.version),generated_at:r(e.generated_at),summary:n?{total:c(n.total),active:c(n.active),paused:c(n.paused),managed:c(n.managed),projected:c(n.projected)}:void 0,microarch:up(e.microarch),operations:Array.isArray(e.operations)?e.operations.map(dp).filter(s=>s!==null):[]}}function mr(t){if(!v(t))return null;const e=r(t.detachment_id),n=r(t.operation_id),s=r(t.assigned_unit_id);return!e||!n||!s?null:{detachment_id:e,operation_id:n,assigned_unit_id:s,leader_id:r(t.leader_id)??null,roster:H(t.roster),session_id:r(t.session_id)??null,checkpoint_ref:r(t.checkpoint_ref)??null,runtime_kind:r(t.runtime_kind)??null,runtime_ref:r(t.runtime_ref)??null,source:r(t.source),status:r(t.status),last_event_at:r(t.last_event_at)??null,last_progress_at:r(t.last_progress_at)??null,heartbeat_deadline:r(t.heartbeat_deadline)??null,created_at:r(t.created_at),updated_at:r(t.updated_at)}}function pp(t){if(!v(t))return null;const e=mr(t.detachment);return e?{detachment:e,assigned_unit_label:r(t.assigned_unit_label),operation:Zs(t.operation)}:null}function vr(t){const e=v(t)?t:{},n=v(e.summary)?e.summary:void 0;return{version:r(e.version),generated_at:r(e.generated_at),summary:n?{total:c(n.total),active:c(n.active),projected:c(n.projected)}:void 0,detachments:Array.isArray(e.detachments)?e.detachments.map(pp).filter(s=>s!==null):[]}}function mp(t){if(!v(t))return null;const e=r(t.decision_id),n=r(t.trace_id),s=r(t.requested_action),a=r(t.scope_type),o=r(t.scope_id);return!e||!n||!s||!a||!o?null:{decision_id:e,trace_id:n,requested_action:s,scope_type:a,scope_id:o,operation_id:r(t.operation_id)??null,target_unit_id:r(t.target_unit_id)??null,requested_by:r(t.requested_by),status:r(t.status),reason:r(t.reason)??null,source:r(t.source),detail:t.detail,created_at:r(t.created_at),decided_at:r(t.decided_at)??null,expires_at:r(t.expires_at)??null}}function _r(t){const e=v(t)?t:{},n=v(e.summary)?e.summary:void 0;return{version:r(e.version),generated_at:r(e.generated_at),summary:n?{total:c(n.total),pending:c(n.pending),approved:c(n.approved),denied:c(n.denied)}:void 0,decisions:Array.isArray(e.decisions)?e.decisions.map(mp).filter(s=>s!==null):[]}}function vp(t){if(!v(t))return null;const e=hi(t.unit);return e?{unit:e,roster_total:c(t.roster_total),roster_live:c(t.roster_live),headcount_cap:c(t.headcount_cap),active_operations:c(t.active_operations),active_operation_cap:c(t.active_operation_cap),utilization:c(t.utilization)}:null}function _p(t){const e=v(t)?t:{};return{version:r(e.version),generated_at:r(e.generated_at),capacity:Array.isArray(e.capacity)?e.capacity.map(vp).filter(n=>n!==null):[]}}function fp(t){if(!v(t))return null;const e=r(t.alert_id);return e?{alert_id:e,severity:r(t.severity),kind:r(t.kind),scope_type:r(t.scope_type),scope_id:r(t.scope_id),title:r(t.title),detail:r(t.detail),timestamp:r(t.timestamp)}:null}function fr(t){const e=v(t)?t:{},n=v(e.summary)?e.summary:void 0;return{version:r(e.version),generated_at:r(e.generated_at),summary:n?{total:c(n.total),bad:c(n.bad),warn:c(n.warn)}:void 0,alerts:Array.isArray(e.alerts)?e.alerts.map(fp).filter(s=>s!==null):[]}}function gr(t){if(!v(t))return null;const e=r(t.event_id),n=r(t.trace_id),s=r(t.event_type);return!e||!n||!s?null:{event_id:e,trace_id:n,event_type:s,operation_id:r(t.operation_id)??null,unit_id:r(t.unit_id)??null,actor:r(t.actor)??null,source:r(t.source),timestamp:r(t.timestamp),detail:t.detail}}function gp(t){const e=v(t)?t:{};return{version:r(e.version),generated_at:r(e.generated_at),events:Array.isArray(e.events)?e.events.map(gr).filter(n=>n!==null):[]}}function $p(t){if(!v(t))return null;const e=r(t.code),n=r(t.severity),s=r(t.summary);return!e||!n||!s?null:{code:e,severity:n,summary:s}}function hp(t){if(!v(t))return null;const e=r(t.lane_id),n=r(t.label),s=r(t.kind),a=r(t.phase),o=r(t.motion_state),l=r(t.source_of_truth),d=r(t.movement_reason),m=r(t.current_step);if(!e||!n||!s||!a||!o||!l||!d||!m)return null;const _=v(t.counts)?t.counts:{};return{lane_id:e,label:n,kind:s,present:q(t.present)??!1,phase:a,motion_state:o,source_of_truth:l,last_movement_at:r(t.last_movement_at)??null,movement_reason:d,current_step:m,blockers:H(t.blockers),counts:{operations:c(_.operations),detachments:c(_.detachments),workers:c(_.workers),approvals:c(_.approvals),alerts:c(_.alerts)},hard_flags:Array.isArray(t.hard_flags)?t.hard_flags.map($p).filter(u=>u!==null):[]}}function yp(t){if(!v(t))return null;const e=r(t.event_id),n=r(t.lane_id),s=r(t.kind),a=r(t.timestamp),o=r(t.title),l=r(t.detail),d=r(t.tone),m=r(t.source);return!e||!n||!s||!a||!o||!l||!d||!m?null:{event_id:e,lane_id:n,kind:s,timestamp:a,title:o,detail:l,tone:d,source:m}}function bp(t){if(!v(t))return null;const e=r(t.code),n=r(t.severity),s=r(t.summary);return!e||!n||!s?null:{code:e,severity:n,summary:s,lane_ids:H(t.lane_ids),count:c(t.count)??0}}function $r(t){if(!v(t))return;const e=v(t.overview)?t.overview:{},n=v(t.gaps)?t.gaps:{},s=v(t.recommended_next_action)?t.recommended_next_action:void 0;return{generated_at:r(t.generated_at),overview:{active_lanes:c(e.active_lanes),moving_lanes:c(e.moving_lanes),stalled_lanes:c(e.stalled_lanes),projected_lanes:c(e.projected_lanes),last_movement_at:r(e.last_movement_at)??null},lanes:Array.isArray(t.lanes)?t.lanes.map(hp).filter(a=>a!==null):[],timeline:Array.isArray(t.timeline)?t.timeline.map(yp).filter(a=>a!==null):[],gaps:{count:c(n.count),items:Array.isArray(n.items)?n.items.map(bp).filter(a=>a!==null):[]},recommended_next_action:s?{tool:r(s.tool)??"masc_operator_snapshot",label:r(s.label)??"Observe operator state",reason:r(s.reason)??"",lane_id:r(s.lane_id)??null}:void 0}}function kp(t){if(!v(t))return;const e=v(t.workers)?t.workers:{},n=q(t.pass);return{status:r(t.status)??"missing",source:r(t.source)??"none",run_id:r(t.run_id)??null,captured_at:r(t.captured_at)??null,...n!==void 0?{pass:n}:{},...c(t.peak_hot_slots)!=null?{peak_hot_slots:c(t.peak_hot_slots)}:{},...c(t.ctx_per_slot)!=null?{ctx_per_slot:c(t.ctx_per_slot)}:{},workers:{expected:c(e.expected),joined:c(e.joined),current_task_bound:c(e.current_task_bound),fresh_heartbeats:c(e.fresh_heartbeats),done:c(e.done),final:c(e.final)},artifact_ref:r(t.artifact_ref)??null,missing_reason:r(t.missing_reason)??null}}function xp(t){const e=v(t)?t:{};return{version:r(e.version),generated_at:r(e.generated_at),topology:ur(e.topology),operations:pr(e.operations),detachments:vr(e.detachments),alerts:fr(e.alerts),decisions:_r(e.decisions),capacity:_p(e.capacity),traces:gp(e.traces),swarm_status:$r(e.swarm_status)}}function Sp(t){const e=v(t)?t:{},n=ur(e.topology),s=pr(e.operations),a=vr(e.detachments),o=fr(e.alerts),l=_r(e.decisions);return{version:r(e.version),generated_at:r(e.generated_at),topology:{version:n.version,generated_at:n.generated_at,source:n.source,summary:n.summary},operations:{version:s.version,generated_at:s.generated_at,summary:s.summary,microarch:s.microarch},detachments:{version:a.version,generated_at:a.generated_at,summary:a.summary},alerts:{version:o.version,generated_at:o.generated_at,summary:o.summary},decisions:{version:l.version,generated_at:l.generated_at,summary:l.summary},swarm_status:$r(e.swarm_status),swarm_proof:kp(e.swarm_proof)}}function Ap(t){return v(t)?{chain_id:r(t.chain_id)??null,started_at:c(t.started_at)??null,progress:c(t.progress)??null,elapsed_sec:c(t.elapsed_sec)??null}:null}function hr(t){if(!v(t))return null;const e=r(t.event);return e?{event:e,chain_id:r(t.chain_id)??null,timestamp:r(t.timestamp)??null,duration_ms:c(t.duration_ms)??null,message:r(t.message)??null,tokens:c(t.tokens)??null}:null}function Cp(t){if(!v(t))return null;const e=Zs(t.operation);return e?{operation:e,runtime:Ap(t.runtime),history:hr(t.history),mermaid:r(t.mermaid)??null,preview_run:yr(t.preview_run)}:null}function wp(t){const e=v(t)?t:{};return{status:r(e.status)??"disconnected",base_url:r(e.base_url)??null,message:r(e.message)??null}}function Tp(t){const e=v(t)?t:{},n=v(e.summary)?e.summary:void 0;return{version:r(e.version),generated_at:r(e.generated_at),connection:wp(e.connection),summary:n?{linked_operations:c(n.linked_operations),active_chains:c(n.active_chains),running_operations:c(n.running_operations),recent_failures:c(n.recent_failures),last_history_event_at:r(n.last_history_event_at)??null}:void 0,operations:Array.isArray(e.operations)?e.operations.map(Cp).filter(s=>s!==null):[],recent_history:Array.isArray(e.recent_history)?e.recent_history.map(hr).filter(s=>s!==null):[]}}function Ip(t){if(!v(t))return null;const e=r(t.id);return e?{id:e,type:r(t.type),status:r(t.status),duration_ms:c(t.duration_ms)??null,error:r(t.error)??null}:null}function yr(t){if(!v(t))return null;const e=r(t.run_id),n=r(t.chain_id);return n?{run_id:e??null,chain_id:n,duration_ms:c(t.duration_ms),success:q(t.success),mermaid:r(t.mermaid),nodes:Array.isArray(t.nodes)?t.nodes.map(Ip).filter(s=>s!==null):[]}:null}function Rp(t){const e=v(t)?t:{};return{run:yr(e.run)}}function Pp(t){if(!v(t))return null;const e=r(t.title),n=r(t.path);return!e||!n?null:{title:e,path:n}}function Np(t){if(!v(t))return null;const e=r(t.id),n=r(t.title),s=r(t.summary);return!e||!n||!s?null:{id:e,title:n,summary:s}}function Lp(t){if(!v(t))return null;const e=r(t.id),n=r(t.title),s=r(t.tool),a=r(t.summary);return!e||!n||!s||!a?null:{id:e,title:n,tool:s,summary:a,success_signals:H(t.success_signals),pitfalls:H(t.pitfalls)}}function Mp(t){if(!v(t))return null;const e=r(t.id),n=r(t.title),s=r(t.summary),a=r(t.when_to_use);return!e||!n||!s||!a?null:{id:e,title:n,summary:s,when_to_use:a,steps:Array.isArray(t.steps)?t.steps.map(Lp).filter(o=>o!==null):[]}}function Dp(t){if(!v(t))return null;const e=r(t.id),n=r(t.title),s=r(t.description);return!e||!n||!s?null:{id:e,title:n,description:s,tools:H(t.tools)}}function zp(t){if(!v(t))return null;const e=r(t.id),n=r(t.title),s=r(t.symptom),a=r(t.why),o=r(t.fix_tool),l=r(t.fix_summary);return!e||!n||!s||!a||!o||!l?null:{id:e,title:n,symptom:s,why:a,fix_tool:o,fix_summary:l}}function Ep(t){if(!v(t))return null;const e=r(t.id),n=r(t.title),s=r(t.path_id),a=r(t.transport);return!e||!n||!s||!a?null:{id:e,title:n,path_id:s,transport:a,request:t.request,response:t.response,notes:H(t.notes)}}function jp(t){const e=v(t)?t:{};return{version:r(e.version),generated_at:r(e.generated_at),docs:Array.isArray(e.docs)?e.docs.map(Pp).filter(n=>n!==null):[],concepts:Array.isArray(e.concepts)?e.concepts.map(Np).filter(n=>n!==null):[],golden_paths:Array.isArray(e.golden_paths)?e.golden_paths.map(Mp).filter(n=>n!==null):[],tool_groups:Array.isArray(e.tool_groups)?e.tool_groups.map(Dp).filter(n=>n!==null):[],pitfalls:Array.isArray(e.pitfalls)?e.pitfalls.map(zp).filter(n=>n!==null):[],examples:Array.isArray(e.examples)?e.examples.map(Ep).filter(n=>n!==null):[]}}function Op(t){if(!v(t))return null;const e=r(t.id),n=r(t.title),s=r(t.status),a=r(t.detail),o=r(t.next_tool);return!e||!n||!s||!a||!o?null:{id:e,title:n,status:s,detail:a,next_tool:o}}function Fp(t){if(!v(t))return null;const e=r(t.code),n=r(t.severity),s=r(t.title),a=r(t.detail),o=r(t.next_tool);return!e||!n||!s||!a||!o?null:{code:e,severity:n,title:s,detail:a,next_tool:o}}function qp(t){if(!v(t))return null;const e=r(t.from),n=r(t.content),s=r(t.timestamp),a=c(t.seq);return!e||!n||!s||a==null?null:{seq:a,from:e,content:n,timestamp:s}}function Kp(t){if(!v(t))return null;const e=r(t.name),n=r(t.role),s=r(t.lane),a=r(t.status),o=r(t.claim_marker),l=r(t.done_marker),d=r(t.final_marker);if(!e||!n||!s||!a||!o||!l||!d)return null;const m=(()=>{if(!v(t.last_message))return null;const _=c(t.last_message.seq),u=r(t.last_message.content),p=r(t.last_message.timestamp);return _==null||!u||!p?null:{seq:_,content:u,timestamp:p}})();return{name:e,role:n,lane:s,joined:q(t.joined)??!1,live_presence:q(t.live_presence)??!1,completed:q(t.completed)??!1,status:a,current_task:r(t.current_task)??null,bound_task_id:r(t.bound_task_id)??null,bound_task_title:r(t.bound_task_title)??null,bound_task_status:r(t.bound_task_status)??null,current_task_matches_run:q(t.current_task_matches_run)??!1,squad_member:q(t.squad_member)??!1,detachment_member:q(t.detachment_member)??!1,last_seen:r(t.last_seen)??null,heartbeat_age_sec:c(t.heartbeat_age_sec)??null,heartbeat_fresh:q(t.heartbeat_fresh)??!1,claim_marker_seen:q(t.claim_marker_seen)??!1,done_marker_seen:q(t.done_marker_seen)??!1,final_marker_seen:q(t.final_marker_seen)??!1,claim_marker:o,done_marker:l,final_marker:d,last_message:m}}function Up(t){if(!v(t))return;const e=Array.isArray(t.timeline)?t.timeline.map(n=>{if(!v(n))return null;const s=r(n.timestamp),a=c(n.active_slots);if(!s||a==null)return null;const o=Array.isArray(n.active_slot_ids)?n.active_slot_ids.map(l=>typeof l=="number"&&Number.isFinite(l)?l:null).filter(l=>l!=null):[];return{timestamp:s,active_slots:a,active_slot_ids:o}}).filter(n=>n!==null):[];return{slot_url:r(t.slot_url)??null,provider_base_url:r(t.provider_base_url)??null,provider_reachable:q(t.provider_reachable)??null,provider_status_code:c(t.provider_status_code)??null,provider_model_id:r(t.provider_model_id)??null,actual_model_id:r(t.actual_model_id)??null,expected_slots:c(t.expected_slots),actual_slots:c(t.actual_slots),expected_ctx:c(t.expected_ctx),actual_ctx:c(t.actual_ctx),slot_reachable:q(t.slot_reachable)??null,slot_status_code:c(t.slot_status_code)??null,runtime_blocker:r(t.runtime_blocker)??null,detail:r(t.detail)??null,checked_at:r(t.checked_at)??null,total_slots:c(t.total_slots),ctx_per_slot:c(t.ctx_per_slot),active_slots_now:c(t.active_slots_now),peak_active_slots:c(t.peak_active_slots),sample_count:c(t.sample_count),last_sample_at:r(t.last_sample_at)??null,timeline:e}}function Hp(t){const e=v(t)?t:{},n=v(e.summary)?e.summary:void 0;return{version:r(e.version),generated_at:r(e.generated_at),run_id:r(e.run_id),room_id:r(e.room_id),operation_id:r(e.operation_id)??null,recommended_next_tool:r(e.recommended_next_tool),summary:n?{expected_workers:c(n.expected_workers),joined_workers:c(n.joined_workers),live_workers:c(n.live_workers),squad_roster_size:c(n.squad_roster_size),detachment_roster_size:c(n.detachment_roster_size),current_task_bound:c(n.current_task_bound),fresh_heartbeats:c(n.fresh_heartbeats),claim_markers_seen:c(n.claim_markers_seen),done_markers_seen:c(n.done_markers_seen),final_markers_seen:c(n.final_markers_seen),completed_workers:c(n.completed_workers),peak_hot_slots:c(n.peak_hot_slots),hot_window_ok:q(n.hot_window_ok),pass_hot_concurrency:q(n.pass_hot_concurrency),pass_end_to_end:q(n.pass_end_to_end),pending_decisions:c(n.pending_decisions),pass:q(n.pass)}:void 0,provider:Up(e.provider),operation:Zs(e.operation),squad:hi(e.squad),detachment:mr(e.detachment),workers:Array.isArray(e.workers)?e.workers.map(Kp).filter(s=>s!==null):[],checklist:Array.isArray(e.checklist)?e.checklist.map(Op).filter(s=>s!==null):[],blockers:Array.isArray(e.blockers)?e.blockers.map(Fp).filter(s=>s!==null):[],recent_messages:Array.isArray(e.recent_messages)?e.recent_messages.map(qp).filter(s=>s!==null):[],recent_trace_events:Array.isArray(e.recent_trace_events)?e.recent_trace_events.map(gr).filter(s=>s!==null):[],truth_notes:H(e.truth_notes)}}function ve(t){U.value=t,$i(t)&&Wp()}async function br(){Ts.value=!0,Rs.value=null;try{const t=await Ml();gi.value=Sp(t)}catch(t){Rs.value=t instanceof Error?t.message:"Failed to load command-plane summary"}finally{Ts.value=!1}}function yi(t){De.value=t}async function bi(){Is.value=!0,Ps.value=null;try{const t=await Ll();Dt.value=xp(t)}catch(t){Ps.value=t instanceof Error?t.message:"Failed to load command-plane snapshot"}finally{Is.value=!1}}async function Wp(){Dt.value||Is.value||await bi()}async function Vt(){await br(),$i(U.value)&&await bi()}async function Yt(){var t;Va.value=!0,zs.value=null;try{const e=await Dl(),n=Tp(e);Fn.value=n;const s=De.value;n.operations.length===0?De.value=null:(!s||!n.operations.some(a=>a.operation.operation_id===s))&&(De.value=((t=n.operations[0])==null?void 0:t.operation.operation_id)??null)}catch(e){zs.value=e instanceof Error?e.message:"Failed to load chain summary"}finally{Va.value=!1}}function Bp(){nn=null,An.value=null,Es.value=!1,Cn.value=null}async function Gp(t){nn=t,Es.value=!0,Cn.value=null;try{const e=await zl(t);if(nn!==t)return;An.value=Rp(e)}catch(e){if(nn!==t)return;An.value=null,Cn.value=e instanceof Error?e.message:"Failed to load chain run"}finally{nn===t&&(Es.value=!1)}}async function Jp(){Ja.value=!0,Ls.value=null;try{const t=await El();On.value=jp(t)}catch(t){Ls.value=t instanceof Error?t.message:"Failed to load command-plane help"}finally{Ja.value=!1}}async function wt(t=ap(),e=ip()){Ms.value=!0,Ds.value=null;try{const n=await jl(t,e);ge.value=Hp(n)}catch(n){Ds.value=n instanceof Error?n.message:"Failed to load command-plane swarm view"}finally{Ms.value=!1}}async function se(t,e,n){Ga.value=t,Ns.value=null;try{await Ol(e,n),await br(),(Dt.value||$i(U.value))&&await bi(),await wt(),await Yt()}catch(s){throw Ns.value=s instanceof Error?s.message:"Failed to execute command-plane action",s}finally{Ga.value=null}}function Vp(t){return se(`pause:${t}`,"/api/v1/command-plane/operations/pause",{operation_id:t})}function Yp(t){return se(`resume:${t}`,"/api/v1/command-plane/operations/resume",{operation_id:t})}function Qp(t){return se(`recall:${t}`,"/api/v1/command-plane/dispatch/recall",{operation_id:t})}function Xp(t={}){return se("dispatch:tick","/api/v1/command-plane/dispatch/tick",{...t.operationId?{operation_id:t.operationId}:{},...t.detachmentId?{detachment_id:t.detachmentId}:{}})}function Zp(t){return se(`approve:${t}`,"/api/v1/command-plane/policy/approve",{decision_id:t})}function tm(t){return se(`deny:${t}`,"/api/v1/command-plane/policy/deny",{decision_id:t})}function em(t,e){return se(`freeze:${t}`,"/api/v1/command-plane/policy/freeze",{unit_id:t,enabled:e})}function nm(t,e){return se(`kill:${t}`,"/api/v1/command-plane/policy/kill-switch",{unit_id:t,enabled:e})}md(()=>{Vt(),Yt(),(U.value==="swarm"||U.value==="warroom"||ge.value!==null)&&wt(),U.value==="warroom"&&st()});const sm="modulepreload",am=function(t){return"/dashboard/"+t},Bi={},im=function(e,n,s){let a=Promise.resolve();if(n&&n.length>0){let l=function(_){return Promise.all(_.map(u=>Promise.resolve(u).then(p=>({status:"fulfilled",value:p}),p=>({status:"rejected",reason:p}))))};document.getElementsByTagName("link");const d=document.querySelector("meta[property=csp-nonce]"),m=(d==null?void 0:d.nonce)||(d==null?void 0:d.getAttribute("nonce"));a=l(n.map(_=>{if(_=am(_),_ in Bi)return;Bi[_]=!0;const u=_.endsWith(".css"),p=u?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${_}"]${p}`))return;const f=document.createElement("link");if(f.rel=u?"stylesheet":sm,u||(f.as="script"),f.crossOrigin="",f.href=_,m&&f.setAttribute("nonce",m),document.head.appendChild(f),u)return new Promise((h,S)=>{f.addEventListener("load",h),f.addEventListener("error",()=>S(new Error(`Unable to preload CSS for ${_}`)))})}))}function o(l){const d=new Event("vite:preloadError",{cancelable:!0});if(d.payload=l,window.dispatchEvent(d),!d.defaultPrevented)throw l}return a.then(l=>{for(const d of l||[])d.status==="rejected"&&o(d.reason);return e().catch(o)})};function kr(t){if(t==null)return"";if(typeof t=="string")return t;try{return JSON.stringify(t,null,2)}catch{return String(t)}}function V(t){if(!t)return"n/a";const e=Date.parse(t);if(Number.isNaN(e))return t;const n=Math.max(0,Math.round((Date.now()-e)/1e3));return n<60?`${n}s ago`:n<3600?`${Math.round(n/60)}m ago`:n<86400?`${Math.round(n/3600)}h ago`:`${Math.round(n/86400)}d ago`}function om(t){if(!t)return"warn";const e=Date.parse(t);return Number.isNaN(e)?"warn":e<=Date.now()?"bad":"ok"}function xr(t){if(!t)return"n/a";const e=Date.parse(t);if(Number.isNaN(e))return t;const n=Math.round((e-Date.now())/1e3);return n<=0?"expired":n<60?`in ${n}s`:n<3600?`in ${Math.round(n/60)}m`:n<86400?`in ${Math.round(n/3600)}h`:`in ${Math.round(n/86400)}d`}function L(t){return t==="bad"?"bad":t==="warn"||t==="pending"?"warn":"ok"}let Gi=!1,rm=0;function lm(){return++rm}let ra=null;async function cm(){ra||(ra=im(()=>import("./mermaid.core-BCvkujfZ.js").then(e=>e.bE),[]).then(e=>e.default));const t=await ra;return Gi||(t.initialize({startOnLoad:!1,theme:"dark",securityLevel:"loose"}),Gi=!0),t}function Qt(t){if(!t)return"warn";const e=t.toLowerCase();return e.includes("failed")||e.includes("error")||e.includes("disconnected")||e.includes("stopped")?"bad":e.includes("running")||e.includes("active")||e.includes("degraded")||e.includes("pending")?"warn":"ok"}function qn(t){return typeof t!="number"||!Number.isFinite(t)?"n/a":`${Math.round(t*100)}%`}function sn(t){return typeof t!="number"||!Number.isFinite(t)?"n/a":t<60?`${Math.round(t)}s`:t<3600?`${Math.round(t/60)}m`:`${Math.round(t/3600)}h`}function Kn(t){return typeof t!="number"||!Number.isFinite(t)?0:Math.max(0,Math.min(100,t))}function ce(t,e){return typeof t!="number"||!Number.isFinite(t)||typeof e!="number"||!Number.isFinite(e)||e<=0?0:Kn(t/e*100)}function dm(t,e){const n=Kn(t);return`--gauge-angle:${Math.max(10,Math.round(n/100*360))}deg;--gauge-color:${e};`}function Sr(t){if(!t)return"No recent chain history";const e=[t.event];return typeof t.duration_ms=="number"&&e.push(`${t.duration_ms}ms`),typeof t.tokens=="number"&&e.push(`${t.tokens} tokens`),t.message&&e.push(t.message),e.join(" · ")}const um=[{id:"status",label:"현황"},{id:"history",label:"이력"},{id:"control",label:"통제"}],Ar=[{id:"warroom",label:"워룸",group:"status"},{id:"summary",label:"요약",group:"status"},{id:"topology",label:"토폴로지",group:"status"},{id:"swarm",label:"스웜",group:"status"},{id:"operations",label:"작전",group:"history"},{id:"trace",label:"트레이스",group:"history"},{id:"chains",label:"체인",group:"history"},{id:"control",label:"제어",group:"control"},{id:"alerts",label:"알림",group:"control"}],pm=Ar.map(t=>t.id),mm=["chain_start","node_start","node_complete","chain_complete","chain_error"],vm={warroom:{title:"라이브 워룸",description:"실제 run, worker, message, trace를 한 화면에서 따라가는 기본 진입 표면입니다."},operations:{title:"현재 작전 상세",description:"활성 operation, detachment, dependency를 먼저 읽는 기본 진입 표면입니다."},swarm:{title:"스웜 실행 흐름",description:"lane 이동, worker 결속, blocker를 따라가며 현장감 있게 보는 표면입니다."},chains:{title:"체인 런타임",description:"체인 연결 상태와 operation별 실행 그래프를 확인하는 표면입니다."},topology:{title:"지휘 계층",description:"company에서 agent까지 지휘 계층과 live roster를 확인합니다."},alerts:{title:"경보 모음",description:"지금 개입을 밀어올리는 alert만 모아서 보는 표면입니다."},trace:{title:"최근 트레이스",description:"operation, actor, unit 단위 이벤트를 시간순으로 보는 표면입니다."},control:{title:"승인과 제어",description:"decision 승인과 unit 제어를 실제로 수행하는 표면입니다."},summary:{title:"지휘 요약",description:"전체 지휘면을 한 번에 훑는 계기판 성격의 요약 표면입니다."}};function Ji(t){return!!t&&pm.includes(t)}function _m(){const t=E.value.params;return t.source!=="mission"?{}:{source:"mission",...t.action_type?{action_type:t.action_type}:{},...t.target_type?{target_type:t.target_type}:{},...t.target_id?{target_id:t.target_id}:{},...t.focus_kind?{focus_kind:t.focus_kind}:{}}}function Cr(t){const e=_m();if(t==="operations")return e;if(t==="chains"){const n=De.value;return n?{...e,surface:t,operation:n}:{...e,surface:t}}return{...e,surface:t}}function fm(){const t=new URLSearchParams(window.location.search),e=new URLSearchParams,n=t.get("agent")??t.get("agent_name"),s=t.get("token");return n&&e.set("agent",n),s&&e.set("token",s),e.toString()?`/api/v1/chains/events?${e.toString()}`:"/api/v1/chains/events"}function gm(t){switch(t){case"company":return"중대 / Company";case"platoon":return"소대 / Platoon";case"squad":return"분대 / Squad";case"agent":return"에이전트 / Agent";default:return t}}function at(t){return Ga.value===t}function Un(){return gi.value}function $m(t){var a,o,l,d,m,_,u;const e=gi.value,n=ge.value,s=Fn.value;switch(t){case"warroom":return{tool:"masc_observe_operations",reason:"live run, worker, message, trace를 한 화면에서 보고 필요한 detail 표면으로 바로 점프합니다."};case"operations":return{tool:"masc_operation_status",reason:`활성 작전 ${((a=e==null?void 0:e.operations.summary)==null?void 0:a.active)??0}개와 dependency를 먼저 확인합니다.`};case"swarm":return{tool:(n==null?void 0:n.recommended_next_tool)??((l=(o=e==null?void 0:e.swarm_status)==null?void 0:o.recommended_next_action)==null?void 0:l.tool)??"masc_observe_traces",reason:((m=(d=e==null?void 0:e.swarm_status)==null?void 0:d.recommended_next_action)==null?void 0:m.reason)??"lane 이동과 blocker를 보고 다음 probe 도구를 고릅니다."};case"chains":return{tool:(u=(_=s==null?void 0:s.operations[0])==null?void 0:_.preview_run)!=null&&u.chain_id?"masc_chain_run_get":"masc_chain_snapshot",reason:"체인 연결 상태와 최근 run 그래프를 함께 보면 병목을 빨리 좁힐 수 있습니다."};case"topology":return{tool:"masc_observe_topology",reason:"지휘 계층과 live roster를 같이 봐야 빈 squad나 고립 unit을 놓치지 않습니다."};case"alerts":return{tool:"masc_observe_alerts",reason:"경보에서 먼저 문제가 된 unit과 operation을 고릅니다."};case"trace":return{tool:"masc_observe_traces",reason:"trace 흐름으로 원인 이벤트를 바로 따라갈 수 있습니다."};case"control":return{tool:"masc_operator_action",reason:"승인이나 kill switch 같은 실제 조작은 control 표면과 operator action이 이어집니다."};case"summary":default:return{tool:"masc_observe_operations",reason:"요약을 본 뒤에는 현재 작전 표면으로 내려가 실제 움직임을 확인하는 게 가장 빠릅니다."}}}function hm(t){var n;const e=((n=t==null?void 0:t.focus_kind)==null?void 0:n.toLowerCase())??"";return e?e.includes("artifact_scope")||e.includes("routing_confidence")||e.includes("cache_contention")?"microarch":e.includes("leader_offline")||e.includes("roster_offline")?"alerts":e.includes("stale_data")?"swarm":null:null}function ym(t){var n;const e=((n=t==null?void 0:t.focus_kind)==null?void 0:n.toLowerCase())??"";return e?e.includes("stale_data")||e.includes("leader_offline")||e.includes("roster_offline")||e.includes("managed")?"recommendation":e.includes("gap")?"gaps":null:null}function bm(){if(typeof window>"u")return null;const t=new URLSearchParams(window.location.search),e=t.get("agent")??t.get("agent_name");if(!e)return null;const n=e.trim();return n===""?null:n}function wr(){if(typeof window>"u")return new URLSearchParams;const t=new URLSearchParams(window.location.search),e=window.location.hash.replace(/^#/,""),n=e.indexOf("?");return n>=0&&new URLSearchParams(e.slice(n+1)).forEach((a,o)=>{t.has(o)||t.set(o,a)}),t}function km(){const e=wr().get("run_id");if(!e)return null;const n=e.trim();return n===""?null:n}function Tr(){const e=wr().get("operation_id");if(!e)return null;const n=e.trim();return n===""?null:n}function xm(t){if(!t)return null;const e=Date.parse(t);return Number.isNaN(e)?null:Math.max(0,Math.round((Date.now()-e)/1e3))}function Sm(t){return t.status==="claimed"||t.status==="in_progress"}function Am(t){const e=On.value;if(!e)return null;for(const n of e.golden_paths){const s=n.steps.find(a=>a.tool===t);if(s)return s}return null}function la(t){var e;return((e=On.value)==null?void 0:e.golden_paths.find(n=>n.id===t))??null}function Cm(t){const e=On.value;if(!e)return[];const n=new Set(t);return e.pitfalls.filter(s=>n.has(s.id))}async function Xt(t){try{await t()}catch{}}function ki(t){return(t==null?void 0:t.trim().toLowerCase())??""}function we(t){const e=ki(t);return e.includes("failed")||e.includes("error")||e.includes("stopped")||e==="paused"?"bad":e.includes("active")||e.includes("running")||e.includes("healthy")||e.includes("ok")?"ok":"warn"}function ca(t){const e=ki(t);return e?e==="active"||e==="running"?"진행 중":e==="paused"?"일시정지":e==="done"||e==="ended"||e==="completed"?"완료":e==="failed"||e==="error"||e==="stopped"?"문제":(t==null?void 0:t.trim())||"확인 필요":"확인 필요"}function wm(){var e,n,s;const t=ge.value;return t?!!(t.run_id||(e=t.operation)!=null&&e.operation_id||(n=t.detachment)!=null&&n.detachment_id||(((s=t.summary)==null?void 0:s.expected_workers)??0)>0||t.workers.length>0||t.recent_messages.length>0||t.recent_trace_events.length>0):!1}function Tm(t){const e=ki(t.status);return e==="active"||e==="running"}function Im(){var o,l,d,m;const t=((o=Nt.value)==null?void 0:o.sessions)??[],e=ge.value,n=((l=e==null?void 0:e.detachment)==null?void 0:l.session_id)??null;if(n){const _=t.find(u=>u.session_id===n);if(_)return _}const s=((d=e==null?void 0:e.operation)==null?void 0:d.operation_id)??Tr();if(s){const _=t.find(u=>u.command_plane_operation_id===s);if(_)return _}const a=((m=e==null?void 0:e.detachment)==null?void 0:m.detachment_id)??null;if(a){const _=t.find(u=>u.command_plane_detachment_id===a);if(_)return _}return t.find(Tm)??t[0]??null}function Rm(){const t=jn(E.value);return t?i`
  ...
  `:null}function Pm(){const t=U.value,e=vm[t],n=$m(t);return i`
  ...
  `}function Yn({label:t,value:e,subtext:n,percent:s,color:a}){return i`
    <article class="command-gauge-card">
      <div class="command-gauge-ring" style=${dm(s,a)}>
  ...
  `}function Nm(){var O,Y,K,Z;const t=Un(),e=t==null?void 0:t.topology.summary,n=t==null?void 0:t.operations.summary,s=t==null?void 0:t.detachments.summary,a=t==null?void 0:t.decisions.summary,o=t==null?void 0:t.alerts.summary,l=(O=t==null?void 0:t.swarm_status)==null?void 0:O.overview,d=t==null?void 0:t.swarm_proof,m=t==null?void 0:t.operations.microarch,_=(e==null?void 0:e.managed_unit_count)??0,u=(e==null?void 0:e.total_units)??0,p=(n==null?void 0:n.active)??0,f=(s==null?void 0:s.active)??0,h=(l==null?void 0:l.moving_lanes)??0,S=(l==null?void 0:l.active_lanes)??0,A=(d==null?void 0:d.workers.done)??0,C=(d==null?void 0:d.workers.expected)??0,T=(o==null?void 0:o.bad)??0,w=(o==null?void 0:o.warn)??0,P=(a==null?void 0:a.pending)??0,k=(a==null?void 0:a.total)??0,R=p+f,G=((Y=m==null?void 0:m.cache)==null?void 0:Y.l1_hit_rate)??((Z=(K=m==null?void 0:m.signals)==null?void 0:K.cache_contention)==null?void 0:Z.l1_hit_rate)??0,W=p>0||f>0?"지휘면이 실제로 움직이고 있습니다":"계층은 준비됐지만 실행은 아직 잠복 상태입니다",$=p>0||h>0?"무거운 상세 탭으로 들어가기 전에, 여기서 먼저 압력과 이동감, 운영 부채를 읽을 수 있어야 합니다.":"이 화면은 체크리스트보다 계기판에 가까워야 합니다. 아래 게이지가 지금 어디가 살아 있는지 먼저 보여줍니다.";return i`
    <section class="command-hero command-hero-summary">
      <div class="command-hero-copy">
        ...
        <span class="command-chip ${L(p>0?"ok":"warn")}">활성 작전 ${p}</span>
          ...
          <span class="command-chip ${L(P>0?"warn":"ok")}">승인 대기 ${P}</span>
        </div>
      </div>
    ...
    <div class="command-signal-grid">
      <${Qn}
        label="승인 대기열"
        value=${`${P}건 대기`}
        detail=${`현재 정책 창에서 ${k}개 결정을 추적 중입니다`}
        percent=${ce(P,Math.max(k,P||1))}
        tone=${P>0?"warn":"ok"}
      />
      <${Qn}
        label="알림 압력"
  ...
  `}function Lm(){var f,h,S,A,C;const t=Un(),e=Fn.value,n=jn(E.value),s=hm(n),a=t==null?void 0:t.topology.summary,o=t==null?void 0:t.operations.summary,l=(f=t==null?void 0:t.swarm_status)==null?void 0:f.overview,d=t==null?void 0:t.operations.microarch,m=t==null?void 0:t.decisions.summary,_=t==null?void 0:t.alerts.summary,u=(h=d==null?void 0:d.signals)==null?void 0:h.issue_pressure,p=d==null?void 0:d.cache;return i`
    ...
    <div class="command-guided-layout">
      ...
      <section class="card command-section">
        ...
        ${Ja.value?i`<div class="empty-state">CPv2 runbook 불러오는 중…</div>`:Ls.value?i`<div class="empty-state error">${Ls.value}</div>`:i`
                ...
                ${W.length>0?i`<div class="command-doc-links">
                      ${W.map(z=>i`<span class="command-tag">${z.title}: ${z.path}</span>`)}
                    </div>`:null}
              `}
      </section>
    </div>
  ...
  `}function jm(){const t=Dt.value;return i`
    <section class="card command-section">
      <div class="card-title-row">
  ...
  `}function Om(){const t=Dt.value;return i`
    <section class="card command-section">
      <div class="card-title-row">
  ...
  `}function qm({total:t}){const n=Math.min(t,20),s=t>20?t-20:0,a=Array.from({length:n});return i`
  ...
  `}function Km({lane:t}){const e=t.counts??{},n=Rr(t),s=e.workers??0,a=e.operations??0,o=e.detachments??0,l=a+o,d=t.motion_state==="moving"?84:t.motion_state==="waiting"?58:t.motion_state==="terminal"?100:26;return i`
  ...
  `}function Um({event:t}){const e=t.timestamp?new Date(t.timestamp):null,n=e&&!isNaN(e.getTime())?e:null,s=n?`${String(n.getHours()).padStart(2,"0")}:${String(n.getMinutes()).padStart(2,"0")}`:"";return i`
  ...
  `}function Wm({proof:t}){const e=(t==null?void 0:t.status)==="missing"?"warn":(t==null?void 0:t.pass)===!1?"bad":(t==null?void 0:t.pass)===!0?"ok":"warn";return i`
  ...
  `}function Bm(){const t=Un(),e=jn(E.value),n=ym(e),s=t==null?void 0:t.swarm_status,a=t==null?void 0:t.swarm_proof,o=(s==null?void 0:s.lanes.filter(p=>p.present))??[],l=(s==null?void 0:s.gaps.items)??[],d=(s==null?void 0:s.timeline.slice(0,8))??[],m=s==null?void 0:s.overview,_=s==null?void 0:s.recommended_next_action,u=o.length<=1;return i`
    <section class="card command-section">
      <div class="card-title-row">
      ...
      ${s?i`
            ...
            <div class="command-swarm-layout ${u?"compact":""}">
              <div class="command-card-stack">
                ${o.length>0?o.map(p=>i`<${Km} lane=${p} />`):i`<div class="empty-state">활성 스웜 레인이 없습니다.</div>`}
              </div>
              ...
              <div class="command-card-stack">
                ...
                <div class="command-guide-card ${l.length>0?"warn":"ok"} ${n==="gaps"?"focus":""}">
                  ...
                  ${l.length>0?i`<div class="swarm-event-rail">${l.slice(0,4).map(p=>i`<${Hm} gap=${p} />`)}</div>`:i`<p>지금 보이는 핵심 공백은 없습니다.</p>`}
                </div>
                ...
                <div class="command-guide-card">
                  ...
                  ${d.length>0?i`<div class="swarm-event-rail">${d.map(p=>i`<${Um} event=${p} />`)}</div>`:i`<p>붙어 있는 최근 이동 이벤트가 아직 없습니다.</p>`}
                </div>
              </div>
            </div>
          `:i`<div class="empty-state">스웜 상태를 아직 불러오지 못했습니다.</div>`}
    </section>
  `}function Gm({item:t}){return i`
  ...
  `}function Vm(){var m,_,u,p,f,h,S,A,C,T,w,P,k,R,G,W,$,O,Y,K,Z;const t=ge.value,e=km(),n=Tr(),s=(m=t==null?void 0:t.provider)!=null&&m.runtime_blocker?"blocked":(_=t==null?void 0:t.provider)!=null&&_.provider_reachable?"ready":"check",a=((u=t==null?void 0:t.provider)==null?void 0:u.actual_slots)??((p=t==null?void 0:t.provider)==null?void 0:p.total_slots)??0,o=((f=t==null?void 0:t.provider)==null?void 0:f.expected_slots)??"n/a",l=((h=t==null?void 0:t.provider)==null?void 0:h.actual_ctx)??((S=t==null?void 0:t.provider)==null?void 0:S.ctx_per_slot)??0,d=((A=t==null?void 0:t.provider)==null?void 0:A.expected_ctx)??"n/a";return i`
        ...
        <section class="card command-section">
          ...
          ${Ms.value?i`<div class="empty-state">Loading swarm live state…</div>`:Ds.value?i`<div class="empty-state error">${Ds.value}</div>`:t?i`
                    <div class="command-summary-grid">
                      ...
                      <div class="monitor-stat-card"><span>워커</span><strong>${((C=t.summary)==null?void 0:C.joined_workers)??0}/${((T=t.summary)==null?void 0:T.expected_workers)??0}</strong><small>${((w=t.summary)==null?void 0:w.live_workers)??0}개 가동 · ${((P=t.summary)==null?void 0:P.completed_workers)??0}개 완료</small></div>
                      <div class="monitor-stat-card"><span>런타임</span><strong>${s}</strong><small>slots ${a}/${o} · ctx ${l}/${d}</small></div>
                      <div class="monitor-stat-card"><span>고동시성</span><strong>${(k=t.summary)!=null&&k.pass_hot_concurrency?"통과":"확인 필요"}</strong><small>${((R=t.provider)==null?void 0:R.slot_url)??"slot 정보 없음"}</small></div>
                    ...
                    <div class="command-card-grid">
                      <span>작전</span><span>${((W=t.operation)==null?void 0:W.operation_id)??n??"없음"}</span>
  ...
  `}function Wt({label:t,surface:e,params:n={}}){return i`
    <button
  ...
  `}function Zm(){var W,$,O,Y,K,Z,x,bt,Ut,ae,ie,z,kt,oe,Ve,Ye,Hn,Wn,Bn,Gn;const t=Un(),e=ge.value,n=Nt.value,s=Lt.value,a=Im(),o=e!=null&&e.operation?((W=Fn.value)==null?void 0:W.operations.find(F=>{var he;return F.operation.operation_id===((he=e.operation)==null?void 0:he.operation_id)}))??null:null,l=(e==null?void 0:e.workers)??[],d=(s==null?void 0:s.worker_cards)??[],m=l.length>0?l.map(Ym):d.map(Qm),_=wm(),u=(($=t==null?void 0:t.decisions.summary)==null?void 0:$.pending)??0,p=(n==null?void 0:n.pending_confirms)??[],f=(e==null?void 0:e.blockers)??[],h=(s==null?void 0:s.recommended_actions)??[],S=(s==null?void 0:s.attention_items)??[],A=((O=e==null?void 0:e.recent_messages[0])==null?void 0:O.timestamp)??null,C=((Y=e==null?void 0:e.recent_trace_events[0])==null?void 0:Y.timestamp)??null,T=A??C??null,w=a==null?void 0:a.summary,P=((K=e==null?void 0:e.summary)==null?void 0:K.expected_workers)??(typeof(w==null?void 0:w.planned_worker_count)=="number"?w.planned_worker_count:void 0)??(s==null?void 0:s.worker_cards.length)??0,k=((Z=e==null?void 0:e.summary)==null?void 0:Z.joined_workers)??(typeof(w==null?void 0:w.active_agent_count)=="number"?w.active_agent_count:void 0)??m.length,R=f.length>0||u>0||p.length>0?"warn":_||a?"ok":"warn",G=((x=t==null?void 0:t.swarm_status)==null?void 0:x.lanes.filter(F=>F.present))??[];return nt(()=>{st()},[]),nt(()=>{a!=null&&a.session_id&&Ue(a.session_id)},[a==null?void 0:a.session_id,n,(bt=e==null?void 0:e.detachment)==null?void 0:bt.session_id]),!_&&!a?Ms.value||xn.value?i`<div class="empty-state">live war room 불러오는 중…</div>`:i`
      <section class="card command-section command-warroom-empty">
        ...
        <div class="command-action-row">
          <${Wt} label="작전 보기" surface="operations" />
          <${Wt} label="스웜 보기" surface="swarm" />
          <${Wt} label="개입 열기" />
          <${Wt} label="제어 보기" surface="control" />
        </div>
      </section>
    `:i`
    <div class="command-section-stack">
      <section class="command-warroom-strip ${L(R)}">
        ...
        <div class="command-warroom-strip-stats">
          ...
          <div class="monitor-stat-card">
            ...
            <small>slots ${((Ye=e==null?void 0:e.provider)==null?void 0:Ye.active_slots_now)??0}/${((Hn=e==null?void 0:e.provider)==null?void 0:Hn.actual_slots)??((Wn=e==null?void 0:e.provider)==null?void 0:Wn.total_slots)??0} · ctx ${((Bn=e==null?void 0:e.provider)==null?void 0:Bn.actual_ctx)??((Gn=e==null?void 0:e.provider)==null?void 0:Gn.ctx_per_slot)??0}</small>
          </div>
          ...
          <div class="monitor-stat-card">
            ...
            <strong>${V(T)}</strong>
            <small>${A?"message":C?"trace":"waiting"}</small>
          </div>
        </div>
      </section>
  ...
  `}function tv({source:t}){const e=tl(null),[n,s]=vo(null);return nt(()=>{let a=!1;const o=e.current;return o?(o.innerHTML="",s(null),(async()=>{try{const d=await cm(),{svg:m}=await d.render(`command-chain-${lm()}`,t);if(a||!e.current)return;e.current.innerHTML=m}catch(d){if(a)return;s(d instanceof Error?d.message:"Mermaid render failed")}})(),()=>{a=!0,e.current&&(e.current.innerHTML="")}):void 0},[t]),i`
    <div class="command-chain-graph-shell">
      ${n?i`<div class="empty-state error">${n}</div>`:null}
      <div class="command-chain-graph" ref=${e}></div>
    </div>
  `}function ev({overlay:t,selected:e,onSelect:n}){const s=t.operation.chain,a=t.runtime;return i`
  ...
  `}function av({card:t}){const e=t.operation,n=`pause:${e.operation_id}`,s=`resume:${e.operation_id}`,a=`recall:${e.operation_id}`,o=e.chain,l=(o==null?void 0:o.run_id)??null;return i`
    <article class="command-card">
      ...
      <div class="command-action-row">
        ...
        ${e.source==="managed"&&e.status==="active"?i`
              <button class="control-btn ghost" disabled=${at(n)} onClick=${()=>Xt(()=>Vp(e.operation_id))}>
                ${at(n)?"Pausing…":"Pause"}
              </button>
              <button class="control-btn ghost" disabled=${at(a)} onClick=${()=>Xt(()=>Qp(e.operation_id))}>
                ${at(a)?"Recalling…":"Recall"}
              </button>
            `:null}
        ${e.source==="managed"&&e.status==="paused"?i`
              <button class="control-btn ghost" disabled=${at(s)} onClick=${()=>Xt(()=>Yp(e.operation_id))}>
  ...
  `}function ov(){const t=Dt.value;return i`
    <div class="command-surface-grid">
      <section class="card command-section">
        <div class="card-title-row">
        ...
        ${t&&t.operations.operations.length>0?i`<div class="command-card-stack">
              ${t.operations.operations.map(e=>i`<${av} card=${e} />`)}
  ...
  `}function rv(){var d,m,_,u,p,f,h,S,A,C,T,w,P,k,R,G;const t=Fn.value,e=(t==null?void 0:t.operations)??[],n=De.value,s=e.find(W=>W.operation.operation_id===n)??e[0]??null,a=((d=s==null?void 0:s.operation.chain)==null?void 0:d.run_id)??null,o=((m=An.value)==null?void 0:m.run)??(s==null?void 0:s.preview_run)??null,l=!((_=An.value)!=null&&_.run)&&!!(s!=null&&s.preview_run);return nt(()=>{a?Gp(a):Bp()},[a]),i`
      ...
      <section class="card command-section">
        ...
        ${Va.value&&!t?i`<div class="empty-state">Loading chain overlays…</div>`:e.length>0?i`
                <div class="command-chain-list">
                  ${e.map(W=>i`
                    <${ev}
                      overlay=${W}
                      selected=${(s==null?void 0:s.operation.operation_id)===W.operation.operation_id}
                      onSelect=${()=>yi(W.operation.operation_id)}
                    />
                  `)}
                </div>
        ...
        <div class="command-chain-history">
          ...
          ${t&&t.recent_history.length>0?i`
                <div class="command-card-stack">
                  ${t.recent_history.slice(0,6).map(W=>i`<${nv} item=${W} />`)}
                </div>
        ...
        ${s?i`
              <article class="command-card">
                ...
                <div class="command-card-grid">
                  ...
                  <span>Elapsed</span><span>${sn((P=s.runtime)==null?void 0:P.elapsed_sec)}</span>
                  <span>Updated</span><span>${V(((k=s.operation.chain)==null?void 0:k.last_sync_at)??s.operation.updated_at)}</span>
                </div>
  ...
  `}function lv({decision:t}){const e=`approve:${t.decision_id}`,n=`deny:${t.decision_id}`,s=t.source==="projected_operator";return i`
    <article class="command-card ${L(t.status)}">
      ...
      ${t.status==="pending"&&!s?i`
            <div class="command-action-row">
              <button class="control-btn ghost" disabled=${at(e)} onClick=${()=>Xt(()=>Zp(t.decision_id))}>
                ${at(e)?"Approving…":"Approve"}
              </button>
              <button class="control-btn ghost" disabled=${at(n)} onClick=${()=>Xt(()=>tm(t.decision_id))}>
                ${at(n)?"Denying…":"Deny"}
              </button>
            </div>
          `:null}
  ...
  `}function cv({row:t}){var d,m,_;const e=t.unit,n=`freeze:${e.unit_id}`,s=`kill:${e.unit_id}`,a=!!((d=e.policy)!=null&&d.frozen),o=!!((m=e.policy)!=null&&m.kill_switch),l=Math.round((t.utilization??0)*100);return i`
    <article class="command-card compact">
      <div class="command-card-head">
        <div>
      ...
      <div class="command-action-row">
        <button class="control-btn ghost" disabled=${at(n)} onClick=${()=>Xt(()=>em(e.unit_id,!a))}>
          ${at(n)?"Applying…":a?"Unfreeze":"Freeze"}
        </button>
        <button class="control-btn ghost" disabled=${at(s)} onClick=${()=>Xt(()=>nm(e.unit_id,!o))}>
    ...
    <div class="command-surface-grid">
      <section class="card command-section">
        ...
        ${t&&t.decisions.decisions.length>0?i`<div class="command-card-stack">
              ${t.decisions.decisions.map(e=>i`<${lv} decision=${e} />`)}
  ...
  `}function pv(){if(U.value==="warroom")return i`<${Zm} />`;if(U.value==="summary")return i`<${Dm} />`;if(U.value==="swarm")return i`<${Vm} />`;if(!Dt.value)return i`<${zm} />`;switch(U.value){case"chains":return i`<${rv} />`;case"topology":return i`<${jm} />`;case"alerts":return i`<${Om} />`;case"trace":return i`<${Fm} />`;case"control":return i`<${dv} />`;case"operations":default:return i`<${ov} />`}}function mv(){return nt(()=>{Vt(),Yt(),Jp(),wt()},[]),nt(()=>{if(E.value.tab!=="command")return;const t=E.value.params.surface,e=E.value.params.operation,n=jn(E.value);if(Ji(t))ve(t);else if(n){const s=er(n);Ji(s)&&ve(s)}else t||ve("warroom");e&&yi(e),(t==="swarm"||t==="warroom"||U.value==="warroom")&&wt(),(t==="warroom"||U.value==="warroom")&&st()},[E.value.tab,E.value.params.surface,E.value.params.operation,E.value.params.operation_id,E.value.params.run_id,E.value.params.source,E.value.params.action_type,E.value.params.target_type,E.value.params.target_id,E.value.params.focus_kind]),nt(()=>{let t=null;const e=()=>{t||(t=window.setTimeout(()=>{t=null,Vt(),Yt(),(U.value==="swarm"||U.value==="warroom")&&wt(),U.value==="warroom"&&st()},250))},n=new EventSource(fm()),s=mm.map(a=>{const o=()=>e();return n.addEventListener(a,o),{type:a,handler:o}});return n.onerror=()=>{e()},()=>{s.forEach(({type:a,handler:o})=>{n.removeEventListener(a,o)}),n.close(),t&&window.clearTimeout(t)}},[]),nt(()=>{const t=window.setInterval(()=>{if(document.visibilityState==="hidden")return;const e=U.value;e!=="swarm"&&e!=="warroom"||(Vt(),wt(),e==="warroom"&&st())},5e3);return()=>{window.clearInterval(t)}},[]),i`
    <section class="dashboard-panel command-plane-view">
      ...
      <${Rm} />
      ${U.value==="warroom"?null:i`<${Pm} />`}
      <${uv} />
      <${pv} />
    </section>
  `}const Mr="masc_dashboard_agent_name";function vv(){var e,n,s;const t=new URLSearchParams(window.location.search);return((e=t.get("agent"))==null?void 0:e.trim())||((n=t.get("agent_name"))==null?void 0:n.trim())||((s=localStorage.getItem(Mr))==null?void 0:s.trim())||"dashboard"}const ta=g(vv()),ze=g(""),Ya=g("운영 점검"),Ee=g(""),wn=g(""),Tn=g("2"),In=g(""),Tt=g("note"),Rn=g(""),Pn=g(""),Nn=g(""),Ln=g("2"),js=g("운영자 중지 요청"),Os=g(""),je=g(""),Xn=g(null);function _v(t){const e=t.trim()||"dashboard";ta.value=e,localStorage.setItem(Mr,e)}function Yi(t){if(t==null)return"";if(typeof t=="string")return t;try{return JSON.stringify(t,null,2)}catch{return String(t)}}function fv(t){return typeof t!="number"||!Number.isFinite(t)?"확인 없음":t<60?`${Math.round(t)}초 전`:t<3600?`${Math.round(t/60)}분 전`:`${Math.round(t/3600)}시간 전`}function He(t){return typeof t=="string"?t.trim().toLowerCase():""}function gv(t){var s;const e=He(t.status);if(e==="paused")return"bad";if(e===""||e==="unknown")return"warn";const n=He((s=t.team_health)==null?void 0:s.status);return n&&n!=="ok"&&n!=="healthy"&&n!=="green"||e&&e!=="active"&&e!=="running"&&e!=="ended"?"warn":"ok"}function da(t){const e=He(t.status);return e==="offline"||e==="inactive"||e==="error"?"bad":e===""||e==="unknown"||(t.context_ratio??0)>=.8||t.context_ratio==null||t.last_turn_ago_s==null||(t.last_turn_ago_s??0)>=3600?"warn":"ok"}function Qi(t){return t.some(e=>He(e.severity)==="bad")?"bad":t.length>0?"warn":"ok"}function $v(t){return t.target_type==="team_session"}function hv(t){return t.target_type==="keeper"}function Zn(t){switch(t){case"broadcast":return"방송";case"room_pause":return"room 일시정지";case"room_resume":return"room 재개";case"team_turn":return"세션 업데이트";case"team_note":return"세션 노트";case"team_broadcast":return"세션 방송";case"team_task_inject":return"세션 작업 주입";case"task_inject":return"작업 주입";case"team_stop":return"세션 중지";case"keeper_message":return"keeper 메시지";case"keeper_msg":return"keeper 메시지";default:return(t==null?void 0:t.trim())||"액션"}}function ts(t){switch(t){case"room":return"room";case"team_session":return"session";case"keeper":return"keeper";default:return(t==null?void 0:t.trim())||"target"}}function tn(t){switch(He(t)){case"running":case"active":return"진행 중";case"paused":return"일시정지";case"ended":case"done":return"종료";case"offline":return"오프라인";case"idle":return"대기";case"unknown":case"":return"확인 필요";default:return(t==null?void 0:t.trim())||"확인 필요"}}function Xi(t){return t?"확인 후 실행":"즉시 실행"}function yv(t){switch(t){case"note":return"노트";case"broadcast":return"방송";case"task":return"작업";default:return t}}function ct(t,e){if(!t)return null;const n=t[e];return typeof n=="string"&&n.trim()!==""?n.trim():typeof n=="number"&&Number.isFinite(n)?String(n):null}function bv(t){if(t.action_type==="team_task_inject")return"task";if(t.action_type==="team_broadcast")return"broadcast";if(t.action_type==="team_note")return"note";if(t.action_type==="team_turn"){const e=ct(t.suggested_payload,"turn_kind");if(e==="broadcast"||e==="task")return e}return"note"}function kv(t){const e=t.suggested_payload;if(t.target_type==="room"){if(t.action_type==="broadcast"){ze.value=ct(e,"message")??t.summary;return}t.action_type==="task_inject"&&(Ee.value=ct(e,"title")??"운영자 주입 작업",wn.value=ct(e,"description")??t.summary,Tn.value=ct(e,"priority")??Tn.value);return}if(t.target_type==="team_session"){if(t.target_id&&(In.value=t.target_id),t.action_type==="team_stop"){js.value=ct(e,"reason")??t.summary;return}Tt.value=bv(t);const n=ct(e,"message");n&&(Rn.value=n),Tt.value==="task"&&(Pn.value=ct(e,"task_title")??ct(e,"title")??"운영자 주입 작업",Nn.value=ct(e,"task_description")??ct(e,"description")??t.summary,Ln.value=ct(e,"task_priority")??ct(e,"priority")??Ln.value);return}t.target_type==="keeper"&&(t.target_id&&(Os.value=t.target_id),je.value=ct(e,"message")??t.summary)}function xv(t,e,n){return!t||!t.target_type||t.target_type==="room"?!0:t.target_type==="team_session"?!!t.target_id&&e.some(s=>s.session_id===t.target_id):t.target_type==="keeper"?!!t.target_id&&n.some(s=>s.name===t.target_id):!0}async function $e(t){const e=ta.value.trim()||"dashboard";try{const n=await su({actor:e,action_type:t.action_type,target_type:t.target_type,target_id:t.target_id,payload:t.payload});return n.confirm_required?N("확인 대기열에 올렸습니다","warning"):N(t.successMessage,"success"),n}catch(n){const s=n instanceof Error?n.message:"개입 실행에 실패했습니다";return N(s,"error"),null}}async function Zi(){const t=ze.value.trim();if(!t)return;await $e({action_type:"broadcast",target_type:"room",payload:{message:t},successMessage:"방송을 보냈습니다"})&&(ze.value="")}async function Sv(){await $e({action_type:"room_pause",target_type:"room",payload:{reason:Ya.value.trim()||"운영 점검"},successMessage:"room 일시정지를 요청했습니다"})}async function to(){await $e({action_type:"room_resume",target_type:"room",payload:{},successMessage:"room 재개를 요청했습니다"})}async function Av(){const t=Ee.value.trim();if(!t)return;await $e({action_type:"task_inject",target_type:"room",payload:{title:t,description:wn.value.trim()||"Intervene 화면에서 주입",priority:Number.parseInt(Tn.value,10)||2},successMessage:"작업 주입을 보냈습니다"})&&(Ee.value="",wn.value="")}async function Cv(){var l;const t=Nt.value,e=In.value||((l=t==null?void 0:t.sessions[0])==null?void 0:l.session_id)||"";if(!e){N("먼저 세션을 고르세요","warning");return}const n={},s=Rn.value.trim();s&&(n.message=s);let a="team_note";Tt.value==="broadcast"?a="team_broadcast":Tt.value==="task"&&(a="team_task_inject"),Tt.value==="task"&&(n.task_title=Pn.value.trim()||"운영자 주입 작업",n.task_description=Nn.value.trim()||"Intervene 화면에서 주입",n.task_priority=Number.parseInt(Ln.value,10)||2),await $e({action_type:a,target_type:"team_session",target_id:e,payload:n,successMessage:"세션 액션을 적용했습니다"})&&(Rn.value="",Tt.value==="task"&&(Pn.value="",Nn.value=""))}async function wv(){var n;const t=Nt.value,e=In.value||((n=t==null?void 0:t.sessions[0])==null?void 0:n.session_id)||"";if(!e){N("먼저 세션을 고르세요","warning");return}await $e({action_type:"team_stop",target_type:"team_session",target_id:e,payload:{reason:js.value.trim()||"운영자 중지 요청"},successMessage:"세션 중지를 요청했습니다"})}async function Tv(){var a;const t=Nt.value,e=Os.value||((a=t==null?void 0:t.keepers[0])==null?void 0:a.name)||"",n=je.value.trim();if(!e){N("먼저 keeper를 고르세요","warning");return}if(!n)return;await $e({action_type:"keeper_message",target_type:"keeper",target_id:e,payload:{message:n},successMessage:`${e}에게 메시지를 보냈습니다`})&&(je.value="")}async function Iv(t){const e=ta.value.trim()||"dashboard";try{await au(e,t),N("확인 실행을 완료했습니다","success")}catch(n){const s=n instanceof Error?n.message:"확인 실행에 실패했습니다";N(s,"error")}}function Rv(){var R,G,W;const t=Nt.value,e=E.value.tab==="intervene"?jn(E.value):null,n=Ho.value,s=Lt.value,a=(t==null?void 0:t.room)??{},o=(t==null?void 0:t.sessions)??[],l=(t==null?void 0:t.keepers)??[],d=(t==null?void 0:t.pending_confirms)??[],m=(t==null?void 0:t.recent_messages)??[],_=(n==null?void 0:n.recommended_actions)??[],u=(t==null?void 0:t.available_actions)??[],p=o.find($=>$.session_id===In.value)??o[0]??null,f=l.find($=>$.name===Os.value)??l[0]??null,h=(n==null?void 0:n.attention_items)??[],S=h.filter($v),A=h.filter(hv),C=o.filter($=>gv($)!=="ok"),T=l.filter($=>da($)!=="ok"),w=m.slice(0,5),P=xv(e,o,l);nt(()=>{qt()},[]),nt(()=>{if(E.value.tab!=="intervene"){Xn.value=null;return}if(!e){Xn.value=null;return}Xn.value!==e.id&&(Xn.value=e.id,kv(e))},[E.value.tab,E.value.params.source,E.value.params.action_type,E.value.params.target_type,E.value.params.target_id,E.value.params.focus_kind,e==null?void 0:e.id]),nt(()=>{const $=(p==null?void 0:p.session_id)??null;Ue($)},[p==null?void 0:p.session_id]);const k=[{key:"room",label:"Room 게이트",value:a.paused?"일시정지":"열림",detail:a.paused?`재개 전환 대기 중${a.pause_reason?` · ${a.pause_reason}`:""}`:"지금은 새 액션과 새 작업을 바로 받을 수 있습니다",tone:a.paused?"bad":"ok"},{key:"confirm",label:"확인 대기",value:d.length,detail:d.length>0?"미리보기만 된 개입이 아직 사람 확인을 기다리고 있습니다":"지금 막혀 있는 확인 대기는 없습니다",tone:d.length>0?"warn":"ok"},{key:"session",label:"세션 리스크",value:S.length>0?S.length:o.length,detail:S.length>0?((R=S[0])==null?void 0:R.summary)??"세션 중 하나가 방향 수정이나 중지 판단을 기다리고 있습니다":o.length===0?"지금 관리 중인 team session이 없습니다":"세션 쪽 긴급 attention은 현재 없습니다",tone:S.length>0?Qi(S):o.length===0?"warn":C.some($=>He($.status)==="paused")?"bad":C.length>0?"warn":"ok"},{key:"keeper",label:"Keeper 압력",value:A.length>0?A.length:T.length,detail:A.length>0?((G=A[0])==null?void 0:G.summary)??"직접 메시지나 상태 점검이 필요한 keeper가 있습니다":T.length>0?"stale, offline, telemetry 누락 keeper가 보입니다":"지금은 keeper 쪽이 비교적 안정적입니다",tone:A.length>0?Qi(A):T.some($=>da($)==="bad")?"bad":T.length>0?"warn":"ok"}];return i`
      ...
      <div class="ops-workbench">
          ...
          <section class="card ops-panel ops-lane-panel">
            ...
            <div class="control-row ops-split-row">
              <input
                ...
                disabled=${J.value}
              />
              <button class="control-btn ghost" onClick=${()=>{Sv()}} disabled=${J.value}>
                일시정지
              </button>
            ...
            <div class="control-row ops-split-row">
              ...
              <button class="control-btn" onClick=${()=>{Av()}} disabled=${J.value||Ee.value.trim()===""}>
                주입
              </button>
            </div>
          </section>
                ...
                ${d.map($=>i`
                  <article key=${$.confirm_token} class="ops-confirmation-card">
                    ...
                    <div class="ops-confirmation-actions">
                      <button class="control-btn" onClick=${()=>{Iv($.confirm_token)}} disabled=${J.value}>
                        실행
                      </button>
        ...
        <div class="ops-column">
          ...
          <section class="card ops-panel ops-lane-panel">
            ...
            <div class="control-row ops-split-row">
              ...
              <button class="control-btn" onClick=${()=>{Cv()}} disabled=${J.value||!p}>
                적용
              </button>
            </div>
            <div class="ops-context-note">현재 선택: ${yv(Tt.value)}</div>
            ...
            <div class="control-row ops-split-row">
              <input
                ...
                disabled=${J.value||!p}
              />
              <button class="control-btn ghost" onClick=${()=>{wv()}} disabled=${J.value||!p}>
                세션 중지
              </button>
            </div>
          </section>
        ...
        <div class="ops-column">
          ...
          <section class="card ops-panel ops-lane-panel">
            ...
            ${f?i`
              <div class="ops-detail-card">
                ...
                <div class="ops-detail-meta">
                  ...
                  <span>활성 목표: ${((W=f.active_goal_ids)==null?void 0:W.length)??0}</span>
                </div>
              </div>
            ...
            ></textarea>
            <div class="control-row">
              <button class="control-btn" onClick=${()=>{Tv()}} disabled=${J.value||!f||je.value.trim()===""}>
                keeper에 보내기
              </button>
            </div>
          </section>
  ...
  `}function Pv({text:t}){if(!t)return null;const e=Nv(t);return i`<div class="markdown-content">${e}</div>`}function Nv(t){const e=t.split(`
...
`)}</code></pre>`);continue}if(a.trim()==="<think>"||a.trim().startsWith("<think>")){const l=[],d=a.trim().replace(/^<think>/,"").trim();for(d&&d!=="</think>"&&l.push(d),s++;s<e.length&&!e[s].includes("</think>");)l.push(e[s]),s++;if(s<e.length){const _=e[s].replace("</think>","").trim();_&&l.push(_),s++}const m=l.join(`
`).trim();n.push(i`
...
`))}</p>`)}return n}function ua(t){const e=[],n=/(`[^`]+`)|(\*\*[^*]+\*\*)|(\*[^*]+\*)|\[([^\]]+)\]\(([^)]+)\)/g;let s=0,a;for(;(a=n.exec(t))!==null;){if(a.index>s&&e.push(t.slice(s,a.index)),a[1]){const o=a[1].slice(1,-1);e.push(i`<code>${o}</code>`)}else if(a[2]){const o=a[2].slice(2,-2);e.push(i`<strong>${o}</strong>`)}else if(a[3]){const o=a[3].slice(1,-1);e.push(i`<em>${o}</em>`)}else a[4]&&a[5]&&e.push(i`<a href=${a[5]} target="_blank" rel="noopener">${a[4]}</a>`);s=a.index+a[0].length}return s<t.length&&e.push(t.slice(s)),e.length>0?e:[t]}const Dr=[{id:"recent",label:"Latest"},{id:"hot",label:"Hot"},{id:"trending",label:"Trending"},{id:"updated",label:"Updated"},{id:"discussed",label:"Discussed"}],ms=g(null),vs=g([]),We=g(!1),me=g(null),dn=g(""),un=g(!1),Te=g(!0);function Lv(){var e,n;const t=new URLSearchParams(window.location.search);return((e=t.get("agent"))==null?void 0:e.trim())||((n=t.get("agent_name"))==null?void 0:n.trim())||"dashboard-user"}const Mv=g(Lv());function Dv(t){const e=t.replace(/!\[[^\]]*\]\([^)]+\)/g," ").replace(/\[[^\]]+\]\([^)]+\)/g,"$1").replace(/[`#>*_~-]/g," ").replace(/\s+/g," ").trim();return e?e.length>180?`${e.slice(0,177)}...`:e:"No preview available"}function eo(t){return t.updated_at!==t.created_at}function zv(t){const e=`${t.title} ${t.tags.join(" ")} ${t.flair??""}`.toLowerCase();return/\b(test|smoke|harness|sandbox|dummy|sample|tmp|qa|e2e)\b/.test(e)||e.includes("테스트")||e.includes("실험")}function Ev(t){const e=(t.hearth??"").toLowerCase();return t.visibility!=="internal"||!t.expires_at||!e?!1:!!(e.startsWith("mdal")||e.includes("harness"))}function zr(t){return Te.value?t.filter(e=>Ev(e)?!1:e.hearth||e.visibility||e.expires_at?!0:!zv(e)):t}async function Si(t){me.value=t,ms.value=null,vs.value=[],We.value=!0;try{const e=await Wl(t);if(me.value!==t)return;ms.value={id:e.id,author:e.author,title:e.title,content:e.content,tags:e.tags,votes:e.votes,vote_balance:e.vote_balance,comment_count:e.comment_count,created_at:e.created_at,updated_at:e.updated_at,flair:e.flair,hearth:e.hearth,visibility:e.visibility,expires_at:e.expires_at,hearth_count:e.hearth_count},vs.value=e.comments??[]}catch{me.value===t&&(ms.value=null,vs.value=[])}finally{me.value===t&&(We.value=!1)}}async function no(t){const e=dn.value.trim();if(e){un.value=!0;try{await Bl(t,Mv.value,e),dn.value="",N("Comment posted","success"),await Si(t),Rt()}catch{N("Failed to post comment","error")}finally{un.value=!1}}}function jv(){const t=gn.value,e=Te.value?"Hiding automation posts":"Show automation posts";return i`
  ...
  `}function Ov({post:t}){const e=async(n,s)=>{s.stopPropagation();try{await Co(t.id,n),Rt()}catch{N("Failed to vote","error")}};return i`
    <div class="board-post" onClick=${()=>il(t.id)}>
      ...
      <div class="post-content">
        ...
        <div class="post-snippet">${Dv(t.content)}</div>
      </div>
    </div>
  `}function Fv({comments:t}){return t.length===0?i`<div class="empty-state" style="font-size:13px">No comments yet</div>`:i`
  ...
  `}function Kv({post:t}){me.value!==t.id&&!We.value&&Si(t.id);const e=async n=>{try{await Co(t.id,n),Rt()}catch{N("Failed to vote","error")}};return i`
    <div>
      ...
      <${I} title="Comments" semanticId="memory.feed">
        ${We.value?i`<div class="loading-indicator">Loading comments...</div>`:i`<${Fv} comments=${vs.value} />`}
        <${qv} postId=${t.id} />
      <//>
    </div>
  `}function Uv(){const t=zr(fn.value),e=E.value.params.post??null,n=e?t.find(s=>s.id===e)??(me.value===e?ms.value:null):null;return e&&!n&&me.value!==e&&!We.value&&Si(e),e?n?i`
          <${ft} surfaceId="memory" />
          <${pa} />
          <${Kv} post=${n} />
        `:i`
  ...
  `}const ma=600*1e3,Hv=1200*1e3,so=.8;function Bt(t){if(t==null)return 0;const e=typeof t=="number"?t:Date.parse(t);return Number.isNaN(e)?0:e}function ke(t){switch(t){case"bad":return 2;case"warn":return 1;default:return 0}}function Wv(t){switch(t){case"working":return"Working";case"watching":return"Watching";case"quiet":return"Quiet";case"offline":return"Offline"}}function Bv(t){switch(t){case"critical":return"Critical";case"warning":return"Watch";default:return"Healthy"}}function Gv(t){return typeof t!="number"||Number.isNaN(t)?"—":`${Math.round(t*100)}%`}function Jv(t){var e;return((e=t.agent)==null?void 0:e.current_task)??t.skill_primary??t.last_proactive_reason??t.memory_recent_note??"No active focus"}function Vv(t){const e=[`Gen ${t.generation??"—"}`,`Turns ${t.turn_count??0}`,`Handoffs ${t.handoff_count_total??0}`];return(t.compaction_count??0)>0&&e.push(`Compactions ${t.compaction_count}`),e.join(" · ")}function Yv(t){var m,_;const e=li.value.get(t.name.trim().toLowerCase())??{activeAssignedCount:0,lastActivityAt:null,lastActivityText:null},n=e.lastActivityAt??t.last_seen??null,s=n?Math.max(0,Date.now()-Bt(n)):Number.POSITIVE_INFINITY,a=!!((m=t.current_task)!=null&&m.trim())||e.activeAssignedCount>0;let o="watching",l="ok",d="Healthy live signal";return t.status==="offline"||t.status==="inactive"?(o="offline",l="bad",d=n?"Offline or inactive":"No recent presence"):s>Hv?(o="quiet",l="bad",d=a?"Working without a fresh signal":"No fresh agent signal"):a?(o="working",l=s>ma?"warn":"ok",d=s>ma?"Execution looks quiet for too long":"Task and live signal aligned"):s>ma?(o="quiet",l="warn",d="Quiet but still reachable"):t.status==="idle"&&(o="watching",l="ok",d="Standing by for the next task"),{agent:t,motion:e,lastSignalAt:n,activeTaskCount:e.activeAssignedCount,state:o,tone:l,focus:((_=t.current_task)==null?void 0:_.trim())||(e.activeAssignedCount>0?`${e.activeAssignedCount} claimed tasks waiting for explicit current_task`:e.lastActivityText??"Idle / waiting for assignment"),note:d}}function Qv(t){const e=Jc.value.get(t.name)??"idle",n=Qc.value.has(t.name),s=t.context_ratio??0;let a="healthy",o="ok",l="Heartbeat and context look healthy";return t.status==="offline"||n||e==="handoff-imminent"?(a="critical",o="bad",l=n?"Heartbeat stale":e==="handoff-imminent"?"Handoff imminent":"Keeper offline"):(e==="preparing"||e==="compacting"||s>=so)&&(a="warning",o="warn",l=s>=so?"High context pressure":e==="compacting"?"Compaction in progress":"Preparing for handoff"),{keeper:t,lifecycle:e,state:a,tone:o,focus:Jv(t),note:l}}function en({label:t,value:e,color:n,caption:s}){return i`
    <div class="stat-card">
      <div class="stat-label">${t}</div>
      <div class="stat-value" style=${n?`color:${n}`:""}>${e}</div>
      ${s?i`<div class="monitor-stat-caption">${s}</div>`:null}
    </div>
  `}function Xv({item:t}){const e=t.kind==="agent"?()=>qe(t.agent.name):()=>mi(t.keeper);return i`
    <button class="monitor-alert ${t.tone}" onClick=${e}>
      ...
      <div class="monitor-alert-meta">
        ...
        ${t.timestamp?i`<span><${tt} timestamp=${t.timestamp} /></span>`:i`<span>No signal</span>`}
      </div>
    </button>
  `}function ao({row:t}){const{agent:e,motion:n}=t;return i`
    <button class="monitor-row ${t.tone} state-${t.state}" onClick=${()=>qe(e.name)}>
      ...
      <div class="monitor-meta">
        ${t.lastSignalAt?i`<span>Signal <${tt} timestamp=${t.lastSignalAt} /></span>`:i`<span>No recent signal</span>`}
        <span>${t.activeTaskCount>0?`${t.activeTaskCount} active tasks`:"No active tasks"}</span>
        ${e.model?i`<span>${e.model}</span>`:null}
        ${e.last_seen?i`<span>Seen <${tt} timestamp=${e.last_seen} /></span>`:null}
      </div>
  ...
  `}function Zv({row:t}){const{keeper:e}=t;return i`
    <button class="monitor-row ${t.tone} state-${t.state}" onClick=${()=>mi(e)}>
      <div class="monitor-row-header">
        ...
        <${Er} ratio=${e.context_ratio} size=${34} stroke=${4} />
        <${ne} status=${e.status} />
        <span class="monitor-pill ${t.tone}">${Bv(t.state)}</span>
      </div>

      <div class="monitor-meta">
        ${e.last_heartbeat?i`<span>Heartbeat <${tt} timestamp=${e.last_heartbeat} /></span>`:i`<span>No heartbeat</span>`}
        <span>${Vv(e)}</span>
  ...
  `}function t_(){const t=[...yt.value].map(Yv).sort((u,p)=>{const f=ke(p.tone)-ke(u.tone);if(f!==0)return f;const h=p.activeTaskCount-u.activeTaskCount;return h!==0?h:Bt(p.lastSignalAt)-Bt(u.lastSignalAt)}),e=[...Kt.value].map(Qv).sort((u,p)=>{const f=ke(p.tone)-ke(u.tone);if(f!==0)return f;const h=(p.keeper.context_ratio??0)-(u.keeper.context_ratio??0);return h!==0?h:Bt(p.keeper.last_heartbeat)-Bt(u.keeper.last_heartbeat)}),n=t.filter(u=>u.state!=="offline"),s=t.filter(u=>u.state==="offline"),a=n.length,o=t.filter(u=>u.state==="working").length,l=t.filter(u=>u.lastSignalAt&&Date.now()-Bt(u.lastSignalAt)<=12e4).length,d=t.filter(u=>u.tone!=="ok"),m=e.filter(u=>u.tone!=="ok"),_=[...m.map(u=>({kind:"keeper",key:`keeper-${u.keeper.name}`,tone:u.tone,title:u.keeper.name,subtitle:`${u.note} · ${u.focus}`,timestamp:u.keeper.last_heartbeat??null,keeper:u.keeper})),...d.map(u=>({kind:"agent",key:`agent-${u.agent.name}`,tone:u.tone,title:u.agent.name,subtitle:`${u.note} · ${u.focus}`,timestamp:u.lastSignalAt,agent:u.agent}))].sort((u,p)=>{const f=ke(p.tone)-ke(u.tone);return f!==0?f:Bt(p.timestamp)-Bt(u.timestamp)}).slice(0,8);return i`
    <div class="agents-monitor">
      <${ft} surfaceId="execution" />
      <div class="stats-grid">
        <${en} label="Workers online" value=${a} color="#4ade80" caption="활성 + 대기 실행 actor" />
        <${en} label="Working now" value=${o} color="#fbbf24" caption="작업 또는 할당된 부하" />
        <${en} label="Fresh signals" value=${l} color="#22d3ee" caption="최근 2분 이내 신호" />
        <${en} label="Worker alerts" value=${d.length} color=${d.length>0?"#fb7185":"#4ade80"} caption="실행 actor 경고" />
        <${en} label="Continuity alerts" value=${m.length} color=${m.length>0?"#fb7185":"#4ade80"} caption="keeper 연속성 경고" />
      </div>
      ...
      <${I} title="Execution Priorities" class="section" semanticId="execution.priority_queue">
        ...
        <div class="monitor-alert-list">
          ${_.length===0?i`<div class="empty-state">No execution alerts right now</div>`:_.map(u=>i`<${Xv} key=${u.key} item=${u} />`)}
        </div>
      <//>
      ...
      <div class="agents-workbench">
        <${I} title="Workers" class="section" semanticId="execution.workers">
          ...
          <div class="monitor-list">
            ${n.length===0?i`<div class="empty-state">No active workers visible</div>`:n.map(u=>i`<${ao} key=${u.agent.name} row=${u} />`)}
          </div>
        <//>
        ...
        <${I} title="Continuity" class="section" semanticId="execution.continuity">
          ...
          <div class="monitor-list">
            ${e.length===0?i`<div class="empty-state">No keepers active</div>`:e.map(u=>i`<${Zv} key=${u.keeper.name} row=${u} />`)}
          </div>
        <//>
        ...
        <${I} title="Offline Workers" class="section" semanticId="execution.offline">
          ...
          <div class="monitor-list">
            ${s.length===0?i`<div class="empty-state">No offline workers right now</div>`:s.map(u=>i`<${ao} key=${u.agent.name} row=${u} />`)}
          </div>
        <//>
      </div>
    </div>
  `}const Fs=g("all"),qs=g("all"),Qa=g(new Set);function e_(t){const e=new Set(Qa.value);e.has(t)?e.delete(t):e.add(t),Qa.value=e}const jr=ht(()=>{let t=Re.value;return Fs.value!=="all"&&(t=t.filter(e=>e.horizon===Fs.value)),qs.value!=="all"&&(t=t.filter(e=>e.status===qs.value)),t}),n_=ht(()=>{const t={short:[],mid:[],long:[]};for(const e of jr.value){const n=t[e.horizon];n&&n.push(e)}return t}),s_=ht(()=>{const t=Array.from(No.value.values());return t.sort((e,n)=>e.status==="running"&&n.status!=="running"?-1:n.status==="running"&&e.status!=="running"?1:e.status==="interrupted"&&n.status!=="interrupted"?-1:n.status==="interrupted"&&e.status!=="interrupted"?1:n.elapsed_seconds-e.elapsed_seconds),t});function a_(t){return"★".repeat(Math.min(t,5))+"☆".repeat(Math.max(0,5-t))}function Ai(t){switch(t){case"short":return"Short-term";case"mid":return"Mid-term";case"long":return"Long-term";default:return t}}function _s(t){switch(t){case"short":return"#4ade80";case"mid":return"#f59e0b";case"long":return"#818cf8";default:return"#888"}}function i_(t){return t<60?`${Math.round(t)}s`:t<3600?`${Math.floor(t/60)}m ${Math.round(t%60)}s`:`${Math.floor(t/3600)}h ${Math.floor(t%3600/60)}m`}function io(t){return t.toFixed(4)}function oo(t){const e=t.current_metric-t.baseline_metric;return`${e>=0?"+":""}${e.toFixed(4)}`}function o_(t){switch(t){case 1:return"P1";case 2:return"P2";case 3:return"P3";default:return"P4"}}function ro(t,e){return(t.priority??4)-(e.priority??4)}function r_(t,e){const n=t.updated_at??t.created_at??"";return(e.updated_at??e.created_at??"").localeCompare(n)}function l_(t,e){return t.length<=e?t:t.slice(0,e)+"..."}function c_({goal:t}){return i`
    <div class="goal-row">
  ...
  `}function u_(){const t=Re.value,e=t.filter(a=>a.status==="active").length,n=t.filter(a=>a.status==="completed").length,s={short:0,mid:0,long:0};for(const a of t)a.horizon in s&&s[a.horizon]++;return i`
  ...
  `}function m_(){const{todo:t,inProgress:e,done:n}=Mo.value,s=[...t].sort(ro),a=[...e].sort(ro),o=[...n].sort(r_);return i`
  ...
  `}function v_(){const{todo:t,inProgress:e,done:n}=Mo.value,s=t.length+e.length+n.length,a=[...t,...e].filter(u=>(u.priority??4)<=2).length,o=n_.value,l=s_.value,d=Re.value.length>0,m=l.length>0,_=oi.value;return i`
    <div>
      ...
      <details class="overview-section-collapsible" open=${m}>
        ...
        <div>
          ${rn.value&&l.length===0?i`<div class="loading-indicator">Loading MDAL loops...</div>`:l.length===0&&(_==="error"||Pe.value)?i`<div class="empty-state">MDAL snapshot could not be loaded${Pe.value?`: ${Pe.value}`:""}. Check backend health.</div>`:l.length===0?i`<div class="empty-state">No active loops. Use <code>masc_mdal_start</code> to start a loop.</div>`:i`
                  <div class="planning-loop-list">
                    ${l.map(u=>i`<${p_} key=${u.loop_id} loop=${u} />`)}
                  </div>
                `}
        </div>
      </details>
    </div>
  `}const pn=g("debates"),Ks=g([]),Us=g([]),Hs=g(!1),mn=g(!1),Mn=g(""),vn=g(""),Ws=g(null),xt=g(null),Xa=g(!1);async function ea(){Hs.value=!0,Mn.value="";try{const t=await wl();Ks.value=Array.isArray(t.debates)?t.debates:[],Us.value=Array.isArray(t.sessions)?t.sessions:[]}catch(t){Mn.value=t instanceof Error?t.message:"Failed to load governance state"}finally{Hs.value=!1}}pd(ea);async function lo(){const t=vn.value.trim();if(t){mn.value=!0;try{const e=await hc(t);vn.value="",N(e!=null&&e.id?`Debate started: ${e.id}`:"Debate started","success"),await ea()}catch(e){const n=e instanceof Error?e.message:"Failed to start debate";N(n,"error")}finally{mn.value=!1}}}async function __(t){Ws.value=t,xt.value=null,Xa.value=!0;try{xt.value=await yc(t)}catch(e){Mn.value=e instanceof Error?e.message:"Failed to load debate detail"}finally{Xa.value=!1}}function f_(){return i`
    <div class="board-summary-strip">
      <div class="board-summary-item">
  ...
  `}function g_({debate:t}){const e=Ws.value===t.id;return i`
  ...
  `}function h_(){const t=pn.value;return i`
    ...
    <div>
      <${I} title="Start Debate" class="section" semanticId="governance.debates">
        <div class="council-create">
          ...
          <button class="control-btn ghost" onClick=${ea} disabled=${Hs.value}>
      ...
      <${I} title="Debates" class="section" semanticId="governance.debates">
        <div class="council-list">
          ${Ks.value.length===0?i`<div class="empty-state">No debates yet</div>`:Ks.value.map(t=>i`<${g_} key=${t.id} debate=${t} />`)}
        </div>
      <//>
  ...
  `}function b_(){return i`
    <${I} title="Voting Sessions" class="section" semanticId="governance.voting">
      <div class="council-list">
        ${Us.value.length===0?i`<div class="empty-state">No active sessions</div>`:Us.value.map(t=>i`<${$_} key=${t.id} session=${t} />`)}
      </div>
    <//>
  `}function k_(){return nt(()=>{ea()},[]),i`
    <div>
      <${ft} surfaceId="governance" />
      <${f_} />
      <${h_} />
      ${pn.value==="debates"?i`<${y_} />`:i`<${b_} />`}
    </div>
  `}const Se=g(""),fa=g("ability_check"),ga=g("10"),$a=g("12"),es=g(""),ns=g("idle"),Gt=g(""),ss=g("keeper-late"),ha=g("player"),ya=g(""),vt=g("idle"),ba=g(null),as=g(""),ka=g(""),xa=g("player"),Sa=g(""),Aa=g(""),Ca=g(""),_n=g("20"),wa=g("20"),Ta=g(""),is=g("idle"),Za=g(null),Or=g("overview"),Ia=g("all"),Ra=g("all"),Pa=g("all"),x_=12e4,na=g(null),co=g(Date.now());function S_(t,e){const n=e>0?t/e*100:0;return n>50?"hp-high":n>25?"hp-mid":"hp-low"}function A_(t,e){return e>0?Math.round(t/e*100):0}const C_={pragmatic:"리스크보다 확실한 이득을 우선합니다.",frugal:"자원 소모를 줄이고 효율을 챙깁니다.",impatient:"짧은 템포로 즉시 압박을 선호합니다.",stubborn:"한 번 정한 전술을 끝까지 밀어붙입니다.",protective:"아군 피해를 줄이는 선택을 우선합니다.","honor-bound":"약속과 규율을 지키는 행동에 보너스가 납니다.",intense:"집중 화력을 짧게 폭발시킵니다.",empathetic:"아군/약자 보호 쪽 선택 확률이 높아집니다.",fatalistic:"위험을 감수하는 고배수 선택을 탑니다.",suspicious:"함정/매복 경계 행동을 우선합니다.",precise:"단일 목표를 정확히 노리는 경향입니다.",vengeful:"직전 위협 대상에게 강하게 반응합니다.",aggressive:"공격적인 전진 행동을 우선합니다.",opportunistic:"빈틈이 열리면 즉시 추격합니다."},w_={supply_scan:"전장/자원 상태를 스캔해 약한 지점을 찾습니다.",ration_shift:"소모를 줄이고 지속 전투 능력을 확보합니다.",logistics_patch:"무너진 운영 라인을 빠르게 복구합니다.",frontline_shield:"전열에서 아군 피해를 흡수합니다.",oath_intercept:"핵심 타깃을 가로막아 위협을 차단합니다.",morale_anchor:"아군 안정도를 높여 붕괴를 막습니다.",omen_trace:"다음 위험 신호를 먼저 감지합니다.",arc_flash:"짧은 순간 광역 압박을 넣습니다.",ward_bloom:"방어 장막을 펼쳐 생존률을 올립니다.",mark_prey:"우선 제거 대상을 지정합니다.",silent_route:"은밀한 진입 경로를 확보합니다.",finisher_strike:"약화된 적을 마무리하는 일격입니다.",shadow_claw:"근접 급습으로 출혈 피해를 노립니다.",lunge:"짧은 돌진으로 전열을 흔듭니다."};function os(t){const e=t.trim();return e?e.split(/[_-]+/g).filter(n=>n.length>0).map(n=>n[0]?`${n[0].toUpperCase()}${n.slice(1)}`:n).join(" "):t}function T_(t){const e=t.trim().toLowerCase();return C_[e]??"행동 선택 가중치에 영향을 주는 성향입니다."}function I_(t){const e=t.trim().toLowerCase();return w_[e]??"상황에 따라 선택되는 전술 액션입니다."}function pt(t,e,n=""){const s=t[e];return typeof s=="string"?s:n}function St(t,e,n=0){const s=t[e];return typeof s=="number"&&Number.isFinite(s)?s:n}function Dn(t,e,n=!1){const s=t[e];return typeof s=="boolean"?s:n}const R_=new Set(["str","dex","con","int","wis","cha"]);function P_(t){const e=t.trim();if(!e)return{};let n;try{n=JSON.parse(e)}catch(a){throw new Error(`능력치 JSON 파싱 실패: ${a instanceof Error?a.message:"invalid json"}`)}if(!v(n))throw new Error('능력치 JSON은 object여야 합니다. 예: {"luck":7}');const s={};return Object.entries(n).forEach(([a,o])=>{const l=a.trim();if(l){if(typeof o=="number"&&Number.isFinite(o)){s[l]=Math.max(0,Math.trunc(o));return}if(typeof o=="string"){const d=Number.parseFloat(o.trim());if(Number.isFinite(d)){s[l]=Math.max(0,Math.trunc(d));return}}throw new Error(`능력치 '${l}' 값은 숫자여야 합니다.`)}}),s}function N_(t){const e=Number.parseInt(t.trim(),10);if(!Number.isFinite(e))return;const n=Math.max(1,e),s=Number.parseInt(_n.value.trim(),10);Number.isFinite(s)&&s>n&&(_n.value=String(n))}function ti(t){const n=(t.actor_name??t.actor??t.actor_id??"system").trim();return n===""?"system":n}function L_(t){var n;return(((n=t.timestamp)==null?void 0:n.trim())??"")||"-"}function M_(t){Or.value=t}function Fr(t){const e=na.value;return e==null||e<=t}function D_(t){const e=na.value;return e==null||e<=t?0:Math.max(0,Math.ceil((e-t)/1e3))}function Bs(){na.value=null}function qr(t){return typeof window>"u"||typeof window.confirm!="function"?!0:window.confirm(t)}function z_(t,e){qr(["관전 모드 잠금을 해제하시겠습니까?",`ROOM: ${t||"-"}`,`PHASE: ${e||"-"}`,"해제 시간: 120초 (시간 경과 또는 위험 액션 실행 후 자동 재잠금)"].join(`
`))&&(na.value=Date.now()+x_,N("조작 잠금이 120초 동안 해제되었습니다.","warning"))}function fs(t){return Fr(t)?(N("관전 모드 잠금 상태입니다. 먼저 잠금을 해제하세요.","warning"),!1):!0}function ei(t,e,n){return qr([`[위험 액션 확인] ${t}`,`ROOM: ${e||"-"}`,`PHASE: ${n||"-"}`,"이 액션은 즉시 실행되며 되돌리기 어렵습니다.","계속 진행하시겠습니까?"].join(`
`))}function E_({hp:t,max:e}){const n=A_(t,e),s=S_(t,e);return i`
  ...
  `}function Kr({actor:t}){var m,_,u,p;const e=(m=t.archetype)==null?void 0:m.trim(),n=(_=t.persona)==null?void 0:_.trim(),s=(u=t.portrait)==null?void 0:u.trim(),a=(p=t.background)==null?void 0:p.trim(),o=t.traits??[],l=t.skills??[],d=Object.entries(t.stats_raw??{}).filter(([f,h])=>Number.isFinite(h)).filter(([f])=>!R_.has(f.toLowerCase()));return i`
  ...
  `}function F_({mapStr:t}){return i`<pre class="trpg-map">${t}</pre>`}function Ur({events:t,emptyLabel:e="아직 이벤트가 없습니다."}){return t.length===0?i`<div class="empty-state" style="font-size:13px">${e}</div>`:i`
  ...
  `}function q_({events:t}){const e="__none__",n=Ia.value,s=Ra.value,a=Pa.value,o=Array.from(new Set(t.map(ti).map(p=>p.trim()).filter(p=>p!==""))).sort((p,f)=>p.localeCompare(f)),l=Array.from(new Set(t.map(p=>(p.type??"").trim()).filter(p=>p!==""))).sort((p,f)=>p.localeCompare(f)),d=t.some(p=>(p.type??"").trim()===""),m=Array.from(new Set(t.map(p=>(p.phase??"").trim()).filter(p=>p!==""))).sort((p,f)=>p.localeCompare(f)),_=t.some(p=>(p.phase??"").trim()===""),u=t.filter(p=>{if(n!=="all"&&ti(p)!==n)return!1;const f=(p.type??"").trim(),h=(p.phase??"").trim();if(s===e){if(f!=="")return!1}else if(s!=="all"&&f!==s)return!1;if(a===e){if(h!=="")return!1}else if(a!=="all"&&h!==a)return!1;return!0});return i`
  ...
  `}function Hr({state:t}){const e=t.history??[];return e.length===0?null:i`
  ...
  `}function U_({state:t,nowMs:e}){var _;const n=jt.value||((_=t.session)==null?void 0:_.room)||"",s=ns.value,a=t.party??[];if(!a.find(u=>u.id===Se.value)&&a.length>0){const u=a[0];u&&(Se.value=u.id)}const l=async()=>{var p,f;if(!n){N("Room ID가 비어 있습니다.","error");return}if(!fs(e))return;const u=((p=t.current_round)==null?void 0:p.phase)??((f=t.session)==null?void 0:f.status)??"unknown";if(ei("라운드 실행",n,u)){ns.value="running";try{const h=await lc(n);Za.value=h,ns.value="ok";const S=v(h.summary)?h.summary:null,A=S?Dn(S,"advanced",!1):!1,C=S?pt(S,"progress_reason",""):"";N(A?"라운드가 정상 진행되었습니다.":`라운드가 정체되었습니다${C?`: ${C}`:""}`,A?"success":"warning"),Pt()}catch(h){Za.value=null,ns.value="error";const S=h instanceof Error?h.message:"라운드 실행에 실패했습니다.";N(S,"error")}finally{Bs()}}},d=async()=>{var p,f;if(!n||!fs(e))return;const u=((p=t.current_round)==null?void 0:p.phase)??((f=t.session)==null?void 0:f.status)??"unknown";if(ei("턴 강제 진행",n,u))try{await uc(n),N("턴을 다음 단계로 이동했습니다.","success"),Pt()}catch{N("턴 이동에 실패했습니다.","error")}finally{Bs()}},m=async()=>{if(!n||!fs(e))return;const u=Se.value.trim();if(!u){N("먼저 Actor를 선택하세요.","warning");return}const p=Number.parseInt(ga.value,10),f=Number.parseInt($a.value,10);if(Number.isNaN(p)||Number.isNaN(f)){N("stat/dc는 숫자여야 합니다.","warning");return}const h=Number.parseInt(es.value,10),S=es.value.trim()===""||Number.isNaN(h)?void 0:h;try{await dc({roomId:n,actorId:u,action:fa.value.trim()||"ability_check",statValue:p,dc:f,rawD20:S}),N("주사위 판정을 기록했습니다.","success"),Pt()}catch{N("주사위 판정 기록에 실패했습니다.","error")}};return i`
  ...
  `}function H_({state:t}){var a;const e=jt.value||((a=t.session)==null?void 0:a.room)||"",n=is.value,s=async()=>{if(!e){N("Room ID가 비어 있습니다.","warning");return}const o=as.value.trim(),l=ka.value.trim();if(!l&&!o){N("이름 또는 Actor ID를 입력하세요.","warning");return}const d=Number.parseInt(_n.value.trim(),10),m=Number.parseInt(wa.value.trim(),10),_=Number.isFinite(m)?Math.max(1,m):20,u=Number.isFinite(d)?Math.max(0,Math.min(_,d)):_;let p={};try{p=P_(Ta.value)}catch(f){N(f instanceof Error?f.message:"능력치 JSON 오류","error");return}is.value="spawning";try{const f=typeof crypto<"u"&&typeof crypto.randomUUID=="function"?`trpg_spawn_${crypto.randomUUID()}`:`trpg_spawn_${Date.now().toString(36)}_${Math.random().toString(36).slice(2,10)}`,h=await pc(e,{actor_id:o||void 0,name:l||void 0,role:xa.value,idempotencyKey:f,portrait:Aa.value.trim()||void 0,background:Ca.value.trim()||void 0,hp:u,max_hp:_,alive:u>0,stats:Object.keys(p).length>0?p:void 0}),S=typeof h.actor_id=="string"?h.actor_id.trim():"";if(!S)throw new Error("생성 응답에 actor_id가 없습니다.");const A=Sa.value.trim();A&&await mc(e,S,A),Se.value=S,Gt.value=S,o||(as.value=""),is.value="ok",N(`Actor 생성 완료: ${S}`,"success"),await Pt()}catch(f){is.value="error",N(f instanceof Error?f.message:"Actor 생성에 실패했습니다.","error")}};return i`
    <div class="trpg-control-box">
      <div class="trpg-control-grid">
        <div class="trpg-control-field">
          <label>Name</label>
        ...
        <div class="trpg-control-grid">
          ...
          <div class="trpg-control-field">
            ...
            <input
              ...
              min="1"
              value=${wa.value}
              onInput=${o=>{const l=o.target.value;wa.value=l,N_(l)}}
              placeholder="20"
            />
          </div>
  ...
  `}function W_({state:t,nowMs:e}){var f;const n=jt.value||((f=t.session)==null?void 0:f.room)||"",s=t.join_gate,a=ba.value,o=v(a)?a:null,l=(t.party??[]).filter(h=>h.role!=="dm"),d=Gt.value.trim(),m=l.some(h=>h.id===d),_=m?d:d?"__manual__":"",u=async()=>{const h=Gt.value.trim(),S=ss.value.trim();if(!n||!h){N("Room/Actor가 필요합니다.","warning");return}vt.value="checking";try{const A=await vc(n,h,S||void 0);ba.value=A,vt.value="ok",N("참가 가능 여부를 갱신했습니다.","success")}catch(A){vt.value="error";const C=A instanceof Error?A.message:"참가 가능 여부 확인에 실패했습니다.";N(C,"error")}},p=async()=>{var T,w;const h=Gt.value.trim(),S=ss.value.trim(),A=ya.value.trim();if(!n||!h||!S){N("Room/Actor/Keeper가 필요합니다.","warning");return}if(!fs(e))return;const C=((T=t.current_round)==null?void 0:T.phase)??((w=t.session)==null?void 0:w.status)??"unknown";if(ei("Mid-Join 승인 요청",n,C)){vt.value="requesting";try{const P=await _c({room_id:n,actor_id:h,keeper_name:S,role:ha.value,...A?{name:A}:{}});ba.value=P;const k=v(P)?Dn(P,"granted",!1):!1,R=v(P)?pt(P,"reason_code",""):"";k?N("Mid-Join이 승인되었습니다.","success"):N(`Mid-Join이 거절되었습니다${R?`: ${R}`:""}`,"warning"),vt.value=k?"ok":"error",Pt()}catch(P){vt.value="error";const k=P instanceof Error?P.message:"Mid-Join 요청에 실패했습니다.";N(k,"error")}finally{Bs()}}};return i`
    <div class="trpg-control-box">
  ...
  `}function Wr({state:t}){const e=[...t.contribution_ledger??[]].sort((n,s)=>(s.score??0)-(n.score??0)).slice(0,8);return e.length===0?i`<div class="empty-state" style="font-size:13px;">No contribution data yet</div>`:i`
    <div class="trpg-round-list">
      ${e.map(n=>i`
  ...
  `}function Br({state:t}){var n;const e=t.current_round;return e?i`
  ...
  `:null}function Gr(){const t=Za.value;if(!t)return i`<div class="empty-state" style="font-size:13px;">Run Round 결과가 아직 없습니다.</div>`;const e=t.summary,n=v(e)?e:null,a=(Array.isArray(t.statuses)?t.statuses:[]).filter(v).slice(-8),o=t.canon_check,l=v(o)?o:null,d=l&&Array.isArray(l.warnings)?l.warnings.filter(R=>typeof R=="string").slice(0,3):[],m=l&&Array.isArray(l.violations)?l.violations.filter(R=>typeof R=="string").slice(0,3):[],_=n?Dn(n,"advanced",!1):!1,u=n?pt(n,"progress_reason",""):"",p=n?pt(n,"progress_detail",""):"",f=n?St(n,"player_successes",0):0,h=n?St(n,"player_required_successes",0):0,S=n?Dn(n,"dm_success",!1):!1,A=n?St(n,"timeouts",0):0,C=n?St(n,"unavailable",0):0,T=n?St(n,"reprompts",0):0,w=n?St(n,"npc_attacks",0):0,P=n?St(n,"keeper_timeout_sec",0):0,k=n?St(n,"roll_audit_count",0):0;return i`
    <div style="display:grid; gap:10px;">
      ...
      ${a.length>0?i`
          <div class="trpg-round-list">
            ${a.map(R=>{const G=pt(R,"status","unknown"),W=pt(R,"actor_id","-"),$=pt(R,"role","-"),O=pt(R,"reason",""),Y=pt(R,"action_type",""),K=pt(R,"reply","");return i`
  ...
  `}function B_({state:t,nowMs:e}){var l,d,m;const n=jt.value||((l=t.session)==null?void 0:l.room)||"",s=((d=t.current_round)==null?void 0:d.phase)??((m=t.session)==null?void 0:m.status)??"unknown",a=Fr(e),o=D_(e);return i`
    <${I} title="조작 안전 잠금" style="margin-bottom:16px;" semanticId="lab.trpg">
      <div class="trpg-control-lock ${a?"locked":"unlocked"}">
        ...
        <div style="display:flex; gap:8px; margin-top:10px; flex-wrap:wrap;">
          ${a?i`<button class="trpg-run-btn recommend" onClick=${()=>z_(n,s)}>잠금 해제 (120초)</button>`:i`<button class="trpg-run-btn secondary" onClick=${()=>{Bs(),N("조작 잠금으로 전환했습니다.","success")}}>즉시 다시 잠금</button>`}
        </div>
      </div>
    <//>
  ...
  `}function Q_(){var d,m,_,u,p;const t=Po.value,e=Ua.value;if(nt(()=>{if(typeof window>"u"||typeof window.setInterval!="function")return;const f=window.setInterval(()=>{co.value=Date.now()},1e3);return()=>{window.clearInterval(f)}},[]),e&&!t)return i`<div class="loading-indicator">Loading TRPG state...</div>`;if(!t)return i`
      <div class="section">
        <h2>TRPG</h2>
    ...
    <div>
      ...
      <div style="display:flex; gap:8px; align-items:center; justify-content:space-between; margin-bottom:8px;">
        <div style="font-size:11px; color:#8ea9d6;">
          room: ${jt.value||((d=t.session)==null?void 0:d.room)||"-"} · phase: ${((m=t.current_round)==null?void 0:m.phase)??((_=t.session)==null?void 0:_.status)??"-"}
        </div>
  ...
  `}const Gs=g(new Set(["broadcast","tasks","keepers","system"]));function Z_(t){const e=new Set(Gs.value);e.has(t)?e.delete(t):e.add(t),Gs.value=e}const Ci=g(null);function Jr(t){Ci.value=t}function tf(t){return t.kind==="board"?"broadcast":t.kind==="tasks"?"tasks":t.kind==="keepers"?"keepers":"system"}const ef=ht(()=>{const t=Gs.value;return $s.value.filter(e=>t.has(tf(e)))}),nf=12e4,sf=ht(()=>{const t=li.value,e=Date.now();return yt.value.map(n=>{const s=n.name.trim().toLowerCase(),a=t.get(s)??null;let o="idle";if(n.status==="active"||n.status==="busy"){const l=a==null?void 0:a.lastActivityAt;l?o=e-new Date(l).getTime()>nf?"stale":"working":o="working"}else(n.status==="offline"||n.status==="inactive")&&(o="stale");return{name:n.name,emoji:n.emoji??"",koreanName:n.koreanName??null,state:o,currentTask:n.current_task,motion:a}})}),af=ht(()=>{const t=li.value;return yt.value.filter(e=>e.status==="active"||e.status==="busy"||e.status==="listening"||e.status==="idle").map(e=>{const n=e.name.trim().toLowerCase(),s=t.get(n),a=(s==null?void 0:s.activeAssignedCount)??0;let o="calm";return a>=3?o="hot":a>=1&&(o="normal"),{name:e.name,emoji:e.emoji??"",koreanName:e.koreanName??null,currentTask:e.current_task,lastActivityAt:(s==null?void 0:s.lastActivityAt)??null,lastActivityText:(s==null?void 0:s.lastActivityText)??null,assignedCount:a,pressure:o}}).sort((e,n)=>{const s={hot:0,normal:1,calm:2};return s[e.pressure]-s[n.pressure]})});function uo(t){return t.kind==="board"?"live-event-broadcast":t.kind==="tasks"?"live-event-task":t.kind==="keepers"?"live-event-keeper":"live-event-system"}function of(t){const e=t.eventType;return e==="broadcast"?"broadcast":e==="agent_joined"?"joined":e==="agent_left"?"left":e==="task_update"?"task":e==="board_post"?"post":e==="board_comment"?"comment":e==="keeper_heartbeat"?"heartbeat":e==="keeper_handoff"?"handoff":e==="keeper_compaction"?"compact":e==="keeper_guardrail"?"guardrail":t.kind==="board"?"board":t.kind==="tasks"?"task":t.kind==="keepers"?"keeper":"system"}function rf(t){switch(t){case"working":return"pulse-working";case"stale":return"pulse-stale";default:return"pulse-idle"}}function lf(){const t=sf.value,e=Ci.value;return t.length===0?i`
  ...
  `}const cf=[{kind:"broadcast",label:"Broadcast",cssClass:"live-event-broadcast"},{kind:"tasks",label:"Task",cssClass:"live-event-task"},{kind:"keepers",label:"Keeper",cssClass:"live-event-keeper"},{kind:"system",label:"System",cssClass:"live-event-system"}];function df(){const t=Gs.value;return i`
        ...
        ${t.length===0?i`<div class="activity-empty">No events matching filters</div>`:t.map((e,n)=>i`
            ...
            >
              <div class="activity-item-head">
                <span class="activity-kind-chip ${uo(e)}">${of(e)}</span>
  ...
  `}function pf(t){switch(t){case"hot":return"focus-pressure-hot";case"normal":return"focus-pressure-normal";default:return"focus-pressure-calm"}}function mf(t){switch(t){case"hot":return"High";case"normal":return"Active";default:return"Calm"}}function vf(){const t=af.value,e=Ci.value;return i`
  ...
  `}function _f(){const t=Zt.value;return i`
  ...
  `}function $f(){const t=Nt.value,e=(t==null?void 0:t.pending_confirms.length)??0,n=(t==null?void 0:t.sessions.length)??0,s=(t==null?void 0:t.keepers.length)??0;return i`
    <section class="rail-card">
      <div class="rail-card-head">
        <h3>개입 바로가기</h3>
  ...
  `}function hf(){const t=E.value.tab,e=ni.find(s=>s.id===t),n=po.find(s=>s.id===(e==null?void 0:e.group));return i`
    ...
    <div class="app-shell">
      ...
      <div class="dashboard-layout">
        ...
        <main class="dashboard-main">
          ${Ka.value&&!Zt.value?i`<div class="loading-indicator">Loading dashboard...</div>`:i`<${yf} />`}
        </main>
      </div>
  ...
  `}const mo=document.getElementById("app");mo&&el(i`<${bf} />`,mo);export{im as _};
