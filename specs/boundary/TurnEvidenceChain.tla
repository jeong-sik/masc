...
vars == <<next_turn, started, agent_core_checkpoint_ref, tool_log_ref, raw_trace_ref,
...
ObserveToolLog ==
    ...
    /\ UNCHANGED <<next_turn, started, agent_core_checkpoint_ref, raw_trace_ref,
                  execution_receipt_ref, runtime_lens_visible, terminal>>

ObserveRawTrace ==
    /\ \E t \in started \ raw_trace_ref :
        raw_trace_ref' = raw_trace_ref \cup {t}
    /\ UNCHANGED <<next_turn, started, agent_core_checkpoint_ref, tool_log_ref,
                  execution_receipt_ref, runtime_lens_visible, terminal>>
...
ChainComplete(t) ==
    /\ t \in agent_core_checkpoint_ref
    /\ t \in tool_log_ref
    /\ t \in raw_trace_ref
