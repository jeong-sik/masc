    ...
    {[
      {
        ...
        "profiles": [
          { "name": "keeper_unified",
            ...
            "candidates": [ { "model": "remote-code:model-a",
                              "config_weight": 50,
                              "effective_weight": 50,
                              "success_rate": 1.0,
                              "in_cooldown": false } , ... ],
    ...
    {[
      {
        ...
        "audit_runs": [
          { "id": "cascade-audit-...",
            ...
            "error_category": "..."?,
            "configured": ["remote-code:auto", ...],
            "primary": "remote-code:auto" | null,
            "selected": "remote-code:auto" | null,
            "total_ms": <int>,
            "hops": [
              { "i": 0,
                "model": "remote-code:auto",
