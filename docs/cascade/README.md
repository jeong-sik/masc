...
| `lib/cascade/cascade_health_tracker.ml` | cooldown, effective weight, trust score |
| `lib/cascade/cascade_trust.ml` | trust kill switch + hardcoded calibration constants |
