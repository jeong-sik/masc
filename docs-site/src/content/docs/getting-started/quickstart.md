...
are required. This guide targets **0.36.1**. Check publication on
...
## First conversation with `imp` (0.36.1)

This is the 0.36.1 installation contract. Check the release tag and asset
