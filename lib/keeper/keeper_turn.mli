...
module For_testing : sig
  ...
  val direct_no_progress_retry_reason :
    Masc_agent_core.Error.sdk_error -> Keeper_error_classify.degraded_retry_reason option
  ...
  val run_direct_no_progress_retry_loop :
    ...
    setup_retry_runtime:
      (string ->
       (Keeper_turn_runtime_budget.runtime_execution, Masc_agent_core.Error.sdk_error) result) ->
