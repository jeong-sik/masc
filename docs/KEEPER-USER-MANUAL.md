...
OAS pin metadata is generated from `scripts/oas-agent-sdk-pin.sh`. Current dependency floor: `agent_sdk >= 0.170.2`, runtime pin: `feature/structured-replay-metadata@7b4bc4658ccbcbd085a1014c43a9a717f01f21f3`, declared base version: `v0.170.2`. 최신성 검증이 필요할 때는 문서에 적힌 숫자보다 `dune-project`와 pin script를 우선 truth source로 본다.
