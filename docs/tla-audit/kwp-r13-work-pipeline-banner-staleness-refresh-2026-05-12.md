...
| Actual keeper exec surface: `keeper_exec_board / _context / _fs / _masc / _memory` | Still accurate; dedicated PR helper wrappers are no longer part of the active surface | keep |
