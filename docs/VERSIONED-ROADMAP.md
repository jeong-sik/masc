...
Carry a requested change through verification, recover by checking the effects
already applied, and preserve those properties as concurrent work grows.
...
| Reproducible product proof | Reproduce the claim from an installed release and inspect it in the UI | G5 |
