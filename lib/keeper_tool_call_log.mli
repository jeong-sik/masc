...
val consume_truncation_info : keeper_name:string -> unit -> int * int option
...
val read_recent : ?keeper_name:string -> ?n:int -> unit -> Yojson.Safe.t list

(** [read_window ?keeper_name ~window_hours ()] returns entries within the
    trailing [window_hours]. Non-positive windows return [[]]. *)
val read_window : ?keeper_name:string -> window_hours:float -> unit -> Yojson.Safe.t list
...
val read_latest : ?keeper_name:string -> unit -> Yojson.Safe.t option
