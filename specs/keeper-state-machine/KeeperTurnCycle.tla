...
(*   turn_phase           | type turn_phase                          | lib/keeper/keeper_registry.ml:63-68 *)
(*   decision_stage       | type decision_stage                      | lib/keeper/keeper_registry.ml:70-74 *)
(*   cascade_state        | type cascade_state                       | lib/keeper/keeper_registry.ml:76-81 *)
...
(*     line 386   mark_turn_started                                        *)
(*     line 404   mark_turn_measurement                                    *)
(*     line 420   set_turn_decision_stage                                  *)
(*     line 424   set_turn_cascade_state                                   *)
(*     line 437   set_turn_selected_model                                  *)
(*     line 441   prepare_turn_retry_after_compaction                      *)
(*     line 452   mark_turn_gate_rejected_by_name                          *)
(*     line 472   mark_turn_finished                                       *)
(*                                                                         *)
(*   lib/keeper/keeper_unified_turn.ml -- top-level turn orchestration     *)
(*     line 1806  mark_turn_started        (StartTurn)                     *)
(*     line 1812  set_turn_decision_stage  (GuardOk -- when measurement bound) *)
(*     line 1819  mark_turn_finished       (FinishTurn -- in finally)      *)
(*     line 1886/1922/1938  set_turn_cascade_state  (CascadeTrying/Done/Exhausted) *)
(*     line 1935  set_turn_selected_model  (CascadeDone)                   *)
(*     line 2058  prepare_turn_retry_after_compaction  (RetryAfterCompaction) *)
(*                                                                         *)
(*   lib/keeper/keeper_agent_run.ml -- tool disclosure / policy selection  *)
(*     line 1591  set_turn_decision_stage = Decision_tool_policy_selected  *)
(*     line 1594  set_turn_cascade_state  = Cascade_selecting              *)
(*       (matches SelectToolPolicy action)                                 *)
(*                                                                         *)
(*   lib/keeper/keeper_guards.ml -- pre_tool_use override / approval gate  *)
(*     line 120   mark_turn_gate_rejected_by_name  (GateRejected)          *)
(*                                                                         *)
