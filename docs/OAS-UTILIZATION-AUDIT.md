...
OAS Pin Snapshot: dependency floor `0.131.0`, runtime pin `main@25658baa9b9dfdc812fa707590a3123b39bf83f5`, declared base version `v0.131.0`
...
`masc-mcp` keeps the runtime pin ratcheted against upstream `main`, while the dependency floor tracks the pinned SDK declaration in `agent_sdk.opam`. Generated snapshot: runtime pin `main@25658baa9b9dfdc812fa707590a3123b39bf83f5`, declared base version `v0.131.0`, dependency floor `0.131.0`.
