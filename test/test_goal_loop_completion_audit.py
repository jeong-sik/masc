...
class GoalLoopCompletionAuditTest(unittest.TestCase):
    ...
    def test_completion_audit_attaches_prompt_closeout_checklist(self) -> None:
        ...
        self.assertEqual(checklist_evidence["status_counts"]["PASS"], 12)
        self.assertEqual(checklist_evidence["status_counts"]["PARTIAL"], 7)
        self.assertEqual(checklist_evidence["status_counts"]["BLOCKED"], 2)
        self.assertEqual(checklist_evidence["non_pass_requirements"], 9)
        self.assertEqual(
            checklist_evidence["requirements_with_tracking_issue_refs"],
            9,
        )
        self.assertEqual(checklist_evidence["tracking_issue_refs_total"], 5)
...
<<<<<<< HEAD
        self.assertEqual(checklist_evidence["artifact_refs_total"], 120)
        self.assertEqual(checklist_evidence["artifact_refs_resolved"], 120)
...
||||||| parent of 992034c60e (docs(goal-loop): record live verify metric failures)
...
=======
        ...
        self.assertEqual(checklist_evidence["artifact_ref_anchors_total"], 11)
        self.assertEqual(checklist_evidence["artifact_ref_anchors_resolved"], 11)
>>>>>>> 992034c60e (docs(goal-loop): record live verify metric failures)
        ...
        self.assertEqual(closeout_evidence["incomplete_requirements"], 11)
        self.assertEqual(closeout_evidence["non_pass_requirements"], 11)
        self.assertEqual(
...
<<<<<<< HEAD
        self.assertEqual(checklist_evidence["artifact_refs_total"], 117)
        self.assertEqual(checklist_evidence["artifact_refs_resolved"], 116)
||||||| parent of 992034c60e (docs(goal-loop): record live verify metric failures)
...
>>>>>>> 992034c60e (docs(goal-loop): record live verify metric failures)
    ...
    def test_completion_audit_rejects_missing_prompt_artifact_ref_anchors(self) -> None:
        ...
        self.assertFalse(checklist_evidence["artifact_refs_all_resolved"])
<<<<<<< HEAD
        self.assertEqual(checklist_evidence["artifact_refs_total"], 116)
        self.assertEqual(checklist_evidence["artifact_refs_resolved"], 115)
...
>>>>>>> 992034c60e (docs(goal-loop): record live verify metric failures)
    ...
    def test_completion_audit_cli_can_fail_until_goal_is_closeable(self) -> None:
        ...
        self.assertEqual(prompt_closeout["evidence"]["incomplete_requirements"], 11)
