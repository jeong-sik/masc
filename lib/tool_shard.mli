...
val tools_of_shards : string list -> Llm.tool_def list
...
val base_tools : Llm.tool_def list
(** Core tools: time_now, context_status, memory_search. *)

val board_tools : Llm.tool_def list
...
val keeper_llm_tools : Llm.tool_def list
