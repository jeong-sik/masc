...
| agent core backend 5종 분리 이미 존재 | `wc -l ~/me/workspace/yousleepwhen/agent core/lib/llm_provider/backend_*.ml` | 2026-05-05T17:58:00+09:00 | High | Provider-D 1550 + Provider-A 210 + Provider-F 363 + Ollama 641 + Provider-K 452 |
| `backend.mli` signature 부재 | `lsd ~/me/workspace/yousleepwhen/agent core/lib/llm_provider/backend.mli` → ENOENT | 2026-05-05T17:58:00+09:00 | High | Sprint 2 신규 |
