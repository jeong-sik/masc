...
val usage_of_response : Masc_agent_core_response.api_response -> Masc_agent_core.Types.api_usage
...
val sanitize_message_utf8 : Masc_agent_core.Types.message -> Masc_agent_core.Types.message

(** Sanitize text content blocks in a list of messages. *)
val sanitize_messages_utf8 : Masc_agent_core.Types.message list -> Masc_agent_core.Types.message list
