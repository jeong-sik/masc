(** Keeper_runtime_trust_timeline — timeline event builders and
    sort/selection logic for keeper runtime trust visualization.
    JSON accessors and utility functions are in
    [Keeper_runtime_trust_timeline_json]. *)

include Keeper_runtime_trust_timeline_json
