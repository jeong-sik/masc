...
(* Merge the main ceiling with Fusion status's independently measured +336
   JSON bytes, preserving main's existing headroom without adding merge slack.
   CI measures the combined production surface. *)
let ceiling_bytes = 114_500 + 336
