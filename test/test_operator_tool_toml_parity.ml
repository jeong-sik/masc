...
(* name, description, input_schema (keys sorted). The order is
   Tool_name.Operator_name.all, the variant's declaration order since #33597
   derived the advertised and remote surfaces from the type. *)
let expected =
