(** Context-bound task tool handlers. *)
...
include module type of Tool_task_contract_gate
...
type task_owner_hooks =
  ...
  ; keeper_tool_names :
      Workspace_core.config -> agent_name:string -> string list option
...
val default_task_owner_hooks : task_owner_hooks
...
val log_task_transition_failed : agent_name:string -> Masc_domain.masc_error -> unit
...
val agent_allowed_tool_names : context -> string list option
...
val persisted_contract_rejection :
  ctx:context -> task_opt:Masc_domain.task option -> notes:string -> string option
