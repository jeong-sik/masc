...
| `Enable_thinking` | `Top_level_preserve_thinking` | Top-level `enable_thinking` plus separate `preserve_thinking` | Preserve historical reasoning only when requested |
