      ...
      return html`
        <div class="error-card rounded my-3 border border-[var(--bad)]/30 bg-[rgba(10,22,40,0.92)] p-5 flex gap-4 items-start shadow-sm" role="alert">
          ...
          <div class="flex-1 min-w-0">
            ...
            <pre class="text-sm whitespace-pre-wrap opacity-80 text-[var(--text-body)] overflow-x-auto bg-[var(--black-20)] p-2 rounded" tabindex="0">${this.state.error.message}</pre>
            <button type="button"
