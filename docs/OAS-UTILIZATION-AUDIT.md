...
OAS Pin Snapshot: dependency floor `0.118.2`, runtime pin `main@9a0fdb89e1e65765299383a8370a0f57b8092fa4`, declared base version `v0.118.2`
...
`masc-mcp` keeps the runtime pin ratcheted against upstream `main`, while the dependency floor tracks the pinned SDK declaration in `agent_sdk.opam`. Generated snapshot: runtime pin `main@9a0fdb89e1e65765299383a8370a0f57b8092fa4`, declared base version `v0.118.2`, dependency floor `0.118.2`.
