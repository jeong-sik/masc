...
|---|---|---|---|---|
| 0001 | Det/NonDet Boundary Hardening, Emotional Recovery Loop, and Adversarial Harness | Draft | 96a954fdcc 2026-06-20 | - |
| 0002 | Keeper 11-State Machine + Det/NonDet Boundary Formalization | reference | 96a954fdcc 2026-06-20 | - |
| 0003 | Keeper Composite Lifecycle Observer | reference | 96a954fdcc 2026-06-20 | - |
| 0004 | OCaml ↔ TypeScript shared contract — SSE + gRPC-web | Active | 96a954fdcc 2026-06-20 | - |
| 0005 | Typed Capability Substrate for Local Exec Core | Draft | 96a954fdcc 2026-06-20 | - |
| 0006 | Keeper Surface And Sandbox | Draft | 96a954fdcc 2026-06-20 | - |
| 0008 | Keeper Credential Provider | Draft | 96a954fdcc 2026-06-20 | - |
| 0009 | Runtime Trust Phase 2: Operator Recommendations + Opt-in Persist | Draft | 96a954fdcc 2026-06-20 | - |
| 0010 | ocamlformat config reconciliation | Implemented | 96a954fdcc 2026-06-20 | - |
| 0012 | Mid-Turn Progress Probe | Draft | 96a954fdcc 2026-06-20 | - |
| 0019 | Keeper Credential Unification | Draft | 96a954fdcc 2026-06-20 | - |
| 0020 | Keeper heartbeat — Event Layer / Policy Layer separation | Active | 96a954fdcc 2026-06-20 | - |
| 0022 | Runtime Attempt Liveness Contract | Draft | 96a954fdcc 2026-06-20 | - |
| 0024 | Ollama Runtime Integration + KV Cache Optimization | Draft | 96a954fdcc 2026-06-20 | - |
| 0025 | Tiered Small-Model Runtime (4B → 9B → 70B+) | Draft | 96a954fdcc 2026-06-20 | - |
| 0027 | Tension Type Safety and Configurable Severity | Draft | 96a954fdcc 2026-06-20 | - |
| 0029 | Dashboard Fiber-Batched Aggregation | Active | 96a954fdcc 2026-06-20 | - |
| 0032 | Environment Knob Unification | Draft | 96a954fdcc 2026-06-20 | - |
| 0034 | d — release_stale_claims agent-side sync | Draft | 96a954fdcc 2026-06-20 | - |
| 0035 | Cognitive IDE Master Plan Integration | Draft | 96a954fdcc 2026-06-20 | - |
| 0036 | oas Cognitive Mapping (companion to RFC-0035) | Draft | 96a954fdcc 2026-06-20 | - |
| 0037 | Local-first Keeper Enablement: Harness/User Boundary | Draft | 96a954fdcc 2026-06-20 | - |
| 0038 | Runtime Routing Intent Preservation | Draft | 96a954fdcc 2026-06-20 | RFC-0038-phase-2-keeper-identity-canonical.md |
| 0041 | Runtime Routing Architecture — Group/Item Hierarchy with Health-Aware Fallback | Draft | 96a954fdcc 2026-06-20 | - |
| 0042 | Closed sum type for keeper turn terminal code | Active | 96a954fdcc 2026-06-20 | - |
| 0043 | Distribute legacy metrics backend metric ownership to domain modules | Active | 96a954fdcc 2026-06-20 | - |
| 0044 | Typed persistence read-drop reason + Result-based reads | Active | 96a954fdcc 2026-06-20 | - |
| 0045 | SDK turn boundary alignment with MASC keeper FSM | Draft | 96a954fdcc 2026-06-20 | - |
| 0046 | Keeper Detail FSM Hub as SSOT | Active | 96a954fdcc 2026-06-20 | - |
| 0047 | `oas_*` adapter family decomposition (consumer-only OAS boundary) | Draft | 96a954fdcc 2026-06-20 | - |
| 0049 | Dashboard Surface Telemetry Foundation | Draft | 96a954fdcc 2026-06-20 | - |
| 0050 | Dashboard Component Ownership Decomposition | Active | 96a954fdcc 2026-06-20 | - |
| 0051 | run_named closure decomposition | Active | 96a954fdcc 2026-06-20 | - |
| 0052 | Boot-time Required Invariants (typed) | Implemented | 96a954fdcc 2026-06-20 | - |
| 0053 | Tool Dispatch Session-Local Handles | Implemented | 96a954fdcc 2026-06-20 | - |
| 0054 | PPX for Typed Capability Substrate Phase 2 (codegen track) | Active | 96a954fdcc 2026-06-20 | - |
| 0056 | Incremental Sub-Library Extraction from Flat masc Library | Active | 96a954fdcc 2026-06-20 | - |
| 0057 | Tool Descriptor Codegen — `[@@deriving tool]` via Build-Time Generation | Draft | 96a954fdcc 2026-06-20 | - |
| 0058 | Terminal Fallback Capability Exemption | Draft | 96a954fdcc 2026-06-20 | RFC-0058-phase-5-erase-provider-variant.md |
| 0062 | Typed `Tool_result.t` + Typed `Sdk_*` Blocker Class (Reverse-Engineered Initi... | Draft | 96a954fdcc 2026-06-20 | - |
| 0063 | Telemetry Feedback Loop & Cooperative Scheduling Safety | Draft | 96a954fdcc 2026-06-20 | - |
| 0064 | Descriptor-Owned Tool Surface | Superseded | 96a954fdcc 2026-06-20 | - |
| 0065 | Keeper Tool Selection Lifecycle - TLA+ Coverage Extension | Active | 96a954fdcc 2026-06-20 | - |
| 0067 | Goal-Scope Observation→Claim Atomicity | Draft | 96a954fdcc 2026-06-20 | - |
| 0068 | Typed `Keeper_turn_disposition` (operator-facing closed sum) | Draft | 96a954fdcc 2026-06-20 | - |
| 0069 | Awareness Channel Split | Active | 96a954fdcc 2026-06-20 | - |
| 0070 | Keeper Sandbox Runtime — Pure/Edge Separation | Active | 96a954fdcc 2026-06-20 | - |
| 0071 | Exhaustive Match Sweep Codemod — Eliminate N-of-M `_ -> false/None` Anti-Pattern | Implemented | 96a954fdcc 2026-06-20 | - |
| 0072 | Type-encoded keeper sub-FSM transitions (runtime + turn_phase) | Implemented | 96a954fdcc 2026-06-20 | - |
| 0073 | Tool Readiness Probe — Typed Precondition + Runtime Gap Disclosure | Implemented | 96a954fdcc 2026-06-20 | - |
| 0074 | Sandbox Credential Auto-provision | Retired | 96a954fdcc 2026-06-20 | - |
| 0075 | Keeper Tools Smoke — Exhaustive Dispatch Coverage Regression Gate | Implemented | 96a954fdcc 2026-06-20 | - |
| 0076 | Tool Readiness Notification Channel | Retired | 96a954fdcc 2026-06-20 | - |
| 0077 | Write-side silent failure — typed propagation | Implemented | 96a954fdcc 2026-06-20 | - |
| 0078 | RFC Number Reservation Ledger + CI Collision Guard | Implemented | 96a954fdcc 2026-06-20 | - |
| 0079 | Log row typed encoder + silent-drop removal | Implemented | 96a954fdcc 2026-06-20 | - |
| 0080 | Tool registry SSOT — collapse multi-source membership into typed Keeper resol... | Implemented | 96a954fdcc 2026-06-20 | - |
| 0081 | OAS Telemetry Envelope Context & Keeper/Goal Pivot Timeline | Implemented | 96a954fdcc 2026-06-20 | - |
| 0082 | Keeper `last_blocker` auto-clear + runtime recovery escalation | Implemented | 96a954fdcc 2026-06-20 | - |
| 0083 | Dashboard system-actor convention typed unification | Implemented | 96a954fdcc 2026-06-20 | - |
| 0084 | Keeper→Tool Dispatch Unification + 100% Trace/Telemetry | Implemented | 96a954fdcc 2026-06-20 | - |
| 0086 | Keeper namespace bulk promotion to sub-library | Implemented | 96a954fdcc 2026-06-20 | - |
| 0087 | Tool Dispatch Path Unification + Legacy Purge | Implemented | 96a954fdcc 2026-06-20 | - |
| 0088 | Counter-as-Fix → Result Propagation (umbrella scoping) | Active | 96a954fdcc 2026-06-20 | - |
| 0089 | String Classifier to Typed Variant — direct replacement, no lint | Implemented | 96a954fdcc 2026-06-20 | - |
| 0090 | Write-side success-model attribution — finish N-of-M migration | Implemented | 96a954fdcc 2026-06-20 | - |
| 0091 | Execute tool: cmd string → typed Argv schema (lexer/validator 박멸) | Implemented | 96a954fdcc 2026-06-20 | - |
| 0093 | Board persistence — path unification (snapshot vs append) | Implemented | 96a954fdcc 2026-06-20 | - |
| 0094 | Compact cooldown semantics split — typed write anchor vs check anchor | Implemented | 96a954fdcc 2026-06-20 | - |
| 0095 | Provider-D-compat provider streaming wire-up | Implemented | 96a954fdcc 2026-06-20 | - |
| 0096 | Keeper Turn Contract — multi-turn reasoning + runtime SPOF root-fix | Withdrawn | 96a954fdcc 2026-06-20 | - |
| 0097 | Keeper sandbox container reuse (long-running sandbox per keeper) | Active | 96a954fdcc 2026-06-20 | - |
| 0098 | Typed JSON-RPC error envelope & production-code silent-failure lint | Implemented | 96a954fdcc 2026-06-20 | - |
| 0099 | Session lifecycle — typed events, explicit eviction, resume backpressure | Active | 96a954fdcc 2026-06-20 | - |
| 0100 | Streamable HTTP as default transport (MCP 2025-03-26) | Active | 96a954fdcc 2026-06-20 | - |
| 0101 | FD accountant — generic Eio.Pool extension to cover all spawn classes | Active | 96a954fdcc 2026-06-20 | - |
| 0102 | Pre-turn runtime availability gate — reuse, not new surface | Implemented | 96a954fdcc 2026-06-20 | - |
| 0103 | Log retention opt-in + JSONL volume root reduction | Draft | 96a954fdcc 2026-06-20 | - |
| 0104 | Keeper task → default repo binding (sandbox cwd disambiguation) | Draft | 96a954fdcc 2026-06-20 | - |
| 0105 | OpenAI-compat boundary: Agent_sdk.Error.t → HTTP status + typed envelope | Implemented | 96a954fdcc 2026-06-20 | - |
| 0106 | Cancel-safe try-with discipline (Eio.Cancel.Cancelled propagation) | Active | 96a954fdcc 2026-06-20 | - |
| 0107 | Outbound HTTP stack consolidation — pooled keep-alive, scoped Switch, Docker ... | Active | 96a954fdcc 2026-06-20 | - |
| 0108 | PR / Worktree Operation Safety Gates | Implemented | 96a954fdcc 2026-06-20 | - |
| 0109 | Cdal_evidence_gate — typed verdict consultation | Active | 96a954fdcc 2026-06-20 | - |
| 0110 | Tool-pair atomicity at write boundary — sunset compaction repair fabrication | Implemented | 96a954fdcc 2026-06-20 | - |
| 0111 | Goal mint atomicity — auto-goal uniqueness invariant at write boundary | Implemented | 96a954fdcc 2026-06-20 | - |
| 0112 | Typed JSON parse boundary — eliminate silent-drop fallback across read sites | Implemented | 96a954fdcc 2026-06-20 | - |
| 0113 | KeeperReactionLiveness L1–L5 runtime — phased OCaml mirror of TLA+ design ground | Implemented | 96a954fdcc 2026-06-20 | - |
| 0114 | KSM event precondition enforcement at apply_event boundary | Implemented | 96a954fdcc 2026-06-20 | - |
| 0116 | KCR fallback cap mechanism parity — explicit counter at spec ↔ visited-list a... | Implemented | 96a954fdcc 2026-06-20 | - |
| 0117 | KCR item-health representation parity — typed Degraded variant + spec cooldow... | Implemented | 96a954fdcc 2026-06-20 | - |
| 0118 | KCT NoTerminalRuntime S1 — typed Result at select_runtime boundary + Zombie m... | Implemented | 96a954fdcc 2026-06-20 | - |
| 0119 | Observer spec mapping table drift lint — guard-marker validator for OCaml↔TLA... | Implemented | 96a954fdcc 2026-06-20 | - |
| 0120 | Cross-spec set-name divergence — 3-class classification framework (STALE / DE... | Implemented | 96a954fdcc 2026-06-20 | - |
| 0121 | Config-dir resolution — single active root, no implicit fallback | Active | 96a954fdcc 2026-06-20 | - |
| 0122 | Keeper disk pressure — process-local fleet failure mode beyond FD | Implemented | 96a954fdcc 2026-06-20 | - |
| 0123 | Briefing last_event fabrication — option-typed write boundary | Implemented | 96a954fdcc 2026-06-20 | - |
| 0124 | Keeper Admission Denial Boundary | Draft | 96a954fdcc 2026-06-20 | - |
| 0125 | Bounded subprocess discipline: per-call Switch scope + Fiber.first timeout race | Active | 96a954fdcc 2026-06-20 | - |
| 0126 | Silent fallback discipline (typed split for option/result wildcard arms) | Implemented | 96a954fdcc 2026-06-20 | - |
| 0127 | Runtime Fast-Fail (Provider Health Phase 3) + Fiber Termination Provenance | Active | 96a954fdcc 2026-06-20 | - |
| 0129 | Runtime attempt idle-cap: kill the reserve_fraction band-aid | Implemented | 96a954fdcc 2026-06-20 | - |
| 0131 | Shell Command Gate facade — multi-caller IR-first validation | Implemented | 96a954fdcc 2026-06-20 | - |
| 0132 | Redaction SSOT — `runtime` boundary-label private type | Implemented | 96a954fdcc 2026-06-20 | - |
| 0134 | Persistence read-drop root fix (recovery story for RFC-0044) | Active | 96a954fdcc 2026-06-20 | - |
| 0135 | Dashboard Keeper Operational Surface — Typed SSOT | Implemented | 96a954fdcc 2026-06-20 | - |
| 0136 | Keeper Unified Turn — Stage Decomposition of run_keeper_cycle | Implemented | 96a954fdcc 2026-06-20 | - |
| 0137 | Host FD pressure → Keeper pause (safety-net for Docker VM FD accumulation) | Active | 96a954fdcc 2026-06-20 | - |
| 0138 | Dashboard Snapshot Lock-Free Immutable Architecture | Implemented | 96a954fdcc 2026-06-20 | - |
| 0139 | Agent Status Vocabulary SSOT | Active | 96a954fdcc 2026-06-20 | - |
| 0140 | Dashboard Wire-Format Codec Layer | Implemented | 96a954fdcc 2026-06-20 | - |
| 0141 | TOML Field Resolution Typed Variant for repo_manager | Implemented | 96a954fdcc 2026-06-20 | - |
| 0142 | runtime_error_classify Decomposition + Typed JSON-Extraction Variant | Active | 96a954fdcc 2026-06-20 | - |
| 0143 | keeper_runtime_profile Typed Catalog Query Result | Active | 96a954fdcc 2026-06-20 | - |
| 0144 | Workaround Sunset Tracking for Keeper Dedup Carryovers | Active | 96a954fdcc 2026-06-20 | - |
| 0145 | Permissive-Silent-Fallback Elimination | Active | 96a954fdcc 2026-06-20 | - |
| 0147 | Keeper Agent Run — Stage Decomposition of run_turn Step 8 | Draft | 96a954fdcc 2026-06-20 | - |
| 0148 | Typed `tool_error` Variant for LLM-Facing Tool Failure Surface | Implemented | 96a954fdcc 2026-06-20 | - |
| 0149 | Audit-Driven Telemetry-as-Fix Sunset | Implemented | 96a954fdcc 2026-06-20 | - |
| 0150 | Keeper Attention Signal — backend 단일 typed wire envelope | Implemented | 96a954fdcc 2026-06-20 | - |
| 0151 | 4-metric monotone-decrease ratchet for code-smell metrics | Withdrawn | 96a954fdcc 2026-06-20 | - |
| 0152 | Keeper Auto-Resume for All Pause Paths | Active | 96a954fdcc 2026-06-20 | - |
| 0153 | Runtime Backpressure & Tier Admission | Implemented | 96a954fdcc 2026-06-20 | - |
| 0154 | System_error_class typed SSOT — close substring-classifier loop across backen... | Implemented | 96a954fdcc 2026-06-20 | - |
| 0155 | System_log_category Typed SSOT — emit-side closed sum for ops log taxonomy | Active | 96a954fdcc 2026-06-20 | - |
| 0156 | OAS total timeout 제거 — turn timeout + stream idle 두 layer로 단순화 | Implemented | 96a954fdcc 2026-06-20 | - |
| 0157 | Runtime pre-turn required-tool filter — provider capability boundary | Active | 96a954fdcc 2026-06-20 | - |
| 0158 | OAS retry-admission typed error — split server timeout from didn't-try | Draft | 96a954fdcc 2026-06-20 | - |
| 0159 | Reason_internal_error typed split — close string-classifier catch-all | Draft | 96a954fdcc 2026-06-20 | - |
| 0160 | Shell IR 1급 승격 — single-source decision substrate across producer/classifier/... | Implemented | 96a954fdcc 2026-06-20 | - |
| 0161 | Tool Error Hint Symmetry Enforcement | Draft | 96a954fdcc 2026-06-20 | - |
| 0162 | JSONL Write-Path FD Pressure Root-Fix | Draft | 96a954fdcc 2026-06-20 | - |
| 0163 | Tier-group capability profile route canonicalization — typed dedup and bypass... | Withdrawn | 96a954fdcc 2026-06-20 | - |
| 0164 | Voice tool abstraction integrity — keeper voice-flag deletion + runtime bound... | Draft | 96a954fdcc 2026-06-20 | - |
| 0167 | CLI-Tool-B omission-dedup + Llama endpoint-discovery feature-path purge | Draft | 96a954fdcc 2026-06-20 | - |
| 0168 | Dashboard upstream-LLM-provider color palette purge | Draft | 96a954fdcc 2026-06-20 | - |
| 0169 | Dashboard common/* MCP-client attribution header purge | Draft | 96a954fdcc 2026-06-20 | - |
| 0170 | Dashboard provider-b palette closure (RFC-0168 N-of-M follow-up) | Draft | 96a954fdcc 2026-06-20 | - |
| 0171 | Design-canvas + ui_kits mock data vendor purge | Draft | 96a954fdcc 2026-06-20 | - |
| 0172 | Big-bang vendor purge across docs, audits, RFCs, design-system, tests | Draft | 96a954fdcc 2026-06-20 | - |
| 0173 | OCaml lib/bin/test vendor purge (identifier + string literal) | Draft | 96a954fdcc 2026-06-20 | - |
| 0174 | Dashboard substring classifier to typed — TypeScript | Draft | 96a954fdcc 2026-06-20 | - |
| 0175 | Godfile decomposition Wave D — keeper core 5-file split | Draft | 96a954fdcc 2026-06-20 | - |
| 0176 | OAS vendor-purge migration — consume agent_sdk 0.198.0 | Implemented | 96a954fdcc 2026-06-20 | - |
| 0177 | Phonebook internal vendor-coupled enum purge | Draft | 96a954fdcc 2026-06-20 | - |
| 0178 | Types Sub-library Extraction with `_intf.ml` mli-only Surface (typed-SSOT) | Draft | 96a954fdcc 2026-06-20 | - |
| 0179 | ToolDescriptor Ecosystem Coverage Extension to Workspace Tools | Draft | 96a954fdcc 2026-06-20 | - |
| 0180 | 24h Runtime ERROR 7-Pattern Sweep Roadmap | Draft | 96a954fdcc 2026-06-20 | - |
| 0181 | Capability/intent-based runtime SSOT | Draft | 96a954fdcc 2026-06-20 | - |
| 0182 | masc_* Workspace Tool Descriptor Projection + Tool_spec SSOT Consolidation | Draft | 96a954fdcc 2026-06-20 | - |
| 0184 | Runtime phonebook typed roundtrip for protocol/flavor/provider identifiers | Draft (Deferred) | 96a954fdcc 2026-06-20 | - |
| 0189 | Typed Tool_result.result variant — eliminating boolean blindness in tool disp... | Draft | 96a954fdcc 2026-06-20 | - |
| 0190 | Descriptor as Visibility/Metadata SSOT — Surface Projection from descriptor.p... | Draft | 96a954fdcc 2026-06-20 | - |
| 0191 | Descriptor as Policy SSOT — Consolidate keeper_tool_policy axes onto descript... | Draft | 96a954fdcc 2026-06-20 | - |
| 0192 | Runtime Deadline Propagation — Cumulative budget invariant for runtime tier-wait | Draft | 96a954fdcc 2026-06-20 | - |
| 0194 | Tool Surface Semantic SSOT — Guiding Principles | Draft | 96a954fdcc 2026-06-20 | - |
| 0197 | Runtime Attempt Watchdog — Per-Candidate Wrap + Shared Deadline | Draft | 96a954fdcc 2026-06-20 | - |
| 0198 | Execute Typed Redirection (Shell IR Syntax Leakage Closure) | Draft | 96a954fdcc 2026-06-20 | - |
| 0199 | Evidence-Driven Auto-Approval for Deterministic Verification Tasks | Draft | 96a954fdcc 2026-06-20 | - |
| 0200 | Time constants 를 leaf library 로 분리 | Draft | 96a954fdcc 2026-06-20 | - |
| 0201 | Activity Events Wait-Free Snapshot | Draft | 96a954fdcc 2026-06-20 | - |
| 0203 | In-process Discord connector | Implemented (Phase 3 cutover landed 2026-05-29) | 96a954fdcc 2026-06-20 | - |
| 0204 | Dashboard Read Serving Isolation from Fleet Compute | Draft | 96a954fdcc 2026-06-20 | - |
| 0205 | Keeper Module Consolidation — Eliminate Facade Anti-Pattern | Draft | 96a954fdcc 2026-06-20 | - |
| 0206 | Runtime 개념 — runtime→Runtime 재탄생 | Draft | 96a954fdcc 2026-06-20 | - |
| 0207 | Per-keeper LLM runtime routing | Draft | 96a954fdcc 2026-06-20 | - |
| 0208 | Typed Domain Classification — String Convention → Variant | Draft | 96a954fdcc 2026-06-20 | - |
| 0210 | Keeper Playground Repo Currency (fetch + fast-forward, work-preserving) | Draft | 96a954fdcc 2026-06-20 | - |
| 0211 | Persona ⊥ {model, runtime}, opaque runtime id, runtime.toml keeper-assignment... | Draft | 96a954fdcc 2026-06-20 | - |
| 0212 | Separate keeper-exposure policy from the Tool-dispatch routing tag (module_ta... | Draft | 96a954fdcc 2026-06-20 | - |
| 0213 | Keeper sandbox/playground isolation model (fix sandbox_repo_not_ready + macOS... | Draft | 96a954fdcc 2026-06-20 | - |
| 0214 | OTel GenAI Semantic Convention Migration | Draft | 96a954fdcc 2026-06-20 | - |
| 0215 | Keeper sub-library extraction campaign — sequence and per-PR gates | Draft | 96a954fdcc 2026-06-20 | - |
| 0216 | Per-Keeper Decline Memory (orphan-task churn root fix) | Draft | 96a954fdcc 2026-06-20 | - |
| 0217 | Telemetry Backend Otel 단일화 (Retired Backend Purge) | Draft | 96a954fdcc 2026-06-20 | - |
| 0218 | Keeper tool-surface coherence + web-tooling roadmap — phases and per-phase gates | Draft | 96a954fdcc 2026-06-20 | - |
| 0219 | Remove Sandbox Repo Patrol Gates | Draft | 96a954fdcc 2026-06-20 | - |
| 0220 | Decouple keeper liveness from verification state + guaranteed satisfier for e... | Draft | 96a954fdcc 2026-06-20 | - |
| 0221 | Atomic verification submission — task_status as the sole outcome authority | Implemented (steps 1-3 merged #20613/#20617; steps 4-5 measured then dropped, §3.3/§3.4) | 96a954fdcc 2026-06-20 | - |
| 0222 | Typed acceptance criterion + harness-driven completion for checkable tasks | Draft | 96a954fdcc 2026-06-20 | - |
| 0223 | Typed connector surfaces: presence in world prompt, pull-based lane context, ... | Draft | 96a954fdcc 2026-06-20 | - |
| 0224 | Structured completion report for free-text contract items | Draft | 96a954fdcc 2026-06-20 | - |
| 0225 | Per-keeper turn single-flight admission | Draft | 96a954fdcc 2026-06-20 | - |
| 0226 | Ambient lane recording: record-vs-trigger decouple for connector surfaces | Draft | 96a954fdcc 2026-06-20 | - |
| 0227 | Keeper benchmark canary: wire verify -> gated promote -> rollback for per-kee... | Draft | 96a954fdcc 2026-06-20 | - |
| 0228 | Paged lane pull + fact-retention harness: digest without a summarizer | Draft | 96a954fdcc 2026-06-20 | - |
| 0229 | Keeper person notes: deliberate per-speaker memory beyond the log window | Draft | 96a954fdcc 2026-06-20 | - |
| 0230 | Keeper mention/scope reactivity: cursor-free salience to complement pull-base... | Draft | 96a954fdcc 2026-06-20 | - |
| 0232 | Typed lane event model: parse at the write boundary, never re-derive by strin... | Draft | 96a954fdcc 2026-06-20 | - |
| 0233 | Typed turn observability: TurnRecord prompt-block provenance + canonical tool... | Draft | 96a954fdcc 2026-06-20 | - |
| 0234 | Scheduled internal automation with separate execution approval | Draft | 96a954fdcc 2026-06-20 | - |
| 0235 | Voice output transport: browser-addressed audio delivery with device-routed p... | Draft | 96a954fdcc 2026-06-20 | - |
| 0236 | Voice input transport: browser-captured speech-to-text for the dashboard comp... | Draft | 96a954fdcc 2026-06-20 | - |
| 0237 | Eliminate the write_meta ~force escape hatch (route snapshot writes through C... | Draft | 96a954fdcc 2026-06-20 | - |
| 0239 | Semantic-identity guards for keeper memory and anti-thrash | Draft | 96a954fdcc 2026-06-20 | - |
| 0240 | Tool-pair invariant enforced at write-time (eliminate repair-on-read) | Draft | 96a954fdcc 2026-06-20 | - |
| 0241 | external-attention store lifecycle: read-side bound, retention, and typed tai... | Draft | 96a954fdcc 2026-06-20 | - |
| 0242 | Continuity state as system-of-record (retire the prose summary filter) | Draft | 96a954fdcc 2026-06-20 | - |
| 0243 | Memory OS confidence mutability via write-side fact upsert | Draft | 96a954fdcc 2026-06-20 | - |
| 0244 | Memory OS recall: turn-seeded deterministic lexical retrieval, with provenanc... | Draft | 96a954fdcc 2026-06-20 | - |
| 0245 | Exempt goalless tasks from the per-goal WIP claim cap | Draft | 96a954fdcc 2026-06-20 | - |
| 0246 | Wake-cascade Recovery Tombstone | Draft | 96a954fdcc 2026-06-20 | - |
| 0247 | Memory OS purge + LLM-judgment rebuild — implementation plan (phase of RFC-0247) | Draft | 96a954fdcc 2026-06-20 | - |
| 0248 | Announce-as-data — typed observation provenance for board activity | Draft | 96a954fdcc 2026-06-20 | - |
| 0249 | Remove the dead `stale_factor` field (execute RFC-0239/0243/0244/0247) | Draft | 96a954fdcc 2026-06-20 | - |
| 0250 | Stale-run window — give the closed `Idle_turn` variant its first producer | Draft | 96a954fdcc 2026-06-20 | - |
| 0251 | Memory OS: record well, do not value — remove the scoring layer | Draft | 96a954fdcc 2026-06-20 | - |
| 0252 | Fusion: 패널+심판(panel+judge) 심의 루프 (MASC 내장) | Draft | 96a954fdcc 2026-06-20 | - |
| 0253 | Dashboard keeper-v2 surfaces: canonical spacing/radius token scale + off-scal... | Draft | 96a954fdcc 2026-06-20 | - |
| 0254 | Shell IR Approval Gate — Autonomous Production Policy | Draft | 96a954fdcc 2026-06-20 | - |
| 0255 | Shell-IR Path Policy — Typed Path-Scope, Read/Write Asymmetry, and Catastroph... | Draft | 96a954fdcc 2026-06-20 | - |
| 0256 | Migrate hand-rolled Mutex lock/protect/unlock to Mutex.protect | Draft | 96a954fdcc 2026-06-20 | - |
| 0257 | Per-keeper memory execution lane | Draft | 96a954fdcc 2026-06-20 | - |
| 0258 | Adversarial Review — Grounded Verdict & Unified Verdict→Action Routing | Draft | 96a954fdcc 2026-06-20 | - |
| 0259 | Memory OS — Volatile Claim Grounding, Retraction & Decay | Draft | 96a954fdcc 2026-06-20 | - |
| 0260 | Provider health gate and audited failover | Draft | 96a954fdcc 2026-06-20 | - |
| 0261 | gRPC LSP failed-initialize FD/process teardown | Draft | 96a954fdcc 2026-06-20 | - |
| 0262 | Completion authority typing — closing the force-bypass and framing completion... | Draft | 96a954fdcc 2026-06-20 | - |
| 0263 | Owner-priority cooperative preemption of in-flight autonomous turns | Draft | 96a954fdcc 2026-06-20 | - |
| 0264 | Memory OS recall outcome-anchored eval harness | Draft | 96a954fdcc 2026-06-20 | - |
| 0265 | Capability-driven proactive runtime reroute (modality-gated) | Draft | 96a954fdcc 2026-06-20 | - |
| 0266 | Fusion async-completion wake + in-progress 가시성 | Draft | 96a954fdcc 2026-06-20 | - |
| 0267 | Make task↔goal links visible and explicitly assignable | Draft | 96a954fdcc 2026-06-20 | - |
| 0268 | Prompt ↔ Closed-sum Variant Sync Gate | Draft | 96a954fdcc 2026-06-20 | - |
| 0269 | Process Critic Loop for Keeper Work Traces | Draft | fae5c47f35 2026-06-20 | - |
| 0270 | CI Gate merge guard: block merges on a non-success CI Gate and trip on red main | Draft | (untracked) | - |
