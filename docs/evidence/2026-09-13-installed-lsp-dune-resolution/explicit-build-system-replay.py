...
out=pathlib.Path('/tmp/masc-lsp-direct-same-fixture-explicit-dune-20260913');out.mkdir()
...
proc=subprocess.Popen(['/Users/dancer/.opam/5.5.0/bin/ocamllsp'],cwd=fixture,env=dict(os.environ,OCAMLLSP_PROJECT_BUILD_SYSTEM='/Users/dancer/.opam/5.5.0/bin/dune'),stdin=subprocess.PIPE,stdout=subprocess.PIPE,stderr=subprocess.PIPE)
