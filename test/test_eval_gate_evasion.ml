...
let test_normalize_mixed () =
  ...
  Alcotest.(check string) "mixed evasion normalized"
    "git push --force" n
...
let () =
  Alcotest.run "Eval_gate_evasion" [
    ("normalization", [
      Alcotest.test_case "strip single quotes" `Quick test_normalize_strips_single_quotes;
      Alcotest.test_case "strip double quotes" `Quick test_normalize_strips_double_quotes;
      Alcotest.test_case "collapse whitespace" `Quick test_normalize_collapses_whitespace;
      Alcotest.test_case "strip tabs/newlines" `Quick test_normalize_strips_tabs_newlines;
    ...
    ("false_positives", [
      ...
      Alcotest.test_case "nested quotes bypass" `Quick test_false_positive_nested_quotes;
    ]);
    ("safe_commands", [
