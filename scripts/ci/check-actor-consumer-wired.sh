...
#   runtime actors) introduced multiple actor-pattern modules.
...
#     - runtime actors must have a production caller
...
if [ "$failed" -ne 0 ]; then
  ...
  echo "Every actor entry point requires a production consumer."
