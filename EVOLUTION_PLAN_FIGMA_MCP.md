...
2.  **Continuous Heartbeat Regression**: A "forever-running" loop that verifies code against design.
    - **Visual**: Multimodal LLM compares Playwright screenshots vs. Figma exports.
...
5.  **Multimodal a11y Audit**: Using vision-capable LLMs to audit both the design intent and the generated DOM to ensure screen-reader friendliness and WCAG compliance at the source.
