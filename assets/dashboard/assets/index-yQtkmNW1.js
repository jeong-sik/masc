var vd=Object.defineProperty;var fd=(e,t,n)=>t in e?vd(e,t,{enumerable:!0,configurable:!0,writable:!0,value:n}):e[t]=n;var Nt=(e,t,n)=>fd(e,typeof t!="symbol"?t+"":t,n);import{e as gd,_ as $d,c as g,b as ze,y as ae,d as Yr,A as hd,G as yd}from"./vendor-kuFK4-oj.js";(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const a of document.querySelectorAll('link[rel="modulepreload"]'))s(a);new MutationObserver(a=>{for(const i of a)if(i.type==="childList")for(const l of i.addedNodes)l.tagName==="LINK"&&l.rel==="modulepreload"&&s(l)}).observe(document,{childList:!0,subtree:!0});function n(a){const i={};return a.integrity&&(i.integrity=a.integrity),a.referrerPolicy&&(i.referrerPolicy=a.referrerPolicy),a.crossOrigin==="use-credentials"?i.credentials="include":a.crossOrigin==="anonymous"?i.credentials="omit":i.credentials="same-origin",i}function s(a){if(a.ep)return;a.ep=!0;const i=n(a);fetch(a.href,i)}})();var o=gd.bind($d);const bd=["mission","proof","execution","tools","live","memory","governance","planning","intervene","command","lab"],Xr={tab:"mission",params:{},postId:null};function Xi(e){return!!e&&bd.includes(e)}function Ro(e){try{return decodeURIComponent(e)}catch{return e}}function zo(e){const t={};return e&&new URLSearchParams(e).forEach((s,a)=>{t[a]=s}),t}function kd(e){const n=e.replace(/^\/+/,"").split("/").filter(Boolean);return n[0]==="dashboard"?n.slice(1):n}function Zr(e,t){if(e[0]==="chains"){const i={...t,surface:"chains"};return e[1]==="operation"&&e[2]&&(i.operation=Ro(e[2])),{tab:"command",params:i,postId:null}}if(e[0]==="lab"){const i={...t};return e[1]&&(i.surface=Ro(e[1])),{tab:"lab",params:i,postId:null}}const n=e[0],s=t.tab;return{tab:Xi(n)?n:Xi(s)?s:"mission",params:t,postId:null}}function Ys(e){const t=(e||"").replace(/^#/,"").trim();if(!t)return Xr;const n=Ro(t);let s=n,a;if(n.startsWith("?"))s="",a=n.slice(1);else{const c=n.indexOf("?");c>=0&&(s=n.slice(0,c),a=n.slice(c+1))}!a&&s.includes("=")&&!s.includes("/")&&(a=s,s="");const i=zo(a),l=kd(s);return Zr(l,i)}function xd(e,t){const n=e.replace(/^\/+/,"").split("/").filter(Boolean);if(n[0]!=="dashboard")return null;const s=n.slice(1);if(s.length===0)return{...Xr,params:zo(t.replace(/^\?/,""))};if(s[0]==="assets"||s[0]==="credits"||s[0]==="lodge")return null;const a=zo(t.replace(/^\?/,""));return Zr(s,a)}function el(e){const t=e.tab==="lab"&&e.params.surface?`lab/${encodeURIComponent(e.params.surface)}`:e.tab,n=Object.entries(e.params).filter(([a])=>!(a==="tab"||e.tab==="lab"&&a==="surface"));if(n.length===0)return`#${t}`;const s=new URLSearchParams(n);return`#${t}?${s.toString()}`}const D=g(Ys(window.location.hash));window.addEventListener("hashchange",()=>{D.value=Ys(window.location.hash)});function re(e,t){const n={tab:e,params:t??{}};window.location.hash=el(n)}function Sd(e){window.location.hash=`#memory?post=${encodeURIComponent(e)}`}function Cd(){if(window.location.hash&&window.location.hash!=="#"){D.value=Ys(window.location.hash);return}const e=xd(window.location.pathname,window.location.search);if(e){D.value=e;const t=el(e);window.history.replaceState(null,"",`${window.location.pathname}${window.location.search}${t}`);return}window.location.hash="#mission",D.value=Ys(window.location.hash)}const Zi="masc_dashboard_sse_session_id",Ad=1e3,Td=15e3,dt=g(!1),Oa=g(0),tl=g(null),Xs=g([]);function Id(){let e=sessionStorage.getItem(Zi);return e||(e=typeof crypto.randomUUID=="function"?`dash_${crypto.randomUUID()}`:`dash_${Date.now().toString(36)}_${Math.random().toString(36).slice(2,10)}`,sessionStorage.setItem(Zi,e)),e}const Ld=200;function Rd(e,t,n="system",s={}){const a={agent:e,text:t,timestamp:Date.now(),kind:n,...s};Xs.value=[a,...Xs.value].slice(0,Ld)}function Po(e,t=88){const n=(e??"").replace(/\s+/g," ").trim();return n?n.length>t?`${n.slice(0,t-3)}...`:n:void 0}function er(e,t){const n=Po(t);return n?`${e}: ${n}`:`New ${e.toLowerCase()}`}function Ie(e,t,n,s,a={}){Rd(e,t,n,{eventType:s,...a})}let Ne=null,Jt=null,Mo=0;function nl(){Jt&&(clearTimeout(Jt),Jt=null)}function zd(){if(Jt)return;Mo++;const e=Math.min(Mo,5),t=Math.min(Td,Ad*Math.pow(2,e));Jt=setTimeout(()=>{Jt=null,sl()},t)}function sl(){nl(),Ne&&(Ne.close(),Ne=null);const e=new URLSearchParams(window.location.search),t=new URLSearchParams,n=e.get("agent")??e.get("agent_name"),s=e.get("token");n&&t.set("agent",n),s&&t.set("token",s),t.set("session_id",Id());const a=t.toString()?`/sse?${t.toString()}`:"/sse",i=new EventSource(a);Ne=i,i.onopen=()=>{Ne===i&&(Mo=0,dt.value=!0)},i.onerror=()=>{Ne===i&&(dt.value=!1,i.close(),Ne=null,zd())},i.onmessage=l=>{try{const c=JSON.parse(l.data);Oa.value++,tl.value=c,Pd(c)}catch{}}}function Pd(e){const t=e.type,n=e.agent??e.author??e.from??e.from_agent??"";switch(t){case"agent_joined":Ie(n,"Joined","system","agent_joined");break;case"agent_left":Ie(n,"Left","system","agent_left");break;case"broadcast":Ie(n,`${(e.message??e.content??"").slice(0,80)}`,"system","broadcast");break;case"task_update":Ie(n,`Task: ${e.task_id??""} -> ${e.status??""}`,"tasks","task_update");break;case"board_post":case"masc/board_post":Ie(n,er("Post",e.content??e.message),"board","board_post",{author:e.author??n,preview:Po(e.content??e.message),postId:e.post_id});break;case"board_comment":case"masc/board_comment":Ie(n,er("Comment",e.content??e.message),"board","board_comment",{author:e.author??n,preview:Po(e.content??e.message),postId:e.post_id});break;case"keeper_heartbeat":Ie(e.name??n,`Heartbeat gen=${e.generation??"?"} ctx=${e.context_ratio!=null?Math.round(e.context_ratio*100)+"%":"?"}`,"keepers","keeper_heartbeat");break;case"keeper_handoff":Ie(e.name??n,`Handoff gen ${e.from_generation??"?"} -> ${e.to_generation??"?"} (${e.to_model??"?"})`,"keepers","keeper_handoff");break;case"keeper_compaction":Ie(e.name??n,`Compaction saved ${e.saved_tokens??"?"} tokens (${e.trigger??"?"})`,"keepers","keeper_compaction");break;case"keeper_guardrail":Ie(e.name??n,`Guardrail: ${e.reason??"stopped"}`,"keepers","keeper_guardrail");break;default:Ie(n,t,"system","unknown")}}function Md(){nl(),Ne&&(Ne.close(),Ne=null),dt.value=!1}function _(e){return typeof e=="object"&&e!==null&&!Array.isArray(e)}function r(e){return typeof e=="string"&&e.trim()!==""?e.trim():void 0}function d(e){return typeof e=="number"&&Number.isFinite(e)?e:void 0}function j(e){return typeof e=="boolean"?e:void 0}function F(e){return Array.isArray(e)?e.map(t=>typeof t=="string"?t.trim():"").filter(Boolean):[]}function ve(e,t=[]){if(Array.isArray(e))return e;if(!_(e))return[];for(const n of t){const s=e[n];if(Array.isArray(s))return s}return[]}function le(e){if(typeof e=="string"&&e.trim()!=="")return e;if(!(typeof e!="number"||!Number.isFinite(e)||e<=0))return new Date(e*1e3).toISOString()}function al(){return new URLSearchParams(window.location.search)}const jd="masc_dashboard_agent_name";function Ed(){var e;try{return((e=localStorage.getItem(jd))==null?void 0:e.trim())||null}catch{return null}}function ol(){const e=al(),t={},n=e.get("token"),s=Ed(),a=e.get("agent")??e.get("agent_name")??s;return n&&(t.Authorization=`Bearer ${n}`),a&&(t["X-MASC-Agent"]=a),t}function il(){return{...ol(),"Content-Type":"application/json"}}const Nd=15e3,ui=3e4,Dd=6e4,tr=new Set([408,425,429,500,502,503,504]);class as extends Error{constructor(n){const s=n.method.toUpperCase(),a=n.timeout===!0,i=a?`${s} ${n.path}: timeout after ${n.timeoutMs??0}ms`:`${s} ${n.path}: ${n.status??"unknown"} ${n.statusText??""}`.trim();super(i);Nt(this,"method");Nt(this,"path");Nt(this,"status");Nt(this,"statusText");Nt(this,"timeout");this.name="ApiRequestError",this.method=s,this.path=n.path,this.status=n.status,this.statusText=n.statusText,this.timeout=a}}async function pi(e,t,n){const s=new AbortController,a=setTimeout(()=>s.abort(),n);try{return await fetch(e,{...t,signal:s.signal})}catch(i){if(i instanceof Error&&i.name==="AbortError"){const l=typeof t.method=="string"?t.method.toUpperCase():"GET";throw new as({method:l,path:e,timeout:!0,timeoutMs:n})}throw i}finally{clearTimeout(a)}}function Od(){var t,n;const e=al();return((t=e.get("agent"))==null?void 0:t.trim())||((n=e.get("agent_name"))==null?void 0:n.trim())||"dashboard-user"}async function se(e){const t=await pi(e,{headers:ol()},Nd);if(!t.ok)throw new as({method:"GET",path:e,status:t.status,statusText:t.statusText});return t.json()}function wd(e){return new Promise(t=>setTimeout(t,e))}function qd(e){const t=e.match(/\b(\d{3})\b/);if(!t)return null;const n=t[1];if(!n)return null;const s=Number.parseInt(n,10);return Number.isFinite(s)?s:null}function Fd(e){if(e instanceof as)return e.timeout||typeof e.status=="number"&&tr.has(e.status);if(!(e instanceof Error))return!1;if(/timeout after \d+ms/i.test(e.message))return!0;const t=qd(e.message);return t!==null&&tr.has(t)}async function wa(e,t,n=2){let s=0;for(;;)try{return await t()}catch(a){if(!Fd(a)||s>=n)throw a;const i=250*(s+1);console.warn(`[dashboard/api] ${e} failed (attempt ${s+1}), retrying in ${i}ms`,a),await wd(i),s+=1}}async function Ke(e,t,n,s=ui){const a=await pi(e,{method:"POST",headers:{...il(),...n??{}},body:JSON.stringify(t)},s);if(!a.ok)throw new as({method:"POST",path:e,status:a.status,statusText:a.statusText});return a.json()}async function Kd(e,t,n,s=ui){const a=await pi(e,{method:"POST",headers:{...il(),...n??{}},body:JSON.stringify(t)},s);if(!a.ok)throw new as({method:"POST",path:e,status:a.status,statusText:a.statusText});return a.text()}function Ud(e){const t=e.split(`
`).find(s=>s.startsWith("data: ")),n=t?t.slice(6).trim():e.trim();return JSON.parse(n)}function Hd(e){var t,n,s,a,i,l,c;if((t=e.error)!=null&&t.message)throw new Error(e.error.message);if((n=e.result)!=null&&n.isError){const p=((a=(s=e.result.content)==null?void 0:s[0])==null?void 0:a.text)??"MCP tool call failed";throw new Error(p)}return((c=(l=(i=e.result)==null?void 0:i.content)==null?void 0:l[0])==null?void 0:c.text)??""}async function _t(e,t){const n=await Kd("/mcp",{jsonrpc:"2.0",method:"tools/call",params:{name:e,arguments:t},id:Math.floor(Date.now()%1e6)},{Accept:"application/json, text/event-stream"},Dd),s=Ud(n);return Hd(s)}function Bd(){return se("/api/v1/dashboard/shell")}function Wd(){return se("/api/v1/dashboard/execution")}function Gd(e,t){const n=new URLSearchParams;return n.set("sort_by",e),t!=null&&t.excludeSystem&&n.set("exclude_system","true"),se(`/api/v1/dashboard/memory${n.toString()?`?${n}`:""}`)}function Jd(){return wa("fetchDashboardGovernance",async()=>{const e=await se("/api/v1/dashboard/governance"),t=Array.isArray(e.items)?e.items.map(i=>mu(i)).filter(i=>i!==null):[],n=Array.isArray(e.pending_actions)?e.pending_actions.map(i=>cl(i)).filter(i=>i!==null):[],s=t.filter(i=>i.kind==="debate").map(i=>({id:i.id,topic:i.topic,status:i.status,argument_count:i.evidence_refs.length,created_at:i.last_activity_at??void 0})),a=t.filter(i=>i.kind==="consensus").map(i=>({id:i.id,topic:i.topic,initiator:i.related_agents[0]||"system",votes:i.votes??0,quorum:i.quorum??0,threshold:i.threshold,state:i.status,created_at:i.last_activity_at??void 0}));return{generated_at:ue(e.generated_at)??void 0,summary:_(e.summary)?{debates:fe(e.summary.debates)??void 0,voting_sessions:fe(e.summary.voting_sessions)??void 0,debates_open:fe(e.summary.debates_open)??void 0,sessions_active:fe(e.summary.sessions_active)??void 0,sessions_without_quorum:fe(e.summary.sessions_without_quorum)??void 0,ready_to_execute:fe(e.summary.ready_to_execute)??void 0,oldest_open_debate_age_s:typeof e.summary.oldest_open_debate_age_s=="number"?e.summary.oldest_open_debate_age_s:null,last_activity_age_s:typeof e.summary.last_activity_age_s=="number"?e.summary.last_activity_age_s:null,judge_online:typeof e.summary.judge_online=="boolean"?e.summary.judge_online:void 0,judge_last_seen_at:ue(e.summary.judge_last_seen_at)}:void 0,debates:s,sessions:a,items:t,activity:Array.isArray(e.activity)?e.activity.map(i=>_u(i)).filter(i=>i!==null):[],judge:vu(e.judge),pending_actions:n}})}function Vd(){return se("/api/v1/dashboard/semantics")}function Qd(){return se("/api/v1/dashboard/mission")}function Yd(e){const t=`?session_id=${encodeURIComponent(e)}`;return se(`/api/v1/dashboard/session${t}`)}function Xd(e=!1){return se(`/api/v1/dashboard/mission/briefing${e?"?force=1":""}`)}function Zd(e,t){const n=new URLSearchParams;e&&n.set("session_id",e),t&&n.set("operation_id",t);const s=n.toString();return se(`/api/v1/dashboard/proof${s?`?${s}`:""}`)}function eu(){return se("/api/v1/dashboard/planning")}function tu(){return se("/api/v1/tool-metrics")}function nu(){return se("/api/v1/dashboard/tools")}function su(){return se("/api/v1/operator")}function rl(e={}){const t=new URLSearchParams;e.targetType&&t.set("target_type",e.targetType),e.targetId&&t.set("target_id",e.targetId),e.includeWorkers!=null&&t.set("include_workers",e.includeWorkers?"true":"false");const n=t.toString();return se(`/api/v1/operator/digest${n?`?${n}`:""}`)}function au(){return se("/api/v1/command-plane")}function ou(){return se("/api/v1/command-plane/summary")}function iu(){return se("/api/v1/chains/summary")}function ru(e){return se(`/api/v1/chains/runs/${encodeURIComponent(e)}`)}function lu(){return se("/api/v1/command-plane/help")}function cu(e,t){const n=new URLSearchParams;e&&n.set("run_id",e),t&&n.set("operation_id",t);const s=n.toString();return se(`/api/v1/command-plane/swarm${s?`?${s}`:""}`)}function du(e,t){const n=new URLSearchParams;e&&n.set("run_id",e),t&&n.set("operation_id",t);const s=n.toString();return se(`/api/v1/command-plane/orchestra${s?`?${s}`:""}`)}function uu(e,t){return Ke(e,t)}function pu(e){switch(e.action_type){case"keeper_message":case"keeper_recover":return 9e4;case"swarm_run_continue":return 6e4;case"swarm_run_rerun":return 12e4;case"swarm_run_abandon":return 3e4;case"lodge_tick":return 45e3;default:return ui}}function qa(e){return Ke("/api/v1/operator/action",e,void 0,pu(e))}function ll(e,t,n="confirm"){return Ke("/api/v1/operator/confirm",{actor:e,confirm_token:t,decision:n})}function ws(e){if(typeof e=="string"&&e.trim())return e;if(typeof e!="number"||Number.isNaN(e))return new Date().toISOString();const t=e<1e12?e*1e3:e;return new Date(t).toISOString()}function ue(e){if(typeof e=="string"){const t=e.trim();return t||null}if(typeof e=="number"&&Number.isFinite(e)){const t=e<1e12?e*1e3:e;return new Date(t).toISOString()}return null}function w(e){if(typeof e!="string")return null;const t=e.trim();return t||null}function cl(e){if(!_(e))return null;const t=k(e.confirm_token??e.token,"").trim();return t?{confirm_token:t,actor:w(e.actor)??void 0,action_type:w(e.action_type)??void 0,target_type:w(e.target_type)??void 0,target_id:w(e.target_id),delegated_tool:w(e.delegated_tool)??void 0,created_at:ue(e.created_at)??void 0,preview:e.preview}:null}function mi(e){return _(e)?{board_post_id:w(e.board_post_id),task_id:w(e.task_id),operation_id:w(e.operation_id),team_session_id:w(e.team_session_id)}:{}}function dl(e){if(!_(e))return null;const t=w(e.action_kind),n=w(e.resolved_tool),s=w(e.target_type),a=w(e.target_id),i=w(e.reason);return!t&&!n&&!s&&!i?null:{action_kind:t??void 0,resolved_tool:n,target_type:s,target_id:a,reason:i??void 0,payload_preview:e.payload_preview}}function ul(e){if(!_(e))return null;const t=w(e.action_type),n=w(e.delegated_tool),s=w(e.confirmation_state),a=ue(e.created_at);return!t&&!n&&!s&&!a?null:{action_type:t??void 0,delegated_tool:n,confirmation_state:s??void 0,created_at:a}}function pl(e){if(!_(e))return null;const t=cl(e.pending_confirm),n=w(e.pending_confirm_token)??(t==null?void 0:t.confirm_token)??null;return{requires_human_gate:typeof e.requires_human_gate=="boolean"?e.requires_human_gate:void 0,pending_confirm:t,pending_confirm_token:n,ready_to_execute:typeof e.ready_to_execute=="boolean"?e.ready_to_execute:void 0}}function ml(e){if(!_(e))return null;const t=w(e.summary),n=w(e.target_id);return!t&&!n?null:{judgment_id:w(e.judgment_id)??void 0,target_kind:w(e.target_kind)??void 0,target_id:n??void 0,status:w(e.status)??void 0,summary:t??void 0,confidence:typeof e.confidence=="number"?e.confidence:null,generated_at:ue(e.generated_at),expires_at:ue(e.expires_at),model_used:w(e.model_used),keeper_name:w(e.keeper_name),evidence_refs:De(e.evidence_refs),recommended_action:dl(e.recommended_action),guardrail_state:pl(e.guardrail_state),executed_route:ul(e.executed_route)}}function mu(e){if(!_(e))return null;const t=k(e.id,"").trim(),n=k(e.topic,"").trim();if(!t||!n)return null;const s=mi(e.context);return{kind:k(e.kind,"debate"),id:t,topic:n,status:k(e.status??e.state,"open"),last_activity_at:ue(e.last_activity_at),truth_summary:w(e.truth_summary)??void 0,judgment_summary:w(e.judgment_summary),confidence:typeof e.confidence=="number"?e.confidence:null,related_agents:De(e.related_agents),context:s,linked_board_post_id:w(e.linked_board_post_id)??s.board_post_id??null,linked_task_id:w(e.linked_task_id)??s.task_id??null,linked_operation_id:w(e.linked_operation_id)??s.operation_id??null,linked_session_id:w(e.linked_session_id)??s.team_session_id??null,recommended_action:dl(e.recommended_action),executed_route:ul(e.executed_route),guardrail_state:pl(e.guardrail_state),evidence_refs:De(e.evidence_refs),approve_count:fe(e.approve_count),reject_count:fe(e.reject_count),abstain_count:fe(e.abstain_count),votes:fe(e.votes),quorum:fe(e.quorum),threshold:typeof e.threshold=="number"?e.threshold:void 0}}function _u(e){if(!_(e))return null;const t=k(e.kind,"").trim();return t?{kind:t,item_kind:w(e.item_kind)??void 0,item_id:w(e.item_id)??void 0,topic:w(e.topic)??void 0,created_at:ue(e.created_at),summary:w(e.summary)??void 0,actor:w(e.actor),index:fe(e.index),decision:w(e.decision)}:null}function vu(e){if(_(e))return{judge_online:typeof e.judge_online=="boolean"?e.judge_online:void 0,refreshing:typeof e.refreshing=="boolean"?e.refreshing:void 0,generated_at:ue(e.generated_at),expires_at:ue(e.expires_at),model_used:w(e.model_used),keeper_name:w(e.keeper_name),last_error:w(e.last_error)}}function fu(e){var a;const t=e.trim(),s=((a=(t.startsWith("[flair:")?t.replace(/^\[flair:[^\]]+\]\s*/i,""):t).split(`
`)[0])==null?void 0:a.trim())||"Untitled post";return s.length<=96?s:`${s.slice(0,93)}...`}function gu(e){if(!_(e))return null;const t=k(e.source,"").trim()||null,n=k(e.state_block,"").trim()||null;return!t&&!n?null:{source:t,state_block:n}}function $u(e){if(!_(e))return null;const t=k(e.id,"").trim(),n=k(e.author,"").trim(),s=k(e.body,"").trim()||k(e.content,"").trim(),a=s;if(!t||!n)return null;const i=H(e.score,0),l=H(e.votes_up,0),c=H(e.votes_down,0),p=H(e.votes,i||l-c),m=H(e.comment_count,H(e.reply_count,0)),u=(()=>{const x=e.flair;if(typeof x=="string"&&x.trim())return x.trim();if(_(x)){const $=k(x.name,"").trim();if($)return $}return k(e.flair_name,"").trim()||void 0})(),f=k(e.created_at_iso,"").trim()||ws(e.created_at),v=k(e.updated_at_iso,"").trim()||(e.updated_at!==void 0?ws(e.updated_at):f),b=k(e.title,"").trim()||fu(s),C=Array.isArray(e.tags)?e.tags.filter(x=>typeof x=="string"&&x.trim()!==""):[];return{id:t,author:n,post_kind:(()=>{const x=k(e.post_kind,"").trim().toLowerCase();return x==="automation"||x==="system"||x==="human"?x:void 0})(),title:b,body:s,content:a,meta:gu(e.meta),tags:C,votes:p,vote_balance:i,comment_count:m,created_at:f,updated_at:v,flair:u,hearth:k(e.hearth,"").trim()||null,visibility:k(e.visibility,"").trim()||void 0,expires_at:k(e.expires_at_iso,"").trim()||(e.expires_at!==void 0&&e.expires_at!==0?ws(e.expires_at):"")||null,hearth_count:H(e.hearth_count,0)}}function hu(e){if(!_(e))return null;const t=k(e.id,"").trim(),n=k(e.post_id,"").trim(),s=k(e.author,"").trim();return!t||!s?null:{id:t,post_id:n,author:s,content:k(e.content,""),created_at:ws(e.created_at)}}async function yu(e){return wa("fetchBoardPost",async()=>{const t=await se(`/api/v1/board/${e}?format=flat`),n=_(t.post)?t.post:t,s=$u(n)??{id:e,author:"unknown",post_kind:"human",title:"Post",body:"",content:"",meta:null,tags:[],votes:0,comment_count:0,created_at:new Date().toISOString(),updated_at:new Date().toISOString(),hearth:null,visibility:"internal",expires_at:null},i=(Array.isArray(t.comments)?t.comments:[]).map(hu).filter(l=>l!==null);return{...s,comments:i}})}function _l(e,t){return Ke("/api/v1/tools/masc_board_vote",{post_id:e,direction:t,vote:t,voter:Od()})}function bu(e,t,n){return Ke("/api/v1/tools/masc_board_comment",{post_id:e,author:t,content:n})}function ku(e){const t=k(e,"").trim().toLowerCase();if(t==="win"||t==="won"||t==="victory")return"victory";if(t==="lose"||t==="lost"||t==="defeat")return"defeat";if(t==="draw"||t==="stalemate"||t==="tie")return"draw"}function pe(...e){for(const t of e){const n=k(t,"");if(n.trim())return n.trim()}return""}function nr(e){const t=ku(pe(e.outcome,e.result,e.result_code));if(!t)return;const n=pe(e.reason,e.reason_code,e.description,e.detail),s=pe(e.summary,e.summary_ko,e.summary_en,e.note),a=pe(e.details,e.details_text,e.text,e.note),i=pe(e.winner,e.winner_name,e.actor_winner,e.winner_actor),l=pe(e.winner_actor_id,e.winner_actor,e.actor_winner_id),c=pe(e.raw_reason,e.raw_reason_code,e.error_message),p=(()=>{const f=e.evidence??e.evidence_ids??e.supporting_events??e.event_ids??[];return typeof f=="string"?[f]:Array.isArray(f)?f.map(v=>{if(typeof v=="string")return v.trim();if(_(v)){const h=k(v.summary,"").trim();if(h)return h;const b=k(v.text,"").trim();if(b)return b;const C=k(v.type,"").trim();return C||k(v.event_id,"").trim()}return""}).filter(v=>v.length>0):[]})(),m=(()=>{const f=H(e.turn,Number.NaN);if(Number.isFinite(f))return f;const v=H(e.turn_number,Number.NaN);if(Number.isFinite(v))return v;const h=H(e.current_turn,Number.NaN);if(Number.isFinite(h))return h;const b=H(e.round,Number.NaN);return Number.isFinite(b)?b:void 0})(),u=pe(e.phase,e.phase_name,e.current_phase,e.phase_id);return{result:t,reason:n||void 0,summary:s||void 0,details:a||void 0,winner:i||void 0,winner_actor_id:l||void 0,evidence:p.length>0?p:void 0,raw_reason:c||void 0,turn:m,phase:u||void 0}}function xu(e,t){const n=_(e.state)?e.state:{};if(k(n.status,"active").toLowerCase()!=="ended")return;const a=[...t].reverse().find(l=>_(l)?k(l.type,"")==="session.outcome":!1),i=_(n.session_outcome)?n.session_outcome:{};if(_(i)&&Object.keys(i).length>0){const l=nr(i);if(l)return l}if(_(a))return nr(_(a.payload)?a.payload:{})}function k(e,t=""){return typeof e=="string"?e:t}function H(e,t=0){return typeof e=="number"&&Number.isFinite(e)?e:t}function fe(e){if(typeof e=="number"&&Number.isFinite(e))return Math.trunc(e);if(typeof e=="string"){const t=Number.parseInt(e.trim(),10);if(Number.isFinite(t))return t}}function Zs(e,t=!1){return typeof e=="boolean"?e:t}function De(e){return Array.isArray(e)?e.map(t=>{if(typeof t=="string")return t.trim();if(_(t)){const n=k(t.name,"").trim(),s=k(t.id,"").trim(),a=k(t.skill,"").trim();return n||s||a}return""}).filter(t=>t.length>0):[]}function Su(e){const t={};if(!_(e)&&!Array.isArray(e))return t;if(_(e))return Object.entries(e).forEach(([n,s])=>{const a=n.trim(),i=k(s,"").trim();!a||!i||(t[a]=i)}),t;for(const n of e){if(!_(n))continue;const s=pe(n.to,n.target,n.actor_id,n.name,n.id),a=pe(n.relationship,n.relation,n.type,n.kind);!s||!a||(t[s]=a)}return t}function Cu(e,t,n){if(e==="dm"||e==="player"||e==="npc")return e;const s=t.trim().toLowerCase();return s==="dm"||s.startsWith("dm-")?"dm":s.startsWith("npc-")||s.startsWith("enemy-")||s.startsWith("mob-")?"npc":/^p\d+$/i.test(s)||s.startsWith("player-")?"player":typeof n=="string"&&n.trim()!==""?n.trim().toLowerCase().includes("dm")?"dm":"player":"npc"}function Ce(e,t,n,s=0){const a=e[t];if(typeof a=="number"&&Number.isFinite(a))return a;if(n){const i=e[n];if(typeof i=="number"&&Number.isFinite(i))return i}return s}const Au=new Set(["str","dex","con","int","wis","cha","strength","dexterity","constitution","intelligence","wisdom","charisma","hp","max_hp","mp","max_mp","level","xp"]);function Tu(e){const t=_(e.stats)?e.stats:{},n={};return Object.entries(t).forEach(([s,a])=>{const i=s.trim();i&&(Au.has(i.toLowerCase())||typeof a=="number"&&Number.isFinite(a)&&(n[i]=a))}),n}function Iu(e,t){if(e!=="dice.rolled")return;const n=H(t.raw_d20,0),s=H(t.total,0),a=H(t.bonus,0),i=k(t.action,"roll"),l=H(t.dc,0);return{notation:l>0?`${i} (DC ${l})`:i,rolls:n>0?[n]:[],total:s,modifier:a}}function Lu(e){const t=JSON.stringify(e);return t?t.length>160?`${t.slice(0,157)}...`:t:""}function Ru(e){const t=e.trim().toLowerCase();return t?t.startsWith("dice.")?"dice":t.startsWith("combat.")||t.includes(".attack")||t.includes(".damage")?"combat":t.includes("actor.")?"actor":t.includes("turn.")||t==="turn.started"||t==="phase.changed"?"turn":t.includes("join.")?"join":t.includes("memory")?"memory":t.includes("world.")?"world":t.includes("narration")?"story":"meta":"meta"}function zu(e,t,n,s){const a=n||t||k(s.actor_id,"")||k(s.actor_name,"");switch(e){case"turn.action.proposed":{const i=k(s.proposed_action,k(s.reply,""));return i?`${a||"actor"}: ${i}`:"Action proposed"}case"turn.action.resolved":{const i=k(s.reply,k(s.result,""));return i?`Resolved: ${i}`:"Action resolved"}case"narration.posted":return k(s.reply,k(s.content,k(s.text,"Narration")));case"dice.rolled":{const i=k(s.action,"roll"),l=H(s.total,0),c=H(s.dc,0),p=k(s.label,""),m=a||"actor",u=c>0?` vs DC ${c}`:"",f=p?` (${p})`:"";return`${m} ${i}: ${l}${u}${f}`}case"turn.started":return`Turn ${H(s.turn,1)} started`;case"phase.changed":return`Phase: ${k(s.phase,"round")}`;case"actor.spawned":return`Actor spawned: ${k(s.name,_(s.actor)?k(s.actor.name,a||"unknown"):a||"unknown")}`;case"actor.claimed":return`${k(s.keeper_name,k(s.keeper,"keeper"))} claimed ${a||"actor"}`;case"actor.released":return`${k(s.keeper_name,k(s.keeper,"keeper"))} released ${a||"actor"}`;case"join.window.opened":return`Join window opened (turn ${H(s.turn,0)})`;case"join.window.closed":return`Join window closed (turn ${H(s.turn,0)})`;case"mid.join.requested":return`Mid-join requested: ${a||k(s.actor_id,"actor")}`;case"mid.join.granted":return`Mid-join granted: ${a||k(s.actor_id,"actor")}`;case"mid.join.rejected":return`Mid-join rejected: ${k(s.reason_code,"unknown")}`;case"memory.signal":{const i=_(s.entity_refs)?s.entity_refs:{},l=k(i.requested_tier,""),c=k(i.effective_tier,""),p=Zs(i.guardrail_applied,!1),m=k(s.summary_en,k(s.summary_ko,"Memory signal"));if(!l&&!c)return m;const u=l&&c?`${l}->${c}`:c||l;return`${m} [${u}${p?" (guardrail)":""}]`}case"world.event":{if(k(s.event_type,"")==="canon.check"){const l=k(s.status,"unknown"),c=k(s.contract_id,"n/a");return`Canon ${l}: ${c}`}return k(s.description,k(s.summary,"World event"))}case"combat.attack":return k(s.summary,k(s.result,"Attack resolved"));case"combat.defense":return k(s.summary,k(s.result,"Defense resolved"));case"session.outcome":return k(s.summary,k(s.outcome,"Session ended"));default:{const i=Lu(s);return i?`${e}: ${i}`:e}}}function Pu(e,t){const n=_(e)?e:{},s=k(n.type,"event"),a=typeof n.actor_id=="string"&&n.actor_id.trim()?n.actor_id.trim():"",i=k(n.actor_name,"").trim()||t[a]||k(_(n.payload)?n.payload.actor_name:"",""),l=_(n.payload)?n.payload:{},c=k(n.ts,k(n.timestamp,new Date().toISOString())),p=k(n.phase,k(l.phase,"")),m=k(n.category,"");return{type:s,actor:i||a||k(l.actor_name,""),actor_id:a||k(l.actor_id,""),actor_name:i,seq:n.seq,room_id:k(n.room_id,""),phase:p||void 0,category:m||Ru(s),visibility:k(n.visibility,k(l.visibility,"public")),event_id:k(n.event_id,""),content:zu(s,a,i,l),dice_roll:Iu(s,l),timestamp:c}}function Mu(e,t,n){var ee,oe;const s=k(e.room_id,"")||n||"default",a=_(e.state)?e.state:{},i=_(a.party)?a.party:{},l=_(a.actor_control)?a.actor_control:{},c=_(a.join_gate)?a.join_gate:{},p=_(a.contribution_ledger)?a.contribution_ledger:{},m=Object.entries(i).map(([W,te])=>{const A=_(te)?te:{},Y=Ce(A,"max_hp",void 0,10),K=Ce(A,"hp",void 0,Y),ne=Ce(A,"max_mp",void 0,0),$t=Ce(A,"mp",void 0,0),U=Ce(A,"level",void 0,1),Pe=Ce(A,"xp",void 0,0),ht=Zs(A.alive,K>0),gn=l[W],$n=typeof gn=="string"?gn:void 0,vs=Cu(A.role,W,$n),fs=fe(A.generation),gs=pe(A.joined_at,A.joinedAt,A.started_at,A.startedAt),$s=pe(A.claimed_at,A.claimedAt,A.assigned_at,A.assignedAt,A.assigned_time),hs=pe(A.last_seen,A.lastSeen,A.last_seen_at,A.lastSeenAt,A.last_active,A.lastActive),ys=pe(A.scene,A.current_scene,A.currentScene,A.world_scene,A.scene_name,A.sceneName),bs=pe(A.location,A.current_location,A.currentLocation,A.position,A.zone,A.area);return{id:W,name:k(A.name,W),role:vs,keeper:$n,archetype:k(A.archetype,""),persona:k(A.persona,""),portrait:k(A.portrait,"")||void 0,background:k(A.background,"")||void 0,traits:De(A.traits),skills:De(A.skills),stats_raw:Tu(A),status:ht?"active":"dead",generation:fs,joined_at:gs||void 0,claimed_at:$s||void 0,last_seen:hs||void 0,scene:ys||void 0,location:bs||void 0,inventory:De(A.inventory),notes:De(A.notes),relationships:Su(A.relationships),stats:{hp:K,max_hp:Y,mp:$t,max_mp:ne,level:U,xp:Pe,strength:Ce(A,"strength","str",10),dexterity:Ce(A,"dexterity","dex",10),constitution:Ce(A,"constitution","con",10),intelligence:Ce(A,"intelligence","int",10),wisdom:Ce(A,"wisdom","wis",10),charisma:Ce(A,"charisma","cha",10)}}}),u=m.filter(W=>W.status!=="dead"),f=xu(e,t),v={phase_open:Zs(c.phase_open,!0),min_points:H(c.min_points,3),window:k(c.window,"round_boundary_only"),last_opened_turn:typeof c.last_opened_turn=="number"?c.last_opened_turn:null,last_closed_turn:typeof c.last_closed_turn=="number"?c.last_closed_turn:null},h=Object.entries(p).map(([W,te])=>{const A=_(te)?te:{};return{actor_id:W,score:H(A.score,0),last_reason:k(A.last_reason,"")||null,reasons:De(A.reasons)}}),b=m.reduce((W,te)=>(W[te.id]=te.name,W),{}),C=t.map(W=>Pu(W,b)),x=H(a.turn,1),S=k(a.phase,"round"),$=k(a.map,""),R=_(a.world)?a.world:{},L=$||k(R.ascii_map,k(R.map,"")),z=C.filter((W,te)=>{const A=t[te];if(!_(A))return!1;const Y=_(A.payload)?A.payload:{};return H(Y.turn,-1)===x}),q=(z.length>0?z:C).slice(-12),I=k(a.status,"active");return{session:{id:s,room:s,status:I==="ended"?"ended":I==="paused"?"paused":"active",round:x,actors:u,created_at:((ee=C[0])==null?void 0:ee.timestamp)??new Date().toISOString()},current_round:{round_number:x,phase:S,events:q,timestamp:((oe=C[C.length-1])==null?void 0:oe.timestamp)??new Date().toISOString()},map:L||void 0,join_gate:v,contribution_ledger:h,outcome:f,party:u,story_log:C,history:[]}}async function ju(e){const t=`?room_id=${encodeURIComponent(e)}`,n=await se(`/api/v1/trpg/events${t}`);return Array.isArray(n.events)?n.events:[]}async function Eu(e){const t=`?room_id=${encodeURIComponent(e)}`,[n,s]=await Promise.all([se(`/api/v1/trpg/state${t}`),ju(e)]);return Mu(n,s,e)}function Nu(e){return Ke("/api/v1/trpg/rounds/run",{room_id:e})}function Du(e){const t="".trim().toLowerCase();if(t)switch(t){case"discussion":case"discuss":case"party_discussion":case"player_discussion":case"action":case"dice":return"round";case"ended":return"end";default:return t}}function Ou(e){const t={room_id:e.roomId,actor_id:e.actorId,action:e.action,stat_value:e.statValue,dc:e.dc};return e.rawD20!=null&&(t.raw_d20=e.rawD20),e.ruleModule&&(t.rule_module=e.ruleModule),Ke("/api/v1/trpg/dice/roll",t)}function wu(e,t){const n=Du();return Ke("/api/v1/trpg/turns/advance",{room_id:e,...n?{phase:n}:{}})}function qu(e,t){var a;const n=(a=t.idempotencyKey)==null?void 0:a.trim(),s={room_id:e};return t.actor_id&&t.actor_id.trim()&&(s.actor_id=t.actor_id.trim()),t.name&&t.name.trim()&&(s.name=t.name.trim()),t.role&&(s.role=t.role),t.archetype&&t.archetype.trim()&&(s.archetype=t.archetype.trim()),t.persona&&t.persona.trim()&&(s.persona=t.persona.trim()),t.portrait&&t.portrait.trim()&&(s.portrait=t.portrait.trim()),t.background&&t.background.trim()&&(s.background=t.background.trim()),t.hp!=null&&(s.hp=t.hp),t.max_hp!=null&&(s.max_hp=t.max_hp),t.alive!=null&&(s.alive=t.alive),Array.isArray(t.traits)&&t.traits.length>0&&(s.traits=t.traits),Array.isArray(t.skills)&&t.skills.length>0&&(s.skills=t.skills),Array.isArray(t.inventory)&&t.inventory.length>0&&(s.inventory=t.inventory),t.stats&&Object.keys(t.stats).length>0&&(s.stats=t.stats),n&&(s.idempotency_key=n),Ke("/api/v1/trpg/actors/spawn",s,n?{"Idempotency-Key":n}:void 0)}function Fu(e,t,n){return Ke("/api/v1/trpg/actors/claim",{room_id:e,actor_id:t,keeper:n})}async function Ku(e,t,n){const s=await _t("trpg.join.eligibility",{room_id:e,actor_id:t,...n?{keeper_name:n}:{}});return JSON.parse(s)}async function Uu(e){const t=await _t("trpg.mid_join.request",e);return JSON.parse(t)}async function Hu(e,t){await _t("masc_broadcast",{agent_name:e,message:t})}async function Bu(e=40){return(await _t("masc_messages",{limit:e})).split(`
`).map(n=>n.trim()).filter(n=>n!=="")}async function Wu(e,t=20){return _t("masc_task_history",{task_id:e,limit:t})}async function Gu(e){const t=await _t("masc_debate_start",{topic:e});try{return JSON.parse(t)}catch{return null}}async function Ju(e){return wa("fetchDebateStatus",async()=>{const t=encodeURIComponent(e),n=await se(`/api/v1/council/debates/${t}/summary`);if(!_(n))return null;const s=_(n.debate)?n.debate:n,a=k(s.id,"").trim(),i=k(s.topic,"").trim();return!a||!i?null:{debate:{id:a,topic:i,status:k(s.status,"open"),created_at:ue(s.created_at_iso??s.created_at),closed_at:ue(s.closed_at)},arguments:Array.isArray(n.arguments)?n.arguments.flatMap(l=>_(l)?[{index:H(l.index,0),agent:k(l.agent,"unknown"),position:k(l.position,"neutral"),content:k(l.content,""),evidence:De(l.evidence),reply_to:fe(l.reply_to)??null,mentions:De(l.mentions),archetype:w(l.archetype),created_at:ue(l.created_at)}]:[]):[],summary:{support_count:_(n.summary)?H(n.summary.support_count,0):H(n.support_count,0),oppose_count:_(n.summary)?H(n.summary.oppose_count,0):H(n.oppose_count,0),neutral_count:_(n.summary)?H(n.summary.neutral_count,0):H(n.neutral_count,0),total_arguments:_(n.summary)?H(n.summary.total_arguments,0):H(n.total_arguments,0),summary_text:_(n.summary)?k(n.summary.summary_text,""):k(n.summary_text,"")},context:mi(n.context),judgment:ml(n.judgment)}})}async function Vu(e){return wa("fetchConsensusSessionSummary",async()=>{const t=encodeURIComponent(e),n=await se(`/api/v1/council/sessions/${t}/summary`);if(!_(n)||!_(n.session))return null;const s=n.session,a=k(s.id,"").trim(),i=k(s.topic,"").trim();return!a||!i?null:{session:{id:a,topic:i,state:k(s.state,"open"),initiator:k(s.initiator,"system"),quorum:H(s.quorum,0),threshold:H(s.threshold,0),created_at:ue(s.created_at),closed_at:ue(s.closed_at)},votes:Array.isArray(n.votes)?n.votes.flatMap(l=>_(l)?[{agent:k(l.agent,"unknown"),decision:k(l.decision,"abstain"),reason:k(l.reason,""),timestamp:ue(l.timestamp),weight:typeof l.weight=="number"?l.weight:void 0,archetype:w(l.archetype)}]:[]):[],summary:{approve_count:_(n.summary)?H(n.summary.approve_count,0):0,reject_count:_(n.summary)?H(n.summary.reject_count,0):0,abstain_count:_(n.summary)?H(n.summary.abstain_count,0):0,quorum_met:_(n.summary)?Zs(n.summary.quorum_met,!1):!1,result:_(n.summary)?w(n.summary.result):null},context:mi(n.context),judgment:ml(n.judgment)}})}function Qu(e,t,n){return _t("masc_keeper_msg",{name:e,message:t})}const Yu=g(""),Ve=g({}),me=g({}),jo=g({}),Eo=g({}),No=g({}),Do=g({}),Qe=g({});function de(e,t,n){e.value={...e.value,[t]:n}}function Xu(e){var n;const t=(n=r(e))==null?void 0:n.toLowerCase();return t==="user"||t==="assistant"||t==="system"||t==="tool"?t:"other"}function Zu(e){switch(e){case"user":return"User";case"assistant":return"Keeper";case"system":return"System";case"tool":return"Tool";default:return"Event"}}function Va(e,t){if(!Array.isArray(e))return[];const n=[];for(const s of e){if(!_(s))continue;const a=r(s.name);if(!a)continue;const i=r(s[t]);t==="summary"?n.push({name:a,summary:i}):n.push({name:a,reason:i})}return n}function ep(e){if(!_(e))return null;const t=r(e.name);return t?{name:t,trigger:r(e.trigger),outcome:r(e.outcome),summary:r(e.summary),reason:r(e.reason)}:null}function tp(e){const t=e.toLowerCase();return t.includes("graphql")?"graphql_error":t.includes("timeout")||t.includes("model")||t.includes("llm")||t.includes("api key")||t.includes("api_key")||t.includes("provider")?"llm_error":"unknown"}function np(e,t){return e==="offline"||e==="degraded"||e==="stale"?"Keeper is not in a healthy reply state. Probe or recover before relying on automation.":t==="quiet_hours"?"Lodge quiet hours are active. Direct messages still work, but scheduled social ticks may look asleep.":t==="min_gap"?"Keeper is inside its proactive cooldown window. Direct messages work now; autonomous check-ins will wait.":t==="never_started"?"Keeper metadata exists but no reply turn has been recorded yet.":"Keeper is reachable. Send a direct message for an immediate response."}function vl(e,t,n){return r(e)??np(t,n)}function fl(e,t){return typeof e=="boolean"?e:t==="recover"}function ea(e){if(!_(e))return null;const t=r(e.health_state),n=r(e.next_action_path),s=r(e.last_reply_status);return!t||!n||!s?null:{health_state:t,quiet_reason:r(e.quiet_reason)??null,next_action_path:n,last_reply_status:s,last_reply_at:le(e.last_reply_at)??null,last_reply_preview:r(e.last_reply_preview)??null,last_error:r(e.last_error)??null,next_eligible_at_s:d(e.next_eligible_at_s)??null,recoverable:fl(e.recoverable,n),summary:vl(e.summary,t,r(e.quiet_reason)??null),keepalive_running:typeof e.keepalive_running=="boolean"?e.keepalive_running:void 0}}function gl(e){return _(e)?{hour:d(e.hour),checked:d(e.checked)??0,acted:d(e.acted)??0,acted_names:F(e.acted_names),activity_report:r(e.activity_report),quiet_hours_overridden:j(e.quiet_hours_overridden),skipped_reason:r(e.skipped_reason),acted_rows:Va(e.acted_rows,"summary").map(t=>({name:t.name,summary:t.summary})),passed_rows:Va(e.passed_rows,"reason").map(t=>({name:t.name,reason:t.reason})),skipped_rows:Va(e.skipped_rows,"reason").map(t=>({name:t.name,reason:t.reason})),checkins:Array.isArray(e.checkins)?e.checkins.map(ep).filter(t=>t!==null):[]}:null}function sp(e){return _(e)?{enabled:j(e.enabled)??!1,interval_s:d(e.interval_s)??0,quiet_start:d(e.quiet_start),quiet_end:d(e.quiet_end),quiet_active:j(e.quiet_active),use_planner:j(e.use_planner),delegate_llm:j(e.delegate_llm),agent_count:d(e.agent_count),agents:F(e.agents),last_tick_ago_s:d(e.last_tick_ago_s)??null,last_tick_ago:r(e.last_tick_ago),total_ticks:d(e.total_ticks),total_checkins:d(e.total_checkins),last_skip_reason:r(e.last_skip_reason)??null,last_tick_result:gl(e.last_tick_result),active_self_heartbeats:F(e.active_self_heartbeats)}:null}function ap(e){return _(e)?{status:e.status,diagnostic:ea(e.diagnostic)}:null}function op(e){return _(e)?{recovered:j(e.recovered)??!1,skipped_reason:r(e.skipped_reason)??null,before:ea(e.before),after:ea(e.after),down:e.down,up:e.up}:null}function ip(e,t){var $,R;if(!(e!=null&&e.name))return null;const n=r(($=e.agent)==null?void 0:$.status)??r(e.status)??"unknown",s=r((R=e.agent)==null?void 0:R.error)??null,a=e.presence_keepalive??!0,i=e.keepalive_running??!1,l=e.turn_count??0,c=e.last_turn_ago_s??null,p=e.proactive_enabled??!1,m=e.proactive_cooldown_sec??0,u=e.last_proactive_ago_s??null,f=p&&u!=null?Math.max(0,m-u):null,v=l<=0||c==null?"never":c>900?"stale":"fresh",h=typeof e.last_heartbeat=="string"&&e.last_heartbeat.trim()?e.last_heartbeat:null,b=s??(a&&!i?"keeper keepalive is not running":null),C=n==="offline"||n==="inactive"?"offline":b?"degraded":v==="stale"?"stale":v==="never"?"idle":"healthy",x=b?tp(b):t!=null&&t.quiet_active&&v!=="fresh"?"quiet_hours":a&&!i?"disabled":l<=0?"never_started":f!=null&&f>0?"min_gap":v==="fresh"||v==="stale"?"no_recent_activity":"unknown",S=C==="offline"||C==="degraded"||C==="stale"?"recover":x==="quiet_hours"?"manual_lodge_poke":x==="unknown"?"probe":"direct_message";return{health_state:C,quiet_reason:x,next_action_path:S,last_reply_status:v,last_reply_at:h,last_reply_preview:null,last_error:b,next_eligible_at_s:f!=null&&f>0?f:null,recoverable:fl(void 0,S),summary:vl(void 0,C,x),keepalive_running:i}}function rp(e,t){if(!_(e))return null;const n=Xu(e.role),s=r(e.content)??r(e.preview);if(!s)return null;const a=le(e.ts_unix)??le(e.timestamp);return{id:`${n}-${a??"entry"}-${t}`,role:n,label:Zu(n),text:s,timestamp:a,delivery:"history"}}function lp(e,t,n){const s=_(n)?n:null,a=Array.isArray(s==null?void 0:s.history_tail)?s.history_tail.map((i,l)=>rp(i,l)).filter(i=>i!==null):[];return{name:e,diagnostic:ea(s==null?void 0:s.diagnostic),history:a,rawText:t,rawStatus:n,loadedAt:new Date().toISOString()}}function sr(e,t){const n=me.value[e]??[];me.value={...me.value,[e]:[...n,t].slice(-50)}}function cp(e,t){return e.role!==t.role||e.text!==t.text?!1:e.timestamp&&t.timestamp?e.timestamp===t.timestamp:!0}function dp(e,t){const s=(me.value[e]??[]).filter(a=>a.delivery!=="history"&&!t.some(i=>cp(a,i)));me.value={...me.value,[e]:[...t,...s].slice(-50)}}function Fa(e,t){Ve.value={...Ve.value,[e]:t},dp(e,t.history)}function ar(e,t){const n=Ve.value[e];if(!n)return;const s=n.diagnostic??{health_state:"idle",next_action_path:"direct_message",last_reply_status:"unknown"};Fa(e,{...n,diagnostic:{...s,...t}})}async function _i(){try{await os()}catch(e){console.warn("[keeper-runtime] dashboard refresh failed",e)}}function up(e){Yu.value=e.trim()}async function $l(e,t=!1){const n=e.trim();if(!n)return null;if(!t&&Ve.value[n])return Ve.value[n];de(jo,n,!0),de(Qe,n,null);try{const s=await _t("masc_keeper_status",{name:n,fast:!1,include_context:!0,include_metrics_overview:!0,include_memory_bank:!1,include_history_tail:!0,include_compaction_history:!1,tail_turns:5,tail_messages:10});let a=null;try{a=JSON.parse(s)}catch{a=null}const i=lp(n,s,a);return Fa(n,i),i}catch(s){const a=s instanceof Error?s.message:`Failed to inspect ${n}`;return de(Qe,n,a),null}finally{de(jo,n,!1)}}async function pp(e,t){const n=e.trim(),s=t.trim();if(!n||!s)return;const a=`local-${Date.now()}`;sr(n,{id:a,role:"user",label:"You",text:s,timestamp:new Date().toISOString(),delivery:"sending"}),de(Eo,n,!0),de(Qe,n,null);try{const i=await Qu(n,s);me.value={...me.value,[n]:(me.value[n]??[]).map(l=>l.id===a?{...l,delivery:"delivered"}:l)},sr(n,{id:`reply-${Date.now()}`,role:"assistant",label:n,text:i.trim()||"(empty reply)",timestamp:new Date().toISOString(),delivery:"delivered"}),ar(n,{last_reply_status:"delivered",last_reply_at:new Date().toISOString(),last_reply_preview:(i.trim()||"(empty reply)").slice(0,200),last_error:null}),await _i()}catch(i){const l=i instanceof Error?i.message:`Failed to send direct message to ${n}`;throw me.value={...me.value,[n]:(me.value[n]??[]).map(c=>c.id===a?{...c,delivery:"error",error:l}:c)},ar(n,{last_reply_status:"error",last_error:l}),de(Qe,n,l),i}finally{de(Eo,n,!1)}}async function mp(e,t){const n=e.trim();if(!n)return null;de(No,n,!0),de(Qe,n,null);try{const s=await qa({actor:t,action_type:"keeper_probe",target_type:"keeper",target_id:n,payload:{}}),a=ap(s.result),i=(a==null?void 0:a.diagnostic)??null;if(i){const l=Ve.value[n];Fa(n,{name:n,diagnostic:i,history:(l==null?void 0:l.history)??me.value[n]??[],rawText:(l==null?void 0:l.rawText)??"",rawStatus:s.result,loadedAt:new Date().toISOString()})}return await _i(),i}catch(s){const a=s instanceof Error?s.message:`Failed to probe ${n}`;throw de(Qe,n,a),s}finally{de(No,n,!1)}}async function _p(e,t){const n=e.trim();if(!n)return null;de(Do,n,!0),de(Qe,n,null);try{const s=await qa({actor:t,action_type:"keeper_recover",target_type:"keeper",target_id:n,payload:{}}),a=op(s.result),i=(a==null?void 0:a.after)??null;if(i){const l=Ve.value[n];Fa(n,{name:n,diagnostic:i,history:(l==null?void 0:l.history)??me.value[n]??[],rawText:(l==null?void 0:l.rawText)??"",rawStatus:s.result,loadedAt:new Date().toISOString()})}return await _i(),i}catch(s){const a=s instanceof Error?s.message:`Failed to recover ${n}`;throw de(Qe,n,a),s}finally{de(Do,n,!1)}}function yt(e){return(e??"").trim().toLowerCase()}function he(e){const t=typeof e=="number"?e:Date.parse(e);return Number.isNaN(t)?0:t}function qs(e,t=88){const n=e.replace(/\s+/g," ").trim();return n&&(n.length>t?`${n.slice(0,t-3)}...`:n)}function xs(e){return typeof e!="number"||!Number.isFinite(e)||e<0?null:new Date(Date.now()-e*1e3).toISOString()}function hn(e){return e.last_heartbeat??xs(e.last_turn_ago_s)??xs(e.last_proactive_ago_s)??xs(e.last_handoff_ago_s)??xs(e.last_compaction_ago_s)}function vp(e){const t=e.title.trim();return t||qs(e.content)}function fp(e){const t=e.generation??"?",n=typeof e.context_ratio=="number"&&Number.isFinite(e.context_ratio)?`${Math.round(e.context_ratio*100)}%`:"?";return e.last_heartbeat?`Heartbeat gen=${t} ctx=${n}`:`Keeper snapshot gen=${t} ctx=${n}`}function gp(e,t,n,s,a={}){var R;const i=yt(e),l=t.filter(L=>yt(L.assignee)===i&&(L.status==="claimed"||L.status==="in_progress")).length,c=n.filter(L=>yt(L.from)===i).sort((L,z)=>he(z.timestamp)-he(L.timestamp))[0],p=s.filter(L=>yt(L.agent)===i||yt(L.author)===i).sort((L,z)=>he(z.timestamp)-he(L.timestamp))[0],m=(a.boardPosts??[]).filter(L=>yt(L.author)===i).sort((L,z)=>he(z.updated_at||z.created_at)-he(L.updated_at||L.created_at))[0],u=(a.keepers??[]).filter(L=>yt(L.name)===i&&hn(L)!==null).sort((L,z)=>he(hn(z)??0)-he(hn(L)??0))[0],f=c?he(c.timestamp):0,v=p?he(p.timestamp):0,h=m?he(m.updated_at||m.created_at):0,b=u?he(hn(u)??0):0,C=a.lastSeen?he(a.lastSeen):0,x=((R=a.currentTask)==null?void 0:R.trim())||(l>0?`${l} claimed tasks`:null);if(f===0&&v===0&&h===0&&b===0&&C===0)return{activeAssignedCount:l,lastActivityAt:null,lastActivityText:x};const $=[c?{timestamp:c.timestamp,ts:f,text:qs(c.content)}:null,m?{timestamp:m.updated_at||m.created_at,ts:h,text:`Post: ${qs(vp(m))}`}:null,u?{timestamp:hn(u),ts:b,text:fp(u)}:null,p?{timestamp:new Date(p.timestamp).toISOString(),ts:v,text:qs(p.text)}:null].filter(L=>L!==null).sort((L,z)=>z.ts-L.ts)[0];return $&&$.ts>=C?{activeAssignedCount:l,lastActivityAt:$.timestamp,lastActivityText:$.text}:{activeAssignedCount:l,lastActivityAt:a.lastSeen??null,lastActivityText:x??"Presence heartbeat"}}const Ye=g([]),st=g([]),Oo=g([]),vt=g([]),ie=g(null),$p=g(null),hl=g(null),yl=g([]),bl=g([]),kl=g([]),xl=g([]),Sl=g(null),vi=g([]),fi=g([]),Cl=g([]),wo=g(new Map),Ka=g([]),wn=g("recent"),At=g(!0),Al=g(null),Je=g(""),Vt=g([]),An=g(!1),Tl=g(new Map),gi=g("unknown"),Qt=g(null),qo=g(!1),qn=g(!1),Fo=g(!1),Tn=g(!1),$i=g(null),ta=g(!1),na=g(null),Il=g(null),Ko=g(null),hp=g(null),yp=g(null),bp=g(null);ze(()=>Ye.value.filter(e=>e.status==="active"||e.status==="busy"||e.status==="listening"||e.status==="idle"));const Ll=ze(()=>{const e=st.value;return{todo:e.filter(t=>t.status==="todo"),inProgress:e.filter(t=>t.status==="in_progress"||t.status==="claimed"),done:e.filter(t=>t.status==="done")}}),Rl=ze(()=>{const e=new Map,t=st.value,n=Oo.value,s=Xs.value,a=Ka.value,i=vt.value;for(const l of Ye.value)e.set(l.name.trim().toLowerCase(),gp(l.name,t,n,s,{currentTask:l.current_task,lastSeen:l.last_seen,boardPosts:a,keepers:i}));return e});function kp(e){var i;const t=((i=e.status)==null?void 0:i.toLowerCase())??"";if(t==="offline"||t==="inactive")return"offline";const n=e.metrics_series;if(!n||n.length===0)return"idle";const s=n[n.length-1];if(!s)return"idle";if(s.is_handoff)return"handoff-imminent";if(s.is_compaction)return"compacting";const a=s.context_ratio;return a>.85?"handoff-imminent":a>.7?"preparing":a>.5?"compacting":"active"}ze(()=>{const e=new Map;for(const t of vt.value)e.set(t.name,kp(t));return e});const xp=12e4;function Sp(e,t){const n=t.get(e.name);if(n!=null)return n;const s=e.last_heartbeat?Date.parse(e.last_heartbeat):Number.NaN;if(!Number.isNaN(s))return s;const a=[e.last_turn_ago_s,e.last_proactive_ago_s,e.last_handoff_ago_s,e.last_compaction_ago_s].find(i=>typeof i=="number"&&Number.isFinite(i)&&i>=0);return typeof a=="number"?Date.now()-a*1e3:null}ze(()=>{const e=Date.now(),t=new Set,n=wo.value;for(const s of vt.value){const a=Sp(s,n);a!=null&&e-a>xp&&t.add(s.name)}return t});function Cp(e){return e==="dashboard_refresh"||e==="masc/dashboard_refresh"||e.startsWith("goal_")||e.startsWith("masc/goal_")||e.startsWith("mdal_")||e.startsWith("masc/mdal_")||e.startsWith("operator_")||e.startsWith("masc/operator_")||e.startsWith("command_plane_")||e.startsWith("masc/command_plane_")}function zl(e){const t=typeof e=="string"?e.toLowerCase():"";return t==="active"||t==="busy"||t==="listening"||t==="idle"||t==="inactive"||t==="offline"?t:t==="in_progress"||t==="claimed"?"busy":"offline"}function Ap(e){const t=typeof e=="string"?e.toLowerCase():"";return t==="todo"||t==="in_progress"||t==="claimed"||t==="done"||t==="cancelled"?t:t==="inprogress"?"in_progress":"todo"}function Tp(e){if(!_(e))return null;const t=r(e.name);return t?{name:t,agent_type:r(e.agent_type),status:zl(e.status),current_task:r(e.current_task)??null,joined_at:r(e.joined_at),last_seen:r(e.last_seen),capabilities:F(e.capabilities),emoji:r(e.emoji),koreanName:r(e.koreanName)??r(e.korean_name),model:r(e.model),traits:F(e.traits),interests:F(e.interests),activityLevel:d(e.activityLevel)??d(e.activity_level),primaryValue:r(e.primaryValue)??r(e.primary_value)}:null}function Ip(e){if(!_(e))return null;const t=r(e.id),n=r(e.title);return!t||!n?null:{id:t,title:n,status:Ap(e.status),priority:d(e.priority),assignee:r(e.assignee),description:r(e.description),created_at:r(e.created_at),updated_at:r(e.updated_at)}}function Lp(e){if(!_(e))return null;const t=r(e.from)??r(e.from_agent)??"system",n=r(e.content)??"",s=r(e.timestamp)??new Date().toISOString();return{id:r(e.id),seq:d(e.seq),from:t,content:n,timestamp:s,type:r(e.type)}}function hi(e){const t=typeof e=="string"?e.toLowerCase():"";return t==="ok"||t==="warn"||t==="bad"?t:"ok"}function Rp(e){return _(e)?{active_sessions:d(e.active_sessions),blocked_sessions:d(e.blocked_sessions),active_operations:d(e.active_operations),blocked_operations:d(e.blocked_operations),runtime_pressure:d(e.runtime_pressure),worker_alerts:d(e.worker_alerts),continuity_alerts:d(e.continuity_alerts),priority_items:d(e.priority_items),todo_tasks:d(e.todo_tasks),claimed_tasks:d(e.claimed_tasks),running_tasks:d(e.running_tasks),done_tasks:d(e.done_tasks),cancelled_tasks:d(e.cancelled_tasks),keepers:d(e.keepers)}:null}function at(e){if(!_(e))return null;const t=r(e.surface),n=r(e.label),s=r(e.target_type),a=r(e.target_id),i=r(e.focus_kind);return!t||!n||!s||!a||!i?null:{surface:t==="command"?"command":"intervene",label:n,target_type:s,target_id:a,focus_kind:i,operation_id:r(e.operation_id)??null,command_surface:r(e.command_surface)??null}}function zp(e){if(!_(e))return null;const t=r(e.id),n=r(e.kind),s=r(e.summary),a=r(e.target_type),i=r(e.target_id);return!t||!s||!a||!i||n!=="session"&&n!=="operation"?null:{id:t,kind:n,severity:hi(e.severity),status:r(e.status),summary:s,target_type:a,target_id:i,linked_session_id:r(e.linked_session_id)??null,linked_operation_id:r(e.linked_operation_id)??null,last_seen_at:r(e.last_seen_at)??null,top_handoff:at(e.top_handoff),intervene_handoff:at(e.intervene_handoff),command_handoff:at(e.command_handoff)}}function Pp(e){if(!_(e))return null;const t=r(e.session_id),n=r(e.goal);return!t||!n?null:{session_id:t,goal:n,room:r(e.room)??null,status:r(e.status),health:r(e.health),member_names:F(e.member_names),linked_operation_id:r(e.linked_operation_id)??null,linked_detachment_id:r(e.linked_detachment_id)??null,runtime_blocker:r(e.runtime_blocker)??null,worker_gap_summary:r(e.worker_gap_summary)??null,last_activity_at:r(e.last_activity_at)??null,last_activity_summary:r(e.last_activity_summary)??null,communication_summary:r(e.communication_summary)??null,active_count:d(e.active_count),required_count:d(e.required_count),top_handoff:at(e.top_handoff),intervene_handoff:at(e.intervene_handoff),command_handoff:at(e.command_handoff)}}function Mp(e){if(!_(e))return null;const t=r(e.operation_id),n=r(e.objective);return!t||!n?null:{operation_id:t,objective:n,status:r(e.status),stage:r(e.stage)??null,assigned_unit_id:r(e.assigned_unit_id)??null,assigned_unit_label:r(e.assigned_unit_label)??null,linked_session_id:r(e.linked_session_id)??null,linked_detachment_id:r(e.linked_detachment_id)??null,blocker_summary:r(e.blocker_summary)??null,search_status:r(e.search_status)??null,next_tool:r(e.next_tool)??null,updated_at:r(e.updated_at)??null,top_handoff:at(e.top_handoff),command_handoff:at(e.command_handoff)}}function or(e){if(!_(e))return null;const t=r(e.name)??r(e.agent_name),n=r(e.note),s=r(e.focus),a=r(e.state);return!t||!n||!s||a!=="working"&&a!=="watching"&&a!=="quiet"&&a!=="offline"?null:{name:t,agent_name:r(e.agent_name),status:r(e.status),tone:hi(e.tone),state:a,note:n,focus:s,last_signal_at:r(e.last_signal_at)??null,active_task_count:d(e.active_task_count),related_session_id:r(e.related_session_id)??null,related_operation_id:r(e.related_operation_id)??null,emoji:r(e.emoji),korean_name:r(e.korean_name),model:r(e.model)??null,recent_output_preview:r(e.recent_output_preview)??null,recent_event:r(e.recent_event)??null}}function jp(e){return _(e)?{checked:d(e.checked),acted:d(e.acted),passed:d(e.passed),skipped:d(e.skipped),failed:d(e.failed),last_tick_at:r(e.last_tick_at)??null,last_skip_reason:r(e.last_skip_reason)??null,activity_report:r(e.activity_report)??null}:null}function Ep(e){if(!_(e))return null;const t=r(e.agent_name),n=r(e.outcome);return!t||!n?null:{agent_name:t,trigger:r(e.trigger)??null,outcome:n,summary:r(e.summary)??null,reason:r(e.reason)??null,allowed_tool_names:F(e.allowed_tool_names)??[],used_tool_names:F(e.used_tool_names)??[],used_tool_call_count:d(e.used_tool_call_count)??null,action_kind:r(e.action_kind)??"none",tool_audit_source:r(e.tool_audit_source)??null,tool_audit_at:r(e.tool_audit_at)??null,checked_at:r(e.checked_at)??null,decision_reason:r(e.decision_reason)??null,worker_name:r(e.worker_name)??null,failure_reason:r(e.failure_reason)??null}}function Np(e){if(!_(e))return null;const t=r(e.name),n=r(e.note),s=r(e.focus),a=r(e.state);return!t||!n||!s||a!=="healthy"&&a!=="warning"&&a!=="critical"?null:{name:t,agent_name:r(e.agent_name)??null,status:r(e.status),tone:hi(e.tone),state:a,note:n,focus:s,last_signal_at:r(e.last_signal_at)??null,last_autonomous_action_at:r(e.last_autonomous_action_at)??null,generation:d(e.generation),turn_count:d(e.turn_count),context_ratio:d(e.context_ratio)??null,continuity:r(e.continuity)??null,lifecycle:r(e.lifecycle)??null,related_session_id:r(e.related_session_id)??null,model:r(e.model)??null,emoji:r(e.emoji),korean_name:r(e.korean_name),skill_reason:r(e.skill_reason)??null,recent_input_preview:r(e.recent_input_preview)??null,recent_output_preview:r(e.recent_output_preview)??null,recent_tool_names:F(e.recent_tool_names)??[],allowed_tool_names:F(e.allowed_tool_names)??[],latest_tool_names:F(e.latest_tool_names)??[],latest_tool_call_count:d(e.latest_tool_call_count)??null,tool_audit_source:r(e.tool_audit_source)??null,tool_audit_at:r(e.tool_audit_at)??null,last_proactive_preview:r(e.last_proactive_preview)??null,continuity_summary:r(e.continuity_summary)??null,skill_route_summary:r(e.skill_route_summary)??null}}function ir(e){if(typeof e.seq=="number"&&Number.isFinite(e.seq))return e.seq;const t=Date.parse(e.timestamp);return Number.isNaN(t)?0:t}function Dp(e,t){if(t.length===0)return e;const n=new Map;for(const s of e){const a=typeof s.seq=="number"?`seq:${s.seq}`:`ts:${s.timestamp}|from:${s.from}|content:${s.content}`;n.set(a,s)}for(const s of t){const a=typeof s.seq=="number"?`seq:${s.seq}`:`ts:${s.timestamp}|from:${s.from}|content:${s.content}`;n.set(a,s)}return[...n.values()].sort((s,a)=>ir(s)-ir(a)).slice(-500)}function Op(e){return Array.isArray(e)?e.map(t=>{if(!_(t))return null;const n=d(t.ts_unix);if(n==null)return null;const s=_(t.handoff)?t.handoff:null;return{ts:n,context_ratio:d(t.context_ratio)??0,context_tokens:d(t.context_tokens)??0,context_max:d(t.context_max)??0,latency_ms:d(t.latency_ms)??0,generation:d(t.generation)??0,channel:typeof t.channel=="string"?t.channel:"turn",is_handoff:s!=null&&t.handoff_performed===!0,is_compaction:t.compacted===!0,compaction_saved_tokens:d(t.compaction_saved_tokens)??0,compaction_trigger:typeof t.compaction_trigger=="string"?t.compaction_trigger:null,model_used:typeof t.model_used=="string"?t.model_used:"",cost_usd:d(t.cost_usd)??0,handoff_to_model:s&&typeof s.to_model=="string"?s.to_model:null,handoff_new_generation:s?d(s.new_generation)??null:null}}).filter(t=>t!==null):[]}function rr(e){if(!_(e))return null;const t=r(e.health_state),n=r(e.next_action_path),s=r(e.last_reply_status);if(!t||!n||!s)return null;const a=r(e.quiet_reason)??null,i=r(e.summary)??(t==="offline"||t==="degraded"||t==="stale"?"Keeper is not in a healthy reply state. Probe or recover before relying on automation.":a==="quiet_hours"?"Lodge quiet hours are active. Direct messages still work, but scheduled social ticks may look asleep.":a==="min_gap"?"Keeper is inside its proactive cooldown window. Direct messages work now; autonomous check-ins will wait.":a==="never_started"?"Keeper metadata exists but no reply turn has been recorded yet.":"Keeper is reachable. Send a direct message for an immediate response.");return{health_state:t,quiet_reason:a,next_action_path:n,last_reply_status:s,last_reply_at:le(e.last_reply_at)??r(e.last_reply_at)??null,last_reply_preview:r(e.last_reply_preview)??null,last_error:r(e.last_error)??null,next_eligible_at_s:d(e.next_eligible_at_s)??null,recoverable:typeof e.recoverable=="boolean"?e.recoverable:n==="recover",summary:i,keepalive_running:typeof e.keepalive_running=="boolean"?e.keepalive_running:void 0}}function wp(e,t){return(Array.isArray(e)?e:_(e)&&Array.isArray(e.keepers)?e.keepers:[]).map(s=>{if(!_(s))return null;const a=_(s.agent)?s.agent:null,i=_(s.context)?s.context:null,l=_(s.metrics_window)?s.metrics_window:void 0,c=r(s.name);if(!c)return null;const p=d(s.context_ratio)??d(i==null?void 0:i.context_ratio),m=r(s.status)??r(a==null?void 0:a.status)??"offline",u=zl(m),f=r(s.model)??r(s.active_model)??r(s.primary_model),v=F(s.skill_secondary),h=i?{source:r(i.source),context_ratio:d(i.context_ratio),context_tokens:d(i.context_tokens),context_max:d(i.context_max),message_count:d(i.message_count),has_checkpoint:typeof i.has_checkpoint=="boolean"?i.has_checkpoint:void 0}:void 0,b=a?{name:r(a.name),exists:typeof a.exists=="boolean"?a.exists:void 0,error:r(a.error),agent_type:r(a.agent_type),status:r(a.status),current_task:r(a.current_task)??null,joined_at:r(a.joined_at),last_seen:r(a.last_seen),last_seen_ago_s:d(a.last_seen_ago_s),capabilities:F(a.capabilities),is_zombie:typeof a.is_zombie=="boolean"?a.is_zombie:void 0}:void 0,C=Op(s.metrics_series),x={name:c,runtime_class:s.runtime_class==="persistent_agent"?"persistent_agent":"resident_keeper",desired:typeof s.desired=="boolean"?s.desired:void 0,resident_registered:typeof s.resident_registered=="boolean"?s.resident_registered:void 0,reconcile_status:r(s.reconcile_status)??null,emoji:r(s.emoji),koreanName:r(s.koreanName)??r(s.korean_name),agent_name:r(s.agent_name),trace_id:r(s.trace_id),model:f,primary_model:r(s.primary_model),active_model:r(s.active_model),next_model_hint:r(s.next_model_hint)??null,status:u,presence_keepalive:typeof s.presence_keepalive=="boolean"?s.presence_keepalive:void 0,presence_keepalive_sec:d(s.presence_keepalive_sec),keepalive_running:typeof s.keepalive_running=="boolean"?s.keepalive_running:void 0,proactive_enabled:typeof s.proactive_enabled=="boolean"?s.proactive_enabled:void 0,proactive_idle_sec:d(s.proactive_idle_sec),proactive_cooldown_sec:d(s.proactive_cooldown_sec),last_heartbeat:r(s.last_heartbeat)??r(a==null?void 0:a.last_seen),generation:d(s.generation),turn_count:d(s.turn_count)??d(s.total_turns),keeper_age_s:d(s.keeper_age_s),last_turn_ago_s:d(s.last_turn_ago_s),last_handoff_ago_s:d(s.last_handoff_ago_s),last_compaction_ago_s:d(s.last_compaction_ago_s),last_proactive_ago_s:d(s.last_proactive_ago_s),last_proactive_preview:r(s.last_proactive_preview)??null,context_ratio:p,context_tokens:d(s.context_tokens)??d(i==null?void 0:i.context_tokens),context_max:d(s.context_max)??d(i==null?void 0:i.context_max),context_source:r(s.context_source)??r(i==null?void 0:i.source),context:h,traits:F(s.traits),interests:F(s.interests),primaryValue:r(s.primaryValue)??r(s.primary_value),activityLevel:d(s.activityLevel)??d(s.activity_level),memory_recent_note:r(s.memory_recent_note)??null,recent_input_preview:r(s.recent_input_preview)??null,recent_output_preview:r(s.recent_output_preview)??null,recent_tool_names:F(s.recent_tool_names)??[],allowed_tool_names:F(s.allowed_tool_names)??[],latest_tool_names:F(s.latest_tool_names)??[],latest_tool_call_count:d(s.latest_tool_call_count)??null,tool_audit_source:r(s.tool_audit_source)??null,tool_audit_at:le(s.tool_audit_at)??r(s.tool_audit_at)??null,conversation_tail_count:d(s.conversation_tail_count),k2k_count:d(s.k2k_count),handoff_count_total:d(s.handoff_count_total)??d(s.trace_history_count),compaction_count:d(s.compaction_count),last_compaction_saved_tokens:d(s.last_compaction_saved_tokens),diagnostic:rr(s.diagnostic),skill_primary:r(s.skill_primary)??null,skill_secondary:v,skill_reason:r(s.skill_reason)??null,metrics_series:C.length>0?C:void 0,metrics_window:l,agent:b};return x.diagnostic=rr(s.diagnostic)??ip(x,(t==null?void 0:t.lodge)??null),x}).filter(s=>s!==null)}function qp(e){if(!_(e))return;const t=r(e.release_version),n=le(e.started_at),s=d(e.uptime_seconds);if(!(!t||!n||s==null))return{release_version:t,commit:r(e.commit)??null,started_at:n,uptime_seconds:s}}function Fp(e){if(_(e))return{enabled:e.enabled===!0,alive:e.alive===!0,status:r(e.status)??void 0,tick_in_progress:typeof e.tick_in_progress=="boolean"?e.tick_in_progress:void 0,tick_count:d(e.tick_count)??void 0,check_interval_sec:d(e.check_interval_sec)??void 0,last_tick_started_at:le(e.last_tick_started_at)??r(e.last_tick_started_at)??null,last_tick_completed_at:le(e.last_tick_completed_at)??r(e.last_tick_completed_at)??null,next_tick_due_at:le(e.next_tick_due_at)??r(e.next_tick_due_at)??null,last_health_check_at:le(e.last_health_check_at)??r(e.last_health_check_at)??null,last_intervention:r(e.last_intervention)??void 0,last_decision_source:r(e.last_decision_source)??void 0,last_action:r(e.last_action)??void 0,last_target:r(e.last_target)??null,last_reason:r(e.last_reason)??null,last_error:r(e.last_error)??null,circuit_open:typeof e.circuit_open=="boolean"?e.circuit_open:void 0,circuit_open_until:le(e.circuit_open_until)??r(e.circuit_open_until)??null,can_spawn:typeof e.can_spawn=="boolean"?e.can_spawn:void 0,can_retire:typeof e.can_retire=="boolean"?e.can_retire:void 0,last_spawn_attempt_at:le(e.last_spawn_attempt_at)??r(e.last_spawn_attempt_at)??null,last_retirement_attempt_at:le(e.last_retirement_attempt_at)??r(e.last_retirement_attempt_at)??null,spawns_today:d(e.spawns_today)??void 0,retirements_today:d(e.retirements_today)??void 0,health_summary:_(e.health_summary)?{total_agents:d(e.health_summary.total_agents)??void 0,active_agents:d(e.health_summary.active_agents)??void 0,idle_agents:d(e.health_summary.idle_agents)??void 0,todo_count:d(e.health_summary.todo_count)??void 0,high_priority_todo:d(e.health_summary.high_priority_todo)??void 0,orphan_count:d(e.health_summary.orphan_count)??void 0,homeostatic_score:d(e.health_summary.homeostatic_score)??void 0,needs_workers:typeof e.health_summary.needs_workers=="boolean"?e.health_summary.needs_workers:void 0}:void 0}}function Kp(e){if(_(e))return{enabled:e.enabled===!0,mode:r(e.mode)??void 0,masc_enabled:typeof e.masc_enabled=="boolean"?e.masc_enabled:void 0,masc_loops_running:typeof e.masc_loops_running=="boolean"?e.masc_loops_running:void 0,runtime_owner:r(e.runtime_owner)??null,zombie_loop_running:typeof e.zombie_loop_running=="boolean"?e.zombie_loop_running:void 0,gc_loop_running:typeof e.gc_loop_running=="boolean"?e.gc_loop_running:void 0,lodge_enabled:typeof e.lodge_enabled=="boolean"?e.lodge_enabled:void 0,lodge_loop_started:typeof e.lodge_loop_started=="boolean"?e.lodge_loop_started:void 0,lodge_running:typeof e.lodge_running=="boolean"?e.lodge_running:void 0,last_zombie_cleanup:le(e.last_zombie_cleanup)??r(e.last_zombie_cleanup)??null,last_gc:le(e.last_gc)??r(e.last_gc)??null,last_lodge:le(e.last_lodge)??r(e.last_lodge)??null,last_zombie_result:r(e.last_zombie_result)??null,last_gc_result:r(e.last_gc_result)??null,last_lodge_result:_(e.last_lodge_result)?{ok:typeof e.last_lodge_result.ok=="boolean"?e.last_lodge_result.ok:void 0,message:r(e.last_lodge_result.message)??void 0}:null}}function Up(e){if(_(e))return{enabled:e.enabled===!0,started:e.started===!0,agent_name:r(e.agent_name)??null,llm_enabled:typeof e.llm_enabled=="boolean"?e.llm_enabled:void 0,uptime_s:d(e.uptime_s)??void 0,embedded_guardian_loops_running:typeof e.embedded_guardian_loops_running=="boolean"?e.embedded_guardian_loops_running:void 0,guardian_runtime_owner:r(e.guardian_runtime_owner)??null,consumers:F(e.consumers)}}function Pl(e,t){return _(e)?{...e,generated_at:t??le(e.generated_at)??void 0,build:qp(e.build),lodge:sp(e.lodge)??void 0,gardener:Fp(e.gardener)??void 0,guardian:Kp(e.guardian)??void 0,sentinel:Up(e.sentinel)??void 0}:null}function Ml(e,t){return t?e?{...e,...t,build:t.build??e.build,generated_at:t.generated_at??e.generated_at}:t:e}function Hp(e){const t=typeof e=="string"?e.toLowerCase():"";return t==="running"||t==="interrupted"||t==="completed"||t==="stopped"||t==="error"?t:t.startsWith("error")?"error":"running"}function Bp(e){if(!_(e))return null;const t=d(e.iteration);if(t==null)return null;const n=d(e.metric_before)??0,s=d(e.metric_after)??n,a=_(e.evidence)?e.evidence:null;return{iteration:t,metric_before:n,metric_after:s,delta:d(e.delta)??s-n,changes:r(e.changes)??"",failed_attempts:r(e.failed_attempts)??"",next_suggestion:r(e.next_suggestion)??"",elapsed_ms:d(e.elapsed_ms)??0,cost_usd:d(e.cost_usd)??null,evidence:a?{worker_engine:(a.worker_engine==="api_tool_loop","api_tool_loop"),worker_model:r(a.worker_model)??"",tool_call_count:d(a.tool_call_count)??0,tool_names:F(a.tool_names)??[],session_id:r(a.session_id)??"",evidence_status:a.evidence_status==="legacy_unverified"?"legacy_unverified":"verified"}:null}}function Wp(e){var i,l;if(!_(e))return null;const t=r(e.loop_id);if(!t)return null;const n=d(e.baseline_metric)??0,s=Array.isArray(e.history)?e.history.map(Bp).filter(c=>c!==null):[],a=d(e.current_metric)??((i=s[0])==null?void 0:i.metric_after)??n;return{loop_id:t,profile:r(e.profile)??"unknown",status:Hp(e.status),strict_mode:typeof e.strict_mode=="boolean"?e.strict_mode:void 0,error_message:r(e.error_message)??r(e.error_reason)??null,stop_reason:r(e.stop_reason)??r(e.reason)??null,current_iteration:d(e.current_iteration)??((l=s[0])==null?void 0:l.iteration)??0,max_iterations:d(e.max_iterations)??0,baseline_metric:n,current_metric:a,target:r(e.target)??"",stagnation_streak:d(e.stagnation_streak)??0,stagnation_limit:d(e.stagnation_limit)??0,elapsed_seconds:d(e.elapsed_seconds)??0,updated_at:le(e.updated_at)??null,stopped_at:le(e.stopped_at)??null,execution_mode:e.execution_mode==="worker_spawn"?"worker_spawn":void 0,worker_engine:e.worker_engine==="api_tool_loop"?"api_tool_loop":null,worker_model:r(e.worker_model)??null,evidence_policy:e.evidence_policy==="hard"||e.evidence_policy==="legacy"?e.evidence_policy:void 0,latest_tool_call_count:d(e.latest_tool_call_count)??0,latest_tool_names:F(e.latest_tool_names)??[],session_id:r(e.session_id)??null,evidence_status:e.evidence_status==="legacy_unverified"?"legacy_unverified":e.evidence_status==="verified"?"verified":null,durability:e.durability==="persistent_backend"||e.durability==="memory_only"?e.durability:void 0,persistence_backend:e.persistence_backend==="filesystem"||e.persistence_backend==="postgres"||e.persistence_backend==="memory"?e.persistence_backend:void 0,recoverable:typeof e.recoverable=="boolean"?e.recoverable:void 0,history:s}}async function os(){qo.value=!0;try{await Promise.all([El(),Tt()]),Il.value=new Date().toISOString()}catch(e){console.error("Dashboard refresh error:",e)}finally{qo.value=!1}}async function jl(){ta.value=!0,na.value=null;try{const e=await Vd();$i.value=e,bp.value=new Date().toISOString()}catch(e){na.value=e instanceof Error?e.message:"Failed to load dashboard semantics"}finally{ta.value=!1}}function Gp(e){var t;return((t=$i.value)==null?void 0:t.surfaces.find(n=>n.id===e))??null}function Jp(e){var n;const t=((n=$i.value)==null?void 0:n.surfaces)??[];for(const s of t){const a=s.panels.find(i=>i.id===e);if(a)return a}return null}function Vp(e){var s,a;Vt.value=(Array.isArray(e.goals)?e.goals:[]).map(i=>{if(!_(i))return null;const l=r(i.id),c=r(i.title),p=r(i.horizon),m=r(i.status),u=r(i.created_at),f=r(i.updated_at);return!l||!c||!p||!m||!u||!f?null:{id:l,horizon:p,title:c,metric:r(i.metric)??null,target_value:r(i.target_value)??null,due_date:r(i.due_date)??null,priority:d(i.priority)??3,status:m,parent_goal_id:r(i.parent_goal_id)??null,last_review_note:r(i.last_review_note)??null,last_review_at:r(i.last_review_at)??null,created_at:u,updated_at:f}}).filter(i=>i!==null);const t=new Map,n=Array.isArray((s=e.mdal)==null?void 0:s.loops)?e.mdal.loops:[];for(const i of n){const l=Wp(i);l&&t.set(l.loop_id,l)}Tl.value=t,Qt.value=typeof((a=e.mdal)==null?void 0:a.error)=="string"?e.mdal.error:null,gi.value=Qt.value?"error":t.size===0?"idle":"ready"}async function El(){try{const e=await Bd(),t=Pl(e.status,e.generated_at);t&&(ie.value=Ml(ie.value,t))}catch(e){console.error("Dashboard shell fetch error:",e)}}async function Tt(){var e;try{const t=await Wd(),n=Pl(t.status,t.generated_at),s=(e=ie.value)==null?void 0:e.room;n&&(ie.value=Ml(ie.value,n));const a=s!=null&&(n==null?void 0:n.room)!=null&&s!==n.room;Ye.value=(Array.isArray(t.agents)?t.agents:[]).map(Tp).filter(l=>l!==null),st.value=(Array.isArray(t.tasks)?t.tasks:[]).map(Ip).filter(l=>l!==null);const i=(Array.isArray(t.messages)?t.messages:[]).map(Lp).filter(l=>l!==null);Oo.value=a?i:Dp(Oo.value,i),vt.value=wp(t.keepers,n??ie.value),hl.value=Rp(t.summary),Sl.value=jp(t.lodge_tick),vi.value=(Array.isArray(t.lodge_checkins)?t.lodge_checkins:[]).map(Ep).filter(l=>l!==null),yl.value=(Array.isArray(t.execution_queue)?t.execution_queue:Array.isArray(t.priority_queue)?t.priority_queue:[]).map(zp).filter(l=>l!==null),bl.value=(Array.isArray(t.session_briefs)?t.session_briefs:[]).map(Pp).filter(l=>l!==null),kl.value=(Array.isArray(t.operation_briefs)?t.operation_briefs:[]).map(Mp).filter(l=>l!==null),xl.value=(Array.isArray(t.worker_support_briefs)?t.worker_support_briefs:Array.isArray(t.worker_briefs)?t.worker_briefs:[]).map(or).filter(l=>l!==null),fi.value=(Array.isArray(t.continuity_briefs)?t.continuity_briefs:[]).map(Np).filter(l=>l!==null),Cl.value=(Array.isArray(t.offline_worker_briefs)?t.offline_worker_briefs:[]).map(or).filter(l=>l!==null),$p.value=null,Il.value=new Date().toISOString()}catch(t){console.error("Dashboard execution fetch error:",t)}}async function ot(){qn.value=!0;try{const e=await Gd(wn.value,{excludeSystem:At.value});Ka.value=e.posts??[],Ko.value=new Date().toISOString()}catch(e){console.error("Board fetch error:",e)}finally{qn.value=!1}}async function it(){var e;Fo.value=!0;try{const t=Je.value||((e=ie.value)==null?void 0:e.room)||"default";Je.value||(Je.value=t);const n=await Eu(t);Al.value=n}catch(t){console.error("TRPG fetch error:",t)}finally{Fo.value=!1}}async function yi(){An.value=!0,Tn.value=!0;try{const e=await eu();Vp(e),hp.value=new Date().toISOString(),yp.value=new Date().toISOString()}catch(e){console.error("Planning fetch error:",e),gi.value="error",Qt.value=e instanceof Error?e.message:String(e)}finally{An.value=!1,Tn.value=!1}}async function Nl(){return yi()}let Fs=null;function Qp(e){Fs=e}let Ks=null;function Yp(e){Ks=e}let Us=null;function Xp(e){Us=e}const It={};let Qa=null;function bt(e,t,n=500){It[e]&&clearTimeout(It[e]),It[e]=setTimeout(()=>{t(),delete It[e]},n)}function Zp(){const e=tl.subscribe(t=>{if(t){if(t.type==="keeper_heartbeat"&&t.name){const n=new Map(wo.value);n.set(t.name,t.ts_unix?t.ts_unix*1e3:Date.now()),wo.value=n;return}(t.type==="agent_joined"||t.type==="agent_left")&&bt("execution",Tt),Cp(t.type)&&(Qa||(Qa=setTimeout(()=>{os(),Ks==null||Ks(),Us==null||Us(),Qa=null},500))),(t.type.startsWith("task_")||t.type.startsWith("masc/task_"))&&bt("execution",Tt),t.type==="broadcast"&&bt("execution",Tt),(t.type==="keeper_handoff"||t.type==="keeper_compaction"||t.type==="keeper_guardrail")&&bt("execution",Tt),(t.type==="board_post"||t.type==="masc/board_post"||t.type==="board_comment"||t.type==="masc/board_comment")&&bt("board",ot),t.type.startsWith("decision_")&&bt("council",()=>Fs==null?void 0:Fs()),(t.type==="mdal_started"||t.type==="mdal_iteration"||t.type==="mdal_completed"||t.type==="mdal_stopped")&&bt("mdal",Nl,350)}});return()=>{e();for(const t of Object.keys(It))clearTimeout(It[t]),delete It[t]}}let In=null;function em(){In||(In=setInterval(()=>{dt.value,os()},1e4))}function tm(){In&&(clearInterval(In),In=null)}const $e=g(null),bi=g(null),Fe=g(null),Fn=g(!1),ut=g(null),Kn=g(!1),rn=g(null),J=g(!1),sa=g([]);let nm=1;function sm(e){return _(e)?{id:r(e.id),seq:d(e.seq),from:r(e.from)??r(e.from_agent)??"system",content:r(e.content)??"",timestamp:r(e.timestamp)??new Date().toISOString(),type:r(e.type)}:null}function am(e){return _(e)?{room_id:r(e.room_id),current_room:r(e.current_room)??r(e.room),project:r(e.project),cluster:r(e.cluster),paused:j(e.paused),pause_reason:r(e.pause_reason)??null,paused_by:r(e.paused_by)??null,paused_at:r(e.paused_at)??null}:{}}function lr(e){if(!_(e))return;const t=Object.entries(e).map(([n,s])=>{const a=r(s);return a?[n,a]:null}).filter(n=>n!==null);return t.length>0?Object.fromEntries(t):void 0}function Dl(e){if(!_(e))return null;const t=r(e.kind),n=r(e.summary),s=r(e.target_type);return!t||!n||!s?null:{kind:t,severity:r(e.severity)??"warn",summary:n,target_type:s,target_id:r(e.target_id)??null,actor:r(e.actor)??null,evidence:e.evidence}}function Ln(e){if(!_(e))return null;const t=r(e.action_type),n=r(e.target_type),s=r(e.reason);return!t||!n||!s?null:{action_type:t,target_type:n,target_id:r(e.target_id)??null,severity:r(e.severity)??"warn",reason:s,confirm_required:j(e.confirm_required),suggested_payload:e.suggested_payload,preview:e.preview}}function Ol(e){return _(e)?{enabled:j(e.enabled),judge_online:j(e.judge_online),refreshing:j(e.refreshing),generated_at:r(e.generated_at)??null,expires_at:r(e.expires_at)??null,model_used:r(e.model_used)??null,keeper_name:r(e.keeper_name)??null,last_error:r(e.last_error)??null}:null}function Ya(e){return _(e)?{summary:r(e.summary)??null,confidence:d(e.confidence)??null,provenance:r(e.provenance)??null,authoritative:j(e.authoritative),surface:r(e.surface)??null,fresh_until:r(e.fresh_until)??null,keeper_name:r(e.keeper_name)??null,fallback_used:j(e.fallback_used),disagreement_with_truth:j(e.disagreement_with_truth)}:null}function om(e){return _(e)?{judgment_id:r(e.judgment_id)??void 0,surface:r(e.surface)??null,target_type:r(e.target_type)??null,target_id:r(e.target_id)??null,status:r(e.status)??null,summary:r(e.summary)??null,confidence:d(e.confidence)??null,generated_at:r(e.generated_at)??null,fresh_until:r(e.fresh_until)??null,keeper_name:r(e.keeper_name)??null,model_name:r(e.model_name)??null,runtime_name:r(e.runtime_name)??null,evidence_refs:F(e.evidence_refs),recommended_action:Ln(e.recommended_action),supersedes:F(e.supersedes),fallback_used:j(e.fallback_used),disagreement_with_truth:j(e.disagreement_with_truth),provenance:r(e.provenance)??null}:null}function im(e){return _(e)?{actor:r(e.actor)??null,spawn_agent:r(e.spawn_agent)??null,spawn_role:r(e.spawn_role)??null,spawn_model:r(e.spawn_model)??null,worker_class:r(e.worker_class)??null,parent_actor:r(e.parent_actor)??null,capsule_mode:r(e.capsule_mode)??null,runtime_pool:r(e.runtime_pool)??null,lane_id:r(e.lane_id)??null,controller_level:r(e.controller_level)??null,control_domain:r(e.control_domain)??null,supervisor_actor:r(e.supervisor_actor)??null,model_tier:r(e.model_tier)??null,task_profile:r(e.task_profile)??null,risk_level:r(e.risk_level)??null,routing_confidence:d(e.routing_confidence)??null,routing_reason:r(e.routing_reason)??null,status:r(e.status)??"unknown",turn_count:d(e.turn_count)??0,empty_note_turn_count:d(e.empty_note_turn_count)??0,has_turn:j(e.has_turn)??!1,last_turn_ts_iso:r(e.last_turn_ts_iso)??null}:null}function rm(e){if(!_(e))return null;const t=r(e.session_id);return t?{session_id:t,goal:r(e.goal),status:r(e.status),health:r(e.health),scale_profile:r(e.scale_profile),control_profile:r(e.control_profile),planned_worker_count:d(e.planned_worker_count),active_agent_count:d(e.active_agent_count),last_turn_age_sec:d(e.last_turn_age_sec)??null,attention_count:d(e.attention_count),recommended_action_count:d(e.recommended_action_count),top_attention:Dl(e.top_attention),top_recommendation:Ln(e.top_recommendation)}:null}function wl(e){const t=_(e)?e:{};return{trace_id:r(t.trace_id),target_type:r(t.target_type)??"room",target_id:r(t.target_id)??null,health:r(t.health),judgment_owner:r(t.judgment_owner)??null,authoritative_judgment_available:j(t.authoritative_judgment_available),resident_judge_runtime:Ol(t.resident_judge_runtime),judgment:om(t.judgment),active_guidance_layer:r(t.active_guidance_layer)??null,active_summary:Ya(t.active_summary),active_recommended_actions:ve(t.active_recommended_actions).map(Ln).filter(n=>n!==null),active_recommendation_source:r(t.active_recommendation_source)??null,active_recommendation_summary:Ya(t.active_recommendation_summary),fallback_recommended_actions:ve(t.fallback_recommended_actions).map(Ln).filter(n=>n!==null),recommendation_summary:Ya(t.recommendation_summary),swarm_status:_(t.swarm_status)?t.swarm_status:void 0,attention_items:ve(t.attention_items).map(Dl).filter(n=>n!==null),recommended_actions:ve(t.recommended_actions).map(Ln).filter(n=>n!==null),session_cards:ve(t.session_cards).map(rm).filter(n=>n!==null),worker_cards:ve(t.worker_cards).map(im).filter(n=>n!==null)}}function lm(e){if(!_(e))return null;const t=_(e.status)?e.status:void 0,n=_(e.summary)?e.summary:_(t==null?void 0:t.summary)?t.summary:void 0,s=_(e.session)?e.session:_(t==null?void 0:t.session)?t.session:void 0,a=r(e.session_id)??r(n==null?void 0:n.session_id)??r(s==null?void 0:s.session_id);if(!a)return null;const i=lr(e.report_paths)??lr(t==null?void 0:t.report_paths),l=ve(e.recent_events,["events"]).filter(_);return{session_id:a,status:r(e.status)??r(n==null?void 0:n.status)??r(s==null?void 0:s.status),progress_pct:d(e.progress_pct)??d(n==null?void 0:n.progress_pct),elapsed_sec:d(e.elapsed_sec)??d(n==null?void 0:n.elapsed_sec),remaining_sec:d(e.remaining_sec)??d(n==null?void 0:n.remaining_sec),done_delta_total:d(e.done_delta_total)??d(n==null?void 0:n.done_delta_total),summary:n,team_health:_(e.team_health)?e.team_health:_(t==null?void 0:t.team_health)?t.team_health:void 0,communication_metrics:_(e.communication_metrics)?e.communication_metrics:_(t==null?void 0:t.communication_metrics)?t.communication_metrics:void 0,orchestration_state:_(e.orchestration_state)?e.orchestration_state:_(t==null?void 0:t.orchestration_state)?t.orchestration_state:void 0,cascade_metrics:_(e.cascade_metrics)?e.cascade_metrics:_(t==null?void 0:t.cascade_metrics)?t.cascade_metrics:void 0,report_paths:i,linked_autoresearch:_(e.linked_autoresearch)?e.linked_autoresearch:_(t==null?void 0:t.linked_autoresearch)?t.linked_autoresearch:void 0,session:s,recent_events:l}}function cr(e){if(!_(e))return null;const t=r(e.name);if(!t)return null;const n=_(e.context)?e.context:void 0;return{name:t,runtime_class:e.runtime_class==="persistent_agent"?"persistent_agent":"resident_keeper",desired:j(e.desired),resident_registered:j(e.resident_registered),agent_name:r(e.agent_name),status:r(e.status),autonomy_level:r(e.autonomy_level),context_ratio:d(e.context_ratio)??d(n==null?void 0:n.context_ratio),generation:d(e.generation),active_goal_ids:F(e.active_goal_ids),last_autonomous_action_at:r(e.last_autonomous_action_at)??null,last_turn_ago_s:d(e.last_turn_ago_s),model:r(e.model)??r(e.active_model)??r(e.primary_model)}}function cm(e){if(!_(e))return null;const t=r(e.confirm_token)??r(e.token);return t?{confirm_token:t,actor:r(e.actor),action_type:r(e.action_type),target_type:r(e.target_type),target_id:r(e.target_id)??null,delegated_tool:r(e.delegated_tool),created_at:r(e.created_at),preview:e.preview}:null}function ql(e){if(!_(e))return null;const t=r(e.action_type),n=r(e.target_type);return!t||!n?null:{action_type:t,target_type:n,description:r(e.description),confirm_required:j(e.confirm_required)}}function dm(e){return _(e)?{actor_filter:r(e.actor_filter)??null,filter_active:j(e.filter_active)??!1,visible_count:d(e.visible_count)??0,total_count:d(e.total_count)??0,hidden_count:d(e.hidden_count)??0,hidden_actors:F(e.hidden_actors),confirm_required_actions:ve(e.confirm_required_actions).map(ql).filter(t=>t!==null)}:null}function um(e){const t=_(e)?e:{};return{room:am(t.room),sessions:ve(t.sessions,["items","sessions"]).map(lm).filter(n=>n!==null),keepers:ve(t.keepers,["items","keepers"]).map(cr).filter(n=>n!==null),resident_judge_runtime:Ol(t.resident_judge_runtime),persistent_agents:ve(t.persistent_agents,["items","persistent_agents"]).map(cr).filter(n=>n!==null),recent_messages:ve(t.recent_messages,["messages"]).map(sm).filter(n=>n!==null),pending_confirms:ve(t.pending_confirms,["items","confirms"]).map(cm).filter(n=>n!==null),pending_confirm_summary:dm(t.pending_confirm_summary)??void 0,available_actions:ve(t.available_actions,["actions"]).map(ql).filter(n=>n!==null)}}function Ss(e){if(typeof e=="string")return e;if(e==null)return"";try{return JSON.stringify(e)}catch{return String(e)}}function dr(e){return e.target_id?`${e.target_type}:${e.target_id}`:e.target_type}function aa(e){sa.value=[{...e,id:nm++,at:new Date().toISOString()},...sa.value].slice(0,20)}function Fl(e){return e.confirm_required?Ss(e.preview)||"Confirmation required":Ss(e.result)||Ss(e.executed_action)||Ss(e.delegated_tool_result)||e.status}async function xe(){Fn.value=!0,ut.value=null;try{const e=await su();$e.value=um(e)}catch(e){ut.value=e instanceof Error?e.message:"Failed to load operator snapshot"}finally{Fn.value=!1}}async function Mt(){Kn.value=!0,rn.value=null;try{const e=await rl({targetType:"room"});bi.value=wl(e)}catch(e){rn.value=e instanceof Error?e.message:"Failed to load operator digest"}finally{Kn.value=!1}}async function ln(e){if(!e){Fe.value=null;return}Kn.value=!0,rn.value=null;try{const t=await rl({targetType:"team_session",targetId:e,includeWorkers:!0});Fe.value=wl(t)}catch(t){rn.value=t instanceof Error?t.message:"Failed to load session digest"}finally{Kn.value=!1}}async function Kl(e){var t;J.value=!0,ut.value=null;try{const n=await qa(e);return aa({actor:e.actor,action_type:e.action_type,target_label:dr(e),outcome:n.confirm_required?"preview":"executed",message:Fl(n),delegated_tool:n.delegated_tool}),await xe(),await Mt(),(t=Fe.value)!=null&&t.target_id&&await ln(Fe.value.target_id),n}catch(n){const s=n instanceof Error?n.message:"Operator action failed";throw ut.value=s,aa({actor:e.actor,action_type:e.action_type,target_label:dr(e),outcome:"error",message:s}),n}finally{J.value=!1}}async function Ul(e,t,n="confirm"){var s;J.value=!0,ut.value=null;try{const a=await ll(e,t,n);return aa({actor:e,action_type:n,target_label:t,outcome:"confirmed",message:Fl(a),delegated_tool:a.delegated_tool}),await xe(),await Mt(),(s=Fe.value)!=null&&s.target_id&&await ln(Fe.value.target_id),a}catch(a){const i=a instanceof Error?a.message:"Operator confirmation failed";throw ut.value=i,aa({actor:e,action_type:"confirm",target_label:t,outcome:"error",message:i}),a}finally{J.value=!1}}Xp(()=>{var e;xe(),Mt(),(e=Fe.value)!=null&&e.target_id&&ln(Fe.value.target_id)});const is=g(null),Uo=g(!1),oa=g(null),Hl=g(null),Ft=g(!1),Ct=g(null),Ho=g(null),Hs=g(!1),Bs=g(null);let Yt=null;function ur(){Yt!==null&&(window.clearTimeout(Yt),Yt=null)}function pm(e=1500){Yt===null&&(Yt=window.setTimeout(()=>{Yt=null,ia(!1)},e))}function E(e){return typeof e=="object"&&e!==null&&!Array.isArray(e)}function y(e){return typeof e=="string"&&e.trim()!==""?e:void 0}function N(e){return typeof e=="number"&&Number.isFinite(e)?e:void 0}function Xt(e){return typeof e=="boolean"?e:void 0}function B(e,t=[]){if(Array.isArray(e))return e;if(!E(e))return[];for(const n of t){const s=e[n];if(Array.isArray(s))return s}return[]}function _n(e){if(!E(e))return null;const t=y(e.kind),n=y(e.summary),s=y(e.target_type);return!t||!n||!s?null:{kind:t,severity:y(e.severity)??"warn",summary:n,target_type:s,target_id:y(e.target_id)??null,actor:y(e.actor)??null,evidence:e.evidence}}function jt(e){if(!E(e))return null;const t=y(e.action_type),n=y(e.target_type),s=y(e.reason);return!t||!n||!s?null:{action_type:t,target_type:n,target_id:y(e.target_id)??null,severity:y(e.severity)??"warn",reason:s,confirm_required:Xt(e.confirm_required),suggested_payload:e.suggested_payload,preview:e.preview}}function mm(e){if(!E(e))return null;const t=y(e.session_id);return t?{session_id:t,goal:y(e.goal),status:y(e.status),health:y(e.health),scale_profile:y(e.scale_profile),control_profile:y(e.control_profile),planned_worker_count:N(e.planned_worker_count),active_agent_count:N(e.active_agent_count),last_turn_age_sec:N(e.last_turn_age_sec)??null,attention_count:N(e.attention_count),recommended_action_count:N(e.recommended_action_count),top_attention:_n(e.top_attention),top_recommendation:jt(e.top_recommendation)}:null}function _m(e){if(!E(e))return null;const t=y(e.session_id);if(!t)return null;const n=E(e.status)?e.status:e,s=E(n.summary)?n.summary:void 0;return{session_id:t,status:y(e.status)??y(s==null?void 0:s.status)??(E(n.session)?y(n.session.status):void 0),progress_pct:N(e.progress_pct)??N(s==null?void 0:s.progress_pct),elapsed_sec:N(e.elapsed_sec)??N(s==null?void 0:s.elapsed_sec),remaining_sec:N(e.remaining_sec)??N(s==null?void 0:s.remaining_sec),done_delta_total:N(e.done_delta_total)??N(s==null?void 0:s.done_delta_total),summary:E(e.summary)?e.summary:s,team_health:E(e.team_health)?e.team_health:E(n.team_health)?n.team_health:void 0,communication_metrics:E(e.communication_metrics)?e.communication_metrics:E(n.communication_metrics)?n.communication_metrics:void 0,orchestration_state:E(e.orchestration_state)?e.orchestration_state:E(n.orchestration_state)?n.orchestration_state:void 0,cascade_metrics:E(e.cascade_metrics)?e.cascade_metrics:E(n.cascade_metrics)?n.cascade_metrics:void 0,report_paths:E(e.report_paths)?Object.fromEntries(Object.entries(e.report_paths).map(([a,i])=>{const l=y(i);return l?[a,l]:null}).filter(a=>a!==null)):E(n.report_paths)?Object.fromEntries(Object.entries(n.report_paths).map(([a,i])=>{const l=y(i);return l?[a,l]:null}).filter(a=>a!==null)):void 0,session:E(e.session)?e.session:E(n.session)?n.session:void 0,recent_events:B(e.recent_events,["events"]).filter(E)}}function vm(e){if(!E(e))return null;const t=y(e.name);return t?{name:t,agent_name:y(e.agent_name),status:y(e.status),autonomy_level:y(e.autonomy_level),context_ratio:N(e.context_ratio),generation:N(e.generation),active_goal_ids:B(e.active_goal_ids).map(n=>typeof n=="string"?n.trim():"").filter(Boolean),last_autonomous_action_at:y(e.last_autonomous_action_at)??null,last_turn_ago_s:N(e.last_turn_ago_s),model:y(e.model)}:null}function fm(e){if(!E(e))return null;const t=y(e.confirm_token)??y(e.token);return t?{confirm_token:t,actor:y(e.actor),action_type:y(e.action_type),target_type:y(e.target_type),target_id:y(e.target_id)??null,delegated_tool:y(e.delegated_tool),created_at:y(e.created_at),preview:e.preview}:null}function gm(e){if(!E(e))return null;const t=y(e.action_type),n=y(e.target_type);return!t||!n?null:{action_type:t,target_type:n,description:y(e.description),confirm_required:Xt(e.confirm_required)}}function $m(e){const t=E(e)?e:{};return{room_health:y(t.room_health),cluster:y(t.cluster),project:y(t.project),current_room:y(t.current_room)??null,paused:Xt(t.paused),tempo_interval_s:N(t.tempo_interval_s),active_agents:N(t.active_agents),keeper_pressure:N(t.keeper_pressure),active_operations:N(t.active_operations),pending_approvals:N(t.pending_approvals),incident_count:N(t.incident_count),recommended_action_count:N(t.recommended_action_count),top_attention:_n(t.top_attention),top_action:jt(t.top_action)}}function hm(e){const t=E(e)?e:{},n=E(t.swarm_overview)?t.swarm_overview:{};return{health:y(t.health),active_operations:N(t.active_operations),pending_approvals:N(t.pending_approvals),swarm_overview:{active_lanes:N(n.active_lanes),moving_lanes:N(n.moving_lanes),stalled_lanes:N(n.stalled_lanes),projected_lanes:N(n.projected_lanes),last_movement_at:y(n.last_movement_at)??null},top_attention:_n(t.top_attention),top_action:jt(t.top_action),session_cards:B(t.session_cards).map(mm).filter(s=>s!==null)}}function ym(e){const t=E(e)?e:{};return{sessions:B(t.sessions,["items"]).map(_m).filter(n=>n!==null),keepers:B(t.keepers,["items"]).map(vm).filter(n=>n!==null),pending_confirms:B(t.pending_confirms).map(fm).filter(n=>n!==null),available_actions:B(t.available_actions).map(gm).filter(n=>n!==null)}}function bm(e){if(!E(e))return null;const t=y(e.id),n=y(e.kind),s=y(e.summary),a=y(e.target_type);return!t||!n||!s||!a?null:{id:t,kind:n,severity:y(e.severity)??"warn",summary:s,target_type:a,target_id:y(e.target_id)??null,top_action:jt(e.top_action),related_session_ids:B(e.related_session_ids).map(i=>typeof i=="string"?i.trim():"").filter(Boolean),related_agent_names:B(e.related_agent_names).map(i=>typeof i=="string"?i.trim():"").filter(Boolean),evidence_preview:B(e.evidence_preview).map(i=>typeof i=="string"?i.trim():"").filter(Boolean),last_seen_at:y(e.last_seen_at)??null}}function Bl(e){if(!E(e))return null;const t=y(e.session_id),n=y(e.goal);return!t||!n?null:{session_id:t,goal:n,room:y(e.room)??null,status:y(e.status),health:y(e.health),member_names:B(e.member_names).map(s=>typeof s=="string"?s.trim():"").filter(Boolean),started_at:y(e.started_at)??null,elapsed_sec:N(e.elapsed_sec)??null,operation_id:y(e.operation_id)??null,blocker_summary:y(e.blocker_summary)??null,last_event_at:y(e.last_event_at)??null,last_event_summary:y(e.last_event_summary)??null,communication_summary:y(e.communication_summary)??null,active_count:N(e.active_count),required_count:N(e.required_count),related_attention_count:N(e.related_attention_count)??0,top_attention:_n(e.top_attention),top_recommendation:jt(e.top_recommendation)}}function Wl(e){if(!E(e))return null;const t=y(e.agent_name);return t?{agent_name:t,status:y(e.status),current_work:y(e.current_work)??null,recent_input_preview:y(e.recent_input_preview)??null,recent_output_preview:y(e.recent_output_preview)??null,recent_tool_names:B(e.recent_tool_names).map(n=>typeof n=="string"?n.trim():"").filter(Boolean),last_activity_at:y(e.last_activity_at)??null}:null}function Gl(e){if(!E(e))return null;const t=y(e.operation_id);return t?{operation_id:t,status:y(e.status),stage:y(e.stage)??null,detachment_status:y(e.detachment_status)??null,objective:y(e.objective)??null,updated_at:y(e.updated_at)??null}:null}function Jl(e){if(!E(e))return null;const t=y(e.name);return t?{name:t,agent_name:y(e.agent_name)??null,status:y(e.status),generation:N(e.generation),context_ratio:N(e.context_ratio)??null,last_turn_ago_s:N(e.last_turn_ago_s)??null,current_work:y(e.current_work)??null}:null}function Vl(e){const t=Bl(e);return t?{...t,member_previews:B(E(e)?e.member_previews:void 0).map(Wl).filter(n=>n!==null),operation_badges:B(E(e)?e.operation_badges:void 0).map(Gl).filter(n=>n!==null),keeper_refs:B(E(e)?e.keeper_refs:void 0).map(Jl).filter(n=>n!==null)}:null}function km(e){if(!E(e))return null;const t=y(e.agent_name);return t?{agent_name:t,status:y(e.status),where:y(e.where)??null,with_whom:B(e.with_whom).map(n=>typeof n=="string"?n.trim():"").filter(Boolean),current_work:y(e.current_work)??null,related_session_id:y(e.related_session_id)??null,related_attention_count:N(e.related_attention_count)??0,last_activity_at:y(e.last_activity_at)??null,recent_output_preview:y(e.recent_output_preview)??null,recent_input_preview:y(e.recent_input_preview)??null,recent_event:y(e.recent_event)??null,recent_tool_names:B(e.recent_tool_names).map(n=>typeof n=="string"?n.trim():"").filter(Boolean),allowed_tool_names:B(e.allowed_tool_names).map(n=>typeof n=="string"?n.trim():"").filter(Boolean),latest_tool_names:B(e.latest_tool_names).map(n=>typeof n=="string"?n.trim():"").filter(Boolean),latest_tool_call_count:N(e.latest_tool_call_count)??null,tool_audit_source:y(e.tool_audit_source)??null,tool_audit_at:y(e.tool_audit_at)??null}:null}function xm(e){if(!E(e))return null;const t=y(e.name);return t?{name:t,agent_name:y(e.agent_name)??null,status:y(e.status),generation:N(e.generation),context_ratio:N(e.context_ratio)??null,last_turn_ago_s:N(e.last_turn_ago_s)??null,current_work:y(e.current_work)??null,last_autonomous_action_at:y(e.last_autonomous_action_at)??null,allowed_tool_names:B(e.allowed_tool_names).map(n=>typeof n=="string"?n.trim():"").filter(Boolean),latest_tool_names:B(e.latest_tool_names).map(n=>typeof n=="string"?n.trim():"").filter(Boolean),latest_tool_call_count:N(e.latest_tool_call_count)??null,tool_audit_source:y(e.tool_audit_source)??null,tool_audit_at:y(e.tool_audit_at)??null}:null}function Sm(e){if(!E(e))return null;const t=y(e.id),n=y(e.signal_type),s=y(e.summary),a=y(e.target_type);return!t||!n||!s||!a?null:{id:t,signal_type:n==="action"?"action":"attention",severity:y(e.severity)??"warn",summary:s,target_type:a,target_id:y(e.target_id)??null,attention:_n(e.attention),action:jt(e.action)}}function Cm(e){const t=E(e)?e:{},n=B(t.session_briefs).map(Bl).filter(a=>a!==null),s=B(t.sessions).map(Vl).filter(a=>a!==null);return{generated_at:y(t.generated_at),summary:$m(t.summary),incidents:B(t.incidents).map(_n).filter(a=>a!==null),recommended_actions:B(t.recommended_actions).map(jt).filter(a=>a!==null),command_focus:hm(t.command_focus),operator_targets:ym(t.operator_targets),attention_queue:B(t.attention_queue).map(bm).filter(a=>a!==null),sessions:s.length>0?s:n.map(a=>({...a,member_previews:[],operation_badges:[],keeper_refs:[]})),session_briefs:n,agent_briefs:B(t.agent_briefs).map(km).filter(a=>a!==null),keeper_briefs:B(t.keeper_briefs).map(xm).filter(a=>a!==null),internal_signals:B(t.internal_signals).map(Sm).filter(a=>a!==null)}}function Am(e){if(!E(e))return null;const t=y(e.id),n=y(e.summary);return!t||!n?null:{id:t,timestamp:y(e.timestamp)??null,event_type:y(e.event_type),actor:y(e.actor)??null,summary:n}}function Tm(e){const t=E(e)?e:{};return{generated_at:y(t.generated_at),session_id:y(t.session_id)??"",session:Vl(t.session),timeline:B(t.timeline).map(Am).filter(n=>n!==null),participants:B(t.participants).map(Wl).filter(n=>n!==null),operations:B(t.operations).map(Gl).filter(n=>n!==null),keepers:B(t.keepers).map(Jl).filter(n=>n!==null),error:y(t.error)??null}}function Im(e){if(!E(e))return null;const t=y(e.id),n=y(e.label),s=y(e.summary);if(!t||!n||!s)return null;const a=y(e.status)??"unclear";return{id:t,label:n,status:a==="ok"||a==="healthy"||a==="aligned"||a==="watch"||a==="risk"||a==="unclear"?a:"unclear",summary:s,signal_class:y(e.signal_class)==="metadata_gap"||y(e.signal_class)==="mixed"||y(e.signal_class)==="operational_risk"?y(e.signal_class):void 0,evidence_quality:y(e.evidence_quality)==="strong"||y(e.evidence_quality)==="partial"||y(e.evidence_quality)==="missing"?y(e.evidence_quality):void 0,evidence:B(e.evidence).map(l=>typeof l=="string"?l.trim():"").filter(Boolean)}}function Lm(e){if(!E(e))return null;const t=y(e.kind),n=y(e.summary),s=y(e.scope_type),a=y(e.severity);return!t||!n||!s||!a||s!=="session"&&s!=="keeper"&&s!=="agent"||a!=="info"&&a!=="watch"?null:{kind:t,summary:n,scope_type:s,scope_id:y(e.scope_id)??null,severity:a}}function Rm(e){const t=E(e)?e:{},n=E(t.basis)?t.basis:{},s=y(t.status)??"error",a=s==="ok"||s==="pending"||s==="unavailable"||s==="error"?s:"error";return{generated_at:y(t.generated_at),cached:Xt(t.cached),stale:Xt(t.stale),refreshing:Xt(t.refreshing),status:a,summary:y(t.summary)??null,model:y(t.model)??null,ttl_sec:N(t.ttl_sec),criteria:B(t.criteria).map(i=>typeof i=="string"?i.trim():"").filter(Boolean),basis:{current_room:y(n.current_room)??null,crew_count:N(n.crew_count),agent_count:N(n.agent_count),keeper_count:N(n.keeper_count)},metadata_gap_count:N(t.metadata_gap_count),metadata_gaps:B(t.metadata_gaps).map(Lm).filter(i=>i!==null),sections:B(t.sections).map(Im).filter(i=>i!==null),error:y(t.error)??null,last_error:y(t.last_error)??null}}async function Ql(){Uo.value=!0,oa.value=null;try{const e=await Qd();is.value=Cm(e)}catch(e){oa.value=e instanceof Error?e.message:"Failed to load mission snapshot"}finally{Uo.value=!1}}async function zm(e){if(!e){Ho.value=null,Bs.value=null,Hs.value=!1;return}Hs.value=!0,Bs.value=null;try{const t=await Yd(e);Ho.value=Tm(t)}catch(t){Bs.value=t instanceof Error?t.message:"Failed to load session detail"}finally{Hs.value=!1}}async function ia(e=!1){Ft.value=!0,Ct.value=null;try{const t=await Xd(e),n=Rm(t);Hl.value=n,n.refreshing||n.status==="pending"?pm():ur()}catch(t){Ct.value=t instanceof Error?t.message:"Failed to load mission briefing",ur()}finally{Ft.value=!1}}const Yl=g(null),Bo=g(!1),Kt=g(null);async function Xl(e,t){Bo.value=!0,Kt.value=null;try{Yl.value=await Zd(e,t)}catch(n){Kt.value=n instanceof Error?n.message:String(n)}finally{Bo.value=!1}}const ki=g(null),Ue=g(null),ra=g(!1),la=g(!1),ca=g(null),da=g(null),Wo=g(null),ua=g(null),V=g("warroom"),rs=g(null),Go=g(!1),pa=g(null),Et=g(null),ma=g(!1),_a=g(null),xi=g(null),Jo=g(!1),va=g(null),ls=g(null),Vo=g(!1),fa=g(null),Un=g(null),ga=g(!1),Hn=g(null),Zt=g(null);let Sn=null;function Si(e){return e!=="summary"&&e!=="swarm"&&e!=="warroom"&&e!=="orchestra"}function Zl(){if(typeof window>"u")return new URLSearchParams;const e=new URLSearchParams(window.location.search),t=window.location.hash.replace(/^#/,""),n=t.indexOf("?");return n>=0&&new URLSearchParams(t.slice(n+1)).forEach((a,i)=>{e.has(i)||e.set(i,a)}),e}function ec(){const t=Zl().get("run_id")??void 0;return t&&t.trim()!==""?t.trim():void 0}function tc(){const t=Zl().get("operation_id")??void 0;return t&&t.trim()!==""?t.trim():void 0}function Pm(e){if(_(e))return{policy_class:r(e.policy_class),approval_class:r(e.approval_class),tool_allowlist:F(e.tool_allowlist),model_allowlist:F(e.model_allowlist),requires_human_for:F(e.requires_human_for),autonomy_level:r(e.autonomy_level),escalation_timeout_sec:d(e.escalation_timeout_sec),kill_switch:j(e.kill_switch),frozen:j(e.frozen)}}function Mm(e){if(_(e))return{headcount_cap:d(e.headcount_cap),active_operation_cap:d(e.active_operation_cap),max_cost_usd:d(e.max_cost_usd),max_tokens:d(e.max_tokens)}}function Ci(e){if(!_(e))return null;const t=r(e.unit_id),n=r(e.label),s=r(e.kind);return!t||!n||!s?null:{unit_id:t,label:n,kind:s,parent_unit_id:r(e.parent_unit_id)??null,leader_id:r(e.leader_id)??null,roster:F(e.roster),capability_profile:F(e.capability_profile),source:r(e.source),created_at:r(e.created_at),updated_at:r(e.updated_at),policy:Pm(e.policy),budget:Mm(e.budget)}}function nc(e){if(!_(e))return null;const t=Ci(e.unit);return t?{unit:t,leader_status:r(e.leader_status),roster_total:d(e.roster_total),roster_live:d(e.roster_live),active_operation_count:d(e.active_operation_count),health:r(e.health),reasons:F(e.reasons),children:Array.isArray(e.children)?e.children.map(nc).filter(n=>n!==null):[]}:null}function jm(e){if(_(e))return{total_units:d(e.total_units),company_count:d(e.company_count),platoon_count:d(e.platoon_count),squad_count:d(e.squad_count),leaf_agent_unit_count:d(e.leaf_agent_unit_count),live_agent_count:d(e.live_agent_count),managed_unit_count:d(e.managed_unit_count),active_operation_count:d(e.active_operation_count)}}function sc(e){const t=_(e)?e:{};return{version:r(t.version),generated_at:r(t.generated_at),source:r(t.source),summary:jm(t.summary),units:Array.isArray(t.units)?t.units.map(nc).filter(n=>n!==null):[]}}function Em(e){if(!_(e))return null;const t=r(e.kind),n=r(e.status);return!t||!n?null:{kind:t,chain_id:r(e.chain_id)??null,goal:r(e.goal)??null,run_id:r(e.run_id)??null,status:n,viewer_path:r(e.viewer_path)??null,last_sync_at:r(e.last_sync_at)??null}}function Ua(e){if(!_(e))return null;const t=r(e.operation_id),n=r(e.objective),s=r(e.assigned_unit_id),a=r(e.trace_id),i=r(e.status);return!t||!n||!s||!a||!i?null:{operation_id:t,objective:n,assigned_unit_id:s,autonomy_level:r(e.autonomy_level),policy_class:r(e.policy_class),budget_class:r(e.budget_class),detachment_session_id:r(e.detachment_session_id)??null,trace_id:a,checkpoint_ref:r(e.checkpoint_ref)??null,active_goal_ids:F(e.active_goal_ids),note:r(e.note)??null,created_by:r(e.created_by),source:r(e.source),status:i,chain:Em(e.chain),created_at:r(e.created_at),updated_at:r(e.updated_at)}}function Nm(e){if(!_(e))return null;const t=Ua(e.operation);return t?{operation:t,assigned_unit_label:r(e.assigned_unit_label)}:null}function yn(e){if(_(e))return{tone:r(e.tone),pending_ops:d(e.pending_ops),blocked_ops:d(e.blocked_ops),in_flight_ops:d(e.in_flight_ops),pipeline_stalls:d(e.pipeline_stalls),bus_traffic:d(e.bus_traffic),l1_hit_rate:d(e.l1_hit_rate),invalidation_count:d(e.invalidation_count),current_pending:d(e.current_pending),current_in_flight:d(e.current_in_flight),cdb_wakeups:d(e.cdb_wakeups),total_stolen:d(e.total_stolen),avg_best_score:d(e.avg_best_score),avg_candidate_count:d(e.avg_candidate_count),best_first_operations:d(e.best_first_operations),active_sessions:d(e.active_sessions),commit_rate:d(e.commit_rate),total_speculations:d(e.total_speculations)}}function Dm(e){if(!_(e))return;const t=_(e.pipeline)?e.pipeline:void 0,n=_(e.cache)?e.cache:void 0,s=_(e.ooo)?e.ooo:void 0,a=_(e.speculative)?e.speculative:void 0,i=_(e.search_fabric)?e.search_fabric:void 0,l=_(e.signals)?e.signals:void 0;return{pipeline:t?{total_ops:d(t.total_ops),completed_ops:d(t.completed_ops),stalled_cycles:d(t.stalled_cycles),hazards_detected:d(t.hazards_detected),forwarding_used:d(t.forwarding_used),pipeline_flushes:d(t.pipeline_flushes),ipc:d(t.ipc)}:void 0,cache:n?{total_reads:d(n.total_reads),total_writes:d(n.total_writes),l1_hit_rate:d(n.l1_hit_rate),invalidation_count:d(n.invalidation_count),writeback_count:d(n.writeback_count),bus_traffic:d(n.bus_traffic)}:void 0,ooo:s?{agent_count:d(s.agent_count),total_added:d(s.total_added),total_issued:d(s.total_issued),total_completed:d(s.total_completed),total_stolen:d(s.total_stolen),cdb_wakeups:d(s.cdb_wakeups),stall_cycles:d(s.stall_cycles),global_cdb_events:d(s.global_cdb_events),current_pending:d(s.current_pending),current_in_flight:d(s.current_in_flight)}:void 0,speculative:a?{total_speculations:d(a.total_speculations),total_commits:d(a.total_commits),total_aborts:d(a.total_aborts),commit_rate:d(a.commit_rate),total_fast_calls:d(a.total_fast_calls),total_cost_usd:d(a.total_cost_usd),active_sessions:d(a.active_sessions)}:void 0,search_fabric:i?{total_operations:d(i.total_operations),best_first_operations:d(i.best_first_operations),legacy_operations:d(i.legacy_operations),blocked_operations:d(i.blocked_operations),ready_operations:d(i.ready_operations),research_pipeline_operations:d(i.research_pipeline_operations),avg_candidate_count:d(i.avg_candidate_count),avg_best_score:d(i.avg_best_score),top_stage:r(i.top_stage)??null}:void 0,signals:l?{issue_pressure:yn(l.issue_pressure),cache_contention:yn(l.cache_contention),scheduler_efficiency:yn(l.scheduler_efficiency),routing_confidence:yn(l.routing_confidence),speculative_posture:yn(l.speculative_posture)}:void 0}}function ac(e){const t=_(e)?e:{},n=_(t.summary)?t.summary:void 0;return{version:r(t.version),generated_at:r(t.generated_at),summary:n?{total:d(n.total),active:d(n.active),paused:d(n.paused),managed:d(n.managed),projected:d(n.projected)}:void 0,microarch:Dm(t.microarch),operations:Array.isArray(t.operations)?t.operations.map(Nm).filter(s=>s!==null):[]}}function oc(e){if(!_(e))return null;const t=r(e.detachment_id),n=r(e.operation_id),s=r(e.assigned_unit_id);return!t||!n||!s?null:{detachment_id:t,operation_id:n,assigned_unit_id:s,leader_id:r(e.leader_id)??null,roster:F(e.roster),session_id:r(e.session_id)??null,checkpoint_ref:r(e.checkpoint_ref)??null,runtime_kind:r(e.runtime_kind)??null,runtime_ref:r(e.runtime_ref)??null,source:r(e.source),status:r(e.status),last_event_at:r(e.last_event_at)??null,last_progress_at:r(e.last_progress_at)??null,heartbeat_deadline:r(e.heartbeat_deadline)??null,created_at:r(e.created_at),updated_at:r(e.updated_at)}}function Om(e){if(!_(e))return null;const t=oc(e.detachment);return t?{detachment:t,assigned_unit_label:r(e.assigned_unit_label),operation:Ua(e.operation)}:null}function ic(e){const t=_(e)?e:{},n=_(t.summary)?t.summary:void 0;return{version:r(t.version),generated_at:r(t.generated_at),summary:n?{total:d(n.total),active:d(n.active),projected:d(n.projected)}:void 0,detachments:Array.isArray(t.detachments)?t.detachments.map(Om).filter(s=>s!==null):[]}}function wm(e){if(!_(e))return null;const t=r(e.decision_id),n=r(e.trace_id),s=r(e.requested_action),a=r(e.scope_type),i=r(e.scope_id);return!t||!n||!s||!a||!i?null:{decision_id:t,trace_id:n,requested_action:s,scope_type:a,scope_id:i,operation_id:r(e.operation_id)??null,target_unit_id:r(e.target_unit_id)??null,requested_by:r(e.requested_by),status:r(e.status),reason:r(e.reason)??null,source:r(e.source),detail:e.detail,created_at:r(e.created_at),decided_at:r(e.decided_at)??null,expires_at:r(e.expires_at)??null}}function rc(e){const t=_(e)?e:{},n=_(t.summary)?t.summary:void 0;return{version:r(t.version),generated_at:r(t.generated_at),summary:n?{total:d(n.total),pending:d(n.pending),approved:d(n.approved),denied:d(n.denied)}:void 0,decisions:Array.isArray(t.decisions)?t.decisions.map(wm).filter(s=>s!==null):[]}}function qm(e){if(!_(e))return null;const t=Ci(e.unit);return t?{unit:t,roster_total:d(e.roster_total),roster_live:d(e.roster_live),headcount_cap:d(e.headcount_cap),active_operations:d(e.active_operations),active_operation_cap:d(e.active_operation_cap),utilization:d(e.utilization)}:null}function Fm(e){const t=_(e)?e:{};return{version:r(t.version),generated_at:r(t.generated_at),capacity:Array.isArray(t.capacity)?t.capacity.map(qm).filter(n=>n!==null):[]}}function Km(e){if(!_(e))return null;const t=r(e.alert_id);return t?{alert_id:t,severity:r(e.severity),kind:r(e.kind),scope_type:r(e.scope_type),scope_id:r(e.scope_id),title:r(e.title),detail:r(e.detail),timestamp:r(e.timestamp)}:null}function lc(e){const t=_(e)?e:{},n=_(t.summary)?t.summary:void 0;return{version:r(t.version),generated_at:r(t.generated_at),summary:n?{total:d(n.total),bad:d(n.bad),warn:d(n.warn)}:void 0,alerts:Array.isArray(t.alerts)?t.alerts.map(Km).filter(s=>s!==null):[]}}function cc(e){if(!_(e))return null;const t=r(e.event_id),n=r(e.trace_id),s=r(e.event_type);return!t||!n||!s?null:{event_id:t,trace_id:n,event_type:s,operation_id:r(e.operation_id)??null,unit_id:r(e.unit_id)??null,actor:r(e.actor)??null,source:r(e.source),timestamp:r(e.timestamp),detail:e.detail}}function Um(e){const t=_(e)?e:{};return{version:r(t.version),generated_at:r(t.generated_at),events:Array.isArray(t.events)?t.events.map(cc).filter(n=>n!==null):[]}}function Hm(e){if(!_(e))return null;const t=r(e.code),n=r(e.severity),s=r(e.summary);return!t||!n||!s?null:{code:t,severity:n,summary:s}}function Bm(e){if(!_(e))return null;const t=r(e.lane_id),n=r(e.label),s=r(e.kind),a=r(e.phase),i=r(e.motion_state),l=r(e.source_of_truth),c=r(e.movement_reason),p=r(e.current_step);if(!t||!n||!s||!a||!i||!l||!c||!p)return null;const m=_(e.counts)?e.counts:{};return{lane_id:t,label:n,kind:s,present:j(e.present)??!1,phase:a,motion_state:i,source_of_truth:l,last_movement_at:r(e.last_movement_at)??null,movement_reason:c,current_step:p,blockers:F(e.blockers),counts:{operations:d(m.operations),detachments:d(m.detachments),workers:d(m.workers),approvals:d(m.approvals),alerts:d(m.alerts)},hard_flags:Array.isArray(e.hard_flags)?e.hard_flags.map(Hm).filter(u=>u!==null):[]}}function Wm(e){if(!_(e))return null;const t=r(e.event_id),n=r(e.lane_id),s=r(e.kind),a=r(e.timestamp),i=r(e.title),l=r(e.detail),c=r(e.tone),p=r(e.source);return!t||!n||!s||!a||!i||!l||!c||!p?null:{event_id:t,lane_id:n,kind:s,timestamp:a,title:i,detail:l,tone:c,source:p}}function Gm(e){if(!_(e))return null;const t=r(e.code),n=r(e.severity),s=r(e.summary);return!t||!n||!s?null:{code:t,severity:n,summary:s,lane_ids:F(e.lane_ids),count:d(e.count)??0}}function Ai(e){if(!_(e))return;const t=_(e.overview)?e.overview:{},n=_(e.gaps)?e.gaps:{},s=_(e.recommended_next_action)?e.recommended_next_action:void 0;return{generated_at:r(e.generated_at),overview:{active_lanes:d(t.active_lanes),moving_lanes:d(t.moving_lanes),stalled_lanes:d(t.stalled_lanes),projected_lanes:d(t.projected_lanes),last_movement_at:r(t.last_movement_at)??null},lanes:Array.isArray(e.lanes)?e.lanes.map(Bm).filter(a=>a!==null):[],timeline:Array.isArray(e.timeline)?e.timeline.map(Wm).filter(a=>a!==null):[],gaps:{count:d(n.count),items:Array.isArray(n.items)?n.items.map(Gm).filter(a=>a!==null):[]},recommended_next_action:s?{tool:r(s.tool)??"masc_operator_snapshot",label:r(s.label)??"Observe operator state",reason:r(s.reason)??"",lane_id:r(s.lane_id)??null}:void 0}}function dc(e){if(!_(e))return;const t=_(e.workers)?e.workers:{},n=j(e.pass);return{status:r(e.status)??"missing",source:r(e.source)??"none",run_id:r(e.run_id)??null,captured_at:r(e.captured_at)??null,...n!==void 0?{pass:n}:{},...d(e.peak_hot_slots)!=null?{peak_hot_slots:d(e.peak_hot_slots)}:{},...d(e.ctx_per_slot)!=null?{ctx_per_slot:d(e.ctx_per_slot)}:{},workers:{expected:d(t.expected),joined:d(t.joined),current_task_bound:d(t.current_task_bound),fresh_heartbeats:d(t.fresh_heartbeats),done:d(t.done),final:d(t.final)},artifact_ref:r(e.artifact_ref)??null,missing_reason:r(e.missing_reason)??null}}function Jm(e){const t=_(e)?e:{};return{version:r(t.version),generated_at:r(t.generated_at),topology:sc(t.topology),operations:ac(t.operations),detachments:ic(t.detachments),alerts:lc(t.alerts),decisions:rc(t.decisions),capacity:Fm(t.capacity),traces:Um(t.traces),swarm_status:Ai(t.swarm_status)}}function Vm(e){const t=_(e)?e:{},n=sc(t.topology),s=ac(t.operations),a=ic(t.detachments),i=lc(t.alerts),l=rc(t.decisions);return{version:r(t.version),generated_at:r(t.generated_at),topology:{version:n.version,generated_at:n.generated_at,source:n.source,summary:n.summary},operations:{version:s.version,generated_at:s.generated_at,summary:s.summary,microarch:s.microarch},detachments:{version:a.version,generated_at:a.generated_at,summary:a.summary},alerts:{version:i.version,generated_at:i.generated_at,summary:i.summary},decisions:{version:l.version,generated_at:l.generated_at,summary:l.summary},swarm_status:Ai(t.swarm_status),swarm_proof:dc(t.swarm_proof)}}function Qm(e){return _(e)?{chain_id:r(e.chain_id)??null,started_at:d(e.started_at)??null,progress:d(e.progress)??null,elapsed_sec:d(e.elapsed_sec)??null}:null}function uc(e){if(!_(e))return null;const t=r(e.event);return t?{event:t,chain_id:r(e.chain_id)??null,timestamp:r(e.timestamp)??null,duration_ms:d(e.duration_ms)??null,message:r(e.message)??null,tokens:d(e.tokens)??null}:null}function Ym(e){if(!_(e))return null;const t=Ua(e.operation);return t?{operation:t,runtime:Qm(e.runtime),history:uc(e.history),mermaid:r(e.mermaid)??null,preview_run:pc(e.preview_run)}:null}function Xm(e){const t=_(e)?e:{};return{status:r(t.status)??"disconnected",base_url:r(t.base_url)??null,message:r(t.message)??null}}function Zm(e){const t=_(e)?e:{},n=_(t.summary)?t.summary:void 0;return{version:r(t.version),generated_at:r(t.generated_at),connection:Xm(t.connection),summary:n?{linked_operations:d(n.linked_operations),active_chains:d(n.active_chains),running_operations:d(n.running_operations),recent_failures:d(n.recent_failures),last_history_event_at:r(n.last_history_event_at)??null}:void 0,operations:Array.isArray(t.operations)?t.operations.map(Ym).filter(s=>s!==null):[],recent_history:Array.isArray(t.recent_history)?t.recent_history.map(uc).filter(s=>s!==null):[]}}function e_(e){if(!_(e))return null;const t=r(e.id);return t?{id:t,type:r(e.type),status:r(e.status),duration_ms:d(e.duration_ms)??null,error:r(e.error)??null}:null}function pc(e){if(!_(e))return null;const t=r(e.run_id),n=r(e.chain_id);return n?{run_id:t??null,chain_id:n,duration_ms:d(e.duration_ms),success:j(e.success),mermaid:r(e.mermaid),nodes:Array.isArray(e.nodes)?e.nodes.map(e_).filter(s=>s!==null):[]}:null}function t_(e){const t=_(e)?e:{};return{run:pc(t.run)}}function n_(e){if(!_(e))return null;const t=r(e.title),n=r(e.path);return!t||!n?null:{title:t,path:n}}function s_(e){if(!_(e))return null;const t=r(e.id),n=r(e.title),s=r(e.summary);return!t||!n||!s?null:{id:t,title:n,summary:s}}function a_(e){if(!_(e))return null;const t=r(e.id),n=r(e.title),s=r(e.tool),a=r(e.summary);return!t||!n||!s||!a?null:{id:t,title:n,tool:s,summary:a,success_signals:F(e.success_signals),pitfalls:F(e.pitfalls)}}function o_(e){if(!_(e))return null;const t=r(e.id),n=r(e.title),s=r(e.summary),a=r(e.when_to_use);return!t||!n||!s||!a?null:{id:t,title:n,summary:s,when_to_use:a,steps:Array.isArray(e.steps)?e.steps.map(a_).filter(i=>i!==null):[]}}function i_(e){if(!_(e))return null;const t=r(e.id),n=r(e.title),s=r(e.description);return!t||!n||!s?null:{id:t,title:n,description:s,tools:F(e.tools)}}function r_(e){if(!_(e))return null;const t=r(e.id),n=r(e.title),s=r(e.symptom),a=r(e.why),i=r(e.fix_tool),l=r(e.fix_summary);return!t||!n||!s||!a||!i||!l?null:{id:t,title:n,symptom:s,why:a,fix_tool:i,fix_summary:l}}function l_(e){if(!_(e))return null;const t=r(e.id),n=r(e.title),s=r(e.path_id),a=r(e.transport);return!t||!n||!s||!a?null:{id:t,title:n,path_id:s,transport:a,request:e.request,response:e.response,notes:F(e.notes)}}function c_(e){const t=_(e)?e:{};return{version:r(t.version),generated_at:r(t.generated_at),docs:Array.isArray(t.docs)?t.docs.map(n_).filter(n=>n!==null):[],concepts:Array.isArray(t.concepts)?t.concepts.map(s_).filter(n=>n!==null):[],golden_paths:Array.isArray(t.golden_paths)?t.golden_paths.map(o_).filter(n=>n!==null):[],tool_groups:Array.isArray(t.tool_groups)?t.tool_groups.map(i_).filter(n=>n!==null):[],pitfalls:Array.isArray(t.pitfalls)?t.pitfalls.map(r_).filter(n=>n!==null):[],examples:Array.isArray(t.examples)?t.examples.map(l_).filter(n=>n!==null):[]}}function d_(e){if(!_(e))return null;const t=r(e.id),n=r(e.title),s=r(e.status),a=r(e.detail),i=r(e.next_tool);return!t||!n||!s||!a||!i?null:{id:t,title:n,status:s,detail:a,next_tool:i}}function u_(e){if(!_(e))return null;const t=r(e.code),n=r(e.severity),s=r(e.title),a=r(e.detail),i=r(e.next_tool);return!t||!n||!s||!a||!i?null:{code:t,severity:n,title:s,detail:a,next_tool:i}}function p_(e){if(!_(e))return null;const t=r(e.from),n=r(e.content),s=r(e.timestamp),a=d(e.seq);return!t||!n||!s||a==null?null:{seq:a,from:t,content:n,timestamp:s}}function m_(e){if(!_(e))return null;const t=r(e.name),n=r(e.role),s=r(e.lane),a=r(e.status),i=r(e.claim_marker),l=r(e.done_marker),c=r(e.final_marker);if(!t||!n||!s||!a||!i||!l||!c)return null;const p=(()=>{if(!_(e.last_message))return null;const m=d(e.last_message.seq),u=r(e.last_message.content),f=r(e.last_message.timestamp);return m==null||!u||!f?null:{seq:m,content:u,timestamp:f}})();return{name:t,role:n,lane:s,joined:j(e.joined)??!1,live_presence:j(e.live_presence)??!1,completed:j(e.completed)??!1,status:a,current_task:r(e.current_task)??null,bound_task_id:r(e.bound_task_id)??null,bound_task_title:r(e.bound_task_title)??null,bound_task_status:r(e.bound_task_status)??null,current_task_matches_run:j(e.current_task_matches_run)??!1,squad_member:j(e.squad_member)??!1,detachment_member:j(e.detachment_member)??!1,last_seen:r(e.last_seen)??null,heartbeat_age_sec:d(e.heartbeat_age_sec)??null,heartbeat_fresh:j(e.heartbeat_fresh)??!1,claim_marker_seen:j(e.claim_marker_seen)??!1,done_marker_seen:j(e.done_marker_seen)??!1,final_marker_seen:j(e.final_marker_seen)??!1,claim_marker:i,done_marker:l,final_marker:c,last_message:p}}function __(e){if(!_(e))return;const t=Array.isArray(e.timeline)?e.timeline.map(n=>{if(!_(n))return null;const s=r(n.timestamp),a=d(n.active_slots);if(!s||a==null)return null;const i=Array.isArray(n.active_slot_ids)?n.active_slot_ids.map(l=>typeof l=="number"&&Number.isFinite(l)?l:null).filter(l=>l!=null):[];return{timestamp:s,active_slots:a,active_slot_ids:i}}).filter(n=>n!==null):[];return{slot_url:r(e.slot_url)??null,provider_base_url:r(e.provider_base_url)??null,provider_reachable:j(e.provider_reachable)??null,provider_status_code:d(e.provider_status_code)??null,provider_model_id:r(e.provider_model_id)??null,actual_model_id:r(e.actual_model_id)??null,expected_slots:d(e.expected_slots),actual_slots:d(e.actual_slots),expected_ctx:d(e.expected_ctx),actual_ctx:d(e.actual_ctx),configured_capacity:d(e.configured_capacity),slot_reachable:j(e.slot_reachable)??null,slot_status_code:d(e.slot_status_code)??null,runtime_blocker:r(e.runtime_blocker)??null,detail:r(e.detail)??null,checked_at:r(e.checked_at)??null,total_slots:d(e.total_slots),ctx_per_slot:d(e.ctx_per_slot),active_slots_now:d(e.active_slots_now),peak_active_slots:d(e.peak_active_slots),sample_count:d(e.sample_count),last_sample_at:r(e.last_sample_at)??null,timeline:t}}function v_(e){if(!_(e))return null;const t=r(e.run_id),n=r(e.status),s=r(e.decided_by),a=r(e.decided_at),i=r(e.reason);if(!t||!n||!s||!a||!i)return null;const l=[];return Array.isArray(e.history)&&e.history.forEach(c=>{if(!_(c))return;const p=r(c.status),m=r(c.decided_by),u=r(c.decided_at),f=r(c.reason);!p||!m||!u||!f||l.push({status:p,decided_by:m,decided_at:u,reason:f,operation_id:r(c.operation_id)??null,detachment_id:r(c.detachment_id)??null,note:r(c.note)??null})}),{run_id:t,status:n,decided_by:s,decided_at:a,reason:i,operation_id:r(e.operation_id)??null,detachment_id:r(e.detachment_id)??null,note:r(e.note)??null,history:l}}function f_(e){if(!_(e))return null;const t=r(e.run_id),n=r(e.recommended_kind),s=r(e.reason);return!t||!n||!s?null:{run_id:t,recommended_kind:n,continue_available:j(e.continue_available)??!1,rerun_available:j(e.rerun_available)??!1,abandon_available:j(e.abandon_available)??!1,reason:s,evidence:_(e.evidence)?{operation_id:r(e.evidence.operation_id)??null,detachment_id:r(e.evidence.detachment_id)??null,joined_workers:d(e.evidence.joined_workers),current_task_bound:d(e.evidence.current_task_bound),fresh_heartbeats:d(e.evidence.fresh_heartbeats),trace_events:d(e.evidence.trace_events),message_events:d(e.evidence.message_events),runtime_blocker:r(e.evidence.runtime_blocker)??null}:void 0,provenance:r(e.provenance),decision_engine:r(e.decision_engine),authoritative:j(e.authoritative)}}function g_(e){const t=_(e)?e:{},n=_(t.summary)?t.summary:void 0;return{version:r(t.version),generated_at:r(t.generated_at),run_id:r(t.run_id),room_id:r(t.room_id),operation_id:r(t.operation_id)??null,run_resolution:v_(t.run_resolution),resolution_recommendation:f_(t.resolution_recommendation),recommended_next_tool:r(t.recommended_next_tool),summary:n?{expected_workers:d(n.expected_workers),joined_workers:d(n.joined_workers),live_workers:d(n.live_workers),squad_roster_size:d(n.squad_roster_size),detachment_roster_size:d(n.detachment_roster_size),current_task_bound:d(n.current_task_bound),fresh_heartbeats:d(n.fresh_heartbeats),claim_markers_seen:d(n.claim_markers_seen),done_markers_seen:d(n.done_markers_seen),final_markers_seen:d(n.final_markers_seen),completed_workers:d(n.completed_workers),peak_hot_slots:d(n.peak_hot_slots),hot_window_ok:j(n.hot_window_ok),pass_hot_concurrency:j(n.pass_hot_concurrency),pass_end_to_end:j(n.pass_end_to_end),pending_decisions:d(n.pending_decisions),pass:j(n.pass)}:void 0,provider:__(t.provider),operation:Ua(t.operation),squad:Ci(t.squad),detachment:oc(t.detachment),workers:Array.isArray(t.workers)?t.workers.map(m_).filter(s=>s!==null):[],checklist:Array.isArray(t.checklist)?t.checklist.map(d_).filter(s=>s!==null):[],blockers:Array.isArray(t.blockers)?t.blockers.map(u_).filter(s=>s!==null):[],recent_messages:Array.isArray(t.recent_messages)?t.recent_messages.map(p_).filter(s=>s!==null):[],recent_trace_events:Array.isArray(t.recent_trace_events)?t.recent_trace_events.map(cc).filter(s=>s!==null):[],truth_notes:F(t.truth_notes)}}function $_(e){if(!_(e))return null;const t=r(e.label),n=r(e.value);return!t||!n?null:{label:t,value:n}}function h_(e){if(!_(e))return null;const t=r(e.id),n=r(e.kind),s=r(e.label),a=r(e.tone),i=r(e.provenance);return!t||!n||!s||!a||!i?null:{id:t,kind:n,label:s,subtitle:r(e.subtitle)??null,status:r(e.status)??null,tone:a,pulse:r(e.pulse)??null,provenance:i,visual_class:r(e.visual_class)??void 0,glyph:r(e.glyph)??void 0,parent_id:r(e.parent_id)??null,lane_id:r(e.lane_id)??null,link_tab:r(e.link_tab)??null,link_surface:r(e.link_surface)??null,link_params:_(e.link_params)?Object.fromEntries(Object.entries(e.link_params).map(([l,c])=>{const p=r(c);return p?[l,p]:null}).filter(l=>l!==null)):{},facts:Array.isArray(e.facts)?e.facts.map($_).filter(l=>l!==null):[]}}function y_(e){if(!_(e))return null;const t=r(e.id),n=r(e.source),s=r(e.target),a=r(e.kind),i=r(e.tone),l=r(e.provenance);return!t||!n||!s||!a||!i||!l?null:{id:t,source:n,target:s,kind:a,label:r(e.label)??null,tone:i,provenance:l,animated:j(e.animated)}}function b_(e){if(!_(e))return null;const t=r(e.id),n=r(e.kind),s=r(e.label),a=r(e.tone),i=r(e.provenance);return!t||!n||!s||!a||!i?null:{id:t,kind:n,label:s,detail:r(e.detail)??null,tone:a,provenance:i,source_id:r(e.source_id)??null,target_id:r(e.target_id)??null,suggested_surface:r(e.suggested_surface)??null,suggested_params:_(e.suggested_params)?Object.fromEntries(Object.entries(e.suggested_params).map(([l,c])=>{const p=r(c);return p?[l,p]:null}).filter(l=>l!==null)):{}}}function k_(e){if(!_(e))return null;const t=r(e.target_kind),n=r(e.target_id),s=r(e.label),a=r(e.reason);return!t||!n||!s||!a?null:{target_kind:t,target_id:n,label:s,reason:a,suggested_surface:r(e.suggested_surface)??null,suggested_params:_(e.suggested_params)?Object.fromEntries(Object.entries(e.suggested_params).map(([i,l])=>{const c=r(l);return c?[i,c]:null}).filter(i=>i!==null)):{}}}function x_(e){const t=_(e)?e:{},n=_(t.room)?t.room:{},s=_(t.summary)?t.summary:void 0;return{version:r(t.version),generated_at:r(t.generated_at),room:{room_id:r(n.room_id),project:r(n.project),cluster:r(n.cluster),paused:j(n.paused),pause_reason:r(n.pause_reason)??null,agent_count:d(n.agent_count),task_count:d(n.task_count),message_count:d(n.message_count)},summary:s?{session_count:d(s.session_count),operation_count:d(s.operation_count),detachment_count:d(s.detachment_count),lane_count:d(s.lane_count),worker_count:d(s.worker_count),keeper_count:d(s.keeper_count),signal_count:d(s.signal_count),alert_count:d(s.alert_count)}:void 0,nodes:Array.isArray(t.nodes)?t.nodes.map(h_).filter(a=>a!==null):[],edges:Array.isArray(t.edges)?t.edges.map(y_).filter(a=>a!==null):[],signals:Array.isArray(t.signals)?t.signals.map(b_).filter(a=>a!==null):[],focus:k_(t.focus),swarm_status:Ai(t.swarm_status),swarm_proof:dc(t.swarm_proof),truth_notes:F(t.truth_notes)}}function rt(e){V.value=e,Si(e)&&S_()}async function mc(){ra.value=!0,ca.value=null;try{const e=await ou();ki.value=Vm(e)}catch(e){ca.value=e instanceof Error?e.message:"Failed to load command-plane summary"}finally{ra.value=!1}}function Ti(e){Zt.value=e}async function Ii(){la.value=!0,da.value=null;try{const e=await au();Ue.value=Jm(e)}catch(e){da.value=e instanceof Error?e.message:"Failed to load command-plane snapshot"}finally{la.value=!1}}async function S_(){Ue.value||la.value||await Ii()}async function Ut(){await mc(),Si(V.value)&&await Ii()}async function en(){var e;Vo.value=!0,fa.value=null;try{const t=await iu(),n=Zm(t);ls.value=n;const s=Zt.value;n.operations.length===0?Zt.value=null:(!s||!n.operations.some(a=>a.operation.operation_id===s))&&(Zt.value=((e=n.operations[0])==null?void 0:e.operation.operation_id)??null)}catch(t){fa.value=t instanceof Error?t.message:"Failed to load chain summary"}finally{Vo.value=!1}}function C_(){Sn=null,Un.value=null,ga.value=!1,Hn.value=null}async function A_(e){Sn=e,ga.value=!0,Hn.value=null;try{const t=await ru(e);if(Sn!==e)return;Un.value=t_(t)}catch(t){if(Sn!==e)return;Un.value=null,Hn.value=t instanceof Error?t.message:"Failed to load chain run"}finally{Sn===e&&(ga.value=!1)}}async function T_(){Go.value=!0,pa.value=null;try{const e=await lu();rs.value=c_(e)}catch(e){pa.value=e instanceof Error?e.message:"Failed to load command-plane help"}finally{Go.value=!1}}async function tt(e=ec(),t=tc()){ma.value=!0,_a.value=null;try{const n=await cu(e,t);Et.value=g_(n)}catch(n){_a.value=n instanceof Error?n.message:"Failed to load command-plane swarm view"}finally{ma.value=!1}}async function Lt(e=ec(),t=tc()){Jo.value=!0,va.value=null;try{const n=await du(e,t);xi.value=x_(n)}catch(n){va.value=n instanceof Error?n.message:"Failed to load orchestra map"}finally{Jo.value=!1}}async function ft(e,t,n){Wo.value=e,ua.value=null;try{await uu(t,n),await mc(),(Ue.value||Si(V.value))&&await Ii(),await tt(),await Lt(),await en()}catch(s){throw ua.value=s instanceof Error?s.message:"Failed to execute command-plane action",s}finally{Wo.value=null}}function I_(e){return ft(`pause:${e}`,"/api/v1/command-plane/operations/pause",{operation_id:e})}function L_(e){return ft(`resume:${e}`,"/api/v1/command-plane/operations/resume",{operation_id:e})}function R_(e){return ft(`recall:${e}`,"/api/v1/command-plane/dispatch/recall",{operation_id:e})}function z_(e={}){return ft("dispatch:tick","/api/v1/command-plane/dispatch/tick",{...e.operationId?{operation_id:e.operationId}:{},...e.detachmentId?{detachment_id:e.detachmentId}:{}})}function P_(e){return ft(`approve:${e}`,"/api/v1/command-plane/policy/approve",{decision_id:e})}function M_(e){return ft(`deny:${e}`,"/api/v1/command-plane/policy/deny",{decision_id:e})}function j_(e,t){return ft(`freeze:${e}`,"/api/v1/command-plane/policy/freeze",{unit_id:e,enabled:t})}function E_(e,t){return ft(`kill:${e}`,"/api/v1/command-plane/policy/kill-switch",{unit_id:e,enabled:t})}Yp(()=>{Ut(),en(),(V.value==="swarm"||V.value==="warroom"||V.value==="orchestra"||Et.value!==null)&&tt(),(V.value==="orchestra"||xi.value!==null)&&Lt(),V.value==="warroom"&&xe()});function Qo(e){e==="command"&&(Ut(),en(),(V.value==="swarm"||V.value==="warroom"||V.value==="orchestra")&&tt(),V.value==="orchestra"&&Lt(),V.value==="warroom"&&xe()),e==="mission"&&(Ql(),ia()),e==="proof"&&Xl(D.value.params.session_id,D.value.params.operation_id),e==="execution"&&Tt(),e==="intervene"&&(xe(),Mt()),e==="memory"&&ot(),e==="planning"&&yi(),e==="lab"&&it()}function N_({metric:e}){return o`
  ...
  `}function D_({panel:e}){return o`
    <div class="semantic-body">
      ...
      ${e.metrics.length>0?o`<div class="semantic-metric-list">
            ${e.metrics.map(t=>o`<${N_} key=${t.id} metric=${t} />`)}
          </div>`:null}
    </div>
  `}function O({panelId:e,compact:t=!1,label:n="왜 필요한가"}){const s=Jp(e);return s?o`
    <details class="semantic-inline ${t?"compact":""}">
      <summary class="semantic-summary">${n}</summary>
      <${D_} panel=${s} />
    </details>
  `:ta.value?o`<span class="semantic-inline-state">의미 계층 불러오는 중…</span>`:null}function Se({surfaceId:e,compact:t=!1}){const n=Gp(e);return n?o`
  ...
  `:ta.value?o`<div class="semantic-surface-card ${t?"compact":""}">의미 계층 불러오는 중…</div>`:na.value?o`<div class="semantic-surface-card ${t?"compact":""}">${na.value}</div>`:null}function T({title:e,class:t,semanticId:n,testId:s,children:a}){return o`
  ...
  `}const $a="masc_dashboard_workflow_context",O_=900*1e3;function ye(e){return typeof e=="string"&&e.trim()!==""?e.trim():null}function Xe(e){const t=ye(e);return t||(typeof e=="number"&&Number.isFinite(e)?String(e):null)}function _c(){if(typeof window>"u")return null;try{return window.sessionStorage}catch{return null}}function Yo(e){return _(e)?e:null}function w_(e){if(!e)return null;try{return JSON.stringify(e)}catch{return null}}function q_(e){if(!e)return null;try{const t=JSON.parse(e);if(!_(t))return null;const n=ye(t.id),s=ye(t.source_surface),a=ye(t.source_label),i=ye(t.summary),l=ye(t.created_at);return!n||s!=="mission"&&s!=="execution"||!a||!i||!l?null:{id:n,source_surface:s,source_label:a,action_type:ye(t.action_type),target_type:ye(t.target_type),target_id:ye(t.target_id),focus_kind:ye(t.focus_kind),operation_id:ye(t.operation_id),command_surface:ye(t.command_surface),summary:i,payload_preview:ye(t.payload_preview),suggested_payload:Yo(t.suggested_payload),preview:t.preview??null,evidence:t.evidence??null,created_at:l}}catch{return null}}function Li(e){const t=Date.parse(e.created_at);return Number.isNaN(t)?!1:Date.now()-t<=O_}function F_(){const e=_c(),t=q_((e==null?void 0:e.getItem($a))??null);return t?Li(t)?t:(e==null||e.removeItem($a),null):null}const vc=g(F_());function fc(e){const t=e&&Li(e)?e:null;vc.value=t;const n=_c();if(!n)return;if(!t){n.removeItem($a);return}const s=w_(t);s&&n.setItem($a,s)}function K_(e){if(!e)return null;const t=Yo(e.suggested_payload);if(t)return t;if(_(e.preview)){const n=Yo(e.preview.payload);if(n)return n}return null}function U_(e){if(!e)return null;const t=Xe(e.message);if(t)return t;const n=Xe(e.task_title)??Xe(e.title),s=Xe(e.task_description)??Xe(e.description),a=Xe(e.reason),i=Xe(e.priority)??Xe(e.task_priority);return n&&s?`${n} · ${s}`:n&&i?`${n} · P${i}`:n||s||a||null}function Ri(e,t,n,s,a,i,l,c){return[e,t,n??"action",s??"target",a??"room",i??"focus",l??"operation",c].join(":")}function vn(e,t,n="상황판 추천 액션"){const s=new Date().toISOString(),a=K_(e),i=(e==null?void 0:e.target_type)??(t==null?void 0:t.target_type)??null,l=(e==null?void 0:e.target_id)??(t==null?void 0:t.target_id)??null,c=(t==null?void 0:t.kind)??(e==null?void 0:e.action_type)??null,p=(e==null?void 0:e.reason)??(t==null?void 0:t.summary)??n;return{id:Ri("mission",n,(e==null?void 0:e.action_type)??null,i,l,c,null,s),source_surface:"mission",source_label:n,action_type:(e==null?void 0:e.action_type)??null,target_type:i,target_id:l,focus_kind:c,operation_id:null,command_surface:null,summary:p,payload_preview:U_(a),suggested_payload:a,preview:(e==null?void 0:e.preview)??null,evidence:(t==null?void 0:t.evidence)??null,created_at:s}}function H_({targetType:e,targetId:t,focusKind:n,sourceLabel:s="Execution 진단",summary:a,operationId:i=null,commandSurface:l=null}){const c=new Date().toISOString();return{id:Ri("execution",s,null,e,t,n,i,c),source_surface:"execution",source_label:s,action_type:null,target_type:e,target_id:t,focus_kind:n,operation_id:i,command_surface:l,summary:a,payload_preview:null,suggested_payload:null,preview:null,evidence:null,created_at:c}}function B_(e,t){return(t.source==="mission"||t.source==="execution")&&(t.action_type??null)===(e.action_type??null)&&(t.target_type??null)===(e.target_type??null)&&(t.target_id??null)===(e.target_id??null)&&(t.focus_kind??null)===(e.focus_kind??null)&&(t.operation_id??null)===(e.operation_id??null)}function cs(e){const{params:t}=e;if(t.source!=="mission"&&t.source!=="execution")return null;const n=vc.value;if(n&&Li(n)&&B_(n,t))return n;const s=new Date().toISOString(),a=t.source==="execution"?"execution":"mission";return{id:Ri(a,a==="execution"?"Execution 이어보기":"상황판 이어보기",t.action_type??null,t.target_type??null,t.target_id??null,t.focus_kind??null,t.operation_id??null,s),source_surface:a,source_label:a==="execution"?"Execution 이어보기":"상황판 이어보기",action_type:t.action_type??null,target_type:t.target_type??null,target_id:t.target_id??null,focus_kind:t.focus_kind??t.action_type??null,operation_id:t.operation_id??null,command_surface:t.surface??null,summary:a==="execution"?t.focus_kind?`${t.focus_kind} 기준으로 열린 execution 컨텍스트입니다.`:"Execution에서 이어진 컨텍스트입니다.":t.focus_kind?`${t.focus_kind} 기준으로 열린 컨텍스트입니다.`:"상황판에서 이어진 컨텍스트입니다.",payload_preview:null,suggested_payload:null,preview:null,evidence:null,created_at:s}}function gc(e){return{source:e.source_surface,...e.action_type?{action_type:e.action_type}:{},...e.target_type?{target_type:e.target_type}:{},...e.target_id?{target_id:e.target_id}:{},...e.focus_kind?{focus_kind:e.focus_kind}:{},...e.operation_id?{operation_id:e.operation_id}:{}}}function $c(e){if(e.command_surface)return e.command_surface;const t=[e.focus_kind,e.summary,e.action_type].filter(n=>typeof n=="string"&&n.trim()!=="").join(" ").toLowerCase();return t.includes("artifact_scope")||t.includes("routing_confidence")||t.includes("cache_contention")?"summary":t.includes("stale_data")||t.includes("leader_offline")||t.includes("roster_offline")||t.includes("managed")||t.includes("swarm")?"swarm":e.focus_kind==="operation"||e.target_type==="operation"?"operations":e.target_type==="room"?"orchestra":"swarm"}function hc(e){return{source:e.source_surface,surface:$c(e),...e.action_type?{action_type:e.action_type}:{},...e.target_type?{target_type:e.target_type}:{},...e.target_id?{target_id:e.target_id}:{},...e.focus_kind?{focus_kind:e.focus_kind}:{},...e.operation_id?{operation_id:e.operation_id}:{}}}function W_(e){return gc(e)}function G_(e){return hc(e)}function zi(e){return e!=null&&e.target_type?e.target_id?`${e.target_type} · ${e.target_id}`:e.target_type:"대상 정보 없음"}function Ha(e){switch(e){case"broadcast":return"room 방송";case"room_pause":return"room 일시정지";case"room_resume":return"room 재개";case"task_inject":return"room 작업 주입";case"team_turn":return"session 업데이트";case"team_note":return"session 노트";case"team_broadcast":return"session 방송";case"team_task_inject":return"session 작업";case"team_stop":return"session 중지";case"keeper_msg":case"keeper_message":return"keeper 메시지";case"keeper_probe":return"keeper probe";case"keeper_recover":return"keeper recover";case"swarm_run_continue":return"swarm run 계속";case"swarm_run_rerun":return"swarm run 재실행";case"swarm_run_abandon":return"swarm run 포기";default:return(e==null?void 0:e.trim())||"추천 액션"}}function J_(e){switch(e){case"warroom":return"워룸";case"summary":return"요약";case"orchestra":return"오케스트라";case"swarm":return"스웜";case"chains":return"체인";case"topology":return"토폴로지";case"alerts":return"알림";case"trace":return"트레이스";case"control":return"제어";case"operations":return"작전";default:return(e==null?void 0:e.trim())||"지휘"}}const We=g(null),nt=g(null);function Me(e,t=120){const n=(e??"").replace(/\s+/g," ").trim();return n?n.length>t?`${n.slice(0,t-1)}…`:n:null}function ge(e){return e==="bad"||e==="offline"||e==="critical"||e==="risk"?"bad":e==="warn"||e==="pending"||e==="degraded"||e==="interrupted"||e==="watch"?"warn":"ok"}function we(e){if(!e)return"방금";const t=Date.parse(e);if(Number.isNaN(t))return e;const n=Math.max(0,Math.round((Date.now()-t)/1e3));return n<60?`${n}초 전`:n<3600?`${Math.round(n/60)}분 전`:n<86400?`${Math.round(n/3600)}시간 전`:`${Math.round(n/86400)}일 전`}function V_(e){return typeof e!="number"||!Number.isFinite(e)||e<0?"확인 필요":e<60?`${Math.round(e)}초`:e<3600?`${Math.round(e/60)}분`:e<86400?`${Math.round(e/3600)}시간`:`${Math.round(e/86400)}일`}function qe(e){switch((e??"").trim().toLowerCase()){case"ok":case"healthy":case"green":return"안정";case"active":case"running":return"진행 중";case"pending":return"대기 중";case"paused":return"일시정지";case"blocked":return"막힘";case"interrupted":return"중단됨";case"warn":case"watch":return"주의";case"bad":case"critical":case"risk":return"위험";case"degraded":return"저하";case"offline":return"오프라인";case"idle":case"quiet":return"대기";case"loading":return"불러오는 중";case"error":return"오류";case"unavailable":return"사용 불가";case"stale":return"오래됨";case"refreshing":return"갱신 중";case"cached":return"캐시";case"unknown":case"":return"확인 필요";default:return(e==null?void 0:e.trim())||"확인 필요"}}function ha(e){switch((e??"").trim().toLowerCase()){case"room":return"방";case"team_session":case"session":return"세션";case"operation":return"작전";case"keeper":return"키퍼";case"agent":return"에이전트";default:return(e==null?void 0:e.trim())||"대상"}}function pr(e){switch((e??"").trim().toLowerCase()){case"metadata_gap":return"메타데이터 부족";case"mixed":return"신호 혼재";case"":return null;default:return(e==null?void 0:e.trim())||null}}function Q_(e){return e!=null&&e.confirm_required?"확인 후 실행":"즉시 실행"}function Y_(e){return zi(e?vn(e,null,"상황판 추천 액션"):null)}function Ba(e,t=vn()){fc(t),re(e,e==="intervene"?W_(t):G_(t))}function yc(e){Ba("intervene",vn(null,e,"상황판 incident"))}function bc(e){Ba("command",vn(null,e,"상황판 incident"))}function Pi(e,t,n="상황판 추천 액션"){Ba("intervene",vn(e,t,n))}function kc(e,t,n="상황판 추천 액션"){Ba("command",vn(e,t,n))}function Xo(e,t){const n={source:"mission",target_type:"team_session",target_id:t,focus_kind:"team_session"};e==="command"&&(n.surface="swarm"),re(e,n)}function X_(e){return{kind:e.kind,severity:e.severity,summary:e.summary,target_type:e.target_type,target_id:e.target_id??null,actor:null,evidence:e.evidence_preview}}function Z_(e){var n,s;const t=vt.value.find(a=>a.name===e.name||a.agent_name===e.agent_name)??null;return{brief:e,keeper:t,currentWork:Me(e.current_work,110)??Me(t==null?void 0:t.skill_primary,110)??Me(t==null?void 0:t.last_proactive_reason,110)??"명시된 키퍼 초점 없음",recentInput:Me(t==null?void 0:t.recent_input_preview,120)??null,recentOutput:Me(t==null?void 0:t.recent_output_preview,120)??Me((n=t==null?void 0:t.diagnostic)==null?void 0:n.last_reply_preview,120)??Me(t==null?void 0:t.last_proactive_preview,120)??null,recentEvent:Me(t==null?void 0:t.last_proactive_reason,120)??Me((s=t==null?void 0:t.diagnostic)==null?void 0:s.summary,120)??null,recentTools:(t==null?void 0:t.recent_tool_names)??[]}}function ev(){const e=is.value;if(!e)return new Map;const t=e.sessions.length>0?e.sessions:e.session_briefs;return new Map(t.map(n=>[n.session_id,n]))}function tv(e){We.value=We.value===e?null:e,nt.value=null}function xc(e){nt.value=nt.value===e?null:e,We.value=null}function nv(){We.value=null,nt.value=null}function Xa(e){return(e==null?void 0:e.trim().toLowerCase())??""}function ds(e){var t,n;return e?((t=e.agent)==null?void 0:t.exists)===!1||Xa((n=e.diagnostic)==null?void 0:n.health_state)==="offline"||Xa(e.status)==="offline"||Xa(e.status)==="inactive"?"offline":"online":"unlinked"}function Ge(e){switch(e){case"offline":return"offline";case"none_recent":return"none_recent";case"not_applicable":return"not_applicable";case"unlinked":return"unlinked";default:return"not_collected"}}function Sc(e){const t=ds(e);return t==="unlinked"?"unlinked":t==="offline"?"offline":"not_collected"}function Cc(e,t){const n=ds(e);return n==="unlinked"?"unlinked":n==="offline"?"offline":t!=null&&t.trim()?"none_recent":"not_collected"}function Ac(e,t){const n=ds(e);return n==="unlinked"?"unlinked":n==="offline"?"offline":t!=null&&t.trim()?"none_recent":"not_collected"}function Mi(e){const t=ds(e);return t==="unlinked"?"unlinked":t==="offline"?"offline":"none_recent"}function Tc(e){const t=e==null?void 0:e.trim();re("tools",t?{q:t}:void 0)}function sv(e){switch(e.trim().toLowerCase()){case"active":case"running":return"가동 중";case"working":return"작업 중";case"watching":return"관찰 중";case"quiet":return"조용함";case"idle":return"유휴";case"ok":case"healthy":return"정상";case"warn":case"warning":case"degraded":return"주의";case"bad":case"critical":case"error":case"failed":return"위험";case"blocked":return"막힘";case"paused":return"일시정지";case"pending":return"대기";case"offline":case"inactive":return"오프라인";case"connected":return"연결됨";case"disconnected":return"끊김";case"ready":return"준비됨";case"done":case"completed":return"완료";case"unknown":return"알 수 없음";default:return e}}function gt({status:e,label:t}){return o`
    <span class="status-badge ${e}">
      <span class="status-dot-inline ${e}"></span>
      ${t??sv(e)}
    </span>
  `}function Ic(e){const t=Date.now(),n=typeof e=="number"?e<1e12?e*1e3:e:new Date(e).getTime(),s=Math.floor((t-n)/1e3);if(s<60)return`${s}초 전`;const a=Math.floor(s/60);if(a<60)return`${a}분 전`;const i=Math.floor(a/60);return i<24?`${i}시간 전`:`${Math.floor(i/24)}일 전`}function G({timestamp:e}){const t=Ic(e),n=typeof e=="string"?e:new Date(e<1e12?e*1e3:e).toISOString();return o`<span class="time-ago" title=${n}>${t}</span>`}let av=0;const Rt=g([]);function M(e,t="success",n=4e3){const s=++av;Rt.value=[...Rt.value,{id:s,message:e,type:t}],setTimeout(()=>{Rt.value=Rt.value.filter(a=>a.id!==s)},n)}function ov(e){Rt.value=Rt.value.filter(t=>t.id!==e)}function iv(){const e=Rt.value;return e.length===0?null:o`
    <div class="toast-container">
      ${e.map(t=>o`
        <div key=${t.id} class="toast ${t.type}" onClick=${()=>ov(t.id)}>
          ${t.message}
        </div>
      `)}
    </div>
  `}const rv="masc_dashboard_agent_name",fn=g(null),ya=g(!1),Bn=g(""),ba=g([]),Wn=g([]),tn=g(""),Rn=g(!1);function us(e){fn.value=e,ji()}function mr(){fn.value=null,Bn.value="",ba.value=[],Wn.value=[],tn.value=""}function lv(){const e=fn.value;return e?Ye.value.find(t=>t.name===e)??null:null}function Lc(e){return e?st.value.filter(t=>t.assignee===e):[]}function Rc(e){return e?vt.value.find(t=>t.agent_name===e||t.name===e)??null:null}function cv(e){if(!e)return null;const t=is.value;return t?t.agent_briefs.find(n=>n.agent_name===e)??null:null}function dv(e){if(!e)return[];const t=e.metrics_window;return(Array.isArray(t==null?void 0:t.top_tools)?t.top_tools:[]).map(s=>typeof s=="object"&&s!==null&&"tool"in s&&typeof s.tool=="string"?s.tool:null).filter(s=>s!==null)}function uv(e){const t=Rc(e);return t?t.recent_tool_names&&t.recent_tool_names.length>0?t.recent_tool_names:[]:[]}function _r(...e){for(const t of e)if(t&&t.length>0)return t;return[]}function pv(e){return e?fi.value.find(t=>t.agent_name===e||t.name===e)??null:null}function mv(e){return e?vi.value.find(t=>t.agent_name===e||t.worker_name===e)??null:null}async function ji(){const e=fn.value;if(e){ya.value=!0,Bn.value="",ba.value=[],Wn.value=[];try{const t=await Bu(80);ba.value=t.filter(a=>a.includes(e)).slice(0,20);const n=Lc(e).slice(0,6);if(n.length===0)return;const s=await Promise.all(n.map(async a=>{try{const i=await Wu(a.id,25);return{taskId:a.id,text:i.trim()}}catch(i){const l=i instanceof Error?i.message:"history load failed";return{taskId:a.id,text:`Failed to load history: ${l}`}}}));Wn.value=s}catch(t){Bn.value=t instanceof Error?t.message:"Failed to load agent detail"}finally{ya.value=!1}}}async function vr(){var s;const e=fn.value,t=tn.value.trim();if(!e||!t)return;const n=((s=localStorage.getItem(rv))==null?void 0:s.trim())||"dashboard";Rn.value=!0;try{await Hu(n,`@${e} ${t}`),tn.value="",M(`Mention sent to ${e}`,"success"),ji()}catch(a){const i=a instanceof Error?a.message:"Failed to send mention";M(i,"error")}finally{Rn.value=!1}}function _v({task:e}){return o`
    <div class="agent-detail-task">
      <span class="pill">${e.id}</span>
      <span class="agent-detail-task-title">${e.title}</span>
      <${gt} status=${e.status} />
    </div>
  `}function vv({row:e}){return o`
  ...
  `}function fv(){var Q,ee,oe,W,te,A,Y;const e=fn.value;if(!e)return null;const t=lv(),n=Rc(e),s=pv(e),a=mv(e),i=cv(e),l=Lc(e),c=ba.value,p=uv(e),m=dv(n),u=_r(s==null?void 0:s.allowed_tool_names,i==null?void 0:i.allowed_tool_names,a==null?void 0:a.allowed_tool_names,n==null?void 0:n.allowed_tool_names),f=_r(s==null?void 0:s.latest_tool_names,i==null?void 0:i.latest_tool_names,a==null?void 0:a.used_tool_names,n==null?void 0:n.latest_tool_names),v=(s==null?void 0:s.latest_tool_call_count)??(i==null?void 0:i.latest_tool_call_count)??(a==null?void 0:a.used_tool_call_count)??(n==null?void 0:n.latest_tool_call_count),h=(s==null?void 0:s.tool_audit_source)??(i==null?void 0:i.tool_audit_source)??(a==null?void 0:a.tool_audit_source)??(n==null?void 0:n.tool_audit_source),b=(s==null?void 0:s.tool_audit_at)??(i==null?void 0:i.tool_audit_at)??(a==null?void 0:a.tool_audit_at)??(n==null?void 0:n.tool_audit_at),C=(t==null?void 0:t.capabilities)??[],x=((Q=ie.value)==null?void 0:Q.room)??"default",S=((ee=ie.value)==null?void 0:ee.project)??"확인 없음",$=((oe=ie.value)==null?void 0:oe.cluster)??"확인 없음",R=Ge(Sc(n)),L=Ge(Cc(n,h)),z=Ge(Ac(n,h)),q=Ge(Mi(n)),I=u[0]??f[0]??p[0]??null;return o`
    <div
      ...
      <div class="agent-detail-modal">
          ...
          <div style="display:flex;flex-direction:column;gap:8px;flex:1">
            ...
            ${(((W=t==null?void 0:t.traits)==null?void 0:W.length)??0)>0?o`
              <div style="display:flex;flex-wrap:wrap;gap:4px">
                ${(te=t==null?void 0:t.traits)==null?void 0:te.map(K=>o`<span style="font-size:0.7rem;background:#1e3a5f;color:#60a5fa;padding:2px 8px;border-radius:10px">${K}</span>`)}
              </div>
            `:""}
            ${(((A=t==null?void 0:t.interests)==null?void 0:A.length)??0)>0?o`
              <div style="display:flex;flex-wrap:wrap;gap:4px">
                ${(Y=t==null?void 0:t.interests)==null?void 0:Y.map(K=>o`<span style="font-size:0.7rem;background:#3b1f4e;color:#c084fc;padding:2px 8px;border-radius:10px">${K}</span>`)}
              </div>
            `:""}
            ${C.length>0?o`
              <div style="display:flex;flex-wrap:wrap;gap:4px">
        ...
        <div class="agent-detail-grid">
          <${T} title="Assigned Tasks">
            ${l.length===0?o`<div class="empty-state">No assigned tasks</div>`:o`<div class="agent-detail-task-list">${l.map(K=>o`<${_v} key=${K.id} task=${K} />`)}</div>`}
          <//>
        ...
        <${T} title="Capabilities & Tool Audit">
          <div style="display:flex; flex-direction:column; gap:12px;">
            ...
            <div style="display:flex; justify-content:flex-end;">
              <button class="control-btn ghost" onClick=${()=>{Tc(I)}}>
                Open tools panel
              </button>
            </div>
            <div>
            ...
            <div>
              ...
              <div style="display:flex; flex-wrap:wrap; gap:6px;">
                ${f.length>0?f.map(K=>o`<span class="pill">${K}</span>`):o`<span class="empty-state" style="font-size:12px;">${L}</span>`}
              </div>
            </div>
            <div class="agent-detail-sub">
              <span>Tool calls: ${typeof v=="number"?v:L==="none_recent"?0:z}</span>
            ...
            <div>
              ...
              <div style="display:flex; flex-wrap:wrap; gap:6px;">
                ${p.length>0?p.map(K=>o`<span class="pill">${K}</span>`):o`<span class="empty-state" style="font-size:12px;">${q}</span>`}
              </div>
            </div>
            ${m.length>0?o`
                  <div>
                    ...
                    <div style="display:flex; flex-wrap:wrap; gap:6px;">
                      ${m.map(K=>o`<span class="pill">${K}</span>`)}
                    </div>
                  </div>
                `:null}
            ${n?o`
        ...
        <${T} title="Task History">
          ${Wn.value.length===0?o`<div class="empty-state">No task history loaded</div>`:o`<div class="agent-history-list">${Wn.value.map(K=>o`<${vv} key=${K.taskId} row=${K} />`)}</div>`}
        <//>
  ...
  `}function gv(e){switch(e){case"quiet_hours":return"quiet hours";case"min_gap":return"cooldown gate";case"no_recent_activity":return"waiting for activity";case"disabled":return"runtime disabled";case"startup":return"warming up";case"llm_error":return"llm error";case"graphql_error":return"graphql error";case"never_started":return"never started";default:return"unknown"}}function $v(e){switch(e){case"manual_lodge_poke":return"Poke Lodge";case"probe":return"Probe";case"recover":return"Recover";default:return"Message"}}function hv(e){switch(e.delivery){case"sending":return"sending";case"timeout":return"timeout";case"error":return"error";case"delivered":return"delivered";default:return e.role}}function fr(e){return e.delivery==="error"||e.delivery==="timeout"?"bad":e.delivery==="sending"?"warn":e.role==="assistant"?"assistant":e.role==="user"?"user":"warn"}function zc(e){if(!e)return null;const t=new Date(e);return Number.isNaN(t.getTime())?null:t.toLocaleTimeString()}function yv(e){return typeof e!="number"||!Number.isFinite(e)||e<=0?null:e<60?`${Math.round(e)}s`:`${Math.ceil(e/60)}m`}function Pc(e){if(!e)return null;const t=Ve.value[e.name];return(t==null?void 0:t.diagnostic)??e.diagnostic??null}function bv({keeper:e,showRawStatus:t=!1}){if(ae(()=>{e!=null&&e.name&&$l(e.name)},[e==null?void 0:e.name]),!e)return o`<div class="control-status-copy">Select a keeper to inspect direct reply state.</div>`;const n=Ve.value[e.name],s=Pc(e),a=jo.value[e.name];return o`
    <div class="control-result-box">
      <div class="control-inline-meta">
        <span class="pill">${(s==null?void 0:s.health_state)??"unknown"}</span>
        <span class="pill">${gv(s==null?void 0:s.quiet_reason)}</span>
        <span class="pill">next ${$v((s==null?void 0:s.next_action_path)??"direct_message")}</span>
      ...
      <div class="control-status-copy">
        ...
        ${s!=null&&s.next_eligible_at_s?o` · next eligible ${yv(s.next_eligible_at_s)}`:null}
      </div>
  ...
  `}function kv({keeperName:e,placeholder:t}){const[n,s]=Yr("");ae(()=>{e&&$l(e)},[e]);const a=me.value[e]??[],i=Eo.value[e]??!1,l=Qe.value[e],c=async()=>{const p=n.trim();if(!(!e||!p)){s("");try{await pp(e,p)}catch(m){const u=m instanceof Error?m.message:`Failed to message ${e}`;M(u,"error")}}};return o`
        ...
        ${a.length===0?o`<div class="control-status-copy">No direct keeper conversation yet.</div>`:a.map(p=>o`
              <div class="keeper-conversation-item" key=${p.id}>
                <div class="keeper-conversation-meta">
                  ...
                  <span class=${`keeper-role-chip ${fr(p)}`}>${hv(p)}</span>
  ...
  `}function xv({actor:e,keeper:t,onPokeLodge:n}){if(!t)return null;const s=Pc(t),a=No.value[t.name]??!1,i=Do.value[t.name]??!1,l=(s==null?void 0:s.next_action_path)??"direct_message",c=(s==null?void 0:s.recoverable)??l==="recover";return o`
    <div class="control-actions">
      <button
      ...
      <button
        ...
        onClick=${()=>{_p(t.name,e).catch(p=>{const m=p instanceof Error?p.message:`Failed to recover ${t.name}`;M(m,"error")})}}
        disabled=${i||!c||!e.trim()}
      >
  ...
  `}const Ei=g(null);function Mc(e){Ei.value=e,up(e.name)}function gr(){Ei.value=null}const Ot=[{level:"L1_Reactive",label:"L1 Reactive",color:"#6b7280"},{level:"L2_Suggestive",label:"L2 Suggestive",color:"#3b82f6"},{level:"L3_Guided",label:"L3 Guided",color:"#f59e0b"},{level:"L4_Autonomous",label:"L4 Autonomous",color:"#f97316"},{level:"L5_Independent",label:"L5 Independent",color:"#ef4444"}];function Sv(e){if(!e)return 0;const t=Ot.findIndex(n=>n.level===e);return t>=0?t:0}function Cv({keeper:e}){const t=Sv(e.autonomy_level),n=Ot[t]??Ot[0];if(!n)return null;const s=(t+1)/Ot.length*100;return o`
    <div class="keeper-signal-list">
      <div style="margin-bottom:8px;">
        <div style="display:flex; justify-content:space-between; align-items:center; margin-bottom:4px;">
          <span style="font-size:13px; font-weight:600; color:${n.color};">${n.label}</span>
          <span style="font-size:11px; color:#888;">${t+1} / ${Ot.length}</span>
        </div>
  ...
  `}function Ws(e){return e?e>=1e6?`${(e/1e6).toFixed(1)}M`:e>=1e3?`${(e/1e3).toFixed(1)}K`:String(e):"—"}function Av(e){switch(e){case"keeper_message":return"message";case"keeper_probe":return"probe";case"keeper_recover":return"recover";case"broadcast":return"broadcast";case"room_pause":return"pause";case"room_resume":return"resume";case"lodge_tick":return"lodge";default:return(e==null?void 0:e.trim())||"action"}}function Tv(e){return e.recent_tool_names&&e.recent_tool_names.length>0?e.recent_tool_names:[]}function Iv(e){const t=e.metrics_window;return(Array.isArray(t==null?void 0:t.top_tools)?t.top_tools:[]).map(s=>typeof s=="object"&&s!==null&&"tool"in s&&typeof s.tool=="string"?s.tool:null).filter(s=>s!==null)}function Lv(e){const t=is.value;return t?t.keeper_briefs.find(n=>n.name===e.name||n.agent_name&&e.agent_name&&n.agent_name===e.agent_name)??null:null}function Rv({keeper:e}){const t=e.metrics_series??[],n=t[t.length-1],s=(n==null?void 0:n.cost_usd)!=null?`$${n.cost_usd.toFixed(4)}`:"—",a=[{label:"Generation",value:e.generation??"-",hint:"Succession count"},{label:"Turns",value:e.turn_count??"-",hint:"Total loop turns"},{label:"Context",value:e.context_ratio!=null?`${Math.round(e.context_ratio*100)}%`:"-",hint:e.context_ratio!=null&&e.context_ratio>.8?"Near limit":void 0},{label:"Activity",value:e.activityLevel??"-",hint:"Level 0–5"}];return o`
  ...
  `}function zv({keeper:e}){var u,f;const t=e.metrics_series??[];if(t.length<2){const v=(((u=e.context)==null?void 0:u.context_ratio)??0)*100,h=v>85?"#ef4444":v>70?"#f59e0b":"#22c55e";return o`
      <div class="context-chart">
        <div class="chart-bar-bg">
          <div class="chart-bar" style="width:${v.toFixed(1)}%;background:${h}"></div>
        </div>
        <span class="chart-pct">${v.toFixed(1)}%</span>
      </div>`}const n=200,s=60,a=2,i=t.length,l=t.map((v,h)=>{const b=a+h/(i-1)*(n-2*a),C=s-a-(v.context_ratio??0)*(s-2*a);return{x:b,y:C,p:v}}),c=l.map(({x:v,y:h})=>`${v.toFixed(1)},${h.toFixed(1)}`).join(" "),p=(((f=t[t.length-1])==null?void 0:f.context_ratio)??0)*100,m=p>85?"#ef4444":p>70?"#f59e0b":"#22c55e";return o`
  ...
  `}function Mv({stats:e}){const t=e.max_hp>0?Math.round(e.hp/e.max_hp*100):0,n=e.max_mp>0?Math.round(e.mp/e.max_mp*100):0;return o`
    <div>
  ...
  `}function jv({items:e}){return e.length===0?o`<div class="empty-state" style="font-size:13px">No equipment</div>`:o`
  ...
  `}function Ev({rels:e}){const t=Object.entries(e);return t.length===0?o`<div class="empty-state" style="font-size:13px">No relationships</div>`:o`
  ...
  `}function Dv({keeper:e}){var I,Q,ee,oe,W,te,A;const t=((I=$e.value)==null?void 0:I.room)??{},n=(((Q=$e.value)==null?void 0:Q.available_actions)??[]).filter(Y=>Y.target_type==="keeper"||Y.target_type==="room").slice(0,8),s=Tv(e),a=Iv(e),i=Lv(e),l=i!=null&&i.allowed_tool_names&&i.allowed_tool_names.length>0?i.allowed_tool_names:e.allowed_tool_names??[],c=i!=null&&i.latest_tool_names&&i.latest_tool_names.length>0?i.latest_tool_names:e.latest_tool_names??[],p=(i==null?void 0:i.latest_tool_call_count)??e.latest_tool_call_count,m=(i==null?void 0:i.tool_audit_source)??e.tool_audit_source,u=(i==null?void 0:i.tool_audit_at)??e.tool_audit_at,f=((ee=e.agent)==null?void 0:ee.capabilities)??[],v=t.current_room??t.room_id??((oe=ie.value)==null?void 0:oe.room)??"default",h=t.project??((W=ie.value)==null?void 0:W.project)??"확인 없음",b=t.cluster??((te=ie.value)==null?void 0:te.cluster)??"확인 없음",C=Ge(Sc(e)),x=Ge(Cc(e,m)),S=Ge(Ac(e,m)),$=Ge(Mi(e)),R=ds(e),L=((A=e.agent)==null?void 0:A.current_task)??(R==="offline"?"offline":"not_collected"),z=e.skill_primary??(R==="offline"?"offline":"not_collected"),q=l[0]??c[0]??s[0]??null;return o`
    <div class="keeper-signal-list">
      <div class="keeper-signal-row">
        <span>Room</span>
        <strong>${v}</strong>
      ...
      <div style="display:flex; flex-direction:column; gap:8px; margin-top:8px;">
        ...
        <div style="display:flex; flex-wrap:wrap; gap:6px;">
          ${l.length>0?l.map(Y=>o`<span class="pill">${Y}</span>`):o`<span style="font-size:12px; color:#888;">${C}</span>`}
        </div>
      </div>
      <div style="display:flex; flex-direction:column; gap:8px; margin-top:8px;">
        ...
        <div style="display:flex; flex-wrap:wrap; gap:6px;">
          ${c.length>0?c.map(Y=>o`<span class="pill">${Y}</span>`):o`<span style="font-size:12px; color:#888;">${x}</span>`}
        </div>
      </div>
      <div class="keeper-signal-row">
        <span>Tool calls</span>
        <strong>${typeof p=="number"?p:x==="none_recent"?0:S}</strong>
      </div>
      <div class="keeper-signal-row">
      ...
      <div class="keeper-signal-row">
        ...
        <strong>${u?o`<${G} timestamp=${u} />`:S}</strong>
      </div>
      <div style="display:flex; flex-direction:column; gap:8px; margin-top:8px;">
        <span style="font-size:12px; color:#888;">Keeper recent tools</span>
        <div style="display:flex; flex-wrap:wrap; gap:6px;">
          ${s.length>0?s.map(Y=>o`<span class="pill">${Y}</span>`):o`<span style="font-size:12px; color:#888;">${$}</span>`}
        </div>
      </div>
      ${a.length>0?o`
            <div style="display:flex; flex-direction:column; gap:8px; margin-top:8px;">
              ...
              <div style="display:flex; flex-wrap:wrap; gap:6px;">
                ${a.map(Y=>o`<span class="pill">${Y}</span>`)}
              </div>
            </div>
          `:null}
      <div style="display:flex; flex-direction:column; gap:8px; margin-top:8px;">
  ...
  `}function qv(){var t,n,s;const e=Ei.value;return e?o`
    <div
  ...
  `:null}function Fv({cluster:e,project:t,room:n,generatedAt:s}){return o`
  ...
  `}function Kv(){const e=Hl.value,t=ge((e==null?void 0:e.status)??(Ct.value?"bad":"warn")),n=!e||e.sections.length===0,s=(e==null?void 0:e.status)==="error"||(e==null?void 0:e.status)==="unavailable"&&!(e!=null&&e.cached);return o`
    <${T} title="판단 레이어" class="mission-briefing-card" semanticId="mission.llm_briefing">
      ...
      <div class="mission-briefing-meta">
        <span class="command-chip ${t}">
          ${qe((e==null?void 0:e.status)??(Ct.value?"error":"loading"))}
        </span>
                ...
                <article class="mission-briefing-section ${ge(a.status)}">
                  <div class="mission-card-head">
                    ...
                    <div class="mission-briefing-section-chips">
                      <span class="command-chip ${ge(a.status)}">${qe(a.status)}</span>
                ...
                ${e.metadata_gaps.map(a=>o`
                  <article class="mission-briefing-gap ${a.severity==="watch"?"warn":""}">
                    <div class="mission-card-head">
                      ...
                      <span class="command-chip ${a.severity==="watch"?"warn":""}">${qe(a.severity)}</span>
                    </div>
                    <p>${a.summary}</p>
                  </article>
                `)}
  ...
  `}function Uv({item:e,selected:t,sessionLookup:n}){const s=X_(e),a=e.related_session_ids.map(l=>n.get(l)).filter(l=>l!=null),i=e.top_action??null;return o`
    <article class="mission-attention-card ${ge((i==null?void 0:i.severity)??e.severity)} ${t?"is-selected":""}">
      <button class="mission-card-select" onClick=${()=>tv(e.id)}>
        <div class="mission-card-head">
          <div>
            <strong>${e.summary}</strong>
            <div class="mission-card-target">${ha(e.target_type)}${e.target_id?` · ${e.target_id}`:""}</div>
          </div>
          <span class="command-chip ${ge((i==null?void 0:i.severity)??e.severity)}">${i?Q_(i):e.severity}</span>
        </div>
              ...
              <div class="mission-link-list">
                ${a.slice(0,4).map(l=>o`
                  <button class="mission-link-row" onClick=${()=>xc(l.session_id)}>
                    ...
                    <span>${qe(l.status)} · ${l.last_event_summary??"최근 사건 없음"}</span>
                  </button>
                `)}
              </div>
  ...
  `}function Hv({brief:e,selected:t}){var i,l;const n=e.member_previews.slice(0,4),s=e.top_recommendation??null,a=e.top_attention??null;return o`
    <article class="mission-crew-card ${ge(((i=e.top_attention)==null?void 0:i.severity)??e.health??e.status)} ${t?"is-selected":""}">
      <button class="mission-card-select" onClick=${()=>xc(e.session_id)}>
        <div class="mission-card-head">
          ...
          <span class="command-chip ${ge(((l=e.top_attention)==null?void 0:l.severity)??e.health??e.status)}">${qe(e.status)}</span>
        </div>
        ...
        <div class="mission-fact-grid">
          ...
          <div class="mission-fact-tile">
            <span>가동 시간</span>
            <strong>${V_(e.elapsed_sec)}</strong>
            ...
            <div class="mission-pill-row">
              ${e.operation_badges.slice(0,3).map(c=>o`
                <span class="mission-pill">
                  ${c.operation_id} · ${qe(c.status)}${c.stage?` · ${c.stage}`:""}
                </span>
              `)}
            </div>
          `:null}
  ...
  `}function Bv({detail:e,loading:t,error:n}){if(t&&!e)return o`
          ...
          <div class="mission-link-list">
            ${e.operations.length>0?e.operations.map(a=>o`
                  <button class="mission-link-row" onClick=${()=>Xo("command",s.session_id)}>
                    ...
                    <span>${qe(a.status)}${a.stage?` · ${a.stage}`:""}</span>
          ...
          <div class="mission-link-list">
            ${e.keepers.length>0?e.keepers.map(a=>o`
                  <div class="mission-link-row static">
                    ...
                    <span>${qe(a.status)}${a.generation!=null?` · 세대 ${a.generation}`:""}</span>
    ...
    <article class="mission-activity-card ${ge(e.brief.status??((i=e.keeper)==null?void 0:i.status))}">
      <button class="mission-card-select" onClick=${()=>{e.keeper&&Mc(e.keeper)}}>
        <div class="mission-activity-head">
          ...
          <span class="command-chip ${ge(e.brief.status??((p=e.keeper)==null?void 0:p.status))}">${qe(e.brief.status??((m=e.keeper)==null?void 0:m.status))}</span>
        </div>

        <div class="mission-activity-meta">
          <span>최근 하트비트 · ${(u=e.keeper)!=null&&u.last_heartbeat?we(e.keeper.last_heartbeat):"기록 없음"}</span>
  ...
  `}function Gv({item:e}){const t=e.action??null,n=e.attention??null;return o`
  ...
  `}function hr(){var h,b,C,x;const e=is.value;if(Uo.value&&!e)return o`<div class="loading-indicator">상황판 스냅샷 불러오는 중...</div>`;if(oa.value&&!e)return o`<div class="empty-state error">${oa.value}</div>`;if(!e)return o`<div class="empty-state">상황판 스냅샷이 아직 없습니다.</div>`;We.value&&!e.attention_queue.some(S=>S.id===We.value)&&(We.value=null);const t=e.sessions;nt.value&&!t.some(S=>S.session_id===nt.value)&&(nt.value=null);const n=e.attention_queue.find(S=>S.id===We.value)??null,s=(n==null?void 0:n.related_session_ids.find(S=>t.some($=>$.session_id===S)))??null,a=nt.value??s??((h=t[0])==null?void 0:h.session_id)??null,i=ev(),l=t.find(S=>S.session_id===a)??null,c=e.keeper_briefs.slice(0,6).map(Z_),p=e.attention_queue.filter(S=>S.related_session_ids.length>0).slice(0,6),m=e.internal_signals.slice(0,3),u=t.filter(S=>{var R;const $=((R=S.top_attention)==null?void 0:R.severity)??S.health??S.status;return ge($)!=="ok"||!!S.blocker_summary}).length,f=new Set(t.flatMap(S=>S.member_names)).size,v=t.flatMap(S=>S.member_previews??[]).filter(S=>S.recent_output_preview).length+c.filter(S=>S.recentOutput).length;return ae(()=>{zm(a)},[a]),o`
    <section class="dashboard-panel mission-view">
      ...
      <div class="panel-header">
        ...
        <div class="mission-header-meta">
          <span class="command-chip ${ge(e.summary.room_health)}">${qe(e.summary.room_health)}</span>
      ...
      <div class="mission-stat-grid">
        ...
        <${Dt} label="내부 신호" value=${m.length} detail="시스템 진단은 보조 면에만 유지" tone=${((x=m[0])==null?void 0:x.severity)??"ok"} />
      </div>

      ${a?o`
            <div class="mission-selection-bar">
              <span>현재 관찰 세션 · ${(l==null?void 0:l.goal)??a}${n?` · ${n.summary}`:""}</span>
              <button class="control-btn ghost" onClick=${nv}>선택 해제</button>
            </div>
          `:null}
      ...
      <${T} title="진행중인 세션" class="mission-list-card" semanticId="mission.session_briefs">
        ...
        <div class="mission-list-stack">
          ${t.length>0?t.map(S=>o`<${Hv} key=${S.session_id} brief=${S} selected=${a===S.session_id} />`):o`<div class="empty-state">지금 활성 세션이 없습니다.</div>`}
        </div>
      <//>
      ...
      <div class="mission-human-grid">
        <${T} title="주의 대기열" class="mission-list-card" semanticId="mission.attention_queue">
          ...
          <div class="mission-lane-stack">
            ${p.length>0?p.map(S=>o`<${Uv} key=${S.id} item=${S} selected=${We.value===S.id} sessionLookup=${i} />`):o`<div class="empty-state">지금 세션 단위 주의 대기열은 비어 있습니다.</div>`}
          </div>
        <//>
        ...
        <${T} title="내부 신호" class="mission-list-card" semanticId="mission.internal_signals">
          ...
          <details class="mission-card-disclosure">
            ...
            <div class="mission-list-stack">
              ${m.length>0?m.map(S=>o`<${Gv} key=${S.id} item=${S} />`):o`<div class="empty-state">지금은 내부 진단 경고가 없습니다.</div>`}
            </div>
          </details>
        <//>
      </div>
  ...
  `}const Jv="modulepreload",Vv=function(e){return"/dashboard/"+e},yr={},Qv=function(t,n,s){let a=Promise.resolve();if(n&&n.length>0){let l=function(m){return Promise.all(m.map(u=>Promise.resolve(u).then(f=>({status:"fulfilled",value:f}),f=>({status:"rejected",reason:f}))))};document.getElementsByTagName("link");const c=document.querySelector("meta[property=csp-nonce]"),p=(c==null?void 0:c.nonce)||(c==null?void 0:c.getAttribute("nonce"));a=l(n.map(m=>{if(m=Vv(m),m in yr)return;yr[m]=!0;const u=m.endsWith(".css"),f=u?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${m}"]${f}`))return;const v=document.createElement("link");if(v.rel=u?"stylesheet":Jv,u||(v.as="script"),v.crossOrigin="",v.href=m,p&&v.setAttribute("nonce",p),document.head.appendChild(v),u)return new Promise((h,b)=>{v.addEventListener("load",h),v.addEventListener("error",()=>b(new Error(`Unable to preload CSS for ${m}`)))})}))}function i(l){const c=new Event("vite:preloadError",{cancelable:!0});if(c.payload=l,window.dispatchEvent(c),!c.defaultPrevented)throw l}return a.then(l=>{for(const c of l||[])c.status==="rejected"&&i(c.reason);return t().catch(i)})};function ka(e){if(e==null)return"";if(typeof e=="string")return e;try{return JSON.stringify(e,null,2)}catch{return String(e)}}function Z(e){if(!e)return"정보 없음";const t=Date.parse(e);if(Number.isNaN(t))return e;const n=Math.max(0,Math.round((Date.now()-t)/1e3));return n<60?`${n}초 전`:n<3600?`${Math.round(n/60)}분 전`:n<86400?`${Math.round(n/3600)}시간 전`:`${Math.round(n/86400)}일 전`}function Yv(e){if(!e)return"warn";const t=Date.parse(e);return Number.isNaN(t)?"warn":t<=Date.now()?"bad":"ok"}function Ec(e){if(!e)return"정보 없음";const t=Date.parse(e);if(Number.isNaN(t))return e;const n=Math.round((t-Date.now())/1e3);return n<=0?"기한 지남":n<60?`${n}초 후`:n<3600?`${Math.round(n/60)}분 후`:n<86400?`${Math.round(n/3600)}시간 후`:`${Math.round(n/86400)}일 후`}function P(e){return e==="bad"?"bad":e==="warn"||e==="pending"?"warn":"ok"}let br=!1,Xv=0;function Zv(){return++Xv}let to=null;async function ef(){to||(to=Qv(()=>import("./mermaid.core-Bh0As8WG.js").then(t=>t.bE),[]).then(t=>t.default));const e=await to;return br||(e.initialize({startOnLoad:!1,theme:"dark",securityLevel:"loose"}),br=!0),e}function lt(e){if(!e)return"warn";const t=e.toLowerCase();return t.includes("failed")||t.includes("error")||t.includes("disconnected")||t.includes("stopped")?"bad":t.includes("running")||t.includes("active")||t.includes("degraded")||t.includes("pending")?"warn":"ok"}function ps(e){return typeof e!="number"||!Number.isFinite(e)?"정보 없음":`${Math.round(e*100)}%`}function Cn(e){return typeof e!="number"||!Number.isFinite(e)?"정보 없음":e<60?`${Math.round(e)}초`:e<3600?`${Math.round(e/60)}분`:`${Math.round(e/3600)}시간`}function ms(e){return typeof e!="number"||!Number.isFinite(e)?0:Math.max(0,Math.min(100,e))}function kt(e,t){return typeof e!="number"||!Number.isFinite(e)||typeof t!="number"||!Number.isFinite(t)||t<=0?0:ms(e/t*100)}function tf(e,t){const n=ms(e);return`--gauge-angle:${Math.max(10,Math.round(n/100*360))}deg;--gauge-color:${t};`}function Nc(e){if(!e)return"최근 체인 이력이 없습니다";const t=[e.event];return typeof e.duration_ms=="number"&&t.push(`${e.duration_ms}ms`),typeof e.tokens=="number"&&t.push(`토큰 ${e.tokens}`),e.message&&t.push(e.message),t.join(" · ")}const nf=[{id:"status",label:"현황"},{id:"history",label:"이력"},{id:"control",label:"통제"}],Dc=[{id:"warroom",label:"워룸",group:"status"},{id:"summary",label:"요약",group:"status"},{id:"topology",label:"토폴로지",group:"status"},{id:"orchestra",label:"오케스트라",group:"status"},{id:"swarm",label:"스웜",group:"status"},{id:"operations",label:"작전",group:"history"},{id:"trace",label:"트레이스",group:"history"},{id:"chains",label:"체인",group:"history"},{id:"control",label:"제어",group:"control"},{id:"alerts",label:"알림",group:"control"}],sf=Dc.map(e=>e.id),af=["chain_start","node_start","node_complete","chain_complete","chain_error"],of={warroom:{title:"실시간 워룸",description:"실제 실행, 워커, 메시지, 트레이스를 한 화면에서 따라가는 기본 진입 표면입니다."},operations:{title:"현재 작전 상세",description:"활성 작전, 분견대, 의존 관계를 먼저 읽는 기본 진입 표면입니다."},orchestra:{title:"룸 오케스트라 맵",description:"룸, 세션, 레인, 워커, 키퍼를 한 장의 작전판으로 읽는 시각화 표면입니다."},swarm:{title:"스웜 실행 흐름",description:"레인 이동, 워커 결속, 막힘을 따라가며 현장감 있게 보는 표면입니다."},chains:{title:"체인 런타임",description:"체인 연결 상태와 작전별 실행 그래프를 확인하는 표면입니다."},topology:{title:"지휘 계층",description:"실제 관리 유닛인지, 실시간 에이전트 기반 자동 투영인지 구분해서 봅니다."},alerts:{title:"경보 모음",description:"지금 개입을 밀어올리는 alert만 모아서 보는 표면입니다."},trace:{title:"최근 트레이스",description:"작전, 주체, 유닛 단위 이벤트를 시간순으로 보는 표면입니다."},control:{title:"승인과 제어",description:"결정 승인과 유닛 제어를 실제로 수행하는 표면입니다."},summary:{title:"지휘 요약",description:"전체 지휘면을 한 번에 훑는 계기판 성격의 요약 표면입니다."}};function kr(e){return!!e&&sf.includes(e)}function rf(){const e=D.value.params;return e.source!=="mission"&&e.source!=="execution"?{}:{source:e.source,...e.action_type?{action_type:e.action_type}:{},...e.target_type?{target_type:e.target_type}:{},...e.target_id?{target_id:e.target_id}:{},...e.focus_kind?{focus_kind:e.focus_kind}:{},...e.operation_id?{operation_id:e.operation_id}:{}}}function Ni(e){const t=rf(),n=qc(),s=Di();if(e==="operations")return t;if(e==="chains"){const a=Zt.value;return a?{...t,surface:e,operation:a}:{...t,surface:e}}return e==="swarm"||e==="warroom"||e==="orchestra"?{...t,surface:e,...n?{run_id:n}:{},...s?{operation_id:s}:{}}:{...t,surface:e}}function lf(){const e=new URLSearchParams(window.location.search),t=new URLSearchParams,n=e.get("agent")??e.get("agent_name"),s=e.get("token");return n&&t.set("agent",n),s&&t.set("token",s),t.toString()?`/api/v1/chains/events?${t.toString()}`:"/api/v1/chains/events"}function cf(e){switch(e){case"company":return"중대";case"platoon":return"소대";case"squad":return"분대";case"agent":return"에이전트";default:return e}}function ce(e){return Wo.value===e}function _s(){return ki.value}function df(e){var a,i,l,c,p,m,u;const t=ki.value,n=Et.value,s=ls.value;switch(e){case"warroom":return{tool:"masc_observe_operations",reason:"실시간 실행, 워커, 메시지, 트레이스를 한 화면에서 보고 필요한 세부 표면으로 바로 이동합니다."};case"operations":return{tool:"masc_operation_status",reason:`활성 작전 ${((a=t==null?void 0:t.operations.summary)==null?void 0:a.active)??0}개와 의존 관계를 먼저 확인합니다.`};case"swarm":return{tool:(n==null?void 0:n.recommended_next_tool)??((l=(i=t==null?void 0:t.swarm_status)==null?void 0:i.recommended_next_action)==null?void 0:l.tool)??"masc_observe_traces",reason:((p=(c=t==null?void 0:t.swarm_status)==null?void 0:c.recommended_next_action)==null?void 0:p.reason)??"레인 이동과 막힘 근거를 보고 다음 확인 도구를 고릅니다."};case"orchestra":return{tool:"masc_operator_snapshot",reason:"룸, 세션, 레인, 워커, 키퍼를 한 장에서 훑은 뒤 내려볼 대상을 고릅니다."};case"chains":return{tool:(u=(m=s==null?void 0:s.operations[0])==null?void 0:m.preview_run)!=null&&u.chain_id?"masc_chain_run_get":"masc_chain_snapshot",reason:"체인 연결 상태와 최근 run 그래프를 함께 보면 병목을 빨리 좁힐 수 있습니다."};case"topology":return{tool:"masc_observe_topology",reason:"이 구조가 실제 관리 단위인지 자동 투영인지 먼저 구분해야 지휘면을 오해하지 않습니다."};case"alerts":return{tool:"masc_observe_alerts",reason:"경보에서 먼저 문제가 된 유닛과 작전을 고릅니다."};case"trace":return{tool:"masc_observe_traces",reason:"트레이스 흐름으로 원인 이벤트를 바로 따라갈 수 있습니다."};case"control":return{tool:"masc_operator_action",reason:"승인이나 kill switch 같은 실제 조작은 제어 표면과 operator action이 이어집니다."};case"summary":default:return{tool:"masc_observe_operations",reason:"요약을 본 뒤에는 현재 작전 표면으로 내려가 실제 움직임을 확인하는 게 가장 빠릅니다."}}}function uf(e){var n;const t=((n=e==null?void 0:e.focus_kind)==null?void 0:n.toLowerCase())??"";return t?t.includes("artifact_scope")||t.includes("routing_confidence")||t.includes("cache_contention")?"microarch":t.includes("leader_offline")||t.includes("roster_offline")?"alerts":t.includes("stale_data")?"swarm":null:null}function pf(e){var n;const t=((n=e==null?void 0:e.focus_kind)==null?void 0:n.toLowerCase())??"";return t?t.includes("stale_data")||t.includes("leader_offline")||t.includes("roster_offline")||t.includes("managed")?"recommendation":t.includes("gap")?"gaps":null:null}function Oc(){if(typeof window>"u")return null;const e=new URLSearchParams(window.location.search),t=e.get("agent")??e.get("agent_name");if(!t)return null;const n=t.trim();return n===""?null:n}function wc(){if(typeof window>"u")return new URLSearchParams;const e=new URLSearchParams(window.location.search),t=window.location.hash.replace(/^#/,""),n=t.indexOf("?");return n>=0&&new URLSearchParams(t.slice(n+1)).forEach((a,i)=>{e.has(i)||e.set(i,a)}),e}function qc(){const t=wc().get("run_id");if(!t)return null;const n=t.trim();return n===""?null:n}function Di(){const t=wc().get("operation_id");if(!t)return null;const n=t.trim();return n===""?null:n}function mf(e){if(!e)return null;const t=Date.parse(e);return Number.isNaN(t)?null:Math.max(0,Math.round((Date.now()-t)/1e3))}function _f(e){return e.status==="claimed"||e.status==="in_progress"}function vf(e){const t=rs.value;if(!t)return null;for(const n of t.golden_paths){const s=n.steps.find(a=>a.tool===e);if(s)return s}return null}function no(e){var t;return((t=rs.value)==null?void 0:t.golden_paths.find(n=>n.id===e))??null}function ff(e){const t=rs.value;if(!t)return[];const n=new Set(e);return t.pitfalls.filter(s=>n.has(s.id))}async function ct(e){try{await e()}catch{}}function Oi(e){return(e==null?void 0:e.trim().toLowerCase())??""}function Ht(e){const t=Oi(e);return t.includes("failed")||t.includes("error")||t.includes("stopped")||t==="paused"?"bad":t.includes("active")||t.includes("running")||t.includes("healthy")||t.includes("ok")?"ok":"warn"}function xt(e){const t=Oi(e);return t?t==="active"||t==="running"?"진행 중":t==="paused"?"일시정지":t==="done"||t==="ended"||t==="completed"?"완료":t==="failed"||t==="error"||t==="stopped"?"문제":(e==null?void 0:e.trim())||"확인 필요":"확인 필요"}function gf(){var n,s,a,i,l,c,p,m,u;const e=Et.value;if(!e)return!1;const t=e.workers.some(f=>f.joined||f.live_presence||f.completed||f.current_task_matches_run||f.heartbeat_fresh||f.claim_marker_seen||f.done_marker_seen||f.final_marker_seen||!!f.current_task||!!f.bound_task_id||!!f.last_message);return!!((n=e.operation)!=null&&n.operation_id||(s=e.detachment)!=null&&s.detachment_id||(((a=e.summary)==null?void 0:a.joined_workers)??0)>0||(((i=e.summary)==null?void 0:i.live_workers)??0)>0||(((l=e.summary)==null?void 0:l.current_task_bound)??0)>0||(((c=e.summary)==null?void 0:c.fresh_heartbeats)??0)>0||(((p=e.summary)==null?void 0:p.claim_markers_seen)??0)>0||(((m=e.summary)==null?void 0:m.done_markers_seen)??0)>0||(((u=e.summary)==null?void 0:u.final_markers_seen)??0)>0||t||e.recent_messages.length>0||e.recent_trace_events.length>0)}function $f(e){const t=Oi(e.status);return t==="active"||t==="running"}function hf(){var i,l,c,p;const e=((i=$e.value)==null?void 0:i.sessions)??[],t=Et.value,n=((l=t==null?void 0:t.detachment)==null?void 0:l.session_id)??null;if(n){const m=e.find(u=>u.session_id===n);if(m)return m}const s=((c=t==null?void 0:t.operation)==null?void 0:c.operation_id)??Di();if(s){const m=e.find(u=>u.command_plane_operation_id===s);if(m)return m}const a=((p=t==null?void 0:t.detachment)==null?void 0:p.detachment_id)??null;if(a){const m=e.find(u=>u.command_plane_detachment_id===a);if(m)return m}return e.find($f)??e[0]??null}function so(e){return e==="proven"?"ok":e==="partial"?"warn":"bad"}function zn(e){return Array.isArray(e)?e:[]}function je(e){return typeof e=="object"&&e!==null&&!Array.isArray(e)?e:{}}function Cs(e){return typeof e=="string"&&e.trim()!==""?e:null}function yf(e){return typeof e=="number"&&Number.isFinite(e)?e:null}function bf(e){const t=e.split("/");return t.length<=3?e:`…/${t.slice(-3).join("/")}`}function kf(e){return e==="proven"?"충분":e==="partial"?"부분":"부족"}function xf(e){return e==="proven"?"협업 증거가 충분합니다":e==="partial"?"흔적은 있으나 협업 증거가 덜 모였습니다":"증거가 부족합니다"}function Sf(e,t,n,s,a){const i=[`${t}명의 actor 흔적이 기록돼 있습니다.`,n>0?`서로를 참조한 상호작용 증거가 ${n}건 있습니다.`:"서로를 참조한 명시적 상호작용 증거가 아직 없습니다.",s>0?`도구·산출물·체크포인트 증거가 ${s}건 있습니다.`:"도구·산출물·체크포인트 증거가 거의 없습니다.",a>0?`CPv2 backing trace가 ${a}건 있어 실행 흔적은 남아 있습니다.`:"관리형 backing trace는 아직 없습니다."];return e==="partial"?[i[0]??"",n===0?"partial인 이유: 참여 흔적은 있지만 actor 간 상호작용이 직접 보이지 않습니다.":"partial인 이유: 일부 증거는 있으나 proven 기준을 모두 채우지 못했습니다.",a>0?"다음 보강 포인트: 대화/상호참조 event를 남기면 proof가 더 강해집니다.":"다음 보강 포인트: 관리형 trace 또는 산출물 연결을 더 남기면 근거가 강해집니다."]:e==="proven"?[i[0]??"","결론: 참여, 상호작용, 산출물, backing evidence가 모두 연결돼 있습니다.","다음 행동: raw evidence는 접어두고 세션 결과와 산출물만 확인하면 됩니다."]:[i[0]??"","결론: 기록은 있으나 협업을 증명할 만큼의 연결 증거가 부족합니다.","다음 보강 포인트: 참여자 간 턴, 도구 근거, 산출물 연결을 더 남겨야 합니다."]}function Cf(e){const t=new Map;for(const n of e){const s=[n.timestamp??"",n.event_type??"",n.actor??"",n.summary??""].join("|"),a=n.source??"unknown",i=t.get(s);if(i){i.sources.includes(a)||i.sources.push(a),!i.operation_id&&n.operation_id&&(i.operation_id=n.operation_id);continue}t.set(s,{...n,sources:[a]})}return[...t.values()]}function Af(e){return e.sources.length===2?"세션 + 지휘":e.sources.length===1?e.sources[0]==="unknown"?"출처 미상":e.sources[0]??"출처":e.sources.join(" + ")}function Tf(e){const t=[];for(const[n,s]of Object.entries(e))if(s!=null){if(typeof s=="string"){if(s.trim()==="")continue;t.push({label:n,value:s});continue}if(typeof s=="number"||typeof s=="boolean"){t.push({label:n,value:String(s)});continue}}return t}function If(e){const t=je(e),n=je(t.traces),s=Array.isArray(n.events)?n.events:[],a=je(t.detachments),i=Array.isArray(a.detachments)?a.detachments:[],l=je(i[0]),c=je(l.detachment),p=je(l.operation),m=je(t.summary),u=je(m.operations),f=je(u.summary);return[{label:"작전",value:Cs(t.operation_id)??"없음"},{label:"분견대",value:Cs(t.detachment_id)??"없음"},{label:"트레이스 이벤트",value:`${s.length}`},{label:"분견대 상태",value:Cs(c.status)??"없음"},{label:"작전 단계",value:Cs(p.stage)??"없음"},{label:"활성 작전",value:`${yf(f.active)??0}`}]}function Lf({item:e}){return o`
    <article class="command-card proof-timeline-row">
      <div class="command-card-head">
        ...
        <span class="command-chip">${Z(e.timestamp)}</span>
      </div>
      ${e.sources.length>1?o`<div class="semantic-tag-row">
            ${e.sources.map(t=>o`<span class="semantic-tag">${t}</span>`)}
          </div>`:null}
    </article>
  `}function Rf({item:e}){const t=e.recent_output_preview??null,n=e.recent_input_preview??null,s=e.recent_event_summary??null,a=(e.interaction_count??0)>0?"ok":"warn";return o`
      ...
      <div class="mission-activity-head">
        <div>
          ...
          <div class="mission-activity-meta">
            ...
            <span>${e.last_active_at?Z(e.last_active_at):"기록 없음"}</span>
          </div>
        </div>
  ...
  `}function Pf(){var R,L,z;const e=D.value.params,t=e.session_id??null,n=e.operation_id??null;ae(()=>{Xl(t,n)},[t,n]);const s=Yl.value;if(Bo.value&&!s)return o`<section class="dashboard-panel"><div class="loading-indicator">근거 화면 불러오는 중…</div></section>`;if(Kt.value&&!s)return o`<section class="dashboard-panel"><div class="error-card">${Kt.value}</div></section>`;const a=s==null?void 0:s.summary,i=zn(s==null?void 0:s.actor_contributions),l=zn(s==null?void 0:s.artifacts),c=(s==null?void 0:s.proof_verdict)??"insufficient",p=(s==null?void 0:s.cp_backing_evidence)??null,m=Array.isArray((R=p==null?void 0:p.traces)==null?void 0:R.events)?((z=(L=p.traces)==null?void 0:L.events)==null?void 0:z.length)??0:0,u=(a==null?void 0:a.actors_count)??i.length,f=(a==null?void 0:a.interaction_count)??0,v=(a==null?void 0:a.evidence_count)??0,h=Cf(zn(s==null?void 0:s.timeline)),b=Tf(je(s==null?void 0:s.goal_binding)),C=If(p),x=l.filter(q=>q.exists).length,S=l.length-x,$=Sf(c,u,f,v,m);return o`
    <section class="dashboard-panel mission-view">
      <${Se} surfaceId="proof" />
      <div class="panel-header">
        <div>
        ...
        <div class="mission-header-meta">
          ...
          ${s!=null&&s.generated_at?o`<span class="command-chip">${Z(s.generated_at)}</span>`:null}
        </div>
      </div>
      ...
      <div class="mission-human-grid">
        <${T} title="3줄 근거 요약" class="mission-list-card" semanticId="proof.summary">
          ...
          <div class="proof-summary-stack">
            ${$.map((q,I)=>o`
              <article class="proof-summary-block ${I===1&&c!=="proven"?so(c):""}">
      ...
      <div class="mission-human-grid">
        <${T} title="협업 타임라인" class="mission-list-card" semanticId="proof.timeline">
          ...
          <div class="mission-list-stack">
            ${h.length>0?h.slice(0,18).map(q=>o`<${Lf} key=${q.id} item=${q} />`):o`<div class="empty-state">표시할 타임라인 근거가 없습니다.</div>`}
          </div>
        <//>
        ...
        <${T} title="참여 흔적" class="mission-list-card" semanticId="proof.contributions">
          ...
          <div class="mission-activity-list">
            ${i.length>0?i.map(q=>o`<${Rf} key=${q.actor} item=${q} />`):o`<div class="empty-state">표시할 참여 흔적이 없습니다.</div>`}
          </div>
        <//>
      </div>
  ...
  `}function Mf(){const e=cs(D.value);return e?o`
    <section class="command-focus-banner">
      <div class="command-focus-head">
        ...
        <span class="command-chip">${J_(D.value.params.surface??"warroom")}</span>
      </div>
  ...
  `}function Ef(){var ee,oe,W,te;const e=_s(),t=e==null?void 0:e.topology.summary,n=e==null?void 0:e.operations.summary,s=e==null?void 0:e.detachments.summary,a=e==null?void 0:e.decisions.summary,i=e==null?void 0:e.alerts.summary,l=(ee=e==null?void 0:e.swarm_status)==null?void 0:ee.overview,c=e==null?void 0:e.swarm_proof,p=e==null?void 0:e.operations.microarch,m=(t==null?void 0:t.managed_unit_count)??0,u=(t==null?void 0:t.total_units)??0,f=(n==null?void 0:n.active)??0,v=(s==null?void 0:s.active)??0,h=(l==null?void 0:l.moving_lanes)??0,b=(l==null?void 0:l.active_lanes)??0,C=(c==null?void 0:c.workers.done)??0,x=(c==null?void 0:c.workers.expected)??0,S=(i==null?void 0:i.bad)??0,$=(i==null?void 0:i.warn)??0,R=(a==null?void 0:a.pending)??0,L=(a==null?void 0:a.total)??0,z=f+v,q=((oe=p==null?void 0:p.cache)==null?void 0:oe.l1_hit_rate)??((te=(W=p==null?void 0:p.signals)==null?void 0:W.cache_contention)==null?void 0:te.l1_hit_rate)??0,I=f>0||v>0?"지휘면이 실제로 움직이고 있습니다":"계층은 준비됐지만 실행은 아직 잠복 상태입니다",Q=f>0||h>0?"무거운 상세 탭으로 들어가기 전에, 여기서 먼저 압력과 이동감, 운영 부채를 읽을 수 있어야 합니다.":"이 화면은 체크리스트보다 계기판에 가까워야 합니다. 아래 게이지가 지금 어디가 살아 있는지 먼저 보여줍니다.";return o`
  ...
  `}function Of(){return o`
    ...
    <${Nf} />
    <${Df} />
  `}function wf(){return la.value?o`<div class="empty-state">command-plane detail 불러오는 중…</div>`:da.value?o`<div class="empty-state error">${da.value}</div>`:o`<div class="empty-state">surface를 선택하면 command-plane detail을 로드합니다.</div>`}const Zo=g(null),Sr=1280,Cr=760;function Ar(e){switch((e??"").trim().toLowerCase()){case"room":return"룸";case"session":return"세션";case"operation":return"작전";case"detachment":return"분견대";case"lane":return"레인";case"worker":return"워커";case"keeper":return"키퍼";default:return(e==null?void 0:e.trim())||"노드"}}function bn(e,t,n){if(e<=0)return[];if(e===1)return[Math.round((t+n)/2)];const s=(n-t)/(e-1);return Array.from({length:e},(a,i)=>Math.round(t+i*s))}function qf(e,t){const n=new Map;for(const s of e){const a=t(s),i=n.get(a)??[];i.push(s),n.set(a,i)}return n}function Ff(e){const t=new Map,n=e.nodes,s=n.find(b=>b.kind==="room")??null,a=n.filter(b=>b.kind==="session"),i=n.filter(b=>b.kind==="operation"),l=n.filter(b=>b.kind==="detachment"),c=n.filter(b=>b.kind==="lane"),p=n.filter(b=>b.kind==="worker"),m=n.filter(b=>b.kind==="keeper");s&&t.set(s.id,{x:640,y:96}),bn(a.length,170,1110).forEach((b,C)=>{const x=a[C];x&&t.set(x.id,{x:b,y:220})}),bn(i.length,240,1040).forEach((b,C)=>{const x=i[C];x&&t.set(x.id,{x:b,y:330})}),bn(l.length,300,980).forEach((b,C)=>{const x=l[C];x&&t.set(x.id,{x:b,y:420})}),bn(c.length,170,1110).forEach((b,C)=>{const x=c[C];x&&t.set(x.id,{x:b,y:530})});const u=new Map(c.map(b=>{const C=t.get(b.id);return C?[b.id,C.x]:null}).filter(b=>b!==null)),f=qf(p,b=>b.lane_id?`lane:${b.lane_id}`:b.parent_id?b.parent_id:"free");let v=0;for(const[b,C]of f){let x=u.get(b);if(x==null){const $=t.get(b);x=$==null?void 0:$.x}x==null&&(x=180+v%5*200,v+=1),bn(C.length,x-90,x+90).forEach(($,R)=>{const L=C[R];if(!L)return;const z=R>5?Math.floor(R/6):0;t.set(L.id,{x:$,y:635+z*62})})}const h=m.length>3?[1120,1180]:[1140];return m.forEach((b,C)=>{const x=C%h.length,S=Math.floor(C/h.length);t.set(b.id,{x:h[x]??1140,y:190+S*108})}),t}function Kf(e,t){const n=(e.x+t.x)/2,s=t.y>=e.y?32:-32;return`M ${e.x} ${e.y} C ${n} ${e.y+s}, ${n} ${t.y-s}, ${t.x} ${t.y}`}function Tr(e,t,n){if(e==="command"){if(t){rt(t),re("command",{...Ni(t),...n});return}re("command",n);return}if(e==="intervene"){re("intervene",n);return}re("command",n)}function Uf(e){switch(e.kind){case"room":return{width:150,height:150,radius:74};case"worker":return{width:78,height:42,radius:22};case"lane":return{width:170,height:54,radius:16};case"keeper":return{width:120,height:56,radius:24};default:return{width:188,height:64,radius:18}}}function Hf({orchestra:e,roomPoint:t,onSelect:n}){if(!t||e.signals.length===0)return null;const s=108;return o`
  ...
  `}function Wf({orchestra:e,positions:t,selectedId:n,onSelect:s}){var i;const a=((i=e.focus)==null?void 0:i.target_kind)==="node"?e.focus.target_id:null;return o`
    ${e.nodes.map(l=>{const c=t.get(l.id);if(!c)return null;const p=Uf(l),m=l.id===n,u=l.id===a;if(l.kind==="room")return o`
        ...
        `;const f=c.x-p.width/2,v=c.y-p.height/2;return o`
        <g
          key=${l.id}
          class=${`orchestra-node ${l.kind} ${P(l.tone)} ${m?"selected":""} ${u?"focused":""}`}
          onClick=${()=>s(l.id)}
        >
          <rect x=${f} y=${v} width=${p.width} height=${p.height} rx=${p.radius} class="orchestra-node-body" />
          ...
          ${l.status?o`<text x=${f+p.width-10} y=${v+18} text-anchor="end" class="orchestra-node-status">${l.status}</text>`:null}
        </g>
      `})}
  ...
  `}function Jf(){var i,l,c,p;const e=xi.value;if(Jo.value&&!e)return o`<section class="card command-section"><div class="empty-state">오케스트라 맵 불러오는 중…</div></section>`;if(va.value)return o`<section class="card command-section"><div class="empty-state error">${va.value}</div></section>`;if(!e)return o`<section class="card command-section"><div class="empty-state">오케스트라 맵 데이터가 아직 없습니다.</div></section>`;const t=Ff(e),n=Fc(e),s=(n==null?void 0:n.value.id)??null,a=e.nodes.find(m=>m.kind==="room")?t.get(e.nodes.find(m=>m.kind==="room").id)??null:null;return o`
      ...
      <div class="orchestra-shell">
        <div class="orchestra-canvas-wrap">
          ...
          <div class="orchestra-summary-strip">
            ...
            <span class="command-chip">갱신 ${Z(e.generated_at)}</span>
          </div>
        </div>
  ...
  `}function vg(){const e=Ue.value,t=e==null?void 0:e.topology,n=t==null?void 0:t.source,s=t==null?void 0:t.summary,a=(s==null?void 0:s.managed_unit_count)??0,i=(s==null?void 0:s.active_operation_count)??0;return o`
    <section class="card command-section">
      <div class="card-title-row">
  ...
  `}function fg(){const e=Ue.value;return o`
    <section class="card command-section">
      <div class="card-title-row">
      ...
      ${e&&e.alerts.alerts.length>0?o`<div class="command-card-stack">
            ${e.alerts.alerts.map(t=>o`<${_g} alert=${t} />`)}
          </div>`:o`<div class="empty-state">지금 올라온 지휘면 경보는 없습니다.</div>`}
    </section>
  `}function gg(){const e=Ue.value;return o`
    <section class="card command-section">
      <div class="card-title-row">
  ...
  `}function $g(e){if(typeof e=="string")return e;if(e==null)return"";try{return JSON.stringify(e,null,2)}catch{return String(e)}}function hg(e,t){return(t==null?void 0:t.status)==="abandoned"||(e==null?void 0:e.recommended_kind)==="continue"?"warn":(e==null?void 0:e.recommended_kind)==="rerun"?"bad":"ok"}function yg(e){switch(e){case"continue":case"continued":return"계속";case"rerun":return"재실행";case"abandon":case"abandoned":return"포기";default:return(e==null?void 0:e.trim())||"결정"}}function bg(e){return e?e.runtime_blocker?"막힘":e.provider_reachable?"준비됨":"확인 필요":"확인 필요"}function Jc({swarm:e}){var f,v;const t=e.run_id,n=e.resolution_recommendation,s=e.run_resolution;if(!t||!n&&!s)return null;const a=Oc()??"dashboard",i=((f=$e.value)==null?void 0:f.pending_confirms.find(h=>h.target_type==="swarm_run"&&h.target_id===t))??null,l=hg(n,s),c=((v=e.operation)==null?void 0:v.operation_id)??e.operation_id??void 0,p={run_id:t};c&&(p.operation_id=c),n!=null&&n.reason&&(p.reason=n.reason);const m=async h=>{await Kl({actor:a,action_type:h,target_type:"swarm_run",target_id:t,payload:p})},u=async h=>{i&&await Ul(a,i.confirm_token,h)};return o`
    <article class="command-guide-card ${P(l)}">
      ...
      ${i?o`
          ...
          `:n?o`
              <div class="command-action-row">
                ${n.continue_available?o`<button class="control-btn ghost" onClick=${()=>{m("swarm_run_continue")}} disabled=${J.value}>계속</button>`:null}
                ${n.rerun_available?o`<button class="control-btn" onClick=${()=>{m("swarm_run_rerun")}} disabled=${J.value}>재실행</button>`:null}
                ${n.abandon_available?o`<button class="control-btn ghost" onClick=${()=>{m("swarm_run_abandon")}} disabled=${J.value}>포기</button>`:null}
              </div>
            `:null}
    </article>
  ...
  `}function kg({total:e}){const n=Math.min(e,20),s=e>20?e-20:0,a=Array.from({length:n});return o`
  ...
  `}function xg({lane:e}){const t=e.counts??{},n=Vc(e),s=t.workers??0,a=t.operations??0,i=t.detachments??0,l=a+i,c=e.motion_state==="moving"?84:e.motion_state==="waiting"?58:e.motion_state==="terminal"?100:26;return o`
    <article class="swarm-lane-strip ${P(n)}">
      <div class="swarm-lane-head">
        ...
        <div class="command-tag-row">
          ...
          <span class="command-chip">${Z(e.last_movement_at)}</span>
        </div>
      </div>
  ...
  `}function Sg({event:e}){const t=e.timestamp?new Date(e.timestamp):null,n=t&&!isNaN(t.getTime())?t:null,s=n?`${String(n.getHours()).padStart(2,"0")}:${String(n.getMinutes()).padStart(2,"0")}`:"";return o`
  ...
  `}function Ag({proof:e}){const t=(e==null?void 0:e.status)==="missing"?"warn":(e==null?void 0:e.pass)===!1?"bad":(e==null?void 0:e.pass)===!0?"ok":"warn";return o`
    <div class="command-guide-card ${P(t)}">
      ...
      ${e?o`
            <div class="command-card-grid">
              ...
              <span>수집 시각</span><span>${Z(e.captured_at)}</span>
      ...
      ${s?o`
            ...
            <div class="command-swarm-layout ${u?"compact":""}">
              <div class="command-card-stack">
                ${i.length>0?i.map(f=>o`<${xg} lane=${f} />`):o`<div class="empty-state">활성 스웜 레인이 없습니다.</div>`}
              </div>
              ...
              <div class="command-card-stack">
                ...
                <div class="command-guide-card ${l.length>0?"warn":"ok"} ${n==="gaps"?"focus":""}">
                  ...
                  ${l.length>0?o`<div class="swarm-event-rail">${l.slice(0,4).map(f=>o`<${Cg} gap=${f} />`)}</div>`:o`<p>지금 보이는 핵심 공백은 없습니다.</p>`}
                </div>
                ...
                <div class="command-guide-card">
                  ...
                  ${c.length>0?o`<div class="swarm-event-rail">${c.map(f=>o`<${Sg} event=${f} />`)}</div>`:o`<p>붙어 있는 최근 이동 이벤트가 아직 없습니다.</p>`}
                </div>
              </div>
            </div>
          `:o`<div class="empty-state">스웜 상태를 아직 불러오지 못했습니다.</div>`}
    </section>
  `}function Ig({item:e}){return o`
  ...
  `}function Lg({worker:e}){return o`
    <article class="command-card compact">
      ...
      ${e.last_message?o`<div class="command-card-foot">${Z(e.last_message.timestamp)} · ${e.last_message.content}</div>`:null}
    </article>
  `}function Rg(){var u,f,v,h,b,C,x,S,$,R,L,z,q,I,Q,ee,oe,W,te,A,Y,K;const e=Et.value,t=qc(),n=Di(),s=bg(e==null?void 0:e.provider),a=((u=e==null?void 0:e.provider)==null?void 0:u.configured_capacity)??0,i=((f=e==null?void 0:e.provider)==null?void 0:f.actual_slots)??((v=e==null?void 0:e.provider)==null?void 0:v.total_slots)??0,l=((h=e==null?void 0:e.provider)==null?void 0:h.expected_slots)??"n/a",c=((b=e==null?void 0:e.provider)==null?void 0:b.actual_ctx)??((C=e==null?void 0:e.provider)==null?void 0:C.ctx_per_slot)??0,p=((x=e==null?void 0:e.provider)==null?void 0:x.expected_ctx)??"n/a",m=((S=e==null?void 0:e.summary)==null?void 0:S.peak_hot_slots)??(($=e==null?void 0:e.provider)==null?void 0:$.peak_active_slots)??0;return o`
    <div class="command-section-stack">
      ...
      <div class="command-surface-grid">
        <section class="card command-section">
          ...
          ${ma.value?o`<div class="empty-state">Loading swarm live state…</div>`:_a.value?o`<div class="empty-state error">${_a.value}</div>`:e?o`
                    <div class="command-summary-grid">
                      <div class="monitor-stat-card"><span>실행 런</span><strong>${e.run_id??t??"swarm-live"}</strong><small>${e.room_id??"room 정보 없음"}</small></div>
                      <div class="monitor-stat-card"><span>워커</span><strong>${((R=e.summary)==null?void 0:R.joined_workers)??0}/${((L=e.summary)==null?void 0:L.expected_workers)??0}</strong><small>${((z=e.summary)==null?void 0:z.live_workers)??0}개 가동 · ${((q=e.summary)==null?void 0:q.completed_workers)??0}개 완료</small></div>
                      <div class="monitor-stat-card"><span>런타임 계약</span><strong>${s}</strong><small>설정 ${a||"n/a"} · 실제 ${i}/${l} · ctx ${c}/${p}</small></div>
                      <div class="monitor-stat-card"><span>고동시성</span><strong>${(I=e.summary)!=null&&I.pass_hot_concurrency?"통과":"확인 필요"}</strong><small>최대 hot ${m} · ${((Q=e.provider)==null?void 0:Q.slot_url)??"slot 정보 없음"}</small></div>
                      <div class="monitor-stat-card"><span>종단 점검</span><strong>${(ee=e.summary)!=null&&ee.pass_end_to_end?"통과":"확인 필요"}</strong><small>${e.recommended_next_tool??"masc_observe_traces"}</small></div>
                    </div>
                    <div class="command-card-grid">
                      <span>작전</span><span>${((oe=e.operation)==null?void 0:oe.operation_id)??n??"없음"}</span>
                      ...
                      <span>최종 마커</span><span>${((Y=e.summary)==null?void 0:Y.final_markers_seen)??0}</span>
        ...
        <section class="card command-section">
          ...
          ${e&&e.checklist.length>0?o`<div class="command-card-stack">
                ${e.checklist.map(ne=>o`<${Ig} item=${ne} />`)}
        ...
        <section class="card command-section">
          ...
          ${e&&e.workers.length>0?o`<div class="command-card-stack">
                ${e.workers.map(ne=>o`<${Lg} worker=${ne} />`)}
        ...
        <section class="card command-section">
          ...
          ${e!=null&&e.provider?o`
                <div class="command-card-grid">
                  ...
                  <span>마지막 샘플</span><span>${e.provider.last_sample_at?Z(e.provider.last_sample_at):"정보 없음"}</span>
                  <span>런타임 막힘</span><span>${e.provider.runtime_blocker??"없음"}</span>
                  <span>검사 시각</span><span>${e.provider.checked_at?Z(e.provider.checked_at):"정보 없음"}</span>
                </div>
                <div class="command-card-sub">
                          ...
                          <article class="command-trace-row">
                            <div class="command-trace-main">
                              <div class="command-trace-head">
                                ...
                                <span class="command-chip">${Z(ne.timestamp)}</span>
                              </div>
        ...
        <section class="card command-section">
          ...
          ${e&&e.blockers.length>0?o`<div class="command-card-stack">
                ${e.blockers.map(ne=>o`<${Xc} blocker=${ne} />`)}
  ...
  `}function Ze({label:e,surface:t,params:n={}}){return o`
    <button
      ...
      onClick=${()=>{if(t){rt(t),re("command",{...Ni(t),...n});return}re("intervene")}}
    >
      ${e}
    </button>
  `}function Ng(){var te,A,Y,K,ne,$t,U,Pe,ht,gn,$n,vs,fs,gs,$s,hs,ys,bs,Vi,Qi,Yi;const e=_s(),t=Et.value,n=$e.value,s=Fe.value,a=hf(),i=t!=null&&t.operation?((te=ls.value)==null?void 0:te.operations.find(X=>{var ks;return X.operation.operation_id===((ks=t.operation)==null?void 0:ks.operation_id)}))??null:null,l=gf(),c=(t==null?void 0:t.workers)??[],p=(s==null?void 0:s.worker_cards)??[],m=l&&c.length>0?c.map(Mg):p.map(jg),u=l,f=((A=e==null?void 0:e.decisions.summary)==null?void 0:A.pending)??0,v=(n==null?void 0:n.pending_confirms)??[],h=l?(t==null?void 0:t.blockers)??[]:[],b=(s==null?void 0:s.recommended_actions)??[],C=(Y=s==null?void 0:s.active_recommended_actions)!=null&&Y.length?s.active_recommended_actions:b,x=s==null?void 0:s.active_summary,S=(s==null?void 0:s.active_guidance_layer)??"fallback",$=(s==null?void 0:s.resident_judge_runtime)??(n==null?void 0:n.resident_judge_runtime),R=(s==null?void 0:s.attention_items)??[],L=((K=t==null?void 0:t.recent_messages[0])==null?void 0:K.timestamp)??null,z=((ne=t==null?void 0:t.recent_trace_events[0])==null?void 0:ne.timestamp)??null,q=l?L??z??null:null,I=a==null?void 0:a.summary,Q=(l?($t=t==null?void 0:t.summary)==null?void 0:$t.expected_workers:void 0)??(typeof(I==null?void 0:I.planned_worker_count)=="number"?I.planned_worker_count:void 0)??(s==null?void 0:s.worker_cards.length)??0,ee=(l?(U=t==null?void 0:t.summary)==null?void 0:U.joined_workers:void 0)??(typeof(I==null?void 0:I.active_agent_count)=="number"?I.active_agent_count:void 0)??m.length,oe=h.length>0||f>0||v.length>0?"warn":u||a?"ok":"warn",W=l?((Pe=e==null?void 0:e.swarm_status)==null?void 0:Pe.lanes.filter(X=>X.present))??[]:[];return ae(()=>{xe()},[]),ae(()=>{a!=null&&a.session_id&&ln(a.session_id)},[a==null?void 0:a.session_id,n,(ht=t==null?void 0:t.detachment)==null?void 0:ht.session_id]),!u&&!a?ma.value||Fn.value?o`<div class="empty-state">실시간 워룸 불러오는 중…</div>`:o`
    ...
    `:o`
    <div class="command-section-stack">
      <section class="command-warroom-strip ${P(oe)}">
        <div class="command-warroom-strip-head">
          <div>
            ...
            ${x!=null&&x.summary?o`<div class="command-warroom-guidance ${Ta(S)}">
                  <strong>${wi(S)}</strong>
                  <span>${x.summary}</span>
                </div>`:null}
          </div>
        ...
        <div class="command-warroom-strip-stats">
          ...
          <div class="monitor-stat-card">
            ...
            <small>${l?`설정 ${((ys=t==null?void 0:t.provider)==null?void 0:ys.configured_capacity)??"n/a"} · 실제 ${((bs=t==null?void 0:t.provider)==null?void 0:bs.actual_slots)??((Vi=t==null?void 0:t.provider)==null?void 0:Vi.total_slots)??0} · hot ${((Qi=t==null?void 0:t.summary)==null?void 0:Qi.peak_hot_slots)??((Yi=t==null?void 0:t.provider)==null?void 0:Yi.peak_active_slots)??0}`:`세션 워커 ${(s==null?void 0:s.worker_cards.length)??0}`}</small>
          </div>
          ...
          <div class="monitor-stat-card ${P(Ta(S))}">
            <span>상주 판정기</span>
            <strong>${qi($)}</strong>
            <small>${Fi(x)}${$!=null&&$.model_used?` · ${$.model_used}`:""}</small>
          </div>
          <div class="monitor-stat-card">
            <span>마지막 신호</span>
            <strong>${Z(q)}</strong>
            <small>${L?"메시지":z?"트레이스":"대기 중"}</small>
          </div>
        </div>
      </section>
        ...
        <div class="command-warroom-column">
          <section class="card command-section">
            ...
            ${t&&t.recent_messages.length>0&&l?o`<div class="command-trace-stack">
                  ...
                  `)}
                    ...
                    ${C.slice(0,4).map(X=>o`
                      <article class="command-guide-card ${Pr(X)}">
                        <div class="command-guide-head">
                          <strong>${X.action_type}</strong>
                          <span class="command-chip ${Pr(X)}">${X.target_type}</span>
                        </div>
                        <p>${X.reason}</p>
                      </article>
                    `)}
                    ...
                    `)}
                      ...
                      ${a.recent_events.slice(0,6).map((X,ks)=>o`
                        <article class="command-trace-row">
                          <div class="command-trace-main">
                            <div class="command-trace-head">
                          ...
                          <pre class="command-trace-detail">${ka(X)}</pre>
                        </article>
                      `)}
          ...
          <section class="card command-section">
            ...
            ${t&&t.recent_trace_events.length>0?o`<div class="command-trace-stack">
                  ${t.recent_trace_events.map(X=>o`<${Ki} event=${X} />`)}
        ...
        <div class="command-warroom-column">
          <section class="card command-section">
            ...
            <div class="command-card-stack">
              ...
              ${h.length>0?h.map(X=>o`<${Xc} blocker=${X} />`):o`<div class="command-guide-card ok"><p>지금 보이는 blocker는 없습니다.</p></div>`}
              ${f>0?o`
              ...
              ${v.length>0?o`
                    <article class="command-guide-card warn">
                      ...
                      <div class="command-tag-row">
                        ${v.slice(0,3).map(X=>o`<span class="command-tag">${X.confirm_token}</span>`)}
                      </div>
                    </article>
                  `:null}
            </div>
              ...
              ${l&&(t!=null&&t.operation)?o`
                    <article class="command-card compact">
                      ...
                      <div class="command-card-grid">
                        ...
                        <span>최근 갱신</span><span>${Z(t.operation.updated_at)}</span>
                      </div>
                    </article>
                  `:null}
  ...
  `}function Mr(e){switch((e??"").trim().toLowerCase()){case"active":return"가동 중";case"paused":return"일시정지";case"failed":return"실패";case"completed":case"done":return"완료";case"disconnected":return"끊김";case"preview":return"미리보기";case"captured":return"기록됨";default:return(e==null?void 0:e.trim())||"확인 필요"}}function Dg({source:e}){const t=hd(null),[n,s]=Yr(null);return ae(()=>{let a=!1;const i=t.current;return i?(i.innerHTML="",s(null),(async()=>{try{const c=await ef(),{svg:p}=await c.render(`command-chain-${Zv()}`,e);if(a||!t.current)return;t.current.innerHTML=p}catch(c){if(a)return;s(c instanceof Error?c.message:"Mermaid 렌더링에 실패했습니다")}})(),()=>{a=!0,t.current&&(t.current.innerHTML="")}):void 0},[e]),o`
    <div class="command-chain-graph-shell">
      ${n?o`<div class="empty-state error">${n}</div>`:null}
      <div class="command-chain-graph" ref=${t}></div>
    </div>
  `}function Og({overlay:e,selected:t,onSelect:n}){const s=e.operation.chain,a=e.runtime;return o`
  ...
  `}function wg({item:e}){return o`
    <article class="command-chain-history-row">
      ...
      <div class="command-card-sub">${Z(e.timestamp)}</div>
      <div class="command-card-sub">${Nc(e)}</div>
    </article>
  `}function qg({node:e}){return o`
  ...
  `}function Fg({card:e}){const t=e.operation,n=`pause:${t.operation_id}`,s=`resume:${t.operation_id}`,a=`recall:${t.operation_id}`,i=t.chain,l=(i==null?void 0:i.run_id)??null;return o`
    <article class="command-card">
      ...
      <div class="command-card-grid">
        ...
        <span>최근 갱신</span><span>${Z(t.updated_at)}</span>
      </div>
      ${i?o`
            <div class="command-tag-row">
      ...
      <div class="command-action-row">
        <button
          class="control-btn ghost"
          onClick=${()=>{rt("swarm"),re("command",{surface:"swarm",operation_id:t.operation_id,...l?{run_id:l}:{}})}}
        >
          스웜 실시간 보기
        </button>
        ${i?o`
              <button
                class="control-btn ghost"
                onClick=${()=>{Ti(t.operation_id),rt("chains"),re("command",{surface:"chains",operation:t.operation_id})}}
              >
                체인 열기
              </button>
            `:null}
        ${t.source==="managed"&&t.status==="active"?o`
              <button class="control-btn ghost" disabled=${ce(n)} onClick=${()=>ct(()=>I_(t.operation_id))}>
                ${ce(n)?"일시정지 중…":"일시정지"}
              </button>
              <button class="control-btn ghost" disabled=${ce(a)} onClick=${()=>ct(()=>R_(t.operation_id))}>
                ${ce(a)?"회수 중…":"회수"}
              </button>
            `:null}
        ${t.source==="managed"&&t.status==="paused"?o`
              <button class="control-btn ghost" disabled=${ce(s)} onClick=${()=>ct(()=>L_(t.operation_id))}>
                ${ce(s)?"재개 중…":"재개"}
              </button>
            `:null}
      </div>
    </article>
  `}function Kg({card:e}){var n;const t=e.detachment;return o`
    <article class="command-card compact">
      <div class="command-card-head">
        <div>
      ...
      <div class="command-card-grid">
        ...
        <span>진행 흔적</span><span>${Z(t.last_progress_at)}</span>
        <span>하트비트</span><span>${Ec(t.heartbeat_deadline)}</span>
        <span>최근 갱신</span><span>${Z(t.updated_at)}</span>
      </div>
      <div class="command-tag-row">
        ${t.heartbeat_deadline?o`<span class="command-tag ${Yv(t.heartbeat_deadline)}">
    ...
    <div class="command-surface-grid">
      <section class="card command-section">
        ...
        ${e&&e.operations.operations.length>0?o`<div class="command-card-stack">
              ${e.operations.operations.map(t=>o`<${Fg} card=${t} />`)}
      ...
      <section class="card command-section">
        ...
        ${e&&e.detachments.detachments.length>0?o`<div class="command-card-stack">
              ${e.detachments.detachments.map(t=>o`<${Kg} card=${t} />`)}
            </div>`:o`<div class="empty-state">투영된 분견대가 없습니다.</div>`}
      </section>
    </div>
  `}function Hg(){var c,p,m,u,f,v,h,b,C,x,S,$,R,L,z,q;const e=ls.value,t=(e==null?void 0:e.operations)??[],n=Zt.value,s=t.find(I=>I.operation.operation_id===n)??t[0]??null,a=((c=s==null?void 0:s.operation.chain)==null?void 0:c.run_id)??null,i=((p=Un.value)==null?void 0:p.run)??(s==null?void 0:s.preview_run)??null,l=!((m=Un.value)!=null&&m.run)&&!!(s!=null&&s.preview_run);return ae(()=>{a?A_(a):C_()},[a]),o`
      ...
      <section class="card command-section">
        ...
        <article class="command-guide-card ${lt(e==null?void 0:e.connection.status)}">
          ...
          <div class="command-card-grid">
            ...
            <span>마지막 이벤트</span><span>${Z((h=e==null?void 0:e.summary)==null?void 0:h.last_history_event_at)}</span>
          </div>
        </article>
                ...
                <div class="command-chain-list">
                  ${t.map(I=>o`
                    <${Og}
                      ...
                      onSelect=${()=>Ti(I.operation.operation_id)}
                    />
                  `)}
                </div>
        ...
        <div class="command-chain-history">
          ...
          ${e&&e.recent_history.length>0?o`
                <div class="command-card-stack">
                  ${e.recent_history.slice(0,6).map(I=>o`<${wg} item=${I} />`)}
                </div>
        ...
        ${s?o`
              <article class="command-card">
                ...
                <div class="command-card-grid">
                  ...
                  <span>경과</span><span>${Cn((R=s.runtime)==null?void 0:R.elapsed_sec)}</span>
                  <span>최근 갱신</span><span>${Z(((L=s.operation.chain)==null?void 0:L.last_sync_at)??s.operation.updated_at)}</span>
                </div>
  ...
  `}function Bg(e){switch((e??"").trim().toLowerCase()){case"pending":return"대기 중";case"approved":return"승인됨";case"denied":return"거부됨";case"executed":return"실행됨";case"active":return"가동 중";default:return(e==null?void 0:e.trim())||"확인 필요"}}function Wg({decision:e}){const t=`approve:${e.decision_id}`,n=`deny:${e.decision_id}`,s=e.source==="projected_operator";return o`
    <article class="command-card ${P(e.status)}">
      <div class="command-card-head">
        ...
        <span class="command-chip ${P(e.status)}">${Bg(e.status??"pending")}</span>
      </div>
      <div class="command-card-grid">
        ...
        <span>생성 시각</span><span>${Z(e.created_at)}</span>
        <span>이유</span><span>${e.reason??"정보 없음"}</span>
      </div>
      ${e.status==="pending"&&!s?o`
            <div class="command-action-row">
              <button class="control-btn ghost" disabled=${ce(t)} onClick=${()=>ct(()=>P_(e.decision_id))}>
                ${ce(t)?"승인 중…":"승인"}
              </button>
              <button class="control-btn ghost" disabled=${ce(n)} onClick=${()=>ct(()=>M_(e.decision_id))}>
                ${ce(n)?"거부 중…":"거부"}
              </button>
            </div>
          `:null}
  ...
  `}function Gg({row:e}){var c,p,m;const t=e.unit,n=`freeze:${t.unit_id}`,s=`kill:${t.unit_id}`,a=!!((c=t.policy)!=null&&c.frozen),i=!!((p=t.policy)!=null&&p.kill_switch),l=Math.round((e.utilization??0)*100);return o`
    <article class="command-card compact">
      <div class="command-card-head">
        <div>
      ...
      <div class="command-action-row">
        <button class="control-btn ghost" disabled=${ce(n)} onClick=${()=>ct(()=>j_(t.unit_id,!a))}>
          ${ce(n)?"적용 중…":a?"동결 해제":"동결"}
        </button>
        <button class="control-btn ghost" disabled=${ce(s)} onClick=${()=>ct(()=>E_(t.unit_id,!i))}>
          ${ce(s)?"적용 중…":i?"킬 스위치 해제":"킬 스위치 켜기"}
        </button>
      </div>
    </article>
  `}function Jg(){const e=Ue.value;return o`
    <div class="command-surface-grid">
      <section class="card command-section">
        <div class="card-title-row">
        ...
        ${e&&e.decisions.decisions.length>0?o`<div class="command-card-stack">
              ${e.decisions.decisions.map(t=>o`<${Wg} decision=${t} />`)}
      ...
      <section class="card command-section">
        ...
        ${e&&e.capacity.capacity.length>0?o`<div class="command-card-stack">
              ${e.capacity.capacity.map(t=>o`<${Gg} row=${t} />`)}
            </div>`:o`<div class="empty-state">제어할 용량 행이 아직 없습니다.</div>`}
      </section>
    </div>
  `}function Vg(){return o`
          ...
          <div class="command-tab-group-items">
            ${Dc.filter(t=>t.group===e.id).map(t=>o`
                <button
                  ...
                  onClick=${()=>{rt(t.id),re("command",Ni(t.id))}}
                >
                  ${t.label}
                </button>
              `)}
  ...
  `}function Qg(){if(V.value==="warroom")return o`<${Ng} />`;if(V.value==="summary")return o`<${Of} />`;if(V.value==="orchestra")return o`<${Jf} />`;if(V.value==="swarm")return o`<${Rg} />`;if(!Ue.value)return o`<${wf} />`;switch(V.value){case"chains":return o`<${Hg} />`;case"topology":return o`<${vg} />`;case"alerts":return o`<${fg} />`;case"trace":return o`<${gg} />`;case"control":return o`<${Jg} />`;case"operations":default:return o`<${Ug} />`}}function Yg(){return ae(()=>{Ut(),en(),T_(),tt(),Lt()},[]),ae(()=>{if(D.value.tab!=="command")return;const e=D.value.params.surface,t=D.value.params.operation,n=cs(D.value);if(kr(e))rt(e);else if(n){const s=$c(n);kr(s)&&rt(s)}else e||rt("warroom");t&&Ti(t),(e==="swarm"||e==="warroom"||e==="orchestra"||V.value==="warroom"||V.value==="orchestra")&&tt(),(e==="orchestra"||V.value==="orchestra")&&Lt(),(e==="warroom"||V.value==="warroom")&&xe()},[D.value.tab,D.value.params.surface,D.value.params.operation,D.value.params.operation_id,D.value.params.run_id,D.value.params.source,D.value.params.action_type,D.value.params.target_type,D.value.params.target_id,D.value.params.focus_kind]),ae(()=>{let e=null;const t=()=>{e||(e=window.setTimeout(()=>{e=null,Ut(),en(),(V.value==="swarm"||V.value==="warroom"||V.value==="orchestra")&&tt(),V.value==="orchestra"&&Lt(),V.value==="warroom"&&xe()},250))},n=new EventSource(lf()),s=af.map(a=>{const i=()=>t();return n.addEventListener(a,i),{type:a,handler:i}});return n.onerror=()=>{t()},()=>{s.forEach(({type:a,handler:i})=>{n.removeEventListener(a,i)}),n.close(),e&&window.clearTimeout(e)}},[]),ae(()=>{const e=window.setInterval(()=>{if(document.visibilityState==="hidden")return;const t=V.value;t!=="swarm"&&t!=="warroom"&&t!=="orchestra"||(Ut(),tt(),t==="orchestra"&&Lt(),t==="warroom"&&xe())},5e3);return()=>{window.clearInterval(e)}},[]),o`
    <section class="dashboard-panel command-plane-view">
      <div class="panel-header">
        ...
        <div class="panel-actions">
          ...
          <button
            class="control-btn ghost"
            onClick=${()=>{Ut(),en(),tt(),V.value==="warroom"&&xe()}}
            disabled=${ra.value}
          >
  ...
  `}function Xg(){var x,S;const e=$e.value,t=bi.value,n=(e==null?void 0:e.room)??{},s=(e==null?void 0:e.pending_confirms)??[],a=e==null?void 0:e.pending_confirm_summary,i=a?a.confirm_required_actions:((e==null?void 0:e.available_actions)??[]).filter($=>$.confirm_required),l=((x=a==null?void 0:a.actor_filter)==null?void 0:x.trim())||null,c=(a==null?void 0:a.hidden_count)??0,p=(a==null?void 0:a.hidden_actors)??[],m=(e==null?void 0:e.recent_messages)??[],u=(t==null?void 0:t.recommended_actions)??[],f=(S=t==null?void 0:t.active_recommended_actions)!=null&&S.length?t.active_recommended_actions:u,v=t==null?void 0:t.active_summary,h=(t==null?void 0:t.resident_judge_runtime)??(e==null?void 0:e.resident_judge_runtime),b=(t==null?void 0:t.active_guidance_layer)??"fallback",C=m.slice(0,5);return o`
      ...
      <section class="card ops-panel ops-lane-panel">
        ...
        <div class="control-row">
          <input
            ...
            onKeyDown=${$=>{$.key==="Enter"&&Rr()}}
            disabled=${J.value}
          />
          <button class="control-btn" onClick=${()=>{Rr()}} disabled=${J.value||nn.value.trim()===""}>
            보내기
          </button>
        </div>
  ...
  `}function e$(){var i;const e=$e.value,t=(e==null?void 0:e.keepers)??[],n=(e==null?void 0:e.persistent_agents)??[],s=(e==null?void 0:e.available_actions)??[],a=t.find(l=>l.name===Ca.value)??t[0]??null;return o`
    <div class="ops-column">
  ...
  `}function t$(){var L,z,q;const e=$e.value,t=D.value.tab==="intervene"?cs(D.value):null,n=bi.value,s=(e==null?void 0:e.room)??{},a=(e==null?void 0:e.sessions)??[],i=(e==null?void 0:e.keepers)??[],l=(e==null?void 0:e.pending_confirms)??[],c=e==null?void 0:e.pending_confirm_summary,p=(c==null?void 0:c.visible_count)??l.length,m=(c==null?void 0:c.total_count)??l.length,u=(c==null?void 0:c.hidden_count)??0,f=((L=c==null?void 0:c.actor_filter)==null?void 0:L.trim())||null,v=a.find(I=>I.session_id===cn.value)??a[0]??null,h=(n==null?void 0:n.attention_items)??[],b=h.filter(Zf),C=h.filter(eg),x=a.filter(I=>Xf(I)!=="ok"),S=i.filter(I=>ao(I)!=="ok"),$=ig(t,a,i);ae(()=>{Mt()},[]),ae(()=>{if(D.value.tab!=="intervene"){Is.value=null;return}if(!t){Is.value=null;return}Is.value!==t.id&&(Is.value=t.id,ag(t))},[D.value.tab,D.value.params.source,D.value.params.action_type,D.value.params.target_type,D.value.params.target_id,D.value.params.focus_kind,t==null?void 0:t.id]),ae(()=>{const I=(v==null?void 0:v.session_id)??null;ln(I)},[v==null?void 0:v.session_id]);const R=[{key:"room",label:"방 게이트",value:s.paused?"일시정지":"열림",detail:s.paused?`재개 전환 대기 중${s.pause_reason?` · ${s.pause_reason}`:""}`:"지금은 새 액션과 새 작업을 바로 받을 수 있습니다",tone:s.paused?"bad":"ok"},{key:"confirm",label:"확인 대기",value:u>0?`${p}/${m}`:p,detail:p>0?"미리보기만 된 개입이 아직 사람 확인을 기다리고 있습니다":u>0&&f?`현재 개입 ID(${f}) 기준으로는 비어 있고, 다른 개입 ID 대기 ${u}건이 있습니다`:"지금 막혀 있는 확인 대기는 없습니다",tone:m>0?"warn":"ok"},{key:"session",label:"세션 리스크",value:b.length>0?b.length:a.length,detail:b.length>0?((z=b[0])==null?void 0:z.summary)??"세션 중 하나가 방향 수정이나 중지 판단을 기다리고 있습니다":a.length===0?"지금 관리 중인 팀 세션이 없습니다":"세션 쪽 긴급 주의 신호는 현재 없습니다",tone:b.length>0?Lr(b):a.length===0?"warn":x.some(I=>dn(I.status)==="paused")?"bad":x.length>0?"warn":"ok"},{key:"keeper",label:"키퍼 압력",value:C.length>0?C.length:S.length,detail:C.length>0?((q=C[0])==null?void 0:q.summary)??"직접 메시지나 상태 점검이 필요한 키퍼가 있습니다":S.length>0?"오래됐거나 오프라인이거나 텔레메트리가 비는 키퍼가 보입니다":"지금은 키퍼 쪽이 비교적 안정적입니다",tone:C.length>0?Lr(C):S.some(I=>ao(I)==="bad")?"bad":S.length>0?"warn":"ok"}];return o`
    <section class="ops-view">
      ...
      <div class="ops-header card">
        ...
        <div class="ops-toolbar">
          ...
          <input
            ...
            type="text"
            value=${Wa.value}
            onInput=${I=>Qf(I.target.value)}
          />
          <button
            class="control-btn ghost"
            onClick=${()=>{xe(),Mt(),ln((v==null?void 0:v.session_id)??null)}}
      ...
      ${(()=>{const I=[];if((p>0||u>0)&&I.push({label:u>0?`확인 대기 ${p}/${m}건 확인`:`확인 대기 ${p}건 처리`,desc:u>0&&f?`현재 개입 ID(${f}) 기준으로 보이는 대기열을 먼저 확인합니다`:"승인 또는 거부가 필요한 개입이 대기 중입니다",tone:p>0?"bad":"warn",onClick:()=>{const Q=document.querySelector(".ops-pending-section");Q==null||Q.scrollIntoView({behavior:"smooth"})}}),s.paused&&I.push({label:"방 재개",desc:`현재 일시정지 상태${s.pause_reason?` (${s.pause_reason})`:""}`,tone:"warn",onClick:()=>void Hc()}),S.length>0){const Q=S.filter(ee=>ao(ee)==="bad");I.push({label:Q.length>0?`오프라인 키퍼 ${Q.length}개`:`점검이 필요한 키퍼 ${S.length}개`,desc:Q.length>0?"메시지를 보내거나 상태를 확인하세요":"오래됐거나 텔레메트리가 비어 있습니다",tone:Q.length>0?"bad":"warn",onClick:()=>{const ee=document.querySelector(".ops-keeper-section");ee==null||ee.scrollIntoView({behavior:"smooth"})}})}return I.length===0?null:o`
  ...
  `}function n$({text:e}){if(!e)return null;const t=s$(e);return o`<div class="markdown-content">${t}</div>`}function s$(e){const t=e.split(`
...
`))}</p>`)}return n}function oo(e){const t=[],n=/(`[^`]+`)|(\*\*[^*]+\*\*)|(\*[^*]+\*)|\[([^\]]+)\]\(([^)]+)\)/g;let s=0,a;for(;(a=n.exec(e))!==null;){if(a.index>s&&t.push(e.slice(s,a.index)),a[1]){const i=a[1].slice(1,-1);t.push(o`<code>${i}</code>`)}else if(a[2]){const i=a[2].slice(2,-2);t.push(o`<strong>${i}</strong>`)}else if(a[3]){const i=a[3].slice(1,-1);t.push(o`<em>${i}</em>`)}else a[4]&&a[5]&&t.push(o`<a href=${a[5]} target="_blank" rel="noopener">${a[4]}</a>`);s=a.index+a[0].length}return s<e.length&&t.push(e.slice(s)),t.length>0?t:[e]}const Zc=[{id:"recent",label:"최신순"},{id:"hot",label:"인기순"},{id:"trending",label:"급상승"},{id:"updated",label:"최근 갱신"},{id:"discussed",label:"토론 많은 순"}],Gs=g(null),Js=g([]),un=g(!1),zt=g(null),Pn=g(""),Mn=g(!1),Wt=g(!0),Ui=20,wt=g(Ui);function a$(){var t,n;const e=new URLSearchParams(window.location.search);return((t=e.get("agent"))==null?void 0:t.trim())||((n=e.get("agent_name"))==null?void 0:n.trim())||"dashboard-user"}const o$=g(a$());function i$(e){const t=e.replace(/!\[[^\]]*\]\([^)]+\)/g," ").replace(/\[[^\]]+\]\([^)]+\)/g,"$1").replace(/[`#>*_~-]/g," ").replace(/\s+/g," ").trim();return t?t.length>180?`${t.slice(0,177)}...`:t:"미리보기 없음"}function jr(e){return e.updated_at!==e.created_at}function r$(e){if(e.post_kind)return e.post_kind==="automation";const t=(e.hearth??"").toLowerCase();return e.visibility!=="internal"||!e.expires_at||!t?!1:!!(t.startsWith("mdal")||t.includes("harness"))}function l$(e){return e==="lodge-system"||e==="team-session"}function es(e){return e.post_kind?e.post_kind:l$(e.author)?"system":r$(e)?"automation":"human"}function ed(e){const t=[],n=[];let s=0;return e.forEach(a=>{const i=es(a);if(!(i==="system"&&At.value)){if(i==="automation"&&Wt.value){s+=1;return}if(i==="human"){t.push(a);return}n.push(a)}}),{human:t,operations:n,hiddenAutomation:s}}function c$(e){if(!e.expires_at)return null;const t=Date.parse(e.expires_at);return Number.isFinite(t)?t<=Date.now()?o`<span class="board-meta-chip">만료됨</span>`:o`<span class="board-meta-chip">만료까지 <${G} timestamp=${e.expires_at} /></span>`:null}async function Hi(e){zt.value=e,Gs.value=null,Js.value=[],un.value=!0;try{const t=await yu(e);if(zt.value!==e)return;Gs.value={id:t.id,author:t.author,title:t.title,body:t.body,content:t.content,meta:t.meta,tags:t.tags,votes:t.votes,vote_balance:t.vote_balance,comment_count:t.comment_count,created_at:t.created_at,updated_at:t.updated_at,post_kind:t.post_kind,flair:t.flair,hearth:t.hearth,visibility:t.visibility,expires_at:t.expires_at,hearth_count:t.hearth_count},Js.value=t.comments??[]}catch{zt.value===e&&(Gs.value=null,Js.value=[])}finally{zt.value===e&&(un.value=!1)}}async function Er(e){const t=Pn.value.trim();if(t){Mn.value=!0;try{await bu(e,o$.value,t),Pn.value="",M("댓글을 등록했습니다","success"),await Hi(e),ot()}catch{M("댓글 등록에 실패했습니다","error")}finally{Mn.value=!1}}}function d$(){const e=wn.value,t=Wt.value?"자동화 글 숨김":"자동화 글 표시 중";return o`
  ...
  `}function io(){var s;const e=((s=Zc.find(a=>a.id===wn.value))==null?void 0:s.label)??wn.value,t=ed(Ka.value),n=t.human.length+t.operations.length;return o`
  ...
  `}function Nr({post:e}){const t=async(n,s)=>{s.stopPropagation();try{await _l(e.id,n),ot()}catch{M("투표에 실패했습니다","error")}};return o`
    <div class="board-post" onClick=${()=>Sd(e.id)}>
      ...
      <div class="post-content">
        ...
        <div class="post-snippet">${i$(e.body)}</div>
      </div>
    </div>
  `}function u$({comments:e}){return e.length===0?o`<div class="empty-state" style="font-size:13px">아직 댓글이 없습니다</div>`:o`
  ...
  `}function m$({post:e}){zt.value!==e.id&&!un.value&&Hi(e.id);const t=async n=>{try{await _l(e.id,n),ot()}catch{M("Failed to vote","error")}};return o`
    <div>
      <button class="back-btn" onClick=${()=>re("memory")}>← 메모리로 돌아가기</button>
      ...
      <${T} title="댓글" semanticId="memory.feed">
        ${un.value?o`<div class="loading-indicator">댓글 불러오는 중...</div>`:o`<${u$} comments=${Js.value} />`}
        <${p$} postId=${e.id} />
      <//>
    </div>
  `}function _$(){const e=ed(Ka.value),t=[...e.human,...e.operations],n=D.value.params.post??null,s=n?t.find(a=>a.id===n)??(zt.value===n?Gs.value:null):null;return n&&!s&&zt.value!==n&&!un.value&&Hi(n),n?s?o`
          <${Se} surfaceId="memory" />
          <${io} />
          <${m$} post=${s} />
        `:o`
      ...
      ${qn.value?o`<div class="loading-indicator">메모리 피드 불러오는 중...</div>`:t.length===0?o`<div class="empty-state">지금은 남아 있는 메모리 글이 없습니다</div>`:o`
              <${T} title="사람이 쓴 글" class="section" semanticId="memory.feed">
                <div class="board-post-list">
                  ${e.human.slice(0,wt.value).map(a=>o`<${Nr} key=${a.id} post=${a} />`)}
                </div>
                ${e.human.length>wt.value?o`
                  <div style="text-align:center; padding:12px 0;">
                    <button
                      class="control-btn ghost"
                      onClick=${()=>{wt.value=wt.value+Ui}}
                    >
  ...
  `}const St=g(null),He=g(null),Be=g(null);function pn(e){return e==="bad"||e==="critical"||e==="offline"?"bad":e==="warn"||e==="paused"||e==="blocked"||e==="interrupted"?"warn":"ok"}function La(e){switch((e??"").trim().toLowerCase()){case"ok":case"healthy":case"green":return"안정";case"active":case"running":return"진행 중";case"paused":return"일시정지";case"blocked":return"막힘";case"interrupted":return"중단됨";case"warn":return"주의";case"bad":case"critical":return"위험";case"offline":return"오프라인";case"idle":case"quiet":return"대기";case"unknown":case"":return"확인 필요";default:return(e==null?void 0:e.trim())||"확인 필요"}}function f$(e){return e==="session"?"세션":"작전"}function g$(e){return typeof e!="number"||Number.isNaN(e)?"—":`${Math.round(e*100)}%`}function $$(e){return e?vt.value.find(t=>t.name===e||t.agent_name===e)??null:null}function h$(e){switch(e){case"working":return"작업 중";case"watching":return"대기 중";case"quiet":return"조용함";case"offline":return"오프라인"}}function y$(e){switch(e){case"critical":return"위험";case"warning":return"주의";default:return"정상"}}function b$(e){switch(e){case"acted":return"행동";case"passed":return"통과";case"skipped":return"건너뜀";case"failed":return"실패";default:return e}}function k$(e){switch(e){case"post":return"post";case"comment":return"comment";case"vote":return"vote";case"none":case null:case void 0:return"none";default:return e}}function Ra(e,t="없음"){const n=e??[];return n.length===0?t:n.length<=3?n.join(", "):`${n.slice(0,3).join(", ")} +${n.length-3}`}function Dr(e){if(!e)return;const t=H_({targetType:e.target_type,targetId:e.target_id,focusKind:e.focus_kind,operationId:e.operation_id??null,commandSurface:e.command_surface??null,sourceLabel:"실행 진단",summary:e.label});fc(t),re(e.surface,e.surface==="intervene"?gc(t):hc(t))}function Re({label:e,value:t,color:n,caption:s}){return o`
    <div class="stat-card">
  ...
  `}function x$({item:e,selected:t}){return o`
    <button
    ...
    >
      <div class="mission-card-head">
        ...
        <span class="command-chip ${pn(e.severity)}">${La(e.status??e.severity)}</span>
      </div>
  ...
  `}function S$({brief:e,selected:t}){return o`
    ...
    >
      <div class="mission-card-head">
        ...
        <span class="command-chip ${pn(e.health??e.status)}">${La(e.status)}</span>
      </div>
      <div class="mission-card-meta">
  ...
  `}function C$({brief:e,selected:t}){return o`
    <button
      class="mission-card-select ${t?"active":""}"
    ...
    >
      <div class="mission-card-head">
        ...
        <span class="command-chip ${pn(e.blocker_summary?"warn":e.status)}">${La(e.status)}</span>
      </div>
      <div class="mission-card-meta">
  ...
  `:o`<div class="empty-state">최근 lodge tick 기록이 없습니다.</div>`}function T$({row:e}){return o`
    <button
    ...
    >
      <div class="monitor-row-header">
        ...
        <span class="monitor-pill ${pn(e.outcome==="failed"?"bad":e.outcome==="skipped"?"warn":"ok")}">${b$(e.outcome)}</span>
      </div>
      <div class="monitor-meta">
        <span>trigger · ${e.trigger??"unknown"}</span>
        ${e.checked_at?o`<span><${G} timestamp=${e.checked_at} /></span>`:null}
        <span>action · ${k$(e.action_kind)}</span>
      ...
      <div class="monitor-footnote">
        허용 도구: ${Ra(e.allowed_tool_names)} · 사용 도구: ${Ra(e.used_tool_names)}
      </div>
  ...
  `}function Or({row:e,testId:t}){return o`
    <button class="monitor-row ${e.tone} state-${e.state}" data-testid=${t} onClick=${()=>us(e.name)}>
      <div class="monitor-row-header">
        ...
        <span class="monitor-pill ${e.tone} state-${e.state}">${h$(e.state)}</span>
      </div>
  ...
  `}function I$({row:e}){var n,s;const t=()=>{const a=$$(e.name);a&&Mc(a)};return o`
    <button class="monitor-row ${e.tone} state-${e.state}" data-testid="execution.continuity-card" onClick=${t}>
      <div class="monitor-row-header">
        ...
        <${gt} status=${e.status??"unknown"} />
        <span class="monitor-pill ${e.tone}">${y$(e.state)}</span>
      </div>
      ...
      <div class="monitor-meta">
        ...
        <span>컨텍스트 ${g$(e.context_ratio)}</span>
      </div>
      ...
      ${(((n=e.recent_tool_names)==null?void 0:n.length)??0)>0||(((s=e.allowed_tool_names)==null?void 0:s.length)??0)>0?o`<div class="monitor-footnote">
            recent tools: ${Ra(e.recent_tool_names)} · allowed: ${Ra(e.allowed_tool_names)}
          </div>`:null}
    </button>
  `}function L$(){const e=hl.value,t=yl.value,n=bl.value,s=kl.value,a=xl.value,i=Sl.value,l=vi.value,c=fi.value,p=Cl.value;St.value&&!t.some($=>$.id===St.value)&&(St.value=null),He.value&&!n.some($=>$.session_id===He.value)&&(He.value=null),Be.value&&!s.some($=>$.operation_id===Be.value)&&(Be.value=null);const m=St.value?t.find($=>$.id===St.value)??null:null,u=He.value?He.value:m?m.kind==="session"?m.target_id:m.linked_session_id??null:null,f=Be.value?Be.value:m?m.kind==="operation"?m.target_id:m.linked_operation_id??null:null,v=u?n.filter($=>$.session_id===u):f?n.filter($=>$.linked_operation_id===f):n,h=f?s.filter($=>$.operation_id===f):u?s.filter($=>{var R;return $.linked_session_id===u||$.operation_id===((R=v[0])==null?void 0:R.linked_operation_id)}):s,b=u||f?a.filter($=>(u?$.related_session_id===u:!1)||(f?$.related_operation_id===f:!1)):a,C=u?c.filter($=>$.related_session_id===u||$.tone!=="ok"):c,x=u?l.filter($=>v.some(R=>R.member_names.includes($.agent_name))):l,S=u||f?p.filter($=>(u?$.related_session_id===u:!1)||(f?$.related_operation_id===f:!1)||$.tone!=="ok"):p;return o`
    <div class="agents-monitor">
      ...
      >
        ...
        <div class="monitor-alert-list">
          ${t.length===0?o`<div class="empty-state">지금은 막힌 실행이 없습니다.</div>`:t.map($=>o`<${x$} key=${$.id} item=${$} selected=${St.value===$.id} />`)}
        </div>
      <//>
      ...
      <div class="agents-workbench">
        ...
        >
          ...
          <div class="monitor-list">
            ${v.length===0?o`<div class="empty-state">선택된 실행과 연결된 세션이 없습니다.</div>`:v.map($=>o`<${S$} key=${$.session_id} brief=${$} selected=${He.value===$.session_id} />`)}
          </div>
        <//>
        ...
        >
          ...
          <div class="monitor-list">
            ${h.length===0?o`<div class="empty-state">선택된 실행과 연결된 작전이 없습니다.</div>`:h.map($=>o`<${C$} key=${$.operation_id} brief=${$} selected=${Be.value===$.operation_id} />`)}
          </div>
        <//>
        ...
        >
          ...
          <${A$} tick=${i} />
          <div class="monitor-list">
            ${x.length===0?o`<div class="empty-state">최근 lodge check-in 기록이 없습니다.</div>`:x.map($=>o`<${T$} key=${`${$.agent_name}-${$.checked_at??$.outcome}`} row=${$} />`)}
          </div>
        <//>
        ...
        >
          ...
          <div class="monitor-list">
            ${b.length===0?o`<div class="empty-state">연결된 작업자가 없습니다.</div>`:b.map($=>o`<${Or} key=${$.name} row=${$} testId="execution.worker-card" />`)}
          </div>
        <//>
        ...
        >
          ...
          <div class="monitor-list">
            ${C.length===0?o`<div class="empty-state">지금은 연속성 경고가 없습니다.</div>`:C.map($=>o`<${I$} key=${$.name} row=${$} />`)}
          </div>
        <//>
        ...
        >
          ...
          <div class="monitor-list">
            ${S.length===0?o`<div class="empty-state">지금은 오프라인 작업자가 없습니다.</div>`:S.map($=>o`<${Or} key=${$.name} row=${$} testId="execution.offline-worker-card" />`)}
          </div>
        <//>
      </div>
    </div>
  `}const ei=g(null),ti=g(null),jn=g(!1);async function wr(){if(!jn.value){jn.value=!0,ti.value=null;try{ei.value=await tu()}catch(e){ti.value=e instanceof Error?e.message:String(e)}finally{jn.value=!1}}}function R$(e){switch(e){case"essential":return"badge-essential";case"standard":return"badge-standard";default:return"badge-full"}}function z$({items:e,maxCount:t}){return e.length===0?o`<p class="muted">No tool calls recorded yet.</p>`:o`
  ...
  `}function P$({dist:e}){const t=e.full,n=t>0?(e.essential/t*100).toFixed(1):"0",s=t>0?(e.standard/t*100).toFixed(1):"0",a=t-e.standard,i=t>0?(a/t*100).toFixed(1):"0";return o`
    <div class="tier-dist">
  ...
  `}function M$(){const e=ei.value,t=jn.value,n=ti.value;return ae(()=>{!ei.value&&!jn.value&&wr()},[]),o`
  ...
  `}const ni=g(null),si=g(null),En=g(!1),kn=g(""),Ls=g("all"),ro=g(!1),lo=g(!1),co=g(!0),uo=g(!0);async function qr(){if(!En.value){En.value=!0,si.value=null;try{ni.value=await nu()}catch(e){si.value=e instanceof Error?e.message:String(e)}finally{En.value=!1}}}function j$(e,t){const n=t.trim().toLowerCase();return n?[e.name,e.description,e.category,e.required_permission??"",e.visibility,e.lifecycle,e.implementationStatus,e.tier,e.canonicalName??"",e.replacement??"",e.reason??"",...e.doc_refs,...e.prompt_hints].join(" ").toLowerCase().includes(n):!0}function Rs(e,t="default"){return o`
    <span
    ...
    <article class="tool-inventory-row">
      <div class="tool-inventory-head">
        ...
        <div class="tool-inventory-badges">
          ${Rs(e.tier,e.tier==="essential"?"ok":e.tier==="standard"?"warn":"default")}
          ${Rs(e.visibility)}
          ${Rs(e.lifecycle,e.lifecycle==="deprecated"?"warn":"default")}
          ${Rs(e.implementationStatus)}
        </div>
      </div>
  ...
  `}function N$(){const e=ni.value,t=En.value,n=si.value,s=(e==null?void 0:e.tool_inventory.tools)??[],a=(e==null?void 0:e.tool_usage)??null;ae(()=>{!ni.value&&!En.value&&qr()},[]),ae(()=>{var h;if(D.value.tab!=="tools")return;const v=(h=D.value.params.q)==null?void 0:h.trim();v&&v!==kn.value&&(kn.value=v)},[D.value.tab,D.value.params.q]);const i=Array.from(new Set(s.map(v=>v.category))).sort((v,h)=>v.localeCompare(h)),l=s.filter(v=>!(!j$(v,kn.value)||Ls.value!=="all"&&v.category!==Ls.value||ro.value&&!v.enabled_in_current_mode||lo.value&&!v.direct_call_allowed||!co.value&&v.visibility==="hidden"||!uo.value&&v.lifecycle==="deprecated")),c=s.length,p=s.filter(v=>v.enabled_in_current_mode).length,m=s.filter(v=>v.visibility==="hidden").length,u=s.filter(v=>v.lifecycle==="deprecated").length,f=s.filter(v=>v.direct_call_allowed).length;return o`
    <div>
      <${T} title="System Tool Inventory" class="section">
        ...
        <div class="tool-inventory-filters">
          ...
          <select
            ...
            value=${Ls.value}
            onChange=${v=>{Ls.value=v.target.value}}
          >
          ...
          <label class="tool-inventory-toggle">
            <input
              type="checkbox"
              checked=${ro.value}
              onChange=${v=>{ro.value=v.target.checked}}
            />
          ...
          <label class="tool-inventory-toggle">
            <input
              type="checkbox"
              checked=${lo.value}
              onChange=${v=>{lo.value=v.target.checked}}
            />
          ...
          <label class="tool-inventory-toggle">
            <input
              type="checkbox"
              checked=${co.value}
              onChange=${v=>{co.value=v.target.checked}}
            />
          ...
          <label class="tool-inventory-toggle">
            <input
              type="checkbox"
              checked=${uo.value}
              onChange=${v=>{uo.value=v.target.checked}}
            />
        ...
        <div class="tool-inventory-list">
          ${l.length>0?l.map(v=>o`<${E$} key=${v.name} item=${v} />`):o`<div class="empty-state">No tools matched the current filters.</div>`}
        </div>
      <//>
  ...
  `}const za=g("all"),Pa=g("all"),ai=g(new Set);function D$(e){const t=new Set(ai.value);t.has(e)?t.delete(e):t.add(e),ai.value=t}const td=ze(()=>{let e=Vt.value;return za.value!=="all"&&(e=e.filter(t=>t.horizon===za.value)),Pa.value!=="all"&&(e=e.filter(t=>t.status===Pa.value)),e}),O$=ze(()=>{const e={short:[],mid:[],long:[]};for(const t of td.value){const n=e[t.horizon];n&&n.push(t)}return e}),w$=ze(()=>{const e=Array.from(Tl.value.values());return e.sort((t,n)=>t.status==="running"&&n.status!=="running"?-1:n.status==="running"&&t.status!=="running"?1:t.status==="interrupted"&&n.status!=="interrupted"?-1:n.status==="interrupted"&&t.status!=="interrupted"?1:n.elapsed_seconds-t.elapsed_seconds),e});function q$(e){return"★".repeat(Math.min(e,5))+"☆".repeat(Math.max(0,5-e))}function Wi(e){switch(e){case"short":return"단기";case"mid":return"중기";case"long":return"장기";default:return e}}function Vs(e){switch(e){case"short":return"#4ade80";case"mid":return"#f59e0b";case"long":return"#818cf8";default:return"#888"}}function F$(e){return e<60?`${Math.round(e)}s`:e<3600?`${Math.floor(e/60)}m ${Math.round(e%60)}s`:`${Math.floor(e/3600)}h ${Math.floor(e%3600/60)}m`}function Fr(e){return e.toFixed(4)}function Kr(e){const t=e.current_metric-e.baseline_metric;return`${t>=0?"+":""}${t.toFixed(4)}`}function K$(e){switch(e){case 1:return"P1";case 2:return"P2";case 3:return"P3";default:return"P4"}}function U$(e){switch(e){case"active":return"진행 중";case"completed":return"완료";case"paused":return"일시정지";default:return"전체"}}function Ur(e,t){return(e.priority??4)-(t.priority??4)}function H$(e,t){const n=e.updated_at??e.created_at??"";return(t.updated_at??t.created_at??"").localeCompare(n)}function B$(e,t){return e.length<=t?e:e.slice(0,t)+"..."}function W$({goal:e}){return o`
    <div class="goal-row">
      <div class="goal-row-main">
        ...
        <div class="goal-meta">
          <span class="goal-priority" title="Priority ${e.priority}">${q$(e.priority)}</span>
  ...
  `}function po({horizon:e,items:t}){if(t.length===0)return null;const n=[...t].sort((s,a)=>a.priority-s.priority);return o`
    <${T} title="${Wi(e)} 목표 (${t.length})" class="section" semanticId="planning.goal_pipeline">
      <div class="goal-list">
        ${n.map(s=>o`<${W$} key=${s.id} goal=${s} />`)}
      </div>
    <//>
  `}function G$(){return o`
  ...
  `}function J$(){const e=Vt.value,t=e.filter(a=>a.status==="active").length,n=e.filter(a=>a.status==="completed").length,s={short:0,mid:0,long:0};for(const a of e)a.horizon in s&&s[a.horizon]++;return o`
  ...
  `}function V$({loop:e}){const t=e.history[0],n=e.latest_tool_names&&e.latest_tool_names.length>0?`${e.latest_tool_call_count??e.latest_tool_names.length}개 도구: ${e.latest_tool_names.join(", ")}`:"아직 근거 없음";return o`
    <div class="planning-loop-row">
      <div class="planning-loop-main">
        ...
        <div class="planning-loop-metrics">
          ...
          <span>Elapsed ${F$(e.elapsed_seconds)}</span>
        </div>
  ...
  `}function mo({task:e}){const t=e.priority??4,n=t<=1?"p1":t===2?"p2":t===3?"p3":"p4",s=ai.value.has(e.id),a=!!e.description;return o`
    <div class="kanban-card ${n}">
      <div class="kanban-card-header">
        <span class="priority-badge priority-badge--${n}">${K$(t)}</span>
      ...
      ${a?o`
        <div
          ...
          onClick=${()=>D$(e.id)}
        >
          ${s?e.description:B$(e.description??"",80)}
        </div>
      `:null}
  ...
  `}function Q$(){const{todo:e,inProgress:t,done:n}=Ll.value,s=[...e].sort(Ur),a=[...t].sort(Ur),i=[...n].sort(H$);return o`
  ...
  `}function Y$(){const{todo:e,inProgress:t,done:n}=Ll.value,s=e.length+t.length+n.length,a=[...e,...t].filter(u=>(u.priority??4)<=2).length,i=O$.value,l=w$.value,c=Vt.value.length>0,p=l.length>0,m=gi.value;return o`
    <div>
        ...
        <div>
          ${Tn.value&&l.length===0?o`<div class="loading-indicator">MDAL 루프 불러오는 중...</div>`:l.length===0&&(m==="error"||Qt.value)?o`<div class="empty-state">MDAL 스냅샷을 불러오지 못했습니다${Qt.value?`: ${Qt.value}`:""}. 백엔드 상태를 확인하세요.</div>`:l.length===0?o`<div class="empty-state">가동 중인 루프가 없습니다. <code>masc_mdal_start</code>로 시작할 수 있습니다.</div>`:o`
                  <div class="planning-loop-list">
                    ${l.map(u=>o`<${V$} key=${u.loop_id} loop=${u} />`)}
                  </div>
                `}
        </div>
      </details>
    </div>
  `}const Ma=g(!1),Nn=g(!1),Gt=g(!1),mt=g(""),Dn=g(""),oi=g("open"),Oe=g(null),ts=g(null),ja=g(null),Ea=g(null),ii=g(!1);function ns(e){return`${e.kind}:${e.id}`}function Gi(){var n;const e=ts.value,t=((n=Oe.value)==null?void 0:n.items)??[];return e?t.find(s=>ns(s)===e)??null:null}function X$(){const e=new URLSearchParams(window.location.search),t=e.get("agent")??e.get("agent_name");return(t==null?void 0:t.trim())||"dashboard"}function Z$(e){const t=e.trim().toLowerCase();return t==="open"||t==="pending"}function nd(e){return!!(e.judgment_summary&&e.judgment_summary.trim())}function sd(e){switch(oi.value){case"needs_quorum":return e.filter(t=>t.kind==="consensus"&&(t.votes??0)<(t.quorum??0));case"ready":return e.filter(t=>{var n;return(n=t.guardrail_state)==null?void 0:n.ready_to_execute});case"needs_approval":return e.filter(t=>{var n,s;return((n=t.guardrail_state)==null?void 0:n.requires_human_gate)||!!((s=t.guardrail_state)!=null&&s.pending_confirm)});case"judge_offline":return e.filter(t=>!nd(t));case"open":default:return e.filter(t=>Z$(t.status))}}function eh(e){if(e==null)return"없음";if(typeof e=="string")return e;try{return JSON.stringify(e,null,2)}catch{return String(e)}}function Ga(e){const t=(e||"").toLowerCase();return t.includes("reject")||t.includes("deny")||t.includes("closed")||t.includes("cancel")?"negative":t.includes("approve")||t.includes("support")||t.includes("open")||t.includes("ready")?"positive":"neutral"}function th(e){return typeof e!="number"||Number.isNaN(e)?"확인 필요":`${Math.round(e*100)}%`}function xn(e){return"resolved_tool"in e||"payload_preview"in e||"reason"in e}async function ad(e){if(ja.value=null,Ea.value=null,!!e){ii.value=!0,mt.value="";try{e.kind==="debate"?ja.value=await Ju(e.id):Ea.value=await Vu(e.id)}catch(t){mt.value=t instanceof Error?t.message:"거버넌스 상세를 불러오지 못했습니다"}finally{ii.value=!1}}}async function nh(e){ts.value=ns(e),await ad(e)}async function mn(){var e;Ma.value=!0,mt.value="";try{const t=await Jd();Oe.value=t;const n=sd(t.items??[]),s=ts.value,a=n.find(i=>ns(i)===s)??n[0]??((e=t.items)==null?void 0:e[0])??null;ts.value=a?ns(a):null,await ad(a)}catch(t){mt.value=t instanceof Error?t.message:"거버넌스 상태를 불러오지 못했습니다"}finally{Ma.value=!1}}Qp(mn);async function Hr(){const e=Dn.value.trim();if(e){Nn.value=!0;try{const t=await Gu(e);Dn.value="",M(t!=null&&t.id?`토론을 시작했습니다: ${t.id}`:"토론을 시작했습니다","success"),await mn()}catch(t){const n=t instanceof Error?t.message:"토론 시작에 실패했습니다";mt.value=n,M(n,"error")}finally{Nn.value=!1}}}async function Br(e){var i,l;const t=Gi(),n=(i=t==null?void 0:t.guardrail_state)==null?void 0:i.pending_confirm,s=n==null?void 0:n.confirm_token;if(!s)return;const a=((l=n==null?void 0:n.actor)==null?void 0:l.trim())||X$();Gt.value=!0;try{await ll(a,s,e),M(e==="confirm"?"액션을 승인했습니다":"액션을 거부했습니다","success"),await mn()}catch(c){const p=c instanceof Error?c.message:"대기 중인 액션 처리에 실패했습니다";mt.value=p,M(p,"error")}finally{Gt.value=!1}}function sh(){var n,s,a,i,l,c;const e=(n=Oe.value)==null?void 0:n.summary,t=(s=Oe.value)==null?void 0:s.judge;return o`
    <div class="board-summary-strip">
      <div class="board-summary-item">
  ...
  `}function oh(){var t;const e=sd(((t=Oe.value)==null?void 0:t.items)??[]);return o`
  ...
  `}function ih({argument:e}){return o`
  ...
  `}function lh(){const e=Gi(),t=ja.value,n=Ea.value;return o`
    <${T}
    ...
    >
      ${ii.value?o`<div class="loading-indicator">거버넌스 상세 불러오는 중...</div>`:e?e.kind==="debate"&&t?o`
                ...
                <div class="governance-ledger">
                  ${t.arguments.length===0?o`<div class="empty-state">기록된 토론이 아직 없습니다.</div>`:t.arguments.map(s=>o`<${ih} key=${s.index} argument=${s} />`)}
                </div>
              `:e.kind==="consensus"&&n?o`
                  ...
                  <div class="governance-ledger">
                    ${n.votes.length===0?o`<div class="empty-state">기록된 표결이 아직 없습니다.</div>`:n.votes.map(s=>o`<${rh} key=${s.agent+s.timestamp} vote=${s} />`)}
                  </div>
  ...
  `}function Wr({title:e,route:t}){if(!t)return null;const n=xn(t)?t.resolved_tool:t.delegated_tool,s=xn(t)?t.target_type:null,a=xn(t)?t.target_id:null,i=xn(t)?t.reason:null,l=xn(t)?t.payload_preview:null;return o`
    <div class="governance-side-block">
      ...
      ${l?o`<pre class="council-detail governance-preview">${eh(l)}</pre>`:null}
    </div>
  `}function ch(){var c,p,m;const e=Gi(),t=ja.value,n=Ea.value,s=(t==null?void 0:t.context)??(n==null?void 0:n.context)??(e==null?void 0:e.context),a=(t==null?void 0:t.judgment)??(n==null?void 0:n.judgment),i=e==null?void 0:e.guardrail_state,l=(c=Oe.value)==null?void 0:c.judge;return o`
    <div class="governance-side-column">
      ...
      <${T} title="최근 활동" class="section" semanticId="governance.activity">
        <div class="governance-activity-list">
          ${(((p=Oe.value)==null?void 0:p.activity)??[]).slice(0,8).map(u=>o`
          ...
          `)}
          ${(((m=Oe.value)==null?void 0:m.activity)??[]).length===0?o`<div class="empty-state">기록된 거버넌스 활동이 없습니다.</div>`:null}
        </div>
      <//>
    </div>
  `}function dh(){return ae(()=>{mn()},[]),o`
    <div>
  ...
  `}const qt=g(""),_o=g("ability_check"),vo=g("10"),fo=g("12"),zs=g(""),Ps=g("idle"),et=g(""),Ms=g("keeper-late"),go=g("player"),$o=g(""),Ae=g("idle"),ho=g(null),js=g(""),yo=g(""),bo=g("player"),ko=g(""),xo=g(""),So=g(""),On=g("20"),Co=g("20"),Ao=g(""),Es=g("idle"),ri=g(null),od=g("overview"),To=g("all"),Io=g("all"),Lo=g("all"),uh=12e4,Ja=g(null),Gr=g(Date.now());function ph(e,t){const n=t>0?e/t*100:0;return n>50?"hp-high":n>25?"hp-mid":"hp-low"}function mh(e,t){return t>0?Math.round(e/t*100):0}const _h={pragmatic:"리스크보다 확실한 이득을 우선합니다.",frugal:"자원 소모를 줄이고 효율을 챙깁니다.",impatient:"짧은 템포로 즉시 압박을 선호합니다.",stubborn:"한 번 정한 전술을 끝까지 밀어붙입니다.",protective:"아군 피해를 줄이는 선택을 우선합니다.","honor-bound":"약속과 규율을 지키는 행동에 보너스가 납니다.",intense:"집중 화력을 짧게 폭발시킵니다.",empathetic:"아군/약자 보호 쪽 선택 확률이 높아집니다.",fatalistic:"위험을 감수하는 고배수 선택을 탑니다.",suspicious:"함정/매복 경계 행동을 우선합니다.",precise:"단일 목표를 정확히 노리는 경향입니다.",vengeful:"직전 위협 대상에게 강하게 반응합니다.",aggressive:"공격적인 전진 행동을 우선합니다.",opportunistic:"빈틈이 열리면 즉시 추격합니다."},vh={supply_scan:"전장/자원 상태를 스캔해 약한 지점을 찾습니다.",ration_shift:"소모를 줄이고 지속 전투 능력을 확보합니다.",logistics_patch:"무너진 운영 라인을 빠르게 복구합니다.",frontline_shield:"전열에서 아군 피해를 흡수합니다.",oath_intercept:"핵심 타깃을 가로막아 위협을 차단합니다.",morale_anchor:"아군 안정도를 높여 붕괴를 막습니다.",omen_trace:"다음 위험 신호를 먼저 감지합니다.",arc_flash:"짧은 순간 광역 압박을 넣습니다.",ward_bloom:"방어 장막을 펼쳐 생존률을 올립니다.",mark_prey:"우선 제거 대상을 지정합니다.",silent_route:"은밀한 진입 경로를 확보합니다.",finisher_strike:"약화된 적을 마무리하는 일격입니다.",shadow_claw:"근접 급습으로 출혈 피해를 노립니다.",lunge:"짧은 돌진으로 전열을 흔듭니다."};function Ns(e){const t=e.trim();return t?t.split(/[_-]+/g).filter(n=>n.length>0).map(n=>n[0]?`${n[0].toUpperCase()}${n.slice(1)}`:n).join(" "):e}function fh(e){const t=e.trim().toLowerCase();return _h[t]??"행동 선택 가중치에 영향을 주는 성향입니다."}function gh(e){const t=e.trim().toLowerCase();return vh[t]??"상황에 따라 선택되는 전술 액션입니다."}function be(e,t,n=""){const s=e[t];return typeof s=="string"?s:n}function Ee(e,t,n=0){const s=e[t];return typeof s=="number"&&Number.isFinite(s)?s:n}function ss(e,t,n=!1){const s=e[t];return typeof s=="boolean"?s:n}const $h=new Set(["str","dex","con","int","wis","cha"]);function hh(e){const t=e.trim();if(!t)return{};let n;try{n=JSON.parse(t)}catch(a){throw new Error(`능력치 JSON 파싱 실패: ${a instanceof Error?a.message:"invalid json"}`)}if(!_(n))throw new Error('능력치 JSON은 object여야 합니다. 예: {"luck":7}');const s={};return Object.entries(n).forEach(([a,i])=>{const l=a.trim();if(l){if(typeof i=="number"&&Number.isFinite(i)){s[l]=Math.max(0,Math.trunc(i));return}if(typeof i=="string"){const c=Number.parseFloat(i.trim());if(Number.isFinite(c)){s[l]=Math.max(0,Math.trunc(c));return}}throw new Error(`능력치 '${l}' 값은 숫자여야 합니다.`)}}),s}function yh(e){const t=Number.parseInt(e.trim(),10);if(!Number.isFinite(t))return;const n=Math.max(1,t),s=Number.parseInt(On.value.trim(),10);Number.isFinite(s)&&s>n&&(On.value=String(n))}function li(e){const n=(e.actor_name??e.actor??e.actor_id??"system").trim();return n===""?"system":n}function bh(e){var n;return(((n=e.timestamp)==null?void 0:n.trim())??"")||"-"}function kh(e){od.value=e}function id(e){const t=Ja.value;return t==null||t<=e}function xh(e){const t=Ja.value;return t==null||t<=e?0:Math.max(0,Math.ceil((t-e)/1e3))}function Na(){Ja.value=null}function rd(e){return typeof window>"u"||typeof window.confirm!="function"?!0:window.confirm(e)}function Sh(e,t){rd(["관전 모드 잠금을 해제하시겠습니까?",`ROOM: ${e||"-"}`,`PHASE: ${t||"-"}`,"해제 시간: 120초 (시간 경과 또는 위험 액션 실행 후 자동 재잠금)"].join(`
`))&&(Ja.value=Date.now()+uh,M("조작 잠금이 120초 동안 해제되었습니다.","warning"))}function Qs(e){return id(e)?(M("관전 모드 잠금 상태입니다. 먼저 잠금을 해제하세요.","warning"),!1):!0}function ci(e,t,n){return rd([`[위험 액션 확인] ${e}`,`ROOM: ${t||"-"}`,`PHASE: ${n||"-"}`,"이 액션은 즉시 실행되며 되돌리기 어렵습니다.","계속 진행하시겠습니까?"].join(`
`))}function Ch({hp:e,max:t}){const n=mh(e,t),s=ph(e,t);return o`
    <div class="trpg-hp-bar">
      <div class="hp-fill ${s}" style="width:${n}%" />
    </div>
  `}function Ah({stats:e}){const t=[{label:"STR",value:e.strength},{label:"DEX",value:e.dexterity},{label:"CON",value:e.constitution},{label:"INT",value:e.intelligence},{label:"WIS",value:e.wisdom},{label:"CHA",value:e.charisma}];return o`
    <div class="trpg-actor-stats">
      ${t.map(n=>o`<span>${n.label} ${n.value}</span>`)}
    </div>
  `}function Th({keeper:e,role:t}){if(!e)return null;const n=t==="dm"?"dm":"player";return o`
    <span class="trpg-keeper-chip">
      <span class="trpg-keeper-tag ${n}">${n}</span>
      ${e}
    </span>
  `}function ld({actor:e}){var p,m,u,f;const t=(p=e.archetype)==null?void 0:p.trim(),n=(m=e.persona)==null?void 0:m.trim(),s=(u=e.portrait)==null?void 0:u.trim(),a=(f=e.background)==null?void 0:f.trim(),i=e.traits??[],l=e.skills??[],c=Object.entries(e.stats_raw??{}).filter(([v,h])=>Number.isFinite(h)).filter(([v])=>!$h.has(v.toLowerCase()));return o`
    <div class="trpg-actor">
      ...
      <div class="trpg-actor-header">
        ...
        <${Th} keeper=${e.keeper} role=${e.role} />
      </div>
      ${e.stats?o`
          <div style="margin-top:4px;">
            ...
            <${Ch} hp=${e.stats.hp} max=${e.stats.max_hp} />
            <${Ah} stats=${e.stats} />
          </div>
        `:null}
      ...
      ${c.length>0?o`
          <div class="trpg-annot-group">
            ...
            <div class="trpg-custom-stats">
              ${c.map(([v,h])=>o`
                <span class="trpg-custom-stat-chip">${Ns(v)} ${h}</span>
              `)}
            </div>
          </div>
        `:null}
            ...
            <div class="trpg-annot-list">
              ${i.map(v=>o`
                <span class="trpg-annot-chip trait">
                  <span class="trpg-annot-name">${Ns(v)}</span>
                  <span class="trpg-annot-desc">${fh(v)}</span>
                </span>
              `)}
            </div>
          </div>
            ...
            <div class="trpg-annot-list">
              ${l.map(v=>o`
                <span class="trpg-annot-chip skill">
                  <span class="trpg-annot-name">${Ns(v)}</span>
                  <span class="trpg-annot-desc">${gh(v)}</span>
                </span>
              `)}
            </div>
          </div>
  ...
  `}function Ih({mapStr:e}){return o`<pre class="trpg-map">${e}</pre>`}function cd({events:e,emptyLabel:t="아직 이벤트가 없습니다."}){return e.length===0?o`<div class="empty-state" style="font-size:13px">${t}</div>`:o`
    <div class="trpg-story" role="list" aria-label="TRPG story events">
      ${e.map((n,s)=>{var a;return o`
        <div key=${s} class="trpg-event ${n.type??""}" role="listitem">
          <div class="trpg-event-meta-row">
            <span class="trpg-event-meta">${bh(n)}</span>
  ...
  `}function Lh({events:e}){const t="__none__",n=To.value,s=Io.value,a=Lo.value,i=Array.from(new Set(e.map(li).map(f=>f.trim()).filter(f=>f!==""))).sort((f,v)=>f.localeCompare(v)),l=Array.from(new Set(e.map(f=>(f.type??"").trim()).filter(f=>f!==""))).sort((f,v)=>f.localeCompare(v)),c=e.some(f=>(f.type??"").trim()===""),p=Array.from(new Set(e.map(f=>(f.phase??"").trim()).filter(f=>f!==""))).sort((f,v)=>f.localeCompare(v)),m=e.some(f=>(f.phase??"").trim()===""),u=e.filter(f=>{if(n!=="all"&&li(f)!==n)return!1;const v=(f.type??"").trim(),h=(f.phase??"").trim();if(s===t){if(v!=="")return!1}else if(s!=="all"&&v!==s)return!1;if(a===t){if(h!=="")return!1}else if(a!=="all"&&h!==a)return!1;return!0});return o`
    <div class="trpg-story-toolbar">
      ...
      <div class="trpg-story-filter">
        <label>Phase</label>
        <select value=${a} onChange=${f=>{Lo.value=f.target.value}}>
          <option value="all">all</option>
      ...
      <button
        ...
        onClick=${()=>{To.value="all",Io.value="all",Lo.value="all"}}
      >
        필터 초기화
      </button>
  ...
  `}function zh({state:e,nowMs:t}){var m;const n=Je.value||((m=e.session)==null?void 0:m.room)||"",s=Ps.value,a=e.party??[];if(!a.find(u=>u.id===qt.value)&&a.length>0){const u=a[0];u&&(qt.value=u.id)}const l=async()=>{var f,v;if(!n){M("Room ID가 비어 있습니다.","error");return}if(!Qs(t))return;const u=((f=e.current_round)==null?void 0:f.phase)??((v=e.session)==null?void 0:v.status)??"unknown";if(ci("라운드 실행",n,u)){Ps.value="running";try{const h=await Nu(n);ri.value=h,Ps.value="ok";const b=_(h.summary)?h.summary:null,C=b?ss(b,"advanced",!1):!1,x=b?be(b,"progress_reason",""):"";M(C?"라운드가 정상 진행되었습니다.":`라운드가 정체되었습니다${x?`: ${x}`:""}`,C?"success":"warning"),it()}catch(h){ri.value=null,Ps.value="error";const b=h instanceof Error?h.message:"라운드 실행에 실패했습니다.";M(b,"error")}finally{Na()}}},c=async()=>{var f,v;if(!n||!Qs(t))return;const u=((f=e.current_round)==null?void 0:f.phase)??((v=e.session)==null?void 0:v.status)??"unknown";if(ci("턴 강제 진행",n,u))try{await wu(n),M("턴을 다음 단계로 이동했습니다.","success"),it()}catch{M("턴 이동에 실패했습니다.","error")}finally{Na()}},p=async()=>{if(!n||!Qs(t))return;const u=qt.value.trim();if(!u){M("먼저 Actor를 선택하세요.","warning");return}const f=Number.parseInt(vo.value,10),v=Number.parseInt(fo.value,10);if(Number.isNaN(f)||Number.isNaN(v)){M("stat/dc는 숫자여야 합니다.","warning");return}const h=Number.parseInt(zs.value,10),b=zs.value.trim()===""||Number.isNaN(h)?void 0:h;try{await Ou({roomId:n,actorId:u,action:_o.value.trim()||"ability_check",statValue:f,dc:v,rawD20:b}),M("주사위 판정을 기록했습니다.","success"),it()}catch{M("주사위 판정 기록에 실패했습니다.","error")}};return o`
  ...
  `}function Ph({state:e}){var a;const t=Je.value||((a=e.session)==null?void 0:a.room)||"",n=Es.value,s=async()=>{if(!t){M("Room ID가 비어 있습니다.","warning");return}const i=js.value.trim(),l=yo.value.trim();if(!l&&!i){M("이름 또는 Actor ID를 입력하세요.","warning");return}const c=Number.parseInt(On.value.trim(),10),p=Number.parseInt(Co.value.trim(),10),m=Number.isFinite(p)?Math.max(1,p):20,u=Number.isFinite(c)?Math.max(0,Math.min(m,c)):m;let f={};try{f=hh(Ao.value)}catch(v){M(v instanceof Error?v.message:"능력치 JSON 오류","error");return}Es.value="spawning";try{const v=typeof crypto<"u"&&typeof crypto.randomUUID=="function"?`trpg_spawn_${crypto.randomUUID()}`:`trpg_spawn_${Date.now().toString(36)}_${Math.random().toString(36).slice(2,10)}`,h=await qu(t,{actor_id:i||void 0,name:l||void 0,role:bo.value,idempotencyKey:v,portrait:xo.value.trim()||void 0,background:So.value.trim()||void 0,hp:u,max_hp:m,alive:u>0,stats:Object.keys(f).length>0?f:void 0}),b=typeof h.actor_id=="string"?h.actor_id.trim():"";if(!b)throw new Error("생성 응답에 actor_id가 없습니다.");const C=ko.value.trim();C&&await Fu(t,b,C),qt.value=b,et.value=b,i||(js.value=""),Es.value="ok",M(`Actor 생성 완료: ${b}`,"success"),await it()}catch(v){Es.value="error",M(v instanceof Error?v.message:"Actor 생성에 실패했습니다.","error")}};return o`
    <div class="trpg-control-box">
      <div class="trpg-control-grid">
        <div class="trpg-control-field">
          <label>Name</label>
        ...
        <div class="trpg-control-grid">
          ...
          <div class="trpg-control-field">
            ...
            <input
              ...
              min="0"
              value=${On.value}
              onInput=${i=>{On.value=i.target.value}}
              placeholder="20"
            />
          </div>
          <div class="trpg-control-field">
            ...
            <input
              ...
              min="1"
              value=${Co.value}
              onInput=${i=>{const l=i.target.value;Co.value=l,yh(l)}}
              placeholder="20"
            />
          </div>
  ...
  `}function Mh({state:e,nowMs:t}){var v;const n=Je.value||((v=e.session)==null?void 0:v.room)||"",s=e.join_gate,a=ho.value,i=_(a)?a:null,l=(e.party??[]).filter(h=>h.role!=="dm"),c=et.value.trim(),p=l.some(h=>h.id===c),m=p?c:c?"__manual__":"",u=async()=>{const h=et.value.trim(),b=Ms.value.trim();if(!n||!h){M("Room/Actor가 필요합니다.","warning");return}Ae.value="checking";try{const C=await Ku(n,h,b||void 0);ho.value=C,Ae.value="ok",M("참가 가능 여부를 갱신했습니다.","success")}catch(C){Ae.value="error";const x=C instanceof Error?C.message:"참가 가능 여부 확인에 실패했습니다.";M(x,"error")}},f=async()=>{var S,$;const h=et.value.trim(),b=Ms.value.trim(),C=$o.value.trim();if(!n||!h||!b){M("Room/Actor/Keeper가 필요합니다.","warning");return}if(!Qs(t))return;const x=((S=e.current_round)==null?void 0:S.phase)??(($=e.session)==null?void 0:$.status)??"unknown";if(ci("Mid-Join 승인 요청",n,x)){Ae.value="requesting";try{const R=await Uu({room_id:n,actor_id:h,keeper_name:b,role:go.value,...C?{name:C}:{}});ho.value=R;const L=_(R)?ss(R,"granted",!1):!1,z=_(R)?be(R,"reason_code",""):"";L?M("Mid-Join이 승인되었습니다.","success"):M(`Mid-Join이 거절되었습니다${z?`: ${z}`:""}`,"warning"),Ae.value=L?"ok":"error",it()}catch(R){Ae.value="error";const L=R instanceof Error?R.message:"Mid-Join 요청에 실패했습니다.";M(L,"error")}finally{Na()}}};return o`
    <div class="trpg-control-box">
  ...
  `:null}function md(){const e=ri.value;if(!e)return o`<div class="empty-state" style="font-size:13px;">Run Round 결과가 아직 없습니다.</div>`;const t=e.summary,n=_(t)?t:null,a=(Array.isArray(e.statuses)?e.statuses:[]).filter(_).slice(-8),i=e.canon_check,l=_(i)?i:null,c=l&&Array.isArray(l.warnings)?l.warnings.filter(z=>typeof z=="string").slice(0,3):[],p=l&&Array.isArray(l.violations)?l.violations.filter(z=>typeof z=="string").slice(0,3):[],m=n?ss(n,"advanced",!1):!1,u=n?be(n,"progress_reason",""):"",f=n?be(n,"progress_detail",""):"",v=n?Ee(n,"player_successes",0):0,h=n?Ee(n,"player_required_successes",0):0,b=n?ss(n,"dm_success",!1):!1,C=n?Ee(n,"timeouts",0):0,x=n?Ee(n,"unavailable",0):0,S=n?Ee(n,"reprompts",0):0,$=n?Ee(n,"npc_attacks",0):0,R=n?Ee(n,"keeper_timeout_sec",0):0,L=n?Ee(n,"roll_audit_count",0):0;return o`
    <div style="display:grid; gap:10px;">
      ...
      ${a.length>0?o`
          <div class="trpg-round-list">
            ${a.map(z=>{const q=be(z,"status","unknown"),I=be(z,"actor_id","-"),Q=be(z,"role","-"),ee=be(z,"reason",""),oe=be(z,"action_type",""),W=be(z,"reply","");return o`
                <div class="trpg-round-item ${q.includes("fallback")||q.includes("timeout")?"failed":"active"}">
                  ...
                  ${ee?o`<div style="width:100%; font-size:11px; color:#9ca3af; margin-top:2px;">reason: ${ee}</div>`:null}
  ...
  `}function jh({state:e,nowMs:t}){var l,c,p;const n=Je.value||((l=e.session)==null?void 0:l.room)||"",s=((c=e.current_round)==null?void 0:c.phase)??((p=e.session)==null?void 0:p.status)??"unknown",a=id(t),i=xh(t);return o`
    <${T} title="조작 안전 잠금" style="margin-bottom:16px;" semanticId="lab.trpg">
      <div class="trpg-control-lock ${a?"locked":"unlocked"}">
        ...
        <div style="display:flex; gap:8px; margin-top:10px; flex-wrap:wrap;">
          ${a?o`<button class="trpg-run-btn recommend" onClick=${()=>Sh(n,s)}>잠금 해제 (120초)</button>`:o`<button class="trpg-run-btn secondary" onClick=${()=>{Na(),M("조작 잠금으로 전환했습니다.","success")}}>즉시 다시 잠금</button>`}
        </div>
      </div>
    <//>
  `}function Eh({active:e}){return o`
  ...
  `}function Nh({state:e}){const t=e.party??[],n=e.story_log??[];return o`
  ...
  `}function Dh({state:e}){const t=e.story_log??[];return o`
    <div class="trpg-layout">
      <div>
  ...
  `}function Oh({state:e,nowMs:t}){const n=e.party??[];return o`
    <div>
      <${jh} state=${e} nowMs=${t} />
      <div class="trpg-layout">
        <div>
  ...
  `}function wh(){var c,p,m,u,f;const e=Al.value,t=Fo.value;if(ae(()=>{if(typeof window>"u"||typeof window.setInterval!="function")return;const v=window.setInterval(()=>{Gr.value=Date.now()},1e3);return()=>{window.clearInterval(v)}},[]),t&&!e)return o`<div class="loading-indicator">Loading TRPG state...</div>`;if(!e)return o`
      <div class="section">
        <h2>TRPG</h2>
    ...
    <div>
      ...
      ${i==="overview"?o`<${Nh} state=${e} />`:i==="timeline"?o`<${Dh} state=${e} />`:o`<${Oh} state=${e} nowMs=${l} />`}
    </div>
  ...
  `}const Da=g(new Set(["broadcast","tasks","keepers","system"]));function Fh(e){const t=new Set(Da.value);t.has(e)?t.delete(e):t.add(e),Da.value=t}const Ji=g(null);function _d(e){Ji.value=e}function Kh(e){return e.kind==="board"?"broadcast":e.kind==="tasks"?"tasks":e.kind==="keepers"?"keepers":"system"}const Uh=ze(()=>{const e=Da.value;return Xs.value.filter(t=>e.has(Kh(t)))}),Hh=12e4,Bh=ze(()=>{const e=Rl.value,t=Date.now();return Ye.value.map(n=>{const s=n.name.trim().toLowerCase(),a=e.get(s)??null;let i="idle";if(n.status==="active"||n.status==="busy"){const l=a==null?void 0:a.lastActivityAt;l?i=t-new Date(l).getTime()>Hh?"stale":"working":i="working"}else(n.status==="offline"||n.status==="inactive")&&(i="stale");return{name:n.name,emoji:n.emoji??"",koreanName:n.koreanName??null,state:i,currentTask:n.current_task,motion:a}})}),Wh=ze(()=>{const e=Rl.value;return Ye.value.filter(t=>t.status==="active"||t.status==="busy"||t.status==="listening"||t.status==="idle").map(t=>{const n=t.name.trim().toLowerCase(),s=e.get(n),a=(s==null?void 0:s.activeAssignedCount)??0;let i="calm";return a>=3?i="hot":a>=1&&(i="normal"),{name:t.name,emoji:t.emoji??"",koreanName:t.koreanName??null,currentTask:t.current_task,lastActivityAt:(s==null?void 0:s.lastActivityAt)??null,lastActivityText:(s==null?void 0:s.lastActivityText)??null,assignedCount:a,pressure:i}}).sort((t,n)=>{const s={hot:0,normal:1,calm:2};return s[t.pressure]-s[n.pressure]})});function Jr(e){return e.kind==="board"?"live-event-broadcast":e.kind==="tasks"?"live-event-task":e.kind==="keepers"?"live-event-keeper":"live-event-system"}function Gh(e){const t=e.eventType;return t==="broadcast"?"broadcast":t==="agent_joined"?"joined":t==="agent_left"?"left":t==="task_update"?"task":t==="board_post"?"post":t==="board_comment"?"comment":t==="keeper_heartbeat"?"heartbeat":t==="keeper_handoff"?"handoff":t==="keeper_compaction"?"compact":t==="keeper_guardrail"?"guardrail":e.kind==="board"?"board":e.kind==="tasks"?"task":e.kind==="keepers"?"keeper":"system"}function Jh(e){switch(e){case"working":return"pulse-working";case"stale":return"pulse-stale";default:return"pulse-idle"}}function Vh(){const e=Bh.value,t=Ji.value;return e.length===0?o`
    ...
    <div class="pulse-strip">
      ${e.map(n=>o`
        <button
          key=${n.name}
          class="pulse-bubble ${Jh(n.state)} ${t===n.name?"pulse-selected":""}"
          onClick=${()=>_d(t===n.name?null:n.name)}
  ...
  `}const Qh=[{kind:"broadcast",label:"Broadcast",cssClass:"live-event-broadcast"},{kind:"tasks",label:"Task",cssClass:"live-event-task"},{kind:"keepers",label:"Keeper",cssClass:"live-event-keeper"},{kind:"system",label:"System",cssClass:"live-event-system"}];function Yh(){const e=Da.value;return o`
  ...
  `}function Xh(){const e=Uh.value;return o`
        ...
        ${e.length===0?o`<div class="activity-empty">No events matching filters</div>`:e.map((t,n)=>o`
            ...
            >
              <div class="activity-item-head">
                <span class="activity-kind-chip ${Jr(t)}">${Gh(t)}</span>
  ...
  `}function Zh(e){switch(e){case"hot":return"focus-pressure-hot";case"normal":return"focus-pressure-normal";default:return"focus-pressure-calm"}}function ey(e){switch(e){case"hot":return"High";case"normal":return"Active";default:return"Calm"}}function ty(){const e=Wh.value,t=Ji.value;return o`
        ...
        ${e.length===0?o`<div class="focus-empty">No active agents</div>`:e.map(n=>o`
            ...
            >
              <div class="focus-agent-header">
                ...
                <span class="focus-pressure-badge ${Zh(n.pressure)}">
                  ${ey(n.pressure)}
  ...
  `}function ny(){const e=dt.value;return o`
    <div class="live-monitor">
      <div class="live-header">
        ...
        <div class="live-header-stats">
          ...
          <span class="live-stat">이벤트 ${Oa.value}</span>
        </div>
      </div>
  ...
  `}function ay({currentTab:e}){var p,m,u,f,v,h,b,C,x,S;const t=dt.value,n=(p=ie.value)==null?void 0:p.build,s=(m=ie.value)==null?void 0:m.lodge,a=(u=ie.value)==null?void 0:u.gardener,i=(f=ie.value)==null?void 0:f.guardian,l=(v=ie.value)==null?void 0:v.sentinel,c=[];if(s&&c.push(Ds("Lodge",s.enabled?Le("lodge",s.quiet_active?"quiet":"live"):Le("lodge","disabled"),s.enabled?s.quiet_active?"warn":"ok":"bad",[Te("틱",s.total_ticks??0),Te("체크인",s.total_checkins??0),Te("최근 결과",((h=s.last_tick_result)==null?void 0:h.activity_report)??s.last_skip_reason??"없음")])),a&&c.push(Ds("Gardener",a.alive?Le("gardener","live"):a.enabled?Le("gardener","starting"):Le("gardener","disabled"),a.alive?"ok":a.enabled?"warn":"bad",[Te("최근 tick",a.last_tick_completed_at?o`<${G} timestamp=${a.last_tick_completed_at} />`:"기록 없음"),Te("판단",`${a.last_intervention??"없음"} · ${a.last_decision_source??"없음"}`),Te("백로그",`미할당 ${((b=a.health_summary)==null?void 0:b.todo_count)??0} · P1/2 ${((C=a.health_summary)==null?void 0:C.high_priority_todo)??0}`)],a.last_reason??a.last_error??void 0)),i){const $=i.masc_loops_running||i.lodge_loop_started||i.lodge_running;c.push(Ds("Guardian",$?Le("guardian","live"):i.enabled?Le("guardian","idle"):Le("guardian","disabled"),$?"ok":i.enabled?"warn":"bad",[Te("모드",i.mode??"알 수 없음"),Te("루프",`zombie ${i.zombie_loop_running?"on":"off"} · gc ${i.gc_loop_running?"on":"off"}`),Te("소유자",i.runtime_owner??"없음")],((x=i.last_lodge_result)==null?void 0:x.message)??i.last_gc_result??i.last_zombie_result??void 0))}return l&&c.push(Ds("Sentinel",l.started?Le("sentinel","live"):l.enabled?Le("sentinel","starting"):Le("sentinel","disabled"),l.started?"ok":l.enabled?"warn":"bad",[Te("에이전트",l.agent_name??"sentinel"),Te("소비자",((S=l.consumers)==null?void 0:S.length)??0),Te("가디언 소유자",l.guardian_runtime_owner??"없음")],l.llm_enabled===!0?"LLM 기반 housekeeping resident":void 0)),o`
    <section class="rail-card">
      ...
      <div class="rail-inline-actions">
        ...
        <button class="rail-secondary-btn" onClick=${()=>re("intervene")}>
          개입 열기
        </button>
      </div>
      ${n?o`<div class="rail-build-hint">서버 빌드 · v${n.release_version} · ${sy(n.commit)}</div>`:null}
      ${c.length>0?o`
  ...
  `}function oy(){const e=$e.value,t=(e==null?void 0:e.pending_confirms.length)??0,n=(e==null?void 0:e.sessions.length)??0,s=(e==null?void 0:e.keepers.length)??0;return o`
    <section class="rail-card">
      <div class="rail-card-head">
        <h3>개입 바로가기</h3>
  ...
  `}const Os=g(!1);function iy(){const e=dt.value;return o`
    <div class="connection-status ${e?"connected":"disconnected"}">
      ...
      <span class="event-count">이벤트 ${Oa.value}</span>
    </div>
  `}function ry(e){const t=e==null?void 0:e.trim();return t?t.length>10?t.slice(0,10):t:"커밋 정보 없음"}function ly(){const e=ie.value,t=e==null?void 0:e.build,n=t?`v${t.release_version} · ${ry(t.commit)}`:e!=null&&e.version?`v${e.version} · 커밋 정보 없음`:"버전 정보 없음";return o`
    <div class="build-identity-wrap">
      <button
        class="version-badge build-badge-trigger"
        type="button"
        aria-expanded=${Os.value}
        onClick=${()=>{Os.value=!Os.value}}
      >
        서버 빌드 · ${n}
      </button>
      ${Os.value?o`
  ...
  `}function cy(){const e=D.value.tab,t=di.find(s=>s.id===e),n=Vr.find(s=>s.id===(t==null?void 0:t.group));return o`
  ...
  `}function dy(){switch(D.value.tab){case"mission":return o`<${hr} />`;case"proof":return o`<${Pf} />`;case"execution":return o`<${L$} />`;case"tools":return o`<${N$} />`;case"live":return o`<${ny} />`;case"memory":return o`<${_$} />`;case"governance":return o`<${dh} />`;case"planning":return o`<${Y$} />`;case"intervene":return o`<${t$} />`;case"command":return o`<${Yg} />`;case"lab":return o`<${qh} />`;default:return o`<${hr} />`}}function uy(){return qo.value&&!dt.value?o`<div class="loading-indicator">대시보드 불러오는 중...</div>`:o`<${dy} />`}function py(){ae(()=>{Cd(),sl(),El(),Tt(),jl(),Ql();const n=Zp();return em(),()=>{Md(),n(),tm()}},[]),ae(()=>{const n=setInterval(()=>{Qo(D.value.tab)},15e3);return()=>{clearInterval(n)}},[]),ae(()=>{Qo(D.value.tab)},[D.value.tab]);const e=D.value.tab,t=di.find(n=>n.id===e);return o`
    <div class="app-shell">
  ...
  `}const Qr=document.getElementById("app");Qr&&yd(o`<${py} />`,Qr);export{Qv as _};
