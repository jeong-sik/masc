...
(** #9662: cooperative-cancel timeout overshoot counter.
    Labels: [layer, origin].  Has no emitter since the timeout_policy
    module was removed; kept as a declared counter name. *)
