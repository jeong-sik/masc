...
let trpg_default_fast_keeper_models () : string list =
  ...
  | true, true ->
      [ "glm:glm-4.7"; "gemini:gemini-2.5-flash"; Provider_adapter.explicit_llama_model_label () ]
  | true, false -> [ "glm:glm-4.7"; Provider_adapter.explicit_llama_model_label () ]
  | false, true -> [ "gemini:gemini-2.5-flash"; Provider_adapter.explicit_llama_model_label () ]
  | false, false -> [ Provider_adapter.explicit_llama_model_label () ]
