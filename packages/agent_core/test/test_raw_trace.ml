  ...
  let file_read_tool =
    Tool.create
      ...
      (fun input ->
         ...
         Ok { Types.content = read_file (Filename.concat root rel); content_blocks = None; _meta = None })
  in
  let file_write_tool =
    Tool.create
      ...
      (fun input ->
         ...
         Ok { Types.content = Printf.sprintf "wrote:%s" rel; content_blocks = None; _meta = None })
  in
  let shell_exec_tool =
    Tool.create
