...
OAS pin metadata is generated from `scripts/oas-agent-sdk-pin.sh`. Current dependency floor: `agent_sdk >= 0.207.25`, runtime pin: `codex/fix-stream-acc-done-sentinel@d8395b9a357d134518c74ca72dbb8af2089e0a02`, declared base version: `v0.207.25`. 최신성 검증이 필요할 때는 문서에 적힌 숫자보다 `dune-project`와 pin script를 우선 truth source로 본다.
