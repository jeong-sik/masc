...
let schemas : Masc_domain.tool_schema list =
  [ ask; ask_status; broadcast; config; dashboard; deliver; gc; keeper_waiting_inventory; messages; note_add; plan_clear_task; plan_get; plan_get_task; plan_init; plan_set_task; plan_update; start; tool_help ]
;;
