...
let metric_oas_bridge_timeout = Otel_metric_store_core.declare_counter "masc_oas_bridge_timeout_total"
...
let metric_oas_context_compaction_total = Otel_metric_store_core.declare_counter "masc_oas_context_compaction_total"
