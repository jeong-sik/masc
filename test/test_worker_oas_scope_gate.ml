...
let test_observe_only_denies_masc_mutating () =
  let gate = Worker_oas.gate_config_of_execution_scope Worker_contract_types.Observe_only in
  let mutating_tools =
...
let test_limited_allows_masc_mutating () =
  let gate = Worker_oas.gate_config_of_execution_scope Worker_contract_types.Limited_code_change in
...
let test_autonomous_allows_all () =
  let gate = Worker_oas.gate_config_of_execution_scope Worker_contract_types.Autonomous in
