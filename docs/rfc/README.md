...
||||||| parent of 39584e066a (docs(rfc): type external tools and image evidence)
...
>>>>>>> 39584e066a (docs(rfc): type external tools and image evidence)
...
| RFC-skills-as-tools | Skill 과 Tool 은 한 카탈로그의 두 표면 — SKILL.md 가 지시·합성·비동기를 선언한다 | Draft | - |
