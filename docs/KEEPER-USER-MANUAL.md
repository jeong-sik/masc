...
OAS pin metadata is generated from `scripts/oas-agent-sdk-pin.sh`. Current dependency floor: `agent_sdk >= 0.207.19`, runtime pin: `fix/oas-assistant-tool-content-capability-20260629@f085fc21c59f92514f892434ec349c8c9e10ff46`, declared base version: `v0.207.19`. 최신성 검증이 필요할 때는 문서에 적힌 숫자보다 `dune-project`와 pin script를 우선 truth source로 본다.
