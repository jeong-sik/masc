...
let merge_usage
    (a : Masc_agent_core.Types.api_usage)
    (b : Masc_agent_core.Types.api_usage) : Masc_agent_core.Types.api_usage =
  { Masc_agent_core.Types.input_tokens = a.input_tokens + b.input_tokens;
