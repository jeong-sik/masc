...
export const raw: ReadonlyArray<TokenBase> = (() => {
  ...
  // 8-step structural spacing (theme-invariant, parallel to --sp-*)
  for (const [step, px] of [
...
export const semantic: ReadonlyArray<TokenBase> = (() => {
  ...
  // Motion-scope marker — parallel to _density-scope
  out.push(t("_motion-scope", "1", "role", "number", "scope marker"));
...
export const themes: ReadonlyArray<Theme> = Object.freeze([
  {
    ...
    tokens: Object.freeze([
      ...
      t("accent-brass", "#968228", "raw", "color", "differs from --brass-1"),
      ...
      // Trace frame — swimlane / flame / tool-category bars
