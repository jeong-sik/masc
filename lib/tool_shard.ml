...
let base_tools : Llm.tool_def list = [
  (* Time *)
  {
...
let board_tools : Llm.tool_def list = [
  {
...
let filesystem_tools : Llm.tool_def list = [
  {
...
let shell_tools : Llm.tool_def list = [
  {
...
let voice_tools : Llm.tool_def list = [
  {
...
let weather_tools : Llm.tool_def list = [
  {
...
let taskboard_tools : Llm.tool_def list = [
  {
...
let tools_of_shards (shard_names : string list) : Llm.tool_def list =
  shard_names
...
let keeper_llm_tools : Llm.tool_def list =
