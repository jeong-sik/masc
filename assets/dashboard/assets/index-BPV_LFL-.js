var Jr=Object.defineProperty;var Vr=(t,e,n)=>e in t?Jr(t,e,{enumerable:!0,configurable:!0,writable:!0,value:n}):t[e]=n;var xe=(t,e,n)=>Vr(t,typeof e!="symbol"?e+"":e,n);import{e as Qr,_ as Yr,c as _,b as Ct,y as rt,d as Wa,A as To,G as Xr}from"./vendor-kuFK4-oj.js";(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const s of document.querySelectorAll('link[rel="modulepreload"]'))a(s);new MutationObserver(s=>{for(const o of s)if(o.type==="childList")for(const r of o.addedNodes)r.tagName==="LINK"&&r.rel==="modulepreload"&&a(r)}).observe(document,{childList:!0,subtree:!0});function n(s){const o={};return s.integrity&&(o.integrity=s.integrity),s.referrerPolicy&&(o.referrerPolicy=s.referrerPolicy),s.crossOrigin==="use-credentials"?o.credentials="include":s.crossOrigin==="anonymous"?o.credentials="omit":o.credentials="same-origin",o}function a(s){if(s.ep)return;s.ep=!0;const o=n(s);fetch(s.href,o)}})();var i=Qr.bind(Yr);const Zr=["command","overview","board","goals","agents","ops","trpg"],No={tab:"overview",params:{},postId:null},tl={journal:"overview",mdal:"goals",tasks:"goals",execution:"overview",council:"board",activity:"overview"};function zi(t){return!!t&&Zr.includes(t)}function ji(t){if(t)return tl[t]??t}function Yn(t){try{return decodeURIComponent(t)}catch{return t}}function Ps(t){const e={};return t&&new URLSearchParams(t).forEach((a,s)=>{e[s]=a}),e}function el(t){const n=t.replace(/^\/+/,"").split("/").filter(Boolean);return n[0]==="dashboard"?n.slice(1):n}function Ro(t,e){if(t[0]==="chains"){const r={...e,surface:"chains"};return t[1]==="operation"&&t[2]&&(r.operation=Yn(t[2])),{tab:"command",params:r,postId:null}}const n=ji(t[0]),a=ji(e.tab),s=zi(n)?n:zi(a)?a:"overview";let o=null;return s==="board"&&(t[0]==="board"&&t[1]==="post"&&t[2]?o=Yn(t[2]):t[0]==="post"&&t[1]&&(o=Yn(t[1]))),{tab:s,params:e,postId:o}}function ca(t){const e=(t||"").replace(/^#/,"").trim();if(!e)return No;const n=Yn(e);let a=n,s;if(n.startsWith("?"))a="",s=n.slice(1);else{const l=n.indexOf("?");l>=0&&(a=n.slice(0,l),s=n.slice(l+1))}!s&&a.includes("=")&&!a.includes("/")&&(s=a,a="");const o=Ps(s),r=el(a);return Ro(r,o)}function nl(t,e){const n=t.replace(/^\/+/,"").split("/").filter(Boolean);if(n[0]!=="dashboard")return null;const a=n.slice(1);if(a.length===0)return{...No,params:Ps(e.replace(/^\?/,""))};if(a[0]==="assets"||a[0]==="credits"||a[0]==="lodge")return null;const s=Ps(e.replace(/^\?/,""));return Ro(a,s)}function Lo(t){const e=t.postId?`board/post/${encodeURIComponent(t.postId)}`:t.tab,n=Object.entries(t.params).filter(([s])=>s!=="tab");if(n.length===0)return`#${e}`;const a=new URLSearchParams(n);return`#${e}?${a.toString()}`}const nt=_(ca(window.location.hash));window.addEventListener("hashchange",()=>{nt.value=ca(window.location.hash)});function At(t,e){const n={tab:t,params:e??{},postId:null};window.location.hash=Lo(n)}function al(t){window.location.hash=`#board/post/${encodeURIComponent(t)}`}function sl(){if(window.location.hash&&window.location.hash!=="#"){nt.value=ca(window.location.hash);return}const t=nl(window.location.pathname,window.location.search);if(t){nt.value=t;const e=Lo(t);window.history.replaceState(null,"",`${window.location.pathname}${window.location.search}${e}`);return}window.location.hash="#overview",nt.value=ca(window.location.hash)}const qi="masc_dashboard_sse_session_id",il=1e3,ol=15e3,Ft=_(!1),In=_(0),Po=_(null),da=_([]);function rl(){let t=sessionStorage.getItem(qi);return t||(t=typeof crypto.randomUUID=="function"?`dash_${crypto.randomUUID()}`:`dash_${Date.now().toString(36)}_${Math.random().toString(36).slice(2,10)}`,sessionStorage.setItem(qi,t)),t}const ll=200;function cl(t,e,n="system",a={}){const s={agent:t,text:e,timestamp:Date.now(),kind:n,...a};da.value=[s,...da.value].slice(0,ll)}function Ds(t,e=88){const n=(t??"").replace(/\s+/g," ").trim();return n?n.length>e?`${n.slice(0,e-3)}...`:n:void 0}function Fi(t,e){const n=Ds(e);return n?`${t}: ${n}`:`New ${t.toLowerCase()}`}function Tt(t,e,n,a,s={}){cl(t,e,n,{eventType:a,...s})}let Ot=null,Ee=null,Es=0;function Do(){Ee&&(clearTimeout(Ee),Ee=null)}function dl(){if(Ee)return;Es++;const t=Math.min(Es,5),e=Math.min(ol,il*Math.pow(2,t));Ee=setTimeout(()=>{Ee=null,Eo()},e)}function Eo(){Do(),Ot&&(Ot.close(),Ot=null);const t=new URLSearchParams(window.location.search),e=new URLSearchParams,n=t.get("agent")??t.get("agent_name"),a=t.get("token");n&&e.set("agent",n),a&&e.set("token",a),e.set("session_id",rl());const s=e.toString()?`/sse?${e.toString()}`:"/sse",o=new EventSource(s);Ot=o,o.onopen=()=>{Ot===o&&(Es=0,Ft.value=!0)},o.onerror=()=>{Ot===o&&(Ft.value=!1,o.close(),Ot=null,dl())},o.onmessage=r=>{try{const l=JSON.parse(r.data);In.value++,Po.value=l,ul(l)}catch{}}}function ul(t){const e=t.type,n=t.agent??t.author??t.from??t.from_agent??"";switch(e){case"agent_joined":Tt(n,"Joined","system","agent_joined");break;case"agent_left":Tt(n,"Left","system","agent_left");break;case"broadcast":Tt(n,`${(t.message??t.content??"").slice(0,80)}`,"system","broadcast");break;case"task_update":Tt(n,`Task: ${t.task_id??""} -> ${t.status??""}`,"tasks","task_update");break;case"board_post":case"masc/board_post":Tt(n,Fi("Post",t.content??t.message),"board","board_post",{author:t.author??n,preview:Ds(t.content??t.message),postId:t.post_id});break;case"board_comment":case"masc/board_comment":Tt(n,Fi("Comment",t.content??t.message),"board","board_comment",{author:t.author??n,preview:Ds(t.content??t.message),postId:t.post_id});break;case"keeper_heartbeat":Tt(t.name??n,`Heartbeat gen=${t.generation??"?"} ctx=${t.context_ratio!=null?Math.round(t.context_ratio*100)+"%":"?"}`,"keepers","keeper_heartbeat");break;case"keeper_handoff":Tt(t.name??n,`Handoff gen ${t.from_generation??"?"} -> ${t.to_generation??"?"} (${t.to_model??"?"})`,"keepers","keeper_handoff");break;case"keeper_compaction":Tt(t.name??n,`Compaction saved ${t.saved_tokens??"?"} tokens (${t.trigger??"?"})`,"keepers","keeper_compaction");break;case"keeper_guardrail":Tt(t.name??n,`Guardrail: ${t.reason??"stopped"}`,"keepers","keeper_guardrail");break;default:Tt(n,e,"system","unknown")}}function pl(){Do(),Ot&&(Ot.close(),Ot=null),Ft.value=!1}function Io(){return new URLSearchParams(window.location.search)}function Mo(){const t=Io(),e={},n=t.get("token"),a=t.get("agent")??t.get("agent_name");return n&&(e.Authorization=`Bearer ${n}`),a&&(e["X-MASC-Agent"]=a),e}function Oo(){return{...Mo(),"Content-Type":"application/json"}}const ml=15e3,$i=3e4,vl=6e4,Ki=new Set([408,425,429,500,502,503,504]);class Mn extends Error{constructor(n){const a=n.method.toUpperCase(),s=n.timeout===!0,o=s?`${a} ${n.path}: timeout after ${n.timeoutMs??0}ms`:`${a} ${n.path}: ${n.status??"unknown"} ${n.statusText??""}`.trim();super(o);xe(this,"method");xe(this,"path");xe(this,"status");xe(this,"statusText");xe(this,"timeout");this.name="ApiRequestError",this.method=a,this.path=n.path,this.status=n.status,this.statusText=n.statusText,this.timeout=s}}async function hi(t,e,n){const a=new AbortController,s=setTimeout(()=>a.abort(),n);try{return await fetch(t,{...e,signal:a.signal})}catch(o){if(o instanceof Error&&o.name==="AbortError"){const r=typeof e.method=="string"?e.method.toUpperCase():"GET";throw new Mn({method:r,path:t,timeout:!0,timeoutMs:n})}throw o}finally{clearTimeout(s)}}function fl(){var e,n;const t=Io();return((e=t.get("agent"))==null?void 0:e.trim())||((n=t.get("agent_name"))==null?void 0:n.trim())||"dashboard-user"}async function tt(t){const e=await hi(t,{headers:Mo()},ml);if(!e.ok)throw new Mn({method:"GET",path:t,status:e.status,statusText:e.statusText});return e.json()}function _l(t){return new Promise(e=>setTimeout(e,t))}function gl(t){const e=t.match(/\b(\d{3})\b/);if(!e)return null;const n=e[1];if(!n)return null;const a=Number.parseInt(n,10);return Number.isFinite(a)?a:null}function $l(t){if(t instanceof Mn)return t.timeout||typeof t.status=="number"&&Ki.has(t.status);if(!(t instanceof Error))return!1;if(/timeout after \d+ms/i.test(t.message))return!0;const e=gl(t.message);return e!==null&&Ki.has(e)}async function Be(t,e,n=2){let a=0;for(;;)try{return await e()}catch(s){if(!$l(s)||a>=n)throw s;const o=250*(a+1);console.warn(`[dashboard/api] ${t} failed (attempt ${a+1}), retrying in ${o}ms`,s),await _l(o),a+=1}}async function Kt(t,e,n,a=$i){const s=await hi(t,{method:"POST",headers:{...Oo(),...n??{}},body:JSON.stringify(e)},a);if(!s.ok)throw new Mn({method:"POST",path:t,status:s.status,statusText:s.statusText});return s.json()}async function hl(t,e,n,a=$i){const s=await hi(t,{method:"POST",headers:{...Oo(),...n??{}},body:JSON.stringify(e)},a);if(!s.ok)throw new Mn({method:"POST",path:t,status:s.status,statusText:s.statusText});return s.text()}function yl(t){const e=t.split(`
`).find(a=>a.startsWith("data: ")),n=e?e.slice(6).trim():t.trim();return JSON.parse(n)}function bl(t){var e,n,a,s,o,r,l;if((e=t.error)!=null&&e.message)throw new Error(t.error.message);if((n=t.result)!=null&&n.isError){const p=((s=(a=t.result.content)==null?void 0:a[0])==null?void 0:s.text)??"MCP tool call failed";throw new Error(p)}return((l=(r=(o=t.result)==null?void 0:o.content)==null?void 0:r[0])==null?void 0:l.text)??""}async function bt(t,e){const n=await hl("/mcp",{jsonrpc:"2.0",method:"tools/call",params:{name:t,arguments:e},id:Math.floor(Date.now()%1e6)},{Accept:"application/json, text/event-stream"},vl),a=yl(n);return bl(a)}function kl(t="compact"){return tt(`/api/v1/dashboard?mode=${t}`)}function xl(){return tt("/api/v1/agents?limit=100")}function Sl(t){const e=new URLSearchParams({limit:"200"});return e.set("include_done","true"),e.set("include_cancelled","true"),tt(`/api/v1/tasks?${e}`)}function Al(t){const e=new URLSearchParams({limit:"50"});return t!=null&&t>0&&e.set("since_seq",String(t)),tt(`/api/v1/messages?${e}`)}function wl(t={}){return Be("fetchMdalLoops",async()=>{const e=new URLSearchParams;t.limit!=null&&e.set("limit",String(t.limit)),t.historyLimit!=null&&e.set("history_limit",String(t.historyLimit)),t.status&&e.set("status",t.status);const n=e.toString();return tt(`/api/v1/mdal/loops${n?`?${n}`:""}`)})}function Cl(){return tt("/api/v1/operator")}function Tl(){return tt("/api/v1/command-plane")}function Nl(){return tt("/api/v1/command-plane/summary")}function Rl(){return tt("/api/v1/chains/summary")}function Ll(t){return tt(`/api/v1/chains/runs/${encodeURIComponent(t)}`)}function Pl(){return tt("/api/v1/command-plane/help")}function Dl(t){const e=new URLSearchParams;t&&e.set("run_id",t);const n=e.toString();return tt(`/api/v1/command-plane/swarm${n?`?${n}`:""}`)}function El(t,e){return Kt(t,e)}function Il(t){switch(t.action_type){case"keeper_msg":case"keeper_message":case"keeper_recover":return 9e4;case"lodge_tick":return 45e3;default:return $i}}function On(t){return Kt("/api/v1/operator/action",t,void 0,Il(t))}function Ml(t,e){return Kt("/api/v1/operator/confirm",{actor:t,confirm_token:e})}const Ol=new Set(["lodge-system","team-session"]);function qe(t){if(typeof t=="string"&&t.trim())return t;if(typeof t!="number"||Number.isNaN(t))return new Date().toISOString();const e=t<1e12?t*1e3:t;return new Date(e).toISOString()}function zl(t){return Ol.has(t.trim().toLowerCase())}function jl(t){return t.filter(e=>!zl(e.author))}function ql(t){var s;const e=t.trim(),a=((s=(e.startsWith("[flair:")?e.replace(/^\[flair:[^\]]+\]\s*/i,""):e).split(`
`)[0])==null?void 0:s.trim())||"Untitled post";return a.length<=96?a:`${a.slice(0,93)}...`}function zo(t){if(!O(t))return null;const e=h(t.id,"").trim(),n=h(t.author,"").trim(),a=h(t.content,"").trim();if(!e||!n)return null;const s=j(t.score,0),o=j(t.votes_up,0),r=j(t.votes_down,0),l=j(t.votes,s||o-r),p=j(t.comment_count,j(t.reply_count,0)),$=(()=>{const y=t.flair;if(typeof y=="string"&&y.trim())return y.trim();if(O(y)){const T=h(y.name,"").trim();if(T)return T}return h(t.flair_name,"").trim()||void 0})(),m=h(t.created_at_iso,"").trim()||qe(t.created_at),d=h(t.updated_at_iso,"").trim()||(t.updated_at!==void 0?qe(t.updated_at):m),c=h(t.title,"").trim()||ql(a);return{id:e,author:n,title:c,content:a,tags:[],votes:l,vote_balance:s,comment_count:p,created_at:m,updated_at:d,flair:$,hearth_count:j(t.hearth_count,0)}}function Fl(t){if(!O(t))return null;const e=h(t.id,"").trim(),n=h(t.post_id,"").trim(),a=h(t.author,"").trim();return!e||!a?null:{id:e,post_id:n,author:a,content:h(t.content,""),created_at:qe(t.created_at)}}async function Kl(t,e){return Be("fetchBoard",async()=>{const n=new URLSearchParams;t&&n.set("sort_by",t),e!=null&&e.excludeSystem&&n.set("exclude_system","true"),n.set("limit",e!=null&&e.excludeSystem?"150":"100");const a=n.toString(),s=await tt(`/api/v1/board${a?`?${a}`:""}`),o=Array.isArray(s.posts)?s.posts.map(zo).filter(l=>l!==null):[];return{posts:e!=null&&e.excludeSystem?jl(o):o}})}async function Hl(t){return Be("fetchBoardPost",async()=>{const e=await tt(`/api/v1/board/${t}?format=flat`),n=O(e.post)?e.post:e,a=zo(n)??{id:t,author:"unknown",title:"Post",content:"",tags:[],votes:0,comment_count:0,created_at:new Date().toISOString(),updated_at:new Date().toISOString()},o=(Array.isArray(e.comments)?e.comments:[]).map(Fl).filter(r=>r!==null);return{...a,comments:o}})}function jo(t,e){return Kt("/api/v1/tools/masc_board_vote",{post_id:t,direction:e,vote:e,voter:fl()})}function Ul(t,e,n){return Kt("/api/v1/tools/masc_board_comment",{post_id:t,author:e,content:n})}function Bl(t){const e=h(t,"").trim().toLowerCase();if(e==="win"||e==="won"||e==="victory")return"victory";if(e==="lose"||e==="lost"||e==="defeat")return"defeat";if(e==="draw"||e==="stalemate"||e==="tie")return"draw"}function lt(...t){for(const e of t){const n=h(e,"");if(n.trim())return n.trim()}return""}function Hi(t){const e=Bl(lt(t.outcome,t.result,t.result_code));if(!e)return;const n=lt(t.reason,t.reason_code,t.description,t.detail),a=lt(t.summary,t.summary_ko,t.summary_en,t.note),s=lt(t.details,t.details_text,t.text,t.note),o=lt(t.winner,t.winner_name,t.actor_winner,t.winner_actor),r=lt(t.winner_actor_id,t.winner_actor,t.actor_winner_id),l=lt(t.raw_reason,t.raw_reason_code,t.error_message),p=(()=>{const d=t.evidence??t.evidence_ids??t.supporting_events??t.event_ids??[];return typeof d=="string"?[d]:Array.isArray(d)?d.map(v=>{if(typeof v=="string")return v.trim();if(O(v)){const c=h(v.summary,"").trim();if(c)return c;const y=h(v.text,"").trim();if(y)return y;const S=h(v.type,"").trim();return S||h(v.event_id,"").trim()}return""}).filter(v=>v.length>0):[]})(),$=(()=>{const d=j(t.turn,Number.NaN);if(Number.isFinite(d))return d;const v=j(t.turn_number,Number.NaN);if(Number.isFinite(v))return v;const c=j(t.current_turn,Number.NaN);if(Number.isFinite(c))return c;const y=j(t.round,Number.NaN);return Number.isFinite(y)?y:void 0})(),m=lt(t.phase,t.phase_name,t.current_phase,t.phase_id);return{result:e,reason:n||void 0,summary:a||void 0,details:s||void 0,winner:o||void 0,winner_actor_id:r||void 0,evidence:p.length>0?p:void 0,raw_reason:l||void 0,turn:$,phase:m||void 0}}function Wl(t,e){const n=O(t.state)?t.state:{};if(h(n.status,"active").toLowerCase()!=="ended")return;const s=[...e].reverse().find(r=>O(r)?h(r.type,"")==="session.outcome":!1),o=O(n.session_outcome)?n.session_outcome:{};if(O(o)&&Object.keys(o).length>0){const r=Hi(o);if(r)return r}if(O(s))return Hi(O(s.payload)?s.payload:{})}function O(t){return typeof t=="object"&&t!==null}function h(t,e=""){return typeof t=="string"?t:e}function j(t,e=0){return typeof t=="number"&&Number.isFinite(t)?t:e}function Gl(t){if(typeof t=="number"&&Number.isFinite(t))return Math.trunc(t);if(typeof t=="string"){const e=Number.parseInt(t.trim(),10);if(Number.isFinite(e))return e}}function Is(t,e=!1){return typeof t=="boolean"?t:e}function Ye(t){return Array.isArray(t)?t.map(e=>{if(typeof e=="string")return e.trim();if(O(e)){const n=h(e.name,"").trim(),a=h(e.id,"").trim(),s=h(e.skill,"").trim();return n||a||s}return""}).filter(e=>e.length>0):[]}function Jl(t){const e={};if(!O(t)&&!Array.isArray(t))return e;if(O(t))return Object.entries(t).forEach(([n,a])=>{const s=n.trim(),o=h(a,"").trim();!s||!o||(e[s]=o)}),e;for(const n of t){if(!O(n))continue;const a=lt(n.to,n.target,n.actor_id,n.name,n.id),s=lt(n.relationship,n.relation,n.type,n.kind);!a||!s||(e[a]=s)}return e}function Vl(t,e,n){if(t==="dm"||t==="player"||t==="npc")return t;const a=e.trim().toLowerCase();return a==="dm"||a.startsWith("dm-")?"dm":a.startsWith("npc-")||a.startsWith("enemy-")||a.startsWith("mob-")?"npc":/^p\d+$/i.test(a)||a.startsWith("player-")?"player":typeof n=="string"&&n.trim()!==""?n.trim().toLowerCase().includes("dm")?"dm":"player":"npc"}function xt(t,e,n,a=0){const s=t[e];if(typeof s=="number"&&Number.isFinite(s))return s;if(n){const o=t[n];if(typeof o=="number"&&Number.isFinite(o))return o}return a}const Ql=new Set(["str","dex","con","int","wis","cha","strength","dexterity","constitution","intelligence","wisdom","charisma","hp","max_hp","mp","max_mp","level","xp"]);function Yl(t){const e=O(t.stats)?t.stats:{},n={};return Object.entries(e).forEach(([a,s])=>{const o=a.trim();o&&(Ql.has(o.toLowerCase())||typeof s=="number"&&Number.isFinite(s)&&(n[o]=s))}),n}function Xl(t,e){if(t!=="dice.rolled")return;const n=j(e.raw_d20,0),a=j(e.total,0),s=j(e.bonus,0),o=h(e.action,"roll"),r=j(e.dc,0);return{notation:r>0?`${o} (DC ${r})`:o,rolls:n>0?[n]:[],total:a,modifier:s}}function Zl(t){const e=JSON.stringify(t);return e?e.length>160?`${e.slice(0,157)}...`:e:""}function tc(t){const e=t.trim().toLowerCase();return e?e.startsWith("dice.")?"dice":e.startsWith("combat.")||e.includes(".attack")||e.includes(".damage")?"combat":e.includes("actor.")?"actor":e.includes("turn.")||e==="turn.started"||e==="phase.changed"?"turn":e.includes("join.")?"join":e.includes("memory")?"memory":e.includes("world.")?"world":e.includes("narration")?"story":"meta":"meta"}function ec(t,e,n,a){const s=n||e||h(a.actor_id,"")||h(a.actor_name,"");switch(t){case"turn.action.proposed":{const o=h(a.proposed_action,h(a.reply,""));return o?`${s||"actor"}: ${o}`:"Action proposed"}case"turn.action.resolved":{const o=h(a.reply,h(a.result,""));return o?`Resolved: ${o}`:"Action resolved"}case"narration.posted":return h(a.reply,h(a.content,h(a.text,"Narration")));case"dice.rolled":{const o=h(a.action,"roll"),r=j(a.total,0),l=j(a.dc,0),p=h(a.label,""),$=s||"actor",m=l>0?` vs DC ${l}`:"",d=p?` (${p})`:"";return`${$} ${o}: ${r}${m}${d}`}case"turn.started":return`Turn ${j(a.turn,1)} started`;case"phase.changed":return`Phase: ${h(a.phase,"round")}`;case"actor.spawned":return`Actor spawned: ${h(a.name,O(a.actor)?h(a.actor.name,s||"unknown"):s||"unknown")}`;case"actor.claimed":return`${h(a.keeper_name,h(a.keeper,"keeper"))} claimed ${s||"actor"}`;case"actor.released":return`${h(a.keeper_name,h(a.keeper,"keeper"))} released ${s||"actor"}`;case"join.window.opened":return`Join window opened (turn ${j(a.turn,0)})`;case"join.window.closed":return`Join window closed (turn ${j(a.turn,0)})`;case"mid.join.requested":return`Mid-join requested: ${s||h(a.actor_id,"actor")}`;case"mid.join.granted":return`Mid-join granted: ${s||h(a.actor_id,"actor")}`;case"mid.join.rejected":return`Mid-join rejected: ${h(a.reason_code,"unknown")}`;case"memory.signal":{const o=O(a.entity_refs)?a.entity_refs:{},r=h(o.requested_tier,""),l=h(o.effective_tier,""),p=Is(o.guardrail_applied,!1),$=h(a.summary_en,h(a.summary_ko,"Memory signal"));if(!r&&!l)return $;const m=r&&l?`${r}->${l}`:l||r;return`${$} [${m}${p?" (guardrail)":""}]`}case"world.event":{if(h(a.event_type,"")==="canon.check"){const r=h(a.status,"unknown"),l=h(a.contract_id,"n/a");return`Canon ${r}: ${l}`}return h(a.description,h(a.summary,"World event"))}case"combat.attack":return h(a.summary,h(a.result,"Attack resolved"));case"combat.defense":return h(a.summary,h(a.result,"Defense resolved"));case"session.outcome":return h(a.summary,h(a.outcome,"Session ended"));default:{const o=Zl(a);return o?`${t}: ${o}`:t}}}function nc(t,e){const n=O(t)?t:{},a=h(n.type,"event"),s=typeof n.actor_id=="string"&&n.actor_id.trim()?n.actor_id.trim():"",o=h(n.actor_name,"").trim()||e[s]||h(O(n.payload)?n.payload.actor_name:"",""),r=O(n.payload)?n.payload:{},l=h(n.ts,h(n.timestamp,new Date().toISOString())),p=h(n.phase,h(r.phase,"")),$=h(n.category,"");return{type:a,actor:o||s||h(r.actor_name,""),actor_id:s||h(r.actor_id,""),actor_name:o,seq:n.seq,room_id:h(n.room_id,""),phase:p||void 0,category:$||tc(a),visibility:h(n.visibility,h(r.visibility,"public")),event_id:h(n.event_id,""),content:ec(a,s,o,r),dice_roll:Xl(a,r),timestamp:l}}function ac(t,e,n){var mt,vt;const a=h(t.room_id,"")||n||"default",s=O(t.state)?t.state:{},o=O(s.party)?s.party:{},r=O(s.actor_control)?s.actor_control:{},l=O(s.join_gate)?s.join_gate:{},p=O(s.contribution_ledger)?s.contribution_ledger:{},$=Object.entries(o).map(([B,M])=>{const x=O(M)?M:{},Dt=xt(x,"max_hp",void 0,10),Vt=xt(x,"hp",void 0,Dt),oe=xt(x,"max_mp",void 0,0),re=xt(x,"mp",void 0,0),I=xt(x,"level",void 0,1),Et=xt(x,"xp",void 0,0),le=Is(x.alive,Vt>0),Ve=r[B],Qe=typeof Ve=="string"?Ve:void 0,qn=Vl(x.role,B,Qe),f=Gl(x.generation),L=lt(x.joined_at,x.joinedAt,x.started_at,x.startedAt),q=lt(x.claimed_at,x.claimedAt,x.assigned_at,x.assignedAt,x.assigned_time),at=lt(x.last_seen,x.lastSeen,x.last_seen_at,x.lastSeenAt,x.last_active,x.lastActive),z=lt(x.scene,x.current_scene,x.currentScene,x.world_scene,x.scene_name,x.sceneName),ft=lt(x.location,x.current_location,x.currentLocation,x.position,x.zone,x.area);return{id:B,name:h(x.name,B),role:qn,keeper:Qe,archetype:h(x.archetype,""),persona:h(x.persona,""),portrait:h(x.portrait,"")||void 0,background:h(x.background,"")||void 0,traits:Ye(x.traits),skills:Ye(x.skills),stats_raw:Yl(x),status:le?"active":"dead",generation:f,joined_at:L||void 0,claimed_at:q||void 0,last_seen:at||void 0,scene:z||void 0,location:ft||void 0,inventory:Ye(x.inventory),notes:Ye(x.notes),relationships:Jl(x.relationships),stats:{hp:Vt,max_hp:Dt,mp:re,max_mp:oe,level:I,xp:Et,strength:xt(x,"strength","str",10),dexterity:xt(x,"dexterity","dex",10),constitution:xt(x,"constitution","con",10),intelligence:xt(x,"intelligence","int",10),wisdom:xt(x,"wisdom","wis",10),charisma:xt(x,"charisma","cha",10)}}}),m=$.filter(B=>B.status!=="dead"),d=Wl(t,e),v={phase_open:Is(l.phase_open,!0),min_points:j(l.min_points,3),window:h(l.window,"round_boundary_only"),last_opened_turn:typeof l.last_opened_turn=="number"?l.last_opened_turn:null,last_closed_turn:typeof l.last_closed_turn=="number"?l.last_closed_turn:null},c=Object.entries(p).map(([B,M])=>{const x=O(M)?M:{};return{actor_id:B,score:j(x.score,0),last_reason:h(x.last_reason,"")||null,reasons:Ye(x.reasons)}}),y=$.reduce((B,M)=>(B[M.id]=M.name,B),{}),S=e.map(B=>nc(B,y)),T=j(s.turn,1),P=h(s.phase,"round"),K=h(s.map,""),E=O(s.world)?s.world:{},N=K||h(E.ascii_map,h(E.map,"")),R=S.filter((B,M)=>{const x=e[M];if(!O(x))return!1;const Dt=O(x.payload)?x.payload:{};return j(Dt.turn,-1)===T}),Y=(R.length>0?R:S).slice(-12),H=h(s.status,"active");return{session:{id:a,room:a,status:H==="ended"?"ended":H==="paused"?"paused":"active",round:T,actors:m,created_at:((mt=S[0])==null?void 0:mt.timestamp)??new Date().toISOString()},current_round:{round_number:T,phase:P,events:Y,timestamp:((vt=S[S.length-1])==null?void 0:vt.timestamp)??new Date().toISOString()},map:N||void 0,join_gate:v,contribution_ledger:c,outcome:d,party:m,story_log:S,history:[]}}async function sc(t){const e=`?room_id=${encodeURIComponent(t)}`,n=await tt(`/api/v1/trpg/events${e}`);return Array.isArray(n.events)?n.events:[]}async function ic(t){const e=`?room_id=${encodeURIComponent(t)}`,[n,a]=await Promise.all([tt(`/api/v1/trpg/state${e}`),sc(t)]);return ac(n,a,t)}function oc(t){return Kt("/api/v1/trpg/rounds/run",{room_id:t})}function rc(t){const e="".trim().toLowerCase();if(e)switch(e){case"discussion":case"discuss":case"party_discussion":case"player_discussion":case"action":case"dice":return"round";case"ended":return"end";default:return e}}function lc(t){const e={room_id:t.roomId,actor_id:t.actorId,action:t.action,stat_value:t.statValue,dc:t.dc};return t.rawD20!=null&&(e.raw_d20=t.rawD20),t.ruleModule&&(e.rule_module=t.ruleModule),Kt("/api/v1/trpg/dice/roll",e)}function cc(t,e){const n=rc();return Kt("/api/v1/trpg/turns/advance",{room_id:t,...n?{phase:n}:{}})}function dc(t,e){var s;const n=(s=e.idempotencyKey)==null?void 0:s.trim(),a={room_id:t};return e.actor_id&&e.actor_id.trim()&&(a.actor_id=e.actor_id.trim()),e.name&&e.name.trim()&&(a.name=e.name.trim()),e.role&&(a.role=e.role),e.archetype&&e.archetype.trim()&&(a.archetype=e.archetype.trim()),e.persona&&e.persona.trim()&&(a.persona=e.persona.trim()),e.portrait&&e.portrait.trim()&&(a.portrait=e.portrait.trim()),e.background&&e.background.trim()&&(a.background=e.background.trim()),e.hp!=null&&(a.hp=e.hp),e.max_hp!=null&&(a.max_hp=e.max_hp),e.alive!=null&&(a.alive=e.alive),Array.isArray(e.traits)&&e.traits.length>0&&(a.traits=e.traits),Array.isArray(e.skills)&&e.skills.length>0&&(a.skills=e.skills),Array.isArray(e.inventory)&&e.inventory.length>0&&(a.inventory=e.inventory),e.stats&&Object.keys(e.stats).length>0&&(a.stats=e.stats),n&&(a.idempotency_key=n),Kt("/api/v1/trpg/actors/spawn",a,n?{"Idempotency-Key":n}:void 0)}function uc(t,e,n){return Kt("/api/v1/trpg/actors/claim",{room_id:t,actor_id:e,keeper:n})}async function pc(t,e,n){const a=await bt("trpg.join.eligibility",{room_id:t,actor_id:e,...n?{keeper_name:n}:{}});return JSON.parse(a)}async function mc(t){const e=await bt("trpg.mid_join.request",t);return JSON.parse(e)}async function qo(t,e){await bt("masc_broadcast",{agent_name:t,message:e})}async function vc(t,e,n=1){await bt("masc_add_task",{title:t,description:e,priority:n})}async function fc(t){return bt("masc_join",{agent_name:t})}async function Fo(t){await bt("masc_leave",{agent_name:t})}async function _c(t){await bt("masc_heartbeat",{agent_name:t})}async function gc(t=40){return(await bt("masc_messages",{limit:t})).split(`
`).map(n=>n.trim()).filter(n=>n!=="")}async function $c(t,e=20){return bt("masc_task_history",{task_id:t,limit:e})}async function hc(){return Be("fetchDebates",async()=>{const t=await tt("/api/v1/council/debates?limit=100");return Array.isArray(t.debates)?t.debates.map(e=>{if(!O(e))return null;const n=h(e.id,"").trim(),a=h(e.topic,"").trim();return!n||!a?null:{id:n,topic:a,status:h(e.status,"open"),argument_count:j(e.argument_count,0),created_at:qe(e.created_at_iso??e.created_at)}}).filter(e=>e!==null):[]})}async function yc(){return Be("fetchCouncilSessions",async()=>{const t=await tt("/api/v1/council/sessions?limit=100");return Array.isArray(t.sessions)?t.sessions.map(e=>{if(!O(e))return null;const n=h(e.id,"").trim(),a=h(e.topic,"").trim();return!n||!a?null:{id:n,topic:a,initiator:h(e.initiator,"system"),votes:j(e.votes,0),quorum:j(e.quorum,0),state:h(e.state,"open"),created_at:qe(e.created_at_iso??e.created_at)}}).filter(e=>e!==null):[]})}async function bc(t){const e=await bt("masc_debate_start",{topic:t});try{return JSON.parse(e)}catch{return null}}async function kc(t){return Be("fetchDebateStatus",async()=>{const e=encodeURIComponent(t),n=await tt(`/api/v1/council/debates/${e}/summary`);if(!O(n))return null;const a=h(n.id,"").trim();return a?{id:a,topic:h(n.topic,""),status:h(n.status,"open"),support_count:j(n.support_count,0),oppose_count:j(n.oppose_count,0),neutral_count:j(n.neutral_count,0),total_arguments:j(n.total_arguments,0),created_at:qe(n.created_at_iso??n.created_at),summary_text:h(n.summary_text,"")}:null})}function xc(t,e,n){return bt("masc_keeper_msg",{name:t,message:e})}async function Sc(){try{const t=await bt("masc_goal_list",{});if(typeof t=="string"){const e=JSON.parse(t);return Array.isArray(e)?e:e.goals??[]}return Array.isArray(t)?t:t.goals??[]}catch{return[]}}const rn=_(""),Bt=_({}),dt=_({}),Ms=_({}),Os=_({}),zs=_({}),js=_({}),Wt=_({});function ot(t,e,n){t.value={...t.value,[e]:n}}function Gt(t){return typeof t=="object"&&t!==null&&!Array.isArray(t)}function U(t){return typeof t=="string"&&t.trim()!==""?t.trim():void 0}function Rt(t){return typeof t=="number"&&Number.isFinite(t)?t:void 0}function Re(t){return typeof t=="boolean"?t:void 0}function qs(t){return typeof t=="string"&&t.trim()!==""?t:typeof t!="number"||!Number.isFinite(t)||t<=0?null:new Date(t*1e3).toISOString()}function Fs(t){return Array.isArray(t)?t.map(e=>U(e)).filter(e=>!!e):[]}function Ac(t){var n;const e=(n=U(t))==null?void 0:n.toLowerCase();return e==="user"||e==="assistant"||e==="system"||e==="tool"?e:"other"}function wc(t){switch(t){case"user":return"User";case"assistant":return"Keeper";case"system":return"System";case"tool":return"Tool";default:return"Event"}}function ts(t,e){if(!Array.isArray(t))return[];const n=[];for(const a of t){if(!Gt(a))continue;const s=U(a.name);if(!s)continue;const o=U(a[e]);e==="summary"?n.push({name:s,summary:o}):n.push({name:s,reason:o})}return n}function Cc(t){if(!Gt(t))return null;const e=U(t.name);return e?{name:e,trigger:U(t.trigger),outcome:U(t.outcome),summary:U(t.summary),reason:U(t.reason)}:null}function Tc(t){const e=t.toLowerCase();return e.includes("graphql")?"graphql_error":e.includes("timeout")||e.includes("model")||e.includes("llm")||e.includes("api key")||e.includes("api_key")||e.includes("provider")?"llm_error":"unknown"}function Nc(t,e){return t==="offline"||t==="degraded"||t==="stale"?"Keeper is not in a healthy reply state. Probe or recover before relying on automation.":e==="quiet_hours"?"Lodge quiet hours are active. Direct messages still work, but scheduled social ticks may look asleep.":e==="min_gap"?"Keeper is inside its proactive cooldown window. Direct messages work now; autonomous check-ins will wait.":e==="never_started"?"Keeper metadata exists but no reply turn has been recorded yet.":"Keeper is reachable. Send a direct message for an immediate response."}function Ko(t,e,n){return U(t)??Nc(e,n)}function Ho(t,e){return typeof t=="boolean"?t:e==="recover"}function ua(t){if(!Gt(t))return null;const e=U(t.health_state),n=U(t.next_action_path),a=U(t.last_reply_status);return!e||!n||!a?null:{health_state:e,quiet_reason:U(t.quiet_reason)??null,next_action_path:n,last_reply_status:a,last_reply_at:qs(t.last_reply_at),last_reply_preview:U(t.last_reply_preview)??null,last_error:U(t.last_error)??null,next_eligible_at_s:Rt(t.next_eligible_at_s)??null,recoverable:Ho(t.recoverable,n),summary:Ko(t.summary,e,U(t.quiet_reason)??null),keepalive_running:typeof t.keepalive_running=="boolean"?t.keepalive_running:void 0}}function yi(t){return Gt(t)?{hour:Rt(t.hour),checked:Rt(t.checked)??0,acted:Rt(t.acted)??0,acted_names:Fs(t.acted_names),activity_report:U(t.activity_report),quiet_hours_overridden:Re(t.quiet_hours_overridden),skipped_reason:U(t.skipped_reason),acted_rows:ts(t.acted_rows,"summary").map(e=>({name:e.name,summary:e.summary})),passed_rows:ts(t.passed_rows,"reason").map(e=>({name:e.name,reason:e.reason})),skipped_rows:ts(t.skipped_rows,"reason").map(e=>({name:e.name,reason:e.reason})),checkins:Array.isArray(t.checkins)?t.checkins.map(Cc).filter(e=>e!==null):[]}:null}function Rc(t){return Gt(t)?{enabled:Re(t.enabled)??!1,interval_s:Rt(t.interval_s)??0,quiet_start:Rt(t.quiet_start),quiet_end:Rt(t.quiet_end),quiet_active:Re(t.quiet_active),use_planner:Re(t.use_planner),delegate_llm:Re(t.delegate_llm),agent_count:Rt(t.agent_count),agents:Fs(t.agents),last_tick_ago_s:Rt(t.last_tick_ago_s)??null,last_tick_ago:U(t.last_tick_ago),total_ticks:Rt(t.total_ticks),total_checkins:Rt(t.total_checkins),last_skip_reason:U(t.last_skip_reason)??null,last_tick_result:yi(t.last_tick_result),active_self_heartbeats:Fs(t.active_self_heartbeats)}:null}function Lc(t){return Gt(t)?{status:t.status,diagnostic:ua(t.diagnostic)}:null}function Pc(t){return Gt(t)?{recovered:Re(t.recovered)??!1,skipped_reason:U(t.skipped_reason)??null,before:ua(t.before),after:ua(t.after),down:t.down,up:t.up}:null}function Dc(t,e){var K,E;if(!(t!=null&&t.name))return null;const n=U((K=t.agent)==null?void 0:K.status)??U(t.status)??"unknown",a=U((E=t.agent)==null?void 0:E.error)??null,s=t.presence_keepalive??!0,o=t.keepalive_running??!1,r=t.turn_count??0,l=t.last_turn_ago_s??null,p=t.proactive_enabled??!1,$=t.proactive_cooldown_sec??0,m=t.last_proactive_ago_s??null,d=p&&m!=null?Math.max(0,$-m):null,v=r<=0||l==null?"never":l>900?"stale":"fresh",c=typeof t.last_heartbeat=="string"&&t.last_heartbeat.trim()?t.last_heartbeat:null,y=a??(s&&!o?"keeper keepalive is not running":null),S=n==="offline"||n==="inactive"?"offline":y?"degraded":v==="stale"?"stale":v==="never"?"idle":"healthy",T=y?Tc(y):e!=null&&e.quiet_active&&v!=="fresh"?"quiet_hours":s&&!o?"disabled":r<=0?"never_started":d!=null&&d>0?"min_gap":v==="fresh"||v==="stale"?"no_recent_activity":"unknown",P=S==="offline"||S==="degraded"||S==="stale"?"recover":T==="quiet_hours"?"manual_lodge_poke":T==="unknown"?"probe":"direct_message";return{health_state:S,quiet_reason:T,next_action_path:P,last_reply_status:v,last_reply_at:c,last_reply_preview:null,last_error:y,next_eligible_at_s:d!=null&&d>0?d:null,recoverable:Ho(void 0,P),summary:Ko(void 0,S,T),keepalive_running:o}}function Ec(t,e){if(!Gt(t))return null;const n=Ac(t.role),a=U(t.content)??U(t.preview);if(!a)return null;const s=qs(t.ts_unix)??qs(t.timestamp);return{id:`${n}-${s??"entry"}-${e}`,role:n,label:wc(n),text:a,timestamp:s,delivery:"history"}}function Ic(t,e,n){const a=Gt(n)?n:null,s=Array.isArray(a==null?void 0:a.history_tail)?a.history_tail.map((o,r)=>Ec(o,r)).filter(o=>o!==null):[];return{name:t,diagnostic:ua(a==null?void 0:a.diagnostic),history:s,rawText:e,rawStatus:n,loadedAt:new Date().toISOString()}}function Ui(t,e){const n=dt.value[t]??[];dt.value={...dt.value,[t]:[...n,e].slice(-50)}}function Mc(t,e){return t.role!==e.role||t.text!==e.text?!1:t.timestamp&&e.timestamp?t.timestamp===e.timestamp:!0}function Oc(t,e){const a=(dt.value[t]??[]).filter(s=>s.delivery!=="history"&&!e.some(o=>Mc(s,o)));dt.value={...dt.value,[t]:[...e,...a].slice(-50)}}function Ga(t,e){Bt.value={...Bt.value,[t]:e},Oc(t,e.history)}function Bi(t,e){const n=Bt.value[t];if(!n)return;const a=n.diagnostic??{health_state:"idle",next_action_path:"direct_message",last_reply_status:"unknown"};Ga(t,{...n,diagnostic:{...a,...e}})}async function bi(){Fe();try{await ne()}catch(t){console.warn("[keeper-runtime] dashboard refresh failed",t)}}function Xn(t){rn.value=t.trim()}async function Uo(t,e=!1){const n=t.trim();if(!n)return null;if(!e&&Bt.value[n])return Bt.value[n];ot(Ms,n,!0),ot(Wt,n,null);try{const a=await bt("masc_keeper_status",{name:n,fast:!1,include_context:!0,include_metrics_overview:!0,include_memory_bank:!1,include_history_tail:!0,include_compaction_history:!1,tail_turns:5,tail_messages:10});let s=null;try{s=JSON.parse(a)}catch{s=null}const o=Ic(n,a,s);return Ga(n,o),o}catch(a){const s=a instanceof Error?a.message:`Failed to inspect ${n}`;return ot(Wt,n,s),null}finally{ot(Ms,n,!1)}}async function zc(t,e){const n=t.trim(),a=e.trim();if(!n||!a)return;const s=`local-${Date.now()}`;Ui(n,{id:s,role:"user",label:"You",text:a,timestamp:new Date().toISOString(),delivery:"sending"}),ot(Os,n,!0),ot(Wt,n,null);try{const o=await xc(n,a);dt.value={...dt.value,[n]:(dt.value[n]??[]).map(r=>r.id===s?{...r,delivery:"delivered"}:r)},Ui(n,{id:`reply-${Date.now()}`,role:"assistant",label:n,text:o.trim()||"(empty reply)",timestamp:new Date().toISOString(),delivery:"delivered"}),Bi(n,{last_reply_status:"delivered",last_reply_at:new Date().toISOString(),last_reply_preview:(o.trim()||"(empty reply)").slice(0,200),last_error:null}),await bi()}catch(o){const r=o instanceof Error?o.message:`Failed to send direct message to ${n}`;throw dt.value={...dt.value,[n]:(dt.value[n]??[]).map(l=>l.id===s?{...l,delivery:"error",error:r}:l)},Bi(n,{last_reply_status:"error",last_error:r}),ot(Wt,n,r),o}finally{ot(Os,n,!1)}}async function jc(t,e){const n=t.trim();if(!n)return null;ot(zs,n,!0),ot(Wt,n,null);try{const a=await On({actor:e,action_type:"keeper_probe",target_type:"keeper",target_id:n,payload:{}}),s=Lc(a.result),o=(s==null?void 0:s.diagnostic)??null;if(o){const r=Bt.value[n];Ga(n,{name:n,diagnostic:o,history:(r==null?void 0:r.history)??dt.value[n]??[],rawText:(r==null?void 0:r.rawText)??"",rawStatus:a.result,loadedAt:new Date().toISOString()})}return await bi(),o}catch(a){const s=a instanceof Error?a.message:`Failed to probe ${n}`;throw ot(Wt,n,s),a}finally{ot(zs,n,!1)}}async function qc(t,e){const n=t.trim();if(!n)return null;ot(js,n,!0),ot(Wt,n,null);try{const a=await On({actor:e,action_type:"keeper_recover",target_type:"keeper",target_id:n,payload:{}}),s=Pc(a.result),o=(s==null?void 0:s.after)??null;if(o){const r=Bt.value[n];Ga(n,{name:n,diagnostic:o,history:(r==null?void 0:r.history)??dt.value[n]??[],rawText:(r==null?void 0:r.rawText)??"",rawStatus:a.result,loadedAt:new Date().toISOString()})}return await bi(),o}catch(a){const s=a instanceof Error?a.message:`Failed to recover ${n}`;throw ot(Wt,n,s),a}finally{ot(js,n,!1)}}function ce(t){return(t??"").trim().toLowerCase()}function _t(t){const e=typeof t=="number"?t:Date.parse(t);return Number.isNaN(e)?0:e}function Zn(t,e=88){const n=t.replace(/\s+/g," ").trim();return n&&(n.length>e?`${n.slice(0,e-3)}...`:n)}function Fn(t){return typeof t!="number"||!Number.isFinite(t)||t<0?null:new Date(Date.now()-t*1e3).toISOString()}function Xe(t){return t.last_heartbeat??Fn(t.last_turn_ago_s)??Fn(t.last_proactive_ago_s)??Fn(t.last_handoff_ago_s)??Fn(t.last_compaction_ago_s)}function Fc(t){const e=t.title.trim();return e||Zn(t.content)}function Kc(t){const e=t.generation??"?",n=typeof t.context_ratio=="number"&&Number.isFinite(t.context_ratio)?`${Math.round(t.context_ratio*100)}%`:"?";return t.last_heartbeat?`Heartbeat gen=${e} ctx=${n}`:`Keeper snapshot gen=${e} ctx=${n}`}function Hc(t,e,n,a,s={}){var E;const o=ce(t),r=e.filter(N=>ce(N.assignee)===o&&(N.status==="claimed"||N.status==="in_progress")).length,l=n.filter(N=>ce(N.from)===o).sort((N,R)=>_t(R.timestamp)-_t(N.timestamp))[0],p=a.filter(N=>ce(N.agent)===o||ce(N.author)===o).sort((N,R)=>_t(R.timestamp)-_t(N.timestamp))[0],$=(s.boardPosts??[]).filter(N=>ce(N.author)===o).sort((N,R)=>_t(R.updated_at||R.created_at)-_t(N.updated_at||N.created_at))[0],m=(s.keepers??[]).filter(N=>ce(N.name)===o&&Xe(N)!==null).sort((N,R)=>_t(Xe(R)??0)-_t(Xe(N)??0))[0],d=l?_t(l.timestamp):0,v=p?_t(p.timestamp):0,c=$?_t($.updated_at||$.created_at):0,y=m?_t(Xe(m)??0):0,S=s.lastSeen?_t(s.lastSeen):0,T=((E=s.currentTask)==null?void 0:E.trim())||(r>0?`${r} claimed tasks`:null);if(d===0&&v===0&&c===0&&y===0&&S===0)return{activeAssignedCount:r,lastActivityAt:null,lastActivityText:T};const K=[l?{timestamp:l.timestamp,ts:d,text:Zn(l.content)}:null,$?{timestamp:$.updated_at||$.created_at,ts:c,text:`Post: ${Zn(Fc($))}`}:null,m?{timestamp:Xe(m),ts:y,text:Kc(m)}:null,p?{timestamp:new Date(p.timestamp).toISOString(),ts:v,text:Zn(p.text)}:null].filter(N=>N!==null).sort((N,R)=>R.ts-N.ts)[0];return K&&K.ts>=S?{activeAssignedCount:r,lastActivityAt:K.timestamp,lastActivityText:K.text}:{activeAssignedCount:r,lastActivityAt:s.lastSeen??null,lastActivityText:T??"Presence heartbeat"}}const wt=_([]),yt=_([]),Sn=_([]),Jt=_([]),se=_(null),an=_(null),Ks=_(new Map),We=_([]),An=_("hot"),ue=_(!0),Bo=_(null),Ut=_(""),wn=_([]),Le=_(!1),Wo=_(new Map),Hs=_("unknown"),Us=_(null),Bs=_(!1),Cn=_(!1),Ws=_(!1),Pe=_(!1),Uc=_(null),Gs=_(null),Go=_(null),Jo=_(null),Bc=Ct(()=>wt.value.filter(t=>t.status==="active"||t.status==="busy"||t.status==="listening"||t.status==="idle")),Vo=Ct(()=>{const t=yt.value;return{todo:t.filter(e=>e.status==="todo"),inProgress:t.filter(e=>e.status==="in_progress"||e.status==="claimed"),done:t.filter(e=>e.status==="done")}}),Ja=Ct(()=>{const t=new Map,e=yt.value,n=Sn.value,a=da.value,s=We.value,o=Jt.value;for(const r of wt.value)t.set(r.name.trim().toLowerCase(),Hc(r.name,e,n,a,{currentTask:r.current_task,lastSeen:r.last_seen,boardPosts:s,keepers:o}));return t});function Wc(t){var o;const e=((o=t.status)==null?void 0:o.toLowerCase())??"";if(e==="offline"||e==="inactive")return"offline";const n=t.metrics_series;if(!n||n.length===0)return"idle";const a=n[n.length-1];if(!a)return"idle";if(a.is_handoff)return"handoff-imminent";if(a.is_compaction)return"compacting";const s=a.context_ratio;return s>.85?"handoff-imminent":s>.7?"preparing":s>.5?"compacting":"active"}const Qo=Ct(()=>{const t=new Map;for(const e of Jt.value)t.set(e.name,Wc(e));return t}),Gc=12e4;function Jc(t,e){const n=e.get(t.name);if(n!=null)return n;const a=t.last_heartbeat?Date.parse(t.last_heartbeat):Number.NaN;if(!Number.isNaN(a))return a;const s=[t.last_turn_ago_s,t.last_proactive_ago_s,t.last_handoff_ago_s,t.last_compaction_ago_s].find(o=>typeof o=="number"&&Number.isFinite(o)&&o>=0);return typeof s=="number"?Date.now()-s*1e3:null}const Yo=Ct(()=>{const t=Date.now(),e=new Set,n=Ks.value;for(const a of Jt.value){const s=Jc(a,n);s!=null&&t-s>Gc&&e.add(a.name)}return e}),pa={},Vc=5e3;let es=null;function Qc(t){return t==="dashboard_refresh"||t==="masc/dashboard_refresh"||t.startsWith("goal_")||t.startsWith("masc/goal_")||t.startsWith("mdal_")||t.startsWith("masc/mdal_")||t.startsWith("operator_")||t.startsWith("masc/operator_")||t.startsWith("command_plane_")||t.startsWith("masc/command_plane_")}function Fe(){delete pa.compact,delete pa.full}function ut(t){return typeof t=="object"&&t!==null}function b(t){return typeof t=="string"&&t.trim()!==""?t:void 0}function A(t){return typeof t=="number"&&Number.isFinite(t)?t:void 0}function _e(t){if(!Array.isArray(t))return;const e=t.filter(n=>typeof n=="string"&&n.trim()!=="");return e.length>0?e:void 0}function Js(t){if(typeof t=="string"&&t.trim()!=="")return t;if(!(typeof t!="number"||!Number.isFinite(t)||t<=0))return new Date(t*1e3).toISOString()}function Xo(t){const e=typeof t=="string"?t.toLowerCase():"";return e==="active"||e==="busy"||e==="listening"||e==="idle"||e==="inactive"||e==="offline"?e:e==="in_progress"||e==="claimed"?"busy":"offline"}function Yc(t){const e=typeof t=="string"?t.toLowerCase():"";return e==="todo"||e==="in_progress"||e==="claimed"||e==="done"||e==="cancelled"?e:e==="inprogress"?"in_progress":"todo"}function Zo(t){if(!ut(t))return null;const e=b(t.name);return e?{name:e,status:Xo(t.status),current_task:b(t.current_task)??null,last_seen:b(t.last_seen),emoji:b(t.emoji),koreanName:b(t.koreanName)??b(t.korean_name),model:b(t.model),traits:_e(t.traits),interests:_e(t.interests),activityLevel:A(t.activityLevel)??A(t.activity_level),primaryValue:b(t.primaryValue)??b(t.primary_value)}:null}function tr(t){if(!ut(t))return null;const e=b(t.id),n=b(t.title);return!e||!n?null:{id:e,title:n,status:Yc(t.status),priority:A(t.priority),assignee:b(t.assignee),description:b(t.description),created_at:b(t.created_at),updated_at:b(t.updated_at)}}function er(t){if(!ut(t))return null;const e=b(t.from)??b(t.from_agent)??"system",n=b(t.content)??"",a=b(t.timestamp)??new Date().toISOString();return{id:b(t.id),seq:A(t.seq),from:e,content:n,timestamp:a,type:b(t.type)}}function Xc(t){return Array.isArray(t)?t.map(e=>{if(!ut(e))return null;const n=A(e.ts_unix);if(n==null)return null;const a=ut(e.handoff)?e.handoff:null;return{ts:n,context_ratio:A(e.context_ratio)??0,context_tokens:A(e.context_tokens)??0,context_max:A(e.context_max)??0,latency_ms:A(e.latency_ms)??0,generation:A(e.generation)??0,channel:typeof e.channel=="string"?e.channel:"turn",is_handoff:a!=null&&e.handoff_performed===!0,is_compaction:e.compacted===!0,compaction_saved_tokens:A(e.compaction_saved_tokens)??0,compaction_trigger:typeof e.compaction_trigger=="string"?e.compaction_trigger:null,model_used:typeof e.model_used=="string"?e.model_used:"",cost_usd:A(e.cost_usd)??0,handoff_to_model:a&&typeof a.to_model=="string"?a.to_model:null,handoff_new_generation:a?A(a.new_generation)??null:null}}).filter(e=>e!==null):[]}function Wi(t){if(!ut(t))return null;const e=b(t.health_state),n=b(t.next_action_path),a=b(t.last_reply_status);if(!e||!n||!a)return null;const s=b(t.quiet_reason)??null,o=b(t.summary)??(e==="offline"||e==="degraded"||e==="stale"?"Keeper is not in a healthy reply state. Probe or recover before relying on automation.":s==="quiet_hours"?"Lodge quiet hours are active. Direct messages still work, but scheduled social ticks may look asleep.":s==="min_gap"?"Keeper is inside its proactive cooldown window. Direct messages work now; autonomous check-ins will wait.":s==="never_started"?"Keeper metadata exists but no reply turn has been recorded yet.":"Keeper is reachable. Send a direct message for an immediate response.");return{health_state:e,quiet_reason:s,next_action_path:n,last_reply_status:a,last_reply_at:Js(t.last_reply_at)??b(t.last_reply_at)??null,last_reply_preview:b(t.last_reply_preview)??null,last_error:b(t.last_error)??null,next_eligible_at_s:A(t.next_eligible_at_s)??null,recoverable:typeof t.recoverable=="boolean"?t.recoverable:n==="recover",summary:o,keepalive_running:typeof t.keepalive_running=="boolean"?t.keepalive_running:void 0}}function Zc(t,e){return(Array.isArray(t)?t:ut(t)&&Array.isArray(t.keepers)?t.keepers:[]).map(a=>{if(!ut(a))return null;const s=ut(a.agent)?a.agent:null,o=ut(a.context)?a.context:null,r=ut(a.metrics_window)?a.metrics_window:void 0,l=b(a.name);if(!l)return null;const p=A(a.context_ratio)??A(o==null?void 0:o.context_ratio),$=b(a.status)??b(s==null?void 0:s.status)??"offline",m=Xo($),d=b(a.model)??b(a.active_model)??b(a.primary_model),v=_e(a.skill_secondary),c=o?{source:b(o.source),context_ratio:A(o.context_ratio),context_tokens:A(o.context_tokens),context_max:A(o.context_max),message_count:A(o.message_count),has_checkpoint:typeof o.has_checkpoint=="boolean"?o.has_checkpoint:void 0}:void 0,y=s?{name:b(s.name),exists:typeof s.exists=="boolean"?s.exists:void 0,error:b(s.error),status:b(s.status),current_task:b(s.current_task)??null,last_seen:b(s.last_seen),last_seen_ago_s:A(s.last_seen_ago_s),is_zombie:typeof s.is_zombie=="boolean"?s.is_zombie:void 0}:void 0,S=Xc(a.metrics_series),T={name:l,emoji:b(a.emoji),koreanName:b(a.koreanName)??b(a.korean_name),agent_name:b(a.agent_name),trace_id:b(a.trace_id),model:d,primary_model:b(a.primary_model),active_model:b(a.active_model),next_model_hint:b(a.next_model_hint)??null,status:m,presence_keepalive:typeof a.presence_keepalive=="boolean"?a.presence_keepalive:void 0,presence_keepalive_sec:A(a.presence_keepalive_sec),keepalive_running:typeof a.keepalive_running=="boolean"?a.keepalive_running:void 0,proactive_enabled:typeof a.proactive_enabled=="boolean"?a.proactive_enabled:void 0,proactive_idle_sec:A(a.proactive_idle_sec),proactive_cooldown_sec:A(a.proactive_cooldown_sec),last_heartbeat:b(a.last_heartbeat)??b(s==null?void 0:s.last_seen),generation:A(a.generation),turn_count:A(a.turn_count)??A(a.total_turns),keeper_age_s:A(a.keeper_age_s),last_turn_ago_s:A(a.last_turn_ago_s),last_handoff_ago_s:A(a.last_handoff_ago_s),last_compaction_ago_s:A(a.last_compaction_ago_s),last_proactive_ago_s:A(a.last_proactive_ago_s),context_ratio:p,context_tokens:A(a.context_tokens)??A(o==null?void 0:o.context_tokens),context_max:A(a.context_max)??A(o==null?void 0:o.context_max),context_source:b(a.context_source)??b(o==null?void 0:o.source),context:c,traits:_e(a.traits),interests:_e(a.interests),primaryValue:b(a.primaryValue)??b(a.primary_value),activityLevel:A(a.activityLevel)??A(a.activity_level),memory_recent_note:b(a.memory_recent_note)??null,conversation_tail_count:A(a.conversation_tail_count),k2k_count:A(a.k2k_count),handoff_count_total:A(a.handoff_count_total)??A(a.trace_history_count),compaction_count:A(a.compaction_count),last_compaction_saved_tokens:A(a.last_compaction_saved_tokens),diagnostic:Wi(a.diagnostic),skill_primary:b(a.skill_primary)??null,skill_secondary:v,skill_reason:b(a.skill_reason)??null,metrics_series:S.length>0?S:void 0,metrics_window:r,agent:y};return T.diagnostic=Wi(a.diagnostic)??Dc(T,(e==null?void 0:e.lodge)??null),T}).filter(a=>a!==null)}function td(t){return ut(t)?{...t,lodge:Rc(t.lodge)??void 0}:null}function ed(t){const e=typeof t=="string"?t.toLowerCase():"";return e==="running"||e==="interrupted"||e==="completed"||e==="stopped"||e==="error"?e:e.startsWith("error")?"error":"running"}function nd(t){if(!ut(t))return null;const e=A(t.iteration);if(e==null)return null;const n=A(t.metric_before)??0,a=A(t.metric_after)??n,s=ut(t.evidence)?t.evidence:null;return{iteration:e,metric_before:n,metric_after:a,delta:A(t.delta)??a-n,changes:b(t.changes)??"",failed_attempts:b(t.failed_attempts)??"",next_suggestion:b(t.next_suggestion)??"",elapsed_ms:A(t.elapsed_ms)??0,cost_usd:A(t.cost_usd)??null,evidence:s?{worker_engine:(s.worker_engine==="api_tool_loop","api_tool_loop"),worker_model:b(s.worker_model)??"",tool_call_count:A(s.tool_call_count)??0,tool_names:_e(s.tool_names)??[],session_id:b(s.session_id)??"",evidence_status:s.evidence_status==="legacy_unverified"?"legacy_unverified":"verified"}:null}}function ad(t){var o,r;if(!ut(t))return null;const e=b(t.loop_id);if(!e)return null;const n=A(t.baseline_metric)??0,a=Array.isArray(t.history)?t.history.map(nd).filter(l=>l!==null):[],s=A(t.current_metric)??((o=a[0])==null?void 0:o.metric_after)??n;return{loop_id:e,profile:b(t.profile)??"unknown",status:ed(t.status),strict_mode:typeof t.strict_mode=="boolean"?t.strict_mode:void 0,error_message:b(t.error_message)??b(t.error_reason)??null,stop_reason:b(t.stop_reason)??b(t.reason)??null,current_iteration:A(t.current_iteration)??((r=a[0])==null?void 0:r.iteration)??0,max_iterations:A(t.max_iterations)??0,baseline_metric:n,current_metric:s,target:b(t.target)??"",stagnation_streak:A(t.stagnation_streak)??0,stagnation_limit:A(t.stagnation_limit)??0,elapsed_seconds:A(t.elapsed_seconds)??0,updated_at:Js(t.updated_at)??null,stopped_at:Js(t.stopped_at)??null,execution_mode:t.execution_mode==="worker_spawn"?"worker_spawn":void 0,worker_engine:t.worker_engine==="api_tool_loop"?"api_tool_loop":null,worker_model:b(t.worker_model)??null,evidence_policy:t.evidence_policy==="hard"||t.evidence_policy==="legacy"?t.evidence_policy:void 0,latest_tool_call_count:A(t.latest_tool_call_count)??0,latest_tool_names:_e(t.latest_tool_names)??[],session_id:b(t.session_id)??null,evidence_status:t.evidence_status==="legacy_unverified"?"legacy_unverified":t.evidence_status==="verified"?"verified":null,durability:t.durability==="persistent_backend"||t.durability==="memory_only"?t.durability:void 0,persistence_backend:t.persistence_backend==="filesystem"||t.persistence_backend==="postgres"||t.persistence_backend==="memory"?t.persistence_backend:void 0,recoverable:typeof t.recoverable=="boolean"?t.recoverable:void 0,history:a}}async function ne(t="full"){var a,s,o;const e=Date.now(),n=pa[t];if(!(n&&e-n.time<Vc)){Bs.value=!0;try{const r=await kl(t);pa[t]={data:r,time:e},wt.value=(Array.isArray((a=r.agents)==null?void 0:a.agents)?r.agents.agents:[]).map(Zo).filter(p=>p!==null),yt.value=(Array.isArray((s=r.tasks)==null?void 0:s.tasks)?r.tasks.tasks:[]).map(tr).filter(p=>p!==null),Sn.value=(Array.isArray((o=r.messages)==null?void 0:o.messages)?r.messages.messages:[]).map(er).filter(p=>p!==null);const l=td(r.status);se.value=l,Jt.value=Zc(r.keepers,l),an.value=r.perpetual??null,Uc.value=new Date().toISOString()}catch(r){console.error("Dashboard fetch error:",r)}finally{Bs.value=!1}}}async function sd(){try{const t=await xl(),e=(Array.isArray(t.agents)?t.agents:[]).map(Zo).filter(s=>s!==null),n=wt.value,a=new Map(n.map(s=>[s.name,s]));wt.value=e.map(s=>{const o=a.get(s.name);return o?{...o,status:s.status,current_task:s.current_task}:s})}catch(t){console.error("Agents selective fetch error:",t)}}async function id(){try{const t=await Sl({includeDone:!0,includeCancelled:!0}),e=(Array.isArray(t.tasks)?t.tasks:[]).map(tr).filter(s=>s!==null),n=yt.value,a=new Map(n.map(s=>[s.id,s]));yt.value=e.map(s=>{const o=a.get(s.id);return o?{...o,status:s.status,priority:s.priority??o.priority,assignee:s.assignee??o.assignee}:s})}catch(t){console.error("Tasks selective fetch error:",t)}}async function od(){try{const t=Sn.value,e=t.reduce((l,p)=>Math.max(l,p.seq??0),0),n=await Al(e),a=(Array.isArray(n.messages)?n.messages:[]).map(er).filter(l=>l!==null);if(a.length===0)return;const s=new Set(t.map(l=>l.seq).filter(l=>l!=null)),o=new Set(t.filter(l=>l.seq==null).map(l=>`${l.timestamp}|${l.from}`)),r=a.filter(l=>{if(l.seq!=null)return!s.has(l.seq);const p=`${l.timestamp}|${l.from}`;return o.has(p)?!1:(o.add(p),!0)});if(r.length>0){const l=[...t,...r];Sn.value=l.length>500?l.slice(-500):l}}catch(t){console.error("Messages selective fetch error:",t)}}async function jt(){Cn.value=!0;try{const t=await Kl(An.value,{excludeSystem:ue.value});We.value=t.posts??[],Gs.value=new Date().toISOString()}catch(t){console.error("Board fetch error:",t)}finally{Cn.value=!1}}async function qt(){var t;Ws.value=!0;try{const e=Ut.value||((t=se.value)==null?void 0:t.room)||"default";Ut.value||(Ut.value=e);const n=await ic(e);Bo.value=n}catch(e){console.error("TRPG fetch error:",e)}finally{Ws.value=!1}}async function Tn(){Le.value=!0;try{const t=await Sc();wn.value=Array.isArray(t)?t:[],Go.value=new Date().toISOString()}catch(t){console.error("Goals fetch error:",t)}finally{Le.value=!1}}async function Ke(){Pe.value=!0;try{const t=await wl(),e=Array.isArray(t.loops)?t.loops:[],n=new Map;for(const a of e){const s=ad(a);s&&n.set(s.loop_id,s)}Wo.value=n,Jo.value=new Date().toISOString(),Us.value=null,Hs.value=n.size===0?"idle":"ready"}catch(t){console.error("MDAL fetch error:",t),Hs.value="error",Us.value=t instanceof Error?t.message:String(t)}finally{Pe.value=!1}}let ta=null;function rd(t){ta=t}let ea=null;function ld(t){ea=t}const pe={};function de(t,e,n=500){pe[t]&&clearTimeout(pe[t]),pe[t]=setTimeout(()=>{e(),delete pe[t]},n)}function cd(){const t=Po.subscribe(e=>{if(e){if(e.type==="keeper_heartbeat"&&e.name){const n=new Map(Ks.value);n.set(e.name,e.ts_unix?e.ts_unix*1e3:Date.now()),Ks.value=n;return}(e.type==="agent_joined"||e.type==="agent_left")&&de("agents",sd),Qc(e.type)&&(Fe(),es||(es=setTimeout(()=>{ne(),ea==null||ea(),es=null},500))),(e.type.startsWith("task_")||e.type.startsWith("masc/task_"))&&de("tasks",id),e.type==="broadcast"&&de("messages",od),(e.type==="keeper_handoff"||e.type==="keeper_compaction"||e.type==="keeper_guardrail")&&de("dashboard",()=>{Fe(),ne()}),(e.type==="board_post"||e.type==="masc/board_post"||e.type==="board_comment"||e.type==="masc/board_comment")&&de("board",jt),e.type.startsWith("decision_")&&de("council",()=>ta==null?void 0:ta()),(e.type==="mdal_started"||e.type==="mdal_iteration"||e.type==="mdal_completed"||e.type==="mdal_stopped")&&de("mdal",Ke,350)}});return()=>{t();for(const e of Object.keys(pe))clearTimeout(pe[e]),delete pe[e]}}let ln=null;function dd(){ln||(ln=setInterval(()=>{Ft.value||Fe(),ne()},1e4))}function ud(){ln&&(clearInterval(ln),ln=null)}function C({title:t,class:e,children:n}){return i`
    <div class="card ${e??""}">
  ...
  `}const _d="masc_dashboard_agent_name",Ge=_(null),ma=_(!1),Nn=_(""),va=_([]),Rn=_([]),Ie=_(""),cn=_(!1);function Me(t){Ge.value=t,xi()}function Gi(){Ge.value=null,Nn.value="",va.value=[],Rn.value=[],Ie.value=""}function gd(){const t=Ge.value;return t?wt.value.find(e=>e.name===t)??null:null}function nr(t){return t?yt.value.filter(e=>e.assignee===t):[]}async function xi(){const t=Ge.value;if(t){ma.value=!0,Nn.value="",va.value=[],Rn.value=[];try{const e=await gc(80);va.value=e.filter(s=>s.includes(t)).slice(0,20);const n=nr(t).slice(0,6);if(n.length===0)return;const a=await Promise.all(n.map(async s=>{try{const o=await $c(s.id,25);return{taskId:s.id,text:o.trim()}}catch(o){const r=o instanceof Error?o.message:"history load failed";return{taskId:s.id,text:`Failed to load history: ${r}`}}}));Rn.value=a}catch(e){Nn.value=e instanceof Error?e.message:"Failed to load agent detail"}finally{ma.value=!1}}}async function Ji(){var a;const t=Ge.value,e=Ie.value.trim();if(!t||!e)return;const n=((a=localStorage.getItem(_d))==null?void 0:a.trim())||"dashboard";cn.value=!0;try{await qo(n,`@${t} ${e}`),Ie.value="",w(`Mention sent to ${t}`,"success"),xi()}catch(s){const o=s instanceof Error?s.message:"Failed to send mention";w(o,"error")}finally{cn.value=!1}}function $d({task:t}){return i`
  ...
  `}function yd(){var s,o,r,l;const t=Ge.value;if(!t)return null;const e=gd(),n=nr(t),a=va.value;return i`
    <div
      class="agent-detail-overlay"
      onClick=${p=>{p.target.classList.contains("agent-detail-overlay")&&Gi()}}
    >
      <div class="agent-detail-modal">
        <div class="agent-detail-header">
          ...
          <div class="agent-detail-actions">
            <button class="control-btn ghost" onClick=${()=>{xi()}} disabled=${ma.value}>
              ${ma.value?"Refreshing...":"Refresh"}
            </button>
            <button class="control-btn ghost" onClick=${Gi}>Close</button>
          </div>
        </div>
        ...
        <${C} title="Task History">
          ${Rn.value.length===0?i`<div class="empty-state">No task history loaded</div>`:i`<div class="agent-history-list">${Rn.value.map(p=>i`<${hd} key=${p.taskId} row=${p} />`)}</div>`}
        <//>
        ...
        <${C} title="Direct Mention">
          <div class="agent-mention-row">
            <input
              ...
              onKeyDown=${p=>{p.key==="Enter"&&Ji()}}
              disabled=${cn.value}
            />
            <button
              class="control-btn"
              onClick=${()=>{Ji()}}
              disabled=${cn.value||Ie.value.trim()===""}
            >
    ...
    <div class="execution-alert ${t.tone}">
      ...
      <div class="monitor-alert-meta">
        <span class="monitor-pill ${t.tone}">
          ${t.kind==="task"?ki(t.taskRow.task.priority):sr(t.agentRow.state)}
        </span>
  ...
  `}function Qi({row:t}){var e;return i`
  ...
  `}function Ad(){const t=wt.value,e=yt.value,n=new Map(t.map(d=>[me(d.name),d])),a=Ja.value,s=e.filter(d=>d.status==="claimed"||d.status==="in_progress").map(d=>Vi(d,n,a)).sort((d,v)=>{const c=st(v.tone)-st(d.tone);return c!==0?c:Q(v.lastSignalAt??v.lastTouchedAt)-Q(d.lastSignalAt??d.lastTouchedAt)}),o=e.filter(d=>d.status==="todo").map(d=>Vi(d,n,a)).sort((d,v)=>{const c=st(v.tone)-st(d.tone);if(c!==0)return c;const y=zt(d.task.priority)-zt(v.task.priority);return y!==0?y:Q(d.lastTouchedAt)-Q(v.lastTouchedAt)}),r=t.map(d=>kd(d,a)).filter(d=>d.state==="dispatchable"||d.state==="drift"||d.state==="quiet").sort((d,v)=>{if(d.state==="dispatchable"&&v.state!=="dispatchable")return-1;if(v.state==="dispatchable"&&d.state!=="dispatchable")return 1;const c=st(v.tone)-st(d.tone);return c!==0?c:Q(v.lastSignalAt)-Q(d.lastSignalAt)}),l=[...s.filter(d=>d.tone!=="ok").map(d=>({kind:"task",key:`active-${d.task.id}`,tone:d.tone,title:d.task.title,subtitle:`${d.note} · ${d.focus}`,timestamp:d.lastSignalAt??d.lastTouchedAt,taskRow:d})),...o.filter(d=>d.tone==="bad").map(d=>({kind:"task",key:`ready-${d.task.id}`,tone:d.tone,title:d.task.title,subtitle:`${d.note} · ${d.focus}`,timestamp:d.lastTouchedAt,taskRow:d})),...r.filter(d=>d.state==="drift"||d.tone==="bad").map(d=>({kind:"agent",key:`agent-${d.agent.name}`,tone:d.tone,title:d.agent.name,subtitle:`${d.note} · ${d.focus}`,timestamp:d.lastSignalAt,agentRow:d}))].sort((d,v)=>{const c=st(v.tone)-st(d.tone);return c!==0?c:Q(v.timestamp)-Q(d.timestamp)}).slice(0,8),p=r.filter(d=>d.state==="dispatchable"),$=[...s,...o].filter(d=>d.ownerGap),m=s.filter(d=>d.quiet);return i`
    <div class="agents-monitor">
      ...
      <div class="grid-2col">
        <${C} title="Ready Queue 대기열" class="section">
          ...
          <div class="monitor-list">
            ${o.length===0?i`<div class="empty-state">No ready tasks in the queue</div>`:o.slice(0,10).map(d=>i`<${Qi} key=${d.task.id} row=${d} />`)}
          </div>
        <//>
      ...
      <${C} title="Active Execution Watch 실행 감시" class="section">
        ...
        <div class="monitor-list">
          ${s.length===0?i`<div class="empty-state">No active execution tasks</div>`:s.map(d=>i`<${Qi} key=${d.task.id} row=${d} />`)}
        </div>
      <//>
    </div>
  `}function wd(t){switch(t){case"quiet_hours":return"quiet hours";case"min_gap":return"cooldown gate";case"no_recent_activity":return"waiting for activity";case"disabled":return"runtime disabled";case"startup":return"warming up";case"llm_error":return"llm error";case"graphql_error":return"graphql error";case"never_started":return"never started";default:return"unknown"}}function Cd(t){switch(t){case"manual_lodge_poke":return"Poke Lodge";case"probe":return"Probe";case"recover":return"Recover";default:return"Message"}}function Td(t){switch(t.delivery){case"sending":return"sending";case"timeout":return"timeout";case"error":return"error";case"delivered":return"delivered";default:return t.role}}function Yi(t){return t.delivery==="error"||t.delivery==="timeout"?"bad":t.delivery==="sending"?"warn":t.role==="assistant"?"assistant":t.role==="user"?"user":"warn"}function ir(t){if(!t)return null;const e=new Date(t);return Number.isNaN(e.getTime())?null:e.toLocaleTimeString()}function Nd(t){return typeof t!="number"||!Number.isFinite(t)||t<=0?null:t<60?`${Math.round(t)}s`:`${Math.ceil(t/60)}m`}function or(t){if(!t)return null;const e=Bt.value[t.name];return(e==null?void 0:e.diagnostic)??t.diagnostic??null}function rr({keeper:t,showRawStatus:e=!1}){if(rt(()=>{t!=null&&t.name&&Uo(t.name)},[t==null?void 0:t.name]),!t)return i`<div class="control-status-copy">Select a keeper to inspect direct reply state.</div>`;const n=Bt.value[t.name],a=or(t),s=Ms.value[t.name];return i`
  ...
  `}function lr({keeperName:t,placeholder:e}){const[n,a]=Wa("");rt(()=>{t&&Uo(t)},[t]);const s=dt.value[t]??[],o=Os.value[t]??!1,r=Wt.value[t],l=async()=>{const p=n.trim();if(!(!t||!p)){a("");try{await zc(t,p)}catch($){const m=$ instanceof Error?$.message:`Failed to message ${t}`;w(m,"error")}}};return i`
        ...
        ${s.length===0?i`<div class="control-status-copy">No direct keeper conversation yet.</div>`:s.map(p=>i`
              <div class="keeper-conversation-item" key=${p.id}>
                <div class="keeper-conversation-meta">
                  <span class=${`keeper-role-chip ${Yi(p)}`}>${p.label}</span>
                  <span class=${`keeper-role-chip ${Yi(p)}`}>${Td(p)}</span>
  ...
  `}function cr({actor:t,keeper:e,onPokeLodge:n}){if(!e)return null;const a=or(e),s=zs.value[e.name]??!1,o=js.value[e.name]??!1,r=(a==null?void 0:a.next_action_path)??"direct_message",l=(a==null?void 0:a.recoverable)??r==="recover";return i`
    <div class="control-actions">
      <button
  ...
  `}function as(t){return t==null||Number.isNaN(t)?"-":`${Math.round(t*100)}%`}function zd({keeper:t}){const e=t.metrics_window,n=[{label:"Model fallback",value:as(typeof(e==null?void 0:e.model_fallback_rate)=="number"?e.model_fallback_rate:void 0)},{label:"Proactive fallback",value:as(typeof(e==null?void 0:e.proactive_fallback_rate)=="number"?e.proactive_fallback_rate:void 0)},{label:"Memory pass rate",value:as(typeof(e==null?void 0:e.memory_pass_rate)=="number"?e.memory_pass_rate:void 0)},{label:"Handoffs",value:typeof(e==null?void 0:e.handoff_count)=="number"?e.handoff_count:t.handoff_count_total??"-"},{label:"Compactions",value:typeof(e==null?void 0:e.compaction_events)=="number"?e.compaction_events:t.compaction_count??"-"},{label:"Saved tokens",value:typeof(e==null?void 0:e.compaction_saved_tokens)=="number"?e.compaction_saved_tokens:t.last_compaction_saved_tokens??"-"},{label:"K2K events",value:t.k2k_count??"-"},{label:"Conversation tail",value:t.conversation_tail_count??"-"},{label:"Tool Calls",value:typeof(e==null?void 0:e.tool_call_count)=="number"?e.tool_call_count:"-"},{label:"Preview Similarity",value:typeof(e==null?void 0:e.proactive_preview_similarity_avg)=="number"?`${(e.proactive_preview_similarity_avg*100).toFixed(1)}%`:"-"},{label:"Memory Avg Score",value:typeof(e==null?void 0:e.memory_avg_score)=="number"?e.memory_avg_score.toFixed(3):"-"},{label:"Fallback Rate",value:typeof(e==null?void 0:e.fallback_rate)=="number"?`${(e.fallback_rate*100).toFixed(1)}%`:"-"}];return i`
    <div class="keeper-signal-list">
      ${n.map(a=>i`
        <div class="keeper-signal-row">
          <span>${a.label}</span>
  ...
  `}function dr(){const t=new URLSearchParams(window.location.search),e=t.get("agent")??t.get("agent_name"),n=localStorage.getItem("masc_dashboard_agent_name");return(e??n??"dashboard").trim()||"dashboard"}async function jd(){try{const t=await On({actor:dr(),action_type:"lodge_tick",target_type:"room",payload:{}}),e=yi(t.result);Fe(),await ne(),e!=null&&e.skipped_reason?w(e.skipped_reason,"warning"):w(e?`Poke finished: ${e.acted}/${e.checked} acted`:"Poke finished",e&&e.acted>0?"success":"warning")}catch(t){const e=t instanceof Error?t.message:"Failed to run Lodge poke";w(e,"error")}}function qd({keeper:t}){return i`
  ...
  `}function Fd(){var e,n,a;const t=Si.value;return t?i`
    <div
      class="keeper-detail-overlay"
      style="display:flex; align-items:center; justify-content:center; padding:20px;"
      onClick=${s=>{s.target.classList.contains("keeper-detail-overlay")&&Xi()}}
    >
  ...
  `:null}const He=_(!1);function Kd(){He.value=!0}function to(){He.value=!1}function Hd(){He.value=!He.value}const ss=600*1e3,is=1200*1e3,eo=.8,os=_("triage");function Se(t){const e=(t??"").toLowerCase();return e==="bad"?"bad":e==="warn"?"warn":"ok"}function Kn(t){switch(t){case"bad":return"#fb7185";case"warn":return"#fbbf24";default:return"#4ade80"}}function no(t){return typeof t!="number"||!Number.isFinite(t)?"??:00":`${String(Math.max(0,t)).padStart(2,"0")}:00`}function ao(t){if(t==null||!Number.isFinite(t))return"unknown";if(t<60)return`${Math.round(t)}s`;const e=Math.round(t/60);if(e<60)return`${e}m`;const n=Math.floor(e/60),a=e%60;return a>0?`${n}h ${a}m`:`${n}h`}function Ud(t){if(!t)return"N/A";const e=Math.floor(t/3600),n=Math.floor(t%3600/60);return e>0?`${e}h ${n}m`:`${n}m`}function rs(t){if(t==null||!Number.isFinite(t))return"No data";if(t<60)return`${Math.max(0,Math.round(t))}s`;const e=Math.floor(t/60);if(e<60)return`${e}m`;const n=Math.floor(e/60),a=e%60;return a>0?`${n}h ${a}m`:`${n}h`}function Bd(t){return t==null?"—":t>=1e6?`${(t/1e6).toFixed(1)}M`:t>=1e3?`${(t/1e3).toFixed(1)}k`:String(t)}function Wd(t){switch(t){case"quiet_hours":return"quiet hours";case"min_gap":return"cooldown gate";case"no_recent_activity":return"waiting for activity";case"disabled":return"runtime disabled";case"startup":return"warming up";case"llm_error":return"llm error";case"graphql_error":return"graphql error";case"never_started":return"never started";default:return"unknown"}}function Gd(t){switch(t){case"manual_lodge_poke":return"Poke Lodge";case"probe":return"Probe";case"recover":return"Recover";default:return"Message"}}function Jd(t){return t?t.enabled?t.quiet_active?`Quiet hours ${no(t.quiet_start)}-${no(t.quiet_end)} KST are active.`:t.last_tick_ago_s==null?`Lodge is enabled and scheduled every ${ao(t.interval_s)}, but no tick has run yet.`:`Lodge ticks every ${ao(t.interval_s)} with planner ${t.use_planner?"on":"off"} and delegated LLM ${t.delegate_llm?"on":"off"}.`:"Lodge automation is disabled.":"Lodge runtime status is unavailable in the current dashboard payload."}function so(t){const e=(t??"").toLowerCase();return e==="ok"?"Healthy":e==="warn"?"Warning":e==="bad"?"Degraded":"Unknown"}function Vd(t){return t==null||t===0?"":t>0?` +${t} ↑`:` ${t} ↓`}function Qd(t){return t==null||t===0?"stat-delta neutral":t>0?"stat-delta up":"stat-delta down"}function Yd({data:t}){if(!t||t.length<2)return null;const e=Math.max(...t),n=Math.min(...t),a=e-n||1,s=60,o=20,r=t.map((l,p)=>`${p/(t.length-1)*s},${o-(l-n)/a*o}`).join(" ");return i`
  ...
  `}function Ae({label:t,value:e,color:n,caption:a,delta:s,spark:o}){return i`
    <div class="stat-card">
      <div class="stat-label">${t}</div>
  ...
  `}function ls({tone:t,title:e,subtitle:n,meta:a,focus:s,onClick:o}){return i`
  ...
  `}function io(){var Y,H,Pt,mt,vt,B,M,x,Dt,Vt,oe,re,I,Et,le,Ve,Qe,qn;const t=se.value,e=wt.value,n=yt.value,a=Jt.value,s=Vo.value,o=(Y=t==null?void 0:t.monitoring)==null?void 0:Y.board,r=(H=t==null?void 0:t.monitoring)==null?void 0:H.council,l=Ft.value,p=new Map(e.map(f=>[me(f.name),f])),$=Ja.value,m=e.map(f=>{var Oi;const L=$.get(me(f.name))??{activeAssignedCount:0,lastActivityAt:null,lastActivityText:null},q=L.lastActivityAt??f.last_seen??null,at=q?Math.max(0,Date.now()-Q(q)):Number.POSITIVE_INFINITY,z=L.activeAssignedCount,ft=!!((Oi=f.current_task)!=null&&Oi.trim()),et=ft||z>0;let X="ok",kt="Fresh and ready",be=!1,ke=!1;return f.status==="offline"||f.status==="inactive"?(X=et?"bad":"warn",kt=et?"Load without an available owner":"Offline"):et&&at>is?(X="bad",kt="Execution is stale"):z>0&&!ft?(X="warn",kt="Claimed work has no current_task",ke=!0):ft&&z===0?(X="warn",kt="current_task has no claimed work",ke=!0):!et&&at<=ss?(X="ok",kt="Dispatchable now",be=!0):!et&&at>is?(X="warn",kt="Idle but not freshly active"):et&&at>ss&&(X="warn",kt="Execution is getting quiet"),{agent:f,lastSignalAt:q,activeTaskCount:z,tone:X,note:kt,focus:ct(f.current_task)??L.lastActivityText??(be?"Ready for assignment.":"Waiting for a clearer signal."),dispatchable:be,drift:ke}}).sort((f,L)=>{const q=st(L.tone)-st(f.tone);return q!==0?q:Q(L.lastSignalAt)-Q(f.lastSignalAt)}),d=a.map(f=>{var X;const L=Qo.value.get(f.name)??"idle",q=Yo.value.has(f.name),at=f.context_ratio??0,z=f.diagnostic??null;let ft="ok",et="Healthy keeper";return q||f.status==="offline"||L==="handoff-imminent"||(z==null?void 0:z.health_state)==="offline"||(z==null?void 0:z.health_state)==="degraded"?(ft="bad",et=ct(z==null?void 0:z.summary,56)??(q?"Heartbeat stale":L==="handoff-imminent"?"Handoff imminent":(z==null?void 0:z.health_state)==="degraded"?"Keeper degraded":"Keeper offline")):((z==null?void 0:z.health_state)==="stale"||at>=eo||L==="preparing"||L==="compacting")&&(ft="warn",et=ct(z==null?void 0:z.summary,56)??(at>=eo?"High context pressure":`Lifecycle ${L}`)),{keeper:f,tone:ft,note:et,focus:ct(z==null?void 0:z.summary,120)??ct((X=f.agent)==null?void 0:X.current_task)??f.skill_primary??f.last_proactive_reason??f.memory_recent_note??"No active focus",timestamp:f.last_heartbeat??null}}).sort((f,L)=>{const q=st(L.tone)-st(f.tone);return q!==0?q:Q(L.timestamp)-Q(f.timestamp)}),v=n.filter(f=>f.status==="todo"||f.status==="claimed"||f.status==="in_progress").map(f=>{var be,ke;const L=f.assignee?p.get(me(f.assignee))??null:null,q=L?$.get(me(L.name))??null:null,at=(q==null?void 0:q.lastActivityAt)??(L==null?void 0:L.last_seen)??null,z=at?Math.max(0,Date.now()-Q(at)):Number.POSITIVE_INFINITY,ft=f.status==="claimed"||f.status==="in_progress";let et="ok",X="Covered",kt=!1;return f.assignee?!L||L.status==="offline"||L.status==="inactive"?(et="bad",X="Assigned owner is unavailable",kt=!0):ft&&z>is?(et="bad",X="Execution has lost a fresh signal"):ft&&z>ss?(et="warn",X="Execution is drifting quiet"):f.status==="todo"&&zt(f.priority)<=2&&!((be=L.current_task)!=null&&be.trim())&&((q==null?void 0:q.activeAssignedCount)??0)===0?(et="ok",X="Ready for dispatch"):ft&&!((ke=L.current_task)!=null&&ke.trim())&&(et="warn",X="Owner focus is not explicit"):(et=zt(f.priority)<=2?"bad":"warn",X=ft?"Active work has no owner":"Ready work has no owner",kt=!0),{task:f,owner:L,lastSignalAt:at,tone:et,note:X,focus:ct(L==null?void 0:L.current_task)??(q==null?void 0:q.lastActivityText)??ct(f.description)??"Needs operator attention.",ownerGap:kt}}).sort((f,L)=>{const q=st(L.tone)-st(f.tone);if(q!==0)return q;const at=zt(f.task.priority)-zt(L.task.priority);return at!==0?at:Q(L.lastSignalAt??L.task.updated_at??L.task.created_at)-Q(f.lastSignalAt??f.task.updated_at??f.task.created_at)}),c=v.filter(f=>f.task.status==="todo"&&zt(f.task.priority)<=2),y=v.filter(f=>f.ownerGap).length,S=m.filter(f=>f.dispatchable),T=m.filter(f=>f.drift||f.tone!=="ok"),P=d.filter(f=>f.tone!=="ok"),K=t!=null&&t.paused?"bad":((Pt=t==null?void 0:t.data_quality)==null?void 0:Pt.board_contract_ok)===!1||((mt=t==null?void 0:t.data_quality)==null?void 0:mt.council_feed_ok)===!1?"warn":l?"ok":"warn",E=[];t!=null&&t.paused&&E.push({key:"paused",tone:"bad",title:"Room is paused",detail:t.tempo?`Tempo is ${t.tempo}. Resume from Ops when ready.`:"Resume from Ops when ready.",timestamp:((vt=t.data_quality)==null?void 0:vt.last_sync_at)??null,action:()=>At("ops")}),l||E.push({key:"live-connection",tone:"warn",title:"Live feed is reconnecting",detail:"Dashboard telemetry is stale until the SSE stream recovers.",timestamp:null,action:Kd}),Se(o==null?void 0:o.alert_level)!=="ok"&&E.push({key:"board-monitor",tone:Se(o==null?void 0:o.alert_level),title:"Board feed needs attention",detail:`Freshness ${rs(o==null?void 0:o.last_activity_age_s)} · ${(o==null?void 0:o.unanswered_posts)??0} unanswered posts.`,timestamp:null,action:()=>At("board")}),Se(r==null?void 0:r.alert_level)!=="ok"&&E.push({key:"council-monitor",tone:Se(r==null?void 0:r.alert_level),title:"Council quorum risk is elevated",detail:`${(r==null?void 0:r.sessions_without_quorum)??0} sessions without quorum · freshness ${rs(r==null?void 0:r.last_activity_age_s)}.`,timestamp:null,action:()=>At("board")}),(((B=t==null?void 0:t.data_quality)==null?void 0:B.board_contract_ok)===!1||((M=t==null?void 0:t.data_quality)==null?void 0:M.council_feed_ok)===!1)&&E.push({key:"data-quality",tone:"warn",title:"Dashboard data quality is degraded",detail:`${((x=t.data_quality)==null?void 0:x.board_contract_ok)===!1?"Board contract":"Board contract ok"} · ${((Dt=t.data_quality)==null?void 0:Dt.council_feed_ok)===!1?"Council feed degraded":"Council feed ok"}.`,timestamp:((Vt=t.data_quality)==null?void 0:Vt.last_sync_at)??null,action:()=>At("ops")});const N=[...E,...v.filter(f=>f.tone!=="ok").slice(0,3).map(f=>({key:`task-${f.task.id}`,tone:f.tone,title:f.task.title,detail:`${f.note} · ${f.focus}`,timestamp:f.lastSignalAt??f.task.updated_at??f.task.created_at??null,action:()=>At("overview")})),...P.slice(0,2).map(f=>({key:`keeper-${f.keeper.name}`,tone:f.tone,title:f.keeper.name,detail:`${f.note} · ${f.focus}`,timestamp:f.timestamp,action:()=>_a(f.keeper)})),...T.slice(0,2).map(f=>({key:`agent-${f.agent.name}`,tone:f.tone,title:f.agent.name,detail:`${f.note} · ${f.focus}`,timestamp:f.lastSignalAt,action:()=>Me(f.agent.name)}))].sort((f,L)=>{const q=st(L.tone)-st(f.tone);return q!==0?q:Q(L.timestamp)-Q(f.timestamp)}).slice(0,8),R=os.value;return i`
    <div class="overview-sub-tabs">
      <button
        class="sub-tab-btn ${R==="triage"?"active":""}"
        onClick=${()=>{os.value="triage"}}
      >Triage</button>
      <button
        class="sub-tab-btn ${R==="dispatch"?"active":""}"
        onClick=${()=>{os.value="dispatch"}}
      >Dispatch</button>
    </div>
    ...
    <${C} title="Room Health" class="section">
      <div class="health-strip">
        ...
        <span class="health-dot" style=${`color:${Kn(Se(o==null?void 0:o.alert_level))}`} title=${`Board: ${so(o==null?void 0:o.alert_level)} · Freshness ${rs(o==null?void 0:o.last_activity_age_s)}`}>● Board</span>
        <span class="health-dot" style=${`color:${Kn(Se(r==null?void 0:r.alert_level))}`} title=${`Council: ${so(r==null?void 0:r.alert_level)} · ${(r==null?void 0:r.sessions_without_quorum)??0} sessions without quorum`}>● Council</span>
        ...
        <${C} title="Agent Watch 에이전트 감시" class="section">
          <div class="monitor-list">
            ${T.length===0?i`<div class="empty-state">No agent drift or stale load right now</div>`:T.slice(0,4).map(f=>i`
                  <button class="monitor-row ${f.tone}" onClick=${()=>Me(f.agent.name)}>
                    <div class="monitor-row-header">
                      <div class="monitor-row-title">
                        <div class="monitor-name-line">
        ...
        <${C} title="Runtime Notes 런타임 메모" class="section">
          <details class="runtime-collapsible">
            ...
            <div class="overview-note-stack">
              ...
              <div class="overview-inline-note">
                Lodge ${(Et=t==null?void 0:t.lodge)!=null&&Et.enabled?"enabled":"disabled"} · Last tick ${((le=t==null?void 0:t.lodge)==null?void 0:le.last_tick_ago)??"never"} · Self heartbeats ${((Qe=(Ve=t==null?void 0:t.lodge)==null?void 0:Ve.active_self_heartbeats)==null?void 0:Qe.length)??0}${(qn=t==null?void 0:t.lodge)!=null&&qn.last_skip_reason?` · Skip ${t.lodge.last_skip_reason}`:""}
              </div>
              <div class="overview-inline-note">
  ...
  `}const Zd="modulepreload",tu=function(t){return"/dashboard/"+t},oo={},eu=function(e,n,a){let s=Promise.resolve();if(n&&n.length>0){let r=function($){return Promise.all($.map(m=>Promise.resolve(m).then(d=>({status:"fulfilled",value:d}),d=>({status:"rejected",reason:d}))))};document.getElementsByTagName("link");const l=document.querySelector("meta[property=csp-nonce]"),p=(l==null?void 0:l.nonce)||(l==null?void 0:l.getAttribute("nonce"));s=r(n.map($=>{if($=tu($),$ in oo)return;oo[$]=!0;const m=$.endsWith(".css"),d=m?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${$}"]${d}`))return;const v=document.createElement("link");if(v.rel=m?"stylesheet":Zd,m||(v.as="script"),v.crossOrigin="",v.href=$,p&&v.setAttribute("nonce",p),document.head.appendChild(v),m)return new Promise((c,y)=>{v.addEventListener("load",c),v.addEventListener("error",()=>y(new Error(`Unable to preload CSS for ${$}`)))})}))}function o(r){const l=new Event("vite:preloadError",{cancelable:!0});if(l.payload=r,window.dispatchEvent(l),!l.defaultPrevented)throw r}return s.then(r=>{for(const l of r||[])l.status==="rejected"&&o(l.reason);return e().catch(o)})},ur=_(null),Ht=_(null),ga=_(!1),$a=_(!1),ha=_(null),ya=_(null),Vs=_(null),ba=_(null),ge=_("summary"),zn=_(null),Qs=_(!1),ka=_(null),pr=_(null),Ys=_(!1),xa=_(null),Ai=_(null),Xs=_(!1),Sa=_(null),Ln=_(null),Aa=_(!1),Pn=_(null),Oe=_(null);let sn=null;function wi(t){return t!=="summary"&&t!=="swarm"}function k(t){return typeof t=="object"&&t!==null&&!Array.isArray(t)}function u(t){return typeof t=="string"&&t.trim()!==""?t:void 0}function g(t){return typeof t=="number"&&Number.isFinite(t)?t:void 0}function V(t){return typeof t=="boolean"?t:void 0}function pt(t){return Array.isArray(t)?t.map(e=>typeof e=="string"?e.trim():"").filter(Boolean):[]}function nu(){if(typeof window>"u")return;const e=new URLSearchParams(window.location.search).get("run_id")??void 0;return e&&e.trim()!==""?e.trim():void 0}function au(t){if(k(t))return{policy_class:u(t.policy_class),approval_class:u(t.approval_class),tool_allowlist:pt(t.tool_allowlist),model_allowlist:pt(t.model_allowlist),requires_human_for:pt(t.requires_human_for),autonomy_level:u(t.autonomy_level),escalation_timeout_sec:g(t.escalation_timeout_sec),kill_switch:V(t.kill_switch),frozen:V(t.frozen)}}function su(t){if(k(t))return{headcount_cap:g(t.headcount_cap),active_operation_cap:g(t.active_operation_cap),max_cost_usd:g(t.max_cost_usd),max_tokens:g(t.max_tokens)}}function Ci(t){if(!k(t))return null;const e=u(t.unit_id),n=u(t.label),a=u(t.kind);return!e||!n||!a?null:{unit_id:e,label:n,kind:a,parent_unit_id:u(t.parent_unit_id)??null,leader_id:u(t.leader_id)??null,roster:pt(t.roster),capability_profile:pt(t.capability_profile),source:u(t.source),created_at:u(t.created_at),updated_at:u(t.updated_at),policy:au(t.policy),budget:su(t.budget)}}function mr(t){if(!k(t))return null;const e=Ci(t.unit);return e?{unit:e,leader_status:u(t.leader_status),roster_total:g(t.roster_total),roster_live:g(t.roster_live),active_operation_count:g(t.active_operation_count),health:u(t.health),reasons:pt(t.reasons),children:Array.isArray(t.children)?t.children.map(mr).filter(n=>n!==null):[]}:null}function iu(t){if(k(t))return{total_units:g(t.total_units),company_count:g(t.company_count),platoon_count:g(t.platoon_count),squad_count:g(t.squad_count),leaf_agent_unit_count:g(t.leaf_agent_unit_count),live_agent_count:g(t.live_agent_count),managed_unit_count:g(t.managed_unit_count),active_operation_count:g(t.active_operation_count)}}function vr(t){const e=k(t)?t:{};return{version:u(e.version),generated_at:u(e.generated_at),source:u(e.source),summary:iu(e.summary),units:Array.isArray(e.units)?e.units.map(mr).filter(n=>n!==null):[]}}function ou(t){if(!k(t))return null;const e=u(t.kind),n=u(t.status);return!e||!n?null:{kind:e,chain_id:u(t.chain_id)??null,goal:u(t.goal)??null,run_id:u(t.run_id)??null,status:n,viewer_path:u(t.viewer_path)??null,last_sync_at:u(t.last_sync_at)??null}}function Va(t){if(!k(t))return null;const e=u(t.operation_id),n=u(t.objective),a=u(t.assigned_unit_id),s=u(t.trace_id),o=u(t.status);return!e||!n||!a||!s||!o?null:{operation_id:e,objective:n,assigned_unit_id:a,autonomy_level:u(t.autonomy_level),policy_class:u(t.policy_class),budget_class:u(t.budget_class),detachment_session_id:u(t.detachment_session_id)??null,trace_id:s,checkpoint_ref:u(t.checkpoint_ref)??null,active_goal_ids:pt(t.active_goal_ids),note:u(t.note)??null,created_by:u(t.created_by),source:u(t.source),status:o,chain:ou(t.chain),created_at:u(t.created_at),updated_at:u(t.updated_at)}}function ru(t){if(!k(t))return null;const e=Va(t.operation);return e?{operation:e,assigned_unit_label:u(t.assigned_unit_label)}:null}function tn(t){if(k(t))return{tone:u(t.tone),pending_ops:g(t.pending_ops),blocked_ops:g(t.blocked_ops),in_flight_ops:g(t.in_flight_ops),pipeline_stalls:g(t.pipeline_stalls),bus_traffic:g(t.bus_traffic),l1_hit_rate:g(t.l1_hit_rate),invalidation_count:g(t.invalidation_count),current_pending:g(t.current_pending),current_in_flight:g(t.current_in_flight),cdb_wakeups:g(t.cdb_wakeups),total_stolen:g(t.total_stolen),avg_best_score:g(t.avg_best_score),avg_candidate_count:g(t.avg_candidate_count),best_first_operations:g(t.best_first_operations),active_sessions:g(t.active_sessions),commit_rate:g(t.commit_rate),total_speculations:g(t.total_speculations)}}function lu(t){if(!k(t))return;const e=k(t.pipeline)?t.pipeline:void 0,n=k(t.cache)?t.cache:void 0,a=k(t.ooo)?t.ooo:void 0,s=k(t.speculative)?t.speculative:void 0,o=k(t.search_fabric)?t.search_fabric:void 0,r=k(t.signals)?t.signals:void 0;return{pipeline:e?{total_ops:g(e.total_ops),completed_ops:g(e.completed_ops),stalled_cycles:g(e.stalled_cycles),hazards_detected:g(e.hazards_detected),forwarding_used:g(e.forwarding_used),pipeline_flushes:g(e.pipeline_flushes),ipc:g(e.ipc)}:void 0,cache:n?{total_reads:g(n.total_reads),total_writes:g(n.total_writes),l1_hit_rate:g(n.l1_hit_rate),invalidation_count:g(n.invalidation_count),writeback_count:g(n.writeback_count),bus_traffic:g(n.bus_traffic)}:void 0,ooo:a?{agent_count:g(a.agent_count),total_added:g(a.total_added),total_issued:g(a.total_issued),total_completed:g(a.total_completed),total_stolen:g(a.total_stolen),cdb_wakeups:g(a.cdb_wakeups),stall_cycles:g(a.stall_cycles),global_cdb_events:g(a.global_cdb_events),current_pending:g(a.current_pending),current_in_flight:g(a.current_in_flight)}:void 0,speculative:s?{total_speculations:g(s.total_speculations),total_commits:g(s.total_commits),total_aborts:g(s.total_aborts),commit_rate:g(s.commit_rate),total_fast_calls:g(s.total_fast_calls),total_cost_usd:g(s.total_cost_usd),active_sessions:g(s.active_sessions)}:void 0,search_fabric:o?{total_operations:g(o.total_operations),best_first_operations:g(o.best_first_operations),legacy_operations:g(o.legacy_operations),blocked_operations:g(o.blocked_operations),ready_operations:g(o.ready_operations),research_pipeline_operations:g(o.research_pipeline_operations),avg_candidate_count:g(o.avg_candidate_count),avg_best_score:g(o.avg_best_score),top_stage:u(o.top_stage)??null}:void 0,signals:r?{issue_pressure:tn(r.issue_pressure),cache_contention:tn(r.cache_contention),scheduler_efficiency:tn(r.scheduler_efficiency),routing_confidence:tn(r.routing_confidence),speculative_posture:tn(r.speculative_posture)}:void 0}}function fr(t){const e=k(t)?t:{},n=k(e.summary)?e.summary:void 0;return{version:u(e.version),generated_at:u(e.generated_at),summary:n?{total:g(n.total),active:g(n.active),paused:g(n.paused),managed:g(n.managed),projected:g(n.projected)}:void 0,microarch:lu(e.microarch),operations:Array.isArray(e.operations)?e.operations.map(ru).filter(a=>a!==null):[]}}function _r(t){if(!k(t))return null;const e=u(t.detachment_id),n=u(t.operation_id),a=u(t.assigned_unit_id);return!e||!n||!a?null:{detachment_id:e,operation_id:n,assigned_unit_id:a,leader_id:u(t.leader_id)??null,roster:pt(t.roster),session_id:u(t.session_id)??null,checkpoint_ref:u(t.checkpoint_ref)??null,runtime_kind:u(t.runtime_kind)??null,runtime_ref:u(t.runtime_ref)??null,source:u(t.source),status:u(t.status),last_event_at:u(t.last_event_at)??null,last_progress_at:u(t.last_progress_at)??null,heartbeat_deadline:u(t.heartbeat_deadline)??null,created_at:u(t.created_at),updated_at:u(t.updated_at)}}function cu(t){if(!k(t))return null;const e=_r(t.detachment);return e?{detachment:e,assigned_unit_label:u(t.assigned_unit_label),operation:Va(t.operation)}:null}function gr(t){const e=k(t)?t:{},n=k(e.summary)?e.summary:void 0;return{version:u(e.version),generated_at:u(e.generated_at),summary:n?{total:g(n.total),active:g(n.active),projected:g(n.projected)}:void 0,detachments:Array.isArray(e.detachments)?e.detachments.map(cu).filter(a=>a!==null):[]}}function du(t){if(!k(t))return null;const e=u(t.decision_id),n=u(t.trace_id),a=u(t.requested_action),s=u(t.scope_type),o=u(t.scope_id);return!e||!n||!a||!s||!o?null:{decision_id:e,trace_id:n,requested_action:a,scope_type:s,scope_id:o,operation_id:u(t.operation_id)??null,target_unit_id:u(t.target_unit_id)??null,requested_by:u(t.requested_by),status:u(t.status),reason:u(t.reason)??null,source:u(t.source),detail:t.detail,created_at:u(t.created_at),decided_at:u(t.decided_at)??null,expires_at:u(t.expires_at)??null}}function $r(t){const e=k(t)?t:{},n=k(e.summary)?e.summary:void 0;return{version:u(e.version),generated_at:u(e.generated_at),summary:n?{total:g(n.total),pending:g(n.pending),approved:g(n.approved),denied:g(n.denied)}:void 0,decisions:Array.isArray(e.decisions)?e.decisions.map(du).filter(a=>a!==null):[]}}function uu(t){if(!k(t))return null;const e=Ci(t.unit);return e?{unit:e,roster_total:g(t.roster_total),roster_live:g(t.roster_live),headcount_cap:g(t.headcount_cap),active_operations:g(t.active_operations),active_operation_cap:g(t.active_operation_cap),utilization:g(t.utilization)}:null}function pu(t){const e=k(t)?t:{};return{version:u(e.version),generated_at:u(e.generated_at),capacity:Array.isArray(e.capacity)?e.capacity.map(uu).filter(n=>n!==null):[]}}function mu(t){if(!k(t))return null;const e=u(t.alert_id);return e?{alert_id:e,severity:u(t.severity),kind:u(t.kind),scope_type:u(t.scope_type),scope_id:u(t.scope_id),title:u(t.title),detail:u(t.detail),timestamp:u(t.timestamp)}:null}function hr(t){const e=k(t)?t:{},n=k(e.summary)?e.summary:void 0;return{version:u(e.version),generated_at:u(e.generated_at),summary:n?{total:g(n.total),bad:g(n.bad),warn:g(n.warn)}:void 0,alerts:Array.isArray(e.alerts)?e.alerts.map(mu).filter(a=>a!==null):[]}}function yr(t){if(!k(t))return null;const e=u(t.event_id),n=u(t.trace_id),a=u(t.event_type);return!e||!n||!a?null:{event_id:e,trace_id:n,event_type:a,operation_id:u(t.operation_id)??null,unit_id:u(t.unit_id)??null,actor:u(t.actor)??null,source:u(t.source),timestamp:u(t.timestamp),detail:t.detail}}function vu(t){const e=k(t)?t:{};return{version:u(e.version),generated_at:u(e.generated_at),events:Array.isArray(e.events)?e.events.map(yr).filter(n=>n!==null):[]}}function fu(t){if(!k(t))return null;const e=u(t.code),n=u(t.severity),a=u(t.summary);return!e||!n||!a?null:{code:e,severity:n,summary:a}}function _u(t){if(!k(t))return null;const e=u(t.lane_id),n=u(t.label),a=u(t.kind),s=u(t.phase),o=u(t.motion_state),r=u(t.source_of_truth),l=u(t.movement_reason),p=u(t.current_step);if(!e||!n||!a||!s||!o||!r||!l||!p)return null;const $=k(t.counts)?t.counts:{};return{lane_id:e,label:n,kind:a,present:V(t.present)??!1,phase:s,motion_state:o,source_of_truth:r,last_movement_at:u(t.last_movement_at)??null,movement_reason:l,current_step:p,blockers:pt(t.blockers),counts:{operations:g($.operations),detachments:g($.detachments),workers:g($.workers),approvals:g($.approvals),alerts:g($.alerts)},hard_flags:Array.isArray(t.hard_flags)?t.hard_flags.map(fu).filter(m=>m!==null):[]}}function gu(t){if(!k(t))return null;const e=u(t.event_id),n=u(t.lane_id),a=u(t.kind),s=u(t.timestamp),o=u(t.title),r=u(t.detail),l=u(t.tone),p=u(t.source);return!e||!n||!a||!s||!o||!r||!l||!p?null:{event_id:e,lane_id:n,kind:a,timestamp:s,title:o,detail:r,tone:l,source:p}}function $u(t){if(!k(t))return null;const e=u(t.code),n=u(t.severity),a=u(t.summary);return!e||!n||!a?null:{code:e,severity:n,summary:a,lane_ids:pt(t.lane_ids),count:g(t.count)??0}}function br(t){if(!k(t))return;const e=k(t.overview)?t.overview:{},n=k(t.gaps)?t.gaps:{},a=k(t.recommended_next_action)?t.recommended_next_action:void 0;return{generated_at:u(t.generated_at),overview:{active_lanes:g(e.active_lanes),moving_lanes:g(e.moving_lanes),stalled_lanes:g(e.stalled_lanes),projected_lanes:g(e.projected_lanes),last_movement_at:u(e.last_movement_at)??null},lanes:Array.isArray(t.lanes)?t.lanes.map(_u).filter(s=>s!==null):[],timeline:Array.isArray(t.timeline)?t.timeline.map(gu).filter(s=>s!==null):[],gaps:{count:g(n.count),items:Array.isArray(n.items)?n.items.map($u).filter(s=>s!==null):[]},recommended_next_action:a?{tool:u(a.tool)??"masc_operator_snapshot",label:u(a.label)??"Observe operator state",reason:u(a.reason)??"",lane_id:u(a.lane_id)??null}:void 0}}function hu(t){if(!k(t))return;const e=k(t.workers)?t.workers:{},n=V(t.pass);return{status:u(t.status)??"missing",source:u(t.source)??"none",run_id:u(t.run_id)??null,captured_at:u(t.captured_at)??null,...n!==void 0?{pass:n}:{},...g(t.peak_hot_slots)!=null?{peak_hot_slots:g(t.peak_hot_slots)}:{},...g(t.ctx_per_slot)!=null?{ctx_per_slot:g(t.ctx_per_slot)}:{},workers:{expected:g(e.expected),joined:g(e.joined),current_task_bound:g(e.current_task_bound),fresh_heartbeats:g(e.fresh_heartbeats),done:g(e.done),final:g(e.final)},artifact_ref:u(t.artifact_ref)??null,missing_reason:u(t.missing_reason)??null}}function yu(t){const e=k(t)?t:{};return{version:u(e.version),generated_at:u(e.generated_at),topology:vr(e.topology),operations:fr(e.operations),detachments:gr(e.detachments),alerts:hr(e.alerts),decisions:$r(e.decisions),capacity:pu(e.capacity),traces:vu(e.traces),swarm_status:br(e.swarm_status)}}function bu(t){const e=k(t)?t:{},n=vr(e.topology),a=fr(e.operations),s=gr(e.detachments),o=hr(e.alerts),r=$r(e.decisions);return{version:u(e.version),generated_at:u(e.generated_at),topology:{version:n.version,generated_at:n.generated_at,source:n.source,summary:n.summary},operations:{version:a.version,generated_at:a.generated_at,summary:a.summary,microarch:a.microarch},detachments:{version:s.version,generated_at:s.generated_at,summary:s.summary},alerts:{version:o.version,generated_at:o.generated_at,summary:o.summary},decisions:{version:r.version,generated_at:r.generated_at,summary:r.summary},swarm_status:br(e.swarm_status),swarm_proof:hu(e.swarm_proof)}}function ku(t){return k(t)?{chain_id:u(t.chain_id)??null,started_at:g(t.started_at)??null,progress:g(t.progress)??null,elapsed_sec:g(t.elapsed_sec)??null}:null}function kr(t){if(!k(t))return null;const e=u(t.event);return e?{event:e,chain_id:u(t.chain_id)??null,timestamp:u(t.timestamp)??null,duration_ms:g(t.duration_ms)??null,message:u(t.message)??null,tokens:g(t.tokens)??null}:null}function xu(t){if(!k(t))return null;const e=Va(t.operation);return e?{operation:e,runtime:ku(t.runtime),history:kr(t.history),mermaid:u(t.mermaid)??null,preview_run:xr(t.preview_run)}:null}function Su(t){const e=k(t)?t:{};return{status:u(e.status)??"disconnected",base_url:u(e.base_url)??null,message:u(e.message)??null}}function Au(t){const e=k(t)?t:{},n=k(e.summary)?e.summary:void 0;return{version:u(e.version),generated_at:u(e.generated_at),connection:Su(e.connection),summary:n?{linked_operations:g(n.linked_operations),active_chains:g(n.active_chains),running_operations:g(n.running_operations),recent_failures:g(n.recent_failures),last_history_event_at:u(n.last_history_event_at)??null}:void 0,operations:Array.isArray(e.operations)?e.operations.map(xu).filter(a=>a!==null):[],recent_history:Array.isArray(e.recent_history)?e.recent_history.map(kr).filter(a=>a!==null):[]}}function wu(t){if(!k(t))return null;const e=u(t.id);return e?{id:e,type:u(t.type),status:u(t.status),duration_ms:g(t.duration_ms)??null,error:u(t.error)??null}:null}function xr(t){if(!k(t))return null;const e=u(t.run_id),n=u(t.chain_id);return n?{run_id:e??null,chain_id:n,duration_ms:g(t.duration_ms),success:V(t.success),mermaid:u(t.mermaid),nodes:Array.isArray(t.nodes)?t.nodes.map(wu).filter(a=>a!==null):[]}:null}function Cu(t){const e=k(t)?t:{};return{run:xr(e.run)}}function Tu(t){if(!k(t))return null;const e=u(t.title),n=u(t.path);return!e||!n?null:{title:e,path:n}}function Nu(t){if(!k(t))return null;const e=u(t.id),n=u(t.title),a=u(t.summary);return!e||!n||!a?null:{id:e,title:n,summary:a}}function Ru(t){if(!k(t))return null;const e=u(t.id),n=u(t.title),a=u(t.tool),s=u(t.summary);return!e||!n||!a||!s?null:{id:e,title:n,tool:a,summary:s,success_signals:pt(t.success_signals),pitfalls:pt(t.pitfalls)}}function Lu(t){if(!k(t))return null;const e=u(t.id),n=u(t.title),a=u(t.summary),s=u(t.when_to_use);return!e||!n||!a||!s?null:{id:e,title:n,summary:a,when_to_use:s,steps:Array.isArray(t.steps)?t.steps.map(Ru).filter(o=>o!==null):[]}}function Pu(t){if(!k(t))return null;const e=u(t.id),n=u(t.title),a=u(t.description);return!e||!n||!a?null:{id:e,title:n,description:a,tools:pt(t.tools)}}function Du(t){if(!k(t))return null;const e=u(t.id),n=u(t.title),a=u(t.symptom),s=u(t.why),o=u(t.fix_tool),r=u(t.fix_summary);return!e||!n||!a||!s||!o||!r?null:{id:e,title:n,symptom:a,why:s,fix_tool:o,fix_summary:r}}function Eu(t){if(!k(t))return null;const e=u(t.id),n=u(t.title),a=u(t.path_id),s=u(t.transport);return!e||!n||!a||!s?null:{id:e,title:n,path_id:a,transport:s,request:t.request,response:t.response,notes:pt(t.notes)}}function Iu(t){const e=k(t)?t:{};return{version:u(e.version),generated_at:u(e.generated_at),docs:Array.isArray(e.docs)?e.docs.map(Tu).filter(n=>n!==null):[],concepts:Array.isArray(e.concepts)?e.concepts.map(Nu).filter(n=>n!==null):[],golden_paths:Array.isArray(e.golden_paths)?e.golden_paths.map(Lu).filter(n=>n!==null):[],tool_groups:Array.isArray(e.tool_groups)?e.tool_groups.map(Pu).filter(n=>n!==null):[],pitfalls:Array.isArray(e.pitfalls)?e.pitfalls.map(Du).filter(n=>n!==null):[],examples:Array.isArray(e.examples)?e.examples.map(Eu).filter(n=>n!==null):[]}}function Mu(t){if(!k(t))return null;const e=u(t.id),n=u(t.title),a=u(t.status),s=u(t.detail),o=u(t.next_tool);return!e||!n||!a||!s||!o?null:{id:e,title:n,status:a,detail:s,next_tool:o}}function Ou(t){if(!k(t))return null;const e=u(t.code),n=u(t.severity),a=u(t.title),s=u(t.detail),o=u(t.next_tool);return!e||!n||!a||!s||!o?null:{code:e,severity:n,title:a,detail:s,next_tool:o}}function zu(t){if(!k(t))return null;const e=u(t.from),n=u(t.content),a=u(t.timestamp),s=g(t.seq);return!e||!n||!a||s==null?null:{seq:s,from:e,content:n,timestamp:a}}function ju(t){if(!k(t))return null;const e=u(t.name),n=u(t.role),a=u(t.lane),s=u(t.status),o=u(t.claim_marker),r=u(t.done_marker),l=u(t.final_marker);if(!e||!n||!a||!s||!o||!r||!l)return null;const p=(()=>{if(!k(t.last_message))return null;const $=g(t.last_message.seq),m=u(t.last_message.content),d=u(t.last_message.timestamp);return $==null||!m||!d?null:{seq:$,content:m,timestamp:d}})();return{name:e,role:n,lane:a,joined:V(t.joined)??!1,live_presence:V(t.live_presence)??!1,completed:V(t.completed)??!1,status:s,current_task:u(t.current_task)??null,bound_task_id:u(t.bound_task_id)??null,bound_task_title:u(t.bound_task_title)??null,bound_task_status:u(t.bound_task_status)??null,current_task_matches_run:V(t.current_task_matches_run)??!1,squad_member:V(t.squad_member)??!1,detachment_member:V(t.detachment_member)??!1,last_seen:u(t.last_seen)??null,heartbeat_age_sec:g(t.heartbeat_age_sec)??null,heartbeat_fresh:V(t.heartbeat_fresh)??!1,claim_marker_seen:V(t.claim_marker_seen)??!1,done_marker_seen:V(t.done_marker_seen)??!1,final_marker_seen:V(t.final_marker_seen)??!1,claim_marker:o,done_marker:r,final_marker:l,last_message:p}}function qu(t){if(!k(t))return;const e=Array.isArray(t.timeline)?t.timeline.map(n=>{if(!k(n))return null;const a=u(n.timestamp),s=g(n.active_slots);if(!a||s==null)return null;const o=Array.isArray(n.active_slot_ids)?n.active_slot_ids.map(r=>typeof r=="number"&&Number.isFinite(r)?r:null).filter(r=>r!=null):[];return{timestamp:a,active_slots:s,active_slot_ids:o}}).filter(n=>n!==null):[];return{slot_url:u(t.slot_url)??null,provider_base_url:u(t.provider_base_url)??null,provider_reachable:V(t.provider_reachable)??null,provider_status_code:g(t.provider_status_code)??null,provider_model_id:u(t.provider_model_id)??null,actual_model_id:u(t.actual_model_id)??null,expected_slots:g(t.expected_slots),actual_slots:g(t.actual_slots),expected_ctx:g(t.expected_ctx),actual_ctx:g(t.actual_ctx),slot_reachable:V(t.slot_reachable)??null,slot_status_code:g(t.slot_status_code)??null,runtime_blocker:u(t.runtime_blocker)??null,detail:u(t.detail)??null,checked_at:u(t.checked_at)??null,total_slots:g(t.total_slots),ctx_per_slot:g(t.ctx_per_slot),active_slots_now:g(t.active_slots_now),peak_active_slots:g(t.peak_active_slots),sample_count:g(t.sample_count),last_sample_at:u(t.last_sample_at)??null,timeline:e}}function Fu(t){const e=k(t)?t:{},n=k(e.summary)?e.summary:void 0;return{version:u(e.version),generated_at:u(e.generated_at),run_id:u(e.run_id),room_id:u(e.room_id),operation_id:u(e.operation_id)??null,recommended_next_tool:u(e.recommended_next_tool),summary:n?{expected_workers:g(n.expected_workers),joined_workers:g(n.joined_workers),live_workers:g(n.live_workers),squad_roster_size:g(n.squad_roster_size),detachment_roster_size:g(n.detachment_roster_size),current_task_bound:g(n.current_task_bound),fresh_heartbeats:g(n.fresh_heartbeats),claim_markers_seen:g(n.claim_markers_seen),done_markers_seen:g(n.done_markers_seen),final_markers_seen:g(n.final_markers_seen),completed_workers:g(n.completed_workers),peak_hot_slots:g(n.peak_hot_slots),hot_window_ok:V(n.hot_window_ok),pass_hot_concurrency:V(n.pass_hot_concurrency),pass_end_to_end:V(n.pass_end_to_end),pending_decisions:g(n.pending_decisions),pass:V(n.pass)}:void 0,provider:qu(e.provider),operation:Va(e.operation),squad:Ci(e.squad),detachment:_r(e.detachment),workers:Array.isArray(e.workers)?e.workers.map(ju).filter(a=>a!==null):[],checklist:Array.isArray(e.checklist)?e.checklist.map(Mu).filter(a=>a!==null):[],blockers:Array.isArray(e.blockers)?e.blockers.map(Ou).filter(a=>a!==null):[],recent_messages:Array.isArray(e.recent_messages)?e.recent_messages.map(zu).filter(a=>a!==null):[],recent_trace_events:Array.isArray(e.recent_trace_events)?e.recent_trace_events.map(yr).filter(a=>a!==null):[],truth_notes:pt(e.truth_notes)}}function wa(t){ge.value=t,wi(t)&&Ku()}async function Ti(){ga.value=!0,ha.value=null;try{const t=await Nl();ur.value=bu(t)}catch(t){ha.value=t instanceof Error?t.message:"Failed to load command-plane summary"}finally{ga.value=!1}}function Ni(t){Oe.value=t}async function Ri(){$a.value=!0,ya.value=null;try{const t=await Tl();Ht.value=yu(t)}catch(t){ya.value=t instanceof Error?t.message:"Failed to load command-plane snapshot"}finally{$a.value=!1}}async function Ku(){Ht.value||$a.value||await Ri()}async function ze(){await Ti(),wi(ge.value)&&await Ri()}async function $e(){var t;Xs.value=!0,Sa.value=null;try{const e=await Rl(),n=Au(e);Ai.value=n;const a=Oe.value;n.operations.length===0?Oe.value=null:(!a||!n.operations.some(s=>s.operation.operation_id===a))&&(Oe.value=((t=n.operations[0])==null?void 0:t.operation.operation_id)??null)}catch(e){Sa.value=e instanceof Error?e.message:"Failed to load chain summary"}finally{Xs.value=!1}}function Hu(){sn=null,Ln.value=null,Aa.value=!1,Pn.value=null}async function Uu(t){sn=t,Aa.value=!0,Pn.value=null;try{const e=await Ll(t);if(sn!==t)return;Ln.value=Cu(e)}catch(e){if(sn!==t)return;Ln.value=null,Pn.value=e instanceof Error?e.message:"Failed to load chain run"}finally{sn===t&&(Aa.value=!1)}}async function Bu(){Qs.value=!0,ka.value=null;try{const t=await Pl();zn.value=Iu(t)}catch(t){ka.value=t instanceof Error?t.message:"Failed to load command-plane help"}finally{Qs.value=!1}}async function Sr(t=nu()){Ys.value=!0,xa.value=null;try{const e=await Dl(t);pr.value=Fu(e)}catch(e){xa.value=e instanceof Error?e.message:"Failed to load command-plane swarm view"}finally{Ys.value=!1}}async function ie(t,e,n){Vs.value=t,ba.value=null;try{await El(e,n),await Ti(),(Ht.value||wi(ge.value))&&await Ri(),await Sr(),await $e()}catch(a){throw ba.value=a instanceof Error?a.message:"Failed to execute command-plane action",a}finally{Vs.value=null}}function Wu(t){return ie(`pause:${t}`,"/api/v1/command-plane/operations/pause",{operation_id:t})}function Gu(t){return ie(`resume:${t}`,"/api/v1/command-plane/operations/resume",{operation_id:t})}function Ju(t){return ie(`recall:${t}`,"/api/v1/command-plane/dispatch/recall",{operation_id:t})}function Vu(t={}){return ie("dispatch:tick","/api/v1/command-plane/dispatch/tick",{...t.operationId?{operation_id:t.operationId}:{},...t.detachmentId?{detachment_id:t.detachmentId}:{}})}function Qu(t){return ie(`approve:${t}`,"/api/v1/command-plane/policy/approve",{decision_id:t})}function Yu(t){return ie(`deny:${t}`,"/api/v1/command-plane/policy/deny",{decision_id:t})}function Xu(t,e){return ie(`freeze:${t}`,"/api/v1/command-plane/policy/freeze",{unit_id:t,enabled:e})}function Zu(t,e){return ie(`kill:${t}`,"/api/v1/command-plane/policy/kill-switch",{unit_id:t,enabled:e})}ld(()=>{Ti()});function tp(t){if(t==null)return"";if(typeof t=="string")return t;try{return JSON.stringify(t,null,2)}catch{return String(t)}}function Z(t){if(!t)return"n/a";const e=Date.parse(t);if(Number.isNaN(e))return t;const n=Math.max(0,Math.round((Date.now()-e)/1e3));return n<60?`${n}s ago`:n<3600?`${Math.round(n/60)}m ago`:n<86400?`${Math.round(n/3600)}h ago`:`${Math.round(n/86400)}d ago`}function ep(t){if(!t)return"warn";const e=Date.parse(t);return Number.isNaN(e)?"warn":e<=Date.now()?"bad":"ok"}function np(t){if(!t)return"n/a";const e=Date.parse(t);if(Number.isNaN(e))return t;const n=Math.round((e-Date.now())/1e3);return n<=0?"expired":n<60?`in ${n}s`:n<3600?`in ${Math.round(n/60)}m`:n<86400?`in ${Math.round(n/3600)}h`:`in ${Math.round(n/86400)}d`}function J(t){return t==="bad"?"bad":t==="warn"||t==="pending"?"warn":"ok"}let ro=!1,ap=0,cs=null;async function sp(){cs||(cs=eu(()=>import("./mermaid.core-UM1s95iI.js").then(e=>e.bE),[]).then(e=>e.default));const t=await cs;return ro||(t.initialize({startOnLoad:!1,theme:"dark",securityLevel:"loose"}),ro=!0),t}function Zt(t){if(!t)return"warn";const e=t.toLowerCase();return e.includes("failed")||e.includes("error")||e.includes("disconnected")||e.includes("stopped")?"bad":e.includes("running")||e.includes("active")||e.includes("degraded")||e.includes("pending")?"warn":"ok"}function Li(t){return typeof t!="number"||!Number.isFinite(t)?"n/a":`${Math.round(t*100)}%`}function ip(t){return typeof t!="number"||!Number.isFinite(t)?"n/a":t<60?`${Math.round(t)}s`:t<3600?`${Math.round(t/60)}m`:`${Math.round(t/3600)}h`}function Ar(t){if(!t)return"No recent chain history";const e=[t.event];return typeof t.duration_ms=="number"&&e.push(`${t.duration_ms}ms`),typeof t.tokens=="number"&&e.push(`${t.tokens} tokens`),t.message&&e.push(t.message),e.join(" · ")}const wr=[{id:"summary",label:"Summary"},{id:"swarm",label:"Swarm"},{id:"operations",label:"Operations"},{id:"chains",label:"Chains"},{id:"topology",label:"Topology"},{id:"alerts",label:"Alerts"},{id:"trace",label:"Trace"},{id:"control",label:"Control"}],op=wr.map(t=>t.id),rp=["chain_start","node_start","node_complete","chain_complete","chain_error"];function lp(t){return!!t&&op.includes(t)}function cp(t){if(t==="summary")return{};if(t==="chains"){const e=Oe.value;return e?{surface:t,operation:e}:{surface:t}}return{surface:t}}function dp(){const t=new URLSearchParams(window.location.search),e=new URLSearchParams,n=t.get("agent")??t.get("agent_name"),a=t.get("token");return n&&e.set("agent",n),a&&e.set("token",a),e.toString()?`/api/v1/chains/events?${e.toString()}`:"/api/v1/chains/events"}function up(t){switch(t){case"company":return"중대 / Company";case"platoon":return"소대 / Platoon";case"squad":return"분대 / Squad";case"agent":return"에이전트 / Agent";default:return t}}function it(t){return Vs.value===t}function Pi(){return ur.value}function pp(){if(typeof window>"u")return null;const t=new URLSearchParams(window.location.search),e=t.get("agent")??t.get("agent_name");if(!e)return null;const n=e.trim();return n===""?null:n}function mp(){if(typeof window>"u")return null;const e=new URLSearchParams(window.location.search).get("run_id");if(!e)return null;const n=e.trim();return n===""?null:n}function vp(t){if(!t)return null;const e=Date.parse(t);return Number.isNaN(e)?null:Math.max(0,Math.round((Date.now()-e)/1e3))}function fp(t){return t.status==="claimed"||t.status==="in_progress"}function _p(t){const e=zn.value;if(!e)return null;for(const n of e.golden_paths){const a=n.steps.find(s=>s.tool===t);if(a)return a}return null}function ds(t){var e;return((e=zn.value)==null?void 0:e.golden_paths.find(n=>n.id===t))??null}function gp(t){const e=zn.value;if(!e)return[];const n=new Set(t);return e.pitfalls.filter(a=>n.has(a.id))}async function te(t){try{await t()}catch{}}function $p(){var m,d,v,c,y;const t=Pi(),e=Ai.value,n=t==null?void 0:t.topology.summary,a=t==null?void 0:t.operations.summary,s=(m=t==null?void 0:t.swarm_status)==null?void 0:m.overview,o=t==null?void 0:t.operations.microarch,r=t==null?void 0:t.decisions.summary,l=t==null?void 0:t.alerts.summary,p=(d=o==null?void 0:o.signals)==null?void 0:d.issue_pressure,$=o==null?void 0:o.cache;return i`
    <div class="command-summary-grid">
      ...
      <div class="monitor-stat-card"><span>Ops</span><strong>${(a==null?void 0:a.active)??0}</strong><small>${((v=t==null?void 0:t.detachments.summary)==null?void 0:v.active)??0} detachments</small></div>
      <div class="monitor-stat-card"><span>Approvals</span><strong>${(r==null?void 0:r.pending)??0}</strong><small>${(r==null?void 0:r.total)??0} tracked</small></div>
      <div class="monitor-stat-card"><span>Alerts</span><strong>${(l==null?void 0:l.bad)??0}</strong><small>${(l==null?void 0:l.warn)??0} warn</small></div>
      <div class="monitor-stat-card"><span>Chains</span><strong>${((c=e==null?void 0:e.summary)==null?void 0:c.active_chains)??0}</strong><small>${((y=e==null?void 0:e.summary)==null?void 0:y.linked_operations)??0} linked</small></div>
      <div class="monitor-stat-card"><span>Swarm</span><strong>${(s==null?void 0:s.active_lanes)??0}</strong><small>${s?`${s.stalled_lanes??0} stalled · ${Z(s.last_movement_at)}`:"no lane snapshot"}</small></div>
      <div class="monitor-stat-card"><span>Microarch</span><strong>${(p==null?void 0:p.pending_ops)??0}</strong><small>${($==null?void 0:$.l1_hit_rate)!=null?`${Li($.l1_hit_rate)} L1 hit`:"no cache data"} · ${(p==null?void 0:p.tone)??"n/a"}</small></div>
    </div>
  `}function hp(t){return t.motion_state==="stalled"||t.hard_flags.some(e=>e.severity==="bad")?"bad":t.motion_state==="waiting"||t.hard_flags.some(e=>e.severity==="warn")?"warn":"ok"}function yp({lanes:t}){const e={moving:0,waiting:0,stalled:0,terminal:0};for(const s of t){const o=s.motion_state;o in e?e[o]++:e.waiting++}if(t.length===0)return null;const a=[{key:"moving",count:e.moving,color:"var(--ok)"},{key:"waiting",count:e.waiting,color:"var(--warn)"},{key:"stalled",count:e.stalled,color:"var(--bad)"},{key:"terminal",count:e.terminal,color:"#556"}];return i`
    <div>
  ...
  `}function kp({lane:t}){const e=t.counts??{},n=hp(t),a=e.workers??0,s=e.operations??0,o=e.detachments??0,r=s+o;return i`
  ...
  `}function xp({event:t}){const e=t.timestamp?new Date(t.timestamp):null,n=e&&!isNaN(e.getTime())?e:null,a=n?`${String(n.getHours()).padStart(2,"0")}:${String(n.getMinutes()).padStart(2,"0")}`:"";return i`
  ...
  `}function Ap({proof:t}){const e=(t==null?void 0:t.status)==="missing"?"warn":(t==null?void 0:t.pass)===!1?"bad":(t==null?void 0:t.pass)===!0?"ok":"warn";return i`
  ...
  `}function wp(){const t=Pi(),e=t==null?void 0:t.swarm_status,n=t==null?void 0:t.swarm_proof,a=(e==null?void 0:e.lanes.filter($=>$.present))??[],s=(e==null?void 0:e.gaps.items)??[],o=(e==null?void 0:e.timeline.slice(0,8))??[],r=e==null?void 0:e.overview,l=e==null?void 0:e.recommended_next_action,p=a.length<=1;return i`
    <section class="card command-section">
      ...
      ${e?i`
            ...
            ${a.length>0?i`<${yp} lanes=${a} />`:null}

            <div class="command-swarm-layout ${p?"compact":""}">
              <div class="command-card-stack">
                ${a.length>0?a.map($=>i`<${kp} lane=${$} />`):i`<div class="empty-state">No active swarm lanes.</div>`}
              </div>
              ...
              <div class="command-card-stack">
                ...
                <div class="command-guide-card ${s.length>0?"warn":"ok"}">
                  <div class="command-guide-head">
                    ...
                    <span class="command-chip ${J(s.some($=>$.severity==="bad")?"bad":s.length>0?"warn":"ok")}">${s.length}</span>
                  </div>
                  ${s.length>0?i`<div class="swarm-event-rail">${s.slice(0,4).map($=>i`<${Sp} gap=${$} />`)}</div>`:i`<p>No hard gaps are currently visible.</p>`}
                </div>
                ...
                <div class="command-guide-card">
                  ...
                  ${o.length>0?i`<div class="swarm-event-rail">${o.map($=>i`<${xp} event=${$} />`)}</div>`:i`<p>No recent movement events are attached yet.</p>`}
                </div>
              </div>
            </div>
  ...
  `}function Tp(){var mt,vt,B,M,x,Dt,Vt,oe,re;const t=Pi(),e=Ht.value,n=se.value,a=pp(),s=a?wt.value.find(I=>I.name===a)??null:null,o=a?yt.value.filter(I=>I.assignee===a&&fp(I)):[],r=((mt=t==null?void 0:t.operations.summary)==null?void 0:mt.active)??0,l=((vt=t==null?void 0:t.detachments.summary)==null?void 0:vt.total)??0,p=((B=t==null?void 0:t.decisions.summary)==null?void 0:B.pending)??0,$=e==null?void 0:e.detachments.detachments.find(I=>{const Et=I.detachment.heartbeat_deadline,le=Et?Date.parse(Et):Number.NaN;return I.detachment.status==="stalled"||!Number.isNaN(le)&&le<=Date.now()}),m=e==null?void 0:e.alerts.alerts.find(I=>I.severity==="bad"),d=!!(n!=null&&n.room||n!=null&&n.project),v=(s==null?void 0:s.current_task)??null,c=vp(s==null?void 0:s.last_seen),y=c!=null?c<=120:null,S=[d?{title:"Room readiness",tone:"ok",detail:`${(n==null?void 0:n.room)??(n==null?void 0:n.project)??"unknown"} · base ${(n==null?void 0:n.room_base_path)??"n/a"}`,tool:"masc_status"}:{title:"Room readiness",tone:"bad",detail:"No room snapshot yet. Set room to repo root before joining.",tool:"masc_set_room"},a?s?o.length===0?{title:"Task readiness",tone:"warn",detail:`${a} has no claimed task. Claim one or create one first.`,tool:yt.value.length>0?"masc_claim":"masc_add_task"}:v?y===!1?{title:"Task readiness",tone:"warn",detail:`${a} current_task=${v}, but heartbeat is stale (${c}s).`,tool:"masc_heartbeat"}:{title:"Task readiness",tone:"ok",detail:`${a} current_task=${v}${c!=null?` · last seen ${c}s ago`:""}`,tool:"masc_plan_get_task"}:{title:"Task readiness",tone:"bad",detail:`${a} has a claimed task but no session current_task binding.`,tool:"masc_plan_set_task"}:{title:"Task readiness",tone:"bad",detail:`${a} is not visible in the room roster.`,tool:"masc_join"}:{title:"Task readiness",tone:"warn",detail:"No ?agent= query param. Dashboard can show room health but not agent-specific next steps.",tool:"masc_join"},!t||(((M=t.topology.summary)==null?void 0:M.managed_unit_count)??0)===0?{title:"Operation readiness",tone:"warn",detail:"No managed units defined yet. CPv2 benchmark cannot start before hierarchy exists.",tool:"masc_unit_define"}:r===0?{title:"Operation readiness",tone:"warn",detail:`${((x=t.topology.summary)==null?void 0:x.managed_unit_count)??0} managed units are ready, but there is no active operation.`,tool:"masc_operation_start"}:{title:"Operation readiness",tone:"ok",detail:`${r} active operation(s) across ${((Dt=t.topology.summary)==null?void 0:Dt.managed_unit_count)??0} managed unit(s).`,tool:"masc_observe_operations"},p>0?{title:"Dispatch readiness",tone:"warn",detail:`${p} pending approval(s) are blocking strict actions.`,tool:"masc_policy_approve"}:r>0&&l===0?{title:"Dispatch readiness",tone:"bad",detail:"Active operation exists but no detachment has been materialized yet.",tool:"masc_dispatch_tick"}:$||m?{title:"Dispatch readiness",tone:"warn",detail:`Dispatch needs reconciliation${$?` · detachment ${$.detachment.detachment_id} is stalled`:""}${m?` · alert ${m.title??m.alert_id}`:""}${!e&&!$&&!m?" · open a detail tab to inspect the exact source.":""}.`,tool:p>0?"masc_policy_approve":"masc_dispatch_tick"}:{title:"Dispatch readiness",tone:"ok",detail:`${l} detachment(s) visible and no strict approval backlog${e?"":" · detail panes stay lazy until opened."}.`,tool:"masc_detachment_list"}],T=d?!a||!s?"masc_join":o.length===0?yt.value.length>0?"masc_claim":"masc_add_task":v?y===!1?"masc_heartbeat":!t||(((Vt=t.topology.summary)==null?void 0:Vt.managed_unit_count)??0)===0?"masc_unit_define":r===0?"masc_operation_start":p>0?"masc_policy_approve":r>0&&l===0||$||m?"masc_dispatch_tick":"masc_observe_traces":"masc_plan_set_task":"masc_set_room",P=_p(T),E=gp(T==="masc_set_room"?["repo-root-room"]:T==="masc_plan_set_task"?["claimed-not-current"]:T==="masc_heartbeat"?["heartbeat-stale"]:T==="masc_dispatch_tick"?["no-detachments"]:T==="masc_policy_approve"?["pending-approval"]:["repo-root-room","claimed-not-current","heartbeat-stale"]).slice(0,2),N=ds("room_task_hygiene"),R=ds("cpv2_benchmark"),Y=ds("supervisor_session"),H=((oe=zn.value)==null?void 0:oe.docs)??[],Pt=[N,R,Y].filter(I=>I!==null);return i`
    <div class="command-guided-layout">
      ...
      <section class="card command-section">
        ...
        ${Qs.value?i`<div class="empty-state">Loading CPv2 runbook…</div>`:ka.value?i`<div class="empty-state error">${ka.value}</div>`:i`
  ...
  `}function Np(){return i`
    <${$p} />
    <${Tp} />
  `}function Rp(){return $a.value?i`<div class="empty-state">Loading command-plane detail…</div>`:ya.value?i`<div class="empty-state error">${ya.value}</div>`:i`<div class="empty-state">Select a surface to load command-plane detail.</div>`}function Cr({node:t,depth:e=0}){const n=t.roster_live??0,a=t.roster_total??t.unit.roster.length,s=t.active_operation_count??0,o=t.unit.policy;return i`
    <div class="command-tree-node depth-${Math.min(e,3)}">
      <div class="command-tree-head">
        <div>
          <div class="command-tree-title-row">
            <strong>${t.unit.label}</strong>
            <span class="command-chip">${up(t.unit.kind)}</span>
  ...
  `}function Lp({source:t}){const e=To(null),[n,a]=Wa(null);return rt(()=>{let s=!1;const o=e.current;return o?(o.innerHTML="",a(null),(async()=>{try{const l=await sp(),{svg:p}=await l.render(`command-chain-${++ap}`,t);if(s||!e.current)return;e.current.innerHTML=p}catch(l){if(s)return;a(l instanceof Error?l.message:"Mermaid render failed")}})(),()=>{s=!0,e.current&&(e.current.innerHTML="")}):void 0},[t]),i`
    <div class="command-chain-graph-shell">
      ${n?i`<div class="empty-state error">${n}</div>`:null}
      <div class="command-chain-graph" ref=${e}></div>
    </div>
  `}function Pp({overlay:t,selected:e,onSelect:n}){const a=t.operation.chain,s=t.runtime;return i`
    <button class="command-chain-item ${e?"selected":""}" onClick=${n}>
      ...
      <div class="command-tag-row">
        ...
        ${s?i`<span class="command-tag ${Zt(a==null?void 0:a.status)}">${Li(s.progress)} progress</span>`:null}
      </div>
  ...
  `}function Ip({card:t}){const e=t.operation,n=`pause:${e.operation_id}`,a=`resume:${e.operation_id}`,s=`recall:${e.operation_id}`,o=e.chain;return i`
      ...
      <div class="command-action-row">
        ${o?i`
              <button
                ...
                onClick=${()=>{Ni(e.operation_id),wa("chains"),At("command",{surface:"chains",operation:e.operation_id})}}
              >
                Open Chain
              </button>
            `:null}
  ...
  `}function Mp({card:t}){var n;const e=t.detachment;return i`
  ...
  `}function zp({decision:t}){const e=`approve:${t.decision_id}`,n=`deny:${t.decision_id}`,a=t.source==="projected_operator";return i`
  ...
  `}function jp({row:t}){var l,p,$;const e=t.unit,n=`freeze:${e.unit_id}`,a=`kill:${e.unit_id}`,s=!!((l=e.policy)!=null&&l.frozen),o=!!((p=e.policy)!=null&&p.kill_switch),r=Math.round((t.utilization??0)*100);return i`
    <article class="command-card compact">
      <div class="command-card-head">
        <div>
  ...
  `}function Fp({blocker:t}){return i`
    <article class="command-alert ${J(t.severity)}">
      <div class="command-card-head">
        <strong>${t.title}</strong>
      ...
      <div class="command-surface-grid">
                        ...
                        <article class="command-trace-row">
                          <div class="command-trace-main">
                            <div class="command-trace-head">
                              ...
                              <span class="command-chip">${Z(M.timestamp)}</span>
                            </div>
        ...
        <section class="card command-section">
          ...
          ${t&&t.blockers.length>0?i`<div class="command-card-stack">
                ${t.blockers.map(M=>i`<${Fp} blocker=${M} />`)}
    ...
    <div class="command-surface-grid">
      <section class="card command-section">
        ...
        ${t&&t.operations.operations.length>0?i`<div class="command-card-stack">
              ${t.operations.operations.map(e=>i`<${Ip} card=${e} />`)}
      ...
      <section class="card command-section">
        ...
        ${t&&t.detachments.detachments.length>0?i`<div class="command-card-stack">
              ${t.detachments.detachments.map(e=>i`<${Mp} card=${e} />`)}
            </div>`:i`<div class="empty-state">No detachments projected.</div>`}
      </section>
    </div>
  `}function Bp(){var l,p,$,m,d,v,c,y,S,T,P,K,E,N,R,Y;const t=Ai.value,e=(t==null?void 0:t.operations)??[],n=Oe.value,a=e.find(H=>H.operation.operation_id===n)??e[0]??null,s=((l=a==null?void 0:a.operation.chain)==null?void 0:l.run_id)??null,o=((p=Ln.value)==null?void 0:p.run)??(a==null?void 0:a.preview_run)??null,r=!(($=Ln.value)!=null&&$.run)&&!!(a!=null&&a.preview_run);return rt(()=>{s?Uu(s):Hu()},[s]),i`
      ...
      <section class="card command-section">
        ...
        <div class="command-chain-history">
          ...
          ${t&&t.recent_history.length>0?i`
                <div class="command-card-stack">
                  ${t.recent_history.slice(0,6).map(H=>i`<${Dp} item=${H} />`)}
                </div>
  ...
  `}function Gp(){const t=Ht.value;return i`
    <section class="card command-section">
      ...
      ${t&&t.alerts.alerts.length>0?i`<div class="command-card-stack">
            ${t.alerts.alerts.map(e=>i`<${Op} alert=${e} />`)}
  ...
  `}function Qp(){if(ge.value==="summary")return i`<${Np} />`;if(ge.value==="swarm")return i`<${Hp} />`;if(!Ht.value)return i`<${Rp} />`;switch(ge.value){case"chains":return i`<${Bp} />`;case"topology":return i`<${Wp} />`;case"alerts":return i`<${Gp} />`;case"trace":return i`<${Jp} />`;case"control":return i`<${Vp} />`;case"operations":default:return i`<${Up} />`}}function Yp(){return rt(()=>{ze(),$e(),Bu(),Sr()},[]),rt(()=>{if(nt.value.tab!=="command")return;const t=nt.value.params.surface,e=nt.value.params.operation;lp(t)?wa(t):t||wa("summary"),e&&Ni(e)},[nt.value.tab,nt.value.params.surface,nt.value.params.operation]),rt(()=>{let t=null;const e=()=>{t||(t=window.setTimeout(()=>{t=null,ze(),$e()},250))},n=new EventSource(dp()),a=rp.map(s=>{const o=()=>e();return n.addEventListener(s,o),{type:s,handler:o}});return n.onerror=()=>{e()},()=>{a.forEach(({type:s,handler:o})=>{n.removeEventListener(s,o)}),n.close(),t&&window.clearTimeout(t)}},[]),i`
    <section class="dashboard-panel command-plane-view">
      <div class="panel-header">
        ...
        <div class="panel-actions">
          ...
          <button class="control-btn ghost" onClick=${()=>{ze(),$e()}} disabled=${ga.value}>
  ...
  `}const jn=_(null),Ca=_(!1),ae=_(null),W=_(!1),Ta=_([]);let Xp=1;function G(t){return typeof t=="object"&&t!==null&&!Array.isArray(t)}function D(t){return typeof t=="string"&&t.trim()!==""?t:void 0}function $t(t){return typeof t=="number"&&Number.isFinite(t)?t:void 0}function Nr(t){return typeof t=="boolean"?t:void 0}function Zp(t){return Array.isArray(t)?t.map(e=>typeof e=="string"?e.trim():"").filter(Boolean):[]}function Te(t,e=[]){if(Array.isArray(t))return t;if(!G(t))return[];for(const n of e){const a=t[n];if(Array.isArray(a))return a}return[]}function tm(t){return G(t)?{id:D(t.id),seq:$t(t.seq),from:D(t.from)??D(t.from_agent)??"system",content:D(t.content)??"",timestamp:D(t.timestamp)??new Date().toISOString(),type:D(t.type)}:null}function em(t){return G(t)?{room_id:D(t.room_id),current_room:D(t.current_room)??D(t.room),project:D(t.project),cluster:D(t.cluster),paused:Nr(t.paused),pause_reason:D(t.pause_reason)??null,paused_by:D(t.paused_by)??null,paused_at:D(t.paused_at)??null}:{}}function lo(t){if(!G(t))return;const e=Object.entries(t).map(([n,a])=>{const s=D(a);return s?[n,s]:null}).filter(n=>n!==null);return e.length>0?Object.fromEntries(e):void 0}function nm(t){if(!G(t))return null;const e=G(t.status)?t.status:void 0,n=G(t.summary)?t.summary:G(e==null?void 0:e.summary)?e.summary:void 0,a=G(t.session)?t.session:G(e==null?void 0:e.session)?e.session:void 0,s=D(t.session_id)??D(n==null?void 0:n.session_id)??D(a==null?void 0:a.session_id);if(!s)return null;const o=lo(t.report_paths)??lo(e==null?void 0:e.report_paths),r=Te(t.recent_events,["events"]).filter(G);return{session_id:s,status:D(t.status)??D(n==null?void 0:n.status)??D(a==null?void 0:a.status),progress_pct:$t(t.progress_pct)??$t(n==null?void 0:n.progress_pct),elapsed_sec:$t(t.elapsed_sec)??$t(n==null?void 0:n.elapsed_sec),remaining_sec:$t(t.remaining_sec)??$t(n==null?void 0:n.remaining_sec),done_delta_total:$t(t.done_delta_total)??$t(n==null?void 0:n.done_delta_total),summary:n,team_health:G(t.team_health)?t.team_health:G(e==null?void 0:e.team_health)?e.team_health:void 0,communication_metrics:G(t.communication_metrics)?t.communication_metrics:G(e==null?void 0:e.communication_metrics)?e.communication_metrics:void 0,orchestration_state:G(t.orchestration_state)?t.orchestration_state:G(e==null?void 0:e.orchestration_state)?e.orchestration_state:void 0,cascade_metrics:G(t.cascade_metrics)?t.cascade_metrics:G(e==null?void 0:e.cascade_metrics)?e.cascade_metrics:void 0,report_paths:o,session:a,recent_events:r}}function am(t){if(!G(t))return null;const e=D(t.name);if(!e)return null;const n=G(t.context)?t.context:void 0;return{name:e,agent_name:D(t.agent_name),status:D(t.status),autonomy_level:D(t.autonomy_level),context_ratio:$t(t.context_ratio)??$t(n==null?void 0:n.context_ratio),generation:$t(t.generation),active_goal_ids:Zp(t.active_goal_ids),last_autonomous_action_at:D(t.last_autonomous_action_at)??null,last_turn_ago_s:$t(t.last_turn_ago_s),model:D(t.model)??D(t.active_model)??D(t.primary_model)}}function sm(t){if(!G(t))return null;const e=D(t.confirm_token)??D(t.token);return e?{confirm_token:e,actor:D(t.actor),action_type:D(t.action_type),target_type:D(t.target_type),target_id:D(t.target_id)??null,delegated_tool:D(t.delegated_tool),created_at:D(t.created_at),preview:t.preview}:null}function im(t){const e=G(t)?t:{};return{room:em(e.room),sessions:Te(e.sessions,["items","sessions"]).map(nm).filter(n=>n!==null),keepers:Te(e.keepers,["items","keepers"]).map(am).filter(n=>n!==null),recent_messages:Te(e.recent_messages,["messages"]).map(tm).filter(n=>n!==null),pending_confirms:Te(e.pending_confirms,["items","confirms"]).map(sm).filter(n=>n!==null),available_actions:Te(e.available_actions,["actions"]).filter(G).map(n=>({action_type:D(n.action_type)??"unknown",target_type:D(n.target_type)??"unknown",description:D(n.description),confirm_required:Nr(n.confirm_required)}))}}function Hn(t){if(typeof t=="string")return t;if(t==null)return"";try{return JSON.stringify(t)}catch{return String(t)}}function co(t){return t.target_id?`${t.target_type}:${t.target_id}`:t.target_type}function Na(t){Ta.value=[{...t,id:Xp++,at:new Date().toISOString()},...Ta.value].slice(0,20)}function Rr(t){return t.confirm_required?Hn(t.preview)||"Confirmation required":Hn(t.result)||Hn(t.executed_action)||Hn(t.delegated_tool_result)||t.status}async function Ue(){Ca.value=!0,ae.value=null;try{const t=await Cl();jn.value=im(t)}catch(t){ae.value=t instanceof Error?t.message:"Failed to load operator snapshot"}finally{Ca.value=!1}}async function om(t){W.value=!0,ae.value=null;try{const e=await On(t);return Na({actor:t.actor,action_type:t.action_type,target_label:co(t),outcome:e.confirm_required?"preview":"executed",message:Rr(e),delegated_tool:e.delegated_tool}),await Ue(),e}catch(e){const n=e instanceof Error?e.message:"Operator action failed";throw ae.value=n,Na({actor:t.actor,action_type:t.action_type,target_label:co(t),outcome:"error",message:n}),e}finally{W.value=!1}}async function rm(t,e){W.value=!0,ae.value=null;try{const n=await Ml(t,e);return Na({actor:t,action_type:"confirm",target_label:e,outcome:"confirmed",message:Rr(n),delegated_tool:n.delegated_tool}),await Ue(),n}catch(n){const a=n instanceof Error?n.message:"Operator confirmation failed";throw ae.value=a,Na({actor:t,action_type:"confirm",target_label:e,outcome:"error",message:a}),n}finally{W.value=!1}}const Lr="masc_dashboard_agent_name";function lm(){var e,n,a;const t=new URLSearchParams(window.location.search);return((e=t.get("agent"))==null?void 0:e.trim())||((n=t.get("agent_name"))==null?void 0:n.trim())||((a=localStorage.getItem(Lr))==null?void 0:a.trim())||"dashboard"}const Qa=_(lm()),dn=_(""),Zs=_("Operator pause"),un=_(""),Ra=_(""),ti=_("2"),La=_(""),je=_("note"),Pa=_(""),Da=_(""),Ea=_(""),ei=_("2"),ni=_("Operator stop request"),ai=_(""),pn=_("");function cm(t){const e=t.trim()||"dashboard";Qa.value=e,localStorage.setItem(Lr,e)}function us(t){if(t==null)return"";if(typeof t=="string")return t;try{return JSON.stringify(t,null,2)}catch{return String(t)}}function dm(t){return typeof t!="number"||!Number.isFinite(t)?"n/a":t<60?`${Math.round(t)}s ago`:t<3600?`${Math.round(t/60)}m ago`:`${Math.round(t/3600)}h ago`}function Ia(t){return typeof t=="string"?t.trim().toLowerCase():""}function um(t){var a;const e=Ia(t.status);if(e==="paused")return"bad";const n=Ia((a=t.team_health)==null?void 0:a.status);return n&&n!=="ok"&&n!=="healthy"&&n!=="green"||e&&e!=="active"&&e!=="running"&&e!=="ended"?"warn":"ok"}function uo(t){const e=Ia(t.status);return e==="offline"||e==="inactive"||e==="error"?"bad":(t.context_ratio??0)>=.8||(t.last_turn_ago_s??0)>=3600?"warn":"ok"}async function ye(t){const e=Qa.value.trim()||"dashboard";try{const n=await om({actor:e,action_type:t.action_type,target_type:t.target_type,target_id:t.target_id,payload:t.payload});return n.confirm_required?w("Confirmation queued","warning"):w(t.successMessage,"success"),n}catch(n){const a=n instanceof Error?n.message:"Operator action failed";return w(a,"error"),null}}async function po(){const t=dn.value.trim();if(!t)return;await ye({action_type:"broadcast",target_type:"room",payload:{message:t},successMessage:"Broadcast sent"})&&(dn.value="")}async function pm(){await ye({action_type:"room_pause",target_type:"room",payload:{reason:Zs.value.trim()||"Operator pause"},successMessage:"Pause request sent"})}async function mm(){await ye({action_type:"room_resume",target_type:"room",payload:{},successMessage:"Room resumed"})}async function vm(){const t=un.value.trim();if(!t)return;await ye({action_type:"task_inject",target_type:"room",payload:{title:t,description:Ra.value.trim()||"Injected from Ops tab",priority:Number.parseInt(ti.value,10)||2},successMessage:"Task injection submitted"})&&(un.value="",Ra.value="")}async function fm(){var o;const t=jn.value,e=La.value||((o=t==null?void 0:t.sessions[0])==null?void 0:o.session_id)||"";if(!e){w("Select a team session first","warning");return}const n={turn_kind:je.value},a=Pa.value.trim();a&&(n.message=a),je.value==="task"&&(n.task_title=Da.value.trim()||"Operator injected task",n.task_description=Ea.value.trim()||"Injected from Ops tab",n.task_priority=Number.parseInt(ei.value,10)||2),await ye({action_type:"team_turn",target_type:"team_session",target_id:e,payload:n,successMessage:"Team session updated"})&&(Pa.value="",je.value==="task"&&(Da.value="",Ea.value=""))}async function _m(){var n;const t=jn.value,e=La.value||((n=t==null?void 0:t.sessions[0])==null?void 0:n.session_id)||"";if(!e){w("Select a team session first","warning");return}await ye({action_type:"team_stop",target_type:"team_session",target_id:e,payload:{reason:ni.value.trim()||"Operator stop request"},successMessage:"Team stop requested"})}async function gm(){var s;const t=jn.value,e=ai.value||((s=t==null?void 0:t.keepers[0])==null?void 0:s.name)||"",n=pn.value.trim();if(!e){w("Select a keeper first","warning");return}if(!n)return;await ye({action_type:"keeper_msg",target_type:"keeper",target_id:e,payload:{message:n},successMessage:`Message sent to ${e}`})&&(pn.value="")}async function mo(t){const e=Qa.value.trim()||"dashboard";try{await rm(e,t),w("Confirmation executed","success")}catch(n){const a=n instanceof Error?n.message:"Confirmation failed";w(a,"error")}}function $m(){var v;const t=jn.value,e=(t==null?void 0:t.room)??{},n=(t==null?void 0:t.sessions)??[],a=(t==null?void 0:t.keepers)??[],s=(t==null?void 0:t.pending_confirms)??[],o=(t==null?void 0:t.recent_messages)??[],r=n.find(c=>c.session_id===La.value)??n[0]??null,l=a.find(c=>c.name===ai.value)??a[0]??null,p=n.filter(c=>um(c)!=="ok"),$=a.filter(c=>uo(c)!=="ok"),m=o.slice(0,5),d=[{key:"room",label:"Room Gate",value:e.paused?"Paused":"Open",detail:e.paused?`Resume gate armed${e.pause_reason?` · ${e.pause_reason}`:""}`:"Commands are live and the room is accepting new work",tone:e.paused?"bad":"ok"},{key:"confirm",label:"Pending Confirm",value:s.length,detail:s.length>0?"Previewed operator actions are waiting for confirmation":"No confirm gates are currently blocking execution",tone:s.length>0?"warn":"ok"},{key:"session",label:"Session Risk",value:p.length,detail:p.length>0?"Team sessions need steering, stop, or checkpoint attention":"Team sessions look healthy from the operator snapshot",tone:p.some(c=>Ia(c.status)==="paused")?"bad":p.length>0?"warn":"ok"},{key:"keeper",label:"Keeper Pressure",value:$.length,detail:$.length>0?"At least one keeper is stale, offline, or running hot":"Keepers are available for direct intervention",tone:$.some(c=>uo(c)==="bad")?"bad":$.length>0?"warn":"ok"}];return i`
      ...
      <div class="ops-header card">
        ...
        <div class="ops-toolbar">
          ...
          <input
            ...
            type="text"
            value=${Qa.value}
            onInput=${c=>cm(c.target.value)}
          />
          <button class="control-btn ghost" onClick=${()=>{Ue()}} disabled=${Ca.value||W.value}>
          ...
          <div class="ops-confirmation-list">
            ${s.map(c=>i`
              <article key=${c.confirm_token} class="ops-confirmation-card">
                ...
                ${c.preview?i`<pre class="ops-code-block">${us(c.preview)}</pre>`:null}
                <div class="ops-confirmation-actions">
                  <button class="control-btn" onClick=${()=>{mo(c.confirm_token)}} disabled=${W.value}>
                    Confirm
                  </button>
              ...
              <div class="ops-confirmation-list">
                ${s.map(c=>i`
                  <article key=${c.confirm_token} class="ops-confirmation-card">
                    ...
                    ${c.preview?i`<pre class="ops-code-block compact">${us(c.preview)}</pre>`:null}
                    <div class="ops-confirmation-actions">
                      <button class="control-btn" onClick=${()=>{mo(c.confirm_token)}} disabled=${W.value}>
                        Confirm
                      </button>
              ...
              ${a.length===0?i`<div class="ops-empty">No keepers available.</div>`:a.map(c=>i`
                ...
                >
                  ...
                  <div class="ops-entity-meta">
                    ...
                    <span>${dm(c.last_turn_ago_s)}</span>
                  </div>
                </button>
              `)}
            </div>
        ...
        <div class="ops-column ops-studio-column">
          <section class="card ops-panel ops-studio-panel">
            ...
            <div class="ops-studio-group">
              ...
              <div class="control-row">
                <input
                  ...
                  disabled=${W.value}
                />
                <button class="control-btn" onClick=${()=>{po()}} disabled=${W.value||dn.value.trim()===""}>
                  Send
                </button>
              </div>
              ...
              <div class="control-row ops-split-row">
                <input
                  ...
                  disabled=${W.value}
                />
                <button class="control-btn ghost" onClick=${()=>{pm()}} disabled=${W.value}>
                  Pause
                </button>
                <button class="control-btn ghost" onClick=${()=>{mm()}} disabled=${W.value}>
                  Resume
                </button>
              </div>
              ...
              <div class="control-row ops-split-row">
                ...
                <button class="control-btn" onClick=${()=>{vm()}} disabled=${W.value||un.value.trim()===""}>
                  Inject
                </button>
              </div>
            </div>
            ...
            <div class="ops-studio-group">
              ...
              ${r?i`
                <div class="ops-detail-card">
                  ...
                  ${r.recent_events&&r.recent_events.length>0?i`
                    <pre class="ops-code-block compact">${us(r.recent_events.slice(-3))}</pre>
                  `:null}
                </div>
              ...
              <div class="control-row ops-split-row">
                <select
                  ...
                  class="control-input ops-select"
                  value=${je.value}
                  onChange=${c=>{je.value=c.target.value}}
                  disabled=${W.value||!r}
                >
                ...
                <button class="control-btn" onClick=${()=>{fm()}} disabled=${W.value||!r}>
                  Apply
                </button>
              </div>
              <textarea
              ...
              <div class="control-row ops-split-row">
                <input
                  ...
                  disabled=${W.value||!r}
                />
                <button class="control-btn ghost" onClick=${()=>{_m()}} disabled=${W.value||!r}>
                  Stop
                </button>
              </div>
            </div>
            ...
            <div class="ops-studio-group">
              ...
              ></textarea>
              <div class="control-row">
                <button class="control-btn" onClick=${()=>{gm()}} disabled=${W.value||!l||pn.value.trim()===""}>
                  Send Keeper Message
                </button>
              </div>
            </div>
  ...
  `}function hm({text:t}){if(!t)return null;const e=ym(t);return i`<div class="markdown-content">${e}</div>`}function ym(t){const e=t.split(`
...
`).trim();n.push(i`
      ...
      `);continue}if(s.startsWith("> ")){const r=[];for(;a<e.length&&e[a].startsWith("> ");)r.push(e[a].slice(2)),a++;n.push(i`<blockquote>${ps(r.join(`
`))}</blockquote>`);continue}if(s.trim()===""){a++;continue}const o=[];for(;a<e.length;){const r=e[a];if(r.trim()===""||/^(`{3,}|~{3,})/.test(r)||r.startsWith("> ")||r.trim().startsWith("<think>"))break;o.push(r),a++}o.length>0&&n.push(i`<p>${ps(o.join(`
`))}</p>`)}return n}function ps(t){const e=[],n=/(`[^`]+`)|(\*\*[^*]+\*\*)|(\*[^*]+\*)|\[([^\]]+)\]\(([^)]+)\)/g;let a=0,s;for(;(s=n.exec(t))!==null;){if(s.index>a&&e.push(t.slice(a,s.index)),s[1]){const o=s[1].slice(1,-1);e.push(i`<code>${o}</code>`)}else if(s[2]){const o=s[2].slice(2,-2);e.push(i`<strong>${o}</strong>`)}else if(s[3]){const o=s[3].slice(1,-1);e.push(i`<em>${o}</em>`)}else s[4]&&s[5]&&e.push(i`<a href=${s[5]} target="_blank" rel="noopener">${s[4]}</a>`);a=s.index+s[0].length}return a<t.length&&e.push(t.slice(a)),e.length>0?e:[t]}const on=_("posts"),si=_([]),ii=_([]),mn=_(""),Ma=_(!1),vn=_(!1),Dn=_(""),Oa=_(null),Nt=_(null),oi=_(!1),Xt=_(null),sa=_(null);async function Ya(){Ma.value=!0,Dn.value="";try{const[t,e]=await Promise.all([hc(),yc()]);si.value=t,ii.value=e,Xt.value=!0,sa.value=Date.now()}catch(t){Dn.value=t instanceof Error?t.message:"Failed to load council data",Xt.value=!1}finally{Ma.value=!1}}rd(Ya);async function vo(){const t=mn.value.trim();if(t){vn.value=!0;try{const e=await bc(t);mn.value="",w(e!=null&&e.id?`Debate started: ${e.id}`:"Debate started","success"),await Ya()}catch(e){const n=e instanceof Error?e.message:"Failed to start debate";w(n,"error")}finally{vn.value=!1}}}async function bm(t){Oa.value=t,oi.value=!0,Nt.value=null;try{Nt.value=await kc(t)}catch(e){Dn.value=e instanceof Error?e.message:"Failed to load debate status",Nt.value=null}finally{oi.value=!1}}const Pr=[{id:"hot",label:"Hot"},{id:"trending",label:"Trending"},{id:"recent",label:"Recent"},{id:"updated",label:"Updated"},{id:"discussed",label:"Discussed"}],ia=_(null),fn=_([]),he=_(!1),fe=_(null),_n=_("");function km(){var e,n;const t=new URLSearchParams(window.location.search);return((e=t.get("agent"))==null?void 0:e.trim())||((n=t.get("agent_name"))==null?void 0:n.trim())||"dashboard-user"}const xm=_(km()),gn=_(!1);async function Di(t){fe.value=t,ia.value=null,fn.value=[],he.value=!0;try{const e=await Hl(t);if(fe.value!==t)return;ia.value={id:e.id,author:e.author,title:e.title,content:e.content,tags:e.tags,votes:e.votes,vote_balance:e.vote_balance,comment_count:e.comment_count,created_at:e.created_at,updated_at:e.updated_at,flair:e.flair,hearth_count:e.hearth_count},fn.value=e.comments??[]}catch{fe.value===t&&(ia.value=null,fn.value=[])}finally{fe.value===t&&(he.value=!1)}}async function fo(t){const e=_n.value.trim();if(e){gn.value=!0;try{await Ul(t,xm.value,e),_n.value="",w("Comment posted","success"),await Di(t),jt()}catch{w("Failed to post comment","error")}finally{gn.value=!1}}}function Sm(){const t=An.value;return i`
  ...
  `}function ri(){var e;const t=(e=se.value)==null?void 0:e.data_quality;return!t||t.board_contract_ok!==!1&&!t.last_sync_at?null:i`
  ...
  `}function Dr({flair:t}){return t?i`<span class="post-flair ${t}">${t}</span>`:null}function Am(t){const e=t.replace(/!\[[^\]]*\]\([^)]+\)/g," ").replace(/\[[^\]]+\]\([^)]+\)/g,"$1").replace(/[`#>*_~-]/g," ").replace(/\s+/g," ").trim();return e?e.length>180?`${e.slice(0,177)}...`:e:"No preview available"}function _o(t){return t.updated_at!==t.created_at}function li(){var n;const t=((n=Pr.find(a=>a.id===An.value))==null?void 0:n.label)??An.value,e=We.value.length;return i`
    <div class="board-summary-strip">
      ...
      <div class="board-summary-item">
        ...
        <strong>${Gs.value?i`<${F} timestamp=${Gs.value} />`:"Not loaded"}</strong>
      </div>
    </div>
  `}function wm({post:t}){const e=async(n,a)=>{a.stopPropagation();try{await jo(t.id,n),jt()}catch{w("Failed to vote","error")}};return i`
      ...
      <div class="post-content">
        <div class="post-head">
          ...
          <div class="post-meta">
            ...
            ${_o(t)?i`<span>Updated <${F} timestamp=${t.updated_at} /></span>`:null}
            <span>${t.comment_count} comments</span>
            <span>${t.votes??0} votes</span>
            ${(t.hearth_count??0)>0?i`<span>♥ ${t.hearth_count}</span>`:null}
          </div>
        </div>
        <div class="post-snippet">${Am(t.content)}</div>
      </div>
    </div>
  `}function Cm({comments:t}){return t.length===0?i`<div class="empty-state" style="font-size:13px">No comments yet</div>`:i`
  ...
  `}function Nm({post:t}){fe.value!==t.id&&!he.value&&Di(t.id);const e=async n=>{try{await jo(t.id,n),jt()}catch{w("Failed to vote","error")}};return i`
    <div>
      ...
      <${C} title="Comments (${he.value?"...":fn.value.length})">
        ${he.value?i`<div class="loading-indicator">Loading comments...</div>`:i`<${Cm} comments=${fn.value} />`}
        <${Tm} postId=${t.id} />
      <//>
    </div>
  `}function Rm({debate:t}){const e=Oa.value===t.id;return i`
    <button
  ...
  `}function Lm({session:t}){return i`
  ...
  `}function Er(){return Xt.value===null||Xt.value&&!sa.value?null:i`
  ...
  `}function Pm(){const t=Xt.value===!1;return i`
    <div>
      <${Er} />
      ...
      <${C} title="Debates" class="section">
        <div class="council-list">
          ${si.value.length===0?i`<div class="empty-state">${t?"No debates loaded (council feed degraded).":"No debates yet"}</div>`:si.value.map(e=>i`<${Rm} key=${e.id} debate=${e} />`)}
        </div>
      <//>

      <${C} title=${Oa.value?`Debate Detail (${Oa.value})`:"Debate Detail"} class="section">
        ${oi.value?i`<div class="loading-indicator">Loading debate detail...</div>`:Nt.value?i`
                ...
                ${Nt.value.summary_text?i`<pre class="council-detail">${Nt.value.summary_text}</pre>`:null}
              `:i`<div class="empty-state">Select a debate to view summary</div>`}
      <//>
    </div>
  `}function Dm(){const t=Xt.value===!1;return i`
    <div>
      <${Er} />
      <${C} title="Voting Sessions" class="section">
        <div class="council-list">
          ${ii.value.length===0?i`<div class="empty-state">${t?"No sessions loaded (council feed degraded).":"No active sessions"}</div>`:ii.value.map(e=>i`<${Lm} key=${e.id} session=${e} />`)}
        </div>
      <//>
    </div>
  `}function Em(){const t=on.value;return i`
  ...
  `}function Im(){var a,s;const t=We.value,e=Cn.value,n=((s=(a=se.value)==null?void 0:a.data_quality)==null?void 0:s.board_contract_ok)===!1;return i`
    <div>
      <${ri} />
      <${li} />
      <${Sm} />
      ${e?i`<div class="loading-indicator">Loading board...</div>`:t.length===0?i`
            ...
            `:i`<div class="board-post-list">
              ${t.map(o=>i`<${wm} key=${o.id} post=${o} />`)}
            </div>`}
    </div>
  `}function Mm(){var s,o;const t=We.value,e=nt.value.postId,n=((o=(s=se.value)==null?void 0:s.data_quality)==null?void 0:o.board_contract_ok)===!1,a=on.value;if(rt(()=>{(a==="debates"||a==="voting")&&Ya()},[a]),e){const r=t.find(l=>l.id===e)??(fe.value===e?ia.value:null);return!r&&fe.value!==e&&!he.value&&Di(e),r?i`
          <${ri} />
          <${li} />
          <${Nm} post=${r} />
        `:i`
          <div>
            ...
            <${li} />
            <button class="back-btn" onClick=${()=>At("board")}>← Back to Board</button>
            ${he.value?i`<div class="loading-indicator">Loading post...</div>`:i`
                  <div class="empty-state">
        ...
        `}return i`
    <${Em} />
    ${a==="debates"?i`<${Pm} />`:a==="voting"?i`<${Dm} />`:i`<${Im} />`}
  `}const Om=40;function zm({items:t,itemHeight:e,overscan:n=5,renderItem:a,getKey:s,className:o=""}){const r=To(null),[l,p]=Wa({start:0,end:30}),$=t.length>Om;if(rt(()=>{if(!$)return;const c=r.current;if(!c)return;let y=!1;const S=()=>{const{scrollTop:E,clientHeight:N}=c,R=Math.max(0,Math.floor(E/e)-n),Y=Math.min(t.length,Math.ceil((E+N)/e)+n);p(H=>H.start===R&&H.end===Y?H:{start:R,end:Y})};let T=!1;const P=()=>{T||y||(T=!0,requestAnimationFrame(()=>{y||S(),T=!1}))},K=new ResizeObserver(()=>{y||S()});return S(),c.addEventListener("scroll",P,{passive:!0}),K.observe(c),()=>{y=!0,c.removeEventListener("scroll",P),K.disconnect()}},[$,t.length,e,n]),!$)return i`
      <div class=${o}>
        ${t.map((c,y)=>a(c,y))}
      </div>
  ...
  `}function jm(t){if(t.kind)return t.kind;switch(t.eventType){case"board_post":case"board_comment":return"board";case"task_update":return"tasks";case"keeper_heartbeat":case"keeper_handoff":case"keeper_compaction":case"keeper_guardrail":return"keepers";default:return"system"}}function qm(t){var e,n;return((e=t.author)==null?void 0:e.trim())||((n=t.agent)==null?void 0:n.trim())||"system"}function Fm(t){switch(t.eventType){case"board_post":return t.preview?`Post: ${t.preview}`:t.text||"New post";case"board_comment":return t.preview?`Comment: ${t.preview}`:t.text||"New comment";default:return t.text}}const Ir=120,Km=12,Hm=16,Um=12,ci=_("all"),Bm={all:"All",messages:"Messages",board:"Board",tasks:"Tasks",keepers:"Keepers",system:"System"},Wm={messages:"MSG",board:"BOARD",tasks:"TASK",keepers:"KEEPER",system:"SYS"};function Gm(t,e){return{id:t.id??`msg-${t.seq??e}`,source:"message",kind:"messages",actor:t.from??"system",content:t.content,timestamp:t.timestamp}}function Jm(t,e){return{id:t.postId?`evt-${t.eventType??"event"}-${t.postId}-${e}`:`evt-${t.timestamp}-${e}`,source:"event",kind:jm(t),actor:qm(t),content:Fm(t),timestamp:new Date(t.timestamp).toISOString()}}function Vm(t,e){var s;const n=(s=t.assignee)==null?void 0:s.trim(),a=t.updated_at??t.created_at;return!n||!a?null:{id:`task-${t.id}-${e}`,source:"snapshot",kind:"tasks",actor:n,content:`Task: ${t.title} (${t.status})`,timestamp:a}}function Qm(t,e){return{id:`board-${t.id}-${e}`,source:"snapshot",kind:"board",actor:t.author,content:`Post: ${t.title||t.content}`,timestamp:t.updated_at||t.created_at}}function Un(t){return typeof t!="number"||!Number.isFinite(t)||t<0?null:new Date(Date.now()-t*1e3).toISOString()}function di(t){return t.last_heartbeat??Un(t.last_turn_ago_s)??Un(t.last_proactive_ago_s)??Un(t.last_handoff_ago_s)??Un(t.last_compaction_ago_s)}function Ym(t,e){const n=di(t);if(!n)return null;const a=typeof t.context_ratio=="number"&&Number.isFinite(t.context_ratio)?`${Math.round(t.context_ratio*100)}%`:"?";return{id:`keeper-${t.name}-${e}`,source:"snapshot",kind:"keepers",actor:t.name,content:t.last_heartbeat?`Heartbeat gen=${t.generation??"?"} ctx=${a}`:`Keeper snapshot gen=${t.generation??"?"} ctx=${a}`,timestamp:n}}function It(t){const e=typeof t=="number"?t:Date.parse(t);return Number.isNaN(e)?0:e}const ui=Ct(()=>{const t=Sn.value.map(Gm),e=da.value.map(Jm),n=[...yt.value].sort((o,r)=>It(r.updated_at??r.created_at??0)-It(o.updated_at??o.created_at??0)).slice(0,Km).map(Vm).filter(o=>o!==null),a=[...We.value].sort((o,r)=>It(r.updated_at||r.created_at)-It(o.updated_at||o.created_at)).slice(0,Hm).map(Qm),s=[...Jt.value].sort((o,r)=>It(di(r)??0)-It(di(o)??0)).slice(0,Um).map(Ym).filter(o=>o!==null);return[...t,...e,...n,...a,...s].sort((o,r)=>It(r.timestamp)-It(o.timestamp))}),Xm=Ct(()=>{const t=ui.value;return{total:t.length,messages:t.filter(e=>e.kind==="messages").length,board:t.filter(e=>e.kind==="board").length,tasks:t.filter(e=>e.kind==="tasks").length,keepers:t.filter(e=>e.kind==="keepers").length,system:t.filter(e=>e.kind==="system").length}}),Zm=Ct(()=>{const t=ci.value;return(t==="all"?ui.value:ui.value.filter(n=>n.kind===t)).slice(0,Ir)}),tv=Ct(()=>{const t=Ja.value,e={activeAssignedCount:0,lastActivityAt:null,lastActivityText:null};return wt.value.map(n=>({agent:n,motion:t.get(n.name.trim().toLowerCase())??e})).sort((n,a)=>{const s=a.motion.activeAssignedCount-n.motion.activeAssignedCount;return s!==0?s:It(a.motion.lastActivityAt??0)-It(n.motion.lastActivityAt??0)})});function ev(t){const e=new Date(t);return Number.isNaN(e.getTime())?"00:00:00":e.toLocaleTimeString("en-US",{hour12:!1})}function en({label:t,value:e,color:n}){return i`
    <div class="stat-card">
      <div class="stat-label">${t}</div>
      <div class="stat-value" style=${n?`color:${n}`:""}>${e}</div>
    </div>
  `}function nv({row:t}){return i`
    <div class="term-row activity-row ${t.kind}">
      <span class="term-time">${ev(t.timestamp)}</span>
      <span class="activity-kind-badge ${t.kind}">${Wm[t.kind]}</span>
      <span class="term-actor">${t.actor}</span>
      <span class="term-text">${t.content}</span>
    </div>
  `}function av(){const t=Xm.value,e=Zm.value,n=e[0],a=tv.value;return i`
    <div class="stats-grid">
      ...
      <${en} label="SSE events" value=${In.value} color="#c084fc" />
    </div>
    ...
    <${C} title="Unified Activity" class="section">
      ...
      ${e.length===0?i`<div class="terminal-feed"><div class="empty-state">Waiting for live or snapshot signals...</div></div>`:i`<${zm}
            items=${e}
            itemHeight=${28}
            overscan=${8}
            getKey=${s=>s.id}
            renderItem=${s=>i`<${nv} row=${s} />`}
  ...
  `}const ms=600*1e3,sv=1200*1e3,go=.8;function Qt(t){if(t==null)return 0;const e=typeof t=="number"?t:Date.parse(t);return Number.isNaN(e)?0:e}function we(t){switch(t){case"bad":return 2;case"warn":return 1;default:return 0}}function iv(t){switch(t){case"working":return"Working";case"watching":return"Watching";case"quiet":return"Quiet";case"offline":return"Offline"}}function ov(t){switch(t){case"critical":return"Critical";case"warning":return"Watch";default:return"Healthy"}}function rv(t){return typeof t!="number"||Number.isNaN(t)?"—":`${Math.round(t*100)}%`}function lv(t){var e;return((e=t.agent)==null?void 0:e.current_task)??t.skill_primary??t.last_proactive_reason??t.memory_recent_note??"No active focus"}function cv(t){const e=[`Gen ${t.generation??"—"}`,`Turns ${t.turn_count??0}`,`Handoffs ${t.handoff_count_total??0}`];return(t.compaction_count??0)>0&&e.push(`Compactions ${t.compaction_count}`),e.join(" · ")}function dv(t){var p,$;const e=Ja.value.get(t.name.trim().toLowerCase())??{activeAssignedCount:0,lastActivityAt:null,lastActivityText:null},n=e.lastActivityAt??t.last_seen??null,a=n?Math.max(0,Date.now()-Qt(n)):Number.POSITIVE_INFINITY,s=!!((p=t.current_task)!=null&&p.trim())||e.activeAssignedCount>0;let o="watching",r="ok",l="Healthy live signal";return t.status==="offline"||t.status==="inactive"?(o="offline",r="bad",l=n?"Offline or inactive":"No recent presence"):a>sv?(o="quiet",r="bad",l=s?"Working without a fresh signal":"No fresh agent signal"):s?(o="working",r=a>ms?"warn":"ok",l=a>ms?"Execution looks quiet for too long":"Task and live signal aligned"):a>ms?(o="quiet",r="warn",l="Quiet but still reachable"):t.status==="idle"&&(o="watching",r="ok",l="Standing by for the next task"),{agent:t,motion:e,lastSignalAt:n,activeTaskCount:e.activeAssignedCount,state:o,tone:r,focus:(($=t.current_task)==null?void 0:$.trim())||(e.activeAssignedCount>0?`${e.activeAssignedCount} claimed tasks waiting for explicit current_task`:e.lastActivityText??"Idle / waiting for assignment"),note:l}}function uv(t){const e=Qo.value.get(t.name)??"idle",n=Yo.value.has(t.name),a=t.context_ratio??0;let s="healthy",o="ok",r="Heartbeat and context look healthy";return t.status==="offline"||n||e==="handoff-imminent"?(s="critical",o="bad",r=n?"Heartbeat stale":e==="handoff-imminent"?"Handoff imminent":"Keeper offline"):(e==="preparing"||e==="compacting"||a>=go)&&(s="warning",o="warn",r=a>=go?"High context pressure":e==="compacting"?"Compaction in progress":"Preparing for handoff"),{keeper:t,lifecycle:e,state:s,tone:o,focus:lv(t),note:r}}function nn({label:t,value:e,color:n,caption:a}){return i`
    <div class="stat-card">
      <div class="stat-label">${t}</div>
      <div class="stat-value" style=${n?`color:${n}`:""}>${e}</div>
      ${a?i`<div class="monitor-stat-caption">${a}</div>`:null}
    </div>
  `}function pv({item:t}){const e=t.kind==="agent"?()=>Me(t.agent.name):()=>_a(t.keeper);return i`
  ...
  `}function mv({row:t}){const{keeper:e}=t;return i`
    <button class="monitor-row ${t.tone} state-${t.state}" onClick=${()=>_a(e)}>
      <div class="monitor-row-header">
        ...
        <${Mr} ratio=${e.context_ratio} size=${34} stroke=${4} />
        <${Lt} status=${e.status} />
        <span class="monitor-pill ${t.tone}">${ov(t.state)}</span>
      </div>
      ...
      <div class="monitor-meta">
        ...
        <span>Context ${rv(e.context_ratio)}</span>
        ${e.model?i`<span>${e.model}</span>`:null}
      </div>
  ...
  `}function vv(){const t=[...wt.value].map(dv).sort((m,d)=>{const v=we(d.tone)-we(m.tone);if(v!==0)return v;const c=d.activeTaskCount-m.activeTaskCount;return c!==0?c:Qt(d.lastSignalAt)-Qt(m.lastSignalAt)}),e=[...Jt.value].map(uv).sort((m,d)=>{const v=we(d.tone)-we(m.tone);if(v!==0)return v;const c=(d.keeper.context_ratio??0)-(m.keeper.context_ratio??0);return c!==0?c:Qt(d.keeper.last_heartbeat)-Qt(m.keeper.last_heartbeat)}),n=t.filter(m=>m.state!=="offline"),a=t.filter(m=>m.state==="offline"),s=n.length,o=t.filter(m=>m.state==="working").length,r=t.filter(m=>m.lastSignalAt&&Date.now()-Qt(m.lastSignalAt)<=12e4).length,l=t.filter(m=>m.tone!=="ok"),p=e.filter(m=>m.tone!=="ok"),$=[...p.map(m=>({kind:"keeper",key:`keeper-${m.keeper.name}`,tone:m.tone,title:m.keeper.name,subtitle:`${m.note} · ${m.focus}`,timestamp:m.keeper.last_heartbeat??null,keeper:m.keeper})),...l.map(m=>({kind:"agent",key:`agent-${m.agent.name}`,tone:m.tone,title:m.agent.name,subtitle:`${m.note} · ${m.focus}`,timestamp:m.lastSignalAt,agent:m.agent}))].sort((m,d)=>{const v=we(d.tone)-we(m.tone);return v!==0?v:Qt(d.timestamp)-Qt(m.timestamp)}).slice(0,8);return i`
    <div class="agents-monitor">
      ...
      <${C} title="Attention Queue" class="section">
        ...
        <div class="monitor-alert-list">
          ${$.length===0?i`<div class="empty-state">No agent or keeper alerts right now</div>`:$.map(m=>i`<${pv} key=${m.key} item=${m} />`)}
        </div>
      <//>
      ...
      <div class="agents-workbench">
        <${C} title="Active Agents" class="section">
          ...
          <div class="monitor-list">
            ${n.length===0?i`<div class="empty-state">No active agents visible</div>`:n.map(m=>i`<${$o} key=${m.agent.name} row=${m} />`)}
          </div>
        <//>
        ...
        <${C} title="Keeper Watch" class="section">
          ...
          <div class="monitor-list">
            ${e.length===0?i`<div class="empty-state">No keepers active</div>`:e.map(m=>i`<${mv} key=${m.keeper.name} row=${m} />`)}
          </div>
        <//>
        ...
        <${C} title="Offline Agents" class="section">
          ...
          <div class="monitor-list">
            ${a.length===0?i`<div class="empty-state">No offline agents right now</div>`:a.map(m=>i`<${$o} key=${m.agent.name} row=${m} />`)}
          </div>
        <//>
      </div>
    </div>
  `}const za=_("all"),ja=_("all"),pi=Ct(()=>{let t=wn.value;return za.value!=="all"&&(t=t.filter(e=>e.horizon===za.value)),ja.value!=="all"&&(t=t.filter(e=>e.status===ja.value)),t}),fv=Ct(()=>{const t={short:[],mid:[],long:[]};for(const e of pi.value){const n=t[e.horizon];n&&n.push(e)}return t}),_v=Ct(()=>{const t=Array.from(Wo.value.values());return t.sort((e,n)=>e.status==="running"&&n.status!=="running"?-1:n.status==="running"&&e.status!=="running"?1:e.status==="interrupted"&&n.status!=="interrupted"?-1:n.status==="interrupted"&&e.status!=="interrupted"?1:n.elapsed_seconds-e.elapsed_seconds),t});function gv(t){return"★".repeat(Math.min(t,5))+"☆".repeat(Math.max(0,5-t))}function Ei(t){switch(t){case"short":return"Short-term";case"mid":return"Mid-term";case"long":return"Long-term";default:return t}}function oa(t){switch(t){case"short":return"#4ade80";case"mid":return"#f59e0b";case"long":return"#818cf8";default:return"#888"}}function $v(t){return t<60?`${Math.round(t)}s`:t<3600?`${Math.floor(t/60)}m ${Math.round(t%60)}s`:`${Math.floor(t/3600)}h ${Math.floor(t%3600/60)}m`}function ho(t){return t.toFixed(4)}function yo(t){const e=t.current_metric-t.baseline_metric;return`${e>=0?"+":""}${e.toFixed(4)}`}function hv({goal:t}){return i`
    <div class="goal-row">
  ...
  `}function bo({label:t,timestamp:e,source:n,note:a}){return i`
  ...
  `}function vs({horizon:t,items:e}){if(e.length===0)return null;const n=[...e].sort((a,s)=>s.priority-a.priority);return i`
    <${C} title="${Ei(t)} Goals (${e.length})" class="section">
      <div class="goal-list">
        ${n.map(a=>i`<${hv} key=${a.id} goal=${a} />`)}
      </div>
    <//>
  `}function yv(){return i`
  ...
  `}function bv(){const t=wn.value,e=t.filter(s=>s.status==="active").length,n=t.filter(s=>s.status==="completed").length,a={short:0,mid:0,long:0};for(const s of t)s.horizon in a&&a[s.horizon]++;return i`
  ...
  `}function kv({loop:t}){const e=t.history[0],n=t.latest_tool_names&&t.latest_tool_names.length>0?`${t.latest_tool_call_count??t.latest_tool_names.length} tool${(t.latest_tool_call_count??t.latest_tool_names.length)===1?"":"s"}: ${t.latest_tool_names.join(", ")}`:"No evidence yet";return i`
    <div class="planning-loop-row">
      <div class="planning-loop-main">
        ...
        <div class="planning-loop-metrics">
          ...
          <span>Elapsed ${$v(t.elapsed_seconds)}</span>
        </div>
  ...
  `}function fs({task:t}){const e=(t.priority??4)<=1?"p1":(t.priority??4)===2?"p2":(t.priority??4)===3?"p3":"p4";return i`
  ...
  `}function xv(){const{todo:t,inProgress:e,done:n}=Vo.value;return i`
    <${C} title="Task Backlog" class="section">
      <div class="kanban-board">
        <div class="kanban-column">
          ...
          ${t.length===0?i`<div class="empty-state" style="opacity: 0.5;">No pending tasks</div>`:t.map(a=>i`<${fs} key=${a.id} task=${a} />`)}
        </div>
        <div class="kanban-column">
          ...
          ${e.length===0?i`<div class="empty-state" style="opacity: 0.5;">No active tasks</div>`:e.map(a=>i`<${fs} key=${a.id} task=${a} />`)}
        </div>
        <div class="kanban-column">
          ...
          ${n.length===0?i`<div class="empty-state" style="opacity: 0.5;">No completed tasks</div>`:n.slice(0,20).map(a=>i`<${fs} key=${a.id} task=${a} />`)}
          ${n.length>20?i`<div class="empty-state" style="opacity: 0.5;">...and ${n.length-20} more</div>`:null}
        </div>
      </div>
    <//>
  `}function Sv(){const t=fv.value,e=_v.value,n=e.filter(l=>l.status==="running").length,a=e.filter(l=>l.recoverable).length,s=wn.value.filter(l=>l.status==="active").length,o=Hs.value,r=o==="idle"?"No loop running":o==="error"?Us.value??"MDAL snapshot unavailable":"Current loop snapshot";return i`
    <div>
      <div class="stats-grid">
        <div class="stat-card">
      ...
      <${C} title="Planning Surface" class="section">
        <div class="planning-header">
          ...
          <div class="planning-actions">
            ...
            <button class="control-btn ghost" onClick=${Ke} disabled=${Pe.value}>
        ...
        <div class="planning-freshness-grid">
          <${bo} label="Goals" timestamp=${Go.value} source="masc_goal_list" />
          <${bo}
            label="MDAL loops"
            timestamp=${Jo.value}
      ...
      ${Le.value&&wn.value.length===0?i`<div class="loading-indicator">Loading goals...</div>`:pi.value.length===0?i`<div class="empty-state">No goals match the current filters</div>`:i`
      ...
      <${C} title="MDAL Loops" class="section">
        ${Pe.value&&e.length===0?i`<div class="loading-indicator">Loading MDAL loops...</div>`:e.length===0&&o==="error"?i`
                <div class="empty-state">
              ...
              `:e.length===0?i`
                ...
                <div class="planning-loop-list">
                  ${e.map(l=>i`<${kv} key=${l.loop_id} loop=${l} />`)}
                </div>
              `}
      <//>
  ...
  `}const Ne=_(""),_s=_("ability_check"),gs=_("10"),$s=_("12"),Bn=_(""),Wn=_("idle"),Yt=_(""),Gn=_("keeper-late"),hs=_("player"),ys=_(""),St=_("idle"),bs=_(null),Jn=_(""),ks=_(""),xs=_("player"),Ss=_(""),As=_(""),ws=_(""),$n=_("20"),Cs=_("20"),Ts=_(""),Vn=_("idle"),mi=_(null),Or=_("overview"),Ns=_("all"),Rs=_("all"),Ls=_("all"),Av=12e4,Xa=_(null),ko=_(Date.now());function wv(t,e){const n=e>0?t/e*100:0;return n>50?"hp-high":n>25?"hp-mid":"hp-low"}function Cv(t,e){return e>0?Math.round(t/e*100):0}const Tv={pragmatic:"리스크보다 확실한 이득을 우선합니다.",frugal:"자원 소모를 줄이고 효율을 챙깁니다.",impatient:"짧은 템포로 즉시 압박을 선호합니다.",stubborn:"한 번 정한 전술을 끝까지 밀어붙입니다.",protective:"아군 피해를 줄이는 선택을 우선합니다.","honor-bound":"약속과 규율을 지키는 행동에 보너스가 납니다.",intense:"집중 화력을 짧게 폭발시킵니다.",empathetic:"아군/약자 보호 쪽 선택 확률이 높아집니다.",fatalistic:"위험을 감수하는 고배수 선택을 탑니다.",suspicious:"함정/매복 경계 행동을 우선합니다.",precise:"단일 목표를 정확히 노리는 경향입니다.",vengeful:"직전 위협 대상에게 강하게 반응합니다.",aggressive:"공격적인 전진 행동을 우선합니다.",opportunistic:"빈틈이 열리면 즉시 추격합니다."},Nv={supply_scan:"전장/자원 상태를 스캔해 약한 지점을 찾습니다.",ration_shift:"소모를 줄이고 지속 전투 능력을 확보합니다.",logistics_patch:"무너진 운영 라인을 빠르게 복구합니다.",frontline_shield:"전열에서 아군 피해를 흡수합니다.",oath_intercept:"핵심 타깃을 가로막아 위협을 차단합니다.",morale_anchor:"아군 안정도를 높여 붕괴를 막습니다.",omen_trace:"다음 위험 신호를 먼저 감지합니다.",arc_flash:"짧은 순간 광역 압박을 넣습니다.",ward_bloom:"방어 장막을 펼쳐 생존률을 올립니다.",mark_prey:"우선 제거 대상을 지정합니다.",silent_route:"은밀한 진입 경로를 확보합니다.",finisher_strike:"약화된 적을 마무리하는 일격입니다.",shadow_claw:"근접 급습으로 출혈 피해를 노립니다.",lunge:"짧은 돌진으로 전열을 흔듭니다."};function Qn(t){const e=t.trim();return e?e.split(/[_-]+/g).filter(n=>n.length>0).map(n=>n[0]?`${n[0].toUpperCase()}${n.slice(1)}`:n).join(" "):t}function Rv(t){const e=t.trim().toLowerCase();return Tv[e]??"행동 선택 가중치에 영향을 주는 성향입니다."}function Lv(t){const e=t.trim().toLowerCase();return Nv[e]??"상황에 따라 선택되는 전술 액션입니다."}function ee(t){return typeof t=="object"&&t!==null}function gt(t,e,n=""){const a=t[e];return typeof a=="string"?a:n}function Mt(t,e,n=0){const a=t[e];return typeof a=="number"&&Number.isFinite(a)?a:n}function En(t,e,n=!1){const a=t[e];return typeof a=="boolean"?a:n}const Pv=new Set(["str","dex","con","int","wis","cha"]);function Dv(t){const e=t.trim();if(!e)return{};let n;try{n=JSON.parse(e)}catch(s){throw new Error(`능력치 JSON 파싱 실패: ${s instanceof Error?s.message:"invalid json"}`)}if(!ee(n))throw new Error('능력치 JSON은 object여야 합니다. 예: {"luck":7}');const a={};return Object.entries(n).forEach(([s,o])=>{const r=s.trim();if(r){if(typeof o=="number"&&Number.isFinite(o)){a[r]=Math.max(0,Math.trunc(o));return}if(typeof o=="string"){const l=Number.parseFloat(o.trim());if(Number.isFinite(l)){a[r]=Math.max(0,Math.trunc(l));return}}throw new Error(`능력치 '${r}' 값은 숫자여야 합니다.`)}}),a}function Ev(t){const e=Number.parseInt(t.trim(),10);if(!Number.isFinite(e))return;const n=Math.max(1,e),a=Number.parseInt($n.value.trim(),10);Number.isFinite(a)&&a>n&&($n.value=String(n))}function vi(t){const n=(t.actor_name??t.actor??t.actor_id??"system").trim();return n===""?"system":n}function Iv(t){var n;return(((n=t.timestamp)==null?void 0:n.trim())??"")||"-"}function Mv(t){Or.value=t}function zr(t){const e=Xa.value;return e==null||e<=t}function Ov(t){const e=Xa.value;return e==null||e<=t?0:Math.max(0,Math.ceil((e-t)/1e3))}function qa(){Xa.value=null}function jr(t){return typeof window>"u"||typeof window.confirm!="function"?!0:window.confirm(t)}function zv(t,e){jr(["관전 모드 잠금을 해제하시겠습니까?",`ROOM: ${t||"-"}`,`PHASE: ${e||"-"}`,"해제 시간: 120초 (시간 경과 또는 위험 액션 실행 후 자동 재잠금)"].join(`
`))&&(Xa.value=Date.now()+Av,w("조작 잠금이 120초 동안 해제되었습니다.","warning"))}function ra(t){return zr(t)?(w("관전 모드 잠금 상태입니다. 먼저 잠금을 해제하세요.","warning"),!1):!0}function fi(t,e,n){return jr([`[위험 액션 확인] ${t}`,`ROOM: ${e||"-"}`,`PHASE: ${n||"-"}`,"이 액션은 즉시 실행되며 되돌리기 어렵습니다.","계속 진행하시겠습니까?"].join(`
`))}function jv({hp:t,max:e}){const n=Cv(t,e),a=wv(t,e);return i`
    <div class="trpg-hp-bar">
      <div class="hp-fill ${a}" style="width:${n}%" />
    </div>
  `}function qv({stats:t}){const e=[{label:"STR",value:t.strength},{label:"DEX",value:t.dexterity},{label:"CON",value:t.constitution},{label:"INT",value:t.intelligence},{label:"WIS",value:t.wisdom},{label:"CHA",value:t.charisma}];return i`
    <div class="trpg-actor-stats">
      ${e.map(n=>i`<span>${n.label} ${n.value}</span>`)}
    </div>
  `}function Fv({keeper:t,role:e}){if(!t)return null;const n=e==="dm"?"dm":"player";return i`
    <span class="trpg-keeper-chip">
      <span class="trpg-keeper-tag ${n}">${n}</span>
      ${t}
    </span>
  `}function qr({actor:t}){var p,$,m,d;const e=(p=t.archetype)==null?void 0:p.trim(),n=($=t.persona)==null?void 0:$.trim(),a=(m=t.portrait)==null?void 0:m.trim(),s=(d=t.background)==null?void 0:d.trim(),o=t.traits??[],r=t.skills??[],l=Object.entries(t.stats_raw??{}).filter(([v,c])=>Number.isFinite(c)).filter(([v])=>!Pv.has(v.toLowerCase()));return i`
            ...
            <div class="trpg-annot-list">
              ${o.map(v=>i`
                <span class="trpg-annot-chip trait">
                  ...
                  <span class="trpg-annot-desc">${Rv(v)}</span>
                </span>
              `)}
            </div>
          </div>
            ...
            <div class="trpg-annot-list">
              ${r.map(v=>i`
                <span class="trpg-annot-chip skill">
                  <span class="trpg-annot-name">${Qn(v)}</span>
                  <span class="trpg-annot-desc">${Lv(v)}</span>
                </span>
              `)}
            </div>
          </div>
  ...
  `}function Kv({mapStr:t}){return i`<pre class="trpg-map">${t}</pre>`}function Fr({events:t,emptyLabel:e="아직 이벤트가 없습니다."}){return t.length===0?i`<div class="empty-state" style="font-size:13px">${e}</div>`:i`
    <div class="trpg-story" role="list" aria-label="TRPG story events">
      ${t.map((n,a)=>{var s;return i`
        <div key=${a} class="trpg-event ${n.type??""}" role="listitem">
          <div class="trpg-event-meta-row">
            <span class="trpg-event-meta">${Iv(n)}</span>
  ...
  `}function Hv({events:t}){const e="__none__",n=Ns.value,a=Rs.value,s=Ls.value,o=Array.from(new Set(t.map(vi).map(d=>d.trim()).filter(d=>d!==""))).sort((d,v)=>d.localeCompare(v)),r=Array.from(new Set(t.map(d=>(d.type??"").trim()).filter(d=>d!==""))).sort((d,v)=>d.localeCompare(v)),l=t.some(d=>(d.type??"").trim()===""),p=Array.from(new Set(t.map(d=>(d.phase??"").trim()).filter(d=>d!==""))).sort((d,v)=>d.localeCompare(v)),$=t.some(d=>(d.phase??"").trim()===""),m=t.filter(d=>{if(n!=="all"&&vi(d)!==n)return!1;const v=(d.type??"").trim(),c=(d.phase??"").trim();if(a===e){if(v!=="")return!1}else if(a!=="all"&&v!==a)return!1;if(s===e){if(c!=="")return!1}else if(s!=="all"&&c!==s)return!1;return!0});return i`
    <div class="trpg-story-toolbar">
      ...
      <div class="trpg-story-filter">
        <label>Type</label>
        <select value=${a} onChange=${d=>{Rs.value=d.target.value}}>
          <option value="all">all</option>
      ...
      <div class="trpg-story-filter">
        <label>Phase</label>
        <select value=${s} onChange=${d=>{Ls.value=d.target.value}}>
          <option value="all">all</option>
      ...
      <button
        ...
        onClick=${()=>{Ns.value="all",Rs.value="all",Ls.value="all"}}
      >
        필터 초기화
      </button>
  ...
  `}function Bv({state:t,nowMs:e}){var $;const n=Ut.value||(($=t.session)==null?void 0:$.room)||"",a=Wn.value,s=t.party??[];if(!s.find(m=>m.id===Ne.value)&&s.length>0){const m=s[0];m&&(Ne.value=m.id)}const r=async()=>{var d,v;if(!n){w("Room ID가 비어 있습니다.","error");return}if(!ra(e))return;const m=((d=t.current_round)==null?void 0:d.phase)??((v=t.session)==null?void 0:v.status)??"unknown";if(fi("라운드 실행",n,m)){Wn.value="running";try{const c=await oc(n);mi.value=c,Wn.value="ok";const y=ee(c.summary)?c.summary:null,S=y?En(y,"advanced",!1):!1,T=y?gt(y,"progress_reason",""):"";w(S?"라운드가 정상 진행되었습니다.":`라운드가 정체되었습니다${T?`: ${T}`:""}`,S?"success":"warning"),qt()}catch(c){mi.value=null,Wn.value="error";const y=c instanceof Error?c.message:"라운드 실행에 실패했습니다.";w(y,"error")}finally{qa()}}},l=async()=>{var d,v;if(!n||!ra(e))return;const m=((d=t.current_round)==null?void 0:d.phase)??((v=t.session)==null?void 0:v.status)??"unknown";if(fi("턴 강제 진행",n,m))try{await cc(n),w("턴을 다음 단계로 이동했습니다.","success"),qt()}catch{w("턴 이동에 실패했습니다.","error")}finally{qa()}},p=async()=>{if(!n||!ra(e))return;const m=Ne.value.trim();if(!m){w("먼저 Actor를 선택하세요.","warning");return}const d=Number.parseInt(gs.value,10),v=Number.parseInt($s.value,10);if(Number.isNaN(d)||Number.isNaN(v)){w("stat/dc는 숫자여야 합니다.","warning");return}const c=Number.parseInt(Bn.value,10),y=Bn.value.trim()===""||Number.isNaN(c)?void 0:c;try{await lc({roomId:n,actorId:m,action:_s.value.trim()||"ability_check",statValue:d,dc:v,rawD20:y}),w("주사위 판정을 기록했습니다.","success"),qt()}catch{w("주사위 판정 기록에 실패했습니다.","error")}};return i`
  ...
  `}function Wv({state:t}){var s;const e=Ut.value||((s=t.session)==null?void 0:s.room)||"",n=Vn.value,a=async()=>{if(!e){w("Room ID가 비어 있습니다.","warning");return}const o=Jn.value.trim(),r=ks.value.trim();if(!r&&!o){w("이름 또는 Actor ID를 입력하세요.","warning");return}const l=Number.parseInt($n.value.trim(),10),p=Number.parseInt(Cs.value.trim(),10),$=Number.isFinite(p)?Math.max(1,p):20,m=Number.isFinite(l)?Math.max(0,Math.min($,l)):$;let d={};try{d=Dv(Ts.value)}catch(v){w(v instanceof Error?v.message:"능력치 JSON 오류","error");return}Vn.value="spawning";try{const v=typeof crypto<"u"&&typeof crypto.randomUUID=="function"?`trpg_spawn_${crypto.randomUUID()}`:`trpg_spawn_${Date.now().toString(36)}_${Math.random().toString(36).slice(2,10)}`,c=await dc(e,{actor_id:o||void 0,name:r||void 0,role:xs.value,idempotencyKey:v,portrait:As.value.trim()||void 0,background:ws.value.trim()||void 0,hp:m,max_hp:$,alive:m>0,stats:Object.keys(d).length>0?d:void 0}),y=typeof c.actor_id=="string"?c.actor_id.trim():"";if(!y)throw new Error("생성 응답에 actor_id가 없습니다.");const S=Ss.value.trim();S&&await uc(e,y,S),Ne.value=y,Yt.value=y,o||(Jn.value=""),Vn.value="ok",w(`Actor 생성 완료: ${y}`,"success"),await qt()}catch(v){Vn.value="error",w(v instanceof Error?v.message:"Actor 생성에 실패했습니다.","error")}};return i`
    <div class="trpg-control-box">
      <div class="trpg-control-grid">
        <div class="trpg-control-field">
          <label>Name</label>
        ...
        <div class="trpg-control-field">
          ...
          <select
            value=${xs.value}
            onChange=${o=>{xs.value=o.target.value}}
          >
        ...
        <div class="trpg-control-grid">
          ...
          <div class="trpg-control-field">
            ...
            <input
              ...
              min="1"
              value=${Cs.value}
              onInput=${o=>{const r=o.target.value;Cs.value=r,Ev(r)}}
              placeholder="20"
            />
          </div>
  ...
  `}function Gv({state:t,nowMs:e}){var v;const n=Ut.value||((v=t.session)==null?void 0:v.room)||"",a=t.join_gate,s=bs.value,o=ee(s)?s:null,r=(t.party??[]).filter(c=>c.role!=="dm"),l=Yt.value.trim(),p=r.some(c=>c.id===l),$=p?l:l?"__manual__":"",m=async()=>{const c=Yt.value.trim(),y=Gn.value.trim();if(!n||!c){w("Room/Actor가 필요합니다.","warning");return}St.value="checking";try{const S=await pc(n,c,y||void 0);bs.value=S,St.value="ok",w("참가 가능 여부를 갱신했습니다.","success")}catch(S){St.value="error";const T=S instanceof Error?S.message:"참가 가능 여부 확인에 실패했습니다.";w(T,"error")}},d=async()=>{var P,K;const c=Yt.value.trim(),y=Gn.value.trim(),S=ys.value.trim();if(!n||!c||!y){w("Room/Actor/Keeper가 필요합니다.","warning");return}if(!ra(e))return;const T=((P=t.current_round)==null?void 0:P.phase)??((K=t.session)==null?void 0:K.status)??"unknown";if(fi("Mid-Join 승인 요청",n,T)){St.value="requesting";try{const E=await mc({room_id:n,actor_id:c,keeper_name:y,role:hs.value,...S?{name:S}:{}});bs.value=E;const N=ee(E)?En(E,"granted",!1):!1,R=ee(E)?gt(E,"reason_code",""):"";N?w("Mid-Join이 승인되었습니다.","success"):w(`Mid-Join이 거절되었습니다${R?`: ${R}`:""}`,"warning"),St.value=N?"ok":"error",qt()}catch(E){St.value="error";const N=E instanceof Error?E.message:"Mid-Join 요청에 실패했습니다.";w(N,"error")}finally{qa()}}};return i`
    <div class="trpg-control-box">
      ...
      <div class="trpg-control-grid">
        ...
        <div class="trpg-control-field">
          ...
          <select
            value=${hs.value}
            onChange=${c=>{hs.value=c.target.value}}
          >
            <option value="player">player</option>
            <option value="npc">npc</option>
            <option value="dm">dm</option>
  ...
  `}function Jv({state:t,nowMs:e}){var r,l,p;const n=Ut.value||((r=t.session)==null?void 0:r.room)||"",a=((l=t.current_round)==null?void 0:l.phase)??((p=t.session)==null?void 0:p.status)??"unknown",s=zr(e),o=Ov(e);return i`
    <${C} title="조작 안전 잠금" style="margin-bottom:16px;">
      <div class="trpg-control-lock ${s?"locked":"unlocked"}">
        ...
        <div style="display:flex; gap:8px; margin-top:10px; flex-wrap:wrap;">
          ${s?i`<button class="trpg-run-btn recommend" onClick=${()=>zv(n,a)}>잠금 해제 (120초)</button>`:i`<button class="trpg-run-btn secondary" onClick=${()=>{qa(),w("조작 잠금으로 전환했습니다.","success")}}>즉시 다시 잠금</button>`}
        </div>
      </div>
    <//>
  `}function Vv({active:t}){return i`
  ...
  `}function Qv({state:t}){const e=t.party??[],n=t.story_log??[];return i`
  ...
  `}function Yv({state:t}){const e=t.story_log??[];return i`
    <div class="trpg-layout">
      <div>
  ...
  `}function Xv({state:t,nowMs:e}){const n=t.party??[];return i`
    <div>
      <${Jv} state=${t} nowMs=${e} />
      <div class="trpg-layout">
        <div>
  ...
  `}function Zv(){var l,p,$,m,d;const t=Bo.value,e=Ws.value;if(rt(()=>{if(typeof window>"u"||typeof window.setInterval!="function")return;const v=window.setInterval(()=>{ko.value=Date.now()},1e3);return()=>{window.clearInterval(v)}},[]),e&&!t)return i`<div class="loading-indicator">Loading TRPG state...</div>`;if(!t)return i`
      <div class="section">
        <h2>TRPG</h2>
        <div class="empty-state">No active TRPG session</div>
        <button class="board-sort-btn" onClick=${()=>qt()}>Refresh</button>
      </div>
    `;const n=t.party??[],a=t.story_log??[],s=t.outcome,o=Or.value,r=ko.value;return i`
    <div>
      ...
      ${o==="overview"?i`<${Qv} state=${t} />`:o==="timeline"?i`<${Yv} state=${t} />`:i`<${Xv} state=${t} nowMs=${r} />`}
    </div>
  `}const Ii="masc_dashboard_agent_name";function tf(){const t=new URLSearchParams(window.location.search),e=t.get("agent")??t.get("agent_name"),n=localStorage.getItem(Ii);return e??n??"dashboard"}const ht=_(tf()),hn=_(""),yn=_(""),Fa=_(""),Wr=_(null),Ka=_(null),bn=_(!1),De=_(!1),kn=_(!1),xn=_(!1),Ha=_(!1),Ua=_(!1),Za=_(!1);function Ba(t){return typeof t!="number"||!Number.isFinite(t)?"??:00":`${String(Math.max(0,t)).padStart(2,"0")}:00`}function la(t){if(typeof t!="number"||!Number.isFinite(t)||t<=0)return"unknown";if(t<60)return`${Math.round(t)}s`;if(t<3600)return`${Math.round(t/60)}m`;const e=Math.floor(t/3600),n=Math.round(t%3600/60);return n>0?`${e}h ${n}m`:`${e}h`}function Gr(t){return!t||t.length===0?"none":t.join(", ")}function ef(t){return t?t.enabled?t.quiet_active?`Quiet hours ${Ba(t.quiet_start)}-${Ba(t.quiet_end)} KST are active. Scheduled ticks may look asleep until the window ends; Poke Now bypasses only that quiet-hours gate.`:t.last_tick_ago_s==null?`Lodge is enabled and scheduled every ${la(t.interval_s)}, but no tick has run yet in this runtime.`:t.last_skip_reason?`Lodge last skipped work because ${t.last_skip_reason}. Scheduled ticks still run every ${la(t.interval_s)}.`:`Lodge ticks every ${la(t.interval_s)}. Planner is ${t.use_planner?"on":"off"} and delegated LLM is ${t.delegate_llm?"on":"off"}.`:"Lodge automation is disabled. Manual poke will report the disabled state but will not revive a stopped runtime.":"Lodge runtime status is unavailable. Refresh the dashboard to inspect scheduling state."}async function Je(){Fe();try{await ne()}catch(t){console.warn("[control-dock] dashboard refresh failed",t)}}function Mi(t){const e=t.trim();ht.value=e,e&&localStorage.setItem(Ii,e)}function nf(t){const n=(t.split(`
`).find(a=>a.includes(" joined"))??t).match(/✅\s+(\S+)\s+joined/i);return(n==null?void 0:n[1])??null}async function _i(){const t=ht.value.trim();if(t){kn.value=!0;try{const e=await fc(t),n=nf(e);n&&Mi(n),Za.value=!0,await Je(),w(`Joined as ${n??t}`,"success")}catch(e){const n=e instanceof Error?e.message:"Failed to join room";w(n,"error")}finally{kn.value=!1}}}async function af(){const t=ht.value.trim();if(t){xn.value=!0;try{await Fo(t),Za.value=!1,await Je(),w(`Left room (${t})`,"success")}catch(e){const n=e instanceof Error?e.message:"Failed to leave room";w(n,"error")}finally{xn.value=!1}}}async function sf(){const t=ht.value.trim();if(t)try{await Fo(t)}catch{}localStorage.removeItem(Ii),Mi("dashboard"),Za.value=!1,await _i()}async function of(){const t=ht.value.trim();if(t){Ha.value=!0;try{await _c(t),await Je(),w("Heartbeat sent","success")}catch(e){const n=e instanceof Error?e.message:"Failed to send heartbeat";w(n,"error")}finally{Ha.value=!1}}}async function xo(){const t=ht.value.trim(),e=hn.value.trim();if(!(!t||!e)){bn.value=!0;try{await qo(t,e),hn.value="",await Je(),w("Broadcast sent","success")}catch(n){const a=n instanceof Error?n.message:"Failed to send broadcast";w(a,"error")}finally{bn.value=!1}}}async function rf(){const t=yn.value.trim(),e=Fa.value.trim()||"Created from dashboard";if(t){De.value=!0;try{await vc(t,e,1),yn.value="",Fa.value="",await Je(),w("Task created","success")}catch(n){const a=n instanceof Error?n.message:"Failed to create task";w(a,"error")}finally{De.value=!1}}}async function So(){const t=ht.value.trim()||"dashboard";Ua.value=!0,Ka.value=null;try{const e=await On({actor:t,action_type:"lodge_tick",target_type:"room",payload:{}}),n=yi(e.result);Wr.value=n,await Je(),n!=null&&n.skipped_reason?w(n.skipped_reason,"warning"):w(n?`Poke finished: ${n.acted}/${n.checked} acted`:"Poke finished",n&&n.acted>0?"success":"warning")}catch(e){const n=e instanceof Error?e.message:"Failed to run Lodge poke";Ka.value=n,w(n,"error")}finally{Ua.value=!1}}function lf({runtime:t}){var s,o;const e=Wr.value??(t==null?void 0:t.last_tick_result)??null;if(Ka.value)return i`<div class="control-result-box is-error">${Ka.value}</div>`;if(!e)return i`<div class="control-status-copy">No poke result yet. The latest scheduled tick will appear here after the first run.</div>`;const n=((s=e.skipped_rows)==null?void 0:s.slice(0,3))??[],a=((o=e.passed_rows)==null?void 0:o.slice(0,3))??[];return i`
    <div class="control-result-box">
      <div class="control-inline-meta">
  ...
  `}function cf(t){return t.find(n=>n.name===rn.value)??t[0]??null}function df(){var a,s;const t=Jt.value,e=((a=se.value)==null?void 0:a.lodge)??null,n=cf(t);return rt(()=>{_i()},[]),rt(()=>{var r;const o=((r=t[0])==null?void 0:r.name)??"";if(!rn.value&&o){Xn(o);return}rn.value&&!t.some(l=>l.name===rn.value)&&Xn(o)},[t.map(o=>o.name).join("|")]),i`
    <section class="rail-card control-dock">
      ...
      <div class="control-section">
        ...
        <div class="control-actions">
          ...
          >
            ${kn.value?"Joining...":Za.value?"Rejoin":"Join"}
          </button>
          <button
            class="control-btn ghost"
            onClick=${()=>{af()}}
  ...
  `}function pf(){const t=nt.value.tab,e=Ft.value,n=gi.find(r=>r.id===t),a=Ao.find(r=>r.id===(n==null?void 0:n.group)),[s,o]=Wa(()=>{const r=localStorage.getItem(wo);return r!=="0"});return rt(()=>{localStorage.setItem(wo,s?"1":"0")},[s]),i`
    <aside class="dashboard-rail">
      ...
      <section class="rail-card">
        ...
        <div class="rail-inline-actions">
          <button
            ...
            onClick=${()=>{ne(),t==="command"&&(ze(),$e()),t==="ops"&&Ue(),t==="board"&&jt(),t==="trpg"&&qt(),t==="goals"&&(Tn(),Ke())}}
          >
            Refresh Now
          </button>
          <button class="rail-secondary-btn" onClick=${()=>At("ops")}>
            Open Ops
          </button>
        </div>
      </section>
      ...
      <section class="rail-card fold-card">
        ...
        ${s?i`<div class="rail-fold-body"><${df} /></div>`:i`<div class="rail-fold-hint">Use inline actions for quick room nudges. Open the Ops tab for structured intervention work.</div>`}
      </section>
    </aside>
  `}function mf(){switch(nt.value.tab){case"command":return i`<${Yp} />`;case"overview":return i`<${io} />`;case"ops":return i`<${$m} />`;case"board":return i`<${Mm} />`;case"agents":return i`<${vv} />`;case"goals":return i`<${Sv} />`;case"trpg":return i`<${Zv} />`;default:return i`<${io} />`}}function vf(){rt(()=>{sl(),Eo(),ne();const n=cd();return dd(),()=>{pl(),n(),ud()}},[]),rt(()=>{const n=setInterval(()=>{const a=nt.value.tab;a==="command"?(ze(),$e()):a==="ops"?Ue():a==="board"?jt():a==="trpg"?qt():a==="goals"&&(Tn(),Ke())},15e3);return()=>{clearInterval(n)}},[]),rt(()=>{const n=nt.value.tab;n==="command"&&(ze(),$e()),n==="ops"&&Ue(),n==="board"&&jt(),n==="trpg"&&qt(),n==="goals"&&(Tn(),Ke())},[nt.value.tab]);const t=nt.value.tab,e=gi.find(n=>n.id===t);return i`
    <div class="app-shell">
      <header class="dashboard-header">
        ...
        <div class="header-right">
          <button
            class="activity-panel-toggle ${He.value?"active":""}"
            onClick=${Hd}
      ...
      <div class="dashboard-layout">
        ...
        <main class="dashboard-main">
          ${Bs.value&&!Ft.value?i`<div class="loading-indicator">Loading dashboard...</div>`:i`<${mf} />`}
        </main>
      </div>

      ${He.value?i`
        <div class="activity-panel-backdrop" onClick=${to} />
        <aside class="activity-panel">
          <div class="activity-panel-header">
            <h3>Activity Feed</h3>
            <button class="activity-panel-close" onClick=${to}>Close</button>
          </div>
  ...
  `}const Co=document.getElementById("app");Co&&Xr(i`<${vf} />`,Co);export{eu as _};
