...
environment error before staging, compilation or execution. The shared reader's
...
Python suite has 23 passing cases and one explicitly skipped CI-only compile
