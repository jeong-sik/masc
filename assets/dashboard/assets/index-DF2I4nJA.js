...
`))}catch{return null}}async function gp(t,e,n,{signal:s,onEvent:a}){var p;const o=await fetch("/api/v1/keepers/chat/stream",{method:"POST",headers:{...Ko(),Accept:"text/event-stream"},body:JSON.stringify({name:t,message:e}),signal:s});if(!o.ok){const _=await o.text();let v=_||`Streaming request failed (${o.status})`;try{const f=JSON.parse(_);v=((p=f.error)==null?void 0:p.message)??f.message??v}catch{}throw new Error(v)}if(!o.body)throw new Error("Streaming response body is unavailable");const l=o.body.getReader(),c=new TextDecoder;let d="";try{for(;;){const{done:v,value:f}=await l.read();d+=c.decode(f??new Uint8Array,{stream:!v});const{frames:h,rest:T}=fp(d);d=T;for(const k of h){const S=ml(k);S&&a(S)}if(v)break}const _=d.trim();if(_){const v=ml(_);v&&a(v)}}finally{l.releaseLock()}}function $p(){return nt("/api/v1/dashboard/shell")}function hp(){return nt("/api/v1/dashboard/room-truth")}function yp(){return nt("/api/v1/dashboard/execution")}function bp(t,e){const n=new URLSearchParams;return n.set("sort_by",t),e!=null&&e.excludeSystem&&n.set("exclude_system","true"),nt(`/api/v1/dashboard/memory${n.toString()?`?${n}`:""}`)}function kp(){return yc("fetchDashboardGovernance",async()=>{const t=await nt("/api/v1/dashboard/governance"),e=Array.isArray(t.items)?t.items.map(s=>Up(s)).filter(s=>s!==null):[],n=Array.isArray(t.pending_actions)?t.pending_actions.map(s=>kc(s)).filter(s=>s!==null):[];return{generated_at:pt(t.generated_at)??void 0,summary:m(t.summary)?{cases_open:zt(t.summary.cases_open)??void 0,pending_ruling:zt(t.summary.pending_ruling)??void 0,ready_auto_execute:zt(t.summary.ready_auto_execute)??void 0,needs_human_gate:zt(t.summary.needs_human_gate)??void 0,executed:zt(t.summary.executed)??void 0,blocked:zt(t.summary.blocked)??void 0,ready_to_execute:zt(t.summary.ready_to_execute)??void 0,oldest_open_case_age_s:typeof t.summary.oldest_open_case_age_s=="number"?t.summary.oldest_open_case_age_s:null,last_activity_age_s:typeof t.summary.last_activity_age_s=="number"?t.summary.last_activity_age_s:null,judge_online:typeof t.summary.judge_online=="boolean"?t.summary.judge_online:void 0,judge_last_seen_at:pt(t.summary.judge_last_seen_at)}:void 0,items:e,activity:Array.isArray(t.activity)?t.activity.map(s=>Wp(s)).filter(s=>s!==null):[],judge:Gp(t.judge),pending_actions:n}})}function xp(){return nt("/api/v1/dashboard/semantics")}function Sp(){return nt("/api/v1/dashboard/mission")}function Cp(t){const e=`?session_id=${encodeURIComponent(t)}`;return nt(`/api/v1/dashboard/session${e}`)}function Ap(t=!1){return nt(`/api/v1/dashboard/mission/briefing${t?"?force=1":""}`)}function Tp(t,e){const n=new URLSearchParams;t&&n.set("session_id",t),e&&n.set("operation_id",e);const s=n.toString();return nt(`/api/v1/dashboard/proof${s?`?${s}`:""}`)}function Ip(){return nt("/api/v1/dashboard/planning")}function Rp(){return nt("/api/v1/tool-metrics")}function Mp(){return nt("/api/v1/dashboard/tools")}function Lp(){return nt("/api/v1/operator")}function bc(t={}){const e=new URLSearchParams;t.targetType&&e.set("target_type",t.targetType),t.targetId&&e.set("target_id",t.targetId),t.includeWorkers!=null&&e.set("include_workers",t.includeWorkers?"true":"false");const n=e.toString();return nt(`/api/v1/operator/digest${n?`?${n}`:""}`)}function Pp(){return nt("/api/v1/command-plane")}function zp(){return nt("/api/v1/command-plane/summary")}function Ep(){return nt("/api/v1/chains/summary")}function Np(t){return nt(`/api/v1/chains/runs/${encodeURIComponent(t)}`)}function jp(){return nt("/api/v1/command-plane/help")}function wp(t,e){const n=new URLSearchParams;t&&n.set("run_id",t),e&&n.set("operation_id",e);const s=n.toString();return nt(`/api/v1/command-plane/swarm${s?`?${s}`:""}`)}function Op(t,e){const n=new URLSearchParams;t&&n.set("run_id",t),e&&n.set("operation_id",e);const s=n.toString();return nt(`/api/v1/command-plane/orchestra${s?`?${s}`:""}`)}function Dp(t,e){return Wt(t,e)}function qp(t){switch(t.action_type){case"keeper_message":case"keeper_recover":return 9e4;case"swarm_run_continue":return 6e4;case"swarm_run_rerun":return 12e4;case"swarm_run_abandon":return 3e4;case"social_sweep":case"lodge_tick":return 45e3;default:return Bo}}function bs(t){return Wt("/api/v1/operator/action",t,void 0,qp(t))}function Fp(t,e,n="confirm"){return Wt("/api/v1/operator/confirm",{actor:t,confirm_token:e,decision:n})}function na(t){if(typeof t=="string"&&t.trim())return t;if(typeof t!="number"||Number.isNaN(t))return new Date().toISOString();const e=t<1e12?t*1e3:t;return new Date(e).toISOString()}function pt(t){if(typeof t=="string"){const e=t.trim();return e||null}if(typeof t=="number"&&Number.isFinite(t)){const e=t<1e12?t*1e3:t;return new Date(e).toISOString()}return null}function j(t){if(typeof t!="string")return null;const e=t.trim();return e||null}function kc(t){if(!m(t))return null;const e=A(t.confirm_token??t.token,"").trim();return e?{confirm_token:e,actor:j(t.actor)??void 0,action_type:j(t.action_type)??void 0,target_type:j(t.target_type)??void 0,target_id:j(t.target_id),delegated_tool:j(t.delegated_tool)??void 0,created_at:pt(t.created_at)??void 0,preview:t.preview}:null}function Kp(t){return m(t)?{board_post_id:j(t.board_post_id),task_id:j(t.task_id),operation_id:j(t.operation_id),team_session_id:j(t.team_session_id)}:{}}function Ho(t){if(!m(t))return null;const e=j(t.action_kind),n=j(t.resolved_tool),s=j(t.target_type),a=j(t.target_id),o=j(t.reason);return!e&&!n&&!s&&!o?null:{action_kind:e??void 0,resolved_tool:n,target_type:s,target_id:a,reason:o??void 0,payload_preview:t.payload_preview}}function xc(t){if(!m(t))return null;const e=j(t.action_type),n=j(t.delegated_tool),s=j(t.confirmation_state),a=pt(t.created_at);return!e&&!n&&!s&&!a?null:{action_type:e??void 0,delegated_tool:n,confirmation_state:s??void 0,created_at:a}}function Sc(t){if(!m(t))return null;const e=kc(t.pending_confirm),n=j(t.pending_confirm_token)??(e==null?void 0:e.confirm_token)??null;return{requires_human_gate:typeof t.requires_human_gate=="boolean"?t.requires_human_gate:void 0,pending_confirm:e,pending_confirm_token:n,ready_to_execute:typeof t.ready_to_execute=="boolean"?t.ready_to_execute:void 0}}function Bp(t){if(!m(t))return null;const e=j(t.summary),n=j(t.target_id);return!e&&!n?null:{judgment_id:j(t.judgment_id)??void 0,target_kind:j(t.target_kind)??void 0,target_id:n??void 0,status:j(t.status)??void 0,summary:e??void 0,confidence:typeof t.confidence=="number"?t.confidence:null,generated_at:pt(t.generated_at),expires_at:pt(t.expires_at),model_used:j(t.model_used),keeper_name:j(t.keeper_name),evidence_refs:Lt(t.evidence_refs),recommended_action:Ho(t.recommended_action),guardrail_state:Sc(t.guardrail_state),executed_route:xc(t.executed_route)}}function Up(t){if(!m(t))return null;const e=A(t.id,"").trim(),n=A(t.topic??t.title,"").trim();if(!e||!n)return null;const s=Kp(t.context);return{kind:A(t.kind,"case"),id:e,topic:n,status:A(t.status??t.state,"open"),origin:j(t.origin),subject_type:j(t.subject_type),risk_class:j(t.risk_class),provenance:j(t.provenance),auto_execution_state:j(t.auto_execution_state),petition_count:zt(t.petition_count),brief_count:zt(t.brief_count),last_activity_at:pt(t.last_activity_at),truth_summary:j(t.truth_summary)??void 0,judgment_summary:j(t.judgment_summary),confidence:typeof t.confidence=="number"?t.confidence:null,related_agents:Lt(t.related_agents),context:s,linked_board_post_id:j(t.linked_board_post_id)??s.board_post_id??null,linked_task_id:j(t.linked_task_id)??s.task_id??null,linked_operation_id:j(t.linked_operation_id)??s.operation_id??null,linked_session_id:j(t.linked_session_id)??s.team_session_id??null,recommended_action:Ho(t.recommended_action),executed_route:xc(t.executed_route),guardrail_state:Sc(t.guardrail_state),evidence_refs:Lt(t.evidence_refs)}}function Hp(t){if(!m(t))return null;const e=A(t.id,"").trim(),n=A(t.author,"").trim(),s=A(t.summary,"").trim();return!e||!n||!s?null:{id:e,author:n,stance:A(t.stance,"support"),summary:s,evidence_refs:Lt(t.evidence_refs),created_at:pt(t.created_at)}}function Cc(t){if(!m(t))return null;const e=A(t.id,"").trim(),n=A(t.case_id,"").trim();return!e||!n?null:{id:e,case_id:n,status:A(t.status,"blocked"),risk_class:j(t.risk_class),action_request:Ho(t.action_request),created_at:pt(t.created_at),updated_at:pt(t.updated_at),execution_ref:j(t.execution_ref),result_summary:j(t.result_summary),actor:j(t.actor)}}function Wo(t){if(!m(t)||!m(t.case))return null;const e=t.case,n=A(e.id,"").trim(),s=A(e.title,"").trim();return!n||!s?null:{case:{id:n,petition_ids:Lt(e.petition_ids),title:s,origin:j(e.origin),subject_type:j(e.subject_type),risk_class:j(e.risk_class),status:A(e.status,"pending_ruling"),created_at:pt(e.created_at),updated_at:pt(e.updated_at),source_refs:Lt(e.source_refs),briefs:Array.isArray(e.briefs)?e.briefs.map(a=>Hp(a)).filter(a=>a!==null):[]},petitions:Array.isArray(t.petitions)?t.petitions.flatMap(a=>{if(!m(a))return[];const o=A(a.id,"").trim(),l=A(a.case_id,"").trim(),c=A(a.title,"").trim();return!o||!l||!c?[]:[{id:o,case_id:l,title:c,origin:j(a.origin),subject_type:j(a.subject_type),risk_class:j(a.risk_class),source_refs:Lt(a.source_refs),created_by:j(a.created_by),created_at:pt(a.created_at)}]}):[],ruling:Bp(t.ruling),execution_order:Cc(t.execution_order)}}function Wp(t){if(!m(t))return null;const e=A(t.kind,"").trim();return e?{kind:e,item_kind:j(t.item_kind)??void 0,item_id:j(t.item_id)??void 0,topic:j(t.topic)??void 0,created_at:pt(t.created_at),summary:j(t.summary)??void 0,actor:j(t.actor),index:zt(t.index),decision:j(t.decision)}:null}function Gp(t){if(m(t))return{judge_online:typeof t.judge_online=="boolean"?t.judge_online:void 0,refreshing:typeof t.refreshing=="boolean"?t.refreshing:void 0,generated_at:pt(t.generated_at),expires_at:pt(t.expires_at),model_used:j(t.model_used),keeper_name:j(t.keeper_name),last_error:j(t.last_error)}}function Jp(t){var a;const e=t.trim(),s=((a=(e.startsWith("[flair:")?e.replace(/^\[flair:[^\]]+\]\s*/i,""):e).split(`
`)[0])==null?void 0:a.trim())||"Untitled post";return s.length<=96?s:`${s.slice(0,93)}...`}function Vp(t){if(!m(t))return null;const e=A(t.source,"").trim()||null,n=A(t.state_block,"").trim()||null;return!e&&!n?null:{source:e,state_block:n}}function Yp(t){if(!m(t))return null;const e=A(t.id,"").trim(),n=A(t.author,"").trim(),s=A(t.body,"").trim()||A(t.content,"").trim(),a=s;if(!e||!n)return null;const o=st(t.score,0),l=st(t.votes_up,0),c=st(t.votes_down,0),d=st(t.votes,o||l-c),p=st(t.comment_count,st(t.reply_count,0)),_=(()=>{const S=t.flair;if(typeof S=="string"&&S.trim())return S.trim();if(m(S)){const y=A(S.name,"").trim();if(y)return y}return A(t.flair_name,"").trim()||void 0})(),v=A(t.created_at_iso,"").trim()||na(t.created_at),f=A(t.updated_at_iso,"").trim()||(t.updated_at!==void 0?na(t.updated_at):v),T=A(t.title,"").trim()||Jp(s),k=Array.isArray(t.tags)?t.tags.filter(S=>typeof S=="string"&&S.trim()!==""):[];return{id:e,author:n,post_kind:(()=>{const S=A(t.post_kind,"").trim().toLowerCase();return S==="automation"||S==="system"||S==="human"?S:void 0})(),title:T,body:s,content:a,meta:Vp(t.meta),tags:k,votes:d,vote_balance:o,comment_count:p,created_at:v,updated_at:f,flair:_,hearth:A(t.hearth,"").trim()||null,visibility:A(t.visibility,"").trim()||void 0,expires_at:A(t.expires_at_iso,"").trim()||(t.expires_at!==void 0&&t.expires_at!==0?na(t.expires_at):"")||null,hearth_count:st(t.hearth_count,0)}}function Xp(t){if(!m(t))return null;const e=A(t.id,"").trim(),n=A(t.post_id,"").trim(),s=A(t.author,"").trim();return!e||!s?null:{id:e,post_id:n,author:s,content:A(t.content,""),created_at:na(t.created_at)}}async function Qp(t){return yc("fetchBoardPost",async()=>{const e=await nt(`/api/v1/board/${t}?format=flat`),n=m(e.post)?e.post:e,s=Yp(n)??{id:t,author:"unknown",post_kind:"human",title:"Post",body:"",content:"",meta:null,tags:[],votes:0,comment_count:0,created_at:new Date().toISOString(),updated_at:new Date().toISOString(),hearth:null,visibility:"internal",expires_at:null},o=(Array.isArray(e.comments)?e.comments:[]).map(Xp).filter(l=>l!==null);return{...s,comments:o}})}function Ac(t,e){return Wt("/api/v1/tools/masc_board_vote",{post_id:t,direction:e,vote:e,voter:sp()})}function Zp(t,e,n){return Wt("/api/v1/tools/masc_board_comment",{post_id:t,author:e,content:n})}function tm(t){const e=A(t,"").trim().toLowerCase();if(e==="win"||e==="won"||e==="victory")return"victory";if(e==="lose"||e==="lost"||e==="defeat")return"defeat";if(e==="draw"||e==="stalemate"||e==="tie")return"draw"}function mt(...t){for(const e of t){const n=A(e,"");if(n.trim())return n.trim()}return""}function _l(t){const e=tm(mt(t.outcome,t.result,t.result_code));if(!e)return;const n=mt(t.reason,t.reason_code,t.description,t.detail),s=mt(t.summary,t.summary_ko,t.summary_en,t.note),a=mt(t.details,t.details_text,t.text,t.note),o=mt(t.winner,t.winner_name,t.actor_winner,t.winner_actor),l=mt(t.winner_actor_id,t.winner_actor,t.actor_winner_id),c=mt(t.raw_reason,t.raw_reason_code,t.error_message),d=(()=>{const v=t.evidence??t.evidence_ids??t.supporting_events??t.event_ids??[];return typeof v=="string"?[v]:Array.isArray(v)?v.map(f=>{if(typeof f=="string")return f.trim();if(m(f)){const h=A(f.summary,"").trim();if(h)return h;const T=A(f.text,"").trim();if(T)return T;const k=A(f.type,"").trim();return k||A(f.event_id,"").trim()}return""}).filter(f=>f.length>0):[]})(),p=(()=>{const v=st(t.turn,Number.NaN);if(Number.isFinite(v))return v;const f=st(t.turn_number,Number.NaN);if(Number.isFinite(f))return f;const h=st(t.current_turn,Number.NaN);if(Number.isFinite(h))return h;const T=st(t.round,Number.NaN);return Number.isFinite(T)?T:void 0})(),_=mt(t.phase,t.phase_name,t.current_phase,t.phase_id);return{result:e,reason:n||void 0,summary:s||void 0,details:a||void 0,winner:o||void 0,winner_actor_id:l||void 0,evidence:d.length>0?d:void 0,raw_reason:c||void 0,turn:p,phase:_||void 0}}function em(t,e){const n=m(t.state)?t.state:{};if(A(n.status,"active").toLowerCase()!=="ended")return;const a=[...e].reverse().find(l=>m(l)?A(l.type,"")==="session.outcome":!1),o=m(n.session_outcome)?n.session_outcome:{};if(m(o)&&Object.keys(o).length>0){const l=_l(o);if(l)return l}if(m(a))return _l(m(a.payload)?a.payload:{})}function A(t,e=""){return typeof t=="string"?t:e}function st(t,e=0){return typeof t=="number"&&Number.isFinite(t)?t:e}function zt(t){if(typeof t=="number"&&Number.isFinite(t))return Math.trunc(t);if(typeof t=="string"){const e=Number.parseInt(t.trim(),10);if(Number.isFinite(e))return e}}function oo(t,e=!1){return typeof t=="boolean"?t:e}function Lt(t){return Array.isArray(t)?t.map(e=>{if(typeof e=="string")return e.trim();if(m(e)){const n=A(e.name,"").trim(),s=A(e.id,"").trim(),a=A(e.skill,"").trim();return n||s||a}return""}).filter(e=>e.length>0):[]}function nm(t){const e={};if(!m(t)&&!Array.isArray(t))return e;if(m(t))return Object.entries(t).forEach(([n,s])=>{const a=n.trim(),o=A(s,"").trim();!a||!o||(e[a]=o)}),e;for(const n of t){if(!m(n))continue;const s=mt(n.to,n.target,n.actor_id,n.name,n.id),a=mt(n.relationship,n.relation,n.type,n.kind);!s||!a||(e[s]=a)}return e}function sm(t,e,n){if(t==="dm"||t==="player"||t==="npc")return t;const s=e.trim().toLowerCase();return s==="dm"||s.startsWith("dm-")?"dm":s.startsWith("npc-")||s.startsWith("enemy-")||s.startsWith("mob-")?"npc":/^p\d+$/i.test(s)||s.startsWith("player-")?"player":typeof n=="string"&&n.trim()!==""?n.trim().toLowerCase().includes("dm")?"dm":"player":"npc"}function Rt(t,e,n,s=0){const a=t[e];if(typeof a=="number"&&Number.isFinite(a))return a;if(n){const o=t[n];if(typeof o=="number"&&Number.isFinite(o))return o}return s}const am=new Set(["str","dex","con","int","wis","cha","strength","dexterity","constitution","intelligence","wisdom","charisma","hp","max_hp","mp","max_mp","level","xp"]);function im(t){const e=m(t.stats)?t.stats:{},n={};return Object.entries(e).forEach(([s,a])=>{const o=s.trim();o&&(am.has(o.toLowerCase())||typeof a=="number"&&Number.isFinite(a)&&(n[o]=a))}),n}function om(t,e){if(t!=="dice.rolled")return;const n=st(e.raw_d20,0),s=st(e.total,0),a=st(e.bonus,0),o=A(e.action,"roll"),l=st(e.dc,0);return{notation:l>0?`${o} (DC ${l})`:o,rolls:n>0?[n]:[],total:s,modifier:a}}function rm(t){const e=JSON.stringify(t);return e?e.length>160?`${e.slice(0,157)}...`:e:""}function lm(t){const e=t.trim().toLowerCase();return e?e.startsWith("dice.")?"dice":e.startsWith("combat.")||e.includes(".attack")||e.includes(".damage")?"combat":e.includes("actor.")?"actor":e.includes("turn.")||e==="turn.started"||e==="phase.changed"?"turn":e.includes("join.")?"join":e.includes("memory")?"memory":e.includes("world.")?"world":e.includes("narration")?"story":"meta":"meta"}function cm(t,e,n,s){const a=n||e||A(s.actor_id,"")||A(s.actor_name,"");switch(t){case"turn.action.proposed":{const o=A(s.proposed_action,A(s.reply,""));return o?`${a||"actor"}: ${o}`:"Action proposed"}case"turn.action.resolved":{const o=A(s.reply,A(s.result,""));return o?`Resolved: ${o}`:"Action resolved"}case"narration.posted":return A(s.reply,A(s.content,A(s.text,"Narration")));case"dice.rolled":{const o=A(s.action,"roll"),l=st(s.total,0),c=st(s.dc,0),d=A(s.label,""),p=a||"actor",_=c>0?` vs DC ${c}`:"",v=d?` (${d})`:"";return`${p} ${o}: ${l}${_}${v}`}case"turn.started":return`Turn ${st(s.turn,1)} started`;case"phase.changed":return`Phase: ${A(s.phase,"round")}`;case"actor.spawned":return`Actor spawned: ${A(s.name,m(s.actor)?A(s.actor.name,a||"unknown"):a||"unknown")}`;case"actor.claimed":return`${A(s.keeper_name,A(s.keeper,"keeper"))} claimed ${a||"actor"}`;case"actor.released":return`${A(s.keeper_name,A(s.keeper,"keeper"))} released ${a||"actor"}`;case"join.window.opened":return`Join window opened (turn ${st(s.turn,0)})`;case"join.window.closed":return`Join window closed (turn ${st(s.turn,0)})`;case"mid.join.requested":return`Mid-join requested: ${a||A(s.actor_id,"actor")}`;case"mid.join.granted":return`Mid-join granted: ${a||A(s.actor_id,"actor")}`;case"mid.join.rejected":return`Mid-join rejected: ${A(s.reason_code,"unknown")}`;case"memory.signal":{const o=m(s.entity_refs)?s.entity_refs:{},l=A(o.requested_tier,""),c=A(o.effective_tier,""),d=oo(o.guardrail_applied,!1),p=A(s.summary_en,A(s.summary_ko,"Memory signal"));if(!l&&!c)return p;const _=l&&c?`${l}->${c}`:c||l;return`${p} [${_}${d?" (guardrail)":""}]`}case"world.event":{if(A(s.event_type,"")==="canon.check"){const l=A(s.status,"unknown"),c=A(s.contract_id,"n/a");return`Canon ${l}: ${c}`}return A(s.description,A(s.summary,"World event"))}case"combat.attack":return A(s.summary,A(s.result,"Attack resolved"));case"combat.defense":return A(s.summary,A(s.result,"Defense resolved"));case"session.outcome":return A(s.summary,A(s.outcome,"Session ended"));default:{const o=rm(s);return o?`${t}: ${o}`:t}}}function dm(t,e){const n=m(t)?t:{},s=A(n.type,"event"),a=typeof n.actor_id=="string"&&n.actor_id.trim()?n.actor_id.trim():"",o=A(n.actor_name,"").trim()||e[a]||A(m(n.payload)?n.payload.actor_name:"",""),l=m(n.payload)?n.payload:{},c=A(n.ts,A(n.timestamp,new Date().toISOString())),d=A(n.phase,A(l.phase,"")),p=A(n.category,"");return{type:s,actor:o||a||A(l.actor_name,""),actor_id:a||A(l.actor_id,""),actor_name:o,seq:n.seq,room_id:A(n.room_id,""),phase:d||void 0,category:p||lm(s),visibility:A(n.visibility,A(l.visibility,"public")),event_id:A(n.event_id,""),content:cm(s,a,o,l),dice_roll:om(s,l),timestamp:c}}function um(t,e,n){var Y,tt;const s=A(t.room_id,"")||n||"default",a=m(t.state)?t.state:{},o=m(a.party)?a.party:{},l=m(a.actor_control)?a.actor_control:{},c=m(a.join_gate)?a.join_gate:{},d=m(a.contribution_ledger)?a.contribution_ledger:{},p=Object.entries(o).map(([G,L])=>{const x=m(L)?L:{},E=Rt(x,"max_hp",void 0,10),J=Rt(x,"hp",void 0,E),ht=Rt(x,"max_mp",void 0,0),ie=Rt(x,"mp",void 0,0),W=Rt(x,"level",void 0,1),vt=Rt(x,"xp",void 0,0),ke=oo(x.alive,J>0),rt=l[G],In=typeof rt=="string"?rt:void 0,Ps=sm(x.role,G,In),zs=zt(x.generation),Es=mt(x.joined_at,x.joinedAt,x.started_at,x.startedAt),mi=mt(x.claimed_at,x.claimedAt,x.assigned_at,x.assignedAt,x.assigned_time),_i=mt(x.last_seen,x.lastSeen,x.last_seen_at,x.lastSeenAt,x.last_active,x.lastActive),vi=mt(x.scene,x.current_scene,x.currentScene,x.world_scene,x.scene_name,x.sceneName),fi=mt(x.location,x.current_location,x.currentLocation,x.position,x.zone,x.area);return{id:G,name:A(x.name,G),role:Ps,keeper:In,archetype:A(x.archetype,""),persona:A(x.persona,""),portrait:A(x.portrait,"")||void 0,background:A(x.background,"")||void 0,traits:Lt(x.traits),skills:Lt(x.skills),stats_raw:im(x),status:ke?"active":"dead",generation:zs,joined_at:Es||void 0,claimed_at:mi||void 0,last_seen:_i||void 0,scene:vi||void 0,location:fi||void 0,inventory:Lt(x.inventory),notes:Lt(x.notes),relationships:nm(x.relationships),stats:{hp:J,max_hp:E,mp:ie,max_mp:ht,level:W,xp:vt,strength:Rt(x,"strength","str",10),dexterity:Rt(x,"dexterity","dex",10),constitution:Rt(x,"constitution","con",10),intelligence:Rt(x,"intelligence","int",10),wisdom:Rt(x,"wisdom","wis",10),charisma:Rt(x,"charisma","cha",10)}}}),_=p.filter(G=>G.status!=="dead"),v=em(t,e),f={phase_open:oo(c.phase_open,!0),min_points:st(c.min_points,3),window:A(c.window,"round_boundary_only"),last_opened_turn:typeof c.last_opened_turn=="number"?c.last_opened_turn:null,last_closed_turn:typeof c.last_closed_turn=="number"?c.last_closed_turn:null},h=Object.entries(d).map(([G,L])=>{const x=m(L)?L:{};return{actor_id:G,score:st(x.score,0),last_reason:A(x.last_reason,"")||null,reasons:Lt(x.reasons)}}),T=p.reduce((G,L)=>(G[L.id]=L.name,G),{}),k=e.map(G=>dm(G,T)),S=st(a.turn,1),$=A(a.phase,"round"),y=A(a.map,""),R=m(a.world)?a.world:{},P=y||A(R.ascii_map,A(R.map,"")),C=k.filter((G,L)=>{const x=e[L];if(!m(x))return!1;const E=m(x.payload)?x.payload:{};return st(E.turn,-1)===S}),M=(C.length>0?C:k).slice(-12),I=A(a.status,"active");return{session:{id:s,room:s,status:I==="ended"?"ended":I==="paused"?"paused":"active",round:S,actors:_,created_at:((Y=k[0])==null?void 0:Y.timestamp)??new Date().toISOString()},current_round:{round_number:S,phase:$,events:M,timestamp:((tt=k[k.length-1])==null?void 0:tt.timestamp)??new Date().toISOString()},map:P||void 0,join_gate:f,contribution_ledger:h,outcome:v,party:_,story_log:k,history:[]}}async function pm(t){const e=`?room_id=${encodeURIComponent(t)}`,n=await nt(`/api/v1/trpg/events${e}`);return Array.isArray(n.events)?n.events:[]}async function mm(t){const e=`?room_id=${encodeURIComponent(t)}`,[n,s]=await Promise.all([nt(`/api/v1/trpg/state${e}`),pm(t)]);return um(n,s,t)}function _m(t){return Wt("/api/v1/trpg/rounds/run",{room_id:t})}function vm(t){const e="".trim().toLowerCase();if(e)switch(e){case"discussion":case"discuss":case"party_discussion":case"player_discussion":case"action":case"dice":return"round";case"ended":return"end";default:return e}}function fm(t){const e={room_id:t.roomId,actor_id:t.actorId,action:t.action,stat_value:t.statValue,dc:t.dc};return t.rawD20!=null&&(e.raw_d20=t.rawD20),t.ruleModule&&(e.rule_module=t.ruleModule),Wt("/api/v1/trpg/dice/roll",e)}function gm(t,e){const n=vm();return Wt("/api/v1/trpg/turns/advance",{room_id:t,...n?{phase:n}:{}})}function $m(t,e){var a;const n=(a=e.idempotencyKey)==null?void 0:a.trim(),s={room_id:t};return e.actor_id&&e.actor_id.trim()&&(s.actor_id=e.actor_id.trim()),e.name&&e.name.trim()&&(s.name=e.name.trim()),e.role&&(s.role=e.role),e.archetype&&e.archetype.trim()&&(s.archetype=e.archetype.trim()),e.persona&&e.persona.trim()&&(s.persona=e.persona.trim()),e.portrait&&e.portrait.trim()&&(s.portrait=e.portrait.trim()),e.background&&e.background.trim()&&(s.background=e.background.trim()),e.hp!=null&&(s.hp=e.hp),e.max_hp!=null&&(s.max_hp=e.max_hp),e.alive!=null&&(s.alive=e.alive),Array.isArray(e.traits)&&e.traits.length>0&&(s.traits=e.traits),Array.isArray(e.skills)&&e.skills.length>0&&(s.skills=e.skills),Array.isArray(e.inventory)&&e.inventory.length>0&&(s.inventory=e.inventory),e.stats&&Object.keys(e.stats).length>0&&(s.stats=e.stats),n&&(s.idempotency_key=n),Wt("/api/v1/trpg/actors/spawn",s,n?{"Idempotency-Key":n}:void 0)}function hm(t,e,n){return Wt("/api/v1/trpg/actors/claim",{room_id:t,actor_id:e,keeper:n})}async function ym(t,e,n){const s=await $t("trpg.join.eligibility",{room_id:t,actor_id:e,...n?{keeper_name:n}:{}});return JSON.parse(s)}async function bm(t){const e=await $t("trpg.mid_join.request",t);return JSON.parse(e)}async function km(t,e){await $t("masc_broadcast",{agent_name:t,message:e})}async function xm(t=40){return(await $t("masc_messages",{limit:t})).split(`
`).map(n=>n.trim()).filter(n=>n!=="")}async function Sm(t,e=20){return $t("masc_task_history",{task_id:t,limit:e})}async function Cm(t){const e=await $t("masc_petition_submit",{title:t,origin:"human",subject_type:"task",risk_class:"low",requested_action:{action_type:"add_task",payload:{title:t}}});try{const n=JSON.parse(e),s=m(n.case)?n.case:null,a=m(n.petition)?n.petition:null,o=m(n.ruling)?n.ruling:null;return!s||!a?null:Wo({case:s,petitions:[a],ruling:o,execution_order:null})}catch{return null}}async function Am(t,e,n){const s=await $t("masc_case_brief_submit",{case_id:t,stance:e,summary:n});try{const a=JSON.parse(s),o=Wo(a);if(o)return o}catch{}return Tc(t)}async function Tc(t){const e=await $t("masc_case_status",{case_id:t});try{return Wo(JSON.parse(e))}catch{return null}}async function Tm(t,e){const n=await $t("masc_execution_orders",{case_id:t,decision:e});try{return Cc(JSON.parse(n))}catch{return null}}const Im=g(""),ne=g({}),gt=g({}),ro=g({}),$a=g({}),lo=g({}),co=g({}),Bt=g({}),Go=new Map,Jo=new Map;function lt(t,e,n){t.value={...t.value,[e]:n}}function Rm(t){var n;const e=(n=r(t))==null?void 0:n.toLowerCase();return e==="user"||e==="assistant"||e==="system"||e==="tool"?e:"other"}function Mm(t){switch(t){case"user":return"User";case"assistant":return"Keeper";case"system":return"System";case"tool":return"Tool";default:return"Event"}}function gi(t,e){if(!Array.isArray(t))return[];const n=[];for(const s of t){if(!m(s))continue;const a=r(s.name);if(!a)continue;const o=r(s[e]);e==="summary"?n.push({name:a,summary:o}):n.push({name:a,reason:o})}return n}function Lm(t){if(!m(t))return null;const e=r(t.name);return e?{name:e,trigger:r(t.trigger),outcome:r(t.outcome),summary:r(t.summary),reason:r(t.reason)}:null}function Pm(t,e){return t==="offline"||t==="degraded"||t==="stale"?"Keeper is not in a healthy reply state. Probe or recover before relying on automation.":e==="quiet_hours"?"Social quiet hours are active. Direct messages still work, but scheduled public-square reactions may look asleep.":e==="min_gap"?"Keeper is inside its proactive cooldown window. Direct messages work now; autonomous check-ins will wait.":e==="never_started"?"Keeper metadata exists but no reply turn has been recorded yet.":"Keeper is reachable. Send a direct message for an immediate response."}function zm(t,e,n){return r(t)??Pm(e,n)}function Em(t,e){return typeof t=="boolean"?t:e==="recover"}function ha(t){if(!m(t))return null;const e=r(t.health_state),n=r(t.next_action_path),s=r(t.last_reply_status);return!e||!n||!s?null:{health_state:e,quiet_reason:r(t.quiet_reason)??null,next_action_path:n,last_reply_status:s,last_reply_at:ot(t.last_reply_at)??null,last_reply_preview:r(t.last_reply_preview)??null,last_error:r(t.last_error)??null,next_eligible_at_s:u(t.next_eligible_at_s)??null,recoverable:Em(t.recoverable,n),summary:zm(t.summary,e,r(t.quiet_reason)??null),keepalive_running:typeof t.keepalive_running=="boolean"?t.keepalive_running:void 0,continuity_state:r(t.continuity_state)??null,continuity_summary:r(t.continuity_summary)??null}}function Ic(t){if(!m(t))return null;const e=r(t.last_system_skip_reason)??r(t.skipped_reason);return{hour:u(t.hour),checked:u(t.checked)??0,acted:u(t.acted)??0,acted_names:U(t.acted_names),activity_report:r(t.activity_report),quiet_hours_overridden:w(t.quiet_hours_overridden),skipped_reason:e,last_pass_reason:r(t.last_pass_reason)??null,last_system_skip_reason:e,acted_rows:gi(t.acted_rows,"summary").map(n=>({name:n.name,summary:n.summary})),passed_rows:gi(t.passed_rows,"reason").map(n=>({name:n.name,reason:n.reason})),skipped_rows:gi(t.skipped_rows,"reason").map(n=>({name:n.name,reason:n.reason})),checkins:Array.isArray(t.checkins)?t.checkins.map(Lm).filter(n=>n!==null):[]}}function Nm(t){if(!m(t))return null;const e=r(t.last_system_skip_reason)??r(t.last_skip_reason)??null;return{enabled:w(t.enabled)??!1,interval_s:u(t.interval_s)??0,quiet_start:u(t.quiet_start),quiet_end:u(t.quiet_end),quiet_active:w(t.quiet_active),use_planner:w(t.use_planner),delegate_llm:w(t.delegate_llm),agent_count:u(t.agent_count),agents:U(t.agents),last_tick_ago_s:u(t.last_tick_ago_s)??null,last_tick_ago:r(t.last_tick_ago),total_ticks:u(t.total_ticks),total_checkins:u(t.total_checkins),last_skip_reason:e,last_pass_reason:r(t.last_pass_reason)??null,last_system_skip_reason:e,last_tick_result:Ic(t.last_tick_result),active_self_heartbeats:U(t.active_self_heartbeats)}}function jm(t){return m(t)?{status:t.status,diagnostic:ha(t.diagnostic)}:null}function wm(t){return m(t)?{recovered:w(t.recovered)??!1,skipped_reason:r(t.skipped_reason)??null,before:ha(t.before),after:ha(t.after),down:t.down,up:t.up}:null}function Om(t,e){if(!m(t))return null;const n=Rm(t.role),s=r(t.content)??r(t.preview);if(!s)return null;const a=fc(s);if(!a)return null;const o=ot(t.ts_unix)??ot(t.timestamp);return{id:`${n}-${o??"entry"}-${e}`,role:n,label:Mm(n),text:a,timestamp:o,delivery:"history",streamState:null,details:null}}function Dm(t,e,n){const s=m(n)?n:null,a=Array.isArray(s==null?void 0:s.history_tail)?s.history_tail.map((o,l)=>Om(o,l)).filter(o=>o!==null):[];return{name:t,diagnostic:ha(s==null?void 0:s.diagnostic),history:a,rawText:e,rawStatus:n,loadedAt:new Date().toISOString()}}function vl(t,e){const n=gt.value[t]??[];gt.value={...gt.value,[t]:[...n,e].slice(-50)}}function Vo(t,e,n){const s=gt.value[t]??[];gt.value={...gt.value,[t]:s.map(a=>a.id===e?n(a):a)}}function $i(t,e,n,s){Vo(t,e,a=>({...a,streamState:n,delivery:s}))}function qm(t,e,n){Vo(t,e,s=>({...s,text:`${s.text}${n}`,streamState:"streaming",delivery:"streaming"}))}function Vt(t,e,n){Vo(t,e,s=>({...s,...n}))}function Fm(t,e){return t.role!==e.role||t.text!==e.text?!1:t.timestamp&&e.timestamp?t.timestamp===e.timestamp:!0}function Km(t,e){const s=(gt.value[t]??[]).filter(a=>a.delivery!=="history"&&!e.some(o=>Fm(a,o)));gt.value={...gt.value,[t]:[...e,...s].slice(-50)}}function ni(t,e){ne.value={...ne.value,[t]:e},Km(t,e.history)}function Ns(t,e){const n=ne.value[t];if(!n)return;const s=n.diagnostic??{health_state:"idle",next_action_path:"direct_message",last_reply_status:"unknown"};ni(t,{...n,diagnostic:{...s,...e}})}function Bm(t,e,n){Jo.set(t,e),Go.set(t,n)}function Rc(t){Jo.delete(t),Go.delete(t)}function Um(t){return Jo.get(t)??null}function Mc(t){const e=t.trim();if(!e)return;const n=Go.get(e),s=Um(e);n&&n.abort(),s&&Vt(e,s,{delivery:"timeout",streamState:null,error:"Stream cancelled",timestamp:new Date().toISOString()}),Rc(e),lt($a,e,!1)}function Hm(t,e,n){switch(n.type){case"RUN_STARTED":return $i(t,e,"opening","sending"),null;case"TEXT_MESSAGE_START":return $i(t,e,"streaming","streaming"),null;case"TEXT_MESSAGE_CONTENT":{const s=typeof n.delta=="string"?n.delta:"";return s&&qm(t,e,s),null}case"TEXT_MESSAGE_END":return $i(t,e,"finalizing","streaming"),null;case"CUSTOM":if(n.name==="KEEPER_REPLY_DETAILS"){const s=gc(n.value);s&&Vt(t,e,{details:s})}return null;case"RUN_ERROR":return typeof n.value=="string"?n.value:(m(n.value)?r(n.value.message):null)??"Keeper stream failed";default:return null}}async function ya(){try{await ks()}catch(t){console.warn("[keeper-runtime] dashboard refresh failed",t)}}function Wm(t){Im.value=t.trim()}async function Lc(t,e=!1){const n=t.trim();if(!n)return null;if(!e&&ne.value[n])return ne.value[n];lt(ro,n,!0),lt(Bt,n,null);try{const s=await $t("masc_keeper_status",{name:n,fast:!1,include_context:!0,include_metrics_overview:!0,include_memory_bank:!1,include_history_tail:!0,include_compaction_history:!1,tail_turns:5,tail_messages:10});let a=null;try{a=JSON.parse(s)}catch{a=null}const o=Dm(n,s,a);return ni(n,o),o}catch(s){const a=s instanceof Error?s.message:`Failed to inspect ${n}`;return lt(Bt,n,a),null}finally{lt(ro,n,!1)}}async function Gm(t,e){var c;const n=t.trim(),s=e.trim();if(!n||!s)return;Mc(n);const a=`local-${Date.now()}`,o=`reply-${Date.now()}`;vl(n,{id:a,role:"user",label:"You",text:s,timestamp:new Date().toISOString(),delivery:"sending",streamState:null,details:null}),vl(n,{id:o,role:"assistant",label:n,text:"",timestamp:null,delivery:"sending",streamState:"opening",details:null}),lt($a,n,!0),lt(Bt,n,null);const l=new AbortController;Bm(n,o,l);try{Vt(n,a,{delivery:"delivered"}),await gp(n,s,void 0,{signal:l.signal,onEvent:_=>{const v=Hm(n,o,_);if(v)throw new Error(v)}});const d=(gt.value[n]??[]).find(_=>_.id===o)??null,p=(d==null?void 0:d.text.trim())||"(empty reply)";Vt(n,o,{text:p,delivery:"delivered",streamState:null,timestamp:new Date().toISOString(),error:null}),Ns(n,{last_reply_status:"delivered",last_reply_at:new Date().toISOString(),last_reply_preview:p.slice(0,200),last_error:null})}catch(d){if(d instanceof Error&&d.name==="AbortError")throw Vt(n,o,{delivery:"timeout",streamState:null,error:"Stream cancelled",timestamp:new Date().toISOString()}),Ns(n,{last_reply_status:"error",last_error:"Stream cancelled"}),lt(Bt,n,"Stream cancelled"),d;if(!((c=(gt.value[n]??[]).find(f=>f.id===o))!=null&&c.text.trim()))try{const f=await vp(n,s);Vt(n,o,{text:f.text.trim()||"(empty reply)",delivery:"delivered",streamState:null,details:f.details,error:null,timestamp:new Date().toISOString()}),Vt(n,a,{delivery:"delivered",error:null}),Ns(n,{last_reply_status:"delivered",last_reply_at:new Date().toISOString(),last_reply_preview:(f.text.trim()||"(empty reply)").slice(0,200),last_error:null}),await ya();return}catch{}const v=d instanceof Error?d.message:`Failed to send direct message to ${n}`;throw Vt(n,o,{delivery:"error",streamState:null,error:v,timestamp:new Date().toISOString()}),Vt(n,a,{delivery:"error",error:v}),Ns(n,{last_reply_status:"error",last_error:v}),lt(Bt,n,v),d}finally{Rc(n),lt($a,n,!1),await ya()}}async function Jm(t,e){const n=t.trim();if(!n)return null;lt(lo,n,!0),lt(Bt,n,null);try{const s=await bs({actor:e,action_type:"keeper_probe",target_type:"keeper",target_id:n,payload:{}}),a=jm(s.result),o=(a==null?void 0:a.diagnostic)??null;if(o){const l=ne.value[n];ni(n,{name:n,diagnostic:o,history:(l==null?void 0:l.history)??gt.value[n]??[],rawText:(l==null?void 0:l.rawText)??"",rawStatus:s.result,loadedAt:new Date().toISOString()})}return await ya(),o}catch(s){const a=s instanceof Error?s.message:`Failed to probe ${n}`;throw lt(Bt,n,a),s}finally{lt(lo,n,!1)}}async function Vm(t,e){const n=t.trim();if(!n)return null;lt(co,n,!0),lt(Bt,n,null);try{const s=await bs({actor:e,action_type:"keeper_recover",target_type:"keeper",target_id:n,payload:{}}),a=wm(s.result),o=(a==null?void 0:a.after)??null;if(o){const l=ne.value[n];ni(n,{name:n,diagnostic:o,history:(l==null?void 0:l.history)??gt.value[n]??[],rawText:(l==null?void 0:l.rawText)??"",rawStatus:s.result,loadedAt:new Date().toISOString()})}return await ya(),o}catch(s){const a=s instanceof Error?s.message:`Failed to recover ${n}`;throw lt(Bt,n,a),s}finally{lt(co,n,!1)}}function Ym(t){const e=typeof t=="string"?t.toLowerCase():"";return e==="active"||e==="busy"||e==="listening"||e==="idle"||e==="inactive"||e==="offline"?e:e==="in_progress"||e==="claimed"?"busy":"offline"}function Xm(t){var o;const e=((o=t.status)==null?void 0:o.toLowerCase())??"";if(e==="offline"||e==="inactive")return"offline";const n=t.metrics_series;if(!n||n.length===0)return"idle";const s=n[n.length-1];if(!s)return"idle";if(s.is_handoff)return"handoff-imminent";if(s.is_compaction)return"compacting";const a=s.context_ratio;return a>.85?"handoff-imminent":a>.7?"preparing":a>.5?"compacting":"active"}function Qm(t,e){const n=e.get(t.name);if(n!=null)return n;const s=t.last_heartbeat?Date.parse(t.last_heartbeat):Number.NaN;if(!Number.isNaN(s))return s;const a=[t.last_turn_ago_s,t.last_proactive_ago_s,t.last_handoff_ago_s,t.last_compaction_ago_s].find(o=>typeof o=="number"&&Number.isFinite(o)&&o>=0);return typeof a=="number"?Date.now()-a*1e3:null}function Zm(t){return Array.isArray(t)?t.map(e=>{if(!m(e))return null;const n=u(e.ts_unix),s=u(e.context_ratio);if(n==null||s==null)return null;const a=m(e.handoff)?e.handoff:null;return{ts:n,context_ratio:s,context_tokens:u(e.context_tokens)??0,context_max:u(e.context_max)??0,latency_ms:u(e.latency_ms)??0,generation:u(e.generation)??0,channel:typeof e.channel=="string"?e.channel:"turn",is_handoff:a!=null&&e.handoff_performed===!0,is_compaction:e.compacted===!0,compaction_saved_tokens:u(e.compaction_saved_tokens)??0,compaction_trigger:typeof e.compaction_trigger=="string"?e.compaction_trigger:null,model_used:typeof e.model_used=="string"?e.model_used:"",cost_usd:u(e.cost_usd)??Number.NaN,handoff_to_model:a&&typeof a.to_model=="string"?a.to_model:null,handoff_new_generation:a?u(a.new_generation)??null:null}}).filter(e=>e!==null):[]}function t_(t){if(!m(t))return;const e={};for(const[n,s]of Object.entries(t)){if(n==="top_tools"){if(!Array.isArray(s))continue;const o=s.filter(l=>m(l)&&typeof l.tool=="string"&&l.tool.trim()!=="");o.length>0&&(e.top_tools=o);continue}const a=u(s);a!=null&&(e[n]=a)}return Object.keys(e).length>0?e:void 0}function e_(t){if(!m(t))return null;const e=r(t.health_state),n=r(t.next_action_path),s=r(t.last_reply_status);if(!e||!n||!s)return null;const a=r(t.quiet_reason)??null;return{health_state:e,quiet_reason:a,next_action_path:n,last_reply_status:s,last_reply_at:ot(t.last_reply_at)??r(t.last_reply_at)??null,last_reply_preview:r(t.last_reply_preview)??null,last_error:r(t.last_error)??null,next_eligible_at_s:u(t.next_eligible_at_s)??null,recoverable:typeof t.recoverable=="boolean"?t.recoverable:n==="recover",summary:r(t.summary),keepalive_running:typeof t.keepalive_running=="boolean"?t.keepalive_running:void 0,continuity_state:r(t.continuity_state)??null,continuity_summary:r(t.continuity_summary)??null}}function n_(t){return(Array.isArray(t)?t:m(t)&&Array.isArray(t.keepers)?t.keepers:[]).map(n=>{if(!m(n))return null;const s=m(n.agent)?n.agent:null,a=m(n.context)?n.context:null,o=t_(n.metrics_window),l=r(n.name);if(!l)return null;const c=u(n.context_ratio)??u(a==null?void 0:a.context_ratio),d=r(n.status)??r(s==null?void 0:s.status)??"offline",p=r(n.model)??r(n.active_model)??r(n.primary_model),_=U(n.skill_secondary),v=Zm(n.metrics_series),f=a?{source:r(a.source),context_ratio:u(a.context_ratio),context_tokens:u(a.context_tokens),context_max:u(a.context_max),message_count:u(a.message_count),has_checkpoint:typeof a.has_checkpoint=="boolean"?a.has_checkpoint:void 0}:void 0,h=s?{name:r(s.name),exists:typeof s.exists=="boolean"?s.exists:void 0,error:r(s.error),agent_type:r(s.agent_type),status:r(s.status),current_task:r(s.current_task)??null,joined_at:r(s.joined_at),last_seen:r(s.last_seen),last_seen_ago_s:u(s.last_seen_ago_s),capabilities:U(s.capabilities),is_zombie:typeof s.is_zombie=="boolean"?s.is_zombie:void 0}:void 0;return{name:l,runtime_class:n.runtime_class==="persistent_agent"?"persistent_agent":"resident_keeper",desired:typeof n.desired=="boolean"?n.desired:void 0,resident_registered:typeof n.resident_registered=="boolean"?n.resident_registered:void 0,reconcile_status:r(n.reconcile_status)??null,emoji:r(n.emoji),koreanName:r(n.koreanName)??r(n.korean_name),agent_name:r(n.agent_name),trace_id:r(n.trace_id),model:p,primary_model:r(n.primary_model),active_model:r(n.active_model),next_model_hint:r(n.next_model_hint)??null,status:Ym(d),presence_keepalive:typeof n.presence_keepalive=="boolean"?n.presence_keepalive:void 0,presence_keepalive_sec:u(n.presence_keepalive_sec),keepalive_running:typeof n.keepalive_running=="boolean"?n.keepalive_running:void 0,proactive_enabled:typeof n.proactive_enabled=="boolean"?n.proactive_enabled:void 0,proactive_idle_sec:u(n.proactive_idle_sec),proactive_cooldown_sec:u(n.proactive_cooldown_sec),last_heartbeat:r(n.last_heartbeat)??r(s==null?void 0:s.last_seen),generation:u(n.generation),turn_count:u(n.turn_count)??u(n.total_turns),keeper_age_s:u(n.keeper_age_s),last_turn_ago_s:u(n.last_turn_ago_s),last_handoff_ago_s:u(n.last_handoff_ago_s),last_compaction_ago_s:u(n.last_compaction_ago_s),last_proactive_ago_s:u(n.last_proactive_ago_s),last_proactive_preview:r(n.last_proactive_preview)??null,context_ratio:c,context_tokens:u(n.context_tokens)??u(a==null?void 0:a.context_tokens),context_max:u(n.context_max)??u(a==null?void 0:a.context_max),context_source:r(n.context_source)??r(a==null?void 0:a.source),context:f,traits:U(n.traits),interests:U(n.interests),primaryValue:r(n.primaryValue)??r(n.primary_value),activityLevel:u(n.activityLevel)??u(n.activity_level),memory_recent_note:r(n.memory_recent_note)??null,recent_input_preview:r(n.recent_input_preview)??null,recent_output_preview:r(n.recent_output_preview)??null,recent_tool_names:U(n.recent_tool_names)??[],allowed_tool_names:U(n.allowed_tool_names)??[],latest_tool_names:U(n.latest_tool_names)??[],latest_tool_call_count:u(n.latest_tool_call_count)??null,tool_audit_source:r(n.tool_audit_source)??null,tool_audit_at:ot(n.tool_audit_at)??r(n.tool_audit_at)??null,conversation_tail_count:u(n.conversation_tail_count),k2k_count:u(n.k2k_count),handoff_count_total:u(n.handoff_count_total)??u(n.trace_history_count),compaction_count:u(n.compaction_count),last_compaction_saved_tokens:u(n.last_compaction_saved_tokens),diagnostic:e_(n.diagnostic),skill_primary:r(n.skill_primary)??null,skill_secondary:_,skill_reason:r(n.skill_reason)??null,metrics_series:v.length>0?v:void 0,metrics_window:o,agent:h}}).filter(n=>n!==null)}function Se(t){return(t??"").trim().toLowerCase()}function yt(t){const e=typeof t=="number"?t:Date.parse(t);return Number.isNaN(e)?0:e}function sa(t,e=88){const n=t.replace(/\s+/g," ").trim();return n&&(n.length>e?`${n.slice(0,e-3)}...`:n)}function js(t){return typeof t!="number"||!Number.isFinite(t)||t<0?null:new Date(Date.now()-t*1e3).toISOString()}function Rn(t){return t.last_heartbeat??js(t.last_turn_ago_s)??js(t.last_proactive_ago_s)??js(t.last_handoff_ago_s)??js(t.last_compaction_ago_s)}function s_(t){const e=t.title.trim();return e||sa(t.content)}function a_(t){const e=t.generation??"?",n=typeof t.context_ratio=="number"&&Number.isFinite(t.context_ratio)?`${Math.round(t.context_ratio*100)}%`:"?";return t.last_heartbeat?`Heartbeat gen=${e} ctx=${n}`:`Keeper snapshot gen=${e} ctx=${n}`}function i_(t,e,n,s,a={}){var R;const o=Se(t),l=e.filter(P=>Se(P.assignee)===o&&(P.status==="claimed"||P.status==="in_progress")).length,c=n.filter(P=>Se(P.from)===o).sort((P,C)=>yt(C.timestamp)-yt(P.timestamp))[0],d=s.filter(P=>Se(P.agent)===o||Se(P.author)===o).sort((P,C)=>yt(C.timestamp)-yt(P.timestamp))[0],p=(a.boardPosts??[]).filter(P=>Se(P.author)===o).sort((P,C)=>yt(C.updated_at||C.created_at)-yt(P.updated_at||P.created_at))[0],_=(a.keepers??[]).filter(P=>Se(P.name)===o&&Rn(P)!==null).sort((P,C)=>yt(Rn(C)??0)-yt(Rn(P)??0))[0],v=c?yt(c.timestamp):0,f=d?yt(d.timestamp):0,h=p?yt(p.updated_at||p.created_at):0,T=_?yt(Rn(_)??0):0,k=a.lastSeen?yt(a.lastSeen):0,S=((R=a.currentTask)==null?void 0:R.trim())||(l>0?`${l} claimed tasks`:null);if(v===0&&f===0&&h===0&&T===0&&k===0)return{activeAssignedCount:l,lastActivityAt:null,lastActivityText:S};const y=[c?{timestamp:c.timestamp,ts:v,text:sa(c.content)}:null,p?{timestamp:p.updated_at||p.created_at,ts:h,text:`Post: ${sa(s_(p))}`}:null,_?{timestamp:Rn(_),ts:T,text:a_(_)}:null,d?{timestamp:new Date(d.timestamp).toISOString(),ts:f,text:sa(d.text)}:null].filter(P=>P!==null).sort((P,C)=>C.ts-P.ts)[0];return y&&y.ts>=k?{activeAssignedCount:l,lastActivityAt:y.timestamp,lastActivityText:y.text}:{activeAssignedCount:l,lastActivityAt:a.lastSeen??null,lastActivityText:S??"Presence heartbeat"}}const Gt=g([]),ue=g([]),uo=g([]),ae=g([]),dt=g(null),o_=g(null),r_=g(null),Pc=g([]),zc=g([]),Ec=g([]),Nc=g([]),jc=g(null),wc=g([]),Yo=g([]),Oc=g([]),po=g(new Map),si=g([]),Xn=g("recent"),Le=g(!0),Dc=g(null),ee=g(""),cn=g([]),On=g(!1),qc=g(new Map),Xo=g("unknown"),dn=g(null),mo=g(!1),Qn=g(!1),_o=g(!1),Dn=g(!1),Qo=g(null),ba=g(!1),ka=g(null),Fc=g(null),vo=g(null),l_=g(null),c_=g(null),d_=g(null);Nt(()=>Gt.value.filter(t=>t.status==="active"||t.status==="busy"||t.status==="listening"||t.status==="idle"));const Kc=Nt(()=>{const t=ue.value;return{todo:t.filter(e=>e.status==="todo"),inProgress:t.filter(e=>e.status==="in_progress"||e.status==="claimed"),done:t.filter(e=>e.status==="done")}}),Bc=Nt(()=>{const t=new Map,e=ue.value,n=uo.value,s=fa.value,a=si.value,o=ae.value;for(const l of Gt.value)t.set(l.name.trim().toLowerCase(),i_(l.name,e,n,s,{currentTask:l.current_task,lastSeen:l.last_seen,boardPosts:a,keepers:o}));return t});Nt(()=>{var e;const t=new Map;for(const n of ae.value){const s=((e=n.status)==null?void 0:e.toLowerCase())??"";if(s==="offline"||s==="inactive"){t.set(n.name,"offline");continue}!n.metrics_series||n.metrics_series.length===0||t.set(n.name,Xm(n))}return t});const u_=12e4;Nt(()=>{const t=Date.now(),e=new Set,n=po.value;for(const s of ae.value){const a=Qm(s,n);a!=null&&t-a>u_&&e.add(s.name)}return e});function p_(t){return t==="dashboard_refresh"||t==="masc/dashboard_refresh"||t.startsWith("goal_")||t.startsWith("masc/goal_")||t.startsWith("mdal_")||t.startsWith("masc/mdal_")||t.startsWith("operator_")||t.startsWith("masc/operator_")||t.startsWith("command_plane_")||t.startsWith("masc/command_plane_")}function m_(t){const e=typeof t=="string"?t.toLowerCase():"";return e==="active"||e==="busy"||e==="listening"||e==="idle"||e==="inactive"||e==="offline"?e:e==="in_progress"||e==="claimed"?"busy":"offline"}function __(t){const e=typeof t=="string"?t.toLowerCase():"";return e==="todo"||e==="in_progress"||e==="claimed"||e==="done"||e==="cancelled"?e:e==="inprogress"?"in_progress":"todo"}function v_(t){if(!m(t))return null;const e=r(t.name);return e?{name:e,agent_type:r(t.agent_type),status:m_(t.status),current_task:r(t.current_task)??null,joined_at:r(t.joined_at),last_seen:r(t.last_seen),capabilities:U(t.capabilities),emoji:r(t.emoji),koreanName:r(t.koreanName)??r(t.korean_name),model:r(t.model),traits:U(t.traits),interests:U(t.interests),activityLevel:u(t.activityLevel)??u(t.activity_level),primaryValue:r(t.primaryValue)??r(t.primary_value)}:null}function f_(t){if(!m(t))return null;const e=r(t.id),n=r(t.title);return!e||!n?null:{id:e,title:n,status:__(t.status),priority:u(t.priority),assignee:r(t.assignee),description:r(t.description),created_at:r(t.created_at),updated_at:r(t.updated_at)}}function g_(t){if(!m(t))return null;const e=r(t.from)??r(t.from_agent)??"system",n=r(t.content)??"",s=r(t.timestamp)??new Date().toISOString();return{id:r(t.id),seq:u(t.seq),from:e,content:n,timestamp:s,type:r(t.type)}}function Zo(t){const e=typeof t=="string"?t.toLowerCase():"";return e==="ok"||e==="warn"||e==="bad"?e:"ok"}function $_(t){return m(t)?{active_sessions:u(t.active_sessions),blocked_sessions:u(t.blocked_sessions),active_operations:u(t.active_operations),blocked_operations:u(t.blocked_operations),runtime_pressure:u(t.runtime_pressure),worker_alerts:u(t.worker_alerts),continuity_alerts:u(t.continuity_alerts),priority_items:u(t.priority_items),todo_tasks:u(t.todo_tasks),claimed_tasks:u(t.claimed_tasks),running_tasks:u(t.running_tasks),done_tasks:u(t.done_tasks),cancelled_tasks:u(t.cancelled_tasks),keepers:u(t.keepers)}:null}function pe(t){if(!m(t))return null;const e=r(t.surface),n=r(t.label),s=r(t.target_type),a=r(t.target_id),o=r(t.focus_kind);return!e||!n||!s||!a||!o?null:{surface:e==="command"?"command":"intervene",label:n,target_type:s,target_id:a,focus_kind:o,operation_id:r(t.operation_id)??null,command_surface:r(t.command_surface)??null}}function h_(t){if(!m(t))return null;const e=r(t.id),n=r(t.kind),s=r(t.summary),a=r(t.target_type),o=r(t.target_id);return!e||!s||!a||!o||n!=="session"&&n!=="operation"?null:{id:e,kind:n,severity:Zo(t.severity),status:r(t.status),summary:s,target_type:a,target_id:o,linked_session_id:r(t.linked_session_id)??null,linked_operation_id:r(t.linked_operation_id)??null,last_seen_at:r(t.last_seen_at)??null,top_handoff:pe(t.top_handoff),intervene_handoff:pe(t.intervene_handoff),command_handoff:pe(t.command_handoff)}}function y_(t){if(!m(t))return null;const e=r(t.session_id),n=r(t.goal);return!e||!n?null:{session_id:e,goal:n,room:r(t.room)??null,status:r(t.status),health:r(t.health),member_names:U(t.member_names),linked_operation_id:r(t.linked_operation_id)??null,linked_detachment_id:r(t.linked_detachment_id)??null,runtime_blocker:r(t.runtime_blocker)??null,worker_gap_summary:r(t.worker_gap_summary)??null,last_activity_at:r(t.last_activity_at)??null,last_activity_summary:r(t.last_activity_summary)??null,communication_summary:r(t.communication_summary)??null,active_count:u(t.active_count),seen_count:u(t.seen_count),planned_count:u(t.planned_count),required_count:u(t.required_count),counts_basis:r(t.counts_basis)??null,top_handoff:pe(t.top_handoff),intervene_handoff:pe(t.intervene_handoff),command_handoff:pe(t.command_handoff)}}function b_(t){if(!m(t))return null;const e=r(t.operation_id),n=r(t.objective);return!e||!n?null:{operation_id:e,objective:n,status:r(t.status),stage:r(t.stage)??null,assigned_unit_id:r(t.assigned_unit_id)??null,assigned_unit_label:r(t.assigned_unit_label)??null,linked_session_id:r(t.linked_session_id)??null,linked_detachment_id:r(t.linked_detachment_id)??null,blocker_summary:r(t.blocker_summary)??null,search_status:r(t.search_status)??null,next_tool:r(t.next_tool)??null,updated_at:r(t.updated_at)??null,top_handoff:pe(t.top_handoff),command_handoff:pe(t.command_handoff)}}function fl(t){if(!m(t))return null;const e=r(t.name)??r(t.agent_name),n=r(t.note),s=r(t.focus),a=r(t.state);if(!e||!n||!s||a!=="working"&&a!=="watching"&&a!=="quiet"&&a!=="offline")return null;const o=r(t.signal_truth),l=o==="live"||o==="stale"||o==="absent"?o:void 0,c=r(t.evidence_source),d=c==="message"||c==="presence"||c==="none"?c:void 0;return{name:e,agent_name:r(t.agent_name),status:r(t.status),tone:Zo(t.tone),state:a,note:n,focus:s,last_signal_at:r(t.last_signal_at)??null,last_signal_age_sec:u(t.last_signal_age_sec)??null,signal_truth:l,evidence_source:d,active_task_count:u(t.active_task_count),related_session_id:r(t.related_session_id)??null,related_operation_id:r(t.related_operation_id)??null,emoji:r(t.emoji),korean_name:r(t.korean_name),model:r(t.model)??null,recent_output_preview:r(t.recent_output_preview)??null,recent_event:r(t.recent_event)??null}}function k_(t){if(!m(t))return null;const e=r(t.last_system_skip_reason)??r(t.last_skip_reason)??null;return{checked:u(t.checked),acted:u(t.acted),passed:u(t.passed),skipped:u(t.skipped),failed:u(t.failed),last_tick_at:r(t.last_tick_at)??null,last_skip_reason:e,last_pass_reason:r(t.last_pass_reason)??null,last_system_skip_reason:e,strategy:r(t.strategy)??null,queue_depth:u(t.queue_depth)??null,activity_report:r(t.activity_report)??null}}function x_(t){if(!m(t))return null;const e=r(t.agent_name),n=r(t.outcome);return!e||!n?null:{agent_name:e,trigger:r(t.trigger)??null,outcome:n,summary:r(t.summary)??null,reason:r(t.reason)??null,allowed_tool_names:U(t.allowed_tool_names)??[],used_tool_names:U(t.used_tool_names)??[],used_tool_call_count:u(t.used_tool_call_count)??null,action_kind:r(t.action_kind)??"none",tool_audit_source:r(t.tool_audit_source)??null,tool_audit_at:r(t.tool_audit_at)??null,checked_at:r(t.checked_at)??null,decision_reason:r(t.decision_reason)??null,worker_name:r(t.worker_name)??null,failure_reason:r(t.failure_reason)??null}}function S_(t){if(!m(t))return null;const e=r(t.name),n=r(t.note),s=r(t.focus),a=r(t.state);return!e||!n||!s||a!=="healthy"&&a!=="warning"&&a!=="critical"?null:{name:e,agent_name:r(t.agent_name)??null,status:r(t.status),tone:Zo(t.tone),state:a,note:n,focus:s,last_signal_at:r(t.last_signal_at)??null,last_autonomous_action_at:r(t.last_autonomous_action_at)??null,generation:u(t.generation),turn_count:u(t.turn_count),context_ratio:u(t.context_ratio)??null,continuity:r(t.continuity)??null,lifecycle:r(t.lifecycle)??null,related_session_id:r(t.related_session_id)??null,model:r(t.model)??null,emoji:r(t.emoji),korean_name:r(t.korean_name),skill_reason:r(t.skill_reason)??null,recent_input_preview:r(t.recent_input_preview)??null,recent_output_preview:r(t.recent_output_preview)??null,recent_tool_names:U(t.recent_tool_names)??[],allowed_tool_names:U(t.allowed_tool_names)??[],latest_tool_names:U(t.latest_tool_names)??[],latest_tool_call_count:u(t.latest_tool_call_count)??null,tool_audit_source:r(t.tool_audit_source)??null,tool_audit_at:r(t.tool_audit_at)??null,last_proactive_preview:r(t.last_proactive_preview)??null,continuity_summary:r(t.continuity_summary)??null,skill_route_summary:r(t.skill_route_summary)??null}}function gl(t){if(typeof t.seq=="number"&&Number.isFinite(t.seq))return t.seq;const e=Date.parse(t.timestamp);return Number.isNaN(e)?0:e}function C_(t,e){if(e.length===0)return t;const n=new Map;for(const s of t){const a=typeof s.seq=="number"?`seq:${s.seq}`:`ts:${s.timestamp}|from:${s.from}|content:${s.content}`;n.set(a,s)}for(const s of e){const a=typeof s.seq=="number"?`seq:${s.seq}`:`ts:${s.timestamp}|from:${s.from}|content:${s.content}`;n.set(a,s)}return[...n.values()].sort((s,a)=>gl(s)-gl(a)).slice(-500)}function A_(t){if(!m(t))return;const e=r(t.release_version),n=ot(t.started_at),s=u(t.uptime_seconds);if(!(!e||!n||s==null))return{release_version:e,commit:r(t.commit)??null,started_at:n,uptime_seconds:s}}function T_(t){if(m(t))return{enabled:t.enabled===!0,alive:t.alive===!0,status:r(t.status)??void 0,tick_in_progress:typeof t.tick_in_progress=="boolean"?t.tick_in_progress:void 0,tick_count:u(t.tick_count)??void 0,check_interval_sec:u(t.check_interval_sec)??void 0,last_tick_started_at:ot(t.last_tick_started_at)??r(t.last_tick_started_at)??null,last_tick_completed_at:ot(t.last_tick_completed_at)??r(t.last_tick_completed_at)??null,next_tick_due_at:ot(t.next_tick_due_at)??r(t.next_tick_due_at)??null,last_health_check_at:ot(t.last_health_check_at)??r(t.last_health_check_at)??null,last_intervention:r(t.last_intervention)??void 0,last_decision_source:r(t.last_decision_source)??void 0,last_action:r(t.last_action)??void 0,last_target:r(t.last_target)??null,last_reason:r(t.last_reason)??null,last_error:r(t.last_error)??null,circuit_open:typeof t.circuit_open=="boolean"?t.circuit_open:void 0,circuit_open_until:ot(t.circuit_open_until)??r(t.circuit_open_until)??null,can_spawn:typeof t.can_spawn=="boolean"?t.can_spawn:void 0,can_retire:typeof t.can_retire=="boolean"?t.can_retire:void 0,last_spawn_attempt_at:ot(t.last_spawn_attempt_at)??r(t.last_spawn_attempt_at)??null,last_retirement_attempt_at:ot(t.last_retirement_attempt_at)??r(t.last_retirement_attempt_at)??null,spawns_today:u(t.spawns_today)??void 0,retirements_today:u(t.retirements_today)??void 0,health_summary:m(t.health_summary)?{total_agents:u(t.health_summary.total_agents)??void 0,active_agents:u(t.health_summary.active_agents)??void 0,idle_agents:u(t.health_summary.idle_agents)??void 0,todo_count:u(t.health_summary.todo_count)??void 0,high_priority_todo:u(t.health_summary.high_priority_todo)??void 0,orphan_count:u(t.health_summary.orphan_count)??void 0,homeostatic_score:u(t.health_summary.homeostatic_score)??void 0,needs_workers:typeof t.health_summary.needs_workers=="boolean"?t.health_summary.needs_workers:void 0}:void 0}}function I_(t){if(m(t))return{enabled:t.enabled===!0,mode:r(t.mode)??void 0,masc_enabled:typeof t.masc_enabled=="boolean"?t.masc_enabled:void 0,masc_loops_running:typeof t.masc_loops_running=="boolean"?t.masc_loops_running:void 0,runtime_owner:r(t.runtime_owner)??null,zombie_loop_running:typeof t.zombie_loop_running=="boolean"?t.zombie_loop_running:void 0,gc_loop_running:typeof t.gc_loop_running=="boolean"?t.gc_loop_running:void 0,lodge_enabled:typeof t.lodge_enabled=="boolean"?t.lodge_enabled:void 0,lodge_loop_started:typeof t.lodge_loop_started=="boolean"?t.lodge_loop_started:void 0,lodge_running:typeof t.lodge_running=="boolean"?t.lodge_running:void 0,last_zombie_cleanup:ot(t.last_zombie_cleanup)??r(t.last_zombie_cleanup)??null,last_gc:ot(t.last_gc)??r(t.last_gc)??null,last_lodge:ot(t.last_lodge)??r(t.last_lodge)??null,last_zombie_result:r(t.last_zombie_result)??null,last_gc_result:r(t.last_gc_result)??null,last_lodge_result:m(t.last_lodge_result)?{ok:typeof t.last_lodge_result.ok=="boolean"?t.last_lodge_result.ok:void 0,message:r(t.last_lodge_result.message)??void 0}:null}}function R_(t){if(m(t))return{enabled:t.enabled===!0,started:t.started===!0,agent_name:r(t.agent_name)??null,llm_enabled:typeof t.llm_enabled=="boolean"?t.llm_enabled:void 0,uptime_s:u(t.uptime_s)??void 0,embedded_guardian_loops_running:typeof t.embedded_guardian_loops_running=="boolean"?t.embedded_guardian_loops_running:void 0,guardian_runtime_owner:r(t.guardian_runtime_owner)??null,consumers:U(t.consumers)}}function M_(t){if(!m(t))return;const e=m(t.last_result)?t.last_result:null;return{enabled:t.enabled===!0,strategy:r(t.strategy)??void 0,queue_depth:u(t.queue_depth)??void 0,processed_events:u(t.processed_events)??void 0,active_keepers:u(t.active_keepers)??void 0,last_event_at:ot(t.last_event_at)??r(t.last_event_at)??null,last_social_action_at:ot(t.last_social_action_at)??r(t.last_social_action_at)??null,last_pass_reason:r(t.last_pass_reason)??null,last_system_skip_reason:r(t.last_system_skip_reason)??null,total_checks:u(t.total_checks)??void 0,total_acted:u(t.total_acted)??void 0,total_passed:u(t.total_passed)??void 0,total_skipped:u(t.total_skipped)??void 0,total_failed:u(t.total_failed)??void 0,last_result:e?{checked:u(e.checked)??void 0,acted:u(e.acted)??void 0,passed:u(e.passed)??void 0,skipped:u(e.skipped)??void 0,failed:u(e.failed)??void 0,last_tick_at:ot(e.last_tick_at)??r(e.last_tick_at)??null,last_pass_reason:r(e.last_pass_reason)??null,last_system_skip_reason:r(e.last_system_skip_reason)??null,activity_report:r(e.activity_report)??null,checkins:Array.isArray(e.checkins)?e.checkins.map(n=>({name:r(n.agent_name)??"",trigger:r(n.trigger)??void 0,outcome:r(n.outcome)??void 0,summary:r(n.summary)??void 0,reason:r(n.reason)??void 0})).filter(n=>n.name!==""):[]}:null}}function Uc(t,e){return m(t)?{...t,generated_at:e??ot(t.generated_at)??void 0,build:A_(t.build),lodge:Nm(t.lodge)??void 0,social_runtime:M_(t.social_runtime),gardener:T_(t.gardener)??void 0,guardian:I_(t.guardian)??void 0,sentinel:R_(t.sentinel)??void 0}:null}function Hc(t,e){return e?t?{...t,...e,build:e.build??t.build,generated_at:e.generated_at??t.generated_at}:e:t}function L_(t){const e=typeof t=="string"?t.toLowerCase():"";return e==="running"||e==="interrupted"||e==="completed"||e==="stopped"||e==="error"?e:e.startsWith("error")?"error":"running"}function P_(t){if(!m(t))return null;const e=u(t.iteration);if(e==null)return null;const n=u(t.metric_before)??0,s=u(t.metric_after)??n,a=m(t.evidence)?t.evidence:null;return{iteration:e,metric_before:n,metric_after:s,delta:u(t.delta)??s-n,changes:r(t.changes)??"",failed_attempts:r(t.failed_attempts)??"",next_suggestion:r(t.next_suggestion)??"",elapsed_ms:u(t.elapsed_ms)??0,cost_usd:u(t.cost_usd)??null,evidence:a?{worker_engine:(a.worker_engine==="api_tool_loop","api_tool_loop"),worker_model:r(a.worker_model)??"",tool_call_count:u(a.tool_call_count)??0,tool_names:U(a.tool_names)??[],session_id:r(a.session_id)??"",evidence_status:a.evidence_status==="legacy_unverified"?"legacy_unverified":"verified"}:null}}function z_(t){var o,l;if(!m(t))return null;const e=r(t.loop_id);if(!e)return null;const n=u(t.baseline_metric)??0,s=Array.isArray(t.history)?t.history.map(P_).filter(c=>c!==null):[],a=u(t.current_metric)??((o=s[0])==null?void 0:o.metric_after)??n;return{loop_id:e,profile:r(t.profile)??"unknown",status:L_(t.status),strict_mode:typeof t.strict_mode=="boolean"?t.strict_mode:void 0,error_message:r(t.error_message)??r(t.error_reason)??null,stop_reason:r(t.stop_reason)??r(t.reason)??null,current_iteration:u(t.current_iteration)??((l=s[0])==null?void 0:l.iteration)??0,max_iterations:u(t.max_iterations)??0,baseline_metric:n,current_metric:a,target:r(t.target)??"",stagnation_streak:u(t.stagnation_streak)??0,stagnation_limit:u(t.stagnation_limit)??0,elapsed_seconds:u(t.elapsed_seconds)??0,updated_at:ot(t.updated_at)??null,stopped_at:ot(t.stopped_at)??null,execution_mode:t.execution_mode==="worker_spawn"?"worker_spawn":void 0,worker_engine:t.worker_engine==="api_tool_loop"?"api_tool_loop":null,worker_model:r(t.worker_model)??null,evidence_policy:t.evidence_policy==="hard"||t.evidence_policy==="legacy"?t.evidence_policy:void 0,latest_tool_call_count:u(t.latest_tool_call_count)??0,latest_tool_names:U(t.latest_tool_names)??[],session_id:r(t.session_id)??null,evidence_status:t.evidence_status==="legacy_unverified"?"legacy_unverified":t.evidence_status==="verified"?"verified":null,durability:t.durability==="persistent_backend"||t.durability==="memory_only"?t.durability:void 0,persistence_backend:t.persistence_backend==="filesystem"||t.persistence_backend==="postgres"||t.persistence_backend==="memory"?t.persistence_backend:void 0,recoverable:typeof t.recoverable=="boolean"?t.recoverable:void 0,history:s}}async function ks(){mo.value=!0;try{await Promise.all([Gc(),Pe()]),Fc.value=new Date().toISOString()}catch(t){console.error("Dashboard refresh error:",t)}finally{mo.value=!1}}async function Wc(){ba.value=!0,ka.value=null;try{const t=await xp();Qo.value=t,d_.value=new Date().toISOString()}catch(t){ka.value=t instanceof Error?t.message:"Failed to load dashboard semantics"}finally{ba.value=!1}}function E_(t){var e;return((e=Qo.value)==null?void 0:e.surfaces.find(n=>n.id===t))??null}function N_(t){var n;const e=((n=Qo.value)==null?void 0:n.surfaces)??[];for(const s of e){const a=s.panels.find(o=>o.id===t);if(a)return a}return null}function j_(t){var s,a;cn.value=(Array.isArray(t.goals)?t.goals:[]).map(o=>{if(!m(o))return null;const l=r(o.id),c=r(o.title),d=r(o.horizon),p=r(o.status),_=r(o.created_at),v=r(o.updated_at);return!l||!c||!d||!p||!_||!v?null:{id:l,horizon:d,title:c,metric:r(o.metric)??null,target_value:r(o.target_value)??null,due_date:r(o.due_date)??null,priority:u(o.priority)??3,status:p,parent_goal_id:r(o.parent_goal_id)??null,last_review_note:r(o.last_review_note)??null,last_review_at:r(o.last_review_at)??null,created_at:_,updated_at:v}}).filter(o=>o!==null);const e=new Map,n=Array.isArray((s=t.mdal)==null?void 0:s.loops)?t.mdal.loops:[];for(const o of n){const l=z_(o);l&&e.set(l.loop_id,l)}qc.value=e,dn.value=typeof((a=t.mdal)==null?void 0:a.error)=="string"?t.mdal.error:null,Xo.value=dn.value?"error":e.size===0?"idle":"ready"}async function Gc(){try{const t=await $p(),e=Uc(t.status,t.generated_at);e&&(dt.value=Hc(dt.value,e))}catch(t){console.error("Dashboard shell fetch error:",t)}}async function Pe(){var t;try{const e=await yp(),n=Uc(e.status,e.generated_at),s=(t=dt.value)==null?void 0:t.room;n&&(dt.value=Hc(dt.value,n));const a=s!=null&&(n==null?void 0:n.room)!=null&&s!==n.room;Gt.value=(Array.isArray(e.agents)?e.agents:[]).map(v_).filter(d=>d!==null),ue.value=(Array.isArray(e.tasks)?e.tasks:[]).map(f_).filter(d=>d!==null);const o=(Array.isArray(e.messages)?e.messages:[]).map(g_).filter(d=>d!==null);uo.value=a?o:C_(uo.value,o),ae.value=n_(e.keepers),r_.value=$_(e.summary);const l=Array.isArray(e.social_checkins)?e.social_checkins:[],c=Array.isArray(e.lodge_checkins)?e.lodge_checkins:[];jc.value=k_(e.social_tick??e.lodge_tick),wc.value=(l.length>0?l:c).map(x_).filter(d=>d!==null),Pc.value=(Array.isArray(e.execution_queue)?e.execution_queue:Array.isArray(e.priority_queue)?e.priority_queue:[]).map(h_).filter(d=>d!==null),zc.value=(Array.isArray(e.session_briefs)?e.session_briefs:[]).map(y_).filter(d=>d!==null),Ec.value=(Array.isArray(e.operation_briefs)?e.operation_briefs:[]).map(b_).filter(d=>d!==null),Nc.value=(Array.isArray(e.worker_support_briefs)?e.worker_support_briefs:Array.isArray(e.worker_briefs)?e.worker_briefs:[]).map(fl).filter(d=>d!==null),Yo.value=(Array.isArray(e.continuity_briefs)?e.continuity_briefs:[]).map(S_).filter(d=>d!==null),Oc.value=(Array.isArray(e.offline_worker_briefs)?e.offline_worker_briefs:[]).map(fl).filter(d=>d!==null),o_.value=null,Fc.value=new Date().toISOString()}catch(e){console.error("Dashboard execution fetch error:",e)}}async function me(){Qn.value=!0;try{const t=await bp(Xn.value,{excludeSystem:Le.value});si.value=t.posts??[],vo.value=new Date().toISOString()}catch(t){console.error("Board fetch error:",t)}finally{Qn.value=!1}}async function _e(){var t;_o.value=!0;try{const e=ee.value||((t=dt.value)==null?void 0:t.room)||"default";ee.value||(ee.value=e);const n=await mm(e);Dc.value=n}catch(e){console.error("TRPG fetch error:",e)}finally{_o.value=!1}}async function tr(){On.value=!0,Dn.value=!0;try{const t=await Ip();j_(t),l_.value=new Date().toISOString(),c_.value=new Date().toISOString()}catch(t){console.error("Planning fetch error:",t),Xo.value="error",dn.value=t instanceof Error?t.message:String(t)}finally{On.value=!1,Dn.value=!1}}async function Jc(){return tr()}const er=g(null),fo=g(!1),xa=g(null);function w_(t){return m(t)?{room:r(t.room)??r(t.current_room),room_base_path:r(t.room_base_path),cluster:r(t.cluster),project:r(t.project),paused:w(t.paused),version:r(t.version),generated_at:r(t.generated_at),tempo_interval_s:u(t.tempo_interval_s)}:null}function O_(t){return m(t)?{active_sessions:u(t.active_sessions),blocked_sessions:u(t.blocked_sessions),active_operations:u(t.active_operations),blocked_operations:u(t.blocked_operations),runtime_pressure:u(t.runtime_pressure),worker_alerts:u(t.worker_alerts),continuity_alerts:u(t.continuity_alerts),priority_items:u(t.priority_items),keepers:u(t.keepers)}:null}function D_(t){if(!m(t))return null;const e=r(t.id),n=r(t.kind),s=r(t.severity),a=r(t.summary),o=r(t.target_type),l=r(t.target_id);return!e||!n||!s||!a||!o||!l?null:{id:e,kind:n,severity:s,summary:a,target_type:o,target_id:l,status:r(t.status),linked_session_id:r(t.linked_session_id)??null,linked_operation_id:r(t.linked_operation_id)??null,last_seen_at:r(t.last_seen_at)??null,top_handoff:m(t.top_handoff)?t.top_handoff:null,intervene_handoff:m(t.intervene_handoff)?t.intervene_handoff:null,command_handoff:m(t.command_handoff)?t.command_handoff:null}}function q_(t){if(!m(t))return null;const e=r(t.kind),n=r(t.summary),s=r(t.target_type);return!e||!n||!s?null:{kind:e,severity:r(t.severity)??"warn",summary:n,target_type:s,target_id:r(t.target_id)??null,actor:r(t.actor)??null,evidence:t.evidence}}function F_(t){if(!m(t))return null;const e=r(t.action_type),n=r(t.target_type),s=r(t.reason);return!e||!n||!s?null:{action_type:e,target_type:n,target_id:r(t.target_id)??null,severity:r(t.severity)??"warn",reason:s,confirm_required:w(t.confirm_required),suggested_payload:m(t.suggested_payload)?t.suggested_payload:void 0,preview:t.preview}}function K_(t){return m(t)?{actor_filter:r(t.actor_filter)??null,filter_active:w(t.filter_active)??!1,visible_count:u(t.visible_count)??0,total_count:u(t.total_count)??0,hidden_count:u(t.hidden_count)??0,hidden_actors:U(t.hidden_actors),confirm_required_actions:ct(t.confirm_required_actions).flatMap(e=>{if(!m(e))return[];const n=r(e.action_type),s=r(e.target_type);return!n||!s?[]:[{action_type:n,target_type:s,description:r(e.description),confirm_required:w(e.confirm_required)}]})}:null}function B_(t){return m(t)?{count:u(t.count)??0,bad_count:u(t.bad_count)??0,warn_count:u(t.warn_count)??0,provenance:r(t.provenance)??null,top_item:q_(t.top_item)}:null}function U_(t){return m(t)?{count:u(t.count)??0,provenance:r(t.provenance)??null,top_action:F_(t.top_action)}:null}function H_(t){if(!m(t))return null;const e=r(t.label),n=r(t.reason),s=r(t.source),a=r(t.provenance);return!e||!n||!s||!a?null:{label:e,reason:n,source:s,provenance:a,target_kind:r(t.target_kind)??null,target_id:r(t.target_id)??null,suggested_tab:r(t.suggested_tab)??null,suggested_surface:r(t.suggested_surface)??null,suggested_params:m(t.suggested_params)?Object.fromEntries(Object.entries(t.suggested_params).map(([o,l])=>{const c=r(l);return c?[o,c]:null}).filter(o=>o!==null)):{}}}function W_(t){const e=m(t)?t:{},n=m(e.room)?e.room:{},s=m(e.execution)?e.execution:{},a=m(e.command)?e.command:{},o=m(e.operator)?e.operator:{};return{generated_at:r(e.generated_at),room:{status:w_(n.status),counts:m(n.counts)?{agents:u(n.counts.agents),tasks:u(n.counts.tasks),keepers:u(n.counts.keepers)}:void 0,provenance:r(n.provenance)??null},execution:{summary:O_(s.summary),top_queue:D_(s.top_queue),provenance:r(s.provenance)??null},command:{active_operations:u(a.active_operations),active_detachments:u(a.active_detachments),pending_approvals:u(a.pending_approvals),bad_alerts:u(a.bad_alerts),warn_alerts:u(a.warn_alerts),moving_lanes:u(a.moving_lanes),active_lanes:u(a.active_lanes),provenance:r(a.provenance)??null},operator:{health:r(o.health)??null,attention_summary:B_(o.attention_summary),recommendation_summary:U_(o.recommendation_summary),pending_confirm_summary:K_(o.pending_confirm_summary),provenance:r(o.provenance)??null},focus:H_(e.focus)}}async function ze(){fo.value=!0,xa.value=null;try{const t=await hp();er.value=W_(t)}catch(t){xa.value=t instanceof Error?t.message:"Failed to load room truth"}finally{fo.value=!1}}let aa=null;function G_(t){aa=t}let ia=null;function J_(t){ia=t}let oa=null;function V_(t){oa=t}const Ee={};let hi=null;function Ce(t,e,n=500){Ee[t]&&clearTimeout(Ee[t]),Ee[t]=setTimeout(()=>{e(),delete Ee[t]},n)}function Y_(){const t=mc.subscribe(e=>{if(e){if(e.type==="keeper_heartbeat"&&e.name){const n=new Map(po.value);n.set(e.name,e.ts_unix?e.ts_unix*1e3:Date.now()),po.value=n;return}(e.type==="agent_joined"||e.type==="agent_left")&&Ce("execution",Pe),p_(e.type)&&(hi||(hi=setTimeout(()=>{ks(),ia==null||ia(),oa==null||oa(),hi=null},500))),(e.type.startsWith("task_")||e.type.startsWith("masc/task_"))&&Ce("execution",Pe),e.type==="broadcast"&&Ce("execution",Pe),(e.type==="keeper_handoff"||e.type==="keeper_compaction"||e.type==="keeper_guardrail")&&Ce("execution",Pe),(e.type==="board_post"||e.type==="masc/board_post"||e.type==="board_comment"||e.type==="masc/board_comment")&&Ce("board",me),e.type.startsWith("decision_")&&Ce("governance",()=>aa==null?void 0:aa()),(e.type==="mdal_started"||e.type==="mdal_iteration"||e.type==="mdal_completed"||e.type==="mdal_stopped")&&Ce("mdal",Jc,350)}});return()=>{t();for(const e of Object.keys(Ee))clearTimeout(Ee[e]),delete Ee[e]}}let qn=null;function X_(){qn||(qn=setInterval(()=>{ge.value,ks()},1e4))}function Q_(){qn&&(clearInterval(qn),qn=null)}function Vc(t){if(!m(t))return null;const e=r(t.action_type),n=r(t.target_type);return!e||!n?null:{action_type:e,target_type:n,description:r(t.description),confirm_required:w(t.confirm_required)}}function Yc(t){if(!m(t))return null;const e=r(t.confirm_token)??r(t.token);return e?{confirm_token:e,actor:r(t.actor),action_type:r(t.action_type),target_type:r(t.target_type),target_id:r(t.target_id)??null,delegated_tool:r(t.delegated_tool),created_at:r(t.created_at),preview:t.preview}:null}function Xc(t){return m(t)?{actor_filter:r(t.actor_filter)??null,filter_active:w(t.filter_active)??!1,visible_count:u(t.visible_count)??0,total_count:u(t.total_count)??0,hidden_count:u(t.hidden_count)??0,hidden_actors:U(t.hidden_actors),confirm_required_actions:ct(t.confirm_required_actions).map(Vc).filter(e=>e!==null)}:null}function Z_(t){if(!m(t))return null;const e=ct(t.items,["confirms"]).map(Yc).filter(s=>s!==null),n=Xc(t.summary);return!n&&e.length===0?null:{items:e,summary:n??{actor_filter:null,filter_active:!1,visible_count:e.length,total_count:e.length,hidden_count:0,hidden_actors:[],confirm_required_actions:[]}}}function ai(t){var a,o,l,c;const e=(t==null?void 0:t.pending_confirm_envelope)??null,n=(e==null?void 0:e.items)??(t==null?void 0:t.pending_confirms)??[],s=(e==null?void 0:e.summary)??(t==null?void 0:t.pending_confirm_summary)??{actor_filter:null,filter_active:!1,visible_count:n.length,total_count:n.length,hidden_count:0,hidden_actors:[],confirm_required_actions:((a=t==null?void 0:t.available_actions)==null?void 0:a.filter(d=>d.confirm_required))??[]};return{items:n,summary:s,actor_filter:((o=s.actor_filter)==null?void 0:o.trim())||null,visible_count:s.visible_count??n.length,total_count:s.total_count??n.length,hidden_count:s.hidden_count??0,hidden_actors:s.hidden_actors??[],confirm_required_actions:(l=s.confirm_required_actions)!=null&&l.length?s.confirm_required_actions:((c=t==null?void 0:t.available_actions)==null?void 0:c.filter(d=>d.confirm_required))??[]}}const It=g(null),nr=g(null),Ht=g(null),Zn=g(!1),$e=g(null),ts=g(!1),hn=g(null),it=g(!1),Sa=g([]);let tv=1;function ev(t){return m(t)?{id:r(t.id),seq:u(t.seq),from:r(t.from)??r(t.from_agent)??"system",content:r(t.content)??"",timestamp:r(t.timestamp)??new Date().toISOString(),type:r(t.type)}:null}function nv(t){return m(t)?{room_id:r(t.room_id),current_room:r(t.current_room)??r(t.room),project:r(t.project),cluster:r(t.cluster),paused:w(t.paused),pause_reason:r(t.pause_reason)??null,paused_by:r(t.paused_by)??null,paused_at:r(t.paused_at)??null}:{}}function $l(t){if(!m(t))return;const e=Object.entries(t).map(([n,s])=>{const a=r(s);return a?[n,a]:null}).filter(n=>n!==null);return e.length>0?Object.fromEntries(e):void 0}function Qc(t){if(!m(t))return null;const e=r(t.kind),n=r(t.summary),s=r(t.target_type);return!e||!n||!s?null:{kind:e,severity:r(t.severity)??"warn",summary:n,target_type:s,target_id:r(t.target_id)??null,actor:r(t.actor)??null,evidence:t.evidence}}function Fn(t){if(!m(t))return null;const e=r(t.action_type),n=r(t.target_type),s=r(t.reason);return!e||!n||!s?null:{action_type:e,target_type:n,target_id:r(t.target_id)??null,severity:r(t.severity)??"warn",reason:s,confirm_required:w(t.confirm_required),suggested_payload:t.suggested_payload,preview:t.preview}}function Zc(t){return m(t)?{enabled:w(t.enabled),judge_online:w(t.judge_online),refreshing:w(t.refreshing),generated_at:r(t.generated_at)??null,expires_at:r(t.expires_at)??null,model_used:r(t.model_used)??null,keeper_name:r(t.keeper_name)??null,last_error:r(t.last_error)??null}:null}function yi(t){return m(t)?{summary:r(t.summary)??null,confidence:u(t.confidence)??null,provenance:r(t.provenance)??null,authoritative:w(t.authoritative),surface:r(t.surface)??null,fresh_until:r(t.fresh_until)??null,keeper_name:r(t.keeper_name)??null,fallback_used:w(t.fallback_used),disagreement_with_truth:w(t.disagreement_with_truth)}:null}function sv(t){return m(t)?{judgment_id:r(t.judgment_id)??void 0,surface:r(t.surface)??null,target_type:r(t.target_type)??null,target_id:r(t.target_id)??null,status:r(t.status)??null,summary:r(t.summary)??null,confidence:u(t.confidence)??null,generated_at:r(t.generated_at)??null,fresh_until:r(t.fresh_until)??null,keeper_name:r(t.keeper_name)??null,model_name:r(t.model_name)??null,runtime_name:r(t.runtime_name)??null,evidence_refs:U(t.evidence_refs),recommended_action:Fn(t.recommended_action),supersedes:U(t.supersedes),fallback_used:w(t.fallback_used),disagreement_with_truth:w(t.disagreement_with_truth),provenance:r(t.provenance)??null}:null}function av(t){return m(t)?{actor:r(t.actor)??null,spawn_agent:r(t.spawn_agent)??null,spawn_role:r(t.spawn_role)??null,spawn_model:r(t.spawn_model)??null,worker_class:r(t.worker_class)??null,parent_actor:r(t.parent_actor)??null,capsule_mode:r(t.capsule_mode)??null,runtime_pool:r(t.runtime_pool)??null,lane_id:r(t.lane_id)??null,controller_level:r(t.controller_level)??null,control_domain:r(t.control_domain)??null,supervisor_actor:r(t.supervisor_actor)??null,model_tier:r(t.model_tier)??null,task_profile:r(t.task_profile)??null,risk_level:r(t.risk_level)??null,routing_confidence:u(t.routing_confidence)??null,routing_reason:r(t.routing_reason)??null,status:r(t.status)??"unknown",turn_count:u(t.turn_count)??0,empty_note_turn_count:u(t.empty_note_turn_count)??0,has_turn:w(t.has_turn)??!1,last_turn_ts_iso:r(t.last_turn_ts_iso)??null}:null}function iv(t){if(!m(t))return null;const e=r(t.session_id);return e?{session_id:e,goal:r(t.goal),status:r(t.status),health:r(t.health),scale_profile:r(t.scale_profile),control_profile:r(t.control_profile),planned_worker_count:u(t.planned_worker_count),active_agent_count:u(t.active_agent_count),last_turn_age_sec:u(t.last_turn_age_sec)??null,attention_count:u(t.attention_count),recommended_action_count:u(t.recommended_action_count),top_attention:Qc(t.top_attention),top_recommendation:Fn(t.top_recommendation)}:null}function hl(t){if(!m(t))return null;const e=r(t.loop_id),n=r(t.status);return!e&&!n?null:{loop_id:e??null,session_id:r(t.session_id)??null,status:n??null,current_cycle:u(t.current_cycle)??void 0,best_score:u(t.best_score)??null,last_decision:r(t.last_decision)??null,target_file:r(t.target_file)??null,workdir:r(t.workdir)??null,source_workdir:r(t.source_workdir)??null,program_note:r(t.program_note)??null,operation_id:r(t.operation_id)??null,queued_hypothesis:r(t.queued_hypothesis)??null,warnings:ct(t.warnings).map(s=>typeof s=="string"?s.trim():"").filter(Boolean),error:r(t.error)??null}}function td(t){const e=m(t)?t:{};return{trace_id:r(e.trace_id),target_type:r(e.target_type)??"room",target_id:r(e.target_id)??null,health:r(e.health),judgment_owner:r(e.judgment_owner)??null,authoritative_judgment_available:w(e.authoritative_judgment_available),resident_judge_runtime:Zc(e.resident_judge_runtime),judgment:sv(e.judgment),active_guidance_layer:r(e.active_guidance_layer)??null,active_summary:yi(e.active_summary),active_recommended_actions:ct(e.active_recommended_actions).map(Fn).filter(n=>n!==null),active_recommendation_source:r(e.active_recommendation_source)??null,active_recommendation_summary:yi(e.active_recommendation_summary),fallback_recommended_actions:ct(e.fallback_recommended_actions).map(Fn).filter(n=>n!==null),recommendation_summary:yi(e.recommendation_summary),swarm_status:m(e.swarm_status)?e.swarm_status:void 0,attention_items:ct(e.attention_items).map(Qc).filter(n=>n!==null),recommended_actions:ct(e.recommended_actions).map(Fn).filter(n=>n!==null),session_cards:ct(e.session_cards).map(iv).filter(n=>n!==null),worker_cards:ct(e.worker_cards).map(av).filter(n=>n!==null)}}function ov(t){if(!m(t))return null;const e=m(t.status)?t.status:void 0,n=m(t.summary)?t.summary:m(e==null?void 0:e.summary)?e.summary:void 0,s=m(t.session)?t.session:m(e==null?void 0:e.session)?e.session:void 0,a=r(t.session_id)??r(n==null?void 0:n.session_id)??r(s==null?void 0:s.session_id);if(!a)return null;const o=$l(t.report_paths)??$l(e==null?void 0:e.report_paths),l=ct(t.recent_events,["events"]).filter(m);return{session_id:a,status:r(t.status)??r(n==null?void 0:n.status)??r(s==null?void 0:s.status),progress_pct:u(t.progress_pct)??u(n==null?void 0:n.progress_pct),elapsed_sec:u(t.elapsed_sec)??u(n==null?void 0:n.elapsed_sec),remaining_sec:u(t.remaining_sec)??u(n==null?void 0:n.remaining_sec),done_delta_total:u(t.done_delta_total)??u(n==null?void 0:n.done_delta_total),summary:n,team_health:m(t.team_health)?t.team_health:m(e==null?void 0:e.team_health)?e.team_health:void 0,communication_metrics:m(t.communication_metrics)?t.communication_metrics:m(e==null?void 0:e.communication_metrics)?e.communication_metrics:void 0,orchestration_state:m(t.orchestration_state)?t.orchestration_state:m(e==null?void 0:e.orchestration_state)?e.orchestration_state:void 0,cascade_metrics:m(t.cascade_metrics)?t.cascade_metrics:m(e==null?void 0:e.cascade_metrics)?e.cascade_metrics:void 0,report_paths:o,linked_autoresearch:hl(t.linked_autoresearch)??hl(e==null?void 0:e.linked_autoresearch)??null,session:s,recent_events:l}}function yl(t){if(!m(t))return null;const e=r(t.name);if(!e)return null;const n=m(t.context)?t.context:void 0;return{name:e,runtime_class:t.runtime_class==="persistent_agent"?"persistent_agent":"resident_keeper",desired:w(t.desired),resident_registered:w(t.resident_registered),agent_name:r(t.agent_name),status:r(t.status),autonomy_level:r(t.autonomy_level),context_ratio:u(t.context_ratio)??u(n==null?void 0:n.context_ratio),generation:u(t.generation),active_goal_ids:U(t.active_goal_ids),last_autonomous_action_at:r(t.last_autonomous_action_at)??null,last_turn_ago_s:u(t.last_turn_ago_s),model:r(t.model)??r(t.active_model)??r(t.primary_model)}}function rv(t){const e=m(t)?t:{},n=Z_(e.pending_confirm_envelope);return{room:nv(e.room),sessions:ct(e.sessions,["items","sessions"]).map(ov).filter(s=>s!==null),keepers:ct(e.keepers,["items","keepers"]).map(yl).filter(s=>s!==null),resident_judge_runtime:Zc(e.resident_judge_runtime),persistent_agents:ct(e.persistent_agents,["items","persistent_agents"]).map(yl).filter(s=>s!==null),recent_messages:ct(e.recent_messages,["messages"]).map(ev).filter(s=>s!==null),pending_confirms:(n==null?void 0:n.items)??ct(e.pending_confirms,["items","confirms"]).map(Yc).filter(s=>s!==null),pending_confirm_envelope:n??void 0,pending_confirm_summary:(n==null?void 0:n.summary)??Xc(e.pending_confirm_summary)??void 0,available_actions:ct(e.available_actions,["actions"]).map(Vc).filter(s=>s!==null)}}function ws(t){if(typeof t=="string")return t;if(t==null)return"";try{return JSON.stringify(t)}catch{return String(t)}}function bl(t){return t.target_id?`${t.target_type}:${t.target_id}`:t.target_type}function Ca(t){Sa.value=[{...t,id:tv++,at:new Date().toISOString()},...Sa.value].slice(0,20)}function ed(t){return t.confirm_required?ws(t.preview)||"Confirmation required":ws(t.result)||ws(t.executed_action)||ws(t.delegated_tool_result)||t.status}async function _t(){Zn.value=!0,$e.value=null;try{const t=await Lp();It.value=rv(t)}catch(t){$e.value=t instanceof Error?t.message:"Failed to load operator snapshot"}finally{Zn.value=!1}}async function Fe(){ts.value=!0,hn.value=null;try{const t=await bc({targetType:"room"});nr.value=td(t)}catch(t){hn.value=t instanceof Error?t.message:"Failed to load operator digest"}finally{ts.value=!1}}async function he(t){if(!t){Ht.value=null;return}ts.value=!0,hn.value=null;try{const e=await bc({targetType:"team_session",targetId:t,includeWorkers:!0});Ht.value=td(e)}catch(e){hn.value=e instanceof Error?e.message:"Failed to load session digest"}finally{ts.value=!1}}async function nd(t){var e;it.value=!0,$e.value=null;try{const n=await bs(t);return Ca({actor:t.actor,action_type:t.action_type,target_label:bl(t),outcome:n.confirm_required?"preview":"executed",message:ed(n),delegated_tool:n.delegated_tool}),await _t(),await Fe(),(e=Ht.value)!=null&&e.target_id&&await he(Ht.value.target_id),n}catch(n){const s=n instanceof Error?n.message:"Operator action failed";throw $e.value=s,Ca({actor:t.actor,action_type:t.action_type,target_label:bl(t),outcome:"error",message:s}),n}finally{it.value=!1}}async function sd(t,e,n="confirm"){var s;it.value=!0,$e.value=null;try{const a=await Fp(t,e,n);return Ca({actor:t,action_type:n,target_label:e,outcome:"confirmed",message:ed(a),delegated_tool:a.delegated_tool}),await _t(),await Fe(),(s=Ht.value)!=null&&s.target_id&&await he(Ht.value.target_id),a}catch(a){const o=a instanceof Error?a.message:"Operator confirmation failed";throw $e.value=o,Ca({actor:t,action_type:"confirm",target_label:e,outcome:"error",message:o}),a}finally{it.value=!1}}V_(()=>{var t;_t(),Fe(),(t=Ht.value)!=null&&t.target_id&&he(Ht.value.target_id)});const xs=g(null),go=g(!1),Aa=g(null),ad=g(null),Qe=g(!1),Me=g(null),$o=g(null),ra=g(!1),la=g(null);let un=null;function kl(){un!==null&&(window.clearTimeout(un),un=null)}function lv(t=1500){un===null&&(un=window.setTimeout(()=>{un=null,Ta(!1)},t))}function q(t){return typeof t=="object"&&t!==null&&!Array.isArray(t)}function b(t){return typeof t=="string"&&t.trim()!==""?t:void 0}function D(t){return typeof t=="number"&&Number.isFinite(t)?t:void 0}function pn(t){return typeof t=="boolean"?t:void 0}function V(t,e=[]){if(Array.isArray(t))return t;if(!q(t))return[];for(const n of e){const s=t[n];if(Array.isArray(s))return s}return[]}function Sn(t){if(!q(t))return null;const e=b(t.kind),n=b(t.summary),s=b(t.target_type);return!e||!n||!s?null:{kind:e,severity:b(t.severity)??"warn",summary:n,target_type:s,target_id:b(t.target_id)??null,actor:b(t.actor)??null,evidence:t.evidence}}function Ue(t){if(!q(t))return null;const e=b(t.action_type),n=b(t.target_type),s=b(t.reason);return!e||!n||!s?null:{action_type:e,target_type:n,target_id:b(t.target_id)??null,severity:b(t.severity)??"warn",reason:s,confirm_required:pn(t.confirm_required),suggested_payload:t.suggested_payload,preview:t.preview}}function cv(t){if(!q(t))return null;const e=b(t.session_id);return e?{session_id:e,goal:b(t.goal),status:b(t.status),health:b(t.health),scale_profile:b(t.scale_profile),control_profile:b(t.control_profile),planned_worker_count:D(t.planned_worker_count),active_agent_count:D(t.active_agent_count),last_turn_age_sec:D(t.last_turn_age_sec)??null,attention_count:D(t.attention_count),recommended_action_count:D(t.recommended_action_count),top_attention:Sn(t.top_attention),top_recommendation:Ue(t.top_recommendation)}:null}function dv(t){if(!q(t))return null;const e=b(t.session_id);if(!e)return null;const n=q(t.status)?t.status:t,s=q(n.summary)?n.summary:void 0;return{session_id:e,status:b(t.status)??b(s==null?void 0:s.status)??(q(n.session)?b(n.session.status):void 0),progress_pct:D(t.progress_pct)??D(s==null?void 0:s.progress_pct),elapsed_sec:D(t.elapsed_sec)??D(s==null?void 0:s.elapsed_sec),remaining_sec:D(t.remaining_sec)??D(s==null?void 0:s.remaining_sec),done_delta_total:D(t.done_delta_total)??D(s==null?void 0:s.done_delta_total),summary:q(t.summary)?t.summary:s,team_health:q(t.team_health)?t.team_health:q(n.team_health)?n.team_health:void 0,communication_metrics:q(t.communication_metrics)?t.communication_metrics:q(n.communication_metrics)?n.communication_metrics:void 0,orchestration_state:q(t.orchestration_state)?t.orchestration_state:q(n.orchestration_state)?n.orchestration_state:void 0,cascade_metrics:q(t.cascade_metrics)?t.cascade_metrics:q(n.cascade_metrics)?n.cascade_metrics:void 0,report_paths:q(t.report_paths)?Object.fromEntries(Object.entries(t.report_paths).map(([a,o])=>{const l=b(o);return l?[a,l]:null}).filter(a=>a!==null)):q(n.report_paths)?Object.fromEntries(Object.entries(n.report_paths).map(([a,o])=>{const l=b(o);return l?[a,l]:null}).filter(a=>a!==null)):void 0,session:q(t.session)?t.session:q(n.session)?n.session:void 0,recent_events:V(t.recent_events,["events"]).filter(q)}}function uv(t){if(!q(t))return null;const e=b(t.name);return e?{name:e,agent_name:b(t.agent_name),status:b(t.status),autonomy_level:b(t.autonomy_level),context_ratio:D(t.context_ratio),generation:D(t.generation),active_goal_ids:V(t.active_goal_ids).map(n=>typeof n=="string"?n.trim():"").filter(Boolean),last_autonomous_action_at:b(t.last_autonomous_action_at)??null,last_turn_ago_s:D(t.last_turn_ago_s),model:b(t.model)}:null}function pv(t){if(!q(t))return null;const e=b(t.confirm_token)??b(t.token);return e?{confirm_token:e,actor:b(t.actor),action_type:b(t.action_type),target_type:b(t.target_type),target_id:b(t.target_id)??null,delegated_tool:b(t.delegated_tool),created_at:b(t.created_at),preview:t.preview}:null}function mv(t){if(!q(t))return null;const e=b(t.action_type),n=b(t.target_type);return!e||!n?null:{action_type:e,target_type:n,description:b(t.description),confirm_required:pn(t.confirm_required)}}function _v(t){const e=q(t)?t:{};return{room_health:b(e.room_health),cluster:b(e.cluster),project:b(e.project),current_room:b(e.current_room)??b(e.room)??null,paused:pn(e.paused),tempo_interval_s:D(e.tempo_interval_s),active_agents:D(e.active_agents),keeper_pressure:D(e.keeper_pressure),active_operations:D(e.active_operations),pending_approvals:D(e.pending_approvals),incident_count:D(e.incident_count),recommended_action_count:D(e.recommended_action_count),top_attention:Sn(e.top_attention),top_action:Ue(e.top_action)}}function vv(t){const e=q(t)?t:{},n=q(e.swarm_overview)?e.swarm_overview:{};return{health:b(e.health),active_operations:D(e.active_operations),pending_approvals:D(e.pending_approvals),swarm_overview:{active_lanes:D(n.active_lanes),moving_lanes:D(n.moving_lanes),stalled_lanes:D(n.stalled_lanes),projected_lanes:D(n.projected_lanes),last_movement_at:b(n.last_movement_at)??null},top_attention:Sn(e.top_attention),top_action:Ue(e.top_action),session_cards:V(e.session_cards).map(cv).filter(s=>s!==null)}}function fv(t){const e=q(t)?t:{};return{sessions:V(e.sessions,["items"]).map(dv).filter(n=>n!==null),keepers:V(e.keepers,["items"]).map(uv).filter(n=>n!==null),pending_confirms:V(e.pending_confirms).map(pv).filter(n=>n!==null),available_actions:V(e.available_actions).map(mv).filter(n=>n!==null)}}function gv(t){if(!q(t))return null;const e=b(t.id),n=b(t.kind),s=b(t.summary),a=b(t.target_type);return!e||!n||!s||!a?null:{id:e,kind:n,severity:b(t.severity)??"warn",summary:s,target_type:a,target_id:b(t.target_id)??null,top_action:Ue(t.top_action),related_session_ids:V(t.related_session_ids).map(o=>typeof o=="string"?o.trim():"").filter(Boolean),related_agent_names:V(t.related_agent_names).map(o=>typeof o=="string"?o.trim():"").filter(Boolean),evidence_preview:V(t.evidence_preview).map(o=>typeof o=="string"?o.trim():"").filter(Boolean),last_seen_at:b(t.last_seen_at)??null}}function id(t){if(!q(t))return null;const e=b(t.session_id),n=b(t.goal);return!e||!n?null:{session_id:e,goal:n,room:b(t.room)??null,status:b(t.status),health:b(t.health),member_names:V(t.member_names).map(s=>typeof s=="string"?s.trim():"").filter(Boolean),started_at:b(t.started_at)??null,elapsed_sec:D(t.elapsed_sec)??null,operation_id:b(t.operation_id)??null,blocker_summary:b(t.blocker_summary)??null,last_event_at:b(t.last_event_at)??null,last_event_summary:b(t.last_event_summary)??null,communication_summary:b(t.communication_summary)??null,active_count:D(t.active_count),seen_count:D(t.seen_count),planned_count:D(t.planned_count),required_count:D(t.required_count),counts_basis:b(t.counts_basis)??null,related_attention_count:D(t.related_attention_count)??0,top_attention:Sn(t.top_attention),top_recommendation:Ue(t.top_recommendation)}}function od(t){if(!q(t))return null;const e=b(t.agent_name);return e?{agent_name:e,display_name:b(t.display_name)??null,is_live:typeof t.is_live=="boolean"?t.is_live:void 0,current_work:b(t.current_work)??null,recent_input_preview:b(t.recent_input_preview)??null,recent_output_preview:b(t.recent_output_preview)??null,recent_tool_names:V(t.recent_tool_names).map(n=>typeof n=="string"?n.trim():"").filter(Boolean),last_activity_at:b(t.last_activity_at)??null}:null}function rd(t){if(!q(t))return null;const e=b(t.operation_id);return e?{operation_id:e,status:b(t.status),stage:b(t.stage)??null,detachment_status:b(t.detachment_status)??null,objective:b(t.objective)??null,updated_at:b(t.updated_at)??null}:null}function ld(t){if(!q(t))return null;const e=b(t.name);return e?{name:e,agent_name:b(t.agent_name)??null,status:b(t.status),generation:D(t.generation),context_ratio:D(t.context_ratio)??null,last_turn_ago_s:D(t.last_turn_ago_s)??null,current_work:b(t.current_work)??null}:null}function cd(t){const e=id(t);return e?{...e,member_previews:V(q(t)?t.member_previews:void 0).map(od).filter(n=>n!==null),operation_badges:V(q(t)?t.operation_badges:void 0).map(rd).filter(n=>n!==null),keeper_refs:V(q(t)?t.keeper_refs:void 0).map(ld).filter(n=>n!==null)}:null}function $v(t){if(!q(t))return null;const e=b(t.agent_name);return e?{agent_name:e,display_name:b(t.display_name)??null,is_live:typeof t.is_live=="boolean"?t.is_live:void 0,archived_reason:b(t.archived_reason)??null,status:b(t.status),where:b(t.where)??null,with_whom:V(t.with_whom).map(n=>typeof n=="string"?n.trim():"").filter(Boolean),current_work:b(t.current_work)??null,related_session_id:b(t.related_session_id)??null,related_attention_count:D(t.related_attention_count)??0,last_activity_at:b(t.last_activity_at)??null,last_activity_age_sec:D(t.last_activity_age_sec)??null,signal_truth:b(t.signal_truth)==="live"||b(t.signal_truth)==="stale"||b(t.signal_truth)==="archived"||b(t.signal_truth)==="unknown"?b(t.signal_truth):void 0,evidence_source:b(t.evidence_source)==="message"||b(t.evidence_source)==="presence"||b(t.evidence_source)==="session"||b(t.evidence_source)==="none"?b(t.evidence_source):void 0,recent_output_preview:b(t.recent_output_preview)??null,recent_input_preview:b(t.recent_input_preview)??null,recent_tool_names:V(t.recent_tool_names).map(n=>typeof n=="string"?n.trim():"").filter(Boolean)}:null}function hv(t){if(!q(t))return null;const e=b(t.name);return e?{name:e,agent_name:b(t.agent_name)??null,status:b(t.status),generation:D(t.generation),context_ratio:D(t.context_ratio)??null,last_turn_ago_s:D(t.last_turn_ago_s)??null,current_work:b(t.current_work)??null,last_autonomous_action_at:b(t.last_autonomous_action_at)??null,allowed_tool_names:V(t.allowed_tool_names).map(n=>typeof n=="string"?n.trim():"").filter(Boolean),latest_tool_names:V(t.latest_tool_names).map(n=>typeof n=="string"?n.trim():"").filter(Boolean),latest_tool_call_count:D(t.latest_tool_call_count)??null,tool_audit_source:b(t.tool_audit_source)??null,tool_audit_at:b(t.tool_audit_at)??null}:null}function yv(t){if(!q(t))return null;const e=b(t.id),n=b(t.signal_type),s=b(t.summary),a=b(t.target_type);return!e||!n||!s||!a?null:{id:e,signal_type:n==="action"?"action":"attention",severity:b(t.severity)??"warn",summary:s,target_type:a,target_id:b(t.target_id)??null,attention:Sn(t.attention),action:Ue(t.action)}}function bv(t){const e=q(t)?t:{},n=V(e.session_briefs).map(id).filter(a=>a!==null),s=V(e.sessions).map(cd).filter(a=>a!==null);return{generated_at:b(e.generated_at),summary:_v(e.summary),incidents:V(e.incidents).map(Sn).filter(a=>a!==null),recommended_actions:V(e.recommended_actions).map(Ue).filter(a=>a!==null),command_focus:vv(e.command_focus),operator_targets:fv(e.operator_targets),attention_queue:V(e.attention_queue).map(gv).filter(a=>a!==null),sessions:s.length>0?s:n.map(a=>({...a,member_previews:[],operation_badges:[],keeper_refs:[]})),session_briefs:n,agent_briefs:V(e.agent_briefs).map($v).filter(a=>a!==null),keeper_briefs:V(e.keeper_briefs).map(hv).filter(a=>a!==null),internal_signals:V(e.internal_signals).map(yv).filter(a=>a!==null)}}function kv(t){if(!q(t))return null;const e=b(t.id),n=b(t.summary);return!e||!n?null:{id:e,timestamp:b(t.timestamp)??null,event_type:b(t.event_type),actor:b(t.actor)??null,summary:n}}function xv(t){const e=q(t)?t:{};return{generated_at:b(e.generated_at),session_id:b(e.session_id)??"",session:cd(e.session),timeline:V(e.timeline).map(kv).filter(n=>n!==null),participants:V(e.participants).map(od).filter(n=>n!==null),operations:V(e.operations).map(rd).filter(n=>n!==null),keepers:V(e.keepers).map(ld).filter(n=>n!==null),error:b(e.error)??null}}function Sv(t){if(!q(t))return null;const e=b(t.id),n=b(t.label),s=b(t.summary);if(!e||!n||!s)return null;const a=b(t.status)??"unclear";return{id:e,label:n,status:a==="ok"||a==="healthy"||a==="aligned"||a==="watch"||a==="risk"||a==="unclear"?a:"unclear",summary:s,signal_class:b(t.signal_class)==="metadata_gap"||b(t.signal_class)==="mixed"||b(t.signal_class)==="operational_risk"?b(t.signal_class):void 0,evidence_quality:b(t.evidence_quality)==="strong"||b(t.evidence_quality)==="partial"||b(t.evidence_quality)==="missing"?b(t.evidence_quality):void 0,evidence:V(t.evidence).map(l=>typeof l=="string"?l.trim():"").filter(Boolean)}}function Cv(t){if(!q(t))return null;const e=b(t.kind),n=b(t.summary),s=b(t.scope_type),a=b(t.severity);return!e||!n||!s||!a||s!=="session"&&s!=="keeper"&&s!=="agent"||a!=="info"&&a!=="watch"?null:{kind:e,summary:n,scope_type:s,scope_id:b(t.scope_id)??null,severity:a}}function Av(t){const e=q(t)?t:{},n=q(e.basis)?e.basis:{},s=b(e.status)??"error",a=s==="ok"||s==="pending"||s==="unavailable"||s==="error"?s:"error";return{generated_at:b(e.generated_at),cached:pn(e.cached),stale:pn(e.stale),refreshing:pn(e.refreshing),status:a,summary:b(e.summary)??null,model:b(e.model)??null,ttl_sec:D(e.ttl_sec),criteria:V(e.criteria).map(o=>typeof o=="string"?o.trim():"").filter(Boolean),basis:{current_room:b(n.current_room)??null,crew_count:D(n.crew_count),agent_count:D(n.agent_count),keeper_count:D(n.keeper_count)},metadata_gap_count:D(e.metadata_gap_count),metadata_gaps:V(e.metadata_gaps).map(Cv).filter(o=>o!==null),sections:V(e.sections).map(Sv).filter(o=>o!==null),error:b(e.error)??null,last_error:b(e.last_error)??null}}async function dd(){go.value=!0,Aa.value=null;try{const t=await Sp();xs.value=bv(t)}catch(t){Aa.value=t instanceof Error?t.message:"Failed to load mission snapshot"}finally{go.value=!1}}async function Tv(t){if(!t){$o.value=null,la.value=null,ra.value=!1;return}ra.value=!0,la.value=null;try{const e=await Cp(t);$o.value=xv(e)}catch(e){la.value=e instanceof Error?e.message:"Failed to load session detail"}finally{ra.value=!1}}async function Ta(t=!1){Qe.value=!0,Me.value=null;try{const e=await Ap(t),n=Av(e);ad.value=n,n.refreshing||n.status==="pending"?lv():kl()}catch(e){Me.value=e instanceof Error?e.message:"Failed to load mission briefing",kl()}finally{Qe.value=!1}}const ud=g(null),ho=g(!1),Ze=g(null);async function pd(t,e){ho.value=!0,Ze.value=null;try{ud.value=await Tp(t,e)}catch(n){Ze.value=n instanceof Error?n.message:String(n)}finally{ho.value=!1}}const sr=g(null),Jt=g(null),Ia=g(!1),Ra=g(!1),Ma=g(null),La=g(null),yo=g(null),Pa=g(null),X=g("warroom"),Ss=g(null),bo=g(!1),za=g(null),He=g(null),Ea=g(!1),Na=g(null),ar=g(null),ko=g(!1),ja=g(null),Cs=g(null),xo=g(!1),wa=g(null),es=g(null),Oa=g(!1),ns=g(null),mn=g(null);let En=null;function ir(t){return t!=="summary"&&t!=="swarm"&&t!=="warroom"&&t!=="orchestra"}function md(){if(typeof window>"u")return new URLSearchParams;const t=new URLSearchParams(window.location.search),e=window.location.hash.replace(/^#/,""),n=e.indexOf("?");return n>=0&&new URLSearchParams(e.slice(n+1)).forEach((a,o)=>{t.has(o)||t.set(o,a)}),t}function _d(){const e=md().get("run_id")??void 0;return e&&e.trim()!==""?e.trim():void 0}function vd(){const e=md().get("operation_id")??void 0;return e&&e.trim()!==""?e.trim():void 0}function Iv(t){if(m(t))return{policy_class:r(t.policy_class),approval_class:r(t.approval_class),tool_allowlist:U(t.tool_allowlist),model_allowlist:U(t.model_allowlist),requires_human_for:U(t.requires_human_for),autonomy_level:r(t.autonomy_level),escalation_timeout_sec:u(t.escalation_timeout_sec),kill_switch:w(t.kill_switch),frozen:w(t.frozen)}}function Rv(t){if(m(t))return{headcount_cap:u(t.headcount_cap),active_operation_cap:u(t.active_operation_cap),max_cost_usd:u(t.max_cost_usd),max_tokens:u(t.max_tokens)}}function or(t){if(!m(t))return null;const e=r(t.unit_id),n=r(t.label),s=r(t.kind);return!e||!n||!s?null:{unit_id:e,label:n,kind:s,parent_unit_id:r(t.parent_unit_id)??null,leader_id:r(t.leader_id)??null,roster:U(t.roster),capability_profile:U(t.capability_profile),source:r(t.source),created_at:r(t.created_at),updated_at:r(t.updated_at),policy:Iv(t.policy),budget:Rv(t.budget)}}function fd(t){if(!m(t))return null;const e=or(t.unit);return e?{unit:e,leader_status:r(t.leader_status),roster_total:u(t.roster_total),roster_live:u(t.roster_live),active_operation_count:u(t.active_operation_count),health:r(t.health),reasons:U(t.reasons),children:Array.isArray(t.children)?t.children.map(fd).filter(n=>n!==null):[]}:null}function Mv(t){if(m(t))return{total_units:u(t.total_units),company_count:u(t.company_count),platoon_count:u(t.platoon_count),squad_count:u(t.squad_count),leaf_agent_unit_count:u(t.leaf_agent_unit_count),live_agent_count:u(t.live_agent_count),managed_unit_count:u(t.managed_unit_count),active_operation_count:u(t.active_operation_count)}}function gd(t){const e=m(t)?t:{};return{version:r(e.version),generated_at:r(e.generated_at),source:r(e.source),summary:Mv(e.summary),units:Array.isArray(e.units)?e.units.map(fd).filter(n=>n!==null):[]}}function Lv(t){if(!m(t))return null;const e=r(t.kind),n=r(t.status);return!e||!n?null:{kind:e,chain_id:r(t.chain_id)??null,goal:r(t.goal)??null,run_id:r(t.run_id)??null,status:n,viewer_path:r(t.viewer_path)??null,last_sync_at:r(t.last_sync_at)??null}}function ii(t){if(!m(t))return null;const e=r(t.operation_id),n=r(t.objective),s=r(t.assigned_unit_id),a=r(t.trace_id),o=r(t.status);return!e||!n||!s||!a||!o?null:{operation_id:e,objective:n,assigned_unit_id:s,autonomy_level:r(t.autonomy_level),policy_class:r(t.policy_class),budget_class:r(t.budget_class),detachment_session_id:r(t.detachment_session_id)??null,trace_id:a,checkpoint_ref:r(t.checkpoint_ref)??null,active_goal_ids:U(t.active_goal_ids),note:r(t.note)??null,created_by:r(t.created_by),source:r(t.source),status:o,chain:Lv(t.chain),created_at:r(t.created_at),updated_at:r(t.updated_at)}}function Pv(t){if(!m(t))return null;const e=ii(t.operation);return e?{operation:e,assigned_unit_label:r(t.assigned_unit_label)}:null}function Mn(t){if(m(t))return{tone:r(t.tone),pending_ops:u(t.pending_ops),blocked_ops:u(t.blocked_ops),in_flight_ops:u(t.in_flight_ops),pipeline_stalls:u(t.pipeline_stalls),bus_traffic:u(t.bus_traffic),l1_hit_rate:u(t.l1_hit_rate),invalidation_count:u(t.invalidation_count),current_pending:u(t.current_pending),current_in_flight:u(t.current_in_flight),cdb_wakeups:u(t.cdb_wakeups),total_stolen:u(t.total_stolen),avg_best_score:u(t.avg_best_score),avg_candidate_count:u(t.avg_candidate_count),best_first_operations:u(t.best_first_operations),active_sessions:u(t.active_sessions),commit_rate:u(t.commit_rate),total_speculations:u(t.total_speculations)}}function zv(t){if(!m(t))return;const e=m(t.pipeline)?t.pipeline:void 0,n=m(t.cache)?t.cache:void 0,s=m(t.ooo)?t.ooo:void 0,a=m(t.speculative)?t.speculative:void 0,o=m(t.search_fabric)?t.search_fabric:void 0,l=m(t.signals)?t.signals:void 0;return{pipeline:e?{total_ops:u(e.total_ops),completed_ops:u(e.completed_ops),stalled_cycles:u(e.stalled_cycles),hazards_detected:u(e.hazards_detected),forwarding_used:u(e.forwarding_used),pipeline_flushes:u(e.pipeline_flushes),ipc:u(e.ipc)}:void 0,cache:n?{total_reads:u(n.total_reads),total_writes:u(n.total_writes),l1_hit_rate:u(n.l1_hit_rate),invalidation_count:u(n.invalidation_count),writeback_count:u(n.writeback_count),bus_traffic:u(n.bus_traffic)}:void 0,ooo:s?{agent_count:u(s.agent_count),total_added:u(s.total_added),total_issued:u(s.total_issued),total_completed:u(s.total_completed),total_stolen:u(s.total_stolen),cdb_wakeups:u(s.cdb_wakeups),stall_cycles:u(s.stall_cycles),global_cdb_events:u(s.global_cdb_events),current_pending:u(s.current_pending),current_in_flight:u(s.current_in_flight)}:void 0,speculative:a?{total_speculations:u(a.total_speculations),total_commits:u(a.total_commits),total_aborts:u(a.total_aborts),commit_rate:u(a.commit_rate),total_fast_calls:u(a.total_fast_calls),total_cost_usd:u(a.total_cost_usd),active_sessions:u(a.active_sessions)}:void 0,search_fabric:o?{total_operations:u(o.total_operations),best_first_operations:u(o.best_first_operations),legacy_operations:u(o.legacy_operations),blocked_operations:u(o.blocked_operations),ready_operations:u(o.ready_operations),research_pipeline_operations:u(o.research_pipeline_operations),avg_candidate_count:u(o.avg_candidate_count),avg_best_score:u(o.avg_best_score),top_stage:r(o.top_stage)??null}:void 0,signals:l?{issue_pressure:Mn(l.issue_pressure),cache_contention:Mn(l.cache_contention),scheduler_efficiency:Mn(l.scheduler_efficiency),routing_confidence:Mn(l.routing_confidence),speculative_posture:Mn(l.speculative_posture)}:void 0}}function $d(t){const e=m(t)?t:{},n=m(e.summary)?e.summary:void 0;return{version:r(e.version),generated_at:r(e.generated_at),summary:n?{total:u(n.total),active:u(n.active),paused:u(n.paused),managed:u(n.managed),projected:u(n.projected)}:void 0,microarch:zv(e.microarch),operations:Array.isArray(e.operations)?e.operations.map(Pv).filter(s=>s!==null):[]}}function hd(t){if(!m(t))return null;const e=r(t.detachment_id),n=r(t.operation_id),s=r(t.assigned_unit_id);return!e||!n||!s?null:{detachment_id:e,operation_id:n,assigned_unit_id:s,leader_id:r(t.leader_id)??null,roster:U(t.roster),session_id:r(t.session_id)??null,checkpoint_ref:r(t.checkpoint_ref)??null,runtime_kind:r(t.runtime_kind)??null,runtime_ref:r(t.runtime_ref)??null,source:r(t.source),status:r(t.status),last_event_at:r(t.last_event_at)??null,last_progress_at:r(t.last_progress_at)??null,heartbeat_deadline:r(t.heartbeat_deadline)??null,created_at:r(t.created_at),updated_at:r(t.updated_at)}}function Ev(t){if(!m(t))return null;const e=hd(t.detachment);return e?{detachment:e,assigned_unit_label:r(t.assigned_unit_label),operation:ii(t.operation)}:null}function yd(t){const e=m(t)?t:{},n=m(e.summary)?e.summary:void 0;return{version:r(e.version),generated_at:r(e.generated_at),summary:n?{total:u(n.total),active:u(n.active),projected:u(n.projected)}:void 0,detachments:Array.isArray(e.detachments)?e.detachments.map(Ev).filter(s=>s!==null):[]}}function Nv(t){if(!m(t))return null;const e=r(t.decision_id),n=r(t.trace_id),s=r(t.requested_action),a=r(t.scope_type),o=r(t.scope_id);return!e||!n||!s||!a||!o?null:{decision_id:e,trace_id:n,requested_action:s,scope_type:a,scope_id:o,operation_id:r(t.operation_id)??null,target_unit_id:r(t.target_unit_id)??null,requested_by:r(t.requested_by),status:r(t.status),reason:r(t.reason)??null,source:r(t.source),detail:t.detail,created_at:r(t.created_at),decided_at:r(t.decided_at)??null,expires_at:r(t.expires_at)??null}}function bd(t){const e=m(t)?t:{},n=m(e.summary)?e.summary:void 0;return{version:r(e.version),generated_at:r(e.generated_at),summary:n?{total:u(n.total),pending:u(n.pending),approved:u(n.approved),denied:u(n.denied)}:void 0,decisions:Array.isArray(e.decisions)?e.decisions.map(Nv).filter(s=>s!==null):[]}}function jv(t){if(!m(t))return null;const e=or(t.unit);return e?{unit:e,roster_total:u(t.roster_total),roster_live:u(t.roster_live),headcount_cap:u(t.headcount_cap),active_operations:u(t.active_operations),active_operation_cap:u(t.active_operation_cap),utilization:u(t.utilization)}:null}function wv(t){const e=m(t)?t:{};return{version:r(e.version),generated_at:r(e.generated_at),capacity:Array.isArray(e.capacity)?e.capacity.map(jv).filter(n=>n!==null):[]}}function Ov(t){if(!m(t))return null;const e=r(t.alert_id);return e?{alert_id:e,severity:r(t.severity),kind:r(t.kind),scope_type:r(t.scope_type),scope_id:r(t.scope_id),title:r(t.title),detail:r(t.detail),timestamp:r(t.timestamp)}:null}function kd(t){const e=m(t)?t:{},n=m(e.summary)?e.summary:void 0;return{version:r(e.version),generated_at:r(e.generated_at),summary:n?{total:u(n.total),bad:u(n.bad),warn:u(n.warn)}:void 0,alerts:Array.isArray(e.alerts)?e.alerts.map(Ov).filter(s=>s!==null):[]}}function xd(t){if(!m(t))return null;const e=r(t.event_id),n=r(t.trace_id),s=r(t.event_type);return!e||!n||!s?null:{event_id:e,trace_id:n,event_type:s,operation_id:r(t.operation_id)??null,unit_id:r(t.unit_id)??null,actor:r(t.actor)??null,source:r(t.source),timestamp:r(t.timestamp),detail:t.detail}}function Dv(t){const e=m(t)?t:{};return{version:r(e.version),generated_at:r(e.generated_at),events:Array.isArray(e.events)?e.events.map(xd).filter(n=>n!==null):[]}}function qv(t){if(!m(t))return null;const e=r(t.code),n=r(t.severity),s=r(t.summary);return!e||!n||!s?null:{code:e,severity:n,summary:s}}function Fv(t){if(!m(t))return null;const e=r(t.lane_id),n=r(t.label),s=r(t.kind),a=r(t.phase),o=r(t.motion_state),l=r(t.source_of_truth),c=r(t.movement_reason),d=r(t.current_step);if(!e||!n||!s||!a||!o||!l||!c||!d)return null;const p=m(t.counts)?t.counts:{};return{lane_id:e,label:n,kind:s,present:w(t.present)??!1,phase:a,motion_state:o,source_of_truth:l,last_movement_at:r(t.last_movement_at)??null,movement_reason:c,current_step:d,blockers:U(t.blockers),counts:{operations:u(p.operations),detachments:u(p.detachments),workers:u(p.workers),approvals:u(p.approvals),alerts:u(p.alerts)},hard_flags:Array.isArray(t.hard_flags)?t.hard_flags.map(qv).filter(_=>_!==null):[]}}function Kv(t){if(!m(t))return null;const e=r(t.event_id),n=r(t.lane_id),s=r(t.kind),a=r(t.timestamp),o=r(t.title),l=r(t.detail),c=r(t.tone),d=r(t.source);return!e||!n||!s||!a||!o||!l||!c||!d?null:{event_id:e,lane_id:n,kind:s,timestamp:a,title:o,detail:l,tone:c,source:d}}function Bv(t){if(!m(t))return null;const e=r(t.code),n=r(t.severity),s=r(t.summary);return!e||!n||!s?null:{code:e,severity:n,summary:s,why_it_matters:r(t.why_it_matters)??void 0,next_tool:r(t.next_tool)??void 0,next_step:r(t.next_step)??void 0,lane_ids:U(t.lane_ids),count:u(t.count)??0}}function rr(t){if(!m(t))return;const e=m(t.overview)?t.overview:{},n=m(t.gaps)?t.gaps:{},s=m(t.narrative)?t.narrative:{},a=m(t.recommended_next_action)?t.recommended_next_action:void 0;return{generated_at:r(t.generated_at),narrative:{state:r(s.state)??void 0,started:r(s.started)??void 0,active_work:r(s.active_work)??void 0,completion:r(s.completion)??void 0,lane_id:r(s.lane_id)??null},overview:{active_lanes:u(e.active_lanes),moving_lanes:u(e.moving_lanes),stalled_lanes:u(e.stalled_lanes),projected_lanes:u(e.projected_lanes),last_movement_at:r(e.last_movement_at)??null},lanes:Array.isArray(t.lanes)?t.lanes.map(Fv).filter(o=>o!==null):[],timeline:Array.isArray(t.timeline)?t.timeline.map(Kv).filter(o=>o!==null):[],gaps:{count:u(n.count),items:Array.isArray(n.items)?n.items.map(Bv).filter(o=>o!==null):[]},recommended_next_action:a?{tool:r(a.tool)??"masc_operator_snapshot",label:r(a.label)??"Observe operator state",reason:r(a.reason)??"",lane_id:r(a.lane_id)??null}:void 0}}function Sd(t){if(!m(t))return;const e=m(t.workers)?t.workers:{},n=w(t.pass);return{status:r(t.status)??"missing",source:r(t.source)??"none",reason_code:r(t.reason_code)??null,status_summary:r(t.status_summary)??null,run_id:r(t.run_id)??null,captured_at:r(t.captured_at)??null,...n!==void 0?{pass:n}:{},...u(t.peak_hot_slots)!=null?{peak_hot_slots:u(t.peak_hot_slots)}:{},...u(t.ctx_per_slot)!=null?{ctx_per_slot:u(t.ctx_per_slot)}:{},workers:{expected:u(e.expected),joined:u(e.joined),current_task_bound:u(e.current_task_bound),fresh_heartbeats:u(e.fresh_heartbeats),done:u(e.done),final:u(e.final)},expected_artifact_dir:r(t.expected_artifact_dir)??null,artifact_ref:r(t.artifact_ref)??null,missing_reason:r(t.missing_reason)??null}}function Uv(t){const e=m(t)?t:{};return{version:r(e.version),generated_at:r(e.generated_at),topology:gd(e.topology),operations:$d(e.operations),detachments:yd(e.detachments),alerts:kd(e.alerts),decisions:bd(e.decisions),capacity:wv(e.capacity),traces:Dv(e.traces),swarm_status:rr(e.swarm_status)}}function Hv(t){const e=m(t)?t:{},n=gd(e.topology),s=$d(e.operations),a=yd(e.detachments),o=kd(e.alerts),l=bd(e.decisions);return{version:r(e.version),generated_at:r(e.generated_at),topology:{version:n.version,generated_at:n.generated_at,source:n.source,summary:n.summary},operations:{version:s.version,generated_at:s.generated_at,summary:s.summary,microarch:s.microarch},detachments:{version:a.version,generated_at:a.generated_at,summary:a.summary},alerts:{version:o.version,generated_at:o.generated_at,summary:o.summary},decisions:{version:l.version,generated_at:l.generated_at,summary:l.summary},swarm_status:rr(e.swarm_status),swarm_proof:Sd(e.swarm_proof)}}function Wv(t){return m(t)?{chain_id:r(t.chain_id)??null,started_at:u(t.started_at)??null,progress:u(t.progress)??null,elapsed_sec:u(t.elapsed_sec)??null}:null}function Cd(t){if(!m(t))return null;const e=r(t.event);return e?{event:e,chain_id:r(t.chain_id)??null,timestamp:r(t.timestamp)??null,duration_ms:u(t.duration_ms)??null,message:r(t.message)??null,tokens:u(t.tokens)??null}:null}function Gv(t){if(!m(t))return null;const e=ii(t.operation);return e?{operation:e,runtime:Wv(t.runtime),history:Cd(t.history),mermaid:r(t.mermaid)??null,preview_run:Ad(t.preview_run)}:null}function Jv(t){const e=m(t)?t:{};return{status:r(e.status)??"disconnected",base_url:r(e.base_url)??null,message:r(e.message)??null}}function Vv(t){const e=m(t)?t:{},n=m(e.summary)?e.summary:void 0;return{version:r(e.version),generated_at:r(e.generated_at),connection:Jv(e.connection),summary:n?{linked_operations:u(n.linked_operations),active_chains:u(n.active_chains),running_operations:u(n.running_operations),recent_failures:u(n.recent_failures),last_history_event_at:r(n.last_history_event_at)??null}:void 0,operations:Array.isArray(e.operations)?e.operations.map(Gv).filter(s=>s!==null):[],recent_history:Array.isArray(e.recent_history)?e.recent_history.map(Cd).filter(s=>s!==null):[]}}function Yv(t){if(!m(t))return null;const e=r(t.id);return e?{id:e,type:r(t.type),status:r(t.status),duration_ms:u(t.duration_ms)??null,error:r(t.error)??null}:null}function Ad(t){if(!m(t))return null;const e=r(t.run_id),n=r(t.chain_id);return n?{run_id:e??null,chain_id:n,duration_ms:u(t.duration_ms),success:w(t.success),mermaid:r(t.mermaid),nodes:Array.isArray(t.nodes)?t.nodes.map(Yv).filter(s=>s!==null):[]}:null}function Xv(t){const e=m(t)?t:{};return{run:Ad(e.run)}}function Qv(t){if(!m(t))return null;const e=r(t.title),n=r(t.path);return!e||!n?null:{title:e,path:n}}function Zv(t){if(!m(t))return null;const e=r(t.id),n=r(t.title),s=r(t.summary);return!e||!n||!s?null:{id:e,title:n,summary:s}}function tf(t){if(!m(t))return null;const e=r(t.id),n=r(t.title),s=r(t.tool),a=r(t.summary);return!e||!n||!s||!a?null:{id:e,title:n,tool:s,summary:a,success_signals:U(t.success_signals),pitfalls:U(t.pitfalls)}}function ef(t){if(!m(t))return null;const e=r(t.id),n=r(t.title),s=r(t.summary),a=r(t.when_to_use);return!e||!n||!s||!a?null:{id:e,title:n,summary:s,when_to_use:a,steps:Array.isArray(t.steps)?t.steps.map(tf).filter(o=>o!==null):[]}}function nf(t){if(!m(t))return null;const e=r(t.id),n=r(t.title),s=r(t.description);return!e||!n||!s?null:{id:e,title:n,description:s,tools:U(t.tools)}}function sf(t){if(!m(t))return null;const e=r(t.id),n=r(t.title),s=r(t.symptom),a=r(t.why),o=r(t.fix_tool),l=r(t.fix_summary);return!e||!n||!s||!a||!o||!l?null:{id:e,title:n,symptom:s,why:a,fix_tool:o,fix_summary:l}}function af(t){if(!m(t))return null;const e=r(t.id),n=r(t.title),s=r(t.path_id),a=r(t.transport);return!e||!n||!s||!a?null:{id:e,title:n,path_id:s,transport:a,request:t.request,response:t.response,notes:U(t.notes)}}function of(t){const e=m(t)?t:{};return{version:r(e.version),generated_at:r(e.generated_at),docs:Array.isArray(e.docs)?e.docs.map(Qv).filter(n=>n!==null):[],concepts:Array.isArray(e.concepts)?e.concepts.map(Zv).filter(n=>n!==null):[],golden_paths:Array.isArray(e.golden_paths)?e.golden_paths.map(ef).filter(n=>n!==null):[],tool_groups:Array.isArray(e.tool_groups)?e.tool_groups.map(nf).filter(n=>n!==null):[],pitfalls:Array.isArray(e.pitfalls)?e.pitfalls.map(sf).filter(n=>n!==null):[],examples:Array.isArray(e.examples)?e.examples.map(af).filter(n=>n!==null):[]}}function rf(t){if(!m(t))return null;const e=r(t.id),n=r(t.title),s=r(t.status),a=r(t.detail),o=r(t.next_tool);return!e||!n||!s||!a||!o?null:{id:e,title:n,status:s,detail:a,next_tool:o}}function lf(t){if(!m(t))return null;const e=r(t.code),n=r(t.severity),s=r(t.title),a=r(t.detail),o=r(t.next_tool);return!e||!n||!s||!a||!o?null:{code:e,severity:n,title:s,detail:a,next_tool:o}}function cf(t){if(!m(t))return null;const e=r(t.from),n=r(t.content),s=r(t.timestamp),a=u(t.seq);return!e||!n||!s||a==null?null:{seq:a,from:e,content:n,timestamp:s}}function df(t){if(!m(t))return null;const e=r(t.name),n=r(t.role),s=r(t.lane),a=r(t.status),o=r(t.claim_marker),l=r(t.done_marker),c=r(t.final_marker);if(!e||!n||!s||!a||!o||!l||!c)return null;const d=(()=>{if(!m(t.last_message))return null;const p=u(t.last_message.seq),_=r(t.last_message.content),v=r(t.last_message.timestamp);return p==null||!_||!v?null:{seq:p,content:_,timestamp:v}})();return{name:e,role:n,lane:s,joined:w(t.joined)??!1,live_presence:w(t.live_presence)??!1,completed:w(t.completed)??!1,status:a,current_task:r(t.current_task)??null,bound_task_id:r(t.bound_task_id)??null,bound_task_title:r(t.bound_task_title)??null,bound_task_status:r(t.bound_task_status)??null,current_task_matches_run:w(t.current_task_matches_run)??!1,squad_member:w(t.squad_member)??!1,detachment_member:w(t.detachment_member)??!1,last_seen:r(t.last_seen)??null,heartbeat_age_sec:u(t.heartbeat_age_sec)??null,heartbeat_fresh:w(t.heartbeat_fresh)??!1,claim_marker_seen:w(t.claim_marker_seen)??!1,done_marker_seen:w(t.done_marker_seen)??!1,final_marker_seen:w(t.final_marker_seen)??!1,claim_marker:o,done_marker:l,final_marker:c,last_message:d}}function uf(t){if(!m(t))return;const e=Array.isArray(t.timeline)?t.timeline.map(n=>{if(!m(n))return null;const s=r(n.timestamp),a=u(n.active_slots);if(!s||a==null)return null;const o=Array.isArray(n.active_slot_ids)?n.active_slot_ids.map(l=>typeof l=="number"&&Number.isFinite(l)?l:null).filter(l=>l!=null):[];return{timestamp:s,active_slots:a,active_slot_ids:o}}).filter(n=>n!==null):[];return{slot_url:r(t.slot_url)??null,provider_base_url:r(t.provider_base_url)??null,provider_reachable:w(t.provider_reachable)??null,provider_status_code:u(t.provider_status_code)??null,provider_model_id:r(t.provider_model_id)??null,actual_model_id:r(t.actual_model_id)??null,expected_slots:u(t.expected_slots),actual_slots:u(t.actual_slots),expected_ctx:u(t.expected_ctx),actual_ctx:u(t.actual_ctx),configured_capacity:u(t.configured_capacity),slot_reachable:w(t.slot_reachable)??null,slot_status_code:u(t.slot_status_code)??null,runtime_blocker:r(t.runtime_blocker)??null,detail:r(t.detail)??null,checked_at:r(t.checked_at)??null,total_slots:u(t.total_slots),ctx_per_slot:u(t.ctx_per_slot),active_slots_now:u(t.active_slots_now),peak_active_slots:u(t.peak_active_slots),sample_count:u(t.sample_count),last_sample_at:r(t.last_sample_at)??null,timeline:e}}function pf(t){if(!m(t))return null;const e=r(t.run_id),n=r(t.status),s=r(t.decided_by),a=r(t.decided_at),o=r(t.reason);if(!e||!n||!s||!a||!o)return null;const l=[];return Array.isArray(t.history)&&t.history.forEach(c=>{if(!m(c))return;const d=r(c.status),p=r(c.decided_by),_=r(c.decided_at),v=r(c.reason);!d||!p||!_||!v||l.push({status:d,decided_by:p,decided_at:_,reason:v,operation_id:r(c.operation_id)??null,detachment_id:r(c.detachment_id)??null,note:r(c.note)??null})}),{run_id:e,status:n,decided_by:s,decided_at:a,reason:o,operation_id:r(t.operation_id)??null,detachment_id:r(t.detachment_id)??null,note:r(t.note)??null,history:l}}function mf(t){if(!m(t))return null;const e=r(t.run_id),n=r(t.recommended_kind),s=r(t.reason);return!e||!n||!s?null:{run_id:e,recommended_kind:n,continue_available:w(t.continue_available)??!1,rerun_available:w(t.rerun_available)??!1,abandon_available:w(t.abandon_available)??!1,reason:s,evidence:m(t.evidence)?{operation_id:r(t.evidence.operation_id)??null,detachment_id:r(t.evidence.detachment_id)??null,joined_workers:u(t.evidence.joined_workers),current_task_bound:u(t.evidence.current_task_bound),fresh_heartbeats:u(t.evidence.fresh_heartbeats),trace_events:u(t.evidence.trace_events),message_events:u(t.evidence.message_events),runtime_blocker:r(t.evidence.runtime_blocker)??null}:void 0,provenance:r(t.provenance),decision_engine:r(t.decision_engine),authoritative:w(t.authoritative)}}function _f(t){const e=m(t)?t:{},n=m(e.summary)?e.summary:void 0;return{version:r(e.version),generated_at:r(e.generated_at),run_id:r(e.run_id),room_id:r(e.room_id),operation_id:r(e.operation_id)??null,run_resolution:pf(e.run_resolution),resolution_recommendation:mf(e.resolution_recommendation),recommended_next_tool:r(e.recommended_next_tool),summary:n?{expected_workers:u(n.expected_workers),joined_workers:u(n.joined_workers),live_workers:u(n.live_workers),squad_roster_size:u(n.squad_roster_size),detachment_roster_size:u(n.detachment_roster_size),current_task_bound:u(n.current_task_bound),fresh_heartbeats:u(n.fresh_heartbeats),claim_markers_seen:u(n.claim_markers_seen),done_markers_seen:u(n.done_markers_seen),final_markers_seen:u(n.final_markers_seen),completed_workers:u(n.completed_workers),peak_hot_slots:u(n.peak_hot_slots),hot_window_ok:w(n.hot_window_ok),pass_hot_concurrency:w(n.pass_hot_concurrency),pass_end_to_end:w(n.pass_end_to_end),pending_decisions:u(n.pending_decisions),pass:w(n.pass)}:void 0,provider:uf(e.provider),operation:ii(e.operation),squad:or(e.squad),detachment:hd(e.detachment),workers:Array.isArray(e.workers)?e.workers.map(df).filter(s=>s!==null):[],checklist:Array.isArray(e.checklist)?e.checklist.map(rf).filter(s=>s!==null):[],blockers:Array.isArray(e.blockers)?e.blockers.map(lf).filter(s=>s!==null):[],recent_messages:Array.isArray(e.recent_messages)?e.recent_messages.map(cf).filter(s=>s!==null):[],recent_trace_events:Array.isArray(e.recent_trace_events)?e.recent_trace_events.map(xd).filter(s=>s!==null):[],truth_notes:U(e.truth_notes)}}function vf(t){if(!m(t))return null;const e=r(t.label),n=r(t.value);return!e||!n?null:{label:e,value:n}}function ff(t){if(!m(t))return null;const e=r(t.id),n=r(t.kind),s=r(t.label),a=r(t.tone),o=r(t.provenance);return!e||!n||!s||!a||!o?null:{id:e,kind:n,label:s,subtitle:r(t.subtitle)??null,status:r(t.status)??null,tone:a,pulse:r(t.pulse)??null,provenance:o,visual_class:r(t.visual_class)??void 0,glyph:r(t.glyph)??void 0,parent_id:r(t.parent_id)??null,lane_id:r(t.lane_id)??null,link_tab:r(t.link_tab)??null,link_surface:r(t.link_surface)??null,link_params:m(t.link_params)?Object.fromEntries(Object.entries(t.link_params).map(([l,c])=>{const d=r(c);return d?[l,d]:null}).filter(l=>l!==null)):{},facts:Array.isArray(t.facts)?t.facts.map(vf).filter(l=>l!==null):[]}}function gf(t){if(!m(t))return null;const e=r(t.id),n=r(t.source),s=r(t.target),a=r(t.kind),o=r(t.tone),l=r(t.provenance);return!e||!n||!s||!a||!o||!l?null:{id:e,source:n,target:s,kind:a,label:r(t.label)??null,tone:o,provenance:l,animated:w(t.animated)}}function $f(t){if(!m(t))return null;const e=r(t.id),n=r(t.kind),s=r(t.label),a=r(t.tone),o=r(t.provenance);return!e||!n||!s||!a||!o?null:{id:e,kind:n,label:s,detail:r(t.detail)??null,tone:a,provenance:o,source_id:r(t.source_id)??null,target_id:r(t.target_id)??null,suggested_surface:r(t.suggested_surface)??null,suggested_params:m(t.suggested_params)?Object.fromEntries(Object.entries(t.suggested_params).map(([l,c])=>{const d=r(c);return d?[l,d]:null}).filter(l=>l!==null)):{}}}function hf(t){if(!m(t))return null;const e=r(t.target_kind),n=r(t.target_id),s=r(t.label),a=r(t.reason);return!e||!n||!s||!a?null:{target_kind:e,target_id:n,label:s,reason:a,suggested_surface:r(t.suggested_surface)??null,suggested_params:m(t.suggested_params)?Object.fromEntries(Object.entries(t.suggested_params).map(([o,l])=>{const c=r(l);return c?[o,c]:null}).filter(o=>o!==null)):{}}}function yf(t){const e=m(t)?t:{},n=m(e.room)?e.room:{},s=m(e.summary)?e.summary:void 0;return{version:r(e.version),generated_at:r(e.generated_at),room:{room_id:r(n.room_id),project:r(n.project),cluster:r(n.cluster),paused:w(n.paused),pause_reason:r(n.pause_reason)??null,agent_count:u(n.agent_count),task_count:u(n.task_count),message_count:u(n.message_count)},summary:s?{session_count:u(s.session_count),operation_count:u(s.operation_count),detachment_count:u(s.detachment_count),lane_count:u(s.lane_count),worker_count:u(s.worker_count),keeper_count:u(s.keeper_count),signal_count:u(s.signal_count),alert_count:u(s.alert_count)}:void 0,nodes:Array.isArray(e.nodes)?e.nodes.map(ff).filter(a=>a!==null):[],edges:Array.isArray(e.edges)?e.edges.map(gf).filter(a=>a!==null):[],signals:Array.isArray(e.signals)?e.signals.map($f).filter(a=>a!==null):[],focus:hf(e.focus),swarm_status:rr(e.swarm_status),swarm_proof:Sd(e.swarm_proof),truth_notes:U(e.truth_notes)}}function Kt(t){X.value=t,ir(t)&&bf()}async function Td(){Ia.value=!0,Ma.value=null;try{const t=await zp();sr.value=Hv(t)}catch(t){Ma.value=t instanceof Error?t.message:"Failed to load command-plane summary"}finally{Ia.value=!1}}function lr(t){mn.value=t}async function cr(){Ra.value=!0,La.value=null;try{const t=await Pp();Jt.value=Uv(t)}catch(t){La.value=t instanceof Error?t.message:"Failed to load command-plane snapshot"}finally{Ra.value=!1}}async function bf(){Jt.value||Ra.value||await cr()}async function tn(){await Td(),ir(X.value)&&await cr()}async function De(){var t;xo.value=!0,wa.value=null;try{const e=await Ep(),n=Vv(e);Cs.value=n;const s=mn.value;n.operations.length===0?mn.value=null:(!s||!n.operations.some(a=>a.operation.operation_id===s))&&(mn.value=((t=n.operations[0])==null?void 0:t.operation.operation_id)??null)}catch(e){wa.value=e instanceof Error?e.message:"Failed to load chain summary"}finally{xo.value=!1}}function kf(){En=null,es.value=null,Oa.value=!1,ns.value=null}async function xf(t){En=t,Oa.value=!0,ns.value=null;try{const e=await Np(t);if(En!==t)return;es.value=Xv(e)}catch(e){if(En!==t)return;es.value=null,ns.value=e instanceof Error?e.message:"Failed to load chain run"}finally{En===t&&(Oa.value=!1)}}async function Sf(){bo.value=!0,za.value=null;try{const t=await jp();Ss.value=of(t)}catch(t){za.value=t instanceof Error?t.message:"Failed to load command-plane help"}finally{bo.value=!1}}async function Zt(t=_d(),e=vd()){Ea.value=!0,Na.value=null;try{const n=await wp(t,e);He.value=_f(n)}catch(n){Na.value=n instanceof Error?n.message:"Failed to load command-plane swarm view"}finally{Ea.value=!1}}async function Ne(t=_d(),e=vd()){ko.value=!0,ja.value=null;try{const n=await Op(t,e);ar.value=yf(n)}catch(n){ja.value=n instanceof Error?n.message:"Failed to load orchestra map"}finally{ko.value=!1}}async function ye(t,e,n){yo.value=t,Pa.value=null;try{await Dp(e,n),await Td(),(Jt.value||ir(X.value))&&await cr(),await Zt(),await Ne(),await De()}catch(s){throw Pa.value=s instanceof Error?s.message:"Failed to execute command-plane action",s}finally{yo.value=null}}function Cf(t){return ye(`pause:${t}`,"/api/v1/command-plane/operations/pause",{operation_id:t})}function Af(t){return ye(`resume:${t}`,"/api/v1/command-plane/operations/resume",{operation_id:t})}function Tf(t){return ye(`recall:${t}`,"/api/v1/command-plane/dispatch/recall",{operation_id:t})}function If(t={}){return ye("dispatch:tick","/api/v1/command-plane/dispatch/tick",{...t.operationId?{operation_id:t.operationId}:{},...t.detachmentId?{detachment_id:t.detachmentId}:{}})}function Rf(t){return ye(`approve:${t}`,"/api/v1/command-plane/policy/approve",{decision_id:t})}function Mf(t){return ye(`deny:${t}`,"/api/v1/command-plane/policy/deny",{decision_id:t})}function Lf(t,e){return ye(`freeze:${t}`,"/api/v1/command-plane/policy/freeze",{unit_id:t,enabled:e})}function Pf(t,e){return ye(`kill:${t}`,"/api/v1/command-plane/policy/kill-switch",{unit_id:t,enabled:e})}J_(()=>{tn(),De(),(X.value==="swarm"||X.value==="warroom"||X.value==="orchestra"||He.value!==null)&&Zt(),(X.value==="orchestra"||ar.value!==null)&&Ne(),X.value==="warroom"&&_t()});function So(t){t==="command"&&(ze(),tn(),De(),(X.value==="swarm"||X.value==="warroom"||X.value==="orchestra")&&Zt(),X.value==="orchestra"&&Ne(),X.value==="warroom"&&_t()),t==="mission"&&(ze(),dd(),Ta()),t==="proof"&&pd(F.value.params.session_id,F.value.params.operation_id),t==="execution"&&(ze(),Pe()),t==="intervene"&&(ze(),_t(),Fe()),t==="memory"&&me(),t==="planning"&&tr(),t==="lab"&&_e()}function zf({metric:t}){return i`
  ...
  `}function Ef({panel:t}){return i`
    <div class="semantic-body">
      ...
      ${t.metrics.length>0?i`<div class="semantic-metric-list">
            ${t.metrics.map(e=>i`<${zf} key=${e.id} metric=${e} />`)}
          </div>`:null}
    </div>
  `}function K({panelId:t,compact:e=!1,label:n="왜 필요한가"}){const s=N_(t);return s?i`
    <details class="semantic-inline ${e?"compact":""}">
      <summary class="semantic-summary">${n}</summary>
      <${Ef} panel=${s} />
    </details>
  `:ba.value?i`<span class="semantic-inline-state">의미 계층 불러오는 중…</span>`:null}function At({surfaceId:t,compact:e=!1}){const n=E_(t);return n?i`
  ...
  `:ba.value?i`<div class="semantic-surface-card ${e?"compact":""}">의미 계층 불러오는 중…</div>`:ka.value?i`<div class="semantic-surface-card ${e?"compact":""}">${ka.value}</div>`:null}function z({title:t,class:e,semanticId:n,testId:s,children:a}){return i`
    <div class="card ${e??""}" data-testid=${s}>
      ${t?i`
            <div class="card-title-row">
              <div class="card-title">${t}</div>
              ${n?i`<${K} panelId=${n} compact=${!0} />`:null}
            </div>
          `:null}
      ${a}
    </div>
  `}const Da="masc_dashboard_workflow_context",Nf=900*1e3;function xt(t){return typeof t=="string"&&t.trim()!==""?t.trim():null}function oe(t){const e=xt(t);return e||(typeof t=="number"&&Number.isFinite(t)?String(t):null)}function Id(){if(typeof window>"u")return null;try{return window.sessionStorage}catch{return null}}function Co(t){return m(t)?t:null}function jf(t){if(!t)return null;try{return JSON.stringify(t)}catch{return null}}function wf(t){if(!t)return null;try{const e=JSON.parse(t);if(!m(e))return null;const n=xt(e.id),s=xt(e.source_surface),a=xt(e.source_label),o=xt(e.summary),l=xt(e.created_at);return!n||s!=="mission"&&s!=="execution"||!a||!o||!l?null:{id:n,source_surface:s,source_label:a,action_type:xt(e.action_type),target_type:xt(e.target_type),target_id:xt(e.target_id),focus_kind:xt(e.focus_kind),operation_id:xt(e.operation_id),command_surface:xt(e.command_surface),summary:o,payload_preview:xt(e.payload_preview),suggested_payload:Co(e.suggested_payload),preview:e.preview??null,evidence:e.evidence??null,created_at:l}}catch{return null}}function dr(t){const e=Date.parse(t.created_at);return Number.isNaN(e)?!1:Date.now()-e<=Nf}function Of(){const t=Id(),e=wf((t==null?void 0:t.getItem(Da))??null);return e?dr(e)?e:(t==null||t.removeItem(Da),null):null}const Rd=g(Of());function Md(t){const e=t&&dr(t)?t:null;Rd.value=e;const n=Id();if(!n)return;if(!e){n.removeItem(Da);return}const s=jf(e);s&&n.setItem(Da,s)}function Df(t){if(!t)return null;const e=Co(t.suggested_payload);if(e)return e;if(m(t.preview)){const n=Co(t.preview.payload);if(n)return n}return null}function qf(t){if(!t)return null;const e=oe(t.message);if(e)return e;const n=oe(t.task_title)??oe(t.title),s=oe(t.task_description)??oe(t.description),a=oe(t.reason),o=oe(t.priority)??oe(t.task_priority);return n&&s?`${n} · ${s}`:n&&o?`${n} · P${o}`:n||s||a||null}function ur(t,e,n,s,a,o,l,c){return[t,e,n??"action",s??"target",a??"room",o??"focus",l??"operation",c].join(":")}function Cn(t,e,n="상황판 추천 액션"){const s=new Date().toISOString(),a=Df(t),o=(t==null?void 0:t.target_type)??(e==null?void 0:e.target_type)??null,l=(t==null?void 0:t.target_id)??(e==null?void 0:e.target_id)??null,c=(e==null?void 0:e.kind)??(t==null?void 0:t.action_type)??null,d=(t==null?void 0:t.reason)??(e==null?void 0:e.summary)??n;return{id:ur("mission",n,(t==null?void 0:t.action_type)??null,o,l,c,null,s),source_surface:"mission",source_label:n,action_type:(t==null?void 0:t.action_type)??null,target_type:o,target_id:l,focus_kind:c,operation_id:null,command_surface:null,summary:d,payload_preview:qf(a),suggested_payload:a,preview:(t==null?void 0:t.preview)??null,evidence:(e==null?void 0:e.evidence)??null,created_at:s}}function Ff({targetType:t,targetId:e,focusKind:n,sourceLabel:s="Execution 진단",summary:a,operationId:o=null,commandSurface:l=null}){const c=new Date().toISOString();return{id:ur("execution",s,null,t,e,n,o,c),source_surface:"execution",source_label:s,action_type:null,target_type:t,target_id:e,focus_kind:n,operation_id:o,command_surface:l,summary:a,payload_preview:null,suggested_payload:null,preview:null,evidence:null,created_at:c}}function Kf(t,e){return(e.source==="mission"||e.source==="execution")&&(e.action_type??null)===(t.action_type??null)&&(e.target_type??null)===(t.target_type??null)&&(e.target_id??null)===(t.target_id??null)&&(e.focus_kind??null)===(t.focus_kind??null)&&(e.operation_id??null)===(t.operation_id??null)}function As(t){const{params:e}=t;if(e.source!=="mission"&&e.source!=="execution")return null;const n=Rd.value;if(n&&dr(n)&&Kf(n,e))return n;const s=new Date().toISOString(),a=e.source==="execution"?"execution":"mission";return{id:ur(a,a==="execution"?"Execution 이어보기":"상황판 이어보기",e.action_type??null,e.target_type??null,e.target_id??null,e.focus_kind??null,e.operation_id??null,s),source_surface:a,source_label:a==="execution"?"Execution 이어보기":"상황판 이어보기",action_type:e.action_type??null,target_type:e.target_type??null,target_id:e.target_id??null,focus_kind:e.focus_kind??e.action_type??null,operation_id:e.operation_id??null,command_surface:e.surface??null,summary:a==="execution"?e.focus_kind?`${e.focus_kind} 기준으로 열린 execution 컨텍스트입니다.`:"Execution에서 이어진 컨텍스트입니다.":e.focus_kind?`${e.focus_kind} 기준으로 열린 컨텍스트입니다.`:"상황판에서 이어진 컨텍스트입니다.",payload_preview:null,suggested_payload:null,preview:null,evidence:null,created_at:s}}function Ld(t){return{source:t.source_surface,...t.action_type?{action_type:t.action_type}:{},...t.target_type?{target_type:t.target_type}:{},...t.target_id?{target_id:t.target_id}:{},...t.focus_kind?{focus_kind:t.focus_kind}:{},...t.operation_id?{operation_id:t.operation_id}:{}}}function Pd(t){if(t.command_surface)return t.command_surface;const e=[t.focus_kind,t.summary,t.action_type].filter(n=>typeof n=="string"&&n.trim()!=="").join(" ").toLowerCase();return e.includes("artifact_scope")||e.includes("routing_confidence")||e.includes("cache_contention")?"summary":e.includes("stale_data")||e.includes("leader_offline")||e.includes("roster_offline")||e.includes("managed")||e.includes("swarm")?"swarm":t.focus_kind==="operation"||t.target_type==="operation"?"operations":t.target_type==="room"?"orchestra":"swarm"}function zd(t){return{source:t.source_surface,surface:Pd(t),...t.action_type?{action_type:t.action_type}:{},...t.target_type?{target_type:t.target_type}:{},...t.target_id?{target_id:t.target_id}:{},...t.focus_kind?{focus_kind:t.focus_kind}:{},...t.operation_id?{operation_id:t.operation_id}:{}}}function Bf(t){return Ld(t)}function Uf(t){return zd(t)}function pr(t){return t!=null&&t.target_type?t.target_id?`${t.target_type} · ${t.target_id}`:t.target_type:"대상 정보 없음"}function oi(t){switch(t){case"broadcast":return"room 방송";case"room_pause":return"room 일시정지";case"room_resume":return"room 재개";case"task_inject":return"room 작업 주입";case"team_turn":return"session 업데이트";case"team_note":return"session 노트";case"team_broadcast":return"session 방송";case"team_task_inject":return"session 작업";case"team_stop":return"session 중지";case"keeper_msg":case"keeper_message":return"keeper 메시지";case"keeper_probe":return"keeper probe";case"keeper_recover":return"keeper recover";case"swarm_run_continue":return"swarm run 계속";case"swarm_run_rerun":return"swarm run 재실행";case"swarm_run_abandon":return"swarm run 포기";default:return(t==null?void 0:t.trim())||"추천 액션"}}function Hf(t){switch(t){case"warroom":return"워룸";case"summary":return"요약";case"orchestra":return"오케스트라";case"swarm":return"스웜";case"chains":return"체인";case"topology":return"토폴로지";case"alerts":return"알림";case"trace":return"트레이스";case"control":return"제어";case"operations":return"작전";default:return(t==null?void 0:t.trim())||"지휘"}}const te=g(null),ce=g(null);function jt(t,e=120){const n=(t??"").replace(/\s+/g," ").trim();return n?n.length>e?`${n.slice(0,e-1)}…`:n:null}function Tt(t){return t==="bad"||t==="offline"||t==="critical"||t==="risk"?"bad":t==="warn"||t==="pending"||t==="degraded"||t==="interrupted"||t==="watch"?"warn":"ok"}function Ut(t){if(!t)return"방금";const e=Date.parse(t);if(Number.isNaN(e))return t;const n=Math.max(0,Math.round((Date.now()-e)/1e3));return n<60?`${n}초 전`:n<3600?`${Math.round(n/60)}분 전`:n<86400?`${Math.round(n/3600)}시간 전`:`${Math.round(n/86400)}일 전`}function Wf(t){return typeof t!="number"||!Number.isFinite(t)||t<0?"확인 필요":t<60?`${Math.round(t)}초`:t<3600?`${Math.round(t/60)}분`:t<86400?`${Math.round(t/3600)}시간`:`${Math.round(t/86400)}일`}function Et(t){switch((t??"").trim().toLowerCase()){case"ok":case"healthy":case"green":return"안정";case"active":case"running":return"진행 중";case"pending":return"대기 중";case"paused":return"일시정지";case"blocked":return"막힘";case"interrupted":return"중단됨";case"warn":case"watch":return"주의";case"bad":case"critical":case"risk":return"위험";case"degraded":return"저하";case"offline":return"오프라인";case"idle":case"quiet":return"대기";case"loading":return"불러오는 중";case"error":return"오류";case"unavailable":return"사용 불가";case"stale":return"오래됨";case"refreshing":return"갱신 중";case"cached":return"캐시";case"unknown":case"":return"확인 필요";default:return(t==null?void 0:t.trim())||"확인 필요"}}function qa(t){switch((t??"").trim().toLowerCase()){case"room":return"방";case"team_session":case"session":return"세션";case"operation":return"작전";case"keeper":return"키퍼";case"agent":return"에이전트";default:return(t==null?void 0:t.trim())||"대상"}}function xl(t){switch((t??"").trim().toLowerCase()){case"metadata_gap":return"메타데이터 부족";case"mixed":return"신호 혼재";case"":return null;default:return(t==null?void 0:t.trim())||null}}function Gf(t){return t!=null&&t.confirm_required?"확인 후 실행":"즉시 실행"}function Jf(t){return pr(t?Cn(t,null,"상황판 추천 액션"):null)}function ri(t,e=Cn()){Md(e),at(t,t==="intervene"?Bf(e):Uf(e))}function Ed(t){ri("intervene",Cn(null,t,"상황판 incident"))}function Nd(t){ri("command",Cn(null,t,"상황판 incident"))}function mr(t,e,n="상황판 추천 액션"){ri("intervene",Cn(t,e,n))}function jd(t,e,n="상황판 추천 액션"){ri("command",Cn(t,e,n))}function Ao(t,e){const n={source:"mission",target_type:"team_session",target_id:e,focus_kind:"team_session"};t==="command"&&(n.surface="swarm"),at(t,n)}function Vf(t){return{kind:t.kind,severity:t.severity,summary:t.summary,target_type:t.target_type,target_id:t.target_id??null,actor:null,evidence:t.evidence_preview}}function Yf(t){var n,s;const e=ae.value.find(a=>a.name===t.name||a.agent_name===t.agent_name)??null;return{brief:t,keeper:e,currentWork:jt(t.current_work,110)??jt(e==null?void 0:e.skill_primary,110)??jt(e==null?void 0:e.last_proactive_reason,110)??"명시된 키퍼 초점 없음",recentInput:jt(e==null?void 0:e.recent_input_preview,120)??null,recentOutput:jt(e==null?void 0:e.recent_output_preview,120)??jt((n=e==null?void 0:e.diagnostic)==null?void 0:n.last_reply_preview,120)??jt(e==null?void 0:e.last_proactive_preview,120)??null,recentEvent:jt(e==null?void 0:e.last_proactive_reason,120)??jt((s=e==null?void 0:e.diagnostic)==null?void 0:s.summary,120)??null,recentTools:(e==null?void 0:e.recent_tool_names)??[]}}function Xf(){const t=xs.value;if(!t)return new Map;const e=t.sessions.length>0?t.sessions:t.session_briefs;return new Map(e.map(n=>[n.session_id,n]))}function Qf(t){te.value=te.value===t?null:t,ce.value=null}function wd(t){ce.value=ce.value===t?null:t,te.value=null}function Zf(){te.value=null,ce.value=null}function bi(t){return(t==null?void 0:t.trim().toLowerCase())??""}function Ts(t){var e,n;return t?((e=t.agent)==null?void 0:e.exists)===!1||bi((n=t.diagnostic)==null?void 0:n.health_state)==="offline"||bi(t.status)==="offline"||bi(t.status)==="inactive"?"offline":"online":"unlinked"}function Nn(t){switch(t){case"offline":return"offline";case"none_recent":return"none_recent";case"not_applicable":return"not_applicable";case"unlinked":return"unlinked";default:return"not_collected"}}function tg(t){const e=Ts(t);return e==="unlinked"?"unlinked":e==="offline"?"offline":"not_collected"}function eg(t,e){const n=Ts(t);return n==="unlinked"?"unlinked":n==="offline"?"offline":e!=null&&e.trim()?"none_recent":"not_collected"}function ng(t,e){const n=Ts(t);return n==="unlinked"?"unlinked":n==="offline"?"offline":e!=null&&e.trim()?"none_recent":"not_collected"}function Od(t){const e=Ts(t);return e==="unlinked"?"unlinked":e==="offline"?"offline":"none_recent"}function sg(t){const e=t==null?void 0:t.trim();at("tools",e?{q:e}:void 0)}function _r(t){return(t??"").trim().toLowerCase()}function ag(t){switch(_r(t)){case"truth":return"ok";case"recorded":return"";case"derived":case"fallback":case"narrative":case"judgment":return"warn";default:return""}}function ig(t){switch(_r(t)){case"truth":return"직접 수집한 source of truth";case"derived":return"truth를 바탕으로 계산한 read-model";case"fallback":return"직접 truth가 비어 있을 때 쓰는 대체 경로";case"recorded":return"이미 기록된 결정 또는 증거";case"narrative":return"LLM 해석 레이어";case"judgment":return"판단 레이어";default:return"근거 계층"}}function To(t){const e=(t.label??"").trim();return e||_r(t.kind)||"unknown"}function je({item:t}){const e=To(t),n=ag(t.kind);return i`
    <span class="command-chip ${n}" title=${ig(t.kind)}>
      ${e}
    </span>
  `}function Je({items:t,className:e="mission-briefing-meta",testId:n}){const s=t.filter(a=>To(a).trim().length>0);return s.length===0?null:i`
    <div class=${e} data-testid=${n}>
      ${s.map((a,o)=>i`<${je} key=${`${To(a)}-${o}`} item=${a} />`)}
    </div>
  `}function og(t){switch(t.trim().toLowerCase()){case"active":case"running":return"가동 중";case"working":return"작업 중";case"watching":return"관찰 중";case"quiet":return"조용함";case"idle":return"유휴";case"ok":case"healthy":return"정상";case"warn":case"warning":case"degraded":return"주의";case"bad":case"critical":case"error":case"failed":return"위험";case"blocked":return"막힘";case"paused":return"일시정지";case"pending":return"대기";case"offline":case"inactive":return"오프라인";case"connected":return"연결됨";case"disconnected":return"끊김";case"ready":return"준비됨";case"done":case"completed":return"완료";case"unknown":return"알 수 없음";default:return t}}function be({status:t,label:e}){return i`
    <span class="status-badge ${t}">
      <span class="status-dot-inline ${t}"></span>
      ${e??og(t)}
    </span>
  `}function Dd(t){const e=Date.now(),n=typeof t=="number"?t<1e12?t*1e3:t:new Date(t).getTime(),s=Math.floor((e-n)/1e3);if(s<60)return`${s}초 전`;const a=Math.floor(s/60);if(a<60)return`${a}분 전`;const o=Math.floor(a/60);return o<24?`${o}시간 전`:`${Math.floor(o/24)}일 전`}function Z({timestamp:t}){const e=Dd(t),n=typeof t=="string"?t:new Date(t<1e12?t*1e3:t).toISOString();return i`<span class="time-ago" title=${n}>${e}</span>`}let rg=0;const we=g([]);function O(t,e="success",n=4e3){const s=++rg;we.value=[...we.value,{id:s,message:t,type:e}],setTimeout(()=>{we.value=we.value.filter(a=>a.id!==s)},n)}function lg(t){we.value=we.value.filter(e=>e.id!==t)}function cg(){const t=we.value;return t.length===0?null:i`
    <div class="toast-container">
      ${t.map(e=>i`
        <div key=${e.id} class="toast ${e.type}" onClick=${()=>lg(e.id)}>
          ${e.message}
        </div>
      `)}
    </div>
  `}function qd(t,e){const n=t==null?void 0:t.trim(),s=e==null?void 0:e.trim();return s?n&&s===n?null:s:null}function dg(t,e){const n=qd(t,e);return n?`runtime · ${n}`:null}function ug(t,e){const n=t==null?void 0:t.trim(),s=qd(n,e);return n?s?`keeper key · ${n} · runtime agent · ${s}`:`keeper key · ${n}`:null}const pg="masc_dashboard_agent_name",An=g(null),Fa=g(!1),ss=g(""),Ka=g([]),as=g([]),_n=g(""),Kn=g(!1);function Is(t){An.value=t,vr()}function Sl(){An.value=null,ss.value="",Ka.value=[],as.value=[],_n.value=""}function mg(){const t=An.value;return t?Gt.value.find(e=>e.name===t)??null:null}function Fd(t){return t?ue.value.filter(e=>e.assignee===t):[]}function _g(t){return t?ae.value.find(e=>e.agent_name===t||e.name===t)??null:null}function vg(t){if(!t)return null;const e=xs.value;return e?e.agent_briefs.find(n=>n.agent_name===t)??null:null}function fg(t){return t?Yo.value.find(e=>e.agent_name===t||e.name===t)??null:null}async function vr(){const t=An.value;if(t){Fa.value=!0,ss.value="",Ka.value=[],as.value=[];try{const e=await xm(80);Ka.value=e.filter(a=>a.includes(t)).slice(0,20);const n=Fd(t).slice(0,6);if(n.length===0)return;const s=await Promise.all(n.map(async a=>{try{const o=await Sm(a.id,25);return{taskId:a.id,text:o.trim()}}catch(o){const l=o instanceof Error?o.message:"history load failed";return{taskId:a.id,text:`Failed to load history: ${l}`}}}));as.value=s}catch(e){ss.value=e instanceof Error?e.message:"Failed to load agent detail"}finally{Fa.value=!1}}}async function Cl(){var s;const t=An.value,e=_n.value.trim();if(!t||!e)return;const n=((s=localStorage.getItem(pg))==null?void 0:s.trim())||"dashboard";Kn.value=!0;try{await km(n,`@${t} ${e}`),_n.value="",O(`Mention sent to ${t}`,"success"),vr()}catch(a){const o=a instanceof Error?a.message:"Failed to send mention";O(o,"error")}finally{Kn.value=!1}}function gg({task:t}){return i`
    <div class="agent-detail-task">
      <span class="pill">${t.id}</span>
      <span class="agent-detail-task-title">${t.title}</span>
      <${be} status=${t.status} />
    </div>
  `}function $g({row:t}){return i`
  ...
  `}function Al(t,e=160){const n=(t??"").replace(/\s+/g," ").trim();return n?n.length>e?`${n.slice(0,e-1)}…`:n:null}function hg(){const t=An.value;if(!t)return null;const e=mg(),n=_g(t),s=fg(t),a=vg(t),o=Fd(t),l=Ka.value,c=(a==null?void 0:a.display_name)??(n==null?void 0:n.name)??t,d=c!==t?t:null,p=(e==null?void 0:e.status)??(a==null?void 0:a.status)??"unknown",_=!e&&(a==null?void 0:a.is_live)===!1,v=(e==null?void 0:e.last_seen)??(a==null?void 0:a.last_activity_at)??null,f=(a==null?void 0:a.signal_truth)==="live"?"live":(a==null?void 0:a.signal_truth)==="stale"?"stale":(a==null?void 0:a.signal_truth)==="archived"?"archived":(a==null?void 0:a.signal_truth)==="unknown"?"unknown":null,h=(a==null?void 0:a.evidence_source)??null,T=(e==null?void 0:e.emoji)??(n==null?void 0:n.emoji),k=(e==null?void 0:e.koreanName)??(n==null?void 0:n.koreanName),S=Al(s==null?void 0:s.continuity_summary)??Al(s==null?void 0:s.skill_route_summary)??null,$=ug(n==null?void 0:n.name,n==null?void 0:n.agent_name);return i`
    <div
    ...
    >
      <div class="agent-detail-modal">
        <div class="agent-detail-header">
          <div style="display:flex;flex-direction:column;gap:8px;flex:1">
            ...
            <div class="agent-detail-sub">
              ...
              ${v?i`<span>Last seen: <${Z} timestamp=${v} /></span>`:null}
            </div>
        ...
        <div class="agent-detail-grid">
          <${z} title="Assigned Tasks">
            ${o.length===0?i`<div class="empty-state">No assigned tasks</div>`:i`<div class="agent-detail-task-list">${o.map(y=>i`<${gg} key=${y.id} task=${y} />`)}</div>`}
          <//>

          <${z} title="Recent Activity">
            ${l.length===0?i`<div class="empty-state">No recent room activity match</div>`:i`<div class="agent-activity-list">${l.map((y,R)=>i`<div key=${R} class="agent-activity-line">${y}</div>`)}</div>`}
          <//>
        </div>
        <${z} title="Task History">
          ${as.value.length===0?i`<div class="empty-state">No task history loaded</div>`:i`<div class="agent-history-list">${as.value.map(y=>i`<${$g} key=${y.taskId} row=${y} />`)}</div>`}
        <//>

        <${z} title="Direct Mention">
  ...
  `}function yg(t){if(!t)return null;const e=new Date(t);return Number.isNaN(e.getTime())?null:e.toLocaleTimeString()}function bg(t){switch(t.delivery){case"sending":return"sending";case"streaming":return t.streamState==="finalizing"?"finalizing":"streaming";case"timeout":return"timeout";case"error":return"error";case"history":return t.role;default:return"delivered"}}function ki(t){return t.delivery==="error"||t.delivery==="timeout"?"error":t.role==="user"?"user":t.role==="assistant"?"assistant":"system"}function Kd(t){return t.role==="user"?"You":t.label.trim()?t.label.trim():t.role}function kg(t){return Kd(t).slice(0,2).toUpperCase()}function xg(t){var n;const e=(n=t==null?void 0:t.usage)==null?void 0:n.totalTokens;return typeof e=="number"&&Number.isFinite(e)?`${e} tok`:null}function Sg(t){return t?[t.modelUsed??null,typeof t.latencyMs=="number"?`${t.latencyMs} ms`:null,xg(t)].filter(e=>!!e):[]}function Tl(t){return typeof t!="number"||!Number.isFinite(t)?null:t===0?"$0.00":t<.01?`$${t.toFixed(4)}`:`$${t.toFixed(2)}`}function Cg(t){if(!t)return[];const e=["Goal","Progress","Next","Decisions","OpenQuestions","Constraints"];return t.split(`
`).map(n=>n.trim()).filter(Boolean).map(n=>{const s=e.find(a=>n.startsWith(`${a}:`));return s?{label:s,value:n.slice(s.length+1).trim()}:null}).filter(n=>!!(n&&n.value))}function Ag(t){var e;return[t.modelUsed?{label:"Model",value:t.modelUsed}:null,typeof t.latencyMs=="number"?{label:"Latency",value:`${t.latencyMs} ms`}:null,typeof((e=t.usage)==null?void 0:e.totalTokens)=="number"?{label:"Tokens",value:`${t.usage.totalTokens}`}:null,Tl(t.costUsd)?{label:"Cost",value:Tl(t.costUsd)}:null,t.traceId?{label:"Trace",value:t.traceId}:null,typeof t.generation=="number"?{label:"Generation",value:`${t.generation}`}:null].filter(n=>!!n)}function Tg({entry:t}){var p;const[e,n]=$n(!1),[s,a]=$n(!1),o=Sg(t.details),l=!!t.details,c=t.details?Ag(t.details):[],d=Cg((p=t.details)==null?void 0:p.stateBlock);return i`
    <article class=${`chat-bubble ${ki(t)}`}>
      <div class="chat-bubble-head">
        <div class="chat-bubble-identity">
          <div class=${`chat-avatar ${ki(t)}`}>${kg(t)}</div>
          <div class="chat-bubble-identity-copy">
            <div class="chat-bubble-labels">
              <span class=${`chat-role-chip ${ki(t)}`}>${t.label}</span>
              <span class="chat-delivery-chip">${bg(t)}</span>
              ${t.timestamp?i`<span class="chat-time-chip">${yg(t.timestamp)}</span>`:null}
            </div>
  ...
  `}function Ig({entries:t,emptyText:e}){const n=wn(null),s=t.map(a=>`${a.id}:${a.text.length}:${a.delivery}`).join("|");return et(()=>{const a=n.current;a&&(a.scrollTop=a.scrollHeight)},[s]),i`
    <div class="chat-transcript" ref=${n}>
      ${t.length===0?i`<div class="chat-empty-copy">${e}</div>`:t.map(a=>i`<${Tg} key=${a.id} entry=${a} />`)}
    </div>
  `}function Rg({draft:t,placeholder:e,disabled:n,streaming:s,onDraftChange:a,onSend:o,onAbort:l}){return i`
  ...
  `}function Mg(t){switch(t){case"quiet_hours":return"quiet hours";case"min_gap":return"cooldown gate";case"no_recent_activity":return"waiting for activity";case"disabled":return"runtime disabled";case"startup":return"warming up";case"llm_error":return"llm error";case"graphql_error":return"graphql error";case"never_started":return"never started";default:return"unknown"}}function Lg(t){switch(t){case"manual_lodge_poke":return"Run Social Sweep";case"probe":return"Probe";case"recover":return"Recover";default:return"Message"}}function Il(t){switch(t){case"healthy":return"정상";case"recovering":return"복구 중";case"desired_offline":return"의도적 오프라인";case"offline":return"오프라인";default:return null}}function Pg(t){if(!t)return null;const e=new Date(t);return Number.isNaN(e.getTime())?null:e.toLocaleTimeString()}function zg(t){return typeof t!="number"||!Number.isFinite(t)||t<=0?null:t<60?`${Math.round(t)}s`:`${Math.ceil(t/60)}m`}function Bd(t){if(!t)return null;const e=ne.value[t.name];return(e==null?void 0:e.diagnostic)??t.diagnostic??null}function Eg({keeper:t,showRawStatus:e=!1}){if(et(()=>{t!=null&&t.name&&Lc(t.name)},[t==null?void 0:t.name]),!t)return i`<div class="control-status-copy">Select a keeper to inspect direct reply state.</div>`;const n=ne.value[t.name],s=Bd(t),a=ro.value[t.name];return i`
    <div class="control-result-box">
      <div class="control-inline-meta">
        ...
        <span class="pill">${Mg(s==null?void 0:s.quiet_reason)}</span>
        <span class="pill">next ${Lg((s==null?void 0:s.next_action_path)??"direct_message")}</span>
      ...
      <div class="control-status-copy">
        ...
        ${s!=null&&s.last_reply_at?i` · ${Pg(s.last_reply_at)}`:null}
        ${s!=null&&s.next_eligible_at_s?i` · next eligible ${zg(s.next_eligible_at_s)}`:null}
      </div>
  ...
  `}function Ud({keeperName:t,placeholder:e}){const[n,s]=$n("");et(()=>{t&&Lc(t)},[t]);const a=gt.value[t]??[],o=$a.value[t]??!1,l=Bt.value[t],c=async()=>{const d=n.trim();if(!(!t||!d)){s("");try{await Gm(t,d)}catch(p){if(p instanceof Error&&p.name==="AbortError")return;const _=p instanceof Error?p.message:`Failed to message ${t}`;O(_,"error")}}};return i`
  ...
  `}function Ng({actor:t,keeper:e,onPokeLodge:n}){if(!e)return null;const s=Bd(e),a=lo.value[e.name]??!1,o=co.value[e.name]??!1,l=(s==null?void 0:s.next_action_path)??"direct_message",c=(s==null?void 0:s.recoverable)??l==="recover";return i`
    <div class="control-actions">
      <button
        class=${`control-btn ghost ${l==="probe"?"is-active":""}`}
        onClick=${()=>{Jm(e.name,t).catch(d=>{const p=d instanceof Error?d.message:`Failed to probe ${e.name}`;O(p,"error")})}}
        disabled=${a||!t.trim()}
      >
        ${a?"Probing...":"Probe"}
      </button>
      <button
        ...
        onClick=${()=>{Vm(e.name,t).catch(d=>{const p=d instanceof Error?d.message:`Failed to recover ${e.name}`;O(p,"error")})}}
        disabled=${o||!c||!t.trim()}
      >
  ...
  `}function ca(t){return t?t>=1e6?`${(t/1e6).toFixed(1)}M`:t>=1e3?`${(t/1e3).toFixed(1)}K`:String(t):"—"}function Og(t){switch(t){case"keeper_message":return"message";case"keeper_probe":return"probe";case"keeper_recover":return"recover";case"broadcast":return"broadcast";case"room_pause":return"pause";case"room_resume":return"resume";case"social_sweep":case"lodge_tick":return"social";default:return(t==null?void 0:t.trim())||"action"}}function Dg(t){return t.recent_tool_names&&t.recent_tool_names.length>0?t.recent_tool_names:[]}function qg(t){const e=t.metrics_window;return(Array.isArray(e==null?void 0:e.top_tools)?e.top_tools:[]).map(s=>typeof s=="object"&&s!==null&&"tool"in s&&typeof s.tool=="string"?s.tool:null).filter(s=>s!==null)}function Fg(t){const e=xs.value;return e?e.keeper_briefs.find(n=>n.name===t.name||n.agent_name&&t.agent_name&&n.agent_name===t.agent_name)??null:null}function Kg({keeper:t}){const e=t.metrics_series??[],n=e[e.length-1],s=n&&Number.isFinite(n.cost_usd)?`$${n.cost_usd.toFixed(4)}`:null,a=[{label:"Generation",value:t.generation??"-",hint:"Succession count"},{label:"Turns",value:t.turn_count??"-",hint:"Total loop turns"},{label:"Context",value:t.context_ratio!=null?`${Math.round(t.context_ratio*100)}%`:"-",hint:t.context_ratio!=null&&t.context_ratio>.8?"Near limit":void 0},{label:"Activity",value:t.activityLevel??"-",hint:"Level 0–5"}];return i`
  ...
  `}function Bg({keeper:t}){var _,v;const e=t.metrics_series??[];if(e.length<2){const f=(((_=t.context)==null?void 0:_.context_ratio)??0)*100,h=f>85?"#ef4444":f>70?"#f59e0b":"#22c55e";return i`
  ...
  `}function Hg({stats:t}){const e=t.max_hp>0?Math.round(t.hp/t.max_hp*100):0,n=t.max_mp>0?Math.round(t.mp/t.max_mp*100):0;return i`
    <div>
  ...
  `}function Wg({items:t}){return t.length===0?i`<div class="empty-state" style="font-size:13px">No equipment</div>`:i`
  ...
  `}function Gg({rels:t}){const e=Object.entries(t);return e.length===0?i`<div class="empty-state" style="font-size:13px">No relationships</div>`:i`
  ...
  `}function Vg({keeper:t}){var I,H,Y,tt,G,L,x;const e=((I=It.value)==null?void 0:I.room)??{},n=(((H=It.value)==null?void 0:H.available_actions)??[]).filter(E=>E.target_type==="keeper"||E.target_type==="room").slice(0,8),s=Dg(t),a=qg(t),o=Fg(t),l=o!=null&&o.allowed_tool_names&&o.allowed_tool_names.length>0?o.allowed_tool_names:t.allowed_tool_names??[],c=o!=null&&o.latest_tool_names&&o.latest_tool_names.length>0?o.latest_tool_names:t.latest_tool_names??[],d=(o==null?void 0:o.latest_tool_call_count)??t.latest_tool_call_count,p=(o==null?void 0:o.tool_audit_source)??t.tool_audit_source,_=(o==null?void 0:o.tool_audit_at)??t.tool_audit_at,v=((Y=t.agent)==null?void 0:Y.capabilities)??[],f=e.current_room??e.room_id??((tt=dt.value)==null?void 0:tt.room)??"default",h=e.project??((G=dt.value)==null?void 0:G.project)??"확인 없음",T=e.cluster??((L=dt.value)==null?void 0:L.cluster)??"확인 없음",k=Nn(tg(t)),S=Nn(eg(t,p)),$=Nn(ng(t,p)),y=Nn(Od(t)),R=Ts(t),P=((x=t.agent)==null?void 0:x.current_task)??(R==="offline"?"offline":"not_collected"),C=t.skill_primary??(R==="offline"?"offline":"not_collected"),M=l[0]??c[0]??s[0]??null;return i`
    <div class="keeper-signal-list">
      <div class="keeper-signal-row">
        <span>Room</span>
        <strong>${f}</strong>
      ...
      <div style="display:flex; justify-content:flex-end; margin-top:4px;">
        <button class="control-btn ghost" onClick=${()=>{sg(M)}}>
          Open tools panel
        </button>
      </div>
      ...
      <div style="display:flex; flex-direction:column; gap:8px; margin-top:8px;">
        ...
        <div style="display:flex; flex-wrap:wrap; gap:6px;">
          ${c.length>0?c.map(E=>i`<span class="pill">${E}</span>`):i`<span style="font-size:12px; color:#888;">${S}</span>`}
        </div>
      </div>
      <div class="keeper-signal-row">
        <span>Tool calls</span>
        <strong>${typeof d=="number"?d:S==="none_recent"?0:$}</strong>
      </div>
      <div class="keeper-signal-row">
      ...
      <div class="keeper-signal-row">
        ...
        <strong>${_?i`<${Z} timestamp=${_} />`:$}</strong>
      </div>
      <div style="display:flex; flex-direction:column; gap:8px; margin-top:8px;">
        <span style="font-size:12px; color:#888;">Keeper recent tools</span>
        <div style="display:flex; flex-wrap:wrap; gap:6px;">
          ${s.length>0?s.map(E=>i`<span class="pill">${E}</span>`):i`<span style="font-size:12px; color:#888;">${y}</span>`}
        </div>
      </div>
      ${a.length>0?i`
            <div style="display:flex; flex-direction:column; gap:8px; margin-top:8px;">
      ...
      <div style="display:flex; flex-direction:column; gap:8px; margin-top:8px;">
        ...
        <div style="display:flex; flex-wrap:wrap; gap:6px;">
          ${n.length>0?n.map(E=>i`<span class="pill">${Og(E.action_type)}</span>`):i`<span style="font-size:12px; color:#888;">operator action 광고 없음</span>`}
        </div>
      </div>
    </div>
  `}function Wd(){const t=new URLSearchParams(window.location.search),e=t.get("agent")??t.get("agent_name"),n=localStorage.getItem("masc_dashboard_agent_name");return(e??n??"dashboard").trim()||"dashboard"}async function Yg(){try{const t=await bs({actor:Wd(),action_type:"social_sweep",target_type:"room",payload:{}}),e=Ic(t.result);await ks();const n=(e==null?void 0:e.last_system_skip_reason)??(e==null?void 0:e.skipped_reason);n?O(n,"warning"):O(e?`Social sweep finished: ${e.acted}/${e.checked} acted`:"Social sweep finished",e&&e.acted>0?"success":"warning")}catch(t){const e=t instanceof Error?t.message:"Failed to run social sweep";O(e,"error")}}function Xg({keeper:t}){return i`
  ...
  `}function Qg(){var e,n,s;const t=fr.value;return t?i`
    <div
    ...
    >
      <div style="max-width:780px; width:100%; max-height:90vh; overflow-y:auto; background:#1a1a2e; border-radius:16px; border:1px solid rgba(255,255,255,0.08); padding:24px;">
        ...
        <div style="display:grid; grid-template-columns:1fr 1fr; gap:16px; margin-top:16px;">
          ...
          ${t.trpg_stats?i`
              <${z} title="TRPG Stats">
                <${Hg} stats=${t.trpg_stats} />
              <//>
            `:null}

          ${""}
          ${t.inventory&&t.inventory.length>0?i`
              <${z} title="Equipment (${t.inventory.length})">
          ...
          ${t.relationships&&Object.keys(t.relationships).length>0?i`
              <${z} title="Relationships (${Object.keys(t.relationships).length})">
                <${Gg} rels=${t.relationships} />
              <//>
            `:null}

          <${z} title="Runtime Signals">
            <${Jg} keeper=${t} />
          <//>

          <${z} title="Neighborhood & Tool Audit">
            <${Vg} keeper=${t} />
          <//>

          <${z} title="Memory & Context">
            <div class="keeper-signal-list">
              <div class="keeper-signal-row">
  ...
  `:null}function Zg({cluster:t,project:e,room:n,generatedAt:s}){return i`
  ...
  `}function t$(){const t=ad.value,e=Tt((t==null?void 0:t.status)??(Me.value?"bad":"warn")),n=!t||t.sections.length===0,s=(t==null?void 0:t.status)==="error"||(t==null?void 0:t.status)==="unavailable"&&!(t!=null&&t.cached);return i`
    <${z} title="판단 레이어" class="mission-briefing-card" semanticId="mission.llm_briefing">
                ...
                <article class="mission-briefing-section ${Tt(a.status)}">
                  <div class="mission-card-head">
                    ...
                    <div class="mission-briefing-section-chips">
                      <span class="command-chip ${Tt(a.status)}">${Et(a.status)}</span>
  ...
  `}function e$({item:t,selected:e,sessionLookup:n}){const s=Vf(t),a=t.related_session_ids.map(l=>n.get(l)).filter(l=>l!=null),o=t.top_action??null;return i`
    <article class="mission-attention-card ${Tt((o==null?void 0:o.severity)??t.severity)} ${e?"is-selected":""}">
      <button class="mission-card-select" onClick=${()=>Qf(t.id)}>
        <div class="mission-card-head">
          <div>
            <strong>${t.summary}</strong>
            <div class="mission-card-target">${qa(t.target_type)}${t.target_id?` · ${t.target_id}`:""}</div>
          </div>
          <span class="command-chip ${Tt((o==null?void 0:o.severity)??t.severity)}">${o?Gf(o):t.severity}</span>
        </div>
  ...
  `}function n$({brief:t,selected:e}){var d,p;const n=t.member_previews.slice(0,4),s=t.top_recommendation??null,a=t.top_attention??null,o=t.active_count??0,l=t.seen_count??o,c=t.planned_count??t.member_names.length;return i`
    <article class="mission-crew-card ${Tt(((d=t.top_attention)==null?void 0:d.severity)??t.health??t.status)} ${e?"is-selected":""}">
      <button class="mission-card-select" onClick=${()=>wd(t.session_id)}>
        <div class="mission-card-head">
          ...
          <span class="command-chip ${Tt(((p=t.top_attention)==null?void 0:p.severity)??t.health??t.status)}">${Et(t.status)}</span>
        </div>
        ...
        <div class="mission-fact-grid">
          ...
          <div class="mission-fact-tile">
            <span>가동 시간</span>
            <strong>${Wf(t.elapsed_sec)}</strong>
  ...
  `}function s$({detail:t,loading:e,error:n}){if(e&&!t)return i`
      <${z} title="세션 상세" class="mission-list-card">
    ...
    <${z} title="세션 상세" class="mission-list-card" semanticId="mission.session_detail">
      <div class="mission-section-head">
        <h3>${s.goal}</h3>
    ...
    <article class="mission-activity-card ${Tt(t.brief.status??((o=t.keeper)==null?void 0:o.status))}">
      <button class="mission-card-select" onClick=${()=>{t.keeper&&Hd(t.keeper)}}>
        <div class="mission-activity-head">
          ...
          <span class="command-chip ${Tt(t.brief.status??((d=t.keeper)==null?void 0:d.status))}">${Et(t.brief.status??((p=t.keeper)==null?void 0:p.status))}</span>
        </div>
  ...
  `}function i$({item:t}){const e=t.action??null,n=t.attention??null;return i`
  ...
  `}function Ll(){var C,M;const t=xs.value;if(go.value&&!t)return i`<div class="loading-indicator">상황판 스냅샷 불러오는 중...</div>`;if(Aa.value&&!t)return i`<div class="empty-state error">${Aa.value}</div>`;if(!t)return i`<div class="empty-state">상황판 스냅샷이 아직 없습니다.</div>`;te.value&&!t.attention_queue.some(I=>I.id===te.value)&&(te.value=null);const e=t.sessions;ce.value&&!e.some(I=>I.session_id===ce.value)&&(ce.value=null);const n=t.attention_queue.find(I=>I.id===te.value)??null,s=(n==null?void 0:n.related_session_ids.find(I=>e.some(H=>H.session_id===I)))??null,a=ce.value??s??((C=e[0])==null?void 0:C.session_id)??null,o=Xf(),l=e.find(I=>I.session_id===a)??null,c=t.keeper_briefs.slice(0,6).map(Yf),d=t.attention_queue.filter(I=>I.related_session_ids.length>0).slice(0,6),p=t.internal_signals.slice(0,3),_=e.filter(I=>I.top_attention!=null||I.related_attention_count>0).length,v=e.filter(I=>!!I.blocker_summary).length,f=e.filter(I=>!!I.last_event_summary||!!I.last_event_at).length,h=new Set,T=new Set;for(const I of e)for(const H of I.member_previews??[])h.add(H.agent_name),H.recent_output_preview&&T.add(H.agent_name);const k=h.size,S=T.size,$=c.filter(I=>{const H=(I.brief.status??"").trim().toLowerCase();return H!==""&&H!=="ok"}).length,y=e.filter(I=>{const H=I.member_previews??[];return H.length===0||H.every(Y=>!Y.recent_output_preview)}).length,R=((l==null?void 0:l.member_previews)??[]).filter(I=>I.recent_output_preview),P=c.filter(I=>I.recentOutput).slice(0,4);return et(()=>{Tv(a)},[a]),i`
    <section class="dashboard-panel mission-view">
      ...
      <div class="panel-header">
        ...
        <div class="mission-header-meta">
          <span class="command-chip ${Tt(t.summary.room_health)}">${Et(t.summary.room_health)}</span>
      ...
      <div class="mission-stat-grid">
        ...
        <${Ae}
          ...
          value=${S}
          detail=${k>0?`participant preview ${k}명 중`:"participant preview 없음"}
          tone=${S>0?"ok":"warn"}
        />
        <${Ae}
          label="비-ok 키퍼"
      ...
      ${a?i`
            <div class="mission-selection-bar">
              ...
              <button class="control-btn ghost" onClick=${Zf}>선택 해제</button>
            </div>
          `:null}

      <${z} title="진행중인 세션" class="mission-list-card" semanticId="mission.session_briefs">
        <div class="mission-section-head">
          <h3>지금 진행중인 일</h3>
        ...
        <div class="mission-list-stack">
          ${e.length>0?e.map(I=>i`<${n$} key=${I.session_id} brief=${I} selected=${a===I.session_id} />`):i`<div class="empty-state">지금 활성 세션이 없습니다.</div>`}
        </div>
      <//>
      ...
      <${z} title="키퍼 연속성" class="mission-list-card" semanticId="mission.keeper_activity">
        <div class="mission-section-head">
        ...
        <div class="mission-activity-list">
          ${c.length>0?c.map(I=>i`<${a$} key=${I.brief.name} row=${I} />`):i`<div class="empty-state">지금 보이는 키퍼가 없습니다.</div>`}
        </div>
        <div class="mission-card-actions">
      ...
      <${z} title="최근 사회 활동" class="mission-list-card" semanticId="mission.session_activity">
        <div class="mission-section-head">
          <h3>누가 방금 무엇을 했나</h3>
      ...
      <${z} title="세션 우선순위" class="mission-list-card" semanticId="mission.attention_queue">
        <div class="mission-section-head">
        ...
        <div class="mission-lane-stack">
          ${d.length>0?d.map(I=>i`<${e$} key=${I.id} item=${I} selected=${te.value===I.id} sessionLookup=${o} />`):i`<div class="empty-state">지금 세션 단위 주의 대기열은 비어 있습니다.</div>`}
        </div>
      <//>
      ...
      <div class="mission-human-grid">
        ...
        <${z} title="운영 보조 진단" class="mission-list-card" semanticId="mission.internal_signals">
          <div class="mission-section-head">
            <h3>시스템 진단</h3>
          ...
          <details class="mission-card-disclosure">
            ...
            <div class="mission-list-stack">
              ${p.length>0?p.map(I=>i`<${i$} key=${I.id} item=${I} />`):i`<div class="empty-state">지금은 내부 진단 경고가 없습니다.</div>`}
            </div>
          </details>
        <//>
      </div>
    </section>
  `}const o$="modulepreload",r$=function(t){return"/dashboard/"+t},Pl={},l$=function(e,n,s){let a=Promise.resolve();if(n&&n.length>0){let l=function(p){return Promise.all(p.map(_=>Promise.resolve(_).then(v=>({status:"fulfilled",value:v}),v=>({status:"rejected",reason:v}))))};document.getElementsByTagName("link");const c=document.querySelector("meta[property=csp-nonce]"),d=(c==null?void 0:c.nonce)||(c==null?void 0:c.getAttribute("nonce"));a=l(n.map(p=>{if(p=r$(p),p in Pl)return;Pl[p]=!0;const _=p.endsWith(".css"),v=_?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${p}"]${v}`))return;const f=document.createElement("link");if(f.rel=_?"stylesheet":o$,_||(f.as="script"),f.crossOrigin="",f.href=p,d&&f.setAttribute("nonce",d),document.head.appendChild(f),_)return new Promise((h,T)=>{f.addEventListener("load",h),f.addEventListener("error",()=>T(new Error(`Unable to preload CSS for ${p}`)))})}))}function o(l){const c=new Event("vite:preloadError",{cancelable:!0});if(c.payload=l,window.dispatchEvent(c),!c.defaultPrevented)throw l}return a.then(l=>{for(const c of l||[])c.status==="rejected"&&o(c.reason);return e().catch(o)})};function is(t){if(t==null)return"";if(typeof t=="string")return t;try{return JSON.stringify(t,null,2)}catch{return String(t)}}function Q(t){if(!t)return"정보 없음";const e=Date.parse(t);if(Number.isNaN(e))return t;const n=Math.max(0,Math.round((Date.now()-e)/1e3));return n<60?`${n}초 전`:n<3600?`${Math.round(n/60)}분 전`:n<86400?`${Math.round(n/3600)}시간 전`:`${Math.round(n/86400)}일 전`}function c$(t){if(!t)return"warn";const e=Date.parse(t);return Number.isNaN(e)?"warn":e<=Date.now()?"bad":"ok"}function Gd(t){if(!t)return"정보 없음";const e=Date.parse(t);if(Number.isNaN(e))return t;const n=Math.round((e-Date.now())/1e3);return n<=0?"기한 지남":n<60?`${n}초 후`:n<3600?`${Math.round(n/60)}분 후`:n<86400?`${Math.round(n/3600)}시간 후`:`${Math.round(n/86400)}일 후`}function N(t){return t==="bad"?"bad":t==="warn"||t==="pending"?"warn":"ok"}let zl=!1,d$=0;function u$(){return++d$}let Ci=null;async function p$(){Ci||(Ci=l$(()=>import("./mermaid.core-AnOuZa-X.js").then(e=>e.bE),[]).then(e=>e.default));const t=await Ci;return zl||(t.initialize({startOnLoad:!1,theme:"dark",securityLevel:"loose"}),zl=!0),t}function ve(t){if(!t)return"warn";const e=t.toLowerCase();return e.includes("failed")||e.includes("error")||e.includes("disconnected")||e.includes("stopped")?"bad":e.includes("running")||e.includes("active")||e.includes("degraded")||e.includes("pending")?"warn":"ok"}function Tn(t){return typeof t!="number"||!Number.isFinite(t)?"정보 없음":`${Math.round(t*100)}%`}function en(t){return typeof t!="number"||!Number.isFinite(t)?"정보 없음":t<60?`${Math.round(t)}초`:t<3600?`${Math.round(t/60)}분`:`${Math.round(t/3600)}시간`}function Rs(t){return typeof t!="number"||!Number.isFinite(t)?0:Math.max(0,Math.min(100,t))}function Te(t,e){return typeof t!="number"||!Number.isFinite(t)||typeof e!="number"||!Number.isFinite(e)||e<=0?0:Rs(t/e*100)}function m$(t,e){const n=Rs(t);return`--gauge-angle:${Math.max(10,Math.round(n/100*360))}deg;--gauge-color:${e};`}function li(t){if(!t)return"최근 체인 이력이 없습니다";const e=[t.event];return typeof t.duration_ms=="number"&&e.push(`${t.duration_ms}ms`),typeof t.tokens=="number"&&e.push(`토큰 ${t.tokens}`),t.message&&e.push(t.message),e.join(" · ")}const _$=[{id:"status",label:"현황"},{id:"history",label:"이력"},{id:"control",label:"통제"}],Jd=[{id:"warroom",label:"워룸",group:"status"},{id:"summary",label:"요약",group:"status"},{id:"topology",label:"토폴로지",group:"status"},{id:"orchestra",label:"오케스트라",group:"status"},{id:"swarm",label:"스웜",group:"status"},{id:"operations",label:"작전",group:"history"},{id:"trace",label:"트레이스",group:"history"},{id:"chains",label:"체인",group:"history"},{id:"control",label:"제어",group:"control"},{id:"alerts",label:"알림",group:"control"}],v$=Jd.map(t=>t.id),f$=["chain_start","node_start","node_complete","chain_complete","chain_error"],g$={warroom:{title:"실시간 워룸",description:"실제 실행, 워커, 메시지, 트레이스를 한 화면에서 따라가는 기본 진입 표면입니다."},operations:{title:"현재 작전 상세",description:"활성 작전, 분견대, 의존 관계를 먼저 읽는 기본 진입 표면입니다."},orchestra:{title:"룸 오케스트라 맵",description:"룸, 세션, 레인, 워커, 키퍼를 한 장의 작전판으로 읽는 시각화 표면입니다."},swarm:{title:"스웜 실행 흐름",description:"레인 이동, 워커 결속, 막힘을 따라가며 현장감 있게 보는 표면입니다."},chains:{title:"체인 런타임",description:"체인 연결 상태와 작전별 실행 그래프를 확인하는 표면입니다."},topology:{title:"지휘 계층",description:"실제 관리 유닛인지, 실시간 에이전트 기반 자동 투영인지 구분해서 봅니다."},alerts:{title:"경보 모음",description:"지금 개입을 밀어올리는 alert만 모아서 보는 표면입니다."},trace:{title:"최근 트레이스",description:"작전, 주체, 유닛 단위 이벤트를 시간순으로 보는 표면입니다."},control:{title:"승인과 제어",description:"결정 승인과 유닛 제어를 실제로 수행하는 표면입니다."},summary:{title:"지휘 요약",description:"전체 지휘면을 한 번에 훑는 계기판 성격의 요약 표면입니다."}};function El(t){return!!t&&v$.includes(t)}function $$(){const t=F.value.params;return t.source!=="mission"&&t.source!=="execution"?{}:{source:t.source,...t.action_type?{action_type:t.action_type}:{},...t.target_type?{target_type:t.target_type}:{},...t.target_id?{target_id:t.target_id}:{},...t.focus_kind?{focus_kind:t.focus_kind}:{},...t.operation_id?{operation_id:t.operation_id}:{}}}function Ms(t){const e=$$(),n=Xd(),s=gr();if(t==="operations")return e;if(t==="chains"){const a=mn.value;return a?{...e,surface:t,operation:a}:{...e,surface:t}}return t==="swarm"||t==="warroom"||t==="orchestra"?{...e,surface:t,...n?{run_id:n}:{},...s?{operation_id:s}:{}}:{...e,surface:t}}function h$(){const t=new URLSearchParams(window.location.search),e=new URLSearchParams,n=t.get("agent")??t.get("agent_name"),s=t.get("token");return n&&e.set("agent",n),s&&e.set("token",s),e.toString()?`/api/v1/chains/events?${e.toString()}`:"/api/v1/chains/events"}function y$(t){switch(t){case"company":return"중대";case"platoon":return"소대";case"squad":return"분대";case"agent":return"에이전트";default:return t}}function ut(t){return yo.value===t}function Ls(){return sr.value}function b$(t){var a,o,l,c,d,p,_;const e=sr.value,n=He.value,s=Cs.value;switch(t){case"warroom":return{tool:"masc_observe_operations",reason:"실시간 실행, 워커, 메시지, 트레이스를 한 화면에서 보고 필요한 세부 표면으로 바로 이동합니다."};case"operations":return{tool:"masc_operation_status",reason:`활성 작전 ${((a=e==null?void 0:e.operations.summary)==null?void 0:a.active)??0}개와 의존 관계를 먼저 확인합니다.`};case"swarm":return{tool:(n==null?void 0:n.recommended_next_tool)??((l=(o=e==null?void 0:e.swarm_status)==null?void 0:o.recommended_next_action)==null?void 0:l.tool)??"masc_observe_traces",reason:((d=(c=e==null?void 0:e.swarm_status)==null?void 0:c.recommended_next_action)==null?void 0:d.reason)??"레인 이동과 막힘 근거를 보고 다음 확인 도구를 고릅니다."};case"orchestra":return{tool:"masc_operator_snapshot",reason:"룸, 세션, 레인, 워커, 키퍼를 한 장에서 훑은 뒤 내려볼 대상을 고릅니다."};case"chains":return{tool:(_=(p=s==null?void 0:s.operations[0])==null?void 0:p.preview_run)!=null&&_.chain_id?"masc_chain_run_get":"masc_chain_snapshot",reason:"체인 연결 상태와 최근 run 그래프를 함께 보면 병목을 빨리 좁힐 수 있습니다."};case"topology":return{tool:"masc_observe_topology",reason:"이 구조가 실제 관리 단위인지 자동 투영인지 먼저 구분해야 지휘면을 오해하지 않습니다."};case"alerts":return{tool:"masc_observe_alerts",reason:"경보에서 먼저 문제가 된 유닛과 작전을 고릅니다."};case"trace":return{tool:"masc_observe_traces",reason:"트레이스 흐름으로 원인 이벤트를 바로 따라갈 수 있습니다."};case"control":return{tool:"masc_operator_action",reason:"승인이나 kill switch 같은 실제 조작은 제어 표면과 operator action이 이어집니다."};case"summary":default:return{tool:"masc_observe_operations",reason:"요약을 본 뒤에는 현재 작전 표면으로 내려가 실제 움직임을 확인하는 게 가장 빠릅니다."}}}function k$(t){var n;const e=((n=t==null?void 0:t.focus_kind)==null?void 0:n.toLowerCase())??"";return e?e.includes("artifact_scope")||e.includes("routing_confidence")||e.includes("cache_contention")?"microarch":e.includes("leader_offline")||e.includes("roster_offline")?"alerts":e.includes("stale_data")?"swarm":null:null}function x$(t){var n;const e=((n=t==null?void 0:t.focus_kind)==null?void 0:n.toLowerCase())??"";return e?e.includes("stale_data")||e.includes("leader_offline")||e.includes("roster_offline")||e.includes("managed")?"recommendation":e.includes("gap")?"gaps":null:null}function Vd(){if(typeof window>"u")return null;const t=new URLSearchParams(window.location.search),e=t.get("agent")??t.get("agent_name");if(!e)return null;const n=e.trim();return n===""?null:n}function Yd(){if(typeof window>"u")return new URLSearchParams;const t=new URLSearchParams(window.location.search),e=window.location.hash.replace(/^#/,""),n=e.indexOf("?");return n>=0&&new URLSearchParams(e.slice(n+1)).forEach((a,o)=>{t.has(o)||t.set(o,a)}),t}function Xd(){const e=Yd().get("run_id");if(!e)return null;const n=e.trim();return n===""?null:n}function gr(){const e=Yd().get("operation_id");if(!e)return null;const n=e.trim();return n===""?null:n}function S$(t){if(!t)return null;const e=Date.parse(t);return Number.isNaN(e)?null:Math.max(0,Math.round((Date.now()-e)/1e3))}function C$(t){return t.status==="claimed"||t.status==="in_progress"}function A$(t){const e=Ss.value;if(!e)return null;for(const n of e.golden_paths){const s=n.steps.find(a=>a.tool===t);if(s)return s}return null}function Ai(t){var e;return((e=Ss.value)==null?void 0:e.golden_paths.find(n=>n.id===t))??null}function T$(t){const e=Ss.value;if(!e)return[];const n=new Set(t);return e.pitfalls.filter(s=>n.has(s.id))}async function fe(t){try{await t()}catch{}}function $r(t){return(t==null?void 0:t.trim().toLowerCase())??""}function de(t){const e=$r(t);return e.includes("failed")||e.includes("error")||e.includes("stopped")||e==="paused"?"bad":e.includes("active")||e.includes("running")||e.includes("healthy")||e.includes("ok")?"ok":"warn"}function Ft(t){const e=$r(t);return e?e==="active"||e==="running"?"진행 중":e==="paused"?"일시정지":e==="done"||e==="ended"||e==="completed"?"완료":e==="failed"||e==="error"||e==="stopped"?"문제":(t==null?void 0:t.trim())||"확인 필요":"확인 필요"}function I$(){var n,s,a,o,l,c,d,p,_;const t=He.value;if(!t)return!1;const e=t.workers.some(v=>v.joined||v.live_presence||v.completed||v.current_task_matches_run||v.heartbeat_fresh||v.claim_marker_seen||v.done_marker_seen||v.final_marker_seen||!!v.current_task||!!v.bound_task_id||!!v.last_message);return!!((n=t.operation)!=null&&n.operation_id||(s=t.detachment)!=null&&s.detachment_id||(((a=t.summary)==null?void 0:a.joined_workers)??0)>0||(((o=t.summary)==null?void 0:o.live_workers)??0)>0||(((l=t.summary)==null?void 0:l.current_task_bound)??0)>0||(((c=t.summary)==null?void 0:c.fresh_heartbeats)??0)>0||(((d=t.summary)==null?void 0:d.claim_markers_seen)??0)>0||(((p=t.summary)==null?void 0:p.done_markers_seen)??0)>0||(((_=t.summary)==null?void 0:_.final_markers_seen)??0)>0||e||t.recent_messages.length>0||t.recent_trace_events.length>0)}function R$(t){const e=$r(t.status);return e==="active"||e==="running"}function M$(){var o,l,c,d;const t=((o=It.value)==null?void 0:o.sessions)??[],e=He.value,n=((l=e==null?void 0:e.detachment)==null?void 0:l.session_id)??null;if(n){const p=t.find(_=>_.session_id===n);if(p)return p}const s=((c=e==null?void 0:e.operation)==null?void 0:c.operation_id)??gr();if(s){const p=t.find(_=>_.command_plane_operation_id===s);if(p)return p}const a=((d=e==null?void 0:e.detachment)==null?void 0:d.detachment_id)??null;if(a){const p=t.find(_=>_.command_plane_detachment_id===a);if(p)return p}return t.find(R$)??t[0]??null}function Ln(t){return t==="proven"?"ok":t==="partial"?"warn":"bad"}function nn(t){return Array.isArray(t)?t:[]}function wt(t){return typeof t=="object"&&t!==null&&!Array.isArray(t)?t:{}}function Os(t){return typeof t=="string"&&t.trim()!==""?t:null}function L$(t){return typeof t=="number"&&Number.isFinite(t)?t:null}function P$(t){const e=t.split("/");return e.length<=3?t:`…/${e.slice(-3).join("/")}`}function z$(t){return t==="proven"?"충분":t==="partial"?"부분":"부족"}function E$(t){return t==="proven"?"협업 증거가 충분합니다":t==="partial"?"흔적은 있으나 협업 증거가 덜 모였습니다":"증거가 부족합니다"}function N$(t,e,n,s,a,o,l,c,d){const p=[`${s}명이 실제 흔적을 남겼고, 계획된 참여자는 ${a}명입니다.`,l>0?`서로를 참조한 상호작용 증거가 ${l}건 있습니다.`:"서로를 참조한 명시적 상호작용 증거가 아직 없습니다.",c>0?`도구·산출물·체크포인트 증거가 ${c}건 있습니다.`:"도구·산출물·체크포인트 증거가 거의 없습니다.",d>0?`CPv2 backing trace가 ${d}건 있어 실행 흔적은 남아 있습니다.`:"관리형 backing trace는 아직 없습니다."];return n==="proven"&&e==="insufficient"?[p[0]??"","왜 이렇게 판정됐나: 과거 proof는 proved였지만, 현재 보이는 live evidence는 부족해서 partial로 완화했습니다.","다음 보강 포인트: 최근 응답 턴이나 도구 호출을 다시 남겨 historical proof를 현재 상태와 연결해야 합니다."]:n==="proven"&&e==="partial"?[p[0]??"","왜 이렇게 판정됐나: historical proof는 강하지만, 현재 live evidence는 아직 partial 수준입니다.","다음 보강 포인트: 최근 상호작용과 실행 근거를 더 남기면 proven으로 회복할 수 있습니다."]:t==="partial"?[p[0]??"",o>0?`partial인 이유: 호출되었지만 응답하지 않은 참여자가 ${o}명 있습니다.`:l===0?"partial인 이유: 여러 흔적은 있지만 actor 간 상호작용이 직접 보이지 않습니다.":"partial인 이유: 일부 증거는 있으나 proven 기준을 모두 채우지 못했습니다.",d>0?"다음 보강 포인트: 응답 턴이나 도구 호출을 남기면 proof가 협업 수준으로 올라갑니다.":"다음 보강 포인트: 관리형 trace 또는 산출물 연결을 더 남기면 근거가 강해집니다."]:t==="proven"?[p[0]??"","결론: 참여, 상호작용, 산출물, backing evidence가 모두 연결돼 있습니다.","다음 행동: raw evidence는 접어두고 결과 산출물과 다음 실행 결정만 확인하면 됩니다."]:[p[0]??"",o>0?`결론: 협업 시도는 있었지만 무응답 참여자가 ${o}명 있어 협업 증거로 인정하기 어렵습니다.`:"결론: 기록은 있으나 협업을 증명할 만큼의 연결 증거가 부족합니다.",c>0?"다음 보강 포인트: 응답 턴과 도구 근거를 서로 연결해 남겨야 합니다.":"다음 보강 포인트: 참여자 간 턴, 도구 근거, 산출물 연결을 더 남겨야 합니다."]}function j$(t){return t==="historical_only"?"historical only":t==="live_and_historical"?"live + historical":"live"}function Nl(t){return(t==null?void 0:t.mode)==="requested_not_found"?"bad":(t==null?void 0:t.mode)==="latest_auto_selected"?"warn":"ok"}function w$(t){return(t==null?void 0:t.mode)==="requested_not_found"?"선택 실패":(t==null?void 0:t.mode)==="latest_auto_selected"?"자동 선택":(t==null?void 0:t.mode)==="explicit"?"명시 선택":"선택 없음"}function O$(t){return t.activity_state==="acted"?(t.interaction_count??0)>0||(t.tool_evidence_count??0)>0?"ok":"warn":t.activity_state==="mentioned_only"?"warn":"bad"}function D$(t){return t.activity_state==="acted"?"실제 흔적":t.activity_state==="mentioned_only"?"호출만 됨":"계획만 됨"}function q$(t){if(t.activity_state==="acted")return`턴 ${t.turn_count??0} · spawn ${t.spawn_count??0} · 도구 근거 ${t.tool_evidence_count??0}`;if(t.activity_state==="mentioned_only"){const e=t.requested_by?`호출자 ${t.requested_by}`:"호출자 미상";return`호출 ${t.mention_count??0}회 · ${e}`}return"계획된 참여자이지만 아직 이벤트가 없습니다."}function jl(t){return Array.isArray(t.tool_names)?t.tool_names:[]}function F$({selection:t,summary:e}){if(!t||t.mode==="explicit")return null;const n=t.mode==="latest_auto_selected"&&(e==null?void 0:e.historical_verdict)==="proven"&&(e==null?void 0:e.live_verdict)!=="proven";return i`
  ...
  `}function B$(t){const e=new Map;for(const n of t){const s=[n.timestamp??"",n.event_type??"",n.actor??"",n.summary??""].join("|"),a=n.source??"unknown",o=e.get(s);if(o){o.sources.includes(a)||o.sources.push(a),!o.operation_id&&n.operation_id&&(o.operation_id=n.operation_id);continue}e.set(s,{...n,sources:[a]})}return[...e.values()]}function U$(t){return t.sources.length===2?"세션 + 지휘":t.sources.length===1?t.sources[0]==="unknown"?"출처 미상":t.sources[0]??"출처":t.sources.join(" + ")}function H$(t){const e=[];for(const[n,s]of Object.entries(t))if(s!=null){if(typeof s=="string"){if(s.trim()==="")continue;e.push({label:n,value:s});continue}if(typeof s=="number"||typeof s=="boolean"){e.push({label:n,value:String(s)});continue}}return e}function W$(t){const e=wt(t),n=wt(e.traces),s=Array.isArray(n.events)?n.events:[],a=wt(e.detachments),o=Array.isArray(a.detachments)?a.detachments:[],l=wt(o[0]),c=wt(l.detachment),d=wt(l.operation),p=wt(e.summary),_=wt(p.operations),v=wt(_.summary);return[{label:"작전",value:Os(e.operation_id)??"없음"},{label:"분견대",value:Os(e.detachment_id)??"없음"},{label:"트레이스 이벤트",value:`${s.length}`},{label:"분견대 상태",value:Os(c.status)??"없음"},{label:"작전 단계",value:Os(d.stage)??"없음"},{label:"활성 작전",value:`${L$(v.active)??0}`}]}function G$({item:t}){return i`
  ...
  `}function J$({item:t}){const e=t.recent_output_preview??null,n=t.recent_input_preview??null,s=t.recent_event_summary??null,a=t.recent_request_preview??null,o=t.last_active_at??t.recent_request_at??null;return i`
  ...
  `}function Y$(){var G,L,x;const t=F.value.params,e=t.session_id??null,n=t.operation_id??null;et(()=>{pd(e,n)},[e,n]);const s=ud.value;if(ho.value&&!s)return i`<section class="dashboard-panel"><div class="loading-indicator">근거 화면 불러오는 중…</div></section>`;if(Ze.value&&!s)return i`<section class="dashboard-panel"><div class="error-card">${Ze.value}</div></section>`;const a=s==null?void 0:s.summary,o=(s==null?void 0:s.selection)??null,l=nn(s==null?void 0:s.actor_contributions),c=nn(s==null?void 0:s.artifacts),d=nn(s==null?void 0:s.tool_evidence),p=(s==null?void 0:s.proof_verdict)??"insufficient",_=(a==null?void 0:a.live_verdict)??p,v=(a==null?void 0:a.historical_verdict)??null,f=(a==null?void 0:a.verdict_basis)??"live",h=(s==null?void 0:s.cp_backing_evidence)??null,T=Array.isArray((G=h==null?void 0:h.traces)==null?void 0:G.events)?((x=(L=h.traces)==null?void 0:L.events)==null?void 0:x.length)??0:0,k=(a==null?void 0:a.actors_count)??l.length,S=(a==null?void 0:a.planned_actor_count)??l.length,$=(a==null?void 0:a.unanswered_actor_count)??l.filter(E=>E.activity_state!=="acted"&&(E.mention_count??0)>0).length,y=(a==null?void 0:a.mentioned_actor_count)??l.filter(E=>(E.mention_count??0)>0).length,R=(a==null?void 0:a.interaction_count)??0,P=(a==null?void 0:a.evidence_count)??0,C=B$(nn(s==null?void 0:s.timeline)),M=H$(wt(s==null?void 0:s.goal_binding)),I=W$(h),H=c.filter(E=>E.exists).length,Y=c.length-H,tt=N$(p,_,v,k,S,$,R,P,T);return i`
    <section class="dashboard-panel mission-view">
      <${At} surfaceId="proof" />
      <div class="panel-header">
        <div>
        ...
        <div class="mission-header-meta">
          <span class="command-chip ${Ln(p)}">${z$(p)}</span>
      ...
      <div class="mission-stat-grid">
        ...
        <div class="summary-stat-card ${S>k?"warn":"ok"}">
          <span>계획된 참여자</span>
          <strong>${S}</strong>
        ...
        <div class="summary-stat-card ${P>0?"ok":"warn"}">
          <span>근거</span>
          <strong>${P}</strong>
        ...
        <div class="summary-stat-card ${Y===0&&c.length>0?"ok":"warn"}">
          <span>산출물</span>
          <strong>${H}/${c.length}</strong>
          <small>${Y>0?`${Y}개 누락`:"전부 존재함"}</small>
        </div>
      </div>

      <div class="mission-human-grid">
        <${z} title="3줄 근거 요약" class="mission-list-card" semanticId="proof.summary">
          <div class="mission-section-head">
            <h3>핵심 증명</h3>
          ...
          <div class="proof-summary-stack">
            ${tt.map((E,J)=>i`
              <article class="proof-summary-block ${J===1&&p!=="proven"?Ln(p):""}">
        ...
        <${z} title="목표 연결" class="mission-list-card" semanticId="proof.goal_binding">
          <div class="mission-section-head">
            <h3>무엇을 증명하려는가</h3>
      ...
      <div class="mission-human-grid">
        <${z} title="협업 타임라인" class="mission-list-card" semanticId="proof.timeline">
          <div class="mission-section-head">
            <h3>협업 타임라인</h3>
            <p>team-session과 command-plane에서 같은 사건이 보이면 한 줄로 묶어 읽습니다.</p>
          </div>
          <div class="mission-list-stack">
            ${C.length>0?C.slice(0,18).map(E=>i`<${G$} key=${E.id} item=${E} />`):i`<div class="empty-state">표시할 타임라인 근거가 없습니다.</div>`}
          </div>
        <//>

        <${z} title="참여 흔적" class="mission-list-card" semanticId="proof.contributions">
          <div class="mission-section-head">
            <h3>누가 무엇을 남겼는가</h3>
            <p>실제 흔적, 호출만 된 참여자, 계획만 된 참여자를 구분해서 봅니다.</p>
          </div>
          <div class="mission-activity-list">
            ${l.length>0?l.map(E=>i`<${J$} key=${E.actor} item=${E} />`):i`<div class="empty-state">표시할 참여 흔적이 없습니다.</div>`}
          </div>
        <//>
      </div>

      <div class="mission-human-grid">
        <${z} title="도구 근거" class="mission-list-card" semanticId="proof.tool_evidence">
          <div class="mission-section-head">
            <h3>어떤 도구를 언제 썼는가</h3>
            <p>숫자만 보여주지 말고, 최근 도구 호출 근거를 직접 확인합니다.</p>
          </div>
          <div class="mission-list-stack">
            ${d.length>0?d.map((E,J)=>i`<${K$} key=${`${E.actor??"system"}-${J}`} item=${E} />`):i`<div class="empty-state">기록된 tool evidence가 없습니다.</div>`}
          </div>
        <//>

        <${z} title="실행 근거" class="mission-list-card" semanticId="proof.backing">
          <div class="mission-section-head">
    ...
    <section class="room-truth-strip">
      ...
      <article class="room-truth-card">
        ...
        <div class="room-truth-chip-row">
          ...
          <${je} item=${{kind:((_=t.execution)==null?void 0:_.provenance)??"derived"}} />
        </div>
      </article>
      ...
      <article class="room-truth-card room-truth-card-focus">
        ...
        <div class="room-truth-chip-row">
          ...
          <${je} item=${{kind:(c==null?void 0:c.provenance)??((h=l==null?void 0:l.recommendation_summary)==null?void 0:h.provenance)??"derived"}} />
        </div>
        ${c!=null&&c.suggested_tab?i`
              <div class="room-truth-actions">
                <button class="control-btn ghost" onClick=${X$}>
  ...
  `}function Q$(){const t=As(F.value);return t?i`
  ...
  `}function Ds({label:t,value:e,subtext:n,percent:s,color:a}){return i`
    <article class="command-gauge-card">
      <div class="command-gauge-ring" style=${m$(s,a)}>
  ...
  `}function qs({label:t,value:e,detail:n,percent:s,tone:a}){return i`
    <article class="command-signal-rail ${N(a)}">
      ...
      <div class="command-signal-bar">
        <span class="${N(a)}" style=${`width: ${Math.max(8,Math.round(Rs(s)))}%`}></span>
      </div>
      <small>${n}</small>
    </article>
  `}function th(){var Y,tt,G,L;const t=Ls(),e=t==null?void 0:t.topology.summary,n=t==null?void 0:t.operations.summary,s=t==null?void 0:t.detachments.summary,a=t==null?void 0:t.decisions.summary,o=t==null?void 0:t.alerts.summary,l=(Y=t==null?void 0:t.swarm_status)==null?void 0:Y.overview,c=t==null?void 0:t.swarm_proof,d=t==null?void 0:t.operations.microarch,p=(e==null?void 0:e.managed_unit_count)??0,_=(e==null?void 0:e.total_units)??0,v=(n==null?void 0:n.active)??0,f=(s==null?void 0:s.active)??0,h=(l==null?void 0:l.moving_lanes)??0,T=(l==null?void 0:l.active_lanes)??0,k=(c==null?void 0:c.workers.done)??0,S=(c==null?void 0:c.workers.expected)??0,$=(o==null?void 0:o.bad)??0,y=(o==null?void 0:o.warn)??0,R=(a==null?void 0:a.pending)??0,P=(a==null?void 0:a.total)??0,C=v+f,M=((tt=d==null?void 0:d.cache)==null?void 0:tt.l1_hit_rate)??((L=(G=d==null?void 0:d.signals)==null?void 0:G.cache_contention)==null?void 0:L.l1_hit_rate)??0,I=v>0||f>0?"지휘면이 실제로 움직이고 있습니다":"계층은 준비됐지만 실행은 아직 잠복 상태입니다",H=v>0||h>0?"무거운 상세 탭으로 들어가기 전에, 여기서 먼저 압력과 이동감, 운영 부채를 읽을 수 있어야 합니다.":"이 화면은 체크리스트보다 계기판에 가까워야 합니다. 아래 게이지가 지금 어디가 살아 있는지 먼저 보여줍니다.";return i`
    <section class="command-hero command-hero-summary">
      <div class="command-hero-copy">
        ...
        <span class="command-chip ${N(v>0?"ok":"warn")}">활성 작전 ${v}</span>
          <span class="command-chip ${N(h>0?"ok":(T>0,"warn"))}">이동 레인 ${h}/${Math.max(T,h)}</span>
          <span class="command-chip ${N($>0?"bad":y>0?"warn":"ok")}">치명 알림 ${$}</span>
    ...
    <div class="command-guided-layout">
      <section class="card command-section">
        ...
        <div class="command-guide-card highlight command-next-step-card">
          <div class="command-guide-head">
            <strong>${($==null?void 0:$.title)??S}</strong>
          ...
          ${(ie=$==null?void 0:$.success_signals)!=null&&ie.length?i`<div class="command-tag-row">
                ${$.success_signals.map(W=>i`<span class="command-tag ok">${W}</span>`)}
              </div>`:null}
        </div>

        <div class="command-readiness-list">
          ${k.map(W=>i`
            <article class="command-readiness-row ${N(W.tone)}">
              <div>
                <div class="command-readiness-title-row">
                  <strong>${W.title}</strong>
                  <span class="command-chip ${N(W.tone)}">${W.tone}</span>
                </div>
                <p>${W.detail}</p>
              </div>
  ...
  `}function sh(){return i`
    ...
    <${eh} />
    <${nh} />
  `}function ah(){return Ra.value?i`<div class="empty-state">command-plane detail 불러오는 중…</div>`:La.value?i`<div class="empty-state error">${La.value}</div>`:i`<div class="empty-state">surface를 선택하면 command-plane detail을 로드합니다.</div>`}const Ie=g(null),Fs=g("compact"),re=g({zoom:1,panX:0,panY:0}),Ii=g(!1),Ks=g(!1),jn={width:1280,height:760},Qd=.42,Zd=1.9;function da(t,e,n){return Math.max(e,Math.min(n,t))}function yr(t,e){const n=t==null?void 0:t.trim();return n?n.length<=e?n:`${n.slice(0,Math.max(1,e-1))}…`:null}function ih(t){return t==="compact"?"집약":"균형"}function Ol(t){switch((t??"").trim().toLowerCase()){case"room":return"룸";case"session":return"세션";case"operation":return"작전";case"detachment":return"분견대";case"lane":return"레인";case"worker":return"워커";case"keeper":return"키퍼";default:return(t==null?void 0:t.trim())||"노드"}}function Bs(t,e,n){if(t<=0)return[];if(t===1)return[Math.round((e+n)/2)];const s=(n-e)/(t-1);return Array.from({length:t},(a,o)=>Math.round(e+o*s))}function oh(t,e){const n=new Map;for(const s of t){const a=e(s),o=n.get(a)??[];o.push(s),n.set(a,o)}return n}function tu(t){return t==="compact"?{room:{x:660,y:108},sessions:{y:228,min:220,max:1110},operations:{y:338,min:260,max:1050},detachments:{y:430,min:310,max:1e3},lanes:{y:540,min:220,max:1110},worker:{perRow:5,xSpacing:60,ySpacing:52,laneOffsetY:76,freeBaseY:662},keeper:{startX:1180,colSpacing:92,rowSpacing:90,startY:176,columns:2},signalRadius:116}:{room:{x:700,y:112},sessions:{y:236,min:240,max:1140},operations:{y:356,min:300,max:1080},detachments:{y:454,min:340,max:1030},lanes:{y:584,min:230,max:1110},worker:{perRow:4,xSpacing:72,ySpacing:60,laneOffsetY:82,freeBaseY:720},keeper:{startX:1210,colSpacing:108,rowSpacing:102,startY:188,columns:2},signalRadius:132}}function eu(t,e){return t.kind==="room"?e==="compact"?{width:138,height:138,radius:68}:{width:156,height:156,radius:76}:t.kind==="worker"?e==="compact"?{width:70,height:36,radius:18}:{width:84,height:44,radius:22}:t.kind==="lane"?e==="compact"?{width:156,height:48,radius:15}:{width:176,height:56,radius:17}:t.kind==="keeper"?e==="compact"?{width:118,height:50,radius:22}:{width:132,height:60,radius:24}:t.kind==="session"?e==="compact"?{width:182,height:58,radius:17}:{width:202,height:68,radius:18}:e==="compact"?{width:176,height:58,radius:16}:{width:196,height:68,radius:18}}function rh(t,e){const n=t.kind==="worker"?e==="compact"?10:14:t.kind==="keeper"?e==="compact"?12:16:t.kind==="lane"?e==="compact"?16:22:e==="compact"?18:26;return yr(t.label,n)??t.label}function lh(t,e){if(e==="compact"&&(t.kind==="worker"||t.kind==="keeper"||t.kind==="detachment"))return null;const n=t.kind==="session"?e==="compact"?20:28:e==="compact"?14:24;return yr(t.subtitle,n)}function ch(t,e){return e==="compact"&&t.kind!=="session"&&t.kind!=="operation"?null:yr(t.status,e==="compact"?10:14)}function dh(t,e){const n=tu(e),s=new Map,a=t.nodes,o=a.find(k=>k.kind==="room")??null,l=a.filter(k=>k.kind==="session"),c=a.filter(k=>k.kind==="operation"),d=a.filter(k=>k.kind==="detachment"),p=a.filter(k=>k.kind==="lane"),_=a.filter(k=>k.kind==="worker"),v=a.filter(k=>k.kind==="keeper");o&&s.set(o.id,{x:n.room.x,y:n.room.y}),Bs(l.length,n.sessions.min,n.sessions.max).forEach((k,S)=>{const $=l[S];$&&s.set($.id,{x:k,y:n.sessions.y})}),Bs(c.length,n.operations.min,n.operations.max).forEach((k,S)=>{const $=c[S];$&&s.set($.id,{x:k,y:n.operations.y})}),Bs(d.length,n.detachments.min,n.detachments.max).forEach((k,S)=>{const $=d[S];$&&s.set($.id,{x:k,y:n.detachments.y})}),Bs(p.length,n.lanes.min,n.lanes.max).forEach((k,S)=>{const $=p[S];$&&s.set($.id,{x:k,y:n.lanes.y})});const f=new Map(p.map(k=>{const S=s.get(k.id);return S?[k.id,S.x]:null}).filter(k=>k!==null)),h=oh(_,k=>k.lane_id?`lane:${k.lane_id}`:k.parent_id?k.parent_id:"free");let T=0;for(const[k,S]of h){let $=f.get(k.replace(/^lane:/,""));if($==null){const R=s.get(k);$=R==null?void 0:R.x}$==null&&($=260+T%4*180,T+=1);const y=Math.max(1,Math.ceil(S.length/n.worker.perRow));for(let R=0;R<y;R+=1){const P=S.slice(R*n.worker.perRow,(R+1)*n.worker.perRow),C=(P.length-1)*n.worker.xSpacing,M=$-C/2;P.forEach((I,H)=>{var Y;s.set(I.id,{x:Math.round(M+H*n.worker.xSpacing),y:k==="free"?n.worker.freeBaseY+R*n.worker.ySpacing:(((Y=s.get(k.replace(/^lane:/,"")))==null?void 0:Y.y)??n.lanes.y)+n.worker.laneOffsetY+R*n.worker.ySpacing})})}}return v.forEach((k,S)=>{const $=S%n.keeper.columns,y=Math.floor(S/n.keeper.columns);s.set(k.id,{x:n.keeper.startX+$*n.keeper.colSpacing,y:n.keeper.startY+y*n.keeper.rowSpacing})}),s}function uh(t,e,n){if(!e||t.signals.length===0)return[];const s=tu(n);return t.signals.slice(0,6).map((a,o)=>{const l=(-130+o*36)*(Math.PI/180);return{signalNode:a,x:Math.round(e.x+Math.cos(l)*s.signalRadius),y:Math.round(e.y+Math.sin(l)*s.signalRadius)}})}function ph(t,e,n,s){let a=Number.POSITIVE_INFINITY,o=Number.NEGATIVE_INFINITY,l=Number.POSITIVE_INFINITY,c=Number.NEGATIVE_INFINITY;for(const d of t.nodes){const p=e.get(d.id);if(!p)continue;const _=eu(d,s);d.kind==="room"?(a=Math.min(a,p.x-_.radius),o=Math.max(o,p.x+_.radius),l=Math.min(l,p.y-_.radius),c=Math.max(c,p.y+_.radius)):(a=Math.min(a,p.x-_.width/2),o=Math.max(o,p.x+_.width/2),l=Math.min(l,p.y-_.height/2),c=Math.max(c,p.y+_.height/2))}for(const d of n)a=Math.min(a,d.x-20),o=Math.max(o,d.x+20),l=Math.min(l,d.y-20),c=Math.max(c,d.y+20);return!Number.isFinite(a)||!Number.isFinite(o)||!Number.isFinite(l)||!Number.isFinite(c)?{minX:0,minY:0,maxX:jn.width,maxY:jn.height,width:jn.width,height:jn.height}:{minX:a,minY:l,maxX:o,maxY:c,width:Math.max(1,o-a),height:Math.max(1,c-l)}}function Dl(t,e,n){const s=n==="compact"?48:72,a=Math.max(360,e.width-s*2),o=Math.max(280,e.height-s*2),l=da(Math.min(a/Math.max(t.width,1),o/Math.max(t.height,1)),Qd,Zd),c=t.minX+t.width/2,d=t.minY+t.height/2;return{zoom:l,panX:e.width/2-c*l,panY:e.height/2-d*l}}function mh(t,e){const n=(t.x+e.x)/2,s=e.y>=t.y?32:-32;return`M ${t.x} ${t.y} C ${n} ${t.y+s}, ${n} ${e.y-s}, ${e.x} ${e.y}`}function ql(t,e,n){if(t==="command"){if(e){Kt(e),at("command",{...Ms(e),...n});return}at("command",n);return}if(t==="intervene"){at("intervene",n);return}at("command",n)}function _h({signalNodes:t,roomPoint:e,onSelect:n}){return!e||t.length===0?null:i`
    ...
    `)}
  `}function vh({edges:t,positions:e,selectedId:n}){return i`
    ${t.map(s=>{const a=e.get(s.source),o=e.get(s.target);if(!a||!o)return null;const l=n!=null&&(s.source===n||s.target===n);return i`
        ...
        />
      `})}
  `}function fh({orchestra:t,positions:e,density:n,selectedId:s,onSelect:a}){var l;const o=((l=t.focus)==null?void 0:l.target_kind)==="node"?t.focus.target_id:null;return i`
    ${t.nodes.map(c=>{const d=e.get(c.id);if(!d)return null;const p=eu(c,n),_=c.id===s,v=c.id===o,f=c.visual_class??c.kind,h=rh(c,n),T=lh(c,n),k=ch(c,n);if(c.kind==="room")return i`
          <g
            key=${c.id}
            data-orchestra-node="true"
            class=${`orchestra-node room ${N(c.tone)} ${_?"selected":""} ${v?"focused":""}`}
            onClick=${()=>a(c.id)}
          >
            <title>${c.label}</title>
        ...
        `;const S=d.x-p.width/2,$=d.y-p.height/2;return i`
        <g
          key=${c.id}
          data-orchestra-node="true"
          class=${`orchestra-node ${f} ${N(c.tone)} ${_?"selected":""} ${v?"focused":""}`}
          onClick=${()=>a(c.id)}
        >
          <title>${c.label}${c.subtitle?` — ${c.subtitle}`:""}${c.status?` (${c.status})`:""}</title>
          <rect x=${S} y=${$} width=${p.width} height=${p.height} rx=${p.radius} class="orchestra-node-body" />
          <text x=${S+16} y=${$+24} class="orchestra-node-glyph">${c.glyph??"•"}</text>
          <text x=${S+38} y=${$+24} class="orchestra-node-label">${h}</text>
          ${T?i`<text x=${S+38} y=${$+42} class="orchestra-node-subtitle">${T}</text>`:null}
          ${k?i`<text x=${S+p.width-10} y=${$+18} text-anchor="end" class="orchestra-node-status">${k}</text>`:null}
        </g>
      `})}
  `}function nu(t){var s,a;const e=Ie.value;if(e){const o=t.nodes.find(c=>c.id===e);if(o)return{type:"node",value:o};const l=t.signals.find(c=>c.id===e);if(l)return{type:"signal",value:l}}if(((s=t.focus)==null?void 0:s.target_kind)==="node"){const o=t.nodes.find(l=>{var c;return l.id===((c=t.focus)==null?void 0:c.target_id)});if(o)return{type:"node",value:o}}if(((a=t.focus)==null?void 0:a.target_kind)==="signal"){const o=t.signals.find(l=>{var c;return l.id===((c=t.focus)==null?void 0:c.target_id)});if(o)return{type:"signal",value:o}}const n=t.nodes[0];return n?{type:"node",value:n}:null}function gh({orchestra:t}){const e=nu(t);if(!e)return i`<aside class="orchestra-drawer card"><div class="empty-state">선택 가능한 대상이 아직 없습니다.</div></aside>`;if(e.type==="signal"){const o=e.value;return i`
      <aside class="orchestra-drawer card ${N(o.tone)}">
        <div class="card-title-row">
          <div class="card-title">${o.label}</div>
          <span class="command-chip ${N(o.tone)}">${Ol(o.kind)}</span>
        </div>
    ...
    <aside class="orchestra-drawer card ${N(n.tone)}">
      <div class="card-title-row">
        ...
        <span class="command-chip ${N(n.tone)}">${Ol(n.kind)}</span>
      </div>
      ...
      ${s.length>0?i`
        <div class="command-tag-row">
          ${s.map(o=>i`<span class="command-chip ${N(o.tone)}">${o.label}</span>`)}
        </div>
      `:null}
  ...
  `}function $h(){var H,Y,tt,G;const t=ar.value,e=wn(null),n=wn(null),s=wn(""),[a,o]=$n(jn);if(et(()=>{const L=e.current;if(!L)return;const x=()=>{const J=L.getBoundingClientRect();J.width<=0||J.height<=0||o({width:Math.max(640,Math.round(J.width)),height:Math.max(480,Math.round(J.height))})};if(x(),typeof ResizeObserver>"u")return window.addEventListener("resize",x),()=>window.removeEventListener("resize",x);const E=new ResizeObserver(()=>x());return E.observe(L),()=>E.disconnect()},[]),ko.value&&!t)return i`<section class="card command-section"><div class="empty-state">오케스트라 맵 불러오는 중…</div></section>`;if(ja.value)return i`<section class="card command-section"><div class="empty-state error">${ja.value}</div></section>`;if(!t)return i`<section class="card command-section"><div class="empty-state">오케스트라 맵 데이터가 아직 없습니다.</div></section>`;const l=Fs.value,c=dh(t,l),d=t.nodes.find(L=>L.kind==="room")??null,p=d?c.get(d.id)??null:null,_=uh(t,p,l),v=ph(t,c,_,l),f=nu(t),h=(f==null?void 0:f.value.id)??null,T=`${l}:${a.width}x${a.height}:${t.nodes.length}:${t.edges.length}:${t.signals.length}`,k=(L,x)=>{re.value=L,Ks.value=x},S=()=>{k(Dl(v,a,l),!1)},$=()=>{if(Ie.value=null,l!=="compact"){Fs.value="compact",Ks.value=!1;return}S()};et(()=>{h&&!t.nodes.some(L=>L.id===h)&&!t.signals.some(L=>L.id===h)&&(Ie.value=null)},[T,h,t]),et(()=>{(!Ks.value||s.current!==T)&&(k(Dl(v,a,l),!1),s.current=T)},[T]);const y=re.value,R=(L,x,E)=>{const J=re.value.zoom,ht=da(J*E,Qd,Zd);if(Math.abs(ht-J)<.001)return;const ie=(L-re.value.panX)/J,W=(x-re.value.panY)/J;k({zoom:ht,panX:L-ie*ht,panY:x-W*ht},!0)},P=L=>{L.preventDefault();const x=e.current;if(!x)return;const E=x.getBoundingClientRect(),J=da(L.clientX-E.left,0,E.width),ht=da(L.clientY-E.top,0,E.height);R(J,ht,L.deltaY<0?1.1:.92)},C=L=>{var J;const x=L.target;if(!(x instanceof Element)||!x.closest('[data-orchestra-background="true"]'))return;const E=L.currentTarget;E&&(n.current={pointerId:L.pointerId,startX:L.clientX,startY:L.clientY,panX:re.value.panX,panY:re.value.panY},Ii.value=!0,Ks.value=!0,(J=E.setPointerCapture)==null||J.call(E,L.pointerId))},M=L=>{const x=n.current;!x||x.pointerId!==L.pointerId||k({zoom:re.value.zoom,panX:x.panX+(L.clientX-x.startX),panY:x.panY+(L.clientY-x.startY)},!0)},I=L=>{var E;if(!n.current)return;const x=L==null?void 0:L.currentTarget;x&&L&&((E=x.releasePointerCapture)==null||E.call(x,L.pointerId)),n.current=null,Ii.value=!1};return i`
    <section class="card command-section orchestra-surface">
      ...
      <div class="orchestra-toolbar">
        ...
        <div class="orchestra-toolbar-group">
          ...
          <span class="command-chip">${ih(l)}</span>
        </div>
      </div>
        ...
        >
          ...
          >
            ...
            <g transform=${`translate(${y.panX} ${y.panY}) scale(${y.zoom})`}>
              <${vh} edges=${t.edges} positions=${c} selectedId=${h} />
              <${_h} signalNodes=${_} roomPoint=${p} onSelect=${L=>{Ie.value=L}} />
              <${fh}
                orchestra=${t}
                positions=${c}
                density=${l}
                selectedId=${h}
                onSelect=${L=>{Ie.value=L}}
              />
            </g>
          </svg>
          <div class="orchestra-summary-strip">
            <span class="command-chip">세션 ${((H=t.summary)==null?void 0:H.session_count)??0}</span>
            ...
            <span class="command-chip ${N(t.signals.some(L=>L.tone==="bad")?"bad":t.signals.length>0?"warn":"ok")}">
  ...
  `}const su="masc_dashboard_agent_name";function hh(){var e,n,s;const t=new URLSearchParams(window.location.search);return((e=t.get("agent"))==null?void 0:e.trim())||((n=t.get("agent_name"))==null?void 0:n.trim())||((s=localStorage.getItem(su))==null?void 0:s.trim())||"dashboard"}const ci=g(hh()),vn=g(""),Ba=g("운영 점검"),fn=g(""),os=g(""),rs=g("2"),yn=g(""),Ct=g("note"),ls=g(""),cs=g(""),ds=g(""),us=g("2"),ps=g(""),Ua=g("운영자 중지 요청"),Io=g(""),yh=g(""),Us=g(null);function bh(t){const e=t.trim()||"dashboard";ci.value=e,localStorage.setItem(su,e)}function Ha(t){if(t==null)return"";if(typeof t=="string")return t;try{return JSON.stringify(t,null,2)}catch{return String(t)}}function br(t){switch((t??"").trim().toLowerCase()){case"judgment":return"상주 판단";case"fallback":return"보조 읽기 모델";default:return(t==null?void 0:t.trim())||"안내"}}function Wa(t){switch((t??"").trim().toLowerCase()){case"judgment":return"ok";case"fallback":return"warn";default:return"warn"}}function di(t){return t!=null&&t.enabled?t.refreshing?"갱신 중":t.judge_online?"온라인":t.last_error?"오류":"대기":"꺼짐"}function au(t){return t!=null&&t.enabled?t.judge_online?"ok":t.refreshing?"warn":"bad":"warn"}function kr(t){return t!=null&&t.fresh_until?t.fresh_until:"갱신 기준 없음"}function Fl(t){return typeof t!="number"||!Number.isFinite(t)?"확인 없음":t<60?`${Math.round(t)}초 전`:t<3600?`${Math.round(t/60)}분 전`:`${Math.round(t/3600)}시간 전`}function bn(t){return typeof t=="string"?t.trim().toLowerCase():""}function kh(t){var s;const e=bn(t.status);if(e==="paused")return"bad";if(e===""||e==="unknown")return"warn";const n=bn((s=t.team_health)==null?void 0:s.status);return n&&n!=="ok"&&n!=="healthy"&&n!=="green"||e&&e!=="active"&&e!=="running"&&e!=="ended"?"warn":"ok"}function Ri(t){const e=bn(t.status);return e==="offline"||e==="inactive"||e==="error"?"bad":e===""||e==="unknown"||(t.context_ratio??0)>=.8||t.context_ratio==null||t.last_turn_ago_s==null||(t.last_turn_ago_s??0)>=3600?"warn":"ok"}function Kl(t){return t.some(e=>bn(e.severity)==="bad")?"bad":t.length>0?"warn":"ok"}function xh(t){return t.target_type==="team_session"}function Sh(t){return t.target_type==="keeper"}function qe(t){switch(t){case"broadcast":return"방송";case"room_pause":return"방 일시정지";case"room_resume":return"방 재개";case"team_turn":return"세션 업데이트";case"team_note":return"세션 노트";case"team_broadcast":return"세션 방송";case"team_task_inject":return"세션 작업 주입";case"team_worker_spawn_batch":return"세션 작업자 교체";case"task_inject":return"작업 주입";case"team_stop":return"세션 중지";case"keeper_message":return"키퍼 메시지";case"keeper_msg":return"키퍼 메시지";case"swarm_run_continue":return"스웜 실행 계속";case"swarm_run_rerun":return"스웜 실행 재실행";case"swarm_run_abandon":return"스웜 실행 포기";default:return(t==null?void 0:t.trim())||"액션"}}function gn(t){switch(t){case"room":return"방";case"team_session":return"세션";case"keeper":return"키퍼";case"swarm_run":return"스웜 실행";default:return(t==null?void 0:t.trim())||"대상"}}function sn(t){switch(bn(t)){case"running":case"active":return"진행 중";case"paused":return"일시정지";case"ended":case"done":return"종료";case"offline":return"오프라인";case"idle":return"대기";case"unknown":case"":return"확인 필요";default:return(t==null?void 0:t.trim())||"확인 필요"}}function Ga(t){return t?"확인 후 실행":"즉시 실행"}function Ch(t){switch(t){case"note":return"노트";case"broadcast":return"방송";case"task":return"작업";case"worker_spawn_batch":return"작업자 교체";default:return t}}function ft(t,e){if(!t)return null;const n=t[e];return typeof n=="string"&&n.trim()!==""?n.trim():typeof n=="number"&&Number.isFinite(n)?String(n):null}function Ah(t){return!t||typeof t!="object"||Array.isArray(t)?null:t}function Th(t){if(!t)return"";const e=t.spawn_batch;return Ha(e!==void 0?e:t)}function iu(t){const e=Ah(t.payload);if(t.target_type==="room"){if(t.action_type==="broadcast"){vn.value=ft(e,"message")??t.summary;return}if(t.action_type==="task_inject"){fn.value=ft(e,"title")??"운영자 주입 작업",os.value=ft(e,"description")??t.summary,rs.value=ft(e,"priority")??rs.value;return}t.action_type==="room_pause"&&(Ba.value=ft(e,"reason")??t.summary);return}if(t.target_type==="team_session"){if(t.target_id&&(yn.value=t.target_id),t.action_type==="team_stop"){Ua.value=ft(e,"reason")??t.summary;return}Ct.value=t.action_type==="team_worker_spawn_batch"?"worker_spawn_batch":t.action_type==="team_task_inject"?"task":t.action_type==="team_broadcast"?"broadcast":"note";const n=ft(e,"message");if(n&&(ls.value=n),Ct.value==="worker_spawn_batch"){ps.value=Th(e);return}Ct.value==="task"&&(cs.value=ft(e,"task_title")??ft(e,"title")??"운영자 주입 작업",ds.value=ft(e,"task_description")??ft(e,"description")??t.summary,us.value=ft(e,"task_priority")??ft(e,"priority")??us.value);return}t.target_type==="keeper"&&(t.target_id&&(Io.value=t.target_id),yh.value=ft(e,"message")??t.summary)}function Ih(t){iu({action_type:t.action_type,target_type:t.target_type,target_id:t.target_id,payload:t.suggested_payload,summary:t.summary})}function Rh(t){iu({action_type:t.action_type,target_type:t.target_type,target_id:t.target_id??null,payload:t.suggested_payload,summary:t.reason}),O("추천 액션 payload를 폼에 채웠습니다","success")}function Mh(t,e,n){return!t||!t.target_type||t.target_type==="room"?!0:t.target_type==="team_session"?!!t.target_id&&e.some(s=>s.session_id===t.target_id):t.target_type==="keeper"?!!t.target_id&&n.some(s=>s.name===t.target_id):!0}async function Ke(t){const e=ci.value.trim()||"dashboard";try{const n=await nd({actor:e,action_type:t.action_type,target_type:t.target_type,target_id:t.target_id,payload:t.payload});return n.confirm_required?O("확인 대기열에 올렸습니다","warning"):O(t.successMessage,"success"),n}catch(n){const s=n instanceof Error?n.message:"개입 실행에 실패했습니다";return O(s,"error"),null}}async function Bl(){const t=vn.value.trim();if(!t)return;await Ke({action_type:"broadcast",target_type:"room",payload:{message:t},successMessage:"방송을 보냈습니다"})&&(vn.value="")}async function Lh(){await Ke({action_type:"room_pause",target_type:"room",payload:{reason:Ba.value.trim()||"운영 점검"},successMessage:"방 일시정지를 요청했습니다"})}async function ou(){await Ke({action_type:"room_resume",target_type:"room",payload:{},successMessage:"방 재개를 요청했습니다"})}async function Ph(){const t=fn.value.trim();if(!t)return;await Ke({action_type:"task_inject",target_type:"room",payload:{title:t,description:os.value.trim()||"개입 화면에서 주입",priority:Number.parseInt(rs.value,10)||2},successMessage:"작업 주입을 보냈습니다"})&&(fn.value="",os.value="")}async function zh(){var l;const t=It.value,e=yn.value||((l=t==null?void 0:t.sessions[0])==null?void 0:l.session_id)||"";if(!e){O("먼저 세션을 고르세요","warning");return}const n={};if(Ct.value==="worker_spawn_batch"){const c=ps.value.trim();if(!c){O("spawn_batch JSON을 먼저 채우세요","warning");return}try{const p=JSON.parse(c);if(Array.isArray(p))n.spawn_batch=p;else if(p&&typeof p=="object"&&Array.isArray(p.spawn_batch))n.spawn_batch=p.spawn_batch;else{O("spawn_batch는 배열 또는 { spawn_batch: [...] } 형태여야 합니다","warning");return}}catch(p){const _=p instanceof Error?p.message:"spawn_batch JSON 파싱에 실패했습니다";O(_,"error");return}await Ke({action_type:"team_worker_spawn_batch",target_type:"team_session",target_id:e,payload:n,successMessage:"작업자 교체 요청을 적용했습니다"})&&(ps.value="");return}const s=ls.value.trim();s&&(n.message=s);let a="team_note";Ct.value==="broadcast"?a="team_broadcast":Ct.value==="task"&&(a="team_task_inject"),Ct.value==="task"&&(n.task_title=cs.value.trim()||"운영자 주입 작업",n.task_description=ds.value.trim()||"개입 화면에서 주입",n.task_priority=Number.parseInt(us.value,10)||2),await Ke({action_type:a,target_type:"team_session",target_id:e,payload:n,successMessage:"세션 액션을 적용했습니다"})&&(ls.value="",Ct.value==="task"&&(cs.value="",ds.value=""))}async function Eh(){var n;const t=It.value,e=yn.value||((n=t==null?void 0:t.sessions[0])==null?void 0:n.session_id)||"";if(!e){O("먼저 세션을 고르세요","warning");return}await Ke({action_type:"team_stop",target_type:"team_session",target_id:e,payload:{reason:Ua.value.trim()||"운영자 중지 요청"},successMessage:"세션 중지를 요청했습니다"})}async function Ul(t,e="confirm"){const n=ci.value.trim()||"dashboard";try{await sd(n,t,e),O(e==="deny"?"승인 대기를 거부했습니다":"확인 실행을 완료했습니다","success")}catch(s){const a=s instanceof Error?s.message:e==="deny"?"승인 대기 거부에 실패했습니다":"확인 실행에 실패했습니다";O(a,"error")}}function ru(t){switch(t){case"explicit":return"실제 관리 단위";case"hybrid":return"관리 단위 + 자동 보강";case"auto":return"자동 투영";default:return"출처 미상"}}function lu(t){switch(t){case"explicit":return"ok";case"hybrid":return"warn";case"auto":return"warn";default:return"warn"}}function Nh(t){switch(t){case"explicit":return"지금 보이는 유닛은 실제로 정의된 지휘면 관리 단위입니다.";case"hybrid":return"일부는 실제 관리 단위이고, 비어 있는 부분은 실시간 에이전트 편성을 보고 자동 보강한 구조입니다.";case"auto":return"이 화면은 실시간 에이전트 편성을 지휘면 모양으로 자동 투영한 것입니다. 실제 명령 체계와 1:1로 같다고 보면 안 됩니다.";default:return"이 화면은 관리 토폴로지와 실효 토폴로지가 섞여 있을 수 있습니다."}}function jh(t){const e=t.unit.source??"unknown";return e==="explicit"?t.active_operation_count&&t.active_operation_count>0?"실제 관리 단위이며 연결된 작전이 있습니다.":"실제 관리 단위이지만 현재 연결된 작전은 없습니다.":e==="hybrid"?t.active_operation_count&&t.active_operation_count>0?"관리 단위를 기반으로 자동 보강된 구조이며 일부 작전이 연결돼 있습니다.":"관리 단위를 기반으로 자동 보강된 구조이며 현재 실행 연결은 약합니다.":t.active_operation_count&&t.active_operation_count>0?"자동 생성된 구조이지만 이 노드에 연결된 작전 흔적은 있습니다.":"자동 생성된 구조이며 현재 실행 연결은 없습니다."}function cu({node:t,depth:e=0}){const n=t.roster_live??0,s=t.roster_total??t.unit.roster.length,a=t.active_operation_count??0,o=t.unit.policy,l=t.unit.source??"unknown",c=a>0?`${a}개 작전 연결`:"실행 연결 없음";return i`
    <div class="command-tree-node depth-${Math.min(e,3)}">
      <div class="command-tree-head">
        <div>
          <div class="command-tree-title-row">
            <strong>${t.unit.label}</strong>
            <span class="command-chip">${y$(t.unit.kind)}</span>
          ...
          <div class="command-card-sub">${jh(t)}</div>
  ...
  `}function Oh(){const t=Jt.value,e=t==null?void 0:t.topology,n=e==null?void 0:e.source,s=e==null?void 0:e.summary,a=(s==null?void 0:s.managed_unit_count)??0,o=(s==null?void 0:s.active_operation_count)??0;return i`
    <section class="card command-section">
      <div class="card-title-row">
  ...
  `}function qh(){const t=Jt.value;return i`
    <section class="card command-section">
      <div class="card-title-row">
  ...
  `}function Fh(t){if(typeof t=="string")return t;if(t==null)return"";try{return JSON.stringify(t,null,2)}catch{return String(t)}}function Kh(t,e){return(e==null?void 0:e.status)==="abandoned"||(t==null?void 0:t.recommended_kind)==="continue"?"warn":(t==null?void 0:t.recommended_kind)==="rerun"?"bad":"ok"}function Bh(t){switch(t){case"continue":case"continued":return"계속";case"rerun":return"재실행";case"abandon":case"abandoned":return"포기";default:return(t==null?void 0:t.trim())||"결정"}}function du({swarm:t}){var v,f;const e=t.run_id,n=t.resolution_recommendation,s=t.run_resolution;if(!e||!n&&!s)return null;const a=Vd()??"dashboard",o=((v=It.value)==null?void 0:v.pending_confirms.find(h=>h.target_type==="swarm_run"&&h.target_id===e))??null,l=Kh(n,s),c=((f=t.operation)==null?void 0:f.operation_id)??t.operation_id??void 0,d={run_id:e};c&&(d.operation_id=c),n!=null&&n.reason&&(d.reason=n.reason);const p=async h=>{await nd({actor:a,action_type:h,target_type:"swarm_run",target_id:e,payload:d})},_=async h=>{o&&await sd(a,o.confirm_token,h)};return i`
    <article class="command-guide-card ${N(l)}">
      <div class="command-guide-head">
        <strong>Run Resolution</strong>
        <span class="command-chip ${N(l)}">
          ${Bh((s==null?void 0:s.status)??(n==null?void 0:n.recommended_kind)??null)}
        </span>
      </div>
      <p>
      ...
      ${n!=null&&n.evidence?i`
            <div class="command-tag-row">
              ...
              ${n.evidence.runtime_blocker?i`<span class="command-tag ${N("bad")}">${n.evidence.runtime_blocker}</span>`:null}
            </div>
          `:null}
      ${o?i`
            <div class="command-guide-card warn">
              ...
              ${o.preview?i`<pre class="command-trace-detail">${Fh(o.preview)}</pre>`:null}
              <div class="command-action-row">
  ...
  `}function Uh({total:t}){const n=Math.min(t,20),s=t>20?t-20:0,a=Array.from({length:n});return i`
  ...
  `}function Hh({lane:t}){const e=t.counts??{},n=uu(t),s=e.workers??0,a=e.operations??0,o=e.detachments??0,l=a+o,c=t.motion_state==="moving"?84:t.motion_state==="waiting"?58:t.motion_state==="terminal"?100:26;return i`
    <article class="swarm-lane-strip ${N(n)}">
      ...
      ${t.hard_flags.length>0?i`
            <div class="swarm-lane-flags">
              ${t.hard_flags.map(d=>i`<span class="command-chip ${N(d.severity)}">${d.code}</span>`)}
            </div>
          `:null}
    </article>
  ...
  `}function Wh({event:t}){const e=t.timestamp?new Date(t.timestamp):null,n=e&&!isNaN(e.getTime())?e:null,s=n?`${String(n.getHours()).padStart(2,"0")}:${String(n.getMinutes()).padStart(2,"0")}`:"";return i`
  ...
  `}function Jh({proof:t}){const e=(t==null?void 0:t.status)==="missing"?"warn":(t==null?void 0:t.pass)===!1?"bad":(t==null?void 0:t.pass)===!0?"ok":"warn";return i`
      ...
      ${s?i`
            ...
            <div class="command-swarm-layout ${_?"compact":""}">
              <div class="command-card-stack">
                ${o.length>0?o.map(v=>i`<${Hh} lane=${v} />`):i`<div class="empty-state">활성 스웜 레인이 없습니다.</div>`}
              </div>
              ...
              <div class="command-card-stack">
                ...
                <div class="command-guide-card ${l.length>0?"warn":"ok"} ${n==="gaps"?"focus":""}">
                  <div class="command-guide-head">
                    <strong>핵심 공백</strong>
                    <span class="command-chip ${N(l.some(v=>v.severity==="bad")?"bad":l.length>0?"warn":"ok")}">${l.length}</span>
                  </div>
                  ${l.length>0?i`<div class="swarm-event-rail">${l.slice(0,4).map(v=>i`<${Gh} gap=${v} />`)}</div>`:i`<p>지금 보이는 핵심 공백은 없습니다.</p>`}
                </div>
                ...
                <div class="command-guide-card">
                  ...
                  ${c.length>0?i`<div class="swarm-event-rail">${c.map(v=>i`<${Wh} event=${v} />`)}</div>`:i`<p>붙어 있는 최근 이동 이벤트가 아직 없습니다.</p>`}
                </div>
              </div>
            </div>
      ...
      <div class="command-surface-grid">
        <section class="card command-section">
          ...
          ${Ea.value?i`<div class="empty-state">Loading swarm live state…</div>`:Na.value?i`<div class="empty-state error">${Na.value}</div>`:t?i`
                    ...
                    <div class="command-summary-grid">
                      ...
                      <div class="monitor-stat-card"><span>워커</span><strong>${((S=t.summary)==null?void 0:S.joined_workers)??0}/${(($=t.summary)==null?void 0:$.expected_workers)??0}</strong><small>${((y=t.summary)==null?void 0:y.live_workers)??0}개 가동 · ${((R=t.summary)==null?void 0:R.completed_workers)??0}개 완료</small></div>
                      <div class="monitor-stat-card"><span>런타임</span><strong>${s}</strong><small>slots ${a}/${o} · ctx ${l}/${c}</small></div>
                      <div class="monitor-stat-card"><span>고동시성</span><strong>${(P=t.summary)!=null&&P.pass_hot_concurrency?"통과":"확인 필요"}</strong><small>${((C=t.provider)==null?void 0:C.slot_url)??"slot 정보 없음"}</small></div>
                    ...
                    <div class="command-card-grid">
                      ...
                      <span>실행체</span><span>${((Y=t.detachment)==null?void 0:Y.detachment_id)??"없음"}</span>
                      ...
                      <span>런타임 막힘</span><span>${((L=t.provider)==null?void 0:L.runtime_blocker)??"없음"}</span>
        ...
        <section class="card command-section">
          ...
          ${t&&t.blockers.length>0?i`<div class="command-card-stack">
                ${t.blockers.map(x=>i`<${_u} blocker=${x} />`)}
        ...
        <section class="card command-section">
          ...
          ${t&&t.recent_trace_events.length>0?i`<div class="command-trace-stack">
                ${t.recent_trace_events.map(x=>i`<${xr} event=${x} />`)}
              </div>`:i`<div class="empty-state">run 범위 trace event가 아직 없습니다.</div>`}
        </section>
      </div>
    </div>
  `}function Yt(t,e=260){return t.length<=e?t:`${t.slice(0,e-1)}…`}function an(t){if(!t)return 0;const e=Date.parse(t);return Number.isNaN(e)?0:e}function Zh(t){return typeof t!="number"||!Number.isFinite(t)?"정보 없음":t<60?`${Math.round(t)}초 전`:t<3600?`${Math.round(t/60)}분 전`:`${Math.round(t/3600)}시간 전`}function ty(t){const e=typeof t.timestamp=="string"?t.timestamp:typeof t.created_at=="string"?t.created_at:typeof t.at=="string"?t.at:null,n=typeof t.title=="string"?t.title:typeof t.kind=="string"?t.kind:typeof t.event=="string"?t.event:"세션 이벤트",s=typeof t.detail=="string"?t.detail:typeof t.summary=="string"?t.summary:is(t);return{timestamp:e,title:n,detail:Yt(s,220)}}function ey(t){return t==="swarm"?"스웜 실시간":"세션 요약"}function ny(t){switch(t){case"current":return"현재 과업 일치";case"drift":return"과업 드리프트";case"claim":return"착수 흔적 있음";case"no-claim":return"착수 흔적 없음";case"done":return"완료 흔적 있음";case"no-done":return"완료 흔적 없음";case"final":return"최종 보고 있음";case"no-final":return"최종 보고 없음";case"turn":return"턴 기록 있음";case"silent":return"턴 기록 없음";case"noted":return"노트 기록 있음";default:return t.startsWith("empty:")?`빈 노트 ${t.slice(6)}회`:t.startsWith("turns:")?`턴 ${t.slice(6)}회`:t}}function sy(t){var n;const e=[t.current_task_matches_run?"current":"drift",t.claim_marker_seen?"claim":"no-claim",t.done_marker_seen?"done":"no-done",t.final_marker_seen?"final":"no-final"];return{key:`swarm:${t.name}`,name:t.name,role:t.role,lane:t.lane,status:t.status,source:"swarm",task:t.current_task??t.bound_task_title??t.bound_task_id??"할당 없음",heartbeat:t.heartbeat_age_sec!=null?`${Math.round(t.heartbeat_age_sec)}초`:t.heartbeat_fresh?"정상":"정보 없음",detail:[t.bound_task_status??null,t.detachment_member?"분견대 소속":null,t.squad_member?"분대 소속":null].filter(Boolean).join(" · ")||"스웜 실시간 카드",markers:e,note:((n=t.last_message)==null?void 0:n.content)??null}}function ay(t,e){const n=t.actor??t.spawn_role??`워커-${e+1}`,s=t.spawn_role??t.worker_class??t.spawn_agent??"워커",a=t.lane_id??t.capsule_mode??t.control_domain??"세션",o=[t.has_turn?"turn":"silent",t.empty_note_turn_count>0?`empty:${t.empty_note_turn_count}`:"noted",t.turn_count>0?`turns:${t.turn_count}`:"turns:0"];return{key:`session:${n}:${e}`,name:n,role:s,lane:a,status:t.status,source:"session",task:t.task_profile??t.runtime_pool??"세션 레인",heartbeat:t.last_turn_ts_iso?Q(t.last_turn_ts_iso):"정보 없음",detail:[t.spawn_agent??null,t.spawn_model??null,t.routing_confidence!=null?Tn(t.routing_confidence):null].filter(Boolean).join(" · ")||"세션 요약 카드",markers:o,note:t.routing_reason??null}}function iy(t){var e;return{key:`agent:${t.name}`,name:t.name,role:t.agent_type??"agent",source:"agent",status:Ft(t.status),tone:N(de(t.status)),task:t.current_task??"대기 중",signal:Q(t.last_seen),detail:[t.model??null,((e=t.capabilities)==null?void 0:e.slice(0,2).join(", "))||null].filter(Boolean).join(" · ")||"글로벌 agent roster",chips:[t.context_ratio!=null?`ctx ${Math.round(t.context_ratio*100)}%`:"ctx n/a",t.status],note:t.personalityHint??null}}function oy(t){var n,s,a;const e=t.status==="offline"||t.status==="inactive"?"bad":t.status==="active"||t.status==="healthy"?"ok":"warn";return{key:`keeper:${t.name}`,name:t.name,role:t.runtime_class??"keeper",source:"keeper",status:Ft(t.status),tone:e,task:((n=t.active_goal_ids)==null?void 0:n[0])??t.last_proactive_reason??((s=t.agent)==null?void 0:s.current_task)??"standby",signal:t.last_heartbeat?Q(t.last_heartbeat):Zh(t.last_turn_ago_s),detail:[t.autonomy_level??null,t.active_model??t.primary_model??t.model??null,t.keepalive_running?"keepalive on":null].filter(Boolean).join(" · ")||"글로벌 keeper roster",chips:[t.context_ratio!=null?`ctx ${Math.round(t.context_ratio*100)}%`:"ctx n/a",t.latest_tool_call_count!=null?`tools ${t.latest_tool_call_count}`:"tools n/a"],note:((a=t.diagnostic)==null?void 0:a.summary)??t.last_proactive_preview??t.recent_output_preview??null}}function ry(t){return{key:`resident:${t.keeper_name??"judge"}`,name:t.keeper_name??"resident-judge",role:"resident judge",source:"resident",status:di(t),tone:au(t),task:t.judge_online?"live guidance":"standby",signal:t.generated_at?Q(t.generated_at):"정보 없음",detail:[t.model_used??null,t.last_error?"error":null].filter(Boolean).join(" · ")||"resident runtime",chips:[t.enabled?"enabled":"disabled",t.judge_online?"online":"offline"],note:t.last_error??null}}function ly(t){return N(t.severity)}function cy({swarmMessages:t,traceEvents:e,chainOverlay:n,linkedAutoresearch:s,selectedSession:a,activeRecommendedActions:o,attentionItems:l}){const c=[];for(const d of t.slice(0,8))c.push({key:`message:${d.seq}`,title:d.from,detail:Yt(d.content,280),meta:`메시지 · seq ${d.seq}`,source:"swarm",tone:"ok",timestamp:d.timestamp,sortTs:an(d.timestamp)});for(const d of e.slice(0,8))c.push({key:`trace:${d.event_id}`,title:d.event_type,detail:Yt(is(d.detail),280),meta:[d.actor??null,d.source??null].filter(Boolean).join(" · ")||"trace",source:"trace",tone:d.event_type.includes("error")||d.event_type.includes("fail")?"bad":"warn",timestamp:d.timestamp,sortTs:an(d.timestamp)});if(n!=null&&n.history&&c.push({key:`chain:${n.operation.operation_id}:${n.history.event}`,title:`Chain · ${n.history.event}`,detail:Yt(li(n.history),260),meta:n.history.chain_id??n.operation.operation_id,source:"chain",tone:n.history.event.includes("error")||n.history.event.includes("fail")?"bad":"warn",timestamp:n.history.timestamp,sortTs:an(n.history.timestamp)}),s){const d=[s.last_decision??null,s.target_file?`target ${s.target_file}`:null,s.error??null].filter(Boolean);c.push({key:`autoresearch:${s.loop_id??(a==null?void 0:a.session_id)??"session"}`,title:`Autoresearch · ${s.status??"unknown"}`,detail:Yt(d.join(" · ")||"linked autoresearch context",260),meta:[s.loop_id?`loop ${s.loop_id}`:null,s.current_cycle!=null?`cycle ${s.current_cycle}`:null,s.best_score!=null?`best ${s.best_score}`:null].filter(Boolean).join(" · ")||"linked autoresearch",source:"autoresearch",tone:s.error?"bad":s.status==="running"?"warn":"ok",timestamp:null,sortTs:0})}for(const d of o.slice(0,4))c.push({key:`recommendation:${d.action_type}:${d.target_type}:${d.target_id??"session"}`,title:`${d.action_type} · ${d.target_type}`,detail:Yt(d.reason,240),meta:d.target_id??"operator recommendation",source:"recommendation",tone:ly(d),timestamp:null,sortTs:0});for(const d of l.slice(0,4))c.push({key:`attention:${d.kind}:${d.target_id??"session"}`,title:`${d.kind} · ${d.target_type}`,detail:Yt(d.summary,240),meta:d.target_id??"attention",source:"attention",tone:N(d.severity),timestamp:null,sortTs:0});for(const[d,p]of((a==null?void 0:a.recent_events)??[]).slice(0,4).entries()){const _=ty(p);c.push({key:`session:${(a==null?void 0:a.session_id)??"unknown"}:${d}`,title:_.title,detail:_.detail,meta:(a==null?void 0:a.session_id)??"session",source:"session",tone:"warn",timestamp:_.timestamp,sortTs:an(_.timestamp)})}return c.sort((d,p)=>p.sortTs-d.sortTs||d.title.localeCompare(p.title)).slice(0,14)}function dy({worker:t}){return i`
    <article class="command-card compact warroom-worker-card ${N(de(t.status))}">
      <div class="command-card-head">
        <div>
          <strong>${t.name}</strong>
          <div class="command-card-sub">${t.role} · ${t.lane}</div>
        </div>
        <span class="command-chip ${N(de(t.status))}">${Ft(t.status)}</span>
      </div>
      <div class="command-card-grid">
        <span>출처</span><span>${ey(t.source)}</span>
        <span>과업</span><span>${t.task}</span>
        <span>최근 신호</span><span>${t.heartbeat}</span>
        <span>근거</span><span>${t.detail}</span>
      </div>
      <div class="command-tag-row">
        ${t.markers.map(e=>i`<span class="command-tag">${ny(e)}</span>`)}
      </div>
  ...
  `}function py({chainOverlay:t,linkedAutoresearch:e}){var n,s,a,o;return!t&&!e?i`<div class="command-guide-card"><p>이 세션에 붙은 chain/autoresearch 오버레이가 아직 없습니다.</p></div>`:i`
      ...
      ${t?i`
            <article class="command-card warroom-orchestration-card">
              <div class="command-card-head">
                ...
                <span class="command-chip ${N(de(t.operation.status))}">${Ft(t.operation.status)}</span>
              </div>
              <div class="command-card-grid">
  ...
  `}function my({wallboard:t=!1}){var Mr,Lr,Pr,zr,Er,Nr,jr,wr,Or,Dr,qr,Fr,Kr,Br,Ur,Hr,Wr,Gr,Jr,Vr,Yr,Xr,Qr,Zr,tl,el,nl,sl,al,il,ol,rl;const e=Ls(),n=He.value,s=It.value,a=Ht.value,o=M$(),l=n!=null&&n.operation?((Mr=Cs.value)==null?void 0:Mr.operations.find(B=>{var xe;return B.operation.operation_id===((xe=n.operation)==null?void 0:xe.operation_id)}))??null:null,c=(o==null?void 0:o.linked_autoresearch)??null,d=I$(),p=(n==null?void 0:n.workers)??[],_=(a==null?void 0:a.worker_cards)??[],v=d&&p.length>0?p.map(sy):_.map(ay),f=Gt.value.filter(B=>B.status==="active"||B.status==="busy"||B.status==="listening"||B.status==="idle"),h=ae.value.filter(B=>B.status!=="offline"||B.keepalive_running||B.last_heartbeat).sort((B,xe)=>an(xe.last_heartbeat)-an(B.last_heartbeat)),T=d,k=((Lr=e==null?void 0:e.decisions.summary)==null?void 0:Lr.pending)??0,S=ai(s),$=S.items,y=S.total_count,R=S.visible_count,P=S.hidden_count,C=d?(n==null?void 0:n.blockers)??[]:[],M=(a==null?void 0:a.recommended_actions)??[],I=(Pr=a==null?void 0:a.active_recommended_actions)!=null&&Pr.length?a.active_recommended_actions:M,H=a==null?void 0:a.active_summary,Y=(a==null?void 0:a.active_guidance_layer)??"fallback",tt=(a==null?void 0:a.resident_judge_runtime)??(s==null?void 0:s.resident_judge_runtime),G=(a==null?void 0:a.attention_items)??[],L=((zr=n==null?void 0:n.recent_messages[0])==null?void 0:zr.timestamp)??null,x=((Er=n==null?void 0:n.recent_trace_events[0])==null?void 0:Er.timestamp)??null,E=d?L??x??null:null,J=o==null?void 0:o.summary,ht=(d?(Nr=n==null?void 0:n.summary)==null?void 0:Nr.expected_workers:void 0)??(typeof(J==null?void 0:J.planned_worker_count)=="number"?J.planned_worker_count:void 0)??(a==null?void 0:a.worker_cards.length)??0,ie=(d?(jr=n==null?void 0:n.summary)==null?void 0:jr.joined_workers:void 0)??(typeof(J==null?void 0:J.active_agent_count)=="number"?J.active_agent_count:void 0)??v.length,W=C.length>0||k>0||y>0?"warn":T||o?"ok":"warn",vt=d?((wr=e==null?void 0:e.swarm_status)==null?void 0:wr.lanes.filter(B=>B.present))??[]:[],ke=((Dr=(Or=e==null?void 0:e.swarm_status)==null?void 0:Or.narrative)==null?void 0:Dr.lane_id)??((Fr=(qr=e==null?void 0:e.swarm_status)==null?void 0:qr.recommended_next_action)==null?void 0:Fr.lane_id)??((Kr=vt[0])==null?void 0:Kr.lane_id)??null,rt=ke?vt.find(B=>B.lane_id===ke)??null:vt[0]??null,In=[...tt?[ry(tt)]:[],...f.slice(0,t?8:5).map(iy),...h.slice(0,t?8:5).map(oy)],Ps=In.filter(B=>B.source==="agent"),zs=In.filter(B=>B.source==="keeper"||B.source==="resident"),Es=cy({swarmMessages:(n==null?void 0:n.recent_messages)??[],traceEvents:(n==null?void 0:n.recent_trace_events)??[],chainOverlay:l,linkedAutoresearch:c,selectedSession:o,activeRecommendedActions:I,attentionItems:G}),mi=((Br=n==null?void 0:n.operation)==null?void 0:Br.objective)??((Hr=(Ur=e==null?void 0:e.swarm_status)==null?void 0:Ur.narrative)==null?void 0:Hr.active_work)??(o==null?void 0:o.session_id)??"가동 중인 워룸",_i=[(H==null?void 0:H.summary)??null,((Gr=(Wr=e==null?void 0:e.swarm_status)==null?void 0:Wr.narrative)==null?void 0:Gr.state)??null,((Vr=(Jr=e==null?void 0:e.swarm_status)==null?void 0:Jr.narrative)==null?void 0:Vr.active_work)??null,rt?`${rt.label} · ${rt.current_step}`:null].filter(Boolean).join(" · ")||"실제 실행, 메시지, 트레이스, 상주 판단을 한 장에서 읽는 wallboard입니다.",[vi,fi]=$n(typeof document<"u"&&!!document.fullscreenElement);et(()=>{_t()},[]),et(()=>{o!=null&&o.session_id&&he(o.session_id)},[o==null?void 0:o.session_id,s,(Yr=n==null?void 0:n.detachment)==null?void 0:Yr.session_id]),et(()=>{if(!t)return;const B=()=>{fi(!!document.fullscreenElement)};return document.addEventListener("fullscreenchange",B),B(),()=>{document.removeEventListener("fullscreenchange",B)}},[t]);const Mu=()=>{var B,xe,ll;if(!(typeof document>"u")){if(document.fullscreenElement){(B=document.exitFullscreen)==null||B.call(document);return}(ll=(xe=document.documentElement).requestFullscreen)==null||ll.call(xe)}},Lu=()=>{_t(),Zt(),De(),o!=null&&o.session_id&&he(o.session_id)};return!T&&!o?Ea.value||Zn.value?i`<div class="empty-state">실시간 워룸 불러오는 중…</div>`:i`
    ...
    <div class="command-section-stack ${t?"wallboard":""}">
      <section class="command-warroom-strip ${N(W)} ${t?"wallboard":""}">
        <div class="command-warroom-strip-head">
          <div>
            ...
            ${H!=null&&H.summary?i`<div class="command-warroom-guidance ${Wa(Y)}">
                  <strong>${br(Y)}</strong>
                  <span>${H.summary}</span>
                </div>`:null}
          </div>
          <div class="command-warroom-hero-actions">
            ...
            ${t?i`
                  ...
                  <button
                    class="control-btn ghost"
                    onClick=${()=>{var B;document.fullscreenElement&&((B=document.exitFullscreen)==null||B.call(document)),Kt("warroom"),at("command",Ms("warroom"))}}
                  >
                    표준 보기
                  </button>
                `:null}
        ...
        <div class="command-warroom-strip-stats">
          ...
          <div class="monitor-stat-card ${N(C.length>0||k>0||y>0?"warn":"ok")}">
            <span>압력</span>
            <strong>${C.length+k+y}</strong>
            <small>막힘 ${C.length} · 승인 ${k} · 확인 ${R}${P>0?`/${y}`:""}</small>
          </div>
          <div class="monitor-stat-card ${N(Wa(Y))}">
            <span>상주 판정기</span>
            <strong>${di(tt)}</strong>
            <small>${kr(H)}${tt!=null&&tt.model_used?` · ${tt.model_used}`:""}</small>
          </div>
          <div class="monitor-stat-card">
            <span>마지막 신호</span>
            <strong>${Q(E)}</strong>
            <small>${L?"메시지":x?"트레이스":"대기 중"}</small>
          </div>
        </div>
      </section>
      ...
      <div class="command-warroom-grid ${t?"wallboard":""}">
        <div class="command-warroom-column">
                ...
                `:o?i`
                    <article class="command-guide-card">
                      <div class="command-guide-head">
                        ...
                        <span class="command-chip ${N(de(o.status))}">${Ft(o.status)}</span>
                      </div>
          ...
          <section class="card command-section">
            ...
            <${py} chainOverlay=${l} linkedAutoresearch=${c} />
          </section>
        ...
        <div class="command-warroom-column">
          ...
          <section class="card command-section">
            ...
            ${n&&n.recent_trace_events.length>0?i`<div class="command-trace-stack">
                  ${n.recent_trace_events.map(B=>i`<${xr} event=${B} />`)}
        ...
        <div class="command-warroom-column">
          ...
          <section class="card command-section">
            ...
            <div class="command-card-stack">
              ...
              ${C.length>0?C.map(B=>i`<${_u} blocker=${B} />`):i`<div class="command-guide-card ok"><p>지금 보이는 blocker는 없습니다.</p></div>`}
              ${k>0?i`
              ...
              ${y>0?i`
                    <article class="command-guide-card warn">
                      <div class="command-guide-head">
                        <strong>확인 대기</strong>
                        <span class="command-chip warn">${P>0?`${R}/${y}`:y}</span>
                      </div>
                      <p>
                        운영자 미리보기가 사람 확인을 기다리고 있습니다.
                        ${P>0?` 현재 actor 기준으로는 ${R}건만 보입니다.`:""}
                      </p>
                      <div class="command-tag-row">
                        ${$.slice(0,3).map(B=>i`<span class="command-tag">${B.confirm_token}</span>`)}
                      </div>
                    </article>
                  `:null}
              ${rt?i`
                    <article class="command-card compact">
                      <div class="command-card-head">
                        ...
                        <span class="command-chip ${N(de(rt.motion_state))}">${Ft(rt.motion_state)}</span>
                      </div>
                      <div class="command-card-grid">
              ...
              ${d&&(n!=null&&n.detachment)?i`
                    <article class="command-card compact">
                      <div class="command-card-head">
                        ...
                        <span class="command-chip ${N(de(n.detachment.status))}">${Ft(n.detachment.status??"active")}</span>
                      </div>
                      <div class="command-card-grid">
  ...
  `}function Wl(t){switch((t??"").trim().toLowerCase()){case"active":return"가동 중";case"paused":return"일시정지";case"failed":return"실패";case"completed":case"done":return"완료";case"disconnected":return"끊김";case"preview":return"미리보기";case"captured":return"기록됨";default:return(t==null?void 0:t.trim())||"확인 필요"}}function _y({source:t}){const e=wn(null),[n,s]=$n(null);return et(()=>{let a=!1;const o=e.current;return o?(o.innerHTML="",s(null),(async()=>{try{const c=await p$(),{svg:d}=await c.render(`command-chain-${u$()}`,t);if(a||!e.current)return;e.current.innerHTML=d}catch(c){if(a)return;s(c instanceof Error?c.message:"Mermaid 렌더링에 실패했습니다")}})(),()=>{a=!0,e.current&&(e.current.innerHTML="")}):void 0},[t]),i`
    <div class="command-chain-graph-shell">
      ${n?i`<div class="empty-state error">${n}</div>`:null}
      <div class="command-chain-graph" ref=${e}></div>
    </div>
  `}function vy({overlay:t,selected:e,onSelect:n}){const s=t.operation.chain,a=t.runtime;return i`
  ...
  `}function $y({card:t}){const e=t.operation,n=`pause:${e.operation_id}`,s=`resume:${e.operation_id}`,a=`recall:${e.operation_id}`,o=e.chain,l=(o==null?void 0:o.run_id)??null;return i`
    <article class="command-card">
      <div class="command-card-head">
        ...
        <span class="command-chip ${N(e.status==="active"?"ok":e.status==="paused"?"warn":e.status==="failed"?"bad":"ok")}">${Wl(e.status)}</span>
      </div>
      <div class="command-card-grid">
      ...
      <div class="command-action-row">
        ...
        ${e.source==="managed"&&e.status==="active"?i`
              <button class="control-btn ghost" disabled=${ut(n)} onClick=${()=>fe(()=>Cf(e.operation_id))}>
                ${ut(n)?"일시정지 중…":"일시정지"}
              </button>
              <button class="control-btn ghost" disabled=${ut(a)} onClick=${()=>fe(()=>Tf(e.operation_id))}>
                ${ut(a)?"회수 중…":"회수"}
              </button>
            `:null}
        ${e.source==="managed"&&e.status==="paused"?i`
              <button class="control-btn ghost" disabled=${ut(s)} onClick=${()=>fe(()=>Af(e.operation_id))}>
                ${ut(s)?"재개 중…":"재개"}
              </button>
            `:null}
      </div>
    </article>
  `}function hy({card:t}){var n;const e=t.detachment;return i`
    <article class="command-card compact">
      <div class="command-card-head">
        <div>
  ...
  `}function yy(){const t=Jt.value;return i`
    <div class="command-surface-grid">
      <section class="card command-section">
        <div class="card-title-row">
        ...
        ${t&&t.operations.operations.length>0?i`<div class="command-card-stack">
              ${t.operations.operations.map(e=>i`<${$y} card=${e} />`)}
      ...
      <section class="card command-section">
        ...
        ${t&&t.detachments.detachments.length>0?i`<div class="command-card-stack">
              ${t.detachments.detachments.map(e=>i`<${hy} card=${e} />`)}
            </div>`:i`<div class="empty-state">투영된 분견대가 없습니다.</div>`}
      </section>
    </div>
  `}function by(){var c,d,p,_,v,f,h,T,k,S,$,y,R,P,C,M;const t=Cs.value,e=(t==null?void 0:t.operations)??[],n=mn.value,s=e.find(I=>I.operation.operation_id===n)??e[0]??null,a=((c=s==null?void 0:s.operation.chain)==null?void 0:c.run_id)??null,o=((d=es.value)==null?void 0:d.run)??(s==null?void 0:s.preview_run)??null,l=!((p=es.value)!=null&&p.run)&&!!(s!=null&&s.preview_run);return et(()=>{a?xf(a):kf()},[a]),i`
      ...
      <section class="card command-section">
                ...
                <div class="command-chain-list">
                  ${e.map(I=>i`
                    <${vy}
                      ...
                      onSelect=${()=>lr(I.operation.operation_id)}
                    />
                  `)}
                </div>
        ...
        <div class="command-chain-history">
          ...
          ${t&&t.recent_history.length>0?i`
                <div class="command-card-stack">
                  ${t.recent_history.slice(0,6).map(I=>i`<${fy} item=${I} />`)}
                </div>
        ...
        ${s?i`
              <article class="command-card">
                ...
                <div class="command-card-grid">
                  ...
                  <span>경과</span><span>${en((R=s.runtime)==null?void 0:R.elapsed_sec)}</span>
                  <span>최근 갱신</span><span>${Q(((P=s.operation.chain)==null?void 0:P.last_sync_at)??s.operation.updated_at)}</span>
                </div>
                ${(C=s.operation.chain)!=null&&C.goal?i`<div class="command-card-foot">${s.operation.chain.goal}</div>`:null}
              </article>
  ...
  `}function ky(t){switch((t??"").trim().toLowerCase()){case"pending":return"대기 중";case"approved":return"승인됨";case"denied":return"거부됨";case"executed":return"실행됨";case"active":return"가동 중";default:return(t==null?void 0:t.trim())||"확인 필요"}}function xy({decision:t}){const e=`approve:${t.decision_id}`,n=`deny:${t.decision_id}`,s=t.source==="projected_operator";return i`
    <article class="command-card ${N(t.status)}">
      <div class="command-card-head">
        ...
        <span class="command-chip ${N(t.status)}">${ky(t.status??"pending")}</span>
      </div>
      <div class="command-card-grid">
      ...
      ${t.status==="pending"&&!s?i`
            <div class="command-action-row">
              <button class="control-btn ghost" disabled=${ut(e)} onClick=${()=>fe(()=>Rf(t.decision_id))}>
                ${ut(e)?"승인 중…":"승인"}
              </button>
              <button class="control-btn ghost" disabled=${ut(n)} onClick=${()=>fe(()=>Mf(t.decision_id))}>
                ${ut(n)?"거부 중…":"거부"}
              </button>
            </div>
          `:null}
  ...
  `}function Sy({row:t}){var c,d,p;const e=t.unit,n=`freeze:${e.unit_id}`,s=`kill:${e.unit_id}`,a=!!((c=e.policy)!=null&&c.frozen),o=!!((d=e.policy)!=null&&d.kill_switch),l=Math.round((t.utilization??0)*100);return i`
    <article class="command-card compact">
      <div class="command-card-head">
        <div>
      ...
      <div class="command-action-row">
        <button class="control-btn ghost" disabled=${ut(n)} onClick=${()=>fe(()=>Lf(e.unit_id,!a))}>
          ${ut(n)?"적용 중…":a?"동결 해제":"동결"}
        </button>
        <button class="control-btn ghost" disabled=${ut(s)} onClick=${()=>fe(()=>Pf(e.unit_id,!o))}>
          ${ut(s)?"적용 중…":o?"킬 스위치 해제":"킬 스위치 켜기"}
        </button>
      </div>
    </article>
  `}function Cy(){const t=Jt.value;return i`
    <div class="command-surface-grid">
      <section class="card command-section">
        <div class="card-title-row">
        ...
        ${t&&t.decisions.decisions.length>0?i`<div class="command-card-stack">
              ${t.decisions.decisions.map(e=>i`<${xy} decision=${e} />`)}
      ...
      <section class="card command-section">
        ...
        ${t&&t.capacity.capacity.length>0?i`<div class="command-card-stack">
              ${t.capacity.capacity.map(e=>i`<${Sy} row=${e} />`)}
            </div>`:i`<div class="empty-state">제어할 용량 행이 아직 없습니다.</div>`}
      </section>
    </div>
  `}function Ay(){return i`
  ...
  `}function Ty({wallboard:t=!1}){if(X.value==="warroom")return i`<${my} wallboard=${t} />`;if(X.value==="summary")return i`<${sh} />`;if(X.value==="orchestra")return i`<${$h} />`;if(X.value==="swarm")return i`<${Qh} />`;if(!Jt.value)return i`<${ah} />`;switch(X.value){case"chains":return i`<${by} />`;case"topology":return i`<${Oh} />`;case"alerts":return i`<${Dh} />`;case"trace":return i`<${qh} />`;case"control":return i`<${Cy} />`;case"operations":default:return i`<${yy} />`}}function Iy(){const t=X.value==="warroom"&&F.value.params.presentation==="wallboard";return et(()=>{tn(),De(),Sf(),Zt(),Ne()},[]),et(()=>{if(F.value.tab!=="command")return;const e=F.value.params.surface,n=F.value.params.operation,s=As(F.value);if(El(e))Kt(e);else if(s){const a=Pd(s);El(a)&&Kt(a)}else e||Kt("warroom");n&&lr(n),(e==="swarm"||e==="warroom"||e==="orchestra"||X.value==="warroom"||X.value==="orchestra")&&Zt(),(e==="orchestra"||X.value==="orchestra")&&Ne(),(e==="warroom"||X.value==="warroom")&&_t()},[F.value.tab,F.value.params.surface,F.value.params.operation,F.value.params.operation_id,F.value.params.run_id,F.value.params.source,F.value.params.action_type,F.value.params.target_type,F.value.params.target_id,F.value.params.focus_kind]),et(()=>{let e=null;const n=()=>{e||(e=window.setTimeout(()=>{e=null,tn(),De(),(X.value==="swarm"||X.value==="warroom"||X.value==="orchestra")&&Zt(),X.value==="orchestra"&&Ne(),X.value==="warroom"&&_t()},250))},s=new EventSource(h$()),a=f$.map(o=>{const l=()=>n();return s.addEventListener(o,l),{type:o,handler:l}});return s.onerror=()=>{n()},()=>{a.forEach(({type:o,handler:l})=>{s.removeEventListener(o,l)}),s.close(),e&&window.clearTimeout(e)}},[]),et(()=>{const e=window.setInterval(()=>{if(document.visibilityState==="hidden")return;const n=X.value;n!=="swarm"&&n!=="warroom"&&n!=="orchestra"||(tn(),Zt(),n==="orchestra"&&Ne(),n==="warroom"&&_t())},5e3);return()=>{window.clearInterval(e)}},[]),i`
    <section class="dashboard-panel command-plane-view ${t?"wallboard":""}">
      ${t?null:i`
        <div class="panel-header">
          ...
          <div class="panel-actions">
            ...
            <button
              class="control-btn ghost"
              onClick=${()=>{ze(),tn(),De(),Zt(),X.value==="warroom"&&_t()}}
              disabled=${Ia.value}
            >
      ...
      ${t?null:i`<${hr} />`}
      ${t?null:i`<${Q$} />`}
      ${t||X.value==="warroom"?null:i`<${Z$} />`}
      ${t?null:i`<${Ay} />`}
      <${Ty} wallboard=${t} />
    </section>
  `}function Ry(){var S;const t=It.value,e=nr.value,n=(t==null?void 0:t.room)??{},s=ai(t),a=s.items,o=s.confirm_required_actions,l=s.actor_filter,c=s.hidden_count,d=s.hidden_actors,p=(t==null?void 0:t.recent_messages)??[],_=(e==null?void 0:e.recommended_actions)??[],v=(S=e==null?void 0:e.active_recommended_actions)!=null&&S.length?e.active_recommended_actions:_,f=e==null?void 0:e.active_summary,h=(e==null?void 0:e.resident_judge_runtime)??(t==null?void 0:t.resident_judge_runtime),T=(e==null?void 0:e.active_guidance_layer)??"fallback",k=p.slice(0,5);return i`
      ...
      <section class="card ops-panel ops-lane-panel">
        ...
        <div class="control-row ops-split-row">
          <input
            ...
            disabled=${it.value}
          />
          <button class="control-btn ghost" onClick=${()=>{Lh()}} disabled=${it.value}>
            일시정지
          </button>
        ...
        <div class="control-row ops-split-row">
          ...
          <button class="control-btn" onClick=${()=>{Ph()}} disabled=${it.value||fn.value.trim()===""}>
            주입
          </button>
        </div>
      </section>
              ...
              <article key=${`${$.action_type}:${$.target_type}:${$.target_id??"room"}`} class="ops-log-entry ${$.severity}">
                ...
                ${$.suggested_payload?i`
                  <div class="ops-confirmation-actions">
                    <button class="control-btn ghost" onClick=${()=>{Rh($)}} disabled=${it.value}>
                      폼에 채우기
                    </button>
                  </div>
                `:null}
  ...
  `}const Ge=g(""),Mi=g(!1),Hs=g(null);function My(){var $;const t=It.value,e=Ht.value,n=(t==null?void 0:t.sessions)??[],s=((t==null?void 0:t.available_actions)??[]).filter(y=>y.target_type==="team_session"),a=n.find(y=>y.session_id===yn.value)??n[0]??null,o=e==null?void 0:e.active_summary,l=(e==null?void 0:e.active_guidance_layer)??"fallback",c=(e==null?void 0:e.resident_judge_runtime)??(t==null?void 0:t.resident_judge_runtime),d=(a==null?void 0:a.linked_autoresearch)??null,p=it.value||Mi.value,_=($=e==null?void 0:e.active_recommended_actions)!=null&&$.length?e.active_recommended_actions:(e==null?void 0:e.recommended_actions)??[],v=async()=>{await _t(),a!=null&&a.session_id&&await he(a.session_id)},f=async y=>{Mi.value=!0,Hs.value=null;try{await y(),await v()}catch(R){Hs.value=R instanceof Error?R.message:"Autoresearch action failed"}finally{Mi.value=!1}},h=async()=>{d!=null&&d.loop_id&&await f(()=>dp(d.loop_id))},T=async()=>{if(!(d!=null&&d.loop_id)||!Ge.value.trim())return;const y=Ge.value.trim();await f(()=>up(d.loop_id,y)),Ge.value=""},k=async()=>{d!=null&&d.loop_id&&await f(()=>pp(d.loop_id))},S=async()=>{d!=null&&d.loop_id&&await f(()=>mp(d.loop_id,"dashboard stop request"))};return i`
    <div class="ops-column">
      <section class="card ops-panel ops-lane-panel">
        <div class="card-title-row">
        ...
        <div class="ops-entity-list">
          ${n.length===0?i`<div class="ops-empty">지금 활성 team session이 없습니다.</div>`:n.map(y=>{var R;return i`
            <button
              key=${y.session_id}
            ...
            >
              ...
              <div class="ops-entity-meta">
                ...
                <span>${(R=y.team_health)!=null&&R.status?sn(String(y.team_health.status)):"상태 확인 필요"}</span>
              </div>
            </button>
          `})}
        </div>
      ...
      <section class="card ops-panel ops-lane-panel">
        ...
        ${d!=null&&d.loop_id?i`
          ...
          <div class="control-row ops-split-row">
            ...
            <button class="control-btn ghost" onClick=${()=>{S()}} disabled=${p}>
              loop 중지
            </button>
          </div>
          <textarea
        ...
        <div class="control-row ops-split-row">
          ...
          <button class="control-btn" onClick=${()=>{zh()}} disabled=${p||!a}>
            적용
          </button>
        </div>
        <div class="ops-context-note">현재 선택: ${Ch(Ct.value)}</div>
        ...
        <div class="control-row ops-split-row">
          <input
            ...
            disabled=${p||!a}
          />
          <button class="control-btn ghost" onClick=${()=>{Eh()}} disabled=${p||!a}>
            세션 중지
          </button>
        </div>
      </section>
    </div>
  `}function Ly(){var o;const t=It.value,e=(t==null?void 0:t.keepers)??[],n=(t==null?void 0:t.persistent_agents)??[],s=(t==null?void 0:t.available_actions)??[],a=e.find(l=>l.name===Io.value)??e[0]??null;return i`
    <div class="ops-column">
  ...
  `}function Py(){var R,P;const t=It.value,e=F.value.tab==="intervene"?As(F.value):null,n=nr.value,s=(t==null?void 0:t.room)??{},a=(t==null?void 0:t.sessions)??[],o=(t==null?void 0:t.keepers)??[],l=ai(t),c=l.visible_count,d=l.total_count,p=l.hidden_count,_=l.actor_filter,v=a.find(C=>C.session_id===yn.value)??a[0]??null,f=(n==null?void 0:n.attention_items)??[],h=f.filter(xh),T=f.filter(Sh),k=a.filter(C=>kh(C)!=="ok"),S=o.filter(C=>Ri(C)!=="ok"),$=Mh(e,a,o);et(()=>{Fe()},[]),et(()=>{if(F.value.tab!=="intervene"){Us.value=null;return}if(!e){Us.value=null;return}Us.value!==e.id&&(Us.value=e.id,Ih(e))},[F.value.tab,F.value.params.source,F.value.params.action_type,F.value.params.target_type,F.value.params.target_id,F.value.params.focus_kind,e==null?void 0:e.id]),et(()=>{const C=(v==null?void 0:v.session_id)??null;he(C)},[v==null?void 0:v.session_id]);const y=[{key:"room",label:"방 게이트",value:s.paused?"일시정지":"열림",detail:s.paused?`재개 전환 대기 중${s.pause_reason?` · ${s.pause_reason}`:""}`:"지금은 새 액션과 새 작업을 바로 받을 수 있습니다",tone:s.paused?"bad":"ok"},{key:"confirm",label:"확인 대기",value:p>0?`${c}/${d}`:c,detail:c>0?"미리보기만 된 개입이 아직 사람 확인을 기다리고 있습니다":p>0&&_?`현재 개입 ID(${_}) 기준으로는 비어 있고, 다른 개입 ID 대기 ${p}건이 있습니다`:"지금 막혀 있는 확인 대기는 없습니다",tone:d>0?"warn":"ok"},{key:"session",label:"세션 리스크",value:h.length>0?h.length:a.length,detail:h.length>0?((R=h[0])==null?void 0:R.summary)??"세션 중 하나가 방향 수정이나 중지 판단을 기다리고 있습니다":a.length===0?"지금 관리 중인 팀 세션이 없습니다":"세션 쪽 긴급 주의 신호는 현재 없습니다",tone:h.length>0?Kl(h):a.length===0?"warn":k.some(C=>bn(C.status)==="paused")?"bad":k.length>0?"warn":"ok"},{key:"keeper",label:"키퍼 압력",value:T.length>0?T.length:S.length,detail:T.length>0?((P=T[0])==null?void 0:P.summary)??"직접 메시지나 상태 점검이 필요한 키퍼가 있습니다":S.length>0?"오래됐거나 오프라인이거나 텔레메트리가 비는 키퍼가 보입니다":"지금은 키퍼 쪽이 비교적 안정적입니다",tone:T.length>0?Kl(T):S.some(C=>Ri(C)==="bad")?"bad":S.length>0?"warn":"ok"}];return i`
    <section class="ops-view">
      ...
      <div class="ops-header card">
        ...
        <div class="ops-toolbar">
          ...
          <input
            ...
            type="text"
            value=${ci.value}
            onInput=${C=>bh(C.target.value)}
          />
            <button
              class="control-btn ghost"
              onClick=${()=>{ze(),_t(),Fe(),he((v==null?void 0:v.session_id)??null)}}
      ...
      ${(()=>{const C=[];if((c>0||p>0)&&C.push({label:p>0?`확인 대기 ${c}/${d}건 확인`:`확인 대기 ${c}건 처리`,desc:p>0&&_?`현재 개입 ID(${_}) 기준으로 보이는 대기열을 먼저 확인합니다`:"승인 또는 거부가 필요한 개입이 대기 중입니다",tone:c>0?"bad":"warn",onClick:()=>{const M=document.querySelector(".ops-pending-section");M==null||M.scrollIntoView({behavior:"smooth"})}}),s.paused&&C.push({label:"방 재개",desc:`현재 일시정지 상태${s.pause_reason?` (${s.pause_reason})`:""}`,tone:"warn",onClick:()=>void ou()}),S.length>0){const M=S.filter(I=>Ri(I)==="bad");C.push({label:M.length>0?`오프라인 키퍼 ${M.length}개`:`점검이 필요한 키퍼 ${S.length}개`,desc:M.length>0?"메시지를 보내거나 상태를 확인하세요":"오래됐거나 텔레메트리가 비어 있습니다",tone:M.length>0?"bad":"warn",onClick:()=>{const I=document.querySelector(".ops-keeper-section");I==null||I.scrollIntoView({behavior:"smooth"})}})}return C.length===0?null:i`
  ...
  `}function zy({text:t}){if(!t)return null;const e=Ey(t);return i`<div class="markdown-content">${e}</div>`}function Ey(t){const e=t.split(`
...
`))}</p>`)}return n}function Li(t){const e=[],n=/(`[^`]+`)|(\*\*[^*]+\*\*)|(\*[^*]+\*)|\[([^\]]+)\]\(([^)]+)\)/g;let s=0,a;for(;(a=n.exec(t))!==null;){if(a.index>s&&e.push(t.slice(s,a.index)),a[1]){const o=a[1].slice(1,-1);e.push(i`<code>${o}</code>`)}else if(a[2]){const o=a[2].slice(2,-2);e.push(i`<strong>${o}</strong>`)}else if(a[3]){const o=a[3].slice(1,-1);e.push(i`<em>${o}</em>`)}else a[4]&&a[5]&&e.push(i`<a href=${a[5]} target="_blank" rel="noopener">${a[4]}</a>`);s=a.index+a[0].length}return s<t.length&&e.push(t.slice(s)),e.length>0?e:[t]}const vu=[{id:"recent",label:"최신순"},{id:"hot",label:"인기순"},{id:"trending",label:"급상승"},{id:"updated",label:"최근 갱신"},{id:"discussed",label:"토론 많은 순"}],ua=g(null),pa=g([]),kn=g(!1),Oe=g(null),Bn=g(""),Un=g(!1),on=g(!0),Sr=20,Ye=g(Sr);function Ny(){var e,n;const t=new URLSearchParams(window.location.search);return((e=t.get("agent"))==null?void 0:e.trim())||((n=t.get("agent_name"))==null?void 0:n.trim())||"dashboard-user"}const jy=g(Ny());function wy(t){const e=t.replace(/!\[[^\]]*\]\([^)]+\)/g," ").replace(/\[[^\]]+\]\([^)]+\)/g,"$1").replace(/[`#>*_~-]/g," ").replace(/\s+/g," ").trim();return e?e.length>180?`${e.slice(0,177)}...`:e:"미리보기 없음"}function Gl(t){return t.updated_at!==t.created_at}function Oy(t){if(t.post_kind)return t.post_kind==="automation";const e=(t.hearth??"").toLowerCase();return t.visibility!=="internal"||!t.expires_at||!e?!1:!!(e.startsWith("mdal")||e.includes("harness"))}function Dy(t){return t==="lodge-system"||t==="team-session"}function ms(t){return t.post_kind?t.post_kind:Dy(t.author)?"system":Oy(t)?"automation":"human"}function fu(t){const e=[],n=[];let s=0;return t.forEach(a=>{const o=ms(a);if(!(o==="system"&&Le.value)){if(o==="automation"&&on.value){s+=1;return}if(o==="human"){e.push(a);return}n.push(a)}}),{human:e,operations:n,hiddenAutomation:s}}function qy(t){if(!t.expires_at)return null;const e=Date.parse(t.expires_at);return Number.isFinite(e)?e<=Date.now()?i`<span class="board-meta-chip">만료됨</span>`:i`<span class="board-meta-chip">만료까지 <${Z} timestamp=${t.expires_at} /></span>`:null}async function Cr(t){Oe.value=t,ua.value=null,pa.value=[],kn.value=!0;try{const e=await Qp(t);if(Oe.value!==t)return;ua.value={id:e.id,author:e.author,title:e.title,body:e.body,content:e.content,meta:e.meta,tags:e.tags,votes:e.votes,vote_balance:e.vote_balance,comment_count:e.comment_count,created_at:e.created_at,updated_at:e.updated_at,post_kind:e.post_kind,flair:e.flair,hearth:e.hearth,visibility:e.visibility,expires_at:e.expires_at,hearth_count:e.hearth_count},pa.value=e.comments??[]}catch{Oe.value===t&&(ua.value=null,pa.value=[])}finally{Oe.value===t&&(kn.value=!1)}}async function Jl(t){const e=Bn.value.trim();if(e){Un.value=!0;try{await Zp(t,jy.value,e),Bn.value="",O("댓글을 등록했습니다","success"),await Cr(t),me()}catch{O("댓글 등록에 실패했습니다","error")}finally{Un.value=!1}}}function Fy(){const t=Xn.value,e=on.value?"자동화 글 숨김":"자동화 글 표시 중";return i`
  ...
  `}function Pi(){var s;const t=((s=vu.find(a=>a.id===Xn.value))==null?void 0:s.label)??Xn.value,e=fu(si.value),n=e.human.length+e.operations.length;return i`
    <div class="board-summary-strip">
      ...
      <div class="board-summary-item">
        ...
        <strong>${vo.value?i`<${Z} timestamp=${vo.value} />`:"아직 불러오지 않음"}</strong>
      </div>
    </div>
  `}function Vl({post:t}){const e=async(n,s)=>{s.stopPropagation();try{await Ac(t.id,n),me()}catch{O("투표에 실패했습니다","error")}};return i`
      ...
      <div class="post-content">
        <div class="post-head">
          ...
          <div class="post-meta">
            ...
            ${Gl(t)?i`<span>수정 <${Z} timestamp=${t.updated_at} /></span>`:null}
  ...
  `}function Ky({comments:t}){return t.length===0?i`<div class="empty-state" style="font-size:13px">아직 댓글이 없습니다</div>`:i`
  ...
  `}function Uy({post:t}){Oe.value!==t.id&&!kn.value&&Cr(t.id);const e=async n=>{try{await Ac(t.id,n),me()}catch{O("Failed to vote","error")}};return i`
    <div>
      <button class="back-btn" onClick=${()=>at("memory")}>← 메모리로 돌아가기</button>
      <${z} title=${t.title} semanticId="memory.feed">
      ...
      <${z} title="댓글" semanticId="memory.feed">
        ${kn.value?i`<div class="loading-indicator">댓글 불러오는 중...</div>`:i`<${Ky} comments=${pa.value} />`}
        <${By} postId=${t.id} />
      <//>
    </div>
  `}function Hy(){const t=fu(si.value),e=[...t.human,...t.operations],n=F.value.params.post??null,s=n?e.find(a=>a.id===n)??(Oe.value===n?ua.value:null):null;return n&&!s&&Oe.value!==n&&!kn.value&&Cr(n),n?s?i`
          <${At} surfaceId="memory" />
          <${Pi} />
          <${Uy} post=${s} />
        `:i`
    ...
    <div>
      ...
      ${Qn.value?i`<div class="loading-indicator">메모리 피드 불러오는 중...</div>`:e.length===0?i`<div class="empty-state">지금은 남아 있는 메모리 글이 없습니다</div>`:i`
              <${z} title="사람이 쓴 글" class="section" semanticId="memory.feed">
              ...
              ${t.operations.length>0?i`
                    <${z} title="자동화 · 시스템" class="section" semanticId="memory.feed">
                      <div class="board-post-list">
  ...
  `}function Wy({ratio:t,size:e=40,stroke:n=4}){if(t==null)return null;const s=(e-n)/2,a=e/2,o=2*Math.PI*s,l=o*((100-t*100)/100);let c="mitosis-safe";return t>=.8?c="mitosis-critical":t>=.5&&(c="mitosis-warn"),i`
    ...
    <article class=${o}>
      <button class=${l} data-testid=${s} onClick=${e}>
        ...
        <div class=${n==="mission"?"mission-activity-meta":"monitor-meta"}>
          ...
          <span>컨텍스트 ${Gy(t.contextRatio)}</span>
        </div>
  ...
  `}const Re=g(null),Xt=g(null),Qt=g(null);function _s(t){return t==="bad"||t==="critical"||t==="offline"?"bad":t==="warn"||t==="paused"||t==="blocked"||t==="interrupted"?"warn":"ok"}function vs(t){switch((t??"").trim().toLowerCase()){case"ok":case"healthy":case"green":return"안정";case"active":case"running":return"진행 중";case"paused":return"일시정지";case"blocked":return"막힘";case"interrupted":return"중단됨";case"warn":return"주의";case"bad":case"critical":return"위험";case"offline":return"오프라인";case"idle":case"quiet":return"대기";case"unknown":case"":return"확인 필요";default:return(t==null?void 0:t.trim())||"확인 필요"}}function Vy(t){return t==="session"?"세션":"작전"}function Yy(t){return t?ae.value.find(e=>e.name===t||e.agent_name===t)??null:null}function Xy(t){switch(t){case"working":return"작업 중";case"watching":return"대기 중";case"quiet":return"조용함";case"offline":return"오프라인"}}function Qy(t){switch(t){case"live":return"최근 신호(≤5m)";case"stale":return"오래된 신호(>5m)";case"absent":return"signal 없음";default:return t??"signal 미상"}}function Zy(t){switch(t){case"message":return"최근 출력";case"presence":return"presence/하트비트";case"none":return"근거 없음";default:return t??"근거 미상"}}function tb(t){switch(t){case"critical":return"위험";case"warning":return"주의";default:return"정상"}}function eb(t){switch(t){case"acted":return"행동";case"passed":return"판단 패스";case"skipped":return"시스템 스킵";case"failed":return"실패";default:return t}}function nb(t){switch(t){case"post":return"post";case"comment":return"comment";case"vote":return"vote";case"none":case null:case void 0:return"없음";default:return t}}function Xl(t){if(!t)return;const e=Ff({targetType:t.target_type,targetId:t.target_id,focusKind:t.focus_kind,operationId:t.operation_id??null,commandSurface:t.command_surface??null,sourceLabel:"실행 진단",summary:t.label});Md(e),at(t.surface,t.surface==="intervene"?Ld(e):zd(e))}function Pn({label:t,value:e,color:n,caption:s}){return i`
    <div class="stat-card">
  ...
  `}function sb({item:t,selected:e}){return i`
    <button
  ...
  `}function ab({brief:t,selected:e}){const n=t.active_count??0,s=t.seen_count??n,a=t.planned_count??t.member_names.length;return i`
    <button
      class="mission-card-select ${e?"active":""}"
  ...
  `}function ib({brief:t,selected:e}){return i`
    <button
      class="mission-card-select ${e?"active":""}"
  ...
  `}function ob({tick:t}){return t?i`
    <div class="monitor-nested-card">
      <div class="stats-grid">
        <${Pn} label="검토" value=${t.checked??0} color="#22d3ee" />
        <${Pn} label="행동" value=${t.acted??0} color="#4ade80" />
        <${Pn} label="판단 패스" value=${t.passed??0} color="#94a3b8" />
        <${Pn} label="시스템 스킵" value=${t.skipped??0} color="#fbbf24" />
        <${Pn} label="실패" value=${t.failed??0} color="#fb7185" />
      </div>
  ...
  `:i`<div class="empty-state">최근 social activity 기록이 없습니다.</div>`}function rb({row:t}){return i`
    <button
    ...
    >
      <div class="monitor-row-header">
        ...
        <span class="monitor-pill ${_s(t.outcome==="failed"?"bad":t.outcome==="skipped"?"warn":"ok")}">${eb(t.outcome)}</span>
      </div>
        <div class="monitor-meta">
        <span>trigger · ${t.trigger??"unknown"}</span>
        ${t.checked_at?i`<span><${Z} timestamp=${t.checked_at} /></span>`:null}
        <span>action · ${nb(t.action_kind)}</span>
      </div>
  ...
  `}function Ql({row:t,testId:e}){return i`
    <button class="monitor-row ${t.tone} state-${t.state}" data-testid=${e} onClick=${()=>Is(t.name)}>
      <div class="monitor-row-header">
        ...
        <span class="monitor-pill ${t.tone} state-${t.state}">${Xy(t.state)}</span>
      </div>

      <div class="monitor-meta">
        ${t.last_signal_at?i`<span>신호 <${Z} timestamp=${t.last_signal_at} /></span>`:i`<span>최근 신호 없음</span>`}
        <span>${Qy(t.signal_truth)} · ${Zy(t.evidence_source)}</span>
  ...
  `}function lb({row:t}){const e=()=>{const a=Yy(t.name);a&&Hd(a)},n=dg(t.name,t.agent_name),s={name:t.name,koreanName:t.korean_name??null,runtimeLabel:n,emoji:t.emoji??null,tone:t.tone,statusRaw:t.status??null,statusLabel:vs(t.status),stateClass:t.state,stateLabel:tb(t.state),contextRatio:t.context_ratio??null,note:t.note,focus:t.focus,lastActivityAt:t.last_signal_at??null,lastActivityFallback:"최근 활동 없음",relatedSessionId:t.related_session_id??null,continuity:t.continuity??null,lifecycle:t.lifecycle??null,summary:t.continuity_summary??t.recent_output_preview??null,recentInput:t.recent_input_preview??null,recentOutput:t.recent_output_preview??null,recentTools:t.recent_tool_names??[],allowedTools:t.allowed_tool_names??[],routeSummary:t.skill_route_summary??null,auditSource:t.tool_audit_source??null,auditAt:t.tool_audit_at??null,disclosureLabel:"연속성 상세"};return i`<${Jy}
    variant="execution"
    model=${s}
    onClick=${e}
    testId="execution.continuity-card"
  />`}function cb(){const t=Pc.value,e=zc.value,n=Ec.value,s=Nc.value,a=jc.value,o=wc.value,l=Yo.value,c=Oc.value;Re.value&&!t.some($=>$.id===Re.value)&&(Re.value=null),Xt.value&&!e.some($=>$.session_id===Xt.value)&&(Xt.value=null),Qt.value&&!n.some($=>$.operation_id===Qt.value)&&(Qt.value=null);const d=Re.value?t.find($=>$.id===Re.value)??null:null,p=Xt.value?Xt.value:d?d.kind==="session"?d.target_id:d.linked_session_id??null:null,_=Qt.value?Qt.value:d?d.kind==="operation"?d.target_id:d.linked_operation_id??null:null,v=p?e.filter($=>$.session_id===p):_?e.filter($=>$.linked_operation_id===_):e,f=_?n.filter($=>$.operation_id===_):p?n.filter($=>{var y;return $.linked_session_id===p||$.operation_id===((y=v[0])==null?void 0:y.linked_operation_id)}):n,h=p||_?s.filter($=>(p?$.related_session_id===p:!1)||(_?$.related_operation_id===_:!1)):s,T=p?l.filter($=>$.related_session_id===p||$.tone!=="ok"):l,k=p?o.filter($=>v.some(y=>y.member_names.includes($.agent_name))):o,S=p||_?c.filter($=>(p?$.related_session_id===p:!1)||(_?$.related_operation_id===_:!1)||$.tone!=="ok"):c;return i`
    <div class="agents-monitor">
      ...
      >
        ...
        <div class="monitor-alert-list">
          ${t.length===0?i`<div class="empty-state">지금은 막힌 실행이 없습니다.</div>`:t.map($=>i`<${sb} key=${$.id} item=${$} selected=${Re.value===$.id} />`)}
        </div>
      <//>
      ...
      <div class="agents-workbench">
        ...
        >
          ...
          <div class="monitor-list">
            ${v.length===0?i`<div class="empty-state">선택된 실행과 연결된 세션이 없습니다.</div>`:v.map($=>i`<${ab} key=${$.session_id} brief=${$} selected=${Xt.value===$.session_id} />`)}
          </div>
        <//>
        ...
        >
          ...
          <div class="monitor-list">
            ${f.length===0?i`<div class="empty-state">선택된 실행과 연결된 작전이 없습니다.</div>`:f.map($=>i`<${ib} key=${$.operation_id} brief=${$} selected=${Qt.value===$.operation_id} />`)}
          </div>
        <//>
        ...
        >
          ...
          <${ob} tick=${a} />
          <div class="monitor-list">
            ${k.length===0?i`<div class="empty-state">최근 social activity 기록이 없습니다.</div>`:k.map($=>i`<${rb} key=${`${$.agent_name}-${$.checked_at??$.outcome}`} row=${$} />`)}
          </div>
        <//>
        ...
        >
          ...
          <div class="monitor-list">
            ${T.length===0?i`<div class="empty-state">지금은 연속성 경고가 없습니다.</div>`:T.map($=>i`<${lb} key=${$.name} row=${$} />`)}
          </div>
        <//>
        ...
        >
          ...
          <div class="monitor-list">
            ${S.length===0?i`<div class="empty-state">지금은 오프라인 작업자가 없습니다.</div>`:S.map($=>i`<${Ql} key=${$.name} row=${$} testId="execution.offline-worker-card" />`)}
          </div>
        <//>
      </div>
    </div>
  `}const Ro=g(null),Mo=g(null),Hn=g(!1);async function Zl(){if(!Hn.value){Hn.value=!0,Mo.value=null;try{Ro.value=await Rp()}catch(t){Mo.value=t instanceof Error?t.message:String(t)}finally{Hn.value=!1}}}function db(t){switch(t){case"essential":return"badge-essential";case"standard":return"badge-standard";default:return"badge-full"}}function ub({items:t,maxCount:e}){return t.length===0?i`<p class="muted">No tool calls recorded yet.</p>`:i`
    <div class="tool-bar-chart">
      ${t.map(n=>{const s=e>0?n.call_count/e*100:0;return i`
          <div class="tool-bar-row" key=${n.name}>
            ...
            <span class="tool-bar-tier ${db(n.tier)}">${n.tier}</span>
  ...
  `}function pb({dist:t}){const e=t.full,n=e>0?(t.essential/e*100).toFixed(1):"0",s=e>0?(t.standard/e*100).toFixed(1):"0",a=e-t.standard,o=e>0?(a/e*100).toFixed(1):"0";return i`
    <div class="tier-dist">
  ...
  `}function mb(){const t=Ro.value,e=Hn.value,n=Mo.value;return et(()=>{!Ro.value&&!Hn.value&&Zl()},[]),i`
  ...
  `}function fb(){const t=Lo.value,e=Wn.value,n=Po.value,s=(t==null?void 0:t.tool_inventory.tools)??[],a=(t==null?void 0:t.tool_usage)??null;et(()=>{!Lo.value&&!Wn.value&&tc()},[]),et(()=>{var h;if(F.value.tab!=="tools")return;const f=(h=F.value.params.q)==null?void 0:h.trim();f&&f!==zn.value&&(zn.value=f)},[F.value.tab,F.value.params.q]);const o=Array.from(new Set(s.map(f=>f.category))).sort((f,h)=>f.localeCompare(h)),l=s.filter(f=>!(!_b(f,zn.value)||Ws.value!=="all"&&f.category!==Ws.value||zi.value&&!f.enabled_in_current_mode||Ei.value&&!f.direct_call_allowed||!Ni.value&&f.visibility==="hidden"||!ji.value&&f.lifecycle==="deprecated")),c=s.length,d=s.filter(f=>f.enabled_in_current_mode).length,p=s.filter(f=>f.visibility==="hidden").length,_=s.filter(f=>f.lifecycle==="deprecated").length,v=s.filter(f=>f.direct_call_allowed).length;return i`
    <div>
      <${z} title="System Tool Inventory" class="section">
        <div class="monitor-section-head">
        ...
        <div class="tool-inventory-list">
          ${l.length>0?l.map(f=>i`<${vb} key=${f.name} item=${f} />`):i`<div class="empty-state">No tools matched the current filters.</div>`}
        </div>
      <//>

      <${z} title="Tool Usage" class="section">
        ${a?i`
  ...
  `}const Ja=g("all"),Va=g("all"),zo=g(new Set);function gb(t){const e=new Set(zo.value);e.has(t)?e.delete(t):e.add(t),zo.value=e}const gu=Nt(()=>{let t=cn.value;return Ja.value!=="all"&&(t=t.filter(e=>e.horizon===Ja.value)),Va.value!=="all"&&(t=t.filter(e=>e.status===Va.value)),t}),$b=Nt(()=>{const t={short:[],mid:[],long:[]};for(const e of gu.value){const n=t[e.horizon];n&&n.push(e)}return t}),hb=Nt(()=>{const t=Array.from(qc.value.values());return t.sort((e,n)=>e.status==="running"&&n.status!=="running"?-1:n.status==="running"&&e.status!=="running"?1:e.status==="interrupted"&&n.status!=="interrupted"?-1:n.status==="interrupted"&&e.status!=="interrupted"?1:n.elapsed_seconds-e.elapsed_seconds),t});function yb(t){return"★".repeat(Math.min(t,5))+"☆".repeat(Math.max(0,5-t))}function Tr(t){switch(t){case"short":return"단기";case"mid":return"중기";case"long":return"장기";default:return t}}function ma(t){switch(t){case"short":return"#4ade80";case"mid":return"#f59e0b";case"long":return"#818cf8";default:return"#888"}}function bb(t){return t<60?`${Math.round(t)}s`:t<3600?`${Math.floor(t/60)}m ${Math.round(t%60)}s`:`${Math.floor(t/3600)}h ${Math.floor(t%3600/60)}m`}function ec(t){return t.toFixed(4)}function nc(t){const e=t.current_metric-t.baseline_metric;return`${e>=0?"+":""}${e.toFixed(4)}`}function kb(t){switch(t){case 1:return"P1";case 2:return"P2";case 3:return"P3";default:return"P4"}}function xb(t){switch(t){case"active":return"진행 중";case"completed":return"완료";case"paused":return"일시정지";default:return"전체"}}function sc(t,e){return(t.priority??4)-(e.priority??4)}function Sb(t,e){const n=t.updated_at??t.created_at??"";return(e.updated_at??e.created_at??"").localeCompare(n)}function Cb(t,e){return t.length<=e?t:t.slice(0,e)+"..."}function Ab({goal:t}){return i`
    <div class="goal-row">
      <div class="goal-row-main">
        ...
        <div class="goal-meta">
          <span class="goal-priority" title="Priority ${t.priority}">${yb(t.priority)}</span>
  ...
  `}function wi({horizon:t,items:e}){if(e.length===0)return null;const n=[...e].sort((s,a)=>a.priority-s.priority);return i`
    <${z} title="${Tr(t)} 목표 (${e.length})" class="section" semanticId="planning.goal_pipeline">
      <div class="goal-list">
        ${n.map(s=>i`<${Ab} key=${s.id} goal=${s} />`)}
      </div>
    <//>
  `}function Tb(){return i`
  ...
  `}function Ib(){const t=cn.value,e=t.filter(a=>a.status==="active").length,n=t.filter(a=>a.status==="completed").length,s={short:0,mid:0,long:0};for(const a of t)a.horizon in s&&s[a.horizon]++;return i`
  ...
  `}function Rb({loop:t}){const e=t.history[0],n=t.latest_tool_names&&t.latest_tool_names.length>0?`${t.latest_tool_call_count??t.latest_tool_names.length}개 도구: ${t.latest_tool_names.join(", ")}`:"아직 근거 없음";return i`
    <div class="planning-loop-row">
      <div class="planning-loop-main">
        ...
        <div class="planning-loop-metrics">
          ...
          <span>Elapsed ${bb(t.elapsed_seconds)}</span>
        </div>
  ...
  `}function Oi({task:t}){const e=t.priority??4,n=e<=1?"p1":e===2?"p2":e===3?"p3":"p4",s=zo.value.has(t.id),a=!!t.description;return i`
    <div class="kanban-card ${n}">
      <div class="kanban-card-header">
        <span class="priority-badge priority-badge--${n}">${kb(e)}</span>
      ...
      ${a?i`
        <div
          ...
          onClick=${()=>gb(t.id)}
        >
          ${s?t.description:Cb(t.description??"",80)}
        </div>
      `:null}
  ...
  `}function Mb(){const{todo:t,inProgress:e,done:n}=Kc.value,s=[...t].sort(sc),a=[...e].sort(sc),o=[...n].sort(Sb);return i`
    <${z} title="태스크 백로그" class="section" semanticId="planning.backlog">
  ...
  `}function Lb(){const{todo:t,inProgress:e,done:n}=Kc.value,s=t.length+e.length+n.length,a=[...t,...e].filter(_=>(_.priority??4)<=2).length,o=$b.value,l=hb.value,c=cn.value.length>0,d=l.length>0,p=Xo.value;return i`
    <div>
        ...
        <div>
          ${Dn.value&&l.length===0?i`<div class="loading-indicator">MDAL 루프 불러오는 중...</div>`:l.length===0&&(p==="error"||dn.value)?i`<div class="empty-state">MDAL 스냅샷을 불러오지 못했습니다${dn.value?`: ${dn.value}`:""}. 백엔드 상태를 확인하세요.</div>`:l.length===0?i`<div class="empty-state">가동 중인 루프가 없습니다. <code>masc_mdal_start</code>로 시작할 수 있습니다.</div>`:i`
                  <div class="planning-loop-list">
                    ${l.map(_=>i`<${Rb} key=${_.loop_id} loop=${_} />`)}
                  </div>
                `}
        </div>
      </details>
    </div>
  `}const Ya=g(!1),Gn=g(!1),rn=g(!1),Xa=g(!1),se=g(""),Jn=g(""),Vn=g(""),Eo=g("support"),No=g("open"),xn=g(null),fs=g(null),gs=g(null),jo=g(!1);function $s(t){return`${t.kind}:${t.id}`}function ui(){var n;const t=fs.value,e=((n=xn.value)==null?void 0:n.items)??[];return t?e.find(s=>$s(s)===t)??null:null}function Pb(t){const e=t.trim().toLowerCase();return e!=="executed"&&e!=="blocked"&&e!=="closed"}function $u(t){switch(No.value){case"pending_ruling":return t.filter(e=>e.status==="pending_ruling");case"needs_human_gate":return t.filter(e=>e.status==="needs_human_gate");case"executed":return t.filter(e=>e.status==="executed");case"blocked":return t.filter(e=>e.status==="blocked"||e.status==="closed");case"open":default:return t.filter(e=>Pb(e.status))}}function zb(t){if(t==null)return"없음";if(typeof t=="string")return t;try{return JSON.stringify(t,null,2)}catch{return String(t)}}function Ir(t){const e=(t||"").toLowerCase();return e.includes("block")||e.includes("deny")||e.includes("closed")?"negative":e.includes("support")||e.includes("approve")||e.includes("ready")||e.includes("executed")||e.includes("done")?"positive":"neutral"}function Eb(t){return typeof t!="number"||Number.isNaN(t)?"판정 대기":`${Math.round(t*100)}%`}async function hu(t){if(gs.value=null,!!t){jo.value=!0,se.value="";try{gs.value=await Tc(t.id)}catch(e){se.value=e instanceof Error?e.message:"거버넌스 상세를 불러오지 못했습니다"}finally{jo.value=!1}}}async function Nb(t){fs.value=$s(t),await hu(t)}async function Be(){Ya.value=!0,se.value="";try{const t=await kp();xn.value=t;const e=$u(t.items??[]),n=fs.value,s=e.find(a=>$s(a)===n)??e[0]??null;fs.value=s?$s(s):null,await hu(s)}catch(t){se.value=t instanceof Error?t.message:"거버넌스 상태를 불러오지 못했습니다"}finally{Ya.value=!1}}G_(Be);async function ac(){const t=Jn.value.trim();if(t){Gn.value=!0;try{const e=await Cm(t);Jn.value="",O(e!=null&&e.case.id?`청원을 접수했습니다: ${e.case.id}`:"청원을 접수했습니다","success"),await Be()}catch(e){const n=e instanceof Error?e.message:"청원 접수에 실패했습니다";se.value=n,O(n,"error")}finally{Gn.value=!1}}}async function jb(){const t=ui(),e=Vn.value.trim();if(!(!t||!e)){Xa.value=!0;try{const n=await Am(t.id,Eo.value,e);Vn.value="",gs.value=n,O("심의 의견을 기록했습니다","success"),await Be()}catch(n){const s=n instanceof Error?n.message:"심의 기록에 실패했습니다";se.value=s,O(s,"error")}finally{Xa.value=!1}}}async function ic(t){const e=ui();if(e){rn.value=!0;try{await Tm(e.id,t),O(t==="confirm"?"집행을 승인했습니다":"집행을 거부했습니다","success"),await Be()}catch(n){const s=n instanceof Error?n.message:"집행 결정을 처리하지 못했습니다";se.value=s,O(s,"error")}finally{rn.value=!1}}}function wb(){var e,n,s;const t=(e=xn.value)==null?void 0:e.summary;return i`
    <div class="board-summary-strip">
      <div class="board-summary-item">
  ...
  `}function Ob(){return i`
    <${z} title="청원 콘솔" class="section" semanticId="governance.supervisor">
      <div class="governance-toolbar">
        <div class="council-create">
          ...
          <button class="control-btn ghost" onClick=${Be} disabled=${Ya.value}>
        ...
        <div class="governance-filter-row">
          ${[["open","진행 중"],["pending_ruling","판정 대기"],["needs_human_gate","승인 대기"],["executed","집행 완료"],["blocked","보류/종결"]].map(([t,e])=>i`
            <button
              ...
              onClick=${async()=>{No.value=t,await Be()}}
            >
              ${e}
            </button>
          `)}
  ...
  `}function Db(){var e;const t=$u(((e=xn.value)==null?void 0:e.items)??[]);return i`
    <${z} title="사건 수신함" class="section" semanticId="governance.inbox">
  ...
  `}function qb({petition:t}){return i`
  ...
  `}function Kb(){var a;const t=ui(),e=gs.value,n=(e==null?void 0:e.petitions)??[],s=(e==null?void 0:e.case.briefs)??[];return i`
    <${z}
    ...
    >
      ${jo.value?i`<div class="loading-indicator">거버넌스 상세 불러오는 중...</div>`:!t||!e?i`<div class="empty-state">사건을 고르면 청원, 심의, 판정, 집행 기록을 볼 수 있습니다.</div>`:i`
              ...
              <div class="governance-ledger">
                ${n.length===0?i`<div class="empty-state">기록된 청원이 없습니다.</div>`:n.map(o=>i`<${qb} key=${o.id} petition=${o} />`)}
              </div>
              <div class="governance-ledger">
                ${s.length===0?i`<div class="empty-state">심의 brief가 아직 없습니다.</div>`:s.map(o=>i`<${Fb} key=${o.id} brief=${o} />`)}
              </div>
            `}
    <//>
  `}function Bb({order:t}){if(!(t!=null&&t.action_request))return null;const e=t.action_request;return i`
    <div class="governance-side-block">
      ...
      ${e.payload_preview?i`<pre class="council-detail governance-preview">${zb(e.payload_preview)}</pre>`:null}
  ...
  `}function Ub(){const t=ui(),e=gs.value,n=e==null?void 0:e.ruling,s=e==null?void 0:e.execution_order;return i`
    <div class="governance-side-column">
      <${z} title="판정 / 집행" class="section" semanticId="governance.guardrail">
        ${!t||!e?i`<div class="empty-state">사건을 고르면 판정과 집행 경로가 보입니다.</div>`:i`
              <div class="governance-side-block">
                <h4>판정</h4>
                <div class="council-sub">
                  <span>${(n==null?void 0:n.status)||"pending"}</span>
                  <span>${Eb(n==null?void 0:n.confidence)}</span>
      ...
      <${z} title="심의 입력" class="section" semanticId="governance.context">
        ${t?i`
              <div class="governance-side-block">
                <div class="governance-filter-row">
  ...
  `}function Hb(){var e;const t=(((e=xn.value)==null?void 0:e.activity)??[]).slice(0,8);return i`
    <${z} title="최근 활동" class="section" semanticId="governance.activity">
  ...
  `}const Xe=g(""),Di=g("ability_check"),qi=g("10"),Fi=g("12"),Js=g(""),Vs=g("idle"),le=g(""),Ys=g("keeper-late"),Ki=g("player"),Bi=g(""),Mt=g("idle"),Ui=g(null),Xs=g(""),Hi=g(""),Wi=g("player"),Gi=g(""),Ji=g(""),Vi=g(""),Yn=g("20"),Yi=g("20"),Xi=g(""),Qs=g("idle"),wo=g(null),yu=g("overview"),Qi=g("all"),Zi=g("all"),to=g("all"),Gb=12e4,pi=g(null),oc=g(Date.now());function Jb(t,e){const n=e>0?t/e*100:0;return n>50?"hp-high":n>25?"hp-mid":"hp-low"}function Vb(t,e){return e>0?Math.round(t/e*100):0}const Yb={pragmatic:"리스크보다 확실한 이득을 우선합니다.",frugal:"자원 소모를 줄이고 효율을 챙깁니다.",impatient:"짧은 템포로 즉시 압박을 선호합니다.",stubborn:"한 번 정한 전술을 끝까지 밀어붙입니다.",protective:"아군 피해를 줄이는 선택을 우선합니다.","honor-bound":"약속과 규율을 지키는 행동에 보너스가 납니다.",intense:"집중 화력을 짧게 폭발시킵니다.",empathetic:"아군/약자 보호 쪽 선택 확률이 높아집니다.",fatalistic:"위험을 감수하는 고배수 선택을 탑니다.",suspicious:"함정/매복 경계 행동을 우선합니다.",precise:"단일 목표를 정확히 노리는 경향입니다.",vengeful:"직전 위협 대상에게 강하게 반응합니다.",aggressive:"공격적인 전진 행동을 우선합니다.",opportunistic:"빈틈이 열리면 즉시 추격합니다."},Xb={supply_scan:"전장/자원 상태를 스캔해 약한 지점을 찾습니다.",ration_shift:"소모를 줄이고 지속 전투 능력을 확보합니다.",logistics_patch:"무너진 운영 라인을 빠르게 복구합니다.",frontline_shield:"전열에서 아군 피해를 흡수합니다.",oath_intercept:"핵심 타깃을 가로막아 위협을 차단합니다.",morale_anchor:"아군 안정도를 높여 붕괴를 막습니다.",omen_trace:"다음 위험 신호를 먼저 감지합니다.",arc_flash:"짧은 순간 광역 압박을 넣습니다.",ward_bloom:"방어 장막을 펼쳐 생존률을 올립니다.",mark_prey:"우선 제거 대상을 지정합니다.",silent_route:"은밀한 진입 경로를 확보합니다.",finisher_strike:"약화된 적을 마무리하는 일격입니다.",shadow_claw:"근접 급습으로 출혈 피해를 노립니다.",lunge:"짧은 돌진으로 전열을 흔듭니다."};function Zs(t){const e=t.trim();return e?e.split(/[_-]+/g).filter(n=>n.length>0).map(n=>n[0]?`${n[0].toUpperCase()}${n.slice(1)}`:n).join(" "):t}function Qb(t){const e=t.trim().toLowerCase();return Yb[e]??"행동 선택 가중치에 영향을 주는 성향입니다."}function Zb(t){const e=t.trim().toLowerCase();return Xb[e]??"상황에 따라 선택되는 전술 액션입니다."}function St(t,e,n=""){const s=t[e];return typeof s=="string"?s:n}function Ot(t,e,n=0){const s=t[e];return typeof s=="number"&&Number.isFinite(s)?s:n}function hs(t,e,n=!1){const s=t[e];return typeof s=="boolean"?s:n}const tk=new Set(["str","dex","con","int","wis","cha"]);function ek(t){const e=t.trim();if(!e)return{};let n;try{n=JSON.parse(e)}catch(a){throw new Error(`능력치 JSON 파싱 실패: ${a instanceof Error?a.message:"invalid json"}`)}if(!m(n))throw new Error('능력치 JSON은 object여야 합니다. 예: {"luck":7}');const s={};return Object.entries(n).forEach(([a,o])=>{const l=a.trim();if(l){if(typeof o=="number"&&Number.isFinite(o)){s[l]=Math.max(0,Math.trunc(o));return}if(typeof o=="string"){const c=Number.parseFloat(o.trim());if(Number.isFinite(c)){s[l]=Math.max(0,Math.trunc(c));return}}throw new Error(`능력치 '${l}' 값은 숫자여야 합니다.`)}}),s}function nk(t){const e=Number.parseInt(t.trim(),10);if(!Number.isFinite(e))return;const n=Math.max(1,e),s=Number.parseInt(Yn.value.trim(),10);Number.isFinite(s)&&s>n&&(Yn.value=String(n))}function Oo(t){const n=(t.actor_name??t.actor??t.actor_id??"system").trim();return n===""?"system":n}function sk(t){var n;return(((n=t.timestamp)==null?void 0:n.trim())??"")||"-"}function ak(t){yu.value=t}function bu(t){const e=pi.value;return e==null||e<=t}function ik(t){const e=pi.value;return e==null||e<=t?0:Math.max(0,Math.ceil((e-t)/1e3))}function Qa(){pi.value=null}function ku(t){return typeof window>"u"||typeof window.confirm!="function"?!0:window.confirm(t)}function ok(t,e){ku(["관전 모드 잠금을 해제하시겠습니까?",`ROOM: ${t||"-"}`,`PHASE: ${e||"-"}`,"해제 시간: 120초 (시간 경과 또는 위험 액션 실행 후 자동 재잠금)"].join(`
`))&&(pi.value=Date.now()+Gb,O("조작 잠금이 120초 동안 해제되었습니다.","warning"))}function _a(t){return bu(t)?(O("관전 모드 잠금 상태입니다. 먼저 잠금을 해제하세요.","warning"),!1):!0}function Do(t,e,n){return ku([`[위험 액션 확인] ${t}`,`ROOM: ${e||"-"}`,`PHASE: ${n||"-"}`,"이 액션은 즉시 실행되며 되돌리기 어렵습니다.","계속 진행하시겠습니까?"].join(`
`))}function rk({hp:t,max:e}){const n=Vb(t,e),s=Jb(t,e);return i`
    <div class="trpg-hp-bar">
      <div class="hp-fill ${s}" style="width:${n}%" />
    </div>
  `}function lk({stats:t}){const e=[{label:"STR",value:t.strength},{label:"DEX",value:t.dexterity},{label:"CON",value:t.constitution},{label:"INT",value:t.intelligence},{label:"WIS",value:t.wisdom},{label:"CHA",value:t.charisma}];return i`
    <div class="trpg-actor-stats">
      ${e.map(n=>i`<span>${n.label} ${n.value}</span>`)}
    </div>
  `}function ck({keeper:t,role:e}){if(!t)return null;const n=e==="dm"?"dm":"player";return i`
    <span class="trpg-keeper-chip">
      <span class="trpg-keeper-tag ${n}">${n}</span>
      ${t}
    </span>
  `}function xu({actor:t}){var d,p,_,v;const e=(d=t.archetype)==null?void 0:d.trim(),n=(p=t.persona)==null?void 0:p.trim(),s=(_=t.portrait)==null?void 0:_.trim(),a=(v=t.background)==null?void 0:v.trim(),o=t.traits??[],l=t.skills??[],c=Object.entries(t.stats_raw??{}).filter(([f,h])=>Number.isFinite(h)).filter(([f])=>!tk.has(f.toLowerCase()));return i`
    <div class="trpg-actor">
      ...
      <div class="trpg-actor-header">
        ...
        <${ck} keeper=${t.keeper} role=${t.role} />
      </div>
      ${t.stats?i`
          <div style="margin-top:4px;">
            ...
            <${rk} hp=${t.stats.hp} max=${t.stats.max_hp} />
            <${lk} stats=${t.stats} />
          </div>
        `:null}
            ...
            <div class="trpg-annot-list">
              ${l.map(f=>i`
                <span class="trpg-annot-chip skill">
                  <span class="trpg-annot-name">${Zs(f)}</span>
                  <span class="trpg-annot-desc">${Zb(f)}</span>
                </span>
              `)}
            </div>
          </div>
  ...
  `}function dk({mapStr:t}){return i`<pre class="trpg-map">${t}</pre>`}function Su({events:t,emptyLabel:e="아직 이벤트가 없습니다."}){return t.length===0?i`<div class="empty-state" style="font-size:13px">${e}</div>`:i`
    <div class="trpg-story" role="list" aria-label="TRPG story events">
      ${t.map((n,s)=>{var a;return i`
        <div key=${s} class="trpg-event ${n.type??""}" role="listitem">
          <div class="trpg-event-meta-row">
            <span class="trpg-event-meta">${sk(n)}</span>
  ...
  `}function mk({state:t,nowMs:e}){var p;const n=ee.value||((p=t.session)==null?void 0:p.room)||"",s=Vs.value,a=t.party??[];if(!a.find(_=>_.id===Xe.value)&&a.length>0){const _=a[0];_&&(Xe.value=_.id)}const l=async()=>{var v,f;if(!n){O("Room ID가 비어 있습니다.","error");return}if(!_a(e))return;const _=((v=t.current_round)==null?void 0:v.phase)??((f=t.session)==null?void 0:f.status)??"unknown";if(Do("라운드 실행",n,_)){Vs.value="running";try{const h=await _m(n);wo.value=h,Vs.value="ok";const T=m(h.summary)?h.summary:null,k=T?hs(T,"advanced",!1):!1,S=T?St(T,"progress_reason",""):"";O(k?"라운드가 정상 진행되었습니다.":`라운드가 정체되었습니다${S?`: ${S}`:""}`,k?"success":"warning"),_e()}catch(h){wo.value=null,Vs.value="error";const T=h instanceof Error?h.message:"라운드 실행에 실패했습니다.";O(T,"error")}finally{Qa()}}},c=async()=>{var v,f;if(!n||!_a(e))return;const _=((v=t.current_round)==null?void 0:v.phase)??((f=t.session)==null?void 0:f.status)??"unknown";if(Do("턴 강제 진행",n,_))try{await gm(n),O("턴을 다음 단계로 이동했습니다.","success"),_e()}catch{O("턴 이동에 실패했습니다.","error")}finally{Qa()}},d=async()=>{if(!n||!_a(e))return;const _=Xe.value.trim();if(!_){O("먼저 Actor를 선택하세요.","warning");return}const v=Number.parseInt(qi.value,10),f=Number.parseInt(Fi.value,10);if(Number.isNaN(v)||Number.isNaN(f)){O("stat/dc는 숫자여야 합니다.","warning");return}const h=Number.parseInt(Js.value,10),T=Js.value.trim()===""||Number.isNaN(h)?void 0:h;try{await fm({roomId:n,actorId:_,action:Di.value.trim()||"ability_check",statValue:v,dc:f,rawD20:T}),O("주사위 판정을 기록했습니다.","success"),_e()}catch{O("주사위 판정 기록에 실패했습니다.","error")}};return i`
  ...
  `}function _k({state:t}){var a;const e=ee.value||((a=t.session)==null?void 0:a.room)||"",n=Qs.value,s=async()=>{if(!e){O("Room ID가 비어 있습니다.","warning");return}const o=Xs.value.trim(),l=Hi.value.trim();if(!l&&!o){O("이름 또는 Actor ID를 입력하세요.","warning");return}const c=Number.parseInt(Yn.value.trim(),10),d=Number.parseInt(Yi.value.trim(),10),p=Number.isFinite(d)?Math.max(1,d):20,_=Number.isFinite(c)?Math.max(0,Math.min(p,c)):p;let v={};try{v=ek(Xi.value)}catch(f){O(f instanceof Error?f.message:"능력치 JSON 오류","error");return}Qs.value="spawning";try{const f=typeof crypto<"u"&&typeof crypto.randomUUID=="function"?`trpg_spawn_${crypto.randomUUID()}`:`trpg_spawn_${Date.now().toString(36)}_${Math.random().toString(36).slice(2,10)}`,h=await $m(e,{actor_id:o||void 0,name:l||void 0,role:Wi.value,idempotencyKey:f,portrait:Ji.value.trim()||void 0,background:Vi.value.trim()||void 0,hp:_,max_hp:p,alive:_>0,stats:Object.keys(v).length>0?v:void 0}),T=typeof h.actor_id=="string"?h.actor_id.trim():"";if(!T)throw new Error("생성 응답에 actor_id가 없습니다.");const k=Gi.value.trim();k&&await hm(e,T,k),Xe.value=T,le.value=T,o||(Xs.value=""),Qs.value="ok",O(`Actor 생성 완료: ${T}`,"success"),await _e()}catch(f){Qs.value="error",O(f instanceof Error?f.message:"Actor 생성에 실패했습니다.","error")}};return i`
    <div class="trpg-control-box">
      <div class="trpg-control-grid">
        <div class="trpg-control-field">
          <label>Name</label>
        ...
        <div class="trpg-control-grid">
          ...
          <div class="trpg-control-field">
            ...
            <input
              ...
              min="1"
              value=${Yi.value}
              onInput=${o=>{const l=o.target.value;Yi.value=l,nk(l)}}
              placeholder="20"
            />
          </div>
  ...
  `}function vk({state:t,nowMs:e}){var f;const n=ee.value||((f=t.session)==null?void 0:f.room)||"",s=t.join_gate,a=Ui.value,o=m(a)?a:null,l=(t.party??[]).filter(h=>h.role!=="dm"),c=le.value.trim(),d=l.some(h=>h.id===c),p=d?c:c?"__manual__":"",_=async()=>{const h=le.value.trim(),T=Ys.value.trim();if(!n||!h){O("Room/Actor가 필요합니다.","warning");return}Mt.value="checking";try{const k=await ym(n,h,T||void 0);Ui.value=k,Mt.value="ok",O("참가 가능 여부를 갱신했습니다.","success")}catch(k){Mt.value="error";const S=k instanceof Error?k.message:"참가 가능 여부 확인에 실패했습니다.";O(S,"error")}},v=async()=>{var $,y;const h=le.value.trim(),T=Ys.value.trim(),k=Bi.value.trim();if(!n||!h||!T){O("Room/Actor/Keeper가 필요합니다.","warning");return}if(!_a(e))return;const S=(($=t.current_round)==null?void 0:$.phase)??((y=t.session)==null?void 0:y.status)??"unknown";if(Do("Mid-Join 승인 요청",n,S)){Mt.value="requesting";try{const R=await bm({room_id:n,actor_id:h,keeper_name:T,role:Ki.value,...k?{name:k}:{}});Ui.value=R;const P=m(R)?hs(R,"granted",!1):!1,C=m(R)?St(R,"reason_code",""):"";P?O("Mid-Join이 승인되었습니다.","success"):O(`Mid-Join이 거절되었습니다${C?`: ${C}`:""}`,"warning"),Mt.value=P?"ok":"error",_e()}catch(R){Mt.value="error";const P=R instanceof Error?R.message:"Mid-Join 요청에 실패했습니다.";O(P,"error")}finally{Qa()}}};return i`
    <div class="trpg-control-box">
      ...
      <div class="trpg-control-grid">
        ...
        <div class="trpg-control-field">
          <label>Actions</label>
          <div style="display:flex; gap:6px;">
            <button class="trpg-run-btn secondary" onClick=${_} disabled=${Mt.value==="checking"||Mt.value==="requesting"}>
              ${Mt.value==="checking"?"Checking...":"Check"}
            </button>
            <button class="trpg-run-btn recommend" onClick=${v} disabled=${Mt.value==="checking"||Mt.value==="requesting"}>
  ...
  `:null}function Iu(){const t=wo.value;if(!t)return i`<div class="empty-state" style="font-size:13px;">Run Round 결과가 아직 없습니다.</div>`;const e=t.summary,n=m(e)?e:null,a=(Array.isArray(t.statuses)?t.statuses:[]).filter(m).slice(-8),o=t.canon_check,l=m(o)?o:null,c=l&&Array.isArray(l.warnings)?l.warnings.filter(C=>typeof C=="string").slice(0,3):[],d=l&&Array.isArray(l.violations)?l.violations.filter(C=>typeof C=="string").slice(0,3):[],p=n?hs(n,"advanced",!1):!1,_=n?St(n,"progress_reason",""):"",v=n?St(n,"progress_detail",""):"",f=n?Ot(n,"player_successes",0):0,h=n?Ot(n,"player_required_successes",0):0,T=n?hs(n,"dm_success",!1):!1,k=n?Ot(n,"timeouts",0):0,S=n?Ot(n,"unavailable",0):0,$=n?Ot(n,"reprompts",0):0,y=n?Ot(n,"npc_attacks",0):0,R=n?Ot(n,"keeper_timeout_sec",0):0,P=n?Ot(n,"roll_audit_count",0):0;return i`
    <div style="display:grid; gap:10px;">
      ...
      ${a.length>0?i`
          <div class="trpg-round-list">
            ${a.map(C=>{const M=St(C,"status","unknown"),I=St(C,"actor_id","-"),H=St(C,"role","-"),Y=St(C,"reason",""),tt=St(C,"action_type",""),G=St(C,"reply","");return i`
                <div class="trpg-round-item ${M.includes("fallback")||M.includes("timeout")?"failed":"active"}">
                  ...
                  ${Y?i`<div style="width:100%; font-size:11px; color:#9ca3af; margin-top:2px;">reason: ${Y}</div>`:null}
          ...
          <div class="trpg-control-box">
            ...
            ${d.length>0?i`
                <div style="margin-top:6px; font-size:11px; color:#fca5a5;">
                  ${d.map(C=>i`<div>violation: ${C}</div>`)}
                </div>`:null}
            ${c.length>0?i`
                <div style="margin-top:6px; font-size:11px; color:#fbbf24;">
                  ${c.map(C=>i`<div>warning: ${C}</div>`)}
                </div>`:null}
          </div>
        `:null}
    </div>
  `}function fk({state:t,nowMs:e}){var l,c,d;const n=ee.value||((l=t.session)==null?void 0:l.room)||"",s=((c=t.current_round)==null?void 0:c.phase)??((d=t.session)==null?void 0:d.status)??"unknown",a=bu(e),o=ik(e);return i`
    <${z} title="조작 안전 잠금" style="margin-bottom:16px;" semanticId="lab.trpg">
      <div class="trpg-control-lock ${a?"locked":"unlocked"}">
        ...
        <div style="display:flex; gap:8px; margin-top:10px; flex-wrap:wrap;">
          ${a?i`<button class="trpg-run-btn recommend" onClick=${()=>ok(n,s)}>잠금 해제 (120초)</button>`:i`<button class="trpg-run-btn secondary" onClick=${()=>{Qa(),O("조작 잠금으로 전환했습니다.","success")}}>즉시 다시 잠금</button>`}
        </div>
      </div>
    <//>
  ...
  `}function $k({state:t}){const e=t.party??[],n=t.story_log??[];return i`
    <div class="trpg-layout">
      <div>
        <${z} title="관전 가이드" semanticId="lab.trpg">
        ...
        <${z} title=${`최근 스토리 (${Math.min(n.length,20)})`} style="margin-top:16px;">
          <${Su} events=${n.slice(-20)} />
        <//>

        ${t.map?i`
            <${z} title="맵" style="margin-top:16px;" semanticId="lab.trpg">
              <${dk} mapStr=${t.map} />
            <//>
          `:null}
      </div>
      ...
      <div class="trpg-sidebar">
        <${z} title="현재 라운드" semanticId="lab.trpg">
          <${Tu} state=${t} />
        <//>

        <${z} title="기여도" style="margin-top:16px;" semanticId="lab.trpg">
          <${Au} state=${t} />
        <//>

        <${z} title=${`파티 (${e.length})`} style="margin-top:16px;">
        ...
        ${t.history&&t.history.length>0?i`
            <${z} title=${`히스토리 (${t.history.length})`} style="margin-top:16px;">
              <${Cu} state=${t} />
            <//>
          `:null}
      </div>
    </div>
  `}function hk({state:t}){const e=t.story_log??[];return i`
    <div class="trpg-layout">
      <div>
        <${z} title=${`이벤트 타임라인 (${e.length})`}>
          <${uk} events=${e} />
        <//>
      </div>

      <div class="trpg-sidebar">
        <${z} title="최근 라운드 결과" semanticId="lab.trpg">
          <${Iu} />
        <//>

        <${z} title="현재 라운드" style="margin-top:16px;" semanticId="lab.trpg">
          <${Tu} state=${t} />
        <//>
      </div>
    </div>
  `}function yk({state:t,nowMs:e}){const n=t.party??[];return i`
    <div>
      ...
      <div class="trpg-layout">
        <div>
          <${z} title="조작 패널" semanticId="lab.trpg">
            <${mk} state=${t} nowMs=${e} />
          <//>

          <${z} title="Actor Spawn" style="margin-top:16px;" semanticId="lab.trpg">
            <${_k} state=${t} />
          <//>

          <${z} title="Mid-Join Gate" style="margin-top:16px;" semanticId="lab.trpg">
            <${vk} state=${t} nowMs=${e} />
          <//>

          <${z} title="최근 라운드 결과" style="margin-top:16px;" semanticId="lab.trpg">
            <${Iu} />
          <//>
        </div>

        <div class="trpg-sidebar">
          <${z} title="기여도" style="margin-top:0;" semanticId="lab.trpg">
            <${Au} state=${t} />
          <//>

          <${z} title=${`파티 (${n.length})`} style="margin-top:16px;">
            <div class="trpg-actor-list">
  ...
  `}function bk(){var c,d,p,_,v;const t=Dc.value,e=_o.value;if(et(()=>{if(typeof window>"u"||typeof window.setInterval!="function")return;const f=window.setInterval(()=>{oc.value=Date.now()},1e3);return()=>{window.clearInterval(f)}},[]),e&&!t)return i`<div class="loading-indicator">Loading TRPG state...</div>`;if(!t)return i`
      <div class="section">
        <h2>TRPG</h2>
    ...
    <div>
      ...
      ${o==="overview"?i`<${$k} state=${t} />`:o==="timeline"?i`<${hk} state=${t} />`:i`<${yk} state=${t} nowMs=${l} />`}
    </div>
  `}function kk(){return i`
    <div>
      <${At} surfaceId="lab" />
      <${z} title="Experimental Surface" class="section" semanticId="lab.experimental">
        <div class="monitor-section-head">
      ...
      <${z} title="TRPG" class="section" semanticId="lab.trpg">
        <${bk} />
      <//>
    </div>
  `}const Za=g(new Set(["broadcast","tasks","keepers","system"]));function xk(t){const e=new Set(Za.value);e.has(t)?e.delete(t):e.add(t),Za.value=e}const Rr=g(null);function Ru(t){Rr.value=t}function Sk(t){return t.kind==="board"?"broadcast":t.kind==="tasks"?"tasks":t.kind==="keepers"?"keepers":"system"}const Ck=Nt(()=>{const t=Za.value;return fa.value.filter(e=>t.has(Sk(e)))}),Ak=12e4,Tk=Nt(()=>{const t=Bc.value,e=Date.now();return Gt.value.map(n=>{const s=n.name.trim().toLowerCase(),a=t.get(s)??null;let o="idle";if(n.status==="active"||n.status==="busy"){const l=a==null?void 0:a.lastActivityAt;l?o=e-new Date(l).getTime()>Ak?"stale":"working":o="working"}else(n.status==="offline"||n.status==="inactive")&&(o="stale");return{name:n.name,emoji:n.emoji??"",koreanName:n.koreanName??null,state:o,currentTask:n.current_task,motion:a}})}),Ik=Nt(()=>{const t=Bc.value;return Gt.value.filter(e=>e.status==="active"||e.status==="busy"||e.status==="listening"||e.status==="idle").map(e=>{const n=e.name.trim().toLowerCase(),s=t.get(n),a=(s==null?void 0:s.activeAssignedCount)??0;let o="calm";return a>=3?o="hot":a>=1&&(o="normal"),{name:e.name,emoji:e.emoji??"",koreanName:e.koreanName??null,currentTask:e.current_task,lastActivityAt:(s==null?void 0:s.lastActivityAt)??null,lastActivityText:(s==null?void 0:s.lastActivityText)??null,assignedCount:a,pressure:o}}).sort((e,n)=>{const s={hot:0,normal:1,calm:2};return s[e.pressure]-s[n.pressure]})});function rc(t){return t.kind==="board"?"live-event-broadcast":t.kind==="tasks"?"live-event-task":t.kind==="keepers"?"live-event-keeper":"live-event-system"}function Rk(t){const e=t.eventType;return e==="broadcast"?"broadcast":e==="agent_joined"?"joined":e==="agent_left"?"left":e==="task_update"?"task":e==="board_post"?"post":e==="board_comment"?"comment":e==="keeper_heartbeat"?"heartbeat":e==="keeper_handoff"?"handoff":e==="keeper_compaction"?"compact":e==="keeper_guardrail"?"guardrail":t.kind==="board"?"board":t.kind==="tasks"?"task":t.kind==="keepers"?"keeper":"system"}function Mk(t){switch(t){case"working":return"pulse-working";case"stale":return"pulse-stale";default:return"pulse-idle"}}function Lk(){const t=Tk.value,e=Rr.value;return t.length===0?i`
  ...
  `}const Pk=[{kind:"broadcast",label:"Broadcast",cssClass:"live-event-broadcast"},{kind:"tasks",label:"Task",cssClass:"live-event-task"},{kind:"keepers",label:"Keeper",cssClass:"live-event-keeper"},{kind:"system",label:"System",cssClass:"live-event-system"}];function zk(){const t=Za.value;return i`
  ...
  `}function Ek(){const t=Ck.value;return i`
        ...
        ${t.length===0?i`<div class="activity-empty">No events matching filters</div>`:t.map((e,n)=>i`
            ...
            >
              <div class="activity-item-head">
                <span class="activity-kind-chip ${rc(e)}">${Rk(e)}</span>
  ...
  `}function Nk(t){switch(t){case"hot":return"focus-pressure-hot";case"normal":return"focus-pressure-normal";default:return"focus-pressure-calm"}}function jk(t){switch(t){case"hot":return"High";case"normal":return"Active";default:return"Calm"}}function wk(){const t=Ik.value,e=Rr.value;return i`
        ...
        ${t.length===0?i`<div class="focus-empty">No active agents</div>`:t.map(n=>i`
            ...
            >
              <div class="focus-agent-header">
                ...
                <span class="focus-pressure-badge ${Nk(n.pressure)}">
                  ${jk(n.pressure)}
  ...
  `}function Ok(){const t=ge.value;return i`
  ...
  `}function qk({currentTab:t}){var p,_,v,f,h,T,k,S,$,y,R,P;const e=ge.value,n=(p=dt.value)==null?void 0:p.build,s=(_=dt.value)==null?void 0:_.social_runtime,a=(v=dt.value)==null?void 0:v.lodge,o=(f=dt.value)==null?void 0:f.gardener,l=(h=dt.value)==null?void 0:h.guardian,c=(T=dt.value)==null?void 0:T.sentinel,d=[];if(s||a){const C=s,M=a;d.push(ta("Social Runtime",C?C.enabled?bt("social","live"):bt("social","disabled"):M!=null&&M.enabled?bt("lodge",M.quiet_active?"quiet":"live"):bt("social","disabled"),C?C.enabled?"ok":"bad":M!=null&&M.enabled?M.quiet_active?"warn":"ok":"bad",[kt("전략",(C==null?void 0:C.strategy)??"legacy_fallback"),kt("대상 keeper",(C==null?void 0:C.active_keepers)??(M==null?void 0:M.agent_count)??0),kt("큐",(C==null?void 0:C.queue_depth)??0),kt("최근 결과",((k=C==null?void 0:C.last_result)==null?void 0:k.activity_report)??(C!=null&&C.last_pass_reason?`판단 패스: ${C.last_pass_reason}`:null)??(C!=null&&C.last_system_skip_reason?`시스템 스킵: ${C.last_system_skip_reason}`:null)??((S=M==null?void 0:M.last_tick_result)==null?void 0:S.activity_report)??(M!=null&&M.last_pass_reason?`판단 패스: ${M.last_pass_reason}`:null)??(M!=null&&M.last_system_skip_reason?`시스템 스킵: ${M.last_system_skip_reason}`:null)??(M==null?void 0:M.last_skip_reason)??"없음")]))}if(o&&d.push(ta("Gardener",o.alive?bt("gardener","live"):o.enabled?bt("gardener","starting"):bt("gardener","disabled"),o.alive?"ok":o.enabled?"warn":"bad",[kt("최근 tick",o.last_tick_completed_at?i`<${Z} timestamp=${o.last_tick_completed_at} />`:"기록 없음"),kt("판단",`${o.last_intervention??"없음"} · ${o.last_decision_source??"없음"}`),kt("백로그",`미할당 ${(($=o.health_summary)==null?void 0:$.todo_count)??0} · P1/2 ${((y=o.health_summary)==null?void 0:y.high_priority_todo)??0}`)],o.last_reason??o.last_error??void 0)),l){const C=l.masc_loops_running||l.lodge_loop_started||l.lodge_running;d.push(ta("Guardian",C?bt("guardian","live"):l.enabled?bt("guardian","idle"):bt("guardian","disabled"),C?"ok":l.enabled?"warn":"bad",[kt("모드",l.mode??"알 수 없음"),kt("루프",`zombie ${l.zombie_loop_running?"on":"off"} · gc ${l.gc_loop_running?"on":"off"}`),kt("소유자",l.runtime_owner??"없음")],((R=l.last_lodge_result)==null?void 0:R.message)??l.last_gc_result??l.last_zombie_result??void 0))}return c&&d.push(ta("Sentinel",c.started?bt("sentinel","live"):c.enabled?bt("sentinel","starting"):bt("sentinel","disabled"),c.started?"ok":c.enabled?"warn":"bad",[kt("에이전트",c.agent_name??"sentinel"),kt("소비자",((P=c.consumers)==null?void 0:P.length)??0),kt("가디언 소유자",c.guardian_runtime_owner??"없음")],c.llm_enabled===!0?"LLM 기반 housekeeping resident":void 0)),i`
    <section class="rail-card">
      ...
      ${n?i`<div class="rail-build-hint">서버 빌드 · v${n.release_version} · ${Dk(n.commit)}</div>`:null}
      ${d.length>0?i`
  ...
  `}function Fk(){const t=It.value,e=ai(t).total_count,n=(t==null?void 0:t.sessions.length)??0,s=(t==null?void 0:t.keepers.length)??0;return i`
    <section class="rail-card">
      <div class="rail-card-head">
        <h3>개입 바로가기</h3>
  ...
  `}const ea=g(!1);function Kk(){const t=ge.value;return i`
    <div class="connection-status ${t?"connected":"disconnected"}">
      <span class="status-dot ${t?"connected":"disconnected"}"></span>
      <span class="status-text">${t?"연결됨":"재연결 중..."}</span>
      <span class="event-count">이벤트 ${ti.value}</span>
    </div>
  `}function Bk(t){const e=t==null?void 0:t.trim();return e?e.length>10?e.slice(0,10):e:"커밋 정보 없음"}function Uk(){const t=dt.value,e=t==null?void 0:t.build,n=e?`v${e.release_version} · ${Bk(e.commit)}`:t!=null&&t.version?`v${t.version} · 커밋 정보 없음`:"버전 정보 없음";return i`
  ...
  `}function Hk(){const t=F.value.tab,e=qo.find(s=>s.id===t),n=lc.find(s=>s.id===(e==null?void 0:e.group));return i`
  ...
  `}function Wk(){switch(F.value.tab){case"mission":return i`<${Ll} />`;case"proof":return i`<${Y$} />`;case"execution":return i`<${cb} />`;case"tools":return i`<${fb} />`;case"live":return i`<${Ok} />`;case"memory":return i`<${Hy} />`;case"governance":return i`<${Wb} />`;case"planning":return i`<${Lb} />`;case"intervene":return i`<${Py} />`;case"command":return i`<${Iy} />`;case"lab":return i`<${kk} />`;default:return i`<${Ll} />`}}function Gk(){return mo.value&&!ge.value?i`<div class="loading-indicator">대시보드 불러오는 중...</div>`:i`<${Wk} />`}function Jk(){et(()=>{Fu(),vc(),Gc(),ze(),Pe(),Wc(),dd();const n=Y_();return X_(),()=>{Vu(),n(),Q_()}},[]),et(()=>{const n=setInterval(()=>{So(F.value.tab)},15e3);return()=>{clearInterval(n)}},[]),et(()=>{So(F.value.tab)},[F.value.tab]);const t=F.value.tab,e=qo.find(n=>n.id===t);return i`
    <div class="app-shell">
  ...
  `}const cc=document.getElementById("app");cc&&ju(i`<${Jk} />`,cc);export{l$ as _};
