  ...
  let summary =
    {
      ...
      grouped_by_provider_model_keeper =
        [
          row ~provider:"chat_completions_v1" ~model:"model-d-5.4" ~keeper_profile:"bench-analyst"
            ~composite_score:100.0 ~cases_total:2 ~cases_passed:2
            ~stability_score:1.0 ();
          row ~provider:"chat_completions_v1" ~model:"model-d-5.4-mini"
            ~keeper_profile:"bench-verifier" ~composite_score:100.0
            ~stability_score:0.6666666667 ();
          row ~provider:"chat_completions_v1" ~model:"model-d-5.4" ~keeper_profile:"bench-executor"
