...
compaction을 자동으로 시작하는 경로는 제거되었다(#26546). overflow는 일반
typed failure route로 처리되며, #26545의 quantized tail window가 전송 이력을
bound한다. OAS는 model call과 provider 오류를 typed 결과로 전달하며, MASC의
