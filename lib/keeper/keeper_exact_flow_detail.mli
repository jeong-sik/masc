(** Rendering of OAS exact-output flow errors with their per-slot provenance.
    ...
    Every masc consumer of [Masc_agent_core.Exact_output] flow errors (HITL summary
...
val flow_evidence_detail : Masc_agent_core.Exact_output.flow_evidence -> string
...
val raw_response_excerpt
  :  Masc_agent_core.Exact_output.raw_response option
  -> string

(** call_id + typed cause + raw-response excerpt for one execution error. *)
val execution_error_detail : Masc_agent_core.Exact_output.execution_error -> string
...
val execution_failure_detail
  :  candidate:Masc_agent_core.Exact_output.flow_attempt_receipt
  -> cause:Masc_agent_core.Exact_output.execution_error
  -> evidence:Masc_agent_core.Exact_output.flow_evidence
  -> string

(** Full rendering for [Flow_candidates_exhausted]: last rejection and the
    flow journey. *)
val candidates_exhausted_detail
  :  rejection:Masc_agent_core.Exact_output.candidate_rejection_receipt
  -> evidence:Masc_agent_core.Exact_output.flow_evidence
  -> string
