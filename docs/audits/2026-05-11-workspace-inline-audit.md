...
| `masc_join` | inline_workspace | 24 | 79 | UNIQUE | workspace lifecycle |
| `masc_leave` | inline_workspace | 16 | 29 | UNIQUE | workspace lifecycle |
| `masc_messages` | inline_workspace | 17 | 29 | UNIQUE | thread read |
| `masc_start` | inline_workspace | 12 | 24 | UNIQUE | session init |
| `masc_who` | inline_workspace | 14 | 29 | UNIQUE | workspace roster |
