...
OAS Pin Snapshot: dependency floor `0.131.0`, runtime pin `main@9993f11206b37a3eb867bd4db51812d104aeed44`, declared base version `v0.131.0`
...
`masc-mcp` keeps the runtime pin ratcheted against upstream `main`, while the dependency floor tracks the pinned SDK declaration in `agent_sdk.opam`. Generated snapshot: runtime pin `main@9993f11206b37a3eb867bd4db51812d104aeed44`, declared base version `v0.131.0`, dependency floor `0.131.0`.
