...
`).map(n=>n.trim()).filter(n=>n!=="")}async function au(t,e=20){return ht("masc_task_history",{task_id:t,limit:e})}async function su(){return tn("fetchDebates",async()=>{const t=await St("/api/v1/council/debates?limit=100");return Array.isArray(t.debates)?t.debates.map(e=>{if(!O(e))return null;const n=h(e.id,"").trim(),a=h(e.topic,"").trim();return!n||!a?null:{id:n,topic:a,status:h(e.status,"open"),argument_count:q(e.argument_count,0),created_at:Ge(e.created_at_iso??e.created_at)}}).filter(e=>e!==null):[]})}async function iu(){return tn("fetchCouncilSessions",async()=>{const t=await St("/api/v1/council/sessions?limit=100");return Array.isArray(t.sessions)?t.sessions.map(e=>{if(!O(e))return null;const n=h(e.id,"").trim(),a=h(e.topic,"").trim();return!n||!a?null:{id:n,topic:a,initiator:h(e.initiator,"system"),votes:q(e.votes,0),quorum:q(e.quorum,0),state:h(e.state,"open"),created_at:Ge(e.created_at_iso??e.created_at)}}).filter(e=>e!==null):[]})}async function ou(t){const e=await ht("masc_debate_start",{topic:t});try{return JSON.parse(e)}catch{return null}}async function ru(t){return tn("fetchDebateStatus",async()=>{const e=encodeURIComponent(t),n=await St(`/api/v1/council/debates/${e}/summary`);if(!O(n))return null;const a=h(n.id,"").trim();return a?{id:a,topic:h(n.topic,""),status:h(n.status,"open"),support_count:q(n.support_count,0),oppose_count:q(n.oppose_count,0),neutral_count:q(n.neutral_count,0),total_arguments:q(n.total_arguments,0),created_at:Ge(n.created_at_iso??n.created_at),summary_text:h(n.summary_text,"")}:null})}function lu(t,e,n){return ht("masc_keeper_msg",{name:t,message:e})}async function cu(){try{const t=await ht("masc_goal_list",{});if(typeof t=="string"){const e=JSON.parse(t);return Array.isArray(e)?e:e.goals??[]}return Array.isArray(t)?t:t.goals??[]}catch{return[]}}const pn=_(""),Wt=_({}),rt=_({}),Xs=_({}),Zs=_({}),ti=_({}),ei=_({}),Gt=_({});function st(t,e,n){t.value={...t.value,[e]:n}}function Vt(t){return typeof t=="object"&&t!==null&&!Array.isArray(t)}function B(t){return typeof t=="string"&&t.trim()!==""?t.trim():void 0}function Ct(t){return typeof t=="number"&&Number.isFinite(t)?t:void 0}function Ie(t){return typeof t=="boolean"?t:void 0}function ni(t){return typeof t=="string"&&t.trim()!==""?t:typeof t!="number"||!Number.isFinite(t)||t<=0?null:new Date(t*1e3).toISOString()}function ai(t){return Array.isArray(t)?t.map(e=>B(e)).filter(e=>!!e):[]}function uu(t){var n;const e=(n=B(t))==null?void 0:n.toLowerCase();return e==="user"||e==="assistant"||e==="system"||e==="tool"?e:"other"}function du(t){switch(t){case"user":return"User";case"assistant":return"Keeper";case"system":return"System";case"tool":return"Tool";default:return"Event"}}function cs(t,e){if(!Array.isArray(t))return[];const n=[];for(const a of t){if(!Vt(a))continue;const s=B(a.name);if(!s)continue;const i=B(a[e]);e==="summary"?n.push({name:s,summary:i}):n.push({name:s,reason:i})}return n}function pu(t){if(!Vt(t))return null;const e=B(t.name);return e?{name:e,trigger:B(t.trigger),outcome:B(t.outcome),summary:B(t.summary),reason:B(t.reason)}:null}function vu(t){const e=t.toLowerCase();return e.includes("graphql")?"graphql_error":e.includes("timeout")||e.includes("model")||e.includes("llm")||e.includes("api key")||e.includes("api_key")||e.includes("provider")?"llm_error":"unknown"}function mu(t,e){return t==="offline"||t==="degraded"||t==="stale"?"Keeper is not in a healthy reply state. Probe or recover before relying on automation.":e==="quiet_hours"?"Lodge quiet hours are active. Direct messages still work, but scheduled social ticks may look asleep.":e==="min_gap"?"Keeper is inside its proactive cooldown window. Direct messages work now; autonomous check-ins will wait.":e==="never_started"?"Keeper metadata exists but no reply turn has been recorded yet.":"Keeper is reachable. Send a direct message for an immediate response."}function Or(t,e,n){return B(t)??mu(e,n)}function Mr(t,e){return typeof t=="boolean"?t:e==="recover"}function Aa(t){if(!Vt(t))return null;const e=B(t.health_state),n=B(t.next_action_path),a=B(t.last_reply_status);return!e||!n||!a?null:{health_state:e,quiet_reason:B(t.quiet_reason)??null,next_action_path:n,last_reply_status:a,last_reply_at:ni(t.last_reply_at),last_reply_preview:B(t.last_reply_preview)??null,last_error:B(t.last_error)??null,next_eligible_at_s:Ct(t.next_eligible_at_s)??null,recoverable:Mr(t.recoverable,n),summary:Or(t.summary,e,B(t.quiet_reason)??null),keepalive_running:typeof t.keepalive_running=="boolean"?t.keepalive_running:void 0}}function Mi(t){return Vt(t)?{hour:Ct(t.hour),checked:Ct(t.checked)??0,acted:Ct(t.acted)??0,acted_names:ai(t.acted_names),activity_report:B(t.activity_report),quiet_hours_overridden:Ie(t.quiet_hours_overridden),skipped_reason:B(t.skipped_reason),acted_rows:cs(t.acted_rows,"summary").map(e=>({name:e.name,summary:e.summary})),passed_rows:cs(t.passed_rows,"reason").map(e=>({name:e.name,reason:e.reason})),skipped_rows:cs(t.skipped_rows,"reason").map(e=>({name:e.name,reason:e.reason})),checkins:Array.isArray(t.checkins)?t.checkins.map(pu).filter(e=>e!==null):[]}:null}function fu(t){return Vt(t)?{enabled:Ie(t.enabled)??!1,interval_s:Ct(t.interval_s)??0,quiet_start:Ct(t.quiet_start),quiet_end:Ct(t.quiet_end),quiet_active:Ie(t.quiet_active),use_planner:Ie(t.use_planner),delegate_llm:Ie(t.delegate_llm),agent_count:Ct(t.agent_count),agents:ai(t.agents),last_tick_ago_s:Ct(t.last_tick_ago_s)??null,last_tick_ago:B(t.last_tick_ago),total_ticks:Ct(t.total_ticks),total_checkins:Ct(t.total_checkins),last_skip_reason:B(t.last_skip_reason)??null,last_tick_result:Mi(t.last_tick_result),active_self_heartbeats:ai(t.active_self_heartbeats)}:null}function _u(t){return Vt(t)?{status:t.status,diagnostic:Aa(t.diagnostic)}:null}function gu(t){return Vt(t)?{recovered:Ie(t.recovered)??!1,skipped_reason:B(t.skipped_reason)??null,before:Aa(t.before),after:Aa(t.after),down:t.down,up:t.up}:null}function hu(t,e){var T,M;if(!(t!=null&&t.name))return null;const n=B((T=t.agent)==null?void 0:T.status)??B(t.status)??"unknown",a=B((M=t.agent)==null?void 0:M.error)??null,s=t.presence_keepalive??!0,i=t.keepalive_running??!1,r=t.turn_count??0,u=t.last_turn_ago_s??null,d=t.proactive_enabled??!1,p=t.proactive_cooldown_sec??0,f=t.last_proactive_ago_s??null,l=d&&f!=null?Math.max(0,p-f):null,c=r<=0||u==null?"never":u>900?"stale":"fresh",m=typeof t.last_heartbeat=="string"&&t.last_heartbeat.trim()?t.last_heartbeat:null,$=a??(s&&!i?"keeper keepalive is not running":null),y=n==="offline"||n==="inactive"?"offline":$?"degraded":c==="stale"?"stale":c==="never"?"idle":"healthy",k=$?vu($):e!=null&&e.quiet_active&&c!=="fresh"?"quiet_hours":s&&!i?"disabled":r<=0?"never_started":l!=null&&l>0?"min_gap":c==="fresh"||c==="stale"?"no_recent_activity":"unknown",R=y==="offline"||y==="degraded"||y==="stale"?"recover":k==="quiet_hours"?"manual_lodge_poke":k==="unknown"?"probe":"direct_message";return{health_state:y,quiet_reason:k,next_action_path:R,last_reply_status:c,last_reply_at:m,last_reply_preview:null,last_error:$,next_eligible_at_s:l!=null&&l>0?l:null,recoverable:Mr(void 0,R),summary:Or(void 0,y,k),keepalive_running:i}}function $u(t,e){if(!Vt(t))return null;const n=uu(t.role),a=B(t.content)??B(t.preview);if(!a)return null;const s=ni(t.ts_unix)??ni(t.timestamp);return{id:`${n}-${s??"entry"}-${e}`,role:n,label:du(n),text:a,timestamp:s,delivery:"history"}}function yu(t,e,n){const a=Vt(n)?n:null,s=Array.isArray(a==null?void 0:a.history_tail)?a.history_tail.map((i,r)=>$u(i,r)).filter(i=>i!==null):[];return{name:t,diagnostic:Aa(a==null?void 0:a.diagnostic),history:s,rawText:e,rawStatus:n,loadedAt:new Date().toISOString()}}function vo(t,e){const n=rt.value[t]??[];rt.value={...rt.value,[t]:[...n,e].slice(-50)}}function bu(t,e){return t.role!==e.role||t.text!==e.text?!1:t.timestamp&&e.timestamp?t.timestamp===e.timestamp:!0}function ku(t,e){const a=(rt.value[t]??[]).filter(s=>s.delivery!=="history"&&!e.some(i=>bu(s,i)));rt.value={...rt.value,[t]:[...e,...a].slice(-50)}}function as(t,e){Wt.value={...Wt.value,[t]:e},ku(t,e.history)}function mo(t,e){const n=Wt.value[t];if(!n)return;const a=n.diagnostic??{health_state:"idle",next_action_path:"direct_message",last_reply_status:"unknown"};as(t,{...n,diagnostic:{...a,...e}})}async function zi(){Je();try{await xe()}catch(t){console.warn("[keeper-runtime] dashboard refresh failed",t)}}function da(t){pn.value=t.trim()}async function zr(t,e=!1){const n=t.trim();if(!n)return null;if(!e&&Wt.value[n])return Wt.value[n];st(Xs,n,!0),st(Gt,n,null);try{const a=await ht("masc_keeper_status",{name:n,fast:!1,include_context:!0,include_metrics_overview:!0,include_memory_bank:!1,include_history_tail:!0,include_compaction_history:!1,tail_turns:5,tail_messages:10});let s=null;try{s=JSON.parse(a)}catch{s=null}const i=yu(n,a,s);return as(n,i),i}catch(a){const s=a instanceof Error?a.message:`Failed to inspect ${n}`;return st(Gt,n,s),null}finally{st(Xs,n,!1)}}async function xu(t,e){const n=t.trim(),a=e.trim();if(!n||!a)return;const s=`local-${Date.now()}`;vo(n,{id:s,role:"user",label:"You",text:a,timestamp:new Date().toISOString(),delivery:"sending"}),st(Zs,n,!0),st(Gt,n,null);try{const i=await lu(n,a);rt.value={...rt.value,[n]:(rt.value[n]??[]).map(r=>r.id===s?{...r,delivery:"delivered"}:r)},vo(n,{id:`reply-${Date.now()}`,role:"assistant",label:n,text:i.trim()||"(empty reply)",timestamp:new Date().toISOString(),delivery:"delivered"}),mo(n,{last_reply_status:"delivered",last_reply_at:new Date().toISOString(),last_reply_preview:(i.trim()||"(empty reply)").slice(0,200),last_error:null}),await zi()}catch(i){const r=i instanceof Error?i.message:`Failed to send direct message to ${n}`;throw rt.value={...rt.value,[n]:(rt.value[n]??[]).map(u=>u.id===s?{...u,delivery:"error",error:r}:u)},mo(n,{last_reply_status:"error",last_error:r}),st(Gt,n,r),i}finally{st(Zs,n,!1)}}async function Su(t,e){const n=t.trim();if(!n)return null;st(ti,n,!0),st(Gt,n,null);try{const a=await Gn({actor:e,action_type:"keeper_probe",target_type:"keeper",target_id:n,payload:{}}),s=_u(a.result),i=(s==null?void 0:s.diagnostic)??null;if(i){const r=Wt.value[n];as(n,{name:n,diagnostic:i,history:(r==null?void 0:r.history)??rt.value[n]??[],rawText:(r==null?void 0:r.rawText)??"",rawStatus:a.result,loadedAt:new Date().toISOString()})}return await zi(),i}catch(a){const s=a instanceof Error?a.message:`Failed to probe ${n}`;throw st(Gt,n,s),a}finally{st(ti,n,!1)}}async function Au(t,e){const n=t.trim();if(!n)return null;st(ei,n,!0),st(Gt,n,null);try{const a=await Gn({actor:e,action_type:"keeper_recover",target_type:"keeper",target_id:n,payload:{}}),s=gu(a.result),i=(s==null?void 0:s.after)??null;if(i){const r=Wt.value[n];as(n,{name:n,diagnostic:i,history:(r==null?void 0:r.history)??rt.value[n]??[],rawText:(r==null?void 0:r.rawText)??"",rawStatus:a.result,loadedAt:new Date().toISOString()})}return await zi(),i}catch(a){const s=a instanceof Error?a.message:`Failed to recover ${n}`;throw st(Gt,n,s),a}finally{st(ei,n,!1)}}const Qt=_([]),_t=_([]),ye=_([]),Nt=_([]),ke=_(null),cn=_(null),si=_(new Map),Jt=_([]),Ln=_("hot"),me=_(!0),jr=_(null),Kt=_(""),En=_([]),Oe=_(!1),qr=_(new Map),ii=_("unknown"),oi=_(null),ri=_(!1),In=_(!1),li=_(!1),Me=_(!1),wu=_(null),ci=_(null),Fr=_(null),Hr=_(null),Tu=gt(()=>Qt.value.filter(t=>t.status==="active"||t.status==="busy"||t.status==="listening"||t.status==="idle")),Kr=gt(()=>{const t=_t.value;return{todo:t.filter(e=>e.status==="todo"),inProgress:t.filter(e=>e.status==="in_progress"||e.status==="claimed"),done:t.filter(e=>e.status==="done")}});function Cu(t){var i;const e=((i=t.status)==null?void 0:i.toLowerCase())??"";if(e==="offline"||e==="inactive")return"offline";const n=t.metrics_series;if(!n||n.length===0)return"idle";const a=n[n.length-1];if(!a)return"idle";if(a.is_handoff)return"handoff-imminent";if(a.is_compaction)return"compacting";const s=a.context_ratio;return s>.85?"handoff-imminent":s>.7?"preparing":s>.5?"compacting":"active"}const Ur=gt(()=>{const t=new Map;for(const e of Nt.value)t.set(e.name,Cu(e));return t}),Nu=12e4;function Ru(t,e){const n=e.get(t.name);if(n!=null)return n;const a=t.last_heartbeat?Date.parse(t.last_heartbeat):Number.NaN;if(!Number.isNaN(a))return a;const s=[t.last_turn_ago_s,t.last_proactive_ago_s,t.last_handoff_ago_s,t.last_compaction_ago_s].find(i=>typeof i=="number"&&Number.isFinite(i)&&i>=0);return typeof s=="number"?Date.now()-s*1e3:null}const Br=gt(()=>{const t=Date.now(),e=new Set,n=si.value;for(const a of Nt.value){const s=Ru(a,n);s!=null&&t-s>Nu&&e.add(a.name)}return e}),wa={},Du=5e3;function Je(){delete wa.compact,delete wa.full}function ut(t){return typeof t=="object"&&t!==null}function x(t){return typeof t=="string"&&t.trim()!==""?t:void 0}function A(t){return typeof t=="number"&&Number.isFinite(t)?t:void 0}function vn(t){if(!Array.isArray(t))return;const e=t.filter(n=>typeof n=="string"&&n.trim()!=="");return e.length>0?e:void 0}function Pu(t){if(typeof t=="string"&&t.trim()!=="")return t;if(!(typeof t!="number"||!Number.isFinite(t)||t<=0))return new Date(t*1e3).toISOString()}function Wr(t){const e=typeof t=="string"?t.toLowerCase():"";return e==="active"||e==="busy"||e==="listening"||e==="idle"||e==="inactive"||e==="offline"?e:e==="in_progress"||e==="claimed"?"busy":"offline"}function Lu(t){const e=typeof t=="string"?t.toLowerCase():"";return e==="todo"||e==="in_progress"||e==="claimed"||e==="done"||e==="cancelled"?e:e==="inprogress"?"in_progress":"todo"}function Eu(t){if(!ut(t))return null;const e=x(t.name);return e?{name:e,status:Wr(t.status),current_task:x(t.current_task)??null,last_seen:x(t.last_seen),emoji:x(t.emoji),koreanName:x(t.koreanName)??x(t.korean_name),model:x(t.model),traits:vn(t.traits),interests:vn(t.interests),activityLevel:A(t.activityLevel)??A(t.activity_level),primaryValue:x(t.primaryValue)??x(t.primary_value)}:null}function Iu(t){if(!ut(t))return null;const e=x(t.id),n=x(t.title);return!e||!n?null:{id:e,title:n,status:Lu(t.status),priority:A(t.priority),assignee:x(t.assignee),description:x(t.description),created_at:x(t.created_at),updated_at:x(t.updated_at)}}function Ou(t){if(!ut(t))return null;const e=x(t.from)??x(t.from_agent)??"system",n=x(t.content)??"",a=x(t.timestamp)??new Date().toISOString();return{id:x(t.id),seq:A(t.seq),from:e,content:n,timestamp:a,type:x(t.type)}}function Mu(t){return Array.isArray(t)?t.map(e=>{if(!ut(e))return null;const n=A(e.ts_unix);if(n==null)return null;const a=ut(e.handoff)?e.handoff:null;return{ts:n,context_ratio:A(e.context_ratio)??0,context_tokens:A(e.context_tokens)??0,context_max:A(e.context_max)??0,latency_ms:A(e.latency_ms)??0,generation:A(e.generation)??0,channel:typeof e.channel=="string"?e.channel:"turn",is_handoff:a!=null&&e.handoff_performed===!0,is_compaction:e.compacted===!0,compaction_saved_tokens:A(e.compaction_saved_tokens)??0,compaction_trigger:typeof e.compaction_trigger=="string"?e.compaction_trigger:null,model_used:typeof e.model_used=="string"?e.model_used:"",cost_usd:A(e.cost_usd)??0,handoff_to_model:a&&typeof a.to_model=="string"?a.to_model:null,handoff_new_generation:a?A(a.new_generation)??null:null}}).filter(e=>e!==null):[]}function fo(t){if(!ut(t))return null;const e=x(t.health_state),n=x(t.next_action_path),a=x(t.last_reply_status);if(!e||!n||!a)return null;const s=x(t.quiet_reason)??null,i=x(t.summary)??(e==="offline"||e==="degraded"||e==="stale"?"Keeper is not in a healthy reply state. Probe or recover before relying on automation.":s==="quiet_hours"?"Lodge quiet hours are active. Direct messages still work, but scheduled social ticks may look asleep.":s==="min_gap"?"Keeper is inside its proactive cooldown window. Direct messages work now; autonomous check-ins will wait.":s==="never_started"?"Keeper metadata exists but no reply turn has been recorded yet.":"Keeper is reachable. Send a direct message for an immediate response.");return{health_state:e,quiet_reason:s,next_action_path:n,last_reply_status:a,last_reply_at:Pu(t.last_reply_at)??x(t.last_reply_at)??null,last_reply_preview:x(t.last_reply_preview)??null,last_error:x(t.last_error)??null,next_eligible_at_s:A(t.next_eligible_at_s)??null,recoverable:typeof t.recoverable=="boolean"?t.recoverable:n==="recover",summary:i,keepalive_running:typeof t.keepalive_running=="boolean"?t.keepalive_running:void 0}}function zu(t,e){return(Array.isArray(t)?t:ut(t)&&Array.isArray(t.keepers)?t.keepers:[]).map(a=>{if(!ut(a))return null;const s=ut(a.agent)?a.agent:null,i=ut(a.context)?a.context:null,r=ut(a.metrics_window)?a.metrics_window:void 0,u=x(a.name);if(!u)return null;const d=A(a.context_ratio)??A(i==null?void 0:i.context_ratio),p=x(a.status)??x(s==null?void 0:s.status)??"offline",f=Wr(p),l=x(a.model)??x(a.active_model)??x(a.primary_model),c=vn(a.skill_secondary),m=i?{source:x(i.source),context_ratio:A(i.context_ratio),context_tokens:A(i.context_tokens),context_max:A(i.context_max),message_count:A(i.message_count),has_checkpoint:typeof i.has_checkpoint=="boolean"?i.has_checkpoint:void 0}:void 0,$=s?{name:x(s.name),exists:typeof s.exists=="boolean"?s.exists:void 0,error:x(s.error),status:x(s.status),current_task:x(s.current_task)??null,last_seen:x(s.last_seen),last_seen_ago_s:A(s.last_seen_ago_s),is_zombie:typeof s.is_zombie=="boolean"?s.is_zombie:void 0}:void 0,y=Mu(a.metrics_series),k={name:u,emoji:x(a.emoji),koreanName:x(a.koreanName)??x(a.korean_name),agent_name:x(a.agent_name),trace_id:x(a.trace_id),model:l,primary_model:x(a.primary_model),active_model:x(a.active_model),next_model_hint:x(a.next_model_hint)??null,status:f,presence_keepalive:typeof a.presence_keepalive=="boolean"?a.presence_keepalive:void 0,presence_keepalive_sec:A(a.presence_keepalive_sec),keepalive_running:typeof a.keepalive_running=="boolean"?a.keepalive_running:void 0,proactive_enabled:typeof a.proactive_enabled=="boolean"?a.proactive_enabled:void 0,proactive_idle_sec:A(a.proactive_idle_sec),proactive_cooldown_sec:A(a.proactive_cooldown_sec),last_heartbeat:x(a.last_heartbeat)??x(s==null?void 0:s.last_seen),generation:A(a.generation),turn_count:A(a.turn_count)??A(a.total_turns),keeper_age_s:A(a.keeper_age_s),last_turn_ago_s:A(a.last_turn_ago_s),last_handoff_ago_s:A(a.last_handoff_ago_s),last_compaction_ago_s:A(a.last_compaction_ago_s),last_proactive_ago_s:A(a.last_proactive_ago_s),context_ratio:d,context_tokens:A(a.context_tokens)??A(i==null?void 0:i.context_tokens),context_max:A(a.context_max)??A(i==null?void 0:i.context_max),context_source:x(a.context_source)??x(i==null?void 0:i.source),context:m,traits:vn(a.traits),interests:vn(a.interests),primaryValue:x(a.primaryValue)??x(a.primary_value),activityLevel:A(a.activityLevel)??A(a.activity_level),memory_recent_note:x(a.memory_recent_note)??null,conversation_tail_count:A(a.conversation_tail_count),k2k_count:A(a.k2k_count),handoff_count_total:A(a.handoff_count_total)??A(a.trace_history_count),compaction_count:A(a.compaction_count),last_compaction_saved_tokens:A(a.last_compaction_saved_tokens),diagnostic:fo(a.diagnostic),skill_primary:x(a.skill_primary)??null,skill_secondary:c,skill_reason:x(a.skill_reason)??null,metrics_series:y.length>0?y:void 0,metrics_window:r,agent:$};return k.diagnostic=fo(a.diagnostic)??hu(k,(e==null?void 0:e.lodge)??null),k}).filter(a=>a!==null)}function ju(t){return ut(t)?{...t,lodge:fu(t.lodge)??void 0}:null}function qu(t){const e=typeof t=="string"?t.toLowerCase():"";return e==="running"||e==="completed"||e==="stopped"||e==="error"?e:e.startsWith("error")?"error":"running"}function Fu(t){if(!ut(t))return null;const e=A(t.iteration);if(e==null)return null;const n=A(t.metric_before)??0,a=A(t.metric_after)??n;return{iteration:e,metric_before:n,metric_after:a,delta:A(t.delta)??a-n,changes:x(t.changes)??"",failed_attempts:x(t.failed_attempts)??"",next_suggestion:x(t.next_suggestion)??"",elapsed_ms:A(t.elapsed_ms)??0,cost_usd:A(t.cost_usd)??null}}function Hu(t){var i,r;if(!ut(t))return null;const e=x(t.loop_id);if(!e)return null;const n=A(t.baseline_metric)??0,a=Array.isArray(t.history)?t.history.map(Fu).filter(u=>u!==null):[],s=A(t.current_metric)??((i=a[0])==null?void 0:i.metric_after)??n;return{loop_id:e,profile:x(t.profile)??"unknown",status:qu(t.status),current_iteration:A(t.current_iteration)??((r=a[0])==null?void 0:r.iteration)??0,max_iterations:A(t.max_iterations)??0,baseline_metric:n,current_metric:s,target:x(t.target)??"",stagnation_streak:A(t.stagnation_streak)??0,stagnation_limit:A(t.stagnation_limit)??0,elapsed_seconds:A(t.elapsed_seconds)??0,history:a}}async function xe(t="full"){var a,s,i;const e=Date.now(),n=wa[t];if(!(n&&e-n.time<Du)){ri.value=!0;try{const r=await mc(t);wa[t]={data:r,time:e},Qt.value=(Array.isArray((a=r.agents)==null?void 0:a.agents)?r.agents.agents:[]).map(Eu).filter(d=>d!==null),_t.value=(Array.isArray((s=r.tasks)==null?void 0:s.tasks)?r.tasks.tasks:[]).map(Iu).filter(d=>d!==null),ye.value=(Array.isArray((i=r.messages)==null?void 0:i.messages)?r.messages.messages:[]).map(Ou).filter(d=>d!==null);const u=ju(r.status);ke.value=u,Nt.value=zu(r.keepers,u),cn.value=r.perpetual??null,wu.value=new Date().toISOString()}catch(r){console.error("Dashboard fetch error:",r)}finally{ri.value=!1}}}async function jt(){In.value=!0;try{const t=await Tc(Ln.value,{excludeSystem:me.value});Jt.value=t.posts??[],ci.value=new Date().toISOString()}catch(t){console.error("Board fetch error:",t)}finally{In.value=!1}}async function Ut(){var t;li.value=!0;try{const e=Kt.value||((t=ke.value)==null?void 0:t.room)||"default";Kt.value||(Kt.value=e);const n=await Uc(e);jr.value=n}catch(e){console.error("TRPG fetch error:",e)}finally{li.value=!1}}async function mn(){Oe.value=!0;try{const t=await cu();En.value=Array.isArray(t)?t:[],Fr.value=new Date().toISOString()}catch(t){console.error("Goals fetch error:",t)}finally{Oe.value=!1}}async function qe(){Me.value=!0;try{const t=await fc(),e=Array.isArray(t.loops)?t.loops:[],n=new Map;for(const a of e){const s=Hu(a);s&&n.set(s.loop_id,s)}qr.value=n,Hr.value=new Date().toISOString(),oi.value=null,ii.value=n.size===0?"idle":"ready"}catch(t){console.error("MDAL fetch error:",t),ii.value="error",oi.value=t instanceof Error?t.message:String(t)}finally{Me.value=!1}}let pa=null;function Ku(t){pa=t}let us=null,ds=null,Fe=null,He=null;function Uu(){Fe||(Fe=setTimeout(()=>{pa==null||pa(),Fe=null},500))}function Bu(){He||(He=setTimeout(()=>{qe(),He=null},350))}function Wu(){const t=wr.subscribe(e=>{if(e){if(e.type==="keeper_heartbeat"&&e.name){const n=new Map(si.value);n.set(e.name,e.ts_unix?e.ts_unix*1e3:Date.now()),si.value=n}Je(),us||(us=setTimeout(()=>{xe(),us=null},500)),(e.type==="board_post"||e.type==="masc/board_post"||e.type==="board_comment"||e.type==="masc/board_comment")&&(ds||(ds=setTimeout(()=>{jt(),ds=null},500))),(e.type==="keeper_handoff"||e.type==="keeper_compaction"||e.type==="keeper_guardrail")&&Je(),e.type.startsWith("decision_")&&Uu(),(e.type==="mdal_started"||e.type==="mdal_iteration"||e.type==="mdal_completed"||e.type==="mdal_stopped")&&Bu()}});return()=>{t(),Fe&&(clearTimeout(Fe),Fe=null),He&&(clearTimeout(He),He=null)}}let fn=null;function Gu(){fn||(fn=setInterval(()=>{Je(),xe()},1e4))}function Ju(){fn&&(clearInterval(fn),fn=null)}function w({title:t,class:e,children:n}){return o`
  ...
  `}function Xr(){const t=new URLSearchParams(window.location.search),e=t.get("agent")??t.get("agent_name"),n=localStorage.getItem("masc_dashboard_agent_name");return(e??n??"dashboard").trim()||"dashboard"}async function md(){try{const t=await Gn({actor:Xr(),action_type:"lodge_tick",target_type:"room",payload:{}}),e=Mi(t.result);Je(),await xe(),e!=null&&e.skipped_reason?S(e.skipped_reason,"warning"):S(e?`Poke finished: ${e.acted}/${e.checked} acted`:"Poke finished",e&&e.acted>0?"success":"warning")}catch(t){const e=t instanceof Error?t.message:"Failed to run Lodge poke";S(e,"error")}}function fd({keeper:t}){return o`
  ...
  `:null}const gd="masc_dashboard_agent_name",en=_(null),Ca=_(!1),Mn=_(""),Na=_([]),zn=_([]),Ke=_(""),_n=_(!1);function Ue(t){en.value=t,qi()}function $o(){en.value=null,Mn.value="",Na.value=[],zn.value=[],Ke.value=""}function hd(){const t=en.value;return t?Qt.value.find(e=>e.name===t)??null:null}function Zr(t){return t?_t.value.filter(e=>e.assignee===t):[]}async function qi(){const t=en.value;if(t){Ca.value=!0,Mn.value="",Na.value=[],zn.value=[];try{const e=await nu(80);Na.value=e.filter(s=>s.includes(t)).slice(0,20);const n=Zr(t).slice(0,6);if(n.length===0)return;const a=await Promise.all(n.map(async s=>{try{const i=await au(s.id,25);return{taskId:s.id,text:i.trim()}}catch(i){const r=i instanceof Error?i.message:"history load failed";return{taskId:s.id,text:`Failed to load history: ${r}`}}}));zn.value=a}catch(e){Mn.value=e instanceof Error?e.message:"Failed to load agent detail"}finally{Ca.value=!1}}}async function yo(){var a;const t=en.value,e=Ke.value.trim();if(!t||!e)return;const n=((a=localStorage.getItem(gd))==null?void 0:a.trim())||"dashboard";_n.value=!0;try{await Er(n,`@${t} ${e}`),Ke.value="",S(`Mention sent to ${t}`,"success"),qi()}catch(s){const i=s instanceof Error?s.message:"Failed to send mention";S(i,"error")}finally{_n.value=!1}}function $d({task:t}){return o`
  ...
  `}function bd(){var s,i,r,u;const t=en.value;if(!t)return null;const e=hd(),n=Zr(t),a=Na.value;return o`
    <div
      ...
      <div class="agent-detail-modal">
        <div class="agent-detail-header">
          ...
          <div class="agent-detail-actions">
            <button class="control-btn ghost" onClick=${()=>{qi()}} disabled=${Ca.value}>
        ...
        <${w} title="Direct Mention">
          <div class="agent-mention-row">
            <input
              ...
              value=${Ke.value}
              onInput=${d=>{Ke.value=d.target.value}}
            ...
            <button
              class="control-btn"
              onClick=${()=>{yo()}}
              disabled=${_n.value||Ke.value.trim()===""}
            >
    ...
    <${w} title="Room Health" class="section">
      ...
      <div class="overview-health-grid">
        ...
        <div class="stat-card">
          ...
          <div class="stat-value" style=${`color:${ta(Ce(i==null?void 0:i.alert_level))}`}>${Ao(i==null?void 0:i.alert_level)}</div>
          <div class="monitor-stat-caption">Freshness ${_s(i==null?void 0:i.last_activity_age_s)}</div>
        </div>
        <div class="stat-card">
          <div class="stat-label">Council Feed</div>
          <div class="stat-value" style=${`color:${ta(Ce(r==null?void 0:r.alert_level))}`}>${Ao(r==null?void 0:r.alert_level)}</div>
    ...
    <div class="grid-2col">
      <${w} title="Agent Watch" class="section">
        ...
        <div class="monitor-list">
          ${y.length===0?o`<div class="empty-state">No agent drift or stale load right now</div>`:y.slice(0,5).map(v=>o`
                <button class="monitor-row ${v.tone}" onClick=${()=>Ue(v.agent.name)}>
                  <div class="monitor-row-header">
                    <div class="monitor-row-title">
                      <div class="monitor-name-line">
      ...
      <${w} title="Runtime Notes" class="section">
        ...
        <div class="overview-note-stack">
          ...
          <div class="overview-inline-note">
            ${cn.value?`Perpetual runtime ${cn.value.running?"running":"stopped"}${cn.value.goal?` · ${Zt(cn.value.goal,120)}`:""}`:"Perpetual runtime unavailable"}
          </div>
          <div class="overview-inline-note">
  ...
  `}function kp(){var dt,tt,it,I,J,b,Dt,Yt,ue;const t=le.value,e=ke.value,n=fp(),a=n?Qt.value.find(L=>L.name===n)??null:null,s=n?_t.value.filter(L=>L.assignee===n&&gp(L)):[],i=((dt=t==null?void 0:t.operations.summary)==null?void 0:dt.active)??0,r=((tt=t==null?void 0:t.detachments.summary)==null?void 0:tt.total)??0,u=((it=t==null?void 0:t.decisions.summary)==null?void 0:it.pending)??0,d=t==null?void 0:t.detachments.detachments.find(L=>{const Pt=L.detachment.heartbeat_deadline,de=Pt?Date.parse(Pt):Number.NaN;return L.detachment.status==="stalled"||!Number.isNaN(de)&&de<=Date.now()}),p=t==null?void 0:t.alerts.alerts.find(L=>L.severity==="bad"),f=!!(e!=null&&e.room||e!=null&&e.project),l=(a==null?void 0:a.current_task)??null,c=_p(a==null?void 0:a.last_seen),m=c!=null?c<=120:null,$=[f?{title:"Room readiness",tone:"ok",detail:`${(e==null?void 0:e.room)??(e==null?void 0:e.project)??"unknown"} · base ${(e==null?void 0:e.room_base_path)??"n/a"}`,tool:"masc_status"}:{title:"Room readiness",tone:"bad",detail:"No room snapshot yet. Set room to repo root before joining.",tool:"masc_set_room"},n?a?s.length===0?{title:"Task readiness",tone:"warn",detail:`${n} has no claimed task. Claim one or create one first.`,tool:_t.value.length>0?"masc_claim":"masc_add_task"}:l?m===!1?{title:"Task readiness",tone:"warn",detail:`${n} current_task=${l}, but heartbeat is stale (${c}s).`,tool:"masc_heartbeat"}:{title:"Task readiness",tone:"ok",detail:`${n} current_task=${l}${c!=null?` · last seen ${c}s ago`:""}`,tool:"masc_plan_get_task"}:{title:"Task readiness",tone:"bad",detail:`${n} has a claimed task but no session current_task binding.`,tool:"masc_plan_set_task"}:{title:"Task readiness",tone:"bad",detail:`${n} is not visible in the room roster.`,tool:"masc_join"}:{title:"Task readiness",tone:"warn",detail:"No ?agent= query param. Dashboard can show room health but not agent-specific next steps.",tool:"masc_join"},!t||(((I=t.topology.summary)==null?void 0:I.managed_unit_count)??0)===0?{title:"Operation readiness",tone:"warn",detail:"No managed units defined yet. CPv2 benchmark cannot start before hierarchy exists.",tool:"masc_unit_define"}:i===0?{title:"Operation readiness",tone:"warn",detail:`${((J=t.topology.summary)==null?void 0:J.managed_unit_count)??0} managed units are ready, but there is no active operation.`,tool:"masc_operation_start"}:{title:"Operation readiness",tone:"ok",detail:`${i} active operation(s) across ${((b=t.topology.summary)==null?void 0:b.managed_unit_count)??0} managed unit(s).`,tool:"masc_observe_operations"},u>0?{title:"Dispatch readiness",tone:"warn",detail:`${u} pending approval(s) are blocking strict actions.`,tool:"masc_policy_approve"}:i>0&&r===0?{title:"Dispatch readiness",tone:"bad",detail:"Active operation exists but no detachment has been materialized yet.",tool:"masc_dispatch_tick"}:d||p?{title:"Dispatch readiness",tone:"warn",detail:`Dispatch needs reconciliation${d?` · detachment ${d.detachment.detachment_id} is stalled`:""}${p?` · alert ${p.title??p.alert_id}`:""}.`,tool:u>0?"masc_policy_approve":"masc_dispatch_tick"}:{title:"Dispatch readiness",tone:"ok",detail:`${r} detachment(s) visible and no strict approval backlog.`,tool:"masc_detachment_list"}],y=f?!n||!a?"masc_join":s.length===0?_t.value.length>0?"masc_claim":"masc_add_task":l?m===!1?"masc_heartbeat":!t||(((Dt=t.topology.summary)==null?void 0:Dt.managed_unit_count)??0)===0?"masc_unit_define":i===0?"masc_operation_start":u>0?"masc_policy_approve":i>0&&r===0||d||p?"masc_dispatch_tick":"masc_observe_traces":"masc_plan_set_task":"masc_set_room",k=hp(y),T=$p(y==="masc_set_room"?["repo-root-room"]:y==="masc_plan_set_task"?["claimed-not-current"]:y==="masc_heartbeat"?["heartbeat-stale"]:y==="masc_dispatch_tick"?["no-detachments"]:y==="masc_policy_approve"?["pending-approval"]:["repo-root-room","claimed-not-current","heartbeat-stale"]).slice(0,2),M=hs("room_task_hygiene"),C=hs("cpv2_benchmark"),D=hs("supervisor_session"),Z=((Yt=Jn.value)==null?void 0:Yt.docs)??[],$t=[M,C,D].filter(L=>L!==null);return o`
    <div class="command-guide-grid">
      ...
      <section class="card command-section">
        ...
        ${di.value?o`<div class="empty-state">Loading CPv2 runbook…</div>`:La.value?o`<div class="empty-state error">${La.value}</div>`:o`
  ...
  `}function Ep(){switch(Fi.value){case"topology":return o`<${Rp} />`;case"alerts":return o`<${Dp} />`;case"trace":return o`<${Pp} />`;case"control":return o`<${Lp} />`;case"operations":default:return o`<${Np} />`}}function Ip(){return xt(()=>{jn(),np()},[]),o`
  ...
  `}const Vn=_(null),Ea=_(!1),re=_(null),W=_(!1),Ia=_([]);let Op=1;function G(t){return typeof t=="object"&&t!==null&&!Array.isArray(t)}function P(t){return typeof t=="string"&&t.trim()!==""?t:void 0}function mt(t){return typeof t=="number"&&Number.isFinite(t)?t:void 0}function sl(t){return typeof t=="boolean"?t:void 0}function Mp(t){return Array.isArray(t)?t.map(e=>typeof e=="string"?e.trim():"").filter(Boolean):[]}function Le(t,e=[]){if(Array.isArray(t))return t;if(!G(t))return[];for(const n of e){const a=t[n];if(Array.isArray(a))return a}return[]}function zp(t){return G(t)?{id:P(t.id),seq:mt(t.seq),from:P(t.from)??P(t.from_agent)??"system",content:P(t.content)??"",timestamp:P(t.timestamp)??new Date().toISOString(),type:P(t.type)}:null}function jp(t){return G(t)?{room_id:P(t.room_id),current_room:P(t.current_room)??P(t.room),project:P(t.project),cluster:P(t.cluster),paused:sl(t.paused),pause_reason:P(t.pause_reason)??null,paused_by:P(t.paused_by)??null,paused_at:P(t.paused_at)??null}:{}}function Co(t){if(!G(t))return;const e=Object.entries(t).map(([n,a])=>{const s=P(a);return s?[n,s]:null}).filter(n=>n!==null);return e.length>0?Object.fromEntries(e):void 0}function qp(t){if(!G(t))return null;const e=G(t.status)?t.status:void 0,n=G(t.summary)?t.summary:G(e==null?void 0:e.summary)?e.summary:void 0,a=G(t.session)?t.session:G(e==null?void 0:e.session)?e.session:void 0,s=P(t.session_id)??P(n==null?void 0:n.session_id)??P(a==null?void 0:a.session_id);if(!s)return null;const i=Co(t.report_paths)??Co(e==null?void 0:e.report_paths),r=Le(t.recent_events,["events"]).filter(G);return{session_id:s,status:P(t.status)??P(n==null?void 0:n.status)??P(a==null?void 0:a.status),progress_pct:mt(t.progress_pct)??mt(n==null?void 0:n.progress_pct),elapsed_sec:mt(t.elapsed_sec)??mt(n==null?void 0:n.elapsed_sec),remaining_sec:mt(t.remaining_sec)??mt(n==null?void 0:n.remaining_sec),done_delta_total:mt(t.done_delta_total)??mt(n==null?void 0:n.done_delta_total),summary:n,team_health:G(t.team_health)?t.team_health:G(e==null?void 0:e.team_health)?e.team_health:void 0,communication_metrics:G(t.communication_metrics)?t.communication_metrics:G(e==null?void 0:e.communication_metrics)?e.communication_metrics:void 0,orchestration_state:G(t.orchestration_state)?t.orchestration_state:G(e==null?void 0:e.orchestration_state)?e.orchestration_state:void 0,cascade_metrics:G(t.cascade_metrics)?t.cascade_metrics:G(e==null?void 0:e.cascade_metrics)?e.cascade_metrics:void 0,report_paths:i,session:a,recent_events:r}}function Fp(t){if(!G(t))return null;const e=P(t.name);if(!e)return null;const n=G(t.context)?t.context:void 0;return{name:e,agent_name:P(t.agent_name),status:P(t.status),autonomy_level:P(t.autonomy_level),context_ratio:mt(t.context_ratio)??mt(n==null?void 0:n.context_ratio),generation:mt(t.generation),active_goal_ids:Mp(t.active_goal_ids),last_autonomous_action_at:P(t.last_autonomous_action_at)??null,last_turn_ago_s:mt(t.last_turn_ago_s),model:P(t.model)??P(t.active_model)??P(t.primary_model)}}function Hp(t){if(!G(t))return null;const e=P(t.confirm_token)??P(t.token);return e?{confirm_token:e,actor:P(t.actor),action_type:P(t.action_type),target_type:P(t.target_type),target_id:P(t.target_id)??null,delegated_tool:P(t.delegated_tool),created_at:P(t.created_at),preview:t.preview}:null}function Kp(t){const e=G(t)?t:{};return{room:jp(e.room),sessions:Le(e.sessions,["items","sessions"]).map(qp).filter(n=>n!==null),keepers:Le(e.keepers,["items","keepers"]).map(Fp).filter(n=>n!==null),recent_messages:Le(e.recent_messages,["messages"]).map(zp).filter(n=>n!==null),pending_confirms:Le(e.pending_confirms,["items","confirms"]).map(Hp).filter(n=>n!==null),available_actions:Le(e.available_actions,["actions"]).filter(G).map(n=>({action_type:P(n.action_type)??"unknown",target_type:P(n.target_type)??"unknown",description:P(n.description),confirm_required:sl(n.confirm_required)}))}}function ea(t){if(typeof t=="string")return t;if(t==null)return"";try{return JSON.stringify(t)}catch{return String(t)}}function No(t){return t.target_id?`${t.target_type}:${t.target_id}`:t.target_type}function Oa(t){Ia.value=[{...t,id:Op++,at:new Date().toISOString()},...Ia.value].slice(0,20)}function il(t){return t.confirm_required?ea(t.preview)||"Confirmation required":ea(t.result)||ea(t.executed_action)||ea(t.delegated_tool_result)||t.status}async function Qe(){Ea.value=!0,re.value=null;try{const t=await _c();Vn.value=Kp(t)}catch(t){re.value=t instanceof Error?t.message:"Failed to load operator snapshot"}finally{Ea.value=!1}}async function Up(t){W.value=!0,re.value=null;try{const e=await Gn(t);return Oa({actor:t.actor,action_type:t.action_type,target_label:No(t),outcome:e.confirm_required?"preview":"executed",message:il(e),delegated_tool:e.delegated_tool}),await Qe(),e}catch(e){const n=e instanceof Error?e.message:"Operator action failed";throw re.value=n,Oa({actor:t.actor,action_type:t.action_type,target_label:No(t),outcome:"error",message:n}),e}finally{W.value=!1}}async function Bp(t,e){W.value=!0,re.value=null;try{const n=await bc(t,e);return Oa({actor:t,action_type:"confirm",target_label:e,outcome:"confirmed",message:il(n),delegated_tool:n.delegated_tool}),await Qe(),n}catch(n){const a=n instanceof Error?n.message:"Operator confirmation failed";throw re.value=a,Oa({actor:t,action_type:"confirm",target_label:e,outcome:"error",message:a}),n}finally{W.value=!1}}const ol="masc_dashboard_agent_name";function Wp(){var e,n,a;const t=new URLSearchParams(window.location.search);return((e=t.get("agent"))==null?void 0:e.trim())||((n=t.get("agent_name"))==null?void 0:n.trim())||((a=localStorage.getItem(ol))==null?void 0:a.trim())||"dashboard"}const ss=_(Wp()),gn=_(""),pi=_("Operator pause"),hn=_(""),Ma=_(""),vi=_("2"),za=_(""),Be=_("note"),ja=_(""),qa=_(""),Fa=_(""),mi=_("2"),fi=_("Operator stop request"),_i=_(""),$n=_("");function Gp(t){const e=t.trim()||"dashboard";ss.value=e,localStorage.setItem(ol,e)}function Ro(t){if(t==null)return"";if(typeof t=="string")return t;try{return JSON.stringify(t,null,2)}catch{return String(t)}}function Jp(t){return typeof t!="number"||!Number.isFinite(t)?"n/a":t<60?`${Math.round(t)}s ago`:t<3600?`${Math.round(t/60)}m ago`:`${Math.round(t/3600)}h ago`}function Ha(t){return typeof t=="string"?t.trim().toLowerCase():""}function Vp(t){var a;const e=Ha(t.status);if(e==="paused")return"bad";const n=Ha((a=t.team_health)==null?void 0:a.status);return n&&n!=="ok"&&n!=="healthy"&&n!=="green"||e&&e!=="active"&&e!=="running"&&e!=="ended"?"warn":"ok"}function Do(t){const e=Ha(t.status);return e==="offline"||e==="inactive"||e==="error"?"bad":(t.context_ratio??0)>=.8||(t.last_turn_ago_s??0)>=3600?"warn":"ok"}async function Se(t){const e=ss.value.trim()||"dashboard";try{const n=await Up({actor:e,action_type:t.action_type,target_type:t.target_type,target_id:t.target_id,payload:t.payload});return n.confirm_required?S("Confirmation queued","warning"):S(t.successMessage,"success"),n}catch(n){const a=n instanceof Error?n.message:"Operator action failed";return S(a,"error"),null}}async function Po(){const t=gn.value.trim();if(!t)return;await Se({action_type:"broadcast",target_type:"room",payload:{message:t},successMessage:"Broadcast sent"})&&(gn.value="")}async function Qp(){await Se({action_type:"room_pause",target_type:"room",payload:{reason:pi.value.trim()||"Operator pause"},successMessage:"Pause request sent"})}async function Yp(){await Se({action_type:"room_resume",target_type:"room",payload:{},successMessage:"Room resumed"})}async function Xp(){const t=hn.value.trim();if(!t)return;await Se({action_type:"task_inject",target_type:"room",payload:{title:t,description:Ma.value.trim()||"Injected from Ops tab",priority:Number.parseInt(vi.value,10)||2},successMessage:"Task injection submitted"})&&(hn.value="",Ma.value="")}async function Zp(){var i;const t=Vn.value,e=za.value||((i=t==null?void 0:t.sessions[0])==null?void 0:i.session_id)||"";if(!e){S("Select a team session first","warning");return}const n={turn_kind:Be.value},a=ja.value.trim();a&&(n.message=a),Be.value==="task"&&(n.task_title=qa.value.trim()||"Operator injected task",n.task_description=Fa.value.trim()||"Injected from Ops tab",n.task_priority=Number.parseInt(mi.value,10)||2),await Se({action_type:"team_turn",target_type:"team_session",target_id:e,payload:n,successMessage:"Team session updated"})&&(ja.value="",Be.value==="task"&&(qa.value="",Fa.value=""))}async function tv(){var n;const t=Vn.value,e=za.value||((n=t==null?void 0:t.sessions[0])==null?void 0:n.session_id)||"";if(!e){S("Select a team session first","warning");return}await Se({action_type:"team_stop",target_type:"team_session",target_id:e,payload:{reason:fi.value.trim()||"Operator stop request"},successMessage:"Team stop requested"})}async function ev(){var s;const t=Vn.value,e=_i.value||((s=t==null?void 0:t.keepers[0])==null?void 0:s.name)||"",n=$n.value.trim();if(!e){S("Select a keeper first","warning");return}if(!n)return;await Se({action_type:"keeper_msg",target_type:"keeper",target_id:e,payload:{message:n},successMessage:`Message sent to ${e}`})&&($n.value="")}async function nv(t){const e=ss.value.trim()||"dashboard";try{await Bp(e,t),S("Confirmation executed","success")}catch(n){const a=n instanceof Error?n.message:"Confirmation failed";S(a,"error")}}function av(){var l;xt(()=>{Qe()},[]);const t=Vn.value,e=(t==null?void 0:t.room)??{},n=(t==null?void 0:t.sessions)??[],a=(t==null?void 0:t.keepers)??[],s=(t==null?void 0:t.pending_confirms)??[],i=(t==null?void 0:t.recent_messages)??[],r=n.find(c=>c.session_id===za.value)??n[0]??null,u=a.find(c=>c.name===_i.value)??a[0]??null,d=n.filter(c=>Vp(c)!=="ok"),p=a.filter(c=>Do(c)!=="ok"),f=[{key:"room",label:"Room Gate",value:e.paused?"Paused":"Open",detail:e.paused?`Resume gate armed${e.pause_reason?` · ${e.pause_reason}`:""}`:"Commands are live and the room is accepting new work",tone:e.paused?"bad":"ok"},{key:"confirm",label:"Pending Confirm",value:s.length,detail:s.length>0?"Previewed operator actions are waiting for confirmation":"No confirm gates are currently blocking execution",tone:s.length>0?"warn":"ok"},{key:"session",label:"Session Risk",value:d.length,detail:d.length>0?"Team sessions need steering, stop, or checkpoint attention":"Team sessions look healthy from the operator snapshot",tone:d.some(c=>Ha(c.status)==="paused")?"bad":d.length>0?"warn":"ok"},{key:"keeper",label:"Keeper Pressure",value:p.length,detail:p.length>0?"At least one keeper is stale, offline, or running hot":"Keepers are available for direct intervention",tone:p.some(c=>Do(c)==="bad")?"bad":p.length>0?"warn":"ok"}];return o`
        ...
        <section class="card ops-panel">
          ...
          <div class="control-row">
            <input
              ...
              disabled=${W.value}
            />
            <button class="control-btn" onClick=${()=>{Po()}} disabled=${W.value||gn.value.trim()===""}>
              Send
            </button>
          </div>
        ...
        <section class="card ops-panel">
          ...
          <div class="control-row ops-split-row">
            <select
              ...
              class="control-input ops-select"
              value=${Be.value}
              onChange=${c=>{Be.value=c.target.value}}
              disabled=${W.value||!r}
            >
  ...
  `}const gi=_([]),hi=_([]),yn=_(""),Ka=_(!1),bn=_(!1),qn=_(""),Ua=_(null),wt=_(null),$i=_(!1),_e=_(null),fa=_(null);async function Ye(){Ka.value=!0,qn.value="";try{const[t,e]=await Promise.all([su(),iu()]);gi.value=t,hi.value=e,_e.value=!0,fa.value=Date.now()}catch(t){qn.value=t instanceof Error?t.message:"Failed to load council data",_e.value=!1}finally{Ka.value=!1}}Ku(Ye);async function Lo(){const t=yn.value.trim();if(t){bn.value=!0;try{const e=await ou(t);yn.value="",S(e!=null&&e.id?`Debate started: ${e.id}`:"Debate started","success"),await Ye()}catch(e){const n=e instanceof Error?e.message:"Failed to start debate";S(n,"error")}finally{bn.value=!1}}}async function sv(t){Ua.value=t,$i.value=!0,wt.value=null;try{wt.value=await ru(t)}catch(e){qn.value=e instanceof Error?e.message:"Failed to load debate status",wt.value=null}finally{$i.value=!1}}function iv({debate:t}){const e=Ua.value===t.id;return o`
    <button
  ...
  `}function lv(){xt(()=>{Ye()},[]);const t=_e.value===!1;return o`
    <div>
      <${rv} />
      <${w} title="Council Command" class="section">
        <div class="council-create">
          ...
          <button class="control-btn ghost" onClick=${Ye} disabled=${Ka.value}>
...
`))}</p>`)}return n}function $s(t){const e=[],n=/(`[^`]+`)|(\*\*[^*]+\*\*)|(\*[^*]+\*)|\[([^\]]+)\]\(([^)]+)\)/g;let a=0,s;for(;(s=n.exec(t))!==null;){if(s.index>a&&e.push(t.slice(a,s.index)),s[1]){const i=s[1].slice(1,-1);e.push(o`<code>${i}</code>`)}else if(s[2]){const i=s[2].slice(2,-2);e.push(o`<strong>${i}</strong>`)}else if(s[3]){const i=s[3].slice(1,-1);e.push(o`<em>${i}</em>`)}else s[4]&&s[5]&&e.push(o`<a href=${s[5]} target="_blank" rel="noopener">${s[4]}</a>`);a=s.index+s[0].length}return a<t.length&&e.push(t.slice(a)),e.length>0?e:[t]}const rl=[{id:"hot",label:"Hot"},{id:"trending",label:"Trending"},{id:"recent",label:"Recent"},{id:"updated",label:"Updated"},{id:"discussed",label:"Discussed"}],_a=_(null),kn=_([]),he=_(!1),ge=_(null),xn=_("");function dv(){var e,n;const t=new URLSearchParams(window.location.search);return((e=t.get("agent"))==null?void 0:e.trim())||((n=t.get("agent_name"))==null?void 0:n.trim())||"dashboard-user"}const pv=_(dv()),Sn=_(!1);async function Hi(t){ge.value=t,_a.value=null,kn.value=[],he.value=!0;try{const e=await Cc(t);if(ge.value!==t)return;_a.value={id:e.id,author:e.author,title:e.title,content:e.content,tags:e.tags,votes:e.votes,vote_balance:e.vote_balance,comment_count:e.comment_count,created_at:e.created_at,updated_at:e.updated_at,flair:e.flair,hearth_count:e.hearth_count},kn.value=e.comments??[]}catch{ge.value===t&&(_a.value=null,kn.value=[])}finally{ge.value===t&&(he.value=!1)}}async function Eo(t){const e=xn.value.trim();if(e){Sn.value=!0;try{await Nc(t,pv.value,e),xn.value="",S("Comment posted","success"),await Hi(t),jt()}catch{S("Failed to post comment","error")}finally{Sn.value=!1}}}function vv(){const t=Ln.value;return o`
  ...
  `}function ll({flair:t}){return t?o`<span class="post-flair ${t}">${t}</span>`:null}function mv(t){const e=t.replace(/!\[[^\]]*\]\([^)]+\)/g," ").replace(/\[[^\]]+\]\([^)]+\)/g,"$1").replace(/[`#>*_~-]/g," ").replace(/\s+/g," ").trim();return e?e.length>180?`${e.slice(0,177)}...`:e:"No preview available"}function Io(t){return t.updated_at!==t.created_at}function bs(){var n;const t=((n=rl.find(a=>a.id===Ln.value))==null?void 0:n.label)??Ln.value,e=Jt.value.length;return o`
  ...
  `}function hv({post:t}){ge.value!==t.id&&!he.value&&Hi(t.id);const e=async n=>{try{await Lr(t.id,n),jt()}catch{S("Failed to vote","error")}};return o`
    <div>
      ...
      <${w} title="Comments (${he.value?"...":kn.value.length})">
        ${he.value?o`<div class="loading-indicator">Loading comments...</div>`:o`<${_v} comments=${kn.value} />`}
        <${gv} postId=${t.id} />
      <//>
    </div>
  `}function $v(){var s,i;const t=Jt.value,e=In.value,n=zt.value.postId,a=((i=(s=ke.value)==null?void 0:s.data_quality)==null?void 0:i.board_contract_ok)===!1;if(n){const r=t.find(u=>u.id===n)??(ge.value===n?_a.value:null);return!r&&ge.value!==n&&!he.value&&Hi(n),r?o`
          <${ys} />
          <${bs} />
          <${hv} post=${r} />
        `:o`
  ...
  `}function zv(){const t=Lv.value,e=Ev.value,n=e[0],a=Iv.value;return o`
    <div class="stats-grid">
      <${on} label="Visible rows" value=${e.length} />
      <${on} label="Tracked messages" value=${t.messages} color="#47b8ff" />
      <${on} label="Keeper signals" value=${t.keepers} color="#4ade80" />
      <${on} label="Board signals" value=${t.board} color="#fbbf24" />
      <${on} label="SSE events" value=${Bn.value} color="#c084fc" />
    </div>
  ...
  `}function Jv({row:t}){const{agent:e,motion:n}=t;return o`
    <button class="monitor-row ${t.tone}" onClick=${()=>Ue(e.name)}>
      <div class="monitor-row-header">
  ...
  `}function Qv(){const t=[...Qt.value].map(Bv).sort((d,p)=>{const f=Re(p.tone)-Re(d.tone);if(f!==0)return f;const l=p.activeTaskCount-d.activeTaskCount;return l!==0?l:ee(p.lastSignalAt)-ee(d.lastSignalAt)}),e=[...Nt.value].map(Wv).sort((d,p)=>{const f=Re(p.tone)-Re(d.tone);if(f!==0)return f;const l=(p.keeper.context_ratio??0)-(d.keeper.context_ratio??0);return l!==0?l:ee(p.keeper.last_heartbeat)-ee(d.keeper.last_heartbeat)}),n=t.filter(d=>d.state!=="offline").length,a=t.filter(d=>d.state==="working").length,s=t.filter(d=>d.lastSignalAt&&Date.now()-ee(d.lastSignalAt)<=12e4).length,i=t.filter(d=>d.tone!=="ok"),r=e.filter(d=>d.tone!=="ok"),u=[...r.map(d=>({kind:"keeper",key:`keeper-${d.keeper.name}`,tone:d.tone,title:d.keeper.name,subtitle:`${d.note} · ${d.focus}`,timestamp:d.keeper.last_heartbeat??null,keeper:d.keeper})),...i.map(d=>({kind:"agent",key:`agent-${d.agent.name}`,tone:d.tone,title:d.agent.name,subtitle:`${d.note} · ${d.focus}`,timestamp:d.lastSignalAt,agent:d.agent}))].sort((d,p)=>{const f=Re(p.tone)-Re(d.tone);return f!==0?f:ee(p.timestamp)-ee(d.timestamp)}).slice(0,8);return o`
    <div class="agents-monitor">
      <div class="stats-grid">
        <${rn} label="Agents online" value=${n} color="#4ade80" caption="active + idle" />
        <${rn} label="Working now" value=${a} color="#fbbf24" caption="task or claimed load" />
        <${rn} label="Fresh signals" value=${s} color="#22d3ee" caption="within last 2 minutes" />
        <${rn} label="Agent alerts" value=${i.length} color=${i.length>0?"#fb7185":"#4ade80"} caption="quiet or offline" />
        <${rn} label="Keeper alerts" value=${r.length} color=${r.length>0?"#fb7185":"#4ade80"} caption="stale or high pressure" />
      </div>
  ...
  `}const Ba=600*1e3,ga=1200*1e3;function is(t){return(t??"").trim().toLowerCase()}function It(t){if(t==null)return 0;const e=typeof t=="number"?t:Date.parse(t);return Number.isNaN(e)?0:e}function $e(t,e=96){const n=(t??"").replace(/\s+/g," ").trim();return n?n.length>e?`${n.slice(0,e-3)}...`:n:null}function te(t){switch(t){case"bad":return 2;case"warn":return 1;default:return 0}}function Fn(t){return typeof t!="number"||Number.isNaN(t)?3:t}function dl(t){const e=Fn(t);return e<=1?"P1":e===2?"P2":e>=4?"P4+":"P3"}function pl(t){switch(t){case"in_progress":return"In Progress";case"claimed":return"Claimed";case"done":return"Done";case"cancelled":return"Cancelled";default:return"Todo"}}function vl(t){switch(t){case"dispatchable":return"Dispatch";case"drift":return"Drift";case"quiet":return"Quiet";case"offline":return"Offline";default:return"Loaded"}}function Xv(t){return t.updated_at??t.created_at??null}function Zv(t){const e=new Map;for(const n of t)e.set(is(n.name),On(n.name,_t.value,ye.value,oe.value,{currentTask:n.current_task,lastSeen:n.last_seen,boardPosts:Jt.value,keepers:Nt.value}));return e}function Mo(t,e,n){var k,R;const a=is(t.assignee),s=a?e.get(a)??null:null,i=s?n.get(a)??null:null,r=(i==null?void 0:i.lastActivityAt)??(s==null?void 0:s.last_seen)??null,u=r?Math.max(0,Date.now()-It(r)):Number.POSITIVE_INFINITY,d=$e(t.description),p=$e(s==null?void 0:s.current_task)??(i==null?void 0:i.lastActivityText)??null,f=t.status==="claimed"||t.status==="in_progress";let l="ok",c="Fresh owner coverage",m=p??d??t.id,$=!1,y=!1;return t.status==="todo"?t.assignee?s?s.status==="offline"||s.status==="inactive"?($=!0,l="bad",c="Assigned owner is offline",m="Queue item is blocked until ownership changes."):u>Ba?(l="warn",c="Owner exists but live signal is quiet",m=p??"Owner may need a nudge before pickup."):((i==null?void 0:i.activeAssignedCount)??0)>0||(k=s.current_task)!=null&&k.trim()?(l="warn",c="Owner is already carrying active work",m=p??`${(i==null?void 0:i.activeAssignedCount)??0} active tasks already assigned.`):(c="Ready and covered by a fresh operator",m=p??d??"This can be picked up immediately."):($=!0,l="bad",c="Assigned owner is not present in the room",m="Reassign or bring the owner back online."):($=!0,l=Fn(t.priority)<=2?"bad":"warn",c=Fn(t.priority)<=2?"Urgent ready work has no owner":"Ready work has no owner",m="Assign an agent before this queue item slips."):f&&(t.assignee?s?s.status==="offline"||s.status==="inactive"?($=!0,l="bad",c="Assigned owner is offline",m=p??"Execution has no live operator right now."):u>ga?(y=!0,l="bad",c="Assigned owner has gone quiet",m=p??"Fresh operator signal is missing."):u>Ba?(y=!0,l="warn",c="Execution has been quiet for too long",m=p??"Check whether this work is blocked."):(R=s.current_task)!=null&&R.trim()?(c="Execution has fresh owner coverage",m=p??d??t.id):(l="warn",c=t.status==="claimed"?"Claimed work is waiting for explicit focus":"Owner is live but current_task is empty",m=p??"Task state and agent focus are drifting apart."):($=!0,l="bad",c="Assigned owner is not active in the room",m="Execution is orphaned until ownership is restored."):($=!0,l="bad",c="Active work has no assignee",m="Claim or reassign this task immediately.")),{task:t,assigneeAgent:s,motion:i,tone:l,note:c,focus:m,lastSignalAt:r,lastTouchedAt:Xv(t),ownerGap:$,quiet:y}}function tm(t,e){var c;const n=e.get(is(t.name))??{activeAssignedCount:0,lastActivityAt:null,lastActivityText:null},a=n.lastActivityAt??t.last_seen??null,s=a?Math.max(0,Date.now()-It(a)):Number.POSITIVE_INFINITY,i=!!((c=t.current_task)!=null&&c.trim()),r=n.activeAssignedCount,u=i||r>0;let d="loaded",p="ok",f="Healthy active load",l=$e(t.current_task)??n.lastActivityText??"Ready for assignment";return t.status==="offline"||t.status==="inactive"?(d="offline",p="bad",f="Agent is unavailable"):u&&s>ga?(d="quiet",p="bad",f="Working without a fresh signal"):r>0&&!i?(d="drift",p="warn",f="Claimed work exists but current_task is empty",l=`${r} active tasks need explicit focus.`):i&&r===0?(d="drift",p="warn",f="current_task has no matching claimed work",l=$e(t.current_task)??"Task metadata and operator state drifted."):!u&&s<=Ba?(d="dispatchable",p="ok",f="Fresh signal and no active load",l=n.lastActivityText??"Ready for assignment."):u?s>Ba&&(d="loaded",p="warn",f="Execution load is healthy but slightly quiet",l=$e(t.current_task)??`${r} active tasks in flight.`):(d="quiet",p=s>ga?"bad":"warn",f=s>ga?"No fresh signal while idle":"Reachable, but not freshly active",l=n.lastActivityText??"Likely available after a quick check-in."),{agent:t,motion:n,tone:p,state:d,note:f,focus:l,lastSignalAt:a,activeTaskCount:r}}function ln({label:t,value:e,color:n,caption:a}){return o`
    <div class="stat-card">
      <div class="stat-label">${t}</div>
      <div class="stat-value" style=${n?`color:${n}`:""}>${e}</div>
      ${a?o`<div class="monitor-stat-caption">${a}</div>`:null}
  ...
  `}const Wa=_("all"),Ga=_("all"),xi=gt(()=>{let t=En.value;return Wa.value!=="all"&&(t=t.filter(e=>e.horizon===Wa.value)),Ga.value!=="all"&&(t=t.filter(e=>e.status===Ga.value)),t}),sm=gt(()=>{const t={short:[],mid:[],long:[]};for(const e of xi.value){const n=t[e.horizon];n&&n.push(e)}return t}),im=gt(()=>{const t=Array.from(qr.value.values());return t.sort((e,n)=>e.status==="running"&&n.status!=="running"?-1:n.status==="running"&&e.status!=="running"?1:n.elapsed_seconds-e.elapsed_seconds),t});function om(t){return"★".repeat(Math.min(t,5))+"☆".repeat(Math.max(0,5-t))}function Ki(t){switch(t){case"short":return"Short-term";case"mid":return"Mid-term";case"long":return"Long-term";default:return t}}function ha(t){switch(t){case"short":return"#4ade80";case"mid":return"#f59e0b";case"long":return"#818cf8";default:return"#888"}}function rm(t){return t<60?`${Math.round(t)}s`:t<3600?`${Math.floor(t/60)}m ${Math.round(t%60)}s`:`${Math.floor(t/3600)}h ${Math.floor(t%3600/60)}m`}function jo(t){return t.toFixed(4)}function qo(t){const e=t.current_metric-t.baseline_metric;return`${e>=0?"+":""}${e.toFixed(4)}`}function lm({goal:t}){return o`
    <div class="goal-row">
  ...
  `}function pm(){xt(()=>{mn(),qe()},[]);const t=sm.value,e=im.value,n=e.filter(r=>r.status==="running").length,a=En.value.filter(r=>r.status==="active").length,s=ii.value,i=s==="idle"?"No loop running":s==="error"?oi.value??"MDAL snapshot unavailable":"Current loop snapshot";return o`
    <div>
      <div class="stats-grid">
        <div class="stat-card">
      ...
      <${w} title="Planning Surface" class="section">
        <div class="planning-header">
          ...
          <div class="planning-actions">
            <button class="control-btn ghost" onClick=${mn} disabled=${Oe.value}>
      ...
      ${Oe.value&&En.value.length===0?o`<div class="loading-indicator">Loading goals...</div>`:xi.value.length===0?o`<div class="empty-state">No goals match the current filters</div>`:o`
...
`))}function Tm({hp:t,max:e}){const n=fm(t,e),a=mm(t,e);return o`
  ...
  `}function Lm({state:t,nowMs:e}){var p;const n=Kt.value||((p=t.session)==null?void 0:p.room)||"",a=sa.value,s=t.party??[];if(!s.find(f=>f.id===Ee.value)&&s.length>0){const f=s[0];f&&(Ee.value=f.id)}const r=async()=>{var l,c;if(!n){S("Room ID가 비어 있습니다.","error");return}if(!$a(e))return;const f=((l=t.current_round)==null?void 0:l.phase)??((c=t.session)==null?void 0:c.status)??"unknown";if(wi("라운드 실행",n,f)){sa.value="running";try{const m=await Bc(n);Si.value=m,sa.value="ok";const $=ie(m.summary)?m.summary:null,y=$?Hn($,"advanced",!1):!1,k=$?vt($,"progress_reason",""):"";S(y?"라운드가 정상 진행되었습니다.":`라운드가 정체되었습니다${k?`: ${k}`:""}`,y?"success":"warning"),Ut()}catch(m){Si.value=null,sa.value="error";const $=m instanceof Error?m.message:"라운드 실행에 실패했습니다.";S($,"error")}finally{Ja()}}},u=async()=>{var l,c;if(!n||!$a(e))return;const f=((l=t.current_round)==null?void 0:l.phase)??((c=t.session)==null?void 0:c.status)??"unknown";if(wi("턴 강제 진행",n,f))try{await Jc(n),S("턴을 다음 단계로 이동했습니다.","success"),Ut()}catch{S("턴 이동에 실패했습니다.","error")}finally{Ja()}},d=async()=>{if(!n||!$a(e))return;const f=Ee.value.trim();if(!f){S("먼저 Actor를 선택하세요.","warning");return}const l=Number.parseInt(ws.value,10),c=Number.parseInt(Ts.value,10);if(Number.isNaN(l)||Number.isNaN(c)){S("stat/dc는 숫자여야 합니다.","warning");return}const m=Number.parseInt(aa.value,10),$=aa.value.trim()===""||Number.isNaN(m)?void 0:m;try{await Gc({roomId:n,actorId:f,action:As.value.trim()||"ability_check",statValue:l,dc:c,rawD20:$}),S("주사위 판정을 기록했습니다.","success"),Ut()}catch{S("주사위 판정 기록에 실패했습니다.","error")}};return o`
  ...
  `}function Em({state:t}){var s;const e=Kt.value||((s=t.session)==null?void 0:s.room)||"",n=ra.value,a=async()=>{if(!e){S("Room ID가 비어 있습니다.","warning");return}const i=oa.value.trim(),r=Ds.value.trim();if(!r&&!i){S("이름 또는 Actor ID를 입력하세요.","warning");return}const u=Number.parseInt(An.value.trim(),10),d=Number.parseInt(Os.value.trim(),10),p=Number.isFinite(d)?Math.max(1,d):20,f=Number.isFinite(u)?Math.max(0,Math.min(p,u)):p;let l={};try{l=bm(Ms.value)}catch(c){S(c instanceof Error?c.message:"능력치 JSON 오류","error");return}ra.value="spawning";try{const c=typeof crypto<"u"&&typeof crypto.randomUUID=="function"?`trpg_spawn_${crypto.randomUUID()}`:`trpg_spawn_${Date.now().toString(36)}_${Math.random().toString(36).slice(2,10)}`,m=await Vc(e,{actor_id:i||void 0,name:r||void 0,role:Ps.value,idempotencyKey:c,portrait:Es.value.trim()||void 0,background:Is.value.trim()||void 0,hp:f,max_hp:p,alive:f>0,stats:Object.keys(l).length>0?l:void 0}),$=typeof m.actor_id=="string"?m.actor_id.trim():"";if(!$)throw new Error("생성 응답에 actor_id가 없습니다.");const y=Ls.value.trim();y&&await Qc(e,$,y),Ee.value=$,ne.value=$,i||(oa.value=""),ra.value="ok",S(`Actor 생성 완료: ${$}`,"success"),await Ut()}catch(c){ra.value="error",S(c instanceof Error?c.message:"Actor 생성에 실패했습니다.","error")}};return o`
    <div class="trpg-control-box">
      <div class="trpg-control-grid">
        <div class="trpg-control-field">
          <label>Name</label>
  ...
  `}function Im({state:t,nowMs:e}){var c;const n=Kt.value||((c=t.session)==null?void 0:c.room)||"",a=t.join_gate,s=Rs.value,i=ie(s)?s:null,r=(t.party??[]).filter(m=>m.role!=="dm"),u=ne.value.trim(),d=r.some(m=>m.id===u),p=d?u:u?"__manual__":"",f=async()=>{const m=ne.value.trim(),$=ia.value.trim();if(!n||!m){S("Room/Actor가 필요합니다.","warning");return}bt.value="checking";try{const y=await Yc(n,m,$||void 0);Rs.value=y,bt.value="ok",S("참가 가능 여부를 갱신했습니다.","success")}catch(y){bt.value="error";const k=y instanceof Error?y.message:"참가 가능 여부 확인에 실패했습니다.";S(k,"error")}},l=async()=>{var R,T;const m=ne.value.trim(),$=ia.value.trim(),y=Ns.value.trim();if(!n||!m||!$){S("Room/Actor/Keeper가 필요합니다.","warning");return}if(!$a(e))return;const k=((R=t.current_round)==null?void 0:R.phase)??((T=t.session)==null?void 0:T.status)??"unknown";if(wi("Mid-Join 승인 요청",n,k)){bt.value="requesting";try{const M=await Xc({room_id:n,actor_id:m,keeper_name:$,role:Cs.value,...y?{name:y}:{}});Rs.value=M;const C=ie(M)?Hn(M,"granted",!1):!1,D=ie(M)?vt(M,"reason_code",""):"";C?S("Mid-Join이 승인되었습니다.","success"):S(`Mid-Join이 거절되었습니다${D?`: ${D}`:""}`,"warning"),bt.value=C?"ok":"error",Ut()}catch(M){bt.value="error";const C=M instanceof Error?M.message:"Mid-Join 요청에 실패했습니다.";S(C,"error")}finally{Ja()}}};return o`
    <div class="trpg-control-box">
  ...
  `:null}function kl(){const t=Si.value;if(!t)return o`<div class="empty-state" style="font-size:13px;">Run Round 결과가 아직 없습니다.</div>`;const e=t.summary,n=ie(e)?e:null,s=(Array.isArray(t.statuses)?t.statuses:[]).filter(ie).slice(-8),i=t.canon_check,r=ie(i)?i:null,u=r&&Array.isArray(r.warnings)?r.warnings.filter(D=>typeof D=="string").slice(0,3):[],d=r&&Array.isArray(r.violations)?r.violations.filter(D=>typeof D=="string").slice(0,3):[],p=n?Hn(n,"advanced",!1):!1,f=n?vt(n,"progress_reason",""):"",l=n?vt(n,"progress_detail",""):"",c=n?Ot(n,"player_successes",0):0,m=n?Ot(n,"player_required_successes",0):0,$=n?Hn(n,"dm_success",!1):!1,y=n?Ot(n,"timeouts",0):0,k=n?Ot(n,"unavailable",0):0,R=n?Ot(n,"reprompts",0):0,T=n?Ot(n,"npc_attacks",0):0,M=n?Ot(n,"keeper_timeout_sec",0):0,C=n?Ot(n,"roll_audit_count",0):0;return o`
    ...
    <${w} title="조작 안전 잠금" style="margin-bottom:16px;">
      <div class="trpg-control-lock ${s?"locked":"unlocked"}">
        ...
        <div style="display:flex; gap:8px; margin-top:10px; flex-wrap:wrap;">
          ${s?o`<button class="trpg-run-btn recommend" onClick=${()=>wm(n,a)}>잠금 해제 (120초)</button>`:o`<button class="trpg-run-btn secondary" onClick=${()=>{Ja(),S("조작 잠금으로 전환했습니다.","success")}}>즉시 다시 잠금</button>`}
        </div>
      </div>
    <//>
  ...
  `}const Ui="masc_dashboard_agent_name";function Hm(){const t=new URLSearchParams(window.location.search),e=t.get("agent")??t.get("agent_name"),n=localStorage.getItem(Ui);return e??n??"dashboard"}const ft=_(Hm()),wn=_(""),Tn=_(""),Va=_(""),xl=_(null),Qa=_(null),Cn=_(!1),ze=_(!1),Nn=_(!1),Rn=_(!1),Ya=_(!1),Xa=_(!1),rs=_(!1);function Za(t){return typeof t!="number"||!Number.isFinite(t)?"??:00":`${String(Math.max(0,t)).padStart(2,"0")}:00`}function ya(t){if(typeof t!="number"||!Number.isFinite(t)||t<=0)return"unknown";if(t<60)return`${Math.round(t)}s`;if(t<3600)return`${Math.round(t/60)}m`;const e=Math.floor(t/3600),n=Math.round(t%3600/60);return n>0?`${e}h ${n}m`:`${e}h`}function Sl(t){return!t||t.length===0?"none":t.join(", ")}function Km(t){return t?t.enabled?t.quiet_active?`Quiet hours ${Za(t.quiet_start)}-${Za(t.quiet_end)} KST are active. Scheduled ticks may look asleep until the window ends; Poke Now bypasses only that quiet-hours gate.`:t.last_tick_ago_s==null?`Lodge is enabled and scheduled every ${ya(t.interval_s)}, but no tick has run yet in this runtime.`:t.last_skip_reason?`Lodge last skipped work because ${t.last_skip_reason}. Scheduled ticks still run every ${ya(t.interval_s)}.`:`Lodge ticks every ${ya(t.interval_s)}. Planner is ${t.use_planner?"on":"off"} and delegated LLM is ${t.delegate_llm?"on":"off"}.`:"Lodge automation is disabled. Manual poke will report the disabled state but will not revive a stopped runtime.":"Lodge runtime status is unavailable. Refresh the dashboard to inspect scheduling state."}async function nn(){Je();try{await xe()}catch(t){console.warn("[control-dock] dashboard refresh failed",t)}}function Bi(t){const e=t.trim();ft.value=e,e&&localStorage.setItem(Ui,e)}function Um(t){const n=(t.split(`
`).find(a=>a.includes(" joined"))??t).match(/✅\s+(\S+)\s+joined/i);return(n==null?void 0:n[1])??null}async function Ti(){const t=ft.value.trim();if(t){Nn.value=!0;try{const e=await tu(t),n=Um(e);n&&Bi(n),rs.value=!0,await nn(),S(`Joined as ${n??t}`,"success")}catch(e){const n=e instanceof Error?e.message:"Failed to join room";S(n,"error")}finally{Nn.value=!1}}}async function Bm(){const t=ft.value.trim();if(t){Rn.value=!0;try{await Ir(t),rs.value=!1,await nn(),S(`Left room (${t})`,"success")}catch(e){const n=e instanceof Error?e.message:"Failed to leave room";S(n,"error")}finally{Rn.value=!1}}}async function Wm(){const t=ft.value.trim();if(t)try{await Ir(t)}catch{}localStorage.removeItem(Ui),Bi("dashboard"),rs.value=!1,await Ti()}async function Gm(){const t=ft.value.trim();if(t){Ya.value=!0;try{await eu(t),await nn(),S("Heartbeat sent","success")}catch(e){const n=e instanceof Error?e.message:"Failed to send heartbeat";S(n,"error")}finally{Ya.value=!1}}}async function Ko(){const t=ft.value.trim(),e=wn.value.trim();if(!(!t||!e)){Cn.value=!0;try{await Er(t,e),wn.value="",await nn(),S("Broadcast sent","success")}catch(n){const a=n instanceof Error?n.message:"Failed to send broadcast";S(a,"error")}finally{Cn.value=!1}}}async function Jm(){const t=Tn.value.trim(),e=Va.value.trim()||"Created from dashboard";if(t){ze.value=!0;try{await Zc(t,e,1),Tn.value="",Va.value="",await nn(),S("Task created","success")}catch(n){const a=n instanceof Error?n.message:"Failed to create task";S(a,"error")}finally{ze.value=!1}}}async function Uo(){const t=ft.value.trim()||"dashboard";Xa.value=!0,Qa.value=null;try{const e=await Gn({actor:t,action_type:"lodge_tick",target_type:"room",payload:{}}),n=Mi(e.result);xl.value=n,await nn(),n!=null&&n.skipped_reason?S(n.skipped_reason,"warning"):S(n?`Poke finished: ${n.acted}/${n.checked} acted`:"Poke finished",n&&n.acted>0?"success":"warning")}catch(e){const n=e instanceof Error?e.message:"Failed to run Lodge poke";Qa.value=n,S(n,"error")}finally{Xa.value=!1}}function Vm({runtime:t}){var s,i;const e=xl.value??(t==null?void 0:t.last_tick_result)??null;if(Qa.value)return o`<div class="control-result-box is-error">${Qa.value}</div>`;if(!e)return o`<div class="control-status-copy">No poke result yet. The latest scheduled tick will appear here after the first run.</div>`;const n=((s=e.skipped_rows)==null?void 0:s.slice(0,3))??[],a=((i=e.passed_rows)==null?void 0:i.slice(0,3))??[];return o`
    <div class="control-result-box">
      <div class="control-inline-meta">
  ...
  `}function Qm(t){return t.find(n=>n.name===pn.value)??t[0]??null}function Ym(){var a,s;const t=Nt.value,e=((a=ke.value)==null?void 0:a.lodge)??null,n=Qm(t);return xt(()=>{Ti()},[]),xt(()=>{var r;const i=((r=t[0])==null?void 0:r.name)??"";if(!pn.value&&i){da(i);return}pn.value&&!t.some(u=>u.name===pn.value)&&da(i)},[t.map(i=>i.name).join("|")]),o`
    <section class="rail-card control-dock">
      ...
      <div class="control-section">
        ...
        <button
          class="control-btn secondary"
          onClick=${()=>{Jm()}}
          disabled=${ze.value||Tn.value.trim()===""}
        >
      ...
      <section class="rail-card">
        ...
        <div class="rail-inline-actions">
          <button
            ...
            onClick=${()=>{xe(),t==="command"&&jn(),t==="ops"&&Qe(),t==="board"&&jt(),t==="council"&&Ye(),t==="trpg"&&Ut(),t==="goals"&&(mn(),qe())}}
          >
            Refresh Now
          </button>
