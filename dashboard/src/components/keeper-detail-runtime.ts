...
function ToolChip({ name }: { name: string }) {
  ...
  return html`
    <button type="button"
      class="inline-flex items-center gap-1 py-0.5 px-2 rounded-sm text-2xs font-medium bg-[var(--accent-12)] text-[var(--accent)] border border-[var(--accent-30)] hover:bg-[var(--accent-20)] cursor-pointer transition-colors"
  ...
  return html`
    <div class="flex flex-col gap-2" id="tool-preview-list">
      ...
      ${tools.length > previewLimit
        ? html`
            <button type="button"
              class="self-start text-2xs text-[var(--text-muted)] hover:text-[var(--text-body)] cursor-pointer transition-colors"
  ...
  return html`
    <div class="flex flex-col gap-1.5">
      ...
      <div class="flex items-center justify-between mt-3">
        ...
        <button type="button"
          class="text-2xs text-[var(--text-muted)] hover:text-[var(--text-body)] cursor-pointer transition-colors disabled:opacity-50 disabled:cursor-default"
