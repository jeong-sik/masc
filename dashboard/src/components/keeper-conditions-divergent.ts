...
export function KeeperConditionsDivergent({ keeper }: { keeper: Keeper }) {
  ...
  return html`
    <section class="rounded-[var(--r-1)] border border-[var(--warn-24)] bg-[var(--warn-soft)] p-3 mb-3 v2-monitoring-panel" aria-label="조건-Phase 불일치 경고">
      ...
      <div class="mt-2 text-3xs text-[var(--color-fg-disabled)] leading-snug v2-monitoring-detail">
