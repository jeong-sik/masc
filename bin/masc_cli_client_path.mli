(** [masc runtime-client-path]: where an official client runs from, as the
    runtime will spawn it ({!Masc.Runtime_official_cli_install.locate}). The
...
val client_arg : Masc.Runtime_official_cli_install.client Cmdliner.Arg.conv
(** [claude-code], [codex] or [antigravity]: the dependency names
    [prerequisite-actions] takes. *)

val to_json
  :  client:Masc.Runtime_official_cli_install.client
  -> command:string
  -> path:string option
  -> Yojson.Safe.t
...
val run : client:Masc.Runtime_official_cli_install.client -> command:string option -> int
