...
(* 2026-09-25: the Stagehand tool changes on the merged parent project to
   ...
   renderer's rules replayed on config/tools/masc_browser_instruct.toml. The
   combined ceiling is projected until exact-head CI measures it. No headroom. *)
let ceiling_bytes = 123_133
