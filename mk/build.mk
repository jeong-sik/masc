...
bonsai-dashboard:
	...
	# 서버는 /dashboard/b/assets/colors_and_type.generated.css로 이 파일을 서빙하고,
	# bonsai_index_html은 이 경로를 <link>로 참조한다. 토큰은
	# dashboard/design-system/tokens/source.ts SSOT에서 `pnpm tokens:build`로
	# 생성되며, 수기 편집은 금지(generated 파일).
