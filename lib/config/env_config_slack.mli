...
(** [MASC_SLACK_APP_TOKEN] — app-level token ([xapp-...]) for Socket Mode
    [apps.connections.open]. Absent ⇒ the gateway does not start. *)

val bot_token_opt : unit -> string option
(** [MASC_SLACK_BOT_TOKEN] — bot token ([xoxb-...]) for REST outbound and
