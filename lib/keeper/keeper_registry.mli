...
(** Failure-reason cluster lives in Keeper_registry_types (intra-library
    file split, 2026-05-16). Re-exported here so the 126 callers keep
    using [Keeper_registry.failure_reason] etc. unchanged. *)
