...
let test_room_bootstrap_ignores_invalid_workspace_id_in_flat_mode () =
  with_memory_test_env (fun config ->
    Coord.ensure_coord_bootstrap config;
...
let () =
  ...
  Alcotest.run "Coord" [
    ...
    "heartbeat", [
      ...
      Alcotest.test_case "backend bootstrap preserves workspace state" `Quick test_room_bootstrap_preserves_backend_state;
      Alcotest.test_case "bootstrap ignores invalid workspace id in flat mode" `Quick test_room_bootstrap_ignores_invalid_workspace_id_in_flat_mode;
