...
OAS pin metadata is generated from `scripts/oas-agent-sdk-pin.sh`. Current dependency floor: `agent_sdk >= 0.205.14`, runtime pin: `fix/qwen36-preserve-thinking-20260611@1cd315c104bac1c8eedd56d899e896b004b30534`, declared base version: `v0.205.14`. 최신성 검증이 필요할 때는 문서에 적힌 숫자보다 `dune-project`와 pin script를 우선 truth source로 본다.
