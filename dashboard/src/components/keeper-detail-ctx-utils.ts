...
export const CTX_SEGMENT_LABELS: Record<string, string> = {
  ...
  memory_os_recall: 'Memory OS recall',
  temporal_summary: '시간 요약',
  current_user: '현재 입력',
  tool_schemas: '도구 스키마',
  extra_system_context_existing_or_joiners: '기존 시스템 컨텍스트·구분자',
  history_system: '히스토리 · system',
  memory_context: '메모리',
  temporal_context: '시간',
  user_message: '현재 입력',
  history_user: '히스토리 · user',
  history_assistant_text: '히스토리 · assistant',
  history_thinking: '히스토리 · thinking',
  history_redacted_thinking: '히스토리 · redacted thinking',
  history_image: '히스토리 · image',
  history_document: '히스토리 · document',
  history_audio: '히스토리 · audio',
...
export const CTX_SEGMENT_COLORS: Record<string, string> = {
  ...
  memory_os_recall: 'var(--rose-light)',
  temporal_summary: 'var(--cyan)',
  current_user: 'var(--sky-400)',
  tool_schemas: 'var(--orange-400)',
  extra_system_context_existing_or_joiners: 'var(--color-fg-muted)',
  history_system: 'var(--amber-bright)',
  ...
  history_thinking: 'var(--violet-400)',
  history_redacted_thinking: 'var(--violet-700)',
  history_image: 'var(--pink-400)',
  history_document: 'var(--teal-400)',
  history_audio: 'var(--lime-400)',
