    ...
    return html`
      <div class="flex items-center gap-1 flex-wrap">
        <input
          type="text"
          autoComplete="off"
          aria-label="반려 사유" required aria-required="true"
                  ...
                  ${hasContract
                    ? html`
                        <div>
                          ...
                          <ul class="list-disc list-inside flex flex-col gap-1 text-[var(--text-body)]" aria-label="완료 조건">
                  ...
                  ${hasEvidence
                    ? html`
                        <div>
                          ...
                          <ul class="list-disc list-inside flex flex-col gap-1 text-[var(--text-body)]" aria-label="필요 증거">
      ...
      <table class="w-full text-xs" aria-label="검증 요청 목록">
        <thead>
          <tr class="text-[var(--text-muted)] border-b border-[var(--card-border)]">
            ...
            <th scope="col" class="text-left py-1 pr-2">태스크</th>
