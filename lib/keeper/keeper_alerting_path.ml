(** Keeper_alerting_path — path normalization, resolution, and sandbox
    helpers.  Typed path-rejection variant and error message/telemetry
    helpers are in [Keeper_alerting_path_rejection]. *)

include Keeper_alerting_path_rejection
