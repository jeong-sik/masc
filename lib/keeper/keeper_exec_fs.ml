(** Keeper_exec_fs — patch/edit logic, write validation, and
    [handle_keeper_fs_edit].  Fs write mode types, constants,
    and [handle_keeper_fs_read] are in [Keeper_exec_fs_read]. *)
