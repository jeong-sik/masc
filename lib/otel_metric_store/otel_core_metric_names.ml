...
let metric_mcp_requests = "masc_requests_total"
...
let metric_llm_provider_cache_read_tokens = "masc_llm_provider_cache_read_tokens_total"
let metric_llm_provider_reasoning_tokens = "masc_llm_provider_reasoning_tokens_total"
