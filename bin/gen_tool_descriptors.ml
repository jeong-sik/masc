...
let masc_spawn_spec : tool_spec =
  ...
  ; parameters =
      [ { p_name = "agent_name"
        ; p_type = T_string { enum = None; default = None }
        ; p_description =
            "Configured spawn agent name, alias, or custom command"
        ; p_required = true
        }
      ; { p_name = "model"
        ; p_type = T_string { enum = None; default = None }
        ; p_description = "Explicit model id when the selected runtime requires one."
        ; p_required = false
        }
      ; { p_name = "prompt"
        ; p_type = T_string { enum = None; default = None }
...
let masc_join_spec : tool_spec =
  ...
  ; parameters =
      [ { p_name = "agent_name"
        ; p_type = T_string { enum = None; default = None }
        ; p_description = "Your MASC agent identity"
        ; p_required = true
        }
      ; { p_name = "capabilities"
