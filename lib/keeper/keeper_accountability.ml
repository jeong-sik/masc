...
let enable_window_read_count_for_testing () = window_read_count_for_testing_ref := Some 0
let disable_window_read_count_for_testing () = window_read_count_for_testing_ref := None
