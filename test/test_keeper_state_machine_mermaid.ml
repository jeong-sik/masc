...
let mermaid_lines phase = Masc.Keeper_state_machine_mermaid.phase_to_mermaid ~current:phase |> String.split_on_char '\n'
...
let test_mermaid_all_phases_appear () =
  List.iter
    (fun phase ->
       let diagram = Masc.Keeper_state_machine_mermaid.phase_to_mermaid ~current:phase in
       let id = Masc.Keeper_state_machine_mermaid.phase_to_mermaid_id phase in
       check
         bool
