...
`).map(n=>n.trim()).filter(n=>n!=="")}async function Sm(t,e=20){return ht("masc_task_history",{task_id:t,limit:e})}async function Cm(t){const e=await ht("masc_petition_submit",{title:t,origin:"human",subject_type:"task",risk_class:"low",requested_action:{action_type:"add_task",payload:{title:t}}});try{const n=JSON.parse(e),s=m(n.case)?n.case:null,a=m(n.petition)?n.petition:null,o=m(n.ruling)?n.ruling:null;return!s||!a?null:Wo({case:s,petitions:[a],ruling:o,execution_order:null})}catch{return null}}async function Am(t,e,n){const s=await ht("masc_case_brief_submit",{case_id:t,stance:e,summary:n});try{const a=JSON.parse(s),o=Wo(a);if(o)return o}catch{}return Tc(t)}async function Tc(t){const e=await ht("masc_case_status",{case_id:t});try{return Wo(JSON.parse(e))}catch{return null}}async function Tm(t,e){const n=await ht("masc_execution_orders",{case_id:t,decision:e});try{return Cc(JSON.parse(n))}catch{return null}}const Im=g(""),ne=g({}),gt=g({}),ro=g({}),$a=g({}),lo=g({}),co=g({}),Bt=g({}),Go=new Map,Jo=new Map;function lt(t,e,n){t.value={...t.value,[e]:n}}function Rm(t){var n;const e=(n=r(t))==null?void 0:n.toLowerCase();return e==="user"||e==="assistant"||e==="system"||e==="tool"?e:"other"}function Mm(t){switch(t){case"user":return"User";case"assistant":return"Keeper";case"system":return"System";case"tool":return"Tool";default:return"Event"}}function gi(t,e){if(!Array.isArray(t))return[];const n=[];for(const s of t){if(!m(s))continue;const a=r(s.name);if(!a)continue;const o=r(s[e]);e==="summary"?n.push({name:a,summary:o}):n.push({name:a,reason:o})}return n}function Lm(t){if(!m(t))return null;const e=r(t.name);return e?{name:e,trigger:r(t.trigger),outcome:r(t.outcome),summary:r(t.summary),reason:r(t.reason)}:null}function zm(t,e){return t==="offline"||t==="degraded"||t==="stale"?"Keeper is not in a healthy reply state. Probe or recover before relying on automation.":e==="quiet_hours"?"Social quiet hours are active. Direct messages still work, but scheduled public-square reactions may look asleep.":e==="min_gap"?"Keeper is inside its proactive cooldown window. Direct messages work now; autonomous check-ins will wait.":e==="never_started"?"Keeper metadata exists but no reply turn has been recorded yet.":"Keeper is reachable. Send a direct message for an immediate response."}function Em(t,e,n){return r(t)??zm(e,n)}function Pm(t,e){return typeof t=="boolean"?t:e==="recover"}function ha(t){if(!m(t))return null;const e=r(t.health_state),n=r(t.next_action_path),s=r(t.last_reply_status);return!e||!n||!s?null:{health_state:e,quiet_reason:r(t.quiet_reason)??null,next_action_path:n,last_reply_status:s,last_reply_at:ot(t.last_reply_at)??null,last_reply_preview:r(t.last_reply_preview)??null,last_error:r(t.last_error)??null,next_eligible_at_s:u(t.next_eligible_at_s)??null,recoverable:Pm(t.recoverable,n),summary:Em(t.summary,e,r(t.quiet_reason)??null),keepalive_running:typeof t.keepalive_running=="boolean"?t.keepalive_running:void 0,continuity_state:r(t.continuity_state)??null,continuity_summary:r(t.continuity_summary)??null}}function Ic(t){if(!m(t))return null;const e=r(t.last_system_skip_reason)??r(t.skipped_reason);return{hour:u(t.hour),checked:u(t.checked)??0,acted:u(t.acted)??0,acted_names:B(t.acted_names),activity_report:r(t.activity_report),quiet_hours_overridden:j(t.quiet_hours_overridden),skipped_reason:e,last_pass_reason:r(t.last_pass_reason)??null,last_system_skip_reason:e,acted_rows:gi(t.acted_rows,"summary").map(n=>({name:n.name,summary:n.summary})),passed_rows:gi(t.passed_rows,"reason").map(n=>({name:n.name,reason:n.reason})),skipped_rows:gi(t.skipped_rows,"reason").map(n=>({name:n.name,reason:n.reason})),checkins:Array.isArray(t.checkins)?t.checkins.map(Lm).filter(n=>n!==null):[]}}function Nm(t){if(!m(t))return null;const e=r(t.last_system_skip_reason)??r(t.last_skip_reason)??null;return{enabled:j(t.enabled)??!1,interval_s:u(t.interval_s)??0,quiet_start:u(t.quiet_start),quiet_end:u(t.quiet_end),quiet_active:j(t.quiet_active),use_planner:j(t.use_planner),delegate_llm:j(t.delegate_llm),agent_count:u(t.agent_count),agents:B(t.agents),last_tick_ago_s:u(t.last_tick_ago_s)??null,last_tick_ago:r(t.last_tick_ago),total_ticks:u(t.total_ticks),total_checkins:u(t.total_checkins),last_skip_reason:e,last_pass_reason:r(t.last_pass_reason)??null,last_system_skip_reason:e,last_tick_result:Ic(t.last_tick_result),active_self_heartbeats:B(t.active_self_heartbeats)}}function jm(t){return m(t)?{status:t.status,diagnostic:ha(t.diagnostic)}:null}function wm(t){return m(t)?{recovered:j(t.recovered)??!1,skipped_reason:r(t.skipped_reason)??null,before:ha(t.before),after:ha(t.after),down:t.down,up:t.up}:null}function Om(t,e){if(!m(t))return null;const n=Rm(t.role),s=r(t.content)??r(t.preview);if(!s)return null;const a=fc(s);if(!a)return null;const o=ot(t.ts_unix)??ot(t.timestamp);return{id:`${n}-${o??"entry"}-${e}`,role:n,label:Mm(n),text:a,timestamp:o,delivery:"history",streamState:null,details:null}}function Dm(t,e,n){const s=m(n)?n:null,a=Array.isArray(s==null?void 0:s.history_tail)?s.history_tail.map((o,l)=>Om(o,l)).filter(o=>o!==null):[];return{name:t,diagnostic:ha(s==null?void 0:s.diagnostic),history:a,rawText:e,rawStatus:n,loadedAt:new Date().toISOString()}}function vl(t,e){const n=gt.value[t]??[];gt.value={...gt.value,[t]:[...n,e].slice(-50)}}function Vo(t,e,n){const s=gt.value[t]??[];gt.value={...gt.value,[t]:s.map(a=>a.id===e?n(a):a)}}function $i(t,e,n,s){Vo(t,e,a=>({...a,streamState:n,delivery:s}))}function qm(t,e,n){Vo(t,e,s=>({...s,text:`${s.text}${n}`,streamState:"streaming",delivery:"streaming"}))}function Vt(t,e,n){Vo(t,e,s=>({...s,...n}))}function Fm(t,e){return t.role!==e.role||t.text!==e.text?!1:t.timestamp&&e.timestamp?t.timestamp===e.timestamp:!0}function Km(t,e){const s=(gt.value[t]??[]).filter(a=>a.delivery!=="history"&&!e.some(o=>Fm(a,o)));gt.value={...gt.value,[t]:[...e,...s].slice(-50)}}function ni(t,e){ne.value={...ne.value,[t]:e},Km(t,e.history)}function Ns(t,e){const n=ne.value[t];if(!n)return;const s=n.diagnostic??{health_state:"idle",next_action_path:"direct_message",last_reply_status:"unknown"};ni(t,{...n,diagnostic:{...s,...e}})}function Bm(t,e,n){Jo.set(t,e),Go.set(t,n)}function Rc(t){Jo.delete(t),Go.delete(t)}function Um(t){return Jo.get(t)??null}function Mc(t){const e=t.trim();if(!e)return;const n=Go.get(e),s=Um(e);n&&n.abort(),s&&Vt(e,s,{delivery:"timeout",streamState:null,error:"Stream cancelled",timestamp:new Date().toISOString()}),Rc(e),lt($a,e,!1)}function Hm(t,e,n){switch(n.type){case"RUN_STARTED":return $i(t,e,"opening","sending"),null;case"TEXT_MESSAGE_START":return $i(t,e,"streaming","streaming"),null;case"TEXT_MESSAGE_CONTENT":{const s=typeof n.delta=="string"?n.delta:"";return s&&qm(t,e,s),null}case"TEXT_MESSAGE_END":return $i(t,e,"finalizing","streaming"),null;case"CUSTOM":if(n.name==="KEEPER_REPLY_DETAILS"){const s=gc(n.value);s&&Vt(t,e,{details:s})}return null;case"RUN_ERROR":return typeof n.value=="string"?n.value:(m(n.value)?r(n.value.message):null)??"Keeper stream failed";default:return null}}async function ya(){try{await ks()}catch(t){console.warn("[keeper-runtime] dashboard refresh failed",t)}}function Wm(t){Im.value=t.trim()}async function Lc(t,e=!1){const n=t.trim();if(!n)return null;if(!e&&ne.value[n])return ne.value[n];lt(ro,n,!0),lt(Bt,n,null);try{const s=await ht("masc_keeper_status",{name:n,fast:!1,include_context:!0,include_metrics_overview:!0,include_memory_bank:!1,include_history_tail:!0,include_compaction_history:!1,tail_turns:5,tail_messages:10});let a=null;try{a=JSON.parse(s)}catch{a=null}const o=Dm(n,s,a);return ni(n,o),o}catch(s){const a=s instanceof Error?s.message:`Failed to inspect ${n}`;return lt(Bt,n,a),null}finally{lt(ro,n,!1)}}async function Gm(t,e){var c;const n=t.trim(),s=e.trim();if(!n||!s)return;Mc(n);const a=`local-${Date.now()}`,o=`reply-${Date.now()}`;vl(n,{id:a,role:"user",label:"You",text:s,timestamp:new Date().toISOString(),delivery:"sending",streamState:null,details:null}),vl(n,{id:o,role:"assistant",label:n,text:"",timestamp:null,delivery:"sending",streamState:"opening",details:null}),lt($a,n,!0),lt(Bt,n,null);const l=new AbortController;Bm(n,o,l);try{Vt(n,a,{delivery:"delivered"}),await gp(n,s,void 0,{signal:l.signal,onEvent:_=>{const v=Hm(n,o,_);if(v)throw new Error(v)}});const d=(gt.value[n]??[]).find(_=>_.id===o)??null,p=(d==null?void 0:d.text.trim())||"(empty reply)";Vt(n,o,{text:p,delivery:"delivered",streamState:null,timestamp:new Date().toISOString(),error:null}),Ns(n,{last_reply_status:"delivered",last_reply_at:new Date().toISOString(),last_reply_preview:p.slice(0,200),last_error:null})}catch(d){if(d instanceof Error&&d.name==="AbortError")throw Vt(n,o,{delivery:"timeout",streamState:null,error:"Stream cancelled",timestamp:new Date().toISOString()}),Ns(n,{last_reply_status:"error",last_error:"Stream cancelled"}),lt(Bt,n,"Stream cancelled"),d;if(!((c=(gt.value[n]??[]).find(f=>f.id===o))!=null&&c.text.trim()))try{const f=await vp(n,s);Vt(n,o,{text:f.text.trim()||"(empty reply)",delivery:"delivered",streamState:null,details:f.details,error:null,timestamp:new Date().toISOString()}),Vt(n,a,{delivery:"delivered",error:null}),Ns(n,{last_reply_status:"delivered",last_reply_at:new Date().toISOString(),last_reply_preview:(f.text.trim()||"(empty reply)").slice(0,200),last_error:null}),await ya();return}catch{}const v=d instanceof Error?d.message:`Failed to send direct message to ${n}`;throw Vt(n,o,{delivery:"error",streamState:null,error:v,timestamp:new Date().toISOString()}),Vt(n,a,{delivery:"error",error:v}),Ns(n,{last_reply_status:"error",last_error:v}),lt(Bt,n,v),d}finally{Rc(n),lt($a,n,!1),await ya()}}async function Jm(t,e){const n=t.trim();if(!n)return null;lt(lo,n,!0),lt(Bt,n,null);try{const s=await bs({actor:e,action_type:"keeper_probe",target_type:"keeper",target_id:n,payload:{}}),a=jm(s.result),o=(a==null?void 0:a.diagnostic)??null;if(o){const l=ne.value[n];ni(n,{name:n,diagnostic:o,history:(l==null?void 0:l.history)??gt.value[n]??[],rawText:(l==null?void 0:l.rawText)??"",rawStatus:s.result,loadedAt:new Date().toISOString()})}return await ya(),o}catch(s){const a=s instanceof Error?s.message:`Failed to probe ${n}`;throw lt(Bt,n,a),s}finally{lt(lo,n,!1)}}async function Vm(t,e){const n=t.trim();if(!n)return null;lt(co,n,!0),lt(Bt,n,null);try{const s=await bs({actor:e,action_type:"keeper_recover",target_type:"keeper",target_id:n,payload:{}}),a=wm(s.result),o=(a==null?void 0:a.after)??null;if(o){const l=ne.value[n];ni(n,{name:n,diagnostic:o,history:(l==null?void 0:l.history)??gt.value[n]??[],rawText:(l==null?void 0:l.rawText)??"",rawStatus:s.result,loadedAt:new Date().toISOString()})}return await ya(),o}catch(s){const a=s instanceof Error?s.message:`Failed to recover ${n}`;throw lt(Bt,n,a),s}finally{lt(co,n,!1)}}function Ym(t){const e=typeof t=="string"?t.toLowerCase():"";return e==="active"||e==="busy"||e==="listening"||e==="idle"||e==="inactive"||e==="offline"?e:e==="in_progress"||e==="claimed"?"busy":"offline"}function Xm(t){var o;const e=((o=t.status)==null?void 0:o.toLowerCase())??"";if(e==="offline"||e==="inactive")return"offline";const n=t.metrics_series;if(!n||n.length===0)return"idle";const s=n[n.length-1];if(!s)return"idle";if(s.is_handoff)return"handoff-imminent";if(s.is_compaction)return"compacting";const a=s.context_ratio;return a>.85?"handoff-imminent":a>.7?"preparing":a>.5?"compacting":"active"}function Qm(t,e){const n=e.get(t.name);if(n!=null)return n;const s=t.last_heartbeat?Date.parse(t.last_heartbeat):Number.NaN;if(!Number.isNaN(s))return s;const a=[t.last_turn_ago_s,t.last_proactive_ago_s,t.last_handoff_ago_s,t.last_compaction_ago_s].find(o=>typeof o=="number"&&Number.isFinite(o)&&o>=0);return typeof a=="number"?Date.now()-a*1e3:null}function Zm(t){return Array.isArray(t)?t.map(e=>{if(!m(e))return null;const n=u(e.ts_unix),s=u(e.context_ratio);if(n==null||s==null)return null;const a=m(e.handoff)?e.handoff:null;return{ts:n,context_ratio:s,context_tokens:u(e.context_tokens)??0,context_max:u(e.context_max)??0,latency_ms:u(e.latency_ms)??0,generation:u(e.generation)??0,channel:typeof e.channel=="string"?e.channel:"turn",is_handoff:a!=null&&e.handoff_performed===!0,is_compaction:e.compacted===!0,compaction_saved_tokens:u(e.compaction_saved_tokens)??0,compaction_trigger:typeof e.compaction_trigger=="string"?e.compaction_trigger:null,model_used:typeof e.model_used=="string"?e.model_used:"",cost_usd:u(e.cost_usd)??Number.NaN,handoff_to_model:a&&typeof a.to_model=="string"?a.to_model:null,handoff_new_generation:a?u(a.new_generation)??null:null}}).filter(e=>e!==null):[]}function t_(t){if(!m(t))return;const e={};for(const[n,s]of Object.entries(t)){if(n==="top_tools"){if(!Array.isArray(s))continue;const o=s.filter(l=>m(l)&&typeof l.tool=="string"&&l.tool.trim()!=="");o.length>0&&(e.top_tools=o);continue}const a=u(s);a!=null&&(e[n]=a)}return Object.keys(e).length>0?e:void 0}function e_(t){if(!m(t))return null;const e=r(t.health_state),n=r(t.next_action_path),s=r(t.last_reply_status);if(!e||!n||!s)return null;const a=r(t.quiet_reason)??null;return{health_state:e,quiet_reason:a,next_action_path:n,last_reply_status:s,last_reply_at:ot(t.last_reply_at)??r(t.last_reply_at)??null,last_reply_preview:r(t.last_reply_preview)??null,last_error:r(t.last_error)??null,next_eligible_at_s:u(t.next_eligible_at_s)??null,recoverable:typeof t.recoverable=="boolean"?t.recoverable:n==="recover",summary:r(t.summary),keepalive_running:typeof t.keepalive_running=="boolean"?t.keepalive_running:void 0,continuity_state:r(t.continuity_state)??null,continuity_summary:r(t.continuity_summary)??null}}function n_(t){return(Array.isArray(t)?t:m(t)&&Array.isArray(t.keepers)?t.keepers:[]).map(n=>{if(!m(n))return null;const s=m(n.agent)?n.agent:null,a=m(n.context)?n.context:null,o=t_(n.metrics_window),l=r(n.name);if(!l)return null;const c=u(n.context_ratio)??u(a==null?void 0:a.context_ratio),d=r(n.status)??r(s==null?void 0:s.status)??"offline",p=r(n.model)??r(n.active_model)??r(n.primary_model),_=B(n.skill_secondary),v=Zm(n.metrics_series),f=a?{source:r(a.source),context_ratio:u(a.context_ratio),context_tokens:u(a.context_tokens),context_max:u(a.context_max),message_count:u(a.message_count),has_checkpoint:typeof a.has_checkpoint=="boolean"?a.has_checkpoint:void 0}:void 0,h=s?{name:r(s.name),exists:typeof s.exists=="boolean"?s.exists:void 0,error:r(s.error),agent_type:r(s.agent_type),status:r(s.status),current_task:r(s.current_task)??null,joined_at:r(s.joined_at),last_seen:r(s.last_seen),last_seen_ago_s:u(s.last_seen_ago_s),capabilities:B(s.capabilities),is_zombie:typeof s.is_zombie=="boolean"?s.is_zombie:void 0}:void 0;return{name:l,runtime_class:n.runtime_class==="persistent_agent"?"persistent_agent":"resident_keeper",desired:typeof n.desired=="boolean"?n.desired:void 0,resident_registered:typeof n.resident_registered=="boolean"?n.resident_registered:void 0,reconcile_status:r(n.reconcile_status)??null,emoji:r(n.emoji),koreanName:r(n.koreanName)??r(n.korean_name),agent_name:r(n.agent_name),trace_id:r(n.trace_id),model:p,primary_model:r(n.primary_model),active_model:r(n.active_model),next_model_hint:r(n.next_model_hint)??null,status:Ym(d),presence_keepalive:typeof n.presence_keepalive=="boolean"?n.presence_keepalive:void 0,presence_keepalive_sec:u(n.presence_keepalive_sec),keepalive_running:typeof n.keepalive_running=="boolean"?n.keepalive_running:void 0,proactive_enabled:typeof n.proactive_enabled=="boolean"?n.proactive_enabled:void 0,proactive_idle_sec:u(n.proactive_idle_sec),proactive_cooldown_sec:u(n.proactive_cooldown_sec),last_heartbeat:r(n.last_heartbeat)??r(s==null?void 0:s.last_seen),generation:u(n.generation),turn_count:u(n.turn_count)??u(n.total_turns),keeper_age_s:u(n.keeper_age_s),last_turn_ago_s:u(n.last_turn_ago_s),last_handoff_ago_s:u(n.last_handoff_ago_s),last_compaction_ago_s:u(n.last_compaction_ago_s),last_proactive_ago_s:u(n.last_proactive_ago_s),last_proactive_preview:r(n.last_proactive_preview)??null,context_ratio:c,context_tokens:u(n.context_tokens)??u(a==null?void 0:a.context_tokens),context_max:u(n.context_max)??u(a==null?void 0:a.context_max),context_source:r(n.context_source)??r(a==null?void 0:a.source),context:f,traits:B(n.traits),interests:B(n.interests),primaryValue:r(n.primaryValue)??r(n.primary_value),activityLevel:u(n.activityLevel)??u(n.activity_level),memory_recent_note:r(n.memory_recent_note)??null,recent_input_preview:r(n.recent_input_preview)??null,recent_output_preview:r(n.recent_output_preview)??null,recent_tool_names:B(n.recent_tool_names)??[],allowed_tool_names:B(n.allowed_tool_names)??[],latest_tool_names:B(n.latest_tool_names)??[],latest_tool_call_count:u(n.latest_tool_call_count)??null,tool_audit_source:r(n.tool_audit_source)??null,tool_audit_at:ot(n.tool_audit_at)??r(n.tool_audit_at)??null,conversation_tail_count:u(n.conversation_tail_count),k2k_count:u(n.k2k_count),handoff_count_total:u(n.handoff_count_total)??u(n.trace_history_count),compaction_count:u(n.compaction_count),last_compaction_saved_tokens:u(n.last_compaction_saved_tokens),diagnostic:e_(n.diagnostic),skill_primary:r(n.skill_primary)??null,skill_secondary:_,skill_reason:r(n.skill_reason)??null,metrics_series:v.length>0?v:void 0,metrics_window:o,agent:h}}).filter(n=>n!==null)}function Se(t){return(t??"").trim().toLowerCase()}function bt(t){const e=typeof t=="number"?t:Date.parse(t);return Number.isNaN(e)?0:e}function sa(t,e=88){const n=t.replace(/\s+/g," ").trim();return n&&(n.length>e?`${n.slice(0,e-3)}...`:n)}function js(t){return typeof t!="number"||!Number.isFinite(t)||t<0?null:new Date(Date.now()-t*1e3).toISOString()}function Rn(t){return t.last_heartbeat??js(t.last_turn_ago_s)??js(t.last_proactive_ago_s)??js(t.last_handoff_ago_s)??js(t.last_compaction_ago_s)}function s_(t){const e=t.title.trim();return e||sa(t.content)}function a_(t){const e=t.generation??"?",n=typeof t.context_ratio=="number"&&Number.isFinite(t.context_ratio)?`${Math.round(t.context_ratio*100)}%`:"?";return t.last_heartbeat?`Heartbeat gen=${e} ctx=${n}`:`Keeper snapshot gen=${e} ctx=${n}`}function i_(t,e,n,s,a={}){var x;const o=Se(t),l=e.filter(R=>Se(R.assignee)===o&&(R.status==="claimed"||R.status==="in_progress")).length,c=n.filter(R=>Se(R.from)===o).sort((R,A)=>bt(A.timestamp)-bt(R.timestamp))[0],d=s.filter(R=>Se(R.agent)===o||Se(R.author)===o).sort((R,A)=>bt(A.timestamp)-bt(R.timestamp))[0],p=(a.boardPosts??[]).filter(R=>Se(R.author)===o).sort((R,A)=>bt(A.updated_at||A.created_at)-bt(R.updated_at||R.created_at))[0],_=(a.keepers??[]).filter(R=>Se(R.name)===o&&Rn(R)!==null).sort((R,A)=>bt(Rn(A)??0)-bt(Rn(R)??0))[0],v=c?bt(c.timestamp):0,f=d?bt(d.timestamp):0,h=p?bt(p.updated_at||p.created_at):0,I=_?bt(Rn(_)??0):0,k=a.lastSeen?bt(a.lastSeen):0,C=((x=a.currentTask)==null?void 0:x.trim())||(l>0?`${l} claimed tasks`:null);if(v===0&&f===0&&h===0&&I===0&&k===0)return{activeAssignedCount:l,lastActivityAt:null,lastActivityText:C};const y=[c?{timestamp:c.timestamp,ts:v,text:sa(c.content)}:null,p?{timestamp:p.updated_at||p.created_at,ts:h,text:`Post: ${sa(s_(p))}`}:null,_?{timestamp:Rn(_),ts:I,text:a_(_)}:null,d?{timestamp:new Date(d.timestamp).toISOString(),ts:f,text:sa(d.text)}:null].filter(R=>R!==null).sort((R,A)=>A.ts-R.ts)[0];return y&&y.ts>=k?{activeAssignedCount:l,lastActivityAt:y.timestamp,lastActivityText:y.text}:{activeAssignedCount:l,lastActivityAt:a.lastSeen??null,lastActivityText:C??"Presence heartbeat"}}const Gt=g([]),ue=g([]),uo=g([]),ae=g([]),dt=g(null),o_=g(null),r_=g(null),zc=g([]),Ec=g([]),Pc=g([]),Nc=g([]),jc=g(null),wc=g([]),Yo=g([]),Oc=g([]),po=g(new Map),si=g([]),Xn=g("recent"),Me=g(!0),Dc=g(null),ee=g(""),cn=g([]),On=g(!1),qc=g(new Map),Xo=g("unknown"),dn=g(null),mo=g(!1),Qn=g(!1),_o=g(!1),Dn=g(!1),Qo=g(null),ba=g(!1),ka=g(null),Fc=g(null),vo=g(null),l_=g(null),c_=g(null),d_=g(null);Nt(()=>Gt.value.filter(t=>t.status==="active"||t.status==="busy"||t.status==="listening"||t.status==="idle"));const Kc=Nt(()=>{const t=ue.value;return{todo:t.filter(e=>e.status==="todo"),inProgress:t.filter(e=>e.status==="in_progress"||e.status==="claimed"),done:t.filter(e=>e.status==="done")}}),Bc=Nt(()=>{const t=new Map,e=ue.value,n=uo.value,s=fa.value,a=si.value,o=ae.value;for(const l of Gt.value)t.set(l.name.trim().toLowerCase(),i_(l.name,e,n,s,{currentTask:l.current_task,lastSeen:l.last_seen,boardPosts:a,keepers:o}));return t});Nt(()=>{var e;const t=new Map;for(const n of ae.value){const s=((e=n.status)==null?void 0:e.toLowerCase())??"";if(s==="offline"||s==="inactive"){t.set(n.name,"offline");continue}!n.metrics_series||n.metrics_series.length===0||t.set(n.name,Xm(n))}return t});const u_=12e4;Nt(()=>{const t=Date.now(),e=new Set,n=po.value;for(const s of ae.value){const a=Qm(s,n);a!=null&&t-a>u_&&e.add(s.name)}return e});function p_(t){return t==="dashboard_refresh"||t==="masc/dashboard_refresh"||t.startsWith("goal_")||t.startsWith("masc/goal_")||t.startsWith("mdal_")||t.startsWith("masc/mdal_")||t.startsWith("operator_")||t.startsWith("masc/operator_")||t.startsWith("command_plane_")||t.startsWith("masc/command_plane_")}function m_(t){const e=typeof t=="string"?t.toLowerCase():"";return e==="active"||e==="busy"||e==="listening"||e==="idle"||e==="inactive"||e==="offline"?e:e==="in_progress"||e==="claimed"?"busy":"offline"}function __(t){const e=typeof t=="string"?t.toLowerCase():"";return e==="todo"||e==="in_progress"||e==="claimed"||e==="done"||e==="cancelled"?e:e==="inprogress"?"in_progress":"todo"}function v_(t){if(!m(t))return null;const e=r(t.name);return e?{name:e,agent_type:r(t.agent_type),status:m_(t.status),current_task:r(t.current_task)??null,joined_at:r(t.joined_at),last_seen:r(t.last_seen),capabilities:B(t.capabilities),emoji:r(t.emoji),koreanName:r(t.koreanName)??r(t.korean_name),model:r(t.model),traits:B(t.traits),interests:B(t.interests),activityLevel:u(t.activityLevel)??u(t.activity_level),primaryValue:r(t.primaryValue)??r(t.primary_value)}:null}function f_(t){if(!m(t))return null;const e=r(t.id),n=r(t.title);return!e||!n?null:{id:e,title:n,status:__(t.status),priority:u(t.priority),assignee:r(t.assignee),description:r(t.description),created_at:r(t.created_at),updated_at:r(t.updated_at)}}function g_(t){if(!m(t))return null;const e=r(t.from)??r(t.from_agent)??"system",n=r(t.content)??"",s=r(t.timestamp)??new Date().toISOString();return{id:r(t.id),seq:u(t.seq),from:e,content:n,timestamp:s,type:r(t.type)}}function Zo(t){const e=typeof t=="string"?t.toLowerCase():"";return e==="ok"||e==="warn"||e==="bad"?e:"ok"}function $_(t){return m(t)?{active_sessions:u(t.active_sessions),blocked_sessions:u(t.blocked_sessions),active_operations:u(t.active_operations),blocked_operations:u(t.blocked_operations),runtime_pressure:u(t.runtime_pressure),worker_alerts:u(t.worker_alerts),continuity_alerts:u(t.continuity_alerts),priority_items:u(t.priority_items),todo_tasks:u(t.todo_tasks),claimed_tasks:u(t.claimed_tasks),running_tasks:u(t.running_tasks),done_tasks:u(t.done_tasks),cancelled_tasks:u(t.cancelled_tasks),keepers:u(t.keepers)}:null}function pe(t){if(!m(t))return null;const e=r(t.surface),n=r(t.label),s=r(t.target_type),a=r(t.target_id),o=r(t.focus_kind);return!e||!n||!s||!a||!o?null:{surface:e==="command"?"command":"intervene",label:n,target_type:s,target_id:a,focus_kind:o,operation_id:r(t.operation_id)??null,command_surface:r(t.command_surface)??null}}function h_(t){if(!m(t))return null;const e=r(t.id),n=r(t.kind),s=r(t.summary),a=r(t.target_type),o=r(t.target_id);return!e||!s||!a||!o||n!=="session"&&n!=="operation"?null:{id:e,kind:n,severity:Zo(t.severity),status:r(t.status),summary:s,target_type:a,target_id:o,linked_session_id:r(t.linked_session_id)??null,linked_operation_id:r(t.linked_operation_id)??null,last_seen_at:r(t.last_seen_at)??null,top_handoff:pe(t.top_handoff),intervene_handoff:pe(t.intervene_handoff),command_handoff:pe(t.command_handoff)}}function y_(t){if(!m(t))return null;const e=r(t.session_id),n=r(t.goal);return!e||!n?null:{session_id:e,goal:n,room:r(t.room)??null,status:r(t.status),health:r(t.health),member_names:B(t.member_names),linked_operation_id:r(t.linked_operation_id)??null,linked_detachment_id:r(t.linked_detachment_id)??null,runtime_blocker:r(t.runtime_blocker)??null,worker_gap_summary:r(t.worker_gap_summary)??null,last_activity_at:r(t.last_activity_at)??null,last_activity_summary:r(t.last_activity_summary)??null,communication_summary:r(t.communication_summary)??null,active_count:u(t.active_count),seen_count:u(t.seen_count),planned_count:u(t.planned_count),required_count:u(t.required_count),counts_basis:r(t.counts_basis)??null,top_handoff:pe(t.top_handoff),intervene_handoff:pe(t.intervene_handoff),command_handoff:pe(t.command_handoff)}}function b_(t){if(!m(t))return null;const e=r(t.operation_id),n=r(t.objective);return!e||!n?null:{operation_id:e,objective:n,status:r(t.status),stage:r(t.stage)??null,assigned_unit_id:r(t.assigned_unit_id)??null,assigned_unit_label:r(t.assigned_unit_label)??null,linked_session_id:r(t.linked_session_id)??null,linked_detachment_id:r(t.linked_detachment_id)??null,blocker_summary:r(t.blocker_summary)??null,search_status:r(t.search_status)??null,next_tool:r(t.next_tool)??null,updated_at:r(t.updated_at)??null,top_handoff:pe(t.top_handoff),command_handoff:pe(t.command_handoff)}}function fl(t){if(!m(t))return null;const e=r(t.name)??r(t.agent_name),n=r(t.note),s=r(t.focus),a=r(t.state);if(!e||!n||!s||a!=="working"&&a!=="watching"&&a!=="quiet"&&a!=="offline")return null;const o=r(t.signal_truth),l=o==="live"||o==="stale"||o==="absent"?o:void 0,c=r(t.evidence_source),d=c==="message"||c==="presence"||c==="none"?c:void 0;return{name:e,agent_name:r(t.agent_name),status:r(t.status),tone:Zo(t.tone),state:a,note:n,focus:s,last_signal_at:r(t.last_signal_at)??null,last_signal_age_sec:u(t.last_signal_age_sec)??null,signal_truth:l,evidence_source:d,active_task_count:u(t.active_task_count),related_session_id:r(t.related_session_id)??null,related_operation_id:r(t.related_operation_id)??null,emoji:r(t.emoji),korean_name:r(t.korean_name),model:r(t.model)??null,recent_output_preview:r(t.recent_output_preview)??null,recent_event:r(t.recent_event)??null}}function k_(t){if(!m(t))return null;const e=r(t.last_system_skip_reason)??r(t.last_skip_reason)??null;return{checked:u(t.checked),acted:u(t.acted),passed:u(t.passed),skipped:u(t.skipped),failed:u(t.failed),last_tick_at:r(t.last_tick_at)??null,last_skip_reason:e,last_pass_reason:r(t.last_pass_reason)??null,last_system_skip_reason:e,strategy:r(t.strategy)??null,queue_depth:u(t.queue_depth)??null,activity_report:r(t.activity_report)??null}}function x_(t){if(!m(t))return null;const e=r(t.agent_name),n=r(t.outcome);return!e||!n?null:{agent_name:e,trigger:r(t.trigger)??null,outcome:n,summary:r(t.summary)??null,reason:r(t.reason)??null,allowed_tool_names:B(t.allowed_tool_names)??[],used_tool_names:B(t.used_tool_names)??[],used_tool_call_count:u(t.used_tool_call_count)??null,action_kind:r(t.action_kind)??"none",tool_audit_source:r(t.tool_audit_source)??null,tool_audit_at:r(t.tool_audit_at)??null,checked_at:r(t.checked_at)??null,decision_reason:r(t.decision_reason)??null,worker_name:r(t.worker_name)??null,failure_reason:r(t.failure_reason)??null}}function S_(t){if(!m(t))return null;const e=r(t.name),n=r(t.note),s=r(t.focus),a=r(t.state);return!e||!n||!s||a!=="healthy"&&a!=="warning"&&a!=="critical"?null:{name:e,agent_name:r(t.agent_name)??null,status:r(t.status),tone:Zo(t.tone),state:a,note:n,focus:s,last_signal_at:r(t.last_signal_at)??null,last_autonomous_action_at:r(t.last_autonomous_action_at)??null,generation:u(t.generation),turn_count:u(t.turn_count),context_ratio:u(t.context_ratio)??null,continuity:r(t.continuity)??null,lifecycle:r(t.lifecycle)??null,related_session_id:r(t.related_session_id)??null,model:r(t.model)??null,emoji:r(t.emoji),korean_name:r(t.korean_name),skill_reason:r(t.skill_reason)??null,recent_input_preview:r(t.recent_input_preview)??null,recent_output_preview:r(t.recent_output_preview)??null,recent_tool_names:B(t.recent_tool_names)??[],allowed_tool_names:B(t.allowed_tool_names)??[],latest_tool_names:B(t.latest_tool_names)??[],latest_tool_call_count:u(t.latest_tool_call_count)??null,tool_audit_source:r(t.tool_audit_source)??null,tool_audit_at:r(t.tool_audit_at)??null,last_proactive_preview:r(t.last_proactive_preview)??null,continuity_summary:r(t.continuity_summary)??null,skill_route_summary:r(t.skill_route_summary)??null}}function gl(t){if(typeof t.seq=="number"&&Number.isFinite(t.seq))return t.seq;const e=Date.parse(t.timestamp);return Number.isNaN(e)?0:e}function C_(t,e){if(e.length===0)return t;const n=new Map;for(const s of t){const a=typeof s.seq=="number"?`seq:${s.seq}`:`ts:${s.timestamp}|from:${s.from}|content:${s.content}`;n.set(a,s)}for(const s of e){const a=typeof s.seq=="number"?`seq:${s.seq}`:`ts:${s.timestamp}|from:${s.from}|content:${s.content}`;n.set(a,s)}return[...n.values()].sort((s,a)=>gl(s)-gl(a)).slice(-500)}function A_(t){if(!m(t))return;const e=r(t.release_version),n=ot(t.started_at),s=u(t.uptime_seconds);if(!(!e||!n||s==null))return{release_version:e,commit:r(t.commit)??null,started_at:n,uptime_seconds:s}}function T_(t){if(m(t))return{enabled:t.enabled===!0,alive:t.alive===!0,status:r(t.status)??void 0,tick_in_progress:typeof t.tick_in_progress=="boolean"?t.tick_in_progress:void 0,tick_count:u(t.tick_count)??void 0,check_interval_sec:u(t.check_interval_sec)??void 0,last_tick_started_at:ot(t.last_tick_started_at)??r(t.last_tick_started_at)??null,last_tick_completed_at:ot(t.last_tick_completed_at)??r(t.last_tick_completed_at)??null,next_tick_due_at:ot(t.next_tick_due_at)??r(t.next_tick_due_at)??null,last_health_check_at:ot(t.last_health_check_at)??r(t.last_health_check_at)??null,last_intervention:r(t.last_intervention)??void 0,last_decision_source:r(t.last_decision_source)??void 0,last_action:r(t.last_action)??void 0,last_target:r(t.last_target)??null,last_reason:r(t.last_reason)??null,last_error:r(t.last_error)??null,circuit_open:typeof t.circuit_open=="boolean"?t.circuit_open:void 0,circuit_open_until:ot(t.circuit_open_until)??r(t.circuit_open_until)??null,can_spawn:typeof t.can_spawn=="boolean"?t.can_spawn:void 0,can_retire:typeof t.can_retire=="boolean"?t.can_retire:void 0,last_spawn_attempt_at:ot(t.last_spawn_attempt_at)??r(t.last_spawn_attempt_at)??null,last_retirement_attempt_at:ot(t.last_retirement_attempt_at)??r(t.last_retirement_attempt_at)??null,spawns_today:u(t.spawns_today)??void 0,retirements_today:u(t.retirements_today)??void 0,health_summary:m(t.health_summary)?{total_agents:u(t.health_summary.total_agents)??void 0,active_agents:u(t.health_summary.active_agents)??void 0,idle_agents:u(t.health_summary.idle_agents)??void 0,todo_count:u(t.health_summary.todo_count)??void 0,high_priority_todo:u(t.health_summary.high_priority_todo)??void 0,orphan_count:u(t.health_summary.orphan_count)??void 0,homeostatic_score:u(t.health_summary.homeostatic_score)??void 0,needs_workers:typeof t.health_summary.needs_workers=="boolean"?t.health_summary.needs_workers:void 0}:void 0}}function I_(t){if(m(t))return{enabled:t.enabled===!0,mode:r(t.mode)??void 0,masc_enabled:typeof t.masc_enabled=="boolean"?t.masc_enabled:void 0,masc_loops_running:typeof t.masc_loops_running=="boolean"?t.masc_loops_running:void 0,runtime_owner:r(t.runtime_owner)??null,zombie_loop_running:typeof t.zombie_loop_running=="boolean"?t.zombie_loop_running:void 0,gc_loop_running:typeof t.gc_loop_running=="boolean"?t.gc_loop_running:void 0,lodge_enabled:typeof t.lodge_enabled=="boolean"?t.lodge_enabled:void 0,lodge_loop_started:typeof t.lodge_loop_started=="boolean"?t.lodge_loop_started:void 0,lodge_running:typeof t.lodge_running=="boolean"?t.lodge_running:void 0,last_zombie_cleanup:ot(t.last_zombie_cleanup)??r(t.last_zombie_cleanup)??null,last_gc:ot(t.last_gc)??r(t.last_gc)??null,last_lodge:ot(t.last_lodge)??r(t.last_lodge)??null,last_zombie_result:r(t.last_zombie_result)??null,last_gc_result:r(t.last_gc_result)??null,last_lodge_result:m(t.last_lodge_result)?{ok:typeof t.last_lodge_result.ok=="boolean"?t.last_lodge_result.ok:void 0,message:r(t.last_lodge_result.message)??void 0}:null}}function R_(t){if(m(t))return{enabled:t.enabled===!0,started:t.started===!0,agent_name:r(t.agent_name)??null,llm_enabled:typeof t.llm_enabled=="boolean"?t.llm_enabled:void 0,uptime_s:u(t.uptime_s)??void 0,embedded_guardian_loops_running:typeof t.embedded_guardian_loops_running=="boolean"?t.embedded_guardian_loops_running:void 0,guardian_runtime_owner:r(t.guardian_runtime_owner)??null,consumers:B(t.consumers)}}function M_(t){if(!m(t))return;const e=m(t.last_result)?t.last_result:null;return{enabled:t.enabled===!0,strategy:r(t.strategy)??void 0,queue_depth:u(t.queue_depth)??void 0,processed_events:u(t.processed_events)??void 0,active_keepers:u(t.active_keepers)??void 0,last_event_at:ot(t.last_event_at)??r(t.last_event_at)??null,last_social_action_at:ot(t.last_social_action_at)??r(t.last_social_action_at)??null,last_pass_reason:r(t.last_pass_reason)??null,last_system_skip_reason:r(t.last_system_skip_reason)??null,total_checks:u(t.total_checks)??void 0,total_acted:u(t.total_acted)??void 0,total_passed:u(t.total_passed)??void 0,total_skipped:u(t.total_skipped)??void 0,total_failed:u(t.total_failed)??void 0,last_result:e?{checked:u(e.checked)??void 0,acted:u(e.acted)??void 0,passed:u(e.passed)??void 0,skipped:u(e.skipped)??void 0,failed:u(e.failed)??void 0,last_tick_at:ot(e.last_tick_at)??r(e.last_tick_at)??null,last_pass_reason:r(e.last_pass_reason)??null,last_system_skip_reason:r(e.last_system_skip_reason)??null,activity_report:r(e.activity_report)??null,checkins:Array.isArray(e.checkins)?e.checkins.map(n=>({name:r(n.agent_name)??"",trigger:r(n.trigger)??void 0,outcome:r(n.outcome)??void 0,summary:r(n.summary)??void 0,reason:r(n.reason)??void 0})).filter(n=>n.name!==""):[]}:null}}function Uc(t,e){return m(t)?{...t,generated_at:e??ot(t.generated_at)??void 0,build:A_(t.build),lodge:Nm(t.lodge)??void 0,social_runtime:M_(t.social_runtime),gardener:T_(t.gardener)??void 0,guardian:I_(t.guardian)??void 0,sentinel:R_(t.sentinel)??void 0}:null}function Hc(t,e){return e?t?{...t,...e,build:e.build??t.build,generated_at:e.generated_at??t.generated_at}:e:t}function L_(t){const e=typeof t=="string"?t.toLowerCase():"";return e==="running"||e==="interrupted"||e==="completed"||e==="stopped"||e==="error"?e:e.startsWith("error")?"error":"running"}function z_(t){if(!m(t))return null;const e=u(t.iteration);if(e==null)return null;const n=u(t.metric_before)??0,s=u(t.metric_after)??n,a=m(t.evidence)?t.evidence:null;return{iteration:e,metric_before:n,metric_after:s,delta:u(t.delta)??s-n,changes:r(t.changes)??"",failed_attempts:r(t.failed_attempts)??"",next_suggestion:r(t.next_suggestion)??"",elapsed_ms:u(t.elapsed_ms)??0,cost_usd:u(t.cost_usd)??null,evidence:a?{worker_engine:(a.worker_engine==="api_tool_loop","api_tool_loop"),worker_model:r(a.worker_model)??"",tool_call_count:u(a.tool_call_count)??0,tool_names:B(a.tool_names)??[],session_id:r(a.session_id)??"",evidence_status:a.evidence_status==="legacy_unverified"?"legacy_unverified":"verified"}:null}}function E_(t){var o,l;if(!m(t))return null;const e=r(t.loop_id);if(!e)return null;const n=u(t.baseline_metric)??0,s=Array.isArray(t.history)?t.history.map(z_).filter(c=>c!==null):[],a=u(t.current_metric)??((o=s[0])==null?void 0:o.metric_after)??n;return{loop_id:e,profile:r(t.profile)??"unknown",status:L_(t.status),strict_mode:typeof t.strict_mode=="boolean"?t.strict_mode:void 0,error_message:r(t.error_message)??r(t.error_reason)??null,stop_reason:r(t.stop_reason)??r(t.reason)??null,current_iteration:u(t.current_iteration)??((l=s[0])==null?void 0:l.iteration)??0,max_iterations:u(t.max_iterations)??0,baseline_metric:n,current_metric:a,target:r(t.target)??"",stagnation_streak:u(t.stagnation_streak)??0,stagnation_limit:u(t.stagnation_limit)??0,elapsed_seconds:u(t.elapsed_seconds)??0,updated_at:ot(t.updated_at)??null,stopped_at:ot(t.stopped_at)??null,execution_mode:t.execution_mode==="worker_spawn"?"worker_spawn":void 0,worker_engine:t.worker_engine==="api_tool_loop"?"api_tool_loop":null,worker_model:r(t.worker_model)??null,evidence_policy:t.evidence_policy==="hard"||t.evidence_policy==="legacy"?t.evidence_policy:void 0,latest_tool_call_count:u(t.latest_tool_call_count)??0,latest_tool_names:B(t.latest_tool_names)??[],session_id:r(t.session_id)??null,evidence_status:t.evidence_status==="legacy_unverified"?"legacy_unverified":t.evidence_status==="verified"?"verified":null,durability:t.durability==="persistent_backend"||t.durability==="memory_only"?t.durability:void 0,persistence_backend:t.persistence_backend==="filesystem"||t.persistence_backend==="postgres"||t.persistence_backend==="memory"?t.persistence_backend:void 0,recoverable:typeof t.recoverable=="boolean"?t.recoverable:void 0,history:s}}async function ks(){mo.value=!0;try{await Promise.all([Gc(),Le()]),Fc.value=new Date().toISOString()}catch(t){console.error("Dashboard refresh error:",t)}finally{mo.value=!1}}async function Wc(){ba.value=!0,ka.value=null;try{const t=await xp();Qo.value=t,d_.value=new Date().toISOString()}catch(t){ka.value=t instanceof Error?t.message:"Failed to load dashboard semantics"}finally{ba.value=!1}}function P_(t){var e;return((e=Qo.value)==null?void 0:e.surfaces.find(n=>n.id===t))??null}function N_(t){var n;const e=((n=Qo.value)==null?void 0:n.surfaces)??[];for(const s of e){const a=s.panels.find(o=>o.id===t);if(a)return a}return null}function j_(t){var s,a;cn.value=(Array.isArray(t.goals)?t.goals:[]).map(o=>{if(!m(o))return null;const l=r(o.id),c=r(o.title),d=r(o.horizon),p=r(o.status),_=r(o.created_at),v=r(o.updated_at);return!l||!c||!d||!p||!_||!v?null:{id:l,horizon:d,title:c,metric:r(o.metric)??null,target_value:r(o.target_value)??null,due_date:r(o.due_date)??null,priority:u(o.priority)??3,status:p,parent_goal_id:r(o.parent_goal_id)??null,last_review_note:r(o.last_review_note)??null,last_review_at:r(o.last_review_at)??null,created_at:_,updated_at:v}}).filter(o=>o!==null);const e=new Map,n=Array.isArray((s=t.mdal)==null?void 0:s.loops)?t.mdal.loops:[];for(const o of n){const l=E_(o);l&&e.set(l.loop_id,l)}qc.value=e,dn.value=typeof((a=t.mdal)==null?void 0:a.error)=="string"?t.mdal.error:null,Xo.value=dn.value?"error":e.size===0?"idle":"ready"}async function Gc(){try{const t=await $p(),e=Uc(t.status,t.generated_at);e&&(dt.value=Hc(dt.value,e))}catch(t){console.error("Dashboard shell fetch error:",t)}}async function Le(){var t;try{const e=await yp(),n=Uc(e.status,e.generated_at),s=(t=dt.value)==null?void 0:t.room;n&&(dt.value=Hc(dt.value,n));const a=s!=null&&(n==null?void 0:n.room)!=null&&s!==n.room;Gt.value=(Array.isArray(e.agents)?e.agents:[]).map(v_).filter(d=>d!==null),ue.value=(Array.isArray(e.tasks)?e.tasks:[]).map(f_).filter(d=>d!==null);const o=(Array.isArray(e.messages)?e.messages:[]).map(g_).filter(d=>d!==null);uo.value=a?o:C_(uo.value,o),ae.value=n_(e.keepers),r_.value=$_(e.summary);const l=Array.isArray(e.social_checkins)?e.social_checkins:[],c=Array.isArray(e.lodge_checkins)?e.lodge_checkins:[];jc.value=k_(e.social_tick??e.lodge_tick),wc.value=(l.length>0?l:c).map(x_).filter(d=>d!==null),zc.value=(Array.isArray(e.execution_queue)?e.execution_queue:Array.isArray(e.priority_queue)?e.priority_queue:[]).map(h_).filter(d=>d!==null),Ec.value=(Array.isArray(e.session_briefs)?e.session_briefs:[]).map(y_).filter(d=>d!==null),Pc.value=(Array.isArray(e.operation_briefs)?e.operation_briefs:[]).map(b_).filter(d=>d!==null),Nc.value=(Array.isArray(e.worker_support_briefs)?e.worker_support_briefs:Array.isArray(e.worker_briefs)?e.worker_briefs:[]).map(fl).filter(d=>d!==null),Yo.value=(Array.isArray(e.continuity_briefs)?e.continuity_briefs:[]).map(S_).filter(d=>d!==null),Oc.value=(Array.isArray(e.offline_worker_briefs)?e.offline_worker_briefs:[]).map(fl).filter(d=>d!==null),o_.value=null,Fc.value=new Date().toISOString()}catch(e){console.error("Dashboard execution fetch error:",e)}}async function me(){Qn.value=!0;try{const t=await bp(Xn.value,{excludeSystem:Me.value});si.value=t.posts??[],vo.value=new Date().toISOString()}catch(t){console.error("Board fetch error:",t)}finally{Qn.value=!1}}async function _e(){var t;_o.value=!0;try{const e=ee.value||((t=dt.value)==null?void 0:t.room)||"default";ee.value||(ee.value=e);const n=await mm(e);Dc.value=n}catch(e){console.error("TRPG fetch error:",e)}finally{_o.value=!1}}async function tr(){On.value=!0,Dn.value=!0;try{const t=await Ip();j_(t),l_.value=new Date().toISOString(),c_.value=new Date().toISOString()}catch(t){console.error("Planning fetch error:",t),Xo.value="error",dn.value=t instanceof Error?t.message:String(t)}finally{On.value=!1,Dn.value=!1}}async function Jc(){return tr()}const er=g(null),fo=g(!1),xa=g(null);function w_(t){return m(t)?{room:r(t.room)??r(t.current_room),room_base_path:r(t.room_base_path),cluster:r(t.cluster),project:r(t.project),paused:j(t.paused),version:r(t.version),generated_at:r(t.generated_at),tempo_interval_s:u(t.tempo_interval_s)}:null}function O_(t){return m(t)?{active_sessions:u(t.active_sessions),blocked_sessions:u(t.blocked_sessions),active_operations:u(t.active_operations),blocked_operations:u(t.blocked_operations),runtime_pressure:u(t.runtime_pressure),worker_alerts:u(t.worker_alerts),continuity_alerts:u(t.continuity_alerts),priority_items:u(t.priority_items),keepers:u(t.keepers)}:null}function D_(t){if(!m(t))return null;const e=r(t.id),n=r(t.kind),s=r(t.severity),a=r(t.summary),o=r(t.target_type),l=r(t.target_id);return!e||!n||!s||!a||!o||!l?null:{id:e,kind:n,severity:s,summary:a,target_type:o,target_id:l,status:r(t.status),linked_session_id:r(t.linked_session_id)??null,linked_operation_id:r(t.linked_operation_id)??null,last_seen_at:r(t.last_seen_at)??null,top_handoff:m(t.top_handoff)?t.top_handoff:null,intervene_handoff:m(t.intervene_handoff)?t.intervene_handoff:null,command_handoff:m(t.command_handoff)?t.command_handoff:null}}function q_(t){if(!m(t))return null;const e=r(t.kind),n=r(t.summary),s=r(t.target_type);return!e||!n||!s?null:{kind:e,severity:r(t.severity)??"warn",summary:n,target_type:s,target_id:r(t.target_id)??null,actor:r(t.actor)??null,evidence:t.evidence}}function F_(t){if(!m(t))return null;const e=r(t.action_type),n=r(t.target_type),s=r(t.reason);return!e||!n||!s?null:{action_type:e,target_type:n,target_id:r(t.target_id)??null,severity:r(t.severity)??"warn",reason:s,confirm_required:j(t.confirm_required),suggested_payload:m(t.suggested_payload)?t.suggested_payload:void 0,preview:t.preview}}function K_(t){return m(t)?{actor_filter:r(t.actor_filter)??null,filter_active:j(t.filter_active)??!1,visible_count:u(t.visible_count)??0,total_count:u(t.total_count)??0,hidden_count:u(t.hidden_count)??0,hidden_actors:B(t.hidden_actors),confirm_required_actions:ct(t.confirm_required_actions).flatMap(e=>{if(!m(e))return[];const n=r(e.action_type),s=r(e.target_type);return!n||!s?[]:[{action_type:n,target_type:s,description:r(e.description),confirm_required:j(e.confirm_required)}]})}:null}function B_(t){return m(t)?{count:u(t.count)??0,bad_count:u(t.bad_count)??0,warn_count:u(t.warn_count)??0,provenance:r(t.provenance)??null,top_item:q_(t.top_item)}:null}function U_(t){return m(t)?{count:u(t.count)??0,provenance:r(t.provenance)??null,top_action:F_(t.top_action)}:null}function H_(t){if(!m(t))return null;const e=r(t.label),n=r(t.reason),s=r(t.source),a=r(t.provenance);return!e||!n||!s||!a?null:{label:e,reason:n,source:s,provenance:a,target_kind:r(t.target_kind)??null,target_id:r(t.target_id)??null,suggested_tab:r(t.suggested_tab)??null,suggested_surface:r(t.suggested_surface)??null,suggested_params:m(t.suggested_params)?Object.fromEntries(Object.entries(t.suggested_params).map(([o,l])=>{const c=r(l);return c?[o,c]:null}).filter(o=>o!==null)):{}}}function W_(t){const e=m(t)?t:{},n=m(e.room)?e.room:{},s=m(e.execution)?e.execution:{},a=m(e.command)?e.command:{},o=m(e.operator)?e.operator:{};return{generated_at:r(e.generated_at),room:{status:w_(n.status),counts:m(n.counts)?{agents:u(n.counts.agents),tasks:u(n.counts.tasks),keepers:u(n.counts.keepers)}:void 0,provenance:r(n.provenance)??null},execution:{summary:O_(s.summary),top_queue:D_(s.top_queue),provenance:r(s.provenance)??null},command:{active_operations:u(a.active_operations),active_detachments:u(a.active_detachments),pending_approvals:u(a.pending_approvals),bad_alerts:u(a.bad_alerts),warn_alerts:u(a.warn_alerts),moving_lanes:u(a.moving_lanes),active_lanes:u(a.active_lanes),provenance:r(a.provenance)??null},operator:{health:r(o.health)??null,attention_summary:B_(o.attention_summary),recommendation_summary:U_(o.recommendation_summary),pending_confirm_summary:K_(o.pending_confirm_summary),provenance:r(o.provenance)??null},focus:H_(e.focus)}}async function ze(){fo.value=!0,xa.value=null;try{const t=await hp();er.value=W_(t)}catch(t){xa.value=t instanceof Error?t.message:"Failed to load room truth"}finally{fo.value=!1}}let aa=null;function G_(t){aa=t}let ia=null;function J_(t){ia=t}let oa=null;function V_(t){oa=t}const Ee={};let hi=null;function Ce(t,e,n=500){Ee[t]&&clearTimeout(Ee[t]),Ee[t]=setTimeout(()=>{e(),delete Ee[t]},n)}function Y_(){const t=mc.subscribe(e=>{if(e){if(e.type==="keeper_heartbeat"&&e.name){const n=new Map(po.value);n.set(e.name,e.ts_unix?e.ts_unix*1e3:Date.now()),po.value=n;return}(e.type==="agent_joined"||e.type==="agent_left")&&Ce("execution",Le),p_(e.type)&&(hi||(hi=setTimeout(()=>{ks(),ia==null||ia(),oa==null||oa(),hi=null},500))),(e.type.startsWith("task_")||e.type.startsWith("masc/task_"))&&Ce("execution",Le),e.type==="broadcast"&&Ce("execution",Le),(e.type==="keeper_handoff"||e.type==="keeper_compaction"||e.type==="keeper_guardrail")&&Ce("execution",Le),(e.type==="board_post"||e.type==="masc/board_post"||e.type==="board_comment"||e.type==="masc/board_comment")&&Ce("board",me),e.type.startsWith("decision_")&&Ce("governance",()=>aa==null?void 0:aa()),(e.type==="mdal_started"||e.type==="mdal_iteration"||e.type==="mdal_completed"||e.type==="mdal_stopped")&&Ce("mdal",Jc,350)}});return()=>{t();for(const e of Object.keys(Ee))clearTimeout(Ee[e]),delete Ee[e]}}let qn=null;function X_(){qn||(qn=setInterval(()=>{ge.value,ks()},1e4))}function Q_(){qn&&(clearInterval(qn),qn=null)}function Vc(t){if(!m(t))return null;const e=r(t.action_type),n=r(t.target_type);return!e||!n?null:{action_type:e,target_type:n,description:r(t.description),confirm_required:j(t.confirm_required)}}function Yc(t){if(!m(t))return null;const e=r(t.confirm_token)??r(t.token);return e?{confirm_token:e,actor:r(t.actor),action_type:r(t.action_type),target_type:r(t.target_type),target_id:r(t.target_id)??null,delegated_tool:r(t.delegated_tool),created_at:r(t.created_at),preview:t.preview}:null}function Xc(t){return m(t)?{actor_filter:r(t.actor_filter)??null,filter_active:j(t.filter_active)??!1,visible_count:u(t.visible_count)??0,total_count:u(t.total_count)??0,hidden_count:u(t.hidden_count)??0,hidden_actors:B(t.hidden_actors),confirm_required_actions:ct(t.confirm_required_actions).map(Vc).filter(e=>e!==null)}:null}function Z_(t){if(!m(t))return null;const e=ct(t.items,["confirms"]).map(Yc).filter(s=>s!==null),n=Xc(t.summary);return!n&&e.length===0?null:{items:e,summary:n??{actor_filter:null,filter_active:!1,visible_count:e.length,total_count:e.length,hidden_count:0,hidden_actors:[],confirm_required_actions:[]}}}function ai(t){var a,o,l,c;const e=(t==null?void 0:t.pending_confirm_envelope)??null,n=(e==null?void 0:e.items)??(t==null?void 0:t.pending_confirms)??[],s=(e==null?void 0:e.summary)??(t==null?void 0:t.pending_confirm_summary)??{actor_filter:null,filter_active:!1,visible_count:n.length,total_count:n.length,hidden_count:0,hidden_actors:[],confirm_required_actions:((a=t==null?void 0:t.available_actions)==null?void 0:a.filter(d=>d.confirm_required))??[]};return{items:n,summary:s,actor_filter:((o=s.actor_filter)==null?void 0:o.trim())||null,visible_count:s.visible_count??n.length,total_count:s.total_count??n.length,hidden_count:s.hidden_count??0,hidden_actors:s.hidden_actors??[],confirm_required_actions:(l=s.confirm_required_actions)!=null&&l.length?s.confirm_required_actions:((c=t==null?void 0:t.available_actions)==null?void 0:c.filter(d=>d.confirm_required))??[]}}const It=g(null),nr=g(null),Ht=g(null),Zn=g(!1),$e=g(null),ts=g(!1),hn=g(null),it=g(!1),Sa=g([]);let tv=1;function ev(t){return m(t)?{id:r(t.id),seq:u(t.seq),from:r(t.from)??r(t.from_agent)??"system",content:r(t.content)??"",timestamp:r(t.timestamp)??new Date().toISOString(),type:r(t.type)}:null}function nv(t){return m(t)?{room_id:r(t.room_id),current_room:r(t.current_room)??r(t.room),project:r(t.project),cluster:r(t.cluster),paused:j(t.paused),pause_reason:r(t.pause_reason)??null,paused_by:r(t.paused_by)??null,paused_at:r(t.paused_at)??null}:{}}function $l(t){if(!m(t))return;const e=Object.entries(t).map(([n,s])=>{const a=r(s);return a?[n,a]:null}).filter(n=>n!==null);return e.length>0?Object.fromEntries(e):void 0}function Qc(t){if(!m(t))return null;const e=r(t.kind),n=r(t.summary),s=r(t.target_type);return!e||!n||!s?null:{kind:e,severity:r(t.severity)??"warn",summary:n,target_type:s,target_id:r(t.target_id)??null,actor:r(t.actor)??null,evidence:t.evidence}}function Fn(t){if(!m(t))return null;const e=r(t.action_type),n=r(t.target_type),s=r(t.reason);return!e||!n||!s?null:{action_type:e,target_type:n,target_id:r(t.target_id)??null,severity:r(t.severity)??"warn",reason:s,confirm_required:j(t.confirm_required),suggested_payload:t.suggested_payload,preview:t.preview}}function Zc(t){return m(t)?{enabled:j(t.enabled),judge_online:j(t.judge_online),refreshing:j(t.refreshing),generated_at:r(t.generated_at)??null,expires_at:r(t.expires_at)??null,model_used:r(t.model_used)??null,keeper_name:r(t.keeper_name)??null,last_error:r(t.last_error)??null}:null}function yi(t){return m(t)?{summary:r(t.summary)??null,confidence:u(t.confidence)??null,provenance:r(t.provenance)??null,authoritative:j(t.authoritative),surface:r(t.surface)??null,fresh_until:r(t.fresh_until)??null,keeper_name:r(t.keeper_name)??null,fallback_used:j(t.fallback_used),disagreement_with_truth:j(t.disagreement_with_truth)}:null}function sv(t){return m(t)?{judgment_id:r(t.judgment_id)??void 0,surface:r(t.surface)??null,target_type:r(t.target_type)??null,target_id:r(t.target_id)??null,status:r(t.status)??null,summary:r(t.summary)??null,confidence:u(t.confidence)??null,generated_at:r(t.generated_at)??null,fresh_until:r(t.fresh_until)??null,keeper_name:r(t.keeper_name)??null,model_name:r(t.model_name)??null,runtime_name:r(t.runtime_name)??null,evidence_refs:B(t.evidence_refs),recommended_action:Fn(t.recommended_action),supersedes:B(t.supersedes),fallback_used:j(t.fallback_used),disagreement_with_truth:j(t.disagreement_with_truth),provenance:r(t.provenance)??null}:null}function av(t){return m(t)?{actor:r(t.actor)??null,spawn_agent:r(t.spawn_agent)??null,spawn_role:r(t.spawn_role)??null,spawn_model:r(t.spawn_model)??null,worker_class:r(t.worker_class)??null,parent_actor:r(t.parent_actor)??null,capsule_mode:r(t.capsule_mode)??null,runtime_pool:r(t.runtime_pool)??null,lane_id:r(t.lane_id)??null,controller_level:r(t.controller_level)??null,control_domain:r(t.control_domain)??null,supervisor_actor:r(t.supervisor_actor)??null,model_tier:r(t.model_tier)??null,task_profile:r(t.task_profile)??null,risk_level:r(t.risk_level)??null,routing_confidence:u(t.routing_confidence)??null,routing_reason:r(t.routing_reason)??null,status:r(t.status)??"unknown",turn_count:u(t.turn_count)??0,empty_note_turn_count:u(t.empty_note_turn_count)??0,has_turn:j(t.has_turn)??!1,last_turn_ts_iso:r(t.last_turn_ts_iso)??null}:null}function iv(t){if(!m(t))return null;const e=r(t.session_id);return e?{session_id:e,goal:r(t.goal),status:r(t.status),health:r(t.health),scale_profile:r(t.scale_profile),control_profile:r(t.control_profile),planned_worker_count:u(t.planned_worker_count),active_agent_count:u(t.active_agent_count),last_turn_age_sec:u(t.last_turn_age_sec)??null,attention_count:u(t.attention_count),recommended_action_count:u(t.recommended_action_count),top_attention:Qc(t.top_attention),top_recommendation:Fn(t.top_recommendation)}:null}function hl(t){if(!m(t))return null;const e=r(t.loop_id),n=r(t.status);return!e&&!n?null:{loop_id:e??null,session_id:r(t.session_id)??null,status:n??null,current_cycle:u(t.current_cycle)??void 0,best_score:u(t.best_score)??null,last_decision:r(t.last_decision)??null,target_file:r(t.target_file)??null,workdir:r(t.workdir)??null,source_workdir:r(t.source_workdir)??null,program_note:r(t.program_note)??null,operation_id:r(t.operation_id)??null,queued_hypothesis:r(t.queued_hypothesis)??null,warnings:ct(t.warnings).map(s=>typeof s=="string"?s.trim():"").filter(Boolean),error:r(t.error)??null}}function td(t){const e=m(t)?t:{};return{trace_id:r(e.trace_id),target_type:r(e.target_type)??"room",target_id:r(e.target_id)??null,health:r(e.health),judgment_owner:r(e.judgment_owner)??null,authoritative_judgment_available:j(e.authoritative_judgment_available),resident_judge_runtime:Zc(e.resident_judge_runtime),judgment:sv(e.judgment),active_guidance_layer:r(e.active_guidance_layer)??null,active_summary:yi(e.active_summary),active_recommended_actions:ct(e.active_recommended_actions).map(Fn).filter(n=>n!==null),active_recommendation_source:r(e.active_recommendation_source)??null,active_recommendation_summary:yi(e.active_recommendation_summary),fallback_recommended_actions:ct(e.fallback_recommended_actions).map(Fn).filter(n=>n!==null),recommendation_summary:yi(e.recommendation_summary),swarm_status:m(e.swarm_status)?e.swarm_status:void 0,attention_items:ct(e.attention_items).map(Qc).filter(n=>n!==null),recommended_actions:ct(e.recommended_actions).map(Fn).filter(n=>n!==null),session_cards:ct(e.session_cards).map(iv).filter(n=>n!==null),worker_cards:ct(e.worker_cards).map(av).filter(n=>n!==null)}}function ov(t){if(!m(t))return null;const e=m(t.status)?t.status:void 0,n=m(t.summary)?t.summary:m(e==null?void 0:e.summary)?e.summary:void 0,s=m(t.session)?t.session:m(e==null?void 0:e.session)?e.session:void 0,a=r(t.session_id)??r(n==null?void 0:n.session_id)??r(s==null?void 0:s.session_id);if(!a)return null;const o=$l(t.report_paths)??$l(e==null?void 0:e.report_paths),l=ct(t.recent_events,["events"]).filter(m);return{session_id:a,status:r(t.status)??r(n==null?void 0:n.status)??r(s==null?void 0:s.status),progress_pct:u(t.progress_pct)??u(n==null?void 0:n.progress_pct),elapsed_sec:u(t.elapsed_sec)??u(n==null?void 0:n.elapsed_sec),remaining_sec:u(t.remaining_sec)??u(n==null?void 0:n.remaining_sec),done_delta_total:u(t.done_delta_total)??u(n==null?void 0:n.done_delta_total),summary:n,team_health:m(t.team_health)?t.team_health:m(e==null?void 0:e.team_health)?e.team_health:void 0,communication_metrics:m(t.communication_metrics)?t.communication_metrics:m(e==null?void 0:e.communication_metrics)?e.communication_metrics:void 0,orchestration_state:m(t.orchestration_state)?t.orchestration_state:m(e==null?void 0:e.orchestration_state)?e.orchestration_state:void 0,cascade_metrics:m(t.cascade_metrics)?t.cascade_metrics:m(e==null?void 0:e.cascade_metrics)?e.cascade_metrics:void 0,report_paths:o,linked_autoresearch:hl(t.linked_autoresearch)??hl(e==null?void 0:e.linked_autoresearch)??null,session:s,recent_events:l}}function yl(t){if(!m(t))return null;const e=r(t.name);if(!e)return null;const n=m(t.context)?t.context:void 0;return{name:e,runtime_class:t.runtime_class==="persistent_agent"?"persistent_agent":"resident_keeper",desired:j(t.desired),resident_registered:j(t.resident_registered),agent_name:r(t.agent_name),status:r(t.status),autonomy_level:r(t.autonomy_level),context_ratio:u(t.context_ratio)??u(n==null?void 0:n.context_ratio),generation:u(t.generation),active_goal_ids:B(t.active_goal_ids),last_autonomous_action_at:r(t.last_autonomous_action_at)??null,last_turn_ago_s:u(t.last_turn_ago_s),model:r(t.model)??r(t.active_model)??r(t.primary_model)}}function rv(t){const e=m(t)?t:{},n=Z_(e.pending_confirm_envelope);return{room:nv(e.room),sessions:ct(e.sessions,["items","sessions"]).map(ov).filter(s=>s!==null),keepers:ct(e.keepers,["items","keepers"]).map(yl).filter(s=>s!==null),resident_judge_runtime:Zc(e.resident_judge_runtime),persistent_agents:ct(e.persistent_agents,["items","persistent_agents"]).map(yl).filter(s=>s!==null),recent_messages:ct(e.recent_messages,["messages"]).map(ev).filter(s=>s!==null),pending_confirms:(n==null?void 0:n.items)??ct(e.pending_confirms,["items","confirms"]).map(Yc).filter(s=>s!==null),pending_confirm_envelope:n??void 0,pending_confirm_summary:(n==null?void 0:n.summary)??Xc(e.pending_confirm_summary)??void 0,available_actions:ct(e.available_actions,["actions"]).map(Vc).filter(s=>s!==null)}}function ws(t){if(typeof t=="string")return t;if(t==null)return"";try{return JSON.stringify(t)}catch{return String(t)}}function bl(t){return t.target_id?`${t.target_type}:${t.target_id}`:t.target_type}function Ca(t){Sa.value=[{...t,id:tv++,at:new Date().toISOString()},...Sa.value].slice(0,20)}function ed(t){return t.confirm_required?ws(t.preview)||"Confirmation required":ws(t.result)||ws(t.executed_action)||ws(t.delegated_tool_result)||t.status}async function _t(){Zn.value=!0,$e.value=null;try{const t=await Lp();It.value=rv(t)}catch(t){$e.value=t instanceof Error?t.message:"Failed to load operator snapshot"}finally{Zn.value=!1}}async function qe(){ts.value=!0,hn.value=null;try{const t=await bc({targetType:"room"});nr.value=td(t)}catch(t){hn.value=t instanceof Error?t.message:"Failed to load operator digest"}finally{ts.value=!1}}async function he(t){if(!t){Ht.value=null;return}ts.value=!0,hn.value=null;try{const e=await bc({targetType:"team_session",targetId:t,includeWorkers:!0});Ht.value=td(e)}catch(e){hn.value=e instanceof Error?e.message:"Failed to load session digest"}finally{ts.value=!1}}async function nd(t){var e;it.value=!0,$e.value=null;try{const n=await bs(t);return Ca({actor:t.actor,action_type:t.action_type,target_label:bl(t),outcome:n.confirm_required?"preview":"executed",message:ed(n),delegated_tool:n.delegated_tool}),await _t(),await qe(),(e=Ht.value)!=null&&e.target_id&&await he(Ht.value.target_id),n}catch(n){const s=n instanceof Error?n.message:"Operator action failed";throw $e.value=s,Ca({actor:t.actor,action_type:t.action_type,target_label:bl(t),outcome:"error",message:s}),n}finally{it.value=!1}}async function sd(t,e,n="confirm"){var s;it.value=!0,$e.value=null;try{const a=await Fp(t,e,n);return Ca({actor:t,action_type:n,target_label:e,outcome:"confirmed",message:ed(a),delegated_tool:a.delegated_tool}),await _t(),await qe(),(s=Ht.value)!=null&&s.target_id&&await he(Ht.value.target_id),a}catch(a){const o=a instanceof Error?a.message:"Operator confirmation failed";throw $e.value=o,Ca({actor:t,action_type:"confirm",target_label:e,outcome:"error",message:o}),a}finally{it.value=!1}}V_(()=>{var t;_t(),qe(),(t=Ht.value)!=null&&t.target_id&&he(Ht.value.target_id)});const xs=g(null),go=g(!1),Aa=g(null),ad=g(null),Qe=g(!1),Re=g(null),$o=g(null),ra=g(!1),la=g(null);let un=null;function kl(){un!==null&&(window.clearTimeout(un),un=null)}function lv(t=1500){un===null&&(un=window.setTimeout(()=>{un=null,Ta(!1)},t))}function D(t){return typeof t=="object"&&t!==null&&!Array.isArray(t)}function b(t){return typeof t=="string"&&t.trim()!==""?t:void 0}function O(t){return typeof t=="number"&&Number.isFinite(t)?t:void 0}function pn(t){return typeof t=="boolean"?t:void 0}function J(t,e=[]){if(Array.isArray(t))return t;if(!D(t))return[];for(const n of e){const s=t[n];if(Array.isArray(s))return s}return[]}function Sn(t){if(!D(t))return null;const e=b(t.kind),n=b(t.summary),s=b(t.target_type);return!e||!n||!s?null:{kind:e,severity:b(t.severity)??"warn",summary:n,target_type:s,target_id:b(t.target_id)??null,actor:b(t.actor)??null,evidence:t.evidence}}function Be(t){if(!D(t))return null;const e=b(t.action_type),n=b(t.target_type),s=b(t.reason);return!e||!n||!s?null:{action_type:e,target_type:n,target_id:b(t.target_id)??null,severity:b(t.severity)??"warn",reason:s,confirm_required:pn(t.confirm_required),suggested_payload:t.suggested_payload,preview:t.preview}}function cv(t){if(!D(t))return null;const e=b(t.session_id);return e?{session_id:e,goal:b(t.goal),status:b(t.status),health:b(t.health),scale_profile:b(t.scale_profile),control_profile:b(t.control_profile),planned_worker_count:O(t.planned_worker_count),active_agent_count:O(t.active_agent_count),last_turn_age_sec:O(t.last_turn_age_sec)??null,attention_count:O(t.attention_count),recommended_action_count:O(t.recommended_action_count),top_attention:Sn(t.top_attention),top_recommendation:Be(t.top_recommendation)}:null}function dv(t){if(!D(t))return null;const e=b(t.session_id);if(!e)return null;const n=D(t.status)?t.status:t,s=D(n.summary)?n.summary:void 0;return{session_id:e,status:b(t.status)??b(s==null?void 0:s.status)??(D(n.session)?b(n.session.status):void 0),progress_pct:O(t.progress_pct)??O(s==null?void 0:s.progress_pct),elapsed_sec:O(t.elapsed_sec)??O(s==null?void 0:s.elapsed_sec),remaining_sec:O(t.remaining_sec)??O(s==null?void 0:s.remaining_sec),done_delta_total:O(t.done_delta_total)??O(s==null?void 0:s.done_delta_total),summary:D(t.summary)?t.summary:s,team_health:D(t.team_health)?t.team_health:D(n.team_health)?n.team_health:void 0,communication_metrics:D(t.communication_metrics)?t.communication_metrics:D(n.communication_metrics)?n.communication_metrics:void 0,orchestration_state:D(t.orchestration_state)?t.orchestration_state:D(n.orchestration_state)?n.orchestration_state:void 0,cascade_metrics:D(t.cascade_metrics)?t.cascade_metrics:D(n.cascade_metrics)?n.cascade_metrics:void 0,report_paths:D(t.report_paths)?Object.fromEntries(Object.entries(t.report_paths).map(([a,o])=>{const l=b(o);return l?[a,l]:null}).filter(a=>a!==null)):D(n.report_paths)?Object.fromEntries(Object.entries(n.report_paths).map(([a,o])=>{const l=b(o);return l?[a,l]:null}).filter(a=>a!==null)):void 0,session:D(t.session)?t.session:D(n.session)?n.session:void 0,recent_events:J(t.recent_events,["events"]).filter(D)}}function uv(t){if(!D(t))return null;const e=b(t.name);return e?{name:e,agent_name:b(t.agent_name),status:b(t.status),autonomy_level:b(t.autonomy_level),context_ratio:O(t.context_ratio),generation:O(t.generation),active_goal_ids:J(t.active_goal_ids).map(n=>typeof n=="string"?n.trim():"").filter(Boolean),last_autonomous_action_at:b(t.last_autonomous_action_at)??null,last_turn_ago_s:O(t.last_turn_ago_s),model:b(t.model)}:null}function pv(t){if(!D(t))return null;const e=b(t.confirm_token)??b(t.token);return e?{confirm_token:e,actor:b(t.actor),action_type:b(t.action_type),target_type:b(t.target_type),target_id:b(t.target_id)??null,delegated_tool:b(t.delegated_tool),created_at:b(t.created_at),preview:t.preview}:null}function mv(t){if(!D(t))return null;const e=b(t.action_type),n=b(t.target_type);return!e||!n?null:{action_type:e,target_type:n,description:b(t.description),confirm_required:pn(t.confirm_required)}}function _v(t){const e=D(t)?t:{};return{room_health:b(e.room_health),cluster:b(e.cluster),project:b(e.project),current_room:b(e.current_room)??b(e.room)??null,paused:pn(e.paused),tempo_interval_s:O(e.tempo_interval_s),active_agents:O(e.active_agents),keeper_pressure:O(e.keeper_pressure),active_operations:O(e.active_operations),pending_approvals:O(e.pending_approvals),incident_count:O(e.incident_count),recommended_action_count:O(e.recommended_action_count),top_attention:Sn(e.top_attention),top_action:Be(e.top_action)}}function vv(t){const e=D(t)?t:{},n=D(e.swarm_overview)?e.swarm_overview:{};return{health:b(e.health),active_operations:O(e.active_operations),pending_approvals:O(e.pending_approvals),swarm_overview:{active_lanes:O(n.active_lanes),moving_lanes:O(n.moving_lanes),stalled_lanes:O(n.stalled_lanes),projected_lanes:O(n.projected_lanes),last_movement_at:b(n.last_movement_at)??null},top_attention:Sn(e.top_attention),top_action:Be(e.top_action),session_cards:J(e.session_cards).map(cv).filter(s=>s!==null)}}function fv(t){const e=D(t)?t:{};return{sessions:J(e.sessions,["items"]).map(dv).filter(n=>n!==null),keepers:J(e.keepers,["items"]).map(uv).filter(n=>n!==null),pending_confirms:J(e.pending_confirms).map(pv).filter(n=>n!==null),available_actions:J(e.available_actions).map(mv).filter(n=>n!==null)}}function gv(t){if(!D(t))return null;const e=b(t.id),n=b(t.kind),s=b(t.summary),a=b(t.target_type);return!e||!n||!s||!a?null:{id:e,kind:n,severity:b(t.severity)??"warn",summary:s,target_type:a,target_id:b(t.target_id)??null,top_action:Be(t.top_action),related_session_ids:J(t.related_session_ids).map(o=>typeof o=="string"?o.trim():"").filter(Boolean),related_agent_names:J(t.related_agent_names).map(o=>typeof o=="string"?o.trim():"").filter(Boolean),evidence_preview:J(t.evidence_preview).map(o=>typeof o=="string"?o.trim():"").filter(Boolean),last_seen_at:b(t.last_seen_at)??null}}function id(t){if(!D(t))return null;const e=b(t.session_id),n=b(t.goal);return!e||!n?null:{session_id:e,goal:n,room:b(t.room)??null,status:b(t.status),health:b(t.health),member_names:J(t.member_names).map(s=>typeof s=="string"?s.trim():"").filter(Boolean),started_at:b(t.started_at)??null,elapsed_sec:O(t.elapsed_sec)??null,operation_id:b(t.operation_id)??null,blocker_summary:b(t.blocker_summary)??null,last_event_at:b(t.last_event_at)??null,last_event_summary:b(t.last_event_summary)??null,communication_summary:b(t.communication_summary)??null,active_count:O(t.active_count),seen_count:O(t.seen_count),planned_count:O(t.planned_count),required_count:O(t.required_count),counts_basis:b(t.counts_basis)??null,related_attention_count:O(t.related_attention_count)??0,top_attention:Sn(t.top_attention),top_recommendation:Be(t.top_recommendation)}}function od(t){if(!D(t))return null;const e=b(t.agent_name);return e?{agent_name:e,display_name:b(t.display_name)??null,is_live:typeof t.is_live=="boolean"?t.is_live:void 0,current_work:b(t.current_work)??null,recent_input_preview:b(t.recent_input_preview)??null,recent_output_preview:b(t.recent_output_preview)??null,recent_tool_names:J(t.recent_tool_names).map(n=>typeof n=="string"?n.trim():"").filter(Boolean),last_activity_at:b(t.last_activity_at)??null}:null}function rd(t){if(!D(t))return null;const e=b(t.operation_id);return e?{operation_id:e,status:b(t.status),stage:b(t.stage)??null,detachment_status:b(t.detachment_status)??null,objective:b(t.objective)??null,updated_at:b(t.updated_at)??null}:null}function ld(t){if(!D(t))return null;const e=b(t.name);return e?{name:e,agent_name:b(t.agent_name)??null,status:b(t.status),generation:O(t.generation),context_ratio:O(t.context_ratio)??null,last_turn_ago_s:O(t.last_turn_ago_s)??null,current_work:b(t.current_work)??null}:null}function cd(t){const e=id(t);return e?{...e,member_previews:J(D(t)?t.member_previews:void 0).map(od).filter(n=>n!==null),operation_badges:J(D(t)?t.operation_badges:void 0).map(rd).filter(n=>n!==null),keeper_refs:J(D(t)?t.keeper_refs:void 0).map(ld).filter(n=>n!==null)}:null}function $v(t){if(!D(t))return null;const e=b(t.agent_name);return e?{agent_name:e,display_name:b(t.display_name)??null,is_live:typeof t.is_live=="boolean"?t.is_live:void 0,archived_reason:b(t.archived_reason)??null,status:b(t.status),where:b(t.where)??null,with_whom:J(t.with_whom).map(n=>typeof n=="string"?n.trim():"").filter(Boolean),current_work:b(t.current_work)??null,related_session_id:b(t.related_session_id)??null,related_attention_count:O(t.related_attention_count)??0,last_activity_at:b(t.last_activity_at)??null,last_activity_age_sec:O(t.last_activity_age_sec)??null,signal_truth:b(t.signal_truth)==="live"||b(t.signal_truth)==="stale"||b(t.signal_truth)==="archived"||b(t.signal_truth)==="unknown"?b(t.signal_truth):void 0,evidence_source:b(t.evidence_source)==="message"||b(t.evidence_source)==="presence"||b(t.evidence_source)==="session"||b(t.evidence_source)==="none"?b(t.evidence_source):void 0,recent_output_preview:b(t.recent_output_preview)??null,recent_input_preview:b(t.recent_input_preview)??null,recent_tool_names:J(t.recent_tool_names).map(n=>typeof n=="string"?n.trim():"").filter(Boolean)}:null}function hv(t){if(!D(t))return null;const e=b(t.name);return e?{name:e,agent_name:b(t.agent_name)??null,status:b(t.status),generation:O(t.generation),context_ratio:O(t.context_ratio)??null,last_turn_ago_s:O(t.last_turn_ago_s)??null,current_work:b(t.current_work)??null,last_autonomous_action_at:b(t.last_autonomous_action_at)??null,allowed_tool_names:J(t.allowed_tool_names).map(n=>typeof n=="string"?n.trim():"").filter(Boolean),latest_tool_names:J(t.latest_tool_names).map(n=>typeof n=="string"?n.trim():"").filter(Boolean),latest_tool_call_count:O(t.latest_tool_call_count)??null,tool_audit_source:b(t.tool_audit_source)??null,tool_audit_at:b(t.tool_audit_at)??null}:null}function yv(t){if(!D(t))return null;const e=b(t.id),n=b(t.signal_type),s=b(t.summary),a=b(t.target_type);return!e||!n||!s||!a?null:{id:e,signal_type:n==="action"?"action":"attention",severity:b(t.severity)??"warn",summary:s,target_type:a,target_id:b(t.target_id)??null,attention:Sn(t.attention),action:Be(t.action)}}function bv(t){const e=D(t)?t:{},n=J(e.session_briefs).map(id).filter(a=>a!==null),s=J(e.sessions).map(cd).filter(a=>a!==null);return{generated_at:b(e.generated_at),summary:_v(e.summary),incidents:J(e.incidents).map(Sn).filter(a=>a!==null),recommended_actions:J(e.recommended_actions).map(Be).filter(a=>a!==null),command_focus:vv(e.command_focus),operator_targets:fv(e.operator_targets),attention_queue:J(e.attention_queue).map(gv).filter(a=>a!==null),sessions:s.length>0?s:n.map(a=>({...a,member_previews:[],operation_badges:[],keeper_refs:[]})),session_briefs:n,agent_briefs:J(e.agent_briefs).map($v).filter(a=>a!==null),keeper_briefs:J(e.keeper_briefs).map(hv).filter(a=>a!==null),internal_signals:J(e.internal_signals).map(yv).filter(a=>a!==null)}}function kv(t){if(!D(t))return null;const e=b(t.id),n=b(t.summary);return!e||!n?null:{id:e,timestamp:b(t.timestamp)??null,event_type:b(t.event_type),actor:b(t.actor)??null,summary:n}}function xv(t){const e=D(t)?t:{};return{generated_at:b(e.generated_at),session_id:b(e.session_id)??"",session:cd(e.session),timeline:J(e.timeline).map(kv).filter(n=>n!==null),participants:J(e.participants).map(od).filter(n=>n!==null),operations:J(e.operations).map(rd).filter(n=>n!==null),keepers:J(e.keepers).map(ld).filter(n=>n!==null),error:b(e.error)??null}}function Sv(t){if(!D(t))return null;const e=b(t.id),n=b(t.label),s=b(t.summary);if(!e||!n||!s)return null;const a=b(t.status)??"unclear";return{id:e,label:n,status:a==="ok"||a==="healthy"||a==="aligned"||a==="watch"||a==="risk"||a==="unclear"?a:"unclear",summary:s,signal_class:b(t.signal_class)==="metadata_gap"||b(t.signal_class)==="mixed"||b(t.signal_class)==="operational_risk"?b(t.signal_class):void 0,evidence_quality:b(t.evidence_quality)==="strong"||b(t.evidence_quality)==="partial"||b(t.evidence_quality)==="missing"?b(t.evidence_quality):void 0,evidence:J(t.evidence).map(l=>typeof l=="string"?l.trim():"").filter(Boolean)}}function Cv(t){if(!D(t))return null;const e=b(t.kind),n=b(t.summary),s=b(t.scope_type),a=b(t.severity);return!e||!n||!s||!a||s!=="session"&&s!=="keeper"&&s!=="agent"||a!=="info"&&a!=="watch"?null:{kind:e,summary:n,scope_type:s,scope_id:b(t.scope_id)??null,severity:a}}function Av(t){const e=D(t)?t:{},n=D(e.basis)?e.basis:{},s=b(e.status)??"error",a=s==="ok"||s==="pending"||s==="unavailable"||s==="error"?s:"error";return{generated_at:b(e.generated_at),cached:pn(e.cached),stale:pn(e.stale),refreshing:pn(e.refreshing),status:a,summary:b(e.summary)??null,model:b(e.model)??null,ttl_sec:O(e.ttl_sec),criteria:J(e.criteria).map(o=>typeof o=="string"?o.trim():"").filter(Boolean),basis:{current_room:b(n.current_room)??null,crew_count:O(n.crew_count),agent_count:O(n.agent_count),keeper_count:O(n.keeper_count)},metadata_gap_count:O(e.metadata_gap_count),metadata_gaps:J(e.metadata_gaps).map(Cv).filter(o=>o!==null),sections:J(e.sections).map(Sv).filter(o=>o!==null),error:b(e.error)??null,last_error:b(e.last_error)??null}}async function dd(){go.value=!0,Aa.value=null;try{const t=await Sp();xs.value=bv(t)}catch(t){Aa.value=t instanceof Error?t.message:"Failed to load mission snapshot"}finally{go.value=!1}}async function Tv(t){if(!t){$o.value=null,la.value=null,ra.value=!1;return}ra.value=!0,la.value=null;try{const e=await Cp(t);$o.value=xv(e)}catch(e){la.value=e instanceof Error?e.message:"Failed to load session detail"}finally{ra.value=!1}}async function Ta(t=!1){Qe.value=!0,Re.value=null;try{const e=await Ap(t),n=Av(e);ad.value=n,n.refreshing||n.status==="pending"?lv():kl()}catch(e){Re.value=e instanceof Error?e.message:"Failed to load mission briefing",kl()}finally{Qe.value=!1}}const ud=g(null),ho=g(!1),Ze=g(null);async function pd(t,e){ho.value=!0,Ze.value=null;try{ud.value=await Tp(t,e)}catch(n){Ze.value=n instanceof Error?n.message:String(n)}finally{ho.value=!1}}const sr=g(null),Jt=g(null),Ia=g(!1),Ra=g(!1),Ma=g(null),La=g(null),yo=g(null),za=g(null),V=g("warroom"),Ss=g(null),bo=g(!1),Ea=g(null),Ue=g(null),Pa=g(!1),Na=g(null),ar=g(null),ko=g(!1),ja=g(null),Cs=g(null),xo=g(!1),wa=g(null),es=g(null),Oa=g(!1),ns=g(null),mn=g(null);let Pn=null;function ir(t){return t!=="summary"&&t!=="swarm"&&t!=="warroom"&&t!=="orchestra"}function md(){if(typeof window>"u")return new URLSearchParams;const t=new URLSearchParams(window.location.search),e=window.location.hash.replace(/^#/,""),n=e.indexOf("?");return n>=0&&new URLSearchParams(e.slice(n+1)).forEach((a,o)=>{t.has(o)||t.set(o,a)}),t}function _d(){const e=md().get("run_id")??void 0;return e&&e.trim()!==""?e.trim():void 0}function vd(){const e=md().get("operation_id")??void 0;return e&&e.trim()!==""?e.trim():void 0}function Iv(t){if(m(t))return{policy_class:r(t.policy_class),approval_class:r(t.approval_class),tool_allowlist:B(t.tool_allowlist),model_allowlist:B(t.model_allowlist),requires_human_for:B(t.requires_human_for),autonomy_level:r(t.autonomy_level),escalation_timeout_sec:u(t.escalation_timeout_sec),kill_switch:j(t.kill_switch),frozen:j(t.frozen)}}function Rv(t){if(m(t))return{headcount_cap:u(t.headcount_cap),active_operation_cap:u(t.active_operation_cap),max_cost_usd:u(t.max_cost_usd),max_tokens:u(t.max_tokens)}}function or(t){if(!m(t))return null;const e=r(t.unit_id),n=r(t.label),s=r(t.kind);return!e||!n||!s?null:{unit_id:e,label:n,kind:s,parent_unit_id:r(t.parent_unit_id)??null,leader_id:r(t.leader_id)??null,roster:B(t.roster),capability_profile:B(t.capability_profile),source:r(t.source),created_at:r(t.created_at),updated_at:r(t.updated_at),policy:Iv(t.policy),budget:Rv(t.budget)}}function fd(t){if(!m(t))return null;const e=or(t.unit);return e?{unit:e,leader_status:r(t.leader_status),roster_total:u(t.roster_total),roster_live:u(t.roster_live),active_operation_count:u(t.active_operation_count),health:r(t.health),reasons:B(t.reasons),children:Array.isArray(t.children)?t.children.map(fd).filter(n=>n!==null):[]}:null}function Mv(t){if(m(t))return{total_units:u(t.total_units),company_count:u(t.company_count),platoon_count:u(t.platoon_count),squad_count:u(t.squad_count),leaf_agent_unit_count:u(t.leaf_agent_unit_count),live_agent_count:u(t.live_agent_count),managed_unit_count:u(t.managed_unit_count),active_operation_count:u(t.active_operation_count)}}function gd(t){const e=m(t)?t:{};return{version:r(e.version),generated_at:r(e.generated_at),source:r(e.source),summary:Mv(e.summary),units:Array.isArray(e.units)?e.units.map(fd).filter(n=>n!==null):[]}}function Lv(t){if(!m(t))return null;const e=r(t.kind),n=r(t.status);return!e||!n?null:{kind:e,chain_id:r(t.chain_id)??null,goal:r(t.goal)??null,run_id:r(t.run_id)??null,status:n,viewer_path:r(t.viewer_path)??null,last_sync_at:r(t.last_sync_at)??null}}function ii(t){if(!m(t))return null;const e=r(t.operation_id),n=r(t.objective),s=r(t.assigned_unit_id),a=r(t.trace_id),o=r(t.status);return!e||!n||!s||!a||!o?null:{operation_id:e,objective:n,assigned_unit_id:s,autonomy_level:r(t.autonomy_level),policy_class:r(t.policy_class),budget_class:r(t.budget_class),detachment_session_id:r(t.detachment_session_id)??null,trace_id:a,checkpoint_ref:r(t.checkpoint_ref)??null,active_goal_ids:B(t.active_goal_ids),note:r(t.note)??null,created_by:r(t.created_by),source:r(t.source),status:o,chain:Lv(t.chain),created_at:r(t.created_at),updated_at:r(t.updated_at)}}function zv(t){if(!m(t))return null;const e=ii(t.operation);return e?{operation:e,assigned_unit_label:r(t.assigned_unit_label)}:null}function Mn(t){if(m(t))return{tone:r(t.tone),pending_ops:u(t.pending_ops),blocked_ops:u(t.blocked_ops),in_flight_ops:u(t.in_flight_ops),pipeline_stalls:u(t.pipeline_stalls),bus_traffic:u(t.bus_traffic),l1_hit_rate:u(t.l1_hit_rate),invalidation_count:u(t.invalidation_count),current_pending:u(t.current_pending),current_in_flight:u(t.current_in_flight),cdb_wakeups:u(t.cdb_wakeups),total_stolen:u(t.total_stolen),avg_best_score:u(t.avg_best_score),avg_candidate_count:u(t.avg_candidate_count),best_first_operations:u(t.best_first_operations),active_sessions:u(t.active_sessions),commit_rate:u(t.commit_rate),total_speculations:u(t.total_speculations)}}function Ev(t){if(!m(t))return;const e=m(t.pipeline)?t.pipeline:void 0,n=m(t.cache)?t.cache:void 0,s=m(t.ooo)?t.ooo:void 0,a=m(t.speculative)?t.speculative:void 0,o=m(t.search_fabric)?t.search_fabric:void 0,l=m(t.signals)?t.signals:void 0;return{pipeline:e?{total_ops:u(e.total_ops),completed_ops:u(e.completed_ops),stalled_cycles:u(e.stalled_cycles),hazards_detected:u(e.hazards_detected),forwarding_used:u(e.forwarding_used),pipeline_flushes:u(e.pipeline_flushes),ipc:u(e.ipc)}:void 0,cache:n?{total_reads:u(n.total_reads),total_writes:u(n.total_writes),l1_hit_rate:u(n.l1_hit_rate),invalidation_count:u(n.invalidation_count),writeback_count:u(n.writeback_count),bus_traffic:u(n.bus_traffic)}:void 0,ooo:s?{agent_count:u(s.agent_count),total_added:u(s.total_added),total_issued:u(s.total_issued),total_completed:u(s.total_completed),total_stolen:u(s.total_stolen),cdb_wakeups:u(s.cdb_wakeups),stall_cycles:u(s.stall_cycles),global_cdb_events:u(s.global_cdb_events),current_pending:u(s.current_pending),current_in_flight:u(s.current_in_flight)}:void 0,speculative:a?{total_speculations:u(a.total_speculations),total_commits:u(a.total_commits),total_aborts:u(a.total_aborts),commit_rate:u(a.commit_rate),total_fast_calls:u(a.total_fast_calls),total_cost_usd:u(a.total_cost_usd),active_sessions:u(a.active_sessions)}:void 0,search_fabric:o?{total_operations:u(o.total_operations),best_first_operations:u(o.best_first_operations),legacy_operations:u(o.legacy_operations),blocked_operations:u(o.blocked_operations),ready_operations:u(o.ready_operations),research_pipeline_operations:u(o.research_pipeline_operations),avg_candidate_count:u(o.avg_candidate_count),avg_best_score:u(o.avg_best_score),top_stage:r(o.top_stage)??null}:void 0,signals:l?{issue_pressure:Mn(l.issue_pressure),cache_contention:Mn(l.cache_contention),scheduler_efficiency:Mn(l.scheduler_efficiency),routing_confidence:Mn(l.routing_confidence),speculative_posture:Mn(l.speculative_posture)}:void 0}}function $d(t){const e=m(t)?t:{},n=m(e.summary)?e.summary:void 0;return{version:r(e.version),generated_at:r(e.generated_at),summary:n?{total:u(n.total),active:u(n.active),paused:u(n.paused),managed:u(n.managed),projected:u(n.projected)}:void 0,microarch:Ev(e.microarch),operations:Array.isArray(e.operations)?e.operations.map(zv).filter(s=>s!==null):[]}}function hd(t){if(!m(t))return null;const e=r(t.detachment_id),n=r(t.operation_id),s=r(t.assigned_unit_id);return!e||!n||!s?null:{detachment_id:e,operation_id:n,assigned_unit_id:s,leader_id:r(t.leader_id)??null,roster:B(t.roster),session_id:r(t.session_id)??null,checkpoint_ref:r(t.checkpoint_ref)??null,runtime_kind:r(t.runtime_kind)??null,runtime_ref:r(t.runtime_ref)??null,source:r(t.source),status:r(t.status),last_event_at:r(t.last_event_at)??null,last_progress_at:r(t.last_progress_at)??null,heartbeat_deadline:r(t.heartbeat_deadline)??null,created_at:r(t.created_at),updated_at:r(t.updated_at)}}function Pv(t){if(!m(t))return null;const e=hd(t.detachment);return e?{detachment:e,assigned_unit_label:r(t.assigned_unit_label),operation:ii(t.operation)}:null}function yd(t){const e=m(t)?t:{},n=m(e.summary)?e.summary:void 0;return{version:r(e.version),generated_at:r(e.generated_at),summary:n?{total:u(n.total),active:u(n.active),projected:u(n.projected)}:void 0,detachments:Array.isArray(e.detachments)?e.detachments.map(Pv).filter(s=>s!==null):[]}}function Nv(t){if(!m(t))return null;const e=r(t.decision_id),n=r(t.trace_id),s=r(t.requested_action),a=r(t.scope_type),o=r(t.scope_id);return!e||!n||!s||!a||!o?null:{decision_id:e,trace_id:n,requested_action:s,scope_type:a,scope_id:o,operation_id:r(t.operation_id)??null,target_unit_id:r(t.target_unit_id)??null,requested_by:r(t.requested_by),status:r(t.status),reason:r(t.reason)??null,source:r(t.source),detail:t.detail,created_at:r(t.created_at),decided_at:r(t.decided_at)??null,expires_at:r(t.expires_at)??null}}function bd(t){const e=m(t)?t:{},n=m(e.summary)?e.summary:void 0;return{version:r(e.version),generated_at:r(e.generated_at),summary:n?{total:u(n.total),pending:u(n.pending),approved:u(n.approved),denied:u(n.denied)}:void 0,decisions:Array.isArray(e.decisions)?e.decisions.map(Nv).filter(s=>s!==null):[]}}function jv(t){if(!m(t))return null;const e=or(t.unit);return e?{unit:e,roster_total:u(t.roster_total),roster_live:u(t.roster_live),headcount_cap:u(t.headcount_cap),active_operations:u(t.active_operations),active_operation_cap:u(t.active_operation_cap),utilization:u(t.utilization)}:null}function wv(t){const e=m(t)?t:{};return{version:r(e.version),generated_at:r(e.generated_at),capacity:Array.isArray(e.capacity)?e.capacity.map(jv).filter(n=>n!==null):[]}}function Ov(t){if(!m(t))return null;const e=r(t.alert_id);return e?{alert_id:e,severity:r(t.severity),kind:r(t.kind),scope_type:r(t.scope_type),scope_id:r(t.scope_id),title:r(t.title),detail:r(t.detail),timestamp:r(t.timestamp)}:null}function kd(t){const e=m(t)?t:{},n=m(e.summary)?e.summary:void 0;return{version:r(e.version),generated_at:r(e.generated_at),summary:n?{total:u(n.total),bad:u(n.bad),warn:u(n.warn)}:void 0,alerts:Array.isArray(e.alerts)?e.alerts.map(Ov).filter(s=>s!==null):[]}}function xd(t){if(!m(t))return null;const e=r(t.event_id),n=r(t.trace_id),s=r(t.event_type);return!e||!n||!s?null:{event_id:e,trace_id:n,event_type:s,operation_id:r(t.operation_id)??null,unit_id:r(t.unit_id)??null,actor:r(t.actor)??null,source:r(t.source),timestamp:r(t.timestamp),detail:t.detail}}function Dv(t){const e=m(t)?t:{};return{version:r(e.version),generated_at:r(e.generated_at),events:Array.isArray(e.events)?e.events.map(xd).filter(n=>n!==null):[]}}function qv(t){if(!m(t))return null;const e=r(t.code),n=r(t.severity),s=r(t.summary);return!e||!n||!s?null:{code:e,severity:n,summary:s}}function Fv(t){if(!m(t))return null;const e=r(t.lane_id),n=r(t.label),s=r(t.kind),a=r(t.phase),o=r(t.motion_state),l=r(t.source_of_truth),c=r(t.movement_reason),d=r(t.current_step);if(!e||!n||!s||!a||!o||!l||!c||!d)return null;const p=m(t.counts)?t.counts:{};return{lane_id:e,label:n,kind:s,present:j(t.present)??!1,phase:a,motion_state:o,source_of_truth:l,last_movement_at:r(t.last_movement_at)??null,movement_reason:c,current_step:d,blockers:B(t.blockers),counts:{operations:u(p.operations),detachments:u(p.detachments),workers:u(p.workers),approvals:u(p.approvals),alerts:u(p.alerts)},hard_flags:Array.isArray(t.hard_flags)?t.hard_flags.map(qv).filter(_=>_!==null):[]}}function Kv(t){if(!m(t))return null;const e=r(t.event_id),n=r(t.lane_id),s=r(t.kind),a=r(t.timestamp),o=r(t.title),l=r(t.detail),c=r(t.tone),d=r(t.source);return!e||!n||!s||!a||!o||!l||!c||!d?null:{event_id:e,lane_id:n,kind:s,timestamp:a,title:o,detail:l,tone:c,source:d}}function Bv(t){if(!m(t))return null;const e=r(t.code),n=r(t.severity),s=r(t.summary);return!e||!n||!s?null:{code:e,severity:n,summary:s,why_it_matters:r(t.why_it_matters)??void 0,next_tool:r(t.next_tool)??void 0,next_step:r(t.next_step)??void 0,lane_ids:B(t.lane_ids),count:u(t.count)??0}}function rr(t){if(!m(t))return;const e=m(t.overview)?t.overview:{},n=m(t.gaps)?t.gaps:{},s=m(t.narrative)?t.narrative:{},a=m(t.recommended_next_action)?t.recommended_next_action:void 0;return{generated_at:r(t.generated_at),narrative:{state:r(s.state)??void 0,started:r(s.started)??void 0,active_work:r(s.active_work)??void 0,completion:r(s.completion)??void 0,lane_id:r(s.lane_id)??null},overview:{active_lanes:u(e.active_lanes),moving_lanes:u(e.moving_lanes),stalled_lanes:u(e.stalled_lanes),projected_lanes:u(e.projected_lanes),last_movement_at:r(e.last_movement_at)??null},lanes:Array.isArray(t.lanes)?t.lanes.map(Fv).filter(o=>o!==null):[],timeline:Array.isArray(t.timeline)?t.timeline.map(Kv).filter(o=>o!==null):[],gaps:{count:u(n.count),items:Array.isArray(n.items)?n.items.map(Bv).filter(o=>o!==null):[]},recommended_next_action:a?{tool:r(a.tool)??"masc_operator_snapshot",label:r(a.label)??"Observe operator state",reason:r(a.reason)??"",lane_id:r(a.lane_id)??null}:void 0}}function Sd(t){if(!m(t))return;const e=m(t.workers)?t.workers:{},n=j(t.pass);return{status:r(t.status)??"missing",source:r(t.source)??"none",reason_code:r(t.reason_code)??null,status_summary:r(t.status_summary)??null,run_id:r(t.run_id)??null,captured_at:r(t.captured_at)??null,...n!==void 0?{pass:n}:{},...u(t.peak_hot_slots)!=null?{peak_hot_slots:u(t.peak_hot_slots)}:{},...u(t.ctx_per_slot)!=null?{ctx_per_slot:u(t.ctx_per_slot)}:{},workers:{expected:u(e.expected),joined:u(e.joined),current_task_bound:u(e.current_task_bound),fresh_heartbeats:u(e.fresh_heartbeats),done:u(e.done),final:u(e.final)},expected_artifact_dir:r(t.expected_artifact_dir)??null,artifact_ref:r(t.artifact_ref)??null,missing_reason:r(t.missing_reason)??null}}function Uv(t){const e=m(t)?t:{};return{version:r(e.version),generated_at:r(e.generated_at),topology:gd(e.topology),operations:$d(e.operations),detachments:yd(e.detachments),alerts:kd(e.alerts),decisions:bd(e.decisions),capacity:wv(e.capacity),traces:Dv(e.traces),swarm_status:rr(e.swarm_status)}}function Hv(t){const e=m(t)?t:{},n=gd(e.topology),s=$d(e.operations),a=yd(e.detachments),o=kd(e.alerts),l=bd(e.decisions);return{version:r(e.version),generated_at:r(e.generated_at),topology:{version:n.version,generated_at:n.generated_at,source:n.source,summary:n.summary},operations:{version:s.version,generated_at:s.generated_at,summary:s.summary,microarch:s.microarch},detachments:{version:a.version,generated_at:a.generated_at,summary:a.summary},alerts:{version:o.version,generated_at:o.generated_at,summary:o.summary},decisions:{version:l.version,generated_at:l.generated_at,summary:l.summary},swarm_status:rr(e.swarm_status),swarm_proof:Sd(e.swarm_proof)}}function Wv(t){return m(t)?{chain_id:r(t.chain_id)??null,started_at:u(t.started_at)??null,progress:u(t.progress)??null,elapsed_sec:u(t.elapsed_sec)??null}:null}function Cd(t){if(!m(t))return null;const e=r(t.event);return e?{event:e,chain_id:r(t.chain_id)??null,timestamp:r(t.timestamp)??null,duration_ms:u(t.duration_ms)??null,message:r(t.message)??null,tokens:u(t.tokens)??null}:null}function Gv(t){if(!m(t))return null;const e=ii(t.operation);return e?{operation:e,runtime:Wv(t.runtime),history:Cd(t.history),mermaid:r(t.mermaid)??null,preview_run:Ad(t.preview_run)}:null}function Jv(t){const e=m(t)?t:{};return{status:r(e.status)??"disconnected",base_url:r(e.base_url)??null,message:r(e.message)??null}}function Vv(t){const e=m(t)?t:{},n=m(e.summary)?e.summary:void 0;return{version:r(e.version),generated_at:r(e.generated_at),connection:Jv(e.connection),summary:n?{linked_operations:u(n.linked_operations),active_chains:u(n.active_chains),running_operations:u(n.running_operations),recent_failures:u(n.recent_failures),last_history_event_at:r(n.last_history_event_at)??null}:void 0,operations:Array.isArray(e.operations)?e.operations.map(Gv).filter(s=>s!==null):[],recent_history:Array.isArray(e.recent_history)?e.recent_history.map(Cd).filter(s=>s!==null):[]}}function Yv(t){if(!m(t))return null;const e=r(t.id);return e?{id:e,type:r(t.type),status:r(t.status),duration_ms:u(t.duration_ms)??null,error:r(t.error)??null}:null}function Ad(t){if(!m(t))return null;const e=r(t.run_id),n=r(t.chain_id);return n?{run_id:e??null,chain_id:n,duration_ms:u(t.duration_ms),success:j(t.success),mermaid:r(t.mermaid),nodes:Array.isArray(t.nodes)?t.nodes.map(Yv).filter(s=>s!==null):[]}:null}function Xv(t){const e=m(t)?t:{};return{run:Ad(e.run)}}function Qv(t){if(!m(t))return null;const e=r(t.title),n=r(t.path);return!e||!n?null:{title:e,path:n}}function Zv(t){if(!m(t))return null;const e=r(t.id),n=r(t.title),s=r(t.summary);return!e||!n||!s?null:{id:e,title:n,summary:s}}function tf(t){if(!m(t))return null;const e=r(t.id),n=r(t.title),s=r(t.tool),a=r(t.summary);return!e||!n||!s||!a?null:{id:e,title:n,tool:s,summary:a,success_signals:B(t.success_signals),pitfalls:B(t.pitfalls)}}function ef(t){if(!m(t))return null;const e=r(t.id),n=r(t.title),s=r(t.summary),a=r(t.when_to_use);return!e||!n||!s||!a?null:{id:e,title:n,summary:s,when_to_use:a,steps:Array.isArray(t.steps)?t.steps.map(tf).filter(o=>o!==null):[]}}function nf(t){if(!m(t))return null;const e=r(t.id),n=r(t.title),s=r(t.description);return!e||!n||!s?null:{id:e,title:n,description:s,tools:B(t.tools)}}function sf(t){if(!m(t))return null;const e=r(t.id),n=r(t.title),s=r(t.symptom),a=r(t.why),o=r(t.fix_tool),l=r(t.fix_summary);return!e||!n||!s||!a||!o||!l?null:{id:e,title:n,symptom:s,why:a,fix_tool:o,fix_summary:l}}function af(t){if(!m(t))return null;const e=r(t.id),n=r(t.title),s=r(t.path_id),a=r(t.transport);return!e||!n||!s||!a?null:{id:e,title:n,path_id:s,transport:a,request:t.request,response:t.response,notes:B(t.notes)}}function of(t){const e=m(t)?t:{};return{version:r(e.version),generated_at:r(e.generated_at),docs:Array.isArray(e.docs)?e.docs.map(Qv).filter(n=>n!==null):[],concepts:Array.isArray(e.concepts)?e.concepts.map(Zv).filter(n=>n!==null):[],golden_paths:Array.isArray(e.golden_paths)?e.golden_paths.map(ef).filter(n=>n!==null):[],tool_groups:Array.isArray(e.tool_groups)?e.tool_groups.map(nf).filter(n=>n!==null):[],pitfalls:Array.isArray(e.pitfalls)?e.pitfalls.map(sf).filter(n=>n!==null):[],examples:Array.isArray(e.examples)?e.examples.map(af).filter(n=>n!==null):[]}}function rf(t){if(!m(t))return null;const e=r(t.id),n=r(t.title),s=r(t.status),a=r(t.detail),o=r(t.next_tool);return!e||!n||!s||!a||!o?null:{id:e,title:n,status:s,detail:a,next_tool:o}}function lf(t){if(!m(t))return null;const e=r(t.code),n=r(t.severity),s=r(t.title),a=r(t.detail),o=r(t.next_tool);return!e||!n||!s||!a||!o?null:{code:e,severity:n,title:s,detail:a,next_tool:o}}function cf(t){if(!m(t))return null;const e=r(t.from),n=r(t.content),s=r(t.timestamp),a=u(t.seq);return!e||!n||!s||a==null?null:{seq:a,from:e,content:n,timestamp:s}}function df(t){if(!m(t))return null;const e=r(t.name),n=r(t.role),s=r(t.lane),a=r(t.status),o=r(t.claim_marker),l=r(t.done_marker),c=r(t.final_marker);if(!e||!n||!s||!a||!o||!l||!c)return null;const d=(()=>{if(!m(t.last_message))return null;const p=u(t.last_message.seq),_=r(t.last_message.content),v=r(t.last_message.timestamp);return p==null||!_||!v?null:{seq:p,content:_,timestamp:v}})();return{name:e,role:n,lane:s,joined:j(t.joined)??!1,live_presence:j(t.live_presence)??!1,completed:j(t.completed)??!1,status:a,current_task:r(t.current_task)??null,bound_task_id:r(t.bound_task_id)??null,bound_task_title:r(t.bound_task_title)??null,bound_task_status:r(t.bound_task_status)??null,current_task_matches_run:j(t.current_task_matches_run)??!1,squad_member:j(t.squad_member)??!1,detachment_member:j(t.detachment_member)??!1,last_seen:r(t.last_seen)??null,heartbeat_age_sec:u(t.heartbeat_age_sec)??null,heartbeat_fresh:j(t.heartbeat_fresh)??!1,claim_marker_seen:j(t.claim_marker_seen)??!1,done_marker_seen:j(t.done_marker_seen)??!1,final_marker_seen:j(t.final_marker_seen)??!1,claim_marker:o,done_marker:l,final_marker:c,last_message:d}}function uf(t){if(!m(t))return;const e=Array.isArray(t.timeline)?t.timeline.map(n=>{if(!m(n))return null;const s=r(n.timestamp),a=u(n.active_slots);if(!s||a==null)return null;const o=Array.isArray(n.active_slot_ids)?n.active_slot_ids.map(l=>typeof l=="number"&&Number.isFinite(l)?l:null).filter(l=>l!=null):[];return{timestamp:s,active_slots:a,active_slot_ids:o}}).filter(n=>n!==null):[];return{slot_url:r(t.slot_url)??null,provider_base_url:r(t.provider_base_url)??null,provider_reachable:j(t.provider_reachable)??null,provider_status_code:u(t.provider_status_code)??null,provider_model_id:r(t.provider_model_id)??null,actual_model_id:r(t.actual_model_id)??null,expected_slots:u(t.expected_slots),actual_slots:u(t.actual_slots),expected_ctx:u(t.expected_ctx),actual_ctx:u(t.actual_ctx),configured_capacity:u(t.configured_capacity),slot_reachable:j(t.slot_reachable)??null,slot_status_code:u(t.slot_status_code)??null,runtime_blocker:r(t.runtime_blocker)??null,detail:r(t.detail)??null,checked_at:r(t.checked_at)??null,total_slots:u(t.total_slots),ctx_per_slot:u(t.ctx_per_slot),active_slots_now:u(t.active_slots_now),peak_active_slots:u(t.peak_active_slots),sample_count:u(t.sample_count),last_sample_at:r(t.last_sample_at)??null,timeline:e}}function pf(t){if(!m(t))return null;const e=r(t.run_id),n=r(t.status),s=r(t.decided_by),a=r(t.decided_at),o=r(t.reason);if(!e||!n||!s||!a||!o)return null;const l=[];return Array.isArray(t.history)&&t.history.forEach(c=>{if(!m(c))return;const d=r(c.status),p=r(c.decided_by),_=r(c.decided_at),v=r(c.reason);!d||!p||!_||!v||l.push({status:d,decided_by:p,decided_at:_,reason:v,operation_id:r(c.operation_id)??null,detachment_id:r(c.detachment_id)??null,note:r(c.note)??null})}),{run_id:e,status:n,decided_by:s,decided_at:a,reason:o,operation_id:r(t.operation_id)??null,detachment_id:r(t.detachment_id)??null,note:r(t.note)??null,history:l}}function mf(t){if(!m(t))return null;const e=r(t.run_id),n=r(t.recommended_kind),s=r(t.reason);return!e||!n||!s?null:{run_id:e,recommended_kind:n,continue_available:j(t.continue_available)??!1,rerun_available:j(t.rerun_available)??!1,abandon_available:j(t.abandon_available)??!1,reason:s,evidence:m(t.evidence)?{operation_id:r(t.evidence.operation_id)??null,detachment_id:r(t.evidence.detachment_id)??null,joined_workers:u(t.evidence.joined_workers),current_task_bound:u(t.evidence.current_task_bound),fresh_heartbeats:u(t.evidence.fresh_heartbeats),trace_events:u(t.evidence.trace_events),message_events:u(t.evidence.message_events),runtime_blocker:r(t.evidence.runtime_blocker)??null}:void 0,provenance:r(t.provenance),decision_engine:r(t.decision_engine),authoritative:j(t.authoritative)}}function _f(t){const e=m(t)?t:{},n=m(e.summary)?e.summary:void 0;return{version:r(e.version),generated_at:r(e.generated_at),run_id:r(e.run_id),room_id:r(e.room_id),operation_id:r(e.operation_id)??null,run_resolution:pf(e.run_resolution),resolution_recommendation:mf(e.resolution_recommendation),recommended_next_tool:r(e.recommended_next_tool),summary:n?{expected_workers:u(n.expected_workers),joined_workers:u(n.joined_workers),live_workers:u(n.live_workers),squad_roster_size:u(n.squad_roster_size),detachment_roster_size:u(n.detachment_roster_size),current_task_bound:u(n.current_task_bound),fresh_heartbeats:u(n.fresh_heartbeats),claim_markers_seen:u(n.claim_markers_seen),done_markers_seen:u(n.done_markers_seen),final_markers_seen:u(n.final_markers_seen),completed_workers:u(n.completed_workers),peak_hot_slots:u(n.peak_hot_slots),hot_window_ok:j(n.hot_window_ok),pass_hot_concurrency:j(n.pass_hot_concurrency),pass_end_to_end:j(n.pass_end_to_end),pending_decisions:u(n.pending_decisions),pass:j(n.pass)}:void 0,provider:uf(e.provider),operation:ii(e.operation),squad:or(e.squad),detachment:hd(e.detachment),workers:Array.isArray(e.workers)?e.workers.map(df).filter(s=>s!==null):[],checklist:Array.isArray(e.checklist)?e.checklist.map(rf).filter(s=>s!==null):[],blockers:Array.isArray(e.blockers)?e.blockers.map(lf).filter(s=>s!==null):[],recent_messages:Array.isArray(e.recent_messages)?e.recent_messages.map(cf).filter(s=>s!==null):[],recent_trace_events:Array.isArray(e.recent_trace_events)?e.recent_trace_events.map(xd).filter(s=>s!==null):[],truth_notes:B(e.truth_notes)}}function vf(t){if(!m(t))return null;const e=r(t.label),n=r(t.value);return!e||!n?null:{label:e,value:n}}function ff(t){if(!m(t))return null;const e=r(t.id),n=r(t.kind),s=r(t.label),a=r(t.tone),o=r(t.provenance);return!e||!n||!s||!a||!o?null:{id:e,kind:n,label:s,subtitle:r(t.subtitle)??null,status:r(t.status)??null,tone:a,pulse:r(t.pulse)??null,provenance:o,visual_class:r(t.visual_class)??void 0,glyph:r(t.glyph)??void 0,parent_id:r(t.parent_id)??null,lane_id:r(t.lane_id)??null,link_tab:r(t.link_tab)??null,link_surface:r(t.link_surface)??null,link_params:m(t.link_params)?Object.fromEntries(Object.entries(t.link_params).map(([l,c])=>{const d=r(c);return d?[l,d]:null}).filter(l=>l!==null)):{},facts:Array.isArray(t.facts)?t.facts.map(vf).filter(l=>l!==null):[]}}function gf(t){if(!m(t))return null;const e=r(t.id),n=r(t.source),s=r(t.target),a=r(t.kind),o=r(t.tone),l=r(t.provenance);return!e||!n||!s||!a||!o||!l?null:{id:e,source:n,target:s,kind:a,label:r(t.label)??null,tone:o,provenance:l,animated:j(t.animated)}}function $f(t){if(!m(t))return null;const e=r(t.id),n=r(t.kind),s=r(t.label),a=r(t.tone),o=r(t.provenance);return!e||!n||!s||!a||!o?null:{id:e,kind:n,label:s,detail:r(t.detail)??null,tone:a,provenance:o,source_id:r(t.source_id)??null,target_id:r(t.target_id)??null,suggested_surface:r(t.suggested_surface)??null,suggested_params:m(t.suggested_params)?Object.fromEntries(Object.entries(t.suggested_params).map(([l,c])=>{const d=r(c);return d?[l,d]:null}).filter(l=>l!==null)):{}}}function hf(t){if(!m(t))return null;const e=r(t.target_kind),n=r(t.target_id),s=r(t.label),a=r(t.reason);return!e||!n||!s||!a?null:{target_kind:e,target_id:n,label:s,reason:a,suggested_surface:r(t.suggested_surface)??null,suggested_params:m(t.suggested_params)?Object.fromEntries(Object.entries(t.suggested_params).map(([o,l])=>{const c=r(l);return c?[o,c]:null}).filter(o=>o!==null)):{}}}function yf(t){const e=m(t)?t:{},n=m(e.room)?e.room:{},s=m(e.summary)?e.summary:void 0;return{version:r(e.version),generated_at:r(e.generated_at),room:{room_id:r(n.room_id),project:r(n.project),cluster:r(n.cluster),paused:j(n.paused),pause_reason:r(n.pause_reason)??null,agent_count:u(n.agent_count),task_count:u(n.task_count),message_count:u(n.message_count)},summary:s?{session_count:u(s.session_count),operation_count:u(s.operation_count),detachment_count:u(s.detachment_count),lane_count:u(s.lane_count),worker_count:u(s.worker_count),keeper_count:u(s.keeper_count),signal_count:u(s.signal_count),alert_count:u(s.alert_count)}:void 0,nodes:Array.isArray(e.nodes)?e.nodes.map(ff).filter(a=>a!==null):[],edges:Array.isArray(e.edges)?e.edges.map(gf).filter(a=>a!==null):[],signals:Array.isArray(e.signals)?e.signals.map($f).filter(a=>a!==null):[],focus:hf(e.focus),swarm_status:rr(e.swarm_status),swarm_proof:Sd(e.swarm_proof),truth_notes:B(e.truth_notes)}}function Kt(t){V.value=t,ir(t)&&bf()}async function Td(){Ia.value=!0,Ma.value=null;try{const t=await Ep();sr.value=Hv(t)}catch(t){Ma.value=t instanceof Error?t.message:"Failed to load command-plane summary"}finally{Ia.value=!1}}function lr(t){mn.value=t}async function cr(){Ra.value=!0,La.value=null;try{const t=await zp();Jt.value=Uv(t)}catch(t){La.value=t instanceof Error?t.message:"Failed to load command-plane snapshot"}finally{Ra.value=!1}}async function bf(){Jt.value||Ra.value||await cr()}async function tn(){await Td(),ir(V.value)&&await cr()}async function Oe(){var t;xo.value=!0,wa.value=null;try{const e=await Pp(),n=Vv(e);Cs.value=n;const s=mn.value;n.operations.length===0?mn.value=null:(!s||!n.operations.some(a=>a.operation.operation_id===s))&&(mn.value=((t=n.operations[0])==null?void 0:t.operation.operation_id)??null)}catch(e){wa.value=e instanceof Error?e.message:"Failed to load chain summary"}finally{xo.value=!1}}function kf(){Pn=null,es.value=null,Oa.value=!1,ns.value=null}async function xf(t){Pn=t,Oa.value=!0,ns.value=null;try{const e=await Np(t);if(Pn!==t)return;es.value=Xv(e)}catch(e){if(Pn!==t)return;es.value=null,ns.value=e instanceof Error?e.message:"Failed to load chain run"}finally{Pn===t&&(Oa.value=!1)}}async function Sf(){bo.value=!0,Ea.value=null;try{const t=await jp();Ss.value=of(t)}catch(t){Ea.value=t instanceof Error?t.message:"Failed to load command-plane help"}finally{bo.value=!1}}async function Zt(t=_d(),e=vd()){Pa.value=!0,Na.value=null;try{const n=await wp(t,e);Ue.value=_f(n)}catch(n){Na.value=n instanceof Error?n.message:"Failed to load command-plane swarm view"}finally{Pa.value=!1}}async function Pe(t=_d(),e=vd()){ko.value=!0,ja.value=null;try{const n=await Op(t,e);ar.value=yf(n)}catch(n){ja.value=n instanceof Error?n.message:"Failed to load orchestra map"}finally{ko.value=!1}}async function ye(t,e,n){yo.value=t,za.value=null;try{await Dp(e,n),await Td(),(Jt.value||ir(V.value))&&await cr(),await Zt(),await Pe(),await Oe()}catch(s){throw za.value=s instanceof Error?s.message:"Failed to execute command-plane action",s}finally{yo.value=null}}function Cf(t){return ye(`pause:${t}`,"/api/v1/command-plane/operations/pause",{operation_id:t})}function Af(t){return ye(`resume:${t}`,"/api/v1/command-plane/operations/resume",{operation_id:t})}function Tf(t){return ye(`recall:${t}`,"/api/v1/command-plane/dispatch/recall",{operation_id:t})}function If(t={}){return ye("dispatch:tick","/api/v1/command-plane/dispatch/tick",{...t.operationId?{operation_id:t.operationId}:{},...t.detachmentId?{detachment_id:t.detachmentId}:{}})}function Rf(t){return ye(`approve:${t}`,"/api/v1/command-plane/policy/approve",{decision_id:t})}function Mf(t){return ye(`deny:${t}`,"/api/v1/command-plane/policy/deny",{decision_id:t})}function Lf(t,e){return ye(`freeze:${t}`,"/api/v1/command-plane/policy/freeze",{unit_id:t,enabled:e})}function zf(t,e){return ye(`kill:${t}`,"/api/v1/command-plane/policy/kill-switch",{unit_id:t,enabled:e})}J_(()=>{tn(),Oe(),(V.value==="swarm"||V.value==="warroom"||V.value==="orchestra"||Ue.value!==null)&&Zt(),(V.value==="orchestra"||ar.value!==null)&&Pe(),V.value==="warroom"&&_t()});function So(t){t==="command"&&(ze(),tn(),Oe(),(V.value==="swarm"||V.value==="warroom"||V.value==="orchestra")&&Zt(),V.value==="orchestra"&&Pe(),V.value==="warroom"&&_t()),t==="mission"&&(ze(),dd(),Ta()),t==="proof"&&pd(q.value.params.session_id,q.value.params.operation_id),t==="execution"&&(ze(),Le()),t==="intervene"&&(ze(),_t(),qe()),t==="memory"&&me(),t==="planning"&&tr(),t==="lab"&&_e()}function Ef({metric:t}){return i`
  ...
  `}function F({panelId:t,compact:e=!1,label:n="왜 필요한가"}){const s=N_(t);return s?i`
    <details class="semantic-inline ${e?"compact":""}">
      <summary class="semantic-summary">${n}</summary>
      <${Pf} panel=${s} />
    </details>
  `:ba.value?i`<span class="semantic-inline-state">의미 계층 불러오는 중…</span>`:null}function Tt({surfaceId:t,compact:e=!1}){const n=P_(t);return n?i`
  ...
  `}function Dd(t){const e=Date.now(),n=typeof t=="number"?t<1e12?t*1e3:t:new Date(t).getTime(),s=Math.floor((e-n)/1e3);if(s<60)return`${s}초 전`;const a=Math.floor(s/60);if(a<60)return`${a}분 전`;const o=Math.floor(a/60);return o<24?`${o}시간 전`:`${Math.floor(o/24)}일 전`}function X({timestamp:t}){const e=Dd(t),n=typeof t=="string"?t:new Date(t<1e12?t*1e3:t).toISOString();return i`<span class="time-ago" title=${n}>${e}</span>`}let rg=0;const je=g([]);function w(t,e="success",n=4e3){const s=++rg;je.value=[...je.value,{id:s,message:t,type:e}],setTimeout(()=>{je.value=je.value.filter(a=>a.id!==s)},n)}function lg(t){je.value=je.value.filter(e=>e.id!==t)}function cg(){const t=je.value;return t.length===0?null:i`
  ...
  `}function Al(t,e=160){const n=(t??"").replace(/\s+/g," ").trim();return n?n.length>e?`${n.slice(0,e-1)}…`:n:null}function hg(){const t=An.value;if(!t)return null;const e=mg(),n=_g(t),s=fg(t),a=vg(t),o=Fd(t),l=Ka.value,c=(a==null?void 0:a.display_name)??(n==null?void 0:n.name)??t,d=c!==t?t:null,p=(e==null?void 0:e.status)??(a==null?void 0:a.status)??"unknown",_=!e&&(a==null?void 0:a.is_live)===!1,v=(e==null?void 0:e.last_seen)??(a==null?void 0:a.last_activity_at)??null,f=(a==null?void 0:a.signal_truth)==="live"?"live":(a==null?void 0:a.signal_truth)==="stale"?"stale":(a==null?void 0:a.signal_truth)==="archived"?"archived":(a==null?void 0:a.signal_truth)==="unknown"?"unknown":null,h=(a==null?void 0:a.evidence_source)??null,I=(e==null?void 0:e.emoji)??(n==null?void 0:n.emoji),k=(e==null?void 0:e.koreanName)??(n==null?void 0:n.koreanName),C=Al(s==null?void 0:s.continuity_summary)??Al(s==null?void 0:s.skill_route_summary)??null,$=ug(n==null?void 0:n.name,n==null?void 0:n.agent_name);return i`
    <div
...
`).map(n=>n.trim()).filter(Boolean).map(n=>{const s=e.find(a=>n.startsWith(`${a}:`));return s?{label:s,value:n.slice(s.length+1).trim()}:null}).filter(n=>!!(n&&n.value))}function Ag(t){var e;return[t.modelUsed?{label:"Model",value:t.modelUsed}:null,typeof t.latencyMs=="number"?{label:"Latency",value:`${t.latencyMs} ms`}:null,typeof((e=t.usage)==null?void 0:e.totalTokens)=="number"?{label:"Tokens",value:`${t.usage.totalTokens}`}:null,Tl(t.costUsd)?{label:"Cost",value:Tl(t.costUsd)}:null,t.traceId?{label:"Trace",value:t.traceId}:null,typeof t.generation=="number"?{label:"Generation",value:`${t.generation}`}:null].filter(n=>!!n)}function Tg({entry:t}){var p;const[e,n]=$n(!1),[s,a]=$n(!1),o=Sg(t.details),l=!!t.details,c=t.details?Ag(t.details):[],d=Cg((p=t.details)==null?void 0:p.stateBlock);return i`
  ...
  `}function Mg(t){switch(t){case"quiet_hours":return"quiet hours";case"min_gap":return"cooldown gate";case"no_recent_activity":return"waiting for activity";case"disabled":return"runtime disabled";case"startup":return"warming up";case"llm_error":return"llm error";case"graphql_error":return"graphql error";case"never_started":return"never started";default:return"unknown"}}function Lg(t){switch(t){case"manual_lodge_poke":return"Run Social Sweep";case"probe":return"Probe";case"recover":return"Recover";default:return"Message"}}function Il(t){switch(t){case"healthy":return"정상";case"recovering":return"복구 중";case"desired_offline":return"의도적 오프라인";case"offline":return"오프라인";default:return null}}function zg(t){if(!t)return null;const e=new Date(t);return Number.isNaN(e.getTime())?null:e.toLocaleTimeString()}function Eg(t){return typeof t!="number"||!Number.isFinite(t)||t<=0?null:t<60?`${Math.round(t)}s`:`${Math.ceil(t/60)}m`}function Bd(t){if(!t)return null;const e=ne.value[t.name];return(e==null?void 0:e.diagnostic)??t.diagnostic??null}function Pg({keeper:t,showRawStatus:e=!1}){if(et(()=>{t!=null&&t.name&&Lc(t.name)},[t==null?void 0:t.name]),!t)return i`<div class="control-status-copy">Select a keeper to inspect direct reply state.</div>`;const n=ne.value[t.name],s=Bd(t),a=ro.value[t.name];return i`
    <div class="control-result-box">
      ...
      <div class="control-status-copy">
        ...
        ${s!=null&&s.last_reply_at?i` · ${zg(s.last_reply_at)}`:null}
  ...
  `}function Ud({keeperName:t,placeholder:e}){const[n,s]=$n("");et(()=>{t&&Lc(t)},[t]);const a=gt.value[t]??[],o=$a.value[t]??!1,l=Bt.value[t],c=async()=>{const d=n.trim();if(!(!t||!d)){s("");try{await Gm(t,d)}catch(p){if(p instanceof Error&&p.name==="AbortError")return;const _=p instanceof Error?p.message:`Failed to message ${t}`;w(_,"error")}}};return i`
  ...
  `}function Ng({actor:t,keeper:e,onPokeLodge:n}){if(!e)return null;const s=Bd(e),a=lo.value[e.name]??!1,o=co.value[e.name]??!1,l=(s==null?void 0:s.next_action_path)??"direct_message",c=(s==null?void 0:s.recoverable)??l==="recover";return i`
    <div class="control-actions">
      <button
        ...
        onClick=${()=>{Jm(e.name,t).catch(d=>{const p=d instanceof Error?d.message:`Failed to probe ${e.name}`;w(p,"error")})}}
        disabled=${a||!t.trim()}
      >
        ${a?"Probing...":"Probe"}
      </button>
      <button
        ...
        onClick=${()=>{Vm(e.name,t).catch(d=>{const p=d instanceof Error?d.message:`Failed to recover ${e.name}`;w(p,"error")})}}
        disabled=${o||!c||!t.trim()}
      >
  ...
  `}function Vg({keeper:t}){var U,tt,Q,Z,W,M,S;const e=((U=It.value)==null?void 0:U.room)??{},n=(((tt=It.value)==null?void 0:tt.available_actions)??[]).filter(E=>E.target_type==="keeper"||E.target_type==="room").slice(0,8),s=Dg(t),a=qg(t),o=Fg(t),l=o!=null&&o.allowed_tool_names&&o.allowed_tool_names.length>0?o.allowed_tool_names:t.allowed_tool_names??[],c=o!=null&&o.latest_tool_names&&o.latest_tool_names.length>0?o.latest_tool_names:t.latest_tool_names??[],d=(o==null?void 0:o.latest_tool_call_count)??t.latest_tool_call_count,p=(o==null?void 0:o.tool_audit_source)??t.tool_audit_source,_=(o==null?void 0:o.tool_audit_at)??t.tool_audit_at,v=((Q=t.agent)==null?void 0:Q.capabilities)??[],f=e.current_room??e.room_id??((Z=dt.value)==null?void 0:Z.room)??"default",h=e.project??((W=dt.value)==null?void 0:W.project)??"확인 없음",I=e.cluster??((M=dt.value)==null?void 0:M.cluster)??"확인 없음",k=Nn(tg(t)),C=Nn(eg(t,p)),$=Nn(ng(t,p)),y=Nn(Od(t)),x=Ts(t),R=((S=t.agent)==null?void 0:S.current_task)??(x==="offline"?"offline":"not_collected"),A=t.skill_primary??(x==="offline"?"offline":"not_collected"),L=l[0]??c[0]??s[0]??null;return i`
    <div class="keeper-signal-list">
      ...
      <div style="display:flex; justify-content:flex-end; margin-top:4px;">
        <button class="control-btn ghost" onClick=${()=>{sg(L)}}>
          Open tools panel
        </button>
      </div>
  ...
  `}function Wd(){const t=new URLSearchParams(window.location.search),e=t.get("agent")??t.get("agent_name"),n=localStorage.getItem("masc_dashboard_agent_name");return(e??n??"dashboard").trim()||"dashboard"}async function Yg(){try{const t=await bs({actor:Wd(),action_type:"social_sweep",target_type:"room",payload:{}}),e=Ic(t.result);await ks();const n=(e==null?void 0:e.last_system_skip_reason)??(e==null?void 0:e.skipped_reason);n?w(n,"warning"):w(e?`Social sweep finished: ${e.acted}/${e.checked} acted`:"Social sweep finished",e&&e.acted>0?"success":"warning")}catch(t){const e=t instanceof Error?t.message:"Failed to run social sweep";w(e,"error")}}function Xg({keeper:t}){return i`
  ...
  `}function t$(){const t=ad.value,e=$t((t==null?void 0:t.status)??(Re.value?"bad":"warn")),n=!t||t.sections.length===0,s=(t==null?void 0:t.status)==="error"||(t==null?void 0:t.status)==="unavailable"&&!(t!=null&&t.cached);return i`
    <${z} title="판단 레이어" class="mission-briefing-card" semanticId="mission.llm_briefing">
      ...
      <div class="mission-briefing-meta">
        <span class="command-chip ${e}">
          ${Pt((t==null?void 0:t.status)??(Re.value?"error":"loading"))}
        </span>
                ...
                <article class="mission-briefing-section ${$t(a.status)}">
                  <div class="mission-card-head">
                    ...
                    <div class="mission-briefing-section-chips">
                      <span class="command-chip ${$t(a.status)}">${Pt(a.status)}</span>
    ...
    <article class="mission-attention-card ${$t((o==null?void 0:o.severity)??t.severity)} ${e?"is-selected":""}">
      <button class="mission-card-select" onClick=${()=>Qf(t.id)}>
        <div class="mission-card-head">
          ...
          <span class="command-chip ${$t((o==null?void 0:o.severity)??t.severity)}">${o?Gf(o):t.severity}</span>
        </div>
      ...
      <div class="mission-card-actions">
        ${o?i`
            ...
            `:i`
              <button class="control-btn ghost" onClick=${()=>Pd(s)}>이 이슈로 개입 열기</button>
    ...
    <article class="mission-crew-card ${$t(((d=t.top_attention)==null?void 0:d.severity)??t.health??t.status)} ${e?"is-selected":""}">
      <button class="mission-card-select" onClick=${()=>wd(t.session_id)}>
        <div class="mission-card-head">
          ...
          <span class="command-chip ${$t(((p=t.top_attention)==null?void 0:p.severity)??t.health??t.status)}">${Pt(t.status)}</span>
        </div>
            ...
            <div class="mission-pill-row">
              ${t.operation_badges.slice(0,3).map(_=>i`
                <span class="mission-pill">
                  ${_.operation_id} · ${Pt(_.status)}${_.stage?` · ${_.stage}`:""}
                </span>
              `)}
            </div>
          `:null}
    ...
    <article class="mission-activity-card ${$t(t.brief.status??((o=t.keeper)==null?void 0:o.status))}">
      <button class="mission-card-select" onClick=${()=>{t.keeper&&Hd(t.keeper)}}>
        <div class="mission-activity-head">
          ...
          <span class="command-chip ${$t(t.brief.status??((d=t.keeper)==null?void 0:d.status))}">${Pt(t.brief.status??((p=t.keeper)==null?void 0:p.status))}</span>
        </div>
    ...
    <article class="mission-action-card ${$t(t.severity)}">
      ...
      <div class="mission-card-actions">
        ${e?i`
            ...
            `:n?i`
                <button class="control-btn ghost" onClick=${()=>Pd(n)}>이 이슈로 개입 열기</button>
                <button class="control-btn ghost" onClick=${()=>Nd(n)}>이 이슈의 원인 보기</button>
              `:null}
      </div>
    </article>
  `}function Ll(){var C,$,y;const t=xs.value;if(go.value&&!t)return i`<div class="loading-indicator">상황판 스냅샷 불러오는 중...</div>`;if(Aa.value&&!t)return i`<div class="empty-state error">${Aa.value}</div>`;if(!t)return i`<div class="empty-state">상황판 스냅샷이 아직 없습니다.</div>`;te.value&&!t.attention_queue.some(x=>x.id===te.value)&&(te.value=null);const e=t.sessions;ce.value&&!e.some(x=>x.session_id===ce.value)&&(ce.value=null);const n=t.attention_queue.find(x=>x.id===te.value)??null,s=(n==null?void 0:n.related_session_ids.find(x=>e.some(R=>R.session_id===x)))??null,a=ce.value??s??((C=e[0])==null?void 0:C.session_id)??null,o=Xf(),l=e.find(x=>x.session_id===a)??null,c=t.keeper_briefs.slice(0,6).map(Yf),d=t.attention_queue.filter(x=>x.related_session_ids.length>0).slice(0,6),p=t.internal_signals.slice(0,3),_=e.filter(x=>{var A;const R=((A=x.top_attention)==null?void 0:A.severity)??x.health??x.status;return $t(R)!=="ok"||!!x.blocker_summary}).length,v=e.filter(x=>x.last_event_summary||x.last_event_at).length,f=new Set(e.flatMap(x=>x.member_names)).size,h=e.flatMap(x=>x.member_previews??[]).filter(x=>x.recent_output_preview).length+c.filter(x=>x.recentOutput).length,I=((l==null?void 0:l.member_previews)??[]).filter(x=>x.recent_output_preview),k=c.filter(x=>x.recentOutput).slice(0,4);return et(()=>{Tv(a)},[a]),i`
    <section class="dashboard-panel mission-view">
      ...
      <div class="panel-header">
        ...
        <div class="mission-header-meta">
          <span class="command-chip ${$t(t.summary.room_health)}">${Pt(t.summary.room_health)}</span>
      ...
      <${z} title="진행중인 세션" class="mission-list-card" semanticId="mission.session_briefs">
        ...
        <div class="mission-list-stack">
          ${e.length>0?e.map(x=>i`<${n$} key=${x.session_id} brief=${x} selected=${a===x.session_id} />`):i`<div class="empty-state">지금 활성 세션이 없습니다.</div>`}
        </div>
      <//>
      ...
      <${z} title="키퍼 연속성" class="mission-list-card" semanticId="mission.keeper_activity">
        ...
        <div class="mission-activity-list">
          ${c.length>0?c.map(x=>i`<${a$} key=${x.brief.name} row=${x} />`):i`<div class="empty-state">지금 보이는 키퍼가 없습니다.</div>`}
        </div>
        <div class="mission-card-actions">
      ...
      <${z} title="세션 우선순위" class="mission-list-card" semanticId="mission.attention_queue">
        ...
        <div class="mission-lane-stack">
          ${d.length>0?d.map(x=>i`<${e$} key=${x.id} item=${x} selected=${te.value===x.id} sessionLookup=${o} />`):i`<div class="empty-state">지금 세션 단위 주의 대기열은 비어 있습니다.</div>`}
        </div>
      <//>
  ...
  `}function Y$(){var W,M,S;const t=q.value.params,e=t.session_id??null,n=t.operation_id??null;et(()=>{pd(e,n)},[e,n]);const s=ud.value;if(ho.value&&!s)return i`<section class="dashboard-panel"><div class="loading-indicator">근거 화면 불러오는 중…</div></section>`;if(Ze.value&&!s)return i`<section class="dashboard-panel"><div class="error-card">${Ze.value}</div></section>`;const a=s==null?void 0:s.summary,o=(s==null?void 0:s.selection)??null,l=nn(s==null?void 0:s.actor_contributions),c=nn(s==null?void 0:s.artifacts),d=nn(s==null?void 0:s.tool_evidence),p=(s==null?void 0:s.proof_verdict)??"insufficient",_=(a==null?void 0:a.live_verdict)??p,v=(a==null?void 0:a.historical_verdict)??null,f=(a==null?void 0:a.verdict_basis)??"live",h=(s==null?void 0:s.cp_backing_evidence)??null,I=Array.isArray((W=h==null?void 0:h.traces)==null?void 0:W.events)?((S=(M=h.traces)==null?void 0:M.events)==null?void 0:S.length)??0:0,k=(a==null?void 0:a.actors_count)??l.length,C=(a==null?void 0:a.planned_actor_count)??l.length,$=(a==null?void 0:a.unanswered_actor_count)??l.filter(E=>E.activity_state!=="acted"&&(E.mention_count??0)>0).length,y=(a==null?void 0:a.mentioned_actor_count)??l.filter(E=>(E.mention_count??0)>0).length,x=(a==null?void 0:a.interaction_count)??0,R=(a==null?void 0:a.evidence_count)??0,A=B$(nn(s==null?void 0:s.timeline)),L=H$(wt(s==null?void 0:s.goal_binding)),U=W$(h),tt=c.filter(E=>E.exists).length,Q=c.length-tt,Z=N$(p,_,v,k,C,$,x,R,I);return i`
    <section class="dashboard-panel mission-view">
      <${Tt} surfaceId="proof" />
      <div class="panel-header">
        <div>
        ...
        <div class="mission-header-meta">
          <span class="command-chip ${Ln(p)}">${E$(p)}</span>
      ...
      <div class="mission-human-grid">
        <${z} title="협업 타임라인" class="mission-list-card" semanticId="proof.timeline">
          ...
          <div class="mission-list-stack">
            ${A.length>0?A.slice(0,18).map(E=>i`<${G$} key=${E.id} item=${E} />`):i`<div class="empty-state">표시할 타임라인 근거가 없습니다.</div>`}
          </div>
        <//>
      ...
      <div class="mission-human-grid">
        <${z} title="도구 근거" class="mission-list-card" semanticId="proof.tool_evidence">
          ...
          <div class="mission-list-stack">
            ${d.length>0?d.map((E,G)=>i`<${K$} key=${`${E.actor??"system"}-${G}`} item=${E} />`):i`<div class="empty-state">기록된 tool evidence가 없습니다.</div>`}
          </div>
        <//>
  ...
  `}function Q$(){const t=As(q.value);return t?i`
  ...
  `}function qs({label:t,value:e,detail:n,percent:s,tone:a}){return i`
    <article class="command-signal-rail ${P(a)}">
      ...
      <div class="command-signal-bar">
        <span class="${P(a)}" style=${`width: ${Math.max(8,Math.round(Rs(s)))}%`}></span>
      </div>
      <small>${n}</small>
    </article>
  `}function th(){var Q,Z,W,M;const t=Ls(),e=t==null?void 0:t.topology.summary,n=t==null?void 0:t.operations.summary,s=t==null?void 0:t.detachments.summary,a=t==null?void 0:t.decisions.summary,o=t==null?void 0:t.alerts.summary,l=(Q=t==null?void 0:t.swarm_status)==null?void 0:Q.overview,c=t==null?void 0:t.swarm_proof,d=t==null?void 0:t.operations.microarch,p=(e==null?void 0:e.managed_unit_count)??0,_=(e==null?void 0:e.total_units)??0,v=(n==null?void 0:n.active)??0,f=(s==null?void 0:s.active)??0,h=(l==null?void 0:l.moving_lanes)??0,I=(l==null?void 0:l.active_lanes)??0,k=(c==null?void 0:c.workers.done)??0,C=(c==null?void 0:c.workers.expected)??0,$=(o==null?void 0:o.bad)??0,y=(o==null?void 0:o.warn)??0,x=(a==null?void 0:a.pending)??0,R=(a==null?void 0:a.total)??0,A=v+f,L=((Z=d==null?void 0:d.cache)==null?void 0:Z.l1_hit_rate)??((M=(W=d==null?void 0:d.signals)==null?void 0:W.cache_contention)==null?void 0:M.l1_hit_rate)??0,U=v>0||f>0?"지휘면이 실제로 움직이고 있습니다":"계층은 준비됐지만 실행은 아직 잠복 상태입니다",tt=v>0||h>0?"무거운 상세 탭으로 들어가기 전에, 여기서 먼저 압력과 이동감, 운영 부채를 읽을 수 있어야 합니다.":"이 화면은 체크리스트보다 계기판에 가까워야 합니다. 아래 게이지가 지금 어디가 살아 있는지 먼저 보여줍니다.";return i`
    <section class="command-hero command-hero-summary">
      <div class="command-hero-copy">
        ...
        <span class="command-chip ${P(v>0?"ok":"warn")}">활성 작전 ${v}</span>
          <span class="command-chip ${P(h>0?"ok":(I>0,"warn"))}">이동 레인 ${h}/${Math.max(I,h)}</span>
  ...
  `}function nh(){var Q,Z,W,M,S,E,G,yt,ie;const t=Ls(),e=Jt.value,n=dt.value,s=Vd(),a=s?Gt.value.find(H=>H.name===s)??null:null,o=s?ue.value.filter(H=>H.assignee===s&&C$(H)):[],l=((Q=t==null?void 0:t.operations.summary)==null?void 0:Q.active)??0,c=((Z=t==null?void 0:t.detachments.summary)==null?void 0:Z.total)??0,d=((W=t==null?void 0:t.decisions.summary)==null?void 0:W.pending)??0,p=e==null?void 0:e.detachments.detachments.find(H=>{const vt=H.detachment.heartbeat_deadline,ke=vt?Date.parse(vt):Number.NaN;return H.detachment.status==="stalled"||!Number.isNaN(ke)&&ke<=Date.now()}),_=e==null?void 0:e.alerts.alerts.find(H=>H.severity==="bad"),v=!!(n!=null&&n.room||n!=null&&n.project),f=(a==null?void 0:a.current_task)??null,h=S$(a==null?void 0:a.last_seen),I=h!=null?h<=120:null,k=[v?{title:"Room 준비도",tone:"ok",detail:`${(n==null?void 0:n.room)??(n==null?void 0:n.project)??"unknown"} · base ${(n==null?void 0:n.room_base_path)??"n/a"}`,tool:"masc_status"}:{title:"Room 준비도",tone:"bad",detail:"아직 room snapshot이 없습니다. 조인 전에 room을 repo root로 맞추세요.",tool:"masc_set_room"},s?a?o.length===0?{title:"Task 준비도",tone:"warn",detail:`${s} 에게 배정된 claimed task가 없습니다. 먼저 claim 하거나 만들어야 합니다.`,tool:ue.value.length>0?"masc_claim":"masc_add_task"}:f?I===!1?{title:"Task 준비도",tone:"warn",detail:`${s} current_task=${f} 이지만 heartbeat가 stale 합니다 (${h}s).`,tool:"masc_heartbeat"}:{title:"Task 준비도",tone:"ok",detail:`${s} current_task=${f}${h!=null?` · 마지막 활동 ${h}s 전`:""}`,tool:"masc_plan_get_task"}:{title:"Task 준비도",tone:"bad",detail:`${s} 에 claimed task는 있지만 session current_task binding이 없습니다.`,tool:"masc_plan_set_task"}:{title:"Task 준비도",tone:"bad",detail:`${s} 이 room roster에 보이지 않습니다.`,tool:"masc_join"}:{title:"Task 준비도",tone:"warn",detail:"?agent= 쿼리가 없습니다. room health는 보이지만 agent 단위 다음 단계는 비어 있습니다.",tool:"masc_join"},!t||(((M=t.topology.summary)==null?void 0:M.managed_unit_count)??0)===0?{title:"작전 준비도",tone:"warn",detail:"관리 단위가 아직 정의되지 않았습니다. hierarchy가 있어야 CPv2 benchmark를 시작할 수 있습니다.",tool:"masc_unit_define"}:l===0?{title:"작전 준비도",tone:"warn",detail:`${((S=t.topology.summary)==null?void 0:S.managed_unit_count)??0}개 관리 단위는 준비됐지만 활성 작전은 없습니다.`,tool:"masc_operation_start"}:{title:"작전 준비도",tone:"ok",detail:`${((E=t.topology.summary)==null?void 0:E.managed_unit_count)??0}개 관리 단위 위에서 ${l}개 활성 작전이 돌고 있습니다.`,tool:"masc_observe_operations"},d>0?{title:"디스패치 준비도",tone:"warn",detail:`${d}개의 pending approval이 strict action을 막고 있습니다.`,tool:"masc_policy_approve"}:l>0&&c===0?{title:"디스패치 준비도",tone:"bad",detail:"active operation은 있지만 detachment가 아직 materialize 되지 않았습니다.",tool:"masc_dispatch_tick"}:p||_?{title:"디스패치 준비도",tone:"warn",detail:`dispatch 재정렬이 필요합니다${p?` · detachment ${p.detachment.detachment_id} 가 stalled 상태입니다`:""}${_?` · alert ${_.title??_.alert_id}`:""}${!e&&!p&&!_?" · 정확한 원인은 detail 탭에서 확인하세요.":""}.`,tool:d>0?"masc_policy_approve":"masc_dispatch_tick"}:{title:"디스패치 준비도",tone:"ok",detail:`${c}개 detachment가 보이고 strict approval backlog도 없습니다${e?"":" · detail pane은 열릴 때만 로드됩니다."}.`,tool:"masc_detachment_list"}],C=v?!s||!a?"masc_join":o.length===0?ue.value.length>0?"masc_claim":"masc_add_task":f?I===!1?"masc_heartbeat":!t||(((G=t.topology.summary)==null?void 0:G.managed_unit_count)??0)===0?"masc_unit_define":l===0?"masc_operation_start":d>0?"masc_policy_approve":l>0&&c===0||p||_?"masc_dispatch_tick":"masc_observe_traces":"masc_plan_set_task":"masc_set_room",$=A$(C),x=T$(C==="masc_set_room"?["repo-root-room"]:C==="masc_plan_set_task"?["claimed-not-current"]:C==="masc_heartbeat"?["heartbeat-stale"]:C==="masc_dispatch_tick"?["no-detachments"]:C==="masc_policy_approve"?["pending-approval"]:["repo-root-room","claimed-not-current","heartbeat-stale"]).slice(0,2),R=Ai("room_task_hygiene"),A=Ai("cpv2_benchmark"),L=Ai("supervisor_session"),U=((yt=Ss.value)==null?void 0:yt.docs)??[],tt=[R,A,L].filter(H=>H!==null);return i`
    <div class="command-guided-layout">
      ...
      <section class="card command-section">
        ...
        ${bo.value?i`<div class="empty-state">CPv2 runbook 불러오는 중…</div>`:Ea.value?i`<div class="empty-state error">${Ea.value}</div>`:i`
  ...
  `}function fh({orchestra:t,positions:e,density:n,selectedId:s,onSelect:a}){var l;const o=((l=t.focus)==null?void 0:l.target_kind)==="node"?t.focus.target_id:null;return i`
    ${t.nodes.map(c=>{const d=e.get(c.id);if(!d)return null;const p=eu(c,n),_=c.id===s,v=c.id===o,f=c.visual_class??c.kind,h=rh(c,n),I=lh(c,n),k=ch(c,n);if(c.kind==="room")return i`
          <g
            key=${c.id}
        ...
        >
          ...
          ${I?i`<text x=${C+38} y=${$+42} class="orchestra-node-subtitle">${I}</text>`:null}
  ...
  `}function nu(t){var s,a;const e=Te.value;if(e){const o=t.nodes.find(c=>c.id===e);if(o)return{type:"node",value:o};const l=t.signals.find(c=>c.id===e);if(l)return{type:"signal",value:l}}if(((s=t.focus)==null?void 0:s.target_kind)==="node"){const o=t.nodes.find(l=>{var c;return l.id===((c=t.focus)==null?void 0:c.target_id)});if(o)return{type:"node",value:o}}if(((a=t.focus)==null?void 0:a.target_kind)==="signal"){const o=t.signals.find(l=>{var c;return l.id===((c=t.focus)==null?void 0:c.target_id)});if(o)return{type:"signal",value:o}}const n=t.nodes[0];return n?{type:"node",value:n}:null}function gh({orchestra:t}){const e=nu(t);if(!e)return i`<aside class="orchestra-drawer card"><div class="empty-state">선택 가능한 대상이 아직 없습니다.</div></aside>`;if(e.type==="signal"){const o=e.value;return i`
      <aside class="orchestra-drawer card ${P(o.tone)}">
        <div class="card-title-row">
          ...
          <span class="command-chip ${P(o.tone)}">${Ol(o.kind)}</span>
        </div>
    ...
    <aside class="orchestra-drawer card ${P(n.tone)}">
      <div class="card-title-row">
        ...
        <span class="command-chip ${P(n.tone)}">${Ol(n.kind)}</span>
      </div>
  ...
  `}function $h(){var tt,Q,Z,W;const t=ar.value,e=wn(null),n=wn(null),s=wn(""),[a,o]=$n(jn);if(et(()=>{const M=e.current;if(!M)return;const S=()=>{const G=M.getBoundingClientRect();G.width<=0||G.height<=0||o({width:Math.max(640,Math.round(G.width)),height:Math.max(480,Math.round(G.height))})};if(S(),typeof ResizeObserver>"u")return window.addEventListener("resize",S),()=>window.removeEventListener("resize",S);const E=new ResizeObserver(()=>S());return E.observe(M),()=>E.disconnect()},[]),ko.value&&!t)return i`<section class="card command-section"><div class="empty-state">오케스트라 맵 불러오는 중…</div></section>`;if(ja.value)return i`<section class="card command-section"><div class="empty-state error">${ja.value}</div></section>`;if(!t)return i`<section class="card command-section"><div class="empty-state">오케스트라 맵 데이터가 아직 없습니다.</div></section>`;const l=Fs.value,c=dh(t,l),d=t.nodes.find(M=>M.kind==="room")??null,p=d?c.get(d.id)??null:null,_=uh(t,p,l),v=ph(t,c,_,l),f=nu(t),h=(f==null?void 0:f.value.id)??null,I=`${l}:${a.width}x${a.height}:${t.nodes.length}:${t.edges.length}:${t.signals.length}`,k=(M,S)=>{re.value=M,Ks.value=S},C=()=>{k(Dl(v,a,l),!1)},$=()=>{if(Te.value=null,l!=="compact"){Fs.value="compact",Ks.value=!1;return}C()};et(()=>{h&&!t.nodes.some(M=>M.id===h)&&!t.signals.some(M=>M.id===h)&&(Te.value=null)},[I,h,t]),et(()=>{(!Ks.value||s.current!==I)&&(k(Dl(v,a,l),!1),s.current=I)},[I]);const y=re.value,x=(M,S,E)=>{const G=re.value.zoom,yt=da(G*E,Qd,Zd);if(Math.abs(yt-G)<.001)return;const ie=(M-re.value.panX)/G,H=(S-re.value.panY)/G;k({zoom:yt,panX:M-ie*yt,panY:S-H*yt},!0)},R=M=>{M.preventDefault();const S=e.current;if(!S)return;const E=S.getBoundingClientRect(),G=da(M.clientX-E.left,0,E.width),yt=da(M.clientY-E.top,0,E.height);x(G,yt,M.deltaY<0?1.1:.92)},A=M=>{var G;const S=M.target;if(!(S instanceof Element)||!S.closest('[data-orchestra-background="true"]'))return;const E=M.currentTarget;E&&(n.current={pointerId:M.pointerId,startX:M.clientX,startY:M.clientY,panX:re.value.panX,panY:re.value.panY},Ii.value=!0,Ks.value=!0,(G=E.setPointerCapture)==null||G.call(E,M.pointerId))},L=M=>{const S=n.current;!S||S.pointerId!==M.pointerId||k({zoom:re.value.zoom,panX:S.panX+(M.clientX-S.startX),panY:S.panY+(M.clientY-S.startY)},!0)},U=M=>{var E;if(!n.current)return;const S=M==null?void 0:M.currentTarget;S&&M&&((E=S.releasePointerCapture)==null||E.call(S,M.pointerId)),n.current=null,Ii.value=!1};return i`
        ...
        >
          ...
          >
            ...
            <g transform=${`translate(${y.panX} ${y.panY}) scale(${y.zoom})`}>
              ...
              <${_h} signalNodes=${_} roomPoint=${p} onSelect=${M=>{Te.value=M}} />
              <${fh}
                orchestra=${t}
                positions=${c}
                density=${l}
                selectedId=${h}
                onSelect=${M=>{Te.value=M}}
              />
            </g>
          </svg>
          <div class="orchestra-summary-strip">
            ...
            <span class="command-chip ${P(t.signals.some(M=>M.tone==="bad")?"bad":t.signals.length>0?"warn":"ok")}">
    ...
    <div class="command-section-stack">
      ...
      <div class="command-surface-grid">
        <section class="card command-section">
          ...
          ${Pa.value?i`<div class="empty-state">Loading swarm live state…</div>`:Na.value?i`<div class="empty-state error">${Na.value}</div>`:t?i`
                    <div class="command-tag-row">
                    ...
                    <div class="command-summary-grid">
                      ...
                      <div class="monitor-stat-card"><span>고동시성</span><strong>${(R=t.summary)!=null&&R.pass_hot_concurrency?"통과":"확인 필요"}</strong><small>${((A=t.provider)==null?void 0:A.slot_url)??"slot 정보 없음"}</small></div>
                    ...
                    <div class="command-card-grid">
                      ...
                      <span>런타임 막힘</span><span>${((M=t.provider)==null?void 0:M.runtime_blocker)??"없음"}</span>
  ...
  `}function my({wallboard:t=!1}){var Mr,Lr,zr,Er,Pr,Nr,jr,wr,Or,Dr,qr,Fr,Kr,Br,Ur,Hr,Wr,Gr,Jr,Vr,Yr,Xr,Qr,Zr,tl,el,nl,sl,al,il,ol,rl;const e=Ls(),n=Ue.value,s=It.value,a=Ht.value,o=M$(),l=n!=null&&n.operation?((Mr=Cs.value)==null?void 0:Mr.operations.find(K=>{var xe;return K.operation.operation_id===((xe=n.operation)==null?void 0:xe.operation_id)}))??null:null,c=(o==null?void 0:o.linked_autoresearch)??null,d=I$(),p=(n==null?void 0:n.workers)??[],_=(a==null?void 0:a.worker_cards)??[],v=d&&p.length>0?p.map(sy):_.map(ay),f=Gt.value.filter(K=>K.status==="active"||K.status==="busy"||K.status==="listening"||K.status==="idle"),h=ae.value.filter(K=>K.status!=="offline"||K.keepalive_running||K.last_heartbeat).sort((K,xe)=>an(xe.last_heartbeat)-an(K.last_heartbeat)),I=d,k=((Lr=e==null?void 0:e.decisions.summary)==null?void 0:Lr.pending)??0,C=ai(s),$=C.items,y=C.total_count,x=C.visible_count,R=C.hidden_count,A=d?(n==null?void 0:n.blockers)??[]:[],L=(a==null?void 0:a.recommended_actions)??[],U=(zr=a==null?void 0:a.active_recommended_actions)!=null&&zr.length?a.active_recommended_actions:L,tt=a==null?void 0:a.active_summary,Q=(a==null?void 0:a.active_guidance_layer)??"fallback",Z=(a==null?void 0:a.resident_judge_runtime)??(s==null?void 0:s.resident_judge_runtime),W=(a==null?void 0:a.attention_items)??[],M=((Er=n==null?void 0:n.recent_messages[0])==null?void 0:Er.timestamp)??null,S=((Pr=n==null?void 0:n.recent_trace_events[0])==null?void 0:Pr.timestamp)??null,E=d?M??S??null:null,G=o==null?void 0:o.summary,yt=(d?(Nr=n==null?void 0:n.summary)==null?void 0:Nr.expected_workers:void 0)??(typeof(G==null?void 0:G.planned_worker_count)=="number"?G.planned_worker_count:void 0)??(a==null?void 0:a.worker_cards.length)??0,ie=(d?(jr=n==null?void 0:n.summary)==null?void 0:jr.joined_workers:void 0)??(typeof(G==null?void 0:G.active_agent_count)=="number"?G.active_agent_count:void 0)??v.length,H=A.length>0||k>0||y>0?"warn":I||o?"ok":"warn",vt=d?((wr=e==null?void 0:e.swarm_status)==null?void 0:wr.lanes.filter(K=>K.present))??[]:[],ke=((Dr=(Or=e==null?void 0:e.swarm_status)==null?void 0:Or.narrative)==null?void 0:Dr.lane_id)??((Fr=(qr=e==null?void 0:e.swarm_status)==null?void 0:qr.recommended_next_action)==null?void 0:Fr.lane_id)??((Kr=vt[0])==null?void 0:Kr.lane_id)??null,rt=ke?vt.find(K=>K.lane_id===ke)??null:vt[0]??null,In=[...Z?[ry(Z)]:[],...f.slice(0,t?8:5).map(iy),...h.slice(0,t?8:5).map(oy)],zs=In.filter(K=>K.source==="agent"),Es=In.filter(K=>K.source==="keeper"||K.source==="resident"),Ps=cy({swarmMessages:(n==null?void 0:n.recent_messages)??[],traceEvents:(n==null?void 0:n.recent_trace_events)??[],chainOverlay:l,linkedAutoresearch:c,selectedSession:o,activeRecommendedActions:U,attentionItems:W}),mi=((Br=n==null?void 0:n.operation)==null?void 0:Br.objective)??((Hr=(Ur=e==null?void 0:e.swarm_status)==null?void 0:Ur.narrative)==null?void 0:Hr.active_work)??(o==null?void 0:o.session_id)??"가동 중인 워룸",_i=[(tt==null?void 0:tt.summary)??null,((Gr=(Wr=e==null?void 0:e.swarm_status)==null?void 0:Wr.narrative)==null?void 0:Gr.state)??null,((Vr=(Jr=e==null?void 0:e.swarm_status)==null?void 0:Jr.narrative)==null?void 0:Vr.active_work)??null,rt?`${rt.label} · ${rt.current_step}`:null].filter(Boolean).join(" · ")||"실제 실행, 메시지, 트레이스, 상주 판단을 한 장에서 읽는 wallboard입니다.",[vi,fi]=$n(typeof document<"u"&&!!document.fullscreenElement);et(()=>{_t()},[]),et(()=>{o!=null&&o.session_id&&he(o.session_id)},[o==null?void 0:o.session_id,s,(Yr=n==null?void 0:n.detachment)==null?void 0:Yr.session_id]),et(()=>{if(!t)return;const K=()=>{fi(!!document.fullscreenElement)};return document.addEventListener("fullscreenchange",K),K(),()=>{document.removeEventListener("fullscreenchange",K)}},[t]);const Mu=()=>{var K,xe,ll;if(!(typeof document>"u")){if(document.fullscreenElement){(K=document.exitFullscreen)==null||K.call(document);return}(ll=(xe=document.documentElement).requestFullscreen)==null||ll.call(xe)}},Lu=()=>{_t(),Zt(),Oe(),o!=null&&o.session_id&&he(o.session_id)};return!I&&!o?Pa.value||Zn.value?i`<div class="empty-state">실시간 워룸 불러오는 중…</div>`:i`
    ...
    <div class="command-section-stack ${t?"wallboard":""}">
      <section class="command-warroom-strip ${P(H)} ${t?"wallboard":""}">
        <div class="command-warroom-strip-head">
          ...
          <div class="command-warroom-hero-actions">
            ...
            ${t?i`
                  ...
                  <button
                    class="control-btn ghost"
                    onClick=${()=>{var K;document.fullscreenElement&&((K=document.exitFullscreen)==null||K.call(document)),Kt("warroom"),at("command",Ms("warroom"))}}
                  >
                    표준 보기
                  </button>
                `:null}
        ...
        <div class="command-warroom-strip-stats">
          ...
          <div class="monitor-stat-card ${P(A.length>0||k>0||y>0?"warn":"ok")}">
            <span>압력</span>
            <strong>${A.length+k+y}</strong>
            <small>막힘 ${A.length} · 승인 ${k} · 확인 ${x}${R>0?`/${y}`:""}</small>
          </div>
          <div class="monitor-stat-card ${P(Wa(Q))}">
            <span>상주 판정기</span>
            <strong>${di(Z)}</strong>
      ...
      <div class="command-warroom-grid ${t?"wallboard":""}">
        ...
        <div class="command-warroom-column">
          <section class="card command-section">
            ...
            ${Ps.length>0?i`<div class="command-trace-stack">
                  ${Ps.map(K=>i`<${uy} item=${K} />`)}
          ...
          <section class="card command-section">
            ...
            ${n&&n.recent_trace_events.length>0?i`<div class="command-trace-stack">
                  ${n.recent_trace_events.map(K=>i`<${xr} event=${K} />`)}
        ...
        <div class="command-warroom-column">
          ...
          <section class="card command-section">
            ...
            <div class="command-card-stack">
              ...
              ${A.length>0?A.map(K=>i`<${_u} blocker=${K} />`):i`<div class="command-guide-card ok"><p>지금 보이는 blocker는 없습니다.</p></div>`}
              ${k>0?i`
              ...
              ${y>0?i`
                    <article class="command-guide-card warn">
                      <div class="command-guide-head">
                        <strong>확인 대기</strong>
                        <span class="command-chip warn">${R>0?`${x}/${y}`:y}</span>
                      </div>
                      <p>
                        운영자 미리보기가 사람 확인을 기다리고 있습니다.
                        ${R>0?` 현재 actor 기준으로는 ${x}건만 보입니다.`:""}
                      </p>
                      <div class="command-tag-row">
                        ${$.slice(0,3).map(K=>i`<span class="command-tag">${K.confirm_token}</span>`)}
                      </div>
                    </article>
                  `:null}
              ${rt?i`
  ...
  `}function $y({card:t}){const e=t.operation,n=`pause:${e.operation_id}`,s=`resume:${e.operation_id}`,a=`recall:${e.operation_id}`,o=e.chain,l=(o==null?void 0:o.run_id)??null;return i`
    <article class="command-card">
      <div class="command-card-head">
        ...
        <span class="command-chip ${P(e.status==="active"?"ok":e.status==="paused"?"warn":e.status==="failed"?"bad":"ok")}">${Wl(e.status)}</span>
      </div>
      <div class="command-card-grid">
      ...
      <section class="card command-section">
        ...
        <div class="command-chain-history">
          ...
          ${t&&t.recent_history.length>0?i`
                <div class="command-card-stack">
                  ${t.recent_history.slice(0,6).map(U=>i`<${fy} item=${U} />`)}
                </div>
        ...
        ${s?i`
              <article class="command-card">
                ...
                <div class="command-card-grid">
                  ...
                  <span>최근 갱신</span><span>${Y(((R=s.operation.chain)==null?void 0:R.last_sync_at)??s.operation.updated_at)}</span>
                </div>
                ${(A=s.operation.chain)!=null&&A.goal?i`<div class="command-card-foot">${s.operation.chain.goal}</div>`:null}
              </article>
  ...
  `}function ky(t){switch((t??"").trim().toLowerCase()){case"pending":return"대기 중";case"approved":return"승인됨";case"denied":return"거부됨";case"executed":return"실행됨";case"active":return"가동 중";default:return(t==null?void 0:t.trim())||"확인 필요"}}function xy({decision:t}){const e=`approve:${t.decision_id}`,n=`deny:${t.decision_id}`,s=t.source==="projected_operator";return i`
    <article class="command-card ${P(t.status)}">
      <div class="command-card-head">
        ...
        <span class="command-chip ${P(t.status)}">${ky(t.status??"pending")}</span>
      </div>
      <div class="command-card-grid">
  ...
  `}function Sy({row:t}){var c,d,p;const e=t.unit,n=`freeze:${e.unit_id}`,s=`kill:${e.unit_id}`,a=!!((c=e.policy)!=null&&c.frozen),o=!!((d=e.policy)!=null&&d.kill_switch),l=Math.round((t.utilization??0)*100);return i`
    <article class="command-card compact">
      ...
      <div class="command-action-row">
        ...
        <button class="control-btn ghost" disabled=${ut(s)} onClick=${()=>fe(()=>zf(e.unit_id,!o))}>
  ...
  `}function Ty({wallboard:t=!1}){if(V.value==="warroom")return i`<${my} wallboard=${t} />`;if(V.value==="summary")return i`<${sh} />`;if(V.value==="orchestra")return i`<${$h} />`;if(V.value==="swarm")return i`<${Qh} />`;if(!Jt.value)return i`<${ah} />`;switch(V.value){case"chains":return i`<${by} />`;case"topology":return i`<${Oh} />`;case"alerts":return i`<${Dh} />`;case"trace":return i`<${qh} />`;case"control":return i`<${Cy} />`;case"operations":default:return i`<${yy} />`}}function Iy(){const t=V.value==="warroom"&&q.value.params.presentation==="wallboard";return et(()=>{tn(),Oe(),Sf(),Zt(),Pe()},[]),et(()=>{if(q.value.tab!=="command")return;const e=q.value.params.surface,n=q.value.params.operation,s=As(q.value);if(Pl(e))Kt(e);else if(s){const a=zd(s);Pl(a)&&Kt(a)}else e||Kt("warroom");n&&lr(n),(e==="swarm"||e==="warroom"||e==="orchestra"||V.value==="warroom"||V.value==="orchestra")&&Zt(),(e==="orchestra"||V.value==="orchestra")&&Pe(),(e==="warroom"||V.value==="warroom")&&_t()},[q.value.tab,q.value.params.surface,q.value.params.operation,q.value.params.operation_id,q.value.params.run_id,q.value.params.source,q.value.params.action_type,q.value.params.target_type,q.value.params.target_id,q.value.params.focus_kind]),et(()=>{let e=null;const n=()=>{e||(e=window.setTimeout(()=>{e=null,tn(),Oe(),(V.value==="swarm"||V.value==="warroom"||V.value==="orchestra")&&Zt(),V.value==="orchestra"&&Pe(),V.value==="warroom"&&_t()},250))},s=new EventSource(h$()),a=f$.map(o=>{const l=()=>n();return s.addEventListener(o,l),{type:o,handler:l}});return s.onerror=()=>{n()},()=>{a.forEach(({type:o,handler:l})=>{s.removeEventListener(o,l)}),s.close(),e&&window.clearTimeout(e)}},[]),et(()=>{const e=window.setInterval(()=>{if(document.visibilityState==="hidden")return;const n=V.value;n!=="swarm"&&n!=="warroom"&&n!=="orchestra"||(tn(),Zt(),n==="orchestra"&&Pe(),n==="warroom"&&_t())},5e3);return()=>{window.clearInterval(e)}},[]),i`
    <section class="dashboard-panel command-plane-view ${t?"wallboard":""}">
      ${t?null:i`
        <div class="panel-header">
          ...
          <div class="panel-actions">
            ...
            <button
              class="control-btn ghost"
              onClick=${()=>{ze(),tn(),Oe(),Zt(),V.value==="warroom"&&_t()}}
              disabled=${Ia.value}
            >
      ...
      ${t?null:i`<${hr} />`}
      ${t?null:i`<${Q$} />`}
      ${t||V.value==="warroom"?null:i`<${Z$} />`}
      ${t?null:i`<${Ay} />`}
      <${Ty} wallboard=${t} />
    </section>
  `}function Ry(){var C;const t=It.value,e=nr.value,n=(t==null?void 0:t.room)??{},s=ai(t),a=s.items,o=s.confirm_required_actions,l=s.actor_filter,c=s.hidden_count,d=s.hidden_actors,p=(t==null?void 0:t.recent_messages)??[],_=(e==null?void 0:e.recommended_actions)??[],v=(C=e==null?void 0:e.active_recommended_actions)!=null&&C.length?e.active_recommended_actions:_,f=e==null?void 0:e.active_summary,h=(e==null?void 0:e.resident_judge_runtime)??(t==null?void 0:t.resident_judge_runtime),I=(e==null?void 0:e.active_guidance_layer)??"fallback",k=p.slice(0,5);return i`
    <div class="ops-column">
      <section class="card ops-panel ops-lane-panel">
        ...
        <div class="control-row ops-split-row">
          ...
          <button class="control-btn" onClick=${()=>{zh()}} disabled=${it.value||fn.value.trim()===""}>
            주입
          </button>
        </div>
      </section>
    ...
    <div class="ops-column">
      ...
      <section class="card ops-panel ops-lane-panel">
        ...
        <div class="control-row ops-split-row">
          ...
          <button class="control-btn" onClick=${()=>{Eh()}} disabled=${p||!a}>
            적용
          </button>
        </div>
        <div class="ops-context-note">현재 선택: ${Ch(At.value)}</div>
        ...
        <div class="control-row ops-split-row">
          <input
            ...
            disabled=${p||!a}
          />
          <button class="control-btn ghost" onClick=${()=>{Ph()}} disabled=${p||!a}>
            세션 중지
          </button>
        </div>
      </section>
  ...
  `}function zy(){var x,R;const t=It.value,e=q.value.tab==="intervene"?As(q.value):null,n=nr.value,s=(t==null?void 0:t.room)??{},a=(t==null?void 0:t.sessions)??[],o=(t==null?void 0:t.keepers)??[],l=ai(t),c=l.visible_count,d=l.total_count,p=l.hidden_count,_=l.actor_filter,v=a.find(A=>A.session_id===yn.value)??a[0]??null,f=(n==null?void 0:n.attention_items)??[],h=f.filter(xh),I=f.filter(Sh),k=a.filter(A=>kh(A)!=="ok"),C=o.filter(A=>Ri(A)!=="ok"),$=Mh(e,a,o);et(()=>{qe()},[]),et(()=>{if(q.value.tab!=="intervene"){Us.value=null;return}if(!e){Us.value=null;return}Us.value!==e.id&&(Us.value=e.id,Ih(e))},[q.value.tab,q.value.params.source,q.value.params.action_type,q.value.params.target_type,q.value.params.target_id,q.value.params.focus_kind,e==null?void 0:e.id]),et(()=>{const A=(v==null?void 0:v.session_id)??null;he(A)},[v==null?void 0:v.session_id]);const y=[{key:"room",label:"방 게이트",value:s.paused?"일시정지":"열림",detail:s.paused?`재개 전환 대기 중${s.pause_reason?` · ${s.pause_reason}`:""}`:"지금은 새 액션과 새 작업을 바로 받을 수 있습니다",tone:s.paused?"bad":"ok"},{key:"confirm",label:"확인 대기",value:p>0?`${c}/${d}`:c,detail:c>0?"미리보기만 된 개입이 아직 사람 확인을 기다리고 있습니다":p>0&&_?`현재 개입 ID(${_}) 기준으로는 비어 있고, 다른 개입 ID 대기 ${p}건이 있습니다`:"지금 막혀 있는 확인 대기는 없습니다",tone:d>0?"warn":"ok"},{key:"session",label:"세션 리스크",value:h.length>0?h.length:a.length,detail:h.length>0?((x=h[0])==null?void 0:x.summary)??"세션 중 하나가 방향 수정이나 중지 판단을 기다리고 있습니다":a.length===0?"지금 관리 중인 팀 세션이 없습니다":"세션 쪽 긴급 주의 신호는 현재 없습니다",tone:h.length>0?Kl(h):a.length===0?"warn":k.some(A=>bn(A.status)==="paused")?"bad":k.length>0?"warn":"ok"},{key:"keeper",label:"키퍼 압력",value:I.length>0?I.length:C.length,detail:I.length>0?((R=I[0])==null?void 0:R.summary)??"직접 메시지나 상태 점검이 필요한 키퍼가 있습니다":C.length>0?"오래됐거나 오프라인이거나 텔레메트리가 비는 키퍼가 보입니다":"지금은 키퍼 쪽이 비교적 안정적입니다",tone:I.length>0?Kl(I):C.some(A=>Ri(A)==="bad")?"bad":C.length>0?"warn":"ok"}];return i`
    <section class="ops-view">
      ...
      <div class="ops-header card">
        ...
        <div class="ops-toolbar">
          ...
          <input
            ...
            type="text"
            value=${ci.value}
            onInput=${A=>bh(A.target.value)}
          />
            <button
              class="control-btn ghost"
              onClick=${()=>{ze(),_t(),qe(),he((v==null?void 0:v.session_id)??null)}}
      ...
      ${(()=>{const A=[];if((c>0||p>0)&&A.push({label:p>0?`확인 대기 ${c}/${d}건 확인`:`확인 대기 ${c}건 처리`,desc:p>0&&_?`현재 개입 ID(${_}) 기준으로 보이는 대기열을 먼저 확인합니다`:"승인 또는 거부가 필요한 개입이 대기 중입니다",tone:c>0?"bad":"warn",onClick:()=>{const L=document.querySelector(".ops-pending-section");L==null||L.scrollIntoView({behavior:"smooth"})}}),s.paused&&A.push({label:"방 재개",desc:`현재 일시정지 상태${s.pause_reason?` (${s.pause_reason})`:""}`,tone:"warn",onClick:()=>void ou()}),C.length>0){const L=C.filter(U=>Ri(U)==="bad");A.push({label:L.length>0?`오프라인 키퍼 ${L.length}개`:`점검이 필요한 키퍼 ${C.length}개`,desc:L.length>0?"메시지를 보내거나 상태를 확인하세요":"오래됐거나 텔레메트리가 비어 있습니다",tone:L.length>0?"bad":"warn",onClick:()=>{const U=document.querySelector(".ops-keeper-section");U==null||U.scrollIntoView({behavior:"smooth"})}})}return A.length===0?null:i`
  ...
  `}function Ey({text:t}){if(!t)return null;const e=Py(t);return i`<div class="markdown-content">${e}</div>`}function Py(t){const e=t.split(`
...
`))}</p>`)}return n}function Li(t){const e=[],n=/(`[^`]+`)|(\*\*[^*]+\*\*)|(\*[^*]+\*)|\[([^\]]+)\]\(([^)]+)\)/g;let s=0,a;for(;(a=n.exec(t))!==null;){if(a.index>s&&e.push(t.slice(s,a.index)),a[1]){const o=a[1].slice(1,-1);e.push(i`<code>${o}</code>`)}else if(a[2]){const o=a[2].slice(2,-2);e.push(i`<strong>${o}</strong>`)}else if(a[3]){const o=a[3].slice(1,-1);e.push(i`<em>${o}</em>`)}else a[4]&&a[5]&&e.push(i`<a href=${a[5]} target="_blank" rel="noopener">${a[4]}</a>`);s=a.index+a[0].length}return s<t.length&&e.push(t.slice(s)),e.length>0?e:[t]}const vu=[{id:"recent",label:"최신순"},{id:"hot",label:"인기순"},{id:"trending",label:"급상승"},{id:"updated",label:"최근 갱신"},{id:"discussed",label:"토론 많은 순"}],ua=g(null),pa=g([]),kn=g(!1),we=g(null),Bn=g(""),Un=g(!1),on=g(!0),Sr=20,Ye=g(Sr);function Ny(){var e,n;const t=new URLSearchParams(window.location.search);return((e=t.get("agent"))==null?void 0:e.trim())||((n=t.get("agent_name"))==null?void 0:n.trim())||"dashboard-user"}const jy=g(Ny());function wy(t){const e=t.replace(/!\[[^\]]*\]\([^)]+\)/g," ").replace(/\[[^\]]+\]\([^)]+\)/g,"$1").replace(/[`#>*_~-]/g," ").replace(/\s+/g," ").trim();return e?e.length>180?`${e.slice(0,177)}...`:e:"미리보기 없음"}function Gl(t){return t.updated_at!==t.created_at}function Oy(t){if(t.post_kind)return t.post_kind==="automation";const e=(t.hearth??"").toLowerCase();return t.visibility!=="internal"||!t.expires_at||!e?!1:!!(e.startsWith("mdal")||e.includes("harness"))}function Dy(t){return t==="lodge-system"||t==="team-session"}function ms(t){return t.post_kind?t.post_kind:Dy(t.author)?"system":Oy(t)?"automation":"human"}function fu(t){const e=[],n=[];let s=0;return t.forEach(a=>{const o=ms(a);if(!(o==="system"&&Me.value)){if(o==="automation"&&on.value){s+=1;return}if(o==="human"){e.push(a);return}n.push(a)}}),{human:e,operations:n,hiddenAutomation:s}}function qy(t){if(!t.expires_at)return null;const e=Date.parse(t.expires_at);return Number.isFinite(e)?e<=Date.now()?i`<span class="board-meta-chip">만료됨</span>`:i`<span class="board-meta-chip">만료까지 <${X} timestamp=${t.expires_at} /></span>`:null}async function Cr(t){we.value=t,ua.value=null,pa.value=[],kn.value=!0;try{const e=await Qp(t);if(we.value!==t)return;ua.value={id:e.id,author:e.author,title:e.title,body:e.body,content:e.content,meta:e.meta,tags:e.tags,votes:e.votes,vote_balance:e.vote_balance,comment_count:e.comment_count,created_at:e.created_at,updated_at:e.updated_at,post_kind:e.post_kind,flair:e.flair,hearth:e.hearth,visibility:e.visibility,expires_at:e.expires_at,hearth_count:e.hearth_count},pa.value=e.comments??[]}catch{we.value===t&&(ua.value=null,pa.value=[])}finally{we.value===t&&(kn.value=!1)}}async function Jl(t){const e=Bn.value.trim();if(e){Un.value=!0;try{await Zp(t,jy.value,e),Bn.value="",w("댓글을 등록했습니다","success"),await Cr(t),me()}catch{w("댓글 등록에 실패했습니다","error")}finally{Un.value=!1}}}function Fy(){const t=Xn.value,e=on.value?"자동화 글 숨김":"자동화 글 표시 중";return i`
  ...
  `}function zi(){var s;const t=((s=vu.find(a=>a.id===Xn.value))==null?void 0:s.label)??Xn.value,e=fu(si.value),n=e.human.length+e.operations.length;return i`
  ...
  `}function Vl({post:t}){const e=async(n,s)=>{s.stopPropagation();try{await Ac(t.id,n),me()}catch{w("투표에 실패했습니다","error")}};return i`
  ...
  `}function Uy({post:t}){we.value!==t.id&&!kn.value&&Cr(t.id);const e=async n=>{try{await Ac(t.id,n),me()}catch{w("Failed to vote","error")}};return i`
    <div>
  ...
  `}function Hy(){const t=fu(si.value),e=[...t.human,...t.operations],n=q.value.params.post??null,s=n?e.find(a=>a.id===n)??(we.value===n?ua.value:null):null;return n&&!s&&we.value!==n&&!kn.value&&Cr(n),n?s?i`
          <${Tt} surfaceId="memory" />
          <${zi} />
          <${Uy} post=${s} />
        `:i`
    ...
    <div class="agents-monitor">
      ...
      >
        ...
        <div class="monitor-alert-list">
          ${t.length===0?i`<div class="empty-state">지금은 막힌 실행이 없습니다.</div>`:t.map($=>i`<${sb} key=${$.id} item=${$} selected=${Ie.value===$.id} />`)}
        </div>
      <//>
      ...
      <div class="agents-workbench">
        ...
        >
          ...
          <div class="monitor-list">
            ${I.length===0?i`<div class="empty-state">지금은 연속성 경고가 없습니다.</div>`:I.map($=>i`<${lb} key=${$.name} row=${$} />`)}
          </div>
        <//>
  ...
  `}function fb(){const t=Lo.value,e=Wn.value,n=zo.value,s=(t==null?void 0:t.tool_inventory.tools)??[],a=(t==null?void 0:t.tool_usage)??null;et(()=>{!Lo.value&&!Wn.value&&tc()},[]),et(()=>{var h;if(q.value.tab!=="tools")return;const f=(h=q.value.params.q)==null?void 0:h.trim();f&&f!==En.value&&(En.value=f)},[q.value.tab,q.value.params.q]);const o=Array.from(new Set(s.map(f=>f.category))).sort((f,h)=>f.localeCompare(h)),l=s.filter(f=>!(!_b(f,En.value)||Ws.value!=="all"&&f.category!==Ws.value||Ei.value&&!f.enabled_in_current_mode||Pi.value&&!f.direct_call_allowed||!Ni.value&&f.visibility==="hidden"||!ji.value&&f.lifecycle==="deprecated")),c=s.length,d=s.filter(f=>f.enabled_in_current_mode).length,p=s.filter(f=>f.visibility==="hidden").length,_=s.filter(f=>f.lifecycle==="deprecated").length,v=s.filter(f=>f.direct_call_allowed).length;return i`
    <div>
  ...
  `}function Oi({task:t}){const e=t.priority??4,n=e<=1?"p1":e===2?"p2":e===3?"p3":"p4",s=Eo.value.has(t.id),a=!!t.description;return i`
  ...
  `}const Ya=g(!1),Gn=g(!1),rn=g(!1),Xa=g(!1),se=g(""),Jn=g(""),Vn=g(""),Po=g("support"),No=g("open"),xn=g(null),fs=g(null),gs=g(null),jo=g(!1);function $s(t){return`${t.kind}:${t.id}`}function ui(){var n;const t=fs.value,e=((n=xn.value)==null?void 0:n.items)??[];return t?e.find(s=>$s(s)===t)??null:null}function zb(t){const e=t.trim().toLowerCase();return e!=="executed"&&e!=="blocked"&&e!=="closed"}function $u(t){switch(No.value){case"pending_ruling":return t.filter(e=>e.status==="pending_ruling");case"needs_human_gate":return t.filter(e=>e.status==="needs_human_gate");case"executed":return t.filter(e=>e.status==="executed");case"blocked":return t.filter(e=>e.status==="blocked"||e.status==="closed");case"open":default:return t.filter(e=>zb(e.status))}}function Eb(t){if(t==null)return"없음";if(typeof t=="string")return t;try{return JSON.stringify(t,null,2)}catch{return String(t)}}function Ir(t){const e=(t||"").toLowerCase();return e.includes("block")||e.includes("deny")||e.includes("closed")?"negative":e.includes("support")||e.includes("approve")||e.includes("ready")||e.includes("executed")||e.includes("done")?"positive":"neutral"}function Pb(t){return typeof t!="number"||Number.isNaN(t)?"판정 대기":`${Math.round(t*100)}%`}async function hu(t){if(gs.value=null,!!t){jo.value=!0,se.value="";try{gs.value=await Tc(t.id)}catch(e){se.value=e instanceof Error?e.message:"거버넌스 상세를 불러오지 못했습니다"}finally{jo.value=!1}}}async function Nb(t){fs.value=$s(t),await hu(t)}async function Ke(){Ya.value=!0,se.value="";try{const t=await kp();xn.value=t;const e=$u(t.items??[]),n=fs.value,s=e.find(a=>$s(a)===n)??e[0]??null;fs.value=s?$s(s):null,await hu(s)}catch(t){se.value=t instanceof Error?t.message:"거버넌스 상태를 불러오지 못했습니다"}finally{Ya.value=!1}}G_(Ke);async function ac(){const t=Jn.value.trim();if(t){Gn.value=!0;try{const e=await Cm(t);Jn.value="",w(e!=null&&e.case.id?`청원을 접수했습니다: ${e.case.id}`:"청원을 접수했습니다","success"),await Ke()}catch(e){const n=e instanceof Error?e.message:"청원 접수에 실패했습니다";se.value=n,w(n,"error")}finally{Gn.value=!1}}}async function jb(){const t=ui(),e=Vn.value.trim();if(!(!t||!e)){Xa.value=!0;try{const n=await Am(t.id,Po.value,e);Vn.value="",gs.value=n,w("심의 의견을 기록했습니다","success"),await Ke()}catch(n){const s=n instanceof Error?n.message:"심의 기록에 실패했습니다";se.value=s,w(s,"error")}finally{Xa.value=!1}}}async function ic(t){const e=ui();if(e){rn.value=!0;try{await Tm(e.id,t),w(t==="confirm"?"집행을 승인했습니다":"집행을 거부했습니다","success"),await Ke()}catch(n){const s=n instanceof Error?n.message:"집행 결정을 처리하지 못했습니다";se.value=s,w(s,"error")}finally{rn.value=!1}}}function wb(){var e,n,s;const t=(e=xn.value)==null?void 0:e.summary;return i`
    <div class="board-summary-strip">
      <div class="board-summary-item">
  ...
  `}function Bb({order:t}){if(!(t!=null&&t.action_request))return null;const e=t.action_request;return i`
    <div class="governance-side-block">
      ...
      ${e.payload_preview?i`<pre class="council-detail governance-preview">${Eb(e.payload_preview)}</pre>`:null}
        ...
        ${!t||!e?i`<div class="empty-state">사건을 고르면 판정과 집행 경로가 보입니다.</div>`:i`
              <div class="governance-side-block">
                ...
                <div class="council-sub">
                  ...
                  <span>${Pb(n==null?void 0:n.confidence)}</span>
              ...
              <div class="governance-side-block">
                <div class="governance-filter-row">
                  ${["support","oppose","neutral"].map(a=>i`
                    <button
                      class="control-btn ${Po.value===a?"is-active":"ghost"}"
                      onClick=${()=>{Po.value=a}}
                    >
                      ${a}
                    </button>
...
`))&&(pi.value=Date.now()+Gb,w("조작 잠금이 120초 동안 해제되었습니다.","warning"))}function _a(t){return bu(t)?(w("관전 모드 잠금 상태입니다. 먼저 잠금을 해제하세요.","warning"),!1):!0}function Do(t,e,n){return ku([`[위험 액션 확인] ${t}`,`ROOM: ${e||"-"}`,`PHASE: ${n||"-"}`,"이 액션은 즉시 실행되며 되돌리기 어렵습니다.","계속 진행하시겠습니까?"].join(`
`))}function rk({hp:t,max:e}){const n=Vb(t,e),s=Jb(t,e);return i`
  ...
  `}function mk({state:t,nowMs:e}){var p;const n=ee.value||((p=t.session)==null?void 0:p.room)||"",s=Vs.value,a=t.party??[];if(!a.find(_=>_.id===Xe.value)&&a.length>0){const _=a[0];_&&(Xe.value=_.id)}const l=async()=>{var v,f;if(!n){w("Room ID가 비어 있습니다.","error");return}if(!_a(e))return;const _=((v=t.current_round)==null?void 0:v.phase)??((f=t.session)==null?void 0:f.status)??"unknown";if(Do("라운드 실행",n,_)){Vs.value="running";try{const h=await _m(n);wo.value=h,Vs.value="ok";const I=m(h.summary)?h.summary:null,k=I?hs(I,"advanced",!1):!1,C=I?Ct(I,"progress_reason",""):"";w(k?"라운드가 정상 진행되었습니다.":`라운드가 정체되었습니다${C?`: ${C}`:""}`,k?"success":"warning"),_e()}catch(h){wo.value=null,Vs.value="error";const I=h instanceof Error?h.message:"라운드 실행에 실패했습니다.";w(I,"error")}finally{Qa()}}},c=async()=>{var v,f;if(!n||!_a(e))return;const _=((v=t.current_round)==null?void 0:v.phase)??((f=t.session)==null?void 0:f.status)??"unknown";if(Do("턴 강제 진행",n,_))try{await gm(n),w("턴을 다음 단계로 이동했습니다.","success"),_e()}catch{w("턴 이동에 실패했습니다.","error")}finally{Qa()}},d=async()=>{if(!n||!_a(e))return;const _=Xe.value.trim();if(!_){w("먼저 Actor를 선택하세요.","warning");return}const v=Number.parseInt(qi.value,10),f=Number.parseInt(Fi.value,10);if(Number.isNaN(v)||Number.isNaN(f)){w("stat/dc는 숫자여야 합니다.","warning");return}const h=Number.parseInt(Js.value,10),I=Js.value.trim()===""||Number.isNaN(h)?void 0:h;try{await fm({roomId:n,actorId:_,action:Di.value.trim()||"ability_check",statValue:v,dc:f,rawD20:I}),w("주사위 판정을 기록했습니다.","success"),_e()}catch{w("주사위 판정 기록에 실패했습니다.","error")}};return i`
  ...
  `}function _k({state:t}){var a;const e=ee.value||((a=t.session)==null?void 0:a.room)||"",n=Qs.value,s=async()=>{if(!e){w("Room ID가 비어 있습니다.","warning");return}const o=Xs.value.trim(),l=Hi.value.trim();if(!l&&!o){w("이름 또는 Actor ID를 입력하세요.","warning");return}const c=Number.parseInt(Yn.value.trim(),10),d=Number.parseInt(Yi.value.trim(),10),p=Number.isFinite(d)?Math.max(1,d):20,_=Number.isFinite(c)?Math.max(0,Math.min(p,c)):p;let v={};try{v=ek(Xi.value)}catch(f){w(f instanceof Error?f.message:"능력치 JSON 오류","error");return}Qs.value="spawning";try{const f=typeof crypto<"u"&&typeof crypto.randomUUID=="function"?`trpg_spawn_${crypto.randomUUID()}`:`trpg_spawn_${Date.now().toString(36)}_${Math.random().toString(36).slice(2,10)}`,h=await $m(e,{actor_id:o||void 0,name:l||void 0,role:Wi.value,idempotencyKey:f,portrait:Ji.value.trim()||void 0,background:Vi.value.trim()||void 0,hp:_,max_hp:p,alive:_>0,stats:Object.keys(v).length>0?v:void 0}),I=typeof h.actor_id=="string"?h.actor_id.trim():"";if(!I)throw new Error("생성 응답에 actor_id가 없습니다.");const k=Gi.value.trim();k&&await hm(e,I,k),Xe.value=I,le.value=I,o||(Xs.value=""),Qs.value="ok",w(`Actor 생성 완료: ${I}`,"success"),await _e()}catch(f){Qs.value="error",w(f instanceof Error?f.message:"Actor 생성에 실패했습니다.","error")}};return i`
    <div class="trpg-control-box">
      <div class="trpg-control-grid">
        <div class="trpg-control-field">
          <label>Name</label>
  ...
  `}function vk({state:t,nowMs:e}){var f;const n=ee.value||((f=t.session)==null?void 0:f.room)||"",s=t.join_gate,a=Ui.value,o=m(a)?a:null,l=(t.party??[]).filter(h=>h.role!=="dm"),c=le.value.trim(),d=l.some(h=>h.id===c),p=d?c:c?"__manual__":"",_=async()=>{const h=le.value.trim(),I=Ys.value.trim();if(!n||!h){w("Room/Actor가 필요합니다.","warning");return}Mt.value="checking";try{const k=await ym(n,h,I||void 0);Ui.value=k,Mt.value="ok",w("참가 가능 여부를 갱신했습니다.","success")}catch(k){Mt.value="error";const C=k instanceof Error?k.message:"참가 가능 여부 확인에 실패했습니다.";w(C,"error")}},v=async()=>{var $,y;const h=le.value.trim(),I=Ys.value.trim(),k=Bi.value.trim();if(!n||!h||!I){w("Room/Actor/Keeper가 필요합니다.","warning");return}if(!_a(e))return;const C=(($=t.current_round)==null?void 0:$.phase)??((y=t.session)==null?void 0:y.status)??"unknown";if(Do("Mid-Join 승인 요청",n,C)){Mt.value="requesting";try{const x=await bm({room_id:n,actor_id:h,keeper_name:I,role:Ki.value,...k?{name:k}:{}});Ui.value=x;const R=m(x)?hs(x,"granted",!1):!1,A=m(x)?Ct(x,"reason_code",""):"";R?w("Mid-Join이 승인되었습니다.","success"):w(`Mid-Join이 거절되었습니다${A?`: ${A}`:""}`,"warning"),Mt.value=R?"ok":"error",_e()}catch(x){Mt.value="error";const R=x instanceof Error?x.message:"Mid-Join 요청에 실패했습니다.";w(R,"error")}finally{Qa()}}};return i`
    <div class="trpg-control-box">
  ...
  `:null}function Iu(){const t=wo.value;if(!t)return i`<div class="empty-state" style="font-size:13px;">Run Round 결과가 아직 없습니다.</div>`;const e=t.summary,n=m(e)?e:null,a=(Array.isArray(t.statuses)?t.statuses:[]).filter(m).slice(-8),o=t.canon_check,l=m(o)?o:null,c=l&&Array.isArray(l.warnings)?l.warnings.filter(A=>typeof A=="string").slice(0,3):[],d=l&&Array.isArray(l.violations)?l.violations.filter(A=>typeof A=="string").slice(0,3):[],p=n?hs(n,"advanced",!1):!1,_=n?Ct(n,"progress_reason",""):"",v=n?Ct(n,"progress_detail",""):"",f=n?Ot(n,"player_successes",0):0,h=n?Ot(n,"player_required_successes",0):0,I=n?hs(n,"dm_success",!1):!1,k=n?Ot(n,"timeouts",0):0,C=n?Ot(n,"unavailable",0):0,$=n?Ot(n,"reprompts",0):0,y=n?Ot(n,"npc_attacks",0):0,x=n?Ot(n,"keeper_timeout_sec",0):0,R=n?Ot(n,"roll_audit_count",0):0;return i`
    <div style="display:grid; gap:10px;">
      ...
      ${a.length>0?i`
          <div class="trpg-round-list">
            ${a.map(A=>{const L=Ct(A,"status","unknown"),U=Ct(A,"actor_id","-"),tt=Ct(A,"role","-"),Q=Ct(A,"reason",""),Z=Ct(A,"action_type",""),W=Ct(A,"reply","");return i`
          ...
          <div class="trpg-control-box">
            ...
            ${d.length>0?i`
                <div style="margin-top:6px; font-size:11px; color:#fca5a5;">
                  ${d.map(A=>i`<div>violation: ${A}</div>`)}
                </div>`:null}
            ${c.length>0?i`
                <div style="margin-top:6px; font-size:11px; color:#fbbf24;">
                  ${c.map(A=>i`<div>warning: ${A}</div>`)}
                </div>`:null}
          </div>
        `:null}
    </div>
    ...
    <${z} title="조작 안전 잠금" style="margin-bottom:16px;" semanticId="lab.trpg">
      <div class="trpg-control-lock ${a?"locked":"unlocked"}">
        ...
        <div style="display:flex; gap:8px; margin-top:10px; flex-wrap:wrap;">
          ${a?i`<button class="trpg-run-btn recommend" onClick=${()=>ok(n,s)}>잠금 해제 (120초)</button>`:i`<button class="trpg-run-btn secondary" onClick=${()=>{Qa(),w("조작 잠금으로 전환했습니다.","success")}}>즉시 다시 잠금</button>`}
        </div>
      </div>
    <//>
  ...
  `}const zk=[{kind:"broadcast",label:"Broadcast",cssClass:"live-event-broadcast"},{kind:"tasks",label:"Task",cssClass:"live-event-task"},{kind:"keepers",label:"Keeper",cssClass:"live-event-keeper"},{kind:"system",label:"System",cssClass:"live-event-system"}];function Ek(){const t=Za.value;return i`
  ...
  `}function Pk(){const t=Ck.value;return i`
  ...
  `}function qk({currentTab:t}){var p,_,v,f,h,I,k,C,$,y,x,R;const e=ge.value,n=(p=dt.value)==null?void 0:p.build,s=(_=dt.value)==null?void 0:_.social_runtime,a=(v=dt.value)==null?void 0:v.lodge,o=(f=dt.value)==null?void 0:f.gardener,l=(h=dt.value)==null?void 0:h.guardian,c=(I=dt.value)==null?void 0:I.sentinel,d=[];if(s||a){const A=s,L=a;d.push(ta("Social Runtime",A?A.enabled?kt("social","live"):kt("social","disabled"):L!=null&&L.enabled?kt("lodge",L.quiet_active?"quiet":"live"):kt("social","disabled"),A?A.enabled?"ok":"bad":L!=null&&L.enabled?L.quiet_active?"warn":"ok":"bad",[xt("전략",(A==null?void 0:A.strategy)??"legacy_fallback"),xt("대상 keeper",(A==null?void 0:A.active_keepers)??(L==null?void 0:L.agent_count)??0),xt("큐",(A==null?void 0:A.queue_depth)??0),xt("최근 결과",((k=A==null?void 0:A.last_result)==null?void 0:k.activity_report)??(A!=null&&A.last_pass_reason?`판단 패스: ${A.last_pass_reason}`:null)??(A!=null&&A.last_system_skip_reason?`시스템 스킵: ${A.last_system_skip_reason}`:null)??((C=L==null?void 0:L.last_tick_result)==null?void 0:C.activity_report)??(L!=null&&L.last_pass_reason?`판단 패스: ${L.last_pass_reason}`:null)??(L!=null&&L.last_system_skip_reason?`시스템 스킵: ${L.last_system_skip_reason}`:null)??(L==null?void 0:L.last_skip_reason)??"없음")]))}if(o&&d.push(ta("Gardener",o.alive?kt("gardener","live"):o.enabled?kt("gardener","starting"):kt("gardener","disabled"),o.alive?"ok":o.enabled?"warn":"bad",[xt("최근 tick",o.last_tick_completed_at?i`<${X} timestamp=${o.last_tick_completed_at} />`:"기록 없음"),xt("판단",`${o.last_intervention??"없음"} · ${o.last_decision_source??"없음"}`),xt("백로그",`미할당 ${(($=o.health_summary)==null?void 0:$.todo_count)??0} · P1/2 ${((y=o.health_summary)==null?void 0:y.high_priority_todo)??0}`)],o.last_reason??o.last_error??void 0)),l){const A=l.masc_loops_running||l.lodge_loop_started||l.lodge_running;d.push(ta("Guardian",A?kt("guardian","live"):l.enabled?kt("guardian","idle"):kt("guardian","disabled"),A?"ok":l.enabled?"warn":"bad",[xt("모드",l.mode??"알 수 없음"),xt("루프",`zombie ${l.zombie_loop_running?"on":"off"} · gc ${l.gc_loop_running?"on":"off"}`),xt("소유자",l.runtime_owner??"없음")],((x=l.last_lodge_result)==null?void 0:x.message)??l.last_gc_result??l.last_zombie_result??void 0))}return c&&d.push(ta("Sentinel",c.started?kt("sentinel","live"):c.enabled?kt("sentinel","starting"):kt("sentinel","disabled"),c.started?"ok":c.enabled?"warn":"bad",[xt("에이전트",c.agent_name??"sentinel"),xt("소비자",((R=c.consumers)==null?void 0:R.length)??0),xt("가디언 소유자",c.guardian_runtime_owner??"없음")],c.llm_enabled===!0?"LLM 기반 housekeeping resident":void 0)),i`
  ...
  `}function Hk(){const t=q.value.tab,e=qo.find(s=>s.id===t),n=lc.find(s=>s.id===(e==null?void 0:e.group));return i`
