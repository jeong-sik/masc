...
let () =
  ...
  run "Keeper_turn_engine guard"
    [
      ( "guard_keeper_hot_path",
        [
          test_case "keeper_managed passes guard" `Quick (fun () ->
              let guard_result =
                Masc_mcp.Keeper_turn_engine.guard_keeper_hot_path
      ...
      ( "dispatch_mode",
        [
          ...
          test_case "oas_dispatch_mode_to_string is stable" `Quick (fun () ->
              let s =
                Masc_mcp.Keeper_turn_engine.oas_dispatch_mode_to_string
      ...
      ( "manifest_fields",
        [
          test_case "fields expose invariant" `Quick (fun () ->
              let fields =
                Masc_mcp.Keeper_turn_engine.manifest_fields
                  Masc_mcp.Keeper_turn_engine.keeper_managed
              in
