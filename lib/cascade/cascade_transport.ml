...
(* Codex CLI runtime MCP tool omission dedup (issue #10097) is owned by
   {!Cascade_codex_omission_dedup}.  Re-exported here so external
   callers (and the call site ~730 lines below) keep their existing
   [Cascade_transport.record_codex_cli_omission*] / *_fingerprint* /
   *_for_tests entry points.  Doc #5 step 9 godfile-split extraction. *)
let codex_cli_omission_fingerprint =
  Cascade_codex_omission_dedup.codex_cli_omission_fingerprint
;;

let codex_cli_omission_fingerprint_seen =
  Cascade_codex_omission_dedup.codex_cli_omission_fingerprint_seen
;;

let record_codex_cli_omission_for_agent =
  Cascade_codex_omission_dedup.record_codex_cli_omission_for_agent
;;

let record_codex_cli_omission = Cascade_codex_omission_dedup.record_codex_cli_omission

let reset_codex_cli_omission_dedup_for_tests =
  Cascade_codex_omission_dedup.reset_codex_cli_omission_dedup_for_tests
;;
