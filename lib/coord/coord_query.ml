...
(** Audit tasks: find claimed/in_progress tasks whose assignees are not active agents.
    Matches assignees by exact name or agent-type prefix (e.g. "agent" matches "agent-xxx").
...
(** Extract seq number from filename like "000001885_unknown_broadcast.json" or "1664_agent_broadcast.json" *)
