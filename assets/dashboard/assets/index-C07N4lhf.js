var pl=Object.defineProperty;var ml=(t,e,n)=>e in t?pl(t,e,{enumerable:!0,configurable:!0,writable:!0,value:n}):t[e]=n;var Ne=(t,e,n)=>ml(t,typeof e!="symbol"?e+"":e,n);import{e as vl,_ as _l,c as _,b as Nt,y as rt,d as Po,A as fl,G as gl}from"./vendor-kuFK4-oj.js";(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const a of document.querySelectorAll('link[rel="modulepreload"]'))s(a);new MutationObserver(a=>{for(const o of a)if(o.type==="childList")for(const r of o.addedNodes)r.tagName==="LINK"&&r.rel==="modulepreload"&&s(r)}).observe(document,{childList:!0,subtree:!0});function n(a){const o={};return a.integrity&&(o.integrity=a.integrity),a.referrerPolicy&&(o.referrerPolicy=a.referrerPolicy),a.crossOrigin==="use-credentials"?o.credentials="include":a.crossOrigin==="anonymous"?o.credentials="omit":o.credentials="same-origin",o}function s(a){if(a.ep)return;a.ep=!0;const o=n(a);fetch(a.href,o)}})();var i=vl.bind(_l);const $l=["mission","execution","live","memory","governance","planning","intervene","command","lab"],Lo={tab:"mission",params:{},postId:null};function Hi(t){return!!t&&$l.includes(t)}function Ja(t){try{return decodeURIComponent(t)}catch{return t}}function Va(t){const e={};return t&&new URLSearchParams(t).forEach((s,a)=>{e[a]=s}),e}function hl(t){const n=t.replace(/^\/+/,"").split("/").filter(Boolean);return n[0]==="dashboard"?n.slice(1):n}function Mo(t,e){if(t[0]==="chains"){const o={...e,surface:"chains"};return t[1]==="operation"&&t[2]&&(o.operation=Ja(t[2])),{tab:"command",params:o,postId:null}}if(t[0]==="lab"){const o={...e};return t[1]&&(o.surface=Ja(t[1])),{tab:"lab",params:o,postId:null}}const n=t[0],s=e.tab;return{tab:Hi(n)?n:Hi(s)?s:"mission",params:e,postId:null}}function ws(t){const e=(t||"").replace(/^#/,"").trim();if(!e)return Lo;const n=Ja(e);let s=n,a;if(n.startsWith("?"))s="",a=n.slice(1);else{const c=n.indexOf("?");c>=0&&(s=n.slice(0,c),a=n.slice(c+1))}!a&&s.includes("=")&&!s.includes("/")&&(a=s,s="");const o=Va(a),r=hl(s);return Mo(r,o)}function yl(t,e){const n=t.replace(/^\/+/,"").split("/").filter(Boolean);if(n[0]!=="dashboard")return null;const s=n.slice(1);if(s.length===0)return{...Lo,params:Va(e.replace(/^\?/,""))};if(s[0]==="assets"||s[0]==="credits"||s[0]==="lodge")return null;const a=Va(e.replace(/^\?/,""));return Mo(s,a)}function Do(t){const e=t.tab==="lab"&&t.params.surface?`lab/${encodeURIComponent(t.params.surface)}`:t.tab,n=Object.entries(t.params).filter(([a])=>!(a==="tab"||t.tab==="lab"&&a==="surface"));if(n.length===0)return`#${e}`;const s=new URLSearchParams(n);return`#${e}?${s.toString()}`}const O=_(ws(window.location.hash));window.addEventListener("hashchange",()=>{O.value=ws(window.location.hash)});function $t(t,e){const n={tab:t,params:e??{}};window.location.hash=Do(n)}function bl(t){window.location.hash=`#memory?post=${encodeURIComponent(t)}`}function kl(){if(window.location.hash&&window.location.hash!=="#"){O.value=ws(window.location.hash);return}const t=yl(window.location.pathname,window.location.search);if(t){O.value=t;const e=Do(t);window.history.replaceState(null,"",`${window.location.pathname}${window.location.search}${e}`);return}window.location.hash="#mission",O.value=ws(window.location.hash)}const Wi="masc_dashboard_sse_session_id",xl=1e3,Sl=15e3,ue=_(!1),aa=_(0),Eo=_(null),Ts=_([]);function Al(){let t=sessionStorage.getItem(Wi);return t||(t=typeof crypto.randomUUID=="function"?`dash_${crypto.randomUUID()}`:`dash_${Date.now().toString(36)}_${Math.random().toString(36).slice(2,10)}`,sessionStorage.setItem(Wi,t)),t}const Cl=200;function wl(t,e,n="system",s={}){const a={agent:t,text:e,timestamp:Date.now(),kind:n,...s};Ts.value=[a,...Ts.value].slice(0,Cl)}function Ya(t,e=88){const n=(t??"").replace(/\s+/g," ").trim();return n?n.length>e?`${n.slice(0,e-3)}...`:n:void 0}function Bi(t,e){const n=Ya(e);return n?`${t}: ${n}`:`New ${t.toLowerCase()}`}function Tt(t,e,n,s,a={}){wl(t,e,n,{eventType:s,...a})}let Et=null,qe=null,Xa=0;function zo(){qe&&(clearTimeout(qe),qe=null)}function Tl(){if(qe)return;Xa++;const t=Math.min(Xa,5),e=Math.min(Sl,xl*Math.pow(2,t));qe=setTimeout(()=>{qe=null,jo()},e)}function jo(){zo(),Et&&(Et.close(),Et=null);const t=new URLSearchParams(window.location.search),e=new URLSearchParams,n=t.get("agent")??t.get("agent_name"),s=t.get("token");n&&e.set("agent",n),s&&e.set("token",s),e.set("session_id",Al());const a=e.toString()?`/sse?${e.toString()}`:"/sse",o=new EventSource(a);Et=o,o.onopen=()=>{Et===o&&(Xa=0,ue.value=!0)},o.onerror=()=>{Et===o&&(ue.value=!1,o.close(),Et=null,Tl())},o.onmessage=r=>{try{const c=JSON.parse(r.data);aa.value++,Eo.value=c,Il(c)}catch{}}}function Il(t){const e=t.type,n=t.agent??t.author??t.from??t.from_agent??"";switch(e){case"agent_joined":Tt(n,"Joined","system","agent_joined");break;case"agent_left":Tt(n,"Left","system","agent_left");break;case"broadcast":Tt(n,`${(t.message??t.content??"").slice(0,80)}`,"system","broadcast");break;case"task_update":Tt(n,`Task: ${t.task_id??""} -> ${t.status??""}`,"tasks","task_update");break;case"board_post":case"masc/board_post":Tt(n,Bi("Post",t.content??t.message),"board","board_post",{author:t.author??n,preview:Ya(t.content??t.message),postId:t.post_id});break;case"board_comment":case"masc/board_comment":Tt(n,Bi("Comment",t.content??t.message),"board","board_comment",{author:t.author??n,preview:Ya(t.content??t.message),postId:t.post_id});break;case"keeper_heartbeat":Tt(t.name??n,`Heartbeat gen=${t.generation??"?"} ctx=${t.context_ratio!=null?Math.round(t.context_ratio*100)+"%":"?"}`,"keepers","keeper_heartbeat");break;case"keeper_handoff":Tt(t.name??n,`Handoff gen ${t.from_generation??"?"} -> ${t.to_generation??"?"} (${t.to_model??"?"})`,"keepers","keeper_handoff");break;case"keeper_compaction":Tt(t.name??n,`Compaction saved ${t.saved_tokens??"?"} tokens (${t.trigger??"?"})`,"keepers","keeper_compaction");break;case"keeper_guardrail":Tt(t.name??n,`Guardrail: ${t.reason??"stopped"}`,"keepers","keeper_guardrail");break;default:Tt(n,e,"system","unknown")}}function Rl(){zo(),Et&&(Et.close(),Et=null),ue.value=!1}function Oo(){return new URLSearchParams(window.location.search)}function Fo(){const t=Oo(),e={},n=t.get("token"),s=t.get("agent")??t.get("agent_name");return n&&(e.Authorization=`Bearer ${n}`),s&&(e["X-MASC-Agent"]=s),e}function qo(){return{...Fo(),"Content-Type":"application/json"}}const Nl=15e3,ki=3e4,Pl=6e4,Gi=new Set([408,425,429,500,502,503,504]);class Bn extends Error{constructor(n){const s=n.method.toUpperCase(),a=n.timeout===!0,o=a?`${s} ${n.path}: timeout after ${n.timeoutMs??0}ms`:`${s} ${n.path}: ${n.status??"unknown"} ${n.statusText??""}`.trim();super(o);Ne(this,"method");Ne(this,"path");Ne(this,"status");Ne(this,"statusText");Ne(this,"timeout");this.name="ApiRequestError",this.method=s,this.path=n.path,this.status=n.status,this.statusText=n.statusText,this.timeout=a}}async function xi(t,e,n){const s=new AbortController,a=setTimeout(()=>s.abort(),n);try{return await fetch(t,{...e,signal:s.signal})}catch(o){if(o instanceof Error&&o.name==="AbortError"){const r=typeof e.method=="string"?e.method.toUpperCase():"GET";throw new Bn({method:r,path:t,timeout:!0,timeoutMs:n})}throw o}finally{clearTimeout(a)}}function Ll(){var e,n;const t=Oo();return((e=t.get("agent"))==null?void 0:e.trim())||((n=t.get("agent_name"))==null?void 0:n.trim())||"dashboard-user"}async function ot(t){const e=await xi(t,{headers:Fo()},Nl);if(!e.ok)throw new Bn({method:"GET",path:t,status:e.status,statusText:e.statusText});return e.json()}function Ml(t){return new Promise(e=>setTimeout(e,t))}function Dl(t){const e=t.match(/\b(\d{3})\b/);if(!e)return null;const n=e[1];if(!n)return null;const s=Number.parseInt(n,10);return Number.isFinite(s)?s:null}function El(t){if(t instanceof Bn)return t.timeout||typeof t.status=="number"&&Gi.has(t.status);if(!(t instanceof Error))return!1;if(/timeout after \d+ms/i.test(t.message))return!0;const e=Dl(t.message);return e!==null&&Gi.has(e)}async function Ko(t,e,n=2){let s=0;for(;;)try{return await e()}catch(a){if(!El(a)||s>=n)throw a;const o=250*(s+1);console.warn(`[dashboard/api] ${t} failed (attempt ${s+1}), retrying in ${o}ms`,a),await Ml(o),s+=1}}async function Bt(t,e,n,s=ki){const a=await xi(t,{method:"POST",headers:{...qo(),...n??{}},body:JSON.stringify(e)},s);if(!a.ok)throw new Bn({method:"POST",path:t,status:a.status,statusText:a.statusText});return a.json()}async function zl(t,e,n,s=ki){const a=await xi(t,{method:"POST",headers:{...qo(),...n??{}},body:JSON.stringify(e)},s);if(!a.ok)throw new Bn({method:"POST",path:t,status:a.status,statusText:a.statusText});return a.text()}function jl(t){const e=t.split(`
`).find(s=>s.startsWith("data: ")),n=e?e.slice(6).trim():t.trim();return JSON.parse(n)}function Ol(t){var e,n,s,a,o,r,c;if((e=t.error)!=null&&e.message)throw new Error(t.error.message);if((n=t.result)!=null&&n.isError){const d=((a=(s=t.result.content)==null?void 0:s[0])==null?void 0:a.text)??"MCP tool call failed";throw new Error(d)}return((c=(r=(o=t.result)==null?void 0:o.content)==null?void 0:r[0])==null?void 0:c.text)??""}async function ve(t,e){const n=await zl("/mcp",{jsonrpc:"2.0",method:"tools/call",params:{name:t,arguments:e},id:Math.floor(Date.now()%1e6)},{Accept:"application/json, text/event-stream"},Pl),s=jl(n);return Ol(s)}function Fl(){return ot("/api/v1/dashboard/shell")}function ql(){return ot("/api/v1/dashboard/execution")}function Kl(t,e){const n=new URLSearchParams;return n.set("sort_by",t),e!=null&&e.excludeSystem&&n.set("exclude_system","true"),ot(`/api/v1/dashboard/memory${n.toString()?`?${n}`:""}`)}function Ul(){return ot("/api/v1/dashboard/governance")}function Hl(){return ot("/api/v1/dashboard/semantics")}function Wl(){return ot("/api/v1/dashboard/mission")}function Bl(t=!1){return ot(`/api/v1/dashboard/mission/briefing${t?"?force=1":""}`)}function Gl(){return ot("/api/v1/dashboard/planning")}function Jl(){return ot("/api/v1/operator")}function Uo(t={}){const e=new URLSearchParams;t.targetType&&e.set("target_type",t.targetType),t.targetId&&e.set("target_id",t.targetId),t.includeWorkers!=null&&e.set("include_workers",t.includeWorkers?"true":"false");const n=e.toString();return ot(`/api/v1/operator/digest${n?`?${n}`:""}`)}function Vl(){return ot("/api/v1/command-plane")}function Yl(){return ot("/api/v1/command-plane/summary")}function Xl(){return ot("/api/v1/chains/summary")}function Ql(t){return ot(`/api/v1/chains/runs/${encodeURIComponent(t)}`)}function Zl(){return ot("/api/v1/command-plane/help")}function tc(t,e){const n=new URLSearchParams;t&&n.set("run_id",t),e&&n.set("operation_id",e);const s=n.toString();return ot(`/api/v1/command-plane/swarm${s?`?${s}`:""}`)}function ec(t,e){return Bt(t,e)}function nc(t){switch(t.action_type){case"keeper_message":case"keeper_recover":return 9e4;case"lodge_tick":return 45e3;default:return ki}}function ia(t){return Bt("/api/v1/operator/action",t,void 0,nc(t))}function sc(t,e){return Bt("/api/v1/operator/confirm",{actor:t,confirm_token:e})}function vn(t){if(typeof t=="string"&&t.trim())return t;if(typeof t!="number"||Number.isNaN(t))return new Date().toISOString();const e=t<1e12?t*1e3:t;return new Date(e).toISOString()}function ac(t){var a;const e=t.trim(),s=((a=(e.startsWith("[flair:")?e.replace(/^\[flair:[^\]]+\]\s*/i,""):e).split(`
`)[0])==null?void 0:a.trim())||"Untitled post";return s.length<=96?s:`${s.slice(0,93)}...`}function ic(t){if(!H(t))return null;const e=h(t.id,"").trim(),n=h(t.author,"").trim(),s=h(t.content,"").trim();if(!e||!n)return null;const a=V(t.score,0),o=V(t.votes_up,0),r=V(t.votes_down,0),c=V(t.votes,a||o-r),d=V(t.comment_count,V(t.reply_count,0)),m=(()=>{const x=t.flair;if(typeof x=="string"&&x.trim())return x.trim();if(H(x)){const N=h(x.name,"").trim();if(N)return N}return h(t.flair_name,"").trim()||void 0})(),u=h(t.created_at_iso,"").trim()||vn(t.created_at),p=h(t.updated_at_iso,"").trim()||(t.updated_at!==void 0?vn(t.updated_at):u),$=h(t.title,"").trim()||ac(s),k=Array.isArray(t.tags)?t.tags.filter(x=>typeof x=="string"&&x.trim()!==""):[];return{id:e,author:n,title:$,content:s,tags:k,votes:c,vote_balance:a,comment_count:d,created_at:u,updated_at:p,flair:m,hearth:h(t.hearth,"").trim()||null,visibility:h(t.visibility,"").trim()||void 0,expires_at:h(t.expires_at_iso,"").trim()||(t.expires_at!==void 0&&t.expires_at!==0?vn(t.expires_at):"")||null,hearth_count:V(t.hearth_count,0)}}function oc(t){if(!H(t))return null;const e=h(t.id,"").trim(),n=h(t.post_id,"").trim(),s=h(t.author,"").trim();return!e||!s?null:{id:e,post_id:n,author:s,content:h(t.content,""),created_at:vn(t.created_at)}}async function rc(t){return Ko("fetchBoardPost",async()=>{const e=await ot(`/api/v1/board/${t}?format=flat`),n=H(e.post)?e.post:e,s=ic(n)??{id:t,author:"unknown",title:"Post",content:"",tags:[],votes:0,comment_count:0,created_at:new Date().toISOString(),updated_at:new Date().toISOString(),hearth:null,visibility:"internal",expires_at:null},o=(Array.isArray(e.comments)?e.comments:[]).map(oc).filter(r=>r!==null);return{...s,comments:o}})}function Ho(t,e){return Bt("/api/v1/tools/masc_board_vote",{post_id:t,direction:e,vote:e,voter:Ll()})}function lc(t,e,n){return Bt("/api/v1/tools/masc_board_comment",{post_id:t,author:e,content:n})}function cc(t){const e=h(t,"").trim().toLowerCase();if(e==="win"||e==="won"||e==="victory")return"victory";if(e==="lose"||e==="lost"||e==="defeat")return"defeat";if(e==="draw"||e==="stalemate"||e==="tie")return"draw"}function pt(...t){for(const e of t){const n=h(e,"");if(n.trim())return n.trim()}return""}function Ji(t){const e=cc(pt(t.outcome,t.result,t.result_code));if(!e)return;const n=pt(t.reason,t.reason_code,t.description,t.detail),s=pt(t.summary,t.summary_ko,t.summary_en,t.note),a=pt(t.details,t.details_text,t.text,t.note),o=pt(t.winner,t.winner_name,t.actor_winner,t.winner_actor),r=pt(t.winner_actor_id,t.winner_actor,t.actor_winner_id),c=pt(t.raw_reason,t.raw_reason_code,t.error_message),d=(()=>{const p=t.evidence??t.evidence_ids??t.supporting_events??t.event_ids??[];return typeof p=="string"?[p]:Array.isArray(p)?p.map(v=>{if(typeof v=="string")return v.trim();if(H(v)){const $=h(v.summary,"").trim();if($)return $;const k=h(v.text,"").trim();if(k)return k;const x=h(v.type,"").trim();return x||h(v.event_id,"").trim()}return""}).filter(v=>v.length>0):[]})(),m=(()=>{const p=V(t.turn,Number.NaN);if(Number.isFinite(p))return p;const v=V(t.turn_number,Number.NaN);if(Number.isFinite(v))return v;const $=V(t.current_turn,Number.NaN);if(Number.isFinite($))return $;const k=V(t.round,Number.NaN);return Number.isFinite(k)?k:void 0})(),u=pt(t.phase,t.phase_name,t.current_phase,t.phase_id);return{result:e,reason:n||void 0,summary:s||void 0,details:a||void 0,winner:o||void 0,winner_actor_id:r||void 0,evidence:d.length>0?d:void 0,raw_reason:c||void 0,turn:m,phase:u||void 0}}function dc(t,e){const n=H(t.state)?t.state:{};if(h(n.status,"active").toLowerCase()!=="ended")return;const a=[...e].reverse().find(r=>H(r)?h(r.type,"")==="session.outcome":!1),o=H(n.session_outcome)?n.session_outcome:{};if(H(o)&&Object.keys(o).length>0){const r=Ji(o);if(r)return r}if(H(a))return Ji(H(a.payload)?a.payload:{})}function H(t){return typeof t=="object"&&t!==null}function h(t,e=""){return typeof t=="string"?t:e}function V(t,e=0){return typeof t=="number"&&Number.isFinite(t)?t:e}function uc(t){if(typeof t=="number"&&Number.isFinite(t))return Math.trunc(t);if(typeof t=="string"){const e=Number.parseInt(t.trim(),10);if(Number.isFinite(e))return e}}function Qa(t,e=!1){return typeof t=="boolean"?t:e}function rn(t){return Array.isArray(t)?t.map(e=>{if(typeof e=="string")return e.trim();if(H(e)){const n=h(e.name,"").trim(),s=h(e.id,"").trim(),a=h(e.skill,"").trim();return n||s||a}return""}).filter(e=>e.length>0):[]}function pc(t){const e={};if(!H(t)&&!Array.isArray(t))return e;if(H(t))return Object.entries(t).forEach(([n,s])=>{const a=n.trim(),o=h(s,"").trim();!a||!o||(e[a]=o)}),e;for(const n of t){if(!H(n))continue;const s=pt(n.to,n.target,n.actor_id,n.name,n.id),a=pt(n.relationship,n.relation,n.type,n.kind);!s||!a||(e[s]=a)}return e}function mc(t,e,n){if(t==="dm"||t==="player"||t==="npc")return t;const s=e.trim().toLowerCase();return s==="dm"||s.startsWith("dm-")?"dm":s.startsWith("npc-")||s.startsWith("enemy-")||s.startsWith("mob-")?"npc":/^p\d+$/i.test(s)||s.startsWith("player-")?"player":typeof n=="string"&&n.trim()!==""?n.trim().toLowerCase().includes("dm")?"dm":"player":"npc"}function kt(t,e,n,s=0){const a=t[e];if(typeof a=="number"&&Number.isFinite(a))return a;if(n){const o=t[n];if(typeof o=="number"&&Number.isFinite(o))return o}return s}const vc=new Set(["str","dex","con","int","wis","cha","strength","dexterity","constitution","intelligence","wisdom","charisma","hp","max_hp","mp","max_mp","level","xp"]);function _c(t){const e=H(t.stats)?t.stats:{},n={};return Object.entries(e).forEach(([s,a])=>{const o=s.trim();o&&(vc.has(o.toLowerCase())||typeof a=="number"&&Number.isFinite(a)&&(n[o]=a))}),n}function fc(t,e){if(t!=="dice.rolled")return;const n=V(e.raw_d20,0),s=V(e.total,0),a=V(e.bonus,0),o=h(e.action,"roll"),r=V(e.dc,0);return{notation:r>0?`${o} (DC ${r})`:o,rolls:n>0?[n]:[],total:s,modifier:a}}function gc(t){const e=JSON.stringify(t);return e?e.length>160?`${e.slice(0,157)}...`:e:""}function $c(t){const e=t.trim().toLowerCase();return e?e.startsWith("dice.")?"dice":e.startsWith("combat.")||e.includes(".attack")||e.includes(".damage")?"combat":e.includes("actor.")?"actor":e.includes("turn.")||e==="turn.started"||e==="phase.changed"?"turn":e.includes("join.")?"join":e.includes("memory")?"memory":e.includes("world.")?"world":e.includes("narration")?"story":"meta":"meta"}function hc(t,e,n,s){const a=n||e||h(s.actor_id,"")||h(s.actor_name,"");switch(t){case"turn.action.proposed":{const o=h(s.proposed_action,h(s.reply,""));return o?`${a||"actor"}: ${o}`:"Action proposed"}case"turn.action.resolved":{const o=h(s.reply,h(s.result,""));return o?`Resolved: ${o}`:"Action resolved"}case"narration.posted":return h(s.reply,h(s.content,h(s.text,"Narration")));case"dice.rolled":{const o=h(s.action,"roll"),r=V(s.total,0),c=V(s.dc,0),d=h(s.label,""),m=a||"actor",u=c>0?` vs DC ${c}`:"",p=d?` (${d})`:"";return`${m} ${o}: ${r}${u}${p}`}case"turn.started":return`Turn ${V(s.turn,1)} started`;case"phase.changed":return`Phase: ${h(s.phase,"round")}`;case"actor.spawned":return`Actor spawned: ${h(s.name,H(s.actor)?h(s.actor.name,a||"unknown"):a||"unknown")}`;case"actor.claimed":return`${h(s.keeper_name,h(s.keeper,"keeper"))} claimed ${a||"actor"}`;case"actor.released":return`${h(s.keeper_name,h(s.keeper,"keeper"))} released ${a||"actor"}`;case"join.window.opened":return`Join window opened (turn ${V(s.turn,0)})`;case"join.window.closed":return`Join window closed (turn ${V(s.turn,0)})`;case"mid.join.requested":return`Mid-join requested: ${a||h(s.actor_id,"actor")}`;case"mid.join.granted":return`Mid-join granted: ${a||h(s.actor_id,"actor")}`;case"mid.join.rejected":return`Mid-join rejected: ${h(s.reason_code,"unknown")}`;case"memory.signal":{const o=H(s.entity_refs)?s.entity_refs:{},r=h(o.requested_tier,""),c=h(o.effective_tier,""),d=Qa(o.guardrail_applied,!1),m=h(s.summary_en,h(s.summary_ko,"Memory signal"));if(!r&&!c)return m;const u=r&&c?`${r}->${c}`:c||r;return`${m} [${u}${d?" (guardrail)":""}]`}case"world.event":{if(h(s.event_type,"")==="canon.check"){const r=h(s.status,"unknown"),c=h(s.contract_id,"n/a");return`Canon ${r}: ${c}`}return h(s.description,h(s.summary,"World event"))}case"combat.attack":return h(s.summary,h(s.result,"Attack resolved"));case"combat.defense":return h(s.summary,h(s.result,"Defense resolved"));case"session.outcome":return h(s.summary,h(s.outcome,"Session ended"));default:{const o=gc(s);return o?`${t}: ${o}`:t}}}function yc(t,e){const n=H(t)?t:{},s=h(n.type,"event"),a=typeof n.actor_id=="string"&&n.actor_id.trim()?n.actor_id.trim():"",o=h(n.actor_name,"").trim()||e[a]||h(H(n.payload)?n.payload.actor_name:"",""),r=H(n.payload)?n.payload:{},c=h(n.ts,h(n.timestamp,new Date().toISOString())),d=h(n.phase,h(r.phase,"")),m=h(n.category,"");return{type:s,actor:o||a||h(r.actor_name,""),actor_id:a||h(r.actor_id,""),actor_name:o,seq:n.seq,room_id:h(n.room_id,""),phase:d||void 0,category:m||$c(s),visibility:h(n.visibility,h(r.visibility,"public")),event_id:h(n.event_id,""),content:hc(s,a,o,r),dice_roll:fc(s,r),timestamp:c}}function bc(t,e,n){var F,tt;const s=h(t.room_id,"")||n||"default",a=H(t.state)?t.state:{},o=H(a.party)?a.party:{},r=H(a.actor_control)?a.actor_control:{},c=H(a.join_gate)?a.join_gate:{},d=H(a.contribution_ledger)?a.contribution_ledger:{},m=Object.entries(o).map(([B,et])=>{const b=H(et)?et:{},Pt=kt(b,"max_hp",void 0,10),ee=kt(b,"hp",void 0,Pt),ge=kt(b,"max_mp",void 0,0),$e=kt(b,"mp",void 0,0),j=kt(b,"level",void 0,1),Lt=kt(b,"xp",void 0,0),he=Qa(b.alive,ee>0),an=r[B],on=typeof an=="string"?an:void 0,ts=mc(b.role,B,on),es=uc(b.generation),ns=pt(b.joined_at,b.joinedAt,b.started_at,b.startedAt),ss=pt(b.claimed_at,b.claimedAt,b.assigned_at,b.assignedAt,b.assigned_time),U=pt(b.last_seen,b.lastSeen,b.last_seen_at,b.lastSeenAt,b.last_active,b.lastActive),Re=pt(b.scene,b.current_scene,b.currentScene,b.world_scene,b.scene_name,b.sceneName),ul=pt(b.location,b.current_location,b.currentLocation,b.position,b.zone,b.area);return{id:B,name:h(b.name,B),role:ts,keeper:on,archetype:h(b.archetype,""),persona:h(b.persona,""),portrait:h(b.portrait,"")||void 0,background:h(b.background,"")||void 0,traits:rn(b.traits),skills:rn(b.skills),stats_raw:_c(b),status:he?"active":"dead",generation:es,joined_at:ns||void 0,claimed_at:ss||void 0,last_seen:U||void 0,scene:Re||void 0,location:ul||void 0,inventory:rn(b.inventory),notes:rn(b.notes),relationships:pc(b.relationships),stats:{hp:ee,max_hp:Pt,mp:$e,max_mp:ge,level:j,xp:Lt,strength:kt(b,"strength","str",10),dexterity:kt(b,"dexterity","dex",10),constitution:kt(b,"constitution","con",10),intelligence:kt(b,"intelligence","int",10),wisdom:kt(b,"wisdom","wis",10),charisma:kt(b,"charisma","cha",10)}}}),u=m.filter(B=>B.status!=="dead"),p=dc(t,e),v={phase_open:Qa(c.phase_open,!0),min_points:V(c.min_points,3),window:h(c.window,"round_boundary_only"),last_opened_turn:typeof c.last_opened_turn=="number"?c.last_opened_turn:null,last_closed_turn:typeof c.last_closed_turn=="number"?c.last_closed_turn:null},$=Object.entries(d).map(([B,et])=>{const b=H(et)?et:{};return{actor_id:B,score:V(b.score,0),last_reason:h(b.last_reason,"")||null,reasons:rn(b.reasons)}}),k=m.reduce((B,et)=>(B[et.id]=et.name,B),{}),x=e.map(B=>yc(B,k)),C=V(a.turn,1),N=h(a.phase,"round"),w=h(a.map,""),E=H(a.world)?a.world:{},P=w||h(E.ascii_map,h(E.map,"")),L=x.filter((B,et)=>{const b=e[et];if(!H(b))return!1;const Pt=H(b.payload)?b.payload:{};return V(Pt.turn,-1)===C}),Y=(L.length>0?L:x).slice(-12),J=h(a.status,"active");return{session:{id:s,room:s,status:J==="ended"?"ended":J==="paused"?"paused":"active",round:C,actors:u,created_at:((F=x[0])==null?void 0:F.timestamp)??new Date().toISOString()},current_round:{round_number:C,phase:N,events:Y,timestamp:((tt=x[x.length-1])==null?void 0:tt.timestamp)??new Date().toISOString()},map:P||void 0,join_gate:v,contribution_ledger:$,outcome:p,party:u,story_log:x,history:[]}}async function kc(t){const e=`?room_id=${encodeURIComponent(t)}`,n=await ot(`/api/v1/trpg/events${e}`);return Array.isArray(n.events)?n.events:[]}async function xc(t){const e=`?room_id=${encodeURIComponent(t)}`,[n,s]=await Promise.all([ot(`/api/v1/trpg/state${e}`),kc(t)]);return bc(n,s,t)}function Sc(t){return Bt("/api/v1/trpg/rounds/run",{room_id:t})}function Ac(t){const e="".trim().toLowerCase();if(e)switch(e){case"discussion":case"discuss":case"party_discussion":case"player_discussion":case"action":case"dice":return"round";case"ended":return"end";default:return e}}function Cc(t){const e={room_id:t.roomId,actor_id:t.actorId,action:t.action,stat_value:t.statValue,dc:t.dc};return t.rawD20!=null&&(e.raw_d20=t.rawD20),t.ruleModule&&(e.rule_module=t.ruleModule),Bt("/api/v1/trpg/dice/roll",e)}function wc(t,e){const n=Ac();return Bt("/api/v1/trpg/turns/advance",{room_id:t,...n?{phase:n}:{}})}function Tc(t,e){var a;const n=(a=e.idempotencyKey)==null?void 0:a.trim(),s={room_id:t};return e.actor_id&&e.actor_id.trim()&&(s.actor_id=e.actor_id.trim()),e.name&&e.name.trim()&&(s.name=e.name.trim()),e.role&&(s.role=e.role),e.archetype&&e.archetype.trim()&&(s.archetype=e.archetype.trim()),e.persona&&e.persona.trim()&&(s.persona=e.persona.trim()),e.portrait&&e.portrait.trim()&&(s.portrait=e.portrait.trim()),e.background&&e.background.trim()&&(s.background=e.background.trim()),e.hp!=null&&(s.hp=e.hp),e.max_hp!=null&&(s.max_hp=e.max_hp),e.alive!=null&&(s.alive=e.alive),Array.isArray(e.traits)&&e.traits.length>0&&(s.traits=e.traits),Array.isArray(e.skills)&&e.skills.length>0&&(s.skills=e.skills),Array.isArray(e.inventory)&&e.inventory.length>0&&(s.inventory=e.inventory),e.stats&&Object.keys(e.stats).length>0&&(s.stats=e.stats),n&&(s.idempotency_key=n),Bt("/api/v1/trpg/actors/spawn",s,n?{"Idempotency-Key":n}:void 0)}function Ic(t,e,n){return Bt("/api/v1/trpg/actors/claim",{room_id:t,actor_id:e,keeper:n})}async function Rc(t,e,n){const s=await ve("trpg.join.eligibility",{room_id:t,actor_id:e,...n?{keeper_name:n}:{}});return JSON.parse(s)}async function Nc(t){const e=await ve("trpg.mid_join.request",t);return JSON.parse(e)}async function Pc(t,e){await ve("masc_broadcast",{agent_name:t,message:e})}async function Lc(t=40){return(await ve("masc_messages",{limit:t})).split(`
`).map(n=>n.trim()).filter(n=>n!=="")}async function Mc(t,e=20){return ve("masc_task_history",{task_id:t,limit:e})}async function Dc(t){const e=await ve("masc_debate_start",{topic:t});try{return JSON.parse(e)}catch{return null}}async function Ec(t){return Ko("fetchDebateStatus",async()=>{const e=encodeURIComponent(t),n=await ot(`/api/v1/council/debates/${e}/summary`);if(!H(n))return null;const s=h(n.id,"").trim();return s?{id:s,topic:h(n.topic,""),status:h(n.status,"open"),support_count:V(n.support_count,0),oppose_count:V(n.oppose_count,0),neutral_count:V(n.neutral_count,0),total_arguments:V(n.total_arguments,0),created_at:vn(n.created_at_iso??n.created_at),summary_text:h(n.summary_text,"")}:null})}function zc(t,e,n){return ve("masc_keeper_msg",{name:t,message:e})}const jc=_(""),Yt=_({}),vt=_({}),Za=_({}),ti=_({}),ei=_({}),ni=_({}),Xt=_({});function ut(t,e,n){t.value={...t.value,[e]:n}}function Zt(t){return typeof t=="object"&&t!==null&&!Array.isArray(t)}function X(t){return typeof t=="string"&&t.trim()!==""?t.trim():void 0}function Rt(t){return typeof t=="number"&&Number.isFinite(t)?t:void 0}function Ee(t){return typeof t=="boolean"?t:void 0}function si(t){return typeof t=="string"&&t.trim()!==""?t:typeof t!="number"||!Number.isFinite(t)||t<=0?null:new Date(t*1e3).toISOString()}function ai(t){return Array.isArray(t)?t.map(e=>X(e)).filter(e=>!!e):[]}function Oc(t){var n;const e=(n=X(t))==null?void 0:n.toLowerCase();return e==="user"||e==="assistant"||e==="system"||e==="tool"?e:"other"}function Fc(t){switch(t){case"user":return"User";case"assistant":return"Keeper";case"system":return"System";case"tool":return"Tool";default:return"Event"}}function $a(t,e){if(!Array.isArray(t))return[];const n=[];for(const s of t){if(!Zt(s))continue;const a=X(s.name);if(!a)continue;const o=X(s[e]);e==="summary"?n.push({name:a,summary:o}):n.push({name:a,reason:o})}return n}function qc(t){if(!Zt(t))return null;const e=X(t.name);return e?{name:e,trigger:X(t.trigger),outcome:X(t.outcome),summary:X(t.summary),reason:X(t.reason)}:null}function Kc(t){const e=t.toLowerCase();return e.includes("graphql")?"graphql_error":e.includes("timeout")||e.includes("model")||e.includes("llm")||e.includes("api key")||e.includes("api_key")||e.includes("provider")?"llm_error":"unknown"}function Uc(t,e){return t==="offline"||t==="degraded"||t==="stale"?"Keeper is not in a healthy reply state. Probe or recover before relying on automation.":e==="quiet_hours"?"Lodge quiet hours are active. Direct messages still work, but scheduled social ticks may look asleep.":e==="min_gap"?"Keeper is inside its proactive cooldown window. Direct messages work now; autonomous check-ins will wait.":e==="never_started"?"Keeper metadata exists but no reply turn has been recorded yet.":"Keeper is reachable. Send a direct message for an immediate response."}function Wo(t,e,n){return X(t)??Uc(e,n)}function Bo(t,e){return typeof t=="boolean"?t:e==="recover"}function Is(t){if(!Zt(t))return null;const e=X(t.health_state),n=X(t.next_action_path),s=X(t.last_reply_status);return!e||!n||!s?null:{health_state:e,quiet_reason:X(t.quiet_reason)??null,next_action_path:n,last_reply_status:s,last_reply_at:si(t.last_reply_at),last_reply_preview:X(t.last_reply_preview)??null,last_error:X(t.last_error)??null,next_eligible_at_s:Rt(t.next_eligible_at_s)??null,recoverable:Bo(t.recoverable,n),summary:Wo(t.summary,e,X(t.quiet_reason)??null),keepalive_running:typeof t.keepalive_running=="boolean"?t.keepalive_running:void 0}}function Go(t){return Zt(t)?{hour:Rt(t.hour),checked:Rt(t.checked)??0,acted:Rt(t.acted)??0,acted_names:ai(t.acted_names),activity_report:X(t.activity_report),quiet_hours_overridden:Ee(t.quiet_hours_overridden),skipped_reason:X(t.skipped_reason),acted_rows:$a(t.acted_rows,"summary").map(e=>({name:e.name,summary:e.summary})),passed_rows:$a(t.passed_rows,"reason").map(e=>({name:e.name,reason:e.reason})),skipped_rows:$a(t.skipped_rows,"reason").map(e=>({name:e.name,reason:e.reason})),checkins:Array.isArray(t.checkins)?t.checkins.map(qc).filter(e=>e!==null):[]}:null}function Hc(t){return Zt(t)?{enabled:Ee(t.enabled)??!1,interval_s:Rt(t.interval_s)??0,quiet_start:Rt(t.quiet_start),quiet_end:Rt(t.quiet_end),quiet_active:Ee(t.quiet_active),use_planner:Ee(t.use_planner),delegate_llm:Ee(t.delegate_llm),agent_count:Rt(t.agent_count),agents:ai(t.agents),last_tick_ago_s:Rt(t.last_tick_ago_s)??null,last_tick_ago:X(t.last_tick_ago),total_ticks:Rt(t.total_ticks),total_checkins:Rt(t.total_checkins),last_skip_reason:X(t.last_skip_reason)??null,last_tick_result:Go(t.last_tick_result),active_self_heartbeats:ai(t.active_self_heartbeats)}:null}function Wc(t){return Zt(t)?{status:t.status,diagnostic:Is(t.diagnostic)}:null}function Bc(t){return Zt(t)?{recovered:Ee(t.recovered)??!1,skipped_reason:X(t.skipped_reason)??null,before:Is(t.before),after:Is(t.after),down:t.down,up:t.up}:null}function Gc(t,e){var w,E;if(!(t!=null&&t.name))return null;const n=X((w=t.agent)==null?void 0:w.status)??X(t.status)??"unknown",s=X((E=t.agent)==null?void 0:E.error)??null,a=t.presence_keepalive??!0,o=t.keepalive_running??!1,r=t.turn_count??0,c=t.last_turn_ago_s??null,d=t.proactive_enabled??!1,m=t.proactive_cooldown_sec??0,u=t.last_proactive_ago_s??null,p=d&&u!=null?Math.max(0,m-u):null,v=r<=0||c==null?"never":c>900?"stale":"fresh",$=typeof t.last_heartbeat=="string"&&t.last_heartbeat.trim()?t.last_heartbeat:null,k=s??(a&&!o?"keeper keepalive is not running":null),x=n==="offline"||n==="inactive"?"offline":k?"degraded":v==="stale"?"stale":v==="never"?"idle":"healthy",C=k?Kc(k):e!=null&&e.quiet_active&&v!=="fresh"?"quiet_hours":a&&!o?"disabled":r<=0?"never_started":p!=null&&p>0?"min_gap":v==="fresh"||v==="stale"?"no_recent_activity":"unknown",N=x==="offline"||x==="degraded"||x==="stale"?"recover":C==="quiet_hours"?"manual_lodge_poke":C==="unknown"?"probe":"direct_message";return{health_state:x,quiet_reason:C,next_action_path:N,last_reply_status:v,last_reply_at:$,last_reply_preview:null,last_error:k,next_eligible_at_s:p!=null&&p>0?p:null,recoverable:Bo(void 0,N),summary:Wo(void 0,x,C),keepalive_running:o}}function Jc(t,e){if(!Zt(t))return null;const n=Oc(t.role),s=X(t.content)??X(t.preview);if(!s)return null;const a=si(t.ts_unix)??si(t.timestamp);return{id:`${n}-${a??"entry"}-${e}`,role:n,label:Fc(n),text:s,timestamp:a,delivery:"history"}}function Vc(t,e,n){const s=Zt(n)?n:null,a=Array.isArray(s==null?void 0:s.history_tail)?s.history_tail.map((o,r)=>Jc(o,r)).filter(o=>o!==null):[];return{name:t,diagnostic:Is(s==null?void 0:s.diagnostic),history:a,rawText:e,rawStatus:n,loadedAt:new Date().toISOString()}}function Vi(t,e){const n=vt.value[t]??[];vt.value={...vt.value,[t]:[...n,e].slice(-50)}}function Yc(t,e){return t.role!==e.role||t.text!==e.text?!1:t.timestamp&&e.timestamp?t.timestamp===e.timestamp:!0}function Xc(t,e){const s=(vt.value[t]??[]).filter(a=>a.delivery!=="history"&&!e.some(o=>Yc(a,o)));vt.value={...vt.value,[t]:[...e,...s].slice(-50)}}function oa(t,e){Yt.value={...Yt.value,[t]:e},Xc(t,e.history)}function Yi(t,e){const n=Yt.value[t];if(!n)return;const s=n.diagnostic??{health_state:"idle",next_action_path:"direct_message",last_reply_status:"unknown"};oa(t,{...n,diagnostic:{...s,...e}})}async function Si(){try{await Gn()}catch(t){console.warn("[keeper-runtime] dashboard refresh failed",t)}}function Qc(t){jc.value=t.trim()}async function Jo(t,e=!1){const n=t.trim();if(!n)return null;if(!e&&Yt.value[n])return Yt.value[n];ut(Za,n,!0),ut(Xt,n,null);try{const s=await ve("masc_keeper_status",{name:n,fast:!1,include_context:!0,include_metrics_overview:!0,include_memory_bank:!1,include_history_tail:!0,include_compaction_history:!1,tail_turns:5,tail_messages:10});let a=null;try{a=JSON.parse(s)}catch{a=null}const o=Vc(n,s,a);return oa(n,o),o}catch(s){const a=s instanceof Error?s.message:`Failed to inspect ${n}`;return ut(Xt,n,a),null}finally{ut(Za,n,!1)}}async function Zc(t,e){const n=t.trim(),s=e.trim();if(!n||!s)return;const a=`local-${Date.now()}`;Vi(n,{id:a,role:"user",label:"You",text:s,timestamp:new Date().toISOString(),delivery:"sending"}),ut(ti,n,!0),ut(Xt,n,null);try{const o=await zc(n,s);vt.value={...vt.value,[n]:(vt.value[n]??[]).map(r=>r.id===a?{...r,delivery:"delivered"}:r)},Vi(n,{id:`reply-${Date.now()}`,role:"assistant",label:n,text:o.trim()||"(empty reply)",timestamp:new Date().toISOString(),delivery:"delivered"}),Yi(n,{last_reply_status:"delivered",last_reply_at:new Date().toISOString(),last_reply_preview:(o.trim()||"(empty reply)").slice(0,200),last_error:null}),await Si()}catch(o){const r=o instanceof Error?o.message:`Failed to send direct message to ${n}`;throw vt.value={...vt.value,[n]:(vt.value[n]??[]).map(c=>c.id===a?{...c,delivery:"error",error:r}:c)},Yi(n,{last_reply_status:"error",last_error:r}),ut(Xt,n,r),o}finally{ut(ti,n,!1)}}async function td(t,e){const n=t.trim();if(!n)return null;ut(ei,n,!0),ut(Xt,n,null);try{const s=await ia({actor:e,action_type:"keeper_probe",target_type:"keeper",target_id:n,payload:{}}),a=Wc(s.result),o=(a==null?void 0:a.diagnostic)??null;if(o){const r=Yt.value[n];oa(n,{name:n,diagnostic:o,history:(r==null?void 0:r.history)??vt.value[n]??[],rawText:(r==null?void 0:r.rawText)??"",rawStatus:s.result,loadedAt:new Date().toISOString()})}return await Si(),o}catch(s){const a=s instanceof Error?s.message:`Failed to probe ${n}`;throw ut(Xt,n,a),s}finally{ut(ei,n,!1)}}async function ed(t,e){const n=t.trim();if(!n)return null;ut(ni,n,!0),ut(Xt,n,null);try{const s=await ia({actor:e,action_type:"keeper_recover",target_type:"keeper",target_id:n,payload:{}}),a=Bc(s.result),o=(a==null?void 0:a.after)??null;if(o){const r=Yt.value[n];oa(n,{name:n,diagnostic:o,history:(r==null?void 0:r.history)??vt.value[n]??[],rawText:(r==null?void 0:r.rawText)??"",rawStatus:s.result,loadedAt:new Date().toISOString()})}return await Si(),o}catch(s){const a=s instanceof Error?s.message:`Failed to recover ${n}`;throw ut(Xt,n,a),s}finally{ut(ni,n,!1)}}function ye(t){return(t??"").trim().toLowerCase()}function ht(t){const e=typeof t=="number"?t:Date.parse(t);return Number.isNaN(e)?0:e}function gs(t,e=88){const n=t.replace(/\s+/g," ").trim();return n&&(n.length>e?`${n.slice(0,e-3)}...`:n)}function as(t){return typeof t!="number"||!Number.isFinite(t)||t<0?null:new Date(Date.now()-t*1e3).toISOString()}function ln(t){return t.last_heartbeat??as(t.last_turn_ago_s)??as(t.last_proactive_ago_s)??as(t.last_handoff_ago_s)??as(t.last_compaction_ago_s)}function nd(t){const e=t.title.trim();return e||gs(t.content)}function sd(t){const e=t.generation??"?",n=typeof t.context_ratio=="number"&&Number.isFinite(t.context_ratio)?`${Math.round(t.context_ratio*100)}%`:"?";return t.last_heartbeat?`Heartbeat gen=${e} ctx=${n}`:`Keeper snapshot gen=${e} ctx=${n}`}function ad(t,e,n,s,a={}){var E;const o=ye(t),r=e.filter(P=>ye(P.assignee)===o&&(P.status==="claimed"||P.status==="in_progress")).length,c=n.filter(P=>ye(P.from)===o).sort((P,L)=>ht(L.timestamp)-ht(P.timestamp))[0],d=s.filter(P=>ye(P.agent)===o||ye(P.author)===o).sort((P,L)=>ht(L.timestamp)-ht(P.timestamp))[0],m=(a.boardPosts??[]).filter(P=>ye(P.author)===o).sort((P,L)=>ht(L.updated_at||L.created_at)-ht(P.updated_at||P.created_at))[0],u=(a.keepers??[]).filter(P=>ye(P.name)===o&&ln(P)!==null).sort((P,L)=>ht(ln(L)??0)-ht(ln(P)??0))[0],p=c?ht(c.timestamp):0,v=d?ht(d.timestamp):0,$=m?ht(m.updated_at||m.created_at):0,k=u?ht(ln(u)??0):0,x=a.lastSeen?ht(a.lastSeen):0,C=((E=a.currentTask)==null?void 0:E.trim())||(r>0?`${r} claimed tasks`:null);if(p===0&&v===0&&$===0&&k===0&&x===0)return{activeAssignedCount:r,lastActivityAt:null,lastActivityText:C};const w=[c?{timestamp:c.timestamp,ts:p,text:gs(c.content)}:null,m?{timestamp:m.updated_at||m.created_at,ts:$,text:`Post: ${gs(nd(m))}`}:null,u?{timestamp:ln(u),ts:k,text:sd(u)}:null,d?{timestamp:new Date(d.timestamp).toISOString(),ts:v,text:gs(d.text)}:null].filter(P=>P!==null).sort((P,L)=>L.ts-P.ts)[0];return w&&w.ts>=x?{activeAssignedCount:r,lastActivityAt:w.timestamp,lastActivityText:w.text}:{activeAssignedCount:r,lastActivityAt:a.lastSeen??null,lastActivityText:C??"Presence heartbeat"}}const wt=_([]),qt=_([]),Xe=_([]),te=_([]),At=_(null),id=_(null),ii=_(new Map),An=_([]),Cn=_("recent"),ze=_(!0),Vo=_(null),Vt=_(""),Ke=_([]),_n=_(!1),Yo=_(new Map),Ai=_("unknown"),Ue=_(null),oi=_(!1),wn=_(!1),ri=_(!1),fn=_(!1),Ci=_(null),Rs=_(!1),Ns=_(null),Xo=_(null),li=_(null),od=_(null),rd=_(null),ld=_(null);Nt(()=>wt.value.filter(t=>t.status==="active"||t.status==="busy"||t.status==="listening"||t.status==="idle"));const Qo=Nt(()=>{const t=qt.value;return{todo:t.filter(e=>e.status==="todo"),inProgress:t.filter(e=>e.status==="in_progress"||e.status==="claimed"),done:t.filter(e=>e.status==="done")}}),ra=Nt(()=>{const t=new Map,e=qt.value,n=Xe.value,s=Ts.value,a=An.value,o=te.value;for(const r of wt.value)t.set(r.name.trim().toLowerCase(),ad(r.name,e,n,s,{currentTask:r.current_task,lastSeen:r.last_seen,boardPosts:a,keepers:o}));return t});function cd(t){var o;const e=((o=t.status)==null?void 0:o.toLowerCase())??"";if(e==="offline"||e==="inactive")return"offline";const n=t.metrics_series;if(!n||n.length===0)return"idle";const s=n[n.length-1];if(!s)return"idle";if(s.is_handoff)return"handoff-imminent";if(s.is_compaction)return"compacting";const a=s.context_ratio;return a>.85?"handoff-imminent":a>.7?"preparing":a>.5?"compacting":"active"}const dd=Nt(()=>{const t=new Map;for(const e of te.value)t.set(e.name,cd(e));return t}),ud=12e4;function pd(t,e){const n=e.get(t.name);if(n!=null)return n;const s=t.last_heartbeat?Date.parse(t.last_heartbeat):Number.NaN;if(!Number.isNaN(s))return s;const a=[t.last_turn_ago_s,t.last_proactive_ago_s,t.last_handoff_ago_s,t.last_compaction_ago_s].find(o=>typeof o=="number"&&Number.isFinite(o)&&o>=0);return typeof a=="number"?Date.now()-a*1e3:null}const md=Nt(()=>{const t=Date.now(),e=new Set,n=ii.value;for(const s of te.value){const a=pd(s,n);a!=null&&t-a>ud&&e.add(s.name)}return e});let ha=null;function vd(t){return t==="dashboard_refresh"||t==="masc/dashboard_refresh"||t.startsWith("goal_")||t.startsWith("masc/goal_")||t.startsWith("mdal_")||t.startsWith("masc/mdal_")||t.startsWith("operator_")||t.startsWith("masc/operator_")||t.startsWith("command_plane_")||t.startsWith("masc/command_plane_")}function dt(t){return typeof t=="object"&&t!==null}function y(t){return typeof t=="string"&&t.trim()!==""?t:void 0}function T(t){return typeof t=="number"&&Number.isFinite(t)?t:void 0}function zt(t){if(!Array.isArray(t))return;const e=t.filter(n=>typeof n=="string"&&n.trim()!=="");return e.length>0?e:void 0}function ci(t){if(typeof t=="string"&&t.trim()!=="")return t;if(!(typeof t!="number"||!Number.isFinite(t)||t<=0))return new Date(t*1e3).toISOString()}function Zo(t){const e=typeof t=="string"?t.toLowerCase():"";return e==="active"||e==="busy"||e==="listening"||e==="idle"||e==="inactive"||e==="offline"?e:e==="in_progress"||e==="claimed"?"busy":"offline"}function _d(t){const e=typeof t=="string"?t.toLowerCase():"";return e==="todo"||e==="in_progress"||e==="claimed"||e==="done"||e==="cancelled"?e:e==="inprogress"?"in_progress":"todo"}function fd(t){if(!dt(t))return null;const e=y(t.name);return e?{name:e,agent_type:y(t.agent_type),status:Zo(t.status),current_task:y(t.current_task)??null,joined_at:y(t.joined_at),last_seen:y(t.last_seen),capabilities:zt(t.capabilities),emoji:y(t.emoji),koreanName:y(t.koreanName)??y(t.korean_name),model:y(t.model),traits:zt(t.traits),interests:zt(t.interests),activityLevel:T(t.activityLevel)??T(t.activity_level),primaryValue:y(t.primaryValue)??y(t.primary_value)}:null}function gd(t){if(!dt(t))return null;const e=y(t.id),n=y(t.title);return!e||!n?null:{id:e,title:n,status:_d(t.status),priority:T(t.priority),assignee:y(t.assignee),description:y(t.description),created_at:y(t.created_at),updated_at:y(t.updated_at)}}function $d(t){if(!dt(t))return null;const e=y(t.from)??y(t.from_agent)??"system",n=y(t.content)??"",s=y(t.timestamp)??new Date().toISOString();return{id:y(t.id),seq:T(t.seq),from:e,content:n,timestamp:s,type:y(t.type)}}function Xi(t){if(typeof t.seq=="number"&&Number.isFinite(t.seq))return t.seq;const e=Date.parse(t.timestamp);return Number.isNaN(e)?0:e}function hd(t,e){if(e.length===0)return t;const n=new Map;for(const s of t){const a=typeof s.seq=="number"?`seq:${s.seq}`:`ts:${s.timestamp}|from:${s.from}|content:${s.content}`;n.set(a,s)}for(const s of e){const a=typeof s.seq=="number"?`seq:${s.seq}`:`ts:${s.timestamp}|from:${s.from}|content:${s.content}`;n.set(a,s)}return[...n.values()].sort((s,a)=>Xi(s)-Xi(a)).slice(-500)}function yd(t){return Array.isArray(t)?t.map(e=>{if(!dt(e))return null;const n=T(e.ts_unix);if(n==null)return null;const s=dt(e.handoff)?e.handoff:null;return{ts:n,context_ratio:T(e.context_ratio)??0,context_tokens:T(e.context_tokens)??0,context_max:T(e.context_max)??0,latency_ms:T(e.latency_ms)??0,generation:T(e.generation)??0,channel:typeof e.channel=="string"?e.channel:"turn",is_handoff:s!=null&&e.handoff_performed===!0,is_compaction:e.compacted===!0,compaction_saved_tokens:T(e.compaction_saved_tokens)??0,compaction_trigger:typeof e.compaction_trigger=="string"?e.compaction_trigger:null,model_used:typeof e.model_used=="string"?e.model_used:"",cost_usd:T(e.cost_usd)??0,handoff_to_model:s&&typeof s.to_model=="string"?s.to_model:null,handoff_new_generation:s?T(s.new_generation)??null:null}}).filter(e=>e!==null):[]}function Qi(t){if(!dt(t))return null;const e=y(t.health_state),n=y(t.next_action_path),s=y(t.last_reply_status);if(!e||!n||!s)return null;const a=y(t.quiet_reason)??null,o=y(t.summary)??(e==="offline"||e==="degraded"||e==="stale"?"Keeper is not in a healthy reply state. Probe or recover before relying on automation.":a==="quiet_hours"?"Lodge quiet hours are active. Direct messages still work, but scheduled social ticks may look asleep.":a==="min_gap"?"Keeper is inside its proactive cooldown window. Direct messages work now; autonomous check-ins will wait.":a==="never_started"?"Keeper metadata exists but no reply turn has been recorded yet.":"Keeper is reachable. Send a direct message for an immediate response.");return{health_state:e,quiet_reason:a,next_action_path:n,last_reply_status:s,last_reply_at:ci(t.last_reply_at)??y(t.last_reply_at)??null,last_reply_preview:y(t.last_reply_preview)??null,last_error:y(t.last_error)??null,next_eligible_at_s:T(t.next_eligible_at_s)??null,recoverable:typeof t.recoverable=="boolean"?t.recoverable:n==="recover",summary:o,keepalive_running:typeof t.keepalive_running=="boolean"?t.keepalive_running:void 0}}function bd(t,e){return(Array.isArray(t)?t:dt(t)&&Array.isArray(t.keepers)?t.keepers:[]).map(s=>{if(!dt(s))return null;const a=dt(s.agent)?s.agent:null,o=dt(s.context)?s.context:null,r=dt(s.metrics_window)?s.metrics_window:void 0,c=y(s.name);if(!c)return null;const d=T(s.context_ratio)??T(o==null?void 0:o.context_ratio),m=y(s.status)??y(a==null?void 0:a.status)??"offline",u=Zo(m),p=y(s.model)??y(s.active_model)??y(s.primary_model),v=zt(s.skill_secondary),$=o?{source:y(o.source),context_ratio:T(o.context_ratio),context_tokens:T(o.context_tokens),context_max:T(o.context_max),message_count:T(o.message_count),has_checkpoint:typeof o.has_checkpoint=="boolean"?o.has_checkpoint:void 0}:void 0,k=a?{name:y(a.name),exists:typeof a.exists=="boolean"?a.exists:void 0,error:y(a.error),agent_type:y(a.agent_type),status:y(a.status),current_task:y(a.current_task)??null,joined_at:y(a.joined_at),last_seen:y(a.last_seen),last_seen_ago_s:T(a.last_seen_ago_s),capabilities:zt(a.capabilities),is_zombie:typeof a.is_zombie=="boolean"?a.is_zombie:void 0}:void 0,x=yd(s.metrics_series),C={name:c,emoji:y(s.emoji),koreanName:y(s.koreanName)??y(s.korean_name),agent_name:y(s.agent_name),trace_id:y(s.trace_id),model:p,primary_model:y(s.primary_model),active_model:y(s.active_model),next_model_hint:y(s.next_model_hint)??null,status:u,presence_keepalive:typeof s.presence_keepalive=="boolean"?s.presence_keepalive:void 0,presence_keepalive_sec:T(s.presence_keepalive_sec),keepalive_running:typeof s.keepalive_running=="boolean"?s.keepalive_running:void 0,proactive_enabled:typeof s.proactive_enabled=="boolean"?s.proactive_enabled:void 0,proactive_idle_sec:T(s.proactive_idle_sec),proactive_cooldown_sec:T(s.proactive_cooldown_sec),last_heartbeat:y(s.last_heartbeat)??y(a==null?void 0:a.last_seen),generation:T(s.generation),turn_count:T(s.turn_count)??T(s.total_turns),keeper_age_s:T(s.keeper_age_s),last_turn_ago_s:T(s.last_turn_ago_s),last_handoff_ago_s:T(s.last_handoff_ago_s),last_compaction_ago_s:T(s.last_compaction_ago_s),last_proactive_ago_s:T(s.last_proactive_ago_s),last_proactive_preview:y(s.last_proactive_preview)??null,context_ratio:d,context_tokens:T(s.context_tokens)??T(o==null?void 0:o.context_tokens),context_max:T(s.context_max)??T(o==null?void 0:o.context_max),context_source:y(s.context_source)??y(o==null?void 0:o.source),context:$,traits:zt(s.traits),interests:zt(s.interests),primaryValue:y(s.primaryValue)??y(s.primary_value),activityLevel:T(s.activityLevel)??T(s.activity_level),memory_recent_note:y(s.memory_recent_note)??null,recent_input_preview:y(s.recent_input_preview)??null,recent_output_preview:y(s.recent_output_preview)??null,recent_tool_names:zt(s.recent_tool_names)??[],conversation_tail_count:T(s.conversation_tail_count),k2k_count:T(s.k2k_count),handoff_count_total:T(s.handoff_count_total)??T(s.trace_history_count),compaction_count:T(s.compaction_count),last_compaction_saved_tokens:T(s.last_compaction_saved_tokens),diagnostic:Qi(s.diagnostic),skill_primary:y(s.skill_primary)??null,skill_secondary:v,skill_reason:y(s.skill_reason)??null,metrics_series:x.length>0?x:void 0,metrics_window:r,agent:k};return C.diagnostic=Qi(s.diagnostic)??Gc(C,(e==null?void 0:e.lodge)??null),C}).filter(s=>s!==null)}function tr(t){return dt(t)?{...t,lodge:Hc(t.lodge)??void 0}:null}function kd(t){const e=typeof t=="string"?t.toLowerCase():"";return e==="running"||e==="interrupted"||e==="completed"||e==="stopped"||e==="error"?e:e.startsWith("error")?"error":"running"}function xd(t){if(!dt(t))return null;const e=T(t.iteration);if(e==null)return null;const n=T(t.metric_before)??0,s=T(t.metric_after)??n,a=dt(t.evidence)?t.evidence:null;return{iteration:e,metric_before:n,metric_after:s,delta:T(t.delta)??s-n,changes:y(t.changes)??"",failed_attempts:y(t.failed_attempts)??"",next_suggestion:y(t.next_suggestion)??"",elapsed_ms:T(t.elapsed_ms)??0,cost_usd:T(t.cost_usd)??null,evidence:a?{worker_engine:(a.worker_engine==="api_tool_loop","api_tool_loop"),worker_model:y(a.worker_model)??"",tool_call_count:T(a.tool_call_count)??0,tool_names:zt(a.tool_names)??[],session_id:y(a.session_id)??"",evidence_status:a.evidence_status==="legacy_unverified"?"legacy_unverified":"verified"}:null}}function Sd(t){var o,r;if(!dt(t))return null;const e=y(t.loop_id);if(!e)return null;const n=T(t.baseline_metric)??0,s=Array.isArray(t.history)?t.history.map(xd).filter(c=>c!==null):[],a=T(t.current_metric)??((o=s[0])==null?void 0:o.metric_after)??n;return{loop_id:e,profile:y(t.profile)??"unknown",status:kd(t.status),strict_mode:typeof t.strict_mode=="boolean"?t.strict_mode:void 0,error_message:y(t.error_message)??y(t.error_reason)??null,stop_reason:y(t.stop_reason)??y(t.reason)??null,current_iteration:T(t.current_iteration)??((r=s[0])==null?void 0:r.iteration)??0,max_iterations:T(t.max_iterations)??0,baseline_metric:n,current_metric:a,target:y(t.target)??"",stagnation_streak:T(t.stagnation_streak)??0,stagnation_limit:T(t.stagnation_limit)??0,elapsed_seconds:T(t.elapsed_seconds)??0,updated_at:ci(t.updated_at)??null,stopped_at:ci(t.stopped_at)??null,execution_mode:t.execution_mode==="worker_spawn"?"worker_spawn":void 0,worker_engine:t.worker_engine==="api_tool_loop"?"api_tool_loop":null,worker_model:y(t.worker_model)??null,evidence_policy:t.evidence_policy==="hard"||t.evidence_policy==="legacy"?t.evidence_policy:void 0,latest_tool_call_count:T(t.latest_tool_call_count)??0,latest_tool_names:zt(t.latest_tool_names)??[],session_id:y(t.session_id)??null,evidence_status:t.evidence_status==="legacy_unverified"?"legacy_unverified":t.evidence_status==="verified"?"verified":null,durability:t.durability==="persistent_backend"||t.durability==="memory_only"?t.durability:void 0,persistence_backend:t.persistence_backend==="filesystem"||t.persistence_backend==="postgres"||t.persistence_backend==="memory"?t.persistence_backend:void 0,recoverable:typeof t.recoverable=="boolean"?t.recoverable:void 0,history:s}}async function Gn(){oi.value=!0;try{await Promise.all([nr(),Jt()]),Xo.value=new Date().toISOString()}catch(t){console.error("Dashboard refresh error:",t)}finally{oi.value=!1}}async function er(){Rs.value=!0,Ns.value=null;try{const t=await Hl();Ci.value=t,ld.value=new Date().toISOString()}catch(t){Ns.value=t instanceof Error?t.message:"Failed to load dashboard semantics"}finally{Rs.value=!1}}function Ad(t){var e;return((e=Ci.value)==null?void 0:e.surfaces.find(n=>n.id===t))??null}function Cd(t){var n;const e=((n=Ci.value)==null?void 0:n.surfaces)??[];for(const s of e){const a=s.panels.find(o=>o.id===t);if(a)return a}return null}function wd(t){var s,a;Ke.value=(Array.isArray(t.goals)?t.goals:[]).map(o=>{if(!dt(o))return null;const r=y(o.id),c=y(o.title),d=y(o.horizon),m=y(o.status),u=y(o.created_at),p=y(o.updated_at);return!r||!c||!d||!m||!u||!p?null:{id:r,horizon:d,title:c,metric:y(o.metric)??null,target_value:y(o.target_value)??null,due_date:y(o.due_date)??null,priority:T(o.priority)??3,status:m,parent_goal_id:y(o.parent_goal_id)??null,last_review_note:y(o.last_review_note)??null,last_review_at:y(o.last_review_at)??null,created_at:u,updated_at:p}}).filter(o=>o!==null);const e=new Map,n=Array.isArray((s=t.mdal)==null?void 0:s.loops)?t.mdal.loops:[];for(const o of n){const r=Sd(o);r&&e.set(r.loop_id,r)}Yo.value=e,Ue.value=typeof((a=t.mdal)==null?void 0:a.error)=="string"?t.mdal.error:null,Ai.value=Ue.value?"error":e.size===0?"idle":"ready"}async function nr(){try{const t=await Fl(),e=tr(t.status);e&&(At.value=e)}catch(t){console.error("Dashboard shell fetch error:",t)}}async function Jt(){var t;try{const e=await ql(),n=tr(e.status),s=(t=At.value)==null?void 0:t.room;n&&(At.value=n);const a=s!=null&&(n==null?void 0:n.room)!=null&&s!==n.room;wt.value=(Array.isArray(e.agents)?e.agents:[]).map(fd).filter(r=>r!==null),qt.value=(Array.isArray(e.tasks)?e.tasks:[]).map(gd).filter(r=>r!==null);const o=(Array.isArray(e.messages)?e.messages:[]).map($d).filter(r=>r!==null);Xe.value=a?o:hd(Xe.value,o),te.value=bd(e.keepers,n??At.value),id.value=null,Xo.value=new Date().toISOString()}catch(e){console.error("Dashboard execution fetch error:",e)}}async function Kt(){wn.value=!0;try{const t=await Kl(Cn.value,{excludeSystem:ze.value});An.value=t.posts??[],li.value=new Date().toISOString()}catch(t){console.error("Board fetch error:",t)}finally{wn.value=!1}}async function Ut(){var t;ri.value=!0;try{const e=Vt.value||((t=At.value)==null?void 0:t.room)||"default";Vt.value||(Vt.value=e);const n=await xc(e);Vo.value=n}catch(e){console.error("TRPG fetch error:",e)}finally{ri.value=!1}}async function Tn(){_n.value=!0,fn.value=!0;try{const t=await Gl();wd(t),od.value=new Date().toISOString(),rd.value=new Date().toISOString()}catch(t){console.error("Planning fetch error:",t),Ai.value="error",Ue.value=t instanceof Error?t.message:String(t)}finally{_n.value=!1,fn.value=!1}}async function sr(){return Tn()}let $s=null;function Td(t){$s=t}let hs=null;function Id(t){hs=t}let ys=null;function Rd(t){ys=t}const Se={};function be(t,e,n=500){Se[t]&&clearTimeout(Se[t]),Se[t]=setTimeout(()=>{e(),delete Se[t]},n)}function Nd(){const t=Eo.subscribe(e=>{if(e){if(e.type==="keeper_heartbeat"&&e.name){const n=new Map(ii.value);n.set(e.name,e.ts_unix?e.ts_unix*1e3:Date.now()),ii.value=n;return}(e.type==="agent_joined"||e.type==="agent_left")&&be("execution",Jt),vd(e.type)&&(ha||(ha=setTimeout(()=>{Gn(),hs==null||hs(),ys==null||ys(),ha=null},500))),(e.type.startsWith("task_")||e.type.startsWith("masc/task_"))&&be("execution",Jt),e.type==="broadcast"&&be("execution",Jt),(e.type==="keeper_handoff"||e.type==="keeper_compaction"||e.type==="keeper_guardrail")&&be("execution",Jt),(e.type==="board_post"||e.type==="masc/board_post"||e.type==="board_comment"||e.type==="masc/board_comment")&&be("board",Kt),e.type.startsWith("decision_")&&be("council",()=>$s==null?void 0:$s()),(e.type==="mdal_started"||e.type==="mdal_iteration"||e.type==="mdal_completed"||e.type==="mdal_stopped")&&be("mdal",sr,350)}});return()=>{t();for(const e of Object.keys(Se))clearTimeout(Se[e]),delete Se[e]}}let gn=null;function Pd(){gn||(gn=setInterval(()=>{ue.value,Gn()},1e4))}function Ld(){gn&&(clearInterval(gn),gn=null)}function Md({metric:t}){return i`
  ...
  `}function z({panelId:t,compact:e=!1,label:n="Why"}){const s=Cd(t);return s?i`
    <details class="semantic-inline ${e?"compact":""}">
      <summary class="semantic-summary">${n}</summary>
      <${Dd} panel=${s} />
    </details>
  `:Rs.value?i`<span class="semantic-inline-state">Loading semantics…</span>`:null}function Ct({surfaceId:t,compact:e=!1}){const n=Ad(t);return n?i`
  ...
  `:Rs.value?i`<div class="semantic-surface-card ${e?"compact":""}">Loading semantics…</div>`:Ns.value?i`<div class="semantic-surface-card ${e?"compact":""}">${Ns.value}</div>`:null}function R({title:t,class:e,semanticId:n,children:s}){return i`
    <div class="card ${e??""}">
      ${t?i`
  ...
  `}function Ed(t){const e=t.indexOf("-");if(e<0)return{model:t,nickname:t,isKeeper:t==="keeper"};const n=t.slice(0,e),s=t.slice(e+1);return{model:n,nickname:s,isKeeper:n==="keeper"}}function zd(t){return t==="keeper"||t.startsWith("keeper-")}const la=_(null),di=_(!1),Ps=_(null),ar=_(null),je=_(!1),xe=_(null);let He=null;function Zi(){He!==null&&(window.clearTimeout(He),He=null)}function jd(t=1500){He===null&&(He=window.setTimeout(()=>{He=null,In(!1)},t))}function q(t){return typeof t=="object"&&t!==null&&!Array.isArray(t)}function I(t){return typeof t=="string"&&t.trim()!==""?t:void 0}function K(t){return typeof t=="number"&&Number.isFinite(t)?t:void 0}function We(t){return typeof t=="boolean"?t:void 0}function St(t,e=[]){if(Array.isArray(t))return t;if(!q(t))return[];for(const n of e){const s=t[n];if(Array.isArray(s))return s}return[]}function ca(t){if(!q(t))return null;const e=I(t.kind),n=I(t.summary),s=I(t.target_type);return!e||!n||!s?null:{kind:e,severity:I(t.severity)??"warn",summary:n,target_type:s,target_id:I(t.target_id)??null,actor:I(t.actor)??null,evidence:t.evidence}}function da(t){if(!q(t))return null;const e=I(t.action_type),n=I(t.target_type),s=I(t.reason);return!e||!n||!s?null:{action_type:e,target_type:n,target_id:I(t.target_id)??null,severity:I(t.severity)??"warn",reason:s,confirm_required:We(t.confirm_required),suggested_payload:t.suggested_payload,preview:t.preview}}function Od(t){if(!q(t))return null;const e=I(t.session_id);return e?{session_id:e,goal:I(t.goal),status:I(t.status),health:I(t.health),scale_profile:I(t.scale_profile),control_profile:I(t.control_profile),planned_worker_count:K(t.planned_worker_count),active_agent_count:K(t.active_agent_count),last_turn_age_sec:K(t.last_turn_age_sec)??null,attention_count:K(t.attention_count),recommended_action_count:K(t.recommended_action_count),top_attention:ca(t.top_attention),top_recommendation:da(t.top_recommendation)}:null}function Fd(t){if(!q(t))return null;const e=I(t.session_id);if(!e)return null;const n=q(t.status)?t.status:t,s=q(n.summary)?n.summary:void 0;return{session_id:e,status:I(t.status)??I(s==null?void 0:s.status)??(q(n.session)?I(n.session.status):void 0),progress_pct:K(t.progress_pct)??K(s==null?void 0:s.progress_pct),elapsed_sec:K(t.elapsed_sec)??K(s==null?void 0:s.elapsed_sec),remaining_sec:K(t.remaining_sec)??K(s==null?void 0:s.remaining_sec),done_delta_total:K(t.done_delta_total)??K(s==null?void 0:s.done_delta_total),summary:q(t.summary)?t.summary:s,team_health:q(t.team_health)?t.team_health:q(n.team_health)?n.team_health:void 0,communication_metrics:q(t.communication_metrics)?t.communication_metrics:q(n.communication_metrics)?n.communication_metrics:void 0,orchestration_state:q(t.orchestration_state)?t.orchestration_state:q(n.orchestration_state)?n.orchestration_state:void 0,cascade_metrics:q(t.cascade_metrics)?t.cascade_metrics:q(n.cascade_metrics)?n.cascade_metrics:void 0,report_paths:q(t.report_paths)?Object.fromEntries(Object.entries(t.report_paths).map(([a,o])=>{const r=I(o);return r?[a,r]:null}).filter(a=>a!==null)):q(n.report_paths)?Object.fromEntries(Object.entries(n.report_paths).map(([a,o])=>{const r=I(o);return r?[a,r]:null}).filter(a=>a!==null)):void 0,session:q(t.session)?t.session:q(n.session)?n.session:void 0,recent_events:St(t.recent_events,["events"]).filter(q)}}function qd(t){if(!q(t))return null;const e=I(t.name);return e?{name:e,agent_name:I(t.agent_name),status:I(t.status),autonomy_level:I(t.autonomy_level),context_ratio:K(t.context_ratio),generation:K(t.generation),active_goal_ids:St(t.active_goal_ids).map(n=>typeof n=="string"?n.trim():"").filter(Boolean),last_autonomous_action_at:I(t.last_autonomous_action_at)??null,last_turn_ago_s:K(t.last_turn_ago_s),model:I(t.model)}:null}function Kd(t){if(!q(t))return null;const e=I(t.confirm_token)??I(t.token);return e?{confirm_token:e,actor:I(t.actor),action_type:I(t.action_type),target_type:I(t.target_type),target_id:I(t.target_id)??null,delegated_tool:I(t.delegated_tool),created_at:I(t.created_at),preview:t.preview}:null}function Ud(t){if(!q(t))return null;const e=I(t.action_type),n=I(t.target_type);return!e||!n?null:{action_type:e,target_type:n,description:I(t.description),confirm_required:We(t.confirm_required)}}function Hd(t){const e=q(t)?t:{};return{room_health:I(e.room_health),cluster:I(e.cluster),project:I(e.project),current_room:I(e.current_room)??null,paused:We(e.paused),tempo_interval_s:K(e.tempo_interval_s),active_agents:K(e.active_agents),keeper_pressure:K(e.keeper_pressure),active_operations:K(e.active_operations),pending_approvals:K(e.pending_approvals),incident_count:K(e.incident_count),recommended_action_count:K(e.recommended_action_count),top_attention:ca(e.top_attention),top_action:da(e.top_action)}}function Wd(t){const e=q(t)?t:{},n=q(e.swarm_overview)?e.swarm_overview:{};return{health:I(e.health),active_operations:K(e.active_operations),pending_approvals:K(e.pending_approvals),swarm_overview:{active_lanes:K(n.active_lanes),moving_lanes:K(n.moving_lanes),stalled_lanes:K(n.stalled_lanes),projected_lanes:K(n.projected_lanes),last_movement_at:I(n.last_movement_at)??null},top_attention:ca(e.top_attention),top_action:da(e.top_action),session_cards:St(e.session_cards).map(Od).filter(s=>s!==null)}}function Bd(t){const e=q(t)?t:{};return{sessions:St(e.sessions,["items"]).map(Fd).filter(n=>n!==null),keepers:St(e.keepers,["items"]).map(qd).filter(n=>n!==null),pending_confirms:St(e.pending_confirms).map(Kd).filter(n=>n!==null),available_actions:St(e.available_actions).map(Ud).filter(n=>n!==null)}}function Gd(t){const e=q(t)?t:{};return{generated_at:I(e.generated_at),summary:Hd(e.summary),incidents:St(e.incidents).map(ca).filter(n=>n!==null),recommended_actions:St(e.recommended_actions).map(da).filter(n=>n!==null),command_focus:Wd(e.command_focus),operator_targets:Bd(e.operator_targets)}}function Jd(t){if(!q(t))return null;const e=I(t.id),n=I(t.label),s=I(t.summary);if(!e||!n||!s)return null;const a=I(t.status)??"unclear";return{id:e,label:n,status:a==="ok"||a==="healthy"||a==="aligned"||a==="watch"||a==="risk"||a==="unclear"?a:"unclear",summary:s,evidence:St(t.evidence).map(r=>typeof r=="string"?r.trim():"").filter(Boolean)}}function Vd(t){const e=q(t)?t:{},n=q(e.basis)?e.basis:{},s=I(e.status)??"error",a=s==="ok"||s==="pending"||s==="unavailable"||s==="error"?s:"error";return{generated_at:I(e.generated_at),cached:We(e.cached),stale:We(e.stale),refreshing:We(e.refreshing),status:a,summary:I(e.summary)??null,model:I(e.model)??null,ttl_sec:K(e.ttl_sec),criteria:St(e.criteria).map(o=>typeof o=="string"?o.trim():"").filter(Boolean),basis:{current_room:I(n.current_room)??null,crew_count:K(n.crew_count),agent_count:K(n.agent_count),keeper_count:K(n.keeper_count)},sections:St(e.sections).map(Jd).filter(o=>o!==null),error:I(e.error)??null,last_error:I(e.last_error)??null}}async function bs(){di.value=!0,Ps.value=null;try{const t=await Wl();la.value=Gd(t)}catch(t){Ps.value=t instanceof Error?t.message:"Failed to load mission snapshot"}finally{di.value=!1}}async function In(t=!1){je.value=!0,xe.value=null;try{const e=await Bl(t),n=Vd(e);ar.value=n,n.refreshing||n.status==="pending"?jd():Zi()}catch(e){xe.value=e instanceof Error?e.message:"Failed to load mission briefing",Zi()}finally{je.value=!1}}function _e({status:t,label:e}){return i`
    <span class="status-badge ${t}">
      <span class="status-dot-inline ${t}"></span>
      ${e??t}
    </span>
  `}function ir(t){const e=Date.now(),n=typeof t=="number"?t<1e12?t*1e3:t:new Date(t).getTime(),s=Math.floor((e-n)/1e3);if(s<60)return`${s}s ago`;const a=Math.floor(s/60);if(a<60)return`${a}m ago`;const o=Math.floor(a/60);return o<24?`${o}h ago`:`${Math.floor(o/24)}d ago`}function it({timestamp:t}){const e=ir(t),n=typeof t=="string"?t:new Date(t<1e12?t*1e3:t).toISOString();return i`<span class="time-ago" title=${n}>${e}</span>`}let Yd=0;const Ae=_([]);function M(t,e="success",n=4e3){const s=++Yd;Ae.value=[...Ae.value,{id:s,message:t,type:e}],setTimeout(()=>{Ae.value=Ae.value.filter(a=>a.id!==s)},n)}function Xd(t){Ae.value=Ae.value.filter(e=>e.id!==t)}function Qd(){const t=Ae.value;return t.length===0?null:i`
    <div class="toast-container">
      ${t.map(e=>i`
        <div key=${e.id} class="toast ${e.type}" onClick=${()=>Xd(e.id)}>
          ${e.message}
        </div>
      `)}
    </div>
  `}const Zd="masc_dashboard_agent_name",nn=_(null),Ls=_(!1),Rn=_(""),Ms=_([]),Nn=_([]),Be=_(""),$n=_(!1);function ua(t){nn.value=t,wi()}function to(){nn.value=null,Rn.value="",Ms.value=[],Nn.value=[],Be.value=""}function tu(){const t=nn.value;return t?wt.value.find(e=>e.name===t)??null:null}function or(t){return t?qt.value.filter(e=>e.assignee===t):[]}function rr(t){return t?te.value.find(e=>e.agent_name===t||e.name===t)??null:null}function eu(t){if(!t)return[];const e=t.metrics_window;return(Array.isArray(e==null?void 0:e.top_tools)?e.top_tools:[]).map(s=>typeof s=="object"&&s!==null&&"tool"in s&&typeof s.tool=="string"?s.tool:null).filter(s=>s!==null)}function nu(t){const e=rr(t);return e?e.recent_tool_names&&e.recent_tool_names.length>0?e.recent_tool_names:[]:[]}async function wi(){const t=nn.value;if(t){Ls.value=!0,Rn.value="",Ms.value=[],Nn.value=[];try{const e=await Lc(80);Ms.value=e.filter(a=>a.includes(t)).slice(0,20);const n=or(t).slice(0,6);if(n.length===0)return;const s=await Promise.all(n.map(async a=>{try{const o=await Mc(a.id,25);return{taskId:a.id,text:o.trim()}}catch(o){const r=o instanceof Error?o.message:"history load failed";return{taskId:a.id,text:`Failed to load history: ${r}`}}}));Nn.value=s}catch(e){Rn.value=e instanceof Error?e.message:"Failed to load agent detail"}finally{Ls.value=!1}}}async function eo(){var s;const t=nn.value,e=Be.value.trim();if(!t||!e)return;const n=((s=localStorage.getItem(Zd))==null?void 0:s.trim())||"dashboard";$n.value=!0;try{await Pc(n,`@${t} ${e}`),Be.value="",M(`Mention sent to ${t}`,"success"),wi()}catch(a){const o=a instanceof Error?a.message:"Failed to send mention";M(o,"error")}finally{$n.value=!1}}function su({task:t}){return i`
    <div class="agent-detail-task">
      <span class="pill">${t.id}</span>
      <span class="agent-detail-task-title">${t.title}</span>
      <${_e} status=${t.status} />
    </div>
  `}function au({row:t}){return i`
  ...
  `}function iu(){var p,v,$,k,x,C,N;const t=nn.value;if(!t)return null;const e=tu(),n=rr(t),s=or(t),a=Ms.value,o=nu(t),r=eu(n),c=(e==null?void 0:e.capabilities)??[],d=((p=At.value)==null?void 0:p.room)??"default",m=((v=At.value)==null?void 0:v.project)??"확인 없음",u=(($=At.value)==null?void 0:$.cluster)??"확인 없음";return i`
    <div
      class="agent-detail-overlay"
      onClick=${w=>{w.target.classList.contains("agent-detail-overlay")&&to()}}
    >
      <div class="agent-detail-modal">
        <div class="agent-detail-header">
          <div style="display:flex;flex-direction:column;gap:8px;flex:1">
            ...
            ${(((C=e==null?void 0:e.interests)==null?void 0:C.length)??0)>0?i`
              <div style="display:flex;flex-wrap:wrap;gap:4px">
                ${(N=e==null?void 0:e.interests)==null?void 0:N.map(w=>i`<span style="font-size:0.7rem;background:#3b1f4e;color:#c084fc;padding:2px 8px;border-radius:10px">${w}</span>`)}
              </div>
            `:""}
            ${c.length>0?i`
              <div style="display:flex;flex-wrap:wrap;gap:4px">
          ...
          <div class="agent-detail-actions">
            <button class="control-btn ghost" onClick=${()=>{wi()}} disabled=${Ls.value}>
        ...
        <div class="agent-detail-grid">
          <${R} title="Assigned Tasks">
            ${s.length===0?i`<div class="empty-state">No assigned tasks</div>`:i`<div class="agent-detail-task-list">${s.map(w=>i`<${su} key=${w.id} task=${w} />`)}</div>`}
          <//>
        ...
        <${R} title="Task History">
          ${Nn.value.length===0?i`<div class="empty-state">No task history loaded</div>`:i`<div class="agent-history-list">${Nn.value.map(w=>i`<${au} key=${w.taskId} row=${w} />`)}</div>`}
        <//>
  ...
  `}const Ht=_(null),lr=_(null),Wt=_(null),Pn=_(!1),pe=_(null),Ln=_(!1),Qe=_(null),Q=_(!1),Ds=_([]);let ou=1;function W(t){return typeof t=="object"&&t!==null&&!Array.isArray(t)}function S(t){return typeof t=="string"&&t.trim()!==""?t:void 0}function at(t){return typeof t=="number"&&Number.isFinite(t)?t:void 0}function pa(t){return typeof t=="boolean"?t:void 0}function ru(t){return Array.isArray(t)?t.map(e=>typeof e=="string"?e.trim():"").filter(Boolean):[]}function jt(t,e=[]){if(Array.isArray(t))return t;if(!W(t))return[];for(const n of e){const s=t[n];if(Array.isArray(s))return s}return[]}function lu(t){return W(t)?{id:S(t.id),seq:at(t.seq),from:S(t.from)??S(t.from_agent)??"system",content:S(t.content)??"",timestamp:S(t.timestamp)??new Date().toISOString(),type:S(t.type)}:null}function cu(t){return W(t)?{room_id:S(t.room_id),current_room:S(t.current_room)??S(t.room),project:S(t.project),cluster:S(t.cluster),paused:pa(t.paused),pause_reason:S(t.pause_reason)??null,paused_by:S(t.paused_by)??null,paused_at:S(t.paused_at)??null}:{}}function no(t){if(!W(t))return;const e=Object.entries(t).map(([n,s])=>{const a=S(s);return a?[n,a]:null}).filter(n=>n!==null);return e.length>0?Object.fromEntries(e):void 0}function cr(t){if(!W(t))return null;const e=S(t.kind),n=S(t.summary),s=S(t.target_type);return!e||!n||!s?null:{kind:e,severity:S(t.severity)??"warn",summary:n,target_type:s,target_id:S(t.target_id)??null,actor:S(t.actor)??null,evidence:t.evidence}}function dr(t){if(!W(t))return null;const e=S(t.action_type),n=S(t.target_type),s=S(t.reason);return!e||!n||!s?null:{action_type:e,target_type:n,target_id:S(t.target_id)??null,severity:S(t.severity)??"warn",reason:s,confirm_required:pa(t.confirm_required),suggested_payload:t.suggested_payload,preview:t.preview}}function du(t){return W(t)?{actor:S(t.actor)??null,spawn_agent:S(t.spawn_agent)??null,spawn_role:S(t.spawn_role)??null,spawn_model:S(t.spawn_model)??null,worker_class:S(t.worker_class)??null,parent_actor:S(t.parent_actor)??null,capsule_mode:S(t.capsule_mode)??null,runtime_pool:S(t.runtime_pool)??null,lane_id:S(t.lane_id)??null,controller_level:S(t.controller_level)??null,control_domain:S(t.control_domain)??null,supervisor_actor:S(t.supervisor_actor)??null,model_tier:S(t.model_tier)??null,task_profile:S(t.task_profile)??null,risk_level:S(t.risk_level)??null,routing_confidence:at(t.routing_confidence)??null,routing_reason:S(t.routing_reason)??null,status:S(t.status)??"unknown",turn_count:at(t.turn_count)??0,empty_note_turn_count:at(t.empty_note_turn_count)??0,has_turn:pa(t.has_turn)??!1,last_turn_ts_iso:S(t.last_turn_ts_iso)??null}:null}function uu(t){if(!W(t))return null;const e=S(t.session_id);return e?{session_id:e,goal:S(t.goal),status:S(t.status),health:S(t.health),scale_profile:S(t.scale_profile),control_profile:S(t.control_profile),planned_worker_count:at(t.planned_worker_count),active_agent_count:at(t.active_agent_count),last_turn_age_sec:at(t.last_turn_age_sec)??null,attention_count:at(t.attention_count),recommended_action_count:at(t.recommended_action_count),top_attention:cr(t.top_attention),top_recommendation:dr(t.top_recommendation)}:null}function ur(t){const e=W(t)?t:{};return{trace_id:S(e.trace_id),target_type:S(e.target_type)??"room",target_id:S(e.target_id)??null,health:S(e.health),swarm_status:W(e.swarm_status)?e.swarm_status:void 0,attention_items:jt(e.attention_items).map(cr).filter(n=>n!==null),recommended_actions:jt(e.recommended_actions).map(dr).filter(n=>n!==null),session_cards:jt(e.session_cards).map(uu).filter(n=>n!==null),worker_cards:jt(e.worker_cards).map(du).filter(n=>n!==null)}}function pu(t){if(!W(t))return null;const e=W(t.status)?t.status:void 0,n=W(t.summary)?t.summary:W(e==null?void 0:e.summary)?e.summary:void 0,s=W(t.session)?t.session:W(e==null?void 0:e.session)?e.session:void 0,a=S(t.session_id)??S(n==null?void 0:n.session_id)??S(s==null?void 0:s.session_id);if(!a)return null;const o=no(t.report_paths)??no(e==null?void 0:e.report_paths),r=jt(t.recent_events,["events"]).filter(W);return{session_id:a,status:S(t.status)??S(n==null?void 0:n.status)??S(s==null?void 0:s.status),progress_pct:at(t.progress_pct)??at(n==null?void 0:n.progress_pct),elapsed_sec:at(t.elapsed_sec)??at(n==null?void 0:n.elapsed_sec),remaining_sec:at(t.remaining_sec)??at(n==null?void 0:n.remaining_sec),done_delta_total:at(t.done_delta_total)??at(n==null?void 0:n.done_delta_total),summary:n,team_health:W(t.team_health)?t.team_health:W(e==null?void 0:e.team_health)?e.team_health:void 0,communication_metrics:W(t.communication_metrics)?t.communication_metrics:W(e==null?void 0:e.communication_metrics)?e.communication_metrics:void 0,orchestration_state:W(t.orchestration_state)?t.orchestration_state:W(e==null?void 0:e.orchestration_state)?e.orchestration_state:void 0,cascade_metrics:W(t.cascade_metrics)?t.cascade_metrics:W(e==null?void 0:e.cascade_metrics)?e.cascade_metrics:void 0,report_paths:o,session:s,recent_events:r}}function mu(t){if(!W(t))return null;const e=S(t.name);if(!e)return null;const n=W(t.context)?t.context:void 0;return{name:e,agent_name:S(t.agent_name),status:S(t.status),autonomy_level:S(t.autonomy_level),context_ratio:at(t.context_ratio)??at(n==null?void 0:n.context_ratio),generation:at(t.generation),active_goal_ids:ru(t.active_goal_ids),last_autonomous_action_at:S(t.last_autonomous_action_at)??null,last_turn_ago_s:at(t.last_turn_ago_s),model:S(t.model)??S(t.active_model)??S(t.primary_model)}}function vu(t){if(!W(t))return null;const e=S(t.confirm_token)??S(t.token);return e?{confirm_token:e,actor:S(t.actor),action_type:S(t.action_type),target_type:S(t.target_type),target_id:S(t.target_id)??null,delegated_tool:S(t.delegated_tool),created_at:S(t.created_at),preview:t.preview}:null}function _u(t){const e=W(t)?t:{};return{room:cu(e.room),sessions:jt(e.sessions,["items","sessions"]).map(pu).filter(n=>n!==null),keepers:jt(e.keepers,["items","keepers"]).map(mu).filter(n=>n!==null),recent_messages:jt(e.recent_messages,["messages"]).map(lu).filter(n=>n!==null),pending_confirms:jt(e.pending_confirms,["items","confirms"]).map(vu).filter(n=>n!==null),available_actions:jt(e.available_actions,["actions"]).filter(W).map(n=>({action_type:S(n.action_type)??"unknown",target_type:S(n.target_type)??"unknown",description:S(n.description),confirm_required:pa(n.confirm_required)}))}}function is(t){if(typeof t=="string")return t;if(t==null)return"";try{return JSON.stringify(t)}catch{return String(t)}}function so(t){return t.target_id?`${t.target_type}:${t.target_id}`:t.target_type}function Es(t){Ds.value=[{...t,id:ou++,at:new Date().toISOString()},...Ds.value].slice(0,20)}function pr(t){return t.confirm_required?is(t.preview)||"Confirmation required":is(t.result)||is(t.executed_action)||is(t.delegated_tool_result)||t.status}async function lt(){Pn.value=!0,pe.value=null;try{const t=await Jl();Ht.value=_u(t)}catch(t){pe.value=t instanceof Error?t.message:"Failed to load operator snapshot"}finally{Pn.value=!1}}async function Qt(){Ln.value=!0,Qe.value=null;try{const t=await Uo({targetType:"room"});lr.value=ur(t)}catch(t){Qe.value=t instanceof Error?t.message:"Failed to load operator digest"}finally{Ln.value=!1}}async function Ze(t){if(!t){Wt.value=null;return}Ln.value=!0,Qe.value=null;try{const e=await Uo({targetType:"team_session",targetId:t,includeWorkers:!0});Wt.value=ur(e)}catch(e){Qe.value=e instanceof Error?e.message:"Failed to load session digest"}finally{Ln.value=!1}}async function fu(t){var e;Q.value=!0,pe.value=null;try{const n=await ia(t);return Es({actor:t.actor,action_type:t.action_type,target_label:so(t),outcome:n.confirm_required?"preview":"executed",message:pr(n),delegated_tool:n.delegated_tool}),await lt(),await Qt(),(e=Wt.value)!=null&&e.target_id&&await Ze(Wt.value.target_id),n}catch(n){const s=n instanceof Error?n.message:"Operator action failed";throw pe.value=s,Es({actor:t.actor,action_type:t.action_type,target_label:so(t),outcome:"error",message:s}),n}finally{Q.value=!1}}async function gu(t,e){var n;Q.value=!0,pe.value=null;try{const s=await sc(t,e);return Es({actor:t,action_type:"confirm",target_label:e,outcome:"confirmed",message:pr(s),delegated_tool:s.delegated_tool}),await lt(),await Qt(),(n=Wt.value)!=null&&n.target_id&&await Ze(Wt.value.target_id),s}catch(s){const a=s instanceof Error?s.message:"Operator confirmation failed";throw pe.value=a,Es({actor:t,action_type:"confirm",target_label:e,outcome:"error",message:a}),s}finally{Q.value=!1}}Rd(()=>{var t;lt(),Qt(),(t=Wt.value)!=null&&t.target_id&&Ze(Wt.value.target_id)});function $u(t){switch(t){case"quiet_hours":return"quiet hours";case"min_gap":return"cooldown gate";case"no_recent_activity":return"waiting for activity";case"disabled":return"runtime disabled";case"startup":return"warming up";case"llm_error":return"llm error";case"graphql_error":return"graphql error";case"never_started":return"never started";default:return"unknown"}}function hu(t){switch(t){case"manual_lodge_poke":return"Poke Lodge";case"probe":return"Probe";case"recover":return"Recover";default:return"Message"}}function yu(t){switch(t.delivery){case"sending":return"sending";case"timeout":return"timeout";case"error":return"error";case"delivered":return"delivered";default:return t.role}}function ao(t){return t.delivery==="error"||t.delivery==="timeout"?"bad":t.delivery==="sending"?"warn":t.role==="assistant"?"assistant":t.role==="user"?"user":"warn"}function mr(t){if(!t)return null;const e=new Date(t);return Number.isNaN(e.getTime())?null:e.toLocaleTimeString()}function bu(t){return typeof t!="number"||!Number.isFinite(t)||t<=0?null:t<60?`${Math.round(t)}s`:`${Math.ceil(t/60)}m`}function vr(t){if(!t)return null;const e=Yt.value[t.name];return(e==null?void 0:e.diagnostic)??t.diagnostic??null}function ku({keeper:t,showRawStatus:e=!1}){if(rt(()=>{t!=null&&t.name&&Jo(t.name)},[t==null?void 0:t.name]),!t)return i`<div class="control-status-copy">Select a keeper to inspect direct reply state.</div>`;const n=Yt.value[t.name],s=vr(t),a=Za.value[t.name];return i`
    <div class="control-result-box">
      <div class="control-inline-meta">
        <span class="pill">${(s==null?void 0:s.health_state)??"unknown"}</span>
        <span class="pill">${$u(s==null?void 0:s.quiet_reason)}</span>
        <span class="pill">next ${hu((s==null?void 0:s.next_action_path)??"direct_message")}</span>
      ...
      <div class="control-status-copy">
        ...
        ${s!=null&&s.next_eligible_at_s?i` · next eligible ${bu(s.next_eligible_at_s)}`:null}
      </div>
  ...
  `}function xu({keeperName:t,placeholder:e}){const[n,s]=Po("");rt(()=>{t&&Jo(t)},[t]);const a=vt.value[t]??[],o=ti.value[t]??!1,r=Xt.value[t],c=async()=>{const d=n.trim();if(!(!t||!d)){s("");try{await Zc(t,d)}catch(m){const u=m instanceof Error?m.message:`Failed to message ${t}`;M(u,"error")}}};return i`
        ...
        ${a.length===0?i`<div class="control-status-copy">No direct keeper conversation yet.</div>`:a.map(d=>i`
              <div class="keeper-conversation-item" key=${d.id}>
                <div class="keeper-conversation-meta">
                  <span class=${`keeper-role-chip ${ao(d)}`}>${d.label}</span>
                  <span class=${`keeper-role-chip ${ao(d)}`}>${yu(d)}</span>
  ...
  `}function Su({actor:t,keeper:e,onPokeLodge:n}){if(!e)return null;const s=vr(e),a=ei.value[e.name]??!1,o=ni.value[e.name]??!1,r=(s==null?void 0:s.next_action_path)??"direct_message",c=(s==null?void 0:s.recoverable)??r==="recover";return i`
    <div class="control-actions">
      <button
  ...
  `}const Ti=_(null);function Ii(t){Ti.value=t,Qc(t.name)}function io(){Ti.value=null}const Me=[{level:"L1_Reactive",label:"L1 Reactive",color:"#6b7280"},{level:"L2_Suggestive",label:"L2 Suggestive",color:"#3b82f6"},{level:"L3_Guided",label:"L3 Guided",color:"#f59e0b"},{level:"L4_Autonomous",label:"L4 Autonomous",color:"#f97316"},{level:"L5_Independent",label:"L5 Independent",color:"#ef4444"}];function Au(t){if(!t)return 0;const e=Me.findIndex(n=>n.level===t);return e>=0?e:0}function Cu({keeper:t}){const e=Au(t.autonomy_level),n=Me[e]??Me[0];if(!n)return null;const s=(e+1)/Me.length*100;return i`
  ...
  `}function Nu({keeper:t}){var u,p;const e=t.metrics_series??[];if(e.length<2){const v=(((u=t.context)==null?void 0:u.context_ratio)??0)*100,$=v>85?"#ef4444":v>70?"#f59e0b":"#22c55e";return i`
      ...
      </div>`}const n=200,s=60,a=2,o=e.length,r=e.map((v,$)=>{const k=a+$/(o-1)*(n-2*a),x=s-a-(v.context_ratio??0)*(s-2*a);return{x:k,y:x,p:v}}),c=r.map(({x:v,y:$})=>`${v.toFixed(1)},${$.toFixed(1)}`).join(" "),d=(((p=e[e.length-1])==null?void 0:p.context_ratio)??0)*100,m=d>85?"#ef4444":d>70?"#f59e0b":"#22c55e";return i`
  ...
  `}function Mu({items:t}){return t.length===0?i`<div class="empty-state" style="font-size:13px">No equipment</div>`:i`
  ...
  `}function zu({keeper:t}){var m,u,p,v,$,k,x;const e=((m=Ht.value)==null?void 0:m.room)??{},n=(((u=Ht.value)==null?void 0:u.available_actions)??[]).filter(C=>C.target_type==="keeper"||C.target_type==="room").slice(0,8),s=Tu(t),a=Iu(t),o=((p=t.agent)==null?void 0:p.capabilities)??[],r=e.current_room??e.room_id??((v=At.value)==null?void 0:v.room)??"default",c=e.project??(($=At.value)==null?void 0:$.project)??"확인 없음",d=e.cluster??((k=At.value)==null?void 0:k.cluster)??"확인 없음";return i`
    <div class="keeper-signal-list">
      <div class="keeper-signal-row">
        <span>Room</span>
        <strong>${r}</strong>
      ...
      <div style="display:flex; flex-direction:column; gap:8px; margin-top:8px;">
        ...
        <div style="display:flex; flex-wrap:wrap; gap:6px;">
          ${n.length>0?n.map(C=>i`<span class="pill">${wu(C.action_type)}</span>`):i`<span style="font-size:12px; color:#888;">operator action 광고 없음</span>`}
        </div>
      </div>
    </div>
  `}function _r(){const t=new URLSearchParams(window.location.search),e=t.get("agent")??t.get("agent_name"),n=localStorage.getItem("masc_dashboard_agent_name");return(e??n??"dashboard").trim()||"dashboard"}async function ju(){try{const t=await ia({actor:_r(),action_type:"lodge_tick",target_type:"room",payload:{}}),e=Go(t.result);await Gn(),e!=null&&e.skipped_reason?M(e.skipped_reason,"warning"):M(e?`Poke finished: ${e.acted}/${e.checked} acted`:"Poke finished",e&&e.acted>0?"success":"warning")}catch(t){const e=t instanceof Error?t.message:"Failed to run Lodge poke";M(e,"error")}}function Ou({keeper:t}){return i`
  ...
  `}function Fu(){var e,n,s;const t=Ti.value;return t?i`
    <div
  ...
  `:null}const zs="masc_dashboard_workflow_context",qu=900*1e3;function Ri(t){return typeof t=="object"&&t!==null&&!Array.isArray(t)}function It(t){return typeof t=="string"&&t.trim()!==""?t.trim():null}function ne(t){const e=It(t);return e||(typeof t=="number"&&Number.isFinite(t)?String(t):null)}function fr(){if(typeof window>"u")return null;try{return window.sessionStorage}catch{return null}}function ui(t){return Ri(t)?t:null}function Ku(t){if(!t)return null;try{return JSON.stringify(t)}catch{return null}}function Uu(t){if(!t)return null;try{const e=JSON.parse(t);if(!Ri(e))return null;const n=It(e.id),s=It(e.source_surface),a=It(e.source_label),o=It(e.summary),r=It(e.created_at);return!n||s!=="mission"||!a||!o||!r?null:{id:n,source_surface:"mission",source_label:a,action_type:It(e.action_type),target_type:It(e.target_type),target_id:It(e.target_id),focus_kind:It(e.focus_kind),summary:o,payload_preview:It(e.payload_preview),suggested_payload:ui(e.suggested_payload),preview:e.preview??null,evidence:e.evidence??null,created_at:r}}catch{return null}}function Ni(t){const e=Date.parse(t.created_at);return Number.isNaN(e)?!1:Date.now()-e<=qu}function Hu(){const t=fr(),e=Uu((t==null?void 0:t.getItem(zs))??null);return e?Ni(e)?e:(t==null||t.removeItem(zs),null):null}const gr=_(Hu());function Wu(t){const e=t&&Ni(t)?t:null;gr.value=e;const n=fr();if(!n)return;if(!e){n.removeItem(zs);return}const s=Ku(e);s&&n.setItem(zs,s)}function $r(t){if(!t)return null;const e=ui(t.suggested_payload);if(e)return e;if(Ri(t.preview)){const n=ui(t.preview.payload);if(n)return n}return null}function hr(t){if(!t)return null;const e=ne(t.message);if(e)return e;const n=ne(t.task_title)??ne(t.title),s=ne(t.task_description)??ne(t.description),a=ne(t.reason),o=ne(t.priority)??ne(t.task_priority);return n&&s?`${n} · ${s}`:n&&o?`${n} · P${o}`:n||s||a||null}function yr(t,e,n,s,a,o){return["mission",t,e??"action",n??"target",s??"room",a??"focus",o].join(":")}function sn(t,e,n="상황판 추천 액션"){const s=new Date().toISOString(),a=$r(t),o=(t==null?void 0:t.target_type)??(e==null?void 0:e.target_type)??null,r=(t==null?void 0:t.target_id)??(e==null?void 0:e.target_id)??null,c=(e==null?void 0:e.kind)??(t==null?void 0:t.action_type)??null,d=(t==null?void 0:t.reason)??(e==null?void 0:e.summary)??n;return{id:yr(n,(t==null?void 0:t.action_type)??null,o,r,c,s),source_surface:"mission",source_label:n,action_type:(t==null?void 0:t.action_type)??null,target_type:o,target_id:r,focus_kind:c,summary:d,payload_preview:hr(a),suggested_payload:a,preview:(t==null?void 0:t.preview)??null,evidence:(e==null?void 0:e.evidence)??null,created_at:s}}function Bu(t,e){return e.source==="mission"&&(e.action_type??null)===(t.action_type??null)&&(e.target_type??null)===(t.target_type??null)&&(e.target_id??null)===(t.target_id??null)&&(e.focus_kind??null)===(t.focus_kind??null)}function Jn(t){const{params:e}=t;if(e.source!=="mission")return null;const n=gr.value;if(n&&Ni(n)&&Bu(n,e))return n;const s=new Date().toISOString();return{id:yr("상황판 이어보기",e.action_type??null,e.target_type??null,e.target_id??null,e.focus_kind??null,s),source_surface:"mission",source_label:"상황판 이어보기",action_type:e.action_type??null,target_type:e.target_type??null,target_id:e.target_id??null,focus_kind:e.focus_kind??e.action_type??null,summary:e.focus_kind?`${e.focus_kind} 기준으로 열린 컨텍스트입니다.`:"상황판에서 이어진 컨텍스트입니다.",payload_preview:null,suggested_payload:null,preview:null,evidence:null,created_at:s}}function Gu(t){return{source:"mission",...t.action_type?{action_type:t.action_type}:{},...t.target_type?{target_type:t.target_type}:{},...t.target_id?{target_id:t.target_id}:{},...t.focus_kind?{focus_kind:t.focus_kind}:{}}}function br(t){const e=[t.focus_kind,t.summary,t.action_type].filter(n=>typeof n=="string"&&n.trim()!=="").join(" ").toLowerCase();return e.includes("artifact_scope")||e.includes("routing_confidence")||e.includes("cache_contention")?"summary":e.includes("stale_data")||e.includes("leader_offline")||e.includes("roster_offline")||e.includes("managed")||e.includes("swarm")?"swarm":t.target_type==="room"?"summary":"swarm"}function Ju(t){return{source:"mission",surface:br(t),...t.action_type?{action_type:t.action_type}:{},...t.target_type?{target_type:t.target_type}:{},...t.target_id?{target_id:t.target_id}:{},...t.focus_kind?{focus_kind:t.focus_kind}:{}}}function Pi(t){return t!=null&&t.target_type?t.target_id?`${t.target_type} · ${t.target_id}`:t.target_type:"대상 정보 없음"}function Li(t){switch(t){case"broadcast":return"room 방송";case"room_pause":return"room 일시정지";case"room_resume":return"room 재개";case"task_inject":return"room 작업 주입";case"team_turn":return"session 업데이트";case"team_note":return"session 노트";case"team_broadcast":return"session 방송";case"team_task_inject":return"session 작업";case"team_stop":return"session 중지";case"keeper_msg":case"keeper_message":return"keeper 메시지";case"keeper_probe":return"keeper probe";case"keeper_recover":return"keeper recover";default:return(t==null?void 0:t.trim())||"추천 액션"}}function Vu(t){switch(t){case"warroom":return"워룸";case"summary":return"요약";case"swarm":return"스웜";case"chains":return"체인";case"topology":return"토폴로지";case"alerts":return"알림";case"trace":return"트레이스";case"control":return"제어";case"operations":return"작전";default:return(t==null?void 0:t.trim())||"지휘"}}function bt(t){return typeof t=="object"&&t!==null&&!Array.isArray(t)}function mt(t){return typeof t=="string"&&t.trim()!==""?t.trim():null}function Mn(t){return typeof t=="number"&&Number.isFinite(t)?t:null}function ka(t){return Array.isArray(t)?t.map(e=>typeof e=="string"?e.trim():"").filter(Boolean):[]}function nt(t,e=120){const n=(t??"").replace(/\s+/g," ").trim();return n?n.length>e?`${n.slice(0,e-1)}…`:n:null}function _t(t){return t==="bad"||t==="offline"||t==="critical"?"bad":t==="warn"||t==="pending"||t==="degraded"||t==="interrupted"?"warn":"ok"}function me(t){if(!t)return"방금";const e=Date.parse(t);if(Number.isNaN(e))return t;const n=Math.max(0,Math.round((Date.now()-e)/1e3));return n<60?`${n}s 전`:n<3600?`${Math.round(n/60)}m 전`:n<86400?`${Math.round(n/3600)}h 전`:`${Math.round(n/86400)}d 전`}function Yu(t){return typeof t!="number"||!Number.isFinite(t)||t<0?"n/a":t<60?`${Math.round(t)}s`:t<3600?`${Math.round(t/60)}m`:t<86400?`${Math.round(t/3600)}h`:`${Math.round(t/86400)}d`}function ro(t){const e=Mn(t.ts);if(e!=null)return e;const n=mt(t.ts_iso);if(!n)return 0;const s=Date.parse(n);return Number.isNaN(s)?0:s}function Xu(t){return[...new Set(t.filter(Boolean))]}function Qu(t){return t!=null&&t.confirm_required?"확인 후 실행":"즉시 실행"}function Zu(t){return hr($r(t))}function tp(t){return Pi(t?sn(t,null,"상황판 추천 액션"):null)}function ma(t,e=sn()){Wu(e),$t(t,t==="intervene"?Gu(e):Ju(e))}function ep(t){ma("intervene",sn(null,t,"상황판 incident"))}function np(t){ma("command",sn(null,t,"상황판 incident"))}function sp(t,e,n="상황판 추천 액션"){ma("intervene",sn(t,e,n))}function ap(t,e,n="상황판 추천 액션"){ma("command",sn(t,e,n))}function lo(t,e){const n={source:"mission",target_type:"team_session",target_id:e,focus_kind:"team_session"};t==="command"&&(n.surface="swarm"),$t(t,n)}function kr(t,e){const n=t.trim().toLowerCase();return[...e].filter(s=>(s.from??"").trim().toLowerCase()===n).sort((s,a)=>Date.parse(a.timestamp)-Date.parse(s.timestamp))[0]??null}function ip(t,e){const n=t.trim().toLowerCase();return[...e].filter(s=>{if((s.from??"").trim().toLowerCase()===n)return!1;const o=(s.content??"").trim().toLowerCase();return o.includes(`@${n}`)||o.includes(n)}).sort((s,a)=>Date.parse(a.timestamp)-Date.parse(s.timestamp))[0]??null}function op(t){const e=bt(t.session)?t.session:{},n=bt(t.summary)?t.summary:{};return Xu([...ka(e.agent_names),...ka(n.active_agents),...ka(n.planned_participants)]).filter(s=>!zd(s))}function rp(t){const e=bt(t.session)?t.session:{};return mt(e.goal)??mt(e.session_id)??t.session_id}function lp(t){const e=bt(t.session)?t.session:{};return mt(e.room_id)}function cp(t){const e=bt(t.session)?t.session:{};return mt(e.created_at_iso)}function dp(t){const e=bt(t.session)?t.session:{};return mt(e.updated_at_iso)}function up(t){const e=bt(t.communication_metrics)?t.communication_metrics:{};return mt(e.mode)}function pp(t){const e=bt(t.communication_metrics)?t.communication_metrics:{};return Mn(e.broadcast_count)??0}function mp(t){const e=bt(t.communication_metrics)?t.communication_metrics:{};return Mn(e.portal_count)??0}function vp(t){const e=bt(t.team_health)?t.team_health:{};return{active:Mn(e.active_agents_count)??0,required:Mn(e.required_agents)??0}}function _p(t){const n=[...t.recent_events??[]].sort((u,p)=>ro(p)-ro(u))[0];if(!n)return{at:null,summary:"최근 session event가 없습니다."};const s=bt(n.detail)?n.detail:{},a=mt(n.event_type)??"event",o=mt(s.actor),r=mt(s.task_title)??mt(s.title),c=nt(mt(s.result),120),d=nt(mt(s.reason),120),m=r?`${o?`${o} · `:""}${r}`:c??d??a.replace(/_/g," ");return{at:mt(n.ts_iso),summary:m}}function fp(){const t=la.value;return t?t.operator_targets.sessions.map(e=>{var o,r;const n=vp(e),s=_p(e),a=t.command_focus.session_cards.find(c=>c.session_id===e.session_id);return{session:e,goal:rp(e),room:lp(e),status:e.status??"unknown",memberNames:op(e),startedAt:cp(e),stoppedAt:dp(e),elapsedSec:e.elapsed_sec??null,lastEventAt:s.at,lastEventSummary:s.summary,communicationMode:up(e),broadcastCount:pp(e),portalCount:mp(e),activeCount:n.active,requiredCount:n.required,attentionSummary:((o=a==null?void 0:a.top_attention)==null?void 0:o.summary)??((r=a==null?void 0:a.top_recommendation)==null?void 0:r.reason)??null}}).sort((e,n)=>{const s=Date.parse(e.lastEventAt??e.startedAt??"")||0;return(Date.parse(n.lastEventAt??n.startedAt??"")||0)-s}):[]}function xr(t){if(t.recent_tool_names&&t.recent_tool_names.length>0)return t.recent_tool_names;const e=bt(t.metrics_window)?t.metrics_window:{};return(Array.isArray(e.top_tools)?e.top_tools:[]).map(s=>bt(s)?mt(s.tool):null).filter(s=>s!==null)}function gp(t){return te.value.find(e=>e.agent_name===t||e.name===t)??null}function Sr(t,e){const n=nt(t.current_task,100);if(!n)return"명시된 current task 없음";const s=e.find(o=>o.id===n);if(s)return`${s.id} · ${nt(s.title,92)}`;const a=e.find(o=>o.title===n);return a?`${a.id} · ${nt(a.title,92)}`:n}function $p(t){const e=new Map;for(const n of t)for(const s of n.memberNames)e.has(s)||e.set(s,n);return[...wt.value].map(n=>{var v,$;const s=e.get(n.name),a=gp(n.name),o=kr(n.name,Xe.value),r=ip(n.name,Xe.value),c=ra.value.get(n.name.trim().toLowerCase()),d=s?s.memberNames.filter(k=>k!==n.name):[],m=s?`${s.goal}${s.room?` · ${s.room}`:""}`:((v=la.value)==null?void 0:v.summary.current_room)??"room",u=(a==null?void 0:a.skill_primary)??(n.capabilities&&n.capabilities.length>0?n.capabilities.slice(0,3).join(", "):null)??n.agent_type??null,p=Sr(n,qt.value);return{agent:n,where:m,withWhom:d,activeSince:(s==null?void 0:s.startedAt)??n.joined_at??n.last_seen??null,currentWork:p,how:u,recentInput:nt(r==null?void 0:r.content,120)??nt(a==null?void 0:a.recent_input_preview,120)??null,recentOutput:nt(o==null?void 0:o.content,120)??nt(a==null?void 0:a.recent_output_preview,120)??nt(($=a==null?void 0:a.diagnostic)==null?void 0:$.last_reply_preview,120)??null,recentEvent:nt(c==null?void 0:c.lastActivityText,120)??(s==null?void 0:s.lastEventSummary)??null,recentTools:a?xr(a):[]}}).sort((n,s)=>{const a=d=>d==="busy"?4:d==="active"?3:d==="listening"?2:d==="idle"?1:0,o=a(s.agent.status)-a(n.agent.status);if(o!==0)return o;const r=Date.parse(n.agent.last_seen??n.activeSince??"")||0;return(Date.parse(s.agent.last_seen??s.activeSince??"")||0)-r})}function hp(){return[...te.value].map(t=>{var e,n,s,a;return{keeper:t,activeSince:((e=t.agent)==null?void 0:e.joined_at)??t.created_at??t.last_heartbeat??null,currentWork:nt((n=t.agent)==null?void 0:n.current_task,110)??nt(t.skill_primary,110)??nt(t.last_proactive_reason,110)??"명시된 keeper focus 없음",recentInput:nt(t.recent_input_preview,120)??null,recentOutput:nt(t.recent_output_preview,120)??nt((s=t.diagnostic)==null?void 0:s.last_reply_preview,120)??nt(t.last_proactive_preview,120)??null,recentEvent:nt(t.last_proactive_reason,120)??nt((a=t.diagnostic)==null?void 0:a.summary,120)??null,recentTools:xr(t)}}).sort((t,e)=>{const n=Date.parse(t.keeper.last_heartbeat??t.activeSince??"")||0;return(Date.parse(e.keeper.last_heartbeat??e.activeSince??"")||0)-n})}function yp({cluster:t,project:e,room:n,generatedAt:s}){return i`
  ...
  `}function bp(){const t=ar.value,e=_t((t==null?void 0:t.status)??(xe.value?"bad":"warn")),n=!t||t.sections.length===0,s=(t==null?void 0:t.status)==="error"||(t==null?void 0:t.status)==="unavailable"&&!(t!=null&&t.cached);return i`
    <${R} title="LLM 판단 레이어" class="mission-briefing-card" semanticId="mission.llm_briefing">
  ...
  `}function kp({row:t}){const e=t.memberNames.slice(0,4).map(n=>{const s=wt.value.find(r=>r.name===n),a=kr(n,Xe.value),o=Ed(n);return{name:n,model:o.model,nickname:o.nickname,currentTask:s?Sr(s,qt.value):"agent snapshot 없음",output:nt(a==null?void 0:a.content,96)}});return i`
    <article class="mission-crew-card ${_t(t.status)}">
      ...
      <div class="mission-card-actions">
        <button class="control-btn ghost" onClick=${()=>lo("intervene",t.session.session_id)}>세션 개입 열기</button>
        <button class="control-btn ghost" onClick=${()=>lo("command",t.session.session_id)}>세션 원인 보기</button>
      </div>
    </article>
  `}function xp({row:t}){const e=t.recentTools.length>0?t.recentTools.join(", "):"도구 텔레메트리 없음",n=t.withWhom.length>0?t.withWhom.slice(0,3).join(", "):"단독 또는 room-level";return i`
  ...
  `}function Sp({row:t}){const e=[`gen ${t.keeper.generation??0}`,`handoff ${t.keeper.handoff_count_total??0}`,`compact ${t.keeper.compaction_count??0}`,t.keeper.context_ratio!=null?`ctx ${Math.round(t.keeper.context_ratio*100)}%`:null].filter(n=>n!==null).join(" · ");return i`
    <button class="mission-activity-card ${_t(t.keeper.status)}" onClick=${()=>Ii(t.keeper)}>
      <div class="mission-activity-head">
        <div class="mission-activity-title">
  ...
  `}function Ap({item:t}){return i`
    <article class="mission-action-card ${_t(t.severity)}">
      ...
      <p>${t.summary}</p>
      <div class="mission-card-actions">
        <button class="control-btn ghost" onClick=${()=>ep(t)}>이 이슈로 개입 열기</button>
        <button class="control-btn ghost" onClick=${()=>np(t)}>이 이슈의 원인 보기</button>
      </div>
    </article>
  `}function Cp({action:t,incident:e}){const n=Zu(t);return i`
    <article class="mission-action-card ${_t(t.severity)}">
      <div class="mission-card-head">
        <span class="command-chip ${_t(t.severity)}">${Li(t.action_type)}</span>
        <span class="mission-card-target">${t.target_type}${t.target_id?` · ${t.target_id}`:""}</span>
      </div>
      <p>${t.reason}</p>
      ...
      <div class="mission-card-actions">
        <button class="control-btn ghost" onClick=${()=>sp(t,e,"상황판 추천 액션")}>이 액션으로 개입 열기</button>
        <button class="control-btn ghost" onClick=${()=>ap(t,e,"상황판 추천 액션")}>이 이슈의 원인 보기</button>
      </div>
    </article>
  `}function co(){const t=la.value;if(di.value&&!t)return i`<div class="loading-indicator">상황판 스냅샷 불러오는 중...</div>`;if(Ps.value&&!t)return i`<div class="empty-state error">${Ps.value}</div>`;if(!t)return i`<div class="empty-state">상황판 스냅샷이 아직 없습니다.</div>`;const e=fp(),n=$p(e),s=hp(),a=n.filter(d=>["active","busy","listening","idle"].includes(d.agent.status)).length,o=n.filter(d=>d.recentOutput).length+s.filter(d=>d.recentOutput).length,r=t.incidents[0]??null,c=t.recommended_actions[0]??null;return i`
    <section class="dashboard-panel mission-view">
      ...
      <div class="mission-human-grid">
        <${R} title="같이 움직이는 흐름" class="mission-list-card" semanticId="mission.crews">
          <div class="mission-section-head">
            <h3>누가 누구와 같은 목표를 향하는지</h3>
            <p>team session 단위로 목표, 멤버, 최근 사건, 커뮤니케이션 흔적을 바로 보여줍니다.</p>
          </div>
          <div class="mission-list-stack">
            ${e.length>0?e.map(d=>i`<${kp} key=${d.session.session_id} row=${d} />`):i`<div class="empty-state">지금 열려 있는 crew / session 이 없습니다.</div>`}
          </div>
        <//>

        <${R} title="에이전트 활동" class="mission-list-card" semanticId="mission.agent_activity">
          <div class="mission-section-head">
            <h3>각 에이전트가 지금 뭘 하는가</h3>
            <p>where / with whom / current task / recent input-output / recent tools 를 preview-first로 보여줍니다.</p>
          </div>
          <div class="mission-activity-list">
            ${n.length>0?n.slice(0,10).map(d=>i`<${xp} key=${d.agent.name} row=${d} />`):i`<div class="empty-state">지금 보이는 에이전트 활동이 없습니다.</div>`}
          </div>
        <//>
      </div>

      <div class="mission-human-grid">
        <${R} title="Keeper 연속성" class="mission-list-card" semanticId="mission.keeper_activity">
          <div class="mission-section-head">
          ...
          <div class="mission-activity-list">
            ${s.length>0?s.slice(0,8).map(d=>i`<${Sp} key=${d.keeper.name} row=${d} />`):i`<div class="empty-state">지금 보이는 keeper 가 없습니다.</div>`}
          </div>
        <//>

        <${R} title="내부 진단은 여기서만" class="mission-list-card" semanticId="mission.internal_signals">
          <div class="mission-section-head">
            <h3>internal signal / recommendation</h3>
            <p>artifact_scope_drift 같은 시스템 진단은 메인 판단 근거가 아니라 보조 신호로만 유지합니다.</p>
          </div>
          <div class="mission-list-stack">
            ${t.incidents.slice(0,2).map(d=>i`<${Ap} key=${`${d.kind}:${d.target_id??"room"}`} item=${d} />`)}
            ${t.recommended_actions.slice(0,2).map(d=>i`<${Cp} key=${`${d.action_type}:${d.target_id??"room"}`} action=${d} />`)}
  ...
  `}const Mi=_(null),Gt=_(null),js=_(!1),Os=_(!1),Fs=_(null),qs=_(null),pi=_(null),Ks=_(null),G=_("warroom"),Vn=_(null),mi=_(!1),Us=_(null),Te=_(null),Hs=_(!1),Ws=_(null),Yn=_(null),vi=_(!1),Bs=_(null),Dn=_(null),Gs=_(!1),En=_(null),Ge=_(null);let pn=null;function Di(t){return t!=="summary"&&t!=="swarm"&&t!=="warroom"}function A(t){return typeof t=="object"&&t!==null&&!Array.isArray(t)}function l(t){return typeof t=="string"&&t.trim()!==""?t:void 0}function g(t){return typeof t=="number"&&Number.isFinite(t)?t:void 0}function st(t){return typeof t=="boolean"?t:void 0}function ft(t){return Array.isArray(t)?t.map(e=>typeof e=="string"?e.trim():"").filter(Boolean):[]}function Ar(){if(typeof window>"u")return new URLSearchParams;const t=new URLSearchParams(window.location.search),e=window.location.hash.replace(/^#/,""),n=e.indexOf("?");return n>=0&&new URLSearchParams(e.slice(n+1)).forEach((a,o)=>{t.has(o)||t.set(o,a)}),t}function wp(){const e=Ar().get("run_id")??void 0;return e&&e.trim()!==""?e.trim():void 0}function Tp(){const e=Ar().get("operation_id")??void 0;return e&&e.trim()!==""?e.trim():void 0}function Ip(t){if(A(t))return{policy_class:l(t.policy_class),approval_class:l(t.approval_class),tool_allowlist:ft(t.tool_allowlist),model_allowlist:ft(t.model_allowlist),requires_human_for:ft(t.requires_human_for),autonomy_level:l(t.autonomy_level),escalation_timeout_sec:g(t.escalation_timeout_sec),kill_switch:st(t.kill_switch),frozen:st(t.frozen)}}function Rp(t){if(A(t))return{headcount_cap:g(t.headcount_cap),active_operation_cap:g(t.active_operation_cap),max_cost_usd:g(t.max_cost_usd),max_tokens:g(t.max_tokens)}}function Ei(t){if(!A(t))return null;const e=l(t.unit_id),n=l(t.label),s=l(t.kind);return!e||!n||!s?null:{unit_id:e,label:n,kind:s,parent_unit_id:l(t.parent_unit_id)??null,leader_id:l(t.leader_id)??null,roster:ft(t.roster),capability_profile:ft(t.capability_profile),source:l(t.source),created_at:l(t.created_at),updated_at:l(t.updated_at),policy:Ip(t.policy),budget:Rp(t.budget)}}function Cr(t){if(!A(t))return null;const e=Ei(t.unit);return e?{unit:e,leader_status:l(t.leader_status),roster_total:g(t.roster_total),roster_live:g(t.roster_live),active_operation_count:g(t.active_operation_count),health:l(t.health),reasons:ft(t.reasons),children:Array.isArray(t.children)?t.children.map(Cr).filter(n=>n!==null):[]}:null}function Np(t){if(A(t))return{total_units:g(t.total_units),company_count:g(t.company_count),platoon_count:g(t.platoon_count),squad_count:g(t.squad_count),leaf_agent_unit_count:g(t.leaf_agent_unit_count),live_agent_count:g(t.live_agent_count),managed_unit_count:g(t.managed_unit_count),active_operation_count:g(t.active_operation_count)}}function wr(t){const e=A(t)?t:{};return{version:l(e.version),generated_at:l(e.generated_at),source:l(e.source),summary:Np(e.summary),units:Array.isArray(e.units)?e.units.map(Cr).filter(n=>n!==null):[]}}function Pp(t){if(!A(t))return null;const e=l(t.kind),n=l(t.status);return!e||!n?null:{kind:e,chain_id:l(t.chain_id)??null,goal:l(t.goal)??null,run_id:l(t.run_id)??null,status:n,viewer_path:l(t.viewer_path)??null,last_sync_at:l(t.last_sync_at)??null}}function va(t){if(!A(t))return null;const e=l(t.operation_id),n=l(t.objective),s=l(t.assigned_unit_id),a=l(t.trace_id),o=l(t.status);return!e||!n||!s||!a||!o?null:{operation_id:e,objective:n,assigned_unit_id:s,autonomy_level:l(t.autonomy_level),policy_class:l(t.policy_class),budget_class:l(t.budget_class),detachment_session_id:l(t.detachment_session_id)??null,trace_id:a,checkpoint_ref:l(t.checkpoint_ref)??null,active_goal_ids:ft(t.active_goal_ids),note:l(t.note)??null,created_by:l(t.created_by),source:l(t.source),status:o,chain:Pp(t.chain),created_at:l(t.created_at),updated_at:l(t.updated_at)}}function Lp(t){if(!A(t))return null;const e=va(t.operation);return e?{operation:e,assigned_unit_label:l(t.assigned_unit_label)}:null}function cn(t){if(A(t))return{tone:l(t.tone),pending_ops:g(t.pending_ops),blocked_ops:g(t.blocked_ops),in_flight_ops:g(t.in_flight_ops),pipeline_stalls:g(t.pipeline_stalls),bus_traffic:g(t.bus_traffic),l1_hit_rate:g(t.l1_hit_rate),invalidation_count:g(t.invalidation_count),current_pending:g(t.current_pending),current_in_flight:g(t.current_in_flight),cdb_wakeups:g(t.cdb_wakeups),total_stolen:g(t.total_stolen),avg_best_score:g(t.avg_best_score),avg_candidate_count:g(t.avg_candidate_count),best_first_operations:g(t.best_first_operations),active_sessions:g(t.active_sessions),commit_rate:g(t.commit_rate),total_speculations:g(t.total_speculations)}}function Mp(t){if(!A(t))return;const e=A(t.pipeline)?t.pipeline:void 0,n=A(t.cache)?t.cache:void 0,s=A(t.ooo)?t.ooo:void 0,a=A(t.speculative)?t.speculative:void 0,o=A(t.search_fabric)?t.search_fabric:void 0,r=A(t.signals)?t.signals:void 0;return{pipeline:e?{total_ops:g(e.total_ops),completed_ops:g(e.completed_ops),stalled_cycles:g(e.stalled_cycles),hazards_detected:g(e.hazards_detected),forwarding_used:g(e.forwarding_used),pipeline_flushes:g(e.pipeline_flushes),ipc:g(e.ipc)}:void 0,cache:n?{total_reads:g(n.total_reads),total_writes:g(n.total_writes),l1_hit_rate:g(n.l1_hit_rate),invalidation_count:g(n.invalidation_count),writeback_count:g(n.writeback_count),bus_traffic:g(n.bus_traffic)}:void 0,ooo:s?{agent_count:g(s.agent_count),total_added:g(s.total_added),total_issued:g(s.total_issued),total_completed:g(s.total_completed),total_stolen:g(s.total_stolen),cdb_wakeups:g(s.cdb_wakeups),stall_cycles:g(s.stall_cycles),global_cdb_events:g(s.global_cdb_events),current_pending:g(s.current_pending),current_in_flight:g(s.current_in_flight)}:void 0,speculative:a?{total_speculations:g(a.total_speculations),total_commits:g(a.total_commits),total_aborts:g(a.total_aborts),commit_rate:g(a.commit_rate),total_fast_calls:g(a.total_fast_calls),total_cost_usd:g(a.total_cost_usd),active_sessions:g(a.active_sessions)}:void 0,search_fabric:o?{total_operations:g(o.total_operations),best_first_operations:g(o.best_first_operations),legacy_operations:g(o.legacy_operations),blocked_operations:g(o.blocked_operations),ready_operations:g(o.ready_operations),research_pipeline_operations:g(o.research_pipeline_operations),avg_candidate_count:g(o.avg_candidate_count),avg_best_score:g(o.avg_best_score),top_stage:l(o.top_stage)??null}:void 0,signals:r?{issue_pressure:cn(r.issue_pressure),cache_contention:cn(r.cache_contention),scheduler_efficiency:cn(r.scheduler_efficiency),routing_confidence:cn(r.routing_confidence),speculative_posture:cn(r.speculative_posture)}:void 0}}function Tr(t){const e=A(t)?t:{},n=A(e.summary)?e.summary:void 0;return{version:l(e.version),generated_at:l(e.generated_at),summary:n?{total:g(n.total),active:g(n.active),paused:g(n.paused),managed:g(n.managed),projected:g(n.projected)}:void 0,microarch:Mp(e.microarch),operations:Array.isArray(e.operations)?e.operations.map(Lp).filter(s=>s!==null):[]}}function Ir(t){if(!A(t))return null;const e=l(t.detachment_id),n=l(t.operation_id),s=l(t.assigned_unit_id);return!e||!n||!s?null:{detachment_id:e,operation_id:n,assigned_unit_id:s,leader_id:l(t.leader_id)??null,roster:ft(t.roster),session_id:l(t.session_id)??null,checkpoint_ref:l(t.checkpoint_ref)??null,runtime_kind:l(t.runtime_kind)??null,runtime_ref:l(t.runtime_ref)??null,source:l(t.source),status:l(t.status),last_event_at:l(t.last_event_at)??null,last_progress_at:l(t.last_progress_at)??null,heartbeat_deadline:l(t.heartbeat_deadline)??null,created_at:l(t.created_at),updated_at:l(t.updated_at)}}function Dp(t){if(!A(t))return null;const e=Ir(t.detachment);return e?{detachment:e,assigned_unit_label:l(t.assigned_unit_label),operation:va(t.operation)}:null}function Rr(t){const e=A(t)?t:{},n=A(e.summary)?e.summary:void 0;return{version:l(e.version),generated_at:l(e.generated_at),summary:n?{total:g(n.total),active:g(n.active),projected:g(n.projected)}:void 0,detachments:Array.isArray(e.detachments)?e.detachments.map(Dp).filter(s=>s!==null):[]}}function Ep(t){if(!A(t))return null;const e=l(t.decision_id),n=l(t.trace_id),s=l(t.requested_action),a=l(t.scope_type),o=l(t.scope_id);return!e||!n||!s||!a||!o?null:{decision_id:e,trace_id:n,requested_action:s,scope_type:a,scope_id:o,operation_id:l(t.operation_id)??null,target_unit_id:l(t.target_unit_id)??null,requested_by:l(t.requested_by),status:l(t.status),reason:l(t.reason)??null,source:l(t.source),detail:t.detail,created_at:l(t.created_at),decided_at:l(t.decided_at)??null,expires_at:l(t.expires_at)??null}}function Nr(t){const e=A(t)?t:{},n=A(e.summary)?e.summary:void 0;return{version:l(e.version),generated_at:l(e.generated_at),summary:n?{total:g(n.total),pending:g(n.pending),approved:g(n.approved),denied:g(n.denied)}:void 0,decisions:Array.isArray(e.decisions)?e.decisions.map(Ep).filter(s=>s!==null):[]}}function zp(t){if(!A(t))return null;const e=Ei(t.unit);return e?{unit:e,roster_total:g(t.roster_total),roster_live:g(t.roster_live),headcount_cap:g(t.headcount_cap),active_operations:g(t.active_operations),active_operation_cap:g(t.active_operation_cap),utilization:g(t.utilization)}:null}function jp(t){const e=A(t)?t:{};return{version:l(e.version),generated_at:l(e.generated_at),capacity:Array.isArray(e.capacity)?e.capacity.map(zp).filter(n=>n!==null):[]}}function Op(t){if(!A(t))return null;const e=l(t.alert_id);return e?{alert_id:e,severity:l(t.severity),kind:l(t.kind),scope_type:l(t.scope_type),scope_id:l(t.scope_id),title:l(t.title),detail:l(t.detail),timestamp:l(t.timestamp)}:null}function Pr(t){const e=A(t)?t:{},n=A(e.summary)?e.summary:void 0;return{version:l(e.version),generated_at:l(e.generated_at),summary:n?{total:g(n.total),bad:g(n.bad),warn:g(n.warn)}:void 0,alerts:Array.isArray(e.alerts)?e.alerts.map(Op).filter(s=>s!==null):[]}}function Lr(t){if(!A(t))return null;const e=l(t.event_id),n=l(t.trace_id),s=l(t.event_type);return!e||!n||!s?null:{event_id:e,trace_id:n,event_type:s,operation_id:l(t.operation_id)??null,unit_id:l(t.unit_id)??null,actor:l(t.actor)??null,source:l(t.source),timestamp:l(t.timestamp),detail:t.detail}}function Fp(t){const e=A(t)?t:{};return{version:l(e.version),generated_at:l(e.generated_at),events:Array.isArray(e.events)?e.events.map(Lr).filter(n=>n!==null):[]}}function qp(t){if(!A(t))return null;const e=l(t.code),n=l(t.severity),s=l(t.summary);return!e||!n||!s?null:{code:e,severity:n,summary:s}}function Kp(t){if(!A(t))return null;const e=l(t.lane_id),n=l(t.label),s=l(t.kind),a=l(t.phase),o=l(t.motion_state),r=l(t.source_of_truth),c=l(t.movement_reason),d=l(t.current_step);if(!e||!n||!s||!a||!o||!r||!c||!d)return null;const m=A(t.counts)?t.counts:{};return{lane_id:e,label:n,kind:s,present:st(t.present)??!1,phase:a,motion_state:o,source_of_truth:r,last_movement_at:l(t.last_movement_at)??null,movement_reason:c,current_step:d,blockers:ft(t.blockers),counts:{operations:g(m.operations),detachments:g(m.detachments),workers:g(m.workers),approvals:g(m.approvals),alerts:g(m.alerts)},hard_flags:Array.isArray(t.hard_flags)?t.hard_flags.map(qp).filter(u=>u!==null):[]}}function Up(t){if(!A(t))return null;const e=l(t.event_id),n=l(t.lane_id),s=l(t.kind),a=l(t.timestamp),o=l(t.title),r=l(t.detail),c=l(t.tone),d=l(t.source);return!e||!n||!s||!a||!o||!r||!c||!d?null:{event_id:e,lane_id:n,kind:s,timestamp:a,title:o,detail:r,tone:c,source:d}}function Hp(t){if(!A(t))return null;const e=l(t.code),n=l(t.severity),s=l(t.summary);return!e||!n||!s?null:{code:e,severity:n,summary:s,lane_ids:ft(t.lane_ids),count:g(t.count)??0}}function Mr(t){if(!A(t))return;const e=A(t.overview)?t.overview:{},n=A(t.gaps)?t.gaps:{},s=A(t.recommended_next_action)?t.recommended_next_action:void 0;return{generated_at:l(t.generated_at),overview:{active_lanes:g(e.active_lanes),moving_lanes:g(e.moving_lanes),stalled_lanes:g(e.stalled_lanes),projected_lanes:g(e.projected_lanes),last_movement_at:l(e.last_movement_at)??null},lanes:Array.isArray(t.lanes)?t.lanes.map(Kp).filter(a=>a!==null):[],timeline:Array.isArray(t.timeline)?t.timeline.map(Up).filter(a=>a!==null):[],gaps:{count:g(n.count),items:Array.isArray(n.items)?n.items.map(Hp).filter(a=>a!==null):[]},recommended_next_action:s?{tool:l(s.tool)??"masc_operator_snapshot",label:l(s.label)??"Observe operator state",reason:l(s.reason)??"",lane_id:l(s.lane_id)??null}:void 0}}function Wp(t){if(!A(t))return;const e=A(t.workers)?t.workers:{},n=st(t.pass);return{status:l(t.status)??"missing",source:l(t.source)??"none",run_id:l(t.run_id)??null,captured_at:l(t.captured_at)??null,...n!==void 0?{pass:n}:{},...g(t.peak_hot_slots)!=null?{peak_hot_slots:g(t.peak_hot_slots)}:{},...g(t.ctx_per_slot)!=null?{ctx_per_slot:g(t.ctx_per_slot)}:{},workers:{expected:g(e.expected),joined:g(e.joined),current_task_bound:g(e.current_task_bound),fresh_heartbeats:g(e.fresh_heartbeats),done:g(e.done),final:g(e.final)},artifact_ref:l(t.artifact_ref)??null,missing_reason:l(t.missing_reason)??null}}function Bp(t){const e=A(t)?t:{};return{version:l(e.version),generated_at:l(e.generated_at),topology:wr(e.topology),operations:Tr(e.operations),detachments:Rr(e.detachments),alerts:Pr(e.alerts),decisions:Nr(e.decisions),capacity:jp(e.capacity),traces:Fp(e.traces),swarm_status:Mr(e.swarm_status)}}function Gp(t){const e=A(t)?t:{},n=wr(e.topology),s=Tr(e.operations),a=Rr(e.detachments),o=Pr(e.alerts),r=Nr(e.decisions);return{version:l(e.version),generated_at:l(e.generated_at),topology:{version:n.version,generated_at:n.generated_at,source:n.source,summary:n.summary},operations:{version:s.version,generated_at:s.generated_at,summary:s.summary,microarch:s.microarch},detachments:{version:a.version,generated_at:a.generated_at,summary:a.summary},alerts:{version:o.version,generated_at:o.generated_at,summary:o.summary},decisions:{version:r.version,generated_at:r.generated_at,summary:r.summary},swarm_status:Mr(e.swarm_status),swarm_proof:Wp(e.swarm_proof)}}function Jp(t){return A(t)?{chain_id:l(t.chain_id)??null,started_at:g(t.started_at)??null,progress:g(t.progress)??null,elapsed_sec:g(t.elapsed_sec)??null}:null}function Dr(t){if(!A(t))return null;const e=l(t.event);return e?{event:e,chain_id:l(t.chain_id)??null,timestamp:l(t.timestamp)??null,duration_ms:g(t.duration_ms)??null,message:l(t.message)??null,tokens:g(t.tokens)??null}:null}function Vp(t){if(!A(t))return null;const e=va(t.operation);return e?{operation:e,runtime:Jp(t.runtime),history:Dr(t.history),mermaid:l(t.mermaid)??null,preview_run:Er(t.preview_run)}:null}function Yp(t){const e=A(t)?t:{};return{status:l(e.status)??"disconnected",base_url:l(e.base_url)??null,message:l(e.message)??null}}function Xp(t){const e=A(t)?t:{},n=A(e.summary)?e.summary:void 0;return{version:l(e.version),generated_at:l(e.generated_at),connection:Yp(e.connection),summary:n?{linked_operations:g(n.linked_operations),active_chains:g(n.active_chains),running_operations:g(n.running_operations),recent_failures:g(n.recent_failures),last_history_event_at:l(n.last_history_event_at)??null}:void 0,operations:Array.isArray(e.operations)?e.operations.map(Vp).filter(s=>s!==null):[],recent_history:Array.isArray(e.recent_history)?e.recent_history.map(Dr).filter(s=>s!==null):[]}}function Qp(t){if(!A(t))return null;const e=l(t.id);return e?{id:e,type:l(t.type),status:l(t.status),duration_ms:g(t.duration_ms)??null,error:l(t.error)??null}:null}function Er(t){if(!A(t))return null;const e=l(t.run_id),n=l(t.chain_id);return n?{run_id:e??null,chain_id:n,duration_ms:g(t.duration_ms),success:st(t.success),mermaid:l(t.mermaid),nodes:Array.isArray(t.nodes)?t.nodes.map(Qp).filter(s=>s!==null):[]}:null}function Zp(t){const e=A(t)?t:{};return{run:Er(e.run)}}function tm(t){if(!A(t))return null;const e=l(t.title),n=l(t.path);return!e||!n?null:{title:e,path:n}}function em(t){if(!A(t))return null;const e=l(t.id),n=l(t.title),s=l(t.summary);return!e||!n||!s?null:{id:e,title:n,summary:s}}function nm(t){if(!A(t))return null;const e=l(t.id),n=l(t.title),s=l(t.tool),a=l(t.summary);return!e||!n||!s||!a?null:{id:e,title:n,tool:s,summary:a,success_signals:ft(t.success_signals),pitfalls:ft(t.pitfalls)}}function sm(t){if(!A(t))return null;const e=l(t.id),n=l(t.title),s=l(t.summary),a=l(t.when_to_use);return!e||!n||!s||!a?null:{id:e,title:n,summary:s,when_to_use:a,steps:Array.isArray(t.steps)?t.steps.map(nm).filter(o=>o!==null):[]}}function am(t){if(!A(t))return null;const e=l(t.id),n=l(t.title),s=l(t.description);return!e||!n||!s?null:{id:e,title:n,description:s,tools:ft(t.tools)}}function im(t){if(!A(t))return null;const e=l(t.id),n=l(t.title),s=l(t.symptom),a=l(t.why),o=l(t.fix_tool),r=l(t.fix_summary);return!e||!n||!s||!a||!o||!r?null:{id:e,title:n,symptom:s,why:a,fix_tool:o,fix_summary:r}}function om(t){if(!A(t))return null;const e=l(t.id),n=l(t.title),s=l(t.path_id),a=l(t.transport);return!e||!n||!s||!a?null:{id:e,title:n,path_id:s,transport:a,request:t.request,response:t.response,notes:ft(t.notes)}}function rm(t){const e=A(t)?t:{};return{version:l(e.version),generated_at:l(e.generated_at),docs:Array.isArray(e.docs)?e.docs.map(tm).filter(n=>n!==null):[],concepts:Array.isArray(e.concepts)?e.concepts.map(em).filter(n=>n!==null):[],golden_paths:Array.isArray(e.golden_paths)?e.golden_paths.map(sm).filter(n=>n!==null):[],tool_groups:Array.isArray(e.tool_groups)?e.tool_groups.map(am).filter(n=>n!==null):[],pitfalls:Array.isArray(e.pitfalls)?e.pitfalls.map(im).filter(n=>n!==null):[],examples:Array.isArray(e.examples)?e.examples.map(om).filter(n=>n!==null):[]}}function lm(t){if(!A(t))return null;const e=l(t.id),n=l(t.title),s=l(t.status),a=l(t.detail),o=l(t.next_tool);return!e||!n||!s||!a||!o?null:{id:e,title:n,status:s,detail:a,next_tool:o}}function cm(t){if(!A(t))return null;const e=l(t.code),n=l(t.severity),s=l(t.title),a=l(t.detail),o=l(t.next_tool);return!e||!n||!s||!a||!o?null:{code:e,severity:n,title:s,detail:a,next_tool:o}}function dm(t){if(!A(t))return null;const e=l(t.from),n=l(t.content),s=l(t.timestamp),a=g(t.seq);return!e||!n||!s||a==null?null:{seq:a,from:e,content:n,timestamp:s}}function um(t){if(!A(t))return null;const e=l(t.name),n=l(t.role),s=l(t.lane),a=l(t.status),o=l(t.claim_marker),r=l(t.done_marker),c=l(t.final_marker);if(!e||!n||!s||!a||!o||!r||!c)return null;const d=(()=>{if(!A(t.last_message))return null;const m=g(t.last_message.seq),u=l(t.last_message.content),p=l(t.last_message.timestamp);return m==null||!u||!p?null:{seq:m,content:u,timestamp:p}})();return{name:e,role:n,lane:s,joined:st(t.joined)??!1,live_presence:st(t.live_presence)??!1,completed:st(t.completed)??!1,status:a,current_task:l(t.current_task)??null,bound_task_id:l(t.bound_task_id)??null,bound_task_title:l(t.bound_task_title)??null,bound_task_status:l(t.bound_task_status)??null,current_task_matches_run:st(t.current_task_matches_run)??!1,squad_member:st(t.squad_member)??!1,detachment_member:st(t.detachment_member)??!1,last_seen:l(t.last_seen)??null,heartbeat_age_sec:g(t.heartbeat_age_sec)??null,heartbeat_fresh:st(t.heartbeat_fresh)??!1,claim_marker_seen:st(t.claim_marker_seen)??!1,done_marker_seen:st(t.done_marker_seen)??!1,final_marker_seen:st(t.final_marker_seen)??!1,claim_marker:o,done_marker:r,final_marker:c,last_message:d}}function pm(t){if(!A(t))return;const e=Array.isArray(t.timeline)?t.timeline.map(n=>{if(!A(n))return null;const s=l(n.timestamp),a=g(n.active_slots);if(!s||a==null)return null;const o=Array.isArray(n.active_slot_ids)?n.active_slot_ids.map(r=>typeof r=="number"&&Number.isFinite(r)?r:null).filter(r=>r!=null):[];return{timestamp:s,active_slots:a,active_slot_ids:o}}).filter(n=>n!==null):[];return{slot_url:l(t.slot_url)??null,provider_base_url:l(t.provider_base_url)??null,provider_reachable:st(t.provider_reachable)??null,provider_status_code:g(t.provider_status_code)??null,provider_model_id:l(t.provider_model_id)??null,actual_model_id:l(t.actual_model_id)??null,expected_slots:g(t.expected_slots),actual_slots:g(t.actual_slots),expected_ctx:g(t.expected_ctx),actual_ctx:g(t.actual_ctx),slot_reachable:st(t.slot_reachable)??null,slot_status_code:g(t.slot_status_code)??null,runtime_blocker:l(t.runtime_blocker)??null,detail:l(t.detail)??null,checked_at:l(t.checked_at)??null,total_slots:g(t.total_slots),ctx_per_slot:g(t.ctx_per_slot),active_slots_now:g(t.active_slots_now),peak_active_slots:g(t.peak_active_slots),sample_count:g(t.sample_count),last_sample_at:l(t.last_sample_at)??null,timeline:e}}function mm(t){const e=A(t)?t:{},n=A(e.summary)?e.summary:void 0;return{version:l(e.version),generated_at:l(e.generated_at),run_id:l(e.run_id),room_id:l(e.room_id),operation_id:l(e.operation_id)??null,recommended_next_tool:l(e.recommended_next_tool),summary:n?{expected_workers:g(n.expected_workers),joined_workers:g(n.joined_workers),live_workers:g(n.live_workers),squad_roster_size:g(n.squad_roster_size),detachment_roster_size:g(n.detachment_roster_size),current_task_bound:g(n.current_task_bound),fresh_heartbeats:g(n.fresh_heartbeats),claim_markers_seen:g(n.claim_markers_seen),done_markers_seen:g(n.done_markers_seen),final_markers_seen:g(n.final_markers_seen),completed_workers:g(n.completed_workers),peak_hot_slots:g(n.peak_hot_slots),hot_window_ok:st(n.hot_window_ok),pass_hot_concurrency:st(n.pass_hot_concurrency),pass_end_to_end:st(n.pass_end_to_end),pending_decisions:g(n.pending_decisions),pass:st(n.pass)}:void 0,provider:pm(e.provider),operation:va(e.operation),squad:Ei(e.squad),detachment:Ir(e.detachment),workers:Array.isArray(e.workers)?e.workers.map(um).filter(s=>s!==null):[],checklist:Array.isArray(e.checklist)?e.checklist.map(lm).filter(s=>s!==null):[],blockers:Array.isArray(e.blockers)?e.blockers.map(cm).filter(s=>s!==null):[],recent_messages:Array.isArray(e.recent_messages)?e.recent_messages.map(dm).filter(s=>s!==null):[],recent_trace_events:Array.isArray(e.recent_trace_events)?e.recent_trace_events.map(Lr).filter(s=>s!==null):[],truth_notes:ft(e.truth_notes)}}function we(t){G.value=t,Di(t)&&vm()}async function zr(){js.value=!0,Fs.value=null;try{const t=await Yl();Mi.value=Gp(t)}catch(t){Fs.value=t instanceof Error?t.message:"Failed to load command-plane summary"}finally{js.value=!1}}function zi(t){Ge.value=t}async function ji(){Os.value=!0,qs.value=null;try{const t=await Vl();Gt.value=Bp(t)}catch(t){qs.value=t instanceof Error?t.message:"Failed to load command-plane snapshot"}finally{Os.value=!1}}async function vm(){Gt.value||Os.value||await ji()}async function oe(){await zr(),Di(G.value)&&await ji()}async function re(){var t;vi.value=!0,Bs.value=null;try{const e=await Xl(),n=Xp(e);Yn.value=n;const s=Ge.value;n.operations.length===0?Ge.value=null:(!s||!n.operations.some(a=>a.operation.operation_id===s))&&(Ge.value=((t=n.operations[0])==null?void 0:t.operation.operation_id)??null)}catch(e){Bs.value=e instanceof Error?e.message:"Failed to load chain summary"}finally{vi.value=!1}}function _m(){pn=null,Dn.value=null,Gs.value=!1,En.value=null}async function fm(t){pn=t,Gs.value=!0,En.value=null;try{const e=await Ql(t);if(pn!==t)return;Dn.value=Zp(e)}catch(e){if(pn!==t)return;Dn.value=null,En.value=e instanceof Error?e.message:"Failed to load chain run"}finally{pn===t&&(Gs.value=!1)}}async function gm(){mi.value=!0,Us.value=null;try{const t=await Zl();Vn.value=rm(t)}catch(t){Us.value=t instanceof Error?t.message:"Failed to load command-plane help"}finally{mi.value=!1}}async function Ot(t=wp(),e=Tp()){Hs.value=!0,Ws.value=null;try{const n=await tc(t,e);Te.value=mm(n)}catch(n){Ws.value=n instanceof Error?n.message:"Failed to load command-plane swarm view"}finally{Hs.value=!1}}async function fe(t,e,n){pi.value=t,Ks.value=null;try{await ec(e,n),await zr(),(Gt.value||Di(G.value))&&await ji(),await Ot(),await re()}catch(s){throw Ks.value=s instanceof Error?s.message:"Failed to execute command-plane action",s}finally{pi.value=null}}function $m(t){return fe(`pause:${t}`,"/api/v1/command-plane/operations/pause",{operation_id:t})}function hm(t){return fe(`resume:${t}`,"/api/v1/command-plane/operations/resume",{operation_id:t})}function ym(t){return fe(`recall:${t}`,"/api/v1/command-plane/dispatch/recall",{operation_id:t})}function bm(t={}){return fe("dispatch:tick","/api/v1/command-plane/dispatch/tick",{...t.operationId?{operation_id:t.operationId}:{},...t.detachmentId?{detachment_id:t.detachmentId}:{}})}function km(t){return fe(`approve:${t}`,"/api/v1/command-plane/policy/approve",{decision_id:t})}function xm(t){return fe(`deny:${t}`,"/api/v1/command-plane/policy/deny",{decision_id:t})}function Sm(t,e){return fe(`freeze:${t}`,"/api/v1/command-plane/policy/freeze",{unit_id:t,enabled:e})}function Am(t,e){return fe(`kill:${t}`,"/api/v1/command-plane/policy/kill-switch",{unit_id:t,enabled:e})}Id(()=>{oe(),re(),(G.value==="swarm"||G.value==="warroom"||Te.value!==null)&&Ot(),G.value==="warroom"&&lt()});const Cm="modulepreload",wm=function(t){return"/dashboard/"+t},uo={},Tm=function(e,n,s){let a=Promise.resolve();if(n&&n.length>0){let r=function(m){return Promise.all(m.map(u=>Promise.resolve(u).then(p=>({status:"fulfilled",value:p}),p=>({status:"rejected",reason:p}))))};document.getElementsByTagName("link");const c=document.querySelector("meta[property=csp-nonce]"),d=(c==null?void 0:c.nonce)||(c==null?void 0:c.getAttribute("nonce"));a=r(n.map(m=>{if(m=wm(m),m in uo)return;uo[m]=!0;const u=m.endsWith(".css"),p=u?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${m}"]${p}`))return;const v=document.createElement("link");if(v.rel=u?"stylesheet":Cm,u||(v.as="script"),v.crossOrigin="",v.href=m,d&&v.setAttribute("nonce",d),document.head.appendChild(v),u)return new Promise(($,k)=>{v.addEventListener("load",$),v.addEventListener("error",()=>k(new Error(`Unable to preload CSS for ${m}`)))})}))}function o(r){const c=new Event("vite:preloadError",{cancelable:!0});if(c.payload=r,window.dispatchEvent(c),!c.defaultPrevented)throw r}return a.then(r=>{for(const c of r||[])c.status==="rejected"&&o(c.reason);return e().catch(o)})};function jr(t){if(t==null)return"";if(typeof t=="string")return t;try{return JSON.stringify(t,null,2)}catch{return String(t)}}function Z(t){if(!t)return"n/a";const e=Date.parse(t);if(Number.isNaN(e))return t;const n=Math.max(0,Math.round((Date.now()-e)/1e3));return n<60?`${n}s ago`:n<3600?`${Math.round(n/60)}m ago`:n<86400?`${Math.round(n/3600)}h ago`:`${Math.round(n/86400)}d ago`}function Im(t){if(!t)return"warn";const e=Date.parse(t);return Number.isNaN(e)?"warn":e<=Date.now()?"bad":"ok"}function Or(t){if(!t)return"n/a";const e=Date.parse(t);if(Number.isNaN(e))return t;const n=Math.round((e-Date.now())/1e3);return n<=0?"expired":n<60?`in ${n}s`:n<3600?`in ${Math.round(n/60)}m`:n<86400?`in ${Math.round(n/3600)}h`:`in ${Math.round(n/86400)}d`}function D(t){return t==="bad"?"bad":t==="warn"||t==="pending"?"warn":"ok"}let po=!1,Rm=0;function Nm(){return++Rm}let xa=null;async function Pm(){xa||(xa=Tm(()=>import("./mermaid.core-BKMfhqzO.js").then(e=>e.bE),[]).then(e=>e.default));const t=await xa;return po||(t.initialize({startOnLoad:!1,theme:"dark",securityLevel:"loose"}),po=!0),t}function le(t){if(!t)return"warn";const e=t.toLowerCase();return e.includes("failed")||e.includes("error")||e.includes("disconnected")||e.includes("stopped")?"bad":e.includes("running")||e.includes("active")||e.includes("degraded")||e.includes("pending")?"warn":"ok"}function Xn(t){return typeof t!="number"||!Number.isFinite(t)?"n/a":`${Math.round(t*100)}%`}function mn(t){return typeof t!="number"||!Number.isFinite(t)?"n/a":t<60?`${Math.round(t)}s`:t<3600?`${Math.round(t/60)}m`:`${Math.round(t/3600)}h`}function Qn(t){return typeof t!="number"||!Number.isFinite(t)?0:Math.max(0,Math.min(100,t))}function ke(t,e){return typeof t!="number"||!Number.isFinite(t)||typeof e!="number"||!Number.isFinite(e)||e<=0?0:Qn(t/e*100)}function Lm(t,e){const n=Qn(t);return`--gauge-angle:${Math.max(10,Math.round(n/100*360))}deg;--gauge-color:${e};`}function Fr(t){if(!t)return"No recent chain history";const e=[t.event];return typeof t.duration_ms=="number"&&e.push(`${t.duration_ms}ms`),typeof t.tokens=="number"&&e.push(`${t.tokens} tokens`),t.message&&e.push(t.message),e.join(" · ")}const Mm=[{id:"status",label:"현황"},{id:"history",label:"이력"},{id:"control",label:"통제"}],qr=[{id:"warroom",label:"워룸",group:"status"},{id:"summary",label:"요약",group:"status"},{id:"topology",label:"토폴로지",group:"status"},{id:"swarm",label:"스웜",group:"status"},{id:"operations",label:"작전",group:"history"},{id:"trace",label:"트레이스",group:"history"},{id:"chains",label:"체인",group:"history"},{id:"control",label:"제어",group:"control"},{id:"alerts",label:"알림",group:"control"}],Dm=qr.map(t=>t.id),Em=["chain_start","node_start","node_complete","chain_complete","chain_error"],zm={warroom:{title:"라이브 워룸",description:"실제 run, worker, message, trace를 한 화면에서 따라가는 기본 진입 표면입니다."},operations:{title:"현재 작전 상세",description:"활성 operation, detachment, dependency를 먼저 읽는 기본 진입 표면입니다."},swarm:{title:"스웜 실행 흐름",description:"lane 이동, worker 결속, blocker를 따라가며 현장감 있게 보는 표면입니다."},chains:{title:"체인 런타임",description:"체인 연결 상태와 operation별 실행 그래프를 확인하는 표면입니다."},topology:{title:"지휘 계층",description:"company에서 agent까지 지휘 계층과 live roster를 확인합니다."},alerts:{title:"경보 모음",description:"지금 개입을 밀어올리는 alert만 모아서 보는 표면입니다."},trace:{title:"최근 트레이스",description:"operation, actor, unit 단위 이벤트를 시간순으로 보는 표면입니다."},control:{title:"승인과 제어",description:"decision 승인과 unit 제어를 실제로 수행하는 표면입니다."},summary:{title:"지휘 요약",description:"전체 지휘면을 한 번에 훑는 계기판 성격의 요약 표면입니다."}};function mo(t){return!!t&&Dm.includes(t)}function jm(){const t=O.value.params;return t.source!=="mission"?{}:{source:"mission",...t.action_type?{action_type:t.action_type}:{},...t.target_type?{target_type:t.target_type}:{},...t.target_id?{target_id:t.target_id}:{},...t.focus_kind?{focus_kind:t.focus_kind}:{}}}function Kr(t){const e=jm();if(t==="operations")return e;if(t==="chains"){const n=Ge.value;return n?{...e,surface:t,operation:n}:{...e,surface:t}}return{...e,surface:t}}function Om(){const t=new URLSearchParams(window.location.search),e=new URLSearchParams,n=t.get("agent")??t.get("agent_name"),s=t.get("token");return n&&e.set("agent",n),s&&e.set("token",s),e.toString()?`/api/v1/chains/events?${e.toString()}`:"/api/v1/chains/events"}function Fm(t){switch(t){case"company":return"중대 / Company";case"platoon":return"소대 / Platoon";case"squad":return"분대 / Squad";case"agent":return"에이전트 / Agent";default:return t}}function ct(t){return pi.value===t}function Zn(){return Mi.value}function qm(t){var a,o,r,c,d,m,u;const e=Mi.value,n=Te.value,s=Yn.value;switch(t){case"warroom":return{tool:"masc_observe_operations",reason:"live run, worker, message, trace를 한 화면에서 보고 필요한 detail 표면으로 바로 점프합니다."};case"operations":return{tool:"masc_operation_status",reason:`활성 작전 ${((a=e==null?void 0:e.operations.summary)==null?void 0:a.active)??0}개와 dependency를 먼저 확인합니다.`};case"swarm":return{tool:(n==null?void 0:n.recommended_next_tool)??((r=(o=e==null?void 0:e.swarm_status)==null?void 0:o.recommended_next_action)==null?void 0:r.tool)??"masc_observe_traces",reason:((d=(c=e==null?void 0:e.swarm_status)==null?void 0:c.recommended_next_action)==null?void 0:d.reason)??"lane 이동과 blocker를 보고 다음 probe 도구를 고릅니다."};case"chains":return{tool:(u=(m=s==null?void 0:s.operations[0])==null?void 0:m.preview_run)!=null&&u.chain_id?"masc_chain_run_get":"masc_chain_snapshot",reason:"체인 연결 상태와 최근 run 그래프를 함께 보면 병목을 빨리 좁힐 수 있습니다."};case"topology":return{tool:"masc_observe_topology",reason:"지휘 계층과 live roster를 같이 봐야 빈 squad나 고립 unit을 놓치지 않습니다."};case"alerts":return{tool:"masc_observe_alerts",reason:"경보에서 먼저 문제가 된 unit과 operation을 고릅니다."};case"trace":return{tool:"masc_observe_traces",reason:"trace 흐름으로 원인 이벤트를 바로 따라갈 수 있습니다."};case"control":return{tool:"masc_operator_action",reason:"승인이나 kill switch 같은 실제 조작은 control 표면과 operator action이 이어집니다."};case"summary":default:return{tool:"masc_observe_operations",reason:"요약을 본 뒤에는 현재 작전 표면으로 내려가 실제 움직임을 확인하는 게 가장 빠릅니다."}}}function Km(t){var n;const e=((n=t==null?void 0:t.focus_kind)==null?void 0:n.toLowerCase())??"";return e?e.includes("artifact_scope")||e.includes("routing_confidence")||e.includes("cache_contention")?"microarch":e.includes("leader_offline")||e.includes("roster_offline")?"alerts":e.includes("stale_data")?"swarm":null:null}function Um(t){var n;const e=((n=t==null?void 0:t.focus_kind)==null?void 0:n.toLowerCase())??"";return e?e.includes("stale_data")||e.includes("leader_offline")||e.includes("roster_offline")||e.includes("managed")?"recommendation":e.includes("gap")?"gaps":null:null}function Hm(){if(typeof window>"u")return null;const t=new URLSearchParams(window.location.search),e=t.get("agent")??t.get("agent_name");if(!e)return null;const n=e.trim();return n===""?null:n}function Ur(){if(typeof window>"u")return new URLSearchParams;const t=new URLSearchParams(window.location.search),e=window.location.hash.replace(/^#/,""),n=e.indexOf("?");return n>=0&&new URLSearchParams(e.slice(n+1)).forEach((a,o)=>{t.has(o)||t.set(o,a)}),t}function Wm(){const e=Ur().get("run_id");if(!e)return null;const n=e.trim();return n===""?null:n}function Hr(){const e=Ur().get("operation_id");if(!e)return null;const n=e.trim();return n===""?null:n}function Bm(t){if(!t)return null;const e=Date.parse(t);return Number.isNaN(e)?null:Math.max(0,Math.round((Date.now()-e)/1e3))}function Gm(t){return t.status==="claimed"||t.status==="in_progress"}function Jm(t){const e=Vn.value;if(!e)return null;for(const n of e.golden_paths){const s=n.steps.find(a=>a.tool===t);if(s)return s}return null}function Sa(t){var e;return((e=Vn.value)==null?void 0:e.golden_paths.find(n=>n.id===t))??null}function Vm(t){const e=Vn.value;if(!e)return[];const n=new Set(t);return e.pitfalls.filter(s=>n.has(s.id))}async function ce(t){try{await t()}catch{}}function Oi(t){return(t==null?void 0:t.trim().toLowerCase())??""}function Oe(t){const e=Oi(t);return e.includes("failed")||e.includes("error")||e.includes("stopped")||e==="paused"?"bad":e.includes("active")||e.includes("running")||e.includes("healthy")||e.includes("ok")?"ok":"warn"}function Aa(t){const e=Oi(t);return e?e==="active"||e==="running"?"진행 중":e==="paused"?"일시정지":e==="done"||e==="ended"||e==="completed"?"완료":e==="failed"||e==="error"||e==="stopped"?"문제":(t==null?void 0:t.trim())||"확인 필요":"확인 필요"}function Ym(){var e,n,s;const t=Te.value;return t?!!(t.run_id||(e=t.operation)!=null&&e.operation_id||(n=t.detachment)!=null&&n.detachment_id||(((s=t.summary)==null?void 0:s.expected_workers)??0)>0||t.workers.length>0||t.recent_messages.length>0||t.recent_trace_events.length>0):!1}function Xm(t){const e=Oi(t.status);return e==="active"||e==="running"}function Qm(){var o,r,c,d;const t=((o=Ht.value)==null?void 0:o.sessions)??[],e=Te.value,n=((r=e==null?void 0:e.detachment)==null?void 0:r.session_id)??null;if(n){const m=t.find(u=>u.session_id===n);if(m)return m}const s=((c=e==null?void 0:e.operation)==null?void 0:c.operation_id)??Hr();if(s){const m=t.find(u=>u.command_plane_operation_id===s);if(m)return m}const a=((d=e==null?void 0:e.detachment)==null?void 0:d.detachment_id)??null;if(a){const m=t.find(u=>u.command_plane_detachment_id===a);if(m)return m}return t.find(Xm)??t[0]??null}function Zm(){const t=Jn(O.value);return t?i`
  ...
  `}function ev(){var F,tt,B,et;const t=Zn(),e=t==null?void 0:t.topology.summary,n=t==null?void 0:t.operations.summary,s=t==null?void 0:t.detachments.summary,a=t==null?void 0:t.decisions.summary,o=t==null?void 0:t.alerts.summary,r=(F=t==null?void 0:t.swarm_status)==null?void 0:F.overview,c=t==null?void 0:t.swarm_proof,d=t==null?void 0:t.operations.microarch,m=(e==null?void 0:e.managed_unit_count)??0,u=(e==null?void 0:e.total_units)??0,p=(n==null?void 0:n.active)??0,v=(s==null?void 0:s.active)??0,$=(r==null?void 0:r.moving_lanes)??0,k=(r==null?void 0:r.active_lanes)??0,x=(c==null?void 0:c.workers.done)??0,C=(c==null?void 0:c.workers.expected)??0,N=(o==null?void 0:o.bad)??0,w=(o==null?void 0:o.warn)??0,E=(a==null?void 0:a.pending)??0,P=(a==null?void 0:a.total)??0,L=p+v,Y=((tt=d==null?void 0:d.cache)==null?void 0:tt.l1_hit_rate)??((et=(B=d==null?void 0:d.signals)==null?void 0:B.cache_contention)==null?void 0:et.l1_hit_rate)??0,J=p>0||v>0?"지휘면이 실제로 움직이고 있습니다":"계층은 준비됐지만 실행은 아직 잠복 상태입니다",f=p>0||$>0?"무거운 상세 탭으로 들어가기 전에, 여기서 먼저 압력과 이동감, 운영 부채를 읽을 수 있어야 합니다.":"이 화면은 체크리스트보다 계기판에 가까워야 합니다. 아래 게이지가 지금 어디가 살아 있는지 먼저 보여줍니다.";return i`
    <section class="command-hero command-hero-summary">
      <div class="command-hero-copy">
        ...
        <span class="command-chip ${D(p>0?"ok":"warn")}">활성 작전 ${p}</span>
          ...
          <span class="command-chip ${D(N>0?"bad":w>0?"warn":"ok")}">치명 알림 ${N}</span>
    ...
    <div class="command-signal-grid">
      ...
      <${rs}
        ...
        percent=${ke(N*2+w,Math.max((N+w)*2,1))}
        tone=${N>0?"bad":w>0?"warn":"ok"}
      />
      <${rs}
        label="디스패치 점유"
          value=${`${v}개 가동`}
      ...
      <section class="card command-section">
        ...
        <div class="command-guide-card highlight command-next-step-card">
          <div class="command-guide-head">
            <strong>${(N==null?void 0:N.title)??C}</strong>
            <span class="command-chip ok">${C}</span>
          </div>
          <p>${(N==null?void 0:N.summary)??"지금 막고 있는 병목을 풀기 위해 canonical flow의 다음 tool부터 실행합니다."}</p>
          ${($e=N==null?void 0:N.success_signals)!=null&&$e.length?i`<div class="command-tag-row">
                ${N.success_signals.map(j=>i`<span class="command-tag ok">${j}</span>`)}
              </div>`:null}
        </div>
  ...
  `}function Fi({event:t}){return i`
    <article class="command-trace-row">
      ...
      <pre class="command-trace-detail">${jr(t.detail)}</pre>
    </article>
  `}function rv(){const t=Gt.value;return i`
    <section class="card command-section">
      ...
      ${t&&t.topology.units.length>0?i`${t.topology.units.map(e=>i`<${Wr} node=${e} />`)}`:i`<div class="empty-state">아직 그려진 지휘 계층이 없습니다.</div>`}
    </section>
  `}function lv(){const t=Gt.value;return i`
    <section class="card command-section">
      ...
      ${t&&t.alerts.alerts.length>0?i`<div class="command-card-stack">
            ${t.alerts.alerts.map(e=>i`<${ov} alert=${e} />`)}
  ...
  `}function dv({total:t}){const n=Math.min(t,20),s=t>20?t-20:0,a=Array.from({length:n});return i`
  ...
  `}function uv({lane:t}){const e=t.counts??{},n=Br(t),s=e.workers??0,a=e.operations??0,o=e.detachments??0,r=a+o,c=t.motion_state==="moving"?84:t.motion_state==="waiting"?58:t.motion_state==="terminal"?100:26;return i`
  ...
  `}function Jr({lanes:t}){const e=t.slice(0,4);return e.length===0?null:i`
    <div class="swarm-storyboard">
      ${e.map(n=>{const s=Br(n),a=n.counts.workers??0,o=n.counts.operations??0,r=n.counts.detachments??0;return i`
  ...
  `}function pv({event:t}){const e=t.timestamp?new Date(t.timestamp):null,n=e&&!isNaN(e.getTime())?e:null,s=n?`${String(n.getHours()).padStart(2,"0")}:${String(n.getMinutes()).padStart(2,"0")}`:"";return i`
  ...
  `}function vv({proof:t}){const e=(t==null?void 0:t.status)==="missing"?"warn":(t==null?void 0:t.pass)===!1?"bad":(t==null?void 0:t.pass)===!0?"ok":"warn";return i`
  ...
  `}function _v(){const t=Zn(),e=Jn(O.value),n=Um(e),s=t==null?void 0:t.swarm_status,a=t==null?void 0:t.swarm_proof,o=(s==null?void 0:s.lanes.filter(p=>p.present))??[],r=(s==null?void 0:s.gaps.items)??[],c=(s==null?void 0:s.timeline.slice(0,8))??[],d=s==null?void 0:s.overview,m=s==null?void 0:s.recommended_next_action,u=o.length<=1;return i`
    <section class="card command-section">
      ...
      ${s?i`
            ...
            ${o.length>0?i`<${Gr} lanes=${o} />`:null}

            <div class="command-swarm-layout ${u?"compact":""}">
              <div class="command-card-stack">
                ${o.length>0?o.map(p=>i`<${uv} lane=${p} />`):i`<div class="empty-state">활성 스웜 레인이 없습니다.</div>`}
              </div>
              ...
              <div class="command-card-stack">
                ...
                <div class="command-guide-card ${r.length>0?"warn":"ok"} ${n==="gaps"?"focus":""}">
                  ...
                  ${r.length>0?i`<div class="swarm-event-rail">${r.slice(0,4).map(p=>i`<${mv} gap=${p} />`)}</div>`:i`<p>지금 보이는 핵심 공백은 없습니다.</p>`}
                </div>
                ...
                <div class="command-guide-card">
                  ...
                  ${c.length>0?i`<div class="swarm-event-rail">${c.map(p=>i`<${pv} event=${p} />`)}</div>`:i`<p>붙어 있는 최근 이동 이벤트가 아직 없습니다.</p>`}
                </div>
              </div>
            </div>
          `:i`<div class="empty-state">스웜 상태를 아직 불러오지 못했습니다.</div>`}
    </section>
  `}function fv({item:t}){return i`
  ...
  `}function Vr({blocker:t}){return i`
    <article class="command-alert ${D(t.severity)}">
      <div class="command-card-head">
        <strong>${t.title}</strong>
  ...
  `}function $v(){var d,m,u,p,v,$,k,x,C,N,w,E,P,L,Y,J,f,F,tt,B,et;const t=Te.value,e=Wm(),n=Hr(),s=(d=t==null?void 0:t.provider)!=null&&d.runtime_blocker?"blocked":(m=t==null?void 0:t.provider)!=null&&m.provider_reachable?"ready":"check",a=((u=t==null?void 0:t.provider)==null?void 0:u.actual_slots)??((p=t==null?void 0:t.provider)==null?void 0:p.total_slots)??0,o=((v=t==null?void 0:t.provider)==null?void 0:v.expected_slots)??"n/a",r=(($=t==null?void 0:t.provider)==null?void 0:$.actual_ctx)??((k=t==null?void 0:t.provider)==null?void 0:k.ctx_per_slot)??0,c=((x=t==null?void 0:t.provider)==null?void 0:x.expected_ctx)??"n/a";return i`
      ...
      <div class="command-surface-grid">
        <section class="card command-section">
          ...
          ${Hs.value?i`<div class="empty-state">Loading swarm live state…</div>`:Ws.value?i`<div class="empty-state error">${Ws.value}</div>`:t?i`
                    <div class="command-summary-grid">
                      ...
                      <div class="monitor-stat-card"><span>워커</span><strong>${((C=t.summary)==null?void 0:C.joined_workers)??0}/${((N=t.summary)==null?void 0:N.expected_workers)??0}</strong><small>${((w=t.summary)==null?void 0:w.live_workers)??0}개 가동 · ${((E=t.summary)==null?void 0:E.completed_workers)??0}개 완료</small></div>
        ...
        <section class="card command-section">
          ...
          ${t&&t.blockers.length>0?i`<div class="command-card-stack">
                ${t.blockers.map(b=>i`<${Vr} blocker=${b} />`)}
      ...
      <div class="command-warroom-grid">
          ...
          <section class="card command-section">
            ...
            ${e&&e.recent_messages.length>0?i`<div class="command-trace-stack">
                  ...
                  `)}
                    ...
                    ${$.slice(0,4).map(U=>i`
                      <article class="command-guide-card ${vo(U)}">
                        <div class="command-guide-head">
                          <strong>${U.action_type}</strong>
                          <span class="command-chip ${vo(U)}">${U.target_type}</span>
                        </div>
                        <p>${U.reason}</p>
                      </article>
                    `)}
                    ...
                    `)}
                      ...
                      ${a.recent_events.slice(0,6).map((U,Re)=>i`
                        <article class="command-trace-row">
                          <div class="command-trace-main">
                            <div class="command-trace-head">
                              <strong>session-event-${Re+1}</strong>
                              <span class="command-chip">${a.session_id}</span>
                            </div>
                          </div>
                          <pre class="command-trace-detail">${jr(U)}</pre>
                        </article>
                      `)}
        ...
        <div class="command-warroom-column">
          <section class="card command-section">
            ...
            <div class="command-card-stack">
              ${v.length>0?v.map(U=>i`<${Vr} blocker=${U} />`):i`<div class="command-guide-card ok"><p>지금 보이는 blocker는 없습니다.</p></div>`}
              ${u>0?i`
              ...
              ${e!=null&&e.detachment?i`
                    <article class="command-card compact">
                      ...
                      <div class="command-card-grid">
                        ...
                        <span>Heartbeat</span><span>${Or(e.detachment.heartbeat_deadline)}</span>
                      </div>
                    </article>
                  `:null}
              ${a?i`
  ...
  `}function xv({source:t}){const e=fl(null),[n,s]=Po(null);return rt(()=>{let a=!1;const o=e.current;return o?(o.innerHTML="",s(null),(async()=>{try{const c=await Pm(),{svg:d}=await c.render(`command-chain-${Nm()}`,t);if(a||!e.current)return;e.current.innerHTML=d}catch(c){if(a)return;s(c instanceof Error?c.message:"Mermaid render failed")}})(),()=>{a=!0,e.current&&(e.current.innerHTML="")}):void 0},[t]),i`
  ...
  `}function wv({card:t}){const e=t.operation,n=`pause:${e.operation_id}`,s=`resume:${e.operation_id}`,a=`recall:${e.operation_id}`,o=e.chain,r=(o==null?void 0:o.run_id)??null;return i`
    <article class="command-card">
      ...
      <div class="command-action-row">
        ...
        ${o?i`
              <button
                class="control-btn ghost"
                onClick=${()=>{zi(e.operation_id),we("chains"),$t("command",{surface:"chains",operation:e.operation_id})}}
              >
                Open Chain
              </button>
            `:null}
        ${e.source==="managed"&&e.status==="active"?i`
              <button class="control-btn ghost" disabled=${ct(n)} onClick=${()=>ce(()=>$m(e.operation_id))}>
                ${ct(n)?"Pausing…":"Pause"}
              </button>
              <button class="control-btn ghost" disabled=${ct(a)} onClick=${()=>ce(()=>ym(e.operation_id))}>
                ${ct(a)?"Recalling…":"Recall"}
              </button>
            `:null}
        ${e.source==="managed"&&e.status==="paused"?i`
              <button class="control-btn ghost" disabled=${ct(s)} onClick=${()=>ce(()=>hm(e.operation_id))}>
  ...
  `}function Tv({card:t}){var n;const e=t.detachment;return i`
    <article class="command-card compact">
      ...
      <div class="command-card-grid">
        ...
        <span>Heartbeat</span><span>${Or(e.heartbeat_deadline)}</span>
        <span>Updated</span><span>${Z(e.updated_at)}</span>
      </div>
      <div class="command-tag-row">
  ...
  `}function Iv(){const t=Gt.value;return i`
    <div class="command-surface-grid">
      <section class="card command-section">
        <div class="card-title-row">
        ...
        ${t&&t.operations.operations.length>0?i`<div class="command-card-stack">
              ${t.operations.operations.map(e=>i`<${wv} card=${e} />`)}
  ...
  `}function Rv(){var c,d,m,u,p,v,$,k,x,C,N,w,E,P,L,Y;const t=Yn.value,e=(t==null?void 0:t.operations)??[],n=Ge.value,s=e.find(J=>J.operation.operation_id===n)??e[0]??null,a=((c=s==null?void 0:s.operation.chain)==null?void 0:c.run_id)??null,o=((d=Dn.value)==null?void 0:d.run)??(s==null?void 0:s.preview_run)??null,r=!((m=Dn.value)!=null&&m.run)&&!!(s!=null&&s.preview_run);return rt(()=>{a?fm(a):_m()},[a]),i`
      ...
      <section class="card command-section">
                ...
                <div class="command-chain-list">
                  ${e.map(J=>i`
                    <${Sv}
                      ...
                      onSelect=${()=>zi(J.operation.operation_id)}
                    />
                  `)}
                </div>
        ...
        <div class="command-chain-history">
          ...
          ${t&&t.recent_history.length>0?i`
                <div class="command-card-stack">
                  ${t.recent_history.slice(0,6).map(J=>i`<${Av} item=${J} />`)}
                </div>
  ...
  `}function Nv({decision:t}){const e=`approve:${t.decision_id}`,n=`deny:${t.decision_id}`,s=t.source==="projected_operator";return i`
    <article class="command-card ${D(t.status)}">
      ...
      ${t.status==="pending"&&!s?i`
            <div class="command-action-row">
              <button class="control-btn ghost" disabled=${ct(e)} onClick=${()=>ce(()=>km(t.decision_id))}>
                ${ct(e)?"Approving…":"Approve"}
              </button>
              <button class="control-btn ghost" disabled=${ct(n)} onClick=${()=>ce(()=>xm(t.decision_id))}>
                ${ct(n)?"Denying…":"Deny"}
              </button>
            </div>
          `:null}
  ...
  `}function Pv({row:t}){var c,d,m;const e=t.unit,n=`freeze:${e.unit_id}`,s=`kill:${e.unit_id}`,a=!!((c=e.policy)!=null&&c.frozen),o=!!((d=e.policy)!=null&&d.kill_switch),r=Math.round((t.utilization??0)*100);return i`
    <article class="command-card compact">
      <div class="command-card-head">
        <div>
      ...
      <div class="command-action-row">
        <button class="control-btn ghost" disabled=${ct(n)} onClick=${()=>ce(()=>Sm(e.unit_id,!a))}>
          ${ct(n)?"Applying…":a?"Unfreeze":"Freeze"}
        </button>
        <button class="control-btn ghost" disabled=${ct(s)} onClick=${()=>ce(()=>Am(e.unit_id,!o))}>
    ...
    <div class="command-surface-grid">
      ...
      <section class="card command-section">
        ...
        ${t&&t.capacity.capacity.length>0?i`<div class="command-card-stack">
              ${t.capacity.capacity.map(e=>i`<${Pv} row=${e} />`)}
      ...
      ${Mm.map(t=>i`
        <div class="command-tab-group" key=${t.id}>
          ...
          <div class="command-tab-group-items">
            ${qr.filter(e=>e.group===t.id).map(e=>i`
                <button
                  class="command-surface-tab ${G.value===e.id?"active":""}"
                  onClick=${()=>{we(e.id),$t("command",Kr(e.id))}}
                >
                  ${e.label}
                </button>
              `)}
  ...
  `}function Dv(){if(G.value==="warroom")return i`<${kv} />`;if(G.value==="summary")return i`<${av} />`;if(G.value==="swarm")return i`<${$v} />`;if(!Gt.value)return i`<${iv} />`;switch(G.value){case"chains":return i`<${Rv} />`;case"topology":return i`<${rv} />`;case"alerts":return i`<${lv} />`;case"trace":return i`<${cv} />`;case"control":return i`<${Lv} />`;case"operations":default:return i`<${Iv} />`}}function Ev(){return rt(()=>{oe(),re(),gm(),Ot()},[]),rt(()=>{if(O.value.tab!=="command")return;const t=O.value.params.surface,e=O.value.params.operation,n=Jn(O.value);if(mo(t))we(t);else if(n){const s=br(n);mo(s)&&we(s)}else t||we("warroom");e&&zi(e),(t==="swarm"||t==="warroom"||G.value==="warroom")&&Ot(),(t==="warroom"||G.value==="warroom")&&lt()},[O.value.tab,O.value.params.surface,O.value.params.operation,O.value.params.operation_id,O.value.params.run_id,O.value.params.source,O.value.params.action_type,O.value.params.target_type,O.value.params.target_id,O.value.params.focus_kind]),rt(()=>{let t=null;const e=()=>{t||(t=window.setTimeout(()=>{t=null,oe(),re(),(G.value==="swarm"||G.value==="warroom")&&Ot(),G.value==="warroom"&&lt()},250))},n=new EventSource(Om()),s=Em.map(a=>{const o=()=>e();return n.addEventListener(a,o),{type:a,handler:o}});return n.onerror=()=>{e()},()=>{s.forEach(({type:a,handler:o})=>{n.removeEventListener(a,o)}),n.close(),t&&window.clearTimeout(t)}},[]),rt(()=>{const t=window.setInterval(()=>{if(document.visibilityState==="hidden")return;const e=G.value;e!=="swarm"&&e!=="warroom"||(oe(),Ot(),e==="warroom"&&lt())},5e3);return()=>{window.clearInterval(t)}},[]),i`
    <section class="dashboard-panel command-plane-view">
      ...
      <${Zm} />
      ${G.value==="warroom"?null:i`<${tv} />`}
      <${Mv} />
      <${Dv} />
    </section>
  `}const Yr="masc_dashboard_agent_name";function zv(){var e,n,s;const t=new URLSearchParams(window.location.search);return((e=t.get("agent"))==null?void 0:e.trim())||((n=t.get("agent_name"))==null?void 0:n.trim())||((s=localStorage.getItem(Yr))==null?void 0:s.trim())||"dashboard"}const _a=_(zv()),Je=_(""),_i=_("운영 점검"),Ve=_(""),zn=_(""),jn=_("2"),On=_(""),Ft=_("note"),Fn=_(""),qn=_(""),Kn=_(""),Un=_("2"),Js=_("운영자 중지 요청"),Vs=_(""),Ye=_(""),ls=_(null);function jv(t){const e=t.trim()||"dashboard";_a.value=e,localStorage.setItem(Yr,e)}function _o(t){if(t==null)return"";if(typeof t=="string")return t;try{return JSON.stringify(t,null,2)}catch{return String(t)}}function Ov(t){return typeof t!="number"||!Number.isFinite(t)?"확인 없음":t<60?`${Math.round(t)}초 전`:t<3600?`${Math.round(t/60)}분 전`:`${Math.round(t/3600)}시간 전`}function tn(t){return typeof t=="string"?t.trim().toLowerCase():""}function Fv(t){var s;const e=tn(t.status);if(e==="paused")return"bad";if(e===""||e==="unknown")return"warn";const n=tn((s=t.team_health)==null?void 0:s.status);return n&&n!=="ok"&&n!=="healthy"&&n!=="green"||e&&e!=="active"&&e!=="running"&&e!=="ended"?"warn":"ok"}function Ca(t){const e=tn(t.status);return e==="offline"||e==="inactive"||e==="error"?"bad":e===""||e==="unknown"||(t.context_ratio??0)>=.8||t.context_ratio==null||t.last_turn_ago_s==null||(t.last_turn_ago_s??0)>=3600?"warn":"ok"}function fo(t){return t.some(e=>tn(e.severity)==="bad")?"bad":t.length>0?"warn":"ok"}function qv(t){return t.target_type==="team_session"}function Kv(t){return t.target_type==="keeper"}function cs(t){switch(t){case"broadcast":return"방송";case"room_pause":return"room 일시정지";case"room_resume":return"room 재개";case"team_turn":return"세션 업데이트";case"team_note":return"세션 노트";case"team_broadcast":return"세션 방송";case"team_task_inject":return"세션 작업 주입";case"task_inject":return"작업 주입";case"team_stop":return"세션 중지";case"keeper_message":return"keeper 메시지";case"keeper_msg":return"keeper 메시지";default:return(t==null?void 0:t.trim())||"액션"}}function ds(t){switch(t){case"room":return"room";case"team_session":return"session";case"keeper":return"keeper";default:return(t==null?void 0:t.trim())||"target"}}function dn(t){switch(tn(t)){case"running":case"active":return"진행 중";case"paused":return"일시정지";case"ended":case"done":return"종료";case"offline":return"오프라인";case"idle":return"대기";case"unknown":case"":return"확인 필요";default:return(t==null?void 0:t.trim())||"확인 필요"}}function go(t){return t?"확인 후 실행":"즉시 실행"}function Uv(t){switch(t){case"note":return"노트";case"broadcast":return"방송";case"task":return"작업";default:return t}}function gt(t,e){if(!t)return null;const n=t[e];return typeof n=="string"&&n.trim()!==""?n.trim():typeof n=="number"&&Number.isFinite(n)?String(n):null}function Hv(t){if(t.action_type==="team_task_inject")return"task";if(t.action_type==="team_broadcast")return"broadcast";if(t.action_type==="team_note")return"note";if(t.action_type==="team_turn"){const e=gt(t.suggested_payload,"turn_kind");if(e==="broadcast"||e==="task")return e}return"note"}function Wv(t){const e=t.suggested_payload;if(t.target_type==="room"){if(t.action_type==="broadcast"){Je.value=gt(e,"message")??t.summary;return}t.action_type==="task_inject"&&(Ve.value=gt(e,"title")??"운영자 주입 작업",zn.value=gt(e,"description")??t.summary,jn.value=gt(e,"priority")??jn.value);return}if(t.target_type==="team_session"){if(t.target_id&&(On.value=t.target_id),t.action_type==="team_stop"){Js.value=gt(e,"reason")??t.summary;return}Ft.value=Hv(t);const n=gt(e,"message");n&&(Fn.value=n),Ft.value==="task"&&(qn.value=gt(e,"task_title")??gt(e,"title")??"운영자 주입 작업",Kn.value=gt(e,"task_description")??gt(e,"description")??t.summary,Un.value=gt(e,"task_priority")??gt(e,"priority")??Un.value);return}t.target_type==="keeper"&&(t.target_id&&(Vs.value=t.target_id),Ye.value=gt(e,"message")??t.summary)}function Bv(t,e,n){return!t||!t.target_type||t.target_type==="room"?!0:t.target_type==="team_session"?!!t.target_id&&e.some(s=>s.session_id===t.target_id):t.target_type==="keeper"?!!t.target_id&&n.some(s=>s.name===t.target_id):!0}async function Ie(t){const e=_a.value.trim()||"dashboard";try{const n=await fu({actor:e,action_type:t.action_type,target_type:t.target_type,target_id:t.target_id,payload:t.payload});return n.confirm_required?M("확인 대기열에 올렸습니다","warning"):M(t.successMessage,"success"),n}catch(n){const s=n instanceof Error?n.message:"개입 실행에 실패했습니다";return M(s,"error"),null}}async function $o(){const t=Je.value.trim();if(!t)return;await Ie({action_type:"broadcast",target_type:"room",payload:{message:t},successMessage:"방송을 보냈습니다"})&&(Je.value="")}async function Gv(){await Ie({action_type:"room_pause",target_type:"room",payload:{reason:_i.value.trim()||"운영 점검"},successMessage:"room 일시정지를 요청했습니다"})}async function ho(){await Ie({action_type:"room_resume",target_type:"room",payload:{},successMessage:"room 재개를 요청했습니다"})}async function Jv(){const t=Ve.value.trim();if(!t)return;await Ie({action_type:"task_inject",target_type:"room",payload:{title:t,description:zn.value.trim()||"Intervene 화면에서 주입",priority:Number.parseInt(jn.value,10)||2},successMessage:"작업 주입을 보냈습니다"})&&(Ve.value="",zn.value="")}async function Vv(){var r;const t=Ht.value,e=On.value||((r=t==null?void 0:t.sessions[0])==null?void 0:r.session_id)||"";if(!e){M("먼저 세션을 고르세요","warning");return}const n={},s=Fn.value.trim();s&&(n.message=s);let a="team_note";Ft.value==="broadcast"?a="team_broadcast":Ft.value==="task"&&(a="team_task_inject"),Ft.value==="task"&&(n.task_title=qn.value.trim()||"운영자 주입 작업",n.task_description=Kn.value.trim()||"Intervene 화면에서 주입",n.task_priority=Number.parseInt(Un.value,10)||2),await Ie({action_type:a,target_type:"team_session",target_id:e,payload:n,successMessage:"세션 액션을 적용했습니다"})&&(Fn.value="",Ft.value==="task"&&(qn.value="",Kn.value=""))}async function Yv(){var n;const t=Ht.value,e=On.value||((n=t==null?void 0:t.sessions[0])==null?void 0:n.session_id)||"";if(!e){M("먼저 세션을 고르세요","warning");return}await Ie({action_type:"team_stop",target_type:"team_session",target_id:e,payload:{reason:Js.value.trim()||"운영자 중지 요청"},successMessage:"세션 중지를 요청했습니다"})}async function Xv(){var a;const t=Ht.value,e=Vs.value||((a=t==null?void 0:t.keepers[0])==null?void 0:a.name)||"",n=Ye.value.trim();if(!e){M("먼저 keeper를 고르세요","warning");return}if(!n)return;await Ie({action_type:"keeper_message",target_type:"keeper",target_id:e,payload:{message:n},successMessage:`${e}에게 메시지를 보냈습니다`})&&(Ye.value="")}async function Qv(t){const e=_a.value.trim()||"dashboard";try{await gu(e,t),M("확인 실행을 완료했습니다","success")}catch(n){const s=n instanceof Error?n.message:"확인 실행에 실패했습니다";M(s,"error")}}function Zv(){var L,Y,J;const t=Ht.value,e=O.value.tab==="intervene"?Jn(O.value):null,n=lr.value,s=Wt.value,a=(t==null?void 0:t.room)??{},o=(t==null?void 0:t.sessions)??[],r=(t==null?void 0:t.keepers)??[],c=(t==null?void 0:t.pending_confirms)??[],d=(t==null?void 0:t.recent_messages)??[],m=(n==null?void 0:n.recommended_actions)??[],u=(t==null?void 0:t.available_actions)??[],p=o.find(f=>f.session_id===On.value)??o[0]??null,v=r.find(f=>f.name===Vs.value)??r[0]??null,$=(n==null?void 0:n.attention_items)??[],k=$.filter(qv),x=$.filter(Kv),C=o.filter(f=>Fv(f)!=="ok"),N=r.filter(f=>Ca(f)!=="ok"),w=d.slice(0,5),E=Bv(e,o,r);rt(()=>{Qt()},[]),rt(()=>{if(O.value.tab!=="intervene"){ls.value=null;return}if(!e){ls.value=null;return}ls.value!==e.id&&(ls.value=e.id,Wv(e))},[O.value.tab,O.value.params.source,O.value.params.action_type,O.value.params.target_type,O.value.params.target_id,O.value.params.focus_kind,e==null?void 0:e.id]),rt(()=>{const f=(p==null?void 0:p.session_id)??null;Ze(f)},[p==null?void 0:p.session_id]);const P=[{key:"room",label:"Room 게이트",value:a.paused?"일시정지":"열림",detail:a.paused?`재개 전환 대기 중${a.pause_reason?` · ${a.pause_reason}`:""}`:"지금은 새 액션과 새 작업을 바로 받을 수 있습니다",tone:a.paused?"bad":"ok"},{key:"confirm",label:"확인 대기",value:c.length,detail:c.length>0?"미리보기만 된 개입이 아직 사람 확인을 기다리고 있습니다":"지금 막혀 있는 확인 대기는 없습니다",tone:c.length>0?"warn":"ok"},{key:"session",label:"세션 리스크",value:k.length>0?k.length:o.length,detail:k.length>0?((L=k[0])==null?void 0:L.summary)??"세션 중 하나가 방향 수정이나 중지 판단을 기다리고 있습니다":o.length===0?"지금 관리 중인 team session이 없습니다":"세션 쪽 긴급 attention은 현재 없습니다",tone:k.length>0?fo(k):o.length===0?"warn":C.some(f=>tn(f.status)==="paused")?"bad":C.length>0?"warn":"ok"},{key:"keeper",label:"Keeper 압력",value:x.length>0?x.length:N.length,detail:x.length>0?((Y=x[0])==null?void 0:Y.summary)??"직접 메시지나 상태 점검이 필요한 keeper가 있습니다":N.length>0?"stale, offline, telemetry 누락 keeper가 보입니다":"지금은 keeper 쪽이 비교적 안정적입니다",tone:x.length>0?fo(x):N.some(f=>Ca(f)==="bad")?"bad":N.length>0?"warn":"ok"}];return i`
      ...
      <div class="ops-workbench">
          ...
          <section class="card ops-panel ops-lane-panel">
            ...
            <div class="control-row">
              <input
                ...
                onKeyDown=${f=>{f.key==="Enter"&&$o()}}
                disabled=${Q.value}
              />
              <button class="control-btn" onClick=${()=>{$o()}} disabled=${Q.value||Je.value.trim()===""}>
                보내기
              </button>
            </div>
            ...
            <div class="control-row ops-split-row">
              <input
                ...
                disabled=${Q.value}
              />
              <button class="control-btn ghost" onClick=${()=>{Gv()}} disabled=${Q.value}>
                일시정지
              </button>
              <button class="control-btn ghost" onClick=${()=>{ho()}} disabled=${Q.value}>
                재개
              </button>
            </div>
            ...
            <div class="control-row ops-split-row">
              ...
              <button class="control-btn" onClick=${()=>{Jv()}} disabled=${Q.value||Ve.value.trim()===""}>
                주입
              </button>
            </div>
          </section>
                ...
                ${m.map(f=>i`
                  <article key=${`${f.action_type}:${f.target_type}:${f.target_id??"room"}`} class="ops-log-entry ${f.severity}">
                    <div class="ops-log-head">
                      ...
                      <span>${go(f.confirm_required)}</span>
                    </div>
              ...
              <div class="ops-confirmation-list">
                ${c.map(f=>i`
                  <article key=${f.confirm_token} class="ops-confirmation-card">
                    ...
                    ${f.preview?i`<pre class="ops-code-block compact">${_o(f.preview)}</pre>`:null}
                    <div class="ops-confirmation-actions">
                      <button class="control-btn" onClick=${()=>{Qv(f.confirm_token)}} disabled=${Q.value}>
                        실행
                      </button>
        ...
        <div class="ops-column">
          ...
          <section class="card ops-panel ops-lane-panel">
            ...
            ${p?i`
              <div class="ops-detail-card">
                ...
                ${p.recent_events&&p.recent_events.length>0?i`
                  <pre class="ops-code-block compact">${_o(p.recent_events.slice(-3))}</pre>
                `:null}
              </div>
            ...
            <div class="control-row ops-split-row">
              ...
              <button class="control-btn" onClick=${()=>{Vv()}} disabled=${Q.value||!p}>
                적용
              </button>
            </div>
            <div class="ops-context-note">현재 선택: ${Uv(Ft.value)}</div>
            ...
            <div class="control-row ops-split-row">
              <input
                ...
                disabled=${Q.value||!p}
              />
              <button class="control-btn ghost" onClick=${()=>{Yv()}} disabled=${Q.value||!p}>
                세션 중지
              </button>
            </div>
          </section>
        ...
        <div class="ops-column">
              ...
              ${r.length===0?i`<div class="ops-empty">지금 보이는 keeper가 없습니다.</div>`:r.map(f=>i`
                ...
                >
                  ...
                  <div class="ops-entity-meta">
                    ...
                    <span>${Ov(f.last_turn_ago_s)}</span>
                  </div>
                </button>
              `)}
            </div>
          ...
          <section class="card ops-panel ops-lane-panel">
            ...
            ></textarea>
            <div class="control-row">
              <button class="control-btn" onClick=${()=>{Xv()}} disabled=${Q.value||!v||Ye.value.trim()===""}>
                keeper에 보내기
              </button>
            </div>
          </section>
  ...
  `}function t_({text:t}){if(!t)return null;const e=e_(t);return i`<div class="markdown-content">${e}</div>`}function e_(t){const e=t.split(`
...
`))}</p>`)}return n}function wa(t){const e=[],n=/(`[^`]+`)|(\*\*[^*]+\*\*)|(\*[^*]+\*)|\[([^\]]+)\]\(([^)]+)\)/g;let s=0,a;for(;(a=n.exec(t))!==null;){if(a.index>s&&e.push(t.slice(s,a.index)),a[1]){const o=a[1].slice(1,-1);e.push(i`<code>${o}</code>`)}else if(a[2]){const o=a[2].slice(2,-2);e.push(i`<strong>${o}</strong>`)}else if(a[3]){const o=a[3].slice(1,-1);e.push(i`<em>${o}</em>`)}else a[4]&&a[5]&&e.push(i`<a href=${a[5]} target="_blank" rel="noopener">${a[4]}</a>`);s=a.index+a[0].length}return s<t.length&&e.push(t.slice(s)),e.length>0?e:[t]}const Xr=[{id:"recent",label:"Latest"},{id:"hot",label:"Hot"},{id:"trending",label:"Trending"},{id:"updated",label:"Updated"},{id:"discussed",label:"Discussed"}],xs=_(null),Ss=_([]),en=_(!1),Ce=_(null),hn=_(""),yn=_(!1),Fe=_(!0);function n_(){var e,n;const t=new URLSearchParams(window.location.search);return((e=t.get("agent"))==null?void 0:e.trim())||((n=t.get("agent_name"))==null?void 0:n.trim())||"dashboard-user"}const s_=_(n_());function a_(t){const e=t.replace(/!\[[^\]]*\]\([^)]+\)/g," ").replace(/\[[^\]]+\]\([^)]+\)/g,"$1").replace(/[`#>*_~-]/g," ").replace(/\s+/g," ").trim();return e?e.length>180?`${e.slice(0,177)}...`:e:"No preview available"}function yo(t){return t.updated_at!==t.created_at}function i_(t){const e=`${t.title} ${t.tags.join(" ")} ${t.flair??""}`.toLowerCase();return/\b(test|smoke|harness|sandbox|dummy|sample|tmp|qa|e2e)\b/.test(e)||e.includes("테스트")||e.includes("실험")}function o_(t){const e=(t.hearth??"").toLowerCase();return t.visibility!=="internal"||!t.expires_at||!e?!1:!!(e.startsWith("mdal")||e.includes("harness"))}function Qr(t){return Fe.value?t.filter(e=>o_(e)?!1:e.hearth||e.visibility||e.expires_at?!0:!i_(e)):t}async function qi(t){Ce.value=t,xs.value=null,Ss.value=[],en.value=!0;try{const e=await rc(t);if(Ce.value!==t)return;xs.value={id:e.id,author:e.author,title:e.title,content:e.content,tags:e.tags,votes:e.votes,vote_balance:e.vote_balance,comment_count:e.comment_count,created_at:e.created_at,updated_at:e.updated_at,flair:e.flair,hearth:e.hearth,visibility:e.visibility,expires_at:e.expires_at,hearth_count:e.hearth_count},Ss.value=e.comments??[]}catch{Ce.value===t&&(xs.value=null,Ss.value=[])}finally{Ce.value===t&&(en.value=!1)}}async function bo(t){const e=hn.value.trim();if(e){yn.value=!0;try{await lc(t,s_.value,e),hn.value="",M("Comment posted","success"),await qi(t),Kt()}catch{M("Failed to post comment","error")}finally{yn.value=!1}}}function r_(){const t=Cn.value,e=Fe.value?"Hiding automation posts":"Show automation posts";return i`
  ...
  `}function Ta(){var s;const t=((s=Xr.find(a=>a.id===Cn.value))==null?void 0:s.label)??Cn.value,e=Qr(An.value),n=An.value.length-e.length;return i`
  ...
  `}function l_({post:t}){const e=async(n,s)=>{s.stopPropagation();try{await Ho(t.id,n),Kt()}catch{M("Failed to vote","error")}};return i`
      ...
      <div class="post-content">
        <div class="post-head">
          ...
          <div class="post-meta">
            ...
            ${yo(t)?i`<span>Updated <${it} timestamp=${t.updated_at} /></span>`:null}
            <span>${t.comment_count} comments</span>
            <span>${t.votes??0} votes</span>
          </div>
        </div>
        <div class="post-snippet">${a_(t.content)}</div>
      </div>
    </div>
  `}function c_({comments:t}){return t.length===0?i`<div class="empty-state" style="font-size:13px">No comments yet</div>`:i`
  ...
  `}function u_({post:t}){Ce.value!==t.id&&!en.value&&qi(t.id);const e=async n=>{try{await Ho(t.id,n),Kt()}catch{M("Failed to vote","error")}};return i`
    <div>
      ...
      <${R} title="Comments" semanticId="memory.feed">
        ${en.value?i`<div class="loading-indicator">Loading comments...</div>`:i`<${c_} comments=${Ss.value} />`}
        <${d_} postId=${t.id} />
      <//>
    </div>
  `}function p_(){const t=Qr(An.value),e=O.value.params.post??null,n=e?t.find(s=>s.id===e)??(Ce.value===e?xs.value:null):null;return e&&!n&&Ce.value!==e&&!en.value&&qi(e),e?n?i`
          <${Ct} surfaceId="memory" />
          <${Ta} />
          <${u_} post=${n} />
        `:i`
    ...
    <div>
      ...
      ${wn.value?i`<div class="loading-indicator">Loading memory feed...</div>`:t.length===0?i`<div class="empty-state">No posts in durable memory right now</div>`:i`
              <${R} title="Posts / Comments" class="section" semanticId="memory.feed">
                <div class="board-post-list">
                  ${t.map(s=>i`<${l_} key=${s.id} post=${s} />`)}
                </div>
              <//>
            `}
    </div>
  `}function Zr({ratio:t,size:e=40,stroke:n=4}){if(t==null)return null;const s=(e-n)/2,a=e/2,o=2*Math.PI*s,r=o*((100-t*100)/100);let c="mitosis-safe";return t>=.8?c="mitosis-critical":t>=.5&&(c="mitosis-warn"),i`
  ...
  `}const Ia=600*1e3,m_=1200*1e3,ko=.8;function ae(t){if(t==null)return 0;const e=typeof t=="number"?t:Date.parse(t);return Number.isNaN(e)?0:e}function Le(t){switch(t){case"bad":return 2;case"warn":return 1;default:return 0}}function v_(t){switch(t){case"working":return"작업 중";case"watching":return"대기 중";case"quiet":return"조용함";case"offline":return"오프라인"}}function __(t){switch(t){case"critical":return"위험";case"warning":return"주의";default:return"정상"}}function f_(t){return typeof t!="number"||Number.isNaN(t)?"—":`${Math.round(t*100)}%`}function g_(t){var e,n,s,a;return((n=(e=t.agent)==null?void 0:e.current_task)==null?void 0:n.trim())||((s=t.skill_primary)==null?void 0:s.trim())||((a=t.last_proactive_reason)==null?void 0:a.trim())||"현재 포커스 없음"}function $_(t){const e=[`Gen ${t.generation??"—"}`,`Turns ${t.turn_count??0}`,`Handoffs ${t.handoff_count_total??0}`];return(t.compaction_count??0)>0&&e.push(`Compactions ${t.compaction_count}`),e.join(" · ")}function h_(t){var d,m;const e=ra.value.get(t.name.trim().toLowerCase())??{activeAssignedCount:0,lastActivityAt:null,lastActivityText:null},n=e.lastActivityAt??t.last_seen??null,s=n?Math.max(0,Date.now()-ae(n)):Number.POSITIVE_INFINITY,a=!!((d=t.current_task)!=null&&d.trim())||e.activeAssignedCount>0;let o="watching",r="ok",c="Healthy live signal";return t.status==="offline"||t.status==="inactive"?(o="offline",r="bad",c=n?"Offline or inactive":"No recent presence"):s>m_?(o="quiet",r="bad",c=a?"Working without a fresh signal":"No fresh agent signal"):a?(o="working",r=s>Ia?"warn":"ok",c=s>Ia?"Execution looks quiet for too long":"Task and live signal aligned"):s>Ia?(o="quiet",r="warn",c="Quiet but still reachable"):t.status==="idle"&&(o="watching",r="ok",c="Standing by for the next task"),{agent:t,motion:e,lastSignalAt:n,activeTaskCount:e.activeAssignedCount,state:o,tone:r,focus:((m=t.current_task)==null?void 0:m.trim())||(e.activeAssignedCount>0?`${e.activeAssignedCount} claimed tasks waiting for explicit current_task`:e.lastActivityText??"Idle / waiting for assignment"),note:c}}function y_(t){const e=dd.value.get(t.name)??"idle",n=md.value.has(t.name),s=t.context_ratio??0;let a="healthy",o="ok",r="하트비트와 컨텍스트 상태가 안정적입니다";return t.status==="offline"||n||e==="handoff-imminent"?(a="critical",o="bad",r=n?"하트비트 지연":e==="handoff-imminent"?"핸드오프 임박":"keeper 오프라인"):(e==="preparing"||e==="compacting"||s>=ko)&&(a="warning",o="warn",r=s>=ko?"컨텍스트 압력이 높습니다":e==="compacting"?"컴팩팅 진행 중":"핸드오프 준비 중"),{keeper:t,lifecycle:e,state:a,tone:o,focus:g_(t),note:r}}function un({label:t,value:e,color:n,caption:s}){return i`
    <div class="stat-card">
      <div class="stat-label">${t}</div>
      <div class="stat-value" style=${n?`color:${n}`:""}>${e}</div>
      ${s?i`<div class="monitor-stat-caption">${s}</div>`:null}
    </div>
  `}function b_({item:t}){const e=t.kind==="agent"?()=>ua(t.agent.name):()=>Ii(t.keeper);return i`
    <button class="monitor-alert ${t.tone}" onClick=${e}>
      ...
      <div class="monitor-alert-meta">
        ...
        ${t.timestamp?i`<span><${it} timestamp=${t.timestamp} /></span>`:i`<span>신호 없음</span>`}
      </div>
    </button>
  `}function xo({row:t}){const{agent:e,motion:n}=t;return i`
    <button class="monitor-row ${t.tone} state-${t.state}" onClick=${()=>ua(e.name)}>
      <div class="monitor-row-header">
        ...
        <${Zr} ratio=${e.context_ratio} size=${34} stroke=${4} />
        <${_e} status=${e.status} />
        <span class="monitor-pill ${t.tone} state-${t.state}">${v_(t.state)}</span>
      </div>

      <div class="monitor-meta">
        ${t.lastSignalAt?i`<span>신호 <${it} timestamp=${t.lastSignalAt} /></span>`:i`<span>최근 신호 없음</span>`}
        <span>${t.activeTaskCount>0?`활성 작업 ${t.activeTaskCount}개`:"활성 작업 없음"}</span>
        ${e.model?i`<span>${e.model}</span>`:null}
        ${e.last_seen?i`<span>마지막 감지 <${it} timestamp=${e.last_seen} /></span>`:null}
      </div>
  ...
  `}function k_({row:t}){const{keeper:e}=t;return i`
    <button class="monitor-row ${t.tone} state-${t.state}" onClick=${()=>Ii(e)}>
      <div class="monitor-row-header">
        ...
        <${Zr} ratio=${e.context_ratio} size=${34} stroke=${4} />
        <${_e} status=${e.status} />
        <span class="monitor-pill ${t.tone}">${__(t.state)}</span>
      </div>

      <div class="monitor-meta">
        ${e.last_heartbeat?i`<span>하트비트 <${it} timestamp=${e.last_heartbeat} /></span>`:i`<span>하트비트 없음</span>`}
        <span>${$_(e)}</span>
        <span>라이프사이클 ${t.lifecycle}</span>
        <span>컨텍스트 ${f_(e.context_ratio)}</span>
        ${e.model?i`<span>${e.model}</span>`:null}
      </div>
    ...
    <div class="agents-monitor">
      ...
      <${R} title="Execution Priorities" class="section" semanticId="execution.priority_queue">
        ...
        <div class="monitor-alert-list">
          ${m.length===0?i`<div class="empty-state">지금은 실행 경고가 없습니다</div>`:m.map(u=>i`<${b_} key=${u.key} item=${u} />`)}
        </div>
      <//>

      <div class="agents-workbench">
        <${R} title="Workers" class="section" semanticId="execution.workers">
          <div class="monitor-section-head">
          ...
          <div class="monitor-list">
            ${n.length===0?i`<div class="empty-state">보이는 활성 worker가 없습니다</div>`:n.map(u=>i`<${xo} key=${u.agent.name} row=${u} />`)}
          </div>
        <//>

        <${R} title="Continuity" class="section" semanticId="execution.continuity">
          <div class="monitor-section-head">
            <h2 class="monitor-headline">장기 keeper 연속성</h2>
            <p class="monitor-subheadline">하트비트, 컨텍스트 압력, 핸드오프 상태를 worker 실행 드리프트와 분리해서 봅니다.</p>
          </div>
          <div class="monitor-list">
            ${e.length===0?i`<div class="empty-state">활성 keeper가 없습니다</div>`:e.map(u=>i`<${k_} key=${u.keeper.name} row=${u} />`)}
          </div>
        <//>

        <${R} title="Offline Workers" class="section" semanticId="execution.offline">
          <div class="monitor-section-head">
            <h2 class="monitor-headline">라이브 루프에서 빠진 worker</h2>
            <p class="monitor-subheadline">오프라인 row를 분리해서, 활성 실행 모니터가 묻히지 않게 합니다.</p>
          </div>
          <div class="monitor-list">
            ${s.length===0?i`<div class="empty-state">지금은 오프라인 worker가 없습니다</div>`:s.map(u=>i`<${xo} key=${u.agent.name} row=${u} />`)}
          </div>
        <//>
      </div>
    </div>
  `}const Ys=_("all"),Xs=_("all"),fi=_(new Set);function S_(t){const e=new Set(fi.value);e.has(t)?e.delete(t):e.add(t),fi.value=e}const tl=Nt(()=>{let t=Ke.value;return Ys.value!=="all"&&(t=t.filter(e=>e.horizon===Ys.value)),Xs.value!=="all"&&(t=t.filter(e=>e.status===Xs.value)),t}),A_=Nt(()=>{const t={short:[],mid:[],long:[]};for(const e of tl.value){const n=t[e.horizon];n&&n.push(e)}return t}),C_=Nt(()=>{const t=Array.from(Yo.value.values());return t.sort((e,n)=>e.status==="running"&&n.status!=="running"?-1:n.status==="running"&&e.status!=="running"?1:e.status==="interrupted"&&n.status!=="interrupted"?-1:n.status==="interrupted"&&e.status!=="interrupted"?1:n.elapsed_seconds-e.elapsed_seconds),t});function w_(t){return"★".repeat(Math.min(t,5))+"☆".repeat(Math.max(0,5-t))}function Ki(t){switch(t){case"short":return"Short-term";case"mid":return"Mid-term";case"long":return"Long-term";default:return t}}function As(t){switch(t){case"short":return"#4ade80";case"mid":return"#f59e0b";case"long":return"#818cf8";default:return"#888"}}function T_(t){return t<60?`${Math.round(t)}s`:t<3600?`${Math.floor(t/60)}m ${Math.round(t%60)}s`:`${Math.floor(t/3600)}h ${Math.floor(t%3600/60)}m`}function So(t){return t.toFixed(4)}function Ao(t){const e=t.current_metric-t.baseline_metric;return`${e>=0?"+":""}${e.toFixed(4)}`}function I_(t){switch(t){case 1:return"P1";case 2:return"P2";case 3:return"P3";default:return"P4"}}function Co(t,e){return(t.priority??4)-(e.priority??4)}function R_(t,e){const n=t.updated_at??t.created_at??"";return(e.updated_at??e.created_at??"").localeCompare(n)}function N_(t,e){return t.length<=e?t:t.slice(0,e)+"..."}function P_({goal:t}){return i`
    <div class="goal-row">
      <div class="goal-row-main">
        ...
        <div class="goal-meta">
          <span class="goal-priority" title="Priority ${t.priority}">${w_(t.priority)}</span>
  ...
  `}function Ra({horizon:t,items:e}){if(e.length===0)return null;const n=[...e].sort((s,a)=>a.priority-s.priority);return i`
    <${R} title="${Ki(t)} Goals (${e.length})" class="section" semanticId="planning.goal_pipeline">
      <div class="goal-list">
        ${n.map(s=>i`<${P_} key=${s.id} goal=${s} />`)}
      </div>
    <//>
  ...
  `}function M_(){const t=Ke.value,e=t.filter(a=>a.status==="active").length,n=t.filter(a=>a.status==="completed").length,s={short:0,mid:0,long:0};for(const a of t)a.horizon in s&&s[a.horizon]++;return i`
  ...
  `}function Na({task:t}){const e=t.priority??4,n=e<=1?"p1":e===2?"p2":e===3?"p3":"p4",s=fi.value.has(t.id),a=!!t.description;return i`
    <div class="kanban-card ${n}">
      ...
      ${a?i`
        <div
          ...
          onClick=${()=>S_(t.id)}
        >
          ${s?t.description:N_(t.description??"",80)}
        </div>
      `:null}
  ...
  `}function E_(){const{todo:t,inProgress:e,done:n}=Qo.value,s=[...t].sort(Co),a=[...e].sort(Co),o=[...n].sort(R_);return i`
    <${R} title="Task Backlog" class="section" semanticId="planning.backlog">
      <div class="kanban-board">
        <div class="kanban-column">
          ...
          ${s.length===0?i`<div class="empty-state" style="opacity: 0.5;">No pending tasks</div>`:s.map(r=>i`<${Na} key=${r.id} task=${r} />`)}
        </div>
        <div class="kanban-column">
          ...
          ${a.length===0?i`<div class="empty-state" style="opacity: 0.5;">No active tasks</div>`:a.map(r=>i`<${Na} key=${r.id} task=${r} />`)}
        </div>
        <div class="kanban-column">
          ...
          ${o.length===0?i`<div class="empty-state" style="opacity: 0.5;">No completed tasks</div>`:o.slice(0,20).map(r=>i`<${Na} key=${r.id} task=${r} />`)}
          ${o.length>20?i`<div class="empty-state" style="opacity: 0.5;">...and ${o.length-20} more</div>`:null}
        </div>
      </div>
    <//>
  `}function z_(){const{todo:t,inProgress:e,done:n}=Qo.value,s=t.length+e.length+n.length,a=[...t,...e].filter(u=>(u.priority??4)<=2).length,o=A_.value,r=C_.value,c=Ke.value.length>0,d=r.length>0,m=Ai.value;return i`
    <div>
      ...
      <details class="overview-section-collapsible" open=${c}>
        ...
        <div>
          ${c?i`
            <${M_} />
            <${L_} />
            ${_n.value&&Ke.value.length===0?i`<div class="loading-indicator">Loading goals...</div>`:tl.value.length===0?i`<div class="empty-state">No goals match the current filters</div>`:i`
                    <${Ra} horizon="short" items=${o.short??[]} />
                    <${Ra} horizon="mid" items=${o.mid??[]} />
                    <${Ra} horizon="long" items=${o.long??[]} />
                  `}
          `:i`
            <div class="empty-state">
        ...
        <div>
          ${fn.value&&r.length===0?i`<div class="loading-indicator">Loading MDAL loops...</div>`:r.length===0&&(m==="error"||Ue.value)?i`<div class="empty-state">MDAL snapshot could not be loaded${Ue.value?`: ${Ue.value}`:""}. Check backend health.</div>`:r.length===0?i`<div class="empty-state">No active loops. Use <code>masc_mdal_start</code> to start a loop.</div>`:i`
                  <div class="planning-loop-list">
                    ${r.map(u=>i`<${D_} key=${u.loop_id} loop=${u} />`)}
                  </div>
                `}
        </div>
      </details>
    </div>
  `}const bn=_("debates"),Qs=_([]),Zs=_([]),ta=_(!1),kn=_(!1),Hn=_(""),xn=_(""),ea=_(null),Mt=_(null),gi=_(!1);async function fa(){ta.value=!0,Hn.value="";try{const t=await Ul();Qs.value=Array.isArray(t.debates)?t.debates:[],Zs.value=Array.isArray(t.sessions)?t.sessions:[]}catch(t){Hn.value=t instanceof Error?t.message:"Failed to load governance state"}finally{ta.value=!1}}Td(fa);async function wo(){const t=xn.value.trim();if(t){kn.value=!0;try{const e=await Dc(t);xn.value="",M(e!=null&&e.id?`Debate started: ${e.id}`:"Debate started","success"),await fa()}catch(e){const n=e instanceof Error?e.message:"Failed to start debate";M(n,"error")}finally{kn.value=!1}}}async function j_(t){ea.value=t,Mt.value=null,gi.value=!0;try{Mt.value=await Ec(t)}catch(e){Hn.value=e instanceof Error?e.message:"Failed to load debate detail"}finally{gi.value=!1}}function O_(){return i`
    <div class="board-summary-strip">
      <div class="board-summary-item">
  ...
  `}function F_({debate:t}){const e=ea.value===t.id;return i`
    <button class="council-row ${e?"selected":""}" onClick=${()=>j_(t.id)}>
  ...
  `}function q_({session:t}){return i`
  ...
  `}function K_(){const t=bn.value;return i`
  ...
  `}function U_(){return i`
    <div>
      <${R} title="Start Debate" class="section" semanticId="governance.debates">
      ...
      <${R} title="Debates" class="section" semanticId="governance.debates">
        <div class="council-list">
          ${Qs.value.length===0?i`<div class="empty-state">No debates yet</div>`:Qs.value.map(t=>i`<${F_} key=${t.id} debate=${t} />`)}
        </div>
      <//>

      <${R} title=${ea.value?`Debate Detail (${ea.value})`:"Debate Detail"} class="section" semanticId="governance.debates">
  ...
  `}function H_(){return i`
    <${R} title="Voting Sessions" class="section" semanticId="governance.voting">
      <div class="council-list">
        ${Zs.value.length===0?i`<div class="empty-state">No active sessions</div>`:Zs.value.map(t=>i`<${q_} key=${t.id} session=${t} />`)}
      </div>
    <//>
  `}function W_(){return rt(()=>{fa()},[]),i`
    <div>
      <${Ct} surfaceId="governance" />
      <${O_} />
      <${K_} />
      ${bn.value==="debates"?i`<${U_} />`:i`<${H_} />`}
    </div>
  `}const De=_(""),Pa=_("ability_check"),La=_("10"),Ma=_("12"),us=_(""),ps=_("idle"),ie=_(""),ms=_("keeper-late"),Da=_("player"),Ea=_(""),xt=_("idle"),za=_(null),vs=_(""),ja=_(""),Oa=_("player"),Fa=_(""),qa=_(""),Ka=_(""),Sn=_("20"),Ua=_("20"),Ha=_(""),_s=_("idle"),$i=_(null),el=_("overview"),Wa=_("all"),Ba=_("all"),Ga=_("all"),B_=12e4,ga=_(null),To=_(Date.now());function G_(t,e){const n=e>0?t/e*100:0;return n>50?"hp-high":n>25?"hp-mid":"hp-low"}function J_(t,e){return e>0?Math.round(t/e*100):0}const V_={pragmatic:"리스크보다 확실한 이득을 우선합니다.",frugal:"자원 소모를 줄이고 효율을 챙깁니다.",impatient:"짧은 템포로 즉시 압박을 선호합니다.",stubborn:"한 번 정한 전술을 끝까지 밀어붙입니다.",protective:"아군 피해를 줄이는 선택을 우선합니다.","honor-bound":"약속과 규율을 지키는 행동에 보너스가 납니다.",intense:"집중 화력을 짧게 폭발시킵니다.",empathetic:"아군/약자 보호 쪽 선택 확률이 높아집니다.",fatalistic:"위험을 감수하는 고배수 선택을 탑니다.",suspicious:"함정/매복 경계 행동을 우선합니다.",precise:"단일 목표를 정확히 노리는 경향입니다.",vengeful:"직전 위협 대상에게 강하게 반응합니다.",aggressive:"공격적인 전진 행동을 우선합니다.",opportunistic:"빈틈이 열리면 즉시 추격합니다."},Y_={supply_scan:"전장/자원 상태를 스캔해 약한 지점을 찾습니다.",ration_shift:"소모를 줄이고 지속 전투 능력을 확보합니다.",logistics_patch:"무너진 운영 라인을 빠르게 복구합니다.",frontline_shield:"전열에서 아군 피해를 흡수합니다.",oath_intercept:"핵심 타깃을 가로막아 위협을 차단합니다.",morale_anchor:"아군 안정도를 높여 붕괴를 막습니다.",omen_trace:"다음 위험 신호를 먼저 감지합니다.",arc_flash:"짧은 순간 광역 압박을 넣습니다.",ward_bloom:"방어 장막을 펼쳐 생존률을 올립니다.",mark_prey:"우선 제거 대상을 지정합니다.",silent_route:"은밀한 진입 경로를 확보합니다.",finisher_strike:"약화된 적을 마무리하는 일격입니다.",shadow_claw:"근접 급습으로 출혈 피해를 노립니다.",lunge:"짧은 돌진으로 전열을 흔듭니다."};function fs(t){const e=t.trim();return e?e.split(/[_-]+/g).filter(n=>n.length>0).map(n=>n[0]?`${n[0].toUpperCase()}${n.slice(1)}`:n).join(" "):t}function X_(t){const e=t.trim().toLowerCase();return V_[e]??"행동 선택 가중치에 영향을 주는 성향입니다."}function Q_(t){const e=t.trim().toLowerCase();return Y_[e]??"상황에 따라 선택되는 전술 액션입니다."}function de(t){return typeof t=="object"&&t!==null}function yt(t,e,n=""){const s=t[e];return typeof s=="string"?s:n}function Dt(t,e,n=0){const s=t[e];return typeof s=="number"&&Number.isFinite(s)?s:n}function Wn(t,e,n=!1){const s=t[e];return typeof s=="boolean"?s:n}const Z_=new Set(["str","dex","con","int","wis","cha"]);function tf(t){const e=t.trim();if(!e)return{};let n;try{n=JSON.parse(e)}catch(a){throw new Error(`능력치 JSON 파싱 실패: ${a instanceof Error?a.message:"invalid json"}`)}if(!de(n))throw new Error('능력치 JSON은 object여야 합니다. 예: {"luck":7}');const s={};return Object.entries(n).forEach(([a,o])=>{const r=a.trim();if(r){if(typeof o=="number"&&Number.isFinite(o)){s[r]=Math.max(0,Math.trunc(o));return}if(typeof o=="string"){const c=Number.parseFloat(o.trim());if(Number.isFinite(c)){s[r]=Math.max(0,Math.trunc(c));return}}throw new Error(`능력치 '${r}' 값은 숫자여야 합니다.`)}}),s}function ef(t){const e=Number.parseInt(t.trim(),10);if(!Number.isFinite(e))return;const n=Math.max(1,e),s=Number.parseInt(Sn.value.trim(),10);Number.isFinite(s)&&s>n&&(Sn.value=String(n))}function hi(t){const n=(t.actor_name??t.actor??t.actor_id??"system").trim();return n===""?"system":n}function nf(t){var n;return(((n=t.timestamp)==null?void 0:n.trim())??"")||"-"}function sf(t){el.value=t}function nl(t){const e=ga.value;return e==null||e<=t}function af(t){const e=ga.value;return e==null||e<=t?0:Math.max(0,Math.ceil((e-t)/1e3))}function na(){ga.value=null}function sl(t){return typeof window>"u"||typeof window.confirm!="function"?!0:window.confirm(t)}function of(t,e){sl(["관전 모드 잠금을 해제하시겠습니까?",`ROOM: ${t||"-"}`,`PHASE: ${e||"-"}`,"해제 시간: 120초 (시간 경과 또는 위험 액션 실행 후 자동 재잠금)"].join(`
`))&&(ga.value=Date.now()+B_,M("조작 잠금이 120초 동안 해제되었습니다.","warning"))}function Cs(t){return nl(t)?(M("관전 모드 잠금 상태입니다. 먼저 잠금을 해제하세요.","warning"),!1):!0}function yi(t,e,n){return sl([`[위험 액션 확인] ${t}`,`ROOM: ${e||"-"}`,`PHASE: ${n||"-"}`,"이 액션은 즉시 실행되며 되돌리기 어렵습니다.","계속 진행하시겠습니까?"].join(`
`))}function rf({hp:t,max:e}){const n=J_(t,e),s=G_(t,e);return i`
    <div class="trpg-hp-bar">
      <div class="hp-fill ${s}" style="width:${n}%" />
    </div>
  `}function lf({stats:t}){const e=[{label:"STR",value:t.strength},{label:"DEX",value:t.dexterity},{label:"CON",value:t.constitution},{label:"INT",value:t.intelligence},{label:"WIS",value:t.wisdom},{label:"CHA",value:t.charisma}];return i`
    <div class="trpg-actor-stats">
      ${e.map(n=>i`<span>${n.label} ${n.value}</span>`)}
    </div>
  `}function cf({keeper:t,role:e}){if(!t)return null;const n=e==="dm"?"dm":"player";return i`
    <span class="trpg-keeper-chip">
      <span class="trpg-keeper-tag ${n}">${n}</span>
      ${t}
    </span>
  `}function al({actor:t}){var d,m,u,p;const e=(d=t.archetype)==null?void 0:d.trim(),n=(m=t.persona)==null?void 0:m.trim(),s=(u=t.portrait)==null?void 0:u.trim(),a=(p=t.background)==null?void 0:p.trim(),o=t.traits??[],r=t.skills??[],c=Object.entries(t.stats_raw??{}).filter(([v,$])=>Number.isFinite($)).filter(([v])=>!Z_.has(v.toLowerCase()));return i`
    <div class="trpg-actor">
      ...
      <div class="trpg-actor-header">
        ...
        <${cf} keeper=${t.keeper} role=${t.role} />
      </div>
      ${t.stats?i`
          <div style="margin-top:4px;">
            ...
            <${rf} hp=${t.stats.hp} max=${t.stats.max_hp} />
            <${lf} stats=${t.stats} />
          </div>
        `:null}
            ...
            <div class="trpg-annot-list">
              ${o.map(v=>i`
                <span class="trpg-annot-chip trait">
                  ...
                  <span class="trpg-annot-desc">${X_(v)}</span>
                </span>
              `)}
            </div>
          </div>
  ...
  `}function df({mapStr:t}){return i`<pre class="trpg-map">${t}</pre>`}function il({events:t,emptyLabel:e="아직 이벤트가 없습니다."}){return t.length===0?i`<div class="empty-state" style="font-size:13px">${e}</div>`:i`
    <div class="trpg-story" role="list" aria-label="TRPG story events">
      ${t.map((n,s)=>{var a;return i`
        <div key=${s} class="trpg-event ${n.type??""}" role="listitem">
          <div class="trpg-event-meta-row">
            <span class="trpg-event-meta">${nf(n)}</span>
  ...
  `}function mf({state:t,nowMs:e}){var m;const n=Vt.value||((m=t.session)==null?void 0:m.room)||"",s=ps.value,a=t.party??[];if(!a.find(u=>u.id===De.value)&&a.length>0){const u=a[0];u&&(De.value=u.id)}const r=async()=>{var p,v;if(!n){M("Room ID가 비어 있습니다.","error");return}if(!Cs(e))return;const u=((p=t.current_round)==null?void 0:p.phase)??((v=t.session)==null?void 0:v.status)??"unknown";if(yi("라운드 실행",n,u)){ps.value="running";try{const $=await Sc(n);$i.value=$,ps.value="ok";const k=de($.summary)?$.summary:null,x=k?Wn(k,"advanced",!1):!1,C=k?yt(k,"progress_reason",""):"";M(x?"라운드가 정상 진행되었습니다.":`라운드가 정체되었습니다${C?`: ${C}`:""}`,x?"success":"warning"),Ut()}catch($){$i.value=null,ps.value="error";const k=$ instanceof Error?$.message:"라운드 실행에 실패했습니다.";M(k,"error")}finally{na()}}},c=async()=>{var p,v;if(!n||!Cs(e))return;const u=((p=t.current_round)==null?void 0:p.phase)??((v=t.session)==null?void 0:v.status)??"unknown";if(yi("턴 강제 진행",n,u))try{await wc(n),M("턴을 다음 단계로 이동했습니다.","success"),Ut()}catch{M("턴 이동에 실패했습니다.","error")}finally{na()}},d=async()=>{if(!n||!Cs(e))return;const u=De.value.trim();if(!u){M("먼저 Actor를 선택하세요.","warning");return}const p=Number.parseInt(La.value,10),v=Number.parseInt(Ma.value,10);if(Number.isNaN(p)||Number.isNaN(v)){M("stat/dc는 숫자여야 합니다.","warning");return}const $=Number.parseInt(us.value,10),k=us.value.trim()===""||Number.isNaN($)?void 0:$;try{await Cc({roomId:n,actorId:u,action:Pa.value.trim()||"ability_check",statValue:p,dc:v,rawD20:k}),M("주사위 판정을 기록했습니다.","success"),Ut()}catch{M("주사위 판정 기록에 실패했습니다.","error")}};return i`
  ...
  `}function vf({state:t}){var a;const e=Vt.value||((a=t.session)==null?void 0:a.room)||"",n=_s.value,s=async()=>{if(!e){M("Room ID가 비어 있습니다.","warning");return}const o=vs.value.trim(),r=ja.value.trim();if(!r&&!o){M("이름 또는 Actor ID를 입력하세요.","warning");return}const c=Number.parseInt(Sn.value.trim(),10),d=Number.parseInt(Ua.value.trim(),10),m=Number.isFinite(d)?Math.max(1,d):20,u=Number.isFinite(c)?Math.max(0,Math.min(m,c)):m;let p={};try{p=tf(Ha.value)}catch(v){M(v instanceof Error?v.message:"능력치 JSON 오류","error");return}_s.value="spawning";try{const v=typeof crypto<"u"&&typeof crypto.randomUUID=="function"?`trpg_spawn_${crypto.randomUUID()}`:`trpg_spawn_${Date.now().toString(36)}_${Math.random().toString(36).slice(2,10)}`,$=await Tc(e,{actor_id:o||void 0,name:r||void 0,role:Oa.value,idempotencyKey:v,portrait:qa.value.trim()||void 0,background:Ka.value.trim()||void 0,hp:u,max_hp:m,alive:u>0,stats:Object.keys(p).length>0?p:void 0}),k=typeof $.actor_id=="string"?$.actor_id.trim():"";if(!k)throw new Error("생성 응답에 actor_id가 없습니다.");const x=Fa.value.trim();x&&await Ic(e,k,x),De.value=k,ie.value=k,o||(vs.value=""),_s.value="ok",M(`Actor 생성 완료: ${k}`,"success"),await Ut()}catch(v){_s.value="error",M(v instanceof Error?v.message:"Actor 생성에 실패했습니다.","error")}};return i`
    <div class="trpg-control-box">
      <div class="trpg-control-grid">
        <div class="trpg-control-field">
          <label>Name</label>
        ...
        <div class="trpg-control-grid">
          ...
          <div class="trpg-control-field">
            ...
            <input
              ...
              min="1"
              value=${Ua.value}
              onInput=${o=>{const r=o.target.value;Ua.value=r,ef(r)}}
              placeholder="20"
            />
          </div>
  ...
  `}function _f({state:t,nowMs:e}){var v;const n=Vt.value||((v=t.session)==null?void 0:v.room)||"",s=t.join_gate,a=za.value,o=de(a)?a:null,r=(t.party??[]).filter($=>$.role!=="dm"),c=ie.value.trim(),d=r.some($=>$.id===c),m=d?c:c?"__manual__":"",u=async()=>{const $=ie.value.trim(),k=ms.value.trim();if(!n||!$){M("Room/Actor가 필요합니다.","warning");return}xt.value="checking";try{const x=await Rc(n,$,k||void 0);za.value=x,xt.value="ok",M("참가 가능 여부를 갱신했습니다.","success")}catch(x){xt.value="error";const C=x instanceof Error?x.message:"참가 가능 여부 확인에 실패했습니다.";M(C,"error")}},p=async()=>{var N,w;const $=ie.value.trim(),k=ms.value.trim(),x=Ea.value.trim();if(!n||!$||!k){M("Room/Actor/Keeper가 필요합니다.","warning");return}if(!Cs(e))return;const C=((N=t.current_round)==null?void 0:N.phase)??((w=t.session)==null?void 0:w.status)??"unknown";if(yi("Mid-Join 승인 요청",n,C)){xt.value="requesting";try{const E=await Nc({room_id:n,actor_id:$,keeper_name:k,role:Da.value,...x?{name:x}:{}});za.value=E;const P=de(E)?Wn(E,"granted",!1):!1,L=de(E)?yt(E,"reason_code",""):"";P?M("Mid-Join이 승인되었습니다.","success"):M(`Mid-Join이 거절되었습니다${L?`: ${L}`:""}`,"warning"),xt.value=P?"ok":"error",Ut()}catch(E){xt.value="error";const P=E instanceof Error?E.message:"Mid-Join 요청에 실패했습니다.";M(P,"error")}finally{na()}}};return i`
    <div class="trpg-control-box">
      ...
      <div class="trpg-control-grid">
        <div class="trpg-control-field">
          ...
          <select
            value=${m}
            onChange=${$=>{const k=$.target.value;if(k==="__manual__"){(d||!c)&&(ie.value="");return}ie.value=k}}
          >
            <option value="">Actor 선택</option>
            ${r.map($=>i`
  ...
  `:null}function cl(){const t=$i.value;if(!t)return i`<div class="empty-state" style="font-size:13px;">Run Round 결과가 아직 없습니다.</div>`;const e=t.summary,n=de(e)?e:null,a=(Array.isArray(t.statuses)?t.statuses:[]).filter(de).slice(-8),o=t.canon_check,r=de(o)?o:null,c=r&&Array.isArray(r.warnings)?r.warnings.filter(L=>typeof L=="string").slice(0,3):[],d=r&&Array.isArray(r.violations)?r.violations.filter(L=>typeof L=="string").slice(0,3):[],m=n?Wn(n,"advanced",!1):!1,u=n?yt(n,"progress_reason",""):"",p=n?yt(n,"progress_detail",""):"",v=n?Dt(n,"player_successes",0):0,$=n?Dt(n,"player_required_successes",0):0,k=n?Wn(n,"dm_success",!1):!1,x=n?Dt(n,"timeouts",0):0,C=n?Dt(n,"unavailable",0):0,N=n?Dt(n,"reprompts",0):0,w=n?Dt(n,"npc_attacks",0):0,E=n?Dt(n,"keeper_timeout_sec",0):0,P=n?Dt(n,"roll_audit_count",0):0;return i`
  ...
  `}function ff({state:t,nowMs:e}){var r,c,d;const n=Vt.value||((r=t.session)==null?void 0:r.room)||"",s=((c=t.current_round)==null?void 0:c.phase)??((d=t.session)==null?void 0:d.status)??"unknown",a=nl(e),o=af(e);return i`
    <${R} title="조작 안전 잠금" style="margin-bottom:16px;" semanticId="lab.trpg">
      <div class="trpg-control-lock ${a?"locked":"unlocked"}">
        ...
        <div style="display:flex; gap:8px; margin-top:10px; flex-wrap:wrap;">
          ${a?i`<button class="trpg-run-btn recommend" onClick=${()=>of(n,s)}>잠금 해제 (120초)</button>`:i`<button class="trpg-run-btn secondary" onClick=${()=>{na(),M("조작 잠금으로 전환했습니다.","success")}}>즉시 다시 잠금</button>`}
        </div>
      </div>
    <//>
  `}function gf({active:t}){return i`
  ...
  `}function $f({state:t}){const e=t.party??[],n=t.story_log??[];return i`
  ...
  `}function hf({state:t}){const e=t.story_log??[];return i`
    <div class="trpg-layout">
      <div>
  ...
  `}function yf({state:t,nowMs:e}){const n=t.party??[];return i`
    <div>
      <${ff} state=${t} nowMs=${e} />
      <div class="trpg-layout">
        <div>
  ...
  `}function bf(){var c,d,m,u,p;const t=Vo.value,e=ri.value;if(rt(()=>{if(typeof window>"u"||typeof window.setInterval!="function")return;const v=window.setInterval(()=>{To.value=Date.now()},1e3);return()=>{window.clearInterval(v)}},[]),e&&!t)return i`<div class="loading-indicator">Loading TRPG state...</div>`;if(!t)return i`
      <div class="section">
        <h2>TRPG</h2>
        <div class="empty-state">No active TRPG session</div>
        <button class="board-sort-btn" onClick=${()=>Ut()}>Refresh</button>
      </div>
    `;const n=t.party??[],s=t.story_log??[],a=t.outcome,o=el.value,r=To.value;return i`
    <div>
      <${Ct} surfaceId="lab" />
      ...
      ${o==="overview"?i`<${$f} state=${t} />`:o==="timeline"?i`<${hf} state=${t} />`:i`<${yf} state=${t} nowMs=${r} />`}
    </div>
  `}function kf(){return i`
    <div>
      <${Ct} surfaceId="lab" />
  ...
  `}const sa=_(new Set(["broadcast","tasks","keepers","system"]));function xf(t){const e=new Set(sa.value);e.has(t)?e.delete(t):e.add(t),sa.value=e}const Ui=_(null);function dl(t){Ui.value=t}function Sf(t){return t.kind==="board"?"broadcast":t.kind==="tasks"?"tasks":t.kind==="keepers"?"keepers":"system"}const Af=Nt(()=>{const t=sa.value;return Ts.value.filter(e=>t.has(Sf(e)))}),Cf=12e4,wf=Nt(()=>{const t=ra.value,e=Date.now();return wt.value.map(n=>{const s=n.name.trim().toLowerCase(),a=t.get(s)??null;let o="idle";if(n.status==="active"||n.status==="busy"){const r=a==null?void 0:a.lastActivityAt;r?o=e-new Date(r).getTime()>Cf?"stale":"working":o="working"}else(n.status==="offline"||n.status==="inactive")&&(o="stale");return{name:n.name,emoji:n.emoji??"",koreanName:n.koreanName??null,state:o,currentTask:n.current_task,motion:a}})}),Tf=Nt(()=>{const t=ra.value;return wt.value.filter(e=>e.status==="active"||e.status==="busy"||e.status==="listening"||e.status==="idle").map(e=>{const n=e.name.trim().toLowerCase(),s=t.get(n),a=(s==null?void 0:s.activeAssignedCount)??0;let o="calm";return a>=3?o="hot":a>=1&&(o="normal"),{name:e.name,emoji:e.emoji??"",koreanName:e.koreanName??null,currentTask:e.current_task,lastActivityAt:(s==null?void 0:s.lastActivityAt)??null,lastActivityText:(s==null?void 0:s.lastActivityText)??null,assignedCount:a,pressure:o}}).sort((e,n)=>{const s={hot:0,normal:1,calm:2};return s[e.pressure]-s[n.pressure]})});function Io(t){return t.kind==="board"?"live-event-broadcast":t.kind==="tasks"?"live-event-task":t.kind==="keepers"?"live-event-keeper":"live-event-system"}function If(t){const e=t.eventType;return e==="broadcast"?"broadcast":e==="agent_joined"?"joined":e==="agent_left"?"left":e==="task_update"?"task":e==="board_post"?"post":e==="board_comment"?"comment":e==="keeper_heartbeat"?"heartbeat":e==="keeper_handoff"?"handoff":e==="keeper_compaction"?"compact":e==="keeper_guardrail"?"guardrail":t.kind==="board"?"board":t.kind==="tasks"?"task":t.kind==="keepers"?"keeper":"system"}function Rf(t){switch(t){case"working":return"pulse-working";case"stale":return"pulse-stale";default:return"pulse-idle"}}function Nf(){const t=wf.value,e=Ui.value;return t.length===0?i`
  ...
  `}const Pf=[{kind:"broadcast",label:"Broadcast",cssClass:"live-event-broadcast"},{kind:"tasks",label:"Task",cssClass:"live-event-task"},{kind:"keepers",label:"Keeper",cssClass:"live-event-keeper"},{kind:"system",label:"System",cssClass:"live-event-system"}];function Lf(){const t=sa.value;return i`
  ...
  `}function Mf(){const t=Af.value;return i`
        ...
        ${t.length===0?i`<div class="activity-empty">No events matching filters</div>`:t.map((e,n)=>i`
            ...
            >
              <div class="activity-item-head">
                <span class="activity-kind-chip ${Io(e)}">${If(e)}</span>
  ...
  `}function Df(t){switch(t){case"hot":return"focus-pressure-hot";case"normal":return"focus-pressure-normal";default:return"focus-pressure-calm"}}function Ef(t){switch(t){case"hot":return"High";case"normal":return"Active";default:return"Calm"}}function zf(){const t=Tf.value,e=Ui.value;return i`
  ...
  `}function jf(){const t=ue.value;return i`
  ...
  `}function qf(){const t=Ht.value,e=(t==null?void 0:t.pending_confirms.length)??0,n=(t==null?void 0:t.sessions.length)??0,s=(t==null?void 0:t.keepers.length)??0;return i`
    <section class="rail-card">
      <div class="rail-card-head">
        <h3>개입 바로가기</h3>
  ...
  `}function Kf(){const t=O.value.tab,e=bi.find(s=>s.id===t),n=Ro.find(s=>s.id===(e==null?void 0:e.group));return i`
    ...
    <div class="app-shell">
      ...
      <div class="dashboard-layout">
        ...
        <main class="dashboard-main">
          ${oi.value&&!ue.value?i`<div class="loading-indicator">Loading dashboard...</div>`:i`<${Uf} />`}
        </main>
      </div>
  ...
  `}const No=document.getElementById("app");No&&gl(i`<${Hf} />`,No);export{Tm as _};
