...
\*   -----------------------------+---------------------------------------------------+---------
\*   phase \in {"Running", "HandingOff"} | lib/keeper_state/keeper_state_machine.ml:phase    | type phase = ... | Running | ... | HandingOff | ...
\*                                | (full 13-phase variant; this spec projects to 2)  |
\*   handoff_needed (boolean)     | lib/keeper_state/keeper_state_machine.ml:context_handoff_needed | conditions.context_handoff_needed : bool
\*                                | lib/keeper_state/keeper_state_machine.ml:update_conditions | set from auto_rules.handoff at update_conditions
\*
...
\*   lib/keeper_state/keeper_state_machine.ml — derive_phase has the
...
\* anchors don't rot):
\*   lib/keeper_state/keeper_state_machine.ml — update_conditions stamps
