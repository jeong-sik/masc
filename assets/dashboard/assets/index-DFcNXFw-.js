...
`))}</p>`)}return n}function ra(t){const e=[],n=/(`[^`]+`)|(\*\*[^*]+\*\*)|(\*[^*]+\*)|\[([^\]]+)\]\(([^)]+)\)/g;let s=0,a;for(;(a=n.exec(t))!==null;){if(a.index>s&&e.push(t.slice(s,a.index)),a[1]){const o=a[1].slice(1,-1);e.push(i`<code>${o}</code>`)}else if(a[2]){const o=a[2].slice(2,-2);e.push(i`<strong>${o}</strong>`)}else if(a[3]){const o=a[3].slice(1,-1);e.push(i`<em>${o}</em>`)}else a[4]&&a[5]&&e.push(i`<a href=${a[5]} target="_blank" rel="noopener">${a[4]}</a>`);s=a.index+a[0].length}return s<t.length&&e.push(t.slice(s)),e.length>0?e:[t]}const Tr=[{id:"recent",label:"Latest"},{id:"hot",label:"Hot"},{id:"trending",label:"Trending"},{id:"updated",label:"Updated"},{id:"discussed",label:"Discussed"}],is=g(null),os=g([]),ze=g(!1),ce=g(null),tn=g(""),en=g(!1),ke=g(!0);function Nv(){var e,n;const t=new URLSearchParams(window.location.search);return((e=t.get("agent"))==null?void 0:e.trim())||((n=t.get("agent_name"))==null?void 0:n.trim())||"dashboard-user"}const Lv=g(Nv());function Mv(t){const e=t.replace(/!\[[^\]]*\]\([^)]+\)/g," ").replace(/\[[^\]]+\]\([^)]+\)/g,"$1").replace(/[`#>*_~-]/g," ").replace(/\s+/g," ").trim();return e?e.length>180?`${e.slice(0,177)}...`:e:"No preview available"}function Yi(t){return t.updated_at!==t.created_at}function Dv(t){const e=`${t.title} ${t.tags.join(" ")} ${t.flair??""}`.toLowerCase();return/\b(test|smoke|harness|sandbox|dummy|sample|tmp|qa|e2e)\b/.test(e)||e.includes("테스트")||e.includes("실험")}function Ev(t){const e=(t.hearth??"").toLowerCase();return t.visibility!=="internal"||!t.expires_at||!e?!1:!!(e.startsWith("mdal")||e.includes("harness"))}function Ir(t){return ke.value?t.filter(e=>Ev(e)?!1:e.hearth||e.visibility||e.expires_at?!0:!Dv(e)):t}async function $i(t){ce.value=t,is.value=null,os.value=[],ze.value=!0;try{const e=await jl(t);if(ce.value!==t)return;is.value={id:e.id,author:e.author,title:e.title,content:e.content,tags:e.tags,votes:e.votes,vote_balance:e.vote_balance,comment_count:e.comment_count,created_at:e.created_at,updated_at:e.updated_at,flair:e.flair,hearth:e.hearth,visibility:e.visibility,expires_at:e.expires_at,hearth_count:e.hearth_count},os.value=e.comments??[]}catch{ce.value===t&&(is.value=null,os.value=[])}finally{ce.value===t&&(ze.value=!1)}}async function Xi(t){const e=tn.value.trim();if(e){en.value=!0;try{await Ol(t,Lv.value,e),tn.value="",R("Comment posted","success"),await $i(t),wt()}catch{R("Failed to post comment","error")}finally{en.value=!1}}}function zv(){const t=ln.value,e=ke.value?"Hiding automation posts":"Show automation posts";return i`
  ...
  `}function Zv({row:t}){const{keeper:e}=t;return i`
...
>>>>>>> origin/main
    ...
    <div class="agents-monitor">
      ...
      <${C} title="Execution Priorities" class="section" semanticId="execution.priority_queue">
        ...
        <div class="monitor-alert-list">
          ${_.length===0?i`<div class="empty-state">지금은 실행 경고가 없습니다</div>`:_.map(m=>i`<${Qv} key=${m.key} item=${m} />`)}
        </div>
      <//>
      ...
      <div class="agents-workbench">
        ...
        <${C} title="Continuity" class="section" semanticId="execution.continuity">
          ...
          <div class="monitor-list">
            ${e.length===0?i`<div class="empty-state">활성 keeper가 없습니다</div>`:e.map(m=>i`<${Zv} key=${m.keeper.name} row=${m} />`)}
          </div>
        <//>
  ...
  `}const Ns=g("all"),Ls=g("all"),Ga=g(new Set);function e_(t){const e=new Set(Ga.value);e.has(t)?e.delete(t):e.add(t),Ga.value=e}const Pr=$t(()=>{let t=Se.value;return Ns.value!=="all"&&(t=t.filter(e=>e.horizon===Ns.value)),Ls.value!=="all"&&(t=t.filter(e=>e.status===Ls.value)),t}),n_=$t(()=>{const t={short:[],mid:[],long:[]};for(const e of Pr.value){const n=t[e.horizon];n&&n.push(e)}return t}),s_=$t(()=>{const t=Array.from(Co.value.values());return t.sort((e,n)=>e.status==="running"&&n.status!=="running"?-1:n.status==="running"&&e.status!=="running"?1:e.status==="interrupted"&&n.status!=="interrupted"?-1:n.status==="interrupted"&&e.status!=="interrupted"?1:n.elapsed_seconds-e.elapsed_seconds),t});function a_(t){return"★".repeat(Math.min(t,5))+"☆".repeat(Math.max(0,5-t))}function hi(t){switch(t){case"short":return"Short-term";case"mid":return"Mid-term";case"long":return"Long-term";default:return t}}function rs(t){switch(t){case"short":return"#4ade80";case"mid":return"#f59e0b";case"long":return"#818cf8";default:return"#888"}}function i_(t){return t<60?`${Math.round(t)}s`:t<3600?`${Math.floor(t/60)}m ${Math.round(t%60)}s`:`${Math.floor(t/3600)}h ${Math.floor(t%3600/60)}m`}function to(t){return t.toFixed(4)}function eo(t){const e=t.current_metric-t.baseline_metric;return`${e>=0?"+":""}${e.toFixed(4)}`}function o_(t){switch(t){case 1:return"P1";case 2:return"P2";case 3:return"P3";default:return"P4"}}function no(t,e){return(t.priority??4)-(e.priority??4)}function r_(t,e){const n=t.updated_at??t.created_at??"";return(e.updated_at??e.created_at??"").localeCompare(n)}function l_(t,e){return t.length<=e?t:t.slice(0,e)+"..."}function c_({goal:t}){return i`
    <div class="goal-row">
  ...
  `}function u_(){const t=Se.value,e=t.filter(a=>a.status==="active").length,n=t.filter(a=>a.status==="completed").length,s={short:0,mid:0,long:0};for(const a of t)a.horizon in s&&s[a.horizon]++;return i`
  ...
  `}function p_({loop:t}){const e=t.history[0],n=t.latest_tool_names&&t.latest_tool_names.length>0?`${t.latest_tool_call_count??t.latest_tool_names.length} tool${(t.latest_tool_call_count??t.latest_tool_names.length)===1?"":"s"}: ${t.latest_tool_names.join(", ")}`:"No evidence yet";return i`
  ...
  `}function ua({task:t}){const e=t.priority??4,n=e<=1?"p1":e===2?"p2":e===3?"p3":"p4",s=Ga.value.has(t.id),a=!!t.description;return i`
    <div class="kanban-card ${n}">
      <div class="kanban-card-header">
        <span class="priority-badge priority-badge--${n}">${o_(e)}</span>
      ...
      ${a?i`
        <div
          ...
          onClick=${()=>e_(t.id)}
        >
          ${s?t.description:l_(t.description??"",80)}
        </div>
      `:null}
  ...
  `}function m_(){const{todo:t,inProgress:e,done:n}=To.value,s=[...t].sort(no),a=[...e].sort(no),o=[...n].sort(r_);return i`
  ...
  `}function v_(){const{todo:t,inProgress:e,done:n}=To.value,s=t.length+e.length+n.length,a=[...t,...e].filter(m=>(m.priority??4)<=2).length,o=n_.value,l=s_.value,d=Se.value.length>0,p=l.length>0,_=si.value;return i`
    <div>
  ...
  `}function g_({debate:t}){const e=zs.value===t.id;return i`
    <button class="council-row ${e?"selected":""}" onClick=${()=>__(t.id)}>
  ...
  `}function h_(){const t=nn.value;return i`
    ...
    <div>
      ...
      <${C} title="Debates" class="section" semanticId="governance.debates">
        <div class="council-list">
          ${Ms.value.length===0?i`<div class="empty-state">No debates yet</div>`:Ms.value.map(t=>i`<${g_} key=${t.id} debate=${t} />`)}
        </div>
      <//>
  ...
  `}function b_(){return i`
    <${C} title="Voting Sessions" class="section" semanticId="governance.voting">
      <div class="council-list">
        ${Ds.value.length===0?i`<div class="empty-state">No active sessions</div>`:Ds.value.map(t=>i`<${$_} key=${t.id} session=${t} />`)}
      </div>
    <//>
  `}function k_(){return Z(()=>{Xs()},[]),i`
    <div>
      <${vt} surfaceId="governance" />
      <${f_} />
      <${h_} />
      ${nn.value==="debates"?i`<${y_} />`:i`<${b_} />`}
    </div>
  `}const $e=g(""),pa=g("ability_check"),ma=g("10"),va=g("12"),Gn=g(""),Jn=g("idle"),Ut=g(""),Vn=g("keeper-late"),_a=g("player"),fa=g(""),pt=g("idle"),ga=g(null),Yn=g(""),$a=g(""),ha=g("player"),ya=g(""),ba=g(""),ka=g(""),on=g("20"),xa=g("20"),Sa=g(""),Xn=g("idle"),Va=g(null),Nr=g("overview"),Aa=g("all"),Ca=g("all"),wa=g("all"),x_=12e4,Qs=g(null),ao=g(Date.now());function S_(t,e){const n=e>0?t/e*100:0;return n>50?"hp-high":n>25?"hp-mid":"hp-low"}function A_(t,e){return e>0?Math.round(t/e*100):0}const C_={pragmatic:"리스크보다 확실한 이득을 우선합니다.",frugal:"자원 소모를 줄이고 효율을 챙깁니다.",impatient:"짧은 템포로 즉시 압박을 선호합니다.",stubborn:"한 번 정한 전술을 끝까지 밀어붙입니다.",protective:"아군 피해를 줄이는 선택을 우선합니다.","honor-bound":"약속과 규율을 지키는 행동에 보너스가 납니다.",intense:"집중 화력을 짧게 폭발시킵니다.",empathetic:"아군/약자 보호 쪽 선택 확률이 높아집니다.",fatalistic:"위험을 감수하는 고배수 선택을 탑니다.",suspicious:"함정/매복 경계 행동을 우선합니다.",precise:"단일 목표를 정확히 노리는 경향입니다.",vengeful:"직전 위협 대상에게 강하게 반응합니다.",aggressive:"공격적인 전진 행동을 우선합니다.",opportunistic:"빈틈이 열리면 즉시 추격합니다."},w_={supply_scan:"전장/자원 상태를 스캔해 약한 지점을 찾습니다.",ration_shift:"소모를 줄이고 지속 전투 능력을 확보합니다.",logistics_patch:"무너진 운영 라인을 빠르게 복구합니다.",frontline_shield:"전열에서 아군 피해를 흡수합니다.",oath_intercept:"핵심 타깃을 가로막아 위협을 차단합니다.",morale_anchor:"아군 안정도를 높여 붕괴를 막습니다.",omen_trace:"다음 위험 신호를 먼저 감지합니다.",arc_flash:"짧은 순간 광역 압박을 넣습니다.",ward_bloom:"방어 장막을 펼쳐 생존률을 올립니다.",mark_prey:"우선 제거 대상을 지정합니다.",silent_route:"은밀한 진입 경로를 확보합니다.",finisher_strike:"약화된 적을 마무리하는 일격입니다.",shadow_claw:"근접 급습으로 출혈 피해를 노립니다.",lunge:"짧은 돌진으로 전열을 흔듭니다."};function Qn(t){const e=t.trim();return e?e.split(/[_-]+/g).filter(n=>n.length>0).map(n=>n[0]?`${n[0].toUpperCase()}${n.slice(1)}`:n).join(" "):t}function T_(t){const e=t.trim().toLowerCase();return C_[e]??"행동 선택 가중치에 영향을 주는 성향입니다."}function I_(t){const e=t.trim().toLowerCase();return w_[e]??"상황에 따라 선택되는 전술 액션입니다."}function dt(t,e,n=""){const s=t[e];return typeof s=="string"?s:n}function kt(t,e,n=0){const s=t[e];return typeof s=="number"&&Number.isFinite(s)?s:n}function wn(t,e,n=!1){const s=t[e];return typeof s=="boolean"?s:n}const R_=new Set(["str","dex","con","int","wis","cha"]);function P_(t){const e=t.trim();if(!e)return{};let n;try{n=JSON.parse(e)}catch(a){throw new Error(`능력치 JSON 파싱 실패: ${a instanceof Error?a.message:"invalid json"}`)}if(!u(n))throw new Error('능력치 JSON은 object여야 합니다. 예: {"luck":7}');const s={};return Object.entries(n).forEach(([a,o])=>{const l=a.trim();if(l){if(typeof o=="number"&&Number.isFinite(o)){s[l]=Math.max(0,Math.trunc(o));return}if(typeof o=="string"){const d=Number.parseFloat(o.trim());if(Number.isFinite(d)){s[l]=Math.max(0,Math.trunc(d));return}}throw new Error(`능력치 '${l}' 값은 숫자여야 합니다.`)}}),s}function N_(t){const e=Number.parseInt(t.trim(),10);if(!Number.isFinite(e))return;const n=Math.max(1,e),s=Number.parseInt(on.value.trim(),10);Number.isFinite(s)&&s>n&&(on.value=String(n))}function Ya(t){const n=(t.actor_name??t.actor??t.actor_id??"system").trim();return n===""?"system":n}function L_(t){var n;return(((n=t.timestamp)==null?void 0:n.trim())??"")||"-"}function M_(t){Nr.value=t}function Lr(t){const e=Qs.value;return e==null||e<=t}function D_(t){const e=Qs.value;return e==null||e<=t?0:Math.max(0,Math.ceil((e-t)/1e3))}function js(){Qs.value=null}function Mr(t){return typeof window>"u"||typeof window.confirm!="function"?!0:window.confirm(t)}function E_(t,e){Mr(["관전 모드 잠금을 해제하시겠습니까?",`ROOM: ${t||"-"}`,`PHASE: ${e||"-"}`,"해제 시간: 120초 (시간 경과 또는 위험 액션 실행 후 자동 재잠금)"].join(`
`))&&(Qs.value=Date.now()+x_,R("조작 잠금이 120초 동안 해제되었습니다.","warning"))}function ls(t){return Lr(t)?(R("관전 모드 잠금 상태입니다. 먼저 잠금을 해제하세요.","warning"),!1):!0}function Xa(t,e,n){return Mr([`[위험 액션 확인] ${t}`,`ROOM: ${e||"-"}`,`PHASE: ${n||"-"}`,"이 액션은 즉시 실행되며 되돌리기 어렵습니다.","계속 진행하시겠습니까?"].join(`
`))}function z_({hp:t,max:e}){const n=A_(t,e),s=S_(t,e);return i`
    <div class="trpg-hp-bar">
      <div class="hp-fill ${s}" style="width:${n}%" />
    </div>
  `}function j_({stats:t}){const e=[{label:"STR",value:t.strength},{label:"DEX",value:t.dexterity},{label:"CON",value:t.constitution},{label:"INT",value:t.intelligence},{label:"WIS",value:t.wisdom},{label:"CHA",value:t.charisma}];return i`
    <div class="trpg-actor-stats">
      ${e.map(n=>i`<span>${n.label} ${n.value}</span>`)}
    </div>
  `}function O_({keeper:t,role:e}){if(!t)return null;const n=e==="dm"?"dm":"player";return i`
    <span class="trpg-keeper-chip">
      <span class="trpg-keeper-tag ${n}">${n}</span>
      ${t}
    </span>
  `}function Dr({actor:t}){var p,_,m,v;const e=(p=t.archetype)==null?void 0:p.trim(),n=(_=t.persona)==null?void 0:_.trim(),s=(m=t.portrait)==null?void 0:m.trim(),a=(v=t.background)==null?void 0:v.trim(),o=t.traits??[],l=t.skills??[],d=Object.entries(t.stats_raw??{}).filter(([f,h])=>Number.isFinite(h)).filter(([f])=>!R_.has(f.toLowerCase()));return i`
    <div class="trpg-actor">
      ...
      <div class="trpg-actor-header">
        ...
        <${O_} keeper=${t.keeper} role=${t.role} />
      </div>
      ${t.stats?i`
          <div style="margin-top:4px;">
            ...
            <${z_} hp=${t.stats.hp} max=${t.stats.max_hp} />
            <${j_} stats=${t.stats} />
          </div>
        `:null}
            ...
            <div class="trpg-annot-list">
              ${l.map(f=>i`
                <span class="trpg-annot-chip skill">
                  <span class="trpg-annot-name">${Qn(f)}</span>
                  <span class="trpg-annot-desc">${I_(f)}</span>
                </span>
              `)}
            </div>
          </div>
  ...
  `}function F_({mapStr:t}){return i`<pre class="trpg-map">${t}</pre>`}function Er({events:t,emptyLabel:e="아직 이벤트가 없습니다."}){return t.length===0?i`<div class="empty-state" style="font-size:13px">${e}</div>`:i`
    <div class="trpg-story" role="list" aria-label="TRPG story events">
      ${t.map((n,s)=>{var a;return i`
        <div key=${s} class="trpg-event ${n.type??""}" role="listitem">
          <div class="trpg-event-meta-row">
            <span class="trpg-event-meta">${L_(n)}</span>
  ...
  `}function B_({state:t,nowMs:e}){var l,d,p;const n=Mt.value||((l=t.session)==null?void 0:l.room)||"",s=((d=t.current_round)==null?void 0:d.phase)??((p=t.session)==null?void 0:p.status)??"unknown",a=Lr(e),o=D_(e);return i`
    <${C} title="조작 안전 잠금" style="margin-bottom:16px;" semanticId="lab.trpg">
      <div class="trpg-control-lock ${a?"locked":"unlocked"}">
        ...
        <div style="display:flex; gap:8px; margin-top:10px; flex-wrap:wrap;">
          ${a?i`<button class="trpg-run-btn recommend" onClick=${()=>E_(n,s)}>잠금 해제 (120초)</button>`:i`<button class="trpg-run-btn secondary" onClick=${()=>{js(),R("조작 잠금으로 전환했습니다.","success")}}>즉시 다시 잠금</button>`}
        </div>
      </div>
    <//>
  `}function G_({active:t}){return i`
  ...
  `}function J_({state:t}){const e=t.party??[],n=t.story_log??[];return i`
  ...
  `}function V_({state:t}){const e=t.story_log??[];return i`
    <div class="trpg-layout">
      <div>
  ...
  `}function Y_({state:t,nowMs:e}){const n=t.party??[];return i`
    <div>
      <${B_} state=${t} nowMs=${e} />
      <div class="trpg-layout">
        <div>
  ...
  `}function X_(){var d,p,_,m,v;const t=Ao.value,e=Oa.value;if(Z(()=>{if(typeof window>"u"||typeof window.setInterval!="function")return;const f=window.setInterval(()=>{ao.value=Date.now()},1e3);return()=>{window.clearInterval(f)}},[]),e&&!t)return i`<div class="loading-indicator">Loading TRPG state...</div>`;if(!t)return i`
      <div class="section">
        <h2>TRPG</h2>
    ...
    <div>
      ...
      ${o==="overview"?i`<${J_} state=${t} />`:o==="timeline"?i`<${V_} state=${t} />`:i`<${Y_} state=${t} nowMs=${l} />`}
    </div>
  ...
  `}const Os=g(new Set(["broadcast","tasks","keepers","system"]));function Z_(t){const e=new Set(Os.value);e.has(t)?e.delete(t):e.add(t),Os.value=e}const yi=g(null);function qr(t){yi.value=t}function tf(t){return t.kind==="board"?"broadcast":t.kind==="tasks"?"tasks":t.kind==="keepers"?"keepers":"system"}const ef=$t(()=>{const t=Os.value;return ds.value.filter(e=>t.has(tf(e)))}),nf=12e4,sf=$t(()=>{const t=Us.value,e=Date.now();return _t.value.map(n=>{const s=n.name.trim().toLowerCase(),a=t.get(s)??null;let o="idle";if(n.status==="active"||n.status==="busy"){const l=a==null?void 0:a.lastActivityAt;l?o=e-new Date(l).getTime()>nf?"stale":"working":o="working"}else(n.status==="offline"||n.status==="inactive")&&(o="stale");return{name:n.name,emoji:n.emoji??"",koreanName:n.koreanName??null,state:o,currentTask:n.current_task,motion:a}})}),af=$t(()=>{const t=Us.value;return _t.value.filter(e=>e.status==="active"||e.status==="busy"||e.status==="listening"||e.status==="idle").map(e=>{const n=e.name.trim().toLowerCase(),s=t.get(n),a=(s==null?void 0:s.activeAssignedCount)??0;let o="calm";return a>=3?o="hot":a>=1&&(o="normal"),{name:e.name,emoji:e.emoji??"",koreanName:e.koreanName??null,currentTask:e.current_task,lastActivityAt:(s==null?void 0:s.lastActivityAt)??null,lastActivityText:(s==null?void 0:s.lastActivityText)??null,assignedCount:a,pressure:o}}).sort((e,n)=>{const s={hot:0,normal:1,calm:2};return s[e.pressure]-s[n.pressure]})});function io(t){return t.kind==="board"?"live-event-broadcast":t.kind==="tasks"?"live-event-task":t.kind==="keepers"?"live-event-keeper":"live-event-system"}function of(t){const e=t.eventType;return e==="broadcast"?"broadcast":e==="agent_joined"?"joined":e==="agent_left"?"left":e==="task_update"?"task":e==="board_post"?"post":e==="board_comment"?"comment":e==="keeper_heartbeat"?"heartbeat":e==="keeper_handoff"?"handoff":e==="keeper_compaction"?"compact":e==="keeper_guardrail"?"guardrail":t.kind==="board"?"board":t.kind==="tasks"?"task":t.kind==="keepers"?"keeper":"system"}function rf(t){switch(t){case"working":return"pulse-working";case"stale":return"pulse-stale";default:return"pulse-idle"}}function lf(){const t=sf.value,e=yi.value;return t.length===0?i`
  ...
  `}const cf=[{kind:"broadcast",label:"Broadcast",cssClass:"live-event-broadcast"},{kind:"tasks",label:"Task",cssClass:"live-event-task"},{kind:"keepers",label:"Keeper",cssClass:"live-event-keeper"},{kind:"system",label:"System",cssClass:"live-event-system"}];function df(){const t=Os.value;return i`
  ...
  `}function uf(){const t=ef.value;return i`
        ...
        ${t.length===0?i`<div class="activity-empty">No events matching filters</div>`:t.map((e,n)=>i`
            ...
            >
              <div class="activity-item-head">
                <span class="activity-kind-chip ${io(e)}">${of(e)}</span>
  ...
  `}function pf(t){switch(t){case"hot":return"focus-pressure-hot";case"normal":return"focus-pressure-normal";default:return"focus-pressure-calm"}}function mf(t){switch(t){case"hot":return"High";case"normal":return"Active";default:return"Calm"}}function vf(){const t=af.value,e=yi.value;return i`
        ...
        ${t.length===0?i`<div class="focus-empty">No active agents</div>`:t.map(n=>i`
            ...
            >
              <div class="focus-agent-header">
                ...
                <span class="focus-pressure-badge ${pf(n.pressure)}">
                  ${mf(n.pressure)}
  ...
  `}function _f(){const t=Jt.value;return i`
  ...
  `}function $f(){const t=It.value,e=(t==null?void 0:t.pending_confirms.length)??0,n=(t==null?void 0:t.sessions.length)??0,s=(t==null?void 0:t.keepers.length)??0;return i`
    <section class="rail-card">
      <div class="rail-card-head">
        <h3>개입 바로가기</h3>
  ...
  `}function hf(){const t=D.value.tab,e=Qa.find(s=>s.id===t),n=oo.find(s=>s.id===(e==null?void 0:e.group));return i`
    ...
    <div class="app-shell">
      ...
      <div class="dashboard-layout">
        ...
        <main class="dashboard-main">
          ${ja.value&&!Jt.value?i`<div class="loading-indicator">Loading dashboard...</div>`:i`<${yf} />`}
        </main>
      </div>
  ...
  `}const ro=document.getElementById("app");ro&&Jr(i`<${bf} />`,ro);export{am as _};
