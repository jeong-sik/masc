...
| 0130 | Fleet Capacity Supervisor — close the loop on `reaction_capacity_shortfall_count` | Draft | #19786 2026-06-02 | PR #16050 (2026-05-18) shipped `reaction_capacity_below_target` + `reaction_capacity_shortfall_count` to `/health` and dashboard chip, but **no code path consumed them** — the visibility layer was thick while the control layer was empty (Issue #16168). PR #16172 landed the RFC body, PR #16183 landed the pure `Fleet_capacity_supervisor.tick` core, and PR #19786 wired read-only `/health` output under `keeper_fleet_safety.supervisor_decision`; flagged execute and closeout remain. Related RFC-0026, RFC-0064, RFC-0088, RFC-0124. |
