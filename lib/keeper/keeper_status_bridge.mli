...
val blocker_class_of_string : string -> blocker_class option
val blocker_class_of_sdk_error : Oas.Error.sdk_error -> blocker_class option
...
val runtime_blocker_surface_of_failure_reason
  ...
  -> runtime_blocker_surface option
...
val live_override_fields : keeper_meta -> keeper_profile_defaults -> string list
val runtime_keepalive_running : Coord_utils.config -> keeper_meta -> bool
val runtime_keepalive_started_at : Coord_utils.config -> keeper_meta -> float option
...
val social_model_resolution_fields_json : keeper_meta -> (string * Yojson.Safe.t) list
val social_runtime_fields_json : keeper_meta -> (string * Yojson.Safe.t) list
val runtime_surface_json : Coord_utils.config -> keeper_meta -> Yojson.Safe.t
val source_provenance_json : Coord_utils.config -> keeper_meta -> Yojson.Safe.t
