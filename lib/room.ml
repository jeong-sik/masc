...
(* ============================================================ *)
(* Task Management - Extracted to Room_task module               *)
(* ============================================================ *)
include Room_task
...
(* get_agents_raw_in_room is now in Room_multiroom *)
...
(* ============================================================ *)
(* Multi-Room Management - Extracted to Room_multiroom module    *)
(* ============================================================ *)
include Room_multiroom

(** Enter a room (switch context).
    Stays in room.ml because it depends on [leave], [init], and [join]
    which are mutually recursive functions defined earlier in this file. *)
