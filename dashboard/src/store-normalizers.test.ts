  ...
  it('parses optional health fleet-safety fields type-safely', () => {
    const result = normalizeDashboardRuntimeResolution(runtimeResolutionRaw({
      ...
      keeper_reaction_ledger: {
        schema: 'keeper.reaction_ledger.fleet_summary.v3',
        status: 'ok',
        status_reasons: ['reaction_ledger_escalated'],
        operator_action_required: false,
        empty: false,
        keeper_count: 2,
        keeper_names: ['keeper-a', 'keeper-b'],
        keeper_name_discovery_error_count: 1,
        keeper_name_discovery_errors: ['meta store unreadable'],
        counts_complete: true,
        pending_id_display_limit_per_keeper: 25,
        row_count: 8,
        stimulus_count: 4,
        reaction_count: 4,
        turn_started_count: 2,
        event_queue_ack_count: 1,
        event_queue_requeue_count: 1,
        event_queue_escalation_count: 1,
        event_queue_external_input_count: 1,
        cursor_ack_count: 2,
        cursor_swept_stimulus_count: 3,
        orphan_reaction_stimulus_count: 1,
        in_progress_stimulus_count: 1,
        acked_stimulus_count: 1,
        escalated_stimulus_count: 1,
        external_input_requested_stimulus_count: 1,
        pending_stimulus_count: 0,
        reaction_store_discovered_keeper_count: 2,
        reaction_store_discovered_keeper_names: ['keeper-a', 'keeper-b'],
        reaction_store_discovery_error_count: 1,
        reaction_store_discovery_errors: ['sidecar conflict'],
        read_error_count: 0,
        pending_by_keeper: [],
        keepers: [{
          schema: 'keeper.reaction_ledger.summary.v3',
          keeper_name: 'keeper-a',
          status: 'degraded',
          operator_action_required: true,
          counts_complete: true,
          pending_id_display_limit: 25,
          row_count: 4,
          stimulus_count: 2,
          reaction_count: 2,
          ...
          latest_recorded_at_unix: 200,
          latest_stimulus_id: 'stimulus-1',
          read_error: null,
        }],
      },
    }))
