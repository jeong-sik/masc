...
`).map(n=>n.trim()).filter(n=>n!=="")}async function Mc(t,e=20){return ve("masc_task_history",{task_id:t,limit:e})}async function Dc(t){const e=await ve("masc_debate_start",{topic:t});try{return JSON.parse(e)}catch{return null}}async function Ec(t){return Ko("fetchDebateStatus",async()=>{const e=encodeURIComponent(t),n=await ot(`/api/v1/council/debates/${e}/summary`);if(!H(n))return null;const s=h(n.id,"").trim();return s?{id:s,topic:h(n.topic,""),status:h(n.status,"open"),support_count:V(n.support_count,0),oppose_count:V(n.oppose_count,0),neutral_count:V(n.neutral_count,0),total_arguments:V(n.total_arguments,0),created_at:vn(n.created_at_iso??n.created_at),summary_text:h(n.summary_text,"")}:null})}function zc(t,e,n){return ve("masc_keeper_msg",{name:t,message:e})}const jc=_(""),Yt=_({}),vt=_({}),Za=_({}),ti=_({}),ei=_({}),ni=_({}),Xt=_({});function ut(t,e,n){t.value={...t.value,[e]:n}}function Zt(t){return typeof t=="object"&&t!==null&&!Array.isArray(t)}function X(t){return typeof t=="string"&&t.trim()!==""?t.trim():void 0}function Nt(t){return typeof t=="number"&&Number.isFinite(t)?t:void 0}function Ee(t){return typeof t=="boolean"?t:void 0}function si(t){return typeof t=="string"&&t.trim()!==""?t:typeof t!="number"||!Number.isFinite(t)||t<=0?null:new Date(t*1e3).toISOString()}function ai(t){return Array.isArray(t)?t.map(e=>X(e)).filter(e=>!!e):[]}function Oc(t){var n;const e=(n=X(t))==null?void 0:n.toLowerCase();return e==="user"||e==="assistant"||e==="system"||e==="tool"?e:"other"}function Fc(t){switch(t){case"user":return"User";case"assistant":return"Keeper";case"system":return"System";case"tool":return"Tool";default:return"Event"}}function $a(t,e){if(!Array.isArray(t))return[];const n=[];for(const s of t){if(!Zt(s))continue;const a=X(s.name);if(!a)continue;const o=X(s[e]);e==="summary"?n.push({name:a,summary:o}):n.push({name:a,reason:o})}return n}function qc(t){if(!Zt(t))return null;const e=X(t.name);return e?{name:e,trigger:X(t.trigger),outcome:X(t.outcome),summary:X(t.summary),reason:X(t.reason)}:null}function Kc(t){const e=t.toLowerCase();return e.includes("graphql")?"graphql_error":e.includes("timeout")||e.includes("model")||e.includes("llm")||e.includes("api key")||e.includes("api_key")||e.includes("provider")?"llm_error":"unknown"}function Uc(t,e){return t==="offline"||t==="degraded"||t==="stale"?"Keeper is not in a healthy reply state. Probe or recover before relying on automation.":e==="quiet_hours"?"Lodge quiet hours are active. Direct messages still work, but scheduled social ticks may look asleep.":e==="min_gap"?"Keeper is inside its proactive cooldown window. Direct messages work now; autonomous check-ins will wait.":e==="never_started"?"Keeper metadata exists but no reply turn has been recorded yet.":"Keeper is reachable. Send a direct message for an immediate response."}function Wo(t,e,n){return X(t)??Uc(e,n)}function Bo(t,e){return typeof t=="boolean"?t:e==="recover"}function Is(t){if(!Zt(t))return null;const e=X(t.health_state),n=X(t.next_action_path),s=X(t.last_reply_status);return!e||!n||!s?null:{health_state:e,quiet_reason:X(t.quiet_reason)??null,next_action_path:n,last_reply_status:s,last_reply_at:si(t.last_reply_at),last_reply_preview:X(t.last_reply_preview)??null,last_error:X(t.last_error)??null,next_eligible_at_s:Nt(t.next_eligible_at_s)??null,recoverable:Bo(t.recoverable,n),summary:Wo(t.summary,e,X(t.quiet_reason)??null),keepalive_running:typeof t.keepalive_running=="boolean"?t.keepalive_running:void 0}}function Go(t){return Zt(t)?{hour:Nt(t.hour),checked:Nt(t.checked)??0,acted:Nt(t.acted)??0,acted_names:ai(t.acted_names),activity_report:X(t.activity_report),quiet_hours_overridden:Ee(t.quiet_hours_overridden),skipped_reason:X(t.skipped_reason),acted_rows:$a(t.acted_rows,"summary").map(e=>({name:e.name,summary:e.summary})),passed_rows:$a(t.passed_rows,"reason").map(e=>({name:e.name,reason:e.reason})),skipped_rows:$a(t.skipped_rows,"reason").map(e=>({name:e.name,reason:e.reason})),checkins:Array.isArray(t.checkins)?t.checkins.map(qc).filter(e=>e!==null):[]}:null}function Hc(t){return Zt(t)?{enabled:Ee(t.enabled)??!1,interval_s:Nt(t.interval_s)??0,quiet_start:Nt(t.quiet_start),quiet_end:Nt(t.quiet_end),quiet_active:Ee(t.quiet_active),use_planner:Ee(t.use_planner),delegate_llm:Ee(t.delegate_llm),agent_count:Nt(t.agent_count),agents:ai(t.agents),last_tick_ago_s:Nt(t.last_tick_ago_s)??null,last_tick_ago:X(t.last_tick_ago),total_ticks:Nt(t.total_ticks),total_checkins:Nt(t.total_checkins),last_skip_reason:X(t.last_skip_reason)??null,last_tick_result:Go(t.last_tick_result),active_self_heartbeats:ai(t.active_self_heartbeats)}:null}function Wc(t){return Zt(t)?{status:t.status,diagnostic:Is(t.diagnostic)}:null}function Bc(t){return Zt(t)?{recovered:Ee(t.recovered)??!1,skipped_reason:X(t.skipped_reason)??null,before:Is(t.before),after:Is(t.after),down:t.down,up:t.up}:null}function Gc(t,e){var w,E;if(!(t!=null&&t.name))return null;const n=X((w=t.agent)==null?void 0:w.status)??X(t.status)??"unknown",s=X((E=t.agent)==null?void 0:E.error)??null,a=t.presence_keepalive??!0,o=t.keepalive_running??!1,r=t.turn_count??0,c=t.last_turn_ago_s??null,d=t.proactive_enabled??!1,m=t.proactive_cooldown_sec??0,u=t.last_proactive_ago_s??null,p=d&&u!=null?Math.max(0,m-u):null,v=r<=0||c==null?"never":c>900?"stale":"fresh",$=typeof t.last_heartbeat=="string"&&t.last_heartbeat.trim()?t.last_heartbeat:null,x=s??(a&&!o?"keeper keepalive is not running":null),k=n==="offline"||n==="inactive"?"offline":x?"degraded":v==="stale"?"stale":v==="never"?"idle":"healthy",C=x?Kc(x):e!=null&&e.quiet_active&&v!=="fresh"?"quiet_hours":a&&!o?"disabled":r<=0?"never_started":p!=null&&p>0?"min_gap":v==="fresh"||v==="stale"?"no_recent_activity":"unknown",R=k==="offline"||k==="degraded"||k==="stale"?"recover":C==="quiet_hours"?"manual_lodge_poke":C==="unknown"?"probe":"direct_message";return{health_state:k,quiet_reason:C,next_action_path:R,last_reply_status:v,last_reply_at:$,last_reply_preview:null,last_error:x,next_eligible_at_s:p!=null&&p>0?p:null,recoverable:Bo(void 0,R),summary:Wo(void 0,k,C),keepalive_running:o}}function Jc(t,e){if(!Zt(t))return null;const n=Oc(t.role),s=X(t.content)??X(t.preview);if(!s)return null;const a=si(t.ts_unix)??si(t.timestamp);return{id:`${n}-${a??"entry"}-${e}`,role:n,label:Fc(n),text:s,timestamp:a,delivery:"history"}}function Vc(t,e,n){const s=Zt(n)?n:null,a=Array.isArray(s==null?void 0:s.history_tail)?s.history_tail.map((o,r)=>Jc(o,r)).filter(o=>o!==null):[];return{name:t,diagnostic:Is(s==null?void 0:s.diagnostic),history:a,rawText:e,rawStatus:n,loadedAt:new Date().toISOString()}}function Vi(t,e){const n=vt.value[t]??[];vt.value={...vt.value,[t]:[...n,e].slice(-50)}}function Yc(t,e){return t.role!==e.role||t.text!==e.text?!1:t.timestamp&&e.timestamp?t.timestamp===e.timestamp:!0}function Xc(t,e){const s=(vt.value[t]??[]).filter(a=>a.delivery!=="history"&&!e.some(o=>Yc(a,o)));vt.value={...vt.value,[t]:[...e,...s].slice(-50)}}function oa(t,e){Yt.value={...Yt.value,[t]:e},Xc(t,e.history)}function Yi(t,e){const n=Yt.value[t];if(!n)return;const s=n.diagnostic??{health_state:"idle",next_action_path:"direct_message",last_reply_status:"unknown"};oa(t,{...n,diagnostic:{...s,...e}})}async function Si(){try{await Gn()}catch(t){console.warn("[keeper-runtime] dashboard refresh failed",t)}}function Qc(t){jc.value=t.trim()}async function Jo(t,e=!1){const n=t.trim();if(!n)return null;if(!e&&Yt.value[n])return Yt.value[n];ut(Za,n,!0),ut(Xt,n,null);try{const s=await ve("masc_keeper_status",{name:n,fast:!1,include_context:!0,include_metrics_overview:!0,include_memory_bank:!1,include_history_tail:!0,include_compaction_history:!1,tail_turns:5,tail_messages:10});let a=null;try{a=JSON.parse(s)}catch{a=null}const o=Vc(n,s,a);return oa(n,o),o}catch(s){const a=s instanceof Error?s.message:`Failed to inspect ${n}`;return ut(Xt,n,a),null}finally{ut(Za,n,!1)}}async function Zc(t,e){const n=t.trim(),s=e.trim();if(!n||!s)return;const a=`local-${Date.now()}`;Vi(n,{id:a,role:"user",label:"You",text:s,timestamp:new Date().toISOString(),delivery:"sending"}),ut(ti,n,!0),ut(Xt,n,null);try{const o=await zc(n,s);vt.value={...vt.value,[n]:(vt.value[n]??[]).map(r=>r.id===a?{...r,delivery:"delivered"}:r)},Vi(n,{id:`reply-${Date.now()}`,role:"assistant",label:n,text:o.trim()||"(empty reply)",timestamp:new Date().toISOString(),delivery:"delivered"}),Yi(n,{last_reply_status:"delivered",last_reply_at:new Date().toISOString(),last_reply_preview:(o.trim()||"(empty reply)").slice(0,200),last_error:null}),await Si()}catch(o){const r=o instanceof Error?o.message:`Failed to send direct message to ${n}`;throw vt.value={...vt.value,[n]:(vt.value[n]??[]).map(c=>c.id===a?{...c,delivery:"error",error:r}:c)},Yi(n,{last_reply_status:"error",last_error:r}),ut(Xt,n,r),o}finally{ut(ti,n,!1)}}async function td(t,e){const n=t.trim();if(!n)return null;ut(ei,n,!0),ut(Xt,n,null);try{const s=await ia({actor:e,action_type:"keeper_probe",target_type:"keeper",target_id:n,payload:{}}),a=Wc(s.result),o=(a==null?void 0:a.diagnostic)??null;if(o){const r=Yt.value[n];oa(n,{name:n,diagnostic:o,history:(r==null?void 0:r.history)??vt.value[n]??[],rawText:(r==null?void 0:r.rawText)??"",rawStatus:s.result,loadedAt:new Date().toISOString()})}return await Si(),o}catch(s){const a=s instanceof Error?s.message:`Failed to probe ${n}`;throw ut(Xt,n,a),s}finally{ut(ei,n,!1)}}async function ed(t,e){const n=t.trim();if(!n)return null;ut(ni,n,!0),ut(Xt,n,null);try{const s=await ia({actor:e,action_type:"keeper_recover",target_type:"keeper",target_id:n,payload:{}}),a=Bc(s.result),o=(a==null?void 0:a.after)??null;if(o){const r=Yt.value[n];oa(n,{name:n,diagnostic:o,history:(r==null?void 0:r.history)??vt.value[n]??[],rawText:(r==null?void 0:r.rawText)??"",rawStatus:s.result,loadedAt:new Date().toISOString()})}return await Si(),o}catch(s){const a=s instanceof Error?s.message:`Failed to recover ${n}`;throw ut(Xt,n,a),s}finally{ut(ni,n,!1)}}function ye(t){return(t??"").trim().toLowerCase()}function ht(t){const e=typeof t=="number"?t:Date.parse(t);return Number.isNaN(e)?0:e}function gs(t,e=88){const n=t.replace(/\s+/g," ").trim();return n&&(n.length>e?`${n.slice(0,e-3)}...`:n)}function as(t){return typeof t!="number"||!Number.isFinite(t)||t<0?null:new Date(Date.now()-t*1e3).toISOString()}function ln(t){return t.last_heartbeat??as(t.last_turn_ago_s)??as(t.last_proactive_ago_s)??as(t.last_handoff_ago_s)??as(t.last_compaction_ago_s)}function nd(t){const e=t.title.trim();return e||gs(t.content)}function sd(t){const e=t.generation??"?",n=typeof t.context_ratio=="number"&&Number.isFinite(t.context_ratio)?`${Math.round(t.context_ratio*100)}%`:"?";return t.last_heartbeat?`Heartbeat gen=${e} ctx=${n}`:`Keeper snapshot gen=${e} ctx=${n}`}function ad(t,e,n,s,a={}){var E;const o=ye(t),r=e.filter(P=>ye(P.assignee)===o&&(P.status==="claimed"||P.status==="in_progress")).length,c=n.filter(P=>ye(P.from)===o).sort((P,L)=>ht(L.timestamp)-ht(P.timestamp))[0],d=s.filter(P=>ye(P.agent)===o||ye(P.author)===o).sort((P,L)=>ht(L.timestamp)-ht(P.timestamp))[0],m=(a.boardPosts??[]).filter(P=>ye(P.author)===o).sort((P,L)=>ht(L.updated_at||L.created_at)-ht(P.updated_at||P.created_at))[0],u=(a.keepers??[]).filter(P=>ye(P.name)===o&&ln(P)!==null).sort((P,L)=>ht(ln(L)??0)-ht(ln(P)??0))[0],p=c?ht(c.timestamp):0,v=d?ht(d.timestamp):0,$=m?ht(m.updated_at||m.created_at):0,x=u?ht(ln(u)??0):0,k=a.lastSeen?ht(a.lastSeen):0,C=((E=a.currentTask)==null?void 0:E.trim())||(r>0?`${r} claimed tasks`:null);if(p===0&&v===0&&$===0&&x===0&&k===0)return{activeAssignedCount:r,lastActivityAt:null,lastActivityText:C};const w=[c?{timestamp:c.timestamp,ts:p,text:gs(c.content)}:null,m?{timestamp:m.updated_at||m.created_at,ts:$,text:`Post: ${gs(nd(m))}`}:null,u?{timestamp:ln(u),ts:x,text:sd(u)}:null,d?{timestamp:new Date(d.timestamp).toISOString(),ts:v,text:gs(d.text)}:null].filter(P=>P!==null).sort((P,L)=>L.ts-P.ts)[0];return w&&w.ts>=k?{activeAssignedCount:r,lastActivityAt:w.timestamp,lastActivityText:w.text}:{activeAssignedCount:r,lastActivityAt:a.lastSeen??null,lastActivityText:C??"Presence heartbeat"}}const wt=_([]),qt=_([]),Xe=_([]),te=_([]),At=_(null),id=_(null),ii=_(new Map),An=_([]),Cn=_("recent"),ze=_(!0),Vo=_(null),Vt=_(""),Ke=_([]),_n=_(!1),Yo=_(new Map),Ai=_("unknown"),Ue=_(null),oi=_(!1),wn=_(!1),ri=_(!1),fn=_(!1),Ci=_(null),Ns=_(!1),Rs=_(null),Xo=_(null),li=_(null),od=_(null),rd=_(null),ld=_(null);Rt(()=>wt.value.filter(t=>t.status==="active"||t.status==="busy"||t.status==="listening"||t.status==="idle"));const Qo=Rt(()=>{const t=qt.value;return{todo:t.filter(e=>e.status==="todo"),inProgress:t.filter(e=>e.status==="in_progress"||e.status==="claimed"),done:t.filter(e=>e.status==="done")}}),ra=Rt(()=>{const t=new Map,e=qt.value,n=Xe.value,s=Ts.value,a=An.value,o=te.value;for(const r of wt.value)t.set(r.name.trim().toLowerCase(),ad(r.name,e,n,s,{currentTask:r.current_task,lastSeen:r.last_seen,boardPosts:a,keepers:o}));return t});function cd(t){var o;const e=((o=t.status)==null?void 0:o.toLowerCase())??"";if(e==="offline"||e==="inactive")return"offline";const n=t.metrics_series;if(!n||n.length===0)return"idle";const s=n[n.length-1];if(!s)return"idle";if(s.is_handoff)return"handoff-imminent";if(s.is_compaction)return"compacting";const a=s.context_ratio;return a>.85?"handoff-imminent":a>.7?"preparing":a>.5?"compacting":"active"}const dd=Rt(()=>{const t=new Map;for(const e of te.value)t.set(e.name,cd(e));return t}),ud=12e4;function pd(t,e){const n=e.get(t.name);if(n!=null)return n;const s=t.last_heartbeat?Date.parse(t.last_heartbeat):Number.NaN;if(!Number.isNaN(s))return s;const a=[t.last_turn_ago_s,t.last_proactive_ago_s,t.last_handoff_ago_s,t.last_compaction_ago_s].find(o=>typeof o=="number"&&Number.isFinite(o)&&o>=0);return typeof a=="number"?Date.now()-a*1e3:null}const md=Rt(()=>{const t=Date.now(),e=new Set,n=ii.value;for(const s of te.value){const a=pd(s,n);a!=null&&t-a>ud&&e.add(s.name)}return e});let ha=null;function vd(t){return t==="dashboard_refresh"||t==="masc/dashboard_refresh"||t.startsWith("goal_")||t.startsWith("masc/goal_")||t.startsWith("mdal_")||t.startsWith("masc/mdal_")||t.startsWith("operator_")||t.startsWith("masc/operator_")||t.startsWith("command_plane_")||t.startsWith("masc/command_plane_")}function dt(t){return typeof t=="object"&&t!==null}function y(t){return typeof t=="string"&&t.trim()!==""?t:void 0}function T(t){return typeof t=="number"&&Number.isFinite(t)?t:void 0}function zt(t){if(!Array.isArray(t))return;const e=t.filter(n=>typeof n=="string"&&n.trim()!=="");return e.length>0?e:void 0}function ci(t){if(typeof t=="string"&&t.trim()!=="")return t;if(!(typeof t!="number"||!Number.isFinite(t)||t<=0))return new Date(t*1e3).toISOString()}function Zo(t){const e=typeof t=="string"?t.toLowerCase():"";return e==="active"||e==="busy"||e==="listening"||e==="idle"||e==="inactive"||e==="offline"?e:e==="in_progress"||e==="claimed"?"busy":"offline"}function _d(t){const e=typeof t=="string"?t.toLowerCase():"";return e==="todo"||e==="in_progress"||e==="claimed"||e==="done"||e==="cancelled"?e:e==="inprogress"?"in_progress":"todo"}function fd(t){if(!dt(t))return null;const e=y(t.name);return e?{name:e,agent_type:y(t.agent_type),status:Zo(t.status),current_task:y(t.current_task)??null,joined_at:y(t.joined_at),last_seen:y(t.last_seen),capabilities:zt(t.capabilities),emoji:y(t.emoji),koreanName:y(t.koreanName)??y(t.korean_name),model:y(t.model),traits:zt(t.traits),interests:zt(t.interests),activityLevel:T(t.activityLevel)??T(t.activity_level),primaryValue:y(t.primaryValue)??y(t.primary_value)}:null}function gd(t){if(!dt(t))return null;const e=y(t.id),n=y(t.title);return!e||!n?null:{id:e,title:n,status:_d(t.status),priority:T(t.priority),assignee:y(t.assignee),description:y(t.description),created_at:y(t.created_at),updated_at:y(t.updated_at)}}function $d(t){if(!dt(t))return null;const e=y(t.from)??y(t.from_agent)??"system",n=y(t.content)??"",s=y(t.timestamp)??new Date().toISOString();return{id:y(t.id),seq:T(t.seq),from:e,content:n,timestamp:s,type:y(t.type)}}function Xi(t){if(typeof t.seq=="number"&&Number.isFinite(t.seq))return t.seq;const e=Date.parse(t.timestamp);return Number.isNaN(e)?0:e}function hd(t,e){if(e.length===0)return t;const n=new Map;for(const s of t){const a=typeof s.seq=="number"?`seq:${s.seq}`:`ts:${s.timestamp}|from:${s.from}|content:${s.content}`;n.set(a,s)}for(const s of e){const a=typeof s.seq=="number"?`seq:${s.seq}`:`ts:${s.timestamp}|from:${s.from}|content:${s.content}`;n.set(a,s)}return[...n.values()].sort((s,a)=>Xi(s)-Xi(a)).slice(-500)}function yd(t){return Array.isArray(t)?t.map(e=>{if(!dt(e))return null;const n=T(e.ts_unix);if(n==null)return null;const s=dt(e.handoff)?e.handoff:null;return{ts:n,context_ratio:T(e.context_ratio)??0,context_tokens:T(e.context_tokens)??0,context_max:T(e.context_max)??0,latency_ms:T(e.latency_ms)??0,generation:T(e.generation)??0,channel:typeof e.channel=="string"?e.channel:"turn",is_handoff:s!=null&&e.handoff_performed===!0,is_compaction:e.compacted===!0,compaction_saved_tokens:T(e.compaction_saved_tokens)??0,compaction_trigger:typeof e.compaction_trigger=="string"?e.compaction_trigger:null,model_used:typeof e.model_used=="string"?e.model_used:"",cost_usd:T(e.cost_usd)??0,handoff_to_model:s&&typeof s.to_model=="string"?s.to_model:null,handoff_new_generation:s?T(s.new_generation)??null:null}}).filter(e=>e!==null):[]}function Qi(t){if(!dt(t))return null;const e=y(t.health_state),n=y(t.next_action_path),s=y(t.last_reply_status);if(!e||!n||!s)return null;const a=y(t.quiet_reason)??null,o=y(t.summary)??(e==="offline"||e==="degraded"||e==="stale"?"Keeper is not in a healthy reply state. Probe or recover before relying on automation.":a==="quiet_hours"?"Lodge quiet hours are active. Direct messages still work, but scheduled social ticks may look asleep.":a==="min_gap"?"Keeper is inside its proactive cooldown window. Direct messages work now; autonomous check-ins will wait.":a==="never_started"?"Keeper metadata exists but no reply turn has been recorded yet.":"Keeper is reachable. Send a direct message for an immediate response.");return{health_state:e,quiet_reason:a,next_action_path:n,last_reply_status:s,last_reply_at:ci(t.last_reply_at)??y(t.last_reply_at)??null,last_reply_preview:y(t.last_reply_preview)??null,last_error:y(t.last_error)??null,next_eligible_at_s:T(t.next_eligible_at_s)??null,recoverable:typeof t.recoverable=="boolean"?t.recoverable:n==="recover",summary:o,keepalive_running:typeof t.keepalive_running=="boolean"?t.keepalive_running:void 0}}function bd(t,e){return(Array.isArray(t)?t:dt(t)&&Array.isArray(t.keepers)?t.keepers:[]).map(s=>{if(!dt(s))return null;const a=dt(s.agent)?s.agent:null,o=dt(s.context)?s.context:null,r=dt(s.metrics_window)?s.metrics_window:void 0,c=y(s.name);if(!c)return null;const d=T(s.context_ratio)??T(o==null?void 0:o.context_ratio),m=y(s.status)??y(a==null?void 0:a.status)??"offline",u=Zo(m),p=y(s.model)??y(s.active_model)??y(s.primary_model),v=zt(s.skill_secondary),$=o?{source:y(o.source),context_ratio:T(o.context_ratio),context_tokens:T(o.context_tokens),context_max:T(o.context_max),message_count:T(o.message_count),has_checkpoint:typeof o.has_checkpoint=="boolean"?o.has_checkpoint:void 0}:void 0,x=a?{name:y(a.name),exists:typeof a.exists=="boolean"?a.exists:void 0,error:y(a.error),agent_type:y(a.agent_type),status:y(a.status),current_task:y(a.current_task)??null,joined_at:y(a.joined_at),last_seen:y(a.last_seen),last_seen_ago_s:T(a.last_seen_ago_s),capabilities:zt(a.capabilities),is_zombie:typeof a.is_zombie=="boolean"?a.is_zombie:void 0}:void 0,k=yd(s.metrics_series),C={name:c,emoji:y(s.emoji),koreanName:y(s.koreanName)??y(s.korean_name),agent_name:y(s.agent_name),trace_id:y(s.trace_id),model:p,primary_model:y(s.primary_model),active_model:y(s.active_model),next_model_hint:y(s.next_model_hint)??null,status:u,presence_keepalive:typeof s.presence_keepalive=="boolean"?s.presence_keepalive:void 0,presence_keepalive_sec:T(s.presence_keepalive_sec),keepalive_running:typeof s.keepalive_running=="boolean"?s.keepalive_running:void 0,proactive_enabled:typeof s.proactive_enabled=="boolean"?s.proactive_enabled:void 0,proactive_idle_sec:T(s.proactive_idle_sec),proactive_cooldown_sec:T(s.proactive_cooldown_sec),last_heartbeat:y(s.last_heartbeat)??y(a==null?void 0:a.last_seen),generation:T(s.generation),turn_count:T(s.turn_count)??T(s.total_turns),keeper_age_s:T(s.keeper_age_s),last_turn_ago_s:T(s.last_turn_ago_s),last_handoff_ago_s:T(s.last_handoff_ago_s),last_compaction_ago_s:T(s.last_compaction_ago_s),last_proactive_ago_s:T(s.last_proactive_ago_s),last_proactive_preview:y(s.last_proactive_preview)??null,context_ratio:d,context_tokens:T(s.context_tokens)??T(o==null?void 0:o.context_tokens),context_max:T(s.context_max)??T(o==null?void 0:o.context_max),context_source:y(s.context_source)??y(o==null?void 0:o.source),context:$,traits:zt(s.traits),interests:zt(s.interests),primaryValue:y(s.primaryValue)??y(s.primary_value),activityLevel:T(s.activityLevel)??T(s.activity_level),memory_recent_note:y(s.memory_recent_note)??null,recent_input_preview:y(s.recent_input_preview)??null,recent_output_preview:y(s.recent_output_preview)??null,recent_tool_names:zt(s.recent_tool_names)??[],conversation_tail_count:T(s.conversation_tail_count),k2k_count:T(s.k2k_count),handoff_count_total:T(s.handoff_count_total)??T(s.trace_history_count),compaction_count:T(s.compaction_count),last_compaction_saved_tokens:T(s.last_compaction_saved_tokens),diagnostic:Qi(s.diagnostic),skill_primary:y(s.skill_primary)??null,skill_secondary:v,skill_reason:y(s.skill_reason)??null,metrics_series:k.length>0?k:void 0,metrics_window:r,agent:x};return C.diagnostic=Qi(s.diagnostic)??Gc(C,(e==null?void 0:e.lodge)??null),C}).filter(s=>s!==null)}function tr(t){return dt(t)?{...t,lodge:Hc(t.lodge)??void 0}:null}function kd(t){const e=typeof t=="string"?t.toLowerCase():"";return e==="running"||e==="interrupted"||e==="completed"||e==="stopped"||e==="error"?e:e.startsWith("error")?"error":"running"}function xd(t){if(!dt(t))return null;const e=T(t.iteration);if(e==null)return null;const n=T(t.metric_before)??0,s=T(t.metric_after)??n,a=dt(t.evidence)?t.evidence:null;return{iteration:e,metric_before:n,metric_after:s,delta:T(t.delta)??s-n,changes:y(t.changes)??"",failed_attempts:y(t.failed_attempts)??"",next_suggestion:y(t.next_suggestion)??"",elapsed_ms:T(t.elapsed_ms)??0,cost_usd:T(t.cost_usd)??null,evidence:a?{worker_engine:(a.worker_engine==="api_tool_loop","api_tool_loop"),worker_model:y(a.worker_model)??"",tool_call_count:T(a.tool_call_count)??0,tool_names:zt(a.tool_names)??[],session_id:y(a.session_id)??"",evidence_status:a.evidence_status==="legacy_unverified"?"legacy_unverified":"verified"}:null}}function Sd(t){var o,r;if(!dt(t))return null;const e=y(t.loop_id);if(!e)return null;const n=T(t.baseline_metric)??0,s=Array.isArray(t.history)?t.history.map(xd).filter(c=>c!==null):[],a=T(t.current_metric)??((o=s[0])==null?void 0:o.metric_after)??n;return{loop_id:e,profile:y(t.profile)??"unknown",status:kd(t.status),strict_mode:typeof t.strict_mode=="boolean"?t.strict_mode:void 0,error_message:y(t.error_message)??y(t.error_reason)??null,stop_reason:y(t.stop_reason)??y(t.reason)??null,current_iteration:T(t.current_iteration)??((r=s[0])==null?void 0:r.iteration)??0,max_iterations:T(t.max_iterations)??0,baseline_metric:n,current_metric:a,target:y(t.target)??"",stagnation_streak:T(t.stagnation_streak)??0,stagnation_limit:T(t.stagnation_limit)??0,elapsed_seconds:T(t.elapsed_seconds)??0,updated_at:ci(t.updated_at)??null,stopped_at:ci(t.stopped_at)??null,execution_mode:t.execution_mode==="worker_spawn"?"worker_spawn":void 0,worker_engine:t.worker_engine==="api_tool_loop"?"api_tool_loop":null,worker_model:y(t.worker_model)??null,evidence_policy:t.evidence_policy==="hard"||t.evidence_policy==="legacy"?t.evidence_policy:void 0,latest_tool_call_count:T(t.latest_tool_call_count)??0,latest_tool_names:zt(t.latest_tool_names)??[],session_id:y(t.session_id)??null,evidence_status:t.evidence_status==="legacy_unverified"?"legacy_unverified":t.evidence_status==="verified"?"verified":null,durability:t.durability==="persistent_backend"||t.durability==="memory_only"?t.durability:void 0,persistence_backend:t.persistence_backend==="filesystem"||t.persistence_backend==="postgres"||t.persistence_backend==="memory"?t.persistence_backend:void 0,recoverable:typeof t.recoverable=="boolean"?t.recoverable:void 0,history:s}}async function Gn(){oi.value=!0;try{await Promise.all([nr(),Jt()]),Xo.value=new Date().toISOString()}catch(t){console.error("Dashboard refresh error:",t)}finally{oi.value=!1}}async function er(){Ns.value=!0,Rs.value=null;try{const t=await Hl();Ci.value=t,ld.value=new Date().toISOString()}catch(t){Rs.value=t instanceof Error?t.message:"Failed to load dashboard semantics"}finally{Ns.value=!1}}function Ad(t){var e;return((e=Ci.value)==null?void 0:e.surfaces.find(n=>n.id===t))??null}function Cd(t){var n;const e=((n=Ci.value)==null?void 0:n.surfaces)??[];for(const s of e){const a=s.panels.find(o=>o.id===t);if(a)return a}return null}function wd(t){var s,a;Ke.value=(Array.isArray(t.goals)?t.goals:[]).map(o=>{if(!dt(o))return null;const r=y(o.id),c=y(o.title),d=y(o.horizon),m=y(o.status),u=y(o.created_at),p=y(o.updated_at);return!r||!c||!d||!m||!u||!p?null:{id:r,horizon:d,title:c,metric:y(o.metric)??null,target_value:y(o.target_value)??null,due_date:y(o.due_date)??null,priority:T(o.priority)??3,status:m,parent_goal_id:y(o.parent_goal_id)??null,last_review_note:y(o.last_review_note)??null,last_review_at:y(o.last_review_at)??null,created_at:u,updated_at:p}}).filter(o=>o!==null);const e=new Map,n=Array.isArray((s=t.mdal)==null?void 0:s.loops)?t.mdal.loops:[];for(const o of n){const r=Sd(o);r&&e.set(r.loop_id,r)}Yo.value=e,Ue.value=typeof((a=t.mdal)==null?void 0:a.error)=="string"?t.mdal.error:null,Ai.value=Ue.value?"error":e.size===0?"idle":"ready"}async function nr(){try{const t=await Fl(),e=tr(t.status);e&&(At.value=e)}catch(t){console.error("Dashboard shell fetch error:",t)}}async function Jt(){var t;try{const e=await ql(),n=tr(e.status),s=(t=At.value)==null?void 0:t.room;n&&(At.value=n);const a=s!=null&&(n==null?void 0:n.room)!=null&&s!==n.room;wt.value=(Array.isArray(e.agents)?e.agents:[]).map(fd).filter(r=>r!==null),qt.value=(Array.isArray(e.tasks)?e.tasks:[]).map(gd).filter(r=>r!==null);const o=(Array.isArray(e.messages)?e.messages:[]).map($d).filter(r=>r!==null);Xe.value=a?o:hd(Xe.value,o),te.value=bd(e.keepers,n??At.value),id.value=null,Xo.value=new Date().toISOString()}catch(e){console.error("Dashboard execution fetch error:",e)}}async function Kt(){wn.value=!0;try{const t=await Kl(Cn.value,{excludeSystem:ze.value});An.value=t.posts??[],li.value=new Date().toISOString()}catch(t){console.error("Board fetch error:",t)}finally{wn.value=!1}}async function Ut(){var t;ri.value=!0;try{const e=Vt.value||((t=At.value)==null?void 0:t.room)||"default";Vt.value||(Vt.value=e);const n=await xc(e);Vo.value=n}catch(e){console.error("TRPG fetch error:",e)}finally{ri.value=!1}}async function Tn(){_n.value=!0,fn.value=!0;try{const t=await Gl();wd(t),od.value=new Date().toISOString(),rd.value=new Date().toISOString()}catch(t){console.error("Planning fetch error:",t),Ai.value="error",Ue.value=t instanceof Error?t.message:String(t)}finally{_n.value=!1,fn.value=!1}}async function sr(){return Tn()}let $s=null;function Td(t){$s=t}let hs=null;function Id(t){hs=t}let ys=null;function Nd(t){ys=t}const Se={};function be(t,e,n=500){Se[t]&&clearTimeout(Se[t]),Se[t]=setTimeout(()=>{e(),delete Se[t]},n)}function Rd(){const t=Eo.subscribe(e=>{if(e){if(e.type==="keeper_heartbeat"&&e.name){const n=new Map(ii.value);n.set(e.name,e.ts_unix?e.ts_unix*1e3:Date.now()),ii.value=n;return}(e.type==="agent_joined"||e.type==="agent_left")&&be("execution",Jt),vd(e.type)&&(ha||(ha=setTimeout(()=>{Gn(),hs==null||hs(),ys==null||ys(),ha=null},500))),(e.type.startsWith("task_")||e.type.startsWith("masc/task_"))&&be("execution",Jt),e.type==="broadcast"&&be("execution",Jt),(e.type==="keeper_handoff"||e.type==="keeper_compaction"||e.type==="keeper_guardrail")&&be("execution",Jt),(e.type==="board_post"||e.type==="masc/board_post"||e.type==="board_comment"||e.type==="masc/board_comment")&&be("board",Kt),e.type.startsWith("decision_")&&be("council",()=>$s==null?void 0:$s()),(e.type==="mdal_started"||e.type==="mdal_iteration"||e.type==="mdal_completed"||e.type==="mdal_stopped")&&be("mdal",sr,350)}});return()=>{t();for(const e of Object.keys(Se))clearTimeout(Se[e]),delete Se[e]}}let gn=null;function Pd(){gn||(gn=setInterval(()=>{ue.value,Gn()},1e4))}function Ld(){gn&&(clearInterval(gn),gn=null)}function Md({metric:t}){return i`
  ...
  `}function iu(){var p,v,$,x,k,C,R;const t=nn.value;if(!t)return null;const e=tu(),n=rr(t),s=or(t),a=Ms.value,o=nu(t),r=eu(n),c=(e==null?void 0:e.capabilities)??[],d=((p=At.value)==null?void 0:p.room)??"default",m=((v=At.value)==null?void 0:v.project)??"확인 없음",u=(($=At.value)==null?void 0:$.cluster)??"확인 없음";return i`
    <div
...
`))}function rf({hp:t,max:e}){const n=J_(t,e),s=G_(t,e);return i`
  ...
  `}function mf({state:t,nowMs:e}){var m;const n=Vt.value||((m=t.session)==null?void 0:m.room)||"",s=ps.value,a=t.party??[];if(!a.find(u=>u.id===De.value)&&a.length>0){const u=a[0];u&&(De.value=u.id)}const r=async()=>{var p,v;if(!n){M("Room ID가 비어 있습니다.","error");return}if(!Cs(e))return;const u=((p=t.current_round)==null?void 0:p.phase)??((v=t.session)==null?void 0:v.status)??"unknown";if(yi("라운드 실행",n,u)){ps.value="running";try{const $=await Sc(n);$i.value=$,ps.value="ok";const x=de($.summary)?$.summary:null,k=x?Wn(x,"advanced",!1):!1,C=x?yt(x,"progress_reason",""):"";M(k?"라운드가 정상 진행되었습니다.":`라운드가 정체되었습니다${C?`: ${C}`:""}`,k?"success":"warning"),Ut()}catch($){$i.value=null,ps.value="error";const x=$ instanceof Error?$.message:"라운드 실행에 실패했습니다.";M(x,"error")}finally{na()}}},c=async()=>{var p,v;if(!n||!Cs(e))return;const u=((p=t.current_round)==null?void 0:p.phase)??((v=t.session)==null?void 0:v.status)??"unknown";if(yi("턴 강제 진행",n,u))try{await wc(n),M("턴을 다음 단계로 이동했습니다.","success"),Ut()}catch{M("턴 이동에 실패했습니다.","error")}finally{na()}},d=async()=>{if(!n||!Cs(e))return;const u=De.value.trim();if(!u){M("먼저 Actor를 선택하세요.","warning");return}const p=Number.parseInt(La.value,10),v=Number.parseInt(Ma.value,10);if(Number.isNaN(p)||Number.isNaN(v)){M("stat/dc는 숫자여야 합니다.","warning");return}const $=Number.parseInt(us.value,10),x=us.value.trim()===""||Number.isNaN($)?void 0:$;try{await Cc({roomId:n,actorId:u,action:Pa.value.trim()||"ability_check",statValue:p,dc:v,rawD20:x}),M("주사위 판정을 기록했습니다.","success"),Ut()}catch{M("주사위 판정 기록에 실패했습니다.","error")}};return i`
  ...
  `}function _f({state:t,nowMs:e}){var v;const n=Vt.value||((v=t.session)==null?void 0:v.room)||"",s=t.join_gate,a=za.value,o=de(a)?a:null,r=(t.party??[]).filter($=>$.role!=="dm"),c=ie.value.trim(),d=r.some($=>$.id===c),m=d?c:c?"__manual__":"",u=async()=>{const $=ie.value.trim(),x=ms.value.trim();if(!n||!$){M("Room/Actor가 필요합니다.","warning");return}xt.value="checking";try{const k=await Nc(n,$,x||void 0);za.value=k,xt.value="ok",M("참가 가능 여부를 갱신했습니다.","success")}catch(k){xt.value="error";const C=k instanceof Error?k.message:"참가 가능 여부 확인에 실패했습니다.";M(C,"error")}},p=async()=>{var R,w;const $=ie.value.trim(),x=ms.value.trim(),k=Ea.value.trim();if(!n||!$||!x){M("Room/Actor/Keeper가 필요합니다.","warning");return}if(!Cs(e))return;const C=((R=t.current_round)==null?void 0:R.phase)??((w=t.session)==null?void 0:w.status)??"unknown";if(yi("Mid-Join 승인 요청",n,C)){xt.value="requesting";try{const E=await Rc({room_id:n,actor_id:$,keeper_name:x,role:Da.value,...k?{name:k}:{}});za.value=E;const P=de(E)?Wn(E,"granted",!1):!1,L=de(E)?yt(E,"reason_code",""):"";P?M("Mid-Join이 승인되었습니다.","success"):M(`Mid-Join이 거절되었습니다${L?`: ${L}`:""}`,"warning"),xt.value=P?"ok":"error",Ut()}catch(E){xt.value="error";const P=E instanceof Error?E.message:"Mid-Join 요청에 실패했습니다.";M(P,"error")}finally{na()}}};return i`
    <div class="trpg-control-box">
