...
val validate_mcp_session_profile : profile:tool_profile -> string -> (unit, string) result
...
val get_protocol_version_for_session : ?session_id:string -> Httpun.Request.t -> string
...
val json_headers : deps:deps -> string -> string -> string -> (string * string) list
...
val handle_get_operator_mcp : deps:deps -> Httpun.Request.t -> Httpun.Reqd.t -> unit
val handle_post_messages : deps:deps -> Httpun.Request.t -> Httpun.Reqd.t -> unit
...
val handle_ag_ui_events : deps:deps -> Httpun.Request.t -> Httpun.Reqd.t -> unit
