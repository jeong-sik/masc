...
`).map(n=>n.trim()).filter(n=>n!=="")}async function Po(t,e=20){return U("masc_task_history",{task_id:t,limit:e})}async function Io(){return ce("fetchDebates",async()=>{const t=await ct("/api/v1/council/debates?limit=100");return Array.isArray(t.debates)?t.debates.map(e=>{if(!w(e))return null;const n=m(e.id,"").trim(),s=m(e.topic,"").trim();return!n||!s?null:{id:n,topic:s,status:m(e.status,"open"),argument_count:N(e.argument_count,0),created_at:Tt(e.created_at_iso??e.created_at)}}).filter(e=>e!==null):[]})}async function Oo(){return ce("fetchCouncilSessions",async()=>{const t=await ct("/api/v1/council/sessions?limit=100");return Array.isArray(t.sessions)?t.sessions.map(e=>{if(!w(e))return null;const n=m(e.id,"").trim(),s=m(e.topic,"").trim();return!n||!s?null:{id:n,topic:s,initiator:m(e.initiator,"system"),votes:N(e.votes,0),quorum:N(e.quorum,0),state:m(e.state,"open"),created_at:Tt(e.created_at_iso??e.created_at)}}).filter(e=>e!==null):[]})}async function jo(t){const e=await U("masc_debate_start",{topic:t});try{return JSON.parse(e)}catch{return null}}async function Mo(t){return ce("fetchDebateStatus",async()=>{const e=encodeURIComponent(t),n=await ct(`/api/v1/council/debates/${e}/summary`);if(!w(n))return null;const s=m(n.id,"").trim();return s?{id:s,topic:m(n.topic,""),status:m(n.status,"open"),support_count:N(n.support_count,0),oppose_count:N(n.oppose_count,0),neutral_count:N(n.neutral_count,0),total_arguments:N(n.total_arguments,0),created_at:Tt(n.created_at_iso??n.created_at),summary_text:m(n.summary_text,"")}:null})}async function Fo(){try{const t=await U("masc_goal_list",{});if(typeof t=="string"){const e=JSON.parse(t);return Array.isArray(e)?e:e.goals??[]}return Array.isArray(t)?t:t.goals??[]}catch{return[]}}const Et=_([]),ue=_([]),Da=_([]),Dt=_([]),gt=_(null),Ot=_(null),Dn=_(new Map),Pa=_([]),Pn=_("hot"),Ia=_(null),st=_(""),Ge=_([]),Ft=_(!1),In=_(!1),On=_(!1),jn=_(!1),Oa=lt(()=>Et.value.filter(t=>t.status==="active"||t.status==="idle")),as=lt(()=>{const t=ue.value;return{todo:t.filter(e=>e.status==="todo"),inProgress:t.filter(e=>e.status==="in_progress"||e.status==="claimed"),done:t.filter(e=>e.status==="done")}});function zo(t){var a;const e=t.metrics_series;if(!e||e.length===0){const i=((a=t.status)==null?void 0:a.toLowerCase())??"";return i==="offline"||i==="inactive"?"offline":"idle"}const n=e[e.length-1];if(!n)return"idle";if(n.is_handoff)return"handoff-imminent";if(n.is_compaction)return"compacting";const s=n.context_ratio;return s>.85?"handoff-imminent":s>.7?"preparing":s>.5?"compacting":"active"}const Ho=lt(()=>{const t=new Map;for(const e of Dt.value)t.set(e.name,zo(e));return t}),Uo=12e4,Bo=lt(()=>{const t=Date.now(),e=new Set,n=Dn.value;for(const s of Dt.value){const a=n.get(s.name);a!=null&&t-a>Uo&&e.add(s.name)}return e}),Ee={},Ko=5e3;function Mn(){delete Ee.compact,delete Ee.full}function V(t){return typeof t=="object"&&t!==null}function h(t){return typeof t=="string"&&t.trim()!==""?t:void 0}function k(t){return typeof t=="number"&&Number.isFinite(t)?t:void 0}function zt(t){if(!Array.isArray(t))return;const e=t.filter(n=>typeof n=="string"&&n.trim()!=="");return e.length>0?e:void 0}function ja(t){const e=typeof t=="string"?t.toLowerCase():"";return e==="active"||e==="idle"||e==="inactive"||e==="offline"?e:e==="busy"||e==="in_progress"||e==="claimed"?"active":"offline"}function qo(t){const e=typeof t=="string"?t.toLowerCase():"";return e==="todo"||e==="in_progress"||e==="claimed"||e==="done"||e==="cancelled"?e:e==="inprogress"?"in_progress":"todo"}function Go(t){if(!V(t))return null;const e=h(t.name);return e?{name:e,status:ja(t.status),current_task:h(t.current_task)??null,last_seen:h(t.last_seen),emoji:h(t.emoji),koreanName:h(t.koreanName)??h(t.korean_name),model:h(t.model),traits:zt(t.traits),interests:zt(t.interests),activityLevel:k(t.activityLevel)??k(t.activity_level),primaryValue:h(t.primaryValue)??h(t.primary_value)}:null}function Jo(t){if(!V(t))return null;const e=h(t.id),n=h(t.title);return!e||!n?null:{id:e,title:n,status:qo(t.status),priority:k(t.priority),assignee:h(t.assignee),description:h(t.description),created_at:h(t.created_at),updated_at:h(t.updated_at)}}function Wo(t){if(!V(t))return null;const e=h(t.from)??h(t.from_agent)??"system",n=h(t.content)??"",s=h(t.timestamp)??new Date().toISOString();return{id:h(t.id),seq:k(t.seq),from:e,content:n,timestamp:s,type:h(t.type)}}function Vo(t){return Array.isArray(t)?t.map(e=>{if(!V(e))return null;const n=k(e.ts_unix);if(n==null)return null;const s=V(e.handoff)?e.handoff:null;return{ts:n,context_ratio:k(e.context_ratio)??0,context_tokens:k(e.context_tokens)??0,context_max:k(e.context_max)??0,latency_ms:k(e.latency_ms)??0,generation:k(e.generation)??0,channel:typeof e.channel=="string"?e.channel:"turn",is_handoff:s!=null&&e.handoff_performed===!0,is_compaction:e.compacted===!0,compaction_saved_tokens:k(e.compaction_saved_tokens)??0,compaction_trigger:typeof e.compaction_trigger=="string"?e.compaction_trigger:null,model_used:typeof e.model_used=="string"?e.model_used:"",cost_usd:k(e.cost_usd)??0,handoff_to_model:s&&typeof s.to_model=="string"?s.to_model:null,handoff_new_generation:s?k(s.new_generation)??null:null}}).filter(e=>e!==null):[]}function Yo(t){return(Array.isArray(t)?t:V(t)&&Array.isArray(t.keepers)?t.keepers:[]).map(n=>{if(!V(n))return null;const s=V(n.agent)?n.agent:null,a=V(n.context)?n.context:null,i=V(n.metrics_window)?n.metrics_window:void 0,r=h(n.name);if(!r)return null;const c=k(n.context_ratio)??k(a==null?void 0:a.context_ratio),u=h(n.status)??h(s==null?void 0:s.status)??"offline",p=ja(u),f=h(n.model)??h(n.active_model)??h(n.primary_model),l=zt(n.skill_secondary),d=a?{source:h(a.source),context_ratio:k(a.context_ratio),context_tokens:k(a.context_tokens),context_max:k(a.context_max),message_count:k(a.message_count),has_checkpoint:typeof a.has_checkpoint=="boolean"?a.has_checkpoint:void 0}:void 0,v=s?{name:h(s.name),status:h(s.status),current_task:h(s.current_task)??null,last_seen:h(s.last_seen)}:void 0,$=Vo(n.metrics_series);return{name:r,emoji:h(n.emoji),koreanName:h(n.koreanName)??h(n.korean_name),agent_name:h(n.agent_name),trace_id:h(n.trace_id),model:f,primary_model:h(n.primary_model),active_model:h(n.active_model),next_model_hint:h(n.next_model_hint)??null,status:p,last_heartbeat:h(n.last_heartbeat)??h(s==null?void 0:s.last_seen),generation:k(n.generation),turn_count:k(n.turn_count)??k(n.total_turns),context_ratio:c,context_tokens:k(n.context_tokens)??k(a==null?void 0:a.context_tokens),context_max:k(n.context_max)??k(a==null?void 0:a.context_max),context_source:h(n.context_source)??h(a==null?void 0:a.source),context:d,traits:zt(n.traits),interests:zt(n.interests),primaryValue:h(n.primaryValue)??h(n.primary_value),activityLevel:k(n.activityLevel)??k(n.activity_level),memory_recent_note:h(n.memory_recent_note)??null,conversation_tail_count:k(n.conversation_tail_count),k2k_count:k(n.k2k_count),handoff_count_total:k(n.handoff_count_total)??k(n.trace_history_count),compaction_count:k(n.compaction_count),last_compaction_saved_tokens:k(n.last_compaction_saved_tokens),skill_primary:h(n.skill_primary)??null,skill_secondary:l,skill_reason:h(n.skill_reason)??null,metrics_series:$.length>0?$:void 0,metrics_window:i,agent:v}}).filter(n=>n!==null)}async function Je(t="full"){var s,a,i;const e=Date.now(),n=Ee[t];if(!(n&&e-n.time<Ko)){In.value=!0;try{const r=await to(t);Ee[t]={data:r,time:e},Et.value=(Array.isArray((s=r.agents)==null?void 0:s.agents)?r.agents.agents:[]).map(Go).filter(c=>c!==null),ue.value=(Array.isArray((a=r.tasks)==null?void 0:a.tasks)?r.tasks.tasks:[]).map(Jo).filter(c=>c!==null),Da.value=(Array.isArray((i=r.messages)==null?void 0:i.messages)?r.messages.messages:[]).map(Wo).filter(c=>c!==null),Dt.value=Yo(r.keepers),gt.value=V(r.status)?r.status:null,Ot.value=r.perpetual??null}catch(r){console.error("Dashboard fetch error:",r)}finally{In.value=!1}}}async function $t(){On.value=!0;try{const t=await so(Pn.value);Pa.value=t.posts??[]}catch(t){console.error("Board fetch error:",t)}finally{On.value=!1}}async function at(){var t;jn.value=!0;try{const e=st.value||((t=gt.value)==null?void 0:t.room)||"default";st.value||(st.value=e);const n=await bo(e);Ia.value=n}catch(e){console.error("TRPG fetch error:",e)}finally{jn.value=!1}}async function Fn(){Ft.value=!0;try{const t=await Fo();Ge.value=Array.isArray(t)?t:[]}catch(t){console.error("Goals fetch error:",t)}finally{Ft.value=!1}}let Qe=null,Xe=null;function Qo(){return xa.subscribe(e=>{if(e){if(e.type==="keeper_heartbeat"&&e.name){const n=new Map(Dn.value);n.set(e.name,e.ts_unix?e.ts_unix*1e3:Date.now()),Dn.value=n}Mn(),Qe||(Qe=setTimeout(()=>{Je(),Qe=null},500)),(e.type==="board_post"||e.type==="board_comment")&&(Xe||(Xe=setTimeout(()=>{$t(),Xe=null},500))),(e.type==="keeper_handoff"||e.type==="keeper_compaction"||e.type==="keeper_guardrail")&&Mn()}})}let Ht=null;function Xo(){Ht||(Ht=setInterval(()=>{Mn(),Je()},1e4))}function Zo(){Ht&&(clearInterval(Ht),Ht=null)}function y({title:t,class:e,children:n}){return o`
  ...
  `}function we(t){return t?t>=1e6?`${(t/1e6).toFixed(1)}M`:t>=1e3?`${(t/1e3).toFixed(1)}K`:String(t):"—"}function sr({keeper:t}){const e=t.metrics_series??[],n=e[e.length-1],s=(n==null?void 0:n.cost_usd)!=null?`$${n.cost_usd.toFixed(4)}`:"—",a=[{label:"Generation",value:t.generation??"-",hint:"Succession count"},{label:"Turns",value:t.turn_count??"-",hint:"Total loop turns"},{label:"Context",value:t.context_ratio!=null?`${Math.round(t.context_ratio*100)}%`:"-",hint:t.context_ratio!=null&&t.context_ratio>.8?"Near limit":void 0},{label:"Activity",value:t.activityLevel??"-",hint:"Level 0–5"}];return o`
    <div class="keeper-kpis">
      ...
      `)}
      <div class="kpi-tile">
        <div class="kpi-value">${we(t.context_tokens)}</div>
  ...
  `}function ar({keeper:t}){var f,l;const e=t.metrics_series??[];if(e.length<2){const d=(((f=t.context)==null?void 0:f.context_ratio)??0)*100,v=d>85?"#ef4444":d>70?"#f59e0b":"#22c55e";return o`
    ...
    <div class="keeper-field-dict">
      ...
      ${t.context_tokens!=null?o`<div class="keeper-field-row"><span class="keeper-field-title">Context Tokens</span><span style="flex:1; text-align:right; color:#ccc;">${we(t.context_tokens)}</span></div>`:""}
      ${t.context_max!=null?o`<div class="keeper-field-row"><span class="keeper-field-title">Context Max</span><span style="flex:1; text-align:right; color:#ccc;">${we(t.context_max)}</span></div>`:""}
      ...
      ${t.last_compaction_saved_tokens!=null?o`<div class="keeper-field-row"><span class="keeper-field-title">Last Compact Saved</span><span style="flex:1; text-align:right; color:#ccc;">${we(t.last_compaction_saved_tokens)}</span></div>`:""}
  ...
  `}function tn(t){return t==null||Number.isNaN(t)?"-":`${Math.round(t*100)}%`}function cr({keeper:t}){const e=t.metrics_window,n=[{label:"Model fallback",value:tn(typeof(e==null?void 0:e.model_fallback_rate)=="number"?e.model_fallback_rate:void 0)},{label:"Proactive fallback",value:tn(typeof(e==null?void 0:e.proactive_fallback_rate)=="number"?e.proactive_fallback_rate:void 0)},{label:"Memory pass rate",value:tn(typeof(e==null?void 0:e.memory_pass_rate)=="number"?e.memory_pass_rate:void 0)},{label:"Handoffs",value:typeof(e==null?void 0:e.handoff_count)=="number"?e.handoff_count:t.handoff_count_total??"-"},{label:"Compactions",value:typeof(e==null?void 0:e.compaction_events)=="number"?e.compaction_events:t.compaction_count??"-"},{label:"Saved tokens",value:typeof(e==null?void 0:e.compaction_saved_tokens)=="number"?e.compaction_saved_tokens:t.last_compaction_saved_tokens??"-"},{label:"K2K events",value:t.k2k_count??"-"},{label:"Conversation tail",value:t.conversation_tail_count??"-"},{label:"Tool Calls",value:typeof(e==null?void 0:e.tool_call_count)=="number"?e.tool_call_count:"-"},{label:"Preview Similarity",value:typeof(e==null?void 0:e.proactive_preview_similarity_avg)=="number"?`${(e.proactive_preview_similarity_avg*100).toFixed(1)}%`:"-"},{label:"Memory Avg Score",value:typeof(e==null?void 0:e.memory_avg_score)=="number"?e.memory_avg_score.toFixed(3):"-"},{label:"Fallback Rate",value:typeof(e==null?void 0:e.fallback_rate)=="number"?`${(e.fallback_rate*100).toFixed(1)}%`:"-"}];return o`
    <div class="keeper-signal-list">
      ${n.map(s=>o`
        <div class="keeper-signal-row">
          <span>${s.label}</span>
  ...
  `}function ur({keeperName:t}){const[e,n]=ve("Loading internal monologue..."),[s,a]=ve(""),[i,r]=ve([]),[c,u]=ve(!1),p=async()=>{try{const l=await U("masc_keeper_status",{name:t,fast:!1,include_history_tail:!0,include_context:!0});n(typeof l=="string"?l:JSON.stringify(l,null,2))}catch(l){n("Failed to load: "+String(l))}};ft(()=>{p()},[t]);const f=async()=>{if(!s.trim())return;u(!0);const l=s;a(""),r(d=>[...d,{role:"You",text:l}]);try{const d=await U("masc_keeper_msg",{name:t,message:l});r(v=>[...v,{role:t,text:typeof d=="string"?d:JSON.stringify(d)}]),p()}catch(d){r(v=>[...v,{role:"System",text:"Error: "+String(d)}])}finally{u(!1)}};return o`
  ...
  `}const mr="masc_dashboard_agent_name",Pt=_(null),De=_(!1),ne=_(""),Pe=_([]),se=_([]),Ct=_(""),Ut=_(!1);function Fa(t){Pt.value=t,os()}function Es(){Pt.value=null,ne.value="",Pe.value=[],se.value=[],Ct.value=""}function _r(){const t=Pt.value;return t?Et.value.find(e=>e.name===t)??null:null}function za(t){return t?ue.value.filter(e=>e.assignee===t):[]}async function os(){const t=Pt.value;if(t){De.value=!0,ne.value="",Pe.value=[],se.value=[];try{const e=await Do(80);Pe.value=e.filter(a=>a.includes(t)).slice(0,20);const n=za(t).slice(0,6);if(n.length===0)return;const s=await Promise.all(n.map(async a=>{try{const i=await Po(a.id,25);return{taskId:a.id,text:i.trim()}}catch(i){const r=i instanceof Error?i.message:"history load failed";return{taskId:a.id,text:`Failed to load history: ${r}`}}}));se.value=s}catch(e){ne.value=e instanceof Error?e.message:"Failed to load agent detail"}finally{De.value=!1}}}async function Ds(){var s;const t=Pt.value,e=Ct.value.trim();if(!t||!e)return;const n=((s=localStorage.getItem(mr))==null?void 0:s.trim())||"dashboard";Ut.value=!0;try{await La(n,`@${t} ${e}`),Ct.value="",b(`Mention sent to ${t}`,"success"),os()}catch(a){const i=a instanceof Error?a.message:"Failed to send mention";b(i,"error")}finally{Ut.value=!1}}function gr({task:t}){return o`
  ...
  `}function hr(){var a,i,r,c;const t=Pt.value;if(!t)return null;const e=_r(),n=za(t),s=Pe.value;return o`
    <div
      ...
      <div class="agent-detail-modal">
        <div class="agent-detail-header">
          ...
          <div class="agent-detail-actions">
            <button class="control-btn ghost" onClick=${()=>{os()}} disabled=${De.value}>
        ...
        <${y} title="Task History">
          ${se.value.length===0?o`<div class="empty-state">No task history loaded</div>`:o`<div class="agent-history-list">${se.value.map(u=>o`<${$r} key=${u.taskId} row=${u} />`)}</div>`}
        <//>
  ...
  `}function Is(){var r,c,u,p,f;const t=gt.value,e=Et.value,n=Dt.value,s=as.value,a=(r=t==null?void 0:t.monitoring)==null?void 0:r.board,i=(c=t==null?void 0:t.monitoring)==null?void 0:c.council;return o`
    <div class="stats-grid">
      ...
      <${yt} label="Tasks" value=${ue.value.length} />
          ...
          <div class="grid-2col">
            <div class="stat-card">
              ...
              <div class="council-sub">
                <span>Freshness: ${me(a==null?void 0:a.last_activity_age_s)}</span>
                <span>SLO: ≤ ${me(a==null?void 0:a.slo_target_age_s)}</span>
            ...
            <div class="stat-card">
              ...
              <div class="council-sub">
                <span>Freshness: ${me(i==null?void 0:i.last_activity_age_s)}</span>
                ...
                <span>SLO: ≤ ${me(i==null?void 0:i.slo_target_quorum_age_s)}</span>
    ...
    ${t!=null&&t.room?o`
      ...
      `:null}
  `}function wr(t){if(!t)return"N/A";const e=Math.floor(t/3600),n=Math.floor(t%3600/60);return e>0?`${e}h ${n}m`:`${n}m`}function me(t){if(t==null||!Number.isFinite(t))return"No data";if(t<60)return`${Math.max(0,Math.round(t))}s`;const e=Math.floor(t/60);if(e<60)return`${e}m`;const n=Math.floor(e/60),s=e%60;return s>0?`${n}h ${s}m`:`${n}h`}function Os(t){const e=(t??"").toLowerCase();return e==="ok"?"Healthy":e==="warn"?"Warning":e==="bad"?"Degraded":"Unknown"}function js(t){const e=(t??"").toLowerCase();return e==="ok"?"#4ade80":e==="warn"?"#fbbf24":e==="bad"?"#fb7185":"#94a3b8"}const zn=_([]),Hn=_([]),Bt=_(""),Ie=_(!1),Kt=_(!1),ae=_(""),Oe=_(null),W=_(null),Un=_(!1);async function Bn(){Ie.value=!0,ae.value="";try{const[t,e]=await Promise.all([Io(),Oo()]);zn.value=t,Hn.value=e}catch(t){ae.value=t instanceof Error?t.message:"Failed to load council data"}finally{Ie.value=!1}}async function Ms(){const t=Bt.value.trim();if(t){Kt.value=!0;try{const e=await jo(t);Bt.value="",b(e!=null&&e.id?`Debate started: ${e.id}`:"Debate started","success"),await Bn()}catch(e){const n=e instanceof Error?e.message:"Failed to start debate";b(n,"error")}finally{Kt.value=!1}}}async function Sr(t){Oe.value=t,Un.value=!0,W.value=null;try{W.value=await Mo(t)}catch(e){ae.value=e instanceof Error?e.message:"Failed to load debate status",W.value=null}finally{Un.value=!1}}function Cr({debate:t}){const e=Oe.value===t.id;return o`
    <button
    ...
    <div>
      ...
      <${y} title="Council Command" class="section">
        <div class="council-create">
          ...
          <button class="control-btn ghost" onClick=${Bn} disabled=${Ie.value}>
        ...
        <${y} title="Voting Sessions" class="section">
          <div class="council-list">
            ${Hn.value.length===0?o`
                ...
                `:Hn.value.map(s=>o`<${Ar} key=${s.id} session=${s} />`)}
          </div>
        <//>
      </div>

      <${y} title=${Oe.value?`Debate Detail (${Oe.value})`:"Debate Detail"} class="section">
        ${Un.value?o`<div class="loading-indicator">Loading debate detail...</div>`:W.value?o`
...
`).trim();n.push(o`
      ...
      `);continue}if(a.startsWith("> ")){const r=[];for(;s<e.length&&e[s].startsWith("> ");)r.push(e[s].slice(2)),s++;n.push(o`<blockquote>${en(r.join(`
`))}</blockquote>`);continue}if(a.trim()===""){s++;continue}const i=[];for(;s<e.length;){const r=e[s];if(r.trim()===""||/^(`{3,}|~{3,})/.test(r)||r.startsWith("> ")||r.trim().startsWith("<think>"))break;i.push(r),s++}i.length>0&&n.push(o`<p>${en(i.join(`
`))}</p>`)}return n}function en(t){const e=[],n=/(`[^`]+`)|(\*\*[^*]+\*\*)|(\*[^*]+\*)|\[([^\]]+)\]\(([^)]+)\)/g;let s=0,a;for(;(a=n.exec(t))!==null;){if(a.index>s&&e.push(t.slice(s,a.index)),a[1]){const i=a[1].slice(1,-1);e.push(o`<code>${i}</code>`)}else if(a[2]){const i=a[2].slice(2,-2);e.push(o`<strong>${i}</strong>`)}else if(a[3]){const i=a[3].slice(1,-1);e.push(o`<em>${i}</em>`)}else a[4]&&a[5]&&e.push(o`<a href=${a[5]} target="_blank" rel="noopener">${a[4]}</a>`);s=a.index+a[0].length}return s<t.length&&e.push(t.slice(s)),e.length>0?e:[t]}const Er=[{id:"hot",label:"Hot"},{id:"trending",label:"Trending"},{id:"recent",label:"Recent"},{id:"updated",label:"Updated"},{id:"discussed",label:"Discussed"}],Kn=_([]),qt=_(!1),qn=_(null),Gt=_(""),Dr=_("dashboard-user"),Jt=_(!1);async function Ha(t){qn.value=t,qt.value=!0;try{const e=await ao(t);if(qn.value!==t)return;Kn.value=e.comments??[]}catch{}finally{qt.value=!1}}async function Fs(t){const e=Gt.value.trim();if(e){Jt.value=!0;try{await io(t,Dr.value,e),Gt.value="",b("Comment posted","success"),await Ha(t),$t()}catch{b("Failed to post comment","error")}finally{Jt.value=!1}}}function Pr(){const t=Pn.value;return o`
  ...
  `}function nn(){var e;const t=(e=gt.value)==null?void 0:e.data_quality;return!t||t.board_contract_ok!==!1&&!t.last_sync_at?null:o`
  ...
  `}function Ua({flair:t}){return t?o`<span class="post-flair ${t}">${t}</span>`:null}function Ir({post:t}){const e=async(n,s)=>{s.stopPropagation();try{await Ra(t.id,n),$t()}catch{b("Failed to vote","error")}};return o`
  ...
  `}function Mr({post:t}){qn.value!==t.id&&!qt.value&&Ha(t.id);const e=async n=>{try{await Ra(t.id,n),$t()}catch{b("Failed to vote","error")}};return o`
    <div>
      <button class="back-btn" onClick=${()=>qe("board")}>← Back to Board</button>
      <${y} title=${o`${t.title} <${Ua} flair=${t.flair} />`}>
  ...
  `}function zr(t,e){return{id:t.id??`msg-${t.seq??e}`,source:"message",actor:t.from??"system",content:t.content,timestamp:t.timestamp}}function Hr(t,e){return{id:`evt-${t.timestamp}-${e}`,source:"event",actor:t.agent||"system",content:t.text,timestamp:new Date(t.timestamp).toISOString()}}function zs(t){const e=Date.parse(t);return Number.isNaN(e)?0:e}function Ur({row:t}){const e=new Date(t.timestamp),n=isNaN(e.getTime())?"00:00:00":e.toLocaleTimeString("en-US",{hour12:!1});return o`
    <div class="term-row">
  ...
  `}function Br(){const t=Da.value.map(zr),e=Le.value.map(Hr),n=[...t,...e].sort((s,a)=>zs(a.timestamp)-zs(s.timestamp)).slice(0,100);return o`
    <div class="section">
      ...
      <div class="terminal-feed">
        ${n.length===0?o`<div class="empty-state" style="font-family: monospace; color: var(--ok);">> Waiting for signal...</div>`:n.map(s=>o`<${Ur} key=${s.id} row=${s} />`)}
      </div>
    </div>
  ...
  `}function Zr(){const{todo:t,inProgress:e,done:n}=as.value;return o`
    <div class="kanban-board">
      ...
      <div class="kanban-column">
        ...
        ${t.length===0?o`<div class="empty-state" style="opacity: 0.5;">No pending tasks</div>`:t.map(s=>o`<${sn} key=${s.id} task=${s} />`)}
      </div>
      ...
      <div class="kanban-column">
        ...
        ${e.length===0?o`<div class="empty-state" style="opacity: 0.5;">No active tasks</div>`:e.map(s=>o`<${sn} key=${s.id} task=${s} />`)}
      </div>
      ...
      <div class="kanban-column">
        ...
        ${n.length===0?o`<div class="empty-state" style="opacity: 0.5;">No completed tasks</div>`:n.slice(0,20).map(s=>o`<${sn} key=${s.id} task=${s} />`)}
        ${n.length>20?o`<div class="empty-state" style="opacity: 0.5;">...and ${n.length-20} more</div>`:null}
      </div>
    </div>
  `}function tl(t){return t==null?"P3":t<=1?"P1":t===2?"P2":t>=4?"P4+":"P3"}function an({task:t}){return o`
    <div class="council-row session">
      <div class="council-row-main">
  ...
  `}function el(){const t=as.value,e=t.inProgress,n=t.todo,s=t.done,a=Oa.value,i=n.filter(c=>(c.priority??3)<=2),r=n.filter(c=>!c.assignee);return o`
    ...
    <div class="council-grid">
      <${y} title="Execution Queue" class="section">
        <div class="council-list">
          ${e.length===0?o`<div class="empty-state">No active execution tasks</div>`:e.slice(0,20).map(c=>o`<${an} key=${c.id} task=${c} />`)}
        </div>
      <//>

      <${y} title="Ready Queue" class="section">
        <div class="council-list">
          ${n.length===0?o`<div class="empty-state">No ready tasks</div>`:n.slice(0,20).map(c=>o`<${an} key=${c.id} task=${c} />`)}
        </div>
      <//>
    </div>
    ...
    <div class="grid-2col">
      ...
      <${y} title="Attention Needed" class="section">
        <div class="council-list">
          ${r.length===0?o`<div class="empty-state">No unassigned tasks</div>`:r.slice(0,20).map(c=>o`<${an} key=${c.id} task=${c} />`)}
        </div>
      <//>
    </div>
  ...
  `}function sl(){const t=Le.value;return o`
    <div class="section">
      <h2>Event Journal</h2>
  ...
  `}const je=_("all"),Me=_("all"),Ka=lt(()=>{let t=Ge.value;return je.value!=="all"&&(t=t.filter(e=>e.horizon===je.value)),Me.value!=="all"&&(t=t.filter(e=>e.status===Me.value)),t}),al=lt(()=>{const t={short:[],mid:[],long:[]};for(const e of Ka.value){const n=t[e.horizon];n&&n.push(e)}return t});function il(t){return"★".repeat(Math.min(t,5))+"☆".repeat(Math.max(0,5-t))}function rs(t){switch(t){case"short":return"Short-term";case"mid":return"Mid-term";case"long":return"Long-term";default:return t}}function Se(t){switch(t){case"short":return"#4ade80";case"mid":return"#f59e0b";case"long":return"#818cf8";default:return"#888"}}function ol({goal:t}){return o`
    <div class="goal-row">
      <div class="goal-row-main">
        <div style="display:flex; align-items:center; gap:8px;">
          <span class="goal-horizon-badge" style="color:${Se(t.horizon)}">
            ${rs(t.horizon)}
          </span>
  ...
  `}function on({horizon:t,items:e}){if(e.length===0)return null;const n=[...e].sort((s,a)=>a.priority-s.priority);return o`
    ...
    <div class="goal-filters">
      ...
      <div class="goal-filter-group">
        ...
        ${["all","active","completed","paused"].map(t=>o`
          <button
            class="goal-filter-btn ${Me.value===t?"active":""}"
            onClick=${()=>{Me.value=t}}
          >
  ...
  `}function ll(){const t=Ge.value,e=t.filter(a=>a.status==="active").length,n=t.filter(a=>a.status==="completed").length,s={short:0,mid:0,long:0};for(const a of t)a.horizon in s&&s[a.horizon]++;return o`
    <div class="goal-summary">
      ...
      <div class="goal-summary-item">
        <div class="goal-summary-value" style="color:${Se("short")}">${s.short}</div>
        <div class="goal-summary-label">Short</div>
      </div>
      <div class="goal-summary-item">
        <div class="goal-summary-value" style="color:${Se("mid")}">${s.mid}</div>
        <div class="goal-summary-label">Mid</div>
      </div>
      <div class="goal-summary-item">
        <div class="goal-summary-value" style="color:${Se("long")}">${s.long}</div>
  ...
  `}function cl(){ft(()=>{Fn()},[]);const t=al.value;return o`
    <div>
      ...
      ${Ft.value&&Ge.value.length===0?o`<div class="loading-indicator">Loading goals...</div>`:Ka.value.length===0?o`<div class="empty-state">No goals match the current filters</div>`:o`
            <${on} horizon="short" items=${t.short??[]} />
            <${on} horizon="mid" items=${t.mid??[]} />
            <${on} horizon="long" items=${t.long??[]} />
          `}
    </div>
  `}const kt=_(""),rn=_("ability_check"),ln=_("10"),cn=_("12"),_e=_(""),ge=_("idle"),it=_(""),$e=_("keeper-late"),un=_("player"),dn=_(""),K=_("idle"),pn=_(null),he=_(""),vn=_(""),fn=_("player"),mn=_(""),_n=_(""),gn=_(""),Wt=_("20"),$n=_("20"),hn=_(""),ye=_("idle"),Gn=_(null),qa=_("overview"),yn=_("all"),bn=_("all"),xn=_("all"),ul=12e4,We=_(null),Hs=_(Date.now());function dl(t,e){const n=e>0?t/e*100:0;return n>50?"hp-high":n>25?"hp-mid":"hp-low"}function pl(t,e){return e>0?Math.round(t/e*100):0}const vl={pragmatic:"리스크보다 확실한 이득을 우선합니다.",frugal:"자원 소모를 줄이고 효율을 챙깁니다.",impatient:"짧은 템포로 즉시 압박을 선호합니다.",stubborn:"한 번 정한 전술을 끝까지 밀어붙입니다.",protective:"아군 피해를 줄이는 선택을 우선합니다.","honor-bound":"약속과 규율을 지키는 행동에 보너스가 납니다.",intense:"집중 화력을 짧게 폭발시킵니다.",empathetic:"아군/약자 보호 쪽 선택 확률이 높아집니다.",fatalistic:"위험을 감수하는 고배수 선택을 탑니다.",suspicious:"함정/매복 경계 행동을 우선합니다.",precise:"단일 목표를 정확히 노리는 경향입니다.",vengeful:"직전 위협 대상에게 강하게 반응합니다.",aggressive:"공격적인 전진 행동을 우선합니다.",opportunistic:"빈틈이 열리면 즉시 추격합니다."},fl={supply_scan:"전장/자원 상태를 스캔해 약한 지점을 찾습니다.",ration_shift:"소모를 줄이고 지속 전투 능력을 확보합니다.",logistics_patch:"무너진 운영 라인을 빠르게 복구합니다.",frontline_shield:"전열에서 아군 피해를 흡수합니다.",oath_intercept:"핵심 타깃을 가로막아 위협을 차단합니다.",morale_anchor:"아군 안정도를 높여 붕괴를 막습니다.",omen_trace:"다음 위험 신호를 먼저 감지합니다.",arc_flash:"짧은 순간 광역 압박을 넣습니다.",ward_bloom:"방어 장막을 펼쳐 생존률을 올립니다.",mark_prey:"우선 제거 대상을 지정합니다.",silent_route:"은밀한 진입 경로를 확보합니다.",finisher_strike:"약화된 적을 마무리하는 일격입니다.",shadow_claw:"근접 급습으로 출혈 피해를 노립니다.",lunge:"짧은 돌진으로 전열을 흔듭니다."};function be(t){const e=t.trim();return e?e.split(/[_-]+/g).filter(n=>n.length>0).map(n=>n[0]?`${n[0].toUpperCase()}${n.slice(1)}`:n).join(" "):t}function ml(t){const e=t.trim().toLowerCase();return vl[e]??"행동 선택 가중치에 영향을 주는 성향입니다."}function _l(t){const e=t.trim().toLowerCase();return fl[e]??"상황에 따라 선택되는 전술 액션입니다."}function rt(t){return typeof t=="object"&&t!==null}function H(t,e,n=""){const s=t[e];return typeof s=="string"?s:n}function Q(t,e,n=0){const s=t[e];return typeof s=="number"&&Number.isFinite(s)?s:n}function ie(t,e,n=!1){const s=t[e];return typeof s=="boolean"?s:n}const gl=new Set(["str","dex","con","int","wis","cha"]);function $l(t){const e=t.trim();if(!e)return{};let n;try{n=JSON.parse(e)}catch(a){throw new Error(`능력치 JSON 파싱 실패: ${a instanceof Error?a.message:"invalid json"}`)}if(!rt(n))throw new Error('능력치 JSON은 object여야 합니다. 예: {"luck":7}');const s={};return Object.entries(n).forEach(([a,i])=>{const r=a.trim();if(r){if(typeof i=="number"&&Number.isFinite(i)){s[r]=Math.max(0,Math.trunc(i));return}if(typeof i=="string"){const c=Number.parseFloat(i.trim());if(Number.isFinite(c)){s[r]=Math.max(0,Math.trunc(c));return}}throw new Error(`능력치 '${r}' 값은 숫자여야 합니다.`)}}),s}function hl(t){const e=Number.parseInt(t.trim(),10);if(!Number.isFinite(e))return;const n=Math.max(1,e),s=Number.parseInt(Wt.value.trim(),10);Number.isFinite(s)&&s>n&&(Wt.value=String(n))}function Jn(t){const n=(t.actor_name??t.actor??t.actor_id??"system").trim();return n===""?"system":n}function yl(t){var n;return(((n=t.timestamp)==null?void 0:n.trim())??"")||"-"}function bl(t){qa.value=t}function Ga(t){const e=We.value;return e==null||e<=t}function xl(t){const e=We.value;return e==null||e<=t?0:Math.max(0,Math.ceil((e-t)/1e3))}function Fe(){We.value=null}function Ja(t){return typeof window>"u"||typeof window.confirm!="function"?!0:window.confirm(t)}function kl(t,e){Ja(["관전 모드 잠금을 해제하시겠습니까?",`ROOM: ${t||"-"}`,`PHASE: ${e||"-"}`,"해제 시간: 120초 (시간 경과 또는 위험 액션 실행 후 자동 재잠금)"].join(`
`))&&(We.value=Date.now()+ul,b("조작 잠금이 120초 동안 해제되었습니다.","warning"))}function Ce(t){return Ga(t)?(b("관전 모드 잠금 상태입니다. 먼저 잠금을 해제하세요.","warning"),!1):!0}function Wn(t,e,n){return Ja([`[위험 액션 확인] ${t}`,`ROOM: ${e||"-"}`,`PHASE: ${n||"-"}`,"이 액션은 즉시 실행되며 되돌리기 어렵습니다.","계속 진행하시겠습니까?"].join(`
`))}function wl({hp:t,max:e}){const n=pl(t,e),s=dl(t,e);return o`
    <div class="trpg-hp-bar">
      <div class="hp-fill ${s}" style="width:${n}%" />
    </div>
  `}function Sl({stats:t}){const e=[{label:"STR",value:t.strength},{label:"DEX",value:t.dexterity},{label:"CON",value:t.constitution},{label:"INT",value:t.intelligence},{label:"WIS",value:t.wisdom},{label:"CHA",value:t.charisma}];return o`
    <div class="trpg-actor-stats">
      ${e.map(n=>o`<span>${n.label} ${n.value}</span>`)}
    </div>
  `}function Cl({keeper:t,role:e}){if(!t)return null;const n=e==="dm"?"dm":"player";return o`
  ...
  `}function Wa({actor:t}){var u,p,f,l;const e=(u=t.archetype)==null?void 0:u.trim(),n=(p=t.persona)==null?void 0:p.trim(),s=(f=t.portrait)==null?void 0:f.trim(),a=(l=t.background)==null?void 0:l.trim(),i=t.traits??[],r=t.skills??[],c=Object.entries(t.stats_raw??{}).filter(([d,v])=>Number.isFinite(v)).filter(([d])=>!gl.has(d.toLowerCase()));return o`
    <div class="trpg-actor">
      ...
      <div class="trpg-actor-header">
        ...
        <${Cl} keeper=${t.keeper} role=${t.role} />
      </div>
      ${t.stats?o`
          <div style="margin-top:4px;">
            ...
            <${wl} hp=${t.stats.hp} max=${t.stats.max_hp} />
            <${Sl} stats=${t.stats} />
          </div>
        `:null}
      ...
      ${c.length>0?o`
          <div class="trpg-annot-group">
            ...
            <div class="trpg-custom-stats">
              ${c.map(([d,v])=>o`
                <span class="trpg-custom-stat-chip">${be(d)} ${v}</span>
              `)}
            </div>
          </div>
        `:null}
            ...
            <div class="trpg-annot-list">
              ${i.map(d=>o`
                <span class="trpg-annot-chip trait">
                  <span class="trpg-annot-name">${be(d)}</span>
  ...
  `}function Al({mapStr:t}){return o`<pre class="trpg-map">${t}</pre>`}function Va({events:t,emptyLabel:e="아직 이벤트가 없습니다."}){return t.length===0?o`<div class="empty-state" style="font-size:13px">${e}</div>`:o`
    <div class="trpg-story" role="list" aria-label="TRPG story events">
      ${t.map((n,s)=>{var a;return o`
        <div key=${s} class="trpg-event ${n.type??""}" role="listitem">
          <div class="trpg-event-meta-row">
            <span class="trpg-event-meta">${yl(n)}</span>
  ...
  `}function Nl({events:t}){const e="__none__",n=yn.value,s=bn.value,a=xn.value,i=Array.from(new Set(t.map(Jn).map(l=>l.trim()).filter(l=>l!==""))).sort((l,d)=>l.localeCompare(d)),r=Array.from(new Set(t.map(l=>(l.type??"").trim()).filter(l=>l!==""))).sort((l,d)=>l.localeCompare(d)),c=t.some(l=>(l.type??"").trim()===""),u=Array.from(new Set(t.map(l=>(l.phase??"").trim()).filter(l=>l!==""))).sort((l,d)=>l.localeCompare(d)),p=t.some(l=>(l.phase??"").trim()===""),f=t.filter(l=>{if(n!=="all"&&Jn(l)!==n)return!1;const d=(l.type??"").trim(),v=(l.phase??"").trim();if(s===e){if(d!=="")return!1}else if(s!=="all"&&d!==s)return!1;if(a===e){if(v!=="")return!1}else if(a!=="all"&&v!==a)return!1;return!0});return o`
  ...
  `}function Rl({state:t,nowMs:e}){var p;const n=st.value||((p=t.session)==null?void 0:p.room)||"",s=ge.value,a=t.party??[];if(!a.find(f=>f.id===kt.value)&&a.length>0){const f=a[0];f&&(kt.value=f.id)}const r=async()=>{var l,d;if(!n){b("Room ID가 비어 있습니다.","error");return}if(!Ce(e))return;const f=((l=t.current_round)==null?void 0:l.phase)??((d=t.session)==null?void 0:d.status)??"unknown";if(Wn("라운드 실행",n,f)){ge.value="running";try{const v=await xo(n);Gn.value=v,ge.value="ok";const $=rt(v.summary)?v.summary:null,x=$?ie($,"advanced",!1):!1,S=$?H($,"progress_reason",""):"";b(x?"라운드가 정상 진행되었습니다.":`라운드가 정체되었습니다${S?`: ${S}`:""}`,x?"success":"warning"),at()}catch(v){Gn.value=null,ge.value="error";const $=v instanceof Error?v.message:"라운드 실행에 실패했습니다.";b($,"error")}finally{Fe()}}},c=async()=>{var l,d;if(!n||!Ce(e))return;const f=((l=t.current_round)==null?void 0:l.phase)??((d=t.session)==null?void 0:d.status)??"unknown";if(Wn("턴 강제 진행",n,f))try{await So(n),b("턴을 다음 단계로 이동했습니다.","success"),at()}catch{b("턴 이동에 실패했습니다.","error")}finally{Fe()}},u=async()=>{if(!n||!Ce(e))return;const f=kt.value.trim();if(!f){b("먼저 Actor를 선택하세요.","warning");return}const l=Number.parseInt(ln.value,10),d=Number.parseInt(cn.value,10);if(Number.isNaN(l)||Number.isNaN(d)){b("stat/dc는 숫자여야 합니다.","warning");return}const v=Number.parseInt(_e.value,10),$=_e.value.trim()===""||Number.isNaN(v)?void 0:v;try{await wo({roomId:n,actorId:f,action:rn.value.trim()||"ability_check",statValue:l,dc:d,rawD20:$}),b("주사위 판정을 기록했습니다.","success"),at()}catch{b("주사위 판정 기록에 실패했습니다.","error")}};return o`
        ...
        <div class="trpg-control-field">
          ...
          <div style="display:grid; grid-template-columns: 1fr 1fr; gap:6px;">
            ...
            <input
              ...
              type="text"
              value=${cn.value}
              onInput=${f=>{cn.value=f.target.value}}
            ...
            <input
              ...
              type="text"
              value=${_e.value}
              onInput=${f=>{_e.value=f.target.value}}
  ...
  `}function Ll({state:t}){var a;const e=st.value||((a=t.session)==null?void 0:a.room)||"",n=ye.value,s=async()=>{if(!e){b("Room ID가 비어 있습니다.","warning");return}const i=he.value.trim(),r=vn.value.trim();if(!r&&!i){b("이름 또는 Actor ID를 입력하세요.","warning");return}const c=Number.parseInt(Wt.value.trim(),10),u=Number.parseInt($n.value.trim(),10),p=Number.isFinite(u)?Math.max(1,u):20,f=Number.isFinite(c)?Math.max(0,Math.min(p,c)):p;let l={};try{l=$l(hn.value)}catch(d){b(d instanceof Error?d.message:"능력치 JSON 오류","error");return}ye.value="spawning";try{const d=await Co(e,{actor_id:i||void 0,name:r||void 0,role:fn.value,portrait:_n.value.trim()||void 0,background:gn.value.trim()||void 0,hp:f,max_hp:p,alive:f>0,stats:Object.keys(l).length>0?l:void 0}),v=typeof d.actor_id=="string"?d.actor_id.trim():"";if(!v)throw new Error("생성 응답에 actor_id가 없습니다.");const $=mn.value.trim();$&&await Ao(e,v,$),kt.value=v,it.value=v,i||(he.value=""),ye.value="ok",b(`Actor 생성 완료: ${v}`,"success"),await at()}catch(d){ye.value="error",b(d instanceof Error?d.message:"Actor 생성에 실패했습니다.","error")}};return o`
    <div class="trpg-control-box">
      <div class="trpg-control-grid">
        <div class="trpg-control-field">
          <label>Name</label>
          <input
            ...
            type="text"
            value=${vn.value}
            onInput=${i=>{vn.value=i.target.value}}
        ...
        <div class="trpg-control-grid">
          <div class="trpg-control-field">
            ...
            <input
              ...
              type="text"
              value=${he.value}
              onInput=${i=>{he.value=i.target.value}}
          ...
          <div class="trpg-control-field">
            ...
            <input
              ...
              min="0"
              value=${Wt.value}
              onInput=${i=>{Wt.value=i.target.value}}
              placeholder="20"
            />
          </div>
          <div class="trpg-control-field">
            ...
            <input
              ...
              min="1"
              value=${$n.value}
              onInput=${i=>{const r=i.target.value;$n.value=r,hl(r)}}
              placeholder="20"
            />
          </div>
  ...
  `}function El({state:t,nowMs:e}){var d;const n=st.value||((d=t.session)==null?void 0:d.room)||"",s=t.join_gate,a=pn.value,i=rt(a)?a:null,r=(t.party??[]).filter(v=>v.role!=="dm"),c=it.value.trim(),u=r.some(v=>v.id===c),p=u?c:c?"__manual__":"",f=async()=>{const v=it.value.trim(),$=$e.value.trim();if(!n||!v){b("Room/Actor가 필요합니다.","warning");return}K.value="checking";try{const x=await No(n,v,$||void 0);pn.value=x,K.value="ok",b("참가 가능 여부를 갱신했습니다.","success")}catch(x){K.value="error";const S=x instanceof Error?x.message:"참가 가능 여부 확인에 실패했습니다.";b(S,"error")}},l=async()=>{var A,C;const v=it.value.trim(),$=$e.value.trim(),x=dn.value.trim();if(!n||!v||!$){b("Room/Actor/Keeper가 필요합니다.","warning");return}if(!Ce(e))return;const S=((A=t.current_round)==null?void 0:A.phase)??((C=t.session)==null?void 0:C.status)??"unknown";if(Wn("Mid-Join 승인 요청",n,S)){K.value="requesting";try{const D=await To({room_id:n,actor_id:v,keeper_name:$,role:un.value,...x?{name:x}:{}});pn.value=D;const M=rt(D)?ie(D,"granted",!1):!1,E=rt(D)?H(D,"reason_code",""):"";M?b("Mid-Join이 승인되었습니다.","success"):b(`Mid-Join이 거절되었습니다${E?`: ${E}`:""}`,"warning"),K.value=M?"ok":"error",at()}catch(D){K.value="error";const M=D instanceof Error?D.message:"Mid-Join 요청에 실패했습니다.";b(M,"error")}finally{Fe()}}};return o`
    <div class="trpg-control-box">
      ...
      <div class="trpg-control-grid">
        ...
        <div class="trpg-control-field">
          ...
          <input
            ...
            type="text"
            value=${$e.value}
            onInput=${v=>{$e.value=v.target.value}}
            placeholder="keeper-name"
          />
        </div>
        <div class="trpg-control-field">
          ...
          <select
            value=${un.value}
            onChange=${v=>{un.value=v.target.value}}
          >
            <option value="player">player</option>
            <option value="npc">npc</option>
            <option value="dm">dm</option>
      ...
      ${i?o`
          <div style="margin-top:8px; font-size:12px; color:#d1d5db;">
            Eligible: <strong>${ie(i,"eligible",!1)?"YES":"NO"}</strong>
  ...
  `:null}function Za(){const t=Gn.value;if(!t)return o`<div class="empty-state" style="font-size:13px;">Run Round 결과가 아직 없습니다.</div>`;const e=t.summary,n=rt(e)?e:null,a=(Array.isArray(t.statuses)?t.statuses:[]).filter(rt).slice(-8),i=t.canon_check,r=rt(i)?i:null,c=r&&Array.isArray(r.warnings)?r.warnings.filter(E=>typeof E=="string").slice(0,3):[],u=r&&Array.isArray(r.violations)?r.violations.filter(E=>typeof E=="string").slice(0,3):[],p=n?ie(n,"advanced",!1):!1,f=n?H(n,"progress_reason",""):"",l=n?H(n,"progress_detail",""):"",d=n?Q(n,"player_successes",0):0,v=n?Q(n,"player_required_successes",0):0,$=n?ie(n,"dm_success",!1):!1,x=n?Q(n,"timeouts",0):0,S=n?Q(n,"unavailable",0):0,A=n?Q(n,"reprompts",0):0,C=n?Q(n,"npc_attacks",0):0,D=n?Q(n,"keeper_timeout_sec",0):0,M=n?Q(n,"roll_audit_count",0):0;return o`
    <div style="display:grid; gap:10px;">
      ...
      ${a.length>0?o`
          <div class="trpg-round-list">
            ${a.map(E=>{const q=H(E,"status","unknown"),ut=H(E,"actor_id","-"),dt=H(E,"role","-"),G=H(E,"reason",""),et=H(E,"action_type",""),R=H(E,"reply","");return o`
  ...
  `}function Dl({state:t,nowMs:e}){var r,c,u;const n=st.value||((r=t.session)==null?void 0:r.room)||"",s=((c=t.current_round)==null?void 0:c.phase)??((u=t.session)==null?void 0:u.status)??"unknown",a=Ga(e),i=xl(e);return o`
    <${y} title="조작 안전 잠금" style="margin-bottom:16px;">
      <div class="trpg-control-lock ${a?"locked":"unlocked"}">
        ...
        <div style="display:flex; gap:8px; margin-top:10px; flex-wrap:wrap;">
          ${a?o`<button class="trpg-run-btn recommend" onClick=${()=>kl(n,s)}>잠금 해제 (120초)</button>`:o`<button class="trpg-run-btn secondary" onClick=${()=>{Fe(),b("조작 잠금으로 전환했습니다.","success")}}>즉시 다시 잠금</button>`}
        </div>
      </div>
    <//>
  `}function Pl({active:t}){return o`
  ...
  `}function Il({state:t}){const e=t.party??[],n=t.story_log??[];return o`
  ...
  `}function Ol({state:t}){const e=t.story_log??[];return o`
    <div class="trpg-layout">
      <div>
  ...
  `}function Ml(){var c,u,p,f,l;const t=Ia.value,e=jn.value;if(ft(()=>{if(typeof window>"u"||typeof window.setInterval!="function")return;const d=window.setInterval(()=>{Hs.value=Date.now()},1e3);return()=>{window.clearInterval(d)}},[]),e&&!t)return o`<div class="loading-indicator">Loading TRPG state...</div>`;if(!t)return o`
      <div class="section">
        <h2>TRPG</h2>
        <div class="empty-state">No active TRPG session</div>
        <button class="board-sort-btn" onClick=${()=>at()}>Refresh</button>
      </div>
    `;const n=t.party??[],s=t.story_log??[],a=t.outcome,i=qa.value,r=Hs.value;return o`
    <div>
      ...
      ${i==="overview"?o`<${Il} state=${t} />`:i==="timeline"?o`<${Ol} state=${t} />`:o`<${jl} state=${t} nowMs=${r} />`}
    </div>
  `}const ls="masc_dashboard_agent_name";function Fl(){const t=new URLSearchParams(window.location.search),e=t.get("agent")??t.get("agent_name"),n=localStorage.getItem(ls);return e??n??"dashboard"}const Y=_(Fl()),Vt=_(""),Yt=_(""),ze=_(""),Qt=_(!1),wt=_(!1),Xt=_(!1),Zt=_(!1),He=_(!1),Ve=_(!1);function cs(t){const e=t.trim();Y.value=e,e&&localStorage.setItem(ls,e)}function zl(t){const n=(t.split(`
`).find(s=>s.includes(" joined"))??t).match(/✅\s+(\S+)\s+joined/i);return(n==null?void 0:n[1])??null}async function Vn(){const t=Y.value.trim();if(t){Xt.value=!0;try{const e=await Lo(t),n=zl(e);n&&cs(n),Ve.value=!0,b(`Joined as ${n??t}`,"success")}catch(e){const n=e instanceof Error?e.message:"Failed to join room";b(n,"error")}finally{Xt.value=!1}}}async function Hl(){const t=Y.value.trim();if(t){Zt.value=!0;try{await Ea(t),Ve.value=!1,b(`Left room (${t})`,"success")}catch(e){const n=e instanceof Error?e.message:"Failed to leave room";b(n,"error")}finally{Zt.value=!1}}}async function Ul(){const t=Y.value.trim();if(t)try{await Ea(t)}catch{}localStorage.removeItem(ls),cs("dashboard"),Ve.value=!1,await Vn()}async function Bl(){const t=Y.value.trim();if(t){He.value=!0;try{await Eo(t),b("Heartbeat sent","success")}catch(e){const n=e instanceof Error?e.message:"Failed to send heartbeat";b(n,"error")}finally{He.value=!1}}}async function Us(){const t=Y.value.trim(),e=Vt.value.trim();if(!(!t||!e)){Qt.value=!0;try{await La(t,e),Vt.value="",b("Broadcast sent","success")}catch(n){const s=n instanceof Error?n.message:"Failed to send broadcast";b(s,"error")}finally{Qt.value=!1}}}async function Kl(){const t=Yt.value.trim(),e=ze.value.trim()||"Created from dashboard";if(t){wt.value=!0;try{await Ro(t,e,1),Yt.value="",ze.value="",b("Task created","success")}catch(n){const s=n instanceof Error?n.message:"Failed to create task";b(s,"error")}finally{wt.value=!1}}}function ql(){return ft(()=>{Vn()},[]),o`
    <section class="rail-card control-dock">
      ...
      <div class="control-row">
        <input
          ...
          onKeyDown=${t=>{t.key==="Enter"&&Us()}}
          disabled=${Qt.value}
        />
        <button
          class="control-btn"
          onClick=${Us}
          disabled=${Qt.value||Vt.value.trim()===""||Y.value.trim()===""}
        >
          ${Qt.value?"Sending...":"Send"}
        </button>
      </div>
      ...
      <div class="control-row">
        ...
        >
          ${Xt.value?"Joining...":Ve.value?"Rejoin":"Join"}
        </button>
        <button
          class="control-btn ghost"
          onClick=${()=>{Hl()}}
      ...
      <textarea
        ...
        value=${ze.value}
        onInput=${t=>{ze.value=t.target.value}}
        disabled=${wt.value}
      ></textarea>
      <button
        class="control-btn secondary"
        onClick=${Kl}
        disabled=${wt.value||Yt.value.trim()===""}
      >
        ${wt.value?"Creating...":"Create Task"}
      </button>
    </section>
  `}function Gl(){const t=Nt.value;return o`
    <div class="connection-status ${t?"connected":"disconnected"}">
      <span class="status-dot ${t?"connected":"disconnected"}"></span>
      <span class="status-text">${t?"Live":"Reconnecting..."}</span>
      <span class="event-count">${ns.value} events</span>
    </div>
  `}function Jl(){const t=Z.value.tab,e=Nt.value;return o`
    <aside class="dashboard-rail">
      ...
      <section class="rail-card">
        ...
        <button
          ...
          onClick=${()=>{Je(),t==="board"&&$t(),t==="trpg"&&at()}}
        >
          Refresh Now
        </button>
      </section>
  ...
  `}function Wl(){switch(Z.value.tab){case"overview":return o`<${Is} />`;case"council":return o`<${Tr} />`;case"board":return o`<${Fr} />`;case"execution":return o`<${el} />`;case"activity":return o`<${Br} />`;case"agents":return o`<${Xr} />`;case"tasks":return o`<${Zr} />`;case"goals":return o`<${cl} />`;case"journal":return o`<${sl} />`;case"trpg":return o`<${Ml} />`;default:return o`<${Is} />`}}function Vl(){return ft(()=>{Oi(),wa(),Je();const t=Qo();return Xo(),()=>{Ki(),t(),Zo()}},[]),ft(()=>{const t=Z.value.tab;t==="board"&&$t(),t==="trpg"&&at(),t==="goals"&&Fn()},[Z.value.tab]),o`
    <div class="app-shell">
      ...
      <div class="dashboard-layout">
        <main class="dashboard-main">
          ${In.value&&!Nt.value?o`<div class="loading-indicator">Loading dashboard...</div>`:o`<${Wl} />`}
        </main>
        <${Jl} />
      </div>
  ...
  `}const Bs=document.getElementById("app");Bs&&hi(o`<${Vl} />`,Bs);
