...
OAS Pin Snapshot: dependency floor `0.121.0`, runtime pin `main@3e145b74c3fac808e74d7456f659d78cd4f0667b`, declared base version `v0.121.0`
...
`masc-mcp` keeps the runtime pin ratcheted against upstream `main`, while the dependency floor tracks the pinned SDK declaration in `agent_sdk.opam`. Generated snapshot: runtime pin `main@3e145b74c3fac808e74d7456f659d78cd4f0667b`, declared base version `v0.121.0`, dependency floor `0.121.0`.
