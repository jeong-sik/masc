var yc=Object.defineProperty;var bc=(e,t,n)=>t in e?yc(e,t,{enumerable:!0,configurable:!0,writable:!0,value:n}):e[t]=n;var Rt=(e,t,n)=>bc(e,typeof t!="symbol"?t+"":t,n);import{e as kc,_ as xc,c as g,b as Se,y as te,d as rr,A as Sc,G as Ac}from"./vendor-kuFK4-oj.js";(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const a of document.querySelectorAll('link[rel="modulepreload"]'))s(a);new MutationObserver(a=>{for(const o of a)if(o.type==="childList")for(const l of o.addedNodes)l.tagName==="LINK"&&l.rel==="modulepreload"&&s(l)}).observe(document,{childList:!0,subtree:!0});function n(a){const o={};return a.integrity&&(o.integrity=a.integrity),a.referrerPolicy&&(o.referrerPolicy=a.referrerPolicy),a.crossOrigin==="use-credentials"?o.credentials="include":a.crossOrigin==="anonymous"?o.credentials="omit":o.credentials="same-origin",o}function s(a){if(a.ep)return;a.ep=!0;const o=n(a);fetch(a.href,o)}})();var i=kc.bind(xc);const Cc=["mission","proof","execution","live","memory","governance","planning","intervene","command","lab"],lr={tab:"mission",params:{},postId:null};function fo(e){return!!e&&Cc.includes(e)}function ri(e){try{return decodeURIComponent(e)}catch{return e}}function li(e){const t={};return e&&new URLSearchParams(e).forEach((s,a)=>{t[a]=s}),t}function Ic(e){const n=e.replace(/^\/+/,"").split("/").filter(Boolean);return n[0]==="dashboard"?n.slice(1):n}function cr(e,t){if(e[0]==="chains"){const o={...t,surface:"chains"};return e[1]==="operation"&&e[2]&&(o.operation=ri(e[2])),{tab:"command",params:o,postId:null}}if(e[0]==="lab"){const o={...t};return e[1]&&(o.surface=ri(e[1])),{tab:"lab",params:o,postId:null}}const n=e[0],s=t.tab;return{tab:fo(n)?n:fo(s)?s:"mission",params:t,postId:null}}function js(e){const t=(e||"").replace(/^#/,"").trim();if(!t)return lr;const n=ri(t);let s=n,a;if(n.startsWith("?"))s="",a=n.slice(1);else{const c=n.indexOf("?");c>=0&&(s=n.slice(0,c),a=n.slice(c+1))}!a&&s.includes("=")&&!s.includes("/")&&(a=s,s="");const o=li(a),l=Ic(s);return cr(l,o)}function Tc(e,t){const n=e.replace(/^\/+/,"").split("/").filter(Boolean);if(n[0]!=="dashboard")return null;const s=n.slice(1);if(s.length===0)return{...lr,params:li(t.replace(/^\?/,""))};if(s[0]==="assets"||s[0]==="credits"||s[0]==="lodge")return null;const a=li(t.replace(/^\?/,""));return cr(s,a)}function dr(e){const t=e.tab==="lab"&&e.params.surface?`lab/${encodeURIComponent(e.params.surface)}`:e.tab,n=Object.entries(e.params).filter(([a])=>!(a==="tab"||e.tab==="lab"&&a==="surface"));if(n.length===0)return`#${t}`;const s=new URLSearchParams(n);return`#${t}?${s.toString()}`}const F=g(js(window.location.hash));window.addEventListener("hashchange",()=>{F.value=js(window.location.hash)});function ce(e,t){const n={tab:e,params:t??{}};window.location.hash=dr(n)}function Rc(e){window.location.hash=`#memory?post=${encodeURIComponent(e)}`}function wc(){if(window.location.hash&&window.location.hash!=="#"){F.value=js(window.location.hash);return}const e=Tc(window.location.pathname,window.location.search);if(e){F.value=e;const t=dr(e);window.history.replaceState(null,"",`${window.location.pathname}${window.location.search}${t}`);return}window.location.hash="#mission",F.value=js(window.location.hash)}const $o="masc_dashboard_sse_session_id",Pc=1e3,Nc=15e3,nt=g(!1),ha=g(0),ur=g(null),Es=g([]);function Lc(){let e=sessionStorage.getItem($o);return e||(e=typeof crypto.randomUUID=="function"?`dash_${crypto.randomUUID()}`:`dash_${Date.now().toString(36)}_${Math.random().toString(36).slice(2,10)}`,sessionStorage.setItem($o,e)),e}const zc=200;function Mc(e,t,n="system",s={}){const a={agent:e,text:t,timestamp:Date.now(),kind:n,...s};Es.value=[a,...Es.value].slice(0,zc)}function ci(e,t=88){const n=(e??"").replace(/\s+/g," ").trim();return n?n.length>t?`${n.slice(0,t-3)}...`:n:void 0}function ho(e,t){const n=ci(t);return n?`${e}: ${n}`:`New ${e.toLowerCase()}`}function xe(e,t,n,s,a={}){Mc(e,t,n,{eventType:s,...a})}let we=null,Kt=null,di=0;function pr(){Kt&&(clearTimeout(Kt),Kt=null)}function jc(){if(Kt)return;di++;const e=Math.min(di,5),t=Math.min(Nc,Pc*Math.pow(2,e));Kt=setTimeout(()=>{Kt=null,mr()},t)}function mr(){pr(),we&&(we.close(),we=null);const e=new URLSearchParams(window.location.search),t=new URLSearchParams,n=e.get("agent")??e.get("agent_name"),s=e.get("token");n&&t.set("agent",n),s&&t.set("token",s),t.set("session_id",Lc());const a=t.toString()?`/sse?${t.toString()}`:"/sse",o=new EventSource(a);we=o,o.onopen=()=>{we===o&&(di=0,nt.value=!0)},o.onerror=()=>{we===o&&(nt.value=!1,o.close(),we=null,jc())},o.onmessage=l=>{try{const c=JSON.parse(l.data);ha.value++,ur.value=c,Ec(c)}catch{}}}function Ec(e){const t=e.type,n=e.agent??e.author??e.from??e.from_agent??"";switch(t){case"agent_joined":xe(n,"Joined","system","agent_joined");break;case"agent_left":xe(n,"Left","system","agent_left");break;case"broadcast":xe(n,`${(e.message??e.content??"").slice(0,80)}`,"system","broadcast");break;case"task_update":xe(n,`Task: ${e.task_id??""} -> ${e.status??""}`,"tasks","task_update");break;case"board_post":case"masc/board_post":xe(n,ho("Post",e.content??e.message),"board","board_post",{author:e.author??n,preview:ci(e.content??e.message),postId:e.post_id});break;case"board_comment":case"masc/board_comment":xe(n,ho("Comment",e.content??e.message),"board","board_comment",{author:e.author??n,preview:ci(e.content??e.message),postId:e.post_id});break;case"keeper_heartbeat":xe(e.name??n,`Heartbeat gen=${e.generation??"?"} ctx=${e.context_ratio!=null?Math.round(e.context_ratio*100)+"%":"?"}`,"keepers","keeper_heartbeat");break;case"keeper_handoff":xe(e.name??n,`Handoff gen ${e.from_generation??"?"} -> ${e.to_generation??"?"} (${e.to_model??"?"})`,"keepers","keeper_handoff");break;case"keeper_compaction":xe(e.name??n,`Compaction saved ${e.saved_tokens??"?"} tokens (${e.trigger??"?"})`,"keepers","keeper_compaction");break;case"keeper_guardrail":xe(e.name??n,`Guardrail: ${e.reason??"stopped"}`,"keepers","keeper_guardrail");break;default:xe(n,t,"system","unknown")}}function Dc(){pr(),we&&(we.close(),we=null),nt.value=!1}function v(e){return typeof e=="object"&&e!==null&&!Array.isArray(e)}function r(e){return typeof e=="string"&&e.trim()!==""?e.trim():void 0}function d(e){return typeof e=="number"&&Number.isFinite(e)?e:void 0}function E(e){return typeof e=="boolean"?e:void 0}function W(e){return Array.isArray(e)?e.map(t=>typeof t=="string"?t.trim():"").filter(Boolean):[]}function ue(e,t=[]){if(Array.isArray(e))return e;if(!v(e))return[];for(const n of t){const s=e[n];if(Array.isArray(s))return s}return[]}function st(e){if(typeof e=="string"&&e.trim()!=="")return e;if(!(typeof e!="number"||!Number.isFinite(e)||e<=0))return new Date(e*1e3).toISOString()}function vr(){return new URLSearchParams(window.location.search)}const Oc="masc_dashboard_agent_name";function qc(){var e;try{return((e=localStorage.getItem(Oc))==null?void 0:e.trim())||null}catch{return null}}function _r(){const e=vr(),t={},n=e.get("token"),s=qc(),a=e.get("agent")??e.get("agent_name")??s;return n&&(t.Authorization=`Bearer ${n}`),a&&(t["X-MASC-Agent"]=a),t}function gr(){return{..._r(),"Content-Type":"application/json"}}const Fc=15e3,ji=3e4,Kc=6e4,yo=new Set([408,425,429,500,502,503,504]);class Gn extends Error{constructor(n){const s=n.method.toUpperCase(),a=n.timeout===!0,o=a?`${s} ${n.path}: timeout after ${n.timeoutMs??0}ms`:`${s} ${n.path}: ${n.status??"unknown"} ${n.statusText??""}`.trim();super(o);Rt(this,"method");Rt(this,"path");Rt(this,"status");Rt(this,"statusText");Rt(this,"timeout");this.name="ApiRequestError",this.method=s,this.path=n.path,this.status=n.status,this.statusText=n.statusText,this.timeout=a}}async function Ei(e,t,n){const s=new AbortController,a=setTimeout(()=>s.abort(),n);try{return await fetch(e,{...t,signal:s.signal})}catch(o){if(o instanceof Error&&o.name==="AbortError"){const l=typeof t.method=="string"?t.method.toUpperCase():"GET";throw new Gn({method:l,path:e,timeout:!0,timeoutMs:n})}throw o}finally{clearTimeout(a)}}function Bc(){var t,n;const e=vr();return((t=e.get("agent"))==null?void 0:t.trim())||((n=e.get("agent_name"))==null?void 0:n.trim())||"dashboard-user"}async function Z(e){const t=await Ei(e,{headers:_r()},Fc);if(!t.ok)throw new Gn({method:"GET",path:e,status:t.status,statusText:t.statusText});return t.json()}function Uc(e){return new Promise(t=>setTimeout(t,e))}function Hc(e){const t=e.match(/\b(\d{3})\b/);if(!t)return null;const n=t[1];if(!n)return null;const s=Number.parseInt(n,10);return Number.isFinite(s)?s:null}function Wc(e){if(e instanceof Gn)return e.timeout||typeof e.status=="number"&&yo.has(e.status);if(!(e instanceof Error))return!1;if(/timeout after \d+ms/i.test(e.message))return!0;const t=Hc(e.message);return t!==null&&yo.has(t)}async function ya(e,t,n=2){let s=0;for(;;)try{return await t()}catch(a){if(!Wc(a)||s>=n)throw a;const o=250*(s+1);console.warn(`[dashboard/api] ${e} failed (attempt ${s+1}), retrying in ${o}ms`,a),await Uc(o),s+=1}}async function Me(e,t,n,s=ji){const a=await Ei(e,{method:"POST",headers:{...gr(),...n??{}},body:JSON.stringify(t)},s);if(!a.ok)throw new Gn({method:"POST",path:e,status:a.status,statusText:a.statusText});return a.json()}async function Gc(e,t,n,s=ji){const a=await Ei(e,{method:"POST",headers:{...gr(),...n??{}},body:JSON.stringify(t)},s);if(!a.ok)throw new Gn({method:"POST",path:e,status:a.status,statusText:a.statusText});return a.text()}function Jc(e){const t=e.split(`
`).find(s=>s.startsWith("data: ")),n=t?t.slice(6).trim():e.trim();return JSON.parse(n)}function Vc(e){var t,n,s,a,o,l,c;if((t=e.error)!=null&&t.message)throw new Error(e.error.message);if((n=e.result)!=null&&n.isError){const p=((a=(s=e.result.content)==null?void 0:s[0])==null?void 0:a.text)??"MCP tool call failed";throw new Error(p)}return((c=(l=(o=e.result)==null?void 0:o.content)==null?void 0:l[0])==null?void 0:c.text)??""}async function rt(e,t){const n=await Gc("/mcp",{jsonrpc:"2.0",method:"tools/call",params:{name:e,arguments:t},id:Math.floor(Date.now()%1e6)},{Accept:"application/json, text/event-stream"},Kc),s=Jc(n);return Vc(s)}function Yc(){return Z("/api/v1/dashboard/shell")}function Qc(){return Z("/api/v1/dashboard/execution")}function Xc(e,t){const n=new URLSearchParams;return n.set("sort_by",e),t!=null&&t.excludeSystem&&n.set("exclude_system","true"),Z(`/api/v1/dashboard/memory${n.toString()?`?${n}`:""}`)}function Zc(){return ya("fetchDashboardGovernance",async()=>{const e=await Z("/api/v1/dashboard/governance"),t=Array.isArray(e.items)?e.items.map(o=>_d(o)).filter(o=>o!==null):[],n=Array.isArray(e.pending_actions)?e.pending_actions.map(o=>hr(o)).filter(o=>o!==null):[],s=t.filter(o=>o.kind==="debate").map(o=>({id:o.id,topic:o.topic,status:o.status,argument_count:o.evidence_refs.length,created_at:o.last_activity_at??void 0})),a=t.filter(o=>o.kind==="consensus").map(o=>({id:o.id,topic:o.topic,initiator:o.related_agents[0]||"system",votes:o.votes??0,quorum:o.quorum??0,threshold:o.threshold,state:o.status,created_at:o.last_activity_at??void 0}));return{generated_at:oe(e.generated_at)??void 0,summary:v(e.summary)?{debates:pe(e.summary.debates)??void 0,voting_sessions:pe(e.summary.voting_sessions)??void 0,debates_open:pe(e.summary.debates_open)??void 0,sessions_active:pe(e.summary.sessions_active)??void 0,sessions_without_quorum:pe(e.summary.sessions_without_quorum)??void 0,ready_to_execute:pe(e.summary.ready_to_execute)??void 0,oldest_open_debate_age_s:typeof e.summary.oldest_open_debate_age_s=="number"?e.summary.oldest_open_debate_age_s:null,last_activity_age_s:typeof e.summary.last_activity_age_s=="number"?e.summary.last_activity_age_s:null,judge_online:typeof e.summary.judge_online=="boolean"?e.summary.judge_online:void 0,judge_last_seen_at:oe(e.summary.judge_last_seen_at)}:void 0,debates:s,sessions:a,items:t,activity:Array.isArray(e.activity)?e.activity.map(o=>gd(o)).filter(o=>o!==null):[],judge:fd(e.judge),pending_actions:n}})}function ed(){return Z("/api/v1/dashboard/semantics")}function td(){return Z("/api/v1/dashboard/mission")}function nd(e){const t=`?session_id=${encodeURIComponent(e)}`;return Z(`/api/v1/dashboard/session${t}`)}function sd(e=!1){return Z(`/api/v1/dashboard/mission/briefing${e?"?force=1":""}`)}function ad(e,t){const n=new URLSearchParams;e&&n.set("session_id",e),t&&n.set("operation_id",t);const s=n.toString();return Z(`/api/v1/dashboard/proof${s?`?${s}`:""}`)}function id(){return Z("/api/v1/dashboard/planning")}function od(){return Z("/api/v1/operator")}function fr(e={}){const t=new URLSearchParams;e.targetType&&t.set("target_type",e.targetType),e.targetId&&t.set("target_id",e.targetId),e.includeWorkers!=null&&t.set("include_workers",e.includeWorkers?"true":"false");const n=t.toString();return Z(`/api/v1/operator/digest${n?`?${n}`:""}`)}function rd(){return Z("/api/v1/command-plane")}function ld(){return Z("/api/v1/command-plane/summary")}function cd(){return Z("/api/v1/chains/summary")}function dd(e){return Z(`/api/v1/chains/runs/${encodeURIComponent(e)}`)}function ud(){return Z("/api/v1/command-plane/help")}function pd(e,t){const n=new URLSearchParams;e&&n.set("run_id",e),t&&n.set("operation_id",t);const s=n.toString();return Z(`/api/v1/command-plane/swarm${s?`?${s}`:""}`)}function md(e,t){return Me(e,t)}function vd(e){switch(e.action_type){case"keeper_message":case"keeper_recover":return 9e4;case"swarm_run_continue":return 6e4;case"swarm_run_rerun":return 12e4;case"swarm_run_abandon":return 3e4;case"lodge_tick":return 45e3;default:return ji}}function ba(e){return Me("/api/v1/operator/action",e,void 0,vd(e))}function $r(e,t,n="confirm"){return Me("/api/v1/operator/confirm",{actor:e,confirm_token:t,decision:n})}function Ss(e){if(typeof e=="string"&&e.trim())return e;if(typeof e!="number"||Number.isNaN(e))return new Date().toISOString();const t=e<1e12?e*1e3:e;return new Date(t).toISOString()}function oe(e){if(typeof e=="string"){const t=e.trim();return t||null}if(typeof e=="number"&&Number.isFinite(e)){const t=e<1e12?e*1e3:e;return new Date(t).toISOString()}return null}function O(e){if(typeof e!="string")return null;const t=e.trim();return t||null}function hr(e){if(!v(e))return null;const t=b(e.confirm_token??e.token,"").trim();return t?{confirm_token:t,actor:O(e.actor)??void 0,action_type:O(e.action_type)??void 0,target_type:O(e.target_type)??void 0,target_id:O(e.target_id),delegated_tool:O(e.delegated_tool)??void 0,created_at:oe(e.created_at)??void 0,preview:e.preview}:null}function Di(e){return v(e)?{board_post_id:O(e.board_post_id),task_id:O(e.task_id),operation_id:O(e.operation_id),team_session_id:O(e.team_session_id)}:{}}function yr(e){if(!v(e))return null;const t=O(e.action_kind),n=O(e.resolved_tool),s=O(e.target_type),a=O(e.target_id),o=O(e.reason);return!t&&!n&&!s&&!o?null:{action_kind:t??void 0,resolved_tool:n,target_type:s,target_id:a,reason:o??void 0,payload_preview:e.payload_preview}}function br(e){if(!v(e))return null;const t=O(e.action_type),n=O(e.delegated_tool),s=O(e.confirmation_state),a=oe(e.created_at);return!t&&!n&&!s&&!a?null:{action_type:t??void 0,delegated_tool:n,confirmation_state:s??void 0,created_at:a}}function kr(e){if(!v(e))return null;const t=hr(e.pending_confirm),n=O(e.pending_confirm_token)??(t==null?void 0:t.confirm_token)??null;return{requires_human_gate:typeof e.requires_human_gate=="boolean"?e.requires_human_gate:void 0,pending_confirm:t,pending_confirm_token:n,ready_to_execute:typeof e.ready_to_execute=="boolean"?e.ready_to_execute:void 0}}function xr(e){if(!v(e))return null;const t=O(e.summary),n=O(e.target_id);return!t&&!n?null:{judgment_id:O(e.judgment_id)??void 0,target_kind:O(e.target_kind)??void 0,target_id:n??void 0,status:O(e.status)??void 0,summary:t??void 0,confidence:typeof e.confidence=="number"?e.confidence:null,generated_at:oe(e.generated_at),expires_at:oe(e.expires_at),model_used:O(e.model_used),keeper_name:O(e.keeper_name),evidence_refs:Pe(e.evidence_refs),recommended_action:yr(e.recommended_action),guardrail_state:kr(e.guardrail_state),executed_route:br(e.executed_route)}}function _d(e){if(!v(e))return null;const t=b(e.id,"").trim(),n=b(e.topic,"").trim();if(!t||!n)return null;const s=Di(e.context);return{kind:b(e.kind,"debate"),id:t,topic:n,status:b(e.status??e.state,"open"),last_activity_at:oe(e.last_activity_at),truth_summary:O(e.truth_summary)??void 0,judgment_summary:O(e.judgment_summary),confidence:typeof e.confidence=="number"?e.confidence:null,related_agents:Pe(e.related_agents),context:s,linked_board_post_id:O(e.linked_board_post_id)??s.board_post_id??null,linked_task_id:O(e.linked_task_id)??s.task_id??null,linked_operation_id:O(e.linked_operation_id)??s.operation_id??null,linked_session_id:O(e.linked_session_id)??s.team_session_id??null,recommended_action:yr(e.recommended_action),executed_route:br(e.executed_route),guardrail_state:kr(e.guardrail_state),evidence_refs:Pe(e.evidence_refs),approve_count:pe(e.approve_count),reject_count:pe(e.reject_count),abstain_count:pe(e.abstain_count),votes:pe(e.votes),quorum:pe(e.quorum),threshold:typeof e.threshold=="number"?e.threshold:void 0}}function gd(e){if(!v(e))return null;const t=b(e.kind,"").trim();return t?{kind:t,item_kind:O(e.item_kind)??void 0,item_id:O(e.item_id)??void 0,topic:O(e.topic)??void 0,created_at:oe(e.created_at),summary:O(e.summary)??void 0,actor:O(e.actor),index:pe(e.index),decision:O(e.decision)}:null}function fd(e){if(v(e))return{judge_online:typeof e.judge_online=="boolean"?e.judge_online:void 0,refreshing:typeof e.refreshing=="boolean"?e.refreshing:void 0,generated_at:oe(e.generated_at),expires_at:oe(e.expires_at),model_used:O(e.model_used),keeper_name:O(e.keeper_name),last_error:O(e.last_error)}}function $d(e){var a;const t=e.trim(),s=((a=(t.startsWith("[flair:")?t.replace(/^\[flair:[^\]]+\]\s*/i,""):t).split(`
`)[0])==null?void 0:a.trim())||"Untitled post";return s.length<=96?s:`${s.slice(0,93)}...`}function hd(e){if(!v(e))return null;const t=b(e.source,"").trim()||null,n=b(e.state_block,"").trim()||null;return!t&&!n?null:{source:t,state_block:n}}function yd(e){if(!v(e))return null;const t=b(e.id,"").trim(),n=b(e.author,"").trim(),s=b(e.body,"").trim()||b(e.content,"").trim(),a=s;if(!t||!n)return null;const o=B(e.score,0),l=B(e.votes_up,0),c=B(e.votes_down,0),p=B(e.votes,o||l-c),m=B(e.comment_count,B(e.reply_count,0)),u=(()=>{const C=e.flair;if(typeof C=="string"&&C.trim())return C.trim();if(v(C)){const k=b(C.name,"").trim();if(k)return k}return b(e.flair_name,"").trim()||void 0})(),_=b(e.created_at_iso,"").trim()||Ss(e.created_at),f=b(e.updated_at_iso,"").trim()||(e.updated_at!==void 0?Ss(e.updated_at):_),S=b(e.title,"").trim()||$d(s),h=Array.isArray(e.tags)?e.tags.filter(C=>typeof C=="string"&&C.trim()!==""):[];return{id:t,author:n,post_kind:(()=>{const C=b(e.post_kind,"").trim().toLowerCase();return C==="automation"||C==="system"||C==="human"?C:void 0})(),title:S,body:s,content:a,meta:hd(e.meta),tags:h,votes:p,vote_balance:o,comment_count:m,created_at:_,updated_at:f,flair:u,hearth:b(e.hearth,"").trim()||null,visibility:b(e.visibility,"").trim()||void 0,expires_at:b(e.expires_at_iso,"").trim()||(e.expires_at!==void 0&&e.expires_at!==0?Ss(e.expires_at):"")||null,hearth_count:B(e.hearth_count,0)}}function bd(e){if(!v(e))return null;const t=b(e.id,"").trim(),n=b(e.post_id,"").trim(),s=b(e.author,"").trim();return!t||!s?null:{id:t,post_id:n,author:s,content:b(e.content,""),created_at:Ss(e.created_at)}}async function kd(e){return ya("fetchBoardPost",async()=>{const t=await Z(`/api/v1/board/${e}?format=flat`),n=v(t.post)?t.post:t,s=yd(n)??{id:e,author:"unknown",post_kind:"human",title:"Post",body:"",content:"",meta:null,tags:[],votes:0,comment_count:0,created_at:new Date().toISOString(),updated_at:new Date().toISOString(),hearth:null,visibility:"internal",expires_at:null},o=(Array.isArray(t.comments)?t.comments:[]).map(bd).filter(l=>l!==null);return{...s,comments:o}})}function Sr(e,t){return Me("/api/v1/tools/masc_board_vote",{post_id:e,direction:t,vote:t,voter:Bc()})}function xd(e,t,n){return Me("/api/v1/tools/masc_board_comment",{post_id:e,author:t,content:n})}function Sd(e){const t=b(e,"").trim().toLowerCase();if(t==="win"||t==="won"||t==="victory")return"victory";if(t==="lose"||t==="lost"||t==="defeat")return"defeat";if(t==="draw"||t==="stalemate"||t==="tie")return"draw"}function re(...e){for(const t of e){const n=b(t,"");if(n.trim())return n.trim()}return""}function bo(e){const t=Sd(re(e.outcome,e.result,e.result_code));if(!t)return;const n=re(e.reason,e.reason_code,e.description,e.detail),s=re(e.summary,e.summary_ko,e.summary_en,e.note),a=re(e.details,e.details_text,e.text,e.note),o=re(e.winner,e.winner_name,e.actor_winner,e.winner_actor),l=re(e.winner_actor_id,e.winner_actor,e.actor_winner_id),c=re(e.raw_reason,e.raw_reason_code,e.error_message),p=(()=>{const _=e.evidence??e.evidence_ids??e.supporting_events??e.event_ids??[];return typeof _=="string"?[_]:Array.isArray(_)?_.map(f=>{if(typeof f=="string")return f.trim();if(v(f)){const $=b(f.summary,"").trim();if($)return $;const S=b(f.text,"").trim();if(S)return S;const h=b(f.type,"").trim();return h||b(f.event_id,"").trim()}return""}).filter(f=>f.length>0):[]})(),m=(()=>{const _=B(e.turn,Number.NaN);if(Number.isFinite(_))return _;const f=B(e.turn_number,Number.NaN);if(Number.isFinite(f))return f;const $=B(e.current_turn,Number.NaN);if(Number.isFinite($))return $;const S=B(e.round,Number.NaN);return Number.isFinite(S)?S:void 0})(),u=re(e.phase,e.phase_name,e.current_phase,e.phase_id);return{result:t,reason:n||void 0,summary:s||void 0,details:a||void 0,winner:o||void 0,winner_actor_id:l||void 0,evidence:p.length>0?p:void 0,raw_reason:c||void 0,turn:m,phase:u||void 0}}function Ad(e,t){const n=v(e.state)?e.state:{};if(b(n.status,"active").toLowerCase()!=="ended")return;const a=[...t].reverse().find(l=>v(l)?b(l.type,"")==="session.outcome":!1),o=v(n.session_outcome)?n.session_outcome:{};if(v(o)&&Object.keys(o).length>0){const l=bo(o);if(l)return l}if(v(a))return bo(v(a.payload)?a.payload:{})}function b(e,t=""){return typeof e=="string"?e:t}function B(e,t=0){return typeof e=="number"&&Number.isFinite(e)?e:t}function pe(e){if(typeof e=="number"&&Number.isFinite(e))return Math.trunc(e);if(typeof e=="string"){const t=Number.parseInt(e.trim(),10);if(Number.isFinite(t))return t}}function Ds(e,t=!1){return typeof e=="boolean"?e:t}function Pe(e){return Array.isArray(e)?e.map(t=>{if(typeof t=="string")return t.trim();if(v(t)){const n=b(t.name,"").trim(),s=b(t.id,"").trim(),a=b(t.skill,"").trim();return n||s||a}return""}).filter(t=>t.length>0):[]}function Cd(e){const t={};if(!v(e)&&!Array.isArray(e))return t;if(v(e))return Object.entries(e).forEach(([n,s])=>{const a=n.trim(),o=b(s,"").trim();!a||!o||(t[a]=o)}),t;for(const n of e){if(!v(n))continue;const s=re(n.to,n.target,n.actor_id,n.name,n.id),a=re(n.relationship,n.relation,n.type,n.kind);!s||!a||(t[s]=a)}return t}function Id(e,t,n){if(e==="dm"||e==="player"||e==="npc")return e;const s=t.trim().toLowerCase();return s==="dm"||s.startsWith("dm-")?"dm":s.startsWith("npc-")||s.startsWith("enemy-")||s.startsWith("mob-")?"npc":/^p\d+$/i.test(s)||s.startsWith("player-")?"player":typeof n=="string"&&n.trim()!==""?n.trim().toLowerCase().includes("dm")?"dm":"player":"npc"}function be(e,t,n,s=0){const a=e[t];if(typeof a=="number"&&Number.isFinite(a))return a;if(n){const o=e[n];if(typeof o=="number"&&Number.isFinite(o))return o}return s}const Td=new Set(["str","dex","con","int","wis","cha","strength","dexterity","constitution","intelligence","wisdom","charisma","hp","max_hp","mp","max_mp","level","xp"]);function Rd(e){const t=v(e.stats)?e.stats:{},n={};return Object.entries(t).forEach(([s,a])=>{const o=s.trim();o&&(Td.has(o.toLowerCase())||typeof a=="number"&&Number.isFinite(a)&&(n[o]=a))}),n}function wd(e,t){if(e!=="dice.rolled")return;const n=B(t.raw_d20,0),s=B(t.total,0),a=B(t.bonus,0),o=b(t.action,"roll"),l=B(t.dc,0);return{notation:l>0?`${o} (DC ${l})`:o,rolls:n>0?[n]:[],total:s,modifier:a}}function Pd(e){const t=JSON.stringify(e);return t?t.length>160?`${t.slice(0,157)}...`:t:""}function Nd(e){const t=e.trim().toLowerCase();return t?t.startsWith("dice.")?"dice":t.startsWith("combat.")||t.includes(".attack")||t.includes(".damage")?"combat":t.includes("actor.")?"actor":t.includes("turn.")||t==="turn.started"||t==="phase.changed"?"turn":t.includes("join.")?"join":t.includes("memory")?"memory":t.includes("world.")?"world":t.includes("narration")?"story":"meta":"meta"}function Ld(e,t,n,s){const a=n||t||b(s.actor_id,"")||b(s.actor_name,"");switch(e){case"turn.action.proposed":{const o=b(s.proposed_action,b(s.reply,""));return o?`${a||"actor"}: ${o}`:"Action proposed"}case"turn.action.resolved":{const o=b(s.reply,b(s.result,""));return o?`Resolved: ${o}`:"Action resolved"}case"narration.posted":return b(s.reply,b(s.content,b(s.text,"Narration")));case"dice.rolled":{const o=b(s.action,"roll"),l=B(s.total,0),c=B(s.dc,0),p=b(s.label,""),m=a||"actor",u=c>0?` vs DC ${c}`:"",_=p?` (${p})`:"";return`${m} ${o}: ${l}${u}${_}`}case"turn.started":return`Turn ${B(s.turn,1)} started`;case"phase.changed":return`Phase: ${b(s.phase,"round")}`;case"actor.spawned":return`Actor spawned: ${b(s.name,v(s.actor)?b(s.actor.name,a||"unknown"):a||"unknown")}`;case"actor.claimed":return`${b(s.keeper_name,b(s.keeper,"keeper"))} claimed ${a||"actor"}`;case"actor.released":return`${b(s.keeper_name,b(s.keeper,"keeper"))} released ${a||"actor"}`;case"join.window.opened":return`Join window opened (turn ${B(s.turn,0)})`;case"join.window.closed":return`Join window closed (turn ${B(s.turn,0)})`;case"mid.join.requested":return`Mid-join requested: ${a||b(s.actor_id,"actor")}`;case"mid.join.granted":return`Mid-join granted: ${a||b(s.actor_id,"actor")}`;case"mid.join.rejected":return`Mid-join rejected: ${b(s.reason_code,"unknown")}`;case"memory.signal":{const o=v(s.entity_refs)?s.entity_refs:{},l=b(o.requested_tier,""),c=b(o.effective_tier,""),p=Ds(o.guardrail_applied,!1),m=b(s.summary_en,b(s.summary_ko,"Memory signal"));if(!l&&!c)return m;const u=l&&c?`${l}->${c}`:c||l;return`${m} [${u}${p?" (guardrail)":""}]`}case"world.event":{if(b(s.event_type,"")==="canon.check"){const l=b(s.status,"unknown"),c=b(s.contract_id,"n/a");return`Canon ${l}: ${c}`}return b(s.description,b(s.summary,"World event"))}case"combat.attack":return b(s.summary,b(s.result,"Attack resolved"));case"combat.defense":return b(s.summary,b(s.result,"Defense resolved"));case"session.outcome":return b(s.summary,b(s.outcome,"Session ended"));default:{const o=Pd(s);return o?`${e}: ${o}`:e}}}function zd(e,t){const n=v(e)?e:{},s=b(n.type,"event"),a=typeof n.actor_id=="string"&&n.actor_id.trim()?n.actor_id.trim():"",o=b(n.actor_name,"").trim()||t[a]||b(v(n.payload)?n.payload.actor_name:"",""),l=v(n.payload)?n.payload:{},c=b(n.ts,b(n.timestamp,new Date().toISOString())),p=b(n.phase,b(l.phase,"")),m=b(n.category,"");return{type:s,actor:o||a||b(l.actor_name,""),actor_id:a||b(l.actor_id,""),actor_name:o,seq:n.seq,room_id:b(n.room_id,""),phase:p||void 0,category:m||Nd(s),visibility:b(n.visibility,b(l.visibility,"public")),event_id:b(n.event_id,""),content:Ld(s,a,o,l),dice_roll:wd(s,l),timestamp:c}}function Md(e,t,n){var Q,ne;const s=b(e.room_id,"")||n||"default",a=v(e.state)?e.state:{},o=v(a.party)?a.party:{},l=v(a.actor_control)?a.actor_control:{},c=v(a.join_gate)?a.join_gate:{},p=v(a.contribution_ledger)?a.contribution_ledger:{},m=Object.entries(o).map(([J,ee])=>{const A=v(ee)?ee:{},Ae=be(A,"max_hp",void 0,10),Ue=be(A,"hp",void 0,Ae),ut=be(A,"max_mp",void 0,0),pt=be(A,"mp",void 0,0),K=be(A,"level",void 0,1),Ce=be(A,"xp",void 0,0),mt=Ds(A.alive,Ue>0),dn=l[J],un=typeof dn=="string"?dn:void 0,ns=Id(A.role,J,un),ss=pe(A.generation),as=re(A.joined_at,A.joinedAt,A.started_at,A.startedAt),is=re(A.claimed_at,A.claimedAt,A.assigned_at,A.assignedAt,A.assigned_time),os=re(A.last_seen,A.lastSeen,A.last_seen_at,A.lastSeenAt,A.last_active,A.lastActive),rs=re(A.scene,A.current_scene,A.currentScene,A.world_scene,A.scene_name,A.sceneName),ls=re(A.location,A.current_location,A.currentLocation,A.position,A.zone,A.area);return{id:J,name:b(A.name,J),role:ns,keeper:un,archetype:b(A.archetype,""),persona:b(A.persona,""),portrait:b(A.portrait,"")||void 0,background:b(A.background,"")||void 0,traits:Pe(A.traits),skills:Pe(A.skills),stats_raw:Rd(A),status:mt?"active":"dead",generation:ss,joined_at:as||void 0,claimed_at:is||void 0,last_seen:os||void 0,scene:rs||void 0,location:ls||void 0,inventory:Pe(A.inventory),notes:Pe(A.notes),relationships:Cd(A.relationships),stats:{hp:Ue,max_hp:Ae,mp:pt,max_mp:ut,level:K,xp:Ce,strength:be(A,"strength","str",10),dexterity:be(A,"dexterity","dex",10),constitution:be(A,"constitution","con",10),intelligence:be(A,"intelligence","int",10),wisdom:be(A,"wisdom","wis",10),charisma:be(A,"charisma","cha",10)}}}),u=m.filter(J=>J.status!=="dead"),_=Ad(e,t),f={phase_open:Ds(c.phase_open,!0),min_points:B(c.min_points,3),window:b(c.window,"round_boundary_only"),last_opened_turn:typeof c.last_opened_turn=="number"?c.last_opened_turn:null,last_closed_turn:typeof c.last_closed_turn=="number"?c.last_closed_turn:null},$=Object.entries(p).map(([J,ee])=>{const A=v(ee)?ee:{};return{actor_id:J,score:B(A.score,0),last_reason:b(A.last_reason,"")||null,reasons:Pe(A.reasons)}}),S=m.reduce((J,ee)=>(J[ee.id]=ee.name,J),{}),h=t.map(J=>zd(J,S)),C=B(a.turn,1),x=b(a.phase,"round"),k=b(a.map,""),L=v(a.world)?a.world:{},R=k||b(L.ascii_map,b(L.map,"")),w=h.filter((J,ee)=>{const A=t[ee];if(!v(A))return!1;const Ae=v(A.payload)?A.payload:{};return B(Ae.turn,-1)===C}),P=(w.length>0?w:h).slice(-12),T=b(a.status,"active");return{session:{id:s,room:s,status:T==="ended"?"ended":T==="paused"?"paused":"active",round:C,actors:u,created_at:((Q=h[0])==null?void 0:Q.timestamp)??new Date().toISOString()},current_round:{round_number:C,phase:x,events:P,timestamp:((ne=h[h.length-1])==null?void 0:ne.timestamp)??new Date().toISOString()},map:R||void 0,join_gate:f,contribution_ledger:$,outcome:_,party:u,story_log:h,history:[]}}async function jd(e){const t=`?room_id=${encodeURIComponent(e)}`,n=await Z(`/api/v1/trpg/events${t}`);return Array.isArray(n.events)?n.events:[]}async function Ed(e){const t=`?room_id=${encodeURIComponent(e)}`,[n,s]=await Promise.all([Z(`/api/v1/trpg/state${t}`),jd(e)]);return Md(n,s,e)}function Dd(e){return Me("/api/v1/trpg/rounds/run",{room_id:e})}function Od(e){const t="".trim().toLowerCase();if(t)switch(t){case"discussion":case"discuss":case"party_discussion":case"player_discussion":case"action":case"dice":return"round";case"ended":return"end";default:return t}}function qd(e){const t={room_id:e.roomId,actor_id:e.actorId,action:e.action,stat_value:e.statValue,dc:e.dc};return e.rawD20!=null&&(t.raw_d20=e.rawD20),e.ruleModule&&(t.rule_module=e.ruleModule),Me("/api/v1/trpg/dice/roll",t)}function Fd(e,t){const n=Od();return Me("/api/v1/trpg/turns/advance",{room_id:e,...n?{phase:n}:{}})}function Kd(e,t){var a;const n=(a=t.idempotencyKey)==null?void 0:a.trim(),s={room_id:e};return t.actor_id&&t.actor_id.trim()&&(s.actor_id=t.actor_id.trim()),t.name&&t.name.trim()&&(s.name=t.name.trim()),t.role&&(s.role=t.role),t.archetype&&t.archetype.trim()&&(s.archetype=t.archetype.trim()),t.persona&&t.persona.trim()&&(s.persona=t.persona.trim()),t.portrait&&t.portrait.trim()&&(s.portrait=t.portrait.trim()),t.background&&t.background.trim()&&(s.background=t.background.trim()),t.hp!=null&&(s.hp=t.hp),t.max_hp!=null&&(s.max_hp=t.max_hp),t.alive!=null&&(s.alive=t.alive),Array.isArray(t.traits)&&t.traits.length>0&&(s.traits=t.traits),Array.isArray(t.skills)&&t.skills.length>0&&(s.skills=t.skills),Array.isArray(t.inventory)&&t.inventory.length>0&&(s.inventory=t.inventory),t.stats&&Object.keys(t.stats).length>0&&(s.stats=t.stats),n&&(s.idempotency_key=n),Me("/api/v1/trpg/actors/spawn",s,n?{"Idempotency-Key":n}:void 0)}function Bd(e,t,n){return Me("/api/v1/trpg/actors/claim",{room_id:e,actor_id:t,keeper:n})}async function Ud(e,t,n){const s=await rt("trpg.join.eligibility",{room_id:e,actor_id:t,...n?{keeper_name:n}:{}});return JSON.parse(s)}async function Hd(e){const t=await rt("trpg.mid_join.request",e);return JSON.parse(t)}async function Wd(e,t){await rt("masc_broadcast",{agent_name:e,message:t})}async function Gd(e=40){return(await rt("masc_messages",{limit:e})).split(`
`).map(n=>n.trim()).filter(n=>n!=="")}async function Jd(e,t=20){return rt("masc_task_history",{task_id:e,limit:t})}async function Vd(e){const t=await rt("masc_debate_start",{topic:e});try{return JSON.parse(t)}catch{return null}}async function Yd(e){return ya("fetchDebateStatus",async()=>{const t=encodeURIComponent(e),n=await Z(`/api/v1/council/debates/${t}/summary`);if(!v(n))return null;const s=v(n.debate)?n.debate:n,a=b(s.id,"").trim(),o=b(s.topic,"").trim();return!a||!o?null:{debate:{id:a,topic:o,status:b(s.status,"open"),created_at:oe(s.created_at_iso??s.created_at),closed_at:oe(s.closed_at)},arguments:Array.isArray(n.arguments)?n.arguments.flatMap(l=>v(l)?[{index:B(l.index,0),agent:b(l.agent,"unknown"),position:b(l.position,"neutral"),content:b(l.content,""),evidence:Pe(l.evidence),reply_to:pe(l.reply_to)??null,mentions:Pe(l.mentions),archetype:O(l.archetype),created_at:oe(l.created_at)}]:[]):[],summary:{support_count:v(n.summary)?B(n.summary.support_count,0):B(n.support_count,0),oppose_count:v(n.summary)?B(n.summary.oppose_count,0):B(n.oppose_count,0),neutral_count:v(n.summary)?B(n.summary.neutral_count,0):B(n.neutral_count,0),total_arguments:v(n.summary)?B(n.summary.total_arguments,0):B(n.total_arguments,0),summary_text:v(n.summary)?b(n.summary.summary_text,""):b(n.summary_text,"")},context:Di(n.context),judgment:xr(n.judgment)}})}async function Qd(e){return ya("fetchConsensusSessionSummary",async()=>{const t=encodeURIComponent(e),n=await Z(`/api/v1/council/sessions/${t}/summary`);if(!v(n)||!v(n.session))return null;const s=n.session,a=b(s.id,"").trim(),o=b(s.topic,"").trim();return!a||!o?null:{session:{id:a,topic:o,state:b(s.state,"open"),initiator:b(s.initiator,"system"),quorum:B(s.quorum,0),threshold:B(s.threshold,0),created_at:oe(s.created_at),closed_at:oe(s.closed_at)},votes:Array.isArray(n.votes)?n.votes.flatMap(l=>v(l)?[{agent:b(l.agent,"unknown"),decision:b(l.decision,"abstain"),reason:b(l.reason,""),timestamp:oe(l.timestamp),weight:typeof l.weight=="number"?l.weight:void 0,archetype:O(l.archetype)}]:[]):[],summary:{approve_count:v(n.summary)?B(n.summary.approve_count,0):0,reject_count:v(n.summary)?B(n.summary.reject_count,0):0,abstain_count:v(n.summary)?B(n.summary.abstain_count,0):0,quorum_met:v(n.summary)?Ds(n.summary.quorum_met,!1):!1,result:v(n.summary)?O(n.summary.result):null},context:Di(n.context),judgment:xr(n.judgment)}})}function Xd(e,t,n){return rt("masc_keeper_msg",{name:e,message:t})}const Zd=g(""),Fe=g({}),le=g({}),ui=g({}),pi=g({}),mi=g({}),vi=g({}),Ke=g({});function ae(e,t,n){e.value={...e.value,[t]:n}}function eu(e){var n;const t=(n=r(e))==null?void 0:n.toLowerCase();return t==="user"||t==="assistant"||t==="system"||t==="tool"?t:"other"}function tu(e){switch(e){case"user":return"User";case"assistant":return"Keeper";case"system":return"System";case"tool":return"Tool";default:return"Event"}}function Na(e,t){if(!Array.isArray(e))return[];const n=[];for(const s of e){if(!v(s))continue;const a=r(s.name);if(!a)continue;const o=r(s[t]);t==="summary"?n.push({name:a,summary:o}):n.push({name:a,reason:o})}return n}function nu(e){if(!v(e))return null;const t=r(e.name);return t?{name:t,trigger:r(e.trigger),outcome:r(e.outcome),summary:r(e.summary),reason:r(e.reason)}:null}function su(e){const t=e.toLowerCase();return t.includes("graphql")?"graphql_error":t.includes("timeout")||t.includes("model")||t.includes("llm")||t.includes("api key")||t.includes("api_key")||t.includes("provider")?"llm_error":"unknown"}function au(e,t){return e==="offline"||e==="degraded"||e==="stale"?"Keeper is not in a healthy reply state. Probe or recover before relying on automation.":t==="quiet_hours"?"Lodge quiet hours are active. Direct messages still work, but scheduled social ticks may look asleep.":t==="min_gap"?"Keeper is inside its proactive cooldown window. Direct messages work now; autonomous check-ins will wait.":t==="never_started"?"Keeper metadata exists but no reply turn has been recorded yet.":"Keeper is reachable. Send a direct message for an immediate response."}function Ar(e,t,n){return r(e)??au(t,n)}function Cr(e,t){return typeof e=="boolean"?e:t==="recover"}function Os(e){if(!v(e))return null;const t=r(e.health_state),n=r(e.next_action_path),s=r(e.last_reply_status);return!t||!n||!s?null:{health_state:t,quiet_reason:r(e.quiet_reason)??null,next_action_path:n,last_reply_status:s,last_reply_at:st(e.last_reply_at)??null,last_reply_preview:r(e.last_reply_preview)??null,last_error:r(e.last_error)??null,next_eligible_at_s:d(e.next_eligible_at_s)??null,recoverable:Cr(e.recoverable,n),summary:Ar(e.summary,t,r(e.quiet_reason)??null),keepalive_running:typeof e.keepalive_running=="boolean"?e.keepalive_running:void 0}}function Ir(e){return v(e)?{hour:d(e.hour),checked:d(e.checked)??0,acted:d(e.acted)??0,acted_names:W(e.acted_names),activity_report:r(e.activity_report),quiet_hours_overridden:E(e.quiet_hours_overridden),skipped_reason:r(e.skipped_reason),acted_rows:Na(e.acted_rows,"summary").map(t=>({name:t.name,summary:t.summary})),passed_rows:Na(e.passed_rows,"reason").map(t=>({name:t.name,reason:t.reason})),skipped_rows:Na(e.skipped_rows,"reason").map(t=>({name:t.name,reason:t.reason})),checkins:Array.isArray(e.checkins)?e.checkins.map(nu).filter(t=>t!==null):[]}:null}function iu(e){return v(e)?{enabled:E(e.enabled)??!1,interval_s:d(e.interval_s)??0,quiet_start:d(e.quiet_start),quiet_end:d(e.quiet_end),quiet_active:E(e.quiet_active),use_planner:E(e.use_planner),delegate_llm:E(e.delegate_llm),agent_count:d(e.agent_count),agents:W(e.agents),last_tick_ago_s:d(e.last_tick_ago_s)??null,last_tick_ago:r(e.last_tick_ago),total_ticks:d(e.total_ticks),total_checkins:d(e.total_checkins),last_skip_reason:r(e.last_skip_reason)??null,last_tick_result:Ir(e.last_tick_result),active_self_heartbeats:W(e.active_self_heartbeats)}:null}function ou(e){return v(e)?{status:e.status,diagnostic:Os(e.diagnostic)}:null}function ru(e){return v(e)?{recovered:E(e.recovered)??!1,skipped_reason:r(e.skipped_reason)??null,before:Os(e.before),after:Os(e.after),down:e.down,up:e.up}:null}function lu(e,t){var k,L;if(!(e!=null&&e.name))return null;const n=r((k=e.agent)==null?void 0:k.status)??r(e.status)??"unknown",s=r((L=e.agent)==null?void 0:L.error)??null,a=e.presence_keepalive??!0,o=e.keepalive_running??!1,l=e.turn_count??0,c=e.last_turn_ago_s??null,p=e.proactive_enabled??!1,m=e.proactive_cooldown_sec??0,u=e.last_proactive_ago_s??null,_=p&&u!=null?Math.max(0,m-u):null,f=l<=0||c==null?"never":c>900?"stale":"fresh",$=typeof e.last_heartbeat=="string"&&e.last_heartbeat.trim()?e.last_heartbeat:null,S=s??(a&&!o?"keeper keepalive is not running":null),h=n==="offline"||n==="inactive"?"offline":S?"degraded":f==="stale"?"stale":f==="never"?"idle":"healthy",C=S?su(S):t!=null&&t.quiet_active&&f!=="fresh"?"quiet_hours":a&&!o?"disabled":l<=0?"never_started":_!=null&&_>0?"min_gap":f==="fresh"||f==="stale"?"no_recent_activity":"unknown",x=h==="offline"||h==="degraded"||h==="stale"?"recover":C==="quiet_hours"?"manual_lodge_poke":C==="unknown"?"probe":"direct_message";return{health_state:h,quiet_reason:C,next_action_path:x,last_reply_status:f,last_reply_at:$,last_reply_preview:null,last_error:S,next_eligible_at_s:_!=null&&_>0?_:null,recoverable:Cr(void 0,x),summary:Ar(void 0,h,C),keepalive_running:o}}function cu(e,t){if(!v(e))return null;const n=eu(e.role),s=r(e.content)??r(e.preview);if(!s)return null;const a=st(e.ts_unix)??st(e.timestamp);return{id:`${n}-${a??"entry"}-${t}`,role:n,label:tu(n),text:s,timestamp:a,delivery:"history"}}function du(e,t,n){const s=v(n)?n:null,a=Array.isArray(s==null?void 0:s.history_tail)?s.history_tail.map((o,l)=>cu(o,l)).filter(o=>o!==null):[];return{name:e,diagnostic:Os(s==null?void 0:s.diagnostic),history:a,rawText:t,rawStatus:n,loadedAt:new Date().toISOString()}}function ko(e,t){const n=le.value[e]??[];le.value={...le.value,[e]:[...n,t].slice(-50)}}function uu(e,t){return e.role!==t.role||e.text!==t.text?!1:e.timestamp&&t.timestamp?e.timestamp===t.timestamp:!0}function pu(e,t){const s=(le.value[e]??[]).filter(a=>a.delivery!=="history"&&!t.some(o=>uu(a,o)));le.value={...le.value,[e]:[...t,...s].slice(-50)}}function ka(e,t){Fe.value={...Fe.value,[e]:t},pu(e,t.history)}function xo(e,t){const n=Fe.value[e];if(!n)return;const s=n.diagnostic??{health_state:"idle",next_action_path:"direct_message",last_reply_status:"unknown"};ka(e,{...n,diagnostic:{...s,...t}})}async function Oi(){try{await Jn()}catch(e){console.warn("[keeper-runtime] dashboard refresh failed",e)}}function mu(e){Zd.value=e.trim()}async function Tr(e,t=!1){const n=e.trim();if(!n)return null;if(!t&&Fe.value[n])return Fe.value[n];ae(ui,n,!0),ae(Ke,n,null);try{const s=await rt("masc_keeper_status",{name:n,fast:!1,include_context:!0,include_metrics_overview:!0,include_memory_bank:!1,include_history_tail:!0,include_compaction_history:!1,tail_turns:5,tail_messages:10});let a=null;try{a=JSON.parse(s)}catch{a=null}const o=du(n,s,a);return ka(n,o),o}catch(s){const a=s instanceof Error?s.message:`Failed to inspect ${n}`;return ae(Ke,n,a),null}finally{ae(ui,n,!1)}}async function vu(e,t){const n=e.trim(),s=t.trim();if(!n||!s)return;const a=`local-${Date.now()}`;ko(n,{id:a,role:"user",label:"You",text:s,timestamp:new Date().toISOString(),delivery:"sending"}),ae(pi,n,!0),ae(Ke,n,null);try{const o=await Xd(n,s);le.value={...le.value,[n]:(le.value[n]??[]).map(l=>l.id===a?{...l,delivery:"delivered"}:l)},ko(n,{id:`reply-${Date.now()}`,role:"assistant",label:n,text:o.trim()||"(empty reply)",timestamp:new Date().toISOString(),delivery:"delivered"}),xo(n,{last_reply_status:"delivered",last_reply_at:new Date().toISOString(),last_reply_preview:(o.trim()||"(empty reply)").slice(0,200),last_error:null}),await Oi()}catch(o){const l=o instanceof Error?o.message:`Failed to send direct message to ${n}`;throw le.value={...le.value,[n]:(le.value[n]??[]).map(c=>c.id===a?{...c,delivery:"error",error:l}:c)},xo(n,{last_reply_status:"error",last_error:l}),ae(Ke,n,l),o}finally{ae(pi,n,!1)}}async function _u(e,t){const n=e.trim();if(!n)return null;ae(mi,n,!0),ae(Ke,n,null);try{const s=await ba({actor:t,action_type:"keeper_probe",target_type:"keeper",target_id:n,payload:{}}),a=ou(s.result),o=(a==null?void 0:a.diagnostic)??null;if(o){const l=Fe.value[n];ka(n,{name:n,diagnostic:o,history:(l==null?void 0:l.history)??le.value[n]??[],rawText:(l==null?void 0:l.rawText)??"",rawStatus:s.result,loadedAt:new Date().toISOString()})}return await Oi(),o}catch(s){const a=s instanceof Error?s.message:`Failed to probe ${n}`;throw ae(Ke,n,a),s}finally{ae(mi,n,!1)}}async function gu(e,t){const n=e.trim();if(!n)return null;ae(vi,n,!0),ae(Ke,n,null);try{const s=await ba({actor:t,action_type:"keeper_recover",target_type:"keeper",target_id:n,payload:{}}),a=ru(s.result),o=(a==null?void 0:a.after)??null;if(o){const l=Fe.value[n];ka(n,{name:n,diagnostic:o,history:(l==null?void 0:l.history)??le.value[n]??[],rawText:(l==null?void 0:l.rawText)??"",rawStatus:s.result,loadedAt:new Date().toISOString()})}return await Oi(),o}catch(s){const a=s instanceof Error?s.message:`Failed to recover ${n}`;throw ae(Ke,n,a),s}finally{ae(vi,n,!1)}}function vt(e){return(e??"").trim().toLowerCase()}function _e(e){const t=typeof e=="number"?e:Date.parse(e);return Number.isNaN(t)?0:t}function As(e,t=88){const n=e.replace(/\s+/g," ").trim();return n&&(n.length>t?`${n.slice(0,t-3)}...`:n)}function ds(e){return typeof e!="number"||!Number.isFinite(e)||e<0?null:new Date(Date.now()-e*1e3).toISOString()}function pn(e){return e.last_heartbeat??ds(e.last_turn_ago_s)??ds(e.last_proactive_ago_s)??ds(e.last_handoff_ago_s)??ds(e.last_compaction_ago_s)}function fu(e){const t=e.title.trim();return t||As(e.content)}function $u(e){const t=e.generation??"?",n=typeof e.context_ratio=="number"&&Number.isFinite(e.context_ratio)?`${Math.round(e.context_ratio*100)}%`:"?";return e.last_heartbeat?`Heartbeat gen=${t} ctx=${n}`:`Keeper snapshot gen=${t} ctx=${n}`}function hu(e,t,n,s,a={}){var L;const o=vt(e),l=t.filter(R=>vt(R.assignee)===o&&(R.status==="claimed"||R.status==="in_progress")).length,c=n.filter(R=>vt(R.from)===o).sort((R,w)=>_e(w.timestamp)-_e(R.timestamp))[0],p=s.filter(R=>vt(R.agent)===o||vt(R.author)===o).sort((R,w)=>_e(w.timestamp)-_e(R.timestamp))[0],m=(a.boardPosts??[]).filter(R=>vt(R.author)===o).sort((R,w)=>_e(w.updated_at||w.created_at)-_e(R.updated_at||R.created_at))[0],u=(a.keepers??[]).filter(R=>vt(R.name)===o&&pn(R)!==null).sort((R,w)=>_e(pn(w)??0)-_e(pn(R)??0))[0],_=c?_e(c.timestamp):0,f=p?_e(p.timestamp):0,$=m?_e(m.updated_at||m.created_at):0,S=u?_e(pn(u)??0):0,h=a.lastSeen?_e(a.lastSeen):0,C=((L=a.currentTask)==null?void 0:L.trim())||(l>0?`${l} claimed tasks`:null);if(_===0&&f===0&&$===0&&S===0&&h===0)return{activeAssignedCount:l,lastActivityAt:null,lastActivityText:C};const k=[c?{timestamp:c.timestamp,ts:_,text:As(c.content)}:null,m?{timestamp:m.updated_at||m.created_at,ts:$,text:`Post: ${As(fu(m))}`}:null,u?{timestamp:pn(u),ts:S,text:$u(u)}:null,p?{timestamp:new Date(p.timestamp).toISOString(),ts:f,text:As(p.text)}:null].filter(R=>R!==null).sort((R,w)=>w.ts-R.ts)[0];return k&&k.ts>=h?{activeAssignedCount:l,lastActivityAt:k.timestamp,lastActivityText:k.text}:{activeAssignedCount:l,lastActivityAt:a.lastSeen??null,lastActivityText:C??"Presence heartbeat"}}const Be=g([]),Ye=g([]),_i=g([]),lt=g([]),ie=g(null),yu=g(null),Rr=g(null),wr=g([]),Pr=g([]),Nr=g([]),Lr=g([]),zr=g([]),Mr=g([]),gi=g(new Map),xa=g([]),Tn=g("recent"),ht=g(!0),jr=g(null),qe=g(""),Bt=g([]),fn=g(!1),Er=g(new Map),qi=g("unknown"),Ut=g(null),fi=g(!1),Rn=g(!1),$i=g(!1),$n=g(!1),Fi=g(null),qs=g(!1),Fs=g(null),Dr=g(null),hi=g(null),bu=g(null),ku=g(null),xu=g(null);Se(()=>Be.value.filter(e=>e.status==="active"||e.status==="busy"||e.status==="listening"||e.status==="idle"));const Or=Se(()=>{const e=Ye.value;return{todo:e.filter(t=>t.status==="todo"),inProgress:e.filter(t=>t.status==="in_progress"||t.status==="claimed"),done:e.filter(t=>t.status==="done")}}),qr=Se(()=>{const e=new Map,t=Ye.value,n=_i.value,s=Es.value,a=xa.value,o=lt.value;for(const l of Be.value)e.set(l.name.trim().toLowerCase(),hu(l.name,t,n,s,{currentTask:l.current_task,lastSeen:l.last_seen,boardPosts:a,keepers:o}));return e});function Su(e){var o;const t=((o=e.status)==null?void 0:o.toLowerCase())??"";if(t==="offline"||t==="inactive")return"offline";const n=e.metrics_series;if(!n||n.length===0)return"idle";const s=n[n.length-1];if(!s)return"idle";if(s.is_handoff)return"handoff-imminent";if(s.is_compaction)return"compacting";const a=s.context_ratio;return a>.85?"handoff-imminent":a>.7?"preparing":a>.5?"compacting":"active"}Se(()=>{const e=new Map;for(const t of lt.value)e.set(t.name,Su(t));return e});const Au=12e4;function Cu(e,t){const n=t.get(e.name);if(n!=null)return n;const s=e.last_heartbeat?Date.parse(e.last_heartbeat):Number.NaN;if(!Number.isNaN(s))return s;const a=[e.last_turn_ago_s,e.last_proactive_ago_s,e.last_handoff_ago_s,e.last_compaction_ago_s].find(o=>typeof o=="number"&&Number.isFinite(o)&&o>=0);return typeof a=="number"?Date.now()-a*1e3:null}Se(()=>{const e=Date.now(),t=new Set,n=gi.value;for(const s of lt.value){const a=Cu(s,n);a!=null&&e-a>Au&&t.add(s.name)}return t});function Iu(e){return e==="dashboard_refresh"||e==="masc/dashboard_refresh"||e.startsWith("goal_")||e.startsWith("masc/goal_")||e.startsWith("mdal_")||e.startsWith("masc/mdal_")||e.startsWith("operator_")||e.startsWith("masc/operator_")||e.startsWith("command_plane_")||e.startsWith("masc/command_plane_")}function Fr(e){const t=typeof e=="string"?e.toLowerCase():"";return t==="active"||t==="busy"||t==="listening"||t==="idle"||t==="inactive"||t==="offline"?t:t==="in_progress"||t==="claimed"?"busy":"offline"}function Tu(e){const t=typeof e=="string"?e.toLowerCase():"";return t==="todo"||t==="in_progress"||t==="claimed"||t==="done"||t==="cancelled"?t:t==="inprogress"?"in_progress":"todo"}function Ru(e){if(!v(e))return null;const t=r(e.name);return t?{name:t,agent_type:r(e.agent_type),status:Fr(e.status),current_task:r(e.current_task)??null,joined_at:r(e.joined_at),last_seen:r(e.last_seen),capabilities:W(e.capabilities),emoji:r(e.emoji),koreanName:r(e.koreanName)??r(e.korean_name),model:r(e.model),traits:W(e.traits),interests:W(e.interests),activityLevel:d(e.activityLevel)??d(e.activity_level),primaryValue:r(e.primaryValue)??r(e.primary_value)}:null}function wu(e){if(!v(e))return null;const t=r(e.id),n=r(e.title);return!t||!n?null:{id:t,title:n,status:Tu(e.status),priority:d(e.priority),assignee:r(e.assignee),description:r(e.description),created_at:r(e.created_at),updated_at:r(e.updated_at)}}function Pu(e){if(!v(e))return null;const t=r(e.from)??r(e.from_agent)??"system",n=r(e.content)??"",s=r(e.timestamp)??new Date().toISOString();return{id:r(e.id),seq:d(e.seq),from:t,content:n,timestamp:s,type:r(e.type)}}function Ki(e){const t=typeof e=="string"?e.toLowerCase():"";return t==="ok"||t==="warn"||t==="bad"?t:"ok"}function Nu(e){return v(e)?{active_sessions:d(e.active_sessions),blocked_sessions:d(e.blocked_sessions),active_operations:d(e.active_operations),blocked_operations:d(e.blocked_operations),runtime_pressure:d(e.runtime_pressure),worker_alerts:d(e.worker_alerts),continuity_alerts:d(e.continuity_alerts),priority_items:d(e.priority_items),todo_tasks:d(e.todo_tasks),claimed_tasks:d(e.claimed_tasks),running_tasks:d(e.running_tasks),done_tasks:d(e.done_tasks),cancelled_tasks:d(e.cancelled_tasks),keepers:d(e.keepers)}:null}function Qe(e){if(!v(e))return null;const t=r(e.surface),n=r(e.label),s=r(e.target_type),a=r(e.target_id),o=r(e.focus_kind);return!t||!n||!s||!a||!o?null:{surface:t==="command"?"command":"intervene",label:n,target_type:s,target_id:a,focus_kind:o,operation_id:r(e.operation_id)??null,command_surface:r(e.command_surface)??null}}function Lu(e){if(!v(e))return null;const t=r(e.id),n=r(e.kind),s=r(e.summary),a=r(e.target_type),o=r(e.target_id);return!t||!s||!a||!o||n!=="session"&&n!=="operation"?null:{id:t,kind:n,severity:Ki(e.severity),status:r(e.status),summary:s,target_type:a,target_id:o,linked_session_id:r(e.linked_session_id)??null,linked_operation_id:r(e.linked_operation_id)??null,last_seen_at:r(e.last_seen_at)??null,top_handoff:Qe(e.top_handoff),intervene_handoff:Qe(e.intervene_handoff),command_handoff:Qe(e.command_handoff)}}function zu(e){if(!v(e))return null;const t=r(e.session_id),n=r(e.goal);return!t||!n?null:{session_id:t,goal:n,room:r(e.room)??null,status:r(e.status),health:r(e.health),member_names:W(e.member_names),linked_operation_id:r(e.linked_operation_id)??null,linked_detachment_id:r(e.linked_detachment_id)??null,runtime_blocker:r(e.runtime_blocker)??null,worker_gap_summary:r(e.worker_gap_summary)??null,last_activity_at:r(e.last_activity_at)??null,last_activity_summary:r(e.last_activity_summary)??null,communication_summary:r(e.communication_summary)??null,active_count:d(e.active_count),required_count:d(e.required_count),top_handoff:Qe(e.top_handoff),intervene_handoff:Qe(e.intervene_handoff),command_handoff:Qe(e.command_handoff)}}function Mu(e){if(!v(e))return null;const t=r(e.operation_id),n=r(e.objective);return!t||!n?null:{operation_id:t,objective:n,status:r(e.status),stage:r(e.stage)??null,assigned_unit_id:r(e.assigned_unit_id)??null,assigned_unit_label:r(e.assigned_unit_label)??null,linked_session_id:r(e.linked_session_id)??null,linked_detachment_id:r(e.linked_detachment_id)??null,blocker_summary:r(e.blocker_summary)??null,search_status:r(e.search_status)??null,next_tool:r(e.next_tool)??null,updated_at:r(e.updated_at)??null,top_handoff:Qe(e.top_handoff),command_handoff:Qe(e.command_handoff)}}function So(e){if(!v(e))return null;const t=r(e.name)??r(e.agent_name),n=r(e.note),s=r(e.focus),a=r(e.state);return!t||!n||!s||a!=="working"&&a!=="watching"&&a!=="quiet"&&a!=="offline"?null:{name:t,agent_name:r(e.agent_name),status:r(e.status),tone:Ki(e.tone),state:a,note:n,focus:s,last_signal_at:r(e.last_signal_at)??null,active_task_count:d(e.active_task_count),related_session_id:r(e.related_session_id)??null,related_operation_id:r(e.related_operation_id)??null,emoji:r(e.emoji),korean_name:r(e.korean_name),model:r(e.model)??null,recent_output_preview:r(e.recent_output_preview)??null,recent_event:r(e.recent_event)??null}}function ju(e){if(!v(e))return null;const t=r(e.name),n=r(e.note),s=r(e.focus),a=r(e.state);return!t||!n||!s||a!=="healthy"&&a!=="warning"&&a!=="critical"?null:{name:t,agent_name:r(e.agent_name)??null,status:r(e.status),tone:Ki(e.tone),state:a,note:n,focus:s,last_signal_at:r(e.last_signal_at)??null,last_autonomous_action_at:r(e.last_autonomous_action_at)??null,generation:d(e.generation),turn_count:d(e.turn_count),context_ratio:d(e.context_ratio)??null,continuity:r(e.continuity)??null,lifecycle:r(e.lifecycle)??null,related_session_id:r(e.related_session_id)??null,model:r(e.model)??null,emoji:r(e.emoji),korean_name:r(e.korean_name),skill_reason:r(e.skill_reason)??null}}function Ao(e){if(typeof e.seq=="number"&&Number.isFinite(e.seq))return e.seq;const t=Date.parse(e.timestamp);return Number.isNaN(t)?0:t}function Eu(e,t){if(t.length===0)return e;const n=new Map;for(const s of e){const a=typeof s.seq=="number"?`seq:${s.seq}`:`ts:${s.timestamp}|from:${s.from}|content:${s.content}`;n.set(a,s)}for(const s of t){const a=typeof s.seq=="number"?`seq:${s.seq}`:`ts:${s.timestamp}|from:${s.from}|content:${s.content}`;n.set(a,s)}return[...n.values()].sort((s,a)=>Ao(s)-Ao(a)).slice(-500)}function Du(e){return Array.isArray(e)?e.map(t=>{if(!v(t))return null;const n=d(t.ts_unix);if(n==null)return null;const s=v(t.handoff)?t.handoff:null;return{ts:n,context_ratio:d(t.context_ratio)??0,context_tokens:d(t.context_tokens)??0,context_max:d(t.context_max)??0,latency_ms:d(t.latency_ms)??0,generation:d(t.generation)??0,channel:typeof t.channel=="string"?t.channel:"turn",is_handoff:s!=null&&t.handoff_performed===!0,is_compaction:t.compacted===!0,compaction_saved_tokens:d(t.compaction_saved_tokens)??0,compaction_trigger:typeof t.compaction_trigger=="string"?t.compaction_trigger:null,model_used:typeof t.model_used=="string"?t.model_used:"",cost_usd:d(t.cost_usd)??0,handoff_to_model:s&&typeof s.to_model=="string"?s.to_model:null,handoff_new_generation:s?d(s.new_generation)??null:null}}).filter(t=>t!==null):[]}function Co(e){if(!v(e))return null;const t=r(e.health_state),n=r(e.next_action_path),s=r(e.last_reply_status);if(!t||!n||!s)return null;const a=r(e.quiet_reason)??null,o=r(e.summary)??(t==="offline"||t==="degraded"||t==="stale"?"Keeper is not in a healthy reply state. Probe or recover before relying on automation.":a==="quiet_hours"?"Lodge quiet hours are active. Direct messages still work, but scheduled social ticks may look asleep.":a==="min_gap"?"Keeper is inside its proactive cooldown window. Direct messages work now; autonomous check-ins will wait.":a==="never_started"?"Keeper metadata exists but no reply turn has been recorded yet.":"Keeper is reachable. Send a direct message for an immediate response.");return{health_state:t,quiet_reason:a,next_action_path:n,last_reply_status:s,last_reply_at:st(e.last_reply_at)??r(e.last_reply_at)??null,last_reply_preview:r(e.last_reply_preview)??null,last_error:r(e.last_error)??null,next_eligible_at_s:d(e.next_eligible_at_s)??null,recoverable:typeof e.recoverable=="boolean"?e.recoverable:n==="recover",summary:o,keepalive_running:typeof e.keepalive_running=="boolean"?e.keepalive_running:void 0}}function Ou(e,t){return(Array.isArray(e)?e:v(e)&&Array.isArray(e.keepers)?e.keepers:[]).map(s=>{if(!v(s))return null;const a=v(s.agent)?s.agent:null,o=v(s.context)?s.context:null,l=v(s.metrics_window)?s.metrics_window:void 0,c=r(s.name);if(!c)return null;const p=d(s.context_ratio)??d(o==null?void 0:o.context_ratio),m=r(s.status)??r(a==null?void 0:a.status)??"offline",u=Fr(m),_=r(s.model)??r(s.active_model)??r(s.primary_model),f=W(s.skill_secondary),$=o?{source:r(o.source),context_ratio:d(o.context_ratio),context_tokens:d(o.context_tokens),context_max:d(o.context_max),message_count:d(o.message_count),has_checkpoint:typeof o.has_checkpoint=="boolean"?o.has_checkpoint:void 0}:void 0,S=a?{name:r(a.name),exists:typeof a.exists=="boolean"?a.exists:void 0,error:r(a.error),agent_type:r(a.agent_type),status:r(a.status),current_task:r(a.current_task)??null,joined_at:r(a.joined_at),last_seen:r(a.last_seen),last_seen_ago_s:d(a.last_seen_ago_s),capabilities:W(a.capabilities),is_zombie:typeof a.is_zombie=="boolean"?a.is_zombie:void 0}:void 0,h=Du(s.metrics_series),C={name:c,runtime_class:s.runtime_class==="persistent_agent"?"persistent_agent":"resident_keeper",desired:typeof s.desired=="boolean"?s.desired:void 0,resident_registered:typeof s.resident_registered=="boolean"?s.resident_registered:void 0,reconcile_status:r(s.reconcile_status)??null,emoji:r(s.emoji),koreanName:r(s.koreanName)??r(s.korean_name),agent_name:r(s.agent_name),trace_id:r(s.trace_id),model:_,primary_model:r(s.primary_model),active_model:r(s.active_model),next_model_hint:r(s.next_model_hint)??null,status:u,presence_keepalive:typeof s.presence_keepalive=="boolean"?s.presence_keepalive:void 0,presence_keepalive_sec:d(s.presence_keepalive_sec),keepalive_running:typeof s.keepalive_running=="boolean"?s.keepalive_running:void 0,proactive_enabled:typeof s.proactive_enabled=="boolean"?s.proactive_enabled:void 0,proactive_idle_sec:d(s.proactive_idle_sec),proactive_cooldown_sec:d(s.proactive_cooldown_sec),last_heartbeat:r(s.last_heartbeat)??r(a==null?void 0:a.last_seen),generation:d(s.generation),turn_count:d(s.turn_count)??d(s.total_turns),keeper_age_s:d(s.keeper_age_s),last_turn_ago_s:d(s.last_turn_ago_s),last_handoff_ago_s:d(s.last_handoff_ago_s),last_compaction_ago_s:d(s.last_compaction_ago_s),last_proactive_ago_s:d(s.last_proactive_ago_s),last_proactive_preview:r(s.last_proactive_preview)??null,context_ratio:p,context_tokens:d(s.context_tokens)??d(o==null?void 0:o.context_tokens),context_max:d(s.context_max)??d(o==null?void 0:o.context_max),context_source:r(s.context_source)??r(o==null?void 0:o.source),context:$,traits:W(s.traits),interests:W(s.interests),primaryValue:r(s.primaryValue)??r(s.primary_value),activityLevel:d(s.activityLevel)??d(s.activity_level),memory_recent_note:r(s.memory_recent_note)??null,recent_input_preview:r(s.recent_input_preview)??null,recent_output_preview:r(s.recent_output_preview)??null,recent_tool_names:W(s.recent_tool_names)??[],conversation_tail_count:d(s.conversation_tail_count),k2k_count:d(s.k2k_count),handoff_count_total:d(s.handoff_count_total)??d(s.trace_history_count),compaction_count:d(s.compaction_count),last_compaction_saved_tokens:d(s.last_compaction_saved_tokens),diagnostic:Co(s.diagnostic),skill_primary:r(s.skill_primary)??null,skill_secondary:f,skill_reason:r(s.skill_reason)??null,metrics_series:h.length>0?h:void 0,metrics_window:l,agent:S};return C.diagnostic=Co(s.diagnostic)??lu(C,(t==null?void 0:t.lodge)??null),C}).filter(s=>s!==null)}function qu(e){if(!v(e))return;const t=r(e.release_version),n=st(e.started_at),s=d(e.uptime_seconds);if(!(!t||!n||s==null))return{release_version:t,commit:r(e.commit)??null,started_at:n,uptime_seconds:s}}function Kr(e,t){return v(e)?{...e,generated_at:t??st(e.generated_at)??void 0,build:qu(e.build),lodge:iu(e.lodge)??void 0}:null}function Br(e,t){return t?e?{...e,...t,build:t.build??e.build,generated_at:t.generated_at??e.generated_at}:t:e}function Fu(e){const t=typeof e=="string"?e.toLowerCase():"";return t==="running"||t==="interrupted"||t==="completed"||t==="stopped"||t==="error"?t:t.startsWith("error")?"error":"running"}function Ku(e){if(!v(e))return null;const t=d(e.iteration);if(t==null)return null;const n=d(e.metric_before)??0,s=d(e.metric_after)??n,a=v(e.evidence)?e.evidence:null;return{iteration:t,metric_before:n,metric_after:s,delta:d(e.delta)??s-n,changes:r(e.changes)??"",failed_attempts:r(e.failed_attempts)??"",next_suggestion:r(e.next_suggestion)??"",elapsed_ms:d(e.elapsed_ms)??0,cost_usd:d(e.cost_usd)??null,evidence:a?{worker_engine:(a.worker_engine==="api_tool_loop","api_tool_loop"),worker_model:r(a.worker_model)??"",tool_call_count:d(a.tool_call_count)??0,tool_names:W(a.tool_names)??[],session_id:r(a.session_id)??"",evidence_status:a.evidence_status==="legacy_unverified"?"legacy_unverified":"verified"}:null}}function Bu(e){var o,l;if(!v(e))return null;const t=r(e.loop_id);if(!t)return null;const n=d(e.baseline_metric)??0,s=Array.isArray(e.history)?e.history.map(Ku).filter(c=>c!==null):[],a=d(e.current_metric)??((o=s[0])==null?void 0:o.metric_after)??n;return{loop_id:t,profile:r(e.profile)??"unknown",status:Fu(e.status),strict_mode:typeof e.strict_mode=="boolean"?e.strict_mode:void 0,error_message:r(e.error_message)??r(e.error_reason)??null,stop_reason:r(e.stop_reason)??r(e.reason)??null,current_iteration:d(e.current_iteration)??((l=s[0])==null?void 0:l.iteration)??0,max_iterations:d(e.max_iterations)??0,baseline_metric:n,current_metric:a,target:r(e.target)??"",stagnation_streak:d(e.stagnation_streak)??0,stagnation_limit:d(e.stagnation_limit)??0,elapsed_seconds:d(e.elapsed_seconds)??0,updated_at:st(e.updated_at)??null,stopped_at:st(e.stopped_at)??null,execution_mode:e.execution_mode==="worker_spawn"?"worker_spawn":void 0,worker_engine:e.worker_engine==="api_tool_loop"?"api_tool_loop":null,worker_model:r(e.worker_model)??null,evidence_policy:e.evidence_policy==="hard"||e.evidence_policy==="legacy"?e.evidence_policy:void 0,latest_tool_call_count:d(e.latest_tool_call_count)??0,latest_tool_names:W(e.latest_tool_names)??[],session_id:r(e.session_id)??null,evidence_status:e.evidence_status==="legacy_unverified"?"legacy_unverified":e.evidence_status==="verified"?"verified":null,durability:e.durability==="persistent_backend"||e.durability==="memory_only"?e.durability:void 0,persistence_backend:e.persistence_backend==="filesystem"||e.persistence_backend==="postgres"||e.persistence_backend==="memory"?e.persistence_backend:void 0,recoverable:typeof e.recoverable=="boolean"?e.recoverable:void 0,history:s}}async function Jn(){fi.value=!0;try{await Promise.all([Hr(),yt()]),Dr.value=new Date().toISOString()}catch(e){console.error("Dashboard refresh error:",e)}finally{fi.value=!1}}async function Ur(){qs.value=!0,Fs.value=null;try{const e=await ed();Fi.value=e,xu.value=new Date().toISOString()}catch(e){Fs.value=e instanceof Error?e.message:"Failed to load dashboard semantics"}finally{qs.value=!1}}function Uu(e){var t;return((t=Fi.value)==null?void 0:t.surfaces.find(n=>n.id===e))??null}function Hu(e){var n;const t=((n=Fi.value)==null?void 0:n.surfaces)??[];for(const s of t){const a=s.panels.find(o=>o.id===e);if(a)return a}return null}function Wu(e){var s,a;Bt.value=(Array.isArray(e.goals)?e.goals:[]).map(o=>{if(!v(o))return null;const l=r(o.id),c=r(o.title),p=r(o.horizon),m=r(o.status),u=r(o.created_at),_=r(o.updated_at);return!l||!c||!p||!m||!u||!_?null:{id:l,horizon:p,title:c,metric:r(o.metric)??null,target_value:r(o.target_value)??null,due_date:r(o.due_date)??null,priority:d(o.priority)??3,status:m,parent_goal_id:r(o.parent_goal_id)??null,last_review_note:r(o.last_review_note)??null,last_review_at:r(o.last_review_at)??null,created_at:u,updated_at:_}}).filter(o=>o!==null);const t=new Map,n=Array.isArray((s=e.mdal)==null?void 0:s.loops)?e.mdal.loops:[];for(const o of n){const l=Bu(o);l&&t.set(l.loop_id,l)}Er.value=t,Ut.value=typeof((a=e.mdal)==null?void 0:a.error)=="string"?e.mdal.error:null,qi.value=Ut.value?"error":t.size===0?"idle":"ready"}async function Hr(){try{const e=await Yc(),t=Kr(e.status,e.generated_at);t&&(ie.value=Br(ie.value,t))}catch(e){console.error("Dashboard shell fetch error:",e)}}async function yt(){var e;try{const t=await Qc(),n=Kr(t.status,t.generated_at),s=(e=ie.value)==null?void 0:e.room;n&&(ie.value=Br(ie.value,n));const a=s!=null&&(n==null?void 0:n.room)!=null&&s!==n.room;Be.value=(Array.isArray(t.agents)?t.agents:[]).map(Ru).filter(l=>l!==null),Ye.value=(Array.isArray(t.tasks)?t.tasks:[]).map(wu).filter(l=>l!==null);const o=(Array.isArray(t.messages)?t.messages:[]).map(Pu).filter(l=>l!==null);_i.value=a?o:Eu(_i.value,o),lt.value=Ou(t.keepers,n??ie.value),Rr.value=Nu(t.summary),wr.value=(Array.isArray(t.execution_queue)?t.execution_queue:Array.isArray(t.priority_queue)?t.priority_queue:[]).map(Lu).filter(l=>l!==null),Pr.value=(Array.isArray(t.session_briefs)?t.session_briefs:[]).map(zu).filter(l=>l!==null),Nr.value=(Array.isArray(t.operation_briefs)?t.operation_briefs:[]).map(Mu).filter(l=>l!==null),Lr.value=(Array.isArray(t.worker_support_briefs)?t.worker_support_briefs:Array.isArray(t.worker_briefs)?t.worker_briefs:[]).map(So).filter(l=>l!==null),zr.value=(Array.isArray(t.continuity_briefs)?t.continuity_briefs:[]).map(ju).filter(l=>l!==null),Mr.value=(Array.isArray(t.offline_worker_briefs)?t.offline_worker_briefs:[]).map(So).filter(l=>l!==null),yu.value=null,Dr.value=new Date().toISOString()}catch(t){console.error("Dashboard execution fetch error:",t)}}async function Xe(){Rn.value=!0;try{const e=await Xc(Tn.value,{excludeSystem:ht.value});xa.value=e.posts??[],hi.value=new Date().toISOString()}catch(e){console.error("Board fetch error:",e)}finally{Rn.value=!1}}async function Ze(){var e;$i.value=!0;try{const t=qe.value||((e=ie.value)==null?void 0:e.room)||"default";qe.value||(qe.value=t);const n=await Ed(t);jr.value=n}catch(t){console.error("TRPG fetch error:",t)}finally{$i.value=!1}}async function Bi(){fn.value=!0,$n.value=!0;try{const e=await id();Wu(e),bu.value=new Date().toISOString(),ku.value=new Date().toISOString()}catch(e){console.error("Planning fetch error:",e),qi.value="error",Ut.value=e instanceof Error?e.message:String(e)}finally{fn.value=!1,$n.value=!1}}async function Wr(){return Bi()}let Cs=null;function Gu(e){Cs=e}let Is=null;function Ju(e){Is=e}let Ts=null;function Vu(e){Ts=e}const bt={};let La=null;function _t(e,t,n=500){bt[e]&&clearTimeout(bt[e]),bt[e]=setTimeout(()=>{t(),delete bt[e]},n)}function Yu(){const e=ur.subscribe(t=>{if(t){if(t.type==="keeper_heartbeat"&&t.name){const n=new Map(gi.value);n.set(t.name,t.ts_unix?t.ts_unix*1e3:Date.now()),gi.value=n;return}(t.type==="agent_joined"||t.type==="agent_left")&&_t("execution",yt),Iu(t.type)&&(La||(La=setTimeout(()=>{Jn(),Is==null||Is(),Ts==null||Ts(),La=null},500))),(t.type.startsWith("task_")||t.type.startsWith("masc/task_"))&&_t("execution",yt),t.type==="broadcast"&&_t("execution",yt),(t.type==="keeper_handoff"||t.type==="keeper_compaction"||t.type==="keeper_guardrail")&&_t("execution",yt),(t.type==="board_post"||t.type==="masc/board_post"||t.type==="board_comment"||t.type==="masc/board_comment")&&_t("board",Xe),t.type.startsWith("decision_")&&_t("council",()=>Cs==null?void 0:Cs()),(t.type==="mdal_started"||t.type==="mdal_iteration"||t.type==="mdal_completed"||t.type==="mdal_stopped")&&_t("mdal",Wr,350)}});return()=>{e();for(const t of Object.keys(bt))clearTimeout(bt[t]),delete bt[t]}}let hn=null;function Qu(){hn||(hn=setInterval(()=>{nt.value,Jn()},1e4))}function Xu(){hn&&(clearInterval(hn),hn=null)}function Zu({metric:e}){return i`
  ...
  `}function ep({panel:e}){return i`
    <div class="semantic-body">
      ...
      ${e.metrics.length>0?i`<div class="semantic-metric-list">
            ${e.metrics.map(t=>i`<${Zu} key=${t.id} metric=${t} />`)}
          </div>`:null}
    </div>
  `}function q({panelId:e,compact:t=!1,label:n="Why"}){const s=Hu(e);return s?i`
    <details class="semantic-inline ${t?"compact":""}">
      <summary class="semantic-summary">${n}</summary>
      <${ep} panel=${s} />
    </details>
  `:qs.value?i`<span class="semantic-inline-state">Loading semantics…</span>`:null}function ye({surfaceId:e,compact:t=!1}){const n=Uu(e);return n?i`
  ...
  `:qs.value?i`<div class="semantic-surface-card ${t?"compact":""}">Loading semantics…</div>`:Fs.value?i`<div class="semantic-surface-card ${t?"compact":""}">${Fs.value}</div>`:null}function I({title:e,class:t,semanticId:n,testId:s,children:a}){return i`
  ...
  `}const Vn=g(null),yi=g(!1),Ks=g(null),Gr=g(null),Mt=g(!1),$t=g(null),bi=g(null),Rs=g(!1),ws=g(null);let Ht=null;function Io(){Ht!==null&&(window.clearTimeout(Ht),Ht=null)}function tp(e=1500){Ht===null&&(Ht=window.setTimeout(()=>{Ht=null,Bs(!1)},e))}function j(e){return typeof e=="object"&&e!==null&&!Array.isArray(e)}function y(e){return typeof e=="string"&&e.trim()!==""?e:void 0}function D(e){return typeof e=="number"&&Number.isFinite(e)?e:void 0}function Wt(e){return typeof e=="boolean"?e:void 0}function U(e,t=[]){if(Array.isArray(e))return e;if(!j(e))return[];for(const n of t){const s=e[n];if(Array.isArray(s))return s}return[]}function rn(e){if(!j(e))return null;const t=y(e.kind),n=y(e.summary),s=y(e.target_type);return!t||!n||!s?null:{kind:t,severity:y(e.severity)??"warn",summary:n,target_type:s,target_id:y(e.target_id)??null,actor:y(e.actor)??null,evidence:e.evidence}}function It(e){if(!j(e))return null;const t=y(e.action_type),n=y(e.target_type),s=y(e.reason);return!t||!n||!s?null:{action_type:t,target_type:n,target_id:y(e.target_id)??null,severity:y(e.severity)??"warn",reason:s,confirm_required:Wt(e.confirm_required),suggested_payload:e.suggested_payload,preview:e.preview}}function np(e){if(!j(e))return null;const t=y(e.session_id);return t?{session_id:t,goal:y(e.goal),status:y(e.status),health:y(e.health),scale_profile:y(e.scale_profile),control_profile:y(e.control_profile),planned_worker_count:D(e.planned_worker_count),active_agent_count:D(e.active_agent_count),last_turn_age_sec:D(e.last_turn_age_sec)??null,attention_count:D(e.attention_count),recommended_action_count:D(e.recommended_action_count),top_attention:rn(e.top_attention),top_recommendation:It(e.top_recommendation)}:null}function sp(e){if(!j(e))return null;const t=y(e.session_id);if(!t)return null;const n=j(e.status)?e.status:e,s=j(n.summary)?n.summary:void 0;return{session_id:t,status:y(e.status)??y(s==null?void 0:s.status)??(j(n.session)?y(n.session.status):void 0),progress_pct:D(e.progress_pct)??D(s==null?void 0:s.progress_pct),elapsed_sec:D(e.elapsed_sec)??D(s==null?void 0:s.elapsed_sec),remaining_sec:D(e.remaining_sec)??D(s==null?void 0:s.remaining_sec),done_delta_total:D(e.done_delta_total)??D(s==null?void 0:s.done_delta_total),summary:j(e.summary)?e.summary:s,team_health:j(e.team_health)?e.team_health:j(n.team_health)?n.team_health:void 0,communication_metrics:j(e.communication_metrics)?e.communication_metrics:j(n.communication_metrics)?n.communication_metrics:void 0,orchestration_state:j(e.orchestration_state)?e.orchestration_state:j(n.orchestration_state)?n.orchestration_state:void 0,cascade_metrics:j(e.cascade_metrics)?e.cascade_metrics:j(n.cascade_metrics)?n.cascade_metrics:void 0,report_paths:j(e.report_paths)?Object.fromEntries(Object.entries(e.report_paths).map(([a,o])=>{const l=y(o);return l?[a,l]:null}).filter(a=>a!==null)):j(n.report_paths)?Object.fromEntries(Object.entries(n.report_paths).map(([a,o])=>{const l=y(o);return l?[a,l]:null}).filter(a=>a!==null)):void 0,session:j(e.session)?e.session:j(n.session)?n.session:void 0,recent_events:U(e.recent_events,["events"]).filter(j)}}function ap(e){if(!j(e))return null;const t=y(e.name);return t?{name:t,agent_name:y(e.agent_name),status:y(e.status),autonomy_level:y(e.autonomy_level),context_ratio:D(e.context_ratio),generation:D(e.generation),active_goal_ids:U(e.active_goal_ids).map(n=>typeof n=="string"?n.trim():"").filter(Boolean),last_autonomous_action_at:y(e.last_autonomous_action_at)??null,last_turn_ago_s:D(e.last_turn_ago_s),model:y(e.model)}:null}function ip(e){if(!j(e))return null;const t=y(e.confirm_token)??y(e.token);return t?{confirm_token:t,actor:y(e.actor),action_type:y(e.action_type),target_type:y(e.target_type),target_id:y(e.target_id)??null,delegated_tool:y(e.delegated_tool),created_at:y(e.created_at),preview:e.preview}:null}function op(e){if(!j(e))return null;const t=y(e.action_type),n=y(e.target_type);return!t||!n?null:{action_type:t,target_type:n,description:y(e.description),confirm_required:Wt(e.confirm_required)}}function rp(e){const t=j(e)?e:{};return{room_health:y(t.room_health),cluster:y(t.cluster),project:y(t.project),current_room:y(t.current_room)??null,paused:Wt(t.paused),tempo_interval_s:D(t.tempo_interval_s),active_agents:D(t.active_agents),keeper_pressure:D(t.keeper_pressure),active_operations:D(t.active_operations),pending_approvals:D(t.pending_approvals),incident_count:D(t.incident_count),recommended_action_count:D(t.recommended_action_count),top_attention:rn(t.top_attention),top_action:It(t.top_action)}}function lp(e){const t=j(e)?e:{},n=j(t.swarm_overview)?t.swarm_overview:{};return{health:y(t.health),active_operations:D(t.active_operations),pending_approvals:D(t.pending_approvals),swarm_overview:{active_lanes:D(n.active_lanes),moving_lanes:D(n.moving_lanes),stalled_lanes:D(n.stalled_lanes),projected_lanes:D(n.projected_lanes),last_movement_at:y(n.last_movement_at)??null},top_attention:rn(t.top_attention),top_action:It(t.top_action),session_cards:U(t.session_cards).map(np).filter(s=>s!==null)}}function cp(e){const t=j(e)?e:{};return{sessions:U(t.sessions,["items"]).map(sp).filter(n=>n!==null),keepers:U(t.keepers,["items"]).map(ap).filter(n=>n!==null),pending_confirms:U(t.pending_confirms).map(ip).filter(n=>n!==null),available_actions:U(t.available_actions).map(op).filter(n=>n!==null)}}function dp(e){if(!j(e))return null;const t=y(e.id),n=y(e.kind),s=y(e.summary),a=y(e.target_type);return!t||!n||!s||!a?null:{id:t,kind:n,severity:y(e.severity)??"warn",summary:s,target_type:a,target_id:y(e.target_id)??null,top_action:It(e.top_action),related_session_ids:U(e.related_session_ids).map(o=>typeof o=="string"?o.trim():"").filter(Boolean),related_agent_names:U(e.related_agent_names).map(o=>typeof o=="string"?o.trim():"").filter(Boolean),evidence_preview:U(e.evidence_preview).map(o=>typeof o=="string"?o.trim():"").filter(Boolean),last_seen_at:y(e.last_seen_at)??null}}function Jr(e){if(!j(e))return null;const t=y(e.session_id),n=y(e.goal);return!t||!n?null:{session_id:t,goal:n,room:y(e.room)??null,status:y(e.status),health:y(e.health),member_names:U(e.member_names).map(s=>typeof s=="string"?s.trim():"").filter(Boolean),started_at:y(e.started_at)??null,elapsed_sec:D(e.elapsed_sec)??null,operation_id:y(e.operation_id)??null,blocker_summary:y(e.blocker_summary)??null,last_event_at:y(e.last_event_at)??null,last_event_summary:y(e.last_event_summary)??null,communication_summary:y(e.communication_summary)??null,active_count:D(e.active_count),required_count:D(e.required_count),related_attention_count:D(e.related_attention_count)??0,top_attention:rn(e.top_attention),top_recommendation:It(e.top_recommendation)}}function Vr(e){if(!j(e))return null;const t=y(e.agent_name);return t?{agent_name:t,status:y(e.status),current_work:y(e.current_work)??null,recent_input_preview:y(e.recent_input_preview)??null,recent_output_preview:y(e.recent_output_preview)??null,recent_tool_names:U(e.recent_tool_names).map(n=>typeof n=="string"?n.trim():"").filter(Boolean),last_activity_at:y(e.last_activity_at)??null}:null}function Yr(e){if(!j(e))return null;const t=y(e.operation_id);return t?{operation_id:t,status:y(e.status),stage:y(e.stage)??null,detachment_status:y(e.detachment_status)??null,objective:y(e.objective)??null,updated_at:y(e.updated_at)??null}:null}function Qr(e){if(!j(e))return null;const t=y(e.name);return t?{name:t,agent_name:y(e.agent_name)??null,status:y(e.status),generation:D(e.generation),context_ratio:D(e.context_ratio)??null,last_turn_ago_s:D(e.last_turn_ago_s)??null,current_work:y(e.current_work)??null}:null}function Xr(e){const t=Jr(e);return t?{...t,member_previews:U(j(e)?e.member_previews:void 0).map(Vr).filter(n=>n!==null),operation_badges:U(j(e)?e.operation_badges:void 0).map(Yr).filter(n=>n!==null),keeper_refs:U(j(e)?e.keeper_refs:void 0).map(Qr).filter(n=>n!==null)}:null}function up(e){if(!j(e))return null;const t=y(e.agent_name);return t?{agent_name:t,status:y(e.status),where:y(e.where)??null,with_whom:U(e.with_whom).map(n=>typeof n=="string"?n.trim():"").filter(Boolean),current_work:y(e.current_work)??null,related_session_id:y(e.related_session_id)??null,related_attention_count:D(e.related_attention_count)??0,last_activity_at:y(e.last_activity_at)??null,recent_output_preview:y(e.recent_output_preview)??null,recent_input_preview:y(e.recent_input_preview)??null,recent_event:y(e.recent_event)??null,recent_tool_names:U(e.recent_tool_names).map(n=>typeof n=="string"?n.trim():"").filter(Boolean),allowed_tool_names:U(e.allowed_tool_names).map(n=>typeof n=="string"?n.trim():"").filter(Boolean),latest_tool_names:U(e.latest_tool_names).map(n=>typeof n=="string"?n.trim():"").filter(Boolean),latest_tool_call_count:D(e.latest_tool_call_count)??null,tool_audit_source:y(e.tool_audit_source)??null,tool_audit_at:y(e.tool_audit_at)??null}:null}function pp(e){if(!j(e))return null;const t=y(e.name);return t?{name:t,agent_name:y(e.agent_name)??null,status:y(e.status),generation:D(e.generation),context_ratio:D(e.context_ratio)??null,last_turn_ago_s:D(e.last_turn_ago_s)??null,current_work:y(e.current_work)??null,last_autonomous_action_at:y(e.last_autonomous_action_at)??null,allowed_tool_names:U(e.allowed_tool_names).map(n=>typeof n=="string"?n.trim():"").filter(Boolean),latest_tool_names:U(e.latest_tool_names).map(n=>typeof n=="string"?n.trim():"").filter(Boolean),latest_tool_call_count:D(e.latest_tool_call_count)??null,tool_audit_source:y(e.tool_audit_source)??null,tool_audit_at:y(e.tool_audit_at)??null}:null}function mp(e){if(!j(e))return null;const t=y(e.id),n=y(e.signal_type),s=y(e.summary),a=y(e.target_type);return!t||!n||!s||!a?null:{id:t,signal_type:n==="action"?"action":"attention",severity:y(e.severity)??"warn",summary:s,target_type:a,target_id:y(e.target_id)??null,attention:rn(e.attention),action:It(e.action)}}function vp(e){const t=j(e)?e:{},n=U(t.session_briefs).map(Jr).filter(a=>a!==null),s=U(t.sessions).map(Xr).filter(a=>a!==null);return{generated_at:y(t.generated_at),summary:rp(t.summary),incidents:U(t.incidents).map(rn).filter(a=>a!==null),recommended_actions:U(t.recommended_actions).map(It).filter(a=>a!==null),command_focus:lp(t.command_focus),operator_targets:cp(t.operator_targets),attention_queue:U(t.attention_queue).map(dp).filter(a=>a!==null),sessions:s.length>0?s:n.map(a=>({...a,member_previews:[],operation_badges:[],keeper_refs:[]})),session_briefs:n,agent_briefs:U(t.agent_briefs).map(up).filter(a=>a!==null),keeper_briefs:U(t.keeper_briefs).map(pp).filter(a=>a!==null),internal_signals:U(t.internal_signals).map(mp).filter(a=>a!==null)}}function _p(e){if(!j(e))return null;const t=y(e.id),n=y(e.summary);return!t||!n?null:{id:t,timestamp:y(e.timestamp)??null,event_type:y(e.event_type),actor:y(e.actor)??null,summary:n}}function gp(e){const t=j(e)?e:{};return{generated_at:y(t.generated_at),session_id:y(t.session_id)??"",session:Xr(t.session),timeline:U(t.timeline).map(_p).filter(n=>n!==null),participants:U(t.participants).map(Vr).filter(n=>n!==null),operations:U(t.operations).map(Yr).filter(n=>n!==null),keepers:U(t.keepers).map(Qr).filter(n=>n!==null),error:y(t.error)??null}}function fp(e){if(!j(e))return null;const t=y(e.id),n=y(e.label),s=y(e.summary);if(!t||!n||!s)return null;const a=y(e.status)??"unclear";return{id:t,label:n,status:a==="ok"||a==="healthy"||a==="aligned"||a==="watch"||a==="risk"||a==="unclear"?a:"unclear",summary:s,signal_class:y(e.signal_class)==="metadata_gap"||y(e.signal_class)==="mixed"||y(e.signal_class)==="operational_risk"?y(e.signal_class):void 0,evidence_quality:y(e.evidence_quality)==="strong"||y(e.evidence_quality)==="partial"||y(e.evidence_quality)==="missing"?y(e.evidence_quality):void 0,evidence:U(e.evidence).map(l=>typeof l=="string"?l.trim():"").filter(Boolean)}}function $p(e){if(!j(e))return null;const t=y(e.kind),n=y(e.summary),s=y(e.scope_type),a=y(e.severity);return!t||!n||!s||!a||s!=="session"&&s!=="keeper"&&s!=="agent"||a!=="info"&&a!=="watch"?null:{kind:t,summary:n,scope_type:s,scope_id:y(e.scope_id)??null,severity:a}}function hp(e){const t=j(e)?e:{},n=j(t.basis)?t.basis:{},s=y(t.status)??"error",a=s==="ok"||s==="pending"||s==="unavailable"||s==="error"?s:"error";return{generated_at:y(t.generated_at),cached:Wt(t.cached),stale:Wt(t.stale),refreshing:Wt(t.refreshing),status:a,summary:y(t.summary)??null,model:y(t.model)??null,ttl_sec:D(t.ttl_sec),criteria:U(t.criteria).map(o=>typeof o=="string"?o.trim():"").filter(Boolean),basis:{current_room:y(n.current_room)??null,crew_count:D(n.crew_count),agent_count:D(n.agent_count),keeper_count:D(n.keeper_count)},metadata_gap_count:D(t.metadata_gap_count),metadata_gaps:U(t.metadata_gaps).map($p).filter(o=>o!==null),sections:U(t.sections).map(fp).filter(o=>o!==null),error:y(t.error)??null,last_error:y(t.last_error)??null}}async function Zr(){yi.value=!0,Ks.value=null;try{const e=await td();Vn.value=vp(e)}catch(e){Ks.value=e instanceof Error?e.message:"Failed to load mission snapshot"}finally{yi.value=!1}}async function yp(e){if(!e){bi.value=null,ws.value=null,Rs.value=!1;return}Rs.value=!0,ws.value=null;try{const t=await nd(e);bi.value=gp(t)}catch(t){ws.value=t instanceof Error?t.message:"Failed to load session detail"}finally{Rs.value=!1}}async function Bs(e=!1){Mt.value=!0,$t.value=null;try{const t=await sd(e),n=hp(t);Gr.value=n,n.refreshing||n.status==="pending"?tp():Io()}catch(t){$t.value=t instanceof Error?t.message:"Failed to load mission briefing",Io()}finally{Mt.value=!1}}const Us="masc_dashboard_workflow_context",bp=900*1e3;function ge(e){return typeof e=="string"&&e.trim()!==""?e.trim():null}function He(e){const t=ge(e);return t||(typeof e=="number"&&Number.isFinite(e)?String(e):null)}function el(){if(typeof window>"u")return null;try{return window.sessionStorage}catch{return null}}function ki(e){return v(e)?e:null}function kp(e){if(!e)return null;try{return JSON.stringify(e)}catch{return null}}function xp(e){if(!e)return null;try{const t=JSON.parse(e);if(!v(t))return null;const n=ge(t.id),s=ge(t.source_surface),a=ge(t.source_label),o=ge(t.summary),l=ge(t.created_at);return!n||s!=="mission"&&s!=="execution"||!a||!o||!l?null:{id:n,source_surface:s,source_label:a,action_type:ge(t.action_type),target_type:ge(t.target_type),target_id:ge(t.target_id),focus_kind:ge(t.focus_kind),operation_id:ge(t.operation_id),command_surface:ge(t.command_surface),summary:o,payload_preview:ge(t.payload_preview),suggested_payload:ki(t.suggested_payload),preview:t.preview??null,evidence:t.evidence??null,created_at:l}}catch{return null}}function Ui(e){const t=Date.parse(e.created_at);return Number.isNaN(t)?!1:Date.now()-t<=bp}function Sp(){const e=el(),t=xp((e==null?void 0:e.getItem(Us))??null);return t?Ui(t)?t:(e==null||e.removeItem(Us),null):null}const tl=g(Sp());function nl(e){const t=e&&Ui(e)?e:null;tl.value=t;const n=el();if(!n)return;if(!t){n.removeItem(Us);return}const s=kp(t);s&&n.setItem(Us,s)}function Ap(e){if(!e)return null;const t=ki(e.suggested_payload);if(t)return t;if(v(e.preview)){const n=ki(e.preview.payload);if(n)return n}return null}function Cp(e){if(!e)return null;const t=He(e.message);if(t)return t;const n=He(e.task_title)??He(e.title),s=He(e.task_description)??He(e.description),a=He(e.reason),o=He(e.priority)??He(e.task_priority);return n&&s?`${n} · ${s}`:n&&o?`${n} · P${o}`:n||s||a||null}function Hi(e,t,n,s,a,o,l,c){return[e,t,n??"action",s??"target",a??"room",o??"focus",l??"operation",c].join(":")}function ln(e,t,n="상황판 추천 액션"){const s=new Date().toISOString(),a=Ap(e),o=(e==null?void 0:e.target_type)??(t==null?void 0:t.target_type)??null,l=(e==null?void 0:e.target_id)??(t==null?void 0:t.target_id)??null,c=(t==null?void 0:t.kind)??(e==null?void 0:e.action_type)??null,p=(e==null?void 0:e.reason)??(t==null?void 0:t.summary)??n;return{id:Hi("mission",n,(e==null?void 0:e.action_type)??null,o,l,c,null,s),source_surface:"mission",source_label:n,action_type:(e==null?void 0:e.action_type)??null,target_type:o,target_id:l,focus_kind:c,operation_id:null,command_surface:null,summary:p,payload_preview:Cp(a),suggested_payload:a,preview:(e==null?void 0:e.preview)??null,evidence:(t==null?void 0:t.evidence)??null,created_at:s}}function Ip({targetType:e,targetId:t,focusKind:n,sourceLabel:s="Execution 진단",summary:a,operationId:o=null,commandSurface:l=null}){const c=new Date().toISOString();return{id:Hi("execution",s,null,e,t,n,o,c),source_surface:"execution",source_label:s,action_type:null,target_type:e,target_id:t,focus_kind:n,operation_id:o,command_surface:l,summary:a,payload_preview:null,suggested_payload:null,preview:null,evidence:null,created_at:c}}function Tp(e,t){return(t.source==="mission"||t.source==="execution")&&(t.action_type??null)===(e.action_type??null)&&(t.target_type??null)===(e.target_type??null)&&(t.target_id??null)===(e.target_id??null)&&(t.focus_kind??null)===(e.focus_kind??null)&&(t.operation_id??null)===(e.operation_id??null)}function Yn(e){const{params:t}=e;if(t.source!=="mission"&&t.source!=="execution")return null;const n=tl.value;if(n&&Ui(n)&&Tp(n,t))return n;const s=new Date().toISOString(),a=t.source==="execution"?"execution":"mission";return{id:Hi(a,a==="execution"?"Execution 이어보기":"상황판 이어보기",t.action_type??null,t.target_type??null,t.target_id??null,t.focus_kind??null,t.operation_id??null,s),source_surface:a,source_label:a==="execution"?"Execution 이어보기":"상황판 이어보기",action_type:t.action_type??null,target_type:t.target_type??null,target_id:t.target_id??null,focus_kind:t.focus_kind??t.action_type??null,operation_id:t.operation_id??null,command_surface:t.surface??null,summary:a==="execution"?t.focus_kind?`${t.focus_kind} 기준으로 열린 execution 컨텍스트입니다.`:"Execution에서 이어진 컨텍스트입니다.":t.focus_kind?`${t.focus_kind} 기준으로 열린 컨텍스트입니다.`:"상황판에서 이어진 컨텍스트입니다.",payload_preview:null,suggested_payload:null,preview:null,evidence:null,created_at:s}}function sl(e){return{source:e.source_surface,...e.action_type?{action_type:e.action_type}:{},...e.target_type?{target_type:e.target_type}:{},...e.target_id?{target_id:e.target_id}:{},...e.focus_kind?{focus_kind:e.focus_kind}:{},...e.operation_id?{operation_id:e.operation_id}:{}}}function al(e){if(e.command_surface)return e.command_surface;const t=[e.focus_kind,e.summary,e.action_type].filter(n=>typeof n=="string"&&n.trim()!=="").join(" ").toLowerCase();return t.includes("artifact_scope")||t.includes("routing_confidence")||t.includes("cache_contention")?"summary":t.includes("stale_data")||t.includes("leader_offline")||t.includes("roster_offline")||t.includes("managed")||t.includes("swarm")?"swarm":e.focus_kind==="operation"||e.target_type==="operation"?"operations":e.target_type==="room"?"summary":"swarm"}function il(e){return{source:e.source_surface,surface:al(e),...e.action_type?{action_type:e.action_type}:{},...e.target_type?{target_type:e.target_type}:{},...e.target_id?{target_id:e.target_id}:{},...e.focus_kind?{focus_kind:e.focus_kind}:{},...e.operation_id?{operation_id:e.operation_id}:{}}}function Rp(e){return sl(e)}function wp(e){return il(e)}function Wi(e){return e!=null&&e.target_type?e.target_id?`${e.target_type} · ${e.target_id}`:e.target_type:"대상 정보 없음"}function Sa(e){switch(e){case"broadcast":return"room 방송";case"room_pause":return"room 일시정지";case"room_resume":return"room 재개";case"task_inject":return"room 작업 주입";case"team_turn":return"session 업데이트";case"team_note":return"session 노트";case"team_broadcast":return"session 방송";case"team_task_inject":return"session 작업";case"team_stop":return"session 중지";case"keeper_msg":case"keeper_message":return"keeper 메시지";case"keeper_probe":return"keeper probe";case"keeper_recover":return"keeper recover";case"swarm_run_continue":return"swarm run 계속";case"swarm_run_rerun":return"swarm run 재실행";case"swarm_run_abandon":return"swarm run 포기";default:return(e==null?void 0:e.trim())||"추천 액션"}}function Pp(e){switch(e){case"warroom":return"워룸";case"summary":return"요약";case"swarm":return"스웜";case"chains":return"체인";case"topology":return"토폴로지";case"alerts":return"알림";case"trace":return"트레이스";case"control":return"제어";case"operations":return"작전";default:return(e==null?void 0:e.trim())||"지휘"}}const Oe=g(null),Ve=g(null);function Ie(e,t=120){const n=(e??"").replace(/\s+/g," ").trim();return n?n.length>t?`${n.slice(0,t-1)}…`:n:null}function me(e){return e==="bad"||e==="offline"||e==="critical"||e==="risk"?"bad":e==="warn"||e==="pending"||e==="degraded"||e==="interrupted"||e==="watch"?"warn":"ok"}function Le(e){if(!e)return"방금";const t=Date.parse(e);if(Number.isNaN(t))return e;const n=Math.max(0,Math.round((Date.now()-t)/1e3));return n<60?`${n}s 전`:n<3600?`${Math.round(n/60)}m 전`:n<86400?`${Math.round(n/3600)}h 전`:`${Math.round(n/86400)}d 전`}function Np(e){return typeof e!="number"||!Number.isFinite(e)||e<0?"n/a":e<60?`${Math.round(e)}s`:e<3600?`${Math.round(e/60)}m`:e<86400?`${Math.round(e/3600)}h`:`${Math.round(e/86400)}d`}function Lp(e){return e!=null&&e.confirm_required?"확인 후 실행":"즉시 실행"}function zp(e){return Wi(e?ln(e,null,"상황판 추천 액션"):null)}function Aa(e,t=ln()){nl(t),ce(e,e==="intervene"?Rp(t):wp(t))}function ol(e){Aa("intervene",ln(null,e,"상황판 incident"))}function rl(e){Aa("command",ln(null,e,"상황판 incident"))}function Gi(e,t,n="상황판 추천 액션"){Aa("intervene",ln(e,t,n))}function ll(e,t,n="상황판 추천 액션"){Aa("command",ln(e,t,n))}function xi(e,t){const n={source:"mission",target_type:"team_session",target_id:t,focus_kind:"team_session"};e==="command"&&(n.surface="swarm"),ce(e,n)}function Mp(e){return{kind:e.kind,severity:e.severity,summary:e.summary,target_type:e.target_type,target_id:e.target_id??null,actor:null,evidence:e.evidence_preview}}function jp(e){var n,s;const t=lt.value.find(a=>a.name===e.name||a.agent_name===e.agent_name)??null;return{brief:e,keeper:t,currentWork:Ie(e.current_work,110)??Ie(t==null?void 0:t.skill_primary,110)??Ie(t==null?void 0:t.last_proactive_reason,110)??"명시된 keeper focus 없음",recentInput:Ie(t==null?void 0:t.recent_input_preview,120)??null,recentOutput:Ie(t==null?void 0:t.recent_output_preview,120)??Ie((n=t==null?void 0:t.diagnostic)==null?void 0:n.last_reply_preview,120)??Ie(t==null?void 0:t.last_proactive_preview,120)??null,recentEvent:Ie(t==null?void 0:t.last_proactive_reason,120)??Ie((s=t==null?void 0:t.diagnostic)==null?void 0:s.summary,120)??null,recentTools:(t==null?void 0:t.recent_tool_names)??[]}}function Ep(){const e=Vn.value;if(!e)return new Map;const t=e.sessions.length>0?e.sessions:e.session_briefs;return new Map(t.map(n=>[n.session_id,n]))}function Dp(e){Oe.value=Oe.value===e?null:e,Ve.value=null}function cl(e){Ve.value=Ve.value===e?null:e,Oe.value=null}function Op(){Oe.value=null,Ve.value=null}function ct({status:e,label:t}){return i`
    <span class="status-badge ${e}">
      <span class="status-dot-inline ${e}"></span>
      ${t??e}
    </span>
  `}function dl(e){const t=Date.now(),n=typeof e=="number"?e<1e12?e*1e3:e:new Date(e).getTime(),s=Math.floor((t-n)/1e3);if(s<60)return`${s}s ago`;const a=Math.floor(s/60);if(a<60)return`${a}m ago`;const o=Math.floor(a/60);return o<24?`${o}h ago`:`${Math.floor(o/24)}d ago`}function G({timestamp:e}){const t=dl(e),n=typeof e=="string"?e:new Date(e<1e12?e*1e3:e).toISOString();return i`<span class="time-ago" title=${n}>${t}</span>`}let qp=0;const kt=g([]);function z(e,t="success",n=4e3){const s=++qp;kt.value=[...kt.value,{id:s,message:e,type:t}],setTimeout(()=>{kt.value=kt.value.filter(a=>a.id!==s)},n)}function Fp(e){kt.value=kt.value.filter(t=>t.id!==e)}function Kp(){const e=kt.value;return e.length===0?null:i`
    <div class="toast-container">
      ${e.map(t=>i`
        <div key=${t.id} class="toast ${t.type}" onClick=${()=>Fp(t.id)}>
          ${t.message}
        </div>
      `)}
    </div>
  `}const Bp="masc_dashboard_agent_name",cn=g(null),Hs=g(!1),wn=g(""),Ws=g([]),Pn=g([]),Gt=g(""),yn=g(!1);function Ca(e){cn.value=e,Ji()}function To(){cn.value=null,wn.value="",Ws.value=[],Pn.value=[],Gt.value=""}function Up(){const e=cn.value;return e?Be.value.find(t=>t.name===e)??null:null}function ul(e){return e?Ye.value.filter(t=>t.assignee===e):[]}function pl(e){return e?lt.value.find(t=>t.agent_name===e||t.name===e)??null:null}function Hp(e){if(!e)return null;const t=Vn.value;return t?t.agent_briefs.find(n=>n.agent_name===e)??null:null}function Wp(e){if(!e)return[];const t=e.metrics_window;return(Array.isArray(t==null?void 0:t.top_tools)?t.top_tools:[]).map(s=>typeof s=="object"&&s!==null&&"tool"in s&&typeof s.tool=="string"?s.tool:null).filter(s=>s!==null)}function Gp(e){const t=pl(e);return t?t.recent_tool_names&&t.recent_tool_names.length>0?t.recent_tool_names:[]:[]}async function Ji(){const e=cn.value;if(e){Hs.value=!0,wn.value="",Ws.value=[],Pn.value=[];try{const t=await Gd(80);Ws.value=t.filter(a=>a.includes(e)).slice(0,20);const n=ul(e).slice(0,6);if(n.length===0)return;const s=await Promise.all(n.map(async a=>{try{const o=await Jd(a.id,25);return{taskId:a.id,text:o.trim()}}catch(o){const l=o instanceof Error?o.message:"history load failed";return{taskId:a.id,text:`Failed to load history: ${l}`}}}));Pn.value=s}catch(t){wn.value=t instanceof Error?t.message:"Failed to load agent detail"}finally{Hs.value=!1}}}async function Ro(){var s;const e=cn.value,t=Gt.value.trim();if(!e||!t)return;const n=((s=localStorage.getItem(Bp))==null?void 0:s.trim())||"dashboard";yn.value=!0;try{await Wd(n,`@${e} ${t}`),Gt.value="",z(`Mention sent to ${e}`,"success"),Ji()}catch(a){const o=a instanceof Error?a.message:"Failed to send mention";z(o,"error")}finally{yn.value=!1}}function Jp({task:e}){return i`
    <div class="agent-detail-task">
      <span class="pill">${e.id}</span>
      <span class="agent-detail-task-title">${e.title}</span>
      <${ct} status=${e.status} />
    </div>
  `}function Vp({row:e}){return i`
  ...
  `}function Yp(){var x,k,L,R,w,P,T;const e=cn.value;if(!e)return null;const t=Up(),n=pl(e),s=Hp(e),a=ul(e),o=Ws.value,l=Gp(e),c=Wp(n),p=(s==null?void 0:s.allowed_tool_names)??[],m=(s==null?void 0:s.latest_tool_names)??[],u=s==null?void 0:s.latest_tool_call_count,_=s==null?void 0:s.tool_audit_source,f=s==null?void 0:s.tool_audit_at,$=(t==null?void 0:t.capabilities)??[],S=((x=ie.value)==null?void 0:x.room)??"default",h=((k=ie.value)==null?void 0:k.project)??"확인 없음",C=((L=ie.value)==null?void 0:L.cluster)??"확인 없음";return i`
    <div
      class="agent-detail-overlay"
      data-testid="agent-detail-overlay"
      onClick=${N=>{N.target.classList.contains("agent-detail-overlay")&&To()}}
    >
      <div class="agent-detail-modal">
        <div class="agent-detail-header">
          <div style="display:flex;flex-direction:column;gap:8px;flex:1">
            ...
            ${(((R=t==null?void 0:t.traits)==null?void 0:R.length)??0)>0?i`
              <div style="display:flex;flex-wrap:wrap;gap:4px">
                ${(w=t==null?void 0:t.traits)==null?void 0:w.map(N=>i`<span style="font-size:0.7rem;background:#1e3a5f;color:#60a5fa;padding:2px 8px;border-radius:10px">${N}</span>`)}
              </div>
            `:""}
            ${(((P=t==null?void 0:t.interests)==null?void 0:P.length)??0)>0?i`
              <div style="display:flex;flex-wrap:wrap;gap:4px">
                ${(T=t==null?void 0:t.interests)==null?void 0:T.map(N=>i`<span style="font-size:0.7rem;background:#3b1f4e;color:#c084fc;padding:2px 8px;border-radius:10px">${N}</span>`)}
              </div>
            `:""}
            ${$.length>0?i`
              <div style="display:flex;flex-wrap:wrap;gap:4px">
                ${$.map(N=>i`<span style="font-size:0.7rem;background:#183153;color:#7dd3fc;padding:2px 8px;border-radius:10px">${N}</span>`)}
              </div>
            `:""}
          ...
          <div class="agent-detail-actions">
            <button class="control-btn ghost" onClick=${()=>{Ji()}} disabled=${Hs.value}>
        ...
        <div class="agent-detail-grid">
          <${I} title="Assigned Tasks">
            ${a.length===0?i`<div class="empty-state">No assigned tasks</div>`:i`<div class="agent-detail-task-list">${a.map(N=>i`<${Jp} key=${N.id} task=${N} />`)}</div>`}
          <//>

          <${I} title="Recent Activity">
            ${o.length===0?i`<div class="empty-state">No recent room activity match</div>`:i`<div class="agent-activity-list">${o.map((N,Q)=>i`<div key=${Q} class="agent-activity-line">${N}</div>`)}</div>`}
          <//>
        </div>
          ...
          <div style="display:flex; flex-direction:column; gap:12px;">
            <div>
              ...
              <div style="display:flex; flex-wrap:wrap; gap:6px;">
                ${$.length>0?$.map(N=>i`<span class="pill">${N}</span>`):i`<span class="empty-state" style="font-size:12px;">No capability metadata</span>`}
              </div>
            </div>
            <div>
              <div style="font-size:12px; color:#888; margin-bottom:6px;">Allowed tools</div>
              <div style="display:flex; flex-wrap:wrap; gap:6px;">
                ${p.length>0?p.map(N=>i`<span class="pill">${N}</span>`):i`<span class="empty-state" style="font-size:12px;">No allowlist reported</span>`}
              </div>
            </div>
            <div>
              <div style="font-size:12px; color:#888; margin-bottom:6px;">Observed tools</div>
              <div style="display:flex; flex-wrap:wrap; gap:6px;">
                ${m.length>0?m.map(N=>i`<span class="pill">${N}</span>`):i`<span class="empty-state" style="font-size:12px;">No observed tool-use evidence</span>`}
              </div>
            </div>
            <div class="agent-detail-sub">
            ...
            <div>
              ...
              <div style="display:flex; flex-wrap:wrap; gap:6px;">
                ${l.length>0?l.map(N=>i`<span class="pill">${N}</span>`):i`<span class="empty-state" style="font-size:12px;">No keeper tool telemetry</span>`}
              </div>
            </div>
            ${c.length>0?i`
                  <div>
                    ...
                    <div style="display:flex; flex-wrap:wrap; gap:6px;">
                      ${c.map(N=>i`<span class="pill">${N}</span>`)}
                    </div>
                  </div>
                `:null}
            ${n?i`
        ...
        <${I} title="Task History">
          ${Pn.value.length===0?i`<div class="empty-state">No task history loaded</div>`:i`<div class="agent-history-list">${Pn.value.map(N=>i`<${Vp} key=${N.taskId} row=${N} />`)}</div>`}
        <//>
        ...
        <${I} title="Direct Mention">
          <div class="agent-mention-row">
            <input
              ...
              value=${Gt.value}
              onInput=${N=>{Gt.value=N.target.value}}
              onKeyDown=${N=>{N.key==="Enter"&&Ro()}}
              disabled=${yn.value}
            />
            <button
              class="control-btn"
  ...
  `}const ve=g(null),Vi=g(null),ze=g(null),Nn=g(!1),at=g(null),Ln=g(!1),en=g(null),H=g(!1),Gs=g([]);let Qp=1;function Xp(e){return v(e)?{id:r(e.id),seq:d(e.seq),from:r(e.from)??r(e.from_agent)??"system",content:r(e.content)??"",timestamp:r(e.timestamp)??new Date().toISOString(),type:r(e.type)}:null}function Zp(e){return v(e)?{room_id:r(e.room_id),current_room:r(e.current_room)??r(e.room),project:r(e.project),cluster:r(e.cluster),paused:E(e.paused),pause_reason:r(e.pause_reason)??null,paused_by:r(e.paused_by)??null,paused_at:r(e.paused_at)??null}:{}}function wo(e){if(!v(e))return;const t=Object.entries(e).map(([n,s])=>{const a=r(s);return a?[n,a]:null}).filter(n=>n!==null);return t.length>0?Object.fromEntries(t):void 0}function ml(e){if(!v(e))return null;const t=r(e.kind),n=r(e.summary),s=r(e.target_type);return!t||!n||!s?null:{kind:t,severity:r(e.severity)??"warn",summary:n,target_type:s,target_id:r(e.target_id)??null,actor:r(e.actor)??null,evidence:e.evidence}}function bn(e){if(!v(e))return null;const t=r(e.action_type),n=r(e.target_type),s=r(e.reason);return!t||!n||!s?null:{action_type:t,target_type:n,target_id:r(e.target_id)??null,severity:r(e.severity)??"warn",reason:s,confirm_required:E(e.confirm_required),suggested_payload:e.suggested_payload,preview:e.preview}}function vl(e){return v(e)?{enabled:E(e.enabled),judge_online:E(e.judge_online),refreshing:E(e.refreshing),generated_at:r(e.generated_at)??null,expires_at:r(e.expires_at)??null,model_used:r(e.model_used)??null,keeper_name:r(e.keeper_name)??null,last_error:r(e.last_error)??null}:null}function za(e){return v(e)?{summary:r(e.summary)??null,confidence:d(e.confidence)??null,provenance:r(e.provenance)??null,authoritative:E(e.authoritative),surface:r(e.surface)??null,fresh_until:r(e.fresh_until)??null,keeper_name:r(e.keeper_name)??null,fallback_used:E(e.fallback_used),disagreement_with_truth:E(e.disagreement_with_truth)}:null}function em(e){return v(e)?{judgment_id:r(e.judgment_id)??void 0,surface:r(e.surface)??null,target_type:r(e.target_type)??null,target_id:r(e.target_id)??null,status:r(e.status)??null,summary:r(e.summary)??null,confidence:d(e.confidence)??null,generated_at:r(e.generated_at)??null,fresh_until:r(e.fresh_until)??null,keeper_name:r(e.keeper_name)??null,model_name:r(e.model_name)??null,runtime_name:r(e.runtime_name)??null,evidence_refs:W(e.evidence_refs),recommended_action:bn(e.recommended_action),supersedes:W(e.supersedes),fallback_used:E(e.fallback_used),disagreement_with_truth:E(e.disagreement_with_truth),provenance:r(e.provenance)??null}:null}function tm(e){return v(e)?{actor:r(e.actor)??null,spawn_agent:r(e.spawn_agent)??null,spawn_role:r(e.spawn_role)??null,spawn_model:r(e.spawn_model)??null,worker_class:r(e.worker_class)??null,parent_actor:r(e.parent_actor)??null,capsule_mode:r(e.capsule_mode)??null,runtime_pool:r(e.runtime_pool)??null,lane_id:r(e.lane_id)??null,controller_level:r(e.controller_level)??null,control_domain:r(e.control_domain)??null,supervisor_actor:r(e.supervisor_actor)??null,model_tier:r(e.model_tier)??null,task_profile:r(e.task_profile)??null,risk_level:r(e.risk_level)??null,routing_confidence:d(e.routing_confidence)??null,routing_reason:r(e.routing_reason)??null,status:r(e.status)??"unknown",turn_count:d(e.turn_count)??0,empty_note_turn_count:d(e.empty_note_turn_count)??0,has_turn:E(e.has_turn)??!1,last_turn_ts_iso:r(e.last_turn_ts_iso)??null}:null}function nm(e){if(!v(e))return null;const t=r(e.session_id);return t?{session_id:t,goal:r(e.goal),status:r(e.status),health:r(e.health),scale_profile:r(e.scale_profile),control_profile:r(e.control_profile),planned_worker_count:d(e.planned_worker_count),active_agent_count:d(e.active_agent_count),last_turn_age_sec:d(e.last_turn_age_sec)??null,attention_count:d(e.attention_count),recommended_action_count:d(e.recommended_action_count),top_attention:ml(e.top_attention),top_recommendation:bn(e.top_recommendation)}:null}function _l(e){const t=v(e)?e:{};return{trace_id:r(t.trace_id),target_type:r(t.target_type)??"room",target_id:r(t.target_id)??null,health:r(t.health),judgment_owner:r(t.judgment_owner)??null,authoritative_judgment_available:E(t.authoritative_judgment_available),resident_judge_runtime:vl(t.resident_judge_runtime),judgment:em(t.judgment),active_guidance_layer:r(t.active_guidance_layer)??null,active_summary:za(t.active_summary),active_recommended_actions:ue(t.active_recommended_actions).map(bn).filter(n=>n!==null),active_recommendation_source:r(t.active_recommendation_source)??null,active_recommendation_summary:za(t.active_recommendation_summary),fallback_recommended_actions:ue(t.fallback_recommended_actions).map(bn).filter(n=>n!==null),recommendation_summary:za(t.recommendation_summary),swarm_status:v(t.swarm_status)?t.swarm_status:void 0,attention_items:ue(t.attention_items).map(ml).filter(n=>n!==null),recommended_actions:ue(t.recommended_actions).map(bn).filter(n=>n!==null),session_cards:ue(t.session_cards).map(nm).filter(n=>n!==null),worker_cards:ue(t.worker_cards).map(tm).filter(n=>n!==null)}}function sm(e){if(!v(e))return null;const t=v(e.status)?e.status:void 0,n=v(e.summary)?e.summary:v(t==null?void 0:t.summary)?t.summary:void 0,s=v(e.session)?e.session:v(t==null?void 0:t.session)?t.session:void 0,a=r(e.session_id)??r(n==null?void 0:n.session_id)??r(s==null?void 0:s.session_id);if(!a)return null;const o=wo(e.report_paths)??wo(t==null?void 0:t.report_paths),l=ue(e.recent_events,["events"]).filter(v);return{session_id:a,status:r(e.status)??r(n==null?void 0:n.status)??r(s==null?void 0:s.status),progress_pct:d(e.progress_pct)??d(n==null?void 0:n.progress_pct),elapsed_sec:d(e.elapsed_sec)??d(n==null?void 0:n.elapsed_sec),remaining_sec:d(e.remaining_sec)??d(n==null?void 0:n.remaining_sec),done_delta_total:d(e.done_delta_total)??d(n==null?void 0:n.done_delta_total),summary:n,team_health:v(e.team_health)?e.team_health:v(t==null?void 0:t.team_health)?t.team_health:void 0,communication_metrics:v(e.communication_metrics)?e.communication_metrics:v(t==null?void 0:t.communication_metrics)?t.communication_metrics:void 0,orchestration_state:v(e.orchestration_state)?e.orchestration_state:v(t==null?void 0:t.orchestration_state)?t.orchestration_state:void 0,cascade_metrics:v(e.cascade_metrics)?e.cascade_metrics:v(t==null?void 0:t.cascade_metrics)?t.cascade_metrics:void 0,report_paths:o,session:s,recent_events:l}}function Po(e){if(!v(e))return null;const t=r(e.name);if(!t)return null;const n=v(e.context)?e.context:void 0;return{name:t,runtime_class:e.runtime_class==="persistent_agent"?"persistent_agent":"resident_keeper",desired:E(e.desired),resident_registered:E(e.resident_registered),agent_name:r(e.agent_name),status:r(e.status),autonomy_level:r(e.autonomy_level),context_ratio:d(e.context_ratio)??d(n==null?void 0:n.context_ratio),generation:d(e.generation),active_goal_ids:W(e.active_goal_ids),last_autonomous_action_at:r(e.last_autonomous_action_at)??null,last_turn_ago_s:d(e.last_turn_ago_s),model:r(e.model)??r(e.active_model)??r(e.primary_model)}}function am(e){if(!v(e))return null;const t=r(e.confirm_token)??r(e.token);return t?{confirm_token:t,actor:r(e.actor),action_type:r(e.action_type),target_type:r(e.target_type),target_id:r(e.target_id)??null,delegated_tool:r(e.delegated_tool),created_at:r(e.created_at),preview:e.preview}:null}function gl(e){if(!v(e))return null;const t=r(e.action_type),n=r(e.target_type);return!t||!n?null:{action_type:t,target_type:n,description:r(e.description),confirm_required:E(e.confirm_required)}}function im(e){return v(e)?{actor_filter:r(e.actor_filter)??null,filter_active:E(e.filter_active)??!1,visible_count:d(e.visible_count)??0,total_count:d(e.total_count)??0,hidden_count:d(e.hidden_count)??0,hidden_actors:W(e.hidden_actors),confirm_required_actions:ue(e.confirm_required_actions).map(gl).filter(t=>t!==null)}:null}function om(e){const t=v(e)?e:{};return{room:Zp(t.room),sessions:ue(t.sessions,["items","sessions"]).map(sm).filter(n=>n!==null),keepers:ue(t.keepers,["items","keepers"]).map(Po).filter(n=>n!==null),resident_judge_runtime:vl(t.resident_judge_runtime),persistent_agents:ue(t.persistent_agents,["items","persistent_agents"]).map(Po).filter(n=>n!==null),recent_messages:ue(t.recent_messages,["messages"]).map(Xp).filter(n=>n!==null),pending_confirms:ue(t.pending_confirms,["items","confirms"]).map(am).filter(n=>n!==null),pending_confirm_summary:im(t.pending_confirm_summary)??void 0,available_actions:ue(t.available_actions,["actions"]).map(gl).filter(n=>n!==null)}}function us(e){if(typeof e=="string")return e;if(e==null)return"";try{return JSON.stringify(e)}catch{return String(e)}}function No(e){return e.target_id?`${e.target_type}:${e.target_id}`:e.target_type}function Js(e){Gs.value=[{...e,id:Qp++,at:new Date().toISOString()},...Gs.value].slice(0,20)}function fl(e){return e.confirm_required?us(e.preview)||"Confirmation required":us(e.result)||us(e.executed_action)||us(e.delegated_tool_result)||e.status}async function he(){Nn.value=!0,at.value=null;try{const e=await od();ve.value=om(e)}catch(e){at.value=e instanceof Error?e.message:"Failed to load operator snapshot"}finally{Nn.value=!1}}async function Ct(){Ln.value=!0,en.value=null;try{const e=await fr({targetType:"room"});Vi.value=_l(e)}catch(e){en.value=e instanceof Error?e.message:"Failed to load operator digest"}finally{Ln.value=!1}}async function tn(e){if(!e){ze.value=null;return}Ln.value=!0,en.value=null;try{const t=await fr({targetType:"team_session",targetId:e,includeWorkers:!0});ze.value=_l(t)}catch(t){en.value=t instanceof Error?t.message:"Failed to load session digest"}finally{Ln.value=!1}}async function $l(e){var t;H.value=!0,at.value=null;try{const n=await ba(e);return Js({actor:e.actor,action_type:e.action_type,target_label:No(e),outcome:n.confirm_required?"preview":"executed",message:fl(n),delegated_tool:n.delegated_tool}),await he(),await Ct(),(t=ze.value)!=null&&t.target_id&&await tn(ze.value.target_id),n}catch(n){const s=n instanceof Error?n.message:"Operator action failed";throw at.value=s,Js({actor:e.actor,action_type:e.action_type,target_label:No(e),outcome:"error",message:s}),n}finally{H.value=!1}}async function hl(e,t,n="confirm"){var s;H.value=!0,at.value=null;try{const a=await $r(e,t,n);return Js({actor:e,action_type:n,target_label:t,outcome:"confirmed",message:fl(a),delegated_tool:a.delegated_tool}),await he(),await Ct(),(s=ze.value)!=null&&s.target_id&&await tn(ze.value.target_id),a}catch(a){const o=a instanceof Error?a.message:"Operator confirmation failed";throw at.value=o,Js({actor:e,action_type:"confirm",target_label:t,outcome:"error",message:o}),a}finally{H.value=!1}}Vu(()=>{var e;he(),Ct(),(e=ze.value)!=null&&e.target_id&&tn(ze.value.target_id)});function rm(e){switch(e){case"quiet_hours":return"quiet hours";case"min_gap":return"cooldown gate";case"no_recent_activity":return"waiting for activity";case"disabled":return"runtime disabled";case"startup":return"warming up";case"llm_error":return"llm error";case"graphql_error":return"graphql error";case"never_started":return"never started";default:return"unknown"}}function lm(e){switch(e){case"manual_lodge_poke":return"Poke Lodge";case"probe":return"Probe";case"recover":return"Recover";default:return"Message"}}function cm(e){switch(e.delivery){case"sending":return"sending";case"timeout":return"timeout";case"error":return"error";case"delivered":return"delivered";default:return e.role}}function Lo(e){return e.delivery==="error"||e.delivery==="timeout"?"bad":e.delivery==="sending"?"warn":e.role==="assistant"?"assistant":e.role==="user"?"user":"warn"}function yl(e){if(!e)return null;const t=new Date(e);return Number.isNaN(t.getTime())?null:t.toLocaleTimeString()}function dm(e){return typeof e!="number"||!Number.isFinite(e)||e<=0?null:e<60?`${Math.round(e)}s`:`${Math.ceil(e/60)}m`}function bl(e){if(!e)return null;const t=Fe.value[e.name];return(t==null?void 0:t.diagnostic)??e.diagnostic??null}function um({keeper:e,showRawStatus:t=!1}){if(te(()=>{e!=null&&e.name&&Tr(e.name)},[e==null?void 0:e.name]),!e)return i`<div class="control-status-copy">Select a keeper to inspect direct reply state.</div>`;const n=Fe.value[e.name],s=bl(e),a=ui.value[e.name];return i`
    <div class="control-result-box">
      <div class="control-inline-meta">
        <span class="pill">${(s==null?void 0:s.health_state)??"unknown"}</span>
        <span class="pill">${rm(s==null?void 0:s.quiet_reason)}</span>
        <span class="pill">next ${lm((s==null?void 0:s.next_action_path)??"direct_message")}</span>
      ...
      <div class="control-status-copy">
        ...
        ${s!=null&&s.next_eligible_at_s?i` · next eligible ${dm(s.next_eligible_at_s)}`:null}
      </div>
  ...
  `}function pm({keeperName:e,placeholder:t}){const[n,s]=rr("");te(()=>{e&&Tr(e)},[e]);const a=le.value[e]??[],o=pi.value[e]??!1,l=Ke.value[e],c=async()=>{const p=n.trim();if(!(!e||!p)){s("");try{await vu(e,p)}catch(m){const u=m instanceof Error?m.message:`Failed to message ${e}`;z(u,"error")}}};return i`
        ...
        ${a.length===0?i`<div class="control-status-copy">No direct keeper conversation yet.</div>`:a.map(p=>i`
              <div class="keeper-conversation-item" key=${p.id}>
                <div class="keeper-conversation-meta">
                  <span class=${`keeper-role-chip ${Lo(p)}`}>${p.label}</span>
                  <span class=${`keeper-role-chip ${Lo(p)}`}>${cm(p)}</span>
  ...
  `}function mm({actor:e,keeper:t,onPokeLodge:n}){if(!t)return null;const s=bl(t),a=mi.value[t.name]??!1,o=vi.value[t.name]??!1,l=(s==null?void 0:s.next_action_path)??"direct_message",c=(s==null?void 0:s.recoverable)??l==="recover";return i`
    <div class="control-actions">
      <button
        class=${`control-btn ghost ${l==="probe"?"is-active":""}`}
        onClick=${()=>{_u(t.name,e).catch(p=>{const m=p instanceof Error?p.message:`Failed to probe ${t.name}`;z(m,"error")})}}
        disabled=${a||!e.trim()}
      >
        ${a?"Probing...":"Probe"}
      </button>
      <button
        ...
        onClick=${()=>{gu(t.name,e).catch(p=>{const m=p instanceof Error?p.message:`Failed to recover ${t.name}`;z(m,"error")})}}
        disabled=${o||!c||!e.trim()}
      >
  ...
  `}const Yi=g(null);function kl(e){Yi.value=e,mu(e.name)}function zo(){Yi.value=null}const Nt=[{level:"L1_Reactive",label:"L1 Reactive",color:"#6b7280"},{level:"L2_Suggestive",label:"L2 Suggestive",color:"#3b82f6"},{level:"L3_Guided",label:"L3 Guided",color:"#f59e0b"},{level:"L4_Autonomous",label:"L4 Autonomous",color:"#f97316"},{level:"L5_Independent",label:"L5 Independent",color:"#ef4444"}];function vm(e){if(!e)return 0;const t=Nt.findIndex(n=>n.level===e);return t>=0?t:0}function _m({keeper:e}){const t=vm(e.autonomy_level),n=Nt[t]??Nt[0];if(!n)return null;const s=(t+1)/Nt.length*100;return i`
  ...
  `}function Ps(e){return e?e>=1e6?`${(e/1e6).toFixed(1)}M`:e>=1e3?`${(e/1e3).toFixed(1)}K`:String(e):"—"}function gm(e){switch(e){case"keeper_message":return"message";case"keeper_probe":return"probe";case"keeper_recover":return"recover";case"broadcast":return"broadcast";case"room_pause":return"pause";case"room_resume":return"resume";case"lodge_tick":return"lodge";default:return(e==null?void 0:e.trim())||"action"}}function fm(e){return e.recent_tool_names&&e.recent_tool_names.length>0?e.recent_tool_names:[]}function $m(e){const t=e.metrics_window;return(Array.isArray(t==null?void 0:t.top_tools)?t.top_tools:[]).map(s=>typeof s=="object"&&s!==null&&"tool"in s&&typeof s.tool=="string"?s.tool:null).filter(s=>s!==null)}function hm(e){const t=Vn.value;return t?t.keeper_briefs.find(n=>n.name===e.name||n.agent_name&&e.agent_name&&n.agent_name===e.agent_name)??null:null}function ym({keeper:e}){const t=e.metrics_series??[],n=t[t.length-1],s=(n==null?void 0:n.cost_usd)!=null?`$${n.cost_usd.toFixed(4)}`:"—",a=[{label:"Generation",value:e.generation??"-",hint:"Succession count"},{label:"Turns",value:e.turn_count??"-",hint:"Total loop turns"},{label:"Context",value:e.context_ratio!=null?`${Math.round(e.context_ratio*100)}%`:"-",hint:e.context_ratio!=null&&e.context_ratio>.8?"Near limit":void 0},{label:"Activity",value:e.activityLevel??"-",hint:"Level 0–5"}];return i`
  ...
  `}function bm({keeper:e}){var u,_;const t=e.metrics_series??[];if(t.length<2){const f=(((u=e.context)==null?void 0:u.context_ratio)??0)*100,$=f>85?"#ef4444":f>70?"#f59e0b":"#22c55e";return i`
  ...
  `}function xm({stats:e}){const t=e.max_hp>0?Math.round(e.hp/e.max_hp*100):0,n=e.max_mp>0?Math.round(e.mp/e.max_mp*100):0;return i`
    <div>
  ...
  `}function Sm({items:e}){return e.length===0?i`<div class="empty-state" style="font-size:13px">No equipment</div>`:i`
  ...
  `}function Am({rels:e}){const t=Object.entries(e);return t.length===0?i`<div class="empty-state" style="font-size:13px">No relationships</div>`:i`
  ...
  `}function Im({keeper:e}){var h,C,x,k,L,R,w;const t=((h=ve.value)==null?void 0:h.room)??{},n=(((C=ve.value)==null?void 0:C.available_actions)??[]).filter(P=>P.target_type==="keeper"||P.target_type==="room").slice(0,8),s=fm(e),a=$m(e),o=hm(e),l=(o==null?void 0:o.allowed_tool_names)??[],c=(o==null?void 0:o.latest_tool_names)??[],p=o==null?void 0:o.latest_tool_call_count,m=o==null?void 0:o.tool_audit_source,u=o==null?void 0:o.tool_audit_at,_=((x=e.agent)==null?void 0:x.capabilities)??[],f=t.current_room??t.room_id??((k=ie.value)==null?void 0:k.room)??"default",$=t.project??((L=ie.value)==null?void 0:L.project)??"확인 없음",S=t.cluster??((R=ie.value)==null?void 0:R.cluster)??"확인 없음";return i`
    <div class="keeper-signal-list">
      <div class="keeper-signal-row">
        <span>Room</span>
        <strong>${f}</strong>
      ...
      <div style="display:flex; flex-direction:column; gap:8px; margin-top:8px;">
        ...
        <div style="display:flex; flex-wrap:wrap; gap:6px;">
          ${n.length>0?n.map(P=>i`<span class="pill">${gm(P.action_type)}</span>`):i`<span style="font-size:12px; color:#888;">operator action 광고 없음</span>`}
        </div>
      </div>
    </div>
  `}function xl(){const e=new URLSearchParams(window.location.search),t=e.get("agent")??e.get("agent_name"),n=localStorage.getItem("masc_dashboard_agent_name");return(t??n??"dashboard").trim()||"dashboard"}async function Tm(){try{const e=await ba({actor:xl(),action_type:"lodge_tick",target_type:"room",payload:{}}),t=Ir(e.result);await Jn(),t!=null&&t.skipped_reason?z(t.skipped_reason,"warning"):z(t?`Poke finished: ${t.acted}/${t.checked} acted`:"Poke finished",t&&t.acted>0?"success":"warning")}catch(e){const t=e instanceof Error?e.message:"Failed to run Lodge poke";z(t,"error")}}function Rm({keeper:e}){return i`
  ...
  `}function wm(){var t,n,s;const e=Yi.value;return e?i`
    <div
  ...
  `:null}function Pm({cluster:e,project:t,room:n,generatedAt:s}){return i`
  ...
  `}function wt({label:e,value:t,detail:n,tone:s}){return i`
  ...
  `}function Nm(){const e=Gr.value,t=me((e==null?void 0:e.status)??($t.value?"bad":"warn")),n=!e||e.sections.length===0,s=(e==null?void 0:e.status)==="error"||(e==null?void 0:e.status)==="unavailable"&&!(e!=null&&e.cached);return i`
    <${I} title="LLM 판단 레이어" class="mission-briefing-card" semanticId="mission.llm_briefing">
      ...
      <div class="mission-card-actions">
        <button class="control-btn ghost" onClick=${()=>{Bs(s)}} disabled=${Mt.value}>
          ${Mt.value?"응답 기다리는 중…":"판단 다시 읽기"}
        </button>
        <button class="control-btn ghost" onClick=${()=>{Bs(!0)}} disabled=${Mt.value}>
          강제 갱신
        </button>
      </div>
    <//>
  ...
  `}function zm({brief:e,selected:t}){var o,l;const n=e.member_previews.slice(0,4),s=e.top_recommendation??null,a=e.top_attention??null;return i`
    <article class="mission-crew-card ${me(((o=e.top_attention)==null?void 0:o.severity)??e.health??e.status)} ${t?"is-selected":""}">
      <button class="mission-card-select" onClick=${()=>cl(e.session_id)}>
        ...
        <div class="mission-fact-grid">
          ...
          <div class="mission-fact-tile">
            <span>가동 시간</span>
            <strong>${Np(e.elapsed_sec)}</strong>
  ...
  `}function Em({item:e}){const t=e.action??null,n=e.attention??null;return i`
    <article class="mission-action-card ${me(e.severity)}">
      ...
      <div class="mission-card-actions">
        ${t?i`
              <button class="control-btn ghost" onClick=${()=>Gi(t,n,"Mission internal signal")}>이 액션으로 개입 열기</button>
  ...
  `}function jo(){var $,S,h,C;const e=Vn.value;if(yi.value&&!e)return i`<div class="loading-indicator">상황판 스냅샷 불러오는 중...</div>`;if(Ks.value&&!e)return i`<div class="empty-state error">${Ks.value}</div>`;if(!e)return i`<div class="empty-state">상황판 스냅샷이 아직 없습니다.</div>`;Oe.value&&!e.attention_queue.some(x=>x.id===Oe.value)&&(Oe.value=null);const t=e.sessions;Ve.value&&!t.some(x=>x.session_id===Ve.value)&&(Ve.value=null);const n=e.attention_queue.find(x=>x.id===Oe.value)??null,s=(n==null?void 0:n.related_session_ids.find(x=>t.some(k=>k.session_id===x)))??null,a=Ve.value??s??(($=t[0])==null?void 0:$.session_id)??null,o=Ep(),l=t.find(x=>x.session_id===a)??null,c=e.keeper_briefs.slice(0,6).map(jp),p=e.attention_queue.filter(x=>x.related_session_ids.length>0).slice(0,6),m=e.internal_signals.slice(0,3),u=t.filter(x=>{var L;const k=((L=x.top_attention)==null?void 0:L.severity)??x.health??x.status;return me(k)!=="ok"||!!x.blocker_summary}).length,_=new Set(t.flatMap(x=>x.member_names)).size,f=t.flatMap(x=>x.member_previews??[]).filter(x=>x.recent_output_preview).length+c.filter(x=>x.recentOutput).length;return te(()=>{yp(a)},[a]),i`
    <section class="dashboard-panel mission-view">
      ...
      <div class="mission-stat-grid">
        <${wt} label="활성 세션" value=${t.length} detail="지금 진행중인 협업 단위" tone=${((S=l==null?void 0:l.top_attention)==null?void 0:S.severity)??(l==null?void 0:l.health)??"ok"} />
        <${wt} label="막힌 세션" value=${u} detail="주의가 필요한 흐름" tone=${u>0?"warn":"ok"} />
        <${wt} label="참여자" value=${_} detail="현재 세션에 연결된 actor" tone=${_>0?"ok":"warn"} />
        <${wt} label="Keeper watch" value=${c.length} detail="continuity lane 관찰 대상" tone=${((h=c[0])==null?void 0:h.brief.status)??"ok"} />
        <${wt} label="최근 output" value=${f} detail="메인에서 바로 읽을 수 있는 출력 수" tone=${f>0?"ok":"warn"} />
        <${wt} label="내부 신호" value=${m.length} detail="시스템 진단은 보조 lane" tone=${((C=m[0])==null?void 0:C.severity)??"ok"} />
      </div>

      ${a?i`
            <div class="mission-selection-bar">
              <span>현재 관찰 세션 · ${(l==null?void 0:l.goal)??a}${n?` · ${n.summary}`:""}</span>
              <button class="control-btn ghost" onClick=${Op}>선택 해제</button>
            </div>
          `:null}
      ...
      <${I} title="진행중인 세션" class="mission-list-card" semanticId="mission.session_briefs">
        ...
        <div class="mission-list-stack">
          ${t.length>0?t.map(x=>i`<${zm} key=${x.session_id} brief=${x} selected=${a===x.session_id} />`):i`<div class="empty-state">지금 활성 세션이 없습니다.</div>`}
        </div>
      <//>
      ...
      <div class="mission-human-grid">
        <${I} title="Attention Queue" class="mission-list-card" semanticId="mission.attention_queue">
          ...
          <div class="mission-lane-stack">
            ${p.length>0?p.map(x=>i`<${Lm} key=${x.id} item=${x} selected=${Oe.value===x.id} sessionLookup=${o} />`):i`<div class="empty-state">지금 session-level attention queue가 비어 있습니다.</div>`}
          </div>
        <//>
        ...
        <${I} title="Internal Signals" class="mission-list-card" semanticId="mission.internal_signals">
          ...
          <details class="mission-card-disclosure">
            ...
            <div class="mission-list-stack">
              ${m.length>0?m.map(x=>i`<${Em} key=${x.id} item=${x} />`):i`<div class="empty-state">지금은 내부 진단 경고가 없습니다.</div>`}
            </div>
          </details>
        <//>
      </div>
      ...
      <${I} title="Keeper Continuity" class="mission-list-card" semanticId="mission.keeper_activity">
        ...
        <div class="mission-activity-list">
          ${c.length>0?c.map(x=>i`<${jm} key=${x.brief.name} row=${x} />`):i`<div class="empty-state">지금 보이는 keeper가 없습니다.</div>`}
        </div>
        <div class="mission-card-actions">
  ...
  `}const Sl=g(null),Si=g(!1),jt=g(null);async function Al(e,t){Si.value=!0,jt.value=null;try{Sl.value=await ad(e,t)}catch(n){jt.value=n instanceof Error?n.message:String(n)}finally{Si.value=!1}}const Dm="modulepreload",Om=function(e){return"/dashboard/"+e},Eo={},qm=function(t,n,s){let a=Promise.resolve();if(n&&n.length>0){let l=function(m){return Promise.all(m.map(u=>Promise.resolve(u).then(_=>({status:"fulfilled",value:_}),_=>({status:"rejected",reason:_}))))};document.getElementsByTagName("link");const c=document.querySelector("meta[property=csp-nonce]"),p=(c==null?void 0:c.nonce)||(c==null?void 0:c.getAttribute("nonce"));a=l(n.map(m=>{if(m=Om(m),m in Eo)return;Eo[m]=!0;const u=m.endsWith(".css"),_=u?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${m}"]${_}`))return;const f=document.createElement("link");if(f.rel=u?"stylesheet":Dm,u||(f.as="script"),f.crossOrigin="",f.href=m,p&&f.setAttribute("nonce",p),document.head.appendChild(f),u)return new Promise(($,S)=>{f.addEventListener("load",$),f.addEventListener("error",()=>S(new Error(`Unable to preload CSS for ${m}`)))})}))}function o(l){const c=new Event("vite:preloadError",{cancelable:!0});if(c.payload=l,window.dispatchEvent(c),!c.defaultPrevented)throw l}return a.then(l=>{for(const c of l||[])c.status==="rejected"&&o(c.reason);return t().catch(o)})},Qi=g(null),je=g(null),Vs=g(!1),Ys=g(!1),Qs=g(null),Xs=g(null),Ai=g(null),Zs=g(null),X=g("warroom"),Qn=g(null),Ci=g(!1),ea=g(null),Tt=g(null),ta=g(!1),na=g(null),Xn=g(null),Ii=g(!1),sa=g(null),zn=g(null),aa=g(!1),Mn=g(null),Jt=g(null);let _n=null;function Xi(e){return e!=="summary"&&e!=="swarm"&&e!=="warroom"}function Cl(){if(typeof window>"u")return new URLSearchParams;const e=new URLSearchParams(window.location.search),t=window.location.hash.replace(/^#/,""),n=t.indexOf("?");return n>=0&&new URLSearchParams(t.slice(n+1)).forEach((a,o)=>{e.has(o)||e.set(o,a)}),e}function Fm(){const t=Cl().get("run_id")??void 0;return t&&t.trim()!==""?t.trim():void 0}function Km(){const t=Cl().get("operation_id")??void 0;return t&&t.trim()!==""?t.trim():void 0}function Bm(e){if(v(e))return{policy_class:r(e.policy_class),approval_class:r(e.approval_class),tool_allowlist:W(e.tool_allowlist),model_allowlist:W(e.model_allowlist),requires_human_for:W(e.requires_human_for),autonomy_level:r(e.autonomy_level),escalation_timeout_sec:d(e.escalation_timeout_sec),kill_switch:E(e.kill_switch),frozen:E(e.frozen)}}function Um(e){if(v(e))return{headcount_cap:d(e.headcount_cap),active_operation_cap:d(e.active_operation_cap),max_cost_usd:d(e.max_cost_usd),max_tokens:d(e.max_tokens)}}function Zi(e){if(!v(e))return null;const t=r(e.unit_id),n=r(e.label),s=r(e.kind);return!t||!n||!s?null:{unit_id:t,label:n,kind:s,parent_unit_id:r(e.parent_unit_id)??null,leader_id:r(e.leader_id)??null,roster:W(e.roster),capability_profile:W(e.capability_profile),source:r(e.source),created_at:r(e.created_at),updated_at:r(e.updated_at),policy:Bm(e.policy),budget:Um(e.budget)}}function Il(e){if(!v(e))return null;const t=Zi(e.unit);return t?{unit:t,leader_status:r(e.leader_status),roster_total:d(e.roster_total),roster_live:d(e.roster_live),active_operation_count:d(e.active_operation_count),health:r(e.health),reasons:W(e.reasons),children:Array.isArray(e.children)?e.children.map(Il).filter(n=>n!==null):[]}:null}function Hm(e){if(v(e))return{total_units:d(e.total_units),company_count:d(e.company_count),platoon_count:d(e.platoon_count),squad_count:d(e.squad_count),leaf_agent_unit_count:d(e.leaf_agent_unit_count),live_agent_count:d(e.live_agent_count),managed_unit_count:d(e.managed_unit_count),active_operation_count:d(e.active_operation_count)}}function Tl(e){const t=v(e)?e:{};return{version:r(t.version),generated_at:r(t.generated_at),source:r(t.source),summary:Hm(t.summary),units:Array.isArray(t.units)?t.units.map(Il).filter(n=>n!==null):[]}}function Wm(e){if(!v(e))return null;const t=r(e.kind),n=r(e.status);return!t||!n?null:{kind:t,chain_id:r(e.chain_id)??null,goal:r(e.goal)??null,run_id:r(e.run_id)??null,status:n,viewer_path:r(e.viewer_path)??null,last_sync_at:r(e.last_sync_at)??null}}function Ia(e){if(!v(e))return null;const t=r(e.operation_id),n=r(e.objective),s=r(e.assigned_unit_id),a=r(e.trace_id),o=r(e.status);return!t||!n||!s||!a||!o?null:{operation_id:t,objective:n,assigned_unit_id:s,autonomy_level:r(e.autonomy_level),policy_class:r(e.policy_class),budget_class:r(e.budget_class),detachment_session_id:r(e.detachment_session_id)??null,trace_id:a,checkpoint_ref:r(e.checkpoint_ref)??null,active_goal_ids:W(e.active_goal_ids),note:r(e.note)??null,created_by:r(e.created_by),source:r(e.source),status:o,chain:Wm(e.chain),created_at:r(e.created_at),updated_at:r(e.updated_at)}}function Gm(e){if(!v(e))return null;const t=Ia(e.operation);return t?{operation:t,assigned_unit_label:r(e.assigned_unit_label)}:null}function mn(e){if(v(e))return{tone:r(e.tone),pending_ops:d(e.pending_ops),blocked_ops:d(e.blocked_ops),in_flight_ops:d(e.in_flight_ops),pipeline_stalls:d(e.pipeline_stalls),bus_traffic:d(e.bus_traffic),l1_hit_rate:d(e.l1_hit_rate),invalidation_count:d(e.invalidation_count),current_pending:d(e.current_pending),current_in_flight:d(e.current_in_flight),cdb_wakeups:d(e.cdb_wakeups),total_stolen:d(e.total_stolen),avg_best_score:d(e.avg_best_score),avg_candidate_count:d(e.avg_candidate_count),best_first_operations:d(e.best_first_operations),active_sessions:d(e.active_sessions),commit_rate:d(e.commit_rate),total_speculations:d(e.total_speculations)}}function Jm(e){if(!v(e))return;const t=v(e.pipeline)?e.pipeline:void 0,n=v(e.cache)?e.cache:void 0,s=v(e.ooo)?e.ooo:void 0,a=v(e.speculative)?e.speculative:void 0,o=v(e.search_fabric)?e.search_fabric:void 0,l=v(e.signals)?e.signals:void 0;return{pipeline:t?{total_ops:d(t.total_ops),completed_ops:d(t.completed_ops),stalled_cycles:d(t.stalled_cycles),hazards_detected:d(t.hazards_detected),forwarding_used:d(t.forwarding_used),pipeline_flushes:d(t.pipeline_flushes),ipc:d(t.ipc)}:void 0,cache:n?{total_reads:d(n.total_reads),total_writes:d(n.total_writes),l1_hit_rate:d(n.l1_hit_rate),invalidation_count:d(n.invalidation_count),writeback_count:d(n.writeback_count),bus_traffic:d(n.bus_traffic)}:void 0,ooo:s?{agent_count:d(s.agent_count),total_added:d(s.total_added),total_issued:d(s.total_issued),total_completed:d(s.total_completed),total_stolen:d(s.total_stolen),cdb_wakeups:d(s.cdb_wakeups),stall_cycles:d(s.stall_cycles),global_cdb_events:d(s.global_cdb_events),current_pending:d(s.current_pending),current_in_flight:d(s.current_in_flight)}:void 0,speculative:a?{total_speculations:d(a.total_speculations),total_commits:d(a.total_commits),total_aborts:d(a.total_aborts),commit_rate:d(a.commit_rate),total_fast_calls:d(a.total_fast_calls),total_cost_usd:d(a.total_cost_usd),active_sessions:d(a.active_sessions)}:void 0,search_fabric:o?{total_operations:d(o.total_operations),best_first_operations:d(o.best_first_operations),legacy_operations:d(o.legacy_operations),blocked_operations:d(o.blocked_operations),ready_operations:d(o.ready_operations),research_pipeline_operations:d(o.research_pipeline_operations),avg_candidate_count:d(o.avg_candidate_count),avg_best_score:d(o.avg_best_score),top_stage:r(o.top_stage)??null}:void 0,signals:l?{issue_pressure:mn(l.issue_pressure),cache_contention:mn(l.cache_contention),scheduler_efficiency:mn(l.scheduler_efficiency),routing_confidence:mn(l.routing_confidence),speculative_posture:mn(l.speculative_posture)}:void 0}}function Rl(e){const t=v(e)?e:{},n=v(t.summary)?t.summary:void 0;return{version:r(t.version),generated_at:r(t.generated_at),summary:n?{total:d(n.total),active:d(n.active),paused:d(n.paused),managed:d(n.managed),projected:d(n.projected)}:void 0,microarch:Jm(t.microarch),operations:Array.isArray(t.operations)?t.operations.map(Gm).filter(s=>s!==null):[]}}function wl(e){if(!v(e))return null;const t=r(e.detachment_id),n=r(e.operation_id),s=r(e.assigned_unit_id);return!t||!n||!s?null:{detachment_id:t,operation_id:n,assigned_unit_id:s,leader_id:r(e.leader_id)??null,roster:W(e.roster),session_id:r(e.session_id)??null,checkpoint_ref:r(e.checkpoint_ref)??null,runtime_kind:r(e.runtime_kind)??null,runtime_ref:r(e.runtime_ref)??null,source:r(e.source),status:r(e.status),last_event_at:r(e.last_event_at)??null,last_progress_at:r(e.last_progress_at)??null,heartbeat_deadline:r(e.heartbeat_deadline)??null,created_at:r(e.created_at),updated_at:r(e.updated_at)}}function Vm(e){if(!v(e))return null;const t=wl(e.detachment);return t?{detachment:t,assigned_unit_label:r(e.assigned_unit_label),operation:Ia(e.operation)}:null}function Pl(e){const t=v(e)?e:{},n=v(t.summary)?t.summary:void 0;return{version:r(t.version),generated_at:r(t.generated_at),summary:n?{total:d(n.total),active:d(n.active),projected:d(n.projected)}:void 0,detachments:Array.isArray(t.detachments)?t.detachments.map(Vm).filter(s=>s!==null):[]}}function Ym(e){if(!v(e))return null;const t=r(e.decision_id),n=r(e.trace_id),s=r(e.requested_action),a=r(e.scope_type),o=r(e.scope_id);return!t||!n||!s||!a||!o?null:{decision_id:t,trace_id:n,requested_action:s,scope_type:a,scope_id:o,operation_id:r(e.operation_id)??null,target_unit_id:r(e.target_unit_id)??null,requested_by:r(e.requested_by),status:r(e.status),reason:r(e.reason)??null,source:r(e.source),detail:e.detail,created_at:r(e.created_at),decided_at:r(e.decided_at)??null,expires_at:r(e.expires_at)??null}}function Nl(e){const t=v(e)?e:{},n=v(t.summary)?t.summary:void 0;return{version:r(t.version),generated_at:r(t.generated_at),summary:n?{total:d(n.total),pending:d(n.pending),approved:d(n.approved),denied:d(n.denied)}:void 0,decisions:Array.isArray(t.decisions)?t.decisions.map(Ym).filter(s=>s!==null):[]}}function Qm(e){if(!v(e))return null;const t=Zi(e.unit);return t?{unit:t,roster_total:d(e.roster_total),roster_live:d(e.roster_live),headcount_cap:d(e.headcount_cap),active_operations:d(e.active_operations),active_operation_cap:d(e.active_operation_cap),utilization:d(e.utilization)}:null}function Xm(e){const t=v(e)?e:{};return{version:r(t.version),generated_at:r(t.generated_at),capacity:Array.isArray(t.capacity)?t.capacity.map(Qm).filter(n=>n!==null):[]}}function Zm(e){if(!v(e))return null;const t=r(e.alert_id);return t?{alert_id:t,severity:r(e.severity),kind:r(e.kind),scope_type:r(e.scope_type),scope_id:r(e.scope_id),title:r(e.title),detail:r(e.detail),timestamp:r(e.timestamp)}:null}function Ll(e){const t=v(e)?e:{},n=v(t.summary)?t.summary:void 0;return{version:r(t.version),generated_at:r(t.generated_at),summary:n?{total:d(n.total),bad:d(n.bad),warn:d(n.warn)}:void 0,alerts:Array.isArray(t.alerts)?t.alerts.map(Zm).filter(s=>s!==null):[]}}function zl(e){if(!v(e))return null;const t=r(e.event_id),n=r(e.trace_id),s=r(e.event_type);return!t||!n||!s?null:{event_id:t,trace_id:n,event_type:s,operation_id:r(e.operation_id)??null,unit_id:r(e.unit_id)??null,actor:r(e.actor)??null,source:r(e.source),timestamp:r(e.timestamp),detail:e.detail}}function ev(e){const t=v(e)?e:{};return{version:r(t.version),generated_at:r(t.generated_at),events:Array.isArray(t.events)?t.events.map(zl).filter(n=>n!==null):[]}}function tv(e){if(!v(e))return null;const t=r(e.code),n=r(e.severity),s=r(e.summary);return!t||!n||!s?null:{code:t,severity:n,summary:s}}function nv(e){if(!v(e))return null;const t=r(e.lane_id),n=r(e.label),s=r(e.kind),a=r(e.phase),o=r(e.motion_state),l=r(e.source_of_truth),c=r(e.movement_reason),p=r(e.current_step);if(!t||!n||!s||!a||!o||!l||!c||!p)return null;const m=v(e.counts)?e.counts:{};return{lane_id:t,label:n,kind:s,present:E(e.present)??!1,phase:a,motion_state:o,source_of_truth:l,last_movement_at:r(e.last_movement_at)??null,movement_reason:c,current_step:p,blockers:W(e.blockers),counts:{operations:d(m.operations),detachments:d(m.detachments),workers:d(m.workers),approvals:d(m.approvals),alerts:d(m.alerts)},hard_flags:Array.isArray(e.hard_flags)?e.hard_flags.map(tv).filter(u=>u!==null):[]}}function sv(e){if(!v(e))return null;const t=r(e.event_id),n=r(e.lane_id),s=r(e.kind),a=r(e.timestamp),o=r(e.title),l=r(e.detail),c=r(e.tone),p=r(e.source);return!t||!n||!s||!a||!o||!l||!c||!p?null:{event_id:t,lane_id:n,kind:s,timestamp:a,title:o,detail:l,tone:c,source:p}}function av(e){if(!v(e))return null;const t=r(e.code),n=r(e.severity),s=r(e.summary);return!t||!n||!s?null:{code:t,severity:n,summary:s,lane_ids:W(e.lane_ids),count:d(e.count)??0}}function Ml(e){if(!v(e))return;const t=v(e.overview)?e.overview:{},n=v(e.gaps)?e.gaps:{},s=v(e.recommended_next_action)?e.recommended_next_action:void 0;return{generated_at:r(e.generated_at),overview:{active_lanes:d(t.active_lanes),moving_lanes:d(t.moving_lanes),stalled_lanes:d(t.stalled_lanes),projected_lanes:d(t.projected_lanes),last_movement_at:r(t.last_movement_at)??null},lanes:Array.isArray(e.lanes)?e.lanes.map(nv).filter(a=>a!==null):[],timeline:Array.isArray(e.timeline)?e.timeline.map(sv).filter(a=>a!==null):[],gaps:{count:d(n.count),items:Array.isArray(n.items)?n.items.map(av).filter(a=>a!==null):[]},recommended_next_action:s?{tool:r(s.tool)??"masc_operator_snapshot",label:r(s.label)??"Observe operator state",reason:r(s.reason)??"",lane_id:r(s.lane_id)??null}:void 0}}function iv(e){if(!v(e))return;const t=v(e.workers)?e.workers:{},n=E(e.pass);return{status:r(e.status)??"missing",source:r(e.source)??"none",run_id:r(e.run_id)??null,captured_at:r(e.captured_at)??null,...n!==void 0?{pass:n}:{},...d(e.peak_hot_slots)!=null?{peak_hot_slots:d(e.peak_hot_slots)}:{},...d(e.ctx_per_slot)!=null?{ctx_per_slot:d(e.ctx_per_slot)}:{},workers:{expected:d(t.expected),joined:d(t.joined),current_task_bound:d(t.current_task_bound),fresh_heartbeats:d(t.fresh_heartbeats),done:d(t.done),final:d(t.final)},artifact_ref:r(e.artifact_ref)??null,missing_reason:r(e.missing_reason)??null}}function ov(e){const t=v(e)?e:{};return{version:r(t.version),generated_at:r(t.generated_at),topology:Tl(t.topology),operations:Rl(t.operations),detachments:Pl(t.detachments),alerts:Ll(t.alerts),decisions:Nl(t.decisions),capacity:Xm(t.capacity),traces:ev(t.traces),swarm_status:Ml(t.swarm_status)}}function rv(e){const t=v(e)?e:{},n=Tl(t.topology),s=Rl(t.operations),a=Pl(t.detachments),o=Ll(t.alerts),l=Nl(t.decisions);return{version:r(t.version),generated_at:r(t.generated_at),topology:{version:n.version,generated_at:n.generated_at,source:n.source,summary:n.summary},operations:{version:s.version,generated_at:s.generated_at,summary:s.summary,microarch:s.microarch},detachments:{version:a.version,generated_at:a.generated_at,summary:a.summary},alerts:{version:o.version,generated_at:o.generated_at,summary:o.summary},decisions:{version:l.version,generated_at:l.generated_at,summary:l.summary},swarm_status:Ml(t.swarm_status),swarm_proof:iv(t.swarm_proof)}}function lv(e){return v(e)?{chain_id:r(e.chain_id)??null,started_at:d(e.started_at)??null,progress:d(e.progress)??null,elapsed_sec:d(e.elapsed_sec)??null}:null}function jl(e){if(!v(e))return null;const t=r(e.event);return t?{event:t,chain_id:r(e.chain_id)??null,timestamp:r(e.timestamp)??null,duration_ms:d(e.duration_ms)??null,message:r(e.message)??null,tokens:d(e.tokens)??null}:null}function cv(e){if(!v(e))return null;const t=Ia(e.operation);return t?{operation:t,runtime:lv(e.runtime),history:jl(e.history),mermaid:r(e.mermaid)??null,preview_run:El(e.preview_run)}:null}function dv(e){const t=v(e)?e:{};return{status:r(t.status)??"disconnected",base_url:r(t.base_url)??null,message:r(t.message)??null}}function uv(e){const t=v(e)?e:{},n=v(t.summary)?t.summary:void 0;return{version:r(t.version),generated_at:r(t.generated_at),connection:dv(t.connection),summary:n?{linked_operations:d(n.linked_operations),active_chains:d(n.active_chains),running_operations:d(n.running_operations),recent_failures:d(n.recent_failures),last_history_event_at:r(n.last_history_event_at)??null}:void 0,operations:Array.isArray(t.operations)?t.operations.map(cv).filter(s=>s!==null):[],recent_history:Array.isArray(t.recent_history)?t.recent_history.map(jl).filter(s=>s!==null):[]}}function pv(e){if(!v(e))return null;const t=r(e.id);return t?{id:t,type:r(e.type),status:r(e.status),duration_ms:d(e.duration_ms)??null,error:r(e.error)??null}:null}function El(e){if(!v(e))return null;const t=r(e.run_id),n=r(e.chain_id);return n?{run_id:t??null,chain_id:n,duration_ms:d(e.duration_ms),success:E(e.success),mermaid:r(e.mermaid),nodes:Array.isArray(e.nodes)?e.nodes.map(pv).filter(s=>s!==null):[]}:null}function mv(e){const t=v(e)?e:{};return{run:El(t.run)}}function vv(e){if(!v(e))return null;const t=r(e.title),n=r(e.path);return!t||!n?null:{title:t,path:n}}function _v(e){if(!v(e))return null;const t=r(e.id),n=r(e.title),s=r(e.summary);return!t||!n||!s?null:{id:t,title:n,summary:s}}function gv(e){if(!v(e))return null;const t=r(e.id),n=r(e.title),s=r(e.tool),a=r(e.summary);return!t||!n||!s||!a?null:{id:t,title:n,tool:s,summary:a,success_signals:W(e.success_signals),pitfalls:W(e.pitfalls)}}function fv(e){if(!v(e))return null;const t=r(e.id),n=r(e.title),s=r(e.summary),a=r(e.when_to_use);return!t||!n||!s||!a?null:{id:t,title:n,summary:s,when_to_use:a,steps:Array.isArray(e.steps)?e.steps.map(gv).filter(o=>o!==null):[]}}function $v(e){if(!v(e))return null;const t=r(e.id),n=r(e.title),s=r(e.description);return!t||!n||!s?null:{id:t,title:n,description:s,tools:W(e.tools)}}function hv(e){if(!v(e))return null;const t=r(e.id),n=r(e.title),s=r(e.symptom),a=r(e.why),o=r(e.fix_tool),l=r(e.fix_summary);return!t||!n||!s||!a||!o||!l?null:{id:t,title:n,symptom:s,why:a,fix_tool:o,fix_summary:l}}function yv(e){if(!v(e))return null;const t=r(e.id),n=r(e.title),s=r(e.path_id),a=r(e.transport);return!t||!n||!s||!a?null:{id:t,title:n,path_id:s,transport:a,request:e.request,response:e.response,notes:W(e.notes)}}function bv(e){const t=v(e)?e:{};return{version:r(t.version),generated_at:r(t.generated_at),docs:Array.isArray(t.docs)?t.docs.map(vv).filter(n=>n!==null):[],concepts:Array.isArray(t.concepts)?t.concepts.map(_v).filter(n=>n!==null):[],golden_paths:Array.isArray(t.golden_paths)?t.golden_paths.map(fv).filter(n=>n!==null):[],tool_groups:Array.isArray(t.tool_groups)?t.tool_groups.map($v).filter(n=>n!==null):[],pitfalls:Array.isArray(t.pitfalls)?t.pitfalls.map(hv).filter(n=>n!==null):[],examples:Array.isArray(t.examples)?t.examples.map(yv).filter(n=>n!==null):[]}}function kv(e){if(!v(e))return null;const t=r(e.id),n=r(e.title),s=r(e.status),a=r(e.detail),o=r(e.next_tool);return!t||!n||!s||!a||!o?null:{id:t,title:n,status:s,detail:a,next_tool:o}}function xv(e){if(!v(e))return null;const t=r(e.code),n=r(e.severity),s=r(e.title),a=r(e.detail),o=r(e.next_tool);return!t||!n||!s||!a||!o?null:{code:t,severity:n,title:s,detail:a,next_tool:o}}function Sv(e){if(!v(e))return null;const t=r(e.from),n=r(e.content),s=r(e.timestamp),a=d(e.seq);return!t||!n||!s||a==null?null:{seq:a,from:t,content:n,timestamp:s}}function Av(e){if(!v(e))return null;const t=r(e.name),n=r(e.role),s=r(e.lane),a=r(e.status),o=r(e.claim_marker),l=r(e.done_marker),c=r(e.final_marker);if(!t||!n||!s||!a||!o||!l||!c)return null;const p=(()=>{if(!v(e.last_message))return null;const m=d(e.last_message.seq),u=r(e.last_message.content),_=r(e.last_message.timestamp);return m==null||!u||!_?null:{seq:m,content:u,timestamp:_}})();return{name:t,role:n,lane:s,joined:E(e.joined)??!1,live_presence:E(e.live_presence)??!1,completed:E(e.completed)??!1,status:a,current_task:r(e.current_task)??null,bound_task_id:r(e.bound_task_id)??null,bound_task_title:r(e.bound_task_title)??null,bound_task_status:r(e.bound_task_status)??null,current_task_matches_run:E(e.current_task_matches_run)??!1,squad_member:E(e.squad_member)??!1,detachment_member:E(e.detachment_member)??!1,last_seen:r(e.last_seen)??null,heartbeat_age_sec:d(e.heartbeat_age_sec)??null,heartbeat_fresh:E(e.heartbeat_fresh)??!1,claim_marker_seen:E(e.claim_marker_seen)??!1,done_marker_seen:E(e.done_marker_seen)??!1,final_marker_seen:E(e.final_marker_seen)??!1,claim_marker:o,done_marker:l,final_marker:c,last_message:p}}function Cv(e){if(!v(e))return;const t=Array.isArray(e.timeline)?e.timeline.map(n=>{if(!v(n))return null;const s=r(n.timestamp),a=d(n.active_slots);if(!s||a==null)return null;const o=Array.isArray(n.active_slot_ids)?n.active_slot_ids.map(l=>typeof l=="number"&&Number.isFinite(l)?l:null).filter(l=>l!=null):[];return{timestamp:s,active_slots:a,active_slot_ids:o}}).filter(n=>n!==null):[];return{slot_url:r(e.slot_url)??null,provider_base_url:r(e.provider_base_url)??null,provider_reachable:E(e.provider_reachable)??null,provider_status_code:d(e.provider_status_code)??null,provider_model_id:r(e.provider_model_id)??null,actual_model_id:r(e.actual_model_id)??null,expected_slots:d(e.expected_slots),actual_slots:d(e.actual_slots),expected_ctx:d(e.expected_ctx),actual_ctx:d(e.actual_ctx),slot_reachable:E(e.slot_reachable)??null,slot_status_code:d(e.slot_status_code)??null,runtime_blocker:r(e.runtime_blocker)??null,detail:r(e.detail)??null,checked_at:r(e.checked_at)??null,total_slots:d(e.total_slots),ctx_per_slot:d(e.ctx_per_slot),active_slots_now:d(e.active_slots_now),peak_active_slots:d(e.peak_active_slots),sample_count:d(e.sample_count),last_sample_at:r(e.last_sample_at)??null,timeline:t}}function Iv(e){if(!v(e))return null;const t=r(e.run_id),n=r(e.status),s=r(e.decided_by),a=r(e.decided_at),o=r(e.reason);if(!t||!n||!s||!a||!o)return null;const l=[];return Array.isArray(e.history)&&e.history.forEach(c=>{if(!v(c))return;const p=r(c.status),m=r(c.decided_by),u=r(c.decided_at),_=r(c.reason);!p||!m||!u||!_||l.push({status:p,decided_by:m,decided_at:u,reason:_,operation_id:r(c.operation_id)??null,detachment_id:r(c.detachment_id)??null,note:r(c.note)??null})}),{run_id:t,status:n,decided_by:s,decided_at:a,reason:o,operation_id:r(e.operation_id)??null,detachment_id:r(e.detachment_id)??null,note:r(e.note)??null,history:l}}function Tv(e){if(!v(e))return null;const t=r(e.run_id),n=r(e.recommended_kind),s=r(e.reason);return!t||!n||!s?null:{run_id:t,recommended_kind:n,continue_available:E(e.continue_available)??!1,rerun_available:E(e.rerun_available)??!1,abandon_available:E(e.abandon_available)??!1,reason:s,evidence:v(e.evidence)?{operation_id:r(e.evidence.operation_id)??null,detachment_id:r(e.evidence.detachment_id)??null,joined_workers:d(e.evidence.joined_workers),current_task_bound:d(e.evidence.current_task_bound),fresh_heartbeats:d(e.evidence.fresh_heartbeats),trace_events:d(e.evidence.trace_events),message_events:d(e.evidence.message_events),runtime_blocker:r(e.evidence.runtime_blocker)??null}:void 0,provenance:r(e.provenance),decision_engine:r(e.decision_engine),authoritative:E(e.authoritative)}}function Rv(e){const t=v(e)?e:{},n=v(t.summary)?t.summary:void 0;return{version:r(t.version),generated_at:r(t.generated_at),run_id:r(t.run_id),room_id:r(t.room_id),operation_id:r(t.operation_id)??null,run_resolution:Iv(t.run_resolution),resolution_recommendation:Tv(t.resolution_recommendation),recommended_next_tool:r(t.recommended_next_tool),summary:n?{expected_workers:d(n.expected_workers),joined_workers:d(n.joined_workers),live_workers:d(n.live_workers),squad_roster_size:d(n.squad_roster_size),detachment_roster_size:d(n.detachment_roster_size),current_task_bound:d(n.current_task_bound),fresh_heartbeats:d(n.fresh_heartbeats),claim_markers_seen:d(n.claim_markers_seen),done_markers_seen:d(n.done_markers_seen),final_markers_seen:d(n.final_markers_seen),completed_workers:d(n.completed_workers),peak_hot_slots:d(n.peak_hot_slots),hot_window_ok:E(n.hot_window_ok),pass_hot_concurrency:E(n.pass_hot_concurrency),pass_end_to_end:E(n.pass_end_to_end),pending_decisions:d(n.pending_decisions),pass:E(n.pass)}:void 0,provider:Cv(t.provider),operation:Ia(t.operation),squad:Zi(t.squad),detachment:wl(t.detachment),workers:Array.isArray(t.workers)?t.workers.map(Av).filter(s=>s!==null):[],checklist:Array.isArray(t.checklist)?t.checklist.map(kv).filter(s=>s!==null):[],blockers:Array.isArray(t.blockers)?t.blockers.map(xv).filter(s=>s!==null):[],recent_messages:Array.isArray(t.recent_messages)?t.recent_messages.map(Sv).filter(s=>s!==null):[],recent_trace_events:Array.isArray(t.recent_trace_events)?t.recent_trace_events.map(zl).filter(s=>s!==null):[],truth_notes:W(t.truth_notes)}}function St(e){X.value=e,Xi(e)&&wv()}async function Dl(){Vs.value=!0,Qs.value=null;try{const e=await ld();Qi.value=rv(e)}catch(e){Qs.value=e instanceof Error?e.message:"Failed to load command-plane summary"}finally{Vs.value=!1}}function eo(e){Jt.value=e}async function to(){Ys.value=!0,Xs.value=null;try{const e=await rd();je.value=ov(e)}catch(e){Xs.value=e instanceof Error?e.message:"Failed to load command-plane snapshot"}finally{Ys.value=!1}}async function wv(){je.value||Ys.value||await to()}async function Et(){await Dl(),Xi(X.value)&&await to()}async function Vt(){var e;Ii.value=!0,sa.value=null;try{const t=await cd(),n=uv(t);Xn.value=n;const s=Jt.value;n.operations.length===0?Jt.value=null:(!s||!n.operations.some(a=>a.operation.operation_id===s))&&(Jt.value=((e=n.operations[0])==null?void 0:e.operation.operation_id)??null)}catch(t){sa.value=t instanceof Error?t.message:"Failed to load chain summary"}finally{Ii.value=!1}}function Pv(){_n=null,zn.value=null,aa.value=!1,Mn.value=null}async function Nv(e){_n=e,aa.value=!0,Mn.value=null;try{const t=await dd(e);if(_n!==e)return;zn.value=mv(t)}catch(t){if(_n!==e)return;zn.value=null,Mn.value=t instanceof Error?t.message:"Failed to load chain run"}finally{_n===e&&(aa.value=!1)}}async function Lv(){Ci.value=!0,ea.value=null;try{const e=await ud();Qn.value=bv(e)}catch(e){ea.value=e instanceof Error?e.message:"Failed to load command-plane help"}finally{Ci.value=!1}}async function Je(e=Fm(),t=Km()){ta.value=!0,na.value=null;try{const n=await pd(e,t);Tt.value=Rv(n)}catch(n){na.value=n instanceof Error?n.message:"Failed to load command-plane swarm view"}finally{ta.value=!1}}async function dt(e,t,n){Ai.value=e,Zs.value=null;try{await md(t,n),await Dl(),(je.value||Xi(X.value))&&await to(),await Je(),await Vt()}catch(s){throw Zs.value=s instanceof Error?s.message:"Failed to execute command-plane action",s}finally{Ai.value=null}}function zv(e){return dt(`pause:${e}`,"/api/v1/command-plane/operations/pause",{operation_id:e})}function Mv(e){return dt(`resume:${e}`,"/api/v1/command-plane/operations/resume",{operation_id:e})}function jv(e){return dt(`recall:${e}`,"/api/v1/command-plane/dispatch/recall",{operation_id:e})}function Ev(e={}){return dt("dispatch:tick","/api/v1/command-plane/dispatch/tick",{...e.operationId?{operation_id:e.operationId}:{},...e.detachmentId?{detachment_id:e.detachmentId}:{}})}function Dv(e){return dt(`approve:${e}`,"/api/v1/command-plane/policy/approve",{decision_id:e})}function Ov(e){return dt(`deny:${e}`,"/api/v1/command-plane/policy/deny",{decision_id:e})}function qv(e,t){return dt(`freeze:${e}`,"/api/v1/command-plane/policy/freeze",{unit_id:e,enabled:t})}function Fv(e,t){return dt(`kill:${e}`,"/api/v1/command-plane/policy/kill-switch",{unit_id:e,enabled:t})}Ju(()=>{Et(),Vt(),(X.value==="swarm"||X.value==="warroom"||Tt.value!==null)&&Je(),X.value==="warroom"&&he()});function ia(e){if(e==null)return"";if(typeof e=="string")return e;try{return JSON.stringify(e,null,2)}catch{return String(e)}}function Y(e){if(!e)return"n/a";const t=Date.parse(e);if(Number.isNaN(t))return e;const n=Math.max(0,Math.round((Date.now()-t)/1e3));return n<60?`${n}s ago`:n<3600?`${Math.round(n/60)}m ago`:n<86400?`${Math.round(n/3600)}h ago`:`${Math.round(n/86400)}d ago`}function Kv(e){if(!e)return"warn";const t=Date.parse(e);return Number.isNaN(t)?"warn":t<=Date.now()?"bad":"ok"}function Ol(e){if(!e)return"n/a";const t=Date.parse(e);if(Number.isNaN(t))return e;const n=Math.round((t-Date.now())/1e3);return n<=0?"expired":n<60?`in ${n}s`:n<3600?`in ${Math.round(n/60)}m`:n<86400?`in ${Math.round(n/3600)}h`:`in ${Math.round(n/86400)}d`}function M(e){return e==="bad"?"bad":e==="warn"||e==="pending"?"warn":"ok"}let Do=!1,Bv=0;function Uv(){return++Bv}let Ea=null;async function Hv(){Ea||(Ea=qm(()=>import("./mermaid.core-DO2e2EGs.js").then(t=>t.bE),[]).then(t=>t.default));const e=await Ea;return Do||(e.initialize({startOnLoad:!1,theme:"dark",securityLevel:"loose"}),Do=!0),e}function et(e){if(!e)return"warn";const t=e.toLowerCase();return t.includes("failed")||t.includes("error")||t.includes("disconnected")||t.includes("stopped")?"bad":t.includes("running")||t.includes("active")||t.includes("degraded")||t.includes("pending")?"warn":"ok"}function Zn(e){return typeof e!="number"||!Number.isFinite(e)?"n/a":`${Math.round(e*100)}%`}function gn(e){return typeof e!="number"||!Number.isFinite(e)?"n/a":e<60?`${Math.round(e)}s`:e<3600?`${Math.round(e/60)}m`:`${Math.round(e/3600)}h`}function es(e){return typeof e!="number"||!Number.isFinite(e)?0:Math.max(0,Math.min(100,e))}function gt(e,t){return typeof e!="number"||!Number.isFinite(e)||typeof t!="number"||!Number.isFinite(t)||t<=0?0:es(e/t*100)}function Wv(e,t){const n=es(e);return`--gauge-angle:${Math.max(10,Math.round(n/100*360))}deg;--gauge-color:${t};`}function ql(e){if(!e)return"No recent chain history";const t=[e.event];return typeof e.duration_ms=="number"&&t.push(`${e.duration_ms}ms`),typeof e.tokens=="number"&&t.push(`${e.tokens} tokens`),e.message&&t.push(e.message),t.join(" · ")}const Gv=[{id:"status",label:"현황"},{id:"history",label:"이력"},{id:"control",label:"통제"}],Fl=[{id:"warroom",label:"워룸",group:"status"},{id:"summary",label:"요약",group:"status"},{id:"topology",label:"토폴로지",group:"status"},{id:"swarm",label:"스웜",group:"status"},{id:"operations",label:"작전",group:"history"},{id:"trace",label:"트레이스",group:"history"},{id:"chains",label:"체인",group:"history"},{id:"control",label:"제어",group:"control"},{id:"alerts",label:"알림",group:"control"}],Jv=Fl.map(e=>e.id),Vv=["chain_start","node_start","node_complete","chain_complete","chain_error"],Yv={warroom:{title:"라이브 워룸",description:"실제 run, worker, message, trace를 한 화면에서 따라가는 기본 진입 표면입니다."},operations:{title:"현재 작전 상세",description:"활성 operation, detachment, dependency를 먼저 읽는 기본 진입 표면입니다."},swarm:{title:"스웜 실행 흐름",description:"lane 이동, worker 결속, blocker를 따라가며 현장감 있게 보는 표면입니다."},chains:{title:"체인 런타임",description:"체인 연결 상태와 operation별 실행 그래프를 확인하는 표면입니다."},topology:{title:"지휘 계층",description:"실제 managed unit인지, live agent 기반 자동 투영인지 구분해서 봅니다."},alerts:{title:"경보 모음",description:"지금 개입을 밀어올리는 alert만 모아서 보는 표면입니다."},trace:{title:"최근 트레이스",description:"operation, actor, unit 단위 이벤트를 시간순으로 보는 표면입니다."},control:{title:"승인과 제어",description:"decision 승인과 unit 제어를 실제로 수행하는 표면입니다."},summary:{title:"지휘 요약",description:"전체 지휘면을 한 번에 훑는 계기판 성격의 요약 표면입니다."}};function Oo(e){return!!e&&Jv.includes(e)}function Qv(){const e=F.value.params;return e.source!=="mission"&&e.source!=="execution"?{}:{source:e.source,...e.action_type?{action_type:e.action_type}:{},...e.target_type?{target_type:e.target_type}:{},...e.target_id?{target_id:e.target_id}:{},...e.focus_kind?{focus_kind:e.focus_kind}:{},...e.operation_id?{operation_id:e.operation_id}:{}}}function Kl(e){const t=Qv();if(e==="operations")return t;if(e==="chains"){const n=Jt.value;return n?{...t,surface:e,operation:n}:{...t,surface:e}}return{...t,surface:e}}function Xv(){const e=new URLSearchParams(window.location.search),t=new URLSearchParams,n=e.get("agent")??e.get("agent_name"),s=e.get("token");return n&&t.set("agent",n),s&&t.set("token",s),t.toString()?`/api/v1/chains/events?${t.toString()}`:"/api/v1/chains/events"}function Zv(e){switch(e){case"company":return"중대 / Company";case"platoon":return"소대 / Platoon";case"squad":return"분대 / Squad";case"agent":return"에이전트 / Agent";default:return e}}function se(e){return Ai.value===e}function ts(){return Qi.value}function e_(e){var a,o,l,c,p,m,u;const t=Qi.value,n=Tt.value,s=Xn.value;switch(e){case"warroom":return{tool:"masc_observe_operations",reason:"live run, worker, message, trace를 한 화면에서 보고 필요한 detail 표면으로 바로 점프합니다."};case"operations":return{tool:"masc_operation_status",reason:`활성 작전 ${((a=t==null?void 0:t.operations.summary)==null?void 0:a.active)??0}개와 dependency를 먼저 확인합니다.`};case"swarm":return{tool:(n==null?void 0:n.recommended_next_tool)??((l=(o=t==null?void 0:t.swarm_status)==null?void 0:o.recommended_next_action)==null?void 0:l.tool)??"masc_observe_traces",reason:((p=(c=t==null?void 0:t.swarm_status)==null?void 0:c.recommended_next_action)==null?void 0:p.reason)??"lane 이동과 blocker를 보고 다음 probe 도구를 고릅니다."};case"chains":return{tool:(u=(m=s==null?void 0:s.operations[0])==null?void 0:m.preview_run)!=null&&u.chain_id?"masc_chain_run_get":"masc_chain_snapshot",reason:"체인 연결 상태와 최근 run 그래프를 함께 보면 병목을 빨리 좁힐 수 있습니다."};case"topology":return{tool:"masc_observe_topology",reason:"이 구조가 실제 관리 단위인지 자동 투영인지 먼저 구분해야 command-plane을 오해하지 않습니다."};case"alerts":return{tool:"masc_observe_alerts",reason:"경보에서 먼저 문제가 된 unit과 operation을 고릅니다."};case"trace":return{tool:"masc_observe_traces",reason:"trace 흐름으로 원인 이벤트를 바로 따라갈 수 있습니다."};case"control":return{tool:"masc_operator_action",reason:"승인이나 kill switch 같은 실제 조작은 control 표면과 operator action이 이어집니다."};case"summary":default:return{tool:"masc_observe_operations",reason:"요약을 본 뒤에는 현재 작전 표면으로 내려가 실제 움직임을 확인하는 게 가장 빠릅니다."}}}function t_(e){var n;const t=((n=e==null?void 0:e.focus_kind)==null?void 0:n.toLowerCase())??"";return t?t.includes("artifact_scope")||t.includes("routing_confidence")||t.includes("cache_contention")?"microarch":t.includes("leader_offline")||t.includes("roster_offline")?"alerts":t.includes("stale_data")?"swarm":null:null}function n_(e){var n;const t=((n=e==null?void 0:e.focus_kind)==null?void 0:n.toLowerCase())??"";return t?t.includes("stale_data")||t.includes("leader_offline")||t.includes("roster_offline")||t.includes("managed")?"recommendation":t.includes("gap")?"gaps":null:null}function Bl(){if(typeof window>"u")return null;const e=new URLSearchParams(window.location.search),t=e.get("agent")??e.get("agent_name");if(!t)return null;const n=t.trim();return n===""?null:n}function Ul(){if(typeof window>"u")return new URLSearchParams;const e=new URLSearchParams(window.location.search),t=window.location.hash.replace(/^#/,""),n=t.indexOf("?");return n>=0&&new URLSearchParams(t.slice(n+1)).forEach((a,o)=>{e.has(o)||e.set(o,a)}),e}function s_(){const t=Ul().get("run_id");if(!t)return null;const n=t.trim();return n===""?null:n}function Hl(){const t=Ul().get("operation_id");if(!t)return null;const n=t.trim();return n===""?null:n}function a_(e){if(!e)return null;const t=Date.parse(e);return Number.isNaN(t)?null:Math.max(0,Math.round((Date.now()-t)/1e3))}function i_(e){return e.status==="claimed"||e.status==="in_progress"}function o_(e){const t=Qn.value;if(!t)return null;for(const n of t.golden_paths){const s=n.steps.find(a=>a.tool===e);if(s)return s}return null}function Da(e){var t;return((t=Qn.value)==null?void 0:t.golden_paths.find(n=>n.id===e))??null}function r_(e){const t=Qn.value;if(!t)return[];const n=new Set(e);return t.pitfalls.filter(s=>n.has(s.id))}async function tt(e){try{await e()}catch{}}function no(e){return(e==null?void 0:e.trim().toLowerCase())??""}function Dt(e){const t=no(e);return t.includes("failed")||t.includes("error")||t.includes("stopped")||t==="paused"?"bad":t.includes("active")||t.includes("running")||t.includes("healthy")||t.includes("ok")?"ok":"warn"}function ps(e){const t=no(e);return t?t==="active"||t==="running"?"진행 중":t==="paused"?"일시정지":t==="done"||t==="ended"||t==="completed"?"완료":t==="failed"||t==="error"||t==="stopped"?"문제":(e==null?void 0:e.trim())||"확인 필요":"확인 필요"}function l_(){var n,s,a,o,l,c,p,m,u;const e=Tt.value;if(!e)return!1;const t=e.workers.some(_=>_.joined||_.live_presence||_.completed||_.current_task_matches_run||_.heartbeat_fresh||_.claim_marker_seen||_.done_marker_seen||_.final_marker_seen||!!_.current_task||!!_.bound_task_id||!!_.last_message);return!!((n=e.operation)!=null&&n.operation_id||(s=e.detachment)!=null&&s.detachment_id||(((a=e.summary)==null?void 0:a.joined_workers)??0)>0||(((o=e.summary)==null?void 0:o.live_workers)??0)>0||(((l=e.summary)==null?void 0:l.current_task_bound)??0)>0||(((c=e.summary)==null?void 0:c.fresh_heartbeats)??0)>0||(((p=e.summary)==null?void 0:p.claim_markers_seen)??0)>0||(((m=e.summary)==null?void 0:m.done_markers_seen)??0)>0||(((u=e.summary)==null?void 0:u.final_markers_seen)??0)>0||t||e.recent_messages.length>0||e.recent_trace_events.length>0)}function c_(e){const t=no(e.status);return t==="active"||t==="running"}function d_(){var o,l,c,p;const e=((o=ve.value)==null?void 0:o.sessions)??[],t=Tt.value,n=((l=t==null?void 0:t.detachment)==null?void 0:l.session_id)??null;if(n){const m=e.find(u=>u.session_id===n);if(m)return m}const s=((c=t==null?void 0:t.operation)==null?void 0:c.operation_id)??Hl();if(s){const m=e.find(u=>u.command_plane_operation_id===s);if(m)return m}const a=((p=t==null?void 0:t.detachment)==null?void 0:p.detachment_id)??null;if(a){const m=e.find(u=>u.command_plane_detachment_id===a);if(m)return m}return e.find(c_)??e[0]??null}function Oa(e){return e==="proven"?"ok":e==="partial"?"warn":"bad"}function kn(e){return Array.isArray(e)?e:[]}function Te(e){return typeof e=="object"&&e!==null&&!Array.isArray(e)?e:{}}function ms(e){return typeof e=="string"&&e.trim()!==""?e:null}function u_(e){return typeof e=="number"&&Number.isFinite(e)?e:null}function p_(e){const t=e.split("/");return t.length<=3?e:`…/${t.slice(-3).join("/")}`}function m_(e){return e==="proven"?"협업 증거가 충분합니다":e==="partial"?"흔적은 있으나 협업 증거가 덜 모였습니다":"증거가 부족합니다"}function v_(e,t,n,s,a){const o=[`${t}명의 actor 흔적이 기록돼 있습니다.`,n>0?`서로를 참조한 상호작용 증거가 ${n}건 있습니다.`:"서로를 참조한 명시적 상호작용 증거가 아직 없습니다.",s>0?`도구·산출물·체크포인트 증거가 ${s}건 있습니다.`:"도구·산출물·체크포인트 증거가 거의 없습니다.",a>0?`CPv2 backing trace가 ${a}건 있어 실행 흔적은 남아 있습니다.`:"managed backing trace는 아직 없습니다."];return e==="partial"?[o[0]??"",n===0?"partial인 이유: 참여 흔적은 있지만 actor 간 상호작용이 직접 보이지 않습니다.":"partial인 이유: 일부 증거는 있으나 proven 기준을 모두 채우지 못했습니다.",a>0?"다음 보강 포인트: 대화/상호참조 event를 남기면 proof가 더 강해집니다.":"다음 보강 포인트: managed trace 또는 산출물 linkage를 더 남기면 proof가 강해집니다."]:e==="proven"?[o[0]??"","결론: 참여, 상호작용, 산출물, backing evidence가 모두 연결돼 있습니다.","다음 행동: raw evidence는 접어두고 세션 결과와 산출물만 확인하면 됩니다."]:[o[0]??"","결론: 기록은 있으나 협업을 증명할 만큼의 연결 증거가 부족합니다.","다음 보강 포인트: participant 간 turn, tool evidence, deliverable linkage를 더 남겨야 합니다."]}function __(e){const t=new Map;for(const n of e){const s=[n.timestamp??"",n.event_type??"",n.actor??"",n.summary??""].join("|"),a=n.source??"unknown",o=t.get(s);if(o){o.sources.includes(a)||o.sources.push(a),!o.operation_id&&n.operation_id&&(o.operation_id=n.operation_id);continue}t.set(s,{...n,sources:[a]})}return[...t.values()]}function g_(e){return e.sources.length===2?"team + command":e.sources.length===1?e.sources[0]??"source":e.sources.join(" + ")}function f_(e){const t=[];for(const[n,s]of Object.entries(e))if(s!=null){if(typeof s=="string"){if(s.trim()==="")continue;t.push({label:n,value:s});continue}if(typeof s=="number"||typeof s=="boolean"){t.push({label:n,value:String(s)});continue}}return t}function $_(e){const t=Te(e),n=Te(t.traces),s=Array.isArray(n.events)?n.events:[],a=Te(t.detachments),o=Array.isArray(a.detachments)?a.detachments:[],l=Te(o[0]),c=Te(l.detachment),p=Te(l.operation),m=Te(t.summary),u=Te(m.operations),_=Te(u.summary);return[{label:"operation",value:ms(t.operation_id)??"없음"},{label:"detachment",value:ms(t.detachment_id)??"없음"},{label:"trace events",value:`${s.length}`},{label:"detachment status",value:ms(c.status)??"없음"},{label:"operation stage",value:ms(p.stage)??"없음"},{label:"active ops",value:`${u_(_.active)??0}`}]}function h_({item:e}){return i`
  ...
  `}function y_({item:e}){const t=e.recent_output_preview??null,n=e.recent_input_preview??null,s=e.recent_event_summary??null,a=(e.interaction_count??0)>0?"ok":"warn";return i`
  ...
  `}function qo({title:e,rows:t}){return t.length===0?null:i`
    ...
    <section class="dashboard-panel mission-view">
      ...
      <div class="mission-human-grid">
        <${I} title="3-Line Proof Summary" class="mission-list-card" semanticId="proof.summary">
          ...
          <div class="proof-summary-stack">
            ${k.map((P,T)=>i`
              <article class="proof-summary-block ${T===1&&c!=="proven"?Oa(c):""}">
      ...
      <div class="mission-human-grid">
        <${I} title="Collaboration Timeline" class="mission-list-card" semanticId="proof.timeline">
          ...
          <div class="mission-list-stack">
            ${$.length>0?$.slice(0,18).map(P=>i`<${h_} key=${P.id} item=${P} />`):i`<div class="empty-state">표시할 timeline evidence가 없습니다.</div>`}
          </div>
        <//>
        ...
        <${I} title="Actor Contributions" class="mission-list-card" semanticId="proof.contributions">
          ...
          <div class="mission-activity-list">
            ${o.length>0?o.map(P=>i`<${y_} key=${P.actor} item=${P} />`):i`<div class="empty-state">표시할 actor contribution이 없습니다.</div>`}
          </div>
        <//>
      </div>
      ...
      <div class="mission-human-grid">
        <${I} title="Backing Evidence" class="mission-list-card" semanticId="proof.backing">
          ...
          <details class="mission-card-disclosure compact">
            ...
            <pre class="command-json-block">${ia(p??{})}</pre>
          </details>
        <//>
        ...
        <${I} title="Artifacts" class="mission-list-card" semanticId="proof.artifacts">
          ...
          <div class="mission-list-stack">
            ${l.length>0?l.map(P=>i`<${b_} key=${P.path} item=${P} />`):i`<div class="empty-state">기록된 artifact가 없습니다.</div>`}
          </div>
        <//>
      </div>
    </section>
  `}function x_(){const e=Yn(F.value);return e?i`
  ...
  `}function vs({label:e,value:t,subtext:n,percent:s,color:a}){return i`
    <article class="command-gauge-card">
      <div class="command-gauge-ring" style=${Wv(s,a)}>
  ...
  `}function A_(){var Q,ne,J,ee;const e=ts(),t=e==null?void 0:e.topology.summary,n=e==null?void 0:e.operations.summary,s=e==null?void 0:e.detachments.summary,a=e==null?void 0:e.decisions.summary,o=e==null?void 0:e.alerts.summary,l=(Q=e==null?void 0:e.swarm_status)==null?void 0:Q.overview,c=e==null?void 0:e.swarm_proof,p=e==null?void 0:e.operations.microarch,m=(t==null?void 0:t.managed_unit_count)??0,u=(t==null?void 0:t.total_units)??0,_=(n==null?void 0:n.active)??0,f=(s==null?void 0:s.active)??0,$=(l==null?void 0:l.moving_lanes)??0,S=(l==null?void 0:l.active_lanes)??0,h=(c==null?void 0:c.workers.done)??0,C=(c==null?void 0:c.workers.expected)??0,x=(o==null?void 0:o.bad)??0,k=(o==null?void 0:o.warn)??0,L=(a==null?void 0:a.pending)??0,R=(a==null?void 0:a.total)??0,w=_+f,P=((ne=p==null?void 0:p.cache)==null?void 0:ne.l1_hit_rate)??((ee=(J=p==null?void 0:p.signals)==null?void 0:J.cache_contention)==null?void 0:ee.l1_hit_rate)??0,T=_>0||f>0?"지휘면이 실제로 움직이고 있습니다":"계층은 준비됐지만 실행은 아직 잠복 상태입니다",N=_>0||$>0?"무거운 상세 탭으로 들어가기 전에, 여기서 먼저 압력과 이동감, 운영 부채를 읽을 수 있어야 합니다.":"이 화면은 체크리스트보다 계기판에 가까워야 합니다. 아래 게이지가 지금 어디가 살아 있는지 먼저 보여줍니다.";return i`
  ...
  `}function I_(){var Q,ne,J,ee,A,Ae,Ue,ut,pt;const e=ts(),t=je.value,n=ie.value,s=Bl(),a=s?Be.value.find(K=>K.name===s)??null:null,o=s?Ye.value.filter(K=>K.assignee===s&&i_(K)):[],l=((Q=e==null?void 0:e.operations.summary)==null?void 0:Q.active)??0,c=((ne=e==null?void 0:e.detachments.summary)==null?void 0:ne.total)??0,p=((J=e==null?void 0:e.decisions.summary)==null?void 0:J.pending)??0,m=t==null?void 0:t.detachments.detachments.find(K=>{const Ce=K.detachment.heartbeat_deadline,mt=Ce?Date.parse(Ce):Number.NaN;return K.detachment.status==="stalled"||!Number.isNaN(mt)&&mt<=Date.now()}),u=t==null?void 0:t.alerts.alerts.find(K=>K.severity==="bad"),_=!!(n!=null&&n.room||n!=null&&n.project),f=(a==null?void 0:a.current_task)??null,$=a_(a==null?void 0:a.last_seen),S=$!=null?$<=120:null,h=[_?{title:"Room 준비도",tone:"ok",detail:`${(n==null?void 0:n.room)??(n==null?void 0:n.project)??"unknown"} · base ${(n==null?void 0:n.room_base_path)??"n/a"}`,tool:"masc_status"}:{title:"Room 준비도",tone:"bad",detail:"아직 room snapshot이 없습니다. 조인 전에 room을 repo root로 맞추세요.",tool:"masc_set_room"},s?a?o.length===0?{title:"Task 준비도",tone:"warn",detail:`${s} 에게 배정된 claimed task가 없습니다. 먼저 claim 하거나 만들어야 합니다.`,tool:Ye.value.length>0?"masc_claim":"masc_add_task"}:f?S===!1?{title:"Task 준비도",tone:"warn",detail:`${s} current_task=${f} 이지만 heartbeat가 stale 합니다 (${$}s).`,tool:"masc_heartbeat"}:{title:"Task 준비도",tone:"ok",detail:`${s} current_task=${f}${$!=null?` · 마지막 활동 ${$}s 전`:""}`,tool:"masc_plan_get_task"}:{title:"Task 준비도",tone:"bad",detail:`${s} 에 claimed task는 있지만 session current_task binding이 없습니다.`,tool:"masc_plan_set_task"}:{title:"Task 준비도",tone:"bad",detail:`${s} 이 room roster에 보이지 않습니다.`,tool:"masc_join"}:{title:"Task 준비도",tone:"warn",detail:"?agent= 쿼리가 없습니다. room health는 보이지만 agent 단위 다음 단계는 비어 있습니다.",tool:"masc_join"},!e||(((ee=e.topology.summary)==null?void 0:ee.managed_unit_count)??0)===0?{title:"작전 준비도",tone:"warn",detail:"관리 단위가 아직 정의되지 않았습니다. hierarchy가 있어야 CPv2 benchmark를 시작할 수 있습니다.",tool:"masc_unit_define"}:l===0?{title:"작전 준비도",tone:"warn",detail:`${((A=e.topology.summary)==null?void 0:A.managed_unit_count)??0}개 관리 단위는 준비됐지만 활성 작전은 없습니다.`,tool:"masc_operation_start"}:{title:"작전 준비도",tone:"ok",detail:`${((Ae=e.topology.summary)==null?void 0:Ae.managed_unit_count)??0}개 관리 단위 위에서 ${l}개 활성 작전이 돌고 있습니다.`,tool:"masc_observe_operations"},p>0?{title:"디스패치 준비도",tone:"warn",detail:`${p}개의 pending approval이 strict action을 막고 있습니다.`,tool:"masc_policy_approve"}:l>0&&c===0?{title:"디스패치 준비도",tone:"bad",detail:"active operation은 있지만 detachment가 아직 materialize 되지 않았습니다.",tool:"masc_dispatch_tick"}:m||u?{title:"디스패치 준비도",tone:"warn",detail:`dispatch 재정렬이 필요합니다${m?` · detachment ${m.detachment.detachment_id} 가 stalled 상태입니다`:""}${u?` · alert ${u.title??u.alert_id}`:""}${!t&&!m&&!u?" · 정확한 원인은 detail 탭에서 확인하세요.":""}.`,tool:p>0?"masc_policy_approve":"masc_dispatch_tick"}:{title:"디스패치 준비도",tone:"ok",detail:`${c}개 detachment가 보이고 strict approval backlog도 없습니다${t?"":" · detail pane은 열릴 때만 로드됩니다."}.`,tool:"masc_detachment_list"}],C=_?!s||!a?"masc_join":o.length===0?Ye.value.length>0?"masc_claim":"masc_add_task":f?S===!1?"masc_heartbeat":!e||(((Ue=e.topology.summary)==null?void 0:Ue.managed_unit_count)??0)===0?"masc_unit_define":l===0?"masc_operation_start":p>0?"masc_policy_approve":l>0&&c===0||m||u?"masc_dispatch_tick":"masc_observe_traces":"masc_plan_set_task":"masc_set_room",x=o_(C),L=r_(C==="masc_set_room"?["repo-root-room"]:C==="masc_plan_set_task"?["claimed-not-current"]:C==="masc_heartbeat"?["heartbeat-stale"]:C==="masc_dispatch_tick"?["no-detachments"]:C==="masc_policy_approve"?["pending-approval"]:["repo-root-room","claimed-not-current","heartbeat-stale"]).slice(0,2),R=Da("room_task_hygiene"),w=Da("cpv2_benchmark"),P=Da("supervisor_session"),T=((ut=Qn.value)==null?void 0:ut.docs)??[],N=[R,w,P].filter(K=>K!==null);return i`
    <div class="command-guided-layout">
      ...
      <section class="card command-section">
        ...
        ${Ci.value?i`<div class="empty-state">CPv2 runbook 불러오는 중…</div>`:ea.value?i`<div class="empty-state error">${ea.value}</div>`:i`
                ...
                ${T.length>0?i`<div class="command-doc-links">
                      ${T.map(K=>i`<span class="command-tag">${K.title}: ${K.path}</span>`)}
                    </div>`:null}
              `}
      </section>
    </div>
  `}function T_(){return i`
    ...
    <${C_} />
    <${I_} />
  `}function R_(){return Ys.value?i`<div class="empty-state">command-plane detail 불러오는 중…</div>`:Xs.value?i`<div class="empty-state error">${Xs.value}</div>`:i`<div class="empty-state">surface를 선택하면 command-plane detail을 로드합니다.</div>`}const Wl="masc_dashboard_agent_name";function w_(){var t,n,s;const e=new URLSearchParams(window.location.search);return((t=e.get("agent"))==null?void 0:t.trim())||((n=e.get("agent_name"))==null?void 0:n.trim())||((s=localStorage.getItem(Wl))==null?void 0:s.trim())||"dashboard"}const Ta=g(w_()),Yt=g(""),oa=g("운영 점검"),Qt=g(""),jn=g(""),En=g("2"),nn=g(""),$e=g("note"),Dn=g(""),On=g(""),qn=g(""),Fn=g("2"),Kn=g(""),ra=g("운영자 중지 요청"),la=g(""),Xt=g(""),gs=g(null);function P_(e){const t=e.trim()||"dashboard";Ta.value=t,localStorage.setItem(Wl,t)}function ca(e){if(e==null)return"";if(typeof e=="string")return e;try{return JSON.stringify(e,null,2)}catch{return String(e)}}function so(e){switch((e??"").trim().toLowerCase()){case"judgment":return"Resident judgment";case"fallback":return"Fallback read model";default:return(e==null?void 0:e.trim())||"Guidance"}}function da(e){switch((e??"").trim().toLowerCase()){case"judgment":return"ok";case"fallback":return"warn";default:return"warn"}}function ao(e){return e!=null&&e.enabled?e.refreshing?"갱신 중":e.judge_online?"온라인":e.last_error?"오류":"대기":"꺼짐"}function N_(e){return e!=null&&e.enabled?e.judge_online?"ok":e.refreshing?"warn":"bad":"warn"}function io(e){return e!=null&&e.fresh_until?e.fresh_until:"freshness 없음"}function Fo(e){return typeof e!="number"||!Number.isFinite(e)?"확인 없음":e<60?`${Math.round(e)}초 전`:e<3600?`${Math.round(e/60)}분 전`:`${Math.round(e/3600)}시간 전`}function sn(e){return typeof e=="string"?e.trim().toLowerCase():""}function L_(e){var s;const t=sn(e.status);if(t==="paused")return"bad";if(t===""||t==="unknown")return"warn";const n=sn((s=e.team_health)==null?void 0:s.status);return n&&n!=="ok"&&n!=="healthy"&&n!=="green"||t&&t!=="active"&&t!=="running"&&t!=="ended"?"warn":"ok"}function qa(e){const t=sn(e.status);return t==="offline"||t==="inactive"||t==="error"?"bad":t===""||t==="unknown"||(e.context_ratio??0)>=.8||e.context_ratio==null||e.last_turn_ago_s==null||(e.last_turn_ago_s??0)>=3600?"warn":"ok"}function Ko(e){return e.some(t=>sn(t.severity)==="bad")?"bad":e.length>0?"warn":"ok"}function z_(e){return e.target_type==="team_session"}function M_(e){return e.target_type==="keeper"}function At(e){switch(e){case"broadcast":return"방송";case"room_pause":return"room 일시정지";case"room_resume":return"room 재개";case"team_turn":return"세션 업데이트";case"team_note":return"세션 노트";case"team_broadcast":return"세션 방송";case"team_task_inject":return"세션 작업 주입";case"team_worker_spawn_batch":return"세션 worker 교체";case"task_inject":return"작업 주입";case"team_stop":return"세션 중지";case"keeper_message":return"keeper 메시지";case"keeper_msg":return"keeper 메시지";case"swarm_run_continue":return"swarm run 계속";case"swarm_run_rerun":return"swarm run 재실행";case"swarm_run_abandon":return"swarm run 포기";default:return(e==null?void 0:e.trim())||"액션"}}function Zt(e){switch(e){case"room":return"room";case"team_session":return"session";case"keeper":return"keeper";case"swarm_run":return"swarm run";default:return(e==null?void 0:e.trim())||"target"}}function Ot(e){switch(sn(e)){case"running":case"active":return"진행 중";case"paused":return"일시정지";case"ended":case"done":return"종료";case"offline":return"오프라인";case"idle":return"대기";case"unknown":case"":return"확인 필요";default:return(e==null?void 0:e.trim())||"확인 필요"}}function ua(e){return e?"확인 후 실행":"즉시 실행"}function j_(e){switch(e){case"note":return"노트";case"broadcast":return"방송";case"task":return"작업";case"worker_spawn_batch":return"worker 교체";default:return e}}function de(e,t){if(!e)return null;const n=e[t];return typeof n=="string"&&n.trim()!==""?n.trim():typeof n=="number"&&Number.isFinite(n)?String(n):null}function E_(e){return!e||typeof e!="object"||Array.isArray(e)?null:e}function D_(e){if(!e)return"";const t=e.spawn_batch;return ca(t!==void 0?t:e)}function Gl(e){const t=E_(e.payload);if(e.target_type==="room"){if(e.action_type==="broadcast"){Yt.value=de(t,"message")??e.summary;return}if(e.action_type==="task_inject"){Qt.value=de(t,"title")??"운영자 주입 작업",jn.value=de(t,"description")??e.summary,En.value=de(t,"priority")??En.value;return}e.action_type==="room_pause"&&(oa.value=de(t,"reason")??e.summary);return}if(e.target_type==="team_session"){if(e.target_id&&(nn.value=e.target_id),e.action_type==="team_stop"){ra.value=de(t,"reason")??e.summary;return}$e.value=e.action_type==="team_worker_spawn_batch"?"worker_spawn_batch":e.action_type==="team_task_inject"?"task":e.action_type==="team_broadcast"?"broadcast":"note";const n=de(t,"message");if(n&&(Dn.value=n),$e.value==="worker_spawn_batch"){Kn.value=D_(t);return}$e.value==="task"&&(On.value=de(t,"task_title")??de(t,"title")??"운영자 주입 작업",qn.value=de(t,"task_description")??de(t,"description")??e.summary,Fn.value=de(t,"task_priority")??de(t,"priority")??Fn.value);return}e.target_type==="keeper"&&(e.target_id&&(la.value=e.target_id),Xt.value=de(t,"message")??e.summary)}function O_(e){Gl({action_type:e.action_type,target_type:e.target_type,target_id:e.target_id,payload:e.suggested_payload,summary:e.summary})}function q_(e){Gl({action_type:e.action_type,target_type:e.target_type,target_id:e.target_id??null,payload:e.suggested_payload,summary:e.reason}),z("추천 액션 payload를 폼에 채웠습니다","success")}function F_(e,t,n){return!e||!e.target_type||e.target_type==="room"?!0:e.target_type==="team_session"?!!e.target_id&&t.some(s=>s.session_id===e.target_id):e.target_type==="keeper"?!!e.target_id&&n.some(s=>s.name===e.target_id):!0}async function it(e){const t=Ta.value.trim()||"dashboard";try{const n=await $l({actor:t,action_type:e.action_type,target_type:e.target_type,target_id:e.target_id,payload:e.payload});return n.confirm_required?z("확인 대기열에 올렸습니다","warning"):z(e.successMessage,"success"),n}catch(n){const s=n instanceof Error?n.message:"개입 실행에 실패했습니다";return z(s,"error"),null}}async function Bo(){const e=Yt.value.trim();if(!e)return;await it({action_type:"broadcast",target_type:"room",payload:{message:e},successMessage:"방송을 보냈습니다"})&&(Yt.value="")}async function K_(){await it({action_type:"room_pause",target_type:"room",payload:{reason:oa.value.trim()||"운영 점검"},successMessage:"room 일시정지를 요청했습니다"})}async function Jl(){await it({action_type:"room_resume",target_type:"room",payload:{},successMessage:"room 재개를 요청했습니다"})}async function B_(){const e=Qt.value.trim();if(!e)return;await it({action_type:"task_inject",target_type:"room",payload:{title:e,description:jn.value.trim()||"Intervene 화면에서 주입",priority:Number.parseInt(En.value,10)||2},successMessage:"작업 주입을 보냈습니다"})&&(Qt.value="",jn.value="")}async function U_(){var l;const e=ve.value,t=nn.value||((l=e==null?void 0:e.sessions[0])==null?void 0:l.session_id)||"";if(!t){z("먼저 세션을 고르세요","warning");return}const n={};if($e.value==="worker_spawn_batch"){const c=Kn.value.trim();if(!c){z("spawn_batch JSON을 먼저 채우세요","warning");return}try{const m=JSON.parse(c);if(Array.isArray(m))n.spawn_batch=m;else if(m&&typeof m=="object"&&Array.isArray(m.spawn_batch))n.spawn_batch=m.spawn_batch;else{z("spawn_batch는 배열 또는 { spawn_batch: [...] } 형태여야 합니다","warning");return}}catch(m){const u=m instanceof Error?m.message:"spawn_batch JSON 파싱에 실패했습니다";z(u,"error");return}await it({action_type:"team_worker_spawn_batch",target_type:"team_session",target_id:t,payload:n,successMessage:"worker 교체 요청을 적용했습니다"})&&(Kn.value="");return}const s=Dn.value.trim();s&&(n.message=s);let a="team_note";$e.value==="broadcast"?a="team_broadcast":$e.value==="task"&&(a="team_task_inject"),$e.value==="task"&&(n.task_title=On.value.trim()||"운영자 주입 작업",n.task_description=qn.value.trim()||"Intervene 화면에서 주입",n.task_priority=Number.parseInt(Fn.value,10)||2),await it({action_type:a,target_type:"team_session",target_id:t,payload:n,successMessage:"세션 액션을 적용했습니다"})&&(Dn.value="",$e.value==="task"&&(On.value="",qn.value=""))}async function H_(){var n;const e=ve.value,t=nn.value||((n=e==null?void 0:e.sessions[0])==null?void 0:n.session_id)||"";if(!t){z("먼저 세션을 고르세요","warning");return}await it({action_type:"team_stop",target_type:"team_session",target_id:t,payload:{reason:ra.value.trim()||"운영자 중지 요청"},successMessage:"세션 중지를 요청했습니다"})}async function W_(){var a;const e=ve.value,t=la.value||((a=e==null?void 0:e.keepers[0])==null?void 0:a.name)||"",n=Xt.value.trim();if(!t){z("먼저 keeper를 고르세요","warning");return}if(!n)return;await it({action_type:"keeper_message",target_type:"keeper",target_id:t,payload:{message:n},successMessage:`${t}에게 메시지를 보냈습니다`})&&(Xt.value="")}async function Uo(e,t="confirm"){const n=Ta.value.trim()||"dashboard";try{await hl(n,e,t),z(t==="deny"?"승인 대기를 거부했습니다":"확인 실행을 완료했습니다","success")}catch(s){const a=s instanceof Error?s.message:t==="deny"?"승인 대기 거부에 실패했습니다":"확인 실행에 실패했습니다";z(a,"error")}}function Vl(e){switch(e){case"explicit":return"실제 관리 단위";case"hybrid":return"관리 단위 + 자동 보강";case"auto":return"자동 투영";default:return"source unknown"}}function Yl(e){switch(e){case"explicit":return"ok";case"hybrid":return"warn";case"auto":return"warn";default:return"warn"}}function G_(e){switch(e){case"explicit":return"지금 보이는 unit은 실제로 정의된 command-plane 관리 단위입니다.";case"hybrid":return"일부는 실제 관리 단위이고, 비어 있는 부분은 live agent roster를 보고 자동 보강한 구조입니다.";case"auto":return"이 화면은 live agent roster를 command-plane 모양으로 자동 투영한 것입니다. 실제 명령 체계와 1:1로 같다고 보면 안 됩니다.";default:return"이 화면은 managed topology와 effective topology가 섞여 있을 수 있습니다."}}function J_(e){const t=e.unit.source??"unknown";return t==="explicit"?e.active_operation_count&&e.active_operation_count>0?"실제 관리 단위이며 연결된 작전이 있습니다.":"실제 관리 단위이지만 현재 연결된 작전은 없습니다.":t==="hybrid"?e.active_operation_count&&e.active_operation_count>0?"관리 단위를 기반으로 자동 보강된 구조이며 일부 작전이 연결돼 있습니다.":"관리 단위를 기반으로 자동 보강된 구조이며 현재 실행 연결은 약합니다.":e.active_operation_count&&e.active_operation_count>0?"자동 생성된 구조이지만 이 노드에 연결된 작전 흔적은 있습니다.":"자동 생성된 구조이며 현재 실행 연결은 없습니다."}function Ql({node:e,depth:t=0}){const n=e.roster_live??0,s=e.roster_total??e.unit.roster.length,a=e.active_operation_count??0,o=e.unit.policy,l=e.unit.source??"unknown",c=a>0?`${a}개 작전 연결`:"실행 연결 없음";return i`
    <div class="command-tree-node depth-${Math.min(t,3)}">
      <div class="command-tree-head">
        <div>
          <div class="command-tree-title-row">
            <strong>${e.unit.label}</strong>
            <span class="command-chip">${Zv(e.unit.kind)}</span>
            <span class="command-chip ${M(e.health)}">${e.health??"ok"}</span>
            <span class="command-chip ${Yl(l)}">${Vl(l)}</span>
          ...
          <div class="command-card-sub">${J_(e)}</div>
      ...
      ${e.children.length>0?i`<div class="command-tree-children">
            ${e.children.map(p=>i`<${Ql} node=${p} depth=${t+1} />`)}
          </div>`:null}
    </div>
  `}function V_({alert:e}){return i`
  ...
  `}function Y_(){const e=je.value,t=e==null?void 0:e.topology,n=t==null?void 0:t.source,s=t==null?void 0:t.summary,a=(s==null?void 0:s.managed_unit_count)??0,o=(s==null?void 0:s.active_operation_count)??0;return i`
    <section class="card command-section">
      <div class="card-title-row">
      ...
      ${e?i`
            <div class="command-topology-explainer">
              <div class="command-tree-title-row">
                <span class="command-chip ${Yl(n)}">${Vl(n)}</span>
          ...
          `:null}
      ${e&&e.topology.units.length>0?i`${e.topology.units.map(l=>i`<${Ql} node=${l} />`)}`:i`<div class="empty-state">지금은 live agent나 managed unit 기준으로 그릴 지휘 계층이 없습니다.</div>`}
    </section>
  `}function Q_(){const e=je.value;return i`
    <section class="card command-section">
      <div class="card-title-row">
      ...
      ${e&&e.alerts.alerts.length>0?i`<div class="command-card-stack">
            ${e.alerts.alerts.map(t=>i`<${V_} alert=${t} />`)}
          </div>`:i`<div class="empty-state">지금 올라온 command-plane 경보는 없습니다.</div>`}
    </section>
  `}function X_(){const e=je.value;return i`
    <section class="card command-section">
      <div class="card-title-row">
      ...
      ${e&&e.traces.events.length>0?i`<div class="command-trace-stack">
            ${e.traces.events.map(t=>i`<${oo} event=${t} />`)}
          </div>`:i`<div class="empty-state">최근 trace event가 없습니다.</div>`}
    </section>
  `}function Z_(e){if(typeof e=="string")return e;if(e==null)return"";try{return JSON.stringify(e,null,2)}catch{return String(e)}}function eg(e,t){return(t==null?void 0:t.status)==="abandoned"||(e==null?void 0:e.recommended_kind)==="continue"?"warn":(e==null?void 0:e.recommended_kind)==="rerun"?"bad":"ok"}function tg(e){switch(e){case"continue":case"continued":return"계속";case"rerun":return"재실행";case"abandon":case"abandoned":return"포기";default:return(e==null?void 0:e.trim())||"결정"}}function Xl({swarm:e}){var _,f;const t=e.run_id,n=e.resolution_recommendation,s=e.run_resolution;if(!t||!n&&!s)return null;const a=Bl()??"dashboard",o=((_=ve.value)==null?void 0:_.pending_confirms.find($=>$.target_type==="swarm_run"&&$.target_id===t))??null,l=eg(n,s),c=((f=e.operation)==null?void 0:f.operation_id)??e.operation_id??void 0,p={run_id:t};c&&(p.operation_id=c),n!=null&&n.reason&&(p.reason=n.reason);const m=async $=>{await $l({actor:a,action_type:$,target_type:"swarm_run",target_id:t,payload:p})},u=async $=>{o&&await hl(a,o.confirm_token,$)};return i`
    <article class="command-guide-card ${M(l)}">
      <div class="command-guide-head">
        <strong>Run Resolution</strong>
        <span class="command-chip ${M(l)}">
          ${tg((s==null?void 0:s.status)??(n==null?void 0:n.recommended_kind)??null)}
        </span>
      </div>
      <p>
      ...
      ${o?i`
            <div class="command-guide-card warn">
              ...
              ${o.preview?i`<pre class="command-trace-detail">${Z_(o.preview)}</pre>`:null}
  ...
  `}function ng({total:e}){const n=Math.min(e,20),s=e>20?e-20:0,a=Array.from({length:n});return i`
  ...
  `}function sg({lane:e}){const t=e.counts??{},n=Zl(e),s=t.workers??0,a=t.operations??0,o=t.detachments??0,l=a+o,c=e.motion_state==="moving"?84:e.motion_state==="waiting"?58:e.motion_state==="terminal"?100:26;return i`
  ...
  `}function tc({lanes:e}){const t=e.slice(0,4);return t.length===0?null:i`
    <div class="swarm-storyboard">
      ${t.map(n=>{const s=Zl(n),a=n.counts.workers??0,o=n.counts.operations??0,l=n.counts.detachments??0;return i`
  ...
  `}function ag({event:e}){const t=e.timestamp?new Date(e.timestamp):null,n=t&&!isNaN(t.getTime())?t:null,s=n?`${String(n.getHours()).padStart(2,"0")}:${String(n.getMinutes()).padStart(2,"0")}`:"";return i`
  ...
  `}function og({proof:e}){const t=(e==null?void 0:e.status)==="missing"?"warn":(e==null?void 0:e.pass)===!1?"bad":(e==null?void 0:e.pass)===!0?"ok":"warn";return i`
  ...
  `}function rg(){const e=ts(),t=Yn(F.value),n=n_(t),s=e==null?void 0:e.swarm_status,a=e==null?void 0:e.swarm_proof,o=(s==null?void 0:s.lanes.filter(_=>_.present))??[],l=(s==null?void 0:s.gaps.items)??[],c=(s==null?void 0:s.timeline.slice(0,8))??[],p=s==null?void 0:s.overview,m=s==null?void 0:s.recommended_next_action,u=o.length<=1;return i`
    <section class="card command-section">
      ...
      ${s?i`
            ...
            ${o.length>0?i`<${ec} lanes=${o} />`:null}

            <div class="command-swarm-layout ${u?"compact":""}">
              <div class="command-card-stack">
                ${o.length>0?o.map(_=>i`<${sg} lane=${_} />`):i`<div class="empty-state">활성 스웜 레인이 없습니다.</div>`}
              </div>
              ...
              <div class="command-card-stack">
                ...
                <div class="command-guide-card ${l.length>0?"warn":"ok"} ${n==="gaps"?"focus":""}">
                  ...
                  ${l.length>0?i`<div class="swarm-event-rail">${l.slice(0,4).map(_=>i`<${ig} gap=${_} />`)}</div>`:i`<p>지금 보이는 핵심 공백은 없습니다.</p>`}
                </div>
                ...
                <div class="command-guide-card">
                  ...
                  ${c.length>0?i`<div class="swarm-event-rail">${c.map(_=>i`<${ag} event=${_} />`)}</div>`:i`<p>붙어 있는 최근 이동 이벤트가 아직 없습니다.</p>`}
                </div>
              </div>
            </div>
  ...
  `}function nc({blocker:e}){return i`
    <article class="command-alert ${M(e.severity)}">
      <div class="command-card-head">
        <strong>${e.title}</strong>
  ...
  `}function dg(){var p,m,u,_,f,$,S,h,C,x,k,L,R,w,P,T,N,Q,ne,J,ee;const e=Tt.value,t=s_(),n=Hl(),s=(p=e==null?void 0:e.provider)!=null&&p.runtime_blocker?"blocked":(m=e==null?void 0:e.provider)!=null&&m.provider_reachable?"ready":"check",a=((u=e==null?void 0:e.provider)==null?void 0:u.actual_slots)??((_=e==null?void 0:e.provider)==null?void 0:_.total_slots)??0,o=((f=e==null?void 0:e.provider)==null?void 0:f.expected_slots)??"n/a",l=(($=e==null?void 0:e.provider)==null?void 0:$.actual_ctx)??((S=e==null?void 0:e.provider)==null?void 0:S.ctx_per_slot)??0,c=((h=e==null?void 0:e.provider)==null?void 0:h.expected_ctx)??"n/a";return i`
    <div class="command-section-stack">
      ...
      <div class="command-surface-grid">
        <section class="card command-section">
          ...
          ${ta.value?i`<div class="empty-state">Loading swarm live state…</div>`:na.value?i`<div class="empty-state error">${na.value}</div>`:e?i`
                    <div class="command-summary-grid">
                      <div class="monitor-stat-card"><span>실행 런</span><strong>${e.run_id??t??"swarm-live"}</strong><small>${e.room_id??"room 정보 없음"}</small></div>
                      <div class="monitor-stat-card"><span>워커</span><strong>${((C=e.summary)==null?void 0:C.joined_workers)??0}/${((x=e.summary)==null?void 0:x.expected_workers)??0}</strong><small>${((k=e.summary)==null?void 0:k.live_workers)??0}개 가동 · ${((L=e.summary)==null?void 0:L.completed_workers)??0}개 완료</small></div>
                    ...
                    <div class="command-card-grid">
                      <span>작전</span><span>${((T=e.operation)==null?void 0:T.operation_id)??n??"없음"}</span>
        ...
        <section class="card command-section">
          ...
          ${e&&e.blockers.length>0?i`<div class="command-card-stack">
                ${e.blockers.map(A=>i`<${nc} blocker=${A} />`)}
  ...
  `}function We({label:e,surface:t,params:n={}}){return i`
    <button
      ...
      onClick=${()=>{if(t){St(t),ce("command",{...Kl(t),...n});return}ce("intervene")}}
    >
      ${e}
    </button>
  `}function vg(){var ee,A,Ae,Ue,ut,pt,K,Ce,mt,dn,un,ns,ss,as,is,os,rs,ls,vo,_o,go;const e=ts(),t=Tt.value,n=ve.value,s=ze.value,a=d_(),o=t!=null&&t.operation?((ee=Xn.value)==null?void 0:ee.operations.find(V=>{var cs;return V.operation.operation_id===((cs=t.operation)==null?void 0:cs.operation_id)}))??null:null,l=l_(),c=(t==null?void 0:t.workers)??[],p=(s==null?void 0:s.worker_cards)??[],m=l&&c.length>0?c.map(ug):p.map(pg),u=l,_=((A=e==null?void 0:e.decisions.summary)==null?void 0:A.pending)??0,f=(n==null?void 0:n.pending_confirms)??[],$=l?(t==null?void 0:t.blockers)??[]:[],S=(s==null?void 0:s.recommended_actions)??[],h=(Ae=s==null?void 0:s.active_recommended_actions)!=null&&Ae.length?s.active_recommended_actions:S,C=s==null?void 0:s.active_summary,x=(s==null?void 0:s.active_guidance_layer)??"fallback",k=(s==null?void 0:s.resident_judge_runtime)??(n==null?void 0:n.resident_judge_runtime),L=(s==null?void 0:s.attention_items)??[],R=((Ue=t==null?void 0:t.recent_messages[0])==null?void 0:Ue.timestamp)??null,w=((ut=t==null?void 0:t.recent_trace_events[0])==null?void 0:ut.timestamp)??null,P=l?R??w??null:null,T=a==null?void 0:a.summary,N=(l?(pt=t==null?void 0:t.summary)==null?void 0:pt.expected_workers:void 0)??(typeof(T==null?void 0:T.planned_worker_count)=="number"?T.planned_worker_count:void 0)??(s==null?void 0:s.worker_cards.length)??0,Q=(l?(K=t==null?void 0:t.summary)==null?void 0:K.joined_workers:void 0)??(typeof(T==null?void 0:T.active_agent_count)=="number"?T.active_agent_count:void 0)??m.length,ne=$.length>0||_>0||f.length>0?"warn":u||a?"ok":"warn",J=l?((Ce=e==null?void 0:e.swarm_status)==null?void 0:Ce.lanes.filter(V=>V.present))??[]:[];return te(()=>{he()},[]),te(()=>{a!=null&&a.session_id&&tn(a.session_id)},[a==null?void 0:a.session_id,n,(mt=t==null?void 0:t.detachment)==null?void 0:mt.session_id]),!u&&!a?ta.value||Nn.value?i`<div class="empty-state">live war room 불러오는 중…</div>`:i`
    ...
    `:i`
    <div class="command-section-stack">
      <section class="command-warroom-strip ${M(ne)}">
        <div class="command-warroom-strip-head">
          <div>
            ...
            ${C!=null&&C.summary?i`<div class="command-warroom-guidance ${da(x)}">
                  <strong>${so(x)}</strong>
                  <span>${C.summary}</span>
                </div>`:null}
          </div>
        ...
        <div class="command-warroom-strip-stats">
          ...
          <div class="monitor-stat-card">
            ...
            <small>${l?`slots ${((rs=t==null?void 0:t.provider)==null?void 0:rs.active_slots_now)??0}/${((ls=t==null?void 0:t.provider)==null?void 0:ls.actual_slots)??((vo=t==null?void 0:t.provider)==null?void 0:vo.total_slots)??0} · ctx ${((_o=t==null?void 0:t.provider)==null?void 0:_o.actual_ctx)??((go=t==null?void 0:t.provider)==null?void 0:go.ctx_per_slot)??0}`:`session workers ${(s==null?void 0:s.worker_cards.length)??0}`}</small>
          </div>
          ...
          <div class="monitor-stat-card ${M(da(x))}">
            <span>Resident Judge</span>
            <strong>${ao(k)}</strong>
            <small>${io(C)}${k!=null&&k.model_used?` · ${k.model_used}`:""}</small>
          </div>
          <div class="monitor-stat-card">
      ...
      <div class="command-warroom-grid">
        ...
        <div class="command-warroom-column">
          <section class="card command-section">
            ...
            ${t&&t.recent_messages.length>0&&l?i`<div class="command-trace-stack">
                  ...
                  `)}
                </div>`:h.length>0||L.length>0?i`<div class="command-card-stack">
                    ${h.slice(0,4).map(V=>i`
                      <article class="command-guide-card ${Ho(V)}">
                        <div class="command-guide-head">
                          <strong>${V.action_type}</strong>
                          <span class="command-chip ${Ho(V)}">${V.target_type}</span>
                        </div>
                        <p>${V.reason}</p>
                      </article>
                    `)}
                    ...
                    `)}
                      ...
                      ${a.recent_events.slice(0,6).map((V,cs)=>i`
                        <article class="command-trace-row">
                          ...
                          <pre class="command-trace-detail">${ia(V)}</pre>
                        </article>
                      `)}
          ...
          <section class="card command-section">
            ...
            ${t&&t.recent_trace_events.length>0?i`<div class="command-trace-stack">
                  ${t.recent_trace_events.map(V=>i`<${oo} event=${V} />`)}
                </div>`:i`<div class="empty-state">run 범위 trace event가 아직 없습니다.</div>`}
          </section>
        </div>
        ...
        <div class="command-warroom-column">
          <section class="card command-section">
            ...
            <div class="command-card-stack">
              ${l&&t?i`<${Xl} swarm=${t} />`:null}
              ${$.length>0?$.map(V=>i`<${nc} blocker=${V} />`):i`<div class="command-guide-card ok"><p>지금 보이는 blocker는 없습니다.</p></div>`}
              ${_>0?i`
  ...
  `}function _g({source:e}){const t=Sc(null),[n,s]=rr(null);return te(()=>{let a=!1;const o=t.current;return o?(o.innerHTML="",s(null),(async()=>{try{const c=await Hv(),{svg:p}=await c.render(`command-chain-${Uv()}`,e);if(a||!t.current)return;t.current.innerHTML=p}catch(c){if(a)return;s(c instanceof Error?c.message:"Mermaid render failed")}})(),()=>{a=!0,t.current&&(t.current.innerHTML="")}):void 0},[e]),i`
    <div class="command-chain-graph-shell">
      ${n?i`<div class="empty-state error">${n}</div>`:null}
      <div class="command-chain-graph" ref=${t}></div>
    </div>
  `}function gg({overlay:e,selected:t,onSelect:n}){const s=e.operation.chain,a=e.runtime;return i`
  ...
  `}function hg({card:e}){const t=e.operation,n=`pause:${t.operation_id}`,s=`resume:${t.operation_id}`,a=`recall:${t.operation_id}`,o=t.chain,l=(o==null?void 0:o.run_id)??null;return i`
    <article class="command-card">
      ...
      <div class="command-action-row">
        <button
          class="control-btn ghost"
          onClick=${()=>{St("swarm"),ce("command",{surface:"swarm",operation_id:t.operation_id,...l?{run_id:l}:{}})}}
        >
          Swarm Live
        </button>
        ${o?i`
              <button
                class="control-btn ghost"
                onClick=${()=>{eo(t.operation_id),St("chains"),ce("command",{surface:"chains",operation:t.operation_id})}}
              >
                Open Chain
              </button>
            `:null}
        ${t.source==="managed"&&t.status==="active"?i`
              <button class="control-btn ghost" disabled=${se(n)} onClick=${()=>tt(()=>zv(t.operation_id))}>
                ${se(n)?"Pausing…":"Pause"}
              </button>
              <button class="control-btn ghost" disabled=${se(a)} onClick=${()=>tt(()=>jv(t.operation_id))}>
  ...
  `}function yg({card:e}){var n;const t=e.detachment;return i`
    <article class="command-card compact">
      <div class="command-card-head">
        <div>
      ...
      <div class="command-tag-row">
        ${t.heartbeat_deadline?i`<span class="command-tag ${Kv(t.heartbeat_deadline)}">
              deadline ${t.heartbeat_deadline}
            </span>`:null}
      </div>
    </article>
  `}function bg(){const e=je.value;return i`
    <div class="command-surface-grid">
      <section class="card command-section">
        <div class="card-title-row">
        ...
        ${e&&e.operations.operations.length>0?i`<div class="command-card-stack">
              ${e.operations.operations.map(t=>i`<${hg} card=${t} />`)}
      ...
      <section class="card command-section">
        ...
        ${e&&e.detachments.detachments.length>0?i`<div class="command-card-stack">
              ${e.detachments.detachments.map(t=>i`<${yg} card=${t} />`)}
            </div>`:i`<div class="empty-state">No detachments projected.</div>`}
      </section>
    </div>
  `}function kg(){var c,p,m,u,_,f,$,S,h,C,x,k,L,R,w,P;const e=Xn.value,t=(e==null?void 0:e.operations)??[],n=Jt.value,s=t.find(T=>T.operation.operation_id===n)??t[0]??null,a=((c=s==null?void 0:s.operation.chain)==null?void 0:c.run_id)??null,o=((p=zn.value)==null?void 0:p.run)??(s==null?void 0:s.preview_run)??null,l=!((m=zn.value)!=null&&m.run)&&!!(s!=null&&s.preview_run);return te(()=>{a?Nv(a):Pv()},[a]),i`
      ...
      <section class="card command-section">
        ...
        <div class="command-chain-history">
          ...
          ${e&&e.recent_history.length>0?i`
                <div class="command-card-stack">
                  ${e.recent_history.slice(0,6).map(T=>i`<${fg} item=${T} />`)}
                </div>
        ...
        ${s?i`
              <article class="command-card">
                ...
                <div class="command-card-grid">
                  ...
                  <span>Elapsed</span><span>${gn((L=s.runtime)==null?void 0:L.elapsed_sec)}</span>
              ...
              <div class="command-chain-panel">
                ...
                ${aa.value?i`<div class="empty-state">Loading run detail…</div>`:Mn.value?i`<div class="empty-state error">${Mn.value}</div>`:o&&o.nodes.length>0?i`
                          <div class="command-card-grid">
  ...
  `}function xg({decision:e}){const t=`approve:${e.decision_id}`,n=`deny:${e.decision_id}`,s=e.source==="projected_operator";return i`
    <article class="command-card ${M(e.status)}">
      ...
      ${e.status==="pending"&&!s?i`
            <div class="command-action-row">
              <button class="control-btn ghost" disabled=${se(t)} onClick=${()=>tt(()=>Dv(e.decision_id))}>
                ${se(t)?"Approving…":"Approve"}
              </button>
              <button class="control-btn ghost" disabled=${se(n)} onClick=${()=>tt(()=>Ov(e.decision_id))}>
                ${se(n)?"Denying…":"Deny"}
              </button>
            </div>
          `:null}
  ...
  `}function Sg({row:e}){var c,p,m;const t=e.unit,n=`freeze:${t.unit_id}`,s=`kill:${t.unit_id}`,a=!!((c=t.policy)!=null&&c.frozen),o=!!((p=t.policy)!=null&&p.kill_switch),l=Math.round((e.utilization??0)*100);return i`
    <article class="command-card compact">
      <div class="command-card-head">
        <div>
      ...
      <div class="command-action-row">
        <button class="control-btn ghost" disabled=${se(n)} onClick=${()=>tt(()=>qv(t.unit_id,!a))}>
  ...
  `}function Ag(){const e=je.value;return i`
    <div class="command-surface-grid">
      <section class="card command-section">
        <div class="card-title-row">
        ...
        ${e&&e.decisions.decisions.length>0?i`<div class="command-card-stack">
              ${e.decisions.decisions.map(t=>i`<${xg} decision=${t} />`)}
      ...
      <section class="card command-section">
        ...
        ${e&&e.capacity.capacity.length>0?i`<div class="command-card-stack">
              ${e.capacity.capacity.map(t=>i`<${Sg} row=${t} />`)}
            </div>`:i`<div class="empty-state">제어할 capacity 행이 아직 없습니다.</div>`}
      </section>
    </div>
  `}function Cg(){return i`
          ...
          <div class="command-tab-group-items">
            ${Fl.filter(t=>t.group===e.id).map(t=>i`
                <button
                  ...
                  onClick=${()=>{St(t.id),ce("command",Kl(t.id))}}
                >
                  ${t.label}
                </button>
              `)}
  ...
  `}function Ig(){if(X.value==="warroom")return i`<${vg} />`;if(X.value==="summary")return i`<${T_} />`;if(X.value==="swarm")return i`<${dg} />`;if(!je.value)return i`<${R_} />`;switch(X.value){case"chains":return i`<${kg} />`;case"topology":return i`<${Y_} />`;case"alerts":return i`<${Q_} />`;case"trace":return i`<${X_} />`;case"control":return i`<${Ag} />`;case"operations":default:return i`<${bg} />`}}function Tg(){return te(()=>{Et(),Vt(),Lv(),Je()},[]),te(()=>{if(F.value.tab!=="command")return;const e=F.value.params.surface,t=F.value.params.operation,n=Yn(F.value);if(Oo(e))St(e);else if(n){const s=al(n);Oo(s)&&St(s)}else e||St("warroom");t&&eo(t),(e==="swarm"||e==="warroom"||X.value==="warroom")&&Je(),(e==="warroom"||X.value==="warroom")&&he()},[F.value.tab,F.value.params.surface,F.value.params.operation,F.value.params.operation_id,F.value.params.run_id,F.value.params.source,F.value.params.action_type,F.value.params.target_type,F.value.params.target_id,F.value.params.focus_kind]),te(()=>{let e=null;const t=()=>{e||(e=window.setTimeout(()=>{e=null,Et(),Vt(),(X.value==="swarm"||X.value==="warroom")&&Je(),X.value==="warroom"&&he()},250))},n=new EventSource(Xv()),s=Vv.map(a=>{const o=()=>t();return n.addEventListener(a,o),{type:a,handler:o}});return n.onerror=()=>{t()},()=>{s.forEach(({type:a,handler:o})=>{n.removeEventListener(a,o)}),n.close(),e&&window.clearTimeout(e)}},[]),te(()=>{const e=window.setInterval(()=>{if(document.visibilityState==="hidden")return;const t=X.value;t!=="swarm"&&t!=="warroom"||(Et(),Je(),t==="warroom"&&he())},5e3);return()=>{window.clearInterval(e)}},[]),i`
    <section class="dashboard-panel command-plane-view">
      <div class="panel-header">
        ...
        <div class="panel-actions">
          ...
          <button
            class="control-btn ghost"
            onClick=${()=>{Et(),Vt(),Je(),X.value==="warroom"&&he()}}
            disabled=${Vs.value}
          >
            ${Vs.value?"새로고침 중...":"새로고침"}
          </button>
        </div>
      </div>
  ...
  `}function Rg(){var C,x;const e=ve.value,t=Vi.value,n=(e==null?void 0:e.room)??{},s=(e==null?void 0:e.pending_confirms)??[],a=e==null?void 0:e.pending_confirm_summary,o=a?a.confirm_required_actions:((e==null?void 0:e.available_actions)??[]).filter(k=>k.confirm_required),l=((C=a==null?void 0:a.actor_filter)==null?void 0:C.trim())||null,c=(a==null?void 0:a.hidden_count)??0,p=(a==null?void 0:a.hidden_actors)??[],m=(e==null?void 0:e.recent_messages)??[],u=(t==null?void 0:t.recommended_actions)??[],_=(x=t==null?void 0:t.active_recommended_actions)!=null&&x.length?t.active_recommended_actions:u,f=t==null?void 0:t.active_summary,$=(t==null?void 0:t.resident_judge_runtime)??(e==null?void 0:e.resident_judge_runtime),S=(t==null?void 0:t.active_guidance_layer)??"fallback",h=m.slice(0,5);return i`
    <div class="ops-column">
      <section class="card ops-panel ops-lane-panel">
        ...
        <div class="control-row">
          <input
            ...
            onKeyDown=${k=>{k.key==="Enter"&&Bo()}}
            disabled=${H.value}
          />
          <button class="control-btn" onClick=${()=>{Bo()}} disabled=${H.value||Yt.value.trim()===""}>
            보내기
          </button>
        </div>
        ...
        <div class="control-row ops-split-row">
          <input
            ...
            type="text"
            value=${oa.value}
            onInput=${k=>{oa.value=k.target.value}}
            disabled=${H.value}
          />
          <button class="control-btn ghost" onClick=${()=>{K_()}} disabled=${H.value}>
            일시정지
          </button>
        ...
        <textarea
          ...
          placeholder="작업 설명"
          value=${jn.value}
          onInput=${k=>{jn.value=k.target.value}}
          disabled=${H.value}
        ></textarea>
        <div class="control-row ops-split-row">
          <select
            ...
            value=${En.value}
            onChange=${k=>{En.value=k.target.value}}
            disabled=${H.value}
          >
          ...
          <button class="control-btn" onClick=${()=>{B_()}} disabled=${H.value||Qt.value.trim()===""}>
            주입
          </button>
        </div>
      </section>
      ...
      <section class="card ops-panel">
        ...
        <article class="ops-guidance-card ${da(S)}">
            ...
            ${_.map(k=>i`
              <article key=${`${k.action_type}:${k.target_type}:${k.target_id??"room"}`} class="ops-log-entry ${k.severity}">
                <div class="ops-log-head">
                  ...
                  <span>${ua(k.confirm_required)}</span>
                </div>
                <div class="ops-log-body">${k.reason}</div>
                ${k.suggested_payload?i`
                  <div class="ops-confirmation-actions">
                    <button class="control-btn ghost" onClick=${()=>{q_(k)}} disabled=${H.value}>
                      폼에 채우기
                    </button>
                  </div>
                `:null}
          ...
          <div class="ops-confirmation-list">
            ${s.map(k=>i`
              <article key=${k.confirm_token} class="ops-confirmation-card">
                ...
                ${k.preview?i`<pre class="ops-code-block compact">${ca(k.preview)}</pre>`:null}
                <div class="ops-confirmation-actions">
                  <button class="control-btn" onClick=${()=>{Uo(k.confirm_token)}} disabled=${H.value}>
                    실행
                  </button>
                  <button class="control-btn ghost" onClick=${()=>{Uo(k.confirm_token,"deny")}} disabled=${H.value}>
                    거부
                  </button>
  ...
  `}function wg(){var m;const e=ve.value,t=ze.value,n=(e==null?void 0:e.sessions)??[],s=((e==null?void 0:e.available_actions)??[]).filter(u=>u.target_type==="team_session"),a=n.find(u=>u.session_id===nn.value)??n[0]??null,o=t==null?void 0:t.active_summary,l=(t==null?void 0:t.active_guidance_layer)??"fallback",c=(t==null?void 0:t.resident_judge_runtime)??(e==null?void 0:e.resident_judge_runtime),p=(m=t==null?void 0:t.active_recommended_actions)!=null&&m.length?t.active_recommended_actions:(t==null?void 0:t.recommended_actions)??[];return i`
    <div class="ops-column">
      ...
      <section class="card ops-panel">
        ...
        ${a&&t?i`
          <article class="ops-guidance-card ${da(l)}">
            <div class="ops-guidance-head">
              <strong>${so(l)}</strong>
              <span>${ao(c)}</span>
            </div>
      ...
      <section class="card ops-panel ops-lane-panel">
          ...
          <div class="ops-log-list">
            ${s.map(u=>i`
              <article key=${u.action_type} class="ops-log-entry">
                <div class="ops-log-head">
                  <strong>${At(u.action_type)}</strong>
                  <span>${ua(u.confirm_required)}</span>
                </div>
        ...
        ${a?i`
          <div class="ops-detail-card">
            ...
            ${a.recent_events&&a.recent_events.length>0?i`
              <pre class="ops-code-block compact">${ca(a.recent_events.slice(-3))}</pre>
            `:null}
          </div>
        ...
        <div class="control-row ops-split-row">
          ...
          <button class="control-btn" onClick=${()=>{U_()}} disabled=${H.value||!a}>
            적용
          </button>
        </div>
        <div class="ops-context-note">현재 선택: ${j_($e.value)}</div>
        ...
        <div class="control-row ops-split-row">
          <input
            ...
            disabled=${H.value||!a}
          />
          <button class="control-btn ghost" onClick=${()=>{H_()}} disabled=${H.value||!a}>
            세션 중지
          </button>
        </div>
      </section>
    </div>
  `}function Pg(){var o;const e=ve.value,t=(e==null?void 0:e.keepers)??[],n=(e==null?void 0:e.persistent_agents)??[],s=(e==null?void 0:e.available_actions)??[],a=t.find(l=>l.name===la.value)??t[0]??null;return i`
    <div class="ops-column">
          ...
          ${t.length===0?i`<div class="ops-empty">지금 보이는 keeper가 없습니다.</div>`:t.map(l=>i`
            ...
            >
              ...
              <div class="ops-entity-meta">
                ...
                <span>${Fo(l.last_turn_ago_s)}</span>
              </div>
            </button>
          `)}
        </div>
      ...
      <section class="card ops-panel ops-lane-panel">
        ...
        ></textarea>
        <div class="control-row">
          <button class="control-btn" onClick=${()=>{W_()}} disabled=${H.value||!a||Xt.value.trim()===""}>
            keeper에 보내기
          </button>
        </div>
      </section>
  ...
  `}function Ng(){var R,w,P;const e=ve.value,t=F.value.tab==="intervene"?Yn(F.value):null,n=Vi.value,s=(e==null?void 0:e.room)??{},a=(e==null?void 0:e.sessions)??[],o=(e==null?void 0:e.keepers)??[],l=(e==null?void 0:e.pending_confirms)??[],c=e==null?void 0:e.pending_confirm_summary,p=(c==null?void 0:c.visible_count)??l.length,m=(c==null?void 0:c.total_count)??l.length,u=(c==null?void 0:c.hidden_count)??0,_=((R=c==null?void 0:c.actor_filter)==null?void 0:R.trim())||null,f=a.find(T=>T.session_id===nn.value)??a[0]??null,$=(n==null?void 0:n.attention_items)??[],S=$.filter(z_),h=$.filter(M_),C=a.filter(T=>L_(T)!=="ok"),x=o.filter(T=>qa(T)!=="ok"),k=F_(t,a,o);te(()=>{Ct()},[]),te(()=>{if(F.value.tab!=="intervene"){gs.value=null;return}if(!t){gs.value=null;return}gs.value!==t.id&&(gs.value=t.id,O_(t))},[F.value.tab,F.value.params.source,F.value.params.action_type,F.value.params.target_type,F.value.params.target_id,F.value.params.focus_kind,t==null?void 0:t.id]),te(()=>{const T=(f==null?void 0:f.session_id)??null;tn(T)},[f==null?void 0:f.session_id]);const L=[{key:"room",label:"Room 게이트",value:s.paused?"일시정지":"열림",detail:s.paused?`재개 전환 대기 중${s.pause_reason?` · ${s.pause_reason}`:""}`:"지금은 새 액션과 새 작업을 바로 받을 수 있습니다",tone:s.paused?"bad":"ok"},{key:"confirm",label:"확인 대기",value:u>0?`${p}/${m}`:p,detail:p>0?"미리보기만 된 개입이 아직 사람 확인을 기다리고 있습니다":u>0&&_?`현재 actor(${_}) 기준으로는 비어 있고, 다른 actor 대기 ${u}건이 있습니다`:"지금 막혀 있는 확인 대기는 없습니다",tone:m>0?"warn":"ok"},{key:"session",label:"세션 리스크",value:S.length>0?S.length:a.length,detail:S.length>0?((w=S[0])==null?void 0:w.summary)??"세션 중 하나가 방향 수정이나 중지 판단을 기다리고 있습니다":a.length===0?"지금 관리 중인 team session이 없습니다":"세션 쪽 긴급 attention은 현재 없습니다",tone:S.length>0?Ko(S):a.length===0?"warn":C.some(T=>sn(T.status)==="paused")?"bad":C.length>0?"warn":"ok"},{key:"keeper",label:"Keeper 압력",value:h.length>0?h.length:x.length,detail:h.length>0?((P=h[0])==null?void 0:P.summary)??"직접 메시지나 상태 점검이 필요한 keeper가 있습니다":x.length>0?"stale, offline, telemetry 누락 keeper가 보입니다":"지금은 keeper 쪽이 비교적 안정적입니다",tone:h.length>0?Ko(h):x.some(T=>qa(T)==="bad")?"bad":x.length>0?"warn":"ok"}];return i`
    <section class="ops-view">
      ...
      <div class="ops-header card">
        ...
        <div class="ops-toolbar">
          ...
          <input
            ...
            type="text"
            value=${Ta.value}
            onInput=${T=>P_(T.target.value)}
          />
          <button
            class="control-btn ghost"
            onClick=${()=>{he(),Ct(),tn((f==null?void 0:f.session_id)??null)}}
      ...
      ${(()=>{const T=[];if((p>0||u>0)&&T.push({label:u>0?`확인 대기 ${p}/${m}건 확인`:`확인 대기 ${p}건 처리`,desc:u>0&&_?`현재 actor(${_}) 기준으로 보이는 queue를 먼저 확인합니다`:"승인 또는 거부가 필요한 개입이 대기 중입니다",tone:p>0?"bad":"warn",onClick:()=>{const N=document.querySelector(".ops-pending-section");N==null||N.scrollIntoView({behavior:"smooth"})}}),s.paused&&T.push({label:"Room 재개",desc:`현재 일시정지 상태${s.pause_reason?` (${s.pause_reason})`:""}`,tone:"warn",onClick:()=>void Jl()}),x.length>0){const N=x.filter(Q=>qa(Q)==="bad");T.push({label:N.length>0?`Keeper ${N.length}개 오프라인`:`Keeper ${x.length}개 점검 필요`,desc:N.length>0?"메시지를 보내거나 상태를 확인하세요":"stale 또는 telemetry 누락",tone:N.length>0?"bad":"warn",onClick:()=>{const Q=document.querySelector(".ops-keeper-section");Q==null||Q.scrollIntoView({behavior:"smooth"})}})}return T.length===0?null:i`
  ...
  `}function Lg({text:e}){if(!e)return null;const t=zg(e);return i`<div class="markdown-content">${t}</div>`}function zg(e){const t=e.split(`
...
`))}</p>`)}return n}function Fa(e){const t=[],n=/(`[^`]+`)|(\*\*[^*]+\*\*)|(\*[^*]+\*)|\[([^\]]+)\]\(([^)]+)\)/g;let s=0,a;for(;(a=n.exec(e))!==null;){if(a.index>s&&t.push(e.slice(s,a.index)),a[1]){const o=a[1].slice(1,-1);t.push(i`<code>${o}</code>`)}else if(a[2]){const o=a[2].slice(2,-2);t.push(i`<strong>${o}</strong>`)}else if(a[3]){const o=a[3].slice(1,-1);t.push(i`<em>${o}</em>`)}else a[4]&&a[5]&&t.push(i`<a href=${a[5]} target="_blank" rel="noopener">${a[4]}</a>`);s=a.index+a[0].length}return s<e.length&&t.push(e.slice(s)),t.length>0?t:[e]}const sc=[{id:"recent",label:"Latest"},{id:"hot",label:"Hot"},{id:"trending",label:"Trending"},{id:"updated",label:"Updated"},{id:"discussed",label:"Discussed"}],Ns=g(null),Ls=g([]),an=g(!1),xt=g(null),xn=g(""),Sn=g(!1),qt=g(!0),ro=20,Lt=g(ro);function Mg(){var t,n;const e=new URLSearchParams(window.location.search);return((t=e.get("agent"))==null?void 0:t.trim())||((n=e.get("agent_name"))==null?void 0:n.trim())||"dashboard-user"}const jg=g(Mg());function Eg(e){const t=e.replace(/!\[[^\]]*\]\([^)]+\)/g," ").replace(/\[[^\]]+\]\([^)]+\)/g,"$1").replace(/[`#>*_~-]/g," ").replace(/\s+/g," ").trim();return t?t.length>180?`${t.slice(0,177)}...`:t:"No preview available"}function Wo(e){return e.updated_at!==e.created_at}function Dg(e){if(e.post_kind)return e.post_kind==="automation";const t=(e.hearth??"").toLowerCase();return e.visibility!=="internal"||!e.expires_at||!t?!1:!!(t.startsWith("mdal")||t.includes("harness"))}function Og(e){return e==="lodge-system"||e==="team-session"}function Bn(e){return e.post_kind?e.post_kind:Og(e.author)?"system":Dg(e)?"automation":"human"}function ac(e){const t=[],n=[];let s=0;return e.forEach(a=>{const o=Bn(a);if(!(o==="system"&&ht.value)){if(o==="automation"&&qt.value){s+=1;return}if(o==="human"){t.push(a);return}n.push(a)}}),{human:t,operations:n,hiddenAutomation:s}}function qg(e){if(!e.expires_at)return null;const t=Date.parse(e.expires_at);return Number.isFinite(t)?t<=Date.now()?i`<span class="board-meta-chip">expired</span>`:i`<span class="board-meta-chip">expires <${G} timestamp=${e.expires_at} /></span>`:null}async function lo(e){xt.value=e,Ns.value=null,Ls.value=[],an.value=!0;try{const t=await kd(e);if(xt.value!==e)return;Ns.value={id:t.id,author:t.author,title:t.title,body:t.body,content:t.content,meta:t.meta,tags:t.tags,votes:t.votes,vote_balance:t.vote_balance,comment_count:t.comment_count,created_at:t.created_at,updated_at:t.updated_at,post_kind:t.post_kind,flair:t.flair,hearth:t.hearth,visibility:t.visibility,expires_at:t.expires_at,hearth_count:t.hearth_count},Ls.value=t.comments??[]}catch{xt.value===e&&(Ns.value=null,Ls.value=[])}finally{xt.value===e&&(an.value=!1)}}async function Go(e){const t=xn.value.trim();if(t){Sn.value=!0;try{await xd(e,jg.value,t),xn.value="",z("Comment posted","success"),await lo(e),Xe()}catch{z("Failed to post comment","error")}finally{Sn.value=!1}}}function Fg(){const e=Tn.value,t=qt.value?"Automation lane collapsed":"Automation lane visible";return i`
    <div class="board-toolbar">
      <div class="board-controls">
        ${sc.map(n=>i`
          <button
            class="board-sort-btn ${e===n.id?"active":""}"
            onClick=${()=>{Tn.value=n.id,Lt.value=ro,Xe()}}
          >
            ${n.label}
          </button>
        `)}
      ...
      <div class="board-toolbar-actions">
        ...
        <button
          ...
          onClick=${()=>{ht.value=!ht.value,Xe()}}
        >
          ${ht.value?"System posts hidden":"System posts visible"}
        </button>
        <button class="control-btn ghost" onClick=${Xe} disabled=${Rn.value}>
          ${Rn.value?"Refreshing...":"Refresh"}
        </button>
      </div>
    </div>
  `}function Ka(){var s;const e=((s=sc.find(a=>a.id===Tn.value))==null?void 0:s.label)??Tn.value,t=ac(xa.value),n=t.human.length+t.operations.length;return i`
  ...
  `}function Jo({post:e}){const t=async(n,s)=>{s.stopPropagation();try{await Sr(e.id,n),Xe()}catch{z("Failed to vote","error")}};return i`
    <div class="board-post" onClick=${()=>Rc(e.id)}>
        ...
        <div class="post-head">
            <div class="post-title-row">
              ...
              <div class="post-chip-row">
                ${Wo(e)?i`<span class="board-meta-chip">Updated</span>`:null}
          ...
          <div class="post-meta">
            ...
            ${Wo(e)?i`<span>Updated <${G} timestamp=${e.updated_at} /></span>`:null}
            <span>${e.comment_count} comments</span>
            <span>${e.votes??0} votes</span>
          </div>
        </div>
        <div class="post-snippet">${Eg(e.body)}</div>
      </div>
    </div>
  `}function Kg({comments:e}){return e.length===0?i`<div class="empty-state" style="font-size:13px">No comments yet</div>`:i`
  ...
  `}function Ug({post:e}){xt.value!==e.id&&!an.value&&lo(e.id);const t=async n=>{try{await Sr(e.id,n),Xe()}catch{z("Failed to vote","error")}};return i`
    <div>
      ...
      <${I} title="Comments" semanticId="memory.feed">
        ${an.value?i`<div class="loading-indicator">Loading comments...</div>`:i`<${Kg} comments=${Ls.value} />`}
        <${Bg} postId=${e.id} />
      <//>
    </div>
  `}function Hg(){const e=ac(xa.value),t=[...e.human,...e.operations],n=F.value.params.post??null,s=n?t.find(a=>a.id===n)??(xt.value===n?Ns.value:null):null;return n&&!s&&xt.value!==n&&!an.value&&lo(n),n?s?i`
          <${ye} surfaceId="memory" />
          <${Ka} />
          <${Ug} post=${s} />
        `:i`
      ...
      ${Rn.value?i`<div class="loading-indicator">Loading memory feed...</div>`:t.length===0?i`<div class="empty-state">No posts in durable memory right now</div>`:i`
              <${I} title="Human Posts" class="section" semanticId="memory.feed">
                <div class="board-post-list">
                  ${e.human.slice(0,Lt.value).map(a=>i`<${Jo} key=${a.id} post=${a} />`)}
                </div>
                ${e.human.length>Lt.value?i`
                  <div style="text-align:center; padding:12px 0;">
                    <button
                      class="control-btn ghost"
                      onClick=${()=>{Lt.value=Lt.value+ro}}
                    >
                      Show more (${e.human.length-Lt.value} remaining)
                    </button>
                  </div>
                `:null}
              <//>
              ${e.operations.length>0?i`
                    <${I} title="Automation & System" class="section" semanticId="memory.feed">
                      <div class="board-post-list">
                        ${e.operations.map(a=>i`<${Jo} key=${a.id} post=${a} />`)}
                      </div>
                    <//>
                  `:null}
            `}
    </div>
  `}function Wg({ratio:e,size:t=40,stroke:n=4}){if(e==null)return null;const s=(t-n)/2,a=t/2,o=2*Math.PI*s,l=o*((100-e*100)/100);let c="mitosis-safe";return e>=.8?c="mitosis-critical":e>=.5&&(c="mitosis-warn"),i`
  ...
  `}const ft=g(null),Ee=g(null),De=g(null);function Ra(e){return e==="bad"||e==="critical"||e==="offline"?"bad":e==="warn"||e==="paused"||e==="blocked"||e==="interrupted"?"warn":"ok"}function Gg(e){return typeof e!="number"||Number.isNaN(e)?"—":`${Math.round(e*100)}%`}function Jg(e){return e?lt.value.find(t=>t.name===e||t.agent_name===e)??null:null}function Vg(e){switch(e){case"working":return"작업 중";case"watching":return"대기 중";case"quiet":return"조용함";case"offline":return"오프라인"}}function Yg(e){switch(e){case"critical":return"위험";case"warning":return"주의";default:return"정상"}}function Vo(e){if(!e)return;const t=Ip({targetType:e.target_type,targetId:e.target_id,focusKind:e.focus_kind,operationId:e.operation_id??null,commandSurface:e.command_surface??null,sourceLabel:"Execution 진단",summary:e.label});nl(t),ce(e.surface,e.surface==="intervene"?sl(t):il(t))}function Pt({label:e,value:t,color:n,caption:s}){return i`
    <div class="stat-card">
      <div class="stat-label">${e}</div>
      <div class="stat-value" style=${n?`color:${n}`:""}>${t}</div>
      ${s?i`<div class="monitor-stat-caption">${s}</div>`:null}
    </div>
  `}function co({intervene:e,command:t}){return i`
    <div class="control-row">
      ${e?i`
            <button
              class="control-btn ghost"
  ...
  `}function Qg({item:e,selected:t}){return i`
    <button
    ...
    >
      ...
      <${co} intervene=${e.intervene_handoff} command=${e.command_handoff} />
    </button>
  `}function Xg({brief:e,selected:t}){return i`
    <button
      class="mission-card-select ${t?"active":""}"
  ...
  `}function Zg({brief:e,selected:t}){return i`
    <button
      class="mission-card-select ${t?"active":""}"
  ...
  `}function Yo({row:e,testId:t}){return i`
    <button class="monitor-row ${e.tone} state-${e.state}" data-testid=${t} onClick=${()=>Ca(e.name)}>
      <div class="monitor-row-header">
        ...
        <span class="monitor-pill ${e.tone} state-${e.state}">${Vg(e.state)}</span>
      </div>
  ...
  `}function ef({row:e}){const t=()=>{const n=Jg(e.name);n&&kl(n)};return i`
    <button class="monitor-row ${e.tone} state-${e.state}" data-testid="execution.continuity-card" onClick=${t}>
      <div class="monitor-row-header">
        ...
        <${Wg} ratio=${e.context_ratio??0} size=${34} stroke=${4} />
        <${ct} status=${e.status??"unknown"} />
        <span class="monitor-pill ${e.tone}">${Yg(e.state)}</span>
      </div>
      ...
      <div class="monitor-meta">
        ...
        <span>컨텍스트 ${Gg(e.context_ratio)}</span>
      </div>

      <div class="monitor-focus">${e.focus}</div>
      ${e.skill_reason?i`<div class="monitor-footnote">연속성 이유: ${e.skill_reason}</div>`:null}
    </button>
  `}function tf(){const e=Rr.value,t=wr.value,n=Pr.value,s=Nr.value,a=Lr.value,o=zr.value,l=Mr.value;ft.value&&!t.some(h=>h.id===ft.value)&&(ft.value=null),Ee.value&&!n.some(h=>h.session_id===Ee.value)&&(Ee.value=null),De.value&&!s.some(h=>h.operation_id===De.value)&&(De.value=null);const c=ft.value?t.find(h=>h.id===ft.value)??null:null,p=Ee.value?Ee.value:c?c.kind==="session"?c.target_id:c.linked_session_id??null:null,m=De.value?De.value:c?c.kind==="operation"?c.target_id:c.linked_operation_id??null:null,u=p?n.filter(h=>h.session_id===p):m?n.filter(h=>h.linked_operation_id===m):n,_=m?s.filter(h=>h.operation_id===m):p?s.filter(h=>{var C;return h.linked_session_id===p||h.operation_id===((C=u[0])==null?void 0:C.linked_operation_id)}):s,f=p||m?a.filter(h=>(p?h.related_session_id===p:!1)||(m?h.related_operation_id===m:!1)):a,$=p?o.filter(h=>h.related_session_id===p||h.tone!=="ok"):o,S=p||m?l.filter(h=>(p?h.related_session_id===p:!1)||(m?h.related_operation_id===m:!1)||h.tone!=="ok"):l;return i`
    <div class="agents-monitor">
      ...
      <div class="stats-grid">
        ...
        <${Pt} label="막힌 세션" value=${(e==null?void 0:e.blocked_sessions)??n.filter(h=>Ra(h.health??h.status)!=="ok").length} color="#fbbf24" caption="개입 후보 session" />
        <${Pt} label="활성 작전" value=${(e==null?void 0:e.active_operations)??s.length} color="#22d3ee" caption="command-plane operation" />
        <${Pt} label="막힌 작전" value=${(e==null?void 0:e.blocked_operations)??s.filter(h=>h.blocker_summary).length} color="#fb7185" caption="원인 분석이 필요한 작전" />
        <${Pt} label="worker 경고" value=${(e==null?void 0:e.worker_alerts)??a.filter(h=>h.tone!=="ok").length} color="#fb7185" caption="supporting worker pressure" />
        <${Pt} label="연속성 경고" value=${(e==null?void 0:e.continuity_alerts)??o.filter(h=>h.tone!=="ok").length} color="#fb7185" caption="keeper continuity pressure" />
      </div>
      ...
      >
        ...
        <div class="monitor-alert-list">
          ${t.length===0?i`<div class="empty-state">지금은 막힌 실행이 없습니다</div>`:t.map(h=>i`<${Qg} key=${h.id} item=${h} selected=${ft.value===h.id} />`)}
        </div>
      <//>
      ...
      <div class="agents-workbench">
        ...
        >
          ...
          <div class="monitor-list">
            ${u.length===0?i`<div class="empty-state">선택된 실행과 연결된 session이 없습니다</div>`:u.map(h=>i`<${Xg} key=${h.session_id} brief=${h} selected=${Ee.value===h.session_id} />`)}
          </div>
        <//>
        ...
        >
          ...
          <div class="monitor-list">
            ${_.length===0?i`<div class="empty-state">선택된 실행과 연결된 operation이 없습니다</div>`:_.map(h=>i`<${Zg} key=${h.operation_id} brief=${h} selected=${De.value===h.operation_id} />`)}
          </div>
        <//>
        ...
        >
          ...
          <div class="monitor-list">
            ${f.length===0?i`<div class="empty-state">연결된 worker가 없습니다</div>`:f.map(h=>i`<${Yo} key=${h.name} row=${h} testId="execution.worker-card" />`)}
          </div>
        <//>
        ...
        >
          ...
          <div class="monitor-list">
            ${$.length===0?i`<div class="empty-state">지금은 연속성 경고가 없습니다</div>`:$.map(h=>i`<${ef} key=${h.name} row=${h} />`)}
          </div>
        <//>
        ...
        >
          ...
          <div class="monitor-list">
            ${S.length===0?i`<div class="empty-state">지금은 오프라인 worker가 없습니다</div>`:S.map(h=>i`<${Yo} key=${h.name} row=${h} testId="execution.offline-worker-card" />`)}
          </div>
        <//>
      </div>
    </div>
  `}const pa=g("all"),ma=g("all"),Ti=g(new Set);function nf(e){const t=new Set(Ti.value);t.has(e)?t.delete(e):t.add(e),Ti.value=t}const ic=Se(()=>{let e=Bt.value;return pa.value!=="all"&&(e=e.filter(t=>t.horizon===pa.value)),ma.value!=="all"&&(e=e.filter(t=>t.status===ma.value)),e}),sf=Se(()=>{const e={short:[],mid:[],long:[]};for(const t of ic.value){const n=e[t.horizon];n&&n.push(t)}return e}),af=Se(()=>{const e=Array.from(Er.value.values());return e.sort((t,n)=>t.status==="running"&&n.status!=="running"?-1:n.status==="running"&&t.status!=="running"?1:t.status==="interrupted"&&n.status!=="interrupted"?-1:n.status==="interrupted"&&t.status!=="interrupted"?1:n.elapsed_seconds-t.elapsed_seconds),e});function of(e){return"★".repeat(Math.min(e,5))+"☆".repeat(Math.max(0,5-e))}function uo(e){switch(e){case"short":return"Short-term";case"mid":return"Mid-term";case"long":return"Long-term";default:return e}}function zs(e){switch(e){case"short":return"#4ade80";case"mid":return"#f59e0b";case"long":return"#818cf8";default:return"#888"}}function rf(e){return e<60?`${Math.round(e)}s`:e<3600?`${Math.floor(e/60)}m ${Math.round(e%60)}s`:`${Math.floor(e/3600)}h ${Math.floor(e%3600/60)}m`}function Qo(e){return e.toFixed(4)}function Xo(e){const t=e.current_metric-e.baseline_metric;return`${t>=0?"+":""}${t.toFixed(4)}`}function lf(e){switch(e){case 1:return"P1";case 2:return"P2";case 3:return"P3";default:return"P4"}}function Zo(e,t){return(e.priority??4)-(t.priority??4)}function cf(e,t){const n=e.updated_at??e.created_at??"";return(t.updated_at??t.created_at??"").localeCompare(n)}function df(e,t){return e.length<=t?e:e.slice(0,t)+"..."}function uf({goal:e}){return i`
    <div class="goal-row">
      <div class="goal-row-main">
        ...
        <div class="goal-meta">
          <span class="goal-priority" title="Priority ${e.priority}">${of(e.priority)}</span>
  ...
  `}function Ba({horizon:e,items:t}){if(t.length===0)return null;const n=[...t].sort((s,a)=>a.priority-s.priority);return i`
    <${I} title="${uo(e)} Goals (${t.length})" class="section" semanticId="planning.goal_pipeline">
      <div class="goal-list">
        ${n.map(s=>i`<${uf} key=${s.id} goal=${s} />`)}
      </div>
    <//>
  `}function pf(){return i`
  ...
  `}function mf(){const e=Bt.value,t=e.filter(a=>a.status==="active").length,n=e.filter(a=>a.status==="completed").length,s={short:0,mid:0,long:0};for(const a of e)a.horizon in s&&s[a.horizon]++;return i`
  ...
  `}function vf({loop:e}){const t=e.history[0],n=e.latest_tool_names&&e.latest_tool_names.length>0?`${e.latest_tool_call_count??e.latest_tool_names.length} tool${(e.latest_tool_call_count??e.latest_tool_names.length)===1?"":"s"}: ${e.latest_tool_names.join(", ")}`:"No evidence yet";return i`
    <div class="planning-loop-row">
      <div class="planning-loop-main">
        ...
        <div class="planning-loop-metrics">
          ...
          <span>Elapsed ${rf(e.elapsed_seconds)}</span>
        </div>
  ...
  `}function Ua({task:e}){const t=e.priority??4,n=t<=1?"p1":t===2?"p2":t===3?"p3":"p4",s=Ti.value.has(e.id),a=!!e.description;return i`
    <div class="kanban-card ${n}">
      <div class="kanban-card-header">
        <span class="priority-badge priority-badge--${n}">${lf(t)}</span>
  ...
  `}function _f(){const{todo:e,inProgress:t,done:n}=Or.value,s=[...e].sort(Zo),a=[...t].sort(Zo),o=[...n].sort(cf);return i`
  ...
  `}function gf(){const{todo:e,inProgress:t,done:n}=Or.value,s=e.length+t.length+n.length,a=[...e,...t].filter(u=>(u.priority??4)<=2).length,o=sf.value,l=af.value,c=Bt.value.length>0,p=l.length>0,m=qi.value;return i`
    <div>
      ...
      <details class="overview-section-collapsible" open=${c}>
        ...
        <div>
          ${c?i`
            <${mf} />
            <${pf} />
            ${fn.value&&Bt.value.length===0?i`<div class="loading-indicator">Loading goals...</div>`:ic.value.length===0?i`<div class="empty-state">No goals match the current filters</div>`:i`
        ...
        <div>
          ${$n.value&&l.length===0?i`<div class="loading-indicator">Loading MDAL loops...</div>`:l.length===0&&(m==="error"||Ut.value)?i`<div class="empty-state">MDAL snapshot could not be loaded${Ut.value?`: ${Ut.value}`:""}. Check backend health.</div>`:l.length===0?i`<div class="empty-state">No active loops. Use <code>masc_mdal_start</code> to start a loop.</div>`:i`
                  <div class="planning-loop-list">
                    ${l.map(u=>i`<${vf} key=${u.loop_id} loop=${u} />`)}
                  </div>
                `}
        </div>
      </details>
    </div>
  `}const va=g(!1),An=g(!1),Ft=g(!1),ot=g(""),Cn=g(""),Ri=g("open"),Ne=g(null),Un=g(null),_a=g(null),ga=g(null),wi=g(!1);function Hn(e){return`${e.kind}:${e.id}`}function po(){var n;const e=Un.value,t=((n=Ne.value)==null?void 0:n.items)??[];return e?t.find(s=>Hn(s)===e)??null:null}function ff(){const e=new URLSearchParams(window.location.search),t=e.get("agent")??e.get("agent_name");return(t==null?void 0:t.trim())||"dashboard"}function $f(e){const t=e.trim().toLowerCase();return t==="open"||t==="pending"}function oc(e){return!!(e.judgment_summary&&e.judgment_summary.trim())}function rc(e){switch(Ri.value){case"needs_quorum":return e.filter(t=>t.kind==="consensus"&&(t.votes??0)<(t.quorum??0));case"ready":return e.filter(t=>{var n;return(n=t.guardrail_state)==null?void 0:n.ready_to_execute});case"needs_approval":return e.filter(t=>{var n,s;return((n=t.guardrail_state)==null?void 0:n.requires_human_gate)||!!((s=t.guardrail_state)!=null&&s.pending_confirm)});case"judge_offline":return e.filter(t=>!oc(t));case"open":default:return e.filter(t=>$f(t.status))}}function hf(e){if(e==null)return"none";if(typeof e=="string")return e;try{return JSON.stringify(e,null,2)}catch{return String(e)}}function wa(e){const t=(e||"").toLowerCase();return t.includes("reject")||t.includes("deny")||t.includes("closed")||t.includes("cancel")?"negative":t.includes("approve")||t.includes("support")||t.includes("open")||t.includes("ready")?"positive":"neutral"}function yf(e){return typeof e!="number"||Number.isNaN(e)?"n/a":`${Math.round(e*100)}%`}function vn(e){return"resolved_tool"in e||"payload_preview"in e||"reason"in e}async function lc(e){if(_a.value=null,ga.value=null,!!e){wi.value=!0,ot.value="";try{e.kind==="debate"?_a.value=await Yd(e.id):ga.value=await Qd(e.id)}catch(t){ot.value=t instanceof Error?t.message:"Failed to load governance detail"}finally{wi.value=!1}}}async function bf(e){Un.value=Hn(e),await lc(e)}async function on(){var e;va.value=!0,ot.value="";try{const t=await Zc();Ne.value=t;const n=rc(t.items??[]),s=Un.value,a=n.find(o=>Hn(o)===s)??n[0]??((e=t.items)==null?void 0:e[0])??null;Un.value=a?Hn(a):null,await lc(a)}catch(t){ot.value=t instanceof Error?t.message:"Failed to load governance state"}finally{va.value=!1}}Gu(on);async function er(){const e=Cn.value.trim();if(e){An.value=!0;try{const t=await Vd(e);Cn.value="",z(t!=null&&t.id?`Debate started: ${t.id}`:"Debate started","success"),await on()}catch(t){const n=t instanceof Error?t.message:"Failed to start debate";ot.value=n,z(n,"error")}finally{An.value=!1}}}async function tr(e){var o,l;const t=po(),n=(o=t==null?void 0:t.guardrail_state)==null?void 0:o.pending_confirm,s=n==null?void 0:n.confirm_token;if(!s)return;const a=((l=n==null?void 0:n.actor)==null?void 0:l.trim())||ff();Ft.value=!0;try{await $r(a,s,e),z(e==="confirm"?"Action approved":"Action denied","success"),await on()}catch(c){const p=c instanceof Error?c.message:"Failed to update pending action";ot.value=p,z(p,"error")}finally{Ft.value=!1}}function kf(){var n,s,a,o,l,c;const e=(n=Ne.value)==null?void 0:n.summary,t=(s=Ne.value)==null?void 0:s.judge;return i`
    <div class="board-summary-strip">
      <div class="board-summary-item">
    ...
    <${I} title="Governance Console" class="section" semanticId="governance.supervisor">
      <div class="governance-toolbar">
        <div class="council-create">
          ...
          <button class="control-btn ghost" onClick=${on} disabled=${va.value}>
  ...
  `}function Sf(){var t;const e=rc(((t=Ne.value)==null?void 0:t.items)??[]);return i`
                ...
                >
                  <div class="council-row-main">
                    ...
                    <div class="governance-chip-row">
                      ...
                      ${oc(n)?null:i`<span class="governance-chip dim">judge offline</span>`}
                    </div>
                  </div>
  ...
  `}function Af({argument:e}){return i`
  ...
  `}function If(){const e=po(),t=_a.value,n=ga.value;return i`
    <${I}
    ...
    >
      ${wi.value?i`<div class="loading-indicator">Loading governance detail...</div>`:e?e.kind==="debate"&&t?i`
                ...
                <div class="governance-ledger">
                  ${t.arguments.length===0?i`<div class="empty-state">No arguments recorded yet.</div>`:t.arguments.map(s=>i`<${Af} key=${s.index} argument=${s} />`)}
                </div>
              `:e.kind==="consensus"&&n?i`
                  ...
                  <div class="governance-ledger">
                    ${n.votes.length===0?i`<div class="empty-state">No votes recorded yet.</div>`:n.votes.map(s=>i`<${Cf} key=${s.agent+s.timestamp} vote=${s} />`)}
                  </div>
  ...
  `}function nr({title:e,route:t}){if(!t)return null;const n=vn(t)?t.resolved_tool:t.delegated_tool,s=vn(t)?t.target_type:null,a=vn(t)?t.target_id:null,o=vn(t)?t.reason:null,l=vn(t)?t.payload_preview:null;return i`
    <div class="governance-side-block">
      ...
      ${l?i`<pre class="council-detail governance-preview">${hf(l)}</pre>`:null}
    </div>
  `}function Tf(){var c,p,m;const e=po(),t=_a.value,n=ga.value,s=(t==null?void 0:t.context)??(n==null?void 0:n.context)??(e==null?void 0:e.context),a=(t==null?void 0:t.judgment)??(n==null?void 0:n.judgment),o=e==null?void 0:e.guardrail_state,l=(c=Ne.value)==null?void 0:c.judge;return i`
      ...
      <${I} title="Why / Guardrail" class="section" semanticId="governance.guardrail">
        ${e?i`
              <div class="governance-side-block">
                ...
                <div class="council-sub">
                  <span>confidence ${yf(e.confidence)}</span>
  ...
  `}const zt=g(""),Ha=g("ability_check"),Wa=g("10"),Ga=g("12"),fs=g(""),$s=g("idle"),Ge=g(""),hs=g("keeper-late"),Ja=g("player"),Va=g(""),ke=g("idle"),Ya=g(null),ys=g(""),Qa=g(""),Xa=g("player"),Za=g(""),ei=g(""),ti=g(""),In=g("20"),ni=g("20"),si=g(""),bs=g("idle"),Pi=g(null),cc=g("overview"),ai=g("all"),ii=g("all"),oi=g("all"),wf=12e4,Pa=g(null),sr=g(Date.now());function Pf(e,t){const n=t>0?e/t*100:0;return n>50?"hp-high":n>25?"hp-mid":"hp-low"}function Nf(e,t){return t>0?Math.round(e/t*100):0}const Lf={pragmatic:"리스크보다 확실한 이득을 우선합니다.",frugal:"자원 소모를 줄이고 효율을 챙깁니다.",impatient:"짧은 템포로 즉시 압박을 선호합니다.",stubborn:"한 번 정한 전술을 끝까지 밀어붙입니다.",protective:"아군 피해를 줄이는 선택을 우선합니다.","honor-bound":"약속과 규율을 지키는 행동에 보너스가 납니다.",intense:"집중 화력을 짧게 폭발시킵니다.",empathetic:"아군/약자 보호 쪽 선택 확률이 높아집니다.",fatalistic:"위험을 감수하는 고배수 선택을 탑니다.",suspicious:"함정/매복 경계 행동을 우선합니다.",precise:"단일 목표를 정확히 노리는 경향입니다.",vengeful:"직전 위협 대상에게 강하게 반응합니다.",aggressive:"공격적인 전진 행동을 우선합니다.",opportunistic:"빈틈이 열리면 즉시 추격합니다."},zf={supply_scan:"전장/자원 상태를 스캔해 약한 지점을 찾습니다.",ration_shift:"소모를 줄이고 지속 전투 능력을 확보합니다.",logistics_patch:"무너진 운영 라인을 빠르게 복구합니다.",frontline_shield:"전열에서 아군 피해를 흡수합니다.",oath_intercept:"핵심 타깃을 가로막아 위협을 차단합니다.",morale_anchor:"아군 안정도를 높여 붕괴를 막습니다.",omen_trace:"다음 위험 신호를 먼저 감지합니다.",arc_flash:"짧은 순간 광역 압박을 넣습니다.",ward_bloom:"방어 장막을 펼쳐 생존률을 올립니다.",mark_prey:"우선 제거 대상을 지정합니다.",silent_route:"은밀한 진입 경로를 확보합니다.",finisher_strike:"약화된 적을 마무리하는 일격입니다.",shadow_claw:"근접 급습으로 출혈 피해를 노립니다.",lunge:"짧은 돌진으로 전열을 흔듭니다."};function ks(e){const t=e.trim();return t?t.split(/[_-]+/g).filter(n=>n.length>0).map(n=>n[0]?`${n[0].toUpperCase()}${n.slice(1)}`:n).join(" "):e}function Mf(e){const t=e.trim().toLowerCase();return Lf[t]??"행동 선택 가중치에 영향을 주는 성향입니다."}function jf(e){const t=e.trim().toLowerCase();return zf[t]??"상황에 따라 선택되는 전술 액션입니다."}function fe(e,t,n=""){const s=e[t];return typeof s=="string"?s:n}function Re(e,t,n=0){const s=e[t];return typeof s=="number"&&Number.isFinite(s)?s:n}function Wn(e,t,n=!1){const s=e[t];return typeof s=="boolean"?s:n}const Ef=new Set(["str","dex","con","int","wis","cha"]);function Df(e){const t=e.trim();if(!t)return{};let n;try{n=JSON.parse(t)}catch(a){throw new Error(`능력치 JSON 파싱 실패: ${a instanceof Error?a.message:"invalid json"}`)}if(!v(n))throw new Error('능력치 JSON은 object여야 합니다. 예: {"luck":7}');const s={};return Object.entries(n).forEach(([a,o])=>{const l=a.trim();if(l){if(typeof o=="number"&&Number.isFinite(o)){s[l]=Math.max(0,Math.trunc(o));return}if(typeof o=="string"){const c=Number.parseFloat(o.trim());if(Number.isFinite(c)){s[l]=Math.max(0,Math.trunc(c));return}}throw new Error(`능력치 '${l}' 값은 숫자여야 합니다.`)}}),s}function Of(e){const t=Number.parseInt(e.trim(),10);if(!Number.isFinite(t))return;const n=Math.max(1,t),s=Number.parseInt(In.value.trim(),10);Number.isFinite(s)&&s>n&&(In.value=String(n))}function Ni(e){const n=(e.actor_name??e.actor??e.actor_id??"system").trim();return n===""?"system":n}function qf(e){var n;return(((n=e.timestamp)==null?void 0:n.trim())??"")||"-"}function Ff(e){cc.value=e}function dc(e){const t=Pa.value;return t==null||t<=e}function Kf(e){const t=Pa.value;return t==null||t<=e?0:Math.max(0,Math.ceil((t-e)/1e3))}function fa(){Pa.value=null}function uc(e){return typeof window>"u"||typeof window.confirm!="function"?!0:window.confirm(e)}function Bf(e,t){uc(["관전 모드 잠금을 해제하시겠습니까?",`ROOM: ${e||"-"}`,`PHASE: ${t||"-"}`,"해제 시간: 120초 (시간 경과 또는 위험 액션 실행 후 자동 재잠금)"].join(`
`))&&(Pa.value=Date.now()+wf,z("조작 잠금이 120초 동안 해제되었습니다.","warning"))}function Ms(e){return dc(e)?(z("관전 모드 잠금 상태입니다. 먼저 잠금을 해제하세요.","warning"),!1):!0}function Li(e,t,n){return uc([`[위험 액션 확인] ${e}`,`ROOM: ${t||"-"}`,`PHASE: ${n||"-"}`,"이 액션은 즉시 실행되며 되돌리기 어렵습니다.","계속 진행하시겠습니까?"].join(`
`))}function Uf({hp:e,max:t}){const n=Nf(e,t),s=Pf(e,t);return i`
    <div class="trpg-hp-bar">
      <div class="hp-fill ${s}" style="width:${n}%" />
    </div>
  `}function Hf({stats:e}){const t=[{label:"STR",value:e.strength},{label:"DEX",value:e.dexterity},{label:"CON",value:e.constitution},{label:"INT",value:e.intelligence},{label:"WIS",value:e.wisdom},{label:"CHA",value:e.charisma}];return i`
    <div class="trpg-actor-stats">
      ${t.map(n=>i`<span>${n.label} ${n.value}</span>`)}
    </div>
  `}function Wf({keeper:e,role:t}){if(!e)return null;const n=t==="dm"?"dm":"player";return i`
    <span class="trpg-keeper-chip">
      <span class="trpg-keeper-tag ${n}">${n}</span>
      ${e}
    </span>
  `}function pc({actor:e}){var p,m,u,_;const t=(p=e.archetype)==null?void 0:p.trim(),n=(m=e.persona)==null?void 0:m.trim(),s=(u=e.portrait)==null?void 0:u.trim(),a=(_=e.background)==null?void 0:_.trim(),o=e.traits??[],l=e.skills??[],c=Object.entries(e.stats_raw??{}).filter(([f,$])=>Number.isFinite($)).filter(([f])=>!Ef.has(f.toLowerCase()));return i`
    <div class="trpg-actor">
      ...
      <div class="trpg-actor-header">
        ...
        <${Wf} keeper=${e.keeper} role=${e.role} />
      </div>
      ${e.stats?i`
          <div style="margin-top:4px;">
            ...
            <${Uf} hp=${e.stats.hp} max=${e.stats.max_hp} />
            <${Hf} stats=${e.stats} />
          </div>
        `:null}
            ...
            <div class="trpg-annot-list">
              ${o.map(f=>i`
                <span class="trpg-annot-chip trait">
                  ...
                  <span class="trpg-annot-desc">${Mf(f)}</span>
                </span>
              `)}
            </div>
          </div>
            ...
            <div class="trpg-annot-list">
              ${l.map(f=>i`
                <span class="trpg-annot-chip skill">
                  <span class="trpg-annot-name">${ks(f)}</span>
                  <span class="trpg-annot-desc">${jf(f)}</span>
                </span>
              `)}
            </div>
          </div>
  ...
  `}function Gf({mapStr:e}){return i`<pre class="trpg-map">${e}</pre>`}function mc({events:e,emptyLabel:t="아직 이벤트가 없습니다."}){return e.length===0?i`<div class="empty-state" style="font-size:13px">${t}</div>`:i`
    <div class="trpg-story" role="list" aria-label="TRPG story events">
      ${e.map((n,s)=>{var a;return i`
        <div key=${s} class="trpg-event ${n.type??""}" role="listitem">
          <div class="trpg-event-meta-row">
            <span class="trpg-event-meta">${qf(n)}</span>
  ...
  `}function vc({state:e}){const t=e.history??[];return t.length===0?null:i`
  ...
  `}function Yf({state:e,nowMs:t}){var m;const n=qe.value||((m=e.session)==null?void 0:m.room)||"",s=$s.value,a=e.party??[];if(!a.find(u=>u.id===zt.value)&&a.length>0){const u=a[0];u&&(zt.value=u.id)}const l=async()=>{var _,f;if(!n){z("Room ID가 비어 있습니다.","error");return}if(!Ms(t))return;const u=((_=e.current_round)==null?void 0:_.phase)??((f=e.session)==null?void 0:f.status)??"unknown";if(Li("라운드 실행",n,u)){$s.value="running";try{const $=await Dd(n);Pi.value=$,$s.value="ok";const S=v($.summary)?$.summary:null,h=S?Wn(S,"advanced",!1):!1,C=S?fe(S,"progress_reason",""):"";z(h?"라운드가 정상 진행되었습니다.":`라운드가 정체되었습니다${C?`: ${C}`:""}`,h?"success":"warning"),Ze()}catch($){Pi.value=null,$s.value="error";const S=$ instanceof Error?$.message:"라운드 실행에 실패했습니다.";z(S,"error")}finally{fa()}}},c=async()=>{var _,f;if(!n||!Ms(t))return;const u=((_=e.current_round)==null?void 0:_.phase)??((f=e.session)==null?void 0:f.status)??"unknown";if(Li("턴 강제 진행",n,u))try{await Fd(n),z("턴을 다음 단계로 이동했습니다.","success"),Ze()}catch{z("턴 이동에 실패했습니다.","error")}finally{fa()}},p=async()=>{if(!n||!Ms(t))return;const u=zt.value.trim();if(!u){z("먼저 Actor를 선택하세요.","warning");return}const _=Number.parseInt(Wa.value,10),f=Number.parseInt(Ga.value,10);if(Number.isNaN(_)||Number.isNaN(f)){z("stat/dc는 숫자여야 합니다.","warning");return}const $=Number.parseInt(fs.value,10),S=fs.value.trim()===""||Number.isNaN($)?void 0:$;try{await qd({roomId:n,actorId:u,action:Ha.value.trim()||"ability_check",statValue:_,dc:f,rawD20:S}),z("주사위 판정을 기록했습니다.","success"),Ze()}catch{z("주사위 판정 기록에 실패했습니다.","error")}};return i`
  ...
  `}function Qf({state:e}){var a;const t=qe.value||((a=e.session)==null?void 0:a.room)||"",n=bs.value,s=async()=>{if(!t){z("Room ID가 비어 있습니다.","warning");return}const o=ys.value.trim(),l=Qa.value.trim();if(!l&&!o){z("이름 또는 Actor ID를 입력하세요.","warning");return}const c=Number.parseInt(In.value.trim(),10),p=Number.parseInt(ni.value.trim(),10),m=Number.isFinite(p)?Math.max(1,p):20,u=Number.isFinite(c)?Math.max(0,Math.min(m,c)):m;let _={};try{_=Df(si.value)}catch(f){z(f instanceof Error?f.message:"능력치 JSON 오류","error");return}bs.value="spawning";try{const f=typeof crypto<"u"&&typeof crypto.randomUUID=="function"?`trpg_spawn_${crypto.randomUUID()}`:`trpg_spawn_${Date.now().toString(36)}_${Math.random().toString(36).slice(2,10)}`,$=await Kd(t,{actor_id:o||void 0,name:l||void 0,role:Xa.value,idempotencyKey:f,portrait:ei.value.trim()||void 0,background:ti.value.trim()||void 0,hp:u,max_hp:m,alive:u>0,stats:Object.keys(_).length>0?_:void 0}),S=typeof $.actor_id=="string"?$.actor_id.trim():"";if(!S)throw new Error("생성 응답에 actor_id가 없습니다.");const h=Za.value.trim();h&&await Bd(t,S,h),zt.value=S,Ge.value=S,o||(ys.value=""),bs.value="ok",z(`Actor 생성 완료: ${S}`,"success"),await Ze()}catch(f){bs.value="error",z(f instanceof Error?f.message:"Actor 생성에 실패했습니다.","error")}};return i`
    <div class="trpg-control-box">
      <div class="trpg-control-grid">
        <div class="trpg-control-field">
          <label>Name</label>
        ...
        <div class="trpg-control-grid">
          ...
          <div class="trpg-control-field">
            ...
            <input
              ...
              min="0"
              value=${In.value}
              onInput=${o=>{In.value=o.target.value}}
              placeholder="20"
            />
          </div>
          <div class="trpg-control-field">
            ...
            <input
              ...
              min="1"
              value=${ni.value}
              onInput=${o=>{const l=o.target.value;ni.value=l,Of(l)}}
              placeholder="20"
            />
          </div>
  ...
  `}function Xf({state:e,nowMs:t}){var f;const n=qe.value||((f=e.session)==null?void 0:f.room)||"",s=e.join_gate,a=Ya.value,o=v(a)?a:null,l=(e.party??[]).filter($=>$.role!=="dm"),c=Ge.value.trim(),p=l.some($=>$.id===c),m=p?c:c?"__manual__":"",u=async()=>{const $=Ge.value.trim(),S=hs.value.trim();if(!n||!$){z("Room/Actor가 필요합니다.","warning");return}ke.value="checking";try{const h=await Ud(n,$,S||void 0);Ya.value=h,ke.value="ok",z("참가 가능 여부를 갱신했습니다.","success")}catch(h){ke.value="error";const C=h instanceof Error?h.message:"참가 가능 여부 확인에 실패했습니다.";z(C,"error")}},_=async()=>{var x,k;const $=Ge.value.trim(),S=hs.value.trim(),h=Va.value.trim();if(!n||!$||!S){z("Room/Actor/Keeper가 필요합니다.","warning");return}if(!Ms(t))return;const C=((x=e.current_round)==null?void 0:x.phase)??((k=e.session)==null?void 0:k.status)??"unknown";if(Li("Mid-Join 승인 요청",n,C)){ke.value="requesting";try{const L=await Hd({room_id:n,actor_id:$,keeper_name:S,role:Ja.value,...h?{name:h}:{}});Ya.value=L;const R=v(L)?Wn(L,"granted",!1):!1,w=v(L)?fe(L,"reason_code",""):"";R?z("Mid-Join이 승인되었습니다.","success"):z(`Mid-Join이 거절되었습니다${w?`: ${w}`:""}`,"warning"),ke.value=R?"ok":"error",Ze()}catch(L){ke.value="error";const R=L instanceof Error?L.message:"Mid-Join 요청에 실패했습니다.";z(R,"error")}finally{fa()}}};return i`
    <div class="trpg-control-box">
      ...
      <div class="trpg-control-grid">
        <div class="trpg-control-field">
          ...
          <select
            value=${m}
            onChange=${$=>{const S=$.target.value;if(S==="__manual__"){(p||!c)&&(Ge.value="");return}Ge.value=S}}
          >
            <option value="">Actor 선택</option>
            ${l.map($=>i`
        ...
        <div class="trpg-control-field">
          ...
          <select
            value=${Ja.value}
            onChange=${$=>{Ja.value=$.target.value}}
          >
            <option value="player">player</option>
            <option value="npc">npc</option>
            <option value="dm">dm</option>
  ...
  `}function _c({state:e}){const t=[...e.contribution_ledger??[]].sort((n,s)=>(s.score??0)-(n.score??0)).slice(0,8);return t.length===0?i`<div class="empty-state" style="font-size:13px;">No contribution data yet</div>`:i`
    <div class="trpg-round-list">
      ${t.map(n=>i`
  ...
  `}function gc({state:e}){var n;const t=e.current_round;return t?i`
  ...
  `:null}function fc(){const e=Pi.value;if(!e)return i`<div class="empty-state" style="font-size:13px;">Run Round 결과가 아직 없습니다.</div>`;const t=e.summary,n=v(t)?t:null,a=(Array.isArray(e.statuses)?e.statuses:[]).filter(v).slice(-8),o=e.canon_check,l=v(o)?o:null,c=l&&Array.isArray(l.warnings)?l.warnings.filter(w=>typeof w=="string").slice(0,3):[],p=l&&Array.isArray(l.violations)?l.violations.filter(w=>typeof w=="string").slice(0,3):[],m=n?Wn(n,"advanced",!1):!1,u=n?fe(n,"progress_reason",""):"",_=n?fe(n,"progress_detail",""):"",f=n?Re(n,"player_successes",0):0,$=n?Re(n,"player_required_successes",0):0,S=n?Wn(n,"dm_success",!1):!1,h=n?Re(n,"timeouts",0):0,C=n?Re(n,"unavailable",0):0,x=n?Re(n,"reprompts",0):0,k=n?Re(n,"npc_attacks",0):0,L=n?Re(n,"keeper_timeout_sec",0):0,R=n?Re(n,"roll_audit_count",0):0;return i`
    <div style="display:grid; gap:10px;">
      ...
      ${a.length>0?i`
          <div class="trpg-round-list">
            ${a.map(w=>{const P=fe(w,"status","unknown"),T=fe(w,"actor_id","-"),N=fe(w,"role","-"),Q=fe(w,"reason",""),ne=fe(w,"action_type",""),J=fe(w,"reply","");return i`
  ...
  `}function Zf({state:e,nowMs:t}){var l,c,p;const n=qe.value||((l=e.session)==null?void 0:l.room)||"",s=((c=e.current_round)==null?void 0:c.phase)??((p=e.session)==null?void 0:p.status)??"unknown",a=dc(t),o=Kf(t);return i`
    <${I} title="조작 안전 잠금" style="margin-bottom:16px;" semanticId="lab.trpg">
      <div class="trpg-control-lock ${a?"locked":"unlocked"}">
        ...
        <div style="display:flex; gap:8px; margin-top:10px; flex-wrap:wrap;">
          ${a?i`<button class="trpg-run-btn recommend" onClick=${()=>Bf(n,s)}>잠금 해제 (120초)</button>`:i`<button class="trpg-run-btn secondary" onClick=${()=>{fa(),z("조작 잠금으로 전환했습니다.","success")}}>즉시 다시 잠금</button>`}
        </div>
      </div>
    <//>
  `}function e$({active:e}){return i`
  ...
  `}function t$({state:e}){const t=e.party??[],n=e.story_log??[];return i`
      ...
      <div class="trpg-sidebar">
        ...
        <${I} title=${`파티 (${t.length})`} style="margin-top:16px;">
          <div class="trpg-actor-list">
            ${t.map(s=>i`<${pc} key=${s.id??s.name} actor=${s} />`)}
  ...
  `}function n$({state:e}){const t=e.story_log??[];return i`
    <div class="trpg-layout">
      <div>
  ...
  `}function s$({state:e,nowMs:t}){const n=e.party??[];return i`
    <div>
      <${Zf} state=${e} nowMs=${t} />
      <div class="trpg-layout">
        <div>
        ...
        <div class="trpg-sidebar">
          ...
          <${I} title=${`파티 (${n.length})`} style="margin-top:16px;">
            <div class="trpg-actor-list">
              ${n.map(s=>i`<${pc} key=${s.id??s.name} actor=${s} />`)}
  ...
  `}function a$(){var c,p,m,u,_;const e=jr.value,t=$i.value;if(te(()=>{if(typeof window>"u"||typeof window.setInterval!="function")return;const f=window.setInterval(()=>{sr.value=Date.now()},1e3);return()=>{window.clearInterval(f)}},[]),t&&!e)return i`<div class="loading-indicator">Loading TRPG state...</div>`;if(!e)return i`
      <div class="section">
        <h2>TRPG</h2>
        <div class="empty-state">No active TRPG session</div>
        <button class="board-sort-btn" onClick=${()=>Ze()}>Refresh</button>
      </div>
    `;const n=e.party??[],s=e.story_log??[],a=e.outcome,o=cc.value,l=sr.value;return i`
    <div>
      <${ye} surfaceId="lab" />
      ...
      ${o==="overview"?i`<${t$} state=${e} />`:o==="timeline"?i`<${n$} state=${e} />`:i`<${s$} state=${e} nowMs=${l} />`}
    </div>
  `}function i$(){return i`
    <div>
      <${ye} surfaceId="lab" />
  ...
  `}const $a=g(new Set(["broadcast","tasks","keepers","system"]));function o$(e){const t=new Set($a.value);t.has(e)?t.delete(e):t.add(e),$a.value=t}const mo=g(null);function $c(e){mo.value=e}function r$(e){return e.kind==="board"?"broadcast":e.kind==="tasks"?"tasks":e.kind==="keepers"?"keepers":"system"}const l$=Se(()=>{const e=$a.value;return Es.value.filter(t=>e.has(r$(t)))}),c$=12e4,d$=Se(()=>{const e=qr.value,t=Date.now();return Be.value.map(n=>{const s=n.name.trim().toLowerCase(),a=e.get(s)??null;let o="idle";if(n.status==="active"||n.status==="busy"){const l=a==null?void 0:a.lastActivityAt;l?o=t-new Date(l).getTime()>c$?"stale":"working":o="working"}else(n.status==="offline"||n.status==="inactive")&&(o="stale");return{name:n.name,emoji:n.emoji??"",koreanName:n.koreanName??null,state:o,currentTask:n.current_task,motion:a}})}),u$=Se(()=>{const e=qr.value;return Be.value.filter(t=>t.status==="active"||t.status==="busy"||t.status==="listening"||t.status==="idle").map(t=>{const n=t.name.trim().toLowerCase(),s=e.get(n),a=(s==null?void 0:s.activeAssignedCount)??0;let o="calm";return a>=3?o="hot":a>=1&&(o="normal"),{name:t.name,emoji:t.emoji??"",koreanName:t.koreanName??null,currentTask:t.current_task,lastActivityAt:(s==null?void 0:s.lastActivityAt)??null,lastActivityText:(s==null?void 0:s.lastActivityText)??null,assignedCount:a,pressure:o}}).sort((t,n)=>{const s={hot:0,normal:1,calm:2};return s[t.pressure]-s[n.pressure]})});function ar(e){return e.kind==="board"?"live-event-broadcast":e.kind==="tasks"?"live-event-task":e.kind==="keepers"?"live-event-keeper":"live-event-system"}function p$(e){const t=e.eventType;return t==="broadcast"?"broadcast":t==="agent_joined"?"joined":t==="agent_left"?"left":t==="task_update"?"task":t==="board_post"?"post":t==="board_comment"?"comment":t==="keeper_heartbeat"?"heartbeat":t==="keeper_handoff"?"handoff":t==="keeper_compaction"?"compact":t==="keeper_guardrail"?"guardrail":e.kind==="board"?"board":e.kind==="tasks"?"task":e.kind==="keepers"?"keeper":"system"}function m$(e){switch(e){case"working":return"pulse-working";case"stale":return"pulse-stale";default:return"pulse-idle"}}function v$(){const e=d$.value,t=mo.value;return e.length===0?i`
    ...
    <div class="pulse-strip">
      ${e.map(n=>i`
        <button
          key=${n.name}
          class="pulse-bubble ${m$(n.state)} ${t===n.name?"pulse-selected":""}"
          onClick=${()=>$c(t===n.name?null:n.name)}
  ...
  `}const _$=[{kind:"broadcast",label:"Broadcast",cssClass:"live-event-broadcast"},{kind:"tasks",label:"Task",cssClass:"live-event-task"},{kind:"keepers",label:"Keeper",cssClass:"live-event-keeper"},{kind:"system",label:"System",cssClass:"live-event-system"}];function g$(){const e=$a.value;return i`
  ...
  `}function f$(){const e=l$.value;return i`
        ...
        ${e.length===0?i`<div class="activity-empty">No events matching filters</div>`:e.map((t,n)=>i`
            ...
            >
              <div class="activity-item-head">
                <span class="activity-kind-chip ${ar(t)}">${p$(t)}</span>
  ...
  `}function $$(e){switch(e){case"hot":return"focus-pressure-hot";case"normal":return"focus-pressure-normal";default:return"focus-pressure-calm"}}function h$(e){switch(e){case"hot":return"High";case"normal":return"Active";default:return"Calm"}}function y$(){const e=u$.value,t=mo.value;return i`
        ...
        ${e.length===0?i`<div class="focus-empty">No active agents</div>`:e.map(n=>i`
            ...
            >
              <div class="focus-agent-header">
                ...
                <span class="focus-pressure-badge ${$$(n.pressure)}">
                  ${h$(n.pressure)}
  ...
  `}function b$(){const e=nt.value;return i`
    <div class="live-monitor">
      <div class="live-header">
        ...
        <div class="live-header-stats">
          ...
          <span class="live-stat">${ha.value} events</span>
        </div>
      </div>
  ...
  `}const ir=[{id:"observe",label:"Observe",description:"지금 상태, 실행 압력, 계획 상태를 먼저 읽는 운영 표면"},{id:"context",label:"Context",description:"비동기 메모리와 의사결정 거버넌스를 분리해서 보는 표면"},{id:"act",label:"Act",description:"개입과 system-of-record 지휘를 실행하는 표면"},{id:"lab",label:"Lab",description:"실험적 기능은 메인 operator console 밖으로 분리"}],zi=[{id:"mission",label:"Mission",icon:"🏠",group:"observe",description:"지금 문제, 다음 액션, 운영 포커스를 먼저 보는 기본 랜딩"},{id:"proof",label:"Proof",icon:"🔍",group:"observe",description:"협업, 대화, 도구, backing evidence를 증명 중심으로 읽는 표면"},{id:"execution",label:"Execution",icon:"🤖",group:"observe",description:"worker, task, keeper continuity를 분리해서 보는 실행 표면"},{id:"live",label:"Live",icon:"📡",group:"observe",description:"실시간 에이전트 활동과 이벤트 스트림을 한눈에 모니터링"},{id:"planning",label:"Planning",icon:"🎯",group:"observe",description:"goal, metric loop, backlog 압력을 읽는 계획 표면"},{id:"memory",label:"Memory",icon:"💬",group:"context",description:"posts/comments만으로 room의 비동기 메모리를 읽는 표면"},{id:"governance",label:"Governance",icon:"⚖️",group:"context",description:"debate와 voting만 분리해 의사결정 상태를 보는 표면"},{id:"intervene",label:"Intervene",icon:"🎮",group:"act",description:"room, session, keeper 액션을 실행하는 개입 화면"},{id:"command",label:"Command",icon:"🧭",group:"act",description:"유닛 계층, 작전 체인, 승인, 추적 이력을 보는 상세 화면"},{id:"lab",label:"Lab",icon:"⚔️",group:"lab",description:"TRPG 같은 실험 surface를 메인 console 밖에서 다룹니다"}],xs=g(!1);function k$(){const e=nt.value;return i`
    <div class="connection-status ${e?"connected":"disconnected"}">
      ...
      <span class="event-count">${ha.value} events</span>
    </div>
  `}function hc(e){const t=e==null?void 0:e.trim();return t?t.length>10?t.slice(0,10):t:"commit unavailable"}function x$(){const e=ie.value,t=e==null?void 0:e.build,n=t?`v${t.release_version} · ${hc(t.commit)}`:e!=null&&e.version?`v${e.version} · commit unavailable`:"version unavailable";return i`
  ...
  `}function Mi(e){e==="command"&&(Et(),Vt(),(X.value==="swarm"||X.value==="warroom")&&Je(),X.value==="warroom"&&he()),e==="mission"&&(Zr(),Bs()),e==="proof"&&Al(F.value.params.session_id,F.value.params.operation_id),e==="execution"&&yt(),e==="intervene"&&(he(),Ct()),e==="memory"&&Xe(),e==="planning"&&Bi(),e==="lab"&&Ze()}function S$({currentTab:e}){var s;const t=nt.value,n=(s=ie.value)==null?void 0:s.build;return i`
    <section class="rail-card">
      ...
      ${n?i`<div class="rail-build-hint">Server Build · v${n.release_version} · ${hc(n.commit)}</div>`:null}
    </section>
  `}function A$(){const e=ve.value,t=(e==null?void 0:e.pending_confirms.length)??0,n=(e==null?void 0:e.sessions.length)??0,s=(e==null?void 0:e.keepers.length)??0;return i`
    <section class="rail-card">
      <div class="rail-card-head">
        <h3>개입 바로가기</h3>
  ...
  `}function C$(){const e=F.value.tab,t=zi.find(s=>s.id===e),n=ir.find(s=>s.id===(t==null?void 0:t.group));return i`
  ...
  `}function I$(){switch(F.value.tab){case"mission":return i`<${jo} />`;case"proof":return i`<${k_} />`;case"execution":return i`<${tf} />`;case"live":return i`<${b$} />`;case"memory":return i`<${Hg} />`;case"governance":return i`<${Rf} />`;case"planning":return i`<${gf} />`;case"intervene":return i`<${Ng} />`;case"command":return i`<${Tg} />`;case"lab":return i`<${i$} />`;default:return i`<${jo} />`}}function T$(){te(()=>{wc(),mr(),Hr(),yt(),Ur(),Zr();const n=Yu();return Qu(),()=>{Dc(),n(),Xu()}},[]),te(()=>{const n=setInterval(()=>{Mi(F.value.tab)},15e3);return()=>{clearInterval(n)}},[]),te(()=>{Mi(F.value.tab)},[F.value.tab]);const e=F.value.tab,t=zi.find(n=>n.id===e);return i`
    <div class="app-shell">
      ...
      <div class="dashboard-layout">
        ...
        <main class="dashboard-main">
          ${fi.value&&!nt.value?i`<div class="loading-indicator">Loading dashboard...</div>`:i`<${I$} />`}
        </main>
      </div>
  ...
  `}const or=document.getElementById("app");or&&Ac(i`<${T$} />`,or);export{qm as _};
