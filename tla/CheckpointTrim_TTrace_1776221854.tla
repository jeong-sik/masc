---- MODULE CheckpointTrim_TTrace_1776221854 ----
...
\* to `JsonSerialize`. For example, a sub-sequence of _TETrace.
    \* ASSUME
    \*     LET J == INSTANCE Json
    \*         IN J!JsonSerialize("CheckpointTrim_TTrace_1776221854.json", _TETrace)
...
\*
\*trace == IODeserialize("CheckpointTrim_TTrace_1776221854.bin", TRUE)
\*
\*=============================================================================
\*
...
trace == 
    <<
    ([result |-> <<>>,msgs |-> <<"Text">>,pc |-> "trim"]),
    ([result |-> <<"Text">>,msgs |-> <<"Text">>,pc |-> "done"])
    >>
----
...
---- CONFIG CheckpointTrim_TTrace_1776221854 ----
CONSTANTS
    MaxLen = 5
    MaxCount = 3
...
ALIAS
    _expression
=============================================================================
\* Generated on Wed Apr 15 11:57:35 KST 2026