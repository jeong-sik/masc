...
OAS Pin Snapshot: dependency floor `0.121.0`, runtime pin `main@893826cf76f4e491795c0c8c98db40996c69fea5`, declared base version `v0.121.0`
...
`masc-mcp` keeps the runtime pin ratcheted against upstream `main`, while the dependency floor tracks the pinned SDK declaration in `agent_sdk.opam`. Generated snapshot: runtime pin `main@893826cf76f4e491795c0c8c98db40996c69fea5`, declared base version `v0.121.0`, dependency floor `0.121.0`.
