...
OAS Pin Snapshot: dependency floor `0.132.0`, runtime pin `main@5723e12ea3a8aa465c22fcbd0ef8abfa7c9651d6`, declared base version `v0.132.0`
...
`masc-mcp` keeps the runtime pin ratcheted against upstream `main`, while the dependency floor tracks the pinned SDK declaration in `agent_sdk.opam`. Generated snapshot: runtime pin `main@5723e12ea3a8aa465c22fcbd0ef8abfa7c9651d6`, declared base version `v0.132.0`, dependency floor `0.132.0`.
