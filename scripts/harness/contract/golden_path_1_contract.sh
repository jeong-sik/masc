...
#
# Tests the fundamental 7-step MASC workflow:
#   add_task → claim → plan_set_task → heartbeat → broadcast → status → done
#
...
# ── Step 2/7: claim ──
echo "[2/7] masc_transition (claim)"
...
# ── Step 3/7: plan_set_task ──
echo "[3/7] masc_plan_set_task"
