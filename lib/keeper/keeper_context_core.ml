...
module Checkpoint_sanitize = Keeper_context_core_checkpoint_sanitize
...
let default_max_checkpoint_text_blocks_per_message =
  Checkpoint_sanitize.default_max_checkpoint_text_blocks_per_message
let default_max_checkpoint_text_chars_per_message =
  Checkpoint_sanitize.default_max_checkpoint_text_chars_per_message
let default_max_checkpoint_content_chars_total =
  Checkpoint_sanitize.default_max_checkpoint_content_chars_total
let checkpoint_text_cap_marker = Checkpoint_sanitize.checkpoint_text_cap_marker
...
let default_max_checkpoint_tool_result_chars =
  Checkpoint_sanitize.default_max_checkpoint_tool_result_chars
let default_max_checkpoint_tool_results_per_message =
  Checkpoint_sanitize.default_max_checkpoint_tool_results_per_message
let default_max_checkpoint_tool_result_total_chars =
  Checkpoint_sanitize.default_max_checkpoint_tool_result_total_chars
...
type checkpoint_sanitize_stats = Checkpoint_sanitize.checkpoint_sanitize_stats =
...
let empty_checkpoint_sanitize_stats =
  Checkpoint_sanitize.empty_checkpoint_sanitize_stats

let checkpoint_sanitize_changed =
  Checkpoint_sanitize.checkpoint_sanitize_changed

let add_checkpoint_sanitize_stats =
  Checkpoint_sanitize.add_checkpoint_sanitize_stats

let truncate_checkpoint_text = Checkpoint_sanitize.truncate_checkpoint_text
let find_substring_from = Checkpoint_sanitize.find_substring_from
let strip_world_state_segments = Checkpoint_sanitize.strip_world_state_segments

let is_ephemeral_system_context_text =
  Checkpoint_sanitize.is_ephemeral_system_context_text

let sanitize_checkpoint_text_block =
  Checkpoint_sanitize.sanitize_checkpoint_text_block

let sanitize_checkpoint_message = Checkpoint_sanitize.sanitize_checkpoint_message

let checkpoint_content_chars_of_block =
  Checkpoint_sanitize.checkpoint_content_chars_of_block

let checkpoint_content_chars_of_message =
  Checkpoint_sanitize.checkpoint_content_chars_of_message

let cap_checkpoint_message_to_remaining_content =
  Checkpoint_sanitize.cap_checkpoint_message_to_remaining_content

let cap_checkpoint_messages_total_content =
  Checkpoint_sanitize.cap_checkpoint_messages_total_content

let sanitize_checkpoint_messages =
  Checkpoint_sanitize.sanitize_checkpoint_messages

let sanitize_oas_checkpoint = Checkpoint_sanitize.sanitize_oas_checkpoint
