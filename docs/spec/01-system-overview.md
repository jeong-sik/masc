...
### 7.4 Native Chain Plane (Internal Supporting Substrate)

Command Plane 안으로 흡수된 internal orchestration substrate. Front-door promise가 아니라 supporting implementation detail이다.
