...
val keepers_by_branch : config:Workspace.config -> (string * string list) list
val list_entries : config:Workspace.config -> branch_entry list
val entry_to_json : branch_entry -> Yojson.Safe.t
val json : config:Workspace.config -> Yojson.Safe.t
