...
let handover_to_json (h : handover_record) : Yojson.Safe.t =
  `Assoc [
    ...
    ("completed_steps", Json_util.json_string_list h.completed_steps);
    ("pending_steps", Json_util.json_string_list h.pending_steps);
    ("key_decisions", Json_util.json_string_list h.key_decisions);
    ("assumptions", Json_util.json_string_list h.assumptions);
    ("warnings", Json_util.json_string_list h.warnings);
    ("unresolved_errors", Json_util.json_string_list h.unresolved_errors);
    ("modified_files", Json_util.json_string_list h.modified_files);
