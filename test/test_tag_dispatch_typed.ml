...
(** RFC-0084 PR-9 — Tag-dispatch fallback telemetry wrap.
    ...
    fallback path inside [keeper_tool_remote_mcp_runtime.ml:180-190] where
...
(** Cumulative wrap sites after PR-9:
    - PR-7 keeper turn: keeper_tool_remote_mcp_runtime.ml:164 + :218     (2 sites)
    - PR-8 MCP server: mcp_server_eio_execute.ml:1065 + :1083 (2 sites)
    - PR-9 tag-dispatch fallback: keeper_tool_remote_mcp_runtime.ml:180+   (1 site)
