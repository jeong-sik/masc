...
| 레이어 | 설명 |
|--------|------|
| HTTP Server | h2_eio (HTTP/2 h2c, default), httpun_eio (HTTP/1.1 fallback: MASC_USE_H2=0) |
...
- Origin: `http://127.0.0.1:8935` (HTTP/2 h2c default)
- Localhost도 HTTP/2 h2c로 SSE 멀티플렉싱 지원
- HTTP/1.1 fallback: `MASC_USE_H2=0`
