...
let synthesize_inconclusive ~(proof : Oas.Cdal_proof.t) (err : Cdal_loader.load_error)
...
let evaluate ~(store : Oas.Proof_store.config) (proof : Oas.Cdal_proof.t) : eval_outcome =
