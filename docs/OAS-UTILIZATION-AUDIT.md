...
OAS Pin Snapshot: dependency floor `0.119.2`, runtime pin `main@67f1e5242dcc11181f2ae4dbb85065da4465083a`, declared base version `v0.119.2`
...
`masc-mcp` keeps the runtime pin ratcheted against upstream `main`, while the dependency floor tracks the pinned SDK declaration in `agent_sdk.opam`. Generated snapshot: runtime pin `main@67f1e5242dcc11181f2ae4dbb85065da4465083a`, declared base version `v0.119.2`, dependency floor `0.119.2`.
