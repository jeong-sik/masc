...
- Delta: r1 표는 20:00 KST 시점(7,515행)이었고 전일은 17,244행·낭비 7,734(44.9%)다. #32322 는 09-01 20:21·20:45 KST unchanged 응답 2건(새 모양, 재호출 0)으로 n=2 확인. r1 의 artifact paging 초과(20:00 시점 968회)는 설명 문구 문제가 아니라 두 keeper 의 행동(검색 대용 탐침 #32449, 오독 탐색 #32451)이 대부분이었다. #32322·#32326 은 이 창에서 해당 경로가 안 타서 미검증. 새 항목 #32452(time_now 폴링).
