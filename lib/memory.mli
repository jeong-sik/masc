(** MASC-owned memory facade.
    ...
    This is the canonical MASC boundary for keeper persistent memory. It wraps
    the existing keeper memory bank, continuity snapshot, and compaction
    contracts without exposing any OAS memory API. *)
...
val state_snapshot : t -> state_snapshot
