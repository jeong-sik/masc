...
(** Tool search, call recording, and side-effect detection extracted to
    [Keeper_exec_tools_search].  Execution dispatch and result
    classification below. *)

open Keeper_types
open Keeper_exec_shared
include Keeper_exec_tools_search
