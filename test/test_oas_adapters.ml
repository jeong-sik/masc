...
(* ================================================================ *)
(* Restore messages (direct Llm.of_oas_message)              *)
(* ================================================================ *)
...
let test_restore_messages_all_roles () =
  ...
  let masc_msgs = List.map Llm.of_oas_message oas_msgs in
