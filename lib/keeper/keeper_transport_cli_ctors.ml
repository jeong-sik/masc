(** CLI transport constructors + registration, extracted from
    ...
    - [Keeper_transport_cli_overrides] (#17393): cli_transport_overrides
      type + default
    - [Keeper_transport_non_http_registry] (#17428): registry +
      register_non_http_transport
    - [Keeper_transport_cli_config]: provider config readers
    - [Keeper_transport_cli_argv_sanitize]: make_cli_argv_sanitizing_transport
    - [Keeper_transport_runtime_policy_provider]: cli_runtime_mcp_jsons
    ...
    - Top-level [let () = ...] registration block that wires the 4
      ctors into [Keeper_transport_non_http_registry] at module
      ...
      [Keeper_transport_non_http_registry]), so by the time any
      caller invokes [non_http_transport_of_provider] at runtime,
      the registry is populated. *)

module Cli_overrides = Keeper_transport_cli_overrides
module Cli_config = Keeper_transport_cli_config
module Cli_argv_sanitize = Keeper_transport_cli_argv_sanitize
module Registry = Keeper_transport_non_http_registry
module Label_resolution = Keeper_transport_label_resolution
