...
OAS pin metadata is generated from `scripts/oas-agent-sdk-pin.sh`. Current dependency floor: `agent_sdk >= 0.163.0`, runtime pin: `codex/glm-coding-plan-cascade@f9388c68537c69fe457ff36ab7dbc0aa57be2920`, declared base version: `v0.163.0`. 최신성 검증이 필요할 때는 문서에 적힌 숫자보다 `dune-project`와 pin script를 우선 truth source로 본다.
