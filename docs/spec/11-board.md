...
| Status | Draft |
| Team | Workspace |
| Maps to | `lib/board_types/` (sub-library), `lib/board/board.ml`, `lib/board_tool_adapter/board_tool.ml` (successor to former `lib/tool_vote.ml` + `lib/tool_social.ml`, both folded into the board tool adapter) |
