...
>>>>>>>> origin/main:assets/dashboard/assets/index-CAxy4Vul.js
...
<<<<<<<< HEAD:assets/dashboard/assets/index-BEXhTso7.js
  `}function Ri(){const t=ga.value.map(Di),e=ne.value.map(Pi),n=[...t,...e].sort((a,s)=>An(s.timestamp)-An(a.timestamp)).slice(0,80);return o`
|||||||| 9f50097:assets/dashboard/assets/index-C2RqaVOn.js
...
<<<<<<<< HEAD:assets/dashboard/assets/index-BEXhTso7.js
  `}function Hi(){const t=ne.value;return o`
|||||||| 9f50097:assets/dashboard/assets/index-C2RqaVOn.js
...
<<<<<<<< HEAD:assets/dashboard/assets/index-BEXhTso7.js
  `}function qi({state:t}){var d;const e=gt.value||((d=t.session)==null?void 0:d.room)||"",n=Wt.value,a=t.party??[];if(!a.find(u=>u.id===_t.value)&&a.length>0){const u=a[0];u&&(_t.value=u.id)}const i=async()=>{if(!e){k("No room set","error");return}Wt.value="running";try{await As(e),Wt.value="ok",k("Round executed","success"),ot()}catch{Wt.value="error",k("Round failed","error")}},r=async()=>{if(e)try{await Ds(e),k("Turn advanced","success"),ot()}catch{k("Advance failed","error")}},c=async()=>{if(!e)return;const u=_t.value.trim();if(!u){k("Select actor first","warning");return}const p=Number.parseInt(Ce.value,10),l=Number.parseInt(Te.value,10);if(Number.isNaN(p)||Number.isNaN(l)){k("Stat/DC must be numbers","warning");return}const m=Number.parseInt(Vt.value,10),f=Vt.value.trim()===""||Number.isNaN(m)?void 0:m;try{await Ns({roomId:e,actorId:u,action:Se.value.trim()||"ability_check",statValue:p,dc:l,rawD20:f}),k("Dice rolled","success"),ot()}catch{k("Dice roll failed","error")}};return o`
|||||||| 9f50097:assets/dashboard/assets/index-C2RqaVOn.js
...
<<<<<<<< HEAD:assets/dashboard/assets/index-BEXhTso7.js
            value=${_t.value}
            onChange=${u=>{_t.value=u.target.value}}
|||||||| 9f50097:assets/dashboard/assets/index-C2RqaVOn.js
            value=${_t.value}
...
<<<<<<<< HEAD:assets/dashboard/assets/index-BEXhTso7.js
  `}function lo(){switch(H.value.tab){case"overview":return o`<${Sn} />`;case"council":return o`<${gi} />`;case"board":return o`<${Ni} />`;case"activity":return o`<${Ri} />`;case"agents":return o`<${Mi} />`;case"tasks":return o`<${ji} />`;case"journal":return o`<${Hi} />`;case"trpg":return o`<${Qi} />`;default:return o`<${Sn} />`}}function co(){return Qt(()=>{Za(),ua(),me();const t=Gs();return Js(),()=>{ls(),t(),qs()}},[]),Qt(()=>{const t=H.value.tab;t==="board"&&nt(),t==="trpg"&&ot()},[H.value.tab]),o`
|||||||| 9f50097:assets/dashboard/assets/index-C2RqaVOn.js
