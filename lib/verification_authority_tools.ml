       ...
       let bytes =
         ...
         | Workspace_producer ->
           (match Keeper_tool_filesystem_runtime.read_owned_bytes
            ...
            (* The parent bounded this read; this branch widened what reaches
               it. Both hold: presentations and MP4 escalate the same way a PDF
               does, and none of the three loads past the ceiling. *)
