...
window 변경 → 모든 overlay (anchored-thread-rail, runtime-overlay-layer) 가 동일 store subscribe → 자동 re-render. inspector slot (RFC-0024) 도 BDI snapshot 을 *그 시점* 의 BDI 로 대체.
