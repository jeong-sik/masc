(** Tool_mitosis_handoff — Heavy mitosis handlers.

    run_sync_handoff, handle_mitosis_handoff, handle_metrics_compare,
    handle_metrics_record. Extracted from tool_mitosis.ml. *)
