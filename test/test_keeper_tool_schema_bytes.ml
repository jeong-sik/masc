...
(* 2026-09-25: 123,633, measured by this suite on CI for #38805 (PR check run
   ...
   above. No headroom. *)
(* 2026-09-25: 123,641, measured by this suite on CI for #38812 (PR check run
   36124103149). BrowserInteract takes the stagehand lane (+12) and the
   browser-tab description is 4 bytes shorter. No headroom. *)
let ceiling_bytes = 123_641
