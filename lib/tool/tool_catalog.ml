...
let explicit_metadata : (string * metadata) list =
  [
    ...
    ("keeper_skill_publish", keeper_shard_write);
    ...
    ("masc_browser_act", keeper_shard_write);
    ("masc_browser_interact", keeper_shard_write);
    ("masc_browser_instruct", keeper_shard_write);
