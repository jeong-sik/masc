        ...
        `List
          [
            ...
            surface ~id:"execution" ~label:"Execution"
              ...
              [
                panel ~id:"execution.priority_queue" ~title:"Execution Priorities"
                  ~purpose:"Ranks worker drift and keeper continuity risk in one top queue."
                  ~problem_solved:"Cuts time to first intervention target."
                  ~when_active:"Top of Execution."
                  ~agent_role:"A supervising agent can start with the first few rows before scanning the full lists."
                  ~ecosystem_function:"Concentrates execution pressure into an actionable queue."
                  [];
                panel ~id:"execution.workers" ~title:"Workers"
                  ~purpose:"Monitors short-horizon execution actors and their task freshness."
                  ~problem_solved:"Shows whether active work still has a credible live owner."
                  ~when_active:"Normal execution."
                  ~agent_role:"Workers are expected to keep ownership and recent signal aligned."
                  ~ecosystem_function:"Makes execution drift visible before tasks rot."
                  [];
                panel ~id:"execution.continuity" ~title:"Continuity"
                  ~purpose:"Monitors keepers for heartbeat, context pressure, and handoff risk."
                  ~problem_solved:"Prevents long-lived continuity assets from being lost in worker noise."
                  ~when_active:"When keepers are active."
                  ~agent_role:"Keepers are expected to maintain continuity, not just recent activity."
                  ~ecosystem_function:"Protects long-horizon memory and autonomy continuity."
                  [];
