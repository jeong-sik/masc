var Hc=Object.defineProperty;var Wc=(e,t,n)=>t in e?Hc(e,t,{enumerable:!0,configurable:!0,writable:!0,value:n}):e[t]=n;var jt=(e,t,n)=>Wc(e,typeof t!="symbol"?t+"":t,n);import{e as Gc,_ as Jc,c as f,b as Ie,y as ne,d as Rr,A as Vc,G as Yc}from"./vendor-kuFK4-oj.js";(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const a of document.querySelectorAll('link[rel="modulepreload"]'))s(a);new MutationObserver(a=>{for(const o of a)if(o.type==="childList")for(const l of o.addedNodes)l.tagName==="LINK"&&l.rel==="modulepreload"&&s(l)}).observe(document,{childList:!0,subtree:!0});function n(a){const o={};return a.integrity&&(o.integrity=a.integrity),a.referrerPolicy&&(o.referrerPolicy=a.referrerPolicy),a.crossOrigin==="use-credentials"?o.credentials="include":a.crossOrigin==="anonymous"?o.credentials="omit":o.credentials="same-origin",o}function s(a){if(a.ep)return;a.ep=!0;const o=n(a);fetch(a.href,o)}})();var i=Gc.bind(Jc);const Xc=["mission","proof","execution","live","memory","governance","planning","intervene","command","lab"],Pr={tab:"mission",params:{},postId:null};function jo(e){return!!e&&Xc.includes(e)}function gi(e){try{return decodeURIComponent(e)}catch{return e}}function $i(e){const t={};return e&&new URLSearchParams(e).forEach((s,a)=>{t[a]=s}),t}function Qc(e){const n=e.replace(/^\/+/,"").split("/").filter(Boolean);return n[0]==="dashboard"?n.slice(1):n}function Lr(e,t){if(e[0]==="chains"){const o={...t,surface:"chains"};return e[1]==="operation"&&e[2]&&(o.operation=gi(e[2])),{tab:"command",params:o,postId:null}}if(e[0]==="lab"){const o={...t};return e[1]&&(o.surface=gi(e[1])),{tab:"lab",params:o,postId:null}}const n=e[0],s=t.tab;return{tab:jo(n)?n:jo(s)?s:"mission",params:t,postId:null}}function Bs(e){const t=(e||"").replace(/^#/,"").trim();if(!t)return Pr;const n=gi(t);let s=n,a;if(n.startsWith("?"))s="",a=n.slice(1);else{const c=n.indexOf("?");c>=0&&(s=n.slice(0,c),a=n.slice(c+1))}!a&&s.includes("=")&&!s.includes("/")&&(a=s,s="");const o=$i(a),l=Qc(s);return Lr(l,o)}function Zc(e,t){const n=e.replace(/^\/+/,"").split("/").filter(Boolean);if(n[0]!=="dashboard")return null;const s=n.slice(1);if(s.length===0)return{...Pr,params:$i(t.replace(/^\?/,""))};if(s[0]==="assets"||s[0]==="credits"||s[0]==="lodge")return null;const a=$i(t.replace(/^\?/,""));return Lr(s,a)}function Mr(e){const t=e.tab==="lab"&&e.params.surface?`lab/${encodeURIComponent(e.params.surface)}`:e.tab,n=Object.entries(e.params).filter(([a])=>!(a==="tab"||e.tab==="lab"&&a==="surface"));if(n.length===0)return`#${t}`;const s=new URLSearchParams(n);return`#${t}?${s.toString()}`}const F=f(Bs(window.location.hash));window.addEventListener("hashchange",()=>{F.value=Bs(window.location.hash)});function se(e,t){const n={tab:e,params:t??{}};window.location.hash=Mr(n)}function ed(e){window.location.hash=`#memory?post=${encodeURIComponent(e)}`}function td(){if(window.location.hash&&window.location.hash!=="#"){F.value=Bs(window.location.hash);return}const e=Zc(window.location.pathname,window.location.search);if(e){F.value=e;const t=Mr(e);window.history.replaceState(null,"",`${window.location.pathname}${window.location.search}${t}`);return}window.location.hash="#mission",F.value=Bs(window.location.hash)}const Eo="masc_dashboard_sse_session_id",nd=1e3,sd=15e3,rt=f(!1),za=f(0),jr=f(null),Us=f([]);function ad(){let e=sessionStorage.getItem(Eo);return e||(e=typeof crypto.randomUUID=="function"?`dash_${crypto.randomUUID()}`:`dash_${Date.now().toString(36)}_${Math.random().toString(36).slice(2,10)}`,sessionStorage.setItem(Eo,e)),e}const id=200;function od(e,t,n="system",s={}){const a={agent:e,text:t,timestamp:Date.now(),kind:n,...s};Us.value=[a,...Us.value].slice(0,id)}function hi(e,t=88){const n=(e??"").replace(/\s+/g," ").trim();return n?n.length>t?`${n.slice(0,t-3)}...`:n:void 0}function No(e,t){const n=hi(t);return n?`${e}: ${n}`:`New ${e.toLowerCase()}`}function Ce(e,t,n,s,a={}){od(e,t,n,{eventType:s,...a})}let Me=null,Gt=null,yi=0;function Er(){Gt&&(clearTimeout(Gt),Gt=null)}function rd(){if(Gt)return;yi++;const e=Math.min(yi,5),t=Math.min(sd,nd*Math.pow(2,e));Gt=setTimeout(()=>{Gt=null,Nr()},t)}function Nr(){Er(),Me&&(Me.close(),Me=null);const e=new URLSearchParams(window.location.search),t=new URLSearchParams,n=e.get("agent")??e.get("agent_name"),s=e.get("token");n&&t.set("agent",n),s&&t.set("token",s),t.set("session_id",ad());const a=t.toString()?`/sse?${t.toString()}`:"/sse",o=new EventSource(a);Me=o,o.onopen=()=>{Me===o&&(yi=0,rt.value=!0)},o.onerror=()=>{Me===o&&(rt.value=!1,o.close(),Me=null,rd())},o.onmessage=l=>{try{const c=JSON.parse(l.data);za.value++,jr.value=c,ld(c)}catch{}}}function ld(e){const t=e.type,n=e.agent??e.author??e.from??e.from_agent??"";switch(t){case"agent_joined":Ce(n,"Joined","system","agent_joined");break;case"agent_left":Ce(n,"Left","system","agent_left");break;case"broadcast":Ce(n,`${(e.message??e.content??"").slice(0,80)}`,"system","broadcast");break;case"task_update":Ce(n,`Task: ${e.task_id??""} -> ${e.status??""}`,"tasks","task_update");break;case"board_post":case"masc/board_post":Ce(n,No("Post",e.content??e.message),"board","board_post",{author:e.author??n,preview:hi(e.content??e.message),postId:e.post_id});break;case"board_comment":case"masc/board_comment":Ce(n,No("Comment",e.content??e.message),"board","board_comment",{author:e.author??n,preview:hi(e.content??e.message),postId:e.post_id});break;case"keeper_heartbeat":Ce(e.name??n,`Heartbeat gen=${e.generation??"?"} ctx=${e.context_ratio!=null?Math.round(e.context_ratio*100)+"%":"?"}`,"keepers","keeper_heartbeat");break;case"keeper_handoff":Ce(e.name??n,`Handoff gen ${e.from_generation??"?"} -> ${e.to_generation??"?"} (${e.to_model??"?"})`,"keepers","keeper_handoff");break;case"keeper_compaction":Ce(e.name??n,`Compaction saved ${e.saved_tokens??"?"} tokens (${e.trigger??"?"})`,"keepers","keeper_compaction");break;case"keeper_guardrail":Ce(e.name??n,`Guardrail: ${e.reason??"stopped"}`,"keepers","keeper_guardrail");break;default:Ce(n,t,"system","unknown")}}function cd(){Er(),Me&&(Me.close(),Me=null),rt.value=!1}function v(e){return typeof e=="object"&&e!==null&&!Array.isArray(e)}function r(e){return typeof e=="string"&&e.trim()!==""?e.trim():void 0}function d(e){return typeof e=="number"&&Number.isFinite(e)?e:void 0}function N(e){return typeof e=="boolean"?e:void 0}function H(e){return Array.isArray(e)?e.map(t=>typeof t=="string"?t.trim():"").filter(Boolean):[]}function pe(e,t=[]){if(Array.isArray(e))return e;if(!v(e))return[];for(const n of t){const s=e[n];if(Array.isArray(s))return s}return[]}function ae(e){if(typeof e=="string"&&e.trim()!=="")return e;if(!(typeof e!="number"||!Number.isFinite(e)||e<=0))return new Date(e*1e3).toISOString()}function wr(){return new URLSearchParams(window.location.search)}const dd="masc_dashboard_agent_name";function ud(){var e;try{return((e=localStorage.getItem(dd))==null?void 0:e.trim())||null}catch{return null}}function Dr(){const e=wr(),t={},n=e.get("token"),s=ud(),a=e.get("agent")??e.get("agent_name")??s;return n&&(t.Authorization=`Bearer ${n}`),a&&(t["X-MASC-Agent"]=a),t}function Or(){return{...Dr(),"Content-Type":"application/json"}}const pd=15e3,Vi=3e4,md=6e4,wo=new Set([408,425,429,500,502,503,504]);class Zn extends Error{constructor(n){const s=n.method.toUpperCase(),a=n.timeout===!0,o=a?`${s} ${n.path}: timeout after ${n.timeoutMs??0}ms`:`${s} ${n.path}: ${n.status??"unknown"} ${n.statusText??""}`.trim();super(o);jt(this,"method");jt(this,"path");jt(this,"status");jt(this,"statusText");jt(this,"timeout");this.name="ApiRequestError",this.method=s,this.path=n.path,this.status=n.status,this.statusText=n.statusText,this.timeout=a}}async function Yi(e,t,n){const s=new AbortController,a=setTimeout(()=>s.abort(),n);try{return await fetch(e,{...t,signal:s.signal})}catch(o){if(o instanceof Error&&o.name==="AbortError"){const l=typeof t.method=="string"?t.method.toUpperCase():"GET";throw new Zn({method:l,path:e,timeout:!0,timeoutMs:n})}throw o}finally{clearTimeout(a)}}function vd(){var t,n;const e=wr();return((t=e.get("agent"))==null?void 0:t.trim())||((n=e.get("agent_name"))==null?void 0:n.trim())||"dashboard-user"}async function Q(e){const t=await Yi(e,{headers:Dr()},pd);if(!t.ok)throw new Zn({method:"GET",path:e,status:t.status,statusText:t.statusText});return t.json()}function _d(e){return new Promise(t=>setTimeout(t,e))}function fd(e){const t=e.match(/\b(\d{3})\b/);if(!t)return null;const n=t[1];if(!n)return null;const s=Number.parseInt(n,10);return Number.isFinite(s)?s:null}function gd(e){if(e instanceof Zn)return e.timeout||typeof e.status=="number"&&wo.has(e.status);if(!(e instanceof Error))return!1;if(/timeout after \d+ms/i.test(e.message))return!0;const t=fd(e.message);return t!==null&&wo.has(t)}async function Ra(e,t,n=2){let s=0;for(;;)try{return await t()}catch(a){if(!gd(a)||s>=n)throw a;const o=250*(s+1);console.warn(`[dashboard/api] ${e} failed (attempt ${s+1}), retrying in ${o}ms`,a),await _d(o),s+=1}}async function Oe(e,t,n,s=Vi){const a=await Yi(e,{method:"POST",headers:{...Or(),...n??{}},body:JSON.stringify(t)},s);if(!a.ok)throw new Zn({method:"POST",path:e,status:a.status,statusText:a.statusText});return a.json()}async function $d(e,t,n,s=Vi){const a=await Yi(e,{method:"POST",headers:{...Or(),...n??{}},body:JSON.stringify(t)},s);if(!a.ok)throw new Zn({method:"POST",path:e,status:a.status,statusText:a.statusText});return a.text()}function hd(e){const t=e.split(`
`).find(s=>s.startsWith("data: ")),n=t?t.slice(6).trim():e.trim();return JSON.parse(n)}function yd(e){var t,n,s,a,o,l,c;if((t=e.error)!=null&&t.message)throw new Error(e.error.message);if((n=e.result)!=null&&n.isError){const p=((a=(s=e.result.content)==null?void 0:s[0])==null?void 0:a.text)??"MCP tool call failed";throw new Error(p)}return((c=(l=(o=e.result)==null?void 0:o.content)==null?void 0:l[0])==null?void 0:c.text)??""}async function ut(e,t){const n=await $d("/mcp",{jsonrpc:"2.0",method:"tools/call",params:{name:e,arguments:t},id:Math.floor(Date.now()%1e6)},{Accept:"application/json, text/event-stream"},md),s=hd(n);return yd(s)}function bd(){return Q("/api/v1/dashboard/shell")}function kd(){return Q("/api/v1/dashboard/execution")}function xd(e,t){const n=new URLSearchParams;return n.set("sort_by",e),t!=null&&t.excludeSystem&&n.set("exclude_system","true"),Q(`/api/v1/dashboard/memory${n.toString()?`?${n}`:""}`)}function Sd(){return Ra("fetchDashboardGovernance",async()=>{const e=await Q("/api/v1/dashboard/governance"),t=Array.isArray(e.items)?e.items.map(o=>Kd(o)).filter(o=>o!==null):[],n=Array.isArray(e.pending_actions)?e.pending_actions.map(o=>Kr(o)).filter(o=>o!==null):[],s=t.filter(o=>o.kind==="debate").map(o=>({id:o.id,topic:o.topic,status:o.status,argument_count:o.evidence_refs.length,created_at:o.last_activity_at??void 0})),a=t.filter(o=>o.kind==="consensus").map(o=>({id:o.id,topic:o.topic,initiator:o.related_agents[0]||"system",votes:o.votes??0,quorum:o.quorum??0,threshold:o.threshold,state:o.status,created_at:o.last_activity_at??void 0}));return{generated_at:le(e.generated_at)??void 0,summary:v(e.summary)?{debates:me(e.summary.debates)??void 0,voting_sessions:me(e.summary.voting_sessions)??void 0,debates_open:me(e.summary.debates_open)??void 0,sessions_active:me(e.summary.sessions_active)??void 0,sessions_without_quorum:me(e.summary.sessions_without_quorum)??void 0,ready_to_execute:me(e.summary.ready_to_execute)??void 0,oldest_open_debate_age_s:typeof e.summary.oldest_open_debate_age_s=="number"?e.summary.oldest_open_debate_age_s:null,last_activity_age_s:typeof e.summary.last_activity_age_s=="number"?e.summary.last_activity_age_s:null,judge_online:typeof e.summary.judge_online=="boolean"?e.summary.judge_online:void 0,judge_last_seen_at:le(e.summary.judge_last_seen_at)}:void 0,debates:s,sessions:a,items:t,activity:Array.isArray(e.activity)?e.activity.map(o=>Bd(o)).filter(o=>o!==null):[],judge:Ud(e.judge),pending_actions:n}})}function Cd(){return Q("/api/v1/dashboard/semantics")}function Ad(){return Q("/api/v1/dashboard/mission")}function Id(e){const t=`?session_id=${encodeURIComponent(e)}`;return Q(`/api/v1/dashboard/session${t}`)}function Td(e=!1){return Q(`/api/v1/dashboard/mission/briefing${e?"?force=1":""}`)}function zd(e,t){const n=new URLSearchParams;e&&n.set("session_id",e),t&&n.set("operation_id",t);const s=n.toString();return Q(`/api/v1/dashboard/proof${s?`?${s}`:""}`)}function Rd(){return Q("/api/v1/dashboard/planning")}function Pd(){return Q("/api/v1/tool-metrics")}function Ld(){return Q("/api/v1/operator")}function qr(e={}){const t=new URLSearchParams;e.targetType&&t.set("target_type",e.targetType),e.targetId&&t.set("target_id",e.targetId),e.includeWorkers!=null&&t.set("include_workers",e.includeWorkers?"true":"false");const n=t.toString();return Q(`/api/v1/operator/digest${n?`?${n}`:""}`)}function Md(){return Q("/api/v1/command-plane")}function jd(){return Q("/api/v1/command-plane/summary")}function Ed(){return Q("/api/v1/chains/summary")}function Nd(e){return Q(`/api/v1/chains/runs/${encodeURIComponent(e)}`)}function wd(){return Q("/api/v1/command-plane/help")}function Dd(e,t){const n=new URLSearchParams;e&&n.set("run_id",e),t&&n.set("operation_id",t);const s=n.toString();return Q(`/api/v1/command-plane/swarm${s?`?${s}`:""}`)}function Od(e,t){const n=new URLSearchParams;e&&n.set("run_id",e),t&&n.set("operation_id",t);const s=n.toString();return Q(`/api/v1/command-plane/orchestra${s?`?${s}`:""}`)}function qd(e,t){return Oe(e,t)}function Fd(e){switch(e.action_type){case"keeper_message":case"keeper_recover":return 9e4;case"swarm_run_continue":return 6e4;case"swarm_run_rerun":return 12e4;case"swarm_run_abandon":return 3e4;case"lodge_tick":return 45e3;default:return Vi}}function Pa(e){return Oe("/api/v1/operator/action",e,void 0,Fd(e))}function Fr(e,t,n="confirm"){return Oe("/api/v1/operator/confirm",{actor:e,confirm_token:t,decision:n})}function Rs(e){if(typeof e=="string"&&e.trim())return e;if(typeof e!="number"||Number.isNaN(e))return new Date().toISOString();const t=e<1e12?e*1e3:e;return new Date(t).toISOString()}function le(e){if(typeof e=="string"){const t=e.trim();return t||null}if(typeof e=="number"&&Number.isFinite(e)){const t=e<1e12?e*1e3:e;return new Date(t).toISOString()}return null}function q(e){if(typeof e!="string")return null;const t=e.trim();return t||null}function Kr(e){if(!v(e))return null;const t=k(e.confirm_token??e.token,"").trim();return t?{confirm_token:t,actor:q(e.actor)??void 0,action_type:q(e.action_type)??void 0,target_type:q(e.target_type)??void 0,target_id:q(e.target_id),delegated_tool:q(e.delegated_tool)??void 0,created_at:le(e.created_at)??void 0,preview:e.preview}:null}function Xi(e){return v(e)?{board_post_id:q(e.board_post_id),task_id:q(e.task_id),operation_id:q(e.operation_id),team_session_id:q(e.team_session_id)}:{}}function Br(e){if(!v(e))return null;const t=q(e.action_kind),n=q(e.resolved_tool),s=q(e.target_type),a=q(e.target_id),o=q(e.reason);return!t&&!n&&!s&&!o?null:{action_kind:t??void 0,resolved_tool:n,target_type:s,target_id:a,reason:o??void 0,payload_preview:e.payload_preview}}function Ur(e){if(!v(e))return null;const t=q(e.action_type),n=q(e.delegated_tool),s=q(e.confirmation_state),a=le(e.created_at);return!t&&!n&&!s&&!a?null:{action_type:t??void 0,delegated_tool:n,confirmation_state:s??void 0,created_at:a}}function Hr(e){if(!v(e))return null;const t=Kr(e.pending_confirm),n=q(e.pending_confirm_token)??(t==null?void 0:t.confirm_token)??null;return{requires_human_gate:typeof e.requires_human_gate=="boolean"?e.requires_human_gate:void 0,pending_confirm:t,pending_confirm_token:n,ready_to_execute:typeof e.ready_to_execute=="boolean"?e.ready_to_execute:void 0}}function Wr(e){if(!v(e))return null;const t=q(e.summary),n=q(e.target_id);return!t&&!n?null:{judgment_id:q(e.judgment_id)??void 0,target_kind:q(e.target_kind)??void 0,target_id:n??void 0,status:q(e.status)??void 0,summary:t??void 0,confidence:typeof e.confidence=="number"?e.confidence:null,generated_at:le(e.generated_at),expires_at:le(e.expires_at),model_used:q(e.model_used),keeper_name:q(e.keeper_name),evidence_refs:je(e.evidence_refs),recommended_action:Br(e.recommended_action),guardrail_state:Hr(e.guardrail_state),executed_route:Ur(e.executed_route)}}function Kd(e){if(!v(e))return null;const t=k(e.id,"").trim(),n=k(e.topic,"").trim();if(!t||!n)return null;const s=Xi(e.context);return{kind:k(e.kind,"debate"),id:t,topic:n,status:k(e.status??e.state,"open"),last_activity_at:le(e.last_activity_at),truth_summary:q(e.truth_summary)??void 0,judgment_summary:q(e.judgment_summary),confidence:typeof e.confidence=="number"?e.confidence:null,related_agents:je(e.related_agents),context:s,linked_board_post_id:q(e.linked_board_post_id)??s.board_post_id??null,linked_task_id:q(e.linked_task_id)??s.task_id??null,linked_operation_id:q(e.linked_operation_id)??s.operation_id??null,linked_session_id:q(e.linked_session_id)??s.team_session_id??null,recommended_action:Br(e.recommended_action),executed_route:Ur(e.executed_route),guardrail_state:Hr(e.guardrail_state),evidence_refs:je(e.evidence_refs),approve_count:me(e.approve_count),reject_count:me(e.reject_count),abstain_count:me(e.abstain_count),votes:me(e.votes),quorum:me(e.quorum),threshold:typeof e.threshold=="number"?e.threshold:void 0}}function Bd(e){if(!v(e))return null;const t=k(e.kind,"").trim();return t?{kind:t,item_kind:q(e.item_kind)??void 0,item_id:q(e.item_id)??void 0,topic:q(e.topic)??void 0,created_at:le(e.created_at),summary:q(e.summary)??void 0,actor:q(e.actor),index:me(e.index),decision:q(e.decision)}:null}function Ud(e){if(v(e))return{judge_online:typeof e.judge_online=="boolean"?e.judge_online:void 0,refreshing:typeof e.refreshing=="boolean"?e.refreshing:void 0,generated_at:le(e.generated_at),expires_at:le(e.expires_at),model_used:q(e.model_used),keeper_name:q(e.keeper_name),last_error:q(e.last_error)}}function Hd(e){var a;const t=e.trim(),s=((a=(t.startsWith("[flair:")?t.replace(/^\[flair:[^\]]+\]\s*/i,""):t).split(`
`)[0])==null?void 0:a.trim())||"Untitled post";return s.length<=96?s:`${s.slice(0,93)}...`}function Wd(e){if(!v(e))return null;const t=k(e.source,"").trim()||null,n=k(e.state_block,"").trim()||null;return!t&&!n?null:{source:t,state_block:n}}function Gd(e){if(!v(e))return null;const t=k(e.id,"").trim(),n=k(e.author,"").trim(),s=k(e.body,"").trim()||k(e.content,"").trim(),a=s;if(!t||!n)return null;const o=B(e.score,0),l=B(e.votes_up,0),c=B(e.votes_down,0),p=B(e.votes,o||l-c),m=B(e.comment_count,B(e.reply_count,0)),u=(()=>{const S=e.flair;if(typeof S=="string"&&S.trim())return S.trim();if(v(S)){const x=k(S.name,"").trim();if(x)return x}return k(e.flair_name,"").trim()||void 0})(),_=k(e.created_at_iso,"").trim()||Rs(e.created_at),g=k(e.updated_at_iso,"").trim()||(e.updated_at!==void 0?Rs(e.updated_at):_),b=k(e.title,"").trim()||Hd(s),$=Array.isArray(e.tags)?e.tags.filter(S=>typeof S=="string"&&S.trim()!==""):[];return{id:t,author:n,post_kind:(()=>{const S=k(e.post_kind,"").trim().toLowerCase();return S==="automation"||S==="system"||S==="human"?S:void 0})(),title:b,body:s,content:a,meta:Wd(e.meta),tags:$,votes:p,vote_balance:o,comment_count:m,created_at:_,updated_at:g,flair:u,hearth:k(e.hearth,"").trim()||null,visibility:k(e.visibility,"").trim()||void 0,expires_at:k(e.expires_at_iso,"").trim()||(e.expires_at!==void 0&&e.expires_at!==0?Rs(e.expires_at):"")||null,hearth_count:B(e.hearth_count,0)}}function Jd(e){if(!v(e))return null;const t=k(e.id,"").trim(),n=k(e.post_id,"").trim(),s=k(e.author,"").trim();return!t||!s?null:{id:t,post_id:n,author:s,content:k(e.content,""),created_at:Rs(e.created_at)}}async function Vd(e){return Ra("fetchBoardPost",async()=>{const t=await Q(`/api/v1/board/${e}?format=flat`),n=v(t.post)?t.post:t,s=Gd(n)??{id:e,author:"unknown",post_kind:"human",title:"Post",body:"",content:"",meta:null,tags:[],votes:0,comment_count:0,created_at:new Date().toISOString(),updated_at:new Date().toISOString(),hearth:null,visibility:"internal",expires_at:null},o=(Array.isArray(t.comments)?t.comments:[]).map(Jd).filter(l=>l!==null);return{...s,comments:o}})}function Gr(e,t){return Oe("/api/v1/tools/masc_board_vote",{post_id:e,direction:t,vote:t,voter:vd()})}function Yd(e,t,n){return Oe("/api/v1/tools/masc_board_comment",{post_id:e,author:t,content:n})}function Xd(e){const t=k(e,"").trim().toLowerCase();if(t==="win"||t==="won"||t==="victory")return"victory";if(t==="lose"||t==="lost"||t==="defeat")return"defeat";if(t==="draw"||t==="stalemate"||t==="tie")return"draw"}function ce(...e){for(const t of e){const n=k(t,"");if(n.trim())return n.trim()}return""}function Do(e){const t=Xd(ce(e.outcome,e.result,e.result_code));if(!t)return;const n=ce(e.reason,e.reason_code,e.description,e.detail),s=ce(e.summary,e.summary_ko,e.summary_en,e.note),a=ce(e.details,e.details_text,e.text,e.note),o=ce(e.winner,e.winner_name,e.actor_winner,e.winner_actor),l=ce(e.winner_actor_id,e.winner_actor,e.actor_winner_id),c=ce(e.raw_reason,e.raw_reason_code,e.error_message),p=(()=>{const _=e.evidence??e.evidence_ids??e.supporting_events??e.event_ids??[];return typeof _=="string"?[_]:Array.isArray(_)?_.map(g=>{if(typeof g=="string")return g.trim();if(v(g)){const h=k(g.summary,"").trim();if(h)return h;const b=k(g.text,"").trim();if(b)return b;const $=k(g.type,"").trim();return $||k(g.event_id,"").trim()}return""}).filter(g=>g.length>0):[]})(),m=(()=>{const _=B(e.turn,Number.NaN);if(Number.isFinite(_))return _;const g=B(e.turn_number,Number.NaN);if(Number.isFinite(g))return g;const h=B(e.current_turn,Number.NaN);if(Number.isFinite(h))return h;const b=B(e.round,Number.NaN);return Number.isFinite(b)?b:void 0})(),u=ce(e.phase,e.phase_name,e.current_phase,e.phase_id);return{result:t,reason:n||void 0,summary:s||void 0,details:a||void 0,winner:o||void 0,winner_actor_id:l||void 0,evidence:p.length>0?p:void 0,raw_reason:c||void 0,turn:m,phase:u||void 0}}function Qd(e,t){const n=v(e.state)?e.state:{};if(k(n.status,"active").toLowerCase()!=="ended")return;const a=[...t].reverse().find(l=>v(l)?k(l.type,"")==="session.outcome":!1),o=v(n.session_outcome)?n.session_outcome:{};if(v(o)&&Object.keys(o).length>0){const l=Do(o);if(l)return l}if(v(a))return Do(v(a.payload)?a.payload:{})}function k(e,t=""){return typeof e=="string"?e:t}function B(e,t=0){return typeof e=="number"&&Number.isFinite(e)?e:t}function me(e){if(typeof e=="number"&&Number.isFinite(e))return Math.trunc(e);if(typeof e=="string"){const t=Number.parseInt(e.trim(),10);if(Number.isFinite(t))return t}}function Hs(e,t=!1){return typeof e=="boolean"?e:t}function je(e){return Array.isArray(e)?e.map(t=>{if(typeof t=="string")return t.trim();if(v(t)){const n=k(t.name,"").trim(),s=k(t.id,"").trim(),a=k(t.skill,"").trim();return n||s||a}return""}).filter(t=>t.length>0):[]}function Zd(e){const t={};if(!v(e)&&!Array.isArray(e))return t;if(v(e))return Object.entries(e).forEach(([n,s])=>{const a=n.trim(),o=k(s,"").trim();!a||!o||(t[a]=o)}),t;for(const n of e){if(!v(n))continue;const s=ce(n.to,n.target,n.actor_id,n.name,n.id),a=ce(n.relationship,n.relation,n.type,n.kind);!s||!a||(t[s]=a)}return t}function eu(e,t,n){if(e==="dm"||e==="player"||e==="npc")return e;const s=t.trim().toLowerCase();return s==="dm"||s.startsWith("dm-")?"dm":s.startsWith("npc-")||s.startsWith("enemy-")||s.startsWith("mob-")?"npc":/^p\d+$/i.test(s)||s.startsWith("player-")?"player":typeof n=="string"&&n.trim()!==""?n.trim().toLowerCase().includes("dm")?"dm":"player":"npc"}function ke(e,t,n,s=0){const a=e[t];if(typeof a=="number"&&Number.isFinite(a))return a;if(n){const o=e[n];if(typeof o=="number"&&Number.isFinite(o))return o}return s}const tu=new Set(["str","dex","con","int","wis","cha","strength","dexterity","constitution","intelligence","wisdom","charisma","hp","max_hp","mp","max_mp","level","xp"]);function nu(e){const t=v(e.stats)?e.stats:{},n={};return Object.entries(t).forEach(([s,a])=>{const o=s.trim();o&&(tu.has(o.toLowerCase())||typeof a=="number"&&Number.isFinite(a)&&(n[o]=a))}),n}function su(e,t){if(e!=="dice.rolled")return;const n=B(t.raw_d20,0),s=B(t.total,0),a=B(t.bonus,0),o=k(t.action,"roll"),l=B(t.dc,0);return{notation:l>0?`${o} (DC ${l})`:o,rolls:n>0?[n]:[],total:s,modifier:a}}function au(e){const t=JSON.stringify(e);return t?t.length>160?`${t.slice(0,157)}...`:t:""}function iu(e){const t=e.trim().toLowerCase();return t?t.startsWith("dice.")?"dice":t.startsWith("combat.")||t.includes(".attack")||t.includes(".damage")?"combat":t.includes("actor.")?"actor":t.includes("turn.")||t==="turn.started"||t==="phase.changed"?"turn":t.includes("join.")?"join":t.includes("memory")?"memory":t.includes("world.")?"world":t.includes("narration")?"story":"meta":"meta"}function ou(e,t,n,s){const a=n||t||k(s.actor_id,"")||k(s.actor_name,"");switch(e){case"turn.action.proposed":{const o=k(s.proposed_action,k(s.reply,""));return o?`${a||"actor"}: ${o}`:"Action proposed"}case"turn.action.resolved":{const o=k(s.reply,k(s.result,""));return o?`Resolved: ${o}`:"Action resolved"}case"narration.posted":return k(s.reply,k(s.content,k(s.text,"Narration")));case"dice.rolled":{const o=k(s.action,"roll"),l=B(s.total,0),c=B(s.dc,0),p=k(s.label,""),m=a||"actor",u=c>0?` vs DC ${c}`:"",_=p?` (${p})`:"";return`${m} ${o}: ${l}${u}${_}`}case"turn.started":return`Turn ${B(s.turn,1)} started`;case"phase.changed":return`Phase: ${k(s.phase,"round")}`;case"actor.spawned":return`Actor spawned: ${k(s.name,v(s.actor)?k(s.actor.name,a||"unknown"):a||"unknown")}`;case"actor.claimed":return`${k(s.keeper_name,k(s.keeper,"keeper"))} claimed ${a||"actor"}`;case"actor.released":return`${k(s.keeper_name,k(s.keeper,"keeper"))} released ${a||"actor"}`;case"join.window.opened":return`Join window opened (turn ${B(s.turn,0)})`;case"join.window.closed":return`Join window closed (turn ${B(s.turn,0)})`;case"mid.join.requested":return`Mid-join requested: ${a||k(s.actor_id,"actor")}`;case"mid.join.granted":return`Mid-join granted: ${a||k(s.actor_id,"actor")}`;case"mid.join.rejected":return`Mid-join rejected: ${k(s.reason_code,"unknown")}`;case"memory.signal":{const o=v(s.entity_refs)?s.entity_refs:{},l=k(o.requested_tier,""),c=k(o.effective_tier,""),p=Hs(o.guardrail_applied,!1),m=k(s.summary_en,k(s.summary_ko,"Memory signal"));if(!l&&!c)return m;const u=l&&c?`${l}->${c}`:c||l;return`${m} [${u}${p?" (guardrail)":""}]`}case"world.event":{if(k(s.event_type,"")==="canon.check"){const l=k(s.status,"unknown"),c=k(s.contract_id,"n/a");return`Canon ${l}: ${c}`}return k(s.description,k(s.summary,"World event"))}case"combat.attack":return k(s.summary,k(s.result,"Attack resolved"));case"combat.defense":return k(s.summary,k(s.result,"Defense resolved"));case"session.outcome":return k(s.summary,k(s.outcome,"Session ended"));default:{const o=au(s);return o?`${e}: ${o}`:e}}}function ru(e,t){const n=v(e)?e:{},s=k(n.type,"event"),a=typeof n.actor_id=="string"&&n.actor_id.trim()?n.actor_id.trim():"",o=k(n.actor_name,"").trim()||t[a]||k(v(n.payload)?n.payload.actor_name:"",""),l=v(n.payload)?n.payload:{},c=k(n.ts,k(n.timestamp,new Date().toISOString())),p=k(n.phase,k(l.phase,"")),m=k(n.category,"");return{type:s,actor:o||a||k(l.actor_name,""),actor_id:a||k(l.actor_id,""),actor_name:o,seq:n.seq,room_id:k(n.room_id,""),phase:p||void 0,category:m||iu(s),visibility:k(n.visibility,k(l.visibility,"public")),event_id:k(n.event_id,""),content:ou(s,a,o,l),dice_roll:su(s,l),timestamp:c}}function lu(e,t,n){var Z,ie;const s=k(e.room_id,"")||n||"default",a=v(e.state)?e.state:{},o=v(a.party)?a.party:{},l=v(a.actor_control)?a.actor_control:{},c=v(a.join_gate)?a.join_gate:{},p=v(a.contribution_ledger)?a.contribution_ledger:{},m=Object.entries(o).map(([V,ee])=>{const A=v(ee)?ee:{},Te=ke(A,"max_hp",void 0,10),Je=ke(A,"hp",void 0,Te),_t=ke(A,"max_mp",void 0,0),ft=ke(A,"mp",void 0,0),K=ke(A,"level",void 0,1),ze=ke(A,"xp",void 0,0),gt=Hs(A.alive,Je>0),_n=l[V],fn=typeof _n=="string"?_n:void 0,ls=eu(A.role,V,fn),cs=me(A.generation),ds=ce(A.joined_at,A.joinedAt,A.started_at,A.startedAt),us=ce(A.claimed_at,A.claimedAt,A.assigned_at,A.assignedAt,A.assigned_time),ps=ce(A.last_seen,A.lastSeen,A.last_seen_at,A.lastSeenAt,A.last_active,A.lastActive),ms=ce(A.scene,A.current_scene,A.currentScene,A.world_scene,A.scene_name,A.sceneName),vs=ce(A.location,A.current_location,A.currentLocation,A.position,A.zone,A.area);return{id:V,name:k(A.name,V),role:ls,keeper:fn,archetype:k(A.archetype,""),persona:k(A.persona,""),portrait:k(A.portrait,"")||void 0,background:k(A.background,"")||void 0,traits:je(A.traits),skills:je(A.skills),stats_raw:nu(A),status:gt?"active":"dead",generation:cs,joined_at:ds||void 0,claimed_at:us||void 0,last_seen:ps||void 0,scene:ms||void 0,location:vs||void 0,inventory:je(A.inventory),notes:je(A.notes),relationships:Zd(A.relationships),stats:{hp:Je,max_hp:Te,mp:ft,max_mp:_t,level:K,xp:ze,strength:ke(A,"strength","str",10),dexterity:ke(A,"dexterity","dex",10),constitution:ke(A,"constitution","con",10),intelligence:ke(A,"intelligence","int",10),wisdom:ke(A,"wisdom","wis",10),charisma:ke(A,"charisma","cha",10)}}}),u=m.filter(V=>V.status!=="dead"),_=Qd(e,t),g={phase_open:Hs(c.phase_open,!0),min_points:B(c.min_points,3),window:k(c.window,"round_boundary_only"),last_opened_turn:typeof c.last_opened_turn=="number"?c.last_opened_turn:null,last_closed_turn:typeof c.last_closed_turn=="number"?c.last_closed_turn:null},h=Object.entries(p).map(([V,ee])=>{const A=v(ee)?ee:{};return{actor_id:V,score:B(A.score,0),last_reason:k(A.last_reason,"")||null,reasons:je(A.reasons)}}),b=m.reduce((V,ee)=>(V[ee.id]=ee.name,V),{}),$=t.map(V=>ru(V,b)),S=B(a.turn,1),C=k(a.phase,"round"),x=k(a.map,""),L=v(a.world)?a.world:{},T=x||k(L.ascii_map,k(L.map,"")),R=$.filter((V,ee)=>{const A=t[ee];if(!v(A))return!1;const Te=v(A.payload)?A.payload:{};return B(Te.turn,-1)===S}),M=(R.length>0?R:$).slice(-12),z=k(a.status,"active");return{session:{id:s,room:s,status:z==="ended"?"ended":z==="paused"?"paused":"active",round:S,actors:u,created_at:((Z=$[0])==null?void 0:Z.timestamp)??new Date().toISOString()},current_round:{round_number:S,phase:C,events:M,timestamp:((ie=$[$.length-1])==null?void 0:ie.timestamp)??new Date().toISOString()},map:T||void 0,join_gate:g,contribution_ledger:h,outcome:_,party:u,story_log:$,history:[]}}async function cu(e){const t=`?room_id=${encodeURIComponent(e)}`,n=await Q(`/api/v1/trpg/events${t}`);return Array.isArray(n.events)?n.events:[]}async function du(e){const t=`?room_id=${encodeURIComponent(e)}`,[n,s]=await Promise.all([Q(`/api/v1/trpg/state${t}`),cu(e)]);return lu(n,s,e)}function uu(e){return Oe("/api/v1/trpg/rounds/run",{room_id:e})}function pu(e){const t="".trim().toLowerCase();if(t)switch(t){case"discussion":case"discuss":case"party_discussion":case"player_discussion":case"action":case"dice":return"round";case"ended":return"end";default:return t}}function mu(e){const t={room_id:e.roomId,actor_id:e.actorId,action:e.action,stat_value:e.statValue,dc:e.dc};return e.rawD20!=null&&(t.raw_d20=e.rawD20),e.ruleModule&&(t.rule_module=e.ruleModule),Oe("/api/v1/trpg/dice/roll",t)}function vu(e,t){const n=pu();return Oe("/api/v1/trpg/turns/advance",{room_id:e,...n?{phase:n}:{}})}function _u(e,t){var a;const n=(a=t.idempotencyKey)==null?void 0:a.trim(),s={room_id:e};return t.actor_id&&t.actor_id.trim()&&(s.actor_id=t.actor_id.trim()),t.name&&t.name.trim()&&(s.name=t.name.trim()),t.role&&(s.role=t.role),t.archetype&&t.archetype.trim()&&(s.archetype=t.archetype.trim()),t.persona&&t.persona.trim()&&(s.persona=t.persona.trim()),t.portrait&&t.portrait.trim()&&(s.portrait=t.portrait.trim()),t.background&&t.background.trim()&&(s.background=t.background.trim()),t.hp!=null&&(s.hp=t.hp),t.max_hp!=null&&(s.max_hp=t.max_hp),t.alive!=null&&(s.alive=t.alive),Array.isArray(t.traits)&&t.traits.length>0&&(s.traits=t.traits),Array.isArray(t.skills)&&t.skills.length>0&&(s.skills=t.skills),Array.isArray(t.inventory)&&t.inventory.length>0&&(s.inventory=t.inventory),t.stats&&Object.keys(t.stats).length>0&&(s.stats=t.stats),n&&(s.idempotency_key=n),Oe("/api/v1/trpg/actors/spawn",s,n?{"Idempotency-Key":n}:void 0)}function fu(e,t,n){return Oe("/api/v1/trpg/actors/claim",{room_id:e,actor_id:t,keeper:n})}async function gu(e,t,n){const s=await ut("trpg.join.eligibility",{room_id:e,actor_id:t,...n?{keeper_name:n}:{}});return JSON.parse(s)}async function $u(e){const t=await ut("trpg.mid_join.request",e);return JSON.parse(t)}async function hu(e,t){await ut("masc_broadcast",{agent_name:e,message:t})}async function yu(e=40){return(await ut("masc_messages",{limit:e})).split(`
`).map(n=>n.trim()).filter(n=>n!=="")}async function bu(e,t=20){return ut("masc_task_history",{task_id:e,limit:t})}async function ku(e){const t=await ut("masc_debate_start",{topic:e});try{return JSON.parse(t)}catch{return null}}async function xu(e){return Ra("fetchDebateStatus",async()=>{const t=encodeURIComponent(e),n=await Q(`/api/v1/council/debates/${t}/summary`);if(!v(n))return null;const s=v(n.debate)?n.debate:n,a=k(s.id,"").trim(),o=k(s.topic,"").trim();return!a||!o?null:{debate:{id:a,topic:o,status:k(s.status,"open"),created_at:le(s.created_at_iso??s.created_at),closed_at:le(s.closed_at)},arguments:Array.isArray(n.arguments)?n.arguments.flatMap(l=>v(l)?[{index:B(l.index,0),agent:k(l.agent,"unknown"),position:k(l.position,"neutral"),content:k(l.content,""),evidence:je(l.evidence),reply_to:me(l.reply_to)??null,mentions:je(l.mentions),archetype:q(l.archetype),created_at:le(l.created_at)}]:[]):[],summary:{support_count:v(n.summary)?B(n.summary.support_count,0):B(n.support_count,0),oppose_count:v(n.summary)?B(n.summary.oppose_count,0):B(n.oppose_count,0),neutral_count:v(n.summary)?B(n.summary.neutral_count,0):B(n.neutral_count,0),total_arguments:v(n.summary)?B(n.summary.total_arguments,0):B(n.total_arguments,0),summary_text:v(n.summary)?k(n.summary.summary_text,""):k(n.summary_text,"")},context:Xi(n.context),judgment:Wr(n.judgment)}})}async function Su(e){return Ra("fetchConsensusSessionSummary",async()=>{const t=encodeURIComponent(e),n=await Q(`/api/v1/council/sessions/${t}/summary`);if(!v(n)||!v(n.session))return null;const s=n.session,a=k(s.id,"").trim(),o=k(s.topic,"").trim();return!a||!o?null:{session:{id:a,topic:o,state:k(s.state,"open"),initiator:k(s.initiator,"system"),quorum:B(s.quorum,0),threshold:B(s.threshold,0),created_at:le(s.created_at),closed_at:le(s.closed_at)},votes:Array.isArray(n.votes)?n.votes.flatMap(l=>v(l)?[{agent:k(l.agent,"unknown"),decision:k(l.decision,"abstain"),reason:k(l.reason,""),timestamp:le(l.timestamp),weight:typeof l.weight=="number"?l.weight:void 0,archetype:q(l.archetype)}]:[]):[],summary:{approve_count:v(n.summary)?B(n.summary.approve_count,0):0,reject_count:v(n.summary)?B(n.summary.reject_count,0):0,abstain_count:v(n.summary)?B(n.summary.abstain_count,0):0,quorum_met:v(n.summary)?Hs(n.summary.quorum_met,!1):!1,result:v(n.summary)?q(n.summary.result):null},context:Xi(n.context),judgment:Wr(n.judgment)}})}function Cu(e,t,n){return ut("masc_keeper_msg",{name:e,message:t})}const Au=f(""),He=f({}),de=f({}),bi=f({}),ki=f({}),xi=f({}),Si=f({}),We=f({});function re(e,t,n){e.value={...e.value,[t]:n}}function Iu(e){var n;const t=(n=r(e))==null?void 0:n.toLowerCase();return t==="user"||t==="assistant"||t==="system"||t==="tool"?t:"other"}function Tu(e){switch(e){case"user":return"User";case"assistant":return"Keeper";case"system":return"System";case"tool":return"Tool";default:return"Event"}}function Ka(e,t){if(!Array.isArray(e))return[];const n=[];for(const s of e){if(!v(s))continue;const a=r(s.name);if(!a)continue;const o=r(s[t]);t==="summary"?n.push({name:a,summary:o}):n.push({name:a,reason:o})}return n}function zu(e){if(!v(e))return null;const t=r(e.name);return t?{name:t,trigger:r(e.trigger),outcome:r(e.outcome),summary:r(e.summary),reason:r(e.reason)}:null}function Ru(e){const t=e.toLowerCase();return t.includes("graphql")?"graphql_error":t.includes("timeout")||t.includes("model")||t.includes("llm")||t.includes("api key")||t.includes("api_key")||t.includes("provider")?"llm_error":"unknown"}function Pu(e,t){return e==="offline"||e==="degraded"||e==="stale"?"Keeper is not in a healthy reply state. Probe or recover before relying on automation.":t==="quiet_hours"?"Lodge quiet hours are active. Direct messages still work, but scheduled social ticks may look asleep.":t==="min_gap"?"Keeper is inside its proactive cooldown window. Direct messages work now; autonomous check-ins will wait.":t==="never_started"?"Keeper metadata exists but no reply turn has been recorded yet.":"Keeper is reachable. Send a direct message for an immediate response."}function Jr(e,t,n){return r(e)??Pu(t,n)}function Vr(e,t){return typeof e=="boolean"?e:t==="recover"}function Ws(e){if(!v(e))return null;const t=r(e.health_state),n=r(e.next_action_path),s=r(e.last_reply_status);return!t||!n||!s?null:{health_state:t,quiet_reason:r(e.quiet_reason)??null,next_action_path:n,last_reply_status:s,last_reply_at:ae(e.last_reply_at)??null,last_reply_preview:r(e.last_reply_preview)??null,last_error:r(e.last_error)??null,next_eligible_at_s:d(e.next_eligible_at_s)??null,recoverable:Vr(e.recoverable,n),summary:Jr(e.summary,t,r(e.quiet_reason)??null),keepalive_running:typeof e.keepalive_running=="boolean"?e.keepalive_running:void 0}}function Yr(e){return v(e)?{hour:d(e.hour),checked:d(e.checked)??0,acted:d(e.acted)??0,acted_names:H(e.acted_names),activity_report:r(e.activity_report),quiet_hours_overridden:N(e.quiet_hours_overridden),skipped_reason:r(e.skipped_reason),acted_rows:Ka(e.acted_rows,"summary").map(t=>({name:t.name,summary:t.summary})),passed_rows:Ka(e.passed_rows,"reason").map(t=>({name:t.name,reason:t.reason})),skipped_rows:Ka(e.skipped_rows,"reason").map(t=>({name:t.name,reason:t.reason})),checkins:Array.isArray(e.checkins)?e.checkins.map(zu).filter(t=>t!==null):[]}:null}function Lu(e){return v(e)?{enabled:N(e.enabled)??!1,interval_s:d(e.interval_s)??0,quiet_start:d(e.quiet_start),quiet_end:d(e.quiet_end),quiet_active:N(e.quiet_active),use_planner:N(e.use_planner),delegate_llm:N(e.delegate_llm),agent_count:d(e.agent_count),agents:H(e.agents),last_tick_ago_s:d(e.last_tick_ago_s)??null,last_tick_ago:r(e.last_tick_ago),total_ticks:d(e.total_ticks),total_checkins:d(e.total_checkins),last_skip_reason:r(e.last_skip_reason)??null,last_tick_result:Yr(e.last_tick_result),active_self_heartbeats:H(e.active_self_heartbeats)}:null}function Mu(e){return v(e)?{status:e.status,diagnostic:Ws(e.diagnostic)}:null}function ju(e){return v(e)?{recovered:N(e.recovered)??!1,skipped_reason:r(e.skipped_reason)??null,before:Ws(e.before),after:Ws(e.after),down:e.down,up:e.up}:null}function Eu(e,t){var x,L;if(!(e!=null&&e.name))return null;const n=r((x=e.agent)==null?void 0:x.status)??r(e.status)??"unknown",s=r((L=e.agent)==null?void 0:L.error)??null,a=e.presence_keepalive??!0,o=e.keepalive_running??!1,l=e.turn_count??0,c=e.last_turn_ago_s??null,p=e.proactive_enabled??!1,m=e.proactive_cooldown_sec??0,u=e.last_proactive_ago_s??null,_=p&&u!=null?Math.max(0,m-u):null,g=l<=0||c==null?"never":c>900?"stale":"fresh",h=typeof e.last_heartbeat=="string"&&e.last_heartbeat.trim()?e.last_heartbeat:null,b=s??(a&&!o?"keeper keepalive is not running":null),$=n==="offline"||n==="inactive"?"offline":b?"degraded":g==="stale"?"stale":g==="never"?"idle":"healthy",S=b?Ru(b):t!=null&&t.quiet_active&&g!=="fresh"?"quiet_hours":a&&!o?"disabled":l<=0?"never_started":_!=null&&_>0?"min_gap":g==="fresh"||g==="stale"?"no_recent_activity":"unknown",C=$==="offline"||$==="degraded"||$==="stale"?"recover":S==="quiet_hours"?"manual_lodge_poke":S==="unknown"?"probe":"direct_message";return{health_state:$,quiet_reason:S,next_action_path:C,last_reply_status:g,last_reply_at:h,last_reply_preview:null,last_error:b,next_eligible_at_s:_!=null&&_>0?_:null,recoverable:Vr(void 0,C),summary:Jr(void 0,$,S),keepalive_running:o}}function Nu(e,t){if(!v(e))return null;const n=Iu(e.role),s=r(e.content)??r(e.preview);if(!s)return null;const a=ae(e.ts_unix)??ae(e.timestamp);return{id:`${n}-${a??"entry"}-${t}`,role:n,label:Tu(n),text:s,timestamp:a,delivery:"history"}}function wu(e,t,n){const s=v(n)?n:null,a=Array.isArray(s==null?void 0:s.history_tail)?s.history_tail.map((o,l)=>Nu(o,l)).filter(o=>o!==null):[];return{name:e,diagnostic:Ws(s==null?void 0:s.diagnostic),history:a,rawText:t,rawStatus:n,loadedAt:new Date().toISOString()}}function Oo(e,t){const n=de.value[e]??[];de.value={...de.value,[e]:[...n,t].slice(-50)}}function Du(e,t){return e.role!==t.role||e.text!==t.text?!1:e.timestamp&&t.timestamp?e.timestamp===t.timestamp:!0}function Ou(e,t){const s=(de.value[e]??[]).filter(a=>a.delivery!=="history"&&!t.some(o=>Du(a,o)));de.value={...de.value,[e]:[...t,...s].slice(-50)}}function La(e,t){He.value={...He.value,[e]:t},Ou(e,t.history)}function qo(e,t){const n=He.value[e];if(!n)return;const s=n.diagnostic??{health_state:"idle",next_action_path:"direct_message",last_reply_status:"unknown"};La(e,{...n,diagnostic:{...s,...t}})}async function Qi(){try{await es()}catch(e){console.warn("[keeper-runtime] dashboard refresh failed",e)}}function qu(e){Au.value=e.trim()}async function Xr(e,t=!1){const n=e.trim();if(!n)return null;if(!t&&He.value[n])return He.value[n];re(bi,n,!0),re(We,n,null);try{const s=await ut("masc_keeper_status",{name:n,fast:!1,include_context:!0,include_metrics_overview:!0,include_memory_bank:!1,include_history_tail:!0,include_compaction_history:!1,tail_turns:5,tail_messages:10});let a=null;try{a=JSON.parse(s)}catch{a=null}const o=wu(n,s,a);return La(n,o),o}catch(s){const a=s instanceof Error?s.message:`Failed to inspect ${n}`;return re(We,n,a),null}finally{re(bi,n,!1)}}async function Fu(e,t){const n=e.trim(),s=t.trim();if(!n||!s)return;const a=`local-${Date.now()}`;Oo(n,{id:a,role:"user",label:"You",text:s,timestamp:new Date().toISOString(),delivery:"sending"}),re(ki,n,!0),re(We,n,null);try{const o=await Cu(n,s);de.value={...de.value,[n]:(de.value[n]??[]).map(l=>l.id===a?{...l,delivery:"delivered"}:l)},Oo(n,{id:`reply-${Date.now()}`,role:"assistant",label:n,text:o.trim()||"(empty reply)",timestamp:new Date().toISOString(),delivery:"delivered"}),qo(n,{last_reply_status:"delivered",last_reply_at:new Date().toISOString(),last_reply_preview:(o.trim()||"(empty reply)").slice(0,200),last_error:null}),await Qi()}catch(o){const l=o instanceof Error?o.message:`Failed to send direct message to ${n}`;throw de.value={...de.value,[n]:(de.value[n]??[]).map(c=>c.id===a?{...c,delivery:"error",error:l}:c)},qo(n,{last_reply_status:"error",last_error:l}),re(We,n,l),o}finally{re(ki,n,!1)}}async function Ku(e,t){const n=e.trim();if(!n)return null;re(xi,n,!0),re(We,n,null);try{const s=await Pa({actor:t,action_type:"keeper_probe",target_type:"keeper",target_id:n,payload:{}}),a=Mu(s.result),o=(a==null?void 0:a.diagnostic)??null;if(o){const l=He.value[n];La(n,{name:n,diagnostic:o,history:(l==null?void 0:l.history)??de.value[n]??[],rawText:(l==null?void 0:l.rawText)??"",rawStatus:s.result,loadedAt:new Date().toISOString()})}return await Qi(),o}catch(s){const a=s instanceof Error?s.message:`Failed to probe ${n}`;throw re(We,n,a),s}finally{re(xi,n,!1)}}async function Bu(e,t){const n=e.trim();if(!n)return null;re(Si,n,!0),re(We,n,null);try{const s=await Pa({actor:t,action_type:"keeper_recover",target_type:"keeper",target_id:n,payload:{}}),a=ju(s.result),o=(a==null?void 0:a.after)??null;if(o){const l=He.value[n];La(n,{name:n,diagnostic:o,history:(l==null?void 0:l.history)??de.value[n]??[],rawText:(l==null?void 0:l.rawText)??"",rawStatus:s.result,loadedAt:new Date().toISOString()})}return await Qi(),o}catch(s){const a=s instanceof Error?s.message:`Failed to recover ${n}`;throw re(We,n,a),s}finally{re(Si,n,!1)}}function $t(e){return(e??"").trim().toLowerCase()}function fe(e){const t=typeof e=="number"?e:Date.parse(e);return Number.isNaN(t)?0:t}function Ps(e,t=88){const n=e.replace(/\s+/g," ").trim();return n&&(n.length>t?`${n.slice(0,t-3)}...`:n)}function fs(e){return typeof e!="number"||!Number.isFinite(e)||e<0?null:new Date(Date.now()-e*1e3).toISOString()}function gn(e){return e.last_heartbeat??fs(e.last_turn_ago_s)??fs(e.last_proactive_ago_s)??fs(e.last_handoff_ago_s)??fs(e.last_compaction_ago_s)}function Uu(e){const t=e.title.trim();return t||Ps(e.content)}function Hu(e){const t=e.generation??"?",n=typeof e.context_ratio=="number"&&Number.isFinite(e.context_ratio)?`${Math.round(e.context_ratio*100)}%`:"?";return e.last_heartbeat?`Heartbeat gen=${t} ctx=${n}`:`Keeper snapshot gen=${t} ctx=${n}`}function Wu(e,t,n,s,a={}){var L;const o=$t(e),l=t.filter(T=>$t(T.assignee)===o&&(T.status==="claimed"||T.status==="in_progress")).length,c=n.filter(T=>$t(T.from)===o).sort((T,R)=>fe(R.timestamp)-fe(T.timestamp))[0],p=s.filter(T=>$t(T.agent)===o||$t(T.author)===o).sort((T,R)=>fe(R.timestamp)-fe(T.timestamp))[0],m=(a.boardPosts??[]).filter(T=>$t(T.author)===o).sort((T,R)=>fe(R.updated_at||R.created_at)-fe(T.updated_at||T.created_at))[0],u=(a.keepers??[]).filter(T=>$t(T.name)===o&&gn(T)!==null).sort((T,R)=>fe(gn(R)??0)-fe(gn(T)??0))[0],_=c?fe(c.timestamp):0,g=p?fe(p.timestamp):0,h=m?fe(m.updated_at||m.created_at):0,b=u?fe(gn(u)??0):0,$=a.lastSeen?fe(a.lastSeen):0,S=((L=a.currentTask)==null?void 0:L.trim())||(l>0?`${l} claimed tasks`:null);if(_===0&&g===0&&h===0&&b===0&&$===0)return{activeAssignedCount:l,lastActivityAt:null,lastActivityText:S};const x=[c?{timestamp:c.timestamp,ts:_,text:Ps(c.content)}:null,m?{timestamp:m.updated_at||m.created_at,ts:h,text:`Post: ${Ps(Uu(m))}`}:null,u?{timestamp:gn(u),ts:b,text:Hu(u)}:null,p?{timestamp:new Date(p.timestamp).toISOString(),ts:g,text:Ps(p.text)}:null].filter(T=>T!==null).sort((T,R)=>R.ts-T.ts)[0];return x&&x.ts>=$?{activeAssignedCount:l,lastActivityAt:x.timestamp,lastActivityText:x.text}:{activeAssignedCount:l,lastActivityAt:a.lastSeen??null,lastActivityText:S??"Presence heartbeat"}}const Ge=f([]),et=f([]),Ci=f([]),pt=f([]),te=f(null),Gu=f(null),Qr=f(null),Zr=f([]),el=f([]),tl=f([]),nl=f([]),sl=f([]),al=f([]),Ai=f(new Map),Ma=f([]),jn=f("recent"),St=f(!0),il=f(null),Ue=f(""),Jt=f([]),xn=f(!1),ol=f(new Map),Zi=f("unknown"),Vt=f(null),Ii=f(!1),En=f(!1),Ti=f(!1),Sn=f(!1),eo=f(null),Gs=f(!1),Js=f(null),rl=f(null),zi=f(null),Ju=f(null),Vu=f(null),Yu=f(null);Ie(()=>Ge.value.filter(e=>e.status==="active"||e.status==="busy"||e.status==="listening"||e.status==="idle"));const ll=Ie(()=>{const e=et.value;return{todo:e.filter(t=>t.status==="todo"),inProgress:e.filter(t=>t.status==="in_progress"||t.status==="claimed"),done:e.filter(t=>t.status==="done")}}),cl=Ie(()=>{const e=new Map,t=et.value,n=Ci.value,s=Us.value,a=Ma.value,o=pt.value;for(const l of Ge.value)e.set(l.name.trim().toLowerCase(),Wu(l.name,t,n,s,{currentTask:l.current_task,lastSeen:l.last_seen,boardPosts:a,keepers:o}));return e});function Xu(e){var o;const t=((o=e.status)==null?void 0:o.toLowerCase())??"";if(t==="offline"||t==="inactive")return"offline";const n=e.metrics_series;if(!n||n.length===0)return"idle";const s=n[n.length-1];if(!s)return"idle";if(s.is_handoff)return"handoff-imminent";if(s.is_compaction)return"compacting";const a=s.context_ratio;return a>.85?"handoff-imminent":a>.7?"preparing":a>.5?"compacting":"active"}Ie(()=>{const e=new Map;for(const t of pt.value)e.set(t.name,Xu(t));return e});const Qu=12e4;function Zu(e,t){const n=t.get(e.name);if(n!=null)return n;const s=e.last_heartbeat?Date.parse(e.last_heartbeat):Number.NaN;if(!Number.isNaN(s))return s;const a=[e.last_turn_ago_s,e.last_proactive_ago_s,e.last_handoff_ago_s,e.last_compaction_ago_s].find(o=>typeof o=="number"&&Number.isFinite(o)&&o>=0);return typeof a=="number"?Date.now()-a*1e3:null}Ie(()=>{const e=Date.now(),t=new Set,n=Ai.value;for(const s of pt.value){const a=Zu(s,n);a!=null&&e-a>Qu&&t.add(s.name)}return t});function ep(e){return e==="dashboard_refresh"||e==="masc/dashboard_refresh"||e.startsWith("goal_")||e.startsWith("masc/goal_")||e.startsWith("mdal_")||e.startsWith("masc/mdal_")||e.startsWith("operator_")||e.startsWith("masc/operator_")||e.startsWith("command_plane_")||e.startsWith("masc/command_plane_")}function dl(e){const t=typeof e=="string"?e.toLowerCase():"";return t==="active"||t==="busy"||t==="listening"||t==="idle"||t==="inactive"||t==="offline"?t:t==="in_progress"||t==="claimed"?"busy":"offline"}function tp(e){const t=typeof e=="string"?e.toLowerCase():"";return t==="todo"||t==="in_progress"||t==="claimed"||t==="done"||t==="cancelled"?t:t==="inprogress"?"in_progress":"todo"}function np(e){if(!v(e))return null;const t=r(e.name);return t?{name:t,agent_type:r(e.agent_type),status:dl(e.status),current_task:r(e.current_task)??null,joined_at:r(e.joined_at),last_seen:r(e.last_seen),capabilities:H(e.capabilities),emoji:r(e.emoji),koreanName:r(e.koreanName)??r(e.korean_name),model:r(e.model),traits:H(e.traits),interests:H(e.interests),activityLevel:d(e.activityLevel)??d(e.activity_level),primaryValue:r(e.primaryValue)??r(e.primary_value)}:null}function sp(e){if(!v(e))return null;const t=r(e.id),n=r(e.title);return!t||!n?null:{id:t,title:n,status:tp(e.status),priority:d(e.priority),assignee:r(e.assignee),description:r(e.description),created_at:r(e.created_at),updated_at:r(e.updated_at)}}function ap(e){if(!v(e))return null;const t=r(e.from)??r(e.from_agent)??"system",n=r(e.content)??"",s=r(e.timestamp)??new Date().toISOString();return{id:r(e.id),seq:d(e.seq),from:t,content:n,timestamp:s,type:r(e.type)}}function to(e){const t=typeof e=="string"?e.toLowerCase():"";return t==="ok"||t==="warn"||t==="bad"?t:"ok"}function ip(e){return v(e)?{active_sessions:d(e.active_sessions),blocked_sessions:d(e.blocked_sessions),active_operations:d(e.active_operations),blocked_operations:d(e.blocked_operations),runtime_pressure:d(e.runtime_pressure),worker_alerts:d(e.worker_alerts),continuity_alerts:d(e.continuity_alerts),priority_items:d(e.priority_items),todo_tasks:d(e.todo_tasks),claimed_tasks:d(e.claimed_tasks),running_tasks:d(e.running_tasks),done_tasks:d(e.done_tasks),cancelled_tasks:d(e.cancelled_tasks),keepers:d(e.keepers)}:null}function tt(e){if(!v(e))return null;const t=r(e.surface),n=r(e.label),s=r(e.target_type),a=r(e.target_id),o=r(e.focus_kind);return!t||!n||!s||!a||!o?null:{surface:t==="command"?"command":"intervene",label:n,target_type:s,target_id:a,focus_kind:o,operation_id:r(e.operation_id)??null,command_surface:r(e.command_surface)??null}}function op(e){if(!v(e))return null;const t=r(e.id),n=r(e.kind),s=r(e.summary),a=r(e.target_type),o=r(e.target_id);return!t||!s||!a||!o||n!=="session"&&n!=="operation"?null:{id:t,kind:n,severity:to(e.severity),status:r(e.status),summary:s,target_type:a,target_id:o,linked_session_id:r(e.linked_session_id)??null,linked_operation_id:r(e.linked_operation_id)??null,last_seen_at:r(e.last_seen_at)??null,top_handoff:tt(e.top_handoff),intervene_handoff:tt(e.intervene_handoff),command_handoff:tt(e.command_handoff)}}function rp(e){if(!v(e))return null;const t=r(e.session_id),n=r(e.goal);return!t||!n?null:{session_id:t,goal:n,room:r(e.room)??null,status:r(e.status),health:r(e.health),member_names:H(e.member_names),linked_operation_id:r(e.linked_operation_id)??null,linked_detachment_id:r(e.linked_detachment_id)??null,runtime_blocker:r(e.runtime_blocker)??null,worker_gap_summary:r(e.worker_gap_summary)??null,last_activity_at:r(e.last_activity_at)??null,last_activity_summary:r(e.last_activity_summary)??null,communication_summary:r(e.communication_summary)??null,active_count:d(e.active_count),required_count:d(e.required_count),top_handoff:tt(e.top_handoff),intervene_handoff:tt(e.intervene_handoff),command_handoff:tt(e.command_handoff)}}function lp(e){if(!v(e))return null;const t=r(e.operation_id),n=r(e.objective);return!t||!n?null:{operation_id:t,objective:n,status:r(e.status),stage:r(e.stage)??null,assigned_unit_id:r(e.assigned_unit_id)??null,assigned_unit_label:r(e.assigned_unit_label)??null,linked_session_id:r(e.linked_session_id)??null,linked_detachment_id:r(e.linked_detachment_id)??null,blocker_summary:r(e.blocker_summary)??null,search_status:r(e.search_status)??null,next_tool:r(e.next_tool)??null,updated_at:r(e.updated_at)??null,top_handoff:tt(e.top_handoff),command_handoff:tt(e.command_handoff)}}function Fo(e){if(!v(e))return null;const t=r(e.name)??r(e.agent_name),n=r(e.note),s=r(e.focus),a=r(e.state);return!t||!n||!s||a!=="working"&&a!=="watching"&&a!=="quiet"&&a!=="offline"?null:{name:t,agent_name:r(e.agent_name),status:r(e.status),tone:to(e.tone),state:a,note:n,focus:s,last_signal_at:r(e.last_signal_at)??null,active_task_count:d(e.active_task_count),related_session_id:r(e.related_session_id)??null,related_operation_id:r(e.related_operation_id)??null,emoji:r(e.emoji),korean_name:r(e.korean_name),model:r(e.model)??null,recent_output_preview:r(e.recent_output_preview)??null,recent_event:r(e.recent_event)??null}}function cp(e){if(!v(e))return null;const t=r(e.name),n=r(e.note),s=r(e.focus),a=r(e.state);return!t||!n||!s||a!=="healthy"&&a!=="warning"&&a!=="critical"?null:{name:t,agent_name:r(e.agent_name)??null,status:r(e.status),tone:to(e.tone),state:a,note:n,focus:s,last_signal_at:r(e.last_signal_at)??null,last_autonomous_action_at:r(e.last_autonomous_action_at)??null,generation:d(e.generation),turn_count:d(e.turn_count),context_ratio:d(e.context_ratio)??null,continuity:r(e.continuity)??null,lifecycle:r(e.lifecycle)??null,related_session_id:r(e.related_session_id)??null,model:r(e.model)??null,emoji:r(e.emoji),korean_name:r(e.korean_name),skill_reason:r(e.skill_reason)??null}}function Ko(e){if(typeof e.seq=="number"&&Number.isFinite(e.seq))return e.seq;const t=Date.parse(e.timestamp);return Number.isNaN(t)?0:t}function dp(e,t){if(t.length===0)return e;const n=new Map;for(const s of e){const a=typeof s.seq=="number"?`seq:${s.seq}`:`ts:${s.timestamp}|from:${s.from}|content:${s.content}`;n.set(a,s)}for(const s of t){const a=typeof s.seq=="number"?`seq:${s.seq}`:`ts:${s.timestamp}|from:${s.from}|content:${s.content}`;n.set(a,s)}return[...n.values()].sort((s,a)=>Ko(s)-Ko(a)).slice(-500)}function up(e){return Array.isArray(e)?e.map(t=>{if(!v(t))return null;const n=d(t.ts_unix);if(n==null)return null;const s=v(t.handoff)?t.handoff:null;return{ts:n,context_ratio:d(t.context_ratio)??0,context_tokens:d(t.context_tokens)??0,context_max:d(t.context_max)??0,latency_ms:d(t.latency_ms)??0,generation:d(t.generation)??0,channel:typeof t.channel=="string"?t.channel:"turn",is_handoff:s!=null&&t.handoff_performed===!0,is_compaction:t.compacted===!0,compaction_saved_tokens:d(t.compaction_saved_tokens)??0,compaction_trigger:typeof t.compaction_trigger=="string"?t.compaction_trigger:null,model_used:typeof t.model_used=="string"?t.model_used:"",cost_usd:d(t.cost_usd)??0,handoff_to_model:s&&typeof s.to_model=="string"?s.to_model:null,handoff_new_generation:s?d(s.new_generation)??null:null}}).filter(t=>t!==null):[]}function Bo(e){if(!v(e))return null;const t=r(e.health_state),n=r(e.next_action_path),s=r(e.last_reply_status);if(!t||!n||!s)return null;const a=r(e.quiet_reason)??null,o=r(e.summary)??(t==="offline"||t==="degraded"||t==="stale"?"Keeper is not in a healthy reply state. Probe or recover before relying on automation.":a==="quiet_hours"?"Lodge quiet hours are active. Direct messages still work, but scheduled social ticks may look asleep.":a==="min_gap"?"Keeper is inside its proactive cooldown window. Direct messages work now; autonomous check-ins will wait.":a==="never_started"?"Keeper metadata exists but no reply turn has been recorded yet.":"Keeper is reachable. Send a direct message for an immediate response.");return{health_state:t,quiet_reason:a,next_action_path:n,last_reply_status:s,last_reply_at:ae(e.last_reply_at)??r(e.last_reply_at)??null,last_reply_preview:r(e.last_reply_preview)??null,last_error:r(e.last_error)??null,next_eligible_at_s:d(e.next_eligible_at_s)??null,recoverable:typeof e.recoverable=="boolean"?e.recoverable:n==="recover",summary:o,keepalive_running:typeof e.keepalive_running=="boolean"?e.keepalive_running:void 0}}function pp(e,t){return(Array.isArray(e)?e:v(e)&&Array.isArray(e.keepers)?e.keepers:[]).map(s=>{if(!v(s))return null;const a=v(s.agent)?s.agent:null,o=v(s.context)?s.context:null,l=v(s.metrics_window)?s.metrics_window:void 0,c=r(s.name);if(!c)return null;const p=d(s.context_ratio)??d(o==null?void 0:o.context_ratio),m=r(s.status)??r(a==null?void 0:a.status)??"offline",u=dl(m),_=r(s.model)??r(s.active_model)??r(s.primary_model),g=H(s.skill_secondary),h=o?{source:r(o.source),context_ratio:d(o.context_ratio),context_tokens:d(o.context_tokens),context_max:d(o.context_max),message_count:d(o.message_count),has_checkpoint:typeof o.has_checkpoint=="boolean"?o.has_checkpoint:void 0}:void 0,b=a?{name:r(a.name),exists:typeof a.exists=="boolean"?a.exists:void 0,error:r(a.error),agent_type:r(a.agent_type),status:r(a.status),current_task:r(a.current_task)??null,joined_at:r(a.joined_at),last_seen:r(a.last_seen),last_seen_ago_s:d(a.last_seen_ago_s),capabilities:H(a.capabilities),is_zombie:typeof a.is_zombie=="boolean"?a.is_zombie:void 0}:void 0,$=up(s.metrics_series),S={name:c,runtime_class:s.runtime_class==="persistent_agent"?"persistent_agent":"resident_keeper",desired:typeof s.desired=="boolean"?s.desired:void 0,resident_registered:typeof s.resident_registered=="boolean"?s.resident_registered:void 0,reconcile_status:r(s.reconcile_status)??null,emoji:r(s.emoji),koreanName:r(s.koreanName)??r(s.korean_name),agent_name:r(s.agent_name),trace_id:r(s.trace_id),model:_,primary_model:r(s.primary_model),active_model:r(s.active_model),next_model_hint:r(s.next_model_hint)??null,status:u,presence_keepalive:typeof s.presence_keepalive=="boolean"?s.presence_keepalive:void 0,presence_keepalive_sec:d(s.presence_keepalive_sec),keepalive_running:typeof s.keepalive_running=="boolean"?s.keepalive_running:void 0,proactive_enabled:typeof s.proactive_enabled=="boolean"?s.proactive_enabled:void 0,proactive_idle_sec:d(s.proactive_idle_sec),proactive_cooldown_sec:d(s.proactive_cooldown_sec),last_heartbeat:r(s.last_heartbeat)??r(a==null?void 0:a.last_seen),generation:d(s.generation),turn_count:d(s.turn_count)??d(s.total_turns),keeper_age_s:d(s.keeper_age_s),last_turn_ago_s:d(s.last_turn_ago_s),last_handoff_ago_s:d(s.last_handoff_ago_s),last_compaction_ago_s:d(s.last_compaction_ago_s),last_proactive_ago_s:d(s.last_proactive_ago_s),last_proactive_preview:r(s.last_proactive_preview)??null,context_ratio:p,context_tokens:d(s.context_tokens)??d(o==null?void 0:o.context_tokens),context_max:d(s.context_max)??d(o==null?void 0:o.context_max),context_source:r(s.context_source)??r(o==null?void 0:o.source),context:h,traits:H(s.traits),interests:H(s.interests),primaryValue:r(s.primaryValue)??r(s.primary_value),activityLevel:d(s.activityLevel)??d(s.activity_level),memory_recent_note:r(s.memory_recent_note)??null,recent_input_preview:r(s.recent_input_preview)??null,recent_output_preview:r(s.recent_output_preview)??null,recent_tool_names:H(s.recent_tool_names)??[],conversation_tail_count:d(s.conversation_tail_count),k2k_count:d(s.k2k_count),handoff_count_total:d(s.handoff_count_total)??d(s.trace_history_count),compaction_count:d(s.compaction_count),last_compaction_saved_tokens:d(s.last_compaction_saved_tokens),diagnostic:Bo(s.diagnostic),skill_primary:r(s.skill_primary)??null,skill_secondary:g,skill_reason:r(s.skill_reason)??null,metrics_series:$.length>0?$:void 0,metrics_window:l,agent:b};return S.diagnostic=Bo(s.diagnostic)??Eu(S,(t==null?void 0:t.lodge)??null),S}).filter(s=>s!==null)}function mp(e){if(!v(e))return;const t=r(e.release_version),n=ae(e.started_at),s=d(e.uptime_seconds);if(!(!t||!n||s==null))return{release_version:t,commit:r(e.commit)??null,started_at:n,uptime_seconds:s}}function vp(e){if(v(e))return{enabled:e.enabled===!0,alive:e.alive===!0,status:r(e.status)??void 0,tick_in_progress:typeof e.tick_in_progress=="boolean"?e.tick_in_progress:void 0,tick_count:d(e.tick_count)??void 0,check_interval_sec:d(e.check_interval_sec)??void 0,last_tick_started_at:ae(e.last_tick_started_at)??r(e.last_tick_started_at)??null,last_tick_completed_at:ae(e.last_tick_completed_at)??r(e.last_tick_completed_at)??null,next_tick_due_at:ae(e.next_tick_due_at)??r(e.next_tick_due_at)??null,last_health_check_at:ae(e.last_health_check_at)??r(e.last_health_check_at)??null,last_intervention:r(e.last_intervention)??void 0,last_decision_source:r(e.last_decision_source)??void 0,last_action:r(e.last_action)??void 0,last_target:r(e.last_target)??null,last_reason:r(e.last_reason)??null,last_error:r(e.last_error)??null,circuit_open:typeof e.circuit_open=="boolean"?e.circuit_open:void 0,circuit_open_until:ae(e.circuit_open_until)??r(e.circuit_open_until)??null,can_spawn:typeof e.can_spawn=="boolean"?e.can_spawn:void 0,can_retire:typeof e.can_retire=="boolean"?e.can_retire:void 0,last_spawn_attempt_at:ae(e.last_spawn_attempt_at)??r(e.last_spawn_attempt_at)??null,last_retirement_attempt_at:ae(e.last_retirement_attempt_at)??r(e.last_retirement_attempt_at)??null,spawns_today:d(e.spawns_today)??void 0,retirements_today:d(e.retirements_today)??void 0,health_summary:v(e.health_summary)?{total_agents:d(e.health_summary.total_agents)??void 0,active_agents:d(e.health_summary.active_agents)??void 0,idle_agents:d(e.health_summary.idle_agents)??void 0,todo_count:d(e.health_summary.todo_count)??void 0,high_priority_todo:d(e.health_summary.high_priority_todo)??void 0,orphan_count:d(e.health_summary.orphan_count)??void 0,homeostatic_score:d(e.health_summary.homeostatic_score)??void 0,needs_workers:typeof e.health_summary.needs_workers=="boolean"?e.health_summary.needs_workers:void 0}:void 0}}function _p(e){if(v(e))return{enabled:e.enabled===!0,mode:r(e.mode)??void 0,masc_enabled:typeof e.masc_enabled=="boolean"?e.masc_enabled:void 0,masc_loops_running:typeof e.masc_loops_running=="boolean"?e.masc_loops_running:void 0,runtime_owner:r(e.runtime_owner)??null,zombie_loop_running:typeof e.zombie_loop_running=="boolean"?e.zombie_loop_running:void 0,gc_loop_running:typeof e.gc_loop_running=="boolean"?e.gc_loop_running:void 0,lodge_enabled:typeof e.lodge_enabled=="boolean"?e.lodge_enabled:void 0,lodge_loop_started:typeof e.lodge_loop_started=="boolean"?e.lodge_loop_started:void 0,lodge_running:typeof e.lodge_running=="boolean"?e.lodge_running:void 0,last_zombie_cleanup:ae(e.last_zombie_cleanup)??r(e.last_zombie_cleanup)??null,last_gc:ae(e.last_gc)??r(e.last_gc)??null,last_lodge:ae(e.last_lodge)??r(e.last_lodge)??null,last_zombie_result:r(e.last_zombie_result)??null,last_gc_result:r(e.last_gc_result)??null,last_lodge_result:v(e.last_lodge_result)?{ok:typeof e.last_lodge_result.ok=="boolean"?e.last_lodge_result.ok:void 0,message:r(e.last_lodge_result.message)??void 0}:null}}function fp(e){if(v(e))return{enabled:e.enabled===!0,started:e.started===!0,agent_name:r(e.agent_name)??null,llm_enabled:typeof e.llm_enabled=="boolean"?e.llm_enabled:void 0,uptime_s:d(e.uptime_s)??void 0,embedded_guardian_loops_running:typeof e.embedded_guardian_loops_running=="boolean"?e.embedded_guardian_loops_running:void 0,guardian_runtime_owner:r(e.guardian_runtime_owner)??null,consumers:H(e.consumers)}}function ul(e,t){return v(e)?{...e,generated_at:t??ae(e.generated_at)??void 0,build:mp(e.build),lodge:Lu(e.lodge)??void 0,gardener:vp(e.gardener)??void 0,guardian:_p(e.guardian)??void 0,sentinel:fp(e.sentinel)??void 0}:null}function pl(e,t){return t?e?{...e,...t,build:t.build??e.build,generated_at:t.generated_at??e.generated_at}:t:e}function gp(e){const t=typeof e=="string"?e.toLowerCase():"";return t==="running"||t==="interrupted"||t==="completed"||t==="stopped"||t==="error"?t:t.startsWith("error")?"error":"running"}function $p(e){if(!v(e))return null;const t=d(e.iteration);if(t==null)return null;const n=d(e.metric_before)??0,s=d(e.metric_after)??n,a=v(e.evidence)?e.evidence:null;return{iteration:t,metric_before:n,metric_after:s,delta:d(e.delta)??s-n,changes:r(e.changes)??"",failed_attempts:r(e.failed_attempts)??"",next_suggestion:r(e.next_suggestion)??"",elapsed_ms:d(e.elapsed_ms)??0,cost_usd:d(e.cost_usd)??null,evidence:a?{worker_engine:(a.worker_engine==="api_tool_loop","api_tool_loop"),worker_model:r(a.worker_model)??"",tool_call_count:d(a.tool_call_count)??0,tool_names:H(a.tool_names)??[],session_id:r(a.session_id)??"",evidence_status:a.evidence_status==="legacy_unverified"?"legacy_unverified":"verified"}:null}}function hp(e){var o,l;if(!v(e))return null;const t=r(e.loop_id);if(!t)return null;const n=d(e.baseline_metric)??0,s=Array.isArray(e.history)?e.history.map($p).filter(c=>c!==null):[],a=d(e.current_metric)??((o=s[0])==null?void 0:o.metric_after)??n;return{loop_id:t,profile:r(e.profile)??"unknown",status:gp(e.status),strict_mode:typeof e.strict_mode=="boolean"?e.strict_mode:void 0,error_message:r(e.error_message)??r(e.error_reason)??null,stop_reason:r(e.stop_reason)??r(e.reason)??null,current_iteration:d(e.current_iteration)??((l=s[0])==null?void 0:l.iteration)??0,max_iterations:d(e.max_iterations)??0,baseline_metric:n,current_metric:a,target:r(e.target)??"",stagnation_streak:d(e.stagnation_streak)??0,stagnation_limit:d(e.stagnation_limit)??0,elapsed_seconds:d(e.elapsed_seconds)??0,updated_at:ae(e.updated_at)??null,stopped_at:ae(e.stopped_at)??null,execution_mode:e.execution_mode==="worker_spawn"?"worker_spawn":void 0,worker_engine:e.worker_engine==="api_tool_loop"?"api_tool_loop":null,worker_model:r(e.worker_model)??null,evidence_policy:e.evidence_policy==="hard"||e.evidence_policy==="legacy"?e.evidence_policy:void 0,latest_tool_call_count:d(e.latest_tool_call_count)??0,latest_tool_names:H(e.latest_tool_names)??[],session_id:r(e.session_id)??null,evidence_status:e.evidence_status==="legacy_unverified"?"legacy_unverified":e.evidence_status==="verified"?"verified":null,durability:e.durability==="persistent_backend"||e.durability==="memory_only"?e.durability:void 0,persistence_backend:e.persistence_backend==="filesystem"||e.persistence_backend==="postgres"||e.persistence_backend==="memory"?e.persistence_backend:void 0,recoverable:typeof e.recoverable=="boolean"?e.recoverable:void 0,history:s}}async function es(){Ii.value=!0;try{await Promise.all([vl(),Ct()]),rl.value=new Date().toISOString()}catch(e){console.error("Dashboard refresh error:",e)}finally{Ii.value=!1}}async function ml(){Gs.value=!0,Js.value=null;try{const e=await Cd();eo.value=e,Yu.value=new Date().toISOString()}catch(e){Js.value=e instanceof Error?e.message:"Failed to load dashboard semantics"}finally{Gs.value=!1}}function yp(e){var t;return((t=eo.value)==null?void 0:t.surfaces.find(n=>n.id===e))??null}function bp(e){var n;const t=((n=eo.value)==null?void 0:n.surfaces)??[];for(const s of t){const a=s.panels.find(o=>o.id===e);if(a)return a}return null}function kp(e){var s,a;Jt.value=(Array.isArray(e.goals)?e.goals:[]).map(o=>{if(!v(o))return null;const l=r(o.id),c=r(o.title),p=r(o.horizon),m=r(o.status),u=r(o.created_at),_=r(o.updated_at);return!l||!c||!p||!m||!u||!_?null:{id:l,horizon:p,title:c,metric:r(o.metric)??null,target_value:r(o.target_value)??null,due_date:r(o.due_date)??null,priority:d(o.priority)??3,status:m,parent_goal_id:r(o.parent_goal_id)??null,last_review_note:r(o.last_review_note)??null,last_review_at:r(o.last_review_at)??null,created_at:u,updated_at:_}}).filter(o=>o!==null);const t=new Map,n=Array.isArray((s=e.mdal)==null?void 0:s.loops)?e.mdal.loops:[];for(const o of n){const l=hp(o);l&&t.set(l.loop_id,l)}ol.value=t,Vt.value=typeof((a=e.mdal)==null?void 0:a.error)=="string"?e.mdal.error:null,Zi.value=Vt.value?"error":t.size===0?"idle":"ready"}async function vl(){try{const e=await bd(),t=ul(e.status,e.generated_at);t&&(te.value=pl(te.value,t))}catch(e){console.error("Dashboard shell fetch error:",e)}}async function Ct(){var e;try{const t=await kd(),n=ul(t.status,t.generated_at),s=(e=te.value)==null?void 0:e.room;n&&(te.value=pl(te.value,n));const a=s!=null&&(n==null?void 0:n.room)!=null&&s!==n.room;Ge.value=(Array.isArray(t.agents)?t.agents:[]).map(np).filter(l=>l!==null),et.value=(Array.isArray(t.tasks)?t.tasks:[]).map(sp).filter(l=>l!==null);const o=(Array.isArray(t.messages)?t.messages:[]).map(ap).filter(l=>l!==null);Ci.value=a?o:dp(Ci.value,o),pt.value=pp(t.keepers,n??te.value),Qr.value=ip(t.summary),Zr.value=(Array.isArray(t.execution_queue)?t.execution_queue:Array.isArray(t.priority_queue)?t.priority_queue:[]).map(op).filter(l=>l!==null),el.value=(Array.isArray(t.session_briefs)?t.session_briefs:[]).map(rp).filter(l=>l!==null),tl.value=(Array.isArray(t.operation_briefs)?t.operation_briefs:[]).map(lp).filter(l=>l!==null),nl.value=(Array.isArray(t.worker_support_briefs)?t.worker_support_briefs:Array.isArray(t.worker_briefs)?t.worker_briefs:[]).map(Fo).filter(l=>l!==null),sl.value=(Array.isArray(t.continuity_briefs)?t.continuity_briefs:[]).map(cp).filter(l=>l!==null),al.value=(Array.isArray(t.offline_worker_briefs)?t.offline_worker_briefs:[]).map(Fo).filter(l=>l!==null),Gu.value=null,rl.value=new Date().toISOString()}catch(t){console.error("Dashboard execution fetch error:",t)}}async function nt(){En.value=!0;try{const e=await xd(jn.value,{excludeSystem:St.value});Ma.value=e.posts??[],zi.value=new Date().toISOString()}catch(e){console.error("Board fetch error:",e)}finally{En.value=!1}}async function st(){var e;Ti.value=!0;try{const t=Ue.value||((e=te.value)==null?void 0:e.room)||"default";Ue.value||(Ue.value=t);const n=await du(t);il.value=n}catch(t){console.error("TRPG fetch error:",t)}finally{Ti.value=!1}}async function no(){xn.value=!0,Sn.value=!0;try{const e=await Rd();kp(e),Ju.value=new Date().toISOString(),Vu.value=new Date().toISOString()}catch(e){console.error("Planning fetch error:",e),Zi.value="error",Vt.value=e instanceof Error?e.message:String(e)}finally{xn.value=!1,Sn.value=!1}}async function _l(){return no()}let Ls=null;function xp(e){Ls=e}let Ms=null;function Sp(e){Ms=e}let js=null;function Cp(e){js=e}const At={};let Ba=null;function ht(e,t,n=500){At[e]&&clearTimeout(At[e]),At[e]=setTimeout(()=>{t(),delete At[e]},n)}function Ap(){const e=jr.subscribe(t=>{if(t){if(t.type==="keeper_heartbeat"&&t.name){const n=new Map(Ai.value);n.set(t.name,t.ts_unix?t.ts_unix*1e3:Date.now()),Ai.value=n;return}(t.type==="agent_joined"||t.type==="agent_left")&&ht("execution",Ct),ep(t.type)&&(Ba||(Ba=setTimeout(()=>{es(),Ms==null||Ms(),js==null||js(),Ba=null},500))),(t.type.startsWith("task_")||t.type.startsWith("masc/task_"))&&ht("execution",Ct),t.type==="broadcast"&&ht("execution",Ct),(t.type==="keeper_handoff"||t.type==="keeper_compaction"||t.type==="keeper_guardrail")&&ht("execution",Ct),(t.type==="board_post"||t.type==="masc/board_post"||t.type==="board_comment"||t.type==="masc/board_comment")&&ht("board",nt),t.type.startsWith("decision_")&&ht("council",()=>Ls==null?void 0:Ls()),(t.type==="mdal_started"||t.type==="mdal_iteration"||t.type==="mdal_completed"||t.type==="mdal_stopped")&&ht("mdal",_l,350)}});return()=>{e();for(const t of Object.keys(At))clearTimeout(At[t]),delete At[t]}}let Cn=null;function Ip(){Cn||(Cn=setInterval(()=>{rt.value,es()},1e4))}function Tp(){Cn&&(clearInterval(Cn),Cn=null)}const _e=f(null),so=f(null),De=f(null),Nn=f(!1),lt=f(null),wn=f(!1),on=f(null),W=f(!1),Vs=f([]);let zp=1;function Rp(e){return v(e)?{id:r(e.id),seq:d(e.seq),from:r(e.from)??r(e.from_agent)??"system",content:r(e.content)??"",timestamp:r(e.timestamp)??new Date().toISOString(),type:r(e.type)}:null}function Pp(e){return v(e)?{room_id:r(e.room_id),current_room:r(e.current_room)??r(e.room),project:r(e.project),cluster:r(e.cluster),paused:N(e.paused),pause_reason:r(e.pause_reason)??null,paused_by:r(e.paused_by)??null,paused_at:r(e.paused_at)??null}:{}}function Uo(e){if(!v(e))return;const t=Object.entries(e).map(([n,s])=>{const a=r(s);return a?[n,a]:null}).filter(n=>n!==null);return t.length>0?Object.fromEntries(t):void 0}function fl(e){if(!v(e))return null;const t=r(e.kind),n=r(e.summary),s=r(e.target_type);return!t||!n||!s?null:{kind:t,severity:r(e.severity)??"warn",summary:n,target_type:s,target_id:r(e.target_id)??null,actor:r(e.actor)??null,evidence:e.evidence}}function An(e){if(!v(e))return null;const t=r(e.action_type),n=r(e.target_type),s=r(e.reason);return!t||!n||!s?null:{action_type:t,target_type:n,target_id:r(e.target_id)??null,severity:r(e.severity)??"warn",reason:s,confirm_required:N(e.confirm_required),suggested_payload:e.suggested_payload,preview:e.preview}}function gl(e){return v(e)?{enabled:N(e.enabled),judge_online:N(e.judge_online),refreshing:N(e.refreshing),generated_at:r(e.generated_at)??null,expires_at:r(e.expires_at)??null,model_used:r(e.model_used)??null,keeper_name:r(e.keeper_name)??null,last_error:r(e.last_error)??null}:null}function Ua(e){return v(e)?{summary:r(e.summary)??null,confidence:d(e.confidence)??null,provenance:r(e.provenance)??null,authoritative:N(e.authoritative),surface:r(e.surface)??null,fresh_until:r(e.fresh_until)??null,keeper_name:r(e.keeper_name)??null,fallback_used:N(e.fallback_used),disagreement_with_truth:N(e.disagreement_with_truth)}:null}function Lp(e){return v(e)?{judgment_id:r(e.judgment_id)??void 0,surface:r(e.surface)??null,target_type:r(e.target_type)??null,target_id:r(e.target_id)??null,status:r(e.status)??null,summary:r(e.summary)??null,confidence:d(e.confidence)??null,generated_at:r(e.generated_at)??null,fresh_until:r(e.fresh_until)??null,keeper_name:r(e.keeper_name)??null,model_name:r(e.model_name)??null,runtime_name:r(e.runtime_name)??null,evidence_refs:H(e.evidence_refs),recommended_action:An(e.recommended_action),supersedes:H(e.supersedes),fallback_used:N(e.fallback_used),disagreement_with_truth:N(e.disagreement_with_truth),provenance:r(e.provenance)??null}:null}function Mp(e){return v(e)?{actor:r(e.actor)??null,spawn_agent:r(e.spawn_agent)??null,spawn_role:r(e.spawn_role)??null,spawn_model:r(e.spawn_model)??null,worker_class:r(e.worker_class)??null,parent_actor:r(e.parent_actor)??null,capsule_mode:r(e.capsule_mode)??null,runtime_pool:r(e.runtime_pool)??null,lane_id:r(e.lane_id)??null,controller_level:r(e.controller_level)??null,control_domain:r(e.control_domain)??null,supervisor_actor:r(e.supervisor_actor)??null,model_tier:r(e.model_tier)??null,task_profile:r(e.task_profile)??null,risk_level:r(e.risk_level)??null,routing_confidence:d(e.routing_confidence)??null,routing_reason:r(e.routing_reason)??null,status:r(e.status)??"unknown",turn_count:d(e.turn_count)??0,empty_note_turn_count:d(e.empty_note_turn_count)??0,has_turn:N(e.has_turn)??!1,last_turn_ts_iso:r(e.last_turn_ts_iso)??null}:null}function jp(e){if(!v(e))return null;const t=r(e.session_id);return t?{session_id:t,goal:r(e.goal),status:r(e.status),health:r(e.health),scale_profile:r(e.scale_profile),control_profile:r(e.control_profile),planned_worker_count:d(e.planned_worker_count),active_agent_count:d(e.active_agent_count),last_turn_age_sec:d(e.last_turn_age_sec)??null,attention_count:d(e.attention_count),recommended_action_count:d(e.recommended_action_count),top_attention:fl(e.top_attention),top_recommendation:An(e.top_recommendation)}:null}function $l(e){const t=v(e)?e:{};return{trace_id:r(t.trace_id),target_type:r(t.target_type)??"room",target_id:r(t.target_id)??null,health:r(t.health),judgment_owner:r(t.judgment_owner)??null,authoritative_judgment_available:N(t.authoritative_judgment_available),resident_judge_runtime:gl(t.resident_judge_runtime),judgment:Lp(t.judgment),active_guidance_layer:r(t.active_guidance_layer)??null,active_summary:Ua(t.active_summary),active_recommended_actions:pe(t.active_recommended_actions).map(An).filter(n=>n!==null),active_recommendation_source:r(t.active_recommendation_source)??null,active_recommendation_summary:Ua(t.active_recommendation_summary),fallback_recommended_actions:pe(t.fallback_recommended_actions).map(An).filter(n=>n!==null),recommendation_summary:Ua(t.recommendation_summary),swarm_status:v(t.swarm_status)?t.swarm_status:void 0,attention_items:pe(t.attention_items).map(fl).filter(n=>n!==null),recommended_actions:pe(t.recommended_actions).map(An).filter(n=>n!==null),session_cards:pe(t.session_cards).map(jp).filter(n=>n!==null),worker_cards:pe(t.worker_cards).map(Mp).filter(n=>n!==null)}}function Ep(e){if(!v(e))return null;const t=v(e.status)?e.status:void 0,n=v(e.summary)?e.summary:v(t==null?void 0:t.summary)?t.summary:void 0,s=v(e.session)?e.session:v(t==null?void 0:t.session)?t.session:void 0,a=r(e.session_id)??r(n==null?void 0:n.session_id)??r(s==null?void 0:s.session_id);if(!a)return null;const o=Uo(e.report_paths)??Uo(t==null?void 0:t.report_paths),l=pe(e.recent_events,["events"]).filter(v);return{session_id:a,status:r(e.status)??r(n==null?void 0:n.status)??r(s==null?void 0:s.status),progress_pct:d(e.progress_pct)??d(n==null?void 0:n.progress_pct),elapsed_sec:d(e.elapsed_sec)??d(n==null?void 0:n.elapsed_sec),remaining_sec:d(e.remaining_sec)??d(n==null?void 0:n.remaining_sec),done_delta_total:d(e.done_delta_total)??d(n==null?void 0:n.done_delta_total),summary:n,team_health:v(e.team_health)?e.team_health:v(t==null?void 0:t.team_health)?t.team_health:void 0,communication_metrics:v(e.communication_metrics)?e.communication_metrics:v(t==null?void 0:t.communication_metrics)?t.communication_metrics:void 0,orchestration_state:v(e.orchestration_state)?e.orchestration_state:v(t==null?void 0:t.orchestration_state)?t.orchestration_state:void 0,cascade_metrics:v(e.cascade_metrics)?e.cascade_metrics:v(t==null?void 0:t.cascade_metrics)?t.cascade_metrics:void 0,report_paths:o,linked_autoresearch:v(e.linked_autoresearch)?e.linked_autoresearch:v(t==null?void 0:t.linked_autoresearch)?t.linked_autoresearch:void 0,session:s,recent_events:l}}function Ho(e){if(!v(e))return null;const t=r(e.name);if(!t)return null;const n=v(e.context)?e.context:void 0;return{name:t,runtime_class:e.runtime_class==="persistent_agent"?"persistent_agent":"resident_keeper",desired:N(e.desired),resident_registered:N(e.resident_registered),agent_name:r(e.agent_name),status:r(e.status),autonomy_level:r(e.autonomy_level),context_ratio:d(e.context_ratio)??d(n==null?void 0:n.context_ratio),generation:d(e.generation),active_goal_ids:H(e.active_goal_ids),last_autonomous_action_at:r(e.last_autonomous_action_at)??null,last_turn_ago_s:d(e.last_turn_ago_s),model:r(e.model)??r(e.active_model)??r(e.primary_model)}}function Np(e){if(!v(e))return null;const t=r(e.confirm_token)??r(e.token);return t?{confirm_token:t,actor:r(e.actor),action_type:r(e.action_type),target_type:r(e.target_type),target_id:r(e.target_id)??null,delegated_tool:r(e.delegated_tool),created_at:r(e.created_at),preview:e.preview}:null}function hl(e){if(!v(e))return null;const t=r(e.action_type),n=r(e.target_type);return!t||!n?null:{action_type:t,target_type:n,description:r(e.description),confirm_required:N(e.confirm_required)}}function wp(e){return v(e)?{actor_filter:r(e.actor_filter)??null,filter_active:N(e.filter_active)??!1,visible_count:d(e.visible_count)??0,total_count:d(e.total_count)??0,hidden_count:d(e.hidden_count)??0,hidden_actors:H(e.hidden_actors),confirm_required_actions:pe(e.confirm_required_actions).map(hl).filter(t=>t!==null)}:null}function Dp(e){const t=v(e)?e:{};return{room:Pp(t.room),sessions:pe(t.sessions,["items","sessions"]).map(Ep).filter(n=>n!==null),keepers:pe(t.keepers,["items","keepers"]).map(Ho).filter(n=>n!==null),resident_judge_runtime:gl(t.resident_judge_runtime),persistent_agents:pe(t.persistent_agents,["items","persistent_agents"]).map(Ho).filter(n=>n!==null),recent_messages:pe(t.recent_messages,["messages"]).map(Rp).filter(n=>n!==null),pending_confirms:pe(t.pending_confirms,["items","confirms"]).map(Np).filter(n=>n!==null),pending_confirm_summary:wp(t.pending_confirm_summary)??void 0,available_actions:pe(t.available_actions,["actions"]).map(hl).filter(n=>n!==null)}}function gs(e){if(typeof e=="string")return e;if(e==null)return"";try{return JSON.stringify(e)}catch{return String(e)}}function Wo(e){return e.target_id?`${e.target_type}:${e.target_id}`:e.target_type}function Ys(e){Vs.value=[{...e,id:zp++,at:new Date().toISOString()},...Vs.value].slice(0,20)}function yl(e){return e.confirm_required?gs(e.preview)||"Confirmation required":gs(e.result)||gs(e.executed_action)||gs(e.delegated_tool_result)||e.status}async function ye(){Nn.value=!0,lt.value=null;try{const e=await Ld();_e.value=Dp(e)}catch(e){lt.value=e instanceof Error?e.message:"Failed to load operator snapshot"}finally{Nn.value=!1}}async function Pt(){wn.value=!0,on.value=null;try{const e=await qr({targetType:"room"});so.value=$l(e)}catch(e){on.value=e instanceof Error?e.message:"Failed to load operator digest"}finally{wn.value=!1}}async function rn(e){if(!e){De.value=null;return}wn.value=!0,on.value=null;try{const t=await qr({targetType:"team_session",targetId:e,includeWorkers:!0});De.value=$l(t)}catch(t){on.value=t instanceof Error?t.message:"Failed to load session digest"}finally{wn.value=!1}}async function bl(e){var t;W.value=!0,lt.value=null;try{const n=await Pa(e);return Ys({actor:e.actor,action_type:e.action_type,target_label:Wo(e),outcome:n.confirm_required?"preview":"executed",message:yl(n),delegated_tool:n.delegated_tool}),await ye(),await Pt(),(t=De.value)!=null&&t.target_id&&await rn(De.value.target_id),n}catch(n){const s=n instanceof Error?n.message:"Operator action failed";throw lt.value=s,Ys({actor:e.actor,action_type:e.action_type,target_label:Wo(e),outcome:"error",message:s}),n}finally{W.value=!1}}async function kl(e,t,n="confirm"){var s;W.value=!0,lt.value=null;try{const a=await Fr(e,t,n);return Ys({actor:e,action_type:n,target_label:t,outcome:"confirmed",message:yl(a),delegated_tool:a.delegated_tool}),await ye(),await Pt(),(s=De.value)!=null&&s.target_id&&await rn(De.value.target_id),a}catch(a){const o=a instanceof Error?a.message:"Operator confirmation failed";throw lt.value=o,Ys({actor:e,action_type:"confirm",target_label:t,outcome:"error",message:o}),a}finally{W.value=!1}}Cp(()=>{var e;ye(),Pt(),(e=De.value)!=null&&e.target_id&&rn(De.value.target_id)});const ts=f(null),Ri=f(!1),Xs=f(null),xl=f(null),qt=f(!1),xt=f(null),Pi=f(null),Es=f(!1),Ns=f(null);let Yt=null;function Go(){Yt!==null&&(window.clearTimeout(Yt),Yt=null)}function Op(e=1500){Yt===null&&(Yt=window.setTimeout(()=>{Yt=null,Qs(!1)},e))}function w(e){return typeof e=="object"&&e!==null&&!Array.isArray(e)}function y(e){return typeof e=="string"&&e.trim()!==""?e:void 0}function D(e){return typeof e=="number"&&Number.isFinite(e)?e:void 0}function Xt(e){return typeof e=="boolean"?e:void 0}function U(e,t=[]){if(Array.isArray(e))return e;if(!w(e))return[];for(const n of t){const s=e[n];if(Array.isArray(s))return s}return[]}function pn(e){if(!w(e))return null;const t=y(e.kind),n=y(e.summary),s=y(e.target_type);return!t||!n||!s?null:{kind:t,severity:y(e.severity)??"warn",summary:n,target_type:s,target_id:y(e.target_id)??null,actor:y(e.actor)??null,evidence:e.evidence}}function Lt(e){if(!w(e))return null;const t=y(e.action_type),n=y(e.target_type),s=y(e.reason);return!t||!n||!s?null:{action_type:t,target_type:n,target_id:y(e.target_id)??null,severity:y(e.severity)??"warn",reason:s,confirm_required:Xt(e.confirm_required),suggested_payload:e.suggested_payload,preview:e.preview}}function qp(e){if(!w(e))return null;const t=y(e.session_id);return t?{session_id:t,goal:y(e.goal),status:y(e.status),health:y(e.health),scale_profile:y(e.scale_profile),control_profile:y(e.control_profile),planned_worker_count:D(e.planned_worker_count),active_agent_count:D(e.active_agent_count),last_turn_age_sec:D(e.last_turn_age_sec)??null,attention_count:D(e.attention_count),recommended_action_count:D(e.recommended_action_count),top_attention:pn(e.top_attention),top_recommendation:Lt(e.top_recommendation)}:null}function Fp(e){if(!w(e))return null;const t=y(e.session_id);if(!t)return null;const n=w(e.status)?e.status:e,s=w(n.summary)?n.summary:void 0;return{session_id:t,status:y(e.status)??y(s==null?void 0:s.status)??(w(n.session)?y(n.session.status):void 0),progress_pct:D(e.progress_pct)??D(s==null?void 0:s.progress_pct),elapsed_sec:D(e.elapsed_sec)??D(s==null?void 0:s.elapsed_sec),remaining_sec:D(e.remaining_sec)??D(s==null?void 0:s.remaining_sec),done_delta_total:D(e.done_delta_total)??D(s==null?void 0:s.done_delta_total),summary:w(e.summary)?e.summary:s,team_health:w(e.team_health)?e.team_health:w(n.team_health)?n.team_health:void 0,communication_metrics:w(e.communication_metrics)?e.communication_metrics:w(n.communication_metrics)?n.communication_metrics:void 0,orchestration_state:w(e.orchestration_state)?e.orchestration_state:w(n.orchestration_state)?n.orchestration_state:void 0,cascade_metrics:w(e.cascade_metrics)?e.cascade_metrics:w(n.cascade_metrics)?n.cascade_metrics:void 0,report_paths:w(e.report_paths)?Object.fromEntries(Object.entries(e.report_paths).map(([a,o])=>{const l=y(o);return l?[a,l]:null}).filter(a=>a!==null)):w(n.report_paths)?Object.fromEntries(Object.entries(n.report_paths).map(([a,o])=>{const l=y(o);return l?[a,l]:null}).filter(a=>a!==null)):void 0,session:w(e.session)?e.session:w(n.session)?n.session:void 0,recent_events:U(e.recent_events,["events"]).filter(w)}}function Kp(e){if(!w(e))return null;const t=y(e.name);return t?{name:t,agent_name:y(e.agent_name),status:y(e.status),autonomy_level:y(e.autonomy_level),context_ratio:D(e.context_ratio),generation:D(e.generation),active_goal_ids:U(e.active_goal_ids).map(n=>typeof n=="string"?n.trim():"").filter(Boolean),last_autonomous_action_at:y(e.last_autonomous_action_at)??null,last_turn_ago_s:D(e.last_turn_ago_s),model:y(e.model)}:null}function Bp(e){if(!w(e))return null;const t=y(e.confirm_token)??y(e.token);return t?{confirm_token:t,actor:y(e.actor),action_type:y(e.action_type),target_type:y(e.target_type),target_id:y(e.target_id)??null,delegated_tool:y(e.delegated_tool),created_at:y(e.created_at),preview:e.preview}:null}function Up(e){if(!w(e))return null;const t=y(e.action_type),n=y(e.target_type);return!t||!n?null:{action_type:t,target_type:n,description:y(e.description),confirm_required:Xt(e.confirm_required)}}function Hp(e){const t=w(e)?e:{};return{room_health:y(t.room_health),cluster:y(t.cluster),project:y(t.project),current_room:y(t.current_room)??null,paused:Xt(t.paused),tempo_interval_s:D(t.tempo_interval_s),active_agents:D(t.active_agents),keeper_pressure:D(t.keeper_pressure),active_operations:D(t.active_operations),pending_approvals:D(t.pending_approvals),incident_count:D(t.incident_count),recommended_action_count:D(t.recommended_action_count),top_attention:pn(t.top_attention),top_action:Lt(t.top_action)}}function Wp(e){const t=w(e)?e:{},n=w(t.swarm_overview)?t.swarm_overview:{};return{health:y(t.health),active_operations:D(t.active_operations),pending_approvals:D(t.pending_approvals),swarm_overview:{active_lanes:D(n.active_lanes),moving_lanes:D(n.moving_lanes),stalled_lanes:D(n.stalled_lanes),projected_lanes:D(n.projected_lanes),last_movement_at:y(n.last_movement_at)??null},top_attention:pn(t.top_attention),top_action:Lt(t.top_action),session_cards:U(t.session_cards).map(qp).filter(s=>s!==null)}}function Gp(e){const t=w(e)?e:{};return{sessions:U(t.sessions,["items"]).map(Fp).filter(n=>n!==null),keepers:U(t.keepers,["items"]).map(Kp).filter(n=>n!==null),pending_confirms:U(t.pending_confirms).map(Bp).filter(n=>n!==null),available_actions:U(t.available_actions).map(Up).filter(n=>n!==null)}}function Jp(e){if(!w(e))return null;const t=y(e.id),n=y(e.kind),s=y(e.summary),a=y(e.target_type);return!t||!n||!s||!a?null:{id:t,kind:n,severity:y(e.severity)??"warn",summary:s,target_type:a,target_id:y(e.target_id)??null,top_action:Lt(e.top_action),related_session_ids:U(e.related_session_ids).map(o=>typeof o=="string"?o.trim():"").filter(Boolean),related_agent_names:U(e.related_agent_names).map(o=>typeof o=="string"?o.trim():"").filter(Boolean),evidence_preview:U(e.evidence_preview).map(o=>typeof o=="string"?o.trim():"").filter(Boolean),last_seen_at:y(e.last_seen_at)??null}}function Sl(e){if(!w(e))return null;const t=y(e.session_id),n=y(e.goal);return!t||!n?null:{session_id:t,goal:n,room:y(e.room)??null,status:y(e.status),health:y(e.health),member_names:U(e.member_names).map(s=>typeof s=="string"?s.trim():"").filter(Boolean),started_at:y(e.started_at)??null,elapsed_sec:D(e.elapsed_sec)??null,operation_id:y(e.operation_id)??null,blocker_summary:y(e.blocker_summary)??null,last_event_at:y(e.last_event_at)??null,last_event_summary:y(e.last_event_summary)??null,communication_summary:y(e.communication_summary)??null,active_count:D(e.active_count),required_count:D(e.required_count),related_attention_count:D(e.related_attention_count)??0,top_attention:pn(e.top_attention),top_recommendation:Lt(e.top_recommendation)}}function Cl(e){if(!w(e))return null;const t=y(e.agent_name);return t?{agent_name:t,status:y(e.status),current_work:y(e.current_work)??null,recent_input_preview:y(e.recent_input_preview)??null,recent_output_preview:y(e.recent_output_preview)??null,recent_tool_names:U(e.recent_tool_names).map(n=>typeof n=="string"?n.trim():"").filter(Boolean),last_activity_at:y(e.last_activity_at)??null}:null}function Al(e){if(!w(e))return null;const t=y(e.operation_id);return t?{operation_id:t,status:y(e.status),stage:y(e.stage)??null,detachment_status:y(e.detachment_status)??null,objective:y(e.objective)??null,updated_at:y(e.updated_at)??null}:null}function Il(e){if(!w(e))return null;const t=y(e.name);return t?{name:t,agent_name:y(e.agent_name)??null,status:y(e.status),generation:D(e.generation),context_ratio:D(e.context_ratio)??null,last_turn_ago_s:D(e.last_turn_ago_s)??null,current_work:y(e.current_work)??null}:null}function Tl(e){const t=Sl(e);return t?{...t,member_previews:U(w(e)?e.member_previews:void 0).map(Cl).filter(n=>n!==null),operation_badges:U(w(e)?e.operation_badges:void 0).map(Al).filter(n=>n!==null),keeper_refs:U(w(e)?e.keeper_refs:void 0).map(Il).filter(n=>n!==null)}:null}function Vp(e){if(!w(e))return null;const t=y(e.agent_name);return t?{agent_name:t,status:y(e.status),where:y(e.where)??null,with_whom:U(e.with_whom).map(n=>typeof n=="string"?n.trim():"").filter(Boolean),current_work:y(e.current_work)??null,related_session_id:y(e.related_session_id)??null,related_attention_count:D(e.related_attention_count)??0,last_activity_at:y(e.last_activity_at)??null,recent_output_preview:y(e.recent_output_preview)??null,recent_input_preview:y(e.recent_input_preview)??null,recent_event:y(e.recent_event)??null,recent_tool_names:U(e.recent_tool_names).map(n=>typeof n=="string"?n.trim():"").filter(Boolean),allowed_tool_names:U(e.allowed_tool_names).map(n=>typeof n=="string"?n.trim():"").filter(Boolean),latest_tool_names:U(e.latest_tool_names).map(n=>typeof n=="string"?n.trim():"").filter(Boolean),latest_tool_call_count:D(e.latest_tool_call_count)??null,tool_audit_source:y(e.tool_audit_source)??null,tool_audit_at:y(e.tool_audit_at)??null}:null}function Yp(e){if(!w(e))return null;const t=y(e.name);return t?{name:t,agent_name:y(e.agent_name)??null,status:y(e.status),generation:D(e.generation),context_ratio:D(e.context_ratio)??null,last_turn_ago_s:D(e.last_turn_ago_s)??null,current_work:y(e.current_work)??null,last_autonomous_action_at:y(e.last_autonomous_action_at)??null,allowed_tool_names:U(e.allowed_tool_names).map(n=>typeof n=="string"?n.trim():"").filter(Boolean),latest_tool_names:U(e.latest_tool_names).map(n=>typeof n=="string"?n.trim():"").filter(Boolean),latest_tool_call_count:D(e.latest_tool_call_count)??null,tool_audit_source:y(e.tool_audit_source)??null,tool_audit_at:y(e.tool_audit_at)??null}:null}function Xp(e){if(!w(e))return null;const t=y(e.id),n=y(e.signal_type),s=y(e.summary),a=y(e.target_type);return!t||!n||!s||!a?null:{id:t,signal_type:n==="action"?"action":"attention",severity:y(e.severity)??"warn",summary:s,target_type:a,target_id:y(e.target_id)??null,attention:pn(e.attention),action:Lt(e.action)}}function Qp(e){const t=w(e)?e:{},n=U(t.session_briefs).map(Sl).filter(a=>a!==null),s=U(t.sessions).map(Tl).filter(a=>a!==null);return{generated_at:y(t.generated_at),summary:Hp(t.summary),incidents:U(t.incidents).map(pn).filter(a=>a!==null),recommended_actions:U(t.recommended_actions).map(Lt).filter(a=>a!==null),command_focus:Wp(t.command_focus),operator_targets:Gp(t.operator_targets),attention_queue:U(t.attention_queue).map(Jp).filter(a=>a!==null),sessions:s.length>0?s:n.map(a=>({...a,member_previews:[],operation_badges:[],keeper_refs:[]})),session_briefs:n,agent_briefs:U(t.agent_briefs).map(Vp).filter(a=>a!==null),keeper_briefs:U(t.keeper_briefs).map(Yp).filter(a=>a!==null),internal_signals:U(t.internal_signals).map(Xp).filter(a=>a!==null)}}function Zp(e){if(!w(e))return null;const t=y(e.id),n=y(e.summary);return!t||!n?null:{id:t,timestamp:y(e.timestamp)??null,event_type:y(e.event_type),actor:y(e.actor)??null,summary:n}}function em(e){const t=w(e)?e:{};return{generated_at:y(t.generated_at),session_id:y(t.session_id)??"",session:Tl(t.session),timeline:U(t.timeline).map(Zp).filter(n=>n!==null),participants:U(t.participants).map(Cl).filter(n=>n!==null),operations:U(t.operations).map(Al).filter(n=>n!==null),keepers:U(t.keepers).map(Il).filter(n=>n!==null),error:y(t.error)??null}}function tm(e){if(!w(e))return null;const t=y(e.id),n=y(e.label),s=y(e.summary);if(!t||!n||!s)return null;const a=y(e.status)??"unclear";return{id:t,label:n,status:a==="ok"||a==="healthy"||a==="aligned"||a==="watch"||a==="risk"||a==="unclear"?a:"unclear",summary:s,signal_class:y(e.signal_class)==="metadata_gap"||y(e.signal_class)==="mixed"||y(e.signal_class)==="operational_risk"?y(e.signal_class):void 0,evidence_quality:y(e.evidence_quality)==="strong"||y(e.evidence_quality)==="partial"||y(e.evidence_quality)==="missing"?y(e.evidence_quality):void 0,evidence:U(e.evidence).map(l=>typeof l=="string"?l.trim():"").filter(Boolean)}}function nm(e){if(!w(e))return null;const t=y(e.kind),n=y(e.summary),s=y(e.scope_type),a=y(e.severity);return!t||!n||!s||!a||s!=="session"&&s!=="keeper"&&s!=="agent"||a!=="info"&&a!=="watch"?null:{kind:t,summary:n,scope_type:s,scope_id:y(e.scope_id)??null,severity:a}}function sm(e){const t=w(e)?e:{},n=w(t.basis)?t.basis:{},s=y(t.status)??"error",a=s==="ok"||s==="pending"||s==="unavailable"||s==="error"?s:"error";return{generated_at:y(t.generated_at),cached:Xt(t.cached),stale:Xt(t.stale),refreshing:Xt(t.refreshing),status:a,summary:y(t.summary)??null,model:y(t.model)??null,ttl_sec:D(t.ttl_sec),criteria:U(t.criteria).map(o=>typeof o=="string"?o.trim():"").filter(Boolean),basis:{current_room:y(n.current_room)??null,crew_count:D(n.crew_count),agent_count:D(n.agent_count),keeper_count:D(n.keeper_count)},metadata_gap_count:D(t.metadata_gap_count),metadata_gaps:U(t.metadata_gaps).map(nm).filter(o=>o!==null),sections:U(t.sections).map(tm).filter(o=>o!==null),error:y(t.error)??null,last_error:y(t.last_error)??null}}async function zl(){Ri.value=!0,Xs.value=null;try{const e=await Ad();ts.value=Qp(e)}catch(e){Xs.value=e instanceof Error?e.message:"Failed to load mission snapshot"}finally{Ri.value=!1}}async function am(e){if(!e){Pi.value=null,Ns.value=null,Es.value=!1;return}Es.value=!0,Ns.value=null;try{const t=await Id(e);Pi.value=em(t)}catch(t){Ns.value=t instanceof Error?t.message:"Failed to load session detail"}finally{Es.value=!1}}async function Qs(e=!1){qt.value=!0,xt.value=null;try{const t=await Td(e),n=sm(t);xl.value=n,n.refreshing||n.status==="pending"?Op():Go()}catch(t){xt.value=t instanceof Error?t.message:"Failed to load mission briefing",Go()}finally{qt.value=!1}}const Rl=f(null),Li=f(!1),Ft=f(null);async function Pl(e,t){Li.value=!0,Ft.value=null;try{Rl.value=await zd(e,t)}catch(n){Ft.value=n instanceof Error?n.message:String(n)}finally{Li.value=!1}}const ao=f(null),qe=f(null),Zs=f(!1),ea=f(!1),ta=f(null),na=f(null),Mi=f(null),sa=f(null),G=f("warroom"),ns=f(null),ji=f(!1),aa=f(null),Mt=f(null),ia=f(!1),oa=f(null),io=f(null),Ei=f(!1),ra=f(null),ss=f(null),Ni=f(!1),la=f(null),Dn=f(null),ca=f(!1),On=f(null),Qt=f(null);let bn=null;function oo(e){return e!=="summary"&&e!=="swarm"&&e!=="warroom"&&e!=="orchestra"}function Ll(){if(typeof window>"u")return new URLSearchParams;const e=new URLSearchParams(window.location.search),t=window.location.hash.replace(/^#/,""),n=t.indexOf("?");return n>=0&&new URLSearchParams(t.slice(n+1)).forEach((a,o)=>{e.has(o)||e.set(o,a)}),e}function Ml(){const t=Ll().get("run_id")??void 0;return t&&t.trim()!==""?t.trim():void 0}function jl(){const t=Ll().get("operation_id")??void 0;return t&&t.trim()!==""?t.trim():void 0}function im(e){if(v(e))return{policy_class:r(e.policy_class),approval_class:r(e.approval_class),tool_allowlist:H(e.tool_allowlist),model_allowlist:H(e.model_allowlist),requires_human_for:H(e.requires_human_for),autonomy_level:r(e.autonomy_level),escalation_timeout_sec:d(e.escalation_timeout_sec),kill_switch:N(e.kill_switch),frozen:N(e.frozen)}}function om(e){if(v(e))return{headcount_cap:d(e.headcount_cap),active_operation_cap:d(e.active_operation_cap),max_cost_usd:d(e.max_cost_usd),max_tokens:d(e.max_tokens)}}function ro(e){if(!v(e))return null;const t=r(e.unit_id),n=r(e.label),s=r(e.kind);return!t||!n||!s?null:{unit_id:t,label:n,kind:s,parent_unit_id:r(e.parent_unit_id)??null,leader_id:r(e.leader_id)??null,roster:H(e.roster),capability_profile:H(e.capability_profile),source:r(e.source),created_at:r(e.created_at),updated_at:r(e.updated_at),policy:im(e.policy),budget:om(e.budget)}}function El(e){if(!v(e))return null;const t=ro(e.unit);return t?{unit:t,leader_status:r(e.leader_status),roster_total:d(e.roster_total),roster_live:d(e.roster_live),active_operation_count:d(e.active_operation_count),health:r(e.health),reasons:H(e.reasons),children:Array.isArray(e.children)?e.children.map(El).filter(n=>n!==null):[]}:null}function rm(e){if(v(e))return{total_units:d(e.total_units),company_count:d(e.company_count),platoon_count:d(e.platoon_count),squad_count:d(e.squad_count),leaf_agent_unit_count:d(e.leaf_agent_unit_count),live_agent_count:d(e.live_agent_count),managed_unit_count:d(e.managed_unit_count),active_operation_count:d(e.active_operation_count)}}function Nl(e){const t=v(e)?e:{};return{version:r(t.version),generated_at:r(t.generated_at),source:r(t.source),summary:rm(t.summary),units:Array.isArray(t.units)?t.units.map(El).filter(n=>n!==null):[]}}function lm(e){if(!v(e))return null;const t=r(e.kind),n=r(e.status);return!t||!n?null:{kind:t,chain_id:r(e.chain_id)??null,goal:r(e.goal)??null,run_id:r(e.run_id)??null,status:n,viewer_path:r(e.viewer_path)??null,last_sync_at:r(e.last_sync_at)??null}}function ja(e){if(!v(e))return null;const t=r(e.operation_id),n=r(e.objective),s=r(e.assigned_unit_id),a=r(e.trace_id),o=r(e.status);return!t||!n||!s||!a||!o?null:{operation_id:t,objective:n,assigned_unit_id:s,autonomy_level:r(e.autonomy_level),policy_class:r(e.policy_class),budget_class:r(e.budget_class),detachment_session_id:r(e.detachment_session_id)??null,trace_id:a,checkpoint_ref:r(e.checkpoint_ref)??null,active_goal_ids:H(e.active_goal_ids),note:r(e.note)??null,created_by:r(e.created_by),source:r(e.source),status:o,chain:lm(e.chain),created_at:r(e.created_at),updated_at:r(e.updated_at)}}function cm(e){if(!v(e))return null;const t=ja(e.operation);return t?{operation:t,assigned_unit_label:r(e.assigned_unit_label)}:null}function $n(e){if(v(e))return{tone:r(e.tone),pending_ops:d(e.pending_ops),blocked_ops:d(e.blocked_ops),in_flight_ops:d(e.in_flight_ops),pipeline_stalls:d(e.pipeline_stalls),bus_traffic:d(e.bus_traffic),l1_hit_rate:d(e.l1_hit_rate),invalidation_count:d(e.invalidation_count),current_pending:d(e.current_pending),current_in_flight:d(e.current_in_flight),cdb_wakeups:d(e.cdb_wakeups),total_stolen:d(e.total_stolen),avg_best_score:d(e.avg_best_score),avg_candidate_count:d(e.avg_candidate_count),best_first_operations:d(e.best_first_operations),active_sessions:d(e.active_sessions),commit_rate:d(e.commit_rate),total_speculations:d(e.total_speculations)}}function dm(e){if(!v(e))return;const t=v(e.pipeline)?e.pipeline:void 0,n=v(e.cache)?e.cache:void 0,s=v(e.ooo)?e.ooo:void 0,a=v(e.speculative)?e.speculative:void 0,o=v(e.search_fabric)?e.search_fabric:void 0,l=v(e.signals)?e.signals:void 0;return{pipeline:t?{total_ops:d(t.total_ops),completed_ops:d(t.completed_ops),stalled_cycles:d(t.stalled_cycles),hazards_detected:d(t.hazards_detected),forwarding_used:d(t.forwarding_used),pipeline_flushes:d(t.pipeline_flushes),ipc:d(t.ipc)}:void 0,cache:n?{total_reads:d(n.total_reads),total_writes:d(n.total_writes),l1_hit_rate:d(n.l1_hit_rate),invalidation_count:d(n.invalidation_count),writeback_count:d(n.writeback_count),bus_traffic:d(n.bus_traffic)}:void 0,ooo:s?{agent_count:d(s.agent_count),total_added:d(s.total_added),total_issued:d(s.total_issued),total_completed:d(s.total_completed),total_stolen:d(s.total_stolen),cdb_wakeups:d(s.cdb_wakeups),stall_cycles:d(s.stall_cycles),global_cdb_events:d(s.global_cdb_events),current_pending:d(s.current_pending),current_in_flight:d(s.current_in_flight)}:void 0,speculative:a?{total_speculations:d(a.total_speculations),total_commits:d(a.total_commits),total_aborts:d(a.total_aborts),commit_rate:d(a.commit_rate),total_fast_calls:d(a.total_fast_calls),total_cost_usd:d(a.total_cost_usd),active_sessions:d(a.active_sessions)}:void 0,search_fabric:o?{total_operations:d(o.total_operations),best_first_operations:d(o.best_first_operations),legacy_operations:d(o.legacy_operations),blocked_operations:d(o.blocked_operations),ready_operations:d(o.ready_operations),research_pipeline_operations:d(o.research_pipeline_operations),avg_candidate_count:d(o.avg_candidate_count),avg_best_score:d(o.avg_best_score),top_stage:r(o.top_stage)??null}:void 0,signals:l?{issue_pressure:$n(l.issue_pressure),cache_contention:$n(l.cache_contention),scheduler_efficiency:$n(l.scheduler_efficiency),routing_confidence:$n(l.routing_confidence),speculative_posture:$n(l.speculative_posture)}:void 0}}function wl(e){const t=v(e)?e:{},n=v(t.summary)?t.summary:void 0;return{version:r(t.version),generated_at:r(t.generated_at),summary:n?{total:d(n.total),active:d(n.active),paused:d(n.paused),managed:d(n.managed),projected:d(n.projected)}:void 0,microarch:dm(t.microarch),operations:Array.isArray(t.operations)?t.operations.map(cm).filter(s=>s!==null):[]}}function Dl(e){if(!v(e))return null;const t=r(e.detachment_id),n=r(e.operation_id),s=r(e.assigned_unit_id);return!t||!n||!s?null:{detachment_id:t,operation_id:n,assigned_unit_id:s,leader_id:r(e.leader_id)??null,roster:H(e.roster),session_id:r(e.session_id)??null,checkpoint_ref:r(e.checkpoint_ref)??null,runtime_kind:r(e.runtime_kind)??null,runtime_ref:r(e.runtime_ref)??null,source:r(e.source),status:r(e.status),last_event_at:r(e.last_event_at)??null,last_progress_at:r(e.last_progress_at)??null,heartbeat_deadline:r(e.heartbeat_deadline)??null,created_at:r(e.created_at),updated_at:r(e.updated_at)}}function um(e){if(!v(e))return null;const t=Dl(e.detachment);return t?{detachment:t,assigned_unit_label:r(e.assigned_unit_label),operation:ja(e.operation)}:null}function Ol(e){const t=v(e)?e:{},n=v(t.summary)?t.summary:void 0;return{version:r(t.version),generated_at:r(t.generated_at),summary:n?{total:d(n.total),active:d(n.active),projected:d(n.projected)}:void 0,detachments:Array.isArray(t.detachments)?t.detachments.map(um).filter(s=>s!==null):[]}}function pm(e){if(!v(e))return null;const t=r(e.decision_id),n=r(e.trace_id),s=r(e.requested_action),a=r(e.scope_type),o=r(e.scope_id);return!t||!n||!s||!a||!o?null:{decision_id:t,trace_id:n,requested_action:s,scope_type:a,scope_id:o,operation_id:r(e.operation_id)??null,target_unit_id:r(e.target_unit_id)??null,requested_by:r(e.requested_by),status:r(e.status),reason:r(e.reason)??null,source:r(e.source),detail:e.detail,created_at:r(e.created_at),decided_at:r(e.decided_at)??null,expires_at:r(e.expires_at)??null}}function ql(e){const t=v(e)?e:{},n=v(t.summary)?t.summary:void 0;return{version:r(t.version),generated_at:r(t.generated_at),summary:n?{total:d(n.total),pending:d(n.pending),approved:d(n.approved),denied:d(n.denied)}:void 0,decisions:Array.isArray(t.decisions)?t.decisions.map(pm).filter(s=>s!==null):[]}}function mm(e){if(!v(e))return null;const t=ro(e.unit);return t?{unit:t,roster_total:d(e.roster_total),roster_live:d(e.roster_live),headcount_cap:d(e.headcount_cap),active_operations:d(e.active_operations),active_operation_cap:d(e.active_operation_cap),utilization:d(e.utilization)}:null}function vm(e){const t=v(e)?e:{};return{version:r(t.version),generated_at:r(t.generated_at),capacity:Array.isArray(t.capacity)?t.capacity.map(mm).filter(n=>n!==null):[]}}function _m(e){if(!v(e))return null;const t=r(e.alert_id);return t?{alert_id:t,severity:r(e.severity),kind:r(e.kind),scope_type:r(e.scope_type),scope_id:r(e.scope_id),title:r(e.title),detail:r(e.detail),timestamp:r(e.timestamp)}:null}function Fl(e){const t=v(e)?e:{},n=v(t.summary)?t.summary:void 0;return{version:r(t.version),generated_at:r(t.generated_at),summary:n?{total:d(n.total),bad:d(n.bad),warn:d(n.warn)}:void 0,alerts:Array.isArray(t.alerts)?t.alerts.map(_m).filter(s=>s!==null):[]}}function Kl(e){if(!v(e))return null;const t=r(e.event_id),n=r(e.trace_id),s=r(e.event_type);return!t||!n||!s?null:{event_id:t,trace_id:n,event_type:s,operation_id:r(e.operation_id)??null,unit_id:r(e.unit_id)??null,actor:r(e.actor)??null,source:r(e.source),timestamp:r(e.timestamp),detail:e.detail}}function fm(e){const t=v(e)?e:{};return{version:r(t.version),generated_at:r(t.generated_at),events:Array.isArray(t.events)?t.events.map(Kl).filter(n=>n!==null):[]}}function gm(e){if(!v(e))return null;const t=r(e.code),n=r(e.severity),s=r(e.summary);return!t||!n||!s?null:{code:t,severity:n,summary:s}}function $m(e){if(!v(e))return null;const t=r(e.lane_id),n=r(e.label),s=r(e.kind),a=r(e.phase),o=r(e.motion_state),l=r(e.source_of_truth),c=r(e.movement_reason),p=r(e.current_step);if(!t||!n||!s||!a||!o||!l||!c||!p)return null;const m=v(e.counts)?e.counts:{};return{lane_id:t,label:n,kind:s,present:N(e.present)??!1,phase:a,motion_state:o,source_of_truth:l,last_movement_at:r(e.last_movement_at)??null,movement_reason:c,current_step:p,blockers:H(e.blockers),counts:{operations:d(m.operations),detachments:d(m.detachments),workers:d(m.workers),approvals:d(m.approvals),alerts:d(m.alerts)},hard_flags:Array.isArray(e.hard_flags)?e.hard_flags.map(gm).filter(u=>u!==null):[]}}function hm(e){if(!v(e))return null;const t=r(e.event_id),n=r(e.lane_id),s=r(e.kind),a=r(e.timestamp),o=r(e.title),l=r(e.detail),c=r(e.tone),p=r(e.source);return!t||!n||!s||!a||!o||!l||!c||!p?null:{event_id:t,lane_id:n,kind:s,timestamp:a,title:o,detail:l,tone:c,source:p}}function ym(e){if(!v(e))return null;const t=r(e.code),n=r(e.severity),s=r(e.summary);return!t||!n||!s?null:{code:t,severity:n,summary:s,lane_ids:H(e.lane_ids),count:d(e.count)??0}}function lo(e){if(!v(e))return;const t=v(e.overview)?e.overview:{},n=v(e.gaps)?e.gaps:{},s=v(e.recommended_next_action)?e.recommended_next_action:void 0;return{generated_at:r(e.generated_at),overview:{active_lanes:d(t.active_lanes),moving_lanes:d(t.moving_lanes),stalled_lanes:d(t.stalled_lanes),projected_lanes:d(t.projected_lanes),last_movement_at:r(t.last_movement_at)??null},lanes:Array.isArray(e.lanes)?e.lanes.map($m).filter(a=>a!==null):[],timeline:Array.isArray(e.timeline)?e.timeline.map(hm).filter(a=>a!==null):[],gaps:{count:d(n.count),items:Array.isArray(n.items)?n.items.map(ym).filter(a=>a!==null):[]},recommended_next_action:s?{tool:r(s.tool)??"masc_operator_snapshot",label:r(s.label)??"Observe operator state",reason:r(s.reason)??"",lane_id:r(s.lane_id)??null}:void 0}}function Bl(e){if(!v(e))return;const t=v(e.workers)?e.workers:{},n=N(e.pass);return{status:r(e.status)??"missing",source:r(e.source)??"none",run_id:r(e.run_id)??null,captured_at:r(e.captured_at)??null,...n!==void 0?{pass:n}:{},...d(e.peak_hot_slots)!=null?{peak_hot_slots:d(e.peak_hot_slots)}:{},...d(e.ctx_per_slot)!=null?{ctx_per_slot:d(e.ctx_per_slot)}:{},workers:{expected:d(t.expected),joined:d(t.joined),current_task_bound:d(t.current_task_bound),fresh_heartbeats:d(t.fresh_heartbeats),done:d(t.done),final:d(t.final)},artifact_ref:r(e.artifact_ref)??null,missing_reason:r(e.missing_reason)??null}}function bm(e){const t=v(e)?e:{};return{version:r(t.version),generated_at:r(t.generated_at),topology:Nl(t.topology),operations:wl(t.operations),detachments:Ol(t.detachments),alerts:Fl(t.alerts),decisions:ql(t.decisions),capacity:vm(t.capacity),traces:fm(t.traces),swarm_status:lo(t.swarm_status)}}function km(e){const t=v(e)?e:{},n=Nl(t.topology),s=wl(t.operations),a=Ol(t.detachments),o=Fl(t.alerts),l=ql(t.decisions);return{version:r(t.version),generated_at:r(t.generated_at),topology:{version:n.version,generated_at:n.generated_at,source:n.source,summary:n.summary},operations:{version:s.version,generated_at:s.generated_at,summary:s.summary,microarch:s.microarch},detachments:{version:a.version,generated_at:a.generated_at,summary:a.summary},alerts:{version:o.version,generated_at:o.generated_at,summary:o.summary},decisions:{version:l.version,generated_at:l.generated_at,summary:l.summary},swarm_status:lo(t.swarm_status),swarm_proof:Bl(t.swarm_proof)}}function xm(e){return v(e)?{chain_id:r(e.chain_id)??null,started_at:d(e.started_at)??null,progress:d(e.progress)??null,elapsed_sec:d(e.elapsed_sec)??null}:null}function Ul(e){if(!v(e))return null;const t=r(e.event);return t?{event:t,chain_id:r(e.chain_id)??null,timestamp:r(e.timestamp)??null,duration_ms:d(e.duration_ms)??null,message:r(e.message)??null,tokens:d(e.tokens)??null}:null}function Sm(e){if(!v(e))return null;const t=ja(e.operation);return t?{operation:t,runtime:xm(e.runtime),history:Ul(e.history),mermaid:r(e.mermaid)??null,preview_run:Hl(e.preview_run)}:null}function Cm(e){const t=v(e)?e:{};return{status:r(t.status)??"disconnected",base_url:r(t.base_url)??null,message:r(t.message)??null}}function Am(e){const t=v(e)?e:{},n=v(t.summary)?t.summary:void 0;return{version:r(t.version),generated_at:r(t.generated_at),connection:Cm(t.connection),summary:n?{linked_operations:d(n.linked_operations),active_chains:d(n.active_chains),running_operations:d(n.running_operations),recent_failures:d(n.recent_failures),last_history_event_at:r(n.last_history_event_at)??null}:void 0,operations:Array.isArray(t.operations)?t.operations.map(Sm).filter(s=>s!==null):[],recent_history:Array.isArray(t.recent_history)?t.recent_history.map(Ul).filter(s=>s!==null):[]}}function Im(e){if(!v(e))return null;const t=r(e.id);return t?{id:t,type:r(e.type),status:r(e.status),duration_ms:d(e.duration_ms)??null,error:r(e.error)??null}:null}function Hl(e){if(!v(e))return null;const t=r(e.run_id),n=r(e.chain_id);return n?{run_id:t??null,chain_id:n,duration_ms:d(e.duration_ms),success:N(e.success),mermaid:r(e.mermaid),nodes:Array.isArray(e.nodes)?e.nodes.map(Im).filter(s=>s!==null):[]}:null}function Tm(e){const t=v(e)?e:{};return{run:Hl(t.run)}}function zm(e){if(!v(e))return null;const t=r(e.title),n=r(e.path);return!t||!n?null:{title:t,path:n}}function Rm(e){if(!v(e))return null;const t=r(e.id),n=r(e.title),s=r(e.summary);return!t||!n||!s?null:{id:t,title:n,summary:s}}function Pm(e){if(!v(e))return null;const t=r(e.id),n=r(e.title),s=r(e.tool),a=r(e.summary);return!t||!n||!s||!a?null:{id:t,title:n,tool:s,summary:a,success_signals:H(e.success_signals),pitfalls:H(e.pitfalls)}}function Lm(e){if(!v(e))return null;const t=r(e.id),n=r(e.title),s=r(e.summary),a=r(e.when_to_use);return!t||!n||!s||!a?null:{id:t,title:n,summary:s,when_to_use:a,steps:Array.isArray(e.steps)?e.steps.map(Pm).filter(o=>o!==null):[]}}function Mm(e){if(!v(e))return null;const t=r(e.id),n=r(e.title),s=r(e.description);return!t||!n||!s?null:{id:t,title:n,description:s,tools:H(e.tools)}}function jm(e){if(!v(e))return null;const t=r(e.id),n=r(e.title),s=r(e.symptom),a=r(e.why),o=r(e.fix_tool),l=r(e.fix_summary);return!t||!n||!s||!a||!o||!l?null:{id:t,title:n,symptom:s,why:a,fix_tool:o,fix_summary:l}}function Em(e){if(!v(e))return null;const t=r(e.id),n=r(e.title),s=r(e.path_id),a=r(e.transport);return!t||!n||!s||!a?null:{id:t,title:n,path_id:s,transport:a,request:e.request,response:e.response,notes:H(e.notes)}}function Nm(e){const t=v(e)?e:{};return{version:r(t.version),generated_at:r(t.generated_at),docs:Array.isArray(t.docs)?t.docs.map(zm).filter(n=>n!==null):[],concepts:Array.isArray(t.concepts)?t.concepts.map(Rm).filter(n=>n!==null):[],golden_paths:Array.isArray(t.golden_paths)?t.golden_paths.map(Lm).filter(n=>n!==null):[],tool_groups:Array.isArray(t.tool_groups)?t.tool_groups.map(Mm).filter(n=>n!==null):[],pitfalls:Array.isArray(t.pitfalls)?t.pitfalls.map(jm).filter(n=>n!==null):[],examples:Array.isArray(t.examples)?t.examples.map(Em).filter(n=>n!==null):[]}}function wm(e){if(!v(e))return null;const t=r(e.id),n=r(e.title),s=r(e.status),a=r(e.detail),o=r(e.next_tool);return!t||!n||!s||!a||!o?null:{id:t,title:n,status:s,detail:a,next_tool:o}}function Dm(e){if(!v(e))return null;const t=r(e.code),n=r(e.severity),s=r(e.title),a=r(e.detail),o=r(e.next_tool);return!t||!n||!s||!a||!o?null:{code:t,severity:n,title:s,detail:a,next_tool:o}}function Om(e){if(!v(e))return null;const t=r(e.from),n=r(e.content),s=r(e.timestamp),a=d(e.seq);return!t||!n||!s||a==null?null:{seq:a,from:t,content:n,timestamp:s}}function qm(e){if(!v(e))return null;const t=r(e.name),n=r(e.role),s=r(e.lane),a=r(e.status),o=r(e.claim_marker),l=r(e.done_marker),c=r(e.final_marker);if(!t||!n||!s||!a||!o||!l||!c)return null;const p=(()=>{if(!v(e.last_message))return null;const m=d(e.last_message.seq),u=r(e.last_message.content),_=r(e.last_message.timestamp);return m==null||!u||!_?null:{seq:m,content:u,timestamp:_}})();return{name:t,role:n,lane:s,joined:N(e.joined)??!1,live_presence:N(e.live_presence)??!1,completed:N(e.completed)??!1,status:a,current_task:r(e.current_task)??null,bound_task_id:r(e.bound_task_id)??null,bound_task_title:r(e.bound_task_title)??null,bound_task_status:r(e.bound_task_status)??null,current_task_matches_run:N(e.current_task_matches_run)??!1,squad_member:N(e.squad_member)??!1,detachment_member:N(e.detachment_member)??!1,last_seen:r(e.last_seen)??null,heartbeat_age_sec:d(e.heartbeat_age_sec)??null,heartbeat_fresh:N(e.heartbeat_fresh)??!1,claim_marker_seen:N(e.claim_marker_seen)??!1,done_marker_seen:N(e.done_marker_seen)??!1,final_marker_seen:N(e.final_marker_seen)??!1,claim_marker:o,done_marker:l,final_marker:c,last_message:p}}function Fm(e){if(!v(e))return;const t=Array.isArray(e.timeline)?e.timeline.map(n=>{if(!v(n))return null;const s=r(n.timestamp),a=d(n.active_slots);if(!s||a==null)return null;const o=Array.isArray(n.active_slot_ids)?n.active_slot_ids.map(l=>typeof l=="number"&&Number.isFinite(l)?l:null).filter(l=>l!=null):[];return{timestamp:s,active_slots:a,active_slot_ids:o}}).filter(n=>n!==null):[];return{slot_url:r(e.slot_url)??null,provider_base_url:r(e.provider_base_url)??null,provider_reachable:N(e.provider_reachable)??null,provider_status_code:d(e.provider_status_code)??null,provider_model_id:r(e.provider_model_id)??null,actual_model_id:r(e.actual_model_id)??null,expected_slots:d(e.expected_slots),actual_slots:d(e.actual_slots),expected_ctx:d(e.expected_ctx),actual_ctx:d(e.actual_ctx),slot_reachable:N(e.slot_reachable)??null,slot_status_code:d(e.slot_status_code)??null,runtime_blocker:r(e.runtime_blocker)??null,detail:r(e.detail)??null,checked_at:r(e.checked_at)??null,total_slots:d(e.total_slots),ctx_per_slot:d(e.ctx_per_slot),active_slots_now:d(e.active_slots_now),peak_active_slots:d(e.peak_active_slots),sample_count:d(e.sample_count),last_sample_at:r(e.last_sample_at)??null,timeline:t}}function Km(e){if(!v(e))return null;const t=r(e.run_id),n=r(e.status),s=r(e.decided_by),a=r(e.decided_at),o=r(e.reason);if(!t||!n||!s||!a||!o)return null;const l=[];return Array.isArray(e.history)&&e.history.forEach(c=>{if(!v(c))return;const p=r(c.status),m=r(c.decided_by),u=r(c.decided_at),_=r(c.reason);!p||!m||!u||!_||l.push({status:p,decided_by:m,decided_at:u,reason:_,operation_id:r(c.operation_id)??null,detachment_id:r(c.detachment_id)??null,note:r(c.note)??null})}),{run_id:t,status:n,decided_by:s,decided_at:a,reason:o,operation_id:r(e.operation_id)??null,detachment_id:r(e.detachment_id)??null,note:r(e.note)??null,history:l}}function Bm(e){if(!v(e))return null;const t=r(e.run_id),n=r(e.recommended_kind),s=r(e.reason);return!t||!n||!s?null:{run_id:t,recommended_kind:n,continue_available:N(e.continue_available)??!1,rerun_available:N(e.rerun_available)??!1,abandon_available:N(e.abandon_available)??!1,reason:s,evidence:v(e.evidence)?{operation_id:r(e.evidence.operation_id)??null,detachment_id:r(e.evidence.detachment_id)??null,joined_workers:d(e.evidence.joined_workers),current_task_bound:d(e.evidence.current_task_bound),fresh_heartbeats:d(e.evidence.fresh_heartbeats),trace_events:d(e.evidence.trace_events),message_events:d(e.evidence.message_events),runtime_blocker:r(e.evidence.runtime_blocker)??null}:void 0,provenance:r(e.provenance),decision_engine:r(e.decision_engine),authoritative:N(e.authoritative)}}function Um(e){const t=v(e)?e:{},n=v(t.summary)?t.summary:void 0;return{version:r(t.version),generated_at:r(t.generated_at),run_id:r(t.run_id),room_id:r(t.room_id),operation_id:r(t.operation_id)??null,run_resolution:Km(t.run_resolution),resolution_recommendation:Bm(t.resolution_recommendation),recommended_next_tool:r(t.recommended_next_tool),summary:n?{expected_workers:d(n.expected_workers),joined_workers:d(n.joined_workers),live_workers:d(n.live_workers),squad_roster_size:d(n.squad_roster_size),detachment_roster_size:d(n.detachment_roster_size),current_task_bound:d(n.current_task_bound),fresh_heartbeats:d(n.fresh_heartbeats),claim_markers_seen:d(n.claim_markers_seen),done_markers_seen:d(n.done_markers_seen),final_markers_seen:d(n.final_markers_seen),completed_workers:d(n.completed_workers),peak_hot_slots:d(n.peak_hot_slots),hot_window_ok:N(n.hot_window_ok),pass_hot_concurrency:N(n.pass_hot_concurrency),pass_end_to_end:N(n.pass_end_to_end),pending_decisions:d(n.pending_decisions),pass:N(n.pass)}:void 0,provider:Fm(t.provider),operation:ja(t.operation),squad:ro(t.squad),detachment:Dl(t.detachment),workers:Array.isArray(t.workers)?t.workers.map(qm).filter(s=>s!==null):[],checklist:Array.isArray(t.checklist)?t.checklist.map(wm).filter(s=>s!==null):[],blockers:Array.isArray(t.blockers)?t.blockers.map(Dm).filter(s=>s!==null):[],recent_messages:Array.isArray(t.recent_messages)?t.recent_messages.map(Om).filter(s=>s!==null):[],recent_trace_events:Array.isArray(t.recent_trace_events)?t.recent_trace_events.map(Kl).filter(s=>s!==null):[],truth_notes:H(t.truth_notes)}}function Hm(e){if(!v(e))return null;const t=r(e.label),n=r(e.value);return!t||!n?null:{label:t,value:n}}function Wm(e){if(!v(e))return null;const t=r(e.id),n=r(e.kind),s=r(e.label),a=r(e.tone),o=r(e.provenance);return!t||!n||!s||!a||!o?null:{id:t,kind:n,label:s,subtitle:r(e.subtitle)??null,status:r(e.status)??null,tone:a,pulse:r(e.pulse)??null,provenance:o,visual_class:r(e.visual_class)??void 0,glyph:r(e.glyph)??void 0,parent_id:r(e.parent_id)??null,lane_id:r(e.lane_id)??null,link_tab:r(e.link_tab)??null,link_surface:r(e.link_surface)??null,link_params:v(e.link_params)?Object.fromEntries(Object.entries(e.link_params).map(([l,c])=>{const p=r(c);return p?[l,p]:null}).filter(l=>l!==null)):{},facts:Array.isArray(e.facts)?e.facts.map(Hm).filter(l=>l!==null):[]}}function Gm(e){if(!v(e))return null;const t=r(e.id),n=r(e.source),s=r(e.target),a=r(e.kind),o=r(e.tone),l=r(e.provenance);return!t||!n||!s||!a||!o||!l?null:{id:t,source:n,target:s,kind:a,label:r(e.label)??null,tone:o,provenance:l,animated:N(e.animated)}}function Jm(e){if(!v(e))return null;const t=r(e.id),n=r(e.kind),s=r(e.label),a=r(e.tone),o=r(e.provenance);return!t||!n||!s||!a||!o?null:{id:t,kind:n,label:s,detail:r(e.detail)??null,tone:a,provenance:o,source_id:r(e.source_id)??null,target_id:r(e.target_id)??null,suggested_surface:r(e.suggested_surface)??null,suggested_params:v(e.suggested_params)?Object.fromEntries(Object.entries(e.suggested_params).map(([l,c])=>{const p=r(c);return p?[l,p]:null}).filter(l=>l!==null)):{}}}function Vm(e){if(!v(e))return null;const t=r(e.target_kind),n=r(e.target_id),s=r(e.label),a=r(e.reason);return!t||!n||!s||!a?null:{target_kind:t,target_id:n,label:s,reason:a,suggested_surface:r(e.suggested_surface)??null,suggested_params:v(e.suggested_params)?Object.fromEntries(Object.entries(e.suggested_params).map(([o,l])=>{const c=r(l);return c?[o,c]:null}).filter(o=>o!==null)):{}}}function Ym(e){const t=v(e)?e:{},n=v(t.room)?t.room:{},s=v(t.summary)?t.summary:void 0;return{version:r(t.version),generated_at:r(t.generated_at),room:{room_id:r(n.room_id),project:r(n.project),cluster:r(n.cluster),paused:N(n.paused),pause_reason:r(n.pause_reason)??null,agent_count:d(n.agent_count),task_count:d(n.task_count),message_count:d(n.message_count)},summary:s?{session_count:d(s.session_count),operation_count:d(s.operation_count),detachment_count:d(s.detachment_count),lane_count:d(s.lane_count),worker_count:d(s.worker_count),keeper_count:d(s.keeper_count),signal_count:d(s.signal_count),alert_count:d(s.alert_count)}:void 0,nodes:Array.isArray(t.nodes)?t.nodes.map(Wm).filter(a=>a!==null):[],edges:Array.isArray(t.edges)?t.edges.map(Gm).filter(a=>a!==null):[],signals:Array.isArray(t.signals)?t.signals.map(Jm).filter(a=>a!==null):[],focus:Vm(t.focus),swarm_status:lo(t.swarm_status),swarm_proof:Bl(t.swarm_proof),truth_notes:H(t.truth_notes)}}function at(e){G.value=e,oo(e)&&Xm()}async function Wl(){Zs.value=!0,ta.value=null;try{const e=await jd();ao.value=km(e)}catch(e){ta.value=e instanceof Error?e.message:"Failed to load command-plane summary"}finally{Zs.value=!1}}function co(e){Qt.value=e}async function uo(){ea.value=!0,na.value=null;try{const e=await Md();qe.value=bm(e)}catch(e){na.value=e instanceof Error?e.message:"Failed to load command-plane snapshot"}finally{ea.value=!1}}async function Xm(){qe.value||ea.value||await uo()}async function Kt(){await Wl(),oo(G.value)&&await uo()}async function Zt(){var e;Ni.value=!0,la.value=null;try{const t=await Ed(),n=Am(t);ss.value=n;const s=Qt.value;n.operations.length===0?Qt.value=null:(!s||!n.operations.some(a=>a.operation.operation_id===s))&&(Qt.value=((e=n.operations[0])==null?void 0:e.operation.operation_id)??null)}catch(t){la.value=t instanceof Error?t.message:"Failed to load chain summary"}finally{Ni.value=!1}}function Qm(){bn=null,Dn.value=null,ca.value=!1,On.value=null}async function Zm(e){bn=e,ca.value=!0,On.value=null;try{const t=await Nd(e);if(bn!==e)return;Dn.value=Tm(t)}catch(t){if(bn!==e)return;Dn.value=null,On.value=t instanceof Error?t.message:"Failed to load chain run"}finally{bn===e&&(ca.value=!1)}}async function ev(){ji.value=!0,aa.value=null;try{const e=await wd();ns.value=Nm(e)}catch(e){aa.value=e instanceof Error?e.message:"Failed to load command-plane help"}finally{ji.value=!1}}async function Qe(e=Ml(),t=jl()){ia.value=!0,oa.value=null;try{const n=await Dd(e,t);Mt.value=Um(n)}catch(n){oa.value=n instanceof Error?n.message:"Failed to load command-plane swarm view"}finally{ia.value=!1}}async function It(e=Ml(),t=jl()){Ei.value=!0,ra.value=null;try{const n=await Od(e,t);io.value=Ym(n)}catch(n){ra.value=n instanceof Error?n.message:"Failed to load orchestra map"}finally{Ei.value=!1}}async function mt(e,t,n){Mi.value=e,sa.value=null;try{await qd(t,n),await Wl(),(qe.value||oo(G.value))&&await uo(),await Qe(),await It(),await Zt()}catch(s){throw sa.value=s instanceof Error?s.message:"Failed to execute command-plane action",s}finally{Mi.value=null}}function tv(e){return mt(`pause:${e}`,"/api/v1/command-plane/operations/pause",{operation_id:e})}function nv(e){return mt(`resume:${e}`,"/api/v1/command-plane/operations/resume",{operation_id:e})}function sv(e){return mt(`recall:${e}`,"/api/v1/command-plane/dispatch/recall",{operation_id:e})}function av(e={}){return mt("dispatch:tick","/api/v1/command-plane/dispatch/tick",{...e.operationId?{operation_id:e.operationId}:{},...e.detachmentId?{detachment_id:e.detachmentId}:{}})}function iv(e){return mt(`approve:${e}`,"/api/v1/command-plane/policy/approve",{decision_id:e})}function ov(e){return mt(`deny:${e}`,"/api/v1/command-plane/policy/deny",{decision_id:e})}function rv(e,t){return mt(`freeze:${e}`,"/api/v1/command-plane/policy/freeze",{unit_id:e,enabled:t})}function lv(e,t){return mt(`kill:${e}`,"/api/v1/command-plane/policy/kill-switch",{unit_id:e,enabled:t})}Sp(()=>{Kt(),Zt(),(G.value==="swarm"||G.value==="warroom"||G.value==="orchestra"||Mt.value!==null)&&Qe(),(G.value==="orchestra"||io.value!==null)&&It(),G.value==="warroom"&&ye()});function wi(e){e==="command"&&(Kt(),Zt(),(G.value==="swarm"||G.value==="warroom"||G.value==="orchestra")&&Qe(),G.value==="orchestra"&&It(),G.value==="warroom"&&ye()),e==="mission"&&(zl(),Qs()),e==="proof"&&Pl(F.value.params.session_id,F.value.params.operation_id),e==="execution"&&Ct(),e==="intervene"&&(ye(),Pt()),e==="memory"&&nt(),e==="planning"&&no(),e==="lab"&&st()}function cv({metric:e}){return i`
  ...
  `}function dv({panel:e}){return i`
    <div class="semantic-body">
      ...
      ${e.metrics.length>0?i`<div class="semantic-metric-list">
            ${e.metrics.map(t=>i`<${cv} key=${t.id} metric=${t} />`)}
          </div>`:null}
    </div>
  `}function O({panelId:e,compact:t=!1,label:n="왜 필요한가"}){const s=bp(e);return s?i`
    <details class="semantic-inline ${t?"compact":""}">
      <summary class="semantic-summary">${n}</summary>
      <${dv} panel=${s} />
    </details>
  `:Gs.value?i`<span class="semantic-inline-state">의미 계층 불러오는 중…</span>`:null}function be({surfaceId:e,compact:t=!1}){const n=yp(e);return n?i`
  ...
  `}const da="masc_dashboard_workflow_context",uv=900*1e3;function ge(e){return typeof e=="string"&&e.trim()!==""?e.trim():null}function Ve(e){const t=ge(e);return t||(typeof e=="number"&&Number.isFinite(e)?String(e):null)}function Gl(){if(typeof window>"u")return null;try{return window.sessionStorage}catch{return null}}function Di(e){return v(e)?e:null}function pv(e){if(!e)return null;try{return JSON.stringify(e)}catch{return null}}function mv(e){if(!e)return null;try{const t=JSON.parse(e);if(!v(t))return null;const n=ge(t.id),s=ge(t.source_surface),a=ge(t.source_label),o=ge(t.summary),l=ge(t.created_at);return!n||s!=="mission"&&s!=="execution"||!a||!o||!l?null:{id:n,source_surface:s,source_label:a,action_type:ge(t.action_type),target_type:ge(t.target_type),target_id:ge(t.target_id),focus_kind:ge(t.focus_kind),operation_id:ge(t.operation_id),command_surface:ge(t.command_surface),summary:o,payload_preview:ge(t.payload_preview),suggested_payload:Di(t.suggested_payload),preview:t.preview??null,evidence:t.evidence??null,created_at:l}}catch{return null}}function po(e){const t=Date.parse(e.created_at);return Number.isNaN(t)?!1:Date.now()-t<=uv}function vv(){const e=Gl(),t=mv((e==null?void 0:e.getItem(da))??null);return t?po(t)?t:(e==null||e.removeItem(da),null):null}const Jl=f(vv());function Vl(e){const t=e&&po(e)?e:null;Jl.value=t;const n=Gl();if(!n)return;if(!t){n.removeItem(da);return}const s=pv(t);s&&n.setItem(da,s)}function _v(e){if(!e)return null;const t=Di(e.suggested_payload);if(t)return t;if(v(e.preview)){const n=Di(e.preview.payload);if(n)return n}return null}function fv(e){if(!e)return null;const t=Ve(e.message);if(t)return t;const n=Ve(e.task_title)??Ve(e.title),s=Ve(e.task_description)??Ve(e.description),a=Ve(e.reason),o=Ve(e.priority)??Ve(e.task_priority);return n&&s?`${n} · ${s}`:n&&o?`${n} · P${o}`:n||s||a||null}function mo(e,t,n,s,a,o,l,c){return[e,t,n??"action",s??"target",a??"room",o??"focus",l??"operation",c].join(":")}function mn(e,t,n="상황판 추천 액션"){const s=new Date().toISOString(),a=_v(e),o=(e==null?void 0:e.target_type)??(t==null?void 0:t.target_type)??null,l=(e==null?void 0:e.target_id)??(t==null?void 0:t.target_id)??null,c=(t==null?void 0:t.kind)??(e==null?void 0:e.action_type)??null,p=(e==null?void 0:e.reason)??(t==null?void 0:t.summary)??n;return{id:mo("mission",n,(e==null?void 0:e.action_type)??null,o,l,c,null,s),source_surface:"mission",source_label:n,action_type:(e==null?void 0:e.action_type)??null,target_type:o,target_id:l,focus_kind:c,operation_id:null,command_surface:null,summary:p,payload_preview:fv(a),suggested_payload:a,preview:(e==null?void 0:e.preview)??null,evidence:(t==null?void 0:t.evidence)??null,created_at:s}}function gv({targetType:e,targetId:t,focusKind:n,sourceLabel:s="Execution 진단",summary:a,operationId:o=null,commandSurface:l=null}){const c=new Date().toISOString();return{id:mo("execution",s,null,e,t,n,o,c),source_surface:"execution",source_label:s,action_type:null,target_type:e,target_id:t,focus_kind:n,operation_id:o,command_surface:l,summary:a,payload_preview:null,suggested_payload:null,preview:null,evidence:null,created_at:c}}function $v(e,t){return(t.source==="mission"||t.source==="execution")&&(t.action_type??null)===(e.action_type??null)&&(t.target_type??null)===(e.target_type??null)&&(t.target_id??null)===(e.target_id??null)&&(t.focus_kind??null)===(e.focus_kind??null)&&(t.operation_id??null)===(e.operation_id??null)}function as(e){const{params:t}=e;if(t.source!=="mission"&&t.source!=="execution")return null;const n=Jl.value;if(n&&po(n)&&$v(n,t))return n;const s=new Date().toISOString(),a=t.source==="execution"?"execution":"mission";return{id:mo(a,a==="execution"?"Execution 이어보기":"상황판 이어보기",t.action_type??null,t.target_type??null,t.target_id??null,t.focus_kind??null,t.operation_id??null,s),source_surface:a,source_label:a==="execution"?"Execution 이어보기":"상황판 이어보기",action_type:t.action_type??null,target_type:t.target_type??null,target_id:t.target_id??null,focus_kind:t.focus_kind??t.action_type??null,operation_id:t.operation_id??null,command_surface:t.surface??null,summary:a==="execution"?t.focus_kind?`${t.focus_kind} 기준으로 열린 execution 컨텍스트입니다.`:"Execution에서 이어진 컨텍스트입니다.":t.focus_kind?`${t.focus_kind} 기준으로 열린 컨텍스트입니다.`:"상황판에서 이어진 컨텍스트입니다.",payload_preview:null,suggested_payload:null,preview:null,evidence:null,created_at:s}}function Yl(e){return{source:e.source_surface,...e.action_type?{action_type:e.action_type}:{},...e.target_type?{target_type:e.target_type}:{},...e.target_id?{target_id:e.target_id}:{},...e.focus_kind?{focus_kind:e.focus_kind}:{},...e.operation_id?{operation_id:e.operation_id}:{}}}function Xl(e){if(e.command_surface)return e.command_surface;const t=[e.focus_kind,e.summary,e.action_type].filter(n=>typeof n=="string"&&n.trim()!=="").join(" ").toLowerCase();return t.includes("artifact_scope")||t.includes("routing_confidence")||t.includes("cache_contention")?"summary":t.includes("stale_data")||t.includes("leader_offline")||t.includes("roster_offline")||t.includes("managed")||t.includes("swarm")?"swarm":e.focus_kind==="operation"||e.target_type==="operation"?"operations":e.target_type==="room"?"orchestra":"swarm"}function Ql(e){return{source:e.source_surface,surface:Xl(e),...e.action_type?{action_type:e.action_type}:{},...e.target_type?{target_type:e.target_type}:{},...e.target_id?{target_id:e.target_id}:{},...e.focus_kind?{focus_kind:e.focus_kind}:{},...e.operation_id?{operation_id:e.operation_id}:{}}}function hv(e){return Yl(e)}function yv(e){return Ql(e)}function vo(e){return e!=null&&e.target_type?e.target_id?`${e.target_type} · ${e.target_id}`:e.target_type:"대상 정보 없음"}function Ea(e){switch(e){case"broadcast":return"room 방송";case"room_pause":return"room 일시정지";case"room_resume":return"room 재개";case"task_inject":return"room 작업 주입";case"team_turn":return"session 업데이트";case"team_note":return"session 노트";case"team_broadcast":return"session 방송";case"team_task_inject":return"session 작업";case"team_stop":return"session 중지";case"keeper_msg":case"keeper_message":return"keeper 메시지";case"keeper_probe":return"keeper probe";case"keeper_recover":return"keeper recover";case"swarm_run_continue":return"swarm run 계속";case"swarm_run_rerun":return"swarm run 재실행";case"swarm_run_abandon":return"swarm run 포기";default:return(e==null?void 0:e.trim())||"추천 액션"}}function bv(e){switch(e){case"warroom":return"워룸";case"summary":return"요약";case"orchestra":return"오케스트라";case"swarm":return"스웜";case"chains":return"체인";case"topology":return"토폴로지";case"alerts":return"알림";case"trace":return"트레이스";case"control":return"제어";case"operations":return"작전";default:return(e==null?void 0:e.trim())||"지휘"}}const Be=f(null),Ze=f(null);function Re(e,t=120){const n=(e??"").replace(/\s+/g," ").trim();return n?n.length>t?`${n.slice(0,t-1)}…`:n:null}function ve(e){return e==="bad"||e==="offline"||e==="critical"||e==="risk"?"bad":e==="warn"||e==="pending"||e==="degraded"||e==="interrupted"||e==="watch"?"warn":"ok"}function Ne(e){if(!e)return"방금";const t=Date.parse(e);if(Number.isNaN(t))return e;const n=Math.max(0,Math.round((Date.now()-t)/1e3));return n<60?`${n}초 전`:n<3600?`${Math.round(n/60)}분 전`:n<86400?`${Math.round(n/3600)}시간 전`:`${Math.round(n/86400)}일 전`}function kv(e){return typeof e!="number"||!Number.isFinite(e)||e<0?"확인 필요":e<60?`${Math.round(e)}초`:e<3600?`${Math.round(e/60)}분`:e<86400?`${Math.round(e/3600)}시간`:`${Math.round(e/86400)}일`}function we(e){switch((e??"").trim().toLowerCase()){case"ok":case"healthy":case"green":return"안정";case"active":case"running":return"진행 중";case"pending":return"대기 중";case"paused":return"일시정지";case"blocked":return"막힘";case"interrupted":return"중단됨";case"warn":case"watch":return"주의";case"bad":case"critical":case"risk":return"위험";case"degraded":return"저하";case"offline":return"오프라인";case"idle":case"quiet":return"대기";case"loading":return"불러오는 중";case"error":return"오류";case"unavailable":return"사용 불가";case"stale":return"오래됨";case"refreshing":return"갱신 중";case"cached":return"캐시";case"unknown":case"":return"확인 필요";default:return(e==null?void 0:e.trim())||"확인 필요"}}function ua(e){switch((e??"").trim().toLowerCase()){case"room":return"방";case"team_session":case"session":return"세션";case"operation":return"작전";case"keeper":return"키퍼";case"agent":return"에이전트";default:return(e==null?void 0:e.trim())||"대상"}}function Jo(e){switch((e??"").trim().toLowerCase()){case"metadata_gap":return"메타데이터 부족";case"mixed":return"신호 혼재";case"":return null;default:return(e==null?void 0:e.trim())||null}}function xv(e){return e!=null&&e.confirm_required?"확인 후 실행":"즉시 실행"}function Sv(e){return vo(e?mn(e,null,"상황판 추천 액션"):null)}function Na(e,t=mn()){Vl(t),se(e,e==="intervene"?hv(t):yv(t))}function Zl(e){Na("intervene",mn(null,e,"상황판 incident"))}function ec(e){Na("command",mn(null,e,"상황판 incident"))}function _o(e,t,n="상황판 추천 액션"){Na("intervene",mn(e,t,n))}function tc(e,t,n="상황판 추천 액션"){Na("command",mn(e,t,n))}function Oi(e,t){const n={source:"mission",target_type:"team_session",target_id:t,focus_kind:"team_session"};e==="command"&&(n.surface="swarm"),se(e,n)}function Cv(e){return{kind:e.kind,severity:e.severity,summary:e.summary,target_type:e.target_type,target_id:e.target_id??null,actor:null,evidence:e.evidence_preview}}function Av(e){var n,s;const t=pt.value.find(a=>a.name===e.name||a.agent_name===e.agent_name)??null;return{brief:e,keeper:t,currentWork:Re(e.current_work,110)??Re(t==null?void 0:t.skill_primary,110)??Re(t==null?void 0:t.last_proactive_reason,110)??"명시된 키퍼 초점 없음",recentInput:Re(t==null?void 0:t.recent_input_preview,120)??null,recentOutput:Re(t==null?void 0:t.recent_output_preview,120)??Re((n=t==null?void 0:t.diagnostic)==null?void 0:n.last_reply_preview,120)??Re(t==null?void 0:t.last_proactive_preview,120)??null,recentEvent:Re(t==null?void 0:t.last_proactive_reason,120)??Re((s=t==null?void 0:t.diagnostic)==null?void 0:s.summary,120)??null,recentTools:(t==null?void 0:t.recent_tool_names)??[]}}function Iv(){const e=ts.value;if(!e)return new Map;const t=e.sessions.length>0?e.sessions:e.session_briefs;return new Map(t.map(n=>[n.session_id,n]))}function Tv(e){Be.value=Be.value===e?null:e,Ze.value=null}function nc(e){Ze.value=Ze.value===e?null:e,Be.value=null}function zv(){Be.value=null,Ze.value=null}function Rv(e){switch(e.trim().toLowerCase()){case"active":case"running":return"가동 중";case"working":return"작업 중";case"watching":return"관찰 중";case"quiet":return"조용함";case"idle":return"유휴";case"ok":case"healthy":return"정상";case"warn":case"warning":case"degraded":return"주의";case"bad":case"critical":case"error":case"failed":return"위험";case"blocked":return"막힘";case"paused":return"일시정지";case"pending":return"대기";case"offline":case"inactive":return"오프라인";case"connected":return"연결됨";case"disconnected":return"끊김";case"ready":return"준비됨";case"done":case"completed":return"완료";case"unknown":return"알 수 없음";default:return e}}function vt({status:e,label:t}){return i`
    <span class="status-badge ${e}">
      <span class="status-dot-inline ${e}"></span>
      ${t??Rv(e)}
    </span>
  `}function sc(e){const t=Date.now(),n=typeof e=="number"?e<1e12?e*1e3:e:new Date(e).getTime(),s=Math.floor((t-n)/1e3);if(s<60)return`${s}초 전`;const a=Math.floor(s/60);if(a<60)return`${a}분 전`;const o=Math.floor(a/60);return o<24?`${o}시간 전`:`${Math.floor(o/24)}일 전`}function J({timestamp:e}){const t=sc(e),n=typeof e=="string"?e:new Date(e<1e12?e*1e3:e).toISOString();return i`<span class="time-ago" title=${n}>${t}</span>`}let Pv=0;const Tt=f([]);function E(e,t="success",n=4e3){const s=++Pv;Tt.value=[...Tt.value,{id:s,message:e,type:t}],setTimeout(()=>{Tt.value=Tt.value.filter(a=>a.id!==s)},n)}function Lv(e){Tt.value=Tt.value.filter(t=>t.id!==e)}function Mv(){const e=Tt.value;return e.length===0?null:i`
    <div class="toast-container">
      ${e.map(t=>i`
        <div key=${t.id} class="toast ${t.type}" onClick=${()=>Lv(t.id)}>
          ${t.message}
        </div>
      `)}
    </div>
  `}const jv="masc_dashboard_agent_name",vn=f(null),pa=f(!1),qn=f(""),ma=f([]),Fn=f([]),en=f(""),In=f(!1);function wa(e){vn.value=e,fo()}function Vo(){vn.value=null,qn.value="",ma.value=[],Fn.value=[],en.value=""}function Ev(){const e=vn.value;return e?Ge.value.find(t=>t.name===e)??null:null}function ac(e){return e?et.value.filter(t=>t.assignee===e):[]}function ic(e){return e?pt.value.find(t=>t.agent_name===e||t.name===e)??null:null}function Nv(e){if(!e)return null;const t=ts.value;return t?t.agent_briefs.find(n=>n.agent_name===e)??null:null}function wv(e){if(!e)return[];const t=e.metrics_window;return(Array.isArray(t==null?void 0:t.top_tools)?t.top_tools:[]).map(s=>typeof s=="object"&&s!==null&&"tool"in s&&typeof s.tool=="string"?s.tool:null).filter(s=>s!==null)}function Dv(e){const t=ic(e);return t?t.recent_tool_names&&t.recent_tool_names.length>0?t.recent_tool_names:[]:[]}async function fo(){const e=vn.value;if(e){pa.value=!0,qn.value="",ma.value=[],Fn.value=[];try{const t=await yu(80);ma.value=t.filter(a=>a.includes(e)).slice(0,20);const n=ac(e).slice(0,6);if(n.length===0)return;const s=await Promise.all(n.map(async a=>{try{const o=await bu(a.id,25);return{taskId:a.id,text:o.trim()}}catch(o){const l=o instanceof Error?o.message:"history load failed";return{taskId:a.id,text:`Failed to load history: ${l}`}}}));Fn.value=s}catch(t){qn.value=t instanceof Error?t.message:"Failed to load agent detail"}finally{pa.value=!1}}}async function Yo(){var s;const e=vn.value,t=en.value.trim();if(!e||!t)return;const n=((s=localStorage.getItem(jv))==null?void 0:s.trim())||"dashboard";In.value=!0;try{await hu(n,`@${e} ${t}`),en.value="",E(`Mention sent to ${e}`,"success"),fo()}catch(a){const o=a instanceof Error?a.message:"Failed to send mention";E(o,"error")}finally{In.value=!1}}function Ov({task:e}){return i`
    <div class="agent-detail-task">
      <span class="pill">${e.id}</span>
      <span class="agent-detail-task-title">${e.title}</span>
      <${vt} status=${e.status} />
    </div>
  `}function qv({row:e}){return i`
  ...
  `}function Fv(){var C,x,L,T,R,M,z;const e=vn.value;if(!e)return null;const t=Ev(),n=ic(e),s=Nv(e),a=ac(e),o=ma.value,l=Dv(e),c=wv(n),p=(s==null?void 0:s.allowed_tool_names)??[],m=(s==null?void 0:s.latest_tool_names)??[],u=s==null?void 0:s.latest_tool_call_count,_=s==null?void 0:s.tool_audit_source,g=s==null?void 0:s.tool_audit_at,h=(t==null?void 0:t.capabilities)??[],b=((C=te.value)==null?void 0:C.room)??"default",$=((x=te.value)==null?void 0:x.project)??"확인 없음",S=((L=te.value)==null?void 0:L.cluster)??"확인 없음";return i`
    <div
      class="agent-detail-overlay"
      data-testid="agent-detail-overlay"
      onClick=${j=>{j.target.classList.contains("agent-detail-overlay")&&Vo()}}
    >
      <div class="agent-detail-modal">
        <div class="agent-detail-header">
          ...
          <div class="agent-detail-actions">
            <button class="control-btn ghost" onClick=${()=>{fo()}} disabled=${pa.value}>
        ...
        ${qn.value?i`<div class="council-error">${qn.value}</div>`:null}

        <div class="agent-detail-grid">
          <${I} title="Assigned Tasks">
            ${a.length===0?i`<div class="empty-state">No assigned tasks</div>`:i`<div class="agent-detail-task-list">${a.map(j=>i`<${Ov} key=${j.id} task=${j} />`)}</div>`}
          <//>
        ...
        <${I} title="Task History">
          ${Fn.value.length===0?i`<div class="empty-state">No task history loaded</div>`:i`<div class="agent-history-list">${Fn.value.map(j=>i`<${qv} key=${j.taskId} row=${j} />`)}</div>`}
        <//>
        ...
        <${I} title="Direct Mention">
          <div class="agent-mention-row">
            <input
              ...
              value=${en.value}
              onInput=${j=>{en.value=j.target.value}}
              onKeyDown=${j=>{j.key==="Enter"&&Yo()}}
              disabled=${In.value}
            />
            <button
              class="control-btn"
              onClick=${()=>{Yo()}}
              disabled=${In.value||en.value.trim()===""}
            >
              ${In.value?"Sending...":"Send"}
            </button>
          </div>
        <//>
      </div>
    </div>
  `}function Kv(e){switch(e){case"quiet_hours":return"quiet hours";case"min_gap":return"cooldown gate";case"no_recent_activity":return"waiting for activity";case"disabled":return"runtime disabled";case"startup":return"warming up";case"llm_error":return"llm error";case"graphql_error":return"graphql error";case"never_started":return"never started";default:return"unknown"}}function Bv(e){switch(e){case"manual_lodge_poke":return"Poke Lodge";case"probe":return"Probe";case"recover":return"Recover";default:return"Message"}}function Uv(e){switch(e.delivery){case"sending":return"sending";case"timeout":return"timeout";case"error":return"error";case"delivered":return"delivered";default:return e.role}}function Xo(e){return e.delivery==="error"||e.delivery==="timeout"?"bad":e.delivery==="sending"?"warn":e.role==="assistant"?"assistant":e.role==="user"?"user":"warn"}function oc(e){if(!e)return null;const t=new Date(e);return Number.isNaN(t.getTime())?null:t.toLocaleTimeString()}function Hv(e){return typeof e!="number"||!Number.isFinite(e)||e<=0?null:e<60?`${Math.round(e)}s`:`${Math.ceil(e/60)}m`}function rc(e){if(!e)return null;const t=He.value[e.name];return(t==null?void 0:t.diagnostic)??e.diagnostic??null}function Wv({keeper:e,showRawStatus:t=!1}){if(ne(()=>{e!=null&&e.name&&Xr(e.name)},[e==null?void 0:e.name]),!e)return i`<div class="control-status-copy">Select a keeper to inspect direct reply state.</div>`;const n=He.value[e.name],s=rc(e),a=bi.value[e.name];return i`
    <div class="control-result-box">
      <div class="control-inline-meta">
        <span class="pill">${(s==null?void 0:s.health_state)??"unknown"}</span>
        <span class="pill">${Kv(s==null?void 0:s.quiet_reason)}</span>
        <span class="pill">next ${Bv((s==null?void 0:s.next_action_path)??"direct_message")}</span>
      ...
      <div class="control-status-copy">
        ...
        ${s!=null&&s.last_reply_at?i` · ${oc(s.last_reply_at)}`:null}
        ${s!=null&&s.next_eligible_at_s?i` · next eligible ${Hv(s.next_eligible_at_s)}`:null}
      </div>
  ...
  `}function Gv({keeperName:e,placeholder:t}){const[n,s]=Rr("");ne(()=>{e&&Xr(e)},[e]);const a=de.value[e]??[],o=ki.value[e]??!1,l=We.value[e],c=async()=>{const p=n.trim();if(!(!e||!p)){s("");try{await Fu(e,p)}catch(m){const u=m instanceof Error?m.message:`Failed to message ${e}`;E(u,"error")}}};return i`
        ...
        ${a.length===0?i`<div class="control-status-copy">No direct keeper conversation yet.</div>`:a.map(p=>i`
              <div class="keeper-conversation-item" key=${p.id}>
                <div class="keeper-conversation-meta">
                  ...
                  <span class=${`keeper-role-chip ${Xo(p)}`}>${Uv(p)}</span>
                  ${p.timestamp?i`<span class="keeper-conversation-time">${oc(p.timestamp)}</span>`:null}
                </div>
  ...
  `}function Jv({actor:e,keeper:t,onPokeLodge:n}){if(!t)return null;const s=rc(t),a=xi.value[t.name]??!1,o=Si.value[t.name]??!1,l=(s==null?void 0:s.next_action_path)??"direct_message",c=(s==null?void 0:s.recoverable)??l==="recover";return i`
    <div class="control-actions">
      <button
        class=${`control-btn ghost ${l==="probe"?"is-active":""}`}
        onClick=${()=>{Ku(t.name,e).catch(p=>{const m=p instanceof Error?p.message:`Failed to probe ${t.name}`;E(m,"error")})}}
        disabled=${a||!e.trim()}
      >
        ${a?"Probing...":"Probe"}
      </button>
      <button
        ...
        onClick=${()=>{Bu(t.name,e).catch(p=>{const m=p instanceof Error?p.message:`Failed to recover ${t.name}`;E(m,"error")})}}
        disabled=${o||!c||!e.trim()}
      >
  ...
  `}const go=f(null);function lc(e){go.value=e,qu(e.name)}function Qo(){go.value=null}const wt=[{level:"L1_Reactive",label:"L1 Reactive",color:"#6b7280"},{level:"L2_Suggestive",label:"L2 Suggestive",color:"#3b82f6"},{level:"L3_Guided",label:"L3 Guided",color:"#f59e0b"},{level:"L4_Autonomous",label:"L4 Autonomous",color:"#f97316"},{level:"L5_Independent",label:"L5 Independent",color:"#ef4444"}];function Vv(e){if(!e)return 0;const t=wt.findIndex(n=>n.level===e);return t>=0?t:0}function Yv({keeper:e}){const t=Vv(e.autonomy_level),n=wt[t]??wt[0];if(!n)return null;const s=(t+1)/wt.length*100;return i`
  ...
  `}function ws(e){return e?e>=1e6?`${(e/1e6).toFixed(1)}M`:e>=1e3?`${(e/1e3).toFixed(1)}K`:String(e):"—"}function Xv(e){switch(e){case"keeper_message":return"message";case"keeper_probe":return"probe";case"keeper_recover":return"recover";case"broadcast":return"broadcast";case"room_pause":return"pause";case"room_resume":return"resume";case"lodge_tick":return"lodge";default:return(e==null?void 0:e.trim())||"action"}}function Qv(e){return e.recent_tool_names&&e.recent_tool_names.length>0?e.recent_tool_names:[]}function Zv(e){const t=e.metrics_window;return(Array.isArray(t==null?void 0:t.top_tools)?t.top_tools:[]).map(s=>typeof s=="object"&&s!==null&&"tool"in s&&typeof s.tool=="string"?s.tool:null).filter(s=>s!==null)}function e_(e){const t=ts.value;return t?t.keeper_briefs.find(n=>n.name===e.name||n.agent_name&&e.agent_name&&n.agent_name===e.agent_name)??null:null}function t_({keeper:e}){const t=e.metrics_series??[],n=t[t.length-1],s=(n==null?void 0:n.cost_usd)!=null?`$${n.cost_usd.toFixed(4)}`:"—",a=[{label:"Generation",value:e.generation??"-",hint:"Succession count"},{label:"Turns",value:e.turn_count??"-",hint:"Total loop turns"},{label:"Context",value:e.context_ratio!=null?`${Math.round(e.context_ratio*100)}%`:"-",hint:e.context_ratio!=null&&e.context_ratio>.8?"Near limit":void 0},{label:"Activity",value:e.activityLevel??"-",hint:"Level 0–5"}];return i`
  ...
  `}function n_({keeper:e}){var u,_;const t=e.metrics_series??[];if(t.length<2){const g=(((u=e.context)==null?void 0:u.context_ratio)??0)*100,h=g>85?"#ef4444":g>70?"#f59e0b":"#22c55e";return i`
  ...
  `}function a_({stats:e}){const t=e.max_hp>0?Math.round(e.hp/e.max_hp*100):0,n=e.max_mp>0?Math.round(e.mp/e.max_mp*100):0;return i`
    <div>
  ...
  `}function i_({items:e}){return e.length===0?i`<div class="empty-state" style="font-size:13px">No equipment</div>`:i`
  ...
  `}function o_({rels:e}){const t=Object.entries(e);return t.length===0?i`<div class="empty-state" style="font-size:13px">No relationships</div>`:i`
  ...
  `}function l_({keeper:e}){var $,S,C,x,L,T,R;const t=(($=_e.value)==null?void 0:$.room)??{},n=(((S=_e.value)==null?void 0:S.available_actions)??[]).filter(M=>M.target_type==="keeper"||M.target_type==="room").slice(0,8),s=Qv(e),a=Zv(e),o=e_(e),l=(o==null?void 0:o.allowed_tool_names)??[],c=(o==null?void 0:o.latest_tool_names)??[],p=o==null?void 0:o.latest_tool_call_count,m=o==null?void 0:o.tool_audit_source,u=o==null?void 0:o.tool_audit_at,_=((C=e.agent)==null?void 0:C.capabilities)??[],g=t.current_room??t.room_id??((x=te.value)==null?void 0:x.room)??"default",h=t.project??((L=te.value)==null?void 0:L.project)??"확인 없음",b=t.cluster??((T=te.value)==null?void 0:T.cluster)??"확인 없음";return i`
    <div class="keeper-signal-list">
      ...
      <div style="display:flex; flex-direction:column; gap:8px; margin-top:8px;">
        ...
        <div style="display:flex; flex-wrap:wrap; gap:6px;">
          ${n.length>0?n.map(M=>i`<span class="pill">${Xv(M.action_type)}</span>`):i`<span style="font-size:12px; color:#888;">operator action 광고 없음</span>`}
        </div>
      </div>
    </div>
  `}function cc(){const e=new URLSearchParams(window.location.search),t=e.get("agent")??e.get("agent_name"),n=localStorage.getItem("masc_dashboard_agent_name");return(t??n??"dashboard").trim()||"dashboard"}async function c_(){try{const e=await Pa({actor:cc(),action_type:"lodge_tick",target_type:"room",payload:{}}),t=Yr(e.result);await es(),t!=null&&t.skipped_reason?E(t.skipped_reason,"warning"):E(t?`Poke finished: ${t.acted}/${t.checked} acted`:"Poke finished",t&&t.acted>0?"success":"warning")}catch(e){const t=e instanceof Error?e.message:"Failed to run Lodge poke";E(t,"error")}}function d_({keeper:e}){return i`
  ...
  `}function u_(){var t,n,s;const e=go.value;return e?i`
    <div
  ...
  `:null}function p_({cluster:e,project:t,room:n,generatedAt:s}){return i`
  ...
  `}function m_(){const e=xl.value,t=ve((e==null?void 0:e.status)??(xt.value?"bad":"warn")),n=!e||e.sections.length===0,s=(e==null?void 0:e.status)==="error"||(e==null?void 0:e.status)==="unavailable"&&!(e!=null&&e.cached);return i`
    <${I} title="판단 레이어" class="mission-briefing-card" semanticId="mission.llm_briefing">
                ...
                <article class="mission-briefing-section ${ve(a.status)}">
                  <div class="mission-card-head">
                    ...
                    <div class="mission-briefing-section-chips">
                      ...
                      ${Jo(a.signal_class)?i`<span class="command-chip ${a.signal_class==="mixed"?"warn":""}">${Jo(a.signal_class)}</span>`:null}
      ...
      <div class="mission-card-actions">
        <button class="control-btn ghost" onClick=${()=>{Qs(s)}} disabled=${qt.value}>
          ${qt.value?"응답 기다리는 중…":"판단 다시 읽기"}
        </button>
        <button class="control-btn ghost" onClick=${()=>{Qs(!0)}} disabled=${qt.value}>
          강제 갱신
        </button>
      </div>
    <//>
  `}function v_({item:e,selected:t,sessionLookup:n}){const s=Cv(e),a=e.related_session_ids.map(l=>n.get(l)).filter(l=>l!=null),o=e.top_action??null;return i`
    <article class="mission-attention-card ${ve((o==null?void 0:o.severity)??e.severity)} ${t?"is-selected":""}">
      <button class="mission-card-select" onClick=${()=>Tv(e.id)}>
        <div class="mission-card-head">
          <div>
            ...
            <div class="mission-card-target">${ua(e.target_type)}${e.target_id?` · ${e.target_id}`:""}</div>
          </div>
          <span class="command-chip ${ve((o==null?void 0:o.severity)??e.severity)}">${o?xv(o):e.severity}</span>
        </div>
        ...
        <div class="mission-fact-grid">
          ...
          <div class="mission-fact-tile">
            ...
            <small>${ua(e.target_type)}</small>
          </div>
          <div class="mission-fact-tile">
            <span>다음 액션</span>
            <strong>${o?Ea(o.action_type):"판단 필요"}</strong>
            <small>${o?Sv(o):"추천 액션 없음"}</small>
          </div>
        </div>
      </button>
        ...
        ${e.related_agent_names.length>0?i`
              <div class="mission-pill-row">
                ${e.related_agent_names.slice(0,8).map(l=>i`
                  <button class="mission-pill action" onClick=${()=>wa(l)}>${l}</button>
                `)}
              </div>
            `:null}
      ...
      <div class="mission-card-actions">
        ${o?i`
              <button class="control-btn ghost" onClick=${()=>_o(o,s,"상황판 주의 신호")}>
                이 액션으로 개입 열기
              </button>
              <button class="control-btn ghost" onClick=${()=>tc(o,s,"상황판 주의 신호")}>
                원인 보기
              </button>
            `:i`
              <button class="control-btn ghost" onClick=${()=>Zl(s)}>이 이슈로 개입 열기</button>
              <button class="control-btn ghost" onClick=${()=>ec(s)}>이 이슈의 원인 보기</button>
            `}
      </div>
    </article>
  `}function __({brief:e,selected:t}){var o,l;const n=e.member_previews.slice(0,4),s=e.top_recommendation??null,a=e.top_attention??null;return i`
    <article class="mission-crew-card ${ve(((o=e.top_attention)==null?void 0:o.severity)??e.health??e.status)} ${t?"is-selected":""}">
      <button class="mission-card-select" onClick=${()=>nc(e.session_id)}>
        ...
        <div class="mission-fact-grid">
          ...
          <div class="mission-fact-tile">
            <span>가동 시간</span>
            <strong>${kv(e.elapsed_sec)}</strong>
      ...
      ${n.length>0?i`
            <div class="mission-member-preview-grid">
              ${n.map(c=>i`
                <button class="mission-member-preview" onClick=${()=>wa(c.agent_name)}>
      ...
      <div class="mission-card-actions">
        <button class="control-btn ghost" onClick=${()=>Oi("intervene",e.session_id)}>세션 개입 열기</button>
        <button class="control-btn ghost" onClick=${()=>Oi("command",e.session_id)}>세션 원인 보기</button>
        ${s?i`<button class="control-btn ghost" onClick=${()=>_o(s,a,"상황판 세션 요약")}>추천 액션 열기</button>`:null}
      </div>
    </article>
  `}function f_({detail:e,loading:t,error:n}){if(t&&!e)return i`
        ...
        <div class="mission-detail-column">
          ...
          <div class="mission-activity-list compact">
            ${e.participants.length>0?e.participants.map(a=>i`
                  <button class="mission-member-preview" onClick=${()=>wa(a.agent_name)}>
        ...
        <div class="mission-detail-column">
          ...
          <div class="mission-link-list">
            ${e.operations.length>0?e.operations.map(a=>i`
                  <button class="mission-link-row" onClick=${()=>Oi("command",s.session_id)}>
    ...
    <section class="dashboard-panel mission-view">
      ...
      ${a?i`
            <div class="mission-selection-bar">
              ...
              <button class="control-btn ghost" onClick=${zv}>선택 해제</button>
            </div>
          `:null}
      ...
      <${I} title="진행중인 세션" class="mission-list-card" semanticId="mission.session_briefs">
        ...
        <div class="mission-list-stack">
          ${t.length>0?t.map(C=>i`<${__} key=${C.session_id} brief=${C} selected=${a===C.session_id} />`):i`<div class="empty-state">지금 활성 세션이 없습니다.</div>`}
        </div>
      <//>
      ...
      <div class="mission-human-grid">
        <${I} title="주의 대기열" class="mission-list-card" semanticId="mission.attention_queue">
          ...
          <div class="mission-lane-stack">
            ${p.length>0?p.map(C=>i`<${v_} key=${C.id} item=${C} selected=${Be.value===C.id} sessionLookup=${o} />`):i`<div class="empty-state">지금 세션 단위 주의 대기열은 비어 있습니다.</div>`}
          </div>
        <//>
        ...
        <${I} title="내부 신호" class="mission-list-card" semanticId="mission.internal_signals">
          ...
          <details class="mission-card-disclosure">
            ...
            <div class="mission-list-stack">
              ${m.length>0?m.map(C=>i`<${$_} key=${C.id} item=${C} />`):i`<div class="empty-state">지금은 내부 진단 경고가 없습니다.</div>`}
            </div>
          </details>
        <//>
      </div>
      ...
      <${I} title="키퍼 연속성" class="mission-list-card" semanticId="mission.keeper_activity">
        ...
        <div class="mission-activity-list">
          ${c.length>0?c.map(C=>i`<${g_} key=${C.brief.name} row=${C} />`):i`<div class="empty-state">지금 보이는 키퍼가 없습니다.</div>`}
        </div>
        <div class="mission-card-actions">
  ...
  `}const h_="modulepreload",y_=function(e){return"/dashboard/"+e},tr={},b_=function(t,n,s){let a=Promise.resolve();if(n&&n.length>0){let l=function(m){return Promise.all(m.map(u=>Promise.resolve(u).then(_=>({status:"fulfilled",value:_}),_=>({status:"rejected",reason:_}))))};document.getElementsByTagName("link");const c=document.querySelector("meta[property=csp-nonce]"),p=(c==null?void 0:c.nonce)||(c==null?void 0:c.getAttribute("nonce"));a=l(n.map(m=>{if(m=y_(m),m in tr)return;tr[m]=!0;const u=m.endsWith(".css"),_=u?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${m}"]${_}`))return;const g=document.createElement("link");if(g.rel=u?"stylesheet":h_,u||(g.as="script"),g.crossOrigin="",g.href=m,p&&g.setAttribute("nonce",p),document.head.appendChild(g),u)return new Promise((h,b)=>{g.addEventListener("load",h),g.addEventListener("error",()=>b(new Error(`Unable to preload CSS for ${m}`)))})}))}function o(l){const c=new Event("vite:preloadError",{cancelable:!0});if(c.payload=l,window.dispatchEvent(c),!c.defaultPrevented)throw l}return a.then(l=>{for(const c of l||[])c.status==="rejected"&&o(c.reason);return t().catch(o)})};function va(e){if(e==null)return"";if(typeof e=="string")return e;try{return JSON.stringify(e,null,2)}catch{return String(e)}}function X(e){if(!e)return"정보 없음";const t=Date.parse(e);if(Number.isNaN(t))return e;const n=Math.max(0,Math.round((Date.now()-t)/1e3));return n<60?`${n}초 전`:n<3600?`${Math.round(n/60)}분 전`:n<86400?`${Math.round(n/3600)}시간 전`:`${Math.round(n/86400)}일 전`}function k_(e){if(!e)return"warn";const t=Date.parse(e);return Number.isNaN(t)?"warn":t<=Date.now()?"bad":"ok"}function dc(e){if(!e)return"정보 없음";const t=Date.parse(e);if(Number.isNaN(t))return e;const n=Math.round((t-Date.now())/1e3);return n<=0?"기한 지남":n<60?`${n}초 후`:n<3600?`${Math.round(n/60)}분 후`:n<86400?`${Math.round(n/3600)}시간 후`:`${Math.round(n/86400)}일 후`}function P(e){return e==="bad"?"bad":e==="warn"||e==="pending"?"warn":"ok"}let nr=!1,x_=0;function S_(){return++x_}let Ga=null;async function C_(){Ga||(Ga=b_(()=>import("./mermaid.core-1_JsIEFh.js").then(t=>t.bE),[]).then(t=>t.default));const e=await Ga;return nr||(e.initialize({startOnLoad:!1,theme:"dark",securityLevel:"loose"}),nr=!0),e}function it(e){if(!e)return"warn";const t=e.toLowerCase();return t.includes("failed")||t.includes("error")||t.includes("disconnected")||t.includes("stopped")?"bad":t.includes("running")||t.includes("active")||t.includes("degraded")||t.includes("pending")?"warn":"ok"}function is(e){return typeof e!="number"||!Number.isFinite(e)?"정보 없음":`${Math.round(e*100)}%`}function kn(e){return typeof e!="number"||!Number.isFinite(e)?"정보 없음":e<60?`${Math.round(e)}초`:e<3600?`${Math.round(e/60)}분`:`${Math.round(e/3600)}시간`}function os(e){return typeof e!="number"||!Number.isFinite(e)?0:Math.max(0,Math.min(100,e))}function yt(e,t){return typeof e!="number"||!Number.isFinite(e)||typeof t!="number"||!Number.isFinite(t)||t<=0?0:os(e/t*100)}function A_(e,t){const n=os(e);return`--gauge-angle:${Math.max(10,Math.round(n/100*360))}deg;--gauge-color:${t};`}function uc(e){if(!e)return"최근 체인 이력이 없습니다";const t=[e.event];return typeof e.duration_ms=="number"&&t.push(`${e.duration_ms}ms`),typeof e.tokens=="number"&&t.push(`토큰 ${e.tokens}`),e.message&&t.push(e.message),t.join(" · ")}const I_=[{id:"status",label:"현황"},{id:"history",label:"이력"},{id:"control",label:"통제"}],pc=[{id:"warroom",label:"워룸",group:"status"},{id:"summary",label:"요약",group:"status"},{id:"topology",label:"토폴로지",group:"status"},{id:"orchestra",label:"오케스트라",group:"status"},{id:"swarm",label:"스웜",group:"status"},{id:"operations",label:"작전",group:"history"},{id:"trace",label:"트레이스",group:"history"},{id:"chains",label:"체인",group:"history"},{id:"control",label:"제어",group:"control"},{id:"alerts",label:"알림",group:"control"}],T_=pc.map(e=>e.id),z_=["chain_start","node_start","node_complete","chain_complete","chain_error"],R_={warroom:{title:"실시간 워룸",description:"실제 실행, 워커, 메시지, 트레이스를 한 화면에서 따라가는 기본 진입 표면입니다."},operations:{title:"현재 작전 상세",description:"활성 작전, 분견대, 의존 관계를 먼저 읽는 기본 진입 표면입니다."},orchestra:{title:"룸 오케스트라 맵",description:"룸, 세션, 레인, 워커, 키퍼를 한 장의 작전판으로 읽는 시각화 표면입니다."},swarm:{title:"스웜 실행 흐름",description:"레인 이동, 워커 결속, 막힘을 따라가며 현장감 있게 보는 표면입니다."},chains:{title:"체인 런타임",description:"체인 연결 상태와 작전별 실행 그래프를 확인하는 표면입니다."},topology:{title:"지휘 계층",description:"실제 관리 유닛인지, 실시간 에이전트 기반 자동 투영인지 구분해서 봅니다."},alerts:{title:"경보 모음",description:"지금 개입을 밀어올리는 alert만 모아서 보는 표면입니다."},trace:{title:"최근 트레이스",description:"작전, 주체, 유닛 단위 이벤트를 시간순으로 보는 표면입니다."},control:{title:"승인과 제어",description:"결정 승인과 유닛 제어를 실제로 수행하는 표면입니다."},summary:{title:"지휘 요약",description:"전체 지휘면을 한 번에 훑는 계기판 성격의 요약 표면입니다."}};function sr(e){return!!e&&T_.includes(e)}function P_(){const e=F.value.params;return e.source!=="mission"&&e.source!=="execution"?{}:{source:e.source,...e.action_type?{action_type:e.action_type}:{},...e.target_type?{target_type:e.target_type}:{},...e.target_id?{target_id:e.target_id}:{},...e.focus_kind?{focus_kind:e.focus_kind}:{},...e.operation_id?{operation_id:e.operation_id}:{}}}function $o(e){const t=P_(),n=_c(),s=ho();if(e==="operations")return t;if(e==="chains"){const a=Qt.value;return a?{...t,surface:e,operation:a}:{...t,surface:e}}return e==="swarm"||e==="warroom"||e==="orchestra"?{...t,surface:e,...n?{run_id:n}:{},...s?{operation_id:s}:{}}:{...t,surface:e}}function L_(){const e=new URLSearchParams(window.location.search),t=new URLSearchParams,n=e.get("agent")??e.get("agent_name"),s=e.get("token");return n&&t.set("agent",n),s&&t.set("token",s),t.toString()?`/api/v1/chains/events?${t.toString()}`:"/api/v1/chains/events"}function M_(e){switch(e){case"company":return"중대";case"platoon":return"소대";case"squad":return"분대";case"agent":return"에이전트";default:return e}}function oe(e){return Mi.value===e}function rs(){return ao.value}function j_(e){var a,o,l,c,p,m,u;const t=ao.value,n=Mt.value,s=ss.value;switch(e){case"warroom":return{tool:"masc_observe_operations",reason:"실시간 실행, 워커, 메시지, 트레이스를 한 화면에서 보고 필요한 세부 표면으로 바로 이동합니다."};case"operations":return{tool:"masc_operation_status",reason:`활성 작전 ${((a=t==null?void 0:t.operations.summary)==null?void 0:a.active)??0}개와 의존 관계를 먼저 확인합니다.`};case"swarm":return{tool:(n==null?void 0:n.recommended_next_tool)??((l=(o=t==null?void 0:t.swarm_status)==null?void 0:o.recommended_next_action)==null?void 0:l.tool)??"masc_observe_traces",reason:((p=(c=t==null?void 0:t.swarm_status)==null?void 0:c.recommended_next_action)==null?void 0:p.reason)??"레인 이동과 막힘 근거를 보고 다음 확인 도구를 고릅니다."};case"orchestra":return{tool:"masc_operator_snapshot",reason:"룸, 세션, 레인, 워커, 키퍼를 한 장에서 훑은 뒤 내려볼 대상을 고릅니다."};case"chains":return{tool:(u=(m=s==null?void 0:s.operations[0])==null?void 0:m.preview_run)!=null&&u.chain_id?"masc_chain_run_get":"masc_chain_snapshot",reason:"체인 연결 상태와 최근 run 그래프를 함께 보면 병목을 빨리 좁힐 수 있습니다."};case"topology":return{tool:"masc_observe_topology",reason:"이 구조가 실제 관리 단위인지 자동 투영인지 먼저 구분해야 지휘면을 오해하지 않습니다."};case"alerts":return{tool:"masc_observe_alerts",reason:"경보에서 먼저 문제가 된 유닛과 작전을 고릅니다."};case"trace":return{tool:"masc_observe_traces",reason:"트레이스 흐름으로 원인 이벤트를 바로 따라갈 수 있습니다."};case"control":return{tool:"masc_operator_action",reason:"승인이나 kill switch 같은 실제 조작은 제어 표면과 operator action이 이어집니다."};case"summary":default:return{tool:"masc_observe_operations",reason:"요약을 본 뒤에는 현재 작전 표면으로 내려가 실제 움직임을 확인하는 게 가장 빠릅니다."}}}function E_(e){var n;const t=((n=e==null?void 0:e.focus_kind)==null?void 0:n.toLowerCase())??"";return t?t.includes("artifact_scope")||t.includes("routing_confidence")||t.includes("cache_contention")?"microarch":t.includes("leader_offline")||t.includes("roster_offline")?"alerts":t.includes("stale_data")?"swarm":null:null}function N_(e){var n;const t=((n=e==null?void 0:e.focus_kind)==null?void 0:n.toLowerCase())??"";return t?t.includes("stale_data")||t.includes("leader_offline")||t.includes("roster_offline")||t.includes("managed")?"recommendation":t.includes("gap")?"gaps":null:null}function mc(){if(typeof window>"u")return null;const e=new URLSearchParams(window.location.search),t=e.get("agent")??e.get("agent_name");if(!t)return null;const n=t.trim();return n===""?null:n}function vc(){if(typeof window>"u")return new URLSearchParams;const e=new URLSearchParams(window.location.search),t=window.location.hash.replace(/^#/,""),n=t.indexOf("?");return n>=0&&new URLSearchParams(t.slice(n+1)).forEach((a,o)=>{e.has(o)||e.set(o,a)}),e}function _c(){const t=vc().get("run_id");if(!t)return null;const n=t.trim();return n===""?null:n}function ho(){const t=vc().get("operation_id");if(!t)return null;const n=t.trim();return n===""?null:n}function w_(e){if(!e)return null;const t=Date.parse(e);return Number.isNaN(t)?null:Math.max(0,Math.round((Date.now()-t)/1e3))}function D_(e){return e.status==="claimed"||e.status==="in_progress"}function O_(e){const t=ns.value;if(!t)return null;for(const n of t.golden_paths){const s=n.steps.find(a=>a.tool===e);if(s)return s}return null}function Ja(e){var t;return((t=ns.value)==null?void 0:t.golden_paths.find(n=>n.id===e))??null}function q_(e){const t=ns.value;if(!t)return[];const n=new Set(e);return t.pitfalls.filter(s=>n.has(s.id))}async function ot(e){try{await e()}catch{}}function yo(e){return(e==null?void 0:e.trim().toLowerCase())??""}function Bt(e){const t=yo(e);return t.includes("failed")||t.includes("error")||t.includes("stopped")||t==="paused"?"bad":t.includes("active")||t.includes("running")||t.includes("healthy")||t.includes("ok")?"ok":"warn"}function bt(e){const t=yo(e);return t?t==="active"||t==="running"?"진행 중":t==="paused"?"일시정지":t==="done"||t==="ended"||t==="completed"?"완료":t==="failed"||t==="error"||t==="stopped"?"문제":(e==null?void 0:e.trim())||"확인 필요":"확인 필요"}function F_(){var n,s,a,o,l,c,p,m,u;const e=Mt.value;if(!e)return!1;const t=e.workers.some(_=>_.joined||_.live_presence||_.completed||_.current_task_matches_run||_.heartbeat_fresh||_.claim_marker_seen||_.done_marker_seen||_.final_marker_seen||!!_.current_task||!!_.bound_task_id||!!_.last_message);return!!((n=e.operation)!=null&&n.operation_id||(s=e.detachment)!=null&&s.detachment_id||(((a=e.summary)==null?void 0:a.joined_workers)??0)>0||(((o=e.summary)==null?void 0:o.live_workers)??0)>0||(((l=e.summary)==null?void 0:l.current_task_bound)??0)>0||(((c=e.summary)==null?void 0:c.fresh_heartbeats)??0)>0||(((p=e.summary)==null?void 0:p.claim_markers_seen)??0)>0||(((m=e.summary)==null?void 0:m.done_markers_seen)??0)>0||(((u=e.summary)==null?void 0:u.final_markers_seen)??0)>0||t||e.recent_messages.length>0||e.recent_trace_events.length>0)}function K_(e){const t=yo(e.status);return t==="active"||t==="running"}function B_(){var o,l,c,p;const e=((o=_e.value)==null?void 0:o.sessions)??[],t=Mt.value,n=((l=t==null?void 0:t.detachment)==null?void 0:l.session_id)??null;if(n){const m=e.find(u=>u.session_id===n);if(m)return m}const s=((c=t==null?void 0:t.operation)==null?void 0:c.operation_id)??ho();if(s){const m=e.find(u=>u.command_plane_operation_id===s);if(m)return m}const a=((p=t==null?void 0:t.detachment)==null?void 0:p.detachment_id)??null;if(a){const m=e.find(u=>u.command_plane_detachment_id===a);if(m)return m}return e.find(K_)??e[0]??null}function Va(e){return e==="proven"?"ok":e==="partial"?"warn":"bad"}function Tn(e){return Array.isArray(e)?e:[]}function Pe(e){return typeof e=="object"&&e!==null&&!Array.isArray(e)?e:{}}function $s(e){return typeof e=="string"&&e.trim()!==""?e:null}function U_(e){return typeof e=="number"&&Number.isFinite(e)?e:null}function H_(e){const t=e.split("/");return t.length<=3?e:`…/${t.slice(-3).join("/")}`}function W_(e){return e==="proven"?"충분":e==="partial"?"부분":"부족"}function G_(e){return e==="proven"?"협업 증거가 충분합니다":e==="partial"?"흔적은 있으나 협업 증거가 덜 모였습니다":"증거가 부족합니다"}function J_(e,t,n,s,a){const o=[`${t}명의 actor 흔적이 기록돼 있습니다.`,n>0?`서로를 참조한 상호작용 증거가 ${n}건 있습니다.`:"서로를 참조한 명시적 상호작용 증거가 아직 없습니다.",s>0?`도구·산출물·체크포인트 증거가 ${s}건 있습니다.`:"도구·산출물·체크포인트 증거가 거의 없습니다.",a>0?`CPv2 backing trace가 ${a}건 있어 실행 흔적은 남아 있습니다.`:"관리형 backing trace는 아직 없습니다."];return e==="partial"?[o[0]??"",n===0?"partial인 이유: 참여 흔적은 있지만 actor 간 상호작용이 직접 보이지 않습니다.":"partial인 이유: 일부 증거는 있으나 proven 기준을 모두 채우지 못했습니다.",a>0?"다음 보강 포인트: 대화/상호참조 event를 남기면 proof가 더 강해집니다.":"다음 보강 포인트: 관리형 trace 또는 산출물 연결을 더 남기면 근거가 강해집니다."]:e==="proven"?[o[0]??"","결론: 참여, 상호작용, 산출물, backing evidence가 모두 연결돼 있습니다.","다음 행동: raw evidence는 접어두고 세션 결과와 산출물만 확인하면 됩니다."]:[o[0]??"","결론: 기록은 있으나 협업을 증명할 만큼의 연결 증거가 부족합니다.","다음 보강 포인트: 참여자 간 턴, 도구 근거, 산출물 연결을 더 남겨야 합니다."]}function V_(e){const t=new Map;for(const n of e){const s=[n.timestamp??"",n.event_type??"",n.actor??"",n.summary??""].join("|"),a=n.source??"unknown",o=t.get(s);if(o){o.sources.includes(a)||o.sources.push(a),!o.operation_id&&n.operation_id&&(o.operation_id=n.operation_id);continue}t.set(s,{...n,sources:[a]})}return[...t.values()]}function Y_(e){return e.sources.length===2?"세션 + 지휘":e.sources.length===1?e.sources[0]==="unknown"?"출처 미상":e.sources[0]??"출처":e.sources.join(" + ")}function X_(e){const t=[];for(const[n,s]of Object.entries(e))if(s!=null){if(typeof s=="string"){if(s.trim()==="")continue;t.push({label:n,value:s});continue}if(typeof s=="number"||typeof s=="boolean"){t.push({label:n,value:String(s)});continue}}return t}function Q_(e){const t=Pe(e),n=Pe(t.traces),s=Array.isArray(n.events)?n.events:[],a=Pe(t.detachments),o=Array.isArray(a.detachments)?a.detachments:[],l=Pe(o[0]),c=Pe(l.detachment),p=Pe(l.operation),m=Pe(t.summary),u=Pe(m.operations),_=Pe(u.summary);return[{label:"작전",value:$s(t.operation_id)??"없음"},{label:"분견대",value:$s(t.detachment_id)??"없음"},{label:"트레이스 이벤트",value:`${s.length}`},{label:"분견대 상태",value:$s(c.status)??"없음"},{label:"작전 단계",value:$s(p.stage)??"없음"},{label:"활성 작전",value:`${U_(_.active)??0}`}]}function Z_({item:e}){return i`
  ...
  `}function ef({item:e}){const t=e.recent_output_preview??null,n=e.recent_input_preview??null,s=e.recent_event_summary??null,a=(e.interaction_count??0)>0?"ok":"warn";return i`
  ...
  `}function nf(){var L,T,R;const e=F.value.params,t=e.session_id??null,n=e.operation_id??null;ne(()=>{Pl(t,n)},[t,n]);const s=Rl.value;if(Li.value&&!s)return i`<section class="dashboard-panel"><div class="loading-indicator">근거 화면 불러오는 중…</div></section>`;if(Ft.value&&!s)return i`<section class="dashboard-panel"><div class="error-card">${Ft.value}</div></section>`;const a=s==null?void 0:s.summary,o=Tn(s==null?void 0:s.actor_contributions),l=Tn(s==null?void 0:s.artifacts),c=(s==null?void 0:s.proof_verdict)??"insufficient",p=(s==null?void 0:s.cp_backing_evidence)??null,m=Array.isArray((L=p==null?void 0:p.traces)==null?void 0:L.events)?((R=(T=p.traces)==null?void 0:T.events)==null?void 0:R.length)??0:0,u=(a==null?void 0:a.actors_count)??o.length,_=(a==null?void 0:a.interaction_count)??0,g=(a==null?void 0:a.evidence_count)??0,h=V_(Tn(s==null?void 0:s.timeline)),b=X_(Pe(s==null?void 0:s.goal_binding)),$=Q_(p),S=l.filter(M=>M.exists).length,C=l.length-S,x=J_(c,u,_,g,m);return i`
    <section class="dashboard-panel mission-view">
      ...
      <div class="panel-header">
        ...
        <div class="mission-header-meta">
          <span class="command-chip ${Va(c)}">${W_(c)}</span>
      ...
      <div class="mission-human-grid">
        <${I} title="협업 타임라인" class="mission-list-card" semanticId="proof.timeline">
          ...
          <div class="mission-list-stack">
            ${h.length>0?h.slice(0,18).map(M=>i`<${Z_} key=${M.id} item=${M} />`):i`<div class="empty-state">표시할 타임라인 근거가 없습니다.</div>`}
          </div>
        <//>
        ...
        <${I} title="참여 흔적" class="mission-list-card" semanticId="proof.contributions">
          ...
          <div class="mission-activity-list">
            ${o.length>0?o.map(M=>i`<${ef} key=${M.actor} item=${M} />`):i`<div class="empty-state">표시할 참여 흔적이 없습니다.</div>`}
          </div>
        <//>
      </div>
      ...
      <div class="mission-human-grid">
        ...
        <${I} title="산출물" class="mission-list-card" semanticId="proof.artifacts">
          ...
          <div class="mission-list-stack">
            ${l.length>0?l.map(M=>i`<${tf} key=${M.path} item=${M} />`):i`<div class="empty-state">기록된 artifact가 없습니다.</div>`}
          </div>
        <//>
      </div>
    </section>
  `}function sf(){const e=as(F.value);return e?i`
    <section class="command-focus-banner">
      <div class="command-focus-head">
        <strong>${e.source_label}</strong>
        <span class="command-chip">${Ea(e.action_type)}</span>
        <span class="command-chip">${vo(e)}</span>
        <span class="command-chip">${bv(F.value.params.surface??"warroom")}</span>
      </div>
      <div class="command-focus-body">${e.summary}</div>
      ${e.payload_preview?i`<div class="command-focus-preview">${e.payload_preview}</div>`:null}
    </section>
  `:null}function af(){const e=G.value,t=R_[e],n=j_(e);return i`
  ...
  `}function hs({label:e,value:t,subtext:n,percent:s,color:a}){return i`
    <article class="command-gauge-card">
      <div class="command-gauge-ring" style=${A_(s,a)}>
  ...
  `}function lf(){var Z,ie,V,ee,A,Te,Je,_t,ft;const e=rs(),t=qe.value,n=te.value,s=mc(),a=s?Ge.value.find(K=>K.name===s)??null:null,o=s?et.value.filter(K=>K.assignee===s&&D_(K)):[],l=((Z=e==null?void 0:e.operations.summary)==null?void 0:Z.active)??0,c=((ie=e==null?void 0:e.detachments.summary)==null?void 0:ie.total)??0,p=((V=e==null?void 0:e.decisions.summary)==null?void 0:V.pending)??0,m=t==null?void 0:t.detachments.detachments.find(K=>{const ze=K.detachment.heartbeat_deadline,gt=ze?Date.parse(ze):Number.NaN;return K.detachment.status==="stalled"||!Number.isNaN(gt)&&gt<=Date.now()}),u=t==null?void 0:t.alerts.alerts.find(K=>K.severity==="bad"),_=!!(n!=null&&n.room||n!=null&&n.project),g=(a==null?void 0:a.current_task)??null,h=w_(a==null?void 0:a.last_seen),b=h!=null?h<=120:null,$=[_?{title:"Room 준비도",tone:"ok",detail:`${(n==null?void 0:n.room)??(n==null?void 0:n.project)??"unknown"} · base ${(n==null?void 0:n.room_base_path)??"n/a"}`,tool:"masc_status"}:{title:"Room 준비도",tone:"bad",detail:"아직 room snapshot이 없습니다. 조인 전에 room을 repo root로 맞추세요.",tool:"masc_set_room"},s?a?o.length===0?{title:"Task 준비도",tone:"warn",detail:`${s} 에게 배정된 claimed task가 없습니다. 먼저 claim 하거나 만들어야 합니다.`,tool:et.value.length>0?"masc_claim":"masc_add_task"}:g?b===!1?{title:"Task 준비도",tone:"warn",detail:`${s} current_task=${g} 이지만 heartbeat가 stale 합니다 (${h}s).`,tool:"masc_heartbeat"}:{title:"Task 준비도",tone:"ok",detail:`${s} current_task=${g}${h!=null?` · 마지막 활동 ${h}s 전`:""}`,tool:"masc_plan_get_task"}:{title:"Task 준비도",tone:"bad",detail:`${s} 에 claimed task는 있지만 session current_task binding이 없습니다.`,tool:"masc_plan_set_task"}:{title:"Task 준비도",tone:"bad",detail:`${s} 이 room roster에 보이지 않습니다.`,tool:"masc_join"}:{title:"Task 준비도",tone:"warn",detail:"?agent= 쿼리가 없습니다. room health는 보이지만 agent 단위 다음 단계는 비어 있습니다.",tool:"masc_join"},!e||(((ee=e.topology.summary)==null?void 0:ee.managed_unit_count)??0)===0?{title:"작전 준비도",tone:"warn",detail:"관리 단위가 아직 정의되지 않았습니다. hierarchy가 있어야 CPv2 benchmark를 시작할 수 있습니다.",tool:"masc_unit_define"}:l===0?{title:"작전 준비도",tone:"warn",detail:`${((A=e.topology.summary)==null?void 0:A.managed_unit_count)??0}개 관리 단위는 준비됐지만 활성 작전은 없습니다.`,tool:"masc_operation_start"}:{title:"작전 준비도",tone:"ok",detail:`${((Te=e.topology.summary)==null?void 0:Te.managed_unit_count)??0}개 관리 단위 위에서 ${l}개 활성 작전이 돌고 있습니다.`,tool:"masc_observe_operations"},p>0?{title:"디스패치 준비도",tone:"warn",detail:`${p}개의 pending approval이 strict action을 막고 있습니다.`,tool:"masc_policy_approve"}:l>0&&c===0?{title:"디스패치 준비도",tone:"bad",detail:"active operation은 있지만 detachment가 아직 materialize 되지 않았습니다.",tool:"masc_dispatch_tick"}:m||u?{title:"디스패치 준비도",tone:"warn",detail:`dispatch 재정렬이 필요합니다${m?` · detachment ${m.detachment.detachment_id} 가 stalled 상태입니다`:""}${u?` · alert ${u.title??u.alert_id}`:""}${!t&&!m&&!u?" · 정확한 원인은 detail 탭에서 확인하세요.":""}.`,tool:p>0?"masc_policy_approve":"masc_dispatch_tick"}:{title:"디스패치 준비도",tone:"ok",detail:`${c}개 detachment가 보이고 strict approval backlog도 없습니다${t?"":" · detail pane은 열릴 때만 로드됩니다."}.`,tool:"masc_detachment_list"}],S=_?!s||!a?"masc_join":o.length===0?et.value.length>0?"masc_claim":"masc_add_task":g?b===!1?"masc_heartbeat":!e||(((Je=e.topology.summary)==null?void 0:Je.managed_unit_count)??0)===0?"masc_unit_define":l===0?"masc_operation_start":p>0?"masc_policy_approve":l>0&&c===0||m||u?"masc_dispatch_tick":"masc_observe_traces":"masc_plan_set_task":"masc_set_room",C=O_(S),L=q_(S==="masc_set_room"?["repo-root-room"]:S==="masc_plan_set_task"?["claimed-not-current"]:S==="masc_heartbeat"?["heartbeat-stale"]:S==="masc_dispatch_tick"?["no-detachments"]:S==="masc_policy_approve"?["pending-approval"]:["repo-root-room","claimed-not-current","heartbeat-stale"]).slice(0,2),T=Ja("room_task_hygiene"),R=Ja("cpv2_benchmark"),M=Ja("supervisor_session"),z=((_t=ns.value)==null?void 0:_t.docs)??[],j=[T,R,M].filter(K=>K!==null);return i`
    <div class="command-guided-layout">
      ...
      <section class="card command-section">
        ...
        ${ji.value?i`<div class="empty-state">CPv2 runbook 불러오는 중…</div>`:aa.value?i`<div class="empty-state error">${aa.value}</div>`:i`
  ...
  `}function cf(){return i`
    ...
    <${rf} />
    <${lf} />
  `}function df(){return ea.value?i`<div class="empty-state">command-plane detail 불러오는 중…</div>`:na.value?i`<div class="empty-state error">${na.value}</div>`:i`<div class="empty-state">surface를 선택하면 command-plane detail을 로드합니다.</div>`}const qi=f(null),ir=1280,or=760;function rr(e){switch((e??"").trim().toLowerCase()){case"room":return"룸";case"session":return"세션";case"operation":return"작전";case"detachment":return"분견대";case"lane":return"레인";case"worker":return"워커";case"keeper":return"키퍼";default:return(e==null?void 0:e.trim())||"노드"}}function hn(e,t,n){if(e<=0)return[];if(e===1)return[Math.round((t+n)/2)];const s=(n-t)/(e-1);return Array.from({length:e},(a,o)=>Math.round(t+o*s))}function uf(e,t){const n=new Map;for(const s of e){const a=t(s),o=n.get(a)??[];o.push(s),n.set(a,o)}return n}function pf(e){const t=new Map,n=e.nodes,s=n.find(b=>b.kind==="room")??null,a=n.filter(b=>b.kind==="session"),o=n.filter(b=>b.kind==="operation"),l=n.filter(b=>b.kind==="detachment"),c=n.filter(b=>b.kind==="lane"),p=n.filter(b=>b.kind==="worker"),m=n.filter(b=>b.kind==="keeper");s&&t.set(s.id,{x:640,y:96}),hn(a.length,170,1110).forEach((b,$)=>{const S=a[$];S&&t.set(S.id,{x:b,y:220})}),hn(o.length,240,1040).forEach((b,$)=>{const S=o[$];S&&t.set(S.id,{x:b,y:330})}),hn(l.length,300,980).forEach((b,$)=>{const S=l[$];S&&t.set(S.id,{x:b,y:420})}),hn(c.length,170,1110).forEach((b,$)=>{const S=c[$];S&&t.set(S.id,{x:b,y:530})});const u=new Map(c.map(b=>{const $=t.get(b.id);return $?[b.id,$.x]:null}).filter(b=>b!==null)),_=uf(p,b=>b.lane_id?`lane:${b.lane_id}`:b.parent_id?b.parent_id:"free");let g=0;for(const[b,$]of _){let S=u.get(b);if(S==null){const x=t.get(b);S=x==null?void 0:x.x}S==null&&(S=180+g%5*200,g+=1),hn($.length,S-90,S+90).forEach((x,L)=>{const T=$[L];if(!T)return;const R=L>5?Math.floor(L/6):0;t.set(T.id,{x,y:635+R*62})})}const h=m.length>3?[1120,1180]:[1140];return m.forEach((b,$)=>{const S=$%h.length,C=Math.floor($/h.length);t.set(b.id,{x:h[S]??1140,y:190+C*108})}),t}function mf(e,t){const n=(e.x+t.x)/2,s=t.y>=e.y?32:-32;return`M ${e.x} ${e.y} C ${n} ${e.y+s}, ${n} ${t.y-s}, ${t.x} ${t.y}`}function lr(e,t,n){if(e==="command"){if(t){at(t),se("command",{...$o(t),...n});return}se("command",n);return}if(e==="intervene"){se("intervene",n);return}se("command",n)}function vf(e){switch(e.kind){case"room":return{width:150,height:150,radius:74};case"worker":return{width:78,height:42,radius:22};case"lane":return{width:170,height:54,radius:16};case"keeper":return{width:120,height:56,radius:24};default:return{width:188,height:64,radius:18}}}function _f({orchestra:e,roomPoint:t,onSelect:n}){if(!t||e.signals.length===0)return null;const s=108;return i`
    ${e.signals.slice(0,6).map((a,o)=>{const l=(-120+o*38)*(Math.PI/180),c=Math.round(t.x+Math.cos(l)*s),p=Math.round(t.y+Math.sin(l)*s);return i`
      ...
      `})}
  `}function ff({edges:e,positions:t,selectedId:n}){return i`
    ${e.map(s=>{const a=t.get(s.source),o=t.get(s.target);if(!a||!o)return null;const l=n!=null&&(s.source===n||s.target===n);return i`
        ...
        />
      `})}
  `}function gf({orchestra:e,positions:t,selectedId:n,onSelect:s}){var o;const a=((o=e.focus)==null?void 0:o.target_kind)==="node"?e.focus.target_id:null;return i`
    ${e.nodes.map(l=>{const c=t.get(l.id);if(!c)return null;const p=vf(l),m=l.id===n,u=l.id===a;if(l.kind==="room")return i`
          <g
            key=${l.id}
      ...
      `})}
  `}function fc(e){var s,a;const t=qi.value;if(t){const o=e.nodes.find(c=>c.id===t);if(o)return{type:"node",value:o};const l=e.signals.find(c=>c.id===t);if(l)return{type:"signal",value:l}}if(((s=e.focus)==null?void 0:s.target_kind)==="node"){const o=e.nodes.find(l=>{var c;return l.id===((c=e.focus)==null?void 0:c.target_id)});if(o)return{type:"node",value:o}}if(((a=e.focus)==null?void 0:a.target_kind)==="signal"){const o=e.signals.find(l=>{var c;return l.id===((c=e.focus)==null?void 0:c.target_id)});if(o)return{type:"signal",value:o}}const n=e.nodes[0];return n?{type:"node",value:n}:null}function $f({orchestra:e}){const t=fc(e);if(!t)return i`<aside class="orchestra-drawer card"><div class="empty-state">선택 가능한 대상이 아직 없습니다.</div></aside>`;if(t.type==="signal"){const o=t.value;return i`
  ...
  `}function hf(){var o,l,c,p;const e=io.value;if(Ei.value&&!e)return i`<section class="card command-section"><div class="empty-state">오케스트라 맵 불러오는 중…</div></section>`;if(ra.value)return i`<section class="card command-section"><div class="empty-state error">${ra.value}</div></section>`;if(!e)return i`<section class="card command-section"><div class="empty-state">오케스트라 맵 데이터가 아직 없습니다.</div></section>`;const t=pf(e),n=fc(e),s=(n==null?void 0:n.value.id)??null,a=e.nodes.find(m=>m.kind==="room")?t.get(e.nodes.find(m=>m.kind==="room").id)??null:null;return i`
      ...
      <div class="orchestra-shell">
        <div class="orchestra-canvas-wrap">
          <svg class="orchestra-canvas" viewBox=${`0 0 ${ir} ${or}`}>
            ...
            <${ff} edges=${e.edges} positions=${t} selectedId=${s} />
            <${_f} orchestra=${e} roomPoint=${a} onSelect=${m=>{qi.value=m}} />
            <${gf}
              orchestra=${e}
              positions=${t}
              selectedId=${s}
              onSelect=${m=>{qi.value=m}}
            />
          </svg>
  ...
  `}const gc="masc_dashboard_agent_name";function yf(){var t,n,s;const e=new URLSearchParams(window.location.search);return((t=e.get("agent"))==null?void 0:t.trim())||((n=e.get("agent_name"))==null?void 0:n.trim())||((s=localStorage.getItem(gc))==null?void 0:s.trim())||"dashboard"}const Da=f(yf()),tn=f(""),_a=f("운영 점검"),nn=f(""),Kn=f(""),Bn=f("2"),ln=f(""),he=f("note"),Un=f(""),Hn=f(""),Wn=f(""),Gn=f("2"),Jn=f(""),fa=f("운영자 중지 요청"),ga=f(""),sn=f(""),bs=f(null);function bf(e){const t=e.trim()||"dashboard";Da.value=t,localStorage.setItem(gc,t)}function $a(e){if(e==null)return"";if(typeof e=="string")return e;try{return JSON.stringify(e,null,2)}catch{return String(e)}}function bo(e){switch((e??"").trim().toLowerCase()){case"judgment":return"상주 판단";case"fallback":return"보조 읽기 모델";default:return(e==null?void 0:e.trim())||"안내"}}function ha(e){switch((e??"").trim().toLowerCase()){case"judgment":return"ok";case"fallback":return"warn";default:return"warn"}}function ko(e){return e!=null&&e.enabled?e.refreshing?"갱신 중":e.judge_online?"온라인":e.last_error?"오류":"대기":"꺼짐"}function kf(e){return e!=null&&e.enabled?e.judge_online?"ok":e.refreshing?"warn":"bad":"warn"}function xo(e){return e!=null&&e.fresh_until?e.fresh_until:"갱신 기준 없음"}function cr(e){return typeof e!="number"||!Number.isFinite(e)?"확인 없음":e<60?`${Math.round(e)}초 전`:e<3600?`${Math.round(e/60)}분 전`:`${Math.round(e/3600)}시간 전`}function cn(e){return typeof e=="string"?e.trim().toLowerCase():""}function xf(e){var s;const t=cn(e.status);if(t==="paused")return"bad";if(t===""||t==="unknown")return"warn";const n=cn((s=e.team_health)==null?void 0:s.status);return n&&n!=="ok"&&n!=="healthy"&&n!=="green"||t&&t!=="active"&&t!=="running"&&t!=="ended"?"warn":"ok"}function Ya(e){const t=cn(e.status);return t==="offline"||t==="inactive"||t==="error"?"bad":t===""||t==="unknown"||(e.context_ratio??0)>=.8||e.context_ratio==null||e.last_turn_ago_s==null||(e.last_turn_ago_s??0)>=3600?"warn":"ok"}function dr(e){return e.some(t=>cn(t.severity)==="bad")?"bad":e.length>0?"warn":"ok"}function Sf(e){return e.target_type==="team_session"}function Cf(e){return e.target_type==="keeper"}function Rt(e){switch(e){case"broadcast":return"방송";case"room_pause":return"방 일시정지";case"room_resume":return"방 재개";case"team_turn":return"세션 업데이트";case"team_note":return"세션 노트";case"team_broadcast":return"세션 방송";case"team_task_inject":return"세션 작업 주입";case"team_worker_spawn_batch":return"세션 작업자 교체";case"task_inject":return"작업 주입";case"team_stop":return"세션 중지";case"keeper_message":return"키퍼 메시지";case"keeper_msg":return"키퍼 메시지";case"swarm_run_continue":return"스웜 실행 계속";case"swarm_run_rerun":return"스웜 실행 재실행";case"swarm_run_abandon":return"스웜 실행 포기";default:return(e==null?void 0:e.trim())||"액션"}}function an(e){switch(e){case"room":return"방";case"team_session":return"세션";case"keeper":return"키퍼";case"swarm_run":return"스웜 실행";default:return(e==null?void 0:e.trim())||"대상"}}function Ut(e){switch(cn(e)){case"running":case"active":return"진행 중";case"paused":return"일시정지";case"ended":case"done":return"종료";case"offline":return"오프라인";case"idle":return"대기";case"unknown":case"":return"확인 필요";default:return(e==null?void 0:e.trim())||"확인 필요"}}function ya(e){return e?"확인 후 실행":"즉시 실행"}function Af(e){switch(e){case"note":return"노트";case"broadcast":return"방송";case"task":return"작업";case"worker_spawn_batch":return"작업자 교체";default:return e}}function ue(e,t){if(!e)return null;const n=e[t];return typeof n=="string"&&n.trim()!==""?n.trim():typeof n=="number"&&Number.isFinite(n)?String(n):null}function If(e){return!e||typeof e!="object"||Array.isArray(e)?null:e}function Tf(e){if(!e)return"";const t=e.spawn_batch;return $a(t!==void 0?t:e)}function $c(e){const t=If(e.payload);if(e.target_type==="room"){if(e.action_type==="broadcast"){tn.value=ue(t,"message")??e.summary;return}if(e.action_type==="task_inject"){nn.value=ue(t,"title")??"운영자 주입 작업",Kn.value=ue(t,"description")??e.summary,Bn.value=ue(t,"priority")??Bn.value;return}e.action_type==="room_pause"&&(_a.value=ue(t,"reason")??e.summary);return}if(e.target_type==="team_session"){if(e.target_id&&(ln.value=e.target_id),e.action_type==="team_stop"){fa.value=ue(t,"reason")??e.summary;return}he.value=e.action_type==="team_worker_spawn_batch"?"worker_spawn_batch":e.action_type==="team_task_inject"?"task":e.action_type==="team_broadcast"?"broadcast":"note";const n=ue(t,"message");if(n&&(Un.value=n),he.value==="worker_spawn_batch"){Jn.value=Tf(t);return}he.value==="task"&&(Hn.value=ue(t,"task_title")??ue(t,"title")??"운영자 주입 작업",Wn.value=ue(t,"task_description")??ue(t,"description")??e.summary,Gn.value=ue(t,"task_priority")??ue(t,"priority")??Gn.value);return}e.target_type==="keeper"&&(e.target_id&&(ga.value=e.target_id),sn.value=ue(t,"message")??e.summary)}function zf(e){$c({action_type:e.action_type,target_type:e.target_type,target_id:e.target_id,payload:e.suggested_payload,summary:e.summary})}function Rf(e){$c({action_type:e.action_type,target_type:e.target_type,target_id:e.target_id??null,payload:e.suggested_payload,summary:e.reason}),E("추천 액션 payload를 폼에 채웠습니다","success")}function Pf(e,t,n){return!e||!e.target_type||e.target_type==="room"?!0:e.target_type==="team_session"?!!e.target_id&&t.some(s=>s.session_id===e.target_id):e.target_type==="keeper"?!!e.target_id&&n.some(s=>s.name===e.target_id):!0}async function ct(e){const t=Da.value.trim()||"dashboard";try{const n=await bl({actor:t,action_type:e.action_type,target_type:e.target_type,target_id:e.target_id,payload:e.payload});return n.confirm_required?E("확인 대기열에 올렸습니다","warning"):E(e.successMessage,"success"),n}catch(n){const s=n instanceof Error?n.message:"개입 실행에 실패했습니다";return E(s,"error"),null}}async function ur(){const e=tn.value.trim();if(!e)return;await ct({action_type:"broadcast",target_type:"room",payload:{message:e},successMessage:"방송을 보냈습니다"})&&(tn.value="")}async function Lf(){await ct({action_type:"room_pause",target_type:"room",payload:{reason:_a.value.trim()||"운영 점검"},successMessage:"방 일시정지를 요청했습니다"})}async function hc(){await ct({action_type:"room_resume",target_type:"room",payload:{},successMessage:"방 재개를 요청했습니다"})}async function Mf(){const e=nn.value.trim();if(!e)return;await ct({action_type:"task_inject",target_type:"room",payload:{title:e,description:Kn.value.trim()||"개입 화면에서 주입",priority:Number.parseInt(Bn.value,10)||2},successMessage:"작업 주입을 보냈습니다"})&&(nn.value="",Kn.value="")}async function jf(){var l;const e=_e.value,t=ln.value||((l=e==null?void 0:e.sessions[0])==null?void 0:l.session_id)||"";if(!t){E("먼저 세션을 고르세요","warning");return}const n={};if(he.value==="worker_spawn_batch"){const c=Jn.value.trim();if(!c){E("spawn_batch JSON을 먼저 채우세요","warning");return}try{const m=JSON.parse(c);if(Array.isArray(m))n.spawn_batch=m;else if(m&&typeof m=="object"&&Array.isArray(m.spawn_batch))n.spawn_batch=m.spawn_batch;else{E("spawn_batch는 배열 또는 { spawn_batch: [...] } 형태여야 합니다","warning");return}}catch(m){const u=m instanceof Error?m.message:"spawn_batch JSON 파싱에 실패했습니다";E(u,"error");return}await ct({action_type:"team_worker_spawn_batch",target_type:"team_session",target_id:t,payload:n,successMessage:"작업자 교체 요청을 적용했습니다"})&&(Jn.value="");return}const s=Un.value.trim();s&&(n.message=s);let a="team_note";he.value==="broadcast"?a="team_broadcast":he.value==="task"&&(a="team_task_inject"),he.value==="task"&&(n.task_title=Hn.value.trim()||"운영자 주입 작업",n.task_description=Wn.value.trim()||"개입 화면에서 주입",n.task_priority=Number.parseInt(Gn.value,10)||2),await ct({action_type:a,target_type:"team_session",target_id:t,payload:n,successMessage:"세션 액션을 적용했습니다"})&&(Un.value="",he.value==="task"&&(Hn.value="",Wn.value=""))}async function Ef(){var n;const e=_e.value,t=ln.value||((n=e==null?void 0:e.sessions[0])==null?void 0:n.session_id)||"";if(!t){E("먼저 세션을 고르세요","warning");return}await ct({action_type:"team_stop",target_type:"team_session",target_id:t,payload:{reason:fa.value.trim()||"운영자 중지 요청"},successMessage:"세션 중지를 요청했습니다"})}async function Nf(){var a;const e=_e.value,t=ga.value||((a=e==null?void 0:e.keepers[0])==null?void 0:a.name)||"",n=sn.value.trim();if(!t){E("먼저 키퍼를 고르세요","warning");return}if(!n)return;await ct({action_type:"keeper_message",target_type:"keeper",target_id:t,payload:{message:n},successMessage:`${t}에게 메시지를 보냈습니다`})&&(sn.value="")}async function pr(e,t="confirm"){const n=Da.value.trim()||"dashboard";try{await kl(n,e,t),E(t==="deny"?"승인 대기를 거부했습니다":"확인 실행을 완료했습니다","success")}catch(s){const a=s instanceof Error?s.message:t==="deny"?"승인 대기 거부에 실패했습니다":"확인 실행에 실패했습니다";E(a,"error")}}function yc(e){switch(e){case"explicit":return"실제 관리 단위";case"hybrid":return"관리 단위 + 자동 보강";case"auto":return"자동 투영";default:return"출처 미상"}}function bc(e){switch(e){case"explicit":return"ok";case"hybrid":return"warn";case"auto":return"warn";default:return"warn"}}function wf(e){switch(e){case"explicit":return"지금 보이는 유닛은 실제로 정의된 지휘면 관리 단위입니다.";case"hybrid":return"일부는 실제 관리 단위이고, 비어 있는 부분은 실시간 에이전트 편성을 보고 자동 보강한 구조입니다.";case"auto":return"이 화면은 실시간 에이전트 편성을 지휘면 모양으로 자동 투영한 것입니다. 실제 명령 체계와 1:1로 같다고 보면 안 됩니다.";default:return"이 화면은 관리 토폴로지와 실효 토폴로지가 섞여 있을 수 있습니다."}}function Df(e){const t=e.unit.source??"unknown";return t==="explicit"?e.active_operation_count&&e.active_operation_count>0?"실제 관리 단위이며 연결된 작전이 있습니다.":"실제 관리 단위이지만 현재 연결된 작전은 없습니다.":t==="hybrid"?e.active_operation_count&&e.active_operation_count>0?"관리 단위를 기반으로 자동 보강된 구조이며 일부 작전이 연결돼 있습니다.":"관리 단위를 기반으로 자동 보강된 구조이며 현재 실행 연결은 약합니다.":e.active_operation_count&&e.active_operation_count>0?"자동 생성된 구조이지만 이 노드에 연결된 작전 흔적은 있습니다.":"자동 생성된 구조이며 현재 실행 연결은 없습니다."}function kc({node:e,depth:t=0}){const n=e.roster_live??0,s=e.roster_total??e.unit.roster.length,a=e.active_operation_count??0,o=e.unit.policy,l=e.unit.source??"unknown",c=a>0?`${a}개 작전 연결`:"실행 연결 없음";return i`
    <div class="command-tree-node depth-${Math.min(t,3)}">
      <div class="command-tree-head">
        <div>
          <div class="command-tree-title-row">
            <strong>${e.unit.label}</strong>
            <span class="command-chip">${M_(e.unit.kind)}</span>
          ...
          <div class="command-card-sub">${Df(e)}</div>
  ...
  `}function qf(){const e=qe.value,t=e==null?void 0:e.topology,n=t==null?void 0:t.source,s=t==null?void 0:t.summary,a=(s==null?void 0:s.managed_unit_count)??0,o=(s==null?void 0:s.active_operation_count)??0;return i`
    <section class="card command-section">
      <div class="card-title-row">
  ...
  `}function Ff(){const e=qe.value;return i`
    <section class="card command-section">
      <div class="card-title-row">
      ...
      ${e&&e.alerts.alerts.length>0?i`<div class="command-card-stack">
            ${e.alerts.alerts.map(t=>i`<${Of} alert=${t} />`)}
  ...
  `}function Wf({total:e}){const n=Math.min(e,20),s=e>20?e-20:0,a=Array.from({length:n});return i`
  ...
  `}function Gf({lane:e}){const t=e.counts??{},n=Sc(e),s=t.workers??0,a=t.operations??0,o=t.detachments??0,l=a+o,c=e.motion_state==="moving"?84:e.motion_state==="waiting"?58:e.motion_state==="terminal"?100:26;return i`
  ...
  `}function Jf({event:e}){const t=e.timestamp?new Date(e.timestamp):null,n=t&&!isNaN(t.getTime())?t:null,s=n?`${String(n.getHours()).padStart(2,"0")}:${String(n.getMinutes()).padStart(2,"0")}`:"";return i`
  ...
  `}function Yf({proof:e}){const t=(e==null?void 0:e.status)==="missing"?"warn":(e==null?void 0:e.pass)===!1?"bad":(e==null?void 0:e.pass)===!0?"ok":"warn";return i`
      ...
      ${s?i`
            ...
            <div class="command-swarm-layout ${u?"compact":""}">
              <div class="command-card-stack">
                ${o.length>0?o.map(_=>i`<${Gf} lane=${_} />`):i`<div class="empty-state">활성 스웜 레인이 없습니다.</div>`}
              </div>
              ...
              <div class="command-card-stack">
                ...
                <div class="command-guide-card ${l.length>0?"warn":"ok"} ${n==="gaps"?"focus":""}">
                  ...
                  ${l.length>0?i`<div class="swarm-event-rail">${l.slice(0,4).map(_=>i`<${Vf} gap=${_} />`)}</div>`:i`<p>지금 보이는 핵심 공백은 없습니다.</p>`}
                </div>
                ...
                <div class="command-guide-card">
                  ...
                  ${c.length>0?i`<div class="swarm-event-rail">${c.map(_=>i`<${Jf} event=${_} />`)}</div>`:i`<p>붙어 있는 최근 이동 이벤트가 아직 없습니다.</p>`}
                </div>
              </div>
            </div>
          `:i`<div class="empty-state">스웜 상태를 아직 불러오지 못했습니다.</div>`}
    </section>
  `}function Qf({item:e}){return i`
  ...
  `}function eg(){var p,m,u,_,g,h,b,$,S,C,x,L,T,R,M,z,j,Z,ie,V,ee;const e=Mt.value,t=_c(),n=ho(),s=(p=e==null?void 0:e.provider)!=null&&p.runtime_blocker?"blocked":(m=e==null?void 0:e.provider)!=null&&m.provider_reachable?"ready":"check",a=((u=e==null?void 0:e.provider)==null?void 0:u.actual_slots)??((_=e==null?void 0:e.provider)==null?void 0:_.total_slots)??0,o=((g=e==null?void 0:e.provider)==null?void 0:g.expected_slots)??"n/a",l=((h=e==null?void 0:e.provider)==null?void 0:h.actual_ctx)??((b=e==null?void 0:e.provider)==null?void 0:b.ctx_per_slot)??0,c=(($=e==null?void 0:e.provider)==null?void 0:$.expected_ctx)??"n/a";return i`
    <div class="command-section-stack">
      ...
      <div class="command-surface-grid">
        <section class="card command-section">
          ...
          ${ia.value?i`<div class="empty-state">Loading swarm live state…</div>`:oa.value?i`<div class="empty-state error">${oa.value}</div>`:e?i`
                    <div class="command-summary-grid">
  ...
  `}function og(){var ee,A,Te,Je,_t,ft,K,ze,gt,_n,fn,ls,cs,ds,us,ps,ms,vs,Po,Lo,Mo;const e=rs(),t=Mt.value,n=_e.value,s=De.value,a=B_(),o=t!=null&&t.operation?((ee=ss.value)==null?void 0:ee.operations.find(Y=>{var _s;return Y.operation.operation_id===((_s=t.operation)==null?void 0:_s.operation_id)}))??null:null,l=F_(),c=(t==null?void 0:t.workers)??[],p=(s==null?void 0:s.worker_cards)??[],m=l&&c.length>0?c.map(sg):p.map(ag),u=l,_=((A=e==null?void 0:e.decisions.summary)==null?void 0:A.pending)??0,g=(n==null?void 0:n.pending_confirms)??[],h=l?(t==null?void 0:t.blockers)??[]:[],b=(s==null?void 0:s.recommended_actions)??[],$=(Te=s==null?void 0:s.active_recommended_actions)!=null&&Te.length?s.active_recommended_actions:b,S=s==null?void 0:s.active_summary,C=(s==null?void 0:s.active_guidance_layer)??"fallback",x=(s==null?void 0:s.resident_judge_runtime)??(n==null?void 0:n.resident_judge_runtime),L=(s==null?void 0:s.attention_items)??[],T=((Je=t==null?void 0:t.recent_messages[0])==null?void 0:Je.timestamp)??null,R=((_t=t==null?void 0:t.recent_trace_events[0])==null?void 0:_t.timestamp)??null,M=l?T??R??null:null,z=a==null?void 0:a.summary,j=(l?(ft=t==null?void 0:t.summary)==null?void 0:ft.expected_workers:void 0)??(typeof(z==null?void 0:z.planned_worker_count)=="number"?z.planned_worker_count:void 0)??(s==null?void 0:s.worker_cards.length)??0,Z=(l?(K=t==null?void 0:t.summary)==null?void 0:K.joined_workers:void 0)??(typeof(z==null?void 0:z.active_agent_count)=="number"?z.active_agent_count:void 0)??m.length,ie=h.length>0||_>0||g.length>0?"warn":u||a?"ok":"warn",V=l?((ze=e==null?void 0:e.swarm_status)==null?void 0:ze.lanes.filter(Y=>Y.present))??[]:[];return ne(()=>{ye()},[]),ne(()=>{a!=null&&a.session_id&&rn(a.session_id)},[a==null?void 0:a.session_id,n,(gt=t==null?void 0:t.detachment)==null?void 0:gt.session_id]),!u&&!a?ia.value||Nn.value?i`<div class="empty-state">실시간 워룸 불러오는 중…</div>`:i`
  ...
  `}function vr(e){switch((e??"").trim().toLowerCase()){case"active":return"가동 중";case"paused":return"일시정지";case"failed":return"실패";case"completed":case"done":return"완료";case"disconnected":return"끊김";case"preview":return"미리보기";case"captured":return"기록됨";default:return(e==null?void 0:e.trim())||"확인 필요"}}function rg({source:e}){const t=Vc(null),[n,s]=Rr(null);return ne(()=>{let a=!1;const o=t.current;return o?(o.innerHTML="",s(null),(async()=>{try{const c=await C_(),{svg:p}=await c.render(`command-chain-${S_()}`,e);if(a||!t.current)return;t.current.innerHTML=p}catch(c){if(a)return;s(c instanceof Error?c.message:"Mermaid 렌더링에 실패했습니다")}})(),()=>{a=!0,t.current&&(t.current.innerHTML="")}):void 0},[e]),i`
    <div class="command-chain-graph-shell">
      ${n?i`<div class="empty-state error">${n}</div>`:null}
      <div class="command-chain-graph" ref=${t}></div>
    </div>
  `}function lg({overlay:e,selected:t,onSelect:n}){const s=e.operation.chain,a=e.runtime;return i`
  ...
  `}function ug({card:e}){const t=e.operation,n=`pause:${t.operation_id}`,s=`resume:${t.operation_id}`,a=`recall:${t.operation_id}`,o=t.chain,l=(o==null?void 0:o.run_id)??null;return i`
    <article class="command-card">
      ...
      <div class="command-action-row">
        ...
        ${o?i`
              <button
                class="control-btn ghost"
                onClick=${()=>{co(t.operation_id),at("chains"),se("command",{surface:"chains",operation:t.operation_id})}}
              >
                체인 열기
              </button>
            `:null}
        ${t.source==="managed"&&t.status==="active"?i`
              <button class="control-btn ghost" disabled=${oe(n)} onClick=${()=>ot(()=>tv(t.operation_id))}>
                ${oe(n)?"일시정지 중…":"일시정지"}
              </button>
              <button class="control-btn ghost" disabled=${oe(a)} onClick=${()=>ot(()=>sv(t.operation_id))}>
                ${oe(a)?"회수 중…":"회수"}
              </button>
            `:null}
        ${t.source==="managed"&&t.status==="paused"?i`
              <button class="control-btn ghost" disabled=${oe(s)} onClick=${()=>ot(()=>nv(t.operation_id))}>
                ${oe(s)?"재개 중…":"재개"}
              </button>
            `:null}
      </div>
    </article>
  `}function pg({card:e}){var n;const t=e.detachment;return i`
    <article class="command-card compact">
      <div class="command-card-head">
        <div>
      ...
      <div class="command-tag-row">
        ${t.heartbeat_deadline?i`<span class="command-tag ${k_(t.heartbeat_deadline)}">
              기한 ${t.heartbeat_deadline}
            </span>`:null}
      </div>
    </article>
  `}function mg(){const e=qe.value;return i`
    <div class="command-surface-grid">
      <section class="card command-section">
        <div class="card-title-row">
        ...
        ${e&&e.operations.operations.length>0?i`<div class="command-card-stack">
              ${e.operations.operations.map(t=>i`<${ug} card=${t} />`)}
      ...
      <section class="card command-section">
        ...
        ${e&&e.detachments.detachments.length>0?i`<div class="command-card-stack">
              ${e.detachments.detachments.map(t=>i`<${pg} card=${t} />`)}
            </div>`:i`<div class="empty-state">투영된 분견대가 없습니다.</div>`}
      </section>
    </div>
  `}function vg(){var c,p,m,u,_,g,h,b,$,S,C,x,L,T,R,M;const e=ss.value,t=(e==null?void 0:e.operations)??[],n=Qt.value,s=t.find(z=>z.operation.operation_id===n)??t[0]??null,a=((c=s==null?void 0:s.operation.chain)==null?void 0:c.run_id)??null,o=((p=Dn.value)==null?void 0:p.run)??(s==null?void 0:s.preview_run)??null,l=!((m=Dn.value)!=null&&m.run)&&!!(s!=null&&s.preview_run);return ne(()=>{a?Zm(a):Qm()},[a]),i`
    <div class="command-grid">
      <section class="card command-section">
        ...
        ${Ni.value&&!e?i`<div class="empty-state">체인 오버레이 불러오는 중…</div>`:t.length>0?i`
                <div class="command-chain-list">
                  ${t.map(z=>i`
                    <${lg}
                      overlay=${z}
                      selected=${(s==null?void 0:s.operation.operation_id)===z.operation.operation_id}
                      onSelect=${()=>co(z.operation.operation_id)}
                    />
                  `)}
                </div>
        ...
        <div class="command-chain-history">
          ...
          ${e&&e.recent_history.length>0?i`
                <div class="command-card-stack">
                  ${e.recent_history.slice(0,6).map(z=>i`<${cg} item=${z} />`)}
                </div>
      ...
      <section class="card command-section">
        ...
        ${s?i`
              ...
              <div class="command-chain-panel">
                ...
                ${ca.value?i`<div class="empty-state">실행 상세 불러오는 중…</div>`:On.value?i`<div class="empty-state error">${On.value}</div>`:o&&o.nodes.length>0?i`
                          <div class="command-card-grid">
  ...
  `}function _g(e){switch((e??"").trim().toLowerCase()){case"pending":return"대기 중";case"approved":return"승인됨";case"denied":return"거부됨";case"executed":return"실행됨";case"active":return"가동 중";default:return(e==null?void 0:e.trim())||"확인 필요"}}function fg({decision:e}){const t=`approve:${e.decision_id}`,n=`deny:${e.decision_id}`,s=e.source==="projected_operator";return i`
    <article class="command-card ${P(e.status)}">
      <div class="command-card-head">
        ...
        <span class="command-chip ${P(e.status)}">${_g(e.status??"pending")}</span>
      </div>
      <div class="command-card-grid">
      ...
      ${e.status==="pending"&&!s?i`
            <div class="command-action-row">
              <button class="control-btn ghost" disabled=${oe(t)} onClick=${()=>ot(()=>iv(e.decision_id))}>
                ${oe(t)?"승인 중…":"승인"}
              </button>
              <button class="control-btn ghost" disabled=${oe(n)} onClick=${()=>ot(()=>ov(e.decision_id))}>
                ${oe(n)?"거부 중…":"거부"}
              </button>
            </div>
          `:null}
  ...
  `}function gg({row:e}){var c,p,m;const t=e.unit,n=`freeze:${t.unit_id}`,s=`kill:${t.unit_id}`,a=!!((c=t.policy)!=null&&c.frozen),o=!!((p=t.policy)!=null&&p.kill_switch),l=Math.round((e.utilization??0)*100);return i`
    <article class="command-card compact">
      <div class="command-card-head">
        <div>
      ...
      <div class="command-action-row">
        <button class="control-btn ghost" disabled=${oe(n)} onClick=${()=>ot(()=>rv(t.unit_id,!a))}>
          ${oe(n)?"적용 중…":a?"동결 해제":"동결"}
        </button>
        <button class="control-btn ghost" disabled=${oe(s)} onClick=${()=>ot(()=>lv(t.unit_id,!o))}>
          ${oe(s)?"적용 중…":o?"킬 스위치 해제":"킬 스위치 켜기"}
        </button>
      </div>
    </article>
  `}function $g(){const e=qe.value;return i`
    <div class="command-surface-grid">
      <section class="card command-section">
        <div class="card-title-row">
        ...
        ${e&&e.decisions.decisions.length>0?i`<div class="command-card-stack">
              ${e.decisions.decisions.map(t=>i`<${fg} decision=${t} />`)}
      ...
      <section class="card command-section">
        ...
        ${e&&e.capacity.capacity.length>0?i`<div class="command-card-stack">
              ${e.capacity.capacity.map(t=>i`<${gg} row=${t} />`)}
            </div>`:i`<div class="empty-state">제어할 용량 행이 아직 없습니다.</div>`}
      </section>
    </div>
  `}function hg(){return i`
  ...
  `}function yg(){if(G.value==="warroom")return i`<${og} />`;if(G.value==="summary")return i`<${cf} />`;if(G.value==="orchestra")return i`<${hf} />`;if(G.value==="swarm")return i`<${eg} />`;if(!qe.value)return i`<${df} />`;switch(G.value){case"chains":return i`<${vg} />`;case"topology":return i`<${qf} />`;case"alerts":return i`<${Ff} />`;case"trace":return i`<${Kf} />`;case"control":return i`<${$g} />`;case"operations":default:return i`<${mg} />`}}function bg(){return ne(()=>{Kt(),Zt(),ev(),Qe(),It()},[]),ne(()=>{if(F.value.tab!=="command")return;const e=F.value.params.surface,t=F.value.params.operation,n=as(F.value);if(sr(e))at(e);else if(n){const s=Xl(n);sr(s)&&at(s)}else e||at("warroom");t&&co(t),(e==="swarm"||e==="warroom"||e==="orchestra"||G.value==="warroom"||G.value==="orchestra")&&Qe(),(e==="orchestra"||G.value==="orchestra")&&It(),(e==="warroom"||G.value==="warroom")&&ye()},[F.value.tab,F.value.params.surface,F.value.params.operation,F.value.params.operation_id,F.value.params.run_id,F.value.params.source,F.value.params.action_type,F.value.params.target_type,F.value.params.target_id,F.value.params.focus_kind]),ne(()=>{let e=null;const t=()=>{e||(e=window.setTimeout(()=>{e=null,Kt(),Zt(),(G.value==="swarm"||G.value==="warroom"||G.value==="orchestra")&&Qe(),G.value==="orchestra"&&It(),G.value==="warroom"&&ye()},250))},n=new EventSource(L_()),s=z_.map(a=>{const o=()=>t();return n.addEventListener(a,o),{type:a,handler:o}});return n.onerror=()=>{t()},()=>{s.forEach(({type:a,handler:o})=>{n.removeEventListener(a,o)}),n.close(),e&&window.clearTimeout(e)}},[]),ne(()=>{const e=window.setInterval(()=>{if(document.visibilityState==="hidden")return;const t=G.value;t!=="swarm"&&t!=="warroom"&&t!=="orchestra"||(Kt(),Qe(),t==="orchestra"&&It(),t==="warroom"&&ye())},5e3);return()=>{window.clearInterval(e)}},[]),i`
    <section class="dashboard-panel command-plane-view">
      <div class="panel-header">
        ...
        <div class="panel-actions">
          ...
          <button
            class="control-btn ghost"
            onClick=${()=>{Kt(),Zt(),Qe(),G.value==="warroom"&&ye()}}
            disabled=${Zs.value}
          >
            ${Zs.value?"새로고침 중...":"새로고침"}
          </button>
        </div>
      </div>
      ...
      <section class="card ops-panel ops-lane-panel">
        ...
        <div class="control-row ops-split-row">
          <input
            ...
            disabled=${W.value}
          />
          <button class="control-btn ghost" onClick=${()=>{Lf()}} disabled=${W.value}>
            일시정지
          </button>
        ...
        <div class="control-row ops-split-row">
          ...
          <button class="control-btn" onClick=${()=>{Mf()}} disabled=${W.value||nn.value.trim()===""}>
            주입
          </button>
        </div>
      </section>
              ...
              <article key=${`${x.action_type}:${x.target_type}:${x.target_id??"room"}`} class="ops-log-entry ${x.severity}">
                ...
                ${x.suggested_payload?i`
                  <div class="ops-confirmation-actions">
                    <button class="control-btn ghost" onClick=${()=>{Rf(x)}} disabled=${W.value}>
                      폼에 채우기
                    </button>
                  </div>
                `:null}
    ...
    <div class="ops-column">
      ...
      <section class="card ops-panel ops-lane-panel">
        ...
        <div class="control-row ops-split-row">
          ...
          <button class="control-btn" onClick=${()=>{jf()}} disabled=${W.value||!a}>
            적용
          </button>
        </div>
        <div class="ops-context-note">현재 선택: ${Af(he.value)}</div>
        ...
        <div class="control-row ops-split-row">
          <input
            ...
            disabled=${W.value||!a}
          />
          <button class="control-btn ghost" onClick=${()=>{Ef()}} disabled=${W.value||!a}>
            세션 중지
          </button>
        </div>
      </section>
    </div>
  `}function Sg(){var o;const e=_e.value,t=(e==null?void 0:e.keepers)??[],n=(e==null?void 0:e.persistent_agents)??[],s=(e==null?void 0:e.available_actions)??[],a=t.find(l=>l.name===ga.value)??t[0]??null;return i`
    <div class="ops-column">
      ...
      <section class="card ops-panel ops-lane-panel">
        ...
        ></textarea>
        <div class="control-row">
          <button class="control-btn" onClick=${()=>{Nf()}} disabled=${W.value||!a||sn.value.trim()===""}>
            keeper에 보내기
          </button>
        </div>
      </section>
      ...
      <div class="ops-header card">
        ...
        <div class="ops-toolbar">
          ...
          <input
            ...
            type="text"
            value=${Da.value}
            onInput=${z=>bf(z.target.value)}
          />
          <button
            class="control-btn ghost"
            onClick=${()=>{ye(),Pt(),rn((g==null?void 0:g.session_id)??null)}}
            disabled=${Nn.value||W.value}
          >
  ...
  `}function Ag({text:e}){if(!e)return null;const t=Ig(e);return i`<div class="markdown-content">${t}</div>`}function Ig(e){const t=e.split(`
...
`))}</p>`)}return n}function Xa(e){const t=[],n=/(`[^`]+`)|(\*\*[^*]+\*\*)|(\*[^*]+\*)|\[([^\]]+)\]\(([^)]+)\)/g;let s=0,a;for(;(a=n.exec(e))!==null;){if(a.index>s&&t.push(e.slice(s,a.index)),a[1]){const o=a[1].slice(1,-1);t.push(i`<code>${o}</code>`)}else if(a[2]){const o=a[2].slice(2,-2);t.push(i`<strong>${o}</strong>`)}else if(a[3]){const o=a[3].slice(1,-1);t.push(i`<em>${o}</em>`)}else a[4]&&a[5]&&t.push(i`<a href=${a[5]} target="_blank" rel="noopener">${a[4]}</a>`);s=a.index+a[0].length}return s<e.length&&t.push(e.slice(s)),t.length>0?t:[e]}const Tc=[{id:"recent",label:"최신순"},{id:"hot",label:"인기순"},{id:"trending",label:"급상승"},{id:"updated",label:"최근 갱신"},{id:"discussed",label:"토론 많은 순"}],Ds=f(null),Os=f([]),dn=f(!1),zt=f(null),zn=f(""),Rn=f(!1),Ht=f(!0),Co=20,Dt=f(Co);function Tg(){var t,n;const e=new URLSearchParams(window.location.search);return((t=e.get("agent"))==null?void 0:t.trim())||((n=e.get("agent_name"))==null?void 0:n.trim())||"dashboard-user"}const zg=f(Tg());function Rg(e){const t=e.replace(/!\[[^\]]*\]\([^)]+\)/g," ").replace(/\[[^\]]+\]\([^)]+\)/g,"$1").replace(/[`#>*_~-]/g," ").replace(/\s+/g," ").trim();return t?t.length>180?`${t.slice(0,177)}...`:t:"미리보기 없음"}function _r(e){return e.updated_at!==e.created_at}function Pg(e){if(e.post_kind)return e.post_kind==="automation";const t=(e.hearth??"").toLowerCase();return e.visibility!=="internal"||!e.expires_at||!t?!1:!!(t.startsWith("mdal")||t.includes("harness"))}function Lg(e){return e==="lodge-system"||e==="team-session"}function Vn(e){return e.post_kind?e.post_kind:Lg(e.author)?"system":Pg(e)?"automation":"human"}function zc(e){const t=[],n=[];let s=0;return e.forEach(a=>{const o=Vn(a);if(!(o==="system"&&St.value)){if(o==="automation"&&Ht.value){s+=1;return}if(o==="human"){t.push(a);return}n.push(a)}}),{human:t,operations:n,hiddenAutomation:s}}function Mg(e){if(!e.expires_at)return null;const t=Date.parse(e.expires_at);return Number.isFinite(t)?t<=Date.now()?i`<span class="board-meta-chip">만료됨</span>`:i`<span class="board-meta-chip">만료까지 <${J} timestamp=${e.expires_at} /></span>`:null}async function Ao(e){zt.value=e,Ds.value=null,Os.value=[],dn.value=!0;try{const t=await Vd(e);if(zt.value!==e)return;Ds.value={id:t.id,author:t.author,title:t.title,body:t.body,content:t.content,meta:t.meta,tags:t.tags,votes:t.votes,vote_balance:t.vote_balance,comment_count:t.comment_count,created_at:t.created_at,updated_at:t.updated_at,post_kind:t.post_kind,flair:t.flair,hearth:t.hearth,visibility:t.visibility,expires_at:t.expires_at,hearth_count:t.hearth_count},Os.value=t.comments??[]}catch{zt.value===e&&(Ds.value=null,Os.value=[])}finally{zt.value===e&&(dn.value=!1)}}async function fr(e){const t=zn.value.trim();if(t){Rn.value=!0;try{await Yd(e,zg.value,t),zn.value="",E("댓글을 등록했습니다","success"),await Ao(e),nt()}catch{E("댓글 등록에 실패했습니다","error")}finally{Rn.value=!1}}}function jg(){const e=jn.value,t=Ht.value?"자동화 글 숨김":"자동화 글 표시 중";return i`
  ...
  `}function gr({post:e}){const t=async(n,s)=>{s.stopPropagation();try{await Gr(e.id,n),nt()}catch{E("투표에 실패했습니다","error")}};return i`
    <div class="board-post" onClick=${()=>ed(e.id)}>
      ...
      <div class="post-content">
        ...
        <div class="post-snippet">${Rg(e.body)}</div>
      </div>
    </div>
  `}function Eg({comments:e}){return e.length===0?i`<div class="empty-state" style="font-size:13px">아직 댓글이 없습니다</div>`:i`
  ...
  `}function wg({post:e}){zt.value!==e.id&&!dn.value&&Ao(e.id);const t=async n=>{try{await Gr(e.id,n),nt()}catch{E("Failed to vote","error")}};return i`
    <div>
      ...
      <${I} title="댓글" semanticId="memory.feed">
        ${dn.value?i`<div class="loading-indicator">댓글 불러오는 중...</div>`:i`<${Eg} comments=${Os.value} />`}
        <${Ng} postId=${e.id} />
      <//>
    </div>
  `}function Dg(){const e=zc(Ma.value),t=[...e.human,...e.operations],n=F.value.params.post??null,s=n?t.find(a=>a.id===n)??(zt.value===n?Ds.value:null):null;return n&&!s&&zt.value!==n&&!dn.value&&Ao(n),n?s?i`
          <${be} surfaceId="memory" />
          <${Qa} />
          <${wg} post=${s} />
        `:i`
  ...
  `}function Og({ratio:e,size:t=40,stroke:n=4}){if(e==null)return null;const s=(t-n)/2,a=t/2,o=2*Math.PI*s,l=o*((100-e*100)/100);let c="mitosis-safe";return e>=.8?c="mitosis-critical":e>=.5&&(c="mitosis-warn"),i`
  ...
  `}const kt=f(null),Fe=f(null),Ke=f(null);function Oa(e){return e==="bad"||e==="critical"||e==="offline"?"bad":e==="warn"||e==="paused"||e==="blocked"||e==="interrupted"?"warn":"ok"}function ba(e){switch((e??"").trim().toLowerCase()){case"ok":case"healthy":case"green":return"안정";case"active":case"running":return"진행 중";case"paused":return"일시정지";case"blocked":return"막힘";case"interrupted":return"중단됨";case"warn":return"주의";case"bad":case"critical":return"위험";case"offline":return"오프라인";case"idle":case"quiet":return"대기";case"unknown":case"":return"확인 필요";default:return(e==null?void 0:e.trim())||"확인 필요"}}function qg(e){return e==="session"?"세션":"작전"}function Fg(e){return typeof e!="number"||Number.isNaN(e)?"—":`${Math.round(e*100)}%`}function Kg(e){return e?pt.value.find(t=>t.name===e||t.agent_name===e)??null:null}function Bg(e){switch(e){case"working":return"작업 중";case"watching":return"대기 중";case"quiet":return"조용함";case"offline":return"오프라인"}}function Ug(e){switch(e){case"critical":return"위험";case"warning":return"주의";default:return"정상"}}function $r(e){if(!e)return;const t=gv({targetType:e.target_type,targetId:e.target_id,focusKind:e.focus_kind,operationId:e.operation_id??null,commandSurface:e.command_surface??null,sourceLabel:"실행 진단",summary:e.label});Vl(t),se(e.surface,e.surface==="intervene"?Yl(t):Ql(t))}function Nt({label:e,value:t,color:n,caption:s}){return i`
    <div class="stat-card">
  ...
  `}function Hg({item:e,selected:t}){return i`
    <button
  ...
  `}function Wg({brief:e,selected:t}){return i`
    <button
      class="mission-card-select ${t?"active":""}"
  ...
  `}function hr({row:e,testId:t}){return i`
    <button class="monitor-row ${e.tone} state-${e.state}" data-testid=${t} onClick=${()=>wa(e.name)}>
  ...
  `}function Jg({row:e}){const t=()=>{const n=Kg(e.name);n&&lc(n)};return i`
    <button class="monitor-row ${e.tone} state-${e.state}" data-testid="execution.continuity-card" onClick=${t}>
      <div class="monitor-row-header">
        ...
        <${Og} ratio=${e.context_ratio??0} size=${34} stroke=${4} />
        <${vt} status=${e.status??"unknown"} />
        <span class="monitor-pill ${e.tone}">${Ug(e.state)}</span>
      </div>
    ...
    <div class="agents-monitor">
      ...
      >
        ...
        <div class="monitor-alert-list">
          ${t.length===0?i`<div class="empty-state">지금은 막힌 실행이 없습니다.</div>`:t.map($=>i`<${Hg} key=${$.id} item=${$} selected=${kt.value===$.id} />`)}
        </div>
      <//>
      ...
      <div class="agents-workbench">
        ...
        >
          ...
          <div class="monitor-list">
            ${u.length===0?i`<div class="empty-state">선택된 실행과 연결된 세션이 없습니다.</div>`:u.map($=>i`<${Wg} key=${$.session_id} brief=${$} selected=${Fe.value===$.session_id} />`)}
          </div>
        <//>
        ...
        >
          ...
          <div class="monitor-list">
            ${_.length===0?i`<div class="empty-state">선택된 실행과 연결된 작전이 없습니다.</div>`:_.map($=>i`<${Gg} key=${$.operation_id} brief=${$} selected=${Ke.value===$.operation_id} />`)}
          </div>
        <//>
        ...
        >
          ...
          <div class="monitor-list">
            ${h.length===0?i`<div class="empty-state">지금은 연속성 경고가 없습니다.</div>`:h.map($=>i`<${Jg} key=${$.name} row=${$} />`)}
          </div>
        <//>
  ...
  `}const ka=f("all"),xa=f("all"),Fi=f(new Set);function Yg(e){const t=new Set(Fi.value);t.has(e)?t.delete(e):t.add(e),Fi.value=t}const Rc=Ie(()=>{let e=Jt.value;return ka.value!=="all"&&(e=e.filter(t=>t.horizon===ka.value)),xa.value!=="all"&&(e=e.filter(t=>t.status===xa.value)),e}),Xg=Ie(()=>{const e={short:[],mid:[],long:[]};for(const t of Rc.value){const n=e[t.horizon];n&&n.push(t)}return e}),Qg=Ie(()=>{const e=Array.from(ol.value.values());return e.sort((t,n)=>t.status==="running"&&n.status!=="running"?-1:n.status==="running"&&t.status!=="running"?1:t.status==="interrupted"&&n.status!=="interrupted"?-1:n.status==="interrupted"&&t.status!=="interrupted"?1:n.elapsed_seconds-t.elapsed_seconds),e});function Zg(e){return"★".repeat(Math.min(e,5))+"☆".repeat(Math.max(0,5-e))}function To(e){switch(e){case"short":return"단기";case"mid":return"중기";case"long":return"장기";default:return e}}function qs(e){switch(e){case"short":return"#4ade80";case"mid":return"#f59e0b";case"long":return"#818cf8";default:return"#888"}}function e$(e){return e<60?`${Math.round(e)}s`:e<3600?`${Math.floor(e/60)}m ${Math.round(e%60)}s`:`${Math.floor(e/3600)}h ${Math.floor(e%3600/60)}m`}function yr(e){return e.toFixed(4)}function br(e){const t=e.current_metric-e.baseline_metric;return`${t>=0?"+":""}${t.toFixed(4)}`}function t$(e){switch(e){case 1:return"P1";case 2:return"P2";case 3:return"P3";default:return"P4"}}function n$(e){switch(e){case"active":return"진행 중";case"completed":return"완료";case"paused":return"일시정지";default:return"전체"}}function kr(e,t){return(e.priority??4)-(t.priority??4)}function s$(e,t){const n=e.updated_at??e.created_at??"";return(t.updated_at??t.created_at??"").localeCompare(n)}function a$(e,t){return e.length<=t?e:e.slice(0,t)+"..."}function i$({goal:e}){return i`
    <div class="goal-row">
      <div class="goal-row-main">
        ...
        <div class="goal-meta">
          <span class="goal-priority" title="Priority ${e.priority}">${Zg(e.priority)}</span>
  ...
  `}function r$(){const e=Jt.value,t=e.filter(a=>a.status==="active").length,n=e.filter(a=>a.status==="completed").length,s={short:0,mid:0,long:0};for(const a of e)a.horizon in s&&s[a.horizon]++;return i`
  ...
  `}function l$({loop:e}){const t=e.history[0],n=e.latest_tool_names&&e.latest_tool_names.length>0?`${e.latest_tool_call_count??e.latest_tool_names.length}개 도구: ${e.latest_tool_names.join(", ")}`:"아직 근거 없음";return i`
    <div class="planning-loop-row">
      <div class="planning-loop-main">
        ...
        <div class="planning-loop-metrics">
          ...
          <span>Elapsed ${e$(e.elapsed_seconds)}</span>
        </div>
  ...
  `}function ei({task:e}){const t=e.priority??4,n=t<=1?"p1":t===2?"p2":t===3?"p3":"p4",s=Fi.value.has(e.id),a=!!e.description;return i`
    <div class="kanban-card ${n}">
      <div class="kanban-card-header">
        <span class="priority-badge priority-badge--${n}">${t$(t)}</span>
      ...
      ${a?i`
        <div
          ...
          onClick=${()=>Yg(e.id)}
        >
          ${s?e.description:a$(e.description??"",80)}
        </div>
      `:null}
  ...
  `}function c$(){const{todo:e,inProgress:t,done:n}=ll.value,s=[...e].sort(kr),a=[...t].sort(kr),o=[...n].sort(s$);return i`
  ...
  `}function d$(){const{todo:e,inProgress:t,done:n}=ll.value,s=e.length+t.length+n.length,a=[...e,...t].filter(u=>(u.priority??4)<=2).length,o=Xg.value,l=Qg.value,c=Jt.value.length>0,p=l.length>0,m=Zi.value;return i`
    <div>
        ...
        <div>
          ${Sn.value&&l.length===0?i`<div class="loading-indicator">MDAL 루프 불러오는 중...</div>`:l.length===0&&(m==="error"||Vt.value)?i`<div class="empty-state">MDAL 스냅샷을 불러오지 못했습니다${Vt.value?`: ${Vt.value}`:""}. 백엔드 상태를 확인하세요.</div>`:l.length===0?i`<div class="empty-state">가동 중인 루프가 없습니다. <code>masc_mdal_start</code>로 시작할 수 있습니다.</div>`:i`
                  <div class="planning-loop-list">
                    ${l.map(u=>i`<${l$} key=${u.loop_id} loop=${u} />`)}
                  </div>
                `}
        </div>
      </details>
    </div>
  `}const Sa=f(!1),Pn=f(!1),Wt=f(!1),dt=f(""),Ln=f(""),Ki=f("open"),Ee=f(null),Yn=f(null),Ca=f(null),Aa=f(null),Bi=f(!1);function Xn(e){return`${e.kind}:${e.id}`}function zo(){var n;const e=Yn.value,t=((n=Ee.value)==null?void 0:n.items)??[];return e?t.find(s=>Xn(s)===e)??null:null}function u$(){const e=new URLSearchParams(window.location.search),t=e.get("agent")??e.get("agent_name");return(t==null?void 0:t.trim())||"dashboard"}function p$(e){const t=e.trim().toLowerCase();return t==="open"||t==="pending"}function Pc(e){return!!(e.judgment_summary&&e.judgment_summary.trim())}function Lc(e){switch(Ki.value){case"needs_quorum":return e.filter(t=>t.kind==="consensus"&&(t.votes??0)<(t.quorum??0));case"ready":return e.filter(t=>{var n;return(n=t.guardrail_state)==null?void 0:n.ready_to_execute});case"needs_approval":return e.filter(t=>{var n,s;return((n=t.guardrail_state)==null?void 0:n.requires_human_gate)||!!((s=t.guardrail_state)!=null&&s.pending_confirm)});case"judge_offline":return e.filter(t=>!Pc(t));case"open":default:return e.filter(t=>p$(t.status))}}function m$(e){if(e==null)return"없음";if(typeof e=="string")return e;try{return JSON.stringify(e,null,2)}catch{return String(e)}}function qa(e){const t=(e||"").toLowerCase();return t.includes("reject")||t.includes("deny")||t.includes("closed")||t.includes("cancel")?"negative":t.includes("approve")||t.includes("support")||t.includes("open")||t.includes("ready")?"positive":"neutral"}function v$(e){return typeof e!="number"||Number.isNaN(e)?"확인 필요":`${Math.round(e*100)}%`}function yn(e){return"resolved_tool"in e||"payload_preview"in e||"reason"in e}async function Mc(e){if(Ca.value=null,Aa.value=null,!!e){Bi.value=!0,dt.value="";try{e.kind==="debate"?Ca.value=await xu(e.id):Aa.value=await Su(e.id)}catch(t){dt.value=t instanceof Error?t.message:"거버넌스 상세를 불러오지 못했습니다"}finally{Bi.value=!1}}}async function _$(e){Yn.value=Xn(e),await Mc(e)}async function un(){var e;Sa.value=!0,dt.value="";try{const t=await Sd();Ee.value=t;const n=Lc(t.items??[]),s=Yn.value,a=n.find(o=>Xn(o)===s)??n[0]??((e=t.items)==null?void 0:e[0])??null;Yn.value=a?Xn(a):null,await Mc(a)}catch(t){dt.value=t instanceof Error?t.message:"거버넌스 상태를 불러오지 못했습니다"}finally{Sa.value=!1}}xp(un);async function xr(){const e=Ln.value.trim();if(e){Pn.value=!0;try{const t=await ku(e);Ln.value="",E(t!=null&&t.id?`토론을 시작했습니다: ${t.id}`:"토론을 시작했습니다","success"),await un()}catch(t){const n=t instanceof Error?t.message:"토론 시작에 실패했습니다";dt.value=n,E(n,"error")}finally{Pn.value=!1}}}async function Sr(e){var o,l;const t=zo(),n=(o=t==null?void 0:t.guardrail_state)==null?void 0:o.pending_confirm,s=n==null?void 0:n.confirm_token;if(!s)return;const a=((l=n==null?void 0:n.actor)==null?void 0:l.trim())||u$();Wt.value=!0;try{await Fr(a,s,e),E(e==="confirm"?"액션을 승인했습니다":"액션을 거부했습니다","success"),await un()}catch(c){const p=c instanceof Error?c.message:"대기 중인 액션 처리에 실패했습니다";dt.value=p,E(p,"error")}finally{Wt.value=!1}}function f$(){var n,s,a,o,l,c;const e=(n=Ee.value)==null?void 0:n.summary,t=(s=Ee.value)==null?void 0:s.judge;return i`
    <div class="board-summary-strip">
      <div class="board-summary-item">
      ...
      <div class="governance-toolbar">
        ...
        <div class="governance-filter-row">
          ${[["open","열림"],["needs_quorum","정족수 부족"],["ready","준비됨"],["needs_approval","승인 필요"],["judge_offline","판정기 오프라인"]].map(([e,t])=>i`
            <button
              class="control-btn ${Ki.value===e?"is-active":"ghost"}"
              onClick=${async()=>{Ki.value=e,await un()}}
            >
              ${t}
            </button>
          `)}
  ...
  `}function $$(){var t;const e=Lc(((t=Ee.value)==null?void 0:t.items)??[]);return i`
  ...
  `}function h$({argument:e}){return i`
  ...
  `}function b$(){const e=zo(),t=Ca.value,n=Aa.value;return i`
    <${I}
      title=${e?`${e.kind==="debate"?"토론":"합의"} 상세`:"의사결정 상세"}
      class="section"
      semanticId="governance.detail"
    >
      ${Bi.value?i`<div class="loading-indicator">거버넌스 상세 불러오는 중...</div>`:e?e.kind==="debate"&&t?i`
                ...
                <div class="governance-ledger">
                  ${t.arguments.length===0?i`<div class="empty-state">기록된 토론이 아직 없습니다.</div>`:t.arguments.map(s=>i`<${h$} key=${s.index} argument=${s} />`)}
                </div>
              `:e.kind==="consensus"&&n?i`
                  ...
                  <div class="governance-ledger">
                    ${n.votes.length===0?i`<div class="empty-state">기록된 표결이 아직 없습니다.</div>`:n.votes.map(s=>i`<${y$} key=${s.agent+s.timestamp} vote=${s} />`)}
                  </div>
  ...
  `}function k$(){var c,p,m;const e=zo(),t=Ca.value,n=Aa.value,s=(t==null?void 0:t.context)??(n==null?void 0:n.context)??(e==null?void 0:e.context),a=(t==null?void 0:t.judgment)??(n==null?void 0:n.judgment),o=e==null?void 0:e.guardrail_state,l=(c=Ee.value)==null?void 0:c.judge;return i`
  ...
  `}const Ot=f(""),ti=f("ability_check"),ni=f("10"),si=f("12"),ks=f(""),xs=f("idle"),Xe=f(""),Ss=f("keeper-late"),ai=f("player"),ii=f(""),xe=f("idle"),oi=f(null),Cs=f(""),ri=f(""),li=f("player"),ci=f(""),di=f(""),ui=f(""),Mn=f("20"),pi=f("20"),mi=f(""),As=f("idle"),Ui=f(null),jc=f("overview"),vi=f("all"),_i=f("all"),fi=f("all"),S$=12e4,Fa=f(null),Ar=f(Date.now());function C$(e,t){const n=t>0?e/t*100:0;return n>50?"hp-high":n>25?"hp-mid":"hp-low"}function A$(e,t){return t>0?Math.round(e/t*100):0}const I$={pragmatic:"리스크보다 확실한 이득을 우선합니다.",frugal:"자원 소모를 줄이고 효율을 챙깁니다.",impatient:"짧은 템포로 즉시 압박을 선호합니다.",stubborn:"한 번 정한 전술을 끝까지 밀어붙입니다.",protective:"아군 피해를 줄이는 선택을 우선합니다.","honor-bound":"약속과 규율을 지키는 행동에 보너스가 납니다.",intense:"집중 화력을 짧게 폭발시킵니다.",empathetic:"아군/약자 보호 쪽 선택 확률이 높아집니다.",fatalistic:"위험을 감수하는 고배수 선택을 탑니다.",suspicious:"함정/매복 경계 행동을 우선합니다.",precise:"단일 목표를 정확히 노리는 경향입니다.",vengeful:"직전 위협 대상에게 강하게 반응합니다.",aggressive:"공격적인 전진 행동을 우선합니다.",opportunistic:"빈틈이 열리면 즉시 추격합니다."},T$={supply_scan:"전장/자원 상태를 스캔해 약한 지점을 찾습니다.",ration_shift:"소모를 줄이고 지속 전투 능력을 확보합니다.",logistics_patch:"무너진 운영 라인을 빠르게 복구합니다.",frontline_shield:"전열에서 아군 피해를 흡수합니다.",oath_intercept:"핵심 타깃을 가로막아 위협을 차단합니다.",morale_anchor:"아군 안정도를 높여 붕괴를 막습니다.",omen_trace:"다음 위험 신호를 먼저 감지합니다.",arc_flash:"짧은 순간 광역 압박을 넣습니다.",ward_bloom:"방어 장막을 펼쳐 생존률을 올립니다.",mark_prey:"우선 제거 대상을 지정합니다.",silent_route:"은밀한 진입 경로를 확보합니다.",finisher_strike:"약화된 적을 마무리하는 일격입니다.",shadow_claw:"근접 급습으로 출혈 피해를 노립니다.",lunge:"짧은 돌진으로 전열을 흔듭니다."};function Is(e){const t=e.trim();return t?t.split(/[_-]+/g).filter(n=>n.length>0).map(n=>n[0]?`${n[0].toUpperCase()}${n.slice(1)}`:n).join(" "):e}function z$(e){const t=e.trim().toLowerCase();return I$[t]??"행동 선택 가중치에 영향을 주는 성향입니다."}function R$(e){const t=e.trim().toLowerCase();return T$[t]??"상황에 따라 선택되는 전술 액션입니다."}function $e(e,t,n=""){const s=e[t];return typeof s=="string"?s:n}function Le(e,t,n=0){const s=e[t];return typeof s=="number"&&Number.isFinite(s)?s:n}function Qn(e,t,n=!1){const s=e[t];return typeof s=="boolean"?s:n}const P$=new Set(["str","dex","con","int","wis","cha"]);function L$(e){const t=e.trim();if(!t)return{};let n;try{n=JSON.parse(t)}catch(a){throw new Error(`능력치 JSON 파싱 실패: ${a instanceof Error?a.message:"invalid json"}`)}if(!v(n))throw new Error('능력치 JSON은 object여야 합니다. 예: {"luck":7}');const s={};return Object.entries(n).forEach(([a,o])=>{const l=a.trim();if(l){if(typeof o=="number"&&Number.isFinite(o)){s[l]=Math.max(0,Math.trunc(o));return}if(typeof o=="string"){const c=Number.parseFloat(o.trim());if(Number.isFinite(c)){s[l]=Math.max(0,Math.trunc(c));return}}throw new Error(`능력치 '${l}' 값은 숫자여야 합니다.`)}}),s}function M$(e){const t=Number.parseInt(e.trim(),10);if(!Number.isFinite(t))return;const n=Math.max(1,t),s=Number.parseInt(Mn.value.trim(),10);Number.isFinite(s)&&s>n&&(Mn.value=String(n))}function Hi(e){const n=(e.actor_name??e.actor??e.actor_id??"system").trim();return n===""?"system":n}function j$(e){var n;return(((n=e.timestamp)==null?void 0:n.trim())??"")||"-"}function E$(e){jc.value=e}function Ec(e){const t=Fa.value;return t==null||t<=e}function N$(e){const t=Fa.value;return t==null||t<=e?0:Math.max(0,Math.ceil((t-e)/1e3))}function Ia(){Fa.value=null}function Nc(e){return typeof window>"u"||typeof window.confirm!="function"?!0:window.confirm(e)}function w$(e,t){Nc(["관전 모드 잠금을 해제하시겠습니까?",`ROOM: ${e||"-"}`,`PHASE: ${t||"-"}`,"해제 시간: 120초 (시간 경과 또는 위험 액션 실행 후 자동 재잠금)"].join(`
`))&&(Fa.value=Date.now()+S$,E("조작 잠금이 120초 동안 해제되었습니다.","warning"))}function Fs(e){return Ec(e)?(E("관전 모드 잠금 상태입니다. 먼저 잠금을 해제하세요.","warning"),!1):!0}function Wi(e,t,n){return Nc([`[위험 액션 확인] ${e}`,`ROOM: ${t||"-"}`,`PHASE: ${n||"-"}`,"이 액션은 즉시 실행되며 되돌리기 어렵습니다.","계속 진행하시겠습니까?"].join(`
`))}function D$({hp:e,max:t}){const n=A$(e,t),s=C$(e,t);return i`
    <div class="trpg-hp-bar">
      <div class="hp-fill ${s}" style="width:${n}%" />
    </div>
  `}function O$({stats:e}){const t=[{label:"STR",value:e.strength},{label:"DEX",value:e.dexterity},{label:"CON",value:e.constitution},{label:"INT",value:e.intelligence},{label:"WIS",value:e.wisdom},{label:"CHA",value:e.charisma}];return i`
    <div class="trpg-actor-stats">
      ${t.map(n=>i`<span>${n.label} ${n.value}</span>`)}
    </div>
  `}function q$({keeper:e,role:t}){if(!e)return null;const n=t==="dm"?"dm":"player";return i`
    <span class="trpg-keeper-chip">
      <span class="trpg-keeper-tag ${n}">${n}</span>
      ${e}
    </span>
  `}function wc({actor:e}){var p,m,u,_;const t=(p=e.archetype)==null?void 0:p.trim(),n=(m=e.persona)==null?void 0:m.trim(),s=(u=e.portrait)==null?void 0:u.trim(),a=(_=e.background)==null?void 0:_.trim(),o=e.traits??[],l=e.skills??[],c=Object.entries(e.stats_raw??{}).filter(([g,h])=>Number.isFinite(h)).filter(([g])=>!P$.has(g.toLowerCase()));return i`
    <div class="trpg-actor">
      ...
      ${e.stats?i`
          <div style="margin-top:4px;">
            ...
            <${D$} hp=${e.stats.hp} max=${e.stats.max_hp} />
            <${O$} stats=${e.stats} />
          </div>
        `:null}
            ...
            <div class="trpg-annot-list">
              ${o.map(g=>i`
                <span class="trpg-annot-chip trait">
                  ...
                  <span class="trpg-annot-desc">${z$(g)}</span>
                </span>
              `)}
            </div>
          </div>
  ...
  `}function F$({mapStr:e}){return i`<pre class="trpg-map">${e}</pre>`}function Dc({events:e,emptyLabel:t="아직 이벤트가 없습니다."}){return e.length===0?i`<div class="empty-state" style="font-size:13px">${t}</div>`:i`
    <div class="trpg-story" role="list" aria-label="TRPG story events">
      ${e.map((n,s)=>{var a;return i`
        <div key=${s} class="trpg-event ${n.type??""}" role="listitem">
          <div class="trpg-event-meta-row">
            <span class="trpg-event-meta">${j$(n)}</span>
  ...
  `}function U$({state:e,nowMs:t}){var m;const n=Ue.value||((m=e.session)==null?void 0:m.room)||"",s=xs.value,a=e.party??[];if(!a.find(u=>u.id===Ot.value)&&a.length>0){const u=a[0];u&&(Ot.value=u.id)}const l=async()=>{var _,g;if(!n){E("Room ID가 비어 있습니다.","error");return}if(!Fs(t))return;const u=((_=e.current_round)==null?void 0:_.phase)??((g=e.session)==null?void 0:g.status)??"unknown";if(Wi("라운드 실행",n,u)){xs.value="running";try{const h=await uu(n);Ui.value=h,xs.value="ok";const b=v(h.summary)?h.summary:null,$=b?Qn(b,"advanced",!1):!1,S=b?$e(b,"progress_reason",""):"";E($?"라운드가 정상 진행되었습니다.":`라운드가 정체되었습니다${S?`: ${S}`:""}`,$?"success":"warning"),st()}catch(h){Ui.value=null,xs.value="error";const b=h instanceof Error?h.message:"라운드 실행에 실패했습니다.";E(b,"error")}finally{Ia()}}},c=async()=>{var _,g;if(!n||!Fs(t))return;const u=((_=e.current_round)==null?void 0:_.phase)??((g=e.session)==null?void 0:g.status)??"unknown";if(Wi("턴 강제 진행",n,u))try{await vu(n),E("턴을 다음 단계로 이동했습니다.","success"),st()}catch{E("턴 이동에 실패했습니다.","error")}finally{Ia()}},p=async()=>{if(!n||!Fs(t))return;const u=Ot.value.trim();if(!u){E("먼저 Actor를 선택하세요.","warning");return}const _=Number.parseInt(ni.value,10),g=Number.parseInt(si.value,10);if(Number.isNaN(_)||Number.isNaN(g)){E("stat/dc는 숫자여야 합니다.","warning");return}const h=Number.parseInt(ks.value,10),b=ks.value.trim()===""||Number.isNaN(h)?void 0:h;try{await mu({roomId:n,actorId:u,action:ti.value.trim()||"ability_check",statValue:_,dc:g,rawD20:b}),E("주사위 판정을 기록했습니다.","success"),st()}catch{E("주사위 판정 기록에 실패했습니다.","error")}};return i`
  ...
  `}function H$({state:e}){var a;const t=Ue.value||((a=e.session)==null?void 0:a.room)||"",n=As.value,s=async()=>{if(!t){E("Room ID가 비어 있습니다.","warning");return}const o=Cs.value.trim(),l=ri.value.trim();if(!l&&!o){E("이름 또는 Actor ID를 입력하세요.","warning");return}const c=Number.parseInt(Mn.value.trim(),10),p=Number.parseInt(pi.value.trim(),10),m=Number.isFinite(p)?Math.max(1,p):20,u=Number.isFinite(c)?Math.max(0,Math.min(m,c)):m;let _={};try{_=L$(mi.value)}catch(g){E(g instanceof Error?g.message:"능력치 JSON 오류","error");return}As.value="spawning";try{const g=typeof crypto<"u"&&typeof crypto.randomUUID=="function"?`trpg_spawn_${crypto.randomUUID()}`:`trpg_spawn_${Date.now().toString(36)}_${Math.random().toString(36).slice(2,10)}`,h=await _u(t,{actor_id:o||void 0,name:l||void 0,role:li.value,idempotencyKey:g,portrait:di.value.trim()||void 0,background:ui.value.trim()||void 0,hp:u,max_hp:m,alive:u>0,stats:Object.keys(_).length>0?_:void 0}),b=typeof h.actor_id=="string"?h.actor_id.trim():"";if(!b)throw new Error("생성 응답에 actor_id가 없습니다.");const $=ci.value.trim();$&&await fu(t,b,$),Ot.value=b,Xe.value=b,o||(Cs.value=""),As.value="ok",E(`Actor 생성 완료: ${b}`,"success"),await st()}catch(g){As.value="error",E(g instanceof Error?g.message:"Actor 생성에 실패했습니다.","error")}};return i`
    <div class="trpg-control-box">
      <div class="trpg-control-grid">
        <div class="trpg-control-field">
          <label>Name</label>
        ...
        <div class="trpg-control-grid">
          ...
          <div class="trpg-control-field">
            ...
            <input
              ...
              min="1"
              value=${pi.value}
              onInput=${o=>{const l=o.target.value;pi.value=l,M$(l)}}
              placeholder="20"
            />
          </div>
  ...
  `}function W$({state:e,nowMs:t}){var g;const n=Ue.value||((g=e.session)==null?void 0:g.room)||"",s=e.join_gate,a=oi.value,o=v(a)?a:null,l=(e.party??[]).filter(h=>h.role!=="dm"),c=Xe.value.trim(),p=l.some(h=>h.id===c),m=p?c:c?"__manual__":"",u=async()=>{const h=Xe.value.trim(),b=Ss.value.trim();if(!n||!h){E("Room/Actor가 필요합니다.","warning");return}xe.value="checking";try{const $=await gu(n,h,b||void 0);oi.value=$,xe.value="ok",E("참가 가능 여부를 갱신했습니다.","success")}catch($){xe.value="error";const S=$ instanceof Error?$.message:"참가 가능 여부 확인에 실패했습니다.";E(S,"error")}},_=async()=>{var C,x;const h=Xe.value.trim(),b=Ss.value.trim(),$=ii.value.trim();if(!n||!h||!b){E("Room/Actor/Keeper가 필요합니다.","warning");return}if(!Fs(t))return;const S=((C=e.current_round)==null?void 0:C.phase)??((x=e.session)==null?void 0:x.status)??"unknown";if(Wi("Mid-Join 승인 요청",n,S)){xe.value="requesting";try{const L=await $u({room_id:n,actor_id:h,keeper_name:b,role:ai.value,...$?{name:$}:{}});oi.value=L;const T=v(L)?Qn(L,"granted",!1):!1,R=v(L)?$e(L,"reason_code",""):"";T?E("Mid-Join이 승인되었습니다.","success"):E(`Mid-Join이 거절되었습니다${R?`: ${R}`:""}`,"warning"),xe.value=T?"ok":"error",st()}catch(L){xe.value="error";const T=L instanceof Error?L.message:"Mid-Join 요청에 실패했습니다.";E(T,"error")}finally{Ia()}}};return i`
    <div class="trpg-control-box">
  ...
  `}function G$({state:e,nowMs:t}){var l,c,p;const n=Ue.value||((l=e.session)==null?void 0:l.room)||"",s=((c=e.current_round)==null?void 0:c.phase)??((p=e.session)==null?void 0:p.status)??"unknown",a=Ec(t),o=N$(t);return i`
    <${I} title="조작 안전 잠금" style="margin-bottom:16px;" semanticId="lab.trpg">
      <div class="trpg-control-lock ${a?"locked":"unlocked"}">
        ...
        <div style="display:flex; gap:8px; margin-top:10px; flex-wrap:wrap;">
          ${a?i`<button class="trpg-run-btn recommend" onClick=${()=>w$(n,s)}>잠금 해제 (120초)</button>`:i`<button class="trpg-run-btn secondary" onClick=${()=>{Ia(),E("조작 잠금으로 전환했습니다.","success")}}>즉시 다시 잠금</button>`}
        </div>
      </div>
    <//>
  `}function J$({active:e}){return i`
  ...
  `}function V$({state:e}){const t=e.party??[],n=e.story_log??[];return i`
  ...
  `}function Y$({state:e}){const t=e.story_log??[];return i`
    <div class="trpg-layout">
      <div>
  ...
  `}function X$({state:e,nowMs:t}){const n=e.party??[];return i`
    <div>
      <${G$} state=${e} nowMs=${t} />
      <div class="trpg-layout">
        <div>
  ...
  `}function Q$(){var c,p,m,u,_;const e=il.value,t=Ti.value;if(ne(()=>{if(typeof window>"u"||typeof window.setInterval!="function")return;const g=window.setInterval(()=>{Ar.value=Date.now()},1e3);return()=>{window.clearInterval(g)}},[]),t&&!e)return i`<div class="loading-indicator">Loading TRPG state...</div>`;if(!e)return i`
      <div class="section">
        <h2>TRPG</h2>
    ...
    <div>
      ...
      ${o==="overview"?i`<${V$} state=${e} />`:o==="timeline"?i`<${Y$} state=${e} />`:i`<${X$} state=${e} nowMs=${l} />`}
    </div>
  `}const Bc=f(null),Gi=f(null),Ks=f(!1);async function Z$(){if(!Ks.value){Ks.value=!0,Gi.value=null;try{Bc.value=await Pd()}catch(e){Gi.value=e instanceof Error?e.message:String(e)}finally{Ks.value=!1}}}function eh(e){switch(e){case"essential":return"badge-essential";case"standard":return"badge-standard";default:return"badge-full"}}function th({items:e,maxCount:t}){return e.length===0?i`<p class="muted">No tool calls recorded yet.</p>`:i`
  ...
  `}function sh(){const e=Bc.value,t=Ks.value,n=Gi.value;return i`
  ...
  `}const Ta=f(new Set(["broadcast","tasks","keepers","system"]));function ih(e){const t=new Set(Ta.value);t.has(e)?t.delete(e):t.add(e),Ta.value=t}const Ro=f(null);function Uc(e){Ro.value=e}function oh(e){return e.kind==="board"?"broadcast":e.kind==="tasks"?"tasks":e.kind==="keepers"?"keepers":"system"}const rh=Ie(()=>{const e=Ta.value;return Us.value.filter(t=>e.has(oh(t)))}),lh=12e4,ch=Ie(()=>{const e=cl.value,t=Date.now();return Ge.value.map(n=>{const s=n.name.trim().toLowerCase(),a=e.get(s)??null;let o="idle";if(n.status==="active"||n.status==="busy"){const l=a==null?void 0:a.lastActivityAt;l?o=t-new Date(l).getTime()>lh?"stale":"working":o="working"}else(n.status==="offline"||n.status==="inactive")&&(o="stale");return{name:n.name,emoji:n.emoji??"",koreanName:n.koreanName??null,state:o,currentTask:n.current_task,motion:a}})}),dh=Ie(()=>{const e=cl.value;return Ge.value.filter(t=>t.status==="active"||t.status==="busy"||t.status==="listening"||t.status==="idle").map(t=>{const n=t.name.trim().toLowerCase(),s=e.get(n),a=(s==null?void 0:s.activeAssignedCount)??0;let o="calm";return a>=3?o="hot":a>=1&&(o="normal"),{name:t.name,emoji:t.emoji??"",koreanName:t.koreanName??null,currentTask:t.current_task,lastActivityAt:(s==null?void 0:s.lastActivityAt)??null,lastActivityText:(s==null?void 0:s.lastActivityText)??null,assignedCount:a,pressure:o}}).sort((t,n)=>{const s={hot:0,normal:1,calm:2};return s[t.pressure]-s[n.pressure]})});function Ir(e){return e.kind==="board"?"live-event-broadcast":e.kind==="tasks"?"live-event-task":e.kind==="keepers"?"live-event-keeper":"live-event-system"}function uh(e){const t=e.eventType;return t==="broadcast"?"broadcast":t==="agent_joined"?"joined":t==="agent_left"?"left":t==="task_update"?"task":t==="board_post"?"post":t==="board_comment"?"comment":t==="keeper_heartbeat"?"heartbeat":t==="keeper_handoff"?"handoff":t==="keeper_compaction"?"compact":t==="keeper_guardrail"?"guardrail":e.kind==="board"?"board":e.kind==="tasks"?"task":e.kind==="keepers"?"keeper":"system"}function ph(e){switch(e){case"working":return"pulse-working";case"stale":return"pulse-stale";default:return"pulse-idle"}}function mh(){const e=ch.value,t=Ro.value;return e.length===0?i`
  ...
  `}const vh=[{kind:"broadcast",label:"Broadcast",cssClass:"live-event-broadcast"},{kind:"tasks",label:"Task",cssClass:"live-event-task"},{kind:"keepers",label:"Keeper",cssClass:"live-event-keeper"},{kind:"system",label:"System",cssClass:"live-event-system"}];function _h(){const e=Ta.value;return i`
  ...
  `}function fh(){const e=rh.value;return i`
        ...
        ${e.length===0?i`<div class="activity-empty">No events matching filters</div>`:e.map((t,n)=>i`
            ...
            >
              <div class="activity-item-head">
                <span class="activity-kind-chip ${Ir(t)}">${uh(t)}</span>
                <span class="activity-agent">${t.agent}</span>
                <span class="activity-time">${sc(t.timestamp)}</span>
              </div>
  ...
  `}function gh(e){switch(e){case"hot":return"focus-pressure-hot";case"normal":return"focus-pressure-normal";default:return"focus-pressure-calm"}}function $h(e){switch(e){case"hot":return"High";case"normal":return"Active";default:return"Calm"}}function hh(){const e=dh.value,t=Ro.value;return i`
        ...
        ${e.length===0?i`<div class="focus-empty">No active agents</div>`:e.map(n=>i`
            ...
            >
              <div class="focus-agent-header">
                ...
                <span class="focus-pressure-badge ${gh(n.pressure)}">
                  ${$h(n.pressure)}
  ...
  `}function yh(){const e=rt.value;return i`
  ...
  `}function kh({currentTab:e}){var p,m,u,_,g,h,b,$,S,C;const t=rt.value,n=(p=te.value)==null?void 0:p.build,s=(m=te.value)==null?void 0:m.lodge,a=(u=te.value)==null?void 0:u.gardener,o=(_=te.value)==null?void 0:_.guardian,l=(g=te.value)==null?void 0:g.sentinel,c=[];if(s&&c.push(Ts("Lodge",s.enabled?Ae("lodge",s.quiet_active?"quiet":"live"):Ae("lodge","disabled"),s.enabled?s.quiet_active?"warn":"ok":"bad",[Se("틱",s.total_ticks??0),Se("체크인",s.total_checkins??0),Se("최근 결과",((h=s.last_tick_result)==null?void 0:h.activity_report)??s.last_skip_reason??"없음")])),a&&c.push(Ts("Gardener",a.alive?Ae("gardener","live"):a.enabled?Ae("gardener","starting"):Ae("gardener","disabled"),a.alive?"ok":a.enabled?"warn":"bad",[Se("최근 tick",a.last_tick_completed_at?i`<${J} timestamp=${a.last_tick_completed_at} />`:"기록 없음"),Se("판단",`${a.last_intervention??"없음"} · ${a.last_decision_source??"없음"}`),Se("백로그",`미할당 ${((b=a.health_summary)==null?void 0:b.todo_count)??0} · P1/2 ${(($=a.health_summary)==null?void 0:$.high_priority_todo)??0}`)],a.last_reason??a.last_error??void 0)),o){const x=o.masc_loops_running||o.lodge_loop_started||o.lodge_running;c.push(Ts("Guardian",x?Ae("guardian","live"):o.enabled?Ae("guardian","idle"):Ae("guardian","disabled"),x?"ok":o.enabled?"warn":"bad",[Se("모드",o.mode??"알 수 없음"),Se("루프",`zombie ${o.zombie_loop_running?"on":"off"} · gc ${o.gc_loop_running?"on":"off"}`),Se("소유자",o.runtime_owner??"없음")],((S=o.last_lodge_result)==null?void 0:S.message)??o.last_gc_result??o.last_zombie_result??void 0))}return l&&c.push(Ts("Sentinel",l.started?Ae("sentinel","live"):l.enabled?Ae("sentinel","starting"):Ae("sentinel","disabled"),l.started?"ok":l.enabled?"warn":"bad",[Se("에이전트",l.agent_name??"sentinel"),Se("소비자",((C=l.consumers)==null?void 0:C.length)??0),Se("가디언 소유자",l.guardian_runtime_owner??"없음")],l.llm_enabled===!0?"LLM 기반 housekeeping resident":void 0)),i`
    <section class="rail-card">
      ...
      ${n?i`<div class="rail-build-hint">서버 빌드 · v${n.release_version} · ${bh(n.commit)}</div>`:null}
      ${c.length>0?i`
  ...
  `}function xh(){const e=_e.value,t=(e==null?void 0:e.pending_confirms.length)??0,n=(e==null?void 0:e.sessions.length)??0,s=(e==null?void 0:e.keepers.length)??0;return i`
    <section class="rail-card">
      <div class="rail-card-head">
        <h3>개입 바로가기</h3>
  ...
  `}const zs=f(!1);function Sh(){const e=rt.value;return i`
  ...
  `}function Ch(e){const t=e==null?void 0:e.trim();return t?t.length>10?t.slice(0,10):t:"커밋 정보 없음"}function Ah(){const e=te.value,t=e==null?void 0:e.build,n=t?`v${t.release_version} · ${Ch(t.commit)}`:e!=null&&e.version?`v${e.version} · 커밋 정보 없음`:"버전 정보 없음";return i`
  ...
  `}function Ih(){const e=F.value.tab,t=Ji.find(s=>s.id===e),n=Tr.find(s=>s.id===(t==null?void 0:t.group));return i`
        ...
        ${Tr.map(s=>i`
          <div class="rail-nav-group" key=${s.id}>
            ...
            <div class="rail-tab-list">
              ${Ji.filter(a=>a.group===s.id).map(a=>i`
                  <button
  ...
  `}function Th(){switch(F.value.tab){case"mission":return i`<${er} />`;case"proof":return i`<${nf} />`;case"execution":return i`<${Vg} />`;case"live":return i`<${yh} />`;case"memory":return i`<${Dg} />`;case"governance":return i`<${x$} />`;case"planning":return i`<${d$} />`;case"intervene":return i`<${Cg} />`;case"command":return i`<${bg} />`;case"lab":return i`<${ah} />`;default:return i`<${er} />`}}function zh(){return Ii.value&&!rt.value?i`<div class="loading-indicator">대시보드 불러오는 중...</div>`:i`<${Th} />`}function Rh(){ne(()=>{td(),Nr(),vl(),Ct(),ml(),zl();const n=Ap();return Ip(),()=>{cd(),n(),Tp()}},[]),ne(()=>{const n=setInterval(()=>{wi(F.value.tab)},15e3);return()=>{clearInterval(n)}},[]),ne(()=>{wi(F.value.tab)},[F.value.tab]);const e=F.value.tab,t=Ji.find(n=>n.id===e);return i`
    <div class="app-shell">
  ...
  `}const zr=document.getElementById("app");zr&&Yc(i`<${Rh} />`,zr);export{b_ as _};
