var Oc=Object.defineProperty;var qc=(e,t,n)=>t in e?Oc(e,t,{enumerable:!0,configurable:!0,writable:!0,value:n}):e[t]=n;var Lt=(e,t,n)=>qc(e,typeof t!="symbol"?t+"":t,n);import{e as Fc,_ as Kc,c as g,b as Ce,y as ne,d as xr,A as Bc,G as Uc}from"./vendor-kuFK4-oj.js";(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const a of document.querySelectorAll('link[rel="modulepreload"]'))s(a);new MutationObserver(a=>{for(const i of a)if(i.type==="childList")for(const l of i.addedNodes)l.tagName==="LINK"&&l.rel==="modulepreload"&&s(l)}).observe(document,{childList:!0,subtree:!0});function n(a){const i={};return a.integrity&&(i.integrity=a.integrity),a.referrerPolicy&&(i.referrerPolicy=a.referrerPolicy),a.crossOrigin==="use-credentials"?i.credentials="include":a.crossOrigin==="anonymous"?i.credentials="omit":i.credentials="same-origin",i}function s(a){if(a.ep)return;a.ep=!0;const i=n(a);fetch(a.href,i)}})();var o=Fc.bind(Kc);const Hc=["mission","proof","execution","live","memory","governance","planning","intervene","command","lab"],Sr={tab:"mission",params:{},postId:null};function Pi(e){return!!e&&Hc.includes(e)}function vo(e){try{return decodeURIComponent(e)}catch{return e}}function _o(e){const t={};return e&&new URLSearchParams(e).forEach((s,a)=>{t[a]=s}),t}function Wc(e){const n=e.replace(/^\/+/,"").split("/").filter(Boolean);return n[0]==="dashboard"?n.slice(1):n}function Ar(e,t){if(e[0]==="chains"){const i={...t,surface:"chains"};return e[1]==="operation"&&e[2]&&(i.operation=vo(e[2])),{tab:"command",params:i,postId:null}}if(e[0]==="lab"){const i={...t};return e[1]&&(i.surface=vo(e[1])),{tab:"lab",params:i,postId:null}}const n=e[0],s=t.tab;return{tab:Pi(n)?n:Pi(s)?s:"mission",params:t,postId:null}}function Fs(e){const t=(e||"").replace(/^#/,"").trim();if(!t)return Sr;const n=vo(t);let s=n,a;if(n.startsWith("?"))s="",a=n.slice(1);else{const c=n.indexOf("?");c>=0&&(s=n.slice(0,c),a=n.slice(c+1))}!a&&s.includes("=")&&!s.includes("/")&&(a=s,s="");const i=_o(a),l=Wc(s);return Ar(l,i)}function Gc(e,t){const n=e.replace(/^\/+/,"").split("/").filter(Boolean);if(n[0]!=="dashboard")return null;const s=n.slice(1);if(s.length===0)return{...Sr,params:_o(t.replace(/^\?/,""))};if(s[0]==="assets"||s[0]==="credits"||s[0]==="lodge")return null;const a=_o(t.replace(/^\?/,""));return Ar(s,a)}function Cr(e){const t=e.tab==="lab"&&e.params.surface?`lab/${encodeURIComponent(e.params.surface)}`:e.tab,n=Object.entries(e.params).filter(([a])=>!(a==="tab"||e.tab==="lab"&&a==="surface"));if(n.length===0)return`#${t}`;const s=new URLSearchParams(n);return`#${t}?${s.toString()}`}const F=g(Fs(window.location.hash));window.addEventListener("hashchange",()=>{F.value=Fs(window.location.hash)});function se(e,t){const n={tab:e,params:t??{}};window.location.hash=Cr(n)}function Jc(e){window.location.hash=`#memory?post=${encodeURIComponent(e)}`}function Vc(){if(window.location.hash&&window.location.hash!=="#"){F.value=Fs(window.location.hash);return}const e=Gc(window.location.pathname,window.location.search);if(e){F.value=e;const t=Cr(e);window.history.replaceState(null,"",`${window.location.pathname}${window.location.search}${t}`);return}window.location.hash="#mission",F.value=Fs(window.location.hash)}const Li="masc_dashboard_sse_session_id",Qc=1e3,Yc=15e3,ot=g(!1),Aa=g(0),Ir=g(null),Ks=g([]);function Xc(){let e=sessionStorage.getItem(Li);return e||(e=typeof crypto.randomUUID=="function"?`dash_${crypto.randomUUID()}`:`dash_${Date.now().toString(36)}_${Math.random().toString(36).slice(2,10)}`,sessionStorage.setItem(Li,e)),e}const Zc=200;function ed(e,t,n="system",s={}){const a={agent:e,text:t,timestamp:Date.now(),kind:n,...s};Ks.value=[a,...Ks.value].slice(0,Zc)}function go(e,t=88){const n=(e??"").replace(/\s+/g," ").trim();return n?n.length>t?`${n.slice(0,t-3)}...`:n:void 0}function zi(e,t){const n=go(t);return n?`${e}: ${n}`:`New ${e.toLowerCase()}`}function Ae(e,t,n,s,a={}){ed(e,t,n,{eventType:s,...a})}let ze=null,Ut=null,fo=0;function Tr(){Ut&&(clearTimeout(Ut),Ut=null)}function td(){if(Ut)return;fo++;const e=Math.min(fo,5),t=Math.min(Yc,Qc*Math.pow(2,e));Ut=setTimeout(()=>{Ut=null,Rr()},t)}function Rr(){Tr(),ze&&(ze.close(),ze=null);const e=new URLSearchParams(window.location.search),t=new URLSearchParams,n=e.get("agent")??e.get("agent_name"),s=e.get("token");n&&t.set("agent",n),s&&t.set("token",s),t.set("session_id",Xc());const a=t.toString()?`/sse?${t.toString()}`:"/sse",i=new EventSource(a);ze=i,i.onopen=()=>{ze===i&&(fo=0,ot.value=!0)},i.onerror=()=>{ze===i&&(ot.value=!1,i.close(),ze=null,td())},i.onmessage=l=>{try{const c=JSON.parse(l.data);Aa.value++,Ir.value=c,nd(c)}catch{}}}function nd(e){const t=e.type,n=e.agent??e.author??e.from??e.from_agent??"";switch(t){case"agent_joined":Ae(n,"Joined","system","agent_joined");break;case"agent_left":Ae(n,"Left","system","agent_left");break;case"broadcast":Ae(n,`${(e.message??e.content??"").slice(0,80)}`,"system","broadcast");break;case"task_update":Ae(n,`Task: ${e.task_id??""} -> ${e.status??""}`,"tasks","task_update");break;case"board_post":case"masc/board_post":Ae(n,zi("Post",e.content??e.message),"board","board_post",{author:e.author??n,preview:go(e.content??e.message),postId:e.post_id});break;case"board_comment":case"masc/board_comment":Ae(n,zi("Comment",e.content??e.message),"board","board_comment",{author:e.author??n,preview:go(e.content??e.message),postId:e.post_id});break;case"keeper_heartbeat":Ae(e.name??n,`Heartbeat gen=${e.generation??"?"} ctx=${e.context_ratio!=null?Math.round(e.context_ratio*100)+"%":"?"}`,"keepers","keeper_heartbeat");break;case"keeper_handoff":Ae(e.name??n,`Handoff gen ${e.from_generation??"?"} -> ${e.to_generation??"?"} (${e.to_model??"?"})`,"keepers","keeper_handoff");break;case"keeper_compaction":Ae(e.name??n,`Compaction saved ${e.saved_tokens??"?"} tokens (${e.trigger??"?"})`,"keepers","keeper_compaction");break;case"keeper_guardrail":Ae(e.name??n,`Guardrail: ${e.reason??"stopped"}`,"keepers","keeper_guardrail");break;default:Ae(n,t,"system","unknown")}}function sd(){Tr(),ze&&(ze.close(),ze=null),ot.value=!1}function v(e){return typeof e=="object"&&e!==null&&!Array.isArray(e)}function r(e){return typeof e=="string"&&e.trim()!==""?e.trim():void 0}function d(e){return typeof e=="number"&&Number.isFinite(e)?e:void 0}function j(e){return typeof e=="boolean"?e:void 0}function H(e){return Array.isArray(e)?e.map(t=>typeof t=="string"?t.trim():"").filter(Boolean):[]}function pe(e,t=[]){if(Array.isArray(e))return e;if(!v(e))return[];for(const n of t){const s=e[n];if(Array.isArray(s))return s}return[]}function ae(e){if(typeof e=="string"&&e.trim()!=="")return e;if(!(typeof e!="number"||!Number.isFinite(e)||e<=0))return new Date(e*1e3).toISOString()}function Pr(){return new URLSearchParams(window.location.search)}const ad="masc_dashboard_agent_name";function od(){var e;try{return((e=localStorage.getItem(ad))==null?void 0:e.trim())||null}catch{return null}}function Lr(){const e=Pr(),t={},n=e.get("token"),s=od(),a=e.get("agent")??e.get("agent_name")??s;return n&&(t.Authorization=`Bearer ${n}`),a&&(t["X-MASC-Agent"]=a),t}function zr(){return{...Lr(),"Content-Type":"application/json"}}const id=15e3,Wo=3e4,rd=6e4,Mi=new Set([408,425,429,500,502,503,504]);class Qn extends Error{constructor(n){const s=n.method.toUpperCase(),a=n.timeout===!0,i=a?`${s} ${n.path}: timeout after ${n.timeoutMs??0}ms`:`${s} ${n.path}: ${n.status??"unknown"} ${n.statusText??""}`.trim();super(i);Lt(this,"method");Lt(this,"path");Lt(this,"status");Lt(this,"statusText");Lt(this,"timeout");this.name="ApiRequestError",this.method=s,this.path=n.path,this.status=n.status,this.statusText=n.statusText,this.timeout=a}}async function Go(e,t,n){const s=new AbortController,a=setTimeout(()=>s.abort(),n);try{return await fetch(e,{...t,signal:s.signal})}catch(i){if(i instanceof Error&&i.name==="AbortError"){const l=typeof t.method=="string"?t.method.toUpperCase():"GET";throw new Qn({method:l,path:e,timeout:!0,timeoutMs:n})}throw i}finally{clearTimeout(a)}}function ld(){var t,n;const e=Pr();return((t=e.get("agent"))==null?void 0:t.trim())||((n=e.get("agent_name"))==null?void 0:n.trim())||"dashboard-user"}async function X(e){const t=await Go(e,{headers:Lr()},id);if(!t.ok)throw new Qn({method:"GET",path:e,status:t.status,statusText:t.statusText});return t.json()}function cd(e){return new Promise(t=>setTimeout(t,e))}function dd(e){const t=e.match(/\b(\d{3})\b/);if(!t)return null;const n=t[1];if(!n)return null;const s=Number.parseInt(n,10);return Number.isFinite(s)?s:null}function ud(e){if(e instanceof Qn)return e.timeout||typeof e.status=="number"&&Mi.has(e.status);if(!(e instanceof Error))return!1;if(/timeout after \d+ms/i.test(e.message))return!0;const t=dd(e.message);return t!==null&&Mi.has(t)}async function Ca(e,t,n=2){let s=0;for(;;)try{return await t()}catch(a){if(!ud(a)||s>=n)throw a;const i=250*(s+1);console.warn(`[dashboard/api] ${e} failed (attempt ${s+1}), retrying in ${i}ms`,a),await cd(i),s+=1}}async function we(e,t,n,s=Wo){const a=await Go(e,{method:"POST",headers:{...zr(),...n??{}},body:JSON.stringify(t)},s);if(!a.ok)throw new Qn({method:"POST",path:e,status:a.status,statusText:a.statusText});return a.json()}async function pd(e,t,n,s=Wo){const a=await Go(e,{method:"POST",headers:{...zr(),...n??{}},body:JSON.stringify(t)},s);if(!a.ok)throw new Qn({method:"POST",path:e,status:a.status,statusText:a.statusText});return a.text()}function md(e){const t=e.split(`
`).find(s=>s.startsWith("data: ")),n=t?t.slice(6).trim():e.trim();return JSON.parse(n)}function vd(e){var t,n,s,a,i,l,c;if((t=e.error)!=null&&t.message)throw new Error(e.error.message);if((n=e.result)!=null&&n.isError){const p=((a=(s=e.result.content)==null?void 0:s[0])==null?void 0:a.text)??"MCP tool call failed";throw new Error(p)}return((c=(l=(i=e.result)==null?void 0:i.content)==null?void 0:l[0])==null?void 0:c.text)??""}async function ct(e,t){const n=await pd("/mcp",{jsonrpc:"2.0",method:"tools/call",params:{name:e,arguments:t},id:Math.floor(Date.now()%1e6)},{Accept:"application/json, text/event-stream"},rd),s=md(n);return vd(s)}function _d(){return X("/api/v1/dashboard/shell")}function gd(){return X("/api/v1/dashboard/execution")}function fd(e,t){const n=new URLSearchParams;return n.set("sort_by",e),t!=null&&t.excludeSystem&&n.set("exclude_system","true"),X(`/api/v1/dashboard/memory${n.toString()?`?${n}`:""}`)}function $d(){return Ca("fetchDashboardGovernance",async()=>{const e=await X("/api/v1/dashboard/governance"),t=Array.isArray(e.items)?e.items.map(i=>jd(i)).filter(i=>i!==null):[],n=Array.isArray(e.pending_actions)?e.pending_actions.map(i=>Er(i)).filter(i=>i!==null):[],s=t.filter(i=>i.kind==="debate").map(i=>({id:i.id,topic:i.topic,status:i.status,argument_count:i.evidence_refs.length,created_at:i.last_activity_at??void 0})),a=t.filter(i=>i.kind==="consensus").map(i=>({id:i.id,topic:i.topic,initiator:i.related_agents[0]||"system",votes:i.votes??0,quorum:i.quorum??0,threshold:i.threshold,state:i.status,created_at:i.last_activity_at??void 0}));return{generated_at:le(e.generated_at)??void 0,summary:v(e.summary)?{debates:me(e.summary.debates)??void 0,voting_sessions:me(e.summary.voting_sessions)??void 0,debates_open:me(e.summary.debates_open)??void 0,sessions_active:me(e.summary.sessions_active)??void 0,sessions_without_quorum:me(e.summary.sessions_without_quorum)??void 0,ready_to_execute:me(e.summary.ready_to_execute)??void 0,oldest_open_debate_age_s:typeof e.summary.oldest_open_debate_age_s=="number"?e.summary.oldest_open_debate_age_s:null,last_activity_age_s:typeof e.summary.last_activity_age_s=="number"?e.summary.last_activity_age_s:null,judge_online:typeof e.summary.judge_online=="boolean"?e.summary.judge_online:void 0,judge_last_seen_at:le(e.summary.judge_last_seen_at)}:void 0,debates:s,sessions:a,items:t,activity:Array.isArray(e.activity)?e.activity.map(i=>wd(i)).filter(i=>i!==null):[],judge:Dd(e.judge),pending_actions:n}})}function hd(){return X("/api/v1/dashboard/semantics")}function yd(){return X("/api/v1/dashboard/mission")}function bd(e){const t=`?session_id=${encodeURIComponent(e)}`;return X(`/api/v1/dashboard/session${t}`)}function kd(e=!1){return X(`/api/v1/dashboard/mission/briefing${e?"?force=1":""}`)}function xd(e,t){const n=new URLSearchParams;e&&n.set("session_id",e),t&&n.set("operation_id",t);const s=n.toString();return X(`/api/v1/dashboard/proof${s?`?${s}`:""}`)}function Sd(){return X("/api/v1/dashboard/planning")}function Ad(){return X("/api/v1/tool-metrics")}function Cd(){return X("/api/v1/operator")}function Mr(e={}){const t=new URLSearchParams;e.targetType&&t.set("target_type",e.targetType),e.targetId&&t.set("target_id",e.targetId),e.includeWorkers!=null&&t.set("include_workers",e.includeWorkers?"true":"false");const n=t.toString();return X(`/api/v1/operator/digest${n?`?${n}`:""}`)}function Id(){return X("/api/v1/command-plane")}function Td(){return X("/api/v1/command-plane/summary")}function Rd(){return X("/api/v1/chains/summary")}function Pd(e){return X(`/api/v1/chains/runs/${encodeURIComponent(e)}`)}function Ld(){return X("/api/v1/command-plane/help")}function zd(e,t){const n=new URLSearchParams;e&&n.set("run_id",e),t&&n.set("operation_id",t);const s=n.toString();return X(`/api/v1/command-plane/swarm${s?`?${s}`:""}`)}function Md(e,t){const n=new URLSearchParams;e&&n.set("run_id",e),t&&n.set("operation_id",t);const s=n.toString();return X(`/api/v1/command-plane/orchestra${s?`?${s}`:""}`)}function Nd(e,t){return we(e,t)}function Ed(e){switch(e.action_type){case"keeper_message":case"keeper_recover":return 9e4;case"swarm_run_continue":return 6e4;case"swarm_run_rerun":return 12e4;case"swarm_run_abandon":return 3e4;case"lodge_tick":return 45e3;default:return Wo}}function Ia(e){return we("/api/v1/operator/action",e,void 0,Ed(e))}function Nr(e,t,n="confirm"){return we("/api/v1/operator/confirm",{actor:e,confirm_token:t,decision:n})}function Ts(e){if(typeof e=="string"&&e.trim())return e;if(typeof e!="number"||Number.isNaN(e))return new Date().toISOString();const t=e<1e12?e*1e3:e;return new Date(t).toISOString()}function le(e){if(typeof e=="string"){const t=e.trim();return t||null}if(typeof e=="number"&&Number.isFinite(e)){const t=e<1e12?e*1e3:e;return new Date(t).toISOString()}return null}function q(e){if(typeof e!="string")return null;const t=e.trim();return t||null}function Er(e){if(!v(e))return null;const t=k(e.confirm_token??e.token,"").trim();return t?{confirm_token:t,actor:q(e.actor)??void 0,action_type:q(e.action_type)??void 0,target_type:q(e.target_type)??void 0,target_id:q(e.target_id),delegated_tool:q(e.delegated_tool)??void 0,created_at:le(e.created_at)??void 0,preview:e.preview}:null}function Jo(e){return v(e)?{board_post_id:q(e.board_post_id),task_id:q(e.task_id),operation_id:q(e.operation_id),team_session_id:q(e.team_session_id)}:{}}function jr(e){if(!v(e))return null;const t=q(e.action_kind),n=q(e.resolved_tool),s=q(e.target_type),a=q(e.target_id),i=q(e.reason);return!t&&!n&&!s&&!i?null:{action_kind:t??void 0,resolved_tool:n,target_type:s,target_id:a,reason:i??void 0,payload_preview:e.payload_preview}}function wr(e){if(!v(e))return null;const t=q(e.action_type),n=q(e.delegated_tool),s=q(e.confirmation_state),a=le(e.created_at);return!t&&!n&&!s&&!a?null:{action_type:t??void 0,delegated_tool:n,confirmation_state:s??void 0,created_at:a}}function Dr(e){if(!v(e))return null;const t=Er(e.pending_confirm),n=q(e.pending_confirm_token)??(t==null?void 0:t.confirm_token)??null;return{requires_human_gate:typeof e.requires_human_gate=="boolean"?e.requires_human_gate:void 0,pending_confirm:t,pending_confirm_token:n,ready_to_execute:typeof e.ready_to_execute=="boolean"?e.ready_to_execute:void 0}}function Or(e){if(!v(e))return null;const t=q(e.summary),n=q(e.target_id);return!t&&!n?null:{judgment_id:q(e.judgment_id)??void 0,target_kind:q(e.target_kind)??void 0,target_id:n??void 0,status:q(e.status)??void 0,summary:t??void 0,confidence:typeof e.confidence=="number"?e.confidence:null,generated_at:le(e.generated_at),expires_at:le(e.expires_at),model_used:q(e.model_used),keeper_name:q(e.keeper_name),evidence_refs:Me(e.evidence_refs),recommended_action:jr(e.recommended_action),guardrail_state:Dr(e.guardrail_state),executed_route:wr(e.executed_route)}}function jd(e){if(!v(e))return null;const t=k(e.id,"").trim(),n=k(e.topic,"").trim();if(!t||!n)return null;const s=Jo(e.context);return{kind:k(e.kind,"debate"),id:t,topic:n,status:k(e.status??e.state,"open"),last_activity_at:le(e.last_activity_at),truth_summary:q(e.truth_summary)??void 0,judgment_summary:q(e.judgment_summary),confidence:typeof e.confidence=="number"?e.confidence:null,related_agents:Me(e.related_agents),context:s,linked_board_post_id:q(e.linked_board_post_id)??s.board_post_id??null,linked_task_id:q(e.linked_task_id)??s.task_id??null,linked_operation_id:q(e.linked_operation_id)??s.operation_id??null,linked_session_id:q(e.linked_session_id)??s.team_session_id??null,recommended_action:jr(e.recommended_action),executed_route:wr(e.executed_route),guardrail_state:Dr(e.guardrail_state),evidence_refs:Me(e.evidence_refs),approve_count:me(e.approve_count),reject_count:me(e.reject_count),abstain_count:me(e.abstain_count),votes:me(e.votes),quorum:me(e.quorum),threshold:typeof e.threshold=="number"?e.threshold:void 0}}function wd(e){if(!v(e))return null;const t=k(e.kind,"").trim();return t?{kind:t,item_kind:q(e.item_kind)??void 0,item_id:q(e.item_id)??void 0,topic:q(e.topic)??void 0,created_at:le(e.created_at),summary:q(e.summary)??void 0,actor:q(e.actor),index:me(e.index),decision:q(e.decision)}:null}function Dd(e){if(v(e))return{judge_online:typeof e.judge_online=="boolean"?e.judge_online:void 0,refreshing:typeof e.refreshing=="boolean"?e.refreshing:void 0,generated_at:le(e.generated_at),expires_at:le(e.expires_at),model_used:q(e.model_used),keeper_name:q(e.keeper_name),last_error:q(e.last_error)}}function Od(e){var a;const t=e.trim(),s=((a=(t.startsWith("[flair:")?t.replace(/^\[flair:[^\]]+\]\s*/i,""):t).split(`
`)[0])==null?void 0:a.trim())||"Untitled post";return s.length<=96?s:`${s.slice(0,93)}...`}function qd(e){if(!v(e))return null;const t=k(e.source,"").trim()||null,n=k(e.state_block,"").trim()||null;return!t&&!n?null:{source:t,state_block:n}}function Fd(e){if(!v(e))return null;const t=k(e.id,"").trim(),n=k(e.author,"").trim(),s=k(e.body,"").trim()||k(e.content,"").trim(),a=s;if(!t||!n)return null;const i=B(e.score,0),l=B(e.votes_up,0),c=B(e.votes_down,0),p=B(e.votes,i||l-c),m=B(e.comment_count,B(e.reply_count,0)),u=(()=>{const S=e.flair;if(typeof S=="string"&&S.trim())return S.trim();if(v(S)){const x=k(S.name,"").trim();if(x)return x}return k(e.flair_name,"").trim()||void 0})(),_=k(e.created_at_iso,"").trim()||Ts(e.created_at),f=k(e.updated_at_iso,"").trim()||(e.updated_at!==void 0?Ts(e.updated_at):_),b=k(e.title,"").trim()||Od(s),$=Array.isArray(e.tags)?e.tags.filter(S=>typeof S=="string"&&S.trim()!==""):[];return{id:t,author:n,post_kind:(()=>{const S=k(e.post_kind,"").trim().toLowerCase();return S==="automation"||S==="system"||S==="human"?S:void 0})(),title:b,body:s,content:a,meta:qd(e.meta),tags:$,votes:p,vote_balance:i,comment_count:m,created_at:_,updated_at:f,flair:u,hearth:k(e.hearth,"").trim()||null,visibility:k(e.visibility,"").trim()||void 0,expires_at:k(e.expires_at_iso,"").trim()||(e.expires_at!==void 0&&e.expires_at!==0?Ts(e.expires_at):"")||null,hearth_count:B(e.hearth_count,0)}}function Kd(e){if(!v(e))return null;const t=k(e.id,"").trim(),n=k(e.post_id,"").trim(),s=k(e.author,"").trim();return!t||!s?null:{id:t,post_id:n,author:s,content:k(e.content,""),created_at:Ts(e.created_at)}}async function Bd(e){return Ca("fetchBoardPost",async()=>{const t=await X(`/api/v1/board/${e}?format=flat`),n=v(t.post)?t.post:t,s=Fd(n)??{id:e,author:"unknown",post_kind:"human",title:"Post",body:"",content:"",meta:null,tags:[],votes:0,comment_count:0,created_at:new Date().toISOString(),updated_at:new Date().toISOString(),hearth:null,visibility:"internal",expires_at:null},i=(Array.isArray(t.comments)?t.comments:[]).map(Kd).filter(l=>l!==null);return{...s,comments:i}})}function qr(e,t){return we("/api/v1/tools/masc_board_vote",{post_id:e,direction:t,vote:t,voter:ld()})}function Ud(e,t,n){return we("/api/v1/tools/masc_board_comment",{post_id:e,author:t,content:n})}function Hd(e){const t=k(e,"").trim().toLowerCase();if(t==="win"||t==="won"||t==="victory")return"victory";if(t==="lose"||t==="lost"||t==="defeat")return"defeat";if(t==="draw"||t==="stalemate"||t==="tie")return"draw"}function ce(...e){for(const t of e){const n=k(t,"");if(n.trim())return n.trim()}return""}function Ni(e){const t=Hd(ce(e.outcome,e.result,e.result_code));if(!t)return;const n=ce(e.reason,e.reason_code,e.description,e.detail),s=ce(e.summary,e.summary_ko,e.summary_en,e.note),a=ce(e.details,e.details_text,e.text,e.note),i=ce(e.winner,e.winner_name,e.actor_winner,e.winner_actor),l=ce(e.winner_actor_id,e.winner_actor,e.actor_winner_id),c=ce(e.raw_reason,e.raw_reason_code,e.error_message),p=(()=>{const _=e.evidence??e.evidence_ids??e.supporting_events??e.event_ids??[];return typeof _=="string"?[_]:Array.isArray(_)?_.map(f=>{if(typeof f=="string")return f.trim();if(v(f)){const h=k(f.summary,"").trim();if(h)return h;const b=k(f.text,"").trim();if(b)return b;const $=k(f.type,"").trim();return $||k(f.event_id,"").trim()}return""}).filter(f=>f.length>0):[]})(),m=(()=>{const _=B(e.turn,Number.NaN);if(Number.isFinite(_))return _;const f=B(e.turn_number,Number.NaN);if(Number.isFinite(f))return f;const h=B(e.current_turn,Number.NaN);if(Number.isFinite(h))return h;const b=B(e.round,Number.NaN);return Number.isFinite(b)?b:void 0})(),u=ce(e.phase,e.phase_name,e.current_phase,e.phase_id);return{result:t,reason:n||void 0,summary:s||void 0,details:a||void 0,winner:i||void 0,winner_actor_id:l||void 0,evidence:p.length>0?p:void 0,raw_reason:c||void 0,turn:m,phase:u||void 0}}function Wd(e,t){const n=v(e.state)?e.state:{};if(k(n.status,"active").toLowerCase()!=="ended")return;const a=[...t].reverse().find(l=>v(l)?k(l.type,"")==="session.outcome":!1),i=v(n.session_outcome)?n.session_outcome:{};if(v(i)&&Object.keys(i).length>0){const l=Ni(i);if(l)return l}if(v(a))return Ni(v(a.payload)?a.payload:{})}function k(e,t=""){return typeof e=="string"?e:t}function B(e,t=0){return typeof e=="number"&&Number.isFinite(e)?e:t}function me(e){if(typeof e=="number"&&Number.isFinite(e))return Math.trunc(e);if(typeof e=="string"){const t=Number.parseInt(e.trim(),10);if(Number.isFinite(t))return t}}function Bs(e,t=!1){return typeof e=="boolean"?e:t}function Me(e){return Array.isArray(e)?e.map(t=>{if(typeof t=="string")return t.trim();if(v(t)){const n=k(t.name,"").trim(),s=k(t.id,"").trim(),a=k(t.skill,"").trim();return n||s||a}return""}).filter(t=>t.length>0):[]}function Gd(e){const t={};if(!v(e)&&!Array.isArray(e))return t;if(v(e))return Object.entries(e).forEach(([n,s])=>{const a=n.trim(),i=k(s,"").trim();!a||!i||(t[a]=i)}),t;for(const n of e){if(!v(n))continue;const s=ce(n.to,n.target,n.actor_id,n.name,n.id),a=ce(n.relationship,n.relation,n.type,n.kind);!s||!a||(t[s]=a)}return t}function Jd(e,t,n){if(e==="dm"||e==="player"||e==="npc")return e;const s=t.trim().toLowerCase();return s==="dm"||s.startsWith("dm-")?"dm":s.startsWith("npc-")||s.startsWith("enemy-")||s.startsWith("mob-")?"npc":/^p\d+$/i.test(s)||s.startsWith("player-")?"player":typeof n=="string"&&n.trim()!==""?n.trim().toLowerCase().includes("dm")?"dm":"player":"npc"}function ke(e,t,n,s=0){const a=e[t];if(typeof a=="number"&&Number.isFinite(a))return a;if(n){const i=e[n];if(typeof i=="number"&&Number.isFinite(i))return i}return s}const Vd=new Set(["str","dex","con","int","wis","cha","strength","dexterity","constitution","intelligence","wisdom","charisma","hp","max_hp","mp","max_mp","level","xp"]);function Qd(e){const t=v(e.stats)?e.stats:{},n={};return Object.entries(t).forEach(([s,a])=>{const i=s.trim();i&&(Vd.has(i.toLowerCase())||typeof a=="number"&&Number.isFinite(a)&&(n[i]=a))}),n}function Yd(e,t){if(e!=="dice.rolled")return;const n=B(t.raw_d20,0),s=B(t.total,0),a=B(t.bonus,0),i=k(t.action,"roll"),l=B(t.dc,0);return{notation:l>0?`${i} (DC ${l})`:i,rolls:n>0?[n]:[],total:s,modifier:a}}function Xd(e){const t=JSON.stringify(e);return t?t.length>160?`${t.slice(0,157)}...`:t:""}function Zd(e){const t=e.trim().toLowerCase();return t?t.startsWith("dice.")?"dice":t.startsWith("combat.")||t.includes(".attack")||t.includes(".damage")?"combat":t.includes("actor.")?"actor":t.includes("turn.")||t==="turn.started"||t==="phase.changed"?"turn":t.includes("join.")?"join":t.includes("memory")?"memory":t.includes("world.")?"world":t.includes("narration")?"story":"meta":"meta"}function eu(e,t,n,s){const a=n||t||k(s.actor_id,"")||k(s.actor_name,"");switch(e){case"turn.action.proposed":{const i=k(s.proposed_action,k(s.reply,""));return i?`${a||"actor"}: ${i}`:"Action proposed"}case"turn.action.resolved":{const i=k(s.reply,k(s.result,""));return i?`Resolved: ${i}`:"Action resolved"}case"narration.posted":return k(s.reply,k(s.content,k(s.text,"Narration")));case"dice.rolled":{const i=k(s.action,"roll"),l=B(s.total,0),c=B(s.dc,0),p=k(s.label,""),m=a||"actor",u=c>0?` vs DC ${c}`:"",_=p?` (${p})`:"";return`${m} ${i}: ${l}${u}${_}`}case"turn.started":return`Turn ${B(s.turn,1)} started`;case"phase.changed":return`Phase: ${k(s.phase,"round")}`;case"actor.spawned":return`Actor spawned: ${k(s.name,v(s.actor)?k(s.actor.name,a||"unknown"):a||"unknown")}`;case"actor.claimed":return`${k(s.keeper_name,k(s.keeper,"keeper"))} claimed ${a||"actor"}`;case"actor.released":return`${k(s.keeper_name,k(s.keeper,"keeper"))} released ${a||"actor"}`;case"join.window.opened":return`Join window opened (turn ${B(s.turn,0)})`;case"join.window.closed":return`Join window closed (turn ${B(s.turn,0)})`;case"mid.join.requested":return`Mid-join requested: ${a||k(s.actor_id,"actor")}`;case"mid.join.granted":return`Mid-join granted: ${a||k(s.actor_id,"actor")}`;case"mid.join.rejected":return`Mid-join rejected: ${k(s.reason_code,"unknown")}`;case"memory.signal":{const i=v(s.entity_refs)?s.entity_refs:{},l=k(i.requested_tier,""),c=k(i.effective_tier,""),p=Bs(i.guardrail_applied,!1),m=k(s.summary_en,k(s.summary_ko,"Memory signal"));if(!l&&!c)return m;const u=l&&c?`${l}->${c}`:c||l;return`${m} [${u}${p?" (guardrail)":""}]`}case"world.event":{if(k(s.event_type,"")==="canon.check"){const l=k(s.status,"unknown"),c=k(s.contract_id,"n/a");return`Canon ${l}: ${c}`}return k(s.description,k(s.summary,"World event"))}case"combat.attack":return k(s.summary,k(s.result,"Attack resolved"));case"combat.defense":return k(s.summary,k(s.result,"Defense resolved"));case"session.outcome":return k(s.summary,k(s.outcome,"Session ended"));default:{const i=Xd(s);return i?`${e}: ${i}`:e}}}function tu(e,t){const n=v(e)?e:{},s=k(n.type,"event"),a=typeof n.actor_id=="string"&&n.actor_id.trim()?n.actor_id.trim():"",i=k(n.actor_name,"").trim()||t[a]||k(v(n.payload)?n.payload.actor_name:"",""),l=v(n.payload)?n.payload:{},c=k(n.ts,k(n.timestamp,new Date().toISOString())),p=k(n.phase,k(l.phase,"")),m=k(n.category,"");return{type:s,actor:i||a||k(l.actor_name,""),actor_id:a||k(l.actor_id,""),actor_name:i,seq:n.seq,room_id:k(n.room_id,""),phase:p||void 0,category:m||Zd(s),visibility:k(n.visibility,k(l.visibility,"public")),event_id:k(n.event_id,""),content:eu(s,a,i,l),dice_roll:Yd(s,l),timestamp:c}}function nu(e,t,n){var Z,oe;const s=k(e.room_id,"")||n||"default",a=v(e.state)?e.state:{},i=v(a.party)?a.party:{},l=v(a.actor_control)?a.actor_control:{},c=v(a.join_gate)?a.join_gate:{},p=v(a.contribution_ledger)?a.contribution_ledger:{},m=Object.entries(i).map(([V,ee])=>{const C=v(ee)?ee:{},Ie=ke(C,"max_hp",void 0,10),We=ke(C,"hp",void 0,Ie),mt=ke(C,"max_mp",void 0,0),vt=ke(C,"mp",void 0,0),K=ke(C,"level",void 0,1),Te=ke(C,"xp",void 0,0),_t=Bs(C.alive,We>0),pn=l[V],mn=typeof pn=="string"?pn:void 0,os=Jd(C.role,V,mn),is=me(C.generation),rs=ce(C.joined_at,C.joinedAt,C.started_at,C.startedAt),ls=ce(C.claimed_at,C.claimedAt,C.assigned_at,C.assignedAt,C.assigned_time),cs=ce(C.last_seen,C.lastSeen,C.last_seen_at,C.lastSeenAt,C.last_active,C.lastActive),ds=ce(C.scene,C.current_scene,C.currentScene,C.world_scene,C.scene_name,C.sceneName),us=ce(C.location,C.current_location,C.currentLocation,C.position,C.zone,C.area);return{id:V,name:k(C.name,V),role:os,keeper:mn,archetype:k(C.archetype,""),persona:k(C.persona,""),portrait:k(C.portrait,"")||void 0,background:k(C.background,"")||void 0,traits:Me(C.traits),skills:Me(C.skills),stats_raw:Qd(C),status:_t?"active":"dead",generation:is,joined_at:rs||void 0,claimed_at:ls||void 0,last_seen:cs||void 0,scene:ds||void 0,location:us||void 0,inventory:Me(C.inventory),notes:Me(C.notes),relationships:Gd(C.relationships),stats:{hp:We,max_hp:Ie,mp:vt,max_mp:mt,level:K,xp:Te,strength:ke(C,"strength","str",10),dexterity:ke(C,"dexterity","dex",10),constitution:ke(C,"constitution","con",10),intelligence:ke(C,"intelligence","int",10),wisdom:ke(C,"wisdom","wis",10),charisma:ke(C,"charisma","cha",10)}}}),u=m.filter(V=>V.status!=="dead"),_=Wd(e,t),f={phase_open:Bs(c.phase_open,!0),min_points:B(c.min_points,3),window:k(c.window,"round_boundary_only"),last_opened_turn:typeof c.last_opened_turn=="number"?c.last_opened_turn:null,last_closed_turn:typeof c.last_closed_turn=="number"?c.last_closed_turn:null},h=Object.entries(p).map(([V,ee])=>{const C=v(ee)?ee:{};return{actor_id:V,score:B(C.score,0),last_reason:k(C.last_reason,"")||null,reasons:Me(C.reasons)}}),b=m.reduce((V,ee)=>(V[ee.id]=ee.name,V),{}),$=t.map(V=>tu(V,b)),S=B(a.turn,1),A=k(a.phase,"round"),x=k(a.map,""),z=v(a.world)?a.world:{},T=x||k(z.ascii_map,k(z.map,"")),P=$.filter((V,ee)=>{const C=t[ee];if(!v(C))return!1;const Ie=v(C.payload)?C.payload:{};return B(Ie.turn,-1)===S}),M=(P.length>0?P:$).slice(-12),R=k(a.status,"active");return{session:{id:s,room:s,status:R==="ended"?"ended":R==="paused"?"paused":"active",round:S,actors:u,created_at:((Z=$[0])==null?void 0:Z.timestamp)??new Date().toISOString()},current_round:{round_number:S,phase:A,events:M,timestamp:((oe=$[$.length-1])==null?void 0:oe.timestamp)??new Date().toISOString()},map:T||void 0,join_gate:f,contribution_ledger:h,outcome:_,party:u,story_log:$,history:[]}}async function su(e){const t=`?room_id=${encodeURIComponent(e)}`,n=await X(`/api/v1/trpg/events${t}`);return Array.isArray(n.events)?n.events:[]}async function au(e){const t=`?room_id=${encodeURIComponent(e)}`,[n,s]=await Promise.all([X(`/api/v1/trpg/state${t}`),su(e)]);return nu(n,s,e)}function ou(e){return we("/api/v1/trpg/rounds/run",{room_id:e})}function iu(e){const t="".trim().toLowerCase();if(t)switch(t){case"discussion":case"discuss":case"party_discussion":case"player_discussion":case"action":case"dice":return"round";case"ended":return"end";default:return t}}function ru(e){const t={room_id:e.roomId,actor_id:e.actorId,action:e.action,stat_value:e.statValue,dc:e.dc};return e.rawD20!=null&&(t.raw_d20=e.rawD20),e.ruleModule&&(t.rule_module=e.ruleModule),we("/api/v1/trpg/dice/roll",t)}function lu(e,t){const n=iu();return we("/api/v1/trpg/turns/advance",{room_id:e,...n?{phase:n}:{}})}function cu(e,t){var a;const n=(a=t.idempotencyKey)==null?void 0:a.trim(),s={room_id:e};return t.actor_id&&t.actor_id.trim()&&(s.actor_id=t.actor_id.trim()),t.name&&t.name.trim()&&(s.name=t.name.trim()),t.role&&(s.role=t.role),t.archetype&&t.archetype.trim()&&(s.archetype=t.archetype.trim()),t.persona&&t.persona.trim()&&(s.persona=t.persona.trim()),t.portrait&&t.portrait.trim()&&(s.portrait=t.portrait.trim()),t.background&&t.background.trim()&&(s.background=t.background.trim()),t.hp!=null&&(s.hp=t.hp),t.max_hp!=null&&(s.max_hp=t.max_hp),t.alive!=null&&(s.alive=t.alive),Array.isArray(t.traits)&&t.traits.length>0&&(s.traits=t.traits),Array.isArray(t.skills)&&t.skills.length>0&&(s.skills=t.skills),Array.isArray(t.inventory)&&t.inventory.length>0&&(s.inventory=t.inventory),t.stats&&Object.keys(t.stats).length>0&&(s.stats=t.stats),n&&(s.idempotency_key=n),we("/api/v1/trpg/actors/spawn",s,n?{"Idempotency-Key":n}:void 0)}function du(e,t,n){return we("/api/v1/trpg/actors/claim",{room_id:e,actor_id:t,keeper:n})}async function uu(e,t,n){const s=await ct("trpg.join.eligibility",{room_id:e,actor_id:t,...n?{keeper_name:n}:{}});return JSON.parse(s)}async function pu(e){const t=await ct("trpg.mid_join.request",e);return JSON.parse(t)}async function mu(e,t){await ct("masc_broadcast",{agent_name:e,message:t})}async function vu(e=40){return(await ct("masc_messages",{limit:e})).split(`
`).map(n=>n.trim()).filter(n=>n!=="")}async function _u(e,t=20){return ct("masc_task_history",{task_id:e,limit:t})}async function gu(e){const t=await ct("masc_debate_start",{topic:e});try{return JSON.parse(t)}catch{return null}}async function fu(e){return Ca("fetchDebateStatus",async()=>{const t=encodeURIComponent(e),n=await X(`/api/v1/council/debates/${t}/summary`);if(!v(n))return null;const s=v(n.debate)?n.debate:n,a=k(s.id,"").trim(),i=k(s.topic,"").trim();return!a||!i?null:{debate:{id:a,topic:i,status:k(s.status,"open"),created_at:le(s.created_at_iso??s.created_at),closed_at:le(s.closed_at)},arguments:Array.isArray(n.arguments)?n.arguments.flatMap(l=>v(l)?[{index:B(l.index,0),agent:k(l.agent,"unknown"),position:k(l.position,"neutral"),content:k(l.content,""),evidence:Me(l.evidence),reply_to:me(l.reply_to)??null,mentions:Me(l.mentions),archetype:q(l.archetype),created_at:le(l.created_at)}]:[]):[],summary:{support_count:v(n.summary)?B(n.summary.support_count,0):B(n.support_count,0),oppose_count:v(n.summary)?B(n.summary.oppose_count,0):B(n.oppose_count,0),neutral_count:v(n.summary)?B(n.summary.neutral_count,0):B(n.neutral_count,0),total_arguments:v(n.summary)?B(n.summary.total_arguments,0):B(n.total_arguments,0),summary_text:v(n.summary)?k(n.summary.summary_text,""):k(n.summary_text,"")},context:Jo(n.context),judgment:Or(n.judgment)}})}async function $u(e){return Ca("fetchConsensusSessionSummary",async()=>{const t=encodeURIComponent(e),n=await X(`/api/v1/council/sessions/${t}/summary`);if(!v(n)||!v(n.session))return null;const s=n.session,a=k(s.id,"").trim(),i=k(s.topic,"").trim();return!a||!i?null:{session:{id:a,topic:i,state:k(s.state,"open"),initiator:k(s.initiator,"system"),quorum:B(s.quorum,0),threshold:B(s.threshold,0),created_at:le(s.created_at),closed_at:le(s.closed_at)},votes:Array.isArray(n.votes)?n.votes.flatMap(l=>v(l)?[{agent:k(l.agent,"unknown"),decision:k(l.decision,"abstain"),reason:k(l.reason,""),timestamp:le(l.timestamp),weight:typeof l.weight=="number"?l.weight:void 0,archetype:q(l.archetype)}]:[]):[],summary:{approve_count:v(n.summary)?B(n.summary.approve_count,0):0,reject_count:v(n.summary)?B(n.summary.reject_count,0):0,abstain_count:v(n.summary)?B(n.summary.abstain_count,0):0,quorum_met:v(n.summary)?Bs(n.summary.quorum_met,!1):!1,result:v(n.summary)?q(n.summary.result):null},context:Jo(n.context),judgment:Or(n.judgment)}})}function hu(e,t,n){return ct("masc_keeper_msg",{name:e,message:t})}const yu=g(""),Be=g({}),de=g({}),$o=g({}),ho=g({}),yo=g({}),bo=g({}),Ue=g({});function re(e,t,n){e.value={...e.value,[t]:n}}function bu(e){var n;const t=(n=r(e))==null?void 0:n.toLowerCase();return t==="user"||t==="assistant"||t==="system"||t==="tool"?t:"other"}function ku(e){switch(e){case"user":return"User";case"assistant":return"Keeper";case"system":return"System";case"tool":return"Tool";default:return"Event"}}function Da(e,t){if(!Array.isArray(e))return[];const n=[];for(const s of e){if(!v(s))continue;const a=r(s.name);if(!a)continue;const i=r(s[t]);t==="summary"?n.push({name:a,summary:i}):n.push({name:a,reason:i})}return n}function xu(e){if(!v(e))return null;const t=r(e.name);return t?{name:t,trigger:r(e.trigger),outcome:r(e.outcome),summary:r(e.summary),reason:r(e.reason)}:null}function Su(e){const t=e.toLowerCase();return t.includes("graphql")?"graphql_error":t.includes("timeout")||t.includes("model")||t.includes("llm")||t.includes("api key")||t.includes("api_key")||t.includes("provider")?"llm_error":"unknown"}function Au(e,t){return e==="offline"||e==="degraded"||e==="stale"?"Keeper is not in a healthy reply state. Probe or recover before relying on automation.":t==="quiet_hours"?"Lodge quiet hours are active. Direct messages still work, but scheduled social ticks may look asleep.":t==="min_gap"?"Keeper is inside its proactive cooldown window. Direct messages work now; autonomous check-ins will wait.":t==="never_started"?"Keeper metadata exists but no reply turn has been recorded yet.":"Keeper is reachable. Send a direct message for an immediate response."}function Fr(e,t,n){return r(e)??Au(t,n)}function Kr(e,t){return typeof e=="boolean"?e:t==="recover"}function Us(e){if(!v(e))return null;const t=r(e.health_state),n=r(e.next_action_path),s=r(e.last_reply_status);return!t||!n||!s?null:{health_state:t,quiet_reason:r(e.quiet_reason)??null,next_action_path:n,last_reply_status:s,last_reply_at:ae(e.last_reply_at)??null,last_reply_preview:r(e.last_reply_preview)??null,last_error:r(e.last_error)??null,next_eligible_at_s:d(e.next_eligible_at_s)??null,recoverable:Kr(e.recoverable,n),summary:Fr(e.summary,t,r(e.quiet_reason)??null),keepalive_running:typeof e.keepalive_running=="boolean"?e.keepalive_running:void 0}}function Br(e){return v(e)?{hour:d(e.hour),checked:d(e.checked)??0,acted:d(e.acted)??0,acted_names:H(e.acted_names),activity_report:r(e.activity_report),quiet_hours_overridden:j(e.quiet_hours_overridden),skipped_reason:r(e.skipped_reason),acted_rows:Da(e.acted_rows,"summary").map(t=>({name:t.name,summary:t.summary})),passed_rows:Da(e.passed_rows,"reason").map(t=>({name:t.name,reason:t.reason})),skipped_rows:Da(e.skipped_rows,"reason").map(t=>({name:t.name,reason:t.reason})),checkins:Array.isArray(e.checkins)?e.checkins.map(xu).filter(t=>t!==null):[]}:null}function Cu(e){return v(e)?{enabled:j(e.enabled)??!1,interval_s:d(e.interval_s)??0,quiet_start:d(e.quiet_start),quiet_end:d(e.quiet_end),quiet_active:j(e.quiet_active),use_planner:j(e.use_planner),delegate_llm:j(e.delegate_llm),agent_count:d(e.agent_count),agents:H(e.agents),last_tick_ago_s:d(e.last_tick_ago_s)??null,last_tick_ago:r(e.last_tick_ago),total_ticks:d(e.total_ticks),total_checkins:d(e.total_checkins),last_skip_reason:r(e.last_skip_reason)??null,last_tick_result:Br(e.last_tick_result),active_self_heartbeats:H(e.active_self_heartbeats)}:null}function Iu(e){return v(e)?{status:e.status,diagnostic:Us(e.diagnostic)}:null}function Tu(e){return v(e)?{recovered:j(e.recovered)??!1,skipped_reason:r(e.skipped_reason)??null,before:Us(e.before),after:Us(e.after),down:e.down,up:e.up}:null}function Ru(e,t){var x,z;if(!(e!=null&&e.name))return null;const n=r((x=e.agent)==null?void 0:x.status)??r(e.status)??"unknown",s=r((z=e.agent)==null?void 0:z.error)??null,a=e.presence_keepalive??!0,i=e.keepalive_running??!1,l=e.turn_count??0,c=e.last_turn_ago_s??null,p=e.proactive_enabled??!1,m=e.proactive_cooldown_sec??0,u=e.last_proactive_ago_s??null,_=p&&u!=null?Math.max(0,m-u):null,f=l<=0||c==null?"never":c>900?"stale":"fresh",h=typeof e.last_heartbeat=="string"&&e.last_heartbeat.trim()?e.last_heartbeat:null,b=s??(a&&!i?"keeper keepalive is not running":null),$=n==="offline"||n==="inactive"?"offline":b?"degraded":f==="stale"?"stale":f==="never"?"idle":"healthy",S=b?Su(b):t!=null&&t.quiet_active&&f!=="fresh"?"quiet_hours":a&&!i?"disabled":l<=0?"never_started":_!=null&&_>0?"min_gap":f==="fresh"||f==="stale"?"no_recent_activity":"unknown",A=$==="offline"||$==="degraded"||$==="stale"?"recover":S==="quiet_hours"?"manual_lodge_poke":S==="unknown"?"probe":"direct_message";return{health_state:$,quiet_reason:S,next_action_path:A,last_reply_status:f,last_reply_at:h,last_reply_preview:null,last_error:b,next_eligible_at_s:_!=null&&_>0?_:null,recoverable:Kr(void 0,A),summary:Fr(void 0,$,S),keepalive_running:i}}function Pu(e,t){if(!v(e))return null;const n=bu(e.role),s=r(e.content)??r(e.preview);if(!s)return null;const a=ae(e.ts_unix)??ae(e.timestamp);return{id:`${n}-${a??"entry"}-${t}`,role:n,label:ku(n),text:s,timestamp:a,delivery:"history"}}function Lu(e,t,n){const s=v(n)?n:null,a=Array.isArray(s==null?void 0:s.history_tail)?s.history_tail.map((i,l)=>Pu(i,l)).filter(i=>i!==null):[];return{name:e,diagnostic:Us(s==null?void 0:s.diagnostic),history:a,rawText:t,rawStatus:n,loadedAt:new Date().toISOString()}}function Ei(e,t){const n=de.value[e]??[];de.value={...de.value,[e]:[...n,t].slice(-50)}}function zu(e,t){return e.role!==t.role||e.text!==t.text?!1:e.timestamp&&t.timestamp?e.timestamp===t.timestamp:!0}function Mu(e,t){const s=(de.value[e]??[]).filter(a=>a.delivery!=="history"&&!t.some(i=>zu(a,i)));de.value={...de.value,[e]:[...t,...s].slice(-50)}}function Ta(e,t){Be.value={...Be.value,[e]:t},Mu(e,t.history)}function ji(e,t){const n=Be.value[e];if(!n)return;const s=n.diagnostic??{health_state:"idle",next_action_path:"direct_message",last_reply_status:"unknown"};Ta(e,{...n,diagnostic:{...s,...t}})}async function Vo(){try{await Yn()}catch(e){console.warn("[keeper-runtime] dashboard refresh failed",e)}}function Nu(e){yu.value=e.trim()}async function Ur(e,t=!1){const n=e.trim();if(!n)return null;if(!t&&Be.value[n])return Be.value[n];re($o,n,!0),re(Ue,n,null);try{const s=await ct("masc_keeper_status",{name:n,fast:!1,include_context:!0,include_metrics_overview:!0,include_memory_bank:!1,include_history_tail:!0,include_compaction_history:!1,tail_turns:5,tail_messages:10});let a=null;try{a=JSON.parse(s)}catch{a=null}const i=Lu(n,s,a);return Ta(n,i),i}catch(s){const a=s instanceof Error?s.message:`Failed to inspect ${n}`;return re(Ue,n,a),null}finally{re($o,n,!1)}}async function Eu(e,t){const n=e.trim(),s=t.trim();if(!n||!s)return;const a=`local-${Date.now()}`;Ei(n,{id:a,role:"user",label:"You",text:s,timestamp:new Date().toISOString(),delivery:"sending"}),re(ho,n,!0),re(Ue,n,null);try{const i=await hu(n,s);de.value={...de.value,[n]:(de.value[n]??[]).map(l=>l.id===a?{...l,delivery:"delivered"}:l)},Ei(n,{id:`reply-${Date.now()}`,role:"assistant",label:n,text:i.trim()||"(empty reply)",timestamp:new Date().toISOString(),delivery:"delivered"}),ji(n,{last_reply_status:"delivered",last_reply_at:new Date().toISOString(),last_reply_preview:(i.trim()||"(empty reply)").slice(0,200),last_error:null}),await Vo()}catch(i){const l=i instanceof Error?i.message:`Failed to send direct message to ${n}`;throw de.value={...de.value,[n]:(de.value[n]??[]).map(c=>c.id===a?{...c,delivery:"error",error:l}:c)},ji(n,{last_reply_status:"error",last_error:l}),re(Ue,n,l),i}finally{re(ho,n,!1)}}async function ju(e,t){const n=e.trim();if(!n)return null;re(yo,n,!0),re(Ue,n,null);try{const s=await Ia({actor:t,action_type:"keeper_probe",target_type:"keeper",target_id:n,payload:{}}),a=Iu(s.result),i=(a==null?void 0:a.diagnostic)??null;if(i){const l=Be.value[n];Ta(n,{name:n,diagnostic:i,history:(l==null?void 0:l.history)??de.value[n]??[],rawText:(l==null?void 0:l.rawText)??"",rawStatus:s.result,loadedAt:new Date().toISOString()})}return await Vo(),i}catch(s){const a=s instanceof Error?s.message:`Failed to probe ${n}`;throw re(Ue,n,a),s}finally{re(yo,n,!1)}}async function wu(e,t){const n=e.trim();if(!n)return null;re(bo,n,!0),re(Ue,n,null);try{const s=await Ia({actor:t,action_type:"keeper_recover",target_type:"keeper",target_id:n,payload:{}}),a=Tu(s.result),i=(a==null?void 0:a.after)??null;if(i){const l=Be.value[n];Ta(n,{name:n,diagnostic:i,history:(l==null?void 0:l.history)??de.value[n]??[],rawText:(l==null?void 0:l.rawText)??"",rawStatus:s.result,loadedAt:new Date().toISOString()})}return await Vo(),i}catch(s){const a=s instanceof Error?s.message:`Failed to recover ${n}`;throw re(Ue,n,a),s}finally{re(bo,n,!1)}}function gt(e){return(e??"").trim().toLowerCase()}function ge(e){const t=typeof e=="number"?e:Date.parse(e);return Number.isNaN(t)?0:t}function Rs(e,t=88){const n=e.replace(/\s+/g," ").trim();return n&&(n.length>t?`${n.slice(0,t-3)}...`:n)}function ms(e){return typeof e!="number"||!Number.isFinite(e)||e<0?null:new Date(Date.now()-e*1e3).toISOString()}function vn(e){return e.last_heartbeat??ms(e.last_turn_ago_s)??ms(e.last_proactive_ago_s)??ms(e.last_handoff_ago_s)??ms(e.last_compaction_ago_s)}function Du(e){const t=e.title.trim();return t||Rs(e.content)}function Ou(e){const t=e.generation??"?",n=typeof e.context_ratio=="number"&&Number.isFinite(e.context_ratio)?`${Math.round(e.context_ratio*100)}%`:"?";return e.last_heartbeat?`Heartbeat gen=${t} ctx=${n}`:`Keeper snapshot gen=${t} ctx=${n}`}function qu(e,t,n,s,a={}){var z;const i=gt(e),l=t.filter(T=>gt(T.assignee)===i&&(T.status==="claimed"||T.status==="in_progress")).length,c=n.filter(T=>gt(T.from)===i).sort((T,P)=>ge(P.timestamp)-ge(T.timestamp))[0],p=s.filter(T=>gt(T.agent)===i||gt(T.author)===i).sort((T,P)=>ge(P.timestamp)-ge(T.timestamp))[0],m=(a.boardPosts??[]).filter(T=>gt(T.author)===i).sort((T,P)=>ge(P.updated_at||P.created_at)-ge(T.updated_at||T.created_at))[0],u=(a.keepers??[]).filter(T=>gt(T.name)===i&&vn(T)!==null).sort((T,P)=>ge(vn(P)??0)-ge(vn(T)??0))[0],_=c?ge(c.timestamp):0,f=p?ge(p.timestamp):0,h=m?ge(m.updated_at||m.created_at):0,b=u?ge(vn(u)??0):0,$=a.lastSeen?ge(a.lastSeen):0,S=((z=a.currentTask)==null?void 0:z.trim())||(l>0?`${l} claimed tasks`:null);if(_===0&&f===0&&h===0&&b===0&&$===0)return{activeAssignedCount:l,lastActivityAt:null,lastActivityText:S};const x=[c?{timestamp:c.timestamp,ts:_,text:Rs(c.content)}:null,m?{timestamp:m.updated_at||m.created_at,ts:h,text:`Post: ${Rs(Du(m))}`}:null,u?{timestamp:vn(u),ts:b,text:Ou(u)}:null,p?{timestamp:new Date(p.timestamp).toISOString(),ts:f,text:Rs(p.text)}:null].filter(T=>T!==null).sort((T,P)=>P.ts-T.ts)[0];return x&&x.ts>=$?{activeAssignedCount:l,lastActivityAt:x.timestamp,lastActivityText:x.text}:{activeAssignedCount:l,lastActivityAt:a.lastSeen??null,lastActivityText:S??"Presence heartbeat"}}const He=g([]),Xe=g([]),ko=g([]),dt=g([]),te=g(null),Fu=g(null),Hr=g(null),Wr=g([]),Gr=g([]),Jr=g([]),Vr=g([]),Qr=g([]),Yr=g([]),xo=g(new Map),Ra=g([]),Ln=g("recent"),bt=g(!0),Xr=g(null),Ke=g(""),Ht=g([]),yn=g(!1),Zr=g(new Map),Qo=g("unknown"),Wt=g(null),So=g(!1),zn=g(!1),Ao=g(!1),bn=g(!1),Yo=g(null),Hs=g(!1),Ws=g(null),el=g(null),Co=g(null),Ku=g(null),Bu=g(null),Uu=g(null);Ce(()=>He.value.filter(e=>e.status==="active"||e.status==="busy"||e.status==="listening"||e.status==="idle"));const tl=Ce(()=>{const e=Xe.value;return{todo:e.filter(t=>t.status==="todo"),inProgress:e.filter(t=>t.status==="in_progress"||t.status==="claimed"),done:e.filter(t=>t.status==="done")}}),nl=Ce(()=>{const e=new Map,t=Xe.value,n=ko.value,s=Ks.value,a=Ra.value,i=dt.value;for(const l of He.value)e.set(l.name.trim().toLowerCase(),qu(l.name,t,n,s,{currentTask:l.current_task,lastSeen:l.last_seen,boardPosts:a,keepers:i}));return e});function Hu(e){var i;const t=((i=e.status)==null?void 0:i.toLowerCase())??"";if(t==="offline"||t==="inactive")return"offline";const n=e.metrics_series;if(!n||n.length===0)return"idle";const s=n[n.length-1];if(!s)return"idle";if(s.is_handoff)return"handoff-imminent";if(s.is_compaction)return"compacting";const a=s.context_ratio;return a>.85?"handoff-imminent":a>.7?"preparing":a>.5?"compacting":"active"}Ce(()=>{const e=new Map;for(const t of dt.value)e.set(t.name,Hu(t));return e});const Wu=12e4;function Gu(e,t){const n=t.get(e.name);if(n!=null)return n;const s=e.last_heartbeat?Date.parse(e.last_heartbeat):Number.NaN;if(!Number.isNaN(s))return s;const a=[e.last_turn_ago_s,e.last_proactive_ago_s,e.last_handoff_ago_s,e.last_compaction_ago_s].find(i=>typeof i=="number"&&Number.isFinite(i)&&i>=0);return typeof a=="number"?Date.now()-a*1e3:null}Ce(()=>{const e=Date.now(),t=new Set,n=xo.value;for(const s of dt.value){const a=Gu(s,n);a!=null&&e-a>Wu&&t.add(s.name)}return t});function Ju(e){return e==="dashboard_refresh"||e==="masc/dashboard_refresh"||e.startsWith("goal_")||e.startsWith("masc/goal_")||e.startsWith("mdal_")||e.startsWith("masc/mdal_")||e.startsWith("operator_")||e.startsWith("masc/operator_")||e.startsWith("command_plane_")||e.startsWith("masc/command_plane_")}function sl(e){const t=typeof e=="string"?e.toLowerCase():"";return t==="active"||t==="busy"||t==="listening"||t==="idle"||t==="inactive"||t==="offline"?t:t==="in_progress"||t==="claimed"?"busy":"offline"}function Vu(e){const t=typeof e=="string"?e.toLowerCase():"";return t==="todo"||t==="in_progress"||t==="claimed"||t==="done"||t==="cancelled"?t:t==="inprogress"?"in_progress":"todo"}function Qu(e){if(!v(e))return null;const t=r(e.name);return t?{name:t,agent_type:r(e.agent_type),status:sl(e.status),current_task:r(e.current_task)??null,joined_at:r(e.joined_at),last_seen:r(e.last_seen),capabilities:H(e.capabilities),emoji:r(e.emoji),koreanName:r(e.koreanName)??r(e.korean_name),model:r(e.model),traits:H(e.traits),interests:H(e.interests),activityLevel:d(e.activityLevel)??d(e.activity_level),primaryValue:r(e.primaryValue)??r(e.primary_value)}:null}function Yu(e){if(!v(e))return null;const t=r(e.id),n=r(e.title);return!t||!n?null:{id:t,title:n,status:Vu(e.status),priority:d(e.priority),assignee:r(e.assignee),description:r(e.description),created_at:r(e.created_at),updated_at:r(e.updated_at)}}function Xu(e){if(!v(e))return null;const t=r(e.from)??r(e.from_agent)??"system",n=r(e.content)??"",s=r(e.timestamp)??new Date().toISOString();return{id:r(e.id),seq:d(e.seq),from:t,content:n,timestamp:s,type:r(e.type)}}function Xo(e){const t=typeof e=="string"?e.toLowerCase():"";return t==="ok"||t==="warn"||t==="bad"?t:"ok"}function Zu(e){return v(e)?{active_sessions:d(e.active_sessions),blocked_sessions:d(e.blocked_sessions),active_operations:d(e.active_operations),blocked_operations:d(e.blocked_operations),runtime_pressure:d(e.runtime_pressure),worker_alerts:d(e.worker_alerts),continuity_alerts:d(e.continuity_alerts),priority_items:d(e.priority_items),todo_tasks:d(e.todo_tasks),claimed_tasks:d(e.claimed_tasks),running_tasks:d(e.running_tasks),done_tasks:d(e.done_tasks),cancelled_tasks:d(e.cancelled_tasks),keepers:d(e.keepers)}:null}function Ze(e){if(!v(e))return null;const t=r(e.surface),n=r(e.label),s=r(e.target_type),a=r(e.target_id),i=r(e.focus_kind);return!t||!n||!s||!a||!i?null:{surface:t==="command"?"command":"intervene",label:n,target_type:s,target_id:a,focus_kind:i,operation_id:r(e.operation_id)??null,command_surface:r(e.command_surface)??null}}function ep(e){if(!v(e))return null;const t=r(e.id),n=r(e.kind),s=r(e.summary),a=r(e.target_type),i=r(e.target_id);return!t||!s||!a||!i||n!=="session"&&n!=="operation"?null:{id:t,kind:n,severity:Xo(e.severity),status:r(e.status),summary:s,target_type:a,target_id:i,linked_session_id:r(e.linked_session_id)??null,linked_operation_id:r(e.linked_operation_id)??null,last_seen_at:r(e.last_seen_at)??null,top_handoff:Ze(e.top_handoff),intervene_handoff:Ze(e.intervene_handoff),command_handoff:Ze(e.command_handoff)}}function tp(e){if(!v(e))return null;const t=r(e.session_id),n=r(e.goal);return!t||!n?null:{session_id:t,goal:n,room:r(e.room)??null,status:r(e.status),health:r(e.health),member_names:H(e.member_names),linked_operation_id:r(e.linked_operation_id)??null,linked_detachment_id:r(e.linked_detachment_id)??null,runtime_blocker:r(e.runtime_blocker)??null,worker_gap_summary:r(e.worker_gap_summary)??null,last_activity_at:r(e.last_activity_at)??null,last_activity_summary:r(e.last_activity_summary)??null,communication_summary:r(e.communication_summary)??null,active_count:d(e.active_count),required_count:d(e.required_count),top_handoff:Ze(e.top_handoff),intervene_handoff:Ze(e.intervene_handoff),command_handoff:Ze(e.command_handoff)}}function np(e){if(!v(e))return null;const t=r(e.operation_id),n=r(e.objective);return!t||!n?null:{operation_id:t,objective:n,status:r(e.status),stage:r(e.stage)??null,assigned_unit_id:r(e.assigned_unit_id)??null,assigned_unit_label:r(e.assigned_unit_label)??null,linked_session_id:r(e.linked_session_id)??null,linked_detachment_id:r(e.linked_detachment_id)??null,blocker_summary:r(e.blocker_summary)??null,search_status:r(e.search_status)??null,next_tool:r(e.next_tool)??null,updated_at:r(e.updated_at)??null,top_handoff:Ze(e.top_handoff),command_handoff:Ze(e.command_handoff)}}function wi(e){if(!v(e))return null;const t=r(e.name)??r(e.agent_name),n=r(e.note),s=r(e.focus),a=r(e.state);return!t||!n||!s||a!=="working"&&a!=="watching"&&a!=="quiet"&&a!=="offline"?null:{name:t,agent_name:r(e.agent_name),status:r(e.status),tone:Xo(e.tone),state:a,note:n,focus:s,last_signal_at:r(e.last_signal_at)??null,active_task_count:d(e.active_task_count),related_session_id:r(e.related_session_id)??null,related_operation_id:r(e.related_operation_id)??null,emoji:r(e.emoji),korean_name:r(e.korean_name),model:r(e.model)??null,recent_output_preview:r(e.recent_output_preview)??null,recent_event:r(e.recent_event)??null}}function sp(e){if(!v(e))return null;const t=r(e.name),n=r(e.note),s=r(e.focus),a=r(e.state);return!t||!n||!s||a!=="healthy"&&a!=="warning"&&a!=="critical"?null:{name:t,agent_name:r(e.agent_name)??null,status:r(e.status),tone:Xo(e.tone),state:a,note:n,focus:s,last_signal_at:r(e.last_signal_at)??null,last_autonomous_action_at:r(e.last_autonomous_action_at)??null,generation:d(e.generation),turn_count:d(e.turn_count),context_ratio:d(e.context_ratio)??null,continuity:r(e.continuity)??null,lifecycle:r(e.lifecycle)??null,related_session_id:r(e.related_session_id)??null,model:r(e.model)??null,emoji:r(e.emoji),korean_name:r(e.korean_name),skill_reason:r(e.skill_reason)??null}}function Di(e){if(typeof e.seq=="number"&&Number.isFinite(e.seq))return e.seq;const t=Date.parse(e.timestamp);return Number.isNaN(t)?0:t}function ap(e,t){if(t.length===0)return e;const n=new Map;for(const s of e){const a=typeof s.seq=="number"?`seq:${s.seq}`:`ts:${s.timestamp}|from:${s.from}|content:${s.content}`;n.set(a,s)}for(const s of t){const a=typeof s.seq=="number"?`seq:${s.seq}`:`ts:${s.timestamp}|from:${s.from}|content:${s.content}`;n.set(a,s)}return[...n.values()].sort((s,a)=>Di(s)-Di(a)).slice(-500)}function op(e){return Array.isArray(e)?e.map(t=>{if(!v(t))return null;const n=d(t.ts_unix);if(n==null)return null;const s=v(t.handoff)?t.handoff:null;return{ts:n,context_ratio:d(t.context_ratio)??0,context_tokens:d(t.context_tokens)??0,context_max:d(t.context_max)??0,latency_ms:d(t.latency_ms)??0,generation:d(t.generation)??0,channel:typeof t.channel=="string"?t.channel:"turn",is_handoff:s!=null&&t.handoff_performed===!0,is_compaction:t.compacted===!0,compaction_saved_tokens:d(t.compaction_saved_tokens)??0,compaction_trigger:typeof t.compaction_trigger=="string"?t.compaction_trigger:null,model_used:typeof t.model_used=="string"?t.model_used:"",cost_usd:d(t.cost_usd)??0,handoff_to_model:s&&typeof s.to_model=="string"?s.to_model:null,handoff_new_generation:s?d(s.new_generation)??null:null}}).filter(t=>t!==null):[]}function Oi(e){if(!v(e))return null;const t=r(e.health_state),n=r(e.next_action_path),s=r(e.last_reply_status);if(!t||!n||!s)return null;const a=r(e.quiet_reason)??null,i=r(e.summary)??(t==="offline"||t==="degraded"||t==="stale"?"Keeper is not in a healthy reply state. Probe or recover before relying on automation.":a==="quiet_hours"?"Lodge quiet hours are active. Direct messages still work, but scheduled social ticks may look asleep.":a==="min_gap"?"Keeper is inside its proactive cooldown window. Direct messages work now; autonomous check-ins will wait.":a==="never_started"?"Keeper metadata exists but no reply turn has been recorded yet.":"Keeper is reachable. Send a direct message for an immediate response.");return{health_state:t,quiet_reason:a,next_action_path:n,last_reply_status:s,last_reply_at:ae(e.last_reply_at)??r(e.last_reply_at)??null,last_reply_preview:r(e.last_reply_preview)??null,last_error:r(e.last_error)??null,next_eligible_at_s:d(e.next_eligible_at_s)??null,recoverable:typeof e.recoverable=="boolean"?e.recoverable:n==="recover",summary:i,keepalive_running:typeof e.keepalive_running=="boolean"?e.keepalive_running:void 0}}function ip(e,t){return(Array.isArray(e)?e:v(e)&&Array.isArray(e.keepers)?e.keepers:[]).map(s=>{if(!v(s))return null;const a=v(s.agent)?s.agent:null,i=v(s.context)?s.context:null,l=v(s.metrics_window)?s.metrics_window:void 0,c=r(s.name);if(!c)return null;const p=d(s.context_ratio)??d(i==null?void 0:i.context_ratio),m=r(s.status)??r(a==null?void 0:a.status)??"offline",u=sl(m),_=r(s.model)??r(s.active_model)??r(s.primary_model),f=H(s.skill_secondary),h=i?{source:r(i.source),context_ratio:d(i.context_ratio),context_tokens:d(i.context_tokens),context_max:d(i.context_max),message_count:d(i.message_count),has_checkpoint:typeof i.has_checkpoint=="boolean"?i.has_checkpoint:void 0}:void 0,b=a?{name:r(a.name),exists:typeof a.exists=="boolean"?a.exists:void 0,error:r(a.error),agent_type:r(a.agent_type),status:r(a.status),current_task:r(a.current_task)??null,joined_at:r(a.joined_at),last_seen:r(a.last_seen),last_seen_ago_s:d(a.last_seen_ago_s),capabilities:H(a.capabilities),is_zombie:typeof a.is_zombie=="boolean"?a.is_zombie:void 0}:void 0,$=op(s.metrics_series),S={name:c,runtime_class:s.runtime_class==="persistent_agent"?"persistent_agent":"resident_keeper",desired:typeof s.desired=="boolean"?s.desired:void 0,resident_registered:typeof s.resident_registered=="boolean"?s.resident_registered:void 0,reconcile_status:r(s.reconcile_status)??null,emoji:r(s.emoji),koreanName:r(s.koreanName)??r(s.korean_name),agent_name:r(s.agent_name),trace_id:r(s.trace_id),model:_,primary_model:r(s.primary_model),active_model:r(s.active_model),next_model_hint:r(s.next_model_hint)??null,status:u,presence_keepalive:typeof s.presence_keepalive=="boolean"?s.presence_keepalive:void 0,presence_keepalive_sec:d(s.presence_keepalive_sec),keepalive_running:typeof s.keepalive_running=="boolean"?s.keepalive_running:void 0,proactive_enabled:typeof s.proactive_enabled=="boolean"?s.proactive_enabled:void 0,proactive_idle_sec:d(s.proactive_idle_sec),proactive_cooldown_sec:d(s.proactive_cooldown_sec),last_heartbeat:r(s.last_heartbeat)??r(a==null?void 0:a.last_seen),generation:d(s.generation),turn_count:d(s.turn_count)??d(s.total_turns),keeper_age_s:d(s.keeper_age_s),last_turn_ago_s:d(s.last_turn_ago_s),last_handoff_ago_s:d(s.last_handoff_ago_s),last_compaction_ago_s:d(s.last_compaction_ago_s),last_proactive_ago_s:d(s.last_proactive_ago_s),last_proactive_preview:r(s.last_proactive_preview)??null,context_ratio:p,context_tokens:d(s.context_tokens)??d(i==null?void 0:i.context_tokens),context_max:d(s.context_max)??d(i==null?void 0:i.context_max),context_source:r(s.context_source)??r(i==null?void 0:i.source),context:h,traits:H(s.traits),interests:H(s.interests),primaryValue:r(s.primaryValue)??r(s.primary_value),activityLevel:d(s.activityLevel)??d(s.activity_level),memory_recent_note:r(s.memory_recent_note)??null,recent_input_preview:r(s.recent_input_preview)??null,recent_output_preview:r(s.recent_output_preview)??null,recent_tool_names:H(s.recent_tool_names)??[],conversation_tail_count:d(s.conversation_tail_count),k2k_count:d(s.k2k_count),handoff_count_total:d(s.handoff_count_total)??d(s.trace_history_count),compaction_count:d(s.compaction_count),last_compaction_saved_tokens:d(s.last_compaction_saved_tokens),diagnostic:Oi(s.diagnostic),skill_primary:r(s.skill_primary)??null,skill_secondary:f,skill_reason:r(s.skill_reason)??null,metrics_series:$.length>0?$:void 0,metrics_window:l,agent:b};return S.diagnostic=Oi(s.diagnostic)??Ru(S,(t==null?void 0:t.lodge)??null),S}).filter(s=>s!==null)}function rp(e){if(!v(e))return;const t=r(e.release_version),n=ae(e.started_at),s=d(e.uptime_seconds);if(!(!t||!n||s==null))return{release_version:t,commit:r(e.commit)??null,started_at:n,uptime_seconds:s}}function lp(e){if(v(e))return{enabled:e.enabled===!0,alive:e.alive===!0,status:r(e.status)??void 0,tick_in_progress:typeof e.tick_in_progress=="boolean"?e.tick_in_progress:void 0,tick_count:d(e.tick_count)??void 0,check_interval_sec:d(e.check_interval_sec)??void 0,last_tick_started_at:ae(e.last_tick_started_at)??r(e.last_tick_started_at)??null,last_tick_completed_at:ae(e.last_tick_completed_at)??r(e.last_tick_completed_at)??null,next_tick_due_at:ae(e.next_tick_due_at)??r(e.next_tick_due_at)??null,last_health_check_at:ae(e.last_health_check_at)??r(e.last_health_check_at)??null,last_intervention:r(e.last_intervention)??void 0,last_decision_source:r(e.last_decision_source)??void 0,last_action:r(e.last_action)??void 0,last_target:r(e.last_target)??null,last_reason:r(e.last_reason)??null,last_error:r(e.last_error)??null,circuit_open:typeof e.circuit_open=="boolean"?e.circuit_open:void 0,circuit_open_until:ae(e.circuit_open_until)??r(e.circuit_open_until)??null,can_spawn:typeof e.can_spawn=="boolean"?e.can_spawn:void 0,can_retire:typeof e.can_retire=="boolean"?e.can_retire:void 0,last_spawn_attempt_at:ae(e.last_spawn_attempt_at)??r(e.last_spawn_attempt_at)??null,last_retirement_attempt_at:ae(e.last_retirement_attempt_at)??r(e.last_retirement_attempt_at)??null,spawns_today:d(e.spawns_today)??void 0,retirements_today:d(e.retirements_today)??void 0,health_summary:v(e.health_summary)?{total_agents:d(e.health_summary.total_agents)??void 0,active_agents:d(e.health_summary.active_agents)??void 0,idle_agents:d(e.health_summary.idle_agents)??void 0,todo_count:d(e.health_summary.todo_count)??void 0,high_priority_todo:d(e.health_summary.high_priority_todo)??void 0,orphan_count:d(e.health_summary.orphan_count)??void 0,homeostatic_score:d(e.health_summary.homeostatic_score)??void 0,needs_workers:typeof e.health_summary.needs_workers=="boolean"?e.health_summary.needs_workers:void 0}:void 0}}function cp(e){if(v(e))return{enabled:e.enabled===!0,mode:r(e.mode)??void 0,masc_enabled:typeof e.masc_enabled=="boolean"?e.masc_enabled:void 0,masc_loops_running:typeof e.masc_loops_running=="boolean"?e.masc_loops_running:void 0,runtime_owner:r(e.runtime_owner)??null,zombie_loop_running:typeof e.zombie_loop_running=="boolean"?e.zombie_loop_running:void 0,gc_loop_running:typeof e.gc_loop_running=="boolean"?e.gc_loop_running:void 0,lodge_enabled:typeof e.lodge_enabled=="boolean"?e.lodge_enabled:void 0,lodge_loop_started:typeof e.lodge_loop_started=="boolean"?e.lodge_loop_started:void 0,lodge_running:typeof e.lodge_running=="boolean"?e.lodge_running:void 0,last_zombie_cleanup:ae(e.last_zombie_cleanup)??r(e.last_zombie_cleanup)??null,last_gc:ae(e.last_gc)??r(e.last_gc)??null,last_lodge:ae(e.last_lodge)??r(e.last_lodge)??null,last_zombie_result:r(e.last_zombie_result)??null,last_gc_result:r(e.last_gc_result)??null,last_lodge_result:v(e.last_lodge_result)?{ok:typeof e.last_lodge_result.ok=="boolean"?e.last_lodge_result.ok:void 0,message:r(e.last_lodge_result.message)??void 0}:null}}function dp(e){if(v(e))return{enabled:e.enabled===!0,started:e.started===!0,agent_name:r(e.agent_name)??null,llm_enabled:typeof e.llm_enabled=="boolean"?e.llm_enabled:void 0,uptime_s:d(e.uptime_s)??void 0,embedded_guardian_loops_running:typeof e.embedded_guardian_loops_running=="boolean"?e.embedded_guardian_loops_running:void 0,guardian_runtime_owner:r(e.guardian_runtime_owner)??null,consumers:H(e.consumers)}}function al(e,t){return v(e)?{...e,generated_at:t??ae(e.generated_at)??void 0,build:rp(e.build),lodge:Cu(e.lodge)??void 0,gardener:lp(e.gardener)??void 0,guardian:cp(e.guardian)??void 0,sentinel:dp(e.sentinel)??void 0}:null}function ol(e,t){return t?e?{...e,...t,build:t.build??e.build,generated_at:t.generated_at??e.generated_at}:t:e}function up(e){const t=typeof e=="string"?e.toLowerCase():"";return t==="running"||t==="interrupted"||t==="completed"||t==="stopped"||t==="error"?t:t.startsWith("error")?"error":"running"}function pp(e){if(!v(e))return null;const t=d(e.iteration);if(t==null)return null;const n=d(e.metric_before)??0,s=d(e.metric_after)??n,a=v(e.evidence)?e.evidence:null;return{iteration:t,metric_before:n,metric_after:s,delta:d(e.delta)??s-n,changes:r(e.changes)??"",failed_attempts:r(e.failed_attempts)??"",next_suggestion:r(e.next_suggestion)??"",elapsed_ms:d(e.elapsed_ms)??0,cost_usd:d(e.cost_usd)??null,evidence:a?{worker_engine:(a.worker_engine==="api_tool_loop","api_tool_loop"),worker_model:r(a.worker_model)??"",tool_call_count:d(a.tool_call_count)??0,tool_names:H(a.tool_names)??[],session_id:r(a.session_id)??"",evidence_status:a.evidence_status==="legacy_unverified"?"legacy_unverified":"verified"}:null}}function mp(e){var i,l;if(!v(e))return null;const t=r(e.loop_id);if(!t)return null;const n=d(e.baseline_metric)??0,s=Array.isArray(e.history)?e.history.map(pp).filter(c=>c!==null):[],a=d(e.current_metric)??((i=s[0])==null?void 0:i.metric_after)??n;return{loop_id:t,profile:r(e.profile)??"unknown",status:up(e.status),strict_mode:typeof e.strict_mode=="boolean"?e.strict_mode:void 0,error_message:r(e.error_message)??r(e.error_reason)??null,stop_reason:r(e.stop_reason)??r(e.reason)??null,current_iteration:d(e.current_iteration)??((l=s[0])==null?void 0:l.iteration)??0,max_iterations:d(e.max_iterations)??0,baseline_metric:n,current_metric:a,target:r(e.target)??"",stagnation_streak:d(e.stagnation_streak)??0,stagnation_limit:d(e.stagnation_limit)??0,elapsed_seconds:d(e.elapsed_seconds)??0,updated_at:ae(e.updated_at)??null,stopped_at:ae(e.stopped_at)??null,execution_mode:e.execution_mode==="worker_spawn"?"worker_spawn":void 0,worker_engine:e.worker_engine==="api_tool_loop"?"api_tool_loop":null,worker_model:r(e.worker_model)??null,evidence_policy:e.evidence_policy==="hard"||e.evidence_policy==="legacy"?e.evidence_policy:void 0,latest_tool_call_count:d(e.latest_tool_call_count)??0,latest_tool_names:H(e.latest_tool_names)??[],session_id:r(e.session_id)??null,evidence_status:e.evidence_status==="legacy_unverified"?"legacy_unverified":e.evidence_status==="verified"?"verified":null,durability:e.durability==="persistent_backend"||e.durability==="memory_only"?e.durability:void 0,persistence_backend:e.persistence_backend==="filesystem"||e.persistence_backend==="postgres"||e.persistence_backend==="memory"?e.persistence_backend:void 0,recoverable:typeof e.recoverable=="boolean"?e.recoverable:void 0,history:s}}async function Yn(){So.value=!0;try{await Promise.all([rl(),kt()]),el.value=new Date().toISOString()}catch(e){console.error("Dashboard refresh error:",e)}finally{So.value=!1}}async function il(){Hs.value=!0,Ws.value=null;try{const e=await hd();Yo.value=e,Uu.value=new Date().toISOString()}catch(e){Ws.value=e instanceof Error?e.message:"Failed to load dashboard semantics"}finally{Hs.value=!1}}function vp(e){var t;return((t=Yo.value)==null?void 0:t.surfaces.find(n=>n.id===e))??null}function _p(e){var n;const t=((n=Yo.value)==null?void 0:n.surfaces)??[];for(const s of t){const a=s.panels.find(i=>i.id===e);if(a)return a}return null}function gp(e){var s,a;Ht.value=(Array.isArray(e.goals)?e.goals:[]).map(i=>{if(!v(i))return null;const l=r(i.id),c=r(i.title),p=r(i.horizon),m=r(i.status),u=r(i.created_at),_=r(i.updated_at);return!l||!c||!p||!m||!u||!_?null:{id:l,horizon:p,title:c,metric:r(i.metric)??null,target_value:r(i.target_value)??null,due_date:r(i.due_date)??null,priority:d(i.priority)??3,status:m,parent_goal_id:r(i.parent_goal_id)??null,last_review_note:r(i.last_review_note)??null,last_review_at:r(i.last_review_at)??null,created_at:u,updated_at:_}}).filter(i=>i!==null);const t=new Map,n=Array.isArray((s=e.mdal)==null?void 0:s.loops)?e.mdal.loops:[];for(const i of n){const l=mp(i);l&&t.set(l.loop_id,l)}Zr.value=t,Wt.value=typeof((a=e.mdal)==null?void 0:a.error)=="string"?e.mdal.error:null,Qo.value=Wt.value?"error":t.size===0?"idle":"ready"}async function rl(){try{const e=await _d(),t=al(e.status,e.generated_at);t&&(te.value=ol(te.value,t))}catch(e){console.error("Dashboard shell fetch error:",e)}}async function kt(){var e;try{const t=await gd(),n=al(t.status,t.generated_at),s=(e=te.value)==null?void 0:e.room;n&&(te.value=ol(te.value,n));const a=s!=null&&(n==null?void 0:n.room)!=null&&s!==n.room;He.value=(Array.isArray(t.agents)?t.agents:[]).map(Qu).filter(l=>l!==null),Xe.value=(Array.isArray(t.tasks)?t.tasks:[]).map(Yu).filter(l=>l!==null);const i=(Array.isArray(t.messages)?t.messages:[]).map(Xu).filter(l=>l!==null);ko.value=a?i:ap(ko.value,i),dt.value=ip(t.keepers,n??te.value),Hr.value=Zu(t.summary),Wr.value=(Array.isArray(t.execution_queue)?t.execution_queue:Array.isArray(t.priority_queue)?t.priority_queue:[]).map(ep).filter(l=>l!==null),Gr.value=(Array.isArray(t.session_briefs)?t.session_briefs:[]).map(tp).filter(l=>l!==null),Jr.value=(Array.isArray(t.operation_briefs)?t.operation_briefs:[]).map(np).filter(l=>l!==null),Vr.value=(Array.isArray(t.worker_support_briefs)?t.worker_support_briefs:Array.isArray(t.worker_briefs)?t.worker_briefs:[]).map(wi).filter(l=>l!==null),Qr.value=(Array.isArray(t.continuity_briefs)?t.continuity_briefs:[]).map(sp).filter(l=>l!==null),Yr.value=(Array.isArray(t.offline_worker_briefs)?t.offline_worker_briefs:[]).map(wi).filter(l=>l!==null),Fu.value=null,el.value=new Date().toISOString()}catch(t){console.error("Dashboard execution fetch error:",t)}}async function et(){zn.value=!0;try{const e=await fd(Ln.value,{excludeSystem:bt.value});Ra.value=e.posts??[],Co.value=new Date().toISOString()}catch(e){console.error("Board fetch error:",e)}finally{zn.value=!1}}async function tt(){var e;Ao.value=!0;try{const t=Ke.value||((e=te.value)==null?void 0:e.room)||"default";Ke.value||(Ke.value=t);const n=await au(t);Xr.value=n}catch(t){console.error("TRPG fetch error:",t)}finally{Ao.value=!1}}async function Zo(){yn.value=!0,bn.value=!0;try{const e=await Sd();gp(e),Ku.value=new Date().toISOString(),Bu.value=new Date().toISOString()}catch(e){console.error("Planning fetch error:",e),Qo.value="error",Wt.value=e instanceof Error?e.message:String(e)}finally{yn.value=!1,bn.value=!1}}async function ll(){return Zo()}let Ps=null;function fp(e){Ps=e}let Ls=null;function $p(e){Ls=e}let zs=null;function hp(e){zs=e}const xt={};let Oa=null;function ft(e,t,n=500){xt[e]&&clearTimeout(xt[e]),xt[e]=setTimeout(()=>{t(),delete xt[e]},n)}function yp(){const e=Ir.subscribe(t=>{if(t){if(t.type==="keeper_heartbeat"&&t.name){const n=new Map(xo.value);n.set(t.name,t.ts_unix?t.ts_unix*1e3:Date.now()),xo.value=n;return}(t.type==="agent_joined"||t.type==="agent_left")&&ft("execution",kt),Ju(t.type)&&(Oa||(Oa=setTimeout(()=>{Yn(),Ls==null||Ls(),zs==null||zs(),Oa=null},500))),(t.type.startsWith("task_")||t.type.startsWith("masc/task_"))&&ft("execution",kt),t.type==="broadcast"&&ft("execution",kt),(t.type==="keeper_handoff"||t.type==="keeper_compaction"||t.type==="keeper_guardrail")&&ft("execution",kt),(t.type==="board_post"||t.type==="masc/board_post"||t.type==="board_comment"||t.type==="masc/board_comment")&&ft("board",et),t.type.startsWith("decision_")&&ft("council",()=>Ps==null?void 0:Ps()),(t.type==="mdal_started"||t.type==="mdal_iteration"||t.type==="mdal_completed"||t.type==="mdal_stopped")&&ft("mdal",ll,350)}});return()=>{e();for(const t of Object.keys(xt))clearTimeout(xt[t]),delete xt[t]}}let kn=null;function bp(){kn||(kn=setInterval(()=>{ot.value,Yn()},1e4))}function kp(){kn&&(clearInterval(kn),kn=null)}const _e=g(null),ei=g(null),je=g(null),Mn=g(!1),it=g(null),Nn=g(!1),nn=g(null),W=g(!1),Gs=g([]);let xp=1;function Sp(e){return v(e)?{id:r(e.id),seq:d(e.seq),from:r(e.from)??r(e.from_agent)??"system",content:r(e.content)??"",timestamp:r(e.timestamp)??new Date().toISOString(),type:r(e.type)}:null}function Ap(e){return v(e)?{room_id:r(e.room_id),current_room:r(e.current_room)??r(e.room),project:r(e.project),cluster:r(e.cluster),paused:j(e.paused),pause_reason:r(e.pause_reason)??null,paused_by:r(e.paused_by)??null,paused_at:r(e.paused_at)??null}:{}}function qi(e){if(!v(e))return;const t=Object.entries(e).map(([n,s])=>{const a=r(s);return a?[n,a]:null}).filter(n=>n!==null);return t.length>0?Object.fromEntries(t):void 0}function cl(e){if(!v(e))return null;const t=r(e.kind),n=r(e.summary),s=r(e.target_type);return!t||!n||!s?null:{kind:t,severity:r(e.severity)??"warn",summary:n,target_type:s,target_id:r(e.target_id)??null,actor:r(e.actor)??null,evidence:e.evidence}}function xn(e){if(!v(e))return null;const t=r(e.action_type),n=r(e.target_type),s=r(e.reason);return!t||!n||!s?null:{action_type:t,target_type:n,target_id:r(e.target_id)??null,severity:r(e.severity)??"warn",reason:s,confirm_required:j(e.confirm_required),suggested_payload:e.suggested_payload,preview:e.preview}}function dl(e){return v(e)?{enabled:j(e.enabled),judge_online:j(e.judge_online),refreshing:j(e.refreshing),generated_at:r(e.generated_at)??null,expires_at:r(e.expires_at)??null,model_used:r(e.model_used)??null,keeper_name:r(e.keeper_name)??null,last_error:r(e.last_error)??null}:null}function qa(e){return v(e)?{summary:r(e.summary)??null,confidence:d(e.confidence)??null,provenance:r(e.provenance)??null,authoritative:j(e.authoritative),surface:r(e.surface)??null,fresh_until:r(e.fresh_until)??null,keeper_name:r(e.keeper_name)??null,fallback_used:j(e.fallback_used),disagreement_with_truth:j(e.disagreement_with_truth)}:null}function Cp(e){return v(e)?{judgment_id:r(e.judgment_id)??void 0,surface:r(e.surface)??null,target_type:r(e.target_type)??null,target_id:r(e.target_id)??null,status:r(e.status)??null,summary:r(e.summary)??null,confidence:d(e.confidence)??null,generated_at:r(e.generated_at)??null,fresh_until:r(e.fresh_until)??null,keeper_name:r(e.keeper_name)??null,model_name:r(e.model_name)??null,runtime_name:r(e.runtime_name)??null,evidence_refs:H(e.evidence_refs),recommended_action:xn(e.recommended_action),supersedes:H(e.supersedes),fallback_used:j(e.fallback_used),disagreement_with_truth:j(e.disagreement_with_truth),provenance:r(e.provenance)??null}:null}function Ip(e){return v(e)?{actor:r(e.actor)??null,spawn_agent:r(e.spawn_agent)??null,spawn_role:r(e.spawn_role)??null,spawn_model:r(e.spawn_model)??null,worker_class:r(e.worker_class)??null,parent_actor:r(e.parent_actor)??null,capsule_mode:r(e.capsule_mode)??null,runtime_pool:r(e.runtime_pool)??null,lane_id:r(e.lane_id)??null,controller_level:r(e.controller_level)??null,control_domain:r(e.control_domain)??null,supervisor_actor:r(e.supervisor_actor)??null,model_tier:r(e.model_tier)??null,task_profile:r(e.task_profile)??null,risk_level:r(e.risk_level)??null,routing_confidence:d(e.routing_confidence)??null,routing_reason:r(e.routing_reason)??null,status:r(e.status)??"unknown",turn_count:d(e.turn_count)??0,empty_note_turn_count:d(e.empty_note_turn_count)??0,has_turn:j(e.has_turn)??!1,last_turn_ts_iso:r(e.last_turn_ts_iso)??null}:null}function Tp(e){if(!v(e))return null;const t=r(e.session_id);return t?{session_id:t,goal:r(e.goal),status:r(e.status),health:r(e.health),scale_profile:r(e.scale_profile),control_profile:r(e.control_profile),planned_worker_count:d(e.planned_worker_count),active_agent_count:d(e.active_agent_count),last_turn_age_sec:d(e.last_turn_age_sec)??null,attention_count:d(e.attention_count),recommended_action_count:d(e.recommended_action_count),top_attention:cl(e.top_attention),top_recommendation:xn(e.top_recommendation)}:null}function ul(e){const t=v(e)?e:{};return{trace_id:r(t.trace_id),target_type:r(t.target_type)??"room",target_id:r(t.target_id)??null,health:r(t.health),judgment_owner:r(t.judgment_owner)??null,authoritative_judgment_available:j(t.authoritative_judgment_available),resident_judge_runtime:dl(t.resident_judge_runtime),judgment:Cp(t.judgment),active_guidance_layer:r(t.active_guidance_layer)??null,active_summary:qa(t.active_summary),active_recommended_actions:pe(t.active_recommended_actions).map(xn).filter(n=>n!==null),active_recommendation_source:r(t.active_recommendation_source)??null,active_recommendation_summary:qa(t.active_recommendation_summary),fallback_recommended_actions:pe(t.fallback_recommended_actions).map(xn).filter(n=>n!==null),recommendation_summary:qa(t.recommendation_summary),swarm_status:v(t.swarm_status)?t.swarm_status:void 0,attention_items:pe(t.attention_items).map(cl).filter(n=>n!==null),recommended_actions:pe(t.recommended_actions).map(xn).filter(n=>n!==null),session_cards:pe(t.session_cards).map(Tp).filter(n=>n!==null),worker_cards:pe(t.worker_cards).map(Ip).filter(n=>n!==null)}}function Rp(e){if(!v(e))return null;const t=v(e.status)?e.status:void 0,n=v(e.summary)?e.summary:v(t==null?void 0:t.summary)?t.summary:void 0,s=v(e.session)?e.session:v(t==null?void 0:t.session)?t.session:void 0,a=r(e.session_id)??r(n==null?void 0:n.session_id)??r(s==null?void 0:s.session_id);if(!a)return null;const i=qi(e.report_paths)??qi(t==null?void 0:t.report_paths),l=pe(e.recent_events,["events"]).filter(v);return{session_id:a,status:r(e.status)??r(n==null?void 0:n.status)??r(s==null?void 0:s.status),progress_pct:d(e.progress_pct)??d(n==null?void 0:n.progress_pct),elapsed_sec:d(e.elapsed_sec)??d(n==null?void 0:n.elapsed_sec),remaining_sec:d(e.remaining_sec)??d(n==null?void 0:n.remaining_sec),done_delta_total:d(e.done_delta_total)??d(n==null?void 0:n.done_delta_total),summary:n,team_health:v(e.team_health)?e.team_health:v(t==null?void 0:t.team_health)?t.team_health:void 0,communication_metrics:v(e.communication_metrics)?e.communication_metrics:v(t==null?void 0:t.communication_metrics)?t.communication_metrics:void 0,orchestration_state:v(e.orchestration_state)?e.orchestration_state:v(t==null?void 0:t.orchestration_state)?t.orchestration_state:void 0,cascade_metrics:v(e.cascade_metrics)?e.cascade_metrics:v(t==null?void 0:t.cascade_metrics)?t.cascade_metrics:void 0,report_paths:i,linked_autoresearch:v(e.linked_autoresearch)?e.linked_autoresearch:v(t==null?void 0:t.linked_autoresearch)?t.linked_autoresearch:void 0,session:s,recent_events:l}}function Fi(e){if(!v(e))return null;const t=r(e.name);if(!t)return null;const n=v(e.context)?e.context:void 0;return{name:t,runtime_class:e.runtime_class==="persistent_agent"?"persistent_agent":"resident_keeper",desired:j(e.desired),resident_registered:j(e.resident_registered),agent_name:r(e.agent_name),status:r(e.status),autonomy_level:r(e.autonomy_level),context_ratio:d(e.context_ratio)??d(n==null?void 0:n.context_ratio),generation:d(e.generation),active_goal_ids:H(e.active_goal_ids),last_autonomous_action_at:r(e.last_autonomous_action_at)??null,last_turn_ago_s:d(e.last_turn_ago_s),model:r(e.model)??r(e.active_model)??r(e.primary_model)}}function Pp(e){if(!v(e))return null;const t=r(e.confirm_token)??r(e.token);return t?{confirm_token:t,actor:r(e.actor),action_type:r(e.action_type),target_type:r(e.target_type),target_id:r(e.target_id)??null,delegated_tool:r(e.delegated_tool),created_at:r(e.created_at),preview:e.preview}:null}function pl(e){if(!v(e))return null;const t=r(e.action_type),n=r(e.target_type);return!t||!n?null:{action_type:t,target_type:n,description:r(e.description),confirm_required:j(e.confirm_required)}}function Lp(e){return v(e)?{actor_filter:r(e.actor_filter)??null,filter_active:j(e.filter_active)??!1,visible_count:d(e.visible_count)??0,total_count:d(e.total_count)??0,hidden_count:d(e.hidden_count)??0,hidden_actors:H(e.hidden_actors),confirm_required_actions:pe(e.confirm_required_actions).map(pl).filter(t=>t!==null)}:null}function zp(e){const t=v(e)?e:{};return{room:Ap(t.room),sessions:pe(t.sessions,["items","sessions"]).map(Rp).filter(n=>n!==null),keepers:pe(t.keepers,["items","keepers"]).map(Fi).filter(n=>n!==null),resident_judge_runtime:dl(t.resident_judge_runtime),persistent_agents:pe(t.persistent_agents,["items","persistent_agents"]).map(Fi).filter(n=>n!==null),recent_messages:pe(t.recent_messages,["messages"]).map(Sp).filter(n=>n!==null),pending_confirms:pe(t.pending_confirms,["items","confirms"]).map(Pp).filter(n=>n!==null),pending_confirm_summary:Lp(t.pending_confirm_summary)??void 0,available_actions:pe(t.available_actions,["actions"]).map(pl).filter(n=>n!==null)}}function vs(e){if(typeof e=="string")return e;if(e==null)return"";try{return JSON.stringify(e)}catch{return String(e)}}function Ki(e){return e.target_id?`${e.target_type}:${e.target_id}`:e.target_type}function Js(e){Gs.value=[{...e,id:xp++,at:new Date().toISOString()},...Gs.value].slice(0,20)}function ml(e){return e.confirm_required?vs(e.preview)||"Confirmation required":vs(e.result)||vs(e.executed_action)||vs(e.delegated_tool_result)||e.status}async function ye(){Mn.value=!0,it.value=null;try{const e=await Cd();_e.value=zp(e)}catch(e){it.value=e instanceof Error?e.message:"Failed to load operator snapshot"}finally{Mn.value=!1}}async function Tt(){Nn.value=!0,nn.value=null;try{const e=await Mr({targetType:"room"});ei.value=ul(e)}catch(e){nn.value=e instanceof Error?e.message:"Failed to load operator digest"}finally{Nn.value=!1}}async function sn(e){if(!e){je.value=null;return}Nn.value=!0,nn.value=null;try{const t=await Mr({targetType:"team_session",targetId:e,includeWorkers:!0});je.value=ul(t)}catch(t){nn.value=t instanceof Error?t.message:"Failed to load session digest"}finally{Nn.value=!1}}async function vl(e){var t;W.value=!0,it.value=null;try{const n=await Ia(e);return Js({actor:e.actor,action_type:e.action_type,target_label:Ki(e),outcome:n.confirm_required?"preview":"executed",message:ml(n),delegated_tool:n.delegated_tool}),await ye(),await Tt(),(t=je.value)!=null&&t.target_id&&await sn(je.value.target_id),n}catch(n){const s=n instanceof Error?n.message:"Operator action failed";throw it.value=s,Js({actor:e.actor,action_type:e.action_type,target_label:Ki(e),outcome:"error",message:s}),n}finally{W.value=!1}}async function _l(e,t,n="confirm"){var s;W.value=!0,it.value=null;try{const a=await Nr(e,t,n);return Js({actor:e,action_type:n,target_label:t,outcome:"confirmed",message:ml(a),delegated_tool:a.delegated_tool}),await ye(),await Tt(),(s=je.value)!=null&&s.target_id&&await sn(je.value.target_id),a}catch(a){const i=a instanceof Error?a.message:"Operator confirmation failed";throw it.value=i,Js({actor:e,action_type:"confirm",target_label:t,outcome:"error",message:i}),a}finally{W.value=!1}}hp(()=>{var e;ye(),Tt(),(e=je.value)!=null&&e.target_id&&sn(je.value.target_id)});const Xn=g(null),Io=g(!1),Vs=g(null),gl=g(null),wt=g(!1),yt=g(null),To=g(null),Ms=g(!1),Ns=g(null);let Gt=null;function Bi(){Gt!==null&&(window.clearTimeout(Gt),Gt=null)}function Mp(e=1500){Gt===null&&(Gt=window.setTimeout(()=>{Gt=null,Qs(!1)},e))}function w(e){return typeof e=="object"&&e!==null&&!Array.isArray(e)}function y(e){return typeof e=="string"&&e.trim()!==""?e:void 0}function D(e){return typeof e=="number"&&Number.isFinite(e)?e:void 0}function Jt(e){return typeof e=="boolean"?e:void 0}function U(e,t=[]){if(Array.isArray(e))return e;if(!w(e))return[];for(const n of t){const s=e[n];if(Array.isArray(s))return s}return[]}function cn(e){if(!w(e))return null;const t=y(e.kind),n=y(e.summary),s=y(e.target_type);return!t||!n||!s?null:{kind:t,severity:y(e.severity)??"warn",summary:n,target_type:s,target_id:y(e.target_id)??null,actor:y(e.actor)??null,evidence:e.evidence}}function Rt(e){if(!w(e))return null;const t=y(e.action_type),n=y(e.target_type),s=y(e.reason);return!t||!n||!s?null:{action_type:t,target_type:n,target_id:y(e.target_id)??null,severity:y(e.severity)??"warn",reason:s,confirm_required:Jt(e.confirm_required),suggested_payload:e.suggested_payload,preview:e.preview}}function Np(e){if(!w(e))return null;const t=y(e.session_id);return t?{session_id:t,goal:y(e.goal),status:y(e.status),health:y(e.health),scale_profile:y(e.scale_profile),control_profile:y(e.control_profile),planned_worker_count:D(e.planned_worker_count),active_agent_count:D(e.active_agent_count),last_turn_age_sec:D(e.last_turn_age_sec)??null,attention_count:D(e.attention_count),recommended_action_count:D(e.recommended_action_count),top_attention:cn(e.top_attention),top_recommendation:Rt(e.top_recommendation)}:null}function Ep(e){if(!w(e))return null;const t=y(e.session_id);if(!t)return null;const n=w(e.status)?e.status:e,s=w(n.summary)?n.summary:void 0;return{session_id:t,status:y(e.status)??y(s==null?void 0:s.status)??(w(n.session)?y(n.session.status):void 0),progress_pct:D(e.progress_pct)??D(s==null?void 0:s.progress_pct),elapsed_sec:D(e.elapsed_sec)??D(s==null?void 0:s.elapsed_sec),remaining_sec:D(e.remaining_sec)??D(s==null?void 0:s.remaining_sec),done_delta_total:D(e.done_delta_total)??D(s==null?void 0:s.done_delta_total),summary:w(e.summary)?e.summary:s,team_health:w(e.team_health)?e.team_health:w(n.team_health)?n.team_health:void 0,communication_metrics:w(e.communication_metrics)?e.communication_metrics:w(n.communication_metrics)?n.communication_metrics:void 0,orchestration_state:w(e.orchestration_state)?e.orchestration_state:w(n.orchestration_state)?n.orchestration_state:void 0,cascade_metrics:w(e.cascade_metrics)?e.cascade_metrics:w(n.cascade_metrics)?n.cascade_metrics:void 0,report_paths:w(e.report_paths)?Object.fromEntries(Object.entries(e.report_paths).map(([a,i])=>{const l=y(i);return l?[a,l]:null}).filter(a=>a!==null)):w(n.report_paths)?Object.fromEntries(Object.entries(n.report_paths).map(([a,i])=>{const l=y(i);return l?[a,l]:null}).filter(a=>a!==null)):void 0,session:w(e.session)?e.session:w(n.session)?n.session:void 0,recent_events:U(e.recent_events,["events"]).filter(w)}}function jp(e){if(!w(e))return null;const t=y(e.name);return t?{name:t,agent_name:y(e.agent_name),status:y(e.status),autonomy_level:y(e.autonomy_level),context_ratio:D(e.context_ratio),generation:D(e.generation),active_goal_ids:U(e.active_goal_ids).map(n=>typeof n=="string"?n.trim():"").filter(Boolean),last_autonomous_action_at:y(e.last_autonomous_action_at)??null,last_turn_ago_s:D(e.last_turn_ago_s),model:y(e.model)}:null}function wp(e){if(!w(e))return null;const t=y(e.confirm_token)??y(e.token);return t?{confirm_token:t,actor:y(e.actor),action_type:y(e.action_type),target_type:y(e.target_type),target_id:y(e.target_id)??null,delegated_tool:y(e.delegated_tool),created_at:y(e.created_at),preview:e.preview}:null}function Dp(e){if(!w(e))return null;const t=y(e.action_type),n=y(e.target_type);return!t||!n?null:{action_type:t,target_type:n,description:y(e.description),confirm_required:Jt(e.confirm_required)}}function Op(e){const t=w(e)?e:{};return{room_health:y(t.room_health),cluster:y(t.cluster),project:y(t.project),current_room:y(t.current_room)??null,paused:Jt(t.paused),tempo_interval_s:D(t.tempo_interval_s),active_agents:D(t.active_agents),keeper_pressure:D(t.keeper_pressure),active_operations:D(t.active_operations),pending_approvals:D(t.pending_approvals),incident_count:D(t.incident_count),recommended_action_count:D(t.recommended_action_count),top_attention:cn(t.top_attention),top_action:Rt(t.top_action)}}function qp(e){const t=w(e)?e:{},n=w(t.swarm_overview)?t.swarm_overview:{};return{health:y(t.health),active_operations:D(t.active_operations),pending_approvals:D(t.pending_approvals),swarm_overview:{active_lanes:D(n.active_lanes),moving_lanes:D(n.moving_lanes),stalled_lanes:D(n.stalled_lanes),projected_lanes:D(n.projected_lanes),last_movement_at:y(n.last_movement_at)??null},top_attention:cn(t.top_attention),top_action:Rt(t.top_action),session_cards:U(t.session_cards).map(Np).filter(s=>s!==null)}}function Fp(e){const t=w(e)?e:{};return{sessions:U(t.sessions,["items"]).map(Ep).filter(n=>n!==null),keepers:U(t.keepers,["items"]).map(jp).filter(n=>n!==null),pending_confirms:U(t.pending_confirms).map(wp).filter(n=>n!==null),available_actions:U(t.available_actions).map(Dp).filter(n=>n!==null)}}function Kp(e){if(!w(e))return null;const t=y(e.id),n=y(e.kind),s=y(e.summary),a=y(e.target_type);return!t||!n||!s||!a?null:{id:t,kind:n,severity:y(e.severity)??"warn",summary:s,target_type:a,target_id:y(e.target_id)??null,top_action:Rt(e.top_action),related_session_ids:U(e.related_session_ids).map(i=>typeof i=="string"?i.trim():"").filter(Boolean),related_agent_names:U(e.related_agent_names).map(i=>typeof i=="string"?i.trim():"").filter(Boolean),evidence_preview:U(e.evidence_preview).map(i=>typeof i=="string"?i.trim():"").filter(Boolean),last_seen_at:y(e.last_seen_at)??null}}function fl(e){if(!w(e))return null;const t=y(e.session_id),n=y(e.goal);return!t||!n?null:{session_id:t,goal:n,room:y(e.room)??null,status:y(e.status),health:y(e.health),member_names:U(e.member_names).map(s=>typeof s=="string"?s.trim():"").filter(Boolean),started_at:y(e.started_at)??null,elapsed_sec:D(e.elapsed_sec)??null,operation_id:y(e.operation_id)??null,blocker_summary:y(e.blocker_summary)??null,last_event_at:y(e.last_event_at)??null,last_event_summary:y(e.last_event_summary)??null,communication_summary:y(e.communication_summary)??null,active_count:D(e.active_count),required_count:D(e.required_count),related_attention_count:D(e.related_attention_count)??0,top_attention:cn(e.top_attention),top_recommendation:Rt(e.top_recommendation)}}function $l(e){if(!w(e))return null;const t=y(e.agent_name);return t?{agent_name:t,status:y(e.status),current_work:y(e.current_work)??null,recent_input_preview:y(e.recent_input_preview)??null,recent_output_preview:y(e.recent_output_preview)??null,recent_tool_names:U(e.recent_tool_names).map(n=>typeof n=="string"?n.trim():"").filter(Boolean),last_activity_at:y(e.last_activity_at)??null}:null}function hl(e){if(!w(e))return null;const t=y(e.operation_id);return t?{operation_id:t,status:y(e.status),stage:y(e.stage)??null,detachment_status:y(e.detachment_status)??null,objective:y(e.objective)??null,updated_at:y(e.updated_at)??null}:null}function yl(e){if(!w(e))return null;const t=y(e.name);return t?{name:t,agent_name:y(e.agent_name)??null,status:y(e.status),generation:D(e.generation),context_ratio:D(e.context_ratio)??null,last_turn_ago_s:D(e.last_turn_ago_s)??null,current_work:y(e.current_work)??null}:null}function bl(e){const t=fl(e);return t?{...t,member_previews:U(w(e)?e.member_previews:void 0).map($l).filter(n=>n!==null),operation_badges:U(w(e)?e.operation_badges:void 0).map(hl).filter(n=>n!==null),keeper_refs:U(w(e)?e.keeper_refs:void 0).map(yl).filter(n=>n!==null)}:null}function Bp(e){if(!w(e))return null;const t=y(e.agent_name);return t?{agent_name:t,status:y(e.status),where:y(e.where)??null,with_whom:U(e.with_whom).map(n=>typeof n=="string"?n.trim():"").filter(Boolean),current_work:y(e.current_work)??null,related_session_id:y(e.related_session_id)??null,related_attention_count:D(e.related_attention_count)??0,last_activity_at:y(e.last_activity_at)??null,recent_output_preview:y(e.recent_output_preview)??null,recent_input_preview:y(e.recent_input_preview)??null,recent_event:y(e.recent_event)??null,recent_tool_names:U(e.recent_tool_names).map(n=>typeof n=="string"?n.trim():"").filter(Boolean),allowed_tool_names:U(e.allowed_tool_names).map(n=>typeof n=="string"?n.trim():"").filter(Boolean),latest_tool_names:U(e.latest_tool_names).map(n=>typeof n=="string"?n.trim():"").filter(Boolean),latest_tool_call_count:D(e.latest_tool_call_count)??null,tool_audit_source:y(e.tool_audit_source)??null,tool_audit_at:y(e.tool_audit_at)??null}:null}function Up(e){if(!w(e))return null;const t=y(e.name);return t?{name:t,agent_name:y(e.agent_name)??null,status:y(e.status),generation:D(e.generation),context_ratio:D(e.context_ratio)??null,last_turn_ago_s:D(e.last_turn_ago_s)??null,current_work:y(e.current_work)??null,last_autonomous_action_at:y(e.last_autonomous_action_at)??null,allowed_tool_names:U(e.allowed_tool_names).map(n=>typeof n=="string"?n.trim():"").filter(Boolean),latest_tool_names:U(e.latest_tool_names).map(n=>typeof n=="string"?n.trim():"").filter(Boolean),latest_tool_call_count:D(e.latest_tool_call_count)??null,tool_audit_source:y(e.tool_audit_source)??null,tool_audit_at:y(e.tool_audit_at)??null}:null}function Hp(e){if(!w(e))return null;const t=y(e.id),n=y(e.signal_type),s=y(e.summary),a=y(e.target_type);return!t||!n||!s||!a?null:{id:t,signal_type:n==="action"?"action":"attention",severity:y(e.severity)??"warn",summary:s,target_type:a,target_id:y(e.target_id)??null,attention:cn(e.attention),action:Rt(e.action)}}function Wp(e){const t=w(e)?e:{},n=U(t.session_briefs).map(fl).filter(a=>a!==null),s=U(t.sessions).map(bl).filter(a=>a!==null);return{generated_at:y(t.generated_at),summary:Op(t.summary),incidents:U(t.incidents).map(cn).filter(a=>a!==null),recommended_actions:U(t.recommended_actions).map(Rt).filter(a=>a!==null),command_focus:qp(t.command_focus),operator_targets:Fp(t.operator_targets),attention_queue:U(t.attention_queue).map(Kp).filter(a=>a!==null),sessions:s.length>0?s:n.map(a=>({...a,member_previews:[],operation_badges:[],keeper_refs:[]})),session_briefs:n,agent_briefs:U(t.agent_briefs).map(Bp).filter(a=>a!==null),keeper_briefs:U(t.keeper_briefs).map(Up).filter(a=>a!==null),internal_signals:U(t.internal_signals).map(Hp).filter(a=>a!==null)}}function Gp(e){if(!w(e))return null;const t=y(e.id),n=y(e.summary);return!t||!n?null:{id:t,timestamp:y(e.timestamp)??null,event_type:y(e.event_type),actor:y(e.actor)??null,summary:n}}function Jp(e){const t=w(e)?e:{};return{generated_at:y(t.generated_at),session_id:y(t.session_id)??"",session:bl(t.session),timeline:U(t.timeline).map(Gp).filter(n=>n!==null),participants:U(t.participants).map($l).filter(n=>n!==null),operations:U(t.operations).map(hl).filter(n=>n!==null),keepers:U(t.keepers).map(yl).filter(n=>n!==null),error:y(t.error)??null}}function Vp(e){if(!w(e))return null;const t=y(e.id),n=y(e.label),s=y(e.summary);if(!t||!n||!s)return null;const a=y(e.status)??"unclear";return{id:t,label:n,status:a==="ok"||a==="healthy"||a==="aligned"||a==="watch"||a==="risk"||a==="unclear"?a:"unclear",summary:s,signal_class:y(e.signal_class)==="metadata_gap"||y(e.signal_class)==="mixed"||y(e.signal_class)==="operational_risk"?y(e.signal_class):void 0,evidence_quality:y(e.evidence_quality)==="strong"||y(e.evidence_quality)==="partial"||y(e.evidence_quality)==="missing"?y(e.evidence_quality):void 0,evidence:U(e.evidence).map(l=>typeof l=="string"?l.trim():"").filter(Boolean)}}function Qp(e){if(!w(e))return null;const t=y(e.kind),n=y(e.summary),s=y(e.scope_type),a=y(e.severity);return!t||!n||!s||!a||s!=="session"&&s!=="keeper"&&s!=="agent"||a!=="info"&&a!=="watch"?null:{kind:t,summary:n,scope_type:s,scope_id:y(e.scope_id)??null,severity:a}}function Yp(e){const t=w(e)?e:{},n=w(t.basis)?t.basis:{},s=y(t.status)??"error",a=s==="ok"||s==="pending"||s==="unavailable"||s==="error"?s:"error";return{generated_at:y(t.generated_at),cached:Jt(t.cached),stale:Jt(t.stale),refreshing:Jt(t.refreshing),status:a,summary:y(t.summary)??null,model:y(t.model)??null,ttl_sec:D(t.ttl_sec),criteria:U(t.criteria).map(i=>typeof i=="string"?i.trim():"").filter(Boolean),basis:{current_room:y(n.current_room)??null,crew_count:D(n.crew_count),agent_count:D(n.agent_count),keeper_count:D(n.keeper_count)},metadata_gap_count:D(t.metadata_gap_count),metadata_gaps:U(t.metadata_gaps).map(Qp).filter(i=>i!==null),sections:U(t.sections).map(Vp).filter(i=>i!==null),error:y(t.error)??null,last_error:y(t.last_error)??null}}async function kl(){Io.value=!0,Vs.value=null;try{const e=await yd();Xn.value=Wp(e)}catch(e){Vs.value=e instanceof Error?e.message:"Failed to load mission snapshot"}finally{Io.value=!1}}async function Xp(e){if(!e){To.value=null,Ns.value=null,Ms.value=!1;return}Ms.value=!0,Ns.value=null;try{const t=await bd(e);To.value=Jp(t)}catch(t){Ns.value=t instanceof Error?t.message:"Failed to load session detail"}finally{Ms.value=!1}}async function Qs(e=!1){wt.value=!0,yt.value=null;try{const t=await kd(e),n=Yp(t);gl.value=n,n.refreshing||n.status==="pending"?Mp():Bi()}catch(t){yt.value=t instanceof Error?t.message:"Failed to load mission briefing",Bi()}finally{wt.value=!1}}const xl=g(null),Ro=g(!1),Dt=g(null);async function Sl(e,t){Ro.value=!0,Dt.value=null;try{xl.value=await xd(e,t)}catch(n){Dt.value=n instanceof Error?n.message:String(n)}finally{Ro.value=!1}}const ti=g(null),De=g(null),Ys=g(!1),Xs=g(!1),Zs=g(null),ea=g(null),Po=g(null),ta=g(null),G=g("warroom"),Zn=g(null),Lo=g(!1),na=g(null),Pt=g(null),sa=g(!1),aa=g(null),ni=g(null),zo=g(!1),oa=g(null),es=g(null),Mo=g(!1),ia=g(null),En=g(null),ra=g(!1),jn=g(null),Vt=g(null);let $n=null;function si(e){return e!=="summary"&&e!=="swarm"&&e!=="warroom"&&e!=="orchestra"}function Al(){if(typeof window>"u")return new URLSearchParams;const e=new URLSearchParams(window.location.search),t=window.location.hash.replace(/^#/,""),n=t.indexOf("?");return n>=0&&new URLSearchParams(t.slice(n+1)).forEach((a,i)=>{e.has(i)||e.set(i,a)}),e}function Cl(){const t=Al().get("run_id")??void 0;return t&&t.trim()!==""?t.trim():void 0}function Il(){const t=Al().get("operation_id")??void 0;return t&&t.trim()!==""?t.trim():void 0}function Zp(e){if(v(e))return{policy_class:r(e.policy_class),approval_class:r(e.approval_class),tool_allowlist:H(e.tool_allowlist),model_allowlist:H(e.model_allowlist),requires_human_for:H(e.requires_human_for),autonomy_level:r(e.autonomy_level),escalation_timeout_sec:d(e.escalation_timeout_sec),kill_switch:j(e.kill_switch),frozen:j(e.frozen)}}function em(e){if(v(e))return{headcount_cap:d(e.headcount_cap),active_operation_cap:d(e.active_operation_cap),max_cost_usd:d(e.max_cost_usd),max_tokens:d(e.max_tokens)}}function ai(e){if(!v(e))return null;const t=r(e.unit_id),n=r(e.label),s=r(e.kind);return!t||!n||!s?null:{unit_id:t,label:n,kind:s,parent_unit_id:r(e.parent_unit_id)??null,leader_id:r(e.leader_id)??null,roster:H(e.roster),capability_profile:H(e.capability_profile),source:r(e.source),created_at:r(e.created_at),updated_at:r(e.updated_at),policy:Zp(e.policy),budget:em(e.budget)}}function Tl(e){if(!v(e))return null;const t=ai(e.unit);return t?{unit:t,leader_status:r(e.leader_status),roster_total:d(e.roster_total),roster_live:d(e.roster_live),active_operation_count:d(e.active_operation_count),health:r(e.health),reasons:H(e.reasons),children:Array.isArray(e.children)?e.children.map(Tl).filter(n=>n!==null):[]}:null}function tm(e){if(v(e))return{total_units:d(e.total_units),company_count:d(e.company_count),platoon_count:d(e.platoon_count),squad_count:d(e.squad_count),leaf_agent_unit_count:d(e.leaf_agent_unit_count),live_agent_count:d(e.live_agent_count),managed_unit_count:d(e.managed_unit_count),active_operation_count:d(e.active_operation_count)}}function Rl(e){const t=v(e)?e:{};return{version:r(t.version),generated_at:r(t.generated_at),source:r(t.source),summary:tm(t.summary),units:Array.isArray(t.units)?t.units.map(Tl).filter(n=>n!==null):[]}}function nm(e){if(!v(e))return null;const t=r(e.kind),n=r(e.status);return!t||!n?null:{kind:t,chain_id:r(e.chain_id)??null,goal:r(e.goal)??null,run_id:r(e.run_id)??null,status:n,viewer_path:r(e.viewer_path)??null,last_sync_at:r(e.last_sync_at)??null}}function Pa(e){if(!v(e))return null;const t=r(e.operation_id),n=r(e.objective),s=r(e.assigned_unit_id),a=r(e.trace_id),i=r(e.status);return!t||!n||!s||!a||!i?null:{operation_id:t,objective:n,assigned_unit_id:s,autonomy_level:r(e.autonomy_level),policy_class:r(e.policy_class),budget_class:r(e.budget_class),detachment_session_id:r(e.detachment_session_id)??null,trace_id:a,checkpoint_ref:r(e.checkpoint_ref)??null,active_goal_ids:H(e.active_goal_ids),note:r(e.note)??null,created_by:r(e.created_by),source:r(e.source),status:i,chain:nm(e.chain),created_at:r(e.created_at),updated_at:r(e.updated_at)}}function sm(e){if(!v(e))return null;const t=Pa(e.operation);return t?{operation:t,assigned_unit_label:r(e.assigned_unit_label)}:null}function _n(e){if(v(e))return{tone:r(e.tone),pending_ops:d(e.pending_ops),blocked_ops:d(e.blocked_ops),in_flight_ops:d(e.in_flight_ops),pipeline_stalls:d(e.pipeline_stalls),bus_traffic:d(e.bus_traffic),l1_hit_rate:d(e.l1_hit_rate),invalidation_count:d(e.invalidation_count),current_pending:d(e.current_pending),current_in_flight:d(e.current_in_flight),cdb_wakeups:d(e.cdb_wakeups),total_stolen:d(e.total_stolen),avg_best_score:d(e.avg_best_score),avg_candidate_count:d(e.avg_candidate_count),best_first_operations:d(e.best_first_operations),active_sessions:d(e.active_sessions),commit_rate:d(e.commit_rate),total_speculations:d(e.total_speculations)}}function am(e){if(!v(e))return;const t=v(e.pipeline)?e.pipeline:void 0,n=v(e.cache)?e.cache:void 0,s=v(e.ooo)?e.ooo:void 0,a=v(e.speculative)?e.speculative:void 0,i=v(e.search_fabric)?e.search_fabric:void 0,l=v(e.signals)?e.signals:void 0;return{pipeline:t?{total_ops:d(t.total_ops),completed_ops:d(t.completed_ops),stalled_cycles:d(t.stalled_cycles),hazards_detected:d(t.hazards_detected),forwarding_used:d(t.forwarding_used),pipeline_flushes:d(t.pipeline_flushes),ipc:d(t.ipc)}:void 0,cache:n?{total_reads:d(n.total_reads),total_writes:d(n.total_writes),l1_hit_rate:d(n.l1_hit_rate),invalidation_count:d(n.invalidation_count),writeback_count:d(n.writeback_count),bus_traffic:d(n.bus_traffic)}:void 0,ooo:s?{agent_count:d(s.agent_count),total_added:d(s.total_added),total_issued:d(s.total_issued),total_completed:d(s.total_completed),total_stolen:d(s.total_stolen),cdb_wakeups:d(s.cdb_wakeups),stall_cycles:d(s.stall_cycles),global_cdb_events:d(s.global_cdb_events),current_pending:d(s.current_pending),current_in_flight:d(s.current_in_flight)}:void 0,speculative:a?{total_speculations:d(a.total_speculations),total_commits:d(a.total_commits),total_aborts:d(a.total_aborts),commit_rate:d(a.commit_rate),total_fast_calls:d(a.total_fast_calls),total_cost_usd:d(a.total_cost_usd),active_sessions:d(a.active_sessions)}:void 0,search_fabric:i?{total_operations:d(i.total_operations),best_first_operations:d(i.best_first_operations),legacy_operations:d(i.legacy_operations),blocked_operations:d(i.blocked_operations),ready_operations:d(i.ready_operations),research_pipeline_operations:d(i.research_pipeline_operations),avg_candidate_count:d(i.avg_candidate_count),avg_best_score:d(i.avg_best_score),top_stage:r(i.top_stage)??null}:void 0,signals:l?{issue_pressure:_n(l.issue_pressure),cache_contention:_n(l.cache_contention),scheduler_efficiency:_n(l.scheduler_efficiency),routing_confidence:_n(l.routing_confidence),speculative_posture:_n(l.speculative_posture)}:void 0}}function Pl(e){const t=v(e)?e:{},n=v(t.summary)?t.summary:void 0;return{version:r(t.version),generated_at:r(t.generated_at),summary:n?{total:d(n.total),active:d(n.active),paused:d(n.paused),managed:d(n.managed),projected:d(n.projected)}:void 0,microarch:am(t.microarch),operations:Array.isArray(t.operations)?t.operations.map(sm).filter(s=>s!==null):[]}}function Ll(e){if(!v(e))return null;const t=r(e.detachment_id),n=r(e.operation_id),s=r(e.assigned_unit_id);return!t||!n||!s?null:{detachment_id:t,operation_id:n,assigned_unit_id:s,leader_id:r(e.leader_id)??null,roster:H(e.roster),session_id:r(e.session_id)??null,checkpoint_ref:r(e.checkpoint_ref)??null,runtime_kind:r(e.runtime_kind)??null,runtime_ref:r(e.runtime_ref)??null,source:r(e.source),status:r(e.status),last_event_at:r(e.last_event_at)??null,last_progress_at:r(e.last_progress_at)??null,heartbeat_deadline:r(e.heartbeat_deadline)??null,created_at:r(e.created_at),updated_at:r(e.updated_at)}}function om(e){if(!v(e))return null;const t=Ll(e.detachment);return t?{detachment:t,assigned_unit_label:r(e.assigned_unit_label),operation:Pa(e.operation)}:null}function zl(e){const t=v(e)?e:{},n=v(t.summary)?t.summary:void 0;return{version:r(t.version),generated_at:r(t.generated_at),summary:n?{total:d(n.total),active:d(n.active),projected:d(n.projected)}:void 0,detachments:Array.isArray(t.detachments)?t.detachments.map(om).filter(s=>s!==null):[]}}function im(e){if(!v(e))return null;const t=r(e.decision_id),n=r(e.trace_id),s=r(e.requested_action),a=r(e.scope_type),i=r(e.scope_id);return!t||!n||!s||!a||!i?null:{decision_id:t,trace_id:n,requested_action:s,scope_type:a,scope_id:i,operation_id:r(e.operation_id)??null,target_unit_id:r(e.target_unit_id)??null,requested_by:r(e.requested_by),status:r(e.status),reason:r(e.reason)??null,source:r(e.source),detail:e.detail,created_at:r(e.created_at),decided_at:r(e.decided_at)??null,expires_at:r(e.expires_at)??null}}function Ml(e){const t=v(e)?e:{},n=v(t.summary)?t.summary:void 0;return{version:r(t.version),generated_at:r(t.generated_at),summary:n?{total:d(n.total),pending:d(n.pending),approved:d(n.approved),denied:d(n.denied)}:void 0,decisions:Array.isArray(t.decisions)?t.decisions.map(im).filter(s=>s!==null):[]}}function rm(e){if(!v(e))return null;const t=ai(e.unit);return t?{unit:t,roster_total:d(e.roster_total),roster_live:d(e.roster_live),headcount_cap:d(e.headcount_cap),active_operations:d(e.active_operations),active_operation_cap:d(e.active_operation_cap),utilization:d(e.utilization)}:null}function lm(e){const t=v(e)?e:{};return{version:r(t.version),generated_at:r(t.generated_at),capacity:Array.isArray(t.capacity)?t.capacity.map(rm).filter(n=>n!==null):[]}}function cm(e){if(!v(e))return null;const t=r(e.alert_id);return t?{alert_id:t,severity:r(e.severity),kind:r(e.kind),scope_type:r(e.scope_type),scope_id:r(e.scope_id),title:r(e.title),detail:r(e.detail),timestamp:r(e.timestamp)}:null}function Nl(e){const t=v(e)?e:{},n=v(t.summary)?t.summary:void 0;return{version:r(t.version),generated_at:r(t.generated_at),summary:n?{total:d(n.total),bad:d(n.bad),warn:d(n.warn)}:void 0,alerts:Array.isArray(t.alerts)?t.alerts.map(cm).filter(s=>s!==null):[]}}function El(e){if(!v(e))return null;const t=r(e.event_id),n=r(e.trace_id),s=r(e.event_type);return!t||!n||!s?null:{event_id:t,trace_id:n,event_type:s,operation_id:r(e.operation_id)??null,unit_id:r(e.unit_id)??null,actor:r(e.actor)??null,source:r(e.source),timestamp:r(e.timestamp),detail:e.detail}}function dm(e){const t=v(e)?e:{};return{version:r(t.version),generated_at:r(t.generated_at),events:Array.isArray(t.events)?t.events.map(El).filter(n=>n!==null):[]}}function um(e){if(!v(e))return null;const t=r(e.code),n=r(e.severity),s=r(e.summary);return!t||!n||!s?null:{code:t,severity:n,summary:s}}function pm(e){if(!v(e))return null;const t=r(e.lane_id),n=r(e.label),s=r(e.kind),a=r(e.phase),i=r(e.motion_state),l=r(e.source_of_truth),c=r(e.movement_reason),p=r(e.current_step);if(!t||!n||!s||!a||!i||!l||!c||!p)return null;const m=v(e.counts)?e.counts:{};return{lane_id:t,label:n,kind:s,present:j(e.present)??!1,phase:a,motion_state:i,source_of_truth:l,last_movement_at:r(e.last_movement_at)??null,movement_reason:c,current_step:p,blockers:H(e.blockers),counts:{operations:d(m.operations),detachments:d(m.detachments),workers:d(m.workers),approvals:d(m.approvals),alerts:d(m.alerts)},hard_flags:Array.isArray(e.hard_flags)?e.hard_flags.map(um).filter(u=>u!==null):[]}}function mm(e){if(!v(e))return null;const t=r(e.event_id),n=r(e.lane_id),s=r(e.kind),a=r(e.timestamp),i=r(e.title),l=r(e.detail),c=r(e.tone),p=r(e.source);return!t||!n||!s||!a||!i||!l||!c||!p?null:{event_id:t,lane_id:n,kind:s,timestamp:a,title:i,detail:l,tone:c,source:p}}function vm(e){if(!v(e))return null;const t=r(e.code),n=r(e.severity),s=r(e.summary);return!t||!n||!s?null:{code:t,severity:n,summary:s,lane_ids:H(e.lane_ids),count:d(e.count)??0}}function oi(e){if(!v(e))return;const t=v(e.overview)?e.overview:{},n=v(e.gaps)?e.gaps:{},s=v(e.recommended_next_action)?e.recommended_next_action:void 0;return{generated_at:r(e.generated_at),overview:{active_lanes:d(t.active_lanes),moving_lanes:d(t.moving_lanes),stalled_lanes:d(t.stalled_lanes),projected_lanes:d(t.projected_lanes),last_movement_at:r(t.last_movement_at)??null},lanes:Array.isArray(e.lanes)?e.lanes.map(pm).filter(a=>a!==null):[],timeline:Array.isArray(e.timeline)?e.timeline.map(mm).filter(a=>a!==null):[],gaps:{count:d(n.count),items:Array.isArray(n.items)?n.items.map(vm).filter(a=>a!==null):[]},recommended_next_action:s?{tool:r(s.tool)??"masc_operator_snapshot",label:r(s.label)??"Observe operator state",reason:r(s.reason)??"",lane_id:r(s.lane_id)??null}:void 0}}function jl(e){if(!v(e))return;const t=v(e.workers)?e.workers:{},n=j(e.pass);return{status:r(e.status)??"missing",source:r(e.source)??"none",run_id:r(e.run_id)??null,captured_at:r(e.captured_at)??null,...n!==void 0?{pass:n}:{},...d(e.peak_hot_slots)!=null?{peak_hot_slots:d(e.peak_hot_slots)}:{},...d(e.ctx_per_slot)!=null?{ctx_per_slot:d(e.ctx_per_slot)}:{},workers:{expected:d(t.expected),joined:d(t.joined),current_task_bound:d(t.current_task_bound),fresh_heartbeats:d(t.fresh_heartbeats),done:d(t.done),final:d(t.final)},artifact_ref:r(e.artifact_ref)??null,missing_reason:r(e.missing_reason)??null}}function _m(e){const t=v(e)?e:{};return{version:r(t.version),generated_at:r(t.generated_at),topology:Rl(t.topology),operations:Pl(t.operations),detachments:zl(t.detachments),alerts:Nl(t.alerts),decisions:Ml(t.decisions),capacity:lm(t.capacity),traces:dm(t.traces),swarm_status:oi(t.swarm_status)}}function gm(e){const t=v(e)?e:{},n=Rl(t.topology),s=Pl(t.operations),a=zl(t.detachments),i=Nl(t.alerts),l=Ml(t.decisions);return{version:r(t.version),generated_at:r(t.generated_at),topology:{version:n.version,generated_at:n.generated_at,source:n.source,summary:n.summary},operations:{version:s.version,generated_at:s.generated_at,summary:s.summary,microarch:s.microarch},detachments:{version:a.version,generated_at:a.generated_at,summary:a.summary},alerts:{version:i.version,generated_at:i.generated_at,summary:i.summary},decisions:{version:l.version,generated_at:l.generated_at,summary:l.summary},swarm_status:oi(t.swarm_status),swarm_proof:jl(t.swarm_proof)}}function fm(e){return v(e)?{chain_id:r(e.chain_id)??null,started_at:d(e.started_at)??null,progress:d(e.progress)??null,elapsed_sec:d(e.elapsed_sec)??null}:null}function wl(e){if(!v(e))return null;const t=r(e.event);return t?{event:t,chain_id:r(e.chain_id)??null,timestamp:r(e.timestamp)??null,duration_ms:d(e.duration_ms)??null,message:r(e.message)??null,tokens:d(e.tokens)??null}:null}function $m(e){if(!v(e))return null;const t=Pa(e.operation);return t?{operation:t,runtime:fm(e.runtime),history:wl(e.history),mermaid:r(e.mermaid)??null,preview_run:Dl(e.preview_run)}:null}function hm(e){const t=v(e)?e:{};return{status:r(t.status)??"disconnected",base_url:r(t.base_url)??null,message:r(t.message)??null}}function ym(e){const t=v(e)?e:{},n=v(t.summary)?t.summary:void 0;return{version:r(t.version),generated_at:r(t.generated_at),connection:hm(t.connection),summary:n?{linked_operations:d(n.linked_operations),active_chains:d(n.active_chains),running_operations:d(n.running_operations),recent_failures:d(n.recent_failures),last_history_event_at:r(n.last_history_event_at)??null}:void 0,operations:Array.isArray(t.operations)?t.operations.map($m).filter(s=>s!==null):[],recent_history:Array.isArray(t.recent_history)?t.recent_history.map(wl).filter(s=>s!==null):[]}}function bm(e){if(!v(e))return null;const t=r(e.id);return t?{id:t,type:r(e.type),status:r(e.status),duration_ms:d(e.duration_ms)??null,error:r(e.error)??null}:null}function Dl(e){if(!v(e))return null;const t=r(e.run_id),n=r(e.chain_id);return n?{run_id:t??null,chain_id:n,duration_ms:d(e.duration_ms),success:j(e.success),mermaid:r(e.mermaid),nodes:Array.isArray(e.nodes)?e.nodes.map(bm).filter(s=>s!==null):[]}:null}function km(e){const t=v(e)?e:{};return{run:Dl(t.run)}}function xm(e){if(!v(e))return null;const t=r(e.title),n=r(e.path);return!t||!n?null:{title:t,path:n}}function Sm(e){if(!v(e))return null;const t=r(e.id),n=r(e.title),s=r(e.summary);return!t||!n||!s?null:{id:t,title:n,summary:s}}function Am(e){if(!v(e))return null;const t=r(e.id),n=r(e.title),s=r(e.tool),a=r(e.summary);return!t||!n||!s||!a?null:{id:t,title:n,tool:s,summary:a,success_signals:H(e.success_signals),pitfalls:H(e.pitfalls)}}function Cm(e){if(!v(e))return null;const t=r(e.id),n=r(e.title),s=r(e.summary),a=r(e.when_to_use);return!t||!n||!s||!a?null:{id:t,title:n,summary:s,when_to_use:a,steps:Array.isArray(e.steps)?e.steps.map(Am).filter(i=>i!==null):[]}}function Im(e){if(!v(e))return null;const t=r(e.id),n=r(e.title),s=r(e.description);return!t||!n||!s?null:{id:t,title:n,description:s,tools:H(e.tools)}}function Tm(e){if(!v(e))return null;const t=r(e.id),n=r(e.title),s=r(e.symptom),a=r(e.why),i=r(e.fix_tool),l=r(e.fix_summary);return!t||!n||!s||!a||!i||!l?null:{id:t,title:n,symptom:s,why:a,fix_tool:i,fix_summary:l}}function Rm(e){if(!v(e))return null;const t=r(e.id),n=r(e.title),s=r(e.path_id),a=r(e.transport);return!t||!n||!s||!a?null:{id:t,title:n,path_id:s,transport:a,request:e.request,response:e.response,notes:H(e.notes)}}function Pm(e){const t=v(e)?e:{};return{version:r(t.version),generated_at:r(t.generated_at),docs:Array.isArray(t.docs)?t.docs.map(xm).filter(n=>n!==null):[],concepts:Array.isArray(t.concepts)?t.concepts.map(Sm).filter(n=>n!==null):[],golden_paths:Array.isArray(t.golden_paths)?t.golden_paths.map(Cm).filter(n=>n!==null):[],tool_groups:Array.isArray(t.tool_groups)?t.tool_groups.map(Im).filter(n=>n!==null):[],pitfalls:Array.isArray(t.pitfalls)?t.pitfalls.map(Tm).filter(n=>n!==null):[],examples:Array.isArray(t.examples)?t.examples.map(Rm).filter(n=>n!==null):[]}}function Lm(e){if(!v(e))return null;const t=r(e.id),n=r(e.title),s=r(e.status),a=r(e.detail),i=r(e.next_tool);return!t||!n||!s||!a||!i?null:{id:t,title:n,status:s,detail:a,next_tool:i}}function zm(e){if(!v(e))return null;const t=r(e.code),n=r(e.severity),s=r(e.title),a=r(e.detail),i=r(e.next_tool);return!t||!n||!s||!a||!i?null:{code:t,severity:n,title:s,detail:a,next_tool:i}}function Mm(e){if(!v(e))return null;const t=r(e.from),n=r(e.content),s=r(e.timestamp),a=d(e.seq);return!t||!n||!s||a==null?null:{seq:a,from:t,content:n,timestamp:s}}function Nm(e){if(!v(e))return null;const t=r(e.name),n=r(e.role),s=r(e.lane),a=r(e.status),i=r(e.claim_marker),l=r(e.done_marker),c=r(e.final_marker);if(!t||!n||!s||!a||!i||!l||!c)return null;const p=(()=>{if(!v(e.last_message))return null;const m=d(e.last_message.seq),u=r(e.last_message.content),_=r(e.last_message.timestamp);return m==null||!u||!_?null:{seq:m,content:u,timestamp:_}})();return{name:t,role:n,lane:s,joined:j(e.joined)??!1,live_presence:j(e.live_presence)??!1,completed:j(e.completed)??!1,status:a,current_task:r(e.current_task)??null,bound_task_id:r(e.bound_task_id)??null,bound_task_title:r(e.bound_task_title)??null,bound_task_status:r(e.bound_task_status)??null,current_task_matches_run:j(e.current_task_matches_run)??!1,squad_member:j(e.squad_member)??!1,detachment_member:j(e.detachment_member)??!1,last_seen:r(e.last_seen)??null,heartbeat_age_sec:d(e.heartbeat_age_sec)??null,heartbeat_fresh:j(e.heartbeat_fresh)??!1,claim_marker_seen:j(e.claim_marker_seen)??!1,done_marker_seen:j(e.done_marker_seen)??!1,final_marker_seen:j(e.final_marker_seen)??!1,claim_marker:i,done_marker:l,final_marker:c,last_message:p}}function Em(e){if(!v(e))return;const t=Array.isArray(e.timeline)?e.timeline.map(n=>{if(!v(n))return null;const s=r(n.timestamp),a=d(n.active_slots);if(!s||a==null)return null;const i=Array.isArray(n.active_slot_ids)?n.active_slot_ids.map(l=>typeof l=="number"&&Number.isFinite(l)?l:null).filter(l=>l!=null):[];return{timestamp:s,active_slots:a,active_slot_ids:i}}).filter(n=>n!==null):[];return{slot_url:r(e.slot_url)??null,provider_base_url:r(e.provider_base_url)??null,provider_reachable:j(e.provider_reachable)??null,provider_status_code:d(e.provider_status_code)??null,provider_model_id:r(e.provider_model_id)??null,actual_model_id:r(e.actual_model_id)??null,expected_slots:d(e.expected_slots),actual_slots:d(e.actual_slots),expected_ctx:d(e.expected_ctx),actual_ctx:d(e.actual_ctx),slot_reachable:j(e.slot_reachable)??null,slot_status_code:d(e.slot_status_code)??null,runtime_blocker:r(e.runtime_blocker)??null,detail:r(e.detail)??null,checked_at:r(e.checked_at)??null,total_slots:d(e.total_slots),ctx_per_slot:d(e.ctx_per_slot),active_slots_now:d(e.active_slots_now),peak_active_slots:d(e.peak_active_slots),sample_count:d(e.sample_count),last_sample_at:r(e.last_sample_at)??null,timeline:t}}function jm(e){if(!v(e))return null;const t=r(e.run_id),n=r(e.status),s=r(e.decided_by),a=r(e.decided_at),i=r(e.reason);if(!t||!n||!s||!a||!i)return null;const l=[];return Array.isArray(e.history)&&e.history.forEach(c=>{if(!v(c))return;const p=r(c.status),m=r(c.decided_by),u=r(c.decided_at),_=r(c.reason);!p||!m||!u||!_||l.push({status:p,decided_by:m,decided_at:u,reason:_,operation_id:r(c.operation_id)??null,detachment_id:r(c.detachment_id)??null,note:r(c.note)??null})}),{run_id:t,status:n,decided_by:s,decided_at:a,reason:i,operation_id:r(e.operation_id)??null,detachment_id:r(e.detachment_id)??null,note:r(e.note)??null,history:l}}function wm(e){if(!v(e))return null;const t=r(e.run_id),n=r(e.recommended_kind),s=r(e.reason);return!t||!n||!s?null:{run_id:t,recommended_kind:n,continue_available:j(e.continue_available)??!1,rerun_available:j(e.rerun_available)??!1,abandon_available:j(e.abandon_available)??!1,reason:s,evidence:v(e.evidence)?{operation_id:r(e.evidence.operation_id)??null,detachment_id:r(e.evidence.detachment_id)??null,joined_workers:d(e.evidence.joined_workers),current_task_bound:d(e.evidence.current_task_bound),fresh_heartbeats:d(e.evidence.fresh_heartbeats),trace_events:d(e.evidence.trace_events),message_events:d(e.evidence.message_events),runtime_blocker:r(e.evidence.runtime_blocker)??null}:void 0,provenance:r(e.provenance),decision_engine:r(e.decision_engine),authoritative:j(e.authoritative)}}function Dm(e){const t=v(e)?e:{},n=v(t.summary)?t.summary:void 0;return{version:r(t.version),generated_at:r(t.generated_at),run_id:r(t.run_id),room_id:r(t.room_id),operation_id:r(t.operation_id)??null,run_resolution:jm(t.run_resolution),resolution_recommendation:wm(t.resolution_recommendation),recommended_next_tool:r(t.recommended_next_tool),summary:n?{expected_workers:d(n.expected_workers),joined_workers:d(n.joined_workers),live_workers:d(n.live_workers),squad_roster_size:d(n.squad_roster_size),detachment_roster_size:d(n.detachment_roster_size),current_task_bound:d(n.current_task_bound),fresh_heartbeats:d(n.fresh_heartbeats),claim_markers_seen:d(n.claim_markers_seen),done_markers_seen:d(n.done_markers_seen),final_markers_seen:d(n.final_markers_seen),completed_workers:d(n.completed_workers),peak_hot_slots:d(n.peak_hot_slots),hot_window_ok:j(n.hot_window_ok),pass_hot_concurrency:j(n.pass_hot_concurrency),pass_end_to_end:j(n.pass_end_to_end),pending_decisions:d(n.pending_decisions),pass:j(n.pass)}:void 0,provider:Em(t.provider),operation:Pa(t.operation),squad:ai(t.squad),detachment:Ll(t.detachment),workers:Array.isArray(t.workers)?t.workers.map(Nm).filter(s=>s!==null):[],checklist:Array.isArray(t.checklist)?t.checklist.map(Lm).filter(s=>s!==null):[],blockers:Array.isArray(t.blockers)?t.blockers.map(zm).filter(s=>s!==null):[],recent_messages:Array.isArray(t.recent_messages)?t.recent_messages.map(Mm).filter(s=>s!==null):[],recent_trace_events:Array.isArray(t.recent_trace_events)?t.recent_trace_events.map(El).filter(s=>s!==null):[],truth_notes:H(t.truth_notes)}}function Om(e){if(!v(e))return null;const t=r(e.label),n=r(e.value);return!t||!n?null:{label:t,value:n}}function qm(e){if(!v(e))return null;const t=r(e.id),n=r(e.kind),s=r(e.label),a=r(e.tone),i=r(e.provenance);return!t||!n||!s||!a||!i?null:{id:t,kind:n,label:s,subtitle:r(e.subtitle)??null,status:r(e.status)??null,tone:a,pulse:r(e.pulse)??null,provenance:i,visual_class:r(e.visual_class)??void 0,glyph:r(e.glyph)??void 0,parent_id:r(e.parent_id)??null,lane_id:r(e.lane_id)??null,link_tab:r(e.link_tab)??null,link_surface:r(e.link_surface)??null,link_params:v(e.link_params)?Object.fromEntries(Object.entries(e.link_params).map(([l,c])=>{const p=r(c);return p?[l,p]:null}).filter(l=>l!==null)):{},facts:Array.isArray(e.facts)?e.facts.map(Om).filter(l=>l!==null):[]}}function Fm(e){if(!v(e))return null;const t=r(e.id),n=r(e.source),s=r(e.target),a=r(e.kind),i=r(e.tone),l=r(e.provenance);return!t||!n||!s||!a||!i||!l?null:{id:t,source:n,target:s,kind:a,label:r(e.label)??null,tone:i,provenance:l,animated:j(e.animated)}}function Km(e){if(!v(e))return null;const t=r(e.id),n=r(e.kind),s=r(e.label),a=r(e.tone),i=r(e.provenance);return!t||!n||!s||!a||!i?null:{id:t,kind:n,label:s,detail:r(e.detail)??null,tone:a,provenance:i,source_id:r(e.source_id)??null,target_id:r(e.target_id)??null,suggested_surface:r(e.suggested_surface)??null,suggested_params:v(e.suggested_params)?Object.fromEntries(Object.entries(e.suggested_params).map(([l,c])=>{const p=r(c);return p?[l,p]:null}).filter(l=>l!==null)):{}}}function Bm(e){if(!v(e))return null;const t=r(e.target_kind),n=r(e.target_id),s=r(e.label),a=r(e.reason);return!t||!n||!s||!a?null:{target_kind:t,target_id:n,label:s,reason:a,suggested_surface:r(e.suggested_surface)??null,suggested_params:v(e.suggested_params)?Object.fromEntries(Object.entries(e.suggested_params).map(([i,l])=>{const c=r(l);return c?[i,c]:null}).filter(i=>i!==null)):{}}}function Um(e){const t=v(e)?e:{},n=v(t.room)?t.room:{},s=v(t.summary)?t.summary:void 0;return{version:r(t.version),generated_at:r(t.generated_at),room:{room_id:r(n.room_id),project:r(n.project),cluster:r(n.cluster),paused:j(n.paused),pause_reason:r(n.pause_reason)??null,agent_count:d(n.agent_count),task_count:d(n.task_count),message_count:d(n.message_count)},summary:s?{session_count:d(s.session_count),operation_count:d(s.operation_count),detachment_count:d(s.detachment_count),lane_count:d(s.lane_count),worker_count:d(s.worker_count),keeper_count:d(s.keeper_count),signal_count:d(s.signal_count),alert_count:d(s.alert_count)}:void 0,nodes:Array.isArray(t.nodes)?t.nodes.map(qm).filter(a=>a!==null):[],edges:Array.isArray(t.edges)?t.edges.map(Fm).filter(a=>a!==null):[],signals:Array.isArray(t.signals)?t.signals.map(Km).filter(a=>a!==null):[],focus:Bm(t.focus),swarm_status:oi(t.swarm_status),swarm_proof:jl(t.swarm_proof),truth_notes:H(t.truth_notes)}}function nt(e){G.value=e,si(e)&&Hm()}async function Ol(){Ys.value=!0,Zs.value=null;try{const e=await Td();ti.value=gm(e)}catch(e){Zs.value=e instanceof Error?e.message:"Failed to load command-plane summary"}finally{Ys.value=!1}}function ii(e){Vt.value=e}async function ri(){Xs.value=!0,ea.value=null;try{const e=await Id();De.value=_m(e)}catch(e){ea.value=e instanceof Error?e.message:"Failed to load command-plane snapshot"}finally{Xs.value=!1}}async function Hm(){De.value||Xs.value||await ri()}async function Ot(){await Ol(),si(G.value)&&await ri()}async function Qt(){var e;Mo.value=!0,ia.value=null;try{const t=await Rd(),n=ym(t);es.value=n;const s=Vt.value;n.operations.length===0?Vt.value=null:(!s||!n.operations.some(a=>a.operation.operation_id===s))&&(Vt.value=((e=n.operations[0])==null?void 0:e.operation.operation_id)??null)}catch(t){ia.value=t instanceof Error?t.message:"Failed to load chain summary"}finally{Mo.value=!1}}function Wm(){$n=null,En.value=null,ra.value=!1,jn.value=null}async function Gm(e){$n=e,ra.value=!0,jn.value=null;try{const t=await Pd(e);if($n!==e)return;En.value=km(t)}catch(t){if($n!==e)return;En.value=null,jn.value=t instanceof Error?t.message:"Failed to load chain run"}finally{$n===e&&(ra.value=!1)}}async function Jm(){Lo.value=!0,na.value=null;try{const e=await Ld();Zn.value=Pm(e)}catch(e){na.value=e instanceof Error?e.message:"Failed to load command-plane help"}finally{Lo.value=!1}}async function Qe(e=Cl(),t=Il()){sa.value=!0,aa.value=null;try{const n=await zd(e,t);Pt.value=Dm(n)}catch(n){aa.value=n instanceof Error?n.message:"Failed to load command-plane swarm view"}finally{sa.value=!1}}async function St(e=Cl(),t=Il()){zo.value=!0,oa.value=null;try{const n=await Md(e,t);ni.value=Um(n)}catch(n){oa.value=n instanceof Error?n.message:"Failed to load orchestra map"}finally{zo.value=!1}}async function ut(e,t,n){Po.value=e,ta.value=null;try{await Nd(t,n),await Ol(),(De.value||si(G.value))&&await ri(),await Qe(),await St(),await Qt()}catch(s){throw ta.value=s instanceof Error?s.message:"Failed to execute command-plane action",s}finally{Po.value=null}}function Vm(e){return ut(`pause:${e}`,"/api/v1/command-plane/operations/pause",{operation_id:e})}function Qm(e){return ut(`resume:${e}`,"/api/v1/command-plane/operations/resume",{operation_id:e})}function Ym(e){return ut(`recall:${e}`,"/api/v1/command-plane/dispatch/recall",{operation_id:e})}function Xm(e={}){return ut("dispatch:tick","/api/v1/command-plane/dispatch/tick",{...e.operationId?{operation_id:e.operationId}:{},...e.detachmentId?{detachment_id:e.detachmentId}:{}})}function Zm(e){return ut(`approve:${e}`,"/api/v1/command-plane/policy/approve",{decision_id:e})}function ev(e){return ut(`deny:${e}`,"/api/v1/command-plane/policy/deny",{decision_id:e})}function tv(e,t){return ut(`freeze:${e}`,"/api/v1/command-plane/policy/freeze",{unit_id:e,enabled:t})}function nv(e,t){return ut(`kill:${e}`,"/api/v1/command-plane/policy/kill-switch",{unit_id:e,enabled:t})}$p(()=>{Ot(),Qt(),(G.value==="swarm"||G.value==="warroom"||G.value==="orchestra"||Pt.value!==null)&&Qe(),(G.value==="orchestra"||ni.value!==null)&&St(),G.value==="warroom"&&ye()});function No(e){e==="command"&&(Ot(),Qt(),(G.value==="swarm"||G.value==="warroom"||G.value==="orchestra")&&Qe(),G.value==="orchestra"&&St(),G.value==="warroom"&&ye()),e==="mission"&&(kl(),Qs()),e==="proof"&&Sl(F.value.params.session_id,F.value.params.operation_id),e==="execution"&&kt(),e==="intervene"&&(ye(),Tt()),e==="memory"&&et(),e==="planning"&&Zo(),e==="lab"&&tt()}function sv({metric:e}){return o`
  ...
  `}function av({panel:e}){return o`
    <div class="semantic-body">
      ...
      ${e.metrics.length>0?o`<div class="semantic-metric-list">
            ${e.metrics.map(t=>o`<${sv} key=${t.id} metric=${t} />`)}
          </div>`:null}
    </div>
  `}function O({panelId:e,compact:t=!1,label:n="Why"}){const s=_p(e);return s?o`
    <details class="semantic-inline ${t?"compact":""}">
      <summary class="semantic-summary">${n}</summary>
      <${av} panel=${s} />
    </details>
  `:Hs.value?o`<span class="semantic-inline-state">Loading semantics…</span>`:null}function be({surfaceId:e,compact:t=!1}){const n=vp(e);return n?o`
  ...
  `}const la="masc_dashboard_workflow_context",ov=900*1e3;function fe(e){return typeof e=="string"&&e.trim()!==""?e.trim():null}function Ge(e){const t=fe(e);return t||(typeof e=="number"&&Number.isFinite(e)?String(e):null)}function ql(){if(typeof window>"u")return null;try{return window.sessionStorage}catch{return null}}function Eo(e){return v(e)?e:null}function iv(e){if(!e)return null;try{return JSON.stringify(e)}catch{return null}}function rv(e){if(!e)return null;try{const t=JSON.parse(e);if(!v(t))return null;const n=fe(t.id),s=fe(t.source_surface),a=fe(t.source_label),i=fe(t.summary),l=fe(t.created_at);return!n||s!=="mission"&&s!=="execution"||!a||!i||!l?null:{id:n,source_surface:s,source_label:a,action_type:fe(t.action_type),target_type:fe(t.target_type),target_id:fe(t.target_id),focus_kind:fe(t.focus_kind),operation_id:fe(t.operation_id),command_surface:fe(t.command_surface),summary:i,payload_preview:fe(t.payload_preview),suggested_payload:Eo(t.suggested_payload),preview:t.preview??null,evidence:t.evidence??null,created_at:l}}catch{return null}}function li(e){const t=Date.parse(e.created_at);return Number.isNaN(t)?!1:Date.now()-t<=ov}function lv(){const e=ql(),t=rv((e==null?void 0:e.getItem(la))??null);return t?li(t)?t:(e==null||e.removeItem(la),null):null}const Fl=g(lv());function Kl(e){const t=e&&li(e)?e:null;Fl.value=t;const n=ql();if(!n)return;if(!t){n.removeItem(la);return}const s=iv(t);s&&n.setItem(la,s)}function cv(e){if(!e)return null;const t=Eo(e.suggested_payload);if(t)return t;if(v(e.preview)){const n=Eo(e.preview.payload);if(n)return n}return null}function dv(e){if(!e)return null;const t=Ge(e.message);if(t)return t;const n=Ge(e.task_title)??Ge(e.title),s=Ge(e.task_description)??Ge(e.description),a=Ge(e.reason),i=Ge(e.priority)??Ge(e.task_priority);return n&&s?`${n} · ${s}`:n&&i?`${n} · P${i}`:n||s||a||null}function ci(e,t,n,s,a,i,l,c){return[e,t,n??"action",s??"target",a??"room",i??"focus",l??"operation",c].join(":")}function dn(e,t,n="상황판 추천 액션"){const s=new Date().toISOString(),a=cv(e),i=(e==null?void 0:e.target_type)??(t==null?void 0:t.target_type)??null,l=(e==null?void 0:e.target_id)??(t==null?void 0:t.target_id)??null,c=(t==null?void 0:t.kind)??(e==null?void 0:e.action_type)??null,p=(e==null?void 0:e.reason)??(t==null?void 0:t.summary)??n;return{id:ci("mission",n,(e==null?void 0:e.action_type)??null,i,l,c,null,s),source_surface:"mission",source_label:n,action_type:(e==null?void 0:e.action_type)??null,target_type:i,target_id:l,focus_kind:c,operation_id:null,command_surface:null,summary:p,payload_preview:dv(a),suggested_payload:a,preview:(e==null?void 0:e.preview)??null,evidence:(t==null?void 0:t.evidence)??null,created_at:s}}function uv({targetType:e,targetId:t,focusKind:n,sourceLabel:s="Execution 진단",summary:a,operationId:i=null,commandSurface:l=null}){const c=new Date().toISOString();return{id:ci("execution",s,null,e,t,n,i,c),source_surface:"execution",source_label:s,action_type:null,target_type:e,target_id:t,focus_kind:n,operation_id:i,command_surface:l,summary:a,payload_preview:null,suggested_payload:null,preview:null,evidence:null,created_at:c}}function pv(e,t){return(t.source==="mission"||t.source==="execution")&&(t.action_type??null)===(e.action_type??null)&&(t.target_type??null)===(e.target_type??null)&&(t.target_id??null)===(e.target_id??null)&&(t.focus_kind??null)===(e.focus_kind??null)&&(t.operation_id??null)===(e.operation_id??null)}function ts(e){const{params:t}=e;if(t.source!=="mission"&&t.source!=="execution")return null;const n=Fl.value;if(n&&li(n)&&pv(n,t))return n;const s=new Date().toISOString(),a=t.source==="execution"?"execution":"mission";return{id:ci(a,a==="execution"?"Execution 이어보기":"상황판 이어보기",t.action_type??null,t.target_type??null,t.target_id??null,t.focus_kind??null,t.operation_id??null,s),source_surface:a,source_label:a==="execution"?"Execution 이어보기":"상황판 이어보기",action_type:t.action_type??null,target_type:t.target_type??null,target_id:t.target_id??null,focus_kind:t.focus_kind??t.action_type??null,operation_id:t.operation_id??null,command_surface:t.surface??null,summary:a==="execution"?t.focus_kind?`${t.focus_kind} 기준으로 열린 execution 컨텍스트입니다.`:"Execution에서 이어진 컨텍스트입니다.":t.focus_kind?`${t.focus_kind} 기준으로 열린 컨텍스트입니다.`:"상황판에서 이어진 컨텍스트입니다.",payload_preview:null,suggested_payload:null,preview:null,evidence:null,created_at:s}}function Bl(e){return{source:e.source_surface,...e.action_type?{action_type:e.action_type}:{},...e.target_type?{target_type:e.target_type}:{},...e.target_id?{target_id:e.target_id}:{},...e.focus_kind?{focus_kind:e.focus_kind}:{},...e.operation_id?{operation_id:e.operation_id}:{}}}function Ul(e){if(e.command_surface)return e.command_surface;const t=[e.focus_kind,e.summary,e.action_type].filter(n=>typeof n=="string"&&n.trim()!=="").join(" ").toLowerCase();return t.includes("artifact_scope")||t.includes("routing_confidence")||t.includes("cache_contention")?"summary":t.includes("stale_data")||t.includes("leader_offline")||t.includes("roster_offline")||t.includes("managed")||t.includes("swarm")?"swarm":e.focus_kind==="operation"||e.target_type==="operation"?"operations":e.target_type==="room"?"orchestra":"swarm"}function Hl(e){return{source:e.source_surface,surface:Ul(e),...e.action_type?{action_type:e.action_type}:{},...e.target_type?{target_type:e.target_type}:{},...e.target_id?{target_id:e.target_id}:{},...e.focus_kind?{focus_kind:e.focus_kind}:{},...e.operation_id?{operation_id:e.operation_id}:{}}}function mv(e){return Bl(e)}function vv(e){return Hl(e)}function di(e){return e!=null&&e.target_type?e.target_id?`${e.target_type} · ${e.target_id}`:e.target_type:"대상 정보 없음"}function La(e){switch(e){case"broadcast":return"room 방송";case"room_pause":return"room 일시정지";case"room_resume":return"room 재개";case"task_inject":return"room 작업 주입";case"team_turn":return"session 업데이트";case"team_note":return"session 노트";case"team_broadcast":return"session 방송";case"team_task_inject":return"session 작업";case"team_stop":return"session 중지";case"keeper_msg":case"keeper_message":return"keeper 메시지";case"keeper_probe":return"keeper probe";case"keeper_recover":return"keeper recover";case"swarm_run_continue":return"swarm run 계속";case"swarm_run_rerun":return"swarm run 재실행";case"swarm_run_abandon":return"swarm run 포기";default:return(e==null?void 0:e.trim())||"추천 액션"}}function _v(e){switch(e){case"warroom":return"워룸";case"summary":return"요약";case"orchestra":return"오케스트라";case"swarm":return"스웜";case"chains":return"체인";case"topology":return"토폴로지";case"alerts":return"알림";case"trace":return"트레이스";case"control":return"제어";case"operations":return"작전";default:return(e==null?void 0:e.trim())||"지휘"}}const Fe=g(null),Ye=g(null);function Re(e,t=120){const n=(e??"").replace(/\s+/g," ").trim();return n?n.length>t?`${n.slice(0,t-1)}…`:n:null}function ve(e){return e==="bad"||e==="offline"||e==="critical"||e==="risk"?"bad":e==="warn"||e==="pending"||e==="degraded"||e==="interrupted"||e==="watch"?"warn":"ok"}function Ee(e){if(!e)return"방금";const t=Date.parse(e);if(Number.isNaN(t))return e;const n=Math.max(0,Math.round((Date.now()-t)/1e3));return n<60?`${n}s 전`:n<3600?`${Math.round(n/60)}m 전`:n<86400?`${Math.round(n/3600)}h 전`:`${Math.round(n/86400)}d 전`}function gv(e){return typeof e!="number"||!Number.isFinite(e)||e<0?"n/a":e<60?`${Math.round(e)}s`:e<3600?`${Math.round(e/60)}m`:e<86400?`${Math.round(e/3600)}h`:`${Math.round(e/86400)}d`}function fv(e){return e!=null&&e.confirm_required?"확인 후 실행":"즉시 실행"}function $v(e){return di(e?dn(e,null,"상황판 추천 액션"):null)}function za(e,t=dn()){Kl(t),se(e,e==="intervene"?mv(t):vv(t))}function Wl(e){za("intervene",dn(null,e,"상황판 incident"))}function Gl(e){za("command",dn(null,e,"상황판 incident"))}function ui(e,t,n="상황판 추천 액션"){za("intervene",dn(e,t,n))}function Jl(e,t,n="상황판 추천 액션"){za("command",dn(e,t,n))}function jo(e,t){const n={source:"mission",target_type:"team_session",target_id:t,focus_kind:"team_session"};e==="command"&&(n.surface="swarm"),se(e,n)}function hv(e){return{kind:e.kind,severity:e.severity,summary:e.summary,target_type:e.target_type,target_id:e.target_id??null,actor:null,evidence:e.evidence_preview}}function yv(e){var n,s;const t=dt.value.find(a=>a.name===e.name||a.agent_name===e.agent_name)??null;return{brief:e,keeper:t,currentWork:Re(e.current_work,110)??Re(t==null?void 0:t.skill_primary,110)??Re(t==null?void 0:t.last_proactive_reason,110)??"명시된 keeper focus 없음",recentInput:Re(t==null?void 0:t.recent_input_preview,120)??null,recentOutput:Re(t==null?void 0:t.recent_output_preview,120)??Re((n=t==null?void 0:t.diagnostic)==null?void 0:n.last_reply_preview,120)??Re(t==null?void 0:t.last_proactive_preview,120)??null,recentEvent:Re(t==null?void 0:t.last_proactive_reason,120)??Re((s=t==null?void 0:t.diagnostic)==null?void 0:s.summary,120)??null,recentTools:(t==null?void 0:t.recent_tool_names)??[]}}function bv(){const e=Xn.value;if(!e)return new Map;const t=e.sessions.length>0?e.sessions:e.session_briefs;return new Map(t.map(n=>[n.session_id,n]))}function kv(e){Fe.value=Fe.value===e?null:e,Ye.value=null}function Vl(e){Ye.value=Ye.value===e?null:e,Fe.value=null}function xv(){Fe.value=null,Ye.value=null}function pt({status:e,label:t}){return o`
    <span class="status-badge ${e}">
      <span class="status-dot-inline ${e}"></span>
      ${t??e}
    </span>
  `}function Ql(e){const t=Date.now(),n=typeof e=="number"?e<1e12?e*1e3:e:new Date(e).getTime(),s=Math.floor((t-n)/1e3);if(s<60)return`${s}s ago`;const a=Math.floor(s/60);if(a<60)return`${a}m ago`;const i=Math.floor(a/60);return i<24?`${i}h ago`:`${Math.floor(i/24)}d ago`}function J({timestamp:e}){const t=Ql(e),n=typeof e=="string"?e:new Date(e<1e12?e*1e3:e).toISOString();return o`<span class="time-ago" title=${n}>${t}</span>`}let Sv=0;const At=g([]);function E(e,t="success",n=4e3){const s=++Sv;At.value=[...At.value,{id:s,message:e,type:t}],setTimeout(()=>{At.value=At.value.filter(a=>a.id!==s)},n)}function Av(e){At.value=At.value.filter(t=>t.id!==e)}function Cv(){const e=At.value;return e.length===0?null:o`
    <div class="toast-container">
      ${e.map(t=>o`
        <div key=${t.id} class="toast ${t.type}" onClick=${()=>Av(t.id)}>
          ${t.message}
        </div>
      `)}
    </div>
  `}const Iv="masc_dashboard_agent_name",un=g(null),ca=g(!1),wn=g(""),da=g([]),Dn=g([]),Yt=g(""),Sn=g(!1);function Ma(e){un.value=e,pi()}function Ui(){un.value=null,wn.value="",da.value=[],Dn.value=[],Yt.value=""}function Tv(){const e=un.value;return e?He.value.find(t=>t.name===e)??null:null}function Yl(e){return e?Xe.value.filter(t=>t.assignee===e):[]}function Xl(e){return e?dt.value.find(t=>t.agent_name===e||t.name===e)??null:null}function Rv(e){if(!e)return null;const t=Xn.value;return t?t.agent_briefs.find(n=>n.agent_name===e)??null:null}function Pv(e){if(!e)return[];const t=e.metrics_window;return(Array.isArray(t==null?void 0:t.top_tools)?t.top_tools:[]).map(s=>typeof s=="object"&&s!==null&&"tool"in s&&typeof s.tool=="string"?s.tool:null).filter(s=>s!==null)}function Lv(e){const t=Xl(e);return t?t.recent_tool_names&&t.recent_tool_names.length>0?t.recent_tool_names:[]:[]}async function pi(){const e=un.value;if(e){ca.value=!0,wn.value="",da.value=[],Dn.value=[];try{const t=await vu(80);da.value=t.filter(a=>a.includes(e)).slice(0,20);const n=Yl(e).slice(0,6);if(n.length===0)return;const s=await Promise.all(n.map(async a=>{try{const i=await _u(a.id,25);return{taskId:a.id,text:i.trim()}}catch(i){const l=i instanceof Error?i.message:"history load failed";return{taskId:a.id,text:`Failed to load history: ${l}`}}}));Dn.value=s}catch(t){wn.value=t instanceof Error?t.message:"Failed to load agent detail"}finally{ca.value=!1}}}async function Hi(){var s;const e=un.value,t=Yt.value.trim();if(!e||!t)return;const n=((s=localStorage.getItem(Iv))==null?void 0:s.trim())||"dashboard";Sn.value=!0;try{await mu(n,`@${e} ${t}`),Yt.value="",E(`Mention sent to ${e}`,"success"),pi()}catch(a){const i=a instanceof Error?a.message:"Failed to send mention";E(i,"error")}finally{Sn.value=!1}}function zv({task:e}){return o`
    <div class="agent-detail-task">
      <span class="pill">${e.id}</span>
      <span class="agent-detail-task-title">${e.title}</span>
      <${pt} status=${e.status} />
    </div>
  `}function Mv({row:e}){return o`
  ...
  `}function Nv(){var A,x,z,T,P,M,R;const e=un.value;if(!e)return null;const t=Tv(),n=Xl(e),s=Rv(e),a=Yl(e),i=da.value,l=Lv(e),c=Pv(n),p=(s==null?void 0:s.allowed_tool_names)??[],m=(s==null?void 0:s.latest_tool_names)??[],u=s==null?void 0:s.latest_tool_call_count,_=s==null?void 0:s.tool_audit_source,f=s==null?void 0:s.tool_audit_at,h=(t==null?void 0:t.capabilities)??[],b=((A=te.value)==null?void 0:A.room)??"default",$=((x=te.value)==null?void 0:x.project)??"확인 없음",S=((z=te.value)==null?void 0:z.cluster)??"확인 없음";return o`
    <div
      ...
      <div class="agent-detail-modal">
        ...
        <div class="agent-detail-grid">
          <${I} title="Assigned Tasks">
            ${a.length===0?o`<div class="empty-state">No assigned tasks</div>`:o`<div class="agent-detail-task-list">${a.map(N=>o`<${zv} key=${N.id} task=${N} />`)}</div>`}
          <//>
        ...
        <${I} title="Task History">
          ${Dn.value.length===0?o`<div class="empty-state">No task history loaded</div>`:o`<div class="agent-history-list">${Dn.value.map(N=>o`<${Mv} key=${N.taskId} row=${N} />`)}</div>`}
        <//>
  ...
  `}function Ev(e){switch(e){case"quiet_hours":return"quiet hours";case"min_gap":return"cooldown gate";case"no_recent_activity":return"waiting for activity";case"disabled":return"runtime disabled";case"startup":return"warming up";case"llm_error":return"llm error";case"graphql_error":return"graphql error";case"never_started":return"never started";default:return"unknown"}}function jv(e){switch(e){case"manual_lodge_poke":return"Poke Lodge";case"probe":return"Probe";case"recover":return"Recover";default:return"Message"}}function wv(e){switch(e.delivery){case"sending":return"sending";case"timeout":return"timeout";case"error":return"error";case"delivered":return"delivered";default:return e.role}}function Wi(e){return e.delivery==="error"||e.delivery==="timeout"?"bad":e.delivery==="sending"?"warn":e.role==="assistant"?"assistant":e.role==="user"?"user":"warn"}function Zl(e){if(!e)return null;const t=new Date(e);return Number.isNaN(t.getTime())?null:t.toLocaleTimeString()}function Dv(e){return typeof e!="number"||!Number.isFinite(e)||e<=0?null:e<60?`${Math.round(e)}s`:`${Math.ceil(e/60)}m`}function ec(e){if(!e)return null;const t=Be.value[e.name];return(t==null?void 0:t.diagnostic)??e.diagnostic??null}function Ov({keeper:e,showRawStatus:t=!1}){if(ne(()=>{e!=null&&e.name&&Ur(e.name)},[e==null?void 0:e.name]),!e)return o`<div class="control-status-copy">Select a keeper to inspect direct reply state.</div>`;const n=Be.value[e.name],s=ec(e),a=$o.value[e.name];return o`
    <div class="control-result-box">
      <div class="control-inline-meta">
        <span class="pill">${(s==null?void 0:s.health_state)??"unknown"}</span>
        <span class="pill">${Ev(s==null?void 0:s.quiet_reason)}</span>
        <span class="pill">next ${jv((s==null?void 0:s.next_action_path)??"direct_message")}</span>
      ...
      <div class="control-status-copy">
        ...
        ${s!=null&&s.next_eligible_at_s?o` · next eligible ${Dv(s.next_eligible_at_s)}`:null}
      </div>
  ...
  `}function qv({keeperName:e,placeholder:t}){const[n,s]=xr("");ne(()=>{e&&Ur(e)},[e]);const a=de.value[e]??[],i=ho.value[e]??!1,l=Ue.value[e],c=async()=>{const p=n.trim();if(!(!e||!p)){s("");try{await Eu(e,p)}catch(m){const u=m instanceof Error?m.message:`Failed to message ${e}`;E(u,"error")}}};return o`
        ...
        ${a.length===0?o`<div class="control-status-copy">No direct keeper conversation yet.</div>`:a.map(p=>o`
              <div class="keeper-conversation-item" key=${p.id}>
                <div class="keeper-conversation-meta">
                  ...
                  <span class=${`keeper-role-chip ${Wi(p)}`}>${wv(p)}</span>
  ...
  `}function Fv({actor:e,keeper:t,onPokeLodge:n}){if(!t)return null;const s=ec(t),a=yo.value[t.name]??!1,i=bo.value[t.name]??!1,l=(s==null?void 0:s.next_action_path)??"direct_message",c=(s==null?void 0:s.recoverable)??l==="recover";return o`
    <div class="control-actions">
      <button
        class=${`control-btn ghost ${l==="probe"?"is-active":""}`}
        onClick=${()=>{ju(t.name,e).catch(p=>{const m=p instanceof Error?p.message:`Failed to probe ${t.name}`;E(m,"error")})}}
        disabled=${a||!e.trim()}
      >
        ${a?"Probing...":"Probe"}
      </button>
      <button
        ...
        onClick=${()=>{wu(t.name,e).catch(p=>{const m=p instanceof Error?p.message:`Failed to recover ${t.name}`;E(m,"error")})}}
        disabled=${i||!c||!e.trim()}
      >
  ...
  `}const mi=g(null);function tc(e){mi.value=e,Nu(e.name)}function Gi(){mi.value=null}const Nt=[{level:"L1_Reactive",label:"L1 Reactive",color:"#6b7280"},{level:"L2_Suggestive",label:"L2 Suggestive",color:"#3b82f6"},{level:"L3_Guided",label:"L3 Guided",color:"#f59e0b"},{level:"L4_Autonomous",label:"L4 Autonomous",color:"#f97316"},{level:"L5_Independent",label:"L5 Independent",color:"#ef4444"}];function Kv(e){if(!e)return 0;const t=Nt.findIndex(n=>n.level===e);return t>=0?t:0}function Bv({keeper:e}){const t=Kv(e.autonomy_level),n=Nt[t]??Nt[0];if(!n)return null;const s=(t+1)/Nt.length*100;return o`
  ...
  `}function Es(e){return e?e>=1e6?`${(e/1e6).toFixed(1)}M`:e>=1e3?`${(e/1e3).toFixed(1)}K`:String(e):"—"}function Uv(e){switch(e){case"keeper_message":return"message";case"keeper_probe":return"probe";case"keeper_recover":return"recover";case"broadcast":return"broadcast";case"room_pause":return"pause";case"room_resume":return"resume";case"lodge_tick":return"lodge";default:return(e==null?void 0:e.trim())||"action"}}function Hv(e){return e.recent_tool_names&&e.recent_tool_names.length>0?e.recent_tool_names:[]}function Wv(e){const t=e.metrics_window;return(Array.isArray(t==null?void 0:t.top_tools)?t.top_tools:[]).map(s=>typeof s=="object"&&s!==null&&"tool"in s&&typeof s.tool=="string"?s.tool:null).filter(s=>s!==null)}function Gv(e){const t=Xn.value;return t?t.keeper_briefs.find(n=>n.name===e.name||n.agent_name&&e.agent_name&&n.agent_name===e.agent_name)??null:null}function Jv({keeper:e}){const t=e.metrics_series??[],n=t[t.length-1],s=(n==null?void 0:n.cost_usd)!=null?`$${n.cost_usd.toFixed(4)}`:"—",a=[{label:"Generation",value:e.generation??"-",hint:"Succession count"},{label:"Turns",value:e.turn_count??"-",hint:"Total loop turns"},{label:"Context",value:e.context_ratio!=null?`${Math.round(e.context_ratio*100)}%`:"-",hint:e.context_ratio!=null&&e.context_ratio>.8?"Near limit":void 0},{label:"Activity",value:e.activityLevel??"-",hint:"Level 0–5"}];return o`
  ...
  `}function Vv({keeper:e}){var u,_;const t=e.metrics_series??[];if(t.length<2){const f=(((u=e.context)==null?void 0:u.context_ratio)??0)*100,h=f>85?"#ef4444":f>70?"#f59e0b":"#22c55e";return o`
  ...
  `}function Yv({stats:e}){const t=e.max_hp>0?Math.round(e.hp/e.max_hp*100):0,n=e.max_mp>0?Math.round(e.mp/e.max_mp*100):0;return o`
    <div>
  ...
  `}function Xv({items:e}){return e.length===0?o`<div class="empty-state" style="font-size:13px">No equipment</div>`:o`
  ...
  `}function Zv({rels:e}){const t=Object.entries(e);return t.length===0?o`<div class="empty-state" style="font-size:13px">No relationships</div>`:o`
  ...
  `}function a_(){var t,n,s;const e=mi.value;return e?o`
    <div
  ...
  `:null}function o_({cluster:e,project:t,room:n,generatedAt:s}){return o`
  ...
  `}function i_(){const e=gl.value,t=ve((e==null?void 0:e.status)??(yt.value?"bad":"warn")),n=!e||e.sections.length===0,s=(e==null?void 0:e.status)==="error"||(e==null?void 0:e.status)==="unavailable"&&!(e!=null&&e.cached);return o`
  ...
  `}function r_({item:e,selected:t,sessionLookup:n}){const s=hv(e),a=e.related_session_ids.map(l=>n.get(l)).filter(l=>l!=null),i=e.top_action??null;return o`
    <article class="mission-attention-card ${ve((i==null?void 0:i.severity)??e.severity)} ${t?"is-selected":""}">
      <button class="mission-card-select" onClick=${()=>kv(e.id)}>
        <div class="mission-card-head">
          <div>
            <strong>${e.summary}</strong>
            <div class="mission-card-target">${e.kind}${e.target_id?` · ${e.target_id}`:""}</div>
          </div>
          <span class="command-chip ${ve((i==null?void 0:i.severity)??e.severity)}">${i?fv(i):e.severity}</span>
        </div>
  ...
  `}function l_({brief:e,selected:t}){var i,l;const n=e.member_previews.slice(0,4),s=e.top_recommendation??null,a=e.top_attention??null;return o`
    <article class="mission-crew-card ${ve(((i=e.top_attention)==null?void 0:i.severity)??e.health??e.status)} ${t?"is-selected":""}">
      <button class="mission-card-select" onClick=${()=>Vl(e.session_id)}>
        ...
        <div class="mission-fact-grid">
          ...
          <div class="mission-fact-tile">
            <span>가동 시간</span>
            <strong>${gv(e.elapsed_sec)}</strong>
  ...
  `}function c_({detail:e,loading:t,error:n}){if(t&&!e)return o`
  ...
  `}function u_({item:e}){const t=e.action??null,n=e.attention??null;return o`
    ...
    <section class="dashboard-panel mission-view">
      ...
      ${a?o`
            <div class="mission-selection-bar">
              ...
              <button class="control-btn ghost" onClick=${xv}>선택 해제</button>
            </div>
          `:null}
      ...
      <${I} title="진행중인 세션" class="mission-list-card" semanticId="mission.session_briefs">
        ...
        <div class="mission-list-stack">
          ${t.length>0?t.map(A=>o`<${l_} key=${A.session_id} brief=${A} selected=${a===A.session_id} />`):o`<div class="empty-state">지금 활성 세션이 없습니다.</div>`}
        </div>
      <//>
      ...
      <div class="mission-human-grid">
        <${I} title="Attention Queue" class="mission-list-card" semanticId="mission.attention_queue">
          ...
          <div class="mission-lane-stack">
            ${p.length>0?p.map(A=>o`<${r_} key=${A.id} item=${A} selected=${Fe.value===A.id} sessionLookup=${i} />`):o`<div class="empty-state">지금 session-level attention queue가 비어 있습니다.</div>`}
          </div>
        <//>
        ...
        <${I} title="Internal Signals" class="mission-list-card" semanticId="mission.internal_signals">
          ...
          <details class="mission-card-disclosure">
            ...
            <div class="mission-list-stack">
              ${m.length>0?m.map(A=>o`<${u_} key=${A.id} item=${A} />`):o`<div class="empty-state">지금은 내부 진단 경고가 없습니다.</div>`}
            </div>
          </details>
        <//>
      </div>
      ...
      <${I} title="Keeper Continuity" class="mission-list-card" semanticId="mission.keeper_activity">
        ...
        <div class="mission-activity-list">
          ${c.length>0?c.map(A=>o`<${d_} key=${A.brief.name} row=${A} />`):o`<div class="empty-state">지금 보이는 keeper가 없습니다.</div>`}
        </div>
        <div class="mission-card-actions">
  ...
  `}const p_="modulepreload",m_=function(e){return"/dashboard/"+e},Qi={},v_=function(t,n,s){let a=Promise.resolve();if(n&&n.length>0){let l=function(m){return Promise.all(m.map(u=>Promise.resolve(u).then(_=>({status:"fulfilled",value:_}),_=>({status:"rejected",reason:_}))))};document.getElementsByTagName("link");const c=document.querySelector("meta[property=csp-nonce]"),p=(c==null?void 0:c.nonce)||(c==null?void 0:c.getAttribute("nonce"));a=l(n.map(m=>{if(m=m_(m),m in Qi)return;Qi[m]=!0;const u=m.endsWith(".css"),_=u?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${m}"]${_}`))return;const f=document.createElement("link");if(f.rel=u?"stylesheet":p_,u||(f.as="script"),f.crossOrigin="",f.href=m,p&&f.setAttribute("nonce",p),document.head.appendChild(f),u)return new Promise((h,b)=>{f.addEventListener("load",h),f.addEventListener("error",()=>b(new Error(`Unable to preload CSS for ${m}`)))})}))}function i(l){const c=new Event("vite:preloadError",{cancelable:!0});if(c.payload=l,window.dispatchEvent(c),!c.defaultPrevented)throw l}return a.then(l=>{for(const c of l||[])c.status==="rejected"&&i(c.reason);return t().catch(i)})};function ua(e){if(e==null)return"";if(typeof e=="string")return e;try{return JSON.stringify(e,null,2)}catch{return String(e)}}function Y(e){if(!e)return"n/a";const t=Date.parse(e);if(Number.isNaN(t))return e;const n=Math.max(0,Math.round((Date.now()-t)/1e3));return n<60?`${n}s ago`:n<3600?`${Math.round(n/60)}m ago`:n<86400?`${Math.round(n/3600)}h ago`:`${Math.round(n/86400)}d ago`}function __(e){if(!e)return"warn";const t=Date.parse(e);return Number.isNaN(t)?"warn":t<=Date.now()?"bad":"ok"}function sc(e){if(!e)return"n/a";const t=Date.parse(e);if(Number.isNaN(t))return e;const n=Math.round((t-Date.now())/1e3);return n<=0?"expired":n<60?`in ${n}s`:n<3600?`in ${Math.round(n/60)}m`:n<86400?`in ${Math.round(n/3600)}h`:`in ${Math.round(n/86400)}d`}function L(e){return e==="bad"?"bad":e==="warn"||e==="pending"?"warn":"ok"}let Yi=!1,g_=0;function f_(){return++g_}let Ba=null;async function $_(){Ba||(Ba=v_(()=>import("./mermaid.core-BD9jYBo9.js").then(t=>t.bE),[]).then(t=>t.default));const e=await Ba;return Yi||(e.initialize({startOnLoad:!1,theme:"dark",securityLevel:"loose"}),Yi=!0),e}function st(e){if(!e)return"warn";const t=e.toLowerCase();return t.includes("failed")||t.includes("error")||t.includes("disconnected")||t.includes("stopped")?"bad":t.includes("running")||t.includes("active")||t.includes("degraded")||t.includes("pending")?"warn":"ok"}function ns(e){return typeof e!="number"||!Number.isFinite(e)?"n/a":`${Math.round(e*100)}%`}function hn(e){return typeof e!="number"||!Number.isFinite(e)?"n/a":e<60?`${Math.round(e)}s`:e<3600?`${Math.round(e/60)}m`:`${Math.round(e/3600)}h`}function ss(e){return typeof e!="number"||!Number.isFinite(e)?0:Math.max(0,Math.min(100,e))}function $t(e,t){return typeof e!="number"||!Number.isFinite(e)||typeof t!="number"||!Number.isFinite(t)||t<=0?0:ss(e/t*100)}function h_(e,t){const n=ss(e);return`--gauge-angle:${Math.max(10,Math.round(n/100*360))}deg;--gauge-color:${t};`}function ac(e){if(!e)return"No recent chain history";const t=[e.event];return typeof e.duration_ms=="number"&&t.push(`${e.duration_ms}ms`),typeof e.tokens=="number"&&t.push(`${e.tokens} tokens`),e.message&&t.push(e.message),t.join(" · ")}const y_=[{id:"status",label:"현황"},{id:"history",label:"이력"},{id:"control",label:"통제"}],oc=[{id:"warroom",label:"워룸",group:"status"},{id:"summary",label:"요약",group:"status"},{id:"topology",label:"토폴로지",group:"status"},{id:"orchestra",label:"오케스트라",group:"status"},{id:"swarm",label:"스웜",group:"status"},{id:"operations",label:"작전",group:"history"},{id:"trace",label:"트레이스",group:"history"},{id:"chains",label:"체인",group:"history"},{id:"control",label:"제어",group:"control"},{id:"alerts",label:"알림",group:"control"}],b_=oc.map(e=>e.id),k_=["chain_start","node_start","node_complete","chain_complete","chain_error"],x_={warroom:{title:"라이브 워룸",description:"실제 run, worker, message, trace를 한 화면에서 따라가는 기본 진입 표면입니다."},operations:{title:"현재 작전 상세",description:"활성 operation, detachment, dependency를 먼저 읽는 기본 진입 표면입니다."},orchestra:{title:"룸 오케스트라 맵",description:"room, session, lane, worker, keeper를 한 장의 작전판으로 읽는 시각화 표면입니다."},swarm:{title:"스웜 실행 흐름",description:"lane 이동, worker 결속, blocker를 따라가며 현장감 있게 보는 표면입니다."},chains:{title:"체인 런타임",description:"체인 연결 상태와 operation별 실행 그래프를 확인하는 표면입니다."},topology:{title:"지휘 계층",description:"실제 managed unit인지, live agent 기반 자동 투영인지 구분해서 봅니다."},alerts:{title:"경보 모음",description:"지금 개입을 밀어올리는 alert만 모아서 보는 표면입니다."},trace:{title:"최근 트레이스",description:"operation, actor, unit 단위 이벤트를 시간순으로 보는 표면입니다."},control:{title:"승인과 제어",description:"decision 승인과 unit 제어를 실제로 수행하는 표면입니다."},summary:{title:"지휘 요약",description:"전체 지휘면을 한 번에 훑는 계기판 성격의 요약 표면입니다."}};function Xi(e){return!!e&&b_.includes(e)}function S_(){const e=F.value.params;return e.source!=="mission"&&e.source!=="execution"?{}:{source:e.source,...e.action_type?{action_type:e.action_type}:{},...e.target_type?{target_type:e.target_type}:{},...e.target_id?{target_id:e.target_id}:{},...e.focus_kind?{focus_kind:e.focus_kind}:{},...e.operation_id?{operation_id:e.operation_id}:{}}}function vi(e){const t=S_(),n=lc(),s=_i();if(e==="operations")return t;if(e==="chains"){const a=Vt.value;return a?{...t,surface:e,operation:a}:{...t,surface:e}}return e==="swarm"||e==="warroom"||e==="orchestra"?{...t,surface:e,...n?{run_id:n}:{},...s?{operation_id:s}:{}}:{...t,surface:e}}function A_(){const e=new URLSearchParams(window.location.search),t=new URLSearchParams,n=e.get("agent")??e.get("agent_name"),s=e.get("token");return n&&t.set("agent",n),s&&t.set("token",s),t.toString()?`/api/v1/chains/events?${t.toString()}`:"/api/v1/chains/events"}function C_(e){switch(e){case"company":return"중대 / Company";case"platoon":return"소대 / Platoon";case"squad":return"분대 / Squad";case"agent":return"에이전트 / Agent";default:return e}}function ie(e){return Po.value===e}function as(){return ti.value}function I_(e){var a,i,l,c,p,m,u;const t=ti.value,n=Pt.value,s=es.value;switch(e){case"warroom":return{tool:"masc_observe_operations",reason:"live run, worker, message, trace를 한 화면에서 보고 필요한 detail 표면으로 바로 점프합니다."};case"operations":return{tool:"masc_operation_status",reason:`활성 작전 ${((a=t==null?void 0:t.operations.summary)==null?void 0:a.active)??0}개와 dependency를 먼저 확인합니다.`};case"swarm":return{tool:(n==null?void 0:n.recommended_next_tool)??((l=(i=t==null?void 0:t.swarm_status)==null?void 0:i.recommended_next_action)==null?void 0:l.tool)??"masc_observe_traces",reason:((p=(c=t==null?void 0:t.swarm_status)==null?void 0:c.recommended_next_action)==null?void 0:p.reason)??"lane 이동과 blocker를 보고 다음 probe 도구를 고릅니다."};case"orchestra":return{tool:"masc_operator_snapshot",reason:"room, session, lane, worker, keeper를 한 장에서 훑은 뒤 drill-down 대상을 고릅니다."};case"chains":return{tool:(u=(m=s==null?void 0:s.operations[0])==null?void 0:m.preview_run)!=null&&u.chain_id?"masc_chain_run_get":"masc_chain_snapshot",reason:"체인 연결 상태와 최근 run 그래프를 함께 보면 병목을 빨리 좁힐 수 있습니다."};case"topology":return{tool:"masc_observe_topology",reason:"이 구조가 실제 관리 단위인지 자동 투영인지 먼저 구분해야 command-plane을 오해하지 않습니다."};case"alerts":return{tool:"masc_observe_alerts",reason:"경보에서 먼저 문제가 된 unit과 operation을 고릅니다."};case"trace":return{tool:"masc_observe_traces",reason:"trace 흐름으로 원인 이벤트를 바로 따라갈 수 있습니다."};case"control":return{tool:"masc_operator_action",reason:"승인이나 kill switch 같은 실제 조작은 control 표면과 operator action이 이어집니다."};case"summary":default:return{tool:"masc_observe_operations",reason:"요약을 본 뒤에는 현재 작전 표면으로 내려가 실제 움직임을 확인하는 게 가장 빠릅니다."}}}function T_(e){var n;const t=((n=e==null?void 0:e.focus_kind)==null?void 0:n.toLowerCase())??"";return t?t.includes("artifact_scope")||t.includes("routing_confidence")||t.includes("cache_contention")?"microarch":t.includes("leader_offline")||t.includes("roster_offline")?"alerts":t.includes("stale_data")?"swarm":null:null}function R_(e){var n;const t=((n=e==null?void 0:e.focus_kind)==null?void 0:n.toLowerCase())??"";return t?t.includes("stale_data")||t.includes("leader_offline")||t.includes("roster_offline")||t.includes("managed")?"recommendation":t.includes("gap")?"gaps":null:null}function ic(){if(typeof window>"u")return null;const e=new URLSearchParams(window.location.search),t=e.get("agent")??e.get("agent_name");if(!t)return null;const n=t.trim();return n===""?null:n}function rc(){if(typeof window>"u")return new URLSearchParams;const e=new URLSearchParams(window.location.search),t=window.location.hash.replace(/^#/,""),n=t.indexOf("?");return n>=0&&new URLSearchParams(t.slice(n+1)).forEach((a,i)=>{e.has(i)||e.set(i,a)}),e}function lc(){const t=rc().get("run_id");if(!t)return null;const n=t.trim();return n===""?null:n}function _i(){const t=rc().get("operation_id");if(!t)return null;const n=t.trim();return n===""?null:n}function P_(e){if(!e)return null;const t=Date.parse(e);return Number.isNaN(t)?null:Math.max(0,Math.round((Date.now()-t)/1e3))}function L_(e){return e.status==="claimed"||e.status==="in_progress"}function z_(e){const t=Zn.value;if(!t)return null;for(const n of t.golden_paths){const s=n.steps.find(a=>a.tool===e);if(s)return s}return null}function Ua(e){var t;return((t=Zn.value)==null?void 0:t.golden_paths.find(n=>n.id===e))??null}function M_(e){const t=Zn.value;if(!t)return[];const n=new Set(e);return t.pitfalls.filter(s=>n.has(s.id))}async function at(e){try{await e()}catch{}}function gi(e){return(e==null?void 0:e.trim().toLowerCase())??""}function qt(e){const t=gi(e);return t.includes("failed")||t.includes("error")||t.includes("stopped")||t==="paused"?"bad":t.includes("active")||t.includes("running")||t.includes("healthy")||t.includes("ok")?"ok":"warn"}function _s(e){const t=gi(e);return t?t==="active"||t==="running"?"진행 중":t==="paused"?"일시정지":t==="done"||t==="ended"||t==="completed"?"완료":t==="failed"||t==="error"||t==="stopped"?"문제":(e==null?void 0:e.trim())||"확인 필요":"확인 필요"}function N_(){var n,s,a,i,l,c,p,m,u;const e=Pt.value;if(!e)return!1;const t=e.workers.some(_=>_.joined||_.live_presence||_.completed||_.current_task_matches_run||_.heartbeat_fresh||_.claim_marker_seen||_.done_marker_seen||_.final_marker_seen||!!_.current_task||!!_.bound_task_id||!!_.last_message);return!!((n=e.operation)!=null&&n.operation_id||(s=e.detachment)!=null&&s.detachment_id||(((a=e.summary)==null?void 0:a.joined_workers)??0)>0||(((i=e.summary)==null?void 0:i.live_workers)??0)>0||(((l=e.summary)==null?void 0:l.current_task_bound)??0)>0||(((c=e.summary)==null?void 0:c.fresh_heartbeats)??0)>0||(((p=e.summary)==null?void 0:p.claim_markers_seen)??0)>0||(((m=e.summary)==null?void 0:m.done_markers_seen)??0)>0||(((u=e.summary)==null?void 0:u.final_markers_seen)??0)>0||t||e.recent_messages.length>0||e.recent_trace_events.length>0)}function E_(e){const t=gi(e.status);return t==="active"||t==="running"}function j_(){var i,l,c,p;const e=((i=_e.value)==null?void 0:i.sessions)??[],t=Pt.value,n=((l=t==null?void 0:t.detachment)==null?void 0:l.session_id)??null;if(n){const m=e.find(u=>u.session_id===n);if(m)return m}const s=((c=t==null?void 0:t.operation)==null?void 0:c.operation_id)??_i();if(s){const m=e.find(u=>u.command_plane_operation_id===s);if(m)return m}const a=((p=t==null?void 0:t.detachment)==null?void 0:p.detachment_id)??null;if(a){const m=e.find(u=>u.command_plane_detachment_id===a);if(m)return m}return e.find(E_)??e[0]??null}function Ha(e){return e==="proven"?"ok":e==="partial"?"warn":"bad"}function An(e){return Array.isArray(e)?e:[]}function Pe(e){return typeof e=="object"&&e!==null&&!Array.isArray(e)?e:{}}function gs(e){return typeof e=="string"&&e.trim()!==""?e:null}function w_(e){return typeof e=="number"&&Number.isFinite(e)?e:null}function D_(e){const t=e.split("/");return t.length<=3?e:`…/${t.slice(-3).join("/")}`}function O_(e){return e==="proven"?"협업 증거가 충분합니다":e==="partial"?"흔적은 있으나 협업 증거가 덜 모였습니다":"증거가 부족합니다"}function q_(e,t,n,s,a){const i=[`${t}명의 actor 흔적이 기록돼 있습니다.`,n>0?`서로를 참조한 상호작용 증거가 ${n}건 있습니다.`:"서로를 참조한 명시적 상호작용 증거가 아직 없습니다.",s>0?`도구·산출물·체크포인트 증거가 ${s}건 있습니다.`:"도구·산출물·체크포인트 증거가 거의 없습니다.",a>0?`CPv2 backing trace가 ${a}건 있어 실행 흔적은 남아 있습니다.`:"managed backing trace는 아직 없습니다."];return e==="partial"?[i[0]??"",n===0?"partial인 이유: 참여 흔적은 있지만 actor 간 상호작용이 직접 보이지 않습니다.":"partial인 이유: 일부 증거는 있으나 proven 기준을 모두 채우지 못했습니다.",a>0?"다음 보강 포인트: 대화/상호참조 event를 남기면 proof가 더 강해집니다.":"다음 보강 포인트: managed trace 또는 산출물 linkage를 더 남기면 proof가 강해집니다."]:e==="proven"?[i[0]??"","결론: 참여, 상호작용, 산출물, backing evidence가 모두 연결돼 있습니다.","다음 행동: raw evidence는 접어두고 세션 결과와 산출물만 확인하면 됩니다."]:[i[0]??"","결론: 기록은 있으나 협업을 증명할 만큼의 연결 증거가 부족합니다.","다음 보강 포인트: participant 간 turn, tool evidence, deliverable linkage를 더 남겨야 합니다."]}function F_(e){const t=new Map;for(const n of e){const s=[n.timestamp??"",n.event_type??"",n.actor??"",n.summary??""].join("|"),a=n.source??"unknown",i=t.get(s);if(i){i.sources.includes(a)||i.sources.push(a),!i.operation_id&&n.operation_id&&(i.operation_id=n.operation_id);continue}t.set(s,{...n,sources:[a]})}return[...t.values()]}function K_(e){return e.sources.length===2?"team + command":e.sources.length===1?e.sources[0]??"source":e.sources.join(" + ")}function B_(e){const t=[];for(const[n,s]of Object.entries(e))if(s!=null){if(typeof s=="string"){if(s.trim()==="")continue;t.push({label:n,value:s});continue}if(typeof s=="number"||typeof s=="boolean"){t.push({label:n,value:String(s)});continue}}return t}function U_(e){const t=Pe(e),n=Pe(t.traces),s=Array.isArray(n.events)?n.events:[],a=Pe(t.detachments),i=Array.isArray(a.detachments)?a.detachments:[],l=Pe(i[0]),c=Pe(l.detachment),p=Pe(l.operation),m=Pe(t.summary),u=Pe(m.operations),_=Pe(u.summary);return[{label:"operation",value:gs(t.operation_id)??"없음"},{label:"detachment",value:gs(t.detachment_id)??"없음"},{label:"trace events",value:`${s.length}`},{label:"detachment status",value:gs(c.status)??"없음"},{label:"operation stage",value:gs(p.stage)??"없음"},{label:"active ops",value:`${w_(_.active)??0}`}]}function H_({item:e}){return o`
  ...
  `}function W_({item:e}){const t=e.recent_output_preview??null,n=e.recent_input_preview??null,s=e.recent_event_summary??null,a=(e.interaction_count??0)>0?"ok":"warn";return o`
    ...
    <section class="dashboard-panel mission-view">
      ...
      <div class="mission-human-grid">
        <${I} title="Collaboration Timeline" class="mission-list-card" semanticId="proof.timeline">
          ...
          <div class="mission-list-stack">
            ${h.length>0?h.slice(0,18).map(M=>o`<${H_} key=${M.id} item=${M} />`):o`<div class="empty-state">표시할 timeline evidence가 없습니다.</div>`}
          </div>
        <//>
        ...
        <${I} title="Actor Contributions" class="mission-list-card" semanticId="proof.contributions">
          ...
          <div class="mission-activity-list">
            ${i.length>0?i.map(M=>o`<${W_} key=${M.actor} item=${M} />`):o`<div class="empty-state">표시할 actor contribution이 없습니다.</div>`}
          </div>
        <//>
      </div>
      ...
      <div class="mission-human-grid">
        ...
        <${I} title="Artifacts" class="mission-list-card" semanticId="proof.artifacts">
          ...
          <div class="mission-list-stack">
            ${l.length>0?l.map(M=>o`<${G_} key=${M.path} item=${M} />`):o`<div class="empty-state">기록된 artifact가 없습니다.</div>`}
          </div>
        <//>
      </div>
    </section>
  `}function V_(){const e=ts(F.value);return e?o`
  ...
  `}function fs({label:e,value:t,subtext:n,percent:s,color:a}){return o`
    <article class="command-gauge-card">
      <div class="command-gauge-ring" style=${h_(s,a)}>
  ...
  `}function eg(){return o`
    <${Y_} />
    <${X_} />
    <${Z_} />
  `}function tg(){return Xs.value?o`<div class="empty-state">command-plane detail 불러오는 중…</div>`:ea.value?o`<div class="empty-state error">${ea.value}</div>`:o`<div class="empty-state">surface를 선택하면 command-plane detail을 로드합니다.</div>`}const wo=g(null),er=1280,tr=760;function gn(e,t,n){if(e<=0)return[];if(e===1)return[Math.round((t+n)/2)];const s=(n-t)/(e-1);return Array.from({length:e},(a,i)=>Math.round(t+i*s))}function ng(e,t){const n=new Map;for(const s of e){const a=t(s),i=n.get(a)??[];i.push(s),n.set(a,i)}return n}function sg(e){const t=new Map,n=e.nodes,s=n.find(b=>b.kind==="room")??null,a=n.filter(b=>b.kind==="session"),i=n.filter(b=>b.kind==="operation"),l=n.filter(b=>b.kind==="detachment"),c=n.filter(b=>b.kind==="lane"),p=n.filter(b=>b.kind==="worker"),m=n.filter(b=>b.kind==="keeper");s&&t.set(s.id,{x:640,y:96}),gn(a.length,170,1110).forEach((b,$)=>{const S=a[$];S&&t.set(S.id,{x:b,y:220})}),gn(i.length,240,1040).forEach((b,$)=>{const S=i[$];S&&t.set(S.id,{x:b,y:330})}),gn(l.length,300,980).forEach((b,$)=>{const S=l[$];S&&t.set(S.id,{x:b,y:420})}),gn(c.length,170,1110).forEach((b,$)=>{const S=c[$];S&&t.set(S.id,{x:b,y:530})});const u=new Map(c.map(b=>{const $=t.get(b.id);return $?[b.id,$.x]:null}).filter(b=>b!==null)),_=ng(p,b=>b.lane_id?`lane:${b.lane_id}`:b.parent_id?b.parent_id:"free");let f=0;for(const[b,$]of _){let S=u.get(b);if(S==null){const x=t.get(b);S=x==null?void 0:x.x}S==null&&(S=180+f%5*200,f+=1),gn($.length,S-90,S+90).forEach((x,z)=>{const T=$[z];if(!T)return;const P=z>5?Math.floor(z/6):0;t.set(T.id,{x,y:635+P*62})})}const h=m.length>3?[1120,1180]:[1140];return m.forEach((b,$)=>{const S=$%h.length,A=Math.floor($/h.length);t.set(b.id,{x:h[S]??1140,y:190+A*108})}),t}function ag(e,t){const n=(e.x+t.x)/2,s=t.y>=e.y?32:-32;return`M ${e.x} ${e.y} C ${n} ${e.y+s}, ${n} ${t.y-s}, ${t.x} ${t.y}`}function nr(e,t,n){if(e==="command"){if(t){nt(t),se("command",{...vi(t),...n});return}se("command",n);return}if(e==="intervene"){se("intervene",n);return}se("command",n)}function og(e){switch(e.kind){case"room":return{width:150,height:150,radius:74};case"worker":return{width:78,height:42,radius:22};case"lane":return{width:170,height:54,radius:16};case"keeper":return{width:120,height:56,radius:24};default:return{width:188,height:64,radius:18}}}function ig({orchestra:e,roomPoint:t,onSelect:n}){if(!t||e.signals.length===0)return null;const s=108;return o`
    ${e.signals.slice(0,6).map((a,i)=>{const l=(-120+i*38)*(Math.PI/180),c=Math.round(t.x+Math.cos(l)*s),p=Math.round(t.y+Math.sin(l)*s);return o`
      ...
      `})}
  `}function rg({edges:e,positions:t,selectedId:n}){return o`
    ${e.map(s=>{const a=t.get(s.source),i=t.get(s.target);if(!a||!i)return null;const l=n!=null&&(s.source===n||s.target===n);return o`
        ...
        />
      `})}
  `}function lg({orchestra:e,positions:t,selectedId:n,onSelect:s}){var i;const a=((i=e.focus)==null?void 0:i.target_kind)==="node"?e.focus.target_id:null;return o`
    ${e.nodes.map(l=>{const c=t.get(l.id);if(!c)return null;const p=og(l),m=l.id===n,u=l.id===a;if(l.kind==="room")return o`
          <g
            key=${l.id}
  ...
  `}function dg(){var i,l,c,p;const e=ni.value;if(zo.value&&!e)return o`<section class="card command-section"><div class="empty-state">오케스트라 맵 불러오는 중…</div></section>`;if(oa.value)return o`<section class="card command-section"><div class="empty-state error">${oa.value}</div></section>`;if(!e)return o`<section class="card command-section"><div class="empty-state">오케스트라 맵 데이터가 아직 없습니다.</div></section>`;const t=sg(e),n=cc(e),s=(n==null?void 0:n.value.id)??null,a=e.nodes.find(m=>m.kind==="room")?t.get(e.nodes.find(m=>m.kind==="room").id)??null:null;return o`
      ...
      <div class="orchestra-shell">
        <div class="orchestra-canvas-wrap">
          <svg class="orchestra-canvas" viewBox=${`0 0 ${er} ${tr}`}>
            ...
            <${rg} edges=${e.edges} positions=${t} selectedId=${s} />
            <${ig} orchestra=${e} roomPoint=${a} onSelect=${m=>{wo.value=m}} />
            <${lg}
              orchestra=${e}
              positions=${t}
              selectedId=${s}
  ...
  `}const dc="masc_dashboard_agent_name";function ug(){var t,n,s;const e=new URLSearchParams(window.location.search);return((t=e.get("agent"))==null?void 0:t.trim())||((n=e.get("agent_name"))==null?void 0:n.trim())||((s=localStorage.getItem(dc))==null?void 0:s.trim())||"dashboard"}const Na=g(ug()),Xt=g(""),pa=g("운영 점검"),Zt=g(""),On=g(""),qn=g("2"),an=g(""),he=g("note"),Fn=g(""),Kn=g(""),Bn=g(""),Un=g("2"),Hn=g(""),ma=g("운영자 중지 요청"),va=g(""),en=g(""),hs=g(null);function pg(e){const t=e.trim()||"dashboard";Na.value=t,localStorage.setItem(dc,t)}function _a(e){if(e==null)return"";if(typeof e=="string")return e;try{return JSON.stringify(e,null,2)}catch{return String(e)}}function fi(e){switch((e??"").trim().toLowerCase()){case"judgment":return"Resident judgment";case"fallback":return"Fallback read model";default:return(e==null?void 0:e.trim())||"Guidance"}}function ga(e){switch((e??"").trim().toLowerCase()){case"judgment":return"ok";case"fallback":return"warn";default:return"warn"}}function $i(e){return e!=null&&e.enabled?e.refreshing?"갱신 중":e.judge_online?"온라인":e.last_error?"오류":"대기":"꺼짐"}function mg(e){return e!=null&&e.enabled?e.judge_online?"ok":e.refreshing?"warn":"bad":"warn"}function hi(e){return e!=null&&e.fresh_until?e.fresh_until:"freshness 없음"}function sr(e){return typeof e!="number"||!Number.isFinite(e)?"확인 없음":e<60?`${Math.round(e)}초 전`:e<3600?`${Math.round(e/60)}분 전`:`${Math.round(e/3600)}시간 전`}function on(e){return typeof e=="string"?e.trim().toLowerCase():""}function vg(e){var s;const t=on(e.status);if(t==="paused")return"bad";if(t===""||t==="unknown")return"warn";const n=on((s=e.team_health)==null?void 0:s.status);return n&&n!=="ok"&&n!=="healthy"&&n!=="green"||t&&t!=="active"&&t!=="running"&&t!=="ended"?"warn":"ok"}function Wa(e){const t=on(e.status);return t==="offline"||t==="inactive"||t==="error"?"bad":t===""||t==="unknown"||(e.context_ratio??0)>=.8||e.context_ratio==null||e.last_turn_ago_s==null||(e.last_turn_ago_s??0)>=3600?"warn":"ok"}function ar(e){return e.some(t=>on(t.severity)==="bad")?"bad":e.length>0?"warn":"ok"}function _g(e){return e.target_type==="team_session"}function gg(e){return e.target_type==="keeper"}function It(e){switch(e){case"broadcast":return"방송";case"room_pause":return"room 일시정지";case"room_resume":return"room 재개";case"team_turn":return"세션 업데이트";case"team_note":return"세션 노트";case"team_broadcast":return"세션 방송";case"team_task_inject":return"세션 작업 주입";case"team_worker_spawn_batch":return"세션 worker 교체";case"task_inject":return"작업 주입";case"team_stop":return"세션 중지";case"keeper_message":return"keeper 메시지";case"keeper_msg":return"keeper 메시지";case"swarm_run_continue":return"swarm run 계속";case"swarm_run_rerun":return"swarm run 재실행";case"swarm_run_abandon":return"swarm run 포기";default:return(e==null?void 0:e.trim())||"액션"}}function tn(e){switch(e){case"room":return"room";case"team_session":return"session";case"keeper":return"keeper";case"swarm_run":return"swarm run";default:return(e==null?void 0:e.trim())||"target"}}function Ft(e){switch(on(e)){case"running":case"active":return"진행 중";case"paused":return"일시정지";case"ended":case"done":return"종료";case"offline":return"오프라인";case"idle":return"대기";case"unknown":case"":return"확인 필요";default:return(e==null?void 0:e.trim())||"확인 필요"}}function fa(e){return e?"확인 후 실행":"즉시 실행"}function fg(e){switch(e){case"note":return"노트";case"broadcast":return"방송";case"task":return"작업";case"worker_spawn_batch":return"worker 교체";default:return e}}function ue(e,t){if(!e)return null;const n=e[t];return typeof n=="string"&&n.trim()!==""?n.trim():typeof n=="number"&&Number.isFinite(n)?String(n):null}function $g(e){return!e||typeof e!="object"||Array.isArray(e)?null:e}function hg(e){if(!e)return"";const t=e.spawn_batch;return _a(t!==void 0?t:e)}function uc(e){const t=$g(e.payload);if(e.target_type==="room"){if(e.action_type==="broadcast"){Xt.value=ue(t,"message")??e.summary;return}if(e.action_type==="task_inject"){Zt.value=ue(t,"title")??"운영자 주입 작업",On.value=ue(t,"description")??e.summary,qn.value=ue(t,"priority")??qn.value;return}e.action_type==="room_pause"&&(pa.value=ue(t,"reason")??e.summary);return}if(e.target_type==="team_session"){if(e.target_id&&(an.value=e.target_id),e.action_type==="team_stop"){ma.value=ue(t,"reason")??e.summary;return}he.value=e.action_type==="team_worker_spawn_batch"?"worker_spawn_batch":e.action_type==="team_task_inject"?"task":e.action_type==="team_broadcast"?"broadcast":"note";const n=ue(t,"message");if(n&&(Fn.value=n),he.value==="worker_spawn_batch"){Hn.value=hg(t);return}he.value==="task"&&(Kn.value=ue(t,"task_title")??ue(t,"title")??"운영자 주입 작업",Bn.value=ue(t,"task_description")??ue(t,"description")??e.summary,Un.value=ue(t,"task_priority")??ue(t,"priority")??Un.value);return}e.target_type==="keeper"&&(e.target_id&&(va.value=e.target_id),en.value=ue(t,"message")??e.summary)}function yg(e){uc({action_type:e.action_type,target_type:e.target_type,target_id:e.target_id,payload:e.suggested_payload,summary:e.summary})}function bg(e){uc({action_type:e.action_type,target_type:e.target_type,target_id:e.target_id??null,payload:e.suggested_payload,summary:e.reason}),E("추천 액션 payload를 폼에 채웠습니다","success")}function kg(e,t,n){return!e||!e.target_type||e.target_type==="room"?!0:e.target_type==="team_session"?!!e.target_id&&t.some(s=>s.session_id===e.target_id):e.target_type==="keeper"?!!e.target_id&&n.some(s=>s.name===e.target_id):!0}async function rt(e){const t=Na.value.trim()||"dashboard";try{const n=await vl({actor:t,action_type:e.action_type,target_type:e.target_type,target_id:e.target_id,payload:e.payload});return n.confirm_required?E("확인 대기열에 올렸습니다","warning"):E(e.successMessage,"success"),n}catch(n){const s=n instanceof Error?n.message:"개입 실행에 실패했습니다";return E(s,"error"),null}}async function or(){const e=Xt.value.trim();if(!e)return;await rt({action_type:"broadcast",target_type:"room",payload:{message:e},successMessage:"방송을 보냈습니다"})&&(Xt.value="")}async function xg(){await rt({action_type:"room_pause",target_type:"room",payload:{reason:pa.value.trim()||"운영 점검"},successMessage:"room 일시정지를 요청했습니다"})}async function pc(){await rt({action_type:"room_resume",target_type:"room",payload:{},successMessage:"room 재개를 요청했습니다"})}async function Sg(){const e=Zt.value.trim();if(!e)return;await rt({action_type:"task_inject",target_type:"room",payload:{title:e,description:On.value.trim()||"Intervene 화면에서 주입",priority:Number.parseInt(qn.value,10)||2},successMessage:"작업 주입을 보냈습니다"})&&(Zt.value="",On.value="")}async function Ag(){var l;const e=_e.value,t=an.value||((l=e==null?void 0:e.sessions[0])==null?void 0:l.session_id)||"";if(!t){E("먼저 세션을 고르세요","warning");return}const n={};if(he.value==="worker_spawn_batch"){const c=Hn.value.trim();if(!c){E("spawn_batch JSON을 먼저 채우세요","warning");return}try{const m=JSON.parse(c);if(Array.isArray(m))n.spawn_batch=m;else if(m&&typeof m=="object"&&Array.isArray(m.spawn_batch))n.spawn_batch=m.spawn_batch;else{E("spawn_batch는 배열 또는 { spawn_batch: [...] } 형태여야 합니다","warning");return}}catch(m){const u=m instanceof Error?m.message:"spawn_batch JSON 파싱에 실패했습니다";E(u,"error");return}await rt({action_type:"team_worker_spawn_batch",target_type:"team_session",target_id:t,payload:n,successMessage:"worker 교체 요청을 적용했습니다"})&&(Hn.value="");return}const s=Fn.value.trim();s&&(n.message=s);let a="team_note";he.value==="broadcast"?a="team_broadcast":he.value==="task"&&(a="team_task_inject"),he.value==="task"&&(n.task_title=Kn.value.trim()||"운영자 주입 작업",n.task_description=Bn.value.trim()||"Intervene 화면에서 주입",n.task_priority=Number.parseInt(Un.value,10)||2),await rt({action_type:a,target_type:"team_session",target_id:t,payload:n,successMessage:"세션 액션을 적용했습니다"})&&(Fn.value="",he.value==="task"&&(Kn.value="",Bn.value=""))}async function Cg(){var n;const e=_e.value,t=an.value||((n=e==null?void 0:e.sessions[0])==null?void 0:n.session_id)||"";if(!t){E("먼저 세션을 고르세요","warning");return}await rt({action_type:"team_stop",target_type:"team_session",target_id:t,payload:{reason:ma.value.trim()||"운영자 중지 요청"},successMessage:"세션 중지를 요청했습니다"})}async function Ig(){var a;const e=_e.value,t=va.value||((a=e==null?void 0:e.keepers[0])==null?void 0:a.name)||"",n=en.value.trim();if(!t){E("먼저 keeper를 고르세요","warning");return}if(!n)return;await rt({action_type:"keeper_message",target_type:"keeper",target_id:t,payload:{message:n},successMessage:`${t}에게 메시지를 보냈습니다`})&&(en.value="")}async function ir(e,t="confirm"){const n=Na.value.trim()||"dashboard";try{await _l(n,e,t),E(t==="deny"?"승인 대기를 거부했습니다":"확인 실행을 완료했습니다","success")}catch(s){const a=s instanceof Error?s.message:t==="deny"?"승인 대기 거부에 실패했습니다":"확인 실행에 실패했습니다";E(a,"error")}}function mc(e){switch(e){case"explicit":return"실제 관리 단위";case"hybrid":return"관리 단위 + 자동 보강";case"auto":return"자동 투영";default:return"source unknown"}}function vc(e){switch(e){case"explicit":return"ok";case"hybrid":return"warn";case"auto":return"warn";default:return"warn"}}function Tg(e){switch(e){case"explicit":return"지금 보이는 unit은 실제로 정의된 command-plane 관리 단위입니다.";case"hybrid":return"일부는 실제 관리 단위이고, 비어 있는 부분은 live agent roster를 보고 자동 보강한 구조입니다.";case"auto":return"이 화면은 live agent roster를 command-plane 모양으로 자동 투영한 것입니다. 실제 명령 체계와 1:1로 같다고 보면 안 됩니다.";default:return"이 화면은 managed topology와 effective topology가 섞여 있을 수 있습니다."}}function Rg(e){const t=e.unit.source??"unknown";return t==="explicit"?e.active_operation_count&&e.active_operation_count>0?"실제 관리 단위이며 연결된 작전이 있습니다.":"실제 관리 단위이지만 현재 연결된 작전은 없습니다.":t==="hybrid"?e.active_operation_count&&e.active_operation_count>0?"관리 단위를 기반으로 자동 보강된 구조이며 일부 작전이 연결돼 있습니다.":"관리 단위를 기반으로 자동 보강된 구조이며 현재 실행 연결은 약합니다.":e.active_operation_count&&e.active_operation_count>0?"자동 생성된 구조이지만 이 노드에 연결된 작전 흔적은 있습니다.":"자동 생성된 구조이며 현재 실행 연결은 없습니다."}function _c({node:e,depth:t=0}){const n=e.roster_live??0,s=e.roster_total??e.unit.roster.length,a=e.active_operation_count??0,i=e.unit.policy,l=e.unit.source??"unknown",c=a>0?`${a}개 작전 연결`:"실행 연결 없음";return o`
    <div class="command-tree-node depth-${Math.min(t,3)}">
      <div class="command-tree-head">
        <div>
          <div class="command-tree-title-row">
            <strong>${e.unit.label}</strong>
            <span class="command-chip">${C_(e.unit.kind)}</span>
          ...
          <div class="command-card-sub">${Rg(e)}</div>
  ...
  `}function Lg(){const e=De.value,t=e==null?void 0:e.topology,n=t==null?void 0:t.source,s=t==null?void 0:t.summary,a=(s==null?void 0:s.managed_unit_count)??0,i=(s==null?void 0:s.active_operation_count)??0;return o`
    <section class="card command-section">
      <div class="card-title-row">
  ...
  `}function zg(){const e=De.value;return o`
    <section class="card command-section">
      ...
      ${e&&e.alerts.alerts.length>0?o`<div class="command-card-stack">
            ${e.alerts.alerts.map(t=>o`<${Pg} alert=${t} />`)}
          </div>`:o`<div class="empty-state">지금 올라온 command-plane 경보는 없습니다.</div>`}
    </section>
  `}function Mg(){const e=De.value;return o`
    <section class="card command-section">
      <div class="card-title-row">
  ...
  `}function Ng(e){if(typeof e=="string")return e;if(e==null)return"";try{return JSON.stringify(e,null,2)}catch{return String(e)}}function Eg(e,t){return(t==null?void 0:t.status)==="abandoned"||(e==null?void 0:e.recommended_kind)==="continue"?"warn":(e==null?void 0:e.recommended_kind)==="rerun"?"bad":"ok"}function jg(e){switch(e){case"continue":case"continued":return"계속";case"rerun":return"재실행";case"abandon":case"abandoned":return"포기";default:return(e==null?void 0:e.trim())||"결정"}}function gc({swarm:e}){var _,f;const t=e.run_id,n=e.resolution_recommendation,s=e.run_resolution;if(!t||!n&&!s)return null;const a=ic()??"dashboard",i=((_=_e.value)==null?void 0:_.pending_confirms.find(h=>h.target_type==="swarm_run"&&h.target_id===t))??null,l=Eg(n,s),c=((f=e.operation)==null?void 0:f.operation_id)??e.operation_id??void 0,p={run_id:t};c&&(p.operation_id=c),n!=null&&n.reason&&(p.reason=n.reason);const m=async h=>{await vl({actor:a,action_type:h,target_type:"swarm_run",target_id:t,payload:p})},u=async h=>{i&&await _l(a,i.confirm_token,h)};return o`
    <article class="command-guide-card ${L(l)}">
      <div class="command-guide-head">
        <strong>Run Resolution</strong>
        <span class="command-chip ${L(l)}">
          ${jg((s==null?void 0:s.status)??(n==null?void 0:n.recommended_kind)??null)}
        </span>
      </div>
      <p>
      ...
      ${i?o`
            <div class="command-guide-card warn">
              ...
              ${i.preview?o`<pre class="command-trace-detail">${Ng(i.preview)}</pre>`:null}
              <div class="command-action-row">
  ...
  `}function wg({total:e}){const n=Math.min(e,20),s=e>20?e-20:0,a=Array.from({length:n});return o`
  ...
  `}function Dg({lane:e}){const t=e.counts??{},n=fc(e),s=t.workers??0,a=t.operations??0,i=t.detachments??0,l=a+i,c=e.motion_state==="moving"?84:e.motion_state==="waiting"?58:e.motion_state==="terminal"?100:26;return o`
  ...
  `}function Og({event:e}){const t=e.timestamp?new Date(e.timestamp):null,n=t&&!isNaN(t.getTime())?t:null,s=n?`${String(n.getHours()).padStart(2,"0")}:${String(n.getMinutes()).padStart(2,"0")}`:"";return o`
  ...
  `}function Fg({proof:e}){const t=(e==null?void 0:e.status)==="missing"?"warn":(e==null?void 0:e.pass)===!1?"bad":(e==null?void 0:e.pass)===!0?"ok":"warn";return o`
      ...
      ${s?o`
            ...
            <div class="command-swarm-layout ${u?"compact":""}">
              <div class="command-card-stack">
                ${i.length>0?i.map(_=>o`<${Dg} lane=${_} />`):o`<div class="empty-state">활성 스웜 레인이 없습니다.</div>`}
              </div>
              ...
              <div class="command-card-stack">
                ...
                <div class="command-guide-card ${l.length>0?"warn":"ok"} ${n==="gaps"?"focus":""}">
                  ...
                  ${l.length>0?o`<div class="swarm-event-rail">${l.slice(0,4).map(_=>o`<${qg} gap=${_} />`)}</div>`:o`<p>지금 보이는 핵심 공백은 없습니다.</p>`}
                </div>
                ...
                <div class="command-guide-card">
                  ...
                  ${c.length>0?o`<div class="swarm-event-rail">${c.map(_=>o`<${Og} event=${_} />`)}</div>`:o`<p>붙어 있는 최근 이동 이벤트가 아직 없습니다.</p>`}
                </div>
              </div>
            </div>
          `:o`<div class="empty-state">스웜 상태를 아직 불러오지 못했습니다.</div>`}
    </section>
  `}function Bg({item:e}){return o`
  ...
  `}function Qg({source:e}){const t=Bc(null),[n,s]=xr(null);return ne(()=>{let a=!1;const i=t.current;return i?(i.innerHTML="",s(null),(async()=>{try{const c=await $_(),{svg:p}=await c.render(`command-chain-${f_()}`,e);if(a||!t.current)return;t.current.innerHTML=p}catch(c){if(a)return;s(c instanceof Error?c.message:"Mermaid render failed")}})(),()=>{a=!0,t.current&&(t.current.innerHTML="")}):void 0},[e]),o`
    <div class="command-chain-graph-shell">
      ${n?o`<div class="empty-state error">${n}</div>`:null}
      <div class="command-chain-graph" ref=${t}></div>
    </div>
  `}function Yg({overlay:e,selected:t,onSelect:n}){const s=e.operation.chain,a=e.runtime;return o`
  ...
  `}function ef({card:e}){const t=e.operation,n=`pause:${t.operation_id}`,s=`resume:${t.operation_id}`,a=`recall:${t.operation_id}`,i=t.chain,l=(i==null?void 0:i.run_id)??null;return o`
    <article class="command-card">
      ...
      <div class="command-action-row">
        ...
        ${t.source==="managed"&&t.status==="active"?o`
              <button class="control-btn ghost" disabled=${ie(n)} onClick=${()=>at(()=>Vm(t.operation_id))}>
                ${ie(n)?"Pausing…":"Pause"}
              </button>
              <button class="control-btn ghost" disabled=${ie(a)} onClick=${()=>at(()=>Ym(t.operation_id))}>
                ${ie(a)?"Recalling…":"Recall"}
              </button>
            `:null}
        ${t.source==="managed"&&t.status==="paused"?o`
              <button class="control-btn ghost" disabled=${ie(s)} onClick=${()=>at(()=>Qm(t.operation_id))}>
                ${ie(s)?"Resuming…":"Resume"}
              </button>
            `:null}
      </div>
    </article>
  `}function tf({card:e}){var n;const t=e.detachment;return o`
    <article class="command-card compact">
      <div class="command-card-head">
        <div>
      ...
      <div class="command-tag-row">
        ${t.heartbeat_deadline?o`<span class="command-tag ${__(t.heartbeat_deadline)}">
              deadline ${t.heartbeat_deadline}
            </span>`:null}
      </div>
    </article>
  `}function nf(){const e=De.value;return o`
    <div class="command-surface-grid">
      <section class="card command-section">
        <div class="card-title-row">
        ...
        ${e&&e.operations.operations.length>0?o`<div class="command-card-stack">
              ${e.operations.operations.map(t=>o`<${ef} card=${t} />`)}
      ...
      <section class="card command-section">
        ...
        <div class="command-chain-history">
          ...
          ${e&&e.recent_history.length>0?o`
                <div class="command-card-stack">
                  ${e.recent_history.slice(0,6).map(R=>o`<${Xg} item=${R} />`)}
                </div>
  ...
  `}function af({decision:e}){const t=`approve:${e.decision_id}`,n=`deny:${e.decision_id}`,s=e.source==="projected_operator";return o`
    <article class="command-card ${L(e.status)}">
      ...
      ${e.status==="pending"&&!s?o`
            <div class="command-action-row">
              <button class="control-btn ghost" disabled=${ie(t)} onClick=${()=>at(()=>Zm(e.decision_id))}>
                ${ie(t)?"Approving…":"Approve"}
              </button>
              <button class="control-btn ghost" disabled=${ie(n)} onClick=${()=>at(()=>ev(e.decision_id))}>
                ${ie(n)?"Denying…":"Deny"}
              </button>
            </div>
          `:null}
  ...
  `}function of({row:e}){var c,p,m;const t=e.unit,n=`freeze:${t.unit_id}`,s=`kill:${t.unit_id}`,a=!!((c=t.policy)!=null&&c.frozen),i=!!((p=t.policy)!=null&&p.kill_switch),l=Math.round((e.utilization??0)*100);return o`
    <article class="command-card compact">
      <div class="command-card-head">
        <div>
      ...
      <div class="command-action-row">
        <button class="control-btn ghost" disabled=${ie(n)} onClick=${()=>at(()=>tv(t.unit_id,!a))}>
          ${ie(n)?"Applying…":a?"Unfreeze":"Freeze"}
        </button>
        <button class="control-btn ghost" disabled=${ie(s)} onClick=${()=>at(()=>nv(t.unit_id,!i))}>
          ${ie(s)?"Applying…":i?"Clear Kill Switch":"Enable Kill Switch"}
        </button>
      </div>
    </article>
  `}function rf(){const e=De.value;return o`
    <div class="command-surface-grid">
      <section class="card command-section">
        <div class="card-title-row">
        ...
        ${e&&e.decisions.decisions.length>0?o`<div class="command-card-stack">
              ${e.decisions.decisions.map(t=>o`<${af} decision=${t} />`)}
      ...
      <section class="card command-section">
        ...
        ${e&&e.capacity.capacity.length>0?o`<div class="command-card-stack">
              ${e.capacity.capacity.map(t=>o`<${of} row=${t} />`)}
            </div>`:o`<div class="empty-state">제어할 capacity 행이 아직 없습니다.</div>`}
      </section>
    </div>
  `}function lf(){return o`
  ...
  `}function cf(){if(G.value==="warroom")return o`<${Vg} />`;if(G.value==="summary")return o`<${eg} />`;if(G.value==="orchestra")return o`<${dg} />`;if(G.value==="swarm")return o`<${Hg} />`;if(!De.value)return o`<${tg} />`;switch(G.value){case"chains":return o`<${sf} />`;case"topology":return o`<${Lg} />`;case"alerts":return o`<${zg} />`;case"trace":return o`<${Mg} />`;case"control":return o`<${rf} />`;case"operations":default:return o`<${nf} />`}}function df(){return ne(()=>{Ot(),Qt(),Jm(),Qe(),St()},[]),ne(()=>{if(F.value.tab!=="command")return;const e=F.value.params.surface,t=F.value.params.operation,n=ts(F.value);if(Xi(e))nt(e);else if(n){const s=Ul(n);Xi(s)&&nt(s)}else e||nt("warroom");t&&ii(t),(e==="swarm"||e==="warroom"||e==="orchestra"||G.value==="warroom"||G.value==="orchestra")&&Qe(),(e==="orchestra"||G.value==="orchestra")&&St(),(e==="warroom"||G.value==="warroom")&&ye()},[F.value.tab,F.value.params.surface,F.value.params.operation,F.value.params.operation_id,F.value.params.run_id,F.value.params.source,F.value.params.action_type,F.value.params.target_type,F.value.params.target_id,F.value.params.focus_kind]),ne(()=>{let e=null;const t=()=>{e||(e=window.setTimeout(()=>{e=null,Ot(),Qt(),(G.value==="swarm"||G.value==="warroom"||G.value==="orchestra")&&Qe(),G.value==="orchestra"&&St(),G.value==="warroom"&&ye()},250))},n=new EventSource(A_()),s=k_.map(a=>{const i=()=>t();return n.addEventListener(a,i),{type:a,handler:i}});return n.onerror=()=>{t()},()=>{s.forEach(({type:a,handler:i})=>{n.removeEventListener(a,i)}),n.close(),e&&window.clearTimeout(e)}},[]),ne(()=>{const e=window.setInterval(()=>{if(document.visibilityState==="hidden")return;const t=G.value;t!=="swarm"&&t!=="warroom"&&t!=="orchestra"||(Ot(),Qe(),t==="orchestra"&&St(),t==="warroom"&&ye())},5e3);return()=>{window.clearInterval(e)}},[]),o`
      ...
      <section class="card ops-panel ops-lane-panel">
        ...
        <div class="control-row ops-split-row">
          <input
            ...
            disabled=${W.value}
          />
          <button class="control-btn ghost" onClick=${()=>{xg()}} disabled=${W.value}>
            일시정지
          </button>
        ...
        <div class="control-row ops-split-row">
          ...
          <button class="control-btn" onClick=${()=>{Sg()}} disabled=${W.value||Zt.value.trim()===""}>
            주입
          </button>
        </div>
      </section>
              ...
              <article key=${`${x.action_type}:${x.target_type}:${x.target_id??"room"}`} class="ops-log-entry ${x.severity}">
                ...
                ${x.suggested_payload?o`
                  <div class="ops-confirmation-actions">
                    <button class="control-btn ghost" onClick=${()=>{bg(x)}} disabled=${W.value}>
                      폼에 채우기
                    </button>
                  </div>
                `:null}
    ...
    <div class="ops-column">
      ...
      <section class="card ops-panel ops-lane-panel">
        ...
        <div class="control-row ops-split-row">
          ...
          <button class="control-btn" onClick=${()=>{Ag()}} disabled=${W.value||!a}>
            적용
          </button>
        </div>
        <div class="ops-context-note">현재 선택: ${fg(he.value)}</div>
        ...
        <div class="control-row ops-split-row">
          <input
            ...
            disabled=${W.value||!a}
          />
          <button class="control-btn ghost" onClick=${()=>{Cg()}} disabled=${W.value||!a}>
            세션 중지
          </button>
        </div>
      </section>
    </div>
  `}function mf(){var i;const e=_e.value,t=(e==null?void 0:e.keepers)??[],n=(e==null?void 0:e.persistent_agents)??[],s=(e==null?void 0:e.available_actions)??[],a=t.find(l=>l.name===va.value)??t[0]??null;return o`
    <div class="ops-column">
      ...
      <section class="card ops-panel ops-lane-panel">
        ...
        ></textarea>
        <div class="control-row">
          <button class="control-btn" onClick=${()=>{Ig()}} disabled=${W.value||!a||en.value.trim()===""}>
            keeper에 보내기
          </button>
        </div>
      </section>
  ...
  `}function _f({text:e}){if(!e)return null;const t=gf(e);return o`<div class="markdown-content">${t}</div>`}function gf(e){const t=e.split(`
...
`))}</p>`)}return n}function Ga(e){const t=[],n=/(`[^`]+`)|(\*\*[^*]+\*\*)|(\*[^*]+\*)|\[([^\]]+)\]\(([^)]+)\)/g;let s=0,a;for(;(a=n.exec(e))!==null;){if(a.index>s&&t.push(e.slice(s,a.index)),a[1]){const i=a[1].slice(1,-1);t.push(o`<code>${i}</code>`)}else if(a[2]){const i=a[2].slice(2,-2);t.push(o`<strong>${i}</strong>`)}else if(a[3]){const i=a[3].slice(1,-1);t.push(o`<em>${i}</em>`)}else a[4]&&a[5]&&t.push(o`<a href=${a[5]} target="_blank" rel="noopener">${a[4]}</a>`);s=a.index+a[0].length}return s<e.length&&t.push(e.slice(s)),t.length>0?t:[e]}const bc=[{id:"recent",label:"Latest"},{id:"hot",label:"Hot"},{id:"trending",label:"Trending"},{id:"updated",label:"Updated"},{id:"discussed",label:"Discussed"}],js=g(null),ws=g([]),rn=g(!1),Ct=g(null),Cn=g(""),In=g(!1),Kt=g(!0),bi=20,Et=g(bi);function ff(){var t,n;const e=new URLSearchParams(window.location.search);return((t=e.get("agent"))==null?void 0:t.trim())||((n=e.get("agent_name"))==null?void 0:n.trim())||"dashboard-user"}const $f=g(ff());function hf(e){const t=e.replace(/!\[[^\]]*\]\([^)]+\)/g," ").replace(/\[[^\]]+\]\([^)]+\)/g,"$1").replace(/[`#>*_~-]/g," ").replace(/\s+/g," ").trim();return t?t.length>180?`${t.slice(0,177)}...`:t:"No preview available"}function lr(e){return e.updated_at!==e.created_at}function yf(e){if(e.post_kind)return e.post_kind==="automation";const t=(e.hearth??"").toLowerCase();return e.visibility!=="internal"||!e.expires_at||!t?!1:!!(t.startsWith("mdal")||t.includes("harness"))}function bf(e){return e==="lodge-system"||e==="team-session"}function Wn(e){return e.post_kind?e.post_kind:bf(e.author)?"system":yf(e)?"automation":"human"}function kc(e){const t=[],n=[];let s=0;return e.forEach(a=>{const i=Wn(a);if(!(i==="system"&&bt.value)){if(i==="automation"&&Kt.value){s+=1;return}if(i==="human"){t.push(a);return}n.push(a)}}),{human:t,operations:n,hiddenAutomation:s}}function kf(e){if(!e.expires_at)return null;const t=Date.parse(e.expires_at);return Number.isFinite(t)?t<=Date.now()?o`<span class="board-meta-chip">expired</span>`:o`<span class="board-meta-chip">expires <${J} timestamp=${e.expires_at} /></span>`:null}async function ki(e){Ct.value=e,js.value=null,ws.value=[],rn.value=!0;try{const t=await Bd(e);if(Ct.value!==e)return;js.value={id:t.id,author:t.author,title:t.title,body:t.body,content:t.content,meta:t.meta,tags:t.tags,votes:t.votes,vote_balance:t.vote_balance,comment_count:t.comment_count,created_at:t.created_at,updated_at:t.updated_at,post_kind:t.post_kind,flair:t.flair,hearth:t.hearth,visibility:t.visibility,expires_at:t.expires_at,hearth_count:t.hearth_count},ws.value=t.comments??[]}catch{Ct.value===e&&(js.value=null,ws.value=[])}finally{Ct.value===e&&(rn.value=!1)}}async function cr(e){const t=Cn.value.trim();if(t){In.value=!0;try{await Ud(e,$f.value,t),Cn.value="",E("Comment posted","success"),await ki(e),et()}catch{E("Failed to post comment","error")}finally{In.value=!1}}}function xf(){const e=Ln.value,t=Kt.value?"Automation lane collapsed":"Automation lane visible";return o`
  ...
  `}function dr({post:e}){const t=async(n,s)=>{s.stopPropagation();try{await qr(e.id,n),et()}catch{E("Failed to vote","error")}};return o`
    <div class="board-post" onClick=${()=>Jc(e.id)}>
      ...
      <div class="post-content">
        ...
        <div class="post-snippet">${hf(e.body)}</div>
      </div>
    </div>
  `}function Sf({comments:e}){return e.length===0?o`<div class="empty-state" style="font-size:13px">No comments yet</div>`:o`
  ...
  `}function Cf({post:e}){Ct.value!==e.id&&!rn.value&&ki(e.id);const t=async n=>{try{await qr(e.id,n),et()}catch{E("Failed to vote","error")}};return o`
    <div>
      ...
      <${I} title="Comments" semanticId="memory.feed">
        ${rn.value?o`<div class="loading-indicator">Loading comments...</div>`:o`<${Sf} comments=${ws.value} />`}
        <${Af} postId=${e.id} />
      <//>
    </div>
  `}function If(){const e=kc(Ra.value),t=[...e.human,...e.operations],n=F.value.params.post??null,s=n?t.find(a=>a.id===n)??(Ct.value===n?js.value:null):null;return n&&!s&&Ct.value!==n&&!rn.value&&ki(n),n?s?o`
          <${be} surfaceId="memory" />
          <${Ja} />
          <${Cf} post=${s} />
        `:o`
  ...
  `}function Tf({ratio:e,size:t=40,stroke:n=4}){if(e==null)return null;const s=(t-n)/2,a=t/2,i=2*Math.PI*s,l=i*((100-e*100)/100);let c="mitosis-safe";return e>=.8?c="mitosis-critical":e>=.5&&(c="mitosis-warn"),o`
  ...
  `}const ht=g(null),Oe=g(null),qe=g(null);function Ea(e){return e==="bad"||e==="critical"||e==="offline"?"bad":e==="warn"||e==="paused"||e==="blocked"||e==="interrupted"?"warn":"ok"}function Rf(e){return typeof e!="number"||Number.isNaN(e)?"—":`${Math.round(e*100)}%`}function Pf(e){return e?dt.value.find(t=>t.name===e||t.agent_name===e)??null:null}function Lf(e){switch(e){case"working":return"작업 중";case"watching":return"대기 중";case"quiet":return"조용함";case"offline":return"오프라인"}}function zf(e){switch(e){case"critical":return"위험";case"warning":return"주의";default:return"정상"}}function ur(e){if(!e)return;const t=uv({targetType:e.target_type,targetId:e.target_id,focusKind:e.focus_kind,operationId:e.operation_id??null,commandSurface:e.command_surface??null,sourceLabel:"Execution 진단",summary:e.label});Kl(t),se(e.surface,e.surface==="intervene"?Bl(t):Hl(t))}function Mt({label:e,value:t,color:n,caption:s}){return o`
    <div class="stat-card">
  ...
  `}function Mf({item:e,selected:t}){return o`
    <button
  ...
  `}function Ef({brief:e,selected:t}){return o`
    <button
      class="mission-card-select ${t?"active":""}"
  ...
  `}function pr({row:e,testId:t}){return o`
    <button class="monitor-row ${e.tone} state-${e.state}" data-testid=${t} onClick=${()=>Ma(e.name)}>
      <div class="monitor-row-header">
        ...
        <span class="monitor-pill ${e.tone} state-${e.state}">${Lf(e.state)}</span>
      </div>
  ...
  `}function jf({row:e}){const t=()=>{const n=Pf(e.name);n&&tc(n)};return o`
    <button class="monitor-row ${e.tone} state-${e.state}" data-testid="execution.continuity-card" onClick=${t}>
      <div class="monitor-row-header">
        ...
        <${pt} status=${e.status??"unknown"} />
        <span class="monitor-pill ${e.tone}">${zf(e.state)}</span>
      </div>
    ...
    <div class="agents-monitor">
      ...
      >
        ...
        <div class="monitor-alert-list">
          ${t.length===0?o`<div class="empty-state">지금은 막힌 실행이 없습니다</div>`:t.map($=>o`<${Mf} key=${$.id} item=${$} selected=${ht.value===$.id} />`)}
        </div>
      <//>
      ...
      <div class="agents-workbench">
        ...
        >
          ...
          <div class="monitor-list">
            ${u.length===0?o`<div class="empty-state">선택된 실행과 연결된 session이 없습니다</div>`:u.map($=>o`<${Nf} key=${$.session_id} brief=${$} selected=${Oe.value===$.session_id} />`)}
          </div>
        <//>
        ...
        >
          ...
          <div class="monitor-list">
            ${_.length===0?o`<div class="empty-state">선택된 실행과 연결된 operation이 없습니다</div>`:_.map($=>o`<${Ef} key=${$.operation_id} brief=${$} selected=${qe.value===$.operation_id} />`)}
          </div>
        <//>
        ...
        >
          ...
          <div class="monitor-list">
            ${h.length===0?o`<div class="empty-state">지금은 연속성 경고가 없습니다</div>`:h.map($=>o`<${jf} key=${$.name} row=${$} />`)}
          </div>
        <//>
  ...
  `}const $a=g("all"),ha=g("all"),Do=g(new Set);function Df(e){const t=new Set(Do.value);t.has(e)?t.delete(e):t.add(e),Do.value=t}const xc=Ce(()=>{let e=Ht.value;return $a.value!=="all"&&(e=e.filter(t=>t.horizon===$a.value)),ha.value!=="all"&&(e=e.filter(t=>t.status===ha.value)),e}),Of=Ce(()=>{const e={short:[],mid:[],long:[]};for(const t of xc.value){const n=e[t.horizon];n&&n.push(t)}return e}),qf=Ce(()=>{const e=Array.from(Zr.value.values());return e.sort((t,n)=>t.status==="running"&&n.status!=="running"?-1:n.status==="running"&&t.status!=="running"?1:t.status==="interrupted"&&n.status!=="interrupted"?-1:n.status==="interrupted"&&t.status!=="interrupted"?1:n.elapsed_seconds-t.elapsed_seconds),e});function Ff(e){return"★".repeat(Math.min(e,5))+"☆".repeat(Math.max(0,5-e))}function Si(e){switch(e){case"short":return"Short-term";case"mid":return"Mid-term";case"long":return"Long-term";default:return e}}function Ds(e){switch(e){case"short":return"#4ade80";case"mid":return"#f59e0b";case"long":return"#818cf8";default:return"#888"}}function Kf(e){return e<60?`${Math.round(e)}s`:e<3600?`${Math.floor(e/60)}m ${Math.round(e%60)}s`:`${Math.floor(e/3600)}h ${Math.floor(e%3600/60)}m`}function mr(e){return e.toFixed(4)}function vr(e){const t=e.current_metric-e.baseline_metric;return`${t>=0?"+":""}${t.toFixed(4)}`}function Bf(e){switch(e){case 1:return"P1";case 2:return"P2";case 3:return"P3";default:return"P4"}}function _r(e,t){return(e.priority??4)-(t.priority??4)}function Uf(e,t){const n=e.updated_at??e.created_at??"";return(t.updated_at??t.created_at??"").localeCompare(n)}function Hf(e,t){return e.length<=t?e:e.slice(0,t)+"..."}function Wf({goal:e}){return o`
    <div class="goal-row">
      <div class="goal-row-main">
        ...
        <div class="goal-meta">
          <span class="goal-priority" title="Priority ${e.priority}">${Ff(e.priority)}</span>
  ...
  `}function Va({horizon:e,items:t}){if(t.length===0)return null;const n=[...t].sort((s,a)=>a.priority-s.priority);return o`
    <${I} title="${Si(e)} Goals (${t.length})" class="section" semanticId="planning.goal_pipeline">
      <div class="goal-list">
        ${n.map(s=>o`<${Wf} key=${s.id} goal=${s} />`)}
      </div>
    <//>
  `}function Gf(){return o`
  ...
  `}function Jf(){const e=Ht.value,t=e.filter(a=>a.status==="active").length,n=e.filter(a=>a.status==="completed").length,s={short:0,mid:0,long:0};for(const a of e)a.horizon in s&&s[a.horizon]++;return o`
  ...
  `}function Vf({loop:e}){const t=e.history[0],n=e.latest_tool_names&&e.latest_tool_names.length>0?`${e.latest_tool_call_count??e.latest_tool_names.length} tool${(e.latest_tool_call_count??e.latest_tool_names.length)===1?"":"s"}: ${e.latest_tool_names.join(", ")}`:"No evidence yet";return o`
  ...
  `}function Qa({task:e}){const t=e.priority??4,n=t<=1?"p1":t===2?"p2":t===3?"p3":"p4",s=Do.value.has(e.id),a=!!e.description;return o`
    <div class="kanban-card ${n}">
      <div class="kanban-card-header">
        <span class="priority-badge priority-badge--${n}">${Bf(t)}</span>
  ...
  `}function Qf(){const{todo:e,inProgress:t,done:n}=tl.value,s=[...e].sort(_r),a=[...t].sort(_r),i=[...n].sort(Uf);return o`
  ...
  `}function Yf(){const{todo:e,inProgress:t,done:n}=tl.value,s=e.length+t.length+n.length,a=[...e,...t].filter(u=>(u.priority??4)<=2).length,i=Of.value,l=qf.value,c=Ht.value.length>0,p=l.length>0,m=Qo.value;return o`
    <div>
        ...
        <div>
          ${bn.value&&l.length===0?o`<div class="loading-indicator">Loading MDAL loops...</div>`:l.length===0&&(m==="error"||Wt.value)?o`<div class="empty-state">MDAL snapshot could not be loaded${Wt.value?`: ${Wt.value}`:""}. Check backend health.</div>`:l.length===0?o`<div class="empty-state">No active loops. Use <code>masc_mdal_start</code> to start a loop.</div>`:o`
                  <div class="planning-loop-list">
                    ${l.map(u=>o`<${Vf} key=${u.loop_id} loop=${u} />`)}
                  </div>
                `}
        </div>
      </details>
    </div>
  `}const ya=g(!1),Tn=g(!1),Bt=g(!1),lt=g(""),Rn=g(""),Oo=g("open"),Ne=g(null),Gn=g(null),ba=g(null),ka=g(null),qo=g(!1);function Jn(e){return`${e.kind}:${e.id}`}function Ai(){var n;const e=Gn.value,t=((n=Ne.value)==null?void 0:n.items)??[];return e?t.find(s=>Jn(s)===e)??null:null}function Xf(){const e=new URLSearchParams(window.location.search),t=e.get("agent")??e.get("agent_name");return(t==null?void 0:t.trim())||"dashboard"}function Zf(e){const t=e.trim().toLowerCase();return t==="open"||t==="pending"}function Sc(e){return!!(e.judgment_summary&&e.judgment_summary.trim())}function Ac(e){switch(Oo.value){case"needs_quorum":return e.filter(t=>t.kind==="consensus"&&(t.votes??0)<(t.quorum??0));case"ready":return e.filter(t=>{var n;return(n=t.guardrail_state)==null?void 0:n.ready_to_execute});case"needs_approval":return e.filter(t=>{var n,s;return((n=t.guardrail_state)==null?void 0:n.requires_human_gate)||!!((s=t.guardrail_state)!=null&&s.pending_confirm)});case"judge_offline":return e.filter(t=>!Sc(t));case"open":default:return e.filter(t=>Zf(t.status))}}function e$(e){if(e==null)return"none";if(typeof e=="string")return e;try{return JSON.stringify(e,null,2)}catch{return String(e)}}function ja(e){const t=(e||"").toLowerCase();return t.includes("reject")||t.includes("deny")||t.includes("closed")||t.includes("cancel")?"negative":t.includes("approve")||t.includes("support")||t.includes("open")||t.includes("ready")?"positive":"neutral"}function t$(e){return typeof e!="number"||Number.isNaN(e)?"n/a":`${Math.round(e*100)}%`}function fn(e){return"resolved_tool"in e||"payload_preview"in e||"reason"in e}async function Cc(e){if(ba.value=null,ka.value=null,!!e){qo.value=!0,lt.value="";try{e.kind==="debate"?ba.value=await fu(e.id):ka.value=await $u(e.id)}catch(t){lt.value=t instanceof Error?t.message:"Failed to load governance detail"}finally{qo.value=!1}}}async function n$(e){Gn.value=Jn(e),await Cc(e)}async function ln(){var e;ya.value=!0,lt.value="";try{const t=await $d();Ne.value=t;const n=Ac(t.items??[]),s=Gn.value,a=n.find(i=>Jn(i)===s)??n[0]??((e=t.items)==null?void 0:e[0])??null;Gn.value=a?Jn(a):null,await Cc(a)}catch(t){lt.value=t instanceof Error?t.message:"Failed to load governance state"}finally{ya.value=!1}}fp(ln);async function gr(){const e=Rn.value.trim();if(e){Tn.value=!0;try{const t=await gu(e);Rn.value="",E(t!=null&&t.id?`Debate started: ${t.id}`:"Debate started","success"),await ln()}catch(t){const n=t instanceof Error?t.message:"Failed to start debate";lt.value=n,E(n,"error")}finally{Tn.value=!1}}}async function fr(e){var i,l;const t=Ai(),n=(i=t==null?void 0:t.guardrail_state)==null?void 0:i.pending_confirm,s=n==null?void 0:n.confirm_token;if(!s)return;const a=((l=n==null?void 0:n.actor)==null?void 0:l.trim())||Xf();Bt.value=!0;try{await Nr(a,s,e),E(e==="confirm"?"Action approved":"Action denied","success"),await ln()}catch(c){const p=c instanceof Error?c.message:"Failed to update pending action";lt.value=p,E(p,"error")}finally{Bt.value=!1}}function s$(){var n,s,a,i,l,c;const e=(n=Ne.value)==null?void 0:n.summary,t=(s=Ne.value)==null?void 0:s.judge;return o`
    <div class="board-summary-strip">
      <div class="board-summary-item">
  ...
  `}function o$(){var t;const e=Ac(((t=Ne.value)==null?void 0:t.items)??[]);return o`
  ...
  `}function i$({argument:e}){return o`
  ...
  `}function l$(){const e=Ai(),t=ba.value,n=ka.value;return o`
    <${I}
    ...
    >
      ${qo.value?o`<div class="loading-indicator">Loading governance detail...</div>`:e?e.kind==="debate"&&t?o`
                ...
                <div class="governance-ledger">
                  ${t.arguments.length===0?o`<div class="empty-state">No arguments recorded yet.</div>`:t.arguments.map(s=>o`<${i$} key=${s.index} argument=${s} />`)}
                </div>
              `:e.kind==="consensus"&&n?o`
                  ...
                  <div class="governance-ledger">
                    ${n.votes.length===0?o`<div class="empty-state">No votes recorded yet.</div>`:n.votes.map(s=>o`<${r$} key=${s.agent+s.timestamp} vote=${s} />`)}
                  </div>
  ...
  `}function $r({title:e,route:t}){if(!t)return null;const n=fn(t)?t.resolved_tool:t.delegated_tool,s=fn(t)?t.target_type:null,a=fn(t)?t.target_id:null,i=fn(t)?t.reason:null,l=fn(t)?t.payload_preview:null;return o`
    <div class="governance-side-block">
      ...
      ${l?o`<pre class="council-detail governance-preview">${e$(l)}</pre>`:null}
    </div>
  `}function c$(){var c,p,m;const e=Ai(),t=ba.value,n=ka.value,s=(t==null?void 0:t.context)??(n==null?void 0:n.context)??(e==null?void 0:e.context),a=(t==null?void 0:t.judgment)??(n==null?void 0:n.judgment),i=e==null?void 0:e.guardrail_state,l=(c=Ne.value)==null?void 0:c.judge;return o`
      ...
      <${I} title="Why / Guardrail" class="section" semanticId="governance.guardrail">
        ${e?o`
              <div class="governance-side-block">
                ...
                <div class="council-sub">
                  <span>confidence ${t$(e.confidence)}</span>
  ...
  `}const jt=g(""),Ya=g("ability_check"),Xa=g("10"),Za=g("12"),ys=g(""),bs=g("idle"),Ve=g(""),ks=g("keeper-late"),eo=g("player"),to=g(""),xe=g("idle"),no=g(null),xs=g(""),so=g(""),ao=g("player"),oo=g(""),io=g(""),ro=g(""),Pn=g("20"),lo=g("20"),co=g(""),Ss=g("idle"),Fo=g(null),Ic=g("overview"),uo=g("all"),po=g("all"),mo=g("all"),u$=12e4,wa=g(null),hr=g(Date.now());function p$(e,t){const n=t>0?e/t*100:0;return n>50?"hp-high":n>25?"hp-mid":"hp-low"}function m$(e,t){return t>0?Math.round(e/t*100):0}const v$={pragmatic:"리스크보다 확실한 이득을 우선합니다.",frugal:"자원 소모를 줄이고 효율을 챙깁니다.",impatient:"짧은 템포로 즉시 압박을 선호합니다.",stubborn:"한 번 정한 전술을 끝까지 밀어붙입니다.",protective:"아군 피해를 줄이는 선택을 우선합니다.","honor-bound":"약속과 규율을 지키는 행동에 보너스가 납니다.",intense:"집중 화력을 짧게 폭발시킵니다.",empathetic:"아군/약자 보호 쪽 선택 확률이 높아집니다.",fatalistic:"위험을 감수하는 고배수 선택을 탑니다.",suspicious:"함정/매복 경계 행동을 우선합니다.",precise:"단일 목표를 정확히 노리는 경향입니다.",vengeful:"직전 위협 대상에게 강하게 반응합니다.",aggressive:"공격적인 전진 행동을 우선합니다.",opportunistic:"빈틈이 열리면 즉시 추격합니다."},_$={supply_scan:"전장/자원 상태를 스캔해 약한 지점을 찾습니다.",ration_shift:"소모를 줄이고 지속 전투 능력을 확보합니다.",logistics_patch:"무너진 운영 라인을 빠르게 복구합니다.",frontline_shield:"전열에서 아군 피해를 흡수합니다.",oath_intercept:"핵심 타깃을 가로막아 위협을 차단합니다.",morale_anchor:"아군 안정도를 높여 붕괴를 막습니다.",omen_trace:"다음 위험 신호를 먼저 감지합니다.",arc_flash:"짧은 순간 광역 압박을 넣습니다.",ward_bloom:"방어 장막을 펼쳐 생존률을 올립니다.",mark_prey:"우선 제거 대상을 지정합니다.",silent_route:"은밀한 진입 경로를 확보합니다.",finisher_strike:"약화된 적을 마무리하는 일격입니다.",shadow_claw:"근접 급습으로 출혈 피해를 노립니다.",lunge:"짧은 돌진으로 전열을 흔듭니다."};function As(e){const t=e.trim();return t?t.split(/[_-]+/g).filter(n=>n.length>0).map(n=>n[0]?`${n[0].toUpperCase()}${n.slice(1)}`:n).join(" "):e}function g$(e){const t=e.trim().toLowerCase();return v$[t]??"행동 선택 가중치에 영향을 주는 성향입니다."}function f$(e){const t=e.trim().toLowerCase();return _$[t]??"상황에 따라 선택되는 전술 액션입니다."}function $e(e,t,n=""){const s=e[t];return typeof s=="string"?s:n}function Le(e,t,n=0){const s=e[t];return typeof s=="number"&&Number.isFinite(s)?s:n}function Vn(e,t,n=!1){const s=e[t];return typeof s=="boolean"?s:n}const $$=new Set(["str","dex","con","int","wis","cha"]);function h$(e){const t=e.trim();if(!t)return{};let n;try{n=JSON.parse(t)}catch(a){throw new Error(`능력치 JSON 파싱 실패: ${a instanceof Error?a.message:"invalid json"}`)}if(!v(n))throw new Error('능력치 JSON은 object여야 합니다. 예: {"luck":7}');const s={};return Object.entries(n).forEach(([a,i])=>{const l=a.trim();if(l){if(typeof i=="number"&&Number.isFinite(i)){s[l]=Math.max(0,Math.trunc(i));return}if(typeof i=="string"){const c=Number.parseFloat(i.trim());if(Number.isFinite(c)){s[l]=Math.max(0,Math.trunc(c));return}}throw new Error(`능력치 '${l}' 값은 숫자여야 합니다.`)}}),s}function y$(e){const t=Number.parseInt(e.trim(),10);if(!Number.isFinite(t))return;const n=Math.max(1,t),s=Number.parseInt(Pn.value.trim(),10);Number.isFinite(s)&&s>n&&(Pn.value=String(n))}function Ko(e){const n=(e.actor_name??e.actor??e.actor_id??"system").trim();return n===""?"system":n}function b$(e){var n;return(((n=e.timestamp)==null?void 0:n.trim())??"")||"-"}function k$(e){Ic.value=e}function Tc(e){const t=wa.value;return t==null||t<=e}function x$(e){const t=wa.value;return t==null||t<=e?0:Math.max(0,Math.ceil((t-e)/1e3))}function xa(){wa.value=null}function Rc(e){return typeof window>"u"||typeof window.confirm!="function"?!0:window.confirm(e)}function S$(e,t){Rc(["관전 모드 잠금을 해제하시겠습니까?",`ROOM: ${e||"-"}`,`PHASE: ${t||"-"}`,"해제 시간: 120초 (시간 경과 또는 위험 액션 실행 후 자동 재잠금)"].join(`
`))&&(wa.value=Date.now()+u$,E("조작 잠금이 120초 동안 해제되었습니다.","warning"))}function Os(e){return Tc(e)?(E("관전 모드 잠금 상태입니다. 먼저 잠금을 해제하세요.","warning"),!1):!0}function Bo(e,t,n){return Rc([`[위험 액션 확인] ${e}`,`ROOM: ${t||"-"}`,`PHASE: ${n||"-"}`,"이 액션은 즉시 실행되며 되돌리기 어렵습니다.","계속 진행하시겠습니까?"].join(`
`))}function A$({hp:e,max:t}){const n=m$(e,t),s=p$(e,t);return o`
    <div class="trpg-hp-bar">
      <div class="hp-fill ${s}" style="width:${n}%" />
    </div>
  `}function C$({stats:e}){const t=[{label:"STR",value:e.strength},{label:"DEX",value:e.dexterity},{label:"CON",value:e.constitution},{label:"INT",value:e.intelligence},{label:"WIS",value:e.wisdom},{label:"CHA",value:e.charisma}];return o`
    <div class="trpg-actor-stats">
      ${t.map(n=>o`<span>${n.label} ${n.value}</span>`)}
    </div>
  `}function I$({keeper:e,role:t}){if(!e)return null;const n=t==="dm"?"dm":"player";return o`
    <span class="trpg-keeper-chip">
      <span class="trpg-keeper-tag ${n}">${n}</span>
      ${e}
    </span>
  `}function Pc({actor:e}){var p,m,u,_;const t=(p=e.archetype)==null?void 0:p.trim(),n=(m=e.persona)==null?void 0:m.trim(),s=(u=e.portrait)==null?void 0:u.trim(),a=(_=e.background)==null?void 0:_.trim(),i=e.traits??[],l=e.skills??[],c=Object.entries(e.stats_raw??{}).filter(([f,h])=>Number.isFinite(h)).filter(([f])=>!$$.has(f.toLowerCase()));return o`
    <div class="trpg-actor">
      ...
      ${e.stats?o`
          <div style="margin-top:4px;">
            ...
            <${A$} hp=${e.stats.hp} max=${e.stats.max_hp} />
            <${C$} stats=${e.stats} />
          </div>
        `:null}
  ...
  `}function T$({mapStr:e}){return o`<pre class="trpg-map">${e}</pre>`}function Lc({events:e,emptyLabel:t="아직 이벤트가 없습니다."}){return e.length===0?o`<div class="empty-state" style="font-size:13px">${t}</div>`:o`
  ...
  `}function L$({state:e,nowMs:t}){var m;const n=Ke.value||((m=e.session)==null?void 0:m.room)||"",s=bs.value,a=e.party??[];if(!a.find(u=>u.id===jt.value)&&a.length>0){const u=a[0];u&&(jt.value=u.id)}const l=async()=>{var _,f;if(!n){E("Room ID가 비어 있습니다.","error");return}if(!Os(t))return;const u=((_=e.current_round)==null?void 0:_.phase)??((f=e.session)==null?void 0:f.status)??"unknown";if(Bo("라운드 실행",n,u)){bs.value="running";try{const h=await ou(n);Fo.value=h,bs.value="ok";const b=v(h.summary)?h.summary:null,$=b?Vn(b,"advanced",!1):!1,S=b?$e(b,"progress_reason",""):"";E($?"라운드가 정상 진행되었습니다.":`라운드가 정체되었습니다${S?`: ${S}`:""}`,$?"success":"warning"),tt()}catch(h){Fo.value=null,bs.value="error";const b=h instanceof Error?h.message:"라운드 실행에 실패했습니다.";E(b,"error")}finally{xa()}}},c=async()=>{var _,f;if(!n||!Os(t))return;const u=((_=e.current_round)==null?void 0:_.phase)??((f=e.session)==null?void 0:f.status)??"unknown";if(Bo("턴 강제 진행",n,u))try{await lu(n),E("턴을 다음 단계로 이동했습니다.","success"),tt()}catch{E("턴 이동에 실패했습니다.","error")}finally{xa()}},p=async()=>{if(!n||!Os(t))return;const u=jt.value.trim();if(!u){E("먼저 Actor를 선택하세요.","warning");return}const _=Number.parseInt(Xa.value,10),f=Number.parseInt(Za.value,10);if(Number.isNaN(_)||Number.isNaN(f)){E("stat/dc는 숫자여야 합니다.","warning");return}const h=Number.parseInt(ys.value,10),b=ys.value.trim()===""||Number.isNaN(h)?void 0:h;try{await ru({roomId:n,actorId:u,action:Ya.value.trim()||"ability_check",statValue:_,dc:f,rawD20:b}),E("주사위 판정을 기록했습니다.","success"),tt()}catch{E("주사위 판정 기록에 실패했습니다.","error")}};return o`
  ...
  `}function z$({state:e}){var a;const t=Ke.value||((a=e.session)==null?void 0:a.room)||"",n=Ss.value,s=async()=>{if(!t){E("Room ID가 비어 있습니다.","warning");return}const i=xs.value.trim(),l=so.value.trim();if(!l&&!i){E("이름 또는 Actor ID를 입력하세요.","warning");return}const c=Number.parseInt(Pn.value.trim(),10),p=Number.parseInt(lo.value.trim(),10),m=Number.isFinite(p)?Math.max(1,p):20,u=Number.isFinite(c)?Math.max(0,Math.min(m,c)):m;let _={};try{_=h$(co.value)}catch(f){E(f instanceof Error?f.message:"능력치 JSON 오류","error");return}Ss.value="spawning";try{const f=typeof crypto<"u"&&typeof crypto.randomUUID=="function"?`trpg_spawn_${crypto.randomUUID()}`:`trpg_spawn_${Date.now().toString(36)}_${Math.random().toString(36).slice(2,10)}`,h=await cu(t,{actor_id:i||void 0,name:l||void 0,role:ao.value,idempotencyKey:f,portrait:io.value.trim()||void 0,background:ro.value.trim()||void 0,hp:u,max_hp:m,alive:u>0,stats:Object.keys(_).length>0?_:void 0}),b=typeof h.actor_id=="string"?h.actor_id.trim():"";if(!b)throw new Error("생성 응답에 actor_id가 없습니다.");const $=oo.value.trim();$&&await du(t,b,$),jt.value=b,Ve.value=b,i||(xs.value=""),Ss.value="ok",E(`Actor 생성 완료: ${b}`,"success"),await tt()}catch(f){Ss.value="error",E(f instanceof Error?f.message:"Actor 생성에 실패했습니다.","error")}};return o`
    <div class="trpg-control-box">
      <div class="trpg-control-grid">
        <div class="trpg-control-field">
          <label>Name</label>
        ...
        <div class="trpg-control-grid">
          ...
          <div class="trpg-control-field">
            ...
            <input
              ...
              min="1"
              value=${lo.value}
              onInput=${i=>{const l=i.target.value;lo.value=l,y$(l)}}
              placeholder="20"
            />
          </div>
  ...
  `}function M$({state:e,nowMs:t}){var f;const n=Ke.value||((f=e.session)==null?void 0:f.room)||"",s=e.join_gate,a=no.value,i=v(a)?a:null,l=(e.party??[]).filter(h=>h.role!=="dm"),c=Ve.value.trim(),p=l.some(h=>h.id===c),m=p?c:c?"__manual__":"",u=async()=>{const h=Ve.value.trim(),b=ks.value.trim();if(!n||!h){E("Room/Actor가 필요합니다.","warning");return}xe.value="checking";try{const $=await uu(n,h,b||void 0);no.value=$,xe.value="ok",E("참가 가능 여부를 갱신했습니다.","success")}catch($){xe.value="error";const S=$ instanceof Error?$.message:"참가 가능 여부 확인에 실패했습니다.";E(S,"error")}},_=async()=>{var A,x;const h=Ve.value.trim(),b=ks.value.trim(),$=to.value.trim();if(!n||!h||!b){E("Room/Actor/Keeper가 필요합니다.","warning");return}if(!Os(t))return;const S=((A=e.current_round)==null?void 0:A.phase)??((x=e.session)==null?void 0:x.status)??"unknown";if(Bo("Mid-Join 승인 요청",n,S)){xe.value="requesting";try{const z=await pu({room_id:n,actor_id:h,keeper_name:b,role:eo.value,...$?{name:$}:{}});no.value=z;const T=v(z)?Vn(z,"granted",!1):!1,P=v(z)?$e(z,"reason_code",""):"";T?E("Mid-Join이 승인되었습니다.","success"):E(`Mid-Join이 거절되었습니다${P?`: ${P}`:""}`,"warning"),xe.value=T?"ok":"error",tt()}catch(z){xe.value="error";const T=z instanceof Error?z.message:"Mid-Join 요청에 실패했습니다.";E(T,"error")}finally{xa()}}};return o`
    <div class="trpg-control-box">
  ...
  `}function N$({state:e,nowMs:t}){var l,c,p;const n=Ke.value||((l=e.session)==null?void 0:l.room)||"",s=((c=e.current_round)==null?void 0:c.phase)??((p=e.session)==null?void 0:p.status)??"unknown",a=Tc(t),i=x$(t);return o`
    <${I} title="조작 안전 잠금" style="margin-bottom:16px;" semanticId="lab.trpg">
      <div class="trpg-control-lock ${a?"locked":"unlocked"}">
        ...
        <div style="display:flex; gap:8px; margin-top:10px; flex-wrap:wrap;">
          ${a?o`<button class="trpg-run-btn recommend" onClick=${()=>S$(n,s)}>잠금 해제 (120초)</button>`:o`<button class="trpg-run-btn secondary" onClick=${()=>{xa(),E("조작 잠금으로 전환했습니다.","success")}}>즉시 다시 잠금</button>`}
        </div>
      </div>
    <//>
  `}function E$({active:e}){return o`
  ...
  `}function j$({state:e}){const t=e.party??[],n=e.story_log??[];return o`
  ...
  `}function w$({state:e}){const t=e.story_log??[];return o`
    <div class="trpg-layout">
      <div>
  ...
  `}function D$({state:e,nowMs:t}){const n=e.party??[];return o`
    <div>
      <${N$} state=${e} nowMs=${t} />
      <div class="trpg-layout">
        <div>
  ...
  `}function O$(){var c,p,m,u,_;const e=Xr.value,t=Ao.value;if(ne(()=>{if(typeof window>"u"||typeof window.setInterval!="function")return;const f=window.setInterval(()=>{hr.value=Date.now()},1e3);return()=>{window.clearInterval(f)}},[]),t&&!e)return o`<div class="loading-indicator">Loading TRPG state...</div>`;if(!e)return o`
      <div class="section">
        <h2>TRPG</h2>
    ...
    <div>
      ...
      ${i==="overview"?o`<${j$} state=${e} />`:i==="timeline"?o`<${w$} state=${e} />`:o`<${D$} state=${e} nowMs=${l} />`}
    </div>
  `}const jc=g(null),Uo=g(null),qs=g(!1);async function q$(){if(!qs.value){qs.value=!0,Uo.value=null;try{jc.value=await Ad()}catch(e){Uo.value=e instanceof Error?e.message:String(e)}finally{qs.value=!1}}}function F$(e){switch(e){case"essential":return"badge-essential";case"standard":return"badge-standard";default:return"badge-full"}}function K$({items:e,maxCount:t}){return e.length===0?o`<p class="muted">No tool calls recorded yet.</p>`:o`
    <div class="tool-bar-chart">
      ${e.map(n=>{const s=t>0?n.call_count/t*100:0;return o`
          <div class="tool-bar-row" key=${n.name}>
            ...
            <span class="tool-bar-tier ${F$(n.tier)}">${n.tier}</span>
  ...
  `}function B$({dist:e}){const t=e.full,n=t>0?(e.essential/t*100).toFixed(1):"0",s=t>0?(e.standard/t*100).toFixed(1):"0",a=t-e.standard,i=t>0?(a/t*100).toFixed(1):"0";return o`
    <div class="tier-dist">
  ...
  `}function U$(){const e=jc.value,t=qs.value,n=Uo.value;return o`
  ...
  `}const Sa=g(new Set(["broadcast","tasks","keepers","system"]));function W$(e){const t=new Set(Sa.value);t.has(e)?t.delete(e):t.add(e),Sa.value=t}const Ci=g(null);function wc(e){Ci.value=e}function G$(e){return e.kind==="board"?"broadcast":e.kind==="tasks"?"tasks":e.kind==="keepers"?"keepers":"system"}const J$=Ce(()=>{const e=Sa.value;return Ks.value.filter(t=>e.has(G$(t)))}),V$=12e4,Q$=Ce(()=>{const e=nl.value,t=Date.now();return He.value.map(n=>{const s=n.name.trim().toLowerCase(),a=e.get(s)??null;let i="idle";if(n.status==="active"||n.status==="busy"){const l=a==null?void 0:a.lastActivityAt;l?i=t-new Date(l).getTime()>V$?"stale":"working":i="working"}else(n.status==="offline"||n.status==="inactive")&&(i="stale");return{name:n.name,emoji:n.emoji??"",koreanName:n.koreanName??null,state:i,currentTask:n.current_task,motion:a}})}),Y$=Ce(()=>{const e=nl.value;return He.value.filter(t=>t.status==="active"||t.status==="busy"||t.status==="listening"||t.status==="idle").map(t=>{const n=t.name.trim().toLowerCase(),s=e.get(n),a=(s==null?void 0:s.activeAssignedCount)??0;let i="calm";return a>=3?i="hot":a>=1&&(i="normal"),{name:t.name,emoji:t.emoji??"",koreanName:t.koreanName??null,currentTask:t.current_task,lastActivityAt:(s==null?void 0:s.lastActivityAt)??null,lastActivityText:(s==null?void 0:s.lastActivityText)??null,assignedCount:a,pressure:i}}).sort((t,n)=>{const s={hot:0,normal:1,calm:2};return s[t.pressure]-s[n.pressure]})});function yr(e){return e.kind==="board"?"live-event-broadcast":e.kind==="tasks"?"live-event-task":e.kind==="keepers"?"live-event-keeper":"live-event-system"}function X$(e){const t=e.eventType;return t==="broadcast"?"broadcast":t==="agent_joined"?"joined":t==="agent_left"?"left":t==="task_update"?"task":t==="board_post"?"post":t==="board_comment"?"comment":t==="keeper_heartbeat"?"heartbeat":t==="keeper_handoff"?"handoff":t==="keeper_compaction"?"compact":t==="keeper_guardrail"?"guardrail":e.kind==="board"?"board":e.kind==="tasks"?"task":e.kind==="keepers"?"keeper":"system"}function Z$(e){switch(e){case"working":return"pulse-working";case"stale":return"pulse-stale";default:return"pulse-idle"}}function eh(){const e=Q$.value,t=Ci.value;return e.length===0?o`
    ...
    <div class="pulse-strip">
      ${e.map(n=>o`
        <button
          key=${n.name}
          class="pulse-bubble ${Z$(n.state)} ${t===n.name?"pulse-selected":""}"
  ...
  `}const th=[{kind:"broadcast",label:"Broadcast",cssClass:"live-event-broadcast"},{kind:"tasks",label:"Task",cssClass:"live-event-task"},{kind:"keepers",label:"Keeper",cssClass:"live-event-keeper"},{kind:"system",label:"System",cssClass:"live-event-system"}];function nh(){const e=Sa.value;return o`
  ...
  `}function sh(){const e=J$.value;return o`
        ...
        ${e.length===0?o`<div class="activity-empty">No events matching filters</div>`:e.map((t,n)=>o`
            ...
            >
              <div class="activity-item-head">
                <span class="activity-kind-chip ${yr(t)}">${X$(t)}</span>
  ...
  `}function ah(e){switch(e){case"hot":return"focus-pressure-hot";case"normal":return"focus-pressure-normal";default:return"focus-pressure-calm"}}function oh(e){switch(e){case"hot":return"High";case"normal":return"Active";default:return"Calm"}}function ih(){const e=Y$.value,t=Ci.value;return o`
        ...
        ${e.length===0?o`<div class="focus-empty">No active agents</div>`:e.map(n=>o`
            ...
            >
              <div class="focus-agent-header">
                ...
                <span class="focus-pressure-badge ${ah(n.pressure)}">
                  ${oh(n.pressure)}
  ...
  `}function rh(){const e=ot.value;return o`
  ...
  `}function Dc(e){const t=e==null?void 0:e.trim();return t?t.length>10?t.slice(0,10):t:"commit unavailable"}function ch(){const e=te.value,t=e==null?void 0:e.build,n=t?`v${t.release_version} · ${Dc(t.commit)}`:e!=null&&e.version?`v${e.version} · commit unavailable`:"version unavailable";return o`
    <div class="build-identity-wrap">
      <button
        class="version-badge build-badge-trigger"
        type="button"
        aria-expanded=${Cs.value}
        onClick=${()=>{Cs.value=!Cs.value}}
      >
        Server Build · ${n}
      </button>
      ${Cs.value?o`
  ...
  `}function Is(e,t,n,s,a){return o`
  ...
  `}function dh({currentTab:e}){var p,m,u,_,f,h,b,$,S,A;const t=ot.value,n=(p=te.value)==null?void 0:p.build,s=(m=te.value)==null?void 0:m.lodge,a=(u=te.value)==null?void 0:u.gardener,i=(_=te.value)==null?void 0:_.guardian,l=(f=te.value)==null?void 0:f.sentinel,c=[];if(s&&c.push(Is("Lodge",s.enabled?s.quiet_active?"Quiet":"Live":"Disabled",s.enabled?s.quiet_active?"warn":"ok":"bad",[Se("Ticks",s.total_ticks??0),Se("Checkins",s.total_checkins??0),Se("Last result",((h=s.last_tick_result)==null?void 0:h.activity_report)??s.last_skip_reason??"none")])),a&&c.push(Is("Gardener",a.alive?"Live":a.enabled?"Starting":"Disabled",a.alive?"ok":a.enabled?"warn":"bad",[Se("Last tick",a.last_tick_completed_at?o`<${J} timestamp=${a.last_tick_completed_at} />`:"never"),Se("Decision",`${a.last_intervention??"none"} · ${a.last_decision_source??"none"}`),Se("Backlog",`${((b=a.health_summary)==null?void 0:b.todo_count)??0} todo · P1/2 ${(($=a.health_summary)==null?void 0:$.high_priority_todo)??0}`)],a.last_reason??a.last_error??void 0)),i){const x=i.masc_loops_running||i.lodge_loop_started||i.lodge_running;c.push(Is("Guardian",x?"Live":i.enabled?"Idle":"Disabled",x?"ok":i.enabled?"warn":"bad",[Se("Mode",i.mode??"unknown"),Se("Loops",`zombie ${i.zombie_loop_running?"on":"off"} · gc ${i.gc_loop_running?"on":"off"}`),Se("Owner",i.runtime_owner??"none")],((S=i.last_lodge_result)==null?void 0:S.message)??i.last_gc_result??i.last_zombie_result??void 0))}return l&&c.push(Is("Sentinel",l.started?"Live":l.enabled?"Starting":"Disabled",l.started?"ok":l.enabled?"warn":"bad",[Se("Agent",l.agent_name??"sentinel"),Se("Consumers",((A=l.consumers)==null?void 0:A.length)??0),Se("Guardian owner",l.guardian_runtime_owner??"none")],l.llm_enabled===!0?"LLM-enabled housekeeping resident":void 0)),o`
    <section class="rail-card">
      ...
      ${n?o`<div class="rail-build-hint">Server Build · v${n.release_version} · ${Dc(n.commit)}</div>`:null}
      ${c.length>0?o`
  ...
  `}function uh(){const e=_e.value,t=(e==null?void 0:e.pending_confirms.length)??0,n=(e==null?void 0:e.sessions.length)??0,s=(e==null?void 0:e.keepers.length)??0;return o`
    <section class="rail-card">
      <div class="rail-card-head">
        <h3>개입 바로가기</h3>
  ...
  `}function ph(){const e=F.value.tab,t=Ho.find(s=>s.id===e),n=br.find(s=>s.id===(t==null?void 0:t.group));return o`
  ...
  `}function mh(){switch(F.value.tab){case"mission":return o`<${Vi} />`;case"proof":return o`<${J_} />`;case"execution":return o`<${wf} />`;case"live":return o`<${rh} />`;case"memory":return o`<${If} />`;case"governance":return o`<${d$} />`;case"planning":return o`<${Yf} />`;case"intervene":return o`<${vf} />`;case"command":return o`<${df} />`;case"lab":return o`<${H$} />`;default:return o`<${Vi} />`}}function vh(){return So.value&&!ot.value?o`<div class="loading-indicator">Loading dashboard...</div>`:o`<${mh} />`}function _h(){ne(()=>{Vc(),Rr(),rl(),kt(),il(),kl();const n=yp();return bp(),()=>{sd(),n(),kp()}},[]),ne(()=>{const n=setInterval(()=>{No(F.value.tab)},15e3);return()=>{clearInterval(n)}},[]),ne(()=>{No(F.value.tab)},[F.value.tab]);const e=F.value.tab,t=Ho.find(n=>n.id===e);return o`
    <div class="app-shell">
  ...
  `}const kr=document.getElementById("app");kr&&Uc(o`<${_h} />`,kr);export{v_ as _};
