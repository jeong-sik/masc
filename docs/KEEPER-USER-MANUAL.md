...
OAS pin metadata is generated from `scripts/oas-agent-sdk-pin.sh`. Current dependency floor: `agent_sdk >= 0.193.12`, runtime pin: `chore/sync-opam-0.193.12-20260514@94fd0e80b1c8b66b71b9deabe4dee36efe0b1deb`, declared base version: `v0.193.12`. 최신성 검증이 필요할 때는 문서에 적힌 숫자보다 `dune-project`와 pin script를 우선 truth source로 본다.
