...
# already cleared, leaving 39. This commit wires one more.
#
# What is left is not "the ones that fail". Of the 39: 17 fail, 5 are not
# runnable tests (4 e2e stanzas gated on MASC_E2E_TESTS, 1 plain executable),
# test_fusion_wake times out in CI (#29064), 4 of the post-test_safe_ops set
# fail, and the remainder is unmeasured. The declared count also includes
# those 5 non-test aliases.
UNWIRED_BASELINE=38
