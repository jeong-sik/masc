...
out=pathlib.Path('/tmp/masc-lsp-direct-same-fixture-v2-20260913');out.mkdir()
...
proc=subprocess.Popen(['/Users/dancer/.opam/5.5.0/bin/ocamllsp'],cwd=fixture,stdin=subprocess.PIPE,stdout=subprocess.PIPE,stderr=subprocess.PIPE)
