...
let task_activities (config : Workspace.config) : activity_item list =
...
let board_post_activities (config : Workspace.config) : activity_item list =
...
let board_comment_activities (config : Workspace.config) : activity_item list =
...
let mention_activities (config : Workspace.config) : activity_item list =
...
let recent_activity (config : Workspace.config) ?agent_name ~(limit : int) ()
    : activity_item list =
  let all_items =
    List.concat [
