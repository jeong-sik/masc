...
let cases_typed_bare =
  [ "claude-haiku-4-5-20251001", Llm_provider.Provider_kind.Anthropic, "claude"
  ; "gemini-2.5-flash", Llm_provider.Provider_kind.Gemini, "gemini"
  ; "gpt-5.4", Llm_provider.Provider_kind.OpenAI_compat, "openai"
  ; "kimi-for-coding", Llm_provider.Provider_kind.Kimi_cli, "kimi_cli"
  ]
;;

let cases_unknown =
  [ "", "unknown"; "definitely-not-a-real-model", "unknown"; "mystery-xyz-4", "unknown" ]
;;
