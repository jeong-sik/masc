...
[![OAS](https://img.shields.io/badge/agent__sdk-%E2%89%A50.193.0-blue.svg)](https://github.com/jeong-sik/oas)
...
- **agent_sdk** >= 0.193.0 (OAS agent runtime; pinned floor in `dune-project`)
