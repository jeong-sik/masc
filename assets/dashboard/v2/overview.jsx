    ...
    <main className="ov">
      <div className="ov-scroll">
        <header className="ov-head">
          <div>
            <h1>운영 개요</h1>
            <p className="ov-sub">namespace <span className="mono">masc-mcp</span> · Keeper {stats.total} · operator <b>@operator</b></p>
          </div>
...
function PlaceholderSurface({ surface }) {
  const map = { board: ['보드', '태스크 칸반 · 골 정렬 · 의존성'], cockpit: ['코크핏', '실시간 trace 스트림 · 도구 실행기'], connectors: ['커넥터', 'Slack · Discord · Amplitude · GitHub'], settings: ['설정', '런타임 · 승인 정책 · 모델 라우팅'] };
