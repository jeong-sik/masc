...
OAS pin metadata is generated from `scripts/oas-agent-sdk-pin.sh`. Current dependency floor: `agent_sdk >= 0.200.2`, runtime pin: `fix/agent-run-timeout-wire-clarity@61ad57f267c1874b611d74a537fae4b70f91c3c2`, declared base version: `v0.200.2`. 최신성 검증이 필요할 때는 문서에 적힌 숫자보다 `dune-project`와 pin script를 우선 truth source로 본다.
