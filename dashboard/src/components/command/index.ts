        ...
        <div class="flex flex-col gap-1.5" key=${group.id}>
          ...
          <div class="flex flex-wrap gap-2">
            ${COMMAND_SURFACE_META
              ...
              .map(surface => html`
                <button
                  class="border p-[8px_14px] capitalize rounded-full ${commandPlaneSurface.value === surface.id ? 'bg-[var(--cyan-16)] text-[#67e8f9] border-[rgba(34,211,238,0.38)]' : 'border-[var(--white-12)] bg-[var(--white-4)] text-[color:var(--white-72)]'}"
                  onClick=${() => {
