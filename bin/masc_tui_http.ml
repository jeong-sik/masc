...
(* The interrupt-signal variant and its decoder live in
   [Masc_tui_interrupt_signal] so tests can link them without this module's
   HTTP surface; the include keeps the [Masc_tui_http.Signalled] spelling. *)
include Masc_tui_interrupt_signal
