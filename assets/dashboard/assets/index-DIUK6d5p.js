...
`))}</p>`)}return n}function wa(t){const e=[],n=/(`[^`]+`)|(\*\*[^*]+\*\*)|(\*[^*]+\*)|\[([^\]]+)\]\(([^)]+)\)/g;let s=0,a;for(;(a=n.exec(t))!==null;){if(a.index>s&&e.push(t.slice(s,a.index)),a[1]){const o=a[1].slice(1,-1);e.push(i`<code>${o}</code>`)}else if(a[2]){const o=a[2].slice(2,-2);e.push(i`<strong>${o}</strong>`)}else if(a[3]){const o=a[3].slice(1,-1);e.push(i`<em>${o}</em>`)}else a[4]&&a[5]&&e.push(i`<a href=${a[5]} target="_blank" rel="noopener">${a[4]}</a>`);s=a.index+a[0].length}return s<t.length&&e.push(t.slice(s)),e.length>0?e:[t]}const Qr=[{id:"recent",label:"Latest"},{id:"hot",label:"Hot"},{id:"trending",label:"Trending"},{id:"updated",label:"Updated"},{id:"discussed",label:"Discussed"}],xs=_(null),Ss=_([]),en=_(!1),Ce=_(null),hn=_(""),yn=_(!1),Fe=_(!0);function s_(){var e,n;const t=new URLSearchParams(window.location.search);return((e=t.get("agent"))==null?void 0:e.trim())||((n=t.get("agent_name"))==null?void 0:n.trim())||"dashboard-user"}const a_=_(s_());function i_(t){const e=t.replace(/!\[[^\]]*\]\([^)]+\)/g," ").replace(/\[[^\]]+\]\([^)]+\)/g,"$1").replace(/[`#>*_~-]/g," ").replace(/\s+/g," ").trim();return e?e.length>180?`${e.slice(0,177)}...`:e:"No preview available"}function bo(t){return t.updated_at!==t.created_at}function o_(t){const e=`${t.title} ${t.tags.join(" ")} ${t.flair??""}`.toLowerCase();return/\b(test|smoke|harness|sandbox|dummy|sample|tmp|qa|e2e)\b/.test(e)||e.includes("테스트")||e.includes("실험")}function r_(t){const e=(t.hearth??"").toLowerCase();return t.visibility!=="internal"||!t.expires_at||!e?!1:!!(e.startsWith("mdal")||e.includes("harness"))}function Zr(t){return Fe.value?t.filter(e=>r_(e)?!1:e.hearth||e.visibility||e.expires_at?!0:!o_(e)):t}async function Ki(t){Ce.value=t,xs.value=null,Ss.value=[],en.value=!0;try{const e=await lc(t);if(Ce.value!==t)return;xs.value={id:e.id,author:e.author,title:e.title,content:e.content,tags:e.tags,votes:e.votes,vote_balance:e.vote_balance,comment_count:e.comment_count,created_at:e.created_at,updated_at:e.updated_at,flair:e.flair,hearth:e.hearth,visibility:e.visibility,expires_at:e.expires_at,hearth_count:e.hearth_count},Ss.value=e.comments??[]}catch{Ce.value===t&&(xs.value=null,Ss.value=[])}finally{Ce.value===t&&(en.value=!1)}}async function ko(t){const e=hn.value.trim();if(e){yn.value=!0;try{await cc(t,a_.value,e),hn.value="",M("Comment posted","success"),await Ki(t),Kt()}catch{M("Failed to post comment","error")}finally{yn.value=!1}}}function l_(){const t=Cn.value,e=Fe.value?"Hiding automation posts":"Show automation posts";return i`
    ...
    <div class="agents-monitor">
      ...
      <${R} title="Execution Priorities" class="section" semanticId="execution.priority_queue">
        ...
        <div class="monitor-alert-list">
          ${m.length===0?i`<div class="empty-state">지금은 실행 경고가 없습니다</div>`:m.map(u=>i`<${x_} key=${u.key} item=${u} />`)}
        </div>
      <//>
  ...
  `}const Ys=_("all"),Xs=_("all"),fi=_(new Set);function C_(t){const e=new Set(fi.value);e.has(t)?e.delete(t):e.add(t),fi.value=e}const el=Nt(()=>{let t=Ke.value;return Ys.value!=="all"&&(t=t.filter(e=>e.horizon===Ys.value)),Xs.value!=="all"&&(t=t.filter(e=>e.status===Xs.value)),t}),w_=Nt(()=>{const t={short:[],mid:[],long:[]};for(const e of el.value){const n=t[e.horizon];n&&n.push(e)}return t}),T_=Nt(()=>{const t=Array.from(Yo.value.values());return t.sort((e,n)=>e.status==="running"&&n.status!=="running"?-1:n.status==="running"&&e.status!=="running"?1:e.status==="interrupted"&&n.status!=="interrupted"?-1:n.status==="interrupted"&&e.status!=="interrupted"?1:n.elapsed_seconds-e.elapsed_seconds),t});function I_(t){return"★".repeat(Math.min(t,5))+"☆".repeat(Math.max(0,5-t))}function Ui(t){switch(t){case"short":return"Short-term";case"mid":return"Mid-term";case"long":return"Long-term";default:return t}}function As(t){switch(t){case"short":return"#4ade80";case"mid":return"#f59e0b";case"long":return"#818cf8";default:return"#888"}}function R_(t){return t<60?`${Math.round(t)}s`:t<3600?`${Math.floor(t/60)}m ${Math.round(t%60)}s`:`${Math.floor(t/3600)}h ${Math.floor(t%3600/60)}m`}function Ao(t){return t.toFixed(4)}function Co(t){const e=t.current_metric-t.baseline_metric;return`${e>=0?"+":""}${e.toFixed(4)}`}function N_(t){switch(t){case 1:return"P1";case 2:return"P2";case 3:return"P3";default:return"P4"}}function wo(t,e){return(t.priority??4)-(e.priority??4)}function P_(t,e){const n=t.updated_at??t.created_at??"";return(e.updated_at??e.created_at??"").localeCompare(n)}function L_(t,e){return t.length<=e?t:t.slice(0,e)+"..."}function M_({goal:t}){return i`
    <div class="goal-row">
      <div class="goal-row-main">
        ...
        <div class="goal-meta">
          <span class="goal-priority" title="Priority ${t.priority}">${I_(t.priority)}</span>
  ...
  `}function E_(){const t=Ke.value,e=t.filter(a=>a.status==="active").length,n=t.filter(a=>a.status==="completed").length,s={short:0,mid:0,long:0};for(const a of t)a.horizon in s&&s[a.horizon]++;return i`
  ...
  `}function z_({loop:t}){const e=t.history[0],n=t.latest_tool_names&&t.latest_tool_names.length>0?`${t.latest_tool_call_count??t.latest_tool_names.length} tool${(t.latest_tool_call_count??t.latest_tool_names.length)===1?"":"s"}: ${t.latest_tool_names.join(", ")}`:"No evidence yet";return i`
  ...
  `}function j_(){const{todo:t,inProgress:e,done:n}=Qo.value,s=[...t].sort(wo),a=[...e].sort(wo),o=[...n].sort(P_);return i`
  ...
  `}function O_(){const{todo:t,inProgress:e,done:n}=Qo.value,s=t.length+e.length+n.length,a=[...t,...e].filter(u=>(u.priority??4)<=2).length,o=w_.value,r=T_.value,c=Ke.value.length>0,d=r.length>0,m=Ci.value;return i`
    <div>
        ...
        <div>
          ${fn.value&&r.length===0?i`<div class="loading-indicator">Loading MDAL loops...</div>`:r.length===0&&(m==="error"||Ue.value)?i`<div class="empty-state">MDAL snapshot could not be loaded${Ue.value?`: ${Ue.value}`:""}. Check backend health.</div>`:r.length===0?i`<div class="empty-state">No active loops. Use <code>masc_mdal_start</code> to start a loop.</div>`:i`
                  <div class="planning-loop-list">
                    ${r.map(u=>i`<${z_} key=${u.loop_id} loop=${u} />`)}
                  </div>
                `}
        </div>
      </details>
    </div>
  `}const bn=_("debates"),Qs=_([]),Zs=_([]),ta=_(!1),kn=_(!1),Hn=_(""),xn=_(""),ea=_(null),Mt=_(null),gi=_(!1);async function fa(){ta.value=!0,Hn.value="";try{const t=await Hl();Qs.value=Array.isArray(t.debates)?t.debates:[],Zs.value=Array.isArray(t.sessions)?t.sessions:[]}catch(t){Hn.value=t instanceof Error?t.message:"Failed to load governance state"}finally{ta.value=!1}}Id(fa);async function To(){const t=xn.value.trim();if(t){kn.value=!0;try{const e=await Ec(t);xn.value="",M(e!=null&&e.id?`Debate started: ${e.id}`:"Debate started","success"),await fa()}catch(e){const n=e instanceof Error?e.message:"Failed to start debate";M(n,"error")}finally{kn.value=!1}}}async function F_(t){ea.value=t,Mt.value=null,gi.value=!0;try{Mt.value=await zc(t)}catch(e){Hn.value=e instanceof Error?e.message:"Failed to load debate detail"}finally{gi.value=!1}}function q_(){return i`
    <div class="board-summary-strip">
      <div class="board-summary-item">
  ...
  `}function K_({debate:t}){const e=ea.value===t.id;return i`
  ...
  `}function H_(){const t=bn.value;return i`
    ...
    <div>
      ...
      <${R} title="Debates" class="section" semanticId="governance.debates">
        <div class="council-list">
          ${Qs.value.length===0?i`<div class="empty-state">No debates yet</div>`:Qs.value.map(t=>i`<${K_} key=${t.id} debate=${t} />`)}
        </div>
      <//>
  ...
  `}function B_(){return i`
    <${R} title="Voting Sessions" class="section" semanticId="governance.voting">
      <div class="council-list">
        ${Zs.value.length===0?i`<div class="empty-state">No active sessions</div>`:Zs.value.map(t=>i`<${U_} key=${t.id} session=${t} />`)}
      </div>
    <//>
  `}function G_(){return rt(()=>{fa()},[]),i`
    <div>
      <${Ct} surfaceId="governance" />
      <${q_} />
      <${H_} />
      ${bn.value==="debates"?i`<${W_} />`:i`<${B_} />`}
    </div>
  `}const De=_(""),Pa=_("ability_check"),La=_("10"),Ma=_("12"),us=_(""),ps=_("idle"),ie=_(""),ms=_("keeper-late"),Da=_("player"),Ea=_(""),xt=_("idle"),za=_(null),vs=_(""),ja=_(""),Oa=_("player"),Fa=_(""),qa=_(""),Ka=_(""),Sn=_("20"),Ua=_("20"),Ha=_(""),_s=_("idle"),$i=_(null),nl=_("overview"),Wa=_("all"),Ba=_("all"),Ga=_("all"),J_=12e4,ga=_(null),Io=_(Date.now());function V_(t,e){const n=e>0?t/e*100:0;return n>50?"hp-high":n>25?"hp-mid":"hp-low"}function Y_(t,e){return e>0?Math.round(t/e*100):0}const X_={pragmatic:"리스크보다 확실한 이득을 우선합니다.",frugal:"자원 소모를 줄이고 효율을 챙깁니다.",impatient:"짧은 템포로 즉시 압박을 선호합니다.",stubborn:"한 번 정한 전술을 끝까지 밀어붙입니다.",protective:"아군 피해를 줄이는 선택을 우선합니다.","honor-bound":"약속과 규율을 지키는 행동에 보너스가 납니다.",intense:"집중 화력을 짧게 폭발시킵니다.",empathetic:"아군/약자 보호 쪽 선택 확률이 높아집니다.",fatalistic:"위험을 감수하는 고배수 선택을 탑니다.",suspicious:"함정/매복 경계 행동을 우선합니다.",precise:"단일 목표를 정확히 노리는 경향입니다.",vengeful:"직전 위협 대상에게 강하게 반응합니다.",aggressive:"공격적인 전진 행동을 우선합니다.",opportunistic:"빈틈이 열리면 즉시 추격합니다."},Q_={supply_scan:"전장/자원 상태를 스캔해 약한 지점을 찾습니다.",ration_shift:"소모를 줄이고 지속 전투 능력을 확보합니다.",logistics_patch:"무너진 운영 라인을 빠르게 복구합니다.",frontline_shield:"전열에서 아군 피해를 흡수합니다.",oath_intercept:"핵심 타깃을 가로막아 위협을 차단합니다.",morale_anchor:"아군 안정도를 높여 붕괴를 막습니다.",omen_trace:"다음 위험 신호를 먼저 감지합니다.",arc_flash:"짧은 순간 광역 압박을 넣습니다.",ward_bloom:"방어 장막을 펼쳐 생존률을 올립니다.",mark_prey:"우선 제거 대상을 지정합니다.",silent_route:"은밀한 진입 경로를 확보합니다.",finisher_strike:"약화된 적을 마무리하는 일격입니다.",shadow_claw:"근접 급습으로 출혈 피해를 노립니다.",lunge:"짧은 돌진으로 전열을 흔듭니다."};function fs(t){const e=t.trim();return e?e.split(/[_-]+/g).filter(n=>n.length>0).map(n=>n[0]?`${n[0].toUpperCase()}${n.slice(1)}`:n).join(" "):t}function Z_(t){const e=t.trim().toLowerCase();return X_[e]??"행동 선택 가중치에 영향을 주는 성향입니다."}function tf(t){const e=t.trim().toLowerCase();return Q_[e]??"상황에 따라 선택되는 전술 액션입니다."}function de(t){return typeof t=="object"&&t!==null}function yt(t,e,n=""){const s=t[e];return typeof s=="string"?s:n}function Dt(t,e,n=0){const s=t[e];return typeof s=="number"&&Number.isFinite(s)?s:n}function Wn(t,e,n=!1){const s=t[e];return typeof s=="boolean"?s:n}const ef=new Set(["str","dex","con","int","wis","cha"]);function nf(t){const e=t.trim();if(!e)return{};let n;try{n=JSON.parse(e)}catch(a){throw new Error(`능력치 JSON 파싱 실패: ${a instanceof Error?a.message:"invalid json"}`)}if(!de(n))throw new Error('능력치 JSON은 object여야 합니다. 예: {"luck":7}');const s={};return Object.entries(n).forEach(([a,o])=>{const r=a.trim();if(r){if(typeof o=="number"&&Number.isFinite(o)){s[r]=Math.max(0,Math.trunc(o));return}if(typeof o=="string"){const c=Number.parseFloat(o.trim());if(Number.isFinite(c)){s[r]=Math.max(0,Math.trunc(c));return}}throw new Error(`능력치 '${r}' 값은 숫자여야 합니다.`)}}),s}function sf(t){const e=Number.parseInt(t.trim(),10);if(!Number.isFinite(e))return;const n=Math.max(1,e),s=Number.parseInt(Sn.value.trim(),10);Number.isFinite(s)&&s>n&&(Sn.value=String(n))}function hi(t){const n=(t.actor_name??t.actor??t.actor_id??"system").trim();return n===""?"system":n}function af(t){var n;return(((n=t.timestamp)==null?void 0:n.trim())??"")||"-"}function of(t){nl.value=t}function sl(t){const e=ga.value;return e==null||e<=t}function rf(t){const e=ga.value;return e==null||e<=t?0:Math.max(0,Math.ceil((e-t)/1e3))}function na(){ga.value=null}function al(t){return typeof window>"u"||typeof window.confirm!="function"?!0:window.confirm(t)}function lf(t,e){al(["관전 모드 잠금을 해제하시겠습니까?",`ROOM: ${t||"-"}`,`PHASE: ${e||"-"}`,"해제 시간: 120초 (시간 경과 또는 위험 액션 실행 후 자동 재잠금)"].join(`
`))&&(ga.value=Date.now()+J_,M("조작 잠금이 120초 동안 해제되었습니다.","warning"))}function Cs(t){return sl(t)?(M("관전 모드 잠금 상태입니다. 먼저 잠금을 해제하세요.","warning"),!1):!0}function yi(t,e,n){return al([`[위험 액션 확인] ${t}`,`ROOM: ${e||"-"}`,`PHASE: ${n||"-"}`,"이 액션은 즉시 실행되며 되돌리기 어렵습니다.","계속 진행하시겠습니까?"].join(`
`))}function cf({hp:t,max:e}){const n=Y_(t,e),s=V_(t,e);return i`
    <div class="trpg-hp-bar">
      <div class="hp-fill ${s}" style="width:${n}%" />
    </div>
  `}function df({stats:t}){const e=[{label:"STR",value:t.strength},{label:"DEX",value:t.dexterity},{label:"CON",value:t.constitution},{label:"INT",value:t.intelligence},{label:"WIS",value:t.wisdom},{label:"CHA",value:t.charisma}];return i`
    <div class="trpg-actor-stats">
      ${e.map(n=>i`<span>${n.label} ${n.value}</span>`)}
    </div>
  `}function uf({keeper:t,role:e}){if(!t)return null;const n=e==="dm"?"dm":"player";return i`
    <span class="trpg-keeper-chip">
      <span class="trpg-keeper-tag ${n}">${n}</span>
      ${t}
    </span>
  `}function il({actor:t}){var d,m,u,p;const e=(d=t.archetype)==null?void 0:d.trim(),n=(m=t.persona)==null?void 0:m.trim(),s=(u=t.portrait)==null?void 0:u.trim(),a=(p=t.background)==null?void 0:p.trim(),o=t.traits??[],r=t.skills??[],c=Object.entries(t.stats_raw??{}).filter(([v,$])=>Number.isFinite($)).filter(([v])=>!ef.has(v.toLowerCase()));return i`
    <div class="trpg-actor">
      ...
      <div class="trpg-actor-header">
        ...
        <${uf} keeper=${t.keeper} role=${t.role} />
      </div>
      ${t.stats?i`
          <div style="margin-top:4px;">
            ...
            <${cf} hp=${t.stats.hp} max=${t.stats.max_hp} />
            <${df} stats=${t.stats} />
          </div>
        `:null}
            ...
            <div class="trpg-annot-list">
              ${r.map(v=>i`
                <span class="trpg-annot-chip skill">
                  <span class="trpg-annot-name">${fs(v)}</span>
                  <span class="trpg-annot-desc">${tf(v)}</span>
                </span>
              `)}
            </div>
          </div>
  ...
  `}function pf({mapStr:t}){return i`<pre class="trpg-map">${t}</pre>`}function ol({events:t,emptyLabel:e="아직 이벤트가 없습니다."}){return t.length===0?i`<div class="empty-state" style="font-size:13px">${e}</div>`:i`
        ...
        <div class="trpg-control-grid">
          ...
          <div class="trpg-control-field">
            ...
            <input
              ...
              min="1"
              value=${Ua.value}
              onInput=${o=>{const r=o.target.value;Ua.value=r,sf(r)}}
              placeholder="20"
            />
          </div>
  ...
  `}function $f({state:t,nowMs:e}){var r,c,d;const n=Vt.value||((r=t.session)==null?void 0:r.room)||"",s=((c=t.current_round)==null?void 0:c.phase)??((d=t.session)==null?void 0:d.status)??"unknown",a=sl(e),o=rf(e);return i`
    <${R} title="조작 안전 잠금" style="margin-bottom:16px;" semanticId="lab.trpg">
      <div class="trpg-control-lock ${a?"locked":"unlocked"}">
        ...
        <div style="display:flex; gap:8px; margin-top:10px; flex-wrap:wrap;">
          ${a?i`<button class="trpg-run-btn recommend" onClick=${()=>lf(n,s)}>잠금 해제 (120초)</button>`:i`<button class="trpg-run-btn secondary" onClick=${()=>{na(),M("조작 잠금으로 전환했습니다.","success")}}>즉시 다시 잠금</button>`}
        </div>
      </div>
    <//>
  `}function hf({active:t}){return i`
  ...
  `}function yf({state:t}){const e=t.party??[],n=t.story_log??[];return i`
  ...
  `}function bf({state:t}){const e=t.story_log??[];return i`
    <div class="trpg-layout">
      <div>
  ...
  `}function kf({state:t,nowMs:e}){const n=t.party??[];return i`
    <div>
      <${$f} state=${t} nowMs=${e} />
      <div class="trpg-layout">
        <div>
  ...
  `}function xf(){var c,d,m,u,p;const t=Vo.value,e=ri.value;if(rt(()=>{if(typeof window>"u"||typeof window.setInterval!="function")return;const v=window.setInterval(()=>{Io.value=Date.now()},1e3);return()=>{window.clearInterval(v)}},[]),e&&!t)return i`<div class="loading-indicator">Loading TRPG state...</div>`;if(!t)return i`
      <div class="section">
        <h2>TRPG</h2>
    ...
    <div>
      ...
      ${o==="overview"?i`<${yf} state=${t} />`:o==="timeline"?i`<${bf} state=${t} />`:i`<${kf} state=${t} nowMs=${r} />`}
    </div>
  ...
  `}const sa=_(new Set(["broadcast","tasks","keepers","system"]));function Af(t){const e=new Set(sa.value);e.has(t)?e.delete(t):e.add(t),sa.value=e}const Hi=_(null);function ul(t){Hi.value=t}function Cf(t){return t.kind==="board"?"broadcast":t.kind==="tasks"?"tasks":t.kind==="keepers"?"keepers":"system"}const wf=Nt(()=>{const t=sa.value;return Ts.value.filter(e=>t.has(Cf(e)))}),Tf=12e4,If=Nt(()=>{const t=ra.value,e=Date.now();return wt.value.map(n=>{const s=n.name.trim().toLowerCase(),a=t.get(s)??null;let o="idle";if(n.status==="active"||n.status==="busy"){const r=a==null?void 0:a.lastActivityAt;r?o=e-new Date(r).getTime()>Tf?"stale":"working":o="working"}else(n.status==="offline"||n.status==="inactive")&&(o="stale");return{name:n.name,emoji:n.emoji??"",koreanName:n.koreanName??null,state:o,currentTask:n.current_task,motion:a}})}),Rf=Nt(()=>{const t=ra.value;return wt.value.filter(e=>e.status==="active"||e.status==="busy"||e.status==="listening"||e.status==="idle").map(e=>{const n=e.name.trim().toLowerCase(),s=t.get(n),a=(s==null?void 0:s.activeAssignedCount)??0;let o="calm";return a>=3?o="hot":a>=1&&(o="normal"),{name:e.name,emoji:e.emoji??"",koreanName:e.koreanName??null,currentTask:e.current_task,lastActivityAt:(s==null?void 0:s.lastActivityAt)??null,lastActivityText:(s==null?void 0:s.lastActivityText)??null,assignedCount:a,pressure:o}}).sort((e,n)=>{const s={hot:0,normal:1,calm:2};return s[e.pressure]-s[n.pressure]})});function Ro(t){return t.kind==="board"?"live-event-broadcast":t.kind==="tasks"?"live-event-task":t.kind==="keepers"?"live-event-keeper":"live-event-system"}function Nf(t){const e=t.eventType;return e==="broadcast"?"broadcast":e==="agent_joined"?"joined":e==="agent_left"?"left":e==="task_update"?"task":e==="board_post"?"post":e==="board_comment"?"comment":e==="keeper_heartbeat"?"heartbeat":e==="keeper_handoff"?"handoff":e==="keeper_compaction"?"compact":e==="keeper_guardrail"?"guardrail":t.kind==="board"?"board":t.kind==="tasks"?"task":t.kind==="keepers"?"keeper":"system"}function Pf(t){switch(t){case"working":return"pulse-working";case"stale":return"pulse-stale";default:return"pulse-idle"}}function Lf(){const t=If.value,e=Hi.value;return t.length===0?i`
    ...
    <div class="pulse-strip">
      ${t.map(n=>i`
        <button
          key=${n.name}
          class="pulse-bubble ${Pf(n.state)} ${e===n.name?"pulse-selected":""}"
  ...
  `}const Mf=[{kind:"broadcast",label:"Broadcast",cssClass:"live-event-broadcast"},{kind:"tasks",label:"Task",cssClass:"live-event-task"},{kind:"keepers",label:"Keeper",cssClass:"live-event-keeper"},{kind:"system",label:"System",cssClass:"live-event-system"}];function Df(){const t=sa.value;return i`
  ...
  `}function Ef(){const t=wf.value;return i`
        ...
        ${t.length===0?i`<div class="activity-empty">No events matching filters</div>`:t.map((e,n)=>i`
            ...
            >
              <div class="activity-item-head">
                <span class="activity-kind-chip ${Ro(e)}">${Nf(e)}</span>
  ...
  `}function zf(t){switch(t){case"hot":return"focus-pressure-hot";case"normal":return"focus-pressure-normal";default:return"focus-pressure-calm"}}function jf(t){switch(t){case"hot":return"High";case"normal":return"Active";default:return"Calm"}}function Of(){const t=Rf.value,e=Hi.value;return i`
  ...
  `}function Ff(){const t=ue.value;return i`
  ...
  `}function Uf(){const t=Ht.value,e=(t==null?void 0:t.pending_confirms.length)??0,n=(t==null?void 0:t.sessions.length)??0,s=(t==null?void 0:t.keepers.length)??0;return i`
    <section class="rail-card">
      <div class="rail-card-head">
        <h3>개입 바로가기</h3>
  ...
  `}function Hf(){const t=O.value.tab,e=bi.find(s=>s.id===t),n=No.find(s=>s.id===(e==null?void 0:e.group));return i`
    <aside class="dashboard-rail">
      ...
      <${Kf} currentTab=${t} currentSectionLabel=${(n==null?void 0:n.label)??"Observe"} />
      <${Uf} />
    </aside>
  `}function Wf(){switch(O.value.tab){case"mission":return i`<${uo} />`;case"execution":return i`<${A_} />`;case"live":return i`<${Ff} />`;case"memory":return i`<${m_} />`;case"governance":return i`<${G_} />`;case"planning":return i`<${O_} />`;case"intervene":return i`<${t_} />`;case"command":return i`<${zv} />`;case"lab":return i`<${Sf} />`;default:return i`<${uo} />`}}function Bf(){rt(()=>{xl(),jo(),nr(),Jt(),er(),bs();const n=Pd();return Ld(),()=>{Nl(),n(),Md()}},[]),rt(()=>{const n=setInterval(()=>{const s=O.value.tab;s==="command"?(oe(),re(),(G.value==="swarm"||G.value==="warroom")&&Ot(),G.value==="warroom"&&lt()):s==="mission"?bs():s==="execution"?Jt():s==="intervene"?(lt(),Qt()):s==="memory"?Kt():s==="planning"?Tn():s==="lab"&&Ut()},15e3);return()=>{clearInterval(n)}},[]),rt(()=>{const n=O.value.tab;n==="command"&&(oe(),re(),(G.value==="swarm"||G.value==="warroom")&&Ot(),G.value==="warroom"&&lt()),n==="mission"&&(bs(),In()),n==="execution"&&Jt(),n==="intervene"&&(lt(),Qt()),n==="memory"&&Kt(),n==="planning"&&Tn(),n==="lab"&&Ut()},[O.value.tab]);const t=O.value.tab,e=bi.find(n=>n.id===t);return i`
    <div class="app-shell">
      ...
      <div class="dashboard-layout">
        ...
        <main class="dashboard-main">
          ${oi.value&&!ue.value?i`<div class="loading-indicator">Loading dashboard...</div>`:i`<${Wf} />`}
        </main>
      </div>
  ...
  `}const Po=document.getElementById("app");Po&&$l(i`<${Bf} />`,Po);export{Im as _};
