...
브레이크는 하나다. 조항 전체의 렌더 바이트에 상한을 둔다. 상한에 닿은 세계는 새 조항을 받지
않고, 누군가 무엇을 지울지 정해야 한다. 자동 만료를 두지 않는 이유는 조용한 삭제보다 막힌
추가가 낫기 때문이다. 무엇이 빠졌는지 아무도 모르는 것보다, 무엇을 뺄지 정하는 편이 세계에
보인다.
...
- 문장이 비었거나 쓴 사람이 없는 조항이 거부된다.
- 지운 조항이 다음 부팅 프롬프트에 없다.
- 지웠다 다시 쓴 조항이 다시 실리고, 원장에 세 줄이 남는다.
- 바이트 상한에 닿은 세계에서 새 조항 추가가 거부된다.
