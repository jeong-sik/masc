...
OAS pin metadata is generated from `scripts/oas-agent-sdk-pin.sh`. Current dependency floor: `agent_sdk >= 0.198.1`, runtime pin: `main@b85b84f2cf23b324869e57f8d36e4e77baeb3b42`, declared base version: `v0.198.1`. 최신성 검증이 필요할 때는 문서에 적힌 숫자보다 `dune-project`와 pin script를 우선 truth source로 본다.
...
`Execute`/`keeper_bash`가 담당하고, Legendary Bash gate와 write/sandbox
정책도 그 경로에만 적용된다.
