...
`).map(n=>n.trim()).filter(n=>n!=="")}async function tp(e,t=20){return _t("masc_task_history",{task_id:e,limit:t})}async function np(e){const t=await _t("masc_debate_start",{topic:e});try{return JSON.parse(t)}catch{return null}}async function sp(e){return Ka("fetchDebateStatus",async()=>{const t=encodeURIComponent(e),n=await se(`/api/v1/council/debates/${t}/summary`);if(!m(n))return null;const s=m(n.debate)?n.debate:n,a=k(s.id,"").trim(),i=k(s.topic,"").trim();return!a||!i?null:{debate:{id:a,topic:i,status:k(s.status,"open"),created_at:ue(s.created_at_iso??s.created_at),closed_at:ue(s.closed_at)},arguments:Array.isArray(n.arguments)?n.arguments.flatMap(l=>m(l)?[{index:H(l.index,0),agent:k(l.agent,"unknown"),position:k(l.position,"neutral"),content:k(l.content,""),evidence:De(l.evidence),reply_to:fe(l.reply_to)??null,mentions:De(l.mentions),archetype:K(l.archetype),created_at:ue(l.created_at)}]:[]):[],summary:{support_count:m(n.summary)?H(n.summary.support_count,0):H(n.support_count,0),oppose_count:m(n.summary)?H(n.summary.oppose_count,0):H(n.oppose_count,0),neutral_count:m(n.summary)?H(n.summary.neutral_count,0):H(n.neutral_count,0),total_arguments:m(n.summary)?H(n.summary.total_arguments,0):H(n.total_arguments,0),summary_text:m(n.summary)?k(n.summary.summary_text,""):k(n.summary_text,"")},context:$i(n.context),judgment:bl(n.judgment)}})}async function ap(e){return Ka("fetchConsensusSessionSummary",async()=>{const t=encodeURIComponent(e),n=await se(`/api/v1/council/sessions/${t}/summary`);if(!m(n)||!m(n.session))return null;const s=n.session,a=k(s.id,"").trim(),i=k(s.topic,"").trim();return!a||!i?null:{session:{id:a,topic:i,state:k(s.state,"open"),initiator:k(s.initiator,"system"),quorum:H(s.quorum,0),threshold:H(s.threshold,0),created_at:ue(s.created_at),closed_at:ue(s.closed_at)},votes:Array.isArray(n.votes)?n.votes.flatMap(l=>m(l)?[{agent:k(l.agent,"unknown"),decision:k(l.decision,"abstain"),reason:k(l.reason,""),timestamp:ue(l.timestamp),weight:typeof l.weight=="number"?l.weight:void 0,archetype:K(l.archetype)}]:[]):[],summary:{approve_count:m(n.summary)?H(n.summary.approve_count,0):0,reject_count:m(n.summary)?H(n.summary.reject_count,0):0,abstain_count:m(n.summary)?H(n.summary.abstain_count,0):0,quorum_met:m(n.summary)?ta(n.summary.quorum_met,!1):!1,result:m(n.summary)?K(n.summary.result):null},context:$i(n.context),judgment:bl(n.judgment)}})}function op(e,t,n){return _t("masc_keeper_msg",{name:e,message:t})}const ip=g(""),Ve=g({}),_e=g({}),Oo=g({}),qo=g({}),wo=g({}),Fo=g({}),Ye=g({});function de(e,t,n){e.value={...e.value,[t]:n}}function rp(e){var n;const t=(n=r(e))==null?void 0:n.toLowerCase();return t==="user"||t==="assistant"||t==="system"||t==="tool"?t:"other"}function lp(e){switch(e){case"user":return"User";case"assistant":return"Keeper";case"system":return"System";case"tool":return"Tool";default:return"Event"}}function Za(e,t){if(!Array.isArray(e))return[];const n=[];for(const s of e){if(!m(s))continue;const a=r(s.name);if(!a)continue;const i=r(s[t]);t==="summary"?n.push({name:a,summary:i}):n.push({name:a,reason:i})}return n}function cp(e){if(!m(e))return null;const t=r(e.name);return t?{name:t,trigger:r(e.trigger),outcome:r(e.outcome),summary:r(e.summary),reason:r(e.reason)}:null}function dp(e){const t=e.toLowerCase();return t.includes("graphql")?"graphql_error":t.includes("timeout")||t.includes("model")||t.includes("llm")||t.includes("api key")||t.includes("api_key")||t.includes("provider")?"llm_error":"unknown"}function up(e,t){return e==="offline"||e==="degraded"||e==="stale"?"Keeper is not in a healthy reply state. Probe or recover before relying on automation.":t==="quiet_hours"?"Lodge quiet hours are active. Direct messages still work, but scheduled social ticks may look asleep.":t==="min_gap"?"Keeper is inside its proactive cooldown window. Direct messages work now; autonomous check-ins will wait.":t==="never_started"?"Keeper metadata exists but no reply turn has been recorded yet.":"Keeper is reachable. Send a direct message for an immediate response."}function xl(e,t,n){return r(e)??up(t,n)}function Sl(e,t){return typeof e=="boolean"?e:t==="recover"}function na(e){if(!m(e))return null;const t=r(e.health_state),n=r(e.next_action_path),s=r(e.last_reply_status);return!t||!n||!s?null:{health_state:t,quiet_reason:r(e.quiet_reason)??null,next_action_path:n,last_reply_status:s,last_reply_at:le(e.last_reply_at)??null,last_reply_preview:r(e.last_reply_preview)??null,last_error:r(e.last_error)??null,next_eligible_at_s:d(e.next_eligible_at_s)??null,recoverable:Sl(e.recoverable,n),summary:xl(e.summary,t,r(e.quiet_reason)??null),keepalive_running:typeof e.keepalive_running=="boolean"?e.keepalive_running:void 0}}function Cl(e){return m(e)?{hour:d(e.hour),checked:d(e.checked)??0,acted:d(e.acted)??0,acted_names:F(e.acted_names),activity_report:r(e.activity_report),quiet_hours_overridden:M(e.quiet_hours_overridden),skipped_reason:r(e.skipped_reason),acted_rows:Za(e.acted_rows,"summary").map(t=>({name:t.name,summary:t.summary})),passed_rows:Za(e.passed_rows,"reason").map(t=>({name:t.name,reason:t.reason})),skipped_rows:Za(e.skipped_rows,"reason").map(t=>({name:t.name,reason:t.reason})),checkins:Array.isArray(e.checkins)?e.checkins.map(cp).filter(t=>t!==null):[]}:null}function pp(e){return m(e)?{enabled:M(e.enabled)??!1,interval_s:d(e.interval_s)??0,quiet_start:d(e.quiet_start),quiet_end:d(e.quiet_end),quiet_active:M(e.quiet_active),use_planner:M(e.use_planner),delegate_llm:M(e.delegate_llm),agent_count:d(e.agent_count),agents:F(e.agents),last_tick_ago_s:d(e.last_tick_ago_s)??null,last_tick_ago:r(e.last_tick_ago),total_ticks:d(e.total_ticks),total_checkins:d(e.total_checkins),last_skip_reason:r(e.last_skip_reason)??null,last_tick_result:Cl(e.last_tick_result),active_self_heartbeats:F(e.active_self_heartbeats)}:null}function mp(e){return m(e)?{status:e.status,diagnostic:na(e.diagnostic)}:null}function _p(e){return m(e)?{recovered:M(e.recovered)??!1,skipped_reason:r(e.skipped_reason)??null,before:na(e.before),after:na(e.after),down:e.down,up:e.up}:null}function vp(e,t){var $,R;if(!(e!=null&&e.name))return null;const n=r(($=e.agent)==null?void 0:$.status)??r(e.status)??"unknown",s=r((R=e.agent)==null?void 0:R.error)??null,a=e.presence_keepalive??!0,i=e.keepalive_running??!1,l=e.turn_count??0,c=e.last_turn_ago_s??null,p=e.proactive_enabled??!1,_=e.proactive_cooldown_sec??0,u=e.last_proactive_ago_s??null,f=p&&u!=null?Math.max(0,_-u):null,v=l<=0||c==null?"never":c>900?"stale":"fresh",h=typeof e.last_heartbeat=="string"&&e.last_heartbeat.trim()?e.last_heartbeat:null,b=s??(a&&!i?"keeper keepalive is not running":null),C=n==="offline"||n==="inactive"?"offline":b?"degraded":v==="stale"?"stale":v==="never"?"idle":"healthy",x=b?dp(b):t!=null&&t.quiet_active&&v!=="fresh"?"quiet_hours":a&&!i?"disabled":l<=0?"never_started":f!=null&&f>0?"min_gap":v==="fresh"||v==="stale"?"no_recent_activity":"unknown",S=C==="offline"||C==="degraded"||C==="stale"?"recover":x==="quiet_hours"?"manual_lodge_poke":x==="unknown"?"probe":"direct_message";return{health_state:C,quiet_reason:x,next_action_path:S,last_reply_status:v,last_reply_at:h,last_reply_preview:null,last_error:b,next_eligible_at_s:f!=null&&f>0?f:null,recoverable:Sl(void 0,S),summary:xl(void 0,C,x),keepalive_running:i}}function fp(e,t){if(!m(e))return null;const n=rp(e.role),s=r(e.content)??r(e.preview);if(!s)return null;const a=le(e.ts_unix)??le(e.timestamp);return{id:`${n}-${a??"entry"}-${t}`,role:n,label:lp(n),text:s,timestamp:a,delivery:"history"}}function gp(e,t,n){const s=m(n)?n:null,a=Array.isArray(s==null?void 0:s.history_tail)?s.history_tail.map((i,l)=>fp(i,l)).filter(i=>i!==null):[];return{name:e,diagnostic:na(s==null?void 0:s.diagnostic),history:a,rawText:t,rawStatus:n,loadedAt:new Date().toISOString()}}function cr(e,t){const n=_e.value[e]??[];_e.value={..._e.value,[e]:[...n,t].slice(-50)}}function $p(e,t){return e.role!==t.role||e.text!==t.text?!1:e.timestamp&&t.timestamp?e.timestamp===t.timestamp:!0}function hp(e,t){const s=(_e.value[e]??[]).filter(a=>a.delivery!=="history"&&!t.some(i=>$p(a,i)));_e.value={..._e.value,[e]:[...t,...s].slice(-50)}}function Ba(e,t){Ve.value={...Ve.value,[e]:t},hp(e,t.history)}function dr(e,t){const n=Ve.value[e];if(!n)return;const s=n.diagnostic??{health_state:"idle",next_action_path:"direct_message",last_reply_status:"unknown"};Ba(e,{...n,diagnostic:{...s,...t}})}async function hi(){try{await rs()}catch(e){console.warn("[keeper-runtime] dashboard refresh failed",e)}}function yp(e){ip.value=e.trim()}async function Al(e,t=!1){const n=e.trim();if(!n)return null;if(!t&&Ve.value[n])return Ve.value[n];de(Oo,n,!0),de(Ye,n,null);try{const s=await _t("masc_keeper_status",{name:n,fast:!1,include_context:!0,include_metrics_overview:!0,include_memory_bank:!1,include_history_tail:!0,include_compaction_history:!1,tail_turns:5,tail_messages:10});let a=null;try{a=JSON.parse(s)}catch{a=null}const i=gp(n,s,a);return Ba(n,i),i}catch(s){const a=s instanceof Error?s.message:`Failed to inspect ${n}`;return de(Ye,n,a),null}finally{de(Oo,n,!1)}}async function bp(e,t){const n=e.trim(),s=t.trim();if(!n||!s)return;const a=`local-${Date.now()}`;cr(n,{id:a,role:"user",label:"You",text:s,timestamp:new Date().toISOString(),delivery:"sending"}),de(qo,n,!0),de(Ye,n,null);try{const i=await op(n,s);_e.value={..._e.value,[n]:(_e.value[n]??[]).map(l=>l.id===a?{...l,delivery:"delivered"}:l)},cr(n,{id:`reply-${Date.now()}`,role:"assistant",label:n,text:i.trim()||"(empty reply)",timestamp:new Date().toISOString(),delivery:"delivered"}),dr(n,{last_reply_status:"delivered",last_reply_at:new Date().toISOString(),last_reply_preview:(i.trim()||"(empty reply)").slice(0,200),last_error:null}),await hi()}catch(i){const l=i instanceof Error?i.message:`Failed to send direct message to ${n}`;throw _e.value={..._e.value,[n]:(_e.value[n]??[]).map(c=>c.id===a?{...c,delivery:"error",error:l}:c)},dr(n,{last_reply_status:"error",last_error:l}),de(Ye,n,l),i}finally{de(qo,n,!1)}}async function kp(e,t){const n=e.trim();if(!n)return null;de(wo,n,!0),de(Ye,n,null);try{const s=await Ua({actor:t,action_type:"keeper_probe",target_type:"keeper",target_id:n,payload:{}}),a=mp(s.result),i=(a==null?void 0:a.diagnostic)??null;if(i){const l=Ve.value[n];Ba(n,{name:n,diagnostic:i,history:(l==null?void 0:l.history)??_e.value[n]??[],rawText:(l==null?void 0:l.rawText)??"",rawStatus:s.result,loadedAt:new Date().toISOString()})}return await hi(),i}catch(s){const a=s instanceof Error?s.message:`Failed to probe ${n}`;throw de(Ye,n,a),s}finally{de(wo,n,!1)}}async function xp(e,t){const n=e.trim();if(!n)return null;de(Fo,n,!0),de(Ye,n,null);try{const s=await Ua({actor:t,action_type:"keeper_recover",target_type:"keeper",target_id:n,payload:{}}),a=_p(s.result),i=(a==null?void 0:a.after)??null;if(i){const l=Ve.value[n];Ba(n,{name:n,diagnostic:i,history:(l==null?void 0:l.history)??_e.value[n]??[],rawText:(l==null?void 0:l.rawText)??"",rawStatus:s.result,loadedAt:new Date().toISOString()})}return await hi(),i}catch(s){const a=s instanceof Error?s.message:`Failed to recover ${n}`;throw de(Ye,n,a),s}finally{de(Fo,n,!1)}}function yt(e){return(e??"").trim().toLowerCase()}function he(e){const t=typeof e=="number"?e:Date.parse(e);return Number.isNaN(t)?0:t}function Ks(e,t=88){const n=e.replace(/\s+/g," ").trim();return n&&(n.length>t?`${n.slice(0,t-3)}...`:n)}function Cs(e){return typeof e!="number"||!Number.isFinite(e)||e<0?null:new Date(Date.now()-e*1e3).toISOString()}function bn(e){return e.last_heartbeat??Cs(e.last_turn_ago_s)??Cs(e.last_proactive_ago_s)??Cs(e.last_handoff_ago_s)??Cs(e.last_compaction_ago_s)}function Sp(e){const t=e.title.trim();return t||Ks(e.content)}function Cp(e){const t=e.generation??"?",n=typeof e.context_ratio=="number"&&Number.isFinite(e.context_ratio)?`${Math.round(e.context_ratio*100)}%`:"?";return e.last_heartbeat?`Heartbeat gen=${t} ctx=${n}`:`Keeper snapshot gen=${t} ctx=${n}`}function Ap(e,t,n,s,a={}){var R;const i=yt(e),l=t.filter(I=>yt(I.assignee)===i&&(I.status==="claimed"||I.status==="in_progress")).length,c=n.filter(I=>yt(I.from)===i).sort((I,L)=>he(L.timestamp)-he(I.timestamp))[0],p=s.filter(I=>yt(I.agent)===i||yt(I.author)===i).sort((I,L)=>he(L.timestamp)-he(I.timestamp))[0],_=(a.boardPosts??[]).filter(I=>yt(I.author)===i).sort((I,L)=>he(L.updated_at||L.created_at)-he(I.updated_at||I.created_at))[0],u=(a.keepers??[]).filter(I=>yt(I.name)===i&&bn(I)!==null).sort((I,L)=>he(bn(L)??0)-he(bn(I)??0))[0],f=c?he(c.timestamp):0,v=p?he(p.timestamp):0,h=_?he(_.updated_at||_.created_at):0,b=u?he(bn(u)??0):0,C=a.lastSeen?he(a.lastSeen):0,x=((R=a.currentTask)==null?void 0:R.trim())||(l>0?`${l} claimed tasks`:null);if(f===0&&v===0&&h===0&&b===0&&C===0)return{activeAssignedCount:l,lastActivityAt:null,lastActivityText:x};const $=[c?{timestamp:c.timestamp,ts:f,text:Ks(c.content)}:null,_?{timestamp:_.updated_at||_.created_at,ts:h,text:`Post: ${Ks(Sp(_))}`}:null,u?{timestamp:bn(u),ts:b,text:Cp(u)}:null,p?{timestamp:new Date(p.timestamp).toISOString(),ts:v,text:Ks(p.text)}:null].filter(I=>I!==null).sort((I,L)=>L.ts-I.ts)[0];return $&&$.ts>=C?{activeAssignedCount:l,lastActivityAt:$.timestamp,lastActivityText:$.text}:{activeAssignedCount:l,lastActivityAt:a.lastSeen??null,lastActivityText:x??"Presence heartbeat"}}const Qe=g([]),st=g([]),Ko=g([]),vt=g([]),re=g(null),Tp=g(null),Tl=g(null),Il=g([]),zl=g([]),Rl=g([]),Ll=g([]),Pl=g(null),yi=g([]),bi=g([]),Ml=g([]),Uo=g(new Map),Ha=g([]),Fn=g("recent"),At=g(!0),jl=g(null),Je=g(""),Qt=g([]),zn=g(!1),El=g(new Map),ki=g("unknown"),Xt=g(null),Bo=g(!1),Kn=g(!1),Ho=g(!1),Rn=g(!1),xi=g(null),sa=g(!1),aa=g(null),Nl=g(null),Wo=g(null),Ip=g(null),zp=g(null),Rp=g(null);Le(()=>Qe.value.filter(e=>e.status==="active"||e.status==="busy"||e.status==="listening"||e.status==="idle"));const Dl=Le(()=>{const e=st.value;return{todo:e.filter(t=>t.status==="todo"),inProgress:e.filter(t=>t.status==="in_progress"||t.status==="claimed"),done:e.filter(t=>t.status==="done")}}),Ol=Le(()=>{const e=new Map,t=st.value,n=Ko.value,s=ea.value,a=Ha.value,i=vt.value;for(const l of Qe.value)e.set(l.name.trim().toLowerCase(),Ap(l.name,t,n,s,{currentTask:l.current_task,lastSeen:l.last_seen,boardPosts:a,keepers:i}));return e});function Lp(e){var i;const t=((i=e.status)==null?void 0:i.toLowerCase())??"";if(t==="offline"||t==="inactive")return"offline";const n=e.metrics_series;if(!n||n.length===0)return"idle";const s=n[n.length-1];if(!s)return"idle";if(s.is_handoff)return"handoff-imminent";if(s.is_compaction)return"compacting";const a=s.context_ratio;return a>.85?"handoff-imminent":a>.7?"preparing":a>.5?"compacting":"active"}Le(()=>{const e=new Map;for(const t of vt.value)e.set(t.name,Lp(t));return e});const Pp=12e4;function Mp(e,t){const n=t.get(e.name);if(n!=null)return n;const s=e.last_heartbeat?Date.parse(e.last_heartbeat):Number.NaN;if(!Number.isNaN(s))return s;const a=[e.last_turn_ago_s,e.last_proactive_ago_s,e.last_handoff_ago_s,e.last_compaction_ago_s].find(i=>typeof i=="number"&&Number.isFinite(i)&&i>=0);return typeof a=="number"?Date.now()-a*1e3:null}Le(()=>{const e=Date.now(),t=new Set,n=Uo.value;for(const s of vt.value){const a=Mp(s,n);a!=null&&e-a>Pp&&t.add(s.name)}return t});function jp(e){return e==="dashboard_refresh"||e==="masc/dashboard_refresh"||e.startsWith("goal_")||e.startsWith("masc/goal_")||e.startsWith("mdal_")||e.startsWith("masc/mdal_")||e.startsWith("operator_")||e.startsWith("masc/operator_")||e.startsWith("command_plane_")||e.startsWith("masc/command_plane_")}function ql(e){const t=typeof e=="string"?e.toLowerCase():"";return t==="active"||t==="busy"||t==="listening"||t==="idle"||t==="inactive"||t==="offline"?t:t==="in_progress"||t==="claimed"?"busy":"offline"}function Ep(e){const t=typeof e=="string"?e.toLowerCase():"";return t==="todo"||t==="in_progress"||t==="claimed"||t==="done"||t==="cancelled"?t:t==="inprogress"?"in_progress":"todo"}function Np(e){if(!m(e))return null;const t=r(e.name);return t?{name:t,agent_type:r(e.agent_type),status:ql(e.status),current_task:r(e.current_task)??null,joined_at:r(e.joined_at),last_seen:r(e.last_seen),capabilities:F(e.capabilities),emoji:r(e.emoji),koreanName:r(e.koreanName)??r(e.korean_name),model:r(e.model),traits:F(e.traits),interests:F(e.interests),activityLevel:d(e.activityLevel)??d(e.activity_level),primaryValue:r(e.primaryValue)??r(e.primary_value)}:null}function Dp(e){if(!m(e))return null;const t=r(e.id),n=r(e.title);return!t||!n?null:{id:t,title:n,status:Ep(e.status),priority:d(e.priority),assignee:r(e.assignee),description:r(e.description),created_at:r(e.created_at),updated_at:r(e.updated_at)}}function Op(e){if(!m(e))return null;const t=r(e.from)??r(e.from_agent)??"system",n=r(e.content)??"",s=r(e.timestamp)??new Date().toISOString();return{id:r(e.id),seq:d(e.seq),from:t,content:n,timestamp:s,type:r(e.type)}}function Si(e){const t=typeof e=="string"?e.toLowerCase():"";return t==="ok"||t==="warn"||t==="bad"?t:"ok"}function qp(e){return m(e)?{active_sessions:d(e.active_sessions),blocked_sessions:d(e.blocked_sessions),active_operations:d(e.active_operations),blocked_operations:d(e.blocked_operations),runtime_pressure:d(e.runtime_pressure),worker_alerts:d(e.worker_alerts),continuity_alerts:d(e.continuity_alerts),priority_items:d(e.priority_items),todo_tasks:d(e.todo_tasks),claimed_tasks:d(e.claimed_tasks),running_tasks:d(e.running_tasks),done_tasks:d(e.done_tasks),cancelled_tasks:d(e.cancelled_tasks),keepers:d(e.keepers)}:null}function at(e){if(!m(e))return null;const t=r(e.surface),n=r(e.label),s=r(e.target_type),a=r(e.target_id),i=r(e.focus_kind);return!t||!n||!s||!a||!i?null:{surface:t==="command"?"command":"intervene",label:n,target_type:s,target_id:a,focus_kind:i,operation_id:r(e.operation_id)??null,command_surface:r(e.command_surface)??null}}function wp(e){if(!m(e))return null;const t=r(e.id),n=r(e.kind),s=r(e.summary),a=r(e.target_type),i=r(e.target_id);return!t||!s||!a||!i||n!=="session"&&n!=="operation"?null:{id:t,kind:n,severity:Si(e.severity),status:r(e.status),summary:s,target_type:a,target_id:i,linked_session_id:r(e.linked_session_id)??null,linked_operation_id:r(e.linked_operation_id)??null,last_seen_at:r(e.last_seen_at)??null,top_handoff:at(e.top_handoff),intervene_handoff:at(e.intervene_handoff),command_handoff:at(e.command_handoff)}}function Fp(e){if(!m(e))return null;const t=r(e.session_id),n=r(e.goal);return!t||!n?null:{session_id:t,goal:n,room:r(e.room)??null,status:r(e.status),health:r(e.health),member_names:F(e.member_names),linked_operation_id:r(e.linked_operation_id)??null,linked_detachment_id:r(e.linked_detachment_id)??null,runtime_blocker:r(e.runtime_blocker)??null,worker_gap_summary:r(e.worker_gap_summary)??null,last_activity_at:r(e.last_activity_at)??null,last_activity_summary:r(e.last_activity_summary)??null,communication_summary:r(e.communication_summary)??null,active_count:d(e.active_count),required_count:d(e.required_count),top_handoff:at(e.top_handoff),intervene_handoff:at(e.intervene_handoff),command_handoff:at(e.command_handoff)}}function Kp(e){if(!m(e))return null;const t=r(e.operation_id),n=r(e.objective);return!t||!n?null:{operation_id:t,objective:n,status:r(e.status),stage:r(e.stage)??null,assigned_unit_id:r(e.assigned_unit_id)??null,assigned_unit_label:r(e.assigned_unit_label)??null,linked_session_id:r(e.linked_session_id)??null,linked_detachment_id:r(e.linked_detachment_id)??null,blocker_summary:r(e.blocker_summary)??null,search_status:r(e.search_status)??null,next_tool:r(e.next_tool)??null,updated_at:r(e.updated_at)??null,top_handoff:at(e.top_handoff),command_handoff:at(e.command_handoff)}}function ur(e){if(!m(e))return null;const t=r(e.name)??r(e.agent_name),n=r(e.note),s=r(e.focus),a=r(e.state);return!t||!n||!s||a!=="working"&&a!=="watching"&&a!=="quiet"&&a!=="offline"?null:{name:t,agent_name:r(e.agent_name),status:r(e.status),tone:Si(e.tone),state:a,note:n,focus:s,last_signal_at:r(e.last_signal_at)??null,active_task_count:d(e.active_task_count),related_session_id:r(e.related_session_id)??null,related_operation_id:r(e.related_operation_id)??null,emoji:r(e.emoji),korean_name:r(e.korean_name),model:r(e.model)??null,recent_output_preview:r(e.recent_output_preview)??null,recent_event:r(e.recent_event)??null}}function Up(e){return m(e)?{checked:d(e.checked),acted:d(e.acted),passed:d(e.passed),skipped:d(e.skipped),failed:d(e.failed),last_tick_at:r(e.last_tick_at)??null,last_skip_reason:r(e.last_skip_reason)??null,activity_report:r(e.activity_report)??null}:null}function Bp(e){if(!m(e))return null;const t=r(e.agent_name),n=r(e.outcome);return!t||!n?null:{agent_name:t,trigger:r(e.trigger)??null,outcome:n,summary:r(e.summary)??null,reason:r(e.reason)??null,allowed_tool_names:F(e.allowed_tool_names)??[],used_tool_names:F(e.used_tool_names)??[],used_tool_call_count:d(e.used_tool_call_count)??null,action_kind:r(e.action_kind)??"none",tool_audit_source:r(e.tool_audit_source)??null,tool_audit_at:r(e.tool_audit_at)??null,checked_at:r(e.checked_at)??null,decision_reason:r(e.decision_reason)??null,worker_name:r(e.worker_name)??null,failure_reason:r(e.failure_reason)??null}}function Hp(e){if(!m(e))return null;const t=r(e.name),n=r(e.note),s=r(e.focus),a=r(e.state);return!t||!n||!s||a!=="healthy"&&a!=="warning"&&a!=="critical"?null:{name:t,agent_name:r(e.agent_name)??null,status:r(e.status),tone:Si(e.tone),state:a,note:n,focus:s,last_signal_at:r(e.last_signal_at)??null,last_autonomous_action_at:r(e.last_autonomous_action_at)??null,generation:d(e.generation),turn_count:d(e.turn_count),context_ratio:d(e.context_ratio)??null,continuity:r(e.continuity)??null,lifecycle:r(e.lifecycle)??null,related_session_id:r(e.related_session_id)??null,model:r(e.model)??null,emoji:r(e.emoji),korean_name:r(e.korean_name),skill_reason:r(e.skill_reason)??null,recent_input_preview:r(e.recent_input_preview)??null,recent_output_preview:r(e.recent_output_preview)??null,recent_tool_names:F(e.recent_tool_names)??[],allowed_tool_names:F(e.allowed_tool_names)??[],latest_tool_names:F(e.latest_tool_names)??[],latest_tool_call_count:d(e.latest_tool_call_count)??null,tool_audit_source:r(e.tool_audit_source)??null,tool_audit_at:r(e.tool_audit_at)??null,last_proactive_preview:r(e.last_proactive_preview)??null,continuity_summary:r(e.continuity_summary)??null,skill_route_summary:r(e.skill_route_summary)??null}}function pr(e){if(typeof e.seq=="number"&&Number.isFinite(e.seq))return e.seq;const t=Date.parse(e.timestamp);return Number.isNaN(t)?0:t}function Wp(e,t){if(t.length===0)return e;const n=new Map;for(const s of e){const a=typeof s.seq=="number"?`seq:${s.seq}`:`ts:${s.timestamp}|from:${s.from}|content:${s.content}`;n.set(a,s)}for(const s of t){const a=typeof s.seq=="number"?`seq:${s.seq}`:`ts:${s.timestamp}|from:${s.from}|content:${s.content}`;n.set(a,s)}return[...n.values()].sort((s,a)=>pr(s)-pr(a)).slice(-500)}function Gp(e){return Array.isArray(e)?e.map(t=>{if(!m(t))return null;const n=d(t.ts_unix);if(n==null)return null;const s=m(t.handoff)?t.handoff:null;return{ts:n,context_ratio:d(t.context_ratio)??0,context_tokens:d(t.context_tokens)??0,context_max:d(t.context_max)??0,latency_ms:d(t.latency_ms)??0,generation:d(t.generation)??0,channel:typeof t.channel=="string"?t.channel:"turn",is_handoff:s!=null&&t.handoff_performed===!0,is_compaction:t.compacted===!0,compaction_saved_tokens:d(t.compaction_saved_tokens)??0,compaction_trigger:typeof t.compaction_trigger=="string"?t.compaction_trigger:null,model_used:typeof t.model_used=="string"?t.model_used:"",cost_usd:d(t.cost_usd)??0,handoff_to_model:s&&typeof s.to_model=="string"?s.to_model:null,handoff_new_generation:s?d(s.new_generation)??null:null}}).filter(t=>t!==null):[]}function mr(e){if(!m(e))return null;const t=r(e.health_state),n=r(e.next_action_path),s=r(e.last_reply_status);if(!t||!n||!s)return null;const a=r(e.quiet_reason)??null,i=r(e.summary)??(t==="offline"||t==="degraded"||t==="stale"?"Keeper is not in a healthy reply state. Probe or recover before relying on automation.":a==="quiet_hours"?"Lodge quiet hours are active. Direct messages still work, but scheduled social ticks may look asleep.":a==="min_gap"?"Keeper is inside its proactive cooldown window. Direct messages work now; autonomous check-ins will wait.":a==="never_started"?"Keeper metadata exists but no reply turn has been recorded yet.":"Keeper is reachable. Send a direct message for an immediate response.");return{health_state:t,quiet_reason:a,next_action_path:n,last_reply_status:s,last_reply_at:le(e.last_reply_at)??r(e.last_reply_at)??null,last_reply_preview:r(e.last_reply_preview)??null,last_error:r(e.last_error)??null,next_eligible_at_s:d(e.next_eligible_at_s)??null,recoverable:typeof e.recoverable=="boolean"?e.recoverable:n==="recover",summary:i,keepalive_running:typeof e.keepalive_running=="boolean"?e.keepalive_running:void 0}}function Jp(e,t){return(Array.isArray(e)?e:m(e)&&Array.isArray(e.keepers)?e.keepers:[]).map(s=>{if(!m(s))return null;const a=m(s.agent)?s.agent:null,i=m(s.context)?s.context:null,l=m(s.metrics_window)?s.metrics_window:void 0,c=r(s.name);if(!c)return null;const p=d(s.context_ratio)??d(i==null?void 0:i.context_ratio),_=r(s.status)??r(a==null?void 0:a.status)??"offline",u=ql(_),f=r(s.model)??r(s.active_model)??r(s.primary_model),v=F(s.skill_secondary),h=i?{source:r(i.source),context_ratio:d(i.context_ratio),context_tokens:d(i.context_tokens),context_max:d(i.context_max),message_count:d(i.message_count),has_checkpoint:typeof i.has_checkpoint=="boolean"?i.has_checkpoint:void 0}:void 0,b=a?{name:r(a.name),exists:typeof a.exists=="boolean"?a.exists:void 0,error:r(a.error),agent_type:r(a.agent_type),status:r(a.status),current_task:r(a.current_task)??null,joined_at:r(a.joined_at),last_seen:r(a.last_seen),last_seen_ago_s:d(a.last_seen_ago_s),capabilities:F(a.capabilities),is_zombie:typeof a.is_zombie=="boolean"?a.is_zombie:void 0}:void 0,C=Gp(s.metrics_series),x={name:c,runtime_class:s.runtime_class==="persistent_agent"?"persistent_agent":"resident_keeper",desired:typeof s.desired=="boolean"?s.desired:void 0,resident_registered:typeof s.resident_registered=="boolean"?s.resident_registered:void 0,reconcile_status:r(s.reconcile_status)??null,emoji:r(s.emoji),koreanName:r(s.koreanName)??r(s.korean_name),agent_name:r(s.agent_name),trace_id:r(s.trace_id),model:f,primary_model:r(s.primary_model),active_model:r(s.active_model),next_model_hint:r(s.next_model_hint)??null,status:u,presence_keepalive:typeof s.presence_keepalive=="boolean"?s.presence_keepalive:void 0,presence_keepalive_sec:d(s.presence_keepalive_sec),keepalive_running:typeof s.keepalive_running=="boolean"?s.keepalive_running:void 0,proactive_enabled:typeof s.proactive_enabled=="boolean"?s.proactive_enabled:void 0,proactive_idle_sec:d(s.proactive_idle_sec),proactive_cooldown_sec:d(s.proactive_cooldown_sec),last_heartbeat:r(s.last_heartbeat)??r(a==null?void 0:a.last_seen),generation:d(s.generation),turn_count:d(s.turn_count)??d(s.total_turns),keeper_age_s:d(s.keeper_age_s),last_turn_ago_s:d(s.last_turn_ago_s),last_handoff_ago_s:d(s.last_handoff_ago_s),last_compaction_ago_s:d(s.last_compaction_ago_s),last_proactive_ago_s:d(s.last_proactive_ago_s),last_proactive_preview:r(s.last_proactive_preview)??null,context_ratio:p,context_tokens:d(s.context_tokens)??d(i==null?void 0:i.context_tokens),context_max:d(s.context_max)??d(i==null?void 0:i.context_max),context_source:r(s.context_source)??r(i==null?void 0:i.source),context:h,traits:F(s.traits),interests:F(s.interests),primaryValue:r(s.primaryValue)??r(s.primary_value),activityLevel:d(s.activityLevel)??d(s.activity_level),memory_recent_note:r(s.memory_recent_note)??null,recent_input_preview:r(s.recent_input_preview)??null,recent_output_preview:r(s.recent_output_preview)??null,recent_tool_names:F(s.recent_tool_names)??[],allowed_tool_names:F(s.allowed_tool_names)??[],latest_tool_names:F(s.latest_tool_names)??[],latest_tool_call_count:d(s.latest_tool_call_count)??null,tool_audit_source:r(s.tool_audit_source)??null,tool_audit_at:le(s.tool_audit_at)??r(s.tool_audit_at)??null,conversation_tail_count:d(s.conversation_tail_count),k2k_count:d(s.k2k_count),handoff_count_total:d(s.handoff_count_total)??d(s.trace_history_count),compaction_count:d(s.compaction_count),last_compaction_saved_tokens:d(s.last_compaction_saved_tokens),diagnostic:mr(s.diagnostic),skill_primary:r(s.skill_primary)??null,skill_secondary:v,skill_reason:r(s.skill_reason)??null,metrics_series:C.length>0?C:void 0,metrics_window:l,agent:b};return x.diagnostic=mr(s.diagnostic)??vp(x,(t==null?void 0:t.lodge)??null),x}).filter(s=>s!==null)}function Vp(e){if(!m(e))return;const t=r(e.release_version),n=le(e.started_at),s=d(e.uptime_seconds);if(!(!t||!n||s==null))return{release_version:t,commit:r(e.commit)??null,started_at:n,uptime_seconds:s}}function Yp(e){if(m(e))return{enabled:e.enabled===!0,alive:e.alive===!0,status:r(e.status)??void 0,tick_in_progress:typeof e.tick_in_progress=="boolean"?e.tick_in_progress:void 0,tick_count:d(e.tick_count)??void 0,check_interval_sec:d(e.check_interval_sec)??void 0,last_tick_started_at:le(e.last_tick_started_at)??r(e.last_tick_started_at)??null,last_tick_completed_at:le(e.last_tick_completed_at)??r(e.last_tick_completed_at)??null,next_tick_due_at:le(e.next_tick_due_at)??r(e.next_tick_due_at)??null,last_health_check_at:le(e.last_health_check_at)??r(e.last_health_check_at)??null,last_intervention:r(e.last_intervention)??void 0,last_decision_source:r(e.last_decision_source)??void 0,last_action:r(e.last_action)??void 0,last_target:r(e.last_target)??null,last_reason:r(e.last_reason)??null,last_error:r(e.last_error)??null,circuit_open:typeof e.circuit_open=="boolean"?e.circuit_open:void 0,circuit_open_until:le(e.circuit_open_until)??r(e.circuit_open_until)??null,can_spawn:typeof e.can_spawn=="boolean"?e.can_spawn:void 0,can_retire:typeof e.can_retire=="boolean"?e.can_retire:void 0,last_spawn_attempt_at:le(e.last_spawn_attempt_at)??r(e.last_spawn_attempt_at)??null,last_retirement_attempt_at:le(e.last_retirement_attempt_at)??r(e.last_retirement_attempt_at)??null,spawns_today:d(e.spawns_today)??void 0,retirements_today:d(e.retirements_today)??void 0,health_summary:m(e.health_summary)?{total_agents:d(e.health_summary.total_agents)??void 0,active_agents:d(e.health_summary.active_agents)??void 0,idle_agents:d(e.health_summary.idle_agents)??void 0,todo_count:d(e.health_summary.todo_count)??void 0,high_priority_todo:d(e.health_summary.high_priority_todo)??void 0,orphan_count:d(e.health_summary.orphan_count)??void 0,homeostatic_score:d(e.health_summary.homeostatic_score)??void 0,needs_workers:typeof e.health_summary.needs_workers=="boolean"?e.health_summary.needs_workers:void 0}:void 0}}function Qp(e){if(m(e))return{enabled:e.enabled===!0,mode:r(e.mode)??void 0,masc_enabled:typeof e.masc_enabled=="boolean"?e.masc_enabled:void 0,masc_loops_running:typeof e.masc_loops_running=="boolean"?e.masc_loops_running:void 0,runtime_owner:r(e.runtime_owner)??null,zombie_loop_running:typeof e.zombie_loop_running=="boolean"?e.zombie_loop_running:void 0,gc_loop_running:typeof e.gc_loop_running=="boolean"?e.gc_loop_running:void 0,lodge_enabled:typeof e.lodge_enabled=="boolean"?e.lodge_enabled:void 0,lodge_loop_started:typeof e.lodge_loop_started=="boolean"?e.lodge_loop_started:void 0,lodge_running:typeof e.lodge_running=="boolean"?e.lodge_running:void 0,last_zombie_cleanup:le(e.last_zombie_cleanup)??r(e.last_zombie_cleanup)??null,last_gc:le(e.last_gc)??r(e.last_gc)??null,last_lodge:le(e.last_lodge)??r(e.last_lodge)??null,last_zombie_result:r(e.last_zombie_result)??null,last_gc_result:r(e.last_gc_result)??null,last_lodge_result:m(e.last_lodge_result)?{ok:typeof e.last_lodge_result.ok=="boolean"?e.last_lodge_result.ok:void 0,message:r(e.last_lodge_result.message)??void 0}:null}}function Xp(e){if(m(e))return{enabled:e.enabled===!0,started:e.started===!0,agent_name:r(e.agent_name)??null,llm_enabled:typeof e.llm_enabled=="boolean"?e.llm_enabled:void 0,uptime_s:d(e.uptime_s)??void 0,embedded_guardian_loops_running:typeof e.embedded_guardian_loops_running=="boolean"?e.embedded_guardian_loops_running:void 0,guardian_runtime_owner:r(e.guardian_runtime_owner)??null,consumers:F(e.consumers)}}function wl(e,t){return m(e)?{...e,generated_at:t??le(e.generated_at)??void 0,build:Vp(e.build),lodge:pp(e.lodge)??void 0,gardener:Yp(e.gardener)??void 0,guardian:Qp(e.guardian)??void 0,sentinel:Xp(e.sentinel)??void 0}:null}function Fl(e,t){return t?e?{...e,...t,build:t.build??e.build,generated_at:t.generated_at??e.generated_at}:t:e}function Zp(e){const t=typeof e=="string"?e.toLowerCase():"";return t==="running"||t==="interrupted"||t==="completed"||t==="stopped"||t==="error"?t:t.startsWith("error")?"error":"running"}function em(e){if(!m(e))return null;const t=d(e.iteration);if(t==null)return null;const n=d(e.metric_before)??0,s=d(e.metric_after)??n,a=m(e.evidence)?e.evidence:null;return{iteration:t,metric_before:n,metric_after:s,delta:d(e.delta)??s-n,changes:r(e.changes)??"",failed_attempts:r(e.failed_attempts)??"",next_suggestion:r(e.next_suggestion)??"",elapsed_ms:d(e.elapsed_ms)??0,cost_usd:d(e.cost_usd)??null,evidence:a?{worker_engine:(a.worker_engine==="api_tool_loop","api_tool_loop"),worker_model:r(a.worker_model)??"",tool_call_count:d(a.tool_call_count)??0,tool_names:F(a.tool_names)??[],session_id:r(a.session_id)??"",evidence_status:a.evidence_status==="legacy_unverified"?"legacy_unverified":"verified"}:null}}function tm(e){var i,l;if(!m(e))return null;const t=r(e.loop_id);if(!t)return null;const n=d(e.baseline_metric)??0,s=Array.isArray(e.history)?e.history.map(em).filter(c=>c!==null):[],a=d(e.current_metric)??((i=s[0])==null?void 0:i.metric_after)??n;return{loop_id:t,profile:r(e.profile)??"unknown",status:Zp(e.status),strict_mode:typeof e.strict_mode=="boolean"?e.strict_mode:void 0,error_message:r(e.error_message)??r(e.error_reason)??null,stop_reason:r(e.stop_reason)??r(e.reason)??null,current_iteration:d(e.current_iteration)??((l=s[0])==null?void 0:l.iteration)??0,max_iterations:d(e.max_iterations)??0,baseline_metric:n,current_metric:a,target:r(e.target)??"",stagnation_streak:d(e.stagnation_streak)??0,stagnation_limit:d(e.stagnation_limit)??0,elapsed_seconds:d(e.elapsed_seconds)??0,updated_at:le(e.updated_at)??null,stopped_at:le(e.stopped_at)??null,execution_mode:e.execution_mode==="worker_spawn"?"worker_spawn":void 0,worker_engine:e.worker_engine==="api_tool_loop"?"api_tool_loop":null,worker_model:r(e.worker_model)??null,evidence_policy:e.evidence_policy==="hard"||e.evidence_policy==="legacy"?e.evidence_policy:void 0,latest_tool_call_count:d(e.latest_tool_call_count)??0,latest_tool_names:F(e.latest_tool_names)??[],session_id:r(e.session_id)??null,evidence_status:e.evidence_status==="legacy_unverified"?"legacy_unverified":e.evidence_status==="verified"?"verified":null,durability:e.durability==="persistent_backend"||e.durability==="memory_only"?e.durability:void 0,persistence_backend:e.persistence_backend==="filesystem"||e.persistence_backend==="postgres"||e.persistence_backend==="memory"?e.persistence_backend:void 0,recoverable:typeof e.recoverable=="boolean"?e.recoverable:void 0,history:s}}async function rs(){Bo.value=!0;try{await Promise.all([Ul(),Tt()]),Nl.value=new Date().toISOString()}catch(e){console.error("Dashboard refresh error:",e)}finally{Bo.value=!1}}async function Kl(){sa.value=!0,aa.value=null;try{const e=await au();xi.value=e,Rp.value=new Date().toISOString()}catch(e){aa.value=e instanceof Error?e.message:"Failed to load dashboard semantics"}finally{sa.value=!1}}function nm(e){var t;return((t=xi.value)==null?void 0:t.surfaces.find(n=>n.id===e))??null}function sm(e){var n;const t=((n=xi.value)==null?void 0:n.surfaces)??[];for(const s of t){const a=s.panels.find(i=>i.id===e);if(a)return a}return null}function am(e){var s,a;Qt.value=(Array.isArray(e.goals)?e.goals:[]).map(i=>{if(!m(i))return null;const l=r(i.id),c=r(i.title),p=r(i.horizon),_=r(i.status),u=r(i.created_at),f=r(i.updated_at);return!l||!c||!p||!_||!u||!f?null:{id:l,horizon:p,title:c,metric:r(i.metric)??null,target_value:r(i.target_value)??null,due_date:r(i.due_date)??null,priority:d(i.priority)??3,status:_,parent_goal_id:r(i.parent_goal_id)??null,last_review_note:r(i.last_review_note)??null,last_review_at:r(i.last_review_at)??null,created_at:u,updated_at:f}}).filter(i=>i!==null);const t=new Map,n=Array.isArray((s=e.mdal)==null?void 0:s.loops)?e.mdal.loops:[];for(const i of n){const l=tm(i);l&&t.set(l.loop_id,l)}El.value=t,Xt.value=typeof((a=e.mdal)==null?void 0:a.error)=="string"?e.mdal.error:null,ki.value=Xt.value?"error":t.size===0?"idle":"ready"}async function Ul(){try{const e=await Zd(),t=wl(e.status,e.generated_at);t&&(re.value=Fl(re.value,t))}catch(e){console.error("Dashboard shell fetch error:",e)}}async function Tt(){var e;try{const t=await tu(),n=wl(t.status,t.generated_at),s=(e=re.value)==null?void 0:e.room;n&&(re.value=Fl(re.value,n));const a=s!=null&&(n==null?void 0:n.room)!=null&&s!==n.room;Qe.value=(Array.isArray(t.agents)?t.agents:[]).map(Np).filter(l=>l!==null),st.value=(Array.isArray(t.tasks)?t.tasks:[]).map(Dp).filter(l=>l!==null);const i=(Array.isArray(t.messages)?t.messages:[]).map(Op).filter(l=>l!==null);Ko.value=a?i:Wp(Ko.value,i),vt.value=Jp(t.keepers,n??re.value),Tl.value=qp(t.summary),Pl.value=Up(t.lodge_tick),yi.value=(Array.isArray(t.lodge_checkins)?t.lodge_checkins:[]).map(Bp).filter(l=>l!==null),Il.value=(Array.isArray(t.execution_queue)?t.execution_queue:Array.isArray(t.priority_queue)?t.priority_queue:[]).map(wp).filter(l=>l!==null),zl.value=(Array.isArray(t.session_briefs)?t.session_briefs:[]).map(Fp).filter(l=>l!==null),Rl.value=(Array.isArray(t.operation_briefs)?t.operation_briefs:[]).map(Kp).filter(l=>l!==null),Ll.value=(Array.isArray(t.worker_support_briefs)?t.worker_support_briefs:Array.isArray(t.worker_briefs)?t.worker_briefs:[]).map(ur).filter(l=>l!==null),bi.value=(Array.isArray(t.continuity_briefs)?t.continuity_briefs:[]).map(Hp).filter(l=>l!==null),Ml.value=(Array.isArray(t.offline_worker_briefs)?t.offline_worker_briefs:[]).map(ur).filter(l=>l!==null),Tp.value=null,Nl.value=new Date().toISOString()}catch(t){console.error("Dashboard execution fetch error:",t)}}async function ot(){Kn.value=!0;try{const e=await nu(Fn.value,{excludeSystem:At.value});Ha.value=e.posts??[],Wo.value=new Date().toISOString()}catch(e){console.error("Board fetch error:",e)}finally{Kn.value=!1}}async function it(){var e;Ho.value=!0;try{const t=Je.value||((e=re.value)==null?void 0:e.room)||"default";Je.value||(Je.value=t);const n=await Bu(t);jl.value=n}catch(t){console.error("TRPG fetch error:",t)}finally{Ho.value=!1}}async function Ci(){zn.value=!0,Rn.value=!0;try{const e=await cu();am(e),Ip.value=new Date().toISOString(),zp.value=new Date().toISOString()}catch(e){console.error("Planning fetch error:",e),ki.value="error",Xt.value=e instanceof Error?e.message:String(e)}finally{zn.value=!1,Rn.value=!1}}async function Bl(){return Ci()}const Ai=g(null),Go=g(!1),oa=g(null);function om(e){return m(e)?{room:r(e.room)??r(e.current_room),room_base_path:r(e.room_base_path),cluster:r(e.cluster),project:r(e.project),paused:M(e.paused),version:r(e.version),generated_at:r(e.generated_at),tempo_interval_s:d(e.tempo_interval_s)}:null}function im(e){return m(e)?{active_sessions:d(e.active_sessions),blocked_sessions:d(e.blocked_sessions),active_operations:d(e.active_operations),blocked_operations:d(e.blocked_operations),runtime_pressure:d(e.runtime_pressure),worker_alerts:d(e.worker_alerts),continuity_alerts:d(e.continuity_alerts),priority_items:d(e.priority_items),keepers:d(e.keepers)}:null}function rm(e){if(!m(e))return null;const t=r(e.id),n=r(e.kind),s=r(e.severity),a=r(e.summary),i=r(e.target_type),l=r(e.target_id);return!t||!n||!s||!a||!i||!l?null:{id:t,kind:n,severity:s,summary:a,target_type:i,target_id:l,status:r(e.status),linked_session_id:r(e.linked_session_id)??null,linked_operation_id:r(e.linked_operation_id)??null,last_seen_at:r(e.last_seen_at)??null,top_handoff:m(e.top_handoff)?e.top_handoff:null,intervene_handoff:m(e.intervene_handoff)?e.intervene_handoff:null,command_handoff:m(e.command_handoff)?e.command_handoff:null}}function lm(e){if(!m(e))return null;const t=r(e.kind),n=r(e.summary),s=r(e.target_type);return!t||!n||!s?null:{kind:t,severity:r(e.severity)??"warn",summary:n,target_type:s,target_id:r(e.target_id)??null,actor:r(e.actor)??null,evidence:e.evidence}}function cm(e){if(!m(e))return null;const t=r(e.action_type),n=r(e.target_type),s=r(e.reason);return!t||!n||!s?null:{action_type:t,target_type:n,target_id:r(e.target_id)??null,severity:r(e.severity)??"warn",reason:s,confirm_required:M(e.confirm_required),suggested_payload:m(e.suggested_payload)?e.suggested_payload:void 0,preview:e.preview}}function dm(e){return m(e)?{actor_filter:r(e.actor_filter)??null,filter_active:M(e.filter_active)??!1,visible_count:d(e.visible_count)??0,total_count:d(e.total_count)??0,hidden_count:d(e.hidden_count)??0,hidden_actors:F(e.hidden_actors),confirm_required_actions:me(e.confirm_required_actions).flatMap(t=>{if(!m(t))return[];const n=r(t.action_type),s=r(t.target_type);return!n||!s?[]:[{action_type:n,target_type:s,description:r(t.description),confirm_required:M(t.confirm_required)}]})}:null}function um(e){return m(e)?{count:d(e.count)??0,bad_count:d(e.bad_count)??0,warn_count:d(e.warn_count)??0,provenance:r(e.provenance)??null,top_item:lm(e.top_item)}:null}function pm(e){return m(e)?{count:d(e.count)??0,provenance:r(e.provenance)??null,top_action:cm(e.top_action)}:null}function mm(e){if(!m(e))return null;const t=r(e.label),n=r(e.reason),s=r(e.source),a=r(e.provenance);return!t||!n||!s||!a?null:{label:t,reason:n,source:s,provenance:a,target_kind:r(e.target_kind)??null,target_id:r(e.target_id)??null,suggested_tab:r(e.suggested_tab)??null,suggested_surface:r(e.suggested_surface)??null,suggested_params:m(e.suggested_params)?Object.fromEntries(Object.entries(e.suggested_params).map(([i,l])=>{const c=r(l);return c?[i,c]:null}).filter(i=>i!==null)):{}}}function _m(e){const t=m(e)?e:{},n=m(t.room)?t.room:{},s=m(t.execution)?t.execution:{},a=m(t.command)?t.command:{},i=m(t.operator)?t.operator:{};return{generated_at:r(t.generated_at),room:{status:om(n.status),counts:m(n.counts)?{agents:d(n.counts.agents),tasks:d(n.counts.tasks),keepers:d(n.counts.keepers)}:void 0,provenance:r(n.provenance)??null},execution:{summary:im(s.summary),top_queue:rm(s.top_queue),provenance:r(s.provenance)??null},command:{active_operations:d(a.active_operations),active_detachments:d(a.active_detachments),pending_approvals:d(a.pending_approvals),bad_alerts:d(a.bad_alerts),warn_alerts:d(a.warn_alerts),moving_lanes:d(a.moving_lanes),active_lanes:d(a.active_lanes),provenance:r(a.provenance)??null},operator:{health:r(i.health)??null,attention_summary:um(i.attention_summary),recommendation_summary:pm(i.recommendation_summary),pending_confirm_summary:dm(i.pending_confirm_summary),provenance:r(i.provenance)??null},focus:mm(t.focus)}}async function It(){Go.value=!0,oa.value=null;try{const e=await eu();Ai.value=_m(e)}catch(e){oa.value=e instanceof Error?e.message:"Failed to load room truth"}finally{Go.value=!1}}let Us=null;function vm(e){Us=e}let Bs=null;function fm(e){Bs=e}let Hs=null;function gm(e){Hs=e}const zt={};let eo=null;function bt(e,t,n=500){zt[e]&&clearTimeout(zt[e]),zt[e]=setTimeout(()=>{t(),delete zt[e]},n)}function $m(){const e=cl.subscribe(t=>{if(t){if(t.type==="keeper_heartbeat"&&t.name){const n=new Map(Uo.value);n.set(t.name,t.ts_unix?t.ts_unix*1e3:Date.now()),Uo.value=n;return}(t.type==="agent_joined"||t.type==="agent_left")&&bt("execution",Tt),jp(t.type)&&(eo||(eo=setTimeout(()=>{rs(),Bs==null||Bs(),Hs==null||Hs(),eo=null},500))),(t.type.startsWith("task_")||t.type.startsWith("masc/task_"))&&bt("execution",Tt),t.type==="broadcast"&&bt("execution",Tt),(t.type==="keeper_handoff"||t.type==="keeper_compaction"||t.type==="keeper_guardrail")&&bt("execution",Tt),(t.type==="board_post"||t.type==="masc/board_post"||t.type==="board_comment"||t.type==="masc/board_comment")&&bt("board",ot),t.type.startsWith("decision_")&&bt("council",()=>Us==null?void 0:Us()),(t.type==="mdal_started"||t.type==="mdal_iteration"||t.type==="mdal_completed"||t.type==="mdal_stopped")&&bt("mdal",Bl,350)}});return()=>{e();for(const t of Object.keys(zt))clearTimeout(zt[t]),delete zt[t]}}let Ln=null;function hm(){Ln||(Ln=setInterval(()=>{dt.value,rs()},1e4))}function ym(){Ln&&(clearInterval(Ln),Ln=null)}const $e=g(null),Ti=g(null),Fe=g(null),Un=g(!1),ut=g(null),Bn=g(!1),cn=g(null),V=g(!1),ia=g([]);let bm=1;function km(e){return m(e)?{id:r(e.id),seq:d(e.seq),from:r(e.from)??r(e.from_agent)??"system",content:r(e.content)??"",timestamp:r(e.timestamp)??new Date().toISOString(),type:r(e.type)}:null}function xm(e){return m(e)?{room_id:r(e.room_id),current_room:r(e.current_room)??r(e.room),project:r(e.project),cluster:r(e.cluster),paused:M(e.paused),pause_reason:r(e.pause_reason)??null,paused_by:r(e.paused_by)??null,paused_at:r(e.paused_at)??null}:{}}function _r(e){if(!m(e))return;const t=Object.entries(e).map(([n,s])=>{const a=r(s);return a?[n,a]:null}).filter(n=>n!==null);return t.length>0?Object.fromEntries(t):void 0}function Hl(e){if(!m(e))return null;const t=r(e.kind),n=r(e.summary),s=r(e.target_type);return!t||!n||!s?null:{kind:t,severity:r(e.severity)??"warn",summary:n,target_type:s,target_id:r(e.target_id)??null,actor:r(e.actor)??null,evidence:e.evidence}}function Pn(e){if(!m(e))return null;const t=r(e.action_type),n=r(e.target_type),s=r(e.reason);return!t||!n||!s?null:{action_type:t,target_type:n,target_id:r(e.target_id)??null,severity:r(e.severity)??"warn",reason:s,confirm_required:M(e.confirm_required),suggested_payload:e.suggested_payload,preview:e.preview}}function Wl(e){return m(e)?{enabled:M(e.enabled),judge_online:M(e.judge_online),refreshing:M(e.refreshing),generated_at:r(e.generated_at)??null,expires_at:r(e.expires_at)??null,model_used:r(e.model_used)??null,keeper_name:r(e.keeper_name)??null,last_error:r(e.last_error)??null}:null}function to(e){return m(e)?{summary:r(e.summary)??null,confidence:d(e.confidence)??null,provenance:r(e.provenance)??null,authoritative:M(e.authoritative),surface:r(e.surface)??null,fresh_until:r(e.fresh_until)??null,keeper_name:r(e.keeper_name)??null,fallback_used:M(e.fallback_used),disagreement_with_truth:M(e.disagreement_with_truth)}:null}function Sm(e){return m(e)?{judgment_id:r(e.judgment_id)??void 0,surface:r(e.surface)??null,target_type:r(e.target_type)??null,target_id:r(e.target_id)??null,status:r(e.status)??null,summary:r(e.summary)??null,confidence:d(e.confidence)??null,generated_at:r(e.generated_at)??null,fresh_until:r(e.fresh_until)??null,keeper_name:r(e.keeper_name)??null,model_name:r(e.model_name)??null,runtime_name:r(e.runtime_name)??null,evidence_refs:F(e.evidence_refs),recommended_action:Pn(e.recommended_action),supersedes:F(e.supersedes),fallback_used:M(e.fallback_used),disagreement_with_truth:M(e.disagreement_with_truth),provenance:r(e.provenance)??null}:null}function Cm(e){return m(e)?{actor:r(e.actor)??null,spawn_agent:r(e.spawn_agent)??null,spawn_role:r(e.spawn_role)??null,spawn_model:r(e.spawn_model)??null,worker_class:r(e.worker_class)??null,parent_actor:r(e.parent_actor)??null,capsule_mode:r(e.capsule_mode)??null,runtime_pool:r(e.runtime_pool)??null,lane_id:r(e.lane_id)??null,controller_level:r(e.controller_level)??null,control_domain:r(e.control_domain)??null,supervisor_actor:r(e.supervisor_actor)??null,model_tier:r(e.model_tier)??null,task_profile:r(e.task_profile)??null,risk_level:r(e.risk_level)??null,routing_confidence:d(e.routing_confidence)??null,routing_reason:r(e.routing_reason)??null,status:r(e.status)??"unknown",turn_count:d(e.turn_count)??0,empty_note_turn_count:d(e.empty_note_turn_count)??0,has_turn:M(e.has_turn)??!1,last_turn_ts_iso:r(e.last_turn_ts_iso)??null}:null}function Am(e){if(!m(e))return null;const t=r(e.session_id);return t?{session_id:t,goal:r(e.goal),status:r(e.status),health:r(e.health),scale_profile:r(e.scale_profile),control_profile:r(e.control_profile),planned_worker_count:d(e.planned_worker_count),active_agent_count:d(e.active_agent_count),last_turn_age_sec:d(e.last_turn_age_sec)??null,attention_count:d(e.attention_count),recommended_action_count:d(e.recommended_action_count),top_attention:Hl(e.top_attention),top_recommendation:Pn(e.top_recommendation)}:null}function Gl(e){const t=m(e)?e:{};return{trace_id:r(t.trace_id),target_type:r(t.target_type)??"room",target_id:r(t.target_id)??null,health:r(t.health),judgment_owner:r(t.judgment_owner)??null,authoritative_judgment_available:M(t.authoritative_judgment_available),resident_judge_runtime:Wl(t.resident_judge_runtime),judgment:Sm(t.judgment),active_guidance_layer:r(t.active_guidance_layer)??null,active_summary:to(t.active_summary),active_recommended_actions:me(t.active_recommended_actions).map(Pn).filter(n=>n!==null),active_recommendation_source:r(t.active_recommendation_source)??null,active_recommendation_summary:to(t.active_recommendation_summary),fallback_recommended_actions:me(t.fallback_recommended_actions).map(Pn).filter(n=>n!==null),recommendation_summary:to(t.recommendation_summary),swarm_status:m(t.swarm_status)?t.swarm_status:void 0,attention_items:me(t.attention_items).map(Hl).filter(n=>n!==null),recommended_actions:me(t.recommended_actions).map(Pn).filter(n=>n!==null),session_cards:me(t.session_cards).map(Am).filter(n=>n!==null),worker_cards:me(t.worker_cards).map(Cm).filter(n=>n!==null)}}function Tm(e){if(!m(e))return null;const t=m(e.status)?e.status:void 0,n=m(e.summary)?e.summary:m(t==null?void 0:t.summary)?t.summary:void 0,s=m(e.session)?e.session:m(t==null?void 0:t.session)?t.session:void 0,a=r(e.session_id)??r(n==null?void 0:n.session_id)??r(s==null?void 0:s.session_id);if(!a)return null;const i=_r(e.report_paths)??_r(t==null?void 0:t.report_paths),l=me(e.recent_events,["events"]).filter(m);return{session_id:a,status:r(e.status)??r(n==null?void 0:n.status)??r(s==null?void 0:s.status),progress_pct:d(e.progress_pct)??d(n==null?void 0:n.progress_pct),elapsed_sec:d(e.elapsed_sec)??d(n==null?void 0:n.elapsed_sec),remaining_sec:d(e.remaining_sec)??d(n==null?void 0:n.remaining_sec),done_delta_total:d(e.done_delta_total)??d(n==null?void 0:n.done_delta_total),summary:n,team_health:m(e.team_health)?e.team_health:m(t==null?void 0:t.team_health)?t.team_health:void 0,communication_metrics:m(e.communication_metrics)?e.communication_metrics:m(t==null?void 0:t.communication_metrics)?t.communication_metrics:void 0,orchestration_state:m(e.orchestration_state)?e.orchestration_state:m(t==null?void 0:t.orchestration_state)?t.orchestration_state:void 0,cascade_metrics:m(e.cascade_metrics)?e.cascade_metrics:m(t==null?void 0:t.cascade_metrics)?t.cascade_metrics:void 0,report_paths:i,linked_autoresearch:m(e.linked_autoresearch)?e.linked_autoresearch:m(t==null?void 0:t.linked_autoresearch)?t.linked_autoresearch:void 0,session:s,recent_events:l}}function vr(e){if(!m(e))return null;const t=r(e.name);if(!t)return null;const n=m(e.context)?e.context:void 0;return{name:t,runtime_class:e.runtime_class==="persistent_agent"?"persistent_agent":"resident_keeper",desired:M(e.desired),resident_registered:M(e.resident_registered),agent_name:r(e.agent_name),status:r(e.status),autonomy_level:r(e.autonomy_level),context_ratio:d(e.context_ratio)??d(n==null?void 0:n.context_ratio),generation:d(e.generation),active_goal_ids:F(e.active_goal_ids),last_autonomous_action_at:r(e.last_autonomous_action_at)??null,last_turn_ago_s:d(e.last_turn_ago_s),model:r(e.model)??r(e.active_model)??r(e.primary_model)}}function Im(e){if(!m(e))return null;const t=r(e.confirm_token)??r(e.token);return t?{confirm_token:t,actor:r(e.actor),action_type:r(e.action_type),target_type:r(e.target_type),target_id:r(e.target_id)??null,delegated_tool:r(e.delegated_tool),created_at:r(e.created_at),preview:e.preview}:null}function Jl(e){if(!m(e))return null;const t=r(e.action_type),n=r(e.target_type);return!t||!n?null:{action_type:t,target_type:n,description:r(e.description),confirm_required:M(e.confirm_required)}}function zm(e){return m(e)?{actor_filter:r(e.actor_filter)??null,filter_active:M(e.filter_active)??!1,visible_count:d(e.visible_count)??0,total_count:d(e.total_count)??0,hidden_count:d(e.hidden_count)??0,hidden_actors:F(e.hidden_actors),confirm_required_actions:me(e.confirm_required_actions).map(Jl).filter(t=>t!==null)}:null}function Rm(e){const t=m(e)?e:{};return{room:xm(t.room),sessions:me(t.sessions,["items","sessions"]).map(Tm).filter(n=>n!==null),keepers:me(t.keepers,["items","keepers"]).map(vr).filter(n=>n!==null),resident_judge_runtime:Wl(t.resident_judge_runtime),persistent_agents:me(t.persistent_agents,["items","persistent_agents"]).map(vr).filter(n=>n!==null),recent_messages:me(t.recent_messages,["messages"]).map(km).filter(n=>n!==null),pending_confirms:me(t.pending_confirms,["items","confirms"]).map(Im).filter(n=>n!==null),pending_confirm_summary:zm(t.pending_confirm_summary)??void 0,available_actions:me(t.available_actions,["actions"]).map(Jl).filter(n=>n!==null)}}function As(e){if(typeof e=="string")return e;if(e==null)return"";try{return JSON.stringify(e)}catch{return String(e)}}function fr(e){return e.target_id?`${e.target_type}:${e.target_id}`:e.target_type}function ra(e){ia.value=[{...e,id:bm++,at:new Date().toISOString()},...ia.value].slice(0,20)}function Vl(e){return e.confirm_required?As(e.preview)||"Confirmation required":As(e.result)||As(e.executed_action)||As(e.delegated_tool_result)||e.status}async function xe(){Un.value=!0,ut.value=null;try{const e=await pu();$e.value=Rm(e)}catch(e){ut.value=e instanceof Error?e.message:"Failed to load operator snapshot"}finally{Un.value=!1}}async function jt(){Bn.value=!0,cn.value=null;try{const e=await vl({targetType:"room"});Ti.value=Gl(e)}catch(e){cn.value=e instanceof Error?e.message:"Failed to load operator digest"}finally{Bn.value=!1}}async function dn(e){if(!e){Fe.value=null;return}Bn.value=!0,cn.value=null;try{const t=await vl({targetType:"team_session",targetId:e,includeWorkers:!0});Fe.value=Gl(t)}catch(t){cn.value=t instanceof Error?t.message:"Failed to load session digest"}finally{Bn.value=!1}}async function Yl(e){var t;V.value=!0,ut.value=null;try{const n=await Ua(e);return ra({actor:e.actor,action_type:e.action_type,target_label:fr(e),outcome:n.confirm_required?"preview":"executed",message:Vl(n),delegated_tool:n.delegated_tool}),await xe(),await jt(),(t=Fe.value)!=null&&t.target_id&&await dn(Fe.value.target_id),n}catch(n){const s=n instanceof Error?n.message:"Operator action failed";throw ut.value=s,ra({actor:e.actor,action_type:e.action_type,target_label:fr(e),outcome:"error",message:s}),n}finally{V.value=!1}}async function Ql(e,t,n="confirm"){var s;V.value=!0,ut.value=null;try{const a=await fl(e,t,n);return ra({actor:e,action_type:n,target_label:t,outcome:"confirmed",message:Vl(a),delegated_tool:a.delegated_tool}),await xe(),await jt(),(s=Fe.value)!=null&&s.target_id&&await dn(Fe.value.target_id),a}catch(a){const i=a instanceof Error?a.message:"Operator confirmation failed";throw ut.value=i,ra({actor:e,action_type:"confirm",target_label:t,outcome:"error",message:i}),a}finally{V.value=!1}}gm(()=>{var e;xe(),jt(),(e=Fe.value)!=null&&e.target_id&&dn(Fe.value.target_id)});const ls=g(null),Jo=g(!1),la=g(null),Xl=g(null),Kt=g(!1),Ct=g(null),Vo=g(null),Ws=g(!1),Gs=g(null);let Zt=null;function gr(){Zt!==null&&(window.clearTimeout(Zt),Zt=null)}function Lm(e=1500){Zt===null&&(Zt=window.setTimeout(()=>{Zt=null,ca(!1)},e))}function D(e){return typeof e=="object"&&e!==null&&!Array.isArray(e)}function y(e){return typeof e=="string"&&e.trim()!==""?e:void 0}function O(e){return typeof e=="number"&&Number.isFinite(e)?e:void 0}function en(e){return typeof e=="boolean"?e:void 0}function W(e,t=[]){if(Array.isArray(e))return e;if(!D(e))return[];for(const n of t){const s=e[n];if(Array.isArray(s))return s}return[]}function fn(e){if(!D(e))return null;const t=y(e.kind),n=y(e.summary),s=y(e.target_type);return!t||!n||!s?null:{kind:t,severity:y(e.severity)??"warn",summary:n,target_type:s,target_id:y(e.target_id)??null,actor:y(e.actor)??null,evidence:e.evidence}}function Et(e){if(!D(e))return null;const t=y(e.action_type),n=y(e.target_type),s=y(e.reason);return!t||!n||!s?null:{action_type:t,target_type:n,target_id:y(e.target_id)??null,severity:y(e.severity)??"warn",reason:s,confirm_required:en(e.confirm_required),suggested_payload:e.suggested_payload,preview:e.preview}}function Pm(e){if(!D(e))return null;const t=y(e.session_id);return t?{session_id:t,goal:y(e.goal),status:y(e.status),health:y(e.health),scale_profile:y(e.scale_profile),control_profile:y(e.control_profile),planned_worker_count:O(e.planned_worker_count),active_agent_count:O(e.active_agent_count),last_turn_age_sec:O(e.last_turn_age_sec)??null,attention_count:O(e.attention_count),recommended_action_count:O(e.recommended_action_count),top_attention:fn(e.top_attention),top_recommendation:Et(e.top_recommendation)}:null}function Mm(e){if(!D(e))return null;const t=y(e.session_id);if(!t)return null;const n=D(e.status)?e.status:e,s=D(n.summary)?n.summary:void 0;return{session_id:t,status:y(e.status)??y(s==null?void 0:s.status)??(D(n.session)?y(n.session.status):void 0),progress_pct:O(e.progress_pct)??O(s==null?void 0:s.progress_pct),elapsed_sec:O(e.elapsed_sec)??O(s==null?void 0:s.elapsed_sec),remaining_sec:O(e.remaining_sec)??O(s==null?void 0:s.remaining_sec),done_delta_total:O(e.done_delta_total)??O(s==null?void 0:s.done_delta_total),summary:D(e.summary)?e.summary:s,team_health:D(e.team_health)?e.team_health:D(n.team_health)?n.team_health:void 0,communication_metrics:D(e.communication_metrics)?e.communication_metrics:D(n.communication_metrics)?n.communication_metrics:void 0,orchestration_state:D(e.orchestration_state)?e.orchestration_state:D(n.orchestration_state)?n.orchestration_state:void 0,cascade_metrics:D(e.cascade_metrics)?e.cascade_metrics:D(n.cascade_metrics)?n.cascade_metrics:void 0,report_paths:D(e.report_paths)?Object.fromEntries(Object.entries(e.report_paths).map(([a,i])=>{const l=y(i);return l?[a,l]:null}).filter(a=>a!==null)):D(n.report_paths)?Object.fromEntries(Object.entries(n.report_paths).map(([a,i])=>{const l=y(i);return l?[a,l]:null}).filter(a=>a!==null)):void 0,session:D(e.session)?e.session:D(n.session)?n.session:void 0,recent_events:W(e.recent_events,["events"]).filter(D)}}function jm(e){if(!D(e))return null;const t=y(e.name);return t?{name:t,agent_name:y(e.agent_name),status:y(e.status),autonomy_level:y(e.autonomy_level),context_ratio:O(e.context_ratio),generation:O(e.generation),active_goal_ids:W(e.active_goal_ids).map(n=>typeof n=="string"?n.trim():"").filter(Boolean),last_autonomous_action_at:y(e.last_autonomous_action_at)??null,last_turn_ago_s:O(e.last_turn_ago_s),model:y(e.model)}:null}function Em(e){if(!D(e))return null;const t=y(e.confirm_token)??y(e.token);return t?{confirm_token:t,actor:y(e.actor),action_type:y(e.action_type),target_type:y(e.target_type),target_id:y(e.target_id)??null,delegated_tool:y(e.delegated_tool),created_at:y(e.created_at),preview:e.preview}:null}function Nm(e){if(!D(e))return null;const t=y(e.action_type),n=y(e.target_type);return!t||!n?null:{action_type:t,target_type:n,description:y(e.description),confirm_required:en(e.confirm_required)}}function Dm(e){const t=D(e)?e:{};return{room_health:y(t.room_health),cluster:y(t.cluster),project:y(t.project),current_room:y(t.current_room)??null,paused:en(t.paused),tempo_interval_s:O(t.tempo_interval_s),active_agents:O(t.active_agents),keeper_pressure:O(t.keeper_pressure),active_operations:O(t.active_operations),pending_approvals:O(t.pending_approvals),incident_count:O(t.incident_count),recommended_action_count:O(t.recommended_action_count),top_attention:fn(t.top_attention),top_action:Et(t.top_action)}}function Om(e){const t=D(e)?e:{},n=D(t.swarm_overview)?t.swarm_overview:{};return{health:y(t.health),active_operations:O(t.active_operations),pending_approvals:O(t.pending_approvals),swarm_overview:{active_lanes:O(n.active_lanes),moving_lanes:O(n.moving_lanes),stalled_lanes:O(n.stalled_lanes),projected_lanes:O(n.projected_lanes),last_movement_at:y(n.last_movement_at)??null},top_attention:fn(t.top_attention),top_action:Et(t.top_action),session_cards:W(t.session_cards).map(Pm).filter(s=>s!==null)}}function qm(e){const t=D(e)?e:{};return{sessions:W(t.sessions,["items"]).map(Mm).filter(n=>n!==null),keepers:W(t.keepers,["items"]).map(jm).filter(n=>n!==null),pending_confirms:W(t.pending_confirms).map(Em).filter(n=>n!==null),available_actions:W(t.available_actions).map(Nm).filter(n=>n!==null)}}function wm(e){if(!D(e))return null;const t=y(e.id),n=y(e.kind),s=y(e.summary),a=y(e.target_type);return!t||!n||!s||!a?null:{id:t,kind:n,severity:y(e.severity)??"warn",summary:s,target_type:a,target_id:y(e.target_id)??null,top_action:Et(e.top_action),related_session_ids:W(e.related_session_ids).map(i=>typeof i=="string"?i.trim():"").filter(Boolean),related_agent_names:W(e.related_agent_names).map(i=>typeof i=="string"?i.trim():"").filter(Boolean),evidence_preview:W(e.evidence_preview).map(i=>typeof i=="string"?i.trim():"").filter(Boolean),last_seen_at:y(e.last_seen_at)??null}}function Zl(e){if(!D(e))return null;const t=y(e.session_id),n=y(e.goal);return!t||!n?null:{session_id:t,goal:n,room:y(e.room)??null,status:y(e.status),health:y(e.health),member_names:W(e.member_names).map(s=>typeof s=="string"?s.trim():"").filter(Boolean),started_at:y(e.started_at)??null,elapsed_sec:O(e.elapsed_sec)??null,operation_id:y(e.operation_id)??null,blocker_summary:y(e.blocker_summary)??null,last_event_at:y(e.last_event_at)??null,last_event_summary:y(e.last_event_summary)??null,communication_summary:y(e.communication_summary)??null,active_count:O(e.active_count),required_count:O(e.required_count),related_attention_count:O(e.related_attention_count)??0,top_attention:fn(e.top_attention),top_recommendation:Et(e.top_recommendation)}}function ec(e){if(!D(e))return null;const t=y(e.agent_name);return t?{agent_name:t,status:y(e.status),current_work:y(e.current_work)??null,recent_input_preview:y(e.recent_input_preview)??null,recent_output_preview:y(e.recent_output_preview)??null,recent_tool_names:W(e.recent_tool_names).map(n=>typeof n=="string"?n.trim():"").filter(Boolean),last_activity_at:y(e.last_activity_at)??null}:null}function tc(e){if(!D(e))return null;const t=y(e.operation_id);return t?{operation_id:t,status:y(e.status),stage:y(e.stage)??null,detachment_status:y(e.detachment_status)??null,objective:y(e.objective)??null,updated_at:y(e.updated_at)??null}:null}function nc(e){if(!D(e))return null;const t=y(e.name);return t?{name:t,agent_name:y(e.agent_name)??null,status:y(e.status),generation:O(e.generation),context_ratio:O(e.context_ratio)??null,last_turn_ago_s:O(e.last_turn_ago_s)??null,current_work:y(e.current_work)??null}:null}function sc(e){const t=Zl(e);return t?{...t,member_previews:W(D(e)?e.member_previews:void 0).map(ec).filter(n=>n!==null),operation_badges:W(D(e)?e.operation_badges:void 0).map(tc).filter(n=>n!==null),keeper_refs:W(D(e)?e.keeper_refs:void 0).map(nc).filter(n=>n!==null)}:null}function Fm(e){if(!D(e))return null;const t=y(e.agent_name);return t?{agent_name:t,status:y(e.status),where:y(e.where)??null,with_whom:W(e.with_whom).map(n=>typeof n=="string"?n.trim():"").filter(Boolean),current_work:y(e.current_work)??null,related_session_id:y(e.related_session_id)??null,related_attention_count:O(e.related_attention_count)??0,last_activity_at:y(e.last_activity_at)??null,recent_output_preview:y(e.recent_output_preview)??null,recent_input_preview:y(e.recent_input_preview)??null,recent_event:y(e.recent_event)??null,recent_tool_names:W(e.recent_tool_names).map(n=>typeof n=="string"?n.trim():"").filter(Boolean),allowed_tool_names:W(e.allowed_tool_names).map(n=>typeof n=="string"?n.trim():"").filter(Boolean),latest_tool_names:W(e.latest_tool_names).map(n=>typeof n=="string"?n.trim():"").filter(Boolean),latest_tool_call_count:O(e.latest_tool_call_count)??null,tool_audit_source:y(e.tool_audit_source)??null,tool_audit_at:y(e.tool_audit_at)??null}:null}function Km(e){if(!D(e))return null;const t=y(e.name);return t?{name:t,agent_name:y(e.agent_name)??null,status:y(e.status),generation:O(e.generation),context_ratio:O(e.context_ratio)??null,last_turn_ago_s:O(e.last_turn_ago_s)??null,current_work:y(e.current_work)??null,last_autonomous_action_at:y(e.last_autonomous_action_at)??null,allowed_tool_names:W(e.allowed_tool_names).map(n=>typeof n=="string"?n.trim():"").filter(Boolean),latest_tool_names:W(e.latest_tool_names).map(n=>typeof n=="string"?n.trim():"").filter(Boolean),latest_tool_call_count:O(e.latest_tool_call_count)??null,tool_audit_source:y(e.tool_audit_source)??null,tool_audit_at:y(e.tool_audit_at)??null}:null}function Um(e){if(!D(e))return null;const t=y(e.id),n=y(e.signal_type),s=y(e.summary),a=y(e.target_type);return!t||!n||!s||!a?null:{id:t,signal_type:n==="action"?"action":"attention",severity:y(e.severity)??"warn",summary:s,target_type:a,target_id:y(e.target_id)??null,attention:fn(e.attention),action:Et(e.action)}}function Bm(e){const t=D(e)?e:{},n=W(t.session_briefs).map(Zl).filter(a=>a!==null),s=W(t.sessions).map(sc).filter(a=>a!==null);return{generated_at:y(t.generated_at),summary:Dm(t.summary),incidents:W(t.incidents).map(fn).filter(a=>a!==null),recommended_actions:W(t.recommended_actions).map(Et).filter(a=>a!==null),command_focus:Om(t.command_focus),operator_targets:qm(t.operator_targets),attention_queue:W(t.attention_queue).map(wm).filter(a=>a!==null),sessions:s.length>0?s:n.map(a=>({...a,member_previews:[],operation_badges:[],keeper_refs:[]})),session_briefs:n,agent_briefs:W(t.agent_briefs).map(Fm).filter(a=>a!==null),keeper_briefs:W(t.keeper_briefs).map(Km).filter(a=>a!==null),internal_signals:W(t.internal_signals).map(Um).filter(a=>a!==null)}}function Hm(e){if(!D(e))return null;const t=y(e.id),n=y(e.summary);return!t||!n?null:{id:t,timestamp:y(e.timestamp)??null,event_type:y(e.event_type),actor:y(e.actor)??null,summary:n}}function Wm(e){const t=D(e)?e:{};return{generated_at:y(t.generated_at),session_id:y(t.session_id)??"",session:sc(t.session),timeline:W(t.timeline).map(Hm).filter(n=>n!==null),participants:W(t.participants).map(ec).filter(n=>n!==null),operations:W(t.operations).map(tc).filter(n=>n!==null),keepers:W(t.keepers).map(nc).filter(n=>n!==null),error:y(t.error)??null}}function Gm(e){if(!D(e))return null;const t=y(e.id),n=y(e.label),s=y(e.summary);if(!t||!n||!s)return null;const a=y(e.status)??"unclear";return{id:t,label:n,status:a==="ok"||a==="healthy"||a==="aligned"||a==="watch"||a==="risk"||a==="unclear"?a:"unclear",summary:s,signal_class:y(e.signal_class)==="metadata_gap"||y(e.signal_class)==="mixed"||y(e.signal_class)==="operational_risk"?y(e.signal_class):void 0,evidence_quality:y(e.evidence_quality)==="strong"||y(e.evidence_quality)==="partial"||y(e.evidence_quality)==="missing"?y(e.evidence_quality):void 0,evidence:W(e.evidence).map(l=>typeof l=="string"?l.trim():"").filter(Boolean)}}function Jm(e){if(!D(e))return null;const t=y(e.kind),n=y(e.summary),s=y(e.scope_type),a=y(e.severity);return!t||!n||!s||!a||s!=="session"&&s!=="keeper"&&s!=="agent"||a!=="info"&&a!=="watch"?null:{kind:t,summary:n,scope_type:s,scope_id:y(e.scope_id)??null,severity:a}}function Vm(e){const t=D(e)?e:{},n=D(t.basis)?t.basis:{},s=y(t.status)??"error",a=s==="ok"||s==="pending"||s==="unavailable"||s==="error"?s:"error";return{generated_at:y(t.generated_at),cached:en(t.cached),stale:en(t.stale),refreshing:en(t.refreshing),status:a,summary:y(t.summary)??null,model:y(t.model)??null,ttl_sec:O(t.ttl_sec),criteria:W(t.criteria).map(i=>typeof i=="string"?i.trim():"").filter(Boolean),basis:{current_room:y(n.current_room)??null,crew_count:O(n.crew_count),agent_count:O(n.agent_count),keeper_count:O(n.keeper_count)},metadata_gap_count:O(t.metadata_gap_count),metadata_gaps:W(t.metadata_gaps).map(Jm).filter(i=>i!==null),sections:W(t.sections).map(Gm).filter(i=>i!==null),error:y(t.error)??null,last_error:y(t.last_error)??null}}async function ac(){Jo.value=!0,la.value=null;try{const e=await ou();ls.value=Bm(e)}catch(e){la.value=e instanceof Error?e.message:"Failed to load mission snapshot"}finally{Jo.value=!1}}async function Ym(e){if(!e){Vo.value=null,Gs.value=null,Ws.value=!1;return}Ws.value=!0,Gs.value=null;try{const t=await iu(e);Vo.value=Wm(t)}catch(t){Gs.value=t instanceof Error?t.message:"Failed to load session detail"}finally{Ws.value=!1}}async function ca(e=!1){Kt.value=!0,Ct.value=null;try{const t=await ru(e),n=Vm(t);Xl.value=n,n.refreshing||n.status==="pending"?Lm():gr()}catch(t){Ct.value=t instanceof Error?t.message:"Failed to load mission briefing",gr()}finally{Kt.value=!1}}const oc=g(null),Yo=g(!1),Ut=g(null);async function ic(e,t){Yo.value=!0,Ut.value=null;try{oc.value=await lu(e,t)}catch(n){Ut.value=n instanceof Error?n.message:String(n)}finally{Yo.value=!1}}const Ii=g(null),Ue=g(null),da=g(!1),ua=g(!1),pa=g(null),ma=g(null),Qo=g(null),_a=g(null),Q=g("warroom"),cs=g(null),Xo=g(!1),va=g(null),Nt=g(null),fa=g(!1),ga=g(null),zi=g(null),Zo=g(!1),$a=g(null),ds=g(null),ei=g(!1),ha=g(null),Hn=g(null),ya=g(!1),Wn=g(null),tn=g(null);let Tn=null;function Ri(e){return e!=="summary"&&e!=="swarm"&&e!=="warroom"&&e!=="orchestra"}function rc(){if(typeof window>"u")return new URLSearchParams;const e=new URLSearchParams(window.location.search),t=window.location.hash.replace(/^#/,""),n=t.indexOf("?");return n>=0&&new URLSearchParams(t.slice(n+1)).forEach((a,i)=>{e.has(i)||e.set(i,a)}),e}function lc(){const t=rc().get("run_id")??void 0;return t&&t.trim()!==""?t.trim():void 0}function cc(){const t=rc().get("operation_id")??void 0;return t&&t.trim()!==""?t.trim():void 0}function Qm(e){if(m(e))return{policy_class:r(e.policy_class),approval_class:r(e.approval_class),tool_allowlist:F(e.tool_allowlist),model_allowlist:F(e.model_allowlist),requires_human_for:F(e.requires_human_for),autonomy_level:r(e.autonomy_level),escalation_timeout_sec:d(e.escalation_timeout_sec),kill_switch:M(e.kill_switch),frozen:M(e.frozen)}}function Xm(e){if(m(e))return{headcount_cap:d(e.headcount_cap),active_operation_cap:d(e.active_operation_cap),max_cost_usd:d(e.max_cost_usd),max_tokens:d(e.max_tokens)}}function Li(e){if(!m(e))return null;const t=r(e.unit_id),n=r(e.label),s=r(e.kind);return!t||!n||!s?null:{unit_id:t,label:n,kind:s,parent_unit_id:r(e.parent_unit_id)??null,leader_id:r(e.leader_id)??null,roster:F(e.roster),capability_profile:F(e.capability_profile),source:r(e.source),created_at:r(e.created_at),updated_at:r(e.updated_at),policy:Qm(e.policy),budget:Xm(e.budget)}}function dc(e){if(!m(e))return null;const t=Li(e.unit);return t?{unit:t,leader_status:r(e.leader_status),roster_total:d(e.roster_total),roster_live:d(e.roster_live),active_operation_count:d(e.active_operation_count),health:r(e.health),reasons:F(e.reasons),children:Array.isArray(e.children)?e.children.map(dc).filter(n=>n!==null):[]}:null}function Zm(e){if(m(e))return{total_units:d(e.total_units),company_count:d(e.company_count),platoon_count:d(e.platoon_count),squad_count:d(e.squad_count),leaf_agent_unit_count:d(e.leaf_agent_unit_count),live_agent_count:d(e.live_agent_count),managed_unit_count:d(e.managed_unit_count),active_operation_count:d(e.active_operation_count)}}function uc(e){const t=m(e)?e:{};return{version:r(t.version),generated_at:r(t.generated_at),source:r(t.source),summary:Zm(t.summary),units:Array.isArray(t.units)?t.units.map(dc).filter(n=>n!==null):[]}}function e_(e){if(!m(e))return null;const t=r(e.kind),n=r(e.status);return!t||!n?null:{kind:t,chain_id:r(e.chain_id)??null,goal:r(e.goal)??null,run_id:r(e.run_id)??null,status:n,viewer_path:r(e.viewer_path)??null,last_sync_at:r(e.last_sync_at)??null}}function Wa(e){if(!m(e))return null;const t=r(e.operation_id),n=r(e.objective),s=r(e.assigned_unit_id),a=r(e.trace_id),i=r(e.status);return!t||!n||!s||!a||!i?null:{operation_id:t,objective:n,assigned_unit_id:s,autonomy_level:r(e.autonomy_level),policy_class:r(e.policy_class),budget_class:r(e.budget_class),detachment_session_id:r(e.detachment_session_id)??null,trace_id:a,checkpoint_ref:r(e.checkpoint_ref)??null,active_goal_ids:F(e.active_goal_ids),note:r(e.note)??null,created_by:r(e.created_by),source:r(e.source),status:i,chain:e_(e.chain),created_at:r(e.created_at),updated_at:r(e.updated_at)}}function t_(e){if(!m(e))return null;const t=Wa(e.operation);return t?{operation:t,assigned_unit_label:r(e.assigned_unit_label)}:null}function kn(e){if(m(e))return{tone:r(e.tone),pending_ops:d(e.pending_ops),blocked_ops:d(e.blocked_ops),in_flight_ops:d(e.in_flight_ops),pipeline_stalls:d(e.pipeline_stalls),bus_traffic:d(e.bus_traffic),l1_hit_rate:d(e.l1_hit_rate),invalidation_count:d(e.invalidation_count),current_pending:d(e.current_pending),current_in_flight:d(e.current_in_flight),cdb_wakeups:d(e.cdb_wakeups),total_stolen:d(e.total_stolen),avg_best_score:d(e.avg_best_score),avg_candidate_count:d(e.avg_candidate_count),best_first_operations:d(e.best_first_operations),active_sessions:d(e.active_sessions),commit_rate:d(e.commit_rate),total_speculations:d(e.total_speculations)}}function n_(e){if(!m(e))return;const t=m(e.pipeline)?e.pipeline:void 0,n=m(e.cache)?e.cache:void 0,s=m(e.ooo)?e.ooo:void 0,a=m(e.speculative)?e.speculative:void 0,i=m(e.search_fabric)?e.search_fabric:void 0,l=m(e.signals)?e.signals:void 0;return{pipeline:t?{total_ops:d(t.total_ops),completed_ops:d(t.completed_ops),stalled_cycles:d(t.stalled_cycles),hazards_detected:d(t.hazards_detected),forwarding_used:d(t.forwarding_used),pipeline_flushes:d(t.pipeline_flushes),ipc:d(t.ipc)}:void 0,cache:n?{total_reads:d(n.total_reads),total_writes:d(n.total_writes),l1_hit_rate:d(n.l1_hit_rate),invalidation_count:d(n.invalidation_count),writeback_count:d(n.writeback_count),bus_traffic:d(n.bus_traffic)}:void 0,ooo:s?{agent_count:d(s.agent_count),total_added:d(s.total_added),total_issued:d(s.total_issued),total_completed:d(s.total_completed),total_stolen:d(s.total_stolen),cdb_wakeups:d(s.cdb_wakeups),stall_cycles:d(s.stall_cycles),global_cdb_events:d(s.global_cdb_events),current_pending:d(s.current_pending),current_in_flight:d(s.current_in_flight)}:void 0,speculative:a?{total_speculations:d(a.total_speculations),total_commits:d(a.total_commits),total_aborts:d(a.total_aborts),commit_rate:d(a.commit_rate),total_fast_calls:d(a.total_fast_calls),total_cost_usd:d(a.total_cost_usd),active_sessions:d(a.active_sessions)}:void 0,search_fabric:i?{total_operations:d(i.total_operations),best_first_operations:d(i.best_first_operations),legacy_operations:d(i.legacy_operations),blocked_operations:d(i.blocked_operations),ready_operations:d(i.ready_operations),research_pipeline_operations:d(i.research_pipeline_operations),avg_candidate_count:d(i.avg_candidate_count),avg_best_score:d(i.avg_best_score),top_stage:r(i.top_stage)??null}:void 0,signals:l?{issue_pressure:kn(l.issue_pressure),cache_contention:kn(l.cache_contention),scheduler_efficiency:kn(l.scheduler_efficiency),routing_confidence:kn(l.routing_confidence),speculative_posture:kn(l.speculative_posture)}:void 0}}function pc(e){const t=m(e)?e:{},n=m(t.summary)?t.summary:void 0;return{version:r(t.version),generated_at:r(t.generated_at),summary:n?{total:d(n.total),active:d(n.active),paused:d(n.paused),managed:d(n.managed),projected:d(n.projected)}:void 0,microarch:n_(t.microarch),operations:Array.isArray(t.operations)?t.operations.map(t_).filter(s=>s!==null):[]}}function mc(e){if(!m(e))return null;const t=r(e.detachment_id),n=r(e.operation_id),s=r(e.assigned_unit_id);return!t||!n||!s?null:{detachment_id:t,operation_id:n,assigned_unit_id:s,leader_id:r(e.leader_id)??null,roster:F(e.roster),session_id:r(e.session_id)??null,checkpoint_ref:r(e.checkpoint_ref)??null,runtime_kind:r(e.runtime_kind)??null,runtime_ref:r(e.runtime_ref)??null,source:r(e.source),status:r(e.status),last_event_at:r(e.last_event_at)??null,last_progress_at:r(e.last_progress_at)??null,heartbeat_deadline:r(e.heartbeat_deadline)??null,created_at:r(e.created_at),updated_at:r(e.updated_at)}}function s_(e){if(!m(e))return null;const t=mc(e.detachment);return t?{detachment:t,assigned_unit_label:r(e.assigned_unit_label),operation:Wa(e.operation)}:null}function _c(e){const t=m(e)?e:{},n=m(t.summary)?t.summary:void 0;return{version:r(t.version),generated_at:r(t.generated_at),summary:n?{total:d(n.total),active:d(n.active),projected:d(n.projected)}:void 0,detachments:Array.isArray(t.detachments)?t.detachments.map(s_).filter(s=>s!==null):[]}}function a_(e){if(!m(e))return null;const t=r(e.decision_id),n=r(e.trace_id),s=r(e.requested_action),a=r(e.scope_type),i=r(e.scope_id);return!t||!n||!s||!a||!i?null:{decision_id:t,trace_id:n,requested_action:s,scope_type:a,scope_id:i,operation_id:r(e.operation_id)??null,target_unit_id:r(e.target_unit_id)??null,requested_by:r(e.requested_by),status:r(e.status),reason:r(e.reason)??null,source:r(e.source),detail:e.detail,created_at:r(e.created_at),decided_at:r(e.decided_at)??null,expires_at:r(e.expires_at)??null}}function vc(e){const t=m(e)?e:{},n=m(t.summary)?t.summary:void 0;return{version:r(t.version),generated_at:r(t.generated_at),summary:n?{total:d(n.total),pending:d(n.pending),approved:d(n.approved),denied:d(n.denied)}:void 0,decisions:Array.isArray(t.decisions)?t.decisions.map(a_).filter(s=>s!==null):[]}}function o_(e){if(!m(e))return null;const t=Li(e.unit);return t?{unit:t,roster_total:d(e.roster_total),roster_live:d(e.roster_live),headcount_cap:d(e.headcount_cap),active_operations:d(e.active_operations),active_operation_cap:d(e.active_operation_cap),utilization:d(e.utilization)}:null}function i_(e){const t=m(e)?e:{};return{version:r(t.version),generated_at:r(t.generated_at),capacity:Array.isArray(t.capacity)?t.capacity.map(o_).filter(n=>n!==null):[]}}function r_(e){if(!m(e))return null;const t=r(e.alert_id);return t?{alert_id:t,severity:r(e.severity),kind:r(e.kind),scope_type:r(e.scope_type),scope_id:r(e.scope_id),title:r(e.title),detail:r(e.detail),timestamp:r(e.timestamp)}:null}function fc(e){const t=m(e)?e:{},n=m(t.summary)?t.summary:void 0;return{version:r(t.version),generated_at:r(t.generated_at),summary:n?{total:d(n.total),bad:d(n.bad),warn:d(n.warn)}:void 0,alerts:Array.isArray(t.alerts)?t.alerts.map(r_).filter(s=>s!==null):[]}}function gc(e){if(!m(e))return null;const t=r(e.event_id),n=r(e.trace_id),s=r(e.event_type);return!t||!n||!s?null:{event_id:t,trace_id:n,event_type:s,operation_id:r(e.operation_id)??null,unit_id:r(e.unit_id)??null,actor:r(e.actor)??null,source:r(e.source),timestamp:r(e.timestamp),detail:e.detail}}function l_(e){const t=m(e)?e:{};return{version:r(t.version),generated_at:r(t.generated_at),events:Array.isArray(t.events)?t.events.map(gc).filter(n=>n!==null):[]}}function c_(e){if(!m(e))return null;const t=r(e.code),n=r(e.severity),s=r(e.summary);return!t||!n||!s?null:{code:t,severity:n,summary:s}}function d_(e){if(!m(e))return null;const t=r(e.lane_id),n=r(e.label),s=r(e.kind),a=r(e.phase),i=r(e.motion_state),l=r(e.source_of_truth),c=r(e.movement_reason),p=r(e.current_step);if(!t||!n||!s||!a||!i||!l||!c||!p)return null;const _=m(e.counts)?e.counts:{};return{lane_id:t,label:n,kind:s,present:M(e.present)??!1,phase:a,motion_state:i,source_of_truth:l,last_movement_at:r(e.last_movement_at)??null,movement_reason:c,current_step:p,blockers:F(e.blockers),counts:{operations:d(_.operations),detachments:d(_.detachments),workers:d(_.workers),approvals:d(_.approvals),alerts:d(_.alerts)},hard_flags:Array.isArray(e.hard_flags)?e.hard_flags.map(c_).filter(u=>u!==null):[]}}function u_(e){if(!m(e))return null;const t=r(e.event_id),n=r(e.lane_id),s=r(e.kind),a=r(e.timestamp),i=r(e.title),l=r(e.detail),c=r(e.tone),p=r(e.source);return!t||!n||!s||!a||!i||!l||!c||!p?null:{event_id:t,lane_id:n,kind:s,timestamp:a,title:i,detail:l,tone:c,source:p}}function p_(e){if(!m(e))return null;const t=r(e.code),n=r(e.severity),s=r(e.summary);return!t||!n||!s?null:{code:t,severity:n,summary:s,why_it_matters:r(e.why_it_matters)??void 0,next_tool:r(e.next_tool)??void 0,next_step:r(e.next_step)??void 0,lane_ids:F(e.lane_ids),count:d(e.count)??0}}function Pi(e){if(!m(e))return;const t=m(e.overview)?e.overview:{},n=m(e.gaps)?e.gaps:{},s=m(e.narrative)?e.narrative:{},a=m(e.recommended_next_action)?e.recommended_next_action:void 0;return{generated_at:r(e.generated_at),narrative:{state:r(s.state)??void 0,started:r(s.started)??void 0,active_work:r(s.active_work)??void 0,completion:r(s.completion)??void 0,lane_id:r(s.lane_id)??null},overview:{active_lanes:d(t.active_lanes),moving_lanes:d(t.moving_lanes),stalled_lanes:d(t.stalled_lanes),projected_lanes:d(t.projected_lanes),last_movement_at:r(t.last_movement_at)??null},lanes:Array.isArray(e.lanes)?e.lanes.map(d_).filter(i=>i!==null):[],timeline:Array.isArray(e.timeline)?e.timeline.map(u_).filter(i=>i!==null):[],gaps:{count:d(n.count),items:Array.isArray(n.items)?n.items.map(p_).filter(i=>i!==null):[]},recommended_next_action:a?{tool:r(a.tool)??"masc_operator_snapshot",label:r(a.label)??"Observe operator state",reason:r(a.reason)??"",lane_id:r(a.lane_id)??null}:void 0}}function $c(e){if(!m(e))return;const t=m(e.workers)?e.workers:{},n=M(e.pass);return{status:r(e.status)??"missing",source:r(e.source)??"none",reason_code:r(e.reason_code)??null,status_summary:r(e.status_summary)??null,run_id:r(e.run_id)??null,captured_at:r(e.captured_at)??null,...n!==void 0?{pass:n}:{},...d(e.peak_hot_slots)!=null?{peak_hot_slots:d(e.peak_hot_slots)}:{},...d(e.ctx_per_slot)!=null?{ctx_per_slot:d(e.ctx_per_slot)}:{},workers:{expected:d(t.expected),joined:d(t.joined),current_task_bound:d(t.current_task_bound),fresh_heartbeats:d(t.fresh_heartbeats),done:d(t.done),final:d(t.final)},expected_artifact_dir:r(e.expected_artifact_dir)??null,artifact_ref:r(e.artifact_ref)??null,missing_reason:r(e.missing_reason)??null}}function m_(e){const t=m(e)?e:{};return{version:r(t.version),generated_at:r(t.generated_at),topology:uc(t.topology),operations:pc(t.operations),detachments:_c(t.detachments),alerts:fc(t.alerts),decisions:vc(t.decisions),capacity:i_(t.capacity),traces:l_(t.traces),swarm_status:Pi(t.swarm_status)}}function __(e){const t=m(e)?e:{},n=uc(t.topology),s=pc(t.operations),a=_c(t.detachments),i=fc(t.alerts),l=vc(t.decisions);return{version:r(t.version),generated_at:r(t.generated_at),topology:{version:n.version,generated_at:n.generated_at,source:n.source,summary:n.summary},operations:{version:s.version,generated_at:s.generated_at,summary:s.summary,microarch:s.microarch},detachments:{version:a.version,generated_at:a.generated_at,summary:a.summary},alerts:{version:i.version,generated_at:i.generated_at,summary:i.summary},decisions:{version:l.version,generated_at:l.generated_at,summary:l.summary},swarm_status:Pi(t.swarm_status),swarm_proof:$c(t.swarm_proof)}}function v_(e){return m(e)?{chain_id:r(e.chain_id)??null,started_at:d(e.started_at)??null,progress:d(e.progress)??null,elapsed_sec:d(e.elapsed_sec)??null}:null}function hc(e){if(!m(e))return null;const t=r(e.event);return t?{event:t,chain_id:r(e.chain_id)??null,timestamp:r(e.timestamp)??null,duration_ms:d(e.duration_ms)??null,message:r(e.message)??null,tokens:d(e.tokens)??null}:null}function f_(e){if(!m(e))return null;const t=Wa(e.operation);return t?{operation:t,runtime:v_(e.runtime),history:hc(e.history),mermaid:r(e.mermaid)??null,preview_run:yc(e.preview_run)}:null}function g_(e){const t=m(e)?e:{};return{status:r(t.status)??"disconnected",base_url:r(t.base_url)??null,message:r(t.message)??null}}function $_(e){const t=m(e)?e:{},n=m(t.summary)?t.summary:void 0;return{version:r(t.version),generated_at:r(t.generated_at),connection:g_(t.connection),summary:n?{linked_operations:d(n.linked_operations),active_chains:d(n.active_chains),running_operations:d(n.running_operations),recent_failures:d(n.recent_failures),last_history_event_at:r(n.last_history_event_at)??null}:void 0,operations:Array.isArray(t.operations)?t.operations.map(f_).filter(s=>s!==null):[],recent_history:Array.isArray(t.recent_history)?t.recent_history.map(hc).filter(s=>s!==null):[]}}function h_(e){if(!m(e))return null;const t=r(e.id);return t?{id:t,type:r(e.type),status:r(e.status),duration_ms:d(e.duration_ms)??null,error:r(e.error)??null}:null}function yc(e){if(!m(e))return null;const t=r(e.run_id),n=r(e.chain_id);return n?{run_id:t??null,chain_id:n,duration_ms:d(e.duration_ms),success:M(e.success),mermaid:r(e.mermaid),nodes:Array.isArray(e.nodes)?e.nodes.map(h_).filter(s=>s!==null):[]}:null}function y_(e){const t=m(e)?e:{};return{run:yc(t.run)}}function b_(e){if(!m(e))return null;const t=r(e.title),n=r(e.path);return!t||!n?null:{title:t,path:n}}function k_(e){if(!m(e))return null;const t=r(e.id),n=r(e.title),s=r(e.summary);return!t||!n||!s?null:{id:t,title:n,summary:s}}function x_(e){if(!m(e))return null;const t=r(e.id),n=r(e.title),s=r(e.tool),a=r(e.summary);return!t||!n||!s||!a?null:{id:t,title:n,tool:s,summary:a,success_signals:F(e.success_signals),pitfalls:F(e.pitfalls)}}function S_(e){if(!m(e))return null;const t=r(e.id),n=r(e.title),s=r(e.summary),a=r(e.when_to_use);return!t||!n||!s||!a?null:{id:t,title:n,summary:s,when_to_use:a,steps:Array.isArray(e.steps)?e.steps.map(x_).filter(i=>i!==null):[]}}function C_(e){if(!m(e))return null;const t=r(e.id),n=r(e.title),s=r(e.description);return!t||!n||!s?null:{id:t,title:n,description:s,tools:F(e.tools)}}function A_(e){if(!m(e))return null;const t=r(e.id),n=r(e.title),s=r(e.symptom),a=r(e.why),i=r(e.fix_tool),l=r(e.fix_summary);return!t||!n||!s||!a||!i||!l?null:{id:t,title:n,symptom:s,why:a,fix_tool:i,fix_summary:l}}function T_(e){if(!m(e))return null;const t=r(e.id),n=r(e.title),s=r(e.path_id),a=r(e.transport);return!t||!n||!s||!a?null:{id:t,title:n,path_id:s,transport:a,request:e.request,response:e.response,notes:F(e.notes)}}function I_(e){const t=m(e)?e:{};return{version:r(t.version),generated_at:r(t.generated_at),docs:Array.isArray(t.docs)?t.docs.map(b_).filter(n=>n!==null):[],concepts:Array.isArray(t.concepts)?t.concepts.map(k_).filter(n=>n!==null):[],golden_paths:Array.isArray(t.golden_paths)?t.golden_paths.map(S_).filter(n=>n!==null):[],tool_groups:Array.isArray(t.tool_groups)?t.tool_groups.map(C_).filter(n=>n!==null):[],pitfalls:Array.isArray(t.pitfalls)?t.pitfalls.map(A_).filter(n=>n!==null):[],examples:Array.isArray(t.examples)?t.examples.map(T_).filter(n=>n!==null):[]}}function z_(e){if(!m(e))return null;const t=r(e.id),n=r(e.title),s=r(e.status),a=r(e.detail),i=r(e.next_tool);return!t||!n||!s||!a||!i?null:{id:t,title:n,status:s,detail:a,next_tool:i}}function R_(e){if(!m(e))return null;const t=r(e.code),n=r(e.severity),s=r(e.title),a=r(e.detail),i=r(e.next_tool);return!t||!n||!s||!a||!i?null:{code:t,severity:n,title:s,detail:a,next_tool:i}}function L_(e){if(!m(e))return null;const t=r(e.from),n=r(e.content),s=r(e.timestamp),a=d(e.seq);return!t||!n||!s||a==null?null:{seq:a,from:t,content:n,timestamp:s}}function P_(e){if(!m(e))return null;const t=r(e.name),n=r(e.role),s=r(e.lane),a=r(e.status),i=r(e.claim_marker),l=r(e.done_marker),c=r(e.final_marker);if(!t||!n||!s||!a||!i||!l||!c)return null;const p=(()=>{if(!m(e.last_message))return null;const _=d(e.last_message.seq),u=r(e.last_message.content),f=r(e.last_message.timestamp);return _==null||!u||!f?null:{seq:_,content:u,timestamp:f}})();return{name:t,role:n,lane:s,joined:M(e.joined)??!1,live_presence:M(e.live_presence)??!1,completed:M(e.completed)??!1,status:a,current_task:r(e.current_task)??null,bound_task_id:r(e.bound_task_id)??null,bound_task_title:r(e.bound_task_title)??null,bound_task_status:r(e.bound_task_status)??null,current_task_matches_run:M(e.current_task_matches_run)??!1,squad_member:M(e.squad_member)??!1,detachment_member:M(e.detachment_member)??!1,last_seen:r(e.last_seen)??null,heartbeat_age_sec:d(e.heartbeat_age_sec)??null,heartbeat_fresh:M(e.heartbeat_fresh)??!1,claim_marker_seen:M(e.claim_marker_seen)??!1,done_marker_seen:M(e.done_marker_seen)??!1,final_marker_seen:M(e.final_marker_seen)??!1,claim_marker:i,done_marker:l,final_marker:c,last_message:p}}function M_(e){if(!m(e))return;const t=Array.isArray(e.timeline)?e.timeline.map(n=>{if(!m(n))return null;const s=r(n.timestamp),a=d(n.active_slots);if(!s||a==null)return null;const i=Array.isArray(n.active_slot_ids)?n.active_slot_ids.map(l=>typeof l=="number"&&Number.isFinite(l)?l:null).filter(l=>l!=null):[];return{timestamp:s,active_slots:a,active_slot_ids:i}}).filter(n=>n!==null):[];return{slot_url:r(e.slot_url)??null,provider_base_url:r(e.provider_base_url)??null,provider_reachable:M(e.provider_reachable)??null,provider_status_code:d(e.provider_status_code)??null,provider_model_id:r(e.provider_model_id)??null,actual_model_id:r(e.actual_model_id)??null,expected_slots:d(e.expected_slots),actual_slots:d(e.actual_slots),expected_ctx:d(e.expected_ctx),actual_ctx:d(e.actual_ctx),configured_capacity:d(e.configured_capacity),slot_reachable:M(e.slot_reachable)??null,slot_status_code:d(e.slot_status_code)??null,runtime_blocker:r(e.runtime_blocker)??null,detail:r(e.detail)??null,checked_at:r(e.checked_at)??null,total_slots:d(e.total_slots),ctx_per_slot:d(e.ctx_per_slot),active_slots_now:d(e.active_slots_now),peak_active_slots:d(e.peak_active_slots),sample_count:d(e.sample_count),last_sample_at:r(e.last_sample_at)??null,timeline:t}}function j_(e){if(!m(e))return null;const t=r(e.run_id),n=r(e.status),s=r(e.decided_by),a=r(e.decided_at),i=r(e.reason);if(!t||!n||!s||!a||!i)return null;const l=[];return Array.isArray(e.history)&&e.history.forEach(c=>{if(!m(c))return;const p=r(c.status),_=r(c.decided_by),u=r(c.decided_at),f=r(c.reason);!p||!_||!u||!f||l.push({status:p,decided_by:_,decided_at:u,reason:f,operation_id:r(c.operation_id)??null,detachment_id:r(c.detachment_id)??null,note:r(c.note)??null})}),{run_id:t,status:n,decided_by:s,decided_at:a,reason:i,operation_id:r(e.operation_id)??null,detachment_id:r(e.detachment_id)??null,note:r(e.note)??null,history:l}}function E_(e){if(!m(e))return null;const t=r(e.run_id),n=r(e.recommended_kind),s=r(e.reason);return!t||!n||!s?null:{run_id:t,recommended_kind:n,continue_available:M(e.continue_available)??!1,rerun_available:M(e.rerun_available)??!1,abandon_available:M(e.abandon_available)??!1,reason:s,evidence:m(e.evidence)?{operation_id:r(e.evidence.operation_id)??null,detachment_id:r(e.evidence.detachment_id)??null,joined_workers:d(e.evidence.joined_workers),current_task_bound:d(e.evidence.current_task_bound),fresh_heartbeats:d(e.evidence.fresh_heartbeats),trace_events:d(e.evidence.trace_events),message_events:d(e.evidence.message_events),runtime_blocker:r(e.evidence.runtime_blocker)??null}:void 0,provenance:r(e.provenance),decision_engine:r(e.decision_engine),authoritative:M(e.authoritative)}}function N_(e){const t=m(e)?e:{},n=m(t.summary)?t.summary:void 0;return{version:r(t.version),generated_at:r(t.generated_at),run_id:r(t.run_id),room_id:r(t.room_id),operation_id:r(t.operation_id)??null,run_resolution:j_(t.run_resolution),resolution_recommendation:E_(t.resolution_recommendation),recommended_next_tool:r(t.recommended_next_tool),summary:n?{expected_workers:d(n.expected_workers),joined_workers:d(n.joined_workers),live_workers:d(n.live_workers),squad_roster_size:d(n.squad_roster_size),detachment_roster_size:d(n.detachment_roster_size),current_task_bound:d(n.current_task_bound),fresh_heartbeats:d(n.fresh_heartbeats),claim_markers_seen:d(n.claim_markers_seen),done_markers_seen:d(n.done_markers_seen),final_markers_seen:d(n.final_markers_seen),completed_workers:d(n.completed_workers),peak_hot_slots:d(n.peak_hot_slots),hot_window_ok:M(n.hot_window_ok),pass_hot_concurrency:M(n.pass_hot_concurrency),pass_end_to_end:M(n.pass_end_to_end),pending_decisions:d(n.pending_decisions),pass:M(n.pass)}:void 0,provider:M_(t.provider),operation:Wa(t.operation),squad:Li(t.squad),detachment:mc(t.detachment),workers:Array.isArray(t.workers)?t.workers.map(P_).filter(s=>s!==null):[],checklist:Array.isArray(t.checklist)?t.checklist.map(z_).filter(s=>s!==null):[],blockers:Array.isArray(t.blockers)?t.blockers.map(R_).filter(s=>s!==null):[],recent_messages:Array.isArray(t.recent_messages)?t.recent_messages.map(L_).filter(s=>s!==null):[],recent_trace_events:Array.isArray(t.recent_trace_events)?t.recent_trace_events.map(gc).filter(s=>s!==null):[],truth_notes:F(t.truth_notes)}}function D_(e){if(!m(e))return null;const t=r(e.label),n=r(e.value);return!t||!n?null:{label:t,value:n}}function O_(e){if(!m(e))return null;const t=r(e.id),n=r(e.kind),s=r(e.label),a=r(e.tone),i=r(e.provenance);return!t||!n||!s||!a||!i?null:{id:t,kind:n,label:s,subtitle:r(e.subtitle)??null,status:r(e.status)??null,tone:a,pulse:r(e.pulse)??null,provenance:i,visual_class:r(e.visual_class)??void 0,glyph:r(e.glyph)??void 0,parent_id:r(e.parent_id)??null,lane_id:r(e.lane_id)??null,link_tab:r(e.link_tab)??null,link_surface:r(e.link_surface)??null,link_params:m(e.link_params)?Object.fromEntries(Object.entries(e.link_params).map(([l,c])=>{const p=r(c);return p?[l,p]:null}).filter(l=>l!==null)):{},facts:Array.isArray(e.facts)?e.facts.map(D_).filter(l=>l!==null):[]}}function q_(e){if(!m(e))return null;const t=r(e.id),n=r(e.source),s=r(e.target),a=r(e.kind),i=r(e.tone),l=r(e.provenance);return!t||!n||!s||!a||!i||!l?null:{id:t,source:n,target:s,kind:a,label:r(e.label)??null,tone:i,provenance:l,animated:M(e.animated)}}function w_(e){if(!m(e))return null;const t=r(e.id),n=r(e.kind),s=r(e.label),a=r(e.tone),i=r(e.provenance);return!t||!n||!s||!a||!i?null:{id:t,kind:n,label:s,detail:r(e.detail)??null,tone:a,provenance:i,source_id:r(e.source_id)??null,target_id:r(e.target_id)??null,suggested_surface:r(e.suggested_surface)??null,suggested_params:m(e.suggested_params)?Object.fromEntries(Object.entries(e.suggested_params).map(([l,c])=>{const p=r(c);return p?[l,p]:null}).filter(l=>l!==null)):{}}}function F_(e){if(!m(e))return null;const t=r(e.target_kind),n=r(e.target_id),s=r(e.label),a=r(e.reason);return!t||!n||!s||!a?null:{target_kind:t,target_id:n,label:s,reason:a,suggested_surface:r(e.suggested_surface)??null,suggested_params:m(e.suggested_params)?Object.fromEntries(Object.entries(e.suggested_params).map(([i,l])=>{const c=r(l);return c?[i,c]:null}).filter(i=>i!==null)):{}}}function K_(e){const t=m(e)?e:{},n=m(t.room)?t.room:{},s=m(t.summary)?t.summary:void 0;return{version:r(t.version),generated_at:r(t.generated_at),room:{room_id:r(n.room_id),project:r(n.project),cluster:r(n.cluster),paused:M(n.paused),pause_reason:r(n.pause_reason)??null,agent_count:d(n.agent_count),task_count:d(n.task_count),message_count:d(n.message_count)},summary:s?{session_count:d(s.session_count),operation_count:d(s.operation_count),detachment_count:d(s.detachment_count),lane_count:d(s.lane_count),worker_count:d(s.worker_count),keeper_count:d(s.keeper_count),signal_count:d(s.signal_count),alert_count:d(s.alert_count)}:void 0,nodes:Array.isArray(t.nodes)?t.nodes.map(O_).filter(a=>a!==null):[],edges:Array.isArray(t.edges)?t.edges.map(q_).filter(a=>a!==null):[],signals:Array.isArray(t.signals)?t.signals.map(w_).filter(a=>a!==null):[],focus:F_(t.focus),swarm_status:Pi(t.swarm_status),swarm_proof:$c(t.swarm_proof),truth_notes:F(t.truth_notes)}}function rt(e){Q.value=e,Ri(e)&&U_()}async function bc(){da.value=!0,pa.value=null;try{const e=await _u();Ii.value=__(e)}catch(e){pa.value=e instanceof Error?e.message:"Failed to load command-plane summary"}finally{da.value=!1}}function Mi(e){tn.value=e}async function ji(){ua.value=!0,ma.value=null;try{const e=await mu();Ue.value=m_(e)}catch(e){ma.value=e instanceof Error?e.message:"Failed to load command-plane snapshot"}finally{ua.value=!1}}async function U_(){Ue.value||ua.value||await ji()}async function Bt(){await bc(),Ri(Q.value)&&await ji()}async function nn(){var e;ei.value=!0,ha.value=null;try{const t=await vu(),n=$_(t);ds.value=n;const s=tn.value;n.operations.length===0?tn.value=null:(!s||!n.operations.some(a=>a.operation.operation_id===s))&&(tn.value=((e=n.operations[0])==null?void 0:e.operation.operation_id)??null)}catch(t){ha.value=t instanceof Error?t.message:"Failed to load chain summary"}finally{ei.value=!1}}function B_(){Tn=null,Hn.value=null,ya.value=!1,Wn.value=null}async function H_(e){Tn=e,ya.value=!0,Wn.value=null;try{const t=await fu(e);if(Tn!==e)return;Hn.value=y_(t)}catch(t){if(Tn!==e)return;Hn.value=null,Wn.value=t instanceof Error?t.message:"Failed to load chain run"}finally{Tn===e&&(ya.value=!1)}}async function W_(){Xo.value=!0,va.value=null;try{const e=await gu();cs.value=I_(e)}catch(e){va.value=e instanceof Error?e.message:"Failed to load command-plane help"}finally{Xo.value=!1}}async function tt(e=lc(),t=cc()){fa.value=!0,ga.value=null;try{const n=await $u(e,t);Nt.value=N_(n)}catch(n){ga.value=n instanceof Error?n.message:"Failed to load command-plane swarm view"}finally{fa.value=!1}}async function Rt(e=lc(),t=cc()){Zo.value=!0,$a.value=null;try{const n=await hu(e,t);zi.value=K_(n)}catch(n){$a.value=n instanceof Error?n.message:"Failed to load orchestra map"}finally{Zo.value=!1}}async function ft(e,t,n){Qo.value=e,_a.value=null;try{await yu(t,n),await bc(),(Ue.value||Ri(Q.value))&&await ji(),await tt(),await Rt(),await nn()}catch(s){throw _a.value=s instanceof Error?s.message:"Failed to execute command-plane action",s}finally{Qo.value=null}}function G_(e){return ft(`pause:${e}`,"/api/v1/command-plane/operations/pause",{operation_id:e})}function J_(e){return ft(`resume:${e}`,"/api/v1/command-plane/operations/resume",{operation_id:e})}function V_(e){return ft(`recall:${e}`,"/api/v1/command-plane/dispatch/recall",{operation_id:e})}function Y_(e={}){return ft("dispatch:tick","/api/v1/command-plane/dispatch/tick",{...e.operationId?{operation_id:e.operationId}:{},...e.detachmentId?{detachment_id:e.detachmentId}:{}})}function Q_(e){return ft(`approve:${e}`,"/api/v1/command-plane/policy/approve",{decision_id:e})}function X_(e){return ft(`deny:${e}`,"/api/v1/command-plane/policy/deny",{decision_id:e})}function Z_(e,t){return ft(`freeze:${e}`,"/api/v1/command-plane/policy/freeze",{unit_id:e,enabled:t})}function ev(e,t){return ft(`kill:${e}`,"/api/v1/command-plane/policy/kill-switch",{unit_id:e,enabled:t})}fm(()=>{Bt(),nn(),(Q.value==="swarm"||Q.value==="warroom"||Q.value==="orchestra"||Nt.value!==null)&&tt(),(Q.value==="orchestra"||zi.value!==null)&&Rt(),Q.value==="warroom"&&xe()});function ti(e){e==="command"&&(It(),Bt(),nn(),(Q.value==="swarm"||Q.value==="warroom"||Q.value==="orchestra")&&tt(),Q.value==="orchestra"&&Rt(),Q.value==="warroom"&&xe()),e==="mission"&&(It(),ac(),ca()),e==="proof"&&ic(q.value.params.session_id,q.value.params.operation_id),e==="execution"&&(It(),Tt()),e==="intervene"&&(It(),xe(),jt()),e==="memory"&&ot(),e==="planning"&&Ci(),e==="lab"&&it()}function tv({metric:e}){return o`
  ...
  `}function w({panelId:e,compact:t=!1,label:n="왜 필요한가"}){const s=sm(e);return s?o`
  ...
  `}function Nc(e){const t=Date.now(),n=typeof e=="number"?e<1e12?e*1e3:e:new Date(e).getTime(),s=Math.floor((t-n)/1e3);if(s<60)return`${s}초 전`;const a=Math.floor(s/60);if(a<60)return`${a}분 전`;const i=Math.floor(a/60);return i<24?`${i}시간 전`:`${Math.floor(i/24)}일 전`}function G({timestamp:e}){const t=Nc(e),n=typeof e=="string"?e:new Date(e<1e12?e*1e3:e).toISOString();return o`<span class="time-ago" title=${n}>${t}</span>`}let Sv=0;const Lt=g([]);function E(e,t="success",n=4e3){const s=++Sv;Lt.value=[...Lt.value,{id:s,message:e,type:t}],setTimeout(()=>{Lt.value=Lt.value.filter(a=>a.id!==s)},n)}function Cv(e){Lt.value=Lt.value.filter(t=>t.id!==e)}function Av(){const e=Lt.value;return e.length===0?null:o`
  ...
  `}function Nv(){var J,Y,ae,U,Z,A,j;const e=$n.value;if(!e)return null;const t=Iv(),n=Oc(e),s=Pv(e),a=Mv(e),i=zv(e),l=Dc(e),c=Sa.value,p=Lv(e),_=Rv(n),u=yr(s==null?void 0:s.allowed_tool_names,i==null?void 0:i.allowed_tool_names,a==null?void 0:a.allowed_tool_names,n==null?void 0:n.allowed_tool_names),f=yr(s==null?void 0:s.latest_tool_names,i==null?void 0:i.latest_tool_names,a==null?void 0:a.used_tool_names,n==null?void 0:n.latest_tool_names),v=(s==null?void 0:s.latest_tool_call_count)??(i==null?void 0:i.latest_tool_call_count)??(a==null?void 0:a.used_tool_call_count)??(n==null?void 0:n.latest_tool_call_count),h=(s==null?void 0:s.tool_audit_source)??(i==null?void 0:i.tool_audit_source)??(a==null?void 0:a.tool_audit_source)??(n==null?void 0:n.tool_audit_source),b=(s==null?void 0:s.tool_audit_at)??(i==null?void 0:i.tool_audit_at)??(a==null?void 0:a.tool_audit_at)??(n==null?void 0:n.tool_audit_at),C=(t==null?void 0:t.capabilities)??[],x=((J=re.value)==null?void 0:J.room)??"default",S=((Y=re.value)==null?void 0:Y.project)??"확인 없음",$=((ae=re.value)==null?void 0:ae.cluster)??"확인 없음",R=Ge(Pc(n)),I=Ge(Mc(n,h)),L=Ge(jc(n,h)),X=Ge(qi(n)),z=u[0]??f[0]??p[0]??null;return o`
    <div
      class="agent-detail-overlay"
      data-testid="agent-detail-overlay"
      onClick=${N=>{N.target.classList.contains("agent-detail-overlay")&&hr()}}
    >
      <div class="agent-detail-modal">
        <div class="agent-detail-header">
          <div style="display:flex;flex-direction:column;gap:8px;flex:1">
            ...
            `:""}
            ${(((U=t==null?void 0:t.traits)==null?void 0:U.length)??0)>0?o`
              <div style="display:flex;flex-wrap:wrap;gap:4px">
                ${(Z=t==null?void 0:t.traits)==null?void 0:Z.map(N=>o`<span style="font-size:0.7rem;background:#1e3a5f;color:#60a5fa;padding:2px 8px;border-radius:10px">${N}</span>`)}
              </div>
            `:""}
            ${(((A=t==null?void 0:t.interests)==null?void 0:A.length)??0)>0?o`
              <div style="display:flex;flex-wrap:wrap;gap:4px">
                ${(j=t==null?void 0:t.interests)==null?void 0:j.map(N=>o`<span style="font-size:0.7rem;background:#3b1f4e;color:#c084fc;padding:2px 8px;border-radius:10px">${N}</span>`)}
              </div>
            `:""}
            ${C.length>0?o`
              <div style="display:flex;flex-wrap:wrap;gap:4px">
                ${C.map(N=>o`<span style="font-size:0.7rem;background:#183153;color:#7dd3fc;padding:2px 8px;border-radius:10px">${N}</span>`)}
              </div>
            `:""}
        ...
        <div class="agent-detail-grid">
          <${T} title="Assigned Tasks">
            ${l.length===0?o`<div class="empty-state">No assigned tasks</div>`:o`<div class="agent-detail-task-list">${l.map(N=>o`<${jv} key=${N.id} task=${N} />`)}</div>`}
          <//>

          <${T} title="Recent Activity">
            ${c.length===0?o`<div class="empty-state">No recent room activity match</div>`:o`<div class="agent-activity-list">${c.map((N,ne)=>o`<div key=${ne} class="agent-activity-line">${N}</div>`)}</div>`}
          <//>
        </div>
          ...
          <div style="display:flex; flex-direction:column; gap:12px;">
            <div>
              ...
              <div style="display:flex; flex-wrap:wrap; gap:6px;">
                ${C.length>0?C.map(N=>o`<span class="pill">${N}</span>`):o`<span class="empty-state" style="font-size:12px;">No capability metadata</span>`}
              </div>
            </div>
            ...
            <div>
              ...
              <div style="display:flex; flex-wrap:wrap; gap:6px;">
                ${u.length>0?u.map(N=>o`<span class="pill">${N}</span>`):o`<span class="empty-state" style="font-size:12px;">${R}</span>`}
              </div>
            </div>
            <div>
              ...
              <div style="display:flex; flex-wrap:wrap; gap:6px;">
                ${f.length>0?f.map(N=>o`<span class="pill">${N}</span>`):o`<span class="empty-state" style="font-size:12px;">${I}</span>`}
              </div>
            </div>
            <div class="agent-detail-sub">
              <span>Tool calls: ${typeof v=="number"?v:I==="none_recent"?0:L}</span>
            ...
            <div>
              ...
              <div style="display:flex; flex-wrap:wrap; gap:6px;">
                ${p.length>0?p.map(N=>o`<span class="pill">${N}</span>`):o`<span class="empty-state" style="font-size:12px;">${X}</span>`}
              </div>
            </div>
            ${_.length>0?o`
                  <div>
                    ...
                    <div style="display:flex; flex-wrap:wrap; gap:6px;">
                      ${_.map(N=>o`<span class="pill">${N}</span>`)}
                    </div>
                  </div>
                `:null}
            ${n?o`
        ...
        <${T} title="Task History">
          ${Jn.value.length===0?o`<div class="empty-state">No task history loaded</div>`:o`<div class="agent-history-list">${Jn.value.map(N=>o`<${Ev} key=${N.taskId} row=${N} />`)}</div>`}
        <//>
        ...
        <${T} title="Direct Mention">
          <div class="agent-mention-row">
            <input
              ...
              value=${sn.value}
              onInput=${N=>{sn.value=N.target.value}}
              onKeyDown=${N=>{N.key==="Enter"&&br()}}
              disabled=${Mn.value}
            />
            <button
              class="control-btn"
  ...
  `}function sf({keeper:e}){var z,J,Y,ae,U,Z,A;const t=((z=$e.value)==null?void 0:z.room)??{},n=(((J=$e.value)==null?void 0:J.available_actions)??[]).filter(j=>j.target_type==="keeper"||j.target_type==="room").slice(0,8),s=Gv(e),a=Jv(e),i=Vv(e),l=i!=null&&i.allowed_tool_names&&i.allowed_tool_names.length>0?i.allowed_tool_names:e.allowed_tool_names??[],c=i!=null&&i.latest_tool_names&&i.latest_tool_names.length>0?i.latest_tool_names:e.latest_tool_names??[],p=(i==null?void 0:i.latest_tool_call_count)??e.latest_tool_call_count,_=(i==null?void 0:i.tool_audit_source)??e.tool_audit_source,u=(i==null?void 0:i.tool_audit_at)??e.tool_audit_at,f=((Y=e.agent)==null?void 0:Y.capabilities)??[],v=t.current_room??t.room_id??((ae=re.value)==null?void 0:ae.room)??"default",h=t.project??((U=re.value)==null?void 0:U.project)??"확인 없음",b=t.cluster??((Z=re.value)==null?void 0:Z.cluster)??"확인 없음",C=Ge(Pc(e)),x=Ge(Mc(e,_)),S=Ge(jc(e,_)),$=Ge(qi(e)),R=ps(e),I=((A=e.agent)==null?void 0:A.current_task)??(R==="offline"?"offline":"not_collected"),L=e.skill_primary??(R==="offline"?"offline":"not_collected"),X=l[0]??c[0]??s[0]??null;return o`
    <div class="keeper-signal-list">
      <div class="keeper-signal-row">
        <span>Room</span>
        <strong>${v}</strong>
      ...
      <div style="display:flex; justify-content:flex-end; margin-top:4px;">
        <button class="control-btn ghost" onClick=${()=>{Ec(X)}}>
          Open tools panel
        </button>
      </div>
      <div style="display:flex; flex-direction:column; gap:8px; margin-top:8px;">
        ...
        <div style="display:flex; flex-wrap:wrap; gap:6px;">
          ${l.length>0?l.map(j=>o`<span class="pill">${j}</span>`):o`<span style="font-size:12px; color:#888;">${C}</span>`}
        </div>
      </div>
      <div style="display:flex; flex-direction:column; gap:8px; margin-top:8px;">
        ...
        <div style="display:flex; flex-wrap:wrap; gap:6px;">
          ${c.length>0?c.map(j=>o`<span class="pill">${j}</span>`):o`<span style="font-size:12px; color:#888;">${x}</span>`}
        </div>
      </div>
      <div class="keeper-signal-row">
      ...
      <div style="display:flex; flex-direction:column; gap:8px; margin-top:8px;">
        ...
        <div style="display:flex; flex-wrap:wrap; gap:6px;">
          ${s.length>0?s.map(j=>o`<span class="pill">${j}</span>`):o`<span style="font-size:12px; color:#888;">${$}</span>`}
        </div>
      </div>
      ${a.length>0?o`
            <div style="display:flex; flex-direction:column; gap:8px; margin-top:8px;">
              ...
              <div style="display:flex; flex-wrap:wrap; gap:6px;">
                ${a.map(j=>o`<span class="pill">${j}</span>`)}
              </div>
            </div>
          `:null}
      <div style="display:flex; flex-direction:column; gap:8px; margin-top:8px;">
        ...
        <div style="display:flex; flex-wrap:wrap; gap:6px;">
          ${f.length>0?f.map(j=>o`<span class="pill">${j}</span>`):o`<span style="font-size:12px; color:#888;">등록된 capability 없음</span>`}
        </div>
      </div>
      <div style="display:flex; flex-direction:column; gap:8px; margin-top:8px;">
        <span style="font-size:12px; color:#888;">Available actions nearby</span>
        <div style="display:flex; flex-wrap:wrap; gap:6px;">
          ${n.length>0?n.map(j=>o`<span class="pill">${Wv(j.action_type)}</span>`):o`<span style="font-size:12px; color:#888;">operator action 광고 없음</span>`}
        </div>
      </div>
    </div>
  `}function Kc(){const e=new URLSearchParams(window.location.search),t=e.get("agent")??e.get("agent_name"),n=localStorage.getItem("masc_dashboard_agent_name");return(t??n??"dashboard").trim()||"dashboard"}async function af(){try{const e=await Ua({actor:Kc(),action_type:"lodge_tick",target_type:"room",payload:{}}),t=Cl(e.result);await rs(),t!=null&&t.skipped_reason?E(t.skipped_reason,"warning"):E(t?`Poke finished: ${t.acted}/${t.checked} acted`:"Poke finished",t&&t.acted>0?"success":"warning")}catch(e){const t=e instanceof Error?e.message:"Failed to run Lodge poke";E(t,"error")}}function of({keeper:e}){return o`
  ...
  `}function og(){var U,Z,A;const e=q.value.params,t=e.session_id??null,n=e.operation_id??null;oe(()=>{ic(t,n)},[t,n]);const s=oc.value;if(Yo.value&&!s)return o`<section class="dashboard-panel"><div class="loading-indicator">근거 화면 불러오는 중…</div></section>`;if(Ut.value&&!s)return o`<section class="dashboard-panel"><div class="error-card">${Ut.value}</div></section>`;const a=s==null?void 0:s.summary,i=(s==null?void 0:s.selection)??null,l=Wt(s==null?void 0:s.actor_contributions),c=Wt(s==null?void 0:s.artifacts),p=Wt(s==null?void 0:s.tool_evidence),_=(s==null?void 0:s.proof_verdict)??"insufficient",u=(a==null?void 0:a.live_verdict)??_,f=(a==null?void 0:a.historical_verdict)??null,v=(a==null?void 0:a.verdict_basis)??"live",h=(s==null?void 0:s.cp_backing_evidence)??null,b=Array.isArray((U=h==null?void 0:h.traces)==null?void 0:U.events)?((A=(Z=h.traces)==null?void 0:Z.events)==null?void 0:A.length)??0:0,C=(a==null?void 0:a.actors_count)??l.length,x=(a==null?void 0:a.planned_actor_count)??l.length,S=(a==null?void 0:a.unanswered_actor_count)??l.filter(j=>j.activity_state!=="acted"&&(j.mention_count??0)>0).length,$=(a==null?void 0:a.mentioned_actor_count)??l.filter(j=>(j.mention_count??0)>0).length,R=(a==null?void 0:a.interaction_count)??0,I=(a==null?void 0:a.evidence_count)??0,L=Xf(Wt(s==null?void 0:s.timeline)),X=eg(je(s==null?void 0:s.goal_binding)),z=tg(h),J=c.filter(j=>j.exists).length,Y=c.length-J,ae=Bf(_,u,f,C,x,S,R,I,b);return o`
    <section class="dashboard-panel mission-view">
      <${Se} surfaceId="proof" />
      <div class="panel-header">
        <div>
      ...
      <div class="mission-stat-grid">
        ...
        <div class="summary-stat-card ${x>C?"warn":"ok"}">
          <span>계획된 참여자</span>
          <strong>${x}</strong>
          <small>${$>0?`${$}명 호출됨`:"호출 기록 없음"}</small>
        </div>
        <div class="summary-stat-card ${S>0?"warn":"ok"}">
          <span>무응답</span>
          <strong>${S}</strong>
          <small>${S>0?"호출됐지만 응답 근거 없음":"무응답 참여자 없음"}</small>
        </div>
      ...
      <div class="mission-human-grid">
        <${T} title="3줄 근거 요약" class="mission-list-card" semanticId="proof.summary">
          ...
          <div class="proof-summary-stack">
            ${ae.map((j,N)=>o`
              <article class="proof-summary-block ${N===1&&_!=="proven"?xn(_):""}">
                <strong>${N===0?"지금 결론":N===1?"왜 이렇게 판정됐나":"다음 보강 포인트"}</strong>
                <span>${j}</span>
              </article>
            `)}
          </div>
      ...
      <div class="mission-human-grid">
        <${T} title="협업 타임라인" class="mission-list-card" semanticId="proof.timeline">
          ...
          <div class="mission-list-stack">
            ${L.length>0?L.slice(0,18).map(j=>o`<${ng} key=${j.id} item=${j} />`):o`<div class="empty-state">표시할 타임라인 근거가 없습니다.</div>`}
          </div>
        <//>
        ...
        <${T} title="참여 흔적" class="mission-list-card" semanticId="proof.contributions">
          ...
          <div class="mission-activity-list">
            ${l.length>0?l.map(j=>o`<${sg} key=${j.actor} item=${j} />`):o`<div class="empty-state">표시할 참여 흔적이 없습니다.</div>`}
          </div>
        <//>
      </div>
      ...
      <div class="mission-human-grid">
        <${T} title="도구 근거" class="mission-list-card" semanticId="proof.tool_evidence">
          ...
          <div class="mission-list-stack">
            ${p.length>0?p.map((j,N)=>o`<${Qf} key=${`${j.actor??"system"}-${N}`} item=${j} />`):o`<div class="empty-state">기록된 tool evidence가 없습니다.</div>`}
          </div>
        <//>
        ...
        <${T} title="실행 근거" class="mission-list-card" semanticId="proof.backing">
          ...
          <details class="mission-card-disclosure compact">
            ...
            <pre class="command-json-block">${Ca(h??{})}</pre>
          </details>
        <//>
      </div>
      ...
      <div class="mission-human-grid">
        <${T} title="산출물" class="mission-list-card" semanticId="proof.artifacts">
          ...
          <div class="mission-list-stack">
            ${c.length>0?c.map(j=>o`<${ag} key=${j.path} item=${j} />`):o`<div class="empty-state">기록된 artifact가 없습니다.</div>`}
          </div>
        <//>
      </div>
    </section>
  `}function ig(){const e=us(q.value);return e?o`
  ...
  `}function lg(){var Y,ae,U,Z;const e=fs(),t=e==null?void 0:e.topology.summary,n=e==null?void 0:e.operations.summary,s=e==null?void 0:e.detachments.summary,a=e==null?void 0:e.decisions.summary,i=e==null?void 0:e.alerts.summary,l=(Y=e==null?void 0:e.swarm_status)==null?void 0:Y.overview,c=e==null?void 0:e.swarm_proof,p=e==null?void 0:e.operations.microarch,_=(t==null?void 0:t.managed_unit_count)??0,u=(t==null?void 0:t.total_units)??0,f=(n==null?void 0:n.active)??0,v=(s==null?void 0:s.active)??0,h=(l==null?void 0:l.moving_lanes)??0,b=(l==null?void 0:l.active_lanes)??0,C=(c==null?void 0:c.workers.done)??0,x=(c==null?void 0:c.workers.expected)??0,S=(i==null?void 0:i.bad)??0,$=(i==null?void 0:i.warn)??0,R=(a==null?void 0:a.pending)??0,I=(a==null?void 0:a.total)??0,L=f+v,X=((ae=p==null?void 0:p.cache)==null?void 0:ae.l1_hit_rate)??((Z=(U=p==null?void 0:p.signals)==null?void 0:U.cache_contention)==null?void 0:Z.l1_hit_rate)??0,z=f>0||v>0?"지휘면이 실제로 움직이고 있습니다":"계층은 준비됐지만 실행은 아직 잠복 상태입니다",J=f>0||h>0?"무거운 상세 탭으로 들어가기 전에, 여기서 먼저 압력과 이동감, 운영 부채를 읽을 수 있어야 합니다.":"이 화면은 체크리스트보다 계기판에 가까워야 합니다. 아래 게이지가 지금 어디가 살아 있는지 먼저 보여줍니다.";return o`
    ...
    <div class="command-signal-grid">
      ...
      <${zs}
        label="캐시 신뢰도"
        value=${X?_s(X):"정보 없음"}
        detail=${X?"microarch 캐시 텔레메트리에서 집계한 L1 적중률":"캐시 텔레메트리가 아직 집계되지 않았습니다"}
        percent=${vs((X??0)*100)}
        tone=${X>=.75?"ok":X>=.4?"warn":"bad"}
      />
    </div>
  `}function cg(){var v,h,b,C,x;const e=fs(),t=ds.value,n=us(q.value),s=Lf(n),a=e==null?void 0:e.topology.summary,i=e==null?void 0:e.operations.summary,l=(v=e==null?void 0:e.swarm_status)==null?void 0:v.overview,c=e==null?void 0:e.operations.microarch,p=e==null?void 0:e.decisions.summary,_=e==null?void 0:e.alerts.summary,u=(h=c==null?void 0:c.signals)==null?void 0:h.issue_pressure,f=c==null?void 0:c.cache;return o`
      ...
      <section class="card command-section">
        ...
        <div class="command-guide-card highlight command-next-step-card">
          ...
          ${($t=S==null?void 0:S.success_signals)!=null&&$t.length?o`<div class="command-tag-row">
                ${S.success_signals.map(B=>o`<span class="command-tag ok">${B}</span>`)}
              </div>`:null}
        </div>

        <div class="command-readiness-list">
          ${C.map(B=>o`
            <article class="command-readiness-row ${P(B.tone)}">
              <div>
                <div class="command-readiness-title-row">
                  <strong>${B.title}</strong>
                  <span class="command-chip ${P(B.tone)}">${B.tone}</span>
                </div>
                <p>${B.detail}</p>
              </div>
      ...
      <section class="card command-section">
        ...
        ${Xo.value?o`<div class="empty-state">CPv2 runbook 불러오는 중…</div>`:va.value?o`<div class="empty-state error">${va.value}</div>`:o`
                ...
                ${z.length>0?o`<div class="command-doc-links">
                      ${z.map(B=>o`<span class="command-tag">${B.title}: ${B.path}</span>`)}
                    </div>`:null}
              `}
      </section>
    </div>
  ...
  `}function Kg(){const e=Ue.value,t=e==null?void 0:e.topology,n=t==null?void 0:t.source,s=t==null?void 0:t.summary,a=(s==null?void 0:s.managed_unit_count)??0,i=(s==null?void 0:s.active_operation_count)??0;return o`
    <section class="card command-section">
      <div class="card-title-row">
  ...
  `}function Bg(){const e=Ue.value;return o`
    <section class="card command-section">
      <div class="card-title-row">
    ...
    <article class="command-guide-card ${P(l)}">
      ...
      ${i?o`
            <div class="command-guide-card warn">
              ...
              <div class="command-action-row">
                <button class="control-btn" onClick=${()=>{u("confirm")}} disabled=${V.value}>확인 실행</button>
                <button class="control-btn ghost" onClick=${()=>{u("deny")}} disabled=${V.value}>취소</button>
              </div>
            </div>
          `:n?o`
              <div class="command-action-row">
                ${n.continue_available?o`<button class="control-btn ghost" onClick=${()=>{_("swarm_run_continue")}} disabled=${V.value}>계속</button>`:null}
                ${n.rerun_available?o`<button class="control-btn" onClick=${()=>{_("swarm_run_rerun")}} disabled=${V.value}>재실행</button>`:null}
                ${n.abandon_available?o`<button class="control-btn ghost" onClick=${()=>{_("swarm_run_abandon")}} disabled=${V.value}>포기</button>`:null}
              </div>
            `:null}
    </article>
  ...
  `}function a$(){var u,f,v,h,b,C,x,S,$,R,I,L,X,z,J,Y,ae,U,Z,A,j,N;const e=Nt.value,t=Jc(),n=Ui(),s=Jg(e==null?void 0:e.provider),a=((u=e==null?void 0:e.provider)==null?void 0:u.configured_capacity)??0,i=((f=e==null?void 0:e.provider)==null?void 0:f.actual_slots)??((v=e==null?void 0:e.provider)==null?void 0:v.total_slots)??0,l=((h=e==null?void 0:e.provider)==null?void 0:h.expected_slots)??"n/a",c=((b=e==null?void 0:e.provider)==null?void 0:b.actual_ctx)??((C=e==null?void 0:e.provider)==null?void 0:C.ctx_per_slot)??0,p=((x=e==null?void 0:e.provider)==null?void 0:x.expected_ctx)??"n/a",_=((S=e==null?void 0:e.summary)==null?void 0:S.peak_hot_slots)??(($=e==null?void 0:e.provider)==null?void 0:$.peak_active_slots)??0;return o`
      ...
      <div class="command-surface-grid">
        <section class="card command-section">
          ...
          ${fa.value?o`<div class="empty-state">Loading swarm live state…</div>`:ga.value?o`<div class="empty-state error">${ga.value}</div>`:e?o`
                    <div class="command-summary-grid">
                      ...
                      <div class="monitor-stat-card"><span>워커</span><strong>${((R=e.summary)==null?void 0:R.joined_workers)??0}/${((I=e.summary)==null?void 0:I.expected_workers)??0}</strong><small>${((L=e.summary)==null?void 0:L.live_workers)??0}개 가동 · ${((X=e.summary)==null?void 0:X.completed_workers)??0}개 완료</small></div>
                      <div class="monitor-stat-card"><span>런타임 계약</span><strong>${s}</strong><small>설정 ${a||"n/a"} · 실제 ${i}/${l} · ctx ${c}/${p}</small></div>
                      <div class="monitor-stat-card"><span>고동시성</span><strong>${(z=e.summary)!=null&&z.pass_hot_concurrency?"통과":"확인 필요"}</strong><small>최대 hot ${_} · ${((J=e.provider)==null?void 0:J.slot_url)??"slot 정보 없음"}</small></div>
                      <div class="monitor-stat-card"><span>종단 점검</span><strong>${(Y=e.summary)!=null&&Y.pass_end_to_end?"통과":"확인 필요"}</strong><small>${e.recommended_next_tool??"masc_observe_traces"}</small></div>
                    </div>
                    <div class="command-card-grid">
                      <span>작전</span><span>${((ae=e.operation)==null?void 0:ae.operation_id)??n??"없음"}</span>
                      <span>분대</span><span>${((U=e.squad)==null?void 0:U.label)??"없음"}</span>
                      ...
                      <span>런타임 막힘</span><span>${((N=e.provider)==null?void 0:N.runtime_blocker)??"없음"}</span>
        ...
        <section class="card command-section">
          ...
          ${e&&e.checklist.length>0?o`<div class="command-card-stack">
                ${e.checklist.map(ne=>o`<${n$} item=${ne} />`)}
        ...
        <section class="card command-section">
          ...
          ${e&&e.workers.length>0?o`<div class="command-card-stack">
                ${e.workers.map(ne=>o`<${s$} worker=${ne} />`)}
  ...
  `}function d$(){var Z,A,j,N,ne,$t,B,Pe,ht,hn,yn,gs,$s,hs,ys,bs,ks,xs,tr,nr,sr;const e=fs(),t=Nt.value,n=$e.value,s=Fe.value,a=qf(),i=t!=null&&t.operation?((Z=ds.value)==null?void 0:Z.operations.find(ee=>{var Ss;return ee.operation.operation_id===((Ss=t.operation)==null?void 0:Ss.operation_id)}))??null:null,l=Df(),c=(t==null?void 0:t.workers)??[],p=(s==null?void 0:s.worker_cards)??[],_=l&&c.length>0?c.map(r$):p.map(l$),u=l,f=((A=e==null?void 0:e.decisions.summary)==null?void 0:A.pending)??0,v=(n==null?void 0:n.pending_confirms)??[],h=l?(t==null?void 0:t.blockers)??[]:[],b=(s==null?void 0:s.recommended_actions)??[],C=(j=s==null?void 0:s.active_recommended_actions)!=null&&j.length?s.active_recommended_actions:b,x=s==null?void 0:s.active_summary,S=(s==null?void 0:s.active_guidance_layer)??"fallback",$=(s==null?void 0:s.resident_judge_runtime)??(n==null?void 0:n.resident_judge_runtime),R=(s==null?void 0:s.attention_items)??[],I=((N=t==null?void 0:t.recent_messages[0])==null?void 0:N.timestamp)??null,L=((ne=t==null?void 0:t.recent_trace_events[0])==null?void 0:ne.timestamp)??null,X=l?I??L??null:null,z=a==null?void 0:a.summary,J=(l?($t=t==null?void 0:t.summary)==null?void 0:$t.expected_workers:void 0)??(typeof(z==null?void 0:z.planned_worker_count)=="number"?z.planned_worker_count:void 0)??(s==null?void 0:s.worker_cards.length)??0,Y=(l?(B=t==null?void 0:t.summary)==null?void 0:B.joined_workers:void 0)??(typeof(z==null?void 0:z.active_agent_count)=="number"?z.active_agent_count:void 0)??_.length,ae=h.length>0||f>0||v.length>0?"warn":u||a?"ok":"warn",U=l?((Pe=e==null?void 0:e.swarm_status)==null?void 0:Pe.lanes.filter(ee=>ee.present))??[]:[];return oe(()=>{xe()},[]),oe(()=>{a!=null&&a.session_id&&dn(a.session_id)},[a==null?void 0:a.session_id,n,(ht=t==null?void 0:t.detachment)==null?void 0:ht.session_id]),!u&&!a?fa.value||Un.value?o`<div class="empty-state">실시간 워룸 불러오는 중…</div>`:o`
    ...
    <div class="command-section-stack">
      <section class="command-warroom-strip ${P(ae)}">
        ...
        <div class="command-warroom-strip-stats">
          ...
          <div class="monitor-stat-card ${P(Ra(S))}">
            <span>상주 판정기</span>
            <strong>${Wi($)}</strong>
            ...
            ${t&&t.recent_messages.length>0&&l?o`<div class="command-trace-stack">
                  ...
                  `)}
                    ...
                    `)}
                      ...
                      ${a.recent_events.slice(0,6).map((ee,Ss)=>o`
                        <article class="command-trace-row">
                          <div class="command-trace-main">
                            <div class="command-trace-head">
                          ...
                          <pre class="command-trace-detail">${Ca(ee)}</pre>
                        </article>
                      `)}
  ...
  `}function g$(){const e=Ue.value;return o`
    <div class="command-surface-grid">
      <section class="card command-section">
        <div class="card-title-row">
  ...
  `}function $$(){var c,p,_,u,f,v,h,b,C,x,S,$,R,I,L,X;const e=ds.value,t=(e==null?void 0:e.operations)??[],n=tn.value,s=t.find(z=>z.operation.operation_id===n)??t[0]??null,a=((c=s==null?void 0:s.operation.chain)==null?void 0:c.run_id)??null,i=((p=Hn.value)==null?void 0:p.run)??(s==null?void 0:s.preview_run)??null,l=!((_=Hn.value)!=null&&_.run)&&!!(s!=null&&s.preview_run);return oe(()=>{a?H_(a):B_()},[a]),o`
        ...
        ${s?o`
              <article class="command-card">
                ...
                <div class="command-card-grid">
                  ...
                  <span>최근 갱신</span><span>${te(((I=s.operation.chain)==null?void 0:I.last_sync_at)??s.operation.updated_at)}</span>
                </div>
              ...
              ${s.mermaid?o`
                    <div class="command-chain-panel">
                      <div class="command-guide-head">
                        ...
                        <span class="command-chip">${((X=s.operation.chain)==null?void 0:X.chain_id)??"graph"}</span>
                      </div>
                      <${u$} source=${s.mermaid} />
                    </div>
  ...
  `}function h$(e){switch((e??"").trim().toLowerCase()){case"pending":return"대기 중";case"approved":return"승인됨";case"denied":return"거부됨";case"executed":return"실행됨";case"active":return"가동 중";default:return(e==null?void 0:e.trim())||"확인 필요"}}function y$({decision:e}){const t=`approve:${e.decision_id}`,n=`deny:${e.decision_id}`,s=e.source==="projected_operator";return o`
    <article class="command-card ${P(e.status)}">
      <div class="command-card-head">
        ...
        <span class="command-chip ${P(e.status)}">${h$(e.status??"pending")}</span>
      </div>
      <div class="command-card-grid">
  ...
  `}function k$(){const e=Ue.value;return o`
    <div class="command-surface-grid">
      <section class="card command-section">
        <div class="card-title-row">
  ...
  `}function S$(){if(Q.value==="warroom")return o`<${d$} />`;if(Q.value==="summary")return o`<${ug} />`;if(Q.value==="orchestra")return o`<${bg} />`;if(Q.value==="swarm")return o`<${a$} />`;if(!Ue.value)return o`<${pg} />`;switch(Q.value){case"chains":return o`<${$$} />`;case"topology":return o`<${Kg} />`;case"alerts":return o`<${Ug} />`;case"trace":return o`<${Bg} />`;case"control":return o`<${k$} />`;case"operations":default:return o`<${g$} />`}}function C$(){return oe(()=>{Bt(),nn(),W_(),tt(),Rt()},[]),oe(()=>{if(q.value.tab!=="command")return;const e=q.value.params.surface,t=q.value.params.operation,n=us(q.value);if(Ir(e))rt(e);else if(n){const s=Ac(n);Ir(s)&&rt(s)}else e||rt("warroom");t&&Mi(t),(e==="swarm"||e==="warroom"||e==="orchestra"||Q.value==="warroom"||Q.value==="orchestra")&&tt(),(e==="orchestra"||Q.value==="orchestra")&&Rt(),(e==="warroom"||Q.value==="warroom")&&xe()},[q.value.tab,q.value.params.surface,q.value.params.operation,q.value.params.operation_id,q.value.params.run_id,q.value.params.source,q.value.params.action_type,q.value.params.target_type,q.value.params.target_id,q.value.params.focus_kind]),oe(()=>{let e=null;const t=()=>{e||(e=window.setTimeout(()=>{e=null,Bt(),nn(),(Q.value==="swarm"||Q.value==="warroom"||Q.value==="orchestra")&&tt(),Q.value==="orchestra"&&Rt(),Q.value==="warroom"&&xe()},250))},n=new EventSource(If()),s=Cf.map(a=>{const i=()=>t();return n.addEventListener(a,i),{type:a,handler:i}});return n.onerror=()=>{t()},()=>{s.forEach(({type:a,handler:i})=>{n.removeEventListener(a,i)}),n.close(),e&&window.clearTimeout(e)}},[]),oe(()=>{const e=window.setInterval(()=>{if(document.visibilityState==="hidden")return;const t=Q.value;t!=="swarm"&&t!=="warroom"&&t!=="orchestra"||(Bt(),tt(),t==="orchestra"&&Rt(),t==="warroom"&&xe())},5e3);return()=>{window.clearInterval(e)}},[]),o`
    <section class="dashboard-panel command-plane-view">
      <div class="panel-header">
        ...
        <div class="panel-actions">
          ...
          <button
            class="control-btn ghost"
            onClick=${()=>{It(),Bt(),nn(),tt(),Q.value==="warroom"&&xe()}}
            disabled=${da.value}
          >
      ...
      <section class="card ops-panel ops-lane-panel">
        ...
        <div class="control-row">
          <input
            ...
            disabled=${V.value}
          />
          <button class="control-btn" onClick=${()=>{Or()}} disabled=${V.value||an.value.trim()===""}>
            보내기
          </button>
        </div>
        ...
        <div class="control-row ops-split-row">
          <input
            ...
            disabled=${V.value}
          />
          <button class="control-btn ghost" onClick=${()=>{jg()}} disabled=${V.value}>
            일시정지
          </button>
          <button class="control-btn ghost" onClick=${()=>{Xc()}} disabled=${V.value}>
            재개
          </button>
        </div>
        ...
        <div class="control-row ops-split-row">
          ...
          <button class="control-btn" onClick=${()=>{Eg()}} disabled=${V.value||on.value.trim()===""}>
            주입
          </button>
        </div>
      </section>
              ...
              <article key=${`${$.action_type}:${$.target_type}:${$.target_id??"room"}`} class="ops-log-entry ${$.severity}">
                ...
                ${$.suggested_payload?o`
                  <div class="ops-confirmation-actions">
                    <button class="control-btn ghost" onClick=${()=>{Pg($)}} disabled=${V.value}>
                      폼에 채우기
                    </button>
                  </div>
                `:null}
          ...
          <div class="ops-confirmation-list">
            ${s.map($=>o`
              <article key=${$.confirm_token} class="ops-confirmation-card">
                ...
                <div class="ops-confirmation-actions">
                  <button class="control-btn" onClick=${()=>{qr($.confirm_token)}} disabled=${V.value}>
                    실행
                  </button>
                  <button class="control-btn ghost" onClick=${()=>{qr($.confirm_token,"deny")}} disabled=${V.value}>
                    거부
                  </button>
    ...
    <div class="ops-column">
      ...
      <section class="card ops-panel ops-lane-panel">
        ...
        <div class="control-row ops-split-row">
          ...
          <button class="control-btn" onClick=${()=>{Ng()}} disabled=${V.value||!a}>
            적용
          </button>
        </div>
        ...
        <div class="control-row ops-split-row">
          <input
            ...
            disabled=${V.value||!a}
          />
          <button class="control-btn ghost" onClick=${()=>{Dg()}} disabled=${V.value||!a}>
            세션 중지
          </button>
        </div>
      </section>
  ...
  `}function I$(){var i;const e=$e.value,t=(e==null?void 0:e.keepers)??[],n=(e==null?void 0:e.persistent_agents)??[],s=(e==null?void 0:e.available_actions)??[],a=t.find(l=>l.name===Ia.value)??t[0]??null;return o`
    <div class="ops-column">
      ...
      <section class="card ops-panel ops-lane-panel">
        ...
        ></textarea>
        <div class="control-row">
          <button class="control-btn" onClick=${()=>{Og()}} disabled=${V.value||!a||rn.value.trim()===""}>
            keeper에 보내기
          </button>
        </div>
      </section>
  ...
  `}function z$(){var I,L,X;const e=$e.value,t=q.value.tab==="intervene"?us(q.value):null,n=Ti.value,s=(e==null?void 0:e.room)??{},a=(e==null?void 0:e.sessions)??[],i=(e==null?void 0:e.keepers)??[],l=(e==null?void 0:e.pending_confirms)??[],c=e==null?void 0:e.pending_confirm_summary,p=(c==null?void 0:c.visible_count)??l.length,_=(c==null?void 0:c.total_count)??l.length,u=(c==null?void 0:c.hidden_count)??0,f=((I=c==null?void 0:c.actor_filter)==null?void 0:I.trim())||null,v=a.find(z=>z.session_id===un.value)??a[0]??null,h=(n==null?void 0:n.attention_items)??[],b=h.filter(Ag),C=h.filter(Tg),x=a.filter(z=>Cg(z)!=="ok"),S=i.filter(z=>lo(z)!=="ok"),$=Mg(t,a,i);oe(()=>{jt()},[]),oe(()=>{if(q.value.tab!=="intervene"){Rs.value=null;return}if(!t){Rs.value=null;return}Rs.value!==t.id&&(Rs.value=t.id,Lg(t))},[q.value.tab,q.value.params.source,q.value.params.action_type,q.value.params.target_type,q.value.params.target_id,q.value.params.focus_kind,t==null?void 0:t.id]),oe(()=>{const z=(v==null?void 0:v.session_id)??null;dn(z)},[v==null?void 0:v.session_id]);const R=[{key:"room",label:"방 게이트",value:s.paused?"일시정지":"열림",detail:s.paused?`재개 전환 대기 중${s.pause_reason?` · ${s.pause_reason}`:""}`:"지금은 새 액션과 새 작업을 바로 받을 수 있습니다",tone:s.paused?"bad":"ok"},{key:"confirm",label:"확인 대기",value:u>0?`${p}/${_}`:p,detail:p>0?"미리보기만 된 개입이 아직 사람 확인을 기다리고 있습니다":u>0&&f?`현재 개입 ID(${f}) 기준으로는 비어 있고, 다른 개입 ID 대기 ${u}건이 있습니다`:"지금 막혀 있는 확인 대기는 없습니다",tone:_>0?"warn":"ok"},{key:"session",label:"세션 리스크",value:b.length>0?b.length:a.length,detail:b.length>0?((L=b[0])==null?void 0:L.summary)??"세션 중 하나가 방향 수정이나 중지 판단을 기다리고 있습니다":a.length===0?"지금 관리 중인 팀 세션이 없습니다":"세션 쪽 긴급 주의 신호는 현재 없습니다",tone:b.length>0?Dr(b):a.length===0?"warn":x.some(z=>pn(z.status)==="paused")?"bad":x.length>0?"warn":"ok"},{key:"keeper",label:"키퍼 압력",value:C.length>0?C.length:S.length,detail:C.length>0?((X=C[0])==null?void 0:X.summary)??"직접 메시지나 상태 점검이 필요한 키퍼가 있습니다":S.length>0?"오래됐거나 오프라인이거나 텔레메트리가 비는 키퍼가 보입니다":"지금은 키퍼 쪽이 비교적 안정적입니다",tone:C.length>0?Dr(C):S.some(z=>lo(z)==="bad")?"bad":S.length>0?"warn":"ok"}];return o`
    <section class="ops-view">
      ...
      ${(()=>{const z=[];if((p>0||u>0)&&z.push({label:u>0?`확인 대기 ${p}/${_}건 확인`:`확인 대기 ${p}건 처리`,desc:u>0&&f?`현재 개입 ID(${f}) 기준으로 보이는 대기열을 먼저 확인합니다`:"승인 또는 거부가 필요한 개입이 대기 중입니다",tone:p>0?"bad":"warn",onClick:()=>{const J=document.querySelector(".ops-pending-section");J==null||J.scrollIntoView({behavior:"smooth"})}}),s.paused&&z.push({label:"방 재개",desc:`현재 일시정지 상태${s.pause_reason?` (${s.pause_reason})`:""}`,tone:"warn",onClick:()=>void Xc()}),S.length>0){const J=S.filter(Y=>lo(Y)==="bad");z.push({label:J.length>0?`오프라인 키퍼 ${J.length}개`:`점검이 필요한 키퍼 ${S.length}개`,desc:J.length>0?"메시지를 보내거나 상태를 확인하세요":"오래됐거나 텔레메트리가 비어 있습니다",tone:J.length>0?"bad":"warn",onClick:()=>{const Y=document.querySelector(".ops-keeper-section");Y==null||Y.scrollIntoView({behavior:"smooth"})}})}return z.length===0?null:o`
...
`))}</p>`)}return n}function co(e){const t=[],n=/(`[^`]+`)|(\*\*[^*]+\*\*)|(\*[^*]+\*)|\[([^\]]+)\]\(([^)]+)\)/g;let s=0,a;for(;(a=n.exec(e))!==null;){if(a.index>s&&t.push(e.slice(s,a.index)),a[1]){const i=a[1].slice(1,-1);t.push(o`<code>${i}</code>`)}else if(a[2]){const i=a[2].slice(2,-2);t.push(o`<strong>${i}</strong>`)}else if(a[3]){const i=a[3].slice(1,-1);t.push(o`<em>${i}</em>`)}else a[4]&&a[5]&&t.push(o`<a href=${a[5]} target="_blank" rel="noopener">${a[4]}</a>`);s=a.index+a[0].length}return s<e.length&&t.push(e.slice(s)),t.length>0?t:[e]}const rd=[{id:"recent",label:"최신순"},{id:"hot",label:"인기순"},{id:"trending",label:"급상승"},{id:"updated",label:"최근 갱신"},{id:"discussed",label:"토론 많은 순"}],Vs=g(null),Ys=g([]),mn=g(!1),Pt=g(null),jn=g(""),En=g(!1),Jt=g(!0),Vi=20,wt=g(Vi);function P$(){var t,n;const e=new URLSearchParams(window.location.search);return((t=e.get("agent"))==null?void 0:t.trim())||((n=e.get("agent_name"))==null?void 0:n.trim())||"dashboard-user"}const M$=g(P$());function j$(e){const t=e.replace(/!\[[^\]]*\]\([^)]+\)/g," ").replace(/\[[^\]]+\]\([^)]+\)/g,"$1").replace(/[`#>*_~-]/g," ").replace(/\s+/g," ").trim();return t?t.length>180?`${t.slice(0,177)}...`:t:"미리보기 없음"}function Kr(e){return e.updated_at!==e.created_at}function E$(e){if(e.post_kind)return e.post_kind==="automation";const t=(e.hearth??"").toLowerCase();return e.visibility!=="internal"||!e.expires_at||!t?!1:!!(t.startsWith("mdal")||t.includes("harness"))}function N$(e){return e==="lodge-system"||e==="team-session"}function ns(e){return e.post_kind?e.post_kind:N$(e.author)?"system":E$(e)?"automation":"human"}function ld(e){const t=[],n=[];let s=0;return e.forEach(a=>{const i=ns(a);if(!(i==="system"&&At.value)){if(i==="automation"&&Jt.value){s+=1;return}if(i==="human"){t.push(a);return}n.push(a)}}),{human:t,operations:n,hiddenAutomation:s}}function D$(e){if(!e.expires_at)return null;const t=Date.parse(e.expires_at);return Number.isFinite(t)?t<=Date.now()?o`<span class="board-meta-chip">만료됨</span>`:o`<span class="board-meta-chip">만료까지 <${G} timestamp=${e.expires_at} /></span>`:null}async function Yi(e){Pt.value=e,Vs.value=null,Ys.value=[],mn.value=!0;try{const t=await zu(e);if(Pt.value!==e)return;Vs.value={id:t.id,author:t.author,title:t.title,body:t.body,content:t.content,meta:t.meta,tags:t.tags,votes:t.votes,vote_balance:t.vote_balance,comment_count:t.comment_count,created_at:t.created_at,updated_at:t.updated_at,post_kind:t.post_kind,flair:t.flair,hearth:t.hearth,visibility:t.visibility,expires_at:t.expires_at,hearth_count:t.hearth_count},Ys.value=t.comments??[]}catch{Pt.value===e&&(Vs.value=null,Ys.value=[])}finally{Pt.value===e&&(mn.value=!1)}}async function Ur(e){const t=jn.value.trim();if(t){En.value=!0;try{await Ru(e,M$.value,t),jn.value="",E("댓글을 등록했습니다","success"),await Yi(e),ot()}catch{E("댓글 등록에 실패했습니다","error")}finally{En.value=!1}}}function O$(){const e=Fn.value,t=Jt.value?"자동화 글 숨김":"자동화 글 표시 중";return o`
  ...
  `}function uo(){var s;const e=((s=rd.find(a=>a.id===Fn.value))==null?void 0:s.label)??Fn.value,t=ld(Ha.value),n=t.human.length+t.operations.length;return o`
    <div class="board-summary-strip">
      ...
      <div class="board-summary-item">
        ...
        <strong>${Wo.value?o`<${G} timestamp=${Wo.value} />`:"아직 불러오지 않음"}</strong>
      </div>
    </div>
  `}function Br({post:e}){const t=async(n,s)=>{s.stopPropagation();try{await kl(e.id,n),ot()}catch{E("투표에 실패했습니다","error")}};return o`
      ...
      <div class="post-content">
        <div class="post-head">
          ...
          <div class="post-meta">
            ...
            ${Kr(e)?o`<span>수정 <${G} timestamp=${e.updated_at} /></span>`:null}
  ...
  `}function K$(){const e=ld(Ha.value),t=[...e.human,...e.operations],n=q.value.params.post??null,s=n?t.find(a=>a.id===n)??(Pt.value===n?Vs.value:null):null;return n&&!s&&Pt.value!==n&&!mn.value&&Yi(n),n?s?o`
          <${Se} surfaceId="memory" />
          <${uo} />
          <${F$} post=${s} />
        `:o`
      ...
      ${Kn.value?o`<div class="loading-indicator">메모리 피드 불러오는 중...</div>`:t.length===0?o`<div class="empty-state">지금은 남아 있는 메모리 글이 없습니다</div>`:o`
              <${T} title="사람이 쓴 글" class="section" semanticId="memory.feed">
                <div class="board-post-list">
                  ${e.human.slice(0,wt.value).map(a=>o`<${Br} key=${a.id} post=${a} />`)}
                </div>
              ...
              ${e.operations.length>0?o`
                    <${T} title="자동화 · 시스템" class="section" semanticId="memory.feed">
                      <div class="board-post-list">
                        ${e.operations.map(a=>o`<${Br} key=${a.id} post=${a} />`)}
                      </div>
                    <//>
                  `:null}
            `}
    </div>
  `}function U$({ratio:e,size:t=40,stroke:n=4}){if(e==null)return null;const s=(t-n)/2,a=t/2,i=2*Math.PI*s,l=i*((100-e*100)/100);let c="mitosis-safe";return e>=.8?c="mitosis-critical":e>=.5&&(c="mitosis-warn"),o`
  ...
  `}function Q$({item:e,selected:t}){return o`
    <button
      ...
      onClick=${()=>{St.value=t?null:e.id,Be.value=null,He.value=null}}
    >
      <div class="mission-card-head">
        <div>
  ...
  `}function X$({brief:e,selected:t}){return o`
    <button
      ...
      onClick=${()=>{Be.value=t?null:e.session_id,He.value=null}}
    >
      <div class="mission-card-head">
        <div>
          <div class="mission-card-target">${e.session_id}${e.room?` · ${e.room}`:""}</div>
  ...
  `}function Z$({brief:e,selected:t}){return o`
    <button
      ...
      onClick=${()=>{He.value=t?null:e.operation_id,Be.value=e.linked_session_id??null}}
    >
      <div class="mission-card-head">
        <div>
  ...
  `}function nh({row:e}){var n,s;const t=()=>{const a=W$(e.name);a&&Fc(a)};return o`
    <button class="monitor-row ${e.tone} state-${e.state}" data-testid="execution.continuity-card" onClick=${t}>
      <div class="monitor-row-header">
        ...
        <${U$} ratio=${e.context_ratio??0} size=${34} stroke=${4} />
        <${gt} status=${e.status??"unknown"} />
      ...
      <div class="agents-workbench">
        ...
        >
          ...
          <div class="monitor-list">
            ${v.length===0?o`<div class="empty-state">선택된 실행과 연결된 세션이 없습니다.</div>`:v.map($=>o`<${X$} key=${$.session_id} brief=${$} selected=${Be.value===$.session_id} />`)}
          </div>
        <//>
...
`))}function Zh({hp:e,max:t}){const n=Fh(e,t),s=wh(e,t);return o`
            ...
            <div class="trpg-annot-list">
              ${i.map(v=>o`
                <span class="trpg-annot-chip trait">
                  ...
                  <span class="trpg-annot-desc">${Bh(v)}</span>
                </span>
              `)}
            </div>
          </div>
  ...
  `}function ry({state:e,nowMs:t}){var v;const n=Je.value||((v=e.session)==null?void 0:v.room)||"",s=e.join_gate,a=xo.value,i=m(a)?a:null,l=(e.party??[]).filter(h=>h.role!=="dm"),c=et.value.trim(),p=l.some(h=>h.id===c),_=p?c:c?"__manual__":"",u=async()=>{const h=et.value.trim(),b=Es.value.trim();if(!n||!h){E("Room/Actor가 필요합니다.","warning");return}Ae.value="checking";try{const C=await Qu(n,h,b||void 0);xo.value=C,Ae.value="ok",E("참가 가능 여부를 갱신했습니다.","success")}catch(C){Ae.value="error";const x=C instanceof Error?C.message:"참가 가능 여부 확인에 실패했습니다.";E(x,"error")}},f=async()=>{var S,$;const h=et.value.trim(),b=Es.value.trim(),C=ko.value.trim();if(!n||!h||!b){E("Room/Actor/Keeper가 필요합니다.","warning");return}if(!Xs(t))return;const x=((S=e.current_round)==null?void 0:S.phase)??(($=e.session)==null?void 0:$.status)??"unknown";if(_i("Mid-Join 승인 요청",n,x)){Ae.value="requesting";try{const R=await Xu({room_id:n,actor_id:h,keeper_name:b,role:bo.value,...C?{name:C}:{}});xo.value=R;const I=m(R)?os(R,"granted",!1):!1,L=m(R)?be(R,"reason_code",""):"";I?E("Mid-Join이 승인되었습니다.","success"):E(`Mid-Join이 거절되었습니다${L?`: ${L}`:""}`,"warning"),Ae.value=I?"ok":"error",it()}catch(R){Ae.value="error";const I=R instanceof Error?R.message:"Mid-Join 요청에 실패했습니다.";E(I,"error")}finally{qa()}}};return o`
    <div class="trpg-control-box">
  ...
  `:null}function bd(){const e=pi.value;if(!e)return o`<div class="empty-state" style="font-size:13px;">Run Round 결과가 아직 없습니다.</div>`;const t=e.summary,n=m(t)?t:null,a=(Array.isArray(e.statuses)?e.statuses:[]).filter(m).slice(-8),i=e.canon_check,l=m(i)?i:null,c=l&&Array.isArray(l.warnings)?l.warnings.filter(L=>typeof L=="string").slice(0,3):[],p=l&&Array.isArray(l.violations)?l.violations.filter(L=>typeof L=="string").slice(0,3):[],_=n?os(n,"advanced",!1):!1,u=n?be(n,"progress_reason",""):"",f=n?be(n,"progress_detail",""):"",v=n?Ee(n,"player_successes",0):0,h=n?Ee(n,"player_required_successes",0):0,b=n?os(n,"dm_success",!1):!1,C=n?Ee(n,"timeouts",0):0,x=n?Ee(n,"unavailable",0):0,S=n?Ee(n,"reprompts",0):0,$=n?Ee(n,"npc_attacks",0):0,R=n?Ee(n,"keeper_timeout_sec",0):0,I=n?Ee(n,"roll_audit_count",0):0;return o`
    <div style="display:grid; gap:10px;">
      ...
      ${a.length>0?o`
          <div class="trpg-round-list">
            ${a.map(L=>{const X=be(L,"status","unknown"),z=be(L,"actor_id","-"),J=be(L,"role","-"),Y=be(L,"reason",""),ae=be(L,"action_type",""),U=be(L,"reply","");return o`
  ...
  `}function Dy(){const e=q.value.tab,t=vi.find(s=>s.id===e),n=sl.find(s=>s.id===(t==null?void 0:t.group));return o`
  ...
  `}function Oy(){switch(q.value.tab){case"mission":return o`<${Cr} />`;case"proof":return o`<${og} />`;case"execution":return o`<${sh} />`;case"tools":return o`<${dh} />`;case"live":return o`<${Ry} />`;case"memory":return o`<${K$} />`;case"governance":return o`<${Oh} />`;case"planning":return o`<${Ch} />`;case"intervene":return o`<${z$} />`;case"command":return o`<${C$} />`;case"lab":return o`<${_y} />`;default:return o`<${Cr} />`}}function qy(){return Bo.value&&!dt.value?o`<div class="loading-indicator">대시보드 불러오는 중...</div>`:o`<${Oy} />`}function wy(){oe(()=>{Md(),ul(),Ul(),It(),Tt(),Kl(),ac();const n=$m();return hm(),()=>{Fd(),n(),ym()}},[]),oe(()=>{const n=setInterval(()=>{ti(q.value.tab)},15e3);return()=>{clearInterval(n)}},[]),oe(()=>{ti(q.value.tab)},[q.value.tab]);const e=q.value.tab,t=vi.find(n=>n.id===e);return o`
    <div class="app-shell">
