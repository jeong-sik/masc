...
(** Detect transient network errors eligible for retry.
    Uses structured [Masc_agent_core.Error.sdk_error] pattern matching. *)
val is_transient_network_error : Masc_agent_core.Error.sdk_error -> bool
...
val is_transient_internal_runner_error : Masc_agent_core.Error.sdk_error -> bool
...
val is_server_rejected_parse_error : Masc_agent_core.Error.sdk_error -> bool

(** [true] for provider-side request-body parse rejections. *)
val is_provider_rejected_parse_error : Masc_agent_core.Error.sdk_error -> bool
...
val is_provider_wire_error : Masc_agent_core.Error.sdk_error -> bool

(** [true] for model/API-side request-body parse rejections reported as
    [InvalidRequest]. *)
val is_model_rejected_parse_error : Masc_agent_core.Error.sdk_error -> bool
...
val is_invalid_request_error : Masc_agent_core.Error.sdk_error -> bool
...
val is_empty_completion_error : Masc_agent_core.Error.sdk_error -> bool
...
val is_auto_recoverable_turn_error : Masc_agent_core.Error.sdk_error -> bool
...
val is_accept_no_usable_progress_error : Masc_agent_core.Error.sdk_error -> bool
...
val should_warn_keeper_cycle_failed : Masc_agent_core.Error.sdk_error -> bool
...
val is_context_overflow : Masc_agent_core.Error.sdk_error -> bool
...
val is_input_required_error : Masc_agent_core.Error.sdk_error -> bool
...
val is_runtime_exhausted_error : Masc_agent_core.Error.sdk_error -> bool
...
val recoverable_runtime_failure_reason :
  Masc_agent_core.Error.sdk_error -> degraded_retry_reason option
...
val is_receipt_lost_error : Masc_agent_core.Error.sdk_error -> bool
