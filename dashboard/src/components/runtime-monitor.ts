...
import {
  runtimeCatalogDeclaredSpec as runtimeDeclaredSpecText,
  runtimeCatalogEffectiveCapabilities as runtimeEffectiveCapabilitiesText,
  runtimeCatalogParameterPolicy as runtimeParameterPolicyText,
...
function runtimeParameterDetailRows(
  ...
  return [
    ...
    detailRow('request', 'seed', settingText(request?.seed)),
    ...
    detailRow('declared provider', 'Exact timeout (s)', settingText(spec?.provider?.exact_body_timeout_s)),
