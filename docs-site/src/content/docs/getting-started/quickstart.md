...
are required. This guide targets **0.42.0**. Check publication on
...
## First conversation with `imp` (0.42.0)

This is the 0.42.0 installation contract. Check the release tag and asset
