...
OAS pin metadata is generated from `scripts/oas-agent-sdk-pin.sh`. Current dependency floor: `agent_sdk >= 0.206.12.1`, runtime pin: `masc-pin-timeout-2099@6c38c0761ac2a55283dd48bc151416cbc3a334cb`, declared base version: `v0.206.12.1`. 최신성 검증이 필요할 때는 문서에 적힌 숫자보다 `dune-project`와 pin script를 우선 truth source로 본다.
