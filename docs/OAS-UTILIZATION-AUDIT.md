...
OAS Pin Snapshot: dependency floor `0.153.0`, runtime pin `main@485ac29af8c14942e29c99381a9946c7000a55c9`, declared base version `v0.153.0`
...
`masc-mcp` keeps the runtime pin ratcheted against upstream `main`, while the dependency floor tracks the pinned SDK declaration in `agent_sdk.opam`. Generated snapshot: runtime pin `main@485ac29af8c14942e29c99381a9946c7000a55c9`, declared base version `v0.153.0`, dependency floor `0.153.0`.
