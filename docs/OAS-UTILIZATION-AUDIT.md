...
OAS Pin Snapshot: dependency floor `0.137.0`, runtime pin `main@86a247150cbc5372d157f8a52d52efaacc2ec0ff`, declared base version `v0.137.0`
...
`masc-mcp` keeps the runtime pin ratcheted against upstream `main`, while the dependency floor tracks the pinned SDK declaration in `agent_sdk.opam`. Generated snapshot: runtime pin `main@86a247150cbc5372d157f8a52d52efaacc2ec0ff`, declared base version `v0.137.0`, dependency floor `0.137.0`.
