...
| 0073 | OAS Telemetry Envelope Context & Stream Lifecycle Aggregation | Draft | (this PR) 2026-05-14 | Track A/B/C phased — related RFC-0046, RFC-0049, RFC-0063 |

### 사용 가능한 다음 번호

- 누락 번호 (이전 사용 후 해제됨): 0010, 0011, 0014, 0015, 0016, 0021, 0060.
- 다음 신규: **0074** (현재 가장 작은 사용 가능 번호는 0010 이지만, 누락 번호 재사용은 race-condition 위험 — 새 작성은 0074 이후 권장).
