...
(* RFC-0072 Phase 4: GADT-encoded turn_phase transitions, aligned with
   ...
   cross-state transitions of the 7-variant [turn_phase] FSM.  The 28
...
(* RFC-0072 Phase 4: typed error for turn_phase transition spec violations.
   Each of the 28 forbidden pairs has its own constructor; mirrors the
...
let resolve_turn_phase_transition
  ...
  (* Valid cross-state transitions (14). *)
  ...
  | Packed Turn_routing, Packed Turn_prompting ->
    Resolved_turn_violation Routing_to_prompting
  ...
  | Packed Turn_executing, Packed Turn_prompting ->
    Resolved_turn_violation Executing_to_prompting
  ...
  | Packed Turn_compacting, Packed Turn_prompting ->
    Resolved_turn_violation Compacting_to_prompting
  ...
  | Packed Turn_finalizing, Packed Turn_prompting ->
    Resolved_turn_violation Finalizing_to_prompting
  | Packed Turn_finalizing, Packed Turn_routing ->
    Resolved_turn_violation Finalizing_to_routing
  | Packed Turn_finalizing, Packed Turn_executing ->
    Resolved_turn_violation Finalizing_to_executing
  ...
  | Packed Turn_exhausted, Packed Turn_prompting ->
    Resolved_turn_violation Exhausted_to_prompting
  | Packed Turn_exhausted, Packed Turn_routing ->
    Resolved_turn_violation Exhausted_to_routing
  | Packed Turn_exhausted, Packed Turn_executing ->
    Resolved_turn_violation Exhausted_to_executing
