...
- Prompt Book full-text/치환 뷰 (주입 스냅샷 API), keeper effort 세그 mutation, keeper 편집, 알림 엔진 wiring, 압축 3열 diff, 컴팩션 임계치 (raw TOML 외 scalar patch 경로 없음 — UX상 전용 patch 권장).
