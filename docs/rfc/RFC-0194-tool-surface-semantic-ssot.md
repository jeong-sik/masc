...
`masc` 의 tool surface (Keeper ~38 + Masc ~80+, 총 ~170 `Tool_name` variants) 가 *3개 독립 non-SSOT 메커니즘* 으로 semantic 의미를 누설 중이며, 각 메커니즘이 fleet-observable 실패 모드를 산출:
...
| RFC-0193 | §1 (typed SSOT, substring sunset) | [Issue #19032](https://github.com/jeong-sik/masc/issues/19032) — body update 예정 |
