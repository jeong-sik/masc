...
module Provider_logs = Server_routes_http_routes_dashboard_provider_logs
...
let dashboard_provider_logs_json = Provider_logs.dashboard_provider_logs_json

let dashboard_provider_log_tail_json =
  Provider_logs.dashboard_provider_log_tail_json
