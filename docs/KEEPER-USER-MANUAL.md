...
OAS pin metadata is generated from `scripts/oas-agent-sdk-pin.sh`. Current dependency floor: `agent_sdk >= 0.207.20`, runtime pin: `fix/oas-glm-tool-choice-typed-boundary-20260629@a08f043fa77e454adb401ad465e0665abd1cf85a`, declared base version: `v0.207.20`. 최신성 검증이 필요할 때는 문서에 적힌 숫자보다 `dune-project`와 pin script를 우선 truth source로 본다.
