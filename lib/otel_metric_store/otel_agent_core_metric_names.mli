...
val metric_agent_core_bridge_timeout : string
...
val metric_agent_core_sse_relay_queue_depth : string
...
(** Histogram populated from AGENT_CORE [InferenceTelemetry.prompt_ms] and
    [prompt_tokens]. Labels: [model_bucket] only. *)
val metric_agent_core_inference_prompt_tok_per_sec : string

(** Histogram populated from AGENT_CORE [InferenceTelemetry.decode_tok_s] or
    [decode_ms] plus [completion_tokens]. Labels: [model_bucket] only. *)
val metric_agent_core_inference_decode_tok_per_sec : string

(** Histogram populated from [AgentCompleted] [usage.cost_usd].
    Labels: [provider] and [model_bucket]. *)
val metric_agent_core_inference_cost_usd : string
