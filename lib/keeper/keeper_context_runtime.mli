...
val usage_of_response : Masc_agent_core.Types.api_response -> Masc_agent_core.Types.api_usage
...
val save_oas_checkpoint
  ...
  -> ctx:working_context
  -> generation:int
  -> (Masc_agent_core.Checkpoint.t, string Keeper_context_core.checkpoint_write_error) result
