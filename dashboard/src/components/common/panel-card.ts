...
export function PanelCard({ title, children }: PanelCardProps) {
  return html`
    <div class="p-5 rounded-[var(--r-1)] border border-card-border bg-card/40 backdrop-blur-sm shadow-sm transition-[border-color,box-shadow] duration-[var(--t-med)] hover:border-accent/30 hover:shadow-sm">
