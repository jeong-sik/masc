...
OAS Pin Snapshot: dependency floor `0.150.0`, runtime pin `main@5b86c03d0c1ec96d5f5633e614bc7257eabe08fd`, declared base version `v0.150.0`
...
`masc-mcp` keeps the runtime pin ratcheted against upstream `main`, while the dependency floor tracks the pinned SDK declaration in `agent_sdk.opam`. Generated snapshot: runtime pin `main@5b86c03d0c1ec96d5f5633e614bc7257eabe08fd`, declared base version `v0.150.0`, dependency floor `0.150.0`.
