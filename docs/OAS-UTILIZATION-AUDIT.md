...
OAS Pin Snapshot: dependency floor `0.122.1`, runtime pin `main@655a7222c4bcab0b4a2f3d17b2e449e4a75dcc92`, declared base version `v0.122.1`
...
`masc-mcp` keeps the runtime pin ratcheted against upstream `main`, while the dependency floor tracks the pinned SDK declaration in `agent_sdk.opam`. Generated snapshot: runtime pin `main@655a7222c4bcab0b4a2f3d17b2e449e4a75dcc92`, declared base version `v0.122.1`, dependency floor `0.122.1`.
