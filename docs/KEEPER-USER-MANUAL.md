...
OAS pin metadata is generated from `scripts/oas-agent-sdk-pin.sh`. Current dependency floor: `agent_sdk >= 0.170.2`, runtime pin: `fix/pipeline-message-constructor@5a20cae08e0f726fb057b6ed83c0a073b953d749`, declared base version: `v0.170.2`. 최신성 검증이 필요할 때는 문서에 적힌 숫자보다 `dune-project`와 pin script를 우선 truth source로 본다.
