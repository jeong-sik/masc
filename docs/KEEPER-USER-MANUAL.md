...
OAS pin metadata is generated from `scripts/oas-agent-sdk-pin.sh`. Current dependency floor: `agent_sdk >= 0.187.5`, runtime pin: `codex/timeout-containment-oas@21ed9d720ffbbe5f51edff46c7d7d999037495c5`, declared base version: `v0.187.5`. 최신성 검증이 필요할 때는 문서에 적힌 숫자보다 `dune-project`와 pin script를 우선 truth source로 본다.
