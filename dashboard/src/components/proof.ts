...
export function Proof() {
  ...
  const liveVerdict = summary?.live_verdict ?? snapshot?.proof_verdict ?? verdict
        ...
        <${Card} title="협업 타임라인" class="mission-list-card" semanticId="proof.timeline">
          ...
          <div class="mission-list-stack">
            ${dedupedTimeline.length > 0
              ...
              : html`<div class="empty-state">표시할 타임라인 근거가 없습니다.</div>`}
          </div>
        <//>
        ...
        <${Card} title="참여 흔적" class="mission-list-card" semanticId="proof.contributions">
          ...
          <div class="mission-activity-list">
            ${contributions.length > 0
              ...
              : html`<div class="empty-state">표시할 참여 흔적이 없습니다.</div>`}
          </div>
        <//>
      </div>
