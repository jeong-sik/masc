...
|---|---|---|---|---|
| 0001 | Det/NonDet Boundary Hardening, Emotional Recovery Loop, and Adversarial Harness | Draft | b032761803 2026-07-10 | - |
| 0002 | Keeper 11-State Machine + Det/NonDet Boundary Formalization | reference | b032761803 2026-07-10 | - |
| 0003 | Keeper Composite Lifecycle Observer | reference | b032761803 2026-07-10 | - |
...
| 0027 | Retired tension and meta-cognition draft | Superseded | 523367a9a6 2026-07-10 | - |
...
| 0038 | Runtime Routing Intent Preservation | Draft | b032761803 2026-07-10 | RFC-0038-phase-2-keeper-identity-canonical.md |
...
| 0094 | Compact cooldown semantics split decision record | Superseded | 523367a9a6 2026-07-10 | - |
...
| 0098 | Typed JSON-RPC error envelope & production-code silent-failure lint | Implemented | b032761803 2026-07-10 | - |
...
| 0111 | Goal mint atomicity — auto-goal uniqueness invariant at write boundary | Implemented | b032761803 2026-07-10 | - |
| 0112 | Typed JSON parse boundary — eliminate silent-drop fallback across read sites | Implemented | 03d5feaf25 2026-07-08 | - |
| 0113 | KeeperReactionLiveness L1–L5 runtime — phased OCaml mirror of TLA+ design ground | Implemented | b032761803 2026-07-10 | - |
...
| 0134 | Persistence read-drop root fix (recovery story for RFC-0044) | Active | b032761803 2026-07-10 | - |
| 0135 | Dashboard Keeper Operational Surface — Typed SSOT | Implemented | b032761803 2026-07-10 | - |
...
| 0147 | Keeper Agent Run — Stage Decomposition of run_turn Step 8 | Draft | b032761803 2026-07-10 | - |
...
| 0150 | Keeper Attention Signal — backend 단일 typed wire envelope | Implemented | b032761803 2026-07-10 | - |
...
| 0199 | Evidence-Driven Auto-Approval for Deterministic Verification Tasks | Draft | b032761803 2026-07-10 | - |
...
| 0233 | Typed turn observability: TurnRecord prompt-block provenance + canonical tool... | Draft | b032761803 2026-07-10 | - |
...
| 0237 | Eliminate the write_meta ~force escape hatch (route snapshot writes through C... | Draft | b032761803 2026-07-10 | - |
| 0239 | Semantic-identity guards for keeper memory and anti-thrash | Draft | b032761803 2026-07-10 | - |
...
| 0242 | Retired continuity prose-filter draft | Superseded | 523367a9a6 2026-07-10 | - |
...
| 0248 | Announce-as-data — typed observation provenance for board activity | Draft | b032761803 2026-07-10 | - |
...
| 0257 | Per-keeper memory execution lane | Draft | b032761803 2026-07-10 | - |
...
| 0273 | Dashboard-driven keeper config & runtime persistence | Draft | b032761803 2026-07-10 | - |
| 0274 | Workspace base_path SSOT — retire env runtime read, thread Workspace.config | Draft | 03d5feaf25 2026-07-08 | - |
| 0275 | Retired cognitive-triple removal record | Implemented | 523367a9a6 2026-07-10 | - |
| 0276 | Remove Keeper social-model self-report protocol | Implemented | 523367a9a6 2026-07-10 | - |
...
| 0282 | Reduce Keeper persona to ordinary instructions | Implemented | 523367a9a6 2026-07-10 | - |
| 0283 | Fusion: judge-of-judges 위상 (flat/staged reducer) | Draft | 03d5feaf25 2026-07-08 | - |
| 0284 | Keeper Guidance Visibility-Leg Drift Guard | Draft | a5435ddc2f 2026-07-10 | - |
| 0285 | Memory OS — Self-Observation Claim Volatility (closing RFC-0259's internal-st... | Draft | b032761803 2026-07-10 | - |
...
| 0288 | Remove per-Keeper goal-horizon fields | Implemented | 523367a9a6 2026-07-10 | - |
...
| 0294 | Remove workspace Goal horizon | Implemented | 523367a9a6 2026-07-10 | - |
...
| 0297 | Keeper lifecycle gate consistency & observability | Draft | b032761803 2026-07-10 | - |
...
| 0310 | Goal convergence loop — typed metric contract, LLM evaluator boundary, audite... | Draft | b032761803 2026-07-10 | - |
...
| 0315 | Typed wake-turn context and self-directed work lane | Active | 523367a9a6 2026-07-10 | - |
...
| 0320 | Keeper connector-aware continuation: carry the originating channel through wa... | Draft | b032761803 2026-07-10 | - |
| 0321 | hard_forbidden 거부 위장(is_error=false) — agent_sdk `Block` variant | Draft | b032761803 2026-07-10 | - |
...
| 0328 | Keeper perseveration: grounding-gated memory promotion, active residue purge,... | Draft | b032761803 2026-07-10 | - |
...
| 0332 | Rejected heuristic memory write dedup draft | Rejected | 523367a9a6 2026-07-10 | - |
