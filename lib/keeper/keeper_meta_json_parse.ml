...
(* Removed-field scrub helpers (formerly Keeper_meta_json_scrub, deleted
   by PR #18021). Inlined here because [parse] is the sole internal
   consumer and the public surface flows through
   [Keeper_meta_json]'s [include] of this module. *)
