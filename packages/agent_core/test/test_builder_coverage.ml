...
(* ── Agent.agent_core_version ────────────────────────────────────── *)

let test_agent_core_version () =
  let v = Agent.agent_core_version in
  ...
  Alcotest.run
    ...
    ; ( "agent_accessors"
      , [ Alcotest.test_case "state/tools/context/desc" `Quick test_agent_accessors
        ...
        ; Alcotest.test_case "agent_core_version" `Quick test_agent_core_version
