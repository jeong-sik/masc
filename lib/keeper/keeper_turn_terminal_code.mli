...
type t =
  ...
  | Turn_overflow_pause
  (** [Keeper_registry.Turn_overflow_pause]: keeper paused after unresolved
      context-overflow compact-retry exhaustion. *)
  | Turn_livelock_pause
  (** [Keeper_registry.Turn_livelock_pause]: keeper paused by the turn
      livelock guard. *)
