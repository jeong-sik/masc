...
OAS pin metadata is generated from `scripts/oas-agent-sdk-pin.sh`. Current dependency floor: `agent_sdk >= 0.156.0`, runtime pin: `fix/oas-cli-noninteractive@82c4f9d9efd05134c80d6910b39a74076c88eec3`, declared base version: `v0.156.0`. 최신성 검증이 필요할 때는 문서에 적힌 숫자보다 `dune-project`와 pin script를 우선 truth source로 본다.
