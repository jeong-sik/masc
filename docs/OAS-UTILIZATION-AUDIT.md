...
OAS Pin Snapshot: dependency floor `0.122.1`, runtime pin `main@d062e4aa434f4a3036119c19db47fe4eab5c0e15`, declared base version `v0.122.1`
...
`masc-mcp` keeps the runtime pin ratcheted against upstream `main`, while the dependency floor tracks the pinned SDK declaration in `agent_sdk.opam`. Generated snapshot: runtime pin `main@d062e4aa434f4a3036119c19db47fe4eab5c0e15`, declared base version `v0.122.1`, dependency floor `0.122.1`.
