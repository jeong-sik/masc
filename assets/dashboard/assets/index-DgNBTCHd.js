...
`))}</p>`)}return n}function Ri(t){const e=[],n=/(`[^`]+`)|(\*\*[^*]+\*\*)|(\*[^*]+\*)|\[([^\]]+)\]\(([^)]+)\)/g;let s=0,a;for(;(a=n.exec(t))!==null;){if(a.index>s&&e.push(t.slice(s,a.index)),a[1]){const o=a[1].slice(1,-1);e.push(i`<code>${o}</code>`)}else if(a[2]){const o=a[2].slice(2,-2);e.push(i`<strong>${o}</strong>`)}else if(a[3]){const o=a[3].slice(1,-1);e.push(i`<em>${o}</em>`)}else a[4]&&a[5]&&e.push(i`<a href=${a[5]} target="_blank" rel="noopener">${a[4]}</a>`);s=a.index+a[0].length}return s<t.length&&e.push(t.slice(s)),e.length>0?e:[t]}const uu=[{id:"recent",label:"최신순"},{id:"hot",label:"인기순"},{id:"trending",label:"급상승"},{id:"updated",label:"최근 갱신"},{id:"discussed",label:"토론 많은 순"}],ca=g(null),da=g([]),yn=g(!1),je=g(null),Fn=g(""),Kn=g(!1),sn=g(!0),yr=20,Je=g(yr);function Iy(){var e,n;const t=new URLSearchParams(window.location.search);return((e=t.get("agent"))==null?void 0:e.trim())||((n=t.get("agent_name"))==null?void 0:n.trim())||"dashboard-user"}const Ry=g(Iy());function My(t){const e=t.replace(/!\[[^\]]*\]\([^)]+\)/g," ").replace(/\[[^\]]+\]\([^)]+\)/g,"$1").replace(/[`#>*_~-]/g," ").replace(/\s+/g," ").trim();return e?e.length>180?`${e.slice(0,177)}...`:e:"미리보기 없음"}function Bl(t){return t.updated_at!==t.created_at}function Ly(t){if(t.post_kind)return t.post_kind==="automation";const e=(t.hearth??"").toLowerCase();return t.visibility!=="internal"||!t.expires_at||!e?!1:!!(e.startsWith("mdal")||e.includes("harness"))}function Ey(t){return t==="lodge-system"||t==="team-session"}function us(t){return t.post_kind?t.post_kind:Ey(t.author)?"system":Ly(t)?"automation":"human"}function pu(t){const e=[],n=[];let s=0;return t.forEach(a=>{const o=us(a);if(!(o==="system"&&Me.value)){if(o==="automation"&&sn.value){s+=1;return}if(o==="human"){e.push(a);return}n.push(a)}}),{human:e,operations:n,hiddenAutomation:s}}function Py(t){if(!t.expires_at)return null;const e=Date.parse(t.expires_at);return Number.isFinite(e)?e<=Date.now()?i`<span class="board-meta-chip">만료됨</span>`:i`<span class="board-meta-chip">만료까지 <${X} timestamp=${t.expires_at} /></span>`:null}async function br(t){je.value=t,ca.value=null,da.value=[],yn.value=!0;try{const e=await Jp(t);if(je.value!==t)return;ca.value={id:e.id,author:e.author,title:e.title,body:e.body,content:e.content,meta:e.meta,tags:e.tags,votes:e.votes,vote_balance:e.vote_balance,comment_count:e.comment_count,created_at:e.created_at,updated_at:e.updated_at,post_kind:e.post_kind,flair:e.flair,hearth:e.hearth,visibility:e.visibility,expires_at:e.expires_at,hearth_count:e.hearth_count},da.value=e.comments??[]}catch{je.value===t&&(ca.value=null,da.value=[])}finally{je.value===t&&(yn.value=!1)}}async function Ul(t){const e=Fn.value.trim();if(e){Kn.value=!0;try{await Vp(t,Ry.value,e),Fn.value="",j("댓글을 등록했습니다","success"),await br(t),me()}catch{j("댓글 등록에 실패했습니다","error")}finally{Kn.value=!1}}}function zy(){const t=Vn.value,e=sn.value?"자동화 글 숨김":"자동화 글 표시 중";return i`
  ...
  `}function Yy({item:t,selected:e}){return i`
    <button
  ...
  `}function Xy({brief:t,selected:e}){const n=t.active_count??0,s=t.seen_count??n,a=t.planned_count??t.member_names.length;return i`
    <button
      class="mission-card-select ${e?"active":""}"
  ...
  `}function Qy({brief:t,selected:e}){return i`
    <button
      class="mission-card-select ${e?"active":""}"
  ...
  `:i`<div class="empty-state">최근 lodge tick 기록이 없습니다.</div>`}function tb({row:t}){return i`
    <button
    ...
    >
      <div class="monitor-row-header">
        ...
        <span class="monitor-pill ${ps(t.outcome==="failed"?"bad":t.outcome==="skipped"?"warn":"ok")}">${Jy(t.outcome)}</span>
      </div>
      <div class="monitor-meta">
        <span>trigger · ${t.trigger??"unknown"}</span>
        ${t.checked_at?i`<span><${X} timestamp=${t.checked_at} /></span>`:null}
        <span>action · ${Vy(t.action_kind)}</span>
      </div>
  ...
  `}function Jl({row:t,testId:e}){return i`
    <button class="monitor-row ${t.tone} state-${t.state}" data-testid=${e} onClick=${()=>As(t.name)}>
      ...
      <div class="monitor-meta">
        ...
        <span>${Hy(t.signal_truth)} · ${Wy(t.evidence_source)}</span>
    ...
    <div class="agents-monitor">
      ...
      >
        ...
        <div class="monitor-alert-list">
          ${t.length===0?i`<div class="empty-state">지금은 막힌 실행이 없습니다.</div>`:t.map($=>i`<${Yy} key=${$.id} item=${$} selected=${Ie.value===$.id} />`)}
        </div>
      <//>
      ...
      <div class="agents-workbench">
        ...
        >
          ...
          <div class="monitor-list">
            ${v.length===0?i`<div class="empty-state">선택된 실행과 연결된 세션이 없습니다.</div>`:v.map($=>i`<${Xy} key=${$.session_id} brief=${$} selected=${Xt.value===$.session_id} />`)}
          </div>
        <//>
        ...
        >
          ...
          <div class="monitor-list">
            ${f.length===0?i`<div class="empty-state">선택된 실행과 연결된 작전이 없습니다.</div>`:f.map($=>i`<${Qy} key=${$.operation_id} brief=${$} selected=${Qt.value===$.operation_id} />`)}
          </div>
        <//>
        ...
        >
          ...
          <${Zy} tick=${a} />
          <div class="monitor-list">
            ${k.length===0?i`<div class="empty-state">최근 lodge check-in 기록이 없습니다.</div>`:k.map($=>i`<${tb} key=${`${$.agent_name}-${$.checked_at??$.outcome}`} row=${$} />`)}
          </div>
        <//>
        ...
        >
          ...
          <div class="monitor-list">
            ${T.length===0?i`<div class="empty-state">지금은 연속성 경고가 없습니다.</div>`:T.map($=>i`<${eb} key=${$.name} row=${$} />`)}
          </div>
        <//>
  ...
  `}const Ao=g(null),To=g(null),Bn=g(!1);async function Vl(){if(!Bn.value){Bn.value=!0,To.value=null;try{Ao.value=await Cp()}catch(t){To.value=t instanceof Error?t.message:String(t)}finally{Bn.value=!1}}}function sb(t){switch(t){case"essential":return"badge-essential";case"standard":return"badge-standard";default:return"badge-full"}}function ab({items:t,maxCount:e}){return t.length===0?i`<p class="muted">No tool calls recorded yet.</p>`:i`
    <div class="tool-bar-chart">
      ${t.map(n=>{const s=e>0?n.call_count/e*100:0;return i`
          <div class="tool-bar-row" key=${n.name}>
            ...
            <span class="tool-bar-tier ${sb(n.tier)}">${n.tier}</span>
  ...
  `}function ob(){const t=Ao.value,e=Bn.value,n=To.value;return et(()=>{!Ao.value&&!Bn.value&&Vl()},[]),i`
  ...
  `}function cb(){const t=Io.value,e=Un.value,n=Ro.value,s=(t==null?void 0:t.tool_inventory.tools)??[],a=(t==null?void 0:t.tool_usage)??null;et(()=>{!Io.value&&!Un.value&&Yl()},[]),et(()=>{var h;if(D.value.tab!=="tools")return;const f=(h=D.value.params.q)==null?void 0:h.trim();f&&f!==Ln.value&&(Ln.value=f)},[D.value.tab,D.value.params.q]);const o=Array.from(new Set(s.map(f=>f.category))).sort((f,h)=>f.localeCompare(h)),l=s.filter(f=>!(!rb(f,Ln.value)||Us.value!=="all"&&f.category!==Us.value||Li.value&&!f.enabled_in_current_mode||Ei.value&&!f.direct_call_allowed||!Pi.value&&f.visibility==="hidden"||!zi.value&&f.lifecycle==="deprecated")),c=s.length,d=s.filter(f=>f.enabled_in_current_mode).length,p=s.filter(f=>f.visibility==="hidden").length,_=s.filter(f=>f.lifecycle==="deprecated").length,v=s.filter(f=>f.direct_call_allowed).length;return i`
    <div>
      <${M} title="System Tool Inventory" class="section">
        ...
        <div class="tool-inventory-list">
          ${l.length>0?l.map(f=>i`<${lb} key=${f.name} item=${f} />`):i`<div class="empty-state">No tools matched the current filters.</div>`}
        </div>
      <//>
  ...
  `}const Wa=g("all"),Ga=g("all"),Mo=g(new Set);function db(t){const e=new Set(Mo.value);e.has(t)?e.delete(t):e.add(t),Mo.value=e}const mu=Nt(()=>{let t=rn.value;return Wa.value!=="all"&&(t=t.filter(e=>e.horizon===Wa.value)),Ga.value!=="all"&&(t=t.filter(e=>e.status===Ga.value)),t}),ub=Nt(()=>{const t={short:[],mid:[],long:[]};for(const e of mu.value){const n=t[e.horizon];n&&n.push(e)}return t}),pb=Nt(()=>{const t=Array.from(jc.value.values());return t.sort((e,n)=>e.status==="running"&&n.status!=="running"?-1:n.status==="running"&&e.status!=="running"?1:e.status==="interrupted"&&n.status!=="interrupted"?-1:n.status==="interrupted"&&e.status!=="interrupted"?1:n.elapsed_seconds-e.elapsed_seconds),t});function mb(t){return"★".repeat(Math.min(t,5))+"☆".repeat(Math.max(0,5-t))}function xr(t){switch(t){case"short":return"단기";case"mid":return"중기";case"long":return"장기";default:return t}}function ua(t){switch(t){case"short":return"#4ade80";case"mid":return"#f59e0b";case"long":return"#818cf8";default:return"#888"}}function _b(t){return t<60?`${Math.round(t)}s`:t<3600?`${Math.floor(t/60)}m ${Math.round(t%60)}s`:`${Math.floor(t/3600)}h ${Math.floor(t%3600/60)}m`}function Xl(t){return t.toFixed(4)}function Ql(t){const e=t.current_metric-t.baseline_metric;return`${e>=0?"+":""}${e.toFixed(4)}`}function vb(t){switch(t){case 1:return"P1";case 2:return"P2";case 3:return"P3";default:return"P4"}}function fb(t){switch(t){case"active":return"진행 중";case"completed":return"완료";case"paused":return"일시정지";default:return"전체"}}function Zl(t,e){return(t.priority??4)-(e.priority??4)}function gb(t,e){const n=t.updated_at??t.created_at??"";return(e.updated_at??e.created_at??"").localeCompare(n)}function $b(t,e){return t.length<=e?t:t.slice(0,e)+"..."}function hb({goal:t}){return i`
    <div class="goal-row">
      <div class="goal-row-main">
        ...
        <div class="goal-meta">
          <span class="goal-priority" title="Priority ${t.priority}">${mb(t.priority)}</span>
  ...
  `}function bb(){const t=rn.value,e=t.filter(a=>a.status==="active").length,n=t.filter(a=>a.status==="completed").length,s={short:0,mid:0,long:0};for(const a of t)a.horizon in s&&s[a.horizon]++;return i`
  ...
  `}function kb({loop:t}){const e=t.history[0],n=t.latest_tool_names&&t.latest_tool_names.length>0?`${t.latest_tool_call_count??t.latest_tool_names.length}개 도구: ${t.latest_tool_names.join(", ")}`:"아직 근거 없음";return i`
    <div class="planning-loop-row">
      <div class="planning-loop-main">
        ...
        <div class="planning-loop-metrics">
          ...
          <span>Elapsed ${_b(t.elapsed_seconds)}</span>
        </div>
  ...
  `}function ji({task:t}){const e=t.priority??4,n=e<=1?"p1":e===2?"p2":e===3?"p3":"p4",s=Mo.value.has(t.id),a=!!t.description;return i`
    <div class="kanban-card ${n}">
      <div class="kanban-card-header">
        <span class="priority-badge priority-badge--${n}">${vb(e)}</span>
      ...
      ${a?i`
        <div
          ...
          onClick=${()=>db(t.id)}
        >
          ${s?t.description:$b(t.description??"",80)}
        </div>
      `:null}
  ...
  `}function xb(){const{todo:t,inProgress:e,done:n}=Oc.value,s=[...t].sort(Zl),a=[...e].sort(Zl),o=[...n].sort(gb);return i`
  ...
  `}function Sb(){const{todo:t,inProgress:e,done:n}=Oc.value,s=t.length+e.length+n.length,a=[...t,...e].filter(_=>(_.priority??4)<=2).length,o=ub.value,l=pb.value,c=rn.value.length>0,d=l.length>0,p=Jo.value;return i`
    <div>
        ...
        <div>
          ${wn.value&&l.length===0?i`<div class="loading-indicator">MDAL 루프 불러오는 중...</div>`:l.length===0&&(p==="error"||ln.value)?i`<div class="empty-state">MDAL 스냅샷을 불러오지 못했습니다${ln.value?`: ${ln.value}`:""}. 백엔드 상태를 확인하세요.</div>`:l.length===0?i`<div class="empty-state">가동 중인 루프가 없습니다. <code>masc_mdal_start</code>로 시작할 수 있습니다.</div>`:i`
                  <div class="planning-loop-list">
                    ${l.map(_=>i`<${kb} key=${_.loop_id} loop=${_} />`)}
                  </div>
                `}
        </div>
      </details>
    </div>
  `}const Ja=g(!1),Hn=g(!1),an=g(!1),Va=g(!1),se=g(""),Wn=g(""),Gn=g(""),Lo=g("support"),Eo=g("open"),bn=g(null),_s=g(null),vs=g(null),Po=g(!1);function fs(t){return`${t.kind}:${t.id}`}function ci(){var n;const t=_s.value,e=((n=bn.value)==null?void 0:n.items)??[];return t?e.find(s=>fs(s)===t)??null:null}function Cb(t){const e=t.trim().toLowerCase();return e!=="executed"&&e!=="blocked"&&e!=="closed"}function _u(t){switch(Eo.value){case"pending_ruling":return t.filter(e=>e.status==="pending_ruling");case"needs_human_gate":return t.filter(e=>e.status==="needs_human_gate");case"executed":return t.filter(e=>e.status==="executed");case"blocked":return t.filter(e=>e.status==="blocked"||e.status==="closed");case"open":default:return t.filter(e=>Cb(e.status))}}function Ab(t){if(t==null)return"없음";if(typeof t=="string")return t;try{return JSON.stringify(t,null,2)}catch{return String(t)}}function Sr(t){const e=(t||"").toLowerCase();return e.includes("block")||e.includes("deny")||e.includes("closed")?"negative":e.includes("support")||e.includes("approve")||e.includes("ready")||e.includes("executed")||e.includes("done")?"positive":"neutral"}function Tb(t){return typeof t!="number"||Number.isNaN(t)?"판정 대기":`${Math.round(t*100)}%`}async function vu(t){if(vs.value=null,!!t){Po.value=!0,se.value="";try{vs.value=await xc(t.id)}catch(e){se.value=e instanceof Error?e.message:"거버넌스 상세를 불러오지 못했습니다"}finally{Po.value=!1}}}async function Ib(t){_s.value=fs(t),await vu(t)}async function Fe(){Ja.value=!0,se.value="";try{const t=await $p();bn.value=t;const e=_u(t.items??[]),n=_s.value,s=e.find(a=>fs(a)===n)??e[0]??null;_s.value=s?fs(s):null,await vu(s)}catch(t){se.value=t instanceof Error?t.message:"거버넌스 상태를 불러오지 못했습니다"}finally{Ja.value=!1}}K_(Fe);async function tc(){const t=Wn.value.trim();if(t){Hn.value=!0;try{const e=await bm(t);Wn.value="",j(e!=null&&e.case.id?`청원을 접수했습니다: ${e.case.id}`:"청원을 접수했습니다","success"),await Fe()}catch(e){const n=e instanceof Error?e.message:"청원 접수에 실패했습니다";se.value=n,j(n,"error")}finally{Hn.value=!1}}}async function Rb(){const t=ci(),e=Gn.value.trim();if(!(!t||!e)){Va.value=!0;try{const n=await km(t.id,Lo.value,e);Gn.value="",vs.value=n,j("심의 의견을 기록했습니다","success"),await Fe()}catch(n){const s=n instanceof Error?n.message:"심의 기록에 실패했습니다";se.value=s,j(s,"error")}finally{Va.value=!1}}}async function ec(t){const e=ci();if(e){an.value=!0;try{await xm(e.id,t),j(t==="confirm"?"집행을 승인했습니다":"집행을 거부했습니다","success"),await Fe()}catch(n){const s=n instanceof Error?n.message:"집행 결정을 처리하지 못했습니다";se.value=s,j(s,"error")}finally{an.value=!1}}}function Mb(){var e,n,s;const t=(e=bn.value)==null?void 0:e.summary;return i`
    <div class="board-summary-strip">
      <div class="board-summary-item">
  ...
  `}function Eb(){var e;const t=_u(((e=bn.value)==null?void 0:e.items)??[]);return i`
  ...
  `}function Pb({petition:t}){return i`
  ...
  `}function Nb(){var a;const t=ci(),e=vs.value,n=(e==null?void 0:e.petitions)??[],s=(e==null?void 0:e.case.briefs)??[];return i`
    <${M}
    ...
    >
      ${Po.value?i`<div class="loading-indicator">거버넌스 상세 불러오는 중...</div>`:!t||!e?i`<div class="empty-state">사건을 고르면 청원, 심의, 판정, 집행 기록을 볼 수 있습니다.</div>`:i`
              ...
              <div class="governance-ledger">
                ${n.length===0?i`<div class="empty-state">기록된 청원이 없습니다.</div>`:n.map(o=>i`<${Pb} key=${o.id} petition=${o} />`)}
              </div>
              <div class="governance-ledger">
                ${s.length===0?i`<div class="empty-state">심의 brief가 아직 없습니다.</div>`:s.map(o=>i`<${zb} key=${o.id} brief=${o} />`)}
              </div>
            `}
    <//>
  `}function jb({order:t}){if(!(t!=null&&t.action_request))return null;const e=t.action_request;return i`
    <div class="governance-side-block">
      ...
      ${e.payload_preview?i`<pre class="council-detail governance-preview">${Ab(e.payload_preview)}</pre>`:null}
  ...
  `}function wb(){const t=ci(),e=vs.value,n=e==null?void 0:e.ruling,s=e==null?void 0:e.execution_order;return i`
        ...
        ${!t||!e?i`<div class="empty-state">사건을 고르면 판정과 집행 경로가 보입니다.</div>`:i`
              <div class="governance-side-block">
                ...
                <div class="council-sub">
                  ...
                  <span>${Tb(n==null?void 0:n.confidence)}</span>
  ...
  `}function Ob(){var e;const t=(((e=bn.value)==null?void 0:e.activity)??[]).slice(0,8);return i`
  ...
  `}const Ve=g(""),wi=g("ability_check"),Oi=g("10"),Di=g("12"),Ws=g(""),Gs=g("idle"),le=g(""),Js=g("keeper-late"),qi=g("player"),Fi=g(""),Rt=g("idle"),Ki=g(null),Vs=g(""),Bi=g(""),Ui=g("player"),Hi=g(""),Wi=g(""),Gi=g(""),Jn=g("20"),Ji=g("20"),Vi=g(""),Ys=g("idle"),zo=g(null),fu=g("overview"),Yi=g("all"),Xi=g("all"),Qi=g("all"),qb=12e4,di=g(null),nc=g(Date.now());function Fb(t,e){const n=e>0?t/e*100:0;return n>50?"hp-high":n>25?"hp-mid":"hp-low"}function Kb(t,e){return e>0?Math.round(t/e*100):0}const Bb={pragmatic:"리스크보다 확실한 이득을 우선합니다.",frugal:"자원 소모를 줄이고 효율을 챙깁니다.",impatient:"짧은 템포로 즉시 압박을 선호합니다.",stubborn:"한 번 정한 전술을 끝까지 밀어붙입니다.",protective:"아군 피해를 줄이는 선택을 우선합니다.","honor-bound":"약속과 규율을 지키는 행동에 보너스가 납니다.",intense:"집중 화력을 짧게 폭발시킵니다.",empathetic:"아군/약자 보호 쪽 선택 확률이 높아집니다.",fatalistic:"위험을 감수하는 고배수 선택을 탑니다.",suspicious:"함정/매복 경계 행동을 우선합니다.",precise:"단일 목표를 정확히 노리는 경향입니다.",vengeful:"직전 위협 대상에게 강하게 반응합니다.",aggressive:"공격적인 전진 행동을 우선합니다.",opportunistic:"빈틈이 열리면 즉시 추격합니다."},Ub={supply_scan:"전장/자원 상태를 스캔해 약한 지점을 찾습니다.",ration_shift:"소모를 줄이고 지속 전투 능력을 확보합니다.",logistics_patch:"무너진 운영 라인을 빠르게 복구합니다.",frontline_shield:"전열에서 아군 피해를 흡수합니다.",oath_intercept:"핵심 타깃을 가로막아 위협을 차단합니다.",morale_anchor:"아군 안정도를 높여 붕괴를 막습니다.",omen_trace:"다음 위험 신호를 먼저 감지합니다.",arc_flash:"짧은 순간 광역 압박을 넣습니다.",ward_bloom:"방어 장막을 펼쳐 생존률을 올립니다.",mark_prey:"우선 제거 대상을 지정합니다.",silent_route:"은밀한 진입 경로를 확보합니다.",finisher_strike:"약화된 적을 마무리하는 일격입니다.",shadow_claw:"근접 급습으로 출혈 피해를 노립니다.",lunge:"짧은 돌진으로 전열을 흔듭니다."};function Xs(t){const e=t.trim();return e?e.split(/[_-]+/g).filter(n=>n.length>0).map(n=>n[0]?`${n[0].toUpperCase()}${n.slice(1)}`:n).join(" "):t}function Hb(t){const e=t.trim().toLowerCase();return Bb[e]??"행동 선택 가중치에 영향을 주는 성향입니다."}function Wb(t){const e=t.trim().toLowerCase();return Ub[e]??"상황에 따라 선택되는 전술 액션입니다."}function St(t,e,n=""){const s=t[e];return typeof s=="string"?s:n}function Ot(t,e,n=0){const s=t[e];return typeof s=="number"&&Number.isFinite(s)?s:n}function gs(t,e,n=!1){const s=t[e];return typeof s=="boolean"?s:n}const Gb=new Set(["str","dex","con","int","wis","cha"]);function Jb(t){const e=t.trim();if(!e)return{};let n;try{n=JSON.parse(e)}catch(a){throw new Error(`능력치 JSON 파싱 실패: ${a instanceof Error?a.message:"invalid json"}`)}if(!m(n))throw new Error('능력치 JSON은 object여야 합니다. 예: {"luck":7}');const s={};return Object.entries(n).forEach(([a,o])=>{const l=a.trim();if(l){if(typeof o=="number"&&Number.isFinite(o)){s[l]=Math.max(0,Math.trunc(o));return}if(typeof o=="string"){const c=Number.parseFloat(o.trim());if(Number.isFinite(c)){s[l]=Math.max(0,Math.trunc(c));return}}throw new Error(`능력치 '${l}' 값은 숫자여야 합니다.`)}}),s}function Vb(t){const e=Number.parseInt(t.trim(),10);if(!Number.isFinite(e))return;const n=Math.max(1,e),s=Number.parseInt(Jn.value.trim(),10);Number.isFinite(s)&&s>n&&(Jn.value=String(n))}function No(t){const n=(t.actor_name??t.actor??t.actor_id??"system").trim();return n===""?"system":n}function Yb(t){var n;return(((n=t.timestamp)==null?void 0:n.trim())??"")||"-"}function Xb(t){fu.value=t}function gu(t){const e=di.value;return e==null||e<=t}function Qb(t){const e=di.value;return e==null||e<=t?0:Math.max(0,Math.ceil((e-t)/1e3))}function Ya(){di.value=null}function $u(t){return typeof window>"u"||typeof window.confirm!="function"?!0:window.confirm(t)}function Zb(t,e){$u(["관전 모드 잠금을 해제하시겠습니까?",`ROOM: ${t||"-"}`,`PHASE: ${e||"-"}`,"해제 시간: 120초 (시간 경과 또는 위험 액션 실행 후 자동 재잠금)"].join(`
`))&&(di.value=Date.now()+qb,j("조작 잠금이 120초 동안 해제되었습니다.","warning"))}function pa(t){return gu(t)?(j("관전 모드 잠금 상태입니다. 먼저 잠금을 해제하세요.","warning"),!1):!0}function jo(t,e,n){return $u([`[위험 액션 확인] ${t}`,`ROOM: ${e||"-"}`,`PHASE: ${n||"-"}`,"이 액션은 즉시 실행되며 되돌리기 어렵습니다.","계속 진행하시겠습니까?"].join(`
`))}function tk({hp:t,max:e}){const n=Kb(t,e),s=Fb(t,e);return i`
    <div class="trpg-hp-bar">
      <div class="hp-fill ${s}" style="width:${n}%" />
    </div>
  `}function ek({stats:t}){const e=[{label:"STR",value:t.strength},{label:"DEX",value:t.dexterity},{label:"CON",value:t.constitution},{label:"INT",value:t.intelligence},{label:"WIS",value:t.wisdom},{label:"CHA",value:t.charisma}];return i`
    <div class="trpg-actor-stats">
      ${e.map(n=>i`<span>${n.label} ${n.value}</span>`)}
    </div>
  `}function nk({keeper:t,role:e}){if(!t)return null;const n=e==="dm"?"dm":"player";return i`
    <span class="trpg-keeper-chip">
      <span class="trpg-keeper-tag ${n}">${n}</span>
      ${t}
    </span>
  `}function hu({actor:t}){var d,p,_,v;const e=(d=t.archetype)==null?void 0:d.trim(),n=(p=t.persona)==null?void 0:p.trim(),s=(_=t.portrait)==null?void 0:_.trim(),a=(v=t.background)==null?void 0:v.trim(),o=t.traits??[],l=t.skills??[],c=Object.entries(t.stats_raw??{}).filter(([f,h])=>Number.isFinite(h)).filter(([f])=>!Gb.has(f.toLowerCase()));return i`
  ...
  `}function sk({mapStr:t}){return i`<pre class="trpg-map">${t}</pre>`}function yu({events:t,emptyLabel:e="아직 이벤트가 없습니다."}){return t.length===0?i`<div class="empty-state" style="font-size:13px">${e}</div>`:i`
        ...
        <div class="trpg-control-grid">
          ...
          <div class="trpg-control-field">
            ...
            <input
              ...
              min="1"
              value=${Ji.value}
              onInput=${o=>{const l=o.target.value;Ji.value=l,Vb(l)}}
              placeholder="20"
            />
          </div>
  ...
  `}function ck({state:t,nowMs:e}){var l,c,d;const n=ee.value||((l=t.session)==null?void 0:l.room)||"",s=((c=t.current_round)==null?void 0:c.phase)??((d=t.session)==null?void 0:d.status)??"unknown",a=gu(e),o=Qb(e);return i`
    <${M} title="조작 안전 잠금" style="margin-bottom:16px;" semanticId="lab.trpg">
      <div class="trpg-control-lock ${a?"locked":"unlocked"}">
        ...
        <div style="display:flex; gap:8px; margin-top:10px; flex-wrap:wrap;">
          ${a?i`<button class="trpg-run-btn recommend" onClick=${()=>Zb(n,s)}>잠금 해제 (120초)</button>`:i`<button class="trpg-run-btn secondary" onClick=${()=>{Ya(),j("조작 잠금으로 전환했습니다.","success")}}>즉시 다시 잠금</button>`}
        </div>
      </div>
    <//>
  `}function dk({active:t}){return i`
  ...
  `}function uk({state:t}){const e=t.party??[],n=t.story_log??[];return i`
  ...
  `}function pk({state:t}){const e=t.story_log??[];return i`
    <div class="trpg-layout">
      <div>
  ...
  `}function mk({state:t,nowMs:e}){const n=t.party??[];return i`
    <div>
      <${ck} state=${t} nowMs=${e} />
      <div class="trpg-layout">
        <div>
  ...
  `}function _k(){var c,d,p,_,v;const t=Nc.value,e=po.value;if(et(()=>{if(typeof window>"u"||typeof window.setInterval!="function")return;const f=window.setInterval(()=>{nc.value=Date.now()},1e3);return()=>{window.clearInterval(f)}},[]),e&&!t)return i`<div class="loading-indicator">Loading TRPG state...</div>`;if(!t)return i`
      <div class="section">
        <h2>TRPG</h2>
    ...
    <div>
      ...
      ${o==="overview"?i`<${uk} state=${t} />`:o==="timeline"?i`<${pk} state=${t} />`:i`<${mk} state=${t} nowMs=${l} />`}
    </div>
  `}function vk(){return i`
    <div>
      <${At} surfaceId="lab" />
  ...
  `}const Xa=g(new Set(["broadcast","tasks","keepers","system"]));function fk(t){const e=new Set(Xa.value);e.has(t)?e.delete(t):e.add(t),Xa.value=e}const Cr=g(null);function Cu(t){Cr.value=t}function gk(t){return t.kind==="board"?"broadcast":t.kind==="tasks"?"tasks":t.kind==="keepers"?"keepers":"system"}const $k=Nt(()=>{const t=Xa.value;return _a.value.filter(e=>t.has(gk(e)))}),hk=12e4,yk=Nt(()=>{const t=Dc.value,e=Date.now();return Gt.value.map(n=>{const s=n.name.trim().toLowerCase(),a=t.get(s)??null;let o="idle";if(n.status==="active"||n.status==="busy"){const l=a==null?void 0:a.lastActivityAt;l?o=e-new Date(l).getTime()>hk?"stale":"working":o="working"}else(n.status==="offline"||n.status==="inactive")&&(o="stale");return{name:n.name,emoji:n.emoji??"",koreanName:n.koreanName??null,state:o,currentTask:n.current_task,motion:a}})}),bk=Nt(()=>{const t=Dc.value;return Gt.value.filter(e=>e.status==="active"||e.status==="busy"||e.status==="listening"||e.status==="idle").map(e=>{const n=e.name.trim().toLowerCase(),s=t.get(n),a=(s==null?void 0:s.activeAssignedCount)??0;let o="calm";return a>=3?o="hot":a>=1&&(o="normal"),{name:e.name,emoji:e.emoji??"",koreanName:e.koreanName??null,currentTask:e.current_task,lastActivityAt:(s==null?void 0:s.lastActivityAt)??null,lastActivityText:(s==null?void 0:s.lastActivityText)??null,assignedCount:a,pressure:o}}).sort((e,n)=>{const s={hot:0,normal:1,calm:2};return s[e.pressure]-s[n.pressure]})});function sc(t){return t.kind==="board"?"live-event-broadcast":t.kind==="tasks"?"live-event-task":t.kind==="keepers"?"live-event-keeper":"live-event-system"}function kk(t){const e=t.eventType;return e==="broadcast"?"broadcast":e==="agent_joined"?"joined":e==="agent_left"?"left":e==="task_update"?"task":e==="board_post"?"post":e==="board_comment"?"comment":e==="keeper_heartbeat"?"heartbeat":e==="keeper_handoff"?"handoff":e==="keeper_compaction"?"compact":e==="keeper_guardrail"?"guardrail":t.kind==="board"?"board":t.kind==="tasks"?"task":t.kind==="keepers"?"keeper":"system"}function xk(t){switch(t){case"working":return"pulse-working";case"stale":return"pulse-stale";default:return"pulse-idle"}}function Sk(){const t=yk.value,e=Cr.value;return t.length===0?i`
  ...
  `}const Ck=[{kind:"broadcast",label:"Broadcast",cssClass:"live-event-broadcast"},{kind:"tasks",label:"Task",cssClass:"live-event-task"},{kind:"keepers",label:"Keeper",cssClass:"live-event-keeper"},{kind:"system",label:"System",cssClass:"live-event-system"}];function Ak(){const t=Xa.value;return i`
  ...
  `}function Tk(){const t=$k.value;return i`
        ...
        ${t.length===0?i`<div class="activity-empty">No events matching filters</div>`:t.map((e,n)=>i`
            ...
            >
              <div class="activity-item-head">
                <span class="activity-kind-chip ${sc(e)}">${kk(e)}</span>
  ...
  `}function Ik(t){switch(t){case"hot":return"focus-pressure-hot";case"normal":return"focus-pressure-normal";default:return"focus-pressure-calm"}}function Rk(t){switch(t){case"hot":return"High";case"normal":return"Active";default:return"Calm"}}function Mk(){const t=bk.value,e=Cr.value;return i`
  ...
  `}function Lk(){const t=ge.value;return i`
  ...
  `}function Pk({currentTab:t}){var d,p,_,v,f,h,T,k,C,$;const e=ge.value,n=(d=pt.value)==null?void 0:d.build,s=(p=pt.value)==null?void 0:p.lodge,a=(_=pt.value)==null?void 0:_.gardener,o=(v=pt.value)==null?void 0:v.guardian,l=(f=pt.value)==null?void 0:f.sentinel,c=[];if(s&&c.push(Qs("Lodge",s.enabled?Pt("lodge",s.quiet_active?"quiet":"live"):Pt("lodge","disabled"),s.enabled?s.quiet_active?"warn":"ok":"bad",[Mt("틱",s.total_ticks??0),Mt("체크인",s.total_checkins??0),Mt("최근 결과",((h=s.last_tick_result)==null?void 0:h.activity_report)??s.last_skip_reason??"없음")])),a&&c.push(Qs("Gardener",a.alive?Pt("gardener","live"):a.enabled?Pt("gardener","starting"):Pt("gardener","disabled"),a.alive?"ok":a.enabled?"warn":"bad",[Mt("최근 tick",a.last_tick_completed_at?i`<${X} timestamp=${a.last_tick_completed_at} />`:"기록 없음"),Mt("판단",`${a.last_intervention??"없음"} · ${a.last_decision_source??"없음"}`),Mt("백로그",`미할당 ${((T=a.health_summary)==null?void 0:T.todo_count)??0} · P1/2 ${((k=a.health_summary)==null?void 0:k.high_priority_todo)??0}`)],a.last_reason??a.last_error??void 0)),o){const y=o.masc_loops_running||o.lodge_loop_started||o.lodge_running;c.push(Qs("Guardian",y?Pt("guardian","live"):o.enabled?Pt("guardian","idle"):Pt("guardian","disabled"),y?"ok":o.enabled?"warn":"bad",[Mt("모드",o.mode??"알 수 없음"),Mt("루프",`zombie ${o.zombie_loop_running?"on":"off"} · gc ${o.gc_loop_running?"on":"off"}`),Mt("소유자",o.runtime_owner??"없음")],((C=o.last_lodge_result)==null?void 0:C.message)??o.last_gc_result??o.last_zombie_result??void 0))}return l&&c.push(Qs("Sentinel",l.started?Pt("sentinel","live"):l.enabled?Pt("sentinel","starting"):Pt("sentinel","disabled"),l.started?"ok":l.enabled?"warn":"bad",[Mt("에이전트",l.agent_name??"sentinel"),Mt("소비자",(($=l.consumers)==null?void 0:$.length)??0),Mt("가디언 소유자",l.guardian_runtime_owner??"없음")],l.llm_enabled===!0?"LLM 기반 housekeeping resident":void 0)),i`
    <section class="rail-card">
      ...
      ${n?i`<div class="rail-build-hint">서버 빌드 · v${n.release_version} · ${Ek(n.commit)}</div>`:null}
      ${c.length>0?i`
  ...
  `}function zk(){const t=Tt.value,e=ni(t).total_count,n=(t==null?void 0:t.sessions.length)??0,s=(t==null?void 0:t.keepers.length)??0;return i`
    <section class="rail-card">
      <div class="rail-card-head">
        <h3>개입 바로가기</h3>
  ...
  `}const Zs=g(!1);function Nk(){const t=ge.value;return i`
    <div class="connection-status ${t?"connected":"disconnected"}">
      <span class="status-dot ${t?"connected":"disconnected"}"></span>
      <span class="status-text">${t?"연결됨":"재연결 중..."}</span>
      <span class="event-count">이벤트 ${Qa.value}</span>
    </div>
  `}function jk(t){const e=t==null?void 0:t.trim();return e?e.length>10?e.slice(0,10):e:"커밋 정보 없음"}function wk(){const t=pt.value,e=t==null?void 0:t.build,n=e?`v${e.release_version} · ${jk(e.commit)}`:t!=null&&t.version?`v${t.version} · 커밋 정보 없음`:"버전 정보 없음";return i`
  ...
  `}function Ok(){const t=D.value.tab,e=wo.find(s=>s.id===t),n=ac.find(s=>s.id===(e==null?void 0:e.group));return i`
  ...
  `}function Dk(){switch(D.value.tab){case"mission":return i`<${Tl} />`;case"proof":return i`<${B$} />`;case"execution":return i`<${nb} />`;case"tools":return i`<${cb} />`;case"live":return i`<${Lk} />`;case"memory":return i`<${Oy} />`;case"governance":return i`<${Db} />`;case"planning":return i`<${Sb} />`;case"intervene":return i`<${Cy} />`;case"command":return i`<${by} />`;case"lab":return i`<${vk} />`;default:return i`<${Tl} />`}}function qk(){return uo.value&&!ge.value?i`<div class="loading-indicator">대시보드 불러오는 중...</div>`:i`<${Dk} />`}function Fk(){et(()=>{wu(),uc(),Bc(),Ee(),Le(),Kc(),od();const n=H_();return W_(),()=>{Hu(),n(),G_()}},[]),et(()=>{const n=setInterval(()=>{ko(D.value.tab)},15e3);return()=>{clearInterval(n)}},[]),et(()=>{ko(D.value.tab)},[D.value.tab]);const t=D.value.tab,e=wo.find(n=>n.id===t);return i`
    <div class="app-shell">
  ...
  `}const ic=document.getElementById("app");ic&&Eu(i`<${Fk} />`,ic);export{e$ as _};
