...
let dashboard_runtime_probe_target ~(api_format : Runtime_schema.api_format) base_url =
  ...
  | Runtime_schema.Muse_cli_runtime -> Probe_requires_cli_transport
  ...
  | Runtime_schema.Http endpoint_url ->
    ...
    with
     | ( Runtime_execution.Codex_app_server _
       ...
       | Runtime_execution.Muse_cli _ ), _
...
let runtime_api_format_wire : Runtime_schema.api_format -> string = function
  ...
  | Runtime_schema.Muse_cli_runtime -> "muse-cli"
;;
...
let runtime_inventory_entry_json ~default_id (rt : Runtime.t) =
  ...
  let is_official_client_runtime =
    ...
    | Runtime_execution.Claude_code _
    | Runtime_execution.Antigravity_cli _
    | Runtime_execution.Muse_cli _ -> true
