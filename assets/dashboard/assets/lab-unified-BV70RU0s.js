import{t as d,u as m,E as i,m as e,v as u,x as v,r as g,C as l,y as $,z as n}from"./index-D0qvPfou.js";import{y as f,c as x}from"./vendor-Chwn_OlE.js";import{S as y}from"./stat-tile-BjJ5RHaD.js";import{Tools as b}from"./tools-DJUVIxn-.js";const p=x(!1);async function c(){try{await v()}catch(t){t instanceof Error&&/\b410\b/.test(t.message)&&(p.value=!0)}}function h(){var r,o;const t=d.value,s=m.value,a=p.value;return f(()=>{!t&&!s&&!a&&c()},[t,s,a]),a?e`<${i} message="TRPG 모듈은 아카이브되었습니다. 과거 세션 기록은 서버 로그에 남아 있습니다." />`:s&&!t?e`<${i} message="TRPG 상태를 불러오는 중..." compact />`:t?e`
