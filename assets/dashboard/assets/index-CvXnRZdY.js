...
`).map(n=>n.trim()).filter(n=>n!=="")}async function Wl(t,e=20){return _t("masc_task_history",{task_id:t,limit:e})}async function Gl(){return Fe("fetchDebates",async()=>{const t=await Y("/api/v1/council/debates?limit=100");return Array.isArray(t.debates)?t.debates.map(e=>{if(!M(e))return null;const n=$(e.id,"").trim(),a=$(e.topic,"").trim();return!n||!a?null:{id:n,topic:a,status:$(e.status,"open"),argument_count:q(e.argument_count,0),created_at:Ee(e.created_at_iso??e.created_at)}}).filter(e=>e!==null):[]})}async function Jl(){return Fe("fetchCouncilSessions",async()=>{const t=await Y("/api/v1/council/sessions?limit=100");return Array.isArray(t.sessions)?t.sessions.map(e=>{if(!M(e))return null;const n=$(e.id,"").trim(),a=$(e.topic,"").trim();return!n||!a?null:{id:n,topic:a,initiator:$(e.initiator,"system"),votes:q(e.votes,0),quorum:q(e.quorum,0),state:$(e.state,"open"),created_at:Ee(e.created_at_iso??e.created_at)}}).filter(e=>e!==null):[]})}async function Vl(t){const e=await _t("masc_debate_start",{topic:t});try{return JSON.parse(e)}catch{return null}}async function Ql(t){return Fe("fetchDebateStatus",async()=>{const e=encodeURIComponent(t),n=await Y(`/api/v1/council/debates/${e}/summary`);if(!M(n))return null;const a=$(n.id,"").trim();return a?{id:a,topic:$(n.topic,""),status:$(n.status,"open"),support_count:q(n.support_count,0),oppose_count:q(n.oppose_count,0),neutral_count:q(n.neutral_count,0),total_arguments:q(n.total_arguments,0),created_at:Ee(n.created_at_iso??n.created_at),summary_text:$(n.summary_text,"")}:null})}function Yl(t,e,n){return _t("masc_keeper_msg",{name:t,message:e})}async function Xl(){try{const t=await _t("masc_goal_list",{});if(typeof t=="string"){const e=JSON.parse(t);return Array.isArray(e)?e:e.goals??[]}return Array.isArray(t)?t:t.goals??[]}catch{return[]}}const tn=f(""),Ut=f({}),it=f({}),bs=f({}),ks=f({}),xs=f({}),Ss=f({}),Bt=f({});function nt(t,e,n){t.value={...t.value,[e]:n}}function Wt(t){return typeof t=="object"&&t!==null&&!Array.isArray(t)}function K(t){return typeof t=="string"&&t.trim()!==""?t.trim():void 0}function Ct(t){return typeof t=="number"&&Number.isFinite(t)?t:void 0}function Te(t){return typeof t=="boolean"?t:void 0}function As(t){return typeof t=="string"&&t.trim()!==""?t:typeof t!="number"||!Number.isFinite(t)||t<=0?null:new Date(t*1e3).toISOString()}function ws(t){return Array.isArray(t)?t.map(e=>K(e)).filter(e=>!!e):[]}function Zl(t){var n;const e=(n=K(t))==null?void 0:n.toLowerCase();return e==="user"||e==="assistant"||e==="system"||e==="tool"?e:"other"}function tc(t){switch(t){case"user":return"User";case"assistant":return"Keeper";case"system":return"System";case"tool":return"Tool";default:return"Event"}}function ja(t,e){if(!Array.isArray(t))return[];const n=[];for(const a of t){if(!Wt(a))continue;const i=K(a.name);if(!i)continue;const o=K(a[e]);e==="summary"?n.push({name:i,summary:o}):n.push({name:i,reason:o})}return n}function ec(t){if(!Wt(t))return null;const e=K(t.name);return e?{name:e,trigger:K(t.trigger),outcome:K(t.outcome),summary:K(t.summary),reason:K(t.reason)}:null}function nc(t){const e=t.toLowerCase();return e.includes("graphql")?"graphql_error":e.includes("timeout")||e.includes("model")||e.includes("llm")||e.includes("api key")||e.includes("api_key")||e.includes("provider")?"llm_error":"unknown"}function ac(t,e){return t==="offline"||t==="degraded"||t==="stale"?"Keeper is not in a healthy reply state. Probe or recover before relying on automation.":e==="quiet_hours"?"Lodge quiet hours are active. Direct messages still work, but scheduled social ticks may look asleep.":e==="min_gap"?"Keeper is inside its proactive cooldown window. Direct messages work now; autonomous check-ins will wait.":e==="never_started"?"Keeper metadata exists but no reply turn has been recorded yet.":"Keeper is reachable. Send a direct message for an immediate response."}function bo(t,e,n){return K(t)??ac(e,n)}function ko(t,e){return typeof t=="boolean"?t:e==="recover"}function ea(t){if(!Wt(t))return null;const e=K(t.health_state),n=K(t.next_action_path),a=K(t.last_reply_status);return!e||!n||!a?null:{health_state:e,quiet_reason:K(t.quiet_reason)??null,next_action_path:n,last_reply_status:a,last_reply_at:As(t.last_reply_at),last_reply_preview:K(t.last_reply_preview)??null,last_error:K(t.last_error)??null,next_eligible_at_s:Ct(t.next_eligible_at_s)??null,recoverable:ko(t.recoverable,n),summary:bo(t.summary,e,K(t.quiet_reason)??null),keepalive_running:typeof t.keepalive_running=="boolean"?t.keepalive_running:void 0}}function ii(t){return Wt(t)?{hour:Ct(t.hour),checked:Ct(t.checked)??0,acted:Ct(t.acted)??0,acted_names:ws(t.acted_names),activity_report:K(t.activity_report),quiet_hours_overridden:Te(t.quiet_hours_overridden),skipped_reason:K(t.skipped_reason),acted_rows:ja(t.acted_rows,"summary").map(e=>({name:e.name,summary:e.summary})),passed_rows:ja(t.passed_rows,"reason").map(e=>({name:e.name,reason:e.reason})),skipped_rows:ja(t.skipped_rows,"reason").map(e=>({name:e.name,reason:e.reason})),checkins:Array.isArray(t.checkins)?t.checkins.map(ec).filter(e=>e!==null):[]}:null}function sc(t){return Wt(t)?{enabled:Te(t.enabled)??!1,interval_s:Ct(t.interval_s)??0,quiet_start:Ct(t.quiet_start),quiet_end:Ct(t.quiet_end),quiet_active:Te(t.quiet_active),use_planner:Te(t.use_planner),delegate_llm:Te(t.delegate_llm),agent_count:Ct(t.agent_count),agents:ws(t.agents),last_tick_ago_s:Ct(t.last_tick_ago_s)??null,last_tick_ago:K(t.last_tick_ago),total_ticks:Ct(t.total_ticks),total_checkins:Ct(t.total_checkins),last_skip_reason:K(t.last_skip_reason)??null,last_tick_result:ii(t.last_tick_result),active_self_heartbeats:ws(t.active_self_heartbeats)}:null}function ic(t){return Wt(t)?{status:t.status,diagnostic:ea(t.diagnostic)}:null}function oc(t){return Wt(t)?{recovered:Te(t.recovered)??!1,skipped_reason:K(t.skipped_reason)??null,before:ea(t.before),after:ea(t.after),down:t.down,up:t.up}:null}function rc(t,e){var L,O;if(!(t!=null&&t.name))return null;const n=K((L=t.agent)==null?void 0:L.status)??K(t.status)??"unknown",a=K((O=t.agent)==null?void 0:O.error)??null,i=t.presence_keepalive??!0,o=t.keepalive_running??!1,r=t.turn_count??0,c=t.last_turn_ago_s??null,p=t.proactive_enabled??!1,_=t.proactive_cooldown_sec??0,m=t.last_proactive_ago_s??null,d=p&&m!=null?Math.max(0,_-m):null,l=r<=0||c==null?"never":c>900?"stale":"fresh",g=typeof t.last_heartbeat=="string"&&t.last_heartbeat.trim()?t.last_heartbeat:null,y=a??(i&&!o?"keeper keepalive is not running":null),x=n==="offline"||n==="inactive"?"offline":y?"degraded":l==="stale"?"stale":l==="never"?"idle":"healthy",C=y?nc(y):e!=null&&e.quiet_active&&l!=="fresh"?"quiet_hours":i&&!o?"disabled":r<=0?"never_started":d!=null&&d>0?"min_gap":l==="fresh"||l==="stale"?"no_recent_activity":"unknown",E=x==="offline"||x==="degraded"||x==="stale"?"recover":C==="quiet_hours"?"manual_lodge_poke":C==="unknown"?"probe":"direct_message";return{health_state:x,quiet_reason:C,next_action_path:E,last_reply_status:l,last_reply_at:g,last_reply_preview:null,last_error:y,next_eligible_at_s:d!=null&&d>0?d:null,recoverable:ko(void 0,E),summary:bo(void 0,x,C),keepalive_running:o}}function lc(t,e){if(!Wt(t))return null;const n=Zl(t.role),a=K(t.content)??K(t.preview);if(!a)return null;const i=As(t.ts_unix)??As(t.timestamp);return{id:`${n}-${i??"entry"}-${e}`,role:n,label:tc(n),text:a,timestamp:i,delivery:"history"}}function cc(t,e,n){const a=Wt(n)?n:null,i=Array.isArray(a==null?void 0:a.history_tail)?a.history_tail.map((o,r)=>lc(o,r)).filter(o=>o!==null):[];return{name:t,diagnostic:ea(a==null?void 0:a.diagnostic),history:i,rawText:e,rawStatus:n,loadedAt:new Date().toISOString()}}function wi(t,e){const n=it.value[t]??[];it.value={...it.value,[t]:[...n,e].slice(-50)}}function dc(t,e){return t.role!==e.role||t.text!==e.text?!1:t.timestamp&&e.timestamp?t.timestamp===e.timestamp:!0}function uc(t,e){const a=(it.value[t]??[]).filter(i=>i.delivery!=="history"&&!e.some(o=>dc(i,o)));it.value={...it.value,[t]:[...e,...a].slice(-50)}}function Pa(t,e){Ut.value={...Ut.value,[t]:e},uc(t,e.history)}function Ti(t,e){const n=Ut.value[t];if(!n)return;const a=n.diagnostic??{health_state:"idle",next_action_path:"direct_message",last_reply_status:"unknown"};Pa(t,{...n,diagnostic:{...a,...e}})}async function oi(){Me();try{await te()}catch(t){console.warn("[keeper-runtime] dashboard refresh failed",t)}}function Kn(t){tn.value=t.trim()}async function xo(t,e=!1){const n=t.trim();if(!n)return null;if(!e&&Ut.value[n])return Ut.value[n];nt(bs,n,!0),nt(Bt,n,null);try{const a=await _t("masc_keeper_status",{name:n,fast:!1,include_context:!0,include_metrics_overview:!0,include_memory_bank:!1,include_history_tail:!0,include_compaction_history:!1,tail_turns:5,tail_messages:10});let i=null;try{i=JSON.parse(a)}catch{i=null}const o=cc(n,a,i);return Pa(n,o),o}catch(a){const i=a instanceof Error?a.message:`Failed to inspect ${n}`;return nt(Bt,n,i),null}finally{nt(bs,n,!1)}}async function pc(t,e){const n=t.trim(),a=e.trim();if(!n||!a)return;const i=`local-${Date.now()}`;wi(n,{id:i,role:"user",label:"You",text:a,timestamp:new Date().toISOString(),delivery:"sending"}),nt(ks,n,!0),nt(Bt,n,null);try{const o=await Yl(n,a);it.value={...it.value,[n]:(it.value[n]??[]).map(r=>r.id===i?{...r,delivery:"delivered"}:r)},wi(n,{id:`reply-${Date.now()}`,role:"assistant",label:n,text:o.trim()||"(empty reply)",timestamp:new Date().toISOString(),delivery:"delivered"}),Ti(n,{last_reply_status:"delivered",last_reply_at:new Date().toISOString(),last_reply_preview:(o.trim()||"(empty reply)").slice(0,200),last_error:null}),await oi()}catch(o){const r=o instanceof Error?o.message:`Failed to send direct message to ${n}`;throw it.value={...it.value,[n]:(it.value[n]??[]).map(c=>c.id===i?{...c,delivery:"error",error:r}:c)},Ti(n,{last_reply_status:"error",last_error:r}),nt(Bt,n,r),o}finally{nt(ks,n,!1)}}async function mc(t,e){const n=t.trim();if(!n)return null;nt(xs,n,!0),nt(Bt,n,null);try{const a=await Nn({actor:e,action_type:"keeper_probe",target_type:"keeper",target_id:n,payload:{}}),i=ic(a.result),o=(i==null?void 0:i.diagnostic)??null;if(o){const r=Ut.value[n];Pa(n,{name:n,diagnostic:o,history:(r==null?void 0:r.history)??it.value[n]??[],rawText:(r==null?void 0:r.rawText)??"",rawStatus:a.result,loadedAt:new Date().toISOString()})}return await oi(),o}catch(a){const i=a instanceof Error?a.message:`Failed to probe ${n}`;throw nt(Bt,n,i),a}finally{nt(xs,n,!1)}}async function vc(t,e){const n=t.trim();if(!n)return null;nt(Ss,n,!0),nt(Bt,n,null);try{const a=await Nn({actor:e,action_type:"keeper_recover",target_type:"keeper",target_id:n,payload:{}}),i=oc(a.result),o=(i==null?void 0:i.after)??null;if(o){const r=Ut.value[n];Pa(n,{name:n,diagnostic:o,history:(r==null?void 0:r.history)??it.value[n]??[],rawText:(r==null?void 0:r.rawText)??"",rawStatus:a.result,loadedAt:new Date().toISOString()})}return await oi(),o}catch(a){const i=a instanceof Error?a.message:`Failed to recover ${n}`;throw nt(Bt,n,i),a}finally{nt(Ss,n,!1)}}function le(t){return(t??"").trim().toLowerCase()}function pt(t){const e=typeof t=="number"?t:Date.parse(t);return Number.isNaN(e)?0:e}function Hn(t,e=88){const n=t.replace(/\s+/g," ").trim();return n&&(n.length>e?`${n.slice(0,e-3)}...`:n)}function Dn(t){return typeof t!="number"||!Number.isFinite(t)||t<0?null:new Date(Date.now()-t*1e3).toISOString()}function Je(t){return t.last_heartbeat??Dn(t.last_turn_ago_s)??Dn(t.last_proactive_ago_s)??Dn(t.last_handoff_ago_s)??Dn(t.last_compaction_ago_s)}function fc(t){const e=t.title.trim();return e||Hn(t.content)}function gc(t){const e=t.generation??"?",n=typeof t.context_ratio=="number"&&Number.isFinite(t.context_ratio)?`${Math.round(t.context_ratio*100)}%`:"?";return t.last_heartbeat?`Heartbeat gen=${e} ctx=${n}`:`Keeper snapshot gen=${e} ctx=${n}`}function _c(t,e,n,a,i={}){var O;const o=le(t),r=e.filter(R=>le(R.assignee)===o&&(R.status==="claimed"||R.status==="in_progress")).length,c=n.filter(R=>le(R.from)===o).sort((R,D)=>pt(D.timestamp)-pt(R.timestamp))[0],p=a.filter(R=>le(R.agent)===o||le(R.author)===o).sort((R,D)=>pt(D.timestamp)-pt(R.timestamp))[0],_=(i.boardPosts??[]).filter(R=>le(R.author)===o).sort((R,D)=>pt(D.updated_at||D.created_at)-pt(R.updated_at||R.created_at))[0],m=(i.keepers??[]).filter(R=>le(R.name)===o&&Je(R)!==null).sort((R,D)=>pt(Je(D)??0)-pt(Je(R)??0))[0],d=c?pt(c.timestamp):0,l=p?pt(p.timestamp):0,g=_?pt(_.updated_at||_.created_at):0,y=m?pt(Je(m)??0):0,x=i.lastSeen?pt(i.lastSeen):0,C=((O=i.currentTask)==null?void 0:O.trim())||(r>0?`${r} claimed tasks`:null);if(d===0&&l===0&&g===0&&y===0&&x===0)return{activeAssignedCount:r,lastActivityAt:null,lastActivityText:C};const L=[c?{timestamp:c.timestamp,ts:d,text:Hn(c.content)}:null,_?{timestamp:_.updated_at||_.created_at,ts:g,text:`Post: ${Hn(fc(_))}`}:null,m?{timestamp:Je(m),ts:y,text:gc(m)}:null,p?{timestamp:new Date(p.timestamp).toISOString(),ts:l,text:Hn(p.text)}:null].filter(R=>R!==null).sort((R,D)=>D.ts-R.ts)[0];return L&&L.ts>=x?{activeAssignedCount:r,lastActivityAt:L.timestamp,lastActivityText:L.text}:{activeAssignedCount:r,lastActivityAt:i.lastSeen??null,lastActivityText:C??"Presence heartbeat"}}const kt=f([]),gt=f([]),$n=f([]),Gt=f([]),ne=f(null),Xe=f(null),Ts=f(new Map),Ke=f([]),hn=f("hot"),de=f(!0),So=f(null),Ht=f(""),yn=f([]),Ce=f(!1),Ao=f(new Map),Cs=f("unknown"),Ns=f(null),Rs=f(!1),bn=f(!1),Ls=f(!1),Ne=f(!1),$c=f(null),Ds=f(null),wo=f(null),To=f(null),hc=xt(()=>kt.value.filter(t=>t.status==="active"||t.status==="busy"||t.status==="listening"||t.status==="idle")),Co=xt(()=>{const t=gt.value;return{todo:t.filter(e=>e.status==="todo"),inProgress:t.filter(e=>e.status==="in_progress"||e.status==="claimed"),done:t.filter(e=>e.status==="done")}}),Ia=xt(()=>{const t=new Map,e=gt.value,n=$n.value,a=ta.value,i=Ke.value,o=Gt.value;for(const r of kt.value)t.set(r.name.trim().toLowerCase(),_c(r.name,e,n,a,{currentTask:r.current_task,lastSeen:r.last_seen,boardPosts:i,keepers:o}));return t});function yc(t){var o;const e=((o=t.status)==null?void 0:o.toLowerCase())??"";if(e==="offline"||e==="inactive")return"offline";const n=t.metrics_series;if(!n||n.length===0)return"idle";const a=n[n.length-1];if(!a)return"idle";if(a.is_handoff)return"handoff-imminent";if(a.is_compaction)return"compacting";const i=a.context_ratio;return i>.85?"handoff-imminent":i>.7?"preparing":i>.5?"compacting":"active"}const No=xt(()=>{const t=new Map;for(const e of Gt.value)t.set(e.name,yc(e));return t}),bc=12e4;function kc(t,e){const n=e.get(t.name);if(n!=null)return n;const a=t.last_heartbeat?Date.parse(t.last_heartbeat):Number.NaN;if(!Number.isNaN(a))return a;const i=[t.last_turn_ago_s,t.last_proactive_ago_s,t.last_handoff_ago_s,t.last_compaction_ago_s].find(o=>typeof o=="number"&&Number.isFinite(o)&&o>=0);return typeof i=="number"?Date.now()-i*1e3:null}const Ro=xt(()=>{const t=Date.now(),e=new Set,n=Ts.value;for(const a of Gt.value){const i=kc(a,n);i!=null&&t-i>bc&&e.add(a.name)}return e}),na={},xc=5e3;let Fa=null;function Sc(t){return t==="dashboard_refresh"||t==="masc/dashboard_refresh"||t.startsWith("goal_")||t.startsWith("masc/goal_")||t.startsWith("mdal_")||t.startsWith("masc/mdal_")||t.startsWith("operator_")||t.startsWith("masc/operator_")||t.startsWith("command_plane_")||t.startsWith("masc/command_plane_")}function Me(){delete na.compact,delete na.full}function ot(t){return typeof t=="object"&&t!==null}function b(t){return typeof t=="string"&&t.trim()!==""?t:void 0}function S(t){return typeof t=="number"&&Number.isFinite(t)?t:void 0}function fe(t){if(!Array.isArray(t))return;const e=t.filter(n=>typeof n=="string"&&n.trim()!=="");return e.length>0?e:void 0}function Ps(t){if(typeof t=="string"&&t.trim()!=="")return t;if(!(typeof t!="number"||!Number.isFinite(t)||t<=0))return new Date(t*1e3).toISOString()}function Lo(t){const e=typeof t=="string"?t.toLowerCase():"";return e==="active"||e==="busy"||e==="listening"||e==="idle"||e==="inactive"||e==="offline"?e:e==="in_progress"||e==="claimed"?"busy":"offline"}function Ac(t){const e=typeof t=="string"?t.toLowerCase():"";return e==="todo"||e==="in_progress"||e==="claimed"||e==="done"||e==="cancelled"?e:e==="inprogress"?"in_progress":"todo"}function Do(t){if(!ot(t))return null;const e=b(t.name);return e?{name:e,status:Lo(t.status),current_task:b(t.current_task)??null,last_seen:b(t.last_seen),emoji:b(t.emoji),koreanName:b(t.koreanName)??b(t.korean_name),model:b(t.model),traits:fe(t.traits),interests:fe(t.interests),activityLevel:S(t.activityLevel)??S(t.activity_level),primaryValue:b(t.primaryValue)??b(t.primary_value)}:null}function Po(t){if(!ot(t))return null;const e=b(t.id),n=b(t.title);return!e||!n?null:{id:e,title:n,status:Ac(t.status),priority:S(t.priority),assignee:b(t.assignee),description:b(t.description),created_at:b(t.created_at),updated_at:b(t.updated_at)}}function Io(t){if(!ot(t))return null;const e=b(t.from)??b(t.from_agent)??"system",n=b(t.content)??"",a=b(t.timestamp)??new Date().toISOString();return{id:b(t.id),seq:S(t.seq),from:e,content:n,timestamp:a,type:b(t.type)}}function wc(t){return Array.isArray(t)?t.map(e=>{if(!ot(e))return null;const n=S(e.ts_unix);if(n==null)return null;const a=ot(e.handoff)?e.handoff:null;return{ts:n,context_ratio:S(e.context_ratio)??0,context_tokens:S(e.context_tokens)??0,context_max:S(e.context_max)??0,latency_ms:S(e.latency_ms)??0,generation:S(e.generation)??0,channel:typeof e.channel=="string"?e.channel:"turn",is_handoff:a!=null&&e.handoff_performed===!0,is_compaction:e.compacted===!0,compaction_saved_tokens:S(e.compaction_saved_tokens)??0,compaction_trigger:typeof e.compaction_trigger=="string"?e.compaction_trigger:null,model_used:typeof e.model_used=="string"?e.model_used:"",cost_usd:S(e.cost_usd)??0,handoff_to_model:a&&typeof a.to_model=="string"?a.to_model:null,handoff_new_generation:a?S(a.new_generation)??null:null}}).filter(e=>e!==null):[]}function Ci(t){if(!ot(t))return null;const e=b(t.health_state),n=b(t.next_action_path),a=b(t.last_reply_status);if(!e||!n||!a)return null;const i=b(t.quiet_reason)??null,o=b(t.summary)??(e==="offline"||e==="degraded"||e==="stale"?"Keeper is not in a healthy reply state. Probe or recover before relying on automation.":i==="quiet_hours"?"Lodge quiet hours are active. Direct messages still work, but scheduled social ticks may look asleep.":i==="min_gap"?"Keeper is inside its proactive cooldown window. Direct messages work now; autonomous check-ins will wait.":i==="never_started"?"Keeper metadata exists but no reply turn has been recorded yet.":"Keeper is reachable. Send a direct message for an immediate response.");return{health_state:e,quiet_reason:i,next_action_path:n,last_reply_status:a,last_reply_at:Ps(t.last_reply_at)??b(t.last_reply_at)??null,last_reply_preview:b(t.last_reply_preview)??null,last_error:b(t.last_error)??null,next_eligible_at_s:S(t.next_eligible_at_s)??null,recoverable:typeof t.recoverable=="boolean"?t.recoverable:n==="recover",summary:o,keepalive_running:typeof t.keepalive_running=="boolean"?t.keepalive_running:void 0}}function Tc(t,e){return(Array.isArray(t)?t:ot(t)&&Array.isArray(t.keepers)?t.keepers:[]).map(a=>{if(!ot(a))return null;const i=ot(a.agent)?a.agent:null,o=ot(a.context)?a.context:null,r=ot(a.metrics_window)?a.metrics_window:void 0,c=b(a.name);if(!c)return null;const p=S(a.context_ratio)??S(o==null?void 0:o.context_ratio),_=b(a.status)??b(i==null?void 0:i.status)??"offline",m=Lo(_),d=b(a.model)??b(a.active_model)??b(a.primary_model),l=fe(a.skill_secondary),g=o?{source:b(o.source),context_ratio:S(o.context_ratio),context_tokens:S(o.context_tokens),context_max:S(o.context_max),message_count:S(o.message_count),has_checkpoint:typeof o.has_checkpoint=="boolean"?o.has_checkpoint:void 0}:void 0,y=i?{name:b(i.name),exists:typeof i.exists=="boolean"?i.exists:void 0,error:b(i.error),status:b(i.status),current_task:b(i.current_task)??null,last_seen:b(i.last_seen),last_seen_ago_s:S(i.last_seen_ago_s),is_zombie:typeof i.is_zombie=="boolean"?i.is_zombie:void 0}:void 0,x=wc(a.metrics_series),C={name:c,emoji:b(a.emoji),koreanName:b(a.koreanName)??b(a.korean_name),agent_name:b(a.agent_name),trace_id:b(a.trace_id),model:d,primary_model:b(a.primary_model),active_model:b(a.active_model),next_model_hint:b(a.next_model_hint)??null,status:m,presence_keepalive:typeof a.presence_keepalive=="boolean"?a.presence_keepalive:void 0,presence_keepalive_sec:S(a.presence_keepalive_sec),keepalive_running:typeof a.keepalive_running=="boolean"?a.keepalive_running:void 0,proactive_enabled:typeof a.proactive_enabled=="boolean"?a.proactive_enabled:void 0,proactive_idle_sec:S(a.proactive_idle_sec),proactive_cooldown_sec:S(a.proactive_cooldown_sec),last_heartbeat:b(a.last_heartbeat)??b(i==null?void 0:i.last_seen),generation:S(a.generation),turn_count:S(a.turn_count)??S(a.total_turns),keeper_age_s:S(a.keeper_age_s),last_turn_ago_s:S(a.last_turn_ago_s),last_handoff_ago_s:S(a.last_handoff_ago_s),last_compaction_ago_s:S(a.last_compaction_ago_s),last_proactive_ago_s:S(a.last_proactive_ago_s),context_ratio:p,context_tokens:S(a.context_tokens)??S(o==null?void 0:o.context_tokens),context_max:S(a.context_max)??S(o==null?void 0:o.context_max),context_source:b(a.context_source)??b(o==null?void 0:o.source),context:g,traits:fe(a.traits),interests:fe(a.interests),primaryValue:b(a.primaryValue)??b(a.primary_value),activityLevel:S(a.activityLevel)??S(a.activity_level),memory_recent_note:b(a.memory_recent_note)??null,conversation_tail_count:S(a.conversation_tail_count),k2k_count:S(a.k2k_count),handoff_count_total:S(a.handoff_count_total)??S(a.trace_history_count),compaction_count:S(a.compaction_count),last_compaction_saved_tokens:S(a.last_compaction_saved_tokens),diagnostic:Ci(a.diagnostic),skill_primary:b(a.skill_primary)??null,skill_secondary:l,skill_reason:b(a.skill_reason)??null,metrics_series:x.length>0?x:void 0,metrics_window:r,agent:y};return C.diagnostic=Ci(a.diagnostic)??rc(C,(e==null?void 0:e.lodge)??null),C}).filter(a=>a!==null)}function Cc(t){return ot(t)?{...t,lodge:sc(t.lodge)??void 0}:null}function Nc(t){const e=typeof t=="string"?t.toLowerCase():"";return e==="running"||e==="interrupted"||e==="completed"||e==="stopped"||e==="error"?e:e.startsWith("error")?"error":"running"}function Rc(t){if(!ot(t))return null;const e=S(t.iteration);if(e==null)return null;const n=S(t.metric_before)??0,a=S(t.metric_after)??n,i=ot(t.evidence)?t.evidence:null;return{iteration:e,metric_before:n,metric_after:a,delta:S(t.delta)??a-n,changes:b(t.changes)??"",failed_attempts:b(t.failed_attempts)??"",next_suggestion:b(t.next_suggestion)??"",elapsed_ms:S(t.elapsed_ms)??0,cost_usd:S(t.cost_usd)??null,evidence:i?{worker_engine:(i.worker_engine==="api_tool_loop","api_tool_loop"),worker_model:b(i.worker_model)??"",tool_call_count:S(i.tool_call_count)??0,tool_names:fe(i.tool_names)??[],session_id:b(i.session_id)??"",evidence_status:i.evidence_status==="legacy_unverified"?"legacy_unverified":"verified"}:null}}function Lc(t){var o,r;if(!ot(t))return null;const e=b(t.loop_id);if(!e)return null;const n=S(t.baseline_metric)??0,a=Array.isArray(t.history)?t.history.map(Rc).filter(c=>c!==null):[],i=S(t.current_metric)??((o=a[0])==null?void 0:o.metric_after)??n;return{loop_id:e,profile:b(t.profile)??"unknown",status:Nc(t.status),strict_mode:typeof t.strict_mode=="boolean"?t.strict_mode:void 0,error_message:b(t.error_message)??b(t.error_reason)??null,stop_reason:b(t.stop_reason)??b(t.reason)??null,current_iteration:S(t.current_iteration)??((r=a[0])==null?void 0:r.iteration)??0,max_iterations:S(t.max_iterations)??0,baseline_metric:n,current_metric:i,target:b(t.target)??"",stagnation_streak:S(t.stagnation_streak)??0,stagnation_limit:S(t.stagnation_limit)??0,elapsed_seconds:S(t.elapsed_seconds)??0,updated_at:Ps(t.updated_at)??null,stopped_at:Ps(t.stopped_at)??null,execution_mode:t.execution_mode==="worker_spawn"?"worker_spawn":void 0,worker_engine:t.worker_engine==="api_tool_loop"?"api_tool_loop":null,worker_model:b(t.worker_model)??null,evidence_policy:t.evidence_policy==="hard"||t.evidence_policy==="legacy"?t.evidence_policy:void 0,latest_tool_call_count:S(t.latest_tool_call_count)??0,latest_tool_names:fe(t.latest_tool_names)??[],session_id:b(t.session_id)??null,evidence_status:t.evidence_status==="legacy_unverified"?"legacy_unverified":t.evidence_status==="verified"?"verified":null,durability:t.durability==="persistent_backend"||t.durability==="memory_only"?t.durability:void 0,persistence_backend:t.persistence_backend==="filesystem"||t.persistence_backend==="postgres"||t.persistence_backend==="memory"?t.persistence_backend:void 0,recoverable:typeof t.recoverable=="boolean"?t.recoverable:void 0,history:a}}async function te(t="full"){var a,i,o;const e=Date.now(),n=na[t];if(!(n&&e-n.time<xc)){Rs.value=!0;try{const r=await Xr(t);na[t]={data:r,time:e},kt.value=(Array.isArray((a=r.agents)==null?void 0:a.agents)?r.agents.agents:[]).map(Do).filter(p=>p!==null),gt.value=(Array.isArray((i=r.tasks)==null?void 0:i.tasks)?r.tasks.tasks:[]).map(Po).filter(p=>p!==null),$n.value=(Array.isArray((o=r.messages)==null?void 0:o.messages)?r.messages.messages:[]).map(Io).filter(p=>p!==null);const c=Cc(r.status);ne.value=c,Gt.value=Tc(r.keepers,c),Xe.value=r.perpetual??null,$c.value=new Date().toISOString()}catch(r){console.error("Dashboard fetch error:",r)}finally{Rs.value=!1}}}async function Dc(){try{const t=await Zr(),e=(Array.isArray(t.agents)?t.agents:[]).map(Do).filter(i=>i!==null),n=kt.value,a=new Map(n.map(i=>[i.name,i]));kt.value=e.map(i=>{const o=a.get(i.name);return o?{...o,status:i.status,current_task:i.current_task}:i})}catch(t){console.error("Agents selective fetch error:",t)}}async function Pc(){try{const t=await tl({includeDone:!0,includeCancelled:!0}),e=(Array.isArray(t.tasks)?t.tasks:[]).map(Po).filter(i=>i!==null),n=gt.value,a=new Map(n.map(i=>[i.id,i]));gt.value=e.map(i=>{const o=a.get(i.id);return o?{...o,status:i.status,priority:i.priority??o.priority,assignee:i.assignee??o.assignee}:i})}catch(t){console.error("Tasks selective fetch error:",t)}}async function Ic(){try{const t=$n.value,e=t.reduce((c,p)=>Math.max(c,p.seq??0),0),n=await el(e),a=(Array.isArray(n.messages)?n.messages:[]).map(Io).filter(c=>c!==null);if(a.length===0)return;const i=new Set(t.map(c=>c.seq).filter(c=>c!=null)),o=new Set(t.filter(c=>c.seq==null).map(c=>`${c.timestamp}|${c.from}`)),r=a.filter(c=>{if(c.seq!=null)return!i.has(c.seq);const p=`${c.timestamp}|${c.from}`;return o.has(p)?!1:(o.add(p),!0)});if(r.length>0){const c=[...t,...r];$n.value=c.length>500?c.slice(-500):c}}catch(t){console.error("Messages selective fetch error:",t)}}async function zt(){bn.value=!0;try{const t=await gl(hn.value,{excludeSystem:de.value});Ke.value=t.posts??[],Ds.value=new Date().toISOString()}catch(t){console.error("Board fetch error:",t)}finally{bn.value=!1}}async function qt(){var t;Ls.value=!0;try{const e=Ht.value||((t=ne.value)==null?void 0:t.room)||"default";Ht.value||(Ht.value=e);const n=await Pl(e);So.value=n}catch(e){console.error("TRPG fetch error:",e)}finally{Ls.value=!1}}async function kn(){Ce.value=!0;try{const t=await Xl();yn.value=Array.isArray(t)?t:[],wo.value=new Date().toISOString()}catch(t){console.error("Goals fetch error:",t)}finally{Ce.value=!1}}async function Oe(){Ne.value=!0;try{const t=await nl(),e=Array.isArray(t.loops)?t.loops:[],n=new Map;for(const a of e){const i=Lc(a);i&&n.set(i.loop_id,i)}Ao.value=n,To.value=new Date().toISOString(),Ns.value=null,Cs.value=n.size===0?"idle":"ready"}catch(t){console.error("MDAL fetch error:",t),Cs.value="error",Ns.value=t instanceof Error?t.message:String(t)}finally{Ne.value=!1}}let Un=null;function Ec(t){Un=t}let Bn=null;function Mc(t){Bn=t}const ue={};function ce(t,e,n=500){ue[t]&&clearTimeout(ue[t]),ue[t]=setTimeout(()=>{e(),delete ue[t]},n)}function Oc(){const t=uo.subscribe(e=>{if(e){if(e.type==="keeper_heartbeat"&&e.name){const n=new Map(Ts.value);n.set(e.name,e.ts_unix?e.ts_unix*1e3:Date.now()),Ts.value=n;return}(e.type==="agent_joined"||e.type==="agent_left")&&ce("agents",Dc),Sc(e.type)&&(Me(),Fa||(Fa=setTimeout(()=>{te(),Bn==null||Bn(),Fa=null},500))),(e.type.startsWith("task_")||e.type.startsWith("masc/task_"))&&ce("tasks",Pc),e.type==="broadcast"&&ce("messages",Ic),(e.type==="keeper_handoff"||e.type==="keeper_compaction"||e.type==="keeper_guardrail")&&ce("dashboard",()=>{Me(),te()}),(e.type==="board_post"||e.type==="masc/board_post"||e.type==="board_comment"||e.type==="masc/board_comment")&&ce("board",zt),e.type.startsWith("decision_")&&ce("council",()=>Un==null?void 0:Un()),(e.type==="mdal_started"||e.type==="mdal_iteration"||e.type==="mdal_completed"||e.type==="mdal_stopped")&&ce("mdal",Oe,350)}});return()=>{t();for(const e of Object.keys(ue))clearTimeout(ue[e]),delete ue[e]}}let en=null;function zc(){en||(en=setInterval(()=>{jt.value||Me(),te()},1e4))}function qc(){en&&(clearInterval(en),en=null)}function w({title:t,class:e,children:n}){return s`
  ...
  `}function Jc(){var i,o,r,c;const t=He.value;if(!t)return null;const e=Bc(),n=Eo(t),a=sa.value;return s`
    <div
        ...
        <div class="agent-detail-header">
          <div style="display:flex;flex-direction:column;gap:8px;flex:1">
            ...
            ${(((r=e==null?void 0:e.interests)==null?void 0:r.length)??0)>0?s`
              <div style="display:flex;flex-wrap:wrap;gap:4px">
                ${(c=e==null?void 0:e.interests)==null?void 0:c.map(p=>s`<span style="font-size:0.7rem;background:#3b1f4e;color:#c084fc;padding:2px 8px;border-radius:10px">${p}</span>`)}
              </div>
            `:""}
  ...
  `}const ia=600*1e3,Wn=1200*1e3;function Mo(t){switch(t){case"in_progress":return"In Progress";case"claimed":return"Claimed";case"done":return"Done";case"cancelled":return"Cancelled";default:return"Todo"}}function Oo(t){switch(t){case"dispatchable":return"Dispatch";case"drift":return"Drift";case"quiet":return"Quiet";case"offline":return"Offline";default:return"Loaded"}}function Vc(t){return t.updated_at??t.created_at??null}function Li(t,e,n){var C,E;const a=pe(t.assignee),i=a?e.get(a)??null:null,o=i?n.get(a)??null:null,r=(o==null?void 0:o.lastActivityAt)??(i==null?void 0:i.last_seen)??null,c=r?Math.max(0,Date.now()-J(r)):Number.POSITIVE_INFINITY,p=st(t.description),_=st(i==null?void 0:i.current_task)??(o==null?void 0:o.lastActivityText)??null,m=t.status==="claimed"||t.status==="in_progress";let d="ok",l="Fresh owner coverage",g=_??p??t.id,y=!1,x=!1;return t.status==="todo"?t.assignee?i?i.status==="offline"||i.status==="inactive"?(y=!0,d="bad",l="Assigned owner is offline",g="Queue item is blocked until ownership changes."):c>ia?(d="warn",l="Owner exists but live signal is quiet",g=_??"Owner may need a nudge before pickup."):((o==null?void 0:o.activeAssignedCount)??0)>0||(C=i.current_task)!=null&&C.trim()?(d="warn",l="Owner is already carrying active work",g=_??`${(o==null?void 0:o.activeAssignedCount)??0} active tasks already assigned.`):(l="Ready and covered by a fresh operator",g=_??p??"This can be picked up immediately."):(y=!0,d="bad",l="Assigned owner is not present in the room",g="Reassign or bring the owner back online."):(y=!0,d=Ot(t.priority)<=2?"bad":"warn",l=Ot(t.priority)<=2?"Urgent ready work has no owner":"Ready work has no owner",g="Assign an agent before this queue item slips."):m&&(t.assignee?i?i.status==="offline"||i.status==="inactive"?(y=!0,d="bad",l="Assigned owner is offline",g=_??"Execution has no live operator right now."):c>Wn?(x=!0,d="bad",l="Assigned owner has gone quiet",g=_??"Fresh operator signal is missing."):c>ia?(x=!0,d="warn",l="Execution has been quiet for too long",g=_??"Check whether this work is blocked."):(E=i.current_task)!=null&&E.trim()?(l="Execution has fresh owner coverage",g=_??p??t.id):(d="warn",l=t.status==="claimed"?"Claimed work is waiting for explicit focus":"Owner is live but current_task is empty",g=_??"Task state and agent focus are drifting apart."):(y=!0,d="bad",l="Assigned owner is not active in the room",g="Execution is orphaned until ownership is restored."):(y=!0,d="bad",l="Active work has no assignee",g="Claim or reassign this task immediately.")),{task:t,assigneeAgent:i,motion:o,tone:d,note:l,focus:g,lastSignalAt:r,lastTouchedAt:Vc(t),ownerGap:y,quiet:x}}function Qc(t,e){var l;const n=e.get(pe(t.name))??{activeAssignedCount:0,lastActivityAt:null,lastActivityText:null},a=n.lastActivityAt??t.last_seen??null,i=a?Math.max(0,Date.now()-J(a)):Number.POSITIVE_INFINITY,o=!!((l=t.current_task)!=null&&l.trim()),r=n.activeAssignedCount,c=o||r>0;let p="loaded",_="ok",m="Healthy active load",d=st(t.current_task)??n.lastActivityText??"Ready for assignment";return t.status==="offline"||t.status==="inactive"?(p="offline",_="bad",m="Agent is unavailable"):c&&i>Wn?(p="quiet",_="bad",m="Working without a fresh signal"):r>0&&!o?(p="drift",_="warn",m="Claimed work exists but current_task is empty",d=`${r} active tasks need explicit focus.`):o&&r===0?(p="drift",_="warn",m="current_task has no matching claimed work",d=st(t.current_task)??"Task metadata and operator state drifted."):!c&&i<=ia?(p="dispatchable",_="ok",m="Fresh signal and no active load",d=n.lastActivityText??"Ready for assignment."):c?i>ia&&(p="loaded",_="warn",m="Execution load is healthy but slightly quiet",d=st(t.current_task)??`${r} active tasks in flight.`):(p="quiet",_=i>Wn?"bad":"warn",m=i>Wn?"No fresh signal while idle":"Reachable, but not freshly active",d=n.lastActivityText??"Likely available after a quick check-in."),{agent:t,motion:n,tone:_,state:p,note:m,focus:d,lastSignalAt:a,activeTaskCount:r}}function Ve({label:t,value:e,color:n,caption:a}){return s`
    <div class="stat-card">
  ...
  `}function Zc(){const t=kt.value,e=gt.value,n=new Map(t.map(d=>[pe(d.name),d])),a=Ia.value,i=e.filter(d=>d.status==="claimed"||d.status==="in_progress").map(d=>Li(d,n,a)).sort((d,l)=>{const g=tt(l.tone)-tt(d.tone);return g!==0?g:J(l.lastSignalAt??l.lastTouchedAt)-J(d.lastSignalAt??d.lastTouchedAt)}),o=e.filter(d=>d.status==="todo").map(d=>Li(d,n,a)).sort((d,l)=>{const g=tt(l.tone)-tt(d.tone);if(g!==0)return g;const y=Ot(d.task.priority)-Ot(l.task.priority);return y!==0?y:J(d.lastTouchedAt)-J(l.lastTouchedAt)}),r=t.map(d=>Qc(d,a)).filter(d=>d.state==="dispatchable"||d.state==="drift"||d.state==="quiet").sort((d,l)=>{if(d.state==="dispatchable"&&l.state!=="dispatchable")return-1;if(l.state==="dispatchable"&&d.state!=="dispatchable")return 1;const g=tt(l.tone)-tt(d.tone);return g!==0?g:J(l.lastSignalAt)-J(d.lastSignalAt)}),c=[...i.filter(d=>d.tone!=="ok").map(d=>({kind:"task",key:`active-${d.task.id}`,tone:d.tone,title:d.task.title,subtitle:`${d.note} · ${d.focus}`,timestamp:d.lastSignalAt??d.lastTouchedAt,taskRow:d})),...o.filter(d=>d.tone==="bad").map(d=>({kind:"task",key:`ready-${d.task.id}`,tone:d.tone,title:d.task.title,subtitle:`${d.note} · ${d.focus}`,timestamp:d.lastTouchedAt,taskRow:d})),...r.filter(d=>d.state==="drift"||d.tone==="bad").map(d=>({kind:"agent",key:`agent-${d.agent.name}`,tone:d.tone,title:d.agent.name,subtitle:`${d.note} · ${d.focus}`,timestamp:d.lastSignalAt,agentRow:d}))].sort((d,l)=>{const g=tt(l.tone)-tt(d.tone);return g!==0?g:J(l.timestamp)-J(d.timestamp)}).slice(0,8),p=r.filter(d=>d.state==="dispatchable"),_=[...i,...o].filter(d=>d.ownerGap),m=i.filter(d=>d.quiet);return s`
    <div class="agents-monitor">
      <div class="stats-grid">
        <${Ve} label="Active work" value=${i.length} color="#fbbf24" caption="claimed + in progress" />
        <${Ve} label="Needs intervention" value=${c.length} color=${c.length>0?"#fb7185":"#4ade80"} caption="stalled or drifting now" />
      ...
      <${w} title="Intervention Queue" class="section">
        ...
        <div class="monitor-alert-list">
          ${c.length===0?s`<div class="empty-state">No active execution risks right now</div>`:c.map(d=>s`<${Yc} key=${d.key} item=${d} />`)}
        </div>
      <//>
      ...
      <div class="grid-2col">
        <${w} title="Ready Queue" class="section">
          ...
          <div class="monitor-list">
            ${o.length===0?s`<div class="empty-state">No ready tasks in the queue</div>`:o.slice(0,10).map(d=>s`<${Di} key=${d.task.id} row=${d} />`)}
          </div>
        <//>
        ...
        <${w} title="Dispatch Window" class="section">
          ...
          <div class="monitor-list">
            ${r.length===0?s`<div class="empty-state">No agent capacity or drift signals right now</div>`:r.map(d=>s`<${Xc} key=${d.agent.name} row=${d} />`)}
          </div>
        <//>
      </div>
      ...
      <${w} title="Active Execution Watch" class="section">
        ...
        <div class="monitor-list">
          ${i.length===0?s`<div class="empty-state">No active execution tasks</div>`:i.map(d=>s`<${Di} key=${d.task.id} row=${d} />`)}
        </div>
      <//>
    </div>
  ...
  `}function Fo({keeperName:t,placeholder:e}){const[n,a]=ni("");bt(()=>{t&&xo(t)},[t]);const i=it.value[t]??[],o=ks.value[t]??!1,r=Bt.value[t],c=async()=>{const p=n.trim();if(!(!t||!p)){a("");try{await pc(t,p)}catch(_){const m=_ instanceof Error?_.message:`Failed to message ${t}`;A(m,"error")}}};return s`
  ...
  `}function Ko({actor:t,keeper:e,onPokeLodge:n}){if(!e)return null;const a=qo(e),i=xs.value[e.name]??!1,o=Ss.value[e.name]??!1,r=(a==null?void 0:a.next_action_path)??"direct_message",c=(a==null?void 0:a.recoverable)??r==="recover";return s`
    <div class="control-actions">
      <button
  ...
  `}const ci=f(null);function oa(t){ci.value=t,Kn(t.name)}function Ii(){ci.value=null}const Se=[{level:"L1_Reactive",label:"L1 Reactive",color:"#6b7280"},{level:"L2_Suggestive",label:"L2 Suggestive",color:"#3b82f6"},{level:"L3_Guided",label:"L3 Guided",color:"#f59e0b"},{level:"L4_Autonomous",label:"L4 Autonomous",color:"#f97316"},{level:"L5_Independent",label:"L5 Independent",color:"#ef4444"}];function sd(t){if(!t)return 0;const e=Se.findIndex(n=>n.level===t);return e>=0?e:0}function id({keeper:t}){const e=sd(t.autonomy_level),n=Se[e]??Se[0];if(!n)return null;const a=(e+1)/Se.length*100;return s`
  ...
  `}function rd({keeper:t}){var m,d;const e=t.metrics_series??[];if(e.length<2){const l=(((m=t.context)==null?void 0:m.context_ratio)??0)*100,g=l>85?"#ef4444":l>70?"#f59e0b":"#22c55e";return s`
      <div class="context-chart">
        <div class="chart-bar-bg">
          <div class="chart-bar" style="width:${l.toFixed(1)}%;background:${g}"></div>
        </div>
        <span class="chart-pct">${l.toFixed(1)}%</span>
      </div>`}const n=200,a=60,i=2,o=e.length,r=e.map((l,g)=>{const y=i+g/(o-1)*(n-2*i),x=a-i-(l.context_ratio??0)*(a-2*i);return{x:y,y:x,p:l}}),c=r.map(({x:l,y:g})=>`${l.toFixed(1)},${g.toFixed(1)}`).join(" "),p=(((d=e[e.length-1])==null?void 0:d.context_ratio)??0)*100,_=p>85?"#ef4444":p>70?"#f59e0b":"#22c55e";return s`
  ...
  `}function Fi(){var ut,ct,se,St,At,B,X,k,Lt,Jt,ie,oe,I,Dt,re,Be,We;const t=ne.value,e=kt.value,n=gt.value,a=Gt.value,i=Co.value,o=(ut=t==null?void 0:t.monitoring)==null?void 0:ut.board,r=(ct=t==null?void 0:t.monitoring)==null?void 0:ct.council,c=jt.value,p=new Map(e.map(v=>[pe(v.name),v])),_=Ia.value,m=e.map(v=>{var hi;const N=_.get(pe(v.name))??{activeAssignedCount:0,lastActivityAt:null,lastActivityText:null},j=N.lastActivityAt??v.last_seen??null,Z=j?Math.max(0,Date.now()-J(j)):Number.POSITIVE_INFINITY,z=N.activeAssignedCount,dt=!!((hi=v.current_task)!=null&&hi.trim()),G=dt||z>0;let V="ok",$t="Fresh and ready",$e=!1,he=!1;return v.status==="offline"||v.status==="inactive"?(V=G?"bad":"warn",$t=G?"Load without an available owner":"Offline"):G&&Z>Ba?(V="bad",$t="Execution is stale"):z>0&&!dt?(V="warn",$t="Claimed work has no current_task",he=!0):dt&&z===0?(V="warn",$t="current_task has no claimed work",he=!0):!G&&Z<=Ua?(V="ok",$t="Dispatchable now",$e=!0):!G&&Z>Ba?(V="warn",$t="Idle but not freshly active"):G&&Z>Ua&&(V="warn",$t="Execution is getting quiet"),{agent:v,lastSignalAt:j,activeTaskCount:z,tone:V,note:$t,focus:st(v.current_task)??N.lastActivityText??($e?"Ready for assignment.":"Waiting for a clearer signal."),dispatchable:$e,drift:he}}).sort((v,N)=>{const j=tt(N.tone)-tt(v.tone);return j!==0?j:J(N.lastSignalAt)-J(v.lastSignalAt)}),d=a.map(v=>{var V;const N=No.value.get(v.name)??"idle",j=Ro.value.has(v.name),Z=v.context_ratio??0,z=v.diagnostic??null;let dt="ok",G="Healthy keeper";return j||v.status==="offline"||N==="handoff-imminent"||(z==null?void 0:z.health_state)==="offline"||(z==null?void 0:z.health_state)==="degraded"?(dt="bad",G=st(z==null?void 0:z.summary,56)??(j?"Heartbeat stale":N==="handoff-imminent"?"Handoff imminent":(z==null?void 0:z.health_state)==="degraded"?"Keeper degraded":"Keeper offline")):((z==null?void 0:z.health_state)==="stale"||Z>=Oi||N==="preparing"||N==="compacting")&&(dt="warn",G=st(z==null?void 0:z.summary,56)??(Z>=Oi?"High context pressure":`Lifecycle ${N}`)),{keeper:v,tone:dt,note:G,focus:st(z==null?void 0:z.summary,120)??st((V=v.agent)==null?void 0:V.current_task)??v.skill_primary??v.last_proactive_reason??v.memory_recent_note??"No active focus",timestamp:v.last_heartbeat??null}}).sort((v,N)=>{const j=tt(N.tone)-tt(v.tone);return j!==0?j:J(N.timestamp)-J(v.timestamp)}),l=n.filter(v=>v.status==="todo"||v.status==="claimed"||v.status==="in_progress").map(v=>{var $e,he;const N=v.assignee?p.get(pe(v.assignee))??null:null,j=N?_.get(pe(N.name))??null:null,Z=(j==null?void 0:j.lastActivityAt)??(N==null?void 0:N.last_seen)??null,z=Z?Math.max(0,Date.now()-J(Z)):Number.POSITIVE_INFINITY,dt=v.status==="claimed"||v.status==="in_progress";let G="ok",V="Covered",$t=!1;return v.assignee?!N||N.status==="offline"||N.status==="inactive"?(G="bad",V="Assigned owner is unavailable",$t=!0):dt&&z>Ba?(G="bad",V="Execution has lost a fresh signal"):dt&&z>Ua?(G="warn",V="Execution is drifting quiet"):v.status==="todo"&&Ot(v.priority)<=2&&!(($e=N.current_task)!=null&&$e.trim())&&((j==null?void 0:j.activeAssignedCount)??0)===0?(G="ok",V="Ready for dispatch"):dt&&!((he=N.current_task)!=null&&he.trim())&&(G="warn",V="Owner focus is not explicit"):(G=Ot(v.priority)<=2?"bad":"warn",V=dt?"Active work has no owner":"Ready work has no owner",$t=!0),{task:v,owner:N,lastSignalAt:Z,tone:G,note:V,focus:st(N==null?void 0:N.current_task)??(j==null?void 0:j.lastActivityText)??st(v.description)??"Needs operator attention.",ownerGap:$t}}).sort((v,N)=>{const j=tt(N.tone)-tt(v.tone);if(j!==0)return j;const Z=Ot(v.task.priority)-Ot(N.task.priority);return Z!==0?Z:J(N.lastSignalAt??N.task.updated_at??N.task.created_at)-J(v.lastSignalAt??v.task.updated_at??v.task.created_at)}),g=l.filter(v=>v.task.status==="todo"&&Ot(v.task.priority)<=2),y=l.filter(v=>v.ownerGap).length,x=m.filter(v=>v.dispatchable),C=m.filter(v=>v.drift||v.tone!=="ok"),E=d.filter(v=>v.tone!=="ok"),L=t!=null&&t.paused?"bad":((se=t==null?void 0:t.data_quality)==null?void 0:se.board_contract_ok)===!1||((St=t==null?void 0:t.data_quality)==null?void 0:St.council_feed_ok)===!1?"warn":c?"ok":"warn",O=[];t!=null&&t.paused&&O.push({key:"paused",tone:"bad",title:"Room is paused",detail:t.tempo?`Tempo is ${t.tempo}. Resume from Ops when ready.`:"Resume from Ops when ready.",timestamp:((At=t.data_quality)==null?void 0:At.last_sync_at)??null,action:()=>Mt("ops")}),c||O.push({key:"live-connection",tone:"warn",title:"Live feed is reconnecting",detail:"Dashboard telemetry is stale until the SSE stream recovers.",timestamp:null,action:gd}),be(o==null?void 0:o.alert_level)!=="ok"&&O.push({key:"board-monitor",tone:be(o==null?void 0:o.alert_level),title:"Board feed needs attention",detail:`Freshness ${Ga(o==null?void 0:o.last_activity_age_s)} · ${(o==null?void 0:o.unanswered_posts)??0} unanswered posts.`,timestamp:null,action:()=>Mt("board")}),be(r==null?void 0:r.alert_level)!=="ok"&&O.push({key:"council-monitor",tone:be(r==null?void 0:r.alert_level),title:"Council quorum risk is elevated",detail:`${(r==null?void 0:r.sessions_without_quorum)??0} sessions without quorum · freshness ${Ga(r==null?void 0:r.last_activity_age_s)}.`,timestamp:null,action:()=>Mt("board")}),(((B=t==null?void 0:t.data_quality)==null?void 0:B.board_contract_ok)===!1||((X=t==null?void 0:t.data_quality)==null?void 0:X.council_feed_ok)===!1)&&O.push({key:"data-quality",tone:"warn",title:"Dashboard data quality is degraded",detail:`${((k=t.data_quality)==null?void 0:k.board_contract_ok)===!1?"Board contract":"Board contract ok"} · ${((Lt=t.data_quality)==null?void 0:Lt.council_feed_ok)===!1?"Council feed degraded":"Council feed ok"}.`,timestamp:((Jt=t.data_quality)==null?void 0:Jt.last_sync_at)??null,action:()=>Mt("ops")});const R=[...O,...l.filter(v=>v.tone!=="ok").slice(0,3).map(v=>({key:`task-${v.task.id}`,tone:v.tone,title:v.task.title,detail:`${v.note} · ${v.focus}`,timestamp:v.lastSignalAt??v.task.updated_at??v.task.created_at??null,action:()=>Mt("overview")})),...E.slice(0,2).map(v=>({key:`keeper-${v.keeper.name}`,tone:v.tone,title:v.keeper.name,detail:`${v.note} · ${v.focus}`,timestamp:v.timestamp,action:()=>oa(v.keeper)})),...C.slice(0,2).map(v=>({key:`agent-${v.agent.name}`,tone:v.tone,title:v.agent.name,detail:`${v.note} · ${v.focus}`,timestamp:v.lastSignalAt,action:()=>Pe(v.agent.name)}))].sort((v,N)=>{const j=tt(N.tone)-tt(v.tone);return j!==0?j:J(N.timestamp)-J(v.timestamp)}).slice(0,8),D=Wa.value;return s`
    ...
    <${w} title="Room Health" class="section">
      ...
      <div class="overview-health-grid">
        <div class="stat-card">
          ...
          <div class="stat-value" style=${`color:${c?"#4ade80":"#fbbf24"}`}>${c?"Online":"Retrying"}</div>
          <div class="monitor-stat-caption">${Tn.value} events seen in this session</div>
        </div>
        <div class="stat-card">
          <div class="stat-label">Board Feed</div>
          <div class="stat-value" style=${`color:${Pn(be(o==null?void 0:o.alert_level))}`}>${ji(o==null?void 0:o.alert_level)}</div>
          <div class="monitor-stat-caption">Freshness ${Ga(o==null?void 0:o.last_activity_age_s)}</div>
        </div>
        <div class="stat-card">
          <div class="stat-label">Council Feed</div>
          <div class="stat-value" style=${`color:${Pn(be(r==null?void 0:r.alert_level))}`}>${ji(r==null?void 0:r.alert_level)}</div>
  ...
  `}function Nu(){const t=vi(),e=t==null?void 0:t.swarm_status,n=t==null?void 0:t.swarm_proof,a=(e==null?void 0:e.lanes.filter(p=>p.present))??[],i=(e==null?void 0:e.gaps.items)??[],o=(e==null?void 0:e.timeline.slice(0,6))??[],r=e==null?void 0:e.overview,c=e==null?void 0:e.recommended_next_action;return s`
    <section class="card command-section">
      ...
      ${e?s`
            <div class="command-summary-grid command-swarm-summary">
              ...
              <div class="monitor-stat-card"><span>Next Action</span><strong>${(c==null?void 0:c.label)??"Observe operator state"}</strong><small>${(c==null?void 0:c.tool)??"masc_operator_snapshot"}</small></div>
            </div>
            ...
            <div class="command-swarm-layout">
              ...
              <div class="command-card-stack">
                <div class="command-guide-card highlight">
                  <div class="command-guide-head">
                    <strong>${(c==null?void 0:c.label)??"Observe operator state"}</strong>
                    <span class="command-chip">${(c==null?void 0:c.lane_id)??"global"}</span>
                  </div>
                  <p>${(c==null?void 0:c.reason)??"No active swarm lane is visible yet."}</p>
  ...
  `}function Lu(){var St,At,B,X,k,Lt,Jt,ie,oe;const t=vi(),e=Kt.value,n=ne.value,a=_u(),i=a?kt.value.find(I=>I.name===a)??null:null,o=a?gt.value.filter(I=>I.assignee===a&&yu(I)):[],r=((St=t==null?void 0:t.operations.summary)==null?void 0:St.active)??0,c=((At=t==null?void 0:t.detachments.summary)==null?void 0:At.total)??0,p=((B=t==null?void 0:t.decisions.summary)==null?void 0:B.pending)??0,_=e==null?void 0:e.detachments.detachments.find(I=>{const Dt=I.detachment.heartbeat_deadline,re=Dt?Date.parse(Dt):Number.NaN;return I.detachment.status==="stalled"||!Number.isNaN(re)&&re<=Date.now()}),m=e==null?void 0:e.alerts.alerts.find(I=>I.severity==="bad"),d=!!(n!=null&&n.room||n!=null&&n.project),l=(i==null?void 0:i.current_task)??null,g=hu(i==null?void 0:i.last_seen),y=g!=null?g<=120:null,x=[d?{title:"Room readiness",tone:"ok",detail:`${(n==null?void 0:n.room)??(n==null?void 0:n.project)??"unknown"} · base ${(n==null?void 0:n.room_base_path)??"n/a"}`,tool:"masc_status"}:{title:"Room readiness",tone:"bad",detail:"No room snapshot yet. Set room to repo root before joining.",tool:"masc_set_room"},a?i?o.length===0?{title:"Task readiness",tone:"warn",detail:`${a} has no claimed task. Claim one or create one first.`,tool:gt.value.length>0?"masc_claim":"masc_add_task"}:l?y===!1?{title:"Task readiness",tone:"warn",detail:`${a} current_task=${l}, but heartbeat is stale (${g}s).`,tool:"masc_heartbeat"}:{title:"Task readiness",tone:"ok",detail:`${a} current_task=${l}${g!=null?` · last seen ${g}s ago`:""}`,tool:"masc_plan_get_task"}:{title:"Task readiness",tone:"bad",detail:`${a} has a claimed task but no session current_task binding.`,tool:"masc_plan_set_task"}:{title:"Task readiness",tone:"bad",detail:`${a} is not visible in the room roster.`,tool:"masc_join"}:{title:"Task readiness",tone:"warn",detail:"No ?agent= query param. Dashboard can show room health but not agent-specific next steps.",tool:"masc_join"},!t||(((X=t.topology.summary)==null?void 0:X.managed_unit_count)??0)===0?{title:"Operation readiness",tone:"warn",detail:"No managed units defined yet. CPv2 benchmark cannot start before hierarchy exists.",tool:"masc_unit_define"}:r===0?{title:"Operation readiness",tone:"warn",detail:`${((k=t.topology.summary)==null?void 0:k.managed_unit_count)??0} managed units are ready, but there is no active operation.`,tool:"masc_operation_start"}:{title:"Operation readiness",tone:"ok",detail:`${r} active operation(s) across ${((Lt=t.topology.summary)==null?void 0:Lt.managed_unit_count)??0} managed unit(s).`,tool:"masc_observe_operations"},p>0?{title:"Dispatch readiness",tone:"warn",detail:`${p} pending approval(s) are blocking strict actions.`,tool:"masc_policy_approve"}:r>0&&c===0?{title:"Dispatch readiness",tone:"bad",detail:"Active operation exists but no detachment has been materialized yet.",tool:"masc_dispatch_tick"}:_||m?{title:"Dispatch readiness",tone:"warn",detail:`Dispatch needs reconciliation${_?` · detachment ${_.detachment.detachment_id} is stalled`:""}${m?` · alert ${m.title??m.alert_id}`:""}${!e&&!_&&!m?" · open a detail tab to inspect the exact source.":""}.`,tool:p>0?"masc_policy_approve":"masc_dispatch_tick"}:{title:"Dispatch readiness",tone:"ok",detail:`${c} detachment(s) visible and no strict approval backlog${e?"":" · detail panes stay lazy until opened."}.`,tool:"masc_detachment_list"}],C=d?!a||!i?"masc_join":o.length===0?gt.value.length>0?"masc_claim":"masc_add_task":l?y===!1?"masc_heartbeat":!t||(((Jt=t.topology.summary)==null?void 0:Jt.managed_unit_count)??0)===0?"masc_unit_define":r===0?"masc_operation_start":p>0?"masc_policy_approve":r>0&&c===0||_||m?"masc_dispatch_tick":"masc_observe_traces":"masc_plan_set_task":"masc_set_room",E=bu(C),O=ku(C==="masc_set_room"?["repo-root-room"]:C==="masc_plan_set_task"?["claimed-not-current"]:C==="masc_heartbeat"?["heartbeat-stale"]:C==="masc_dispatch_tick"?["no-detachments"]:C==="masc_policy_approve"?["pending-approval"]:["repo-root-room","claimed-not-current","heartbeat-stale"]).slice(0,2),R=Va("room_task_hygiene"),D=Va("cpv2_benchmark"),ut=Va("supervisor_session"),ct=((ie=Rn.value)==null?void 0:ie.docs)??[],se=[R,D,ut].filter(I=>I!==null);return s`
  ...
  `}function zu({row:t}){var c,p,_;const e=t.unit,n=`freeze:${e.unit_id}`,a=`kill:${e.unit_id}`,i=!!((c=e.policy)!=null&&c.frozen),o=!!((p=e.policy)!=null&&p.kill_switch),r=Math.round((t.utilization??0)*100);return s`
    <article class="command-card compact">
      <div class="command-card-head">
        <div>
  ...
  `}function Ku(){var n,a,i,o,r,c,p,_,m,d,l,g,y,x,C,E;const t=Bo.value,e=$u();return s`
      ...
      <section class="card command-section">
        ...
        ${Ms.value?s`<div class="empty-state">Loading swarm live state…</div>`:ma.value?s`<div class="empty-state error">${ma.value}</div>`:t?s`
                  <div class="command-summary-grid">
                    ...
                    <div class="monitor-stat-card"><span>Runtime</span><strong>${((r=t.provider)==null?void 0:r.active_slots_now)??0}/${((c=t.provider)==null?void 0:c.total_slots)??0}</strong><small>peak ${((p=t.summary)==null?void 0:p.peak_hot_slots)??0} · ctx ${((_=t.provider)==null?void 0:_.ctx_per_slot)??0}</small></div>
    ...
    <section class="ops-view">
      ...
      <div class="ops-grid">
        ...
        <section class="card ops-panel">
          ...
          ></textarea>
          <div class="control-row">
            <button class="control-btn" onClick=${()=>{fp()}} disabled=${H.value||!c||on.value.trim()===""}>
              Send Keeper Message
            </button>
          </div>
        </section>
...
`),n=[];let a=0;for(;a<e.length;){const i=e[a];if(/^(`{3,}|~{3,})/.test(i)){const r=i.match(/^(`{3,}|~{3,})/)[0],c=i.slice(r.length).trim(),p=[];for(a++;a<e.length&&!e[a].startsWith(r);)p.push(e[a]),a++;a++,n.push(s`<pre><code class=${c?`language-${c}`:""}>${p.join(`
`)}</code></pre>`);continue}if(i.trim()==="<think>"||i.trim().startsWith("<think>")){const r=[],c=i.trim().replace(/^<think>/,"").trim();for(c&&c!=="</think>"&&r.push(c),a++;a<e.length&&!e[a].includes("</think>");)r.push(e[a]),a++;if(a<e.length){const _=e[a].replace("</think>","").trim();_&&r.push(_),a++}const p=r.join(`
`).trim();n.push(s`
...
`))}</p>`)}return n}function Qa(t){const e=[],n=/(`[^`]+`)|(\*\*[^*]+\*\*)|(\*[^*]+\*)|\[([^\]]+)\]\(([^)]+)\)/g;let a=0,i;for(;(i=n.exec(t))!==null;){if(i.index>a&&e.push(t.slice(a,i.index)),i[1]){const o=i[1].slice(1,-1);e.push(s`<code>${o}</code>`)}else if(i[2]){const o=i[2].slice(2,-2);e.push(s`<strong>${o}</strong>`)}else if(i[3]){const o=i[3].slice(1,-1);e.push(s`<em>${o}</em>`)}else i[4]&&i[5]&&e.push(s`<a href=${i[5]} target="_blank" rel="noopener">${i[4]}</a>`);a=i.index+i[0].length}return a<t.length&&e.push(t.slice(a)),e.length>0?e:[t]}const Ze=f("posts"),Ks=f([]),Hs=f([]),rn=f(""),xa=f(!1),ln=f(!1),An=f(""),Sa=f(null),Tt=f(null),Us=f(!1),Yt=f(null),Jn=f(null);async function Oa(){xa.value=!0,An.value="";try{const[t,e]=await Promise.all([Gl(),Jl()]);Ks.value=t,Hs.value=e,Yt.value=!0,Jn.value=Date.now()}catch(t){An.value=t instanceof Error?t.message:"Failed to load council data",Yt.value=!1}finally{xa.value=!1}}Ec(Oa);async function Gi(){const t=rn.value.trim();if(t){ln.value=!0;try{const e=await Vl(t);rn.value="",A(e!=null&&e.id?`Debate started: ${e.id}`:"Debate started","success"),await Oa()}catch(e){const n=e instanceof Error?e.message:"Failed to start debate";A(n,"error")}finally{ln.value=!1}}}async function yp(t){Sa.value=t,Us.value=!0,Tt.value=null;try{Tt.value=await Ql(t)}catch(e){An.value=e instanceof Error?e.message:"Failed to load debate status",Tt.value=null}finally{Us.value=!1}}const rr=[{id:"hot",label:"Hot"},{id:"trending",label:"Trending"},{id:"recent",label:"Recent"},{id:"updated",label:"Updated"},{id:"discussed",label:"Discussed"}],Vn=f(null),cn=f([]),ge=f(!1),ve=f(null),dn=f("");function bp(){var e,n;const t=new URLSearchParams(window.location.search);return((e=t.get("agent"))==null?void 0:e.trim())||((n=t.get("agent_name"))==null?void 0:n.trim())||"dashboard-user"}const kp=f(bp()),un=f(!1);async function fi(t){ve.value=t,Vn.value=null,cn.value=[],ge.value=!0;try{const e=await _l(t);if(ve.value!==t)return;Vn.value={id:e.id,author:e.author,title:e.title,content:e.content,tags:e.tags,votes:e.votes,vote_balance:e.vote_balance,comment_count:e.comment_count,created_at:e.created_at,updated_at:e.updated_at,flair:e.flair,hearth_count:e.hearth_count},cn.value=e.comments??[]}catch{ve.value===t&&(Vn.value=null,cn.value=[])}finally{ve.value===t&&(ge.value=!1)}}async function Ji(t){const e=dn.value.trim();if(e){un.value=!0;try{await $l(t,kp.value,e),dn.value="",A("Comment posted","success"),await fi(t),zt()}catch{A("Failed to post comment","error")}finally{un.value=!1}}}function xp(){const t=hn.value;return s`
  ...
  `}function Cp({post:t}){ve.value!==t.id&&!ge.value&&fi(t.id);const e=async n=>{try{await $o(t.id,n),zt()}catch{A("Failed to vote","error")}};return s`
    <div>
      ...
      <${w} title="Comments (${ge.value?"...":cn.value.length})">
        ${ge.value?s`<div class="loading-indicator">Loading comments...</div>`:s`<${wp} comments=${cn.value} />`}
        <${Tp} postId=${t.id} />
      <//>
    </div>
  ...
  `}function Ep(){var i,o;const t=Ke.value,e=Nt.value.postId,n=((o=(i=ne.value)==null?void 0:i.data_quality)==null?void 0:o.board_contract_ok)===!1,a=Ze.value;if(bt(()=>{(a==="debates"||a==="voting")&&Oa()},[a]),e){const r=t.find(c=>c.id===e)??(ve.value===e?Vn.value:null);return!r&&ve.value!==e&&!ge.value&&fi(e),r?s`
          <${Bs} />
          <${Ws} />
          <${Cp} post=${r} />
        `:s`
          <div>
            ...
            <${Ws} />
            <button class="back-btn" onClick=${()=>Mt("board")}>← Back to Board</button>
            ${ge.value?s`<div class="loading-indicator">Loading post...</div>`:s`
                  <div class="empty-state">
  ...
  `}const Mp=40;function Op({items:t,itemHeight:e,overscan:n=5,renderItem:a,getKey:i,className:o=""}){const r=Tr(null),[c,p]=ni({start:0,end:30}),_=t.length>Mp;if(bt(()=>{if(!_)return;const g=r.current;if(!g)return;let y=!1;const x=()=>{const{scrollTop:O,clientHeight:R}=g,D=Math.max(0,Math.floor(O/e)-n),ut=Math.min(t.length,Math.ceil((O+R)/e)+n);p(ct=>ct.start===D&&ct.end===ut?ct:{start:D,end:ut})};let C=!1;const E=()=>{C||y||(C=!0,requestAnimationFrame(()=>{y||x(),C=!1}))},L=new ResizeObserver(()=>{y||x()});return x(),g.addEventListener("scroll",E,{passive:!0}),L.observe(g),()=>{y=!0,g.removeEventListener("scroll",E),L.disconnect()}},[_,t.length,e,n]),!_)return s`
      <div class=${o}>
        ${t.map((g,y)=>a(g,y))}
      </div>
    `;const m=t.length*e,d=c.start*e,l=t.slice(c.start,c.end);return s`
    <div ref=${r} class=${o}>
      <div class="virtual-list-spacer" style=${{height:`${m}px`,position:"relative"}}>
        ...
        >
          ${l.map((g,y)=>{const x=c.start+y;return s`<div key=${i(g)}>${a(g,x)}</div>`})}
        </div>
      </div>
    </div>
  ...
  `}function ur({ratio:t,size:e=40,stroke:n=4}){if(t==null)return null;const a=(e-n)/2,i=e/2,o=2*Math.PI*a,r=o*((100-t*100)/100);let c="mitosis-safe";return t>=.8?c="mitosis-critical":t>=.5&&(c="mitosis-warn"),s`
  ...
  `}function mm(){const t=[...kt.value].map(cm).sort((m,d)=>{const l=xe(d.tone)-xe(m.tone);if(l!==0)return l;const g=d.activeTaskCount-m.activeTaskCount;return g!==0?g:Vt(d.lastSignalAt)-Vt(m.lastSignalAt)}),e=[...Gt.value].map(dm).sort((m,d)=>{const l=xe(d.tone)-xe(m.tone);if(l!==0)return l;const g=(d.keeper.context_ratio??0)-(m.keeper.context_ratio??0);return g!==0?g:Vt(d.keeper.last_heartbeat)-Vt(m.keeper.last_heartbeat)}),n=t.filter(m=>m.state!=="offline"),a=t.filter(m=>m.state==="offline"),i=n.length,o=t.filter(m=>m.state==="working").length,r=t.filter(m=>m.lastSignalAt&&Date.now()-Vt(m.lastSignalAt)<=12e4).length,c=t.filter(m=>m.tone!=="ok"),p=e.filter(m=>m.tone!=="ok"),_=[...p.map(m=>({kind:"keeper",key:`keeper-${m.keeper.name}`,tone:m.tone,title:m.keeper.name,subtitle:`${m.note} · ${m.focus}`,timestamp:m.keeper.last_heartbeat??null,keeper:m.keeper})),...c.map(m=>({kind:"agent",key:`agent-${m.agent.name}`,tone:m.tone,title:m.agent.name,subtitle:`${m.note} · ${m.focus}`,timestamp:m.lastSignalAt,agent:m.agent}))].sort((m,d)=>{const l=xe(d.tone)-xe(m.tone);return l!==0?l:Vt(d.timestamp)-Vt(m.timestamp)}).slice(0,8);return s`
    <div class="agents-monitor">
      <div class="stats-grid">
        ...
        <${Ye} label="Agent alerts" value=${c.length} color=${c.length>0?"#fb7185":"#4ade80"} caption="quiet or offline" />
  ...
  `}function xm(){const t=vm.value,e=fm.value,n=e.filter(c=>c.status==="running").length,a=e.filter(c=>c.recoverable).length,i=yn.value.filter(c=>c.status==="active").length,o=Cs.value,r=o==="idle"?"No loop running":o==="error"?Ns.value??"MDAL snapshot unavailable":"Current loop snapshot";return s`
    <div>
      <div class="stats-grid">
        <div class="stat-card">
      ...
      <${w} title="Planning Surface" class="section">
        <div class="planning-header">
          ...
          <div class="planning-actions">
            <button class="control-btn ghost" onClick=${kn} disabled=${Ce.value}>
              ${Ce.value?"Refreshing goals...":"Refresh goals"}
            </button>
            <button class="control-btn ghost" onClick=${Oe} disabled=${Ne.value}>
              ${Ne.value?"Refreshing loops...":"Refresh loops"}
            </button>
            <button
              class="control-btn secondary"
              onClick=${()=>{kn(),Oe()}}
      ...
      ${Ce.value&&yn.value.length===0?s`<div class="loading-indicator">Loading goals...</div>`:Qs.value.length===0?s`<div class="empty-state">No goals match the current filters</div>`:s`
      ...
      <${w} title="MDAL Loops" class="section">
        ${Ne.value&&e.length===0?s`<div class="loading-indicator">Loading MDAL loops...</div>`:e.length===0&&o==="error"?s`
                <div class="empty-state">
              ...
              `:e.length===0?s`
                ...
                <div class="planning-loop-list">
                  ${e.map(c=>s`<${bm} key=${c.loop_id} loop=${c} />`)}
                </div>
              `}
      <//>
...
`))}function zm({hp:t,max:e}){const n=wm(t,e),a=Am(t,e);return s`
  ...
  `}function fr({actor:t}){var p,_,m,d;const e=(p=t.archetype)==null?void 0:p.trim(),n=(_=t.persona)==null?void 0:_.trim(),a=(m=t.portrait)==null?void 0:m.trim(),i=(d=t.background)==null?void 0:d.trim(),o=t.traits??[],r=t.skills??[],c=Object.entries(t.stats_raw??{}).filter(([l,g])=>Number.isFinite(g)).filter(([l])=>!Lm.has(l.toLowerCase()));return s`
  ...
  `}function Km({events:t}){const e="__none__",n=ms.value,a=vs.value,i=fs.value,o=Array.from(new Set(t.map(Xs).map(d=>d.trim()).filter(d=>d!==""))).sort((d,l)=>d.localeCompare(l)),r=Array.from(new Set(t.map(d=>(d.type??"").trim()).filter(d=>d!==""))).sort((d,l)=>d.localeCompare(l)),c=t.some(d=>(d.type??"").trim()===""),p=Array.from(new Set(t.map(d=>(d.phase??"").trim()).filter(d=>d!==""))).sort((d,l)=>d.localeCompare(l)),_=t.some(d=>(d.phase??"").trim()===""),m=t.filter(d=>{if(n!=="all"&&Xs(d)!==n)return!1;const l=(d.type??"").trim(),g=(d.phase??"").trim();if(a===e){if(l!=="")return!1}else if(a!=="all"&&l!==a)return!1;if(i===e){if(g!=="")return!1}else if(i!=="all"&&g!==i)return!1;return!0});return s`
    <div class="trpg-story-toolbar">
      <div class="trpg-story-filter">
        <label>Actor</label>
        <select value=${n} onChange=${d=>{ms.value=d.target.value}}>
      ...
      <div class="trpg-story-filter">
        <label>Type</label>
        <select value=${a} onChange=${d=>{vs.value=d.target.value}}>
          <option value="all">all</option>
      ...
      <div class="trpg-story-filter">
        <label>Phase</label>
        <select value=${i} onChange=${d=>{fs.value=d.target.value}}>
          <option value="all">all</option>
  ...
  `}function Um({state:t,nowMs:e}){var _;const n=Ht.value||((_=t.session)==null?void 0:_.room)||"",a=On.value,i=t.party??[];if(!i.find(m=>m.id===we.value)&&i.length>0){const m=i[0];m&&(we.value=m.id)}const r=async()=>{var d,l;if(!n){A("Room ID가 비어 있습니다.","error");return}if(!Yn(e))return;const m=((d=t.current_round)==null?void 0:d.phase)??((l=t.session)==null?void 0:l.status)??"unknown";if(Zs("라운드 실행",n,m)){On.value="running";try{const g=await Il(n);Ys.value=g,On.value="ok";const y=Zt(g.summary)?g.summary:null,x=y?wn(y,"advanced",!1):!1,C=y?mt(y,"progress_reason",""):"";A(x?"라운드가 정상 진행되었습니다.":`라운드가 정체되었습니다${C?`: ${C}`:""}`,x?"success":"warning"),qt()}catch(g){Ys.value=null,On.value="error";const y=g instanceof Error?g.message:"라운드 실행에 실패했습니다.";A(y,"error")}finally{Ta()}}},c=async()=>{var d,l;if(!n||!Yn(e))return;const m=((d=t.current_round)==null?void 0:d.phase)??((l=t.session)==null?void 0:l.status)??"unknown";if(Zs("턴 강제 진행",n,m))try{await Ol(n),A("턴을 다음 단계로 이동했습니다.","success"),qt()}catch{A("턴 이동에 실패했습니다.","error")}finally{Ta()}},p=async()=>{if(!n||!Yn(e))return;const m=we.value.trim();if(!m){A("먼저 Actor를 선택하세요.","warning");return}const d=Number.parseInt(es.value,10),l=Number.parseInt(ns.value,10);if(Number.isNaN(d)||Number.isNaN(l)){A("stat/dc는 숫자여야 합니다.","warning");return}const g=Number.parseInt(Mn.value,10),y=Mn.value.trim()===""||Number.isNaN(g)?void 0:g;try{await Ml({roomId:n,actorId:m,action:ts.value.trim()||"ability_check",statValue:d,dc:l,rawD20:y}),A("주사위 판정을 기록했습니다.","success"),qt()}catch{A("주사위 판정 기록에 실패했습니다.","error")}};return s`
    <div class="trpg-control-box">
      <div class="trpg-control-grid">
        ...
        <div class="trpg-control-field">
          ...
          <select
            value=${we.value}
            onChange=${m=>{we.value=m.target.value}}
          >
  ...
  `}function Bm({state:t}){var i;const e=Ht.value||((i=t.session)==null?void 0:i.room)||"",n=jn.value,a=async()=>{if(!e){A("Room ID가 비어 있습니다.","warning");return}const o=qn.value.trim(),r=os.value.trim();if(!r&&!o){A("이름 또는 Actor ID를 입력하세요.","warning");return}const c=Number.parseInt(pn.value.trim(),10),p=Number.parseInt(us.value.trim(),10),_=Number.isFinite(p)?Math.max(1,p):20,m=Number.isFinite(c)?Math.max(0,Math.min(_,c)):_;let d={};try{d=Dm(ps.value)}catch(l){A(l instanceof Error?l.message:"능력치 JSON 오류","error");return}jn.value="spawning";try{const l=typeof crypto<"u"&&typeof crypto.randomUUID=="function"?`trpg_spawn_${crypto.randomUUID()}`:`trpg_spawn_${Date.now().toString(36)}_${Math.random().toString(36).slice(2,10)}`,g=await zl(e,{actor_id:o||void 0,name:r||void 0,role:rs.value,idempotencyKey:l,portrait:cs.value.trim()||void 0,background:ds.value.trim()||void 0,hp:m,max_hp:_,alive:m>0,stats:Object.keys(d).length>0?d:void 0}),y=typeof g.actor_id=="string"?g.actor_id.trim():"";if(!y)throw new Error("생성 응답에 actor_id가 없습니다.");const x=ls.value.trim();x&&await ql(e,y,x),we.value=y,Qt.value=y,o||(qn.value=""),jn.value="ok",A(`Actor 생성 완료: ${y}`,"success"),await qt()}catch(l){jn.value="error",A(l instanceof Error?l.message:"Actor 생성에 실패했습니다.","error")}};return s`
    <div class="trpg-control-box">
      <div class="trpg-control-grid">
        <div class="trpg-control-field">
          <label>Name</label>
  ...
  `}function Wm({state:t,nowMs:e}){var l;const n=Ht.value||((l=t.session)==null?void 0:l.room)||"",a=t.join_gate,i=is.value,o=Zt(i)?i:null,r=(t.party??[]).filter(g=>g.role!=="dm"),c=Qt.value.trim(),p=r.some(g=>g.id===c),_=p?c:c?"__manual__":"",m=async()=>{const g=Qt.value.trim(),y=zn.value.trim();if(!n||!g){A("Room/Actor가 필요합니다.","warning");return}yt.value="checking";try{const x=await jl(n,g,y||void 0);is.value=x,yt.value="ok",A("참가 가능 여부를 갱신했습니다.","success")}catch(x){yt.value="error";const C=x instanceof Error?x.message:"참가 가능 여부 확인에 실패했습니다.";A(C,"error")}},d=async()=>{var E,L;const g=Qt.value.trim(),y=zn.value.trim(),x=ss.value.trim();if(!n||!g||!y){A("Room/Actor/Keeper가 필요합니다.","warning");return}if(!Yn(e))return;const C=((E=t.current_round)==null?void 0:E.phase)??((L=t.session)==null?void 0:L.status)??"unknown";if(Zs("Mid-Join 승인 요청",n,C)){yt.value="requesting";try{const O=await Fl({room_id:n,actor_id:g,keeper_name:y,role:as.value,...x?{name:x}:{}});is.value=O;const R=Zt(O)?wn(O,"granted",!1):!1,D=Zt(O)?mt(O,"reason_code",""):"";R?A("Mid-Join이 승인되었습니다.","success"):A(`Mid-Join이 거절되었습니다${D?`: ${D}`:""}`,"warning"),yt.value=R?"ok":"error",qt()}catch(O){yt.value="error";const R=O instanceof Error?O.message:"Mid-Join 요청에 실패했습니다.";A(R,"error")}finally{Ta()}}};return s`
    <div class="trpg-control-box">
      ...
      <div class="trpg-control-grid">
        <div class="trpg-control-field">
          ...
          <select
            value=${_}
            onChange=${g=>{const y=g.target.value;if(y==="__manual__"){(p||!c)&&(Qt.value="");return}Qt.value=y}}
          >
            <option value="">Actor 선택</option>
            ${r.map(g=>s`
        ...
        <div class="trpg-control-field">
          ...
          <div style="display:flex; gap:6px;">
            ...
            <button class="trpg-run-btn recommend" onClick=${d} disabled=${yt.value==="checking"||yt.value==="requesting"}>
  ...
  `:null}function yr(){const t=Ys.value;if(!t)return s`<div class="empty-state" style="font-size:13px;">Run Round 결과가 아직 없습니다.</div>`;const e=t.summary,n=Zt(e)?e:null,i=(Array.isArray(t.statuses)?t.statuses:[]).filter(Zt).slice(-8),o=t.canon_check,r=Zt(o)?o:null,c=r&&Array.isArray(r.warnings)?r.warnings.filter(D=>typeof D=="string").slice(0,3):[],p=r&&Array.isArray(r.violations)?r.violations.filter(D=>typeof D=="string").slice(0,3):[],_=n?wn(n,"advanced",!1):!1,m=n?mt(n,"progress_reason",""):"",d=n?mt(n,"progress_detail",""):"",l=n?It(n,"player_successes",0):0,g=n?It(n,"player_required_successes",0):0,y=n?wn(n,"dm_success",!1):!1,x=n?It(n,"timeouts",0):0,C=n?It(n,"unavailable",0):0,E=n?It(n,"reprompts",0):0,L=n?It(n,"npc_attacks",0):0,O=n?It(n,"keeper_timeout_sec",0):0,R=n?It(n,"roll_audit_count",0):0;return s`
          ...
          <div class="trpg-control-box">
            ...
            ${c.length>0?s`
                <div style="margin-top:6px; font-size:11px; color:#fbbf24;">
                  ${c.map(D=>s`<div>warning: ${D}</div>`)}
                </div>`:null}
          </div>
        `:null}
    </div>
  `}function Gm({state:t,nowMs:e}){var r,c,p;const n=Ht.value||((r=t.session)==null?void 0:r.room)||"",a=((c=t.current_round)==null?void 0:c.phase)??((p=t.session)==null?void 0:p.status)??"unknown",i=mr(e),o=Mm(e);return s`
  ...
  `}function Xm(){var c,p,_,m,d;const t=So.value,e=Ls.value;if(bt(()=>{if(typeof window>"u"||typeof window.setInterval!="function")return;const l=window.setInterval(()=>{eo.value=Date.now()},1e3);return()=>{window.clearInterval(l)}},[]),e&&!t)return s`<div class="loading-indicator">Loading TRPG state...</div>`;if(!t)return s`
      <div class="section">
        <h2>TRPG</h2>
    ...
    <div>
      <div style="display:flex; gap:8px; align-items:center; justify-content:space-between; margin-bottom:8px;">
        <div style="font-size:11px; color:#8ea9d6;">
          room: ${Ht.value||((c=t.session)==null?void 0:c.room)||"-"} · phase: ${((p=t.current_round)==null?void 0:p.phase)??((_=t.session)==null?void 0:_.status)??"-"}
        </div>
...
`).find(a=>a.includes(" joined"))??t).match(/✅\s+(\S+)\s+joined/i);return(n==null?void 0:n[1])??null}async function ti(){const t=ft.value.trim();if(t){gn.value=!0;try{const e=await Hl(t),n=ev(e);n&&$i(n),qa.value=!0,await Ue(),A(`Joined as ${n??t}`,"success")}catch(e){const n=e instanceof Error?e.message:"Failed to join room";A(n,"error")}finally{gn.value=!1}}}async function nv(){const t=ft.value.trim();if(t){_n.value=!0;try{await yo(t),qa.value=!1,await Ue(),A(`Left room (${t})`,"success")}catch(e){const n=e instanceof Error?e.message:"Failed to leave room";A(n,"error")}finally{_n.value=!1}}}async function av(){const t=ft.value.trim();if(t)try{await yo(t)}catch{}localStorage.removeItem(_i),$i("dashboard"),qa.value=!1,await ti()}async function sv(){const t=ft.value.trim();if(t){Ra.value=!0;try{await Ul(t),await Ue(),A("Heartbeat sent","success")}catch(e){const n=e instanceof Error?e.message:"Failed to send heartbeat";A(n,"error")}finally{Ra.value=!1}}}async function no(){const t=ft.value.trim(),e=mn.value.trim();if(!(!t||!e)){fn.value=!0;try{await ho(t,e),mn.value="",await Ue(),A("Broadcast sent","success")}catch(n){const a=n instanceof Error?n.message:"Failed to send broadcast";A(a,"error")}finally{fn.value=!1}}}async function iv(){const t=vn.value.trim(),e=Ca.value.trim()||"Created from dashboard";if(t){Re.value=!0;try{await Kl(t,e,1),vn.value="",Ca.value="",await Ue(),A("Task created","success")}catch(n){const a=n instanceof Error?n.message:"Failed to create task";A(a,"error")}finally{Re.value=!1}}}async function ao(){const t=ft.value.trim()||"dashboard";La.value=!0,Na.value=null;try{const e=await Nn({actor:t,action_type:"lodge_tick",target_type:"room",payload:{}}),n=ii(e.result);br.value=n,await Ue(),n!=null&&n.skipped_reason?A(n.skipped_reason,"warning"):A(n?`Poke finished: ${n.acted}/${n.checked} acted`:"Poke finished",n&&n.acted>0?"success":"warning")}catch(e){const n=e instanceof Error?e.message:"Failed to run Lodge poke";Na.value=n,A(n,"error")}finally{La.value=!1}}function ov({runtime:t}){var i,o;const e=br.value??(t==null?void 0:t.last_tick_result)??null;if(Na.value)return s`<div class="control-result-box is-error">${Na.value}</div>`;if(!e)return s`<div class="control-status-copy">No poke result yet. The latest scheduled tick will appear here after the first run.</div>`;const n=((i=e.skipped_rows)==null?void 0:i.slice(0,3))??[],a=((o=e.passed_rows)==null?void 0:o.slice(0,3))??[];return s`
  ...
  `}function rv(t){return t.find(n=>n.name===tn.value)??t[0]??null}function lv(){var a,i;const t=Gt.value,e=((a=ne.value)==null?void 0:a.lodge)??null,n=rv(t);return bt(()=>{ti()},[]),bt(()=>{var r;const o=((r=t[0])==null?void 0:r.name)??"";if(!tn.value&&o){Kn(o);return}tn.value&&!t.some(c=>c.name===tn.value)&&Kn(o)},[t.map(o=>o.name).join("|")]),s`
    <section class="rail-card control-dock">
      ...
      <div class="control-section">
        ...
        <button
          class="control-btn secondary"
          onClick=${()=>{iv()}}
          disabled=${Re.value||vn.value.trim()===""}
        >
          ${Re.value?"Creating...":"Create Task"}
        </button>
      </div>
    </section>
        ...
        ${so.map(r=>s`
          <div class="rail-nav-group" key=${r.id}>
            ...
            <div class="rail-tab-list">
              ${ei.filter(c=>c.group===r.id).map(c=>s`
                  <button
                    class="rail-tab-btn ${t===c.id?"active":""}"
                    onClick=${()=>Mt(c.id)}
                  >
                    <span class="rail-tab-icon">${c.icon}</span>
