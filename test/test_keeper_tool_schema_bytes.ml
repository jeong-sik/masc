...
(* 2026-09-24: +316 rendered bytes over the 122,275 ceiling above, measured by
   this suite on CI for PR #38835. masc_board_post takes a typed `attachments`
