(** Verification-evidence helpers for coord task lifecycle.
    ...
    These predicates stay in a private implementation module so
    [Coord_task.transition_task_r] can keep the verification gate small
    without exposing a second task-transition surface. *)
