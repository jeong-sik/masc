...
let metric_anti_rationalization_fallback = Otel_metric_store_core.declare_counter "masc_anti_rationalization_fallback_total"

let metric_anti_rationalization_excuse_pattern =
  Otel_metric_store_core.declare_counter "masc_anti_rationalization_excuse_pattern_total"
;;
