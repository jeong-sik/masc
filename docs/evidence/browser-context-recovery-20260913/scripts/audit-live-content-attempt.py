...
print(json.dumps({k:result[k] for k in ['state','outer_call_count','outer_errors','outer_result_bytes','composition_invocations','successful_compositions','observed_elapsed_seconds','answer']},ensure_ascii=False))
