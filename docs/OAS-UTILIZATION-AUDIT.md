...
OAS Pin Snapshot: dependency floor `0.139.0`, runtime pin `main@c502ed64668688a47dc6a70df7c0534f11d37783`, declared base version `v0.139.0`
...
`masc-mcp` keeps the runtime pin ratcheted against upstream `main`, while the dependency floor tracks the pinned SDK declaration in `agent_sdk.opam`. Generated snapshot: runtime pin `main@c502ed64668688a47dc6a70df7c0534f11d37783`, declared base version `v0.139.0`, dependency floor `0.139.0`.
