...
- L4: `merged.md` §L4. WARN 1,145 (09-08T00:02Z..09-11T15:00Z), decisions 796행, 09-10/11 keeper 별 21·16·15·12·11·3, openai insufficient_quota 2,748줄·FAILED 94줄. 코드: `keeper_runtime_failure_route.ml:route_of_api_error` (:181), `keeper_heartbeat_loop.ml:196`, `keeper_direct_runtime_continuation.ml:retry_not_before` (:60-70, `Hard_quota` 는 :67), `keeper_runtime/keeper_terminal_reason.ml:is_authorization_refused_wire`, `keeper_error_classify.ml:recoverable_runtime_failure_reason` (:320, :395), `provider_failure_attribution.ml:ownership_of_provider_failure` (:208).
