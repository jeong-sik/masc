...
(function () {
  ...
  const REPOS = [
    { slug: "runtime",   owner: "masc",   pinned: true,  active_prs: 3, openIssues: 12, dirty: 1, head: "da11b063", desc: "claim-loop, runtime router, Execute output" },
  ...
  const BRANCH_TO_REPO = {
    ...
    "research/runtime-step2": "runtime",
