...
OAS Pin Snapshot: dependency floor `0.121.0`, runtime pin `main@7b70f43ea571bcb1dd16b0fb1b9ee5a6df7d038a`, declared base version `v0.121.0`
...
`masc-mcp` keeps the runtime pin ratcheted against upstream `main`, while the dependency floor tracks the pinned SDK declaration in `agent_sdk.opam`. Generated snapshot: runtime pin `main@7b70f43ea571bcb1dd16b0fb1b9ee5a6df7d038a`, declared base version `v0.121.0`, dependency floor `0.121.0`.
