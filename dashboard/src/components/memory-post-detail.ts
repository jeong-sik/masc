                ...
                <details class="mt-1">
                  ...
                  <div class="mt-2 p-3 rounded bg-[var(--white-3)] border border-[var(--border-slate-12)]">
                    ...
                    ${post.meta.state_block
                      ? html`<pre class="whitespace-pre-wrap mt-2 text-2xs text-[var(--text-muted)] leading-relaxed max-h-40 overflow-y-auto custom-scrollbar" tabindex="0" aria-label="상태 블록">${post.meta.state_block}</pre>`
                      : null}
                  </div>
                </details>
              `
