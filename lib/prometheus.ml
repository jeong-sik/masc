...
(** Keeper metric aliases — re-exported from [Keeper_metrics] *)
let metric_keeper_turns = Keeper_metrics.metric_keeper_turns
let metric_keeper_input_tokens = Keeper_metrics.metric_keeper_input_tokens
let metric_keeper_output_tokens = Keeper_metrics.metric_keeper_output_tokens
let metric_keeper_cache_creation_tokens = Keeper_metrics.metric_keeper_cache_creation_tokens
let metric_keeper_cache_read_tokens = Keeper_metrics.metric_keeper_cache_read_tokens
let metric_keeper_usage_anomalies = Keeper_metrics.metric_keeper_usage_anomalies
let metric_keeper_total_cost_usd = Keeper_metrics.metric_keeper_total_cost_usd
let metric_keeper_turn_scheduled = Keeper_metrics.metric_keeper_turn_scheduled
let metric_keeper_turn_completed = Keeper_metrics.metric_keeper_turn_completed
let metric_keeper_idle_seconds = Keeper_metrics.metric_keeper_idle_seconds
let metric_keeper_contract_violations = Keeper_metrics.metric_keeper_contract_violations
let metric_keeper_alive_but_stuck = Keeper_metrics.metric_keeper_alive_but_stuck
let metric_keeper_alive_but_stuck_seconds = Keeper_metrics.metric_keeper_alive_but_stuck_seconds
let metric_keeper_alive_but_stuck_threshold_seconds = Keeper_metrics.metric_keeper_alive_but_stuck_threshold_seconds
let metric_keeper_alive_but_stuck_recovery_requests = Keeper_metrics.metric_keeper_alive_but_stuck_recovery_requests
let metric_keeper_alive_but_stuck_recovery = Keeper_metrics.metric_keeper_alive_but_stuck_recovery
let metric_keeper_metric_emit_dropped = Keeper_metrics.metric_keeper_metric_emit_dropped
let metric_keeper_context_max_observed = Keeper_metrics.metric_keeper_context_max_observed
let metric_keeper_turn_starts = Keeper_metrics.metric_keeper_turn_starts
let metric_keeper_turn_reattempts = Keeper_metrics.metric_keeper_turn_reattempts
let metric_keeper_turn_regressions = Keeper_metrics.metric_keeper_turn_regressions
let metric_keeper_turn_livelock_blocks = Keeper_metrics.metric_keeper_turn_livelock_blocks
let metric_keeper_turn_latency_bucket = Keeper_metrics.metric_keeper_turn_latency_bucket
let metric_keeper_turn_latency_by_model_bucket = Keeper_metrics.metric_keeper_turn_latency_by_model_bucket
let metric_keeper_provider_cooldown_skip = Keeper_metrics.metric_keeper_provider_cooldown_skip
let metric_keeper_provider_cooldown_remaining_sec = Keeper_metrics.metric_keeper_provider_cooldown_remaining_sec
let metric_keeper_provider_block_duration_sec = Keeper_metrics.metric_keeper_provider_block_duration_sec
let metric_keeper_turn_queue_depth = Keeper_metrics.metric_keeper_turn_queue_depth
let metric_keeper_supervisor_sweep_starts = Keeper_metrics.metric_keeper_supervisor_sweep_starts
let metric_keeper_supervisor_last_sweep_unixtime = Keeper_metrics.metric_keeper_supervisor_last_sweep_unixtime
let metric_keeper_semaphore_wait_timeout = Keeper_metrics.metric_keeper_semaphore_wait_timeout
let metric_keeper_turn_slot_bookkeeping_failures = Keeper_metrics.metric_keeper_turn_slot_bookkeeping_failures
let metric_keeper_semaphore_wait_seconds = Keeper_metrics.metric_keeper_semaphore_wait_seconds
let metric_keeper_semaphore_wait_seconds_bucket = Keeper_metrics.metric_keeper_semaphore_wait_seconds_bucket
let metric_keeper_slot_yield_total = Keeper_metrics.metric_keeper_slot_yield_total
let metric_keeper_compactions = Keeper_metrics.metric_keeper_compactions
let metric_keeper_compaction_ratio_change = Keeper_metrics.metric_keeper_compaction_ratio_change
let metric_keeper_compaction_saved_tokens = Keeper_metrics.metric_keeper_compaction_saved_tokens
let metric_keeper_operator_compact = Keeper_metrics.metric_keeper_operator_compact
let metric_keeper_operator_clear = Keeper_metrics.metric_keeper_operator_clear
let metric_keeper_compaction_noop = Keeper_metrics.metric_keeper_compaction_noop
let metric_keeper_tool_emission_registry_size = Keeper_metrics.metric_keeper_tool_emission_registry_size
let metric_keeper_tool_emission_pushes = Keeper_metrics.metric_keeper_tool_emission_pushes
let metric_keeper_tool_underused_allowed_count = Keeper_metrics.metric_keeper_tool_underused_allowed_count
let metric_keeper_tool_underused_allowed = Keeper_metrics.metric_keeper_tool_underused_allowed
let metric_keeper_path_rejection = Keeper_metrics.metric_keeper_path_rejection
let metric_keeper_admission_shadow_outcome = Keeper_metrics.metric_keeper_admission_shadow_outcome
let metric_keeper_heartbeat_successes = Keeper_metrics.metric_keeper_heartbeat_successes
let metric_keeper_heartbeat_failures = Keeper_metrics.metric_keeper_heartbeat_failures
let metric_keeper_cleanup_tracking_failures = Keeper_metrics.metric_keeper_cleanup_tracking_failures
let metric_keeper_dispatch_event_failures = Keeper_metrics.metric_keeper_dispatch_event_failures
let metric_keeper_directive_failures = Keeper_metrics.metric_keeper_directive_failures
let metric_keeper_tool_call_duration = Keeper_metrics.metric_keeper_tool_call_duration
let metric_keeper_write_meta_failures = Keeper_metrics.metric_keeper_write_meta_failures
let metric_keeper_meta_read_failures = Keeper_metrics.metric_keeper_meta_read_failures
let metric_keeper_approval_queue_failures = Keeper_metrics.metric_keeper_approval_queue_failures
let metric_keeper_guards_failures = Keeper_metrics.metric_keeper_guards_failures
let metric_keeper_profile_load_failures = Keeper_metrics.metric_keeper_profile_load_failures
let metric_keeper_compact_audit_failures = Keeper_metrics.metric_keeper_compact_audit_failures
let metric_keeper_fs_failures = Keeper_metrics.metric_keeper_fs_failures
let metric_keeper_crash_persistence_failures = Keeper_metrics.metric_keeper_crash_persistence_failures
let metric_keeper_generation_lineage_failures = Keeper_metrics.metric_keeper_generation_lineage_failures
let metric_keeper_keepalive_signal_failures = Keeper_metrics.metric_keeper_keepalive_signal_failures
let metric_keeper_board_signal_no_wake_total = Keeper_metrics.metric_keeper_board_signal_no_wake_total
let metric_keeper_meta_json_failures = Keeper_metrics.metric_keeper_meta_json_failures
let metric_keeper_tools_oas_failures = Keeper_metrics.metric_keeper_tools_oas_failures
let metric_keeper_oas_hook_output_parse_failures = Keeper_metrics.metric_keeper_oas_hook_output_parse_failures
let metric_keeper_turn_up_update_failures = Keeper_metrics.metric_keeper_turn_up_update_failures
let metric_keeper_exec_tools_failures = Keeper_metrics.metric_keeper_exec_tools_failures
let metric_keeper_circuit_breaker_trips = Keeper_metrics.metric_keeper_circuit_breaker_trips
let metric_keeper_prompt_failures = Keeper_metrics.metric_keeper_prompt_failures
let metric_keeper_run_context_failures = Keeper_metrics.metric_keeper_run_context_failures
let metric_keeper_shell_ops_failures = Keeper_metrics.metric_keeper_shell_ops_failures
let metric_keeper_tag_dispatch_failures = Keeper_metrics.metric_keeper_tag_dispatch_failures
let metric_keeper_trace_emit_failures = Keeper_metrics.metric_keeper_trace_emit_failures
let metric_keeper_transition_audit_failures = Keeper_metrics.metric_keeper_transition_audit_failures
let metric_keeper_execution_receipt_failures = Keeper_metrics.metric_keeper_execution_receipt_failures
let metric_keeper_llm_bridge_failures = Keeper_metrics.metric_keeper_llm_bridge_failures
let metric_keeper_shell_bash_failures = Keeper_metrics.metric_keeper_shell_bash_failures
let metric_keeper_rollover_failures = Keeper_metrics.metric_keeper_rollover_failures
let metric_keeper_lifecycle_dispatch_rejections = Keeper_metrics.metric_keeper_lifecycle_dispatch_rejections
let metric_keeper_paused_state_persist_errors = Keeper_metrics.metric_keeper_paused_state_persist_errors
let metric_keeper_unexpected_tool_partial_tolerance = Keeper_metrics.metric_keeper_unexpected_tool_partial_tolerance
let metric_keeper_require_tool_use_violations = Keeper_metrics.metric_keeper_require_tool_use_violations
let metric_keeper_tool_alias_canonicalizations = Keeper_metrics.metric_keeper_tool_alias_canonicalizations
let metric_keeper_profile_config_conflicts = Keeper_metrics.metric_keeper_profile_config_conflicts
let metric_keeper_oas_timeout_classifications = Keeper_metrics.metric_keeper_oas_timeout_classifications
let metric_keeper_no_tool_provider = Keeper_metrics.metric_keeper_no_tool_provider
let metric_keeper_proactive_outcome = Keeper_metrics.metric_keeper_proactive_outcome
let metric_keeper_ollama_saturation_skip = Keeper_metrics.metric_keeper_ollama_saturation_skip
let metric_keeper_task_load_failures = Keeper_metrics.metric_keeper_task_load_failures
let metric_keeper_tool_selection_failures = Keeper_metrics.metric_keeper_tool_selection_failures
let metric_keeper_tool_policy_failures = Keeper_metrics.metric_keeper_tool_policy_failures
let metric_keeper_reconcile_failures = Keeper_metrics.metric_keeper_reconcile_failures
let metric_keeper_decision_audit_flush_failures = Keeper_metrics.metric_keeper_decision_audit_flush_failures
let metric_keeper_oas_cancel = Keeper_metrics.metric_keeper_oas_cancel
let metric_keeper_claim_auto_provision = Keeper_metrics.metric_keeper_claim_auto_provision
let metric_keeper_toml_invalid = Keeper_metrics.metric_keeper_toml_invalid
let metric_keeper_persona_drift_missing = Keeper_metrics.metric_keeper_persona_drift_missing
let metric_keeper_room_init_failures = Keeper_metrics.metric_keeper_room_init_failures
let metric_keeper_presence_sync_failures = Keeper_metrics.metric_keeper_presence_sync_failures
let metric_keeper_self_preservation_universal = Keeper_metrics.metric_keeper_self_preservation_universal
let metric_keeper_stale_storm_paused = Keeper_metrics.metric_keeper_stale_storm_paused
let metric_keeper_stale_fleet_batch_paused = Keeper_metrics.metric_keeper_stale_fleet_batch_paused
let metric_keeper_oas_timeout_budget_loop_paused = Keeper_metrics.metric_keeper_oas_timeout_budget_loop_paused
let metric_keeper_cycle_exceptions = Keeper_metrics.metric_keeper_cycle_exceptions
let metric_keeper_snapshot_write_failures = Keeper_metrics.metric_keeper_snapshot_write_failures
let metric_keeper_progress_updated_line_failures = Keeper_metrics.metric_keeper_progress_updated_line_failures
let metric_keeper_sse_broadcast_failures = Keeper_metrics.metric_keeper_sse_broadcast_failures
let metric_keeper_room_heartbeat_failures = Keeper_metrics.metric_keeper_room_heartbeat_failures
let metric_keeper_turn_metrics_snapshot_failures = Keeper_metrics.metric_keeper_turn_metrics_snapshot_failures
let metric_keeper_oas_execution_errors = Keeper_metrics.metric_keeper_oas_execution_errors
let metric_keeper_episode_create_failures = Keeper_metrics.metric_keeper_episode_create_failures
let metric_keeper_memory_activity_emit_failures = Keeper_metrics.metric_keeper_memory_activity_emit_failures
let metric_keeper_supervisor_sweep_failures = Keeper_metrics.metric_keeper_supervisor_sweep_failures
let metric_keeper_toml_reconcile_sweep_failures = Keeper_metrics.metric_keeper_toml_reconcile_sweep_failures
let metric_keeper_tool_usage_flush_failures = Keeper_metrics.metric_keeper_tool_usage_flush_failures
let metric_keeper_turn_timeout_committed = Keeper_metrics.metric_keeper_turn_timeout_committed
let metric_keeper_turn_error_after_tools = Keeper_metrics.metric_keeper_turn_error_after_tools
let metric_keeper_cascade_sync_failures = Keeper_metrics.metric_keeper_cascade_sync_failures
let metric_keeper_local_discovery_failures = Keeper_metrics.metric_keeper_local_discovery_failures
let metric_keeper_thinking_persist_failures = Keeper_metrics.metric_keeper_thinking_persist_failures
let metric_keeper_checkpoint_failures = Keeper_metrics.metric_keeper_checkpoint_failures
let metric_keeper_memory_write_failures = Keeper_metrics.metric_keeper_memory_write_failures
let metric_keeper_memory_consolidations = Keeper_metrics.metric_keeper_memory_consolidations
let metric_keeper_write_meta_cycle_failures = Keeper_metrics.metric_keeper_write_meta_cycle_failures
let metric_keeper_alert_persist_failures = Keeper_metrics.metric_keeper_alert_persist_failures
let metric_keeper_metrics_sse_failures = Keeper_metrics.metric_keeper_metrics_sse_failures
let metric_keeper_chat_store_failures = Keeper_metrics.metric_keeper_chat_store_failures
let metric_keeper_observation_query_failures = Keeper_metrics.metric_keeper_observation_query_failures
let metric_keeper_oas_on_stop = Keeper_metrics.metric_keeper_oas_on_stop
let metric_keeper_oas_on_idle_escalated = Keeper_metrics.metric_keeper_oas_on_idle_escalated
let metric_keeper_quantitative_claim_rejections = Keeper_metrics.metric_keeper_quantitative_claim_rejections
let metric_keeper_invariant_violations = Keeper_metrics.metric_keeper_invariant_violations
let metric_keeper_fsm_edge_transitions = Keeper_metrics.metric_keeper_fsm_edge_transitions
let metric_keeper_turn_fsm_transitions = Keeper_metrics.metric_keeper_turn_fsm_transitions
let metric_keeper_turn_phase_duration = Keeper_metrics.metric_keeper_turn_phase_duration
let metric_keeper_lifecycle_transitions = Keeper_metrics.metric_keeper_lifecycle_transitions
let metric_keeper_lifecycle_callback_failures = Keeper_metrics.metric_keeper_lifecycle_callback_failures
let metric_keeper_event_bus_drain = Keeper_metrics.metric_keeper_event_bus_drain
let metric_keeper_supervisor_cleanup_failures = Keeper_metrics.metric_keeper_supervisor_cleanup_failures
let metric_keeper_slot_force_released = Keeper_metrics.metric_keeper_slot_force_released
let metric_keeper_registry_update_dropped = Keeper_metrics.metric_keeper_registry_update_dropped
let metric_keeper_registry_orphan_threshold_breached = Keeper_metrics.metric_keeper_registry_orphan_threshold_breached
let metric_keeper_stale_watchdog_tick_failures = Keeper_metrics.metric_keeper_stale_watchdog_tick_failures
let metric_keeper_dead_total = Keeper_metrics.metric_keeper_dead_total
let metric_keeper_auto_resumed_total = Keeper_metrics.metric_keeper_auto_resumed_total
let metric_keeper_auto_resume_blocked_total = Keeper_metrics.metric_keeper_auto_resume_blocked_total
let metric_keeper_skip_idle_wake_resumed = Keeper_metrics.metric_keeper_skip_idle_wake_resumed
let metric_keeper_event_queue_override = Keeper_metrics.metric_keeper_event_queue_override
let metric_keeper_stimulus_consumed = Keeper_metrics.metric_keeper_stimulus_consumed
let metric_keeper_unsupported_stimulus = Keeper_metrics.metric_keeper_unsupported_stimulus
let metric_keeper_near_exhaustion_total = Keeper_metrics.metric_keeper_near_exhaustion_total
let metric_keeper_restart_attempts = Keeper_metrics.metric_keeper_restart_attempts
let metric_keeper_restart_outcomes = Keeper_metrics.metric_keeper_restart_outcomes
let metric_keeper_liveness_recovery_attempts = Keeper_metrics.metric_keeper_liveness_recovery_attempts
let metric_keeper_liveness_recovery_outcomes = Keeper_metrics.metric_keeper_liveness_recovery_outcomes
let metric_keeper_passive_loop_detected_total = Keeper_metrics.metric_keeper_passive_loop_detected_total
let metric_keeper_required_tool_loop_detected_total = Keeper_metrics.metric_keeper_required_tool_loop_detected_total
let metric_keeper_zombie_loop_detected_total = Keeper_metrics.metric_keeper_zombie_loop_detected_total
let metric_keeper_required_tool_gate_suppressed_total = Keeper_metrics.metric_keeper_required_tool_gate_suppressed_total
let metric_keeper_consecutive_idle = Keeper_metrics.metric_keeper_consecutive_idle
let metric_keeper_last_productive_ts = Keeper_metrics.metric_keeper_last_productive_ts
let metric_keeper_oas_timeout_budget_strike = Keeper_metrics.metric_keeper_oas_timeout_budget_strike
let metric_keeper_stale_termination_total = Keeper_metrics.metric_keeper_stale_termination_total
let metric_keeper_stale_termination_by_class = Keeper_metrics.metric_keeper_stale_termination_by_class
let metric_keeper_oas_timeout_budget_watchdog_termination = Keeper_metrics.metric_keeper_oas_timeout_budget_watchdog_termination
let metric_keeper_stale_termination_threshold_breached = Keeper_metrics.metric_keeper_stale_termination_threshold_breached
let metric_keeper_stale_termination_batch = Keeper_metrics.metric_keeper_stale_termination_batch
let metric_keeper_stale_broadcast_emit_failures = Keeper_metrics.metric_keeper_stale_broadcast_emit_failures
let metric_keeper_oas_run_timeout = Keeper_metrics.metric_keeper_oas_run_timeout
let metric_keeper_tool_use_failure = Keeper_metrics.metric_keeper_tool_use_failure
let metric_keeper_tool_not_allowed = Keeper_metrics.metric_keeper_tool_not_allowed
let metric_keeper_turn_gate_rejected_terminal = Keeper_metrics.metric_keeper_turn_gate_rejected_terminal
let metric_keeper_receipt_unmapped_disposition = Keeper_metrics.metric_keeper_receipt_unmapped_disposition
let metric_keeper_bash_network_upgrade = Keeper_metrics.metric_keeper_bash_network_upgrade
let metric_keeper_bash_local_execution = Keeper_metrics.metric_keeper_bash_local_execution
let metric_keeper_docker_runtime_discarded = Keeper_metrics.metric_keeper_docker_runtime_discarded
let metric_keeper_proactive_skip = Keeper_metrics.metric_keeper_proactive_skip
let metric_keeper_stay_silent_loop_detected = Keeper_metrics.metric_keeper_stay_silent_loop_detected
let metric_keeper_usage_trust = Keeper_metrics.metric_keeper_usage_trust
let metric_keeper_usage_anomaly_reason = Keeper_metrics.metric_keeper_usage_anomaly_reason
let metric_keeper_config_env_parse_failures = Keeper_metrics.metric_keeper_config_env_parse_failures
let metric_keeper_post_turn_wirein_failures = Keeper_metrics.metric_keeper_post_turn_wirein_failures
let metric_keeper_recurring_failures = Keeper_metrics.metric_keeper_recurring_failures
let metric_keeper_turn_cleanup_failures = Keeper_metrics.metric_keeper_turn_cleanup_failures
let metric_keeper_session_cleanup_failures = Keeper_metrics.metric_keeper_session_cleanup_failures
