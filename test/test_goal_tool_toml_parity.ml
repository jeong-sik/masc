...
let published =
  ...
  ; ( "masc_goal_upsert"
  , "Create or update Goal metadata and parent linkage. Creation requires a measurable success condition: metric and target_value (RFC-0387 B1). Use masc_goal_transition for lifecycle changes."
