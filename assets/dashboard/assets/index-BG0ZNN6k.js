var Fl=Object.defineProperty;var Kl=(e,t,n)=>t in e?Fl(e,t,{enumerable:!0,configurable:!0,writable:!0,value:n}):e[t]=n;var It=(e,t,n)=>Kl(e,typeof t!="symbol"?t+"":t,n);import{e as Ul,_ as Bl,c as _,b as xe,y as ne,d as zo,A as Wl,G as Hl}from"./vendor-kuFK4-oj.js";(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const a of document.querySelectorAll('link[rel="modulepreload"]'))s(a);new MutationObserver(a=>{for(const o of a)if(o.type==="childList")for(const l of o.addedNodes)l.tagName==="LINK"&&l.rel==="modulepreload"&&s(l)}).observe(document,{childList:!0,subtree:!0});function n(a){const o={};return a.integrity&&(o.integrity=a.integrity),a.referrerPolicy&&(o.referrerPolicy=a.referrerPolicy),a.crossOrigin==="use-credentials"?o.credentials="include":a.crossOrigin==="anonymous"?o.credentials="omit":o.credentials="same-origin",o}function s(a){if(a.ep)return;a.ep=!0;const o=n(a);fetch(a.href,o)}})();var i=Ul.bind(Bl);const Gl=["mission","proof","execution","live","memory","governance","planning","intervene","command","lab"],Eo={tab:"mission",params:{},postId:null};function Ji(e){return!!e&&Gl.includes(e)}function Ha(e){try{return decodeURIComponent(e)}catch{return e}}function Ga(e){const t={};return e&&new URLSearchParams(e).forEach((s,a)=>{t[a]=s}),t}function Jl(e){const n=e.replace(/^\/+/,"").split("/").filter(Boolean);return n[0]==="dashboard"?n.slice(1):n}function Do(e,t){if(e[0]==="chains"){const o={...t,surface:"chains"};return e[1]==="operation"&&e[2]&&(o.operation=Ha(e[2])),{tab:"command",params:o,postId:null}}if(e[0]==="lab"){const o={...t};return e[1]&&(o.surface=Ha(e[1])),{tab:"lab",params:o,postId:null}}const n=e[0],s=t.tab;return{tab:Ji(n)?n:Ji(s)?s:"mission",params:t,postId:null}}function Cs(e){const t=(e||"").replace(/^#/,"").trim();if(!t)return Eo;const n=Ha(t);let s=n,a;if(n.startsWith("?"))s="",a=n.slice(1);else{const c=n.indexOf("?");c>=0&&(s=n.slice(0,c),a=n.slice(c+1))}!a&&s.includes("=")&&!s.includes("/")&&(a=s,s="");const o=Ga(a),l=Jl(s);return Do(l,o)}function Vl(e,t){const n=e.replace(/^\/+/,"").split("/").filter(Boolean);if(n[0]!=="dashboard")return null;const s=n.slice(1);if(s.length===0)return{...Eo,params:Ga(t.replace(/^\?/,""))};if(s[0]==="assets"||s[0]==="credits"||s[0]==="lodge")return null;const a=Ga(t.replace(/^\?/,""));return Do(s,a)}function jo(e){const t=e.tab==="lab"&&e.params.surface?`lab/${encodeURIComponent(e.params.surface)}`:e.tab,n=Object.entries(e.params).filter(([a])=>!(a==="tab"||e.tab==="lab"&&a==="surface"));if(n.length===0)return`#${t}`;const s=new URLSearchParams(n);return`#${t}?${s.toString()}`}const j=_(Cs(window.location.hash));window.addEventListener("hashchange",()=>{j.value=Cs(window.location.hash)});function ue(e,t){const n={tab:e,params:t??{}};window.location.hash=jo(n)}function Ql(e){window.location.hash=`#memory?post=${encodeURIComponent(e)}`}function Yl(){if(window.location.hash&&window.location.hash!=="#"){j.value=Cs(window.location.hash);return}const e=Vl(window.location.pathname,window.location.search);if(e){j.value=e;const t=jo(e);window.history.replaceState(null,"",`${window.location.pathname}${window.location.search}${t}`);return}window.location.hash="#mission",j.value=Cs(window.location.hash)}const Vi="masc_dashboard_sse_session_id",Xl=1e3,Zl=15e3,tt=_(!1),ra=_(0),Oo=_(null),Is=_([]);function ec(){let e=sessionStorage.getItem(Vi);return e||(e=typeof crypto.randomUUID=="function"?`dash_${crypto.randomUUID()}`:`dash_${Date.now().toString(36)}_${Math.random().toString(36).slice(2,10)}`,sessionStorage.setItem(Vi,e)),e}const tc=200;function nc(e,t,n="system",s={}){const a={agent:e,text:t,timestamp:Date.now(),kind:n,...s};Is.value=[a,...Is.value].slice(0,tc)}function Ja(e,t=88){const n=(e??"").replace(/\s+/g," ").trim();return n?n.length>t?`${n.slice(0,t-3)}...`:n:void 0}function Qi(e,t){const n=Ja(t);return n?`${e}: ${n}`:`New ${e.toLowerCase()}`}function ke(e,t,n,s,a={}){nc(e,t,n,{eventType:s,...a})}let Ie=null,qt=null,Va=0;function qo(){qt&&(clearTimeout(qt),qt=null)}function sc(){if(qt)return;Va++;const e=Math.min(Va,5),t=Math.min(Zl,Xl*Math.pow(2,e));qt=setTimeout(()=>{qt=null,Fo()},t)}function Fo(){qo(),Ie&&(Ie.close(),Ie=null);const e=new URLSearchParams(window.location.search),t=new URLSearchParams,n=e.get("agent")??e.get("agent_name"),s=e.get("token");n&&t.set("agent",n),s&&t.set("token",s),t.set("session_id",ec());const a=t.toString()?`/sse?${t.toString()}`:"/sse",o=new EventSource(a);Ie=o,o.onopen=()=>{Ie===o&&(Va=0,tt.value=!0)},o.onerror=()=>{Ie===o&&(tt.value=!1,o.close(),Ie=null,sc())},o.onmessage=l=>{try{const c=JSON.parse(l.data);ra.value++,Oo.value=c,ac(c)}catch{}}}function ac(e){const t=e.type,n=e.agent??e.author??e.from??e.from_agent??"";switch(t){case"agent_joined":ke(n,"Joined","system","agent_joined");break;case"agent_left":ke(n,"Left","system","agent_left");break;case"broadcast":ke(n,`${(e.message??e.content??"").slice(0,80)}`,"system","broadcast");break;case"task_update":ke(n,`Task: ${e.task_id??""} -> ${e.status??""}`,"tasks","task_update");break;case"board_post":case"masc/board_post":ke(n,Qi("Post",e.content??e.message),"board","board_post",{author:e.author??n,preview:Ja(e.content??e.message),postId:e.post_id});break;case"board_comment":case"masc/board_comment":ke(n,Qi("Comment",e.content??e.message),"board","board_comment",{author:e.author??n,preview:Ja(e.content??e.message),postId:e.post_id});break;case"keeper_heartbeat":ke(e.name??n,`Heartbeat gen=${e.generation??"?"} ctx=${e.context_ratio!=null?Math.round(e.context_ratio*100)+"%":"?"}`,"keepers","keeper_heartbeat");break;case"keeper_handoff":ke(e.name??n,`Handoff gen ${e.from_generation??"?"} -> ${e.to_generation??"?"} (${e.to_model??"?"})`,"keepers","keeper_handoff");break;case"keeper_compaction":ke(e.name??n,`Compaction saved ${e.saved_tokens??"?"} tokens (${e.trigger??"?"})`,"keepers","keeper_compaction");break;case"keeper_guardrail":ke(e.name??n,`Guardrail: ${e.reason??"stopped"}`,"keepers","keeper_guardrail");break;default:ke(n,t,"system","unknown")}}function ic(){qo(),Ie&&(Ie.close(),Ie=null),tt.value=!1}function p(e){return typeof e=="object"&&e!==null&&!Array.isArray(e)}function r(e){return typeof e=="string"&&e.trim()!==""?e.trim():void 0}function d(e){return typeof e=="number"&&Number.isFinite(e)?e:void 0}function U(e){return typeof e=="boolean"?e:void 0}function W(e){return Array.isArray(e)?e.map(t=>typeof t=="string"?t.trim():"").filter(Boolean):[]}function Te(e,t=[]){if(Array.isArray(e))return e;if(!p(e))return[];for(const n of t){const s=e[n];if(Array.isArray(s))return s}return[]}function nt(e){if(typeof e=="string"&&e.trim()!=="")return e;if(!(typeof e!="number"||!Number.isFinite(e)||e<=0))return new Date(e*1e3).toISOString()}function Ko(){return new URLSearchParams(window.location.search)}function Uo(){const e=Ko(),t={},n=e.get("token"),s=e.get("agent")??e.get("agent_name");return n&&(t.Authorization=`Bearer ${n}`),s&&(t["X-MASC-Agent"]=s),t}function Bo(){return{...Uo(),"Content-Type":"application/json"}}const oc=15e3,hi=3e4,rc=6e4,Yi=new Set([408,425,429,500,502,503,504]);class Wn extends Error{constructor(n){const s=n.method.toUpperCase(),a=n.timeout===!0,o=a?`${s} ${n.path}: timeout after ${n.timeoutMs??0}ms`:`${s} ${n.path}: ${n.status??"unknown"} ${n.statusText??""}`.trim();super(o);It(this,"method");It(this,"path");It(this,"status");It(this,"statusText");It(this,"timeout");this.name="ApiRequestError",this.method=s,this.path=n.path,this.status=n.status,this.statusText=n.statusText,this.timeout=a}}async function yi(e,t,n){const s=new AbortController,a=setTimeout(()=>s.abort(),n);try{return await fetch(e,{...t,signal:s.signal})}catch(o){if(o instanceof Error&&o.name==="AbortError"){const l=typeof t.method=="string"?t.method.toUpperCase():"GET";throw new Wn({method:l,path:e,timeout:!0,timeoutMs:n})}throw o}finally{clearTimeout(a)}}function lc(){var t,n;const e=Ko();return((t=e.get("agent"))==null?void 0:t.trim())||((n=e.get("agent_name"))==null?void 0:n.trim())||"dashboard-user"}async function ee(e){const t=await yi(e,{headers:Uo()},oc);if(!t.ok)throw new Wn({method:"GET",path:e,status:t.status,statusText:t.statusText});return t.json()}function cc(e){return new Promise(t=>setTimeout(t,e))}function dc(e){const t=e.match(/\b(\d{3})\b/);if(!t)return null;const n=t[1];if(!n)return null;const s=Number.parseInt(n,10);return Number.isFinite(s)?s:null}function uc(e){if(e instanceof Wn)return e.timeout||typeof e.status=="number"&&Yi.has(e.status);if(!(e instanceof Error))return!1;if(/timeout after \d+ms/i.test(e.message))return!0;const t=dc(e.message);return t!==null&&Yi.has(t)}async function la(e,t,n=2){let s=0;for(;;)try{return await t()}catch(a){if(!uc(a)||s>=n)throw a;const o=250*(s+1);console.warn(`[dashboard/api] ${e} failed (attempt ${s+1}), retrying in ${o}ms`,a),await cc(o),s+=1}}async function Me(e,t,n,s=hi){const a=await yi(e,{method:"POST",headers:{...Bo(),...n??{}},body:JSON.stringify(t)},s);if(!a.ok)throw new Wn({method:"POST",path:e,status:a.status,statusText:a.statusText});return a.json()}async function pc(e,t,n,s=hi){const a=await yi(e,{method:"POST",headers:{...Bo(),...n??{}},body:JSON.stringify(t)},s);if(!a.ok)throw new Wn({method:"POST",path:e,status:a.status,statusText:a.statusText});return a.text()}function mc(e){const t=e.split(`
`).find(s=>s.startsWith("data: ")),n=t?t.slice(6).trim():e.trim();return JSON.parse(n)}function vc(e){var t,n,s,a,o,l,c;if((t=e.error)!=null&&t.message)throw new Error(e.error.message);if((n=e.result)!=null&&n.isError){const u=((a=(s=e.result.content)==null?void 0:s[0])==null?void 0:a.text)??"MCP tool call failed";throw new Error(u)}return((c=(l=(o=e.result)==null?void 0:o.content)==null?void 0:l[0])==null?void 0:c.text)??""}async function it(e,t){const n=await pc("/mcp",{jsonrpc:"2.0",method:"tools/call",params:{name:e,arguments:t},id:Math.floor(Date.now()%1e6)},{Accept:"application/json, text/event-stream"},rc),s=mc(n);return vc(s)}function _c(){return ee("/api/v1/dashboard/shell")}function fc(){return ee("/api/v1/dashboard/execution")}function gc(e,t){const n=new URLSearchParams;return n.set("sort_by",e),t!=null&&t.excludeSystem&&n.set("exclude_system","true"),ee(`/api/v1/dashboard/memory${n.toString()?`?${n}`:""}`)}function $c(){return la("fetchDashboardGovernance",async()=>{const e=await ee("/api/v1/dashboard/governance"),t=Array.isArray(e.items)?e.items.map(o=>Nc(o)).filter(o=>o!==null):[],n=Array.isArray(e.pending_actions)?e.pending_actions.map(o=>Go(o)).filter(o=>o!==null):[],s=t.filter(o=>o.kind==="debate").map(o=>({id:o.id,topic:o.topic,status:o.status,argument_count:o.evidence_refs.length,created_at:o.last_activity_at??void 0})),a=t.filter(o=>o.kind==="consensus").map(o=>({id:o.id,topic:o.topic,initiator:o.related_agents[0]||"system",votes:o.votes??0,quorum:o.quorum??0,threshold:o.threshold,state:o.status,created_at:o.last_activity_at??void 0}));return{generated_at:re(e.generated_at)??void 0,summary:p(e.summary)?{debates:me(e.summary.debates)??void 0,voting_sessions:me(e.summary.voting_sessions)??void 0,debates_open:me(e.summary.debates_open)??void 0,sessions_active:me(e.summary.sessions_active)??void 0,sessions_without_quorum:me(e.summary.sessions_without_quorum)??void 0,ready_to_execute:me(e.summary.ready_to_execute)??void 0,oldest_open_debate_age_s:typeof e.summary.oldest_open_debate_age_s=="number"?e.summary.oldest_open_debate_age_s:null,last_activity_age_s:typeof e.summary.last_activity_age_s=="number"?e.summary.last_activity_age_s:null,judge_online:typeof e.summary.judge_online=="boolean"?e.summary.judge_online:void 0,judge_last_seen_at:re(e.summary.judge_last_seen_at)}:void 0,debates:s,sessions:a,items:t,activity:Array.isArray(e.activity)?e.activity.map(o=>Mc(o)).filter(o=>o!==null):[],judge:zc(e.judge),pending_actions:n}})}function hc(){return ee("/api/v1/dashboard/semantics")}function yc(){return ee("/api/v1/dashboard/mission")}function bc(e=!1){return ee(`/api/v1/dashboard/mission/briefing${e?"?force=1":""}`)}function kc(e,t){const n=new URLSearchParams;e&&n.set("session_id",e),t&&n.set("operation_id",t);const s=n.toString();return ee(`/api/v1/dashboard/proof${s?`?${s}`:""}`)}function xc(){return ee("/api/v1/dashboard/planning")}function Sc(){return ee("/api/v1/operator")}function Wo(e={}){const t=new URLSearchParams;e.targetType&&t.set("target_type",e.targetType),e.targetId&&t.set("target_id",e.targetId),e.includeWorkers!=null&&t.set("include_workers",e.includeWorkers?"true":"false");const n=t.toString();return ee(`/api/v1/operator/digest${n?`?${n}`:""}`)}function Ac(){return ee("/api/v1/command-plane")}function Cc(){return ee("/api/v1/command-plane/summary")}function Ic(){return ee("/api/v1/chains/summary")}function Tc(e){return ee(`/api/v1/chains/runs/${encodeURIComponent(e)}`)}function Rc(){return ee("/api/v1/command-plane/help")}function Pc(e,t){const n=new URLSearchParams;e&&n.set("run_id",e),t&&n.set("operation_id",t);const s=n.toString();return ee(`/api/v1/command-plane/swarm${s?`?${s}`:""}`)}function wc(e,t){return Me(e,t)}function Lc(e){switch(e.action_type){case"keeper_message":case"keeper_recover":return 9e4;case"lodge_tick":return 45e3;default:return hi}}function ca(e){return Me("/api/v1/operator/action",e,void 0,Lc(e))}function Ho(e,t,n="confirm"){return Me("/api/v1/operator/confirm",{actor:e,confirm_token:t,decision:n})}function fs(e){if(typeof e=="string"&&e.trim())return e;if(typeof e!="number"||Number.isNaN(e))return new Date().toISOString();const t=e<1e12?e*1e3:e;return new Date(t).toISOString()}function re(e){if(typeof e=="string"){const t=e.trim();return t||null}if(typeof e=="number"&&Number.isFinite(e)){const t=e<1e12?e*1e3:e;return new Date(t).toISOString()}return null}function M(e){if(typeof e!="string")return null;const t=e.trim();return t||null}function Go(e){if(!p(e))return null;const t=y(e.confirm_token??e.token,"").trim();return t?{confirm_token:t,actor:M(e.actor)??void 0,action_type:M(e.action_type)??void 0,target_type:M(e.target_type)??void 0,target_id:M(e.target_id),delegated_tool:M(e.delegated_tool)??void 0,created_at:re(e.created_at)??void 0,preview:e.preview}:null}function bi(e){return p(e)?{board_post_id:M(e.board_post_id),task_id:M(e.task_id),operation_id:M(e.operation_id),team_session_id:M(e.team_session_id)}:{}}function Jo(e){if(!p(e))return null;const t=M(e.action_kind),n=M(e.resolved_tool),s=M(e.target_type),a=M(e.target_id),o=M(e.reason);return!t&&!n&&!s&&!o?null:{action_kind:t??void 0,resolved_tool:n,target_type:s,target_id:a,reason:o??void 0,payload_preview:e.payload_preview}}function Vo(e){if(!p(e))return null;const t=M(e.action_type),n=M(e.delegated_tool),s=M(e.confirmation_state),a=re(e.created_at);return!t&&!n&&!s&&!a?null:{action_type:t??void 0,delegated_tool:n,confirmation_state:s??void 0,created_at:a}}function Qo(e){if(!p(e))return null;const t=Go(e.pending_confirm),n=M(e.pending_confirm_token)??(t==null?void 0:t.confirm_token)??null;return{requires_human_gate:typeof e.requires_human_gate=="boolean"?e.requires_human_gate:void 0,pending_confirm:t,pending_confirm_token:n,ready_to_execute:typeof e.ready_to_execute=="boolean"?e.ready_to_execute:void 0}}function Yo(e){if(!p(e))return null;const t=M(e.summary),n=M(e.target_id);return!t&&!n?null:{judgment_id:M(e.judgment_id)??void 0,target_kind:M(e.target_kind)??void 0,target_id:n??void 0,status:M(e.status)??void 0,summary:t??void 0,confidence:typeof e.confidence=="number"?e.confidence:null,generated_at:re(e.generated_at),expires_at:re(e.expires_at),model_used:M(e.model_used),keeper_name:M(e.keeper_name),evidence_refs:Re(e.evidence_refs),recommended_action:Jo(e.recommended_action),guardrail_state:Qo(e.guardrail_state),executed_route:Vo(e.executed_route)}}function Nc(e){if(!p(e))return null;const t=y(e.id,"").trim(),n=y(e.topic,"").trim();if(!t||!n)return null;const s=bi(e.context);return{kind:y(e.kind,"debate"),id:t,topic:n,status:y(e.status??e.state,"open"),last_activity_at:re(e.last_activity_at),truth_summary:M(e.truth_summary)??void 0,judgment_summary:M(e.judgment_summary),confidence:typeof e.confidence=="number"?e.confidence:null,related_agents:Re(e.related_agents),context:s,linked_board_post_id:M(e.linked_board_post_id)??s.board_post_id??null,linked_task_id:M(e.linked_task_id)??s.task_id??null,linked_operation_id:M(e.linked_operation_id)??s.operation_id??null,linked_session_id:M(e.linked_session_id)??s.team_session_id??null,recommended_action:Jo(e.recommended_action),executed_route:Vo(e.executed_route),guardrail_state:Qo(e.guardrail_state),evidence_refs:Re(e.evidence_refs),approve_count:me(e.approve_count),reject_count:me(e.reject_count),abstain_count:me(e.abstain_count),votes:me(e.votes),quorum:me(e.quorum),threshold:typeof e.threshold=="number"?e.threshold:void 0}}function Mc(e){if(!p(e))return null;const t=y(e.kind,"").trim();return t?{kind:t,item_kind:M(e.item_kind)??void 0,item_id:M(e.item_id)??void 0,topic:M(e.topic)??void 0,created_at:re(e.created_at),summary:M(e.summary)??void 0,actor:M(e.actor),index:me(e.index),decision:M(e.decision)}:null}function zc(e){if(p(e))return{judge_online:typeof e.judge_online=="boolean"?e.judge_online:void 0,refreshing:typeof e.refreshing=="boolean"?e.refreshing:void 0,generated_at:re(e.generated_at),expires_at:re(e.expires_at),model_used:M(e.model_used),keeper_name:M(e.keeper_name),last_error:M(e.last_error)}}function Ec(e){var a;const t=e.trim(),s=((a=(t.startsWith("[flair:")?t.replace(/^\[flair:[^\]]+\]\s*/i,""):t).split(`
`)[0])==null?void 0:a.trim())||"Untitled post";return s.length<=96?s:`${s.slice(0,93)}...`}function Dc(e){if(!p(e))return null;const t=y(e.id,"").trim(),n=y(e.author,"").trim(),s=y(e.content,"").trim();if(!t||!n)return null;const a=F(e.score,0),o=F(e.votes_up,0),l=F(e.votes_down,0),c=F(e.votes,a||o-l),u=F(e.comment_count,F(e.reply_count,0)),m=(()=>{const $=e.flair;if(typeof $=="string"&&$.trim())return $.trim();if(p($)){const A=y($.name,"").trim();if(A)return A}return y(e.flair_name,"").trim()||void 0})(),v=y(e.created_at_iso,"").trim()||fs(e.created_at),f=y(e.updated_at_iso,"").trim()||(e.updated_at!==void 0?fs(e.updated_at):v),h=y(e.title,"").trim()||Ec(s),k=Array.isArray(e.tags)?e.tags.filter($=>typeof $=="string"&&$.trim()!==""):[];return{id:t,author:n,post_kind:(()=>{const $=y(e.post_kind,"").trim().toLowerCase();return $==="automation"||$==="system"||$==="human"?$:void 0})(),title:h,content:s,tags:k,votes:c,vote_balance:a,comment_count:u,created_at:v,updated_at:f,flair:m,hearth:y(e.hearth,"").trim()||null,visibility:y(e.visibility,"").trim()||void 0,expires_at:y(e.expires_at_iso,"").trim()||(e.expires_at!==void 0&&e.expires_at!==0?fs(e.expires_at):"")||null,hearth_count:F(e.hearth_count,0)}}function jc(e){if(!p(e))return null;const t=y(e.id,"").trim(),n=y(e.post_id,"").trim(),s=y(e.author,"").trim();return!t||!s?null:{id:t,post_id:n,author:s,content:y(e.content,""),created_at:fs(e.created_at)}}async function Oc(e){return la("fetchBoardPost",async()=>{const t=await ee(`/api/v1/board/${e}?format=flat`),n=p(t.post)?t.post:t,s=Dc(n)??{id:e,author:"unknown",post_kind:"human",title:"Post",content:"",tags:[],votes:0,comment_count:0,created_at:new Date().toISOString(),updated_at:new Date().toISOString(),hearth:null,visibility:"internal",expires_at:null},o=(Array.isArray(t.comments)?t.comments:[]).map(jc).filter(l=>l!==null);return{...s,comments:o}})}function Xo(e,t){return Me("/api/v1/tools/masc_board_vote",{post_id:e,direction:t,vote:t,voter:lc()})}function qc(e,t,n){return Me("/api/v1/tools/masc_board_comment",{post_id:e,author:t,content:n})}function Fc(e){const t=y(e,"").trim().toLowerCase();if(t==="win"||t==="won"||t==="victory")return"victory";if(t==="lose"||t==="lost"||t==="defeat")return"defeat";if(t==="draw"||t==="stalemate"||t==="tie")return"draw"}function le(...e){for(const t of e){const n=y(t,"");if(n.trim())return n.trim()}return""}function Xi(e){const t=Fc(le(e.outcome,e.result,e.result_code));if(!t)return;const n=le(e.reason,e.reason_code,e.description,e.detail),s=le(e.summary,e.summary_ko,e.summary_en,e.note),a=le(e.details,e.details_text,e.text,e.note),o=le(e.winner,e.winner_name,e.actor_winner,e.winner_actor),l=le(e.winner_actor_id,e.winner_actor,e.actor_winner_id),c=le(e.raw_reason,e.raw_reason_code,e.error_message),u=(()=>{const f=e.evidence??e.evidence_ids??e.supporting_events??e.event_ids??[];return typeof f=="string"?[f]:Array.isArray(f)?f.map(g=>{if(typeof g=="string")return g.trim();if(p(g)){const h=y(g.summary,"").trim();if(h)return h;const k=y(g.text,"").trim();if(k)return k;const $=y(g.type,"").trim();return $||y(g.event_id,"").trim()}return""}).filter(g=>g.length>0):[]})(),m=(()=>{const f=F(e.turn,Number.NaN);if(Number.isFinite(f))return f;const g=F(e.turn_number,Number.NaN);if(Number.isFinite(g))return g;const h=F(e.current_turn,Number.NaN);if(Number.isFinite(h))return h;const k=F(e.round,Number.NaN);return Number.isFinite(k)?k:void 0})(),v=le(e.phase,e.phase_name,e.current_phase,e.phase_id);return{result:t,reason:n||void 0,summary:s||void 0,details:a||void 0,winner:o||void 0,winner_actor_id:l||void 0,evidence:u.length>0?u:void 0,raw_reason:c||void 0,turn:m,phase:v||void 0}}function Kc(e,t){const n=p(e.state)?e.state:{};if(y(n.status,"active").toLowerCase()!=="ended")return;const a=[...t].reverse().find(l=>p(l)?y(l.type,"")==="session.outcome":!1),o=p(n.session_outcome)?n.session_outcome:{};if(p(o)&&Object.keys(o).length>0){const l=Xi(o);if(l)return l}if(p(a))return Xi(p(a.payload)?a.payload:{})}function y(e,t=""){return typeof e=="string"?e:t}function F(e,t=0){return typeof e=="number"&&Number.isFinite(e)?e:t}function me(e){if(typeof e=="number"&&Number.isFinite(e))return Math.trunc(e);if(typeof e=="string"){const t=Number.parseInt(e.trim(),10);if(Number.isFinite(t))return t}}function Ts(e,t=!1){return typeof e=="boolean"?e:t}function Re(e){return Array.isArray(e)?e.map(t=>{if(typeof t=="string")return t.trim();if(p(t)){const n=y(t.name,"").trim(),s=y(t.id,"").trim(),a=y(t.skill,"").trim();return n||s||a}return""}).filter(t=>t.length>0):[]}function Uc(e){const t={};if(!p(e)&&!Array.isArray(e))return t;if(p(e))return Object.entries(e).forEach(([n,s])=>{const a=n.trim(),o=y(s,"").trim();!a||!o||(t[a]=o)}),t;for(const n of e){if(!p(n))continue;const s=le(n.to,n.target,n.actor_id,n.name,n.id),a=le(n.relationship,n.relation,n.type,n.kind);!s||!a||(t[s]=a)}return t}function Bc(e,t,n){if(e==="dm"||e==="player"||e==="npc")return e;const s=t.trim().toLowerCase();return s==="dm"||s.startsWith("dm-")?"dm":s.startsWith("npc-")||s.startsWith("enemy-")||s.startsWith("mob-")?"npc":/^p\d+$/i.test(s)||s.startsWith("player-")?"player":typeof n=="string"&&n.trim()!==""?n.trim().toLowerCase().includes("dm")?"dm":"player":"npc"}function ye(e,t,n,s=0){const a=e[t];if(typeof a=="number"&&Number.isFinite(a))return a;if(n){const o=e[n];if(typeof o=="number"&&Number.isFinite(o))return o}return s}const Wc=new Set(["str","dex","con","int","wis","cha","strength","dexterity","constitution","intelligence","wisdom","charisma","hp","max_hp","mp","max_mp","level","xp"]);function Hc(e){const t=p(e.stats)?e.stats:{},n={};return Object.entries(t).forEach(([s,a])=>{const o=s.trim();o&&(Wc.has(o.toLowerCase())||typeof a=="number"&&Number.isFinite(a)&&(n[o]=a))}),n}function Gc(e,t){if(e!=="dice.rolled")return;const n=F(t.raw_d20,0),s=F(t.total,0),a=F(t.bonus,0),o=y(t.action,"roll"),l=F(t.dc,0);return{notation:l>0?`${o} (DC ${l})`:o,rolls:n>0?[n]:[],total:s,modifier:a}}function Jc(e){const t=JSON.stringify(e);return t?t.length>160?`${t.slice(0,157)}...`:t:""}function Vc(e){const t=e.trim().toLowerCase();return t?t.startsWith("dice.")?"dice":t.startsWith("combat.")||t.includes(".attack")||t.includes(".damage")?"combat":t.includes("actor.")?"actor":t.includes("turn.")||t==="turn.started"||t==="phase.changed"?"turn":t.includes("join.")?"join":t.includes("memory")?"memory":t.includes("world.")?"world":t.includes("narration")?"story":"meta":"meta"}function Qc(e,t,n,s){const a=n||t||y(s.actor_id,"")||y(s.actor_name,"");switch(e){case"turn.action.proposed":{const o=y(s.proposed_action,y(s.reply,""));return o?`${a||"actor"}: ${o}`:"Action proposed"}case"turn.action.resolved":{const o=y(s.reply,y(s.result,""));return o?`Resolved: ${o}`:"Action resolved"}case"narration.posted":return y(s.reply,y(s.content,y(s.text,"Narration")));case"dice.rolled":{const o=y(s.action,"roll"),l=F(s.total,0),c=F(s.dc,0),u=y(s.label,""),m=a||"actor",v=c>0?` vs DC ${c}`:"",f=u?` (${u})`:"";return`${m} ${o}: ${l}${v}${f}`}case"turn.started":return`Turn ${F(s.turn,1)} started`;case"phase.changed":return`Phase: ${y(s.phase,"round")}`;case"actor.spawned":return`Actor spawned: ${y(s.name,p(s.actor)?y(s.actor.name,a||"unknown"):a||"unknown")}`;case"actor.claimed":return`${y(s.keeper_name,y(s.keeper,"keeper"))} claimed ${a||"actor"}`;case"actor.released":return`${y(s.keeper_name,y(s.keeper,"keeper"))} released ${a||"actor"}`;case"join.window.opened":return`Join window opened (turn ${F(s.turn,0)})`;case"join.window.closed":return`Join window closed (turn ${F(s.turn,0)})`;case"mid.join.requested":return`Mid-join requested: ${a||y(s.actor_id,"actor")}`;case"mid.join.granted":return`Mid-join granted: ${a||y(s.actor_id,"actor")}`;case"mid.join.rejected":return`Mid-join rejected: ${y(s.reason_code,"unknown")}`;case"memory.signal":{const o=p(s.entity_refs)?s.entity_refs:{},l=y(o.requested_tier,""),c=y(o.effective_tier,""),u=Ts(o.guardrail_applied,!1),m=y(s.summary_en,y(s.summary_ko,"Memory signal"));if(!l&&!c)return m;const v=l&&c?`${l}->${c}`:c||l;return`${m} [${v}${u?" (guardrail)":""}]`}case"world.event":{if(y(s.event_type,"")==="canon.check"){const l=y(s.status,"unknown"),c=y(s.contract_id,"n/a");return`Canon ${l}: ${c}`}return y(s.description,y(s.summary,"World event"))}case"combat.attack":return y(s.summary,y(s.result,"Attack resolved"));case"combat.defense":return y(s.summary,y(s.result,"Defense resolved"));case"session.outcome":return y(s.summary,y(s.outcome,"Session ended"));default:{const o=Jc(s);return o?`${e}: ${o}`:e}}}function Yc(e,t){const n=p(e)?e:{},s=y(n.type,"event"),a=typeof n.actor_id=="string"&&n.actor_id.trim()?n.actor_id.trim():"",o=y(n.actor_name,"").trim()||t[a]||y(p(n.payload)?n.payload.actor_name:"",""),l=p(n.payload)?n.payload:{},c=y(n.ts,y(n.timestamp,new Date().toISOString())),u=y(n.phase,y(l.phase,"")),m=y(n.category,"");return{type:s,actor:o||a||y(l.actor_name,""),actor_id:a||y(l.actor_id,""),actor_name:o,seq:n.seq,room_id:y(n.room_id,""),phase:u||void 0,category:m||Vc(s),visibility:y(n.visibility,y(l.visibility,"public")),event_id:y(n.event_id,""),content:Qc(s,a,o,l),dice_roll:Gc(s,l),timestamp:c}}function Xc(e,t,n){var te,se;const s=y(e.room_id,"")||n||"default",a=p(e.state)?e.state:{},o=p(a.party)?a.party:{},l=p(a.actor_control)?a.actor_control:{},c=p(a.join_gate)?a.join_gate:{},u=p(a.contribution_ledger)?a.contribution_ledger:{},m=Object.entries(o).map(([H,Z])=>{const S=p(Z)?Z:{},Se=ye(S,"max_hp",void 0,10),Be=ye(S,"hp",void 0,Se),lt=ye(S,"max_mp",void 0,0),ct=ye(S,"mp",void 0,0),O=ye(S,"level",void 0,1),Ae=ye(S,"xp",void 0,0),dt=Ts(S.alive,Be>0),ln=l[H],cn=typeof ln=="string"?ln:void 0,es=Bc(S.role,H,cn),ts=me(S.generation),ns=le(S.joined_at,S.joinedAt,S.started_at,S.startedAt),ss=le(S.claimed_at,S.claimedAt,S.assigned_at,S.assignedAt,S.assigned_time),K=le(S.last_seen,S.lastSeen,S.last_seen_at,S.lastSeenAt,S.last_active,S.lastActive),Ct=le(S.scene,S.current_scene,S.currentScene,S.world_scene,S.scene_name,S.sceneName),ql=le(S.location,S.current_location,S.currentLocation,S.position,S.zone,S.area);return{id:H,name:y(S.name,H),role:es,keeper:cn,archetype:y(S.archetype,""),persona:y(S.persona,""),portrait:y(S.portrait,"")||void 0,background:y(S.background,"")||void 0,traits:Re(S.traits),skills:Re(S.skills),stats_raw:Hc(S),status:dt?"active":"dead",generation:ts,joined_at:ns||void 0,claimed_at:ss||void 0,last_seen:K||void 0,scene:Ct||void 0,location:ql||void 0,inventory:Re(S.inventory),notes:Re(S.notes),relationships:Uc(S.relationships),stats:{hp:Be,max_hp:Se,mp:ct,max_mp:lt,level:O,xp:Ae,strength:ye(S,"strength","str",10),dexterity:ye(S,"dexterity","dex",10),constitution:ye(S,"constitution","con",10),intelligence:ye(S,"intelligence","int",10),wisdom:ye(S,"wisdom","wis",10),charisma:ye(S,"charisma","cha",10)}}}),v=m.filter(H=>H.status!=="dead"),f=Kc(e,t),g={phase_open:Ts(c.phase_open,!0),min_points:F(c.min_points,3),window:y(c.window,"round_boundary_only"),last_opened_turn:typeof c.last_opened_turn=="number"?c.last_opened_turn:null,last_closed_turn:typeof c.last_closed_turn=="number"?c.last_closed_turn:null},h=Object.entries(u).map(([H,Z])=>{const S=p(Z)?Z:{};return{actor_id:H,score:F(S.score,0),last_reason:y(S.last_reason,"")||null,reasons:Re(S.reasons)}}),k=m.reduce((H,Z)=>(H[Z.id]=Z.name,H),{}),$=t.map(H=>Yc(H,k)),C=F(a.turn,1),A=y(a.phase,"round"),T=y(a.map,""),x=p(a.world)?a.world:{},R=T||y(x.ascii_map,y(x.map,"")),P=$.filter((H,Z)=>{const S=t[Z];if(!p(S))return!1;const Se=p(S.payload)?S.payload:{};return F(Se.turn,-1)===C}),E=(P.length>0?P:$).slice(-12),G=y(a.status,"active");return{session:{id:s,room:s,status:G==="ended"?"ended":G==="paused"?"paused":"active",round:C,actors:v,created_at:((te=$[0])==null?void 0:te.timestamp)??new Date().toISOString()},current_round:{round_number:C,phase:A,events:E,timestamp:((se=$[$.length-1])==null?void 0:se.timestamp)??new Date().toISOString()},map:R||void 0,join_gate:g,contribution_ledger:h,outcome:f,party:v,story_log:$,history:[]}}async function Zc(e){const t=`?room_id=${encodeURIComponent(e)}`,n=await ee(`/api/v1/trpg/events${t}`);return Array.isArray(n.events)?n.events:[]}async function ed(e){const t=`?room_id=${encodeURIComponent(e)}`,[n,s]=await Promise.all([ee(`/api/v1/trpg/state${t}`),Zc(e)]);return Xc(n,s,e)}function td(e){return Me("/api/v1/trpg/rounds/run",{room_id:e})}function nd(e){const t="".trim().toLowerCase();if(t)switch(t){case"discussion":case"discuss":case"party_discussion":case"player_discussion":case"action":case"dice":return"round";case"ended":return"end";default:return t}}function sd(e){const t={room_id:e.roomId,actor_id:e.actorId,action:e.action,stat_value:e.statValue,dc:e.dc};return e.rawD20!=null&&(t.raw_d20=e.rawD20),e.ruleModule&&(t.rule_module=e.ruleModule),Me("/api/v1/trpg/dice/roll",t)}function ad(e,t){const n=nd();return Me("/api/v1/trpg/turns/advance",{room_id:e,...n?{phase:n}:{}})}function id(e,t){var a;const n=(a=t.idempotencyKey)==null?void 0:a.trim(),s={room_id:e};return t.actor_id&&t.actor_id.trim()&&(s.actor_id=t.actor_id.trim()),t.name&&t.name.trim()&&(s.name=t.name.trim()),t.role&&(s.role=t.role),t.archetype&&t.archetype.trim()&&(s.archetype=t.archetype.trim()),t.persona&&t.persona.trim()&&(s.persona=t.persona.trim()),t.portrait&&t.portrait.trim()&&(s.portrait=t.portrait.trim()),t.background&&t.background.trim()&&(s.background=t.background.trim()),t.hp!=null&&(s.hp=t.hp),t.max_hp!=null&&(s.max_hp=t.max_hp),t.alive!=null&&(s.alive=t.alive),Array.isArray(t.traits)&&t.traits.length>0&&(s.traits=t.traits),Array.isArray(t.skills)&&t.skills.length>0&&(s.skills=t.skills),Array.isArray(t.inventory)&&t.inventory.length>0&&(s.inventory=t.inventory),t.stats&&Object.keys(t.stats).length>0&&(s.stats=t.stats),n&&(s.idempotency_key=n),Me("/api/v1/trpg/actors/spawn",s,n?{"Idempotency-Key":n}:void 0)}function od(e,t,n){return Me("/api/v1/trpg/actors/claim",{room_id:e,actor_id:t,keeper:n})}async function rd(e,t,n){const s=await it("trpg.join.eligibility",{room_id:e,actor_id:t,...n?{keeper_name:n}:{}});return JSON.parse(s)}async function ld(e){const t=await it("trpg.mid_join.request",e);return JSON.parse(t)}async function cd(e,t){await it("masc_broadcast",{agent_name:e,message:t})}async function dd(e=40){return(await it("masc_messages",{limit:e})).split(`
`).map(n=>n.trim()).filter(n=>n!=="")}async function ud(e,t=20){return it("masc_task_history",{task_id:e,limit:t})}async function pd(e){const t=await it("masc_debate_start",{topic:e});try{return JSON.parse(t)}catch{return null}}async function md(e){return la("fetchDebateStatus",async()=>{const t=encodeURIComponent(e),n=await ee(`/api/v1/council/debates/${t}/summary`);if(!p(n))return null;const s=p(n.debate)?n.debate:n,a=y(s.id,"").trim(),o=y(s.topic,"").trim();return!a||!o?null:{debate:{id:a,topic:o,status:y(s.status,"open"),created_at:re(s.created_at_iso??s.created_at),closed_at:re(s.closed_at)},arguments:Array.isArray(n.arguments)?n.arguments.flatMap(l=>p(l)?[{index:F(l.index,0),agent:y(l.agent,"unknown"),position:y(l.position,"neutral"),content:y(l.content,""),evidence:Re(l.evidence),reply_to:me(l.reply_to)??null,mentions:Re(l.mentions),archetype:M(l.archetype),created_at:re(l.created_at)}]:[]):[],summary:{support_count:p(n.summary)?F(n.summary.support_count,0):F(n.support_count,0),oppose_count:p(n.summary)?F(n.summary.oppose_count,0):F(n.oppose_count,0),neutral_count:p(n.summary)?F(n.summary.neutral_count,0):F(n.neutral_count,0),total_arguments:p(n.summary)?F(n.summary.total_arguments,0):F(n.total_arguments,0),summary_text:p(n.summary)?y(n.summary.summary_text,""):y(n.summary_text,"")},context:bi(n.context),judgment:Yo(n.judgment)}})}async function vd(e){return la("fetchConsensusSessionSummary",async()=>{const t=encodeURIComponent(e),n=await ee(`/api/v1/council/sessions/${t}/summary`);if(!p(n)||!p(n.session))return null;const s=n.session,a=y(s.id,"").trim(),o=y(s.topic,"").trim();return!a||!o?null:{session:{id:a,topic:o,state:y(s.state,"open"),initiator:y(s.initiator,"system"),quorum:F(s.quorum,0),threshold:F(s.threshold,0),created_at:re(s.created_at),closed_at:re(s.closed_at)},votes:Array.isArray(n.votes)?n.votes.flatMap(l=>p(l)?[{agent:y(l.agent,"unknown"),decision:y(l.decision,"abstain"),reason:y(l.reason,""),timestamp:re(l.timestamp),weight:typeof l.weight=="number"?l.weight:void 0,archetype:M(l.archetype)}]:[]):[],summary:{approve_count:p(n.summary)?F(n.summary.approve_count,0):0,reject_count:p(n.summary)?F(n.summary.reject_count,0):0,abstain_count:p(n.summary)?F(n.summary.abstain_count,0):0,quorum_met:p(n.summary)?Ts(n.summary.quorum_met,!1):!1,result:p(n.summary)?M(n.summary.result):null},context:bi(n.context),judgment:Yo(n.judgment)}})}function _d(e,t,n){return it("masc_keeper_msg",{name:e,message:t})}const fd=_(""),Fe=_({}),ce=_({}),Qa=_({}),Ya=_({}),Xa=_({}),Za=_({}),Ke=_({});function ie(e,t,n){e.value={...e.value,[t]:n}}function gd(e){var n;const t=(n=r(e))==null?void 0:n.toLowerCase();return t==="user"||t==="assistant"||t==="system"||t==="tool"?t:"other"}function $d(e){switch(e){case"user":return"User";case"assistant":return"Keeper";case"system":return"System";case"tool":return"Tool";default:return"Event"}}function $a(e,t){if(!Array.isArray(e))return[];const n=[];for(const s of e){if(!p(s))continue;const a=r(s.name);if(!a)continue;const o=r(s[t]);t==="summary"?n.push({name:a,summary:o}):n.push({name:a,reason:o})}return n}function hd(e){if(!p(e))return null;const t=r(e.name);return t?{name:t,trigger:r(e.trigger),outcome:r(e.outcome),summary:r(e.summary),reason:r(e.reason)}:null}function yd(e){const t=e.toLowerCase();return t.includes("graphql")?"graphql_error":t.includes("timeout")||t.includes("model")||t.includes("llm")||t.includes("api key")||t.includes("api_key")||t.includes("provider")?"llm_error":"unknown"}function bd(e,t){return e==="offline"||e==="degraded"||e==="stale"?"Keeper is not in a healthy reply state. Probe or recover before relying on automation.":t==="quiet_hours"?"Lodge quiet hours are active. Direct messages still work, but scheduled social ticks may look asleep.":t==="min_gap"?"Keeper is inside its proactive cooldown window. Direct messages work now; autonomous check-ins will wait.":t==="never_started"?"Keeper metadata exists but no reply turn has been recorded yet.":"Keeper is reachable. Send a direct message for an immediate response."}function Zo(e,t,n){return r(e)??bd(t,n)}function er(e,t){return typeof e=="boolean"?e:t==="recover"}function Rs(e){if(!p(e))return null;const t=r(e.health_state),n=r(e.next_action_path),s=r(e.last_reply_status);return!t||!n||!s?null:{health_state:t,quiet_reason:r(e.quiet_reason)??null,next_action_path:n,last_reply_status:s,last_reply_at:nt(e.last_reply_at)??null,last_reply_preview:r(e.last_reply_preview)??null,last_error:r(e.last_error)??null,next_eligible_at_s:d(e.next_eligible_at_s)??null,recoverable:er(e.recoverable,n),summary:Zo(e.summary,t,r(e.quiet_reason)??null),keepalive_running:typeof e.keepalive_running=="boolean"?e.keepalive_running:void 0}}function tr(e){return p(e)?{hour:d(e.hour),checked:d(e.checked)??0,acted:d(e.acted)??0,acted_names:W(e.acted_names),activity_report:r(e.activity_report),quiet_hours_overridden:U(e.quiet_hours_overridden),skipped_reason:r(e.skipped_reason),acted_rows:$a(e.acted_rows,"summary").map(t=>({name:t.name,summary:t.summary})),passed_rows:$a(e.passed_rows,"reason").map(t=>({name:t.name,reason:t.reason})),skipped_rows:$a(e.skipped_rows,"reason").map(t=>({name:t.name,reason:t.reason})),checkins:Array.isArray(e.checkins)?e.checkins.map(hd).filter(t=>t!==null):[]}:null}function kd(e){return p(e)?{enabled:U(e.enabled)??!1,interval_s:d(e.interval_s)??0,quiet_start:d(e.quiet_start),quiet_end:d(e.quiet_end),quiet_active:U(e.quiet_active),use_planner:U(e.use_planner),delegate_llm:U(e.delegate_llm),agent_count:d(e.agent_count),agents:W(e.agents),last_tick_ago_s:d(e.last_tick_ago_s)??null,last_tick_ago:r(e.last_tick_ago),total_ticks:d(e.total_ticks),total_checkins:d(e.total_checkins),last_skip_reason:r(e.last_skip_reason)??null,last_tick_result:tr(e.last_tick_result),active_self_heartbeats:W(e.active_self_heartbeats)}:null}function xd(e){return p(e)?{status:e.status,diagnostic:Rs(e.diagnostic)}:null}function Sd(e){return p(e)?{recovered:U(e.recovered)??!1,skipped_reason:r(e.skipped_reason)??null,before:Rs(e.before),after:Rs(e.after),down:e.down,up:e.up}:null}function Ad(e,t){var T,x;if(!(e!=null&&e.name))return null;const n=r((T=e.agent)==null?void 0:T.status)??r(e.status)??"unknown",s=r((x=e.agent)==null?void 0:x.error)??null,a=e.presence_keepalive??!0,o=e.keepalive_running??!1,l=e.turn_count??0,c=e.last_turn_ago_s??null,u=e.proactive_enabled??!1,m=e.proactive_cooldown_sec??0,v=e.last_proactive_ago_s??null,f=u&&v!=null?Math.max(0,m-v):null,g=l<=0||c==null?"never":c>900?"stale":"fresh",h=typeof e.last_heartbeat=="string"&&e.last_heartbeat.trim()?e.last_heartbeat:null,k=s??(a&&!o?"keeper keepalive is not running":null),$=n==="offline"||n==="inactive"?"offline":k?"degraded":g==="stale"?"stale":g==="never"?"idle":"healthy",C=k?yd(k):t!=null&&t.quiet_active&&g!=="fresh"?"quiet_hours":a&&!o?"disabled":l<=0?"never_started":f!=null&&f>0?"min_gap":g==="fresh"||g==="stale"?"no_recent_activity":"unknown",A=$==="offline"||$==="degraded"||$==="stale"?"recover":C==="quiet_hours"?"manual_lodge_poke":C==="unknown"?"probe":"direct_message";return{health_state:$,quiet_reason:C,next_action_path:A,last_reply_status:g,last_reply_at:h,last_reply_preview:null,last_error:k,next_eligible_at_s:f!=null&&f>0?f:null,recoverable:er(void 0,A),summary:Zo(void 0,$,C),keepalive_running:o}}function Cd(e,t){if(!p(e))return null;const n=gd(e.role),s=r(e.content)??r(e.preview);if(!s)return null;const a=nt(e.ts_unix)??nt(e.timestamp);return{id:`${n}-${a??"entry"}-${t}`,role:n,label:$d(n),text:s,timestamp:a,delivery:"history"}}function Id(e,t,n){const s=p(n)?n:null,a=Array.isArray(s==null?void 0:s.history_tail)?s.history_tail.map((o,l)=>Cd(o,l)).filter(o=>o!==null):[];return{name:e,diagnostic:Rs(s==null?void 0:s.diagnostic),history:a,rawText:t,rawStatus:n,loadedAt:new Date().toISOString()}}function Zi(e,t){const n=ce.value[e]??[];ce.value={...ce.value,[e]:[...n,t].slice(-50)}}function Td(e,t){return e.role!==t.role||e.text!==t.text?!1:e.timestamp&&t.timestamp?e.timestamp===t.timestamp:!0}function Rd(e,t){const s=(ce.value[e]??[]).filter(a=>a.delivery!=="history"&&!t.some(o=>Td(a,o)));ce.value={...ce.value,[e]:[...t,...s].slice(-50)}}function da(e,t){Fe.value={...Fe.value,[e]:t},Rd(e,t.history)}function eo(e,t){const n=Fe.value[e];if(!n)return;const s=n.diagnostic??{health_state:"idle",next_action_path:"direct_message",last_reply_status:"unknown"};da(e,{...n,diagnostic:{...s,...t}})}async function ki(){try{await Hn()}catch(e){console.warn("[keeper-runtime] dashboard refresh failed",e)}}function Pd(e){fd.value=e.trim()}async function nr(e,t=!1){const n=e.trim();if(!n)return null;if(!t&&Fe.value[n])return Fe.value[n];ie(Qa,n,!0),ie(Ke,n,null);try{const s=await it("masc_keeper_status",{name:n,fast:!1,include_context:!0,include_metrics_overview:!0,include_memory_bank:!1,include_history_tail:!0,include_compaction_history:!1,tail_turns:5,tail_messages:10});let a=null;try{a=JSON.parse(s)}catch{a=null}const o=Id(n,s,a);return da(n,o),o}catch(s){const a=s instanceof Error?s.message:`Failed to inspect ${n}`;return ie(Ke,n,a),null}finally{ie(Qa,n,!1)}}async function wd(e,t){const n=e.trim(),s=t.trim();if(!n||!s)return;const a=`local-${Date.now()}`;Zi(n,{id:a,role:"user",label:"You",text:s,timestamp:new Date().toISOString(),delivery:"sending"}),ie(Ya,n,!0),ie(Ke,n,null);try{const o=await _d(n,s);ce.value={...ce.value,[n]:(ce.value[n]??[]).map(l=>l.id===a?{...l,delivery:"delivered"}:l)},Zi(n,{id:`reply-${Date.now()}`,role:"assistant",label:n,text:o.trim()||"(empty reply)",timestamp:new Date().toISOString(),delivery:"delivered"}),eo(n,{last_reply_status:"delivered",last_reply_at:new Date().toISOString(),last_reply_preview:(o.trim()||"(empty reply)").slice(0,200),last_error:null}),await ki()}catch(o){const l=o instanceof Error?o.message:`Failed to send direct message to ${n}`;throw ce.value={...ce.value,[n]:(ce.value[n]??[]).map(c=>c.id===a?{...c,delivery:"error",error:l}:c)},eo(n,{last_reply_status:"error",last_error:l}),ie(Ke,n,l),o}finally{ie(Ya,n,!1)}}async function Ld(e,t){const n=e.trim();if(!n)return null;ie(Xa,n,!0),ie(Ke,n,null);try{const s=await ca({actor:t,action_type:"keeper_probe",target_type:"keeper",target_id:n,payload:{}}),a=xd(s.result),o=(a==null?void 0:a.diagnostic)??null;if(o){const l=Fe.value[n];da(n,{name:n,diagnostic:o,history:(l==null?void 0:l.history)??ce.value[n]??[],rawText:(l==null?void 0:l.rawText)??"",rawStatus:s.result,loadedAt:new Date().toISOString()})}return await ki(),o}catch(s){const a=s instanceof Error?s.message:`Failed to probe ${n}`;throw ie(Ke,n,a),s}finally{ie(Xa,n,!1)}}async function Nd(e,t){const n=e.trim();if(!n)return null;ie(Za,n,!0),ie(Ke,n,null);try{const s=await ca({actor:t,action_type:"keeper_recover",target_type:"keeper",target_id:n,payload:{}}),a=Sd(s.result),o=(a==null?void 0:a.after)??null;if(o){const l=Fe.value[n];da(n,{name:n,diagnostic:o,history:(l==null?void 0:l.history)??ce.value[n]??[],rawText:(l==null?void 0:l.rawText)??"",rawStatus:s.result,loadedAt:new Date().toISOString()})}return await ki(),o}catch(s){const a=s instanceof Error?s.message:`Failed to recover ${n}`;throw ie(Ke,n,a),s}finally{ie(Za,n,!1)}}function ut(e){return(e??"").trim().toLowerCase()}function ve(e){const t=typeof e=="number"?e:Date.parse(e);return Number.isNaN(t)?0:t}function gs(e,t=88){const n=e.replace(/\s+/g," ").trim();return n&&(n.length>t?`${n.slice(0,t-3)}...`:n)}function as(e){return typeof e!="number"||!Number.isFinite(e)||e<0?null:new Date(Date.now()-e*1e3).toISOString()}function dn(e){return e.last_heartbeat??as(e.last_turn_ago_s)??as(e.last_proactive_ago_s)??as(e.last_handoff_ago_s)??as(e.last_compaction_ago_s)}function Md(e){const t=e.title.trim();return t||gs(e.content)}function zd(e){const t=e.generation??"?",n=typeof e.context_ratio=="number"&&Number.isFinite(e.context_ratio)?`${Math.round(e.context_ratio*100)}%`:"?";return e.last_heartbeat?`Heartbeat gen=${t} ctx=${n}`:`Keeper snapshot gen=${t} ctx=${n}`}function Ed(e,t,n,s,a={}){var x;const o=ut(e),l=t.filter(R=>ut(R.assignee)===o&&(R.status==="claimed"||R.status==="in_progress")).length,c=n.filter(R=>ut(R.from)===o).sort((R,P)=>ve(P.timestamp)-ve(R.timestamp))[0],u=s.filter(R=>ut(R.agent)===o||ut(R.author)===o).sort((R,P)=>ve(P.timestamp)-ve(R.timestamp))[0],m=(a.boardPosts??[]).filter(R=>ut(R.author)===o).sort((R,P)=>ve(P.updated_at||P.created_at)-ve(R.updated_at||R.created_at))[0],v=(a.keepers??[]).filter(R=>ut(R.name)===o&&dn(R)!==null).sort((R,P)=>ve(dn(P)??0)-ve(dn(R)??0))[0],f=c?ve(c.timestamp):0,g=u?ve(u.timestamp):0,h=m?ve(m.updated_at||m.created_at):0,k=v?ve(dn(v)??0):0,$=a.lastSeen?ve(a.lastSeen):0,C=((x=a.currentTask)==null?void 0:x.trim())||(l>0?`${l} claimed tasks`:null);if(f===0&&g===0&&h===0&&k===0&&$===0)return{activeAssignedCount:l,lastActivityAt:null,lastActivityText:C};const T=[c?{timestamp:c.timestamp,ts:f,text:gs(c.content)}:null,m?{timestamp:m.updated_at||m.created_at,ts:h,text:`Post: ${gs(Md(m))}`}:null,v?{timestamp:dn(v),ts:k,text:zd(v)}:null,u?{timestamp:new Date(u.timestamp).toISOString(),ts:g,text:gs(u.text)}:null].filter(R=>R!==null).sort((R,P)=>P.ts-R.ts)[0];return T&&T.ts>=$?{activeAssignedCount:l,lastActivityAt:T.timestamp,lastActivityText:T.text}:{activeAssignedCount:l,lastActivityAt:a.lastSeen??null,lastActivityText:C??"Presence heartbeat"}}const ze=_([]),Le=_([]),Yt=_([]),Ue=_([]),oe=_(null),Dd=_(null),sr=_(null),ar=_([]),ir=_([]),or=_([]),rr=_([]),lr=_([]),cr=_([]),ei=_(new Map),Cn=_([]),In=_("recent"),Nt=_(!0),dr=_(null),qe=_(""),Ft=_([]),fn=_(!1),ur=_(new Map),xi=_("unknown"),Kt=_(null),ti=_(!1),Tn=_(!1),ni=_(!1),gn=_(!1),Si=_(null),Ps=_(!1),ws=_(null),pr=_(null),si=_(null),jd=_(null),Od=_(null),qd=_(null);xe(()=>ze.value.filter(e=>e.status==="active"||e.status==="busy"||e.status==="listening"||e.status==="idle"));const mr=xe(()=>{const e=Le.value;return{todo:e.filter(t=>t.status==="todo"),inProgress:e.filter(t=>t.status==="in_progress"||t.status==="claimed"),done:e.filter(t=>t.status==="done")}}),vr=xe(()=>{const e=new Map,t=Le.value,n=Yt.value,s=Is.value,a=Cn.value,o=Ue.value;for(const l of ze.value)e.set(l.name.trim().toLowerCase(),Ed(l.name,t,n,s,{currentTask:l.current_task,lastSeen:l.last_seen,boardPosts:a,keepers:o}));return e});function Fd(e){var o;const t=((o=e.status)==null?void 0:o.toLowerCase())??"";if(t==="offline"||t==="inactive")return"offline";const n=e.metrics_series;if(!n||n.length===0)return"idle";const s=n[n.length-1];if(!s)return"idle";if(s.is_handoff)return"handoff-imminent";if(s.is_compaction)return"compacting";const a=s.context_ratio;return a>.85?"handoff-imminent":a>.7?"preparing":a>.5?"compacting":"active"}xe(()=>{const e=new Map;for(const t of Ue.value)e.set(t.name,Fd(t));return e});const Kd=12e4;function Ud(e,t){const n=t.get(e.name);if(n!=null)return n;const s=e.last_heartbeat?Date.parse(e.last_heartbeat):Number.NaN;if(!Number.isNaN(s))return s;const a=[e.last_turn_ago_s,e.last_proactive_ago_s,e.last_handoff_ago_s,e.last_compaction_ago_s].find(o=>typeof o=="number"&&Number.isFinite(o)&&o>=0);return typeof a=="number"?Date.now()-a*1e3:null}xe(()=>{const e=Date.now(),t=new Set,n=ei.value;for(const s of Ue.value){const a=Ud(s,n);a!=null&&e-a>Kd&&t.add(s.name)}return t});function Bd(e){return e==="dashboard_refresh"||e==="masc/dashboard_refresh"||e.startsWith("goal_")||e.startsWith("masc/goal_")||e.startsWith("mdal_")||e.startsWith("masc/mdal_")||e.startsWith("operator_")||e.startsWith("masc/operator_")||e.startsWith("command_plane_")||e.startsWith("masc/command_plane_")}function _r(e){const t=typeof e=="string"?e.toLowerCase():"";return t==="active"||t==="busy"||t==="listening"||t==="idle"||t==="inactive"||t==="offline"?t:t==="in_progress"||t==="claimed"?"busy":"offline"}function Wd(e){const t=typeof e=="string"?e.toLowerCase():"";return t==="todo"||t==="in_progress"||t==="claimed"||t==="done"||t==="cancelled"?t:t==="inprogress"?"in_progress":"todo"}function Hd(e){if(!p(e))return null;const t=r(e.name);return t?{name:t,agent_type:r(e.agent_type),status:_r(e.status),current_task:r(e.current_task)??null,joined_at:r(e.joined_at),last_seen:r(e.last_seen),capabilities:W(e.capabilities),emoji:r(e.emoji),koreanName:r(e.koreanName)??r(e.korean_name),model:r(e.model),traits:W(e.traits),interests:W(e.interests),activityLevel:d(e.activityLevel)??d(e.activity_level),primaryValue:r(e.primaryValue)??r(e.primary_value)}:null}function Gd(e){if(!p(e))return null;const t=r(e.id),n=r(e.title);return!t||!n?null:{id:t,title:n,status:Wd(e.status),priority:d(e.priority),assignee:r(e.assignee),description:r(e.description),created_at:r(e.created_at),updated_at:r(e.updated_at)}}function Jd(e){if(!p(e))return null;const t=r(e.from)??r(e.from_agent)??"system",n=r(e.content)??"",s=r(e.timestamp)??new Date().toISOString();return{id:r(e.id),seq:d(e.seq),from:t,content:n,timestamp:s,type:r(e.type)}}function Ai(e){const t=typeof e=="string"?e.toLowerCase():"";return t==="ok"||t==="warn"||t==="bad"?t:"ok"}function Vd(e){return p(e)?{active_sessions:d(e.active_sessions),blocked_sessions:d(e.blocked_sessions),active_operations:d(e.active_operations),blocked_operations:d(e.blocked_operations),runtime_pressure:d(e.runtime_pressure),worker_alerts:d(e.worker_alerts),continuity_alerts:d(e.continuity_alerts),priority_items:d(e.priority_items),todo_tasks:d(e.todo_tasks),claimed_tasks:d(e.claimed_tasks),running_tasks:d(e.running_tasks),done_tasks:d(e.done_tasks),cancelled_tasks:d(e.cancelled_tasks),keepers:d(e.keepers)}:null}function Qe(e){if(!p(e))return null;const t=r(e.surface),n=r(e.label),s=r(e.target_type),a=r(e.target_id),o=r(e.focus_kind);return!t||!n||!s||!a||!o?null:{surface:t==="command"?"command":"intervene",label:n,target_type:s,target_id:a,focus_kind:o,operation_id:r(e.operation_id)??null,command_surface:r(e.command_surface)??null}}function Qd(e){if(!p(e))return null;const t=r(e.id),n=r(e.kind),s=r(e.summary),a=r(e.target_type),o=r(e.target_id);return!t||!s||!a||!o||n!=="session"&&n!=="operation"?null:{id:t,kind:n,severity:Ai(e.severity),status:r(e.status),summary:s,target_type:a,target_id:o,linked_session_id:r(e.linked_session_id)??null,linked_operation_id:r(e.linked_operation_id)??null,last_seen_at:r(e.last_seen_at)??null,top_handoff:Qe(e.top_handoff),intervene_handoff:Qe(e.intervene_handoff),command_handoff:Qe(e.command_handoff)}}function Yd(e){if(!p(e))return null;const t=r(e.session_id),n=r(e.goal);return!t||!n?null:{session_id:t,goal:n,room:r(e.room)??null,status:r(e.status),health:r(e.health),member_names:W(e.member_names),linked_operation_id:r(e.linked_operation_id)??null,linked_detachment_id:r(e.linked_detachment_id)??null,runtime_blocker:r(e.runtime_blocker)??null,worker_gap_summary:r(e.worker_gap_summary)??null,last_activity_at:r(e.last_activity_at)??null,last_activity_summary:r(e.last_activity_summary)??null,communication_summary:r(e.communication_summary)??null,active_count:d(e.active_count),required_count:d(e.required_count),top_handoff:Qe(e.top_handoff),intervene_handoff:Qe(e.intervene_handoff),command_handoff:Qe(e.command_handoff)}}function Xd(e){if(!p(e))return null;const t=r(e.operation_id),n=r(e.objective);return!t||!n?null:{operation_id:t,objective:n,status:r(e.status),stage:r(e.stage)??null,assigned_unit_id:r(e.assigned_unit_id)??null,assigned_unit_label:r(e.assigned_unit_label)??null,linked_session_id:r(e.linked_session_id)??null,linked_detachment_id:r(e.linked_detachment_id)??null,blocker_summary:r(e.blocker_summary)??null,search_status:r(e.search_status)??null,next_tool:r(e.next_tool)??null,updated_at:r(e.updated_at)??null,top_handoff:Qe(e.top_handoff),command_handoff:Qe(e.command_handoff)}}function to(e){if(!p(e))return null;const t=r(e.name)??r(e.agent_name),n=r(e.note),s=r(e.focus),a=r(e.state);return!t||!n||!s||a!=="working"&&a!=="watching"&&a!=="quiet"&&a!=="offline"?null:{name:t,agent_name:r(e.agent_name),status:r(e.status),tone:Ai(e.tone),state:a,note:n,focus:s,last_signal_at:r(e.last_signal_at)??null,active_task_count:d(e.active_task_count),related_session_id:r(e.related_session_id)??null,related_operation_id:r(e.related_operation_id)??null,emoji:r(e.emoji),korean_name:r(e.korean_name),model:r(e.model)??null,recent_output_preview:r(e.recent_output_preview)??null,recent_event:r(e.recent_event)??null}}function Zd(e){if(!p(e))return null;const t=r(e.name),n=r(e.note),s=r(e.focus),a=r(e.state);return!t||!n||!s||a!=="healthy"&&a!=="warning"&&a!=="critical"?null:{name:t,agent_name:r(e.agent_name)??null,status:r(e.status),tone:Ai(e.tone),state:a,note:n,focus:s,last_signal_at:r(e.last_signal_at)??null,last_autonomous_action_at:r(e.last_autonomous_action_at)??null,generation:d(e.generation),turn_count:d(e.turn_count),context_ratio:d(e.context_ratio)??null,continuity:r(e.continuity)??null,lifecycle:r(e.lifecycle)??null,related_session_id:r(e.related_session_id)??null,model:r(e.model)??null,emoji:r(e.emoji),korean_name:r(e.korean_name),skill_reason:r(e.skill_reason)??null}}function no(e){if(typeof e.seq=="number"&&Number.isFinite(e.seq))return e.seq;const t=Date.parse(e.timestamp);return Number.isNaN(t)?0:t}function eu(e,t){if(t.length===0)return e;const n=new Map;for(const s of e){const a=typeof s.seq=="number"?`seq:${s.seq}`:`ts:${s.timestamp}|from:${s.from}|content:${s.content}`;n.set(a,s)}for(const s of t){const a=typeof s.seq=="number"?`seq:${s.seq}`:`ts:${s.timestamp}|from:${s.from}|content:${s.content}`;n.set(a,s)}return[...n.values()].sort((s,a)=>no(s)-no(a)).slice(-500)}function tu(e){return Array.isArray(e)?e.map(t=>{if(!p(t))return null;const n=d(t.ts_unix);if(n==null)return null;const s=p(t.handoff)?t.handoff:null;return{ts:n,context_ratio:d(t.context_ratio)??0,context_tokens:d(t.context_tokens)??0,context_max:d(t.context_max)??0,latency_ms:d(t.latency_ms)??0,generation:d(t.generation)??0,channel:typeof t.channel=="string"?t.channel:"turn",is_handoff:s!=null&&t.handoff_performed===!0,is_compaction:t.compacted===!0,compaction_saved_tokens:d(t.compaction_saved_tokens)??0,compaction_trigger:typeof t.compaction_trigger=="string"?t.compaction_trigger:null,model_used:typeof t.model_used=="string"?t.model_used:"",cost_usd:d(t.cost_usd)??0,handoff_to_model:s&&typeof s.to_model=="string"?s.to_model:null,handoff_new_generation:s?d(s.new_generation)??null:null}}).filter(t=>t!==null):[]}function so(e){if(!p(e))return null;const t=r(e.health_state),n=r(e.next_action_path),s=r(e.last_reply_status);if(!t||!n||!s)return null;const a=r(e.quiet_reason)??null,o=r(e.summary)??(t==="offline"||t==="degraded"||t==="stale"?"Keeper is not in a healthy reply state. Probe or recover before relying on automation.":a==="quiet_hours"?"Lodge quiet hours are active. Direct messages still work, but scheduled social ticks may look asleep.":a==="min_gap"?"Keeper is inside its proactive cooldown window. Direct messages work now; autonomous check-ins will wait.":a==="never_started"?"Keeper metadata exists but no reply turn has been recorded yet.":"Keeper is reachable. Send a direct message for an immediate response.");return{health_state:t,quiet_reason:a,next_action_path:n,last_reply_status:s,last_reply_at:nt(e.last_reply_at)??r(e.last_reply_at)??null,last_reply_preview:r(e.last_reply_preview)??null,last_error:r(e.last_error)??null,next_eligible_at_s:d(e.next_eligible_at_s)??null,recoverable:typeof e.recoverable=="boolean"?e.recoverable:n==="recover",summary:o,keepalive_running:typeof e.keepalive_running=="boolean"?e.keepalive_running:void 0}}function nu(e,t){return(Array.isArray(e)?e:p(e)&&Array.isArray(e.keepers)?e.keepers:[]).map(s=>{if(!p(s))return null;const a=p(s.agent)?s.agent:null,o=p(s.context)?s.context:null,l=p(s.metrics_window)?s.metrics_window:void 0,c=r(s.name);if(!c)return null;const u=d(s.context_ratio)??d(o==null?void 0:o.context_ratio),m=r(s.status)??r(a==null?void 0:a.status)??"offline",v=_r(m),f=r(s.model)??r(s.active_model)??r(s.primary_model),g=W(s.skill_secondary),h=o?{source:r(o.source),context_ratio:d(o.context_ratio),context_tokens:d(o.context_tokens),context_max:d(o.context_max),message_count:d(o.message_count),has_checkpoint:typeof o.has_checkpoint=="boolean"?o.has_checkpoint:void 0}:void 0,k=a?{name:r(a.name),exists:typeof a.exists=="boolean"?a.exists:void 0,error:r(a.error),agent_type:r(a.agent_type),status:r(a.status),current_task:r(a.current_task)??null,joined_at:r(a.joined_at),last_seen:r(a.last_seen),last_seen_ago_s:d(a.last_seen_ago_s),capabilities:W(a.capabilities),is_zombie:typeof a.is_zombie=="boolean"?a.is_zombie:void 0}:void 0,$=tu(s.metrics_series),C={name:c,emoji:r(s.emoji),koreanName:r(s.koreanName)??r(s.korean_name),agent_name:r(s.agent_name),trace_id:r(s.trace_id),model:f,primary_model:r(s.primary_model),active_model:r(s.active_model),next_model_hint:r(s.next_model_hint)??null,status:v,presence_keepalive:typeof s.presence_keepalive=="boolean"?s.presence_keepalive:void 0,presence_keepalive_sec:d(s.presence_keepalive_sec),keepalive_running:typeof s.keepalive_running=="boolean"?s.keepalive_running:void 0,proactive_enabled:typeof s.proactive_enabled=="boolean"?s.proactive_enabled:void 0,proactive_idle_sec:d(s.proactive_idle_sec),proactive_cooldown_sec:d(s.proactive_cooldown_sec),last_heartbeat:r(s.last_heartbeat)??r(a==null?void 0:a.last_seen),generation:d(s.generation),turn_count:d(s.turn_count)??d(s.total_turns),keeper_age_s:d(s.keeper_age_s),last_turn_ago_s:d(s.last_turn_ago_s),last_handoff_ago_s:d(s.last_handoff_ago_s),last_compaction_ago_s:d(s.last_compaction_ago_s),last_proactive_ago_s:d(s.last_proactive_ago_s),last_proactive_preview:r(s.last_proactive_preview)??null,context_ratio:u,context_tokens:d(s.context_tokens)??d(o==null?void 0:o.context_tokens),context_max:d(s.context_max)??d(o==null?void 0:o.context_max),context_source:r(s.context_source)??r(o==null?void 0:o.source),context:h,traits:W(s.traits),interests:W(s.interests),primaryValue:r(s.primaryValue)??r(s.primary_value),activityLevel:d(s.activityLevel)??d(s.activity_level),memory_recent_note:r(s.memory_recent_note)??null,recent_input_preview:r(s.recent_input_preview)??null,recent_output_preview:r(s.recent_output_preview)??null,recent_tool_names:W(s.recent_tool_names)??[],conversation_tail_count:d(s.conversation_tail_count),k2k_count:d(s.k2k_count),handoff_count_total:d(s.handoff_count_total)??d(s.trace_history_count),compaction_count:d(s.compaction_count),last_compaction_saved_tokens:d(s.last_compaction_saved_tokens),diagnostic:so(s.diagnostic),skill_primary:r(s.skill_primary)??null,skill_secondary:g,skill_reason:r(s.skill_reason)??null,metrics_series:$.length>0?$:void 0,metrics_window:l,agent:k};return C.diagnostic=so(s.diagnostic)??Ad(C,(t==null?void 0:t.lodge)??null),C}).filter(s=>s!==null)}function su(e){if(!p(e))return;const t=r(e.release_version),n=nt(e.started_at),s=d(e.uptime_seconds);if(!(!t||!n||s==null))return{release_version:t,commit:r(e.commit)??null,started_at:n,uptime_seconds:s}}function fr(e,t){return p(e)?{...e,generated_at:t??nt(e.generated_at)??void 0,build:su(e.build),lodge:kd(e.lodge)??void 0}:null}function gr(e,t){return t?e?{...e,...t,build:t.build??e.build,generated_at:t.generated_at??e.generated_at}:t:e}function au(e){const t=typeof e=="string"?e.toLowerCase():"";return t==="running"||t==="interrupted"||t==="completed"||t==="stopped"||t==="error"?t:t.startsWith("error")?"error":"running"}function iu(e){if(!p(e))return null;const t=d(e.iteration);if(t==null)return null;const n=d(e.metric_before)??0,s=d(e.metric_after)??n,a=p(e.evidence)?e.evidence:null;return{iteration:t,metric_before:n,metric_after:s,delta:d(e.delta)??s-n,changes:r(e.changes)??"",failed_attempts:r(e.failed_attempts)??"",next_suggestion:r(e.next_suggestion)??"",elapsed_ms:d(e.elapsed_ms)??0,cost_usd:d(e.cost_usd)??null,evidence:a?{worker_engine:(a.worker_engine==="api_tool_loop","api_tool_loop"),worker_model:r(a.worker_model)??"",tool_call_count:d(a.tool_call_count)??0,tool_names:W(a.tool_names)??[],session_id:r(a.session_id)??"",evidence_status:a.evidence_status==="legacy_unverified"?"legacy_unverified":"verified"}:null}}function ou(e){var o,l;if(!p(e))return null;const t=r(e.loop_id);if(!t)return null;const n=d(e.baseline_metric)??0,s=Array.isArray(e.history)?e.history.map(iu).filter(c=>c!==null):[],a=d(e.current_metric)??((o=s[0])==null?void 0:o.metric_after)??n;return{loop_id:t,profile:r(e.profile)??"unknown",status:au(e.status),strict_mode:typeof e.strict_mode=="boolean"?e.strict_mode:void 0,error_message:r(e.error_message)??r(e.error_reason)??null,stop_reason:r(e.stop_reason)??r(e.reason)??null,current_iteration:d(e.current_iteration)??((l=s[0])==null?void 0:l.iteration)??0,max_iterations:d(e.max_iterations)??0,baseline_metric:n,current_metric:a,target:r(e.target)??"",stagnation_streak:d(e.stagnation_streak)??0,stagnation_limit:d(e.stagnation_limit)??0,elapsed_seconds:d(e.elapsed_seconds)??0,updated_at:nt(e.updated_at)??null,stopped_at:nt(e.stopped_at)??null,execution_mode:e.execution_mode==="worker_spawn"?"worker_spawn":void 0,worker_engine:e.worker_engine==="api_tool_loop"?"api_tool_loop":null,worker_model:r(e.worker_model)??null,evidence_policy:e.evidence_policy==="hard"||e.evidence_policy==="legacy"?e.evidence_policy:void 0,latest_tool_call_count:d(e.latest_tool_call_count)??0,latest_tool_names:W(e.latest_tool_names)??[],session_id:r(e.session_id)??null,evidence_status:e.evidence_status==="legacy_unverified"?"legacy_unverified":e.evidence_status==="verified"?"verified":null,durability:e.durability==="persistent_backend"||e.durability==="memory_only"?e.durability:void 0,persistence_backend:e.persistence_backend==="filesystem"||e.persistence_backend==="postgres"||e.persistence_backend==="memory"?e.persistence_backend:void 0,recoverable:typeof e.recoverable=="boolean"?e.recoverable:void 0,history:s}}async function Hn(){ti.value=!0;try{await Promise.all([hr(),ft()]),pr.value=new Date().toISOString()}catch(e){console.error("Dashboard refresh error:",e)}finally{ti.value=!1}}async function $r(){Ps.value=!0,ws.value=null;try{const e=await hc();Si.value=e,qd.value=new Date().toISOString()}catch(e){ws.value=e instanceof Error?e.message:"Failed to load dashboard semantics"}finally{Ps.value=!1}}function ru(e){var t;return((t=Si.value)==null?void 0:t.surfaces.find(n=>n.id===e))??null}function lu(e){var n;const t=((n=Si.value)==null?void 0:n.surfaces)??[];for(const s of t){const a=s.panels.find(o=>o.id===e);if(a)return a}return null}function cu(e){var s,a;Ft.value=(Array.isArray(e.goals)?e.goals:[]).map(o=>{if(!p(o))return null;const l=r(o.id),c=r(o.title),u=r(o.horizon),m=r(o.status),v=r(o.created_at),f=r(o.updated_at);return!l||!c||!u||!m||!v||!f?null:{id:l,horizon:u,title:c,metric:r(o.metric)??null,target_value:r(o.target_value)??null,due_date:r(o.due_date)??null,priority:d(o.priority)??3,status:m,parent_goal_id:r(o.parent_goal_id)??null,last_review_note:r(o.last_review_note)??null,last_review_at:r(o.last_review_at)??null,created_at:v,updated_at:f}}).filter(o=>o!==null);const t=new Map,n=Array.isArray((s=e.mdal)==null?void 0:s.loops)?e.mdal.loops:[];for(const o of n){const l=ou(o);l&&t.set(l.loop_id,l)}ur.value=t,Kt.value=typeof((a=e.mdal)==null?void 0:a.error)=="string"?e.mdal.error:null,xi.value=Kt.value?"error":t.size===0?"idle":"ready"}async function hr(){try{const e=await _c(),t=fr(e.status,e.generated_at);t&&(oe.value=gr(oe.value,t))}catch(e){console.error("Dashboard shell fetch error:",e)}}async function ft(){var e;try{const t=await fc(),n=fr(t.status,t.generated_at),s=(e=oe.value)==null?void 0:e.room;n&&(oe.value=gr(oe.value,n));const a=s!=null&&(n==null?void 0:n.room)!=null&&s!==n.room;ze.value=(Array.isArray(t.agents)?t.agents:[]).map(Hd).filter(l=>l!==null),Le.value=(Array.isArray(t.tasks)?t.tasks:[]).map(Gd).filter(l=>l!==null);const o=(Array.isArray(t.messages)?t.messages:[]).map(Jd).filter(l=>l!==null);Yt.value=a?o:eu(Yt.value,o),Ue.value=nu(t.keepers,n??oe.value),sr.value=Vd(t.summary),ar.value=(Array.isArray(t.execution_queue)?t.execution_queue:Array.isArray(t.priority_queue)?t.priority_queue:[]).map(Qd).filter(l=>l!==null),ir.value=(Array.isArray(t.session_briefs)?t.session_briefs:[]).map(Yd).filter(l=>l!==null),or.value=(Array.isArray(t.operation_briefs)?t.operation_briefs:[]).map(Xd).filter(l=>l!==null),rr.value=(Array.isArray(t.worker_support_briefs)?t.worker_support_briefs:Array.isArray(t.worker_briefs)?t.worker_briefs:[]).map(to).filter(l=>l!==null),lr.value=(Array.isArray(t.continuity_briefs)?t.continuity_briefs:[]).map(Zd).filter(l=>l!==null),cr.value=(Array.isArray(t.offline_worker_briefs)?t.offline_worker_briefs:[]).map(to).filter(l=>l!==null),Dd.value=null,pr.value=new Date().toISOString()}catch(t){console.error("Dashboard execution fetch error:",t)}}async function Ye(){Tn.value=!0;try{const e=await gc(In.value,{excludeSystem:Nt.value});Cn.value=e.posts??[],si.value=new Date().toISOString()}catch(e){console.error("Board fetch error:",e)}finally{Tn.value=!1}}async function Xe(){var e;ni.value=!0;try{const t=qe.value||((e=oe.value)==null?void 0:e.room)||"default";qe.value||(qe.value=t);const n=await ed(t);dr.value=n}catch(t){console.error("TRPG fetch error:",t)}finally{ni.value=!1}}async function Ci(){fn.value=!0,gn.value=!0;try{const e=await xc();cu(e),jd.value=new Date().toISOString(),Od.value=new Date().toISOString()}catch(e){console.error("Planning fetch error:",e),xi.value="error",Kt.value=e instanceof Error?e.message:String(e)}finally{fn.value=!1,gn.value=!1}}async function yr(){return Ci()}let $s=null;function du(e){$s=e}let hs=null;function uu(e){hs=e}let ys=null;function pu(e){ys=e}const gt={};let ha=null;function pt(e,t,n=500){gt[e]&&clearTimeout(gt[e]),gt[e]=setTimeout(()=>{t(),delete gt[e]},n)}function mu(){const e=Oo.subscribe(t=>{if(t){if(t.type==="keeper_heartbeat"&&t.name){const n=new Map(ei.value);n.set(t.name,t.ts_unix?t.ts_unix*1e3:Date.now()),ei.value=n;return}(t.type==="agent_joined"||t.type==="agent_left")&&pt("execution",ft),Bd(t.type)&&(ha||(ha=setTimeout(()=>{Hn(),hs==null||hs(),ys==null||ys(),ha=null},500))),(t.type.startsWith("task_")||t.type.startsWith("masc/task_"))&&pt("execution",ft),t.type==="broadcast"&&pt("execution",ft),(t.type==="keeper_handoff"||t.type==="keeper_compaction"||t.type==="keeper_guardrail")&&pt("execution",ft),(t.type==="board_post"||t.type==="masc/board_post"||t.type==="board_comment"||t.type==="masc/board_comment")&&pt("board",Ye),t.type.startsWith("decision_")&&pt("council",()=>$s==null?void 0:$s()),(t.type==="mdal_started"||t.type==="mdal_iteration"||t.type==="mdal_completed"||t.type==="mdal_stopped")&&pt("mdal",yr,350)}});return()=>{e();for(const t of Object.keys(gt))clearTimeout(gt[t]),delete gt[t]}}let $n=null;function vu(){$n||($n=setInterval(()=>{tt.value,Hn()},1e4))}function _u(){$n&&(clearInterval($n),$n=null)}function fu({metric:e}){return i`
  ...
  `}function gu({panel:e}){return i`
    <div class="semantic-body">
      ...
      ${e.metrics.length>0?i`<div class="semantic-metric-list">
            ${e.metrics.map(t=>i`<${fu} key=${t.id} metric=${t} />`)}
          </div>`:null}
    </div>
  `}function z({panelId:e,compact:t=!1,label:n="Why"}){const s=lu(e);return s?i`
    <details class="semantic-inline ${t?"compact":""}">
      <summary class="semantic-summary">${n}</summary>
      <${gu} panel=${s} />
    </details>
  `:Ps.value?i`<span class="semantic-inline-state">Loading semantics…</span>`:null}function $e({surfaceId:e,compact:t=!1}){const n=ru(e);return n?i`
  ...
  `:Ps.value?i`<div class="semantic-surface-card ${t?"compact":""}">Loading semantics…</div>`:ws.value?i`<div class="semantic-surface-card ${t?"compact":""}">${ws.value}</div>`:null}function I({title:e,class:t,semanticId:n,testId:s,children:a}){return i`
  ...
  `}function Ii(e){const t=e.indexOf("-");if(t<0)return{model:e,nickname:e,isKeeper:e==="keeper"};const n=e.slice(0,t),s=e.slice(t+1);return{model:n,nickname:s,isKeeper:n==="keeper"}}function $u(e){return e==="keeper"||e.startsWith("keeper-")}const Gn=_(null),ai=_(!1),Ls=_(null),br=_(null),Mt=_(!1),_t=_(null);let Ut=null;function ao(){Ut!==null&&(window.clearTimeout(Ut),Ut=null)}function hu(e=1500){Ut===null&&(Ut=window.setTimeout(()=>{Ut=null,Ns(!1)},e))}function q(e){return typeof e=="object"&&e!==null&&!Array.isArray(e)}function b(e){return typeof e=="string"&&e.trim()!==""?e:void 0}function L(e){return typeof e=="number"&&Number.isFinite(e)?e:void 0}function Bt(e){return typeof e=="boolean"?e:void 0}function J(e,t=[]){if(Array.isArray(e))return e;if(!q(e))return[];for(const n of t){const s=e[n];if(Array.isArray(s))return s}return[]}function an(e){if(!q(e))return null;const t=b(e.kind),n=b(e.summary),s=b(e.target_type);return!t||!n||!s?null:{kind:t,severity:b(e.severity)??"warn",summary:n,target_type:s,target_id:b(e.target_id)??null,actor:b(e.actor)??null,evidence:e.evidence}}function xt(e){if(!q(e))return null;const t=b(e.action_type),n=b(e.target_type),s=b(e.reason);return!t||!n||!s?null:{action_type:t,target_type:n,target_id:b(e.target_id)??null,severity:b(e.severity)??"warn",reason:s,confirm_required:Bt(e.confirm_required),suggested_payload:e.suggested_payload,preview:e.preview}}function yu(e){if(!q(e))return null;const t=b(e.session_id);return t?{session_id:t,goal:b(e.goal),status:b(e.status),health:b(e.health),scale_profile:b(e.scale_profile),control_profile:b(e.control_profile),planned_worker_count:L(e.planned_worker_count),active_agent_count:L(e.active_agent_count),last_turn_age_sec:L(e.last_turn_age_sec)??null,attention_count:L(e.attention_count),recommended_action_count:L(e.recommended_action_count),top_attention:an(e.top_attention),top_recommendation:xt(e.top_recommendation)}:null}function bu(e){if(!q(e))return null;const t=b(e.session_id);if(!t)return null;const n=q(e.status)?e.status:e,s=q(n.summary)?n.summary:void 0;return{session_id:t,status:b(e.status)??b(s==null?void 0:s.status)??(q(n.session)?b(n.session.status):void 0),progress_pct:L(e.progress_pct)??L(s==null?void 0:s.progress_pct),elapsed_sec:L(e.elapsed_sec)??L(s==null?void 0:s.elapsed_sec),remaining_sec:L(e.remaining_sec)??L(s==null?void 0:s.remaining_sec),done_delta_total:L(e.done_delta_total)??L(s==null?void 0:s.done_delta_total),summary:q(e.summary)?e.summary:s,team_health:q(e.team_health)?e.team_health:q(n.team_health)?n.team_health:void 0,communication_metrics:q(e.communication_metrics)?e.communication_metrics:q(n.communication_metrics)?n.communication_metrics:void 0,orchestration_state:q(e.orchestration_state)?e.orchestration_state:q(n.orchestration_state)?n.orchestration_state:void 0,cascade_metrics:q(e.cascade_metrics)?e.cascade_metrics:q(n.cascade_metrics)?n.cascade_metrics:void 0,report_paths:q(e.report_paths)?Object.fromEntries(Object.entries(e.report_paths).map(([a,o])=>{const l=b(o);return l?[a,l]:null}).filter(a=>a!==null)):q(n.report_paths)?Object.fromEntries(Object.entries(n.report_paths).map(([a,o])=>{const l=b(o);return l?[a,l]:null}).filter(a=>a!==null)):void 0,session:q(e.session)?e.session:q(n.session)?n.session:void 0,recent_events:J(e.recent_events,["events"]).filter(q)}}function ku(e){if(!q(e))return null;const t=b(e.name);return t?{name:t,agent_name:b(e.agent_name),status:b(e.status),autonomy_level:b(e.autonomy_level),context_ratio:L(e.context_ratio),generation:L(e.generation),active_goal_ids:J(e.active_goal_ids).map(n=>typeof n=="string"?n.trim():"").filter(Boolean),last_autonomous_action_at:b(e.last_autonomous_action_at)??null,last_turn_ago_s:L(e.last_turn_ago_s),model:b(e.model)}:null}function xu(e){if(!q(e))return null;const t=b(e.confirm_token)??b(e.token);return t?{confirm_token:t,actor:b(e.actor),action_type:b(e.action_type),target_type:b(e.target_type),target_id:b(e.target_id)??null,delegated_tool:b(e.delegated_tool),created_at:b(e.created_at),preview:e.preview}:null}function Su(e){if(!q(e))return null;const t=b(e.action_type),n=b(e.target_type);return!t||!n?null:{action_type:t,target_type:n,description:b(e.description),confirm_required:Bt(e.confirm_required)}}function Au(e){const t=q(e)?e:{};return{room_health:b(t.room_health),cluster:b(t.cluster),project:b(t.project),current_room:b(t.current_room)??null,paused:Bt(t.paused),tempo_interval_s:L(t.tempo_interval_s),active_agents:L(t.active_agents),keeper_pressure:L(t.keeper_pressure),active_operations:L(t.active_operations),pending_approvals:L(t.pending_approvals),incident_count:L(t.incident_count),recommended_action_count:L(t.recommended_action_count),top_attention:an(t.top_attention),top_action:xt(t.top_action)}}function Cu(e){const t=q(e)?e:{},n=q(t.swarm_overview)?t.swarm_overview:{};return{health:b(t.health),active_operations:L(t.active_operations),pending_approvals:L(t.pending_approvals),swarm_overview:{active_lanes:L(n.active_lanes),moving_lanes:L(n.moving_lanes),stalled_lanes:L(n.stalled_lanes),projected_lanes:L(n.projected_lanes),last_movement_at:b(n.last_movement_at)??null},top_attention:an(t.top_attention),top_action:xt(t.top_action),session_cards:J(t.session_cards).map(yu).filter(s=>s!==null)}}function Iu(e){const t=q(e)?e:{};return{sessions:J(t.sessions,["items"]).map(bu).filter(n=>n!==null),keepers:J(t.keepers,["items"]).map(ku).filter(n=>n!==null),pending_confirms:J(t.pending_confirms).map(xu).filter(n=>n!==null),available_actions:J(t.available_actions).map(Su).filter(n=>n!==null)}}function Tu(e){if(!q(e))return null;const t=b(e.id),n=b(e.kind),s=b(e.summary),a=b(e.target_type);return!t||!n||!s||!a?null:{id:t,kind:n,severity:b(e.severity)??"warn",summary:s,target_type:a,target_id:b(e.target_id)??null,top_action:xt(e.top_action),related_session_ids:J(e.related_session_ids).map(o=>typeof o=="string"?o.trim():"").filter(Boolean),related_agent_names:J(e.related_agent_names).map(o=>typeof o=="string"?o.trim():"").filter(Boolean),evidence_preview:J(e.evidence_preview).map(o=>typeof o=="string"?o.trim():"").filter(Boolean),last_seen_at:b(e.last_seen_at)??null}}function Ru(e){if(!q(e))return null;const t=b(e.session_id),n=b(e.goal);return!t||!n?null:{session_id:t,goal:n,room:b(e.room)??null,status:b(e.status),health:b(e.health),member_names:J(e.member_names).map(s=>typeof s=="string"?s.trim():"").filter(Boolean),started_at:b(e.started_at)??null,elapsed_sec:L(e.elapsed_sec)??null,last_event_at:b(e.last_event_at)??null,last_event_summary:b(e.last_event_summary)??null,communication_summary:b(e.communication_summary)??null,active_count:L(e.active_count),required_count:L(e.required_count),related_attention_count:L(e.related_attention_count)??0,top_attention:an(e.top_attention),top_recommendation:xt(e.top_recommendation)}}function Pu(e){if(!q(e))return null;const t=b(e.agent_name);return t?{agent_name:t,status:b(e.status),where:b(e.where)??null,with_whom:J(e.with_whom).map(n=>typeof n=="string"?n.trim():"").filter(Boolean),current_work:b(e.current_work)??null,related_session_id:b(e.related_session_id)??null,related_attention_count:L(e.related_attention_count)??0,recent_output_preview:b(e.recent_output_preview)??null,recent_input_preview:b(e.recent_input_preview)??null,recent_event:b(e.recent_event)??null,recent_tool_names:J(e.recent_tool_names).map(n=>typeof n=="string"?n.trim():"").filter(Boolean),allowed_tool_names:J(e.allowed_tool_names).map(n=>typeof n=="string"?n.trim():"").filter(Boolean),latest_tool_names:J(e.latest_tool_names).map(n=>typeof n=="string"?n.trim():"").filter(Boolean),latest_tool_call_count:L(e.latest_tool_call_count)??null,tool_audit_source:b(e.tool_audit_source)??null,tool_audit_at:b(e.tool_audit_at)??null}:null}function wu(e){if(!q(e))return null;const t=b(e.name);return t?{name:t,agent_name:b(e.agent_name)??null,status:b(e.status),generation:L(e.generation),context_ratio:L(e.context_ratio)??null,last_turn_ago_s:L(e.last_turn_ago_s)??null,current_work:b(e.current_work)??null,last_autonomous_action_at:b(e.last_autonomous_action_at)??null,allowed_tool_names:J(e.allowed_tool_names).map(n=>typeof n=="string"?n.trim():"").filter(Boolean),latest_tool_names:J(e.latest_tool_names).map(n=>typeof n=="string"?n.trim():"").filter(Boolean),latest_tool_call_count:L(e.latest_tool_call_count)??null,tool_audit_source:b(e.tool_audit_source)??null,tool_audit_at:b(e.tool_audit_at)??null}:null}function Lu(e){if(!q(e))return null;const t=b(e.id),n=b(e.signal_type),s=b(e.summary),a=b(e.target_type);return!t||!n||!s||!a?null:{id:t,signal_type:n==="action"?"action":"attention",severity:b(e.severity)??"warn",summary:s,target_type:a,target_id:b(e.target_id)??null,attention:an(e.attention),action:xt(e.action)}}function Nu(e){const t=q(e)?e:{};return{generated_at:b(t.generated_at),summary:Au(t.summary),incidents:J(t.incidents).map(an).filter(n=>n!==null),recommended_actions:J(t.recommended_actions).map(xt).filter(n=>n!==null),command_focus:Cu(t.command_focus),operator_targets:Iu(t.operator_targets),attention_queue:J(t.attention_queue).map(Tu).filter(n=>n!==null),session_briefs:J(t.session_briefs).map(Ru).filter(n=>n!==null),agent_briefs:J(t.agent_briefs).map(Pu).filter(n=>n!==null),keeper_briefs:J(t.keeper_briefs).map(wu).filter(n=>n!==null),internal_signals:J(t.internal_signals).map(Lu).filter(n=>n!==null)}}function Mu(e){if(!q(e))return null;const t=b(e.id),n=b(e.label),s=b(e.summary);if(!t||!n||!s)return null;const a=b(e.status)??"unclear";return{id:t,label:n,status:a==="ok"||a==="healthy"||a==="aligned"||a==="watch"||a==="risk"||a==="unclear"?a:"unclear",summary:s,signal_class:b(e.signal_class)==="metadata_gap"||b(e.signal_class)==="mixed"||b(e.signal_class)==="operational_risk"?b(e.signal_class):void 0,evidence_quality:b(e.evidence_quality)==="strong"||b(e.evidence_quality)==="partial"||b(e.evidence_quality)==="missing"?b(e.evidence_quality):void 0,evidence:J(e.evidence).map(l=>typeof l=="string"?l.trim():"").filter(Boolean)}}function zu(e){if(!q(e))return null;const t=b(e.kind),n=b(e.summary),s=b(e.scope_type),a=b(e.severity);return!t||!n||!s||!a||s!=="session"&&s!=="keeper"&&s!=="agent"||a!=="info"&&a!=="watch"?null:{kind:t,summary:n,scope_type:s,scope_id:b(e.scope_id)??null,severity:a}}function Eu(e){const t=q(e)?e:{},n=q(t.basis)?t.basis:{},s=b(t.status)??"error",a=s==="ok"||s==="pending"||s==="unavailable"||s==="error"?s:"error";return{generated_at:b(t.generated_at),cached:Bt(t.cached),stale:Bt(t.stale),refreshing:Bt(t.refreshing),status:a,summary:b(t.summary)??null,model:b(t.model)??null,ttl_sec:L(t.ttl_sec),criteria:J(t.criteria).map(o=>typeof o=="string"?o.trim():"").filter(Boolean),basis:{current_room:b(n.current_room)??null,crew_count:L(n.crew_count),agent_count:L(n.agent_count),keeper_count:L(n.keeper_count)},metadata_gap_count:L(t.metadata_gap_count),metadata_gaps:J(t.metadata_gaps).map(zu).filter(o=>o!==null),sections:J(t.sections).map(Mu).filter(o=>o!==null),error:b(t.error)??null,last_error:b(t.last_error)??null}}async function kr(){ai.value=!0,Ls.value=null;try{const e=await yc();Gn.value=Nu(e)}catch(e){Ls.value=e instanceof Error?e.message:"Failed to load mission snapshot"}finally{ai.value=!1}}async function Ns(e=!1){Mt.value=!0,_t.value=null;try{const t=await bc(e),n=Eu(t);br.value=n,n.refreshing||n.status==="pending"?hu():ao()}catch(t){_t.value=t instanceof Error?t.message:"Failed to load mission briefing",ao()}finally{Mt.value=!1}}const Ms="masc_dashboard_workflow_context",Du=900*1e3;function _e(e){return typeof e=="string"&&e.trim()!==""?e.trim():null}function We(e){const t=_e(e);return t||(typeof e=="number"&&Number.isFinite(e)?String(e):null)}function xr(){if(typeof window>"u")return null;try{return window.sessionStorage}catch{return null}}function ii(e){return p(e)?e:null}function ju(e){if(!e)return null;try{return JSON.stringify(e)}catch{return null}}function Ou(e){if(!e)return null;try{const t=JSON.parse(e);if(!p(t))return null;const n=_e(t.id),s=_e(t.source_surface),a=_e(t.source_label),o=_e(t.summary),l=_e(t.created_at);return!n||s!=="mission"&&s!=="execution"||!a||!o||!l?null:{id:n,source_surface:s,source_label:a,action_type:_e(t.action_type),target_type:_e(t.target_type),target_id:_e(t.target_id),focus_kind:_e(t.focus_kind),operation_id:_e(t.operation_id),command_surface:_e(t.command_surface),summary:o,payload_preview:_e(t.payload_preview),suggested_payload:ii(t.suggested_payload),preview:t.preview??null,evidence:t.evidence??null,created_at:l}}catch{return null}}function Ti(e){const t=Date.parse(e.created_at);return Number.isNaN(t)?!1:Date.now()-t<=Du}function qu(){const e=xr(),t=Ou((e==null?void 0:e.getItem(Ms))??null);return t?Ti(t)?t:(e==null||e.removeItem(Ms),null):null}const Sr=_(qu());function Ar(e){const t=e&&Ti(e)?e:null;Sr.value=t;const n=xr();if(!n)return;if(!t){n.removeItem(Ms);return}const s=ju(t);s&&n.setItem(Ms,s)}function Fu(e){if(!e)return null;const t=ii(e.suggested_payload);if(t)return t;if(p(e.preview)){const n=ii(e.preview.payload);if(n)return n}return null}function Ku(e){if(!e)return null;const t=We(e.message);if(t)return t;const n=We(e.task_title)??We(e.title),s=We(e.task_description)??We(e.description),a=We(e.reason),o=We(e.priority)??We(e.task_priority);return n&&s?`${n} · ${s}`:n&&o?`${n} · P${o}`:n||s||a||null}function Ri(e,t,n,s,a,o,l,c){return[e,t,n??"action",s??"target",a??"room",o??"focus",l??"operation",c].join(":")}function on(e,t,n="상황판 추천 액션"){const s=new Date().toISOString(),a=Fu(e),o=(e==null?void 0:e.target_type)??(t==null?void 0:t.target_type)??null,l=(e==null?void 0:e.target_id)??(t==null?void 0:t.target_id)??null,c=(t==null?void 0:t.kind)??(e==null?void 0:e.action_type)??null,u=(e==null?void 0:e.reason)??(t==null?void 0:t.summary)??n;return{id:Ri("mission",n,(e==null?void 0:e.action_type)??null,o,l,c,null,s),source_surface:"mission",source_label:n,action_type:(e==null?void 0:e.action_type)??null,target_type:o,target_id:l,focus_kind:c,operation_id:null,command_surface:null,summary:u,payload_preview:Ku(a),suggested_payload:a,preview:(e==null?void 0:e.preview)??null,evidence:(t==null?void 0:t.evidence)??null,created_at:s}}function Uu({targetType:e,targetId:t,focusKind:n,sourceLabel:s="Execution 진단",summary:a,operationId:o=null,commandSurface:l=null}){const c=new Date().toISOString();return{id:Ri("execution",s,null,e,t,n,o,c),source_surface:"execution",source_label:s,action_type:null,target_type:e,target_id:t,focus_kind:n,operation_id:o,command_surface:l,summary:a,payload_preview:null,suggested_payload:null,preview:null,evidence:null,created_at:c}}function Bu(e,t){return(t.source==="mission"||t.source==="execution")&&(t.action_type??null)===(e.action_type??null)&&(t.target_type??null)===(e.target_type??null)&&(t.target_id??null)===(e.target_id??null)&&(t.focus_kind??null)===(e.focus_kind??null)&&(t.operation_id??null)===(e.operation_id??null)}function Jn(e){const{params:t}=e;if(t.source!=="mission"&&t.source!=="execution")return null;const n=Sr.value;if(n&&Ti(n)&&Bu(n,t))return n;const s=new Date().toISOString(),a=t.source==="execution"?"execution":"mission";return{id:Ri(a,a==="execution"?"Execution 이어보기":"상황판 이어보기",t.action_type??null,t.target_type??null,t.target_id??null,t.focus_kind??null,t.operation_id??null,s),source_surface:a,source_label:a==="execution"?"Execution 이어보기":"상황판 이어보기",action_type:t.action_type??null,target_type:t.target_type??null,target_id:t.target_id??null,focus_kind:t.focus_kind??t.action_type??null,operation_id:t.operation_id??null,command_surface:t.surface??null,summary:a==="execution"?t.focus_kind?`${t.focus_kind} 기준으로 열린 execution 컨텍스트입니다.`:"Execution에서 이어진 컨텍스트입니다.":t.focus_kind?`${t.focus_kind} 기준으로 열린 컨텍스트입니다.`:"상황판에서 이어진 컨텍스트입니다.",payload_preview:null,suggested_payload:null,preview:null,evidence:null,created_at:s}}function Cr(e){return{source:e.source_surface,...e.action_type?{action_type:e.action_type}:{},...e.target_type?{target_type:e.target_type}:{},...e.target_id?{target_id:e.target_id}:{},...e.focus_kind?{focus_kind:e.focus_kind}:{},...e.operation_id?{operation_id:e.operation_id}:{}}}function Ir(e){if(e.command_surface)return e.command_surface;const t=[e.focus_kind,e.summary,e.action_type].filter(n=>typeof n=="string"&&n.trim()!=="").join(" ").toLowerCase();return t.includes("artifact_scope")||t.includes("routing_confidence")||t.includes("cache_contention")?"summary":t.includes("stale_data")||t.includes("leader_offline")||t.includes("roster_offline")||t.includes("managed")||t.includes("swarm")?"swarm":e.focus_kind==="operation"||e.target_type==="operation"?"operations":e.target_type==="room"?"summary":"swarm"}function Tr(e){return{source:e.source_surface,surface:Ir(e),...e.action_type?{action_type:e.action_type}:{},...e.target_type?{target_type:e.target_type}:{},...e.target_id?{target_id:e.target_id}:{},...e.focus_kind?{focus_kind:e.focus_kind}:{},...e.operation_id?{operation_id:e.operation_id}:{}}}function Wu(e){return Cr(e)}function Hu(e){return Tr(e)}function Pi(e){return e!=null&&e.target_type?e.target_id?`${e.target_type} · ${e.target_id}`:e.target_type:"대상 정보 없음"}function ua(e){switch(e){case"broadcast":return"room 방송";case"room_pause":return"room 일시정지";case"room_resume":return"room 재개";case"task_inject":return"room 작업 주입";case"team_turn":return"session 업데이트";case"team_note":return"session 노트";case"team_broadcast":return"session 방송";case"team_task_inject":return"session 작업";case"team_stop":return"session 중지";case"keeper_msg":case"keeper_message":return"keeper 메시지";case"keeper_probe":return"keeper probe";case"keeper_recover":return"keeper recover";default:return(e==null?void 0:e.trim())||"추천 액션"}}function Gu(e){switch(e){case"warroom":return"워룸";case"summary":return"요약";case"swarm":return"스웜";case"chains":return"체인";case"topology":return"토폴로지";case"alerts":return"알림";case"trace":return"트레이스";case"control":return"제어";case"operations":return"작전";default:return(e==null?void 0:e.trim())||"지휘"}}const Je=_(null),Oe=_(null);function Y(e,t=120){const n=(e??"").replace(/\s+/g," ").trim();return n?n.length>t?`${n.slice(0,t-1)}…`:n:null}function de(e){return e==="bad"||e==="offline"||e==="critical"||e==="risk"?"bad":e==="warn"||e==="pending"||e==="degraded"||e==="interrupted"||e==="watch"?"warn":"ok"}function bt(e){if(!e)return"방금";const t=Date.parse(e);if(Number.isNaN(t))return e;const n=Math.max(0,Math.round((Date.now()-t)/1e3));return n<60?`${n}s 전`:n<3600?`${Math.round(n/60)}m 전`:n<86400?`${Math.round(n/3600)}h 전`:`${Math.round(n/86400)}d 전`}function Ju(e){return typeof e!="number"||!Number.isFinite(e)||e<0?"n/a":e<60?`${Math.round(e)}s`:e<3600?`${Math.round(e/60)}m`:e<86400?`${Math.round(e/3600)}h`:`${Math.round(e/86400)}d`}function Vu(e){return e!=null&&e.confirm_required?"확인 후 실행":"즉시 실행"}function Qu(e){return Pi(e?on(e,null,"상황판 추천 액션"):null)}function pa(e,t=on()){Ar(t),ue(e,e==="intervene"?Wu(t):Hu(t))}function Rr(e){pa("intervene",on(null,e,"상황판 incident"))}function Pr(e){pa("command",on(null,e,"상황판 incident"))}function wi(e,t,n="상황판 추천 액션"){pa("intervene",on(e,t,n))}function wr(e,t,n="상황판 추천 액션"){pa("command",on(e,t,n))}function io(e,t){const n={source:"mission",target_type:"team_session",target_id:t,focus_kind:"team_session"};e==="command"&&(n.surface="swarm"),ue(e,n)}function Yu(e){return{kind:e.kind,severity:e.severity,summary:e.summary,target_type:e.target_type,target_id:e.target_id??null,actor:null,evidence:e.evidence_preview}}function Lr(e,t){const n=e.trim().toLowerCase();return[...t].filter(s=>(s.from??"").trim().toLowerCase()===n).sort((s,a)=>Date.parse(a.timestamp)-Date.parse(s.timestamp))[0]??null}function Xu(e){return e.replace(/[.*+?^${}()|[\]\\]/g,"\\$&")}function Zu(e,t){if(!t)return!1;const n=Xu(t);return new RegExp(`(?:^|[^a-z0-9_])@${n}(?![a-z0-9_-])`,"i").test(e)}function ep(e,t){const n=e.trim().toLowerCase();return[...t].filter(s=>{if((s.from??"").trim().toLowerCase()===n)return!1;const o=(s.content??"").trim().toLowerCase();return Zu(o,n)}).sort((s,a)=>Date.parse(a.timestamp)-Date.parse(s.timestamp))[0]??null}function tp(e){return Ue.value.find(t=>t.agent_name===e||t.name===e)??null}function Nr(e){return ze.value.find(t=>t.name===e)??null}function Mr(e,t){const n=Y(e,100);if(!n)return null;const s=t.find(o=>o.id===n);if(s)return`${s.id} · ${Y(s.title,92)}`;const a=t.find(o=>o.title===n);return a?`${a.id} · ${Y(a.title,92)}`:n}function np(e){var c,u;const t=Nr(e.agent_name),n=tp(e.agent_name),s=Lr(e.agent_name,Yt.value),a=ep(e.agent_name,Yt.value),o=Ii(e.agent_name),l=(n==null?void 0:n.skill_primary)??(t!=null&&t.capabilities&&t.capabilities.length>0?t.capabilities.slice(0,3).join(", "):null)??o.model??(t==null?void 0:t.agent_type)??null;return{brief:e,agent:t,keeper:n,where:e.where??"room",withWhom:e.with_whom,currentWork:e.current_work??Mr((t==null?void 0:t.current_task)??null,Le.value)??"명시된 current task 없음",how:l,recentInput:Y(e.recent_input_preview,120)??Y(a==null?void 0:a.content,120)??Y(n==null?void 0:n.recent_input_preview,120)??null,recentOutput:Y(e.recent_output_preview,120)??Y(s==null?void 0:s.content,120)??Y(n==null?void 0:n.recent_output_preview,120)??Y((c=n==null?void 0:n.diagnostic)==null?void 0:c.last_reply_preview,120)??null,recentEvent:Y(e.recent_event,120)??Y((u=n==null?void 0:n.diagnostic)==null?void 0:u.summary,120)??null,recentTools:e.recent_tool_names.length>0?e.recent_tool_names:(n==null?void 0:n.recent_tool_names)??[]}}function sp(e){var n,s;const t=Ue.value.find(a=>a.name===e.name||a.agent_name===e.agent_name)??null;return{brief:e,keeper:t,currentWork:Y(e.current_work,110)??Y(t==null?void 0:t.skill_primary,110)??Y(t==null?void 0:t.last_proactive_reason,110)??"명시된 keeper focus 없음",recentInput:Y(t==null?void 0:t.recent_input_preview,120)??null,recentOutput:Y(t==null?void 0:t.recent_output_preview,120)??Y((n=t==null?void 0:t.diagnostic)==null?void 0:n.last_reply_preview,120)??Y(t==null?void 0:t.last_proactive_preview,120)??null,recentEvent:Y(t==null?void 0:t.last_proactive_reason,120)??Y((s=t==null?void 0:t.diagnostic)==null?void 0:s.summary,120)??null,recentTools:(t==null?void 0:t.recent_tool_names)??[]}}function ap(){const e=Gn.value;return e?new Map(e.session_briefs.map(t=>[t.session_id,t])):new Map}function ip(e){const t=Nr(e),n=Lr(e,Yt.value),s=Ii(e);return{name:e,model:s.model,nickname:s.nickname,currentTask:Mr((t==null?void 0:t.current_task)??null,Le.value)??"agent snapshot 없음",output:Y(n==null?void 0:n.content,96)}}function op(e){Je.value=Je.value===e?null:e,Oe.value=null}function zr(e){Oe.value=Oe.value===e?null:e}function rp(){Je.value=null,Oe.value=null}function ot({status:e,label:t}){return i`
    <span class="status-badge ${e}">
      <span class="status-dot-inline ${e}"></span>
      ${t??e}
    </span>
  `}function Er(e){const t=Date.now(),n=typeof e=="number"?e<1e12?e*1e3:e:new Date(e).getTime(),s=Math.floor((t-n)/1e3);if(s<60)return`${s}s ago`;const a=Math.floor(s/60);if(a<60)return`${a}m ago`;const o=Math.floor(a/60);return o<24?`${o}h ago`:`${Math.floor(o/24)}d ago`}function B({timestamp:e}){const t=Er(e),n=typeof e=="string"?e:new Date(e<1e12?e*1e3:e).toISOString();return i`<span class="time-ago" title=${n}>${t}</span>`}let lp=0;const $t=_([]);function w(e,t="success",n=4e3){const s=++lp;$t.value=[...$t.value,{id:s,message:e,type:t}],setTimeout(()=>{$t.value=$t.value.filter(a=>a.id!==s)},n)}function cp(e){$t.value=$t.value.filter(t=>t.id!==e)}function dp(){const e=$t.value;return e.length===0?null:i`
    <div class="toast-container">
      ${e.map(t=>i`
        <div key=${t.id} class="toast ${t.type}" onClick=${()=>cp(t.id)}>
          ${t.message}
        </div>
      `)}
    </div>
  `}const up="masc_dashboard_agent_name",rn=_(null),zs=_(!1),Rn=_(""),Es=_([]),Pn=_([]),Wt=_(""),hn=_(!1);function wn(e){rn.value=e,Li()}function oo(){rn.value=null,Rn.value="",Es.value=[],Pn.value=[],Wt.value=""}function pp(){const e=rn.value;return e?ze.value.find(t=>t.name===e)??null:null}function Dr(e){return e?Le.value.filter(t=>t.assignee===e):[]}function jr(e){return e?Ue.value.find(t=>t.agent_name===e||t.name===e)??null:null}function mp(e){if(!e)return null;const t=Gn.value;return t?t.agent_briefs.find(n=>n.agent_name===e)??null:null}function vp(e){if(!e)return[];const t=e.metrics_window;return(Array.isArray(t==null?void 0:t.top_tools)?t.top_tools:[]).map(s=>typeof s=="object"&&s!==null&&"tool"in s&&typeof s.tool=="string"?s.tool:null).filter(s=>s!==null)}function _p(e){const t=jr(e);return t?t.recent_tool_names&&t.recent_tool_names.length>0?t.recent_tool_names:[]:[]}async function Li(){const e=rn.value;if(e){zs.value=!0,Rn.value="",Es.value=[],Pn.value=[];try{const t=await dd(80);Es.value=t.filter(a=>a.includes(e)).slice(0,20);const n=Dr(e).slice(0,6);if(n.length===0)return;const s=await Promise.all(n.map(async a=>{try{const o=await ud(a.id,25);return{taskId:a.id,text:o.trim()}}catch(o){const l=o instanceof Error?o.message:"history load failed";return{taskId:a.id,text:`Failed to load history: ${l}`}}}));Pn.value=s}catch(t){Rn.value=t instanceof Error?t.message:"Failed to load agent detail"}finally{zs.value=!1}}}async function ro(){var s;const e=rn.value,t=Wt.value.trim();if(!e||!t)return;const n=((s=localStorage.getItem(up))==null?void 0:s.trim())||"dashboard";hn.value=!0;try{await cd(n,`@${e} ${t}`),Wt.value="",w(`Mention sent to ${e}`,"success"),Li()}catch(a){const o=a instanceof Error?a.message:"Failed to send mention";w(o,"error")}finally{hn.value=!1}}function fp({task:e}){return i`
    <div class="agent-detail-task">
      <span class="pill">${e.id}</span>
      <span class="agent-detail-task-title">${e.title}</span>
      <${ot} status=${e.status} />
    </div>
  `}function gp({row:e}){return i`
  ...
  `}function $p(){var A,T,x,R,P,E,G;const e=rn.value;if(!e)return null;const t=pp(),n=jr(e),s=mp(e),a=Dr(e),o=Es.value,l=_p(e),c=vp(n),u=(s==null?void 0:s.allowed_tool_names)??[],m=(s==null?void 0:s.latest_tool_names)??[],v=s==null?void 0:s.latest_tool_call_count,f=s==null?void 0:s.tool_audit_source,g=s==null?void 0:s.tool_audit_at,h=(t==null?void 0:t.capabilities)??[],k=((A=oe.value)==null?void 0:A.room)??"default",$=((T=oe.value)==null?void 0:T.project)??"확인 없음",C=((x=oe.value)==null?void 0:x.cluster)??"확인 없음";return i`
    <div
      ...
      <div class="agent-detail-modal">
        ...
        <div class="agent-detail-grid">
          <${I} title="Assigned Tasks">
            ${a.length===0?i`<div class="empty-state">No assigned tasks</div>`:i`<div class="agent-detail-task-list">${a.map(D=>i`<${fp} key=${D.id} task=${D} />`)}</div>`}
          <//>
        ...
        <${I} title="Task History">
          ${Pn.value.length===0?i`<div class="empty-state">No task history loaded</div>`:i`<div class="agent-history-list">${Pn.value.map(D=>i`<${gp} key=${D.taskId} row=${D} />`)}</div>`}
        <//>
  ...
  `}const he=_(null),Ni=_(null),Ne=_(null),Ln=_(!1),st=_(null),Nn=_(!1),Xt=_(null),Q=_(!1),Ds=_([]);let hp=1;function yp(e){return p(e)?{id:r(e.id),seq:d(e.seq),from:r(e.from)??r(e.from_agent)??"system",content:r(e.content)??"",timestamp:r(e.timestamp)??new Date().toISOString(),type:r(e.type)}:null}function bp(e){return p(e)?{room_id:r(e.room_id),current_room:r(e.current_room)??r(e.room),project:r(e.project),cluster:r(e.cluster),paused:U(e.paused),pause_reason:r(e.pause_reason)??null,paused_by:r(e.paused_by)??null,paused_at:r(e.paused_at)??null}:{}}function lo(e){if(!p(e))return;const t=Object.entries(e).map(([n,s])=>{const a=r(s);return a?[n,a]:null}).filter(n=>n!==null);return t.length>0?Object.fromEntries(t):void 0}function Or(e){if(!p(e))return null;const t=r(e.kind),n=r(e.summary),s=r(e.target_type);return!t||!n||!s?null:{kind:t,severity:r(e.severity)??"warn",summary:n,target_type:s,target_id:r(e.target_id)??null,actor:r(e.actor)??null,evidence:e.evidence}}function qr(e){if(!p(e))return null;const t=r(e.action_type),n=r(e.target_type),s=r(e.reason);return!t||!n||!s?null:{action_type:t,target_type:n,target_id:r(e.target_id)??null,severity:r(e.severity)??"warn",reason:s,confirm_required:U(e.confirm_required),suggested_payload:e.suggested_payload,preview:e.preview}}function kp(e){return p(e)?{actor:r(e.actor)??null,spawn_agent:r(e.spawn_agent)??null,spawn_role:r(e.spawn_role)??null,spawn_model:r(e.spawn_model)??null,worker_class:r(e.worker_class)??null,parent_actor:r(e.parent_actor)??null,capsule_mode:r(e.capsule_mode)??null,runtime_pool:r(e.runtime_pool)??null,lane_id:r(e.lane_id)??null,controller_level:r(e.controller_level)??null,control_domain:r(e.control_domain)??null,supervisor_actor:r(e.supervisor_actor)??null,model_tier:r(e.model_tier)??null,task_profile:r(e.task_profile)??null,risk_level:r(e.risk_level)??null,routing_confidence:d(e.routing_confidence)??null,routing_reason:r(e.routing_reason)??null,status:r(e.status)??"unknown",turn_count:d(e.turn_count)??0,empty_note_turn_count:d(e.empty_note_turn_count)??0,has_turn:U(e.has_turn)??!1,last_turn_ts_iso:r(e.last_turn_ts_iso)??null}:null}function xp(e){if(!p(e))return null;const t=r(e.session_id);return t?{session_id:t,goal:r(e.goal),status:r(e.status),health:r(e.health),scale_profile:r(e.scale_profile),control_profile:r(e.control_profile),planned_worker_count:d(e.planned_worker_count),active_agent_count:d(e.active_agent_count),last_turn_age_sec:d(e.last_turn_age_sec)??null,attention_count:d(e.attention_count),recommended_action_count:d(e.recommended_action_count),top_attention:Or(e.top_attention),top_recommendation:qr(e.top_recommendation)}:null}function Fr(e){const t=p(e)?e:{};return{trace_id:r(t.trace_id),target_type:r(t.target_type)??"room",target_id:r(t.target_id)??null,health:r(t.health),swarm_status:p(t.swarm_status)?t.swarm_status:void 0,attention_items:Te(t.attention_items).map(Or).filter(n=>n!==null),recommended_actions:Te(t.recommended_actions).map(qr).filter(n=>n!==null),session_cards:Te(t.session_cards).map(xp).filter(n=>n!==null),worker_cards:Te(t.worker_cards).map(kp).filter(n=>n!==null)}}function Sp(e){if(!p(e))return null;const t=p(e.status)?e.status:void 0,n=p(e.summary)?e.summary:p(t==null?void 0:t.summary)?t.summary:void 0,s=p(e.session)?e.session:p(t==null?void 0:t.session)?t.session:void 0,a=r(e.session_id)??r(n==null?void 0:n.session_id)??r(s==null?void 0:s.session_id);if(!a)return null;const o=lo(e.report_paths)??lo(t==null?void 0:t.report_paths),l=Te(e.recent_events,["events"]).filter(p);return{session_id:a,status:r(e.status)??r(n==null?void 0:n.status)??r(s==null?void 0:s.status),progress_pct:d(e.progress_pct)??d(n==null?void 0:n.progress_pct),elapsed_sec:d(e.elapsed_sec)??d(n==null?void 0:n.elapsed_sec),remaining_sec:d(e.remaining_sec)??d(n==null?void 0:n.remaining_sec),done_delta_total:d(e.done_delta_total)??d(n==null?void 0:n.done_delta_total),summary:n,team_health:p(e.team_health)?e.team_health:p(t==null?void 0:t.team_health)?t.team_health:void 0,communication_metrics:p(e.communication_metrics)?e.communication_metrics:p(t==null?void 0:t.communication_metrics)?t.communication_metrics:void 0,orchestration_state:p(e.orchestration_state)?e.orchestration_state:p(t==null?void 0:t.orchestration_state)?t.orchestration_state:void 0,cascade_metrics:p(e.cascade_metrics)?e.cascade_metrics:p(t==null?void 0:t.cascade_metrics)?t.cascade_metrics:void 0,report_paths:o,session:s,recent_events:l}}function Ap(e){if(!p(e))return null;const t=r(e.name);if(!t)return null;const n=p(e.context)?e.context:void 0;return{name:t,agent_name:r(e.agent_name),status:r(e.status),autonomy_level:r(e.autonomy_level),context_ratio:d(e.context_ratio)??d(n==null?void 0:n.context_ratio),generation:d(e.generation),active_goal_ids:W(e.active_goal_ids),last_autonomous_action_at:r(e.last_autonomous_action_at)??null,last_turn_ago_s:d(e.last_turn_ago_s),model:r(e.model)??r(e.active_model)??r(e.primary_model)}}function Cp(e){if(!p(e))return null;const t=r(e.confirm_token)??r(e.token);return t?{confirm_token:t,actor:r(e.actor),action_type:r(e.action_type),target_type:r(e.target_type),target_id:r(e.target_id)??null,delegated_tool:r(e.delegated_tool),created_at:r(e.created_at),preview:e.preview}:null}function Ip(e){const t=p(e)?e:{};return{room:bp(t.room),sessions:Te(t.sessions,["items","sessions"]).map(Sp).filter(n=>n!==null),keepers:Te(t.keepers,["items","keepers"]).map(Ap).filter(n=>n!==null),recent_messages:Te(t.recent_messages,["messages"]).map(yp).filter(n=>n!==null),pending_confirms:Te(t.pending_confirms,["items","confirms"]).map(Cp).filter(n=>n!==null),available_actions:Te(t.available_actions,["actions"]).filter(p).map(n=>({action_type:r(n.action_type)??"unknown",target_type:r(n.target_type)??"unknown",description:r(n.description),confirm_required:U(n.confirm_required)}))}}function is(e){if(typeof e=="string")return e;if(e==null)return"";try{return JSON.stringify(e)}catch{return String(e)}}function co(e){return e.target_id?`${e.target_type}:${e.target_id}`:e.target_type}function js(e){Ds.value=[{...e,id:hp++,at:new Date().toISOString()},...Ds.value].slice(0,20)}function Kr(e){return e.confirm_required?is(e.preview)||"Confirmation required":is(e.result)||is(e.executed_action)||is(e.delegated_tool_result)||e.status}async function ge(){Ln.value=!0,st.value=null;try{const e=await Sc();he.value=Ip(e)}catch(e){st.value=e instanceof Error?e.message:"Failed to load operator snapshot"}finally{Ln.value=!1}}async function kt(){Nn.value=!0,Xt.value=null;try{const e=await Wo({targetType:"room"});Ni.value=Fr(e)}catch(e){Xt.value=e instanceof Error?e.message:"Failed to load operator digest"}finally{Nn.value=!1}}async function Zt(e){if(!e){Ne.value=null;return}Nn.value=!0,Xt.value=null;try{const t=await Wo({targetType:"team_session",targetId:e,includeWorkers:!0});Ne.value=Fr(t)}catch(t){Xt.value=t instanceof Error?t.message:"Failed to load session digest"}finally{Nn.value=!1}}async function Tp(e){var t;Q.value=!0,st.value=null;try{const n=await ca(e);return js({actor:e.actor,action_type:e.action_type,target_label:co(e),outcome:n.confirm_required?"preview":"executed",message:Kr(n),delegated_tool:n.delegated_tool}),await ge(),await kt(),(t=Ne.value)!=null&&t.target_id&&await Zt(Ne.value.target_id),n}catch(n){const s=n instanceof Error?n.message:"Operator action failed";throw st.value=s,js({actor:e.actor,action_type:e.action_type,target_label:co(e),outcome:"error",message:s}),n}finally{Q.value=!1}}async function Rp(e,t){var n;Q.value=!0,st.value=null;try{const s=await Ho(e,t);return js({actor:e,action_type:"confirm",target_label:t,outcome:"confirmed",message:Kr(s),delegated_tool:s.delegated_tool}),await ge(),await kt(),(n=Ne.value)!=null&&n.target_id&&await Zt(Ne.value.target_id),s}catch(s){const a=s instanceof Error?s.message:"Operator confirmation failed";throw st.value=a,js({actor:e,action_type:"confirm",target_label:t,outcome:"error",message:a}),s}finally{Q.value=!1}}pu(()=>{var e;ge(),kt(),(e=Ne.value)!=null&&e.target_id&&Zt(Ne.value.target_id)});function Pp(e){switch(e){case"quiet_hours":return"quiet hours";case"min_gap":return"cooldown gate";case"no_recent_activity":return"waiting for activity";case"disabled":return"runtime disabled";case"startup":return"warming up";case"llm_error":return"llm error";case"graphql_error":return"graphql error";case"never_started":return"never started";default:return"unknown"}}function wp(e){switch(e){case"manual_lodge_poke":return"Poke Lodge";case"probe":return"Probe";case"recover":return"Recover";default:return"Message"}}function Lp(e){switch(e.delivery){case"sending":return"sending";case"timeout":return"timeout";case"error":return"error";case"delivered":return"delivered";default:return e.role}}function uo(e){return e.delivery==="error"||e.delivery==="timeout"?"bad":e.delivery==="sending"?"warn":e.role==="assistant"?"assistant":e.role==="user"?"user":"warn"}function Ur(e){if(!e)return null;const t=new Date(e);return Number.isNaN(t.getTime())?null:t.toLocaleTimeString()}function Np(e){return typeof e!="number"||!Number.isFinite(e)||e<=0?null:e<60?`${Math.round(e)}s`:`${Math.ceil(e/60)}m`}function Br(e){if(!e)return null;const t=Fe.value[e.name];return(t==null?void 0:t.diagnostic)??e.diagnostic??null}function Mp({keeper:e,showRawStatus:t=!1}){if(ne(()=>{e!=null&&e.name&&nr(e.name)},[e==null?void 0:e.name]),!e)return i`<div class="control-status-copy">Select a keeper to inspect direct reply state.</div>`;const n=Fe.value[e.name],s=Br(e),a=Qa.value[e.name];return i`
    <div class="control-result-box">
      <div class="control-inline-meta">
        <span class="pill">${(s==null?void 0:s.health_state)??"unknown"}</span>
        <span class="pill">${Pp(s==null?void 0:s.quiet_reason)}</span>
      ...
      <div class="control-status-copy">
        ...
        ${s!=null&&s.last_reply_at?i` · ${Ur(s.last_reply_at)}`:null}
        ${s!=null&&s.next_eligible_at_s?i` · next eligible ${Np(s.next_eligible_at_s)}`:null}
      </div>
  ...
  `}function zp({keeperName:e,placeholder:t}){const[n,s]=zo("");ne(()=>{e&&nr(e)},[e]);const a=ce.value[e]??[],o=Ya.value[e]??!1,l=Ke.value[e],c=async()=>{const u=n.trim();if(!(!e||!u)){s("");try{await wd(e,u)}catch(m){const v=m instanceof Error?m.message:`Failed to message ${e}`;w(v,"error")}}};return i`
        ...
        ${a.length===0?i`<div class="control-status-copy">No direct keeper conversation yet.</div>`:a.map(u=>i`
              <div class="keeper-conversation-item" key=${u.id}>
                <div class="keeper-conversation-meta">
                  ...
                  <span class=${`keeper-role-chip ${uo(u)}`}>${Lp(u)}</span>
                  ${u.timestamp?i`<span class="keeper-conversation-time">${Ur(u.timestamp)}</span>`:null}
                </div>
  ...
  `}function Ep({actor:e,keeper:t,onPokeLodge:n}){if(!t)return null;const s=Br(t),a=Xa.value[t.name]??!1,o=Za.value[t.name]??!1,l=(s==null?void 0:s.next_action_path)??"direct_message",c=(s==null?void 0:s.recoverable)??l==="recover";return i`
    <div class="control-actions">
      <button
        class=${`control-btn ghost ${l==="probe"?"is-active":""}`}
        onClick=${()=>{Ld(t.name,e).catch(u=>{const m=u instanceof Error?u.message:`Failed to probe ${t.name}`;w(m,"error")})}}
        disabled=${a||!e.trim()}
      >
        ${a?"Probing...":"Probe"}
      </button>
      <button
        ...
        onClick=${()=>{Nd(t.name,e).catch(u=>{const m=u instanceof Error?u.message:`Failed to recover ${t.name}`;w(m,"error")})}}
        disabled=${o||!c||!e.trim()}
      >
  ...
  `}const Mi=_(null);function Wr(e){Mi.value=e,Pd(e.name)}function po(){Mi.value=null}const Pt=[{level:"L1_Reactive",label:"L1 Reactive",color:"#6b7280"},{level:"L2_Suggestive",label:"L2 Suggestive",color:"#3b82f6"},{level:"L3_Guided",label:"L3 Guided",color:"#f59e0b"},{level:"L4_Autonomous",label:"L4 Autonomous",color:"#f97316"},{level:"L5_Independent",label:"L5 Independent",color:"#ef4444"}];function Dp(e){if(!e)return 0;const t=Pt.findIndex(n=>n.level===e);return t>=0?t:0}function jp({keeper:e}){const t=Dp(e.autonomy_level),n=Pt[t]??Pt[0];if(!n)return null;const s=(t+1)/Pt.length*100;return i`
  ...
  `}function bs(e){return e?e>=1e6?`${(e/1e6).toFixed(1)}M`:e>=1e3?`${(e/1e3).toFixed(1)}K`:String(e):"—"}function Op(e){switch(e){case"keeper_message":return"message";case"keeper_probe":return"probe";case"keeper_recover":return"recover";case"broadcast":return"broadcast";case"room_pause":return"pause";case"room_resume":return"resume";case"lodge_tick":return"lodge";default:return(e==null?void 0:e.trim())||"action"}}function qp(e){return e.recent_tool_names&&e.recent_tool_names.length>0?e.recent_tool_names:[]}function Fp(e){const t=e.metrics_window;return(Array.isArray(t==null?void 0:t.top_tools)?t.top_tools:[]).map(s=>typeof s=="object"&&s!==null&&"tool"in s&&typeof s.tool=="string"?s.tool:null).filter(s=>s!==null)}function Kp(e){const t=Gn.value;return t?t.keeper_briefs.find(n=>n.name===e.name||n.agent_name&&e.agent_name&&n.agent_name===e.agent_name)??null:null}function Up({keeper:e}){const t=e.metrics_series??[],n=t[t.length-1],s=(n==null?void 0:n.cost_usd)!=null?`$${n.cost_usd.toFixed(4)}`:"—",a=[{label:"Generation",value:e.generation??"-",hint:"Succession count"},{label:"Turns",value:e.turn_count??"-",hint:"Total loop turns"},{label:"Context",value:e.context_ratio!=null?`${Math.round(e.context_ratio*100)}%`:"-",hint:e.context_ratio!=null&&e.context_ratio>.8?"Near limit":void 0},{label:"Activity",value:e.activityLevel??"-",hint:"Level 0–5"}];return i`
  ...
  `}function Bp({keeper:e}){var v,f;const t=e.metrics_series??[];if(t.length<2){const g=(((v=e.context)==null?void 0:v.context_ratio)??0)*100,h=g>85?"#ef4444":g>70?"#f59e0b":"#22c55e";return i`
  ...
  `}function Hp({stats:e}){const t=e.max_hp>0?Math.round(e.hp/e.max_hp*100):0,n=e.max_mp>0?Math.round(e.mp/e.max_mp*100):0;return i`
    <div>
  ...
  `}function Gp({items:e}){return e.length===0?i`<div class="empty-state" style="font-size:13px">No equipment</div>`:i`
  ...
  `}function Jp({rels:e}){const t=Object.entries(e);return t.length===0?i`<div class="empty-state" style="font-size:13px">No relationships</div>`:i`
  ...
  `}function Qp({keeper:e}){var $,C,A,T,x,R,P;const t=(($=he.value)==null?void 0:$.room)??{},n=(((C=he.value)==null?void 0:C.available_actions)??[]).filter(E=>E.target_type==="keeper"||E.target_type==="room").slice(0,8),s=qp(e),a=Fp(e),o=Kp(e),l=(o==null?void 0:o.allowed_tool_names)??[],c=(o==null?void 0:o.latest_tool_names)??[],u=o==null?void 0:o.latest_tool_call_count,m=o==null?void 0:o.tool_audit_source,v=o==null?void 0:o.tool_audit_at,f=((A=e.agent)==null?void 0:A.capabilities)??[],g=t.current_room??t.room_id??((T=oe.value)==null?void 0:T.room)??"default",h=t.project??((x=oe.value)==null?void 0:x.project)??"확인 없음",k=t.cluster??((R=oe.value)==null?void 0:R.cluster)??"확인 없음";return i`
    <div class="keeper-signal-list">
      ...
      <div style="display:flex; flex-direction:column; gap:8px; margin-top:8px;">
        ...
        <div style="display:flex; flex-wrap:wrap; gap:6px;">
          ${n.length>0?n.map(E=>i`<span class="pill">${Op(E.action_type)}</span>`):i`<span style="font-size:12px; color:#888;">operator action 광고 없음</span>`}
        </div>
      </div>
    </div>
  `}function Hr(){const e=new URLSearchParams(window.location.search),t=e.get("agent")??e.get("agent_name"),n=localStorage.getItem("masc_dashboard_agent_name");return(t??n??"dashboard").trim()||"dashboard"}async function Yp(){try{const e=await ca({actor:Hr(),action_type:"lodge_tick",target_type:"room",payload:{}}),t=tr(e.result);await Hn(),t!=null&&t.skipped_reason?w(t.skipped_reason,"warning"):w(t?`Poke finished: ${t.acted}/${t.checked} acted`:"Poke finished",t&&t.acted>0?"success":"warning")}catch(e){const t=e instanceof Error?e.message:"Failed to run Lodge poke";w(t,"error")}}function Xp({keeper:e}){return i`
  ...
  `}function Zp(){var t,n,s;const e=Mi.value;return e?i`
    <div
  ...
  `}function tm(){const e=br.value,t=de((e==null?void 0:e.status)??(_t.value?"bad":"warn")),n=!e||e.sections.length===0,s=(e==null?void 0:e.status)==="error"||(e==null?void 0:e.status)==="unavailable"&&!(e!=null&&e.cached);return i`
  ...
  `}function nm({item:e,selected:t,sessionLookup:n}){const s=Yu(e),a=e.related_session_ids.map(l=>n.get(l)).filter(l=>l!=null),o=e.top_action??null;return i`
    <article class="mission-attention-card ${de((o==null?void 0:o.severity)??e.severity)} ${t?"is-selected":""}">
      <button class="mission-card-select" onClick=${()=>op(e.id)}>
        <div class="mission-card-head">
          <div>
            <strong>${e.summary}</strong>
            <div class="mission-card-target">${e.kind}${e.target_id?` · ${e.target_id}`:""}</div>
          </div>
          <span class="command-chip ${de((o==null?void 0:o.severity)??e.severity)}">${o?Vu(o):e.severity}</span>
        </div>
      ...
      <div class="mission-card-actions">
        ${o?i`
              <button class="control-btn ghost" onClick=${()=>wi(o,s,"Mission attention")}>
                이 액션으로 개입 열기
              </button>
              <button class="control-btn ghost" onClick=${()=>wr(o,s,"Mission attention")}>
                원인 보기
              </button>
            `:i`
              <button class="control-btn ghost" onClick=${()=>Rr(s)}>이 이슈로 개입 열기</button>
              <button class="control-btn ghost" onClick=${()=>Pr(s)}>이 이슈의 원인 보기</button>
            `}
      </div>
    </article>
  `}function sm({brief:e,selected:t}){var o,l;const n=e.member_names.slice(0,6).map(ip),s=e.top_recommendation??null,a=e.top_attention??null;return i`
    <article class="mission-crew-card ${de(((o=e.top_attention)==null?void 0:o.severity)??e.health??e.status)} ${t?"is-selected":""}">
      <button class="mission-card-select" onClick=${()=>zr(e.session_id)}>
        ...
        <div class="mission-fact-grid">
          ...
          <div class="mission-fact-tile">
            <span>가동 시간</span>
            <strong>${Ju(e.elapsed_sec)}</strong>
      ...
      <div class="mission-card-actions">
        ...
        ${s?i`<button class="control-btn ghost" onClick=${()=>wi(s,a,"Mission session brief")}>추천 액션 열기</button>`:null}
      </div>
    </article>
  `}function am({row:e}){var s,a,o,l,c;const t=Ii(e.brief.agent_name),n=e.withWhom.length>0?e.withWhom.slice(0,3).join(", "):"단독 또는 room-level";return i`
  ...
  `}function om({item:e}){const t=e.action??null,n=e.attention??null;return i`
    ...
    <section class="dashboard-panel mission-view">
      ...
      ${t||n?i`
            <div class="mission-selection-bar">
              ...
              <button class="control-btn ghost" onClick=${rp}>선택 해제</button>
            </div>
          `:null}
      ...
      <${I} title="Attention Queue" class="mission-list-card" semanticId="mission.attention_queue">
        ...
        <div class="mission-lane-stack">
          ${m.length>0?m.map(x=>i`<${nm} key=${x.id} item=${x} selected=${Je.value===x.id} sessionLookup=${s} />`):i`<div class="empty-state">지금 Mission attention queue가 비어 있습니다.</div>`}
        </div>
      <//>
      ...
      <div class="mission-human-grid">
        <${I} title="Affected Sessions" class="mission-list-card" semanticId="mission.session_briefs">
          ...
          <div class="mission-list-stack">
            ${l.length>0?l.map(x=>i`<${sm} key=${x.session_id} brief=${x} selected=${Oe.value===x.session_id} />`):i`<div class="empty-state">현재 선택과 연결된 session이 없습니다.</div>`}
          </div>
        <//>
        ...
        <${I} title="Impacted Agents" class="mission-list-card" semanticId="mission.agent_activity">
          ...
          <div class="mission-activity-list">
            ${c.length>0?c.map(x=>i`<${am} key=${x.brief.agent_name} row=${x} />`):i`<div class="empty-state">현재 선택과 연결된 agent가 없습니다.</div>`}
          </div>
        <//>
      </div>
      ...
      <div class="mission-human-grid">
        <${I} title="Keeper Continuity" class="mission-list-card" semanticId="mission.keeper_activity">
          ...
          <div class="mission-activity-list">
            ${u.length>0?u.map(x=>i`<${im} key=${x.brief.name} row=${x} />`):i`<div class="empty-state">지금 보이는 keeper가 없습니다.</div>`}
          </div>
        <//>
        ...
        <${I} title="Internal Signals" class="mission-list-card" semanticId="mission.internal_signals">
          ...
          <div class="mission-list-stack">
            ${v.length>0?v.map(x=>i`<${om} key=${x.id} item=${x} />`):i`<div class="empty-state">지금은 내부 진단 경고가 없습니다.</div>`}
          </div>
          <div class="mission-card-actions">
  ...
  `}const Gr=_(null),oi=_(!1),zt=_(null);async function Jr(e,t){oi.value=!0,zt.value=null;try{Gr.value=await kc(e,t)}catch(n){zt.value=n instanceof Error?n.message:String(n)}finally{oi.value=!1}}const rm="modulepreload",lm=function(e){return"/dashboard/"+e},_o={},cm=function(t,n,s){let a=Promise.resolve();if(n&&n.length>0){let l=function(m){return Promise.all(m.map(v=>Promise.resolve(v).then(f=>({status:"fulfilled",value:f}),f=>({status:"rejected",reason:f}))))};document.getElementsByTagName("link");const c=document.querySelector("meta[property=csp-nonce]"),u=(c==null?void 0:c.nonce)||(c==null?void 0:c.getAttribute("nonce"));a=l(n.map(m=>{if(m=lm(m),m in _o)return;_o[m]=!0;const v=m.endsWith(".css"),f=v?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${m}"]${f}`))return;const g=document.createElement("link");if(g.rel=v?"stylesheet":rm,v||(g.as="script"),g.crossOrigin="",g.href=m,u&&g.setAttribute("nonce",u),document.head.appendChild(g),v)return new Promise((h,k)=>{g.addEventListener("load",h),g.addEventListener("error",()=>k(new Error(`Unable to preload CSS for ${m}`)))})}))}function o(l){const c=new Event("vite:preloadError",{cancelable:!0});if(c.payload=l,window.dispatchEvent(c),!c.defaultPrevented)throw l}return a.then(l=>{for(const c of l||[])c.status==="rejected"&&o(c.reason);return t().catch(o)})},zi=_(null),Ee=_(null),Os=_(!1),qs=_(!1),Fs=_(null),Ks=_(null),ri=_(null),Us=_(null),X=_("warroom"),Vn=_(null),li=_(!1),Bs=_(null),St=_(null),Ws=_(!1),Hs=_(null),Qn=_(null),ci=_(!1),Gs=_(null),Mn=_(null),Js=_(!1),zn=_(null),Ht=_(null);let mn=null;function Ei(e){return e!=="summary"&&e!=="swarm"&&e!=="warroom"}function Vr(){if(typeof window>"u")return new URLSearchParams;const e=new URLSearchParams(window.location.search),t=window.location.hash.replace(/^#/,""),n=t.indexOf("?");return n>=0&&new URLSearchParams(t.slice(n+1)).forEach((a,o)=>{e.has(o)||e.set(o,a)}),e}function dm(){const t=Vr().get("run_id")??void 0;return t&&t.trim()!==""?t.trim():void 0}function um(){const t=Vr().get("operation_id")??void 0;return t&&t.trim()!==""?t.trim():void 0}function pm(e){if(p(e))return{policy_class:r(e.policy_class),approval_class:r(e.approval_class),tool_allowlist:W(e.tool_allowlist),model_allowlist:W(e.model_allowlist),requires_human_for:W(e.requires_human_for),autonomy_level:r(e.autonomy_level),escalation_timeout_sec:d(e.escalation_timeout_sec),kill_switch:U(e.kill_switch),frozen:U(e.frozen)}}function mm(e){if(p(e))return{headcount_cap:d(e.headcount_cap),active_operation_cap:d(e.active_operation_cap),max_cost_usd:d(e.max_cost_usd),max_tokens:d(e.max_tokens)}}function Di(e){if(!p(e))return null;const t=r(e.unit_id),n=r(e.label),s=r(e.kind);return!t||!n||!s?null:{unit_id:t,label:n,kind:s,parent_unit_id:r(e.parent_unit_id)??null,leader_id:r(e.leader_id)??null,roster:W(e.roster),capability_profile:W(e.capability_profile),source:r(e.source),created_at:r(e.created_at),updated_at:r(e.updated_at),policy:pm(e.policy),budget:mm(e.budget)}}function Qr(e){if(!p(e))return null;const t=Di(e.unit);return t?{unit:t,leader_status:r(e.leader_status),roster_total:d(e.roster_total),roster_live:d(e.roster_live),active_operation_count:d(e.active_operation_count),health:r(e.health),reasons:W(e.reasons),children:Array.isArray(e.children)?e.children.map(Qr).filter(n=>n!==null):[]}:null}function vm(e){if(p(e))return{total_units:d(e.total_units),company_count:d(e.company_count),platoon_count:d(e.platoon_count),squad_count:d(e.squad_count),leaf_agent_unit_count:d(e.leaf_agent_unit_count),live_agent_count:d(e.live_agent_count),managed_unit_count:d(e.managed_unit_count),active_operation_count:d(e.active_operation_count)}}function Yr(e){const t=p(e)?e:{};return{version:r(t.version),generated_at:r(t.generated_at),source:r(t.source),summary:vm(t.summary),units:Array.isArray(t.units)?t.units.map(Qr).filter(n=>n!==null):[]}}function _m(e){if(!p(e))return null;const t=r(e.kind),n=r(e.status);return!t||!n?null:{kind:t,chain_id:r(e.chain_id)??null,goal:r(e.goal)??null,run_id:r(e.run_id)??null,status:n,viewer_path:r(e.viewer_path)??null,last_sync_at:r(e.last_sync_at)??null}}function ma(e){if(!p(e))return null;const t=r(e.operation_id),n=r(e.objective),s=r(e.assigned_unit_id),a=r(e.trace_id),o=r(e.status);return!t||!n||!s||!a||!o?null:{operation_id:t,objective:n,assigned_unit_id:s,autonomy_level:r(e.autonomy_level),policy_class:r(e.policy_class),budget_class:r(e.budget_class),detachment_session_id:r(e.detachment_session_id)??null,trace_id:a,checkpoint_ref:r(e.checkpoint_ref)??null,active_goal_ids:W(e.active_goal_ids),note:r(e.note)??null,created_by:r(e.created_by),source:r(e.source),status:o,chain:_m(e.chain),created_at:r(e.created_at),updated_at:r(e.updated_at)}}function fm(e){if(!p(e))return null;const t=ma(e.operation);return t?{operation:t,assigned_unit_label:r(e.assigned_unit_label)}:null}function un(e){if(p(e))return{tone:r(e.tone),pending_ops:d(e.pending_ops),blocked_ops:d(e.blocked_ops),in_flight_ops:d(e.in_flight_ops),pipeline_stalls:d(e.pipeline_stalls),bus_traffic:d(e.bus_traffic),l1_hit_rate:d(e.l1_hit_rate),invalidation_count:d(e.invalidation_count),current_pending:d(e.current_pending),current_in_flight:d(e.current_in_flight),cdb_wakeups:d(e.cdb_wakeups),total_stolen:d(e.total_stolen),avg_best_score:d(e.avg_best_score),avg_candidate_count:d(e.avg_candidate_count),best_first_operations:d(e.best_first_operations),active_sessions:d(e.active_sessions),commit_rate:d(e.commit_rate),total_speculations:d(e.total_speculations)}}function gm(e){if(!p(e))return;const t=p(e.pipeline)?e.pipeline:void 0,n=p(e.cache)?e.cache:void 0,s=p(e.ooo)?e.ooo:void 0,a=p(e.speculative)?e.speculative:void 0,o=p(e.search_fabric)?e.search_fabric:void 0,l=p(e.signals)?e.signals:void 0;return{pipeline:t?{total_ops:d(t.total_ops),completed_ops:d(t.completed_ops),stalled_cycles:d(t.stalled_cycles),hazards_detected:d(t.hazards_detected),forwarding_used:d(t.forwarding_used),pipeline_flushes:d(t.pipeline_flushes),ipc:d(t.ipc)}:void 0,cache:n?{total_reads:d(n.total_reads),total_writes:d(n.total_writes),l1_hit_rate:d(n.l1_hit_rate),invalidation_count:d(n.invalidation_count),writeback_count:d(n.writeback_count),bus_traffic:d(n.bus_traffic)}:void 0,ooo:s?{agent_count:d(s.agent_count),total_added:d(s.total_added),total_issued:d(s.total_issued),total_completed:d(s.total_completed),total_stolen:d(s.total_stolen),cdb_wakeups:d(s.cdb_wakeups),stall_cycles:d(s.stall_cycles),global_cdb_events:d(s.global_cdb_events),current_pending:d(s.current_pending),current_in_flight:d(s.current_in_flight)}:void 0,speculative:a?{total_speculations:d(a.total_speculations),total_commits:d(a.total_commits),total_aborts:d(a.total_aborts),commit_rate:d(a.commit_rate),total_fast_calls:d(a.total_fast_calls),total_cost_usd:d(a.total_cost_usd),active_sessions:d(a.active_sessions)}:void 0,search_fabric:o?{total_operations:d(o.total_operations),best_first_operations:d(o.best_first_operations),legacy_operations:d(o.legacy_operations),blocked_operations:d(o.blocked_operations),ready_operations:d(o.ready_operations),research_pipeline_operations:d(o.research_pipeline_operations),avg_candidate_count:d(o.avg_candidate_count),avg_best_score:d(o.avg_best_score),top_stage:r(o.top_stage)??null}:void 0,signals:l?{issue_pressure:un(l.issue_pressure),cache_contention:un(l.cache_contention),scheduler_efficiency:un(l.scheduler_efficiency),routing_confidence:un(l.routing_confidence),speculative_posture:un(l.speculative_posture)}:void 0}}function Xr(e){const t=p(e)?e:{},n=p(t.summary)?t.summary:void 0;return{version:r(t.version),generated_at:r(t.generated_at),summary:n?{total:d(n.total),active:d(n.active),paused:d(n.paused),managed:d(n.managed),projected:d(n.projected)}:void 0,microarch:gm(t.microarch),operations:Array.isArray(t.operations)?t.operations.map(fm).filter(s=>s!==null):[]}}function Zr(e){if(!p(e))return null;const t=r(e.detachment_id),n=r(e.operation_id),s=r(e.assigned_unit_id);return!t||!n||!s?null:{detachment_id:t,operation_id:n,assigned_unit_id:s,leader_id:r(e.leader_id)??null,roster:W(e.roster),session_id:r(e.session_id)??null,checkpoint_ref:r(e.checkpoint_ref)??null,runtime_kind:r(e.runtime_kind)??null,runtime_ref:r(e.runtime_ref)??null,source:r(e.source),status:r(e.status),last_event_at:r(e.last_event_at)??null,last_progress_at:r(e.last_progress_at)??null,heartbeat_deadline:r(e.heartbeat_deadline)??null,created_at:r(e.created_at),updated_at:r(e.updated_at)}}function $m(e){if(!p(e))return null;const t=Zr(e.detachment);return t?{detachment:t,assigned_unit_label:r(e.assigned_unit_label),operation:ma(e.operation)}:null}function el(e){const t=p(e)?e:{},n=p(t.summary)?t.summary:void 0;return{version:r(t.version),generated_at:r(t.generated_at),summary:n?{total:d(n.total),active:d(n.active),projected:d(n.projected)}:void 0,detachments:Array.isArray(t.detachments)?t.detachments.map($m).filter(s=>s!==null):[]}}function hm(e){if(!p(e))return null;const t=r(e.decision_id),n=r(e.trace_id),s=r(e.requested_action),a=r(e.scope_type),o=r(e.scope_id);return!t||!n||!s||!a||!o?null:{decision_id:t,trace_id:n,requested_action:s,scope_type:a,scope_id:o,operation_id:r(e.operation_id)??null,target_unit_id:r(e.target_unit_id)??null,requested_by:r(e.requested_by),status:r(e.status),reason:r(e.reason)??null,source:r(e.source),detail:e.detail,created_at:r(e.created_at),decided_at:r(e.decided_at)??null,expires_at:r(e.expires_at)??null}}function tl(e){const t=p(e)?e:{},n=p(t.summary)?t.summary:void 0;return{version:r(t.version),generated_at:r(t.generated_at),summary:n?{total:d(n.total),pending:d(n.pending),approved:d(n.approved),denied:d(n.denied)}:void 0,decisions:Array.isArray(t.decisions)?t.decisions.map(hm).filter(s=>s!==null):[]}}function ym(e){if(!p(e))return null;const t=Di(e.unit);return t?{unit:t,roster_total:d(e.roster_total),roster_live:d(e.roster_live),headcount_cap:d(e.headcount_cap),active_operations:d(e.active_operations),active_operation_cap:d(e.active_operation_cap),utilization:d(e.utilization)}:null}function bm(e){const t=p(e)?e:{};return{version:r(t.version),generated_at:r(t.generated_at),capacity:Array.isArray(t.capacity)?t.capacity.map(ym).filter(n=>n!==null):[]}}function km(e){if(!p(e))return null;const t=r(e.alert_id);return t?{alert_id:t,severity:r(e.severity),kind:r(e.kind),scope_type:r(e.scope_type),scope_id:r(e.scope_id),title:r(e.title),detail:r(e.detail),timestamp:r(e.timestamp)}:null}function nl(e){const t=p(e)?e:{},n=p(t.summary)?t.summary:void 0;return{version:r(t.version),generated_at:r(t.generated_at),summary:n?{total:d(n.total),bad:d(n.bad),warn:d(n.warn)}:void 0,alerts:Array.isArray(t.alerts)?t.alerts.map(km).filter(s=>s!==null):[]}}function sl(e){if(!p(e))return null;const t=r(e.event_id),n=r(e.trace_id),s=r(e.event_type);return!t||!n||!s?null:{event_id:t,trace_id:n,event_type:s,operation_id:r(e.operation_id)??null,unit_id:r(e.unit_id)??null,actor:r(e.actor)??null,source:r(e.source),timestamp:r(e.timestamp),detail:e.detail}}function xm(e){const t=p(e)?e:{};return{version:r(t.version),generated_at:r(t.generated_at),events:Array.isArray(t.events)?t.events.map(sl).filter(n=>n!==null):[]}}function Sm(e){if(!p(e))return null;const t=r(e.code),n=r(e.severity),s=r(e.summary);return!t||!n||!s?null:{code:t,severity:n,summary:s}}function Am(e){if(!p(e))return null;const t=r(e.lane_id),n=r(e.label),s=r(e.kind),a=r(e.phase),o=r(e.motion_state),l=r(e.source_of_truth),c=r(e.movement_reason),u=r(e.current_step);if(!t||!n||!s||!a||!o||!l||!c||!u)return null;const m=p(e.counts)?e.counts:{};return{lane_id:t,label:n,kind:s,present:U(e.present)??!1,phase:a,motion_state:o,source_of_truth:l,last_movement_at:r(e.last_movement_at)??null,movement_reason:c,current_step:u,blockers:W(e.blockers),counts:{operations:d(m.operations),detachments:d(m.detachments),workers:d(m.workers),approvals:d(m.approvals),alerts:d(m.alerts)},hard_flags:Array.isArray(e.hard_flags)?e.hard_flags.map(Sm).filter(v=>v!==null):[]}}function Cm(e){if(!p(e))return null;const t=r(e.event_id),n=r(e.lane_id),s=r(e.kind),a=r(e.timestamp),o=r(e.title),l=r(e.detail),c=r(e.tone),u=r(e.source);return!t||!n||!s||!a||!o||!l||!c||!u?null:{event_id:t,lane_id:n,kind:s,timestamp:a,title:o,detail:l,tone:c,source:u}}function Im(e){if(!p(e))return null;const t=r(e.code),n=r(e.severity),s=r(e.summary);return!t||!n||!s?null:{code:t,severity:n,summary:s,lane_ids:W(e.lane_ids),count:d(e.count)??0}}function al(e){if(!p(e))return;const t=p(e.overview)?e.overview:{},n=p(e.gaps)?e.gaps:{},s=p(e.recommended_next_action)?e.recommended_next_action:void 0;return{generated_at:r(e.generated_at),overview:{active_lanes:d(t.active_lanes),moving_lanes:d(t.moving_lanes),stalled_lanes:d(t.stalled_lanes),projected_lanes:d(t.projected_lanes),last_movement_at:r(t.last_movement_at)??null},lanes:Array.isArray(e.lanes)?e.lanes.map(Am).filter(a=>a!==null):[],timeline:Array.isArray(e.timeline)?e.timeline.map(Cm).filter(a=>a!==null):[],gaps:{count:d(n.count),items:Array.isArray(n.items)?n.items.map(Im).filter(a=>a!==null):[]},recommended_next_action:s?{tool:r(s.tool)??"masc_operator_snapshot",label:r(s.label)??"Observe operator state",reason:r(s.reason)??"",lane_id:r(s.lane_id)??null}:void 0}}function Tm(e){if(!p(e))return;const t=p(e.workers)?e.workers:{},n=U(e.pass);return{status:r(e.status)??"missing",source:r(e.source)??"none",run_id:r(e.run_id)??null,captured_at:r(e.captured_at)??null,...n!==void 0?{pass:n}:{},...d(e.peak_hot_slots)!=null?{peak_hot_slots:d(e.peak_hot_slots)}:{},...d(e.ctx_per_slot)!=null?{ctx_per_slot:d(e.ctx_per_slot)}:{},workers:{expected:d(t.expected),joined:d(t.joined),current_task_bound:d(t.current_task_bound),fresh_heartbeats:d(t.fresh_heartbeats),done:d(t.done),final:d(t.final)},artifact_ref:r(e.artifact_ref)??null,missing_reason:r(e.missing_reason)??null}}function Rm(e){const t=p(e)?e:{};return{version:r(t.version),generated_at:r(t.generated_at),topology:Yr(t.topology),operations:Xr(t.operations),detachments:el(t.detachments),alerts:nl(t.alerts),decisions:tl(t.decisions),capacity:bm(t.capacity),traces:xm(t.traces),swarm_status:al(t.swarm_status)}}function Pm(e){const t=p(e)?e:{},n=Yr(t.topology),s=Xr(t.operations),a=el(t.detachments),o=nl(t.alerts),l=tl(t.decisions);return{version:r(t.version),generated_at:r(t.generated_at),topology:{version:n.version,generated_at:n.generated_at,source:n.source,summary:n.summary},operations:{version:s.version,generated_at:s.generated_at,summary:s.summary,microarch:s.microarch},detachments:{version:a.version,generated_at:a.generated_at,summary:a.summary},alerts:{version:o.version,generated_at:o.generated_at,summary:o.summary},decisions:{version:l.version,generated_at:l.generated_at,summary:l.summary},swarm_status:al(t.swarm_status),swarm_proof:Tm(t.swarm_proof)}}function wm(e){return p(e)?{chain_id:r(e.chain_id)??null,started_at:d(e.started_at)??null,progress:d(e.progress)??null,elapsed_sec:d(e.elapsed_sec)??null}:null}function il(e){if(!p(e))return null;const t=r(e.event);return t?{event:t,chain_id:r(e.chain_id)??null,timestamp:r(e.timestamp)??null,duration_ms:d(e.duration_ms)??null,message:r(e.message)??null,tokens:d(e.tokens)??null}:null}function Lm(e){if(!p(e))return null;const t=ma(e.operation);return t?{operation:t,runtime:wm(e.runtime),history:il(e.history),mermaid:r(e.mermaid)??null,preview_run:ol(e.preview_run)}:null}function Nm(e){const t=p(e)?e:{};return{status:r(t.status)??"disconnected",base_url:r(t.base_url)??null,message:r(t.message)??null}}function Mm(e){const t=p(e)?e:{},n=p(t.summary)?t.summary:void 0;return{version:r(t.version),generated_at:r(t.generated_at),connection:Nm(t.connection),summary:n?{linked_operations:d(n.linked_operations),active_chains:d(n.active_chains),running_operations:d(n.running_operations),recent_failures:d(n.recent_failures),last_history_event_at:r(n.last_history_event_at)??null}:void 0,operations:Array.isArray(t.operations)?t.operations.map(Lm).filter(s=>s!==null):[],recent_history:Array.isArray(t.recent_history)?t.recent_history.map(il).filter(s=>s!==null):[]}}function zm(e){if(!p(e))return null;const t=r(e.id);return t?{id:t,type:r(e.type),status:r(e.status),duration_ms:d(e.duration_ms)??null,error:r(e.error)??null}:null}function ol(e){if(!p(e))return null;const t=r(e.run_id),n=r(e.chain_id);return n?{run_id:t??null,chain_id:n,duration_ms:d(e.duration_ms),success:U(e.success),mermaid:r(e.mermaid),nodes:Array.isArray(e.nodes)?e.nodes.map(zm).filter(s=>s!==null):[]}:null}function Em(e){const t=p(e)?e:{};return{run:ol(t.run)}}function Dm(e){if(!p(e))return null;const t=r(e.title),n=r(e.path);return!t||!n?null:{title:t,path:n}}function jm(e){if(!p(e))return null;const t=r(e.id),n=r(e.title),s=r(e.summary);return!t||!n||!s?null:{id:t,title:n,summary:s}}function Om(e){if(!p(e))return null;const t=r(e.id),n=r(e.title),s=r(e.tool),a=r(e.summary);return!t||!n||!s||!a?null:{id:t,title:n,tool:s,summary:a,success_signals:W(e.success_signals),pitfalls:W(e.pitfalls)}}function qm(e){if(!p(e))return null;const t=r(e.id),n=r(e.title),s=r(e.summary),a=r(e.when_to_use);return!t||!n||!s||!a?null:{id:t,title:n,summary:s,when_to_use:a,steps:Array.isArray(e.steps)?e.steps.map(Om).filter(o=>o!==null):[]}}function Fm(e){if(!p(e))return null;const t=r(e.id),n=r(e.title),s=r(e.description);return!t||!n||!s?null:{id:t,title:n,description:s,tools:W(e.tools)}}function Km(e){if(!p(e))return null;const t=r(e.id),n=r(e.title),s=r(e.symptom),a=r(e.why),o=r(e.fix_tool),l=r(e.fix_summary);return!t||!n||!s||!a||!o||!l?null:{id:t,title:n,symptom:s,why:a,fix_tool:o,fix_summary:l}}function Um(e){if(!p(e))return null;const t=r(e.id),n=r(e.title),s=r(e.path_id),a=r(e.transport);return!t||!n||!s||!a?null:{id:t,title:n,path_id:s,transport:a,request:e.request,response:e.response,notes:W(e.notes)}}function Bm(e){const t=p(e)?e:{};return{version:r(t.version),generated_at:r(t.generated_at),docs:Array.isArray(t.docs)?t.docs.map(Dm).filter(n=>n!==null):[],concepts:Array.isArray(t.concepts)?t.concepts.map(jm).filter(n=>n!==null):[],golden_paths:Array.isArray(t.golden_paths)?t.golden_paths.map(qm).filter(n=>n!==null):[],tool_groups:Array.isArray(t.tool_groups)?t.tool_groups.map(Fm).filter(n=>n!==null):[],pitfalls:Array.isArray(t.pitfalls)?t.pitfalls.map(Km).filter(n=>n!==null):[],examples:Array.isArray(t.examples)?t.examples.map(Um).filter(n=>n!==null):[]}}function Wm(e){if(!p(e))return null;const t=r(e.id),n=r(e.title),s=r(e.status),a=r(e.detail),o=r(e.next_tool);return!t||!n||!s||!a||!o?null:{id:t,title:n,status:s,detail:a,next_tool:o}}function Hm(e){if(!p(e))return null;const t=r(e.code),n=r(e.severity),s=r(e.title),a=r(e.detail),o=r(e.next_tool);return!t||!n||!s||!a||!o?null:{code:t,severity:n,title:s,detail:a,next_tool:o}}function Gm(e){if(!p(e))return null;const t=r(e.from),n=r(e.content),s=r(e.timestamp),a=d(e.seq);return!t||!n||!s||a==null?null:{seq:a,from:t,content:n,timestamp:s}}function Jm(e){if(!p(e))return null;const t=r(e.name),n=r(e.role),s=r(e.lane),a=r(e.status),o=r(e.claim_marker),l=r(e.done_marker),c=r(e.final_marker);if(!t||!n||!s||!a||!o||!l||!c)return null;const u=(()=>{if(!p(e.last_message))return null;const m=d(e.last_message.seq),v=r(e.last_message.content),f=r(e.last_message.timestamp);return m==null||!v||!f?null:{seq:m,content:v,timestamp:f}})();return{name:t,role:n,lane:s,joined:U(e.joined)??!1,live_presence:U(e.live_presence)??!1,completed:U(e.completed)??!1,status:a,current_task:r(e.current_task)??null,bound_task_id:r(e.bound_task_id)??null,bound_task_title:r(e.bound_task_title)??null,bound_task_status:r(e.bound_task_status)??null,current_task_matches_run:U(e.current_task_matches_run)??!1,squad_member:U(e.squad_member)??!1,detachment_member:U(e.detachment_member)??!1,last_seen:r(e.last_seen)??null,heartbeat_age_sec:d(e.heartbeat_age_sec)??null,heartbeat_fresh:U(e.heartbeat_fresh)??!1,claim_marker_seen:U(e.claim_marker_seen)??!1,done_marker_seen:U(e.done_marker_seen)??!1,final_marker_seen:U(e.final_marker_seen)??!1,claim_marker:o,done_marker:l,final_marker:c,last_message:u}}function Vm(e){if(!p(e))return;const t=Array.isArray(e.timeline)?e.timeline.map(n=>{if(!p(n))return null;const s=r(n.timestamp),a=d(n.active_slots);if(!s||a==null)return null;const o=Array.isArray(n.active_slot_ids)?n.active_slot_ids.map(l=>typeof l=="number"&&Number.isFinite(l)?l:null).filter(l=>l!=null):[];return{timestamp:s,active_slots:a,active_slot_ids:o}}).filter(n=>n!==null):[];return{slot_url:r(e.slot_url)??null,provider_base_url:r(e.provider_base_url)??null,provider_reachable:U(e.provider_reachable)??null,provider_status_code:d(e.provider_status_code)??null,provider_model_id:r(e.provider_model_id)??null,actual_model_id:r(e.actual_model_id)??null,expected_slots:d(e.expected_slots),actual_slots:d(e.actual_slots),expected_ctx:d(e.expected_ctx),actual_ctx:d(e.actual_ctx),slot_reachable:U(e.slot_reachable)??null,slot_status_code:d(e.slot_status_code)??null,runtime_blocker:r(e.runtime_blocker)??null,detail:r(e.detail)??null,checked_at:r(e.checked_at)??null,total_slots:d(e.total_slots),ctx_per_slot:d(e.ctx_per_slot),active_slots_now:d(e.active_slots_now),peak_active_slots:d(e.peak_active_slots),sample_count:d(e.sample_count),last_sample_at:r(e.last_sample_at)??null,timeline:t}}function Qm(e){const t=p(e)?e:{},n=p(t.summary)?t.summary:void 0;return{version:r(t.version),generated_at:r(t.generated_at),run_id:r(t.run_id),room_id:r(t.room_id),operation_id:r(t.operation_id)??null,recommended_next_tool:r(t.recommended_next_tool),summary:n?{expected_workers:d(n.expected_workers),joined_workers:d(n.joined_workers),live_workers:d(n.live_workers),squad_roster_size:d(n.squad_roster_size),detachment_roster_size:d(n.detachment_roster_size),current_task_bound:d(n.current_task_bound),fresh_heartbeats:d(n.fresh_heartbeats),claim_markers_seen:d(n.claim_markers_seen),done_markers_seen:d(n.done_markers_seen),final_markers_seen:d(n.final_markers_seen),completed_workers:d(n.completed_workers),peak_hot_slots:d(n.peak_hot_slots),hot_window_ok:U(n.hot_window_ok),pass_hot_concurrency:U(n.pass_hot_concurrency),pass_end_to_end:U(n.pass_end_to_end),pending_decisions:d(n.pending_decisions),pass:U(n.pass)}:void 0,provider:Vm(t.provider),operation:ma(t.operation),squad:Di(t.squad),detachment:Zr(t.detachment),workers:Array.isArray(t.workers)?t.workers.map(Jm).filter(s=>s!==null):[],checklist:Array.isArray(t.checklist)?t.checklist.map(Wm).filter(s=>s!==null):[],blockers:Array.isArray(t.blockers)?t.blockers.map(Hm).filter(s=>s!==null):[],recent_messages:Array.isArray(t.recent_messages)?t.recent_messages.map(Gm).filter(s=>s!==null):[],recent_trace_events:Array.isArray(t.recent_trace_events)?t.recent_trace_events.map(sl).filter(s=>s!==null):[],truth_notes:W(t.truth_notes)}}function yt(e){X.value=e,Ei(e)&&Ym()}async function rl(){Os.value=!0,Fs.value=null;try{const e=await Cc();zi.value=Pm(e)}catch(e){Fs.value=e instanceof Error?e.message:"Failed to load command-plane summary"}finally{Os.value=!1}}function ji(e){Ht.value=e}async function Oi(){qs.value=!0,Ks.value=null;try{const e=await Ac();Ee.value=Rm(e)}catch(e){Ks.value=e instanceof Error?e.message:"Failed to load command-plane snapshot"}finally{qs.value=!1}}async function Ym(){Ee.value||qs.value||await Oi()}async function Et(){await rl(),Ei(X.value)&&await Oi()}async function Gt(){var e;ci.value=!0,Gs.value=null;try{const t=await Ic(),n=Mm(t);Qn.value=n;const s=Ht.value;n.operations.length===0?Ht.value=null:(!s||!n.operations.some(a=>a.operation.operation_id===s))&&(Ht.value=((e=n.operations[0])==null?void 0:e.operation.operation_id)??null)}catch(t){Gs.value=t instanceof Error?t.message:"Failed to load chain summary"}finally{ci.value=!1}}function Xm(){mn=null,Mn.value=null,Js.value=!1,zn.value=null}async function Zm(e){mn=e,Js.value=!0,zn.value=null;try{const t=await Tc(e);if(mn!==e)return;Mn.value=Em(t)}catch(t){if(mn!==e)return;Mn.value=null,zn.value=t instanceof Error?t.message:"Failed to load chain run"}finally{mn===e&&(Js.value=!1)}}async function ev(){li.value=!0,Bs.value=null;try{const e=await Rc();Vn.value=Bm(e)}catch(e){Bs.value=e instanceof Error?e.message:"Failed to load command-plane help"}finally{li.value=!1}}async function Ve(e=dm(),t=um()){Ws.value=!0,Hs.value=null;try{const n=await Pc(e,t);St.value=Qm(n)}catch(n){Hs.value=n instanceof Error?n.message:"Failed to load command-plane swarm view"}finally{Ws.value=!1}}async function rt(e,t,n){ri.value=e,Us.value=null;try{await wc(t,n),await rl(),(Ee.value||Ei(X.value))&&await Oi(),await Ve(),await Gt()}catch(s){throw Us.value=s instanceof Error?s.message:"Failed to execute command-plane action",s}finally{ri.value=null}}function tv(e){return rt(`pause:${e}`,"/api/v1/command-plane/operations/pause",{operation_id:e})}function nv(e){return rt(`resume:${e}`,"/api/v1/command-plane/operations/resume",{operation_id:e})}function sv(e){return rt(`recall:${e}`,"/api/v1/command-plane/dispatch/recall",{operation_id:e})}function av(e={}){return rt("dispatch:tick","/api/v1/command-plane/dispatch/tick",{...e.operationId?{operation_id:e.operationId}:{},...e.detachmentId?{detachment_id:e.detachmentId}:{}})}function iv(e){return rt(`approve:${e}`,"/api/v1/command-plane/policy/approve",{decision_id:e})}function ov(e){return rt(`deny:${e}`,"/api/v1/command-plane/policy/deny",{decision_id:e})}function rv(e,t){return rt(`freeze:${e}`,"/api/v1/command-plane/policy/freeze",{unit_id:e,enabled:t})}function lv(e,t){return rt(`kill:${e}`,"/api/v1/command-plane/policy/kill-switch",{unit_id:e,enabled:t})}uu(()=>{Et(),Gt(),(X.value==="swarm"||X.value==="warroom"||St.value!==null)&&Ve(),X.value==="warroom"&&ge()});function Vs(e){if(e==null)return"";if(typeof e=="string")return e;try{return JSON.stringify(e,null,2)}catch{return String(e)}}function V(e){if(!e)return"n/a";const t=Date.parse(e);if(Number.isNaN(t))return e;const n=Math.max(0,Math.round((Date.now()-t)/1e3));return n<60?`${n}s ago`:n<3600?`${Math.round(n/60)}m ago`:n<86400?`${Math.round(n/3600)}h ago`:`${Math.round(n/86400)}d ago`}function cv(e){if(!e)return"warn";const t=Date.parse(e);return Number.isNaN(t)?"warn":t<=Date.now()?"bad":"ok"}function ll(e){if(!e)return"n/a";const t=Date.parse(e);if(Number.isNaN(t))return e;const n=Math.round((t-Date.now())/1e3);return n<=0?"expired":n<60?`in ${n}s`:n<3600?`in ${Math.round(n/60)}m`:n<86400?`in ${Math.round(n/3600)}h`:`in ${Math.round(n/86400)}d`}function N(e){return e==="bad"?"bad":e==="warn"||e==="pending"?"warn":"ok"}let fo=!1,dv=0;function uv(){return++dv}let ka=null;async function pv(){ka||(ka=cm(()=>import("./mermaid.core-CCmMEKq1.js").then(t=>t.bE),[]).then(t=>t.default));const e=await ka;return fo||(e.initialize({startOnLoad:!1,theme:"dark",securityLevel:"loose"}),fo=!0),e}function Ze(e){if(!e)return"warn";const t=e.toLowerCase();return t.includes("failed")||t.includes("error")||t.includes("disconnected")||t.includes("stopped")?"bad":t.includes("running")||t.includes("active")||t.includes("degraded")||t.includes("pending")?"warn":"ok"}function Yn(e){return typeof e!="number"||!Number.isFinite(e)?"n/a":`${Math.round(e*100)}%`}function vn(e){return typeof e!="number"||!Number.isFinite(e)?"n/a":e<60?`${Math.round(e)}s`:e<3600?`${Math.round(e/60)}m`:`${Math.round(e/3600)}h`}function Xn(e){return typeof e!="number"||!Number.isFinite(e)?0:Math.max(0,Math.min(100,e))}function mt(e,t){return typeof e!="number"||!Number.isFinite(e)||typeof t!="number"||!Number.isFinite(t)||t<=0?0:Xn(e/t*100)}function mv(e,t){const n=Xn(e);return`--gauge-angle:${Math.max(10,Math.round(n/100*360))}deg;--gauge-color:${t};`}function cl(e){if(!e)return"No recent chain history";const t=[e.event];return typeof e.duration_ms=="number"&&t.push(`${e.duration_ms}ms`),typeof e.tokens=="number"&&t.push(`${e.tokens} tokens`),e.message&&t.push(e.message),t.join(" · ")}const vv=[{id:"status",label:"현황"},{id:"history",label:"이력"},{id:"control",label:"통제"}],dl=[{id:"warroom",label:"워룸",group:"status"},{id:"summary",label:"요약",group:"status"},{id:"topology",label:"토폴로지",group:"status"},{id:"swarm",label:"스웜",group:"status"},{id:"operations",label:"작전",group:"history"},{id:"trace",label:"트레이스",group:"history"},{id:"chains",label:"체인",group:"history"},{id:"control",label:"제어",group:"control"},{id:"alerts",label:"알림",group:"control"}],_v=dl.map(e=>e.id),fv=["chain_start","node_start","node_complete","chain_complete","chain_error"],gv={warroom:{title:"라이브 워룸",description:"실제 run, worker, message, trace를 한 화면에서 따라가는 기본 진입 표면입니다."},operations:{title:"현재 작전 상세",description:"활성 operation, detachment, dependency를 먼저 읽는 기본 진입 표면입니다."},swarm:{title:"스웜 실행 흐름",description:"lane 이동, worker 결속, blocker를 따라가며 현장감 있게 보는 표면입니다."},chains:{title:"체인 런타임",description:"체인 연결 상태와 operation별 실행 그래프를 확인하는 표면입니다."},topology:{title:"지휘 계층",description:"company에서 agent까지 지휘 계층과 live roster를 확인합니다."},alerts:{title:"경보 모음",description:"지금 개입을 밀어올리는 alert만 모아서 보는 표면입니다."},trace:{title:"최근 트레이스",description:"operation, actor, unit 단위 이벤트를 시간순으로 보는 표면입니다."},control:{title:"승인과 제어",description:"decision 승인과 unit 제어를 실제로 수행하는 표면입니다."},summary:{title:"지휘 요약",description:"전체 지휘면을 한 번에 훑는 계기판 성격의 요약 표면입니다."}};function go(e){return!!e&&_v.includes(e)}function $v(){const e=j.value.params;return e.source!=="mission"&&e.source!=="execution"?{}:{source:e.source,...e.action_type?{action_type:e.action_type}:{},...e.target_type?{target_type:e.target_type}:{},...e.target_id?{target_id:e.target_id}:{},...e.focus_kind?{focus_kind:e.focus_kind}:{},...e.operation_id?{operation_id:e.operation_id}:{}}}function ul(e){const t=$v();if(e==="operations")return t;if(e==="chains"){const n=Ht.value;return n?{...t,surface:e,operation:n}:{...t,surface:e}}return{...t,surface:e}}function hv(){const e=new URLSearchParams(window.location.search),t=new URLSearchParams,n=e.get("agent")??e.get("agent_name"),s=e.get("token");return n&&t.set("agent",n),s&&t.set("token",s),t.toString()?`/api/v1/chains/events?${t.toString()}`:"/api/v1/chains/events"}function yv(e){switch(e){case"company":return"중대 / Company";case"platoon":return"소대 / Platoon";case"squad":return"분대 / Squad";case"agent":return"에이전트 / Agent";default:return e}}function ae(e){return ri.value===e}function Zn(){return zi.value}function bv(e){var a,o,l,c,u,m,v;const t=zi.value,n=St.value,s=Qn.value;switch(e){case"warroom":return{tool:"masc_observe_operations",reason:"live run, worker, message, trace를 한 화면에서 보고 필요한 detail 표면으로 바로 점프합니다."};case"operations":return{tool:"masc_operation_status",reason:`활성 작전 ${((a=t==null?void 0:t.operations.summary)==null?void 0:a.active)??0}개와 dependency를 먼저 확인합니다.`};case"swarm":return{tool:(n==null?void 0:n.recommended_next_tool)??((l=(o=t==null?void 0:t.swarm_status)==null?void 0:o.recommended_next_action)==null?void 0:l.tool)??"masc_observe_traces",reason:((u=(c=t==null?void 0:t.swarm_status)==null?void 0:c.recommended_next_action)==null?void 0:u.reason)??"lane 이동과 blocker를 보고 다음 probe 도구를 고릅니다."};case"chains":return{tool:(v=(m=s==null?void 0:s.operations[0])==null?void 0:m.preview_run)!=null&&v.chain_id?"masc_chain_run_get":"masc_chain_snapshot",reason:"체인 연결 상태와 최근 run 그래프를 함께 보면 병목을 빨리 좁힐 수 있습니다."};case"topology":return{tool:"masc_observe_topology",reason:"지휘 계층과 live roster를 같이 봐야 빈 squad나 고립 unit을 놓치지 않습니다."};case"alerts":return{tool:"masc_observe_alerts",reason:"경보에서 먼저 문제가 된 unit과 operation을 고릅니다."};case"trace":return{tool:"masc_observe_traces",reason:"trace 흐름으로 원인 이벤트를 바로 따라갈 수 있습니다."};case"control":return{tool:"masc_operator_action",reason:"승인이나 kill switch 같은 실제 조작은 control 표면과 operator action이 이어집니다."};case"summary":default:return{tool:"masc_observe_operations",reason:"요약을 본 뒤에는 현재 작전 표면으로 내려가 실제 움직임을 확인하는 게 가장 빠릅니다."}}}function kv(e){var n;const t=((n=e==null?void 0:e.focus_kind)==null?void 0:n.toLowerCase())??"";return t?t.includes("artifact_scope")||t.includes("routing_confidence")||t.includes("cache_contention")?"microarch":t.includes("leader_offline")||t.includes("roster_offline")?"alerts":t.includes("stale_data")?"swarm":null:null}function xv(e){var n;const t=((n=e==null?void 0:e.focus_kind)==null?void 0:n.toLowerCase())??"";return t?t.includes("stale_data")||t.includes("leader_offline")||t.includes("roster_offline")||t.includes("managed")?"recommendation":t.includes("gap")?"gaps":null:null}function Sv(){if(typeof window>"u")return null;const e=new URLSearchParams(window.location.search),t=e.get("agent")??e.get("agent_name");if(!t)return null;const n=t.trim();return n===""?null:n}function pl(){if(typeof window>"u")return new URLSearchParams;const e=new URLSearchParams(window.location.search),t=window.location.hash.replace(/^#/,""),n=t.indexOf("?");return n>=0&&new URLSearchParams(t.slice(n+1)).forEach((a,o)=>{e.has(o)||e.set(o,a)}),e}function Av(){const t=pl().get("run_id");if(!t)return null;const n=t.trim();return n===""?null:n}function ml(){const t=pl().get("operation_id");if(!t)return null;const n=t.trim();return n===""?null:n}function Cv(e){if(!e)return null;const t=Date.parse(e);return Number.isNaN(t)?null:Math.max(0,Math.round((Date.now()-t)/1e3))}function Iv(e){return e.status==="claimed"||e.status==="in_progress"}function Tv(e){const t=Vn.value;if(!t)return null;for(const n of t.golden_paths){const s=n.steps.find(a=>a.tool===e);if(s)return s}return null}function xa(e){var t;return((t=Vn.value)==null?void 0:t.golden_paths.find(n=>n.id===e))??null}function Rv(e){const t=Vn.value;if(!t)return[];const n=new Set(e);return t.pitfalls.filter(s=>n.has(s.id))}async function et(e){try{await e()}catch{}}function qi(e){return(e==null?void 0:e.trim().toLowerCase())??""}function Dt(e){const t=qi(e);return t.includes("failed")||t.includes("error")||t.includes("stopped")||t==="paused"?"bad":t.includes("active")||t.includes("running")||t.includes("healthy")||t.includes("ok")?"ok":"warn"}function Sa(e){const t=qi(e);return t?t==="active"||t==="running"?"진행 중":t==="paused"?"일시정지":t==="done"||t==="ended"||t==="completed"?"완료":t==="failed"||t==="error"||t==="stopped"?"문제":(e==null?void 0:e.trim())||"확인 필요":"확인 필요"}function Pv(){var t,n,s;const e=St.value;return e?!!(e.run_id||(t=e.operation)!=null&&t.operation_id||(n=e.detachment)!=null&&n.detachment_id||(((s=e.summary)==null?void 0:s.expected_workers)??0)>0||e.workers.length>0||e.recent_messages.length>0||e.recent_trace_events.length>0):!1}function wv(e){const t=qi(e.status);return t==="active"||t==="running"}function Lv(){var o,l,c,u;const e=((o=he.value)==null?void 0:o.sessions)??[],t=St.value,n=((l=t==null?void 0:t.detachment)==null?void 0:l.session_id)??null;if(n){const m=e.find(v=>v.session_id===n);if(m)return m}const s=((c=t==null?void 0:t.operation)==null?void 0:c.operation_id)??ml();if(s){const m=e.find(v=>v.command_plane_operation_id===s);if(m)return m}const a=((u=t==null?void 0:t.detachment)==null?void 0:u.detachment_id)??null;if(a){const m=e.find(v=>v.command_plane_detachment_id===a);if(m)return m}return e.find(wv)??e[0]??null}function Nv(e){return e==="proven"?"ok":e==="partial"?"warn":"bad"}function yn(e){return Array.isArray(e)?e:[]}function Mv({item:e}){return i`
  ...
  `}function Dv(){var f,g,h;const e=j.value.params,t=e.session_id??null,n=e.operation_id??null;ne(()=>{Jr(t,n)},[t,n]);const s=Gr.value;if(oi.value&&!s)return i`<section class="dashboard-panel"><div class="loading-indicator">Loading proof…</div></section>`;if(zt.value&&!s)return i`<section class="dashboard-panel"><div class="error-card">${zt.value}</div></section>`;const a=s==null?void 0:s.summary,o=yn(s==null?void 0:s.timeline),l=yn(s==null?void 0:s.actor_contributions),c=yn(s==null?void 0:s.artifacts),u=(s==null?void 0:s.proof_verdict)??"insufficient",m=(s==null?void 0:s.cp_backing_evidence)??null,v=Array.isArray((f=m==null?void 0:m.traces)==null?void 0:f.events)?((h=(g=m.traces)==null?void 0:g.events)==null?void 0:h.length)??0:0;return i`
    <section class="dashboard-panel mission-view">
      <${$e} surfaceId="proof" />
      <div class="panel-header">
        <div>
        ...
        <div class="mission-header-meta">
          <span class="command-chip ${Nv(u)}">${u}</span>
      ...
      <div class="mission-human-grid">
        <${I} title="Collaboration Timeline" class="mission-list-card" semanticId="proof.timeline">
          ...
          <div class="mission-list-stack">
            ${o.length>0?o.slice(0,24).map(k=>i`<${Mv} key=${k.id} item=${k} />`):i`<div class="empty-state">표시할 timeline evidence가 없습니다.</div>`}
          </div>
        <//>
        ...
        <${I} title="Actor Contributions" class="mission-list-card" semanticId="proof.contributions">
          ...
          <div class="mission-activity-list">
            ${l.length>0?l.map(k=>i`<${zv} key=${k.actor} item=${k} />`):i`<div class="empty-state">표시할 actor contribution이 없습니다.</div>`}
          </div>
        <//>
      </div>
      ...
      <div class="mission-human-grid">
        ...
        <${I} title="Artifacts" class="mission-list-card" semanticId="proof.artifacts">
          ...
          <div class="mission-list-stack">
            ${c.length>0?c.map(k=>i`<${Ev} key=${k.path} item=${k} />`):i`<div class="empty-state">기록된 artifact가 없습니다.</div>`}
          </div>
        <//>
      </div>
    </section>
  `}function jv(){const e=Jn(j.value);return e?i`
    <section class="command-focus-banner">
      <div class="command-focus-head">
        ...
        <span class="command-chip">${Pi(e)}</span>
        <span class="command-chip">${Gu(j.value.params.surface??"warroom")}</span>
      </div>
      <div class="command-focus-body">${e.summary}</div>
      ${e.payload_preview?i`<div class="command-focus-preview">${e.payload_preview}</div>`:null}
    </section>
  `:null}function Ov(){const e=X.value,t=gv[e],n=bv(e);return i`
    ...
    <section class="command-hero command-hero-summary">
      <div class="command-hero-copy">
        ...
        <span class="command-chip ${N(f>0?"ok":"warn")}">활성 작전 ${f}</span>
          ...
          <span class="command-chip ${N(A>0?"bad":T>0?"warn":"ok")}">치명 알림 ${A}</span>
  ...
  `}function Uv(){return i`
    <${qv} />
    <${Fv} />
    <${Kv} />
  `}function Bv(){return qs.value?i`<div class="empty-state">command-plane detail 불러오는 중…</div>`:Ks.value?i`<div class="empty-state error">${Ks.value}</div>`:i`<div class="empty-state">surface를 선택하면 command-plane detail을 로드합니다.</div>`}function vl({node:e,depth:t=0}){const n=e.roster_live??0,s=e.roster_total??e.unit.roster.length,a=e.active_operation_count??0,o=e.unit.policy;return i`
    <div class="command-tree-node depth-${Math.min(t,3)}">
      <div class="command-tree-head">
        <div>
          <div class="command-tree-title-row">
            <strong>${e.unit.label}</strong>
            <span class="command-chip">${yv(e.unit.kind)}</span>
  ...
  `}function Hv(){const e=Ee.value;return i`
    <section class="card command-section">
      <div class="card-title-row">
  ...
  `}function Gv(){const e=Ee.value;return i`
    <section class="card command-section">
      <div class="card-title-row">
      ...
      ${e&&e.alerts.alerts.length>0?i`<div class="command-card-stack">
            ${e.alerts.alerts.map(t=>i`<${Wv} alert=${t} />`)}
          </div>`:i`<div class="empty-state">지금 올라온 command-plane 경보는 없습니다.</div>`}
    </section>
  `}function Jv(){const e=Ee.value;return i`
    <section class="card command-section">
      <div class="card-title-row">
  ...
  `}function Vv({total:e}){const n=Math.min(e,20),s=e>20?e-20:0,a=Array.from({length:n});return i`
  ...
  `}function Qv({lane:e}){const t=e.counts??{},n=_l(e),s=t.workers??0,a=t.operations??0,o=t.detachments??0,l=a+o,c=e.motion_state==="moving"?84:e.motion_state==="waiting"?58:e.motion_state==="terminal"?100:26;return i`
  ...
  `}function gl({lanes:e}){const t=e.slice(0,4);return t.length===0?null:i`
    <div class="swarm-storyboard">
      ${t.map(n=>{const s=_l(n),a=n.counts.workers??0,o=n.counts.operations??0,l=n.counts.detachments??0;return i`
  ...
  `}function Yv({event:e}){const t=e.timestamp?new Date(e.timestamp):null,n=t&&!isNaN(t.getTime())?t:null,s=n?`${String(n.getHours()).padStart(2,"0")}:${String(n.getMinutes()).padStart(2,"0")}`:"";return i`
  ...
  `}function Zv({proof:e}){const t=(e==null?void 0:e.status)==="missing"?"warn":(e==null?void 0:e.pass)===!1?"bad":(e==null?void 0:e.pass)===!0?"ok":"warn";return i`
  ...
  `}function e_(){const e=Zn(),t=Jn(j.value),n=xv(t),s=e==null?void 0:e.swarm_status,a=e==null?void 0:e.swarm_proof,o=(s==null?void 0:s.lanes.filter(f=>f.present))??[],l=(s==null?void 0:s.gaps.items)??[],c=(s==null?void 0:s.timeline.slice(0,8))??[],u=s==null?void 0:s.overview,m=s==null?void 0:s.recommended_next_action,v=o.length<=1;return i`
    <section class="card command-section">
      ...
      ${s?i`
            ...
            ${o.length>0?i`<${fl} lanes=${o} />`:null}

            <div class="command-swarm-layout ${v?"compact":""}">
              <div class="command-card-stack">
                ${o.length>0?o.map(f=>i`<${Qv} lane=${f} />`):i`<div class="empty-state">활성 스웜 레인이 없습니다.</div>`}
              </div>
              ...
              <div class="command-card-stack">
                ...
                <div class="command-guide-card ${l.length>0?"warn":"ok"} ${n==="gaps"?"focus":""}">
                  ...
                  ${l.length>0?i`<div class="swarm-event-rail">${l.slice(0,4).map(f=>i`<${Xv} gap=${f} />`)}</div>`:i`<p>지금 보이는 핵심 공백은 없습니다.</p>`}
                </div>
                ...
                <div class="command-guide-card">
                  ...
                  ${c.length>0?i`<div class="swarm-event-rail">${c.map(f=>i`<${Yv} event=${f} />`)}</div>`:i`<p>붙어 있는 최근 이동 이벤트가 아직 없습니다.</p>`}
                </div>
              </div>
            </div>
  ...
  `}function s_(){var u,m,v,f,g,h,k,$,C,A,T,x,R,P,E,G,D,te,se,H,Z;const e=St.value,t=Av(),n=ml(),s=(u=e==null?void 0:e.provider)!=null&&u.runtime_blocker?"blocked":(m=e==null?void 0:e.provider)!=null&&m.provider_reachable?"ready":"check",a=((v=e==null?void 0:e.provider)==null?void 0:v.actual_slots)??((f=e==null?void 0:e.provider)==null?void 0:f.total_slots)??0,o=((g=e==null?void 0:e.provider)==null?void 0:g.expected_slots)??"n/a",l=((h=e==null?void 0:e.provider)==null?void 0:h.actual_ctx)??((k=e==null?void 0:e.provider)==null?void 0:k.ctx_per_slot)??0,c=(($=e==null?void 0:e.provider)==null?void 0:$.expected_ctx)??"n/a";return i`
      ...
      <div class="command-surface-grid">
        ...
        <section class="card command-section">
          ...
          ${e&&e.blockers.length>0?i`<div class="command-card-stack">
                ${e.blockers.map(S=>i`<${$l} blocker=${S} />`)}
  ...
  `}function He({label:e,surface:t,params:n={}}){return i`
    <button
      ...
      onClick=${()=>{if(t){yt(t),ue("command",{...ul(t),...n});return}ue("intervene")}}
    >
      ${e}
    </button>
  `}function r_(){var G,D,te,se,H,Z,S,Se,Be,lt,ct,O,Ae,dt,ln,cn,es,ts,ns,ss;const e=Zn(),t=St.value,n=he.value,s=Ne.value,a=Lv(),o=t!=null&&t.operation?((G=Qn.value)==null?void 0:G.operations.find(K=>{var Ct;return K.operation.operation_id===((Ct=t.operation)==null?void 0:Ct.operation_id)}))??null:null,l=(t==null?void 0:t.workers)??[],c=(s==null?void 0:s.worker_cards)??[],u=l.length>0?l.map(a_):c.map(i_),m=Pv(),v=((D=e==null?void 0:e.decisions.summary)==null?void 0:D.pending)??0,f=(n==null?void 0:n.pending_confirms)??[],g=(t==null?void 0:t.blockers)??[],h=(s==null?void 0:s.recommended_actions)??[],k=(s==null?void 0:s.attention_items)??[],$=((te=t==null?void 0:t.recent_messages[0])==null?void 0:te.timestamp)??null,C=((se=t==null?void 0:t.recent_trace_events[0])==null?void 0:se.timestamp)??null,A=$??C??null,T=a==null?void 0:a.summary,x=((H=t==null?void 0:t.summary)==null?void 0:H.expected_workers)??(typeof(T==null?void 0:T.planned_worker_count)=="number"?T.planned_worker_count:void 0)??(s==null?void 0:s.worker_cards.length)??0,R=((Z=t==null?void 0:t.summary)==null?void 0:Z.joined_workers)??(typeof(T==null?void 0:T.active_agent_count)=="number"?T.active_agent_count:void 0)??u.length,P=g.length>0||v>0||f.length>0?"warn":m||a?"ok":"warn",E=((S=e==null?void 0:e.swarm_status)==null?void 0:S.lanes.filter(K=>K.present))??[];return ne(()=>{ge()},[]),ne(()=>{a!=null&&a.session_id&&Zt(a.session_id)},[a==null?void 0:a.session_id,n,(Se=t==null?void 0:t.detachment)==null?void 0:Se.session_id]),!m&&!a?Ws.value||Ln.value?i`<div class="empty-state">live war room 불러오는 중…</div>`:i`
      ...
      <div class="command-warroom-grid">
                ...
                `:a?i`
                    <article class="command-guide-card">
                      <div class="command-guide-head">
                        ...
                        <span class="command-chip ${N(Dt(a.status))}">${Sa(a.status)}</span>
                      </div>
          ...
          <section class="card command-section">
            ...
            ${t&&t.recent_messages.length>0?i`<div class="command-trace-stack">
                  ...
                  `)}
                    ...
                    ${h.slice(0,4).map(K=>i`
                      <article class="command-guide-card ${$o(K)}">
                        <div class="command-guide-head">
                          <strong>${K.action_type}</strong>
                          <span class="command-chip ${$o(K)}">${K.target_type}</span>
                        </div>
                        <p>${K.reason}</p>
                      </article>
                    `)}
                    ...
                    `)}
                      ...
                      ${a.recent_events.slice(0,6).map((K,Ct)=>i`
                        <article class="command-trace-row">
                          <div class="command-trace-main">
                            <div class="command-trace-head">
                          ...
                          <pre class="command-trace-detail">${Vs(K)}</pre>
                        </article>
                      `)}
        ...
        <div class="command-warroom-column">
          <section class="card command-section">
            ...
            <div class="command-card-stack">
              ${g.length>0?g.map(K=>i`<${$l} blocker=${K} />`):i`<div class="command-guide-card ok"><p>지금 보이는 blocker는 없습니다.</p></div>`}
              ${v>0?i`
              ...
              ${t!=null&&t.operation?i`
                    <article class="command-card compact">
                      <div class="command-card-head">
                        ...
                        <span class="command-chip ${N(Dt(t.operation.status))}">${t.operation.status}</span>
                      </div>
                      <div class="command-card-grid">
              ...
              ${t!=null&&t.detachment?i`
                    <article class="command-card compact">
                      <div class="command-card-head">
                        ...
                        <span class="command-chip ${N(Dt(t.detachment.status))}">${t.detachment.status??"active"}</span>
                      </div>
                      <div class="command-card-grid">
                        ...
                        <span>Heartbeat</span><span>${ll(t.detachment.heartbeat_deadline)}</span>
                      </div>
                    </article>
                  `:null}
              ${a?i`
  ...
  `}function l_({source:e}){const t=Wl(null),[n,s]=zo(null);return ne(()=>{let a=!1;const o=t.current;return o?(o.innerHTML="",s(null),(async()=>{try{const c=await pv(),{svg:u}=await c.render(`command-chain-${uv()}`,e);if(a||!t.current)return;t.current.innerHTML=u}catch(c){if(a)return;s(c instanceof Error?c.message:"Mermaid render failed")}})(),()=>{a=!0,t.current&&(t.current.innerHTML="")}):void 0},[e]),i`
    <div class="command-chain-graph-shell">
      ${n?i`<div class="empty-state error">${n}</div>`:null}
      <div class="command-chain-graph" ref=${t}></div>
    </div>
  `}function c_({overlay:e,selected:t,onSelect:n}){const s=e.operation.chain,a=e.runtime;return i`
    <button class="command-chain-item ${t?"selected":""}" onClick=${n}>
      ...
      <div class="command-card-sub">${cl(e.history)}</div>
    </button>
  `}function d_({item:e}){return i`
    <article class="command-chain-history-row">
      ...
      <div class="command-card-sub">${cl(e)}</div>
    </article>
  `}function u_({node:e}){return i`
    ...
    <article class="command-card">
      ...
      <div class="command-action-row">
        ...
        ${t.source==="managed"&&t.status==="active"?i`
              <button class="control-btn ghost" disabled=${ae(n)} onClick=${()=>et(()=>tv(t.operation_id))}>
                ${ae(n)?"Pausing…":"Pause"}
              </button>
              <button class="control-btn ghost" disabled=${ae(a)} onClick=${()=>et(()=>sv(t.operation_id))}>
                ${ae(a)?"Recalling…":"Recall"}
              </button>
            `:null}
        ${t.source==="managed"&&t.status==="paused"?i`
              <button class="control-btn ghost" disabled=${ae(s)} onClick=${()=>et(()=>nv(t.operation_id))}>
                ${ae(s)?"Resuming…":"Resume"}
              </button>
            `:null}
      </div>
    </article>
  `}function m_({card:e}){var n;const t=e.detachment;return i`
    <article class="command-card compact">
      <div class="command-card-head">
        <div>
      ...
      <div class="command-card-grid">
        ...
        <span>Heartbeat</span><span>${ll(t.heartbeat_deadline)}</span>
        <span>Updated</span><span>${V(t.updated_at)}</span>
      </div>
      <div class="command-tag-row">
        ${t.heartbeat_deadline?i`<span class="command-tag ${cv(t.heartbeat_deadline)}">
      ...
      <section class="card command-section">
                ...
                <div class="command-chain-list">
                  ${t.map(G=>i`
                    <${c_}
                      ...
                      onSelect=${()=>ji(G.operation.operation_id)}
                    />
                  `)}
                </div>
        ...
        <div class="command-chain-history">
          ...
          ${e&&e.recent_history.length>0?i`
                <div class="command-card-stack">
                  ${e.recent_history.slice(0,6).map(G=>i`<${d_} item=${G} />`)}
                </div>
  ...
  `}function f_({decision:e}){const t=`approve:${e.decision_id}`,n=`deny:${e.decision_id}`,s=e.source==="projected_operator";return i`
    <article class="command-card ${N(e.status)}">
      ...
      ${e.status==="pending"&&!s?i`
            <div class="command-action-row">
              <button class="control-btn ghost" disabled=${ae(t)} onClick=${()=>et(()=>iv(e.decision_id))}>
                ${ae(t)?"Approving…":"Approve"}
              </button>
              <button class="control-btn ghost" disabled=${ae(n)} onClick=${()=>et(()=>ov(e.decision_id))}>
                ${ae(n)?"Denying…":"Deny"}
              </button>
            </div>
          `:null}
  ...
  `}function g_({row:e}){var c,u,m;const t=e.unit,n=`freeze:${t.unit_id}`,s=`kill:${t.unit_id}`,a=!!((c=t.policy)!=null&&c.frozen),o=!!((u=t.policy)!=null&&u.kill_switch),l=Math.round((e.utilization??0)*100);return i`
    <article class="command-card compact">
      <div class="command-card-head">
        <div>
      ...
      <div class="command-action-row">
        <button class="control-btn ghost" disabled=${ae(n)} onClick=${()=>et(()=>rv(t.unit_id,!a))}>
          ${ae(n)?"Applying…":a?"Unfreeze":"Freeze"}
        </button>
        <button class="control-btn ghost" disabled=${ae(s)} onClick=${()=>et(()=>lv(t.unit_id,!o))}>
          ${ae(s)?"Applying…":o?"Clear Kill Switch":"Enable Kill Switch"}
        </button>
      </div>
    </article>
  `}function $_(){const e=Ee.value;return i`
    <div class="command-surface-grid">
      <section class="card command-section">
        <div class="card-title-row">
        ...
        ${e&&e.decisions.decisions.length>0?i`<div class="command-card-stack">
              ${e.decisions.decisions.map(t=>i`<${f_} decision=${t} />`)}
      ...
      <section class="card command-section">
        ...
        ${e&&e.capacity.capacity.length>0?i`<div class="command-card-stack">
              ${e.capacity.capacity.map(t=>i`<${g_} row=${t} />`)}
      ...
      ${vv.map(e=>i`
        <div class="command-tab-group" key=${e.id}>
          ...
          <div class="command-tab-group-items">
            ${dl.filter(t=>t.group===e.id).map(t=>i`
                <button
                  class="command-surface-tab ${X.value===t.id?"active":""}"
                  onClick=${()=>{yt(t.id),ue("command",ul(t.id))}}
                >
                  ${t.label}
                </button>
              `)}
  ...
  `}function y_(){if(X.value==="warroom")return i`<${r_} />`;if(X.value==="summary")return i`<${Uv} />`;if(X.value==="swarm")return i`<${s_} />`;if(!Ee.value)return i`<${Bv} />`;switch(X.value){case"chains":return i`<${__} />`;case"topology":return i`<${Hv} />`;case"alerts":return i`<${Gv} />`;case"trace":return i`<${Jv} />`;case"control":return i`<${$_} />`;case"operations":default:return i`<${v_} />`}}function b_(){return ne(()=>{Et(),Gt(),ev(),Ve()},[]),ne(()=>{if(j.value.tab!=="command")return;const e=j.value.params.surface,t=j.value.params.operation,n=Jn(j.value);if(go(e))yt(e);else if(n){const s=Ir(n);go(s)&&yt(s)}else e||yt("warroom");t&&ji(t),(e==="swarm"||e==="warroom"||X.value==="warroom")&&Ve(),(e==="warroom"||X.value==="warroom")&&ge()},[j.value.tab,j.value.params.surface,j.value.params.operation,j.value.params.operation_id,j.value.params.run_id,j.value.params.source,j.value.params.action_type,j.value.params.target_type,j.value.params.target_id,j.value.params.focus_kind]),ne(()=>{let e=null;const t=()=>{e||(e=window.setTimeout(()=>{e=null,Et(),Gt(),(X.value==="swarm"||X.value==="warroom")&&Ve(),X.value==="warroom"&&ge()},250))},n=new EventSource(hv()),s=fv.map(a=>{const o=()=>t();return n.addEventListener(a,o),{type:a,handler:o}});return n.onerror=()=>{t()},()=>{s.forEach(({type:a,handler:o})=>{n.removeEventListener(a,o)}),n.close(),e&&window.clearTimeout(e)}},[]),ne(()=>{const e=window.setInterval(()=>{if(document.visibilityState==="hidden")return;const t=X.value;t!=="swarm"&&t!=="warroom"||(Et(),Ve(),t==="warroom"&&ge())},5e3);return()=>{window.clearInterval(e)}},[]),i`
    <section class="dashboard-panel command-plane-view">
      <div class="panel-header">
        ...
        <div class="panel-actions">
          ...
          <button
            class="control-btn ghost"
            onClick=${()=>{Et(),Gt(),Ve(),X.value==="warroom"&&ge()}}
            disabled=${Os.value}
          >
      ...
      <${$e} surfaceId="command" />
      <${jv} />
      ${X.value==="warroom"?null:i`<${Ov} />`}
      <${h_} />
      <${y_} />
    </section>
  `}const hl="masc_dashboard_agent_name";function k_(){var t,n,s;const e=new URLSearchParams(window.location.search);return((t=e.get("agent"))==null?void 0:t.trim())||((n=e.get("agent_name"))==null?void 0:n.trim())||((s=localStorage.getItem(hl))==null?void 0:s.trim())||"dashboard"}const va=_(k_()),Jt=_(""),di=_("운영 점검"),Vt=_(""),En=_(""),Dn=_("2"),en=_(""),Pe=_("note"),jn=_(""),On=_(""),qn=_(""),Fn=_("2"),Qs=_("운영자 중지 요청"),Ys=_(""),Qt=_(""),ls=_(null);function x_(e){const t=e.trim()||"dashboard";va.value=t,localStorage.setItem(hl,t)}function yl(e){if(e==null)return"";if(typeof e=="string")return e;try{return JSON.stringify(e,null,2)}catch{return String(e)}}function S_(e){return typeof e!="number"||!Number.isFinite(e)?"확인 없음":e<60?`${Math.round(e)}초 전`:e<3600?`${Math.round(e/60)}분 전`:`${Math.round(e/3600)}시간 전`}function tn(e){return typeof e=="string"?e.trim().toLowerCase():""}function A_(e){var s;const t=tn(e.status);if(t==="paused")return"bad";if(t===""||t==="unknown")return"warn";const n=tn((s=e.team_health)==null?void 0:s.status);return n&&n!=="ok"&&n!=="healthy"&&n!=="green"||t&&t!=="active"&&t!=="running"&&t!=="ended"?"warn":"ok"}function Aa(e){const t=tn(e.status);return t==="offline"||t==="inactive"||t==="error"?"bad":t===""||t==="unknown"||(e.context_ratio??0)>=.8||e.context_ratio==null||e.last_turn_ago_s==null||(e.last_turn_ago_s??0)>=3600?"warn":"ok"}function ho(e){return e.some(t=>tn(t.severity)==="bad")?"bad":e.length>0?"warn":"ok"}function C_(e){return e.target_type==="team_session"}function I_(e){return e.target_type==="keeper"}function Xs(e){switch(e){case"broadcast":return"방송";case"room_pause":return"room 일시정지";case"room_resume":return"room 재개";case"team_turn":return"세션 업데이트";case"team_note":return"세션 노트";case"team_broadcast":return"세션 방송";case"team_task_inject":return"세션 작업 주입";case"task_inject":return"작업 주입";case"team_stop":return"세션 중지";case"keeper_message":return"keeper 메시지";case"keeper_msg":return"keeper 메시지";default:return(e==null?void 0:e.trim())||"액션"}}function Zs(e){switch(e){case"room":return"room";case"team_session":return"session";case"keeper":return"keeper";default:return(e==null?void 0:e.trim())||"target"}}function _n(e){switch(tn(e)){case"running":case"active":return"진행 중";case"paused":return"일시정지";case"ended":case"done":return"종료";case"offline":return"오프라인";case"idle":return"대기";case"unknown":case"":return"확인 필요";default:return(e==null?void 0:e.trim())||"확인 필요"}}function bl(e){return e?"확인 후 실행":"즉시 실행"}function T_(e){switch(e){case"note":return"노트";case"broadcast":return"방송";case"task":return"작업";default:return e}}function pe(e,t){if(!e)return null;const n=e[t];return typeof n=="string"&&n.trim()!==""?n.trim():typeof n=="number"&&Number.isFinite(n)?String(n):null}function R_(e){if(e.action_type==="team_task_inject")return"task";if(e.action_type==="team_broadcast")return"broadcast";if(e.action_type==="team_note")return"note";if(e.action_type==="team_turn"){const t=pe(e.suggested_payload,"turn_kind");if(t==="broadcast"||t==="task")return t}return"note"}function P_(e){const t=e.suggested_payload;if(e.target_type==="room"){if(e.action_type==="broadcast"){Jt.value=pe(t,"message")??e.summary;return}e.action_type==="task_inject"&&(Vt.value=pe(t,"title")??"운영자 주입 작업",En.value=pe(t,"description")??e.summary,Dn.value=pe(t,"priority")??Dn.value);return}if(e.target_type==="team_session"){if(e.target_id&&(en.value=e.target_id),e.action_type==="team_stop"){Qs.value=pe(t,"reason")??e.summary;return}Pe.value=R_(e);const n=pe(t,"message");n&&(jn.value=n),Pe.value==="task"&&(On.value=pe(t,"task_title")??pe(t,"title")??"운영자 주입 작업",qn.value=pe(t,"task_description")??pe(t,"description")??e.summary,Fn.value=pe(t,"task_priority")??pe(t,"priority")??Fn.value);return}e.target_type==="keeper"&&(e.target_id&&(Ys.value=e.target_id),Qt.value=pe(t,"message")??e.summary)}function w_(e,t,n){return!e||!e.target_type||e.target_type==="room"?!0:e.target_type==="team_session"?!!e.target_id&&t.some(s=>s.session_id===e.target_id):e.target_type==="keeper"?!!e.target_id&&n.some(s=>s.name===e.target_id):!0}async function At(e){const t=va.value.trim()||"dashboard";try{const n=await Tp({actor:t,action_type:e.action_type,target_type:e.target_type,target_id:e.target_id,payload:e.payload});return n.confirm_required?w("확인 대기열에 올렸습니다","warning"):w(e.successMessage,"success"),n}catch(n){const s=n instanceof Error?n.message:"개입 실행에 실패했습니다";return w(s,"error"),null}}async function yo(){const e=Jt.value.trim();if(!e)return;await At({action_type:"broadcast",target_type:"room",payload:{message:e},successMessage:"방송을 보냈습니다"})&&(Jt.value="")}async function L_(){await At({action_type:"room_pause",target_type:"room",payload:{reason:di.value.trim()||"운영 점검"},successMessage:"room 일시정지를 요청했습니다"})}async function kl(){await At({action_type:"room_resume",target_type:"room",payload:{},successMessage:"room 재개를 요청했습니다"})}async function N_(){const e=Vt.value.trim();if(!e)return;await At({action_type:"task_inject",target_type:"room",payload:{title:e,description:En.value.trim()||"Intervene 화면에서 주입",priority:Number.parseInt(Dn.value,10)||2},successMessage:"작업 주입을 보냈습니다"})&&(Vt.value="",En.value="")}async function M_(){var l;const e=he.value,t=en.value||((l=e==null?void 0:e.sessions[0])==null?void 0:l.session_id)||"";if(!t){w("먼저 세션을 고르세요","warning");return}const n={},s=jn.value.trim();s&&(n.message=s);let a="team_note";Pe.value==="broadcast"?a="team_broadcast":Pe.value==="task"&&(a="team_task_inject"),Pe.value==="task"&&(n.task_title=On.value.trim()||"운영자 주입 작업",n.task_description=qn.value.trim()||"Intervene 화면에서 주입",n.task_priority=Number.parseInt(Fn.value,10)||2),await At({action_type:a,target_type:"team_session",target_id:t,payload:n,successMessage:"세션 액션을 적용했습니다"})&&(jn.value="",Pe.value==="task"&&(On.value="",qn.value=""))}async function z_(){var n;const e=he.value,t=en.value||((n=e==null?void 0:e.sessions[0])==null?void 0:n.session_id)||"";if(!t){w("먼저 세션을 고르세요","warning");return}await At({action_type:"team_stop",target_type:"team_session",target_id:t,payload:{reason:Qs.value.trim()||"운영자 중지 요청"},successMessage:"세션 중지를 요청했습니다"})}async function E_(){var a;const e=he.value,t=Ys.value||((a=e==null?void 0:e.keepers[0])==null?void 0:a.name)||"",n=Qt.value.trim();if(!t){w("먼저 keeper를 고르세요","warning");return}if(!n)return;await At({action_type:"keeper_message",target_type:"keeper",target_id:t,payload:{message:n},successMessage:`${t}에게 메시지를 보냈습니다`})&&(Qt.value="")}async function D_(e){const t=va.value.trim()||"dashboard";try{await Rp(t,e),w("확인 실행을 완료했습니다","success")}catch(n){const s=n instanceof Error?n.message:"확인 실행에 실패했습니다";w(s,"error")}}function j_(){const e=he.value,t=Ni.value,n=(e==null?void 0:e.room)??{},s=(e==null?void 0:e.pending_confirms)??[],a=(e==null?void 0:e.recent_messages)??[],o=(t==null?void 0:t.recommended_actions)??[],l=a.slice(0,5);return i`
      ...
      <section class="card ops-panel ops-lane-panel">
        ...
        <div class="control-row">
          <input
            ...
            disabled=${Q.value}
          />
          <button class="control-btn" onClick=${()=>{yo()}} disabled=${Q.value||Jt.value.trim()===""}>
            보내기
          </button>
        </div>
        ...
        <div class="control-row ops-split-row">
          <input
            ...
            disabled=${Q.value}
          />
          <button class="control-btn ghost" onClick=${()=>{L_()}} disabled=${Q.value}>
            일시정지
          </button>
          <button class="control-btn ghost" onClick=${()=>{kl()}} disabled=${Q.value}>
            재개
          </button>
        </div>
        ...
        <div class="control-row ops-split-row">
          ...
          <button class="control-btn" onClick=${()=>{N_()}} disabled=${Q.value||Vt.value.trim()===""}>
            주입
          </button>
        </div>
      </section>
            ...
            ${o.map(c=>i`
              <article key=${`${c.action_type}:${c.target_type}:${c.target_id??"room"}`} class="ops-log-entry ${c.severity}">
                <div class="ops-log-head">
                  ...
                  <span>${bl(c.confirm_required)}</span>
                </div>
          ...
          <div class="ops-confirmation-list">
            ${s.map(c=>i`
              <article key=${c.confirm_token} class="ops-confirmation-card">
                ...
                ${c.preview?i`<pre class="ops-code-block compact">${yl(c.preview)}</pre>`:null}
                <div class="ops-confirmation-actions">
                  <button class="control-btn" onClick=${()=>{D_(c.confirm_token)}} disabled=${Q.value}>
                    실행
                  </button>
  ...
  `}function O_(){const e=he.value,t=Ne.value,n=(e==null?void 0:e.sessions)??[],s=n.find(a=>a.session_id===en.value)??n[0]??null;return i`
    <div class="ops-column">
      <section class="card ops-panel ops-lane-panel">
        <div class="card-title-row">
      ...
      <section class="card ops-panel ops-lane-panel">
        ...
        ${s?i`
          <div class="ops-detail-card">
            ...
            ${s.recent_events&&s.recent_events.length>0?i`
              <pre class="ops-code-block compact">${yl(s.recent_events.slice(-3))}</pre>
            `:null}
          </div>
        ...
        <div class="control-row ops-split-row">
          ...
          <button class="control-btn" onClick=${()=>{M_()}} disabled=${Q.value||!s}>
            적용
          </button>
        </div>
        <div class="ops-context-note">현재 선택: ${T_(Pe.value)}</div>
        ...
        <div class="control-row ops-split-row">
          <input
            ...
            disabled=${Q.value||!s}
          />
          <button class="control-btn ghost" onClick=${()=>{z_()}} disabled=${Q.value||!s}>
            세션 중지
          </button>
        </div>
      </section>
    </div>
  `}function q_(){var a;const e=he.value,t=(e==null?void 0:e.keepers)??[],n=(e==null?void 0:e.available_actions)??[],s=t.find(o=>o.name===Ys.value)??t[0]??null;return i`
    <div class="ops-column">
          ...
          ${t.length===0?i`<div class="ops-empty">지금 보이는 keeper가 없습니다.</div>`:t.map(o=>i`
            ...
            >
              ...
              <div class="ops-entity-meta">
                ...
                <span>${S_(o.last_turn_ago_s)}</span>
              </div>
            </button>
          `)}
        </div>
      ...
      <section class="card ops-panel ops-lane-panel">
        ...
        ></textarea>
        <div class="control-row">
          <button class="control-btn" onClick=${()=>{E_()}} disabled=${Q.value||!s||Qt.value.trim()===""}>
            keeper에 보내기
          </button>
        </div>
      </section>
          ...
          ${n.length?n.map(o=>i`
                <article key=${`${o.action_type}:${o.target_type}`} class="ops-log-entry">
                  <div class="ops-log-head">
                    ...
                    <span>${bl(o.confirm_required)}</span>
                  </div>
      ...
      <div class="ops-header card">
        ...
        <div class="ops-toolbar">
          ...
          <input
            ...
            type="text"
            value=${va.value}
            onInput=${A=>x_(A.target.value)}
          />
          <button
            class="control-btn ghost"
            onClick=${()=>{ge(),kt(),Zt((c==null?void 0:c.session_id)??null)}}
  ...
  `}function K_({text:e}){if(!e)return null;const t=U_(e);return i`<div class="markdown-content">${t}</div>`}function U_(e){const t=e.split(`
...
`))}</p>`)}return n}function Ca(e){const t=[],n=/(`[^`]+`)|(\*\*[^*]+\*\*)|(\*[^*]+\*)|\[([^\]]+)\]\(([^)]+)\)/g;let s=0,a;for(;(a=n.exec(e))!==null;){if(a.index>s&&t.push(e.slice(s,a.index)),a[1]){const o=a[1].slice(1,-1);t.push(i`<code>${o}</code>`)}else if(a[2]){const o=a[2].slice(2,-2);t.push(i`<strong>${o}</strong>`)}else if(a[3]){const o=a[3].slice(1,-1);t.push(i`<em>${o}</em>`)}else a[4]&&a[5]&&t.push(i`<a href=${a[5]} target="_blank" rel="noopener">${a[4]}</a>`);s=a.index+a[0].length}return s<e.length&&t.push(e.slice(s)),t.length>0?t:[e]}const xl=[{id:"recent",label:"Latest"},{id:"hot",label:"Hot"},{id:"trending",label:"Trending"},{id:"updated",label:"Updated"},{id:"discussed",label:"Discussed"}],ks=_(null),xs=_([]),nn=_(!1),ht=_(null),bn=_(""),kn=_(!1),jt=_(!0),Ki=20,wt=_(Ki);function B_(){var t,n;const e=new URLSearchParams(window.location.search);return((t=e.get("agent"))==null?void 0:t.trim())||((n=e.get("agent_name"))==null?void 0:n.trim())||"dashboard-user"}const W_=_(B_());function H_(e){const t=e.replace(/!\[[^\]]*\]\([^)]+\)/g," ").replace(/\[[^\]]+\]\([^)]+\)/g,"$1").replace(/[`#>*_~-]/g," ").replace(/\s+/g," ").trim();return t?t.length>180?`${t.slice(0,177)}...`:t:"No preview available"}function bo(e){return e.updated_at!==e.created_at}function G_(e){const t=`${e.title} ${e.author} ${e.tags.join(" ")} ${e.flair??""}`.toLowerCase();return/\b(test|smoke|harness|sandbox|dummy|sample|tmp|qa|e2e)\b/.test(t)||t.includes("테스트")||t.includes("실험")}function J_(e){if(e.post_kind)return e.post_kind==="automation";const t=(e.hearth??"").toLowerCase();return e.visibility!=="internal"||!e.expires_at||!t?!1:!!(t.startsWith("mdal")||t.includes("harness"))}function Sl(e){return jt.value?e.filter(t=>J_(t)?!1:t.post_kind||t.hearth||t.visibility||t.expires_at?!0:!G_(t)):e}async function Ui(e){ht.value=e,ks.value=null,xs.value=[],nn.value=!0;try{const t=await Oc(e);if(ht.value!==e)return;ks.value={id:t.id,author:t.author,title:t.title,content:t.content,tags:t.tags,votes:t.votes,vote_balance:t.vote_balance,comment_count:t.comment_count,created_at:t.created_at,updated_at:t.updated_at,post_kind:t.post_kind,flair:t.flair,hearth:t.hearth,visibility:t.visibility,expires_at:t.expires_at,hearth_count:t.hearth_count},xs.value=t.comments??[]}catch{ht.value===e&&(ks.value=null,xs.value=[])}finally{ht.value===e&&(nn.value=!1)}}async function ko(e){const t=bn.value.trim();if(t){kn.value=!0;try{await qc(e,W_.value,t),bn.value="",w("Comment posted","success"),await Ui(e),Ye()}catch{w("Failed to post comment","error")}finally{kn.value=!1}}}function V_(){const e=In.value,t=jt.value?"Hiding automation posts":"Show automation posts";return i`
    <div class="board-toolbar">
      <div class="board-controls">
        ${xl.map(n=>i`
          <button
            class="board-sort-btn ${e===n.id?"active":""}"
            onClick=${()=>{In.value=n.id,wt.value=Ki,Ye()}}
          >
            ${n.label}
          </button>
        `)}
  ...
  `}function Ia(){var s;const e=((s=xl.find(a=>a.id===In.value))==null?void 0:s.label)??In.value,t=Sl(Cn.value),n=Cn.value.length-t.length;return i`
  ...
  `}function Q_({post:e}){const t=async(n,s)=>{s.stopPropagation();try{await Xo(e.id,n),Ye()}catch{w("Failed to vote","error")}};return i`
    <div class="board-post" onClick=${()=>Ql(e.id)}>
      ...
      <div class="post-content">
        ...
        <div class="post-snippet">${H_(e.content)}</div>
      </div>
    </div>
  `}function Y_({comments:e}){return e.length===0?i`<div class="empty-state" style="font-size:13px">No comments yet</div>`:i`
  ...
  `}function Z_({post:e}){ht.value!==e.id&&!nn.value&&Ui(e.id);const t=async n=>{try{await Xo(e.id,n),Ye()}catch{w("Failed to vote","error")}};return i`
    <div>
      ...
      <${I} title="Comments" semanticId="memory.feed">
        ${nn.value?i`<div class="loading-indicator">Loading comments...</div>`:i`<${Y_} comments=${xs.value} />`}
        <${X_} postId=${e.id} />
      <//>
    </div>
  `}function ef(){const e=Sl(Cn.value),t=j.value.params.post??null,n=t?e.find(s=>s.id===t)??(ht.value===t?ks.value:null):null;return t&&!n&&ht.value!==t&&!nn.value&&Ui(t),t?n?i`
          <${$e} surfaceId="memory" />
          <${Ia} />
          <${Z_} post=${n} />
        `:i`
      ...
      ${Tn.value?i`<div class="loading-indicator">Loading memory feed...</div>`:e.length===0?i`<div class="empty-state">No posts in durable memory right now</div>`:i`
              <${I} title="Posts / Comments" class="section" semanticId="memory.feed">
                <div class="board-post-list">
                  ${e.slice(0,wt.value).map(s=>i`<${Q_} key=${s.id} post=${s} />`)}
                </div>
                ${e.length>wt.value?i`
                  <div style="text-align:center; padding:12px 0;">
                    <button
                      class="control-btn ghost"
                      onClick=${()=>{wt.value=wt.value+Ki}}
                    >
                      Show more (${e.length-wt.value} remaining)
                    </button>
                  </div>
                `:null}
              <//>
  ...
  `}function tf({ratio:e,size:t=40,stroke:n=4}){if(e==null)return null;const s=(t-n)/2,a=t/2,o=2*Math.PI*s,l=o*((100-e*100)/100);let c="mitosis-safe";return e>=.8?c="mitosis-critical":e>=.5&&(c="mitosis-warn"),i`
  ...
  `}const vt=_(null),De=_(null),je=_(null);function _a(e){return e==="bad"||e==="critical"||e==="offline"?"bad":e==="warn"||e==="paused"||e==="blocked"||e==="interrupted"?"warn":"ok"}function nf(e){return typeof e!="number"||Number.isNaN(e)?"—":`${Math.round(e*100)}%`}function sf(e){return e?Ue.value.find(t=>t.name===e||t.agent_name===e)??null:null}function af(e){switch(e){case"working":return"작업 중";case"watching":return"대기 중";case"quiet":return"조용함";case"offline":return"오프라인"}}function of(e){switch(e){case"critical":return"위험";case"warning":return"주의";default:return"정상"}}function xo(e){if(!e)return;const t=Uu({targetType:e.target_type,targetId:e.target_id,focusKind:e.focus_kind,operationId:e.operation_id??null,commandSurface:e.command_surface??null,sourceLabel:"Execution 진단",summary:e.label});Ar(t),ue(e.surface,e.surface==="intervene"?Cr(t):Tr(t))}function Rt({label:e,value:t,color:n,caption:s}){return i`
    <div class="stat-card">
  ...
  `}function rf({item:e,selected:t}){return i`
    <button
  ...
  `}function lf({brief:e,selected:t}){return i`
    <button
      class="mission-card-select ${t?"active":""}"
  ...
  `}function cf({brief:e,selected:t}){return i`
    <button
      class="mission-card-select ${t?"active":""}"
  ...
  `}function So({row:e,testId:t}){return i`
    <button class="monitor-row ${e.tone} state-${e.state}" data-testid=${t} onClick=${()=>wn(e.name)}>
      <div class="monitor-row-header">
        ...
        <span class="monitor-pill ${e.tone} state-${e.state}">${af(e.state)}</span>
      </div>
  ...
  `}function df({row:e}){const t=()=>{const n=sf(e.name);n&&Wr(n)};return i`
    <button class="monitor-row ${e.tone} state-${e.state}" data-testid="execution.continuity-card" onClick=${t}>
      <div class="monitor-row-header">
        ...
        <${tf} ratio=${e.context_ratio??0} size=${34} stroke=${4} />
        <${ot} status=${e.status??"unknown"} />
        <span class="monitor-pill ${e.tone}">${of(e.state)}</span>
      </div>
    ...
    <div class="agents-monitor">
      ...
      >
        ...
        <div class="monitor-alert-list">
          ${t.length===0?i`<div class="empty-state">지금은 막힌 실행이 없습니다</div>`:t.map($=>i`<${rf} key=${$.id} item=${$} selected=${vt.value===$.id} />`)}
        </div>
      <//>
      ...
      <div class="agents-workbench">
        ...
        >
          ...
          <div class="monitor-list">
            ${v.length===0?i`<div class="empty-state">선택된 실행과 연결된 session이 없습니다</div>`:v.map($=>i`<${lf} key=${$.session_id} brief=${$} selected=${De.value===$.session_id} />`)}
          </div>
        <//>
        ...
        >
          ...
          <div class="monitor-list">
            ${f.length===0?i`<div class="empty-state">선택된 실행과 연결된 operation이 없습니다</div>`:f.map($=>i`<${cf} key=${$.operation_id} brief=${$} selected=${je.value===$.operation_id} />`)}
          </div>
        <//>
        ...
        >
          ...
          <div class="monitor-list">
            ${h.length===0?i`<div class="empty-state">지금은 연속성 경고가 없습니다</div>`:h.map($=>i`<${df} key=${$.name} row=${$} />`)}
          </div>
        <//>
  ...
  `}const ea=_("all"),ta=_("all"),ui=_(new Set);function pf(e){const t=new Set(ui.value);t.has(e)?t.delete(e):t.add(e),ui.value=t}const Al=xe(()=>{let e=Ft.value;return ea.value!=="all"&&(e=e.filter(t=>t.horizon===ea.value)),ta.value!=="all"&&(e=e.filter(t=>t.status===ta.value)),e}),mf=xe(()=>{const e={short:[],mid:[],long:[]};for(const t of Al.value){const n=e[t.horizon];n&&n.push(t)}return e}),vf=xe(()=>{const e=Array.from(ur.value.values());return e.sort((t,n)=>t.status==="running"&&n.status!=="running"?-1:n.status==="running"&&t.status!=="running"?1:t.status==="interrupted"&&n.status!=="interrupted"?-1:n.status==="interrupted"&&t.status!=="interrupted"?1:n.elapsed_seconds-t.elapsed_seconds),e});function _f(e){return"★".repeat(Math.min(e,5))+"☆".repeat(Math.max(0,5-e))}function Wi(e){switch(e){case"short":return"Short-term";case"mid":return"Mid-term";case"long":return"Long-term";default:return e}}function Ss(e){switch(e){case"short":return"#4ade80";case"mid":return"#f59e0b";case"long":return"#818cf8";default:return"#888"}}function ff(e){return e<60?`${Math.round(e)}s`:e<3600?`${Math.floor(e/60)}m ${Math.round(e%60)}s`:`${Math.floor(e/3600)}h ${Math.floor(e%3600/60)}m`}function Ao(e){return e.toFixed(4)}function Co(e){const t=e.current_metric-e.baseline_metric;return`${t>=0?"+":""}${t.toFixed(4)}`}function gf(e){switch(e){case 1:return"P1";case 2:return"P2";case 3:return"P3";default:return"P4"}}function Io(e,t){return(e.priority??4)-(t.priority??4)}function $f(e,t){const n=e.updated_at??e.created_at??"";return(t.updated_at??t.created_at??"").localeCompare(n)}function hf(e,t){return e.length<=t?e:e.slice(0,t)+"..."}function yf({goal:e}){return i`
    <div class="goal-row">
      <div class="goal-row-main">
        ...
        <div class="goal-meta">
          <span class="goal-priority" title="Priority ${e.priority}">${_f(e.priority)}</span>
  ...
  `}function kf(){const e=Ft.value,t=e.filter(a=>a.status==="active").length,n=e.filter(a=>a.status==="completed").length,s={short:0,mid:0,long:0};for(const a of e)a.horizon in s&&s[a.horizon]++;return i`
  ...
  `}function xf({loop:e}){const t=e.history[0],n=e.latest_tool_names&&e.latest_tool_names.length>0?`${e.latest_tool_call_count??e.latest_tool_names.length} tool${(e.latest_tool_call_count??e.latest_tool_names.length)===1?"":"s"}: ${e.latest_tool_names.join(", ")}`:"No evidence yet";return i`
  ...
  `}function Ra({task:e}){const t=e.priority??4,n=t<=1?"p1":t===2?"p2":t===3?"p3":"p4",s=ui.value.has(e.id),a=!!e.description;return i`
    <div class="kanban-card ${n}">
      <div class="kanban-card-header">
        <span class="priority-badge priority-badge--${n}">${gf(t)}</span>
      ...
      ${a?i`
        <div
          ...
          onClick=${()=>pf(e.id)}
        >
          ${s?e.description:hf(e.description??"",80)}
        </div>
      `:null}
  ...
  `}function Sf(){const{todo:e,inProgress:t,done:n}=mr.value,s=[...e].sort(Io),a=[...t].sort(Io),o=[...n].sort($f);return i`
  ...
  `}function Af(){const{todo:e,inProgress:t,done:n}=mr.value,s=e.length+t.length+n.length,a=[...e,...t].filter(v=>(v.priority??4)<=2).length,o=mf.value,l=vf.value,c=Ft.value.length>0,u=l.length>0,m=xi.value;return i`
    <div>
      ...
      <details class="overview-section-collapsible" open=${c}>
        ...
        <div>
          ${c?i`
            <${kf} />
            <${bf} />
            ${fn.value&&Ft.value.length===0?i`<div class="loading-indicator">Loading goals...</div>`:Al.value.length===0?i`<div class="empty-state">No goals match the current filters</div>`:i`
        ...
        <div>
          ${gn.value&&l.length===0?i`<div class="loading-indicator">Loading MDAL loops...</div>`:l.length===0&&(m==="error"||Kt.value)?i`<div class="empty-state">MDAL snapshot could not be loaded${Kt.value?`: ${Kt.value}`:""}. Check backend health.</div>`:l.length===0?i`<div class="empty-state">No active loops. Use <code>masc_mdal_start</code> to start a loop.</div>`:i`
                  <div class="planning-loop-list">
                    ${l.map(v=>i`<${xf} key=${v.loop_id} loop=${v} />`)}
                  </div>
                `}
        </div>
      </details>
    </div>
  `}const na=_(!1),xn=_(!1),Ot=_(!1),at=_(""),Sn=_(""),pi=_("open"),we=_(null),Kn=_(null),sa=_(null),aa=_(null),mi=_(!1);function Un(e){return`${e.kind}:${e.id}`}function Hi(){var n;const e=Kn.value,t=((n=we.value)==null?void 0:n.items)??[];return e?t.find(s=>Un(s)===e)??null:null}function Cf(){const e=new URLSearchParams(window.location.search),t=e.get("agent")??e.get("agent_name");return(t==null?void 0:t.trim())||"dashboard"}function If(e){const t=e.trim().toLowerCase();return t==="open"||t==="pending"}function Cl(e){return!!(e.judgment_summary&&e.judgment_summary.trim())}function Il(e){switch(pi.value){case"needs_quorum":return e.filter(t=>t.kind==="consensus"&&(t.votes??0)<(t.quorum??0));case"ready":return e.filter(t=>{var n;return(n=t.guardrail_state)==null?void 0:n.ready_to_execute});case"needs_approval":return e.filter(t=>{var n,s;return((n=t.guardrail_state)==null?void 0:n.requires_human_gate)||!!((s=t.guardrail_state)!=null&&s.pending_confirm)});case"judge_offline":return e.filter(t=>!Cl(t));case"open":default:return e.filter(t=>If(t.status))}}function Tf(e){if(e==null)return"none";if(typeof e=="string")return e;try{return JSON.stringify(e,null,2)}catch{return String(e)}}function fa(e){const t=(e||"").toLowerCase();return t.includes("reject")||t.includes("deny")||t.includes("closed")||t.includes("cancel")?"negative":t.includes("approve")||t.includes("support")||t.includes("open")||t.includes("ready")?"positive":"neutral"}function Rf(e){return typeof e!="number"||Number.isNaN(e)?"n/a":`${Math.round(e*100)}%`}function pn(e){return"resolved_tool"in e||"payload_preview"in e||"reason"in e}async function Tl(e){if(sa.value=null,aa.value=null,!!e){mi.value=!0,at.value="";try{e.kind==="debate"?sa.value=await md(e.id):aa.value=await vd(e.id)}catch(t){at.value=t instanceof Error?t.message:"Failed to load governance detail"}finally{mi.value=!1}}}async function Pf(e){Kn.value=Un(e),await Tl(e)}async function sn(){var e;na.value=!0,at.value="";try{const t=await $c();we.value=t;const n=Il(t.items??[]),s=Kn.value,a=n.find(o=>Un(o)===s)??n[0]??((e=t.items)==null?void 0:e[0])??null;Kn.value=a?Un(a):null,await Tl(a)}catch(t){at.value=t instanceof Error?t.message:"Failed to load governance state"}finally{na.value=!1}}du(sn);async function To(){const e=Sn.value.trim();if(e){xn.value=!0;try{const t=await pd(e);Sn.value="",w(t!=null&&t.id?`Debate started: ${t.id}`:"Debate started","success"),await sn()}catch(t){const n=t instanceof Error?t.message:"Failed to start debate";at.value=n,w(n,"error")}finally{xn.value=!1}}}async function Ro(e){var o,l;const t=Hi(),n=(o=t==null?void 0:t.guardrail_state)==null?void 0:o.pending_confirm,s=n==null?void 0:n.confirm_token;if(!s)return;const a=((l=n==null?void 0:n.actor)==null?void 0:l.trim())||Cf();Ot.value=!0;try{await Ho(a,s,e),w(e==="confirm"?"Action approved":"Action denied","success"),await sn()}catch(c){const u=c instanceof Error?c.message:"Failed to update pending action";at.value=u,w(u,"error")}finally{Ot.value=!1}}function wf(){var n,s,a,o,l,c;const e=(n=we.value)==null?void 0:n.summary,t=(s=we.value)==null?void 0:s.judge;return i`
    <div class="board-summary-strip">
      <div class="board-summary-item">
  ...
  `}function Nf(){var t;const e=Il(((t=we.value)==null?void 0:t.items)??[]);return i`
                ...
                >
                  <div class="council-row-main">
                    ...
                    <div class="governance-chip-row">
                      ...
                      ${Cl(n)?null:i`<span class="governance-chip dim">judge offline</span>`}
                    </div>
                  </div>
  ...
  `}function Mf({argument:e}){return i`
  ...
  `}function Ef(){const e=Hi(),t=sa.value,n=aa.value;return i`
    <${I}
    ...
    >
      ${mi.value?i`<div class="loading-indicator">Loading governance detail...</div>`:e?e.kind==="debate"&&t?i`
                ...
                <div class="governance-ledger">
                  ${t.arguments.length===0?i`<div class="empty-state">No arguments recorded yet.</div>`:t.arguments.map(s=>i`<${Mf} key=${s.index} argument=${s} />`)}
                </div>
              `:e.kind==="consensus"&&n?i`
                  ...
                  <div class="governance-ledger">
                    ${n.votes.length===0?i`<div class="empty-state">No votes recorded yet.</div>`:n.votes.map(s=>i`<${zf} key=${s.agent+s.timestamp} vote=${s} />`)}
                  </div>
  ...
  `}function Po({title:e,route:t}){if(!t)return null;const n=pn(t)?t.resolved_tool:t.delegated_tool,s=pn(t)?t.target_type:null,a=pn(t)?t.target_id:null,o=pn(t)?t.reason:null,l=pn(t)?t.payload_preview:null;return i`
    <div class="governance-side-block">
      ...
      ${l?i`<pre class="council-detail governance-preview">${Tf(l)}</pre>`:null}
    </div>
  `}function Df(){var c,u,m;const e=Hi(),t=sa.value,n=aa.value,s=(t==null?void 0:t.context)??(n==null?void 0:n.context)??(e==null?void 0:e.context),a=(t==null?void 0:t.judgment)??(n==null?void 0:n.judgment),o=e==null?void 0:e.guardrail_state,l=(c=we.value)==null?void 0:c.judge;return i`
      ...
      <${I} title="Why / Guardrail" class="section" semanticId="governance.guardrail">
        ${e?i`
              <div class="governance-side-block">
                ...
                <div class="council-sub">
                  <span>confidence ${Rf(e.confidence)}</span>
                  ${a!=null&&a.keeper_name?i`<span>${a.keeper_name}</span>`:null}
                </div>
              </div>

              <${Po} title="Recommended Route" route=${e.recommended_action} />
              <${Po} title="Executed Route" route=${e.executed_route} />
  ...
  `}const Lt=_(""),Pa=_("ability_check"),wa=_("10"),La=_("12"),cs=_(""),ds=_("idle"),Ge=_(""),us=_("keeper-late"),Na=_("player"),Ma=_(""),be=_("idle"),za=_(null),ps=_(""),Ea=_(""),Da=_("player"),ja=_(""),Oa=_(""),qa=_(""),An=_("20"),Fa=_("20"),Ka=_(""),ms=_("idle"),vi=_(null),Rl=_("overview"),Ua=_("all"),Ba=_("all"),Wa=_("all"),Of=12e4,ga=_(null),wo=_(Date.now());function qf(e,t){const n=t>0?e/t*100:0;return n>50?"hp-high":n>25?"hp-mid":"hp-low"}function Ff(e,t){return t>0?Math.round(e/t*100):0}const Kf={pragmatic:"리스크보다 확실한 이득을 우선합니다.",frugal:"자원 소모를 줄이고 효율을 챙깁니다.",impatient:"짧은 템포로 즉시 압박을 선호합니다.",stubborn:"한 번 정한 전술을 끝까지 밀어붙입니다.",protective:"아군 피해를 줄이는 선택을 우선합니다.","honor-bound":"약속과 규율을 지키는 행동에 보너스가 납니다.",intense:"집중 화력을 짧게 폭발시킵니다.",empathetic:"아군/약자 보호 쪽 선택 확률이 높아집니다.",fatalistic:"위험을 감수하는 고배수 선택을 탑니다.",suspicious:"함정/매복 경계 행동을 우선합니다.",precise:"단일 목표를 정확히 노리는 경향입니다.",vengeful:"직전 위협 대상에게 강하게 반응합니다.",aggressive:"공격적인 전진 행동을 우선합니다.",opportunistic:"빈틈이 열리면 즉시 추격합니다."},Uf={supply_scan:"전장/자원 상태를 스캔해 약한 지점을 찾습니다.",ration_shift:"소모를 줄이고 지속 전투 능력을 확보합니다.",logistics_patch:"무너진 운영 라인을 빠르게 복구합니다.",frontline_shield:"전열에서 아군 피해를 흡수합니다.",oath_intercept:"핵심 타깃을 가로막아 위협을 차단합니다.",morale_anchor:"아군 안정도를 높여 붕괴를 막습니다.",omen_trace:"다음 위험 신호를 먼저 감지합니다.",arc_flash:"짧은 순간 광역 압박을 넣습니다.",ward_bloom:"방어 장막을 펼쳐 생존률을 올립니다.",mark_prey:"우선 제거 대상을 지정합니다.",silent_route:"은밀한 진입 경로를 확보합니다.",finisher_strike:"약화된 적을 마무리하는 일격입니다.",shadow_claw:"근접 급습으로 출혈 피해를 노립니다.",lunge:"짧은 돌진으로 전열을 흔듭니다."};function vs(e){const t=e.trim();return t?t.split(/[_-]+/g).filter(n=>n.length>0).map(n=>n[0]?`${n[0].toUpperCase()}${n.slice(1)}`:n).join(" "):e}function Bf(e){const t=e.trim().toLowerCase();return Kf[t]??"행동 선택 가중치에 영향을 주는 성향입니다."}function Wf(e){const t=e.trim().toLowerCase();return Uf[t]??"상황에 따라 선택되는 전술 액션입니다."}function fe(e,t,n=""){const s=e[t];return typeof s=="string"?s:n}function Ce(e,t,n=0){const s=e[t];return typeof s=="number"&&Number.isFinite(s)?s:n}function Bn(e,t,n=!1){const s=e[t];return typeof s=="boolean"?s:n}const Hf=new Set(["str","dex","con","int","wis","cha"]);function Gf(e){const t=e.trim();if(!t)return{};let n;try{n=JSON.parse(t)}catch(a){throw new Error(`능력치 JSON 파싱 실패: ${a instanceof Error?a.message:"invalid json"}`)}if(!p(n))throw new Error('능력치 JSON은 object여야 합니다. 예: {"luck":7}');const s={};return Object.entries(n).forEach(([a,o])=>{const l=a.trim();if(l){if(typeof o=="number"&&Number.isFinite(o)){s[l]=Math.max(0,Math.trunc(o));return}if(typeof o=="string"){const c=Number.parseFloat(o.trim());if(Number.isFinite(c)){s[l]=Math.max(0,Math.trunc(c));return}}throw new Error(`능력치 '${l}' 값은 숫자여야 합니다.`)}}),s}function Jf(e){const t=Number.parseInt(e.trim(),10);if(!Number.isFinite(t))return;const n=Math.max(1,t),s=Number.parseInt(An.value.trim(),10);Number.isFinite(s)&&s>n&&(An.value=String(n))}function _i(e){const n=(e.actor_name??e.actor??e.actor_id??"system").trim();return n===""?"system":n}function Vf(e){var n;return(((n=e.timestamp)==null?void 0:n.trim())??"")||"-"}function Qf(e){Rl.value=e}function Pl(e){const t=ga.value;return t==null||t<=e}function Yf(e){const t=ga.value;return t==null||t<=e?0:Math.max(0,Math.ceil((t-e)/1e3))}function ia(){ga.value=null}function wl(e){return typeof window>"u"||typeof window.confirm!="function"?!0:window.confirm(e)}function Xf(e,t){wl(["관전 모드 잠금을 해제하시겠습니까?",`ROOM: ${e||"-"}`,`PHASE: ${t||"-"}`,"해제 시간: 120초 (시간 경과 또는 위험 액션 실행 후 자동 재잠금)"].join(`
`))&&(ga.value=Date.now()+Of,w("조작 잠금이 120초 동안 해제되었습니다.","warning"))}function As(e){return Pl(e)?(w("관전 모드 잠금 상태입니다. 먼저 잠금을 해제하세요.","warning"),!1):!0}function fi(e,t,n){return wl([`[위험 액션 확인] ${e}`,`ROOM: ${t||"-"}`,`PHASE: ${n||"-"}`,"이 액션은 즉시 실행되며 되돌리기 어렵습니다.","계속 진행하시겠습니까?"].join(`
`))}function Zf({hp:e,max:t}){const n=Ff(e,t),s=qf(e,t);return i`
    <div class="trpg-hp-bar">
      <div class="hp-fill ${s}" style="width:${n}%" />
    </div>
  `}function eg({stats:e}){const t=[{label:"STR",value:e.strength},{label:"DEX",value:e.dexterity},{label:"CON",value:e.constitution},{label:"INT",value:e.intelligence},{label:"WIS",value:e.wisdom},{label:"CHA",value:e.charisma}];return i`
    <div class="trpg-actor-stats">
      ${t.map(n=>i`<span>${n.label} ${n.value}</span>`)}
    </div>
  `}function tg({keeper:e,role:t}){if(!e)return null;const n=t==="dm"?"dm":"player";return i`
    <span class="trpg-keeper-chip">
      <span class="trpg-keeper-tag ${n}">${n}</span>
      ${e}
    </span>
  `}function Ll({actor:e}){var u,m,v,f;const t=(u=e.archetype)==null?void 0:u.trim(),n=(m=e.persona)==null?void 0:m.trim(),s=(v=e.portrait)==null?void 0:v.trim(),a=(f=e.background)==null?void 0:f.trim(),o=e.traits??[],l=e.skills??[],c=Object.entries(e.stats_raw??{}).filter(([g,h])=>Number.isFinite(h)).filter(([g])=>!Hf.has(g.toLowerCase()));return i`
    <div class="trpg-actor">
      ...
      <div class="trpg-actor-header">
        ...
        <${tg} keeper=${e.keeper} role=${e.role} />
      </div>
      ${e.stats?i`
          <div style="margin-top:4px;">
            ...
            <${Zf} hp=${e.stats.hp} max=${e.stats.max_hp} />
            <${eg} stats=${e.stats} />
          </div>
        `:null}
            ...
            <div class="trpg-annot-list">
              ${o.map(g=>i`
                <span class="trpg-annot-chip trait">
                  ...
                  <span class="trpg-annot-desc">${Bf(g)}</span>
                </span>
              `)}
            </div>
          </div>
            ...
            <div class="trpg-annot-list">
              ${l.map(g=>i`
                <span class="trpg-annot-chip skill">
                  <span class="trpg-annot-name">${vs(g)}</span>
                  <span class="trpg-annot-desc">${Wf(g)}</span>
                </span>
              `)}
            </div>
          </div>
  ...
  `}function ng({mapStr:e}){return i`<pre class="trpg-map">${e}</pre>`}function Nl({events:e,emptyLabel:t="아직 이벤트가 없습니다."}){return e.length===0?i`<div class="empty-state" style="font-size:13px">${t}</div>`:i`
    <div class="trpg-story" role="list" aria-label="TRPG story events">
      ${e.map((n,s)=>{var a;return i`
        <div key=${s} class="trpg-event ${n.type??""}" role="listitem">
          <div class="trpg-event-meta-row">
            <span class="trpg-event-meta">${Vf(n)}</span>
  ...
  `}function Ml({state:e}){const t=e.history??[];return t.length===0?null:i`
  ...
  `}function ig({state:e,nowMs:t}){var m;const n=qe.value||((m=e.session)==null?void 0:m.room)||"",s=ds.value,a=e.party??[];if(!a.find(v=>v.id===Lt.value)&&a.length>0){const v=a[0];v&&(Lt.value=v.id)}const l=async()=>{var f,g;if(!n){w("Room ID가 비어 있습니다.","error");return}if(!As(t))return;const v=((f=e.current_round)==null?void 0:f.phase)??((g=e.session)==null?void 0:g.status)??"unknown";if(fi("라운드 실행",n,v)){ds.value="running";try{const h=await td(n);vi.value=h,ds.value="ok";const k=p(h.summary)?h.summary:null,$=k?Bn(k,"advanced",!1):!1,C=k?fe(k,"progress_reason",""):"";w($?"라운드가 정상 진행되었습니다.":`라운드가 정체되었습니다${C?`: ${C}`:""}`,$?"success":"warning"),Xe()}catch(h){vi.value=null,ds.value="error";const k=h instanceof Error?h.message:"라운드 실행에 실패했습니다.";w(k,"error")}finally{ia()}}},c=async()=>{var f,g;if(!n||!As(t))return;const v=((f=e.current_round)==null?void 0:f.phase)??((g=e.session)==null?void 0:g.status)??"unknown";if(fi("턴 강제 진행",n,v))try{await ad(n),w("턴을 다음 단계로 이동했습니다.","success"),Xe()}catch{w("턴 이동에 실패했습니다.","error")}finally{ia()}},u=async()=>{if(!n||!As(t))return;const v=Lt.value.trim();if(!v){w("먼저 Actor를 선택하세요.","warning");return}const f=Number.parseInt(wa.value,10),g=Number.parseInt(La.value,10);if(Number.isNaN(f)||Number.isNaN(g)){w("stat/dc는 숫자여야 합니다.","warning");return}const h=Number.parseInt(cs.value,10),k=cs.value.trim()===""||Number.isNaN(h)?void 0:h;try{await sd({roomId:n,actorId:v,action:Pa.value.trim()||"ability_check",statValue:f,dc:g,rawD20:k}),w("주사위 판정을 기록했습니다.","success"),Xe()}catch{w("주사위 판정 기록에 실패했습니다.","error")}};return i`
  ...
  `}function og({state:e}){var a;const t=qe.value||((a=e.session)==null?void 0:a.room)||"",n=ms.value,s=async()=>{if(!t){w("Room ID가 비어 있습니다.","warning");return}const o=ps.value.trim(),l=Ea.value.trim();if(!l&&!o){w("이름 또는 Actor ID를 입력하세요.","warning");return}const c=Number.parseInt(An.value.trim(),10),u=Number.parseInt(Fa.value.trim(),10),m=Number.isFinite(u)?Math.max(1,u):20,v=Number.isFinite(c)?Math.max(0,Math.min(m,c)):m;let f={};try{f=Gf(Ka.value)}catch(g){w(g instanceof Error?g.message:"능력치 JSON 오류","error");return}ms.value="spawning";try{const g=typeof crypto<"u"&&typeof crypto.randomUUID=="function"?`trpg_spawn_${crypto.randomUUID()}`:`trpg_spawn_${Date.now().toString(36)}_${Math.random().toString(36).slice(2,10)}`,h=await id(t,{actor_id:o||void 0,name:l||void 0,role:Da.value,idempotencyKey:g,portrait:Oa.value.trim()||void 0,background:qa.value.trim()||void 0,hp:v,max_hp:m,alive:v>0,stats:Object.keys(f).length>0?f:void 0}),k=typeof h.actor_id=="string"?h.actor_id.trim():"";if(!k)throw new Error("생성 응답에 actor_id가 없습니다.");const $=ja.value.trim();$&&await od(t,k,$),Lt.value=k,Ge.value=k,o||(ps.value=""),ms.value="ok",w(`Actor 생성 완료: ${k}`,"success"),await Xe()}catch(g){ms.value="error",w(g instanceof Error?g.message:"Actor 생성에 실패했습니다.","error")}};return i`
    <div class="trpg-control-box">
      <div class="trpg-control-grid">
        <div class="trpg-control-field">
          <label>Name</label>
        ...
        <div class="trpg-control-grid">
          ...
          <div class="trpg-control-field">
            ...
            <input
              ...
              min="1"
              value=${Fa.value}
              onInput=${o=>{const l=o.target.value;Fa.value=l,Jf(l)}}
              placeholder="20"
            />
          </div>
  ...
  `}function rg({state:e,nowMs:t}){var g;const n=qe.value||((g=e.session)==null?void 0:g.room)||"",s=e.join_gate,a=za.value,o=p(a)?a:null,l=(e.party??[]).filter(h=>h.role!=="dm"),c=Ge.value.trim(),u=l.some(h=>h.id===c),m=u?c:c?"__manual__":"",v=async()=>{const h=Ge.value.trim(),k=us.value.trim();if(!n||!h){w("Room/Actor가 필요합니다.","warning");return}be.value="checking";try{const $=await rd(n,h,k||void 0);za.value=$,be.value="ok",w("참가 가능 여부를 갱신했습니다.","success")}catch($){be.value="error";const C=$ instanceof Error?$.message:"참가 가능 여부 확인에 실패했습니다.";w(C,"error")}},f=async()=>{var A,T;const h=Ge.value.trim(),k=us.value.trim(),$=Ma.value.trim();if(!n||!h||!k){w("Room/Actor/Keeper가 필요합니다.","warning");return}if(!As(t))return;const C=((A=e.current_round)==null?void 0:A.phase)??((T=e.session)==null?void 0:T.status)??"unknown";if(fi("Mid-Join 승인 요청",n,C)){be.value="requesting";try{const x=await ld({room_id:n,actor_id:h,keeper_name:k,role:Na.value,...$?{name:$}:{}});za.value=x;const R=p(x)?Bn(x,"granted",!1):!1,P=p(x)?fe(x,"reason_code",""):"";R?w("Mid-Join이 승인되었습니다.","success"):w(`Mid-Join이 거절되었습니다${P?`: ${P}`:""}`,"warning"),be.value=R?"ok":"error",Xe()}catch(x){be.value="error";const R=x instanceof Error?x.message:"Mid-Join 요청에 실패했습니다.";w(R,"error")}finally{ia()}}};return i`
    <div class="trpg-control-box">
  ...
  `}function zl({state:e}){const t=[...e.contribution_ledger??[]].sort((n,s)=>(s.score??0)-(n.score??0)).slice(0,8);return t.length===0?i`<div class="empty-state" style="font-size:13px;">No contribution data yet</div>`:i`
    <div class="trpg-round-list">
      ${t.map(n=>i`
  ...
  `}function El({state:e}){var n;const t=e.current_round;return t?i`
  ...
  `:null}function Dl(){const e=vi.value;if(!e)return i`<div class="empty-state" style="font-size:13px;">Run Round 결과가 아직 없습니다.</div>`;const t=e.summary,n=p(t)?t:null,a=(Array.isArray(e.statuses)?e.statuses:[]).filter(p).slice(-8),o=e.canon_check,l=p(o)?o:null,c=l&&Array.isArray(l.warnings)?l.warnings.filter(P=>typeof P=="string").slice(0,3):[],u=l&&Array.isArray(l.violations)?l.violations.filter(P=>typeof P=="string").slice(0,3):[],m=n?Bn(n,"advanced",!1):!1,v=n?fe(n,"progress_reason",""):"",f=n?fe(n,"progress_detail",""):"",g=n?Ce(n,"player_successes",0):0,h=n?Ce(n,"player_required_successes",0):0,k=n?Bn(n,"dm_success",!1):!1,$=n?Ce(n,"timeouts",0):0,C=n?Ce(n,"unavailable",0):0,A=n?Ce(n,"reprompts",0):0,T=n?Ce(n,"npc_attacks",0):0,x=n?Ce(n,"keeper_timeout_sec",0):0,R=n?Ce(n,"roll_audit_count",0):0;return i`
    <div style="display:grid; gap:10px;">
      ...
      ${a.length>0?i`
          <div class="trpg-round-list">
            ${a.map(P=>{const E=fe(P,"status","unknown"),G=fe(P,"actor_id","-"),D=fe(P,"role","-"),te=fe(P,"reason",""),se=fe(P,"action_type",""),H=fe(P,"reply","");return i`
                <div class="trpg-round-item ${E.includes("fallback")||E.includes("timeout")?"failed":"active"}">
                  ...
                  ${H?i`<div style="width:100%; font-size:11px; color:#d1d5db; margin-top:2px;">${H.slice(0,120)}</div>`:null}
                </div>
              `})}
          </div>`:null}
  ...
  `}function lg({state:e,nowMs:t}){var l,c,u;const n=qe.value||((l=e.session)==null?void 0:l.room)||"",s=((c=e.current_round)==null?void 0:c.phase)??((u=e.session)==null?void 0:u.status)??"unknown",a=Pl(t),o=Yf(t);return i`
    <${I} title="조작 안전 잠금" style="margin-bottom:16px;" semanticId="lab.trpg">
      <div class="trpg-control-lock ${a?"locked":"unlocked"}">
        ...
        <div style="display:flex; gap:8px; margin-top:10px; flex-wrap:wrap;">
          ${a?i`<button class="trpg-run-btn recommend" onClick=${()=>Xf(n,s)}>잠금 해제 (120초)</button>`:i`<button class="trpg-run-btn secondary" onClick=${()=>{ia(),w("조작 잠금으로 전환했습니다.","success")}}>즉시 다시 잠금</button>`}
        </div>
      </div>
    <//>
  `}function cg({active:e}){return i`
  ...
  `}function dg({state:e}){const t=e.party??[],n=e.story_log??[];return i`
      ...
      <div class="trpg-sidebar">
        ...
        <${I} title=${`파티 (${t.length})`} style="margin-top:16px;">
          <div class="trpg-actor-list">
            ${t.map(s=>i`<${Ll} key=${s.id??s.name} actor=${s} />`)}
  ...
  `}function ug({state:e}){const t=e.story_log??[];return i`
    <div class="trpg-layout">
      <div>
  ...
  `}function pg({state:e,nowMs:t}){const n=e.party??[];return i`
    <div>
      <${lg} state=${e} nowMs=${t} />
      <div class="trpg-layout">
        <div>
        ...
        <div class="trpg-sidebar">
          ...
          <${I} title=${`파티 (${n.length})`} style="margin-top:16px;">
            <div class="trpg-actor-list">
              ${n.map(s=>i`<${Ll} key=${s.id??s.name} actor=${s} />`)}
  ...
  `}function mg(){var c,u,m,v,f;const e=dr.value,t=ni.value;if(ne(()=>{if(typeof window>"u"||typeof window.setInterval!="function")return;const g=window.setInterval(()=>{wo.value=Date.now()},1e3);return()=>{window.clearInterval(g)}},[]),t&&!e)return i`<div class="loading-indicator">Loading TRPG state...</div>`;if(!e)return i`
      <div class="section">
        <h2>TRPG</h2>
        <div class="empty-state">No active TRPG session</div>
        <button class="board-sort-btn" onClick=${()=>Xe()}>Refresh</button>
      </div>
    `;const n=e.party??[],s=e.story_log??[],a=e.outcome,o=Rl.value,l=wo.value;return i`
    <div>
      <${$e} surfaceId="lab" />
      ...
      ${o==="overview"?i`<${dg} state=${e} />`:o==="timeline"?i`<${ug} state=${e} />`:i`<${pg} state=${e} nowMs=${l} />`}
    </div>
  ...
  `}const oa=_(new Set(["broadcast","tasks","keepers","system"]));function _g(e){const t=new Set(oa.value);t.has(e)?t.delete(e):t.add(e),oa.value=t}const Gi=_(null);function jl(e){Gi.value=e}function fg(e){return e.kind==="board"?"broadcast":e.kind==="tasks"?"tasks":e.kind==="keepers"?"keepers":"system"}const gg=xe(()=>{const e=oa.value;return Is.value.filter(t=>e.has(fg(t)))}),$g=12e4,hg=xe(()=>{const e=vr.value,t=Date.now();return ze.value.map(n=>{const s=n.name.trim().toLowerCase(),a=e.get(s)??null;let o="idle";if(n.status==="active"||n.status==="busy"){const l=a==null?void 0:a.lastActivityAt;l?o=t-new Date(l).getTime()>$g?"stale":"working":o="working"}else(n.status==="offline"||n.status==="inactive")&&(o="stale");return{name:n.name,emoji:n.emoji??"",koreanName:n.koreanName??null,state:o,currentTask:n.current_task,motion:a}})}),yg=xe(()=>{const e=vr.value;return ze.value.filter(t=>t.status==="active"||t.status==="busy"||t.status==="listening"||t.status==="idle").map(t=>{const n=t.name.trim().toLowerCase(),s=e.get(n),a=(s==null?void 0:s.activeAssignedCount)??0;let o="calm";return a>=3?o="hot":a>=1&&(o="normal"),{name:t.name,emoji:t.emoji??"",koreanName:t.koreanName??null,currentTask:t.current_task,lastActivityAt:(s==null?void 0:s.lastActivityAt)??null,lastActivityText:(s==null?void 0:s.lastActivityText)??null,assignedCount:a,pressure:o}}).sort((t,n)=>{const s={hot:0,normal:1,calm:2};return s[t.pressure]-s[n.pressure]})});function Lo(e){return e.kind==="board"?"live-event-broadcast":e.kind==="tasks"?"live-event-task":e.kind==="keepers"?"live-event-keeper":"live-event-system"}function bg(e){const t=e.eventType;return t==="broadcast"?"broadcast":t==="agent_joined"?"joined":t==="agent_left"?"left":t==="task_update"?"task":t==="board_post"?"post":t==="board_comment"?"comment":t==="keeper_heartbeat"?"heartbeat":t==="keeper_handoff"?"handoff":t==="keeper_compaction"?"compact":t==="keeper_guardrail"?"guardrail":e.kind==="board"?"board":e.kind==="tasks"?"task":e.kind==="keepers"?"keeper":"system"}function kg(e){switch(e){case"working":return"pulse-working";case"stale":return"pulse-stale";default:return"pulse-idle"}}function xg(){const e=hg.value,t=Gi.value;return e.length===0?i`
    ...
    <div class="pulse-strip">
      ${e.map(n=>i`
        <button
          key=${n.name}
          class="pulse-bubble ${kg(n.state)} ${t===n.name?"pulse-selected":""}"
          onClick=${()=>jl(t===n.name?null:n.name)}
  ...
  `}const Sg=[{kind:"broadcast",label:"Broadcast",cssClass:"live-event-broadcast"},{kind:"tasks",label:"Task",cssClass:"live-event-task"},{kind:"keepers",label:"Keeper",cssClass:"live-event-keeper"},{kind:"system",label:"System",cssClass:"live-event-system"}];function Ag(){const e=oa.value;return i`
  ...
  `}function Cg(){const e=gg.value;return i`
        ...
        ${e.length===0?i`<div class="activity-empty">No events matching filters</div>`:e.map((t,n)=>i`
            ...
            >
              <div class="activity-item-head">
                <span class="activity-kind-chip ${Lo(t)}">${bg(t)}</span>
  ...
  `}function Ig(e){switch(e){case"hot":return"focus-pressure-hot";case"normal":return"focus-pressure-normal";default:return"focus-pressure-calm"}}function Tg(e){switch(e){case"hot":return"High";case"normal":return"Active";default:return"Calm"}}function Rg(){const e=yg.value,t=Gi.value;return i`
        ...
        ${e.length===0?i`<div class="focus-empty">No active agents</div>`:e.map(n=>i`
            ...
            >
              <div class="focus-agent-header">
                ...
                <span class="focus-pressure-badge ${Ig(n.pressure)}">
                  ${Tg(n.pressure)}
  ...
  `}function Pg(){const e=tt.value;return i`
  ...
  `}function Ol(e){const t=e==null?void 0:e.trim();return t?t.length>10?t.slice(0,10):t:"commit unavailable"}function Lg(){const e=oe.value,t=e==null?void 0:e.build,n=t?`v${t.release_version} · ${Ol(t.commit)}`:e!=null&&e.version?`v${e.version} · commit unavailable`:"version unavailable";return i`
  ...
  `}function $i(e){e==="command"&&(Et(),Gt(),(X.value==="swarm"||X.value==="warroom")&&Ve(),X.value==="warroom"&&ge()),e==="mission"&&(kr(),Ns()),e==="proof"&&Jr(j.value.params.session_id,j.value.params.operation_id),e==="execution"&&ft(),e==="intervene"&&(ge(),kt()),e==="memory"&&Ye(),e==="planning"&&Ci(),e==="lab"&&Xe()}function Ng({currentTab:e}){var s;const t=tt.value,n=(s=oe.value)==null?void 0:s.build;return i`
    <section class="rail-card">
      ...
      ${n?i`<div class="rail-build-hint">Server Build · v${n.release_version} · ${Ol(n.commit)}</div>`:null}
    </section>
  `}function Mg(){const e=he.value,t=(e==null?void 0:e.pending_confirms.length)??0,n=(e==null?void 0:e.sessions.length)??0,s=(e==null?void 0:e.keepers.length)??0;return i`
    <section class="rail-card">
      <div class="rail-card-head">
        <h3>개입 바로가기</h3>
  ...
  `}function zg(){const e=j.value.tab,t=gi.find(s=>s.id===e),n=No.find(s=>s.id===(t==null?void 0:t.group));return i`
  ...
  `}function Eg(){switch(j.value.tab){case"mission":return i`<${vo} />`;case"proof":return i`<${Dv} />`;case"execution":return i`<${uf} />`;case"live":return i`<${Pg} />`;case"memory":return i`<${ef} />`;case"governance":return i`<${jf} />`;case"planning":return i`<${Af} />`;case"intervene":return i`<${F_} />`;case"command":return i`<${b_} />`;case"lab":return i`<${vg} />`;default:return i`<${vo} />`}}function Dg(){ne(()=>{Yl(),Fo(),hr(),ft(),$r(),kr();const n=mu();return vu(),()=>{ic(),n(),_u()}},[]),ne(()=>{const n=setInterval(()=>{$i(j.value.tab)},15e3);return()=>{clearInterval(n)}},[]),ne(()=>{$i(j.value.tab)},[j.value.tab]);const e=j.value.tab,t=gi.find(n=>n.id===e);return i`
    <div class="app-shell">
      ...
      <div class="dashboard-layout">
        ...
        <main class="dashboard-main">
          ${ti.value&&!tt.value?i`<div class="loading-indicator">Loading dashboard...</div>`:i`<${Eg} />`}
        </main>
      </div>
  ...
  `}const Mo=document.getElementById("app");Mo&&Hl(i`<${Dg} />`,Mo);export{cm as _};
