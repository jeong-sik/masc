var Gr=Object.defineProperty;var Jr=(t,e,n)=>e in t?Gr(t,e,{enumerable:!0,configurable:!0,writable:!0,value:n}):t[e]=n;var ke=(t,e,n)=>Jr(t,typeof e!="symbol"?e+"":e,n);import{e as Vr,_ as Qr,c as _,b as Tt,y as lt,d as Ga,A as Co,G as Yr}from"./vendor-kuFK4-oj.js";(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const s of document.querySelectorAll('link[rel="modulepreload"]'))a(s);new MutationObserver(s=>{for(const o of s)if(o.type==="childList")for(const r of o.addedNodes)r.tagName==="LINK"&&r.rel==="modulepreload"&&a(r)}).observe(document,{childList:!0,subtree:!0});function n(s){const o={};return s.integrity&&(o.integrity=s.integrity),s.referrerPolicy&&(o.referrerPolicy=s.referrerPolicy),s.crossOrigin==="use-credentials"?o.credentials="include":s.crossOrigin==="anonymous"?o.credentials="omit":o.credentials="same-origin",o}function a(s){if(s.ep)return;s.ep=!0;const o=n(s);fetch(s.href,o)}})();var i=Vr.bind(Qr);const Xr=["command","overview","board","goals","agents","ops","trpg"],To={tab:"overview",params:{},postId:null},Zr={journal:"overview",mdal:"goals",tasks:"goals",execution:"overview",council:"board",activity:"overview"};function Oi(t){return!!t&&Xr.includes(t)}function zi(t){if(t)return Zr[t]??t}function Zn(t){try{return decodeURIComponent(t)}catch{return t}}function Ds(t){const e={};return t&&new URLSearchParams(t).forEach((a,s)=>{e[s]=a}),e}function tl(t){const n=t.replace(/^\/+/,"").split("/").filter(Boolean);return n[0]==="dashboard"?n.slice(1):n}function No(t,e){if(t[0]==="chains"){const r={...e,surface:"chains"};return t[1]==="operation"&&t[2]&&(r.operation=Zn(t[2])),{tab:"command",params:r,postId:null}}const n=zi(t[0]),a=zi(e.tab),s=Oi(n)?n:Oi(a)?a:"overview";let o=null;return s==="board"&&(t[0]==="board"&&t[1]==="post"&&t[2]?o=Zn(t[2]):t[0]==="post"&&t[1]&&(o=Zn(t[1]))),{tab:s,params:e,postId:o}}function ua(t){const e=(t||"").replace(/^#/,"").trim();if(!e)return To;const n=Zn(e);let a=n,s;if(n.startsWith("?"))a="",s=n.slice(1);else{const l=n.indexOf("?");l>=0&&(a=n.slice(0,l),s=n.slice(l+1))}!s&&a.includes("=")&&!a.includes("/")&&(s=a,a="");const o=Ds(s),r=tl(a);return No(r,o)}function el(t,e){const n=t.replace(/^\/+/,"").split("/").filter(Boolean);if(n[0]!=="dashboard")return null;const a=n.slice(1);if(a.length===0)return{...To,params:Ds(e.replace(/^\?/,""))};if(a[0]==="assets"||a[0]==="credits"||a[0]==="lodge")return null;const s=Ds(e.replace(/^\?/,""));return No(a,s)}function Ro(t){const e=t.postId?`board/post/${encodeURIComponent(t.postId)}`:t.tab,n=Object.entries(t.params).filter(([s])=>s!=="tab");if(n.length===0)return`#${e}`;const a=new URLSearchParams(n);return`#${e}?${a.toString()}`}const at=_(ua(window.location.hash));window.addEventListener("hashchange",()=>{at.value=ua(window.location.hash)});function Pt(t,e){const n={tab:t,params:e??{},postId:null};window.location.hash=Ro(n)}function nl(t){window.location.hash=`#board/post/${encodeURIComponent(t)}`}function al(){if(window.location.hash&&window.location.hash!=="#"){at.value=ua(window.location.hash);return}const t=el(window.location.pathname,window.location.search);if(t){at.value=t;const e=Ro(t);window.history.replaceState(null,"",`${window.location.pathname}${window.location.search}${e}`);return}window.location.hash="#overview",at.value=ua(window.location.hash)}const ji="masc_dashboard_sse_session_id",sl=1e3,il=15e3,Ht=_(!1),On=_(0),Lo=_(null),pa=_([]);function ol(){let t=sessionStorage.getItem(ji);return t||(t=typeof crypto.randomUUID=="function"?`dash_${crypto.randomUUID()}`:`dash_${Date.now().toString(36)}_${Math.random().toString(36).slice(2,10)}`,sessionStorage.setItem(ji,t)),t}const rl=200;function ll(t,e,n="system",a={}){const s={agent:t,text:e,timestamp:Date.now(),kind:n,...a};pa.value=[s,...pa.value].slice(0,rl)}function Es(t,e=88){const n=(t??"").replace(/\s+/g," ").trim();return n?n.length>e?`${n.slice(0,e-3)}...`:n:void 0}function qi(t,e){const n=Es(e);return n?`${t}: ${n}`:`New ${t.toLowerCase()}`}function Nt(t,e,n,a,s={}){ll(t,e,n,{eventType:a,...s})}let jt=null,De=null,Is=0;function Po(){De&&(clearTimeout(De),De=null)}function cl(){if(De)return;Is++;const t=Math.min(Is,5),e=Math.min(il,sl*Math.pow(2,t));De=setTimeout(()=>{De=null,Do()},e)}function Do(){Po(),jt&&(jt.close(),jt=null);const t=new URLSearchParams(window.location.search),e=new URLSearchParams,n=t.get("agent")??t.get("agent_name"),a=t.get("token");n&&e.set("agent",n),a&&e.set("token",a),e.set("session_id",ol());const s=e.toString()?`/sse?${e.toString()}`:"/sse",o=new EventSource(s);jt=o,o.onopen=()=>{jt===o&&(Is=0,Ht.value=!0)},o.onerror=()=>{jt===o&&(Ht.value=!1,o.close(),jt=null,cl())},o.onmessage=r=>{try{const l=JSON.parse(r.data);On.value++,Lo.value=l,dl(l)}catch{}}}function dl(t){const e=t.type,n=t.agent??t.author??t.from??t.from_agent??"";switch(e){case"agent_joined":Nt(n,"Joined","system","agent_joined");break;case"agent_left":Nt(n,"Left","system","agent_left");break;case"broadcast":Nt(n,`${(t.message??t.content??"").slice(0,80)}`,"system","broadcast");break;case"task_update":Nt(n,`Task: ${t.task_id??""} -> ${t.status??""}`,"tasks","task_update");break;case"board_post":case"masc/board_post":Nt(n,qi("Post",t.content??t.message),"board","board_post",{author:t.author??n,preview:Es(t.content??t.message),postId:t.post_id});break;case"board_comment":case"masc/board_comment":Nt(n,qi("Comment",t.content??t.message),"board","board_comment",{author:t.author??n,preview:Es(t.content??t.message),postId:t.post_id});break;case"keeper_heartbeat":Nt(t.name??n,`Heartbeat gen=${t.generation??"?"} ctx=${t.context_ratio!=null?Math.round(t.context_ratio*100)+"%":"?"}`,"keepers","keeper_heartbeat");break;case"keeper_handoff":Nt(t.name??n,`Handoff gen ${t.from_generation??"?"} -> ${t.to_generation??"?"} (${t.to_model??"?"})`,"keepers","keeper_handoff");break;case"keeper_compaction":Nt(t.name??n,`Compaction saved ${t.saved_tokens??"?"} tokens (${t.trigger??"?"})`,"keepers","keeper_compaction");break;case"keeper_guardrail":Nt(t.name??n,`Guardrail: ${t.reason??"stopped"}`,"keepers","keeper_guardrail");break;default:Nt(n,e,"system","unknown")}}function ul(){Po(),jt&&(jt.close(),jt=null),Ht.value=!1}function Eo(){return new URLSearchParams(window.location.search)}function Io(){const t=Eo(),e={},n=t.get("token"),a=t.get("agent")??t.get("agent_name");return n&&(e.Authorization=`Bearer ${n}`),a&&(e["X-MASC-Agent"]=a),e}function Mo(){return{...Io(),"Content-Type":"application/json"}}const pl=15e3,$i=3e4,ml=6e4,Fi=new Set([408,425,429,500,502,503,504]);class zn extends Error{constructor(n){const a=n.method.toUpperCase(),s=n.timeout===!0,o=s?`${a} ${n.path}: timeout after ${n.timeoutMs??0}ms`:`${a} ${n.path}: ${n.status??"unknown"} ${n.statusText??""}`.trim();super(o);ke(this,"method");ke(this,"path");ke(this,"status");ke(this,"statusText");ke(this,"timeout");this.name="ApiRequestError",this.method=a,this.path=n.path,this.status=n.status,this.statusText=n.statusText,this.timeout=s}}async function hi(t,e,n){const a=new AbortController,s=setTimeout(()=>a.abort(),n);try{return await fetch(t,{...e,signal:a.signal})}catch(o){if(o instanceof Error&&o.name==="AbortError"){const r=typeof e.method=="string"?e.method.toUpperCase():"GET";throw new zn({method:r,path:t,timeout:!0,timeoutMs:n})}throw o}finally{clearTimeout(s)}}function vl(){var e,n;const t=Eo();return((e=t.get("agent"))==null?void 0:e.trim())||((n=t.get("agent_name"))==null?void 0:n.trim())||"dashboard-user"}async function Z(t){const e=await hi(t,{headers:Io()},pl);if(!e.ok)throw new zn({method:"GET",path:t,status:e.status,statusText:e.statusText});return e.json()}function fl(t){return new Promise(e=>setTimeout(e,t))}function _l(t){const e=t.match(/\b(\d{3})\b/);if(!e)return null;const n=e[1];if(!n)return null;const a=Number.parseInt(n,10);return Number.isFinite(a)?a:null}function gl(t){if(t instanceof zn)return t.timeout||typeof t.status=="number"&&Fi.has(t.status);if(!(t instanceof Error))return!1;if(/timeout after \d+ms/i.test(t.message))return!0;const e=_l(t.message);return e!==null&&Fi.has(e)}async function Ue(t,e,n=2){let a=0;for(;;)try{return await e()}catch(s){if(!gl(s)||a>=n)throw s;const o=250*(a+1);console.warn(`[dashboard/api] ${t} failed (attempt ${a+1}), retrying in ${o}ms`,s),await fl(o),a+=1}}async function Ut(t,e,n,a=$i){const s=await hi(t,{method:"POST",headers:{...Mo(),...n??{}},body:JSON.stringify(e)},a);if(!s.ok)throw new zn({method:"POST",path:t,status:s.status,statusText:s.statusText});return s.json()}async function $l(t,e,n,a=$i){const s=await hi(t,{method:"POST",headers:{...Mo(),...n??{}},body:JSON.stringify(e)},a);if(!s.ok)throw new zn({method:"POST",path:t,status:s.status,statusText:s.statusText});return s.text()}function hl(t){const e=t.split(`
`).find(a=>a.startsWith("data: ")),n=e?e.slice(6).trim():t.trim();return JSON.parse(n)}function yl(t){var e,n,a,s,o,r,l;if((e=t.error)!=null&&e.message)throw new Error(t.error.message);if((n=t.result)!=null&&n.isError){const p=((s=(a=t.result.content)==null?void 0:a[0])==null?void 0:s.text)??"MCP tool call failed";throw new Error(p)}return((l=(r=(o=t.result)==null?void 0:o.content)==null?void 0:r[0])==null?void 0:l.text)??""}async function St(t,e){const n=await $l("/mcp",{jsonrpc:"2.0",method:"tools/call",params:{name:t,arguments:e},id:Math.floor(Date.now()%1e6)},{Accept:"application/json, text/event-stream"},ml),a=hl(n);return yl(a)}function bl(t="compact"){return Z(`/api/v1/dashboard?mode=${t}`)}function kl(){return Z("/api/v1/agents?limit=100")}function xl(t){const e=new URLSearchParams({limit:"200"});return e.set("include_done","true"),e.set("include_cancelled","true"),Z(`/api/v1/tasks?${e}`)}function Sl(t){const e=new URLSearchParams({limit:"50"});return t!=null&&t>0&&e.set("since_seq",String(t)),Z(`/api/v1/messages?${e}`)}function Al(t={}){return Ue("fetchMdalLoops",async()=>{const e=new URLSearchParams;t.limit!=null&&e.set("limit",String(t.limit)),t.historyLimit!=null&&e.set("history_limit",String(t.historyLimit)),t.status&&e.set("status",t.status);const n=e.toString();return Z(`/api/v1/mdal/loops${n?`?${n}`:""}`)})}function wl(){return Z("/api/v1/operator")}function Cl(){return Z("/api/v1/command-plane")}function Tl(){return Z("/api/v1/command-plane/summary")}function Nl(){return Z("/api/v1/chains/summary")}function Rl(t){return Z(`/api/v1/chains/runs/${encodeURIComponent(t)}`)}function Ll(){return Z("/api/v1/command-plane/help")}function Pl(t){const e=new URLSearchParams;t&&e.set("run_id",t);const n=e.toString();return Z(`/api/v1/command-plane/swarm${n?`?${n}`:""}`)}function Dl(t,e){return Ut(t,e)}function El(t){switch(t.action_type){case"keeper_msg":case"keeper_message":case"keeper_recover":return 9e4;case"lodge_tick":return 45e3;default:return $i}}function jn(t){return Ut("/api/v1/operator/action",t,void 0,El(t))}function Il(t,e){return Ut("/api/v1/operator/confirm",{actor:t,confirm_token:e})}const Ml=new Set(["lodge-system","team-session"]);function ze(t){if(typeof t=="string"&&t.trim())return t;if(typeof t!="number"||Number.isNaN(t))return new Date().toISOString();const e=t<1e12?t*1e3:t;return new Date(e).toISOString()}function Ol(t){return Ml.has(t.trim().toLowerCase())}function zl(t){return t.filter(e=>!Ol(e.author))}function jl(t){var s;const e=t.trim(),a=((s=(e.startsWith("[flair:")?e.replace(/^\[flair:[^\]]+\]\s*/i,""):e).split(`
`)[0])==null?void 0:s.trim())||"Untitled post";return a.length<=96?a:`${a.slice(0,93)}...`}function Oo(t){if(!O(t))return null;const e=h(t.id,"").trim(),n=h(t.author,"").trim(),a=h(t.content,"").trim();if(!e||!n)return null;const s=j(t.score,0),o=j(t.votes_up,0),r=j(t.votes_down,0),l=j(t.votes,s||o-r),p=j(t.comment_count,j(t.reply_count,0)),$=(()=>{const y=t.flair;if(typeof y=="string"&&y.trim())return y.trim();if(O(y)){const T=h(y.name,"").trim();if(T)return T}return h(t.flair_name,"").trim()||void 0})(),m=h(t.created_at_iso,"").trim()||ze(t.created_at),d=h(t.updated_at_iso,"").trim()||(t.updated_at!==void 0?ze(t.updated_at):m),c=h(t.title,"").trim()||jl(a);return{id:e,author:n,title:c,content:a,tags:[],votes:l,vote_balance:s,comment_count:p,created_at:m,updated_at:d,flair:$,hearth_count:j(t.hearth_count,0)}}function ql(t){if(!O(t))return null;const e=h(t.id,"").trim(),n=h(t.post_id,"").trim(),a=h(t.author,"").trim();return!e||!a?null:{id:e,post_id:n,author:a,content:h(t.content,""),created_at:ze(t.created_at)}}async function Fl(t,e){return Ue("fetchBoard",async()=>{const n=new URLSearchParams;t&&n.set("sort_by",t),e!=null&&e.excludeSystem&&n.set("exclude_system","true"),n.set("limit",e!=null&&e.excludeSystem?"150":"100");const a=n.toString(),s=await Z(`/api/v1/board${a?`?${a}`:""}`),o=Array.isArray(s.posts)?s.posts.map(Oo).filter(l=>l!==null):[];return{posts:e!=null&&e.excludeSystem?zl(o):o}})}async function Kl(t){return Ue("fetchBoardPost",async()=>{const e=await Z(`/api/v1/board/${t}?format=flat`),n=O(e.post)?e.post:e,a=Oo(n)??{id:t,author:"unknown",title:"Post",content:"",tags:[],votes:0,comment_count:0,created_at:new Date().toISOString(),updated_at:new Date().toISOString()},o=(Array.isArray(e.comments)?e.comments:[]).map(ql).filter(r=>r!==null);return{...a,comments:o}})}function zo(t,e){return Ut("/api/v1/tools/masc_board_vote",{post_id:t,direction:e,vote:e,voter:vl()})}function Hl(t,e,n){return Ut("/api/v1/tools/masc_board_comment",{post_id:t,author:e,content:n})}function Ul(t){const e=h(t,"").trim().toLowerCase();if(e==="win"||e==="won"||e==="victory")return"victory";if(e==="lose"||e==="lost"||e==="defeat")return"defeat";if(e==="draw"||e==="stalemate"||e==="tie")return"draw"}function dt(...t){for(const e of t){const n=h(e,"");if(n.trim())return n.trim()}return""}function Ki(t){const e=Ul(dt(t.outcome,t.result,t.result_code));if(!e)return;const n=dt(t.reason,t.reason_code,t.description,t.detail),a=dt(t.summary,t.summary_ko,t.summary_en,t.note),s=dt(t.details,t.details_text,t.text,t.note),o=dt(t.winner,t.winner_name,t.actor_winner,t.winner_actor),r=dt(t.winner_actor_id,t.winner_actor,t.actor_winner_id),l=dt(t.raw_reason,t.raw_reason_code,t.error_message),p=(()=>{const d=t.evidence??t.evidence_ids??t.supporting_events??t.event_ids??[];return typeof d=="string"?[d]:Array.isArray(d)?d.map(v=>{if(typeof v=="string")return v.trim();if(O(v)){const c=h(v.summary,"").trim();if(c)return c;const y=h(v.text,"").trim();if(y)return y;const S=h(v.type,"").trim();return S||h(v.event_id,"").trim()}return""}).filter(v=>v.length>0):[]})(),$=(()=>{const d=j(t.turn,Number.NaN);if(Number.isFinite(d))return d;const v=j(t.turn_number,Number.NaN);if(Number.isFinite(v))return v;const c=j(t.current_turn,Number.NaN);if(Number.isFinite(c))return c;const y=j(t.round,Number.NaN);return Number.isFinite(y)?y:void 0})(),m=dt(t.phase,t.phase_name,t.current_phase,t.phase_id);return{result:e,reason:n||void 0,summary:a||void 0,details:s||void 0,winner:o||void 0,winner_actor_id:r||void 0,evidence:p.length>0?p:void 0,raw_reason:l||void 0,turn:$,phase:m||void 0}}function Bl(t,e){const n=O(t.state)?t.state:{};if(h(n.status,"active").toLowerCase()!=="ended")return;const s=[...e].reverse().find(r=>O(r)?h(r.type,"")==="session.outcome":!1),o=O(n.session_outcome)?n.session_outcome:{};if(O(o)&&Object.keys(o).length>0){const r=Ki(o);if(r)return r}if(O(s))return Ki(O(s.payload)?s.payload:{})}function O(t){return typeof t=="object"&&t!==null}function h(t,e=""){return typeof t=="string"?t:e}function j(t,e=0){return typeof t=="number"&&Number.isFinite(t)?t:e}function Wl(t){if(typeof t=="number"&&Number.isFinite(t))return Math.trunc(t);if(typeof t=="string"){const e=Number.parseInt(t.trim(),10);if(Number.isFinite(e))return e}}function Ms(t,e=!1){return typeof t=="boolean"?t:e}function Ye(t){return Array.isArray(t)?t.map(e=>{if(typeof e=="string")return e.trim();if(O(e)){const n=h(e.name,"").trim(),a=h(e.id,"").trim(),s=h(e.skill,"").trim();return n||a||s}return""}).filter(e=>e.length>0):[]}function Gl(t){const e={};if(!O(t)&&!Array.isArray(t))return e;if(O(t))return Object.entries(t).forEach(([n,a])=>{const s=n.trim(),o=h(a,"").trim();!s||!o||(e[s]=o)}),e;for(const n of t){if(!O(n))continue;const a=dt(n.to,n.target,n.actor_id,n.name,n.id),s=dt(n.relationship,n.relation,n.type,n.kind);!a||!s||(e[a]=s)}return e}function Jl(t,e,n){if(t==="dm"||t==="player"||t==="npc")return t;const a=e.trim().toLowerCase();return a==="dm"||a.startsWith("dm-")?"dm":a.startsWith("npc-")||a.startsWith("enemy-")||a.startsWith("mob-")?"npc":/^p\d+$/i.test(a)||a.startsWith("player-")?"player":typeof n=="string"&&n.trim()!==""?n.trim().toLowerCase().includes("dm")?"dm":"player":"npc"}function At(t,e,n,a=0){const s=t[e];if(typeof s=="number"&&Number.isFinite(s))return s;if(n){const o=t[n];if(typeof o=="number"&&Number.isFinite(o))return o}return a}const Vl=new Set(["str","dex","con","int","wis","cha","strength","dexterity","constitution","intelligence","wisdom","charisma","hp","max_hp","mp","max_mp","level","xp"]);function Ql(t){const e=O(t.stats)?t.stats:{},n={};return Object.entries(e).forEach(([a,s])=>{const o=a.trim();o&&(Vl.has(o.toLowerCase())||typeof s=="number"&&Number.isFinite(s)&&(n[o]=s))}),n}function Yl(t,e){if(t!=="dice.rolled")return;const n=j(e.raw_d20,0),a=j(e.total,0),s=j(e.bonus,0),o=h(e.action,"roll"),r=j(e.dc,0);return{notation:r>0?`${o} (DC ${r})`:o,rolls:n>0?[n]:[],total:a,modifier:s}}function Xl(t){const e=JSON.stringify(t);return e?e.length>160?`${e.slice(0,157)}...`:e:""}function Zl(t){const e=t.trim().toLowerCase();return e?e.startsWith("dice.")?"dice":e.startsWith("combat.")||e.includes(".attack")||e.includes(".damage")?"combat":e.includes("actor.")?"actor":e.includes("turn.")||e==="turn.started"||e==="phase.changed"?"turn":e.includes("join.")?"join":e.includes("memory")?"memory":e.includes("world.")?"world":e.includes("narration")?"story":"meta":"meta"}function tc(t,e,n,a){const s=n||e||h(a.actor_id,"")||h(a.actor_name,"");switch(t){case"turn.action.proposed":{const o=h(a.proposed_action,h(a.reply,""));return o?`${s||"actor"}: ${o}`:"Action proposed"}case"turn.action.resolved":{const o=h(a.reply,h(a.result,""));return o?`Resolved: ${o}`:"Action resolved"}case"narration.posted":return h(a.reply,h(a.content,h(a.text,"Narration")));case"dice.rolled":{const o=h(a.action,"roll"),r=j(a.total,0),l=j(a.dc,0),p=h(a.label,""),$=s||"actor",m=l>0?` vs DC ${l}`:"",d=p?` (${p})`:"";return`${$} ${o}: ${r}${m}${d}`}case"turn.started":return`Turn ${j(a.turn,1)} started`;case"phase.changed":return`Phase: ${h(a.phase,"round")}`;case"actor.spawned":return`Actor spawned: ${h(a.name,O(a.actor)?h(a.actor.name,s||"unknown"):s||"unknown")}`;case"actor.claimed":return`${h(a.keeper_name,h(a.keeper,"keeper"))} claimed ${s||"actor"}`;case"actor.released":return`${h(a.keeper_name,h(a.keeper,"keeper"))} released ${s||"actor"}`;case"join.window.opened":return`Join window opened (turn ${j(a.turn,0)})`;case"join.window.closed":return`Join window closed (turn ${j(a.turn,0)})`;case"mid.join.requested":return`Mid-join requested: ${s||h(a.actor_id,"actor")}`;case"mid.join.granted":return`Mid-join granted: ${s||h(a.actor_id,"actor")}`;case"mid.join.rejected":return`Mid-join rejected: ${h(a.reason_code,"unknown")}`;case"memory.signal":{const o=O(a.entity_refs)?a.entity_refs:{},r=h(o.requested_tier,""),l=h(o.effective_tier,""),p=Ms(o.guardrail_applied,!1),$=h(a.summary_en,h(a.summary_ko,"Memory signal"));if(!r&&!l)return $;const m=r&&l?`${r}->${l}`:l||r;return`${$} [${m}${p?" (guardrail)":""}]`}case"world.event":{if(h(a.event_type,"")==="canon.check"){const r=h(a.status,"unknown"),l=h(a.contract_id,"n/a");return`Canon ${r}: ${l}`}return h(a.description,h(a.summary,"World event"))}case"combat.attack":return h(a.summary,h(a.result,"Attack resolved"));case"combat.defense":return h(a.summary,h(a.result,"Defense resolved"));case"session.outcome":return h(a.summary,h(a.outcome,"Session ended"));default:{const o=Xl(a);return o?`${t}: ${o}`:t}}}function ec(t,e){const n=O(t)?t:{},a=h(n.type,"event"),s=typeof n.actor_id=="string"&&n.actor_id.trim()?n.actor_id.trim():"",o=h(n.actor_name,"").trim()||e[s]||h(O(n.payload)?n.payload.actor_name:"",""),r=O(n.payload)?n.payload:{},l=h(n.ts,h(n.timestamp,new Date().toISOString())),p=h(n.phase,h(r.phase,"")),$=h(n.category,"");return{type:a,actor:o||s||h(r.actor_name,""),actor_id:s||h(r.actor_id,""),actor_name:o,seq:n.seq,room_id:h(n.room_id,""),phase:p||void 0,category:$||Zl(a),visibility:h(n.visibility,h(r.visibility,"public")),event_id:h(n.event_id,""),content:tc(a,s,o,r),dice_roll:Yl(a,r),timestamp:l}}function nc(t,e,n){var vt,ft;const a=h(t.room_id,"")||n||"default",s=O(t.state)?t.state:{},o=O(s.party)?s.party:{},r=O(s.actor_control)?s.actor_control:{},l=O(s.join_gate)?s.join_gate:{},p=O(s.contribution_ledger)?s.contribution_ledger:{},$=Object.entries(o).map(([B,M])=>{const x=O(M)?M:{},It=At(x,"max_hp",void 0,10),Yt=At(x,"hp",void 0,It),le=At(x,"max_mp",void 0,0),ce=At(x,"mp",void 0,0),I=At(x,"level",void 0,1),Mt=At(x,"xp",void 0,0),de=Ms(x.alive,Yt>0),Je=r[B],Ve=typeof Je=="string"?Je:void 0,Kn=Jl(x.role,B,Ve),f=Wl(x.generation),L=dt(x.joined_at,x.joinedAt,x.started_at,x.startedAt),q=dt(x.claimed_at,x.claimedAt,x.assigned_at,x.assignedAt,x.assigned_time),st=dt(x.last_seen,x.lastSeen,x.last_seen_at,x.lastSeenAt,x.last_active,x.lastActive),z=dt(x.scene,x.current_scene,x.currentScene,x.world_scene,x.scene_name,x.sceneName),ct=dt(x.location,x.current_location,x.currentLocation,x.position,x.zone,x.area);return{id:B,name:h(x.name,B),role:Kn,keeper:Ve,archetype:h(x.archetype,""),persona:h(x.persona,""),portrait:h(x.portrait,"")||void 0,background:h(x.background,"")||void 0,traits:Ye(x.traits),skills:Ye(x.skills),stats_raw:Ql(x),status:de?"active":"dead",generation:f,joined_at:L||void 0,claimed_at:q||void 0,last_seen:st||void 0,scene:z||void 0,location:ct||void 0,inventory:Ye(x.inventory),notes:Ye(x.notes),relationships:Gl(x.relationships),stats:{hp:Yt,max_hp:It,mp:ce,max_mp:le,level:I,xp:Mt,strength:At(x,"strength","str",10),dexterity:At(x,"dexterity","dex",10),constitution:At(x,"constitution","con",10),intelligence:At(x,"intelligence","int",10),wisdom:At(x,"wisdom","wis",10),charisma:At(x,"charisma","cha",10)}}}),m=$.filter(B=>B.status!=="dead"),d=Bl(t,e),v={phase_open:Ms(l.phase_open,!0),min_points:j(l.min_points,3),window:h(l.window,"round_boundary_only"),last_opened_turn:typeof l.last_opened_turn=="number"?l.last_opened_turn:null,last_closed_turn:typeof l.last_closed_turn=="number"?l.last_closed_turn:null},c=Object.entries(p).map(([B,M])=>{const x=O(M)?M:{};return{actor_id:B,score:j(x.score,0),last_reason:h(x.last_reason,"")||null,reasons:Ye(x.reasons)}}),y=$.reduce((B,M)=>(B[M.id]=M.name,B),{}),S=e.map(B=>ec(B,y)),T=j(s.turn,1),P=h(s.phase,"round"),K=h(s.map,""),E=O(s.world)?s.world:{},N=K||h(E.ascii_map,h(E.map,"")),R=S.filter((B,M)=>{const x=e[M];if(!O(x))return!1;const It=O(x.payload)?x.payload:{};return j(It.turn,-1)===T}),X=(R.length>0?R:S).slice(-12),H=h(s.status,"active");return{session:{id:a,room:a,status:H==="ended"?"ended":H==="paused"?"paused":"active",round:T,actors:m,created_at:((vt=S[0])==null?void 0:vt.timestamp)??new Date().toISOString()},current_round:{round_number:T,phase:P,events:X,timestamp:((ft=S[S.length-1])==null?void 0:ft.timestamp)??new Date().toISOString()},map:N||void 0,join_gate:v,contribution_ledger:c,outcome:d,party:m,story_log:S,history:[]}}async function ac(t){const e=`?room_id=${encodeURIComponent(t)}`,n=await Z(`/api/v1/trpg/events${e}`);return Array.isArray(n.events)?n.events:[]}async function sc(t){const e=`?room_id=${encodeURIComponent(t)}`,[n,a]=await Promise.all([Z(`/api/v1/trpg/state${e}`),ac(t)]);return nc(n,a,t)}function ic(t){return Ut("/api/v1/trpg/rounds/run",{room_id:t})}function oc(t){const e="".trim().toLowerCase();if(e)switch(e){case"discussion":case"discuss":case"party_discussion":case"player_discussion":case"action":case"dice":return"round";case"ended":return"end";default:return e}}function rc(t){const e={room_id:t.roomId,actor_id:t.actorId,action:t.action,stat_value:t.statValue,dc:t.dc};return t.rawD20!=null&&(e.raw_d20=t.rawD20),t.ruleModule&&(e.rule_module=t.ruleModule),Ut("/api/v1/trpg/dice/roll",e)}function lc(t,e){const n=oc();return Ut("/api/v1/trpg/turns/advance",{room_id:t,...n?{phase:n}:{}})}function cc(t,e){var s;const n=(s=e.idempotencyKey)==null?void 0:s.trim(),a={room_id:t};return e.actor_id&&e.actor_id.trim()&&(a.actor_id=e.actor_id.trim()),e.name&&e.name.trim()&&(a.name=e.name.trim()),e.role&&(a.role=e.role),e.archetype&&e.archetype.trim()&&(a.archetype=e.archetype.trim()),e.persona&&e.persona.trim()&&(a.persona=e.persona.trim()),e.portrait&&e.portrait.trim()&&(a.portrait=e.portrait.trim()),e.background&&e.background.trim()&&(a.background=e.background.trim()),e.hp!=null&&(a.hp=e.hp),e.max_hp!=null&&(a.max_hp=e.max_hp),e.alive!=null&&(a.alive=e.alive),Array.isArray(e.traits)&&e.traits.length>0&&(a.traits=e.traits),Array.isArray(e.skills)&&e.skills.length>0&&(a.skills=e.skills),Array.isArray(e.inventory)&&e.inventory.length>0&&(a.inventory=e.inventory),e.stats&&Object.keys(e.stats).length>0&&(a.stats=e.stats),n&&(a.idempotency_key=n),Ut("/api/v1/trpg/actors/spawn",a,n?{"Idempotency-Key":n}:void 0)}function dc(t,e,n){return Ut("/api/v1/trpg/actors/claim",{room_id:t,actor_id:e,keeper:n})}async function uc(t,e,n){const a=await St("trpg.join.eligibility",{room_id:t,actor_id:e,...n?{keeper_name:n}:{}});return JSON.parse(a)}async function pc(t){const e=await St("trpg.mid_join.request",t);return JSON.parse(e)}async function jo(t,e){await St("masc_broadcast",{agent_name:t,message:e})}async function mc(t,e,n=1){await St("masc_add_task",{title:t,description:e,priority:n})}async function vc(t){return St("masc_join",{agent_name:t})}async function qo(t){await St("masc_leave",{agent_name:t})}async function fc(t){await St("masc_heartbeat",{agent_name:t})}async function _c(t=40){return(await St("masc_messages",{limit:t})).split(`
`).map(n=>n.trim()).filter(n=>n!=="")}async function gc(t,e=20){return St("masc_task_history",{task_id:t,limit:e})}async function $c(){return Ue("fetchDebates",async()=>{const t=await Z("/api/v1/council/debates?limit=100");return Array.isArray(t.debates)?t.debates.map(e=>{if(!O(e))return null;const n=h(e.id,"").trim(),a=h(e.topic,"").trim();return!n||!a?null:{id:n,topic:a,status:h(e.status,"open"),argument_count:j(e.argument_count,0),created_at:ze(e.created_at_iso??e.created_at)}}).filter(e=>e!==null):[]})}async function hc(){return Ue("fetchCouncilSessions",async()=>{const t=await Z("/api/v1/council/sessions?limit=100");return Array.isArray(t.sessions)?t.sessions.map(e=>{if(!O(e))return null;const n=h(e.id,"").trim(),a=h(e.topic,"").trim();return!n||!a?null:{id:n,topic:a,initiator:h(e.initiator,"system"),votes:j(e.votes,0),quorum:j(e.quorum,0),state:h(e.state,"open"),created_at:ze(e.created_at_iso??e.created_at)}}).filter(e=>e!==null):[]})}async function yc(t){const e=await St("masc_debate_start",{topic:t});try{return JSON.parse(e)}catch{return null}}async function bc(t){return Ue("fetchDebateStatus",async()=>{const e=encodeURIComponent(t),n=await Z(`/api/v1/council/debates/${e}/summary`);if(!O(n))return null;const a=h(n.id,"").trim();return a?{id:a,topic:h(n.topic,""),status:h(n.status,"open"),support_count:j(n.support_count,0),oppose_count:j(n.oppose_count,0),neutral_count:j(n.neutral_count,0),total_arguments:j(n.total_arguments,0),created_at:ze(n.created_at_iso??n.created_at),summary_text:h(n.summary_text,"")}:null})}function kc(t,e,n){return St("masc_keeper_msg",{name:t,message:e})}async function xc(){try{const t=await St("masc_goal_list",{});if(typeof t=="string"){const e=JSON.parse(t);return Array.isArray(e)?e:e.goals??[]}return Array.isArray(t)?t:t.goals??[]}catch{return[]}}const rn=_(""),Gt=_({}),ut=_({}),Os=_({}),zs=_({}),js=_({}),qs=_({}),Jt=_({});function rt(t,e,n){t.value={...t.value,[e]:n}}function Vt(t){return typeof t=="object"&&t!==null&&!Array.isArray(t)}function U(t){return typeof t=="string"&&t.trim()!==""?t.trim():void 0}function Lt(t){return typeof t=="number"&&Number.isFinite(t)?t:void 0}function Ne(t){return typeof t=="boolean"?t:void 0}function Fs(t){return typeof t=="string"&&t.trim()!==""?t:typeof t!="number"||!Number.isFinite(t)||t<=0?null:new Date(t*1e3).toISOString()}function Ks(t){return Array.isArray(t)?t.map(e=>U(e)).filter(e=>!!e):[]}function Sc(t){var n;const e=(n=U(t))==null?void 0:n.toLowerCase();return e==="user"||e==="assistant"||e==="system"||e==="tool"?e:"other"}function Ac(t){switch(t){case"user":return"User";case"assistant":return"Keeper";case"system":return"System";case"tool":return"Tool";default:return"Event"}}function es(t,e){if(!Array.isArray(t))return[];const n=[];for(const a of t){if(!Vt(a))continue;const s=U(a.name);if(!s)continue;const o=U(a[e]);e==="summary"?n.push({name:s,summary:o}):n.push({name:s,reason:o})}return n}function wc(t){if(!Vt(t))return null;const e=U(t.name);return e?{name:e,trigger:U(t.trigger),outcome:U(t.outcome),summary:U(t.summary),reason:U(t.reason)}:null}function Cc(t){const e=t.toLowerCase();return e.includes("graphql")?"graphql_error":e.includes("timeout")||e.includes("model")||e.includes("llm")||e.includes("api key")||e.includes("api_key")||e.includes("provider")?"llm_error":"unknown"}function Tc(t,e){return t==="offline"||t==="degraded"||t==="stale"?"Keeper is not in a healthy reply state. Probe or recover before relying on automation.":e==="quiet_hours"?"Lodge quiet hours are active. Direct messages still work, but scheduled social ticks may look asleep.":e==="min_gap"?"Keeper is inside its proactive cooldown window. Direct messages work now; autonomous check-ins will wait.":e==="never_started"?"Keeper metadata exists but no reply turn has been recorded yet.":"Keeper is reachable. Send a direct message for an immediate response."}function Fo(t,e,n){return U(t)??Tc(e,n)}function Ko(t,e){return typeof t=="boolean"?t:e==="recover"}function ma(t){if(!Vt(t))return null;const e=U(t.health_state),n=U(t.next_action_path),a=U(t.last_reply_status);return!e||!n||!a?null:{health_state:e,quiet_reason:U(t.quiet_reason)??null,next_action_path:n,last_reply_status:a,last_reply_at:Fs(t.last_reply_at),last_reply_preview:U(t.last_reply_preview)??null,last_error:U(t.last_error)??null,next_eligible_at_s:Lt(t.next_eligible_at_s)??null,recoverable:Ko(t.recoverable,n),summary:Fo(t.summary,e,U(t.quiet_reason)??null),keepalive_running:typeof t.keepalive_running=="boolean"?t.keepalive_running:void 0}}function yi(t){return Vt(t)?{hour:Lt(t.hour),checked:Lt(t.checked)??0,acted:Lt(t.acted)??0,acted_names:Ks(t.acted_names),activity_report:U(t.activity_report),quiet_hours_overridden:Ne(t.quiet_hours_overridden),skipped_reason:U(t.skipped_reason),acted_rows:es(t.acted_rows,"summary").map(e=>({name:e.name,summary:e.summary})),passed_rows:es(t.passed_rows,"reason").map(e=>({name:e.name,reason:e.reason})),skipped_rows:es(t.skipped_rows,"reason").map(e=>({name:e.name,reason:e.reason})),checkins:Array.isArray(t.checkins)?t.checkins.map(wc).filter(e=>e!==null):[]}:null}function Nc(t){return Vt(t)?{enabled:Ne(t.enabled)??!1,interval_s:Lt(t.interval_s)??0,quiet_start:Lt(t.quiet_start),quiet_end:Lt(t.quiet_end),quiet_active:Ne(t.quiet_active),use_planner:Ne(t.use_planner),delegate_llm:Ne(t.delegate_llm),agent_count:Lt(t.agent_count),agents:Ks(t.agents),last_tick_ago_s:Lt(t.last_tick_ago_s)??null,last_tick_ago:U(t.last_tick_ago),total_ticks:Lt(t.total_ticks),total_checkins:Lt(t.total_checkins),last_skip_reason:U(t.last_skip_reason)??null,last_tick_result:yi(t.last_tick_result),active_self_heartbeats:Ks(t.active_self_heartbeats)}:null}function Rc(t){return Vt(t)?{status:t.status,diagnostic:ma(t.diagnostic)}:null}function Lc(t){return Vt(t)?{recovered:Ne(t.recovered)??!1,skipped_reason:U(t.skipped_reason)??null,before:ma(t.before),after:ma(t.after),down:t.down,up:t.up}:null}function Pc(t,e){var K,E;if(!(t!=null&&t.name))return null;const n=U((K=t.agent)==null?void 0:K.status)??U(t.status)??"unknown",a=U((E=t.agent)==null?void 0:E.error)??null,s=t.presence_keepalive??!0,o=t.keepalive_running??!1,r=t.turn_count??0,l=t.last_turn_ago_s??null,p=t.proactive_enabled??!1,$=t.proactive_cooldown_sec??0,m=t.last_proactive_ago_s??null,d=p&&m!=null?Math.max(0,$-m):null,v=r<=0||l==null?"never":l>900?"stale":"fresh",c=typeof t.last_heartbeat=="string"&&t.last_heartbeat.trim()?t.last_heartbeat:null,y=a??(s&&!o?"keeper keepalive is not running":null),S=n==="offline"||n==="inactive"?"offline":y?"degraded":v==="stale"?"stale":v==="never"?"idle":"healthy",T=y?Cc(y):e!=null&&e.quiet_active&&v!=="fresh"?"quiet_hours":s&&!o?"disabled":r<=0?"never_started":d!=null&&d>0?"min_gap":v==="fresh"||v==="stale"?"no_recent_activity":"unknown",P=S==="offline"||S==="degraded"||S==="stale"?"recover":T==="quiet_hours"?"manual_lodge_poke":T==="unknown"?"probe":"direct_message";return{health_state:S,quiet_reason:T,next_action_path:P,last_reply_status:v,last_reply_at:c,last_reply_preview:null,last_error:y,next_eligible_at_s:d!=null&&d>0?d:null,recoverable:Ko(void 0,P),summary:Fo(void 0,S,T),keepalive_running:o}}function Dc(t,e){if(!Vt(t))return null;const n=Sc(t.role),a=U(t.content)??U(t.preview);if(!a)return null;const s=Fs(t.ts_unix)??Fs(t.timestamp);return{id:`${n}-${s??"entry"}-${e}`,role:n,label:Ac(n),text:a,timestamp:s,delivery:"history"}}function Ec(t,e,n){const a=Vt(n)?n:null,s=Array.isArray(a==null?void 0:a.history_tail)?a.history_tail.map((o,r)=>Dc(o,r)).filter(o=>o!==null):[];return{name:t,diagnostic:ma(a==null?void 0:a.diagnostic),history:s,rawText:e,rawStatus:n,loadedAt:new Date().toISOString()}}function Hi(t,e){const n=ut.value[t]??[];ut.value={...ut.value,[t]:[...n,e].slice(-50)}}function Ic(t,e){return t.role!==e.role||t.text!==e.text?!1:t.timestamp&&e.timestamp?t.timestamp===e.timestamp:!0}function Mc(t,e){const a=(ut.value[t]??[]).filter(s=>s.delivery!=="history"&&!e.some(o=>Ic(s,o)));ut.value={...ut.value,[t]:[...e,...a].slice(-50)}}function Ja(t,e){Gt.value={...Gt.value,[t]:e},Mc(t,e.history)}function Ui(t,e){const n=Gt.value[t];if(!n)return;const a=n.diagnostic??{health_state:"idle",next_action_path:"direct_message",last_reply_status:"unknown"};Ja(t,{...n,diagnostic:{...a,...e}})}async function bi(){je();try{await se()}catch(t){console.warn("[keeper-runtime] dashboard refresh failed",t)}}function ta(t){rn.value=t.trim()}async function Ho(t,e=!1){const n=t.trim();if(!n)return null;if(!e&&Gt.value[n])return Gt.value[n];rt(Os,n,!0),rt(Jt,n,null);try{const a=await St("masc_keeper_status",{name:n,fast:!1,include_context:!0,include_metrics_overview:!0,include_memory_bank:!1,include_history_tail:!0,include_compaction_history:!1,tail_turns:5,tail_messages:10});let s=null;try{s=JSON.parse(a)}catch{s=null}const o=Ec(n,a,s);return Ja(n,o),o}catch(a){const s=a instanceof Error?a.message:`Failed to inspect ${n}`;return rt(Jt,n,s),null}finally{rt(Os,n,!1)}}async function Oc(t,e){const n=t.trim(),a=e.trim();if(!n||!a)return;const s=`local-${Date.now()}`;Hi(n,{id:s,role:"user",label:"You",text:a,timestamp:new Date().toISOString(),delivery:"sending"}),rt(zs,n,!0),rt(Jt,n,null);try{const o=await kc(n,a);ut.value={...ut.value,[n]:(ut.value[n]??[]).map(r=>r.id===s?{...r,delivery:"delivered"}:r)},Hi(n,{id:`reply-${Date.now()}`,role:"assistant",label:n,text:o.trim()||"(empty reply)",timestamp:new Date().toISOString(),delivery:"delivered"}),Ui(n,{last_reply_status:"delivered",last_reply_at:new Date().toISOString(),last_reply_preview:(o.trim()||"(empty reply)").slice(0,200),last_error:null}),await bi()}catch(o){const r=o instanceof Error?o.message:`Failed to send direct message to ${n}`;throw ut.value={...ut.value,[n]:(ut.value[n]??[]).map(l=>l.id===s?{...l,delivery:"error",error:r}:l)},Ui(n,{last_reply_status:"error",last_error:r}),rt(Jt,n,r),o}finally{rt(zs,n,!1)}}async function zc(t,e){const n=t.trim();if(!n)return null;rt(js,n,!0),rt(Jt,n,null);try{const a=await jn({actor:e,action_type:"keeper_probe",target_type:"keeper",target_id:n,payload:{}}),s=Rc(a.result),o=(s==null?void 0:s.diagnostic)??null;if(o){const r=Gt.value[n];Ja(n,{name:n,diagnostic:o,history:(r==null?void 0:r.history)??ut.value[n]??[],rawText:(r==null?void 0:r.rawText)??"",rawStatus:a.result,loadedAt:new Date().toISOString()})}return await bi(),o}catch(a){const s=a instanceof Error?a.message:`Failed to probe ${n}`;throw rt(Jt,n,s),a}finally{rt(js,n,!1)}}async function jc(t,e){const n=t.trim();if(!n)return null;rt(qs,n,!0),rt(Jt,n,null);try{const a=await jn({actor:e,action_type:"keeper_recover",target_type:"keeper",target_id:n,payload:{}}),s=Lc(a.result),o=(s==null?void 0:s.after)??null;if(o){const r=Gt.value[n];Ja(n,{name:n,diagnostic:o,history:(r==null?void 0:r.history)??ut.value[n]??[],rawText:(r==null?void 0:r.rawText)??"",rawStatus:a.result,loadedAt:new Date().toISOString()})}return await bi(),o}catch(a){const s=a instanceof Error?a.message:`Failed to recover ${n}`;throw rt(Jt,n,s),a}finally{rt(qs,n,!1)}}function ue(t){return(t??"").trim().toLowerCase()}function ht(t){const e=typeof t=="number"?t:Date.parse(t);return Number.isNaN(e)?0:e}function ea(t,e=88){const n=t.replace(/\s+/g," ").trim();return n&&(n.length>e?`${n.slice(0,e-3)}...`:n)}function Hn(t){return typeof t!="number"||!Number.isFinite(t)||t<0?null:new Date(Date.now()-t*1e3).toISOString()}function Xe(t){return t.last_heartbeat??Hn(t.last_turn_ago_s)??Hn(t.last_proactive_ago_s)??Hn(t.last_handoff_ago_s)??Hn(t.last_compaction_ago_s)}function qc(t){const e=t.title.trim();return e||ea(t.content)}function Fc(t){const e=t.generation??"?",n=typeof t.context_ratio=="number"&&Number.isFinite(t.context_ratio)?`${Math.round(t.context_ratio*100)}%`:"?";return t.last_heartbeat?`Heartbeat gen=${e} ctx=${n}`:`Keeper snapshot gen=${e} ctx=${n}`}function Kc(t,e,n,a,s={}){var E;const o=ue(t),r=e.filter(N=>ue(N.assignee)===o&&(N.status==="claimed"||N.status==="in_progress")).length,l=n.filter(N=>ue(N.from)===o).sort((N,R)=>ht(R.timestamp)-ht(N.timestamp))[0],p=a.filter(N=>ue(N.agent)===o||ue(N.author)===o).sort((N,R)=>ht(R.timestamp)-ht(N.timestamp))[0],$=(s.boardPosts??[]).filter(N=>ue(N.author)===o).sort((N,R)=>ht(R.updated_at||R.created_at)-ht(N.updated_at||N.created_at))[0],m=(s.keepers??[]).filter(N=>ue(N.name)===o&&Xe(N)!==null).sort((N,R)=>ht(Xe(R)??0)-ht(Xe(N)??0))[0],d=l?ht(l.timestamp):0,v=p?ht(p.timestamp):0,c=$?ht($.updated_at||$.created_at):0,y=m?ht(Xe(m)??0):0,S=s.lastSeen?ht(s.lastSeen):0,T=((E=s.currentTask)==null?void 0:E.trim())||(r>0?`${r} claimed tasks`:null);if(d===0&&v===0&&c===0&&y===0&&S===0)return{activeAssignedCount:r,lastActivityAt:null,lastActivityText:T};const K=[l?{timestamp:l.timestamp,ts:d,text:ea(l.content)}:null,$?{timestamp:$.updated_at||$.created_at,ts:c,text:`Post: ${ea(qc($))}`}:null,m?{timestamp:Xe(m),ts:y,text:Fc(m)}:null,p?{timestamp:new Date(p.timestamp).toISOString(),ts:v,text:ea(p.text)}:null].filter(N=>N!==null).sort((N,R)=>R.ts-N.ts)[0];return K&&K.ts>=S?{activeAssignedCount:r,lastActivityAt:K.timestamp,lastActivityText:K.text}:{activeAssignedCount:r,lastActivityAt:s.lastSeen??null,lastActivityText:T??"Presence heartbeat"}}const Ct=_([]),xt=_([]),An=_([]),Qt=_([]),oe=_(null),an=_(null),Hs=_(new Map),Be=_([]),wn=_("hot"),me=_(!0),Uo=_(null),Wt=_(""),Cn=_([]),Re=_(!1),Bo=_(new Map),Us=_("unknown"),Bs=_(null),Ws=_(!1),Tn=_(!1),Gs=_(!1),Le=_(!1),Hc=_(null),Js=_(null),Wo=_(null),Go=_(null),Uc=Tt(()=>Ct.value.filter(t=>t.status==="active"||t.status==="busy"||t.status==="listening"||t.status==="idle")),Jo=Tt(()=>{const t=xt.value;return{todo:t.filter(e=>e.status==="todo"),inProgress:t.filter(e=>e.status==="in_progress"||e.status==="claimed"),done:t.filter(e=>e.status==="done")}}),Va=Tt(()=>{const t=new Map,e=xt.value,n=An.value,a=pa.value,s=Be.value,o=Qt.value;for(const r of Ct.value)t.set(r.name.trim().toLowerCase(),Kc(r.name,e,n,a,{currentTask:r.current_task,lastSeen:r.last_seen,boardPosts:s,keepers:o}));return t});function Bc(t){var o;const e=((o=t.status)==null?void 0:o.toLowerCase())??"";if(e==="offline"||e==="inactive")return"offline";const n=t.metrics_series;if(!n||n.length===0)return"idle";const a=n[n.length-1];if(!a)return"idle";if(a.is_handoff)return"handoff-imminent";if(a.is_compaction)return"compacting";const s=a.context_ratio;return s>.85?"handoff-imminent":s>.7?"preparing":s>.5?"compacting":"active"}const Vo=Tt(()=>{const t=new Map;for(const e of Qt.value)t.set(e.name,Bc(e));return t}),Wc=12e4;function Gc(t,e){const n=e.get(t.name);if(n!=null)return n;const a=t.last_heartbeat?Date.parse(t.last_heartbeat):Number.NaN;if(!Number.isNaN(a))return a;const s=[t.last_turn_ago_s,t.last_proactive_ago_s,t.last_handoff_ago_s,t.last_compaction_ago_s].find(o=>typeof o=="number"&&Number.isFinite(o)&&o>=0);return typeof s=="number"?Date.now()-s*1e3:null}const Qo=Tt(()=>{const t=Date.now(),e=new Set,n=Hs.value;for(const a of Qt.value){const s=Gc(a,n);s!=null&&t-s>Wc&&e.add(a.name)}return e}),va={},Jc=5e3;let ns=null;function Vc(t){return t==="dashboard_refresh"||t==="masc/dashboard_refresh"||t.startsWith("goal_")||t.startsWith("masc/goal_")||t.startsWith("mdal_")||t.startsWith("masc/mdal_")||t.startsWith("operator_")||t.startsWith("masc/operator_")||t.startsWith("command_plane_")||t.startsWith("masc/command_plane_")}function je(){delete va.compact,delete va.full}function pt(t){return typeof t=="object"&&t!==null}function b(t){return typeof t=="string"&&t.trim()!==""?t:void 0}function A(t){return typeof t=="number"&&Number.isFinite(t)?t:void 0}function $e(t){if(!Array.isArray(t))return;const e=t.filter(n=>typeof n=="string"&&n.trim()!=="");return e.length>0?e:void 0}function Nn(t){if(typeof t=="string"&&t.trim()!=="")return t;if(!(typeof t!="number"||!Number.isFinite(t)||t<=0))return new Date(t*1e3).toISOString()}function Yo(t){const e=typeof t=="string"?t.toLowerCase():"";return e==="active"||e==="busy"||e==="listening"||e==="idle"||e==="inactive"||e==="offline"?e:e==="in_progress"||e==="claimed"?"busy":"offline"}function Qc(t){const e=typeof t=="string"?t.toLowerCase():"";return e==="todo"||e==="in_progress"||e==="claimed"||e==="done"||e==="cancelled"?e:e==="inprogress"?"in_progress":"todo"}function Xo(t){if(!pt(t))return null;const e=b(t.name);return e?{name:e,status:Yo(t.status),current_task:b(t.current_task)??null,last_seen:b(t.last_seen),emoji:b(t.emoji),koreanName:b(t.koreanName)??b(t.korean_name),model:b(t.model),traits:$e(t.traits),interests:$e(t.interests),activityLevel:A(t.activityLevel)??A(t.activity_level),primaryValue:b(t.primaryValue)??b(t.primary_value)}:null}function Zo(t){if(!pt(t))return null;const e=b(t.id),n=b(t.title);return!e||!n?null:{id:e,title:n,status:Qc(t.status),priority:A(t.priority),assignee:b(t.assignee),description:b(t.description),created_at:b(t.created_at),updated_at:b(t.updated_at)}}function tr(t){if(!pt(t))return null;const e=b(t.from)??b(t.from_agent)??"system",n=b(t.content)??"",a=b(t.timestamp)??new Date().toISOString();return{id:b(t.id),seq:A(t.seq),from:e,content:n,timestamp:a,type:b(t.type)}}function Yc(t){return Array.isArray(t)?t.map(e=>{if(!pt(e))return null;const n=A(e.ts_unix);if(n==null)return null;const a=pt(e.handoff)?e.handoff:null;return{ts:n,context_ratio:A(e.context_ratio)??0,context_tokens:A(e.context_tokens)??0,context_max:A(e.context_max)??0,latency_ms:A(e.latency_ms)??0,generation:A(e.generation)??0,channel:typeof e.channel=="string"?e.channel:"turn",is_handoff:a!=null&&e.handoff_performed===!0,is_compaction:e.compacted===!0,compaction_saved_tokens:A(e.compaction_saved_tokens)??0,compaction_trigger:typeof e.compaction_trigger=="string"?e.compaction_trigger:null,model_used:typeof e.model_used=="string"?e.model_used:"",cost_usd:A(e.cost_usd)??0,handoff_to_model:a&&typeof a.to_model=="string"?a.to_model:null,handoff_new_generation:a?A(a.new_generation)??null:null}}).filter(e=>e!==null):[]}function Bi(t){if(!pt(t))return null;const e=b(t.health_state),n=b(t.next_action_path),a=b(t.last_reply_status);if(!e||!n||!a)return null;const s=b(t.quiet_reason)??null,o=b(t.summary)??(e==="offline"||e==="degraded"||e==="stale"?"Keeper is not in a healthy reply state. Probe or recover before relying on automation.":s==="quiet_hours"?"Lodge quiet hours are active. Direct messages still work, but scheduled social ticks may look asleep.":s==="min_gap"?"Keeper is inside its proactive cooldown window. Direct messages work now; autonomous check-ins will wait.":s==="never_started"?"Keeper metadata exists but no reply turn has been recorded yet.":"Keeper is reachable. Send a direct message for an immediate response.");return{health_state:e,quiet_reason:s,next_action_path:n,last_reply_status:a,last_reply_at:Nn(t.last_reply_at)??b(t.last_reply_at)??null,last_reply_preview:b(t.last_reply_preview)??null,last_error:b(t.last_error)??null,next_eligible_at_s:A(t.next_eligible_at_s)??null,recoverable:typeof t.recoverable=="boolean"?t.recoverable:n==="recover",summary:o,keepalive_running:typeof t.keepalive_running=="boolean"?t.keepalive_running:void 0}}function Xc(t,e){return(Array.isArray(t)?t:pt(t)&&Array.isArray(t.keepers)?t.keepers:[]).map(a=>{if(!pt(a))return null;const s=pt(a.agent)?a.agent:null,o=pt(a.context)?a.context:null,r=pt(a.metrics_window)?a.metrics_window:void 0,l=b(a.name);if(!l)return null;const p=A(a.context_ratio)??A(o==null?void 0:o.context_ratio),$=b(a.status)??b(s==null?void 0:s.status)??"offline",m=Yo($),d=b(a.model)??b(a.active_model)??b(a.primary_model),v=$e(a.skill_secondary),c=o?{source:b(o.source),context_ratio:A(o.context_ratio),context_tokens:A(o.context_tokens),context_max:A(o.context_max),message_count:A(o.message_count),has_checkpoint:typeof o.has_checkpoint=="boolean"?o.has_checkpoint:void 0}:void 0,y=s?{name:b(s.name),exists:typeof s.exists=="boolean"?s.exists:void 0,error:b(s.error),status:b(s.status),current_task:b(s.current_task)??null,last_seen:b(s.last_seen),last_seen_ago_s:A(s.last_seen_ago_s),is_zombie:typeof s.is_zombie=="boolean"?s.is_zombie:void 0}:void 0,S=Yc(a.metrics_series),T={name:l,emoji:b(a.emoji),koreanName:b(a.koreanName)??b(a.korean_name),agent_name:b(a.agent_name),trace_id:b(a.trace_id),model:d,primary_model:b(a.primary_model),active_model:b(a.active_model),next_model_hint:b(a.next_model_hint)??null,status:m,presence_keepalive:typeof a.presence_keepalive=="boolean"?a.presence_keepalive:void 0,presence_keepalive_sec:A(a.presence_keepalive_sec),keepalive_running:typeof a.keepalive_running=="boolean"?a.keepalive_running:void 0,proactive_enabled:typeof a.proactive_enabled=="boolean"?a.proactive_enabled:void 0,reactive_enabled:typeof a.reactive_enabled=="boolean"?a.reactive_enabled:void 0,proactive_idle_sec:A(a.proactive_idle_sec),proactive_cooldown_sec:A(a.proactive_cooldown_sec),last_heartbeat:b(a.last_heartbeat)??b(s==null?void 0:s.last_seen),generation:A(a.generation),turn_count:A(a.turn_count)??A(a.total_turns),keeper_age_s:A(a.keeper_age_s),last_turn_ago_s:A(a.last_turn_ago_s),last_handoff_ago_s:A(a.last_handoff_ago_s),last_compaction_ago_s:A(a.last_compaction_ago_s),last_proactive_ago_s:A(a.last_proactive_ago_s),last_successful_reaction_at:Nn(a.last_successful_reaction_at)??b(a.last_successful_reaction_at)??null,last_successful_reaction_summary:b(a.last_successful_reaction_summary)??null,last_handled_event_id:b(a.last_handled_event_id)??null,last_handled_event_ts:Nn(a.last_handled_event_ts)??b(a.last_handled_event_ts)??null,pending_reactive_items:A(a.pending_reactive_items),inbox_latest_summary:b(a.inbox_latest_summary)??null,continuity_summary:b(a.continuity_summary)??null,timeout_streak:A(a.timeout_streak),recent_provider_failures:A(a.recent_provider_failures),recent_fallback_rate:A(a.recent_fallback_rate),context_ratio:p,context_tokens:A(a.context_tokens)??A(o==null?void 0:o.context_tokens),context_max:A(a.context_max)??A(o==null?void 0:o.context_max),context_source:b(a.context_source)??b(o==null?void 0:o.source),context:c,traits:$e(a.traits),interests:$e(a.interests),primaryValue:b(a.primaryValue)??b(a.primary_value),activityLevel:A(a.activityLevel)??A(a.activity_level),memory_recent_note:b(a.memory_recent_note)??null,conversation_tail_count:A(a.conversation_tail_count),k2k_count:A(a.k2k_count),handoff_count_total:A(a.handoff_count_total)??A(a.trace_history_count),compaction_count:A(a.compaction_count),last_compaction_saved_tokens:A(a.last_compaction_saved_tokens),diagnostic:Bi(a.diagnostic),skill_primary:b(a.skill_primary)??null,skill_secondary:v,skill_reason:b(a.skill_reason)??null,metrics_series:S.length>0?S:void 0,metrics_window:r,agent:y};return T.diagnostic=Bi(a.diagnostic)??Pc(T,(e==null?void 0:e.lodge)??null),T}).filter(a=>a!==null)}function Zc(t){return pt(t)?{...t,lodge:Nc(t.lodge)??void 0}:null}function td(t){const e=typeof t=="string"?t.toLowerCase():"";return e==="running"||e==="interrupted"||e==="completed"||e==="stopped"||e==="error"?e:e.startsWith("error")?"error":"running"}function ed(t){if(!pt(t))return null;const e=A(t.iteration);if(e==null)return null;const n=A(t.metric_before)??0,a=A(t.metric_after)??n,s=pt(t.evidence)?t.evidence:null;return{iteration:e,metric_before:n,metric_after:a,delta:A(t.delta)??a-n,changes:b(t.changes)??"",failed_attempts:b(t.failed_attempts)??"",next_suggestion:b(t.next_suggestion)??"",elapsed_ms:A(t.elapsed_ms)??0,cost_usd:A(t.cost_usd)??null,evidence:s?{worker_engine:(s.worker_engine==="api_tool_loop","api_tool_loop"),worker_model:b(s.worker_model)??"",tool_call_count:A(s.tool_call_count)??0,tool_names:$e(s.tool_names)??[],session_id:b(s.session_id)??"",evidence_status:s.evidence_status==="legacy_unverified"?"legacy_unverified":"verified"}:null}}function nd(t){var o,r;if(!pt(t))return null;const e=b(t.loop_id);if(!e)return null;const n=A(t.baseline_metric)??0,a=Array.isArray(t.history)?t.history.map(ed).filter(l=>l!==null):[],s=A(t.current_metric)??((o=a[0])==null?void 0:o.metric_after)??n;return{loop_id:e,profile:b(t.profile)??"unknown",status:td(t.status),strict_mode:typeof t.strict_mode=="boolean"?t.strict_mode:void 0,error_message:b(t.error_message)??b(t.error_reason)??null,stop_reason:b(t.stop_reason)??b(t.reason)??null,current_iteration:A(t.current_iteration)??((r=a[0])==null?void 0:r.iteration)??0,max_iterations:A(t.max_iterations)??0,baseline_metric:n,current_metric:s,target:b(t.target)??"",stagnation_streak:A(t.stagnation_streak)??0,stagnation_limit:A(t.stagnation_limit)??0,elapsed_seconds:A(t.elapsed_seconds)??0,updated_at:Nn(t.updated_at)??null,stopped_at:Nn(t.stopped_at)??null,execution_mode:t.execution_mode==="worker_spawn"?"worker_spawn":void 0,worker_engine:t.worker_engine==="api_tool_loop"?"api_tool_loop":null,worker_model:b(t.worker_model)??null,evidence_policy:t.evidence_policy==="hard"||t.evidence_policy==="legacy"?t.evidence_policy:void 0,latest_tool_call_count:A(t.latest_tool_call_count)??0,latest_tool_names:$e(t.latest_tool_names)??[],session_id:b(t.session_id)??null,evidence_status:t.evidence_status==="legacy_unverified"?"legacy_unverified":t.evidence_status==="verified"?"verified":null,durability:t.durability==="persistent_backend"||t.durability==="memory_only"?t.durability:void 0,persistence_backend:t.persistence_backend==="filesystem"||t.persistence_backend==="postgres"||t.persistence_backend==="memory"?t.persistence_backend:void 0,recoverable:typeof t.recoverable=="boolean"?t.recoverable:void 0,history:a}}async function se(t="full"){var a,s,o;const e=Date.now(),n=va[t];if(!(n&&e-n.time<Jc)){Ws.value=!0;try{const r=await bl(t);va[t]={data:r,time:e},Ct.value=(Array.isArray((a=r.agents)==null?void 0:a.agents)?r.agents.agents:[]).map(Xo).filter(p=>p!==null),xt.value=(Array.isArray((s=r.tasks)==null?void 0:s.tasks)?r.tasks.tasks:[]).map(Zo).filter(p=>p!==null),An.value=(Array.isArray((o=r.messages)==null?void 0:o.messages)?r.messages.messages:[]).map(tr).filter(p=>p!==null);const l=Zc(r.status);oe.value=l,Qt.value=Xc(r.keepers,l),an.value=r.perpetual??null,Hc.value=new Date().toISOString()}catch(r){console.error("Dashboard fetch error:",r)}finally{Ws.value=!1}}}async function ad(){try{const t=await kl(),e=(Array.isArray(t.agents)?t.agents:[]).map(Xo).filter(s=>s!==null),n=Ct.value,a=new Map(n.map(s=>[s.name,s]));Ct.value=e.map(s=>{const o=a.get(s.name);return o?{...o,status:s.status,current_task:s.current_task}:s})}catch(t){console.error("Agents selective fetch error:",t)}}async function sd(){try{const t=await xl({includeDone:!0,includeCancelled:!0}),e=(Array.isArray(t.tasks)?t.tasks:[]).map(Zo).filter(s=>s!==null),n=xt.value,a=new Map(n.map(s=>[s.id,s]));xt.value=e.map(s=>{const o=a.get(s.id);return o?{...o,status:s.status,priority:s.priority??o.priority,assignee:s.assignee??o.assignee}:s})}catch(t){console.error("Tasks selective fetch error:",t)}}async function id(){try{const t=An.value,e=t.reduce((l,p)=>Math.max(l,p.seq??0),0),n=await Sl(e),a=(Array.isArray(n.messages)?n.messages:[]).map(tr).filter(l=>l!==null);if(a.length===0)return;const s=new Set(t.map(l=>l.seq).filter(l=>l!=null)),o=new Set(t.filter(l=>l.seq==null).map(l=>`${l.timestamp}|${l.from}`)),r=a.filter(l=>{if(l.seq!=null)return!s.has(l.seq);const p=`${l.timestamp}|${l.from}`;return o.has(p)?!1:(o.add(p),!0)});if(r.length>0){const l=[...t,...r];An.value=l.length>500?l.slice(-500):l}}catch(t){console.error("Messages selective fetch error:",t)}}async function Ft(){Tn.value=!0;try{const t=await Fl(wn.value,{excludeSystem:me.value});Be.value=t.posts??[],Js.value=new Date().toISOString()}catch(t){console.error("Board fetch error:",t)}finally{Tn.value=!1}}async function Kt(){var t;Gs.value=!0;try{const e=Wt.value||((t=oe.value)==null?void 0:t.room)||"default";Wt.value||(Wt.value=e);const n=await sc(e);Uo.value=n}catch(e){console.error("TRPG fetch error:",e)}finally{Gs.value=!1}}async function Rn(){Re.value=!0;try{const t=await xc();Cn.value=Array.isArray(t)?t:[],Wo.value=new Date().toISOString()}catch(t){console.error("Goals fetch error:",t)}finally{Re.value=!1}}async function qe(){Le.value=!0;try{const t=await Al(),e=Array.isArray(t.loops)?t.loops:[],n=new Map;for(const a of e){const s=nd(a);s&&n.set(s.loop_id,s)}Bo.value=n,Go.value=new Date().toISOString(),Bs.value=null,Us.value=n.size===0?"idle":"ready"}catch(t){console.error("MDAL fetch error:",t),Us.value="error",Bs.value=t instanceof Error?t.message:String(t)}finally{Le.value=!1}}let na=null;function od(t){na=t}let aa=null;function rd(t){aa=t}const ve={};function pe(t,e,n=500){ve[t]&&clearTimeout(ve[t]),ve[t]=setTimeout(()=>{e(),delete ve[t]},n)}function ld(){const t=Lo.subscribe(e=>{if(e){if(e.type==="keeper_heartbeat"&&e.name){const n=new Map(Hs.value);n.set(e.name,e.ts_unix?e.ts_unix*1e3:Date.now()),Hs.value=n;return}(e.type==="agent_joined"||e.type==="agent_left")&&pe("agents",ad),Vc(e.type)&&(je(),ns||(ns=setTimeout(()=>{se(),aa==null||aa(),ns=null},500))),(e.type.startsWith("task_")||e.type.startsWith("masc/task_"))&&pe("tasks",sd),e.type==="broadcast"&&pe("messages",id),(e.type==="keeper_handoff"||e.type==="keeper_compaction"||e.type==="keeper_guardrail")&&pe("dashboard",()=>{je(),se()}),(e.type==="board_post"||e.type==="masc/board_post"||e.type==="board_comment"||e.type==="masc/board_comment")&&pe("board",Ft),e.type.startsWith("decision_")&&pe("council",()=>na==null?void 0:na()),(e.type==="mdal_started"||e.type==="mdal_iteration"||e.type==="mdal_completed"||e.type==="mdal_stopped")&&pe("mdal",qe,350)}});return()=>{t();for(const e of Object.keys(ve))clearTimeout(ve[e]),delete ve[e]}}let ln=null;function cd(){ln||(ln=setInterval(()=>{Ht.value||je(),se()},1e4))}function dd(){ln&&(clearInterval(ln),ln=null)}function C({title:t,class:e,children:n}){return i`
    <div class="card ${e??""}">
  ...
  `}function ud(t){const e=Date.now(),n=typeof t=="number"?t<1e12?t*1e3:t:new Date(t).getTime(),a=Math.floor((e-n)/1e3);if(a<60)return`${a}s ago`;const s=Math.floor(a/60);if(s<60)return`${s}m ago`;const o=Math.floor(s/60);return o<24?`${o}h ago`:`${Math.floor(o/24)}d ago`}function F({timestamp:t}){const e=ud(t),n=typeof t=="string"?t:new Date(t<1e12?t*1e3:t).toISOString();return i`<span class="time-ago" title=${n}>${e}</span>`}function Y(t){if(t==null)return 0;const e=typeof t=="number"?t:Date.parse(t);return Number.isNaN(e)?0:e}function it(t){switch(t){case"bad":return 2;case"warn":return 1;default:return 0}}function fe(t){return(t??"").trim().toLowerCase()}function et(t,e=96){const n=(t??"").replace(/\s+/g," ").trim();return n?n.length>e?`${n.slice(0,e-3)}...`:n:null}function qt(t){return typeof t!="number"||Number.isNaN(t)?3:t}function ki(t){const e=qt(t);return e<=1?"P1":e===2?"P2":e>=4?"P4+":"P3"}let pd=0;const _e=_([]);function w(t,e="success",n=4e3){const a=++pd;_e.value=[..._e.value,{id:a,message:t,type:e}],setTimeout(()=>{_e.value=_e.value.filter(s=>s.id!==a)},n)}function md(t){_e.value=_e.value.filter(e=>e.id!==t)}function vd(){const t=_e.value;return t.length===0?null:i`
  ...
  `}const fd="masc_dashboard_agent_name",We=_(null),fa=_(!1),Ln=_(""),_a=_([]),Pn=_([]),Ee=_(""),cn=_(!1);function Ie(t){We.value=t,xi()}function Wi(){We.value=null,Ln.value="",_a.value=[],Pn.value=[],Ee.value=""}function _d(){const t=We.value;return t?Ct.value.find(e=>e.name===t)??null:null}function er(t){return t?xt.value.filter(e=>e.assignee===t):[]}async function xi(){const t=We.value;if(t){fa.value=!0,Ln.value="",_a.value=[],Pn.value=[];try{const e=await _c(80);_a.value=e.filter(s=>s.includes(t)).slice(0,20);const n=er(t).slice(0,6);if(n.length===0)return;const a=await Promise.all(n.map(async s=>{try{const o=await gc(s.id,25);return{taskId:s.id,text:o.trim()}}catch(o){const r=o instanceof Error?o.message:"history load failed";return{taskId:s.id,text:`Failed to load history: ${r}`}}}));Pn.value=a}catch(e){Ln.value=e instanceof Error?e.message:"Failed to load agent detail"}finally{fa.value=!1}}}async function Gi(){var a;const t=We.value,e=Ee.value.trim();if(!t||!e)return;const n=((a=localStorage.getItem(fd))==null?void 0:a.trim())||"dashboard";cn.value=!0;try{await jo(n,`@${t} ${e}`),Ee.value="",w(`Mention sent to ${t}`,"success"),xi()}catch(s){const o=s instanceof Error?s.message:"Failed to send mention";w(o,"error")}finally{cn.value=!1}}function gd({task:t}){return i`
  ...
  `}function hd(){var s,o,r,l;const t=We.value;if(!t)return null;const e=_d(),n=er(t),a=_a.value;return i`
    <div
      ...
      <div class="agent-detail-modal">
        <div class="agent-detail-header">
          ...
          <div class="agent-detail-actions">
            <button class="control-btn ghost" onClick=${()=>{xi()}} disabled=${fa.value}>
        ...
        <${C} title="Task History">
          ${Pn.value.length===0?i`<div class="empty-state">No task history loaded</div>`:i`<div class="agent-history-list">${Pn.value.map(p=>i`<${$d} key=${p.taskId} row=${p} />`)}</div>`}
        <//>
  ...
  `}const ga=600*1e3,sa=1200*1e3;function nr(t){switch(t){case"in_progress":return"In Progress";case"claimed":return"Claimed";case"done":return"Done";case"cancelled":return"Cancelled";default:return"Todo"}}function ar(t){switch(t){case"dispatchable":return"Dispatch";case"drift":return"Drift";case"quiet":return"Quiet";case"offline":return"Offline";default:return"Loaded"}}function yd(t){return t.updated_at??t.created_at??null}function Ji(t,e,n){var T,P;const a=fe(t.assignee),s=a?e.get(a)??null:null,o=s?n.get(a)??null:null,r=(o==null?void 0:o.lastActivityAt)??(s==null?void 0:s.last_seen)??null,l=r?Math.max(0,Date.now()-Y(r)):Number.POSITIVE_INFINITY,p=et(t.description),$=et(s==null?void 0:s.current_task)??(o==null?void 0:o.lastActivityText)??null,m=t.status==="claimed"||t.status==="in_progress";let d="ok",v="Fresh owner coverage",c=$??p??t.id,y=!1,S=!1;return t.status==="todo"?t.assignee?s?s.status==="offline"||s.status==="inactive"?(y=!0,d="bad",v="Assigned owner is offline",c="Queue item is blocked until ownership changes."):l>ga?(d="warn",v="Owner exists but live signal is quiet",c=$??"Owner may need a nudge before pickup."):((o==null?void 0:o.activeAssignedCount)??0)>0||(T=s.current_task)!=null&&T.trim()?(d="warn",v="Owner is already carrying active work",c=$??`${(o==null?void 0:o.activeAssignedCount)??0} active tasks already assigned.`):(v="Ready and covered by a fresh operator",c=$??p??"This can be picked up immediately."):(y=!0,d="bad",v="Assigned owner is not present in the room",c="Reassign or bring the owner back online."):(y=!0,d=qt(t.priority)<=2?"bad":"warn",v=qt(t.priority)<=2?"Urgent ready work has no owner":"Ready work has no owner",c="Assign an agent before this queue item slips."):m&&(t.assignee?s?s.status==="offline"||s.status==="inactive"?(y=!0,d="bad",v="Assigned owner is offline",c=$??"Execution has no live operator right now."):l>sa?(S=!0,d="bad",v="Assigned owner has gone quiet",c=$??"Fresh operator signal is missing."):l>ga?(S=!0,d="warn",v="Execution has been quiet for too long",c=$??"Check whether this work is blocked."):(P=s.current_task)!=null&&P.trim()?(v="Execution has fresh owner coverage",c=$??p??t.id):(d="warn",v=t.status==="claimed"?"Claimed work is waiting for explicit focus":"Owner is live but current_task is empty",c=$??"Task state and agent focus are drifting apart."):(y=!0,d="bad",v="Assigned owner is not active in the room",c="Execution is orphaned until ownership is restored."):(y=!0,d="bad",v="Active work has no assignee",c="Claim or reassign this task immediately.")),{task:t,assigneeAgent:s,motion:o,tone:d,note:v,focus:c,lastSignalAt:r,lastTouchedAt:yd(t),ownerGap:y,quiet:S}}function bd(t,e){var v;const n=e.get(fe(t.name))??{activeAssignedCount:0,lastActivityAt:null,lastActivityText:null},a=n.lastActivityAt??t.last_seen??null,s=a?Math.max(0,Date.now()-Y(a)):Number.POSITIVE_INFINITY,o=!!((v=t.current_task)!=null&&v.trim()),r=n.activeAssignedCount,l=o||r>0;let p="loaded",$="ok",m="Healthy active load",d=et(t.current_task)??n.lastActivityText??"Ready for assignment";return t.status==="offline"||t.status==="inactive"?(p="offline",$="bad",m="Agent is unavailable"):l&&s>sa?(p="quiet",$="bad",m="Working without a fresh signal"):r>0&&!o?(p="drift",$="warn",m="Claimed work exists but current_task is empty",d=`${r} active tasks need explicit focus.`):o&&r===0?(p="drift",$="warn",m="current_task has no matching claimed work",d=et(t.current_task)??"Task metadata and operator state drifted."):!l&&s<=ga?(p="dispatchable",$="ok",m="Fresh signal and no active load",d=n.lastActivityText??"Ready for assignment."):l?s>ga&&(p="loaded",$="warn",m="Execution load is healthy but slightly quiet",d=et(t.current_task)??`${r} active tasks in flight.`):(p="quiet",$=s>sa?"bad":"warn",m=s>sa?"No fresh signal while idle":"Reachable, but not freshly active",d=n.lastActivityText??"Likely available after a quick check-in."),{agent:t,motion:n,tone:$,state:p,note:m,focus:d,lastSignalAt:a,activeTaskCount:r}}function Ze({label:t,value:e,color:n,caption:a}){return i`
    <div class="stat-card">
    ...
    <div class="execution-alert ${t.tone}">
      ...
      <div class="monitor-alert-meta">
        <span class="monitor-pill ${t.tone}">
          ${t.kind==="task"?ki(t.taskRow.task.priority):ar(t.agentRow.state)}
        </span>
  ...
  `}function Vi({row:t}){var e;return i`
    <div class="execution-task-row ${t.tone}">
      <div class="monitor-row-header">
        <span class="monitor-pill ${t.tone}">${ki(t.task.priority)}</span>
      ...
      ${(e=t.assigneeAgent)!=null&&e.current_task&&et(t.assigneeAgent.current_task)!==t.focus?i`<div class="monitor-footnote">Owner focus: ${et(t.assigneeAgent.current_task)}</div>`:null}
    </div>
  ...
  `}function Sd(){const t=Ct.value,e=xt.value,n=new Map(t.map(d=>[fe(d.name),d])),a=Va.value,s=e.filter(d=>d.status==="claimed"||d.status==="in_progress").map(d=>Ji(d,n,a)).sort((d,v)=>{const c=it(v.tone)-it(d.tone);return c!==0?c:Y(v.lastSignalAt??v.lastTouchedAt)-Y(d.lastSignalAt??d.lastTouchedAt)}),o=e.filter(d=>d.status==="todo").map(d=>Ji(d,n,a)).sort((d,v)=>{const c=it(v.tone)-it(d.tone);if(c!==0)return c;const y=qt(d.task.priority)-qt(v.task.priority);return y!==0?y:Y(d.lastTouchedAt)-Y(v.lastTouchedAt)}),r=t.map(d=>bd(d,a)).filter(d=>d.state==="dispatchable"||d.state==="drift"||d.state==="quiet").sort((d,v)=>{if(d.state==="dispatchable"&&v.state!=="dispatchable")return-1;if(v.state==="dispatchable"&&d.state!=="dispatchable")return 1;const c=it(v.tone)-it(d.tone);return c!==0?c:Y(v.lastSignalAt)-Y(d.lastSignalAt)}),l=[...s.filter(d=>d.tone!=="ok").map(d=>({kind:"task",key:`active-${d.task.id}`,tone:d.tone,title:d.task.title,subtitle:`${d.note} · ${d.focus}`,timestamp:d.lastSignalAt??d.lastTouchedAt,taskRow:d})),...o.filter(d=>d.tone==="bad").map(d=>({kind:"task",key:`ready-${d.task.id}`,tone:d.tone,title:d.task.title,subtitle:`${d.note} · ${d.focus}`,timestamp:d.lastTouchedAt,taskRow:d})),...r.filter(d=>d.state==="drift"||d.tone==="bad").map(d=>({kind:"agent",key:`agent-${d.agent.name}`,tone:d.tone,title:d.agent.name,subtitle:`${d.note} · ${d.focus}`,timestamp:d.lastSignalAt,agentRow:d}))].sort((d,v)=>{const c=it(v.tone)-it(d.tone);return c!==0?c:Y(v.timestamp)-Y(d.timestamp)}).slice(0,8),p=r.filter(d=>d.state==="dispatchable"),$=[...s,...o].filter(d=>d.ownerGap),m=s.filter(d=>d.quiet);return i`
  ...
  `}function Ad(t){switch(t){case"quiet_hours":return"quiet hours";case"min_gap":return"cooldown gate";case"no_recent_activity":return"waiting for activity";case"disabled":return"runtime disabled";case"startup":return"warming up";case"llm_error":return"llm error";case"graphql_error":return"graphql error";case"never_started":return"never started";default:return"unknown"}}function wd(t){switch(t){case"manual_lodge_poke":return"Poke Lodge";case"probe":return"Probe";case"recover":return"Recover";default:return"Message"}}function Cd(t){switch(t.delivery){case"sending":return"sending";case"timeout":return"timeout";case"error":return"error";case"delivered":return"delivered";default:return t.role}}function Qi(t){return t.delivery==="error"||t.delivery==="timeout"?"bad":t.delivery==="sending"?"warn":t.role==="assistant"?"assistant":t.role==="user"?"user":"warn"}function sr(t){if(!t)return null;const e=new Date(t);return Number.isNaN(e.getTime())?null:e.toLocaleTimeString()}function Td(t){return typeof t!="number"||!Number.isFinite(t)||t<=0?null:t<60?`${Math.round(t)}s`:`${Math.ceil(t/60)}m`}function ir(t){if(!t)return null;const e=Gt.value[t.name];return(e==null?void 0:e.diagnostic)??t.diagnostic??null}function or({keeper:t,showRawStatus:e=!1}){if(lt(()=>{t!=null&&t.name&&Ho(t.name)},[t==null?void 0:t.name]),!t)return i`<div class="control-status-copy">Select a keeper to inspect direct reply state.</div>`;const n=Gt.value[t.name],a=ir(t),s=Os.value[t.name];return i`
  ...
  `}function rr({keeperName:t,placeholder:e}){const[n,a]=Ga("");lt(()=>{t&&Ho(t)},[t]);const s=ut.value[t]??[],o=zs.value[t]??!1,r=Jt.value[t],l=async()=>{const p=n.trim();if(!(!t||!p)){a("");try{await Oc(t,p)}catch($){const m=$ instanceof Error?$.message:`Failed to message ${t}`;w(m,"error")}}};return i`
  ...
  `}function lr({actor:t,keeper:e,onPokeLodge:n}){if(!e)return null;const a=ir(e),s=js.value[e.name]??!1,o=qs.value[e.name]??!1,r=(a==null?void 0:a.next_action_path)??"direct_message",l=(a==null?void 0:a.recoverable)??r==="recover";return i`
    <div class="control-actions">
      <button
  ...
  `}function cr(){const t=new URLSearchParams(window.location.search),e=t.get("agent")??t.get("agent_name"),n=localStorage.getItem("masc_dashboard_agent_name");return(e??n??"dashboard").trim()||"dashboard"}async function zd(){try{const t=await jn({actor:cr(),action_type:"lodge_tick",target_type:"room",payload:{}}),e=yi(t.result);je(),await se(),e!=null&&e.skipped_reason?w(e.skipped_reason,"warning"):w(e?`Poke finished: ${e.acted}/${e.checked} acted`:"Poke finished",e&&e.acted>0?"success":"warning")}catch(t){const e=t instanceof Error?t.message:"Failed to run Lodge poke";w(e,"error")}}function jd({keeper:t}){return i`
  ...
  `}function qd(){var e,n,a;const t=Si.value;return t?i`
    <div
  ...
  `}function cs({tone:t,title:e,subtitle:n,meta:a,focus:s,onClick:o}){return i`
  ...
  `}function so(){var X,H,Et,vt,ft,B,M,x,It,Yt,le,ce,I,Mt,de,Je,Ve,Kn;const t=oe.value,e=Ct.value,n=xt.value,a=Qt.value,s=Jo.value,o=(X=t==null?void 0:t.monitoring)==null?void 0:X.board,r=(H=t==null?void 0:t.monitoring)==null?void 0:H.council,l=Ht.value,p=new Map(e.map(f=>[fe(f.name),f])),$=Va.value,m=e.map(f=>{var Qe;const L=$.get(fe(f.name))??{activeAssignedCount:0,lastActivityAt:null,lastActivityText:null},q=L.lastActivityAt??f.last_seen??null,st=q?Math.max(0,Date.now()-Y(q)):Number.POSITIVE_INFINITY,z=L.activeAssignedCount,ct=!!((Qe=f.current_task)!=null&&Qe.trim()),tt=ct||z>0;let Q="ok",_t="Fresh and ready",gt=!1,$t=!1;return f.status==="offline"||f.status==="inactive"?(Q=tt?"bad":"warn",_t=tt?"Load without an available owner":"Offline"):tt&&st>os?(Q="bad",_t="Execution is stale"):z>0&&!ct?(Q="warn",_t="Claimed work has no current_task",$t=!0):ct&&z===0?(Q="warn",_t="current_task has no claimed work",$t=!0):!tt&&st<=is?(Q="ok",_t="Dispatchable now",gt=!0):!tt&&st>os?(Q="warn",_t="Idle but not freshly active"):tt&&st>is&&(Q="warn",_t="Execution is getting quiet"),{agent:f,lastSignalAt:q,activeTaskCount:z,tone:Q,note:_t,focus:et(f.current_task)??L.lastActivityText??(gt?"Ready for assignment.":"Waiting for a clearer signal."),dispatchable:gt,drift:$t}}).sort((f,L)=>{const q=it(L.tone)-it(f.tone);return q!==0?q:Y(L.lastSignalAt)-Y(f.lastSignalAt)}),d=a.map(f=>{var Qe;const L=Vo.value.get(f.name)??"idle",q=Qo.value.has(f.name),st=f.context_ratio??0,z=f.diagnostic??null,ct=f.pending_reactive_items??0,tt=f.keepalive_running??!1,Q=f.timeout_streak??0,_t=f.recent_provider_failures??0;let gt="ok",$t="Healthy keeper";return ct>0&&!tt?(gt="bad",$t=`Reactive inbox blocked (${ct})`):ct>0?(gt="warn",$t=`Reactive inbox ${ct}`):tt&&(Q>0||_t>0)?(gt="warn",$t=Q>0?`Provider timeout ${Q}`:"Provider failures"):q||tt&&f.status==="offline"||L==="handoff-imminent"||(z==null?void 0:z.health_state)==="offline"||(z==null?void 0:z.health_state)==="degraded"?(gt="bad",$t=et(z==null?void 0:z.summary,56)??(q?"Heartbeat stale":L==="handoff-imminent"?"Handoff imminent":(z==null?void 0:z.health_state)==="degraded"?"Keeper degraded":"Keeper offline")):((z==null?void 0:z.health_state)==="stale"||st>=to||L==="preparing"||L==="compacting")&&(gt="warn",$t=et(z==null?void 0:z.summary,56)??(st>=to?"High context pressure":`Lifecycle ${L}`)),{keeper:f,tone:gt,note:$t,focus:et(z==null?void 0:z.summary,120)??et(f.inbox_latest_summary)??et(f.last_successful_reaction_summary)??et(f.continuity_summary)??et((Qe=f.agent)==null?void 0:Qe.current_task)??f.skill_primary??f.last_proactive_reason??f.memory_recent_note??"No active focus",timestamp:f.last_heartbeat??null}}).sort((f,L)=>{const q=it(L.tone)-it(f.tone);return q!==0?q:Y(L.timestamp)-Y(f.timestamp)}),v=n.filter(f=>f.status==="todo"||f.status==="claimed"||f.status==="in_progress").map(f=>{var gt,$t;const L=f.assignee?p.get(fe(f.assignee))??null:null,q=L?$.get(fe(L.name))??null:null,st=(q==null?void 0:q.lastActivityAt)??(L==null?void 0:L.last_seen)??null,z=st?Math.max(0,Date.now()-Y(st)):Number.POSITIVE_INFINITY,ct=f.status==="claimed"||f.status==="in_progress";let tt="ok",Q="Covered",_t=!1;return f.assignee?!L||L.status==="offline"||L.status==="inactive"?(tt="bad",Q="Assigned owner is unavailable",_t=!0):ct&&z>os?(tt="bad",Q="Execution has lost a fresh signal"):ct&&z>is?(tt="warn",Q="Execution is drifting quiet"):f.status==="todo"&&qt(f.priority)<=2&&!((gt=L.current_task)!=null&&gt.trim())&&((q==null?void 0:q.activeAssignedCount)??0)===0?(tt="ok",Q="Ready for dispatch"):ct&&!(($t=L.current_task)!=null&&$t.trim())&&(tt="warn",Q="Owner focus is not explicit"):(tt=qt(f.priority)<=2?"bad":"warn",Q=ct?"Active work has no owner":"Ready work has no owner",_t=!0),{task:f,owner:L,lastSignalAt:st,tone:tt,note:Q,focus:et(L==null?void 0:L.current_task)??(q==null?void 0:q.lastActivityText)??et(f.description)??"Needs operator attention.",ownerGap:_t}}).sort((f,L)=>{const q=it(L.tone)-it(f.tone);if(q!==0)return q;const st=qt(f.task.priority)-qt(L.task.priority);return st!==0?st:Y(L.lastSignalAt??L.task.updated_at??L.task.created_at)-Y(f.lastSignalAt??f.task.updated_at??f.task.created_at)}),c=v.filter(f=>f.task.status==="todo"&&qt(f.task.priority)<=2),y=v.filter(f=>f.ownerGap).length,S=m.filter(f=>f.dispatchable),T=m.filter(f=>f.drift||f.tone!=="ok"),P=d.filter(f=>f.tone!=="ok"),K=t!=null&&t.paused?"bad":((Et=t==null?void 0:t.data_quality)==null?void 0:Et.board_contract_ok)===!1||((vt=t==null?void 0:t.data_quality)==null?void 0:vt.council_feed_ok)===!1?"warn":l?"ok":"warn",E=[];t!=null&&t.paused&&E.push({key:"paused",tone:"bad",title:"Room is paused",detail:t.tempo?`Tempo is ${t.tempo}. Resume from Ops when ready.`:"Resume from Ops when ready.",timestamp:((ft=t.data_quality)==null?void 0:ft.last_sync_at)??null,action:()=>Pt("ops")}),l||E.push({key:"live-connection",tone:"warn",title:"Live feed is reconnecting",detail:"Dashboard telemetry is stale until the SSE stream recovers.",timestamp:null,action:Fd}),xe(o==null?void 0:o.alert_level)!=="ok"&&E.push({key:"board-monitor",tone:xe(o==null?void 0:o.alert_level),title:"Board feed needs attention",detail:`Freshness ${ls(o==null?void 0:o.last_activity_age_s)} · ${(o==null?void 0:o.unanswered_posts)??0} unanswered posts.`,timestamp:null,action:()=>Pt("board")}),xe(r==null?void 0:r.alert_level)!=="ok"&&E.push({key:"council-monitor",tone:xe(r==null?void 0:r.alert_level),title:"Council quorum risk is elevated",detail:`${(r==null?void 0:r.sessions_without_quorum)??0} sessions without quorum · freshness ${ls(r==null?void 0:r.last_activity_age_s)}.`,timestamp:null,action:()=>Pt("board")}),(((B=t==null?void 0:t.data_quality)==null?void 0:B.board_contract_ok)===!1||((M=t==null?void 0:t.data_quality)==null?void 0:M.council_feed_ok)===!1)&&E.push({key:"data-quality",tone:"warn",title:"Dashboard data quality is degraded",detail:`${((x=t.data_quality)==null?void 0:x.board_contract_ok)===!1?"Board contract":"Board contract ok"} · ${((It=t.data_quality)==null?void 0:It.council_feed_ok)===!1?"Council feed degraded":"Council feed ok"}.`,timestamp:((Yt=t.data_quality)==null?void 0:Yt.last_sync_at)??null,action:()=>Pt("ops")});const N=[...E,...v.filter(f=>f.tone!=="ok").slice(0,3).map(f=>({key:`task-${f.task.id}`,tone:f.tone,title:f.task.title,detail:`${f.note} · ${f.focus}`,timestamp:f.lastSignalAt??f.task.updated_at??f.task.created_at??null,action:()=>Pt("overview")})),...P.slice(0,2).map(f=>({key:`keeper-${f.keeper.name}`,tone:f.tone,title:f.keeper.name,detail:`${f.note} · ${f.focus}`,timestamp:f.timestamp,action:()=>$a(f.keeper)})),...T.slice(0,2).map(f=>({key:`agent-${f.agent.name}`,tone:f.tone,title:f.agent.name,detail:`${f.note} · ${f.focus}`,timestamp:f.lastSignalAt,action:()=>Ie(f.agent.name)}))].sort((f,L)=>{const q=it(L.tone)-it(f.tone);return q!==0?q:Y(L.timestamp)-Y(f.timestamp)}).slice(0,8),R=rs.value;return i`
    <div class="overview-sub-tabs">
      <button
        class="sub-tab-btn ${R==="triage"?"active":""}"
        onClick=${()=>{rs.value="triage"}}
      >Triage</button>
      <button
        class="sub-tab-btn ${R==="dispatch"?"active":""}"
        onClick=${()=>{rs.value="dispatch"}}
      >Dispatch</button>
    </div>
    ...
    <${C} title="Room Health" class="section">
      <div class="health-strip">
        <span class="health-dot" style=${`color:${l?"#4ade80":"#fbbf24"}`} title=${`Live Feed: ${l?"Online":"Retrying"} · ${On.value} events`}>● Live</span>
        <span class="health-dot" style=${`color:${Un(xe(o==null?void 0:o.alert_level))}`} title=${`Board: ${ao(o==null?void 0:o.alert_level)} · Freshness ${ls(o==null?void 0:o.last_activity_age_s)}`}>● Board</span>
        <span class="health-dot" style=${`color:${Un(xe(r==null?void 0:r.alert_level))}`} title=${`Council: ${ao(r==null?void 0:r.alert_level)} · ${(r==null?void 0:r.sessions_without_quorum)??0} sessions without quorum`}>● Council</span>
        <span class="health-dot" style=${`color:${Un(K)}`} title=${`Runtime: ${t!=null&&t.paused?"Paused":"Stable"}`}>● Runtime</span>
      ...
      <details class="runtime-collapsible">
        ...
        <div class="overview-note-stack">
          <div class="overview-inline-note">
            ${(le=t==null?void 0:t.data_quality)!=null&&le.last_sync_at?i`Last sync <${F} timestamp=${t.data_quality.last_sync_at} />`:i`No sync metadata yet`}
          </div>
          <div class="overview-inline-note">
          ...
          ${(ce=t==null?void 0:t.lodge)!=null&&ce.last_skip_reason?i`<div class="overview-inline-note">Last Lodge skip: ${t.lodge.last_skip_reason}</div>`:null}
        </div>
      </details>
    <//>
        ...
        <${C} title="Runtime Notes" class="section">
          <details class="runtime-collapsible">
            ...
            <div class="overview-note-stack">
              ...
              <div class="overview-inline-note">
                ${an.value?`Perpetual runtime ${an.value.running?"running":"stopped"}${an.value.goal?` · ${et(an.value.goal,120)}`:""}`:"Perpetual runtime unavailable"}
              </div>
              <div class="overview-inline-note">
                Lodge ${(Mt=t==null?void 0:t.lodge)!=null&&Mt.enabled?"enabled":"disabled"} · Last tick ${((de=t==null?void 0:t.lodge)==null?void 0:de.last_tick_ago)??"never"} · Self heartbeats ${((Ve=(Je=t==null?void 0:t.lodge)==null?void 0:Je.active_self_heartbeats)==null?void 0:Ve.length)??0}${(Kn=t==null?void 0:t.lodge)!=null&&Kn.last_skip_reason?` · Skip ${t.lodge.last_skip_reason}`:""}
              </div>
              <div class="overview-inline-note">
        ...
        <div class="monitor-list">
          ${v.length===0?i`<div class="empty-state">No active or ready tasks</div>`:v.slice(0,6).map(f=>i`
                <${cs}
                  ...
                  tone=${f.tone}
                  title=${f.task.title}
                  subtitle=${`${ki(f.task.priority)} · ${f.note}`}
  ...
  `}const Xd="modulepreload",Zd=function(t){return"/dashboard/"+t},io={},tu=function(e,n,a){let s=Promise.resolve();if(n&&n.length>0){let r=function($){return Promise.all($.map(m=>Promise.resolve(m).then(d=>({status:"fulfilled",value:d}),d=>({status:"rejected",reason:d}))))};document.getElementsByTagName("link");const l=document.querySelector("meta[property=csp-nonce]"),p=(l==null?void 0:l.nonce)||(l==null?void 0:l.getAttribute("nonce"));s=r(n.map($=>{if($=Zd($),$ in io)return;io[$]=!0;const m=$.endsWith(".css"),d=m?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${$}"]${d}`))return;const v=document.createElement("link");if(v.rel=m?"stylesheet":Xd,m||(v.as="script"),v.crossOrigin="",v.href=$,p&&v.setAttribute("nonce",p),document.head.appendChild(v),m)return new Promise((c,y)=>{v.addEventListener("load",c),v.addEventListener("error",()=>y(new Error(`Unable to preload CSS for ${$}`)))})}))}function o(r){const l=new Event("vite:preloadError",{cancelable:!0});if(l.payload=r,window.dispatchEvent(l),!l.defaultPrevented)throw r}return s.then(r=>{for(const l of r||[])l.status==="rejected"&&o(l.reason);return e().catch(o)})},dr=_(null),Bt=_(null),ha=_(!1),ya=_(!1),ba=_(null),ka=_(null),Vs=_(null),xa=_(null),Ke=_("summary"),qn=_(null),Qs=_(!1),Sa=_(null),ur=_(null),Ys=_(!1),Aa=_(null),Ai=_(null),Xs=_(!1),wa=_(null),Dn=_(null),Ca=_(!1),En=_(null),dn=_(null);let sn=null;function k(t){return typeof t=="object"&&t!==null&&!Array.isArray(t)}function u(t){return typeof t=="string"&&t.trim()!==""?t:void 0}function g(t){return typeof t=="number"&&Number.isFinite(t)?t:void 0}function V(t){return typeof t=="boolean"?t:void 0}function mt(t){return Array.isArray(t)?t.map(e=>typeof e=="string"?e.trim():"").filter(Boolean):[]}function eu(){if(typeof window>"u")return;const e=new URLSearchParams(window.location.search).get("run_id")??void 0;return e&&e.trim()!==""?e.trim():void 0}function nu(t){if(k(t))return{policy_class:u(t.policy_class),approval_class:u(t.approval_class),tool_allowlist:mt(t.tool_allowlist),model_allowlist:mt(t.model_allowlist),requires_human_for:mt(t.requires_human_for),autonomy_level:u(t.autonomy_level),escalation_timeout_sec:g(t.escalation_timeout_sec),kill_switch:V(t.kill_switch),frozen:V(t.frozen)}}function au(t){if(k(t))return{headcount_cap:g(t.headcount_cap),active_operation_cap:g(t.active_operation_cap),max_cost_usd:g(t.max_cost_usd),max_tokens:g(t.max_tokens)}}function wi(t){if(!k(t))return null;const e=u(t.unit_id),n=u(t.label),a=u(t.kind);return!e||!n||!a?null:{unit_id:e,label:n,kind:a,parent_unit_id:u(t.parent_unit_id)??null,leader_id:u(t.leader_id)??null,roster:mt(t.roster),capability_profile:mt(t.capability_profile),source:u(t.source),created_at:u(t.created_at),updated_at:u(t.updated_at),policy:nu(t.policy),budget:au(t.budget)}}function pr(t){if(!k(t))return null;const e=wi(t.unit);return e?{unit:e,leader_status:u(t.leader_status),roster_total:g(t.roster_total),roster_live:g(t.roster_live),active_operation_count:g(t.active_operation_count),health:u(t.health),reasons:mt(t.reasons),children:Array.isArray(t.children)?t.children.map(pr).filter(n=>n!==null):[]}:null}function su(t){if(k(t))return{total_units:g(t.total_units),company_count:g(t.company_count),platoon_count:g(t.platoon_count),squad_count:g(t.squad_count),leaf_agent_unit_count:g(t.leaf_agent_unit_count),live_agent_count:g(t.live_agent_count),managed_unit_count:g(t.managed_unit_count),active_operation_count:g(t.active_operation_count)}}function mr(t){const e=k(t)?t:{};return{version:u(e.version),generated_at:u(e.generated_at),source:u(e.source),summary:su(e.summary),units:Array.isArray(e.units)?e.units.map(pr).filter(n=>n!==null):[]}}function iu(t){if(!k(t))return null;const e=u(t.kind),n=u(t.status);return!e||!n?null:{kind:e,chain_id:u(t.chain_id)??null,goal:u(t.goal)??null,run_id:u(t.run_id)??null,status:n,viewer_path:u(t.viewer_path)??null,last_sync_at:u(t.last_sync_at)??null}}function Qa(t){if(!k(t))return null;const e=u(t.operation_id),n=u(t.objective),a=u(t.assigned_unit_id),s=u(t.trace_id),o=u(t.status);return!e||!n||!a||!s||!o?null:{operation_id:e,objective:n,assigned_unit_id:a,autonomy_level:u(t.autonomy_level),policy_class:u(t.policy_class),budget_class:u(t.budget_class),detachment_session_id:u(t.detachment_session_id)??null,trace_id:s,checkpoint_ref:u(t.checkpoint_ref)??null,active_goal_ids:mt(t.active_goal_ids),note:u(t.note)??null,created_by:u(t.created_by),source:u(t.source),status:o,chain:iu(t.chain),created_at:u(t.created_at),updated_at:u(t.updated_at)}}function ou(t){if(!k(t))return null;const e=Qa(t.operation);return e?{operation:e,assigned_unit_label:u(t.assigned_unit_label)}:null}function tn(t){if(k(t))return{tone:u(t.tone),pending_ops:g(t.pending_ops),blocked_ops:g(t.blocked_ops),in_flight_ops:g(t.in_flight_ops),pipeline_stalls:g(t.pipeline_stalls),bus_traffic:g(t.bus_traffic),l1_hit_rate:g(t.l1_hit_rate),invalidation_count:g(t.invalidation_count),current_pending:g(t.current_pending),current_in_flight:g(t.current_in_flight),cdb_wakeups:g(t.cdb_wakeups),total_stolen:g(t.total_stolen),avg_best_score:g(t.avg_best_score),avg_candidate_count:g(t.avg_candidate_count),best_first_operations:g(t.best_first_operations),active_sessions:g(t.active_sessions),commit_rate:g(t.commit_rate),total_speculations:g(t.total_speculations)}}function ru(t){if(!k(t))return;const e=k(t.pipeline)?t.pipeline:void 0,n=k(t.cache)?t.cache:void 0,a=k(t.ooo)?t.ooo:void 0,s=k(t.speculative)?t.speculative:void 0,o=k(t.search_fabric)?t.search_fabric:void 0,r=k(t.signals)?t.signals:void 0;return{pipeline:e?{total_ops:g(e.total_ops),completed_ops:g(e.completed_ops),stalled_cycles:g(e.stalled_cycles),hazards_detected:g(e.hazards_detected),forwarding_used:g(e.forwarding_used),pipeline_flushes:g(e.pipeline_flushes),ipc:g(e.ipc)}:void 0,cache:n?{total_reads:g(n.total_reads),total_writes:g(n.total_writes),l1_hit_rate:g(n.l1_hit_rate),invalidation_count:g(n.invalidation_count),writeback_count:g(n.writeback_count),bus_traffic:g(n.bus_traffic)}:void 0,ooo:a?{agent_count:g(a.agent_count),total_added:g(a.total_added),total_issued:g(a.total_issued),total_completed:g(a.total_completed),total_stolen:g(a.total_stolen),cdb_wakeups:g(a.cdb_wakeups),stall_cycles:g(a.stall_cycles),global_cdb_events:g(a.global_cdb_events),current_pending:g(a.current_pending),current_in_flight:g(a.current_in_flight)}:void 0,speculative:s?{total_speculations:g(s.total_speculations),total_commits:g(s.total_commits),total_aborts:g(s.total_aborts),commit_rate:g(s.commit_rate),total_fast_calls:g(s.total_fast_calls),total_cost_usd:g(s.total_cost_usd),active_sessions:g(s.active_sessions)}:void 0,search_fabric:o?{total_operations:g(o.total_operations),best_first_operations:g(o.best_first_operations),legacy_operations:g(o.legacy_operations),blocked_operations:g(o.blocked_operations),ready_operations:g(o.ready_operations),research_pipeline_operations:g(o.research_pipeline_operations),avg_candidate_count:g(o.avg_candidate_count),avg_best_score:g(o.avg_best_score),top_stage:u(o.top_stage)??null}:void 0,signals:r?{issue_pressure:tn(r.issue_pressure),cache_contention:tn(r.cache_contention),scheduler_efficiency:tn(r.scheduler_efficiency),routing_confidence:tn(r.routing_confidence),speculative_posture:tn(r.speculative_posture)}:void 0}}function vr(t){const e=k(t)?t:{},n=k(e.summary)?e.summary:void 0;return{version:u(e.version),generated_at:u(e.generated_at),summary:n?{total:g(n.total),active:g(n.active),paused:g(n.paused),managed:g(n.managed),projected:g(n.projected)}:void 0,microarch:ru(e.microarch),operations:Array.isArray(e.operations)?e.operations.map(ou).filter(a=>a!==null):[]}}function fr(t){if(!k(t))return null;const e=u(t.detachment_id),n=u(t.operation_id),a=u(t.assigned_unit_id);return!e||!n||!a?null:{detachment_id:e,operation_id:n,assigned_unit_id:a,leader_id:u(t.leader_id)??null,roster:mt(t.roster),session_id:u(t.session_id)??null,checkpoint_ref:u(t.checkpoint_ref)??null,runtime_kind:u(t.runtime_kind)??null,runtime_ref:u(t.runtime_ref)??null,source:u(t.source),status:u(t.status),last_event_at:u(t.last_event_at)??null,last_progress_at:u(t.last_progress_at)??null,heartbeat_deadline:u(t.heartbeat_deadline)??null,created_at:u(t.created_at),updated_at:u(t.updated_at)}}function lu(t){if(!k(t))return null;const e=fr(t.detachment);return e?{detachment:e,assigned_unit_label:u(t.assigned_unit_label),operation:Qa(t.operation)}:null}function _r(t){const e=k(t)?t:{},n=k(e.summary)?e.summary:void 0;return{version:u(e.version),generated_at:u(e.generated_at),summary:n?{total:g(n.total),active:g(n.active),projected:g(n.projected)}:void 0,detachments:Array.isArray(e.detachments)?e.detachments.map(lu).filter(a=>a!==null):[]}}function cu(t){if(!k(t))return null;const e=u(t.decision_id),n=u(t.trace_id),a=u(t.requested_action),s=u(t.scope_type),o=u(t.scope_id);return!e||!n||!a||!s||!o?null:{decision_id:e,trace_id:n,requested_action:a,scope_type:s,scope_id:o,operation_id:u(t.operation_id)??null,target_unit_id:u(t.target_unit_id)??null,requested_by:u(t.requested_by),status:u(t.status),reason:u(t.reason)??null,source:u(t.source),detail:t.detail,created_at:u(t.created_at),decided_at:u(t.decided_at)??null,expires_at:u(t.expires_at)??null}}function gr(t){const e=k(t)?t:{},n=k(e.summary)?e.summary:void 0;return{version:u(e.version),generated_at:u(e.generated_at),summary:n?{total:g(n.total),pending:g(n.pending),approved:g(n.approved),denied:g(n.denied)}:void 0,decisions:Array.isArray(e.decisions)?e.decisions.map(cu).filter(a=>a!==null):[]}}function du(t){if(!k(t))return null;const e=wi(t.unit);return e?{unit:e,roster_total:g(t.roster_total),roster_live:g(t.roster_live),headcount_cap:g(t.headcount_cap),active_operations:g(t.active_operations),active_operation_cap:g(t.active_operation_cap),utilization:g(t.utilization)}:null}function uu(t){const e=k(t)?t:{};return{version:u(e.version),generated_at:u(e.generated_at),capacity:Array.isArray(e.capacity)?e.capacity.map(du).filter(n=>n!==null):[]}}function pu(t){if(!k(t))return null;const e=u(t.alert_id);return e?{alert_id:e,severity:u(t.severity),kind:u(t.kind),scope_type:u(t.scope_type),scope_id:u(t.scope_id),title:u(t.title),detail:u(t.detail),timestamp:u(t.timestamp)}:null}function $r(t){const e=k(t)?t:{},n=k(e.summary)?e.summary:void 0;return{version:u(e.version),generated_at:u(e.generated_at),summary:n?{total:g(n.total),bad:g(n.bad),warn:g(n.warn)}:void 0,alerts:Array.isArray(e.alerts)?e.alerts.map(pu).filter(a=>a!==null):[]}}function hr(t){if(!k(t))return null;const e=u(t.event_id),n=u(t.trace_id),a=u(t.event_type);return!e||!n||!a?null:{event_id:e,trace_id:n,event_type:a,operation_id:u(t.operation_id)??null,unit_id:u(t.unit_id)??null,actor:u(t.actor)??null,source:u(t.source),timestamp:u(t.timestamp),detail:t.detail}}function mu(t){const e=k(t)?t:{};return{version:u(e.version),generated_at:u(e.generated_at),events:Array.isArray(e.events)?e.events.map(hr).filter(n=>n!==null):[]}}function vu(t){if(!k(t))return null;const e=u(t.code),n=u(t.severity),a=u(t.summary);return!e||!n||!a?null:{code:e,severity:n,summary:a}}function fu(t){if(!k(t))return null;const e=u(t.lane_id),n=u(t.label),a=u(t.kind),s=u(t.phase),o=u(t.motion_state),r=u(t.source_of_truth),l=u(t.movement_reason),p=u(t.current_step);if(!e||!n||!a||!s||!o||!r||!l||!p)return null;const $=k(t.counts)?t.counts:{};return{lane_id:e,label:n,kind:a,present:V(t.present)??!1,phase:s,motion_state:o,source_of_truth:r,last_movement_at:u(t.last_movement_at)??null,movement_reason:l,current_step:p,blockers:mt(t.blockers),counts:{operations:g($.operations),detachments:g($.detachments),workers:g($.workers),approvals:g($.approvals),alerts:g($.alerts)},hard_flags:Array.isArray(t.hard_flags)?t.hard_flags.map(vu).filter(m=>m!==null):[]}}function _u(t){if(!k(t))return null;const e=u(t.event_id),n=u(t.lane_id),a=u(t.kind),s=u(t.timestamp),o=u(t.title),r=u(t.detail),l=u(t.tone),p=u(t.source);return!e||!n||!a||!s||!o||!r||!l||!p?null:{event_id:e,lane_id:n,kind:a,timestamp:s,title:o,detail:r,tone:l,source:p}}function gu(t){if(!k(t))return null;const e=u(t.code),n=u(t.severity),a=u(t.summary);return!e||!n||!a?null:{code:e,severity:n,summary:a,lane_ids:mt(t.lane_ids),count:g(t.count)??0}}function yr(t){if(!k(t))return;const e=k(t.overview)?t.overview:{},n=k(t.gaps)?t.gaps:{},a=k(t.recommended_next_action)?t.recommended_next_action:void 0;return{generated_at:u(t.generated_at),overview:{active_lanes:g(e.active_lanes),moving_lanes:g(e.moving_lanes),stalled_lanes:g(e.stalled_lanes),projected_lanes:g(e.projected_lanes),last_movement_at:u(e.last_movement_at)??null},lanes:Array.isArray(t.lanes)?t.lanes.map(fu).filter(s=>s!==null):[],timeline:Array.isArray(t.timeline)?t.timeline.map(_u).filter(s=>s!==null):[],gaps:{count:g(n.count),items:Array.isArray(n.items)?n.items.map(gu).filter(s=>s!==null):[]},recommended_next_action:a?{tool:u(a.tool)??"masc_operator_snapshot",label:u(a.label)??"Observe operator state",reason:u(a.reason)??"",lane_id:u(a.lane_id)??null}:void 0}}function $u(t){if(!k(t))return;const e=k(t.workers)?t.workers:{},n=V(t.pass);return{status:u(t.status)??"missing",source:u(t.source)??"none",run_id:u(t.run_id)??null,captured_at:u(t.captured_at)??null,...n!==void 0?{pass:n}:{},...g(t.peak_hot_slots)!=null?{peak_hot_slots:g(t.peak_hot_slots)}:{},...g(t.ctx_per_slot)!=null?{ctx_per_slot:g(t.ctx_per_slot)}:{},workers:{expected:g(e.expected),joined:g(e.joined),current_task_bound:g(e.current_task_bound),fresh_heartbeats:g(e.fresh_heartbeats),done:g(e.done),final:g(e.final)},artifact_ref:u(t.artifact_ref)??null,missing_reason:u(t.missing_reason)??null}}function hu(t){const e=k(t)?t:{};return{version:u(e.version),generated_at:u(e.generated_at),topology:mr(e.topology),operations:vr(e.operations),detachments:_r(e.detachments),alerts:$r(e.alerts),decisions:gr(e.decisions),capacity:uu(e.capacity),traces:mu(e.traces),swarm_status:yr(e.swarm_status)}}function yu(t){const e=k(t)?t:{},n=mr(e.topology),a=vr(e.operations),s=_r(e.detachments),o=$r(e.alerts),r=gr(e.decisions);return{version:u(e.version),generated_at:u(e.generated_at),topology:{version:n.version,generated_at:n.generated_at,source:n.source,summary:n.summary},operations:{version:a.version,generated_at:a.generated_at,summary:a.summary,microarch:a.microarch},detachments:{version:s.version,generated_at:s.generated_at,summary:s.summary},alerts:{version:o.version,generated_at:o.generated_at,summary:o.summary},decisions:{version:r.version,generated_at:r.generated_at,summary:r.summary},swarm_status:yr(e.swarm_status),swarm_proof:$u(e.swarm_proof)}}function bu(t){return k(t)?{chain_id:u(t.chain_id)??null,started_at:g(t.started_at)??null,progress:g(t.progress)??null,elapsed_sec:g(t.elapsed_sec)??null}:null}function br(t){if(!k(t))return null;const e=u(t.event);return e?{event:e,chain_id:u(t.chain_id)??null,timestamp:u(t.timestamp)??null,duration_ms:g(t.duration_ms)??null,message:u(t.message)??null,tokens:g(t.tokens)??null}:null}function ku(t){if(!k(t))return null;const e=Qa(t.operation);return e?{operation:e,runtime:bu(t.runtime),history:br(t.history),mermaid:u(t.mermaid)??null,preview_run:kr(t.preview_run)}:null}function xu(t){const e=k(t)?t:{};return{status:u(e.status)??"disconnected",base_url:u(e.base_url)??null,message:u(e.message)??null}}function Su(t){const e=k(t)?t:{},n=k(e.summary)?e.summary:void 0;return{version:u(e.version),generated_at:u(e.generated_at),connection:xu(e.connection),summary:n?{linked_operations:g(n.linked_operations),active_chains:g(n.active_chains),running_operations:g(n.running_operations),recent_failures:g(n.recent_failures),last_history_event_at:u(n.last_history_event_at)??null}:void 0,operations:Array.isArray(e.operations)?e.operations.map(ku).filter(a=>a!==null):[],recent_history:Array.isArray(e.recent_history)?e.recent_history.map(br).filter(a=>a!==null):[]}}function Au(t){if(!k(t))return null;const e=u(t.id);return e?{id:e,type:u(t.type),status:u(t.status),duration_ms:g(t.duration_ms)??null,error:u(t.error)??null}:null}function kr(t){if(!k(t))return null;const e=u(t.run_id),n=u(t.chain_id);return n?{run_id:e??null,chain_id:n,duration_ms:g(t.duration_ms),success:V(t.success),mermaid:u(t.mermaid),nodes:Array.isArray(t.nodes)?t.nodes.map(Au).filter(a=>a!==null):[]}:null}function wu(t){const e=k(t)?t:{};return{run:kr(e.run)}}function Cu(t){if(!k(t))return null;const e=u(t.title),n=u(t.path);return!e||!n?null:{title:e,path:n}}function Tu(t){if(!k(t))return null;const e=u(t.id),n=u(t.title),a=u(t.summary);return!e||!n||!a?null:{id:e,title:n,summary:a}}function Nu(t){if(!k(t))return null;const e=u(t.id),n=u(t.title),a=u(t.tool),s=u(t.summary);return!e||!n||!a||!s?null:{id:e,title:n,tool:a,summary:s,success_signals:mt(t.success_signals),pitfalls:mt(t.pitfalls)}}function Ru(t){if(!k(t))return null;const e=u(t.id),n=u(t.title),a=u(t.summary),s=u(t.when_to_use);return!e||!n||!a||!s?null:{id:e,title:n,summary:a,when_to_use:s,steps:Array.isArray(t.steps)?t.steps.map(Nu).filter(o=>o!==null):[]}}function Lu(t){if(!k(t))return null;const e=u(t.id),n=u(t.title),a=u(t.description);return!e||!n||!a?null:{id:e,title:n,description:a,tools:mt(t.tools)}}function Pu(t){if(!k(t))return null;const e=u(t.id),n=u(t.title),a=u(t.symptom),s=u(t.why),o=u(t.fix_tool),r=u(t.fix_summary);return!e||!n||!a||!s||!o||!r?null:{id:e,title:n,symptom:a,why:s,fix_tool:o,fix_summary:r}}function Du(t){if(!k(t))return null;const e=u(t.id),n=u(t.title),a=u(t.path_id),s=u(t.transport);return!e||!n||!a||!s?null:{id:e,title:n,path_id:a,transport:s,request:t.request,response:t.response,notes:mt(t.notes)}}function Eu(t){const e=k(t)?t:{};return{version:u(e.version),generated_at:u(e.generated_at),docs:Array.isArray(e.docs)?e.docs.map(Cu).filter(n=>n!==null):[],concepts:Array.isArray(e.concepts)?e.concepts.map(Tu).filter(n=>n!==null):[],golden_paths:Array.isArray(e.golden_paths)?e.golden_paths.map(Ru).filter(n=>n!==null):[],tool_groups:Array.isArray(e.tool_groups)?e.tool_groups.map(Lu).filter(n=>n!==null):[],pitfalls:Array.isArray(e.pitfalls)?e.pitfalls.map(Pu).filter(n=>n!==null):[],examples:Array.isArray(e.examples)?e.examples.map(Du).filter(n=>n!==null):[]}}function Iu(t){if(!k(t))return null;const e=u(t.id),n=u(t.title),a=u(t.status),s=u(t.detail),o=u(t.next_tool);return!e||!n||!a||!s||!o?null:{id:e,title:n,status:a,detail:s,next_tool:o}}function Mu(t){if(!k(t))return null;const e=u(t.code),n=u(t.severity),a=u(t.title),s=u(t.detail),o=u(t.next_tool);return!e||!n||!a||!s||!o?null:{code:e,severity:n,title:a,detail:s,next_tool:o}}function Ou(t){if(!k(t))return null;const e=u(t.from),n=u(t.content),a=u(t.timestamp),s=g(t.seq);return!e||!n||!a||s==null?null:{seq:s,from:e,content:n,timestamp:a}}function zu(t){if(!k(t))return null;const e=u(t.name),n=u(t.role),a=u(t.lane),s=u(t.status),o=u(t.claim_marker),r=u(t.done_marker),l=u(t.final_marker);if(!e||!n||!a||!s||!o||!r||!l)return null;const p=(()=>{if(!k(t.last_message))return null;const $=g(t.last_message.seq),m=u(t.last_message.content),d=u(t.last_message.timestamp);return $==null||!m||!d?null:{seq:$,content:m,timestamp:d}})();return{name:e,role:n,lane:a,joined:V(t.joined)??!1,live_presence:V(t.live_presence)??!1,completed:V(t.completed)??!1,status:s,current_task:u(t.current_task)??null,bound_task_id:u(t.bound_task_id)??null,bound_task_title:u(t.bound_task_title)??null,bound_task_status:u(t.bound_task_status)??null,current_task_matches_run:V(t.current_task_matches_run)??!1,squad_member:V(t.squad_member)??!1,detachment_member:V(t.detachment_member)??!1,last_seen:u(t.last_seen)??null,heartbeat_age_sec:g(t.heartbeat_age_sec)??null,heartbeat_fresh:V(t.heartbeat_fresh)??!1,claim_marker_seen:V(t.claim_marker_seen)??!1,done_marker_seen:V(t.done_marker_seen)??!1,final_marker_seen:V(t.final_marker_seen)??!1,claim_marker:o,done_marker:r,final_marker:l,last_message:p}}function ju(t){if(!k(t))return;const e=Array.isArray(t.timeline)?t.timeline.map(n=>{if(!k(n))return null;const a=u(n.timestamp),s=g(n.active_slots);if(!a||s==null)return null;const o=Array.isArray(n.active_slot_ids)?n.active_slot_ids.map(r=>typeof r=="number"&&Number.isFinite(r)?r:null).filter(r=>r!=null):[];return{timestamp:a,active_slots:s,active_slot_ids:o}}).filter(n=>n!==null):[];return{slot_url:u(t.slot_url)??null,provider_base_url:u(t.provider_base_url)??null,provider_reachable:V(t.provider_reachable)??null,provider_status_code:g(t.provider_status_code)??null,provider_model_id:u(t.provider_model_id)??null,actual_model_id:u(t.actual_model_id)??null,expected_slots:g(t.expected_slots),actual_slots:g(t.actual_slots),expected_ctx:g(t.expected_ctx),actual_ctx:g(t.actual_ctx),slot_reachable:V(t.slot_reachable)??null,slot_status_code:g(t.slot_status_code)??null,runtime_blocker:u(t.runtime_blocker)??null,detail:u(t.detail)??null,checked_at:u(t.checked_at)??null,total_slots:g(t.total_slots),ctx_per_slot:g(t.ctx_per_slot),active_slots_now:g(t.active_slots_now),peak_active_slots:g(t.peak_active_slots),sample_count:g(t.sample_count),last_sample_at:u(t.last_sample_at)??null,timeline:e}}function qu(t){const e=k(t)?t:{},n=k(e.summary)?e.summary:void 0;return{version:u(e.version),generated_at:u(e.generated_at),run_id:u(e.run_id),room_id:u(e.room_id),operation_id:u(e.operation_id)??null,recommended_next_tool:u(e.recommended_next_tool),summary:n?{expected_workers:g(n.expected_workers),joined_workers:g(n.joined_workers),live_workers:g(n.live_workers),squad_roster_size:g(n.squad_roster_size),detachment_roster_size:g(n.detachment_roster_size),current_task_bound:g(n.current_task_bound),fresh_heartbeats:g(n.fresh_heartbeats),claim_markers_seen:g(n.claim_markers_seen),done_markers_seen:g(n.done_markers_seen),final_markers_seen:g(n.final_markers_seen),completed_workers:g(n.completed_workers),peak_hot_slots:g(n.peak_hot_slots),hot_window_ok:V(n.hot_window_ok),pass_hot_concurrency:V(n.pass_hot_concurrency),pass_end_to_end:V(n.pass_end_to_end),pending_decisions:g(n.pending_decisions),pass:V(n.pass)}:void 0,provider:ju(e.provider),operation:Qa(e.operation),squad:wi(e.squad),detachment:fr(e.detachment),workers:Array.isArray(e.workers)?e.workers.map(zu).filter(a=>a!==null):[],checklist:Array.isArray(e.checklist)?e.checklist.map(Iu).filter(a=>a!==null):[],blockers:Array.isArray(e.blockers)?e.blockers.map(Mu).filter(a=>a!==null):[],recent_messages:Array.isArray(e.recent_messages)?e.recent_messages.map(Ou).filter(a=>a!==null):[],recent_trace_events:Array.isArray(e.recent_trace_events)?e.recent_trace_events.map(hr).filter(a=>a!==null):[],truth_notes:mt(e.truth_notes)}}function Ci(t){Ke.value=t,t!=="summary"&&Fu()}async function Ti(){ha.value=!0,ba.value=null;try{const t=await Tl();dr.value=yu(t)}catch(t){ba.value=t instanceof Error?t.message:"Failed to load command-plane summary"}finally{ha.value=!1}}function Ni(t){dn.value=t}async function Ri(){ya.value=!0,ka.value=null;try{const t=await Cl();Bt.value=hu(t)}catch(t){ka.value=t instanceof Error?t.message:"Failed to load command-plane snapshot"}finally{ya.value=!1}}async function Fu(){Bt.value||ya.value||await Ri()}async function Me(){await Ti(),Ke.value!=="summary"&&await Ri()}async function he(){var t;Xs.value=!0,wa.value=null;try{const e=await Nl(),n=Su(e);Ai.value=n;const a=dn.value;n.operations.length===0?dn.value=null:(!a||!n.operations.some(s=>s.operation.operation_id===a))&&(dn.value=((t=n.operations[0])==null?void 0:t.operation.operation_id)??null)}catch(e){wa.value=e instanceof Error?e.message:"Failed to load chain summary"}finally{Xs.value=!1}}function Ku(){sn=null,Dn.value=null,Ca.value=!1,En.value=null}async function Hu(t){sn=t,Ca.value=!0,En.value=null;try{const e=await Rl(t);if(sn!==t)return;Dn.value=wu(e)}catch(e){if(sn!==t)return;Dn.value=null,En.value=e instanceof Error?e.message:"Failed to load chain run"}finally{sn===t&&(Ca.value=!1)}}async function Uu(){Qs.value=!0,Sa.value=null;try{const t=await Ll();qn.value=Eu(t)}catch(t){Sa.value=t instanceof Error?t.message:"Failed to load command-plane help"}finally{Qs.value=!1}}async function xr(t=eu()){Ys.value=!0,Aa.value=null;try{const e=await Pl(t);ur.value=qu(e)}catch(e){Aa.value=e instanceof Error?e.message:"Failed to load command-plane swarm view"}finally{Ys.value=!1}}async function re(t,e,n){Vs.value=t,xa.value=null;try{await Dl(e,n),await Ti(),(Bt.value||Ke.value!=="summary")&&await Ri(),await xr(),await he()}catch(a){throw xa.value=a instanceof Error?a.message:"Failed to execute command-plane action",a}finally{Vs.value=null}}function Bu(t){return re(`pause:${t}`,"/api/v1/command-plane/operations/pause",{operation_id:t})}function Wu(t){return re(`resume:${t}`,"/api/v1/command-plane/operations/resume",{operation_id:t})}function Gu(t){return re(`recall:${t}`,"/api/v1/command-plane/dispatch/recall",{operation_id:t})}function Ju(t={}){return re("dispatch:tick","/api/v1/command-plane/dispatch/tick",{...t.operationId?{operation_id:t.operationId}:{},...t.detachmentId?{detachment_id:t.detachmentId}:{}})}function Vu(t){return re(`approve:${t}`,"/api/v1/command-plane/policy/approve",{decision_id:t})}function Qu(t){return re(`deny:${t}`,"/api/v1/command-plane/policy/deny",{decision_id:t})}function Yu(t,e){return re(`freeze:${t}`,"/api/v1/command-plane/policy/freeze",{unit_id:t,enabled:e})}function Xu(t,e){return re(`kill:${t}`,"/api/v1/command-plane/policy/kill-switch",{unit_id:t,enabled:e})}rd(()=>{Ti()});function Zu(t){if(t==null)return"";if(typeof t=="string")return t;try{return JSON.stringify(t,null,2)}catch{return String(t)}}function nt(t){if(!t)return"n/a";const e=Date.parse(t);if(Number.isNaN(e))return t;const n=Math.max(0,Math.round((Date.now()-e)/1e3));return n<60?`${n}s ago`:n<3600?`${Math.round(n/60)}m ago`:n<86400?`${Math.round(n/3600)}h ago`:`${Math.round(n/86400)}d ago`}function tp(t){if(!t)return"warn";const e=Date.parse(t);return Number.isNaN(e)?"warn":e<=Date.now()?"bad":"ok"}function ep(t){if(!t)return"n/a";const e=Date.parse(t);if(Number.isNaN(e))return t;const n=Math.round((e-Date.now())/1e3);return n<=0?"expired":n<60?`in ${n}s`:n<3600?`in ${Math.round(n/60)}m`:n<86400?`in ${Math.round(n/3600)}h`:`in ${Math.round(n/86400)}d`}function J(t){return t==="bad"?"bad":t==="warn"||t==="pending"?"warn":"ok"}let oo=!1,np=0,ds=null;async function ap(){ds||(ds=tu(()=>import("./mermaid.core-Bc8JYKIF.js").then(e=>e.bE),[]).then(e=>e.default));const t=await ds;return oo||(t.initialize({startOnLoad:!1,theme:"dark",securityLevel:"loose"}),oo=!0),t}function ee(t){if(!t)return"warn";const e=t.toLowerCase();return e.includes("failed")||e.includes("error")||e.includes("disconnected")||e.includes("stopped")?"bad":e.includes("running")||e.includes("active")||e.includes("degraded")||e.includes("pending")?"warn":"ok"}function Li(t){return typeof t!="number"||!Number.isFinite(t)?"n/a":`${Math.round(t*100)}%`}function sp(t){return typeof t!="number"||!Number.isFinite(t)?"n/a":t<60?`${Math.round(t)}s`:t<3600?`${Math.round(t/60)}m`:`${Math.round(t/3600)}h`}function Sr(t){if(!t)return"No recent chain history";const e=[t.event];return typeof t.duration_ms=="number"&&e.push(`${t.duration_ms}ms`),typeof t.tokens=="number"&&e.push(`${t.tokens} tokens`),t.message&&e.push(t.message),e.join(" · ")}const Ar=["operations","chains","topology","alerts","trace","control"],ip=["chain_start","node_start","node_complete","chain_complete","chain_error"];function op(t){return!!t&&Ar.includes(t)}function rp(){const t=new URLSearchParams(window.location.search),e=new URLSearchParams,n=t.get("agent")??t.get("agent_name"),a=t.get("token");return n&&e.set("agent",n),a&&e.set("token",a),e.toString()?`/api/v1/chains/events?${e.toString()}`:"/api/v1/chains/events"}function lp(t){switch(t){case"company":return"중대 / Company";case"platoon":return"소대 / Platoon";case"squad":return"분대 / Squad";case"agent":return"에이전트 / Agent";default:return t}}function ot(t){return Vs.value===t}function Pi(){return dr.value}function cp(){if(typeof window>"u")return null;const t=new URLSearchParams(window.location.search),e=t.get("agent")??t.get("agent_name");if(!e)return null;const n=e.trim();return n===""?null:n}function dp(){if(typeof window>"u")return null;const e=new URLSearchParams(window.location.search).get("run_id");if(!e)return null;const n=e.trim();return n===""?null:n}function up(t){if(!t)return null;const e=Date.parse(t);return Number.isNaN(e)?null:Math.max(0,Math.round((Date.now()-e)/1e3))}function pp(t){return t.status==="claimed"||t.status==="in_progress"}function mp(t){const e=qn.value;if(!e)return null;for(const n of e.golden_paths){const a=n.steps.find(s=>s.tool===t);if(a)return a}return null}function us(t){var e;return((e=qn.value)==null?void 0:e.golden_paths.find(n=>n.id===t))??null}function vp(t){const e=qn.value;if(!e)return[];const n=new Set(t);return e.pitfalls.filter(a=>n.has(a.id))}async function ne(t){try{await t()}catch{}}function fp(){var d,v,c,y,S,T;const t=Pi(),e=Ai.value,n=t==null?void 0:t.topology.summary,a=t==null?void 0:t.operations.summary,s=t==null?void 0:t.operations.microarch,o=t==null?void 0:t.decisions.summary,r=t==null?void 0:t.alerts.summary,l=(d=s==null?void 0:s.signals)==null?void 0:d.routing_confidence,p=(v=s==null?void 0:s.signals)==null?void 0:v.issue_pressure,$=s==null?void 0:s.search_fabric,m=s==null?void 0:s.cache;return i`
    <div class="command-summary-grid">
      ...
      <div class="monitor-stat-card"><span>Microarch</span><strong>${(p==null?void 0:p.pending_ops)??0}</strong><small>${(m==null?void 0:m.l1_hit_rate)!=null?`${Li(m.l1_hit_rate)} L1 hit`:"no cache data"} · ${(p==null?void 0:p.tone)??"n/a"}</small></div>
    </div>
    ...
    <div class="command-guide-card ${J(e)}">
      ...
      ${t?i`
            <div class="command-card-grid">
              ...
              <span>Captured</span><span>${nt(t.captured_at)}</span>
  ...
  `}function xp(){const t=Pi(),e=t==null?void 0:t.swarm_status,n=t==null?void 0:t.swarm_proof,a=(e==null?void 0:e.lanes.filter(p=>p.present))??[],s=(e==null?void 0:e.gaps.items)??[],o=(e==null?void 0:e.timeline.slice(0,8))??[],r=e==null?void 0:e.overview,l=e==null?void 0:e.recommended_next_action;return i`
    <section class="card command-section">
      ...
      ${e?i`
            <div class="command-summary-grid command-swarm-summary">
              ...
              <div class="monitor-stat-card"><span>Last Movement</span><strong>${nt(r==null?void 0:r.last_movement_at)}</strong><small>${e.generated_at?`snapshot ${nt(e.generated_at)}`:"snapshot now"}</small></div>
  ...
  `}function Ap(){var vt,ft,B,M,x,It,Yt,le,ce;const t=Pi(),e=Bt.value,n=oe.value,a=cp(),s=a?Ct.value.find(I=>I.name===a)??null:null,o=a?xt.value.filter(I=>I.assignee===a&&pp(I)):[],r=((vt=t==null?void 0:t.operations.summary)==null?void 0:vt.active)??0,l=((ft=t==null?void 0:t.detachments.summary)==null?void 0:ft.total)??0,p=((B=t==null?void 0:t.decisions.summary)==null?void 0:B.pending)??0,$=e==null?void 0:e.detachments.detachments.find(I=>{const Mt=I.detachment.heartbeat_deadline,de=Mt?Date.parse(Mt):Number.NaN;return I.detachment.status==="stalled"||!Number.isNaN(de)&&de<=Date.now()}),m=e==null?void 0:e.alerts.alerts.find(I=>I.severity==="bad"),d=!!(n!=null&&n.room||n!=null&&n.project),v=(s==null?void 0:s.current_task)??null,c=up(s==null?void 0:s.last_seen),y=c!=null?c<=120:null,S=[d?{title:"Room readiness",tone:"ok",detail:`${(n==null?void 0:n.room)??(n==null?void 0:n.project)??"unknown"} · base ${(n==null?void 0:n.room_base_path)??"n/a"}`,tool:"masc_status"}:{title:"Room readiness",tone:"bad",detail:"No room snapshot yet. Set room to repo root before joining.",tool:"masc_set_room"},a?s?o.length===0?{title:"Task readiness",tone:"warn",detail:`${a} has no claimed task. Claim one or create one first.`,tool:xt.value.length>0?"masc_claim":"masc_add_task"}:v?y===!1?{title:"Task readiness",tone:"warn",detail:`${a} current_task=${v}, but heartbeat is stale (${c}s).`,tool:"masc_heartbeat"}:{title:"Task readiness",tone:"ok",detail:`${a} current_task=${v}${c!=null?` · last seen ${c}s ago`:""}`,tool:"masc_plan_get_task"}:{title:"Task readiness",tone:"bad",detail:`${a} has a claimed task but no session current_task binding.`,tool:"masc_plan_set_task"}:{title:"Task readiness",tone:"bad",detail:`${a} is not visible in the room roster.`,tool:"masc_join"}:{title:"Task readiness",tone:"warn",detail:"No ?agent= query param. Dashboard can show room health but not agent-specific next steps.",tool:"masc_join"},!t||(((M=t.topology.summary)==null?void 0:M.managed_unit_count)??0)===0?{title:"Operation readiness",tone:"warn",detail:"No managed units defined yet. CPv2 benchmark cannot start before hierarchy exists.",tool:"masc_unit_define"}:r===0?{title:"Operation readiness",tone:"warn",detail:`${((x=t.topology.summary)==null?void 0:x.managed_unit_count)??0} managed units are ready, but there is no active operation.`,tool:"masc_operation_start"}:{title:"Operation readiness",tone:"ok",detail:`${r} active operation(s) across ${((It=t.topology.summary)==null?void 0:It.managed_unit_count)??0} managed unit(s).`,tool:"masc_observe_operations"},p>0?{title:"Dispatch readiness",tone:"warn",detail:`${p} pending approval(s) are blocking strict actions.`,tool:"masc_policy_approve"}:r>0&&l===0?{title:"Dispatch readiness",tone:"bad",detail:"Active operation exists but no detachment has been materialized yet.",tool:"masc_dispatch_tick"}:$||m?{title:"Dispatch readiness",tone:"warn",detail:`Dispatch needs reconciliation${$?` · detachment ${$.detachment.detachment_id} is stalled`:""}${m?` · alert ${m.title??m.alert_id}`:""}${!e&&!$&&!m?" · open a detail tab to inspect the exact source.":""}.`,tool:p>0?"masc_policy_approve":"masc_dispatch_tick"}:{title:"Dispatch readiness",tone:"ok",detail:`${l} detachment(s) visible and no strict approval backlog${e?"":" · detail panes stay lazy until opened."}.`,tool:"masc_detachment_list"}],T=d?!a||!s?"masc_join":o.length===0?xt.value.length>0?"masc_claim":"masc_add_task":v?y===!1?"masc_heartbeat":!t||(((Yt=t.topology.summary)==null?void 0:Yt.managed_unit_count)??0)===0?"masc_unit_define":r===0?"masc_operation_start":p>0?"masc_policy_approve":r>0&&l===0||$||m?"masc_dispatch_tick":"masc_observe_traces":"masc_plan_set_task":"masc_set_room",P=mp(T),E=vp(T==="masc_set_room"?["repo-root-room"]:T==="masc_plan_set_task"?["claimed-not-current"]:T==="masc_heartbeat"?["heartbeat-stale"]:T==="masc_dispatch_tick"?["no-detachments"]:T==="masc_policy_approve"?["pending-approval"]:["repo-root-room","claimed-not-current","heartbeat-stale"]).slice(0,2),N=us("room_task_hygiene"),R=us("cpv2_benchmark"),X=us("supervisor_session"),H=((le=qn.value)==null?void 0:le.docs)??[],Et=[N,R,X].filter(I=>I!==null);return i`
    <div class="command-guided-layout">
      <section class="card command-section">
        ...
        <div class="command-guide-card highlight command-next-step-card">
          ...
          ${(ce=P==null?void 0:P.success_signals)!=null&&ce.length?i`<div class="command-tag-row">
      ...
      <section class="card command-section">
        ...
        ${Qs.value?i`<div class="empty-state">Loading CPv2 runbook…</div>`:Sa.value?i`<div class="empty-state error">${Sa.value}</div>`:i`
  ...
  `}function Cp(){return ya.value?i`<div class="empty-state">Loading command-plane detail…</div>`:ka.value?i`<div class="empty-state error">${ka.value}</div>`:i`<div class="empty-state">Select a surface to load command-plane detail.</div>`}function wr({node:t,depth:e=0}){const n=t.roster_live??0,a=t.roster_total??t.unit.roster.length,s=t.active_operation_count??0,o=t.unit.policy;return i`
  ...
  `}function Tp({source:t}){const e=Co(null),[n,a]=Ga(null);return lt(()=>{let s=!1;const o=e.current;return o?(o.innerHTML="",a(null),(async()=>{try{const l=await ap(),{svg:p}=await l.render(`command-chain-${++np}`,t);if(s||!e.current)return;e.current.innerHTML=p}catch(l){if(s)return;a(l instanceof Error?l.message:"Mermaid render failed")}})(),()=>{s=!0,e.current&&(e.current.innerHTML="")}):void 0},[t]),i`
  ...
  `}function Np({overlay:t,selected:e,onSelect:n}){const a=t.operation.chain,s=t.runtime;return i`
    <button class="command-chain-item ${e?"selected":""}" onClick=${n}>
      <div class="command-card-head">
        ...
        <span class="command-chip ${ee(a==null?void 0:a.status)}">${(a==null?void 0:a.status)??t.operation.status}</span>
      </div>
      <div class="command-tag-row">
        ...
        ${s?i`<span class="command-tag ${ee(a==null?void 0:a.status)}">${Li(s.progress)} progress</span>`:null}
      </div>
  ...
  `}function Rp({item:t}){return i`
    <article class="command-chain-history-row">
      <div class="command-guide-head">
        ...
        <span class="command-chip ${ee(t.event)}">${t.event}</span>
      </div>
  ...
  `}function Lp({node:t}){return i`
    <article class="command-chain-node-row">
      <div class="command-guide-head">
        <strong>${t.id}</strong>
        <span class="command-chip ${ee(t.status)}">${t.status??"unknown"}</span>
      </div>
  ...
  `}function Pp({card:t}){const e=t.operation,n=`pause:${e.operation_id}`,a=`resume:${e.operation_id}`,s=`recall:${e.operation_id}`,o=e.chain;return i`
    <article class="command-card">
      ...
      <div class="command-card-grid">
        ...
        <span>Updated</span><span>${nt(e.updated_at)}</span>
      </div>
      ${o?i`
            <div class="command-tag-row">
              <span class="command-tag">${o.kind}</span>
              <span class="command-tag ${ee(o.status)}">${o.status}</span>
      ...
      <div class="command-action-row">
        ${o?i`
              <button
                ...
                onClick=${()=>{Ni(e.operation_id),Ci("chains"),Pt("command",{surface:"chains",operation:e.operation_id})}}
              >
                Open Chain
              </button>
            `:null}
        ${e.source==="managed"&&e.status==="active"?i`
              <button class="control-btn ghost" disabled=${ot(n)} onClick=${()=>ne(()=>Bu(e.operation_id))}>
                ${ot(n)?"Pausing…":"Pause"}
              </button>
              <button class="control-btn ghost" disabled=${ot(s)} onClick=${()=>ne(()=>Gu(e.operation_id))}>
                ${ot(s)?"Recalling…":"Recall"}
              </button>
            `:null}
        ${e.source==="managed"&&e.status==="paused"?i`
              <button class="control-btn ghost" disabled=${ot(a)} onClick=${()=>ne(()=>Wu(e.operation_id))}>
                ${ot(a)?"Resuming…":"Resume"}
              </button>
            `:null}
      </div>
    </article>
  `}function Dp({card:t}){var n;const e=t.detachment;return i`
    <article class="command-card compact">
      ...
      <div class="command-card-grid">
        ...
        <span>Progress</span><span>${nt(e.last_progress_at)}</span>
  ...
  `}function Ip({decision:t}){const e=`approve:${t.decision_id}`,n=`deny:${t.decision_id}`,a=t.source==="projected_operator";return i`
    <article class="command-card ${J(t.status)}">
      ...
      <div class="command-card-grid">
        ...
        <span>Created</span><span>${nt(t.created_at)}</span>
        <span>Reason</span><span>${t.reason??"n/a"}</span>
      </div>
      ${t.status==="pending"&&!a?i`
            <div class="command-action-row">
              <button class="control-btn ghost" disabled=${ot(e)} onClick=${()=>ne(()=>Vu(t.decision_id))}>
                ${ot(e)?"Approving…":"Approve"}
              </button>
              <button class="control-btn ghost" disabled=${ot(n)} onClick=${()=>ne(()=>Qu(t.decision_id))}>
                ${ot(n)?"Denying…":"Deny"}
              </button>
            </div>
          `:null}
  ...
  `}function Mp({row:t}){var l,p,$;const e=t.unit,n=`freeze:${e.unit_id}`,a=`kill:${e.unit_id}`,s=!!((l=e.policy)!=null&&l.frozen),o=!!((p=e.policy)!=null&&p.kill_switch),r=Math.round((t.utilization??0)*100);return i`
    <article class="command-card compact">
      ...
      <div class="command-action-row">
        <button class="control-btn ghost" disabled=${ot(n)} onClick=${()=>ne(()=>Yu(e.unit_id,!s))}>
          ${ot(n)?"Applying…":s?"Unfreeze":"Freeze"}
        </button>
        <button class="control-btn ghost" disabled=${ot(a)} onClick=${()=>ne(()=>Xu(e.unit_id,!o))}>
          ${ot(a)?"Applying…":o?"Clear Kill Switch":"Enable Kill Switch"}
        </button>
      </div>
    </article>
  ...
  `}function jp({worker:t}){return i`
    <article class="command-card compact">
      ...
      ${t.last_message?i`<div class="command-card-foot">${nt(t.last_message.timestamp)} · ${t.last_message.content}</div>`:null}
    </article>
  `}function qp(){var l,p,$,m,d,v,c,y,S,T,P,K,E,N,R,X,H,Et,vt,ft,B;const t=ur.value,e=dp(),n=(l=t==null?void 0:t.provider)!=null&&l.runtime_blocker?"blocked":(p=t==null?void 0:t.provider)!=null&&p.provider_reachable?"ready":"check",a=(($=t==null?void 0:t.provider)==null?void 0:$.actual_slots)??((m=t==null?void 0:t.provider)==null?void 0:m.total_slots)??0,s=((d=t==null?void 0:t.provider)==null?void 0:d.expected_slots)??"n/a",o=((v=t==null?void 0:t.provider)==null?void 0:v.actual_ctx)??((c=t==null?void 0:t.provider)==null?void 0:c.ctx_per_slot)??0,r=((y=t==null?void 0:t.provider)==null?void 0:y.expected_ctx)??"n/a";return i`
    <div class="command-surface-grid">
      <section class="card command-section">
        <div class="card-title">Swarm Live Run</div>
        ${Ys.value?i`<div class="empty-state">Loading swarm live state…</div>`:Aa.value?i`<div class="empty-state error">${Aa.value}</div>`:t?i`
                  <div class="command-summary-grid">
                  ...
                  <div class="command-card-grid">
                    ...
                    <span>Detachment</span><span>${((Et=t.detachment)==null?void 0:Et.detachment_id)??"none"}</span>
                    <span>Expected</span><span>${((vt=t.summary)==null?void 0:vt.expected_workers)??0} workers</span>
                    <span>Final Markers</span><span>${((ft=t.summary)==null?void 0:ft.final_markers_seen)??0}</span>
      ...
      <section class="card command-section">
        ...
        ${t!=null&&t.provider?i`
              <div class="command-card-grid">
                ...
                <span>Last Sample</span><span>${t.provider.last_sample_at?nt(t.provider.last_sample_at):"n/a"}</span>
                <span>Runtime Blocker</span><span>${t.provider.runtime_blocker??"none"}</span>
                <span>Doctor Checked</span><span>${t.provider.checked_at?nt(t.provider.checked_at):"n/a"}</span>
              </div>
                      ...
                      <article class="command-trace-row">
                        <div class="command-trace-main">
                          <div class="command-trace-head">
                            ...
                            <span class="command-chip">${nt(M.timestamp)}</span>
                          </div>
  ...
  `}function Fp(){const t=Bt.value;return i`
    <div class="command-surface-grid">
      <section class="card command-section">
  ...
  `}function Kp(){var l,p,$,m,d,v,c,y,S,T,P,K,E,N,R,X;const t=Ai.value,e=(t==null?void 0:t.operations)??[],n=dn.value,a=e.find(H=>H.operation.operation_id===n)??e[0]??null,s=((l=a==null?void 0:a.operation.chain)==null?void 0:l.run_id)??null,o=((p=Dn.value)==null?void 0:p.run)??(a==null?void 0:a.preview_run)??null,r=!(($=Dn.value)!=null&&$.run)&&!!(a!=null&&a.preview_run);return lt(()=>{s?Hu(s):Ku()},[s]),i`
    <div class="command-grid">
      <section class="card command-section">
        <div class="card-title">Chains</div>
        <article class="command-guide-card ${ee(t==null?void 0:t.connection.status)}">
          <div class="command-guide-head">
            <strong>llm-mcp connection</strong>
            <span class="command-chip ${ee(t==null?void 0:t.connection.status)}">${(t==null?void 0:t.connection.status)??"disconnected"}</span>
          </div>
          ...
          <div class="command-card-grid">
            ...
            <span>Last Event</span><span>${nt((c=t==null?void 0:t.summary)==null?void 0:c.last_history_event_at)}</span>
          </div>
        </article>

        ${wa.value?i`<div class="empty-state error">${wa.value}</div>`:null}

        ${Xs.value&&!t?i`<div class="empty-state">Loading chain overlays…</div>`:e.length>0?i`
                <div class="command-chain-list">
                  ${e.map(H=>i`
                    <${Np}
                      overlay=${H}
                      selected=${(a==null?void 0:a.operation.operation_id)===H.operation.operation_id}
                      onSelect=${()=>Ni(H.operation.operation_id)}
                    />
                  `)}
                </div>
        ...
        ${a?i`
              <article class="command-card">
                <div class="command-card-head">
                  ...
                  <span class="command-chip ${ee((y=a.operation.chain)==null?void 0:y.status)}">
                ...
                <div class="command-card-grid">
                  ...
                  <span>Progress</span><span>${Li((K=a.runtime)==null?void 0:K.progress)}</span>
                  <span>Elapsed</span><span>${sp((E=a.runtime)==null?void 0:E.elapsed_sec)}</span>
                  <span>Updated</span><span>${nt(((N=a.operation.chain)==null?void 0:N.last_sync_at)??a.operation.updated_at)}</span>
                </div>
              ...
              <div class="command-chain-panel">
                ...
                ${Ca.value?i`<div class="empty-state">Loading run detail…</div>`:En.value?i`<div class="empty-state error">${En.value}</div>`:o&&o.nodes.length>0?i`
                          <div class="command-card-grid">
  ...
  `}function Hp(){const t=Bt.value;return i`
    <section class="card command-section">
  ...
  `}function Up(){const t=Bt.value;return i`
    <section class="card command-section">
  ...
  `}function Bp(){const t=Bt.value;return i`
    <section class="card command-section">
  ...
  `}function Wp(){const t=Bt.value;return i`
    <div class="command-surface-grid">
      <section class="card command-section">
  ...
  `}function Gp(){if(Ke.value==="summary")return i`<${wp} />`;if(!Bt.value)return i`<${Cp} />`;switch(Ke.value){case"swarm":return i`<${qp} />`;case"chains":return i`<${Kp} />`;case"topology":return i`<${Hp} />`;case"alerts":return i`<${Up} />`;case"trace":return i`<${Bp} />`;case"control":return i`<${Wp} />`;case"operations":default:return i`<${Fp} />`}}function Jp(){return lt(()=>{Me(),he(),Uu(),xr()},[]),lt(()=>{if(at.value.tab!=="command")return;const t=at.value.params.surface,e=at.value.params.operation;op(t)&&Ci(t),e&&Ni(e)},[at.value.tab,at.value.params.surface,at.value.params.operation]),lt(()=>{let t=null;const e=()=>{t||(t=window.setTimeout(()=>{t=null,Me(),he()},250))},n=new EventSource(rp()),a=ip.map(s=>{const o=()=>e();return n.addEventListener(s,o),{type:s,handler:o}});return n.onerror=()=>{e()},()=>{a.forEach(({type:s,handler:o})=>{n.removeEventListener(s,o)}),n.close(),t&&window.clearTimeout(t)}},[]),i`
    <section class="dashboard-panel command-plane-view">
      <div class="panel-header">
        ...
        <div class="panel-actions">
          ...
          >
            ${ot("dispatch:tick")?"Reconciling…":"Run Tick"}
          </button>
          <button class="control-btn ghost" onClick=${()=>{Me(),he()}} disabled=${ha.value}>
  ...
  `}const Fn=_(null),Ta=_(!1),ie=_(null),W=_(!1),Na=_([]);let Vp=1;function G(t){return typeof t=="object"&&t!==null&&!Array.isArray(t)}function D(t){return typeof t=="string"&&t.trim()!==""?t:void 0}function bt(t){return typeof t=="number"&&Number.isFinite(t)?t:void 0}function Tr(t){return typeof t=="boolean"?t:void 0}function Qp(t){return Array.isArray(t)?t.map(e=>typeof e=="string"?e.trim():"").filter(Boolean):[]}function Ce(t,e=[]){if(Array.isArray(t))return t;if(!G(t))return[];for(const n of e){const a=t[n];if(Array.isArray(a))return a}return[]}function Yp(t){return G(t)?{id:D(t.id),seq:bt(t.seq),from:D(t.from)??D(t.from_agent)??"system",content:D(t.content)??"",timestamp:D(t.timestamp)??new Date().toISOString(),type:D(t.type)}:null}function Xp(t){return G(t)?{room_id:D(t.room_id),current_room:D(t.current_room)??D(t.room),project:D(t.project),cluster:D(t.cluster),paused:Tr(t.paused),pause_reason:D(t.pause_reason)??null,paused_by:D(t.paused_by)??null,paused_at:D(t.paused_at)??null}:{}}function ro(t){if(!G(t))return;const e=Object.entries(t).map(([n,a])=>{const s=D(a);return s?[n,s]:null}).filter(n=>n!==null);return e.length>0?Object.fromEntries(e):void 0}function Zp(t){if(!G(t))return null;const e=G(t.status)?t.status:void 0,n=G(t.summary)?t.summary:G(e==null?void 0:e.summary)?e.summary:void 0,a=G(t.session)?t.session:G(e==null?void 0:e.session)?e.session:void 0,s=D(t.session_id)??D(n==null?void 0:n.session_id)??D(a==null?void 0:a.session_id);if(!s)return null;const o=ro(t.report_paths)??ro(e==null?void 0:e.report_paths),r=Ce(t.recent_events,["events"]).filter(G);return{session_id:s,status:D(t.status)??D(n==null?void 0:n.status)??D(a==null?void 0:a.status),progress_pct:bt(t.progress_pct)??bt(n==null?void 0:n.progress_pct),elapsed_sec:bt(t.elapsed_sec)??bt(n==null?void 0:n.elapsed_sec),remaining_sec:bt(t.remaining_sec)??bt(n==null?void 0:n.remaining_sec),done_delta_total:bt(t.done_delta_total)??bt(n==null?void 0:n.done_delta_total),summary:n,team_health:G(t.team_health)?t.team_health:G(e==null?void 0:e.team_health)?e.team_health:void 0,communication_metrics:G(t.communication_metrics)?t.communication_metrics:G(e==null?void 0:e.communication_metrics)?e.communication_metrics:void 0,orchestration_state:G(t.orchestration_state)?t.orchestration_state:G(e==null?void 0:e.orchestration_state)?e.orchestration_state:void 0,cascade_metrics:G(t.cascade_metrics)?t.cascade_metrics:G(e==null?void 0:e.cascade_metrics)?e.cascade_metrics:void 0,report_paths:o,session:a,recent_events:r}}function tm(t){if(!G(t))return null;const e=D(t.name);if(!e)return null;const n=G(t.context)?t.context:void 0;return{name:e,agent_name:D(t.agent_name),status:D(t.status),autonomy_level:D(t.autonomy_level),context_ratio:bt(t.context_ratio)??bt(n==null?void 0:n.context_ratio),generation:bt(t.generation),active_goal_ids:Qp(t.active_goal_ids),last_autonomous_action_at:D(t.last_autonomous_action_at)??null,last_turn_ago_s:bt(t.last_turn_ago_s),model:D(t.model)??D(t.active_model)??D(t.primary_model)}}function em(t){if(!G(t))return null;const e=D(t.confirm_token)??D(t.token);return e?{confirm_token:e,actor:D(t.actor),action_type:D(t.action_type),target_type:D(t.target_type),target_id:D(t.target_id)??null,delegated_tool:D(t.delegated_tool),created_at:D(t.created_at),preview:t.preview}:null}function nm(t){const e=G(t)?t:{};return{room:Xp(e.room),sessions:Ce(e.sessions,["items","sessions"]).map(Zp).filter(n=>n!==null),keepers:Ce(e.keepers,["items","keepers"]).map(tm).filter(n=>n!==null),recent_messages:Ce(e.recent_messages,["messages"]).map(Yp).filter(n=>n!==null),pending_confirms:Ce(e.pending_confirms,["items","confirms"]).map(em).filter(n=>n!==null),available_actions:Ce(e.available_actions,["actions"]).filter(G).map(n=>({action_type:D(n.action_type)??"unknown",target_type:D(n.target_type)??"unknown",description:D(n.description),confirm_required:Tr(n.confirm_required)}))}}function Bn(t){if(typeof t=="string")return t;if(t==null)return"";try{return JSON.stringify(t)}catch{return String(t)}}function lo(t){return t.target_id?`${t.target_type}:${t.target_id}`:t.target_type}function Ra(t){Na.value=[{...t,id:Vp++,at:new Date().toISOString()},...Na.value].slice(0,20)}function Nr(t){return t.confirm_required?Bn(t.preview)||"Confirmation required":Bn(t.result)||Bn(t.executed_action)||Bn(t.delegated_tool_result)||t.status}async function He(){Ta.value=!0,ie.value=null;try{const t=await wl();Fn.value=nm(t)}catch(t){ie.value=t instanceof Error?t.message:"Failed to load operator snapshot"}finally{Ta.value=!1}}async function am(t){W.value=!0,ie.value=null;try{const e=await jn(t);return Ra({actor:t.actor,action_type:t.action_type,target_label:lo(t),outcome:e.confirm_required?"preview":"executed",message:Nr(e),delegated_tool:e.delegated_tool}),await He(),e}catch(e){const n=e instanceof Error?e.message:"Operator action failed";throw ie.value=n,Ra({actor:t.actor,action_type:t.action_type,target_label:lo(t),outcome:"error",message:n}),e}finally{W.value=!1}}async function sm(t,e){W.value=!0,ie.value=null;try{const n=await Il(t,e);return Ra({actor:t,action_type:"confirm",target_label:e,outcome:"confirmed",message:Nr(n),delegated_tool:n.delegated_tool}),await He(),n}catch(n){const a=n instanceof Error?n.message:"Operator confirmation failed";throw ie.value=a,Ra({actor:t,action_type:"confirm",target_label:e,outcome:"error",message:a}),n}finally{W.value=!1}}const Rr="masc_dashboard_agent_name";function im(){var e,n,a;const t=new URLSearchParams(window.location.search);return((e=t.get("agent"))==null?void 0:e.trim())||((n=t.get("agent_name"))==null?void 0:n.trim())||((a=localStorage.getItem(Rr))==null?void 0:a.trim())||"dashboard"}const Ya=_(im()),un=_(""),Zs=_("Operator pause"),pn=_(""),La=_(""),ti=_("2"),Pa=_(""),Oe=_("note"),Da=_(""),Ea=_(""),Ia=_(""),ei=_("2"),ni=_("Operator stop request"),ai=_(""),mn=_("");function om(t){const e=t.trim()||"dashboard";Ya.value=e,localStorage.setItem(Rr,e)}function ps(t){if(t==null)return"";if(typeof t=="string")return t;try{return JSON.stringify(t,null,2)}catch{return String(t)}}function rm(t){return typeof t!="number"||!Number.isFinite(t)?"n/a":t<60?`${Math.round(t)}s ago`:t<3600?`${Math.round(t/60)}m ago`:`${Math.round(t/3600)}h ago`}function Ma(t){return typeof t=="string"?t.trim().toLowerCase():""}function lm(t){var a;const e=Ma(t.status);if(e==="paused")return"bad";const n=Ma((a=t.team_health)==null?void 0:a.status);return n&&n!=="ok"&&n!=="healthy"&&n!=="green"||e&&e!=="active"&&e!=="running"&&e!=="ended"?"warn":"ok"}function co(t){const e=Ma(t.status);return e==="offline"||e==="inactive"||e==="error"?"bad":(t.context_ratio??0)>=.8||(t.last_turn_ago_s??0)>=3600?"warn":"ok"}async function be(t){const e=Ya.value.trim()||"dashboard";try{const n=await am({actor:e,action_type:t.action_type,target_type:t.target_type,target_id:t.target_id,payload:t.payload});return n.confirm_required?w("Confirmation queued","warning"):w(t.successMessage,"success"),n}catch(n){const a=n instanceof Error?n.message:"Operator action failed";return w(a,"error"),null}}async function uo(){const t=un.value.trim();if(!t)return;await be({action_type:"broadcast",target_type:"room",payload:{message:t},successMessage:"Broadcast sent"})&&(un.value="")}async function cm(){await be({action_type:"room_pause",target_type:"room",payload:{reason:Zs.value.trim()||"Operator pause"},successMessage:"Pause request sent"})}async function dm(){await be({action_type:"room_resume",target_type:"room",payload:{},successMessage:"Room resumed"})}async function um(){const t=pn.value.trim();if(!t)return;await be({action_type:"task_inject",target_type:"room",payload:{title:t,description:La.value.trim()||"Injected from Ops tab",priority:Number.parseInt(ti.value,10)||2},successMessage:"Task injection submitted"})&&(pn.value="",La.value="")}async function pm(){var o;const t=Fn.value,e=Pa.value||((o=t==null?void 0:t.sessions[0])==null?void 0:o.session_id)||"";if(!e){w("Select a team session first","warning");return}const n={turn_kind:Oe.value},a=Da.value.trim();a&&(n.message=a),Oe.value==="task"&&(n.task_title=Ea.value.trim()||"Operator injected task",n.task_description=Ia.value.trim()||"Injected from Ops tab",n.task_priority=Number.parseInt(ei.value,10)||2),await be({action_type:"team_turn",target_type:"team_session",target_id:e,payload:n,successMessage:"Team session updated"})&&(Da.value="",Oe.value==="task"&&(Ea.value="",Ia.value=""))}async function mm(){var n;const t=Fn.value,e=Pa.value||((n=t==null?void 0:t.sessions[0])==null?void 0:n.session_id)||"";if(!e){w("Select a team session first","warning");return}await be({action_type:"team_stop",target_type:"team_session",target_id:e,payload:{reason:ni.value.trim()||"Operator stop request"},successMessage:"Team stop requested"})}async function vm(){var s;const t=Fn.value,e=ai.value||((s=t==null?void 0:t.keepers[0])==null?void 0:s.name)||"",n=mn.value.trim();if(!e){w("Select a keeper first","warning");return}if(!n)return;await be({action_type:"keeper_msg",target_type:"keeper",target_id:e,payload:{message:n},successMessage:`Message sent to ${e}`})&&(mn.value="")}async function po(t){const e=Ya.value.trim()||"dashboard";try{await sm(e,t),w("Confirmation executed","success")}catch(n){const a=n instanceof Error?n.message:"Confirmation failed";w(a,"error")}}function fm(){var v;const t=Fn.value,e=(t==null?void 0:t.room)??{},n=(t==null?void 0:t.sessions)??[],a=(t==null?void 0:t.keepers)??[],s=(t==null?void 0:t.pending_confirms)??[],o=(t==null?void 0:t.recent_messages)??[],r=n.find(c=>c.session_id===Pa.value)??n[0]??null,l=a.find(c=>c.name===ai.value)??a[0]??null,p=n.filter(c=>lm(c)!=="ok"),$=a.filter(c=>co(c)!=="ok"),m=o.slice(0,5),d=[{key:"room",label:"Room Gate",value:e.paused?"Paused":"Open",detail:e.paused?`Resume gate armed${e.pause_reason?` · ${e.pause_reason}`:""}`:"Commands are live and the room is accepting new work",tone:e.paused?"bad":"ok"},{key:"confirm",label:"Pending Confirm",value:s.length,detail:s.length>0?"Previewed operator actions are waiting for confirmation":"No confirm gates are currently blocking execution",tone:s.length>0?"warn":"ok"},{key:"session",label:"Session Risk",value:p.length,detail:p.length>0?"Team sessions need steering, stop, or checkpoint attention":"Team sessions look healthy from the operator snapshot",tone:p.some(c=>Ma(c.status)==="paused")?"bad":p.length>0?"warn":"ok"},{key:"keeper",label:"Keeper Pressure",value:$.length,detail:$.length>0?"At least one keeper is stale, offline, or running hot":"Keepers are available for direct intervention",tone:$.some(c=>co(c)==="bad")?"bad":$.length>0?"warn":"ok"}];return i`
    <section class="ops-view">
      <div class="ops-header card">
        ...
        <div class="ops-toolbar">
          ...
          />
          <button class="control-btn ghost" onClick=${()=>{He()}} disabled=${Ta.value||W.value}>
      ...
      ${ie.value?i`
        <section class="ops-banner error">${ie.value}</section>
      `:null}
          ...
          <div class="ops-confirmation-list">
            ${s.map(c=>i`
              <article key=${c.confirm_token} class="ops-confirmation-card">
                ...
                ${c.preview?i`<pre class="ops-code-block">${ps(c.preview)}</pre>`:null}
              ...
              <div class="ops-confirmation-list">
                ${s.map(c=>i`
                  <article key=${c.confirm_token} class="ops-confirmation-card">
                    ...
                    ${c.preview?i`<pre class="ops-code-block compact">${ps(c.preview)}</pre>`:null}
                    <div class="ops-confirmation-actions">
                      <button class="control-btn" onClick=${()=>{po(c.confirm_token)}} disabled=${W.value}>
                        Confirm
                      </button>
          ...
          <section class="card ops-panel ops-studio-panel">
            ...
            <div class="ops-studio-group">
              ...
              <div class="control-row ops-split-row">
                ...
                <button class="control-btn" onClick=${()=>{um()}} disabled=${W.value||pn.value.trim()===""}>
                  Inject
                </button>
              </div>
            </div>
            ...
            <div class="ops-studio-group">
              ...
              ${r?i`
                <div class="ops-detail-card">
                  ...
                  ${r.recent_events&&r.recent_events.length>0?i`
                    <pre class="ops-code-block compact">${ps(r.recent_events.slice(-3))}</pre>
                  `:null}
                </div>
              ...
              ${Oe.value==="task"?i`
                ...
                <select
                  class="control-input ops-select"
                  value=${ei.value}
                  onChange=${c=>{ei.value=c.target.value}}
                  disabled=${W.value||!r}
                >
                  <option value="1">P1</option>
                  <option value="2">P2</option>
              ...
              <div class="control-row ops-split-row">
                <input
                  ...
                  type="text"
                  value=${ni.value}
                  onInput=${c=>{ni.value=c.target.value}}
                  disabled=${W.value||!r}
                />
            ...
            <div class="ops-studio-group">
              ...
              ></textarea>
              <div class="control-row">
                <button class="control-btn" onClick=${()=>{vm()}} disabled=${W.value||!l||mn.value.trim()===""}>
                  Send Keeper Message
                </button>
              </div>
            </div>
...
`).trim();n.push(i`
      ...
      `);continue}if(s.startsWith("> ")){const r=[];for(;a<e.length&&e[a].startsWith("> ");)r.push(e[a].slice(2)),a++;n.push(i`<blockquote>${ms(r.join(`
`))}</blockquote>`);continue}if(s.trim()===""){a++;continue}const o=[];for(;a<e.length;){const r=e[a];if(r.trim()===""||/^(`{3,}|~{3,})/.test(r)||r.startsWith("> ")||r.trim().startsWith("<think>"))break;o.push(r),a++}o.length>0&&n.push(i`<p>${ms(o.join(`
`))}</p>`)}return n}function ms(t){const e=[],n=/(`[^`]+`)|(\*\*[^*]+\*\*)|(\*[^*]+\*)|\[([^\]]+)\]\(([^)]+)\)/g;let a=0,s;for(;(s=n.exec(t))!==null;){if(s.index>a&&e.push(t.slice(a,s.index)),s[1]){const o=s[1].slice(1,-1);e.push(i`<code>${o}</code>`)}else if(s[2]){const o=s[2].slice(2,-2);e.push(i`<strong>${o}</strong>`)}else if(s[3]){const o=s[3].slice(1,-1);e.push(i`<em>${o}</em>`)}else s[4]&&s[5]&&e.push(i`<a href=${s[5]} target="_blank" rel="noopener">${s[4]}</a>`);a=s.index+s[0].length}return a<t.length&&e.push(t.slice(a)),e.length>0?e:[t]}const on=_("posts"),si=_([]),ii=_([]),vn=_(""),Oa=_(!1),fn=_(!1),In=_(""),za=_(null),Rt=_(null),oi=_(!1),te=_(null),oa=_(null);async function Xa(){Oa.value=!0,In.value="";try{const[t,e]=await Promise.all([$c(),hc()]);si.value=t,ii.value=e,te.value=!0,oa.value=Date.now()}catch(t){In.value=t instanceof Error?t.message:"Failed to load council data",te.value=!1}finally{Oa.value=!1}}od(Xa);async function mo(){const t=vn.value.trim();if(t){fn.value=!0;try{const e=await yc(t);vn.value="",w(e!=null&&e.id?`Debate started: ${e.id}`:"Debate started","success"),await Xa()}catch(e){const n=e instanceof Error?e.message:"Failed to start debate";w(n,"error")}finally{fn.value=!1}}}async function $m(t){za.value=t,oi.value=!0,Rt.value=null;try{Rt.value=await bc(t)}catch(e){In.value=e instanceof Error?e.message:"Failed to load debate status",Rt.value=null}finally{oi.value=!1}}const Lr=[{id:"hot",label:"Hot"},{id:"trending",label:"Trending"},{id:"recent",label:"Recent"},{id:"updated",label:"Updated"},{id:"discussed",label:"Discussed"}],ra=_(null),_n=_([]),ye=_(!1),ge=_(null),gn=_("");function hm(){var e,n;const t=new URLSearchParams(window.location.search);return((e=t.get("agent"))==null?void 0:e.trim())||((n=t.get("agent_name"))==null?void 0:n.trim())||"dashboard-user"}const ym=_(hm()),$n=_(!1);async function Di(t){ge.value=t,ra.value=null,_n.value=[],ye.value=!0;try{const e=await Kl(t);if(ge.value!==t)return;ra.value={id:e.id,author:e.author,title:e.title,content:e.content,tags:e.tags,votes:e.votes,vote_balance:e.vote_balance,comment_count:e.comment_count,created_at:e.created_at,updated_at:e.updated_at,flair:e.flair,hearth_count:e.hearth_count},_n.value=e.comments??[]}catch{ge.value===t&&(ra.value=null,_n.value=[])}finally{ge.value===t&&(ye.value=!1)}}async function vo(t){const e=gn.value.trim();if(e){$n.value=!0;try{await Hl(t,ym.value,e),gn.value="",w("Comment posted","success"),await Di(t),Ft()}catch{w("Failed to post comment","error")}finally{$n.value=!1}}}function bm(){const t=wn.value;return i`
    <div class="board-toolbar">
      <div class="board-controls">
        ${Lr.map(e=>i`
          <button
            class="board-sort-btn ${t===e.id?"active":""}"
            onClick=${()=>{wn.value=e.id,Ft()}}
          >
            ${e.label}
          </button>
        `)}
      ...
      <div class="board-toolbar-actions">
        <button
          ...
          onClick=${()=>{me.value=!me.value,Ft()}}
        >
          ${me.value?"Hiding auto reports":"Show auto reports"}
        </button>
        <button class="control-btn ghost" onClick=${Ft} disabled=${Tn.value}>
          ${Tn.value?"Refreshing...":"Refresh"}
        </button>
      </div>
    </div>
  `}function ri(){var e;const t=(e=oe.value)==null?void 0:e.data_quality;return!t||t.board_contract_ok!==!1&&!t.last_sync_at?null:i`
  ...
  `}function Pr({flair:t}){return t?i`<span class="post-flair ${t}">${t}</span>`:null}function km(t){const e=t.replace(/!\[[^\]]*\]\([^)]+\)/g," ").replace(/\[[^\]]+\]\([^)]+\)/g,"$1").replace(/[`#>*_~-]/g," ").replace(/\s+/g," ").trim();return e?e.length>180?`${e.slice(0,177)}...`:e:"No preview available"}function fo(t){return t.updated_at!==t.created_at}function li(){var n;const t=((n=Lr.find(a=>a.id===wn.value))==null?void 0:n.label)??wn.value,e=Be.value.length;return i`
    <div class="board-summary-strip">
      ...
      <div class="board-summary-item">
        ...
        <strong>${Js.value?i`<${F} timestamp=${Js.value} />`:"Not loaded"}</strong>
      </div>
    </div>
  `}function xm({post:t}){const e=async(n,a)=>{a.stopPropagation();try{await zo(t.id,n),Ft()}catch{w("Failed to vote","error")}};return i`
  ...
  `}function wm({post:t}){ge.value!==t.id&&!ye.value&&Di(t.id);const e=async n=>{try{await zo(t.id,n),Ft()}catch{w("Failed to vote","error")}};return i`
    <div>
      ...
      <${C} title="Comments (${ye.value?"...":_n.value.length})">
        ${ye.value?i`<div class="loading-indicator">Loading comments...</div>`:i`<${Sm} comments=${_n.value} />`}
        <${Am} postId=${t.id} />
      <//>
    </div>
  `}function Cm({debate:t}){const e=za.value===t.id;return i`
    <button
  ...
  `}function Dr(){return te.value===null||te.value&&!oa.value?null:i`
    <div class="feed-health-banner ${te.value===!1?"degraded":"ok"}">
      <span class="feed-health-title">
        ${te.value===!1?"Council feed degraded":"Council feed synced"}
      </span>
      ${oa.value?i`<span class="feed-health-meta">Last sync: <${F} timestamp=${oa.value} /></span>`:i`<span class="feed-health-meta">No sync timestamp</span>`}
    </div>
  `}function Nm(){const t=te.value===!1;return i`
    <div>
      <${Dr} />
      <${C} title="Start Debate" class="section">
        <div class="council-create">
          ...
          <button class="control-btn ghost" onClick=${Xa} disabled=${Oa.value}>
      ...
      <${C} title="Debates" class="section">
        <div class="council-list">
          ${si.value.length===0?i`<div class="empty-state">${t?"No debates loaded (council feed degraded).":"No debates yet"}</div>`:si.value.map(e=>i`<${Cm} key=${e.id} debate=${e} />`)}
        </div>
      <//>

      <${C} title=${za.value?`Debate Detail (${za.value})`:"Debate Detail"} class="section">
        ${oi.value?i`<div class="loading-indicator">Loading debate detail...</div>`:Rt.value?i`
  ...
  `}function Rm(){const t=te.value===!1;return i`
    <div>
      <${Dr} />
      <${C} title="Voting Sessions" class="section">
        <div class="council-list">
          ${ii.value.length===0?i`<div class="empty-state">${t?"No sessions loaded (council feed degraded).":"No active sessions"}</div>`:ii.value.map(e=>i`<${Tm} key=${e.id} session=${e} />`)}
        </div>
      <//>
    </div>
  `}function Lm(){const t=on.value;return i`
  ...
  `}function Pm(){var a,s;const t=Be.value,e=Tn.value,n=((s=(a=oe.value)==null?void 0:a.data_quality)==null?void 0:s.board_contract_ok)===!1;return i`
    <div>
      <${ri} />
      <${li} />
      <${bm} />
      ${e?i`<div class="loading-indicator">Loading board...</div>`:t.length===0?i`
              <div class="empty-state">
                ${n?"No posts loaded (board feed degraded). Check board contract sync.":me.value?"No visible posts right now. Automated reports may be hidden; toggle them back on if you need the raw feed.":"No posts yet"}
              </div>
            `:i`<div class="board-post-list">
              ${t.map(o=>i`<${xm} key=${o.id} post=${o} />`)}
            </div>`}
    </div>
  `}function Dm(){var s,o;const t=Be.value,e=at.value.postId,n=((o=(s=oe.value)==null?void 0:s.data_quality)==null?void 0:o.board_contract_ok)===!1,a=on.value;if(lt(()=>{(a==="debates"||a==="voting")&&Xa()},[a]),e){const r=t.find(l=>l.id===e)??(ge.value===e?ra.value:null);return!r&&ge.value!==e&&!ye.value&&Di(e),r?i`
          <${ri} />
          <${li} />
          <${wm} post=${r} />
        `:i`
  ...
  `}const Em=40;function Im({items:t,itemHeight:e,overscan:n=5,renderItem:a,getKey:s,className:o=""}){const r=Co(null),[l,p]=Ga({start:0,end:30}),$=t.length>Em;if(lt(()=>{if(!$)return;const c=r.current;if(!c)return;let y=!1;const S=()=>{const{scrollTop:E,clientHeight:N}=c,R=Math.max(0,Math.floor(E/e)-n),X=Math.min(t.length,Math.ceil((E+N)/e)+n);p(H=>H.start===R&&H.end===X?H:{start:R,end:X})};let T=!1;const P=()=>{T||y||(T=!0,requestAnimationFrame(()=>{y||S(),T=!1}))},K=new ResizeObserver(()=>{y||S()});return S(),c.addEventListener("scroll",P,{passive:!0}),K.observe(c),()=>{y=!0,c.removeEventListener("scroll",P),K.disconnect()}},[$,t.length,e,n]),!$)return i`
      <div class=${o}>
        ${t.map((c,y)=>a(c,y))}
      </div>
  ...
  `}function Mm(t){if(t.kind)return t.kind;switch(t.eventType){case"board_post":case"board_comment":return"board";case"task_update":return"tasks";case"keeper_heartbeat":case"keeper_handoff":case"keeper_compaction":case"keeper_guardrail":return"keepers";default:return"system"}}function Om(t){var e,n;return((e=t.author)==null?void 0:e.trim())||((n=t.agent)==null?void 0:n.trim())||"system"}function zm(t){switch(t.eventType){case"board_post":return t.preview?`Post: ${t.preview}`:t.text||"New post";case"board_comment":return t.preview?`Comment: ${t.preview}`:t.text||"New comment";default:return t.text}}const Er=120,jm=12,qm=16,Fm=12,ci=_("all"),Km={all:"All",messages:"Messages",board:"Board",tasks:"Tasks",keepers:"Keepers",system:"System"},Hm={messages:"MSG",board:"BOARD",tasks:"TASK",keepers:"KEEPER",system:"SYS"};function Um(t,e){return{id:t.id??`msg-${t.seq??e}`,source:"message",kind:"messages",actor:t.from??"system",content:t.content,timestamp:t.timestamp}}function Bm(t,e){return{id:t.postId?`evt-${t.eventType??"event"}-${t.postId}-${e}`:`evt-${t.timestamp}-${e}`,source:"event",kind:Mm(t),actor:Om(t),content:zm(t),timestamp:new Date(t.timestamp).toISOString()}}function Wm(t,e){var s;const n=(s=t.assignee)==null?void 0:s.trim(),a=t.updated_at??t.created_at;return!n||!a?null:{id:`task-${t.id}-${e}`,source:"snapshot",kind:"tasks",actor:n,content:`Task: ${t.title} (${t.status})`,timestamp:a}}function Gm(t,e){return{id:`board-${t.id}-${e}`,source:"snapshot",kind:"board",actor:t.author,content:`Post: ${t.title||t.content}`,timestamp:t.updated_at||t.created_at}}function Wn(t){return typeof t!="number"||!Number.isFinite(t)||t<0?null:new Date(Date.now()-t*1e3).toISOString()}function di(t){return t.last_heartbeat??Wn(t.last_turn_ago_s)??Wn(t.last_proactive_ago_s)??Wn(t.last_handoff_ago_s)??Wn(t.last_compaction_ago_s)}function Jm(t,e){const n=di(t);if(!n)return null;const a=typeof t.context_ratio=="number"&&Number.isFinite(t.context_ratio)?`${Math.round(t.context_ratio*100)}%`:"?";return{id:`keeper-${t.name}-${e}`,source:"snapshot",kind:"keepers",actor:t.name,content:t.last_heartbeat?`Heartbeat gen=${t.generation??"?"} ctx=${a}`:`Keeper snapshot gen=${t.generation??"?"} ctx=${a}`,timestamp:n}}function Ot(t){const e=typeof t=="number"?t:Date.parse(t);return Number.isNaN(e)?0:e}const ui=Tt(()=>{const t=An.value.map(Um),e=pa.value.map(Bm),n=[...xt.value].sort((o,r)=>Ot(r.updated_at??r.created_at??0)-Ot(o.updated_at??o.created_at??0)).slice(0,jm).map(Wm).filter(o=>o!==null),a=[...Be.value].sort((o,r)=>Ot(r.updated_at||r.created_at)-Ot(o.updated_at||o.created_at)).slice(0,qm).map(Gm),s=[...Qt.value].sort((o,r)=>Ot(di(r)??0)-Ot(di(o)??0)).slice(0,Fm).map(Jm).filter(o=>o!==null);return[...t,...e,...n,...a,...s].sort((o,r)=>Ot(r.timestamp)-Ot(o.timestamp))}),Vm=Tt(()=>{const t=ui.value;return{total:t.length,messages:t.filter(e=>e.kind==="messages").length,board:t.filter(e=>e.kind==="board").length,tasks:t.filter(e=>e.kind==="tasks").length,keepers:t.filter(e=>e.kind==="keepers").length,system:t.filter(e=>e.kind==="system").length}}),Qm=Tt(()=>{const t=ci.value;return(t==="all"?ui.value:ui.value.filter(n=>n.kind===t)).slice(0,Er)}),Ym=Tt(()=>{const t=Va.value,e={activeAssignedCount:0,lastActivityAt:null,lastActivityText:null};return Ct.value.map(n=>({agent:n,motion:t.get(n.name.trim().toLowerCase())??e})).sort((n,a)=>{const s=a.motion.activeAssignedCount-n.motion.activeAssignedCount;return s!==0?s:Ot(a.motion.lastActivityAt??0)-Ot(n.motion.lastActivityAt??0)})});function Xm(t){const e=new Date(t);return Number.isNaN(e.getTime())?"00:00:00":e.toLocaleTimeString("en-US",{hour12:!1})}function en({label:t,value:e,color:n}){return i`
    <div class="stat-card">
      <div class="stat-label">${t}</div>
      <div class="stat-value" style=${n?`color:${n}`:""}>${e}</div>
    </div>
  ...
  `}function tv(){const t=Vm.value,e=Qm.value,n=e[0],a=Ym.value;return i`
    <div class="stats-grid">
      ...
      <${en} label="SSE events" value=${On.value} color="#c084fc" />
    </div>
      ...
      <div class="activity-toolbar">
        <div class="activity-filter-row">
          ${["all","messages","board","tasks","keepers","system"].map(s=>i`
            <button
              class="goal-filter-btn ${ci.value===s?"active":""}"
              onClick=${()=>{ci.value=s}}
            >
              ${Km[s]}
            </button>
  ...
  `}const vs=600*1e3,ev=1200*1e3,_o=.8;function Xt(t){if(t==null)return 0;const e=typeof t=="number"?t:Date.parse(t);return Number.isNaN(e)?0:e}function Ae(t){switch(t){case"bad":return 2;case"warn":return 1;default:return 0}}function nv(t){switch(t){case"working":return"Working";case"watching":return"Watching";case"quiet":return"Quiet";case"offline":return"Offline"}}function av(t){switch(t){case"critical":return"Critical";case"warning":return"Watch";default:return"Healthy"}}function sv(t){return typeof t!="number"||Number.isNaN(t)?"—":`${Math.round(t*100)}%`}function iv(t){var e;return t.inbox_latest_summary??t.last_successful_reaction_summary??t.continuity_summary??((e=t.agent)==null?void 0:e.current_task)??t.skill_primary??t.last_proactive_reason??t.memory_recent_note??"No active focus"}function ov(t){const e=[`Gen ${t.generation??"—"}`,`Turns ${t.turn_count??0}`,`Handoffs ${t.handoff_count_total??0}`];return(t.compaction_count??0)>0&&e.push(`Compactions ${t.compaction_count}`),e.join(" · ")}function rv(t){var p,$;const e=Va.value.get(t.name.trim().toLowerCase())??{activeAssignedCount:0,lastActivityAt:null,lastActivityText:null},n=e.lastActivityAt??t.last_seen??null,a=n?Math.max(0,Date.now()-Xt(n)):Number.POSITIVE_INFINITY,s=!!((p=t.current_task)!=null&&p.trim())||e.activeAssignedCount>0;let o="watching",r="ok",l="Healthy live signal";return t.status==="offline"||t.status==="inactive"?(o="offline",r="bad",l=n?"Offline or inactive":"No recent presence"):a>ev?(o="quiet",r="bad",l=s?"Working without a fresh signal":"No fresh agent signal"):s?(o="working",r=a>vs?"warn":"ok",l=a>vs?"Execution looks quiet for too long":"Task and live signal aligned"):a>vs?(o="quiet",r="warn",l="Quiet but still reachable"):t.status==="idle"&&(o="watching",r="ok",l="Standing by for the next task"),{agent:t,motion:e,lastSignalAt:n,activeTaskCount:e.activeAssignedCount,state:o,tone:r,focus:(($=t.current_task)==null?void 0:$.trim())||(e.activeAssignedCount>0?`${e.activeAssignedCount} claimed tasks waiting for explicit current_task`:e.lastActivityText??"Idle / waiting for assignment"),note:l}}function lv(t){const e=Vo.value.get(t.name)??"idle",n=Qo.value.has(t.name),a=t.context_ratio??0,s=t.pending_reactive_items??0,o=t.keepalive_running??!1,r=t.timeout_streak??0,l=t.recent_provider_failures??0;let p="healthy",$="ok",m="Keeper continuity looks healthy";return s>0&&!o?(p="critical",$="bad",m="Reactive inbox is backed up while the keeper is offline"):s>0?(p="warning",$="warn",m=s>1?`Reactive inbox backlog (${s})`:"Reactive inbox waiting for a keeper turn"):o&&(r>0||l>0)?(p="warning",$="warn",m=r>0?`Provider timeout detected (${r})`:"Recent provider failures detected"):o&&(t.status==="offline"||n||e==="handoff-imminent")?(p="critical",$="bad",m=n?"Heartbeat stale":e==="handoff-imminent"?"Handoff imminent":"Keeper offline"):o?(e==="preparing"||e==="compacting"||a>=_o)&&(p="warning",$="warn",m=a>=_o?"High context pressure":e==="compacting"?"Compaction in progress":"Preparing for handoff"):(p="healthy",$="ok",m=t.reactive_enabled?"Reactive keeper is parked with no backlog":"Keeper is parked"),{keeper:t,lifecycle:e,state:p,tone:$,focus:iv(t),note:m}}function nn({label:t,value:e,color:n,caption:a}){return i`
    <div class="stat-card">
      <div class="stat-label">${t}</div>
      <div class="stat-value" style=${n?`color:${n}`:""}>${e}</div>
      ${a?i`<div class="monitor-stat-caption">${a}</div>`:null}
    </div>
  `}function cv({item:t}){const e=t.kind==="agent"?()=>Ie(t.agent.name):()=>$a(t.keeper);return i`
  ...
  `}function dv({row:t}){const{keeper:e}=t,n=e.recent_fallback_rate??0;return i`
    <button class="monitor-row ${t.tone} state-${t.state}" onClick=${()=>$a(e)}>
      <div class="monitor-row-header">
        <span class="agent-emoji">${e.emoji??""}</span>
        <div class="monitor-row-title">
          <div class="monitor-name-line">
      ...
      <div class="monitor-meta">
        ...
        ${typeof e.pending_reactive_items=="number"?i`<span>${e.pending_reactive_items} inbox</span>`:null}
        ${e.model?i`<span>${e.model}</span>`:null}
      </div>

      <div class="monitor-focus">${t.focus}</div>
      ${e.last_successful_reaction_at?i`<div class="monitor-footnote">Last reaction <${F} timestamp=${e.last_successful_reaction_at} /></div>`:n>0?i`<div class="monitor-footnote">Recent fallback rate ${(n*100).toFixed(0)}%</div>`:e.skill_reason?i`<div class="monitor-footnote">Skill route: ${e.skill_reason}</div>`:null}
    </button>
  `}function uv(){const t=[...Ct.value].map(rv).sort((m,d)=>{const v=Ae(d.tone)-Ae(m.tone);if(v!==0)return v;const c=d.activeTaskCount-m.activeTaskCount;return c!==0?c:Xt(d.lastSignalAt)-Xt(m.lastSignalAt)}),e=[...Qt.value].map(lv).sort((m,d)=>{const v=Ae(d.tone)-Ae(m.tone);if(v!==0)return v;const c=(d.keeper.context_ratio??0)-(m.keeper.context_ratio??0);return c!==0?c:Xt(d.keeper.last_heartbeat)-Xt(m.keeper.last_heartbeat)}),n=t.filter(m=>m.state!=="offline"),a=t.filter(m=>m.state==="offline"),s=n.length,o=t.filter(m=>m.state==="working").length,r=t.filter(m=>m.lastSignalAt&&Date.now()-Xt(m.lastSignalAt)<=12e4).length,l=t.filter(m=>m.tone!=="ok"),p=e.filter(m=>m.tone!=="ok"),$=[...p.map(m=>({kind:"keeper",key:`keeper-${m.keeper.name}`,tone:m.tone,title:m.keeper.name,subtitle:`${m.note} · ${m.focus}`,timestamp:m.keeper.last_heartbeat??null,keeper:m.keeper})),...l.map(m=>({kind:"agent",key:`agent-${m.agent.name}`,tone:m.tone,title:m.agent.name,subtitle:`${m.note} · ${m.focus}`,timestamp:m.lastSignalAt,agent:m.agent}))].sort((m,d)=>{const v=Ae(d.tone)-Ae(m.tone);return v!==0?v:Xt(d.timestamp)-Xt(m.timestamp)}).slice(0,8);return i`
    <div class="agents-monitor">
      <div class="stats-grid">
  ...
  `}const ja=_("all"),qa=_("all"),pi=Tt(()=>{let t=Cn.value;return ja.value!=="all"&&(t=t.filter(e=>e.horizon===ja.value)),qa.value!=="all"&&(t=t.filter(e=>e.status===qa.value)),t}),pv=Tt(()=>{const t={short:[],mid:[],long:[]};for(const e of pi.value){const n=t[e.horizon];n&&n.push(e)}return t}),mv=Tt(()=>{const t=Array.from(Bo.value.values());return t.sort((e,n)=>e.status==="running"&&n.status!=="running"?-1:n.status==="running"&&e.status!=="running"?1:e.status==="interrupted"&&n.status!=="interrupted"?-1:n.status==="interrupted"&&e.status!=="interrupted"?1:n.elapsed_seconds-e.elapsed_seconds),t});function vv(t){return"★".repeat(Math.min(t,5))+"☆".repeat(Math.max(0,5-t))}function Ei(t){switch(t){case"short":return"Short-term";case"mid":return"Mid-term";case"long":return"Long-term";default:return t}}function la(t){switch(t){case"short":return"#4ade80";case"mid":return"#f59e0b";case"long":return"#818cf8";default:return"#888"}}function fv(t){return t<60?`${Math.round(t)}s`:t<3600?`${Math.floor(t/60)}m ${Math.round(t%60)}s`:`${Math.floor(t/3600)}h ${Math.floor(t%3600/60)}m`}function $o(t){return t.toFixed(4)}function ho(t){const e=t.current_metric-t.baseline_metric;return`${e>=0?"+":""}${e.toFixed(4)}`}function _v({goal:t}){return i`
    <div class="goal-row">
      <div class="goal-row-main">
        <div style="display:flex; align-items:center; gap:8px;">
          <span class="goal-horizon-badge" style="color:${la(t.horizon)}">
            ${Ei(t.horizon)}
          </span>
  ...
  `}function fs({horizon:t,items:e}){if(e.length===0)return null;const n=[...e].sort((a,s)=>s.priority-a.priority);return i`
    <${C} title="${Ei(t)} Goals (${e.length})" class="section">
      <div class="goal-list">
  ...
  `}function $v(){const t=Cn.value,e=t.filter(s=>s.status==="active").length,n=t.filter(s=>s.status==="completed").length,a={short:0,mid:0,long:0};for(const s of t)s.horizon in a&&a[s.horizon]++;return i`
    <div class="goal-summary">
      ...
      <div class="goal-summary-item">
        <div class="goal-summary-value" style="color:${la("short")}">${a.short}</div>
        <div class="goal-summary-label">Short</div>
      </div>
      <div class="goal-summary-item">
        <div class="goal-summary-value" style="color:${la("mid")}">${a.mid}</div>
        <div class="goal-summary-label">Mid</div>
      </div>
      <div class="goal-summary-item">
        <div class="goal-summary-value" style="color:${la("long")}">${a.long}</div>
  ...
  `}function _s({task:t}){const e=(t.priority??4)<=1?"p1":(t.priority??4)===2?"p2":(t.priority??4)===3?"p3":"p4";return i`
    ...
    <${C} title="Task Backlog" class="section">
      <div class="kanban-board">
        <div class="kanban-column">
          ...
          ${t.length===0?i`<div class="empty-state" style="opacity: 0.5;">No pending tasks</div>`:t.map(a=>i`<${_s} key=${a.id} task=${a} />`)}
        </div>
        <div class="kanban-column">
          ...
          ${e.length===0?i`<div class="empty-state" style="opacity: 0.5;">No active tasks</div>`:e.map(a=>i`<${_s} key=${a.id} task=${a} />`)}
        </div>
        <div class="kanban-column">
          ...
          ${n.length===0?i`<div class="empty-state" style="opacity: 0.5;">No completed tasks</div>`:n.slice(0,20).map(a=>i`<${_s} key=${a.id} task=${a} />`)}
          ${n.length>20?i`<div class="empty-state" style="opacity: 0.5;">...and ${n.length-20} more</div>`:null}
        </div>
      </div>
    <//>
  `}function bv(){const t=pv.value,e=mv.value,n=e.filter(l=>l.status==="running").length,a=e.filter(l=>l.recoverable).length,s=Cn.value.filter(l=>l.status==="active").length,o=Us.value,r=o==="idle"?"No loop running":o==="error"?Bs.value??"MDAL snapshot unavailable":"Current loop snapshot";return i`
    <div>
      <div class="stats-grid">
        <div class="stat-card">
        ...
        <div class="stat-card">
          ...
          <div class="stat-value">${pi.value.length}</div>
        </div>
        <div class="stat-card">
      ...
      <${C} title="Planning Surface" class="section">
        <div class="planning-header">
          ...
          <div class="planning-actions">
            <button class="control-btn ghost" onClick=${Rn} disabled=${Re.value}>
      ...
      ${Re.value&&Cn.value.length===0?i`<div class="loading-indicator">Loading goals...</div>`:pi.value.length===0?i`<div class="empty-state">No goals match the current filters</div>`:i`
              <${fs} horizon="short" items=${t.short??[]} />
              <${fs} horizon="mid" items=${t.mid??[]} />
              <${fs} horizon="long" items=${t.long??[]} />
            `}
  ...
  `}const Te=_(""),gs=_("ability_check"),$s=_("10"),hs=_("12"),Gn=_(""),Jn=_("idle"),Zt=_(""),Vn=_("keeper-late"),ys=_("player"),bs=_(""),wt=_("idle"),ks=_(null),Qn=_(""),xs=_(""),Ss=_("player"),As=_(""),ws=_(""),Cs=_(""),hn=_("20"),Ts=_("20"),Ns=_(""),Yn=_("idle"),mi=_(null),Mr=_("overview"),Rs=_("all"),Ls=_("all"),Ps=_("all"),kv=12e4,Za=_(null),bo=_(Date.now());function xv(t,e){const n=e>0?t/e*100:0;return n>50?"hp-high":n>25?"hp-mid":"hp-low"}function Sv(t,e){return e>0?Math.round(t/e*100):0}const Av={pragmatic:"리스크보다 확실한 이득을 우선합니다.",frugal:"자원 소모를 줄이고 효율을 챙깁니다.",impatient:"짧은 템포로 즉시 압박을 선호합니다.",stubborn:"한 번 정한 전술을 끝까지 밀어붙입니다.",protective:"아군 피해를 줄이는 선택을 우선합니다.","honor-bound":"약속과 규율을 지키는 행동에 보너스가 납니다.",intense:"집중 화력을 짧게 폭발시킵니다.",empathetic:"아군/약자 보호 쪽 선택 확률이 높아집니다.",fatalistic:"위험을 감수하는 고배수 선택을 탑니다.",suspicious:"함정/매복 경계 행동을 우선합니다.",precise:"단일 목표를 정확히 노리는 경향입니다.",vengeful:"직전 위협 대상에게 강하게 반응합니다.",aggressive:"공격적인 전진 행동을 우선합니다.",opportunistic:"빈틈이 열리면 즉시 추격합니다."},wv={supply_scan:"전장/자원 상태를 스캔해 약한 지점을 찾습니다.",ration_shift:"소모를 줄이고 지속 전투 능력을 확보합니다.",logistics_patch:"무너진 운영 라인을 빠르게 복구합니다.",frontline_shield:"전열에서 아군 피해를 흡수합니다.",oath_intercept:"핵심 타깃을 가로막아 위협을 차단합니다.",morale_anchor:"아군 안정도를 높여 붕괴를 막습니다.",omen_trace:"다음 위험 신호를 먼저 감지합니다.",arc_flash:"짧은 순간 광역 압박을 넣습니다.",ward_bloom:"방어 장막을 펼쳐 생존률을 올립니다.",mark_prey:"우선 제거 대상을 지정합니다.",silent_route:"은밀한 진입 경로를 확보합니다.",finisher_strike:"약화된 적을 마무리하는 일격입니다.",shadow_claw:"근접 급습으로 출혈 피해를 노립니다.",lunge:"짧은 돌진으로 전열을 흔듭니다."};function Xn(t){const e=t.trim();return e?e.split(/[_-]+/g).filter(n=>n.length>0).map(n=>n[0]?`${n[0].toUpperCase()}${n.slice(1)}`:n).join(" "):t}function Cv(t){const e=t.trim().toLowerCase();return Av[e]??"행동 선택 가중치에 영향을 주는 성향입니다."}function Tv(t){const e=t.trim().toLowerCase();return wv[e]??"상황에 따라 선택되는 전술 액션입니다."}function ae(t){return typeof t=="object"&&t!==null}function yt(t,e,n=""){const a=t[e];return typeof a=="string"?a:n}function zt(t,e,n=0){const a=t[e];return typeof a=="number"&&Number.isFinite(a)?a:n}function Mn(t,e,n=!1){const a=t[e];return typeof a=="boolean"?a:n}const Nv=new Set(["str","dex","con","int","wis","cha"]);function Rv(t){const e=t.trim();if(!e)return{};let n;try{n=JSON.parse(e)}catch(s){throw new Error(`능력치 JSON 파싱 실패: ${s instanceof Error?s.message:"invalid json"}`)}if(!ae(n))throw new Error('능력치 JSON은 object여야 합니다. 예: {"luck":7}');const a={};return Object.entries(n).forEach(([s,o])=>{const r=s.trim();if(r){if(typeof o=="number"&&Number.isFinite(o)){a[r]=Math.max(0,Math.trunc(o));return}if(typeof o=="string"){const l=Number.parseFloat(o.trim());if(Number.isFinite(l)){a[r]=Math.max(0,Math.trunc(l));return}}throw new Error(`능력치 '${r}' 값은 숫자여야 합니다.`)}}),a}function Lv(t){const e=Number.parseInt(t.trim(),10);if(!Number.isFinite(e))return;const n=Math.max(1,e),a=Number.parseInt(hn.value.trim(),10);Number.isFinite(a)&&a>n&&(hn.value=String(n))}function vi(t){const n=(t.actor_name??t.actor??t.actor_id??"system").trim();return n===""?"system":n}function Pv(t){var n;return(((n=t.timestamp)==null?void 0:n.trim())??"")||"-"}function Dv(t){Mr.value=t}function Or(t){const e=Za.value;return e==null||e<=t}function Ev(t){const e=Za.value;return e==null||e<=t?0:Math.max(0,Math.ceil((e-t)/1e3))}function Fa(){Za.value=null}function zr(t){return typeof window>"u"||typeof window.confirm!="function"?!0:window.confirm(t)}function Iv(t,e){zr(["관전 모드 잠금을 해제하시겠습니까?",`ROOM: ${t||"-"}`,`PHASE: ${e||"-"}`,"해제 시간: 120초 (시간 경과 또는 위험 액션 실행 후 자동 재잠금)"].join(`
`))&&(Za.value=Date.now()+kv,w("조작 잠금이 120초 동안 해제되었습니다.","warning"))}function ca(t){return Or(t)?(w("관전 모드 잠금 상태입니다. 먼저 잠금을 해제하세요.","warning"),!1):!0}function fi(t,e,n){return zr([`[위험 액션 확인] ${t}`,`ROOM: ${e||"-"}`,`PHASE: ${n||"-"}`,"이 액션은 즉시 실행되며 되돌리기 어렵습니다.","계속 진행하시겠습니까?"].join(`
`))}function Mv({hp:t,max:e}){const n=Sv(t,e),a=xv(t,e);return i`
  ...
  `}function jr({actor:t}){var p,$,m,d;const e=(p=t.archetype)==null?void 0:p.trim(),n=($=t.persona)==null?void 0:$.trim(),a=(m=t.portrait)==null?void 0:m.trim(),s=(d=t.background)==null?void 0:d.trim(),o=t.traits??[],r=t.skills??[],l=Object.entries(t.stats_raw??{}).filter(([v,c])=>Number.isFinite(c)).filter(([v])=>!Nv.has(v.toLowerCase()));return i`
    <div class="trpg-actor">
      ...
      ${t.stats?i`
        ...
        `:null}
      ${e?i`<div class="trpg-actor-meta">Archetype: ${Xn(e)}</div>`:null}
      ...
      ${l.length>0?i`
          <div class="trpg-annot-group">
            ...
            <div class="trpg-custom-stats">
              ${l.map(([v,c])=>i`
                <span class="trpg-custom-stat-chip">${Xn(v)} ${c}</span>
              `)}
            </div>
          </div>
        `:null}
            ...
            <div class="trpg-annot-list">
              ${o.map(v=>i`
                <span class="trpg-annot-chip trait">
                  <span class="trpg-annot-name">${Xn(v)}</span>
  ...
  `}function qv({events:t}){const e="__none__",n=Rs.value,a=Ls.value,s=Ps.value,o=Array.from(new Set(t.map(vi).map(d=>d.trim()).filter(d=>d!==""))).sort((d,v)=>d.localeCompare(v)),r=Array.from(new Set(t.map(d=>(d.type??"").trim()).filter(d=>d!==""))).sort((d,v)=>d.localeCompare(v)),l=t.some(d=>(d.type??"").trim()===""),p=Array.from(new Set(t.map(d=>(d.phase??"").trim()).filter(d=>d!==""))).sort((d,v)=>d.localeCompare(v)),$=t.some(d=>(d.phase??"").trim()===""),m=t.filter(d=>{if(n!=="all"&&vi(d)!==n)return!1;const v=(d.type??"").trim(),c=(d.phase??"").trim();if(a===e){if(v!=="")return!1}else if(a!=="all"&&v!==a)return!1;if(s===e){if(c!=="")return!1}else if(s!=="all"&&c!==s)return!1;return!0});return i`
    <div class="trpg-story-toolbar">
      ...
      <div class="trpg-story-filter">
        <label>Type</label>
        <select value=${a} onChange=${d=>{Ls.value=d.target.value}}>
          <option value="all">all</option>
      ...
      <div class="trpg-story-filter">
        <label>Phase</label>
        <select value=${s} onChange=${d=>{Ps.value=d.target.value}}>
          <option value="all">all</option>
      ...
      <button
        ...
        onClick=${()=>{Rs.value="all",Ls.value="all",Ps.value="all"}}
      >
        필터 초기화
      </button>
  ...
  `}function Kv({state:t,nowMs:e}){var $;const n=Wt.value||(($=t.session)==null?void 0:$.room)||"",a=Jn.value,s=t.party??[];if(!s.find(m=>m.id===Te.value)&&s.length>0){const m=s[0];m&&(Te.value=m.id)}const r=async()=>{var d,v;if(!n){w("Room ID가 비어 있습니다.","error");return}if(!ca(e))return;const m=((d=t.current_round)==null?void 0:d.phase)??((v=t.session)==null?void 0:v.status)??"unknown";if(fi("라운드 실행",n,m)){Jn.value="running";try{const c=await ic(n);mi.value=c,Jn.value="ok";const y=ae(c.summary)?c.summary:null,S=y?Mn(y,"advanced",!1):!1,T=y?yt(y,"progress_reason",""):"";w(S?"라운드가 정상 진행되었습니다.":`라운드가 정체되었습니다${T?`: ${T}`:""}`,S?"success":"warning"),Kt()}catch(c){mi.value=null,Jn.value="error";const y=c instanceof Error?c.message:"라운드 실행에 실패했습니다.";w(y,"error")}finally{Fa()}}},l=async()=>{var d,v;if(!n||!ca(e))return;const m=((d=t.current_round)==null?void 0:d.phase)??((v=t.session)==null?void 0:v.status)??"unknown";if(fi("턴 강제 진행",n,m))try{await lc(n),w("턴을 다음 단계로 이동했습니다.","success"),Kt()}catch{w("턴 이동에 실패했습니다.","error")}finally{Fa()}},p=async()=>{if(!n||!ca(e))return;const m=Te.value.trim();if(!m){w("먼저 Actor를 선택하세요.","warning");return}const d=Number.parseInt($s.value,10),v=Number.parseInt(hs.value,10);if(Number.isNaN(d)||Number.isNaN(v)){w("stat/dc는 숫자여야 합니다.","warning");return}const c=Number.parseInt(Gn.value,10),y=Gn.value.trim()===""||Number.isNaN(c)?void 0:c;try{await rc({roomId:n,actorId:m,action:gs.value.trim()||"ability_check",statValue:d,dc:v,rawD20:y}),w("주사위 판정을 기록했습니다.","success"),Kt()}catch{w("주사위 판정 기록에 실패했습니다.","error")}};return i`
        ...
        <div class="trpg-control-field">
          ...
          <div style="display:grid; grid-template-columns: 1fr 1fr; gap:6px;">
            ...
            <input
              ...
              type="text"
              value=${$s.value}
              onInput=${m=>{$s.value=m.target.value}}
            ...
            <input
              ...
              type="text"
              value=${hs.value}
              onInput=${m=>{hs.value=m.target.value}}
  ...
  `}function Hv({state:t}){var s;const e=Wt.value||((s=t.session)==null?void 0:s.room)||"",n=Yn.value,a=async()=>{if(!e){w("Room ID가 비어 있습니다.","warning");return}const o=Qn.value.trim(),r=xs.value.trim();if(!r&&!o){w("이름 또는 Actor ID를 입력하세요.","warning");return}const l=Number.parseInt(hn.value.trim(),10),p=Number.parseInt(Ts.value.trim(),10),$=Number.isFinite(p)?Math.max(1,p):20,m=Number.isFinite(l)?Math.max(0,Math.min($,l)):$;let d={};try{d=Rv(Ns.value)}catch(v){w(v instanceof Error?v.message:"능력치 JSON 오류","error");return}Yn.value="spawning";try{const v=typeof crypto<"u"&&typeof crypto.randomUUID=="function"?`trpg_spawn_${crypto.randomUUID()}`:`trpg_spawn_${Date.now().toString(36)}_${Math.random().toString(36).slice(2,10)}`,c=await cc(e,{actor_id:o||void 0,name:r||void 0,role:Ss.value,idempotencyKey:v,portrait:ws.value.trim()||void 0,background:Cs.value.trim()||void 0,hp:m,max_hp:$,alive:m>0,stats:Object.keys(d).length>0?d:void 0}),y=typeof c.actor_id=="string"?c.actor_id.trim():"";if(!y)throw new Error("생성 응답에 actor_id가 없습니다.");const S=As.value.trim();S&&await dc(e,y,S),Te.value=y,Zt.value=y,o||(Qn.value=""),Yn.value="ok",w(`Actor 생성 완료: ${y}`,"success"),await Kt()}catch(v){Yn.value="error",w(v instanceof Error?v.message:"Actor 생성에 실패했습니다.","error")}};return i`
    <div class="trpg-control-box">
      <div class="trpg-control-grid">
        <div class="trpg-control-field">
          <label>Name</label>
        ...
        <div class="trpg-control-field">
          ...
          <select
            value=${Ss.value}
            onChange=${o=>{Ss.value=o.target.value}}
          >
        ...
        <div class="trpg-control-grid">
          ...
          <div class="trpg-control-field">
            ...
            <input
              ...
              min="1"
              value=${Ts.value}
              onInput=${o=>{const r=o.target.value;Ts.value=r,Lv(r)}}
              placeholder="20"
            />
          </div>
  ...
  `}function Uv({state:t,nowMs:e}){var v;const n=Wt.value||((v=t.session)==null?void 0:v.room)||"",a=t.join_gate,s=ks.value,o=ae(s)?s:null,r=(t.party??[]).filter(c=>c.role!=="dm"),l=Zt.value.trim(),p=r.some(c=>c.id===l),$=p?l:l?"__manual__":"",m=async()=>{const c=Zt.value.trim(),y=Vn.value.trim();if(!n||!c){w("Room/Actor가 필요합니다.","warning");return}wt.value="checking";try{const S=await uc(n,c,y||void 0);ks.value=S,wt.value="ok",w("참가 가능 여부를 갱신했습니다.","success")}catch(S){wt.value="error";const T=S instanceof Error?S.message:"참가 가능 여부 확인에 실패했습니다.";w(T,"error")}},d=async()=>{var P,K;const c=Zt.value.trim(),y=Vn.value.trim(),S=bs.value.trim();if(!n||!c||!y){w("Room/Actor/Keeper가 필요합니다.","warning");return}if(!ca(e))return;const T=((P=t.current_round)==null?void 0:P.phase)??((K=t.session)==null?void 0:K.status)??"unknown";if(fi("Mid-Join 승인 요청",n,T)){wt.value="requesting";try{const E=await pc({room_id:n,actor_id:c,keeper_name:y,role:ys.value,...S?{name:S}:{}});ks.value=E;const N=ae(E)?Mn(E,"granted",!1):!1,R=ae(E)?yt(E,"reason_code",""):"";N?w("Mid-Join이 승인되었습니다.","success"):w(`Mid-Join이 거절되었습니다${R?`: ${R}`:""}`,"warning"),wt.value=N?"ok":"error",Kt()}catch(E){wt.value="error";const N=E instanceof Error?E.message:"Mid-Join 요청에 실패했습니다.";w(N,"error")}finally{Fa()}}};return i`
    <div class="trpg-control-box">
      ...
      <div class="trpg-control-grid">
        <div class="trpg-control-field">
          ...
          <select
            value=${$}
            onChange=${c=>{const y=c.target.value;if(y==="__manual__"){(p||!l)&&(Zt.value="");return}Zt.value=y}}
          >
            <option value="">Actor 선택</option>
            ${r.map(c=>i`
        ...
        <div class="trpg-control-field">
          ...
          <div style="display:flex; gap:6px;">
            ...
            <button class="trpg-run-btn recommend" onClick=${d} disabled=${wt.value==="checking"||wt.value==="requesting"}>
      ...
      ${o?i`
          <div style="margin-top:8px; font-size:12px; color:#d1d5db;">
            Eligible: <strong>${Mn(o,"eligible",!1)?"YES":"NO"}</strong>
  ...
  `:null}function Ur(){const t=mi.value;if(!t)return i`<div class="empty-state" style="font-size:13px;">Run Round 결과가 아직 없습니다.</div>`;const e=t.summary,n=ae(e)?e:null,s=(Array.isArray(t.statuses)?t.statuses:[]).filter(ae).slice(-8),o=t.canon_check,r=ae(o)?o:null,l=r&&Array.isArray(r.warnings)?r.warnings.filter(R=>typeof R=="string").slice(0,3):[],p=r&&Array.isArray(r.violations)?r.violations.filter(R=>typeof R=="string").slice(0,3):[],$=n?Mn(n,"advanced",!1):!1,m=n?yt(n,"progress_reason",""):"",d=n?yt(n,"progress_detail",""):"",v=n?zt(n,"player_successes",0):0,c=n?zt(n,"player_required_successes",0):0,y=n?Mn(n,"dm_success",!1):!1,S=n?zt(n,"timeouts",0):0,T=n?zt(n,"unavailable",0):0,P=n?zt(n,"reprompts",0):0,K=n?zt(n,"npc_attacks",0):0,E=n?zt(n,"keeper_timeout_sec",0):0,N=n?zt(n,"roll_audit_count",0):0;return i`
    <div style="display:grid; gap:10px;">
      ...
      ${s.length>0?i`
          <div class="trpg-round-list">
            ${s.map(R=>{const X=yt(R,"status","unknown"),H=yt(R,"actor_id","-"),Et=yt(R,"role","-"),vt=yt(R,"reason",""),ft=yt(R,"action_type",""),B=yt(R,"reply","");return i`
                <div class="trpg-round-item ${X.includes("fallback")||X.includes("timeout")?"failed":"active"}">
                  ...
                  ${ft?i`<div style="width:100%; font-size:11px; color:#9ca3af; margin-top:2px;">action: ${ft}</div>`:null}
                  ${vt?i`<div style="width:100%; font-size:11px; color:#9ca3af; margin-top:2px;">reason: ${vt}</div>`:null}
  ...
  `}function Bv({state:t,nowMs:e}){var r,l,p;const n=Wt.value||((r=t.session)==null?void 0:r.room)||"",a=((l=t.current_round)==null?void 0:l.phase)??((p=t.session)==null?void 0:p.status)??"unknown",s=Or(e),o=Ev(e);return i`
    <${C} title="조작 안전 잠금" style="margin-bottom:16px;">
      <div class="trpg-control-lock ${s?"locked":"unlocked"}">
        ...
        <div style="display:flex; gap:8px; margin-top:10px; flex-wrap:wrap;">
          ${s?i`<button class="trpg-run-btn recommend" onClick=${()=>Iv(n,a)}>잠금 해제 (120초)</button>`:i`<button class="trpg-run-btn secondary" onClick=${()=>{Fa(),w("조작 잠금으로 전환했습니다.","success")}}>즉시 다시 잠금</button>`}
        </div>
      </div>
    <//>
  ...
  `}function Qv(){var l,p,$,m,d;const t=Uo.value,e=Gs.value;if(lt(()=>{if(typeof window>"u"||typeof window.setInterval!="function")return;const v=window.setInterval(()=>{bo.value=Date.now()},1e3);return()=>{window.clearInterval(v)}},[]),e&&!t)return i`<div class="loading-indicator">Loading TRPG state...</div>`;if(!t)return i`
      <div class="section">
        <h2>TRPG</h2>
    ...
    <div>
      <div style="display:flex; gap:8px; align-items:center; justify-content:space-between; margin-bottom:8px;">
        <div style="font-size:11px; color:#8ea9d6;">
          room: ${Wt.value||((l=t.session)==null?void 0:l.room)||"-"} · phase: ${((p=t.current_round)==null?void 0:p.phase)??(($=t.session)==null?void 0:$.status)??"-"}
        </div>
  ...
  `}const Ii="masc_dashboard_agent_name";function Yv(){const t=new URLSearchParams(window.location.search),e=t.get("agent")??t.get("agent_name"),n=localStorage.getItem(Ii);return e??n??"dashboard"}const kt=_(Yv()),yn=_(""),bn=_(""),Ka=_(""),Br=_(null),Ha=_(null),kn=_(!1),Pe=_(!1),xn=_(!1),Sn=_(!1),Ua=_(!1),Ba=_(!1),ts=_(!1);function Wa(t){return typeof t!="number"||!Number.isFinite(t)?"??:00":`${String(Math.max(0,t)).padStart(2,"0")}:00`}function da(t){if(typeof t!="number"||!Number.isFinite(t)||t<=0)return"unknown";if(t<60)return`${Math.round(t)}s`;if(t<3600)return`${Math.round(t/60)}m`;const e=Math.floor(t/3600),n=Math.round(t%3600/60);return n>0?`${e}h ${n}m`:`${e}h`}function Wr(t){return!t||t.length===0?"none":t.join(", ")}function Xv(t){return t?t.enabled?t.quiet_active?`Quiet hours ${Wa(t.quiet_start)}-${Wa(t.quiet_end)} KST are active. Scheduled ticks may look asleep until the window ends; Poke Now bypasses only that quiet-hours gate.`:t.last_tick_ago_s==null?`Lodge is enabled and scheduled every ${da(t.interval_s)}, but no tick has run yet in this runtime.`:t.last_skip_reason?`Lodge last skipped work because ${t.last_skip_reason}. Scheduled ticks still run every ${da(t.interval_s)}.`:`Lodge ticks every ${da(t.interval_s)}. Planner is ${t.use_planner?"on":"off"} and delegated LLM is ${t.delegate_llm?"on":"off"}.`:"Lodge automation is disabled. Manual poke will report the disabled state but will not revive a stopped runtime.":"Lodge runtime status is unavailable. Refresh the dashboard to inspect scheduling state."}async function Ge(){je();try{await se()}catch(t){console.warn("[control-dock] dashboard refresh failed",t)}}function Mi(t){const e=t.trim();kt.value=e,e&&localStorage.setItem(Ii,e)}function Zv(t){const n=(t.split(`
`).find(a=>a.includes(" joined"))??t).match(/✅\s+(\S+)\s+joined/i);return(n==null?void 0:n[1])??null}async function _i(){const t=kt.value.trim();if(t){xn.value=!0;try{const e=await vc(t),n=Zv(e);n&&Mi(n),ts.value=!0,await Ge(),w(`Joined as ${n??t}`,"success")}catch(e){const n=e instanceof Error?e.message:"Failed to join room";w(n,"error")}finally{xn.value=!1}}}async function tf(){const t=kt.value.trim();if(t){Sn.value=!0;try{await qo(t),ts.value=!1,await Ge(),w(`Left room (${t})`,"success")}catch(e){const n=e instanceof Error?e.message:"Failed to leave room";w(n,"error")}finally{Sn.value=!1}}}async function ef(){const t=kt.value.trim();if(t)try{await qo(t)}catch{}localStorage.removeItem(Ii),Mi("dashboard"),ts.value=!1,await _i()}async function nf(){const t=kt.value.trim();if(t){Ua.value=!0;try{await fc(t),await Ge(),w("Heartbeat sent","success")}catch(e){const n=e instanceof Error?e.message:"Failed to send heartbeat";w(n,"error")}finally{Ua.value=!1}}}async function ko(){const t=kt.value.trim(),e=yn.value.trim();if(!(!t||!e)){kn.value=!0;try{await jo(t,e),yn.value="",await Ge(),w("Broadcast sent","success")}catch(n){const a=n instanceof Error?n.message:"Failed to send broadcast";w(a,"error")}finally{kn.value=!1}}}async function af(){const t=bn.value.trim(),e=Ka.value.trim()||"Created from dashboard";if(t){Pe.value=!0;try{await mc(t,e,1),bn.value="",Ka.value="",await Ge(),w("Task created","success")}catch(n){const a=n instanceof Error?n.message:"Failed to create task";w(a,"error")}finally{Pe.value=!1}}}async function xo(){const t=kt.value.trim()||"dashboard";Ba.value=!0,Ha.value=null;try{const e=await jn({actor:t,action_type:"lodge_tick",target_type:"room",payload:{}}),n=yi(e.result);Br.value=n,await Ge(),n!=null&&n.skipped_reason?w(n.skipped_reason,"warning"):w(n?`Poke finished: ${n.acted}/${n.checked} acted`:"Poke finished",n&&n.acted>0?"success":"warning")}catch(e){const n=e instanceof Error?e.message:"Failed to run Lodge poke";Ha.value=n,w(n,"error")}finally{Ba.value=!1}}function sf({runtime:t}){var s,o;const e=Br.value??(t==null?void 0:t.last_tick_result)??null;if(Ha.value)return i`<div class="control-result-box is-error">${Ha.value}</div>`;if(!e)return i`<div class="control-status-copy">No poke result yet. The latest scheduled tick will appear here after the first run.</div>`;const n=((s=e.skipped_rows)==null?void 0:s.slice(0,3))??[],a=((o=e.passed_rows)==null?void 0:o.slice(0,3))??[];return i`
    <div class="control-result-box">
      <div class="control-inline-meta">
  ...
  `}function of(t){return t.find(n=>n.name===rn.value)??t[0]??null}function rf(){var a,s;const t=Qt.value,e=((a=oe.value)==null?void 0:a.lodge)??null,n=of(t);return lt(()=>{_i()},[]),lt(()=>{var r;const o=((r=t[0])==null?void 0:r.name)??"";if(!rn.value&&o){ta(o);return}rn.value&&!t.some(l=>l.name===rn.value)&&ta(o)},[t.map(o=>o.name).join("|")]),i`
    <section class="rail-card control-dock">
      ...
      <div class="control-section">
        ...
        <div class="control-actions">
          <button
            class="control-btn ghost"
            onClick=${()=>{_i()}}
            disabled=${xn.value||kt.value.trim()===""}
          >
            ${xn.value?"Joining...":ts.value?"Rejoin":"Join"}
          </button>
          <button
            class="control-btn ghost"
            onClick=${()=>{tf()}}
            disabled=${Sn.value||kt.value.trim()===""}
          >
          ...
          <button
            class="control-btn ghost"
            onClick=${()=>{nf()}}
            disabled=${Ua.value||kt.value.trim()===""}
          >
      ...
      <div class="control-section">
        ...
        <div class="control-row">
          ...
          <button
            class="control-btn"
            onClick=${()=>{ko()}}
            disabled=${kn.value||yn.value.trim()===""||kt.value.trim()===""}
          >
      ...
      <div class="control-section">
        ...
        <div class="control-inline-meta">
          ...
          <span class="pill">every ${da(e==null?void 0:e.interval_s)}</span>
  ...
  `}const So=[{id:"observe",label:"Observe",description:"Live health, execution state, and room-wide telemetry"},{id:"coordinate",label:"Coordinate",description:"Conversation, decisions, planning, and backlog context"},{id:"command",label:"Command",description:"Direct control surfaces and intervention workflows"}],gi=[{id:"command",label:"Command",icon:"🧭",group:"command",description:"Company, platoon, squad, and agent command plane with operation and trace visibility"},{id:"overview",label:"Overview",icon:"🏠",group:"observe",description:"Room health, keeper pressure, and top-line execution status"},{id:"agents",label:"Agents",icon:"🤖",group:"observe",description:"Live monitor for agent status, keeper pressure, and current execution focus"},{id:"board",label:"Board",icon:"💬",group:"coordinate",description:"Human and agent discussion feed with system noise filtered by default"},{id:"goals",label:"Planning",icon:"🎯",group:"coordinate",description:"Goals, MDAL loops, and task backlog in one planning surface"},{id:"ops",label:"Ops",icon:"🎮",group:"command",description:"Guided operator controls for room, sessions, and keepers"},{id:"trpg",label:"TRPG",icon:"⚔️",group:"command",description:"Narrative room control and state visibility"}],Ao="masc_dashboard_quick_actions_open";function lf(){const t=Ht.value;return i`
    <div class="connection-status ${t?"connected":"disconnected"}">
      <span class="status-dot ${t?"connected":"disconnected"}"></span>
      <span class="status-text">${t?"Live":"Reconnecting..."}</span>
      <span class="event-count">${On.value} events</span>
    </div>
  `}function cf(){const t=at.value.tab,e=Ht.value,n=gi.find(r=>r.id===t),a=So.find(r=>r.id===(n==null?void 0:n.group)),[s,o]=Ga(()=>{const r=localStorage.getItem(Ao);return r!=="0"});return lt(()=>{localStorage.setItem(Ao,s?"1":"0")},[s]),i`
        ...
        ${So.map(r=>i`
          <div class="rail-nav-group" key=${r.id}>
            ...
            <div class="rail-tab-list">
              ${gi.filter(l=>l.group===r.id).map(l=>i`
                  <button
      ...
      <section class="rail-card">
        ...
        <div class="rail-inline-actions">
          <button
            ...
            onClick=${()=>{se(),t==="command"&&(Me(),he()),t==="ops"&&He(),t==="board"&&Ft(),t==="trpg"&&Kt(),t==="goals"&&(Rn(),qe())}}
          >
            Refresh Now
          </button>
  ...
  `}function df(){switch(at.value.tab){case"command":return i`<${Jp} />`;case"overview":return i`<${so} />`;case"ops":return i`<${fm} />`;case"board":return i`<${Dm} />`;case"agents":return i`<${uv} />`;case"goals":return i`<${bv} />`;case"trpg":return i`<${Qv} />`;default:return i`<${so} />`}}function uf(){lt(()=>{al(),Do(),se();const n=ld();return cd(),()=>{ul(),n(),dd()}},[]),lt(()=>{const n=setInterval(()=>{const a=at.value.tab;a==="command"?(Me(),he()):a==="ops"?He():a==="board"?Ft():a==="trpg"?Kt():a==="goals"&&(Rn(),qe())},15e3);return()=>{clearInterval(n)}},[]),lt(()=>{const n=at.value.tab;n==="command"&&(Me(),he()),n==="ops"&&He(),n==="board"&&Ft(),n==="trpg"&&Kt(),n==="goals"&&(Rn(),qe())},[at.value.tab]);const t=at.value.tab,e=gi.find(n=>n.id===t);return i`
    <div class="app-shell">
      ...
      <div class="dashboard-layout">
        ...
        <main class="dashboard-main">
          ${Ws.value&&!Ht.value?i`<div class="loading-indicator">Loading dashboard...</div>`:i`<${df} />`}
        </main>
      </div>
