...
- [x] **Step 4: PR** — the implementation chain (#31409, #31435, #31443, #31446, #31459, #31468, #31469) merged incrementally. Final security closure PR #31485 is a Draft rebased directly on current `main`; its body records the live fixture, full-suite caveat, named security finding, and Phase 2 / remote-file-op follow-ups.
