...
let existing_dir_path_values = Exec_policy.existing_dir_path_values
let validate_shell_ir_paths = Exec_policy.validate_shell_ir_paths
let validate_command_paths = Exec_policy.validate_command_paths
...
let is_write_operation_of_string = Exec_policy.is_write_operation_of_string
let is_git_branch_switch_of_string = Exec_policy.is_git_branch_switch_of_string
let is_destructive_bash_operation_of_string = Exec_policy.is_destructive_bash_operation_of_string
