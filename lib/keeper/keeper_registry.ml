...
module Cascade_attempts = Keeper_registry_cascade_attempts
...
let record_cascade_attempt ~base_path ~keeper_name attempt =
  Cascade_attempts.record ~get_entry:get ~base_path ~keeper_name attempt
;;

let enrich_fiber_unresolved_outcome ~base_path ~keeper_name outcome =
  Cascade_attempts.enrich_fiber_unresolved_outcome
    ~get_entry:get
    ~base_path
    ~keeper_name
    outcome
