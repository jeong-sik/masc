    ...
    ; ( "execution_queue"
      , `List
          ...
          ; `Assoc
              ...
              ; "status", `String "active"
              ; ( "summary"
                , `String "Runtime squad needs trace review before verify proceeds" )
              ; "target_type", `String "operation"
    ...
    ; ( "operation_briefs"
      , `List
          ...
          ; `Assoc
              ...
              ; "linked_detachment_id", `Null
              ; ( "blocker_summary"
                , `String "Waiting on upstream checkpoint before verify stage" )
              ; "search_status", `String "blocked"
    ...
    ; ( "worker_support_briefs"
      , `List
          [ `Assoc
              ...
              ; ( "model"
                , `String
                    (Provider_adapter.make_local_label Env_config.Llama.default_model) )
              ; ( "recent_output_preview"
                , `String
                    "manager synthesized runtime visibility and handed next checks to \
                     beta" )
          ...
          ; `Assoc
              ...
              ; ( "recent_output_preview"
                , `String
                    "secondary runtime is quiet; watching queue depth before escalation" )
      ...
      , `List
          [ `Assoc
              ...
              ; ( "recent_input_preview"
                , `String
                    "Player asked to continue the next scene without breaking continuity"
                )
              ; ( "recent_output_preview"
                , `String "Prepared the next scene transition and handoff summary" )
              ; ( "recent_tool_names"
                , `List [ `String "masc_keeper_status"; `String "masc_board_post" ] )
              ; "allowed_tool_count", `Int 3
              ; ( "allowed_tool_preview"
                , `List
                    [ `String "masc_board_get"
                    ; `String "masc_board_post"
                    ; `String "masc_keeper_status"
                    ] )
              ...
              ; ( "continuity_summary"
                , `String "Continuity pressure is high; handoff prep is underway" )
    ...
    ; ( "keepers"
      , `List
          [ `Assoc
              ...
              ; "model", `String (Provider_adapter.make_local_label "fixture-model-a")
              ; ( "active_model"
                , `String (Provider_adapter.make_local_label "fixture-model-a") )
