  ...
  | Ok session_id -> (
      ...
      | Ok () ->
          ...
          | Ok raw_spawn_specs ->
              ...
              let append_delegate_event = Tool_team_session_step_exec.append_delegate_event env in
              let append_spawn_requested_event = Tool_team_session_step_exec.append_spawn_requested_event env in
              let append_delegate_requested_event = Tool_team_session_step_exec.append_delegate_requested_event env in
              let persist_worker_run_snapshot = Tool_team_session_step_exec.persist_worker_run_snapshot env in
              let release_prepared_runtime = Tool_team_session_step_exec.release_prepared_runtime in
