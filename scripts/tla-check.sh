...
run_tlc "$REPO_ROOT/specs/keeper-state-machine" "KeeperRuntimeLifecycle.tla"
run_tlc_buggy "$REPO_ROOT/specs/keeper-state-machine" "KeeperRuntimeLifecycle.tla"
...
run_tlc "$REPO_ROOT/specs/keeper-state-machine" "KeeperRuntimeAttemptFSM.tla"
run_tlc_buggy "$REPO_ROOT/specs/keeper-state-machine" "KeeperRuntimeAttemptFSM.tla"
run_tlc "$REPO_ROOT/specs/keeper-state-machine" "KeeperRuntimeRouting.tla"
run_tlc_buggy "$REPO_ROOT/specs/keeper-state-machine" "KeeperRuntimeRouting.tla"
...
run_tlc "$REPO_ROOT/specs/boundary" "RuntimeKeeperRecovery.tla"
run_tlc_buggy "$REPO_ROOT/specs/boundary" "RuntimeKeeperRecovery.tla"
run_tlc "$REPO_ROOT/specs/boundary" "RuntimeResolver.tla"
run_tlc_buggy "$REPO_ROOT/specs/boundary" "RuntimeResolver.tla"
run_tlc "$REPO_ROOT/specs/boundary" "RuntimeStrategy.tla"
run_tlc_buggy "$REPO_ROOT/specs/boundary" "RuntimeStrategy.tla"
...
run_tlc "$REPO_ROOT/specs/runtime" "RuntimeAttemptLiveness.tla"
run_tlc_buggy "$REPO_ROOT/specs/runtime" "RuntimeAttemptLiveness.tla"
