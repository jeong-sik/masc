...
Version 0.39.0 was prepared on 2026-09-25 but never published: its release candidate failed, so there is no 0.39.0 tag or release. Its changes ship in 0.40.0 and are listed here, after the new entries in each section. Upgrading from 0.38.0 means reading every Upgrade note below.
