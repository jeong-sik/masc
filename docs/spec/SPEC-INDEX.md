...
| Executables | 8 public (`masc`, `masc-stdio`, `masc-cost`, `masc-compaction-audit`, `masc-keeper-feature-proof`, `masc-trace`, `masc-tui`, `masc-fusion-run`) + 4 internal (`public_tool_manifest`, `env_knob_catalog`, `gen_tool_descriptors`, `deployment_preflight_helper`) |
