...
(** Per-call workspace context.  Carries the resolved
    {!Workspace.config} and the agent identifier. *)
type context =
...
(** Resolved binding between [current_task] and the assignee /
    ...
    - [current_is_assigned]: whether the [current_task] workspace
    ...
    - [current_task_set]: whether the workspace [current_task] field
      is non-empty.
