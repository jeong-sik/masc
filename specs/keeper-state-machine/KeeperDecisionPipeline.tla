...
(*   decision_stage     | type decision_stage = Decision_undecided | lib/keeper/keeper_registry.ml:70-74 *)
(*                      |   | Decision_guard_ok                    | (mli mirror at keeper_registry.mli:49-53) *)
...
(*   - mark_turn_started                       line 493  -- Decision_undecided          *)
(*   - mark_turn_measurement                   line 515  -- sets measurement_bound      *)
(*   - set_turn_decision_stage                 line 535  -- Decision_guard_ok | _selected *)
(*   - prepare_turn_retry_after_compaction     line 575  -- reset to Decision_guard_ok   *)
(*   - mark_turn_gate_rejected_by_name         line 590  -- Decision_gate_rejected       *)
(*   - mark_turn_finished                      line 614  -- reset to Decision_undecided  *)
(*                                                                         *)
(* Variant exhaustiveness re-export:                                        *)
(*   lib/keeper/keeper_composite_observer.ml:25-32                         *)
