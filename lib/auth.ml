...
module Credential_store = Auth_credential_store
...
let credential_file = Credential_store.credential_file
let legacy_credential_aliases = Credential_store.legacy_credential_aliases
let load_redirect_target = Credential_store.load_redirect_target
let load_credential = Credential_store.load_credential
let load_credential_with_aliases = Credential_store.load_credential_with_aliases
...
let save_credential = Credential_store.save_credential
let ensure_credential_alias = Credential_store.ensure_credential_alias
let load_raw_token = Credential_store.load_raw_token
let persist_raw_token = Credential_store.persist_raw_token
let delete_credential = Credential_store.delete_credential
let list_credentials = Credential_store.list_credentials
...
module Tool_authorization = Auth_tool_authorization

let permission_for_tool = Tool_authorization.permission_for_tool
let is_tool_auth_strict_enabled = Tool_authorization.is_tool_auth_strict_enabled
...
let authorize_tool_for_role = Tool_authorization.authorize_tool_for_role
