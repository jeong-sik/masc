...
val append : working_context -> Llm_types.message -> working_context

(** Append multiple messages. *)
val append_many : working_context -> Llm_types.message list -> working_context
...
val format_message_readable : Llm_types.message -> string
...
val offload_messages :
  ...
  Llm_types.message list -> string option
...
val persist_message : session_context -> Llm_types.message -> unit
