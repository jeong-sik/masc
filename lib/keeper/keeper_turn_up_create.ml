      ...
      let meta = {
        ...
        runtime = {
          ...
          compaction_rt = {
            count = 0;
            last_ts = 0.0;
            last_selected_runtime_id = None;
            last_before_checkpoint_bytes = 0;
            last_after_checkpoint_bytes = 0;
            last_before_message_count = 0;
            last_after_message_count = 0;
            last_summarized_message_count = 0;
            last_dropped_message_count = 0;
            last_before_tool_use_count = 0;
            last_after_tool_use_count = 0;
            last_before_tool_result_count = 0;
            last_after_tool_result_count = 0;
