...
module Parser = Keeper_config_parser
(* Removed dead alias [module Resolve = Keeper_config_resolve] — the only
   ...
   Keeper_catalog_runtime_validate (see PR cycle resolution). *)
