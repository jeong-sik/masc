...
code_refs:
  ...
  - lib/masc_agent_core_response.ml
  - lib/masc_oas_bridge.ml
  - packages/agent_core/lib/masc_agent_core.mli
...
| Maps to | `packages/agent_core/`, `lib/masc_agent_core_response.ml`, `lib/masc_oas_bridge.ml` |
...
graph TB
  subgraph "MASC coordinator"
    ...
    ASR[masc_agent_core_response.ml]
