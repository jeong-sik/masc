  ...
  return html`
    <div class="rounded border border-[var(--card-border)] bg-[var(--white-2)] px-3 py-3">
      ...
      ${summary.continuity_summary
        ? html`<pre class="mt-2 whitespace-pre-wrap rounded border border-[var(--white-8)] bg-[var(--white-3)] px-3 py-2 text-2xs leading-relaxed text-[var(--text-muted)] max-h-40 overflow-y-auto custom-scrollbar" tabindex="0" aria-label="연속성 요약">${summary.continuity_summary}</pre>`
...
export function KeeperCheckpointPanel({
  ...
  if (loading) {
    return html`
      <div class="rounded border border-[var(--card-border)] bg-[var(--white-2)] px-3 py-3 text-xs text-[var(--text-muted)]" role="status">
                    ...
                    <label class="flex gap-3 border-b border-[var(--card-border)] px-3 py-3 text-xs last:border-b-0">
                      ...
                      <div class="min-w-0 flex-1">
                        ...
                        ${item.continuity_summary
                          ? html`<pre class="mt-2 whitespace-pre-wrap rounded border border-[var(--white-8)] bg-[var(--white-3)] px-3 py-2 text-2xs leading-relaxed text-[var(--text-muted)] max-h-40 overflow-y-auto custom-scrollbar" tabindex="0" aria-label="연속성 요약">${item.continuity_summary}</pre>`
                          : html`<div class="mt-2 text-2xs text-[var(--text-dim)]">continuity snapshot 없음</div>`}
                      </div>
                    </label>
                  `)}
          ...
          ? html`
            <div class="rounded border border-[var(--accent-20)] bg-[var(--accent-8)] p-3 mb-3">
              <div class="flex flex-wrap items-center gap-2 mb-1">
                <span class="text-3xs font-semibold uppercase tracking-wider text-[var(--accent)]">최근 인계</span>
