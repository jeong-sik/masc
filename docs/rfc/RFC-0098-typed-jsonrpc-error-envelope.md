...
> **Numbering note.** Originally drafted as RFC-0094; renumbered to **0098** on 2026-05-17 after ledger race-loss against parallel in-flight PRs #15716 ("compact cooldown semantics", RFC-0094), #15728 ("keeper sandbox container reuse", RFC-0097), #15722 / #15725 ("Chat Completions v1-compatible streaming wireup", RFC-0095), and the merged RFC-0097 sandbox-container spec. Following [[RFC-0078]] §monotonic-ledger and the `feedback_rfc_number_reservation_needed.md` operational rule, the number is reallocated; the topic and content are unchanged from the original draft.
...
- PR #15722 / #15725 — "[RFC-0095] Chat Completions v1-compatible streaming wire-up / diagnostic" overlaps IMPROVE-02 (Streamable HTTP default) and IMPROVE-04 (TTFT). IMPROVE-02 RFC will be drafted *after* reading these PRs to decide stack vs absorb.
