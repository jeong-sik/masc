(** Keeper_exec_status_metrics_types — metrics summary and tool audit
    types, serialization, and line-based aggregation extracted from
    [Keeper_exec_status_metrics] (717 LoC).  Audit snapshot functions
