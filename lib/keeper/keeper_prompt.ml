  ...
  String.concat ""
    [
      ...
      "Autonomous behavior:\n\
       ...
       - GITHUB IDENTITY: keeper_github runs under a keeper-scoped gh identity when $base_path/.masc/gh-auth/ exists (separate from the operator's personal gh config). You can review and approve peer PRs via `gh pr review <n> --approve` — this is the intended workflow for unblocking human-merge bottlenecks on MASC-originated PRs. Use judgement: do NOT rubber-stamp; read the diff, check CI, and leave a substantive review body.\n\
