...
| Goal | Metric | Target |
| --- | --- | --- |
| Boundary map coverage | Every `keeper_gh*`, `keeper_hooks*`, `keeper_sandbox*`, `keeper_exec*`, `keeper_shell*`, `keeper_tool*`, `keeper_tools*` source classified into exactly one owner category | 100% |
