...
let cascade_prefix_of_decl_protocol raw =
  let kind =
    ...
    | "provider_d-cli" -> Some Llm_provider.Provider_config.Cli_tool_d
    | "provider_d-http" -> Some Llm_provider.Provider_config.Provider_d_compat
    | "google-cli" -> Some Llm_provider.Provider_config.Cli_tool_c
    | "provider_c-cli" -> Some Llm_provider.Provider_config.Cli_tool_b
