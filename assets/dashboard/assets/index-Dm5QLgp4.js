...
`).map(n=>n.trim()).filter(n=>n!=="")}async function _c(t,e=20){return bt("masc_task_history",{task_id:t,limit:e})}async function gc(){return Ue("fetchDebates",async()=>{const t=await et("/api/v1/council/debates?limit=100");return Array.isArray(t.debates)?t.debates.map(e=>{if(!O(e))return null;const n=h(e.id,"").trim(),a=h(e.topic,"").trim();return!n||!a?null:{id:n,topic:a,status:h(e.status,"open"),argument_count:q(e.argument_count,0),created_at:ze(e.created_at_iso??e.created_at)}}).filter(e=>e!==null):[]})}async function $c(){return Ue("fetchCouncilSessions",async()=>{const t=await et("/api/v1/council/sessions?limit=100");return Array.isArray(t.sessions)?t.sessions.map(e=>{if(!O(e))return null;const n=h(e.id,"").trim(),a=h(e.topic,"").trim();return!n||!a?null:{id:n,topic:a,initiator:h(e.initiator,"system"),votes:q(e.votes,0),quorum:q(e.quorum,0),state:h(e.state,"open"),created_at:ze(e.created_at_iso??e.created_at)}}).filter(e=>e!==null):[]})}async function hc(t){const e=await bt("masc_debate_start",{topic:t});try{return JSON.parse(e)}catch{return null}}async function yc(t){return Ue("fetchDebateStatus",async()=>{const e=encodeURIComponent(t),n=await et(`/api/v1/council/debates/${e}/summary`);if(!O(n))return null;const a=h(n.id,"").trim();return a?{id:a,topic:h(n.topic,""),status:h(n.status,"open"),support_count:q(n.support_count,0),oppose_count:q(n.oppose_count,0),neutral_count:q(n.neutral_count,0),total_arguments:q(n.total_arguments,0),created_at:ze(n.created_at_iso??n.created_at),summary_text:h(n.summary_text,"")}:null})}function bc(t,e,n){return bt("masc_keeper_msg",{name:t,message:e})}async function kc(){try{const t=await bt("masc_goal_list",{});if(typeof t=="string"){const e=JSON.parse(t);return Array.isArray(e)?e:e.goals??[]}return Array.isArray(t)?t:t.goals??[]}catch{return[]}}const on=_(""),Bt=_({}),dt=_({}),Es=_({}),Is=_({}),Ms=_({}),Os=_({}),Wt=_({});function ot(t,e,n){t.value={...t.value,[e]:n}}function Gt(t){return typeof t=="object"&&t!==null&&!Array.isArray(t)}function U(t){return typeof t=="string"&&t.trim()!==""?t.trim():void 0}function Nt(t){return typeof t=="number"&&Number.isFinite(t)?t:void 0}function Ne(t){return typeof t=="boolean"?t:void 0}function zs(t){return typeof t=="string"&&t.trim()!==""?t:typeof t!="number"||!Number.isFinite(t)||t<=0?null:new Date(t*1e3).toISOString()}function qs(t){return Array.isArray(t)?t.map(e=>U(e)).filter(e=>!!e):[]}function xc(t){var n;const e=(n=U(t))==null?void 0:n.toLowerCase();return e==="user"||e==="assistant"||e==="system"||e==="tool"?e:"other"}function Sc(t){switch(t){case"user":return"User";case"assistant":return"Keeper";case"system":return"System";case"tool":return"Tool";default:return"Event"}}function Xa(t,e){if(!Array.isArray(t))return[];const n=[];for(const a of t){if(!Gt(a))continue;const i=U(a.name);if(!i)continue;const o=U(a[e]);e==="summary"?n.push({name:i,summary:o}):n.push({name:i,reason:o})}return n}function Ac(t){if(!Gt(t))return null;const e=U(t.name);return e?{name:e,trigger:U(t.trigger),outcome:U(t.outcome),summary:U(t.summary),reason:U(t.reason)}:null}function Cc(t){const e=t.toLowerCase();return e.includes("graphql")?"graphql_error":e.includes("timeout")||e.includes("model")||e.includes("llm")||e.includes("api key")||e.includes("api_key")||e.includes("provider")?"llm_error":"unknown"}function wc(t,e){return t==="offline"||t==="degraded"||t==="stale"?"Keeper is not in a healthy reply state. Probe or recover before relying on automation.":e==="quiet_hours"?"Lodge quiet hours are active. Direct messages still work, but scheduled social ticks may look asleep.":e==="min_gap"?"Keeper is inside its proactive cooldown window. Direct messages work now; autonomous check-ins will wait.":e==="never_started"?"Keeper metadata exists but no reply turn has been recorded yet.":"Keeper is reachable. Send a direct message for an immediate response."}function jo(t,e,n){return U(t)??wc(e,n)}function Fo(t,e){return typeof t=="boolean"?t:e==="recover"}function da(t){if(!Gt(t))return null;const e=U(t.health_state),n=U(t.next_action_path),a=U(t.last_reply_status);return!e||!n||!a?null:{health_state:e,quiet_reason:U(t.quiet_reason)??null,next_action_path:n,last_reply_status:a,last_reply_at:zs(t.last_reply_at),last_reply_preview:U(t.last_reply_preview)??null,last_error:U(t.last_error)??null,next_eligible_at_s:Nt(t.next_eligible_at_s)??null,recoverable:Fo(t.recoverable,n),summary:jo(t.summary,e,U(t.quiet_reason)??null),keepalive_running:typeof t.keepalive_running=="boolean"?t.keepalive_running:void 0}}function $i(t){return Gt(t)?{hour:Nt(t.hour),checked:Nt(t.checked)??0,acted:Nt(t.acted)??0,acted_names:qs(t.acted_names),activity_report:U(t.activity_report),quiet_hours_overridden:Ne(t.quiet_hours_overridden),skipped_reason:U(t.skipped_reason),acted_rows:Xa(t.acted_rows,"summary").map(e=>({name:e.name,summary:e.summary})),passed_rows:Xa(t.passed_rows,"reason").map(e=>({name:e.name,reason:e.reason})),skipped_rows:Xa(t.skipped_rows,"reason").map(e=>({name:e.name,reason:e.reason})),checkins:Array.isArray(t.checkins)?t.checkins.map(Ac).filter(e=>e!==null):[]}:null}function Tc(t){return Gt(t)?{enabled:Ne(t.enabled)??!1,interval_s:Nt(t.interval_s)??0,quiet_start:Nt(t.quiet_start),quiet_end:Nt(t.quiet_end),quiet_active:Ne(t.quiet_active),use_planner:Ne(t.use_planner),delegate_llm:Ne(t.delegate_llm),agent_count:Nt(t.agent_count),agents:qs(t.agents),last_tick_ago_s:Nt(t.last_tick_ago_s)??null,last_tick_ago:U(t.last_tick_ago),total_ticks:Nt(t.total_ticks),total_checkins:Nt(t.total_checkins),last_skip_reason:U(t.last_skip_reason)??null,last_tick_result:$i(t.last_tick_result),active_self_heartbeats:qs(t.active_self_heartbeats)}:null}function Nc(t){return Gt(t)?{status:t.status,diagnostic:da(t.diagnostic)}:null}function Rc(t){return Gt(t)?{recovered:Ne(t.recovered)??!1,skipped_reason:U(t.skipped_reason)??null,before:da(t.before),after:da(t.after),down:t.down,up:t.up}:null}function Lc(t,e){var K,E;if(!(t!=null&&t.name))return null;const n=U((K=t.agent)==null?void 0:K.status)??U(t.status)??"unknown",a=U((E=t.agent)==null?void 0:E.error)??null,i=t.presence_keepalive??!0,o=t.keepalive_running??!1,r=t.turn_count??0,l=t.last_turn_ago_s??null,p=t.proactive_enabled??!1,$=t.proactive_cooldown_sec??0,m=t.last_proactive_ago_s??null,d=p&&m!=null?Math.max(0,$-m):null,v=r<=0||l==null?"never":l>900?"stale":"fresh",c=typeof t.last_heartbeat=="string"&&t.last_heartbeat.trim()?t.last_heartbeat:null,y=a??(i&&!o?"keeper keepalive is not running":null),S=n==="offline"||n==="inactive"?"offline":y?"degraded":v==="stale"?"stale":v==="never"?"idle":"healthy",T=y?Cc(y):e!=null&&e.quiet_active&&v!=="fresh"?"quiet_hours":i&&!o?"disabled":r<=0?"never_started":d!=null&&d>0?"min_gap":v==="fresh"||v==="stale"?"no_recent_activity":"unknown",P=S==="offline"||S==="degraded"||S==="stale"?"recover":T==="quiet_hours"?"manual_lodge_poke":T==="unknown"?"probe":"direct_message";return{health_state:S,quiet_reason:T,next_action_path:P,last_reply_status:v,last_reply_at:c,last_reply_preview:null,last_error:y,next_eligible_at_s:d!=null&&d>0?d:null,recoverable:Fo(void 0,P),summary:jo(void 0,S,T),keepalive_running:o}}function Pc(t,e){if(!Gt(t))return null;const n=xc(t.role),a=U(t.content)??U(t.preview);if(!a)return null;const i=zs(t.ts_unix)??zs(t.timestamp);return{id:`${n}-${i??"entry"}-${e}`,role:n,label:Sc(n),text:a,timestamp:i,delivery:"history"}}function Dc(t,e,n){const a=Gt(n)?n:null,i=Array.isArray(a==null?void 0:a.history_tail)?a.history_tail.map((o,r)=>Pc(o,r)).filter(o=>o!==null):[];return{name:t,diagnostic:da(a==null?void 0:a.diagnostic),history:i,rawText:e,rawStatus:n,loadedAt:new Date().toISOString()}}function Ki(t,e){const n=dt.value[t]??[];dt.value={...dt.value,[t]:[...n,e].slice(-50)}}function Ec(t,e){return t.role!==e.role||t.text!==e.text?!1:t.timestamp&&e.timestamp?t.timestamp===e.timestamp:!0}function Ic(t,e){const a=(dt.value[t]??[]).filter(i=>i.delivery!=="history"&&!e.some(o=>Ec(i,o)));dt.value={...dt.value,[t]:[...e,...a].slice(-50)}}function Ba(t,e){Bt.value={...Bt.value,[t]:e},Ic(t,e.history)}function Hi(t,e){const n=Bt.value[t];if(!n)return;const a=n.diagnostic??{health_state:"idle",next_action_path:"direct_message",last_reply_status:"unknown"};Ba(t,{...n,diagnostic:{...a,...e}})}async function hi(){qe();try{await ne()}catch(t){console.warn("[keeper-runtime] dashboard refresh failed",t)}}function Yn(t){on.value=t.trim()}async function Ko(t,e=!1){const n=t.trim();if(!n)return null;if(!e&&Bt.value[n])return Bt.value[n];ot(Es,n,!0),ot(Wt,n,null);try{const a=await bt("masc_keeper_status",{name:n,fast:!1,include_context:!0,include_metrics_overview:!0,include_memory_bank:!1,include_history_tail:!0,include_compaction_history:!1,tail_turns:5,tail_messages:10});let i=null;try{i=JSON.parse(a)}catch{i=null}const o=Dc(n,a,i);return Ba(n,o),o}catch(a){const i=a instanceof Error?a.message:`Failed to inspect ${n}`;return ot(Wt,n,i),null}finally{ot(Es,n,!1)}}async function Mc(t,e){const n=t.trim(),a=e.trim();if(!n||!a)return;const i=`local-${Date.now()}`;Ki(n,{id:i,role:"user",label:"You",text:a,timestamp:new Date().toISOString(),delivery:"sending"}),ot(Is,n,!0),ot(Wt,n,null);try{const o=await bc(n,a);dt.value={...dt.value,[n]:(dt.value[n]??[]).map(r=>r.id===i?{...r,delivery:"delivered"}:r)},Ki(n,{id:`reply-${Date.now()}`,role:"assistant",label:n,text:o.trim()||"(empty reply)",timestamp:new Date().toISOString(),delivery:"delivered"}),Hi(n,{last_reply_status:"delivered",last_reply_at:new Date().toISOString(),last_reply_preview:(o.trim()||"(empty reply)").slice(0,200),last_error:null}),await hi()}catch(o){const r=o instanceof Error?o.message:`Failed to send direct message to ${n}`;throw dt.value={...dt.value,[n]:(dt.value[n]??[]).map(l=>l.id===i?{...l,delivery:"error",error:r}:l)},Hi(n,{last_reply_status:"error",last_error:r}),ot(Wt,n,r),o}finally{ot(Is,n,!1)}}async function Oc(t,e){const n=t.trim();if(!n)return null;ot(Ms,n,!0),ot(Wt,n,null);try{const a=await On({actor:e,action_type:"keeper_probe",target_type:"keeper",target_id:n,payload:{}}),i=Nc(a.result),o=(i==null?void 0:i.diagnostic)??null;if(o){const r=Bt.value[n];Ba(n,{name:n,diagnostic:o,history:(r==null?void 0:r.history)??dt.value[n]??[],rawText:(r==null?void 0:r.rawText)??"",rawStatus:a.result,loadedAt:new Date().toISOString()})}return await hi(),o}catch(a){const i=a instanceof Error?a.message:`Failed to probe ${n}`;throw ot(Wt,n,i),a}finally{ot(Ms,n,!1)}}async function zc(t,e){const n=t.trim();if(!n)return null;ot(Os,n,!0),ot(Wt,n,null);try{const a=await On({actor:e,action_type:"keeper_recover",target_type:"keeper",target_id:n,payload:{}}),i=Rc(a.result),o=(i==null?void 0:i.after)??null;if(o){const r=Bt.value[n];Ba(n,{name:n,diagnostic:o,history:(r==null?void 0:r.history)??dt.value[n]??[],rawText:(r==null?void 0:r.rawText)??"",rawStatus:a.result,loadedAt:new Date().toISOString()})}return await hi(),o}catch(a){const i=a instanceof Error?a.message:`Failed to recover ${n}`;throw ot(Wt,n,i),a}finally{ot(Os,n,!1)}}function ce(t){return(t??"").trim().toLowerCase()}function _t(t){const e=typeof t=="number"?t:Date.parse(t);return Number.isNaN(e)?0:e}function Xn(t,e=88){const n=t.replace(/\s+/g," ").trim();return n&&(n.length>e?`${n.slice(0,e-3)}...`:n)}function jn(t){return typeof t!="number"||!Number.isFinite(t)||t<0?null:new Date(Date.now()-t*1e3).toISOString()}function Ye(t){return t.last_heartbeat??jn(t.last_turn_ago_s)??jn(t.last_proactive_ago_s)??jn(t.last_handoff_ago_s)??jn(t.last_compaction_ago_s)}function qc(t){const e=t.title.trim();return e||Xn(t.content)}function jc(t){const e=t.generation??"?",n=typeof t.context_ratio=="number"&&Number.isFinite(t.context_ratio)?`${Math.round(t.context_ratio*100)}%`:"?";return t.last_heartbeat?`Heartbeat gen=${e} ctx=${n}`:`Keeper snapshot gen=${e} ctx=${n}`}function Fc(t,e,n,a,i={}){var E;const o=ce(t),r=e.filter(N=>ce(N.assignee)===o&&(N.status==="claimed"||N.status==="in_progress")).length,l=n.filter(N=>ce(N.from)===o).sort((N,R)=>_t(R.timestamp)-_t(N.timestamp))[0],p=a.filter(N=>ce(N.agent)===o||ce(N.author)===o).sort((N,R)=>_t(R.timestamp)-_t(N.timestamp))[0],$=(i.boardPosts??[]).filter(N=>ce(N.author)===o).sort((N,R)=>_t(R.updated_at||R.created_at)-_t(N.updated_at||N.created_at))[0],m=(i.keepers??[]).filter(N=>ce(N.name)===o&&Ye(N)!==null).sort((N,R)=>_t(Ye(R)??0)-_t(Ye(N)??0))[0],d=l?_t(l.timestamp):0,v=p?_t(p.timestamp):0,c=$?_t($.updated_at||$.created_at):0,y=m?_t(Ye(m)??0):0,S=i.lastSeen?_t(i.lastSeen):0,T=((E=i.currentTask)==null?void 0:E.trim())||(r>0?`${r} claimed tasks`:null);if(d===0&&v===0&&c===0&&y===0&&S===0)return{activeAssignedCount:r,lastActivityAt:null,lastActivityText:T};const K=[l?{timestamp:l.timestamp,ts:d,text:Xn(l.content)}:null,$?{timestamp:$.updated_at||$.created_at,ts:c,text:`Post: ${Xn(qc($))}`}:null,m?{timestamp:Ye(m),ts:y,text:jc(m)}:null,p?{timestamp:new Date(p.timestamp).toISOString(),ts:v,text:Xn(p.text)}:null].filter(N=>N!==null).sort((N,R)=>R.ts-N.ts)[0];return K&&K.ts>=S?{activeAssignedCount:r,lastActivityAt:K.timestamp,lastActivityText:K.text}:{activeAssignedCount:r,lastActivityAt:i.lastSeen??null,lastActivityText:T??"Presence heartbeat"}}const At=_([]),yt=_([]),Sn=_([]),Jt=_([]),se=_(null),nn=_(null),js=_(new Map),Be=_([]),An=_("hot"),ue=_(!0),Ho=_(null),Ut=_(""),Cn=_([]),Re=_(!1),Uo=_(new Map),Fs=_("unknown"),Ks=_(null),Hs=_(!1),wn=_(!1),Us=_(!1),Le=_(!1),Kc=_(null),Bs=_(null),Bo=_(null),Wo=_(null),Hc=Ct(()=>At.value.filter(t=>t.status==="active"||t.status==="busy"||t.status==="listening"||t.status==="idle")),Go=Ct(()=>{const t=yt.value;return{todo:t.filter(e=>e.status==="todo"),inProgress:t.filter(e=>e.status==="in_progress"||e.status==="claimed"),done:t.filter(e=>e.status==="done")}}),Wa=Ct(()=>{const t=new Map,e=yt.value,n=Sn.value,a=ca.value,i=Be.value,o=Jt.value;for(const r of At.value)t.set(r.name.trim().toLowerCase(),Fc(r.name,e,n,a,{currentTask:r.current_task,lastSeen:r.last_seen,boardPosts:i,keepers:o}));return t});function Uc(t){var o;const e=((o=t.status)==null?void 0:o.toLowerCase())??"";if(e==="offline"||e==="inactive")return"offline";const n=t.metrics_series;if(!n||n.length===0)return"idle";const a=n[n.length-1];if(!a)return"idle";if(a.is_handoff)return"handoff-imminent";if(a.is_compaction)return"compacting";const i=a.context_ratio;return i>.85?"handoff-imminent":i>.7?"preparing":i>.5?"compacting":"active"}const Jo=Ct(()=>{const t=new Map;for(const e of Jt.value)t.set(e.name,Uc(e));return t}),Bc=12e4;function Wc(t,e){const n=e.get(t.name);if(n!=null)return n;const a=t.last_heartbeat?Date.parse(t.last_heartbeat):Number.NaN;if(!Number.isNaN(a))return a;const i=[t.last_turn_ago_s,t.last_proactive_ago_s,t.last_handoff_ago_s,t.last_compaction_ago_s].find(o=>typeof o=="number"&&Number.isFinite(o)&&o>=0);return typeof i=="number"?Date.now()-i*1e3:null}const Vo=Ct(()=>{const t=Date.now(),e=new Set,n=js.value;for(const a of Jt.value){const i=Wc(a,n);i!=null&&t-i>Bc&&e.add(a.name)}return e}),ua={},Gc=5e3;let Za=null;function Jc(t){return t==="dashboard_refresh"||t==="masc/dashboard_refresh"||t.startsWith("goal_")||t.startsWith("masc/goal_")||t.startsWith("mdal_")||t.startsWith("masc/mdal_")||t.startsWith("operator_")||t.startsWith("masc/operator_")||t.startsWith("command_plane_")||t.startsWith("masc/command_plane_")}function qe(){delete ua.compact,delete ua.full}function ut(t){return typeof t=="object"&&t!==null}function b(t){return typeof t=="string"&&t.trim()!==""?t:void 0}function A(t){return typeof t=="number"&&Number.isFinite(t)?t:void 0}function _e(t){if(!Array.isArray(t))return;const e=t.filter(n=>typeof n=="string"&&n.trim()!=="");return e.length>0?e:void 0}function Ws(t){if(typeof t=="string"&&t.trim()!=="")return t;if(!(typeof t!="number"||!Number.isFinite(t)||t<=0))return new Date(t*1e3).toISOString()}function Qo(t){const e=typeof t=="string"?t.toLowerCase():"";return e==="active"||e==="busy"||e==="listening"||e==="idle"||e==="inactive"||e==="offline"?e:e==="in_progress"||e==="claimed"?"busy":"offline"}function Vc(t){const e=typeof t=="string"?t.toLowerCase():"";return e==="todo"||e==="in_progress"||e==="claimed"||e==="done"||e==="cancelled"?e:e==="inprogress"?"in_progress":"todo"}function Yo(t){if(!ut(t))return null;const e=b(t.name);return e?{name:e,status:Qo(t.status),current_task:b(t.current_task)??null,last_seen:b(t.last_seen),emoji:b(t.emoji),koreanName:b(t.koreanName)??b(t.korean_name),model:b(t.model),traits:_e(t.traits),interests:_e(t.interests),activityLevel:A(t.activityLevel)??A(t.activity_level),primaryValue:b(t.primaryValue)??b(t.primary_value)}:null}function Xo(t){if(!ut(t))return null;const e=b(t.id),n=b(t.title);return!e||!n?null:{id:e,title:n,status:Vc(t.status),priority:A(t.priority),assignee:b(t.assignee),description:b(t.description),created_at:b(t.created_at),updated_at:b(t.updated_at)}}function Zo(t){if(!ut(t))return null;const e=b(t.from)??b(t.from_agent)??"system",n=b(t.content)??"",a=b(t.timestamp)??new Date().toISOString();return{id:b(t.id),seq:A(t.seq),from:e,content:n,timestamp:a,type:b(t.type)}}function Qc(t){return Array.isArray(t)?t.map(e=>{if(!ut(e))return null;const n=A(e.ts_unix);if(n==null)return null;const a=ut(e.handoff)?e.handoff:null;return{ts:n,context_ratio:A(e.context_ratio)??0,context_tokens:A(e.context_tokens)??0,context_max:A(e.context_max)??0,latency_ms:A(e.latency_ms)??0,generation:A(e.generation)??0,channel:typeof e.channel=="string"?e.channel:"turn",is_handoff:a!=null&&e.handoff_performed===!0,is_compaction:e.compacted===!0,compaction_saved_tokens:A(e.compaction_saved_tokens)??0,compaction_trigger:typeof e.compaction_trigger=="string"?e.compaction_trigger:null,model_used:typeof e.model_used=="string"?e.model_used:"",cost_usd:A(e.cost_usd)??0,handoff_to_model:a&&typeof a.to_model=="string"?a.to_model:null,handoff_new_generation:a?A(a.new_generation)??null:null}}).filter(e=>e!==null):[]}function Ui(t){if(!ut(t))return null;const e=b(t.health_state),n=b(t.next_action_path),a=b(t.last_reply_status);if(!e||!n||!a)return null;const i=b(t.quiet_reason)??null,o=b(t.summary)??(e==="offline"||e==="degraded"||e==="stale"?"Keeper is not in a healthy reply state. Probe or recover before relying on automation.":i==="quiet_hours"?"Lodge quiet hours are active. Direct messages still work, but scheduled social ticks may look asleep.":i==="min_gap"?"Keeper is inside its proactive cooldown window. Direct messages work now; autonomous check-ins will wait.":i==="never_started"?"Keeper metadata exists but no reply turn has been recorded yet.":"Keeper is reachable. Send a direct message for an immediate response.");return{health_state:e,quiet_reason:i,next_action_path:n,last_reply_status:a,last_reply_at:Ws(t.last_reply_at)??b(t.last_reply_at)??null,last_reply_preview:b(t.last_reply_preview)??null,last_error:b(t.last_error)??null,next_eligible_at_s:A(t.next_eligible_at_s)??null,recoverable:typeof t.recoverable=="boolean"?t.recoverable:n==="recover",summary:o,keepalive_running:typeof t.keepalive_running=="boolean"?t.keepalive_running:void 0}}function Yc(t,e){return(Array.isArray(t)?t:ut(t)&&Array.isArray(t.keepers)?t.keepers:[]).map(a=>{if(!ut(a))return null;const i=ut(a.agent)?a.agent:null,o=ut(a.context)?a.context:null,r=ut(a.metrics_window)?a.metrics_window:void 0,l=b(a.name);if(!l)return null;const p=A(a.context_ratio)??A(o==null?void 0:o.context_ratio),$=b(a.status)??b(i==null?void 0:i.status)??"offline",m=Qo($),d=b(a.model)??b(a.active_model)??b(a.primary_model),v=_e(a.skill_secondary),c=o?{source:b(o.source),context_ratio:A(o.context_ratio),context_tokens:A(o.context_tokens),context_max:A(o.context_max),message_count:A(o.message_count),has_checkpoint:typeof o.has_checkpoint=="boolean"?o.has_checkpoint:void 0}:void 0,y=i?{name:b(i.name),exists:typeof i.exists=="boolean"?i.exists:void 0,error:b(i.error),status:b(i.status),current_task:b(i.current_task)??null,last_seen:b(i.last_seen),last_seen_ago_s:A(i.last_seen_ago_s),is_zombie:typeof i.is_zombie=="boolean"?i.is_zombie:void 0}:void 0,S=Qc(a.metrics_series),T={name:l,emoji:b(a.emoji),koreanName:b(a.koreanName)??b(a.korean_name),agent_name:b(a.agent_name),trace_id:b(a.trace_id),model:d,primary_model:b(a.primary_model),active_model:b(a.active_model),next_model_hint:b(a.next_model_hint)??null,status:m,presence_keepalive:typeof a.presence_keepalive=="boolean"?a.presence_keepalive:void 0,presence_keepalive_sec:A(a.presence_keepalive_sec),keepalive_running:typeof a.keepalive_running=="boolean"?a.keepalive_running:void 0,proactive_enabled:typeof a.proactive_enabled=="boolean"?a.proactive_enabled:void 0,proactive_idle_sec:A(a.proactive_idle_sec),proactive_cooldown_sec:A(a.proactive_cooldown_sec),last_heartbeat:b(a.last_heartbeat)??b(i==null?void 0:i.last_seen),generation:A(a.generation),turn_count:A(a.turn_count)??A(a.total_turns),keeper_age_s:A(a.keeper_age_s),last_turn_ago_s:A(a.last_turn_ago_s),last_handoff_ago_s:A(a.last_handoff_ago_s),last_compaction_ago_s:A(a.last_compaction_ago_s),last_proactive_ago_s:A(a.last_proactive_ago_s),context_ratio:p,context_tokens:A(a.context_tokens)??A(o==null?void 0:o.context_tokens),context_max:A(a.context_max)??A(o==null?void 0:o.context_max),context_source:b(a.context_source)??b(o==null?void 0:o.source),context:c,traits:_e(a.traits),interests:_e(a.interests),primaryValue:b(a.primaryValue)??b(a.primary_value),activityLevel:A(a.activityLevel)??A(a.activity_level),memory_recent_note:b(a.memory_recent_note)??null,conversation_tail_count:A(a.conversation_tail_count),k2k_count:A(a.k2k_count),handoff_count_total:A(a.handoff_count_total)??A(a.trace_history_count),compaction_count:A(a.compaction_count),last_compaction_saved_tokens:A(a.last_compaction_saved_tokens),diagnostic:Ui(a.diagnostic),skill_primary:b(a.skill_primary)??null,skill_secondary:v,skill_reason:b(a.skill_reason)??null,metrics_series:S.length>0?S:void 0,metrics_window:r,agent:y};return T.diagnostic=Ui(a.diagnostic)??Lc(T,(e==null?void 0:e.lodge)??null),T}).filter(a=>a!==null)}function Xc(t){return ut(t)?{...t,lodge:Tc(t.lodge)??void 0}:null}function Zc(t){const e=typeof t=="string"?t.toLowerCase():"";return e==="running"||e==="interrupted"||e==="completed"||e==="stopped"||e==="error"?e:e.startsWith("error")?"error":"running"}function td(t){if(!ut(t))return null;const e=A(t.iteration);if(e==null)return null;const n=A(t.metric_before)??0,a=A(t.metric_after)??n,i=ut(t.evidence)?t.evidence:null;return{iteration:e,metric_before:n,metric_after:a,delta:A(t.delta)??a-n,changes:b(t.changes)??"",failed_attempts:b(t.failed_attempts)??"",next_suggestion:b(t.next_suggestion)??"",elapsed_ms:A(t.elapsed_ms)??0,cost_usd:A(t.cost_usd)??null,evidence:i?{worker_engine:(i.worker_engine==="api_tool_loop","api_tool_loop"),worker_model:b(i.worker_model)??"",tool_call_count:A(i.tool_call_count)??0,tool_names:_e(i.tool_names)??[],session_id:b(i.session_id)??"",evidence_status:i.evidence_status==="legacy_unverified"?"legacy_unverified":"verified"}:null}}function ed(t){var o,r;if(!ut(t))return null;const e=b(t.loop_id);if(!e)return null;const n=A(t.baseline_metric)??0,a=Array.isArray(t.history)?t.history.map(td).filter(l=>l!==null):[],i=A(t.current_metric)??((o=a[0])==null?void 0:o.metric_after)??n;return{loop_id:e,profile:b(t.profile)??"unknown",status:Zc(t.status),strict_mode:typeof t.strict_mode=="boolean"?t.strict_mode:void 0,error_message:b(t.error_message)??b(t.error_reason)??null,stop_reason:b(t.stop_reason)??b(t.reason)??null,current_iteration:A(t.current_iteration)??((r=a[0])==null?void 0:r.iteration)??0,max_iterations:A(t.max_iterations)??0,baseline_metric:n,current_metric:i,target:b(t.target)??"",stagnation_streak:A(t.stagnation_streak)??0,stagnation_limit:A(t.stagnation_limit)??0,elapsed_seconds:A(t.elapsed_seconds)??0,updated_at:Ws(t.updated_at)??null,stopped_at:Ws(t.stopped_at)??null,execution_mode:t.execution_mode==="worker_spawn"?"worker_spawn":void 0,worker_engine:t.worker_engine==="api_tool_loop"?"api_tool_loop":null,worker_model:b(t.worker_model)??null,evidence_policy:t.evidence_policy==="hard"||t.evidence_policy==="legacy"?t.evidence_policy:void 0,latest_tool_call_count:A(t.latest_tool_call_count)??0,latest_tool_names:_e(t.latest_tool_names)??[],session_id:b(t.session_id)??null,evidence_status:t.evidence_status==="legacy_unverified"?"legacy_unverified":t.evidence_status==="verified"?"verified":null,durability:t.durability==="persistent_backend"||t.durability==="memory_only"?t.durability:void 0,persistence_backend:t.persistence_backend==="filesystem"||t.persistence_backend==="postgres"||t.persistence_backend==="memory"?t.persistence_backend:void 0,recoverable:typeof t.recoverable=="boolean"?t.recoverable:void 0,history:a}}async function ne(t="full"){var a,i,o;const e=Date.now(),n=ua[t];if(!(n&&e-n.time<Gc)){Hs.value=!0;try{const r=await yl(t);ua[t]={data:r,time:e},At.value=(Array.isArray((a=r.agents)==null?void 0:a.agents)?r.agents.agents:[]).map(Yo).filter(p=>p!==null),yt.value=(Array.isArray((i=r.tasks)==null?void 0:i.tasks)?r.tasks.tasks:[]).map(Xo).filter(p=>p!==null),Sn.value=(Array.isArray((o=r.messages)==null?void 0:o.messages)?r.messages.messages:[]).map(Zo).filter(p=>p!==null);const l=Xc(r.status);se.value=l,Jt.value=Yc(r.keepers,l),nn.value=r.perpetual??null,Kc.value=new Date().toISOString()}catch(r){console.error("Dashboard fetch error:",r)}finally{Hs.value=!1}}}async function nd(){try{const t=await bl(),e=(Array.isArray(t.agents)?t.agents:[]).map(Yo).filter(i=>i!==null),n=At.value,a=new Map(n.map(i=>[i.name,i]));At.value=e.map(i=>{const o=a.get(i.name);return o?{...o,status:i.status,current_task:i.current_task}:i})}catch(t){console.error("Agents selective fetch error:",t)}}async function ad(){try{const t=await kl({includeDone:!0,includeCancelled:!0}),e=(Array.isArray(t.tasks)?t.tasks:[]).map(Xo).filter(i=>i!==null),n=yt.value,a=new Map(n.map(i=>[i.id,i]));yt.value=e.map(i=>{const o=a.get(i.id);return o?{...o,status:i.status,priority:i.priority??o.priority,assignee:i.assignee??o.assignee}:i})}catch(t){console.error("Tasks selective fetch error:",t)}}async function sd(){try{const t=Sn.value,e=t.reduce((l,p)=>Math.max(l,p.seq??0),0),n=await xl(e),a=(Array.isArray(n.messages)?n.messages:[]).map(Zo).filter(l=>l!==null);if(a.length===0)return;const i=new Set(t.map(l=>l.seq).filter(l=>l!=null)),o=new Set(t.filter(l=>l.seq==null).map(l=>`${l.timestamp}|${l.from}`)),r=a.filter(l=>{if(l.seq!=null)return!i.has(l.seq);const p=`${l.timestamp}|${l.from}`;return o.has(p)?!1:(o.add(p),!0)});if(r.length>0){const l=[...t,...r];Sn.value=l.length>500?l.slice(-500):l}}catch(t){console.error("Messages selective fetch error:",t)}}async function qt(){wn.value=!0;try{const t=await jl(An.value,{excludeSystem:ue.value});Be.value=t.posts??[],Bs.value=new Date().toISOString()}catch(t){console.error("Board fetch error:",t)}finally{wn.value=!1}}async function jt(){var t;Us.value=!0;try{const e=Ut.value||((t=se.value)==null?void 0:t.room)||"default";Ut.value||(Ut.value=e);const n=await ac(e);Ho.value=n}catch(e){console.error("TRPG fetch error:",e)}finally{Us.value=!1}}async function Tn(){Re.value=!0;try{const t=await kc();Cn.value=Array.isArray(t)?t:[],Bo.value=new Date().toISOString()}catch(t){console.error("Goals fetch error:",t)}finally{Re.value=!1}}async function je(){Le.value=!0;try{const t=await Sl(),e=Array.isArray(t.loops)?t.loops:[],n=new Map;for(const a of e){const i=ed(a);i&&n.set(i.loop_id,i)}Uo.value=n,Wo.value=new Date().toISOString(),Ks.value=null,Fs.value=n.size===0?"idle":"ready"}catch(t){console.error("MDAL fetch error:",t),Fs.value="error",Ks.value=t instanceof Error?t.message:String(t)}finally{Le.value=!1}}let Zn=null;function id(t){Zn=t}let ta=null;function od(t){ta=t}const pe={};function de(t,e,n=500){pe[t]&&clearTimeout(pe[t]),pe[t]=setTimeout(()=>{e(),delete pe[t]},n)}function rd(){const t=Ro.subscribe(e=>{if(e){if(e.type==="keeper_heartbeat"&&e.name){const n=new Map(js.value);n.set(e.name,e.ts_unix?e.ts_unix*1e3:Date.now()),js.value=n;return}(e.type==="agent_joined"||e.type==="agent_left")&&de("agents",nd),Jc(e.type)&&(qe(),Za||(Za=setTimeout(()=>{ne(),ta==null||ta(),Za=null},500))),(e.type.startsWith("task_")||e.type.startsWith("masc/task_"))&&de("tasks",ad),e.type==="broadcast"&&de("messages",sd),(e.type==="keeper_handoff"||e.type==="keeper_compaction"||e.type==="keeper_guardrail")&&de("dashboard",()=>{qe(),ne()}),(e.type==="board_post"||e.type==="masc/board_post"||e.type==="board_comment"||e.type==="masc/board_comment")&&de("board",qt),e.type.startsWith("decision_")&&de("council",()=>Zn==null?void 0:Zn()),(e.type==="mdal_started"||e.type==="mdal_iteration"||e.type==="mdal_completed"||e.type==="mdal_stopped")&&de("mdal",je,350)}});return()=>{t();for(const e of Object.keys(pe))clearTimeout(pe[e]),delete pe[e]}}let rn=null;function ld(){rn||(rn=setInterval(()=>{Ft.value||qe(),ne()},1e4))}function cd(){rn&&(clearInterval(rn),rn=null)}function w({title:t,class:e,children:n}){return s`
  ...
  `}function dd(t){const e=Date.now(),n=typeof t=="number"?t<1e12?t*1e3:t:new Date(t).getTime(),a=Math.floor((e-n)/1e3);if(a<60)return`${a}s ago`;const i=Math.floor(a/60);if(i<60)return`${i}m ago`;const o=Math.floor(i/60);return o<24?`${o}h ago`:`${Math.floor(o/24)}d ago`}function F({timestamp:t}){const e=dd(t),n=typeof t=="string"?t:new Date(t<1e12?t*1e3:t).toISOString();return s`<span class="time-ago" title=${n}>${e}</span>`}function Y(t){if(t==null)return 0;const e=typeof t=="number"?t:Date.parse(t);return Number.isNaN(e)?0:e}function st(t){switch(t){case"bad":return 2;case"warn":return 1;default:return 0}}function me(t){return(t??"").trim().toLowerCase()}function ct(t,e=96){const n=(t??"").replace(/\s+/g," ").trim();return n?n.length>e?`${n.slice(0,e-3)}...`:n:null}function zt(t){return typeof t!="number"||Number.isNaN(t)?3:t}function yi(t){const e=zt(t);return e<=1?"P1":e===2?"P2":e>=4?"P4+":"P3"}let ud=0;const ve=_([]);function C(t,e="success",n=4e3){const a=++ud;ve.value=[...ve.value,{id:a,message:t,type:e}],setTimeout(()=>{ve.value=ve.value.filter(i=>i.id!==a)},n)}function pd(t){ve.value=ve.value.filter(e=>e.id!==t)}function md(){const t=ve.value;return t.length===0?null:s`
  ...
  `}function Sd(t){switch(t){case"quiet_hours":return"quiet hours";case"min_gap":return"cooldown gate";case"no_recent_activity":return"waiting for activity";case"disabled":return"runtime disabled";case"startup":return"warming up";case"llm_error":return"llm error";case"graphql_error":return"graphql error";case"never_started":return"never started";default:return"unknown"}}function Ad(t){switch(t){case"manual_lodge_poke":return"Poke Lodge";case"probe":return"Probe";case"recover":return"Recover";default:return"Message"}}function Cd(t){switch(t.delivery){case"sending":return"sending";case"timeout":return"timeout";case"error":return"error";case"delivered":return"delivered";default:return t.role}}function Vi(t){return t.delivery==="error"||t.delivery==="timeout"?"bad":t.delivery==="sending"?"warn":t.role==="assistant"?"assistant":t.role==="user"?"user":"warn"}function ar(t){if(!t)return null;const e=new Date(t);return Number.isNaN(e.getTime())?null:e.toLocaleTimeString()}function wd(t){return typeof t!="number"||!Number.isFinite(t)||t<=0?null:t<60?`${Math.round(t)}s`:`${Math.ceil(t/60)}m`}function sr(t){if(!t)return null;const e=Bt.value[t.name];return(e==null?void 0:e.diagnostic)??t.diagnostic??null}function ir({keeper:t,showRawStatus:e=!1}){if(rt(()=>{t!=null&&t.name&&Ko(t.name)},[t==null?void 0:t.name]),!t)return s`<div class="control-status-copy">Select a keeper to inspect direct reply state.</div>`;const n=Bt.value[t.name],a=sr(t),i=Es.value[t.name];return s`
  ...
  `}function or({keeperName:t,placeholder:e}){const[n,a]=Ua("");rt(()=>{t&&Ko(t)},[t]);const i=dt.value[t]??[],o=Is.value[t]??!1,r=Wt.value[t],l=async()=>{const p=n.trim();if(!(!t||!p)){a("");try{await Mc(t,p)}catch($){const m=$ instanceof Error?$.message:`Failed to message ${t}`;C(m,"error")}}};return s`
        ...
        ${i.length===0?s`<div class="control-status-copy">No direct keeper conversation yet.</div>`:i.map(p=>s`
              <div class="keeper-conversation-item" key=${p.id}>
                <div class="keeper-conversation-meta">
                  ...
                  <span class=${`keeper-role-chip ${Vi(p)}`}>${Cd(p)}</span>
  ...
  `}function rr({actor:t,keeper:e,onPokeLodge:n}){if(!e)return null;const a=sr(e),i=Ms.value[e.name]??!1,o=Os.value[e.name]??!1,r=(a==null?void 0:a.next_action_path)??"direct_message",l=(a==null?void 0:a.recoverable)??r==="recover";return s`
    <div class="control-actions">
      <button
        ...
        onClick=${()=>{Oc(e.name,t).catch(p=>{const $=p instanceof Error?p.message:`Failed to probe ${e.name}`;C($,"error")})}}
        disabled=${i||!t.trim()}
      >
        ${i?"Probing...":"Probe"}
      </button>
      <button
        ...
        onClick=${()=>{zc(e.name,t).catch(p=>{const $=p instanceof Error?p.message:`Failed to recover ${e.name}`;C($,"error")})}}
        disabled=${o||!l||!t.trim()}
      >
  ...
  `}function ao(){var X,H,Pt,mt,vt,B,M,x,Dt,Vt,oe,re,I,Et,le,Je,Ve;const t=se.value,e=At.value,n=yt.value,a=Jt.value,i=Go.value,o=(X=t==null?void 0:t.monitoring)==null?void 0:X.board,r=(H=t==null?void 0:t.monitoring)==null?void 0:H.council,l=Ft.value,p=new Map(e.map(f=>[me(f.name),f])),$=Wa.value,m=e.map(f=>{var Ii;const L=$.get(me(f.name))??{activeAssignedCount:0,lastActivityAt:null,lastActivityText:null},j=L.lastActivityAt??f.last_seen??null,at=j?Math.max(0,Date.now()-Y(j)):Number.POSITIVE_INFINITY,z=L.activeAssignedCount,ft=!!((Ii=f.current_task)!=null&&Ii.trim()),Q=ft||z>0;let Z="ok",kt="Fresh and ready",ye=!1,be=!1;return f.status==="offline"||f.status==="inactive"?(Z=Q?"bad":"warn",kt=Q?"Load without an available owner":"Offline"):Q&&at>as?(Z="bad",kt="Execution is stale"):z>0&&!ft?(Z="warn",kt="Claimed work has no current_task",be=!0):ft&&z===0?(Z="warn",kt="current_task has no claimed work",be=!0):!Q&&at<=ns?(Z="ok",kt="Dispatchable now",ye=!0):!Q&&at>as?(Z="warn",kt="Idle but not freshly active"):Q&&at>ns&&(Z="warn",kt="Execution is getting quiet"),{agent:f,lastSignalAt:j,activeTaskCount:z,tone:Z,note:kt,focus:ct(f.current_task)??L.lastActivityText??(ye?"Ready for assignment.":"Waiting for a clearer signal."),dispatchable:ye,drift:be}}).sort((f,L)=>{const j=st(L.tone)-st(f.tone);return j!==0?j:Y(L.lastSignalAt)-Y(f.lastSignalAt)}),d=a.map(f=>{var Z;const L=Jo.value.get(f.name)??"idle",j=Vo.value.has(f.name),at=f.context_ratio??0,z=f.diagnostic??null;let ft="ok",Q="Healthy keeper";return j||f.status==="offline"||L==="handoff-imminent"||(z==null?void 0:z.health_state)==="offline"||(z==null?void 0:z.health_state)==="degraded"?(ft="bad",Q=ct(z==null?void 0:z.summary,56)??(j?"Heartbeat stale":L==="handoff-imminent"?"Handoff imminent":(z==null?void 0:z.health_state)==="degraded"?"Keeper degraded":"Keeper offline")):((z==null?void 0:z.health_state)==="stale"||at>=Zi||L==="preparing"||L==="compacting")&&(ft="warn",Q=ct(z==null?void 0:z.summary,56)??(at>=Zi?"High context pressure":`Lifecycle ${L}`)),{keeper:f,tone:ft,note:Q,focus:ct(z==null?void 0:z.summary,120)??ct((Z=f.agent)==null?void 0:Z.current_task)??f.skill_primary??f.last_proactive_reason??f.memory_recent_note??"No active focus",timestamp:f.last_heartbeat??null}}).sort((f,L)=>{const j=st(L.tone)-st(f.tone);return j!==0?j:Y(L.timestamp)-Y(f.timestamp)}),v=n.filter(f=>f.status==="todo"||f.status==="claimed"||f.status==="in_progress").map(f=>{var ye,be;const L=f.assignee?p.get(me(f.assignee))??null:null,j=L?$.get(me(L.name))??null:null,at=(j==null?void 0:j.lastActivityAt)??(L==null?void 0:L.last_seen)??null,z=at?Math.max(0,Date.now()-Y(at)):Number.POSITIVE_INFINITY,ft=f.status==="claimed"||f.status==="in_progress";let Q="ok",Z="Covered",kt=!1;return f.assignee?!L||L.status==="offline"||L.status==="inactive"?(Q="bad",Z="Assigned owner is unavailable",kt=!0):ft&&z>as?(Q="bad",Z="Execution has lost a fresh signal"):ft&&z>ns?(Q="warn",Z="Execution is drifting quiet"):f.status==="todo"&&zt(f.priority)<=2&&!((ye=L.current_task)!=null&&ye.trim())&&((j==null?void 0:j.activeAssignedCount)??0)===0?(Q="ok",Z="Ready for dispatch"):ft&&!((be=L.current_task)!=null&&be.trim())&&(Q="warn",Z="Owner focus is not explicit"):(Q=zt(f.priority)<=2?"bad":"warn",Z=ft?"Active work has no owner":"Ready work has no owner",kt=!0),{task:f,owner:L,lastSignalAt:at,tone:Q,note:Z,focus:ct(L==null?void 0:L.current_task)??(j==null?void 0:j.lastActivityText)??ct(f.description)??"Needs operator attention.",ownerGap:kt}}).sort((f,L)=>{const j=st(L.tone)-st(f.tone);if(j!==0)return j;const at=zt(f.task.priority)-zt(L.task.priority);return at!==0?at:Y(L.lastSignalAt??L.task.updated_at??L.task.created_at)-Y(f.lastSignalAt??f.task.updated_at??f.task.created_at)}),c=v.filter(f=>f.task.status==="todo"&&zt(f.task.priority)<=2),y=v.filter(f=>f.ownerGap).length,S=m.filter(f=>f.dispatchable),T=m.filter(f=>f.drift||f.tone!=="ok"),P=d.filter(f=>f.tone!=="ok"),K=t!=null&&t.paused?"bad":((Pt=t==null?void 0:t.data_quality)==null?void 0:Pt.board_contract_ok)===!1||((mt=t==null?void 0:t.data_quality)==null?void 0:mt.council_feed_ok)===!1?"warn":l?"ok":"warn",E=[];t!=null&&t.paused&&E.push({key:"paused",tone:"bad",title:"Room is paused",detail:t.tempo?`Tempo is ${t.tempo}. Resume from Ops when ready.`:"Resume from Ops when ready.",timestamp:((vt=t.data_quality)==null?void 0:vt.last_sync_at)??null,action:()=>Rt("ops")}),l||E.push({key:"live-connection",tone:"warn",title:"Live feed is reconnecting",detail:"Dashboard telemetry is stale until the SSE stream recovers.",timestamp:null,action:jd}),xe(o==null?void 0:o.alert_level)!=="ok"&&E.push({key:"board-monitor",tone:xe(o==null?void 0:o.alert_level),title:"Board feed needs attention",detail:`Freshness ${is(o==null?void 0:o.last_activity_age_s)} · ${(o==null?void 0:o.unanswered_posts)??0} unanswered posts.`,timestamp:null,action:()=>Rt("board")}),xe(r==null?void 0:r.alert_level)!=="ok"&&E.push({key:"council-monitor",tone:xe(r==null?void 0:r.alert_level),title:"Council quorum risk is elevated",detail:`${(r==null?void 0:r.sessions_without_quorum)??0} sessions without quorum · freshness ${is(r==null?void 0:r.last_activity_age_s)}.`,timestamp:null,action:()=>Rt("board")}),(((B=t==null?void 0:t.data_quality)==null?void 0:B.board_contract_ok)===!1||((M=t==null?void 0:t.data_quality)==null?void 0:M.council_feed_ok)===!1)&&E.push({key:"data-quality",tone:"warn",title:"Dashboard data quality is degraded",detail:`${((x=t.data_quality)==null?void 0:x.board_contract_ok)===!1?"Board contract":"Board contract ok"} · ${((Dt=t.data_quality)==null?void 0:Dt.council_feed_ok)===!1?"Council feed degraded":"Council feed ok"}.`,timestamp:((Vt=t.data_quality)==null?void 0:Vt.last_sync_at)??null,action:()=>Rt("ops")});const N=[...E,...v.filter(f=>f.tone!=="ok").slice(0,3).map(f=>({key:`task-${f.task.id}`,tone:f.tone,title:f.task.title,detail:`${f.note} · ${f.focus}`,timestamp:f.lastSignalAt??f.task.updated_at??f.task.created_at??null,action:()=>Rt("overview")})),...P.slice(0,2).map(f=>({key:`keeper-${f.keeper.name}`,tone:f.tone,title:f.keeper.name,detail:`${f.note} · ${f.focus}`,timestamp:f.timestamp,action:()=>fa(f.keeper)})),...T.slice(0,2).map(f=>({key:`agent-${f.agent.name}`,tone:f.tone,title:f.agent.name,detail:`${f.note} · ${f.focus}`,timestamp:f.lastSignalAt,action:()=>Ie(f.agent.name)}))].sort((f,L)=>{const j=st(L.tone)-st(f.tone);return j!==0?j:Y(L.timestamp)-Y(f.timestamp)}).slice(0,8),R=ss.value;return s`
    ...
    ${R==="dispatch"?s`<${xd} />`:s`<div class="stats-grid">
      <${Se}
        label="Room State"
    ...
    <div class="overview-workbench">
      ...
      <div class="overview-column">
        <${w} title="Keeper Pressure" class="section">
          ...
          <div class="monitor-list">
            ${P.length===0?s`<div class="empty-state">No keeper pressure signals right now</div>`:P.slice(0,4).map(f=>{var L;return s`
                  <${os}
                    key=${f.keeper.name}
                    tone=${f.tone}
                    title=${f.keeper.name}
      ...
      <section class="card command-section">
        ...
        <div class="command-guide-card highlight command-next-step-card">
          ...
          ${(re=P==null?void 0:P.success_signals)!=null&&re.length?s`<div class="command-tag-row">
                ${P.success_signals.map(I=>s`<span class="command-tag ok">${I}</span>`)}
              </div>`:null}
        </div>
      ...
      <section class="card command-section">
        ...
        ${Js.value?s`<div class="empty-state">Loading CPv2 runbook…</div>`:ba.value?s`<div class="empty-state error">${ba.value}</div>`:s`
                ...
                ${H.length>0?s`<div class="command-doc-links">
                      ${H.map(I=>s`<span class="command-tag">${I.title}: ${I.path}</span>`)}
                    </div>`:null}
              `}
      </section>
    </div>
  ...
  `}function kp({source:t}){const e=Co(null),[n,a]=Ua(null);return rt(()=>{let i=!1;const o=e.current;return o?(o.innerHTML="",a(null),(async()=>{try{const l=await Zu(),{svg:p}=await l.render(`command-chain-${++Xu}`,t);if(i||!e.current)return;e.current.innerHTML=p}catch(l){if(i)return;a(l instanceof Error?l.message:"Mermaid render failed")}})(),()=>{i=!0,e.current&&(e.current.innerHTML="")}):void 0},[t]),s`
  ...
  `}function xp({overlay:t,selected:e,onSelect:n}){const a=t.operation.chain,i=t.runtime;return s`
    <button class="command-chain-item ${e?"selected":""}" onClick=${n}>
      ...
      <div class="command-tag-row">
        ...
        ${i?s`<span class="command-tag ${Zt(a==null?void 0:a.status)}">${Ni(i.progress)} progress</span>`:null}
      </div>
  ...
  `}function Cp({card:t}){const e=t.operation,n=`pause:${e.operation_id}`,a=`resume:${e.operation_id}`,i=`recall:${e.operation_id}`,o=e.chain;return s`
      ...
      <div class="command-action-row">
        ${o?s`
              <button
                ...
                onClick=${()=>{wi(e.operation_id),Ai("chains"),Rt("command",{surface:"chains",operation:e.operation_id})}}
              >
                Open Chain
              </button>
            `:null}
        ${e.source==="managed"&&e.status==="active"?s`
              ...
              <button class="control-btn ghost" disabled=${it(i)} onClick=${()=>te(()=>Hu(e.operation_id))}>
  ...
  `}function wp({card:t}){var n;const e=t.detachment;return s`
    <article class="command-card compact">
      <div class="command-card-head">
        <div>
  ...
  `}function Rp({row:t}){var l,p,$;const e=t.unit,n=`freeze:${e.unit_id}`,a=`kill:${e.unit_id}`,i=!!((l=e.policy)!=null&&l.frozen),o=!!((p=e.policy)!=null&&p.kill_switch),r=Math.round((t.utilization??0)*100);return s`
    <article class="command-card compact">
      ...
      <div class="command-action-row">
        <button class="control-btn ghost" disabled=${it(n)} onClick=${()=>te(()=>Gu(e.unit_id,!i))}>
  ...
  `}function Ep(){var l,p,$,m,d,v,c,y,S,T,P,K,E,N,R,X,H,Pt,mt,vt,B;const t=dr.value,e=op(),n=(l=t==null?void 0:t.provider)!=null&&l.runtime_blocker?"blocked":(p=t==null?void 0:t.provider)!=null&&p.provider_reachable?"ready":"check",a=(($=t==null?void 0:t.provider)==null?void 0:$.actual_slots)??((m=t==null?void 0:t.provider)==null?void 0:m.total_slots)??0,i=((d=t==null?void 0:t.provider)==null?void 0:d.expected_slots)??"n/a",o=((v=t==null?void 0:t.provider)==null?void 0:v.actual_ctx)??((c=t==null?void 0:t.provider)==null?void 0:c.ctx_per_slot)??0,r=((y=t==null?void 0:t.provider)==null?void 0:y.expected_ctx)??"n/a";return s`
    <div class="command-surface-grid">
      ...
      <section class="card command-section">
        ...
        ${t&&t.blockers.length>0?s`<div class="command-card-stack">
              ${t.blockers.map(M=>s`<${Pp} blocker=${M} />`)}
      ...
      <section class="card command-section">
        ...
        ${t&&t.recent_trace_events.length>0?s`<div class="command-trace-stack">
              ${t.recent_trace_events.map(M=>s`<${Cr} event=${M} />`)}
    ...
    <div class="command-surface-grid">
      <section class="card command-section">
        ...
        ${t&&t.operations.operations.length>0?s`<div class="command-card-stack">
              ${t.operations.operations.map(e=>s`<${Cp} card=${e} />`)}
      ...
      <section class="card command-section">
        ...
        <article class="command-guide-card ${Zt(t==null?void 0:t.connection.status)}">
          ...
          <div class="command-card-grid">
            ...
            <span>Last Event</span><span>${tt((c=t==null?void 0:t.summary)==null?void 0:c.last_history_event_at)}</span>
          </div>
        </article>
                ...
                <div class="command-chain-list">
                  ${e.map(H=>s`
                    <${xp}
                      ...
                      onSelect=${()=>wi(H.operation.operation_id)}
                    />
                  `)}
                </div>
        ...
        <div class="command-chain-history">
          ...
          ${t&&t.recent_history.length>0?s`
                <div class="command-card-stack">
                  ${t.recent_history.slice(0,6).map(H=>s`<${Sp} item=${H} />`)}
                </div>
  ...
  `}function zp(){const t=Ht.value;return s`
    <section class="card command-section">
  ...
  `}function Fp(){if(Ke.value==="summary")return s`<${yp} />`;if(!Ht.value)return s`<${bp} />`;switch(Ke.value){case"swarm":return s`<${Ep} />`;case"chains":return s`<${Mp} />`;case"topology":return s`<${Op} />`;case"alerts":return s`<${zp} />`;case"trace":return s`<${qp} />`;case"control":return s`<${jp} />`;case"operations":default:return s`<${Ip} />`}}function Kp(){return rt(()=>{Me(),ge(),ju(),kr()},[]),rt(()=>{if(nt.value.tab!=="command")return;const t=nt.value.params.surface,e=nt.value.params.operation;np(t)&&Ai(t),e&&wi(e)},[nt.value.tab,nt.value.params.surface,nt.value.params.operation]),rt(()=>{let t=null;const e=()=>{t||(t=window.setTimeout(()=>{t=null,Me(),ge()},250))},n=new EventSource(ap()),a=ep.map(i=>{const o=()=>e();return n.addEventListener(i,o),{type:i,handler:o}});return n.onerror=()=>{e()},()=>{a.forEach(({type:i,handler:o})=>{n.removeEventListener(i,o)}),n.close(),t&&window.clearTimeout(t)}},[]),s`
  ...
  `}const qn=_(null),Aa=_(!1),ae=_(null),W=_(!1),Ca=_([]);let Hp=1;function G(t){return typeof t=="object"&&t!==null&&!Array.isArray(t)}function D(t){return typeof t=="string"&&t.trim()!==""?t:void 0}function $t(t){return typeof t=="number"&&Number.isFinite(t)?t:void 0}function wr(t){return typeof t=="boolean"?t:void 0}function Up(t){return Array.isArray(t)?t.map(e=>typeof e=="string"?e.trim():"").filter(Boolean):[]}function we(t,e=[]){if(Array.isArray(t))return t;if(!G(t))return[];for(const n of e){const a=t[n];if(Array.isArray(a))return a}return[]}function Bp(t){return G(t)?{id:D(t.id),seq:$t(t.seq),from:D(t.from)??D(t.from_agent)??"system",content:D(t.content)??"",timestamp:D(t.timestamp)??new Date().toISOString(),type:D(t.type)}:null}function Wp(t){return G(t)?{room_id:D(t.room_id),current_room:D(t.current_room)??D(t.room),project:D(t.project),cluster:D(t.cluster),paused:wr(t.paused),pause_reason:D(t.pause_reason)??null,paused_by:D(t.paused_by)??null,paused_at:D(t.paused_at)??null}:{}}function oo(t){if(!G(t))return;const e=Object.entries(t).map(([n,a])=>{const i=D(a);return i?[n,i]:null}).filter(n=>n!==null);return e.length>0?Object.fromEntries(e):void 0}function Gp(t){if(!G(t))return null;const e=G(t.status)?t.status:void 0,n=G(t.summary)?t.summary:G(e==null?void 0:e.summary)?e.summary:void 0,a=G(t.session)?t.session:G(e==null?void 0:e.session)?e.session:void 0,i=D(t.session_id)??D(n==null?void 0:n.session_id)??D(a==null?void 0:a.session_id);if(!i)return null;const o=oo(t.report_paths)??oo(e==null?void 0:e.report_paths),r=we(t.recent_events,["events"]).filter(G);return{session_id:i,status:D(t.status)??D(n==null?void 0:n.status)??D(a==null?void 0:a.status),progress_pct:$t(t.progress_pct)??$t(n==null?void 0:n.progress_pct),elapsed_sec:$t(t.elapsed_sec)??$t(n==null?void 0:n.elapsed_sec),remaining_sec:$t(t.remaining_sec)??$t(n==null?void 0:n.remaining_sec),done_delta_total:$t(t.done_delta_total)??$t(n==null?void 0:n.done_delta_total),summary:n,team_health:G(t.team_health)?t.team_health:G(e==null?void 0:e.team_health)?e.team_health:void 0,communication_metrics:G(t.communication_metrics)?t.communication_metrics:G(e==null?void 0:e.communication_metrics)?e.communication_metrics:void 0,orchestration_state:G(t.orchestration_state)?t.orchestration_state:G(e==null?void 0:e.orchestration_state)?e.orchestration_state:void 0,cascade_metrics:G(t.cascade_metrics)?t.cascade_metrics:G(e==null?void 0:e.cascade_metrics)?e.cascade_metrics:void 0,report_paths:o,session:a,recent_events:r}}function Jp(t){if(!G(t))return null;const e=D(t.name);if(!e)return null;const n=G(t.context)?t.context:void 0;return{name:e,agent_name:D(t.agent_name),status:D(t.status),autonomy_level:D(t.autonomy_level),context_ratio:$t(t.context_ratio)??$t(n==null?void 0:n.context_ratio),generation:$t(t.generation),active_goal_ids:Up(t.active_goal_ids),last_autonomous_action_at:D(t.last_autonomous_action_at)??null,last_turn_ago_s:$t(t.last_turn_ago_s),model:D(t.model)??D(t.active_model)??D(t.primary_model)}}function Vp(t){if(!G(t))return null;const e=D(t.confirm_token)??D(t.token);return e?{confirm_token:e,actor:D(t.actor),action_type:D(t.action_type),target_type:D(t.target_type),target_id:D(t.target_id)??null,delegated_tool:D(t.delegated_tool),created_at:D(t.created_at),preview:t.preview}:null}function Qp(t){const e=G(t)?t:{};return{room:Wp(e.room),sessions:we(e.sessions,["items","sessions"]).map(Gp).filter(n=>n!==null),keepers:we(e.keepers,["items","keepers"]).map(Jp).filter(n=>n!==null),recent_messages:we(e.recent_messages,["messages"]).map(Bp).filter(n=>n!==null),pending_confirms:we(e.pending_confirms,["items","confirms"]).map(Vp).filter(n=>n!==null),available_actions:we(e.available_actions,["actions"]).filter(G).map(n=>({action_type:D(n.action_type)??"unknown",target_type:D(n.target_type)??"unknown",description:D(n.description),confirm_required:wr(n.confirm_required)}))}}function Kn(t){if(typeof t=="string")return t;if(t==null)return"";try{return JSON.stringify(t)}catch{return String(t)}}function ro(t){return t.target_id?`${t.target_type}:${t.target_id}`:t.target_type}function wa(t){Ca.value=[{...t,id:Hp++,at:new Date().toISOString()},...Ca.value].slice(0,20)}function Tr(t){return t.confirm_required?Kn(t.preview)||"Confirmation required":Kn(t.result)||Kn(t.executed_action)||Kn(t.delegated_tool_result)||t.status}async function He(){Aa.value=!0,ae.value=null;try{const t=await Al();qn.value=Qp(t)}catch(t){ae.value=t instanceof Error?t.message:"Failed to load operator snapshot"}finally{Aa.value=!1}}async function Yp(t){W.value=!0,ae.value=null;try{const e=await On(t);return wa({actor:t.actor,action_type:t.action_type,target_label:ro(t),outcome:e.confirm_required?"preview":"executed",message:Tr(e),delegated_tool:e.delegated_tool}),await He(),e}catch(e){const n=e instanceof Error?e.message:"Operator action failed";throw ae.value=n,wa({actor:t.actor,action_type:t.action_type,target_label:ro(t),outcome:"error",message:n}),e}finally{W.value=!1}}async function Xp(t,e){W.value=!0,ae.value=null;try{const n=await El(t,e);return wa({actor:t,action_type:"confirm",target_label:e,outcome:"confirmed",message:Tr(n),delegated_tool:n.delegated_tool}),await He(),n}catch(n){const a=n instanceof Error?n.message:"Operator confirmation failed";throw ae.value=a,wa({actor:t,action_type:"confirm",target_label:e,outcome:"error",message:a}),n}finally{W.value=!1}}const Nr="masc_dashboard_agent_name";function Zp(){var e,n,a;const t=new URLSearchParams(window.location.search);return((e=t.get("agent"))==null?void 0:e.trim())||((n=t.get("agent_name"))==null?void 0:n.trim())||((a=localStorage.getItem(Nr))==null?void 0:a.trim())||"dashboard"}const Ja=_(Zp()),dn=_(""),Ys=_("Operator pause"),un=_(""),Ta=_(""),Xs=_("2"),Na=_(""),Oe=_("note"),Ra=_(""),La=_(""),Pa=_(""),Zs=_("2"),ti=_("Operator stop request"),ei=_(""),pn=_("");function tm(t){const e=t.trim()||"dashboard";Ja.value=e,localStorage.setItem(Nr,e)}function cs(t){if(t==null)return"";if(typeof t=="string")return t;try{return JSON.stringify(t,null,2)}catch{return String(t)}}function em(t){return typeof t!="number"||!Number.isFinite(t)?"n/a":t<60?`${Math.round(t)}s ago`:t<3600?`${Math.round(t/60)}m ago`:`${Math.round(t/3600)}h ago`}function Da(t){return typeof t=="string"?t.trim().toLowerCase():""}function nm(t){var a;const e=Da(t.status);if(e==="paused")return"bad";const n=Da((a=t.team_health)==null?void 0:a.status);return n&&n!=="ok"&&n!=="healthy"&&n!=="green"||e&&e!=="active"&&e!=="running"&&e!=="ended"?"warn":"ok"}function lo(t){const e=Da(t.status);return e==="offline"||e==="inactive"||e==="error"?"bad":(t.context_ratio??0)>=.8||(t.last_turn_ago_s??0)>=3600?"warn":"ok"}async function he(t){const e=Ja.value.trim()||"dashboard";try{const n=await Yp({actor:e,action_type:t.action_type,target_type:t.target_type,target_id:t.target_id,payload:t.payload});return n.confirm_required?C("Confirmation queued","warning"):C(t.successMessage,"success"),n}catch(n){const a=n instanceof Error?n.message:"Operator action failed";return C(a,"error"),null}}async function co(){const t=dn.value.trim();if(!t)return;await he({action_type:"broadcast",target_type:"room",payload:{message:t},successMessage:"Broadcast sent"})&&(dn.value="")}async function am(){await he({action_type:"room_pause",target_type:"room",payload:{reason:Ys.value.trim()||"Operator pause"},successMessage:"Pause request sent"})}async function sm(){await he({action_type:"room_resume",target_type:"room",payload:{},successMessage:"Room resumed"})}async function im(){const t=un.value.trim();if(!t)return;await he({action_type:"task_inject",target_type:"room",payload:{title:t,description:Ta.value.trim()||"Injected from Ops tab",priority:Number.parseInt(Xs.value,10)||2},successMessage:"Task injection submitted"})&&(un.value="",Ta.value="")}async function om(){var o;const t=qn.value,e=Na.value||((o=t==null?void 0:t.sessions[0])==null?void 0:o.session_id)||"";if(!e){C("Select a team session first","warning");return}const n={turn_kind:Oe.value},a=Ra.value.trim();a&&(n.message=a),Oe.value==="task"&&(n.task_title=La.value.trim()||"Operator injected task",n.task_description=Pa.value.trim()||"Injected from Ops tab",n.task_priority=Number.parseInt(Zs.value,10)||2),await he({action_type:"team_turn",target_type:"team_session",target_id:e,payload:n,successMessage:"Team session updated"})&&(Ra.value="",Oe.value==="task"&&(La.value="",Pa.value=""))}async function rm(){var n;const t=qn.value,e=Na.value||((n=t==null?void 0:t.sessions[0])==null?void 0:n.session_id)||"";if(!e){C("Select a team session first","warning");return}await he({action_type:"team_stop",target_type:"team_session",target_id:e,payload:{reason:ti.value.trim()||"Operator stop request"},successMessage:"Team stop requested"})}async function lm(){var i;const t=qn.value,e=ei.value||((i=t==null?void 0:t.keepers[0])==null?void 0:i.name)||"",n=pn.value.trim();if(!e){C("Select a keeper first","warning");return}if(!n)return;await he({action_type:"keeper_msg",target_type:"keeper",target_id:e,payload:{message:n},successMessage:`Message sent to ${e}`})&&(pn.value="")}async function uo(t){const e=Ja.value.trim()||"dashboard";try{await Xp(e,t),C("Confirmation executed","success")}catch(n){const a=n instanceof Error?n.message:"Confirmation failed";C(a,"error")}}function cm(){var v;const t=qn.value,e=(t==null?void 0:t.room)??{},n=(t==null?void 0:t.sessions)??[],a=(t==null?void 0:t.keepers)??[],i=(t==null?void 0:t.pending_confirms)??[],o=(t==null?void 0:t.recent_messages)??[],r=n.find(c=>c.session_id===Na.value)??n[0]??null,l=a.find(c=>c.name===ei.value)??a[0]??null,p=n.filter(c=>nm(c)!=="ok"),$=a.filter(c=>lo(c)!=="ok"),m=o.slice(0,5),d=[{key:"room",label:"Room Gate",value:e.paused?"Paused":"Open",detail:e.paused?`Resume gate armed${e.pause_reason?` · ${e.pause_reason}`:""}`:"Commands are live and the room is accepting new work",tone:e.paused?"bad":"ok"},{key:"confirm",label:"Pending Confirm",value:i.length,detail:i.length>0?"Previewed operator actions are waiting for confirmation":"No confirm gates are currently blocking execution",tone:i.length>0?"warn":"ok"},{key:"session",label:"Session Risk",value:p.length,detail:p.length>0?"Team sessions need steering, stop, or checkpoint attention":"Team sessions look healthy from the operator snapshot",tone:p.some(c=>Da(c.status)==="paused")?"bad":p.length>0?"warn":"ok"},{key:"keeper",label:"Keeper Pressure",value:$.length,detail:$.length>0?"At least one keeper is stale, offline, or running hot":"Keepers are available for direct intervention",tone:$.some(c=>lo(c)==="bad")?"bad":$.length>0?"warn":"ok"}];return s`
          ...
          <section class="card ops-panel ops-studio-panel">
            ...
            <div class="ops-studio-group">
              ...
              <div class="control-row ops-split-row">
                <input
                  ...
                  disabled=${W.value}
                />
                <button class="control-btn ghost" onClick=${()=>{am()}} disabled=${W.value}>
                  Pause
                </button>
                <button class="control-btn ghost" onClick=${()=>{sm()}} disabled=${W.value}>
                  Resume
                </button>
              </div>
              ...
              <div class="control-row ops-split-row">
                ...
                <button class="control-btn" onClick=${()=>{im()}} disabled=${W.value||un.value.trim()===""}>
                  Inject
                </button>
              </div>
            </div>
            ...
            <div class="ops-studio-group">
              ...
              <div class="control-row ops-split-row">
                ...
                <button class="control-btn" onClick=${()=>{om()}} disabled=${W.value||!r}>
                  Apply
                </button>
              </div>
              <textarea
              ...
              <div class="control-row ops-split-row">
                <input
                  ...
                  disabled=${W.value||!r}
                />
                <button class="control-btn ghost" onClick=${()=>{rm()}} disabled=${W.value||!r}>
                  Stop
                </button>
              </div>
            </div>
            ...
            <div class="ops-studio-group">
              ...
              ></textarea>
              <div class="control-row">
                <button class="control-btn" onClick=${()=>{lm()}} disabled=${W.value||!l||pn.value.trim()===""}>
                  Send Keeper Message
                </button>
              </div>
            </div>
...
`))}</p>`)}return n}function ds(t){const e=[],n=/(`[^`]+`)|(\*\*[^*]+\*\*)|(\*[^*]+\*)|\[([^\]]+)\]\(([^)]+)\)/g;let a=0,i;for(;(i=n.exec(t))!==null;){if(i.index>a&&e.push(t.slice(a,i.index)),i[1]){const o=i[1].slice(1,-1);e.push(s`<code>${o}</code>`)}else if(i[2]){const o=i[2].slice(2,-2);e.push(s`<strong>${o}</strong>`)}else if(i[3]){const o=i[3].slice(1,-1);e.push(s`<em>${o}</em>`)}else i[4]&&i[5]&&e.push(s`<a href=${i[5]} target="_blank" rel="noopener">${i[4]}</a>`);a=i.index+i[0].length}return a<t.length&&e.push(t.slice(a)),e.length>0?e:[t]}const sn=_("posts"),ni=_([]),ai=_([]),mn=_(""),Ea=_(!1),vn=_(!1),Dn=_(""),Ia=_(null),Tt=_(null),si=_(!1),Xt=_(null),aa=_(null);async function Va(){Ea.value=!0,Dn.value="";try{const[t,e]=await Promise.all([gc(),$c()]);ni.value=t,ai.value=e,Xt.value=!0,aa.value=Date.now()}catch(t){Dn.value=t instanceof Error?t.message:"Failed to load council data",Xt.value=!1}finally{Ea.value=!1}}id(Va);async function po(){const t=mn.value.trim();if(t){vn.value=!0;try{const e=await hc(t);mn.value="",C(e!=null&&e.id?`Debate started: ${e.id}`:"Debate started","success"),await Va()}catch(e){const n=e instanceof Error?e.message:"Failed to start debate";C(n,"error")}finally{vn.value=!1}}}async function pm(t){Ia.value=t,si.value=!0,Tt.value=null;try{Tt.value=await yc(t)}catch(e){Dn.value=e instanceof Error?e.message:"Failed to load debate status",Tt.value=null}finally{si.value=!1}}const Rr=[{id:"hot",label:"Hot"},{id:"trending",label:"Trending"},{id:"recent",label:"Recent"},{id:"updated",label:"Updated"},{id:"discussed",label:"Discussed"}],sa=_(null),fn=_([]),$e=_(!1),fe=_(null),_n=_("");function mm(){var e,n;const t=new URLSearchParams(window.location.search);return((e=t.get("agent"))==null?void 0:e.trim())||((n=t.get("agent_name"))==null?void 0:n.trim())||"dashboard-user"}const vm=_(mm()),gn=_(!1);async function Li(t){fe.value=t,sa.value=null,fn.value=[],$e.value=!0;try{const e=await Fl(t);if(fe.value!==t)return;sa.value={id:e.id,author:e.author,title:e.title,content:e.content,tags:e.tags,votes:e.votes,vote_balance:e.vote_balance,comment_count:e.comment_count,created_at:e.created_at,updated_at:e.updated_at,flair:e.flair,hearth_count:e.hearth_count},fn.value=e.comments??[]}catch{fe.value===t&&(sa.value=null,fn.value=[])}finally{fe.value===t&&($e.value=!1)}}async function mo(t){const e=_n.value.trim();if(e){gn.value=!0;try{await Kl(t,vm.value,e),_n.value="",C("Comment posted","success"),await Li(t),qt()}catch{C("Failed to post comment","error")}finally{gn.value=!1}}}function fm(){const t=An.value;return s`
  ...
  `}function ii(){var e;const t=(e=se.value)==null?void 0:e.data_quality;return!t||t.board_contract_ok!==!1&&!t.last_sync_at?null:s`
  ...
  `}function gm({post:t}){const e=async(n,a)=>{a.stopPropagation();try{await Oo(t.id,n),qt()}catch{C("Failed to vote","error")}};return s`
  ...
  `}function ym({post:t}){fe.value!==t.id&&!$e.value&&Li(t.id);const e=async n=>{try{await Oo(t.id,n),qt()}catch{C("Failed to vote","error")}};return s`
    <div>
      ...
      <${w} title="Comments (${$e.value?"...":fn.value.length})">
  ...
  `}function Pr(){return Xt.value===null||Xt.value&&!aa.value?null:s`
  ...
  `}function xm(){const t=Xt.value===!1;return s`
    <div>
      <${Pr} />
      ...
      <${w} title=${Ia.value?`Debate Detail (${Ia.value})`:"Debate Detail"} class="section">
  ...
  `}function Sm(){const t=Xt.value===!1;return s`
    <div>
      <${Pr} />
  ...
  `}function Cm(){var a,i;const t=Be.value,e=wn.value,n=((i=(a=se.value)==null?void 0:a.data_quality)==null?void 0:i.board_contract_ok)===!1;return s`
    <div>
      <${ii} />
      <${oi} />
      <${fm} />
  ...
  `}function wm(){var i,o;const t=Be.value,e=nt.value.postId,n=((o=(i=se.value)==null?void 0:i.data_quality)==null?void 0:o.board_contract_ok)===!1,a=sn.value;if(rt(()=>{(a==="debates"||a==="voting")&&Va()},[a]),e){const r=t.find(l=>l.id===e)??(fe.value===e?sa.value:null);return!r&&fe.value!==e&&!$e.value&&Li(e),r?s`
          <${ii} />
          <${oi} />
          <${ym} post=${r} />
        `:s`
        ...
        `}return s`
    <${Am} />
    ${a==="debates"?s`<${xm} />`:a==="voting"?s`<${Sm} />`:s`<${Cm} />`}
  `}const Tm=40;function Nm({items:t,itemHeight:e,overscan:n=5,renderItem:a,getKey:i,className:o=""}){const r=Co(null),[l,p]=Ua({start:0,end:30}),$=t.length>Tm;if(rt(()=>{if(!$)return;const c=r.current;if(!c)return;let y=!1;const S=()=>{const{scrollTop:E,clientHeight:N}=c,R=Math.max(0,Math.floor(E/e)-n),X=Math.min(t.length,Math.ceil((E+N)/e)+n);p(H=>H.start===R&&H.end===X?H:{start:R,end:X})};let T=!1;const P=()=>{T||y||(T=!0,requestAnimationFrame(()=>{y||S(),T=!1}))},K=new ResizeObserver(()=>{y||S()});return S(),c.addEventListener("scroll",P,{passive:!0}),K.observe(c),()=>{y=!0,c.removeEventListener("scroll",P),K.disconnect()}},[$,t.length,e,n]),!$)return s`
      <div class=${o}>
        ${t.map((c,y)=>a(c,y))}
      </div>
  ...
  `}function iv(){const t=[...At.value].map(ev).sort((m,d)=>{const v=Ae(d.tone)-Ae(m.tone);if(v!==0)return v;const c=d.activeTaskCount-m.activeTaskCount;return c!==0?c:Qt(d.lastSignalAt)-Qt(m.lastSignalAt)}),e=[...Jt.value].map(nv).sort((m,d)=>{const v=Ae(d.tone)-Ae(m.tone);if(v!==0)return v;const c=(d.keeper.context_ratio??0)-(m.keeper.context_ratio??0);return c!==0?c:Qt(d.keeper.last_heartbeat)-Qt(m.keeper.last_heartbeat)}),n=t.filter(m=>m.state!=="offline"),a=t.filter(m=>m.state==="offline"),i=n.length,o=t.filter(m=>m.state==="working").length,r=t.filter(m=>m.lastSignalAt&&Date.now()-Qt(m.lastSignalAt)<=12e4).length,l=t.filter(m=>m.tone!=="ok"),p=e.filter(m=>m.tone!=="ok"),$=[...p.map(m=>({kind:"keeper",key:`keeper-${m.keeper.name}`,tone:m.tone,title:m.keeper.name,subtitle:`${m.note} · ${m.focus}`,timestamp:m.keeper.last_heartbeat??null,keeper:m.keeper})),...l.map(m=>({kind:"agent",key:`agent-${m.agent.name}`,tone:m.tone,title:m.agent.name,subtitle:`${m.note} · ${m.focus}`,timestamp:m.lastSignalAt,agent:m.agent}))].sort((m,d)=>{const v=Ae(d.tone)-Ae(m.tone);return v!==0?v:Qt(d.timestamp)-Qt(m.timestamp)}).slice(0,8);return s`
    <div class="agents-monitor">
      <div class="stats-grid">
      ...
      <div class="agents-workbench">
        <${w} title="Active Agents" class="section">
          <div class="monitor-section-head">
        ...
        <${w} title="Offline Agents" class="section">
          <div class="monitor-section-head">
  ...
  `}const Ma=_("all"),Oa=_("all"),di=Ct(()=>{let t=Cn.value;return Ma.value!=="all"&&(t=t.filter(e=>e.horizon===Ma.value)),Oa.value!=="all"&&(t=t.filter(e=>e.status===Oa.value)),t}),ov=Ct(()=>{const t={short:[],mid:[],long:[]};for(const e of di.value){const n=t[e.horizon];n&&n.push(e)}return t}),rv=Ct(()=>{const t=Array.from(Uo.value.values());return t.sort((e,n)=>e.status==="running"&&n.status!=="running"?-1:n.status==="running"&&e.status!=="running"?1:e.status==="interrupted"&&n.status!=="interrupted"?-1:n.status==="interrupted"&&e.status!=="interrupted"?1:n.elapsed_seconds-e.elapsed_seconds),t});function lv(t){return"★".repeat(Math.min(t,5))+"☆".repeat(Math.max(0,5-t))}function Pi(t){switch(t){case"short":return"Short-term";case"mid":return"Mid-term";case"long":return"Long-term";default:return t}}function ia(t){switch(t){case"short":return"#4ade80";case"mid":return"#f59e0b";case"long":return"#818cf8";default:return"#888"}}function cv(t){return t<60?`${Math.round(t)}s`:t<3600?`${Math.floor(t/60)}m ${Math.round(t%60)}s`:`${Math.floor(t/3600)}h ${Math.floor(t%3600/60)}m`}function go(t){return t.toFixed(4)}function $o(t){const e=t.current_metric-t.baseline_metric;return`${e>=0?"+":""}${e.toFixed(4)}`}function dv({goal:t}){return s`
    <div class="goal-row">
  ...
  `}function ps({horizon:t,items:e}){if(e.length===0)return null;const n=[...e].sort((a,i)=>i.priority-a.priority);return s`
    <${w} title="${Pi(t)} Goals (${e.length})" class="section">
      <div class="goal-list">
  ...
  `}function pv(){const t=Cn.value,e=t.filter(i=>i.status==="active").length,n=t.filter(i=>i.status==="completed").length,a={short:0,mid:0,long:0};for(const i of t)i.horizon in a&&a[i.horizon]++;return s`
  ...
  `}function fv(){const t=ov.value,e=rv.value,n=e.filter(l=>l.status==="running").length,a=e.filter(l=>l.recoverable).length,i=Cn.value.filter(l=>l.status==="active").length,o=Fs.value,r=o==="idle"?"No loop running":o==="error"?Ks.value??"MDAL snapshot unavailable":"Current loop snapshot";return s`
    <div>
      <div class="stats-grid">
        <div class="stat-card">
      ...
      ${Re.value&&Cn.value.length===0?s`<div class="loading-indicator">Loading goals...</div>`:di.value.length===0?s`<div class="empty-state">No goals match the current filters</div>`:s`
  ...
  `}const Te=_(""),vs=_("ability_check"),fs=_("10"),_s=_("12"),Un=_(""),Bn=_("idle"),Yt=_(""),Wn=_("keeper-late"),gs=_("player"),$s=_(""),St=_("idle"),hs=_(null),Gn=_(""),ys=_(""),bs=_("player"),ks=_(""),xs=_(""),Ss=_(""),$n=_("20"),As=_("20"),Cs=_(""),Jn=_("idle"),ui=_(null),Ir=_("overview"),ws=_("all"),Ts=_("all"),Ns=_("all"),_v=12e4,Qa=_(null),yo=_(Date.now());function gv(t,e){const n=e>0?t/e*100:0;return n>50?"hp-high":n>25?"hp-mid":"hp-low"}function $v(t,e){return e>0?Math.round(t/e*100):0}const hv={pragmatic:"리스크보다 확실한 이득을 우선합니다.",frugal:"자원 소모를 줄이고 효율을 챙깁니다.",impatient:"짧은 템포로 즉시 압박을 선호합니다.",stubborn:"한 번 정한 전술을 끝까지 밀어붙입니다.",protective:"아군 피해를 줄이는 선택을 우선합니다.","honor-bound":"약속과 규율을 지키는 행동에 보너스가 납니다.",intense:"집중 화력을 짧게 폭발시킵니다.",empathetic:"아군/약자 보호 쪽 선택 확률이 높아집니다.",fatalistic:"위험을 감수하는 고배수 선택을 탑니다.",suspicious:"함정/매복 경계 행동을 우선합니다.",precise:"단일 목표를 정확히 노리는 경향입니다.",vengeful:"직전 위협 대상에게 강하게 반응합니다.",aggressive:"공격적인 전진 행동을 우선합니다.",opportunistic:"빈틈이 열리면 즉시 추격합니다."},yv={supply_scan:"전장/자원 상태를 스캔해 약한 지점을 찾습니다.",ration_shift:"소모를 줄이고 지속 전투 능력을 확보합니다.",logistics_patch:"무너진 운영 라인을 빠르게 복구합니다.",frontline_shield:"전열에서 아군 피해를 흡수합니다.",oath_intercept:"핵심 타깃을 가로막아 위협을 차단합니다.",morale_anchor:"아군 안정도를 높여 붕괴를 막습니다.",omen_trace:"다음 위험 신호를 먼저 감지합니다.",arc_flash:"짧은 순간 광역 압박을 넣습니다.",ward_bloom:"방어 장막을 펼쳐 생존률을 올립니다.",mark_prey:"우선 제거 대상을 지정합니다.",silent_route:"은밀한 진입 경로를 확보합니다.",finisher_strike:"약화된 적을 마무리하는 일격입니다.",shadow_claw:"근접 급습으로 출혈 피해를 노립니다.",lunge:"짧은 돌진으로 전열을 흔듭니다."};function Vn(t){const e=t.trim();return e?e.split(/[_-]+/g).filter(n=>n.length>0).map(n=>n[0]?`${n[0].toUpperCase()}${n.slice(1)}`:n).join(" "):t}function bv(t){const e=t.trim().toLowerCase();return hv[e]??"행동 선택 가중치에 영향을 주는 성향입니다."}function kv(t){const e=t.trim().toLowerCase();return yv[e]??"상황에 따라 선택되는 전술 액션입니다."}function ee(t){return typeof t=="object"&&t!==null}function gt(t,e,n=""){const a=t[e];return typeof a=="string"?a:n}function Mt(t,e,n=0){const a=t[e];return typeof a=="number"&&Number.isFinite(a)?a:n}function En(t,e,n=!1){const a=t[e];return typeof a=="boolean"?a:n}const xv=new Set(["str","dex","con","int","wis","cha"]);function Sv(t){const e=t.trim();if(!e)return{};let n;try{n=JSON.parse(e)}catch(i){throw new Error(`능력치 JSON 파싱 실패: ${i instanceof Error?i.message:"invalid json"}`)}if(!ee(n))throw new Error('능력치 JSON은 object여야 합니다. 예: {"luck":7}');const a={};return Object.entries(n).forEach(([i,o])=>{const r=i.trim();if(r){if(typeof o=="number"&&Number.isFinite(o)){a[r]=Math.max(0,Math.trunc(o));return}if(typeof o=="string"){const l=Number.parseFloat(o.trim());if(Number.isFinite(l)){a[r]=Math.max(0,Math.trunc(l));return}}throw new Error(`능력치 '${r}' 값은 숫자여야 합니다.`)}}),a}function Av(t){const e=Number.parseInt(t.trim(),10);if(!Number.isFinite(e))return;const n=Math.max(1,e),a=Number.parseInt($n.value.trim(),10);Number.isFinite(a)&&a>n&&($n.value=String(n))}function pi(t){const n=(t.actor_name??t.actor??t.actor_id??"system").trim();return n===""?"system":n}function Cv(t){var n;return(((n=t.timestamp)==null?void 0:n.trim())??"")||"-"}function wv(t){Ir.value=t}function Mr(t){const e=Qa.value;return e==null||e<=t}function Tv(t){const e=Qa.value;return e==null||e<=t?0:Math.max(0,Math.ceil((e-t)/1e3))}function za(){Qa.value=null}function Or(t){return typeof window>"u"||typeof window.confirm!="function"?!0:window.confirm(t)}function Nv(t,e){Or(["관전 모드 잠금을 해제하시겠습니까?",`ROOM: ${t||"-"}`,`PHASE: ${e||"-"}`,"해제 시간: 120초 (시간 경과 또는 위험 액션 실행 후 자동 재잠금)"].join(`
`))&&(Qa.value=Date.now()+_v,C("조작 잠금이 120초 동안 해제되었습니다.","warning"))}function oa(t){return Mr(t)?(C("관전 모드 잠금 상태입니다. 먼저 잠금을 해제하세요.","warning"),!1):!0}function mi(t,e,n){return Or([`[위험 액션 확인] ${t}`,`ROOM: ${e||"-"}`,`PHASE: ${n||"-"}`,"이 액션은 즉시 실행되며 되돌리기 어렵습니다.","계속 진행하시겠습니까?"].join(`
`))}function Rv({hp:t,max:e}){const n=$v(t,e),a=gv(t,e);return s`
      ...
      ${t.map((n,a)=>{var i;return s`
        <div key=${a} class="trpg-event ${n.type??""}" role="listitem">
          <div class="trpg-event-meta-row">
            <span class="trpg-event-meta">${Cv(n)}</span>
  ...
  `}function Ev({events:t}){const e="__none__",n=ws.value,a=Ts.value,i=Ns.value,o=Array.from(new Set(t.map(pi).map(d=>d.trim()).filter(d=>d!==""))).sort((d,v)=>d.localeCompare(v)),r=Array.from(new Set(t.map(d=>(d.type??"").trim()).filter(d=>d!==""))).sort((d,v)=>d.localeCompare(v)),l=t.some(d=>(d.type??"").trim()===""),p=Array.from(new Set(t.map(d=>(d.phase??"").trim()).filter(d=>d!==""))).sort((d,v)=>d.localeCompare(v)),$=t.some(d=>(d.phase??"").trim()===""),m=t.filter(d=>{if(n!=="all"&&pi(d)!==n)return!1;const v=(d.type??"").trim(),c=(d.phase??"").trim();if(a===e){if(v!=="")return!1}else if(a!=="all"&&v!==a)return!1;if(i===e){if(c!=="")return!1}else if(i!=="all"&&c!==i)return!1;return!0});return s`
    <div class="trpg-story-toolbar">
      ...
      <button
        ...
        onClick=${()=>{ws.value="all",Ts.value="all",Ns.value="all"}}
      >
        필터 초기화
      </button>
  ...
  `}function Mv({state:t,nowMs:e}){var $;const n=Ut.value||(($=t.session)==null?void 0:$.room)||"",a=Bn.value,i=t.party??[];if(!i.find(m=>m.id===Te.value)&&i.length>0){const m=i[0];m&&(Te.value=m.id)}const r=async()=>{var d,v;if(!n){C("Room ID가 비어 있습니다.","error");return}if(!oa(e))return;const m=((d=t.current_round)==null?void 0:d.phase)??((v=t.session)==null?void 0:v.status)??"unknown";if(mi("라운드 실행",n,m)){Bn.value="running";try{const c=await sc(n);ui.value=c,Bn.value="ok";const y=ee(c.summary)?c.summary:null,S=y?En(y,"advanced",!1):!1,T=y?gt(y,"progress_reason",""):"";C(S?"라운드가 정상 진행되었습니다.":`라운드가 정체되었습니다${T?`: ${T}`:""}`,S?"success":"warning"),jt()}catch(c){ui.value=null,Bn.value="error";const y=c instanceof Error?c.message:"라운드 실행에 실패했습니다.";C(y,"error")}finally{za()}}},l=async()=>{var d,v;if(!n||!oa(e))return;const m=((d=t.current_round)==null?void 0:d.phase)??((v=t.session)==null?void 0:v.status)??"unknown";if(mi("턴 강제 진행",n,m))try{await rc(n),C("턴을 다음 단계로 이동했습니다.","success"),jt()}catch{C("턴 이동에 실패했습니다.","error")}finally{za()}},p=async()=>{if(!n||!oa(e))return;const m=Te.value.trim();if(!m){C("먼저 Actor를 선택하세요.","warning");return}const d=Number.parseInt(fs.value,10),v=Number.parseInt(_s.value,10);if(Number.isNaN(d)||Number.isNaN(v)){C("stat/dc는 숫자여야 합니다.","warning");return}const c=Number.parseInt(Un.value,10),y=Un.value.trim()===""||Number.isNaN(c)?void 0:c;try{await oc({roomId:n,actorId:m,action:vs.value.trim()||"ability_check",statValue:d,dc:v,rawD20:y}),C("주사위 판정을 기록했습니다.","success"),jt()}catch{C("주사위 판정 기록에 실패했습니다.","error")}};return s`
  ...
  `}function Ov({state:t}){var i;const e=Ut.value||((i=t.session)==null?void 0:i.room)||"",n=Jn.value,a=async()=>{if(!e){C("Room ID가 비어 있습니다.","warning");return}const o=Gn.value.trim(),r=ys.value.trim();if(!r&&!o){C("이름 또는 Actor ID를 입력하세요.","warning");return}const l=Number.parseInt($n.value.trim(),10),p=Number.parseInt(As.value.trim(),10),$=Number.isFinite(p)?Math.max(1,p):20,m=Number.isFinite(l)?Math.max(0,Math.min($,l)):$;let d={};try{d=Sv(Cs.value)}catch(v){C(v instanceof Error?v.message:"능력치 JSON 오류","error");return}Jn.value="spawning";try{const v=typeof crypto<"u"&&typeof crypto.randomUUID=="function"?`trpg_spawn_${crypto.randomUUID()}`:`trpg_spawn_${Date.now().toString(36)}_${Math.random().toString(36).slice(2,10)}`,c=await lc(e,{actor_id:o||void 0,name:r||void 0,role:bs.value,idempotencyKey:v,portrait:xs.value.trim()||void 0,background:Ss.value.trim()||void 0,hp:m,max_hp:$,alive:m>0,stats:Object.keys(d).length>0?d:void 0}),y=typeof c.actor_id=="string"?c.actor_id.trim():"";if(!y)throw new Error("생성 응답에 actor_id가 없습니다.");const S=ks.value.trim();S&&await cc(e,y,S),Te.value=y,Yt.value=y,o||(Gn.value=""),Jn.value="ok",C(`Actor 생성 완료: ${y}`,"success"),await jt()}catch(v){Jn.value="error",C(v instanceof Error?v.message:"Actor 생성에 실패했습니다.","error")}};return s`
    <div class="trpg-control-box">
      <div class="trpg-control-grid">
        <div class="trpg-control-field">
          <label>Name</label>
  ...
  `}function zv({state:t,nowMs:e}){var v;const n=Ut.value||((v=t.session)==null?void 0:v.room)||"",a=t.join_gate,i=hs.value,o=ee(i)?i:null,r=(t.party??[]).filter(c=>c.role!=="dm"),l=Yt.value.trim(),p=r.some(c=>c.id===l),$=p?l:l?"__manual__":"",m=async()=>{const c=Yt.value.trim(),y=Wn.value.trim();if(!n||!c){C("Room/Actor가 필요합니다.","warning");return}St.value="checking";try{const S=await dc(n,c,y||void 0);hs.value=S,St.value="ok",C("참가 가능 여부를 갱신했습니다.","success")}catch(S){St.value="error";const T=S instanceof Error?S.message:"참가 가능 여부 확인에 실패했습니다.";C(T,"error")}},d=async()=>{var P,K;const c=Yt.value.trim(),y=Wn.value.trim(),S=$s.value.trim();if(!n||!c||!y){C("Room/Actor/Keeper가 필요합니다.","warning");return}if(!oa(e))return;const T=((P=t.current_round)==null?void 0:P.phase)??((K=t.session)==null?void 0:K.status)??"unknown";if(mi("Mid-Join 승인 요청",n,T)){St.value="requesting";try{const E=await uc({room_id:n,actor_id:c,keeper_name:y,role:gs.value,...S?{name:S}:{}});hs.value=E;const N=ee(E)?En(E,"granted",!1):!1,R=ee(E)?gt(E,"reason_code",""):"";N?C("Mid-Join이 승인되었습니다.","success"):C(`Mid-Join이 거절되었습니다${R?`: ${R}`:""}`,"warning"),St.value=N?"ok":"error",jt()}catch(E){St.value="error";const N=E instanceof Error?E.message:"Mid-Join 요청에 실패했습니다.";C(N,"error")}finally{za()}}};return s`
    <div class="trpg-control-box">
      ...
      ${o?s`
          <div style="margin-top:8px; font-size:12px; color:#d1d5db;">
            ...
            ${gt(o,"reason_code","")?s`<span style="margin-left:8px;">Reason: ${gt(o,"reason_code","")}</span>`:null}
          </div>
        `:null}
    </div>
  ...
  `:null}function Hr(){const t=ui.value;if(!t)return s`<div class="empty-state" style="font-size:13px;">Run Round 결과가 아직 없습니다.</div>`;const e=t.summary,n=ee(e)?e:null,i=(Array.isArray(t.statuses)?t.statuses:[]).filter(ee).slice(-8),o=t.canon_check,r=ee(o)?o:null,l=r&&Array.isArray(r.warnings)?r.warnings.filter(R=>typeof R=="string").slice(0,3):[],p=r&&Array.isArray(r.violations)?r.violations.filter(R=>typeof R=="string").slice(0,3):[],$=n?En(n,"advanced",!1):!1,m=n?gt(n,"progress_reason",""):"",d=n?gt(n,"progress_detail",""):"",v=n?Mt(n,"player_successes",0):0,c=n?Mt(n,"player_required_successes",0):0,y=n?En(n,"dm_success",!1):!1,S=n?Mt(n,"timeouts",0):0,T=n?Mt(n,"unavailable",0):0,P=n?Mt(n,"reprompts",0):0,K=n?Mt(n,"npc_attacks",0):0,E=n?Mt(n,"keeper_timeout_sec",0):0,N=n?Mt(n,"roll_audit_count",0):0;return s`
    <div style="display:grid; gap:10px;">
      ...
      ${i.length>0?s`
          <div class="trpg-round-list">
            ${i.map(R=>{const X=gt(R,"status","unknown"),H=gt(R,"actor_id","-"),Pt=gt(R,"role","-"),mt=gt(R,"reason",""),vt=gt(R,"action_type",""),B=gt(R,"reply","");return s`
  ...
  `}function qv({state:t,nowMs:e}){var r,l,p;const n=Ut.value||((r=t.session)==null?void 0:r.room)||"",a=((l=t.current_round)==null?void 0:l.phase)??((p=t.session)==null?void 0:p.status)??"unknown",i=Mr(e),o=Tv(e);return s`
    <${w} title="조작 안전 잠금" style="margin-bottom:16px;">
      <div class="trpg-control-lock ${i?"locked":"unlocked"}">
        ...
        <div style="display:flex; gap:8px; margin-top:10px; flex-wrap:wrap;">
          ${i?s`<button class="trpg-run-btn recommend" onClick=${()=>Nv(n,a)}>잠금 해제 (120초)</button>`:s`<button class="trpg-run-btn secondary" onClick=${()=>{za(),C("조작 잠금으로 전환했습니다.","success")}}>즉시 다시 잠금</button>`}
        </div>
      </div>
    <//>
  ...
  `}const Di="masc_dashboard_agent_name";function Bv(){const t=new URLSearchParams(window.location.search),e=t.get("agent")??t.get("agent_name"),n=localStorage.getItem(Di);return e??n??"dashboard"}const ht=_(Bv()),hn=_(""),yn=_(""),qa=_(""),Ur=_(null),ja=_(null),bn=_(!1),Pe=_(!1),kn=_(!1),xn=_(!1),Fa=_(!1),Ka=_(!1),Ya=_(!1);function Ha(t){return typeof t!="number"||!Number.isFinite(t)?"??:00":`${String(Math.max(0,t)).padStart(2,"0")}:00`}function ra(t){if(typeof t!="number"||!Number.isFinite(t)||t<=0)return"unknown";if(t<60)return`${Math.round(t)}s`;if(t<3600)return`${Math.round(t/60)}m`;const e=Math.floor(t/3600),n=Math.round(t%3600/60);return n>0?`${e}h ${n}m`:`${e}h`}function Br(t){return!t||t.length===0?"none":t.join(", ")}function Wv(t){return t?t.enabled?t.quiet_active?`Quiet hours ${Ha(t.quiet_start)}-${Ha(t.quiet_end)} KST are active. Scheduled ticks may look asleep until the window ends; Poke Now bypasses only that quiet-hours gate.`:t.last_tick_ago_s==null?`Lodge is enabled and scheduled every ${ra(t.interval_s)}, but no tick has run yet in this runtime.`:t.last_skip_reason?`Lodge last skipped work because ${t.last_skip_reason}. Scheduled ticks still run every ${ra(t.interval_s)}.`:`Lodge ticks every ${ra(t.interval_s)}. Planner is ${t.use_planner?"on":"off"} and delegated LLM is ${t.delegate_llm?"on":"off"}.`:"Lodge automation is disabled. Manual poke will report the disabled state but will not revive a stopped runtime.":"Lodge runtime status is unavailable. Refresh the dashboard to inspect scheduling state."}async function Ge(){qe();try{await ne()}catch(t){console.warn("[control-dock] dashboard refresh failed",t)}}function Ei(t){const e=t.trim();ht.value=e,e&&localStorage.setItem(Di,e)}function Gv(t){const n=(t.split(`
`).find(a=>a.includes(" joined"))??t).match(/✅\s+(\S+)\s+joined/i);return(n==null?void 0:n[1])??null}async function vi(){const t=ht.value.trim();if(t){kn.value=!0;try{const e=await mc(t),n=Gv(e);n&&Ei(n),Ya.value=!0,await Ge(),C(`Joined as ${n??t}`,"success")}catch(e){const n=e instanceof Error?e.message:"Failed to join room";C(n,"error")}finally{kn.value=!1}}}async function Jv(){const t=ht.value.trim();if(t){xn.value=!0;try{await qo(t),Ya.value=!1,await Ge(),C(`Left room (${t})`,"success")}catch(e){const n=e instanceof Error?e.message:"Failed to leave room";C(n,"error")}finally{xn.value=!1}}}async function Vv(){const t=ht.value.trim();if(t)try{await qo(t)}catch{}localStorage.removeItem(Di),Ei("dashboard"),Ya.value=!1,await vi()}async function Qv(){const t=ht.value.trim();if(t){Fa.value=!0;try{await vc(t),await Ge(),C("Heartbeat sent","success")}catch(e){const n=e instanceof Error?e.message:"Failed to send heartbeat";C(n,"error")}finally{Fa.value=!1}}}async function bo(){const t=ht.value.trim(),e=hn.value.trim();if(!(!t||!e)){bn.value=!0;try{await zo(t,e),hn.value="",await Ge(),C("Broadcast sent","success")}catch(n){const a=n instanceof Error?n.message:"Failed to send broadcast";C(a,"error")}finally{bn.value=!1}}}async function Yv(){const t=yn.value.trim(),e=qa.value.trim()||"Created from dashboard";if(t){Pe.value=!0;try{await pc(t,e,1),yn.value="",qa.value="",await Ge(),C("Task created","success")}catch(n){const a=n instanceof Error?n.message:"Failed to create task";C(a,"error")}finally{Pe.value=!1}}}async function ko(){const t=ht.value.trim()||"dashboard";Ka.value=!0,ja.value=null;try{const e=await On({actor:t,action_type:"lodge_tick",target_type:"room",payload:{}}),n=$i(e.result);Ur.value=n,await Ge(),n!=null&&n.skipped_reason?C(n.skipped_reason,"warning"):C(n?`Poke finished: ${n.acted}/${n.checked} acted`:"Poke finished",n&&n.acted>0?"success":"warning")}catch(e){const n=e instanceof Error?e.message:"Failed to run Lodge poke";ja.value=n,C(n,"error")}finally{Ka.value=!1}}function Xv({runtime:t}){var i,o;const e=Ur.value??(t==null?void 0:t.last_tick_result)??null;if(ja.value)return s`<div class="control-result-box is-error">${ja.value}</div>`;if(!e)return s`<div class="control-status-copy">No poke result yet. The latest scheduled tick will appear here after the first run.</div>`;const n=((i=e.skipped_rows)==null?void 0:i.slice(0,3))??[],a=((o=e.passed_rows)==null?void 0:o.slice(0,3))??[];return s`
    <div class="control-result-box">
      <div class="control-inline-meta">
  ...
  `}function Zv(t){return t.find(n=>n.name===on.value)??t[0]??null}function tf(){var a,i;const t=Jt.value,e=((a=se.value)==null?void 0:a.lodge)??null,n=Zv(t);return rt(()=>{vi()},[]),rt(()=>{var r;const o=((r=t[0])==null?void 0:r.name)??"";if(!on.value&&o){Yn(o);return}on.value&&!t.some(l=>l.name===on.value)&&Yn(o)},[t.map(o=>o.name).join("|")]),s`
  ...
  `}function af(){switch(nt.value.tab){case"command":return s`<${Kp} />`;case"overview":return s`<${ao} />`;case"ops":return s`<${cm} />`;case"board":return s`<${wm} />`;case"agents":return s`<${iv} />`;case"goals":return s`<${fv} />`;case"trpg":return s`<${Uv} />`;default:return s`<${ao} />`}}function sf(){rt(()=>{nl(),Po(),ne();const n=rd();return ld(),()=>{dl(),n(),cd()}},[]),rt(()=>{const n=setInterval(()=>{const a=nt.value.tab;a==="command"?(Me(),ge()):a==="ops"?He():a==="board"?qt():a==="trpg"?jt():a==="goals"&&(Tn(),je())},15e3);return()=>{clearInterval(n)}},[]),rt(()=>{const n=nt.value.tab;n==="command"&&(Me(),ge()),n==="ops"&&He(),n==="board"&&qt(),n==="trpg"&&jt(),n==="goals"&&(Tn(),je())},[nt.value.tab]);const t=nt.value.tab,e=fi.find(n=>n.id===t);return s`
    <div class="app-shell">
      ...
      <div class="dashboard-layout">
        ...
        <main class="dashboard-main">
          ${Hs.value&&!Ft.value?s`<div class="loading-indicator">Loading dashboard...</div>`:s`<${af} />`}
        </main>
      </div>
