import{m as s,i as f,j as g,k as l,l as $,A as u,n as k,p as h,q as v,w,s as b}from"./index-D0qvPfou.js";import{S as d}from"./status-chip-Dhooy91w.js";import{t as _}from"./input-DZpazjxt.js";import{c}from"./vendor-Chwn_OlE.js";function p(e){return(e??"").trim().toLowerCase()}function S(e){switch(p(e)){case"truth":return"ok";case"recorded":return"";case"derived":case"fallback":case"narrative":case"judgment":return"warn";default:return""}}function i(e){const t=(e.label??"").trim();return t||p(e.kind)||"unknown"}function x({item:e}){const t=i(e),n=S(e.kind);return s`<${d} label=${t} tone=${n} />`}function A({items:e,className:t="mission-briefing-meta",testId:n}){const r=e.filter(a=>i(a).trim().length>0);return r.length===0?null:s`
