...
val pending_confirms_path : Room.config -> string
...
val raw_pending_confirms : Room.config -> pending_confirm list
val write_pending_confirms : Room.config -> pending_confirm list -> unit
