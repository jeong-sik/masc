(** Keeper_runner — Config, build, and run for OAS agent execution.
...
type cli_transport_overrides =
  Keeper_transport.cli_transport_overrides = {
  cwd : string option;
...
type label_resolution_error =
  Keeper_transport.label_resolution_error =
  | Invalid_model_label of string

let label_resolution_error_to_string =
  Keeper_transport.label_resolution_error_to_string

let label_resolution_error_to_sdk_error =
  Keeper_transport.label_resolution_error_to_sdk_error

let resolve_provider_config_of_label =
  Keeper_transport.resolve_provider_config_of_label

let invalid_runtime_config =
  Keeper_transport.invalid_runtime_config

let cli_model_override =
  Keeper_transport.cli_model_override

let provider_caps_of_config =
  Keeper_transport.provider_caps_of_config

let provider_supports_inline_tools =
  Keeper_transport.provider_supports_inline_tools

let provider_supports_runtime_mcp_lane =
  Keeper_transport.provider_supports_runtime_mcp_lane

let dedupe_preserve_order =
  Keeper_transport.dedupe_preserve_order

let public_mcp_tool_names_of_oas_tools =
  Keeper_transport.public_mcp_tool_names_of_oas_tools

let public_mcp_tool_requires_bound_actor =
  Keeper_transport.public_mcp_tool_requires_bound_actor

let runtime_mcp_tool_requires_bound_actor =
  Keeper_transport.runtime_mcp_tool_requires_bound_actor

let runtime_mcp_policy_with_masc_agent_name =
  Keeper_transport.runtime_mcp_policy_with_masc_agent_name

let cli_tool_a_can_auth_keeper_bound_runtime_mcp =
  Keeper_transport.cli_tool_a_can_auth_keeper_bound_runtime_mcp

let runtime_mcp_policy_for_provider =
  Keeper_transport.runtime_mcp_policy_for_provider

let public_mcp_tools_of_oas_tools =
  Keeper_transport.public_mcp_tools_of_oas_tools

let tool_names_are_public_mcp =
  Keeper_transport.tool_names_are_public_mcp

let public_mcp_runtime_policy_of_tool_names =
  Keeper_transport.public_mcp_runtime_policy_of_tool_names

let runtime_mcp_policy_of_tool_names =
  Keeper_transport.runtime_mcp_policy_of_tool_names

let provider_label =
  Keeper_transport.provider_label

let cli_tool_d_max_turns_hard_cap =
  Keeper_transport.cli_tool_d_max_turns_hard_cap

let provider_effective_max_turns =
  Keeper_transport.provider_effective_max_turns

let resolve_tool_lane_for_oas_tools =
  Keeper_transport.resolve_tool_lane_for_oas_tools

let make_per_call_switch_transport =
  Keeper_transport.make_per_call_switch_transport

let non_http_transport_of_provider =
  Keeper_transport.non_http_transport_of_provider
...
let run
  ...
  | exn ->
    ...
    (* Keep the typed internal-error envelope, but construct it locally so
       Keeper_runner does not depend on Cascade_error_classify. *)
