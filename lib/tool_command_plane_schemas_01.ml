      ...
      input_schema =
        object_schema ~required:[ "assigned_unit_id"; "objective" ]
          [
            ...
            ("detachment_session_id", string_prop "Optional legacy compatibility id that used to point at a supervised session runtime. Current ids may still use the established ts-* format.");
