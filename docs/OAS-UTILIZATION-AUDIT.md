...
OAS Pin Snapshot: dependency floor `0.118.0`, runtime pin `main@7a05d1d22201358473086e96b27253eebace7957`, declared base version `v0.118.1`
...
`masc-mcp` keeps the runtime pin ratcheted against upstream `main`, while the dependency floor tracks the pinned SDK declaration in `agent_sdk.opam`. Generated snapshot: runtime pin `main@7a05d1d22201358473086e96b27253eebace7957`, declared base version `v0.118.1`, dependency floor `0.118.0`.
