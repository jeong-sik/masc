...
[![agent_sdk](https://img.shields.io/badge/agent__sdk-%3E%3D%200.217.4-blue.svg)](https://github.com/jeong-sik/oas)
...
- **Goal + Task** — Goals and tasks are created via MCP tools, transitioned through states, and active goals are injected into the Keeper system prompt. Turns are driven by channels/events. (The legacy goal-loop OODA scheduler scripts were deleted on 2026-07-21 per RFC-0000:781 KILL; the Goal surface itself is RFC-0352 decision scope.)
...
| 4 | **Goal + Task** | (superseded) The goal-loop scheduler was deleted on 2026-07-21. Goal-driven wake can only be redesigned via the typed Scheduler after the RFC-0352 decision. | RFC-0352 |
