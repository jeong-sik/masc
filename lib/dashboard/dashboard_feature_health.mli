...
val lifecycle_to_status : Feature_flag_registry.lifecycle -> feature_status
val feature_to_health_item : Feature_flag_registry.flag -> feature_health_item
...
val count_by_status : feature_health_item list -> feature_status -> int

(** {1 JSON output} *)

val feature_health_item_to_json : feature_health_item -> Yojson.Safe.t
val overview_json : feature_health_item list -> Yojson.Safe.t
val features_by_category_json : feature_health_item list -> Yojson.Safe.t
