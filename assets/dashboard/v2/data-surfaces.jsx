...
/* ── COCKPIT — Command Map (cockpit-entrypoints.ts) ── */
const CP_MODES = [
  { id: 'cockpit', label: 'Cockpit', load: 'situational', layout: 'all-panels' },
  { id: 'code',    label: 'Code',    load: 'focused',     layout: 'editor-first' },
  { id: 'split',   label: 'Split',   load: 'comparative', layout: 'side-by-side' },
  { id: 'explode', label: 'Explode', load: 'exploratory', layout: 'graph-map' },
];

const CP_PLANES = [
  { id: 'work',      label: 'Work',      sum: 'Goals, tasks, and accountability routes' },
  { id: 'comms',     label: 'Comms',     sum: 'Board, message, and composer routes' },
  { id: 'observe',   label: 'Observe',   sum: 'Runtime, safety, audit, and cost routes' },
  { id: 'cognition', label: 'Cognition', sum: 'Keeper, decision, memory, and research routes' },
  { id: 'ide',       label: 'IDE',       sum: 'Source, review, diff, graph, and search routes' },
];

// label, caption(#tab / section / view / focus), coverage
const CP_ROUTES = {
  work: [
    ['Goal Horizon',          '#workspace / planning / goal-tree', 'covered'],
    ['Task Board',            '#workspace / planning / default', 'covered'],
    ['Goal Snapshot Diff',    '#workspace / planning / goal-tree / snapshot', 'backend-blocked'],
    ['Task Stale',            '#workspace / planning / default / stale', 'covered'],
    ['Accountability Ledger', '#workspace / planning / accountability-ledger', 'covered'],
    ['Accountability Matrix', '#workspace / planning / accountability-matrix', 'covered'],
  ],
  comms: [
    ['Board Feed',        '#workspace / board', 'covered'],
    ['Board Thread',      '#workspace / board / thread', 'covered'],
    ['Mention Inbox',     '#workspace / board / mention-inbox', 'covered'],
    ['Messages State Block', '#workspace / board / state-block', 'covered'],
    ['Composer Broadcast', '#command / operations / ops / broadcast', 'covered'],
    ['Composer Mention',   '#command / operations / ops / mention', 'covered'],
  ],
  observe: [
    ['Runtime',          '#monitoring / runtime', 'covered'],
    ['Runtime Deep Dive','#monitoring / runtime / inspector / deep-dive', 'covered'],
    ['Audit Ledger',     '#monitoring / runtime / audit', 'covered'],
    ['Audit By Actor',   '#monitoring / runtime / audit / actor', 'covered'],
    ['Safety',           '#command / operations / safety', 'covered'],
    ['Cost Per Agent',   '#monitoring / runtime / cost / agent', 'covered'],
    ['Cost Latency',     '#monitoring / runtime / cost / latency', 'covered'],
  ],
  cognition: [
    ['Keeper Cognition', '#monitoring / cognition / keeper', 'covered'],
    ['Keeper BDI',       '#monitoring / cognition / keeper / bdi', 'covered'],
    ['Token Stats',      '#monitoring / cognition / token-stats', 'covered'],
    ['Decisions Stream', '#monitoring / cognition / decisions', 'covered'],
    ['Memory Entries',   '#monitoring / cognition / memory / entries', 'covered'],
    ['Episodes Cards',   '#monitoring / cognition / episodes', 'covered'],
  ],
  ide: [
    ['Source',     '#code / ide-shell / source', 'covered'],
    ['Review · PR Thread', '#code / ide-shell / unified / review', 'covered'],
    ['Split Diff', '#code / ide-shell / split-diff', 'covered'],
    ['Search',     '#code / ide-shell / source / find', 'covered'],
    ['Terminal',   '#code / ide-shell / source / terminal', 'covered'],
  ],
};
...
const IDE_REPO = { name: 'masc-mcp', branch: 'fix/round-lock-reentry', dirty: 2 };
