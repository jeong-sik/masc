...
(** Run the full post-turn memory series.
    ...
    The post-turn entrypoint only wakes the durable Agent-Core consumer after
    its boundary is recorded. Official-client turns retain the direct input
    path until they have a durable source (masc #37207). Disabled or invalid
    configuration submits neither path. *)
