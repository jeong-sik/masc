...
let test_config_footer_names_child_hops () =
  ...
  check str "Config names its three off-ring children"
    "j/k:select / scroll  p:runtime.toml / models / params / prompts / presets / themes / voice  v:runtime.toml read status  9:Runtime  s:resources  t:tools  e:edit  E:advanced JSON  Enter:edit / use  x:default / clear  f:filter  n:new  u:restore  i:input  a:fragments / voice  o:assets  Esc:overview  r:reload  Tab:next"
