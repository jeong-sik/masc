...
type agent_reputation =
  ...
  ; accountability_risk_band : string
    (** low | medium | high from the accountability ledger *)
  ...
  ; accountability_keeper_name : string
    (** Keeper identity used for accountability lookup. *)
...
val agent_reputation_of_yojson : Yojson.Safe.t -> (agent_reputation, string) result
