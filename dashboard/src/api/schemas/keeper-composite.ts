...
const KeeperRunStateSchema = object({
  ...
  active_tool_count: optional(number()),
  queue_depth: optional(nullable(number())),
  queue_read_error: optional(nullable(string())),
...
export const KeeperCompositeSnapshotSchema = object({
  ...
  event_queue_depth: optional(nullable(number())),
  event_queue_read_error: optional(nullable(string())),
  board_attention_candidate_retired_epoch_residue: optional(nullable(string())),
  board_attention_candidate_epoch_read_error: optional(nullable(string())),
