...
describe('keeper workspace v2 (26) mobile contract', () => {
  ...
  it('keeps the turn inspector drawer phone-fullscreen from the runtime inspector', () => {
    ...
    expect(keeperTurnInspectorSource).toContain('class="ti-overlay"')
    expect(keeperTurnInspectorSource).toContain('class="ti-drawer"')
    expect(baseTurnInspectorRuleDecls('.ti-head h3').flex).toBe('none')
    expect(baseTurnInspectorRuleDecls('.ti-head .tid').overflow).toBe('hidden')
    expect(baseTurnInspectorRuleDecls('.ti-head .tid')['text-overflow']).toBe('ellipsis')
    expect(baseTurnInspectorRuleDecls('.ti-close').width).toBe('26px')
    expect(baseTurnInspectorRuleDecls('.ti-close').height).toBe('26px')
    expect(baseTurnInspectorRuleDecls('.ti-stat').padding).toBe('11px 14px')
    expect(baseTurnInspectorRuleDecls('.ti-stat .k')['font-size']).toBe('8.5px')
    expect(baseTurnInspectorRuleDecls('.ti-stat .v')['margin-top']).toBe('5px')
    expect(baseTurnInspectorRuleDecls('.ti-stat .v small')['font-size']).toBe('var(--fs-10)')
    expect(baseTurnInspectorRuleDecls('.ti-sub').padding).toBe('0 var(--sp-4) 12px')
    expect(baseTurnInspectorRuleDecls('.ti-chip')['font-size']).toBe('10.5px')
    expect(baseTurnInspectorRuleDecls('.ti-chip').padding).toBe('3px 9px')
    expect(baseTurnInspectorRuleDecls('.ti-chip .sub-k').margin).toBe('0')
    expect(baseTurnInspectorRuleDecls('.ti-chip .sub-k')['text-transform']).toBeUndefined()
    expect(baseTurnInspectorRuleDecls('.ti-tok').padding).toBe('13px var(--sp-4)')
    expect(baseTurnInspectorRuleDecls('.ti-tok-top .lbl')['font-size']).toBe('9.5px')
    expect(baseTurnInspectorRuleDecls('.ti-tok-top .ctxpct')['font-size']).toBe('var(--fs-11)')
    expect(baseTurnInspectorRuleDecls('.ti-tok-legend').gap).toBe('18px')
    expect(baseTurnInspectorRuleDecls('.ti-tok-legend')['margin-top']).toBe('9px')
    expect(baseTurnInspectorRuleDecls('.ti-tok-legend')['font-size']).toBe('11.5px')
    expect(baseTurnInspectorRuleDecls('.ti-tok-legend b')['font-weight']).toBe('600')
    expect(baseTurnInspectorRuleDecls('.ti-wf-row').gap).toBe('12px')
    expect(baseTurnInspectorRuleDecls('.ti-wf-lbl')['font-size']).toBe('12.5px')
    expect(baseTurnInspectorRuleDecls('.ti-wf-lbl').color).toBe('var(--color-fg-primary)')
    expect(baseTurnInspectorRuleDecls('.ti-wf-lbl .nm.mono')['font-size']).toBe('11.5px')
    expect(baseTurnInspectorRuleDecls('.ti-wf-dur')['font-size']).toBe('var(--fs-11)')
    expect(baseTurnInspectorRuleDecls('.ti-wf-foot')['margin-top']).toBe('12px')
    expect(baseTurnInspectorRuleDecls('.ti-wf-foot')['padding-top']).toBe('11px')
    expect(baseTurnInspectorRuleDecls('.ti-wf-foot')['font-size']).toBe('11.5px')
    expect(baseTurnInspectorRuleDecls('.ti-wf-foot b')['font-weight']).toBe('600')
    expect(baseTurnInspectorRuleDecls('.ti-wf-legend').gap).toBe('14px')
    expect(baseTurnInspectorRuleDecls('.ti-wf-legend span').gap).toBe('5px')
    expect(baseTurnInspectorRuleDecls('.ti-wf-legend span')['font-size']).toBe('10.5px')
    expect(baseTurnInspectorRuleDecls('.ti-copy').gap).toBe('5px')
    expect(baseTurnInspectorRuleDecls('.ti-copy')['font-size']).toBe('var(--fs-10)')
    expect(baseTurnInspectorRuleDecls('.ti-copy').padding).toBe('3px 9px')
    expect(baseTurnInspectorRuleDecls('.ti-code-h .cap')['font-size']).toBe('9.5px')
    expect(baseTurnInspectorRuleDecls('.ti-code-h .sz')['font-size']).toBe('9.5px')
    expect(baseTurnInspectorRuleDecls('.ti-code pre')['font-size']).toBe('11.5px')
    expect(baseTurnInspectorRuleDecls('.ti-code pre')['line-height']).toBe('1.62')
    expect(baseTurnInspectorRuleDecls('.ti-tool-h').gap).toBe('9px')
    expect(baseTurnInspectorRuleDecls('.ti-tool-h').padding).toBe('9px 12px')
    expect(baseTurnInspectorRuleDecls('.ti-tool-h .seq')['font-size']).toBe('9.5px')
    expect(baseTurnInspectorRuleDecls('.ti-tool-h .tnm')['font-size']).toBe('12.5px')
    expect(baseTurnInspectorRuleDecls('.ti-tool-h .pill')['font-size']).toBe('var(--fs-9)')
    expect(baseTurnInspectorRuleDecls('.ti-tool-h .pill').padding).toBe('2px 7px')
    expect(baseTurnInspectorRuleDecls('.ti-tool-h .lat')['font-size']).toBe('var(--fs-11)')
    expect(baseTurnInspectorRuleDecls('.ti-msg-h').padding).toBe('7px 11px')
    expect(baseTurnInspectorRuleDecls('.ti-msg-role')['font-size']).toBe('9.5px')
    expect(baseTurnInspectorRuleDecls('.ti-msg-h .who')['font-size']).toBe('10.5px')
    expect(baseTurnInspectorRuleDecls('.ti-msg-h .seq')['font-size']).toBe('9.5px')
    expect(baseTurnInspectorRuleDecls('.ti-msg-b')['font-size']).toBe('12.5px')
    expect(baseTurnInspectorRuleDecls('.ti-msg-b')['line-height']).toBe('1.62')
    expect(baseTurnInspectorRuleDecls('.ti-msg-b').color).toBe('var(--color-fg-primary)')
    expect(baseTurnInspectorRuleDecls('.ti-msg-b.mono')['font-size']).toBe('11.5px')
    expect(baseTurnInspectorRuleDecls('.ti-ctx-h .t')['font-size']).toBe('var(--fs-10)')
    expect(baseTurnInspectorRuleDecls('.ti-ctx-h .tok')['font-size']).toBe('var(--fs-10)')
    expect(baseTurnInspectorRuleDecls('.ti-ctx-card pre').padding).toBe('11px 13px')
    expect(baseTurnInspectorRuleDecls('.ti-ctx-card pre')['font-size']).toBe('11.5px')
    expect(baseTurnInspectorRuleDecls('.ti-ctx-card pre')['line-height']).toBe('1.62')
    expect(baseTurnInspectorRuleDecls('.ti-params').gap).toBe('7px')
    expect(baseTurnInspectorRuleDecls('.ti-param')['font-size']).toBe('var(--fs-11)')
    expect(baseTurnInspectorRuleDecls('.ti-param').padding).toBe('4px 11px')
    expect(baseTurnInspectorRuleDecls('.ti-param b')['font-weight']).toBe('600')
    expect(baseTurnInspectorRuleDecls('.ti-sec-h').gap).toBe('10px')
    expect(baseTurnInspectorRuleDecls('.ti-sec-h').margin).toBe('0 0 9px')
    expect(baseTurnInspectorRuleDecls('.ti-sec-h .n')['font-size']).toBe('var(--fs-10)')
    expect(shellMobileTurnInspectorRuleDecls('.ti-drawer').width).toBe('100vw')
    expect(shellMobileTurnInspectorRuleDecls('.ti-drawer')['max-width']).toBe('100vw')
    expect(shellMobileTurnInspectorRuleDecls('.ti-drawer').height).toBe('100dvh')
    expect(shellMobileTurnInspectorRuleDecls('.ti-drawer')['border-left']).toBe('0')
    expect(shellMobileTurnInspectorRuleDecls('.ti-head')['padding-top']).toContain(
      'env(safe-area-inset-top, 0px)',
    )
    expect(shellMobileTurnInspectorRuleDecls('.ti-head')['padding-left']).toContain(
      'env(safe-area-inset-left, 0px)',
    )
    expect(shellMobileTurnInspectorRuleDecls('.ti-head')['padding-right']).toContain(
      'env(safe-area-inset-right, 0px)',
    )
    expect(shellMobileTurnInspectorRuleDecls('.ti-sub')['padding-left']).toContain(
      'env(safe-area-inset-left, 0px)',
    )
    expect(shellMobileTurnInspectorRuleDecls('.ti-sub')['padding-right']).toContain(
      'env(safe-area-inset-right, 0px)',
    )
    expect(shellMobileTurnInspectorRuleDecls('.ti-tok')['padding-left']).toContain(
      'env(safe-area-inset-left, 0px)',
    )
    expect(shellMobileTurnInspectorRuleDecls('.ti-tok')['padding-right']).toContain(
      'env(safe-area-inset-right, 0px)',
    )
  })
