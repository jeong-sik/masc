...
Date: 2026-03-31
OAS Version: 0.100.4 floor (CI/runtime pin on `jeong-sik/oas@8b7e4d90676273db85ea210d78340274062a33b2`, latest tagged base `v0.100.6`)
...
`masc-mcp` keeps the runtime pin ratcheted against upstream `main`, while the dependency floor stays at the currently required install floor. As of this audit refresh, the runtime pin is aligned to `main@8b7e4d90676273db85ea210d78340274062a33b2`, the latest tagged base is `v0.100.6`, and the dependency floor remains `0.100.4`.
