...
- 날짜(ISO8601): 2026-08-31T04:22:32+09:00
- 작성자: Codex
- 결정 ID: docker-runtime-events-dir-r78
...
- 출처: OCaml 5.5 Runtime_events 공식 API/runtime tracing manual, issue #31998, r70 반례, r74 shared-PID 반례, r78 Linux artifacts
- 확인일시: 2026-08-31T04:22:32+09:00
- 신뢰도: High
...
- 5차: r78 fresh shared volume에서 12/12 unique runtime/current-ready를 확인했다. 11회 SIGKILL 뒤 ring 1개가 남고 다음 ready에서 정확히 1개의 새 ring으로 교체됐다. 마지막 clean exit 뒤 ring은 0개였다.
- 재현 결과: 동일 event filename 재사용 6회 모두 이전/새 ring SHA-256이 달랐다. 다른 filename 전환 5회는 stale cleanup log가 있었다. same-volume contender는 exit 1, token hash 불변이었고 shared PID file과 잘못된 takeover log는 0건이었다.
