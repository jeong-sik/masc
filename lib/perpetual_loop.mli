...
type loop_config = {
  initial_goal : string;
  model_cascade : Llm.model_spec list;   (** Ordered preference *)
  ...
  verifier_model : Llm.model_spec;        (** Cheap model for verification *)
...
val default_config :
  goal:string ->
  models:Llm.model_spec list ->
  ?verifier:Llm.model_spec ->
  ?session_dir:string ->
  unit -> loop_config
