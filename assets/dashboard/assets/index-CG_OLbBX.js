...
`).map(n=>n.trim()).filter(n=>n!=="")}async function tp(e,t=20){return _t("masc_task_history",{task_id:e,limit:t})}async function np(e){const t=await _t("masc_debate_start",{topic:e});try{return JSON.parse(t)}catch{return null}}async function sp(e){return Ka("fetchDebateStatus",async()=>{const t=encodeURIComponent(e),n=await se(`/api/v1/council/debates/${t}/summary`);if(!m(n))return null;const s=m(n.debate)?n.debate:n,a=k(s.id,"").trim(),i=k(s.topic,"").trim();return!a||!i?null:{debate:{id:a,topic:i,status:k(s.status,"open"),created_at:ue(s.created_at_iso??s.created_at),closed_at:ue(s.closed_at)},arguments:Array.isArray(n.arguments)?n.arguments.flatMap(l=>m(l)?[{index:U(l.index,0),agent:k(l.agent,"unknown"),position:k(l.position,"neutral"),content:k(l.content,""),evidence:De(l.evidence),reply_to:fe(l.reply_to)??null,mentions:De(l.mentions),archetype:F(l.archetype),created_at:ue(l.created_at)}]:[]):[],summary:{support_count:m(n.summary)?U(n.summary.support_count,0):U(n.support_count,0),oppose_count:m(n.summary)?U(n.summary.oppose_count,0):U(n.oppose_count,0),neutral_count:m(n.summary)?U(n.summary.neutral_count,0):U(n.neutral_count,0),total_arguments:m(n.summary)?U(n.summary.total_arguments,0):U(n.total_arguments,0),summary_text:m(n.summary)?k(n.summary.summary_text,""):k(n.summary_text,"")},context:$i(n.context),judgment:bl(n.judgment)}})}async function ap(e){return Ka("fetchConsensusSessionSummary",async()=>{const t=encodeURIComponent(e),n=await se(`/api/v1/council/sessions/${t}/summary`);if(!m(n)||!m(n.session))return null;const s=n.session,a=k(s.id,"").trim(),i=k(s.topic,"").trim();return!a||!i?null:{session:{id:a,topic:i,state:k(s.state,"open"),initiator:k(s.initiator,"system"),quorum:U(s.quorum,0),threshold:U(s.threshold,0),created_at:ue(s.created_at),closed_at:ue(s.closed_at)},votes:Array.isArray(n.votes)?n.votes.flatMap(l=>m(l)?[{agent:k(l.agent,"unknown"),decision:k(l.decision,"abstain"),reason:k(l.reason,""),timestamp:ue(l.timestamp),weight:typeof l.weight=="number"?l.weight:void 0,archetype:F(l.archetype)}]:[]):[],summary:{approve_count:m(n.summary)?U(n.summary.approve_count,0):0,reject_count:m(n.summary)?U(n.summary.reject_count,0):0,abstain_count:m(n.summary)?U(n.summary.abstain_count,0):0,quorum_met:m(n.summary)?ta(n.summary.quorum_met,!1):!1,result:m(n.summary)?F(n.summary.result):null},context:$i(n.context),judgment:bl(n.judgment)}})}function op(e,t,n){return _t("masc_keeper_msg",{name:e,message:t})}const ip=g(""),Ve=g({}),_e=g({}),Oo=g({}),qo=g({}),wo=g({}),Fo=g({}),Ye=g({});function de(e,t,n){e.value={...e.value,[t]:n}}function rp(e){var n;const t=(n=r(e))==null?void 0:n.toLowerCase();return t==="user"||t==="assistant"||t==="system"||t==="tool"?t:"other"}function lp(e){switch(e){case"user":return"User";case"assistant":return"Keeper";case"system":return"System";case"tool":return"Tool";default:return"Event"}}function Za(e,t){if(!Array.isArray(e))return[];const n=[];for(const s of e){if(!m(s))continue;const a=r(s.name);if(!a)continue;const i=r(s[t]);t==="summary"?n.push({name:a,summary:i}):n.push({name:a,reason:i})}return n}function cp(e){if(!m(e))return null;const t=r(e.name);return t?{name:t,trigger:r(e.trigger),outcome:r(e.outcome),summary:r(e.summary),reason:r(e.reason)}:null}function dp(e){const t=e.toLowerCase();return t.includes("graphql")?"graphql_error":t.includes("timeout")||t.includes("model")||t.includes("llm")||t.includes("api key")||t.includes("api_key")||t.includes("provider")?"llm_error":"unknown"}function up(e,t){return e==="offline"||e==="degraded"||e==="stale"?"Keeper is not in a healthy reply state. Probe or recover before relying on automation.":t==="quiet_hours"?"Lodge quiet hours are active. Direct messages still work, but scheduled social ticks may look asleep.":t==="min_gap"?"Keeper is inside its proactive cooldown window. Direct messages work now; autonomous check-ins will wait.":t==="never_started"?"Keeper metadata exists but no reply turn has been recorded yet.":"Keeper is reachable. Send a direct message for an immediate response."}function xl(e,t,n){return r(e)??up(t,n)}function Sl(e,t){return typeof e=="boolean"?e:t==="recover"}function na(e){if(!m(e))return null;const t=r(e.health_state),n=r(e.next_action_path),s=r(e.last_reply_status);return!t||!n||!s?null:{health_state:t,quiet_reason:r(e.quiet_reason)??null,next_action_path:n,last_reply_status:s,last_reply_at:le(e.last_reply_at)??null,last_reply_preview:r(e.last_reply_preview)??null,last_error:r(e.last_error)??null,next_eligible_at_s:d(e.next_eligible_at_s)??null,recoverable:Sl(e.recoverable,n),summary:xl(e.summary,t,r(e.quiet_reason)??null),keepalive_running:typeof e.keepalive_running=="boolean"?e.keepalive_running:void 0}}function Cl(e){return m(e)?{hour:d(e.hour),checked:d(e.checked)??0,acted:d(e.acted)??0,acted_names:w(e.acted_names),activity_report:r(e.activity_report),quiet_hours_overridden:j(e.quiet_hours_overridden),skipped_reason:r(e.skipped_reason),acted_rows:Za(e.acted_rows,"summary").map(t=>({name:t.name,summary:t.summary})),passed_rows:Za(e.passed_rows,"reason").map(t=>({name:t.name,reason:t.reason})),skipped_rows:Za(e.skipped_rows,"reason").map(t=>({name:t.name,reason:t.reason})),checkins:Array.isArray(e.checkins)?e.checkins.map(cp).filter(t=>t!==null):[]}:null}function pp(e){return m(e)?{enabled:j(e.enabled)??!1,interval_s:d(e.interval_s)??0,quiet_start:d(e.quiet_start),quiet_end:d(e.quiet_end),quiet_active:j(e.quiet_active),use_planner:j(e.use_planner),delegate_llm:j(e.delegate_llm),agent_count:d(e.agent_count),agents:w(e.agents),last_tick_ago_s:d(e.last_tick_ago_s)??null,last_tick_ago:r(e.last_tick_ago),total_ticks:d(e.total_ticks),total_checkins:d(e.total_checkins),last_skip_reason:r(e.last_skip_reason)??null,last_tick_result:Cl(e.last_tick_result),active_self_heartbeats:w(e.active_self_heartbeats)}:null}function mp(e){return m(e)?{status:e.status,diagnostic:na(e.diagnostic)}:null}function _p(e){return m(e)?{recovered:j(e.recovered)??!1,skipped_reason:r(e.skipped_reason)??null,before:na(e.before),after:na(e.after),down:e.down,up:e.up}:null}function vp(e,t){var $,L;if(!(e!=null&&e.name))return null;const n=r(($=e.agent)==null?void 0:$.status)??r(e.status)??"unknown",s=r((L=e.agent)==null?void 0:L.error)??null,a=e.presence_keepalive??!0,i=e.keepalive_running??!1,l=e.turn_count??0,c=e.last_turn_ago_s??null,p=e.proactive_enabled??!1,_=e.proactive_cooldown_sec??0,u=e.last_proactive_ago_s??null,f=p&&u!=null?Math.max(0,_-u):null,v=l<=0||c==null?"never":c>900?"stale":"fresh",h=typeof e.last_heartbeat=="string"&&e.last_heartbeat.trim()?e.last_heartbeat:null,b=s??(a&&!i?"keeper keepalive is not running":null),C=n==="offline"||n==="inactive"?"offline":b?"degraded":v==="stale"?"stale":v==="never"?"idle":"healthy",x=b?dp(b):t!=null&&t.quiet_active&&v!=="fresh"?"quiet_hours":a&&!i?"disabled":l<=0?"never_started":f!=null&&f>0?"min_gap":v==="fresh"||v==="stale"?"no_recent_activity":"unknown",S=C==="offline"||C==="degraded"||C==="stale"?"recover":x==="quiet_hours"?"manual_lodge_poke":x==="unknown"?"probe":"direct_message";return{health_state:C,quiet_reason:x,next_action_path:S,last_reply_status:v,last_reply_at:h,last_reply_preview:null,last_error:b,next_eligible_at_s:f!=null&&f>0?f:null,recoverable:Sl(void 0,S),summary:xl(void 0,C,x),keepalive_running:i}}function fp(e,t){if(!m(e))return null;const n=rp(e.role),s=r(e.content)??r(e.preview);if(!s)return null;const a=le(e.ts_unix)??le(e.timestamp);return{id:`${n}-${a??"entry"}-${t}`,role:n,label:lp(n),text:s,timestamp:a,delivery:"history"}}function gp(e,t,n){const s=m(n)?n:null,a=Array.isArray(s==null?void 0:s.history_tail)?s.history_tail.map((i,l)=>fp(i,l)).filter(i=>i!==null):[];return{name:e,diagnostic:na(s==null?void 0:s.diagnostic),history:a,rawText:t,rawStatus:n,loadedAt:new Date().toISOString()}}function cr(e,t){const n=_e.value[e]??[];_e.value={..._e.value,[e]:[...n,t].slice(-50)}}function $p(e,t){return e.role!==t.role||e.text!==t.text?!1:e.timestamp&&t.timestamp?e.timestamp===t.timestamp:!0}function hp(e,t){const s=(_e.value[e]??[]).filter(a=>a.delivery!=="history"&&!t.some(i=>$p(a,i)));_e.value={..._e.value,[e]:[...t,...s].slice(-50)}}function Ua(e,t){Ve.value={...Ve.value,[e]:t},hp(e,t.history)}function dr(e,t){const n=Ve.value[e];if(!n)return;const s=n.diagnostic??{health_state:"idle",next_action_path:"direct_message",last_reply_status:"unknown"};Ua(e,{...n,diagnostic:{...s,...t}})}async function hi(){try{await rs()}catch(e){console.warn("[keeper-runtime] dashboard refresh failed",e)}}function yp(e){ip.value=e.trim()}async function Al(e,t=!1){const n=e.trim();if(!n)return null;if(!t&&Ve.value[n])return Ve.value[n];de(Oo,n,!0),de(Ye,n,null);try{const s=await _t("masc_keeper_status",{name:n,fast:!1,include_context:!0,include_metrics_overview:!0,include_memory_bank:!1,include_history_tail:!0,include_compaction_history:!1,tail_turns:5,tail_messages:10});let a=null;try{a=JSON.parse(s)}catch{a=null}const i=gp(n,s,a);return Ua(n,i),i}catch(s){const a=s instanceof Error?s.message:`Failed to inspect ${n}`;return de(Ye,n,a),null}finally{de(Oo,n,!1)}}async function bp(e,t){const n=e.trim(),s=t.trim();if(!n||!s)return;const a=`local-${Date.now()}`;cr(n,{id:a,role:"user",label:"You",text:s,timestamp:new Date().toISOString(),delivery:"sending"}),de(qo,n,!0),de(Ye,n,null);try{const i=await op(n,s);_e.value={..._e.value,[n]:(_e.value[n]??[]).map(l=>l.id===a?{...l,delivery:"delivered"}:l)},cr(n,{id:`reply-${Date.now()}`,role:"assistant",label:n,text:i.trim()||"(empty reply)",timestamp:new Date().toISOString(),delivery:"delivered"}),dr(n,{last_reply_status:"delivered",last_reply_at:new Date().toISOString(),last_reply_preview:(i.trim()||"(empty reply)").slice(0,200),last_error:null}),await hi()}catch(i){const l=i instanceof Error?i.message:`Failed to send direct message to ${n}`;throw _e.value={..._e.value,[n]:(_e.value[n]??[]).map(c=>c.id===a?{...c,delivery:"error",error:l}:c)},dr(n,{last_reply_status:"error",last_error:l}),de(Ye,n,l),i}finally{de(qo,n,!1)}}async function kp(e,t){const n=e.trim();if(!n)return null;de(wo,n,!0),de(Ye,n,null);try{const s=await Ba({actor:t,action_type:"keeper_probe",target_type:"keeper",target_id:n,payload:{}}),a=mp(s.result),i=(a==null?void 0:a.diagnostic)??null;if(i){const l=Ve.value[n];Ua(n,{name:n,diagnostic:i,history:(l==null?void 0:l.history)??_e.value[n]??[],rawText:(l==null?void 0:l.rawText)??"",rawStatus:s.result,loadedAt:new Date().toISOString()})}return await hi(),i}catch(s){const a=s instanceof Error?s.message:`Failed to probe ${n}`;throw de(Ye,n,a),s}finally{de(wo,n,!1)}}async function xp(e,t){const n=e.trim();if(!n)return null;de(Fo,n,!0),de(Ye,n,null);try{const s=await Ba({actor:t,action_type:"keeper_recover",target_type:"keeper",target_id:n,payload:{}}),a=_p(s.result),i=(a==null?void 0:a.after)??null;if(i){const l=Ve.value[n];Ua(n,{name:n,diagnostic:i,history:(l==null?void 0:l.history)??_e.value[n]??[],rawText:(l==null?void 0:l.rawText)??"",rawStatus:s.result,loadedAt:new Date().toISOString()})}return await hi(),i}catch(s){const a=s instanceof Error?s.message:`Failed to recover ${n}`;throw de(Ye,n,a),s}finally{de(Fo,n,!1)}}function yt(e){return(e??"").trim().toLowerCase()}function he(e){const t=typeof e=="number"?e:Date.parse(e);return Number.isNaN(t)?0:t}function Ks(e,t=88){const n=e.replace(/\s+/g," ").trim();return n&&(n.length>t?`${n.slice(0,t-3)}...`:n)}function Cs(e){return typeof e!="number"||!Number.isFinite(e)||e<0?null:new Date(Date.now()-e*1e3).toISOString()}function bn(e){return e.last_heartbeat??Cs(e.last_turn_ago_s)??Cs(e.last_proactive_ago_s)??Cs(e.last_handoff_ago_s)??Cs(e.last_compaction_ago_s)}function Sp(e){const t=e.title.trim();return t||Ks(e.content)}function Cp(e){const t=e.generation??"?",n=typeof e.context_ratio=="number"&&Number.isFinite(e.context_ratio)?`${Math.round(e.context_ratio*100)}%`:"?";return e.last_heartbeat?`Heartbeat gen=${t} ctx=${n}`:`Keeper snapshot gen=${t} ctx=${n}`}function Ap(e,t,n,s,a={}){var L;const i=yt(e),l=t.filter(I=>yt(I.assignee)===i&&(I.status==="claimed"||I.status==="in_progress")).length,c=n.filter(I=>yt(I.from)===i).sort((I,P)=>he(P.timestamp)-he(I.timestamp))[0],p=s.filter(I=>yt(I.agent)===i||yt(I.author)===i).sort((I,P)=>he(P.timestamp)-he(I.timestamp))[0],_=(a.boardPosts??[]).filter(I=>yt(I.author)===i).sort((I,P)=>he(P.updated_at||P.created_at)-he(I.updated_at||I.created_at))[0],u=(a.keepers??[]).filter(I=>yt(I.name)===i&&bn(I)!==null).sort((I,P)=>he(bn(P)??0)-he(bn(I)??0))[0],f=c?he(c.timestamp):0,v=p?he(p.timestamp):0,h=_?he(_.updated_at||_.created_at):0,b=u?he(bn(u)??0):0,C=a.lastSeen?he(a.lastSeen):0,x=((L=a.currentTask)==null?void 0:L.trim())||(l>0?`${l} claimed tasks`:null);if(f===0&&v===0&&h===0&&b===0&&C===0)return{activeAssignedCount:l,lastActivityAt:null,lastActivityText:x};const $=[c?{timestamp:c.timestamp,ts:f,text:Ks(c.content)}:null,_?{timestamp:_.updated_at||_.created_at,ts:h,text:`Post: ${Ks(Sp(_))}`}:null,u?{timestamp:bn(u),ts:b,text:Cp(u)}:null,p?{timestamp:new Date(p.timestamp).toISOString(),ts:v,text:Ks(p.text)}:null].filter(I=>I!==null).sort((I,P)=>P.ts-I.ts)[0];return $&&$.ts>=C?{activeAssignedCount:l,lastActivityAt:$.timestamp,lastActivityText:$.text}:{activeAssignedCount:l,lastActivityAt:a.lastSeen??null,lastActivityText:x??"Presence heartbeat"}}const Qe=g([]),st=g([]),Ko=g([]),vt=g([]),re=g(null),Tp=g(null),Tl=g(null),Il=g([]),zl=g([]),Rl=g([]),Ll=g([]),Pl=g(null),yi=g([]),bi=g([]),Ml=g([]),Bo=g(new Map),Ha=g([]),Fn=g("recent"),At=g(!0),jl=g(null),Je=g(""),Qt=g([]),zn=g(!1),El=g(new Map),ki=g("unknown"),Xt=g(null),Uo=g(!1),Kn=g(!1),Ho=g(!1),Rn=g(!1),xi=g(null),sa=g(!1),aa=g(null),Nl=g(null),Wo=g(null),Ip=g(null),zp=g(null),Rp=g(null);Le(()=>Qe.value.filter(e=>e.status==="active"||e.status==="busy"||e.status==="listening"||e.status==="idle"));const Dl=Le(()=>{const e=st.value;return{todo:e.filter(t=>t.status==="todo"),inProgress:e.filter(t=>t.status==="in_progress"||t.status==="claimed"),done:e.filter(t=>t.status==="done")}}),Ol=Le(()=>{const e=new Map,t=st.value,n=Ko.value,s=ea.value,a=Ha.value,i=vt.value;for(const l of Qe.value)e.set(l.name.trim().toLowerCase(),Ap(l.name,t,n,s,{currentTask:l.current_task,lastSeen:l.last_seen,boardPosts:a,keepers:i}));return e});function Lp(e){var i;const t=((i=e.status)==null?void 0:i.toLowerCase())??"";if(t==="offline"||t==="inactive")return"offline";const n=e.metrics_series;if(!n||n.length===0)return"idle";const s=n[n.length-1];if(!s)return"idle";if(s.is_handoff)return"handoff-imminent";if(s.is_compaction)return"compacting";const a=s.context_ratio;return a>.85?"handoff-imminent":a>.7?"preparing":a>.5?"compacting":"active"}Le(()=>{const e=new Map;for(const t of vt.value)e.set(t.name,Lp(t));return e});const Pp=12e4;function Mp(e,t){const n=t.get(e.name);if(n!=null)return n;const s=e.last_heartbeat?Date.parse(e.last_heartbeat):Number.NaN;if(!Number.isNaN(s))return s;const a=[e.last_turn_ago_s,e.last_proactive_ago_s,e.last_handoff_ago_s,e.last_compaction_ago_s].find(i=>typeof i=="number"&&Number.isFinite(i)&&i>=0);return typeof a=="number"?Date.now()-a*1e3:null}Le(()=>{const e=Date.now(),t=new Set,n=Bo.value;for(const s of vt.value){const a=Mp(s,n);a!=null&&e-a>Pp&&t.add(s.name)}return t});function jp(e){return e==="dashboard_refresh"||e==="masc/dashboard_refresh"||e.startsWith("goal_")||e.startsWith("masc/goal_")||e.startsWith("mdal_")||e.startsWith("masc/mdal_")||e.startsWith("operator_")||e.startsWith("masc/operator_")||e.startsWith("command_plane_")||e.startsWith("masc/command_plane_")}function ql(e){const t=typeof e=="string"?e.toLowerCase():"";return t==="active"||t==="busy"||t==="listening"||t==="idle"||t==="inactive"||t==="offline"?t:t==="in_progress"||t==="claimed"?"busy":"offline"}function Ep(e){const t=typeof e=="string"?e.toLowerCase():"";return t==="todo"||t==="in_progress"||t==="claimed"||t==="done"||t==="cancelled"?t:t==="inprogress"?"in_progress":"todo"}function Np(e){if(!m(e))return null;const t=r(e.name);return t?{name:t,agent_type:r(e.agent_type),status:ql(e.status),current_task:r(e.current_task)??null,joined_at:r(e.joined_at),last_seen:r(e.last_seen),capabilities:w(e.capabilities),emoji:r(e.emoji),koreanName:r(e.koreanName)??r(e.korean_name),model:r(e.model),traits:w(e.traits),interests:w(e.interests),activityLevel:d(e.activityLevel)??d(e.activity_level),primaryValue:r(e.primaryValue)??r(e.primary_value)}:null}function Dp(e){if(!m(e))return null;const t=r(e.id),n=r(e.title);return!t||!n?null:{id:t,title:n,status:Ep(e.status),priority:d(e.priority),assignee:r(e.assignee),description:r(e.description),created_at:r(e.created_at),updated_at:r(e.updated_at)}}function Op(e){if(!m(e))return null;const t=r(e.from)??r(e.from_agent)??"system",n=r(e.content)??"",s=r(e.timestamp)??new Date().toISOString();return{id:r(e.id),seq:d(e.seq),from:t,content:n,timestamp:s,type:r(e.type)}}function Si(e){const t=typeof e=="string"?e.toLowerCase():"";return t==="ok"||t==="warn"||t==="bad"?t:"ok"}function qp(e){return m(e)?{active_sessions:d(e.active_sessions),blocked_sessions:d(e.blocked_sessions),active_operations:d(e.active_operations),blocked_operations:d(e.blocked_operations),runtime_pressure:d(e.runtime_pressure),worker_alerts:d(e.worker_alerts),continuity_alerts:d(e.continuity_alerts),priority_items:d(e.priority_items),todo_tasks:d(e.todo_tasks),claimed_tasks:d(e.claimed_tasks),running_tasks:d(e.running_tasks),done_tasks:d(e.done_tasks),cancelled_tasks:d(e.cancelled_tasks),keepers:d(e.keepers)}:null}function at(e){if(!m(e))return null;const t=r(e.surface),n=r(e.label),s=r(e.target_type),a=r(e.target_id),i=r(e.focus_kind);return!t||!n||!s||!a||!i?null:{surface:t==="command"?"command":"intervene",label:n,target_type:s,target_id:a,focus_kind:i,operation_id:r(e.operation_id)??null,command_surface:r(e.command_surface)??null}}function wp(e){if(!m(e))return null;const t=r(e.id),n=r(e.kind),s=r(e.summary),a=r(e.target_type),i=r(e.target_id);return!t||!s||!a||!i||n!=="session"&&n!=="operation"?null:{id:t,kind:n,severity:Si(e.severity),status:r(e.status),summary:s,target_type:a,target_id:i,linked_session_id:r(e.linked_session_id)??null,linked_operation_id:r(e.linked_operation_id)??null,last_seen_at:r(e.last_seen_at)??null,top_handoff:at(e.top_handoff),intervene_handoff:at(e.intervene_handoff),command_handoff:at(e.command_handoff)}}function Fp(e){if(!m(e))return null;const t=r(e.session_id),n=r(e.goal);return!t||!n?null:{session_id:t,goal:n,room:r(e.room)??null,status:r(e.status),health:r(e.health),member_names:w(e.member_names),linked_operation_id:r(e.linked_operation_id)??null,linked_detachment_id:r(e.linked_detachment_id)??null,runtime_blocker:r(e.runtime_blocker)??null,worker_gap_summary:r(e.worker_gap_summary)??null,last_activity_at:r(e.last_activity_at)??null,last_activity_summary:r(e.last_activity_summary)??null,communication_summary:r(e.communication_summary)??null,active_count:d(e.active_count),required_count:d(e.required_count),top_handoff:at(e.top_handoff),intervene_handoff:at(e.intervene_handoff),command_handoff:at(e.command_handoff)}}function Kp(e){if(!m(e))return null;const t=r(e.operation_id),n=r(e.objective);return!t||!n?null:{operation_id:t,objective:n,status:r(e.status),stage:r(e.stage)??null,assigned_unit_id:r(e.assigned_unit_id)??null,assigned_unit_label:r(e.assigned_unit_label)??null,linked_session_id:r(e.linked_session_id)??null,linked_detachment_id:r(e.linked_detachment_id)??null,blocker_summary:r(e.blocker_summary)??null,search_status:r(e.search_status)??null,next_tool:r(e.next_tool)??null,updated_at:r(e.updated_at)??null,top_handoff:at(e.top_handoff),command_handoff:at(e.command_handoff)}}function ur(e){if(!m(e))return null;const t=r(e.name)??r(e.agent_name),n=r(e.note),s=r(e.focus),a=r(e.state);return!t||!n||!s||a!=="working"&&a!=="watching"&&a!=="quiet"&&a!=="offline"?null:{name:t,agent_name:r(e.agent_name),status:r(e.status),tone:Si(e.tone),state:a,note:n,focus:s,last_signal_at:r(e.last_signal_at)??null,active_task_count:d(e.active_task_count),related_session_id:r(e.related_session_id)??null,related_operation_id:r(e.related_operation_id)??null,emoji:r(e.emoji),korean_name:r(e.korean_name),model:r(e.model)??null,recent_output_preview:r(e.recent_output_preview)??null,recent_event:r(e.recent_event)??null}}function Bp(e){return m(e)?{checked:d(e.checked),acted:d(e.acted),passed:d(e.passed),skipped:d(e.skipped),failed:d(e.failed),last_tick_at:r(e.last_tick_at)??null,last_skip_reason:r(e.last_skip_reason)??null,activity_report:r(e.activity_report)??null}:null}function Up(e){if(!m(e))return null;const t=r(e.agent_name),n=r(e.outcome);return!t||!n?null:{agent_name:t,trigger:r(e.trigger)??null,outcome:n,summary:r(e.summary)??null,reason:r(e.reason)??null,allowed_tool_names:w(e.allowed_tool_names)??[],used_tool_names:w(e.used_tool_names)??[],used_tool_call_count:d(e.used_tool_call_count)??null,action_kind:r(e.action_kind)??"none",tool_audit_source:r(e.tool_audit_source)??null,tool_audit_at:r(e.tool_audit_at)??null,checked_at:r(e.checked_at)??null,decision_reason:r(e.decision_reason)??null,worker_name:r(e.worker_name)??null,failure_reason:r(e.failure_reason)??null}}function Hp(e){if(!m(e))return null;const t=r(e.name),n=r(e.note),s=r(e.focus),a=r(e.state);return!t||!n||!s||a!=="healthy"&&a!=="warning"&&a!=="critical"?null:{name:t,agent_name:r(e.agent_name)??null,status:r(e.status),tone:Si(e.tone),state:a,note:n,focus:s,last_signal_at:r(e.last_signal_at)??null,last_autonomous_action_at:r(e.last_autonomous_action_at)??null,generation:d(e.generation),turn_count:d(e.turn_count),context_ratio:d(e.context_ratio)??null,continuity:r(e.continuity)??null,lifecycle:r(e.lifecycle)??null,related_session_id:r(e.related_session_id)??null,model:r(e.model)??null,emoji:r(e.emoji),korean_name:r(e.korean_name),skill_reason:r(e.skill_reason)??null,recent_input_preview:r(e.recent_input_preview)??null,recent_output_preview:r(e.recent_output_preview)??null,recent_tool_names:w(e.recent_tool_names)??[],allowed_tool_names:w(e.allowed_tool_names)??[],latest_tool_names:w(e.latest_tool_names)??[],latest_tool_call_count:d(e.latest_tool_call_count)??null,tool_audit_source:r(e.tool_audit_source)??null,tool_audit_at:r(e.tool_audit_at)??null,last_proactive_preview:r(e.last_proactive_preview)??null,continuity_summary:r(e.continuity_summary)??null,skill_route_summary:r(e.skill_route_summary)??null}}function pr(e){if(typeof e.seq=="number"&&Number.isFinite(e.seq))return e.seq;const t=Date.parse(e.timestamp);return Number.isNaN(t)?0:t}function Wp(e,t){if(t.length===0)return e;const n=new Map;for(const s of e){const a=typeof s.seq=="number"?`seq:${s.seq}`:`ts:${s.timestamp}|from:${s.from}|content:${s.content}`;n.set(a,s)}for(const s of t){const a=typeof s.seq=="number"?`seq:${s.seq}`:`ts:${s.timestamp}|from:${s.from}|content:${s.content}`;n.set(a,s)}return[...n.values()].sort((s,a)=>pr(s)-pr(a)).slice(-500)}function Gp(e){return Array.isArray(e)?e.map(t=>{if(!m(t))return null;const n=d(t.ts_unix);if(n==null)return null;const s=m(t.handoff)?t.handoff:null;return{ts:n,context_ratio:d(t.context_ratio)??0,context_tokens:d(t.context_tokens)??0,context_max:d(t.context_max)??0,latency_ms:d(t.latency_ms)??0,generation:d(t.generation)??0,channel:typeof t.channel=="string"?t.channel:"turn",is_handoff:s!=null&&t.handoff_performed===!0,is_compaction:t.compacted===!0,compaction_saved_tokens:d(t.compaction_saved_tokens)??0,compaction_trigger:typeof t.compaction_trigger=="string"?t.compaction_trigger:null,model_used:typeof t.model_used=="string"?t.model_used:"",cost_usd:d(t.cost_usd)??0,handoff_to_model:s&&typeof s.to_model=="string"?s.to_model:null,handoff_new_generation:s?d(s.new_generation)??null:null}}).filter(t=>t!==null):[]}function mr(e){if(!m(e))return null;const t=r(e.health_state),n=r(e.next_action_path),s=r(e.last_reply_status);if(!t||!n||!s)return null;const a=r(e.quiet_reason)??null,i=r(e.summary)??(t==="offline"||t==="degraded"||t==="stale"?"Keeper is not in a healthy reply state. Probe or recover before relying on automation.":a==="quiet_hours"?"Lodge quiet hours are active. Direct messages still work, but scheduled social ticks may look asleep.":a==="min_gap"?"Keeper is inside its proactive cooldown window. Direct messages work now; autonomous check-ins will wait.":a==="never_started"?"Keeper metadata exists but no reply turn has been recorded yet.":"Keeper is reachable. Send a direct message for an immediate response.");return{health_state:t,quiet_reason:a,next_action_path:n,last_reply_status:s,last_reply_at:le(e.last_reply_at)??r(e.last_reply_at)??null,last_reply_preview:r(e.last_reply_preview)??null,last_error:r(e.last_error)??null,next_eligible_at_s:d(e.next_eligible_at_s)??null,recoverable:typeof e.recoverable=="boolean"?e.recoverable:n==="recover",summary:i,keepalive_running:typeof e.keepalive_running=="boolean"?e.keepalive_running:void 0}}function Jp(e,t){return(Array.isArray(e)?e:m(e)&&Array.isArray(e.keepers)?e.keepers:[]).map(s=>{if(!m(s))return null;const a=m(s.agent)?s.agent:null,i=m(s.context)?s.context:null,l=m(s.metrics_window)?s.metrics_window:void 0,c=r(s.name);if(!c)return null;const p=d(s.context_ratio)??d(i==null?void 0:i.context_ratio),_=r(s.status)??r(a==null?void 0:a.status)??"offline",u=ql(_),f=r(s.model)??r(s.active_model)??r(s.primary_model),v=w(s.skill_secondary),h=i?{source:r(i.source),context_ratio:d(i.context_ratio),context_tokens:d(i.context_tokens),context_max:d(i.context_max),message_count:d(i.message_count),has_checkpoint:typeof i.has_checkpoint=="boolean"?i.has_checkpoint:void 0}:void 0,b=a?{name:r(a.name),exists:typeof a.exists=="boolean"?a.exists:void 0,error:r(a.error),agent_type:r(a.agent_type),status:r(a.status),current_task:r(a.current_task)??null,joined_at:r(a.joined_at),last_seen:r(a.last_seen),last_seen_ago_s:d(a.last_seen_ago_s),capabilities:w(a.capabilities),is_zombie:typeof a.is_zombie=="boolean"?a.is_zombie:void 0}:void 0,C=Gp(s.metrics_series),x={name:c,runtime_class:s.runtime_class==="persistent_agent"?"persistent_agent":"resident_keeper",desired:typeof s.desired=="boolean"?s.desired:void 0,resident_registered:typeof s.resident_registered=="boolean"?s.resident_registered:void 0,reconcile_status:r(s.reconcile_status)??null,emoji:r(s.emoji),koreanName:r(s.koreanName)??r(s.korean_name),agent_name:r(s.agent_name),trace_id:r(s.trace_id),model:f,primary_model:r(s.primary_model),active_model:r(s.active_model),next_model_hint:r(s.next_model_hint)??null,status:u,presence_keepalive:typeof s.presence_keepalive=="boolean"?s.presence_keepalive:void 0,presence_keepalive_sec:d(s.presence_keepalive_sec),keepalive_running:typeof s.keepalive_running=="boolean"?s.keepalive_running:void 0,proactive_enabled:typeof s.proactive_enabled=="boolean"?s.proactive_enabled:void 0,proactive_idle_sec:d(s.proactive_idle_sec),proactive_cooldown_sec:d(s.proactive_cooldown_sec),last_heartbeat:r(s.last_heartbeat)??r(a==null?void 0:a.last_seen),generation:d(s.generation),turn_count:d(s.turn_count)??d(s.total_turns),keeper_age_s:d(s.keeper_age_s),last_turn_ago_s:d(s.last_turn_ago_s),last_handoff_ago_s:d(s.last_handoff_ago_s),last_compaction_ago_s:d(s.last_compaction_ago_s),last_proactive_ago_s:d(s.last_proactive_ago_s),last_proactive_preview:r(s.last_proactive_preview)??null,context_ratio:p,context_tokens:d(s.context_tokens)??d(i==null?void 0:i.context_tokens),context_max:d(s.context_max)??d(i==null?void 0:i.context_max),context_source:r(s.context_source)??r(i==null?void 0:i.source),context:h,traits:w(s.traits),interests:w(s.interests),primaryValue:r(s.primaryValue)??r(s.primary_value),activityLevel:d(s.activityLevel)??d(s.activity_level),memory_recent_note:r(s.memory_recent_note)??null,recent_input_preview:r(s.recent_input_preview)??null,recent_output_preview:r(s.recent_output_preview)??null,recent_tool_names:w(s.recent_tool_names)??[],allowed_tool_names:w(s.allowed_tool_names)??[],latest_tool_names:w(s.latest_tool_names)??[],latest_tool_call_count:d(s.latest_tool_call_count)??null,tool_audit_source:r(s.tool_audit_source)??null,tool_audit_at:le(s.tool_audit_at)??r(s.tool_audit_at)??null,conversation_tail_count:d(s.conversation_tail_count),k2k_count:d(s.k2k_count),handoff_count_total:d(s.handoff_count_total)??d(s.trace_history_count),compaction_count:d(s.compaction_count),last_compaction_saved_tokens:d(s.last_compaction_saved_tokens),diagnostic:mr(s.diagnostic),skill_primary:r(s.skill_primary)??null,skill_secondary:v,skill_reason:r(s.skill_reason)??null,metrics_series:C.length>0?C:void 0,metrics_window:l,agent:b};return x.diagnostic=mr(s.diagnostic)??vp(x,(t==null?void 0:t.lodge)??null),x}).filter(s=>s!==null)}function Vp(e){if(!m(e))return;const t=r(e.release_version),n=le(e.started_at),s=d(e.uptime_seconds);if(!(!t||!n||s==null))return{release_version:t,commit:r(e.commit)??null,started_at:n,uptime_seconds:s}}function Yp(e){if(m(e))return{enabled:e.enabled===!0,alive:e.alive===!0,status:r(e.status)??void 0,tick_in_progress:typeof e.tick_in_progress=="boolean"?e.tick_in_progress:void 0,tick_count:d(e.tick_count)??void 0,check_interval_sec:d(e.check_interval_sec)??void 0,last_tick_started_at:le(e.last_tick_started_at)??r(e.last_tick_started_at)??null,last_tick_completed_at:le(e.last_tick_completed_at)??r(e.last_tick_completed_at)??null,next_tick_due_at:le(e.next_tick_due_at)??r(e.next_tick_due_at)??null,last_health_check_at:le(e.last_health_check_at)??r(e.last_health_check_at)??null,last_intervention:r(e.last_intervention)??void 0,last_decision_source:r(e.last_decision_source)??void 0,last_action:r(e.last_action)??void 0,last_target:r(e.last_target)??null,last_reason:r(e.last_reason)??null,last_error:r(e.last_error)??null,circuit_open:typeof e.circuit_open=="boolean"?e.circuit_open:void 0,circuit_open_until:le(e.circuit_open_until)??r(e.circuit_open_until)??null,can_spawn:typeof e.can_spawn=="boolean"?e.can_spawn:void 0,can_retire:typeof e.can_retire=="boolean"?e.can_retire:void 0,last_spawn_attempt_at:le(e.last_spawn_attempt_at)??r(e.last_spawn_attempt_at)??null,last_retirement_attempt_at:le(e.last_retirement_attempt_at)??r(e.last_retirement_attempt_at)??null,spawns_today:d(e.spawns_today)??void 0,retirements_today:d(e.retirements_today)??void 0,health_summary:m(e.health_summary)?{total_agents:d(e.health_summary.total_agents)??void 0,active_agents:d(e.health_summary.active_agents)??void 0,idle_agents:d(e.health_summary.idle_agents)??void 0,todo_count:d(e.health_summary.todo_count)??void 0,high_priority_todo:d(e.health_summary.high_priority_todo)??void 0,orphan_count:d(e.health_summary.orphan_count)??void 0,homeostatic_score:d(e.health_summary.homeostatic_score)??void 0,needs_workers:typeof e.health_summary.needs_workers=="boolean"?e.health_summary.needs_workers:void 0}:void 0}}function Qp(e){if(m(e))return{enabled:e.enabled===!0,mode:r(e.mode)??void 0,masc_enabled:typeof e.masc_enabled=="boolean"?e.masc_enabled:void 0,masc_loops_running:typeof e.masc_loops_running=="boolean"?e.masc_loops_running:void 0,runtime_owner:r(e.runtime_owner)??null,zombie_loop_running:typeof e.zombie_loop_running=="boolean"?e.zombie_loop_running:void 0,gc_loop_running:typeof e.gc_loop_running=="boolean"?e.gc_loop_running:void 0,lodge_enabled:typeof e.lodge_enabled=="boolean"?e.lodge_enabled:void 0,lodge_loop_started:typeof e.lodge_loop_started=="boolean"?e.lodge_loop_started:void 0,lodge_running:typeof e.lodge_running=="boolean"?e.lodge_running:void 0,last_zombie_cleanup:le(e.last_zombie_cleanup)??r(e.last_zombie_cleanup)??null,last_gc:le(e.last_gc)??r(e.last_gc)??null,last_lodge:le(e.last_lodge)??r(e.last_lodge)??null,last_zombie_result:r(e.last_zombie_result)??null,last_gc_result:r(e.last_gc_result)??null,last_lodge_result:m(e.last_lodge_result)?{ok:typeof e.last_lodge_result.ok=="boolean"?e.last_lodge_result.ok:void 0,message:r(e.last_lodge_result.message)??void 0}:null}}function Xp(e){if(m(e))return{enabled:e.enabled===!0,started:e.started===!0,agent_name:r(e.agent_name)??null,llm_enabled:typeof e.llm_enabled=="boolean"?e.llm_enabled:void 0,uptime_s:d(e.uptime_s)??void 0,embedded_guardian_loops_running:typeof e.embedded_guardian_loops_running=="boolean"?e.embedded_guardian_loops_running:void 0,guardian_runtime_owner:r(e.guardian_runtime_owner)??null,consumers:w(e.consumers)}}function wl(e,t){return m(e)?{...e,generated_at:t??le(e.generated_at)??void 0,build:Vp(e.build),lodge:pp(e.lodge)??void 0,gardener:Yp(e.gardener)??void 0,guardian:Qp(e.guardian)??void 0,sentinel:Xp(e.sentinel)??void 0}:null}function Fl(e,t){return t?e?{...e,...t,build:t.build??e.build,generated_at:t.generated_at??e.generated_at}:t:e}function Zp(e){const t=typeof e=="string"?e.toLowerCase():"";return t==="running"||t==="interrupted"||t==="completed"||t==="stopped"||t==="error"?t:t.startsWith("error")?"error":"running"}function em(e){if(!m(e))return null;const t=d(e.iteration);if(t==null)return null;const n=d(e.metric_before)??0,s=d(e.metric_after)??n,a=m(e.evidence)?e.evidence:null;return{iteration:t,metric_before:n,metric_after:s,delta:d(e.delta)??s-n,changes:r(e.changes)??"",failed_attempts:r(e.failed_attempts)??"",next_suggestion:r(e.next_suggestion)??"",elapsed_ms:d(e.elapsed_ms)??0,cost_usd:d(e.cost_usd)??null,evidence:a?{worker_engine:(a.worker_engine==="api_tool_loop","api_tool_loop"),worker_model:r(a.worker_model)??"",tool_call_count:d(a.tool_call_count)??0,tool_names:w(a.tool_names)??[],session_id:r(a.session_id)??"",evidence_status:a.evidence_status==="legacy_unverified"?"legacy_unverified":"verified"}:null}}function tm(e){var i,l;if(!m(e))return null;const t=r(e.loop_id);if(!t)return null;const n=d(e.baseline_metric)??0,s=Array.isArray(e.history)?e.history.map(em).filter(c=>c!==null):[],a=d(e.current_metric)??((i=s[0])==null?void 0:i.metric_after)??n;return{loop_id:t,profile:r(e.profile)??"unknown",status:Zp(e.status),strict_mode:typeof e.strict_mode=="boolean"?e.strict_mode:void 0,error_message:r(e.error_message)??r(e.error_reason)??null,stop_reason:r(e.stop_reason)??r(e.reason)??null,current_iteration:d(e.current_iteration)??((l=s[0])==null?void 0:l.iteration)??0,max_iterations:d(e.max_iterations)??0,baseline_metric:n,current_metric:a,target:r(e.target)??"",stagnation_streak:d(e.stagnation_streak)??0,stagnation_limit:d(e.stagnation_limit)??0,elapsed_seconds:d(e.elapsed_seconds)??0,updated_at:le(e.updated_at)??null,stopped_at:le(e.stopped_at)??null,execution_mode:e.execution_mode==="worker_spawn"?"worker_spawn":void 0,worker_engine:e.worker_engine==="api_tool_loop"?"api_tool_loop":null,worker_model:r(e.worker_model)??null,evidence_policy:e.evidence_policy==="hard"||e.evidence_policy==="legacy"?e.evidence_policy:void 0,latest_tool_call_count:d(e.latest_tool_call_count)??0,latest_tool_names:w(e.latest_tool_names)??[],session_id:r(e.session_id)??null,evidence_status:e.evidence_status==="legacy_unverified"?"legacy_unverified":e.evidence_status==="verified"?"verified":null,durability:e.durability==="persistent_backend"||e.durability==="memory_only"?e.durability:void 0,persistence_backend:e.persistence_backend==="filesystem"||e.persistence_backend==="postgres"||e.persistence_backend==="memory"?e.persistence_backend:void 0,recoverable:typeof e.recoverable=="boolean"?e.recoverable:void 0,history:s}}async function rs(){Uo.value=!0;try{await Promise.all([Bl(),Tt()]),Nl.value=new Date().toISOString()}catch(e){console.error("Dashboard refresh error:",e)}finally{Uo.value=!1}}async function Kl(){sa.value=!0,aa.value=null;try{const e=await au();xi.value=e,Rp.value=new Date().toISOString()}catch(e){aa.value=e instanceof Error?e.message:"Failed to load dashboard semantics"}finally{sa.value=!1}}function nm(e){var t;return((t=xi.value)==null?void 0:t.surfaces.find(n=>n.id===e))??null}function sm(e){var n;const t=((n=xi.value)==null?void 0:n.surfaces)??[];for(const s of t){const a=s.panels.find(i=>i.id===e);if(a)return a}return null}function am(e){var s,a;Qt.value=(Array.isArray(e.goals)?e.goals:[]).map(i=>{if(!m(i))return null;const l=r(i.id),c=r(i.title),p=r(i.horizon),_=r(i.status),u=r(i.created_at),f=r(i.updated_at);return!l||!c||!p||!_||!u||!f?null:{id:l,horizon:p,title:c,metric:r(i.metric)??null,target_value:r(i.target_value)??null,due_date:r(i.due_date)??null,priority:d(i.priority)??3,status:_,parent_goal_id:r(i.parent_goal_id)??null,last_review_note:r(i.last_review_note)??null,last_review_at:r(i.last_review_at)??null,created_at:u,updated_at:f}}).filter(i=>i!==null);const t=new Map,n=Array.isArray((s=e.mdal)==null?void 0:s.loops)?e.mdal.loops:[];for(const i of n){const l=tm(i);l&&t.set(l.loop_id,l)}El.value=t,Xt.value=typeof((a=e.mdal)==null?void 0:a.error)=="string"?e.mdal.error:null,ki.value=Xt.value?"error":t.size===0?"idle":"ready"}async function Bl(){try{const e=await Zd(),t=wl(e.status,e.generated_at);t&&(re.value=Fl(re.value,t))}catch(e){console.error("Dashboard shell fetch error:",e)}}async function Tt(){var e;try{const t=await tu(),n=wl(t.status,t.generated_at),s=(e=re.value)==null?void 0:e.room;n&&(re.value=Fl(re.value,n));const a=s!=null&&(n==null?void 0:n.room)!=null&&s!==n.room;Qe.value=(Array.isArray(t.agents)?t.agents:[]).map(Np).filter(l=>l!==null),st.value=(Array.isArray(t.tasks)?t.tasks:[]).map(Dp).filter(l=>l!==null);const i=(Array.isArray(t.messages)?t.messages:[]).map(Op).filter(l=>l!==null);Ko.value=a?i:Wp(Ko.value,i),vt.value=Jp(t.keepers,n??re.value),Tl.value=qp(t.summary),Pl.value=Bp(t.lodge_tick),yi.value=(Array.isArray(t.lodge_checkins)?t.lodge_checkins:[]).map(Up).filter(l=>l!==null),Il.value=(Array.isArray(t.execution_queue)?t.execution_queue:Array.isArray(t.priority_queue)?t.priority_queue:[]).map(wp).filter(l=>l!==null),zl.value=(Array.isArray(t.session_briefs)?t.session_briefs:[]).map(Fp).filter(l=>l!==null),Rl.value=(Array.isArray(t.operation_briefs)?t.operation_briefs:[]).map(Kp).filter(l=>l!==null),Ll.value=(Array.isArray(t.worker_support_briefs)?t.worker_support_briefs:Array.isArray(t.worker_briefs)?t.worker_briefs:[]).map(ur).filter(l=>l!==null),bi.value=(Array.isArray(t.continuity_briefs)?t.continuity_briefs:[]).map(Hp).filter(l=>l!==null),Ml.value=(Array.isArray(t.offline_worker_briefs)?t.offline_worker_briefs:[]).map(ur).filter(l=>l!==null),Tp.value=null,Nl.value=new Date().toISOString()}catch(t){console.error("Dashboard execution fetch error:",t)}}async function ot(){Kn.value=!0;try{const e=await nu(Fn.value,{excludeSystem:At.value});Ha.value=e.posts??[],Wo.value=new Date().toISOString()}catch(e){console.error("Board fetch error:",e)}finally{Kn.value=!1}}async function it(){var e;Ho.value=!0;try{const t=Je.value||((e=re.value)==null?void 0:e.room)||"default";Je.value||(Je.value=t);const n=await Uu(t);jl.value=n}catch(t){console.error("TRPG fetch error:",t)}finally{Ho.value=!1}}async function Ci(){zn.value=!0,Rn.value=!0;try{const e=await cu();am(e),Ip.value=new Date().toISOString(),zp.value=new Date().toISOString()}catch(e){console.error("Planning fetch error:",e),ki.value="error",Xt.value=e instanceof Error?e.message:String(e)}finally{zn.value=!1,Rn.value=!1}}async function Ul(){return Ci()}const Ai=g(null),Go=g(!1),oa=g(null);function om(e){return m(e)?{room:r(e.room)??r(e.current_room),room_base_path:r(e.room_base_path),cluster:r(e.cluster),project:r(e.project),paused:j(e.paused),version:r(e.version),generated_at:r(e.generated_at),tempo_interval_s:d(e.tempo_interval_s)}:null}function im(e){return m(e)?{active_sessions:d(e.active_sessions),blocked_sessions:d(e.blocked_sessions),active_operations:d(e.active_operations),blocked_operations:d(e.blocked_operations),runtime_pressure:d(e.runtime_pressure),worker_alerts:d(e.worker_alerts),continuity_alerts:d(e.continuity_alerts),priority_items:d(e.priority_items),keepers:d(e.keepers)}:null}function rm(e){if(!m(e))return null;const t=r(e.id),n=r(e.kind),s=r(e.severity),a=r(e.summary),i=r(e.target_type),l=r(e.target_id);return!t||!n||!s||!a||!i||!l?null:{id:t,kind:n,severity:s,summary:a,target_type:i,target_id:l,status:r(e.status),linked_session_id:r(e.linked_session_id)??null,linked_operation_id:r(e.linked_operation_id)??null,last_seen_at:r(e.last_seen_at)??null,top_handoff:m(e.top_handoff)?e.top_handoff:null,intervene_handoff:m(e.intervene_handoff)?e.intervene_handoff:null,command_handoff:m(e.command_handoff)?e.command_handoff:null}}function lm(e){if(!m(e))return null;const t=r(e.kind),n=r(e.summary),s=r(e.target_type);return!t||!n||!s?null:{kind:t,severity:r(e.severity)??"warn",summary:n,target_type:s,target_id:r(e.target_id)??null,actor:r(e.actor)??null,evidence:e.evidence}}function cm(e){if(!m(e))return null;const t=r(e.action_type),n=r(e.target_type),s=r(e.reason);return!t||!n||!s?null:{action_type:t,target_type:n,target_id:r(e.target_id)??null,severity:r(e.severity)??"warn",reason:s,confirm_required:j(e.confirm_required),suggested_payload:m(e.suggested_payload)?e.suggested_payload:void 0,preview:e.preview}}function dm(e){return m(e)?{actor_filter:r(e.actor_filter)??null,filter_active:j(e.filter_active)??!1,visible_count:d(e.visible_count)??0,total_count:d(e.total_count)??0,hidden_count:d(e.hidden_count)??0,hidden_actors:w(e.hidden_actors),confirm_required_actions:me(e.confirm_required_actions).flatMap(t=>{if(!m(t))return[];const n=r(t.action_type),s=r(t.target_type);return!n||!s?[]:[{action_type:n,target_type:s,description:r(t.description),confirm_required:j(t.confirm_required)}]})}:null}function um(e){return m(e)?{count:d(e.count)??0,bad_count:d(e.bad_count)??0,warn_count:d(e.warn_count)??0,provenance:r(e.provenance)??null,top_item:lm(e.top_item)}:null}function pm(e){return m(e)?{count:d(e.count)??0,provenance:r(e.provenance)??null,top_action:cm(e.top_action)}:null}function mm(e){if(!m(e))return null;const t=r(e.label),n=r(e.reason),s=r(e.source),a=r(e.provenance);return!t||!n||!s||!a?null:{label:t,reason:n,source:s,provenance:a,target_kind:r(e.target_kind)??null,target_id:r(e.target_id)??null,suggested_tab:r(e.suggested_tab)??null,suggested_surface:r(e.suggested_surface)??null,suggested_params:m(e.suggested_params)?Object.fromEntries(Object.entries(e.suggested_params).map(([i,l])=>{const c=r(l);return c?[i,c]:null}).filter(i=>i!==null)):{}}}function _m(e){const t=m(e)?e:{},n=m(t.room)?t.room:{},s=m(t.execution)?t.execution:{},a=m(t.command)?t.command:{},i=m(t.operator)?t.operator:{};return{generated_at:r(t.generated_at),room:{status:om(n.status),counts:m(n.counts)?{agents:d(n.counts.agents),tasks:d(n.counts.tasks),keepers:d(n.counts.keepers)}:void 0,provenance:r(n.provenance)??null},execution:{summary:im(s.summary),top_queue:rm(s.top_queue),provenance:r(s.provenance)??null},command:{active_operations:d(a.active_operations),active_detachments:d(a.active_detachments),pending_approvals:d(a.pending_approvals),bad_alerts:d(a.bad_alerts),warn_alerts:d(a.warn_alerts),moving_lanes:d(a.moving_lanes),active_lanes:d(a.active_lanes),provenance:r(a.provenance)??null},operator:{health:r(i.health)??null,attention_summary:um(i.attention_summary),recommendation_summary:pm(i.recommendation_summary),pending_confirm_summary:dm(i.pending_confirm_summary),provenance:r(i.provenance)??null},focus:mm(t.focus)}}async function It(){Go.value=!0,oa.value=null;try{const e=await eu();Ai.value=_m(e)}catch(e){oa.value=e instanceof Error?e.message:"Failed to load room truth"}finally{Go.value=!1}}let Bs=null;function vm(e){Bs=e}let Us=null;function fm(e){Us=e}let Hs=null;function gm(e){Hs=e}const zt={};let eo=null;function bt(e,t,n=500){zt[e]&&clearTimeout(zt[e]),zt[e]=setTimeout(()=>{t(),delete zt[e]},n)}function $m(){const e=cl.subscribe(t=>{if(t){if(t.type==="keeper_heartbeat"&&t.name){const n=new Map(Bo.value);n.set(t.name,t.ts_unix?t.ts_unix*1e3:Date.now()),Bo.value=n;return}(t.type==="agent_joined"||t.type==="agent_left")&&bt("execution",Tt),jp(t.type)&&(eo||(eo=setTimeout(()=>{rs(),Us==null||Us(),Hs==null||Hs(),eo=null},500))),(t.type.startsWith("task_")||t.type.startsWith("masc/task_"))&&bt("execution",Tt),t.type==="broadcast"&&bt("execution",Tt),(t.type==="keeper_handoff"||t.type==="keeper_compaction"||t.type==="keeper_guardrail")&&bt("execution",Tt),(t.type==="board_post"||t.type==="masc/board_post"||t.type==="board_comment"||t.type==="masc/board_comment")&&bt("board",ot),t.type.startsWith("decision_")&&bt("council",()=>Bs==null?void 0:Bs()),(t.type==="mdal_started"||t.type==="mdal_iteration"||t.type==="mdal_completed"||t.type==="mdal_stopped")&&bt("mdal",Ul,350)}});return()=>{e();for(const t of Object.keys(zt))clearTimeout(zt[t]),delete zt[t]}}let Ln=null;function hm(){Ln||(Ln=setInterval(()=>{dt.value,rs()},1e4))}function ym(){Ln&&(clearInterval(Ln),Ln=null)}const $e=g(null),Ti=g(null),Fe=g(null),Bn=g(!1),ut=g(null),Un=g(!1),cn=g(null),Y=g(!1),ia=g([]);let bm=1;function km(e){return m(e)?{id:r(e.id),seq:d(e.seq),from:r(e.from)??r(e.from_agent)??"system",content:r(e.content)??"",timestamp:r(e.timestamp)??new Date().toISOString(),type:r(e.type)}:null}function xm(e){return m(e)?{room_id:r(e.room_id),current_room:r(e.current_room)??r(e.room),project:r(e.project),cluster:r(e.cluster),paused:j(e.paused),pause_reason:r(e.pause_reason)??null,paused_by:r(e.paused_by)??null,paused_at:r(e.paused_at)??null}:{}}function _r(e){if(!m(e))return;const t=Object.entries(e).map(([n,s])=>{const a=r(s);return a?[n,a]:null}).filter(n=>n!==null);return t.length>0?Object.fromEntries(t):void 0}function Hl(e){if(!m(e))return null;const t=r(e.kind),n=r(e.summary),s=r(e.target_type);return!t||!n||!s?null:{kind:t,severity:r(e.severity)??"warn",summary:n,target_type:s,target_id:r(e.target_id)??null,actor:r(e.actor)??null,evidence:e.evidence}}function Pn(e){if(!m(e))return null;const t=r(e.action_type),n=r(e.target_type),s=r(e.reason);return!t||!n||!s?null:{action_type:t,target_type:n,target_id:r(e.target_id)??null,severity:r(e.severity)??"warn",reason:s,confirm_required:j(e.confirm_required),suggested_payload:e.suggested_payload,preview:e.preview}}function Wl(e){return m(e)?{enabled:j(e.enabled),judge_online:j(e.judge_online),refreshing:j(e.refreshing),generated_at:r(e.generated_at)??null,expires_at:r(e.expires_at)??null,model_used:r(e.model_used)??null,keeper_name:r(e.keeper_name)??null,last_error:r(e.last_error)??null}:null}function to(e){return m(e)?{summary:r(e.summary)??null,confidence:d(e.confidence)??null,provenance:r(e.provenance)??null,authoritative:j(e.authoritative),surface:r(e.surface)??null,fresh_until:r(e.fresh_until)??null,keeper_name:r(e.keeper_name)??null,fallback_used:j(e.fallback_used),disagreement_with_truth:j(e.disagreement_with_truth)}:null}function Sm(e){return m(e)?{judgment_id:r(e.judgment_id)??void 0,surface:r(e.surface)??null,target_type:r(e.target_type)??null,target_id:r(e.target_id)??null,status:r(e.status)??null,summary:r(e.summary)??null,confidence:d(e.confidence)??null,generated_at:r(e.generated_at)??null,fresh_until:r(e.fresh_until)??null,keeper_name:r(e.keeper_name)??null,model_name:r(e.model_name)??null,runtime_name:r(e.runtime_name)??null,evidence_refs:w(e.evidence_refs),recommended_action:Pn(e.recommended_action),supersedes:w(e.supersedes),fallback_used:j(e.fallback_used),disagreement_with_truth:j(e.disagreement_with_truth),provenance:r(e.provenance)??null}:null}function Cm(e){return m(e)?{actor:r(e.actor)??null,spawn_agent:r(e.spawn_agent)??null,spawn_role:r(e.spawn_role)??null,spawn_model:r(e.spawn_model)??null,worker_class:r(e.worker_class)??null,parent_actor:r(e.parent_actor)??null,capsule_mode:r(e.capsule_mode)??null,runtime_pool:r(e.runtime_pool)??null,lane_id:r(e.lane_id)??null,controller_level:r(e.controller_level)??null,control_domain:r(e.control_domain)??null,supervisor_actor:r(e.supervisor_actor)??null,model_tier:r(e.model_tier)??null,task_profile:r(e.task_profile)??null,risk_level:r(e.risk_level)??null,routing_confidence:d(e.routing_confidence)??null,routing_reason:r(e.routing_reason)??null,status:r(e.status)??"unknown",turn_count:d(e.turn_count)??0,empty_note_turn_count:d(e.empty_note_turn_count)??0,has_turn:j(e.has_turn)??!1,last_turn_ts_iso:r(e.last_turn_ts_iso)??null}:null}function Am(e){if(!m(e))return null;const t=r(e.session_id);return t?{session_id:t,goal:r(e.goal),status:r(e.status),health:r(e.health),scale_profile:r(e.scale_profile),control_profile:r(e.control_profile),planned_worker_count:d(e.planned_worker_count),active_agent_count:d(e.active_agent_count),last_turn_age_sec:d(e.last_turn_age_sec)??null,attention_count:d(e.attention_count),recommended_action_count:d(e.recommended_action_count),top_attention:Hl(e.top_attention),top_recommendation:Pn(e.top_recommendation)}:null}function Gl(e){const t=m(e)?e:{};return{trace_id:r(t.trace_id),target_type:r(t.target_type)??"room",target_id:r(t.target_id)??null,health:r(t.health),judgment_owner:r(t.judgment_owner)??null,authoritative_judgment_available:j(t.authoritative_judgment_available),resident_judge_runtime:Wl(t.resident_judge_runtime),judgment:Sm(t.judgment),active_guidance_layer:r(t.active_guidance_layer)??null,active_summary:to(t.active_summary),active_recommended_actions:me(t.active_recommended_actions).map(Pn).filter(n=>n!==null),active_recommendation_source:r(t.active_recommendation_source)??null,active_recommendation_summary:to(t.active_recommendation_summary),fallback_recommended_actions:me(t.fallback_recommended_actions).map(Pn).filter(n=>n!==null),recommendation_summary:to(t.recommendation_summary),swarm_status:m(t.swarm_status)?t.swarm_status:void 0,attention_items:me(t.attention_items).map(Hl).filter(n=>n!==null),recommended_actions:me(t.recommended_actions).map(Pn).filter(n=>n!==null),session_cards:me(t.session_cards).map(Am).filter(n=>n!==null),worker_cards:me(t.worker_cards).map(Cm).filter(n=>n!==null)}}function Tm(e){if(!m(e))return null;const t=m(e.status)?e.status:void 0,n=m(e.summary)?e.summary:m(t==null?void 0:t.summary)?t.summary:void 0,s=m(e.session)?e.session:m(t==null?void 0:t.session)?t.session:void 0,a=r(e.session_id)??r(n==null?void 0:n.session_id)??r(s==null?void 0:s.session_id);if(!a)return null;const i=_r(e.report_paths)??_r(t==null?void 0:t.report_paths),l=me(e.recent_events,["events"]).filter(m);return{session_id:a,status:r(e.status)??r(n==null?void 0:n.status)??r(s==null?void 0:s.status),progress_pct:d(e.progress_pct)??d(n==null?void 0:n.progress_pct),elapsed_sec:d(e.elapsed_sec)??d(n==null?void 0:n.elapsed_sec),remaining_sec:d(e.remaining_sec)??d(n==null?void 0:n.remaining_sec),done_delta_total:d(e.done_delta_total)??d(n==null?void 0:n.done_delta_total),summary:n,team_health:m(e.team_health)?e.team_health:m(t==null?void 0:t.team_health)?t.team_health:void 0,communication_metrics:m(e.communication_metrics)?e.communication_metrics:m(t==null?void 0:t.communication_metrics)?t.communication_metrics:void 0,orchestration_state:m(e.orchestration_state)?e.orchestration_state:m(t==null?void 0:t.orchestration_state)?t.orchestration_state:void 0,cascade_metrics:m(e.cascade_metrics)?e.cascade_metrics:m(t==null?void 0:t.cascade_metrics)?t.cascade_metrics:void 0,report_paths:i,linked_autoresearch:m(e.linked_autoresearch)?e.linked_autoresearch:m(t==null?void 0:t.linked_autoresearch)?t.linked_autoresearch:void 0,session:s,recent_events:l}}function vr(e){if(!m(e))return null;const t=r(e.name);if(!t)return null;const n=m(e.context)?e.context:void 0;return{name:t,runtime_class:e.runtime_class==="persistent_agent"?"persistent_agent":"resident_keeper",desired:j(e.desired),resident_registered:j(e.resident_registered),agent_name:r(e.agent_name),status:r(e.status),autonomy_level:r(e.autonomy_level),context_ratio:d(e.context_ratio)??d(n==null?void 0:n.context_ratio),generation:d(e.generation),active_goal_ids:w(e.active_goal_ids),last_autonomous_action_at:r(e.last_autonomous_action_at)??null,last_turn_ago_s:d(e.last_turn_ago_s),model:r(e.model)??r(e.active_model)??r(e.primary_model)}}function Im(e){if(!m(e))return null;const t=r(e.confirm_token)??r(e.token);return t?{confirm_token:t,actor:r(e.actor),action_type:r(e.action_type),target_type:r(e.target_type),target_id:r(e.target_id)??null,delegated_tool:r(e.delegated_tool),created_at:r(e.created_at),preview:e.preview}:null}function Jl(e){if(!m(e))return null;const t=r(e.action_type),n=r(e.target_type);return!t||!n?null:{action_type:t,target_type:n,description:r(e.description),confirm_required:j(e.confirm_required)}}function zm(e){return m(e)?{actor_filter:r(e.actor_filter)??null,filter_active:j(e.filter_active)??!1,visible_count:d(e.visible_count)??0,total_count:d(e.total_count)??0,hidden_count:d(e.hidden_count)??0,hidden_actors:w(e.hidden_actors),confirm_required_actions:me(e.confirm_required_actions).map(Jl).filter(t=>t!==null)}:null}function Rm(e){const t=m(e)?e:{};return{room:xm(t.room),sessions:me(t.sessions,["items","sessions"]).map(Tm).filter(n=>n!==null),keepers:me(t.keepers,["items","keepers"]).map(vr).filter(n=>n!==null),resident_judge_runtime:Wl(t.resident_judge_runtime),persistent_agents:me(t.persistent_agents,["items","persistent_agents"]).map(vr).filter(n=>n!==null),recent_messages:me(t.recent_messages,["messages"]).map(km).filter(n=>n!==null),pending_confirms:me(t.pending_confirms,["items","confirms"]).map(Im).filter(n=>n!==null),pending_confirm_summary:zm(t.pending_confirm_summary)??void 0,available_actions:me(t.available_actions,["actions"]).map(Jl).filter(n=>n!==null)}}function As(e){if(typeof e=="string")return e;if(e==null)return"";try{return JSON.stringify(e)}catch{return String(e)}}function fr(e){return e.target_id?`${e.target_type}:${e.target_id}`:e.target_type}function ra(e){ia.value=[{...e,id:bm++,at:new Date().toISOString()},...ia.value].slice(0,20)}function Vl(e){return e.confirm_required?As(e.preview)||"Confirmation required":As(e.result)||As(e.executed_action)||As(e.delegated_tool_result)||e.status}async function xe(){Bn.value=!0,ut.value=null;try{const e=await pu();$e.value=Rm(e)}catch(e){ut.value=e instanceof Error?e.message:"Failed to load operator snapshot"}finally{Bn.value=!1}}async function jt(){Un.value=!0,cn.value=null;try{const e=await vl({targetType:"room"});Ti.value=Gl(e)}catch(e){cn.value=e instanceof Error?e.message:"Failed to load operator digest"}finally{Un.value=!1}}async function dn(e){if(!e){Fe.value=null;return}Un.value=!0,cn.value=null;try{const t=await vl({targetType:"team_session",targetId:e,includeWorkers:!0});Fe.value=Gl(t)}catch(t){cn.value=t instanceof Error?t.message:"Failed to load session digest"}finally{Un.value=!1}}async function Yl(e){var t;Y.value=!0,ut.value=null;try{const n=await Ba(e);return ra({actor:e.actor,action_type:e.action_type,target_label:fr(e),outcome:n.confirm_required?"preview":"executed",message:Vl(n),delegated_tool:n.delegated_tool}),await xe(),await jt(),(t=Fe.value)!=null&&t.target_id&&await dn(Fe.value.target_id),n}catch(n){const s=n instanceof Error?n.message:"Operator action failed";throw ut.value=s,ra({actor:e.actor,action_type:e.action_type,target_label:fr(e),outcome:"error",message:s}),n}finally{Y.value=!1}}async function Ql(e,t,n="confirm"){var s;Y.value=!0,ut.value=null;try{const a=await fl(e,t,n);return ra({actor:e,action_type:n,target_label:t,outcome:"confirmed",message:Vl(a),delegated_tool:a.delegated_tool}),await xe(),await jt(),(s=Fe.value)!=null&&s.target_id&&await dn(Fe.value.target_id),a}catch(a){const i=a instanceof Error?a.message:"Operator confirmation failed";throw ut.value=i,ra({actor:e,action_type:"confirm",target_label:t,outcome:"error",message:i}),a}finally{Y.value=!1}}gm(()=>{var e;xe(),jt(),(e=Fe.value)!=null&&e.target_id&&dn(Fe.value.target_id)});const ls=g(null),Jo=g(!1),la=g(null),Xl=g(null),Kt=g(!1),Ct=g(null),Vo=g(null),Ws=g(!1),Gs=g(null);let Zt=null;function gr(){Zt!==null&&(window.clearTimeout(Zt),Zt=null)}function Lm(e=1500){Zt===null&&(Zt=window.setTimeout(()=>{Zt=null,ca(!1)},e))}function N(e){return typeof e=="object"&&e!==null&&!Array.isArray(e)}function y(e){return typeof e=="string"&&e.trim()!==""?e:void 0}function D(e){return typeof e=="number"&&Number.isFinite(e)?e:void 0}function en(e){return typeof e=="boolean"?e:void 0}function H(e,t=[]){if(Array.isArray(e))return e;if(!N(e))return[];for(const n of t){const s=e[n];if(Array.isArray(s))return s}return[]}function fn(e){if(!N(e))return null;const t=y(e.kind),n=y(e.summary),s=y(e.target_type);return!t||!n||!s?null:{kind:t,severity:y(e.severity)??"warn",summary:n,target_type:s,target_id:y(e.target_id)??null,actor:y(e.actor)??null,evidence:e.evidence}}function Et(e){if(!N(e))return null;const t=y(e.action_type),n=y(e.target_type),s=y(e.reason);return!t||!n||!s?null:{action_type:t,target_type:n,target_id:y(e.target_id)??null,severity:y(e.severity)??"warn",reason:s,confirm_required:en(e.confirm_required),suggested_payload:e.suggested_payload,preview:e.preview}}function Pm(e){if(!N(e))return null;const t=y(e.session_id);return t?{session_id:t,goal:y(e.goal),status:y(e.status),health:y(e.health),scale_profile:y(e.scale_profile),control_profile:y(e.control_profile),planned_worker_count:D(e.planned_worker_count),active_agent_count:D(e.active_agent_count),last_turn_age_sec:D(e.last_turn_age_sec)??null,attention_count:D(e.attention_count),recommended_action_count:D(e.recommended_action_count),top_attention:fn(e.top_attention),top_recommendation:Et(e.top_recommendation)}:null}function Mm(e){if(!N(e))return null;const t=y(e.session_id);if(!t)return null;const n=N(e.status)?e.status:e,s=N(n.summary)?n.summary:void 0;return{session_id:t,status:y(e.status)??y(s==null?void 0:s.status)??(N(n.session)?y(n.session.status):void 0),progress_pct:D(e.progress_pct)??D(s==null?void 0:s.progress_pct),elapsed_sec:D(e.elapsed_sec)??D(s==null?void 0:s.elapsed_sec),remaining_sec:D(e.remaining_sec)??D(s==null?void 0:s.remaining_sec),done_delta_total:D(e.done_delta_total)??D(s==null?void 0:s.done_delta_total),summary:N(e.summary)?e.summary:s,team_health:N(e.team_health)?e.team_health:N(n.team_health)?n.team_health:void 0,communication_metrics:N(e.communication_metrics)?e.communication_metrics:N(n.communication_metrics)?n.communication_metrics:void 0,orchestration_state:N(e.orchestration_state)?e.orchestration_state:N(n.orchestration_state)?n.orchestration_state:void 0,cascade_metrics:N(e.cascade_metrics)?e.cascade_metrics:N(n.cascade_metrics)?n.cascade_metrics:void 0,report_paths:N(e.report_paths)?Object.fromEntries(Object.entries(e.report_paths).map(([a,i])=>{const l=y(i);return l?[a,l]:null}).filter(a=>a!==null)):N(n.report_paths)?Object.fromEntries(Object.entries(n.report_paths).map(([a,i])=>{const l=y(i);return l?[a,l]:null}).filter(a=>a!==null)):void 0,session:N(e.session)?e.session:N(n.session)?n.session:void 0,recent_events:H(e.recent_events,["events"]).filter(N)}}function jm(e){if(!N(e))return null;const t=y(e.name);return t?{name:t,agent_name:y(e.agent_name),status:y(e.status),autonomy_level:y(e.autonomy_level),context_ratio:D(e.context_ratio),generation:D(e.generation),active_goal_ids:H(e.active_goal_ids).map(n=>typeof n=="string"?n.trim():"").filter(Boolean),last_autonomous_action_at:y(e.last_autonomous_action_at)??null,last_turn_ago_s:D(e.last_turn_ago_s),model:y(e.model)}:null}function Em(e){if(!N(e))return null;const t=y(e.confirm_token)??y(e.token);return t?{confirm_token:t,actor:y(e.actor),action_type:y(e.action_type),target_type:y(e.target_type),target_id:y(e.target_id)??null,delegated_tool:y(e.delegated_tool),created_at:y(e.created_at),preview:e.preview}:null}function Nm(e){if(!N(e))return null;const t=y(e.action_type),n=y(e.target_type);return!t||!n?null:{action_type:t,target_type:n,description:y(e.description),confirm_required:en(e.confirm_required)}}function Dm(e){const t=N(e)?e:{};return{room_health:y(t.room_health),cluster:y(t.cluster),project:y(t.project),current_room:y(t.current_room)??null,paused:en(t.paused),tempo_interval_s:D(t.tempo_interval_s),active_agents:D(t.active_agents),keeper_pressure:D(t.keeper_pressure),active_operations:D(t.active_operations),pending_approvals:D(t.pending_approvals),incident_count:D(t.incident_count),recommended_action_count:D(t.recommended_action_count),top_attention:fn(t.top_attention),top_action:Et(t.top_action)}}function Om(e){const t=N(e)?e:{},n=N(t.swarm_overview)?t.swarm_overview:{};return{health:y(t.health),active_operations:D(t.active_operations),pending_approvals:D(t.pending_approvals),swarm_overview:{active_lanes:D(n.active_lanes),moving_lanes:D(n.moving_lanes),stalled_lanes:D(n.stalled_lanes),projected_lanes:D(n.projected_lanes),last_movement_at:y(n.last_movement_at)??null},top_attention:fn(t.top_attention),top_action:Et(t.top_action),session_cards:H(t.session_cards).map(Pm).filter(s=>s!==null)}}function qm(e){const t=N(e)?e:{};return{sessions:H(t.sessions,["items"]).map(Mm).filter(n=>n!==null),keepers:H(t.keepers,["items"]).map(jm).filter(n=>n!==null),pending_confirms:H(t.pending_confirms).map(Em).filter(n=>n!==null),available_actions:H(t.available_actions).map(Nm).filter(n=>n!==null)}}function wm(e){if(!N(e))return null;const t=y(e.id),n=y(e.kind),s=y(e.summary),a=y(e.target_type);return!t||!n||!s||!a?null:{id:t,kind:n,severity:y(e.severity)??"warn",summary:s,target_type:a,target_id:y(e.target_id)??null,top_action:Et(e.top_action),related_session_ids:H(e.related_session_ids).map(i=>typeof i=="string"?i.trim():"").filter(Boolean),related_agent_names:H(e.related_agent_names).map(i=>typeof i=="string"?i.trim():"").filter(Boolean),evidence_preview:H(e.evidence_preview).map(i=>typeof i=="string"?i.trim():"").filter(Boolean),last_seen_at:y(e.last_seen_at)??null}}function Zl(e){if(!N(e))return null;const t=y(e.session_id),n=y(e.goal);return!t||!n?null:{session_id:t,goal:n,room:y(e.room)??null,status:y(e.status),health:y(e.health),member_names:H(e.member_names).map(s=>typeof s=="string"?s.trim():"").filter(Boolean),started_at:y(e.started_at)??null,elapsed_sec:D(e.elapsed_sec)??null,operation_id:y(e.operation_id)??null,blocker_summary:y(e.blocker_summary)??null,last_event_at:y(e.last_event_at)??null,last_event_summary:y(e.last_event_summary)??null,communication_summary:y(e.communication_summary)??null,active_count:D(e.active_count),required_count:D(e.required_count),related_attention_count:D(e.related_attention_count)??0,top_attention:fn(e.top_attention),top_recommendation:Et(e.top_recommendation)}}function ec(e){if(!N(e))return null;const t=y(e.agent_name);return t?{agent_name:t,status:y(e.status),current_work:y(e.current_work)??null,recent_input_preview:y(e.recent_input_preview)??null,recent_output_preview:y(e.recent_output_preview)??null,recent_tool_names:H(e.recent_tool_names).map(n=>typeof n=="string"?n.trim():"").filter(Boolean),last_activity_at:y(e.last_activity_at)??null}:null}function tc(e){if(!N(e))return null;const t=y(e.operation_id);return t?{operation_id:t,status:y(e.status),stage:y(e.stage)??null,detachment_status:y(e.detachment_status)??null,objective:y(e.objective)??null,updated_at:y(e.updated_at)??null}:null}function nc(e){if(!N(e))return null;const t=y(e.name);return t?{name:t,agent_name:y(e.agent_name)??null,status:y(e.status),generation:D(e.generation),context_ratio:D(e.context_ratio)??null,last_turn_ago_s:D(e.last_turn_ago_s)??null,current_work:y(e.current_work)??null}:null}function sc(e){const t=Zl(e);return t?{...t,member_previews:H(N(e)?e.member_previews:void 0).map(ec).filter(n=>n!==null),operation_badges:H(N(e)?e.operation_badges:void 0).map(tc).filter(n=>n!==null),keeper_refs:H(N(e)?e.keeper_refs:void 0).map(nc).filter(n=>n!==null)}:null}function Fm(e){if(!N(e))return null;const t=y(e.agent_name);return t?{agent_name:t,status:y(e.status),where:y(e.where)??null,with_whom:H(e.with_whom).map(n=>typeof n=="string"?n.trim():"").filter(Boolean),current_work:y(e.current_work)??null,related_session_id:y(e.related_session_id)??null,related_attention_count:D(e.related_attention_count)??0,last_activity_at:y(e.last_activity_at)??null,recent_output_preview:y(e.recent_output_preview)??null,recent_input_preview:y(e.recent_input_preview)??null,recent_event:y(e.recent_event)??null,recent_tool_names:H(e.recent_tool_names).map(n=>typeof n=="string"?n.trim():"").filter(Boolean),allowed_tool_names:H(e.allowed_tool_names).map(n=>typeof n=="string"?n.trim():"").filter(Boolean),latest_tool_names:H(e.latest_tool_names).map(n=>typeof n=="string"?n.trim():"").filter(Boolean),latest_tool_call_count:D(e.latest_tool_call_count)??null,tool_audit_source:y(e.tool_audit_source)??null,tool_audit_at:y(e.tool_audit_at)??null}:null}function Km(e){if(!N(e))return null;const t=y(e.name);return t?{name:t,agent_name:y(e.agent_name)??null,status:y(e.status),generation:D(e.generation),context_ratio:D(e.context_ratio)??null,last_turn_ago_s:D(e.last_turn_ago_s)??null,current_work:y(e.current_work)??null,last_autonomous_action_at:y(e.last_autonomous_action_at)??null,allowed_tool_names:H(e.allowed_tool_names).map(n=>typeof n=="string"?n.trim():"").filter(Boolean),latest_tool_names:H(e.latest_tool_names).map(n=>typeof n=="string"?n.trim():"").filter(Boolean),latest_tool_call_count:D(e.latest_tool_call_count)??null,tool_audit_source:y(e.tool_audit_source)??null,tool_audit_at:y(e.tool_audit_at)??null}:null}function Bm(e){if(!N(e))return null;const t=y(e.id),n=y(e.signal_type),s=y(e.summary),a=y(e.target_type);return!t||!n||!s||!a?null:{id:t,signal_type:n==="action"?"action":"attention",severity:y(e.severity)??"warn",summary:s,target_type:a,target_id:y(e.target_id)??null,attention:fn(e.attention),action:Et(e.action)}}function Um(e){const t=N(e)?e:{},n=H(t.session_briefs).map(Zl).filter(a=>a!==null),s=H(t.sessions).map(sc).filter(a=>a!==null);return{generated_at:y(t.generated_at),summary:Dm(t.summary),incidents:H(t.incidents).map(fn).filter(a=>a!==null),recommended_actions:H(t.recommended_actions).map(Et).filter(a=>a!==null),command_focus:Om(t.command_focus),operator_targets:qm(t.operator_targets),attention_queue:H(t.attention_queue).map(wm).filter(a=>a!==null),sessions:s.length>0?s:n.map(a=>({...a,member_previews:[],operation_badges:[],keeper_refs:[]})),session_briefs:n,agent_briefs:H(t.agent_briefs).map(Fm).filter(a=>a!==null),keeper_briefs:H(t.keeper_briefs).map(Km).filter(a=>a!==null),internal_signals:H(t.internal_signals).map(Bm).filter(a=>a!==null)}}function Hm(e){if(!N(e))return null;const t=y(e.id),n=y(e.summary);return!t||!n?null:{id:t,timestamp:y(e.timestamp)??null,event_type:y(e.event_type),actor:y(e.actor)??null,summary:n}}function Wm(e){const t=N(e)?e:{};return{generated_at:y(t.generated_at),session_id:y(t.session_id)??"",session:sc(t.session),timeline:H(t.timeline).map(Hm).filter(n=>n!==null),participants:H(t.participants).map(ec).filter(n=>n!==null),operations:H(t.operations).map(tc).filter(n=>n!==null),keepers:H(t.keepers).map(nc).filter(n=>n!==null),error:y(t.error)??null}}function Gm(e){if(!N(e))return null;const t=y(e.id),n=y(e.label),s=y(e.summary);if(!t||!n||!s)return null;const a=y(e.status)??"unclear";return{id:t,label:n,status:a==="ok"||a==="healthy"||a==="aligned"||a==="watch"||a==="risk"||a==="unclear"?a:"unclear",summary:s,signal_class:y(e.signal_class)==="metadata_gap"||y(e.signal_class)==="mixed"||y(e.signal_class)==="operational_risk"?y(e.signal_class):void 0,evidence_quality:y(e.evidence_quality)==="strong"||y(e.evidence_quality)==="partial"||y(e.evidence_quality)==="missing"?y(e.evidence_quality):void 0,evidence:H(e.evidence).map(l=>typeof l=="string"?l.trim():"").filter(Boolean)}}function Jm(e){if(!N(e))return null;const t=y(e.kind),n=y(e.summary),s=y(e.scope_type),a=y(e.severity);return!t||!n||!s||!a||s!=="session"&&s!=="keeper"&&s!=="agent"||a!=="info"&&a!=="watch"?null:{kind:t,summary:n,scope_type:s,scope_id:y(e.scope_id)??null,severity:a}}function Vm(e){const t=N(e)?e:{},n=N(t.basis)?t.basis:{},s=y(t.status)??"error",a=s==="ok"||s==="pending"||s==="unavailable"||s==="error"?s:"error";return{generated_at:y(t.generated_at),cached:en(t.cached),stale:en(t.stale),refreshing:en(t.refreshing),status:a,summary:y(t.summary)??null,model:y(t.model)??null,ttl_sec:D(t.ttl_sec),criteria:H(t.criteria).map(i=>typeof i=="string"?i.trim():"").filter(Boolean),basis:{current_room:y(n.current_room)??null,crew_count:D(n.crew_count),agent_count:D(n.agent_count),keeper_count:D(n.keeper_count)},metadata_gap_count:D(t.metadata_gap_count),metadata_gaps:H(t.metadata_gaps).map(Jm).filter(i=>i!==null),sections:H(t.sections).map(Gm).filter(i=>i!==null),error:y(t.error)??null,last_error:y(t.last_error)??null}}async function ac(){Jo.value=!0,la.value=null;try{const e=await ou();ls.value=Um(e)}catch(e){la.value=e instanceof Error?e.message:"Failed to load mission snapshot"}finally{Jo.value=!1}}async function Ym(e){if(!e){Vo.value=null,Gs.value=null,Ws.value=!1;return}Ws.value=!0,Gs.value=null;try{const t=await iu(e);Vo.value=Wm(t)}catch(t){Gs.value=t instanceof Error?t.message:"Failed to load session detail"}finally{Ws.value=!1}}async function ca(e=!1){Kt.value=!0,Ct.value=null;try{const t=await ru(e),n=Vm(t);Xl.value=n,n.refreshing||n.status==="pending"?Lm():gr()}catch(t){Ct.value=t instanceof Error?t.message:"Failed to load mission briefing",gr()}finally{Kt.value=!1}}const oc=g(null),Yo=g(!1),Bt=g(null);async function ic(e,t){Yo.value=!0,Bt.value=null;try{oc.value=await lu(e,t)}catch(n){Bt.value=n instanceof Error?n.message:String(n)}finally{Yo.value=!1}}const Ii=g(null),Be=g(null),da=g(!1),ua=g(!1),pa=g(null),ma=g(null),Qo=g(null),_a=g(null),X=g("warroom"),cs=g(null),Xo=g(!1),va=g(null),Nt=g(null),fa=g(!1),ga=g(null),zi=g(null),Zo=g(!1),$a=g(null),ds=g(null),ei=g(!1),ha=g(null),Hn=g(null),ya=g(!1),Wn=g(null),tn=g(null);let Tn=null;function Ri(e){return e!=="summary"&&e!=="swarm"&&e!=="warroom"&&e!=="orchestra"}function rc(){if(typeof window>"u")return new URLSearchParams;const e=new URLSearchParams(window.location.search),t=window.location.hash.replace(/^#/,""),n=t.indexOf("?");return n>=0&&new URLSearchParams(t.slice(n+1)).forEach((a,i)=>{e.has(i)||e.set(i,a)}),e}function lc(){const t=rc().get("run_id")??void 0;return t&&t.trim()!==""?t.trim():void 0}function cc(){const t=rc().get("operation_id")??void 0;return t&&t.trim()!==""?t.trim():void 0}function Qm(e){if(m(e))return{policy_class:r(e.policy_class),approval_class:r(e.approval_class),tool_allowlist:w(e.tool_allowlist),model_allowlist:w(e.model_allowlist),requires_human_for:w(e.requires_human_for),autonomy_level:r(e.autonomy_level),escalation_timeout_sec:d(e.escalation_timeout_sec),kill_switch:j(e.kill_switch),frozen:j(e.frozen)}}function Xm(e){if(m(e))return{headcount_cap:d(e.headcount_cap),active_operation_cap:d(e.active_operation_cap),max_cost_usd:d(e.max_cost_usd),max_tokens:d(e.max_tokens)}}function Li(e){if(!m(e))return null;const t=r(e.unit_id),n=r(e.label),s=r(e.kind);return!t||!n||!s?null:{unit_id:t,label:n,kind:s,parent_unit_id:r(e.parent_unit_id)??null,leader_id:r(e.leader_id)??null,roster:w(e.roster),capability_profile:w(e.capability_profile),source:r(e.source),created_at:r(e.created_at),updated_at:r(e.updated_at),policy:Qm(e.policy),budget:Xm(e.budget)}}function dc(e){if(!m(e))return null;const t=Li(e.unit);return t?{unit:t,leader_status:r(e.leader_status),roster_total:d(e.roster_total),roster_live:d(e.roster_live),active_operation_count:d(e.active_operation_count),health:r(e.health),reasons:w(e.reasons),children:Array.isArray(e.children)?e.children.map(dc).filter(n=>n!==null):[]}:null}function Zm(e){if(m(e))return{total_units:d(e.total_units),company_count:d(e.company_count),platoon_count:d(e.platoon_count),squad_count:d(e.squad_count),leaf_agent_unit_count:d(e.leaf_agent_unit_count),live_agent_count:d(e.live_agent_count),managed_unit_count:d(e.managed_unit_count),active_operation_count:d(e.active_operation_count)}}function uc(e){const t=m(e)?e:{};return{version:r(t.version),generated_at:r(t.generated_at),source:r(t.source),summary:Zm(t.summary),units:Array.isArray(t.units)?t.units.map(dc).filter(n=>n!==null):[]}}function e_(e){if(!m(e))return null;const t=r(e.kind),n=r(e.status);return!t||!n?null:{kind:t,chain_id:r(e.chain_id)??null,goal:r(e.goal)??null,run_id:r(e.run_id)??null,status:n,viewer_path:r(e.viewer_path)??null,last_sync_at:r(e.last_sync_at)??null}}function Wa(e){if(!m(e))return null;const t=r(e.operation_id),n=r(e.objective),s=r(e.assigned_unit_id),a=r(e.trace_id),i=r(e.status);return!t||!n||!s||!a||!i?null:{operation_id:t,objective:n,assigned_unit_id:s,autonomy_level:r(e.autonomy_level),policy_class:r(e.policy_class),budget_class:r(e.budget_class),detachment_session_id:r(e.detachment_session_id)??null,trace_id:a,checkpoint_ref:r(e.checkpoint_ref)??null,active_goal_ids:w(e.active_goal_ids),note:r(e.note)??null,created_by:r(e.created_by),source:r(e.source),status:i,chain:e_(e.chain),created_at:r(e.created_at),updated_at:r(e.updated_at)}}function t_(e){if(!m(e))return null;const t=Wa(e.operation);return t?{operation:t,assigned_unit_label:r(e.assigned_unit_label)}:null}function kn(e){if(m(e))return{tone:r(e.tone),pending_ops:d(e.pending_ops),blocked_ops:d(e.blocked_ops),in_flight_ops:d(e.in_flight_ops),pipeline_stalls:d(e.pipeline_stalls),bus_traffic:d(e.bus_traffic),l1_hit_rate:d(e.l1_hit_rate),invalidation_count:d(e.invalidation_count),current_pending:d(e.current_pending),current_in_flight:d(e.current_in_flight),cdb_wakeups:d(e.cdb_wakeups),total_stolen:d(e.total_stolen),avg_best_score:d(e.avg_best_score),avg_candidate_count:d(e.avg_candidate_count),best_first_operations:d(e.best_first_operations),active_sessions:d(e.active_sessions),commit_rate:d(e.commit_rate),total_speculations:d(e.total_speculations)}}function n_(e){if(!m(e))return;const t=m(e.pipeline)?e.pipeline:void 0,n=m(e.cache)?e.cache:void 0,s=m(e.ooo)?e.ooo:void 0,a=m(e.speculative)?e.speculative:void 0,i=m(e.search_fabric)?e.search_fabric:void 0,l=m(e.signals)?e.signals:void 0;return{pipeline:t?{total_ops:d(t.total_ops),completed_ops:d(t.completed_ops),stalled_cycles:d(t.stalled_cycles),hazards_detected:d(t.hazards_detected),forwarding_used:d(t.forwarding_used),pipeline_flushes:d(t.pipeline_flushes),ipc:d(t.ipc)}:void 0,cache:n?{total_reads:d(n.total_reads),total_writes:d(n.total_writes),l1_hit_rate:d(n.l1_hit_rate),invalidation_count:d(n.invalidation_count),writeback_count:d(n.writeback_count),bus_traffic:d(n.bus_traffic)}:void 0,ooo:s?{agent_count:d(s.agent_count),total_added:d(s.total_added),total_issued:d(s.total_issued),total_completed:d(s.total_completed),total_stolen:d(s.total_stolen),cdb_wakeups:d(s.cdb_wakeups),stall_cycles:d(s.stall_cycles),global_cdb_events:d(s.global_cdb_events),current_pending:d(s.current_pending),current_in_flight:d(s.current_in_flight)}:void 0,speculative:a?{total_speculations:d(a.total_speculations),total_commits:d(a.total_commits),total_aborts:d(a.total_aborts),commit_rate:d(a.commit_rate),total_fast_calls:d(a.total_fast_calls),total_cost_usd:d(a.total_cost_usd),active_sessions:d(a.active_sessions)}:void 0,search_fabric:i?{total_operations:d(i.total_operations),best_first_operations:d(i.best_first_operations),legacy_operations:d(i.legacy_operations),blocked_operations:d(i.blocked_operations),ready_operations:d(i.ready_operations),research_pipeline_operations:d(i.research_pipeline_operations),avg_candidate_count:d(i.avg_candidate_count),avg_best_score:d(i.avg_best_score),top_stage:r(i.top_stage)??null}:void 0,signals:l?{issue_pressure:kn(l.issue_pressure),cache_contention:kn(l.cache_contention),scheduler_efficiency:kn(l.scheduler_efficiency),routing_confidence:kn(l.routing_confidence),speculative_posture:kn(l.speculative_posture)}:void 0}}function pc(e){const t=m(e)?e:{},n=m(t.summary)?t.summary:void 0;return{version:r(t.version),generated_at:r(t.generated_at),summary:n?{total:d(n.total),active:d(n.active),paused:d(n.paused),managed:d(n.managed),projected:d(n.projected)}:void 0,microarch:n_(t.microarch),operations:Array.isArray(t.operations)?t.operations.map(t_).filter(s=>s!==null):[]}}function mc(e){if(!m(e))return null;const t=r(e.detachment_id),n=r(e.operation_id),s=r(e.assigned_unit_id);return!t||!n||!s?null:{detachment_id:t,operation_id:n,assigned_unit_id:s,leader_id:r(e.leader_id)??null,roster:w(e.roster),session_id:r(e.session_id)??null,checkpoint_ref:r(e.checkpoint_ref)??null,runtime_kind:r(e.runtime_kind)??null,runtime_ref:r(e.runtime_ref)??null,source:r(e.source),status:r(e.status),last_event_at:r(e.last_event_at)??null,last_progress_at:r(e.last_progress_at)??null,heartbeat_deadline:r(e.heartbeat_deadline)??null,created_at:r(e.created_at),updated_at:r(e.updated_at)}}function s_(e){if(!m(e))return null;const t=mc(e.detachment);return t?{detachment:t,assigned_unit_label:r(e.assigned_unit_label),operation:Wa(e.operation)}:null}function _c(e){const t=m(e)?e:{},n=m(t.summary)?t.summary:void 0;return{version:r(t.version),generated_at:r(t.generated_at),summary:n?{total:d(n.total),active:d(n.active),projected:d(n.projected)}:void 0,detachments:Array.isArray(t.detachments)?t.detachments.map(s_).filter(s=>s!==null):[]}}function a_(e){if(!m(e))return null;const t=r(e.decision_id),n=r(e.trace_id),s=r(e.requested_action),a=r(e.scope_type),i=r(e.scope_id);return!t||!n||!s||!a||!i?null:{decision_id:t,trace_id:n,requested_action:s,scope_type:a,scope_id:i,operation_id:r(e.operation_id)??null,target_unit_id:r(e.target_unit_id)??null,requested_by:r(e.requested_by),status:r(e.status),reason:r(e.reason)??null,source:r(e.source),detail:e.detail,created_at:r(e.created_at),decided_at:r(e.decided_at)??null,expires_at:r(e.expires_at)??null}}function vc(e){const t=m(e)?e:{},n=m(t.summary)?t.summary:void 0;return{version:r(t.version),generated_at:r(t.generated_at),summary:n?{total:d(n.total),pending:d(n.pending),approved:d(n.approved),denied:d(n.denied)}:void 0,decisions:Array.isArray(t.decisions)?t.decisions.map(a_).filter(s=>s!==null):[]}}function o_(e){if(!m(e))return null;const t=Li(e.unit);return t?{unit:t,roster_total:d(e.roster_total),roster_live:d(e.roster_live),headcount_cap:d(e.headcount_cap),active_operations:d(e.active_operations),active_operation_cap:d(e.active_operation_cap),utilization:d(e.utilization)}:null}function i_(e){const t=m(e)?e:{};return{version:r(t.version),generated_at:r(t.generated_at),capacity:Array.isArray(t.capacity)?t.capacity.map(o_).filter(n=>n!==null):[]}}function r_(e){if(!m(e))return null;const t=r(e.alert_id);return t?{alert_id:t,severity:r(e.severity),kind:r(e.kind),scope_type:r(e.scope_type),scope_id:r(e.scope_id),title:r(e.title),detail:r(e.detail),timestamp:r(e.timestamp)}:null}function fc(e){const t=m(e)?e:{},n=m(t.summary)?t.summary:void 0;return{version:r(t.version),generated_at:r(t.generated_at),summary:n?{total:d(n.total),bad:d(n.bad),warn:d(n.warn)}:void 0,alerts:Array.isArray(t.alerts)?t.alerts.map(r_).filter(s=>s!==null):[]}}function gc(e){if(!m(e))return null;const t=r(e.event_id),n=r(e.trace_id),s=r(e.event_type);return!t||!n||!s?null:{event_id:t,trace_id:n,event_type:s,operation_id:r(e.operation_id)??null,unit_id:r(e.unit_id)??null,actor:r(e.actor)??null,source:r(e.source),timestamp:r(e.timestamp),detail:e.detail}}function l_(e){const t=m(e)?e:{};return{version:r(t.version),generated_at:r(t.generated_at),events:Array.isArray(t.events)?t.events.map(gc).filter(n=>n!==null):[]}}function c_(e){if(!m(e))return null;const t=r(e.code),n=r(e.severity),s=r(e.summary);return!t||!n||!s?null:{code:t,severity:n,summary:s}}function d_(e){if(!m(e))return null;const t=r(e.lane_id),n=r(e.label),s=r(e.kind),a=r(e.phase),i=r(e.motion_state),l=r(e.source_of_truth),c=r(e.movement_reason),p=r(e.current_step);if(!t||!n||!s||!a||!i||!l||!c||!p)return null;const _=m(e.counts)?e.counts:{};return{lane_id:t,label:n,kind:s,present:j(e.present)??!1,phase:a,motion_state:i,source_of_truth:l,last_movement_at:r(e.last_movement_at)??null,movement_reason:c,current_step:p,blockers:w(e.blockers),counts:{operations:d(_.operations),detachments:d(_.detachments),workers:d(_.workers),approvals:d(_.approvals),alerts:d(_.alerts)},hard_flags:Array.isArray(e.hard_flags)?e.hard_flags.map(c_).filter(u=>u!==null):[]}}function u_(e){if(!m(e))return null;const t=r(e.event_id),n=r(e.lane_id),s=r(e.kind),a=r(e.timestamp),i=r(e.title),l=r(e.detail),c=r(e.tone),p=r(e.source);return!t||!n||!s||!a||!i||!l||!c||!p?null:{event_id:t,lane_id:n,kind:s,timestamp:a,title:i,detail:l,tone:c,source:p}}function p_(e){if(!m(e))return null;const t=r(e.code),n=r(e.severity),s=r(e.summary);return!t||!n||!s?null:{code:t,severity:n,summary:s,why_it_matters:r(e.why_it_matters)??void 0,next_tool:r(e.next_tool)??void 0,next_step:r(e.next_step)??void 0,lane_ids:w(e.lane_ids),count:d(e.count)??0}}function Pi(e){if(!m(e))return;const t=m(e.overview)?e.overview:{},n=m(e.gaps)?e.gaps:{},s=m(e.narrative)?e.narrative:{},a=m(e.recommended_next_action)?e.recommended_next_action:void 0;return{generated_at:r(e.generated_at),narrative:{state:r(s.state)??void 0,started:r(s.started)??void 0,active_work:r(s.active_work)??void 0,completion:r(s.completion)??void 0,lane_id:r(s.lane_id)??null},overview:{active_lanes:d(t.active_lanes),moving_lanes:d(t.moving_lanes),stalled_lanes:d(t.stalled_lanes),projected_lanes:d(t.projected_lanes),last_movement_at:r(t.last_movement_at)??null},lanes:Array.isArray(e.lanes)?e.lanes.map(d_).filter(i=>i!==null):[],timeline:Array.isArray(e.timeline)?e.timeline.map(u_).filter(i=>i!==null):[],gaps:{count:d(n.count),items:Array.isArray(n.items)?n.items.map(p_).filter(i=>i!==null):[]},recommended_next_action:a?{tool:r(a.tool)??"masc_operator_snapshot",label:r(a.label)??"Observe operator state",reason:r(a.reason)??"",lane_id:r(a.lane_id)??null}:void 0}}function $c(e){if(!m(e))return;const t=m(e.workers)?e.workers:{},n=j(e.pass);return{status:r(e.status)??"missing",source:r(e.source)??"none",reason_code:r(e.reason_code)??null,status_summary:r(e.status_summary)??null,run_id:r(e.run_id)??null,captured_at:r(e.captured_at)??null,...n!==void 0?{pass:n}:{},...d(e.peak_hot_slots)!=null?{peak_hot_slots:d(e.peak_hot_slots)}:{},...d(e.ctx_per_slot)!=null?{ctx_per_slot:d(e.ctx_per_slot)}:{},workers:{expected:d(t.expected),joined:d(t.joined),current_task_bound:d(t.current_task_bound),fresh_heartbeats:d(t.fresh_heartbeats),done:d(t.done),final:d(t.final)},expected_artifact_dir:r(e.expected_artifact_dir)??null,artifact_ref:r(e.artifact_ref)??null,missing_reason:r(e.missing_reason)??null}}function m_(e){const t=m(e)?e:{};return{version:r(t.version),generated_at:r(t.generated_at),topology:uc(t.topology),operations:pc(t.operations),detachments:_c(t.detachments),alerts:fc(t.alerts),decisions:vc(t.decisions),capacity:i_(t.capacity),traces:l_(t.traces),swarm_status:Pi(t.swarm_status)}}function __(e){const t=m(e)?e:{},n=uc(t.topology),s=pc(t.operations),a=_c(t.detachments),i=fc(t.alerts),l=vc(t.decisions);return{version:r(t.version),generated_at:r(t.generated_at),topology:{version:n.version,generated_at:n.generated_at,source:n.source,summary:n.summary},operations:{version:s.version,generated_at:s.generated_at,summary:s.summary,microarch:s.microarch},detachments:{version:a.version,generated_at:a.generated_at,summary:a.summary},alerts:{version:i.version,generated_at:i.generated_at,summary:i.summary},decisions:{version:l.version,generated_at:l.generated_at,summary:l.summary},swarm_status:Pi(t.swarm_status),swarm_proof:$c(t.swarm_proof)}}function v_(e){return m(e)?{chain_id:r(e.chain_id)??null,started_at:d(e.started_at)??null,progress:d(e.progress)??null,elapsed_sec:d(e.elapsed_sec)??null}:null}function hc(e){if(!m(e))return null;const t=r(e.event);return t?{event:t,chain_id:r(e.chain_id)??null,timestamp:r(e.timestamp)??null,duration_ms:d(e.duration_ms)??null,message:r(e.message)??null,tokens:d(e.tokens)??null}:null}function f_(e){if(!m(e))return null;const t=Wa(e.operation);return t?{operation:t,runtime:v_(e.runtime),history:hc(e.history),mermaid:r(e.mermaid)??null,preview_run:yc(e.preview_run)}:null}function g_(e){const t=m(e)?e:{};return{status:r(t.status)??"disconnected",base_url:r(t.base_url)??null,message:r(t.message)??null}}function $_(e){const t=m(e)?e:{},n=m(t.summary)?t.summary:void 0;return{version:r(t.version),generated_at:r(t.generated_at),connection:g_(t.connection),summary:n?{linked_operations:d(n.linked_operations),active_chains:d(n.active_chains),running_operations:d(n.running_operations),recent_failures:d(n.recent_failures),last_history_event_at:r(n.last_history_event_at)??null}:void 0,operations:Array.isArray(t.operations)?t.operations.map(f_).filter(s=>s!==null):[],recent_history:Array.isArray(t.recent_history)?t.recent_history.map(hc).filter(s=>s!==null):[]}}function h_(e){if(!m(e))return null;const t=r(e.id);return t?{id:t,type:r(e.type),status:r(e.status),duration_ms:d(e.duration_ms)??null,error:r(e.error)??null}:null}function yc(e){if(!m(e))return null;const t=r(e.run_id),n=r(e.chain_id);return n?{run_id:t??null,chain_id:n,duration_ms:d(e.duration_ms),success:j(e.success),mermaid:r(e.mermaid),nodes:Array.isArray(e.nodes)?e.nodes.map(h_).filter(s=>s!==null):[]}:null}function y_(e){const t=m(e)?e:{};return{run:yc(t.run)}}function b_(e){if(!m(e))return null;const t=r(e.title),n=r(e.path);return!t||!n?null:{title:t,path:n}}function k_(e){if(!m(e))return null;const t=r(e.id),n=r(e.title),s=r(e.summary);return!t||!n||!s?null:{id:t,title:n,summary:s}}function x_(e){if(!m(e))return null;const t=r(e.id),n=r(e.title),s=r(e.tool),a=r(e.summary);return!t||!n||!s||!a?null:{id:t,title:n,tool:s,summary:a,success_signals:w(e.success_signals),pitfalls:w(e.pitfalls)}}function S_(e){if(!m(e))return null;const t=r(e.id),n=r(e.title),s=r(e.summary),a=r(e.when_to_use);return!t||!n||!s||!a?null:{id:t,title:n,summary:s,when_to_use:a,steps:Array.isArray(e.steps)?e.steps.map(x_).filter(i=>i!==null):[]}}function C_(e){if(!m(e))return null;const t=r(e.id),n=r(e.title),s=r(e.description);return!t||!n||!s?null:{id:t,title:n,description:s,tools:w(e.tools)}}function A_(e){if(!m(e))return null;const t=r(e.id),n=r(e.title),s=r(e.symptom),a=r(e.why),i=r(e.fix_tool),l=r(e.fix_summary);return!t||!n||!s||!a||!i||!l?null:{id:t,title:n,symptom:s,why:a,fix_tool:i,fix_summary:l}}function T_(e){if(!m(e))return null;const t=r(e.id),n=r(e.title),s=r(e.path_id),a=r(e.transport);return!t||!n||!s||!a?null:{id:t,title:n,path_id:s,transport:a,request:e.request,response:e.response,notes:w(e.notes)}}function I_(e){const t=m(e)?e:{};return{version:r(t.version),generated_at:r(t.generated_at),docs:Array.isArray(t.docs)?t.docs.map(b_).filter(n=>n!==null):[],concepts:Array.isArray(t.concepts)?t.concepts.map(k_).filter(n=>n!==null):[],golden_paths:Array.isArray(t.golden_paths)?t.golden_paths.map(S_).filter(n=>n!==null):[],tool_groups:Array.isArray(t.tool_groups)?t.tool_groups.map(C_).filter(n=>n!==null):[],pitfalls:Array.isArray(t.pitfalls)?t.pitfalls.map(A_).filter(n=>n!==null):[],examples:Array.isArray(t.examples)?t.examples.map(T_).filter(n=>n!==null):[]}}function z_(e){if(!m(e))return null;const t=r(e.id),n=r(e.title),s=r(e.status),a=r(e.detail),i=r(e.next_tool);return!t||!n||!s||!a||!i?null:{id:t,title:n,status:s,detail:a,next_tool:i}}function R_(e){if(!m(e))return null;const t=r(e.code),n=r(e.severity),s=r(e.title),a=r(e.detail),i=r(e.next_tool);return!t||!n||!s||!a||!i?null:{code:t,severity:n,title:s,detail:a,next_tool:i}}function L_(e){if(!m(e))return null;const t=r(e.from),n=r(e.content),s=r(e.timestamp),a=d(e.seq);return!t||!n||!s||a==null?null:{seq:a,from:t,content:n,timestamp:s}}function P_(e){if(!m(e))return null;const t=r(e.name),n=r(e.role),s=r(e.lane),a=r(e.status),i=r(e.claim_marker),l=r(e.done_marker),c=r(e.final_marker);if(!t||!n||!s||!a||!i||!l||!c)return null;const p=(()=>{if(!m(e.last_message))return null;const _=d(e.last_message.seq),u=r(e.last_message.content),f=r(e.last_message.timestamp);return _==null||!u||!f?null:{seq:_,content:u,timestamp:f}})();return{name:t,role:n,lane:s,joined:j(e.joined)??!1,live_presence:j(e.live_presence)??!1,completed:j(e.completed)??!1,status:a,current_task:r(e.current_task)??null,bound_task_id:r(e.bound_task_id)??null,bound_task_title:r(e.bound_task_title)??null,bound_task_status:r(e.bound_task_status)??null,current_task_matches_run:j(e.current_task_matches_run)??!1,squad_member:j(e.squad_member)??!1,detachment_member:j(e.detachment_member)??!1,last_seen:r(e.last_seen)??null,heartbeat_age_sec:d(e.heartbeat_age_sec)??null,heartbeat_fresh:j(e.heartbeat_fresh)??!1,claim_marker_seen:j(e.claim_marker_seen)??!1,done_marker_seen:j(e.done_marker_seen)??!1,final_marker_seen:j(e.final_marker_seen)??!1,claim_marker:i,done_marker:l,final_marker:c,last_message:p}}function M_(e){if(!m(e))return;const t=Array.isArray(e.timeline)?e.timeline.map(n=>{if(!m(n))return null;const s=r(n.timestamp),a=d(n.active_slots);if(!s||a==null)return null;const i=Array.isArray(n.active_slot_ids)?n.active_slot_ids.map(l=>typeof l=="number"&&Number.isFinite(l)?l:null).filter(l=>l!=null):[];return{timestamp:s,active_slots:a,active_slot_ids:i}}).filter(n=>n!==null):[];return{slot_url:r(e.slot_url)??null,provider_base_url:r(e.provider_base_url)??null,provider_reachable:j(e.provider_reachable)??null,provider_status_code:d(e.provider_status_code)??null,provider_model_id:r(e.provider_model_id)??null,actual_model_id:r(e.actual_model_id)??null,expected_slots:d(e.expected_slots),actual_slots:d(e.actual_slots),expected_ctx:d(e.expected_ctx),actual_ctx:d(e.actual_ctx),configured_capacity:d(e.configured_capacity),slot_reachable:j(e.slot_reachable)??null,slot_status_code:d(e.slot_status_code)??null,runtime_blocker:r(e.runtime_blocker)??null,detail:r(e.detail)??null,checked_at:r(e.checked_at)??null,total_slots:d(e.total_slots),ctx_per_slot:d(e.ctx_per_slot),active_slots_now:d(e.active_slots_now),peak_active_slots:d(e.peak_active_slots),sample_count:d(e.sample_count),last_sample_at:r(e.last_sample_at)??null,timeline:t}}function j_(e){if(!m(e))return null;const t=r(e.run_id),n=r(e.status),s=r(e.decided_by),a=r(e.decided_at),i=r(e.reason);if(!t||!n||!s||!a||!i)return null;const l=[];return Array.isArray(e.history)&&e.history.forEach(c=>{if(!m(c))return;const p=r(c.status),_=r(c.decided_by),u=r(c.decided_at),f=r(c.reason);!p||!_||!u||!f||l.push({status:p,decided_by:_,decided_at:u,reason:f,operation_id:r(c.operation_id)??null,detachment_id:r(c.detachment_id)??null,note:r(c.note)??null})}),{run_id:t,status:n,decided_by:s,decided_at:a,reason:i,operation_id:r(e.operation_id)??null,detachment_id:r(e.detachment_id)??null,note:r(e.note)??null,history:l}}function E_(e){if(!m(e))return null;const t=r(e.run_id),n=r(e.recommended_kind),s=r(e.reason);return!t||!n||!s?null:{run_id:t,recommended_kind:n,continue_available:j(e.continue_available)??!1,rerun_available:j(e.rerun_available)??!1,abandon_available:j(e.abandon_available)??!1,reason:s,evidence:m(e.evidence)?{operation_id:r(e.evidence.operation_id)??null,detachment_id:r(e.evidence.detachment_id)??null,joined_workers:d(e.evidence.joined_workers),current_task_bound:d(e.evidence.current_task_bound),fresh_heartbeats:d(e.evidence.fresh_heartbeats),trace_events:d(e.evidence.trace_events),message_events:d(e.evidence.message_events),runtime_blocker:r(e.evidence.runtime_blocker)??null}:void 0,provenance:r(e.provenance),decision_engine:r(e.decision_engine),authoritative:j(e.authoritative)}}function N_(e){const t=m(e)?e:{},n=m(t.summary)?t.summary:void 0;return{version:r(t.version),generated_at:r(t.generated_at),run_id:r(t.run_id),room_id:r(t.room_id),operation_id:r(t.operation_id)??null,run_resolution:j_(t.run_resolution),resolution_recommendation:E_(t.resolution_recommendation),recommended_next_tool:r(t.recommended_next_tool),summary:n?{expected_workers:d(n.expected_workers),joined_workers:d(n.joined_workers),live_workers:d(n.live_workers),squad_roster_size:d(n.squad_roster_size),detachment_roster_size:d(n.detachment_roster_size),current_task_bound:d(n.current_task_bound),fresh_heartbeats:d(n.fresh_heartbeats),claim_markers_seen:d(n.claim_markers_seen),done_markers_seen:d(n.done_markers_seen),final_markers_seen:d(n.final_markers_seen),completed_workers:d(n.completed_workers),peak_hot_slots:d(n.peak_hot_slots),hot_window_ok:j(n.hot_window_ok),pass_hot_concurrency:j(n.pass_hot_concurrency),pass_end_to_end:j(n.pass_end_to_end),pending_decisions:d(n.pending_decisions),pass:j(n.pass)}:void 0,provider:M_(t.provider),operation:Wa(t.operation),squad:Li(t.squad),detachment:mc(t.detachment),workers:Array.isArray(t.workers)?t.workers.map(P_).filter(s=>s!==null):[],checklist:Array.isArray(t.checklist)?t.checklist.map(z_).filter(s=>s!==null):[],blockers:Array.isArray(t.blockers)?t.blockers.map(R_).filter(s=>s!==null):[],recent_messages:Array.isArray(t.recent_messages)?t.recent_messages.map(L_).filter(s=>s!==null):[],recent_trace_events:Array.isArray(t.recent_trace_events)?t.recent_trace_events.map(gc).filter(s=>s!==null):[],truth_notes:w(t.truth_notes)}}function D_(e){if(!m(e))return null;const t=r(e.label),n=r(e.value);return!t||!n?null:{label:t,value:n}}function O_(e){if(!m(e))return null;const t=r(e.id),n=r(e.kind),s=r(e.label),a=r(e.tone),i=r(e.provenance);return!t||!n||!s||!a||!i?null:{id:t,kind:n,label:s,subtitle:r(e.subtitle)??null,status:r(e.status)??null,tone:a,pulse:r(e.pulse)??null,provenance:i,visual_class:r(e.visual_class)??void 0,glyph:r(e.glyph)??void 0,parent_id:r(e.parent_id)??null,lane_id:r(e.lane_id)??null,link_tab:r(e.link_tab)??null,link_surface:r(e.link_surface)??null,link_params:m(e.link_params)?Object.fromEntries(Object.entries(e.link_params).map(([l,c])=>{const p=r(c);return p?[l,p]:null}).filter(l=>l!==null)):{},facts:Array.isArray(e.facts)?e.facts.map(D_).filter(l=>l!==null):[]}}function q_(e){if(!m(e))return null;const t=r(e.id),n=r(e.source),s=r(e.target),a=r(e.kind),i=r(e.tone),l=r(e.provenance);return!t||!n||!s||!a||!i||!l?null:{id:t,source:n,target:s,kind:a,label:r(e.label)??null,tone:i,provenance:l,animated:j(e.animated)}}function w_(e){if(!m(e))return null;const t=r(e.id),n=r(e.kind),s=r(e.label),a=r(e.tone),i=r(e.provenance);return!t||!n||!s||!a||!i?null:{id:t,kind:n,label:s,detail:r(e.detail)??null,tone:a,provenance:i,source_id:r(e.source_id)??null,target_id:r(e.target_id)??null,suggested_surface:r(e.suggested_surface)??null,suggested_params:m(e.suggested_params)?Object.fromEntries(Object.entries(e.suggested_params).map(([l,c])=>{const p=r(c);return p?[l,p]:null}).filter(l=>l!==null)):{}}}function F_(e){if(!m(e))return null;const t=r(e.target_kind),n=r(e.target_id),s=r(e.label),a=r(e.reason);return!t||!n||!s||!a?null:{target_kind:t,target_id:n,label:s,reason:a,suggested_surface:r(e.suggested_surface)??null,suggested_params:m(e.suggested_params)?Object.fromEntries(Object.entries(e.suggested_params).map(([i,l])=>{const c=r(l);return c?[i,c]:null}).filter(i=>i!==null)):{}}}function K_(e){const t=m(e)?e:{},n=m(t.room)?t.room:{},s=m(t.summary)?t.summary:void 0;return{version:r(t.version),generated_at:r(t.generated_at),room:{room_id:r(n.room_id),project:r(n.project),cluster:r(n.cluster),paused:j(n.paused),pause_reason:r(n.pause_reason)??null,agent_count:d(n.agent_count),task_count:d(n.task_count),message_count:d(n.message_count)},summary:s?{session_count:d(s.session_count),operation_count:d(s.operation_count),detachment_count:d(s.detachment_count),lane_count:d(s.lane_count),worker_count:d(s.worker_count),keeper_count:d(s.keeper_count),signal_count:d(s.signal_count),alert_count:d(s.alert_count)}:void 0,nodes:Array.isArray(t.nodes)?t.nodes.map(O_).filter(a=>a!==null):[],edges:Array.isArray(t.edges)?t.edges.map(q_).filter(a=>a!==null):[],signals:Array.isArray(t.signals)?t.signals.map(w_).filter(a=>a!==null):[],focus:F_(t.focus),swarm_status:Pi(t.swarm_status),swarm_proof:$c(t.swarm_proof),truth_notes:w(t.truth_notes)}}function rt(e){X.value=e,Ri(e)&&B_()}async function bc(){da.value=!0,pa.value=null;try{const e=await _u();Ii.value=__(e)}catch(e){pa.value=e instanceof Error?e.message:"Failed to load command-plane summary"}finally{da.value=!1}}function Mi(e){tn.value=e}async function ji(){ua.value=!0,ma.value=null;try{const e=await mu();Be.value=m_(e)}catch(e){ma.value=e instanceof Error?e.message:"Failed to load command-plane snapshot"}finally{ua.value=!1}}async function B_(){Be.value||ua.value||await ji()}async function Ut(){await bc(),Ri(X.value)&&await ji()}async function nn(){var e;ei.value=!0,ha.value=null;try{const t=await vu(),n=$_(t);ds.value=n;const s=tn.value;n.operations.length===0?tn.value=null:(!s||!n.operations.some(a=>a.operation.operation_id===s))&&(tn.value=((e=n.operations[0])==null?void 0:e.operation.operation_id)??null)}catch(t){ha.value=t instanceof Error?t.message:"Failed to load chain summary"}finally{ei.value=!1}}function U_(){Tn=null,Hn.value=null,ya.value=!1,Wn.value=null}async function H_(e){Tn=e,ya.value=!0,Wn.value=null;try{const t=await fu(e);if(Tn!==e)return;Hn.value=y_(t)}catch(t){if(Tn!==e)return;Hn.value=null,Wn.value=t instanceof Error?t.message:"Failed to load chain run"}finally{Tn===e&&(ya.value=!1)}}async function W_(){Xo.value=!0,va.value=null;try{const e=await gu();cs.value=I_(e)}catch(e){va.value=e instanceof Error?e.message:"Failed to load command-plane help"}finally{Xo.value=!1}}async function tt(e=lc(),t=cc()){fa.value=!0,ga.value=null;try{const n=await $u(e,t);Nt.value=N_(n)}catch(n){ga.value=n instanceof Error?n.message:"Failed to load command-plane swarm view"}finally{fa.value=!1}}async function Rt(e=lc(),t=cc()){Zo.value=!0,$a.value=null;try{const n=await hu(e,t);zi.value=K_(n)}catch(n){$a.value=n instanceof Error?n.message:"Failed to load orchestra map"}finally{Zo.value=!1}}async function ft(e,t,n){Qo.value=e,_a.value=null;try{await yu(t,n),await bc(),(Be.value||Ri(X.value))&&await ji(),await tt(),await Rt(),await nn()}catch(s){throw _a.value=s instanceof Error?s.message:"Failed to execute command-plane action",s}finally{Qo.value=null}}function G_(e){return ft(`pause:${e}`,"/api/v1/command-plane/operations/pause",{operation_id:e})}function J_(e){return ft(`resume:${e}`,"/api/v1/command-plane/operations/resume",{operation_id:e})}function V_(e){return ft(`recall:${e}`,"/api/v1/command-plane/dispatch/recall",{operation_id:e})}function Y_(e={}){return ft("dispatch:tick","/api/v1/command-plane/dispatch/tick",{...e.operationId?{operation_id:e.operationId}:{},...e.detachmentId?{detachment_id:e.detachmentId}:{}})}function Q_(e){return ft(`approve:${e}`,"/api/v1/command-plane/policy/approve",{decision_id:e})}function X_(e){return ft(`deny:${e}`,"/api/v1/command-plane/policy/deny",{decision_id:e})}function Z_(e,t){return ft(`freeze:${e}`,"/api/v1/command-plane/policy/freeze",{unit_id:e,enabled:t})}function ev(e,t){return ft(`kill:${e}`,"/api/v1/command-plane/policy/kill-switch",{unit_id:e,enabled:t})}fm(()=>{Ut(),nn(),(X.value==="swarm"||X.value==="warroom"||X.value==="orchestra"||Nt.value!==null)&&tt(),(X.value==="orchestra"||zi.value!==null)&&Rt(),X.value==="warroom"&&xe()});function ti(e){e==="command"&&(It(),Ut(),nn(),(X.value==="swarm"||X.value==="warroom"||X.value==="orchestra")&&tt(),X.value==="orchestra"&&Rt(),X.value==="warroom"&&xe()),e==="mission"&&(It(),ac(),ca()),e==="proof"&&ic(O.value.params.session_id,O.value.params.operation_id),e==="execution"&&(It(),Tt()),e==="intervene"&&(It(),xe(),jt()),e==="memory"&&ot(),e==="planning"&&Ci(),e==="lab"&&it()}function tv({metric:e}){return o`
  ...
  `:sa.value?o`<span class="semantic-inline-state">의미 계층 불러오는 중…</span>`:null}function Se({surfaceId:e,compact:t=!1}){const n=nm(e);return n?o`
  ...
  `:sa.value?o`<div class="semantic-surface-card ${t?"compact":""}">의미 계층 불러오는 중…</div>`:aa.value?o`<div class="semantic-surface-card ${t?"compact":""}">${aa.value}</div>`:null}function T({title:e,class:t,semanticId:n,testId:s,children:a}){return o`
  ...
  `}function no(e){const t=(e??"").trim().toLowerCase();return t==="bad"||t==="critical"||t==="offline"?"bad":t==="warn"||t==="paused"||t==="blocked"?"warn":"ok"}function sv(){var n;const e=(n=Ai.value)==null?void 0:n.focus;if(!(e!=null&&e.suggested_tab))return;const t=e.suggested_params??{};if(e.suggested_tab==="intervene"){ie("intervene",t);return}ie("command",{...e.suggested_surface?{surface:e.suggested_surface}:{},...t})}function Ga(){var p,_,u,f,v,h;const e=Ai.value;if(!e)return Go.value?o`<section class="room-truth-strip room-truth-strip-loading">room truth 불러오는 중...</section>`:oa.value?o`<section class="room-truth-strip room-truth-strip-error">${oa.value}</section>`:null;const t=e.room.status,n=e.room.counts,s=(p=e.execution)==null?void 0:p.summary,a=(_=e.execution)==null?void 0:_.top_queue,i=e.command,l=e.operator,c=e.focus;return o`
    <section class="room-truth-strip">
      ...
      <article class="room-truth-card">
        ...
        <div class="room-truth-chip-row">
          <span class="command-chip ${no(((s==null?void 0:s.blocked_sessions)??0)>0?"warn":"ok")}">priority ${(s==null?void 0:s.priority_items)??0}</span>
      ...
      <article class="room-truth-card">
        ...
        <div class="room-truth-chip-row">
          <span class="command-chip ${no(((i==null?void 0:i.bad_alerts)??0)>0?"bad":((i==null?void 0:i.warn_alerts)??0)>0||((i==null?void 0:i.pending_approvals)??0)>0?"warn":"ok")}">
      ...
      <article class="room-truth-card room-truth-card-focus">
        ...
        <div class="room-truth-chip-row">
          <span class="command-chip ${no((c==null?void 0:c.provenance)==="fallback"?"warn":"ok")}">${(c==null?void 0:c.source)??"steady"}</span>
  ...
  `}const Tv="masc_dashboard_agent_name",$n=g(null),xa=g(!1),Gn=g(""),Sa=g([]),Jn=g([]),sn=g(""),Mn=g(!1);function ms(e){$n.value=e,wi()}function hr(){$n.value=null,Gn.value="",Sa.value=[],Jn.value=[],sn.value=""}function Iv(){const e=$n.value;return e?Qe.value.find(t=>t.name===e)??null:null}function Dc(e){return e?st.value.filter(t=>t.assignee===e):[]}function Oc(e){return e?vt.value.find(t=>t.agent_name===e||t.name===e)??null:null}function zv(e){if(!e)return null;const t=ls.value;return t?t.agent_briefs.find(n=>n.agent_name===e)??null:null}function Rv(e){if(!e)return[];const t=e.metrics_window;return(Array.isArray(t==null?void 0:t.top_tools)?t.top_tools:[]).map(s=>typeof s=="object"&&s!==null&&"tool"in s&&typeof s.tool=="string"?s.tool:null).filter(s=>s!==null)}function Lv(e){const t=Oc(e);return t?t.recent_tool_names&&t.recent_tool_names.length>0?t.recent_tool_names:[]:[]}function yr(...e){for(const t of e)if(t&&t.length>0)return t;return[]}function Pv(e){return e?bi.value.find(t=>t.agent_name===e||t.name===e)??null:null}function Mv(e){return e?yi.value.find(t=>t.agent_name===e||t.worker_name===e)??null:null}async function wi(){const e=$n.value;if(e){xa.value=!0,Gn.value="",Sa.value=[],Jn.value=[];try{const t=await ep(80);Sa.value=t.filter(a=>a.includes(e)).slice(0,20);const n=Dc(e).slice(0,6);if(n.length===0)return;const s=await Promise.all(n.map(async a=>{try{const i=await tp(a.id,25);return{taskId:a.id,text:i.trim()}}catch(i){const l=i instanceof Error?i.message:"history load failed";return{taskId:a.id,text:`Failed to load history: ${l}`}}}));Jn.value=s}catch(t){Gn.value=t instanceof Error?t.message:"Failed to load agent detail"}finally{xa.value=!1}}}async function br(){var s;const e=$n.value,t=sn.value.trim();if(!e||!t)return;const n=((s=localStorage.getItem(Tv))==null?void 0:s.trim())||"dashboard";Mn.value=!0;try{await Zu(n,`@${e} ${t}`),sn.value="",E(`Mention sent to ${e}`,"success"),wi()}catch(a){const i=a instanceof Error?a.message:"Failed to send mention";E(i,"error")}finally{Mn.value=!1}}function jv({task:e}){return o`
  ...
  `}function Nv(){var V,Z,ae,B,ee,A,G;const e=$n.value;if(!e)return null;const t=Iv(),n=Oc(e),s=Pv(e),a=Mv(e),i=zv(e),l=Dc(e),c=Sa.value,p=Lv(e),_=Rv(n),u=yr(s==null?void 0:s.allowed_tool_names,i==null?void 0:i.allowed_tool_names,a==null?void 0:a.allowed_tool_names,n==null?void 0:n.allowed_tool_names),f=yr(s==null?void 0:s.latest_tool_names,i==null?void 0:i.latest_tool_names,a==null?void 0:a.used_tool_names,n==null?void 0:n.latest_tool_names),v=(s==null?void 0:s.latest_tool_call_count)??(i==null?void 0:i.latest_tool_call_count)??(a==null?void 0:a.used_tool_call_count)??(n==null?void 0:n.latest_tool_call_count),h=(s==null?void 0:s.tool_audit_source)??(i==null?void 0:i.tool_audit_source)??(a==null?void 0:a.tool_audit_source)??(n==null?void 0:n.tool_audit_source),b=(s==null?void 0:s.tool_audit_at)??(i==null?void 0:i.tool_audit_at)??(a==null?void 0:a.tool_audit_at)??(n==null?void 0:n.tool_audit_at),C=(t==null?void 0:t.capabilities)??[],x=((V=re.value)==null?void 0:V.room)??"default",S=((Z=re.value)==null?void 0:Z.project)??"확인 없음",$=((ae=re.value)==null?void 0:ae.cluster)??"확인 없음",L=Ge(Pc(n)),I=Ge(Mc(n,h)),P=Ge(jc(n,h)),Q=Ge(qi(n)),z=u[0]??f[0]??p[0]??null;return o`
    <div
      class="agent-detail-overlay"
      data-testid="agent-detail-overlay"
      onClick=${R=>{R.target.classList.contains("agent-detail-overlay")&&hr()}}
    >
      <div class="agent-detail-modal">
        <div class="agent-detail-header">
          <div style="display:flex;flex-direction:column;gap:8px;flex:1">
            ...
            `:""}
            ${(((B=t==null?void 0:t.traits)==null?void 0:B.length)??0)>0?o`
              <div style="display:flex;flex-wrap:wrap;gap:4px">
                ${(ee=t==null?void 0:t.traits)==null?void 0:ee.map(R=>o`<span style="font-size:0.7rem;background:#1e3a5f;color:#60a5fa;padding:2px 8px;border-radius:10px">${R}</span>`)}
              </div>
            `:""}
            ${(((A=t==null?void 0:t.interests)==null?void 0:A.length)??0)>0?o`
              <div style="display:flex;flex-wrap:wrap;gap:4px">
                ${(G=t==null?void 0:t.interests)==null?void 0:G.map(R=>o`<span style="font-size:0.7rem;background:#3b1f4e;color:#c084fc;padding:2px 8px;border-radius:10px">${R}</span>`)}
              </div>
            `:""}
            ${C.length>0?o`
              <div style="display:flex;flex-wrap:wrap;gap:4px">
                ${C.map(R=>o`<span style="font-size:0.7rem;background:#183153;color:#7dd3fc;padding:2px 8px;border-radius:10px">${R}</span>`)}
              </div>
            `:""}
          ...
          <div class="agent-detail-actions">
            <button class="control-btn ghost" onClick=${()=>{wi()}} disabled=${xa.value}>
        ...
        <div class="agent-detail-grid">
          <${T} title="Assigned Tasks">
            ${l.length===0?o`<div class="empty-state">No assigned tasks</div>`:o`<div class="agent-detail-task-list">${l.map(R=>o`<${jv} key=${R.id} task=${R} />`)}</div>`}
          <//>

          <${T} title="Recent Activity">
            ${c.length===0?o`<div class="empty-state">No recent room activity match</div>`:o`<div class="agent-activity-list">${c.map((R,J)=>o`<div key=${J} class="agent-activity-line">${R}</div>`)}</div>`}
          <//>
        </div>
          ...
          <div style="display:flex; flex-direction:column; gap:12px;">
            <div>
              ...
              <div style="display:flex; flex-wrap:wrap; gap:6px;">
                ${C.length>0?C.map(R=>o`<span class="pill">${R}</span>`):o`<span class="empty-state" style="font-size:12px;">No capability metadata</span>`}
              </div>
            </div>
            <div style="display:flex; justify-content:flex-end;">
              <button class="control-btn ghost" onClick=${()=>{Ec(z)}}>
                Open tools panel
              </button>
            </div>
            <div>
              ...
              <div style="display:flex; flex-wrap:wrap; gap:6px;">
                ${u.length>0?u.map(R=>o`<span class="pill">${R}</span>`):o`<span class="empty-state" style="font-size:12px;">${L}</span>`}
              </div>
            </div>
            <div>
              ...
              <div style="display:flex; flex-wrap:wrap; gap:6px;">
                ${f.length>0?f.map(R=>o`<span class="pill">${R}</span>`):o`<span class="empty-state" style="font-size:12px;">${I}</span>`}
              </div>
            </div>
            <div class="agent-detail-sub">
              <span>Tool calls: ${typeof v=="number"?v:I==="none_recent"?0:P}</span>
              <span>Evidence source: ${h??P}</span>
              <span>
                Observed at:
                ${b?o` <${W} timestamp=${b} />`:` ${P}`}
              </span>
            ...
            <div>
              ...
              <div style="display:flex; flex-wrap:wrap; gap:6px;">
                ${p.length>0?p.map(R=>o`<span class="pill">${R}</span>`):o`<span class="empty-state" style="font-size:12px;">${Q}</span>`}
              </div>
            </div>
            ${_.length>0?o`
                  <div>
                    ...
                    <div style="display:flex; flex-wrap:wrap; gap:6px;">
                      ${_.map(R=>o`<span class="pill">${R}</span>`)}
                    </div>
                  </div>
                `:null}
            ${n?o`
        ...
        <${T} title="Task History">
          ${Jn.value.length===0?o`<div class="empty-state">No task history loaded</div>`:o`<div class="agent-history-list">${Jn.value.map(R=>o`<${Ev} key=${R.taskId} row=${R} />`)}</div>`}
        <//>
        ...
        <${T} title="Direct Mention">
          <div class="agent-mention-row">
            <input
              ...
              value=${sn.value}
              onInput=${R=>{sn.value=R.target.value}}
              onKeyDown=${R=>{R.key==="Enter"&&br()}}
              disabled=${Mn.value}
            />
            <button
              class="control-btn"
              onClick=${()=>{br()}}
              disabled=${Mn.value||sn.value.trim()===""}
            >
  ...
  `}function Kv({keeperName:e,placeholder:t}){const[n,s]=ol("");oe(()=>{e&&Al(e)},[e]);const a=_e.value[e]??[],i=qo.value[e]??!1,l=Ye.value[e],c=async()=>{const p=n.trim();if(!(!e||!p)){s("");try{await bp(e,p)}catch(_){const u=_ instanceof Error?_.message:`Failed to message ${e}`;E(u,"error")}}};return o`
        ...
        ${a.length===0?o`<div class="control-status-copy">No direct keeper conversation yet.</div>`:a.map(p=>o`
              <div class="keeper-conversation-item" key=${p.id}>
                <div class="keeper-conversation-meta">
                  <span class=${`keeper-role-chip ${kr(p)}`}>${p.label}</span>
                  <span class=${`keeper-role-chip ${kr(p)}`}>${qv(p)}</span>
                  ${p.timestamp?o`<span class="keeper-conversation-time">${qc(p.timestamp)}</span>`:null}
                </div>
  ...
  `}function Bv({actor:e,keeper:t,onPokeLodge:n}){if(!t)return null;const s=wc(t),a=wo.value[t.name]??!1,i=Fo.value[t.name]??!1,l=(s==null?void 0:s.next_action_path)??"direct_message",c=(s==null?void 0:s.recoverable)??l==="recover";return o`
    <div class="control-actions">
      <button
        class=${`control-btn ghost ${l==="probe"?"is-active":""}`}
        onClick=${()=>{kp(t.name,e).catch(p=>{const _=p instanceof Error?p.message:`Failed to probe ${t.name}`;E(_,"error")})}}
        disabled=${a||!e.trim()}
      >
        ${a?"Probing...":"Probe"}
      </button>
      <button
        ...
        onClick=${()=>{xp(t.name,e).catch(p=>{const _=p instanceof Error?p.message:`Failed to recover ${t.name}`;E(_,"error")})}}
        disabled=${i||!c||!e.trim()}
      >
  ...
  `}function Qv({keeper:e}){var u,f;const t=e.metrics_series??[];if(t.length<2){const v=(((u=e.context)==null?void 0:u.context_ratio)??0)*100,h=v>85?"#ef4444":v>70?"#f59e0b":"#22c55e";return o`
      ...
      </div>`}const n=200,s=60,a=2,i=t.length,l=t.map((v,h)=>{const b=a+h/(i-1)*(n-2*a),C=s-a-(v.context_ratio??0)*(s-2*a);return{x:b,y:C,p:v}}),c=l.map(({x:v,y:h})=>`${v.toFixed(1)},${h.toFixed(1)}`).join(" "),p=(((f=t[t.length-1])==null?void 0:f.context_ratio)??0)*100,_=p>85?"#ef4444":p>70?"#f59e0b":"#22c55e";return o`
    ...
    <div class="keeper-field-dict">
      <input
        ...
        value=${ao.value}
        onInput=${p=>{ao.value=p.target.value}}
      />
      ${s.map(p=>o`
  ...
  `}function sf({keeper:e}){var z,V,Z,ae,B,ee,A;const t=((z=$e.value)==null?void 0:z.room)??{},n=(((V=$e.value)==null?void 0:V.available_actions)??[]).filter(G=>G.target_type==="keeper"||G.target_type==="room").slice(0,8),s=Gv(e),a=Jv(e),i=Vv(e),l=i!=null&&i.allowed_tool_names&&i.allowed_tool_names.length>0?i.allowed_tool_names:e.allowed_tool_names??[],c=i!=null&&i.latest_tool_names&&i.latest_tool_names.length>0?i.latest_tool_names:e.latest_tool_names??[],p=(i==null?void 0:i.latest_tool_call_count)??e.latest_tool_call_count,_=(i==null?void 0:i.tool_audit_source)??e.tool_audit_source,u=(i==null?void 0:i.tool_audit_at)??e.tool_audit_at,f=((Z=e.agent)==null?void 0:Z.capabilities)??[],v=t.current_room??t.room_id??((ae=re.value)==null?void 0:ae.room)??"default",h=t.project??((B=re.value)==null?void 0:B.project)??"확인 없음",b=t.cluster??((ee=re.value)==null?void 0:ee.cluster)??"확인 없음",C=Ge(Pc(e)),x=Ge(Mc(e,_)),S=Ge(jc(e,_)),$=Ge(qi(e)),L=ps(e),I=((A=e.agent)==null?void 0:A.current_task)??(L==="offline"?"offline":"not_collected"),P=e.skill_primary??(L==="offline"?"offline":"not_collected"),Q=l[0]??c[0]??s[0]??null;return o`
    <div class="keeper-signal-list">
      <div class="keeper-signal-row">
        <span>Room</span>
        <strong>${v}</strong>
      ...
      <div style="display:flex; justify-content:flex-end; margin-top:4px;">
        <button class="control-btn ghost" onClick=${()=>{Ec(Q)}}>
          Open tools panel
        </button>
      </div>
      <div style="display:flex; flex-direction:column; gap:8px; margin-top:8px;">
        ...
        <div style="display:flex; flex-wrap:wrap; gap:6px;">
          ${l.length>0?l.map(G=>o`<span class="pill">${G}</span>`):o`<span style="font-size:12px; color:#888;">${C}</span>`}
        </div>
      </div>
      <div style="display:flex; flex-direction:column; gap:8px; margin-top:8px;">
        ...
        <div style="display:flex; flex-wrap:wrap; gap:6px;">
          ${c.length>0?c.map(G=>o`<span class="pill">${G}</span>`):o`<span style="font-size:12px; color:#888;">${x}</span>`}
        </div>
      </div>
      <div class="keeper-signal-row">
      ...
      <div style="display:flex; flex-direction:column; gap:8px; margin-top:8px;">
        ...
        <div style="display:flex; flex-wrap:wrap; gap:6px;">
          ${s.length>0?s.map(G=>o`<span class="pill">${G}</span>`):o`<span style="font-size:12px; color:#888;">${$}</span>`}
        </div>
      </div>
      ${a.length>0?o`
            <div style="display:flex; flex-direction:column; gap:8px; margin-top:8px;">
              ...
              <div style="display:flex; flex-wrap:wrap; gap:6px;">
                ${a.map(G=>o`<span class="pill">${G}</span>`)}
              </div>
            </div>
          `:null}
      <div style="display:flex; flex-direction:column; gap:8px; margin-top:8px;">
        ...
        <div style="display:flex; flex-wrap:wrap; gap:6px;">
          ${f.length>0?f.map(G=>o`<span class="pill">${G}</span>`):o`<span style="font-size:12px; color:#888;">등록된 capability 없음</span>`}
        </div>
      </div>
      <div style="display:flex; flex-direction:column; gap:8px; margin-top:8px;">
        <span style="font-size:12px; color:#888;">Available actions nearby</span>
        <div style="display:flex; flex-wrap:wrap; gap:6px;">
          ${n.length>0?n.map(G=>o`<span class="pill">${Wv(G.action_type)}</span>`):o`<span style="font-size:12px; color:#888;">operator action 광고 없음</span>`}
        </div>
      </div>
    </div>
  `}function Kc(){const e=new URLSearchParams(window.location.search),t=e.get("agent")??e.get("agent_name"),n=localStorage.getItem("masc_dashboard_agent_name");return(t??n??"dashboard").trim()||"dashboard"}async function af(){try{const e=await Ba({actor:Kc(),action_type:"lodge_tick",target_type:"room",payload:{}}),t=Cl(e.result);await rs(),t!=null&&t.skipped_reason?E(t.skipped_reason,"warning"):E(t?`Poke finished: ${t.acted}/${t.checked} acted`:"Poke finished",t&&t.acted>0?"success":"warning")}catch(e){const t=e instanceof Error?e.message:"Failed to run Lodge poke";E(t,"error")}}function of({keeper:e}){return o`
  ...
  `}function cf(){const e=Xl.value,t=ge((e==null?void 0:e.status)??(Ct.value?"bad":"warn")),n=!e||e.sections.length===0,s=(e==null?void 0:e.status)==="error"||(e==null?void 0:e.status)==="unavailable"&&!(e!=null&&e.cached);return o`
    <${T} title="판단 레이어" class="mission-briefing-card" semanticId="mission.llm_briefing">
      ...
      <div class="mission-card-actions">
        <button class="control-btn ghost" onClick=${()=>{ca(s)}} disabled=${Kt.value}>
          ${Kt.value?"응답 기다리는 중…":"판단 다시 읽기"}
        </button>
        <button class="control-btn ghost" onClick=${()=>{ca(!0)}} disabled=${Kt.value}>
          강제 갱신
        </button>
      </div>
    <//>
      ...
      <button class="mission-card-select" onClick=${()=>bv(e.id)}>
        <div class="mission-card-head">
          <div>
            ...
            <div class="mission-card-target">${ka(e.target_type)}${e.target_id?` · ${e.target_id}`:""}</div>
          </div>
        ...
        <div class="mission-fact-grid">
          ...
          <div class="mission-fact-tile">
            ...
            <small>${ka(e.target_type)}</small>
          </div>
          <div class="mission-fact-tile">
            <span>다음 액션</span>
            <strong>${i?Ja(i.action_type):"판단 필요"}</strong>
    ...
    <article class="mission-activity-card ${ge(e.brief.status??((i=e.keeper)==null?void 0:i.status))}">
      <button class="mission-card-select" onClick=${()=>{e.keeper&&Fc(e.keeper)}}>
        <div class="mission-activity-head">
          ...
          <span class="command-chip ${ge(e.brief.status??((p=e.keeper)==null?void 0:p.status))}">${we(e.brief.status??((_=e.keeper)==null?void 0:_.status))}</span>
        </div>
  ...
  `}function _f({item:e}){const t=e.action??null,n=e.attention??null;return o`
    <article class="mission-action-card ${ge(e.severity)}">
      <div class="mission-card-head">
        ...
        <span class="mission-card-target">${ka(e.target_type)}${e.target_id?` · ${e.target_id}`:""}</span>
      </div>
      <p>${e.summary}</p>
      ...
      <div class="mission-human-grid">
        <${T} title="주의 대기열" class="mission-list-card" semanticId="mission.attention_queue">
          ...
          <div class="mission-lane-stack">
            ${p.length>0?p.map(S=>o`<${df} key=${S.id} item=${S} selected=${We.value===S.id} sessionLookup=${i} />`):o`<div class="empty-state">지금 세션 단위 주의 대기열은 비어 있습니다.</div>`}
          </div>
        <//>
  ...
  `}const vf="modulepreload",ff=function(e){return"/dashboard/"+e},Ar={},gf=function(t,n,s){let a=Promise.resolve();if(n&&n.length>0){let l=function(_){return Promise.all(_.map(u=>Promise.resolve(u).then(f=>({status:"fulfilled",value:f}),f=>({status:"rejected",reason:f}))))};document.getElementsByTagName("link");const c=document.querySelector("meta[property=csp-nonce]"),p=(c==null?void 0:c.nonce)||(c==null?void 0:c.getAttribute("nonce"));a=l(n.map(_=>{if(_=ff(_),_ in Ar)return;Ar[_]=!0;const u=_.endsWith(".css"),f=u?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${_}"]${f}`))return;const v=document.createElement("link");if(v.rel=u?"stylesheet":vf,u||(v.as="script"),v.crossOrigin="",v.href=_,p&&v.setAttribute("nonce",p),document.head.appendChild(v),u)return new Promise((h,b)=>{v.addEventListener("load",h),v.addEventListener("error",()=>b(new Error(`Unable to preload CSS for ${_}`)))})}))}function i(l){const c=new Event("vite:preloadError",{cancelable:!0});if(c.payload=l,window.dispatchEvent(c),!c.defaultPrevented)throw l}return a.then(l=>{for(const c of l||[])c.status==="rejected"&&i(c.reason);return t().catch(i)})};function Ca(e){if(e==null)return"";if(typeof e=="string")return e;try{return JSON.stringify(e,null,2)}catch{return String(e)}}function ne(e){if(!e)return"정보 없음";const t=Date.parse(e);if(Number.isNaN(t))return e;const n=Math.max(0,Math.round((Date.now()-t)/1e3));return n<60?`${n}초 전`:n<3600?`${Math.round(n/60)}분 전`:n<86400?`${Math.round(n/3600)}시간 전`:`${Math.round(n/86400)}일 전`}function $f(e){if(!e)return"warn";const t=Date.parse(e);return Number.isNaN(t)?"warn":t<=Date.now()?"bad":"ok"}function Bc(e){if(!e)return"정보 없음";const t=Date.parse(e);if(Number.isNaN(t))return e;const n=Math.round((t-Date.now())/1e3);return n<=0?"기한 지남":n<60?`${n}초 후`:n<3600?`${Math.round(n/60)}분 후`:n<86400?`${Math.round(n/3600)}시간 후`:`${Math.round(n/86400)}일 후`}function M(e){return e==="bad"?"bad":e==="warn"||e==="pending"?"warn":"ok"}let Tr=!1,hf=0;function yf(){return++hf}let io=null;async function bf(){io||(io=gf(()=>import("./mermaid.core-BU9led37.js").then(t=>t.bE),[]).then(t=>t.default));const e=await io;return Tr||(e.initialize({startOnLoad:!1,theme:"dark",securityLevel:"loose"}),Tr=!0),e}function lt(e){if(!e)return"warn";const t=e.toLowerCase();return t.includes("failed")||t.includes("error")||t.includes("disconnected")||t.includes("stopped")?"bad":t.includes("running")||t.includes("active")||t.includes("degraded")||t.includes("pending")?"warn":"ok"}function _s(e){return typeof e!="number"||!Number.isFinite(e)?"정보 없음":`${Math.round(e*100)}%`}function In(e){return typeof e!="number"||!Number.isFinite(e)?"정보 없음":e<60?`${Math.round(e)}초`:e<3600?`${Math.round(e/60)}분`:`${Math.round(e/3600)}시간`}function vs(e){return typeof e!="number"||!Number.isFinite(e)?0:Math.max(0,Math.min(100,e))}function kt(e,t){return typeof e!="number"||!Number.isFinite(e)||typeof t!="number"||!Number.isFinite(t)||t<=0?0:vs(e/t*100)}function kf(e,t){const n=vs(e);return`--gauge-angle:${Math.max(10,Math.round(n/100*360))}deg;--gauge-color:${t};`}function Uc(e){if(!e)return"최근 체인 이력이 없습니다";const t=[e.event];return typeof e.duration_ms=="number"&&t.push(`${e.duration_ms}ms`),typeof e.tokens=="number"&&t.push(`토큰 ${e.tokens}`),e.message&&t.push(e.message),t.join(" · ")}const xf=[{id:"status",label:"현황"},{id:"history",label:"이력"},{id:"control",label:"통제"}],Hc=[{id:"warroom",label:"워룸",group:"status"},{id:"summary",label:"요약",group:"status"},{id:"topology",label:"토폴로지",group:"status"},{id:"orchestra",label:"오케스트라",group:"status"},{id:"swarm",label:"스웜",group:"status"},{id:"operations",label:"작전",group:"history"},{id:"trace",label:"트레이스",group:"history"},{id:"chains",label:"체인",group:"history"},{id:"control",label:"제어",group:"control"},{id:"alerts",label:"알림",group:"control"}],Sf=Hc.map(e=>e.id),Cf=["chain_start","node_start","node_complete","chain_complete","chain_error"],Af={warroom:{title:"실시간 워룸",description:"실제 실행, 워커, 메시지, 트레이스를 한 화면에서 따라가는 기본 진입 표면입니다."},operations:{title:"현재 작전 상세",description:"활성 작전, 분견대, 의존 관계를 먼저 읽는 기본 진입 표면입니다."},orchestra:{title:"룸 오케스트라 맵",description:"룸, 세션, 레인, 워커, 키퍼를 한 장의 작전판으로 읽는 시각화 표면입니다."},swarm:{title:"스웜 실행 흐름",description:"레인 이동, 워커 결속, 막힘을 따라가며 현장감 있게 보는 표면입니다."},chains:{title:"체인 런타임",description:"체인 연결 상태와 작전별 실행 그래프를 확인하는 표면입니다."},topology:{title:"지휘 계층",description:"실제 관리 유닛인지, 실시간 에이전트 기반 자동 투영인지 구분해서 봅니다."},alerts:{title:"경보 모음",description:"지금 개입을 밀어올리는 alert만 모아서 보는 표면입니다."},trace:{title:"최근 트레이스",description:"작전, 주체, 유닛 단위 이벤트를 시간순으로 보는 표면입니다."},control:{title:"승인과 제어",description:"결정 승인과 유닛 제어를 실제로 수행하는 표면입니다."},summary:{title:"지휘 요약",description:"전체 지휘면을 한 번에 훑는 계기판 성격의 요약 표면입니다."}};function Ir(e){return!!e&&Sf.includes(e)}function Tf(){const e=O.value.params;return e.source!=="mission"&&e.source!=="execution"?{}:{source:e.source,...e.action_type?{action_type:e.action_type}:{},...e.target_type?{target_type:e.target_type}:{},...e.target_id?{target_id:e.target_id}:{},...e.focus_kind?{focus_kind:e.focus_kind}:{},...e.operation_id?{operation_id:e.operation_id}:{}}}function Ki(e){const t=Tf(),n=Jc(),s=Bi();if(e==="operations")return t;if(e==="chains"){const a=tn.value;return a?{...t,surface:e,operation:a}:{...t,surface:e}}return e==="swarm"||e==="warroom"||e==="orchestra"?{...t,surface:e,...n?{run_id:n}:{},...s?{operation_id:s}:{}}:{...t,surface:e}}function If(){const e=new URLSearchParams(window.location.search),t=new URLSearchParams,n=e.get("agent")??e.get("agent_name"),s=e.get("token");return n&&t.set("agent",n),s&&t.set("token",s),t.toString()?`/api/v1/chains/events?${t.toString()}`:"/api/v1/chains/events"}function zf(e){switch(e){case"company":return"중대";case"platoon":return"소대";case"squad":return"분대";case"agent":return"에이전트";default:return e}}function ce(e){return Qo.value===e}function fs(){return Ii.value}function Rf(e){var a,i,l,c,p,_,u;const t=Ii.value,n=Nt.value,s=ds.value;switch(e){case"warroom":return{tool:"masc_observe_operations",reason:"실시간 실행, 워커, 메시지, 트레이스를 한 화면에서 보고 필요한 세부 표면으로 바로 이동합니다."};case"operations":return{tool:"masc_operation_status",reason:`활성 작전 ${((a=t==null?void 0:t.operations.summary)==null?void 0:a.active)??0}개와 의존 관계를 먼저 확인합니다.`};case"swarm":return{tool:(n==null?void 0:n.recommended_next_tool)??((l=(i=t==null?void 0:t.swarm_status)==null?void 0:i.recommended_next_action)==null?void 0:l.tool)??"masc_observe_traces",reason:((p=(c=t==null?void 0:t.swarm_status)==null?void 0:c.recommended_next_action)==null?void 0:p.reason)??"레인 이동과 막힘 근거를 보고 다음 확인 도구를 고릅니다."};case"orchestra":return{tool:"masc_operator_snapshot",reason:"룸, 세션, 레인, 워커, 키퍼를 한 장에서 훑은 뒤 내려볼 대상을 고릅니다."};case"chains":return{tool:(u=(_=s==null?void 0:s.operations[0])==null?void 0:_.preview_run)!=null&&u.chain_id?"masc_chain_run_get":"masc_chain_snapshot",reason:"체인 연결 상태와 최근 run 그래프를 함께 보면 병목을 빨리 좁힐 수 있습니다."};case"topology":return{tool:"masc_observe_topology",reason:"이 구조가 실제 관리 단위인지 자동 투영인지 먼저 구분해야 지휘면을 오해하지 않습니다."};case"alerts":return{tool:"masc_observe_alerts",reason:"경보에서 먼저 문제가 된 유닛과 작전을 고릅니다."};case"trace":return{tool:"masc_observe_traces",reason:"트레이스 흐름으로 원인 이벤트를 바로 따라갈 수 있습니다."};case"control":return{tool:"masc_operator_action",reason:"승인이나 kill switch 같은 실제 조작은 제어 표면과 operator action이 이어집니다."};case"summary":default:return{tool:"masc_observe_operations",reason:"요약을 본 뒤에는 현재 작전 표면으로 내려가 실제 움직임을 확인하는 게 가장 빠릅니다."}}}function Lf(e){var n;const t=((n=e==null?void 0:e.focus_kind)==null?void 0:n.toLowerCase())??"";return t?t.includes("artifact_scope")||t.includes("routing_confidence")||t.includes("cache_contention")?"microarch":t.includes("leader_offline")||t.includes("roster_offline")?"alerts":t.includes("stale_data")?"swarm":null:null}function Pf(e){var n;const t=((n=e==null?void 0:e.focus_kind)==null?void 0:n.toLowerCase())??"";return t?t.includes("stale_data")||t.includes("leader_offline")||t.includes("roster_offline")||t.includes("managed")?"recommendation":t.includes("gap")?"gaps":null:null}function Wc(){if(typeof window>"u")return null;const e=new URLSearchParams(window.location.search),t=e.get("agent")??e.get("agent_name");if(!t)return null;const n=t.trim();return n===""?null:n}function Gc(){if(typeof window>"u")return new URLSearchParams;const e=new URLSearchParams(window.location.search),t=window.location.hash.replace(/^#/,""),n=t.indexOf("?");return n>=0&&new URLSearchParams(t.slice(n+1)).forEach((a,i)=>{e.has(i)||e.set(i,a)}),e}function Jc(){const t=Gc().get("run_id");if(!t)return null;const n=t.trim();return n===""?null:n}function Bi(){const t=Gc().get("operation_id");if(!t)return null;const n=t.trim();return n===""?null:n}function Mf(e){if(!e)return null;const t=Date.parse(e);return Number.isNaN(t)?null:Math.max(0,Math.round((Date.now()-t)/1e3))}function jf(e){return e.status==="claimed"||e.status==="in_progress"}function Ef(e){const t=cs.value;if(!t)return null;for(const n of t.golden_paths){const s=n.steps.find(a=>a.tool===e);if(s)return s}return null}function ro(e){var t;return((t=cs.value)==null?void 0:t.golden_paths.find(n=>n.id===e))??null}function Nf(e){const t=cs.value;if(!t)return[];const n=new Set(e);return t.pitfalls.filter(s=>n.has(s.id))}async function ct(e){try{await e()}catch{}}function Ui(e){return(e==null?void 0:e.trim().toLowerCase())??""}function Ht(e){const t=Ui(e);return t.includes("failed")||t.includes("error")||t.includes("stopped")||t==="paused"?"bad":t.includes("active")||t.includes("running")||t.includes("healthy")||t.includes("ok")?"ok":"warn"}function xt(e){const t=Ui(e);return t?t==="active"||t==="running"?"진행 중":t==="paused"?"일시정지":t==="done"||t==="ended"||t==="completed"?"완료":t==="failed"||t==="error"||t==="stopped"?"문제":(e==null?void 0:e.trim())||"확인 필요":"확인 필요"}function Df(){var n,s,a,i,l,c,p,_,u;const e=Nt.value;if(!e)return!1;const t=e.workers.some(f=>f.joined||f.live_presence||f.completed||f.current_task_matches_run||f.heartbeat_fresh||f.claim_marker_seen||f.done_marker_seen||f.final_marker_seen||!!f.current_task||!!f.bound_task_id||!!f.last_message);return!!((n=e.operation)!=null&&n.operation_id||(s=e.detachment)!=null&&s.detachment_id||(((a=e.summary)==null?void 0:a.joined_workers)??0)>0||(((i=e.summary)==null?void 0:i.live_workers)??0)>0||(((l=e.summary)==null?void 0:l.current_task_bound)??0)>0||(((c=e.summary)==null?void 0:c.fresh_heartbeats)??0)>0||(((p=e.summary)==null?void 0:p.claim_markers_seen)??0)>0||(((_=e.summary)==null?void 0:_.done_markers_seen)??0)>0||(((u=e.summary)==null?void 0:u.final_markers_seen)??0)>0||t||e.recent_messages.length>0||e.recent_trace_events.length>0)}function Of(e){const t=Ui(e.status);return t==="active"||t==="running"}function qf(){var i,l,c,p;const e=((i=$e.value)==null?void 0:i.sessions)??[],t=Nt.value,n=((l=t==null?void 0:t.detachment)==null?void 0:l.session_id)??null;if(n){const _=e.find(u=>u.session_id===n);if(_)return _}const s=((c=t==null?void 0:t.operation)==null?void 0:c.operation_id)??Bi();if(s){const _=e.find(u=>u.command_plane_operation_id===s);if(_)return _}const a=((p=t==null?void 0:t.detachment)==null?void 0:p.detachment_id)??null;if(a){const _=e.find(u=>u.command_plane_detachment_id===a);if(_)return _}return e.find(Of)??e[0]??null}function xn(e){return e==="proven"?"ok":e==="partial"?"warn":"bad"}function Wt(e){return Array.isArray(e)?e:[]}function je(e){return typeof e=="object"&&e!==null&&!Array.isArray(e)?e:{}}function Ts(e){return typeof e=="string"&&e.trim()!==""?e:null}function wf(e){return typeof e=="number"&&Number.isFinite(e)?e:null}function Ff(e){const t=e.split("/");return t.length<=3?e:`…/${t.slice(-3).join("/")}`}function Kf(e){return e==="proven"?"충분":e==="partial"?"부분":"부족"}function Bf(e){return e==="proven"?"협업 증거가 충분합니다":e==="partial"?"흔적은 있으나 협업 증거가 덜 모였습니다":"증거가 부족합니다"}function Uf(e,t,n,s,a,i,l,c,p){const _=[`${s}명이 실제 흔적을 남겼고, 계획된 참여자는 ${a}명입니다.`,l>0?`서로를 참조한 상호작용 증거가 ${l}건 있습니다.`:"서로를 참조한 명시적 상호작용 증거가 아직 없습니다.",c>0?`도구·산출물·체크포인트 증거가 ${c}건 있습니다.`:"도구·산출물·체크포인트 증거가 거의 없습니다.",p>0?`CPv2 backing trace가 ${p}건 있어 실행 흔적은 남아 있습니다.`:"관리형 backing trace는 아직 없습니다."];return n==="proven"&&t==="insufficient"?[_[0]??"","왜 이렇게 판정됐나: 과거 proof는 proved였지만, 현재 보이는 live evidence는 부족해서 partial로 완화했습니다.","다음 보강 포인트: 최근 응답 턴이나 도구 호출을 다시 남겨 historical proof를 현재 상태와 연결해야 합니다."]:n==="proven"&&t==="partial"?[_[0]??"","왜 이렇게 판정됐나: historical proof는 강하지만, 현재 live evidence는 아직 partial 수준입니다.","다음 보강 포인트: 최근 상호작용과 실행 근거를 더 남기면 proven으로 회복할 수 있습니다."]:e==="partial"?[_[0]??"",i>0?`partial인 이유: 호출되었지만 응답하지 않은 참여자가 ${i}명 있습니다.`:l===0?"partial인 이유: 여러 흔적은 있지만 actor 간 상호작용이 직접 보이지 않습니다.":"partial인 이유: 일부 증거는 있으나 proven 기준을 모두 채우지 못했습니다.",p>0?"다음 보강 포인트: 응답 턴이나 도구 호출을 남기면 proof가 협업 수준으로 올라갑니다.":"다음 보강 포인트: 관리형 trace 또는 산출물 연결을 더 남기면 근거가 강해집니다."]:e==="proven"?[_[0]??"","결론: 참여, 상호작용, 산출물, backing evidence가 모두 연결돼 있습니다.","다음 행동: raw evidence는 접어두고 결과 산출물과 다음 실행 결정만 확인하면 됩니다."]:[_[0]??"",i>0?`결론: 협업 시도는 있었지만 무응답 참여자가 ${i}명 있어 협업 증거로 인정하기 어렵습니다.`:"결론: 기록은 있으나 협업을 증명할 만큼의 연결 증거가 부족합니다.",c>0?"다음 보강 포인트: 응답 턴과 도구 근거를 서로 연결해 남겨야 합니다.":"다음 보강 포인트: 참여자 간 턴, 도구 근거, 산출물 연결을 더 남겨야 합니다."]}function Hf(e){return e==="historical_only"?"historical only":e==="live_and_historical"?"live + historical":"live"}function zr(e){return(e==null?void 0:e.mode)==="requested_not_found"?"bad":(e==null?void 0:e.mode)==="latest_auto_selected"?"warn":"ok"}function Wf(e){return(e==null?void 0:e.mode)==="requested_not_found"?"선택 실패":(e==null?void 0:e.mode)==="latest_auto_selected"?"자동 선택":(e==null?void 0:e.mode)==="explicit"?"명시 선택":"선택 없음"}function Gf(e){return e.activity_state==="acted"?(e.interaction_count??0)>0||(e.tool_evidence_count??0)>0?"ok":"warn":e.activity_state==="mentioned_only"?"warn":"bad"}function Jf(e){return e.activity_state==="acted"?"실제 흔적":e.activity_state==="mentioned_only"?"호출만 됨":"계획만 됨"}function Vf(e){if(e.activity_state==="acted")return`턴 ${e.turn_count??0} · spawn ${e.spawn_count??0} · 도구 근거 ${e.tool_evidence_count??0}`;if(e.activity_state==="mentioned_only"){const t=e.requested_by?`호출자 ${e.requested_by}`:"호출자 미상";return`호출 ${e.mention_count??0}회 · ${t}`}return"계획된 참여자이지만 아직 이벤트가 없습니다."}function Rr(e){return Array.isArray(e.tool_names)?e.tool_names:[]}function Yf({selection:e,summary:t}){if(!e||e.mode==="explicit")return null;const n=e.mode==="latest_auto_selected"&&(t==null?void 0:t.historical_verdict)==="proven"&&(t==null?void 0:t.live_verdict)!=="proven";return o`
  ...
  `}function Qf({item:e}){return o`
    <article class="command-card proof-artifact-row">
      <div class="command-card-head">
        ...
        <span class="command-chip">${ne(e.timestamp??null)}</span>
      </div>
      ${Rr(e).length>0?o`<div class="semantic-tag-row">
            ${Rr(e).map(t=>o`<span class="semantic-tag">${t}</span>`)}
          </div>`:null}
    </article>
  `}function Xf(e){const t=new Map;for(const n of e){const s=[n.timestamp??"",n.event_type??"",n.actor??"",n.summary??""].join("|"),a=n.source??"unknown",i=t.get(s);if(i){i.sources.includes(a)||i.sources.push(a),!i.operation_id&&n.operation_id&&(i.operation_id=n.operation_id);continue}t.set(s,{...n,sources:[a]})}return[...t.values()]}function Zf(e){return e.sources.length===2?"세션 + 지휘":e.sources.length===1?e.sources[0]==="unknown"?"출처 미상":e.sources[0]??"출처":e.sources.join(" + ")}function eg(e){const t=[];for(const[n,s]of Object.entries(e))if(s!=null){if(typeof s=="string"){if(s.trim()==="")continue;t.push({label:n,value:s});continue}if(typeof s=="number"||typeof s=="boolean"){t.push({label:n,value:String(s)});continue}}return t}function tg(e){const t=je(e),n=je(t.traces),s=Array.isArray(n.events)?n.events:[],a=je(t.detachments),i=Array.isArray(a.detachments)?a.detachments:[],l=je(i[0]),c=je(l.detachment),p=je(l.operation),_=je(t.summary),u=je(_.operations),f=je(u.summary);return[{label:"작전",value:Ts(t.operation_id)??"없음"},{label:"분견대",value:Ts(t.detachment_id)??"없음"},{label:"트레이스 이벤트",value:`${s.length}`},{label:"분견대 상태",value:Ts(c.status)??"없음"},{label:"작전 단계",value:Ts(p.stage)??"없음"},{label:"활성 작전",value:`${wf(f.active)??0}`}]}function ng({item:e}){return o`
    <article class="command-card proof-timeline-row">
      <div class="command-card-head">
        ...
        <span class="command-chip">${ne(e.timestamp)}</span>
      </div>
      ${e.sources.length>1?o`<div class="semantic-tag-row">
            ${e.sources.map(t=>o`<span class="semantic-tag">${t}</span>`)}
          </div>`:null}
    </article>
  `}function sg({item:e}){const t=e.recent_output_preview??null,n=e.recent_input_preview??null,s=e.recent_event_summary??null,a=e.recent_request_preview??null,i=e.last_active_at??e.recent_request_at??null;return o`
      ...
      <div class="mission-activity-head">
        <div>
          ...
          <div class="mission-activity-meta">
            ...
            <span>${i?ne(i):"기록 없음"}</span>
          </div>
        </div>
        <span class="command-chip ${Gf(e)}">
          ${Jf(e)}
        </span>
      </div>
  ...
  `}function og(){var ee,A,G;const e=O.value.params,t=e.session_id??null,n=e.operation_id??null;oe(()=>{ic(t,n)},[t,n]);const s=oc.value;if(Yo.value&&!s)return o`<section class="dashboard-panel"><div class="loading-indicator">근거 화면 불러오는 중…</div></section>`;if(Bt.value&&!s)return o`<section class="dashboard-panel"><div class="error-card">${Bt.value}</div></section>`;const a=s==null?void 0:s.summary,i=(s==null?void 0:s.selection)??null,l=Wt(s==null?void 0:s.actor_contributions),c=Wt(s==null?void 0:s.artifacts),p=Wt(s==null?void 0:s.tool_evidence),_=(s==null?void 0:s.collaboration_verdict)??(s==null?void 0:s.proof_verdict)??"insufficient",u=(a==null?void 0:a.live_verdict)??(s==null?void 0:s.proof_verdict)??_,f=(a==null?void 0:a.historical_verdict)??null,v=(a==null?void 0:a.verdict_basis)??"live",h=(s==null?void 0:s.execution_backing_status)??"none",b=(s==null?void 0:s.cp_backing_evidence)??null,C=Array.isArray((ee=b==null?void 0:b.traces)==null?void 0:ee.events)?((G=(A=b.traces)==null?void 0:A.events)==null?void 0:G.length)??0:0,x=(a==null?void 0:a.actors_count)??l.length,S=(a==null?void 0:a.planned_actor_count)??l.length,$=(a==null?void 0:a.unanswered_actor_count)??l.filter(R=>R.activity_state!=="acted"&&(R.mention_count??0)>0).length,L=(a==null?void 0:a.mentioned_actor_count)??l.filter(R=>(R.mention_count??0)>0).length,I=(a==null?void 0:a.interaction_count)??0,P=(a==null?void 0:a.evidence_count)??0,Q=Xf(Wt(s==null?void 0:s.timeline)),z=eg(je(s==null?void 0:s.goal_binding)),V=tg(b),Z=c.filter(R=>R.exists).length,ae=c.length-Z,B=Uf(_,u,f,x,S,$,I,P,C);return o`
    <section class="dashboard-panel mission-view">
      <${Se} surfaceId="proof" />
      <div class="panel-header">
        <div>
        ...
        <div class="mission-header-meta">
          <span class="command-chip ${xn(_)}">${Kf(_)}</span>
          ${s!=null&&s.session_id?o`<span class="command-chip">${s.session_id}</span>`:null}
          ${s!=null&&s.generated_at?o`<span class="command-chip">${ne(s.generated_at)}</span>`:null}
        </div>
      </div>

      ${Bt.value?o`<div class="error-card">${Bt.value}</div>`:null}

      <${Yf} selection=${i} summary=${a??null} />

      <div class="mission-stat-grid">
        <div class="summary-stat-card ${xn(_)}">
          <span>판정</span>
          <strong>${Bf(_)}</strong>
          <small>${(a==null?void 0:a.detail)??"협업 증거를 verdict로 요약합니다."}</small>
        </div>
        <div class="summary-stat-card ${h==="present"?"ok":h==="missing"?"warn":""}">
          <span>실행 backing</span>
          <strong>${h==="present"?"있음":h==="missing"?"누락":"없음"}</strong>
          <small>협업 verdict와 분리해서 읽습니다.</small>
        </div>
        <div class="summary-stat-card ${xn(u)}">
          <span>Live 판정</span>
          <strong>${u}</strong>
          <small>${Hf(v)} 기준 최종 판정에 반영</small>
        </div>
        <div class="summary-stat-card ${xn(f??"insufficient")}">
        ...
        <div class="summary-stat-card ${S>x?"warn":"ok"}">
          <span>계획된 참여자</span>
          <strong>${S}</strong>
          <small>${L>0?`${L}명 호출됨`:"호출 기록 없음"}</small>
        </div>
        ...
        <div class="summary-stat-card ${ae===0&&c.length>0?"ok":"warn"}">
          <span>산출물</span>
          <strong>${Z}/${c.length}</strong>
          <small>${ae>0?`${ae}개 누락`:"전부 존재함"}</small>
        </div>
      </div>
      ...
      <div class="mission-human-grid">
        <${T} title="3줄 근거 요약" class="mission-list-card" semanticId="proof.summary">
          ...
          <div class="proof-summary-stack">
            ${B.map((R,J)=>o`
              <article class="proof-summary-block ${J===1&&_!=="proven"?xn(_):""}">
        ...
        <${T} title="목표 연결" class="mission-list-card" semanticId="proof.goal_binding">
          ...
          <details class="mission-card-disclosure compact">
            ...
            <pre class="command-json-block">${Ca((s==null?void 0:s.goal_binding)??{})}</pre>
          </details>
        <//>
      </div>
      ...
      <div class="mission-human-grid">
        <${T} title="협업 타임라인" class="mission-list-card" semanticId="proof.timeline">
          ...
          <div class="mission-list-stack">
            ${Q.length>0?Q.slice(0,18).map(R=>o`<${ng} key=${R.id} item=${R} />`):o`<div class="empty-state">표시할 타임라인 근거가 없습니다.</div>`}
          </div>
        <//>
        ...
        <${T} title="참여 흔적" class="mission-list-card" semanticId="proof.contributions">
          ...
          <div class="mission-activity-list">
            ${l.length>0?l.map(R=>o`<${sg} key=${R.actor} item=${R} />`):o`<div class="empty-state">표시할 참여 흔적이 없습니다.</div>`}
          </div>
        <//>
      </div>
      ...
      <div class="mission-human-grid">
        <${T} title="도구 근거" class="mission-list-card" semanticId="proof.tool_evidence">
          ...
          <div class="mission-list-stack">
            ${p.length>0?p.map((R,J)=>o`<${Qf} key=${`${R.actor??"system"}-${J}`} item=${R} />`):o`<div class="empty-state">기록된 tool evidence가 없습니다.</div>`}
          </div>
        <//>
        ...
        <${T} title="실행 근거" class="mission-list-card" semanticId="proof.backing">
          ...
          <details class="mission-card-disclosure compact">
            ...
            <pre class="command-json-block">${Ca(b??{})}</pre>
          </details>
        <//>
      </div>
      ...
      <div class="mission-human-grid">
        <${T} title="산출물" class="mission-list-card" semanticId="proof.artifacts">
          ...
          <div class="mission-list-stack">
            ${c.length>0?c.map(R=>o`<${ag} key=${R.path} item=${R} />`):o`<div class="empty-state">기록된 artifact가 없습니다.</div>`}
          </div>
        <//>
      </div>
    </section>
  `}function ig(){const e=us(O.value);return e?o`
  ...
  `:null}function rg(){const e=X.value,t=Af[e],n=Rf(e);return o`
  ...
  `}function zs({label:e,value:t,detail:n,percent:s,tone:a}){return o`
    <article class="command-signal-rail ${M(a)}">
      ...
      <div class="command-signal-bar">
        <span class="${M(a)}" style=${`width: ${Math.max(8,Math.round(vs(s)))}%`}></span>
      </div>
      <small>${n}</small>
    </article>
  `}function lg(){var Z,ae,B,ee;const e=fs(),t=e==null?void 0:e.topology.summary,n=e==null?void 0:e.operations.summary,s=e==null?void 0:e.detachments.summary,a=e==null?void 0:e.decisions.summary,i=e==null?void 0:e.alerts.summary,l=(Z=e==null?void 0:e.swarm_status)==null?void 0:Z.overview,c=e==null?void 0:e.swarm_proof,p=e==null?void 0:e.operations.microarch,_=(t==null?void 0:t.managed_unit_count)??0,u=(t==null?void 0:t.total_units)??0,f=(n==null?void 0:n.active)??0,v=(s==null?void 0:s.active)??0,h=(l==null?void 0:l.moving_lanes)??0,b=(l==null?void 0:l.active_lanes)??0,C=(c==null?void 0:c.workers.done)??0,x=(c==null?void 0:c.workers.expected)??0,S=(i==null?void 0:i.bad)??0,$=(i==null?void 0:i.warn)??0,L=(a==null?void 0:a.pending)??0,I=(a==null?void 0:a.total)??0,P=f+v,Q=((ae=p==null?void 0:p.cache)==null?void 0:ae.l1_hit_rate)??((ee=(B=p==null?void 0:p.signals)==null?void 0:B.cache_contention)==null?void 0:ee.l1_hit_rate)??0,z=f>0||v>0?"지휘면이 실제로 움직이고 있습니다":"계층은 준비됐지만 실행은 아직 잠복 상태입니다",V=f>0||h>0?"무거운 상세 탭으로 들어가기 전에, 여기서 먼저 압력과 이동감, 운영 부채를 읽을 수 있어야 합니다.":"이 화면은 체크리스트보다 계기판에 가까워야 합니다. 아래 게이지가 지금 어디가 살아 있는지 먼저 보여줍니다.";return o`
    <section class="command-hero command-hero-summary">
      <div class="command-hero-copy">
        ...
        <span class="command-chip ${M(f>0?"ok":"warn")}">활성 작전 ${f}</span>
          ...
          <span class="command-chip ${M(L>0?"warn":"ok")}">승인 대기 ${L}</span>
        </div>
      </div>
      ...
      <div class="command-gauge-grid">
        ...
        <${Is}
          ...
          percent=${kt(P,Math.max(_,P||1))}
          color="#4ade80"
        />
        <${Is}
          label="스웜 이동감"
          value=${`${h}/${Math.max(b,h)}`}
          subtext=${l!=null&&l.last_movement_at?`마지막 이동 ${ne(l.last_movement_at)}`:"최근 스웜 이동이 아직 없습니다"}
  ...
  `}function cg(){var v,h,b,C,x;const e=fs(),t=ds.value,n=us(O.value),s=Lf(n),a=e==null?void 0:e.topology.summary,i=e==null?void 0:e.operations.summary,l=(v=e==null?void 0:e.swarm_status)==null?void 0:v.overview,c=e==null?void 0:e.operations.microarch,p=e==null?void 0:e.decisions.summary,_=e==null?void 0:e.alerts.summary,u=(h=c==null?void 0:c.signals)==null?void 0:h.issue_pressure,f=c==null?void 0:c.cache;return o`
    <div class="command-summary-grid">
      ...
      <div class="monitor-stat-card ${s==="swarm"?"highlight":""}"><span>스웜</span><strong>${(l==null?void 0:l.active_lanes)??0}</strong><small>${l?`${l.stalled_lanes??0}개 정체 · ${ne(l.last_movement_at)}`:"lane snapshot 없음"}</small></div>
      <div class="monitor-stat-card ${s==="microarch"?"highlight":""}"><span>마이크로아크</span><strong>${(u==null?void 0:u.pending_ops)??0}</strong><small>${(f==null?void 0:f.l1_hit_rate)!=null?`${_s(f.l1_hit_rate)} L1 적중`:"캐시 데이터 없음"} · ${(u==null?void 0:u.tone)??"정보 없음"}</small></div>
    </div>
  `}function dg(){var Z,ae,B,ee,A,G,R,J,$t;const e=fs(),t=Be.value,n=re.value,s=Wc(),a=s?Qe.value.find(K=>K.name===s)??null:null,i=s?st.value.filter(K=>K.assignee===s&&jf(K)):[],l=((Z=e==null?void 0:e.operations.summary)==null?void 0:Z.active)??0,c=((ae=e==null?void 0:e.detachments.summary)==null?void 0:ae.total)??0,p=((B=e==null?void 0:e.decisions.summary)==null?void 0:B.pending)??0,_=t==null?void 0:t.detachments.detachments.find(K=>{const Pe=K.detachment.heartbeat_deadline,ht=Pe?Date.parse(Pe):Number.NaN;return K.detachment.status==="stalled"||!Number.isNaN(ht)&&ht<=Date.now()}),u=t==null?void 0:t.alerts.alerts.find(K=>K.severity==="bad"),f=!!(n!=null&&n.room||n!=null&&n.project),v=(a==null?void 0:a.current_task)??null,h=Mf(a==null?void 0:a.last_seen),b=h!=null?h<=120:null,C=[f?{title:"Room 준비도",tone:"ok",detail:`${(n==null?void 0:n.room)??(n==null?void 0:n.project)??"unknown"} · base ${(n==null?void 0:n.room_base_path)??"n/a"}`,tool:"masc_status"}:{title:"Room 준비도",tone:"bad",detail:"아직 room snapshot이 없습니다. 조인 전에 room을 repo root로 맞추세요.",tool:"masc_set_room"},s?a?i.length===0?{title:"Task 준비도",tone:"warn",detail:`${s} 에게 배정된 claimed task가 없습니다. 먼저 claim 하거나 만들어야 합니다.`,tool:st.value.length>0?"masc_claim":"masc_add_task"}:v?b===!1?{title:"Task 준비도",tone:"warn",detail:`${s} current_task=${v} 이지만 heartbeat가 stale 합니다 (${h}s).`,tool:"masc_heartbeat"}:{title:"Task 준비도",tone:"ok",detail:`${s} current_task=${v}${h!=null?` · 마지막 활동 ${h}s 전`:""}`,tool:"masc_plan_get_task"}:{title:"Task 준비도",tone:"bad",detail:`${s} 에 claimed task는 있지만 session current_task binding이 없습니다.`,tool:"masc_plan_set_task"}:{title:"Task 준비도",tone:"bad",detail:`${s} 이 room roster에 보이지 않습니다.`,tool:"masc_join"}:{title:"Task 준비도",tone:"warn",detail:"?agent= 쿼리가 없습니다. room health는 보이지만 agent 단위 다음 단계는 비어 있습니다.",tool:"masc_join"},!e||(((ee=e.topology.summary)==null?void 0:ee.managed_unit_count)??0)===0?{title:"작전 준비도",tone:"warn",detail:"관리 단위가 아직 정의되지 않았습니다. hierarchy가 있어야 CPv2 benchmark를 시작할 수 있습니다.",tool:"masc_unit_define"}:l===0?{title:"작전 준비도",tone:"warn",detail:`${((A=e.topology.summary)==null?void 0:A.managed_unit_count)??0}개 관리 단위는 준비됐지만 활성 작전은 없습니다.`,tool:"masc_operation_start"}:{title:"작전 준비도",tone:"ok",detail:`${((G=e.topology.summary)==null?void 0:G.managed_unit_count)??0}개 관리 단위 위에서 ${l}개 활성 작전이 돌고 있습니다.`,tool:"masc_observe_operations"},p>0?{title:"디스패치 준비도",tone:"warn",detail:`${p}개의 pending approval이 strict action을 막고 있습니다.`,tool:"masc_policy_approve"}:l>0&&c===0?{title:"디스패치 준비도",tone:"bad",detail:"active operation은 있지만 detachment가 아직 materialize 되지 않았습니다.",tool:"masc_dispatch_tick"}:_||u?{title:"디스패치 준비도",tone:"warn",detail:`dispatch 재정렬이 필요합니다${_?` · detachment ${_.detachment.detachment_id} 가 stalled 상태입니다`:""}${u?` · alert ${u.title??u.alert_id}`:""}${!t&&!_&&!u?" · 정확한 원인은 detail 탭에서 확인하세요.":""}.`,tool:p>0?"masc_policy_approve":"masc_dispatch_tick"}:{title:"디스패치 준비도",tone:"ok",detail:`${c}개 detachment가 보이고 strict approval backlog도 없습니다${t?"":" · detail pane은 열릴 때만 로드됩니다."}.`,tool:"masc_detachment_list"}],x=f?!s||!a?"masc_join":i.length===0?st.value.length>0?"masc_claim":"masc_add_task":v?b===!1?"masc_heartbeat":!e||(((R=e.topology.summary)==null?void 0:R.managed_unit_count)??0)===0?"masc_unit_define":l===0?"masc_operation_start":p>0?"masc_policy_approve":l>0&&c===0||_||u?"masc_dispatch_tick":"masc_observe_traces":"masc_plan_set_task":"masc_set_room",S=Ef(x),L=Nf(x==="masc_set_room"?["repo-root-room"]:x==="masc_plan_set_task"?["claimed-not-current"]:x==="masc_heartbeat"?["heartbeat-stale"]:x==="masc_dispatch_tick"?["no-detachments"]:x==="masc_policy_approve"?["pending-approval"]:["repo-root-room","claimed-not-current","heartbeat-stale"]).slice(0,2),I=ro("room_task_hygiene"),P=ro("cpv2_benchmark"),Q=ro("supervisor_session"),z=((J=cs.value)==null?void 0:J.docs)??[],V=[I,P,Q].filter(K=>K!==null);return o`
    <div class="command-guided-layout">
      <section class="card command-section">
        ...
        <div class="command-guide-card highlight command-next-step-card">
          ...
          ${($t=S==null?void 0:S.success_signals)!=null&&$t.length?o`<div class="command-tag-row">
                ${S.success_signals.map(K=>o`<span class="command-tag ok">${K}</span>`)}
              </div>`:null}
        </div>
      ...
      <section class="card command-section">
        ...
        ${Xo.value?o`<div class="empty-state">CPv2 runbook 불러오는 중…</div>`:va.value?o`<div class="empty-state error">${va.value}</div>`:o`
                ...
                ${z.length>0?o`<div class="command-doc-links">
                      ${z.map(K=>o`<span class="command-tag">${K.title}: ${K.path}</span>`)}
                    </div>`:null}
              `}
      </section>
    </div>
  `}function ug(){return o`
    ...
    <${cg} />
    <${dg} />
  `}function pg(){return ua.value?o`<div class="empty-state">command-plane detail 불러오는 중…</div>`:ma.value?o`<div class="empty-state error">${ma.value}</div>`:o`<div class="empty-state">surface를 선택하면 command-plane detail을 로드합니다.</div>`}const ai=g(null),Pr=1280,Mr=760;function jr(e){switch((e??"").trim().toLowerCase()){case"room":return"룸";case"session":return"세션";case"operation":return"작전";case"detachment":return"분견대";case"lane":return"레인";case"worker":return"워커";case"keeper":return"키퍼";default:return(e==null?void 0:e.trim())||"노드"}}function Sn(e,t,n){if(e<=0)return[];if(e===1)return[Math.round((t+n)/2)];const s=(n-t)/(e-1);return Array.from({length:e},(a,i)=>Math.round(t+i*s))}function mg(e,t){const n=new Map;for(const s of e){const a=t(s),i=n.get(a)??[];i.push(s),n.set(a,i)}return n}function _g(e){const t=new Map,n=e.nodes,s=n.find(b=>b.kind==="room")??null,a=n.filter(b=>b.kind==="session"),i=n.filter(b=>b.kind==="operation"),l=n.filter(b=>b.kind==="detachment"),c=n.filter(b=>b.kind==="lane"),p=n.filter(b=>b.kind==="worker"),_=n.filter(b=>b.kind==="keeper");s&&t.set(s.id,{x:640,y:96}),Sn(a.length,170,1110).forEach((b,C)=>{const x=a[C];x&&t.set(x.id,{x:b,y:220})}),Sn(i.length,240,1040).forEach((b,C)=>{const x=i[C];x&&t.set(x.id,{x:b,y:330})}),Sn(l.length,300,980).forEach((b,C)=>{const x=l[C];x&&t.set(x.id,{x:b,y:420})}),Sn(c.length,170,1110).forEach((b,C)=>{const x=c[C];x&&t.set(x.id,{x:b,y:530})});const u=new Map(c.map(b=>{const C=t.get(b.id);return C?[b.id,C.x]:null}).filter(b=>b!==null)),f=mg(p,b=>b.lane_id?`lane:${b.lane_id}`:b.parent_id?b.parent_id:"free");let v=0;for(const[b,C]of f){let x=u.get(b);if(x==null){const $=t.get(b);x=$==null?void 0:$.x}x==null&&(x=180+v%5*200,v+=1),Sn(C.length,x-90,x+90).forEach(($,L)=>{const I=C[L];if(!I)return;const P=L>5?Math.floor(L/6):0;t.set(I.id,{x:$,y:635+P*62})})}const h=_.length>3?[1120,1180]:[1140];return _.forEach((b,C)=>{const x=C%h.length,S=Math.floor(C/h.length);t.set(b.id,{x:h[x]??1140,y:190+S*108})}),t}function vg(e,t){const n=(e.x+t.x)/2,s=t.y>=e.y?32:-32;return`M ${e.x} ${e.y} C ${n} ${e.y+s}, ${n} ${t.y-s}, ${t.x} ${t.y}`}function Er(e,t,n){if(e==="command"){if(t){rt(t),ie("command",{...Ki(t),...n});return}ie("command",n);return}if(e==="intervene"){ie("intervene",n);return}ie("command",n)}function fg(e){switch(e.kind){case"room":return{width:150,height:150,radius:74};case"worker":return{width:78,height:42,radius:22};case"lane":return{width:170,height:54,radius:16};case"keeper":return{width:120,height:56,radius:24};default:return{width:188,height:64,radius:18}}}function gg({orchestra:e,roomPoint:t,onSelect:n}){if(!t||e.signals.length===0)return null;const s=108;return o`
    ${e.signals.slice(0,6).map((a,i)=>{const l=(-120+i*38)*(Math.PI/180),c=Math.round(t.x+Math.cos(l)*s),p=Math.round(t.y+Math.sin(l)*s);return o`
      ...
      `})}
  `}function $g({edges:e,positions:t,selectedId:n}){return o`
    ${e.map(s=>{const a=t.get(s.source),i=t.get(s.target);if(!a||!i)return null;const l=n!=null&&(s.source===n||s.target===n);return o`
        ...
        />
      `})}
  `}function hg({orchestra:e,positions:t,selectedId:n,onSelect:s}){var i;const a=((i=e.focus)==null?void 0:i.target_kind)==="node"?e.focus.target_id:null;return o`
    ${e.nodes.map(l=>{const c=t.get(l.id);if(!c)return null;const p=fg(l),_=l.id===n,u=l.id===a;if(l.kind==="room")return o`
          <g
            key=${l.id}
  ...
  `}function Vc(e){var s,a;const t=ai.value;if(t){const i=e.nodes.find(c=>c.id===t);if(i)return{type:"node",value:i};const l=e.signals.find(c=>c.id===t);if(l)return{type:"signal",value:l}}if(((s=e.focus)==null?void 0:s.target_kind)==="node"){const i=e.nodes.find(l=>{var c;return l.id===((c=e.focus)==null?void 0:c.target_id)});if(i)return{type:"node",value:i}}if(((a=e.focus)==null?void 0:a.target_kind)==="signal"){const i=e.signals.find(l=>{var c;return l.id===((c=e.focus)==null?void 0:c.target_id)});if(i)return{type:"signal",value:i}}const n=e.nodes[0];return n?{type:"node",value:n}:null}function yg({orchestra:e}){const t=Vc(e);if(!t)return o`<aside class="orchestra-drawer card"><div class="empty-state">선택 가능한 대상이 아직 없습니다.</div></aside>`;if(t.type==="signal"){const i=t.value;return o`
    ...
    <aside class="orchestra-drawer card ${M(n.tone)}">
      <div class="card-title-row">
        ...
        <span class="command-chip ${M(n.tone)}">${jr(n.kind)}</span>
      </div>
  ...
  `}function bg(){var i,l,c,p;const e=zi.value;if(Zo.value&&!e)return o`<section class="card command-section"><div class="empty-state">오케스트라 맵 불러오는 중…</div></section>`;if($a.value)return o`<section class="card command-section"><div class="empty-state error">${$a.value}</div></section>`;if(!e)return o`<section class="card command-section"><div class="empty-state">오케스트라 맵 데이터가 아직 없습니다.</div></section>`;const t=_g(e),n=Vc(e),s=(n==null?void 0:n.value.id)??null,a=e.nodes.find(_=>_.kind==="room")?t.get(e.nodes.find(_=>_.kind==="room").id)??null:null;return o`
      ...
      <div class="orchestra-shell">
        <div class="orchestra-canvas-wrap">
          <svg class="orchestra-canvas" viewBox=${`0 0 ${Pr} ${Mr}`}>
            ...
            <${$g} edges=${e.edges} positions=${t} selectedId=${s} />
            <${gg} orchestra=${e} roomPoint=${a} onSelect=${_=>{ai.value=_}} />
            <${hg}
              orchestra=${e}
              positions=${t}
              selectedId=${s}
          ...
          <div class="orchestra-summary-strip">
            ...
            <span class="command-chip">갱신 ${ne(e.generated_at)}</span>
          </div>
        </div>
  ...
  `}const Yc="masc_dashboard_agent_name";function kg(){var t,n,s;const e=new URLSearchParams(window.location.search);return((t=e.get("agent"))==null?void 0:t.trim())||((n=e.get("agent_name"))==null?void 0:n.trim())||((s=localStorage.getItem(Yc))==null?void 0:s.trim())||"dashboard"}const Ya=g(kg()),an=g(""),Aa=g("운영 점검"),on=g(""),Vn=g(""),Yn=g("2"),un=g(""),ke=g("note"),Qn=g(""),Xn=g(""),Zn=g(""),es=g("2"),ts=g(""),Ta=g("운영자 중지 요청"),Ia=g(""),rn=g(""),Rs=g(null);function xg(e){const t=e.trim()||"dashboard";Ya.value=t,localStorage.setItem(Yc,t)}function za(e){if(e==null)return"";if(typeof e=="string")return e;try{return JSON.stringify(e,null,2)}catch{return String(e)}}function Hi(e){switch((e??"").trim().toLowerCase()){case"judgment":return"상주 판단";case"fallback":return"보조 읽기 모델";default:return(e==null?void 0:e.trim())||"안내"}}function Ra(e){switch((e??"").trim().toLowerCase()){case"judgment":return"ok";case"fallback":return"warn";default:return"warn"}}function Wi(e){return e!=null&&e.enabled?e.refreshing?"갱신 중":e.judge_online?"온라인":e.last_error?"오류":"대기":"꺼짐"}function Sg(e){return e!=null&&e.enabled?e.judge_online?"ok":e.refreshing?"warn":"bad":"warn"}function Gi(e){return e!=null&&e.fresh_until?e.fresh_until:"갱신 기준 없음"}function Nr(e){return typeof e!="number"||!Number.isFinite(e)?"확인 없음":e<60?`${Math.round(e)}초 전`:e<3600?`${Math.round(e/60)}분 전`:`${Math.round(e/3600)}시간 전`}function pn(e){return typeof e=="string"?e.trim().toLowerCase():""}function Cg(e){var s;const t=pn(e.status);if(t==="paused")return"bad";if(t===""||t==="unknown")return"warn";const n=pn((s=e.team_health)==null?void 0:s.status);return n&&n!=="ok"&&n!=="healthy"&&n!=="green"||t&&t!=="active"&&t!=="running"&&t!=="ended"?"warn":"ok"}function lo(e){const t=pn(e.status);return t==="offline"||t==="inactive"||t==="error"?"bad":t===""||t==="unknown"||(e.context_ratio??0)>=.8||e.context_ratio==null||e.last_turn_ago_s==null||(e.last_turn_ago_s??0)>=3600?"warn":"ok"}function Dr(e){return e.some(t=>pn(t.severity)==="bad")?"bad":e.length>0?"warn":"ok"}function Ag(e){return e.target_type==="team_session"}function Tg(e){return e.target_type==="keeper"}function Mt(e){switch(e){case"broadcast":return"방송";case"room_pause":return"방 일시정지";case"room_resume":return"방 재개";case"team_turn":return"세션 업데이트";case"team_note":return"세션 노트";case"team_broadcast":return"세션 방송";case"team_task_inject":return"세션 작업 주입";case"team_worker_spawn_batch":return"세션 작업자 교체";case"task_inject":return"작업 주입";case"team_stop":return"세션 중지";case"keeper_message":return"키퍼 메시지";case"keeper_msg":return"키퍼 메시지";case"swarm_run_continue":return"스웜 실행 계속";case"swarm_run_rerun":return"스웜 실행 재실행";case"swarm_run_abandon":return"스웜 실행 포기";default:return(e==null?void 0:e.trim())||"액션"}}function ln(e){switch(e){case"room":return"방";case"team_session":return"세션";case"keeper":return"키퍼";case"swarm_run":return"스웜 실행";default:return(e==null?void 0:e.trim())||"대상"}}function Gt(e){switch(pn(e)){case"running":case"active":return"진행 중";case"paused":return"일시정지";case"ended":case"done":return"종료";case"offline":return"오프라인";case"idle":return"대기";case"unknown":case"":return"확인 필요";default:return(e==null?void 0:e.trim())||"확인 필요"}}function La(e){return e?"확인 후 실행":"즉시 실행"}function Ig(e){switch(e){case"note":return"노트";case"broadcast":return"방송";case"task":return"작업";case"worker_spawn_batch":return"작업자 교체";default:return e}}function ve(e,t){if(!e)return null;const n=e[t];return typeof n=="string"&&n.trim()!==""?n.trim():typeof n=="number"&&Number.isFinite(n)?String(n):null}function zg(e){return!e||typeof e!="object"||Array.isArray(e)?null:e}function Rg(e){if(!e)return"";const t=e.spawn_batch;return za(t!==void 0?t:e)}function Qc(e){const t=zg(e.payload);if(e.target_type==="room"){if(e.action_type==="broadcast"){an.value=ve(t,"message")??e.summary;return}if(e.action_type==="task_inject"){on.value=ve(t,"title")??"운영자 주입 작업",Vn.value=ve(t,"description")??e.summary,Yn.value=ve(t,"priority")??Yn.value;return}e.action_type==="room_pause"&&(Aa.value=ve(t,"reason")??e.summary);return}if(e.target_type==="team_session"){if(e.target_id&&(un.value=e.target_id),e.action_type==="team_stop"){Ta.value=ve(t,"reason")??e.summary;return}ke.value=e.action_type==="team_worker_spawn_batch"?"worker_spawn_batch":e.action_type==="team_task_inject"?"task":e.action_type==="team_broadcast"?"broadcast":"note";const n=ve(t,"message");if(n&&(Qn.value=n),ke.value==="worker_spawn_batch"){ts.value=Rg(t);return}ke.value==="task"&&(Xn.value=ve(t,"task_title")??ve(t,"title")??"운영자 주입 작업",Zn.value=ve(t,"task_description")??ve(t,"description")??e.summary,es.value=ve(t,"task_priority")??ve(t,"priority")??es.value);return}e.target_type==="keeper"&&(e.target_id&&(Ia.value=e.target_id),rn.value=ve(t,"message")??e.summary)}function Lg(e){Qc({action_type:e.action_type,target_type:e.target_type,target_id:e.target_id,payload:e.suggested_payload,summary:e.summary})}function Pg(e){Qc({action_type:e.action_type,target_type:e.target_type,target_id:e.target_id??null,payload:e.suggested_payload,summary:e.reason}),E("추천 액션 payload를 폼에 채웠습니다","success")}function Mg(e,t,n){return!e||!e.target_type||e.target_type==="room"?!0:e.target_type==="team_session"?!!e.target_id&&t.some(s=>s.session_id===e.target_id):e.target_type==="keeper"?!!e.target_id&&n.some(s=>s.name===e.target_id):!0}async function pt(e){const t=Ya.value.trim()||"dashboard";try{const n=await Yl({actor:t,action_type:e.action_type,target_type:e.target_type,target_id:e.target_id,payload:e.payload});return n.confirm_required?E("확인 대기열에 올렸습니다","warning"):E(e.successMessage,"success"),n}catch(n){const s=n instanceof Error?n.message:"개입 실행에 실패했습니다";return E(s,"error"),null}}async function Or(){const e=an.value.trim();if(!e)return;await pt({action_type:"broadcast",target_type:"room",payload:{message:e},successMessage:"방송을 보냈습니다"})&&(an.value="")}async function jg(){await pt({action_type:"room_pause",target_type:"room",payload:{reason:Aa.value.trim()||"운영 점검"},successMessage:"방 일시정지를 요청했습니다"})}async function Xc(){await pt({action_type:"room_resume",target_type:"room",payload:{},successMessage:"방 재개를 요청했습니다"})}async function Eg(){const e=on.value.trim();if(!e)return;await pt({action_type:"task_inject",target_type:"room",payload:{title:e,description:Vn.value.trim()||"개입 화면에서 주입",priority:Number.parseInt(Yn.value,10)||2},successMessage:"작업 주입을 보냈습니다"})&&(on.value="",Vn.value="")}async function Ng(){var l;const e=$e.value,t=un.value||((l=e==null?void 0:e.sessions[0])==null?void 0:l.session_id)||"";if(!t){E("먼저 세션을 고르세요","warning");return}const n={};if(ke.value==="worker_spawn_batch"){const c=ts.value.trim();if(!c){E("spawn_batch JSON을 먼저 채우세요","warning");return}try{const _=JSON.parse(c);if(Array.isArray(_))n.spawn_batch=_;else if(_&&typeof _=="object"&&Array.isArray(_.spawn_batch))n.spawn_batch=_.spawn_batch;else{E("spawn_batch는 배열 또는 { spawn_batch: [...] } 형태여야 합니다","warning");return}}catch(_){const u=_ instanceof Error?_.message:"spawn_batch JSON 파싱에 실패했습니다";E(u,"error");return}await pt({action_type:"team_worker_spawn_batch",target_type:"team_session",target_id:t,payload:n,successMessage:"작업자 교체 요청을 적용했습니다"})&&(ts.value="");return}const s=Qn.value.trim();s&&(n.message=s);let a="team_note";ke.value==="broadcast"?a="team_broadcast":ke.value==="task"&&(a="team_task_inject"),ke.value==="task"&&(n.task_title=Xn.value.trim()||"운영자 주입 작업",n.task_description=Zn.value.trim()||"개입 화면에서 주입",n.task_priority=Number.parseInt(es.value,10)||2),await pt({action_type:a,target_type:"team_session",target_id:t,payload:n,successMessage:"세션 액션을 적용했습니다"})&&(Qn.value="",ke.value==="task"&&(Xn.value="",Zn.value=""))}async function Dg(){var n;const e=$e.value,t=un.value||((n=e==null?void 0:e.sessions[0])==null?void 0:n.session_id)||"";if(!t){E("먼저 세션을 고르세요","warning");return}await pt({action_type:"team_stop",target_type:"team_session",target_id:t,payload:{reason:Ta.value.trim()||"운영자 중지 요청"},successMessage:"세션 중지를 요청했습니다"})}async function Og(){var a;const e=$e.value,t=Ia.value||((a=e==null?void 0:e.keepers[0])==null?void 0:a.name)||"",n=rn.value.trim();if(!t){E("먼저 키퍼를 고르세요","warning");return}if(!n)return;await pt({action_type:"keeper_message",target_type:"keeper",target_id:t,payload:{message:n},successMessage:`${t}에게 메시지를 보냈습니다`})&&(rn.value="")}async function qr(e,t="confirm"){const n=Ya.value.trim()||"dashboard";try{await Ql(n,e,t),E(t==="deny"?"승인 대기를 거부했습니다":"확인 실행을 완료했습니다","success")}catch(s){const a=s instanceof Error?s.message:t==="deny"?"승인 대기 거부에 실패했습니다":"확인 실행에 실패했습니다";E(a,"error")}}function Zc(e){switch(e){case"explicit":return"실제 관리 단위";case"hybrid":return"관리 단위 + 자동 보강";case"auto":return"자동 투영";default:return"출처 미상"}}function ed(e){switch(e){case"explicit":return"ok";case"hybrid":return"warn";case"auto":return"warn";default:return"warn"}}function qg(e){switch(e){case"explicit":return"지금 보이는 유닛은 실제로 정의된 지휘면 관리 단위입니다.";case"hybrid":return"일부는 실제 관리 단위이고, 비어 있는 부분은 실시간 에이전트 편성을 보고 자동 보강한 구조입니다.";case"auto":return"이 화면은 실시간 에이전트 편성을 지휘면 모양으로 자동 투영한 것입니다. 실제 명령 체계와 1:1로 같다고 보면 안 됩니다.";default:return"이 화면은 관리 토폴로지와 실효 토폴로지가 섞여 있을 수 있습니다."}}function wg(e){const t=e.unit.source??"unknown";return t==="explicit"?e.active_operation_count&&e.active_operation_count>0?"실제 관리 단위이며 연결된 작전이 있습니다.":"실제 관리 단위이지만 현재 연결된 작전은 없습니다.":t==="hybrid"?e.active_operation_count&&e.active_operation_count>0?"관리 단위를 기반으로 자동 보강된 구조이며 일부 작전이 연결돼 있습니다.":"관리 단위를 기반으로 자동 보강된 구조이며 현재 실행 연결은 약합니다.":e.active_operation_count&&e.active_operation_count>0?"자동 생성된 구조이지만 이 노드에 연결된 작전 흔적은 있습니다.":"자동 생성된 구조이며 현재 실행 연결은 없습니다."}function td({node:e,depth:t=0}){const n=e.roster_live??0,s=e.roster_total??e.unit.roster.length,a=e.active_operation_count??0,i=e.unit.policy,l=e.unit.source??"unknown",c=a>0?`${a}개 작전 연결`:"실행 연결 없음";return o`
    <div class="command-tree-node depth-${Math.min(t,3)}">
      <div class="command-tree-head">
        <div>
          ...
          <div class="command-card-sub">${wg(e)}</div>
      ...
      ${e.children.length>0?o`<div class="command-tree-children">
            ${e.children.map(p=>o`<${td} node=${p} depth=${t+1} />`)}
          </div>`:null}
    </div>
  `}function Fg({alert:e}){return o`
  ...
  `}function Ji({event:e}){return o`
    <article class="command-trace-row">
      ...
      <pre class="command-trace-detail">${Ca(e.detail)}</pre>
    </article>
  `}function Kg(){const e=Be.value,t=e==null?void 0:e.topology,n=t==null?void 0:t.source,s=t==null?void 0:t.summary,a=(s==null?void 0:s.managed_unit_count)??0,i=(s==null?void 0:s.active_operation_count)??0;return o`
    <section class="card command-section">
      <div class="card-title-row">
  ...
  `}function Bg(){const e=Be.value;return o`
    <section class="card command-section">
      <div class="card-title-row">
      ...
      ${e&&e.alerts.alerts.length>0?o`<div class="command-card-stack">
            ${e.alerts.alerts.map(t=>o`<${Fg} alert=${t} />`)}
          </div>`:o`<div class="empty-state">지금 올라온 지휘면 경보는 없습니다.</div>`}
    </section>
  `}function Ug(){const e=Be.value;return o`
    <section class="card command-section">
      <div class="card-title-row">
  ...
  `}function Hg(e){if(typeof e=="string")return e;if(e==null)return"";try{return JSON.stringify(e,null,2)}catch{return String(e)}}function Wg(e,t){return(t==null?void 0:t.status)==="abandoned"||(e==null?void 0:e.recommended_kind)==="continue"?"warn":(e==null?void 0:e.recommended_kind)==="rerun"?"bad":"ok"}function Gg(e){switch(e){case"continue":case"continued":return"계속";case"rerun":return"재실행";case"abandon":case"abandoned":return"포기";default:return(e==null?void 0:e.trim())||"결정"}}function Jg(e){return e?e.runtime_blocker?"막힘":e.provider_reachable?"준비됨":"확인 필요":"확인 필요"}function nd({swarm:e}){var f,v;const t=e.run_id,n=e.resolution_recommendation,s=e.run_resolution;if(!t||!n&&!s)return null;const a=Wc()??"dashboard",i=((f=$e.value)==null?void 0:f.pending_confirms.find(h=>h.target_type==="swarm_run"&&h.target_id===t))??null,l=Wg(n,s),c=((v=e.operation)==null?void 0:v.operation_id)??e.operation_id??void 0,p={run_id:t};c&&(p.operation_id=c),n!=null&&n.reason&&(p.reason=n.reason);const _=async h=>{await Yl({actor:a,action_type:h,target_type:"swarm_run",target_id:t,payload:p})},u=async h=>{i&&await Ql(a,i.confirm_token,h)};return o`
    <article class="command-guide-card ${M(l)}">
      <div class="command-guide-head">
        <strong>런 해석</strong>
        <span class="command-chip ${M(l)}">
          ${Gg((s==null?void 0:s.status)??(n==null?void 0:n.recommended_kind)??null)}
        </span>
      </div>
      <p>
        ${(s==null?void 0:s.status)==="abandoned"?`이 run은 ${s.decided_by}가 ${ne(s.decided_at)}에 soft abandon 처리했습니다. ${s.reason}`:(n==null?void 0:n.reason)??"이 run에 대한 별도 resolution recommendation은 아직 없습니다."}
      </p>
      <div class="command-card-grid">
  ...
  `}function Vg({total:e}){const n=Math.min(e,20),s=e>20?e-20:0,a=Array.from({length:n});return o`
  ...
  `}function Yg({lane:e}){const t=e.counts??{},n=sd(e),s=t.workers??0,a=t.operations??0,i=t.detachments??0,l=a+i,c=e.motion_state==="moving"?84:e.motion_state==="waiting"?58:e.motion_state==="terminal"?100:26;return o`
    <article class="swarm-lane-strip ${M(n)}">
      <div class="swarm-lane-head">
        ...
        <div class="command-tag-row">
          ...
          <span class="command-chip">${ne(e.last_movement_at)}</span>
        </div>
      </div>
      ...
      ${e.hard_flags.length>0?o`
            <div class="swarm-lane-flags">
              ${e.hard_flags.map(p=>o`<span class="command-chip ${M(p.severity)}">${p.code}</span>`)}
            </div>
          `:null}
    </article>
  ...
  `}function Qg({event:e}){const t=e.timestamp?new Date(e.timestamp):null,n=t&&!isNaN(t.getTime())?t:null,s=n?`${String(n.getHours()).padStart(2,"0")}:${String(n.getMinutes()).padStart(2,"0")}`:"";return o`
  ...
  `}function Zg({swarm:e}){const t=e==null?void 0:e.narrative;return t?o`
    ...
    <div class="command-guide-card ${M(t)}">
      ...
      ${e?o`
            ...
            <div class="command-card-grid">
              ...
              <span>수집 시각</span><span>${ne(e.captured_at)}</span>
  ...
  `}function t$(){const e=fs(),t=us(O.value),n=Pf(t),s=e==null?void 0:e.swarm_status,a=e==null?void 0:e.swarm_proof,i=(s==null?void 0:s.lanes.filter(f=>f.present))??[],l=(s==null?void 0:s.gaps.items)??[],c=(s==null?void 0:s.timeline.slice(0,8))??[],p=s==null?void 0:s.overview,_=s==null?void 0:s.recommended_next_action,u=i.length<=1;return o`
    <section class="card command-section">
      <div class="card-title-row">
      ...
      ${s?o`
            ...
            <div class="command-summary-grid command-swarm-summary">
              ...
              <div class="monitor-stat-card"><span>마지막 이동</span><strong>${ne(p==null?void 0:p.last_movement_at)}</strong><small>${s.generated_at?`스냅샷 ${ne(s.generated_at)}`:"방금 스냅샷"}</small></div>
            ...
            <div class="command-swarm-layout ${u?"compact":""}">
              <div class="command-card-stack">
                ${i.length>0?i.map(f=>o`<${Yg} lane=${f} />`):o`<div class="empty-state">활성 스웜 레인이 없습니다.</div>`}
              </div>
              ...
              <div class="command-card-stack">
                ...
                <div class="command-guide-card ${l.length>0?"warn":"ok"} ${n==="gaps"?"focus":""}">
                  ...
                  ${l.length>0?o`<div class="command-card-stack">${l.slice(0,4).map(f=>o`<${Xg} gap=${f} />`)}</div>`:o`<p>지금 보이는 핵심 공백은 없습니다.</p>`}
                </div>
                ...
                <div class="command-guide-card">
                  ...
                  ${c.length>0?o`<div class="swarm-event-rail">${c.map(f=>o`<${Qg} event=${f} />`)}</div>`:o`<p>붙어 있는 최근 이동 이벤트가 아직 없습니다.</p>`}
                </div>
              </div>
            </div>
          `:o`<div class="empty-state">스웜 상태를 아직 불러오지 못했습니다.</div>`}
    </section>
  `}function n$({item:e}){return o`
  ...
  `}function s$({worker:e}){return o`
    <article class="command-card compact">
      ...
      ${e.last_message?o`<div class="command-card-foot">${ne(e.last_message.timestamp)} · ${e.last_message.content}</div>`:null}
    </article>
  `}function a$(){var u,f,v,h,b,C,x,S,$,L,I,P,Q,z,V,Z,ae,B,ee,A,G,R;const e=Nt.value,t=Jc(),n=Bi(),s=Jg(e==null?void 0:e.provider),a=((u=e==null?void 0:e.provider)==null?void 0:u.configured_capacity)??0,i=((f=e==null?void 0:e.provider)==null?void 0:f.actual_slots)??((v=e==null?void 0:e.provider)==null?void 0:v.total_slots)??0,l=((h=e==null?void 0:e.provider)==null?void 0:h.expected_slots)??"n/a",c=((b=e==null?void 0:e.provider)==null?void 0:b.actual_ctx)??((C=e==null?void 0:e.provider)==null?void 0:C.ctx_per_slot)??0,p=((x=e==null?void 0:e.provider)==null?void 0:x.expected_ctx)??"n/a",_=((S=e==null?void 0:e.summary)==null?void 0:S.peak_hot_slots)??(($=e==null?void 0:e.provider)==null?void 0:$.peak_active_slots)??0;return o`
    <div class="command-section-stack">
      ...
      <div class="command-surface-grid">
        <section class="card command-section">
          ...
          ${fa.value?o`<div class="empty-state">Loading swarm live state…</div>`:ga.value?o`<div class="empty-state error">${ga.value}</div>`:e?o`
                    <div class="command-summary-grid">
                      <div class="monitor-stat-card"><span>실행 런</span><strong>${e.run_id??t??"swarm-live"}</strong><small>${e.room_id??"room 정보 없음"}</small></div>
                      <div class="monitor-stat-card"><span>워커</span><strong>${((L=e.summary)==null?void 0:L.joined_workers)??0}/${((I=e.summary)==null?void 0:I.expected_workers)??0}</strong><small>${((P=e.summary)==null?void 0:P.live_workers)??0}개 가동 · ${((Q=e.summary)==null?void 0:Q.completed_workers)??0}개 완료</small></div>
                      <div class="monitor-stat-card"><span>런타임 계약</span><strong>${s}</strong><small>설정 ${a||"n/a"} · 실제 ${i}/${l} · ctx ${c}/${p}</small></div>
                      <div class="monitor-stat-card"><span>고동시성</span><strong>${(z=e.summary)!=null&&z.pass_hot_concurrency?"통과":"확인 필요"}</strong><small>최대 hot ${_} · ${((V=e.provider)==null?void 0:V.slot_url)??"slot 정보 없음"}</small></div>
                      <div class="monitor-stat-card"><span>종단 점검</span><strong>${(Z=e.summary)!=null&&Z.pass_end_to_end?"통과":"확인 필요"}</strong><small>${e.recommended_next_tool??"masc_observe_traces"}</small></div>
                    </div>
                    <div class="command-card-grid">
                      ...
                      <span>실행체</span><span>${((ee=e.detachment)==null?void 0:ee.detachment_id)??"없음"}</span>
                      ...
                      <span>런타임 막힘</span><span>${((R=e.provider)==null?void 0:R.runtime_blocker)??"없음"}</span>
                      <span>추천 도구</span><span>${e.recommended_next_tool??"masc_observe_traces"}</span>
                    </div>
                    ${e.truth_notes.length>0?o`<div class="command-tag-row">
                          ${e.truth_notes.map(J=>o`<span class="command-tag">${J}</span>`)}
                        </div>`:null}
                    <${nd} swarm=${e} />
        ...
        <section class="card command-section">
          ...
          ${e!=null&&e.provider?o`
                <div class="command-card-grid">
                  ...
                  <span>마지막 샘플</span><span>${e.provider.last_sample_at?ne(e.provider.last_sample_at):"정보 없음"}</span>
                  <span>런타임 막힘</span><span>${e.provider.runtime_blocker??"없음"}</span>
                  <span>검사 시각</span><span>${e.provider.checked_at?ne(e.provider.checked_at):"정보 없음"}</span>
                </div>
                <div class="command-card-sub">
                ...
                ${e.provider.timeline.length>0?o`<div class="command-trace-stack">
                      ${e.provider.timeline.slice(-12).map(J=>o`
                          <article class="command-trace-row">
                            <div class="command-trace-main">
                              <div class="command-trace-head">
                                <strong>hot ${J.active_slots}</strong>
                                <span class="command-chip">${ne(J.timestamp)}</span>
                              </div>
        ...
        <section class="card command-section">
          ...
          ${e&&e.blockers.length>0?o`<div class="command-card-stack">
                ${e.blockers.map(J=>o`<${id} blocker=${J} />`)}
        ...
        <section class="card command-section">
          ...
          ${e&&e.recent_trace_events.length>0?o`<div class="command-trace-stack">
                ${e.recent_trace_events.map(J=>o`<${Ji} event=${J} />`)}
              </div>`:o`<div class="empty-state">run 범위 trace event가 아직 없습니다.</div>`}
        </section>
      </div>
    </div>
  `}function o$(e){return e==="swarm"?"스웜 실시간":"세션 요약"}function i$(e){switch(e){case"current":return"현재 과업 일치";case"drift":return"과업 드리프트";case"claim":return"착수 흔적 있음";case"no-claim":return"착수 흔적 없음";case"done":return"완료 흔적 있음";case"no-done":return"완료 흔적 없음";case"final":return"최종 보고 있음";case"no-final":return"최종 보고 없음";case"turn":return"턴 기록 있음";case"silent":return"턴 기록 없음";case"noted":return"노트 기록 있음";default:return e.startsWith("empty:")?`빈 노트 ${e.slice(6)}회`:e.startsWith("turns:")?`턴 ${e.slice(6)}회`:e}}function r$(e){var n;const t=[e.current_task_matches_run?"current":"drift",e.claim_marker_seen?"claim":"no-claim",e.done_marker_seen?"done":"no-done",e.final_marker_seen?"final":"no-final"];return{key:`swarm:${e.name}`,name:e.name,role:e.role,lane:e.lane,status:e.status,source:"swarm",task:e.current_task??e.bound_task_title??e.bound_task_id??"할당 없음",heartbeat:e.heartbeat_age_sec!=null?`${Math.round(e.heartbeat_age_sec)}초`:e.heartbeat_fresh?"정상":"정보 없음",detail:[e.bound_task_status??null,e.detachment_member?"분견대 소속":null,e.squad_member?"분대 소속":null].filter(Boolean).join(" · ")||"스웜 실시간 카드",markers:t,note:((n=e.last_message)==null?void 0:n.content)??null}}function l$(e,t){const n=e.actor??e.spawn_role??`워커-${t+1}`,s=e.spawn_role??e.worker_class??e.spawn_agent??"워커",a=e.lane_id??e.capsule_mode??e.control_domain??"세션",i=[e.has_turn?"turn":"silent",e.empty_note_turn_count>0?`empty:${e.empty_note_turn_count}`:"noted",e.turn_count>0?`turns:${e.turn_count}`:"turns:0"];return{key:`session:${n}:${t}`,name:n,role:s,lane:a,status:e.status,source:"session",task:e.task_profile??e.runtime_pool??"세션 레인",heartbeat:e.last_turn_ts_iso?ne(e.last_turn_ts_iso):"정보 없음",detail:[e.spawn_agent??null,e.spawn_model??null,e.routing_confidence!=null?_s(e.routing_confidence):null].filter(Boolean).join(" · ")||"세션 요약 카드",markers:i,note:e.routing_reason??null}}function wr(e){return M(e.severity)}function c$({worker:e}){return o`
    <article class="command-card compact warroom-worker-card ${M(Ht(e.status))}">
      <div class="command-card-head">
        <div>
          <strong>${e.name}</strong>
          <div class="command-card-sub">${e.role} · ${e.lane}</div>
        </div>
        <span class="command-chip ${M(Ht(e.status))}">${xt(e.status)}</span>
      </div>
      <div class="command-card-grid">
        <span>출처</span><span>${o$(e.source)}</span>
        <span>과업</span><span>${e.task}</span>
        <span>최근 신호</span><span>${e.heartbeat}</span>
        <span>근거</span><span>${e.detail}</span>
      </div>
      <div class="command-tag-row">
        ${e.markers.map(t=>o`<span class="command-tag">${i$(t)}</span>`)}
      </div>
  ...
  `}function d$(){var ee,A,G,R,J,$t,K,Pe,ht,hn,yn,gs,$s,hs,ys,bs,ks,xs,tr,nr,sr;const e=fs(),t=Nt.value,n=$e.value,s=Fe.value,a=qf(),i=t!=null&&t.operation?((ee=ds.value)==null?void 0:ee.operations.find(te=>{var Ss;return te.operation.operation_id===((Ss=t.operation)==null?void 0:Ss.operation_id)}))??null:null,l=Df(),c=(t==null?void 0:t.workers)??[],p=(s==null?void 0:s.worker_cards)??[],_=l&&c.length>0?c.map(r$):p.map(l$),u=l,f=((A=e==null?void 0:e.decisions.summary)==null?void 0:A.pending)??0,v=(n==null?void 0:n.pending_confirms)??[],h=l?(t==null?void 0:t.blockers)??[]:[],b=(s==null?void 0:s.recommended_actions)??[],C=(G=s==null?void 0:s.active_recommended_actions)!=null&&G.length?s.active_recommended_actions:b,x=s==null?void 0:s.active_summary,S=(s==null?void 0:s.active_guidance_layer)??"fallback",$=(s==null?void 0:s.resident_judge_runtime)??(n==null?void 0:n.resident_judge_runtime),L=(s==null?void 0:s.attention_items)??[],I=((R=t==null?void 0:t.recent_messages[0])==null?void 0:R.timestamp)??null,P=((J=t==null?void 0:t.recent_trace_events[0])==null?void 0:J.timestamp)??null,Q=l?I??P??null:null,z=a==null?void 0:a.summary,V=(l?($t=t==null?void 0:t.summary)==null?void 0:$t.expected_workers:void 0)??(typeof(z==null?void 0:z.planned_worker_count)=="number"?z.planned_worker_count:void 0)??(s==null?void 0:s.worker_cards.length)??0,Z=(l?(K=t==null?void 0:t.summary)==null?void 0:K.joined_workers:void 0)??(typeof(z==null?void 0:z.active_agent_count)=="number"?z.active_agent_count:void 0)??_.length,ae=h.length>0||f>0||v.length>0?"warn":u||a?"ok":"warn",B=l?((Pe=e==null?void 0:e.swarm_status)==null?void 0:Pe.lanes.filter(te=>te.present))??[]:[];return oe(()=>{xe()},[]),oe(()=>{a!=null&&a.session_id&&dn(a.session_id)},[a==null?void 0:a.session_id,n,(ht=t==null?void 0:t.detachment)==null?void 0:ht.session_id]),!u&&!a?fa.value||Bn.value?o`<div class="empty-state">실시간 워룸 불러오는 중…</div>`:o`
      ...
      <section class="command-warroom-strip ${M(ae)}">
        <div class="command-warroom-strip-head">
          <div>
            ...
            ${x!=null&&x.summary?o`<div class="command-warroom-guidance ${Ra(S)}">
                  <strong>${Hi(S)}</strong>
                  <span>${x.summary}</span>
                </div>`:null}
          </div>
        ...
        <div class="command-warroom-strip-stats">
          <div class="monitor-stat-card">
            <span>워커</span>
            <strong>${Z??0}/${V??0}</strong>
            <small>${l?((hs=t==null?void 0:t.summary)==null?void 0:hs.completed_workers)??0:0} 완료 · ${_.length} 카드</small>
          </div>
          <div class="monitor-stat-card">
            <span>런타임</span>
          ...
          <div class="monitor-stat-card ${M(Ra(S))}">
            <span>상주 판정기</span>
            <strong>${Wi($)}</strong>
                ...
                `:a?o`
                    <article class="command-guide-card">
                      <div class="command-guide-head">
                        ...
                        <span class="command-chip ${M(Ht(a.status))}">${xt(a.status)}</span>
                      </div>
        ...
        <div class="command-warroom-column">
          <section class="card command-section">
            ...
            ${t&&t.recent_messages.length>0&&l?o`<div class="command-trace-stack">
                  ${t.recent_messages.map(te=>o`
                    <article class="command-trace-row">
                      <div class="command-trace-main">
                        <div class="command-trace-head">
                          <strong>${te.from}</strong>
                          <span class="command-chip">${ne(te.timestamp)}</span>
                        </div>
                  ...
                  `)}
                </div>`:C.length>0||L.length>0?o`<div class="command-card-stack">
                    ${C.slice(0,4).map(te=>o`
                      <article class="command-guide-card ${wr(te)}">
                        <div class="command-guide-head">
                          <strong>${te.action_type}</strong>
                          <span class="command-chip ${wr(te)}">${te.target_type}</span>
                        </div>
                        <p>${te.reason}</p>
                      </article>
                    `)}
                    ${L.slice(0,3).map(te=>o`
                      <article class="command-alert ${M(te.severity)}">
                        <div class="command-card-head">
                          <strong>${te.kind}</strong>
                          <span class="command-chip ${M(te.severity)}">${te.severity}</span>
                        </div>
                        <p>${te.summary}</p>
                      </article>
                    `)}
                  </div>`:a!=null&&a.recent_events&&a.recent_events.length>0?o`<div class="command-trace-stack">
                      ${a.recent_events.slice(0,6).map((te,Ss)=>o`
                        <article class="command-trace-row">
                          <div class="command-trace-main">
                            <div class="command-trace-head">
                          ...
                          <pre class="command-trace-detail">${Ca(te)}</pre>
                        </article>
                      `)}
          ...
          <section class="card command-section">
            ...
            ${t&&t.recent_trace_events.length>0?o`<div class="command-trace-stack">
                  ${t.recent_trace_events.map(te=>o`<${Ji} event=${te} />`)}
        ...
        <div class="command-warroom-column">
          <section class="card command-section">
            ...
            <div class="command-card-stack">
              ...
              ${h.length>0?h.map(te=>o`<${id} blocker=${te} />`):o`<div class="command-guide-card ok"><p>지금 보이는 blocker는 없습니다.</p></div>`}
              ${f>0?o`
              ...
              ${v.length>0?o`
                    <article class="command-guide-card warn">
                      ...
                      <div class="command-tag-row">
                        ${v.slice(0,3).map(te=>o`<span class="command-tag">${te.confirm_token}</span>`)}
                      </div>
                    </article>
                  `:null}
            </div>
              ...
              ${l&&(t!=null&&t.operation)?o`
                    <article class="command-card compact">
                      <div class="command-card-head">
                        ...
                        <span class="command-chip ${M(Ht(t.operation.status))}">${xt(t.operation.status)}</span>
                      </div>
                      <div class="command-card-grid">
                        ...
                        <span>최근 갱신</span><span>${ne(t.operation.updated_at)}</span>
                      </div>
                    </article>
                  `:null}
              ${l&&(t!=null&&t.detachment)?o`
                    <article class="command-card compact">
                      <div class="command-card-head">
                        ...
                        <span class="command-chip ${M(Ht(t.detachment.status))}">${xt(t.detachment.status??"active")}</span>
                      </div>
                      <div class="command-card-grid">
                        ...
                        <span>하트비트</span><span>${Bc(t.detachment.heartbeat_deadline)}</span>
                      </div>
                    </article>
                  `:null}
              ${a?o`
  ...
  `}function Fr(e){switch((e??"").trim().toLowerCase()){case"active":return"가동 중";case"paused":return"일시정지";case"failed":return"실패";case"completed":case"done":return"완료";case"disconnected":return"끊김";case"preview":return"미리보기";case"captured":return"기록됨";default:return(e==null?void 0:e.trim())||"확인 필요"}}function u$({source:e}){const t=Td(null),[n,s]=ol(null);return oe(()=>{let a=!1;const i=t.current;return i?(i.innerHTML="",s(null),(async()=>{try{const c=await bf(),{svg:p}=await c.render(`command-chain-${yf()}`,e);if(a||!t.current)return;t.current.innerHTML=p}catch(c){if(a)return;s(c instanceof Error?c.message:"Mermaid 렌더링에 실패했습니다")}})(),()=>{a=!0,t.current&&(t.current.innerHTML="")}):void 0},[e]),o`
    <div class="command-chain-graph-shell">
      ${n?o`<div class="empty-state error">${n}</div>`:null}
      <div class="command-chain-graph" ref=${t}></div>
    </div>
  `}function p$({overlay:e,selected:t,onSelect:n}){const s=e.operation.chain,a=e.runtime;return o`
    <button class="command-chain-item ${t?"selected":""}" onClick=${n}>
      ...
      <div class="command-tag-row">
        ...
        ${a?o`<span class="command-tag ${lt(s==null?void 0:s.status)}">${_s(a.progress)} progress</span>`:null}
      </div>
  ...
  `}function m$({item:e}){return o`
    <article class="command-chain-history-row">
      ...
      <div class="command-card-sub">${ne(e.timestamp)}</div>
      <div class="command-card-sub">${Uc(e)}</div>
    </article>
  `}function _$({node:e}){return o`
  ...
  `}function v$({card:e}){const t=e.operation,n=`pause:${t.operation_id}`,s=`resume:${t.operation_id}`,a=`recall:${t.operation_id}`,i=t.chain,l=(i==null?void 0:i.run_id)??null;return o`
    <article class="command-card">
      <div class="command-card-head">
        ...
        <span class="command-chip ${M(t.status==="active"?"ok":t.status==="paused"?"warn":t.status==="failed"?"bad":"ok")}">${Fr(t.status)}</span>
      </div>
      <div class="command-card-grid">
        ...
        <span>최근 갱신</span><span>${ne(t.updated_at)}</span>
      </div>
      ${i?o`
            <div class="command-tag-row">
  ...
  `}function f$({card:e}){var n;const t=e.detachment;return o`
    <article class="command-card compact">
      <div class="command-card-head">
        <div>
      ...
      <div class="command-card-grid">
        ...
        <span>진행 흔적</span><span>${ne(t.last_progress_at)}</span>
        <span>하트비트</span><span>${Bc(t.heartbeat_deadline)}</span>
        <span>최근 갱신</span><span>${ne(t.updated_at)}</span>
      </div>
      <div class="command-tag-row">
  ...
  `}function g$(){const e=Be.value;return o`
    <div class="command-surface-grid">
      <section class="card command-section">
        <div class="card-title-row">
        ...
        ${e&&e.operations.operations.length>0?o`<div class="command-card-stack">
              ${e.operations.operations.map(t=>o`<${v$} card=${t} />`)}
      ...
      <section class="card command-section">
        ...
        ${e&&e.detachments.detachments.length>0?o`<div class="command-card-stack">
              ${e.detachments.detachments.map(t=>o`<${f$} card=${t} />`)}
            </div>`:o`<div class="empty-state">투영된 분견대가 없습니다.</div>`}
      </section>
    </div>
  `}function $$(){var c,p,_,u,f,v,h,b,C,x,S,$,L,I,P,Q;const e=ds.value,t=(e==null?void 0:e.operations)??[],n=tn.value,s=t.find(z=>z.operation.operation_id===n)??t[0]??null,a=((c=s==null?void 0:s.operation.chain)==null?void 0:c.run_id)??null,i=((p=Hn.value)==null?void 0:p.run)??(s==null?void 0:s.preview_run)??null,l=!((_=Hn.value)!=null&&_.run)&&!!(s!=null&&s.preview_run);return oe(()=>{a?H_(a):U_()},[a]),o`
      ...
      <section class="card command-section">
        ...
        <article class="command-guide-card ${lt(e==null?void 0:e.connection.status)}">
          ...
          <div class="command-card-grid">
            ...
            <span>마지막 이벤트</span><span>${ne((h=e==null?void 0:e.summary)==null?void 0:h.last_history_event_at)}</span>
          </div>
        </article>

        ${ha.value?o`<div class="empty-state error">${ha.value}</div>`:null}
                ...
                <div class="command-chain-list">
                  ${t.map(z=>o`
                    <${p$}
                      ...
                      onSelect=${()=>Mi(z.operation.operation_id)}
                    />
                  `)}
                </div>
        ...
        <div class="command-chain-history">
          ...
          ${e&&e.recent_history.length>0?o`
                <div class="command-card-stack">
                  ${e.recent_history.slice(0,6).map(z=>o`<${m$} item=${z} />`)}
                </div>
        ...
        ${s?o`
              <article class="command-card">
                ...
                <div class="command-card-grid">
                  ...
                  <span>진행률</span><span>${_s(($=s.runtime)==null?void 0:$.progress)}</span>
                  <span>경과</span><span>${In((L=s.runtime)==null?void 0:L.elapsed_sec)}</span>
                  <span>최근 갱신</span><span>${ne(((I=s.operation.chain)==null?void 0:I.last_sync_at)??s.operation.updated_at)}</span>
                </div>
              ...
              <div class="command-chain-panel">
                ...
                ${ya.value?o`<div class="empty-state">실행 상세 불러오는 중…</div>`:Wn.value?o`<div class="empty-state error">${Wn.value}</div>`:i&&i.nodes.length>0?o`
                          <div class="command-card-grid">
  ...
  `}function h$(e){switch((e??"").trim().toLowerCase()){case"pending":return"대기 중";case"approved":return"승인됨";case"denied":return"거부됨";case"executed":return"실행됨";case"active":return"가동 중";default:return(e==null?void 0:e.trim())||"확인 필요"}}function y$({decision:e}){const t=`approve:${e.decision_id}`,n=`deny:${e.decision_id}`,s=e.source==="projected_operator";return o`
    <article class="command-card ${M(e.status)}">
      <div class="command-card-head">
        ...
        <span class="command-chip ${M(e.status)}">${h$(e.status??"pending")}</span>
      </div>
      <div class="command-card-grid">
        ...
        <span>생성 시각</span><span>${ne(e.created_at)}</span>
  ...
  `}function b$({row:e}){var c,p,_;const t=e.unit,n=`freeze:${t.unit_id}`,s=`kill:${t.unit_id}`,a=!!((c=t.policy)!=null&&c.frozen),i=!!((p=t.policy)!=null&&p.kill_switch),l=Math.round((e.utilization??0)*100);return o`
    <article class="command-card compact">
      <div class="command-card-head">
        <div>
    ...
    <div class="command-surface-grid">
      <section class="card command-section">
        ...
        ${e&&e.decisions.decisions.length>0?o`<div class="command-card-stack">
              ${e.decisions.decisions.map(t=>o`<${y$} decision=${t} />`)}
      ...
      <section class="card command-section">
        ...
        ${e&&e.capacity.capacity.length>0?o`<div class="command-card-stack">
              ${e.capacity.capacity.map(t=>o`<${b$} row=${t} />`)}
      ...
      ${xf.map(e=>o`
        <div class="command-tab-group" key=${e.id}>
          ...
          <div class="command-tab-group-items">
            ${Hc.filter(t=>t.group===e.id).map(t=>o`
                <button
  ...
  `}function S$(){if(X.value==="warroom")return o`<${d$} />`;if(X.value==="summary")return o`<${ug} />`;if(X.value==="orchestra")return o`<${bg} />`;if(X.value==="swarm")return o`<${a$} />`;if(!Be.value)return o`<${pg} />`;switch(X.value){case"chains":return o`<${$$} />`;case"topology":return o`<${Kg} />`;case"alerts":return o`<${Bg} />`;case"trace":return o`<${Ug} />`;case"control":return o`<${k$} />`;case"operations":default:return o`<${g$} />`}}function C$(){return oe(()=>{Ut(),nn(),W_(),tt(),Rt()},[]),oe(()=>{if(O.value.tab!=="command")return;const e=O.value.params.surface,t=O.value.params.operation,n=us(O.value);if(Ir(e))rt(e);else if(n){const s=Ac(n);Ir(s)&&rt(s)}else e||rt("warroom");t&&Mi(t),(e==="swarm"||e==="warroom"||e==="orchestra"||X.value==="warroom"||X.value==="orchestra")&&tt(),(e==="orchestra"||X.value==="orchestra")&&Rt(),(e==="warroom"||X.value==="warroom")&&xe()},[O.value.tab,O.value.params.surface,O.value.params.operation,O.value.params.operation_id,O.value.params.run_id,O.value.params.source,O.value.params.action_type,O.value.params.target_type,O.value.params.target_id,O.value.params.focus_kind]),oe(()=>{let e=null;const t=()=>{e||(e=window.setTimeout(()=>{e=null,Ut(),nn(),(X.value==="swarm"||X.value==="warroom"||X.value==="orchestra")&&tt(),X.value==="orchestra"&&Rt(),X.value==="warroom"&&xe()},250))},n=new EventSource(If()),s=Cf.map(a=>{const i=()=>t();return n.addEventListener(a,i),{type:a,handler:i}});return n.onerror=()=>{t()},()=>{s.forEach(({type:a,handler:i})=>{n.removeEventListener(a,i)}),n.close(),e&&window.clearTimeout(e)}},[]),oe(()=>{const e=window.setInterval(()=>{if(document.visibilityState==="hidden")return;const t=X.value;t!=="swarm"&&t!=="warroom"&&t!=="orchestra"||(Ut(),tt(),t==="orchestra"&&Rt(),t==="warroom"&&xe())},5e3);return()=>{window.clearInterval(e)}},[]),o`
    <section class="dashboard-panel command-plane-view">
      <div class="panel-header">
        ...
        <div class="panel-actions">
          ...
          <button
            class="control-btn ghost"
            onClick=${()=>{It(),Ut(),nn(),tt(),X.value==="warroom"&&xe()}}
            disabled=${da.value}
          >
  ...
  `}function A$(){var x,S;const e=$e.value,t=Ti.value,n=(e==null?void 0:e.room)??{},s=(e==null?void 0:e.pending_confirms)??[],a=e==null?void 0:e.pending_confirm_summary,i=a?a.confirm_required_actions:((e==null?void 0:e.available_actions)??[]).filter($=>$.confirm_required),l=((x=a==null?void 0:a.actor_filter)==null?void 0:x.trim())||null,c=(a==null?void 0:a.hidden_count)??0,p=(a==null?void 0:a.hidden_actors)??[],_=(e==null?void 0:e.recent_messages)??[],u=(t==null?void 0:t.recommended_actions)??[],f=(S=t==null?void 0:t.active_recommended_actions)!=null&&S.length?t.active_recommended_actions:u,v=t==null?void 0:t.active_summary,h=(t==null?void 0:t.resident_judge_runtime)??(e==null?void 0:e.resident_judge_runtime),b=(t==null?void 0:t.active_guidance_layer)??"fallback",C=_.slice(0,5);return o`
    <div class="ops-column">
      <section class="card ops-panel ops-lane-panel">
        ...
        <div class="control-row ops-split-row">
          <input
            ...
            type="text"
            value=${Aa.value}
            onInput=${$=>{Aa.value=$.target.value}}
            disabled=${Y.value}
          />
          <button class="control-btn ghost" onClick=${()=>{jg()}} disabled=${Y.value}>
            일시정지
          </button>
        ...
        <div class="control-row ops-split-row">
          ...
          <button class="control-btn" onClick=${()=>{Eg()}} disabled=${Y.value||on.value.trim()===""}>
            주입
          </button>
        </div>
      </section>
      ...
      <section class="card ops-panel">
        ...
        <article class="ops-guidance-card ${Ra(b)}">
            ...
            ${f.map($=>o`
              <article key=${`${$.action_type}:${$.target_type}:${$.target_id??"room"}`} class="ops-log-entry ${$.severity}">
                <div class="ops-log-head">
                  ...
                  <span>${La($.confirm_required)}</span>
                </div>
                <div class="ops-log-body">${$.reason}</div>
                ${$.suggested_payload?o`
                  <div class="ops-confirmation-actions">
                    <button class="control-btn ghost" onClick=${()=>{Pg($)}} disabled=${Y.value}>
                      폼에 채우기
                    </button>
                  </div>
                `:null}
          ...
          <div class="ops-confirmation-list">
            ${s.map($=>o`
              <article key=${$.confirm_token} class="ops-confirmation-card">
                ...
                ${$.preview?o`<pre class="ops-code-block compact">${za($.preview)}</pre>`:null}
                <div class="ops-confirmation-actions">
  ...
  `}function T$(){var _;const e=$e.value,t=Fe.value,n=(e==null?void 0:e.sessions)??[],s=((e==null?void 0:e.available_actions)??[]).filter(u=>u.target_type==="team_session"),a=n.find(u=>u.session_id===un.value)??n[0]??null,i=t==null?void 0:t.active_summary,l=(t==null?void 0:t.active_guidance_layer)??"fallback",c=(t==null?void 0:t.resident_judge_runtime)??(e==null?void 0:e.resident_judge_runtime),p=(_=t==null?void 0:t.active_recommended_actions)!=null&&_.length?t.active_recommended_actions:(t==null?void 0:t.recommended_actions)??[];return o`
    <div class="ops-column">
      <section class="card ops-panel ops-lane-panel">
        <div class="card-title-row">
      ...
      <section class="card ops-panel">
        ...
        ${a&&t?o`
          <article class="ops-guidance-card ${Ra(l)}">
            <div class="ops-guidance-head">
              <strong>${Hi(l)}</strong>
              <span>${Wi(c)}</span>
            </div>
      ...
      <section class="card ops-panel ops-lane-panel">
          ...
          <div class="ops-log-list">
            ${s.map(u=>o`
              <article key=${u.action_type} class="ops-log-entry">
                <div class="ops-log-head">
                  <strong>${Mt(u.action_type)}</strong>
                  <span>${La(u.confirm_required)}</span>
                </div>
        ...
        <div class="control-row ops-split-row">
          ...
          <button class="control-btn" onClick=${()=>{Ng()}} disabled=${Y.value||!a}>
            적용
          </button>
        </div>
        <div class="ops-context-note">현재 선택: ${Ig(ke.value)}</div>
        ...
        <div class="control-row ops-split-row">
          <input
            ...
            disabled=${Y.value||!a}
          />
          <button class="control-btn ghost" onClick=${()=>{Dg()}} disabled=${Y.value||!a}>
            세션 중지
          </button>
        </div>
      </section>
    </div>
  `}function I$(){var i;const e=$e.value,t=(e==null?void 0:e.keepers)??[],n=(e==null?void 0:e.persistent_agents)??[],s=(e==null?void 0:e.available_actions)??[],a=t.find(l=>l.name===Ia.value)??t[0]??null;return o`
    <div class="ops-column">
      ...
      <section class="card ops-panel ops-lane-panel">
        ...
        ></textarea>
        <div class="control-row">
          <button class="control-btn" onClick=${()=>{Og()}} disabled=${Y.value||!a||rn.value.trim()===""}>
            keeper에 보내기
          </button>
        </div>
      </section>
          ...
          ${s.length?s.map(l=>o`
                <article key=${`${l.action_type}:${l.target_type}`} class="ops-log-entry">
                  <div class="ops-log-head">
                    ...
                    <span>${La(l.confirm_required)}</span>
                  </div>
  ...
  `}function z$(){var I,P,Q;const e=$e.value,t=O.value.tab==="intervene"?us(O.value):null,n=Ti.value,s=(e==null?void 0:e.room)??{},a=(e==null?void 0:e.sessions)??[],i=(e==null?void 0:e.keepers)??[],l=(e==null?void 0:e.pending_confirms)??[],c=e==null?void 0:e.pending_confirm_summary,p=(c==null?void 0:c.visible_count)??l.length,_=(c==null?void 0:c.total_count)??l.length,u=(c==null?void 0:c.hidden_count)??0,f=((I=c==null?void 0:c.actor_filter)==null?void 0:I.trim())||null,v=a.find(z=>z.session_id===un.value)??a[0]??null,h=(n==null?void 0:n.attention_items)??[],b=h.filter(Ag),C=h.filter(Tg),x=a.filter(z=>Cg(z)!=="ok"),S=i.filter(z=>lo(z)!=="ok"),$=Mg(t,a,i);oe(()=>{jt()},[]),oe(()=>{if(O.value.tab!=="intervene"){Rs.value=null;return}if(!t){Rs.value=null;return}Rs.value!==t.id&&(Rs.value=t.id,Lg(t))},[O.value.tab,O.value.params.source,O.value.params.action_type,O.value.params.target_type,O.value.params.target_id,O.value.params.focus_kind,t==null?void 0:t.id]),oe(()=>{const z=(v==null?void 0:v.session_id)??null;dn(z)},[v==null?void 0:v.session_id]);const L=[{key:"room",label:"방 게이트",value:s.paused?"일시정지":"열림",detail:s.paused?`재개 전환 대기 중${s.pause_reason?` · ${s.pause_reason}`:""}`:"지금은 새 액션과 새 작업을 바로 받을 수 있습니다",tone:s.paused?"bad":"ok"},{key:"confirm",label:"확인 대기",value:u>0?`${p}/${_}`:p,detail:p>0?"미리보기만 된 개입이 아직 사람 확인을 기다리고 있습니다":u>0&&f?`현재 개입 ID(${f}) 기준으로는 비어 있고, 다른 개입 ID 대기 ${u}건이 있습니다`:"지금 막혀 있는 확인 대기는 없습니다",tone:_>0?"warn":"ok"},{key:"session",label:"세션 리스크",value:b.length>0?b.length:a.length,detail:b.length>0?((P=b[0])==null?void 0:P.summary)??"세션 중 하나가 방향 수정이나 중지 판단을 기다리고 있습니다":a.length===0?"지금 관리 중인 팀 세션이 없습니다":"세션 쪽 긴급 주의 신호는 현재 없습니다",tone:b.length>0?Dr(b):a.length===0?"warn":x.some(z=>pn(z.status)==="paused")?"bad":x.length>0?"warn":"ok"},{key:"keeper",label:"키퍼 압력",value:C.length>0?C.length:S.length,detail:C.length>0?((Q=C[0])==null?void 0:Q.summary)??"직접 메시지나 상태 점검이 필요한 키퍼가 있습니다":S.length>0?"오래됐거나 오프라인이거나 텔레메트리가 비는 키퍼가 보입니다":"지금은 키퍼 쪽이 비교적 안정적입니다",tone:C.length>0?Dr(C):S.some(z=>lo(z)==="bad")?"bad":S.length>0?"warn":"ok"}];return o`
    <section class="ops-view">
      ...
      <div class="ops-header card">
        ...
        <div class="ops-toolbar">
          ...
          <input
            ...
            type="text"
            value=${Ya.value}
            onInput=${z=>xg(z.target.value)}
          />
            <button
              class="control-btn ghost"
              onClick=${()=>{It(),xe(),jt(),dn((v==null?void 0:v.session_id)??null)}}
            disabled=${Bn.value||Y.value}
          >
      ...
      ${(()=>{const z=[];if((p>0||u>0)&&z.push({label:u>0?`확인 대기 ${p}/${_}건 확인`:`확인 대기 ${p}건 처리`,desc:u>0&&f?`현재 개입 ID(${f}) 기준으로 보이는 대기열을 먼저 확인합니다`:"승인 또는 거부가 필요한 개입이 대기 중입니다",tone:p>0?"bad":"warn",onClick:()=>{const V=document.querySelector(".ops-pending-section");V==null||V.scrollIntoView({behavior:"smooth"})}}),s.paused&&z.push({label:"방 재개",desc:`현재 일시정지 상태${s.pause_reason?` (${s.pause_reason})`:""}`,tone:"warn",onClick:()=>void Xc()}),S.length>0){const V=S.filter(Z=>lo(Z)==="bad");z.push({label:V.length>0?`오프라인 키퍼 ${V.length}개`:`점검이 필요한 키퍼 ${S.length}개`,desc:V.length>0?"메시지를 보내거나 상태를 확인하세요":"오래됐거나 텔레메트리가 비어 있습니다",tone:V.length>0?"bad":"warn",onClick:()=>{const Z=document.querySelector(".ops-keeper-section");Z==null||Z.scrollIntoView({behavior:"smooth"})}})}return z.length===0?null:o`
  ...
  `}function R$({text:e}){if(!e)return null;const t=L$(e);return o`<div class="markdown-content">${t}</div>`}function L$(e){const t=e.split(`
...
`))}</p>`)}return n}function co(e){const t=[],n=/(`[^`]+`)|(\*\*[^*]+\*\*)|(\*[^*]+\*)|\[([^\]]+)\]\(([^)]+)\)/g;let s=0,a;for(;(a=n.exec(e))!==null;){if(a.index>s&&t.push(e.slice(s,a.index)),a[1]){const i=a[1].slice(1,-1);t.push(o`<code>${i}</code>`)}else if(a[2]){const i=a[2].slice(2,-2);t.push(o`<strong>${i}</strong>`)}else if(a[3]){const i=a[3].slice(1,-1);t.push(o`<em>${i}</em>`)}else a[4]&&a[5]&&t.push(o`<a href=${a[5]} target="_blank" rel="noopener">${a[4]}</a>`);s=a.index+a[0].length}return s<e.length&&t.push(e.slice(s)),t.length>0?t:[e]}const rd=[{id:"recent",label:"최신순"},{id:"hot",label:"인기순"},{id:"trending",label:"급상승"},{id:"updated",label:"최근 갱신"},{id:"discussed",label:"토론 많은 순"}],Vs=g(null),Ys=g([]),mn=g(!1),Pt=g(null),jn=g(""),En=g(!1),Jt=g(!0),Vi=20,wt=g(Vi);function P$(){var t,n;const e=new URLSearchParams(window.location.search);return((t=e.get("agent"))==null?void 0:t.trim())||((n=e.get("agent_name"))==null?void 0:n.trim())||"dashboard-user"}const M$=g(P$());function j$(e){const t=e.replace(/!\[[^\]]*\]\([^)]+\)/g," ").replace(/\[[^\]]+\]\([^)]+\)/g,"$1").replace(/[`#>*_~-]/g," ").replace(/\s+/g," ").trim();return t?t.length>180?`${t.slice(0,177)}...`:t:"미리보기 없음"}function Kr(e){return e.updated_at!==e.created_at}function E$(e){if(e.post_kind)return e.post_kind==="automation";const t=(e.hearth??"").toLowerCase();return e.visibility!=="internal"||!e.expires_at||!t?!1:!!(t.startsWith("mdal")||t.includes("harness"))}function N$(e){return e==="lodge-system"||e==="team-session"}function ns(e){return e.post_kind?e.post_kind:N$(e.author)?"system":E$(e)?"automation":"human"}function ld(e){const t=[],n=[];let s=0;return e.forEach(a=>{const i=ns(a);if(!(i==="system"&&At.value)){if(i==="automation"&&Jt.value){s+=1;return}if(i==="human"){t.push(a);return}n.push(a)}}),{human:t,operations:n,hiddenAutomation:s}}function D$(e){if(!e.expires_at)return null;const t=Date.parse(e.expires_at);return Number.isFinite(t)?t<=Date.now()?o`<span class="board-meta-chip">만료됨</span>`:o`<span class="board-meta-chip">만료까지 <${W} timestamp=${e.expires_at} /></span>`:null}async function Yi(e){Pt.value=e,Vs.value=null,Ys.value=[],mn.value=!0;try{const t=await zu(e);if(Pt.value!==e)return;Vs.value={id:t.id,author:t.author,title:t.title,body:t.body,content:t.content,meta:t.meta,tags:t.tags,votes:t.votes,vote_balance:t.vote_balance,comment_count:t.comment_count,created_at:t.created_at,updated_at:t.updated_at,post_kind:t.post_kind,flair:t.flair,hearth:t.hearth,visibility:t.visibility,expires_at:t.expires_at,hearth_count:t.hearth_count},Ys.value=t.comments??[]}catch{Pt.value===e&&(Vs.value=null,Ys.value=[])}finally{Pt.value===e&&(mn.value=!1)}}async function Br(e){const t=jn.value.trim();if(t){En.value=!0;try{await Ru(e,M$.value,t),jn.value="",E("댓글을 등록했습니다","success"),await Yi(e),ot()}catch{E("댓글 등록에 실패했습니다","error")}finally{En.value=!1}}}function O$(){const e=Fn.value,t=Jt.value?"자동화 글 숨김":"자동화 글 표시 중";return o`
    <div class="board-toolbar">
      <div class="board-controls">
        ${rd.map(n=>o`
          <button
            class="board-sort-btn ${e===n.id?"active":""}"
            onClick=${()=>{Fn.value=n.id,wt.value=Vi,ot()}}
          >
            ${n.label}
          </button>
        `)}
  ...
  `}function uo(){var s;const e=((s=rd.find(a=>a.id===Fn.value))==null?void 0:s.label)??Fn.value,t=ld(Ha.value),n=t.human.length+t.operations.length;return o`
  ...
  `}function Ur({post:e}){const t=async(n,s)=>{s.stopPropagation();try{await kl(e.id,n),ot()}catch{E("투표에 실패했습니다","error")}};return o`
    <div class="board-post" onClick=${()=>Pd(e.id)}>
      ...
      <div class="post-content">
        ...
        <div class="post-snippet">${j$(e.body)}</div>
      </div>
    </div>
  `}function q$({comments:e}){return e.length===0?o`<div class="empty-state" style="font-size:13px">아직 댓글이 없습니다</div>`:o`
  ...
  `}function F$({post:e}){Pt.value!==e.id&&!mn.value&&Yi(e.id);const t=async n=>{try{await kl(e.id,n),ot()}catch{E("Failed to vote","error")}};return o`
    <div>
      ...
      <${T} title="댓글" semanticId="memory.feed">
        ${mn.value?o`<div class="loading-indicator">댓글 불러오는 중...</div>`:o`<${q$} comments=${Ys.value} />`}
        <${w$} postId=${e.id} />
      <//>
    </div>
  `}function K$(){const e=ld(Ha.value),t=[...e.human,...e.operations],n=O.value.params.post??null,s=n?t.find(a=>a.id===n)??(Pt.value===n?Vs.value:null):null;return n&&!s&&Pt.value!==n&&!mn.value&&Yi(n),n?s?o`
          <${Se} surfaceId="memory" />
          <${uo} />
          <${F$} post=${s} />
        `:o`
      ...
      ${Kn.value?o`<div class="loading-indicator">메모리 피드 불러오는 중...</div>`:t.length===0?o`<div class="empty-state">지금은 남아 있는 메모리 글이 없습니다</div>`:o`
              <${T} title="사람이 쓴 글" class="section" semanticId="memory.feed">
                <div class="board-post-list">
                  ${e.human.slice(0,wt.value).map(a=>o`<${Ur} key=${a.id} post=${a} />`)}
                </div>
              ...
              ${e.operations.length>0?o`
                    <${T} title="자동화 · 시스템" class="section" semanticId="memory.feed">
                      <div class="board-post-list">
                        ${e.operations.map(a=>o`<${Ur} key=${a.id} post=${a} />`)}
                      </div>
                    <//>
                  `:null}
            `}
    </div>
  `}function B$({ratio:e,size:t=40,stroke:n=4}){if(e==null)return null;const s=(t-n)/2,a=t/2,i=2*Math.PI*s,l=i*((100-e*100)/100);let c="mitosis-safe";return e>=.8?c="mitosis-critical":e>=.5&&(c="mitosis-warn"),o`
  ...
  `}const St=g(null),Ue=g(null),He=g(null);function _n(e){return e==="bad"||e==="critical"||e==="offline"?"bad":e==="warn"||e==="paused"||e==="blocked"||e==="interrupted"?"warn":"ok"}function Pa(e){switch((e??"").trim().toLowerCase()){case"ok":case"healthy":case"green":return"안정";case"active":case"running":return"진행 중";case"paused":return"일시정지";case"blocked":return"막힘";case"interrupted":return"중단됨";case"warn":return"주의";case"bad":case"critical":return"위험";case"offline":return"오프라인";case"idle":case"quiet":return"대기";case"unknown":case"":return"확인 필요";default:return(e==null?void 0:e.trim())||"확인 필요"}}function U$(e){return e==="session"?"세션":"작전"}function H$(e){return typeof e!="number"||Number.isNaN(e)?"—":`${Math.round(e*100)}%`}function W$(e){return e?vt.value.find(t=>t.name===e||t.agent_name===e)??null:null}function G$(e){switch(e){case"working":return"작업 중";case"watching":return"대기 중";case"quiet":return"조용함";case"offline":return"오프라인"}}function J$(e){switch(e){case"critical":return"위험";case"warning":return"주의";default:return"정상"}}function V$(e){switch(e){case"acted":return"행동";case"passed":return"통과";case"skipped":return"건너뜀";case"failed":return"실패";default:return e}}function Y$(e){switch(e){case"post":return"post";case"comment":return"comment";case"vote":return"vote";case"none":case null:case void 0:return"none";default:return e}}function Ma(e,t="없음"){const n=e??[];return n.length===0?t:n.length<=3?n.join(", "):`${n.slice(0,3).join(", ")} +${n.length-3}`}function Hr(e){if(!e)return;const t=dv({targetType:e.target_type,targetId:e.target_id,focusKind:e.focus_kind,operationId:e.operation_id??null,commandSurface:e.command_surface??null,sourceLabel:"실행 진단",summary:e.label});Sc(t),ie(e.surface,e.surface==="intervene"?Cc(t):Tc(t))}function Re({label:e,value:t,color:n,caption:s}){return o`
    <div class="stat-card">
    ...
    <div class="control-row">
      ${e?o`
            <button
              ...
              onClick=${n=>{n.stopPropagation(),Hr(e)}}
            >
              ${e.label}
            </button>
          `:null}
      ${t?o`
            <button
              ...
              onClick=${n=>{n.stopPropagation(),Hr(t)}}
            >
              ${t.label}
            </button>
          `:null}
    </div>
  `}function Q$({item:e,selected:t}){return o`
    <button
      class="mission-card-select ${t?"active":""}"
      data-testid="execution.queue-card"
      onClick=${()=>{St.value=t?null:e.id,Ue.value=null,He.value=null}}
    >
      <div class="mission-card-head">
        <div>
        ...
        <span class="command-chip ${_n(e.severity)}">${Pa(e.status??e.severity)}</span>
      </div>
  ...
  `}function X$({brief:e,selected:t}){return o`
    <button
      ...
      onClick=${()=>{Ue.value=t?null:e.session_id,He.value=null}}
    >
      <div class="mission-card-head">
        <div>
          <div class="mission-card-target">${e.session_id}${e.room?` · ${e.room}`:""}</div>
        ...
        <span class="command-chip ${_n(e.health??e.status)}">${Pa(e.status)}</span>
      </div>
      <div class="mission-card-meta">
  ...
  `}function Z$({brief:e,selected:t}){return o`
    <button
      class="mission-card-select ${t?"active":""}"
      data-testid="execution.operation-card"
      onClick=${()=>{He.value=t?null:e.operation_id,Ue.value=e.linked_session_id??null}}
    >
      <div class="mission-card-head">
        <div>
        ...
        <span class="command-chip ${_n(e.blocker_summary?"warn":e.status)}">${Pa(e.status)}</span>
      </div>
      <div class="mission-card-meta">
  ...
  `:o`<div class="empty-state">최근 lodge tick 기록이 없습니다.</div>`}function th({row:e}){return o`
    <button
    ...
    >
      <div class="monitor-row-header">
        ...
        <span class="monitor-pill ${_n(e.outcome==="failed"?"bad":e.outcome==="skipped"?"warn":"ok")}">${V$(e.outcome)}</span>
      </div>
      <div class="monitor-meta">
        <span>trigger · ${e.trigger??"unknown"}</span>
        ${e.checked_at?o`<span><${W} timestamp=${e.checked_at} /></span>`:null}
        <span>action · ${Y$(e.action_kind)}</span>
      ...
      <div class="monitor-footnote">
        허용 도구: ${Ma(e.allowed_tool_names)} · 사용 도구: ${Ma(e.used_tool_names)}
      </div>
  ...
  `}function Wr({row:e,testId:t}){return o`
    <button class="monitor-row ${e.tone} state-${e.state}" data-testid=${t} onClick=${()=>ms(e.name)}>
      <div class="monitor-row-header">
        ...
        <span class="monitor-pill ${e.tone} state-${e.state}">${G$(e.state)}</span>
      </div>
  ...
  `}function nh({row:e}){var n,s;const t=()=>{const a=W$(e.name);a&&Fc(a)};return o`
    <button class="monitor-row ${e.tone} state-${e.state}" data-testid="execution.continuity-card" onClick=${t}>
      <div class="monitor-row-header">
        ...
        <${B$} ratio=${e.context_ratio??0} size=${34} stroke=${4} />
        <${gt} status=${e.status??"unknown"} />
        <span class="monitor-pill ${e.tone}">${J$(e.state)}</span>
      </div>
      ...
      ${(((n=e.recent_tool_names)==null?void 0:n.length)??0)>0||(((s=e.allowed_tool_names)==null?void 0:s.length)??0)>0?o`<div class="monitor-footnote">
            recent tools: ${Ma(e.recent_tool_names)} · allowed: ${Ma(e.allowed_tool_names)}
          </div>`:null}
    </button>
  `}function sh(){const e=Tl.value,t=Il.value,n=zl.value,s=Rl.value,a=Ll.value,i=Pl.value,l=yi.value,c=bi.value,p=Ml.value;St.value&&!t.some($=>$.id===St.value)&&(St.value=null),Ue.value&&!n.some($=>$.session_id===Ue.value)&&(Ue.value=null),He.value&&!s.some($=>$.operation_id===He.value)&&(He.value=null);const _=St.value?t.find($=>$.id===St.value)??null:null,u=Ue.value?Ue.value:_?_.kind==="session"?_.target_id:_.linked_session_id??null:null,f=He.value?He.value:_?_.kind==="operation"?_.target_id:_.linked_operation_id??null:null,v=u?n.filter($=>$.session_id===u):f?n.filter($=>$.linked_operation_id===f):n,h=f?s.filter($=>$.operation_id===f):u?s.filter($=>{var L;return $.linked_session_id===u||$.operation_id===((L=v[0])==null?void 0:L.linked_operation_id)}):s,b=u||f?a.filter($=>(u?$.related_session_id===u:!1)||(f?$.related_operation_id===f:!1)):a,C=u?c.filter($=>$.related_session_id===u||$.tone!=="ok"):c,x=u?l.filter($=>v.some(L=>L.member_names.includes($.agent_name))):l,S=u||f?p.filter($=>(u?$.related_session_id===u:!1)||(f?$.related_operation_id===f:!1)||$.tone!=="ok"):p;return o`
    <div class="agents-monitor">
      ...
      >
        ...
        <div class="monitor-alert-list">
          ${t.length===0?o`<div class="empty-state">지금은 막힌 실행이 없습니다.</div>`:t.map($=>o`<${Q$} key=${$.id} item=${$} selected=${St.value===$.id} />`)}
        </div>
      <//>
      ...
      <div class="agents-workbench">
        ...
        >
          ...
          <div class="monitor-list">
            ${v.length===0?o`<div class="empty-state">선택된 실행과 연결된 세션이 없습니다.</div>`:v.map($=>o`<${X$} key=${$.session_id} brief=${$} selected=${Ue.value===$.session_id} />`)}
          </div>
        <//>
        ...
        >
          ...
          <div class="monitor-list">
            ${h.length===0?o`<div class="empty-state">선택된 실행과 연결된 작전이 없습니다.</div>`:h.map($=>o`<${Z$} key=${$.operation_id} brief=${$} selected=${He.value===$.operation_id} />`)}
          </div>
        <//>
        ...
        >
          ...
          <${eh} tick=${i} />
          <div class="monitor-list">
            ${x.length===0?o`<div class="empty-state">최근 lodge check-in 기록이 없습니다.</div>`:x.map($=>o`<${th} key=${`${$.agent_name}-${$.checked_at??$.outcome}`} row=${$} />`)}
          </div>
        <//>
        ...
        >
          ...
          <div class="monitor-list">
            ${C.length===0?o`<div class="empty-state">지금은 연속성 경고가 없습니다.</div>`:C.map($=>o`<${nh} key=${$.name} row=${$} />`)}
          </div>
        <//>
  ...
  `}const oi=g(null),ii=g(null),Nn=g(!1);async function Gr(){if(!Nn.value){Nn.value=!0,ii.value=null;try{oi.value=await du()}catch(e){ii.value=e instanceof Error?e.message:String(e)}finally{Nn.value=!1}}}function ah(e){switch(e){case"essential":return"badge-essential";case"standard":return"badge-standard";default:return"badge-full"}}function oh({items:e,maxCount:t}){return e.length===0?o`<p class="muted">No tool calls recorded yet.</p>`:o`
    <div class="tool-bar-chart">
      ${e.map(n=>{const s=t>0?n.call_count/t*100:0;return o`
          <div class="tool-bar-row" key=${n.name}>
            ...
            <span class="tool-bar-tier ${ah(n.tier)}">${n.tier}</span>
  ...
  `}function ih({dist:e}){const t=e.full,n=t>0?(e.essential/t*100).toFixed(1):"0",s=t>0?(e.standard/t*100).toFixed(1):"0",a=t-e.standard,i=t>0?(a/t*100).toFixed(1):"0";return o`
    <div class="tier-dist">
  ...
  `}function rh(){const e=oi.value,t=Nn.value,n=ii.value;return oe(()=>{!oi.value&&!Nn.value&&Gr()},[]),o`
  ...
  `}function dh(){const e=ri.value,t=Dn.value,n=li.value,s=(e==null?void 0:e.tool_inventory.tools)??[],a=(e==null?void 0:e.tool_usage)??null;oe(()=>{!ri.value&&!Dn.value&&Jr()},[]),oe(()=>{var h;if(O.value.tab!=="tools")return;const v=(h=O.value.params.q)==null?void 0:h.trim();v&&v!==Cn.value&&(Cn.value=v)},[O.value.tab,O.value.params.q]);const i=Array.from(new Set(s.map(v=>v.category))).sort((v,h)=>v.localeCompare(h)),l=s.filter(v=>!(!lh(v,Cn.value)||Ls.value!=="all"&&v.category!==Ls.value||po.value&&!v.enabled_in_current_mode||mo.value&&!v.direct_call_allowed||!_o.value&&v.visibility==="hidden"||!vo.value&&v.lifecycle==="deprecated")),c=s.length,p=s.filter(v=>v.enabled_in_current_mode).length,_=s.filter(v=>v.visibility==="hidden").length,u=s.filter(v=>v.lifecycle==="deprecated").length,f=s.filter(v=>v.direct_call_allowed).length;return o`
    <div>
      <${T} title="System Tool Inventory" class="section">
        ...
        <div class="tool-inventory-list">
          ${l.length>0?l.map(v=>o`<${ch} key=${v.name} item=${v} />`):o`<div class="empty-state">No tools matched the current filters.</div>`}
        </div>
      <//>
  ...
  `}const ja=g("all"),Ea=g("all"),ci=g(new Set);function uh(e){const t=new Set(ci.value);t.has(e)?t.delete(e):t.add(e),ci.value=t}const cd=Le(()=>{let e=Qt.value;return ja.value!=="all"&&(e=e.filter(t=>t.horizon===ja.value)),Ea.value!=="all"&&(e=e.filter(t=>t.status===Ea.value)),e}),ph=Le(()=>{const e={short:[],mid:[],long:[]};for(const t of cd.value){const n=e[t.horizon];n&&n.push(t)}return e}),mh=Le(()=>{const e=Array.from(El.value.values());return e.sort((t,n)=>t.status==="running"&&n.status!=="running"?-1:n.status==="running"&&t.status!=="running"?1:t.status==="interrupted"&&n.status!=="interrupted"?-1:n.status==="interrupted"&&t.status!=="interrupted"?1:n.elapsed_seconds-t.elapsed_seconds),e});function _h(e){return"★".repeat(Math.min(e,5))+"☆".repeat(Math.max(0,5-e))}function Xi(e){switch(e){case"short":return"단기";case"mid":return"중기";case"long":return"장기";default:return e}}function Qs(e){switch(e){case"short":return"#4ade80";case"mid":return"#f59e0b";case"long":return"#818cf8";default:return"#888"}}function vh(e){return e<60?`${Math.round(e)}s`:e<3600?`${Math.floor(e/60)}m ${Math.round(e%60)}s`:`${Math.floor(e/3600)}h ${Math.floor(e%3600/60)}m`}function Vr(e){return e.toFixed(4)}function Yr(e){const t=e.current_metric-e.baseline_metric;return`${t>=0?"+":""}${t.toFixed(4)}`}function fh(e){switch(e){case 1:return"P1";case 2:return"P2";case 3:return"P3";default:return"P4"}}function gh(e){switch(e){case"active":return"진행 중";case"completed":return"완료";case"paused":return"일시정지";default:return"전체"}}function Qr(e,t){return(e.priority??4)-(t.priority??4)}function $h(e,t){const n=e.updated_at??e.created_at??"";return(t.updated_at??t.created_at??"").localeCompare(n)}function hh(e,t){return e.length<=t?e:e.slice(0,t)+"..."}function yh({goal:e}){return o`
    <div class="goal-row">
      <div class="goal-row-main">
        ...
        <div class="goal-meta">
          <span class="goal-priority" title="Priority ${e.priority}">${_h(e.priority)}</span>
  ...
  `}function fo({horizon:e,items:t}){if(t.length===0)return null;const n=[...t].sort((s,a)=>a.priority-s.priority);return o`
    <${T} title="${Xi(e)} 목표 (${t.length})" class="section" semanticId="planning.goal_pipeline">
      <div class="goal-list">
        ${n.map(s=>o`<${yh} key=${s.id} goal=${s} />`)}
      </div>
    <//>
  `}function bh(){return o`
  ...
  `}function kh(){const e=Qt.value,t=e.filter(a=>a.status==="active").length,n=e.filter(a=>a.status==="completed").length,s={short:0,mid:0,long:0};for(const a of e)a.horizon in s&&s[a.horizon]++;return o`
  ...
  `}function xh({loop:e}){const t=e.history[0],n=e.latest_tool_names&&e.latest_tool_names.length>0?`${e.latest_tool_call_count??e.latest_tool_names.length}개 도구: ${e.latest_tool_names.join(", ")}`:"아직 근거 없음";return o`
    <div class="planning-loop-row">
      <div class="planning-loop-main">
        ...
        <div class="planning-loop-metrics">
          ...
          <span>Elapsed ${vh(e.elapsed_seconds)}</span>
        </div>
  ...
  `}function go({task:e}){const t=e.priority??4,n=t<=1?"p1":t===2?"p2":t===3?"p3":"p4",s=ci.value.has(e.id),a=!!e.description;return o`
    <div class="kanban-card ${n}">
      <div class="kanban-card-header">
        <span class="priority-badge priority-badge--${n}">${fh(t)}</span>
      ...
      ${a?o`
        <div
          ...
          onClick=${()=>uh(e.id)}
        >
          ${s?e.description:hh(e.description??"",80)}
        </div>
      `:null}
  ...
  `}function Sh(){const{todo:e,inProgress:t,done:n}=Dl.value,s=[...e].sort(Qr),a=[...t].sort(Qr),i=[...n].sort($h);return o`
  ...
  `}function Ch(){const{todo:e,inProgress:t,done:n}=Dl.value,s=e.length+t.length+n.length,a=[...e,...t].filter(u=>(u.priority??4)<=2).length,i=ph.value,l=mh.value,c=Qt.value.length>0,p=l.length>0,_=ki.value;return o`
    <div>
      ...
      <details class="overview-section-collapsible" open=${c}>
        ...
        <div>
          ${c?o`
            <${kh} />
            <${bh} />
            ${zn.value&&Qt.value.length===0?o`<div class="loading-indicator">목표 불러오는 중...</div>`:cd.value.length===0?o`<div class="empty-state">현재 필터에 맞는 목표가 없습니다</div>`:o`
      ...
      <details class="overview-section-collapsible" open=${p}>
        ...
        <div>
          ${Rn.value&&l.length===0?o`<div class="loading-indicator">MDAL 루프 불러오는 중...</div>`:l.length===0&&(_==="error"||Xt.value)?o`<div class="empty-state">MDAL 스냅샷을 불러오지 못했습니다${Xt.value?`: ${Xt.value}`:""}. 백엔드 상태를 확인하세요.</div>`:l.length===0?o`<div class="empty-state">가동 중인 루프가 없습니다. <code>masc_mdal_start</code>로 시작할 수 있습니다.</div>`:o`
                  <div class="planning-loop-list">
                    ${l.map(u=>o`<${xh} key=${u.loop_id} loop=${u} />`)}
                  </div>
                `}
        </div>
      </details>
    </div>
  `}const Na=g(!1),On=g(!1),Vt=g(!1),mt=g(""),qn=g(""),di=g("open"),Oe=g(null),ss=g(null),Da=g(null),Oa=g(null),ui=g(!1);function as(e){return`${e.kind}:${e.id}`}function Zi(){var n;const e=ss.value,t=((n=Oe.value)==null?void 0:n.items)??[];return e?t.find(s=>as(s)===e)??null:null}function Ah(){const e=new URLSearchParams(window.location.search),t=e.get("agent")??e.get("agent_name");return(t==null?void 0:t.trim())||"dashboard"}function Th(e){const t=e.trim().toLowerCase();return t==="open"||t==="pending"}function dd(e){return!!(e.judgment_summary&&e.judgment_summary.trim())}function ud(e){switch(di.value){case"needs_quorum":return e.filter(t=>t.kind==="consensus"&&(t.votes??0)<(t.quorum??0));case"ready":return e.filter(t=>{var n;return(n=t.guardrail_state)==null?void 0:n.ready_to_execute});case"needs_approval":return e.filter(t=>{var n,s;return((n=t.guardrail_state)==null?void 0:n.requires_human_gate)||!!((s=t.guardrail_state)!=null&&s.pending_confirm)});case"judge_offline":return e.filter(t=>!dd(t));case"open":default:return e.filter(t=>Th(t.status))}}function Ih(e){if(e==null)return"없음";if(typeof e=="string")return e;try{return JSON.stringify(e,null,2)}catch{return String(e)}}function Qa(e){const t=(e||"").toLowerCase();return t.includes("reject")||t.includes("deny")||t.includes("closed")||t.includes("cancel")?"negative":t.includes("approve")||t.includes("support")||t.includes("open")||t.includes("ready")?"positive":"neutral"}function zh(e){return typeof e!="number"||Number.isNaN(e)?"확인 필요":`${Math.round(e*100)}%`}function An(e){return"resolved_tool"in e||"payload_preview"in e||"reason"in e}async function pd(e){if(Da.value=null,Oa.value=null,!!e){ui.value=!0,mt.value="";try{e.kind==="debate"?Da.value=await sp(e.id):Oa.value=await ap(e.id)}catch(t){mt.value=t instanceof Error?t.message:"거버넌스 상세를 불러오지 못했습니다"}finally{ui.value=!1}}}async function Rh(e){ss.value=as(e),await pd(e)}async function vn(){var e;Na.value=!0,mt.value="";try{const t=await su();Oe.value=t;const n=ud(t.items??[]),s=ss.value,a=n.find(i=>as(i)===s)??n[0]??((e=t.items)==null?void 0:e[0])??null;ss.value=a?as(a):null,await pd(a)}catch(t){mt.value=t instanceof Error?t.message:"거버넌스 상태를 불러오지 못했습니다"}finally{Na.value=!1}}vm(vn);async function Xr(){const e=qn.value.trim();if(e){On.value=!0;try{const t=await np(e);qn.value="",E(t!=null&&t.id?`토론을 시작했습니다: ${t.id}`:"토론을 시작했습니다","success"),await vn()}catch(t){const n=t instanceof Error?t.message:"토론 시작에 실패했습니다";mt.value=n,E(n,"error")}finally{On.value=!1}}}async function Zr(e){var i,l;const t=Zi(),n=(i=t==null?void 0:t.guardrail_state)==null?void 0:i.pending_confirm,s=n==null?void 0:n.confirm_token;if(!s)return;const a=((l=n==null?void 0:n.actor)==null?void 0:l.trim())||Ah();Vt.value=!0;try{await fl(a,s,e),E(e==="confirm"?"액션을 승인했습니다":"액션을 거부했습니다","success"),await vn()}catch(c){const p=c instanceof Error?c.message:"대기 중인 액션 처리에 실패했습니다";mt.value=p,E(p,"error")}finally{Vt.value=!1}}function Lh(){var n,s,a,i,l,c;const e=(n=Oe.value)==null?void 0:n.summary,t=(s=Oe.value)==null?void 0:s.judge;return o`
    <div class="board-summary-strip">
      <div class="board-summary-item">
    ...
    <${T} title="거버넌스 콘솔" class="section" semanticId="governance.supervisor">
      <div class="governance-toolbar">
        <div class="council-create">
          ...
          <button class="control-btn ghost" onClick=${vn} disabled=${Na.value}>
  ...
  `}function Mh(){var t;const e=ud(((t=Oe.value)==null?void 0:t.items)??[]);return o`
  ...
  `}function jh({argument:e}){return o`
  ...
  `}function Nh(){const e=Zi(),t=Da.value,n=Oa.value;return o`
    <${T}
    ...
    >
      ${ui.value?o`<div class="loading-indicator">거버넌스 상세 불러오는 중...</div>`:e?e.kind==="debate"&&t?o`
                ...
                <div class="governance-ledger">
                  ${t.arguments.length===0?o`<div class="empty-state">기록된 토론이 아직 없습니다.</div>`:t.arguments.map(s=>o`<${jh} key=${s.index} argument=${s} />`)}
                </div>
              `:e.kind==="consensus"&&n?o`
                  ...
                  <div class="governance-ledger">
                    ${n.votes.length===0?o`<div class="empty-state">기록된 표결이 아직 없습니다.</div>`:n.votes.map(s=>o`<${Eh} key=${s.agent+s.timestamp} vote=${s} />`)}
                  </div>
                `:o`<div class="empty-state">이 의사결정의 상세를 아직 읽을 수 없습니다.</div>`:o`<div class="empty-state">사실 계층과 판단을 보려면 의사결정 항목을 고르세요.</div>`}
    <//>
  `}function el({title:e,route:t}){if(!t)return null;const n=An(t)?t.resolved_tool:t.delegated_tool,s=An(t)?t.target_type:null,a=An(t)?t.target_id:null,i=An(t)?t.reason:null,l=An(t)?t.payload_preview:null;return o`
    <div class="governance-side-block">
      ...
      ${l?o`<pre class="council-detail governance-preview">${Ih(l)}</pre>`:null}
    </div>
  `}function Dh(){var c,p,_;const e=Zi(),t=Da.value,n=Oa.value,s=(t==null?void 0:t.context)??(n==null?void 0:n.context)??(e==null?void 0:e.context),a=(t==null?void 0:t.judgment)??(n==null?void 0:n.judgment),i=e==null?void 0:e.guardrail_state,l=(c=Oe.value)==null?void 0:c.judge;return o`
  ...
  `}const Ft=g(""),$o=g("ability_check"),ho=g("10"),yo=g("12"),Ms=g(""),js=g("idle"),et=g(""),Es=g("keeper-late"),bo=g("player"),ko=g(""),Ae=g("idle"),xo=g(null),Ns=g(""),So=g(""),Co=g("player"),Ao=g(""),To=g(""),Io=g(""),wn=g("20"),zo=g("20"),Ro=g(""),Ds=g("idle"),pi=g(null),md=g("overview"),Lo=g("all"),Po=g("all"),Mo=g("all"),qh=12e4,Xa=g(null),tl=g(Date.now());function wh(e,t){const n=t>0?e/t*100:0;return n>50?"hp-high":n>25?"hp-mid":"hp-low"}function Fh(e,t){return t>0?Math.round(e/t*100):0}const Kh={pragmatic:"리스크보다 확실한 이득을 우선합니다.",frugal:"자원 소모를 줄이고 효율을 챙깁니다.",impatient:"짧은 템포로 즉시 압박을 선호합니다.",stubborn:"한 번 정한 전술을 끝까지 밀어붙입니다.",protective:"아군 피해를 줄이는 선택을 우선합니다.","honor-bound":"약속과 규율을 지키는 행동에 보너스가 납니다.",intense:"집중 화력을 짧게 폭발시킵니다.",empathetic:"아군/약자 보호 쪽 선택 확률이 높아집니다.",fatalistic:"위험을 감수하는 고배수 선택을 탑니다.",suspicious:"함정/매복 경계 행동을 우선합니다.",precise:"단일 목표를 정확히 노리는 경향입니다.",vengeful:"직전 위협 대상에게 강하게 반응합니다.",aggressive:"공격적인 전진 행동을 우선합니다.",opportunistic:"빈틈이 열리면 즉시 추격합니다."},Bh={supply_scan:"전장/자원 상태를 스캔해 약한 지점을 찾습니다.",ration_shift:"소모를 줄이고 지속 전투 능력을 확보합니다.",logistics_patch:"무너진 운영 라인을 빠르게 복구합니다.",frontline_shield:"전열에서 아군 피해를 흡수합니다.",oath_intercept:"핵심 타깃을 가로막아 위협을 차단합니다.",morale_anchor:"아군 안정도를 높여 붕괴를 막습니다.",omen_trace:"다음 위험 신호를 먼저 감지합니다.",arc_flash:"짧은 순간 광역 압박을 넣습니다.",ward_bloom:"방어 장막을 펼쳐 생존률을 올립니다.",mark_prey:"우선 제거 대상을 지정합니다.",silent_route:"은밀한 진입 경로를 확보합니다.",finisher_strike:"약화된 적을 마무리하는 일격입니다.",shadow_claw:"근접 급습으로 출혈 피해를 노립니다.",lunge:"짧은 돌진으로 전열을 흔듭니다."};function Os(e){const t=e.trim();return t?t.split(/[_-]+/g).filter(n=>n.length>0).map(n=>n[0]?`${n[0].toUpperCase()}${n.slice(1)}`:n).join(" "):e}function Uh(e){const t=e.trim().toLowerCase();return Kh[t]??"행동 선택 가중치에 영향을 주는 성향입니다."}function Hh(e){const t=e.trim().toLowerCase();return Bh[t]??"상황에 따라 선택되는 전술 액션입니다."}function be(e,t,n=""){const s=e[t];return typeof s=="string"?s:n}function Ee(e,t,n=0){const s=e[t];return typeof s=="number"&&Number.isFinite(s)?s:n}function os(e,t,n=!1){const s=e[t];return typeof s=="boolean"?s:n}const Wh=new Set(["str","dex","con","int","wis","cha"]);function Gh(e){const t=e.trim();if(!t)return{};let n;try{n=JSON.parse(t)}catch(a){throw new Error(`능력치 JSON 파싱 실패: ${a instanceof Error?a.message:"invalid json"}`)}if(!m(n))throw new Error('능력치 JSON은 object여야 합니다. 예: {"luck":7}');const s={};return Object.entries(n).forEach(([a,i])=>{const l=a.trim();if(l){if(typeof i=="number"&&Number.isFinite(i)){s[l]=Math.max(0,Math.trunc(i));return}if(typeof i=="string"){const c=Number.parseFloat(i.trim());if(Number.isFinite(c)){s[l]=Math.max(0,Math.trunc(c));return}}throw new Error(`능력치 '${l}' 값은 숫자여야 합니다.`)}}),s}function Jh(e){const t=Number.parseInt(e.trim(),10);if(!Number.isFinite(t))return;const n=Math.max(1,t),s=Number.parseInt(wn.value.trim(),10);Number.isFinite(s)&&s>n&&(wn.value=String(n))}function mi(e){const n=(e.actor_name??e.actor??e.actor_id??"system").trim();return n===""?"system":n}function Vh(e){var n;return(((n=e.timestamp)==null?void 0:n.trim())??"")||"-"}function Yh(e){md.value=e}function _d(e){const t=Xa.value;return t==null||t<=e}function Qh(e){const t=Xa.value;return t==null||t<=e?0:Math.max(0,Math.ceil((t-e)/1e3))}function qa(){Xa.value=null}function vd(e){return typeof window>"u"||typeof window.confirm!="function"?!0:window.confirm(e)}function Xh(e,t){vd(["관전 모드 잠금을 해제하시겠습니까?",`ROOM: ${e||"-"}`,`PHASE: ${t||"-"}`,"해제 시간: 120초 (시간 경과 또는 위험 액션 실행 후 자동 재잠금)"].join(`
`))&&(Xa.value=Date.now()+qh,E("조작 잠금이 120초 동안 해제되었습니다.","warning"))}function Xs(e){return _d(e)?(E("관전 모드 잠금 상태입니다. 먼저 잠금을 해제하세요.","warning"),!1):!0}function _i(e,t,n){return vd([`[위험 액션 확인] ${e}`,`ROOM: ${t||"-"}`,`PHASE: ${n||"-"}`,"이 액션은 즉시 실행되며 되돌리기 어렵습니다.","계속 진행하시겠습니까?"].join(`
`))}function Zh({hp:e,max:t}){const n=Fh(e,t),s=wh(e,t);return o`
  ...
  `}function ty({keeper:e,role:t}){if(!e)return null;const n=t==="dm"?"dm":"player";return o`
    <span class="trpg-keeper-chip">
      <span class="trpg-keeper-tag ${n}">${n}</span>
      ${e}
    </span>
  `}function fd({actor:e}){var p,_,u,f;const t=(p=e.archetype)==null?void 0:p.trim(),n=(_=e.persona)==null?void 0:_.trim(),s=(u=e.portrait)==null?void 0:u.trim(),a=(f=e.background)==null?void 0:f.trim(),i=e.traits??[],l=e.skills??[],c=Object.entries(e.stats_raw??{}).filter(([v,h])=>Number.isFinite(h)).filter(([v])=>!Wh.has(v.toLowerCase()));return o`
    <div class="trpg-actor">
      ...
      <div class="trpg-actor-header">
        ...
        <${ty} keeper=${e.keeper} role=${e.role} />
      </div>
      ${e.stats?o`
          <div style="margin-top:4px;">
            ...
            <${Zh} hp=${e.stats.hp} max=${e.stats.max_hp} />
            <${ey} stats=${e.stats} />
          </div>
        `:null}
      ...
      ${c.length>0?o`
          <div class="trpg-annot-group">
            ...
            <div class="trpg-custom-stats">
              ${c.map(([v,h])=>o`
                <span class="trpg-custom-stat-chip">${Os(v)} ${h}</span>
              `)}
            </div>
          </div>
        `:null}
            ...
            <div class="trpg-annot-list">
              ${i.map(v=>o`
                <span class="trpg-annot-chip trait">
                  <span class="trpg-annot-name">${Os(v)}</span>
  ...
  `}function ny({mapStr:e}){return o`<pre class="trpg-map">${e}</pre>`}function gd({events:e,emptyLabel:t="아직 이벤트가 없습니다."}){return e.length===0?o`<div class="empty-state" style="font-size:13px">${t}</div>`:o`
    <div class="trpg-story" role="list" aria-label="TRPG story events">
      ${e.map((n,s)=>{var a;return o`
        <div key=${s} class="trpg-event ${n.type??""}" role="listitem">
          <div class="trpg-event-meta-row">
            <span class="trpg-event-meta">${Vh(n)}</span>
  ...
  `}function sy({events:e}){const t="__none__",n=Lo.value,s=Po.value,a=Mo.value,i=Array.from(new Set(e.map(mi).map(f=>f.trim()).filter(f=>f!==""))).sort((f,v)=>f.localeCompare(v)),l=Array.from(new Set(e.map(f=>(f.type??"").trim()).filter(f=>f!==""))).sort((f,v)=>f.localeCompare(v)),c=e.some(f=>(f.type??"").trim()===""),p=Array.from(new Set(e.map(f=>(f.phase??"").trim()).filter(f=>f!==""))).sort((f,v)=>f.localeCompare(v)),_=e.some(f=>(f.phase??"").trim()===""),u=e.filter(f=>{if(n!=="all"&&mi(f)!==n)return!1;const v=(f.type??"").trim(),h=(f.phase??"").trim();if(s===t){if(v!=="")return!1}else if(s!=="all"&&v!==s)return!1;if(a===t){if(h!=="")return!1}else if(a!=="all"&&h!==a)return!1;return!0});return o`
  ...
  `}function oy({state:e,nowMs:t}){var _;const n=Je.value||((_=e.session)==null?void 0:_.room)||"",s=js.value,a=e.party??[];if(!a.find(u=>u.id===Ft.value)&&a.length>0){const u=a[0];u&&(Ft.value=u.id)}const l=async()=>{var f,v;if(!n){E("Room ID가 비어 있습니다.","error");return}if(!Xs(t))return;const u=((f=e.current_round)==null?void 0:f.phase)??((v=e.session)==null?void 0:v.status)??"unknown";if(_i("라운드 실행",n,u)){js.value="running";try{const h=await Hu(n);pi.value=h,js.value="ok";const b=m(h.summary)?h.summary:null,C=b?os(b,"advanced",!1):!1,x=b?be(b,"progress_reason",""):"";E(C?"라운드가 정상 진행되었습니다.":`라운드가 정체되었습니다${x?`: ${x}`:""}`,C?"success":"warning"),it()}catch(h){pi.value=null,js.value="error";const b=h instanceof Error?h.message:"라운드 실행에 실패했습니다.";E(b,"error")}finally{qa()}}},c=async()=>{var f,v;if(!n||!Xs(t))return;const u=((f=e.current_round)==null?void 0:f.phase)??((v=e.session)==null?void 0:v.status)??"unknown";if(_i("턴 강제 진행",n,u))try{await Ju(n),E("턴을 다음 단계로 이동했습니다.","success"),it()}catch{E("턴 이동에 실패했습니다.","error")}finally{qa()}},p=async()=>{if(!n||!Xs(t))return;const u=Ft.value.trim();if(!u){E("먼저 Actor를 선택하세요.","warning");return}const f=Number.parseInt(ho.value,10),v=Number.parseInt(yo.value,10);if(Number.isNaN(f)||Number.isNaN(v)){E("stat/dc는 숫자여야 합니다.","warning");return}const h=Number.parseInt(Ms.value,10),b=Ms.value.trim()===""||Number.isNaN(h)?void 0:h;try{await Gu({roomId:n,actorId:u,action:$o.value.trim()||"ability_check",statValue:f,dc:v,rawD20:b}),E("주사위 판정을 기록했습니다.","success"),it()}catch{E("주사위 판정 기록에 실패했습니다.","error")}};return o`
        ...
        <div class="trpg-control-field">
          ...
          <div style="display:grid; grid-template-columns: 1fr 1fr; gap:6px;">
            ...
            <input
              ...
              type="text"
              value=${Ms.value}
              onInput=${u=>{Ms.value=u.target.value}}
  ...
  `}function iy({state:e}){var a;const t=Je.value||((a=e.session)==null?void 0:a.room)||"",n=Ds.value,s=async()=>{if(!t){E("Room ID가 비어 있습니다.","warning");return}const i=Ns.value.trim(),l=So.value.trim();if(!l&&!i){E("이름 또는 Actor ID를 입력하세요.","warning");return}const c=Number.parseInt(wn.value.trim(),10),p=Number.parseInt(zo.value.trim(),10),_=Number.isFinite(p)?Math.max(1,p):20,u=Number.isFinite(c)?Math.max(0,Math.min(_,c)):_;let f={};try{f=Gh(Ro.value)}catch(v){E(v instanceof Error?v.message:"능력치 JSON 오류","error");return}Ds.value="spawning";try{const v=typeof crypto<"u"&&typeof crypto.randomUUID=="function"?`trpg_spawn_${crypto.randomUUID()}`:`trpg_spawn_${Date.now().toString(36)}_${Math.random().toString(36).slice(2,10)}`,h=await Vu(t,{actor_id:i||void 0,name:l||void 0,role:Co.value,idempotencyKey:v,portrait:To.value.trim()||void 0,background:Io.value.trim()||void 0,hp:u,max_hp:_,alive:u>0,stats:Object.keys(f).length>0?f:void 0}),b=typeof h.actor_id=="string"?h.actor_id.trim():"";if(!b)throw new Error("생성 응답에 actor_id가 없습니다.");const C=Ao.value.trim();C&&await Yu(t,b,C),Ft.value=b,et.value=b,i||(Ns.value=""),Ds.value="ok",E(`Actor 생성 완료: ${b}`,"success"),await it()}catch(v){Ds.value="error",E(v instanceof Error?v.message:"Actor 생성에 실패했습니다.","error")}};return o`
    <div class="trpg-control-box">
      <div class="trpg-control-grid">
        <div class="trpg-control-field">
          <label>Name</label>
        ...
        <div class="trpg-control-grid">
          ...
          <div class="trpg-control-field">
            ...
            <input
              ...
              min="1"
              value=${zo.value}
              onInput=${i=>{const l=i.target.value;zo.value=l,Jh(l)}}
              placeholder="20"
            />
          </div>
  ...
  `}function ry({state:e,nowMs:t}){var v;const n=Je.value||((v=e.session)==null?void 0:v.room)||"",s=e.join_gate,a=xo.value,i=m(a)?a:null,l=(e.party??[]).filter(h=>h.role!=="dm"),c=et.value.trim(),p=l.some(h=>h.id===c),_=p?c:c?"__manual__":"",u=async()=>{const h=et.value.trim(),b=Es.value.trim();if(!n||!h){E("Room/Actor가 필요합니다.","warning");return}Ae.value="checking";try{const C=await Qu(n,h,b||void 0);xo.value=C,Ae.value="ok",E("참가 가능 여부를 갱신했습니다.","success")}catch(C){Ae.value="error";const x=C instanceof Error?C.message:"참가 가능 여부 확인에 실패했습니다.";E(x,"error")}},f=async()=>{var S,$;const h=et.value.trim(),b=Es.value.trim(),C=ko.value.trim();if(!n||!h||!b){E("Room/Actor/Keeper가 필요합니다.","warning");return}if(!Xs(t))return;const x=((S=e.current_round)==null?void 0:S.phase)??(($=e.session)==null?void 0:$.status)??"unknown";if(_i("Mid-Join 승인 요청",n,x)){Ae.value="requesting";try{const L=await Xu({room_id:n,actor_id:h,keeper_name:b,role:bo.value,...C?{name:C}:{}});xo.value=L;const I=m(L)?os(L,"granted",!1):!1,P=m(L)?be(L,"reason_code",""):"";I?E("Mid-Join이 승인되었습니다.","success"):E(`Mid-Join이 거절되었습니다${P?`: ${P}`:""}`,"warning"),Ae.value=I?"ok":"error",it()}catch(L){Ae.value="error";const I=L instanceof Error?L.message:"Mid-Join 요청에 실패했습니다.";E(I,"error")}finally{qa()}}};return o`
    <div class="trpg-control-box">
      ...
      <div class="trpg-control-grid">
        ...
        <div class="trpg-control-field">
          ...
          <input
            ...
            type="text"
            value=${Es.value}
            onInput=${h=>{Es.value=h.target.value}}
            placeholder="keeper-name"
          />
        </div>
        <div class="trpg-control-field">
  ...
  `:null}function bd(){const e=pi.value;if(!e)return o`<div class="empty-state" style="font-size:13px;">Run Round 결과가 아직 없습니다.</div>`;const t=e.summary,n=m(t)?t:null,a=(Array.isArray(e.statuses)?e.statuses:[]).filter(m).slice(-8),i=e.canon_check,l=m(i)?i:null,c=l&&Array.isArray(l.warnings)?l.warnings.filter(P=>typeof P=="string").slice(0,3):[],p=l&&Array.isArray(l.violations)?l.violations.filter(P=>typeof P=="string").slice(0,3):[],_=n?os(n,"advanced",!1):!1,u=n?be(n,"progress_reason",""):"",f=n?be(n,"progress_detail",""):"",v=n?Ee(n,"player_successes",0):0,h=n?Ee(n,"player_required_successes",0):0,b=n?os(n,"dm_success",!1):!1,C=n?Ee(n,"timeouts",0):0,x=n?Ee(n,"unavailable",0):0,S=n?Ee(n,"reprompts",0):0,$=n?Ee(n,"npc_attacks",0):0,L=n?Ee(n,"keeper_timeout_sec",0):0,I=n?Ee(n,"roll_audit_count",0):0;return o`
    <div style="display:grid; gap:10px;">
      ...
      ${a.length>0?o`
          <div class="trpg-round-list">
            ${a.map(P=>{const Q=be(P,"status","unknown"),z=be(P,"actor_id","-"),V=be(P,"role","-"),Z=be(P,"reason",""),ae=be(P,"action_type",""),B=be(P,"reply","");return o`
                <div class="trpg-round-item ${Q.includes("fallback")||Q.includes("timeout")?"failed":"active"}">
                  ...
                  ${B?o`<div style="width:100%; font-size:11px; color:#d1d5db; margin-top:2px;">${B.slice(0,120)}</div>`:null}
                </div>
              `})}
          </div>`:null}
  ...
  `}function ly({state:e,nowMs:t}){var l,c,p;const n=Je.value||((l=e.session)==null?void 0:l.room)||"",s=((c=e.current_round)==null?void 0:c.phase)??((p=e.session)==null?void 0:p.status)??"unknown",a=_d(t),i=Qh(t);return o`
    <${T} title="조작 안전 잠금" style="margin-bottom:16px;" semanticId="lab.trpg">
      <div class="trpg-control-lock ${a?"locked":"unlocked"}">
        ...
        <div style="display:flex; gap:8px; margin-top:10px; flex-wrap:wrap;">
          ${a?o`<button class="trpg-run-btn recommend" onClick=${()=>Xh(n,s)}>잠금 해제 (120초)</button>`:o`<button class="trpg-run-btn secondary" onClick=${()=>{qa(),E("조작 잠금으로 전환했습니다.","success")}}>즉시 다시 잠금</button>`}
        </div>
      </div>
    <//>
  `}function cy({active:e}){return o`
  ...
  `}function dy({state:e}){const t=e.party??[],n=e.story_log??[];return o`
  ...
  `}function py({state:e,nowMs:t}){const n=e.party??[];return o`
    <div>
      <${ly} state=${e} nowMs=${t} />
      <div class="trpg-layout">
        <div>
  ...
  `}function my(){var c,p,_,u,f;const e=jl.value,t=Ho.value;if(oe(()=>{if(typeof window>"u"||typeof window.setInterval!="function")return;const v=window.setInterval(()=>{tl.value=Date.now()},1e3);return()=>{window.clearInterval(v)}},[]),t&&!e)return o`<div class="loading-indicator">Loading TRPG state...</div>`;if(!e)return o`
      <div class="section">
        <h2>TRPG</h2>
    ...
    <div>
      ...
      <div style="display:flex; gap:8px; align-items:center; justify-content:space-between; margin-bottom:8px;">
        <div style="font-size:11px; color:#8ea9d6;">
          room: ${Je.value||((c=e.session)==null?void 0:c.room)||"-"} · phase: ${((p=e.current_round)==null?void 0:p.phase)??((_=e.session)==null?void 0:_.status)??"-"}
        </div>
      ...
      ${i==="overview"?o`<${dy} state=${e} />`:i==="timeline"?o`<${uy} state=${e} />`:o`<${py} state=${e} nowMs=${l} />`}
    </div>
  `}function _y(){return o`
    <div>
      <${Se} surfaceId="lab" />
  ...
  `}const wa=g(new Set(["broadcast","tasks","keepers","system"]));function vy(e){const t=new Set(wa.value);t.has(e)?t.delete(e):t.add(e),wa.value=t}const er=g(null);function kd(e){er.value=e}function fy(e){return e.kind==="board"?"broadcast":e.kind==="tasks"?"tasks":e.kind==="keepers"?"keepers":"system"}const gy=Le(()=>{const e=wa.value;return ea.value.filter(t=>e.has(fy(t)))}),$y=12e4,hy=Le(()=>{const e=Ol.value,t=Date.now();return Qe.value.map(n=>{const s=n.name.trim().toLowerCase(),a=e.get(s)??null;let i="idle";if(n.status==="active"||n.status==="busy"){const l=a==null?void 0:a.lastActivityAt;l?i=t-new Date(l).getTime()>$y?"stale":"working":i="working"}else(n.status==="offline"||n.status==="inactive")&&(i="stale");return{name:n.name,emoji:n.emoji??"",koreanName:n.koreanName??null,state:i,currentTask:n.current_task,motion:a}})}),yy=Le(()=>{const e=Ol.value;return Qe.value.filter(t=>t.status==="active"||t.status==="busy"||t.status==="listening"||t.status==="idle").map(t=>{const n=t.name.trim().toLowerCase(),s=e.get(n),a=(s==null?void 0:s.activeAssignedCount)??0;let i="calm";return a>=3?i="hot":a>=1&&(i="normal"),{name:t.name,emoji:t.emoji??"",koreanName:t.koreanName??null,currentTask:t.current_task,lastActivityAt:(s==null?void 0:s.lastActivityAt)??null,lastActivityText:(s==null?void 0:s.lastActivityText)??null,assignedCount:a,pressure:i}}).sort((t,n)=>{const s={hot:0,normal:1,calm:2};return s[t.pressure]-s[n.pressure]})});function nl(e){return e.kind==="board"?"live-event-broadcast":e.kind==="tasks"?"live-event-task":e.kind==="keepers"?"live-event-keeper":"live-event-system"}function by(e){const t=e.eventType;return t==="broadcast"?"broadcast":t==="agent_joined"?"joined":t==="agent_left"?"left":t==="task_update"?"task":t==="board_post"?"post":t==="board_comment"?"comment":t==="keeper_heartbeat"?"heartbeat":t==="keeper_handoff"?"handoff":t==="keeper_compaction"?"compact":t==="keeper_guardrail"?"guardrail":e.kind==="board"?"board":e.kind==="tasks"?"task":e.kind==="keepers"?"keeper":"system"}function ky(e){switch(e){case"working":return"pulse-working";case"stale":return"pulse-stale";default:return"pulse-idle"}}function xy(){const e=hy.value,t=er.value;return e.length===0?o`
    ...
    <div class="pulse-strip">
      ${e.map(n=>o`
        <button
          key=${n.name}
          class="pulse-bubble ${ky(n.state)} ${t===n.name?"pulse-selected":""}"
  ...
  `}const Sy=[{kind:"broadcast",label:"Broadcast",cssClass:"live-event-broadcast"},{kind:"tasks",label:"Task",cssClass:"live-event-task"},{kind:"keepers",label:"Keeper",cssClass:"live-event-keeper"},{kind:"system",label:"System",cssClass:"live-event-system"}];function Cy(){const e=wa.value;return o`
  ...
  `}function Ay(){const e=gy.value;return o`
        ...
        ${e.length===0?o`<div class="activity-empty">No events matching filters</div>`:e.map((t,n)=>o`
            ...
            >
              <div class="activity-item-head">
                <span class="activity-kind-chip ${nl(t)}">${by(t)}</span>
  ...
  `}function Ty(e){switch(e){case"hot":return"focus-pressure-hot";case"normal":return"focus-pressure-normal";default:return"focus-pressure-calm"}}function Iy(e){switch(e){case"hot":return"High";case"normal":return"Active";default:return"Calm"}}function zy(){const e=yy.value,t=er.value;return o`
        ...
        ${e.length===0?o`<div class="focus-empty">No active agents</div>`:e.map(n=>o`
            ...
            >
              <div class="focus-agent-header">
                ...
                <span class="focus-pressure-badge ${Ty(n.pressure)}">
                  ${Iy(n.pressure)}
  ...
  `}function Ry(){const e=dt.value;return o`
    <div class="live-monitor">
      <div class="live-header">
        ...
        <div class="live-header-stats">
          ...
          <span class="live-stat">이벤트 ${Fa.value}</span>
        </div>
      </div>
  ...
  `}function Py({currentTab:e}){var p,_,u,f,v,h,b,C,x,S;const t=dt.value,n=(p=re.value)==null?void 0:p.build,s=(_=re.value)==null?void 0:_.lodge,a=(u=re.value)==null?void 0:u.gardener,i=(f=re.value)==null?void 0:f.guardian,l=(v=re.value)==null?void 0:v.sentinel,c=[];if(s&&c.push(qs("Lodge",s.enabled?ze("lodge",s.quiet_active?"quiet":"live"):ze("lodge","disabled"),s.enabled?s.quiet_active?"warn":"ok":"bad",[Te("틱",s.total_ticks??0),Te("체크인",s.total_checkins??0),Te("최근 결과",((h=s.last_tick_result)==null?void 0:h.activity_report)??s.last_skip_reason??"없음")])),a&&c.push(qs("Gardener",a.alive?ze("gardener","live"):a.enabled?ze("gardener","starting"):ze("gardener","disabled"),a.alive?"ok":a.enabled?"warn":"bad",[Te("최근 tick",a.last_tick_completed_at?o`<${W} timestamp=${a.last_tick_completed_at} />`:"기록 없음"),Te("판단",`${a.last_intervention??"없음"} · ${a.last_decision_source??"없음"}`),Te("백로그",`미할당 ${((b=a.health_summary)==null?void 0:b.todo_count)??0} · P1/2 ${((C=a.health_summary)==null?void 0:C.high_priority_todo)??0}`)],a.last_reason??a.last_error??void 0)),i){const $=i.masc_loops_running||i.lodge_loop_started||i.lodge_running;c.push(qs("Guardian",$?ze("guardian","live"):i.enabled?ze("guardian","idle"):ze("guardian","disabled"),$?"ok":i.enabled?"warn":"bad",[Te("모드",i.mode??"알 수 없음"),Te("루프",`zombie ${i.zombie_loop_running?"on":"off"} · gc ${i.gc_loop_running?"on":"off"}`),Te("소유자",i.runtime_owner??"없음")],((x=i.last_lodge_result)==null?void 0:x.message)??i.last_gc_result??i.last_zombie_result??void 0))}return l&&c.push(qs("Sentinel",l.started?ze("sentinel","live"):l.enabled?ze("sentinel","starting"):ze("sentinel","disabled"),l.started?"ok":l.enabled?"warn":"bad",[Te("에이전트",l.agent_name??"sentinel"),Te("소비자",((S=l.consumers)==null?void 0:S.length)??0),Te("가디언 소유자",l.guardian_runtime_owner??"없음")],l.llm_enabled===!0?"LLM 기반 housekeeping resident":void 0)),o`
    <section class="rail-card">
      ...
      ${n?o`<div class="rail-build-hint">서버 빌드 · v${n.release_version} · ${Ly(n.commit)}</div>`:null}
      ${c.length>0?o`
  ...
  `}function My(){const e=$e.value,t=(e==null?void 0:e.pending_confirms.length)??0,n=(e==null?void 0:e.sessions.length)??0,s=(e==null?void 0:e.keepers.length)??0;return o`
    <section class="rail-card">
      <div class="rail-card-head">
        <h3>개입 바로가기</h3>
  ...
  `}const ws=g(!1);function jy(){const e=dt.value;return o`
    <div class="connection-status ${e?"connected":"disconnected"}">
      ...
      <span class="event-count">이벤트 ${Fa.value}</span>
    </div>
  `}function Ey(e){const t=e==null?void 0:e.trim();return t?t.length>10?t.slice(0,10):t:"커밋 정보 없음"}function Ny(){const e=re.value,t=e==null?void 0:e.build,n=t?`v${t.release_version} · ${Ey(t.commit)}`:e!=null&&e.version?`v${e.version} · 커밋 정보 없음`:"버전 정보 없음";return o`
  ...
  `}function Dy(){const e=O.value.tab,t=vi.find(s=>s.id===e),n=sl.find(s=>s.id===(t==null?void 0:t.group));return o`
  ...
  `}function Oy(){switch(O.value.tab){case"mission":return o`<${Cr} />`;case"proof":return o`<${og} />`;case"execution":return o`<${sh} />`;case"tools":return o`<${dh} />`;case"live":return o`<${Ry} />`;case"memory":return o`<${K$} />`;case"governance":return o`<${Oh} />`;case"planning":return o`<${Ch} />`;case"intervene":return o`<${z$} />`;case"command":return o`<${C$} />`;case"lab":return o`<${_y} />`;default:return o`<${Cr} />`}}function qy(){return Uo.value&&!dt.value?o`<div class="loading-indicator">대시보드 불러오는 중...</div>`:o`<${Oy} />`}function wy(){oe(()=>{Md(),ul(),Bl(),It(),Tt(),Kl(),ac();const n=$m();return hm(),()=>{Fd(),n(),ym()}},[]),oe(()=>{const n=setInterval(()=>{ti(O.value.tab)},15e3);return()=>{clearInterval(n)}},[]),oe(()=>{ti(O.value.tab)},[O.value.tab]);const e=O.value.tab,t=vi.find(n=>n.id===e);return o`
    <div class="app-shell">
  ...
  `}const al=document.getElementById("app");al&&Id(o`<${wy} />`,al);export{gf as _};
