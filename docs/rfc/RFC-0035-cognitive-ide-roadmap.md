...
| PR-7 | `cognitive_mode` FSM (Dim01 P0 #2 backend) | P0 backend | in-flight (#13952) |
| PR-8 | `cognitive_disclosure` (Dim01 P0 #1 backend) | P0 backend | in-flight (#13958) |
| PR-9 | `chronicle_vector_index` (Dim02 P1 vector embedder) | P1 | in-flight (this PR) |
