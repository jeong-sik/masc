...
Example models: 'gemini:gemini-2.5-flash', 'ollama:glm-4.7-flash', 'claude:opus', 'glm:glm-4.7'.";
    input_schema = `Assoc [
      ("type", `String "object");
      ("properties", `Assoc [
        ("goal", `Assoc [
...
Format: 'provider:model_id'. Examples: 'gemini:gemini-2.5-flash', 'ollama:glm-4.7-flash', 'claude:opus', 'glm:glm-4.7'");
        ]);
        ("verify", `Assoc [
          ("type", `String "boolean");
