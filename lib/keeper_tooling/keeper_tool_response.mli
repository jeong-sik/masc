...
val response_accept_rejection : Masc_agent_core.Types.api_response -> accept_rejection option
...
val accept_rejection_of_response :
  runtime_id:string -> Masc_agent_core.Types.api_response -> accept_rejection
...
(** [true] when a provider response carries OAS-defined downstream-visible
    ...
    boundary to [Masc_agent_core.Response_shape.has_deliverable_content]; MASC should
...
val response_has_text_or_tool_progress : Masc_agent_core.Types.api_response -> bool
