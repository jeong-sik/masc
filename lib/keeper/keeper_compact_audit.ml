...
(** Types, state, ID synthesis, and JSON codecs extracted to
    [Keeper_compact_audit_types].  Write API, retention, and
    subscriber logic below. *)

include Keeper_compact_audit_types
