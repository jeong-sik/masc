...
collision-recovery renumber to RFC-0125 that masc #15970 noted in
the index entry.
...
- (ii) socket-level (cohttp-eio, websocket, raw Eio.Flow) 의 *같은 bounded scope 패턴* 보강 — RFC-0107 와 *synchronized* 진행.
