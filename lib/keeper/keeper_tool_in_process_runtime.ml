...
(* RFC-0182 §3.1 — masc_approval cluster.  Backs descriptor projection for
   [masc_approval_pending/get/resolve].
...
(* Closed sum type for the approval cluster — same pattern as
   [Keeper_tool_task_runtime.task_op].  String → typed conversion happens
