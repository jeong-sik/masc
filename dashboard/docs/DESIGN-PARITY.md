...
workspace/board, sub-boards, planning, repositories — along with monitoring/transport-health, a hidden
diagnostic. Nothing is drifting there; the design simply does not draw them.
