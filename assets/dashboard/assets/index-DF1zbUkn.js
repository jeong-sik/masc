...
`).map(n=>n.trim()).filter(n=>n!=="")}async function Hl(t,e=20){return jt("masc_task_history",{task_id:t,limit:e})}async function Bl(){return Re("fetchDebates",async()=>{const t=await Y("/api/v1/council/debates?limit=100");return Array.isArray(t.debates)?t.debates.map(e=>{if(!I(e))return null;const n=h(e.id,"").trim(),s=h(e.topic,"").trim();return!n||!s?null:{id:n,topic:s,status:h(e.status,"open"),argument_count:j(e.argument_count,0),created_at:Ae(e.created_at_iso??e.created_at)}}).filter(e=>e!==null):[]})}async function Wl(){return Re("fetchCouncilSessions",async()=>{const t=await Y("/api/v1/council/sessions?limit=100");return Array.isArray(t.sessions)?t.sessions.map(e=>{if(!I(e))return null;const n=h(e.id,"").trim(),s=h(e.topic,"").trim();return!n||!s?null:{id:n,topic:s,initiator:h(e.initiator,"system"),votes:j(e.votes,0),quorum:j(e.quorum,0),state:h(e.state,"open"),created_at:Ae(e.created_at_iso??e.created_at)}}).filter(e=>e!==null):[]})}async function Gl(t){const e=await jt("masc_debate_start",{topic:t});try{return JSON.parse(e)}catch{return null}}async function Jl(t){return Re("fetchDebateStatus",async()=>{const e=encodeURIComponent(t),n=await Y(`/api/v1/council/debates/${e}/summary`);if(!I(n))return null;const s=h(n.id,"").trim();return s?{id:s,topic:h(n.topic,""),status:h(n.status,"open"),support_count:j(n.support_count,0),oppose_count:j(n.oppose_count,0),neutral_count:j(n.neutral_count,0),total_arguments:j(n.total_arguments,0),created_at:Ae(n.created_at_iso??n.created_at),summary_text:h(n.summary_text,"")}:null})}function Vl(t,e,n){return jt("masc_keeper_msg",{name:t,message:e})}async function Yl(){try{const t=await jt("masc_goal_list",{});if(typeof t=="string"){const e=JSON.parse(t);return Array.isArray(e)?e:e.goals??[]}return Array.isArray(t)?t:t.goals??[]}catch{return[]}}const Xl=v(""),Et=v({}),at=v({}),ma=v({}),va=v({}),_a=v({}),fa=v({}),It=v({});function nt(t,e,n){t.value={...t.value,[e]:n}}function Ft(t){return typeof t=="object"&&t!==null&&!Array.isArray(t)}function K(t){return typeof t=="string"&&t.trim()!==""?t.trim():void 0}function ht(t){return typeof t=="number"&&Number.isFinite(t)?t:void 0}function he(t){return typeof t=="boolean"?t:void 0}function ga(t){return typeof t=="string"&&t.trim()!==""?t:typeof t!="number"||!Number.isFinite(t)||t<=0?null:new Date(t*1e3).toISOString()}function $a(t){return Array.isArray(t)?t.map(e=>K(e)).filter(e=>!!e):[]}function Ql(t){var n;const e=(n=K(t))==null?void 0:n.toLowerCase();return e==="user"||e==="assistant"||e==="system"||e==="tool"?e:"other"}function Zl(t){switch(t){case"user":return"User";case"assistant":return"Keeper";case"system":return"System";case"tool":return"Tool";default:return"Event"}}function Es(t,e){if(!Array.isArray(t))return[];const n=[];for(const s of t){if(!Ft(s))continue;const a=K(s.name);if(!a)continue;const i=K(s[e]);e==="summary"?n.push({name:a,summary:i}):n.push({name:a,reason:i})}return n}function tc(t){if(!Ft(t))return null;const e=K(t.name);return e?{name:e,trigger:K(t.trigger),outcome:K(t.outcome),summary:K(t.summary),reason:K(t.reason)}:null}function ec(t){const e=t.toLowerCase();return e.includes("graphql")?"graphql_error":e.includes("timeout")||e.includes("model")||e.includes("llm")||e.includes("api key")||e.includes("api_key")||e.includes("provider")?"llm_error":"unknown"}function nc(t,e){return t==="offline"||t==="degraded"||t==="stale"?"Keeper is not in a healthy reply state. Probe or recover before relying on automation.":e==="quiet_hours"?"Lodge quiet hours are active. Direct messages still work, but scheduled social ticks may look asleep.":e==="min_gap"?"Keeper is inside its proactive cooldown window. Direct messages work now; autonomous check-ins will wait.":e==="never_started"?"Keeper metadata exists but no reply turn has been recorded yet.":"Keeper is reachable. Send a direct message for an immediate response."}function li(t,e,n){return K(t)??nc(e,n)}function ci(t,e){return typeof t=="boolean"?t:e==="recover"}function Jn(t){if(!Ft(t))return null;const e=K(t.health_state),n=K(t.next_action_path),s=K(t.last_reply_status);return!e||!n||!s?null:{health_state:e,quiet_reason:K(t.quiet_reason)??null,next_action_path:n,last_reply_status:s,last_reply_at:ga(t.last_reply_at),last_reply_preview:K(t.last_reply_preview)??null,last_error:K(t.last_error)??null,next_eligible_at_s:ht(t.next_eligible_at_s)??null,recoverable:ci(t.recoverable,n),summary:li(t.summary,e,K(t.quiet_reason)??null),keepalive_running:typeof t.keepalive_running=="boolean"?t.keepalive_running:void 0}}function di(t){return Ft(t)?{hour:ht(t.hour),checked:ht(t.checked)??0,acted:ht(t.acted)??0,acted_names:$a(t.acted_names),activity_report:K(t.activity_report),quiet_hours_overridden:he(t.quiet_hours_overridden),skipped_reason:K(t.skipped_reason),acted_rows:Es(t.acted_rows,"summary").map(e=>({name:e.name,summary:e.summary})),passed_rows:Es(t.passed_rows,"reason").map(e=>({name:e.name,reason:e.reason})),skipped_rows:Es(t.skipped_rows,"reason").map(e=>({name:e.name,reason:e.reason})),checkins:Array.isArray(t.checkins)?t.checkins.map(tc).filter(e=>e!==null):[]}:null}function sc(t){return Ft(t)?{enabled:he(t.enabled)??!1,interval_s:ht(t.interval_s)??0,quiet_start:ht(t.quiet_start),quiet_end:ht(t.quiet_end),quiet_active:he(t.quiet_active),use_planner:he(t.use_planner),delegate_llm:he(t.delegate_llm),agent_count:ht(t.agent_count),agents:$a(t.agents),last_tick_ago_s:ht(t.last_tick_ago_s)??null,last_tick_ago:K(t.last_tick_ago),total_ticks:ht(t.total_ticks),total_checkins:ht(t.total_checkins),last_skip_reason:K(t.last_skip_reason)??null,last_tick_result:di(t.last_tick_result),active_self_heartbeats:$a(t.active_self_heartbeats)}:null}function ac(t){return Ft(t)?{status:t.status,diagnostic:Jn(t.diagnostic)}:null}function oc(t){return Ft(t)?{recovered:he(t.recovered)??!1,skipped_reason:K(t.skipped_reason)??null,before:Jn(t.before),after:Jn(t.after),down:t.down,up:t.up}:null}function ic(t,e){var O,M;if(!(t!=null&&t.name))return null;const n=K((O=t.agent)==null?void 0:O.status)??K(t.status)??"unknown",s=K((M=t.agent)==null?void 0:M.error)??null,a=t.presence_keepalive??!0,i=t.keepalive_running??!1,r=t.turn_count??0,l=t.last_turn_ago_s??null,u=t.proactive_enabled??!1,_=t.proactive_cooldown_sec??0,d=t.last_proactive_ago_s??null,f=u&&d!=null?Math.max(0,_-d):null,g=r<=0||l==null?"never":l>900?"stale":"fresh",$=typeof t.last_heartbeat=="string"&&t.last_heartbeat.trim()?t.last_heartbeat:null,y=s??(a&&!i?"keeper keepalive is not running":null),A=n==="offline"||n==="inactive"?"offline":y?"degraded":g==="stale"?"stale":g==="never"?"idle":"healthy",w=y?ec(y):e!=null&&e.quiet_active&&g!=="fresh"?"quiet_hours":a&&!i?"disabled":r<=0?"never_started":f!=null&&f>0?"min_gap":g==="fresh"||g==="stale"?"no_recent_activity":"unknown",D=A==="offline"||A==="degraded"||A==="stale"?"recover":w==="quiet_hours"?"manual_lodge_poke":w==="unknown"?"probe":"direct_message";return{health_state:A,quiet_reason:w,next_action_path:D,last_reply_status:g,last_reply_at:$,last_reply_preview:null,last_error:y,next_eligible_at_s:f!=null&&f>0?f:null,recoverable:ci(void 0,D),summary:li(void 0,A,w),keepalive_running:i}}function rc(t,e){if(!Ft(t))return null;const n=Ql(t.role),s=K(t.content)??K(t.preview);if(!s)return null;const a=ga(t.ts_unix)??ga(t.timestamp);return{id:`${n}-${a??"entry"}-${e}`,role:n,label:Zl(n),text:s,timestamp:a,delivery:"history"}}function lc(t,e,n){const s=Ft(n)?n:null,a=Array.isArray(s==null?void 0:s.history_tail)?s.history_tail.map((i,r)=>rc(i,r)).filter(i=>i!==null):[];return{name:t,diagnostic:Jn(s==null?void 0:s.diagnostic),history:a,rawText:e,rawStatus:n,loadedAt:new Date().toISOString()}}function $o(t,e){const n=at.value[t]??[];at.value={...at.value,[t]:[...n,e].slice(-50)}}function cc(t,e){return t.role!==e.role||t.text!==e.text?!1:t.timestamp&&e.timestamp?t.timestamp===e.timestamp:!0}function dc(t,e){const s=(at.value[t]??[]).filter(a=>a.delivery!=="history"&&!e.some(i=>cc(a,i)));at.value={...at.value,[t]:[...e,...s].slice(-50)}}function xs(t,e){Et.value={...Et.value,[t]:e},dc(t,e.history)}function ho(t,e){const n=Et.value[t];if(!n)return;const s=n.diagnostic??{health_state:"idle",next_action_path:"direct_message",last_reply_status:"unknown"};xs(t,{...n,diagnostic:{...s,...e}})}async function Za(){an();try{await ue()}catch(t){console.warn("[keeper-runtime] dashboard refresh failed",t)}}function uc(t){Xl.value=t.trim()}async function ui(t,e=!1){const n=t.trim();if(!n)return null;if(!e&&Et.value[n])return Et.value[n];nt(ma,n,!0),nt(It,n,null);try{const s=await jt("masc_keeper_status",{name:n,fast:!1,include_context:!0,include_metrics_overview:!0,include_memory_bank:!1,include_history_tail:!0,include_compaction_history:!1,tail_turns:5,tail_messages:10});let a=null;try{a=JSON.parse(s)}catch{a=null}const i=lc(n,s,a);return xs(n,i),i}catch(s){const a=s instanceof Error?s.message:`Failed to inspect ${n}`;return nt(It,n,a),null}finally{nt(ma,n,!1)}}async function pc(t,e){const n=t.trim(),s=e.trim();if(!n||!s)return;const a=`local-${Date.now()}`;$o(n,{id:a,role:"user",label:"You",text:s,timestamp:new Date().toISOString(),delivery:"sending"}),nt(va,n,!0),nt(It,n,null);try{const i=await Vl(n,s);at.value={...at.value,[n]:(at.value[n]??[]).map(r=>r.id===a?{...r,delivery:"delivered"}:r)},$o(n,{id:`reply-${Date.now()}`,role:"assistant",label:n,text:i.trim()||"(empty reply)",timestamp:new Date().toISOString(),delivery:"delivered"}),ho(n,{last_reply_status:"delivered",last_reply_at:new Date().toISOString(),last_reply_preview:(i.trim()||"(empty reply)").slice(0,200),last_error:null}),await Za()}catch(i){const r=i instanceof Error?i.message:`Failed to send direct message to ${n}`;throw at.value={...at.value,[n]:(at.value[n]??[]).map(l=>l.id===a?{...l,delivery:"error",error:r}:l)},ho(n,{last_reply_status:"error",last_error:r}),nt(It,n,r),i}finally{nt(va,n,!1)}}async function mc(t,e){const n=t.trim();if(!n)return null;nt(_a,n,!0),nt(It,n,null);try{const s=await ks({actor:e,action_type:"keeper_probe",target_type:"keeper",target_id:n,payload:{}}),a=ac(s.result),i=(a==null?void 0:a.diagnostic)??null;if(i){const r=Et.value[n];xs(n,{name:n,diagnostic:i,history:(r==null?void 0:r.history)??at.value[n]??[],rawText:(r==null?void 0:r.rawText)??"",rawStatus:s.result,loadedAt:new Date().toISOString()})}return await Za(),i}catch(s){const a=s instanceof Error?s.message:`Failed to probe ${n}`;throw nt(It,n,a),s}finally{nt(_a,n,!1)}}async function vc(t,e){const n=t.trim();if(!n)return null;nt(fa,n,!0),nt(It,n,null);try{const s=await ks({actor:e,action_type:"keeper_recover",target_type:"keeper",target_id:n,payload:{}}),a=oc(s.result),i=(a==null?void 0:a.after)??null;if(i){const r=Et.value[n];xs(n,{name:n,diagnostic:i,history:(r==null?void 0:r.history)??at.value[n]??[],rawText:(r==null?void 0:r.rawText)??"",rawStatus:s.result,loadedAt:new Date().toISOString()})}return await Za(),i}catch(s){const a=s instanceof Error?s.message:`Failed to recover ${n}`;throw nt(It,n,a),s}finally{nt(fa,n,!1)}}function te(t){return(t??"").trim().toLowerCase()}function dt(t){const e=typeof t=="number"?t:Date.parse(t);return Number.isNaN(e)?0:e}function zn(t,e=88){const n=t.replace(/\s+/g," ").trim();return n&&(n.length>e?`${n.slice(0,e-3)}...`:n)}function xn(t){return typeof t!="number"||!Number.isFinite(t)||t<0?null:new Date(Date.now()-t*1e3).toISOString()}function Ie(t){return t.last_heartbeat??xn(t.last_turn_ago_s)??xn(t.last_proactive_ago_s)??xn(t.last_handoff_ago_s)??xn(t.last_compaction_ago_s)}function _c(t){const e=t.title.trim();return e||zn(t.content)}function fc(t){const e=t.generation??"?",n=typeof t.context_ratio=="number"&&Number.isFinite(t.context_ratio)?`${Math.round(t.context_ratio*100)}%`:"?";return t.last_heartbeat?`Heartbeat gen=${e} ctx=${n}`:`Keeper snapshot gen=${e} ctx=${n}`}function gc(t,e,n,s,a={}){var M;const i=te(t),r=e.filter(R=>te(R.assignee)===i&&(R.status==="claimed"||R.status==="in_progress")).length,l=n.filter(R=>te(R.from)===i).sort((R,N)=>dt(N.timestamp)-dt(R.timestamp))[0],u=s.filter(R=>te(R.agent)===i||te(R.author)===i).sort((R,N)=>dt(N.timestamp)-dt(R.timestamp))[0],_=(a.boardPosts??[]).filter(R=>te(R.author)===i).sort((R,N)=>dt(N.updated_at||N.created_at)-dt(R.updated_at||R.created_at))[0],d=(a.keepers??[]).filter(R=>te(R.name)===i&&Ie(R)!==null).sort((R,N)=>dt(Ie(N)??0)-dt(Ie(R)??0))[0],f=l?dt(l.timestamp):0,g=u?dt(u.timestamp):0,$=_?dt(_.updated_at||_.created_at):0,y=d?dt(Ie(d)??0):0,A=a.lastSeen?dt(a.lastSeen):0,w=((M=a.currentTask)==null?void 0:M.trim())||(r>0?`${r} claimed tasks`:null);if(f===0&&g===0&&$===0&&y===0&&A===0)return{activeAssignedCount:r,lastActivityAt:null,lastActivityText:w};const O=[l?{timestamp:l.timestamp,ts:f,text:zn(l.content)}:null,_?{timestamp:_.updated_at||_.created_at,ts:$,text:`Post: ${zn(_c(_))}`}:null,d?{timestamp:Ie(d),ts:y,text:fc(d)}:null,u?{timestamp:new Date(u.timestamp).toISOString(),ts:g,text:zn(u.text)}:null].filter(R=>R!==null).sort((R,N)=>N.ts-R.ts)[0];return O&&O.ts>=A?{activeAssignedCount:r,lastActivityAt:O.timestamp,lastActivityText:O.text}:{activeAssignedCount:r,lastActivityAt:a.lastSeen??null,lastActivityText:w??"Presence heartbeat"}}const wt=v([]),yt=v([]),tn=v([]),pe=v([]),Ne=v(null),$c=v(null),ha=v(new Map),Le=v([]),en=v("hot"),se=v(!0),pi=v(null),Mt=v(""),nn=v([]),ye=v(!1),mi=v(new Map),ya=v("unknown"),ba=v(null),ka=v(!1),sn=v(!1),xa=v(!1),be=v(!1),hc=v(null),Sa=v(null),vi=v(null),_i=v(null);ft(()=>wt.value.filter(t=>t.status==="active"||t.status==="busy"||t.status==="listening"||t.status==="idle"));const yc=ft(()=>{const t=yt.value;return{todo:t.filter(e=>e.status==="todo"),inProgress:t.filter(e=>e.status==="in_progress"||e.status==="claimed"),done:t.filter(e=>e.status==="done")}}),fi=ft(()=>{const t=new Map,e=yt.value,n=tn.value,s=Gn.value,a=Le.value,i=pe.value;for(const r of wt.value)t.set(r.name.trim().toLowerCase(),gc(r.name,e,n,s,{currentTask:r.current_task,lastSeen:r.last_seen,boardPosts:a,keepers:i}));return t});function bc(t){var i;const e=((i=t.status)==null?void 0:i.toLowerCase())??"";if(e==="offline"||e==="inactive")return"offline";const n=t.metrics_series;if(!n||n.length===0)return"idle";const s=n[n.length-1];if(!s)return"idle";if(s.is_handoff)return"handoff-imminent";if(s.is_compaction)return"compacting";const a=s.context_ratio;return a>.85?"handoff-imminent":a>.7?"preparing":a>.5?"compacting":"active"}const kc=ft(()=>{const t=new Map;for(const e of pe.value)t.set(e.name,bc(e));return t}),xc=12e4;function Sc(t,e){const n=e.get(t.name);if(n!=null)return n;const s=t.last_heartbeat?Date.parse(t.last_heartbeat):Number.NaN;if(!Number.isNaN(s))return s;const a=[t.last_turn_ago_s,t.last_proactive_ago_s,t.last_handoff_ago_s,t.last_compaction_ago_s].find(i=>typeof i=="number"&&Number.isFinite(i)&&i>=0);return typeof a=="number"?Date.now()-a*1e3:null}const Ac=ft(()=>{const t=Date.now(),e=new Set,n=ha.value;for(const s of pe.value){const a=Sc(s,n);a!=null&&t-a>xc&&e.add(s.name)}return e}),Vn={},Cc=5e3;let Is=null;function wc(t){return t==="dashboard_refresh"||t==="masc/dashboard_refresh"||t.startsWith("goal_")||t.startsWith("masc/goal_")||t.startsWith("mdal_")||t.startsWith("masc/mdal_")||t.startsWith("operator_")||t.startsWith("masc/operator_")||t.startsWith("command_plane_")||t.startsWith("masc/command_plane_")}function an(){delete Vn.compact,delete Vn.full}function ot(t){return typeof t=="object"&&t!==null}function x(t){return typeof t=="string"&&t.trim()!==""?t:void 0}function C(t){return typeof t=="number"&&Number.isFinite(t)?t:void 0}function le(t){if(!Array.isArray(t))return;const e=t.filter(n=>typeof n=="string"&&n.trim()!=="");return e.length>0?e:void 0}function Aa(t){if(typeof t=="string"&&t.trim()!=="")return t;if(!(typeof t!="number"||!Number.isFinite(t)||t<=0))return new Date(t*1e3).toISOString()}function gi(t){const e=typeof t=="string"?t.toLowerCase():"";return e==="active"||e==="busy"||e==="listening"||e==="idle"||e==="inactive"||e==="offline"?e:e==="in_progress"||e==="claimed"?"busy":"offline"}function Tc(t){const e=typeof t=="string"?t.toLowerCase():"";return e==="todo"||e==="in_progress"||e==="claimed"||e==="done"||e==="cancelled"?e:e==="inprogress"?"in_progress":"todo"}function $i(t){if(!ot(t))return null;const e=x(t.name);return e?{name:e,status:gi(t.status),current_task:x(t.current_task)??null,last_seen:x(t.last_seen),emoji:x(t.emoji),koreanName:x(t.koreanName)??x(t.korean_name),model:x(t.model),traits:le(t.traits),interests:le(t.interests),activityLevel:C(t.activityLevel)??C(t.activity_level),primaryValue:x(t.primaryValue)??x(t.primary_value)}:null}function hi(t){if(!ot(t))return null;const e=x(t.id),n=x(t.title);return!e||!n?null:{id:e,title:n,status:Tc(t.status),priority:C(t.priority),assignee:x(t.assignee),description:x(t.description),created_at:x(t.created_at),updated_at:x(t.updated_at)}}function yi(t){if(!ot(t))return null;const e=x(t.from)??x(t.from_agent)??"system",n=x(t.content)??"",s=x(t.timestamp)??new Date().toISOString();return{id:x(t.id),seq:C(t.seq),from:e,content:n,timestamp:s,type:x(t.type)}}function Rc(t){return Array.isArray(t)?t.map(e=>{if(!ot(e))return null;const n=C(e.ts_unix);if(n==null)return null;const s=ot(e.handoff)?e.handoff:null;return{ts:n,context_ratio:C(e.context_ratio)??0,context_tokens:C(e.context_tokens)??0,context_max:C(e.context_max)??0,latency_ms:C(e.latency_ms)??0,generation:C(e.generation)??0,channel:typeof e.channel=="string"?e.channel:"turn",is_handoff:s!=null&&e.handoff_performed===!0,is_compaction:e.compacted===!0,compaction_saved_tokens:C(e.compaction_saved_tokens)??0,compaction_trigger:typeof e.compaction_trigger=="string"?e.compaction_trigger:null,model_used:typeof e.model_used=="string"?e.model_used:"",cost_usd:C(e.cost_usd)??0,handoff_to_model:s&&typeof s.to_model=="string"?s.to_model:null,handoff_new_generation:s?C(s.new_generation)??null:null}}).filter(e=>e!==null):[]}function yo(t){if(!ot(t))return null;const e=x(t.health_state),n=x(t.next_action_path),s=x(t.last_reply_status);if(!e||!n||!s)return null;const a=x(t.quiet_reason)??null,i=x(t.summary)??(e==="offline"||e==="degraded"||e==="stale"?"Keeper is not in a healthy reply state. Probe or recover before relying on automation.":a==="quiet_hours"?"Lodge quiet hours are active. Direct messages still work, but scheduled social ticks may look asleep.":a==="min_gap"?"Keeper is inside its proactive cooldown window. Direct messages work now; autonomous check-ins will wait.":a==="never_started"?"Keeper metadata exists but no reply turn has been recorded yet.":"Keeper is reachable. Send a direct message for an immediate response.");return{health_state:e,quiet_reason:a,next_action_path:n,last_reply_status:s,last_reply_at:Aa(t.last_reply_at)??x(t.last_reply_at)??null,last_reply_preview:x(t.last_reply_preview)??null,last_error:x(t.last_error)??null,next_eligible_at_s:C(t.next_eligible_at_s)??null,recoverable:typeof t.recoverable=="boolean"?t.recoverable:n==="recover",summary:i,keepalive_running:typeof t.keepalive_running=="boolean"?t.keepalive_running:void 0}}function Nc(t,e){return(Array.isArray(t)?t:ot(t)&&Array.isArray(t.keepers)?t.keepers:[]).map(s=>{if(!ot(s))return null;const a=ot(s.agent)?s.agent:null,i=ot(s.context)?s.context:null,r=ot(s.metrics_window)?s.metrics_window:void 0,l=x(s.name);if(!l)return null;const u=C(s.context_ratio)??C(i==null?void 0:i.context_ratio),_=x(s.status)??x(a==null?void 0:a.status)??"offline",d=gi(_),f=x(s.model)??x(s.active_model)??x(s.primary_model),g=le(s.skill_secondary),$=i?{source:x(i.source),context_ratio:C(i.context_ratio),context_tokens:C(i.context_tokens),context_max:C(i.context_max),message_count:C(i.message_count),has_checkpoint:typeof i.has_checkpoint=="boolean"?i.has_checkpoint:void 0}:void 0,y=a?{name:x(a.name),exists:typeof a.exists=="boolean"?a.exists:void 0,error:x(a.error),status:x(a.status),current_task:x(a.current_task)??null,last_seen:x(a.last_seen),last_seen_ago_s:C(a.last_seen_ago_s),is_zombie:typeof a.is_zombie=="boolean"?a.is_zombie:void 0}:void 0,A=Rc(s.metrics_series),w={name:l,emoji:x(s.emoji),koreanName:x(s.koreanName)??x(s.korean_name),agent_name:x(s.agent_name),trace_id:x(s.trace_id),model:f,primary_model:x(s.primary_model),active_model:x(s.active_model),next_model_hint:x(s.next_model_hint)??null,status:d,presence_keepalive:typeof s.presence_keepalive=="boolean"?s.presence_keepalive:void 0,presence_keepalive_sec:C(s.presence_keepalive_sec),keepalive_running:typeof s.keepalive_running=="boolean"?s.keepalive_running:void 0,proactive_enabled:typeof s.proactive_enabled=="boolean"?s.proactive_enabled:void 0,proactive_idle_sec:C(s.proactive_idle_sec),proactive_cooldown_sec:C(s.proactive_cooldown_sec),last_heartbeat:x(s.last_heartbeat)??x(a==null?void 0:a.last_seen),generation:C(s.generation),turn_count:C(s.turn_count)??C(s.total_turns),keeper_age_s:C(s.keeper_age_s),last_turn_ago_s:C(s.last_turn_ago_s),last_handoff_ago_s:C(s.last_handoff_ago_s),last_compaction_ago_s:C(s.last_compaction_ago_s),last_proactive_ago_s:C(s.last_proactive_ago_s),context_ratio:u,context_tokens:C(s.context_tokens)??C(i==null?void 0:i.context_tokens),context_max:C(s.context_max)??C(i==null?void 0:i.context_max),context_source:x(s.context_source)??x(i==null?void 0:i.source),context:$,traits:le(s.traits),interests:le(s.interests),primaryValue:x(s.primaryValue)??x(s.primary_value),activityLevel:C(s.activityLevel)??C(s.activity_level),memory_recent_note:x(s.memory_recent_note)??null,conversation_tail_count:C(s.conversation_tail_count),k2k_count:C(s.k2k_count),handoff_count_total:C(s.handoff_count_total)??C(s.trace_history_count),compaction_count:C(s.compaction_count),last_compaction_saved_tokens:C(s.last_compaction_saved_tokens),diagnostic:yo(s.diagnostic),skill_primary:x(s.skill_primary)??null,skill_secondary:g,skill_reason:x(s.skill_reason)??null,metrics_series:A.length>0?A:void 0,metrics_window:r,agent:y};return w.diagnostic=yo(s.diagnostic)??ic(w,(e==null?void 0:e.lodge)??null),w}).filter(s=>s!==null)}function Lc(t){return ot(t)?{...t,lodge:sc(t.lodge)??void 0}:null}function Pc(t){const e=typeof t=="string"?t.toLowerCase():"";return e==="running"||e==="interrupted"||e==="completed"||e==="stopped"||e==="error"?e:e.startsWith("error")?"error":"running"}function Mc(t){if(!ot(t))return null;const e=C(t.iteration);if(e==null)return null;const n=C(t.metric_before)??0,s=C(t.metric_after)??n,a=ot(t.evidence)?t.evidence:null;return{iteration:e,metric_before:n,metric_after:s,delta:C(t.delta)??s-n,changes:x(t.changes)??"",failed_attempts:x(t.failed_attempts)??"",next_suggestion:x(t.next_suggestion)??"",elapsed_ms:C(t.elapsed_ms)??0,cost_usd:C(t.cost_usd)??null,evidence:a?{worker_engine:(a.worker_engine==="api_tool_loop","api_tool_loop"),worker_model:x(a.worker_model)??"",tool_call_count:C(a.tool_call_count)??0,tool_names:le(a.tool_names)??[],session_id:x(a.session_id)??"",evidence_status:a.evidence_status==="legacy_unverified"?"legacy_unverified":"verified"}:null}}function Dc(t){var i,r;if(!ot(t))return null;const e=x(t.loop_id);if(!e)return null;const n=C(t.baseline_metric)??0,s=Array.isArray(t.history)?t.history.map(Mc).filter(l=>l!==null):[],a=C(t.current_metric)??((i=s[0])==null?void 0:i.metric_after)??n;return{loop_id:e,profile:x(t.profile)??"unknown",status:Pc(t.status),strict_mode:typeof t.strict_mode=="boolean"?t.strict_mode:void 0,error_message:x(t.error_message)??x(t.error_reason)??null,stop_reason:x(t.stop_reason)??x(t.reason)??null,current_iteration:C(t.current_iteration)??((r=s[0])==null?void 0:r.iteration)??0,max_iterations:C(t.max_iterations)??0,baseline_metric:n,current_metric:a,target:x(t.target)??"",stagnation_streak:C(t.stagnation_streak)??0,stagnation_limit:C(t.stagnation_limit)??0,elapsed_seconds:C(t.elapsed_seconds)??0,updated_at:Aa(t.updated_at)??null,stopped_at:Aa(t.stopped_at)??null,execution_mode:t.execution_mode==="worker_spawn"?"worker_spawn":void 0,worker_engine:t.worker_engine==="api_tool_loop"?"api_tool_loop":null,worker_model:x(t.worker_model)??null,evidence_policy:t.evidence_policy==="hard"||t.evidence_policy==="legacy"?t.evidence_policy:void 0,latest_tool_call_count:C(t.latest_tool_call_count)??0,latest_tool_names:le(t.latest_tool_names)??[],session_id:x(t.session_id)??null,evidence_status:t.evidence_status==="legacy_unverified"?"legacy_unverified":t.evidence_status==="verified"?"verified":null,durability:t.durability==="persistent_backend"||t.durability==="memory_only"?t.durability:void 0,persistence_backend:t.persistence_backend==="filesystem"||t.persistence_backend==="postgres"||t.persistence_backend==="memory"?t.persistence_backend:void 0,recoverable:typeof t.recoverable=="boolean"?t.recoverable:void 0,history:s}}async function ue(t="full"){var s,a,i;const e=Date.now(),n=Vn[t];if(!(n&&e-n.time<Cc)){ka.value=!0;try{const r=await Vr(t);Vn[t]={data:r,time:e},wt.value=(Array.isArray((s=r.agents)==null?void 0:s.agents)?r.agents.agents:[]).map($i).filter(u=>u!==null),yt.value=(Array.isArray((a=r.tasks)==null?void 0:a.tasks)?r.tasks.tasks:[]).map(hi).filter(u=>u!==null),tn.value=(Array.isArray((i=r.messages)==null?void 0:i.messages)?r.messages.messages:[]).map(yi).filter(u=>u!==null);const l=Lc(r.status);Ne.value=l,pe.value=Nc(r.keepers,l),$c.value=r.perpetual??null,hc.value=new Date().toISOString()}catch(r){console.error("Dashboard fetch error:",r)}finally{ka.value=!1}}}async function Ec(){try{const t=await Xr(),e=(Array.isArray(t.agents)?t.agents:[]).map($i).filter(a=>a!==null),n=wt.value,s=new Map(n.map(a=>[a.name,a]));wt.value=e.map(a=>{const i=s.get(a.name);return i?{...i,status:a.status,current_task:a.current_task}:a})}catch(t){console.error("Agents selective fetch error:",t)}}async function Ic(){try{const t=await Qr({includeDone:!0,includeCancelled:!0}),e=(Array.isArray(t.tasks)?t.tasks:[]).map(hi).filter(a=>a!==null),n=yt.value,s=new Map(n.map(a=>[a.id,a]));yt.value=e.map(a=>{const i=s.get(a.id);return i?{...i,status:a.status,priority:a.priority??i.priority,assignee:a.assignee??i.assignee}:a})}catch(t){console.error("Tasks selective fetch error:",t)}}async function zc(){try{const t=tn.value,e=t.reduce((l,u)=>Math.max(l,u.seq??0),0),n=await Zr(e),s=(Array.isArray(n.messages)?n.messages:[]).map(yi).filter(l=>l!==null);if(s.length===0)return;const a=new Set(t.map(l=>l.seq).filter(l=>l!=null)),i=new Set(t.filter(l=>l.seq==null).map(l=>`${l.timestamp}|${l.from}`)),r=s.filter(l=>{if(l.seq!=null)return!a.has(l.seq);const u=`${l.timestamp}|${l.from}`;return i.has(u)?!1:(i.add(u),!0)});if(r.length>0){const l=[...t,...r];tn.value=l.length>500?l.slice(-500):l}}catch(t){console.error("Messages selective fetch error:",t)}}async function At(){sn.value=!0;try{const t=await fl(en.value,{excludeSystem:se.value});Le.value=t.posts??[],Sa.value=new Date().toISOString()}catch(t){console.error("Board fetch error:",t)}finally{sn.value=!1}}async function Ct(){var t;xa.value=!0;try{const e=Mt.value||((t=Ne.value)==null?void 0:t.room)||"default";Mt.value||(Mt.value=e);const n=await Ml(e);pi.value=n}catch(e){console.error("TRPG fetch error:",e)}finally{xa.value=!1}}async function on(){ye.value=!0;try{const t=await Yl();nn.value=Array.isArray(t)?t:[],vi.value=new Date().toISOString()}catch(t){console.error("Goals fetch error:",t)}finally{ye.value=!1}}async function Ce(){be.value=!0;try{const t=await tl(),e=Array.isArray(t.loops)?t.loops:[],n=new Map;for(const s of e){const a=Dc(s);a&&n.set(a.loop_id,a)}mi.value=n,_i.value=new Date().toISOString(),ba.value=null,ya.value=n.size===0?"idle":"ready"}catch(t){console.error("MDAL fetch error:",t),ya.value="error",ba.value=t instanceof Error?t.message:String(t)}finally{be.value=!1}}let On=null;function Oc(t){On=t}let jn=null;function jc(t){jn=t}let Fn=null;function Fc(t){Fn=t}const ae={};function ee(t,e,n=500){ae[t]&&clearTimeout(ae[t]),ae[t]=setTimeout(()=>{e(),delete ae[t]},n)}function qc(){const t=Zo.subscribe(e=>{if(e){if(e.type==="keeper_heartbeat"&&e.name){const n=new Map(ha.value);n.set(e.name,e.ts_unix?e.ts_unix*1e3:Date.now()),ha.value=n;return}(e.type==="agent_joined"||e.type==="agent_left")&&ee("agents",Ec),wc(e.type)&&(an(),Is||(Is=setTimeout(()=>{ue(),jn==null||jn(),Fn==null||Fn(),Is=null},500))),(e.type.startsWith("task_")||e.type.startsWith("masc/task_"))&&ee("tasks",Ic),e.type==="broadcast"&&ee("messages",zc),(e.type==="keeper_handoff"||e.type==="keeper_compaction"||e.type==="keeper_guardrail")&&ee("dashboard",()=>{an(),ue()}),(e.type==="board_post"||e.type==="masc/board_post"||e.type==="board_comment"||e.type==="masc/board_comment")&&ee("board",At),e.type.startsWith("decision_")&&ee("council",()=>On==null?void 0:On()),(e.type==="mdal_started"||e.type==="mdal_iteration"||e.type==="mdal_completed"||e.type==="mdal_stopped")&&ee("mdal",Ce,350)}});return()=>{t();for(const e of Object.keys(ae))clearTimeout(ae[e]),delete ae[e]}}let Ue=null;function Kc(){Ue||(Ue=setInterval(()=>{Dt.value||an(),ue()},1e4))}function Uc(){Ue&&(clearInterval(Ue),Ue=null)}function T({title:t,class:e,children:n}){return o`
  ...
  `}function zs(){var r,l,u;const t=bi.value;if(Ca.value&&!t)return o`<div class="loading-indicator">상황판 스냅샷 불러오는 중...</div>`;if(Yn.value&&!t)return o`<div class="empty-state error">${Yn.value}</div>`;if(!t)return o`<div class="empty-state">상황판 스냅샷이 아직 없습니다.</div>`;const e=t.summary,n=t.incidents[0]??e.top_attention??null,s=t.recommended_actions[0]??e.top_action??null,a=t.command_focus.session_cards.slice(0,3),i=t.operator_targets.keepers.slice(0,4);return o`
  ...
  `}function bu(){if(typeof window>"u")return null;const t=new URLSearchParams(window.location.search),e=t.get("agent")??t.get("agent_name");if(!e)return null;const n=e.trim();return n===""?null:n}function Oi(){if(typeof window>"u")return new URLSearchParams;const t=new URLSearchParams(window.location.search),e=window.location.hash.replace(/^#/,""),n=e.indexOf("?");return n>=0&&new URLSearchParams(e.slice(n+1)).forEach((a,i)=>{t.has(i)||t.set(i,a)}),t}function ku(){const e=Oi().get("run_id");if(!e)return null;const n=e.trim();return n===""?null:n}function xu(){const e=Oi().get("operation_id");if(!e)return null;const n=e.trim();return n===""?null:n}function Su(t){if(!t)return null;const e=Date.parse(t);return Number.isNaN(e)?null:Math.max(0,Math.round((Date.now()-e)/1e3))}function Au(t){return t.status==="claimed"||t.status==="in_progress"}function Cu(t){const e=$n.value;if(!e)return null;for(const n of e.golden_paths){const s=n.steps.find(a=>a.tool===t);if(s)return s}return null}function js(t){var e;return((e=$n.value)==null?void 0:e.golden_paths.find(n=>n.id===t))??null}function wu(t){const e=$n.value;if(!e)return[];const n=new Set(t);return e.pitfalls.filter(s=>n.has(s.id))}async function Wt(t){try{await t()}catch{}}function Tu(){var d,f,g,$,y;const t=Ns(),e=ws.value,n=t==null?void 0:t.topology.summary,s=t==null?void 0:t.operations.summary,a=(d=t==null?void 0:t.swarm_status)==null?void 0:d.overview,i=t==null?void 0:t.operations.microarch,r=t==null?void 0:t.decisions.summary,l=t==null?void 0:t.alerts.summary,u=(f=i==null?void 0:i.signals)==null?void 0:f.issue_pressure,_=i==null?void 0:i.cache;return o`
    <div class="command-summary-grid">
      ...
      <div class="monitor-stat-card"><span>마이크로아크</span><strong>${(u==null?void 0:u.pending_ops)??0}</strong><small>${(_==null?void 0:_.l1_hit_rate)!=null?`${Rs(_.l1_hit_rate)} L1 hit`:"캐시 데이터 없음"} · ${(u==null?void 0:u.tone)??"n/a"}</small></div>
    </div>
  ...
  `}function Iu(){const t=Ns(),e=t==null?void 0:t.swarm_status,n=t==null?void 0:t.swarm_proof,s=(e==null?void 0:e.lanes.filter(_=>_.present))??[],a=(e==null?void 0:e.gaps.items)??[],i=(e==null?void 0:e.timeline.slice(0,8))??[],r=e==null?void 0:e.overview,l=e==null?void 0:e.recommended_next_action,u=s.length<=1;return o`
  ...
  `}function Ou(){var lt,ct,U,Q,b,Qt,De,yn,bn;const t=Ns(),e=Rt.value,n=Ne.value,s=bu(),a=s?wt.value.find(E=>E.name===s)??null:null,i=s?yt.value.filter(E=>E.assignee===s&&Au(E)):[],r=((lt=t==null?void 0:t.operations.summary)==null?void 0:lt.active)??0,l=((ct=t==null?void 0:t.detachments.summary)==null?void 0:ct.total)??0,u=((U=t==null?void 0:t.decisions.summary)==null?void 0:U.pending)??0,_=e==null?void 0:e.detachments.detachments.find(E=>{const Zt=E.detachment.heartbeat_deadline,kn=Zt?Date.parse(Zt):Number.NaN;return E.detachment.status==="stalled"||!Number.isNaN(kn)&&kn<=Date.now()}),d=e==null?void 0:e.alerts.alerts.find(E=>E.severity==="bad"),f=!!(n!=null&&n.room||n!=null&&n.project),g=(a==null?void 0:a.current_task)??null,$=Su(a==null?void 0:a.last_seen),y=$!=null?$<=120:null,A=[f?{title:"Room 준비도",tone:"ok",detail:`${(n==null?void 0:n.room)??(n==null?void 0:n.project)??"unknown"} · base ${(n==null?void 0:n.room_base_path)??"n/a"}`,tool:"masc_status"}:{title:"Room 준비도",tone:"bad",detail:"아직 room snapshot이 없습니다. 조인 전에 room을 repo root로 맞추세요.",tool:"masc_set_room"},s?a?i.length===0?{title:"Task 준비도",tone:"warn",detail:`${s} 에게 배정된 claimed task가 없습니다. 먼저 claim 하거나 만들어야 합니다.`,tool:yt.value.length>0?"masc_claim":"masc_add_task"}:g?y===!1?{title:"Task 준비도",tone:"warn",detail:`${s} current_task=${g} 이지만 heartbeat가 stale 합니다 (${$}s).`,tool:"masc_heartbeat"}:{title:"Task 준비도",tone:"ok",detail:`${s} current_task=${g}${$!=null?` · 마지막 활동 ${$}s 전`:""}`,tool:"masc_plan_get_task"}:{title:"Task 준비도",tone:"bad",detail:`${s} 에 claimed task는 있지만 session current_task binding이 없습니다.`,tool:"masc_plan_set_task"}:{title:"Task 준비도",tone:"bad",detail:`${s} 이 room roster에 보이지 않습니다.`,tool:"masc_join"}:{title:"Task 준비도",tone:"warn",detail:"?agent= 쿼리가 없습니다. room health는 보이지만 agent 단위 다음 단계는 비어 있습니다.",tool:"masc_join"},!t||(((Q=t.topology.summary)==null?void 0:Q.managed_unit_count)??0)===0?{title:"작전 준비도",tone:"warn",detail:"관리 단위가 아직 정의되지 않았습니다. hierarchy가 있어야 CPv2 benchmark를 시작할 수 있습니다.",tool:"masc_unit_define"}:r===0?{title:"작전 준비도",tone:"warn",detail:`${((b=t.topology.summary)==null?void 0:b.managed_unit_count)??0}개 관리 단위는 준비됐지만 활성 작전은 없습니다.`,tool:"masc_operation_start"}:{title:"작전 준비도",tone:"ok",detail:`${((Qt=t.topology.summary)==null?void 0:Qt.managed_unit_count)??0}개 관리 단위 위에서 ${r}개 활성 작전이 돌고 있습니다.`,tool:"masc_observe_operations"},u>0?{title:"디스패치 준비도",tone:"warn",detail:`${u}개의 pending approval이 strict action을 막고 있습니다.`,tool:"masc_policy_approve"}:r>0&&l===0?{title:"디스패치 준비도",tone:"bad",detail:"active operation은 있지만 detachment가 아직 materialize 되지 않았습니다.",tool:"masc_dispatch_tick"}:_||d?{title:"디스패치 준비도",tone:"warn",detail:`dispatch 재정렬이 필요합니다${_?` · detachment ${_.detachment.detachment_id} 가 stalled 상태입니다`:""}${d?` · alert ${d.title??d.alert_id}`:""}${!e&&!_&&!d?" · 정확한 원인은 detail 탭에서 확인하세요.":""}.`,tool:u>0?"masc_policy_approve":"masc_dispatch_tick"}:{title:"디스패치 준비도",tone:"ok",detail:`${l}개 detachment가 보이고 strict approval backlog도 없습니다${e?"":" · detail pane은 열릴 때만 로드됩니다."}.`,tool:"masc_detachment_list"}],w=f?!s||!a?"masc_join":i.length===0?yt.value.length>0?"masc_claim":"masc_add_task":g?y===!1?"masc_heartbeat":!t||(((De=t.topology.summary)==null?void 0:De.managed_unit_count)??0)===0?"masc_unit_define":r===0?"masc_operation_start":u>0?"masc_policy_approve":r>0&&l===0||_||d?"masc_dispatch_tick":"masc_observe_traces":"masc_plan_set_task":"masc_set_room",D=Cu(w),M=wu(w==="masc_set_room"?["repo-root-room"]:w==="masc_plan_set_task"?["claimed-not-current"]:w==="masc_heartbeat"?["heartbeat-stale"]:w==="masc_dispatch_tick"?["no-detachments"]:w==="masc_policy_approve"?["pending-approval"]:["repo-root-room","claimed-not-current","heartbeat-stale"]).slice(0,2),R=js("room_task_hygiene"),N=js("cpv2_benchmark"),p=js("supervisor_session"),q=((yn=$n.value)==null?void 0:yn.docs)??[],Nt=[R,N,p].filter(E=>E!==null);return o`
    <div class="command-guided-layout">
      ...
      <section class="card command-section">
        ...
        ${Ra.value?o`<div class="empty-state">CPv2 runbook 불러오는 중…</div>`:ns.value?o`<div class="empty-state error">${ns.value}</div>`:o`
  ...
  `}function ju(){return o`
    ...
    <${Tu} />
    <${Ou} />
  `}function Fu(){return Qn.value?o`<div class="empty-state">command-plane detail 불러오는 중…</div>`:ts.value?o`<div class="empty-state error">${ts.value}</div>`:o`<div class="empty-state">surface를 선택하면 command-plane detail을 로드합니다.</div>`}function Fi({node:t,depth:e=0}){const n=t.roster_live??0,s=t.roster_total??t.unit.roster.length,a=t.active_operation_count??0,i=t.unit.policy;return o`
  ...
  `}function Ku({overlay:t,selected:e,onSelect:n}){const s=t.operation.chain,a=t.runtime;return o`
    <button class="command-chain-item ${e?"selected":""}" onClick=${n}>
      ...
      <div class="command-tag-row">
        ...
        ${a?o`<span class="command-tag ${Bt(s==null?void 0:s.status)}">${Rs(a.progress)} progress</span>`:null}
      </div>
  ...
  `}function Zu(){var u,_,d,f,g,$,y,A,w,D,O,M,R,N,p,q,Nt,lt,ct,U,Q;const t=Cs.value,e=ku(),n=xu(),s=(u=t==null?void 0:t.provider)!=null&&u.runtime_blocker?"blocked":(_=t==null?void 0:t.provider)!=null&&_.provider_reachable?"ready":"check",a=((d=t==null?void 0:t.provider)==null?void 0:d.actual_slots)??((f=t==null?void 0:t.provider)==null?void 0:f.total_slots)??0,i=((g=t==null?void 0:t.provider)==null?void 0:g.expected_slots)??"n/a",r=(($=t==null?void 0:t.provider)==null?void 0:$.actual_ctx)??((y=t==null?void 0:t.provider)==null?void 0:y.ctx_per_slot)??0,l=((A=t==null?void 0:t.provider)==null?void 0:A.expected_ctx)??"n/a";return o`
    <div class="command-section-stack">
      <${Iu} />
      <div class="command-surface-grid">
        <section class="card command-section">
          <div class="card-title">스웜 라이브 런</div>
          ${Na.value?o`<div class="empty-state">Loading swarm live state…</div>`:ss.value?o`<div class="empty-state error">${ss.value}</div>`:t?o`
                    <div class="command-summary-grid">
  ...
  `}function ep(){var l,u,_,d,f,g,$,y,A,w,D,O,M,R,N,p;const t=ws.value,e=(t==null?void 0:t.operations)??[],n=xe.value,s=e.find(q=>q.operation.operation_id===n)??e[0]??null,a=((l=s==null?void 0:s.operation.chain)==null?void 0:l.run_id)??null,i=((u=rn.value)==null?void 0:u.run)??(s==null?void 0:s.preview_run)??null,r=!((_=rn.value)!=null&&_.run)&&!!(s!=null&&s.preview_run);return it(()=>{a?Jd(a):Gd()},[a]),o`
    <div class="command-grid">
      <section class="card command-section">
        ...
        ${La.value&&!t?o`<div class="empty-state">Loading chain overlays…</div>`:e.length>0?o`
        ...
        ${s?o`
              <article class="command-card">
                ...
                <div class="command-card-grid">
                  ...
                  <span>Progress</span><span>${Rs((O=s.runtime)==null?void 0:O.progress)}</span>
              ...
              <div class="command-chain-panel">
                ...
                ${os.value?o`<div class="empty-state">Loading run detail…</div>`:ln.value?o`<div class="empty-state error">${ln.value}</div>`:i&&i.nodes.length>0?o`
                          <div class="command-card-grid">
  ...
  `}function ip(){if(mt.value==="summary")return o`<${ju} />`;if(mt.value==="swarm")return o`<${Zu} />`;if(!Rt.value)return o`<${Fu} />`;switch(mt.value){case"chains":return o`<${ep} />`;case"topology":return o`<${np} />`;case"alerts":return o`<${sp} />`;case"trace":return o`<${ap} />`;case"control":return o`<${op} />`;case"operations":default:return o`<${tp} />`}}function rp(){return it(()=>{ce(),Ht(),Vd(),Pt()},[]),it(()=>{if(Z.value.tab!=="command")return;const t=Z.value.params.surface,e=Z.value.params.operation;vu(t)?cn(t):t||cn("operations"),e&&ao(e),t==="swarm"&&Pt()},[Z.value.tab,Z.value.params.surface,Z.value.params.operation,Z.value.params.operation_id,Z.value.params.run_id]),it(()=>{let t=null;const e=()=>{t||(t=window.setTimeout(()=>{t=null,ce(),Ht(),mt.value==="swarm"&&Pt()},250))},n=new EventSource(fu()),s=pu.map(a=>{const i=()=>e();return n.addEventListener(a,i),{type:a,handler:i}});return n.onerror=()=>{e()},()=>{s.forEach(({type:a,handler:i})=>{n.removeEventListener(a,i)}),n.close(),t&&window.clearTimeout(t)}},[]),o`
    <section class="dashboard-panel command-plane-view">
      ...
      ${Zn.value?o`<div class="empty-state error">${Zn.value}</div>`:null}
          ...
          <section class="card ops-panel ops-lane-panel">
            ...
            <div class="control-row ops-split-row">
              <select
                ...
                value=${Ma.value}
                onChange=${p=>{Ma.value=p.target.value}}
                disabled=${H.value}
              >
        ...
        <div class="ops-column">
          ...
          <section class="card ops-panel ops-lane-panel">
            ...
            <textarea
              ...
              value=${us.value}
              onInput=${p=>{us.value=p.target.value}}
              disabled=${H.value||!d}
            ></textarea>
...
`).trim();n.push(o`
      ...
      `);continue}if(a.startsWith("> ")){const r=[];for(;s<e.length&&e[s].startsWith("> ");)r.push(e[s].slice(2)),s++;n.push(o`<blockquote>${Fs(r.join(`
`))}</blockquote>`);continue}if(a.trim()===""){s++;continue}const i=[];for(;s<e.length;){const r=e[s];if(r.trim()===""||/^(`{3,}|~{3,})/.test(r)||r.startsWith("> ")||r.trim().startsWith("<think>"))break;i.push(r),s++}i.length>0&&n.push(o`<p>${Fs(i.join(`
`))}</p>`)}return n}function Fs(t){const e=[],n=/(`[^`]+`)|(\*\*[^*]+\*\*)|(\*[^*]+\*)|\[([^\]]+)\]\(([^)]+)\)/g;let s=0,a;for(;(a=n.exec(t))!==null;){if(a.index>s&&e.push(t.slice(s,a.index)),a[1]){const i=a[1].slice(1,-1);e.push(o`<code>${i}</code>`)}else if(a[2]){const i=a[2].slice(2,-2);e.push(o`<strong>${i}</strong>`)}else if(a[3]){const i=a[3].slice(1,-1);e.push(o`<em>${i}</em>`)}else a[4]&&a[5]&&e.push(o`<a href=${a[5]} target="_blank" rel="noopener">${a[4]}</a>`);s=a.index+a[0].length}return s<t.length&&e.push(t.slice(s)),e.length>0?e:[t]}const Ke=v("posts"),za=v([]),Oa=v([]),Ge=v(""),vs=v(!1),Je=v(!1),pn=v(""),_s=v(null),$t=v(null),ja=v(!1),Ut=v(null),qn=v(null);async function Ms(){vs.value=!0,pn.value="";try{const[t,e]=await Promise.all([Bl(),Wl()]);za.value=t,Oa.value=e,Ut.value=!0,qn.value=Date.now()}catch(t){pn.value=t instanceof Error?t.message:"Failed to load council data",Ut.value=!1}finally{vs.value=!1}}Oc(Ms);async function Po(){const t=Ge.value.trim();if(t){Je.value=!0;try{const e=await Gl(t);Ge.value="",L(e!=null&&e.id?`Debate started: ${e.id}`:"Debate started","success"),await Ms()}catch(e){const n=e instanceof Error?e.message:"Failed to start debate";L(n,"error")}finally{Je.value=!1}}}async function Fp(t){_s.value=t,ja.value=!0,$t.value=null;try{$t.value=await Jl(t)}catch(e){pn.value=e instanceof Error?e.message:"Failed to load debate status",$t.value=null}finally{ja.value=!1}}const Ji=[{id:"hot",label:"Hot"},{id:"trending",label:"Trending"},{id:"recent",label:"Recent"},{id:"updated",label:"Updated"},{id:"discussed",label:"Discussed"}],Kn=v(null),Ve=v([]),de=v(!1),re=v(null),Ye=v("");function qp(){var e,n;const t=new URLSearchParams(window.location.search);return((e=t.get("agent"))==null?void 0:e.trim())||((n=t.get("agent_name"))==null?void 0:n.trim())||"dashboard-user"}const Kp=v(qp()),Xe=v(!1);async function io(t){re.value=t,Kn.value=null,Ve.value=[],de.value=!0;try{const e=await gl(t);if(re.value!==t)return;Kn.value={id:e.id,author:e.author,title:e.title,content:e.content,tags:e.tags,votes:e.votes,vote_balance:e.vote_balance,comment_count:e.comment_count,created_at:e.created_at,updated_at:e.updated_at,flair:e.flair,hearth_count:e.hearth_count},Ve.value=e.comments??[]}catch{re.value===t&&(Kn.value=null,Ve.value=[])}finally{re.value===t&&(de.value=!1)}}async function Mo(t){const e=Ye.value.trim();if(e){Xe.value=!0;try{await $l(t,Kp.value,e),Ye.value="",L("Comment posted","success"),await io(t),At()}catch{L("Failed to post comment","error")}finally{Xe.value=!1}}}function Up(){const t=en.value;return o`
  ...
  `}function Fa(){var e;const t=(e=Ne.value)==null?void 0:e.data_quality;return!t||t.board_contract_ok!==!1&&!t.last_sync_at?null:o`
  ...
  `}function Vi({flair:t}){return t?o`<span class="post-flair ${t}">${t}</span>`:null}function Hp(t){const e=t.replace(/!\[[^\]]*\]\([^)]+\)/g," ").replace(/\[[^\]]+\]\([^)]+\)/g,"$1").replace(/[`#>*_~-]/g," ").replace(/\s+/g," ").trim();return e?e.length>180?`${e.slice(0,177)}...`:e:"No preview available"}function Do(t){return t.updated_at!==t.created_at}function qa(){var n;const t=((n=Ji.find(s=>s.id===en.value))==null?void 0:n.label)??en.value,e=Le.value.length;return o`
    <div class="board-summary-strip">
      ...
      <div class="board-summary-item">
        ...
        <strong>${Sa.value?o`<${V} timestamp=${Sa.value} />`:"Not loaded"}</strong>
      </div>
    </div>
  ...
  `}function Vp({debate:t}){const e=_s.value===t.id;return o`
    <button
    ...
    <div>
      ...
      <${T} title="Start Debate" class="section">
        <div class="council-create">
          ...
          <button class="control-btn ghost" onClick=${Ms} disabled=${vs.value}>
      ...
      <${T} title="Debates" class="section">
        <div class="council-list">
          ${za.value.length===0?o`<div class="empty-state">${t?"No debates loaded (council feed degraded).":"No debates yet"}</div>`:za.value.map(e=>o`<${Vp} key=${e.id} debate=${e} />`)}
        </div>
      <//>

      <${T} title=${_s.value?`Debate Detail (${_s.value})`:"Debate Detail"} class="section">
        ${ja.value?o`<div class="loading-indicator">Loading debate detail...</div>`:$t.value?o`
  ...
  `}function Qp(){const t=Ut.value===!1;return o`
    <div>
      ...
      <${T} title="Voting Sessions" class="section">
        <div class="council-list">
          ${Oa.value.length===0?o`<div class="empty-state">${t?"No sessions loaded (council feed degraded).":"No active sessions"}</div>`:Oa.value.map(e=>o`<${Yp} key=${e.id} session=${e} />`)}
        </div>
      <//>
    </div>
  ...
  `}function em(){var a,i;const t=Le.value,e=Z.value.postId,n=((i=(a=Ne.value)==null?void 0:a.data_quality)==null?void 0:i.board_contract_ok)===!1,s=Ke.value;if(it(()=>{(s==="debates"||s==="voting")&&Ms()},[s]),e){const r=t.find(l=>l.id===e)??(re.value===e?Kn.value:null);return!r&&re.value!==e&&!de.value&&io(e),r?o`
          <${Fa} />
          <${qa} />
          <${Jp} post=${r} />
        `:o`
  ...
  `}function km(){const t=gm.value,e=$m.value,n=e[0],s=hm.value;return o`
    <div class="stats-grid">
      ...
      <${je} label="SSE events SSE 이벤트" value=${bs.value} color="#c084fc" />
    </div>
      ...
      <div class="activity-toolbar">
        <div class="activity-filter-row">
          ${["all","messages","board","tasks","keepers","system"].map(a=>o`
            <button
              class="goal-filter-btn ${Ka.value===a?"active":""}"
              onClick=${()=>{Ka.value=a}}
            >
              ${dm[a]}
            </button>
  ...
  `}function Tm({keeperName:t,placeholder:e}){const[n,s]=Ya("");it(()=>{t&&ui(t)},[t]);const a=at.value[t]??[],i=va.value[t]??!1,r=It.value[t],l=async()=>{const u=n.trim();if(!(!t||!u)){s("");try{await pc(t,u)}catch(_){const d=_ instanceof Error?_.message:`Failed to message ${t}`;L(d,"error")}}};return o`
  ...
  `}function Rm({actor:t,keeper:e,onPokeLodge:n}){if(!e)return null;const s=tr(e),a=_a.value[e.name]??!1,i=fa.value[e.name]??!1,r=(s==null?void 0:s.next_action_path)??"direct_message",l=(s==null?void 0:s.recoverable)??r==="recover";return o`
    <div class="control-actions">
      <button
  ...
  `}function Mm({keeper:t}){var d,f;const e=t.metrics_series??[];if(e.length<2){const g=(((d=t.context)==null?void 0:d.context_ratio)??0)*100,$=g>85?"#ef4444":g>70?"#f59e0b":"#22c55e";return o`
    ...
    <div class="keeper-field-dict">
      <input
        ...
        value=${qs.value}
        onInput=${u=>{qs.value=u.target.value}}
      />
      ${s.map(u=>o`
  ...
  `}function Ks(t){return t==null||Number.isNaN(t)?"-":`${Math.round(t*100)}%`}function Om({keeper:t}){const e=t.metrics_window,n=[{label:"Model fallback",value:Ks(typeof(e==null?void 0:e.model_fallback_rate)=="number"?e.model_fallback_rate:void 0)},{label:"Proactive fallback",value:Ks(typeof(e==null?void 0:e.proactive_fallback_rate)=="number"?e.proactive_fallback_rate:void 0)},{label:"Memory pass rate",value:Ks(typeof(e==null?void 0:e.memory_pass_rate)=="number"?e.memory_pass_rate:void 0)},{label:"Handoffs",value:typeof(e==null?void 0:e.handoff_count)=="number"?e.handoff_count:t.handoff_count_total??"-"},{label:"Compactions",value:typeof(e==null?void 0:e.compaction_events)=="number"?e.compaction_events:t.compaction_count??"-"},{label:"Saved tokens",value:typeof(e==null?void 0:e.compaction_saved_tokens)=="number"?e.compaction_saved_tokens:t.last_compaction_saved_tokens??"-"},{label:"K2K events",value:t.k2k_count??"-"},{label:"Conversation tail",value:t.conversation_tail_count??"-"},{label:"Tool Calls",value:typeof(e==null?void 0:e.tool_call_count)=="number"?e.tool_call_count:"-"},{label:"Preview Similarity",value:typeof(e==null?void 0:e.proactive_preview_similarity_avg)=="number"?`${(e.proactive_preview_similarity_avg*100).toFixed(1)}%`:"-"},{label:"Memory Avg Score",value:typeof(e==null?void 0:e.memory_avg_score)=="number"?e.memory_avg_score.toFixed(3):"-"},{label:"Fallback Rate",value:typeof(e==null?void 0:e.fallback_rate)=="number"?`${(e.fallback_rate*100).toFixed(1)}%`:"-"}];return o`
    <div class="keeper-signal-list">
      ${n.map(s=>o`
        <div class="keeper-signal-row">
          <span>${s.label}</span>
  ...
  `}function nr(){const t=new URLSearchParams(window.location.search),e=t.get("agent")??t.get("agent_name"),n=localStorage.getItem("masc_dashboard_agent_name");return(e??n??"dashboard").trim()||"dashboard"}async function jm(){try{const t=await ks({actor:nr(),action_type:"lodge_tick",target_type:"room",payload:{}}),e=di(t.result);an(),await ue(),e!=null&&e.skipped_reason?L(e.skipped_reason,"warning"):L(e?`Poke finished: ${e.acted}/${e.checked} acted`:"Poke finished",e&&e.acted>0?"success":"warning")}catch(t){const e=t instanceof Error?t.message:"Failed to run Lodge poke";L(e,"error")}}function Fm({keeper:t}){return o`
  ...
  `:null}const Km="masc_dashboard_agent_name",Me=v(null),fs=v(!1),mn=v(""),gs=v([]),vn=v([]),Se=v(""),Qe=v(!1);function sr(t){Me.value=t,lo()}function Oo(){Me.value=null,mn.value="",gs.value=[],vn.value=[],Se.value=""}function Um(){const t=Me.value;return t?wt.value.find(e=>e.name===t)??null:null}function ar(t){return t?yt.value.filter(e=>e.assignee===t):[]}async function lo(){const t=Me.value;if(t){fs.value=!0,mn.value="",gs.value=[],vn.value=[];try{const e=await Ul(80);gs.value=e.filter(a=>a.includes(t)).slice(0,20);const n=ar(t).slice(0,6);if(n.length===0)return;const s=await Promise.all(n.map(async a=>{try{const i=await Hl(a.id,25);return{taskId:a.id,text:i.trim()}}catch(i){const r=i instanceof Error?i.message:"history load failed";return{taskId:a.id,text:`Failed to load history: ${r}`}}}));vn.value=s}catch(e){mn.value=e instanceof Error?e.message:"Failed to load agent detail"}finally{fs.value=!1}}}async function jo(){var s;const t=Me.value,e=Se.value.trim();if(!t||!e)return;const n=((s=localStorage.getItem(Km))==null?void 0:s.trim())||"dashboard";Qe.value=!0;try{await Kl(n,`@${t} ${e}`),Se.value="",L(`Mention sent to ${t}`,"success"),lo()}catch(a){const i=a instanceof Error?a.message:"Failed to send mention";L(i,"error")}finally{Qe.value=!1}}function Hm({task:t}){return o`
  ...
  `}function Wm(){var a,i,r,l;const t=Me.value;if(!t)return null;const e=Um(),n=ar(t),s=gs.value;return o`
    <div
      ...
      <div class="agent-detail-modal">
        <div class="agent-detail-header">
          ...
          <div class="agent-detail-actions">
            <button class="control-btn ghost" onClick=${()=>{lo()}} disabled=${fs.value}>
              ${fs.value?"Refreshing...":"Refresh"}
            </button>
  ...
  `}const $s=v("all"),hs=v("all"),Ba=ft(()=>{let t=nn.value;return $s.value!=="all"&&(t=t.filter(e=>e.horizon===$s.value)),hs.value!=="all"&&(t=t.filter(e=>e.status===hs.value)),t}),av=ft(()=>{const t={short:[],mid:[],long:[]};for(const e of Ba.value){const n=t[e.horizon];n&&n.push(e)}return t}),ov=ft(()=>{const t=Array.from(mi.value.values());return t.sort((e,n)=>e.status==="running"&&n.status!=="running"?-1:n.status==="running"&&e.status!=="running"?1:e.status==="interrupted"&&n.status!=="interrupted"?-1:n.status==="interrupted"&&e.status!=="interrupted"?1:n.elapsed_seconds-e.elapsed_seconds),t});function iv(t){return"★".repeat(Math.min(t,5))+"☆".repeat(Math.max(0,5-t))}function co(t){switch(t){case"short":return"Short-term";case"mid":return"Mid-term";case"long":return"Long-term";default:return t}}function Hn(t){switch(t){case"short":return"#4ade80";case"mid":return"#f59e0b";case"long":return"#818cf8";default:return"#888"}}function rv(t){return t<60?`${Math.round(t)}s`:t<3600?`${Math.floor(t/60)}m ${Math.round(t%60)}s`:`${Math.floor(t/3600)}h ${Math.floor(t%3600/60)}m`}function Ko(t){return t.toFixed(4)}function Uo(t){const e=t.current_metric-t.baseline_metric;return`${e>=0?"+":""}${e.toFixed(4)}`}function lv({goal:t}){return o`
    <div class="goal-row">
      <div class="goal-row-main">
        <div style="display:flex; align-items:center; gap:8px;">
          <span class="goal-horizon-badge" style="color:${Hn(t.horizon)}">
            ${co(t.horizon)}
          </span>
  ...
  `}function Hs({horizon:t,items:e}){if(e.length===0)return null;const n=[...e].sort((s,a)=>a.priority-s.priority);return o`
    ...
    <div class="goal-filters">
      <div class="goal-filter-group">
        ...
        ${["all","short","mid","long"].map(t=>o`
          <button
            class="goal-filter-btn ${$s.value===t?"active":""}"
            onClick=${()=>{$s.value=t}}
          >
            ${t==="all"?"All":co(t)}
          </button>
  ...
  `}function dv(){const t=nn.value,e=t.filter(a=>a.status==="active").length,n=t.filter(a=>a.status==="completed").length,s={short:0,mid:0,long:0};for(const a of t)a.horizon in s&&s[a.horizon]++;return o`
    <div class="goal-summary">
      ...
      <div class="goal-summary-item">
        <div class="goal-summary-value" style="color:${Hn("short")}">${s.short}</div>
        <div class="goal-summary-label">Short</div>
      </div>
      <div class="goal-summary-item">
        <div class="goal-summary-value" style="color:${Hn("mid")}">${s.mid}</div>
        <div class="goal-summary-label">Mid</div>
      </div>
      <div class="goal-summary-item">
        <div class="goal-summary-value" style="color:${Hn("long")}">${s.long}</div>
  ...
  `}function mv(){const t=av.value,e=ov.value,n=e.filter(l=>l.status==="running").length,s=e.filter(l=>l.recoverable).length,a=nn.value.filter(l=>l.status==="active").length,i=ya.value,r=i==="idle"?"No loop running":i==="error"?ba.value??"MDAL snapshot unavailable":"Current loop snapshot";return o`
    <div>
      <div class="stats-grid">
        <div class="stat-card">
      ...
      ${ye.value&&nn.value.length===0?o`<div class="loading-indicator">Loading goals...</div>`:Ba.value.length===0?o`<div class="empty-state">No goals match the current filters</div>`:o`
              <${Hs} horizon="short" items=${t.short??[]} />
              <${Hs} horizon="mid" items=${t.mid??[]} />
              <${Hs} horizon="long" items=${t.long??[]} />
            `}
...
`))}function Tv({hp:t,max:e}){const n=fv(t,e),s=_v(t,e);return o`
  ...
  `}function Pv({events:t}){const e="__none__",n=oa.value,s=ia.value,a=ra.value,i=Array.from(new Set(t.map(Ga).map(f=>f.trim()).filter(f=>f!==""))).sort((f,g)=>f.localeCompare(g)),r=Array.from(new Set(t.map(f=>(f.type??"").trim()).filter(f=>f!==""))).sort((f,g)=>f.localeCompare(g)),l=t.some(f=>(f.type??"").trim()===""),u=Array.from(new Set(t.map(f=>(f.phase??"").trim()).filter(f=>f!==""))).sort((f,g)=>f.localeCompare(g)),_=t.some(f=>(f.phase??"").trim()===""),d=t.filter(f=>{if(n!=="all"&&Ga(f)!==n)return!1;const g=(f.type??"").trim(),$=(f.phase??"").trim();if(s===e){if(g!=="")return!1}else if(s!=="all"&&g!==s)return!1;if(a===e){if($!=="")return!1}else if(a!=="all"&&$!==a)return!1;return!0});return o`
    <div class="trpg-story-toolbar">
      <div class="trpg-story-filter">
        <label>Actor</label>
        <select value=${n} onChange=${f=>{oa.value=f.target.value}}>
      ...
      <div class="trpg-story-filter">
        <label>Type</label>
        <select value=${s} onChange=${f=>{ia.value=f.target.value}}>
          <option value="all">all</option>
      ...
      <div class="trpg-story-filter">
        <label>Phase</label>
        <select value=${a} onChange=${f=>{ra.value=f.target.value}}>
          <option value="all">all</option>
      ...
      <button
        ...
        onClick=${()=>{oa.value="all",ia.value="all",ra.value="all"}}
      >
        필터 초기화
      </button>
  ...
  `}function Dv({state:t,nowMs:e}){var _;const n=Mt.value||((_=t.session)==null?void 0:_.room)||"",s=Ln.value,a=t.party??[];if(!a.find(d=>d.id===$e.value)&&a.length>0){const d=a[0];d&&($e.value=d.id)}const r=async()=>{var f,g;if(!n){L("Room ID가 비어 있습니다.","error");return}if(!Bn(e))return;const d=((f=t.current_round)==null?void 0:f.phase)??((g=t.session)==null?void 0:g.status)??"unknown";if(Ja("라운드 실행",n,d)){Ln.value="running";try{const $=await Dl(n);Wa.value=$,Ln.value="ok";const y=Gt($.summary)?$.summary:null,A=y?_n(y,"advanced",!1):!1,w=y?ut(y,"progress_reason",""):"";L(A?"라운드가 정상 진행되었습니다.":`라운드가 정체되었습니다${w?`: ${w}`:""}`,A?"success":"warning"),Ct()}catch($){Wa.value=null,Ln.value="error";const y=$ instanceof Error?$.message:"라운드 실행에 실패했습니다.";L(y,"error")}finally{ys()}}},l=async()=>{var f,g;if(!n||!Bn(e))return;const d=((f=t.current_round)==null?void 0:f.phase)??((g=t.session)==null?void 0:g.status)??"unknown";if(Ja("턴 강제 진행",n,d))try{await zl(n),L("턴을 다음 단계로 이동했습니다.","success"),Ct()}catch{L("턴 이동에 실패했습니다.","error")}finally{ys()}},u=async()=>{if(!n||!Bn(e))return;const d=$e.value.trim();if(!d){L("먼저 Actor를 선택하세요.","warning");return}const f=Number.parseInt(Gs.value,10),g=Number.parseInt(Js.value,10);if(Number.isNaN(f)||Number.isNaN(g)){L("stat/dc는 숫자여야 합니다.","warning");return}const $=Number.parseInt(Nn.value,10),y=Nn.value.trim()===""||Number.isNaN($)?void 0:$;try{await Il({roomId:n,actorId:d,action:Ws.value.trim()||"ability_check",statValue:f,dc:g,rawD20:y}),L("주사위 판정을 기록했습니다.","success"),Ct()}catch{L("주사위 판정 기록에 실패했습니다.","error")}};return o`
        ...
        <div class="trpg-control-field">
          ...
          <div style="display:grid; grid-template-columns: 1fr 1fr; gap:6px;">
            <input
              ...
              type="text"
              value=${Ws.value}
              onInput=${d=>{Ws.value=d.target.value}}
              placeholder="action"
            />
            <input
  ...
  `}function Ev({state:t}){var a;const e=Mt.value||((a=t.session)==null?void 0:a.room)||"",n=Dn.value,s=async()=>{if(!e){L("Room ID가 비어 있습니다.","warning");return}const i=Mn.value.trim(),r=Qs.value.trim();if(!r&&!i){L("이름 또는 Actor ID를 입력하세요.","warning");return}const l=Number.parseInt(Ze.value.trim(),10),u=Number.parseInt(sa.value.trim(),10),_=Number.isFinite(u)?Math.max(1,u):20,d=Number.isFinite(l)?Math.max(0,Math.min(_,l)):_;let f={};try{f=kv(aa.value)}catch(g){L(g instanceof Error?g.message:"능력치 JSON 오류","error");return}Dn.value="spawning";try{const g=typeof crypto<"u"&&typeof crypto.randomUUID=="function"?`trpg_spawn_${crypto.randomUUID()}`:`trpg_spawn_${Date.now().toString(36)}_${Math.random().toString(36).slice(2,10)}`,$=await Ol(e,{actor_id:i||void 0,name:r||void 0,role:Zs.value,idempotencyKey:g,portrait:ea.value.trim()||void 0,background:na.value.trim()||void 0,hp:d,max_hp:_,alive:d>0,stats:Object.keys(f).length>0?f:void 0}),y=typeof $.actor_id=="string"?$.actor_id.trim():"";if(!y)throw new Error("생성 응답에 actor_id가 없습니다.");const A=ta.value.trim();A&&await jl(e,y,A),$e.value=y,Kt.value=y,i||(Mn.value=""),Dn.value="ok",L(`Actor 생성 완료: ${y}`,"success"),await Ct()}catch(g){Dn.value="error",L(g instanceof Error?g.message:"Actor 생성에 실패했습니다.","error")}};return o`
    <div class="trpg-control-box">
      <div class="trpg-control-grid">
        <div class="trpg-control-field">
          <label>Name</label>
        ...
        <div class="trpg-control-field">
          ...
          <select
            value=${Zs.value}
            onChange=${i=>{Zs.value=i.target.value}}
          >
        ...
        <div class="trpg-control-field">
          ...
          <input
            ...
            type="text"
            value=${ta.value}
            onInput=${i=>{ta.value=i.target.value}}
        ...
        <div class="trpg-control-grid">
          ...
          <div class="trpg-control-field">
            ...
            <input
              ...
              min="1"
              value=${sa.value}
              onInput=${i=>{const r=i.target.value;sa.value=r,xv(r)}}
              placeholder="20"
            />
          </div>
  ...
  `}function Iv({state:t,nowMs:e}){var g;const n=Mt.value||((g=t.session)==null?void 0:g.room)||"",s=t.join_gate,a=Xs.value,i=Gt(a)?a:null,r=(t.party??[]).filter($=>$.role!=="dm"),l=Kt.value.trim(),u=r.some($=>$.id===l),_=u?l:l?"__manual__":"",d=async()=>{const $=Kt.value.trim(),y=Pn.value.trim();if(!n||!$){L("Room/Actor가 필요합니다.","warning");return}_t.value="checking";try{const A=await Fl(n,$,y||void 0);Xs.value=A,_t.value="ok",L("참가 가능 여부를 갱신했습니다.","success")}catch(A){_t.value="error";const w=A instanceof Error?A.message:"참가 가능 여부 확인에 실패했습니다.";L(w,"error")}},f=async()=>{var D,O;const $=Kt.value.trim(),y=Pn.value.trim(),A=Ys.value.trim();if(!n||!$||!y){L("Room/Actor/Keeper가 필요합니다.","warning");return}if(!Bn(e))return;const w=((D=t.current_round)==null?void 0:D.phase)??((O=t.session)==null?void 0:O.status)??"unknown";if(Ja("Mid-Join 승인 요청",n,w)){_t.value="requesting";try{const M=await ql({room_id:n,actor_id:$,keeper_name:y,role:Vs.value,...A?{name:A}:{}});Xs.value=M;const R=Gt(M)?_n(M,"granted",!1):!1,N=Gt(M)?ut(M,"reason_code",""):"";R?L("Mid-Join이 승인되었습니다.","success"):L(`Mid-Join이 거절되었습니다${N?`: ${N}`:""}`,"warning"),_t.value=R?"ok":"error",Ct()}catch(M){_t.value="error";const R=M instanceof Error?M.message:"Mid-Join 요청에 실패했습니다.";L(R,"error")}finally{ys()}}};return o`
    <div class="trpg-control-box">
      ...
      <div class="trpg-control-grid">
        ...
        <div class="trpg-control-field">
          ...
          <select
            value=${Vs.value}
            onChange=${$=>{Vs.value=$.target.value}}
          >
            <option value="player">player</option>
            <option value="npc">npc</option>
            <option value="dm">dm</option>
    ...
    <${T} title="조작 안전 잠금" style="margin-bottom:16px;">
      <div class="trpg-control-lock ${a?"locked":"unlocked"}">
        ...
        <div style="display:flex; gap:8px; margin-top:10px; flex-wrap:wrap;">
          ${a?o`<button class="trpg-run-btn recommend" onClick=${()=>wv(n,s)}>잠금 해제 (120초)</button>`:o`<button class="trpg-run-btn secondary" onClick=${()=>{ys(),L("조작 잠금으로 전환했습니다.","success")}}>즉시 다시 잠금</button>`}
        </div>
      </div>
    <//>
  ...
  `}function Kv(){var l,u,_,d,f;const t=pi.value,e=xa.value;if(it(()=>{if(typeof window>"u"||typeof window.setInterval!="function")return;const g=window.setInterval(()=>{Bo.value=Date.now()},1e3);return()=>{window.clearInterval(g)}},[]),e&&!t)return o`<div class="loading-indicator">Loading TRPG state...</div>`;if(!t)return o`
      <div class="section">
        <h2>TRPG</h2>
  ...
  `}const Wo=[{id:"observe",label:"먼저 보기",description:"지금 상태와 우선순위를 먼저 읽는 운영 랜딩"},{id:"coordinate",label:"보조 공간",description:"대화, 계획, 에이전트 상태를 보조 작업 공간으로 분리"},{id:"command",label:"실행",description:"개입과 지휘를 실제로 실행하는 표면"}],Va=[{id:"mission",label:"상황판",icon:"🏠",group:"observe",description:"지금 문제, 다음 액션, 운영 포커스를 먼저 보는 기본 랜딩"},{id:"intervene",label:"개입",icon:"🎮",group:"command",description:"room/session/keeper 액션을 실제로 실행하는 intervention workspace"},{id:"command",label:"지휘",icon:"🧭",group:"command",description:"command plane, swarm, trace, approvals를 drill-down으로 보는 상세 화면"},{id:"agents",label:"에이전트",icon:"🤖",group:"observe",description:"agent 상태, keeper 압력, 현재 작업 초점을 보는 모니터"},{id:"board",label:"보드",icon:"💬",group:"coordinate",description:"사람과 agent 대화를 시스템 노이즈를 줄여서 보는 피드"},{id:"goals",label:"계획",icon:"🎯",group:"coordinate",description:"goal, MDAL loop, backlog를 한 화면에서 보는 계획 표면"},{id:"trpg",label:"TRPG",icon:"⚔️",group:"command",description:"Narrative room control and state visibility"}],fn=v(!1);function Go(){fn.value=!1}function Uv(){fn.value=!fn.value}function Hv(){const t=Dt.value;return o`
    <div class="connection-status ${t?"connected":"disconnected"}">
      ...
      <span class="event-count">${bs.value} events</span>
    </div>
    ...
    <section class="rail-card">
      ...
      <div class="rail-inline-actions">
        <button
          ...
          onClick=${()=>{ue(),t==="command"&&(ce(),Ht(),mt.value==="swarm"&&Pt()),(t==="mission"||t==="overview")&&wa(),(t==="intervene"||t==="ops")&&(Vt(),Ot()),t==="board"&&At(),t==="trpg"&&Ct(),t==="goals"&&(on(),Ce())}}
        >
          Refresh Now
        </button>
  ...
  `}function Jv(){switch(Z.value.tab){case"mission":return o`<${zs} />`;case"intervene":return o`<${Lo} />`;case"command":return o`<${rp} />`;case"overview":return o`<${zs} />`;case"ops":return o`<${Lo} />`;case"board":return o`<${em} />`;case"agents":return o`<${sv} />`;case"goals":return o`<${mv} />`;case"trpg":return o`<${Kv} />`;default:return o`<${zs} />`}}function Vv(){it(()=>{Lr(),ei(),ue();const n=qc();return Kc(),()=>{jr(),n(),Uc()}},[]),it(()=>{const n=setInterval(()=>{const s=Z.value.tab;s==="command"?(ce(),Ht(),mt.value==="swarm"&&Pt()):s==="mission"||s==="overview"?wa():s==="intervene"||s==="ops"?(Vt(),Ot()):s==="board"?At():s==="trpg"?Ct():s==="goals"&&(on(),Ce())},15e3);return()=>{clearInterval(n)}},[]),it(()=>{const n=Z.value.tab;n==="command"&&(ce(),Ht(),mt.value==="swarm"&&Pt()),(n==="mission"||n==="overview")&&wa(),(n==="intervene"||n==="ops")&&(Vt(),Ot()),n==="board"&&At(),n==="trpg"&&Ct(),n==="goals"&&(on(),Ce())},[Z.value.tab]);const t=Z.value.tab,e=Va.find(n=>n.id===t);return o`
    <div class="app-shell">
      ...
      <div class="dashboard-layout">
        ...
        <main class="dashboard-main">
          ${ka.value&&!Dt.value?o`<div class="loading-indicator">Loading dashboard...</div>`:o`<${Jv} />`}
        </main>
      </div>
