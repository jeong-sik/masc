(** Unit tests for [Masc_agent_core_diag_sink] — the routing of OAS [Llm_provider.Diag]
    ...
    [Masc_agent_core_diag_sink] and [Llm_provider] are bound directly. *)

module Sink = Masc_agent_core_diag_sink
