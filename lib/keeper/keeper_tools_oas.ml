...
let sse_error_preview_max_chars = Keeper_tools_oas_markers.sse_error_preview_max_chars
let tool_exec_result_markers = Keeper_tools_oas_markers.tool_exec_result_markers
