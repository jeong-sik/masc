...
(* 2026-09-25: +8 rendered bytes projected from BrowserInteract's stagehand
   lane enum (+12) and browser-tab description (-4), over the 123,461
   ceiling above. The exact merged-head CI reading must replace this
   projection; no added headroom. *)
let ceiling_bytes = 123_469
