...
OAS pin metadata is generated from `scripts/oas-agent-sdk-pin.sh`. Current dependency floor: `agent_sdk >= 0.170.3`, runtime pin: `fix/pipeline-message-constructor@7ae2d9c897eb1dc168e0187277128a3f057ee133`, declared base version: `v0.170.3`. 최신성 검증이 필요할 때는 문서에 적힌 숫자보다 `dune-project`와 pin script를 우선 truth source로 본다.
