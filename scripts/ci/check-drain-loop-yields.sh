...
#   [Masc_agent_core_metrics_bridge.drain] and recursed without
...
DRAIN_RE='Masc_agent_core_metrics_bridge\.drain|Masc_agent_core\.Event_bus\.drain|Eio\.Stream\.take_nonblocking'
