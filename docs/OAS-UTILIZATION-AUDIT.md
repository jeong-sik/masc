...
OAS Pin Snapshot: dependency floor `0.121.0`, runtime pin `main@a9e189fe5126e932b99ad21c862dce72e0b43ad5`, declared base version `v0.121.0`
...
`masc-mcp` keeps the runtime pin ratcheted against upstream `main`, while the dependency floor tracks the pinned SDK declaration in `agent_sdk.opam`. Generated snapshot: runtime pin `main@a9e189fe5126e932b99ad21c862dce72e0b43ad5`, declared base version `v0.121.0`, dependency floor `0.121.0`.
