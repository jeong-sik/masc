...
OAS pin metadata is generated from `scripts/oas-agent-sdk-pin.sh`. Current dependency floor: `agent_sdk >= 0.193.9`, runtime pin: `fix/boundary-turn-ownership-current-20260513@aff322f6301f4a9adc128c3b05eff4385e10090e`, declared base version: `v0.193.9`. 최신성 검증이 필요할 때는 문서에 적힌 숫자보다 `dune-project`와 pin script를 우선 truth source로 본다.
