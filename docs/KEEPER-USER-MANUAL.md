...
OAS pin metadata is generated from `scripts/oas-agent-sdk-pin.sh`. Current dependency floor: `agent_sdk >= 0.172.0`, runtime pin: `feat/ollama-cascade-stack-for-masc-pin@b30c506fe254a03ef28c6a57fcdf1672557478ee`, declared base version: `v0.172.0`. 최신성 검증이 필요할 때는 문서에 적힌 숫자보다 `dune-project`와 pin script를 우선 truth source로 본다.
