...
let test_mdal_auditable_tools_do_not_include_lodge_search () =
  ...
  check bool "omits lodge_search" false (List.mem "lodge_search" names)
      ...
      ( "surfaces",
        [
          ...
          test_case "mdal auditable tools stay curated" `Quick
            test_mdal_auditable_tools_do_not_include_lodge_search;
        ] );
    ]
