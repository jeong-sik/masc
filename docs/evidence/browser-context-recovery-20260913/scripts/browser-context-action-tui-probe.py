...
report={'scope':'isolated three-channel website; real live Firefox extension and native host; binary-exported composition with typed TUI default action and input recovery; persistent native TUI','steps':[],'cleanup':[]}
