...
> Snapshot baseline: `dune-project` version `0.19.17`
...
| Executables | 7 public (`masc-mcp`, `masc-mcp-stdio`, `masc-cost`, `masc-compaction-audit`, `masc-tui`, `cdal-label`, `masc-worker-run`) + 2 internal (`public_tool_manifest`, `trace_to_tla`) |
