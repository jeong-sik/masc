...
OAS Pin Snapshot: dependency floor `0.120.0`, runtime pin `main@3a3f7c80460e78aa2ba4ca9335c22774de78629b`, declared base version `v0.120.0`
...
`masc-mcp` keeps the runtime pin ratcheted against upstream `main`, while the dependency floor tracks the pinned SDK declaration in `agent_sdk.opam`. Generated snapshot: runtime pin `main@3a3f7c80460e78aa2ba4ca9335c22774de78629b`, declared base version `v0.120.0`, dependency floor `0.120.0`.
