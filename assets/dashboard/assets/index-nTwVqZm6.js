...
`).map(n=>n.trim()).filter(n=>n!=="")}async function bc(t,e=20){return Qt("masc_task_history",{task_id:t,limit:e})}async function kc(t){const e=await Qt("masc_debate_start",{topic:t});try{return JSON.parse(e)}catch{return null}}async function xc(t){return So("fetchDebateStatus",async()=>{const e=encodeURIComponent(t),n=await X(`/api/v1/council/debates/${e}/summary`);if(!v(n))return null;const s=y(n.id,"").trim();return s?{id:s,topic:y(n.topic,""),status:y(n.status,"open"),support_count:K(n.support_count,0),oppose_count:K(n.oppose_count,0),neutral_count:K(n.neutral_count,0),total_arguments:K(n.total_arguments,0),created_at:rn(n.created_at_iso??n.created_at),summary_text:y(n.summary_text,"")}:null})}function Sc(t,e,n){return Qt("masc_keeper_msg",{name:t,message:e})}const Ac=f(""),Dt=f({}),it=f({}),za=f({}),Ea=f({}),ja=f({}),Oa=f({}),zt=f({});function st(t,e,n){t.value={...t.value,[e]:n}}function Cc(t){var n;const e=(n=r(t))==null?void 0:n.toLowerCase();return e==="user"||e==="assistant"||e==="system"||e==="tool"?e:"other"}function wc(t){switch(t){case"user":return"User";case"assistant":return"Keeper";case"system":return"System";case"tool":return"Tool";default:return"Event"}}function na(t,e){if(!Array.isArray(t))return[];const n=[];for(const s of t){if(!v(s))continue;const a=r(s.name);if(!a)continue;const o=r(s[e]);e==="summary"?n.push({name:a,summary:o}):n.push({name:a,reason:o})}return n}function Tc(t){if(!v(t))return null;const e=r(t.name);return e?{name:e,trigger:r(t.trigger),outcome:r(t.outcome),summary:r(t.summary),reason:r(t.reason)}:null}function Ic(t){const e=t.toLowerCase();return e.includes("graphql")?"graphql_error":e.includes("timeout")||e.includes("model")||e.includes("llm")||e.includes("api key")||e.includes("api_key")||e.includes("provider")?"llm_error":"unknown"}function Rc(t,e){return t==="offline"||t==="degraded"||t==="stale"?"Keeper is not in a healthy reply state. Probe or recover before relying on automation.":e==="quiet_hours"?"Lodge quiet hours are active. Direct messages still work, but scheduled social ticks may look asleep.":e==="min_gap"?"Keeper is inside its proactive cooldown window. Direct messages work now; autonomous check-ins will wait.":e==="never_started"?"Keeper metadata exists but no reply turn has been recorded yet.":"Keeper is reachable. Send a direct message for an immediate response."}function wo(t,e,n){return r(t)??Rc(e,n)}function To(t,e){return typeof t=="boolean"?t:e==="recover"}function _s(t){if(!v(t))return null;const e=r(t.health_state),n=r(t.next_action_path),s=r(t.last_reply_status);return!e||!n||!s?null:{health_state:e,quiet_reason:r(t.quiet_reason)??null,next_action_path:n,last_reply_status:s,last_reply_at:qe(t.last_reply_at)??null,last_reply_preview:r(t.last_reply_preview)??null,last_error:r(t.last_error)??null,next_eligible_at_s:d(t.next_eligible_at_s)??null,recoverable:To(t.recoverable,n),summary:wo(t.summary,e,r(t.quiet_reason)??null),keepalive_running:typeof t.keepalive_running=="boolean"?t.keepalive_running:void 0}}function Io(t){return v(t)?{hour:d(t.hour),checked:d(t.checked)??0,acted:d(t.acted)??0,acted_names:F(t.acted_names),activity_report:r(t.activity_report),quiet_hours_overridden:O(t.quiet_hours_overridden),skipped_reason:r(t.skipped_reason),acted_rows:na(t.acted_rows,"summary").map(e=>({name:e.name,summary:e.summary})),passed_rows:na(t.passed_rows,"reason").map(e=>({name:e.name,reason:e.reason})),skipped_rows:na(t.skipped_rows,"reason").map(e=>({name:e.name,reason:e.reason})),checkins:Array.isArray(t.checkins)?t.checkins.map(Tc).filter(e=>e!==null):[]}:null}function Pc(t){return v(t)?{enabled:O(t.enabled)??!1,interval_s:d(t.interval_s)??0,quiet_start:d(t.quiet_start),quiet_end:d(t.quiet_end),quiet_active:O(t.quiet_active),use_planner:O(t.use_planner),delegate_llm:O(t.delegate_llm),agent_count:d(t.agent_count),agents:F(t.agents),last_tick_ago_s:d(t.last_tick_ago_s)??null,last_tick_ago:r(t.last_tick_ago),total_ticks:d(t.total_ticks),total_checkins:d(t.total_checkins),last_skip_reason:r(t.last_skip_reason)??null,last_tick_result:Io(t.last_tick_result),active_self_heartbeats:F(t.active_self_heartbeats)}:null}function Mc(t){return v(t)?{status:t.status,diagnostic:_s(t.diagnostic)}:null}function Nc(t){return v(t)?{recovered:O(t.recovered)??!1,skipped_reason:r(t.skipped_reason)??null,before:_s(t.before),after:_s(t.after),down:t.down,up:t.up}:null}function Lc(t,e){var A,x;if(!(t!=null&&t.name))return null;const n=r((A=t.agent)==null?void 0:A.status)??r(t.status)??"unknown",s=r((x=t.agent)==null?void 0:x.error)??null,a=t.presence_keepalive??!0,o=t.keepalive_running??!1,l=t.turn_count??0,c=t.last_turn_ago_s??null,p=t.proactive_enabled??!1,m=t.proactive_cooldown_sec??0,u=t.last_proactive_ago_s??null,_=p&&u!=null?Math.max(0,m-u):null,g=l<=0||c==null?"never":c>900?"stale":"fresh",$=typeof t.last_heartbeat=="string"&&t.last_heartbeat.trim()?t.last_heartbeat:null,S=s??(a&&!o?"keeper keepalive is not running":null),k=n==="offline"||n==="inactive"?"offline":S?"degraded":g==="stale"?"stale":g==="never"?"idle":"healthy",w=S?Ic(S):e!=null&&e.quiet_active&&g!=="fresh"?"quiet_hours":a&&!o?"disabled":l<=0?"never_started":_!=null&&_>0?"min_gap":g==="fresh"||g==="stale"?"no_recent_activity":"unknown",C=k==="offline"||k==="degraded"||k==="stale"?"recover":w==="quiet_hours"?"manual_lodge_poke":w==="unknown"?"probe":"direct_message";return{health_state:k,quiet_reason:w,next_action_path:C,last_reply_status:g,last_reply_at:$,last_reply_preview:null,last_error:S,next_eligible_at_s:_!=null&&_>0?_:null,recoverable:To(void 0,C),summary:wo(void 0,k,w),keepalive_running:o}}function Dc(t,e){if(!v(t))return null;const n=Cc(t.role),s=r(t.content)??r(t.preview);if(!s)return null;const a=qe(t.ts_unix)??qe(t.timestamp);return{id:`${n}-${a??"entry"}-${e}`,role:n,label:wc(n),text:s,timestamp:a,delivery:"history"}}function zc(t,e,n){const s=v(n)?n:null,a=Array.isArray(s==null?void 0:s.history_tail)?s.history_tail.map((o,l)=>Dc(o,l)).filter(o=>o!==null):[];return{name:t,diagnostic:_s(s==null?void 0:s.diagnostic),history:a,rawText:e,rawStatus:n,loadedAt:new Date().toISOString()}}function Di(t,e){const n=it.value[t]??[];it.value={...it.value,[t]:[...n,e].slice(-50)}}function Ec(t,e){return t.role!==e.role||t.text!==e.text?!1:t.timestamp&&e.timestamp?t.timestamp===e.timestamp:!0}function jc(t,e){const s=(it.value[t]??[]).filter(a=>a.delivery!=="history"&&!e.some(o=>Ec(a,o)));it.value={...it.value,[t]:[...e,...s].slice(-50)}}function Vs(t,e){Dt.value={...Dt.value,[t]:e},jc(t,e.history)}function zi(t,e){const n=Dt.value[t];if(!n)return;const s=n.diagnostic??{health_state:"idle",next_action_path:"direct_message",last_reply_status:"unknown"};Vs(t,{...n,diagnostic:{...s,...e}})}async function ii(){try{await zn()}catch(t){console.warn("[keeper-runtime] dashboard refresh failed",t)}}function Oc(t){Ac.value=t.trim()}async function Ro(t,e=!1){const n=t.trim();if(!n)return null;if(!e&&Dt.value[n])return Dt.value[n];st(za,n,!0),st(zt,n,null);try{const s=await Qt("masc_keeper_status",{name:n,fast:!1,include_context:!0,include_metrics_overview:!0,include_memory_bank:!1,include_history_tail:!0,include_compaction_history:!1,tail_turns:5,tail_messages:10});let a=null;try{a=JSON.parse(s)}catch{a=null}const o=zc(n,s,a);return Vs(n,o),o}catch(s){const a=s instanceof Error?s.message:`Failed to inspect ${n}`;return st(zt,n,a),null}finally{st(za,n,!1)}}async function qc(t,e){const n=t.trim(),s=e.trim();if(!n||!s)return;const a=`local-${Date.now()}`;Di(n,{id:a,role:"user",label:"You",text:s,timestamp:new Date().toISOString(),delivery:"sending"}),st(Ea,n,!0),st(zt,n,null);try{const o=await Sc(n,s);it.value={...it.value,[n]:(it.value[n]??[]).map(l=>l.id===a?{...l,delivery:"delivered"}:l)},Di(n,{id:`reply-${Date.now()}`,role:"assistant",label:n,text:o.trim()||"(empty reply)",timestamp:new Date().toISOString(),delivery:"delivered"}),zi(n,{last_reply_status:"delivered",last_reply_at:new Date().toISOString(),last_reply_preview:(o.trim()||"(empty reply)").slice(0,200),last_error:null}),await ii()}catch(o){const l=o instanceof Error?o.message:`Failed to send direct message to ${n}`;throw it.value={...it.value,[n]:(it.value[n]??[]).map(c=>c.id===a?{...c,delivery:"error",error:l}:c)},zi(n,{last_reply_status:"error",last_error:l}),st(zt,n,l),o}finally{st(Ea,n,!1)}}async function Fc(t,e){const n=t.trim();if(!n)return null;st(ja,n,!0),st(zt,n,null);try{const s=await Js({actor:e,action_type:"keeper_probe",target_type:"keeper",target_id:n,payload:{}}),a=Mc(s.result),o=(a==null?void 0:a.diagnostic)??null;if(o){const l=Dt.value[n];Vs(n,{name:n,diagnostic:o,history:(l==null?void 0:l.history)??it.value[n]??[],rawText:(l==null?void 0:l.rawText)??"",rawStatus:s.result,loadedAt:new Date().toISOString()})}return await ii(),o}catch(s){const a=s instanceof Error?s.message:`Failed to probe ${n}`;throw st(zt,n,a),s}finally{st(ja,n,!1)}}async function Kc(t,e){const n=t.trim();if(!n)return null;st(Oa,n,!0),st(zt,n,null);try{const s=await Js({actor:e,action_type:"keeper_recover",target_type:"keeper",target_id:n,payload:{}}),a=Nc(s.result),o=(a==null?void 0:a.after)??null;if(o){const l=Dt.value[n];Vs(n,{name:n,diagnostic:o,history:(l==null?void 0:l.history)??it.value[n]??[],rawText:(l==null?void 0:l.rawText)??"",rawStatus:s.result,loadedAt:new Date().toISOString()})}return await ii(),o}catch(s){const a=s instanceof Error?s.message:`Failed to recover ${n}`;throw st(zt,n,a),s}finally{st(Oa,n,!1)}}function se(t){return(t??"").trim().toLowerCase()}function ct(t){const e=typeof t=="number"?t:Date.parse(t);return Number.isNaN(e)?0:e}function as(t,e=88){const n=t.replace(/\s+/g," ").trim();return n&&(n.length>e?`${n.slice(0,e-3)}...`:n)}function Gn(t){return typeof t!="number"||!Number.isFinite(t)||t<0?null:new Date(Date.now()-t*1e3).toISOString()}function tn(t){return t.last_heartbeat??Gn(t.last_turn_ago_s)??Gn(t.last_proactive_ago_s)??Gn(t.last_handoff_ago_s)??Gn(t.last_compaction_ago_s)}function Uc(t){const e=t.title.trim();return e||as(t.content)}function Bc(t){const e=t.generation??"?",n=typeof t.context_ratio=="number"&&Number.isFinite(t.context_ratio)?`${Math.round(t.context_ratio*100)}%`:"?";return t.last_heartbeat?`Heartbeat gen=${e} ctx=${n}`:`Keeper snapshot gen=${e} ctx=${n}`}function Hc(t,e,n,s,a={}){var x;const o=se(t),l=e.filter(I=>se(I.assignee)===o&&(I.status==="claimed"||I.status==="in_progress")).length,c=n.filter(I=>se(I.from)===o).sort((I,P)=>ct(P.timestamp)-ct(I.timestamp))[0],p=s.filter(I=>se(I.agent)===o||se(I.author)===o).sort((I,P)=>ct(P.timestamp)-ct(I.timestamp))[0],m=(a.boardPosts??[]).filter(I=>se(I.author)===o).sort((I,P)=>ct(P.updated_at||P.created_at)-ct(I.updated_at||I.created_at))[0],u=(a.keepers??[]).filter(I=>se(I.name)===o&&tn(I)!==null).sort((I,P)=>ct(tn(P)??0)-ct(tn(I)??0))[0],_=c?ct(c.timestamp):0,g=p?ct(p.timestamp):0,$=m?ct(m.updated_at||m.created_at):0,S=u?ct(tn(u)??0):0,k=a.lastSeen?ct(a.lastSeen):0,w=((x=a.currentTask)==null?void 0:x.trim())||(l>0?`${l} claimed tasks`:null);if(_===0&&g===0&&$===0&&S===0&&k===0)return{activeAssignedCount:l,lastActivityAt:null,lastActivityText:w};const A=[c?{timestamp:c.timestamp,ts:_,text:as(c.content)}:null,m?{timestamp:m.updated_at||m.created_at,ts:$,text:`Post: ${as(Uc(m))}`}:null,u?{timestamp:tn(u),ts:S,text:Bc(u)}:null,p?{timestamp:new Date(p.timestamp).toISOString(),ts:g,text:as(p.text)}:null].filter(I=>I!==null).sort((I,P)=>P.ts-I.ts)[0];return A&&A.ts>=k?{activeAssignedCount:l,lastActivityAt:A.timestamp,lastActivityText:A.text}:{activeAssignedCount:l,lastActivityAt:a.lastSeen??null,lastActivityText:w??"Presence heartbeat"}}const bt=f([]),It=f([]),Fe=f([]),Et=f([]),ft=f(null),Wc=f(null),qa=f(new Map),$n=f([]),hn=f("recent"),Se=f(!0),Po=f(null),Lt=f(""),Re=f([]),ln=f(!1),Mo=f(new Map),oi=f("unknown"),Pe=f(null),Fa=f(!1),yn=f(!1),Ka=f(!1),cn=f(!1),ri=f(null),fs=f(!1),gs=f(null),No=f(null),Ua=f(null),Gc=f(null),Jc=f(null),Vc=f(null);yt(()=>bt.value.filter(t=>t.status==="active"||t.status==="busy"||t.status==="listening"||t.status==="idle"));const Lo=yt(()=>{const t=It.value;return{todo:t.filter(e=>e.status==="todo"),inProgress:t.filter(e=>e.status==="in_progress"||e.status==="claimed"),done:t.filter(e=>e.status==="done")}}),li=yt(()=>{const t=new Map,e=It.value,n=Fe.value,s=vs.value,a=$n.value,o=Et.value;for(const l of bt.value)t.set(l.name.trim().toLowerCase(),Hc(l.name,e,n,s,{currentTask:l.current_task,lastSeen:l.last_seen,boardPosts:a,keepers:o}));return t});function Yc(t){var o;const e=((o=t.status)==null?void 0:o.toLowerCase())??"";if(e==="offline"||e==="inactive")return"offline";const n=t.metrics_series;if(!n||n.length===0)return"idle";const s=n[n.length-1];if(!s)return"idle";if(s.is_handoff)return"handoff-imminent";if(s.is_compaction)return"compacting";const a=s.context_ratio;return a>.85?"handoff-imminent":a>.7?"preparing":a>.5?"compacting":"active"}const Qc=yt(()=>{const t=new Map;for(const e of Et.value)t.set(e.name,Yc(e));return t}),Xc=12e4;function Zc(t,e){const n=e.get(t.name);if(n!=null)return n;const s=t.last_heartbeat?Date.parse(t.last_heartbeat):Number.NaN;if(!Number.isNaN(s))return s;const a=[t.last_turn_ago_s,t.last_proactive_ago_s,t.last_handoff_ago_s,t.last_compaction_ago_s].find(o=>typeof o=="number"&&Number.isFinite(o)&&o>=0);return typeof a=="number"?Date.now()-a*1e3:null}const td=yt(()=>{const t=Date.now(),e=new Set,n=qa.value;for(const s of Et.value){const a=Zc(s,n);a!=null&&t-a>Xc&&e.add(s.name)}return e});function ed(t){return t==="dashboard_refresh"||t==="masc/dashboard_refresh"||t.startsWith("goal_")||t.startsWith("masc/goal_")||t.startsWith("mdal_")||t.startsWith("masc/mdal_")||t.startsWith("operator_")||t.startsWith("masc/operator_")||t.startsWith("command_plane_")||t.startsWith("masc/command_plane_")}function Do(t){const e=typeof t=="string"?t.toLowerCase():"";return e==="active"||e==="busy"||e==="listening"||e==="idle"||e==="inactive"||e==="offline"?e:e==="in_progress"||e==="claimed"?"busy":"offline"}function nd(t){const e=typeof t=="string"?t.toLowerCase():"";return e==="todo"||e==="in_progress"||e==="claimed"||e==="done"||e==="cancelled"?e:e==="inprogress"?"in_progress":"todo"}function sd(t){if(!v(t))return null;const e=r(t.name);return e?{name:e,agent_type:r(t.agent_type),status:Do(t.status),current_task:r(t.current_task)??null,joined_at:r(t.joined_at),last_seen:r(t.last_seen),capabilities:F(t.capabilities),emoji:r(t.emoji),koreanName:r(t.koreanName)??r(t.korean_name),model:r(t.model),traits:F(t.traits),interests:F(t.interests),activityLevel:d(t.activityLevel)??d(t.activity_level),primaryValue:r(t.primaryValue)??r(t.primary_value)}:null}function ad(t){if(!v(t))return null;const e=r(t.id),n=r(t.title);return!e||!n?null:{id:e,title:n,status:nd(t.status),priority:d(t.priority),assignee:r(t.assignee),description:r(t.description),created_at:r(t.created_at),updated_at:r(t.updated_at)}}function id(t){if(!v(t))return null;const e=r(t.from)??r(t.from_agent)??"system",n=r(t.content)??"",s=r(t.timestamp)??new Date().toISOString();return{id:r(t.id),seq:d(t.seq),from:e,content:n,timestamp:s,type:r(t.type)}}function Ei(t){if(typeof t.seq=="number"&&Number.isFinite(t.seq))return t.seq;const e=Date.parse(t.timestamp);return Number.isNaN(e)?0:e}function od(t,e){if(e.length===0)return t;const n=new Map;for(const s of t){const a=typeof s.seq=="number"?`seq:${s.seq}`:`ts:${s.timestamp}|from:${s.from}|content:${s.content}`;n.set(a,s)}for(const s of e){const a=typeof s.seq=="number"?`seq:${s.seq}`:`ts:${s.timestamp}|from:${s.from}|content:${s.content}`;n.set(a,s)}return[...n.values()].sort((s,a)=>Ei(s)-Ei(a)).slice(-500)}function rd(t){return Array.isArray(t)?t.map(e=>{if(!v(e))return null;const n=d(e.ts_unix);if(n==null)return null;const s=v(e.handoff)?e.handoff:null;return{ts:n,context_ratio:d(e.context_ratio)??0,context_tokens:d(e.context_tokens)??0,context_max:d(e.context_max)??0,latency_ms:d(e.latency_ms)??0,generation:d(e.generation)??0,channel:typeof e.channel=="string"?e.channel:"turn",is_handoff:s!=null&&e.handoff_performed===!0,is_compaction:e.compacted===!0,compaction_saved_tokens:d(e.compaction_saved_tokens)??0,compaction_trigger:typeof e.compaction_trigger=="string"?e.compaction_trigger:null,model_used:typeof e.model_used=="string"?e.model_used:"",cost_usd:d(e.cost_usd)??0,handoff_to_model:s&&typeof s.to_model=="string"?s.to_model:null,handoff_new_generation:s?d(s.new_generation)??null:null}}).filter(e=>e!==null):[]}function ji(t){if(!v(t))return null;const e=r(t.health_state),n=r(t.next_action_path),s=r(t.last_reply_status);if(!e||!n||!s)return null;const a=r(t.quiet_reason)??null,o=r(t.summary)??(e==="offline"||e==="degraded"||e==="stale"?"Keeper is not in a healthy reply state. Probe or recover before relying on automation.":a==="quiet_hours"?"Lodge quiet hours are active. Direct messages still work, but scheduled social ticks may look asleep.":a==="min_gap"?"Keeper is inside its proactive cooldown window. Direct messages work now; autonomous check-ins will wait.":a==="never_started"?"Keeper metadata exists but no reply turn has been recorded yet.":"Keeper is reachable. Send a direct message for an immediate response.");return{health_state:e,quiet_reason:a,next_action_path:n,last_reply_status:s,last_reply_at:qe(t.last_reply_at)??r(t.last_reply_at)??null,last_reply_preview:r(t.last_reply_preview)??null,last_error:r(t.last_error)??null,next_eligible_at_s:d(t.next_eligible_at_s)??null,recoverable:typeof t.recoverable=="boolean"?t.recoverable:n==="recover",summary:o,keepalive_running:typeof t.keepalive_running=="boolean"?t.keepalive_running:void 0}}function ld(t,e){return(Array.isArray(t)?t:v(t)&&Array.isArray(t.keepers)?t.keepers:[]).map(s=>{if(!v(s))return null;const a=v(s.agent)?s.agent:null,o=v(s.context)?s.context:null,l=v(s.metrics_window)?s.metrics_window:void 0,c=r(s.name);if(!c)return null;const p=d(s.context_ratio)??d(o==null?void 0:o.context_ratio),m=r(s.status)??r(a==null?void 0:a.status)??"offline",u=Do(m),_=r(s.model)??r(s.active_model)??r(s.primary_model),g=F(s.skill_secondary),$=o?{source:r(o.source),context_ratio:d(o.context_ratio),context_tokens:d(o.context_tokens),context_max:d(o.context_max),message_count:d(o.message_count),has_checkpoint:typeof o.has_checkpoint=="boolean"?o.has_checkpoint:void 0}:void 0,S=a?{name:r(a.name),exists:typeof a.exists=="boolean"?a.exists:void 0,error:r(a.error),agent_type:r(a.agent_type),status:r(a.status),current_task:r(a.current_task)??null,joined_at:r(a.joined_at),last_seen:r(a.last_seen),last_seen_ago_s:d(a.last_seen_ago_s),capabilities:F(a.capabilities),is_zombie:typeof a.is_zombie=="boolean"?a.is_zombie:void 0}:void 0,k=rd(s.metrics_series),w={name:c,emoji:r(s.emoji),koreanName:r(s.koreanName)??r(s.korean_name),agent_name:r(s.agent_name),trace_id:r(s.trace_id),model:_,primary_model:r(s.primary_model),active_model:r(s.active_model),next_model_hint:r(s.next_model_hint)??null,status:u,presence_keepalive:typeof s.presence_keepalive=="boolean"?s.presence_keepalive:void 0,presence_keepalive_sec:d(s.presence_keepalive_sec),keepalive_running:typeof s.keepalive_running=="boolean"?s.keepalive_running:void 0,proactive_enabled:typeof s.proactive_enabled=="boolean"?s.proactive_enabled:void 0,proactive_idle_sec:d(s.proactive_idle_sec),proactive_cooldown_sec:d(s.proactive_cooldown_sec),last_heartbeat:r(s.last_heartbeat)??r(a==null?void 0:a.last_seen),generation:d(s.generation),turn_count:d(s.turn_count)??d(s.total_turns),keeper_age_s:d(s.keeper_age_s),last_turn_ago_s:d(s.last_turn_ago_s),last_handoff_ago_s:d(s.last_handoff_ago_s),last_compaction_ago_s:d(s.last_compaction_ago_s),last_proactive_ago_s:d(s.last_proactive_ago_s),last_proactive_preview:r(s.last_proactive_preview)??null,context_ratio:p,context_tokens:d(s.context_tokens)??d(o==null?void 0:o.context_tokens),context_max:d(s.context_max)??d(o==null?void 0:o.context_max),context_source:r(s.context_source)??r(o==null?void 0:o.source),context:$,traits:F(s.traits),interests:F(s.interests),primaryValue:r(s.primaryValue)??r(s.primary_value),activityLevel:d(s.activityLevel)??d(s.activity_level),memory_recent_note:r(s.memory_recent_note)??null,recent_input_preview:r(s.recent_input_preview)??null,recent_output_preview:r(s.recent_output_preview)??null,recent_tool_names:F(s.recent_tool_names)??[],conversation_tail_count:d(s.conversation_tail_count),k2k_count:d(s.k2k_count),handoff_count_total:d(s.handoff_count_total)??d(s.trace_history_count),compaction_count:d(s.compaction_count),last_compaction_saved_tokens:d(s.last_compaction_saved_tokens),diagnostic:ji(s.diagnostic),skill_primary:r(s.skill_primary)??null,skill_secondary:g,skill_reason:r(s.skill_reason)??null,metrics_series:k.length>0?k:void 0,metrics_window:l,agent:S};return w.diagnostic=ji(s.diagnostic)??Lc(w,(e==null?void 0:e.lodge)??null),w}).filter(s=>s!==null)}function zo(t){return v(t)?{...t,lodge:Pc(t.lodge)??void 0}:null}function cd(t){const e=typeof t=="string"?t.toLowerCase():"";return e==="running"||e==="interrupted"||e==="completed"||e==="stopped"||e==="error"?e:e.startsWith("error")?"error":"running"}function dd(t){if(!v(t))return null;const e=d(t.iteration);if(e==null)return null;const n=d(t.metric_before)??0,s=d(t.metric_after)??n,a=v(t.evidence)?t.evidence:null;return{iteration:e,metric_before:n,metric_after:s,delta:d(t.delta)??s-n,changes:r(t.changes)??"",failed_attempts:r(t.failed_attempts)??"",next_suggestion:r(t.next_suggestion)??"",elapsed_ms:d(t.elapsed_ms)??0,cost_usd:d(t.cost_usd)??null,evidence:a?{worker_engine:(a.worker_engine==="api_tool_loop","api_tool_loop"),worker_model:r(a.worker_model)??"",tool_call_count:d(a.tool_call_count)??0,tool_names:F(a.tool_names)??[],session_id:r(a.session_id)??"",evidence_status:a.evidence_status==="legacy_unverified"?"legacy_unverified":"verified"}:null}}function ud(t){var o,l;if(!v(t))return null;const e=r(t.loop_id);if(!e)return null;const n=d(t.baseline_metric)??0,s=Array.isArray(t.history)?t.history.map(dd).filter(c=>c!==null):[],a=d(t.current_metric)??((o=s[0])==null?void 0:o.metric_after)??n;return{loop_id:e,profile:r(t.profile)??"unknown",status:cd(t.status),strict_mode:typeof t.strict_mode=="boolean"?t.strict_mode:void 0,error_message:r(t.error_message)??r(t.error_reason)??null,stop_reason:r(t.stop_reason)??r(t.reason)??null,current_iteration:d(t.current_iteration)??((l=s[0])==null?void 0:l.iteration)??0,max_iterations:d(t.max_iterations)??0,baseline_metric:n,current_metric:a,target:r(t.target)??"",stagnation_streak:d(t.stagnation_streak)??0,stagnation_limit:d(t.stagnation_limit)??0,elapsed_seconds:d(t.elapsed_seconds)??0,updated_at:qe(t.updated_at)??null,stopped_at:qe(t.stopped_at)??null,execution_mode:t.execution_mode==="worker_spawn"?"worker_spawn":void 0,worker_engine:t.worker_engine==="api_tool_loop"?"api_tool_loop":null,worker_model:r(t.worker_model)??null,evidence_policy:t.evidence_policy==="hard"||t.evidence_policy==="legacy"?t.evidence_policy:void 0,latest_tool_call_count:d(t.latest_tool_call_count)??0,latest_tool_names:F(t.latest_tool_names)??[],session_id:r(t.session_id)??null,evidence_status:t.evidence_status==="legacy_unverified"?"legacy_unverified":t.evidence_status==="verified"?"verified":null,durability:t.durability==="persistent_backend"||t.durability==="memory_only"?t.durability:void 0,persistence_backend:t.persistence_backend==="filesystem"||t.persistence_backend==="postgres"||t.persistence_backend==="memory"?t.persistence_backend:void 0,recoverable:typeof t.recoverable=="boolean"?t.recoverable:void 0,history:s}}async function zn(){Fa.value=!0;try{await Promise.all([jo(),re()]),No.value=new Date().toISOString()}catch(t){console.error("Dashboard refresh error:",t)}finally{Fa.value=!1}}async function Eo(){fs.value=!0,gs.value=null;try{const t=await Pl();ri.value=t,Vc.value=new Date().toISOString()}catch(t){gs.value=t instanceof Error?t.message:"Failed to load dashboard semantics"}finally{fs.value=!1}}function pd(t){var e;return((e=ri.value)==null?void 0:e.surfaces.find(n=>n.id===t))??null}function md(t){var n;const e=((n=ri.value)==null?void 0:n.surfaces)??[];for(const s of e){const a=s.panels.find(o=>o.id===t);if(a)return a}return null}function vd(t){var s,a;Re.value=(Array.isArray(t.goals)?t.goals:[]).map(o=>{if(!v(o))return null;const l=r(o.id),c=r(o.title),p=r(o.horizon),m=r(o.status),u=r(o.created_at),_=r(o.updated_at);return!l||!c||!p||!m||!u||!_?null:{id:l,horizon:p,title:c,metric:r(o.metric)??null,target_value:r(o.target_value)??null,due_date:r(o.due_date)??null,priority:d(o.priority)??3,status:m,parent_goal_id:r(o.parent_goal_id)??null,last_review_note:r(o.last_review_note)??null,last_review_at:r(o.last_review_at)??null,created_at:u,updated_at:_}}).filter(o=>o!==null);const e=new Map,n=Array.isArray((s=t.mdal)==null?void 0:s.loops)?t.mdal.loops:[];for(const o of n){const l=ud(o);l&&e.set(l.loop_id,l)}Mo.value=e,Pe.value=typeof((a=t.mdal)==null?void 0:a.error)=="string"?t.mdal.error:null,oi.value=Pe.value?"error":e.size===0?"idle":"ready"}async function jo(){try{const t=await wl(),e=zo(t.status);e&&(ft.value=e)}catch(t){console.error("Dashboard shell fetch error:",t)}}async function re(){var t;try{const e=await Tl(),n=zo(e.status),s=(t=ft.value)==null?void 0:t.room;n&&(ft.value=n);const a=s!=null&&(n==null?void 0:n.room)!=null&&s!==n.room;bt.value=(Array.isArray(e.agents)?e.agents:[]).map(sd).filter(l=>l!==null),It.value=(Array.isArray(e.tasks)?e.tasks:[]).map(ad).filter(l=>l!==null);const o=(Array.isArray(e.messages)?e.messages:[]).map(id).filter(l=>l!==null);Fe.value=a?o:od(Fe.value,o),Et.value=ld(e.keepers,n??ft.value),Wc.value=null,No.value=new Date().toISOString()}catch(e){console.error("Dashboard execution fetch error:",e)}}async function Ht(){yn.value=!0;try{const t=await Il(hn.value,{excludeSystem:Se.value});$n.value=t.posts??[],Ua.value=new Date().toISOString()}catch(t){console.error("Board fetch error:",t)}finally{yn.value=!1}}async function Wt(){var t;Ka.value=!0;try{const e=Lt.value||((t=ft.value)==null?void 0:t.room)||"default";Lt.value||(Lt.value=e);const n=await dc(e);Po.value=n}catch(e){console.error("TRPG fetch error:",e)}finally{Ka.value=!1}}async function ci(){ln.value=!0,cn.value=!0;try{const t=await Ll();vd(t),Gc.value=new Date().toISOString(),Jc.value=new Date().toISOString()}catch(t){console.error("Planning fetch error:",t),oi.value="error",Pe.value=t instanceof Error?t.message:String(t)}finally{ln.value=!1,cn.value=!1}}async function Oo(){return ci()}let is=null;function _d(t){is=t}let os=null;function fd(t){os=t}let rs=null;function gd(t){rs=t}const le={};let sa=null;function ae(t,e,n=500){le[t]&&clearTimeout(le[t]),le[t]=setTimeout(()=>{e(),delete le[t]},n)}function $d(){const t=$o.subscribe(e=>{if(e){if(e.type==="keeper_heartbeat"&&e.name){const n=new Map(qa.value);n.set(e.name,e.ts_unix?e.ts_unix*1e3:Date.now()),qa.value=n;return}(e.type==="agent_joined"||e.type==="agent_left")&&ae("execution",re),ed(e.type)&&(sa||(sa=setTimeout(()=>{zn(),os==null||os(),rs==null||rs(),sa=null},500))),(e.type.startsWith("task_")||e.type.startsWith("masc/task_"))&&ae("execution",re),e.type==="broadcast"&&ae("execution",re),(e.type==="keeper_handoff"||e.type==="keeper_compaction"||e.type==="keeper_guardrail")&&ae("execution",re),(e.type==="board_post"||e.type==="masc/board_post"||e.type==="board_comment"||e.type==="masc/board_comment")&&ae("board",Ht),e.type.startsWith("decision_")&&ae("council",()=>is==null?void 0:is()),(e.type==="mdal_started"||e.type==="mdal_iteration"||e.type==="mdal_completed"||e.type==="mdal_stopped")&&ae("mdal",Oo,350)}});return()=>{t();for(const e of Object.keys(le))clearTimeout(le[e]),delete le[e]}}let dn=null;function hd(){dn||(dn=setInterval(()=>{Vt.value,zn()},1e4))}function yd(){dn&&(clearInterval(dn),dn=null)}function bd({metric:t}){return i`
  ...
  `}function N({panelId:t,compact:e=!1,label:n="Why"}){const s=md(t);return s?i`
  ...
  `}function di(t){const e=t.indexOf("-");if(e<0)return{model:t,nickname:t,isKeeper:t==="keeper"};const n=t.slice(0,e),s=t.slice(e+1);return{model:n,nickname:s,isKeeper:n==="keeper"}}function xd(t){return t==="keeper"||t.startsWith("keeper-")}const ui=f(null),Ba=f(!1),$s=f(null),qo=f(null),Ae=f(!1),oe=f(null);let Me=null;function Oi(){Me!==null&&(window.clearTimeout(Me),Me=null)}function Sd(t=1500){Me===null&&(Me=window.setTimeout(()=>{Me=null,hs(!1)},t))}function z(t){return typeof t=="object"&&t!==null&&!Array.isArray(t)}function h(t){return typeof t=="string"&&t.trim()!==""?t:void 0}function L(t){return typeof t=="number"&&Number.isFinite(t)?t:void 0}function Ne(t){return typeof t=="boolean"?t:void 0}function W(t,e=[]){if(Array.isArray(t))return t;if(!z(t))return[];for(const n of e){const s=t[n];if(Array.isArray(s))return s}return[]}function Je(t){if(!z(t))return null;const e=h(t.kind),n=h(t.summary),s=h(t.target_type);return!e||!n||!s?null:{kind:e,severity:h(t.severity)??"warn",summary:n,target_type:s,target_id:h(t.target_id)??null,actor:h(t.actor)??null,evidence:t.evidence}}function ve(t){if(!z(t))return null;const e=h(t.action_type),n=h(t.target_type),s=h(t.reason);return!e||!n||!s?null:{action_type:e,target_type:n,target_id:h(t.target_id)??null,severity:h(t.severity)??"warn",reason:s,confirm_required:Ne(t.confirm_required),suggested_payload:t.suggested_payload,preview:t.preview}}function Ad(t){if(!z(t))return null;const e=h(t.session_id);return e?{session_id:e,goal:h(t.goal),status:h(t.status),health:h(t.health),scale_profile:h(t.scale_profile),control_profile:h(t.control_profile),planned_worker_count:L(t.planned_worker_count),active_agent_count:L(t.active_agent_count),last_turn_age_sec:L(t.last_turn_age_sec)??null,attention_count:L(t.attention_count),recommended_action_count:L(t.recommended_action_count),top_attention:Je(t.top_attention),top_recommendation:ve(t.top_recommendation)}:null}function Cd(t){if(!z(t))return null;const e=h(t.session_id);if(!e)return null;const n=z(t.status)?t.status:t,s=z(n.summary)?n.summary:void 0;return{session_id:e,status:h(t.status)??h(s==null?void 0:s.status)??(z(n.session)?h(n.session.status):void 0),progress_pct:L(t.progress_pct)??L(s==null?void 0:s.progress_pct),elapsed_sec:L(t.elapsed_sec)??L(s==null?void 0:s.elapsed_sec),remaining_sec:L(t.remaining_sec)??L(s==null?void 0:s.remaining_sec),done_delta_total:L(t.done_delta_total)??L(s==null?void 0:s.done_delta_total),summary:z(t.summary)?t.summary:s,team_health:z(t.team_health)?t.team_health:z(n.team_health)?n.team_health:void 0,communication_metrics:z(t.communication_metrics)?t.communication_metrics:z(n.communication_metrics)?n.communication_metrics:void 0,orchestration_state:z(t.orchestration_state)?t.orchestration_state:z(n.orchestration_state)?n.orchestration_state:void 0,cascade_metrics:z(t.cascade_metrics)?t.cascade_metrics:z(n.cascade_metrics)?n.cascade_metrics:void 0,report_paths:z(t.report_paths)?Object.fromEntries(Object.entries(t.report_paths).map(([a,o])=>{const l=h(o);return l?[a,l]:null}).filter(a=>a!==null)):z(n.report_paths)?Object.fromEntries(Object.entries(n.report_paths).map(([a,o])=>{const l=h(o);return l?[a,l]:null}).filter(a=>a!==null)):void 0,session:z(t.session)?t.session:z(n.session)?n.session:void 0,recent_events:W(t.recent_events,["events"]).filter(z)}}function wd(t){if(!z(t))return null;const e=h(t.name);return e?{name:e,agent_name:h(t.agent_name),status:h(t.status),autonomy_level:h(t.autonomy_level),context_ratio:L(t.context_ratio),generation:L(t.generation),active_goal_ids:W(t.active_goal_ids).map(n=>typeof n=="string"?n.trim():"").filter(Boolean),last_autonomous_action_at:h(t.last_autonomous_action_at)??null,last_turn_ago_s:L(t.last_turn_ago_s),model:h(t.model)}:null}function Td(t){if(!z(t))return null;const e=h(t.confirm_token)??h(t.token);return e?{confirm_token:e,actor:h(t.actor),action_type:h(t.action_type),target_type:h(t.target_type),target_id:h(t.target_id)??null,delegated_tool:h(t.delegated_tool),created_at:h(t.created_at),preview:t.preview}:null}function Id(t){if(!z(t))return null;const e=h(t.action_type),n=h(t.target_type);return!e||!n?null:{action_type:e,target_type:n,description:h(t.description),confirm_required:Ne(t.confirm_required)}}function Rd(t){const e=z(t)?t:{};return{room_health:h(e.room_health),cluster:h(e.cluster),project:h(e.project),current_room:h(e.current_room)??null,paused:Ne(e.paused),tempo_interval_s:L(e.tempo_interval_s),active_agents:L(e.active_agents),keeper_pressure:L(e.keeper_pressure),active_operations:L(e.active_operations),pending_approvals:L(e.pending_approvals),incident_count:L(e.incident_count),recommended_action_count:L(e.recommended_action_count),top_attention:Je(e.top_attention),top_action:ve(e.top_action)}}function Pd(t){const e=z(t)?t:{},n=z(e.swarm_overview)?e.swarm_overview:{};return{health:h(e.health),active_operations:L(e.active_operations),pending_approvals:L(e.pending_approvals),swarm_overview:{active_lanes:L(n.active_lanes),moving_lanes:L(n.moving_lanes),stalled_lanes:L(n.stalled_lanes),projected_lanes:L(n.projected_lanes),last_movement_at:h(n.last_movement_at)??null},top_attention:Je(e.top_attention),top_action:ve(e.top_action),session_cards:W(e.session_cards).map(Ad).filter(s=>s!==null)}}function Md(t){const e=z(t)?t:{};return{sessions:W(e.sessions,["items"]).map(Cd).filter(n=>n!==null),keepers:W(e.keepers,["items"]).map(wd).filter(n=>n!==null),pending_confirms:W(e.pending_confirms).map(Td).filter(n=>n!==null),available_actions:W(e.available_actions).map(Id).filter(n=>n!==null)}}function Nd(t){if(!z(t))return null;const e=h(t.id),n=h(t.kind),s=h(t.summary),a=h(t.target_type);return!e||!n||!s||!a?null:{id:e,kind:n,severity:h(t.severity)??"warn",summary:s,target_type:a,target_id:h(t.target_id)??null,top_action:ve(t.top_action),related_session_ids:W(t.related_session_ids).map(o=>typeof o=="string"?o.trim():"").filter(Boolean),related_agent_names:W(t.related_agent_names).map(o=>typeof o=="string"?o.trim():"").filter(Boolean),evidence_preview:W(t.evidence_preview).map(o=>typeof o=="string"?o.trim():"").filter(Boolean),last_seen_at:h(t.last_seen_at)??null}}function Ld(t){if(!z(t))return null;const e=h(t.session_id),n=h(t.goal);return!e||!n?null:{session_id:e,goal:n,room:h(t.room)??null,status:h(t.status),health:h(t.health),member_names:W(t.member_names).map(s=>typeof s=="string"?s.trim():"").filter(Boolean),started_at:h(t.started_at)??null,elapsed_sec:L(t.elapsed_sec)??null,last_event_at:h(t.last_event_at)??null,last_event_summary:h(t.last_event_summary)??null,communication_summary:h(t.communication_summary)??null,active_count:L(t.active_count),required_count:L(t.required_count),related_attention_count:L(t.related_attention_count)??0,top_attention:Je(t.top_attention),top_recommendation:ve(t.top_recommendation)}}function Dd(t){if(!z(t))return null;const e=h(t.agent_name);return e?{agent_name:e,status:h(t.status),where:h(t.where)??null,with_whom:W(t.with_whom).map(n=>typeof n=="string"?n.trim():"").filter(Boolean),current_work:h(t.current_work)??null,related_session_id:h(t.related_session_id)??null,related_attention_count:L(t.related_attention_count)??0,recent_output_preview:h(t.recent_output_preview)??null,recent_input_preview:h(t.recent_input_preview)??null,recent_event:h(t.recent_event)??null,recent_tool_names:W(t.recent_tool_names).map(n=>typeof n=="string"?n.trim():"").filter(Boolean)}:null}function zd(t){if(!z(t))return null;const e=h(t.name);return e?{name:e,agent_name:h(t.agent_name)??null,status:h(t.status),generation:L(t.generation),context_ratio:L(t.context_ratio)??null,last_turn_ago_s:L(t.last_turn_ago_s)??null,current_work:h(t.current_work)??null,last_autonomous_action_at:h(t.last_autonomous_action_at)??null}:null}function Ed(t){if(!z(t))return null;const e=h(t.id),n=h(t.signal_type),s=h(t.summary),a=h(t.target_type);return!e||!n||!s||!a?null:{id:e,signal_type:n==="action"?"action":"attention",severity:h(t.severity)??"warn",summary:s,target_type:a,target_id:h(t.target_id)??null,attention:Je(t.attention),action:ve(t.action)}}function jd(t){const e=z(t)?t:{};return{generated_at:h(e.generated_at),summary:Rd(e.summary),incidents:W(e.incidents).map(Je).filter(n=>n!==null),recommended_actions:W(e.recommended_actions).map(ve).filter(n=>n!==null),command_focus:Pd(e.command_focus),operator_targets:Md(e.operator_targets),attention_queue:W(e.attention_queue).map(Nd).filter(n=>n!==null),session_briefs:W(e.session_briefs).map(Ld).filter(n=>n!==null),agent_briefs:W(e.agent_briefs).map(Dd).filter(n=>n!==null),keeper_briefs:W(e.keeper_briefs).map(zd).filter(n=>n!==null),internal_signals:W(e.internal_signals).map(Ed).filter(n=>n!==null)}}function Od(t){if(!z(t))return null;const e=h(t.id),n=h(t.label),s=h(t.summary);if(!e||!n||!s)return null;const a=h(t.status)??"unclear";return{id:e,label:n,status:a==="ok"||a==="healthy"||a==="aligned"||a==="watch"||a==="risk"||a==="unclear"?a:"unclear",summary:s,signal_class:h(t.signal_class)==="metadata_gap"||h(t.signal_class)==="mixed"||h(t.signal_class)==="operational_risk"?h(t.signal_class):void 0,evidence_quality:h(t.evidence_quality)==="strong"||h(t.evidence_quality)==="partial"||h(t.evidence_quality)==="missing"?h(t.evidence_quality):void 0,evidence:W(t.evidence).map(l=>typeof l=="string"?l.trim():"").filter(Boolean)}}function qd(t){if(!z(t))return null;const e=h(t.kind),n=h(t.summary),s=h(t.scope_type),a=h(t.severity);return!e||!n||!s||!a||s!=="session"&&s!=="keeper"&&s!=="agent"||a!=="info"&&a!=="watch"?null:{kind:e,summary:n,scope_type:s,scope_id:h(t.scope_id)??null,severity:a}}function Fd(t){const e=z(t)?t:{},n=z(e.basis)?e.basis:{},s=h(e.status)??"error",a=s==="ok"||s==="pending"||s==="unavailable"||s==="error"?s:"error";return{generated_at:h(e.generated_at),cached:Ne(e.cached),stale:Ne(e.stale),refreshing:Ne(e.refreshing),status:a,summary:h(e.summary)??null,model:h(e.model)??null,ttl_sec:L(e.ttl_sec),criteria:W(e.criteria).map(o=>typeof o=="string"?o.trim():"").filter(Boolean),basis:{current_room:h(n.current_room)??null,crew_count:L(n.crew_count),agent_count:L(n.agent_count),keeper_count:L(n.keeper_count)},metadata_gap_count:L(e.metadata_gap_count),metadata_gaps:W(e.metadata_gaps).map(qd).filter(o=>o!==null),sections:W(e.sections).map(Od).filter(o=>o!==null),error:h(e.error)??null,last_error:h(e.last_error)??null}}async function Fo(){Ba.value=!0,$s.value=null;try{const t=await Ml();ui.value=jd(t)}catch(t){$s.value=t instanceof Error?t.message:"Failed to load mission snapshot"}finally{Ba.value=!1}}async function hs(t=!1){Ae.value=!0,oe.value=null;try{const e=await Nl(t),n=Fd(e);qo.value=n,n.refreshing||n.status==="pending"?Sd():Oi()}catch(e){oe.value=e instanceof Error?e.message:"Failed to load mission briefing",Oi()}finally{Ae.value=!1}}const ys="masc_dashboard_workflow_context",Kd=900*1e3;function ht(t){return typeof t=="string"&&t.trim()!==""?t.trim():null}function Ot(t){const e=ht(t);return e||(typeof t=="number"&&Number.isFinite(t)?String(t):null)}function Ko(){if(typeof window>"u")return null;try{return window.sessionStorage}catch{return null}}function Ha(t){return v(t)?t:null}function Ud(t){if(!t)return null;try{return JSON.stringify(t)}catch{return null}}function Bd(t){if(!t)return null;try{const e=JSON.parse(t);if(!v(e))return null;const n=ht(e.id),s=ht(e.source_surface),a=ht(e.source_label),o=ht(e.summary),l=ht(e.created_at);return!n||s!=="mission"||!a||!o||!l?null:{id:n,source_surface:"mission",source_label:a,action_type:ht(e.action_type),target_type:ht(e.target_type),target_id:ht(e.target_id),focus_kind:ht(e.focus_kind),summary:o,payload_preview:ht(e.payload_preview),suggested_payload:Ha(e.suggested_payload),preview:e.preview??null,evidence:e.evidence??null,created_at:l}}catch{return null}}function pi(t){const e=Date.parse(t.created_at);return Number.isNaN(e)?!1:Date.now()-e<=Kd}function Hd(){const t=Ko(),e=Bd((t==null?void 0:t.getItem(ys))??null);return e?pi(e)?e:(t==null||t.removeItem(ys),null):null}const Uo=f(Hd());function Wd(t){const e=t&&pi(t)?t:null;Uo.value=e;const n=Ko();if(!n)return;if(!e){n.removeItem(ys);return}const s=Ud(e);s&&n.setItem(ys,s)}function Gd(t){if(!t)return null;const e=Ha(t.suggested_payload);if(e)return e;if(v(t.preview)){const n=Ha(t.preview.payload);if(n)return n}return null}function Jd(t){if(!t)return null;const e=Ot(t.message);if(e)return e;const n=Ot(t.task_title)??Ot(t.title),s=Ot(t.task_description)??Ot(t.description),a=Ot(t.reason),o=Ot(t.priority)??Ot(t.task_priority);return n&&s?`${n} · ${s}`:n&&o?`${n} · P${o}`:n||s||a||null}function Bo(t,e,n,s,a,o){return["mission",t,e??"action",n??"target",s??"room",a??"focus",o].join(":")}function Ve(t,e,n="상황판 추천 액션"){const s=new Date().toISOString(),a=Gd(t),o=(t==null?void 0:t.target_type)??(e==null?void 0:e.target_type)??null,l=(t==null?void 0:t.target_id)??(e==null?void 0:e.target_id)??null,c=(e==null?void 0:e.kind)??(t==null?void 0:t.action_type)??null,p=(t==null?void 0:t.reason)??(e==null?void 0:e.summary)??n;return{id:Bo(n,(t==null?void 0:t.action_type)??null,o,l,c,s),source_surface:"mission",source_label:n,action_type:(t==null?void 0:t.action_type)??null,target_type:o,target_id:l,focus_kind:c,summary:p,payload_preview:Jd(a),suggested_payload:a,preview:(t==null?void 0:t.preview)??null,evidence:(e==null?void 0:e.evidence)??null,created_at:s}}function Vd(t,e){return e.source==="mission"&&(e.action_type??null)===(t.action_type??null)&&(e.target_type??null)===(t.target_type??null)&&(e.target_id??null)===(t.target_id??null)&&(e.focus_kind??null)===(t.focus_kind??null)}function En(t){const{params:e}=t;if(e.source!=="mission")return null;const n=Uo.value;if(n&&pi(n)&&Vd(n,e))return n;const s=new Date().toISOString();return{id:Bo("상황판 이어보기",e.action_type??null,e.target_type??null,e.target_id??null,e.focus_kind??null,s),source_surface:"mission",source_label:"상황판 이어보기",action_type:e.action_type??null,target_type:e.target_type??null,target_id:e.target_id??null,focus_kind:e.focus_kind??e.action_type??null,summary:e.focus_kind?`${e.focus_kind} 기준으로 열린 컨텍스트입니다.`:"상황판에서 이어진 컨텍스트입니다.",payload_preview:null,suggested_payload:null,preview:null,evidence:null,created_at:s}}function Yd(t){return{source:"mission",...t.action_type?{action_type:t.action_type}:{},...t.target_type?{target_type:t.target_type}:{},...t.target_id?{target_id:t.target_id}:{},...t.focus_kind?{focus_kind:t.focus_kind}:{}}}function Ho(t){const e=[t.focus_kind,t.summary,t.action_type].filter(n=>typeof n=="string"&&n.trim()!=="").join(" ").toLowerCase();return e.includes("artifact_scope")||e.includes("routing_confidence")||e.includes("cache_contention")?"summary":e.includes("stale_data")||e.includes("leader_offline")||e.includes("roster_offline")||e.includes("managed")||e.includes("swarm")?"swarm":t.target_type==="room"?"summary":"swarm"}function Qd(t){return{source:"mission",surface:Ho(t),...t.action_type?{action_type:t.action_type}:{},...t.target_type?{target_type:t.target_type}:{},...t.target_id?{target_id:t.target_id}:{},...t.focus_kind?{focus_kind:t.focus_kind}:{}}}function mi(t){return t!=null&&t.target_type?t.target_id?`${t.target_type} · ${t.target_id}`:t.target_type:"대상 정보 없음"}function Ys(t){switch(t){case"broadcast":return"room 방송";case"room_pause":return"room 일시정지";case"room_resume":return"room 재개";case"task_inject":return"room 작업 주입";case"team_turn":return"session 업데이트";case"team_note":return"session 노트";case"team_broadcast":return"session 방송";case"team_task_inject":return"session 작업";case"team_stop":return"session 중지";case"keeper_msg":case"keeper_message":return"keeper 메시지";case"keeper_probe":return"keeper probe";case"keeper_recover":return"keeper recover";default:return(t==null?void 0:t.trim())||"추천 액션"}}function Xd(t){switch(t){case"warroom":return"워룸";case"summary":return"요약";case"swarm":return"스웜";case"chains":return"체인";case"topology":return"토폴로지";case"alerts":return"알림";case"trace":return"트레이스";case"control":return"제어";case"operations":return"작전";default:return(t==null?void 0:t.trim())||"지휘"}}const Ut=f(null),Nt=f(null);function J(t,e=120){const n=(t??"").replace(/\s+/g," ").trim();return n?n.length>e?`${n.slice(0,e-1)}…`:n:null}function ot(t){return t==="bad"||t==="offline"||t==="critical"||t==="risk"?"bad":t==="warn"||t==="pending"||t==="degraded"||t==="interrupted"||t==="watch"?"warn":"ok"}function pe(t){if(!t)return"방금";const e=Date.parse(t);if(Number.isNaN(e))return t;const n=Math.max(0,Math.round((Date.now()-e)/1e3));return n<60?`${n}s 전`:n<3600?`${Math.round(n/60)}m 전`:n<86400?`${Math.round(n/3600)}h 전`:`${Math.round(n/86400)}d 전`}function Zd(t){return typeof t!="number"||!Number.isFinite(t)||t<0?"n/a":t<60?`${Math.round(t)}s`:t<3600?`${Math.round(t/60)}m`:t<86400?`${Math.round(t/3600)}h`:`${Math.round(t/86400)}d`}function tu(t){return t!=null&&t.confirm_required?"확인 후 실행":"즉시 실행"}function eu(t){return mi(t?Ve(t,null,"상황판 추천 액션"):null)}function Qs(t,e=Ve()){Wd(e),lt(t,t==="intervene"?Yd(e):Qd(e))}function Wo(t){Qs("intervene",Ve(null,t,"상황판 incident"))}function Go(t){Qs("command",Ve(null,t,"상황판 incident"))}function vi(t,e,n="상황판 추천 액션"){Qs("intervene",Ve(t,e,n))}function Jo(t,e,n="상황판 추천 액션"){Qs("command",Ve(t,e,n))}function qi(t,e){const n={source:"mission",target_type:"team_session",target_id:e,focus_kind:"team_session"};t==="command"&&(n.surface="swarm"),lt(t,n)}function nu(t){return{kind:t.kind,severity:t.severity,summary:t.summary,target_type:t.target_type,target_id:t.target_id??null,actor:null,evidence:t.evidence_preview}}function Vo(t,e){const n=t.trim().toLowerCase();return[...e].filter(s=>(s.from??"").trim().toLowerCase()===n).sort((s,a)=>Date.parse(a.timestamp)-Date.parse(s.timestamp))[0]??null}function su(t){return t.replace(/[.*+?^${}()|[\]\\]/g,"\\$&")}function au(t,e){if(!e)return!1;const n=su(e);return new RegExp(`(?:^|[^a-z0-9_])@${n}(?![a-z0-9_-])`,"i").test(t)}function iu(t,e){const n=t.trim().toLowerCase();return[...e].filter(s=>{if((s.from??"").trim().toLowerCase()===n)return!1;const o=(s.content??"").trim().toLowerCase();return au(o,n)}).sort((s,a)=>Date.parse(a.timestamp)-Date.parse(s.timestamp))[0]??null}function ou(t){return Et.value.find(e=>e.agent_name===t||e.name===t)??null}function Yo(t){return bt.value.find(e=>e.name===t)??null}function Qo(t,e){const n=J(t,100);if(!n)return null;const s=e.find(o=>o.id===n);if(s)return`${s.id} · ${J(s.title,92)}`;const a=e.find(o=>o.title===n);return a?`${a.id} · ${J(a.title,92)}`:n}function ru(t){var c,p;const e=Yo(t.agent_name),n=ou(t.agent_name),s=Vo(t.agent_name,Fe.value),a=iu(t.agent_name,Fe.value),o=di(t.agent_name),l=(n==null?void 0:n.skill_primary)??(e!=null&&e.capabilities&&e.capabilities.length>0?e.capabilities.slice(0,3).join(", "):null)??o.model??(e==null?void 0:e.agent_type)??null;return{brief:t,agent:e,keeper:n,where:t.where??"room",withWhom:t.with_whom,currentWork:t.current_work??Qo((e==null?void 0:e.current_task)??null,It.value)??"명시된 current task 없음",how:l,recentInput:J(t.recent_input_preview,120)??J(a==null?void 0:a.content,120)??J(n==null?void 0:n.recent_input_preview,120)??null,recentOutput:J(t.recent_output_preview,120)??J(s==null?void 0:s.content,120)??J(n==null?void 0:n.recent_output_preview,120)??J((c=n==null?void 0:n.diagnostic)==null?void 0:c.last_reply_preview,120)??null,recentEvent:J(t.recent_event,120)??J((p=n==null?void 0:n.diagnostic)==null?void 0:p.summary,120)??null,recentTools:t.recent_tool_names.length>0?t.recent_tool_names:(n==null?void 0:n.recent_tool_names)??[]}}function lu(t){var n,s;const e=Et.value.find(a=>a.name===t.name||a.agent_name===t.agent_name)??null;return{brief:t,keeper:e,currentWork:J(t.current_work,110)??J(e==null?void 0:e.skill_primary,110)??J(e==null?void 0:e.last_proactive_reason,110)??"명시된 keeper focus 없음",recentInput:J(e==null?void 0:e.recent_input_preview,120)??null,recentOutput:J(e==null?void 0:e.recent_output_preview,120)??J((n=e==null?void 0:e.diagnostic)==null?void 0:n.last_reply_preview,120)??J(e==null?void 0:e.last_proactive_preview,120)??null,recentEvent:J(e==null?void 0:e.last_proactive_reason,120)??J((s=e==null?void 0:e.diagnostic)==null?void 0:s.summary,120)??null,recentTools:(e==null?void 0:e.recent_tool_names)??[]}}function cu(){const t=ui.value;return t?new Map(t.session_briefs.map(e=>[e.session_id,e])):new Map}function du(t){const e=Yo(t),n=Vo(t,Fe.value),s=di(t);return{name:t,model:s.model,nickname:s.nickname,currentTask:Qo((e==null?void 0:e.current_task)??null,It.value)??"agent snapshot 없음",output:J(n==null?void 0:n.content,96)}}function uu(t){Ut.value=Ut.value===t?null:t,Nt.value=null}function Xo(t){Nt.value=Nt.value===t?null:t}function pu(){Ut.value=null,Nt.value=null}function Xt({status:t,label:e}){return i`
    <span class="status-badge ${t}">
      <span class="status-dot-inline ${t}"></span>
      ${e??t}
    </span>
  `}function Zo(t){const e=Date.now(),n=typeof t=="number"?t<1e12?t*1e3:t:new Date(t).getTime(),s=Math.floor((e-n)/1e3);if(s<60)return`${s}s ago`;const a=Math.floor(s/60);if(a<60)return`${a}m ago`;const o=Math.floor(a/60);return o<24?`${o}h ago`:`${Math.floor(o/24)}d ago`}function Q({timestamp:t}){const e=Zo(t),n=typeof t=="string"?t:new Date(t<1e12?t*1e3:t).toISOString();return i`<span class="time-ago" title=${n}>${e}</span>`}let mu=0;const ce=f([]);function R(t,e="success",n=4e3){const s=++mu;ce.value=[...ce.value,{id:s,message:t,type:e}],setTimeout(()=>{ce.value=ce.value.filter(a=>a.id!==s)},n)}function vu(t){ce.value=ce.value.filter(e=>e.id!==t)}function _u(){const t=ce.value;return t.length===0?null:i`
  ...
  `}const fu="masc_dashboard_agent_name",Ye=f(null),bs=f(!1),bn=f(""),ks=f([]),kn=f([]),Le=f(""),un=f(!1);function Ke(t){Ye.value=t,_i()}function Fi(){Ye.value=null,bn.value="",ks.value=[],kn.value=[],Le.value=""}function gu(){const t=Ye.value;return t?bt.value.find(e=>e.name===t)??null:null}function tr(t){return t?It.value.filter(e=>e.assignee===t):[]}function er(t){return t?Et.value.find(e=>e.agent_name===t||e.name===t)??null:null}function $u(t){if(!t)return[];const e=t.metrics_window;return(Array.isArray(e==null?void 0:e.top_tools)?e.top_tools:[]).map(s=>typeof s=="object"&&s!==null&&"tool"in s&&typeof s.tool=="string"?s.tool:null).filter(s=>s!==null)}function hu(t){const e=er(t);return e?e.recent_tool_names&&e.recent_tool_names.length>0?e.recent_tool_names:[]:[]}async function _i(){const t=Ye.value;if(t){bs.value=!0,bn.value="",ks.value=[],kn.value=[];try{const e=await yc(80);ks.value=e.filter(a=>a.includes(t)).slice(0,20);const n=tr(t).slice(0,6);if(n.length===0)return;const s=await Promise.all(n.map(async a=>{try{const o=await bc(a.id,25);return{taskId:a.id,text:o.trim()}}catch(o){const l=o instanceof Error?o.message:"history load failed";return{taskId:a.id,text:`Failed to load history: ${l}`}}}));kn.value=s}catch(e){bn.value=e instanceof Error?e.message:"Failed to load agent detail"}finally{bs.value=!1}}}async function Ki(){var s;const t=Ye.value,e=Le.value.trim();if(!t||!e)return;const n=((s=localStorage.getItem(fu))==null?void 0:s.trim())||"dashboard";un.value=!0;try{await hc(n,`@${t} ${e}`),Le.value="",R(`Mention sent to ${t}`,"success"),_i()}catch(a){const o=a instanceof Error?a.message:"Failed to send mention";R(o,"error")}finally{un.value=!1}}function yu({task:t}){return i`
    <div class="agent-detail-task">
      <span class="pill">${t.id}</span>
      <span class="agent-detail-task-title">${t.title}</span>
      <${Xt} status=${t.status} />
    </div>
  `}function bu({row:t}){return i`
  ...
  `}function ku(){var _,g,$,S,k,w,C;const t=Ye.value;if(!t)return null;const e=gu(),n=er(t),s=tr(t),a=ks.value,o=hu(t),l=$u(n),c=(e==null?void 0:e.capabilities)??[],p=((_=ft.value)==null?void 0:_.room)??"default",m=((g=ft.value)==null?void 0:g.project)??"확인 없음",u=(($=ft.value)==null?void 0:$.cluster)??"확인 없음";return i`
    <div
      class="agent-detail-overlay"
      onClick=${A=>{A.target.classList.contains("agent-detail-overlay")&&Fi()}}
    >
      <div class="agent-detail-modal">
        <div class="agent-detail-header">
          ...
          <div class="agent-detail-actions">
            ...
            <button class="control-btn ghost" onClick=${Fi}>Close</button>
          </div>
        </div>
        ...
        <div class="agent-detail-grid">
          <${T} title="Assigned Tasks">
            ${s.length===0?i`<div class="empty-state">No assigned tasks</div>`:i`<div class="agent-detail-task-list">${s.map(A=>i`<${yu} key=${A.id} task=${A} />`)}</div>`}
          <//>
        ...
        <${T} title="Task History">
          ${kn.value.length===0?i`<div class="empty-state">No task history loaded</div>`:i`<div class="agent-history-list">${kn.value.map(A=>i`<${bu} key=${A.taskId} row=${A} />`)}</div>`}
        <//>
  ...
  `}const pt=f(null),fi=f(null),Rt=f(null),xn=f(!1),Yt=f(null),Sn=f(!1),Ue=f(null),B=f(!1),xs=f([]);let xu=1;function Su(t){return v(t)?{id:r(t.id),seq:d(t.seq),from:r(t.from)??r(t.from_agent)??"system",content:r(t.content)??"",timestamp:r(t.timestamp)??new Date().toISOString(),type:r(t.type)}:null}function Au(t){return v(t)?{room_id:r(t.room_id),current_room:r(t.current_room)??r(t.room),project:r(t.project),cluster:r(t.cluster),paused:O(t.paused),pause_reason:r(t.pause_reason)??null,paused_by:r(t.paused_by)??null,paused_at:r(t.paused_at)??null}:{}}function Ui(t){if(!v(t))return;const e=Object.entries(t).map(([n,s])=>{const a=r(s);return a?[n,a]:null}).filter(n=>n!==null);return e.length>0?Object.fromEntries(e):void 0}function nr(t){if(!v(t))return null;const e=r(t.kind),n=r(t.summary),s=r(t.target_type);return!e||!n||!s?null:{kind:e,severity:r(t.severity)??"warn",summary:n,target_type:s,target_id:r(t.target_id)??null,actor:r(t.actor)??null,evidence:t.evidence}}function sr(t){if(!v(t))return null;const e=r(t.action_type),n=r(t.target_type),s=r(t.reason);return!e||!n||!s?null:{action_type:e,target_type:n,target_id:r(t.target_id)??null,severity:r(t.severity)??"warn",reason:s,confirm_required:O(t.confirm_required),suggested_payload:t.suggested_payload,preview:t.preview}}function Cu(t){return v(t)?{actor:r(t.actor)??null,spawn_agent:r(t.spawn_agent)??null,spawn_role:r(t.spawn_role)??null,spawn_model:r(t.spawn_model)??null,worker_class:r(t.worker_class)??null,parent_actor:r(t.parent_actor)??null,capsule_mode:r(t.capsule_mode)??null,runtime_pool:r(t.runtime_pool)??null,lane_id:r(t.lane_id)??null,controller_level:r(t.controller_level)??null,control_domain:r(t.control_domain)??null,supervisor_actor:r(t.supervisor_actor)??null,model_tier:r(t.model_tier)??null,task_profile:r(t.task_profile)??null,risk_level:r(t.risk_level)??null,routing_confidence:d(t.routing_confidence)??null,routing_reason:r(t.routing_reason)??null,status:r(t.status)??"unknown",turn_count:d(t.turn_count)??0,empty_note_turn_count:d(t.empty_note_turn_count)??0,has_turn:O(t.has_turn)??!1,last_turn_ts_iso:r(t.last_turn_ts_iso)??null}:null}function wu(t){if(!v(t))return null;const e=r(t.session_id);return e?{session_id:e,goal:r(t.goal),status:r(t.status),health:r(t.health),scale_profile:r(t.scale_profile),control_profile:r(t.control_profile),planned_worker_count:d(t.planned_worker_count),active_agent_count:d(t.active_agent_count),last_turn_age_sec:d(t.last_turn_age_sec)??null,attention_count:d(t.attention_count),recommended_action_count:d(t.recommended_action_count),top_attention:nr(t.top_attention),top_recommendation:sr(t.top_recommendation)}:null}function ar(t){const e=v(t)?t:{};return{trace_id:r(e.trace_id),target_type:r(e.target_type)??"room",target_id:r(e.target_id)??null,health:r(e.health),swarm_status:v(e.swarm_status)?e.swarm_status:void 0,attention_items:wt(e.attention_items).map(nr).filter(n=>n!==null),recommended_actions:wt(e.recommended_actions).map(sr).filter(n=>n!==null),session_cards:wt(e.session_cards).map(wu).filter(n=>n!==null),worker_cards:wt(e.worker_cards).map(Cu).filter(n=>n!==null)}}function Tu(t){if(!v(t))return null;const e=v(t.status)?t.status:void 0,n=v(t.summary)?t.summary:v(e==null?void 0:e.summary)?e.summary:void 0,s=v(t.session)?t.session:v(e==null?void 0:e.session)?e.session:void 0,a=r(t.session_id)??r(n==null?void 0:n.session_id)??r(s==null?void 0:s.session_id);if(!a)return null;const o=Ui(t.report_paths)??Ui(e==null?void 0:e.report_paths),l=wt(t.recent_events,["events"]).filter(v);return{session_id:a,status:r(t.status)??r(n==null?void 0:n.status)??r(s==null?void 0:s.status),progress_pct:d(t.progress_pct)??d(n==null?void 0:n.progress_pct),elapsed_sec:d(t.elapsed_sec)??d(n==null?void 0:n.elapsed_sec),remaining_sec:d(t.remaining_sec)??d(n==null?void 0:n.remaining_sec),done_delta_total:d(t.done_delta_total)??d(n==null?void 0:n.done_delta_total),summary:n,team_health:v(t.team_health)?t.team_health:v(e==null?void 0:e.team_health)?e.team_health:void 0,communication_metrics:v(t.communication_metrics)?t.communication_metrics:v(e==null?void 0:e.communication_metrics)?e.communication_metrics:void 0,orchestration_state:v(t.orchestration_state)?t.orchestration_state:v(e==null?void 0:e.orchestration_state)?e.orchestration_state:void 0,cascade_metrics:v(t.cascade_metrics)?t.cascade_metrics:v(e==null?void 0:e.cascade_metrics)?e.cascade_metrics:void 0,report_paths:o,session:s,recent_events:l}}function Iu(t){if(!v(t))return null;const e=r(t.name);if(!e)return null;const n=v(t.context)?t.context:void 0;return{name:e,agent_name:r(t.agent_name),status:r(t.status),autonomy_level:r(t.autonomy_level),context_ratio:d(t.context_ratio)??d(n==null?void 0:n.context_ratio),generation:d(t.generation),active_goal_ids:F(t.active_goal_ids),last_autonomous_action_at:r(t.last_autonomous_action_at)??null,last_turn_ago_s:d(t.last_turn_ago_s),model:r(t.model)??r(t.active_model)??r(t.primary_model)}}function Ru(t){if(!v(t))return null;const e=r(t.confirm_token)??r(t.token);return e?{confirm_token:e,actor:r(t.actor),action_type:r(t.action_type),target_type:r(t.target_type),target_id:r(t.target_id)??null,delegated_tool:r(t.delegated_tool),created_at:r(t.created_at),preview:t.preview}:null}function Pu(t){const e=v(t)?t:{};return{room:Au(e.room),sessions:wt(e.sessions,["items","sessions"]).map(Tu).filter(n=>n!==null),keepers:wt(e.keepers,["items","keepers"]).map(Iu).filter(n=>n!==null),recent_messages:wt(e.recent_messages,["messages"]).map(Su).filter(n=>n!==null),pending_confirms:wt(e.pending_confirms,["items","confirms"]).map(Ru).filter(n=>n!==null),available_actions:wt(e.available_actions,["actions"]).filter(v).map(n=>({action_type:r(n.action_type)??"unknown",target_type:r(n.target_type)??"unknown",description:r(n.description),confirm_required:O(n.confirm_required)}))}}function Jn(t){if(typeof t=="string")return t;if(t==null)return"";try{return JSON.stringify(t)}catch{return String(t)}}function Bi(t){return t.target_id?`${t.target_type}:${t.target_id}`:t.target_type}function Ss(t){xs.value=[{...t,id:xu++,at:new Date().toISOString()},...xs.value].slice(0,20)}function ir(t){return t.confirm_required?Jn(t.preview)||"Confirmation required":Jn(t.result)||Jn(t.executed_action)||Jn(t.delegated_tool_result)||t.status}async function ut(){xn.value=!0,Yt.value=null;try{const t=await Dl();pt.value=Pu(t)}catch(t){Yt.value=t instanceof Error?t.message:"Failed to load operator snapshot"}finally{xn.value=!1}}async function me(){Sn.value=!0,Ue.value=null;try{const t=await Ao({targetType:"room"});fi.value=ar(t)}catch(t){Ue.value=t instanceof Error?t.message:"Failed to load operator digest"}finally{Sn.value=!1}}async function Be(t){if(!t){Rt.value=null;return}Sn.value=!0,Ue.value=null;try{const e=await Ao({targetType:"team_session",targetId:t,includeWorkers:!0});Rt.value=ar(e)}catch(e){Ue.value=e instanceof Error?e.message:"Failed to load session digest"}finally{Sn.value=!1}}async function Mu(t){var e;B.value=!0,Yt.value=null;try{const n=await Js(t);return Ss({actor:t.actor,action_type:t.action_type,target_label:Bi(t),outcome:n.confirm_required?"preview":"executed",message:ir(n),delegated_tool:n.delegated_tool}),await ut(),await me(),(e=Rt.value)!=null&&e.target_id&&await Be(Rt.value.target_id),n}catch(n){const s=n instanceof Error?n.message:"Operator action failed";throw Yt.value=s,Ss({actor:t.actor,action_type:t.action_type,target_label:Bi(t),outcome:"error",message:s}),n}finally{B.value=!1}}async function Nu(t,e){var n;B.value=!0,Yt.value=null;try{const s=await Bl(t,e);return Ss({actor:t,action_type:"confirm",target_label:e,outcome:"confirmed",message:ir(s),delegated_tool:s.delegated_tool}),await ut(),await me(),(n=Rt.value)!=null&&n.target_id&&await Be(Rt.value.target_id),s}catch(s){const a=s instanceof Error?s.message:"Operator confirmation failed";throw Yt.value=a,Ss({actor:t,action_type:"confirm",target_label:e,outcome:"error",message:a}),s}finally{B.value=!1}}gd(()=>{var t;ut(),me(),(t=Rt.value)!=null&&t.target_id&&Be(Rt.value.target_id)});function Lu(t){switch(t){case"quiet_hours":return"quiet hours";case"min_gap":return"cooldown gate";case"no_recent_activity":return"waiting for activity";case"disabled":return"runtime disabled";case"startup":return"warming up";case"llm_error":return"llm error";case"graphql_error":return"graphql error";case"never_started":return"never started";default:return"unknown"}}function Du(t){switch(t){case"manual_lodge_poke":return"Poke Lodge";case"probe":return"Probe";case"recover":return"Recover";default:return"Message"}}function zu(t){switch(t.delivery){case"sending":return"sending";case"timeout":return"timeout";case"error":return"error";case"delivered":return"delivered";default:return t.role}}function Hi(t){return t.delivery==="error"||t.delivery==="timeout"?"bad":t.delivery==="sending"?"warn":t.role==="assistant"?"assistant":t.role==="user"?"user":"warn"}function or(t){if(!t)return null;const e=new Date(t);return Number.isNaN(e.getTime())?null:e.toLocaleTimeString()}function Eu(t){return typeof t!="number"||!Number.isFinite(t)||t<=0?null:t<60?`${Math.round(t)}s`:`${Math.ceil(t/60)}m`}function rr(t){if(!t)return null;const e=Dt.value[t.name];return(e==null?void 0:e.diagnostic)??t.diagnostic??null}function ju({keeper:t,showRawStatus:e=!1}){if(Z(()=>{t!=null&&t.name&&Ro(t.name)},[t==null?void 0:t.name]),!t)return i`<div class="control-status-copy">Select a keeper to inspect direct reply state.</div>`;const n=Dt.value[t.name],s=rr(t),a=za.value[t.name];return i`
    <div class="control-result-box">
      <div class="control-inline-meta">
        <span class="pill">${(s==null?void 0:s.health_state)??"unknown"}</span>
        <span class="pill">${Lu(s==null?void 0:s.quiet_reason)}</span>
        <span class="pill">next ${Du((s==null?void 0:s.next_action_path)??"direct_message")}</span>
      ...
      <div class="control-status-copy">
        ...
        ${s!=null&&s.next_eligible_at_s?i` · next eligible ${Eu(s.next_eligible_at_s)}`:null}
      </div>
  ...
  `}function Ou({keeperName:t,placeholder:e}){const[n,s]=vo("");Z(()=>{t&&Ro(t)},[t]);const a=it.value[t]??[],o=Ea.value[t]??!1,l=zt.value[t],c=async()=>{const p=n.trim();if(!(!t||!p)){s("");try{await qc(t,p)}catch(m){const u=m instanceof Error?m.message:`Failed to message ${t}`;R(u,"error")}}};return i`
        ...
        ${a.length===0?i`<div class="control-status-copy">No direct keeper conversation yet.</div>`:a.map(p=>i`
              <div class="keeper-conversation-item" key=${p.id}>
                <div class="keeper-conversation-meta">
                  ...
                  <span class=${`keeper-role-chip ${Hi(p)}`}>${zu(p)}</span>
  ...
  `}function qu({actor:t,keeper:e,onPokeLodge:n}){if(!e)return null;const s=rr(e),a=ja.value[e.name]??!1,o=Oa.value[e.name]??!1,l=(s==null?void 0:s.next_action_path)??"direct_message",c=(s==null?void 0:s.recoverable)??l==="recover";return i`
    <div class="control-actions">
      <button
  ...
  `}function ls(t){return t?t>=1e6?`${(t/1e6).toFixed(1)}M`:t>=1e3?`${(t/1e3).toFixed(1)}K`:String(t):"—"}function Uu(t){switch(t){case"keeper_message":return"message";case"keeper_probe":return"probe";case"keeper_recover":return"recover";case"broadcast":return"broadcast";case"room_pause":return"pause";case"room_resume":return"resume";case"lodge_tick":return"lodge";default:return(t==null?void 0:t.trim())||"action"}}function Bu(t){return t.recent_tool_names&&t.recent_tool_names.length>0?t.recent_tool_names:[]}function Hu(t){const e=t.metrics_window;return(Array.isArray(e==null?void 0:e.top_tools)?e.top_tools:[]).map(s=>typeof s=="object"&&s!==null&&"tool"in s&&typeof s.tool=="string"?s.tool:null).filter(s=>s!==null)}function Wu({keeper:t}){const e=t.metrics_series??[],n=e[e.length-1],s=(n==null?void 0:n.cost_usd)!=null?`$${n.cost_usd.toFixed(4)}`:"—",a=[{label:"Generation",value:t.generation??"-",hint:"Succession count"},{label:"Turns",value:t.turn_count??"-",hint:"Total loop turns"},{label:"Context",value:t.context_ratio!=null?`${Math.round(t.context_ratio*100)}%`:"-",hint:t.context_ratio!=null&&t.context_ratio>.8?"Near limit":void 0},{label:"Activity",value:t.activityLevel??"-",hint:"Level 0–5"}];return i`
  ...
  `}function Gu({keeper:t}){var u,_;const e=t.metrics_series??[];if(e.length<2){const g=(((u=t.context)==null?void 0:u.context_ratio)??0)*100,$=g>85?"#ef4444":g>70?"#f59e0b":"#22c55e";return i`
  ...
  `}function Vu({stats:t}){const e=t.max_hp>0?Math.round(t.hp/t.max_hp*100):0,n=t.max_mp>0?Math.round(t.mp/t.max_mp*100):0;return i`
    <div>
  ...
  `}function Yu({items:t}){return t.length===0?i`<div class="empty-state" style="font-size:13px">No equipment</div>`:i`
  ...
  `}function Qu({rels:t}){const e=Object.entries(t);return e.length===0?i`<div class="empty-state" style="font-size:13px">No relationships</div>`:i`
  ...
  `}function Zu({keeper:t}){var m,u,_,g,$,S,k;const e=((m=pt.value)==null?void 0:m.room)??{},n=(((u=pt.value)==null?void 0:u.available_actions)??[]).filter(w=>w.target_type==="keeper"||w.target_type==="room").slice(0,8),s=Bu(t),a=Hu(t),o=((_=t.agent)==null?void 0:_.capabilities)??[],l=e.current_room??e.room_id??((g=ft.value)==null?void 0:g.room)??"default",c=e.project??(($=ft.value)==null?void 0:$.project)??"확인 없음",p=e.cluster??((S=ft.value)==null?void 0:S.cluster)??"확인 없음";return i`
    <div class="keeper-signal-list">
      <div class="keeper-signal-row">
        <span>Room</span>
        <strong>${l}</strong>
      ...
      <div style="display:flex; flex-direction:column; gap:8px; margin-top:8px;">
        ...
        <div style="display:flex; flex-wrap:wrap; gap:6px;">
          ${n.length>0?n.map(w=>i`<span class="pill">${Uu(w.action_type)}</span>`):i`<span style="font-size:12px; color:#888;">operator action 광고 없음</span>`}
        </div>
      </div>
    </div>
  `}function lr(){const t=new URLSearchParams(window.location.search),e=t.get("agent")??t.get("agent_name"),n=localStorage.getItem("masc_dashboard_agent_name");return(e??n??"dashboard").trim()||"dashboard"}async function tp(){try{const t=await Js({actor:lr(),action_type:"lodge_tick",target_type:"room",payload:{}}),e=Io(t.result);await zn(),e!=null&&e.skipped_reason?R(e.skipped_reason,"warning"):R(e?`Poke finished: ${e.acted}/${e.checked} acted`:"Poke finished",e&&e.acted>0?"success":"warning")}catch(t){const e=t instanceof Error?t.message:"Failed to run Lodge poke";R(e,"error")}}function ep({keeper:t}){return i`
  ...
  `}function np(){var e,n,s;const t=gi.value;return t?i`
    <div
  ...
  `:null}function sp({cluster:t,project:e,room:n,generatedAt:s}){return i`
  ...
  `}function ap(){const t=qo.value,e=ot((t==null?void 0:t.status)??(oe.value?"bad":"warn")),n=(t==null?void 0:t.status)==="error"||(t==null?void 0:t.status)==="unavailable"&&!(t!=null&&t.cached);return i`
  ...
  `}function ip({item:t,selected:e,sessionLookup:n}){const s=nu(t),a=t.related_session_ids.map(l=>n.get(l)).filter(l=>l!=null),o=t.top_action??null;return i`
    <article class="mission-attention-card ${ot((o==null?void 0:o.severity)??t.severity)} ${e?"is-selected":""}">
      <button class="mission-card-select" onClick=${()=>uu(t.id)}>
        <div class="mission-card-head">
          <div>
            <strong>${t.summary}</strong>
            <div class="mission-card-target">${t.kind}${t.target_id?` · ${t.target_id}`:""}</div>
          </div>
          <span class="command-chip ${ot((o==null?void 0:o.severity)??t.severity)}">${o?tu(o):t.severity}</span>
        </div>
  ...
  `}function op({brief:t,selected:e}){var o,l;const n=t.member_names.slice(0,6).map(du),s=t.top_recommendation??null,a=t.top_attention??null;return i`
    <article class="mission-crew-card ${ot(((o=t.top_attention)==null?void 0:o.severity)??t.health??t.status)} ${e?"is-selected":""}">
      <button class="mission-card-select" onClick=${()=>Xo(t.session_id)}>
        ...
        <div class="mission-fact-grid">
          ...
          <div class="mission-fact-tile">
            <span>가동 시간</span>
            <strong>${Zd(t.elapsed_sec)}</strong>
      ...
      <div class="mission-card-actions">
        <button class="control-btn ghost" onClick=${()=>qi("intervene",t.session_id)}>세션 개입 열기</button>
        <button class="control-btn ghost" onClick=${()=>qi("command",t.session_id)}>세션 원인 보기</button>
        ${s?i`<button class="control-btn ghost" onClick=${()=>vi(s,a,"Mission session brief")}>추천 액션 열기</button>`:null}
      </div>
    </article>
  `}function rp({row:t}){var s,a,o,l,c;const e=di(t.brief.agent_name),n=t.withWhom.length>0?t.withWhom.slice(0,3).join(", "):"단독 또는 room-level";return i`
  ...
  `}function cp({item:t}){const e=t.action??null,n=t.attention??null;return i`
  ...
  `}function Ji(){var g,$,S,k,w,C,A;const t=ui.value;if(Ba.value&&!t)return i`<div class="loading-indicator">상황판 스냅샷 불러오는 중...</div>`;if($s.value&&!t)return i`<div class="empty-state error">${$s.value}</div>`;if(!t)return i`<div class="empty-state">상황판 스냅샷이 아직 없습니다.</div>`;Ut.value&&!t.attention_queue.some(x=>x.id===Ut.value)&&(Ut.value=null),Nt.value&&!t.session_briefs.some(x=>x.session_id===Nt.value)&&(Nt.value=null);const e=t.attention_queue.find(x=>x.id===Ut.value)??null,n=Nt.value,s=cu(),a=e?new Set(e.related_session_ids):null,o=e?new Set(e.related_agent_names):null,l=(a?t.session_briefs.filter(x=>a.has(x.session_id)):t.session_briefs).slice(0,e?8:6),c=t.agent_briefs.filter(x=>!xd(x.agent_name)).filter(x=>n?x.related_session_id===n:o&&a?o.has(x.agent_name)||(x.related_session_id?a.has(x.related_session_id):!1):!0).slice(0,n||e?10:8).map(ru),p=t.keeper_briefs.slice(0,6).map(lu),m=t.attention_queue.slice(0,6),u=t.internal_signals.slice(0,3),_=c.filter(x=>x.recentOutput).length+p.filter(x=>x.recentOutput).length;return i`
    <section class="dashboard-panel mission-view">
      ...
      ${e||n?i`
            <div class="mission-selection-bar">
              ...
              <button class="control-btn ghost" onClick=${pu}>선택 해제</button>
            </div>
          `:null}
      ...
      <${T} title="Attention Queue" class="mission-list-card" semanticId="mission.attention_queue">
        ...
        <div class="mission-lane-stack">
          ${m.length>0?m.map(x=>i`<${ip} key=${x.id} item=${x} selected=${Ut.value===x.id} sessionLookup=${s} />`):i`<div class="empty-state">지금 Mission attention queue가 비어 있습니다.</div>`}
        </div>
      <//>
      ...
      <div class="mission-human-grid">
        <${T} title="Affected Sessions" class="mission-list-card" semanticId="mission.session_briefs">
          ...
          <div class="mission-list-stack">
            ${l.length>0?l.map(x=>i`<${op} key=${x.session_id} brief=${x} selected=${Nt.value===x.session_id} />`):i`<div class="empty-state">현재 선택과 연결된 session이 없습니다.</div>`}
          </div>
        <//>
        ...
        <${T} title="Impacted Agents" class="mission-list-card" semanticId="mission.agent_activity">
          ...
          <div class="mission-activity-list">
            ${c.length>0?c.map(x=>i`<${rp} key=${x.brief.agent_name} row=${x} />`):i`<div class="empty-state">현재 선택과 연결된 agent가 없습니다.</div>`}
          </div>
        <//>
      </div>
      ...
      <div class="mission-human-grid">
        <${T} title="Keeper Continuity" class="mission-list-card" semanticId="mission.keeper_activity">
          ...
          <div class="mission-activity-list">
            ${p.length>0?p.map(x=>i`<${lp} key=${x.brief.name} row=${x} />`):i`<div class="empty-state">지금 보이는 keeper가 없습니다.</div>`}
          </div>
        <//>
        ...
        <${T} title="Internal Signals" class="mission-list-card" semanticId="mission.internal_signals">
          ...
          <div class="mission-list-stack">
            ${u.length>0?u.map(x=>i`<${cp} key=${x.id} item=${x} />`):i`<div class="empty-state">지금은 내부 진단 경고가 없습니다.</div>`}
          </div>
          <div class="mission-card-actions">
  ...
  `}const hi=f(null),Mt=f(null),As=f(!1),Cs=f(!1),ws=f(null),Ts=f(null),Wa=f(null),Is=f(null),V=f("warroom"),jn=f(null),Ga=f(!1),Rs=f(null),_e=f(null),Ps=f(!1),Ms=f(null),On=f(null),Ja=f(!1),Ns=f(null),An=f(null),Ls=f(!1),Cn=f(null),De=f(null);let sn=null;function yi(t){return t!=="summary"&&t!=="swarm"&&t!=="warroom"}function cr(){if(typeof window>"u")return new URLSearchParams;const t=new URLSearchParams(window.location.search),e=window.location.hash.replace(/^#/,""),n=e.indexOf("?");return n>=0&&new URLSearchParams(e.slice(n+1)).forEach((a,o)=>{t.has(o)||t.set(o,a)}),t}function dp(){const e=cr().get("run_id")??void 0;return e&&e.trim()!==""?e.trim():void 0}function up(){const e=cr().get("operation_id")??void 0;return e&&e.trim()!==""?e.trim():void 0}function pp(t){if(v(t))return{policy_class:r(t.policy_class),approval_class:r(t.approval_class),tool_allowlist:F(t.tool_allowlist),model_allowlist:F(t.model_allowlist),requires_human_for:F(t.requires_human_for),autonomy_level:r(t.autonomy_level),escalation_timeout_sec:d(t.escalation_timeout_sec),kill_switch:O(t.kill_switch),frozen:O(t.frozen)}}function mp(t){if(v(t))return{headcount_cap:d(t.headcount_cap),active_operation_cap:d(t.active_operation_cap),max_cost_usd:d(t.max_cost_usd),max_tokens:d(t.max_tokens)}}function bi(t){if(!v(t))return null;const e=r(t.unit_id),n=r(t.label),s=r(t.kind);return!e||!n||!s?null:{unit_id:e,label:n,kind:s,parent_unit_id:r(t.parent_unit_id)??null,leader_id:r(t.leader_id)??null,roster:F(t.roster),capability_profile:F(t.capability_profile),source:r(t.source),created_at:r(t.created_at),updated_at:r(t.updated_at),policy:pp(t.policy),budget:mp(t.budget)}}function dr(t){if(!v(t))return null;const e=bi(t.unit);return e?{unit:e,leader_status:r(t.leader_status),roster_total:d(t.roster_total),roster_live:d(t.roster_live),active_operation_count:d(t.active_operation_count),health:r(t.health),reasons:F(t.reasons),children:Array.isArray(t.children)?t.children.map(dr).filter(n=>n!==null):[]}:null}function vp(t){if(v(t))return{total_units:d(t.total_units),company_count:d(t.company_count),platoon_count:d(t.platoon_count),squad_count:d(t.squad_count),leaf_agent_unit_count:d(t.leaf_agent_unit_count),live_agent_count:d(t.live_agent_count),managed_unit_count:d(t.managed_unit_count),active_operation_count:d(t.active_operation_count)}}function ur(t){const e=v(t)?t:{};return{version:r(e.version),generated_at:r(e.generated_at),source:r(e.source),summary:vp(e.summary),units:Array.isArray(e.units)?e.units.map(dr).filter(n=>n!==null):[]}}function _p(t){if(!v(t))return null;const e=r(t.kind),n=r(t.status);return!e||!n?null:{kind:e,chain_id:r(t.chain_id)??null,goal:r(t.goal)??null,run_id:r(t.run_id)??null,status:n,viewer_path:r(t.viewer_path)??null,last_sync_at:r(t.last_sync_at)??null}}function Xs(t){if(!v(t))return null;const e=r(t.operation_id),n=r(t.objective),s=r(t.assigned_unit_id),a=r(t.trace_id),o=r(t.status);return!e||!n||!s||!a||!o?null:{operation_id:e,objective:n,assigned_unit_id:s,autonomy_level:r(t.autonomy_level),policy_class:r(t.policy_class),budget_class:r(t.budget_class),detachment_session_id:r(t.detachment_session_id)??null,trace_id:a,checkpoint_ref:r(t.checkpoint_ref)??null,active_goal_ids:F(t.active_goal_ids),note:r(t.note)??null,created_by:r(t.created_by),source:r(t.source),status:o,chain:_p(t.chain),created_at:r(t.created_at),updated_at:r(t.updated_at)}}function fp(t){if(!v(t))return null;const e=Xs(t.operation);return e?{operation:e,assigned_unit_label:r(t.assigned_unit_label)}:null}function en(t){if(v(t))return{tone:r(t.tone),pending_ops:d(t.pending_ops),blocked_ops:d(t.blocked_ops),in_flight_ops:d(t.in_flight_ops),pipeline_stalls:d(t.pipeline_stalls),bus_traffic:d(t.bus_traffic),l1_hit_rate:d(t.l1_hit_rate),invalidation_count:d(t.invalidation_count),current_pending:d(t.current_pending),current_in_flight:d(t.current_in_flight),cdb_wakeups:d(t.cdb_wakeups),total_stolen:d(t.total_stolen),avg_best_score:d(t.avg_best_score),avg_candidate_count:d(t.avg_candidate_count),best_first_operations:d(t.best_first_operations),active_sessions:d(t.active_sessions),commit_rate:d(t.commit_rate),total_speculations:d(t.total_speculations)}}function gp(t){if(!v(t))return;const e=v(t.pipeline)?t.pipeline:void 0,n=v(t.cache)?t.cache:void 0,s=v(t.ooo)?t.ooo:void 0,a=v(t.speculative)?t.speculative:void 0,o=v(t.search_fabric)?t.search_fabric:void 0,l=v(t.signals)?t.signals:void 0;return{pipeline:e?{total_ops:d(e.total_ops),completed_ops:d(e.completed_ops),stalled_cycles:d(e.stalled_cycles),hazards_detected:d(e.hazards_detected),forwarding_used:d(e.forwarding_used),pipeline_flushes:d(e.pipeline_flushes),ipc:d(e.ipc)}:void 0,cache:n?{total_reads:d(n.total_reads),total_writes:d(n.total_writes),l1_hit_rate:d(n.l1_hit_rate),invalidation_count:d(n.invalidation_count),writeback_count:d(n.writeback_count),bus_traffic:d(n.bus_traffic)}:void 0,ooo:s?{agent_count:d(s.agent_count),total_added:d(s.total_added),total_issued:d(s.total_issued),total_completed:d(s.total_completed),total_stolen:d(s.total_stolen),cdb_wakeups:d(s.cdb_wakeups),stall_cycles:d(s.stall_cycles),global_cdb_events:d(s.global_cdb_events),current_pending:d(s.current_pending),current_in_flight:d(s.current_in_flight)}:void 0,speculative:a?{total_speculations:d(a.total_speculations),total_commits:d(a.total_commits),total_aborts:d(a.total_aborts),commit_rate:d(a.commit_rate),total_fast_calls:d(a.total_fast_calls),total_cost_usd:d(a.total_cost_usd),active_sessions:d(a.active_sessions)}:void 0,search_fabric:o?{total_operations:d(o.total_operations),best_first_operations:d(o.best_first_operations),legacy_operations:d(o.legacy_operations),blocked_operations:d(o.blocked_operations),ready_operations:d(o.ready_operations),research_pipeline_operations:d(o.research_pipeline_operations),avg_candidate_count:d(o.avg_candidate_count),avg_best_score:d(o.avg_best_score),top_stage:r(o.top_stage)??null}:void 0,signals:l?{issue_pressure:en(l.issue_pressure),cache_contention:en(l.cache_contention),scheduler_efficiency:en(l.scheduler_efficiency),routing_confidence:en(l.routing_confidence),speculative_posture:en(l.speculative_posture)}:void 0}}function pr(t){const e=v(t)?t:{},n=v(e.summary)?e.summary:void 0;return{version:r(e.version),generated_at:r(e.generated_at),summary:n?{total:d(n.total),active:d(n.active),paused:d(n.paused),managed:d(n.managed),projected:d(n.projected)}:void 0,microarch:gp(e.microarch),operations:Array.isArray(e.operations)?e.operations.map(fp).filter(s=>s!==null):[]}}function mr(t){if(!v(t))return null;const e=r(t.detachment_id),n=r(t.operation_id),s=r(t.assigned_unit_id);return!e||!n||!s?null:{detachment_id:e,operation_id:n,assigned_unit_id:s,leader_id:r(t.leader_id)??null,roster:F(t.roster),session_id:r(t.session_id)??null,checkpoint_ref:r(t.checkpoint_ref)??null,runtime_kind:r(t.runtime_kind)??null,runtime_ref:r(t.runtime_ref)??null,source:r(t.source),status:r(t.status),last_event_at:r(t.last_event_at)??null,last_progress_at:r(t.last_progress_at)??null,heartbeat_deadline:r(t.heartbeat_deadline)??null,created_at:r(t.created_at),updated_at:r(t.updated_at)}}function $p(t){if(!v(t))return null;const e=mr(t.detachment);return e?{detachment:e,assigned_unit_label:r(t.assigned_unit_label),operation:Xs(t.operation)}:null}function vr(t){const e=v(t)?t:{},n=v(e.summary)?e.summary:void 0;return{version:r(e.version),generated_at:r(e.generated_at),summary:n?{total:d(n.total),active:d(n.active),projected:d(n.projected)}:void 0,detachments:Array.isArray(e.detachments)?e.detachments.map($p).filter(s=>s!==null):[]}}function hp(t){if(!v(t))return null;const e=r(t.decision_id),n=r(t.trace_id),s=r(t.requested_action),a=r(t.scope_type),o=r(t.scope_id);return!e||!n||!s||!a||!o?null:{decision_id:e,trace_id:n,requested_action:s,scope_type:a,scope_id:o,operation_id:r(t.operation_id)??null,target_unit_id:r(t.target_unit_id)??null,requested_by:r(t.requested_by),status:r(t.status),reason:r(t.reason)??null,source:r(t.source),detail:t.detail,created_at:r(t.created_at),decided_at:r(t.decided_at)??null,expires_at:r(t.expires_at)??null}}function _r(t){const e=v(t)?t:{},n=v(e.summary)?e.summary:void 0;return{version:r(e.version),generated_at:r(e.generated_at),summary:n?{total:d(n.total),pending:d(n.pending),approved:d(n.approved),denied:d(n.denied)}:void 0,decisions:Array.isArray(e.decisions)?e.decisions.map(hp).filter(s=>s!==null):[]}}function yp(t){if(!v(t))return null;const e=bi(t.unit);return e?{unit:e,roster_total:d(t.roster_total),roster_live:d(t.roster_live),headcount_cap:d(t.headcount_cap),active_operations:d(t.active_operations),active_operation_cap:d(t.active_operation_cap),utilization:d(t.utilization)}:null}function bp(t){const e=v(t)?t:{};return{version:r(e.version),generated_at:r(e.generated_at),capacity:Array.isArray(e.capacity)?e.capacity.map(yp).filter(n=>n!==null):[]}}function kp(t){if(!v(t))return null;const e=r(t.alert_id);return e?{alert_id:e,severity:r(t.severity),kind:r(t.kind),scope_type:r(t.scope_type),scope_id:r(t.scope_id),title:r(t.title),detail:r(t.detail),timestamp:r(t.timestamp)}:null}function fr(t){const e=v(t)?t:{},n=v(e.summary)?e.summary:void 0;return{version:r(e.version),generated_at:r(e.generated_at),summary:n?{total:d(n.total),bad:d(n.bad),warn:d(n.warn)}:void 0,alerts:Array.isArray(e.alerts)?e.alerts.map(kp).filter(s=>s!==null):[]}}function gr(t){if(!v(t))return null;const e=r(t.event_id),n=r(t.trace_id),s=r(t.event_type);return!e||!n||!s?null:{event_id:e,trace_id:n,event_type:s,operation_id:r(t.operation_id)??null,unit_id:r(t.unit_id)??null,actor:r(t.actor)??null,source:r(t.source),timestamp:r(t.timestamp),detail:t.detail}}function xp(t){const e=v(t)?t:{};return{version:r(e.version),generated_at:r(e.generated_at),events:Array.isArray(e.events)?e.events.map(gr).filter(n=>n!==null):[]}}function Sp(t){if(!v(t))return null;const e=r(t.code),n=r(t.severity),s=r(t.summary);return!e||!n||!s?null:{code:e,severity:n,summary:s}}function Ap(t){if(!v(t))return null;const e=r(t.lane_id),n=r(t.label),s=r(t.kind),a=r(t.phase),o=r(t.motion_state),l=r(t.source_of_truth),c=r(t.movement_reason),p=r(t.current_step);if(!e||!n||!s||!a||!o||!l||!c||!p)return null;const m=v(t.counts)?t.counts:{};return{lane_id:e,label:n,kind:s,present:O(t.present)??!1,phase:a,motion_state:o,source_of_truth:l,last_movement_at:r(t.last_movement_at)??null,movement_reason:c,current_step:p,blockers:F(t.blockers),counts:{operations:d(m.operations),detachments:d(m.detachments),workers:d(m.workers),approvals:d(m.approvals),alerts:d(m.alerts)},hard_flags:Array.isArray(t.hard_flags)?t.hard_flags.map(Sp).filter(u=>u!==null):[]}}function Cp(t){if(!v(t))return null;const e=r(t.event_id),n=r(t.lane_id),s=r(t.kind),a=r(t.timestamp),o=r(t.title),l=r(t.detail),c=r(t.tone),p=r(t.source);return!e||!n||!s||!a||!o||!l||!c||!p?null:{event_id:e,lane_id:n,kind:s,timestamp:a,title:o,detail:l,tone:c,source:p}}function wp(t){if(!v(t))return null;const e=r(t.code),n=r(t.severity),s=r(t.summary);return!e||!n||!s?null:{code:e,severity:n,summary:s,lane_ids:F(t.lane_ids),count:d(t.count)??0}}function $r(t){if(!v(t))return;const e=v(t.overview)?t.overview:{},n=v(t.gaps)?t.gaps:{},s=v(t.recommended_next_action)?t.recommended_next_action:void 0;return{generated_at:r(t.generated_at),overview:{active_lanes:d(e.active_lanes),moving_lanes:d(e.moving_lanes),stalled_lanes:d(e.stalled_lanes),projected_lanes:d(e.projected_lanes),last_movement_at:r(e.last_movement_at)??null},lanes:Array.isArray(t.lanes)?t.lanes.map(Ap).filter(a=>a!==null):[],timeline:Array.isArray(t.timeline)?t.timeline.map(Cp).filter(a=>a!==null):[],gaps:{count:d(n.count),items:Array.isArray(n.items)?n.items.map(wp).filter(a=>a!==null):[]},recommended_next_action:s?{tool:r(s.tool)??"masc_operator_snapshot",label:r(s.label)??"Observe operator state",reason:r(s.reason)??"",lane_id:r(s.lane_id)??null}:void 0}}function Tp(t){if(!v(t))return;const e=v(t.workers)?t.workers:{},n=O(t.pass);return{status:r(t.status)??"missing",source:r(t.source)??"none",run_id:r(t.run_id)??null,captured_at:r(t.captured_at)??null,...n!==void 0?{pass:n}:{},...d(t.peak_hot_slots)!=null?{peak_hot_slots:d(t.peak_hot_slots)}:{},...d(t.ctx_per_slot)!=null?{ctx_per_slot:d(t.ctx_per_slot)}:{},workers:{expected:d(e.expected),joined:d(e.joined),current_task_bound:d(e.current_task_bound),fresh_heartbeats:d(e.fresh_heartbeats),done:d(e.done),final:d(e.final)},artifact_ref:r(t.artifact_ref)??null,missing_reason:r(t.missing_reason)??null}}function Ip(t){const e=v(t)?t:{};return{version:r(e.version),generated_at:r(e.generated_at),topology:ur(e.topology),operations:pr(e.operations),detachments:vr(e.detachments),alerts:fr(e.alerts),decisions:_r(e.decisions),capacity:bp(e.capacity),traces:xp(e.traces),swarm_status:$r(e.swarm_status)}}function Rp(t){const e=v(t)?t:{},n=ur(e.topology),s=pr(e.operations),a=vr(e.detachments),o=fr(e.alerts),l=_r(e.decisions);return{version:r(e.version),generated_at:r(e.generated_at),topology:{version:n.version,generated_at:n.generated_at,source:n.source,summary:n.summary},operations:{version:s.version,generated_at:s.generated_at,summary:s.summary,microarch:s.microarch},detachments:{version:a.version,generated_at:a.generated_at,summary:a.summary},alerts:{version:o.version,generated_at:o.generated_at,summary:o.summary},decisions:{version:l.version,generated_at:l.generated_at,summary:l.summary},swarm_status:$r(e.swarm_status),swarm_proof:Tp(e.swarm_proof)}}function Pp(t){return v(t)?{chain_id:r(t.chain_id)??null,started_at:d(t.started_at)??null,progress:d(t.progress)??null,elapsed_sec:d(t.elapsed_sec)??null}:null}function hr(t){if(!v(t))return null;const e=r(t.event);return e?{event:e,chain_id:r(t.chain_id)??null,timestamp:r(t.timestamp)??null,duration_ms:d(t.duration_ms)??null,message:r(t.message)??null,tokens:d(t.tokens)??null}:null}function Mp(t){if(!v(t))return null;const e=Xs(t.operation);return e?{operation:e,runtime:Pp(t.runtime),history:hr(t.history),mermaid:r(t.mermaid)??null,preview_run:yr(t.preview_run)}:null}function Np(t){const e=v(t)?t:{};return{status:r(e.status)??"disconnected",base_url:r(e.base_url)??null,message:r(e.message)??null}}function Lp(t){const e=v(t)?t:{},n=v(e.summary)?e.summary:void 0;return{version:r(e.version),generated_at:r(e.generated_at),connection:Np(e.connection),summary:n?{linked_operations:d(n.linked_operations),active_chains:d(n.active_chains),running_operations:d(n.running_operations),recent_failures:d(n.recent_failures),last_history_event_at:r(n.last_history_event_at)??null}:void 0,operations:Array.isArray(e.operations)?e.operations.map(Mp).filter(s=>s!==null):[],recent_history:Array.isArray(e.recent_history)?e.recent_history.map(hr).filter(s=>s!==null):[]}}function Dp(t){if(!v(t))return null;const e=r(t.id);return e?{id:e,type:r(t.type),status:r(t.status),duration_ms:d(t.duration_ms)??null,error:r(t.error)??null}:null}function yr(t){if(!v(t))return null;const e=r(t.run_id),n=r(t.chain_id);return n?{run_id:e??null,chain_id:n,duration_ms:d(t.duration_ms),success:O(t.success),mermaid:r(t.mermaid),nodes:Array.isArray(t.nodes)?t.nodes.map(Dp).filter(s=>s!==null):[]}:null}function zp(t){const e=v(t)?t:{};return{run:yr(e.run)}}function Ep(t){if(!v(t))return null;const e=r(t.title),n=r(t.path);return!e||!n?null:{title:e,path:n}}function jp(t){if(!v(t))return null;const e=r(t.id),n=r(t.title),s=r(t.summary);return!e||!n||!s?null:{id:e,title:n,summary:s}}function Op(t){if(!v(t))return null;const e=r(t.id),n=r(t.title),s=r(t.tool),a=r(t.summary);return!e||!n||!s||!a?null:{id:e,title:n,tool:s,summary:a,success_signals:F(t.success_signals),pitfalls:F(t.pitfalls)}}function qp(t){if(!v(t))return null;const e=r(t.id),n=r(t.title),s=r(t.summary),a=r(t.when_to_use);return!e||!n||!s||!a?null:{id:e,title:n,summary:s,when_to_use:a,steps:Array.isArray(t.steps)?t.steps.map(Op).filter(o=>o!==null):[]}}function Fp(t){if(!v(t))return null;const e=r(t.id),n=r(t.title),s=r(t.description);return!e||!n||!s?null:{id:e,title:n,description:s,tools:F(t.tools)}}function Kp(t){if(!v(t))return null;const e=r(t.id),n=r(t.title),s=r(t.symptom),a=r(t.why),o=r(t.fix_tool),l=r(t.fix_summary);return!e||!n||!s||!a||!o||!l?null:{id:e,title:n,symptom:s,why:a,fix_tool:o,fix_summary:l}}function Up(t){if(!v(t))return null;const e=r(t.id),n=r(t.title),s=r(t.path_id),a=r(t.transport);return!e||!n||!s||!a?null:{id:e,title:n,path_id:s,transport:a,request:t.request,response:t.response,notes:F(t.notes)}}function Bp(t){const e=v(t)?t:{};return{version:r(e.version),generated_at:r(e.generated_at),docs:Array.isArray(e.docs)?e.docs.map(Ep).filter(n=>n!==null):[],concepts:Array.isArray(e.concepts)?e.concepts.map(jp).filter(n=>n!==null):[],golden_paths:Array.isArray(e.golden_paths)?e.golden_paths.map(qp).filter(n=>n!==null):[],tool_groups:Array.isArray(e.tool_groups)?e.tool_groups.map(Fp).filter(n=>n!==null):[],pitfalls:Array.isArray(e.pitfalls)?e.pitfalls.map(Kp).filter(n=>n!==null):[],examples:Array.isArray(e.examples)?e.examples.map(Up).filter(n=>n!==null):[]}}function Hp(t){if(!v(t))return null;const e=r(t.id),n=r(t.title),s=r(t.status),a=r(t.detail),o=r(t.next_tool);return!e||!n||!s||!a||!o?null:{id:e,title:n,status:s,detail:a,next_tool:o}}function Wp(t){if(!v(t))return null;const e=r(t.code),n=r(t.severity),s=r(t.title),a=r(t.detail),o=r(t.next_tool);return!e||!n||!s||!a||!o?null:{code:e,severity:n,title:s,detail:a,next_tool:o}}function Gp(t){if(!v(t))return null;const e=r(t.from),n=r(t.content),s=r(t.timestamp),a=d(t.seq);return!e||!n||!s||a==null?null:{seq:a,from:e,content:n,timestamp:s}}function Jp(t){if(!v(t))return null;const e=r(t.name),n=r(t.role),s=r(t.lane),a=r(t.status),o=r(t.claim_marker),l=r(t.done_marker),c=r(t.final_marker);if(!e||!n||!s||!a||!o||!l||!c)return null;const p=(()=>{if(!v(t.last_message))return null;const m=d(t.last_message.seq),u=r(t.last_message.content),_=r(t.last_message.timestamp);return m==null||!u||!_?null:{seq:m,content:u,timestamp:_}})();return{name:e,role:n,lane:s,joined:O(t.joined)??!1,live_presence:O(t.live_presence)??!1,completed:O(t.completed)??!1,status:a,current_task:r(t.current_task)??null,bound_task_id:r(t.bound_task_id)??null,bound_task_title:r(t.bound_task_title)??null,bound_task_status:r(t.bound_task_status)??null,current_task_matches_run:O(t.current_task_matches_run)??!1,squad_member:O(t.squad_member)??!1,detachment_member:O(t.detachment_member)??!1,last_seen:r(t.last_seen)??null,heartbeat_age_sec:d(t.heartbeat_age_sec)??null,heartbeat_fresh:O(t.heartbeat_fresh)??!1,claim_marker_seen:O(t.claim_marker_seen)??!1,done_marker_seen:O(t.done_marker_seen)??!1,final_marker_seen:O(t.final_marker_seen)??!1,claim_marker:o,done_marker:l,final_marker:c,last_message:p}}function Vp(t){if(!v(t))return;const e=Array.isArray(t.timeline)?t.timeline.map(n=>{if(!v(n))return null;const s=r(n.timestamp),a=d(n.active_slots);if(!s||a==null)return null;const o=Array.isArray(n.active_slot_ids)?n.active_slot_ids.map(l=>typeof l=="number"&&Number.isFinite(l)?l:null).filter(l=>l!=null):[];return{timestamp:s,active_slots:a,active_slot_ids:o}}).filter(n=>n!==null):[];return{slot_url:r(t.slot_url)??null,provider_base_url:r(t.provider_base_url)??null,provider_reachable:O(t.provider_reachable)??null,provider_status_code:d(t.provider_status_code)??null,provider_model_id:r(t.provider_model_id)??null,actual_model_id:r(t.actual_model_id)??null,expected_slots:d(t.expected_slots),actual_slots:d(t.actual_slots),expected_ctx:d(t.expected_ctx),actual_ctx:d(t.actual_ctx),slot_reachable:O(t.slot_reachable)??null,slot_status_code:d(t.slot_status_code)??null,runtime_blocker:r(t.runtime_blocker)??null,detail:r(t.detail)??null,checked_at:r(t.checked_at)??null,total_slots:d(t.total_slots),ctx_per_slot:d(t.ctx_per_slot),active_slots_now:d(t.active_slots_now),peak_active_slots:d(t.peak_active_slots),sample_count:d(t.sample_count),last_sample_at:r(t.last_sample_at)??null,timeline:e}}function Yp(t){const e=v(t)?t:{},n=v(e.summary)?e.summary:void 0;return{version:r(e.version),generated_at:r(e.generated_at),run_id:r(e.run_id),room_id:r(e.room_id),operation_id:r(e.operation_id)??null,recommended_next_tool:r(e.recommended_next_tool),summary:n?{expected_workers:d(n.expected_workers),joined_workers:d(n.joined_workers),live_workers:d(n.live_workers),squad_roster_size:d(n.squad_roster_size),detachment_roster_size:d(n.detachment_roster_size),current_task_bound:d(n.current_task_bound),fresh_heartbeats:d(n.fresh_heartbeats),claim_markers_seen:d(n.claim_markers_seen),done_markers_seen:d(n.done_markers_seen),final_markers_seen:d(n.final_markers_seen),completed_workers:d(n.completed_workers),peak_hot_slots:d(n.peak_hot_slots),hot_window_ok:O(n.hot_window_ok),pass_hot_concurrency:O(n.pass_hot_concurrency),pass_end_to_end:O(n.pass_end_to_end),pending_decisions:d(n.pending_decisions),pass:O(n.pass)}:void 0,provider:Vp(e.provider),operation:Xs(e.operation),squad:bi(e.squad),detachment:mr(e.detachment),workers:Array.isArray(e.workers)?e.workers.map(Jp).filter(s=>s!==null):[],checklist:Array.isArray(e.checklist)?e.checklist.map(Hp).filter(s=>s!==null):[],blockers:Array.isArray(e.blockers)?e.blockers.map(Wp).filter(s=>s!==null):[],recent_messages:Array.isArray(e.recent_messages)?e.recent_messages.map(Gp).filter(s=>s!==null):[],recent_trace_events:Array.isArray(e.recent_trace_events)?e.recent_trace_events.map(gr).filter(s=>s!==null):[],truth_notes:F(e.truth_notes)}}function ue(t){V.value=t,yi(t)&&Qp()}async function br(){As.value=!0,ws.value=null;try{const t=await El();hi.value=Rp(t)}catch(t){ws.value=t instanceof Error?t.message:"Failed to load command-plane summary"}finally{As.value=!1}}function ki(t){De.value=t}async function xi(){Cs.value=!0,Ts.value=null;try{const t=await zl();Mt.value=Ip(t)}catch(t){Ts.value=t instanceof Error?t.message:"Failed to load command-plane snapshot"}finally{Cs.value=!1}}async function Qp(){Mt.value||Cs.value||await xi()}async function Ce(){await br(),yi(V.value)&&await xi()}async function ze(){var t;Ja.value=!0,Ns.value=null;try{const e=await jl(),n=Lp(e);On.value=n;const s=De.value;n.operations.length===0?De.value=null:(!s||!n.operations.some(a=>a.operation.operation_id===s))&&(De.value=((t=n.operations[0])==null?void 0:t.operation.operation_id)??null)}catch(e){Ns.value=e instanceof Error?e.message:"Failed to load chain summary"}finally{Ja.value=!1}}function Xp(){sn=null,An.value=null,Ls.value=!1,Cn.value=null}async function Zp(t){sn=t,Ls.value=!0,Cn.value=null;try{const e=await Ol(t);if(sn!==t)return;An.value=zp(e)}catch(e){if(sn!==t)return;An.value=null,Cn.value=e instanceof Error?e.message:"Failed to load chain run"}finally{sn===t&&(Ls.value=!1)}}async function tm(){Ga.value=!0,Rs.value=null;try{const t=await ql();jn.value=Bp(t)}catch(t){Rs.value=t instanceof Error?t.message:"Failed to load command-plane help"}finally{Ga.value=!1}}async function Bt(t=dp(),e=up()){Ps.value=!0,Ms.value=null;try{const n=await Fl(t,e);_e.value=Yp(n)}catch(n){Ms.value=n instanceof Error?n.message:"Failed to load command-plane swarm view"}finally{Ps.value=!1}}async function Zt(t,e,n){Wa.value=t,Is.value=null;try{await Kl(e,n),await br(),(Mt.value||yi(V.value))&&await xi(),await Bt(),await ze()}catch(s){throw Is.value=s instanceof Error?s.message:"Failed to execute command-plane action",s}finally{Wa.value=null}}function em(t){return Zt(`pause:${t}`,"/api/v1/command-plane/operations/pause",{operation_id:t})}function nm(t){return Zt(`resume:${t}`,"/api/v1/command-plane/operations/resume",{operation_id:t})}function sm(t){return Zt(`recall:${t}`,"/api/v1/command-plane/dispatch/recall",{operation_id:t})}function am(t={}){return Zt("dispatch:tick","/api/v1/command-plane/dispatch/tick",{...t.operationId?{operation_id:t.operationId}:{},...t.detachmentId?{detachment_id:t.detachmentId}:{}})}function im(t){return Zt(`approve:${t}`,"/api/v1/command-plane/policy/approve",{decision_id:t})}function om(t){return Zt(`deny:${t}`,"/api/v1/command-plane/policy/deny",{decision_id:t})}function rm(t,e){return Zt(`freeze:${t}`,"/api/v1/command-plane/policy/freeze",{unit_id:t,enabled:e})}function lm(t,e){return Zt(`kill:${t}`,"/api/v1/command-plane/policy/kill-switch",{unit_id:t,enabled:e})}fd(()=>{Ce(),ze(),(V.value==="swarm"||V.value==="warroom"||_e.value!==null)&&Bt(),V.value==="warroom"&&ut()});const cm="modulepreload",dm=function(t){return"/dashboard/"+t},Vi={},um=function(e,n,s){let a=Promise.resolve();if(n&&n.length>0){let l=function(m){return Promise.all(m.map(u=>Promise.resolve(u).then(_=>({status:"fulfilled",value:_}),_=>({status:"rejected",reason:_}))))};document.getElementsByTagName("link");const c=document.querySelector("meta[property=csp-nonce]"),p=(c==null?void 0:c.nonce)||(c==null?void 0:c.getAttribute("nonce"));a=l(n.map(m=>{if(m=dm(m),m in Vi)return;Vi[m]=!0;const u=m.endsWith(".css"),_=u?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${m}"]${_}`))return;const g=document.createElement("link");if(g.rel=u?"stylesheet":cm,u||(g.as="script"),g.crossOrigin="",g.href=m,p&&g.setAttribute("nonce",p),document.head.appendChild(g),u)return new Promise(($,S)=>{g.addEventListener("load",$),g.addEventListener("error",()=>S(new Error(`Unable to preload CSS for ${m}`)))})}))}function o(l){const c=new Event("vite:preloadError",{cancelable:!0});if(c.payload=l,window.dispatchEvent(c),!c.defaultPrevented)throw l}return a.then(l=>{for(const c of l||[])c.status==="rejected"&&o(c.reason);return e().catch(o)})};function kr(t){if(t==null)return"";if(typeof t=="string")return t;try{return JSON.stringify(t,null,2)}catch{return String(t)}}function G(t){if(!t)return"n/a";const e=Date.parse(t);if(Number.isNaN(e))return t;const n=Math.max(0,Math.round((Date.now()-e)/1e3));return n<60?`${n}s ago`:n<3600?`${Math.round(n/60)}m ago`:n<86400?`${Math.round(n/3600)}h ago`:`${Math.round(n/86400)}d ago`}function pm(t){if(!t)return"warn";const e=Date.parse(t);return Number.isNaN(e)?"warn":e<=Date.now()?"bad":"ok"}function xr(t){if(!t)return"n/a";const e=Date.parse(t);if(Number.isNaN(e))return t;const n=Math.round((e-Date.now())/1e3);return n<=0?"expired":n<60?`in ${n}s`:n<3600?`in ${Math.round(n/60)}m`:n<86400?`in ${Math.round(n/3600)}h`:`in ${Math.round(n/86400)}d`}function M(t){return t==="bad"?"bad":t==="warn"||t==="pending"?"warn":"ok"}let Yi=!1,mm=0;function vm(){return++mm}let oa=null;async function _m(){oa||(oa=um(()=>import("./mermaid.core-C1kG5s24.js").then(e=>e.bE),[]).then(e=>e.default));const t=await oa;return Yi||(t.initialize({startOnLoad:!1,theme:"dark",securityLevel:"loose"}),Yi=!0),t}function Gt(t){if(!t)return"warn";const e=t.toLowerCase();return e.includes("failed")||e.includes("error")||e.includes("disconnected")||e.includes("stopped")?"bad":e.includes("running")||e.includes("active")||e.includes("degraded")||e.includes("pending")?"warn":"ok"}function qn(t){return typeof t!="number"||!Number.isFinite(t)?"n/a":`${Math.round(t*100)}%`}function an(t){return typeof t!="number"||!Number.isFinite(t)?"n/a":t<60?`${Math.round(t)}s`:t<3600?`${Math.round(t/60)}m`:`${Math.round(t/3600)}h`}function Fn(t){return typeof t!="number"||!Number.isFinite(t)?0:Math.max(0,Math.min(100,t))}function ie(t,e){return typeof t!="number"||!Number.isFinite(t)||typeof e!="number"||!Number.isFinite(e)||e<=0?0:Fn(t/e*100)}function fm(t,e){const n=Fn(t);return`--gauge-angle:${Math.max(10,Math.round(n/100*360))}deg;--gauge-color:${e};`}function Sr(t){if(!t)return"No recent chain history";const e=[t.event];return typeof t.duration_ms=="number"&&e.push(`${t.duration_ms}ms`),typeof t.tokens=="number"&&e.push(`${t.tokens} tokens`),t.message&&e.push(t.message),e.join(" · ")}const gm=[{id:"status",label:"현황"},{id:"history",label:"이력"},{id:"control",label:"통제"}],Ar=[{id:"warroom",label:"워룸",group:"status"},{id:"summary",label:"요약",group:"status"},{id:"topology",label:"토폴로지",group:"status"},{id:"swarm",label:"스웜",group:"status"},{id:"operations",label:"작전",group:"history"},{id:"trace",label:"트레이스",group:"history"},{id:"chains",label:"체인",group:"history"},{id:"control",label:"제어",group:"control"},{id:"alerts",label:"알림",group:"control"}],$m=Ar.map(t=>t.id),hm=["chain_start","node_start","node_complete","chain_complete","chain_error"],ym={warroom:{title:"라이브 워룸",description:"실제 run, worker, message, trace를 한 화면에서 따라가는 기본 진입 표면입니다."},operations:{title:"현재 작전 상세",description:"활성 operation, detachment, dependency를 먼저 읽는 기본 진입 표면입니다."},swarm:{title:"스웜 실행 흐름",description:"lane 이동, worker 결속, blocker를 따라가며 현장감 있게 보는 표면입니다."},chains:{title:"체인 런타임",description:"체인 연결 상태와 operation별 실행 그래프를 확인하는 표면입니다."},topology:{title:"지휘 계층",description:"company에서 agent까지 지휘 계층과 live roster를 확인합니다."},alerts:{title:"경보 모음",description:"지금 개입을 밀어올리는 alert만 모아서 보는 표면입니다."},trace:{title:"최근 트레이스",description:"operation, actor, unit 단위 이벤트를 시간순으로 보는 표면입니다."},control:{title:"승인과 제어",description:"decision 승인과 unit 제어를 실제로 수행하는 표면입니다."},summary:{title:"지휘 요약",description:"전체 지휘면을 한 번에 훑는 계기판 성격의 요약 표면입니다."}};function Qi(t){return!!t&&$m.includes(t)}function bm(){const t=E.value.params;return t.source!=="mission"?{}:{source:"mission",...t.action_type?{action_type:t.action_type}:{},...t.target_type?{target_type:t.target_type}:{},...t.target_id?{target_id:t.target_id}:{},...t.focus_kind?{focus_kind:t.focus_kind}:{}}}function Cr(t){const e=bm();if(t==="operations")return e;if(t==="chains"){const n=De.value;return n?{...e,surface:t,operation:n}:{...e,surface:t}}return{...e,surface:t}}function km(){const t=new URLSearchParams(window.location.search),e=new URLSearchParams,n=t.get("agent")??t.get("agent_name"),s=t.get("token");return n&&e.set("agent",n),s&&e.set("token",s),e.toString()?`/api/v1/chains/events?${e.toString()}`:"/api/v1/chains/events"}function xm(t){switch(t){case"company":return"중대 / Company";case"platoon":return"소대 / Platoon";case"squad":return"분대 / Squad";case"agent":return"에이전트 / Agent";default:return t}}function nt(t){return Wa.value===t}function Kn(){return hi.value}function Sm(t){var a,o,l,c,p,m,u;const e=hi.value,n=_e.value,s=On.value;switch(t){case"warroom":return{tool:"masc_observe_operations",reason:"live run, worker, message, trace를 한 화면에서 보고 필요한 detail 표면으로 바로 점프합니다."};case"operations":return{tool:"masc_operation_status",reason:`활성 작전 ${((a=e==null?void 0:e.operations.summary)==null?void 0:a.active)??0}개와 dependency를 먼저 확인합니다.`};case"swarm":return{tool:(n==null?void 0:n.recommended_next_tool)??((l=(o=e==null?void 0:e.swarm_status)==null?void 0:o.recommended_next_action)==null?void 0:l.tool)??"masc_observe_traces",reason:((p=(c=e==null?void 0:e.swarm_status)==null?void 0:c.recommended_next_action)==null?void 0:p.reason)??"lane 이동과 blocker를 보고 다음 probe 도구를 고릅니다."};case"chains":return{tool:(u=(m=s==null?void 0:s.operations[0])==null?void 0:m.preview_run)!=null&&u.chain_id?"masc_chain_run_get":"masc_chain_snapshot",reason:"체인 연결 상태와 최근 run 그래프를 함께 보면 병목을 빨리 좁힐 수 있습니다."};case"topology":return{tool:"masc_observe_topology",reason:"지휘 계층과 live roster를 같이 봐야 빈 squad나 고립 unit을 놓치지 않습니다."};case"alerts":return{tool:"masc_observe_alerts",reason:"경보에서 먼저 문제가 된 unit과 operation을 고릅니다."};case"trace":return{tool:"masc_observe_traces",reason:"trace 흐름으로 원인 이벤트를 바로 따라갈 수 있습니다."};case"control":return{tool:"masc_operator_action",reason:"승인이나 kill switch 같은 실제 조작은 control 표면과 operator action이 이어집니다."};case"summary":default:return{tool:"masc_observe_operations",reason:"요약을 본 뒤에는 현재 작전 표면으로 내려가 실제 움직임을 확인하는 게 가장 빠릅니다."}}}function Am(t){var n;const e=((n=t==null?void 0:t.focus_kind)==null?void 0:n.toLowerCase())??"";return e?e.includes("artifact_scope")||e.includes("routing_confidence")||e.includes("cache_contention")?"microarch":e.includes("leader_offline")||e.includes("roster_offline")?"alerts":e.includes("stale_data")?"swarm":null:null}function Cm(t){var n;const e=((n=t==null?void 0:t.focus_kind)==null?void 0:n.toLowerCase())??"";return e?e.includes("stale_data")||e.includes("leader_offline")||e.includes("roster_offline")||e.includes("managed")?"recommendation":e.includes("gap")?"gaps":null:null}function wm(){if(typeof window>"u")return null;const t=new URLSearchParams(window.location.search),e=t.get("agent")??t.get("agent_name");if(!e)return null;const n=e.trim();return n===""?null:n}function wr(){if(typeof window>"u")return new URLSearchParams;const t=new URLSearchParams(window.location.search),e=window.location.hash.replace(/^#/,""),n=e.indexOf("?");return n>=0&&new URLSearchParams(e.slice(n+1)).forEach((a,o)=>{t.has(o)||t.set(o,a)}),t}function Tm(){const e=wr().get("run_id");if(!e)return null;const n=e.trim();return n===""?null:n}function Tr(){const e=wr().get("operation_id");if(!e)return null;const n=e.trim();return n===""?null:n}function Im(t){if(!t)return null;const e=Date.parse(t);return Number.isNaN(e)?null:Math.max(0,Math.round((Date.now()-e)/1e3))}function Rm(t){return t.status==="claimed"||t.status==="in_progress"}function Pm(t){const e=jn.value;if(!e)return null;for(const n of e.golden_paths){const s=n.steps.find(a=>a.tool===t);if(s)return s}return null}function ra(t){var e;return((e=jn.value)==null?void 0:e.golden_paths.find(n=>n.id===t))??null}function Mm(t){const e=jn.value;if(!e)return[];const n=new Set(t);return e.pitfalls.filter(s=>n.has(s.id))}async function Jt(t){try{await t()}catch{}}function Si(t){return(t==null?void 0:t.trim().toLowerCase())??""}function we(t){const e=Si(t);return e.includes("failed")||e.includes("error")||e.includes("stopped")||e==="paused"?"bad":e.includes("active")||e.includes("running")||e.includes("healthy")||e.includes("ok")?"ok":"warn"}function la(t){const e=Si(t);return e?e==="active"||e==="running"?"진행 중":e==="paused"?"일시정지":e==="done"||e==="ended"||e==="completed"?"완료":e==="failed"||e==="error"||e==="stopped"?"문제":(t==null?void 0:t.trim())||"확인 필요":"확인 필요"}function Nm(){var e,n,s;const t=_e.value;return t?!!(t.run_id||(e=t.operation)!=null&&e.operation_id||(n=t.detachment)!=null&&n.detachment_id||(((s=t.summary)==null?void 0:s.expected_workers)??0)>0||t.workers.length>0||t.recent_messages.length>0||t.recent_trace_events.length>0):!1}function Lm(t){const e=Si(t.status);return e==="active"||e==="running"}function Dm(){var o,l,c,p;const t=((o=pt.value)==null?void 0:o.sessions)??[],e=_e.value,n=((l=e==null?void 0:e.detachment)==null?void 0:l.session_id)??null;if(n){const m=t.find(u=>u.session_id===n);if(m)return m}const s=((c=e==null?void 0:e.operation)==null?void 0:c.operation_id)??Tr();if(s){const m=t.find(u=>u.command_plane_operation_id===s);if(m)return m}const a=((p=e==null?void 0:e.detachment)==null?void 0:p.detachment_id)??null;if(a){const m=t.find(u=>u.command_plane_detachment_id===a);if(m)return m}return t.find(Lm)??t[0]??null}function zm(){const t=En(E.value);return t?i`
    ...
    <section class="command-hero command-hero-summary">
      <div class="command-hero-copy">
        ...
        <span class="command-chip ${M(_>0?"ok":"warn")}">활성 작전 ${_}</span>
          ...
          <span class="command-chip ${M(C>0?"bad":A>0?"warn":"ok")}">치명 알림 ${C}</span>
          <span class="command-chip ${M(x>0?"warn":"ok")}">승인 대기 ${x}</span>
        </div>
      </div>
    ...
    <div class="command-guided-layout">
      <section class="card command-section">
        ...
        <div class="command-readiness-list">
          ${k.map(D=>i`
            <article class="command-readiness-row ${M(D.tone)}">
              <div>
                <div class="command-readiness-title-row">
                  <strong>${D.title}</strong>
                  <span class="command-chip ${M(D.tone)}">${D.tone}</span>
                </div>
                <p>${D.detail}</p>
              </div>
  ...
  `}function Bm(){const t=Mt.value;return i`
    <section class="card command-section">
      <div class="card-title-row">
  ...
  `}function Hm(){const t=Mt.value;return i`
    <section class="card command-section">
      <div class="card-title-row">
      ...
      ${t&&t.alerts.alerts.length>0?i`<div class="command-card-stack">
            ${t.alerts.alerts.map(e=>i`<${Um} alert=${e} />`)}
          </div>`:i`<div class="empty-state">지금 올라온 command-plane 경보는 없습니다.</div>`}
    </section>
  `}function Wm(){const t=Mt.value;return i`
    <section class="card command-section">
      <div class="card-title-row">
  ...
  `}function Gm({total:t}){const n=Math.min(t,20),s=t>20?t-20:0,a=Array.from({length:n});return i`
  ...
  `}function Jm({lane:t}){const e=t.counts??{},n=Rr(t),s=e.workers??0,a=e.operations??0,o=e.detachments??0,l=a+o,c=t.motion_state==="moving"?84:t.motion_state==="waiting"?58:t.motion_state==="terminal"?100:26;return i`
    <article class="swarm-lane-strip ${M(n)}">
      ...
      ${t.hard_flags.length>0?i`
            <div class="swarm-lane-flags">
              ${t.hard_flags.map(p=>i`<span class="command-chip ${M(p.severity)}">${p.code}</span>`)}
            </div>
          `:null}
    </article>
  ...
  `}function Vm({event:t}){const e=t.timestamp?new Date(t.timestamp):null,n=e&&!isNaN(e.getTime())?e:null,s=n?`${String(n.getHours()).padStart(2,"0")}:${String(n.getMinutes()).padStart(2,"0")}`:"";return i`
  ...
  `}function Qm({proof:t}){const e=(t==null?void 0:t.status)==="missing"?"warn":(t==null?void 0:t.pass)===!1?"bad":(t==null?void 0:t.pass)===!0?"ok":"warn";return i`
      ...
      ${s?i`
            ...
            <div class="command-swarm-layout ${u?"compact":""}">
              <div class="command-card-stack">
                ${o.length>0?o.map(_=>i`<${Jm} lane=${_} />`):i`<div class="empty-state">활성 스웜 레인이 없습니다.</div>`}
              </div>
              ...
              <div class="command-card-stack">
                ...
                <div class="command-guide-card ${l.length>0?"warn":"ok"} ${n==="gaps"?"focus":""}">
                  ...
                  ${l.length>0?i`<div class="swarm-event-rail">${l.slice(0,4).map(_=>i`<${Ym} gap=${_} />`)}</div>`:i`<p>지금 보이는 핵심 공백은 없습니다.</p>`}
                </div>
                ...
                <div class="command-guide-card">
                  ...
                  ${c.length>0?i`<div class="swarm-event-rail">${c.map(_=>i`<${Vm} event=${_} />`)}</div>`:i`<p>붙어 있는 최근 이동 이벤트가 아직 없습니다.</p>`}
                </div>
              </div>
            </div>
          `:i`<div class="empty-state">스웜 상태를 아직 불러오지 못했습니다.</div>`}
    </section>
  `}function Zm({item:t}){return i`
    ...
    <div class="command-section-stack">
      ...
      <div class="command-surface-grid">
        <section class="card command-section">
          ...
          ${Ps.value?i`<div class="empty-state">Loading swarm live state…</div>`:Ms.value?i`<div class="empty-state error">${Ms.value}</div>`:t?i`
                    <div class="command-summary-grid">
  ...
  `}function iv(){var U,mt,tt,et,q,Y,b,kt,jt,te,ee,D,xt,ne,Qe,Xe,Un,Bn,Hn,Wn;const t=Kn(),e=_e.value,n=pt.value,s=Rt.value,a=Dm(),o=e!=null&&e.operation?((U=On.value)==null?void 0:U.operations.find(j=>{var ge;return j.operation.operation_id===((ge=e.operation)==null?void 0:ge.operation_id)}))??null:null,l=(e==null?void 0:e.workers)??[],c=(s==null?void 0:s.worker_cards)??[],p=l.length>0?l.map(nv):c.map(sv),m=Nm(),u=((mt=t==null?void 0:t.decisions.summary)==null?void 0:mt.pending)??0,_=(n==null?void 0:n.pending_confirms)??[],g=(e==null?void 0:e.blockers)??[],$=(s==null?void 0:s.recommended_actions)??[],S=(s==null?void 0:s.attention_items)??[],k=((tt=e==null?void 0:e.recent_messages[0])==null?void 0:tt.timestamp)??null,w=((et=e==null?void 0:e.recent_trace_events[0])==null?void 0:et.timestamp)??null,C=k??w??null,A=a==null?void 0:a.summary,x=((q=e==null?void 0:e.summary)==null?void 0:q.expected_workers)??(typeof(A==null?void 0:A.planned_worker_count)=="number"?A.planned_worker_count:void 0)??(s==null?void 0:s.worker_cards.length)??0,I=((Y=e==null?void 0:e.summary)==null?void 0:Y.joined_workers)??(typeof(A==null?void 0:A.active_agent_count)=="number"?A.active_agent_count:void 0)??p.length,P=g.length>0||u>0||_.length>0?"warn":m||a?"ok":"warn",H=((b=t==null?void 0:t.swarm_status)==null?void 0:b.lanes.filter(j=>j.present))??[];return Z(()=>{ut()},[]),Z(()=>{a!=null&&a.session_id&&Be(a.session_id)},[a==null?void 0:a.session_id,n,(kt=e==null?void 0:e.detachment)==null?void 0:kt.session_id]),!m&&!a?Ps.value||xn.value?i`<div class="empty-state">live war room 불러오는 중…</div>`:i`
    ...
    <div class="command-section-stack">
      <section class="command-warroom-strip ${M(P)}">
        ...
        <div class="command-warroom-strip-stats">
          ...
          <div class="monitor-stat-card ${M(g.length>0||u>0?"warn":"ok")}">
            <span>Pressure</span>
                ...
                `:a?i`
                    <article class="command-guide-card">
                      <div class="command-guide-head">
                        ...
                        <span class="command-chip ${M(we(a.status))}">${la(a.status)}</span>
                      </div>
          ...
          <section class="card command-section">
            ...
            ${e&&e.recent_messages.length>0?i`<div class="command-trace-stack">
                  ...
                  `)}
                    ...
                    `)}
                    ${S.slice(0,3).map(j=>i`
                      <article class="command-alert ${M(j.severity)}">
                        <div class="command-card-head">
                          <strong>${j.kind}</strong>
                          <span class="command-chip ${M(j.severity)}">${j.severity}</span>
                        </div>
                        <p>${j.summary}</p>
                      </article>
                    `)}
  ...
  `}function ov({source:t}){const e=sl(null),[n,s]=vo(null);return Z(()=>{let a=!1;const o=e.current;return o?(o.innerHTML="",s(null),(async()=>{try{const c=await _m(),{svg:p}=await c.render(`command-chain-${vm()}`,t);if(a||!e.current)return;e.current.innerHTML=p}catch(c){if(a)return;s(c instanceof Error?c.message:"Mermaid render failed")}})(),()=>{a=!0,e.current&&(e.current.innerHTML="")}):void 0},[t]),i`
    <div class="command-chain-graph-shell">
      ${n?i`<div class="empty-state error">${n}</div>`:null}
      <div class="command-chain-graph" ref=${e}></div>
    </div>
  `}function rv({overlay:t,selected:e,onSelect:n}){const s=t.operation.chain,a=t.runtime;return i`
    <button class="command-chain-item ${e?"selected":""}" onClick=${n}>
      ...
      <div class="command-tag-row">
        ...
        ${a?i`<span class="command-tag ${Gt(s==null?void 0:s.status)}">${qn(a.progress)} progress</span>`:null}
      </div>
  ...
  `}function dv({card:t}){const e=t.operation,n=`pause:${e.operation_id}`,s=`resume:${e.operation_id}`,a=`recall:${e.operation_id}`,o=e.chain,l=(o==null?void 0:o.run_id)??null;return i`
    <article class="command-card">
      ...
      <div class="command-action-row">
        ...
        ${e.source==="managed"&&e.status==="active"?i`
              <button class="control-btn ghost" disabled=${nt(n)} onClick=${()=>Jt(()=>em(e.operation_id))}>
                ${nt(n)?"Pausing…":"Pause"}
              </button>
              <button class="control-btn ghost" disabled=${nt(a)} onClick=${()=>Jt(()=>sm(e.operation_id))}>
                ${nt(a)?"Recalling…":"Recall"}
              </button>
            `:null}
        ${e.source==="managed"&&e.status==="paused"?i`
              <button class="control-btn ghost" disabled=${nt(s)} onClick=${()=>Jt(()=>nm(e.operation_id))}>
                ${nt(s)?"Resuming…":"Resume"}
              </button>
            `:null}
      </div>
    </article>
  `}function uv({card:t}){var n;const e=t.detachment;return i`
    <article class="command-card compact">
      <div class="command-card-head">
        <div>
      ...
      <div class="command-tag-row">
        ${e.heartbeat_deadline?i`<span class="command-tag ${pm(e.heartbeat_deadline)}">
              deadline ${e.heartbeat_deadline}
            </span>`:null}
      </div>
    </article>
  `}function pv(){const t=Mt.value;return i`
    <div class="command-surface-grid">
      <section class="card command-section">
        <div class="card-title-row">
        ...
        ${t&&t.operations.operations.length>0?i`<div class="command-card-stack">
              ${t.operations.operations.map(e=>i`<${dv} card=${e} />`)}
      ...
      <section class="card command-section">
        ...
        <div class="command-chain-history">
          ...
          ${t&&t.recent_history.length>0?i`
                <div class="command-card-stack">
                  ${t.recent_history.slice(0,6).map(U=>i`<${lv} item=${U} />`)}
                </div>
        ...
        ${s?i`
              <article class="command-card">
                ...
                <div class="command-card-grid">
                  ...
                  <span>Progress</span><span>${qn((A=s.runtime)==null?void 0:A.progress)}</span>
  ...
  `}function vv({decision:t}){const e=`approve:${t.decision_id}`,n=`deny:${t.decision_id}`,s=t.source==="projected_operator";return i`
    <article class="command-card ${M(t.status)}">
      ...
      ${t.status==="pending"&&!s?i`
            <div class="command-action-row">
              <button class="control-btn ghost" disabled=${nt(e)} onClick=${()=>Jt(()=>im(t.decision_id))}>
                ${nt(e)?"Approving…":"Approve"}
              </button>
              <button class="control-btn ghost" disabled=${nt(n)} onClick=${()=>Jt(()=>om(t.decision_id))}>
                ${nt(n)?"Denying…":"Deny"}
              </button>
            </div>
          `:null}
  ...
  `}function _v({row:t}){var c,p,m;const e=t.unit,n=`freeze:${e.unit_id}`,s=`kill:${e.unit_id}`,a=!!((c=e.policy)!=null&&c.frozen),o=!!((p=e.policy)!=null&&p.kill_switch),l=Math.round((t.utilization??0)*100);return i`
    <article class="command-card compact">
      <div class="command-card-head">
        <div>
      ...
      <div class="command-action-row">
        <button class="control-btn ghost" disabled=${nt(n)} onClick=${()=>Jt(()=>rm(e.unit_id,!a))}>
          ${nt(n)?"Applying…":a?"Unfreeze":"Freeze"}
        </button>
        <button class="control-btn ghost" disabled=${nt(s)} onClick=${()=>Jt(()=>lm(e.unit_id,!o))}>
          ${nt(s)?"Applying…":o?"Clear Kill Switch":"Enable Kill Switch"}
        </button>
      </div>
    </article>
  `}function fv(){const t=Mt.value;return i`
    <div class="command-surface-grid">
      <section class="card command-section">
        <div class="card-title-row">
        ...
        ${t&&t.decisions.decisions.length>0?i`<div class="command-card-stack">
              ${t.decisions.decisions.map(e=>i`<${vv} decision=${e} />`)}
      ...
      <section class="card command-section">
        ...
        ${t&&t.capacity.capacity.length>0?i`<div class="command-card-stack">
              ${t.capacity.capacity.map(e=>i`<${_v} row=${e} />`)}
  ...
  `}function $v(){if(V.value==="warroom")return i`<${iv} />`;if(V.value==="summary")return i`<${Fm} />`;if(V.value==="swarm")return i`<${ev} />`;if(!Mt.value)return i`<${Km} />`;switch(V.value){case"chains":return i`<${mv} />`;case"topology":return i`<${Bm} />`;case"alerts":return i`<${Hm} />`;case"trace":return i`<${Wm} />`;case"control":return i`<${fv} />`;case"operations":default:return i`<${pv} />`}}function hv(){return Z(()=>{Ce(),ze(),tm(),Bt()},[]),Z(()=>{if(E.value.tab!=="command")return;const t=E.value.params.surface,e=E.value.params.operation,n=En(E.value);if(Qi(t))ue(t);else if(n){const s=Ho(n);Qi(s)&&ue(s)}else t||ue("warroom");e&&ki(e),(t==="swarm"||t==="warroom"||V.value==="warroom")&&Bt(),(t==="warroom"||V.value==="warroom")&&ut()},[E.value.tab,E.value.params.surface,E.value.params.operation,E.value.params.operation_id,E.value.params.run_id,E.value.params.source,E.value.params.action_type,E.value.params.target_type,E.value.params.target_id,E.value.params.focus_kind]),Z(()=>{let t=null;const e=()=>{t||(t=window.setTimeout(()=>{t=null,Ce(),ze(),(V.value==="swarm"||V.value==="warroom")&&Bt(),V.value==="warroom"&&ut()},250))},n=new EventSource(km()),s=hm.map(a=>{const o=()=>e();return n.addEventListener(a,o),{type:a,handler:o}});return n.onerror=()=>{e()},()=>{s.forEach(({type:a,handler:o})=>{n.removeEventListener(a,o)}),n.close(),t&&window.clearTimeout(t)}},[]),Z(()=>{const t=window.setInterval(()=>{if(document.visibilityState==="hidden")return;const e=V.value;e!=="swarm"&&e!=="warroom"||(Ce(),Bt(),e==="warroom"&&ut())},5e3);return()=>{window.clearInterval(t)}},[]),i`
    <section class="dashboard-panel command-plane-view">
      <div class="panel-header">
        ...
        <div class="panel-actions">
          ...
          <button
            class="control-btn ghost"
            onClick=${()=>{Ce(),ze(),Bt(),V.value==="warroom"&&ut()}}
            disabled=${As.value}
          >
      ...
      <${zm} />
      ${V.value==="warroom"?null:i`<${Em} />`}
      <${gv} />
      <${$v} />
    </section>
  `}const Lr="masc_dashboard_agent_name";function yv(){var e,n,s;const t=new URLSearchParams(window.location.search);return((e=t.get("agent"))==null?void 0:e.trim())||((n=t.get("agent_name"))==null?void 0:n.trim())||((s=localStorage.getItem(Lr))==null?void 0:s.trim())||"dashboard"}const Zs=f(yv()),Ee=f(""),Va=f("운영 점검"),je=f(""),wn=f(""),Tn=f("2"),He=f(""),Tt=f("note"),In=f(""),Rn=f(""),Pn=f(""),Mn=f("2"),Ds=f("운영자 중지 요청"),zs=f(""),Oe=f(""),Qn=f(null);function bv(t){const e=t.trim()||"dashboard";Zs.value=e,localStorage.setItem(Lr,e)}function Dr(t){if(t==null)return"";if(typeof t=="string")return t;try{return JSON.stringify(t,null,2)}catch{return String(t)}}function kv(t){return typeof t!="number"||!Number.isFinite(t)?"확인 없음":t<60?`${Math.round(t)}초 전`:t<3600?`${Math.round(t/60)}분 전`:`${Math.round(t/3600)}시간 전`}function We(t){return typeof t=="string"?t.trim().toLowerCase():""}function xv(t){var s;const e=We(t.status);if(e==="paused")return"bad";if(e===""||e==="unknown")return"warn";const n=We((s=t.team_health)==null?void 0:s.status);return n&&n!=="ok"&&n!=="healthy"&&n!=="green"||e&&e!=="active"&&e!=="running"&&e!=="ended"?"warn":"ok"}function ca(t){const e=We(t.status);return e==="offline"||e==="inactive"||e==="error"?"bad":e===""||e==="unknown"||(t.context_ratio??0)>=.8||t.context_ratio==null||t.last_turn_ago_s==null||(t.last_turn_ago_s??0)>=3600?"warn":"ok"}function Zi(t){return t.some(e=>We(e.severity)==="bad")?"bad":t.length>0?"warn":"ok"}function Sv(t){return t.target_type==="team_session"}function Av(t){return t.target_type==="keeper"}function Es(t){switch(t){case"broadcast":return"방송";case"room_pause":return"room 일시정지";case"room_resume":return"room 재개";case"team_turn":return"세션 업데이트";case"team_note":return"세션 노트";case"team_broadcast":return"세션 방송";case"team_task_inject":return"세션 작업 주입";case"task_inject":return"작업 주입";case"team_stop":return"세션 중지";case"keeper_message":return"keeper 메시지";case"keeper_msg":return"keeper 메시지";default:return(t==null?void 0:t.trim())||"액션"}}function js(t){switch(t){case"room":return"room";case"team_session":return"session";case"keeper":return"keeper";default:return(t==null?void 0:t.trim())||"target"}}function on(t){switch(We(t)){case"running":case"active":return"진행 중";case"paused":return"일시정지";case"ended":case"done":return"종료";case"offline":return"오프라인";case"idle":return"대기";case"unknown":case"":return"확인 필요";default:return(t==null?void 0:t.trim())||"확인 필요"}}function zr(t){return t?"확인 후 실행":"즉시 실행"}function Cv(t){switch(t){case"note":return"노트";case"broadcast":return"방송";case"task":return"작업";default:return t}}function rt(t,e){if(!t)return null;const n=t[e];return typeof n=="string"&&n.trim()!==""?n.trim():typeof n=="number"&&Number.isFinite(n)?String(n):null}function wv(t){if(t.action_type==="team_task_inject")return"task";if(t.action_type==="team_broadcast")return"broadcast";if(t.action_type==="team_note")return"note";if(t.action_type==="team_turn"){const e=rt(t.suggested_payload,"turn_kind");if(e==="broadcast"||e==="task")return e}return"note"}function Tv(t){const e=t.suggested_payload;if(t.target_type==="room"){if(t.action_type==="broadcast"){Ee.value=rt(e,"message")??t.summary;return}t.action_type==="task_inject"&&(je.value=rt(e,"title")??"운영자 주입 작업",wn.value=rt(e,"description")??t.summary,Tn.value=rt(e,"priority")??Tn.value);return}if(t.target_type==="team_session"){if(t.target_id&&(He.value=t.target_id),t.action_type==="team_stop"){Ds.value=rt(e,"reason")??t.summary;return}Tt.value=wv(t);const n=rt(e,"message");n&&(In.value=n),Tt.value==="task"&&(Rn.value=rt(e,"task_title")??rt(e,"title")??"운영자 주입 작업",Pn.value=rt(e,"task_description")??rt(e,"description")??t.summary,Mn.value=rt(e,"task_priority")??rt(e,"priority")??Mn.value);return}t.target_type==="keeper"&&(t.target_id&&(zs.value=t.target_id),Oe.value=rt(e,"message")??t.summary)}function Iv(t,e,n){return!t||!t.target_type||t.target_type==="room"?!0:t.target_type==="team_session"?!!t.target_id&&e.some(s=>s.session_id===t.target_id):t.target_type==="keeper"?!!t.target_id&&n.some(s=>s.name===t.target_id):!0}async function fe(t){const e=Zs.value.trim()||"dashboard";try{const n=await Mu({actor:e,action_type:t.action_type,target_type:t.target_type,target_id:t.target_id,payload:t.payload});return n.confirm_required?R("확인 대기열에 올렸습니다","warning"):R(t.successMessage,"success"),n}catch(n){const s=n instanceof Error?n.message:"개입 실행에 실패했습니다";return R(s,"error"),null}}async function to(){const t=Ee.value.trim();if(!t)return;await fe({action_type:"broadcast",target_type:"room",payload:{message:t},successMessage:"방송을 보냈습니다"})&&(Ee.value="")}async function Rv(){await fe({action_type:"room_pause",target_type:"room",payload:{reason:Va.value.trim()||"운영 점검"},successMessage:"room 일시정지를 요청했습니다"})}async function Er(){await fe({action_type:"room_resume",target_type:"room",payload:{},successMessage:"room 재개를 요청했습니다"})}async function Pv(){const t=je.value.trim();if(!t)return;await fe({action_type:"task_inject",target_type:"room",payload:{title:t,description:wn.value.trim()||"Intervene 화면에서 주입",priority:Number.parseInt(Tn.value,10)||2},successMessage:"작업 주입을 보냈습니다"})&&(je.value="",wn.value="")}async function Mv(){var l;const t=pt.value,e=He.value||((l=t==null?void 0:t.sessions[0])==null?void 0:l.session_id)||"";if(!e){R("먼저 세션을 고르세요","warning");return}const n={},s=In.value.trim();s&&(n.message=s);let a="team_note";Tt.value==="broadcast"?a="team_broadcast":Tt.value==="task"&&(a="team_task_inject"),Tt.value==="task"&&(n.task_title=Rn.value.trim()||"운영자 주입 작업",n.task_description=Pn.value.trim()||"Intervene 화면에서 주입",n.task_priority=Number.parseInt(Mn.value,10)||2),await fe({action_type:a,target_type:"team_session",target_id:e,payload:n,successMessage:"세션 액션을 적용했습니다"})&&(In.value="",Tt.value==="task"&&(Rn.value="",Pn.value=""))}async function Nv(){var n;const t=pt.value,e=He.value||((n=t==null?void 0:t.sessions[0])==null?void 0:n.session_id)||"";if(!e){R("먼저 세션을 고르세요","warning");return}await fe({action_type:"team_stop",target_type:"team_session",target_id:e,payload:{reason:Ds.value.trim()||"운영자 중지 요청"},successMessage:"세션 중지를 요청했습니다"})}async function Lv(){var a;const t=pt.value,e=zs.value||((a=t==null?void 0:t.keepers[0])==null?void 0:a.name)||"",n=Oe.value.trim();if(!e){R("먼저 keeper를 고르세요","warning");return}if(!n)return;await fe({action_type:"keeper_message",target_type:"keeper",target_id:e,payload:{message:n},successMessage:`${e}에게 메시지를 보냈습니다`})&&(Oe.value="")}async function Dv(t){const e=Zs.value.trim()||"dashboard";try{await Nu(e,t),R("확인 실행을 완료했습니다","success")}catch(n){const s=n instanceof Error?n.message:"확인 실행에 실패했습니다";R(s,"error")}}function zv(){const t=pt.value,e=fi.value,n=(t==null?void 0:t.room)??{},s=(t==null?void 0:t.pending_confirms)??[],a=(t==null?void 0:t.recent_messages)??[],o=(e==null?void 0:e.recommended_actions)??[],l=a.slice(0,5);return i`
      ...
      <section class="card ops-panel ops-lane-panel">
        ...
        <div class="control-row ops-split-row">
          <input
            ...
            disabled=${B.value}
          />
          <button class="control-btn ghost" onClick=${()=>{Rv()}} disabled=${B.value}>
            일시정지
          </button>
        ...
        <div class="control-row ops-split-row">
          ...
          <button class="control-btn" onClick=${()=>{Pv()}} disabled=${B.value||je.value.trim()===""}>
            주입
          </button>
        </div>
      </section>
            ...
            ${s.map(c=>i`
              <article key=${c.confirm_token} class="ops-confirmation-card">
                ...
                <div class="ops-confirmation-actions">
                  <button class="control-btn" onClick=${()=>{Dv(c.confirm_token)}} disabled=${B.value}>
                    실행
                  </button>
  ...
  `}function Ev(){const t=pt.value,e=Rt.value,n=(t==null?void 0:t.sessions)??[],s=n.find(a=>a.session_id===He.value)??n[0]??null;return i`
    <div class="ops-column">
      <section class="card ops-panel ops-lane-panel">
        <div class="card-title-row">
      ...
      <section class="card ops-panel ops-lane-panel">
        ...
        <div class="control-row ops-split-row">
          ...
          <button class="control-btn" onClick=${()=>{Mv()}} disabled=${B.value||!s}>
            적용
          </button>
        </div>
        <div class="ops-context-note">현재 선택: ${Cv(Tt.value)}</div>
  ...
  `}function jv(){var a;const t=pt.value,e=(t==null?void 0:t.keepers)??[],n=(t==null?void 0:t.available_actions)??[],s=e.find(o=>o.name===zs.value)??e[0]??null;return i`
    <div class="ops-column">
          ...
          ${e.length===0?i`<div class="ops-empty">지금 보이는 keeper가 없습니다.</div>`:e.map(o=>i`
            ...
            >
              ...
              <div class="ops-entity-meta">
                ...
                <span>${kv(o.last_turn_ago_s)}</span>
              </div>
            </button>
          `)}
        </div>
      ...
      <section class="card ops-panel ops-lane-panel">
        ...
        ></textarea>
        <div class="control-row">
          <button class="control-btn" onClick=${()=>{Lv()}} disabled=${B.value||!s||Oe.value.trim()===""}>
            keeper에 보내기
          </button>
        </div>
      </section>
  ...
  `}function Ov(){var k,w;const t=pt.value,e=E.value.tab==="intervene"?En(E.value):null,n=fi.value,s=(t==null?void 0:t.room)??{},a=(t==null?void 0:t.sessions)??[],o=(t==null?void 0:t.keepers)??[],l=(t==null?void 0:t.pending_confirms)??[],c=a.find(C=>C.session_id===He.value)??a[0]??null,p=(n==null?void 0:n.attention_items)??[],m=p.filter(Sv),u=p.filter(Av),_=a.filter(C=>xv(C)!=="ok"),g=o.filter(C=>ca(C)!=="ok"),$=Iv(e,a,o);Z(()=>{me()},[]),Z(()=>{if(E.value.tab!=="intervene"){Qn.value=null;return}if(!e){Qn.value=null;return}Qn.value!==e.id&&(Qn.value=e.id,Tv(e))},[E.value.tab,E.value.params.source,E.value.params.action_type,E.value.params.target_type,E.value.params.target_id,E.value.params.focus_kind,e==null?void 0:e.id]),Z(()=>{const C=(c==null?void 0:c.session_id)??null;Be(C)},[c==null?void 0:c.session_id]);const S=[{key:"room",label:"Room 게이트",value:s.paused?"일시정지":"열림",detail:s.paused?`재개 전환 대기 중${s.pause_reason?` · ${s.pause_reason}`:""}`:"지금은 새 액션과 새 작업을 바로 받을 수 있습니다",tone:s.paused?"bad":"ok"},{key:"confirm",label:"확인 대기",value:l.length,detail:l.length>0?"미리보기만 된 개입이 아직 사람 확인을 기다리고 있습니다":"지금 막혀 있는 확인 대기는 없습니다",tone:l.length>0?"warn":"ok"},{key:"session",label:"세션 리스크",value:m.length>0?m.length:a.length,detail:m.length>0?((k=m[0])==null?void 0:k.summary)??"세션 중 하나가 방향 수정이나 중지 판단을 기다리고 있습니다":a.length===0?"지금 관리 중인 team session이 없습니다":"세션 쪽 긴급 attention은 현재 없습니다",tone:m.length>0?Zi(m):a.length===0?"warn":_.some(C=>We(C.status)==="paused")?"bad":_.length>0?"warn":"ok"},{key:"keeper",label:"Keeper 압력",value:u.length>0?u.length:g.length,detail:u.length>0?((w=u[0])==null?void 0:w.summary)??"직접 메시지나 상태 점검이 필요한 keeper가 있습니다":g.length>0?"stale, offline, telemetry 누락 keeper가 보입니다":"지금은 keeper 쪽이 비교적 안정적입니다",tone:u.length>0?Zi(u):g.some(C=>ca(C)==="bad")?"bad":g.length>0?"warn":"ok"}];return i`
  ...
  `}function qv({text:t}){if(!t)return null;const e=Fv(t);return i`<div class="markdown-content">${e}</div>`}function Fv(t){const e=t.split(`
...
`))}</p>`)}return n}function da(t){const e=[],n=/(`[^`]+`)|(\*\*[^*]+\*\*)|(\*[^*]+\*)|\[([^\]]+)\]\(([^)]+)\)/g;let s=0,a;for(;(a=n.exec(t))!==null;){if(a.index>s&&e.push(t.slice(s,a.index)),a[1]){const o=a[1].slice(1,-1);e.push(i`<code>${o}</code>`)}else if(a[2]){const o=a[2].slice(2,-2);e.push(i`<strong>${o}</strong>`)}else if(a[3]){const o=a[3].slice(1,-1);e.push(i`<em>${o}</em>`)}else a[4]&&a[5]&&e.push(i`<a href=${a[5]} target="_blank" rel="noopener">${a[4]}</a>`);s=a.index+a[0].length}return s<t.length&&e.push(t.slice(s)),e.length>0?e:[t]}const jr=[{id:"recent",label:"Latest"},{id:"hot",label:"Hot"},{id:"trending",label:"Trending"},{id:"updated",label:"Updated"},{id:"discussed",label:"Discussed"}],cs=f(null),ds=f([]),Ge=f(!1),de=f(null),pn=f(""),mn=f(!1),Te=f(!0),Ci=20,ke=f(Ci);function Kv(){var e,n;const t=new URLSearchParams(window.location.search);return((e=t.get("agent"))==null?void 0:e.trim())||((n=t.get("agent_name"))==null?void 0:n.trim())||"dashboard-user"}const Uv=f(Kv());function Bv(t){const e=t.replace(/!\[[^\]]*\]\([^)]+\)/g," ").replace(/\[[^\]]+\]\([^)]+\)/g,"$1").replace(/[`#>*_~-]/g," ").replace(/\s+/g," ").trim();return e?e.length>180?`${e.slice(0,177)}...`:e:"No preview available"}function eo(t){return t.updated_at!==t.created_at}function Hv(t){const e=`${t.title} ${t.author} ${t.tags.join(" ")} ${t.flair??""}`.toLowerCase();return/\b(test|smoke|harness|sandbox|dummy|sample|tmp|qa|e2e)\b/.test(e)||e.includes("테스트")||e.includes("실험")}function Wv(t){if(t.post_kind)return t.post_kind==="automation";const e=(t.hearth??"").toLowerCase();return t.visibility!=="internal"||!t.expires_at||!e?!1:!!(e.startsWith("mdal")||e.includes("harness"))}function Or(t){return Te.value?t.filter(e=>Wv(e)?!1:e.post_kind||e.hearth||e.visibility||e.expires_at?!0:!Hv(e)):t}async function wi(t){de.value=t,cs.value=null,ds.value=[],Ge.value=!0;try{const e=await Jl(t);if(de.value!==t)return;cs.value={id:e.id,author:e.author,title:e.title,content:e.content,tags:e.tags,votes:e.votes,vote_balance:e.vote_balance,comment_count:e.comment_count,created_at:e.created_at,updated_at:e.updated_at,post_kind:e.post_kind,flair:e.flair,hearth:e.hearth,visibility:e.visibility,expires_at:e.expires_at,hearth_count:e.hearth_count},ds.value=e.comments??[]}catch{de.value===t&&(cs.value=null,ds.value=[])}finally{de.value===t&&(Ge.value=!1)}}async function no(t){const e=pn.value.trim();if(e){mn.value=!0;try{await Vl(t,Uv.value,e),pn.value="",R("Comment posted","success"),await wi(t),Ht()}catch{R("Failed to post comment","error")}finally{mn.value=!1}}}function Gv(){const t=hn.value,e=Te.value?"Hiding automation posts":"Show automation posts";return i`
  ...
  `}function Jv({post:t}){const e=async(n,s)=>{s.stopPropagation();try{await Co(t.id,n),Ht()}catch{R("Failed to vote","error")}};return i`
    <div class="board-post" onClick=${()=>ll(t.id)}>
      ...
      <div class="post-content">
        ...
        <div class="post-snippet">${Bv(t.content)}</div>
      </div>
    </div>
  `}function Vv({comments:t}){return t.length===0?i`<div class="empty-state" style="font-size:13px">No comments yet</div>`:i`
  ...
  `}function Qv({post:t}){de.value!==t.id&&!Ge.value&&wi(t.id);const e=async n=>{try{await Co(t.id,n),Ht()}catch{R("Failed to vote","error")}};return i`
    <div>
      ...
      <${T} title="Comments" semanticId="memory.feed">
        ${Ge.value?i`<div class="loading-indicator">Loading comments...</div>`:i`<${Vv} comments=${ds.value} />`}
        <${Yv} postId=${t.id} />
      <//>
    </div>
  `}function Xv(){const t=Or($n.value),e=E.value.params.post??null,n=e?t.find(s=>s.id===e)??(de.value===e?cs.value:null):null;return e&&!n&&de.value!==e&&!Ge.value&&wi(e),e?n?i`
          <${gt} surfaceId="memory" />
          <${ua} />
          <${Qv} post=${n} />
        `:i`
      ...
      ${yn.value?i`<div class="loading-indicator">Loading memory feed...</div>`:t.length===0?i`<div class="empty-state">No posts in durable memory right now</div>`:i`
              <${T} title="Posts / Comments" class="section" semanticId="memory.feed">
                <div class="board-post-list">
                  ${t.slice(0,ke.value).map(s=>i`<${Jv} key=${s.id} post=${s} />`)}
                </div>
                ${t.length>ke.value?i`
  ...
  `}function qr({ratio:t,size:e=40,stroke:n=4}){if(t==null)return null;const s=(e-n)/2,a=e/2,o=2*Math.PI*s,l=o*((100-t*100)/100);let c="mitosis-safe";return t>=.8?c="mitosis-critical":t>=.5&&(c="mitosis-warn"),i`
  ...
  `}const pa=600*1e3,Zv=1200*1e3,so=.8;function Ft(t){if(t==null)return 0;const e=typeof t=="number"?t:Date.parse(t);return Number.isNaN(e)?0:e}function ye(t){switch(t){case"bad":return 2;case"warn":return 1;default:return 0}}function t_(t){switch(t){case"working":return"작업 중";case"watching":return"대기 중";case"quiet":return"조용함";case"offline":return"오프라인"}}function e_(t){switch(t){case"critical":return"위험";case"warning":return"주의";default:return"정상"}}function n_(t){return typeof t!="number"||Number.isNaN(t)?"—":`${Math.round(t*100)}%`}function s_(t){var e,n,s,a;return((n=(e=t.agent)==null?void 0:e.current_task)==null?void 0:n.trim())||((s=t.skill_primary)==null?void 0:s.trim())||((a=t.last_proactive_reason)==null?void 0:a.trim())||"현재 포커스 없음"}function a_(t){const e=[`Gen ${t.generation??"—"}`,`Turns ${t.turn_count??0}`,`Handoffs ${t.handoff_count_total??0}`];return(t.compaction_count??0)>0&&e.push(`Compactions ${t.compaction_count}`),e.join(" · ")}function i_(t){var p,m;const e=li.value.get(t.name.trim().toLowerCase())??{activeAssignedCount:0,lastActivityAt:null,lastActivityText:null},n=e.lastActivityAt??t.last_seen??null,s=n?Math.max(0,Date.now()-Ft(n)):Number.POSITIVE_INFINITY,a=!!((p=t.current_task)!=null&&p.trim())||e.activeAssignedCount>0;let o="watching",l="ok",c="Healthy live signal";return t.status==="offline"||t.status==="inactive"?(o="offline",l="bad",c=n?"Offline or inactive":"No recent presence"):s>Zv?(o="quiet",l="bad",c=a?"Working without a fresh signal":"No fresh agent signal"):a?(o="working",l=s>pa?"warn":"ok",c=s>pa?"Execution looks quiet for too long":"Task and live signal aligned"):s>pa?(o="quiet",l="warn",c="Quiet but still reachable"):t.status==="idle"&&(o="watching",l="ok",c="Standing by for the next task"),{agent:t,motion:e,lastSignalAt:n,activeTaskCount:e.activeAssignedCount,state:o,tone:l,focus:((m=t.current_task)==null?void 0:m.trim())||(e.activeAssignedCount>0?`${e.activeAssignedCount} claimed tasks waiting for explicit current_task`:e.lastActivityText??"Idle / waiting for assignment"),note:c}}function o_(t){const e=Qc.value.get(t.name)??"idle",n=td.value.has(t.name),s=t.context_ratio??0;let a="healthy",o="ok",l="하트비트와 컨텍스트 상태가 안정적입니다";return t.status==="offline"||n||e==="handoff-imminent"?(a="critical",o="bad",l=n?"하트비트 지연":e==="handoff-imminent"?"핸드오프 임박":"keeper 오프라인"):(e==="preparing"||e==="compacting"||s>=so)&&(a="warning",o="warn",l=s>=so?"컨텍스트 압력이 높습니다":e==="compacting"?"컴팩팅 진행 중":"핸드오프 준비 중"),{keeper:t,lifecycle:e,state:a,tone:o,focus:s_(t),note:l}}function nn({label:t,value:e,color:n,caption:s}){return i`
    <div class="stat-card">
      <div class="stat-label">${t}</div>
      <div class="stat-value" style=${n?`color:${n}`:""}>${e}</div>
      ${s?i`<div class="monitor-stat-caption">${s}</div>`:null}
    </div>
  `}function r_({item:t}){const e=t.kind==="agent"?()=>Ke(t.agent.name):()=>$i(t.keeper);return i`
  ...
  `}function ao({row:t}){const{agent:e,motion:n}=t;return i`
    <button class="monitor-row ${t.tone} state-${t.state}" onClick=${()=>Ke(e.name)}>
      <div class="monitor-row-header">
        ...
        <${Xt} status=${e.status} />
        <span class="monitor-pill ${t.tone} state-${t.state}">${t_(t.state)}</span>
      </div>
  ...
  `}function l_({row:t}){const{keeper:e}=t;return i`
    <button class="monitor-row ${t.tone} state-${t.state}" onClick=${()=>$i(e)}>
      <div class="monitor-row-header">
        ...
        <${qr} ratio=${e.context_ratio} size=${34} stroke=${4} />
        <${Xt} status=${e.status} />
        <span class="monitor-pill ${t.tone}">${e_(t.state)}</span>
      </div>
      ...
      <div class="monitor-meta">
        ...
        <span>컨텍스트 ${n_(e.context_ratio)}</span>
        ${e.model?i`<span>${e.model}</span>`:null}
      </div>
  ...
  `}function c_(){const t=[...bt.value].map(i_).sort((u,_)=>{const g=ye(_.tone)-ye(u.tone);if(g!==0)return g;const $=_.activeTaskCount-u.activeTaskCount;return $!==0?$:Ft(_.lastSignalAt)-Ft(u.lastSignalAt)}),e=[...Et.value].map(o_).sort((u,_)=>{const g=ye(_.tone)-ye(u.tone);if(g!==0)return g;const $=(_.keeper.context_ratio??0)-(u.keeper.context_ratio??0);return $!==0?$:Ft(_.keeper.last_heartbeat)-Ft(u.keeper.last_heartbeat)}),n=t.filter(u=>u.state!=="offline"),s=t.filter(u=>u.state==="offline"),a=n.length,o=t.filter(u=>u.state==="working").length,l=t.filter(u=>u.lastSignalAt&&Date.now()-Ft(u.lastSignalAt)<=12e4).length,c=t.filter(u=>u.tone!=="ok"),p=e.filter(u=>u.tone!=="ok"),m=[...p.map(u=>({kind:"keeper",key:`keeper-${u.keeper.name}`,tone:u.tone,title:u.keeper.name,subtitle:`${u.note} · ${u.focus}`,timestamp:u.keeper.last_heartbeat??null,keeper:u.keeper})),...c.map(u=>({kind:"agent",key:`agent-${u.agent.name}`,tone:u.tone,title:u.agent.name,subtitle:`${u.note} · ${u.focus}`,timestamp:u.lastSignalAt,agent:u.agent}))].sort((u,_)=>{const g=ye(_.tone)-ye(u.tone);return g!==0?g:Ft(_.timestamp)-Ft(u.timestamp)}).slice(0,8);return i`
    <div class="agents-monitor">
      ...
      <${T} title="Execution Priorities" class="section" semanticId="execution.priority_queue">
        ...
        <div class="monitor-alert-list">
          ${m.length===0?i`<div class="empty-state">지금은 실행 경고가 없습니다</div>`:m.map(u=>i`<${r_} key=${u.key} item=${u} />`)}
        </div>
      <//>
      ...
      <div class="agents-workbench">
        ...
        <${T} title="Continuity" class="section" semanticId="execution.continuity">
          ...
          <div class="monitor-list">
            ${e.length===0?i`<div class="empty-state">활성 keeper가 없습니다</div>`:e.map(u=>i`<${l_} key=${u.keeper.name} row=${u} />`)}
          </div>
        <//>
  ...
  `}const Os=f("all"),qs=f("all"),Ya=f(new Set);function d_(t){const e=new Set(Ya.value);e.has(t)?e.delete(t):e.add(t),Ya.value=e}const Fr=yt(()=>{let t=Re.value;return Os.value!=="all"&&(t=t.filter(e=>e.horizon===Os.value)),qs.value!=="all"&&(t=t.filter(e=>e.status===qs.value)),t}),u_=yt(()=>{const t={short:[],mid:[],long:[]};for(const e of Fr.value){const n=t[e.horizon];n&&n.push(e)}return t}),p_=yt(()=>{const t=Array.from(Mo.value.values());return t.sort((e,n)=>e.status==="running"&&n.status!=="running"?-1:n.status==="running"&&e.status!=="running"?1:e.status==="interrupted"&&n.status!=="interrupted"?-1:n.status==="interrupted"&&e.status!=="interrupted"?1:n.elapsed_seconds-e.elapsed_seconds),t});function m_(t){return"★".repeat(Math.min(t,5))+"☆".repeat(Math.max(0,5-t))}function Ti(t){switch(t){case"short":return"Short-term";case"mid":return"Mid-term";case"long":return"Long-term";default:return t}}function us(t){switch(t){case"short":return"#4ade80";case"mid":return"#f59e0b";case"long":return"#818cf8";default:return"#888"}}function v_(t){return t<60?`${Math.round(t)}s`:t<3600?`${Math.floor(t/60)}m ${Math.round(t%60)}s`:`${Math.floor(t/3600)}h ${Math.floor(t%3600/60)}m`}function io(t){return t.toFixed(4)}function oo(t){const e=t.current_metric-t.baseline_metric;return`${e>=0?"+":""}${e.toFixed(4)}`}function __(t){switch(t){case 1:return"P1";case 2:return"P2";case 3:return"P3";default:return"P4"}}function ro(t,e){return(t.priority??4)-(e.priority??4)}function f_(t,e){const n=t.updated_at??t.created_at??"";return(e.updated_at??e.created_at??"").localeCompare(n)}function g_(t,e){return t.length<=e?t:t.slice(0,e)+"..."}function $_({goal:t}){return i`
    <div class="goal-row">
      <div class="goal-row-main">
        ...
        <div class="goal-meta">
          <span class="goal-priority" title="Priority ${t.priority}">${m_(t.priority)}</span>
  ...
  `}function y_(){const t=Re.value,e=t.filter(a=>a.status==="active").length,n=t.filter(a=>a.status==="completed").length,s={short:0,mid:0,long:0};for(const a of t)a.horizon in s&&s[a.horizon]++;return i`
  ...
  `}function b_({loop:t}){const e=t.history[0],n=t.latest_tool_names&&t.latest_tool_names.length>0?`${t.latest_tool_call_count??t.latest_tool_names.length} tool${(t.latest_tool_call_count??t.latest_tool_names.length)===1?"":"s"}: ${t.latest_tool_names.join(", ")}`:"No evidence yet";return i`
    <div class="planning-loop-row">
      <div class="planning-loop-main">
        ...
        <div class="planning-loop-metrics">
          ...
          <span>Elapsed ${v_(t.elapsed_seconds)}</span>
        </div>
  ...
  `}function va({task:t}){const e=t.priority??4,n=e<=1?"p1":e===2?"p2":e===3?"p3":"p4",s=Ya.value.has(t.id),a=!!t.description;return i`
    <div class="kanban-card ${n}">
      <div class="kanban-card-header">
        <span class="priority-badge priority-badge--${n}">${__(e)}</span>
      ...
      ${a?i`
        <div
          ...
          onClick=${()=>d_(t.id)}
        >
          ${s?t.description:g_(t.description??"",80)}
        </div>
      `:null}
  ...
  `}function k_(){const{todo:t,inProgress:e,done:n}=Lo.value,s=[...t].sort(ro),a=[...e].sort(ro),o=[...n].sort(f_);return i`
  ...
  `}function x_(){const{todo:t,inProgress:e,done:n}=Lo.value,s=t.length+e.length+n.length,a=[...t,...e].filter(u=>(u.priority??4)<=2).length,o=u_.value,l=p_.value,c=Re.value.length>0,p=l.length>0,m=oi.value;return i`
    <div>
      ...
      <details class="overview-section-collapsible" open=${c}>
        ...
        <div>
          ${c?i`
            <${y_} />
            <${h_} />
            ${ln.value&&Re.value.length===0?i`<div class="loading-indicator">Loading goals...</div>`:Fr.value.length===0?i`<div class="empty-state">No goals match the current filters</div>`:i`
        ...
        <div>
          ${cn.value&&l.length===0?i`<div class="loading-indicator">Loading MDAL loops...</div>`:l.length===0&&(m==="error"||Pe.value)?i`<div class="empty-state">MDAL snapshot could not be loaded${Pe.value?`: ${Pe.value}`:""}. Check backend health.</div>`:l.length===0?i`<div class="empty-state">No active loops. Use <code>masc_mdal_start</code> to start a loop.</div>`:i`
                  <div class="planning-loop-list">
                    ${l.map(u=>i`<${b_} key=${u.loop_id} loop=${u} />`)}
                  </div>
                `}
        </div>
      </details>
    </div>
  `}const vn=f("debates"),Fs=f([]),Ks=f([]),Us=f(!1),_n=f(!1),Nn=f(""),fn=f(""),Bs=f(null),St=f(null),Qa=f(!1);async function ta(){Us.value=!0,Nn.value="";try{const t=await Rl();Fs.value=Array.isArray(t.debates)?t.debates:[],Ks.value=Array.isArray(t.sessions)?t.sessions:[]}catch(t){Nn.value=t instanceof Error?t.message:"Failed to load governance state"}finally{Us.value=!1}}_d(ta);async function lo(){const t=fn.value.trim();if(t){_n.value=!0;try{const e=await kc(t);fn.value="",R(e!=null&&e.id?`Debate started: ${e.id}`:"Debate started","success"),await ta()}catch(e){const n=e instanceof Error?e.message:"Failed to start debate";R(n,"error")}finally{_n.value=!1}}}async function S_(t){Bs.value=t,St.value=null,Qa.value=!0;try{St.value=await xc(t)}catch(e){Nn.value=e instanceof Error?e.message:"Failed to load debate detail"}finally{Qa.value=!1}}function A_(){return i`
    <div class="board-summary-strip">
      <div class="board-summary-item">
        <span class="board-summary-label">Open debates</span>
        <strong>${Fs.value.length}</strong>
      </div>
      <div class="board-summary-item">
  ...
  `}function C_({debate:t}){const e=Bs.value===t.id;return i`
  ...
  `}function w_({session:t}){return i`
  ...
  `}function T_(){const t=vn.value;return i`
    ...
    <div>
      ...
      <${T} title="Debates" class="section" semanticId="governance.debates">
        <div class="council-list">
          ${Fs.value.length===0?i`<div class="empty-state">No debates yet</div>`:Fs.value.map(t=>i`<${C_} key=${t.id} debate=${t} />`)}
        </div>
      <//>
  ...
  `}function R_(){return i`
    <${T} title="Voting Sessions" class="section" semanticId="governance.voting">
      <div class="council-list">
        ${Ks.value.length===0?i`<div class="empty-state">No active sessions</div>`:Ks.value.map(t=>i`<${w_} key=${t.id} session=${t} />`)}
      </div>
    <//>
  `}function P_(){return Z(()=>{ta()},[]),i`
    <div>
      <${gt} surfaceId="governance" />
      <${A_} />
      <${T_} />
      ${vn.value==="debates"?i`<${I_} />`:i`<${R_} />`}
    </div>
  `}const xe=f(""),_a=f("ability_check"),fa=f("10"),ga=f("12"),Xn=f(""),Zn=f("idle"),Kt=f(""),ts=f("keeper-late"),$a=f("player"),ha=f(""),_t=f("idle"),ya=f(null),es=f(""),ba=f(""),ka=f("player"),xa=f(""),Sa=f(""),Aa=f(""),gn=f("20"),Ca=f("20"),wa=f(""),ns=f("idle"),Xa=f(null),Kr=f("overview"),Ta=f("all"),Ia=f("all"),Ra=f("all"),M_=12e4,ea=f(null),co=f(Date.now());function N_(t,e){const n=e>0?t/e*100:0;return n>50?"hp-high":n>25?"hp-mid":"hp-low"}function L_(t,e){return e>0?Math.round(t/e*100):0}const D_={pragmatic:"리스크보다 확실한 이득을 우선합니다.",frugal:"자원 소모를 줄이고 효율을 챙깁니다.",impatient:"짧은 템포로 즉시 압박을 선호합니다.",stubborn:"한 번 정한 전술을 끝까지 밀어붙입니다.",protective:"아군 피해를 줄이는 선택을 우선합니다.","honor-bound":"약속과 규율을 지키는 행동에 보너스가 납니다.",intense:"집중 화력을 짧게 폭발시킵니다.",empathetic:"아군/약자 보호 쪽 선택 확률이 높아집니다.",fatalistic:"위험을 감수하는 고배수 선택을 탑니다.",suspicious:"함정/매복 경계 행동을 우선합니다.",precise:"단일 목표를 정확히 노리는 경향입니다.",vengeful:"직전 위협 대상에게 강하게 반응합니다.",aggressive:"공격적인 전진 행동을 우선합니다.",opportunistic:"빈틈이 열리면 즉시 추격합니다."},z_={supply_scan:"전장/자원 상태를 스캔해 약한 지점을 찾습니다.",ration_shift:"소모를 줄이고 지속 전투 능력을 확보합니다.",logistics_patch:"무너진 운영 라인을 빠르게 복구합니다.",frontline_shield:"전열에서 아군 피해를 흡수합니다.",oath_intercept:"핵심 타깃을 가로막아 위협을 차단합니다.",morale_anchor:"아군 안정도를 높여 붕괴를 막습니다.",omen_trace:"다음 위험 신호를 먼저 감지합니다.",arc_flash:"짧은 순간 광역 압박을 넣습니다.",ward_bloom:"방어 장막을 펼쳐 생존률을 올립니다.",mark_prey:"우선 제거 대상을 지정합니다.",silent_route:"은밀한 진입 경로를 확보합니다.",finisher_strike:"약화된 적을 마무리하는 일격입니다.",shadow_claw:"근접 급습으로 출혈 피해를 노립니다.",lunge:"짧은 돌진으로 전열을 흔듭니다."};function ss(t){const e=t.trim();return e?e.split(/[_-]+/g).filter(n=>n.length>0).map(n=>n[0]?`${n[0].toUpperCase()}${n.slice(1)}`:n).join(" "):t}function E_(t){const e=t.trim().toLowerCase();return D_[e]??"행동 선택 가중치에 영향을 주는 성향입니다."}function j_(t){const e=t.trim().toLowerCase();return z_[e]??"상황에 따라 선택되는 전술 액션입니다."}function dt(t,e,n=""){const s=t[e];return typeof s=="string"?s:n}function At(t,e,n=0){const s=t[e];return typeof s=="number"&&Number.isFinite(s)?s:n}function Ln(t,e,n=!1){const s=t[e];return typeof s=="boolean"?s:n}const O_=new Set(["str","dex","con","int","wis","cha"]);function q_(t){const e=t.trim();if(!e)return{};let n;try{n=JSON.parse(e)}catch(a){throw new Error(`능력치 JSON 파싱 실패: ${a instanceof Error?a.message:"invalid json"}`)}if(!v(n))throw new Error('능력치 JSON은 object여야 합니다. 예: {"luck":7}');const s={};return Object.entries(n).forEach(([a,o])=>{const l=a.trim();if(l){if(typeof o=="number"&&Number.isFinite(o)){s[l]=Math.max(0,Math.trunc(o));return}if(typeof o=="string"){const c=Number.parseFloat(o.trim());if(Number.isFinite(c)){s[l]=Math.max(0,Math.trunc(c));return}}throw new Error(`능력치 '${l}' 값은 숫자여야 합니다.`)}}),s}function F_(t){const e=Number.parseInt(t.trim(),10);if(!Number.isFinite(e))return;const n=Math.max(1,e),s=Number.parseInt(gn.value.trim(),10);Number.isFinite(s)&&s>n&&(gn.value=String(n))}function Za(t){const n=(t.actor_name??t.actor??t.actor_id??"system").trim();return n===""?"system":n}function K_(t){var n;return(((n=t.timestamp)==null?void 0:n.trim())??"")||"-"}function U_(t){Kr.value=t}function Ur(t){const e=ea.value;return e==null||e<=t}function B_(t){const e=ea.value;return e==null||e<=t?0:Math.max(0,Math.ceil((e-t)/1e3))}function Hs(){ea.value=null}function Br(t){return typeof window>"u"||typeof window.confirm!="function"?!0:window.confirm(t)}function H_(t,e){Br(["관전 모드 잠금을 해제하시겠습니까?",`ROOM: ${t||"-"}`,`PHASE: ${e||"-"}`,"해제 시간: 120초 (시간 경과 또는 위험 액션 실행 후 자동 재잠금)"].join(`
`))&&(ea.value=Date.now()+M_,R("조작 잠금이 120초 동안 해제되었습니다.","warning"))}function ps(t){return Ur(t)?(R("관전 모드 잠금 상태입니다. 먼저 잠금을 해제하세요.","warning"),!1):!0}function ti(t,e,n){return Br([`[위험 액션 확인] ${t}`,`ROOM: ${e||"-"}`,`PHASE: ${n||"-"}`,"이 액션은 즉시 실행되며 되돌리기 어렵습니다.","계속 진행하시겠습니까?"].join(`
`))}function W_({hp:t,max:e}){const n=L_(t,e),s=N_(t,e);return i`
    <div class="trpg-hp-bar">
      <div class="hp-fill ${s}" style="width:${n}%" />
    </div>
  `}function G_({stats:t}){const e=[{label:"STR",value:t.strength},{label:"DEX",value:t.dexterity},{label:"CON",value:t.constitution},{label:"INT",value:t.intelligence},{label:"WIS",value:t.wisdom},{label:"CHA",value:t.charisma}];return i`
  ...
  `}function Hr({actor:t}){var p,m,u,_;const e=(p=t.archetype)==null?void 0:p.trim(),n=(m=t.persona)==null?void 0:m.trim(),s=(u=t.portrait)==null?void 0:u.trim(),a=(_=t.background)==null?void 0:_.trim(),o=t.traits??[],l=t.skills??[],c=Object.entries(t.stats_raw??{}).filter(([g,$])=>Number.isFinite($)).filter(([g])=>!O_.has(g.toLowerCase()));return i`
  ...
  `}function V_({mapStr:t}){return i`<pre class="trpg-map">${t}</pre>`}function Wr({events:t,emptyLabel:e="아직 이벤트가 없습니다."}){return t.length===0?i`<div class="empty-state" style="font-size:13px">${e}</div>`:i`
  ...
  `:null}function Yr(){const t=Xa.value;if(!t)return i`<div class="empty-state" style="font-size:13px;">Run Round 결과가 아직 없습니다.</div>`;const e=t.summary,n=v(e)?e:null,a=(Array.isArray(t.statuses)?t.statuses:[]).filter(v).slice(-8),o=t.canon_check,l=v(o)?o:null,c=l&&Array.isArray(l.warnings)?l.warnings.filter(P=>typeof P=="string").slice(0,3):[],p=l&&Array.isArray(l.violations)?l.violations.filter(P=>typeof P=="string").slice(0,3):[],m=n?Ln(n,"advanced",!1):!1,u=n?dt(n,"progress_reason",""):"",_=n?dt(n,"progress_detail",""):"",g=n?At(n,"player_successes",0):0,$=n?At(n,"player_required_successes",0):0,S=n?Ln(n,"dm_success",!1):!1,k=n?At(n,"timeouts",0):0,w=n?At(n,"unavailable",0):0,C=n?At(n,"reprompts",0):0,A=n?At(n,"npc_attacks",0):0,x=n?At(n,"keeper_timeout_sec",0):0,I=n?At(n,"roll_audit_count",0):0;return i`
    <div style="display:grid; gap:10px;">
      ...
      ${a.length>0?i`
          <div class="trpg-round-list">
            ${a.map(P=>{const H=dt(P,"status","unknown"),U=dt(P,"actor_id","-"),mt=dt(P,"role","-"),tt=dt(P,"reason",""),et=dt(P,"action_type",""),q=dt(P,"reply","");return i`
  ...
  `}function ef({state:t,nowMs:e}){var l,c,p;const n=Lt.value||((l=t.session)==null?void 0:l.room)||"",s=((c=t.current_round)==null?void 0:c.phase)??((p=t.session)==null?void 0:p.status)??"unknown",a=Ur(e),o=B_(e);return i`
    <${T} title="조작 안전 잠금" style="margin-bottom:16px;" semanticId="lab.trpg">
      <div class="trpg-control-lock ${a?"locked":"unlocked"}">
        ...
        <div style="display:flex; gap:8px; margin-top:10px; flex-wrap:wrap;">
          ${a?i`<button class="trpg-run-btn recommend" onClick=${()=>H_(n,s)}>잠금 해제 (120초)</button>`:i`<button class="trpg-run-btn secondary" onClick=${()=>{Hs(),R("조작 잠금으로 전환했습니다.","success")}}>즉시 다시 잠금</button>`}
        </div>
      </div>
    <//>
  ...
  `}function sf({state:t}){const e=t.party??[],n=t.story_log??[];return i`
  ...
  `}function af({state:t}){const e=t.story_log??[];return i`
    <div class="trpg-layout">
      <div>
  ...
  `}function rf(){var c,p,m,u,_;const t=Po.value,e=Ka.value;if(Z(()=>{if(typeof window>"u"||typeof window.setInterval!="function")return;const g=window.setInterval(()=>{co.value=Date.now()},1e3);return()=>{window.clearInterval(g)}},[]),e&&!t)return i`<div class="loading-indicator">Loading TRPG state...</div>`;if(!t)return i`
      <div class="section">
        <h2>TRPG</h2>
    ...
    <div>
      ...
      ${o==="overview"?i`<${sf} state=${t} />`:o==="timeline"?i`<${af} state=${t} />`:i`<${of} state=${t} nowMs=${l} />`}
    </div>
  ...
  `}const Ws=f(new Set(["broadcast","tasks","keepers","system"]));function cf(t){const e=new Set(Ws.value);e.has(t)?e.delete(t):e.add(t),Ws.value=e}const Ii=f(null);function Qr(t){Ii.value=t}function df(t){return t.kind==="board"?"broadcast":t.kind==="tasks"?"tasks":t.kind==="keepers"?"keepers":"system"}const uf=yt(()=>{const t=Ws.value;return vs.value.filter(e=>t.has(df(e)))}),pf=12e4,mf=yt(()=>{const t=li.value,e=Date.now();return bt.value.map(n=>{const s=n.name.trim().toLowerCase(),a=t.get(s)??null;let o="idle";if(n.status==="active"||n.status==="busy"){const l=a==null?void 0:a.lastActivityAt;l?o=e-new Date(l).getTime()>pf?"stale":"working":o="working"}else(n.status==="offline"||n.status==="inactive")&&(o="stale");return{name:n.name,emoji:n.emoji??"",koreanName:n.koreanName??null,state:o,currentTask:n.current_task,motion:a}})}),vf=yt(()=>{const t=li.value;return bt.value.filter(e=>e.status==="active"||e.status==="busy"||e.status==="listening"||e.status==="idle").map(e=>{const n=e.name.trim().toLowerCase(),s=t.get(n),a=(s==null?void 0:s.activeAssignedCount)??0;let o="calm";return a>=3?o="hot":a>=1&&(o="normal"),{name:e.name,emoji:e.emoji??"",koreanName:e.koreanName??null,currentTask:e.current_task,lastActivityAt:(s==null?void 0:s.lastActivityAt)??null,lastActivityText:(s==null?void 0:s.lastActivityText)??null,assignedCount:a,pressure:o}}).sort((e,n)=>{const s={hot:0,normal:1,calm:2};return s[e.pressure]-s[n.pressure]})});function uo(t){return t.kind==="board"?"live-event-broadcast":t.kind==="tasks"?"live-event-task":t.kind==="keepers"?"live-event-keeper":"live-event-system"}function _f(t){const e=t.eventType;return e==="broadcast"?"broadcast":e==="agent_joined"?"joined":e==="agent_left"?"left":e==="task_update"?"task":e==="board_post"?"post":e==="board_comment"?"comment":e==="keeper_heartbeat"?"heartbeat":e==="keeper_handoff"?"handoff":e==="keeper_compaction"?"compact":e==="keeper_guardrail"?"guardrail":t.kind==="board"?"board":t.kind==="tasks"?"task":t.kind==="keepers"?"keeper":"system"}function ff(t){switch(t){case"working":return"pulse-working";case"stale":return"pulse-stale";default:return"pulse-idle"}}function gf(){const t=mf.value,e=Ii.value;return t.length===0?i`
    ...
    <div class="pulse-strip">
      ${t.map(n=>i`
        <button
          key=${n.name}
          class="pulse-bubble ${ff(n.state)} ${e===n.name?"pulse-selected":""}"
  ...
  `}const $f=[{kind:"broadcast",label:"Broadcast",cssClass:"live-event-broadcast"},{kind:"tasks",label:"Task",cssClass:"live-event-task"},{kind:"keepers",label:"Keeper",cssClass:"live-event-keeper"},{kind:"system",label:"System",cssClass:"live-event-system"}];function hf(){const t=Ws.value;return i`
  ...
  `}function yf(){const t=uf.value;return i`
        ...
        ${t.length===0?i`<div class="activity-empty">No events matching filters</div>`:t.map((e,n)=>i`
            ...
            >
              <div class="activity-item-head">
                <span class="activity-kind-chip ${uo(e)}">${_f(e)}</span>
  ...
  `}function bf(t){switch(t){case"hot":return"focus-pressure-hot";case"normal":return"focus-pressure-normal";default:return"focus-pressure-calm"}}function kf(t){switch(t){case"hot":return"High";case"normal":return"Active";default:return"Calm"}}function xf(){const t=vf.value,e=Ii.value;return i`
  ...
  `}function Sf(){const t=Vt.value;return i`
  ...
  `}function wf(){const t=pt.value,e=(t==null?void 0:t.pending_confirms.length)??0,n=(t==null?void 0:t.sessions.length)??0,s=(t==null?void 0:t.keepers.length)??0;return i`
    <section class="rail-card">
      <div class="rail-card-head">
        <h3>개입 바로가기</h3>
  ...
  `}function Tf(){const t=E.value.tab,e=ei.find(s=>s.id===t),n=po.find(s=>s.id===(e==null?void 0:e.group));return i`
  ...
  `}function If(){switch(E.value.tab){case"mission":return i`<${Ji} />`;case"execution":return i`<${c_} />`;case"live":return i`<${Sf} />`;case"memory":return i`<${Xv} />`;case"governance":return i`<${P_} />`;case"planning":return i`<${x_} />`;case"intervene":return i`<${Ov} />`;case"command":return i`<${hv} />`;case"lab":return i`<${lf} />`;default:return i`<${Ji} />`}}function Rf(){Z(()=>{cl(),yo(),jo(),re(),Eo(),Fo();const n=$d();return hd(),()=>{gl(),n(),yd()}},[]),Z(()=>{const n=setInterval(()=>{ni(E.value.tab)},15e3);return()=>{clearInterval(n)}},[]),Z(()=>{ni(E.value.tab)},[E.value.tab]);const t=E.value.tab,e=ei.find(n=>n.id===t);return i`
    <div class="app-shell">
      ...
      <div class="dashboard-layout">
        ...
        <main class="dashboard-main">
          ${Fa.value&&!Vt.value?i`<div class="loading-indicator">Loading dashboard...</div>`:i`<${If} />`}
        </main>
      </div>
  ...
  `}const mo=document.getElementById("app");mo&&al(i`<${Rf} />`,mo);export{um as _};
