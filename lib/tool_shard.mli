...
(** Issue #8513: hand-mirrored from
    [Masc_board_handlers.Board_dispatch.valid_sort_order_strings] (#8453 SSOT). Schema
...
(** Issue #8506: hand-mirrored from
    [Masc_board_handlers.Board_votes.valid_vote_direction_strings]. Sync regression test
