...
type closed_unit =
  | Ordinary_message of Masc_agent_core.Types.message
  | Closed_tool_cycle of Masc_agent_core.Types.message list
...
type partition =
  ...
  ; protected_suffix : Masc_agent_core.Types.message list
  }
...
val messages_of_closed_unit : closed_unit -> Masc_agent_core.Types.message list
