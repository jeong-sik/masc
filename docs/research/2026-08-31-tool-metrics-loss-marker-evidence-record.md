...
- 날짜(ISO8601): 2026-08-31T09:33:33+09:00
- 작성자: Codex
...
- 확인일시: 2026-08-31T09:33:33+09:00
- 신뢰도: High
- 제한조건: Linux/arm64 Docker Desktop, local named volume, single process writer, 30-day retention

## 검증

- 1차: focused tests 15/15에서 fresh unknown, valid known-incomplete, expiry, invalid/unreadable marker, marker-write failure를 확인했다.
- 2차: final exact-head helper와 health가 commit `ecba6acf...` 및 binary SHA `bd61f90c...`를 증언했다.
...
- 7차: r117 marker target-directory failure 뒤 SIGKILL replacement가 marker read failure와 pending hydration을 격리해 recovered/final 4,096을 유지하는지 확인했다.
