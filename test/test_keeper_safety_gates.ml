(** Comprehensive tests for keeper safety gates.
    ...
    2. Keeper_tool_dispatch_runtime.keeper_allowed_tool_names — tool_access grants
...
let test_explicit_access_lists_control_tool_count () =
  ...
  let tools_a = Keeper_tool_dispatch_runtime.keeper_allowed_tool_names meta_a in
  let tools_b = Keeper_tool_dispatch_runtime.keeper_allowed_tool_names meta_b in
