...
let () =
  ...
  (match Workspace_eio.register_agent config ~name:"test-agent" ~capabilities:[] () with
  ...
  (match Workspace_eio.broadcast config ~from_agent:"test-agent" ~content:"Hello!" with
